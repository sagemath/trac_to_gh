...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395761",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "This is still WIP, more to be done here.",
    "created_at": "2019-08-02T08:58:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395762",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395763",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395764",
    "user": "git"
}
```
...
```json
{
    "body": "still needed to sort out dependencies properly, and provide spkg-configure.m4 for gp2c.\n\nFor installing gp2c, one must provide pari.cfg location, something that it's not really discoverable. (save for `find / -name pari.cfg` :-))",
    "created_at": "2019-08-03T22:12:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395765",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "`pari.cfg` is installed in something called `sysdatadir` at configure time. I don't know if it is possible to get that variable at runtime (without knowing `pari.cfg` already that is).",
    "created_at": "2019-08-04T10:06:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395769",
    "user": "@kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395770",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395771",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395772",
    "user": "@isuruf"
}
```
...
```json
{
    "body": "Do you have `libpari-gmp` or `libpari-gmp-tls`?",
    "created_at": "2019-08-05T21:13:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395777",
    "user": "@kiwifb"
}
```
...
```json
{
    "body": "I have libpari-gmp-tls",
    "created_at": "2019-08-06T05:38:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395778",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "Given that everything else works, I think it should be a docbuild bug, that produces segfaults at random places while reference manual is built. Something to do with tread-local storage in libpari, presumably.",
    "created_at": "2019-08-06T10:20:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395779",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "I know for pari we're also dependent currently on a few patches for bug fixes (on Cygwin one of these is critical).  It would be nice to get these upstream if they aren't already...",
    "created_at": "2019-08-06T12:49:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395780",
    "user": "@embray"
}
```
...
```json
{
    "body": "there is a Darwin-specific and a Cygwin-specific ones, the rest I presume are already in (in particular as they are by Pari people).",
    "created_at": "2019-08-06T13:46:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395781",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395782",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "Right, using the CYGWIN workaround, i.e. unconditional `from .utils import _build_many as build_many` in [src/sage_setup/docbuild/__init__.py](https://github.com/sagemath/sage/blob/master/src/sage_setup/docbuild/__init__.py#L307) allows docs to build. Now, we can either always use it for external PARI, or test external PARI on whether it has multi-threading enabled, and only in this case use it.\n\nI don't know how to test for PARI  multi-threading enabled, so unless someone can provide a test, I'm going to set it on always.",
    "created_at": "2019-08-07T07:17:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395783",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395784",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395785",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395786",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395787",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395788",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "please review. I only tested this on Debian 10, which has all the require PARI packages. A new Fedora (29 or better) should do, too.",
    "created_at": "2019-08-08T10:28:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395789",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "The workaeound for docbuilding is not yet in this branch, thus if you supply a multithreaded libpari, docs won't build (unless one uses the workabout in comment:25)",
    "created_at": "2019-08-08T10:46:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395790",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395791",
    "user": "git"
}
```
...
```json
{
    "body": "I checked in conda and this picks up the conda installation correctly. For that though I needed to install the optional packages `pari-*`. `conda install pari` only pulls in `pari-seadata-small` and `pari-galdata`.\n\nEven though the above issue is there, this is still an improvement over current situation.",
    "created_at": "2019-08-09T17:13:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395793",
    "user": "@isuruf"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395794",
    "user": "@isuruf"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395795",
    "user": "@isuruf"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395796",
    "user": "@isuruf"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395797",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395798",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395799",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395800",
    "user": "@isuruf"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395801",
    "user": "@isuruf"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395803",
    "user": "@kiwifb"
}
```
...
```json
{
    "body": "Follow up will take place at #28341.",
    "created_at": "2019-08-11T01:03:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395805",
    "user": "@kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395806",
    "user": "@kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395807",
    "user": "@vbraun"
}
```
...
```json
{
    "body": "Can Archlinux get more PARI packages (as much as Debian 10), so that its PARI may be used?",
    "created_at": "2019-08-26T18:15:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395808",
    "user": "@dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395809",
    "user": "@antonio-rojas"
}
```
...
```json
{
    "body": "Follow up at #29319",
    "created_at": "2020-03-12T17:39:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395810",
    "user": "@mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395811",
    "user": "@mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395812",
...
```json
{
    "body": "Hmm, not sure what's happening here. I don't think I saw this before. Something related to `--enable-tls` (tls=thread-local storage) option while buildig Pari/GP - which works on Linux smoothly.",
    "created_at": "2020-04-26T16:47:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395813",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "But it seems that this is disabled when Sage builds Pari?\n\nIn build/pkgs/pari/spkg-install.in there is \"unset enable_tls\".",
    "created_at": "2020-04-26T17:26:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395814",
    "user": "@thierry-FreeBSD"
}
```
...
```json
{
    "body": "I mean to say that we can use Pari built with `--enable-tls` with Sage on several Linux distributions (not the Pari built by Sage). Does FreeBSD Pari port use some special clang flags for TLS? \n\nIs Pari built with pthread on FreeBSD?",
    "created_at": "2020-04-27T03:05:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395815",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "On the other hand, `cysignals` is not known to be thread-safe, so it could be that FreeBSD tools are better than Linux tools in detecting this:\nhttps://github.com/sagemath/cysignals/issues/21\n\nIn view of this, linking `cysignals` with `-pthreads` might be what causes this error.",
    "created_at": "2020-04-27T04:06:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395816",
    "user": "@dimpase"
}
```
...
```json
{
    "body": "That's fixed already by #29554",
    "created_at": "2020-04-27T22:35:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395818",
    "user": "@mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28005#issuecomment-395819",
    "user": "@dimpase"
}
```
