...
```json
{
    "body": "Spkg looks good to me. The src directory is potentially a mess, but that is not due to the work on this ticket. We need to update the source to the latest release anyway, so we will deal with that issue then, i.e. #1631.\n\nCheers,\n\nMichael",
    "created_at": "2008-05-18T13:08:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3236#issuecomment-22365",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3236",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3236#event-3455"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3236#issuecomment-22366",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3236#issuecomment-22367",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
