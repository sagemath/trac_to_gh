...
```json
{
    "body": "I think some of the desired tests are performed on the subsidiary methods.  There was a desire at the time not to put too much in the main documentation.\n\nFir example, `random_unimodular_matrix` tests three very different results for determinant one.",
    "created_at": "2012-10-01T03:44:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13351",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13351#issuecomment-163793",
...
```json
{
    "body": "But if there had been some additional doctesting, the inconsistency between documentation and result would have been spotted a long time ago. The (duplicate) bug that inspired this trac report has been around since before 4.7.3.\u00a0 #11968\n\nIf something goes into the documentation, then it should probably be tested there as well, or removed from the documentation. If a change somewhere else then breaks the doctest, then that at least acts as a flag that the documentation needs to be changed.",
    "created_at": "2012-10-01T03:53:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13351",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13351#issuecomment-163794",
    "user": "https://trac.sagemath.org/admin/accounts/users/JoalHeagney"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13351#event-37680"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13351#event-37681"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13351#event-37682"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13351#event-37683"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13351#event-37684"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13351#event-37685"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13351#event-37686"
}
```
