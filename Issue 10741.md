...
```json
{
    ...
    "title": "Modular Symbols trouble restorng saved objects",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10741#issuecomment-113366",
    "user": "jonhanke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10741#issuecomment-113367",
    "user": "davidloeffler"
}
```
...
```json
{
    "body": "Attachment [trac_10807.patch](tarball://root/attachments/some-uuid/ticket10807/trac_10807.patch) by davidloeffler created at 2011-12-26 10:51:14\n\nHere's a patch which sorts out the issue with restoring saved objects. The `system_of_eigenvalues` issue is a separate bug -- please open a separate ticket for that!",
    "created_at": "2011-12-26T10:51:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10741#issuecomment-113368",
    "user": "davidloeffler"
}
```

Attachment [trac_10807.patch](tarball://root/attachments/some-uuid/ticket10807/trac_10807.patch) by davidloeffler created at 2011-12-26 10:51:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10741#issuecomment-113369",
    "user": "davidloeffler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10741#issuecomment-113370",
    "user": "mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10741#issuecomment-113371",
    "user": "jdemeyer"
}
```
