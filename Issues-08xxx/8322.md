...
```json
{
    "body": "Changing author from \"\" to \"Pedro Sanchez\"",
    "created_at": "2010-02-28T07:54:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8322#issuecomment-86756",
    "user": "https://trac.sagemath.org/admin/accounts/users/drini"
}
```

Changing author from "" to "Pedro Sanchez"
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19918"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19919"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19920"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19921"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19922"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19923"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19924"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19925"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19926"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8322#issuecomment-86758",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8322#issuecomment-86759",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpswanson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8322#issuecomment-86760",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpswanson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8322",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8322#event-19927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8322#issuecomment-86761",
