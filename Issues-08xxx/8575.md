...
<a id='comment:2'></a>There is a very good chance that this is a bug of sphinx. I asked it on
sphinx-dev. I'm waiting for their answer.
...
<a id='comment:3'></a>This is indeed a bug of sphinx (see [this Sphinx-dev thread](http://groups.google.com/group/sphinx-dev/t/c65dcb4b8a057d04)). Georg Brandl answered:
...
<a id='comment:6'></a>This ticket should be closed since sage uses now sphinx 1.0.4
