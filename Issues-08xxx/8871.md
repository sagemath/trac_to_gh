...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-94166"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-94167"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-94168"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-94169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-94170"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8871#issuecomment-74379",
    "user": "https://github.com/sagetrac-ecurry"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8871#issuecomment-74380",
    "user": "https://github.com/sagetrac-ecurry"
}
```
