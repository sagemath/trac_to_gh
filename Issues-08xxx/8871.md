...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8871#issuecomment-96725",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8871#issuecomment-96726",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>A better method for \"centered\" would be to find the lattice points in the interior of G (already implemented in Polyhedra?), then find the lattice points in the facets of G that I want to include, then take the union of these sets.\n\nTo Do: how to list the facets as Polyhedra, and choose the d (=dimension) of them that I want to include?",
    "created_at": "2010-05-05T15:18:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8871#issuecomment-96727",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```

<a id='comment:3'></a>A better method for "centered" would be to find the lattice points in the interior of G (already implemented in Polyhedra?), then find the lattice points in the facets of G that I want to include, then take the union of these sets.
