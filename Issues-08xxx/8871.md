...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-102401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-102402"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8871#issuecomment-74396",
    "user": "https://github.com/sagetrac-ecurry"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8871#issuecomment-74397",
    "user": "https://github.com/sagetrac-ecurry"
}
```
