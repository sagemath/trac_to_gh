...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66080",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66081",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57918"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57919"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57920"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57921"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66082",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66083",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66084",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "asset_name": "trac_8273_digraphs_cycles_enumerations-abm.patch",
    "asset_url": "tarball://root/attachments/ticket8273/trac_8273_digraphs_cycles_enumerations-abm.patch",
    "created_at": "2010-02-23T14:01:55Z",
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8273/trac_8273_digraphs_cycles_enumerations-abm.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "Attachment [trac_8273_digraphs_cycles_enumerations-abm.patch](https://github.com/sagemath/sage/files/ticket8273/trac_8273_digraphs_cycles_enumerations-abm.patch) by abmasse created at 2010-02-23 14:01:55\n\nNew patch taking into account Nathann's comments",
    "created_at": "2010-02-23T14:01:55Z",
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66085",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

Attachment [trac_8273_digraphs_cycles_enumerations-abm.patch](https://github.com/sagemath/sage/files/ticket8273/trac_8273_digraphs_cycles_enumerations-abm.patch) by abmasse created at 2010-02-23 14:01:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66086",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57923"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57924"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57925"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57926"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66087",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66088",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66089",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_8273_with_heap-abm.patch",
    "asset_url": "tarball://root/attachments/ticket8273/trac_8273_with_heap-abm.patch",
    "created_at": "2010-02-25T17:55:26Z",
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8273/trac_8273_with_heap-abm.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>\nAttachment [trac_8273_with_heap-abm.patch](https://github.com/sagemath/sage/files/ticket8273/trac_8273_with_heap-abm.patch) by abmasse created at 2010-02-25 17:55:26\n\nI uploaded another patch that include your comments. Needs review !",
    "created_at": "2010-02-25T17:55:26Z",
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66090",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57927"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57928"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66091",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57929"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66092",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66093",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66094",
...
```json
{
    "body": "<a id='comment:12'></a>\nMerged in this order:\n\n1. [trac_8273_digraphs_cycles_enumerations-abm.patch](https://github.com/sagemath/sage/files/ticket8273/trac_8273_digraphs_cycles_enumerations-abm.patch)\n2. [trac_8273_with_heap-abm.patch](https://github.com/sagemath/sage/files/ticket8273/trac_8273_with_heap-abm.patch)\n\nAlexandre: you should place a sensible commit message in your patch together with the ticket number.",
    "created_at": "2010-03-03T14:23:40Z",
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66095",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8273#event-57932"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8273#issuecomment-66096",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
