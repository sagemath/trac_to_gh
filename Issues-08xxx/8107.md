...
```json
{
    "body": "<a id='comment:1'></a>The *sage*-repository patch and #8102 together reduce the overall time for me from ~1.9 s to ~1.7 s.",
...
<a id='comment:1'></a>The *sage*-repository patch and #8102 together reduce the overall time for me from ~1.9 s to ~1.7 s.
...
```json
{
    "body": "<a id='comment:2'></a>I'm sure we can do better with #7502...",
...
<a id='comment:2'></a>I'm sure we can do better with #7502...
...
```json
{
    "body": "<a id='comment:3'></a>Awesome -- I was just being annoyed by precisely these imports last night.",
...
<a id='comment:3'></a>Awesome -- I was just being annoyed by precisely these imports last night.
...
```json
{
    "body": "<a id='comment:4'></a>A big +1 from me too. I'm curious about the comment \n\n```\n# We import the following two only for doctesting purposes\n```\n\nthough.",
...
<a id='comment:4'></a>A big +1 from me too. I'm curious about the comment 
