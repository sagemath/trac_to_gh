...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82340",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I have attached a half-baked patch, which is not ready for review. I leave it here so I, or anyone, can work on it later on.",
    "created_at": "2010-03-02T02:28:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82341",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>I have attached a half-baked patch, which is not ready for review. I leave it here so I, or anyone, can work on it later on.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82344",
    "user": "https://trac.sagemath.org/admin/accounts/users/jasonbhill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82346",
    "user": "https://trac.sagemath.org/admin/accounts/users/jasonbhill"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>How many physical processors do Iras and Cleo have? (My guess is 2.) Have you noticed that their \"physical id\" tags are very strange? The physical cpu labels are 0 and 3 instead of 0 and 1. I'm wondering if this is consistent with other Itaniums.",
    "created_at": "2010-07-24T02:36:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82351",
    "user": "https://trac.sagemath.org/admin/accounts/users/jasonbhill"
}
```

<a id='comment:10'></a>How many physical processors do Iras and Cleo have? (My guess is 2.) Have you noticed that their "physical id" tags are very strange? The physical cpu labels are 0 and 3 instead of 0 and 1. I'm wondering if this is consistent with other Itaniums.
...
```json
{
    "body": "<a id='comment:11'></a>How do I find out how many physical processors they have?  A comment on some random web page suggests that if two \"processors\" in /proc/cpuinfo have the same physical address, then they're the same processor.  How else do I tell?",
    "created_at": "2010-07-24T02:55:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82352",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>How do I find out how many physical processors they have?  A comment on some random web page suggests that if two "processors" in /proc/cpuinfo have the same physical address, then they're the same processor.  How else do I tell?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82353",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82354",
    "user": "https://trac.sagemath.org/admin/accounts/users/jasonbhill"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>One thing that would be useful is the free disk space on whatever file system someone is building Sage on. Not sure the best way to find that out. Any ideas?\n\nDave",
    "created_at": "2010-07-24T20:55:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82357",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:16'></a>One thing that would be useful is the free disk space on whatever file system someone is building Sage on. Not sure the best way to find that out. Any ideas?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82360",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8048#issuecomment-82361",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
