...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74852",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [8909_gap2cyclotomic.patch](https://github.com/sagemath/sage/files/ticket8909/8909_gap2cyclotomic.patch) by @simon-king-jena created at 2010-05-08 12:16:57\n\nSorry, I forgot to label it \"needs review\"",
    "created_at": "2010-05-08T12:16:57Z",
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74853",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74854",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74855",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74856",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74857",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74858",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74859",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [trac_8909_catch_exception.patch](https://github.com/sagemath/sage/files/ticket8909/trac_8909_catch_exception.patch) by @simon-king-jena created at 2010-07-04 19:12:30\n\nReplying to [SimonKing](#comment%3A5):\n> Replying to [mhansen](#comment%3A4):\n> > There's a bare except clause at 6767 which should be fixed.\n\n> \n> By 'bare', you mean that it is not specified what error is raised? So, `except TypeError:` instead of `except:`? Well this would be easy enough to fix.\n> \n\n\nUnder the assumption that I understood you correctly, I provided a second patch that specifies that we only want to catch a `TypeError`, and return to needs_review.",
    "created_at": "2010-07-04T19:12:30Z",
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74860",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74861",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8909#issuecomment-74862",
