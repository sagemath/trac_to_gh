...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8957#issuecomment-75307",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_8957-matrix_group_word_problem.patch](https://github.com/sagemath/sage/files/ticket8957/trac_8957-matrix_group_word_problem.patch) by @loefflerd created at 2010-05-15 18:54:27",
    "created_at": "2010-05-15T18:54:27Z",
    "issue": "https://github.com/sagemath/sage/issues/8957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8957#issuecomment-75308",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8957#issuecomment-75309",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8957#issuecomment-75310",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8957#issuecomment-75311",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8957#issuecomment-75312",
    "user": "https://github.com/mwhansen"
}
```
