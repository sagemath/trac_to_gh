...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91390"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91391"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91394"
}
```
...
```json
{
    "body": "Changed assignee from **@jhpalmieri** to **mhampton**",
...
Changed assignee from **@jhpalmieri** to **mhampton**
...
```json
{
    "body": "Changed assignee from **mhampton** to **@jhpalmieri**",
...
Changed assignee from **mhampton** to **@jhpalmieri**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91395"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91396"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91397"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91398"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91399"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8302",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8302#event-91404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8302#issuecomment-66421",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8302#issuecomment-66422",
    "user": "https://github.com/jhpalmieri"
}
```
