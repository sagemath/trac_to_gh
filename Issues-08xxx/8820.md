...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95913",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Actually, this makes sense because I'm not giving Pari the embedding to use.",
    "created_at": "2010-04-29T09:13:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95914",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>Actually, this makes sense because I'm not giving Pari the embedding to use.
...
```json
{
    "body": "<a id='comment:2'></a>Rats, I thought I had implemented this properly.  The elliptic log does have examples over number fields with complex embeddings!  This should be a lot easier...\n\nThe period lattice has an embedding into CC (or RR) stored with it.  That should be used to create a pari elliptic curve defined over RR or CC, there the pari function would work.\n\nI would much prefer to have our own Weierstrass functions implemented, but that's the situation right now.\n\nNote that this will involve some of the same code as #8815.",
    "created_at": "2010-04-29T09:35:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95915",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>Rats, I thought I had implemented this properly.  The elliptic log does have examples over number fields with complex embeddings!  This should be a lot easier...
...
```json
{
    "body": "<a id='comment:3'></a>I am working on this right now.",
    "created_at": "2010-08-27T09:47:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95916",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:3'></a>I am working on this right now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95917",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95918",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_8820-elliptic-exp.patch](tarball://root/attachments/some-uuid/ticket8820/trac_8820-elliptic-exp.patch) by @JohnCremona created at 2010-08-29 14:38:36\n\nThe patch implements this.  I left the old code (using ellztopoint) for curves over QQ though the new code (using ellwp) works fine too, since the the output of many doctests would have changed (in insignificant bits), especially in heegner.py.\n\nI also documented a couple of functions in period_lattice.py which were not, so that file now has 100% coverage.",
    "created_at": "2010-08-29T14:38:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95919",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>Attachment [trac_8820-elliptic-exp.patch](tarball://root/attachments/some-uuid/ticket8820/trac_8820-elliptic-exp.patch) by @JohnCremona created at 2010-08-29 14:38:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95920",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I get doctest failures, like the typical case below. It should be considered numerical noise, but somehow it is not a very good example then. I think a point (1,1) would give a more convincing example.\n\n```\nFile \"/local/pmzcw/prog/sage-4.5/devel/sage-test/sage/schemes/elliptic_curves/period_lattice.py\", line 1424:\n    sage: Li[0].elliptic_exponential(zi[0])\nExpected:\n    (2.17701177381006e-16 + 2.21973923391111e-16*I : 1.11022302462516e-16 - 2.21990394816407e-16*I : 1.00000000000000)\nGot:\n    (2.17818031662168e-16 + 2.22022549601564e-16*I : 1.11022302462516e-16 - 2.22044604925031e-16*I : 1.00000000000000)\n```\n\nThe lines that fail are 1424, 1426, 1428, 1440, 1450, 1452.",
    "created_at": "2010-09-23T19:14:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95921",
    "user": "https://github.com/categorie"
}
```

<a id='comment:5'></a>I get doctest failures, like the typical case below. It should be considered numerical noise, but somehow it is not a very good example then. I think a point (1,1) would give a more convincing example.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95922",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95923",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95924",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95926",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95927",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95928",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Please try the rebased patch.  I changes the point (0,0) to (-1,-1) in the bad example, but that was enough since the approximate imaginary parts were not exactly 0 -- which I got around by taking real parts where necessary.  A little crude, but it avoids the fuzz.",
    "created_at": "2010-09-24T20:04:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95929",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:11'></a>Please try the rebased patch.  I changes the point (0,0) to (-1,-1) in the bad example, but that was enough since the approximate imaginary parts were not exactly 0 -- which I got around by taking real parts where necessary.  A little crude, but it avoids the fuzz.
...
```json
{
    "body": "<a id='comment:12'></a>John: I suppose you mean rebased to 4.6.alpha1 unless you have some super-secret pre-release version of sage-4.6.alpha2 :-)\n\nAlso: you should use \"PARI\" instead of \"Pari\".",
    "created_at": "2010-09-25T17:20:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95930",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:12'></a>John: I suppose you mean rebased to 4.6.alpha1 unless you have some super-secret pre-release version of sage-4.6.alpha2 :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95931",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95932",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95933",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>John, I have rebased your patch such that it can be applied after the positively-reviewed #9931 (there were several conflicts).  I also made some very small changes to the docstring of the `cardinality` function in `ell_finite_field.py`",
    "created_at": "2010-09-26T18:04:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95934",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>John, I have rebased your patch such that it can be applied after the positively-reviewed #9931 (there were several conflicts).  I also made some very small changes to the docstring of the `cardinality` function in `ell_finite_field.py`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95935",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95936",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95937",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95938",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95939",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95940",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [8820_rebase_after_9931.patch](tarball://root/attachments/some-uuid/ticket8820/8820_rebase_after_9931.patch) by @JohnCremona created at 2010-09-26 21:42:19\n\nReplying to [jdemeyer](#comment%3A17):\n> Replying to [cremona](#comment%3A16):\n> > # User Jeroen Demeyer <jdemeyer`@`cage.ugent.be>\n> > ...\n> > [mq]: 8820_rebase_after_9931\n> > }}}\n> > and I think protocol would leave me as author (and have a better one-line description) ;)\n\n> \n> OK, I just copy-pasted the header from your patch.\n\n\nThanks -- I added your name as reviewer and marked the ticket Positive Review.  If you want, you can add your name as author (and mine as reviewer) -- I appreciate your attention to detail.\n\nRelease manager:  apply only the last patch 8820_rebase_after_9931.patch, after the patch at #9931.",
    "created_at": "2010-09-26T21:42:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95941",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:18'></a>Attachment [8820_rebase_after_9931.patch](tarball://root/attachments/some-uuid/ticket8820/8820_rebase_after_9931.patch) by @JohnCremona created at 2010-09-26 21:42:19
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95942",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I'm sorry John, but I did not review your patch, I just made a few small comments.  In any case, I think it is strange for the author of a patch to set his ticket to positive_review (no offense though).  I can probably review your patch later (not tonight).",
    "created_at": "2010-09-26T22:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95943",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>I'm sorry John, but I did not review your patch, I just made a few small comments.  In any case, I think it is strange for the author of a patch to set his ticket to positive_review (no offense though).  I can probably review your patch later (not tonight).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95944",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95945",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95946",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95948",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Thanks for the comments, I will revise the patch accordingly.  The very last point (evaluation when z is very small but not zero) will not be easy though.  I think that I left in the special code for QQ since it was faster, but I may be mixing this up with the (harder!) elliptic logarithm.",
    "created_at": "2010-09-30T10:41:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95950",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:25'></a>Thanks for the comments, I will revise the patch accordingly.  The very last point (evaluation when z is very small but not zero) will not be easy though.  I think that I left in the special code for QQ since it was faster, but I may be mixing this up with the (harder!) elliptic logarithm.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95951",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>It's ok, I have fixed it and the only reason I have not yet upadted the patch is that I am getting lots of failures in heegner.py -- not for the first time.  Several of the doctests there are not very well designed, so I may complain to Robert Bradshaw if I cannot fix them all!",
    "created_at": "2010-09-30T16:43:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95952",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:27'></a>It's ok, I have fixed it and the only reason I have not yet upadted the patch is that I am getting lots of failures in heegner.py -- not for the first time.  Several of the doctests there are not very well designed, so I may complain to Robert Bradshaw if I cannot fix them all!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95954",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95955",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95956",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95957",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>I give all the changes to heegner.py in the patch \"8820_rebase_after_9931-new.patch\" a positive review.",
    "created_at": "2010-10-04T23:56:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95958",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:32'></a>I give all the changes to heegner.py in the patch "8820_rebase_after_9931-new.patch" a positive review.
...
```json
{
    "body": "<a id='comment:33'></a>You beat me to it :). Looks fine by me too.",
    "created_at": "2010-10-05T04:40:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95959",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:33'></a>You beat me to it :). Looks fine by me too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95961",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95963",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95964",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8820#issuecomment-95965",
    "user": "https://github.com/qed777"
}
```
