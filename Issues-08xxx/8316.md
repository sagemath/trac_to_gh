...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86634",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86635",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>To do: Update `spkg/install` and `spkg/standard/deps`.  I'll wait for #8306.",
    "created_at": "2010-03-05T02:34:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86636",
    "user": "https://github.com/qed777"
}
```

<a id='comment:2'></a>To do: Update `spkg/install` and `spkg/standard/deps`.  I'll wait for #8306.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86637",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86638",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86639",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86640",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86642",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86643",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86644",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86645",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86646",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86647",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86648",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Thanks for fixing up gen_interpreters.py, your changes look fine (and the template output from the patched gen_interpreters.py using jinja2 is byte-for-byte identical to the previous output using jinja).\n\nI tested by starting from sage-4.5.rc1.tar, removing the jinja spkg, and applying install.diff and 4.5.rc1-deps.diff (the original deps.diff would no longer apply, so I rebased it).  I then typed \"make\", waited for the build to fail, applied trac_8316-remove_jinja.2.patch, and restarted the build.  The build was successfull, and all (long) tests passed.\n\nPositive review.",
    "created_at": "2010-07-16T02:57:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86649",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:5'></a>Thanks for fixing up gen_interpreters.py, your changes look fine (and the template output from the patched gen_interpreters.py using jinja2 is byte-for-byte identical to the previous output using jinja).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86651",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8316#issuecomment-86652",
    "user": "https://github.com/qed777"
}
```
