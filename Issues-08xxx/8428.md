...
```json
{
    "body": "Changed assignee from **@aghitza** to **@sagetrac-cturner**",
    "created_at": "2010-03-04T10:29:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8428",
    "type": "issue_comment",
...
Changed assignee from **@aghitza** to **@sagetrac-cturner**
...
```json
{
    "body": "Changed assignee from **@sagetrac-cturner** to **@aghitza**",
...
Changed assignee from **@sagetrac-cturner** to **@aghitza**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8428#event-96096"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8428#event-96097"
}
```
