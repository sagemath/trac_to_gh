...
```json
{
    "body": "**Attachment:** [8992_coercion_for_polynomial_quotient_rings.patch](https://github.com/sagemath/sage/files/ticket8992/8992_coercion_for_polynomial_quotient_rings.patch)\n\n`_element_constructor_` and `_coerce_map_from_` for polynomial quotient rings; may depend on #8800",
    "created_at": "2010-05-19T13:36:43Z",
    "issue": "https://github.com/sagemath/sage/issues/8992",
    "type": "issue_comment",
...
**Attachment:** [8992_coercion_for_polynomial_quotient_rings.patch](https://github.com/sagemath/sage/files/ticket8992/8992_coercion_for_polynomial_quotient_rings.patch)
...
```json
{
    "body": "**Attachment:** [8992_test_for_coerce_map_from.patch](https://github.com/sagemath/sage/files/ticket8992/8992_test_for_coerce_map_from.patch)\n\nAdditional doc test; to be applied after the previous patch",
    "created_at": "2010-05-19T14:07:20Z",
    "issue": "https://github.com/sagemath/sage/issues/8992",
    "type": "issue_comment",
...
**Attachment:** [8992_test_for_coerce_map_from.patch](https://github.com/sagemath/sage/files/ticket8992/8992_test_for_coerce_map_from.patch)
...
```json
{
    "body": "**Changing work issues** from \"rebase\" to \"rewrite\".",
    "created_at": "2012-03-11T21:47:56Z",
    "issue": "https://github.com/sagemath/sage/issues/8992",
    "type": "issue_comment",
...
**Changing work issues** from "rebase" to "rewrite".
...
```json
{
    "body": "**Changing work issues** from \"rewrite\" to \"rewrite, make polynomial division work\".",
...
**Changing work issues** from "rewrite" to "rewrite, make polynomial division work".
...
```json
{
    "body": "**Changing work issues** from \"rewrite, make polynomial division work\" to \"\".",
    "created_at": "2012-03-12T19:41:52Z",
    "issue": "https://github.com/sagemath/sage/issues/8992",
    "type": "issue_comment",
...
**Changing work issues** from "rewrite, make polynomial division work" to "".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8992#issuecomment-75861",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "**Changing work issues** from \"Convert string into base ring as a fail safe\" to \"Convert string into cover ring as a fail safe\".",
    "created_at": "2012-05-31T08:17:53Z",
    "issue": "https://github.com/sagemath/sage/issues/8992",
    "type": "issue_comment",
...
**Changing work issues** from "Convert string into base ring as a fail safe" to "Convert string into cover ring as a fail safe".
...
```json
{
    "body": "**Changing work issues** from \"Convert string into cover ring as a fail safe\" to \"Test that the result of conversion lives in the correct ring.\".",
...
**Changing work issues** from "Convert string into cover ring as a fail safe" to "Test that the result of conversion lives in the correct ring.".
...
```json
{
    "body": "**Attachment:** [trac8992_conversion_polynomial_quotient_ring.patch](https://github.com/sagemath/sage/files/ticket8992/trac8992_conversion_polynomial_quotient_ring.patch)\n\nNew patch, replacing the old patches",
    "created_at": "2012-05-31T08:39:25Z",
    "issue": "https://github.com/sagemath/sage/issues/8992",
    "type": "issue_comment",
...
**Attachment:** [trac8992_conversion_polynomial_quotient_ring.patch](https://github.com/sagemath/sage/files/ticket8992/trac8992_conversion_polynomial_quotient_ring.patch)
...
```json
{
    "body": "**Changing work issues** from \"Test that the result of conversion lives in the correct ring.\" to \"\".",
...
**Changing work issues** from "Test that the result of conversion lives in the correct ring." to "".
