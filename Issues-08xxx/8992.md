...
```json
{
    "body": "<a id='comment:1'></a>The quotient rings implement their own call method, instead of implementing _element_constructor_. I guess this is where I should start.",
    "created_at": "2010-05-19T10:54:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98738",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>The quotient rings implement their own call method, instead of implementing _element_constructor_. I guess this is where I should start.
...
```json
{
    "body": "<a id='comment:3'></a>A side remark: I just noticed that univariate quotient rings have no representation in Singular. I guess this will be on a different ticket, though.",
    "created_at": "2010-05-19T12:15:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98740",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>A side remark: I just noticed that univariate quotient rings have no representation in Singular. I guess this will be on a different ticket, though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98741",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98743",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98744",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>OK, the doc test is added (testing coercion from a polynomial ring to a quotient ring and between two quotient rings). Ready for review!",
    "created_at": "2010-05-19T14:08:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98745",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>OK, the doc test is added (testing coercion from a polynomial ring to a quotient ring and between two quotient rings). Ready for review!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98746",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98747",
...
```json
{
    "body": "<a id='comment:6'></a>Afraid this one has bitrotted -- it needs a rebase.",
    "created_at": "2012-03-11T19:32:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98748",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:6'></a>Afraid this one has bitrotted -- it needs a rebase.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98749",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98750",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98752",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98753",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The reason for my complaint about `y.divides(y)` is that the following example from a comment above would not work with the patch that I am now preparing:\n\n```\nsage: P.<x> = QQ[]\nsage: Q1 = P.quo([(x^2+1)^2*(x^2-3)])\nsage: R.<y> = P[]\nsage: Q3 = R.quo([(y^2+1)]); Q3\nUnivariate Quotient Polynomial Ring in ybar over Univariate Polynomial Ring in x over Rational Field with modulus y^2 + 1\nsage: Q3(Q1.gen())  # uses the lift from Q1 to P, which is the base ring of Q3\nx\n```\n\nThe problem is that the coercion framework is not able to find out whether `Q3` has a coerce map from `Q1`.\n\nSo, I guess I should add a \"try-except\" clause in `Q3._coerce_map_from_`, so that an error in division is caught and results in the answer \"no, there is no coerce map\".",
    "created_at": "2012-03-12T10:55:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98755",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>The reason for my complaint about `y.divides(y)` is that the following example from a comment above would not work with the patch that I am now preparing:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98757",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98758",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98759",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Sorry, I should have mentioned that the patch is for 5.0.beta7, not for 4.8.",
    "created_at": "2012-03-12T20:15:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98760",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:11'></a>Sorry, I should have mentioned that the patch is for 5.0.beta7, not for 4.8.
...
```json
{
    "body": "<a id='comment:12'></a>Findings of the patchbot: It does apply to 5.0.beta7, the tests pass (except for one test that seems unrelated with my patch).\n\nNevertheless, I had to modify my patch, because it has added trailing white space. It should be fixed now.\n\nApply trac8992_conversion_polynomial_quotient_ring.patch",
    "created_at": "2012-03-12T20:22:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98761",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>Findings of the patchbot: It does apply to 5.0.beta7, the tests pass (except for one test that seems unrelated with my patch).
...
```json
{
    "body": "<a id='comment:13'></a>There are a few typos in your patch: \"are no unique\", \"my lift an\", \"in principal\".",
    "created_at": "2012-03-12T21:01:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98762",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:13'></a>There are a few typos in your patch: "are no unique", "my lift an", "in principal".
...
```json
{
    "body": "<a id='comment:14'></a>Typos corrected, I hope!\n\nApply trac8992_conversion_polynomial_quotient_ring.patch",
    "created_at": "2012-03-13T06:21:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98763",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:14'></a>Typos corrected, I hope!
...
```json
{
    "body": "<a id='comment:15'></a>This looks pretty good to me.  The one things I worry about is that the result of sage_eval may not actually belong to the correct parent.  I would put a check to make sure that it actually does.  Then, I think we can mark this as positive review.",
    "created_at": "2012-05-28T22:03:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98764",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:15'></a>This looks pretty good to me.  The one things I worry about is that the result of sage_eval may not actually belong to the correct parent.  I would put a check to make sure that it actually does.  Then, I think we can mark this as positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98765",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98766",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98767",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Convert string into base ring as a fail safe\"",
    "created_at": "2012-05-31T08:11:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98768",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Convert string into base ring as a fail safe"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98770",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98771",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98772",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Mike, you are right, the wrong parent *can* occur:\n\n```\nsage: Q1('1')\n1\nsage: _.parent()\nInteger Ring\n```",
    "created_at": "2012-05-31T08:28:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98774",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:20'></a>Mike, you are right, the wrong parent *can* occur:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98775",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>OK, the two issues discussed in the previous posts are fixed and became doc tests. Needs review.\n\nApply trac8992_conversion_polynomial_quotient_ring.patch",
    "created_at": "2012-05-31T08:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98776",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:21'></a>OK, the two issues discussed in the previous posts are fixed and became doc tests. Needs review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98777",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98778",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98779",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98780",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98781",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98782",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98783",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8992#issuecomment-98784",
    "user": "https://github.com/jdemeyer"
}
```
