...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95869",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Ah, OK, that makes more sense. I suspected rank, as the first example I tried (and was surprised by) was 389a (which also has integral generators). \n\nI have implemented some of this (e.g. the computation of alpha) in my min-height stuff, and am hoping to get a ticket up for that soon.",
    "created_at": "2010-04-29T18:12:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95870",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>Ah, OK, that makes more sense. I suspected rank, as the first example I tried (and was surprised by) was 389a (which also has integral generators). 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95871",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95872",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95873",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95874",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Positive review.  (All the patch does is make a minor correction to a docstring.)",
    "created_at": "2010-04-30T20:38:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95875",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>Positive review.  (All the patch does is make a minor correction to a docstring.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95876",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95877",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8816#issuecomment-95878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
