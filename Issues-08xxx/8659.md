...
```json
{
    "body": "<a id='comment:9'></a>attachment:trac_8659-hold_powers.take2.patch should address the issues in[comment:7](#comment%3A7) at the cost of magically changing the type of the coefficients to rational.\n\nThe test\n\n```\nsage: 8^(-1/5)\n```\ndoes test the `__pow__` method of rationals, since the `__pow__` method of `Integer` casts the base to a rational and calls pow again.",
    "created_at": "2011-05-30T22:32:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8659",
    "type": "issue_comment",
...
<a id='comment:9'></a>attachment:trac_8659-hold_powers.take2.patch should address the issues in[comment:7](#comment%3A7) at the cost of magically changing the type of the coefficients to rational.
