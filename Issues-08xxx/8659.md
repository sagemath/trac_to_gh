...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96303"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96305"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96306"
}
```
...
```json
{
    "body": "<a id='comment:5'>Comment 5:</a>\nNow that we have the `hold()` function for symbolic expressions (#9879), we don't need `sage.symbolic.power_helper`. [attachment: trac_8659-hold_powers.patch.gz](https://github.com/sagemath/sage/files/ticket8659/trac_8659-hold_powers.patch.gz) removes this module, and fixes the problem described.\n\nThis ticket depends on #9879.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96311"
}
```
...
```json
{
    "body": "<a id='comment:9'>Comment 9:</a>\n[attachment: trac_8659-hold_powers.take2.patch.gz](https://github.com/sagemath/sage/files/ticket8659/trac_8659-hold_powers.take2.patch.gz) should address the issues in [comment:7](#comment%3A7) at the cost of magically changing the type of the coefficients to rational.\n\nThe test\n\n```\nsage: 8^(-1/5)\n```\ndoes test the `__pow__` method of rationals, since the `__pow__` method of `Integer` casts the base to a rational and calls pow again.",
    "created_at": "2011-05-30T22:32:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96312"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96313"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -79,4 +79,4 @@\n <boom>\n ```\n \n-Apply trac_8659-hold_powers.take2.patch\n+Apply [attachment: trac_8659-hold_powers.take3.patch.gz](https://github.com/sagemath/sage/files/ticket8659/trac_8659-hold_powers.take3.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96314"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96315"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96316"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96317"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96318"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96319"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71298",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71299",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71300",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71301",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71302",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:19'>Comment 19:</a>\nI rebased the patch to 5.0. Apply only [attachment: trac_8659-hold_powers.take4.patch..gz](https://github.com/sagemath/sage/files/ticket8659/trac_8659-hold_powers.take4.patch..gz)",
    "created_at": "2012-05-24T09:50:55Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71303",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96323"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71304",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71305",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71306",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71307",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71308",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8659#event-96327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8659#issuecomment-71309",
