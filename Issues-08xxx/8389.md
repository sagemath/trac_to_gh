...
```json
{
    "body": "<a id='comment:11'></a>\nOk, after talking with Nicolas I think I understand better what is going on and what should be done. Here is an attempt to streamline the implementation of `__getitem__` for general rings.\n\nI *didn't* leave a version `__getitem__` in `ring.Ring` after all, because virtually all rings properly initialize their category by now. The doctests pass, but there is at least one ring (namely `InfinityRing`) rings for which `R['x']` will fail while it used to work, and there may be more. Thoughts?\n\n---\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[b446839](http://git.sagemath.org/sage.git/commit/?id=b44683987105bbe07b596d6b2c3103e736aafa69)|`Improve Parent.__getitem__`|\n|[286eb3c](http://git.sagemath.org/sage.git/commit/?id=286eb3cd93fb229a44ee15aac738e1b56dab9b0a)|`Move __getitem__ from rings.ring to categories.ring`|\n|[57b55c3](http://git.sagemath.org/sage.git/commit/?id=57b55c3d86e37e6be0b54ca3ead8ad7c9c8d9a3c)|`Move is_zero from Ring to Rings.ParentMethods`|\n|[50b5381](http://git.sagemath.org/sage.git/commit/?id=50b53819a0f612c3dd92b6d924f016277ec5ca25)|`Make gen_name private`|\n|[f6a8daf](http://git.sagemath.org/sage.git/commit/?id=f6a8dafd9d3b92c50ea62acb59960db4a50116d1)|`Simplify ZZ.__getitem__`|\n|[0cf8043](http://git.sagemath.org/sage.git/commit/?id=0cf8043a49ce79ebd070a7eb0612b59a8aeb6eca)|`Clean up and simplify Rings.ParentMethods.__getitem__`|\n|[d3890c0](http://git.sagemath.org/sage.git/commit/?id=d3890c00bd0b89c14a06c7aae1fe38ee0b6c01df)|`Further simplify/robustify Rings.ParentMethods.__getitem__`|\n|[86dc8f9](http://git.sagemath.org/sage.git/commit/?id=86dc8f990141fcc8bff71f55f92a912f53f633f5)|`A schizophrenic __getitem__ for matrix rings`|\n|[0d960ec](http://git.sagemath.org/sage.git/commit/?id=0d960ecb4d96be2280ab04af7a9acdaf727fcb15)|`Clarify that polynomials over general rings are supported`|\n|[8241fd6](http://git.sagemath.org/sage.git/commit/?id=8241fd65d1552db6255e911260cf6c3524c6ec8c)|`coercion tutorial: Update some examples...`|",
    "created_at": "2014-01-31T20:33:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8389",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[d3e0119](http://git.sagemath.org/sage.git/commit/?id=d3e011961e08b5771eb16c78e6e5e31b42627311)|`Improve doc of Rings.EM.__getitem__ and related functions`|",
    "created_at": "2014-02-21T10:26:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8389",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[f4abe5d](http://git.sagemath.org/sage.git/commit/?id=f4abe5d7ff07f6b7c2f83c8a0d993465ec755fed)|`Fix broken link in doc of Rings.EM.__getitem__`|",
