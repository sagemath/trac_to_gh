...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94798",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This could be related to #4509.",
    "created_at": "2010-04-24T22:17:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94799",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>This could be related to #4509.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94801",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94805",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94806",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The new C code also has some new features, I think, like testing for outerplanarity, some sort of graph coloring stuff, etc.",
    "created_at": "2010-04-27T17:41:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94807",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:9'></a>The new C code also has some new features, I think, like testing for outerplanarity, some sort of graph coloring stuff, etc.
...
```json
{
    "body": "<a id='comment:12'></a>Previously, **every** long test run on planarity.pyx failed on my Ubuntu 9.04 x86/Prescott (gcc 4.3.3) (see http://groups.google.com/group/sage-release/msg/560824983a71627f).\n\nAfter applying the three patches on top of 4.4.2.rc0 (no rejects), all seems fine: \nRunning 100 times\n\n```\n./sage -t -long devel/sage/sage/graphs/planarity.pyx\n```\nno errors occurred. (Also `devel/sage/sage/graphs` passed.)\n\nJust for the record, the (second) patch contains two Eclipse project files (and some text files for comparing the output of tests I guess).\n\n-Leif",
    "created_at": "2010-05-15T23:03:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94809",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:12'></a>Previously, **every** long test run on planarity.pyx failed on my Ubuntu 9.04 x86/Prescott (gcc 4.3.3) (see http://groups.google.com/group/sage-release/msg/560824983a71627f).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94811",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94812",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Attachment [trac-8756-planarity-sage-changes.patch](tarball://root/attachments/some-uuid/ticket8756/trac-8756-planarity-sage-changes.patch) by @jasongrout created at 2010-05-16 03:38:12\n\nI've attached patches which have the necessary commit messages.  I also removed the Eclipse and example data files from the code.  The new second patch now also has the updated BSD license in the graphK4* files.\n\nThere is a problem compiling these patches on OSX (the C code has #include <malloc.h>, which is apparently a problem on OSX).",
    "created_at": "2010-05-16T03:38:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94813",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:14'></a>Attachment [trac-8756-planarity-sage-changes.patch](tarball://root/attachments/some-uuid/ticket8756/trac-8756-planarity-sage-changes.patch) by @jasongrout created at 2010-05-16 03:38:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94814",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>The patch just `#define`s `_XOPEN_SOURCE` (if not already defined) and includes `stdlib.h` instead of `malloc.h` in two files.\n\nNote that compiling with `-std=c99` (ISO C99) already implies presence of `stdlib.h` (and `malloc()` being defined *there*).\n\n(Apply only if needed, on top of the other three patches.)",
    "created_at": "2010-05-16T05:19:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94815",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:16'></a>The patch just `#define`s `_XOPEN_SOURCE` (if not already defined) and includes `stdlib.h` instead of `malloc.h` in two files.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94816",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94817",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>My comments above apply to the patch I've just uploaded/freshened (too).",
    "created_at": "2010-05-16T06:22:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94818",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:18'></a>My comments above apply to the patch I've just uploaded/freshened (too).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94819",
...
```json
{
    "body": "<a id='comment:19'></a>This newest patch allows the code to compile on OS X, as I have verified.",
    "created_at": "2010-05-27T23:32:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94820",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:19'></a>This newest patch allows the code to compile on OS X, as I have verified.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94821",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94822",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94823",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Looks good to me. Compiles on OS X, doesn't segfault on ubuntu32...",
    "created_at": "2010-05-27T23:40:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94824",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:20'></a>Looks good to me. Compiles on OS X, doesn't segfault on ubuntu32...
...
```json
{
    "body": "<a id='comment:21'></a>Funny, I just realized that *this* doctest failure seemed to have vanished in 4.4.3.alpha0 (again on Ubuntu 9.04 x86/32-bit, ptestlong), because there's now *another* test failing, but in `sage/graphs/generic_graph.py`.\n\nTesting only the single file `sage/graphs/planarity.pyx` on vanilla 4.4.3.alpha0, it reproducably shows up again.\n\nI'll apply this patch to 4.4.3.alpha0 later...",
    "created_at": "2010-05-28T02:47:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94825",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:21'></a>Funny, I just realized that *this* doctest failure seemed to have vanished in 4.4.3.alpha0 (again on Ubuntu 9.04 x86/32-bit, ptestlong), because there's now *another* test failing, but in `sage/graphs/generic_graph.py`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94826",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94827",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94828",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Merged into sage-4.4.3.alpha2",
    "created_at": "2010-06-03T04:05:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94829",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:23'></a>Merged into sage-4.4.3.alpha2
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8756#issuecomment-94830",
