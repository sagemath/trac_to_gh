...
```json
{
    "body": "<a id='comment:2'></a>A few doctests don't pass, including one troubling one that seems to indicate that `@`cached_method isn't computing the right values in a simple case.  In the cases in the timings above, the right values are calculated.",
    "created_at": "2010-03-26T03:57:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92042",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>A few doctests don't pass, including one troubling one that seems to indicate that `@`cached_method isn't computing the right values in a simple case.  In the cases in the timings above, the right values are calculated.
...
```json
{
    "body": "<a id='comment:4'></a>Might it not be better for `@`cached_method to store its cache as an attribute of the instance object, rather than having a single cache which stores the values for all instances of that class?\n\nE.g. the following code works for methods with no arguments:\n\n```\ndef fast_cached_method(func):\n    def fast_func(some_instance):\n        try:\n            return getattr(some_instance, '_cache_' + func.__name__)\n        except AttributeError:\n            result = func(some_instance)\n            foo_instance.__dict__['_cache_' + func.__name__] = result\n            return result\n    return fast_func\n```\n\nI tested this and it's only about 1.5 times slower than doing the caching \"by hand\", while your speeded-up version above is still about 40 times slower.\n\nDavid",
    "created_at": "2010-03-26T16:36:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92043",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:4'></a>Might it not be better for `@`cached_method to store its cache as an attribute of the instance object, rather than having a single cache which stores the values for all instances of that class?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92044",
...
```json
{
    "body": "<a id='comment:5'></a>I just noticed that the patch does not apply anymore. I am trying to work on cached_function and cached_method anyway, so, I hope that I can soon submit a new patch.",
    "created_at": "2011-01-07T14:00:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92045",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>I just noticed that the patch does not apply anymore. I am trying to work on cached_function and cached_method anyway, so, I hope that I can soon submit a new patch.
...
```json
{
    "body": "Changing work_issues from \"\" to \"Patch doesn't apply\"",
    "created_at": "2011-01-07T14:00:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92046",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Patch doesn't apply"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92047",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92048",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92049",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"Patch doesn't apply\" to \"\"",
    "created_at": "2011-01-09T20:55:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92051",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "Patch doesn't apply" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92052",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92053",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92056",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>In the patch version that I've just attached, I also inserted the documentation of `sage.misc.cachedfunc` and (after cleaning the documentation) of `sage.misc.function_mangling` into the reference manual. I think the documentation looks nice, but perhaps the referee can have a look on it as well.",
    "created_at": "2011-01-10T09:51:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92057",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:11'></a>In the patch version that I've just attached, I also inserted the documentation of `sage.misc.cachedfunc` and (after cleaning the documentation) of `sage.misc.function_mangling` into the reference manual. I think the documentation looks nice, but perhaps the referee can have a look on it as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92058",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Apply trac8611_cached_method_overhaul.patch\n\n(for the patchbot)",
    "created_at": "2011-01-16T16:03:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92060",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:14'></a>Apply trac8611_cached_method_overhaul.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92064",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92065",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Please use line breaks in the commit message if it is so long.  Make sure the first line is a short description of the patch with the ticket number.  Following lines can contain a longer description.",
    "created_at": "2011-01-23T13:34:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92066",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>Please use line breaks in the commit message if it is so long.  Make sure the first line is a short description of the patch with the ticket number.  Following lines can contain a longer description.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92067",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92068",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Attachment [trac8611_cached_method_overhaul-fixed.patch](tarball://root/attachments/some-uuid/ticket8611/trac8611_cached_method_overhaul-fixed.patch) by @loefflerd created at 2011-01-23 15:17:01\n\nDone.",
    "created_at": "2011-01-23T15:17:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92069",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:19'></a>Attachment [trac8611_cached_method_overhaul-fixed.patch](tarball://root/attachments/some-uuid/ticket8611/trac8611_cached_method_overhaul-fixed.patch) by @loefflerd created at 2011-01-23 15:17:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92070",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92071",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92072",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92073",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>For the record, a related thread:\n\n- http://groups.google.com/group/sage-devel/browse_thread/thread/6607a3919c619345",
    "created_at": "2011-01-28T10:34:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8611#issuecomment-92074",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:22'></a>For the record, a related thread:
