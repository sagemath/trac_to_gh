...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8660#event-99415"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8660#event-99416"
}
```
...
```json
{
    "body": "Changed assignee from **mvngu** to **@hedtke**",
...
Changed assignee from **mvngu** to **@hedtke**
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,14 @@\n A German translation of the Sage installation guide is complete. See [sage-support](http://groups.google.com/group/sage-support/browse_thread/thread/cc2232f6cba3386f) for background information. What needs to be done now is to use Sphinx for the markup so that the translated guide could be included in the Sage standard documentation. Attached is the ODF version of the German translation.\n \n It's very likely that #8698 would be merged first, prior to merging the current ticket. In that case, the patch on this ticket would need to be rebased against #8698.\n+\n+---\n+\n+**Apply**\n+1. [attachment: trac_8660_restart.patch.gz](https://github.com/sagemath/sage/files/ticket8660/trac_8660_restart.patch.gz)\n+2. [attachment: trac_8660_restart_p1.patch.gz](https://github.com/sagemath/sage/files/ticket8660/trac_8660_restart_p1.patch.gz)\n+3. [attachment: trac_8660_restart_p2.patch.gz](https://github.com/sagemath/sage/files/ticket8660/trac_8660_restart_p2.patch.gz)\n+to the **Sage library**.\n+\n+For Sage versions prior to 4.7.1.alpha2, you'll also have to apply the patches from #9725.\n+\n``````\n",
    "created_at": "2011-07-19T21:52:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8660",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8660#issuecomment-71374",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8660#issuecomment-71375",
    "user": "https://github.com/mkoeppe"
}
```
