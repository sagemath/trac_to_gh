...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8400#event-95737"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8400#event-95738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8400#issuecomment-68087",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8400#issuecomment-68088",
    "user": "https://github.com/mwhansen"
}
```
