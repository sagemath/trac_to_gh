...
<a id='comment:27'></a>Replying to [comment:26 davidloeffler]:
> All seems to be well.
...
<a id='comment:29'></a>Replying to [comment:28 davidloeffler]:
> Hi John,
> 
