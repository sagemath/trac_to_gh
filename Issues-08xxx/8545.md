...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8545#issuecomment-69999",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8545#issuecomment-70000",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8545#event-97899"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8545#event-97900"
}
```
