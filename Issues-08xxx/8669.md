...
archive/attachments_011235.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_8669-download.2.patch](https://github.com/sagemath/sage/files/ticket8669/trac_8669-download.2.patch)\n\nscripts repo",
    "created_at": "2010-04-10T23:46:55Z",
    "issue": "https://github.com/sagemath/sage/issues/8669",
    "type": "issue_comment",
...
**Attachment:** [trac_8669-download.2.patch](https://github.com/sagemath/sage/files/ticket8669/trac_8669-download.2.patch)
...
archive/attachments_011236.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_8669-download.patch](https://github.com/sagemath/sage/files/ticket8669/trac_8669-download.patch)\n\nscripts repo (same as other patch)",
    "created_at": "2010-04-10T23:47:11Z",
    "issue": "https://github.com/sagemath/sage/issues/8669",
    "type": "issue_comment",
...
**Attachment:** [trac_8669-download.patch](https://github.com/sagemath/sage/files/ticket8669/trac_8669-download.patch)
...
archive/attachments_011237.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:5'></a>\n**Attachment:** [trac_8669-download.3.patch](https://github.com/sagemath/sage/files/ticket8669/trac_8669-download.3.patch)\n\nTo the release manager: please delete all but \"trac_8669-download.patch\".",
    "created_at": "2010-04-10T23:47:47Z",
    "issue": "https://github.com/sagemath/sage/issues/8669",
    "type": "issue_comment",
