...
archive/attachments_011663.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_8983.patch](https://github.com/sagemath/sage/files/ticket8983/trac_8983.patch)\n\nmake erf(0) return 0",
    "created_at": "2012-02-12T06:34:43Z",
    "issue": "https://github.com/sagemath/sage/issues/8983",
    "type": "issue_comment",
...
**Attachment:** [trac_8983.patch](https://github.com/sagemath/sage/files/ticket8983/trac_8983.patch)
...
archive/attachments_011664.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_8983_v2.patch](https://github.com/sagemath/sage/files/ticket8983/trac_8983_v2.patch)\n\nmake erf(0) return 0",
    "created_at": "2012-02-13T04:33:25Z",
    "issue": "https://github.com/sagemath/sage/issues/8983",
    "type": "issue_comment",
...
**Attachment:** [trac_8983_v2.patch](https://github.com/sagemath/sage/files/ticket8983/trac_8983_v2.patch)
...
archive/attachments_011665.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_8983_v3.patch](https://github.com/sagemath/sage/files/ticket8983/trac_8983_v3.patch)\n\nmake erf(0) return 0, with added doctests and simplified branching in `_eval_`",
    "created_at": "2012-02-14T16:53:00Z",
    "issue": "https://github.com/sagemath/sage/issues/8983",
    "type": "issue_comment",
...
**Attachment:** [trac_8983_v3.patch](https://github.com/sagemath/sage/files/ticket8983/trac_8983_v3.patch)
