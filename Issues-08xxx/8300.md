...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86338",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86339",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Looks good, applies to 4.3.5 (with a small amount of fuzz).  Tests in sage/rings all pass.  Docs build and look good.  I did some random testing of my own and the results seem fine.\n\nSmall question:  why does algdep? not display the docstring?  algdep?? works fine though.",
    "created_at": "2010-04-05T16:42:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86340",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>Looks good, applies to 4.3.5 (with a small amount of fuzz).  Tests in sage/rings all pass.  Docs build and look good.  I did some random testing of my own and the results seem fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86341",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86342",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86343",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86344",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86345",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8300#issuecomment-86346",
    "user": "https://github.com/jhpalmieri"
}
```
