...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_8963_row_stabilizer.patch](https://github.com/sagemath/sage/files/ticket8963/trac_8963_row_stabilizer.patch) by @jdchristensen created at 2010-05-14 15:41:34\n\nThe attached patch also adds a method called entries() which returns a list containing the entries of the tableau.  All tests pass and coverage for tableau.py is 100%.  The patch is based on sage-4.4.",
    "created_at": "2010-05-14T15:41:34Z",
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75351",
    "user": "https://github.com/jdchristensen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75352",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75353",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75354",
