...
archive/attachments_011270.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_8991-mq-syntax-for-developers.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket8991/trac_8991-mq-syntax-for-developers.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8991#issuecomment-75815",
    "user": "https://trac.sagemath.org/admin/accounts/users/alubovsky"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8991#event-65029"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8991#event-65030"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8991#event-65031"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8991#issuecomment-75816",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8991#issuecomment-75817",
    "user": "https://trac.sagemath.org/admin/accounts/users/alubovsky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8991#issuecomment-75818",
    "user": "https://trac.sagemath.org/admin/accounts/users/alubovsky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8991#issuecomment-75819",
    "user": "https://trac.sagemath.org/admin/accounts/users/alubovsky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8991#issuecomment-75820",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8991#issuecomment-75821",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8991#event-65032"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8991#event-65033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8991",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8991#event-65034"
}
```
