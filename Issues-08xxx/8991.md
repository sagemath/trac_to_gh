...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100856"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100862"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8991#issuecomment-75860",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8991#issuecomment-75861",
...
```json
{
    ...
    "milestone_title": "sage-4.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8991",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8991#event-100865"
}
```
