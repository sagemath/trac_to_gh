...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85889",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85890",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>#7619 now have a positive review... so this patch can now get reviewed",
    "created_at": "2010-03-02T10:19:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85891",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:2'></a>#7619 now have a positive review... so this patch can now get reviewed
...
```json
{
    "body": "<a id='comment:3'></a>Looked at the patch. Since it is a documentation-only patch, all tests passed. I made sure that the patch of ticket #7619 was applied first. I still made a few minor changes.\n\n1. I replaced \"pyhon\" by \"Python\" everywhere I found it.\n\n2. I added \":\" after a NOTE block that was not appearing in the documentation.\n\n3. I replaced strange unicode characters by \" at the end of S\u00e9bastien's patch.\n\n4. I replaced the latex output of \"w.\" by a code-font \"w.\"\n\nIf S\u00e9bastien agrees with my changes, I allow him to set the ticket to \"positive review\".",
    "created_at": "2010-03-03T21:11:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85892",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

<a id='comment:3'></a>Looked at the patch. Since it is a documentation-only patch, all tests passed. I made sure that the patch of ticket #7619 was applied first. I still made a few minor changes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85893",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85894",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85895",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85896",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Thanks for the review Alex. I don't know where those strange characters came from... I added one patch to fix two of those characters (I really wanted ```` not \").\n\nSince I my patch fix only two characters in the doc and because I agree with your changes and because your gave a positive review to my first patch, I think I can change the status of this ticket to positive review.",
    "created_at": "2010-03-03T23:32:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85897",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>Thanks for the review Alex. I don't know where those strange characters came from... I added one patch to fix two of those characters (I really wanted ```` not ").
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85898",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85899",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8266#issuecomment-85900",
    "user": "https://github.com/mwhansen"
}
```
