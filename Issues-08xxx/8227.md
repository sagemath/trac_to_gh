...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8227#event-93325"
}
```
...
```json
{
    "body": "Changed assignee from **@aghitza** to **abmasse**",
...
Changed assignee from **@aghitza** to **abmasse**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8227",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8227#issuecomment-65554",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8227",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8227#issuecomment-65555",
    "user": "https://github.com/sagetrac-mvngu"
}
```
