...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_8092-init_sage.patch](tarball://root/attachments/some-uuid/ticket8092/trac_8092-init_sage.patch) by @qed777 created at 2010-01-27 13:09:54\n\nThe attached patch seems to work for me.\u00a0 `DOT_SAGE/init.sage` is equivalent to `os.environ['SAGE_STARTUP_FILE']` (see `SAGE_LOCAL/bin/ipy_profile_sage.py`).",
    "created_at": "2010-01-27T13:09:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8092",
    "type": "issue_comment",
...
<a id='comment:1'></a>Attachment [trac_8092-init_sage.patch](tarball://root/attachments/some-uuid/ticket8092/trac_8092-init_sage.patch) by @qed777 created at 2010-01-27 13:09:54
