...
```json
{
    "body": "<a id='comment:1'></a>This bug appears to be gone in sage-4.6.  I'm not sure at what point it was fixed, but it was most likely when Martin Raum or David Loeffler touched the code recently.\n\nIn any case, I am attaching a mini-patch with a doctest that verifies that it is fixed.",
...
<a id='comment:1'></a>This bug appears to be gone in sage-4.6.  I'm not sure at what point it was fixed, but it was most likely when Martin Raum or David Loeffler touched the code recently.
...
```json
{
    "body": "<a id='comment:2'></a>cc-ing Martin and David in case they have more info about this.",
...
<a id='comment:2'></a>cc-ing Martin and David in case they have more info about this.
...
```json
{
    "body": "<a id='comment:3'></a>This has been indeed fixed by David from what I see in googlecodes, and he also added the doctest right before yours. It's a good a idea to introduce another explicit test and it won't cost much time. So this gets a positive review.",
    "created_at": "2010-11-05T15:47:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8291",
    "type": "issue_comment",
...
<a id='comment:3'></a>This has been indeed fixed by David from what I see in googlecodes, and he also added the doctest right before yours. It's a good a idea to introduce another explicit test and it won't cost much time. So this gets a positive review.
