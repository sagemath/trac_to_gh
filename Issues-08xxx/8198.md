...
```json
{
    "body": "<a id='comment:1'></a>I must admit that I have not searched through the tracs to see if this is a duplicate. Sorry.\n\nResolving the bug would result in the resolution of #4656, too, I believe.",
    "created_at": "2010-02-05T22:53:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84781",
    "user": "https://github.com/categorie"
}
```

<a id='comment:1'></a>I must admit that I have not searched through the tracs to see if this is a duplicate. Sorry.
...
```json
{
    "body": "<a id='comment:2'></a>I found this bug also, while working on #9457.  After a fair bit of struggling with elliptic curve code, I now think this is a significant part of the problem.\n\nI noticed the following also; I can't tell if it's the same bug or not.\n\n```\nsage: R = QQ.completion(5,5)\nsage: P.<T> = R[]\nsage: Q.<T> = R[[]]\nsage: P(R(0).add_bigoh(-1))\n(O(5^-1))\nsage: Q(R(0).add_bigoh(-1))\n0\nsage: P(R(0).add_bigoh(2))\n(O(5^2))\nsage: Q(R(0).add_bigoh(2))\n0\nsage: Q(R(1).add_bigoh(2))\n1 + O(5^2)\nsage: Q(R(1).add_bigoh(-1))\n0\nsage: Q(R(1/25).add_bigoh(-1))\n5^-2 + O(5^-1)\n```",
    "created_at": "2010-08-03T23:24:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84782",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:2'></a>I found this bug also, while working on #9457.  After a fair bit of struggling with elliptic curve code, I now think this is a significant part of the problem.
...
```json
{
    "body": "<a id='comment:3'></a>Replying to [niles](#comment%3A2):\n> I noticed the following also; I can't tell if it's the same bug or not.\n\n\noh, this seems to be the same as #4656",
    "created_at": "2010-08-03T23:36:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84783",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:3'></a>Replying to [niles](#comment%3A2):
> I noticed the following also; I can't tell if it's the same bug or not.
...
```json
{
    "body": "<a id='comment:4'></a>I narrowed down the last issue above. (vector calls Sequence which calls list):\n\n```\nsage: R = Qp(5,5)\nsage: x = R(5).add_bigoh(1)\nsage: list(x)\n[0]\n```\n\nagain the element is set to zero. The problem here is different than the original case. In fact list(x) should raise an error, just like list(0) does. \n\n```\nsage: list([x,x]) \n[O(5), O(5)]\n```\n\nworks correctly. So this is really about matrix multiplication.",
    "created_at": "2011-01-27T11:32:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84784",
    "user": "https://github.com/categorie"
}
```

<a id='comment:4'></a>I narrowed down the last issue above. (vector calls Sequence which calls list):
...
```json
{
    "body": "<a id='comment:7'></a>Note the very last bug, is not longer a problem in 6.1 as `vv = vector(x)`\nraises the error\n `TypeError: this local element is not iterable`\nand that should be ok.",
    "created_at": "2014-02-02T15:06:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84785",
    "user": "https://github.com/categorie"
}
```

<a id='comment:7'></a>Note the very last bug, is not longer a problem in 6.1 as `vv = vector(x)`
raises the error
 `TypeError: this local element is not iterable`
and that should be ok.
...
```json
{
    "body": "<a id='comment:8'></a>I don't even understand where vector * matrix multiplication is implemented...",
    "created_at": "2014-02-02T15:39:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84786",
    "user": "https://github.com/categorie"
}
```

<a id='comment:8'></a>I don't even understand where vector * matrix multiplication is implemented...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84787",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84788",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84789",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84790",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84791",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84792",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84793",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84794",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Thanks; hopefully this goes some way towards being able to fix the related tickets #4656, #5075 and #9457...",
    "created_at": "2014-04-11T17:03:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84796",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:13'></a>Thanks; hopefully this goes some way towards being able to fix the related tickets #4656, #5075 and #9457...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84797",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8198#issuecomment-84798",
    "user": "https://github.com/vbraun"
}
```
