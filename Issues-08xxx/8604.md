...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91959",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91961",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91963",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I just updated the patch. There was issue with the ordering of many list of factors. I added many ``sorted`` which should fix uniformize the results of doctests and not depend on the machine used anymore.",
    "created_at": "2010-04-13T18:28:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91964",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:5'></a>I just updated the patch. There was issue with the ordering of many list of factors. I added many ``sorted`` which should fix uniformize the results of doctests and not depend on the machine used anymore.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91965",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91966",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91967",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91968",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91969",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I agree with your suggestions. I changed the patch accordingly (see new patch attached).\n\nNeeds review!",
    "created_at": "2010-04-18T19:31:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91970",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:7'></a>I agree with your suggestions. I changed the patch accordingly (see new patch attached).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91971",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91972",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91974",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91975",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8604#event-20802"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91976",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Please see #9589 for doctest failures that may stem from this ticket.",
    "created_at": "2010-07-24T02:49:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8604#issuecomment-91977",
    "user": "https://github.com/qed777"
}
```

<a id='comment:10'></a>Please see #9589 for doctest failures that may stem from this ticket.
