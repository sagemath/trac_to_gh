...
```json
{
    "body": "<a id='comment:1'></a>The XGCD issue needs some work w.r.t. doctests (but not only, see below), maybe David Harvey has something done already in this direction when preparing the optional \"true\" GMP spkg he maintains. (I don't find the thread right now, but I seem to remember he said something in this direction).\n\nSnippet from a private communication by Bill Hart (MPIR upstream):\n\n```\nMPIR 2.0.1 will be required for Sage because it brings the gcdext\nnormalisation in line with GMP's (which is what Pari needs). I think\npeople have skipped MPIR 1.3.0 in favour of waiting for MPIR 2.0.1.\nWe're in the release phase of MPIR 2.0.1 ...\n```\nAlso note that as soon as this ticket here is closed, we should mark #8455 as invalid.",
    "created_at": "2010-05-19T09:55:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92891",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:1'></a>The XGCD issue needs some work w.r.t. doctests (but not only, see below), maybe David Harvey has something done already in this direction when preparing the optional "true" GMP spkg he maintains. (I don't find the thread right now, but I seem to remember he said something in this direction).
...
```json
{
    "body": "<a id='comment:2'></a>This needs to be handled with #5847 and should take care of #9522 at the same time.",
    "created_at": "2010-08-17T18:33:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92892",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>This needs to be handled with #5847 and should take care of #9522 at the same time.
...
```json
{
    "body": "<a id='comment:4'></a>I've put an spkg at http://sage.math.washington.edu/home/mhansen/mpir-2.1.1.spkg\n\nInterestingly, I did not get any of the failures listed above.",
    "created_at": "2010-08-18T06:22:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92893",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>I've put an spkg at http://sage.math.washington.edu/home/mhansen/mpir-2.1.1.spkg
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92894",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92895",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92896",
...
```json
{
    "body": "<a id='comment:8'></a>Dave, as it seems you're addicted to testing, you could also test *this* new spkg (e.g. on Solaris, OpenSolaris)... ;-)",
    "created_at": "2010-08-26T23:08:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92898",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>Dave, as it seems you're addicted to testing, you could also test *this* new spkg (e.g. on Solaris, OpenSolaris)... ;-)
...
```json
{
    "body": "<a id='comment:9'></a>I guess unless we bump the patch levels of all packages that depend on GMP/MPIR (and ECM), this package breaks upgrading Sage (at least with the current upgrade process), due to interface change (in conjunction with shared library versioning).\n\nThe same applies to testing this package (and/with ECM 6.3 from #5847); one has to either build from scratch or delete `spkg/installed/<package-name>` for all packages that depend on those two.\n\nPerhaps one could simply (conditionally) do the latter in `spkg/install`, which also gets updated during upgrade.",
    "created_at": "2010-08-27T01:41:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92899",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:9'></a>I guess unless we bump the patch levels of all packages that depend on GMP/MPIR (and ECM), this package breaks upgrading Sage (at least with the current upgrade process), due to interface change (in conjunction with shared library versioning).
...
```json
{
    "body": "<a id='comment:10'></a>Defining `SAGE_SPKG` to `sage-spkg -f` in `spkg/standard/deps` should *in principle* also work, but doesn't... apparently because *not really all* shared libraries that use `libgmpxx.so` get rebuilt, so some still refer to the old, deleted `libgmpxx.so.3`.\n\n---\n\nRebuilding Sage 4.5.3.alpha2 with MPIR 2.1.1 and ECM 6.3 *from scratch* worked on Ubuntu 10.04 x86_64 (parallel build with 32 jobs); `ptestlong` passed all tests.",
    "created_at": "2010-08-27T03:32:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92900",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:10'></a>Defining `SAGE_SPKG` to `sage-spkg -f` in `spkg/standard/deps` should *in principle* also work, but doesn't... apparently because *not really all* shared libraries that use `libgmpxx.so` get rebuilt, so some still refer to the old, deleted `libgmpxx.so.3`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92901",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92902",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92903",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92904",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>The problem of ticket #9837 has been fixed in MPIR svn, it was purely a bug in MPIR 2.1.1.",
    "created_at": "2010-09-04T21:17:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92905",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>The problem of ticket #9837 has been fixed in MPIR svn, it was purely a bug in MPIR 2.1.1.
...
```json
{
    "body": "<a id='comment:16'></a>Please upgrade to MPIR 2.1.2, where #9837 is fixed.",
    "created_at": "2010-09-05T12:20:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92906",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>Please upgrade to MPIR 2.1.2, where #9837 is fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92907",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Apparently [they've released MPIR 2.1.2](http://www.mpir.org/) with just this bug fixed today.\n\nHaven't tested that yet.",
    "created_at": "2010-09-05T17:11:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92908",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:18'></a>Apparently [they've released MPIR 2.1.2](http://www.mpir.org/) with just this bug fixed today.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92909",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>FLINT also needs to be updated (from 1.5.0[.p5] to 1.5.2) to work with the new MPIR; otherwise the test suite won't build. See #9858.",
    "created_at": "2010-09-06T09:57:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92910",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:21'></a>FLINT also needs to be updated (from 1.5.0[.p5] to 1.5.2) to work with the new MPIR; otherwise the test suite won't build. See #9858.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92912",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>W.r.t. the race condition, cf. http://trac.sagemath.org/sage_trac/ticket/9343#comment:324\n\n(I currently don't recall if I reported this elsewhere, or my results of inspecting the Makefile... :( )",
    "created_at": "2010-10-22T07:51:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92914",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:25'></a>W.r.t. the race condition, cf. http://trac.sagemath.org/sage_trac/ticket/9343#comment:324
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92916",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>I would have taken the latest version anyway...\n\n---\n\nA trivial fix for the executable stack issue is to add the following to `spkg-install`:\n\n```sh\ncase \"$UNAME\" in\n    Linux) # implies a GNU linker\n        LDFLAGS=\"$LDFLAGS -Wl,z,noexecstack\"\n        # already exported by sage-env\n        ;;\n    # perhaps other platforms, too\nesac\n```",
    "created_at": "2010-11-03T23:39:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92917",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:27'></a>I would have taken the latest version anyway...
...
```json
{
    "body": "<a id='comment:28'></a>Copy and paste with typos included... It should of course be `-Wl,-z,noexecstack`.",
    "created_at": "2010-11-04T02:08:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92918",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:28'></a>Copy and paste with typos included... It should of course be `-Wl,-z,noexecstack`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92919",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92920",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92921",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92922",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92923",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92925",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Ooops, I just noticed the hint to rerun `make` if the **install** failed is in the wrong place (it is actually shown if the **build** failed), but that's IMHO a minor issue I'll perhaps fix later.",
    "created_at": "2010-11-04T07:05:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92926",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:30'></a>Ooops, I just noticed the hint to rerun `make` if the **install** failed is in the wrong place (it is actually shown if the **build** failed), but that's IMHO a minor issue I'll perhaps fix later.
...
```json
{
    "body": "<a id='comment:31'></a>Built and tested on sage.math.washington.edu without problems.",
    "created_at": "2010-11-04T15:49:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92927",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>Built and tested on sage.math.washington.edu without problems.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92928",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92929",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92930",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92931",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92933",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>P.S.: My patch shouldn't conflict with #10094, only the line numbers will change.",
    "created_at": "2010-11-04T20:33:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92934",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:35'></a>P.S.: My patch shouldn't conflict with #10094, only the line numbers will change.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92935",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92936",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92937",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92938",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>Replying to [leif](#comment%3A34):\n> Can you include the patch to the Sage library?\n\n\nNow it should be also merged, same spkg file.",
    "created_at": "2010-11-04T22:50:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92939",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:40'></a>Replying to [leif](#comment%3A34):
> Can you include the patch to the Sage library?
...
```json
{
    "body": "<a id='comment:41'></a>Does the problem in [comment 22](#comment%3A22) occur during `$MAKE install`?",
    "created_at": "2010-11-04T23:02:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92940",
    "user": "https://github.com/qed777"
}
```

<a id='comment:41'></a>Does the problem in [comment 22](#comment%3A22) occur during `$MAKE install`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92943",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92944",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>Any reason to keep\n\n```sh\n    SAGE_CONF_OPTS=\"--enable-shared --disable-static\"\n```\n(i.e., why not build the static library, too)?",
    "created_at": "2010-11-05T03:07:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92945",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:46'></a>Any reason to keep
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92947",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92948",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92949",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92950",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92951",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92952",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92953",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92954",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>P.S.: Except for the filename, test / installation instructions remain the same. (See [above](http://trac.sagemath.org/sage_trac/ticket/8664#comment:33).)",
    "created_at": "2010-11-06T02:11:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92956",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:55'></a>P.S.: Except for the filename, test / installation instructions remain the same. (See [above](http://trac.sagemath.org/sage_trac/ticket/8664#comment:33).)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92958",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92960",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92961",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92962",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:61'></a>Replying to [leif](#comment%3A53):\n> Replying to [leif](#comment%3A52):\n> > Replying to [dimpase](#comment%3A50):\n> > > Replying to [leif](#comment%3A49):\n> > > > Replying to [leif](#comment%3A48):\n> > > > > Would adding `-Wa,-force_cpusubtype_ALL` on MacOS PPCs work?\n\n> \n> P.S.: Does Apple's XCode `gcc` understand `-force_cpusubtype_ALL` (i.e., without `-Wa,`)?\n\n\nyes Apple's gcc 4.2.1 does. As well as gcc-4.0.1, which is probably more usual on OSX PPC...",
    "created_at": "2010-11-06T06:27:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92963",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:61'></a>Replying to [leif](#comment%3A53):
> Replying to [leif](#comment%3A52):
> > Replying to [dimpase](#comment%3A50):
> > > Replying to [leif](#comment%3A49):
> > > > Replying to [leif](#comment%3A48):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92964",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:62'></a>**Updated p1 spkg: http://spkg-upload.googlecode.com/files/mpir-2.1.3.p1.spkg (same place)**\n\n**md5sum:** `08dfaa24301ba4e4481cfbbbc77156b3  mpir-2.1.3.p1.spkg`\n\nNow also recognizes PPCs giving \"`Power*`\" as `uname -m`.",
    "created_at": "2010-11-06T06:28:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92965",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:62'></a>**Updated p1 spkg: http://spkg-upload.googlecode.com/files/mpir-2.1.3.p1.spkg (same place)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92967",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92968",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92969",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92970",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92972",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92974",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:69'></a>P.S.: Could you attach the full MPIR build log, or its `make install` part?",
    "created_at": "2010-11-06T09:02:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92975",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:69'></a>P.S.: Could you attach the full MPIR build log, or its `make install` part?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92976",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92977",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92978",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92979",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:74'></a>I asked Bill by email about Leif's comments above.  Please see [mpir-devel](http://groups.google.com/group/mpir-devel/browse_thread/thread/892ce7f3c9c93b9f).",
    "created_at": "2010-11-06T20:22:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92980",
    "user": "https://github.com/qed777"
}
```

<a id='comment:74'></a>I asked Bill by email about Leif's comments above.  Please see [mpir-devel](http://groups.google.com/group/mpir-devel/browse_thread/thread/892ce7f3c9c93b9f).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92982",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92983",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92984",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92985",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:79'></a>Replying to [dimpase](#comment%3A76):\n> and with tweaked ECM spkg (see #5847).\n\n\nWhich \"tweaked\" ECM spkg do you mean?",
    "created_at": "2010-11-09T08:35:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92986",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:79'></a>Replying to [dimpase](#comment%3A76):
> and with tweaked ECM spkg (see #5847).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92987",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92988",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92989",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92990",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92991",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92992",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92993",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92994",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:85'></a>Unmerged from sage-4.6.1.alpha1 because of the problems with the ECM package, see #10252.",
    "created_at": "2010-11-12T13:08:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92995",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:85'></a>Unmerged from sage-4.6.1.alpha1 because of the problems with the ECM package, see #10252.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92996",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-92999",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93000",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:94'></a>The old mpir spkg compiles with -march=<...>, the new spkg here doesn't do that.  That is definately a bug.",
    "created_at": "2011-01-12T19:06:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93002",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:94'></a>The old mpir spkg compiles with -march=<...>, the new spkg here doesn't do that.  That is definately a bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93003",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93004",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93005",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93006",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93007",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93008",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93009",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:99'></a>Probably, yes, it should be rebased.\n\nBut also the `CFLAGS` issue still needs to be fixed...",
    "created_at": "2011-04-18T16:51:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93010",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:99'></a>Probably, yes, it should be rebased.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93011",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Oh, not to mention #9858 (FLINT). :)\n\n(And I guess MPFR also still should be upgraded, an MPC spkg provided...)",
    "created_at": "2011-04-18T17:42:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93012",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Oh, not to mention #9858 (FLINT). :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93014",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>We really need to get MPIR updated in Sage.  What's the status of this?",
    "created_at": "2011-05-09T18:19:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93015",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>We really need to get MPIR updated in Sage.  What's the status of this?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93016",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93017",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93018",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93019",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.1.alpha4.patch](tarball://root/attachments/some-uuid/ticket8664/trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.1.alpha4.patch) by @williamstein created at 2011-07-18 05:21:21\n\nMPIR 2.4.0 has now been out over a month:  http://mpir.org/\nWe really, really need to get this upgraded.",
    "created_at": "2011-07-18T05:21:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93020",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>Attachment [trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.1.alpha4.patch](tarball://root/attachments/some-uuid/ticket8664/trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.1.alpha4.patch) by @williamstein created at 2011-07-18 05:21:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93022",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:0'></a>Attachment [mpir-2.1.3.p1-mpir-2.1.3.p2.diff](tarball://root/attachments/some-uuid/ticket8664/mpir-2.1.3.p1-mpir-2.1.3.p2.diff) by @nexttime created at 2011-07-18 08:33:17\n\nI've attached a \"preview\" diff of the p2 in case that makes anyone happy...",
    "created_at": "2011-07-18T08:33:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93023",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:0'></a>Attachment [mpir-2.1.3.p1-mpir-2.1.3.p2.diff](tarball://root/attachments/some-uuid/ticket8664/mpir-2.1.3.p1-mpir-2.1.3.p2.diff) by @nexttime created at 2011-07-18 08:33:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93025",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93026",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93027",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93028",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93029",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93030",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93031",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93033",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93034",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:117'></a>Replying to [dimpase](#comment%3A115):\n> Replying to [leif](#comment%3A114):\n> \n> \n> I'm currently running this on MacOSX 10.6. Will report as soon as it's done\n\n\nI can confirm that the above procedure and \"make ptestlong\" works just fine on MacOSX 10.6.",
    "created_at": "2011-07-22T10:25:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93035",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:117'></a>Replying to [dimpase](#comment%3A115):
> Replying to [leif](#comment%3A114):
> 
> 
> I'm currently running this on MacOSX 10.6. Will report as soon as it's done
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93036",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93037",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:0'></a>because it depends on a not-yet-positively-reviewed ticket",
    "created_at": "2011-07-24T18:53:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93038",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:0'></a>because it depends on a not-yet-positively-reviewed ticket
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93039",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:123'></a>#5847 has a positive review again",
    "created_at": "2011-08-23T05:57:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93040",
    "user": "https://github.com/ohanar"
}
```

<a id='comment:123'></a>#5847 has a positive review again
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93041",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93042",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.2.alpha2.patch](tarball://root/attachments/some-uuid/ticket8664/trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.2.alpha2.patch) by @nexttime created at 2011-08-31 21:49:09",
    "created_at": "2011-08-31T21:49:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93043",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:5'></a>Attachment [trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.2.alpha2.patch](tarball://root/attachments/some-uuid/ticket8664/trac_8664-fix_extmod_deps_for_MPIR_generically-sagelib-rebased_to_4.7.2.alpha2.patch) by @nexttime created at 2011-08-31 21:49:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93044",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93045",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93046",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93047",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93048",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Had to fix the changelog and some file permissions.\n\nCorrected spkg at new location.",
    "created_at": "2011-09-23T05:13:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93049",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>Had to fix the changelog and some file permissions.
...
```json
{
    "body": "<a id='comment:130'></a>Replying to [leif](#comment%3A129):\n> Replying to [strogdon](#comment%3A128):\n> > I'm not sure if this is the best place to report this since the ticket has been merged, but in building vanilla sage-4.7.2.alpha3 on x86, mpir-2.1.3.p4 fails with\n> > \n\n{{{\ntmp-lshift.s: Assembler messages:\ntmp-lshift.s:53: Error: bad register name `%rbx'\n...\nmake[4]: *** [lshift.lo] Error 1\n...\n}}}\n> I'll provide follow-up spkgs (also at #11616) that will fix this without the need to set `ABI`, but perhaps not that very soon.\n\n\nAn MPIR 2.1.3.p5 spkg fixing this is now available at #11896, currently needing review.",
    "created_at": "2011-10-05T03:37:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93052",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:130'></a>Replying to [leif](#comment%3A129):
> Replying to [strogdon](#comment%3A128):
> > I'm not sure if this is the best place to report this since the ticket has been merged, but in building vanilla sage-4.7.2.alpha3 on x86, mpir-2.1.3.p4 fails with
> > 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93053",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93054",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93055",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93056",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Unmerging this because of #9858 and #11896.",
    "created_at": "2011-10-11T07:36:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93057",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Unmerging this because of #9858 and #11896.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93058",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93059",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:135'></a>Replying to [leif](#comment%3A134):\n> Another cyclic dependency... ;-) (#11698 depends on this ticket)\n\n\nOoops, #11896 of course. XD\n\n(But I'll try to review #11698 anyway.)",
    "created_at": "2011-10-11T22:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93061",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:135'></a>Replying to [leif](#comment%3A134):
> Another cyclic dependency... ;-) (#11698 depends on this ticket)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93062",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93063",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93064",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8664#issuecomment-93065",
    "user": "https://github.com/jdemeyer"
}
```
