...
{
    "assignees": [
        "https://github.com/sagetrac-Boussicault"
    ],
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8643#event-108945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8643#event-108946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8643#event-108947"
}
```
...
```json
{
    "actor": "https://github.com/sagetrac-Boussicault",
    "created_at": "2010-04-02T14:41:00Z",
    "event": "assigned",
    "issue": "https://github.com/sagemath/sage/issues/8643",
    "subject": "https://github.com/sagetrac-boussica",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8643#event-108948"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8643",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8643#event-108949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8643#issuecomment-69348",
    "user": "https://github.com/sagetrac-boussica"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8643#issuecomment-69349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8643#issuecomment-69350",
