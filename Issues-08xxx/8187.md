...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84605",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84606",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84607",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84608",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"equality\"",
    "created_at": "2010-02-05T03:40:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84609",
    "user": "https://github.com/seblabbe"
}
```

Changing work_issues from "" to "equality"
...
```json
{
    "body": "<a id='comment:4'></a>This patch seems to introduce some problems. See\n\nhttp://groups.google.com/group/sage-combinat-devel/browse_thread/thread/9e90bbeb0328034c\n\nNeeds work...",
    "created_at": "2010-02-10T15:55:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84610",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>This patch seems to introduce some problems. See
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84611",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84612",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84613",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84614",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>> This patch seems to introduce some problems.\n\n\nFinally, the problem were already present. This ticket was simply making them appear! The problem is being tracked at #8232.\n\nI just uploaded a new patch.\n\nNeeds review again!",
    "created_at": "2010-02-10T18:24:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84615",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:6'></a>> This patch seems to introduce some problems.
...
```json
{
    "body": "<a id='comment:7'></a>I tested the patch and everything seems fine. Although it modifies several basic functions, it doesn't seem to have any side effect. I couldn't check all documentation since some part of the code is written in Cython, but the functions I did check built correctly.\n\nI've made minor changes in the doc: just formatting some part of the code or correcting typos. If S\u00e9bastien agrees with my change, I allow him to set the path to `positive review`.",
    "created_at": "2010-02-24T00:59:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84616",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

<a id='comment:7'></a>I tested the patch and everything seems fine. Although it modifies several basic functions, it doesn't seem to have any side effect. I couldn't check all documentation since some part of the code is written in Cython, but the functions I did check built correctly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84617",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_8187_review-abm.patch](tarball://root/attachments/some-uuid/ticket8187/trac_8187_review-abm.patch) by abmasse created at 2010-02-24 01:03:23\n\nI forgot to mention that equality tests are indeed improved in some cases, and I haven't encountered any worse case, which is good !",
    "created_at": "2010-02-24T01:03:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84618",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

<a id='comment:8'></a>Attachment [trac_8187_review-abm.patch](tarball://root/attachments/some-uuid/ticket8187/trac_8187_review-abm.patch) by abmasse created at 2010-02-24 01:03:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84619",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84620",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84621",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84622",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84623",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8187#issuecomment-84624",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
