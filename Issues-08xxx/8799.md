...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8799#event-101449"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8799#event-101450"
}
```
...
```json
{
    "body": "Changed assignee from **mvngu** to **@JohnCremona**",
...
Changed assignee from **mvngu** to **@JohnCremona**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8799#issuecomment-73451",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8799#issuecomment-73452",
