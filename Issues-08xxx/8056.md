...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8056#event-91115"
}
```
...
```json
{
    "body": "<a id='comment:3'>Comment 3:</a>\nThank you for the review.\n\n[attachment: trac_8056-fast_callable.take2.patch.gz](https://github.com/sagemath/sage/files/ticket8056/trac_8056-fast_callable.take2.patch.gz) uses `SR.one_element()` instead of `ZZ(1)`. This fixes the problems reported in [comment:2](#comment%3A2).\n\nApply only [attachment: trac_8056-fast_callable.take2.patch..gz](https://github.com/sagemath/sage/files/ticket8056/trac_8056-fast_callable.take2.patch..gz)\n\nCan you take another look?",
    "created_at": "2010-01-31T21:51:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8056",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8056#issuecomment-63545",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8056#issuecomment-63546",
