...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100691"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100696"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100697"
}
```
...
```json
{
    "body": "Changed keywords from **** to **combinat, crystals**",
    "created_at": "2010-06-06T16:56:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8984",
    "type": "issue_comment",
...
Changed keywords from **** to **combinat, crystals**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100699"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100701"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8984",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100703"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100704"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100707"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8984#issuecomment-75677",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8984#issuecomment-75678",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100708"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8984",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8984#event-100709"
}
```
