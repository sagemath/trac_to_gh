...
```json
{
    "body": "<a id='comment:2'></a>It would be really nice if CartesianProduct supported a repeat keyword, like the python itertools product function does:\n\n```\n\nsage: import itertools                      \nsage: list(itertools.product([1/2,-1/2],repeat=3))\n[(1/2, 1/2, 1/2), (1/2, 1/2, -1/2), (1/2, -1/2, 1/2), (1/2, -1/2, -1/2), (-1/2, 1/2, 1/2), (-1/2, 1/2, -1/2), (-1/2, -1/2, 1/2), (-1/2, -1/2, -1/2)]\n```\n\nThat would make a common case (cartesian product of a set with itself) much easier to read.",
    "created_at": "2010-05-05T17:34:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96960",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>It would be really nice if CartesianProduct supported a repeat keyword, like the python itertools product function does:
...
```json
{
    "body": "<a id='comment:3'></a>That does!  Sorry for opening the unnecessary ticket then.\n-Eva\n\nReplying to [mhansen](#comment%3A1):\n> Does this do what you want?\n> \n> \n> ```\n> sage: l = [1/2, -1/2]\n> sage: CartesianProduct(*([l]*3)).list()\n> [[1/2, 1/2, 1/2], [1/2, 1/2, -1/2], [1/2, -1/2, 1/2], [1/2, -1/2, -1/2], [-1/2, 1/2, 1/2], [-1/2, 1/2, -1/2], [-1/2, -1/2, 1/2], [-1/2, -1/2, -1/2]]\n> sage: CartesianProduct(*([l]*2)).list()\n> [[1/2, 1/2], [1/2, -1/2], [-1/2, 1/2], [-1/2, -1/2]]\n> ```",
    "created_at": "2010-05-05T17:54:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96961",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```

<a id='comment:3'></a>That does!  Sorry for opening the unnecessary ticket then.
-Eva
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96962",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96963",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_8889.patch](tarball://root/attachments/some-uuid/ticket8889/trac_8889.patch) by @mwhansen created at 2010-05-05 18:53:57\n\nI've added a patch which adds the repeat keyword.",
    "created_at": "2010-05-05T18:53:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96964",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>Attachment [trac_8889.patch](tarball://root/attachments/some-uuid/ticket8889/trac_8889.patch) by @mwhansen created at 2010-05-05 18:53:57
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96965",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>There is also Tuples in sage.combinat.tuple:\nhttp://sagemath.org/doc/reference/sage/combinat/tuple.html",
    "created_at": "2010-05-06T00:25:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96966",
    "user": "https://trac.sagemath.org/admin/accounts/users/ecurry"
}
```

<a id='comment:6'></a>There is also Tuples in sage.combinat.tuple:
http://sagemath.org/doc/reference/sage/combinat/tuple.html
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [ecurry](#comment%3A6):\n> There is also Tuples in sage.combinat.tuple:\n> http://sagemath.org/doc/reference/sage/combinat/tuple.html\n\n\nHeh, I should have known about that since it was likely I who wrote it :-)",
    "created_at": "2010-05-06T01:48:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96967",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>Replying to [ecurry](#comment%3A6):
> There is also Tuples in sage.combinat.tuple:
> http://sagemath.org/doc/reference/sage/combinat/tuple.html
...
```json
{
    "body": "<a id='comment:8'></a>I'm going to close this as invalid for now.  If we have a discussion and decide we really want to repeat option to CartesianProduct, then we can add it.",
    "created_at": "2010-06-22T21:57:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96968",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:8'></a>I'm going to close this as invalid for now.  If we have a discussion and decide we really want to repeat option to CartesianProduct, then we can add it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8889#issuecomment-96969",
    "user": "https://github.com/mwhansen"
}
```
