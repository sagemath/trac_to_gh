...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87823",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87824",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87825",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [cddlib-094f.p5.spkg](tarball://root/attachments/some-uuid/ticket8363/cddlib-094f.p5.spkg) by drkirkby created at 2010-02-25 16:35:11",
    "created_at": "2010-02-25T16:35:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87826",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>Attachment [cddlib-094f.p5.spkg](tarball://root/attachments/some-uuid/ticket8363/cddlib-094f.p5.spkg) by drkirkby created at 2010-02-25 16:35:11
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87827",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Please put a link to the spkg in the ticket. An attachment does not work.\n\nJaap",
    "created_at": "2010-02-25T17:20:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87828",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:3'></a>Please put a link to the spkg in the ticket. An attachment does not work.
...
```json
{
    "body": "<a id='comment:5'></a>Em, looks like multiple inclusion of the same libraries. I'm not sure how to solve this. I'll take a look - perhaps there is a configure option to select what library gets linked. \n\ndave",
    "created_at": "2010-02-25T22:47:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87830",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>Em, looks like multiple inclusion of the same libraries. I'm not sure how to solve this. I'll take a look - perhaps there is a configure option to select what library gets linked. 
...
```json
{
    "body": "<a id='comment:6'></a>Thinking about this ticket, it does fix what the title says it does. In other words, it removes the useless but broken check for mpir. \n\nI don't believe the removal of the OS X restriction for a 64-bit build can do any harm and its failure to work probably has more to do with the multiple inclusion of libraries. \n\nAs such, I believe this should get a positive review. \n\nThe fact it does not build on OpenSolaris is another issue. \n\nDave",
    "created_at": "2010-02-26T01:27:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87831",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:6'></a>Thinking about this ticket, it does fix what the title says it does. In other words, it removes the useless but broken check for mpir. 
...
```json
{
    "body": "<a id='comment:7'></a>Packages should not be attached to tickets. Instead, provide a URL to the spkg. David's updated spkg is available at\n\nhttp://sage.math.washington.edu/home/mvngu/spkg/standard/cddlib/cddlib-094f.p5.spkg",
    "created_at": "2010-03-01T02:31:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87832",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:7'></a>Packages should not be attached to tickets. Instead, provide a URL to the spkg. David's updated spkg is available at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87833",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Updating to blocker, as this is essential for a successful Solaris build, which with care should build and pass all doc tests.",
    "created_at": "2010-03-01T16:25:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87834",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:8'></a>Updating to blocker, as this is essential for a successful Solaris build, which with care should build and pass all doc tests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87835",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I'm happy with the changes in `cddlib-094f.p5.spkg`.",
    "created_at": "2010-03-02T13:35:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87836",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:9'></a>I'm happy with the changes in `cddlib-094f.p5.spkg`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87837",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Thank you Minh. I don't know what I was thinking when I attached the package to the trac ticket. Perhaps I thought it was so small - not sure. Anyway, I will not do it again. \n\nThank you for the positive review. \n\nI've opened another ticket, #8419, to resolve the issue which Jaap found - i.e. cddlib is not building as 64-bit on OpenSolaris.",
    "created_at": "2010-03-02T14:09:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87838",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:10'></a>Thank you Minh. I don't know what I was thinking when I attached the package to the trac ticket. Perhaps I thought it was so small - not sure. Anyway, I will not do it again. 
...
```json
{
    "body": "<a id='comment:11'></a>Merged [cddlib-094f.p5.spkg](http://sage.math.washington.edu/home/mvngu/spkg/standard/cddlib/cddlib-094f.p5.spkg) in the standard spkg repository.",
    "created_at": "2010-03-02T23:35:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87839",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:11'></a>Merged [cddlib-094f.p5.spkg](http://sage.math.washington.edu/home/mvngu/spkg/standard/cddlib/cddlib-094f.p5.spkg) in the standard spkg repository.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87840",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8363#issuecomment-87841",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
