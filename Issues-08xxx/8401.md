...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104214"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104215"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104217"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8401#issuecomment-66321",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8401#issuecomment-66322",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8401#issuecomment-66323",
    "user": "https://github.com/mwhansen"
}
```
