...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-105570"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-105571"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-105572"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-105573"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-105574"
}
```
