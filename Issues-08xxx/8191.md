...
```json
{
    "body": "**Attachment:** [install](https://github.com/sagemath/sage/files/ticket8191/install)\n\nNew $SAGE_ROOT/spkg/install to add support for the new iconv package",
    "created_at": "2010-02-15T11:51:27Z",
    "issue": "https://github.com/sagemath/sage/issues/8191",
    "type": "issue_comment",
...
**Attachment:** [install](https://github.com/sagemath/sage/files/ticket8191/install)
...
```json
{
    "body": "**Attachment:** [install.diff](https://github.com/sagemath/sage/files/ticket8191/install.diff)\n\nDiff for for $SAGE_ROOT/spkg/install",
    "created_at": "2010-02-15T11:52:02Z",
    "issue": "https://github.com/sagemath/sage/issues/8191",
    "type": "issue_comment",
...
**Attachment:** [install.diff](https://github.com/sagemath/sage/files/ticket8191/install.diff)
...
```json
{
    "body": "**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket8191/deps)\n\nDiff file for $SAGE_ROOT/spkg/standard/deps",
    "created_at": "2010-02-15T11:54:31Z",
    "issue": "https://github.com/sagemath/sage/issues/8191",
    "type": "issue_comment",
...
**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket8191/deps)
...
archive/attachments_010497.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_010498.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "R.patch",
...
archive/attachments_010499.json:
```json
{
    "asset_content_type": "application/octet-stream",
