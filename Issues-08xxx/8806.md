...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-63274"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-63275"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-63276"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-63277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-63278"
}
```
...
archive/attachments_011435.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "README.txt",
    "asset_url": "tarball://root/attachments/ticket8806/README.txt",
    "created_at": "2010-05-03T15:31:09Z",
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8806/README.txt",
    "user": "https://github.com/williamstein"
}
```
