...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93875",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93876",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93878",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93879",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93880",
...
```json
{
    "body": "<a id='comment:2'></a>Looks good, passes all doctests!",
    "created_at": "2010-04-17T23:24:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93881",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:2'></a>Looks good, passes all doctests!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93882",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Do we know for sure that types are the only sorts of objects which have this problem (that is, which seem to inherit a `_latex_` method according to hasattr, but which actually don't when you try to call it)?",
    "created_at": "2010-04-18T02:52:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93883",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Do we know for sure that types are the only sorts of objects which have this problem (that is, which seem to inherit a `_latex_` method according to hasattr, but which actually don't when you try to call it)?
...
```json
{
    "body": "<a id='comment:4'></a>I thought about it, but it seems to me that such objects should be \"special\" rather than \"usual\". Then it makes sense to check if x is in one of the special classes and hope that everything is good otherwise, i.e. return True. If it will turn out that there are other special cases, we can add tests for them and document them!",
    "created_at": "2010-04-18T03:44:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93884",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:4'></a>I thought about it, but it seems to me that such objects should be "special" rather than "usual". Then it makes sense to check if x is in one of the special classes and hope that everything is good otherwise, i.e. return True. If it will turn out that there are other special cases, we can add tests for them and document them!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93885",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93886",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Merged into 4.4.alpha1.",
    "created_at": "2010-04-19T05:18:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8707#issuecomment-93887",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Merged into 4.4.alpha1.
