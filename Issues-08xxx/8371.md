...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8371#issuecomment-67631",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8371#issuecomment-67632",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [Solaris-specific-patch-for-pyprocessing.patch](https://github.com/sagemath/sage/files/ticket8371/Solaris-specific-patch-for-pyprocessing.patch) by drkirkby created at 2010-03-01 15:21:56",
    "created_at": "2010-03-01T15:21:56Z",
    "issue": "https://github.com/sagemath/sage/issues/8371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8371#issuecomment-67633",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8371#event-58918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8371#issuecomment-67634",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8371#event-58919"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8371#event-58920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8371#issuecomment-67635",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8371#event-58921"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8371#event-58922"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8371#event-58923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8371",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8371#event-58924"
}
```
