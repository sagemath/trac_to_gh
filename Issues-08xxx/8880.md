...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8880#issuecomment-74442",
...
```json
{
    "body": "Changed assignee from **@jasongrout, @sagetrac-jkantor** to **@jasongrout**",
    "created_at": "2010-05-15T03:34:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8880",
    "type": "issue_comment",
...
Changed assignee from **@jasongrout, @sagetrac-jkantor** to **@jasongrout**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8880#event-102495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8880#event-102496"
}
```
