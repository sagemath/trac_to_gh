...
```json
{
    "body": "<a id='comment:5'></a>Actually, it is a part of my modules for cones/fans/toric varieties/fano toric varieties/Calabi-Yau hypersurfaces and complete intersections inside them. We should probably coordinate our efforts. At what stage is your work?",
    "created_at": "2010-05-09T15:05:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92732",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:5'></a>Actually, it is a part of my modules for cones/fans/toric varieties/fano toric varieties/Calabi-Yau hypersurfaces and complete intersections inside them. We should probably coordinate our efforts. At what stage is your work?
...
```json
{
    "body": "<a id='comment:6'></a>I've implemented all the fan/lattice basics, cohomology and Chern clases, Chow ring, divisors, Mori cone.\n\nThe current status is at [http://www.stp.dias.ie/~vbraun/Sage/](http://www.stp.dias.ie/~vbraun/Sage/), documentation is at [http://www.stp.dias.ie/~vbraun/Sage/html/en/reference/sage/geometry/toricvariety.html](http://www.stp.dias.ie/~vbraun/Sage/html/en/reference/sage/geometry/toricvariety.html)",
    "created_at": "2010-05-09T15:48:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92733",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>I've implemented all the fan/lattice basics, cohomology and Chern clases, Chow ring, divisors, Mori cone.
...
```json
{
    "body": "<a id='comment:7'></a>Fixed by the patch in #9954:\n\n```\nsage: for lset in Polyhedron(rays=[(1,0)]).face_lattice().level_sets(): lset\n....: \n[<>]\n[<1>]\n[<0,1>]\nsage: sage: for lset in Polyhedron(rays=[(1,0), (0,1)]).face_lattice().level_sets(): lset\n....: \n[<>]\n[<2>]\n[<1,2>, <0,2>]\n[<0,1,2>]\n```\nThis ticket can be closed once #9954 is merged.",
    "created_at": "2010-10-25T14:39:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92734",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:7'></a>Fixed by the patch in #9954:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92735",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Indeed, #9954 fixes the problem, so this ticket should be closed.",
    "created_at": "2010-11-08T21:39:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92736",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:8'></a>Indeed, #9954 fixes the problem, so this ticket should be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92737",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92738",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92739",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8656#issuecomment-92740",
