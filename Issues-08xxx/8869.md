...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8869#event-102372"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8869#event-102373"
}
```
...
```json
{
    "body": "Changed keywords from **** to **CDF conversion, complex double**",
    "created_at": "2010-05-27T12:15:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8869#issuecomment-74383",
    "user": "https://github.com/nexttime"
}
```

Changed keywords from **** to **CDF conversion, complex double**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8869#issuecomment-74384",
