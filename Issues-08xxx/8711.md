...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-100208"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-100209"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8711#issuecomment-72245",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8711#issuecomment-72246",
    "user": "https://github.com/jhpalmieri"
}
```
