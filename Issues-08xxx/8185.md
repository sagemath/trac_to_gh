...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84581",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84582",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Here's a Mercurial patch, which fixes the issue \n\n```\ndrkirkby@kestrel:~/sage-4.3.0.1$ ./sage -t devel/sage-main/build/sage/calculus/functional.py\nsage -t  \"devel/sage-main/build/sage/calculus/functional.py\"\n         [65.0 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 65.0 seconds\n```",
    "created_at": "2010-02-04T19:51:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84583",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:1'></a>Here's a Mercurial patch, which fixes the issue 
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [8185-numerical-noise.patch](tarball://root/attachments/some-uuid/ticket8185/8185-numerical-noise.patch) by @robertwb created at 2010-02-04 20:55:36",
    "created_at": "2010-02-04T20:55:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84584",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>Attachment [8185-numerical-noise.patch](tarball://root/attachments/some-uuid/ticket8185/8185-numerical-noise.patch) by @robertwb created at 2010-02-04 20:55:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84585",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8185#event-19592"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84586",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84587",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8185#issuecomment-84588",
    "user": "https://github.com/qed777"
}
```
