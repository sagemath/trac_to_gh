...
archive/attachments_010987.json:
```json
{
...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [trac_8488.patch](https://github.com/sagemath/sage/files/ticket8488/trac_8488.patch)",
    "created_at": "2010-03-10T13:22:48Z",
    "issue": "https://github.com/sagemath/sage/issues/8488",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8488#issuecomment-69320",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8488#issuecomment-69321",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8488#issuecomment-69322",
    "user": "https://github.com/jasongrout"
}
```
...
archive/attachments_010988.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac-8488-sage_wrap_decorator.patch](https://github.com/sagemath/sage/files/ticket8488/trac-8488-sage_wrap_decorator.patch)\n\napply on top of previous patch",
    "created_at": "2010-03-11T05:31:43Z",
    "issue": "https://github.com/sagemath/sage/issues/8488",
    "type": "issue_comment",
...
**Attachment:** [trac-8488-sage_wrap_decorator.patch](https://github.com/sagemath/sage/files/ticket8488/trac-8488-sage_wrap_decorator.patch)
...
```json
{
    "body": "**Attachment:** [trac_8488-part3.patch](https://github.com/sagemath/sage/files/ticket8488/trac_8488-part3.patch)",
    "created_at": "2010-04-18T00:33:15Z",
    "issue": "https://github.com/sagemath/sage/issues/8488",
    "type": "issue_comment",
...
**Attachment:** [trac_8488-part3.patch](https://github.com/sagemath/sage/files/ticket8488/trac_8488-part3.patch)
...
```json
{
    "body": "**Attachment:** [trac_8488-part4.patch](https://github.com/sagemath/sage/files/ticket8488/trac_8488-part4.patch)",
    "created_at": "2010-04-19T00:07:17Z",
    "issue": "https://github.com/sagemath/sage/issues/8488",
    "type": "issue_comment",
...
**Attachment:** [trac_8488-part4.patch](https://github.com/sagemath/sage/files/ticket8488/trac_8488-part4.patch)
