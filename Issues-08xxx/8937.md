...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8937#event-103285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8937#event-103286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8937#event-103287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8937#event-103288"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8937#issuecomment-75099",
    "user": "https://github.com/sagetrac-amca01"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-mvngu** to **@sagetrac-amca01**",
    "created_at": "2010-05-11T22:38:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8937#issuecomment-75100",
    "user": "https://github.com/sagetrac-amca01"
}
```

Changed assignee from **@sagetrac-mvngu** to **@sagetrac-amca01**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8937#event-103289"
}
```
