...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8445#event-96365"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8445#event-96366"
}
```
...
```json
{
    "body": "Changed assignee from **drkirkby** to **@jhpalmieri**",
...
Changed assignee from **drkirkby** to **@jhpalmieri**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8445#issuecomment-68762",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8445#issuecomment-68763",
    "user": "https://github.com/mwhansen"
}
```
