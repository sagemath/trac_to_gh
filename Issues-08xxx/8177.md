...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84453",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84455",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84456",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84457",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84458",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84459",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84461",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84462",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I have worked further on Florent's patch, and made a separate ticket for it: #8200.\nI have removed the blocker priority on this, and set it on #8200. I leave this ticket open, since the issue is still there. I let the experts decide whether this should be a won't fix or not.",
    "created_at": "2010-02-06T12:16:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84463",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:6'></a>I have worked further on Florent's patch, and made a separate ticket for it: #8200.
I have removed the blocker priority on this, and set it on #8200. I leave this ticket open, since the issue is still there. I let the experts decide whether this should be a won't fix or not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84465",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84466",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84467",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>> No, it means that, with #8200, I have done my part at fixing my improper usage of ZZ. But the issue that such an improper usage can cause a segfault is still there, and I leave to the experts the decision of whether to fix it now, leave it to later, or resolve it as wontfix.\n> \n> I personally vote -1 for making it a wontfix.\n\n\nI strongly second Nicolas -1. \n\nMoreover, if the segfault is not removed the invariant \n\n```\n    x.parent() == ZZ <==> x.class == Integer\n```\nmust be clearly stated with a _big warning_ in the doc. My opinion is that the segfault must be left only if there is a very large performance penalty fixing it.\nBy the way is this invariant an equivalence ? As far as I understood the segfault only came because we where breaking the `==>` part. \n\nCheers,\n\nFlorent\n\nBy the way, I've removed myself as author since I won't be hacking in integers (my work in integrated in #8200).",
    "created_at": "2010-02-07T10:20:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84468",
    "user": "https://github.com/hivert"
}
```

<a id='comment:11'></a>> No, it means that, with #8200, I have done my part at fixing my improper usage of ZZ. But the issue that such an improper usage can cause a segfault is still there, and I leave to the experts the decision of whether to fix it now, leave it to later, or resolve it as wontfix.
> 
> I personally vote -1 for making it a wontfix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84469",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84470",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84471",
...
```json
{
    "body": "<a id='comment:13'></a>I think we can mark this as invalid as of 5.10:\n\n```\nsage: class MyElement(ElementWrapper): __lt__ = ElementWrapper._lt_by_value\nsage: a = MyElement(ZZ, 1)\nsage: 1 < a\nFalse\nsage: a < 1\nFalse\n```",
    "created_at": "2013-07-22T15:19:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84472",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:13'></a>I think we can mark this as invalid as of 5.10:
...
```json
{
    "body": "<a id='comment:14'></a>I looked at the code of Integer._rich_cmp, and indeed it now tests that the right hand side is indeed in the Integer class which fixes the issue.\n\nIn an ideal world, we would have added a regression test, but oh well, let's move on.",
    "created_at": "2013-07-24T10:56:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8177#issuecomment-84473",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:14'></a>I looked at the code of Integer._rich_cmp, and indeed it now tests that the right hand side is indeed in the Integer class which fixes the issue.
