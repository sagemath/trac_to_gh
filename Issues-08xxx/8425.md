...
```json
{
    "body": "<a id='comment:1'></a>One of the \"core\" routines to overload from #1941.",
    "created_at": "2010-03-03T01:36:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88869",
    "user": "https://github.com/rhinton"
}
```

<a id='comment:1'></a>One of the "core" routines to overload from #1941.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88871",
    "user": "https://github.com/rhinton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88872",
    "user": "https://github.com/rhinton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88873",
...
```json
{
    "body": "<a id='comment:4'></a>Hunk failures applying to Sage-4.3.4.alpha0 + #8329 + #8421. Please rebase.",
    "created_at": "2010-03-06T22:25:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88874",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>Hunk failures applying to Sage-4.3.4.alpha0 + #8329 + #8421. Please rebase.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88875",
    "user": "https://github.com/rhinton"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Sorry for the delay and mixup.\n\nREQUIRES: #8421 + #8329 + #8330\n\nI don't know how to change the \"patch\" section above to reflect this....",
    "created_at": "2010-03-24T18:26:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88876",
    "user": "https://github.com/rhinton"
}
```

<a id='comment:5'></a>Sorry for the delay and mixup.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88877",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88878",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88880",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>> The docstring test shows that an exception is raised.  Would you like me to add verbiage above saying that it is an error for the two endpoints to be in the same partition?\n\n\nWell, it is already the case, as the Exception raised is \"RuntimeError: Edge vertices must lie in different partitions\". Well, I can understand you would like to have a *functional* BipartiteGraph as soon as possible, so I'm giving this ticket a positive review !\n\nThe tests pass, the documentation is fine, and it clearly is a necessary fix :-)\n\nNathann",
    "created_at": "2010-04-22T08:07:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88881",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:8'></a>> The docstring test shows that an exception is raised.  Would you like me to add verbiage above saying that it is an error for the two endpoints to be in the same partition?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88882",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>See #8744 for the previous comments :-)\n\nNathann",
    "created_at": "2010-04-22T08:15:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88883",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:10'></a>See #8744 for the previous comments :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88884",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88885",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88886",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8425#issuecomment-88887",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
