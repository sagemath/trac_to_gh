...
<a id='comment:3'></a>In other words, this should work:
...
<a id='comment:4'></a>here is a patch that changes the behavior of arrow() to be more like line().  
...
```json
{
    "body": "<a id='comment:5'></a>This looks great.  However, for backwards compatibility, could you name the arguments to arrow() \"tailpoint\" and \"headpoint\".  Now, this command won't work, whereas before it would:\n\n```\narrow(tailpoint=(0,1), headpoint=(2,3))\n```\n\nWe should keep our API unless there is a very good reason to change it.",
    "created_at": "2010-08-29T02:59:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8838",
    "type": "issue_comment",
...
<a id='comment:5'></a>This looks great.  However, for backwards compatibility, could you name the arguments to arrow() "tailpoint" and "headpoint".  Now, this command won't work, whereas before it would:
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_8838_arrow2d_arrow3d.patch](tarball://root/attachments/some-uuid/ticket8838/trac_8838_arrow2d_arrow3d.patch) by ryan created at 2010-09-11 05:25:40",
...
<a id='comment:6'></a>Attachment [trac_8838_arrow2d_arrow3d.patch](tarball://root/attachments/some-uuid/ticket8838/trac_8838_arrow2d_arrow3d.patch) by ryan created at 2010-09-11 05:25:40
...
```json
{
    "body": "<a id='comment:9'></a>Note that this is Ryan's first contribution (along with #9199 and #7154)",
...
<a id='comment:9'></a>Note that this is Ryan's first contribution (along with #9199 and #7154)
