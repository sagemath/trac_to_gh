...
```json
{
    "body": "<a id='comment:1'></a>I put this in the component 'modular forms' since the relevant file dirichlet.py is there. But I think it is a bit odd that this file is there; it should be with number fields, I believe. \n\nThe attached patch changes the string representation of a Dirichlet character to \n\n```\nsage: G = DirichletGroup(12)\nsage: chi = G.0\nsage: chi\nDirichlet character modulo 12 of conductor 4 mapping the generators to {5: 1, 7: -1}\n```\n\nI have also created a shorter representation that is used in other _repr_ like in\n\n```\nsage: ModularForms(chi,7)\nModular Forms space of dimension 14, character {5: 1, 7: -1} and weight 7 over Rational Field\n```",
    "created_at": "2010-01-31T01:39:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83786",
    "user": "https://github.com/categorie"
}
```

<a id='comment:1'></a>I put this in the component 'modular forms' since the relevant file dirichlet.py is there. But I think it is a bit odd that this file is there; it should be with number fields, I believe. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83787",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83788",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>sorry, this is not ready for review ! I fail to see some tests.",
    "created_at": "2010-01-31T01:51:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83789",
    "user": "https://github.com/categorie"
}
```

<a id='comment:4'></a>sorry, this is not ready for review ! I fail to see some tests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83790",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83792",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83794",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83795",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>So, here is a new version of the patch. This one is ready to be reviewed. It changes the string representation of a Dirichlet character to \n\n```\nsage: chi\nDirichlet character modulo 12 of conductor 4 mapping 5 |--> 1, 7  |--> -1\n```\n\nbut leaves the usual representation within modular form etc, like \n\n```\nsage: ModularForms(chi,7)\nModular Forms space of dimension 14, character [1,-1] and weight 7 over Rational Field\n```\n\nIf this change is not approved by some, I would propose to make a vote on sage-nt.",
    "created_at": "2010-03-27T21:12:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83796",
    "user": "https://github.com/categorie"
}
```

<a id='comment:8'></a>So, here is a new version of the patch. This one is ready to be reviewed. It changes the string representation of a Dirichlet character to 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83797",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I like the new output format.  But I can see that William might be attached to the old one, being used to (and also responsible for) it.\n\nTesting now...",
    "created_at": "2010-04-03T11:50:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83798",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:9'></a>I like the new output format.  But I can see that William might be attached to the old one, being used to (and also responsible for) it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83799",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>...all tests pass, so I am giving this a positive review --but would not mind opening the discussion up, so will post on sage-nt also).",
    "created_at": "2010-04-03T12:04:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83800",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:10'></a>...all tests pass, so I am giving this a positive review --but would not mind opening the discussion up, so will post on sage-nt also).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83801",
...
```json
{
    "body": "<a id='comment:12'></a>After 4 days, there were two responses on sage-nt:  a positive one from William, and a suggestion for a few further changes from Robert Bradshaw (see http://groups.google.co.uk/group/sage-nt/browse_thread/thread/be56e6f0e29b44e8).\n\n```\nI certainly like the new representation better. Perhaps the _latex_   \nmethod should use \\mapsto rather than the ASCII art |-->, but it   \nshould certainly produce \\zeta_{n}^{k} rather than returning just   \nplain _repr_. Another alternative short representation would be   \nsomething like \n(31, 41, 37) |--> (1, 1, zeta4) \n- Robert \n```",
    "created_at": "2010-04-07T21:26:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83802",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:12'></a>After 4 days, there were two responses on sage-nt:  a positive one from William, and a suggestion for a few further changes from Robert Bradshaw (see http://groups.google.co.uk/group/sage-nt/browse_thread/thread/be56e6f0e29b44e8).
...
```json
{
    "body": "<a id='comment:13'></a>Latexing of Dirichlet characters is being tracked at #8584. I have uploaded a new patch there which implements Robert's suggestions (using `\\mapsto` and the latex representation of roots of unity). \n\nFor what it's worth, I'm also in favour of the change.",
    "created_at": "2010-04-08T10:26:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83803",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:13'></a>Latexing of Dirichlet characters is being tracked at #8584. I have uploaded a new patch there which implements Robert's suggestions (using `\mapsto` and the latex representation of roots of unity). 
...
```json
{
    "body": "<a id='comment:14'></a>I was just about to submit an additional patch (equal to the new one in #8584), because I completely agree with changing the LaTeX representation as well. Thanks David, I will review yours.",
    "created_at": "2010-04-08T11:21:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83804",
    "user": "https://github.com/categorie"
}
```

<a id='comment:14'></a>I was just about to submit an additional patch (equal to the new one in #8584), because I completely agree with changing the LaTeX representation as well. Thanks David, I will review yours.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83805",
...
```json
{
    "body": "<a id='comment:15'></a>Merged \"trac_8133.patch\" in 4.4.alpha0.",
    "created_at": "2010-04-15T23:39:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83806",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:15'></a>Merged "trac_8133.patch" in 4.4.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8133#issuecomment-83807",
    "user": "https://github.com/jhpalmieri"
}
```
