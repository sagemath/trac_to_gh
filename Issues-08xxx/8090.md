...
```json
{
    "body": "Attachment [genus2reduction-0.3.p6.patch](https://github.com/sagemath/sage/files/ticket8090/genus2reduction-0.3.p6.patch) by @jaapspies created at 2010-01-27 20:32:36",
    "created_at": "2010-01-27T20:32:36Z",
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8090#issuecomment-63874",
    "user": "https://github.com/jaapspies"
}
```

Attachment [genus2reduction-0.3.p6.patch](https://github.com/sagemath/sage/files/ticket8090/genus2reduction-0.3.p6.patch) by @jaapspies created at 2010-01-27 20:32:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8090#issuecomment-63875",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8090#issuecomment-63876",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8090#event-56326"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8090#event-56327"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8090#event-56328"
}
```
