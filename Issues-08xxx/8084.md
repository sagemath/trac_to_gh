...
```json
{
    "body": "Attachment [factor_old.png](https://github.com/sagemath/sage/files/ticket8084/factor_old.png) by @jhpalmieri created at 2010-01-26 21:28:49\n\noutput of view(type(factor)) before the patch",
    "created_at": "2010-01-26T21:28:49Z",
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63829",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [factor_old.png](https://github.com/sagemath/sage/files/ticket8084/factor_old.png) by @jhpalmieri created at 2010-01-26 21:28:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63830",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [factor_new.png](https://github.com/sagemath/sage/files/ticket8084/factor_new.png) by @jhpalmieri created at 2010-01-28 21:15:57",
    "created_at": "2010-01-28T21:15:57Z",
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63831",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63832",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63833",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63834",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63835",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8084#issuecomment-63836",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
