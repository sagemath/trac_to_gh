...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8687#event-99876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8687#event-99877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8687#issuecomment-71893",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8687#issuecomment-71894",
    "user": "https://github.com/kcrisman"
}
```
