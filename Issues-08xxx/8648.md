...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8648#event-96188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8648#event-96189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8648#event-96190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8648",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8648#issuecomment-71186",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8648",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8648#issuecomment-71187",
    "user": "https://github.com/mwhansen"
}
```
