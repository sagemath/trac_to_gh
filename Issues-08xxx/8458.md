...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68920",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68921",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59823"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac_8458_independent_graphs.patch](https://github.com/sagemath/sage/files/ticket8458/trac_8458_independent_graphs.patch) by brunellus created at 2012-01-03 23:10:53\n\nI corrected the main generator. There are several specialized (e.g. tree generator) but I don't think the same problem arises in any of them. Do you agree?",
    "created_at": "2012-01-03T23:10:53Z",
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68922",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59824"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59825"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68923",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68924",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68925",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68926",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59826"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59827"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68928",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68929",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59828"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59829"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59830"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59831"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68930",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68931",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68932",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Attachment [trac_8458.patch](https://github.com/sagemath/sage/files/ticket8458/trac_8458.patch) by @nathanncohen created at 2012-01-31 17:44:47",
    "created_at": "2012-01-31T17:44:47Z",
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68933",
    "user": "https://github.com/nathanncohen"
}
```

Attachment [trac_8458.patch](https://github.com/sagemath/sage/files/ticket8458/trac_8458.patch) by @nathanncohen created at 2012-01-31 17:44:47
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59832"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59833"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68934",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68935",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68936",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-59835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68937",
    "user": "https://github.com/jdemeyer"
}
```
