...
```json
{
    "body": "<a id='comment:1'></a>Bug fixed:  I added tests for when the resulting value is either 0, or a nonzero constant, in which case an element of the base ring is returned.  Otherwise an element of the parent is returned (so you can still evaluate f(x+y,y) and similar.)\n\nPatch up as soon as testing is finished.\n\nmalb: I'm CC-ing you as the past person to work on this file.",
    "created_at": "2010-04-02T11:22:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90465",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>Bug fixed:  I added tests for when the resulting value is either 0, or a nonzero constant, in which case an element of the base ring is returned.  Otherwise an element of the parent is returned (so you can still evaluate f(x+y,y) and similar.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90466",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90467",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90468",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_8502-mpoly.patch](tarball://root/attachments/some-uuid/ticket8502/trac_8502-mpoly.patch) by @JohnCremona created at 2010-04-02 11:44:20",
    "created_at": "2010-04-02T11:44:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90469",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>Attachment [trac_8502-mpoly.patch](tarball://root/attachments/some-uuid/ticket8502/trac_8502-mpoly.patch) by @JohnCremona created at 2010-04-02 11:44:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90470",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90471",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90472",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90473",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90474",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Merged \"trac_8502-mpoly.patch\" in 4.4.alpha0.",
    "created_at": "2010-04-16T18:44:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8502#issuecomment-90475",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>Merged "trac_8502-mpoly.patch" in 4.4.alpha0.
