...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-93998",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Bellman-Ford is available in `networkx 1.6`. I added the dependency #12806, where the upgrade to 1.6 happens.\n\nWhen #12806 is done, we can add an interface in the graph class for Bellman-Ford algorithm, which should be done with this ticket here.",
    "created_at": "2012-04-03T23:23:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-93999",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:3'></a>Bellman-Ford is available in `networkx 1.6`. I added the dependency #12806, where the upgrade to 1.6 happens.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94000",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94001",
...
```json
{
    "body": "<a id='comment:7'></a>At first I can add it to generic_graph.py, and let to others to option to improve the implementation in C.\n\nI will propose a patch over the week end.",
    "created_at": "2012-06-22T12:06:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94004",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>At first I can add it to generic_graph.py, and let to others to option to improve the implementation in C.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94005",
...
```json
{
    "body": "<a id='comment:9'></a>I don't have a lot of free time these days and it takes some time to write the documentation and doctests. I will try to commit soon.",
    "created_at": "2013-04-06T13:40:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94006",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:9'></a>I don't have a lot of free time these days and it takes some time to write the documentation and doctests. I will try to commit soon.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94007",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94008",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I have uploaded the first part of the patch: the hidden bellman-ford function. You can already try it (and reviewed it) via `G.__bellman_ford__(source node)`  where G is either a graph or a digraph, with or without loops and multiple edges, with negative edge weights, etc.\n\nIt remains the long/boring part to call that function from other functions, add optional arguments and tests, etc. I don't have time to do it now, so anyone is welcome to contribute.\n\nI set the patch to needs review, but it should be needs work.\n\nDavid.",
    "created_at": "2013-04-06T15:49:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94009",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:10'></a>I have uploaded the first part of the patch: the hidden bellman-ford function. You can already try it (and reviewed it) via `G.__bellman_ford__(source node)`  where G is either a graph or a digraph, with or without loops and multiple edges, with negative edge weights, etc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94010",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>> I set the patch to needs review, but it should be needs work.\n\n\nWell, then.. `O_o`\n\nNathann",
    "created_at": "2013-05-12T09:32:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94011",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:11'></a>> I set the patch to needs review, but it should be needs work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94012",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94013",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Attachment [trac_8714.2.patch](tarball://root/attachments/some-uuid/ticket8714/trac_8714.2.patch) by @dcoudert created at 2013-09-15 14:07:48\n\nFinally, this patch is ready to be reviewed!\n\nThe method is now transparently called when negative weights are detected. I have also added an optional parameter that could be used e.g. in patch #13380.\n\n\napply: trac_8714.2.patch",
    "created_at": "2013-09-15T14:07:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94014",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:13'></a>Attachment [trac_8714.2.patch](tarball://root/attachments/some-uuid/ticket8714/trac_8714.2.patch) by @dcoudert created at 2013-09-15 14:07:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94015",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [trac_8714_addon1.patch](tarball://root/attachments/some-uuid/ticket8714/trac_8714_addon1.patch) by @fchapoton created at 2013-10-20 12:23:40",
    "created_at": "2013-10-20T12:23:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94016",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:15'></a>Attachment [trac_8714_addon1.patch](tarball://root/attachments/some-uuid/ticket8714/trac_8714_addon1.patch) by @fchapoton created at 2013-10-20 12:23:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94017",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I have made a small review patch, mainly changing minor cosmetic details.",
    "created_at": "2013-10-20T12:32:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94018",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:16'></a>I have made a small review patch, mainly changing minor cosmetic details.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94019",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94021",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94022",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94023",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94024",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21151"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21152"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21153"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21154"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94025",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94026",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>I had a short look at this patch and corrected a few obvious typos.\n\nReplying to [ncohen](#comment%3A18):\n> - You say that loops are supported, but I don't see how. Where do you detect if there is a negative loop somewhere, for instance ?\n\n\nIf there is a negative loop somewhere, `max_number_of_loops` is reached and the code raises a `ValueError`.\n\n---\nNew commits:",
    "created_at": "2014-05-14T11:37:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94027",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:24'></a>I had a short look at this patch and corrected a few obvious typos.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94028",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94029",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94033",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94034",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>I fixed two issues with the code. This includes a simple doctest for the (previously broken for negative edge weights) function shortest_paths. IMHO, doctests should be included for the other\nchanged functions, too.",
    "created_at": "2014-05-16T07:03:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94035",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:30'></a>I fixed two issues with the code. This includes a simple doctest for the (previously broken for negative edge weights) function shortest_paths. IMHO, doctests should be included for the other
changed functions, too.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21155"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21156"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21157"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21158"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94036",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Bellman-Ford has now been implemented in #18931. As discussed in [#18931 comment 15](http://trac.sagemath.org/ticket/18931#comment:15), the performance has not yet been compared with the code here.\n\nHowever, the branch attached to this ticket no longer merges with develop and very much work would be needed. Moreover, this ticket has not had any activity for 15 months. My suggestion is to close this ticket here as a duplicate.",
    "created_at": "2015-08-24T06:54:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94037",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:32'></a>Bellman-Ford has now been implemented in #18931. As discussed in [#18931 comment 15](http://trac.sagemath.org/ticket/18931#comment:15), the performance has not yet been compared with the code here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94038",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94039",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Actually I tried this patch a few days ago and I fully agree that it has to be fully rewritten. Moreover, to be competitive with respect to #18931, the algorithm has to be cythonized.\nSo let's close this ticket, and if later we decide to give a try to a fresh cython implementation, we can do it in another ticket.\nBest,\nDavid.",
    "created_at": "2015-08-24T09:11:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94040",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:33'></a>Actually I tried this patch a few days ago and I fully agree that it has to be fully rewritten. Moreover, to be competitive with respect to #18931, the algorithm has to be cythonized.
So let's close this ticket, and if later we decide to give a try to a fresh cython implementation, we can do it in another ticket.
Best,
David.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8714#issuecomment-94041",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8714",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8714#event-21159"
}
```
