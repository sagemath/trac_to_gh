...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8750#event-100772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8750#event-100773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8750#issuecomment-72866",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8750#issuecomment-72867",
    "user": "https://github.com/jhpalmieri"
}
```
