...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8398#event-95725"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8398#event-95726"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8398#event-95727"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8398#event-95728"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8398#issuecomment-68077",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8398#issuecomment-68078",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8398",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8398#event-95729"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8398#issuecomment-68079",
    "user": "https://github.com/mwhansen"
}
```
