...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8946#issuecomment-97801",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8946#issuecomment-97802",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The attached patch should fix the problem.\n\nBut there is another problem when applying sumbolic functions to numpy types,\nwhich is independent of #8479. See #8949.",
    "created_at": "2010-05-11T08:33:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8946#issuecomment-97803",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```

<a id='comment:1'></a>The attached patch should fix the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8946#issuecomment-97804",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8946#issuecomment-97805",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8946#issuecomment-97806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8946#issuecomment-97807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
