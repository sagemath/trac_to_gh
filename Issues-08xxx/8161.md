...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84135",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84136",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84138",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>With this patch, all tests pass on boxen.",
    "created_at": "2010-02-03T04:41:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84139",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>With this patch, all tests pass on boxen.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84140",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84141",
...
```json
{
    "body": "<a id='comment:4'></a>This looks good.  I noticed an existing problem with Unicode docstrings.  With #8051 and with or without #8167,\n\n```python\nsage: sagenb.notebook.worksheet.Worksheet.name?\nsage: sagenb.misc.misc.unicode_str?\n```\nhave `'<no docstring>'`.  V2 should fix this.",
    "created_at": "2010-02-04T06:34:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84142",
    "user": "https://github.com/qed777"
}
```

<a id='comment:4'></a>This looks good.  I noticed an existing problem with Unicode docstrings.  With #8051 and with or without #8167,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84143",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84144",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_8161-sagenb_sageinspect.patch](tarball://root/attachments/some-uuid/ticket8161/trac_8161-sagenb_sageinspect.patch) by @qed777 created at 2010-02-04 06:59:21\n\nV2 replaces `return str(r)` with\n\n```python\n    from sagenb.misc.misc import encoded_str\n    return encoded_str(r)\n```\nin `sage.misc.sageinspect._sage_getdoc_unformatted`.\n\nThe sagenb patch depends on #8051 + #8167 + #8102 + #8160.",
    "created_at": "2010-02-04T06:59:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84145",
    "user": "https://github.com/qed777"
}
```

<a id='comment:5'></a>Attachment [trac_8161-sagenb_sageinspect.patch](tarball://root/attachments/some-uuid/ticket8161/trac_8161-sagenb_sageinspect.patch) by @qed777 created at 2010-02-04 06:59:21
...
```json
{
    "body": "<a id='comment:6'></a>On further reflection, I've decided that replacing ```` with `\"` is a bad idea.  It's complicated, and it can make some docstrings less clear.  For example, should ```\"text\"``` be turned into `\"text\"` or `\"'text'\"`?  What about ```algorithm=\"gap\"```: turn it into `\"algorithm='gap'\"`?  What about (from sage.interfaces.sage0.Sage) the beautiful ```s('\"x\"')```?\n\nIf we eventually decide this is a good idea, we can do it in another ticket (or submit it as a possible customization for text output in Sphinx), but I'm taking it out for now.\n\nA few doctests in sage and sagenb need to be changed as a consequence; see the new patches.",
    "created_at": "2010-02-05T03:55:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84146",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>On further reflection, I've decided that replacing ```` with `"` is a bad idea.  It's complicated, and it can make some docstrings less clear.  For example, should ```"text"``` be turned into `"text"` or `"'text'"`?  What about ```algorithm="gap"```: turn it into `"algorithm='gap'"`?  What about (from sage.interfaces.sage0.Sage) the beautiful ```s('"x"')```?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84147",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84148",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84149",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84150",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8161#issuecomment-84151",
    "user": "https://github.com/qed777"
}
```
