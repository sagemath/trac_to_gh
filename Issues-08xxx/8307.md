...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-66524",
    "user": "https://github.com/qed777"
}
```
...
archive/attachments_010270.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_8307-update_sage-update.patch](https://github.com/sagemath/sage/files/ticket8307/trac_8307-update_sage-update.patch) by @qed777 created at 2010-02-19 14:30:01\n\nThe patch\n\n* Fixes `rstrip` problems.\n* Includes pep8-related cleanup and cosmetic changes.\n* Uses [textwrap](http://docs.python.org/library/textwrap.html).\n\nFeel free to make further improvements, or to undo mine!",
    "created_at": "2010-02-19T14:30:01Z",
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-66525",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-66526",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-66527",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-66528",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-66529",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
