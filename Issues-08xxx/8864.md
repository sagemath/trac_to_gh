...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99085"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99086"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99094"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99095"
}
```
...
```json
{
    "body": "<a id='comment:4'>Comment 4:</a>\nI uploaded [attachment: trac_8864-symbolic_zeta.take2.patch.gz](https://github.com/sagemath/sage/files/ticket8864/trac_8864-symbolic_zeta.take2.patch.gz) which also includes a fix for the `lfunctions/dokchitser.py` doctest. I simply replaced `zeta(2)` with `zeta(2)` to get a numeric evaluation.\n\nI agree that `pi+1.0` looks strange, but that is not so trivial to fix. :) FWIW, maple also seems to leave that unevaluated:\n\n```\n    |\\^/|     Maple 12 (IBM INTEL LINUX)\n._|\\|   |/|_. Copyright (c) Maplesoft, a division of Waterloo Maple Inc. 2008\n \\  MAPLE  /  All rights reserved. Maple is a trademark of\n <____ ____>  Waterloo Maple Inc.\n      |       Type ? for help.\n> Pi +1.0;\n                                   Pi + 1.0\n\n> 1.0*Pi;\n                                    1.0 Pi\n```",
    "created_at": "2010-05-08T22:24:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8864",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8864#issuecomment-74310",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99096"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8864#issuecomment-74311",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8864",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8864#event-99099"
}
```
