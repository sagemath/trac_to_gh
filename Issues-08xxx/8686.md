...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110054"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110057"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110058"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-logix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110059"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-logix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110060"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-logix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110061"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-logix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110062"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110064"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110065"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110066"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110067"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8686",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8686#event-110069"
}
```
