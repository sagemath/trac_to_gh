...
<a id='comment:20'></a>Replying to [VivianePons](#comment%3A16):
...
<a id='comment:24'></a>Replying to [VivianePons](#comment%3A23):
> (I added the feature for both ordered tree and binary trees)
...
<a id='comment:26'></a>Replying to [hivert](#comment%3A25):
