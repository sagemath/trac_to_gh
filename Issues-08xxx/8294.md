...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94198"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94199"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8294#issuecomment-66338",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-h** to **@hivert**",
    "created_at": "2010-02-17T15:41:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8294",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8294#issuecomment-66339",
    "user": "https://github.com/hivert"
}
```

Changed assignee from **@sagetrac-h** to **@hivert**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8294",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8294#event-94206"
}
```
