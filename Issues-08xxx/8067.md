...
<a id='comment:4'></a>That's fine. My only long-term concern is that hard-coding -m64 is not a great idea, since it is not portable, but hopefully we will have a solution to that. 
