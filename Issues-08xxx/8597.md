...
<a id='comment:3'></a>The problem happens in sage.plot.plot3d.shapes2
...
```json
{
    "body": "<a id='comment:5'></a>`point(vector((2,3,4)))` should work now",
...
<a id='comment:5'></a>`point(vector((2,3,4)))` should work now
...
```json
{
    "body": "<a id='comment:6'></a>latest patch includes small improvement that was suggested to me.",
...
<a id='comment:6'></a>latest patch includes small improvement that was suggested to me.
...
```json
{
    "body": "<a id='comment:7'></a>Looks good, but it needs a doctest.  I've added one in the following patch.",
...
<a id='comment:7'></a>Looks good, but it needs a doctest.  I've added one in the following patch.
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_8597_point_vector.2.patch](tarball://root/attachments/some-uuid/ticket8597/trac_8597_point_vector.2.patch) by jthurber created at 2011-01-10 11:25:11\n\nThe second patch does not apply on top of the first.\n\nOnly the second patch with doctest should be applied.  Otherwise, it's all good.",
...
<a id='comment:8'></a>Attachment [trac_8597_point_vector.2.patch](tarball://root/attachments/some-uuid/ticket8597/trac_8597_point_vector.2.patch) by jthurber created at 2011-01-10 11:25:11
