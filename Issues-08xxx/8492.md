...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90241",
...
```json
{
    "body": "<a id='comment:1'></a>Here's a patch.  The patch fixes all but one of the issues.  One question: in the docstring for `apply_simple_projection` in `sage.categories.coxeter_groups.py`, I changed `\\opi` to `\\overline\\pi` -- this looked like the right change, given the other documentation.  But I would like some confirmation from someone (Nicolas? Dan?) familiar with that code.\n\nThe remaining issue: I don't know what's causing\n\n```\n<autodoc>:0: (ERROR/3) Unexpected indentation.\n<autodoc>:0: (ERROR/3) Unexpected indentation.\n<autodoc>:0: (ERROR/3) Unexpected indentation.\n```\nbut I'm trying to track it down.  A patch could go on another ticket -- no need to hold up this one.",
    "created_at": "2010-03-10T21:02:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90242",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>Here's a patch.  The patch fixes all but one of the issues.  One question: in the docstring for `apply_simple_projection` in `sage.categories.coxeter_groups.py`, I changed `\opi` to `\overline\pi` -- this looked like the right change, given the other documentation.  But I would like some confirmation from someone (Nicolas? Dan?) familiar with that code.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90243",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90244",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90245",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_8492-ref.patch](tarball://root/attachments/some-uuid/ticket8492/trac_8492-ref.patch) by mvngu created at 2010-03-11 00:43:11\n\nThe patch is OK by me. The remaining three warnings can be dealt with in another ticket.",
    "created_at": "2010-03-11T00:43:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90246",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:2'></a>Attachment [trac_8492-ref.patch](tarball://root/attachments/some-uuid/ticket8492/trac_8492-ref.patch) by mvngu created at 2010-03-11 00:43:11
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90247",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90248",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8492#issuecomment-90249",
    "user": "https://github.com/jhpalmieri"
}
```
