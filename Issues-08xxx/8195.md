...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8195#event-92911"
}
```
...
```json
{
    "body": "Changed assignee from **@haraldschilly** to **drkirkby**",
...
Changed assignee from **@haraldschilly** to **drkirkby**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8195#issuecomment-65215",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8195#issuecomment-65216",
