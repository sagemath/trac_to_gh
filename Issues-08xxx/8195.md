...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84758",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Oops, I forgot to put braces around the commands. \n\n```\n$ p7zip -d sage-....tar.7z (if you used the recommended .7z file) \n$ gzip -d sage-....tar.gz (if you downloaded the larger .gz file) \n```\nSun's version of tar will not extract the binaries, so use the GNU tar. \n\n```\n$ /usr/sfw/bin/gtar xf sage-..tar \n$ LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/sfw/lib \n$ export LD_LIBRARY_PATH\n\nChange to the directory where the files were extract, then run\n\n$ ./sage",
    "created_at": "2010-02-05T23:34:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84760",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>Oops, I forgot to put braces around the commands. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84762",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84764",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Sage 5.0 \"almost works\" on Solaris SPARC (it builds but there are a few doctest errors) and it works fully on OpenSolaris i386.  See [SupportedPlatforms](http://wiki.sagemath.org/SupportedPlatforms).  Currently, we don't build (Open)Solaris binaries on the buildbot.  Should this be changed?",
    "created_at": "2012-05-17T22:13:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84766",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>Sage 5.0 "almost works" on Solaris SPARC (it builds but there are a few doctest errors) and it works fully on OpenSolaris i386.  See [SupportedPlatforms](http://wiki.sagemath.org/SupportedPlatforms).  Currently, we don't build (Open)Solaris binaries on the buildbot.  Should this be changed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84767",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84768",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8195#event-19602"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84769",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84770",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8195#event-19603"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-84771",
