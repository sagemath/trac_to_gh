...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket8089/disable-assembly-code-on-OpenSolaris.patch",
...
```json
{
    "body": "Mercurial patch to disable assembly code on OpenSolaris x64",
    "created_at": "2010-05-31T00:35:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8089",
    "type": "issue_comment",
