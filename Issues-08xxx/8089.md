...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8089#issuecomment-63868",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8089#issuecomment-63869",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "Attachment [disable-assembly-code-on-OpenSolaris.patch](https://github.com/sagemath/sage/files/ticket8089/disable-assembly-code-on-OpenSolaris.patch) by drkirkby created at 2010-05-31 00:35:57\n\nMercurial patch to disable assembly code on OpenSolaris x64",
    "created_at": "2010-05-31T00:35:57Z",
    "issue": "https://github.com/sagemath/sage/issues/8089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8089#issuecomment-63870",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

Attachment [disable-assembly-code-on-OpenSolaris.patch](https://github.com/sagemath/sage/files/ticket8089/disable-assembly-code-on-OpenSolaris.patch) by drkirkby created at 2010-05-31 00:35:57
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8089#issuecomment-63871",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8089#issuecomment-63872",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8089#issuecomment-63873",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
