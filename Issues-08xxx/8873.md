...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8873#issuecomment-74398",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8873#issuecomment-74399",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8873#event-102424"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8873#event-102425"
}
```
