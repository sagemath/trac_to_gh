...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65299"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65300"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65301"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65302"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65303"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65304"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65305"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65306"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8873#issuecomment-75974",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8873#issuecomment-75975",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65307"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65308"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65309"
}
```
...
```json
{
    ...
    "label": "duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8873#issuecomment-75976",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65311"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8873#event-65312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8873#issuecomment-75977",
    "user": "https://github.com/tscrim"
}
```
