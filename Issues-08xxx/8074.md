...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73149",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73150",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73151",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73152",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73153",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73154",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73155",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73156",
...
```json
{
    "body": "<a id='comment:11'></a>Replying to [comment:5 jason]:\n\n```\nsage: RR('nan').__pow(0.5)\nException RuntimeError: 'maximum recursion depth exceeded while calling a Python object' in <type 'exceptions.RuntimeError'> ignored\n...\n```\n\nRegardless of whatever the output of `RR('nan').__pow(0.5)` should be, it is a bug by itself that we don't get a decent exception here...",
    "created_at": "2010-09-28T20:52:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8074#issuecomment-73157",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Replying to [comment:5 jason]:
