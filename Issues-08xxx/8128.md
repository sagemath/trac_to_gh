...
<a id='comment:1'></a>Attachment [trac_8128-latex_cell_unicode.patch](tarball://root/attachments/some-uuid/ticket8128/trac_8128-latex_cell_unicode.patch) by @qed777 created at 2010-01-30 03:00:55
...
<a id='comment:2'></a>From `sagenb.misc.misc`:
...
```json
{
    "body": "<a id='comment:3'></a>I haven't tested it extensively either, but it looks okay. See #8083 for a related notebook issue and #8130 for a related command-line issue.",
...
<a id='comment:3'></a>I haven't tested it extensively either, but it looks okay. See #8083 for a related notebook issue and #8130 for a related command-line issue.
...
```json
{
    "body": "<a id='comment:4'></a>Seems good, works for me. Tested on the top of #8051",
...
<a id='comment:4'></a>Seems good, works for me. Tested on the top of #8051
...
```json
{
    "body": "<a id='comment:5'></a>Just a quick note: This is for the sage repository.",
...
<a id='comment:5'></a>Just a quick note: This is for the sage repository.
