...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64409",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8128/trac_8128-latex_cell_unicode.patch",
    "created_at": "2010-01-30T03:00:55Z",
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8128/trac_8128-latex_cell_unicode.patch",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_8128-latex_cell_unicode.patch](https://github.com/sagemath/sage/files/ticket8128/trac_8128-latex_cell_unicode.patch) by @qed777 created at 2010-01-30 03:00:55\n\nThe patch uses the recently added (cf. #7249, #8051) `sagenb.misc.encoded_str` to avoid attempting to re-encode encoded strings.\n\nI haven't tested this extensively, but it appears to fix the problem above.",
    "created_at": "2010-01-30T03:00:55Z",
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64410",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64411",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64412",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64414",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64415",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64416",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8128#issuecomment-64417",
    "user": "https://github.com/qed777"
}
```
