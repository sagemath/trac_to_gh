...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93783"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93784"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93785"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93786"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93787"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93788"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -7,3 +7,8 @@\n \n \n **Prerequisites:** #8465\n+\n+**Apply:**\n+\n+1. [attachment: trac_8469-rsa.patch.gz](https://github.com/sagemath/sage/files/ticket8469/trac_8469-rsa.patch.gz)\n+2. [attachment: trac_8469-review-rebased.patch.gz](https://github.com/sagemath/sage/files/ticket8469/trac_8469-review-rebased.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93795"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8469#issuecomment-69113",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8469",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8469#event-93798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8469#issuecomment-69114",
