...
```json
{
    "body": "Attachment [iter_method_for_integer_vectors-nb.patch](https://github.com/sagemath/sage/files/ticket8361/iter_method_for_integer_vectors-nb.patch) by nborie created at 2010-02-25 13:18:46",
    "created_at": "2010-02-25T13:18:46Z",
    "issue": "https://github.com/sagemath/sage/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8361#issuecomment-67515",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```

Attachment [iter_method_for_integer_vectors-nb.patch](https://github.com/sagemath/sage/files/ticket8361/iter_method_for_integer_vectors-nb.patch) by nborie created at 2010-02-25 13:18:46
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8361#issuecomment-67516",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8361#issuecomment-67517",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8361#issuecomment-67518",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8361#issuecomment-67519",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
