...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8361#issuecomment-87803",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8361#issuecomment-87804",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I have started a discussion about this patch in sage-devel: http://groups.google.com/group/sage-devel/browse_thread/thread/26d80fb37461ac19#\n\nI think that accepting this enhancement should be deferred until that discussion is concluded.",
    "created_at": "2010-08-02T10:11:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8361#issuecomment-87805",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:2'></a>I have started a discussion about this patch in sage-devel: http://groups.google.com/group/sage-devel/browse_thread/thread/26d80fb37461ac19#
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8361#issuecomment-87806",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8361#issuecomment-87807",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8361#issuecomment-87809",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
