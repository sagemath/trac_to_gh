...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97131"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97132"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **@sagetrac-flawrence**",
    "created_at": "2010-03-14T12:59:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
...
Changed assignee from **@williamstein** to **@sagetrac-flawrence**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97135"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97146"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97148"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8495#issuecomment-69448",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8495#issuecomment-69449",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97152"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8495#issuecomment-69450",
    "user": "https://github.com/sagetrac-flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8495#issuecomment-69451",
    "user": "https://github.com/sagetrac-flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8495#issuecomment-69452",
    "user": "https://github.com/sagetrac-flawrence"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97154"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97155"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97156"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8495#issuecomment-69453",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97157"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8495#event-97158"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8495#issuecomment-69454",
    "user": "https://github.com/jdemeyer"
}
```
