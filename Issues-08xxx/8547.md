...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91084",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91085",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_8547.patch](tarball://root/attachments/some-uuid/ticket8547/trac_8547.patch) by @williamstein created at 2010-03-20 12:49:50",
    "created_at": "2010-03-20T12:49:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91086",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Attachment [trac_8547.patch](tarball://root/attachments/some-uuid/ticket8547/trac_8547.patch) by @williamstein created at 2010-03-20 12:49:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91087",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91089",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91090",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91092",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I've been wanting to review this but I just haven't had the time.  I might this weekend, but its unclear.",
    "created_at": "2010-03-31T03:06:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91094",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:9'></a>I've been wanting to review this but I just haven't had the time.  I might this weekend, but its unclear.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91096",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91099",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Attachment [trac_8547-take2-part2.patch](tarball://root/attachments/some-uuid/ticket8547/trac_8547-take2-part2.patch) by @jasongrout created at 2010-04-08 22:29:13\n\nReplying to [was](#comment%3A13):\n\n\n\n> * Jason said above that IntList.sum doesn't have a doctest for the overflow case... but it does, so I don't know what he meant. \n\n\n\nI meant that the doctest looks like this:\n\n```\nNote that there can be overflow, since the entries are C ints:: \n    sage: a = stats.IntList([2^30,2^30]); a \n    [1073741824, 1073741824] \n\n```\n\nThat's it.  There's no test there; you're just creating a list, not summing anything.\n\n\n>  \n\n> * I read the source code for `sage.misc.misc_c.normalize_index` and cannot bring myself to use that in this situation.  That  function actually returns a Python *list* of Python ints for every single index into the list that is being sliced!  That would easily lead to factor of 50-100 slowdowns on realistic operations:\n\n> This stats code I'm writing is really meant to be industrial strength -- the sort of code maybe somebody would use in \"realtime\" processing of large datastreams.    I don't want slow functions anywhere in there. \n\n\n\nI agree.",
    "created_at": "2010-04-08T22:29:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91100",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:14'></a>Attachment [trac_8547-take2-part2.patch](tarball://root/attachments/some-uuid/ticket8547/trac_8547-take2-part2.patch) by @jasongrout created at 2010-04-08 22:29:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91101",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91102",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>OK, positive review.  I think this and basic_stats should be added to the reference manual, but that can be another ticket I guess.",
    "created_at": "2010-04-11T21:32:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91103",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:16'></a>OK, positive review.  I think this and basic_stats should be added to the reference manual, but that can be another ticket I guess.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91104",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91105",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91106",
...
```json
{
    "body": "Changing reviewer from \"\" to \"Marshall Hampton, Tom Boothby, Jason Grout\"",
    "created_at": "2010-04-16T18:43:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91107",
    "user": "https://github.com/jhpalmieri"
}
```

Changing reviewer from "" to "Marshall Hampton, Tom Boothby, Jason Grout"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91108",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91109",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8547#issuecomment-91110",
    "user": "https://github.com/jhpalmieri"
}
```
