...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-94516"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-94517"
}
```
...
```json
{
    "body": "Changed assignee from **@burcin** to **maldun**",
...
Changed assignee from **@burcin** to **maldun**
...
```json
{
    "body": "Changed assignee from **maldun** to **@burcin**",
...
Changed assignee from **maldun** to **@burcin**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8321#issuecomment-66712",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8321#issuecomment-66713",
    "user": "https://github.com/zimmermann6"
}
```
