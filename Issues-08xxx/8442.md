...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96286"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96289"
}
```
...
```json
{
    "body": "Changed assignee from **mvngu** to **@dwbump**",
    "created_at": "2010-03-05T03:16:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
...
Changed assignee from **mvngu** to **@dwbump**
...
```json
{
    "body": "Attachment: **[a2rho.png.gz](https://github.com/sagemath/sage/files/ticket8442/a2rho.png.gz)**",
...
Attachment: **[a2rho.png.gz](https://github.com/sagemath/sage/files/ticket8442/a2rho.png.gz)**
...
```json
{
    "body": "Attachment: **[standard1.png.gz](https://github.com/sagemath/sage/files/ticket8442/standard1.png.gz)**",
...
Attachment: **[standard1.png.gz](https://github.com/sagemath/sage/files/ticket8442/standard1.png.gz)**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96297"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96298"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,3 +36,10 @@\n identical to the union of the three patches.\n \n In addition, the three .png files must be where they get properly linked.\n+\n+**Apply:**\n+\n+1. #8464\n+2. [trac_8442-config.patch](https://github.com/sagemath/sage/files/ticket8442/trac_8442-config.patch.gz)\n+3. [trac_8442-lie-rebased-4.4.2.rc0.patch](https://github.com/sagemath/sage/files/ticket8442/trac_8442-lie-rebased-4.4.2.rc0.patch.gz)\n+4. Copy [wcf1.png](https://github.com/sagemath/sage/files/ticket8442/wcf1.png.gz), [a2rho.png](https://github.com/sagemath/sage/files/ticket8442/a2rho.png.gz), and [standard1.png](https://github.com/sagemath/sage/files/ticket8442/standard1.png.gz) to the directory `doc/en/thematic_tutorials/static/`.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96299"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96300"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96305"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96306"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96307"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96311"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96312"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96313"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96314"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96315"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96316"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96317"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96318"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96319"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96324"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96326"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96327"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96328"
}
```
...
```json
{
    "body": "<a id='comment:62'>Comment 62:</a>\nPlease add ticket number to commit message of [attachment: trac_8442-png-files.patch.gz](https://github.com/sagemath/sage/files/ticket8442/trac_8442-png-files.patch.gz)",
    "created_at": "2011-01-22T20:18:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68721",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96330"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68722",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96331"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96332"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68723",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68724",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96333"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96334"
}
```
...
```json
{
    "body": "<a id='comment:64'>Comment 64:</a>\nAdded [attachment: 8442_manifest.patch.gz](https://github.com/sagemath/sage/files/ticket8442/8442_manifest.patch.gz), still needs testing.",
    "created_at": "2011-01-27T13:58:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68725",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68726",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96335"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68727",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96337"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96338"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8442#event-96340"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8442#issuecomment-68728",
    "user": "https://github.com/jdemeyer"
}
```
