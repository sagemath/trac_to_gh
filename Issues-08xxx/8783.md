...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95184",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Note that this still builds on sage.math with GCC-4.2.4...  But it doesn't build on Skynet with newer GCC's.",
    "created_at": "2010-04-27T20:17:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95185",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Note that this still builds on sage.math with GCC-4.2.4...  But it doesn't build on Skynet with newer GCC's.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95186",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95187",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95188",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Note, gcc 4.5 is **not** the latest gcc, but gcc 4.4.4 is: See\n\n http://gcc.gnu.org/\n\n```\nNews\n\nApril 29, 2010\n    GCC 4.4.4 has been released.\nApril 14, 2010\n    GCC 4.5.0 has been released.\n```\n\nDave",
    "created_at": "2010-05-06T23:06:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95189",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>Note, gcc 4.5 is **not** the latest gcc, but gcc 4.4.4 is: See
...
```json
{
    "body": "<a id='comment:6'></a>Even with gcc-4.4.3, Frobby doesn't build.\n\nIf somebody doesn't post a new frobby spkg on this ticket for review this week, I'm moving the frobby spkg to \"experimental\". \n\n -- William",
    "created_at": "2010-06-22T04:15:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95190",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>Even with gcc-4.4.3, Frobby doesn't build.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95191",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I have moved Frobby from optional to experimental.  I'll move it back when this problem is addressed.\n\nhttp://sagemath.org/packages/optional/\n\nhttp://sagemath.org/packages/experimental/",
    "created_at": "2010-06-28T17:37:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95192",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>I have moved Frobby from optional to experimental.  I'll move it back when this problem is addressed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95194",
    "user": "https://trac.sagemath.org/admin/accounts/users/broune"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95195",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95198",
    "user": "https://trac.sagemath.org/admin/accounts/users/broune"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95199",
    "user": "https://trac.sagemath.org/admin/accounts/users/broune"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>(Oops, I put my response as the description. Now fixed.)\n\nThanks for the prompt review. I committed the outstanding files in the repository and removed the two ~ files. The result is up in the same place:\n\n http://sage.math.washington.edu/home/bjarke/frobby-0.7.6.p1.spkg\n\nI'm adding patches rather than edit src/ because as I understand it the code in src/ must be an official release of the upstream code. No version 0.7.6 of Frobby exists that compiles under gcc 4.3.0, and I'd rather add some patches here than make an official release of an old version.",
    "created_at": "2010-07-06T11:53:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95200",
    "user": "https://trac.sagemath.org/admin/accounts/users/broune"
}
```

<a id='comment:13'></a>(Oops, I put my response as the description. Now fixed.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95201",
    "user": "https://trac.sagemath.org/admin/accounts/users/broune"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95202",
...
```json
{
    "body": "<a id='comment:14'></a>I can verify that the ~ files were removed and the repository is clean. The SPKG successfully builds using GCC 4.4.5. I'm trying GCC 4.5.? now.",
    "created_at": "2011-08-22T16:32:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95203",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:14'></a>I can verify that the ~ files were removed and the repository is clean. The SPKG successfully builds using GCC 4.4.5. I'm trying GCC 4.5.? now.
...
```json
{
    "body": "<a id='comment:15'></a>The SPKG builds using GCC 4.6.1 as well. Here is the build log: https://gist.github.com/1164148\n\nUnless anyone has further comments / concerns, I will give the new SPKG a positive review.",
    "created_at": "2011-08-23T02:05:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95204",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:15'></a>The SPKG builds using GCC 4.6.1 as well. Here is the build log: https://gist.github.com/1164148
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95205",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95206",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95207",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95208",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95209",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95210",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95212",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Attachment [frobby-0.7.6.p1-redhawk-SAGE_CHECK.log](tarball://root/attachments/some-uuid/ticket8783/frobby-0.7.6.p1-redhawk-SAGE_CHECK.log) by @nexttime created at 2011-09-12 20:12:09\n\nOoops, should read 4.**4**.3, but the version shouldn't matter much anyway... ;-)\n\n(Attached the build log.)",
    "created_at": "2011-09-12T20:12:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95213",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:21'></a>Attachment [frobby-0.7.6.p1-redhawk-SAGE_CHECK.log](tarball://root/attachments/some-uuid/ticket8783/frobby-0.7.6.p1-redhawk-SAGE_CHECK.log) by @nexttime created at 2011-09-12 20:12:09
...
```json
{
    "body": "<a id='comment:22'></a>I didn't run the build with SAGE_CHECK=yes when I reviewed the package, but I did run the test suite manually. This was on skynet/eno which has GCC 4.6.1 installed. \n\nI just ran the build under Sage 4.7.2.alpha1 on skynet/eno using `export SAGE_CHECK=yes; ./sage -f frobby-0.7.6.p1.spkg` and both the build and the test suite finish without errors. I'll attach the build log.",
    "created_at": "2011-09-13T01:38:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95214",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:22'></a>I didn't run the build with SAGE_CHECK=yes when I reviewed the package, but I did run the test suite manually. This was on skynet/eno which has GCC 4.6.1 installed. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95215",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95216",
...
```json
{
    "body": "<a id='comment:24'></a>Closing as a duplicate in light of #13007.",
    "created_at": "2012-05-25T20:27:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95217",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:24'></a>Closing as a duplicate in light of #13007.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95218",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95219",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8783#issuecomment-95220",
    "user": "https://github.com/jdemeyer"
}
```
