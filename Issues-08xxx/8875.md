...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8875#issuecomment-74370",
    "user": "https://trac.sagemath.org/admin/accounts/users/mrobado"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_8875_Set_from_iterator_mr.patch](https://github.com/sagemath/sage/files/ticket8875/trac_8875_Set_from_iterator_mr.patch) by mrobado created at 2010-05-04 20:52:52",
    "created_at": "2010-05-04T20:52:52Z",
    "issue": "https://github.com/sagemath/sage/issues/8875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8875#issuecomment-74371",
    "user": "https://trac.sagemath.org/admin/accounts/users/mrobado"
}
```
...
```json
{
    "body": "Attachment [trac_8875_Set_from_iterator_mr.2.patch](https://github.com/sagemath/sage/files/ticket8875/trac_8875_Set_from_iterator_mr.2.patch) by @mwhansen created at 2010-05-04 21:51:50",
    "created_at": "2010-05-04T21:51:50Z",
    "issue": "https://github.com/sagemath/sage/issues/8875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8875#issuecomment-74372",
    "user": "https://github.com/mwhansen"
}
```

Attachment [trac_8875_Set_from_iterator_mr.2.patch](https://github.com/sagemath/sage/files/ticket8875/trac_8875_Set_from_iterator_mr.2.patch) by @mwhansen created at 2010-05-04 21:51:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8875#issuecomment-74373",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8875#issuecomment-74374",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8875#issuecomment-74375",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8875#issuecomment-74376",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
