...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-91710"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-91711"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-91712"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-91713"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8104#issuecomment-64110",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-91714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8104#issuecomment-64111",
    "user": "https://github.com/sagetrac-mvngu"
}
```
