...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-100794"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-100795"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-100796"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-100797"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-100798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8104#issuecomment-62445",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-100799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8104#issuecomment-62446",
    "user": "https://github.com/sagetrac-mvngu"
}
```
