...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8804#issuecomment-73603",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8804#issuecomment-73604",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8804#event-101571"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8804#event-101572"
}
```
