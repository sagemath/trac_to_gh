...
```json
{
    "body": "<a id='comment:2'></a>I should add that this breaks the remote sagetex functionality that lets people that don't have Sage installed to use sagetex through a remote server.",
    "created_at": "2010-03-18T06:49:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8556#issuecomment-91257",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>I should add that this breaks the remote sagetex functionality that lets people that don't have Sage installed to use sagetex through a remote server.
...
```json
{
    "body": "<a id='comment:3'></a>Closing as it's about a very outdated notebook version.",
    "created_at": "2013-05-16T07:43:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8556#issuecomment-91258",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>Closing as it's about a very outdated notebook version.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8556#issuecomment-91259",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8556#issuecomment-91260",
    "user": "https://github.com/jdemeyer"
}
```
