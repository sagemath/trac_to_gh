...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90675"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90676"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90678"
}
```
...
```json
{
    "body": "Changed assignee from **mvngu** to **@mezzarobba**",
...
Changed assignee from **mvngu** to **@mezzarobba**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90680"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90683"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65783",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90688"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65784",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65785",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65786",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65787",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65788",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65789",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65790",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65791",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90692"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65792",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90693"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8242#event-90694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8242#issuecomment-65793",
    "user": "https://github.com/jhpalmieri"
}
```
