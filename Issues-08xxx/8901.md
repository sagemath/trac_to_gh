...
```json
{
    "body": "Changed assignee from **@sagetrac-sage-combinat** to **@sagetrac-ecurry**",
    "created_at": "2010-05-06T14:00:55Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8901",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-sage-combinat** to **@sagetrac-ecurry**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8901#issuecomment-74764",
    "user": "https://github.com/sagetrac-ecurry"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8901#event-102814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8901",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8901#event-102815"
}
```
