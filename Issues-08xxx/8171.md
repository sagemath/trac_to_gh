...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84326",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84327",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I just updated the spkg to make it support multithreading through Cbc !\n\nNathann",
    "created_at": "2010-02-26T11:11:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84328",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>I just updated the spkg to make it support multithreading through Cbc !
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84329",
...
```json
{
    "body": "<a id='comment:3'></a>Since this is new, you need to state whether it is intended to go into experimental or optional. Also, since this is new, you should remove the .p2 from the spkg name and instead call it cbc-2.3.spkg.\n\nIf you update this, before it is committed to Sage, just replace it, or provide a new link. The patch number increments each time a new version is added to Sage - not each time you change your version. \n\nDave",
    "created_at": "2010-03-10T23:37:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84330",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>Since this is new, you need to state whether it is intended to go into experimental or optional. Also, since this is new, you should remove the .p2 from the spkg name and instead call it cbc-2.3.spkg.
...
```json
{
    "body": "<a id='comment:5'></a>Yes, it does clarify this. I was under the impression this was a new package, rather than an update to a pre-existing one. \n\nI've stuck it back to needs review. I'm personally unable to review it, as it is outside my level of expertese.",
    "created_at": "2010-03-11T14:04:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84332",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:5'></a>Yes, it does clarify this. I was under the impression this was a new package, rather than an update to a pre-existing one. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84333",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Harald, can you take a look at the SPKG? I tried it and it works but someone needs to check for the basics (hg status, SPKG.txt, etc.) and I'm busy for the next few days.",
    "created_at": "2010-03-11T18:39:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84334",
    "user": "https://github.com/malb"
}
```

<a id='comment:7'></a>Harald, can you take a look at the SPKG? I tried it and it works but someone needs to check for the basics (hg status, SPKG.txt, etc.) and I'm busy for the next few days.
...
```json
{
    "body": "<a id='comment:8'></a>Finally ..... This package has been tested on t2 (Solaris). It compiles and runs ! :-)\n\nAs soon as this and #8172 are in Sage, it will be possible to work on the inclusion of SCIP !\n\nNathann",
    "created_at": "2010-03-22T23:20:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84335",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:8'></a>Finally ..... This package has been tested on t2 (Solaris). It compiles and runs ! :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84336",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84337",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84338",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84339",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Merged 2010/04/20.",
    "created_at": "2010-04-20T22:55:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84340",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:10'></a>Merged 2010/04/20.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8171#issuecomment-84341",
    "user": "https://github.com/jhpalmieri"
}
```
