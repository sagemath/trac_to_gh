...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71214",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "Attachment [8655_genus.patch](https://github.com/sagemath/sage/files/ticket8655/8655_genus.patch) by boothby created at 2010-05-21 21:32:12\n\nDepends on #8691",
    "created_at": "2010-05-21T21:32:12Z",
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71215",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

Attachment [8655_genus.patch](https://github.com/sagemath/sage/files/ticket8655/8655_genus.patch) by boothby created at 2010-05-21 21:32:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71216",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71217",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71218",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71219",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71220",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71221",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [8655_genus_2.patch](https://github.com/sagemath/sage/files/ticket8655/8655_genus_2.patch) by boothby created at 2010-05-27 22:49:29\n\nRegarding \"line 231 -> probably a bitset way to do this faster\", I agree, there probably is, but I'd rather not peek any further into the cgraph structure than necessary.",
    "created_at": "2010-05-27T22:49:29Z",
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71222",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71223",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8655#issuecomment-71224",
