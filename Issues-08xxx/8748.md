...
```json
{
    "body": "<a id='comment:1'></a>For an explanation of the Linear Program used to solve this problem, see the LP chapter from :  http://code.google.com/p/graph-theory-algorithms-book/\n\nNathann",
    "created_at": "2010-04-23T01:06:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8748",
    "type": "issue_comment",
...
<a id='comment:1'></a>For an explanation of the Linear Program used to solve this problem, see the LP chapter from :  http://code.google.com/p/graph-theory-algorithms-book/
...
```json
{
    "body": "<a id='comment:3'></a>Yet another graph constructor from networkx, with {} instead of None as labels. A g.edges(labels = False) did the trick :-)\n\nSorry abou that !\n\nNathann",
...
<a id='comment:3'></a>Yet another graph constructor from networkx, with {} instead of None as labels. A g.edges(labels = False) did the trick :-)
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_8748.2.patch](tarball://root/attachments/some-uuid/ticket8748/trac_8748.2.patch) by @rlmill created at 2010-06-21 21:57:09",
    "created_at": "2010-06-21T21:57:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8748",
    "type": "issue_comment",
...
<a id='comment:4'></a>Attachment [trac_8748.2.patch](tarball://root/attachments/some-uuid/ticket8748/trac_8748.2.patch) by @rlmill created at 2010-06-21 21:57:09
