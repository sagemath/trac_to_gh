...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70347",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70348",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70349",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_8572-poset_doc_fix-fh.patch](https://github.com/sagemath/sage/files/ticket8572/trac_8572-poset_doc_fix-fh.patch) by @hivert created at 2010-03-21 21:57:33\n\nHi John,\n\n> A little more data:\n\n\n```\n sage: from sage.misc.sageinspect import _sage_getdoc_unformatted\n sage: from sagenb.misc.sphinxify import sphinxify\n sage: r = _sage_getdoc_unformatted(Poset)\n sage: len(sphinxify(r[:1438], format='text'))\n 1382\n sage: len(sphinxify(r[:1439], format='text'))\n 0\n```\n\nI don't know how you got it but this was exactly the problem: an extraneous space at the 1438th character ! Please review.\n\nFlorent",
    "created_at": "2010-03-21T21:57:33Z",
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70350",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70351",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70352",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70353",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70354",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70355",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8572#issuecomment-70356",
    "user": "https://github.com/jhpalmieri"
}
```
