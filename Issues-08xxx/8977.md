...
```json
{
    "body": "<a id='comment:1'></a>I think a short explanation of the bug (and the fix) here in trac would be useful. Also, adding an example to the docstring to test for this would be nice.\n\nOtherwise, the patch seems reasonable, asuming I understood it correctly (I *can* reproduce the bug, but I did *not* try the fix)",
    "created_at": "2010-05-18T20:33:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98380",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:1'></a>I think a short explanation of the bug (and the fix) here in trac would be useful. Also, adding an example to the docstring to test for this would be nice.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98381",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Changed the patch to add the example given to the doctest, and fixed the doctest also.",
    "created_at": "2010-05-28T01:24:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98382",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```

<a id='comment:3'></a>Changed the patch to add the example given to the doctest, and fixed the doctest also.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98383",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The patch fails to apply (4.6.1.rc1).\nAlso, the INPUT and OUTPUT blocks should only have a single colon (see [here](http://www.sagemath.org/doc/developer/conventions.html))",
    "created_at": "2011-01-16T14:22:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98384",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:5'></a>The patch fails to apply (4.6.1.rc1).
Also, the INPUT and OUTPUT blocks should only have a single colon (see [here](http://www.sagemath.org/doc/developer/conventions.html))
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98385",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98386",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I fixed the patch for sage-4.6.1 and make the corrections mstreng told.",
    "created_at": "2011-02-05T15:32:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98387",
    "user": "https://trac.sagemath.org/admin/accounts/users/gdrama"
}
```

<a id='comment:6'></a>I fixed the patch for sage-4.6.1 and make the corrections mstreng told.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98389",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98391",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98392",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98394",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98395",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Apply trac_8977_rational_diagonal_form_fix2.patch",
    "created_at": "2011-02-07T20:52:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98396",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:10'></a>Apply trac_8977_rational_diagonal_form_fix2.patch
...
```json
{
    "body": "<a id='comment:11'></a>Can we merge this, please?",
    "created_at": "2011-03-08T20:36:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98397",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:11'></a>Can we merge this, please?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98398",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98399",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8977#issuecomment-98400",
    "user": "https://github.com/jdemeyer"
}
```
