...
```json
{
    "body": "<a id='comment:3'></a>First, the code is obviously right.  Second, it works: starting with Sage 4.3.4, force-installing the previous version of the iconv spkg breaks Sage 4.3.4 on platforms other than Solaris or Cygwin.  Force-installing this one doesn't.",
...
<a id='comment:3'></a>First, the code is obviously right.  Second, it works: starting with Sage 4.3.4, force-installing the previous version of the iconv spkg breaks Sage 4.3.4 on platforms other than Solaris or Cygwin.  Force-installing this one doesn't.
...
```json
{
    "body": "<a id='comment:4'></a>Merged spkg from #8638 in 4.4.alpha0.",
...
<a id='comment:4'></a>Merged spkg from #8638 in 4.4.alpha0.
