...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8317#issuecomment-66599",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58304"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8317#issuecomment-66600",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8317#issuecomment-66601",
...
```json
{
    ...
    "label": "component: symbolics",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58306"
}
```
...
```json
{
    ...
    "label": "component: misc",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58307"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58308"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58309"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8317#issuecomment-66602",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/8317#event-58311"
}
```
