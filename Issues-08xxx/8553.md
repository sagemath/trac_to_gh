...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94965"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94976"
}
```
...
```json
{
    "body": "<a id='comment:26'>Comment 26:</a>\nAttachment: **[trac_8553-review.patch.gz](https://github.com/sagemath/sage/files/ticket8553/trac_8553-review.patch.gz)**\n\nThe doctests for using values that are taken to be True in Leif's patch added a few extra seconds to the time to test `sage/symbolic/relation.py`. I uploaded a revised version of Leif's patch, [attachment: trac_8553_solve_fix_IndexError.3.patch,.gz](https://github.com/sagemath/sage/files/ticket8553/38dd7ba34818c1351c34679001aea3b8.gz) which cuts down on these examples.\n\n[attachment: trac_8553-review.patch.gz](https://github.com/sagemath/sage/files/ticket8553/trac_8553-review.patch.gz) adds a new test condition to check if the first argument is a list, after the statement that handles a single symbolic expression.\n\nCan someone review my patch?",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70126",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70127",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70128",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70129",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94980"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94982"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70130",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70131",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70132",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94984"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8553#event-94985"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70133",
...
```json
{
    "body": "<a id='comment:35'>Comment 35:</a>\nFor the sagebot:\n\nApply [[attachment: trac_8553-review.patch.gz](https://github.com/sagemath/sage/files/ticket8553/trac_8553-review.patch.gz)(https://github.com/sagemath/sage/files/ticket8553/e18200977209cae499452a7bca5de3fb.gz)",
    "created_at": "2011-07-22T19:57:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8553",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8553#issuecomment-70134",
    "user": "https://github.com/nexttime"
}
```
