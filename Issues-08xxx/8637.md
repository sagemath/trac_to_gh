...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8637/trac_8637.patch",
    "created_at": "2010-03-31T23:47:22Z",
    "issue": "https://github.com/sagemath/sage/issues/8637",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8637/trac_8637.patch",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_8637.patch](https://github.com/sagemath/sage/files/ticket8637/trac_8637.patch) by @dandrake created at 2010-03-31 23:47:22\n\nI made Paul's patch into a proper Mercurial patch and credited him for it. Please review!",
    "created_at": "2010-03-31T23:47:22Z",
    "issue": "https://github.com/sagemath/sage/issues/8637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8637#issuecomment-71015",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8637#issuecomment-71016",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8637#issuecomment-71017",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8637#issuecomment-71018",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8637#issuecomment-71019",
    "user": "https://github.com/TimDumol"
}
```
