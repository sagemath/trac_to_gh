...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100189"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100192"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100199"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75216",
    "user": "https://github.com/sagetrac-pang"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75217",
    "user": "https://github.com/sagetrac-pang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75218",
    "user": "https://github.com/sagetrac-pang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75219",
    "user": "https://github.com/sagetrac-pang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75220",
    "user": "https://github.com/sagetrac-uri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75221",
    "user": "https://github.com/sagetrac-uri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75222",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75223",
    "user": "https://github.com/sagetrac-uri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75224",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75225",
    "user": "https://github.com/sagetrac-uri"
}
```
...
```json
{
    "body": "<a id='comment:20'>Comment 20:</a>\nWhich patch(es) should the release manager merge?  The attachment [attachment: trac_8950_desolve_odeint_unified_4.patch.gz](https://github.com/sagemath/sage/files/ticket8950/trac_8950_desolve_odeint_unified_4.patch.gz) is missing a Mercurial header.  In case it helps: [This wiki page](http://wiki.sagemath.org/MercurialQueues) shows how to fold together multiple patches.\n\nAlso, can someone fill in the \"Reviewer(s)\" field?",
    "created_at": "2010-09-05T03:40:35Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75226",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100212"
}
```
...
```json
{
    "body": "<a id='comment:21'>Comment 21:</a>\nReplying to [@qed777](#comment%3A20):\n> Which patch(es) should the release manager merge?  The attachment [attachment: trac_8950_desolve_odeint_unified_4.patch.gz](https://github.com/sagemath/sage/files/ticket8950/trac_8950_desolve_odeint_unified_4.patch.gz) is missing a Mercurial header.  In case it helps: [This wiki page](http://wiki.sagemath.org/MercurialQueues) shows how to fold together multiple patches.\n\nThanks for the help. Now [attachment: trac_8950_desolve_odeint_unified_4.patch.gz](https://github.com/sagemath/sage/files/ticket8950/trac_8950_desolve_odeint_unified_4.patch.gz) contains the Mercurial header. This is the patch that the release manager should merge.",
    "created_at": "2010-09-07T14:24:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75227",
    "user": "https://github.com/sagetrac-uri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75228",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75229",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75230",
    "user": "https://github.com/sagetrac-uri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75231",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75232",
    "user": "https://github.com/sagetrac-uri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100213"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100214"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75233",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8950#event-100216"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8950#issuecomment-75234",
    "user": "https://github.com/qed777"
}
```
