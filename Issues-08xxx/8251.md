...
```json
{
    "body": "<a id='comment:1'></a>This may be related to #7930.  In both cases, a sequence of elliptic curves and number fields and reduction mod primes is carried out, and something is getting confused about all the finite fields which getting created.\n\nIt would be a great help if we could simplify the script which causes this.  There's an outer look through curves and an inner loop through certain fields, depending on the curve, and then the torsion of the curve over that field is computed.  I'll try to do that.",
    "created_at": "2010-02-13T18:07:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85666",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>This may be related to #7930.  In both cases, a sequence of elliptic curves and number fields and reduction mod primes is carried out, and something is getting confused about all the finite fields which getting created.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85669",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85670",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Even easier to reproduce:\n\n```\nRationalField()\nx = load(SAGE_ROOT + \"/data/jones/jones.sobj\")\nRationalField()\n```",
    "created_at": "2011-01-08T21:51:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85671",
    "user": "https://github.com/wjp"
}
```

<a id='comment:5'></a>Even easier to reproduce:
...
```json
{
    "body": "<a id='comment:6'></a>As far as I can tell, `jones.sobj` contains a `RationalField` with `_names` equal to `'x'`, while in current versions of sage, `QQ._names` equals `('x',)`.",
    "created_at": "2011-01-08T21:58:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85672",
    "user": "https://github.com/wjp"
}
```

<a id='comment:6'></a>As far as I can tell, `jones.sobj` contains a `RationalField` with `_names` equal to `'x'`, while in current versions of sage, `QQ._names` equals `('x',)`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85674",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [jones.sobj](tarball://root/attachments/some-uuid/ticket8251/jones.sobj) by @wjp created at 2011-01-09 23:00:38\n\nIt would also be possible to fix unpickling the old sobj (and any other potentially broken old pickles) by creating an empty `RationalField.__setstate__(state)`.",
    "created_at": "2011-01-09T23:00:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85675",
    "user": "https://github.com/wjp"
}
```

<a id='comment:8'></a>Attachment [jones.sobj](tarball://root/attachments/some-uuid/ticket8251/jones.sobj) by @wjp created at 2011-01-09 23:00:38
...
```json
{
    "body": "<a id='comment:13'></a>See https://groups.google.com/forum/#!topic/sage-devel/U1dsVFP-2PA  Is this still even relevant?  I assume the database exists somewhere still.",
    "created_at": "2020-10-08T12:47:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85676",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:13'></a>See https://groups.google.com/forum/#!topic/sage-devel/U1dsVFP-2PA  Is this still even relevant?  I assume the database exists somewhere still.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85677",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I know nothing about the bug, and have never installed the optional Jones-Roberts database.  I only posted here to answer the question about whether that database still exists.  It does, and is being maintained, as it can do some things not yet available in the LMFDB though John Jones also maintains the number field collection there.\n\nIt seems that you haves tested that the package database_jones_numfield does work, and I am also now installing it....done, and I see no problem.\n\nLet's close this issue.",
    "created_at": "2020-10-08T16:28:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85679",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:16'></a>I know nothing about the bug, and have never installed the optional Jones-Roberts database.  I only posted here to answer the question about whether that database still exists.  It does, and is being maintained, as it can do some things not yet available in the LMFDB though John Jones also maintains the number field collection there.
...
```json
{
    "body": "<a id='comment:17'></a>Did you try the `RationalField()` before and after using it like in[comment:15](#comment%3A15)?  I agree that we can close it if that succeeds.  I only assumed you knew something about it since you were already on this ticket.",
    "created_at": "2020-10-08T16:35:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85680",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:17'></a>Did you try the `RationalField()` before and after using it like in[comment:15](#comment%3A15)?  I agree that we can close it if that succeeds.  I only assumed you knew something about it since you were already on this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85681",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85682",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85683",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85684",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>If there is still a bug, at any rate we didn't find it :-)",
    "created_at": "2020-10-08T17:14:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85685",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:21'></a>If there is still a bug, at any rate we didn't find it :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8251#issuecomment-85686",
