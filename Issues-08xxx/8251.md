...
```json
{
    "body": "<a id='comment:17'></a>Did you try the `RationalField()` before and after using it like in comment:15?  I agree that we can close it if that succeeds.  I only assumed you knew something about it since you were already on this ticket.",
...
<a id='comment:17'></a>Did you try the `RationalField()` before and after using it like in comment:15?  I agree that we can close it if that succeeds.  I only assumed you knew something about it since you were already on this ticket.
