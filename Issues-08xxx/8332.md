...
```json
{
    "body": "<a id='comment:4'></a>(BTW, the aforementioned failure doesn't seem to be dealt with by any of the other tickets in the series -- none of them change that line of code.)",
...
<a id='comment:4'></a>(BTW, the aforementioned failure doesn't seem to be dealt with by any of the other tickets in the series -- none of them change that line of code.)
...
<a id='comment:5'></a>Attachment [trac_8332_fix.patch](tarball://root/attachments/some-uuid/ticket8332/trac_8332_fix.patch) by @loefflerd created at 2010-04-04 14:33:38
...
<a id='comment:6'></a>I applied both patches on top of a 4.3.5 build on 32-bit ubuntu, after previously applying the relevant bundle & patches from #8128.
