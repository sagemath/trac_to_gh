...
```json
{
    "body": "<a id='comment:2'></a>Similarly, one gets\n\n```\nsage: MS = MatrixSpace(QQ,8)\nsage: M = MS.random_element()\nsage: M = M.stack(M)\nsage: v = copy(M).left_kernel()\nsage: n = 0\nsage: mem = get_memory_usage()\nsage: while(1):\n....:     n+=1\n....:     if get_memory_usage()>mem:\n....:         mem = get_memory_usage()\n....:         print mem,n\n....:     v = copy(M).left_kernel()\n....:\n800.3828125 27\n800.51171875 62\n800.640625 94\n800.76953125 151\n801.05078125 168\n801.1796875 187\n801.30859375 221\n801.4375 256\n801.56640625 278\n801.71484375 314\n802.08984375 375\n802.21875 423\n802.34765625 460\n802.4765625 497\n802.60546875 521\n802.8984375 610\n803.02734375 635\n803.15625 690\n```\nI guess the two are related.",
    "created_at": "2010-05-06T14:57:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97276",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>Similarly, one gets
...
```json
{
    "body": "<a id='comment:3'></a>I guess #10262 might explain both of these leaks. I wouldn't find it strange that somewhere in both algorithms scalar*vector multiplication happens.",
    "created_at": "2011-01-08T01:08:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97277",
    "user": "https://github.com/koffie"
}
```

<a id='comment:3'></a>I guess #10262 might explain both of these leaks. I wouldn't find it strange that somewhere in both algorithms scalar*vector multiplication happens.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97278",
...
```json
{
    "body": "<a id='comment:9'></a>Seems to be fixed indeed.\n\n```\n\u250c\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510\n\u2502 SageMath Version 6.6.rc2, Release Date: 2015-04-02                 \u2502\n[...]\nsage: MS = MatrixSpace(QQ,8)\nsage: M = MS.random_element()\nsage: N = copy(M)\nsage: N.echelonize()\nsage: N==M\nFalse\nsage: mem = get_memory_usage()\nsage: n = 0\nsage: while(1):\n....:     n+=1\n....:     if get_memory_usage()>mem:\n....:         mem = get_memory_usage()\n....:         print mem,n\n....:     N = copy(M)\n....:     N.echelonize()\n....:\n1006.625 2302\n1006.875 19154\n1007.0078125 27590\n1007.2578125 36321\n```",
    "created_at": "2015-04-11T17:37:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97279",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:9'></a>Seems to be fixed indeed.
...
```json
{
    "body": "<a id='comment:10'></a>Marco, the numbers you are giving indicate that the memory leak is smaller than before. But why do you think it is fixed?",
    "created_at": "2015-04-11T18:01:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97280",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>Marco, the numbers you are giving indicate that the memory leak is smaller than before. But why do you think it is fixed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97281",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97282",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97283",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97284",
...
```json
{
    "body": "<a id='comment:13'></a>Yes, I came to the same conclusion after letting it run for a bit longer:\n\n```\n1005.9921875 376\n1006.2421875 2015\n1006.4921875 19150\n1006.4921875 20000\n1006.640625 30356\n1006.890625 36624\n1006.890625 40000\n1006.890625 60000\n1006.890625 80000\n1007.140625 95959\n1007.140625 100000\n1007.140625 6000000\n```",
    "created_at": "2015-04-11T20:48:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97285",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:13'></a>Yes, I came to the same conclusion after letting it run for a bit longer:
...
```json
{
    "body": "<a id='comment:14'></a>Setting the ticket to duplicate/positive_review as we agree that the problem is fixed and there is no obvious regression test to add.",
    "created_at": "2015-04-13T12:09:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97286",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:14'></a>Setting the ticket to duplicate/positive_review as we agree that the problem is fixed and there is no obvious regression test to add.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97287",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8905#issuecomment-97288",
