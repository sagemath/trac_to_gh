...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8146#issuecomment-64549",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8146#issuecomment-64550",
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_8146-french.patch](https://github.com/sagemath/sage/files/ticket8146/trac_8146-french.patch) by @jhpalmieri created at 2010-02-02 02:46:33\n\n(I didn't check `conf.py` for the other documents, but they build with just the usual warnings, so I don't think we need to modify them.)",
    "created_at": "2010-02-02T02:46:33Z",
    "issue": "https://github.com/sagemath/sage/issues/8146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8146#issuecomment-64551",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8146#issuecomment-64552",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8146#issuecomment-64553",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8146#issuecomment-64554",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
