...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92921"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92922"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92925"
}
```
...
```json
{
    "body": "Changed keywords from **** to **Branching rules**",
...
Changed keywords from **** to **Branching rules**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8411#issuecomment-68199",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8411#issuecomment-68200",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8411#issuecomment-68201",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92928"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8411",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8411#event-92929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8411#issuecomment-68202",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8411#issuecomment-68203",
    "user": "https://github.com/jhpalmieri"
}
```
