...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-101857"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-101858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8826#issuecomment-73857",
    "user": "https://github.com/sagetrac-gostrc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8826#issuecomment-73858",
    "user": "https://github.com/sagetrac-gostrc"
}
```
