...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112236"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112239"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112242"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.4.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112243"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112244"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-112245"
}
```
