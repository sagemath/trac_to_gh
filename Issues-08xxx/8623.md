...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8623#event-98974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8623#event-98975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8623#issuecomment-70906",
    "user": "https://github.com/rishikesha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8623#issuecomment-70907",
    "user": "https://github.com/rishikesha"
}
```
