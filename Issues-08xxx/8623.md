...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8623#issuecomment-70872",
    "user": "https://github.com/rishikesha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8623#issuecomment-70873",
    "user": "https://github.com/rishikesha"
}
```
...
```json
{
    ...
    "asset_name": "trac_8623.patch",
    "asset_url": "tarball://root/attachments/ticket8623/trac_8623.patch",
    "created_at": "2010-03-29T13:14:36Z",
    "issue": "https://github.com/sagemath/sage/issues/8623",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8623/trac_8623.patch",
    "user": "https://github.com/rishikesha"
}
```
...
```json
{
    "body": "Attachment [trac_8623.patch](https://github.com/sagemath/sage/files/ticket8623/trac_8623.patch) by @rishikesha created at 2010-03-29 13:14:36",
    "created_at": "2010-03-29T13:14:36Z",
    "issue": "https://github.com/sagemath/sage/issues/8623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8623#issuecomment-70874",
    "user": "https://github.com/rishikesha"
}
```

Attachment [trac_8623.patch](https://github.com/sagemath/sage/files/ticket8623/trac_8623.patch) by @rishikesha created at 2010-03-29 13:14:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8623#issuecomment-70875",
