...
```json
{
    "body": "<a id='comment:1'></a>Strange, I cannot confirm this. Did you apply the new spkg \"into\" a formerly unsuccessful build, or did you rebuild everything from scratch? I did the latter, i.e. taking a freshly unzipped source distribution Sage-4.4.1.rc0, replacing pari-2.3.5.spkg with pari-2.3.5.p0.spkg, and then typing\"make\". It's still building the docs at the moment, but opening a second terminal gives me on my MacIntel with OS X 10.4.11:\n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n**********************************************************************\n*                                                                    *\n* Warning: this is a prerelease version, and it may be unstable.     *\n*                                                                    *\n**********************************************************************\nsage: 2 + 2\n4\nsage: \n```",
    "created_at": "2010-05-02T22:11:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8841#issuecomment-96359",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:1'></a>Strange, I cannot confirm this. Did you apply the new spkg "into" a formerly unsuccessful build, or did you rebuild everything from scratch? I did the latter, i.e. taking a freshly unzipped source distribution Sage-4.4.1.rc0, replacing pari-2.3.5.spkg with pari-2.3.5.p0.spkg, and then typing"make". It's still building the docs at the moment, but opening a second terminal gives me on my MacIntel with OS X 10.4.11:
...
```json
{
    "body": "<a id='comment:2'></a>I wonder if this is now a PPC-only issue on OSX 10.4.  I will try downloading and building Sage on my PPC machine overnight tonight if no one has dealt with it by then to see what happens.",
    "created_at": "2010-05-03T14:24:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8841#issuecomment-96360",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>I wonder if this is now a PPC-only issue on OSX 10.4.  I will try downloading and building Sage on my PPC machine overnight tonight if no one has dealt with it by then to see what happens.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8841#issuecomment-96361",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8841#issuecomment-96363",
...
```json
{
    "body": "<a id='comment:4'></a>Closing this ticket as invalid. See #8935 to update README.txt to reflect support for Mac OS X 10.4.x.",
    "created_at": "2010-05-09T00:48:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8841#issuecomment-96364",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:4'></a>Closing this ticket as invalid. See #8935 to update README.txt to reflect support for Mac OS X 10.4.x.
