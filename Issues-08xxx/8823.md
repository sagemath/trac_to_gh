...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8823#event-101828"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8823#event-101829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8823#issuecomment-73834",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8823#issuecomment-73835",
    "user": "https://github.com/sagetrac-mvngu"
}
```
