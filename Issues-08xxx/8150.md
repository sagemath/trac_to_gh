...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83954",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>`# random order` is preferable to `#not tested`. I think a lot of these could be tested in sensible ways. For example, if word_problem returned a list of *tuples* rather than lists (which is more natural), then one could do\n\n```\nsage: w = word_problem([a*b,a*c], b*c)\nsage: set(w) == set([(a*b, 1), (a*c, 1)])\n```\n\nEven better, \n\n```\nsage: w = word_problem([a*b,a*c], b*c); w # random solution\n[[a*b, 1], [a*c, 1]]\nsage: w == prod(g^e for g,e in w)\nTrue\n```\n\nwhich demonstrates that w is indeed a solution. \n\nAlso, it's clearer to us any and all instead of reduce, if you need to. Having huge blocks of `#not tested` should be avoided unless there's no clean way around it.",
    "created_at": "2010-02-02T12:43:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83955",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>`# random order` is preferable to `#not tested`. I think a lot of these could be tested in sensible ways. For example, if word_problem returned a list of *tuples* rather than lists (which is more natural), then one could do
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83956",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83957",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>What Robert meant was:\n\n```\nsage: G.<a,b,c> = AbelianGroup(3,[2,3,4])\nsage: w = word_problem([a*b,a*c], b*c)\nsage: b*c == prod(g^e for g,e in w)\nTrue\n```",
    "created_at": "2010-02-02T13:39:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83958",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:3'></a>What Robert meant was:
...
```json
{
    "body": "<a id='comment:4'></a>> These changes actually would also work for 4.4.10 (not tested, but pretty sure)\n\n\nI applied the patch and tested this. Yes, this is basically correct, except for the gap.version() tests.\n\nI now will test the patch after the 4.4.12 spkg is applied.",
    "created_at": "2010-02-02T20:47:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83959",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:4'></a>> These changes actually would also work for 4.4.10 (not tested, but pretty sure)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83960",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>It's just not a question of whether it passes tests, having huge blocks of `# not tested` is undesireable as well. There have been better suggestions on the mailing list which should be incorporated into this patch.",
    "created_at": "2010-02-02T20:57:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83961",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>It's just not a question of whether it passes tests, having huge blocks of `# not tested` is undesireable as well. There have been better suggestions on the mailing list which should be incorporated into this patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83962",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83963",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Sorry, I should have added that the last failure I reported was unrelated (it was on a mac 10.6.2, where this segfault wasthe only failure on a clean install of 4.3.2.a1). Looks like you have fixed everything then!\n\nLet me know when a new patch is available and if I should apply it on top of the old patch or not.",
    "created_at": "2010-02-03T11:41:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83964",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:8'></a>Sorry, I should have added that the last failure I reported was unrelated (it was on a mac 10.6.2, where this segfault wasthe only failure on a clean install of 4.3.2.a1). Looks like you have fixed everything then!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83965",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83966",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83967",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83968",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>With both patches applied (and the 4.4.12 gap spkg) , this now passes sage -testall except for the segfault already reported.\n\nPositive review but maybe this should be tested on other platforms?\n\nThanks Dima!",
    "created_at": "2010-02-03T18:25:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83969",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:10'></a>With both patches applied (and the 4.4.12 gap spkg) , this now passes sage -testall except for the segfault already reported.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83971",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83972",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83973",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Sorry Robert, I guess I misunderstood and should not have given it the positive review.\n\nI'm retesting the new patch now.",
    "created_at": "2010-02-04T12:36:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83975",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:13'></a>Sorry Robert, I guess I misunderstood and should not have given it the positive review.
...
```json
{
    "body": "<a id='comment:14'></a>Passes as before. \n\nI'll leave it to Robert Bradshaw now to decide if it should receive a positive review.",
    "created_at": "2010-02-04T14:24:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83976",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:14'></a>Passes as before. 
...
```json
{
    "body": "<a id='comment:15'></a>Looks very good now. I agree that the irreducible_characters one is ugly enough to go in TESTS, and thanks wdj for running all the tests again. I say it's ready to go in.",
    "created_at": "2010-02-04T18:26:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83977",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:15'></a>Looks very good now. I agree that the irreducible_characters one is ugly enough to go in TESTS, and thanks wdj for running all the tests again. I say it's ready to go in.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83978",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83979",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83980",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83981",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83982",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83983",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Merged [trac-8150.patch](http://trac.sagemath.org/sage_trac/attachment/ticket/8150/trac-8150.patch) with a sensible commit message containing the ticket number.",
    "created_at": "2010-02-17T20:53:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8150#issuecomment-83984",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:18'></a>Merged [trac-8150.patch](http://trac.sagemath.org/sage_trac/attachment/ticket/8150/trac-8150.patch) with a sensible commit message containing the ticket number.
