...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8769#event-101052"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8769#event-101053"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8769#issuecomment-73040",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8769#issuecomment-73041",
    "user": "https://github.com/williamstein"
}
```
