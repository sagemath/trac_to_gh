...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63480",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8052#event-56019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63481",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63482",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8052/configure.ac.patch",
    "created_at": "2010-01-26T11:34:53Z",
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8052/configure.ac.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "prereq-install.patch",
    "asset_url": "tarball://root/attachments/ticket8052/prereq-install.patch",
    "created_at": "2010-01-26T11:34:53Z",
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8052/prereq-install.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "**Attachment:** [configure.ac.patch](https://github.com/sagemath/sage/files/ticket8052/configure.ac.patch)\n\n**Attachment:** [prereq-install.patch](https://github.com/sagemath/sage/files/ticket8052/prereq-install.patch)\n\npatch against prereq-install of prereq-0.6",
    "created_at": "2010-01-26T11:34:53Z",
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63483",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

**Attachment:** [configure.ac.patch](https://github.com/sagemath/sage/files/ticket8052/configure.ac.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63484",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63485",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8052#event-56020"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8052#event-56021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63486",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63487",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8052#event-56022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8052#event-56023"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8052#issuecomment-63488",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
