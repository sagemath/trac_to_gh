...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95880",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95881",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95882",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>> but forgot we can't do that.  Is it legitimate to put #not tested with\n> this doctest as a fix, since it is important to have the example\n> there?\n\nFrom was:\n\n```\nAnother option:\n\n1. make sufpre the png file you are about to write doesn't exist in the current directory, then write it.\n2. then delete it!\n\n\n# not tested should be avoided at all costs.\n```",
    "created_at": "2010-04-30T14:19:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95883",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>> but forgot we can't do that.  Is it legitimate to put #not tested with
> this doctest as a fix, since it is important to have the example
> there?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95884",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95885",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_8817-R-plot-file-remove.patch](tarball://root/attachments/some-uuid/ticket8817/trac_8817-R-plot-file-remove.patch) by @kcrisman created at 2010-04-30 15:05:48\n\nOkay, try this - it is VERY explicit.  I also replaced occurrences of os.unlink with os.remove, which is identical but makes far more sense to those who are not familiar with the unlink command (like me).",
    "created_at": "2010-04-30T15:05:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95886",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Attachment [trac_8817-R-plot-file-remove.patch](tarball://root/attachments/some-uuid/ticket8817/trac_8817-R-plot-file-remove.patch) by @kcrisman created at 2010-04-30 15:05:48
...
```json
{
    "body": "<a id='comment:5'></a>I really don't like this very brittle and dangerous patch.  I've posted a new patch.  Please review. I've included this in alpha3 anyways.\n\nWilliam",
    "created_at": "2010-05-01T05:16:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95887",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>I really don't like this very brittle and dangerous patch.  I've posted a new patch.  Please review. I've included this in alpha3 anyways.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95888",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95889",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95890",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The directory named by the environment variable `SAGE_TMP` is where junk files can go. Such junk files include temporary files generated during doctesting.",
    "created_at": "2010-05-02T23:57:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95891",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:6'></a>The directory named by the environment variable `SAGE_TMP` is where junk files can go. Such junk files include temporary files generated during doctesting.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95892",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8817#issuecomment-95893",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
