...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73697",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73698",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73699",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73700",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac_8817-R-plot-file-remove.patch](https://github.com/sagemath/sage/files/ticket8817/trac_8817-R-plot-file-remove.patch) by @kcrisman created at 2010-04-30 15:05:48\n\nOkay, try this - it is VERY explicit.  I also replaced occurrences of os.unlink with os.remove, which is identical but makes far more sense to those who are not familiar with the unlink command (like me).",
    "created_at": "2010-04-30T15:05:48Z",
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73701",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73702",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [trac_8817-wstein.patch](https://github.com/sagemath/sage/files/ticket8817/trac_8817-wstein.patch) by @williamstein created at 2010-05-01 05:17:04",
    "created_at": "2010-05-01T05:17:04Z",
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73703",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac_8817-wstein.patch](https://github.com/sagemath/sage/files/ticket8817/trac_8817-wstein.patch) by @williamstein created at 2010-05-01 05:17:04
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73704",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73705",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73706",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8817#issuecomment-73707",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
