...
<a id='comment:1'></a>Yes, this is an error
...
```json
{
    "body": "<a id='comment:2'></a>I think, this in fact can be closed as a duplicate of the ticket you mention (#9831).\n\nReplying to [lftabera](#comment%3A1):\n> Yes, this is an error\n> \n> [1,2,3,1] dos not define a permutation, so the method should raise an error. See also #9831",
...
<a id='comment:2'></a>I think, this in fact can be closed as a duplicate of the ticket you mention (#9831).
...
```json
{
    "body": "<a id='comment:4'></a>One of a few tickets like this. Bonus points if you can find them all.\n\nAlso, don't forget to set this to needs_review. Thanks.",
    "created_at": "2013-01-29T19:46:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8918",
    "type": "issue_comment",
...
<a id='comment:4'></a>One of a few tickets like this. Bonus points if you can find them all.
