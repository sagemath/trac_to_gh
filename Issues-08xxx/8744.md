...
```json
{
    "body": "<a id='comment:13'></a>\nReplying to [David Coudert](#comment%3A12):\n> You should use `self.connected_component_containing_vertex(v, sort=False)`.\n\nGood spot, thanks!\n\n> For coding style, prefer `old_left = frozenset(self.left)` with spaces around `=`.\n\nThanks, will do this tomorrow.\n\n---\nNew commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[c46e838](https://git.sagemath.org/sage.git/commit?id=c46e83804a3221529c7477dd350662c701540414)|`refactoring + improvements + warning + doctests`|",
    "created_at": "2022-11-18T19:40:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8744",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nUpdate: I've implemented the algorithm to check whether adding a set of edges is possible\n\n---\nNew commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[7d92dfd](https://git.sagemath.org/sage.git/commit?id=7d92dfda14062fc3e81325c76801b129430e907d)|`formatting + docs and doctest + removed warning`|\n|[5cebd58](https://git.sagemath.org/sage.git/commit?id=5cebd5861bcfd8744224949bb5c6d97f837e6b51)|`add_edges is now all-or-nothing + tests`|",
    "created_at": "2022-11-24T17:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8744",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[8eb29c8](https://git.sagemath.org/sage.git/commit/?id=8eb29c80b559f550a78f4b0c1be8647cc9892483)|`trac #8744: better loop`|",
    "created_at": "2022-12-10T16:44:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8744",
    "type": "issue_comment",
