...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65608",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_8235.patch](https://github.com/sagemath/sage/files/ticket8235/trac_8235.patch) by wcauchois created at 2010-02-11 01:10:51\n\nIts not terribly pretty, but this should fix it.",
    "created_at": "2010-02-11T01:10:51Z",
    "issue": "https://github.com/sagemath/sage/issues/8235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65609",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65610",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65611",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65612",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65613",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65614",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8235#issuecomment-65615",
    "user": "https://github.com/qed777"
}
```
