...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8878#issuecomment-84648",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8878#issuecomment-84649",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The link to sage-combinat is dead.\n\n(Posting this mainly to get a CC on this ticket.)",
    "created_at": "2013-06-22T23:29:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8878#issuecomment-84650",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:3'></a>The link to sage-combinat is dead.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8878#issuecomment-84651",
    "user": "https://github.com/nthiery"
}
```
