...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8018#issuecomment-63094",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8018#issuecomment-63095",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "asset_name": "trac_8018-numerical-eigenforms.patch",
    "asset_url": "tarball://root/attachments/ticket8018/trac_8018-numerical-eigenforms.patch",
    "created_at": "2010-01-24T05:25:32Z",
    "issue": "https://github.com/sagemath/sage/issues/8018",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8018/trac_8018-numerical-eigenforms.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "Attachment [trac_8018-numerical-eigenforms.patch](https://github.com/sagemath/sage/files/ticket8018/trac_8018-numerical-eigenforms.patch) by @rbeezer created at 2010-01-24 05:25:32",
    "created_at": "2010-01-24T05:25:32Z",
    "issue": "https://github.com/sagemath/sage/issues/8018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8018#issuecomment-63096",
    "user": "https://github.com/rbeezer"
}
```

Attachment [trac_8018-numerical-eigenforms.patch](https://github.com/sagemath/sage/files/ticket8018/trac_8018-numerical-eigenforms.patch) by @rbeezer created at 2010-01-24 05:25:32
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8018#issuecomment-63097",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8018#issuecomment-63098",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8018#issuecomment-63099",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8018#issuecomment-63100",
    "user": "https://github.com/jhpalmieri"
}
```
