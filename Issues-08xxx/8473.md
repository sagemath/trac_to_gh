...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96819"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96829"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,6 +10,13 @@\n \n would be a very good step in this direction.\n \n-Apply only trac_8473-sagenb.2.patch\n+Apply only [attachment: trac_8473-sagenb.2.patch.gz](https://github.com/sagemath/sage/files/ticket8473/trac_8473-sagenb.2.patch.gz)\n+\n+Syntax is \n+\n+```\n+sage -notebook upload=\"/path/to/worksheet.sws\"\n+```\n+\n \n The changes to extcode (specifically for the Mac app) have been moved to #11026.\n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96832"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,7 +10,7 @@\n \n would be a very good step in this direction.\n \n-Apply only [attachment: trac_8473-sagenb.2.patch.gz](https://github.com/sagemath/sage/files/ticket8473/trac_8473-sagenb.2.patch.gz)\n+Depends on #693; apply only [attachment: trac_8473-sagenb.2.patch.gz](https://github.com/sagemath/sage/files/ticket8473/trac_8473-sagenb.2.patch.gz)\n \n Syntax is \n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96834"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,7 +10,7 @@\n \n would be a very good step in this direction.\n \n-Depends on #693; apply only [attachment: trac_8473-sagenb.2.patch.gz](https://github.com/sagemath/sage/files/ticket8473/trac_8473-sagenb.2.patch.gz)\n+Depends on #693; apply only [attachment: trac_8473-sagenb.2.patch.gz](https://github.com/sagemath/sage/files/ticket8473/trac_8473-sagenb.2.patch.gz) to the notebook repository.\n \n Syntax is \n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96835"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96836"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96837"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96840"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69192",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69193",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69194",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69195",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69196",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69197",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69198",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8473#issuecomment-69199",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96847"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8473",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8473#event-96848"
}
```
