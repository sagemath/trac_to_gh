...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85928",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I was able to get Maxima to build in Cygwin with ECL 10.3.1 and the spkg at http://sage.math.washington.edu/home/mhansen/cygwin_port/maxima-5.20.1.p0.spkg . Everything builds correctly except building maxima as a library at the end:\n\n```\ncd src\necho \"building Maxima as an ecl library\"\necl -eval \"(require 'asdf)\" -eval '(load \"maxima-build.lisp\")' -eval  '(asdf:make-build :maxima :type :fasl)' -eval \"(quit)\"\nECLLIB=`ecl -eval \"(princ (SI:GET-LIBRARY-PATHNAME))\" -eval \"(quit)\"`\necho\necho \"installing Maxima library as $ECLLIB/maxima.fas\"\ncp maxima.fasb $ECLLIB/maxima.fas\ncd ..\n```\n\nAll of the building commands run correctly, but there is no \"maxima.fasb\" file produced.",
    "created_at": "2010-03-13T07:16:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85931",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:6'></a>I was able to get Maxima to build in Cygwin with ECL 10.3.1 and the spkg at http://sage.math.washington.edu/home/mhansen/cygwin_port/maxima-5.20.1.p0.spkg . Everything builds correctly except building maxima as a library at the end:
...
```json
{
    "body": "<a id='comment:7'></a>This can be fixed by using ECL from #8645 and Maxima from #8645 or #8731",
    "created_at": "2010-04-27T17:35:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85932",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>This can be fixed by using ECL from #8645 and Maxima from #8645 or #8731
...
```json
{
    "body": "<a id='comment:8'></a>Mike, this one should be closed, right?  Note that in the mean time #11502 and #11260 seem to have raised different issues... aargh.",
    "created_at": "2011-06-16T14:27:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85933",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Mike, this one should be closed, right?  Note that in the mean time #11502 and #11260 seem to have raised different issues... aargh.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85935",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85936",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85937",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85938",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8269#issuecomment-85939",
