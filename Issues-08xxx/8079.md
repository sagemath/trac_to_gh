...
```json
{
    "body": "<a id='comment:6'></a>\nThe attachment [trac_8079-patching-spkgs.patch](https://github.com/sagemath/sage/files/ticket8079/trac_8079-patching-spkgs.patch) adds a chapter to the Developer's Guide, explaining how to patch an existing spkg. This attachment also solves the issues reported at #8104 and #3882. Once this ticket is closed, tickets #8104 and #3882 can also be closed as fixed.",
