...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84510",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84512",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84513",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Actually, I think using the newer version of graph_editor just delays the error message until you run some graph theory command like `graphs.CompleteGraph(2)`.  \n\nHere's a patch which does fix the problem, I think.",
    "created_at": "2010-02-04T02:48:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84514",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Actually, I think using the newer version of graph_editor just delays the error message until you run some graph theory command like `graphs.CompleteGraph(2)`.  
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_8180-kpsewhich.patch](tarball://root/attachments/some-uuid/ticket8180/trac_8180-kpsewhich.patch) by @williamstein created at 2010-02-04 02:57:57",
    "created_at": "2010-02-04T02:57:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84515",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Attachment [trac_8180-kpsewhich.patch](tarball://root/attachments/some-uuid/ticket8180/trac_8180-kpsewhich.patch) by @williamstein created at 2010-02-04 02:57:57
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84516",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84517",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84518",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84519",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>The patch does not prevent this error message occuring on Solaris. I have created another ticket, #8445 to preport the same problem still existing. \n\nDave",
    "created_at": "2010-03-05T13:46:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8180#issuecomment-84520",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:7'></a>The patch does not prevent this error message occuring on Solaris. I have created another ticket, #8445 to preport the same problem still existing. 
