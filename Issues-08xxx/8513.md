...
```json
{
    "body": "<a id='comment:1'></a>Wait until Sage 4.3.4 is released. I expect that release to fix all the warnings relating to building the HTML and PDF versions of the Sage standard documentation. At least, I expect that release to fix such warnings for the reference manual.",
    "created_at": "2010-03-13T00:33:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90595",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>Wait until Sage 4.3.4 is released. I expect that release to fix all the warnings relating to building the HTML and PDF versions of the Sage standard documentation. At least, I expect that release to fix such warnings for the reference manual.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90597",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90598",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Finally, since there weren't too many warnings, I think it's worth trying to fix all of them. This is done in the patch I just submitted.\n\nTo summarize, this patch adds the two files digraph.py and generic_graph.py to the reference manual and correct the less than 10 warnings that Sphinx was displaying.\n\nNeeds review!",
    "created_at": "2010-03-22T19:51:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90599",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

<a id='comment:3'></a>Finally, since there weren't too many warnings, I think it's worth trying to fix all of them. This is done in the patch I just submitted.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90600",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90601",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Excellent ! Now we appear in the doc, and there are no warnings anymore.\n\nReviewing your patch, I met a few things that needed fixing in the docs, so if you agree with my modifications, you can set this to positive review.. Thank you !! :-)\n\nNathann",
    "created_at": "2010-03-23T10:54:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90602",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Excellent ! Now we appear in the doc, and there are no warnings anymore.
...
```json
{
    "body": "<a id='comment:7'></a>No idea... Anyway, I'll try it with the sage-combinat queue to look at the documentation generated by your patch and it should be fine.",
    "created_at": "2010-03-23T14:08:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90605",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

<a id='comment:7'></a>No idea... Anyway, I'll try it with the sage-combinat queue to look at the documentation generated by your patch and it should be fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90606",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I have replaced ncohen's patch with one that has the ticket number in its commit message.",
    "created_at": "2010-04-12T20:01:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90607",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:8'></a>I have replaced ncohen's patch with one that has the ticket number in its commit message.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90608",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90609",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Alexandre Blondin Mass\u00e9, Nathann Cohen\"",
    "created_at": "2010-04-12T22:18:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90610",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

Changing author from "" to "Alexandre Blondin Massé, Nathann Cohen"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90611",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I'm running the longtest on all sage right now. Giving some feedback later tonight.",
    "created_at": "2010-04-12T22:51:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90613",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```

<a id='comment:12'></a>I'm running the longtest on all sage right now. Giving some feedback later tonight.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90614",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90615",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>> My reviewer patch should fix this doctest failure. It needs reviewing by anyone but me.\n\n\nYour patch fixes the problem, but it doesn't really fit in sagedoc.py: the doctests there are supposed to contrast what happens if `whole_word=True` is not used (more than 2000 matches) vs. when it is (used to be fewer than 100 matches).  How about changing it to `len(...) < 150` or `len(...) < 200`?",
    "created_at": "2010-04-12T23:25:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90616",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:13'></a>> My reviewer patch should fix this doctest failure. It needs reviewing by anyone but me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90617",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90618",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90619",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I'm happy with the reviewer patch now.  After rebuilding the docs, all tests pass on sage.math.  Does that mean the whole ticket gets a positive review?",
    "created_at": "2010-04-13T02:56:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90620",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:15'></a>I'm happy with the reviewer patch now.  After rebuilding the docs, all tests pass on sage.math.  Does that mean the whole ticket gets a positive review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90621",
    "user": "https://trac.sagemath.org/admin/accounts/users/abmasse"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Replying to [jhpalmieri](#comment%3A15):\n> I'm happy with the reviewer patch now.  After rebuilding the docs, all tests pass on sage.math.  Does that mean the whole ticket gets a positive review?\n\n\nI think so. Cleaning up the modules added by this ticket to the reference manual can be split off to an enhancement ticket.",
    "created_at": "2010-04-13T23:33:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90622",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:17'></a>Replying to [jhpalmieri](#comment%3A15):
> I'm happy with the reviewer patch now.  After rebuilding the docs, all tests pass on sage.math.  Does that mean the whole ticket gets a positive review?
...
```json
{
    "body": "<a id='comment:18'></a>See #8684 for a follow-up ticket, the purpose of which is to organize the graph theory stuff in the reference manual.  I'm not going to do this myself, since I don't know enough about graph theory in general, or the graph theory in Sage, to know how to organize it.",
    "created_at": "2010-04-14T05:24:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90623",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:18'></a>See #8684 for a follow-up ticket, the purpose of which is to organize the graph theory stuff in the reference manual.  I'm not going to do this myself, since I don't know enough about graph theory in general, or the graph theory in Sage, to know how to organize it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90624",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90625",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90626",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8513",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8513#issuecomment-90627",
    "user": "https://github.com/jhpalmieri"
}
```
