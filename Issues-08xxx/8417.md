...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88739",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>the provided patch does also some 'cosmetic' changes, replacing \n`range(2*n)[n:]`with `range(n,2*n)`.",
    "created_at": "2010-03-02T11:03:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88740",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:1'></a>the provided patch does also some 'cosmetic' changes, replacing 
`range(2*n)[n:]`with `range(n,2*n)`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88741",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88742",
...
```json
{
    "body": "<a id='comment:2'></a>Apply both patches in order.",
    "created_at": "2010-03-09T16:56:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88743",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:2'></a>Apply both patches in order.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88744",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88746",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_8417-ref.patch](tarball://root/attachments/some-uuid/ticket8417/trac_8417-ref.patch) by @rlmill created at 2010-03-09 18:23:57\n\nReplying to [comment:3 ylchapuy]:\n> Beware, with your patch applied I get:\n\n\nThank you for pointing this out. I've reverted that part of the patch.\n\nCan you see any way to make the overhead from checking in this case any better? Also, what do you think about a check=False option in graph construction, more generally?",
    "created_at": "2010-03-09T18:23:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88747",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>Attachment [trac_8417-ref.patch](tarball://root/attachments/some-uuid/ticket8417/trac_8417-ref.patch) by @rlmill created at 2010-03-09 18:23:57
...
```json
{
    "body": "<a id='comment:5'></a>Merged into 4.4.alpha0:\n- trac_8417.patch\n- trac_8417-ref.patch",
    "created_at": "2010-04-15T23:49:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88748",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Merged into 4.4.alpha0:
- trac_8417.patch
- trac_8417-ref.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88749",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8417#issuecomment-88750",
    "user": "https://github.com/jhpalmieri"
}
```
