...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98655"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98657"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98658"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8601#issuecomment-70638",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8601#issuecomment-70639",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98661"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8601",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8601#event-98665"
}
```
