...
```json
{
    "body": "<a id='comment:1'></a>This seems to be fixed in the meanwhile. attachment:trac_8345-doctest.patch adds a doctest.",
    "created_at": "2011-06-01T14:12:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87533",
    "user": "https://github.com/burcin"
}
```

<a id='comment:1'></a>This seems to be fixed in the meanwhile. attachment:trac_8345-doctest.patch adds a doctest.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87534",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87535",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87536",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87537",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This patch does not apply to 4.7.1.alpha1 because of a blank line someone must have removed earlier.  Unfortunately, I can't figure out how to fix the patch easily (so that Burcin remains the author of the patch), so it will have to be rebased.  Hopefully that won't be too much trouble :(\n\nThis also exposes a different problem - that our variables are assumed to be real.  This is known elsewhere.\n\n```\nsage: latex(x.conjugate())\n\\overline{x}\nsage: latex(x.conjugate().simplify())\nx\n```\n\nNot sure if that needs to be addressed on this ticket, though.",
    "created_at": "2011-06-08T19:58:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87538",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>This patch does not apply to 4.7.1.alpha1 because of a blank line someone must have removed earlier.  Unfortunately, I can't figure out how to fix the patch easily (so that Burcin remains the author of the patch), so it will have to be rebased.  Hopefully that won't be too much trouble :(
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87539",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87541",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Okay, thanks - and thanks for the tip, in the last few months I've finally started using queues.\n\nI already tried several things yesterday, so all is well.  Positive review.\n\nIncidentally, this has been fixed for a *while*:\n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nLoading Sage library. Current Mercurial branch is: hackbranch\nsage: assume(x,'complex')\nsage: latex(x.conjugate().simplify())\n\\overline{x}\nsage: \n```\n| Sage Version 4.4.4, Release Date: 2010-06-23                       |\n| Type notebook() for the GUI, and license() for information.        |\n---\nApply [attachment:trac_8345-doctest.patch].",
    "created_at": "2011-06-09T13:28:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87542",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>Okay, thanks - and thanks for the tip, in the last few months I've finally started using queues.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87543",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87544",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8345#issuecomment-87545",
    "user": "https://github.com/jdemeyer"
}
```
