...
```json
{
    "body": "Attachment [trac_8921_7d_cross_product.patch](https://github.com/sagemath/sage/files/ticket8921/trac_8921_7d_cross_product.patch) by bwonderly created at 2010-05-07 18:45:38",
    "created_at": "2010-05-07T18:45:38Z",
    "issue": "https://github.com/sagemath/sage/issues/8921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8921#issuecomment-74966",
    "user": "https://trac.sagemath.org/admin/accounts/users/bwonderly"
}
```

Attachment [trac_8921_7d_cross_product.patch](https://github.com/sagemath/sage/files/ticket8921/trac_8921_7d_cross_product.patch) by bwonderly created at 2010-05-07 18:45:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8921#issuecomment-74967",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8921#issuecomment-74968",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8921#event-64294"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8921#event-64295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8921#event-64296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8921#issuecomment-74969",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8921#issuecomment-74970",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8921#issuecomment-74971",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8921#event-64297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8921",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8921#event-64298"
}
```
