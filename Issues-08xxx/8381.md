...
```json
{
    "body": "Attachment [15468.patch](https://github.com/sagemath/sage/files/ticket8381/15468.patch) by fdiebold created at 2011-05-22 20:06:28\n\nRemove \\mathop and \\mathrm when displaying docs in python",
    "created_at": "2011-05-22T20:06:28Z",
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67770",
    "user": "https://trac.sagemath.org/admin/accounts/users/fdiebold"
}
```

Attachment [15468.patch](https://github.com/sagemath/sage/files/ticket8381/15468.patch) by fdiebold created at 2011-05-22 20:06:28
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67771",
    "user": "https://trac.sagemath.org/admin/accounts/users/fdiebold"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67772",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67773",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67774",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67775",
    "user": "https://trac.sagemath.org/admin/accounts/users/fdiebold"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67776",
    "user": "https://trac.sagemath.org/admin/accounts/users/fdiebold"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8381#issuecomment-67777",
    "user": "https://github.com/jdemeyer"
}
```
