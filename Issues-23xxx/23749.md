...
```json
{
    "body": "The reduction data of an element class shouldn't be passed to the `dynamic_class` function, but should be assigned to the resulting class later, to circumvent the cache.",
