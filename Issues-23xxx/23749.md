...
```json
{
    "body": "<a id='comment:1'></a>The reduction data of an element class shouldn't be passed to the `dynamic_class` function, but should be assigned to the resulting class later, to circumvent the cache.",
    "created_at": "2017-08-30T08:39:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23749#issuecomment-448137",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>The reduction data of an element class shouldn't be passed to the `dynamic_class` function, but should be assigned to the resulting class later, to circumvent the cache.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23749#issuecomment-448138",
    "user": "https://github.com/simon-king-jena"
}
```
