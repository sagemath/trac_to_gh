...
```json
{
    "body": "<a id='comment:20'></a>Actually, I have another question:[comment:6](#comment%3A6). If you don't want to, it's fine, but just a thought (at least, I don't recall you saying anything about it previous, sorry if you did). Both of these are primarily for Fr\u00e9d\u00e9ric.",
...
<a id='comment:20'></a>Actually, I have another question:[comment:6](#comment%3A6). If you don't want to, it's fine, but just a thought (at least, I don't recall you saying anything about it previous, sorry if you did). Both of these are primarily for Frédéric.
