...
```json
{
    "body": "<a id='comment:38'></a>png patch was missing from Gonzalo's branch; we now add it, and it fixed comment:36",
...
<a id='comment:38'></a>png patch was missing from Gonzalo's branch; we now add it, and it fixed comment:36
