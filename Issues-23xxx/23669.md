...
```json
{
    "body": "A simple heuristic to avoid the issue is to limit the expansion of construction functors in `pushout()` to cases where it results in a reasonably small number of elementary functors. This is neither super elegant nor super robust, but `pushout()` itself is a heuristic in the first place...\n\n---\nNew commits:",
    "created_at": "2018-02-07T14:06:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331159",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331160",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331161",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331162",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331163",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23669#event-60858"
}
```
...
```json
{
    "body": "Since `_expand_threshold` is completely static it would better be a class attribute.",
    "created_at": "2018-05-01T13:06:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331164",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331165",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331167",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "I think we discussed the issue verbally in Bordeaux, and that I convinced myself at the time that breaking this example was an acceptable trade-off. But I don't remember the details (and I'm not planning to work on this ticket any further for the moment).",
    "created_at": "2018-05-01T13:24:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331168",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23669#event-60859"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23669#event-60860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331169",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23669#issuecomment-331170",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
