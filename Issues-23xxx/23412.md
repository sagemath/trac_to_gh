...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23412#event-307886"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23412#event-307887"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23412#event-307888"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23412#event-307889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23412#issuecomment-354388",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23412#issuecomment-354389",
    "user": "https://github.com/annahaensch"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23412#event-307890"
}
```
