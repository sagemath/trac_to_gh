...
```json
{
    "body": "<a id='comment:3'></a>\nI ended up doing some additional things:\n\n* Remove some old code related to lazy p-adics (since I was changing the key format anyway)\n* Change the printing of unramified and eisenstein extensions\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|\n|[7e21e77](https://git.sagemath.org/sage.git/commit?id=7e21e774b084f947cdccc455d4f1f1b03c872837)|`Adding an exact modulus to p-adic rings and fields, changing printing for p-adic extensions, removing some vestigal lazy p-adic code`|\n|[dbbc631](https://git.sagemath.org/sage.git/commit?id=dbbc631feff9dbf4f3a37825329263d640290202)|`Fix pickles`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[6cb9d22](https://git.sagemath.org/sage.git/commit/?id=6cb9d22e018af5672f54d2ba657ae354283098a8)|`Remove extraneous newlines in padic_ZZ_pX_FM_element.pyx`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[7f96697](https://git.sagemath.org/sage.git/commit/?id=7f966970ce066669c13ec27ef5d6c13eaf6441dd)|`Fixed typo with variable assignment`|\n|[bbb7268](https://git.sagemath.org/sage.git/commit/?id=bbb7268c1692a0068a9d4bd5ae7624eadf321454)|`added doctests`|\n|[ee461b6](https://git.sagemath.org/sage.git/commit/?id=ee461b61afa23c587307df64a64df219deb0b1c9)|`merge with develop`|\n|[8081eab](https://git.sagemath.org/sage.git/commit/?id=8081eab7fac81a3cef7d40133937bc2ca01baa38)|`added doctests after fixing conflicts`|\n|[063b58c](https://git.sagemath.org/sage.git/commit/?id=063b58cfb2a52bfb3bd4917e5a400a37ed03a0c2)|`Merge branch 'develop' into t/20073/ticket/20073`|\n|[48be601](https://git.sagemath.org/sage.git/commit/?id=48be601fe35d7d56ec6cbbb6d21bb6921230b7eb)|`Added documentation to verify that the extension has the right defining polynomial`|\n|[921af5e](https://git.sagemath.org/sage.git/commit/?id=921af5e95be38203770443d6d9f6e8c9f123d269)|`Changing modulus and defining_polynomial to use an exact keyword`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nPositive review once the patchbot is happy.\n\n---\nNew commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[77779ea](https://git.sagemath.org/sage.git/commit?id=77779eabdebc98cb503fe2e432a90745c8390aab)|`minor docstring changes`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[e9c4c39](https://git.sagemath.org/sage.git/commit/?id=e9c4c394066d9ce451b500a2ddf9572a488d006f)|`Merge branch 'u/roed/allow_exact_defining_polynomials_for_p_adic_extensions' of git://trac.sagemath.org/sage into t/23331/allow_exact_defining_polynomials_for_p_adic_extensions`|",
    "created_at": "2017-08-02T17:31:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23331",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[561f5ac](https://git.sagemath.org/sage.git/commit/?id=561f5ac333b00f5e4a2ee70b82e2b5e4965876b3)|`Fix doctest errors`|",
    "created_at": "2017-08-02T17:54:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23331",
    "type": "issue_comment",
