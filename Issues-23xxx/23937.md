...
archive/attachments_021679.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [0001-added-initial-.gitlab-ci.yml.patch](https://github.com/sagemath/sage/files/ticket23937/0001-added-initial-.gitlab-ci.yml.patch)\n\nThis doesn't actually seem to work due to the 2 hour time limit. Are we allowed to use multiple processors?",
    "created_at": "2017-10-13T08:34:40Z",
    "issue": "https://github.com/sagemath/sage/issues/23937",
    "type": "issue_comment",
