...
```json
{
    "body": "<a id='comment:1'></a>Attachment [0001-added-initial-.gitlab-ci.yml.patch](tarball://root/attachments/some-uuid/ticket23937/0001-added-initial-.gitlab-ci.yml.patch) by @jdemeyer created at 2017-10-13 08:34:40\n\nThis doesn't actually seem to work due to the 2 hour time limit. Are we allowed to use multiple processors?",
    "created_at": "2017-10-13T08:34:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23937#issuecomment-451944",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Attachment [0001-added-initial-.gitlab-ci.yml.patch](tarball://root/attachments/some-uuid/ticket23937/0001-added-initial-.gitlab-ci.yml.patch) by @jdemeyer created at 2017-10-13 08:34:40
...
```json
{
    "body": "<a id='comment:2'></a>And use ccache?",
    "created_at": "2017-10-13T08:34:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23937#issuecomment-451945",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>And use ccache?
...
```json
{
    "body": "<a id='comment:4'></a>Replying to [kprichter](#comment%3A3):\n> > And use ccache?\n\n> \n> It's a program that can be installed into Docker. It might have a very limited effect because the docker images are thrown away after each build.\n\n\nAnd there is no way to keep persistent data, like in Travis CI? This would make an important difference.",
    "created_at": "2017-10-13T15:16:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23937#issuecomment-451947",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>Replying to [kprichter](#comment%3A3):
> > And use ccache?
...
```json
{
    "body": "<a id='comment:5'></a>>  And there is no way to keep persistent data, like in Travis CI? This would make an important difference. \n\n\nMaybe. You can create your own Docker image which already has the data in it after booting the container.",
    "created_at": "2017-10-13T15:29:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23937#issuecomment-451948",
    "user": "https://trac.sagemath.org/admin/accounts/users/kprichter"
}
```

<a id='comment:5'></a>>  And there is no way to keep persistent data, like in Travis CI? This would make an important difference. 
...
```json
{
    "body": "<a id='comment:6'></a>Unfortunate that I never saw this ticket before.  Nevertheless, this is basically now done, albeit a little more complex than the specific solution proposed here: #24655",
    "created_at": "2018-09-10T16:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23937#issuecomment-451949",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>Unfortunate that I never saw this ticket before.  Nevertheless, this is basically now done, albeit a little more complex than the specific solution proposed here: #24655
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23937",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23937#event-60904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23937#issuecomment-451950",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23937#event-60905"
}
```
