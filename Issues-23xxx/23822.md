...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449623",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449624",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449625",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449626",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449627",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449628",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449629",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449630",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Do you need the `.decode`, or can you just use\n\n```\nstdout = proc.communicate()[0]\n```\n?",
    "created_at": "2017-09-18T15:49:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449631",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>Do you need the `.decode`, or can you just use
...
```json
{
    "body": "<a id='comment:5'></a>In python 2 it is not needed but good praxis.  In python 3 it is needed since stdout is a bytestring before decoding and the json library only takes unicode strings and not bytestrings as input.",
    "created_at": "2017-09-18T21:49:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449632",
    "user": "https://github.com/koffie"
}
```

<a id='comment:5'></a>In python 2 it is not needed but good praxis.  In python 3 it is needed since stdout is a bytestring before decoding and the json library only takes unicode strings and not bytestrings as input.
...
```json
{
    "body": "<a id='comment:7'></a>I could have sworn that I only added the decode() because it was failing otherwise. But sage was already on 3.6 when I wrote this. I dont think either solution is clearly better then the other. But the one with a decode already has positive review so I propose to leave it as is.",
    "created_at": "2017-09-18T22:36:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449634",
    "user": "https://github.com/koffie"
}
```

<a id='comment:7'></a>I could have sworn that I only added the decode() because it was failing otherwise. But sage was already on 3.6 when I wrote this. I dont think either solution is clearly better then the other. But the one with a decode already has positive review so I propose to leave it as is.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449635",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23822#event-60729"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23822#issuecomment-449636",
    "user": "https://github.com/vbraun"
}
```
