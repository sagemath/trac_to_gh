...
```json
{
    "body": "<a id='comment:8'></a>\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[b290110](https://git.sagemath.org/sage.git/commit?id=b290110728a3f2bdc4024b6cfc9e56fe60dea27d)|`Better exceptions when Cremona database lookup fails`|\n|[b7825ff](https://git.sagemath.org/sage.git/commit?id=b7825ff9567577b6b9cd12c32f57a337aff8efd2)|`Don't use invalid Cremona labels from elliptic_curves database`|",
    "created_at": "2017-08-11T14:17:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23609",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------|\n|[4e7f810](https://git.sagemath.org/sage.git/commit/?id=4e7f8103d08ac132c0324a09d1a2ae8e960ee9d8)|`Typo`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[5ef3ae1](https://git.sagemath.org/sage.git/commit/?id=5ef3ae13b49ca3c71a51f90058a0d8cc4b106012)|`Better exceptions when Cremona database lookup fails`|\n|[dfbd9a6](https://git.sagemath.org/sage.git/commit/?id=dfbd9a6a2bb0c405c7fc1a92a6729cf3d3dad5fd)|`Don't use invalid Cremona labels from elliptic_curves database`|",
