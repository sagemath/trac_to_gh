...
```json
{
    "body": "<a id='comment:2'></a>\nI did not run any doctests yet (still rebuilding sage.)\n\n---\nNew commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[8051942](https://git.sagemath.org/sage.git/commit?id=8051942732eb094eca775f2a6ad91b361c3c5e1f)|`is_squarefree() for p-adics`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[3875877](https://git.sagemath.org/sage.git/commit/?id=3875877441a7715c8ee032ff3dd36f625c57f6ac)|`simplify field case`|",
