...
```json
{
    "body": "To answer my own question, no, this won't do it. The file `DOT_SAGE/ipython-5.0.0/profile_default/history.sqlite` is still modified when doctesting `sage/misc/trace.py`, and the command history is modified accordingly.",
