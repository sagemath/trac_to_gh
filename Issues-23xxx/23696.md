...
```json
{
    "body": "<a id='comment:31'></a>\nAll right, it is time to move ahead. Please review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[c35f93f](https://git.sagemath.org/sage.git/commit?id=c35f93f1db89eea6a53827a10dac85c7a71a1ddd)|`update matplotlib spkg. Use github in spkg-src instead of pypy (url more stable).`|\n|[d8630f8](https://git.sagemath.org/sage.git/commit?id=d8630f81c26e824cc3e61e28ad98bb890abe079b)|`matplotlib doesn't like integer in some context, and after 2.0, doesn't seem to cast them.`|\n|[ecf0cb7](https://git.sagemath.org/sage.git/commit?id=ecf0cb7b1e5e4d036a5bf8d37317b4a3f96076f4)|`fix arrow.py. 1) slight change of interface 2) in a doctest, improve the selection done by regular expression.`|\n|[6a0510f](https://git.sagemath.org/sage.git/commit?id=6a0510f35a19f907a719edb832c80dc8ecf6ffea)|`Remove warning suppression needed with MPL-1.5/numpy-1.13`|",
    "created_at": "2017-11-07T22:28:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23696",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[496ded5](https://git.sagemath.org/sage.git/commit/?id=496ded5808d15c7d1830ca9662082d448a994215)|`add backports_functools_lru_cache a new dependency of MPL. Fix MPL 2.1.0 dependencies.`|",
...
```json
{
    "body": "<a id='comment:46'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[f6a9e53](https://git.sagemath.org/sage.git/commit/?id=f6a9e539143095b1cd6a0e0ba762b850339d2746)|`update setuptools_scm for matplotlib-2.1.0`|",
...
```json
{
    "body": "<a id='comment:47'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[717c3da](https://git.sagemath.org/sage.git/commit/?id=717c3dad0ffd8aed76ba9dd7968c90c7a745252f)|`Add subprocess32 as a dependency of MPL-2.1.0`|",
...
```json
{
    "body": "<a id='comment:58'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[2f4fed4](https://git.sagemath.org/sage.git/commit/?id=2f4fed4b27411651ca9e2cb0608bd2bbe4fdec6e)|`Merge branch 'develop' into matplotlib-2.1.0`|\n|[3508ea3](https://git.sagemath.org/sage.git/commit/?id=3508ea33211cc1eb1dff07f4fb4f2fb1fbe9c52a)|`Add new user warnings in the expected output of a couple of tests`|",
    "created_at": "2017-11-09T02:13:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23696",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:65'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[2902b62](https://git.sagemath.org/sage.git/commit/?id=2902b626d0cb27fd842bebdfca89ef4fd6ae152c)|`WIP: replace deprecated set_linestyle`|\n|[e4d8039](https://git.sagemath.org/sage.git/commit/?id=e4d80390bfd6dc56e102623aa055bc64b8b1c983)|`better (correct) fix for userwarnings in plot.py`|",
...
```json
{
    "body": "<a id='comment:67'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------|\n|[7c028ad](https://git.sagemath.org/sage.git/commit/?id=7c028ad5ffaa40fa5333b40d43b0d3d0f547dd82)|`easy fix`|",
...
```json
{
    "body": "<a id='comment:76'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[87b33cf](https://git.sagemath.org/sage.git/commit/?id=87b33cf3f2cf959e161c857decc2be47ab824437)|`supress last warning in arrow.py by adding a label in the right place`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[d29091b](https://git.sagemath.org/sage.git/commit/?id=d29091bf4a36027761bf08da8b62d06ca94a8aab)|`Merge branch 'develop' into matplotlib-2.1.0`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[594df56](https://git.sagemath.org/sage.git/commit/?id=594df5633ec94dde7a15cc3a866cba9cfedfde9e)|`MPL's delaunay module has been removed so we switch to regular triangulation (which happen to Delaunay by default in MPL) and replace Delaunay's 'natural neighbors'`|",
    "created_at": "2017-12-11T01:11:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23696",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[b81b49c](https://git.sagemath.org/sage.git/commit/?id=b81b49c8935bf50dd64267ce0931f45542a6ffa9)|`Add Steve's suggestion to set the default fonts in matplotlib`|",
    "created_at": "2017-12-19T19:29:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23696",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[29a35c2](https://git.sagemath.org/sage.git/commit/?id=29a35c2fb62d0bc8ec98bb736b46d6905ecbff6e)|`use the classic MPL 1.5 style in sphinx_plot`|",
...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[91749f5](https://git.sagemath.org/sage.git/commit/?id=91749f5f0dda58d56e3b493ba9d4d60ad0b58dd4)|`Merge branch 'develop' into matplotlib-2.1.0`|\n|[8f4ca6b](https://git.sagemath.org/sage.git/commit/?id=8f4ca6bfe57c467b5a13594f6699782068cf86c2)|`convert all instances of interpolation='nn' to 'clough'`|",
    "created_at": "2017-12-23T21:52:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23696",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[07b732c](https://git.sagemath.org/sage.git/commit/?id=07b732c5f9afe3fc557483d1e457ba5011651d78)|`Merge branch 'develop' into matplotlib-2.1.0`|\n|[0db7034](https://git.sagemath.org/sage.git/commit/?id=0db703433170a8a266151229194693242499da89)|`Add Steve's corrections to arc.py`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[ca9f8e2](https://git.sagemath.org/sage.git/commit/?id=ca9f8e2679b9acbabf9e07a21c9baae8aaafb8d7)|`make the classic style (from 1.5.3) the default style for now.`|\n|[41c21c6](https://git.sagemath.org/sage.git/commit/?id=41c21c6ac7a6fd7f2595129b33421ce5fb2c7521)|`Add a comment on enforcing the classics style in sphinx_plot for sage-on-distro`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nSwitch the active branch on trac. 3D plots should look nice now. Still have to fix arrow.py again. Possibly do qhull as well.\n\n---\nNew commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[3c5d53c](https://git.sagemath.org/sage.git/commit?id=3c5d53c1f537acf545a0c6579feef1cff7cd541a)|`Rebase MPL-2.1.0 upgrade branch`|\n|[d109b75](https://git.sagemath.org/sage.git/commit?id=d109b7593ef7d1e8d3e234d554524e99c7e92b5e)|`WIP on inserting matplotlib style sheet as a plot option and defaulting it to classic`|\n|[9b90efa](https://git.sagemath.org/sage.git/commit?id=9b90efadd3a8aa3dfc2ecd77c3f8e538f20cf424)|`Set matplotlib options in sphinx_plot so that 3D plots look nice again.`|",
    "created_at": "2018-01-15T21:33:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23696",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[1158425](https://git.sagemath.org/sage.git/commit/?id=115842500d43cc3866c27292cf5680a317b5da3f)|`Make sure agg backend is set in matplotlib when doctests are run`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[8dcadff](https://git.sagemath.org/sage.git/commit/?id=8dcadff0d0dcc86aff0111749f85082f888afc7a)|`Make sure agg backend is set in matplotlib when doctests are run and put the call in the right spot`|",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|\n|[d5be931](https://git.sagemath.org/sage.git/commit/?id=d5be931f48b77bb03d2d5750bea3805435e795fd)|`Change the startup test for numpy and pyparsing now that they are imported in the doctesting framework via matplotlib.`|",
    "created_at": "2018-01-25T01:41:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23696",
    "type": "issue_comment",
