...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23696#event-311399"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23696#event-311400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23696#event-311401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23696#event-311402"
}
```
...
```json
{
    "body": "Attachment: **[MPL153-linear.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL153-linear.png.gz)**",
...
Attachment: **[MPL153-linear.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL153-linear.png.gz)**
...
```json
{
    "body": "Attachment: **[MPL153-nn.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL153-nn.png.gz)**",
...
Attachment: **[MPL153-nn.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL153-nn.png.gz)**
...
```json
{
    "body": "Attachment: **[MPL210-clough.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL210-clough.png.gz)**",
...
Attachment: **[MPL210-clough.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL210-clough.png.gz)**
...
```json
{
    "body": "Attachment: **[MPL-2.1.0.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL-2.1.0.png.gz)**",
...
Attachment: **[MPL-2.1.0.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL-2.1.0.png.gz)**
...
```json
{
    "body": "Attachment: **[MPL-1.5.3.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL-1.5.3.png.gz)**",
...
Attachment: **[MPL-1.5.3.png.gz](https://github.com/sagemath/sage/files/ticket23696/MPL-1.5.3.png.gz)**
...
```json
{
    "body": "Attachment: **[plot-11.png.gz](https://github.com/sagemath/sage/files/ticket23696/plot-11.png.gz)**",
...
Attachment: **[plot-11.png.gz](https://github.com/sagemath/sage/files/ticket23696/plot-11.png.gz)**
...
```json
{
    "body": "Attachment: **[latex_display_original.png.gz](https://github.com/sagemath/sage/files/ticket23696/latex_display_original.png.gz)**",
...
Attachment: **[latex_display_original.png.gz](https://github.com/sagemath/sage/files/ticket23696/latex_display_original.png.gz)**
...
```json
{
    "body": "Attachment: **[latex_display_MPL-2.1.0.png.gz](https://github.com/sagemath/sage/files/ticket23696/latex_display_MPL-2.1.0.png.gz)**",
...
Attachment: **[latex_display_MPL-2.1.0.png.gz](https://github.com/sagemath/sage/files/ticket23696/latex_display_MPL-2.1.0.png.gz)**
...
```json
{
    "body": "Attachment: **[bezier+arc.png.gz](https://github.com/sagemath/sage/files/ticket23696/7b96501f734a26f992d50c7065dc12a7.gz)**",
...
Attachment: **[bezier+arc.png.gz](https://github.com/sagemath/sage/files/ticket23696/7b96501f734a26f992d50c7065dc12a7.gz)**
...
```json
{
    "body": "Attachment: **[arc.png.gz](https://github.com/sagemath/sage/files/ticket23696/arc.png.gz)**",
...
Attachment: **[arc.png.gz](https://github.com/sagemath/sage/files/ticket23696/arc.png.gz)**
...
```json
{
    "body": "<a id='comment:2'>Comment 2:</a>\nAttachment: **[bezier.png.gz](https://github.com/sagemath/sage/files/ticket23696/bezier.png.gz)**\n\nThe code\n\n```\nsage: a = arc((0,0),2,1,0,(pi/5,pi/2+pi/12), linestyle=\"--\", color=\"red\")\nsage: a\n```\ndisplays\n\n![](arc.png)\n\nWhile the code\n\n```\nsage: a = arc((0,0),2,1,0,(pi/5,pi/2+pi/12), linestyle=\"--\", color=\"red\")\nsage: b = a[0].bezier_path()\nsage: b\n```\ndisplays\n\n![](bezier.png)\n\nPreviously, I was trying to show that these two graphs are the same.",
...
```json
{
    "body": "Attachment: **[new_bezier+arc.png.gz](https://github.com/sagemath/sage/files/ticket23696/ae6d90497534da8077560dcdbc2d43a7.gz)**",
...
Attachment: **[new_bezier+arc.png.gz](https://github.com/sagemath/sage/files/ticket23696/ae6d90497534da8077560dcdbc2d43a7.gz)**
...
<a id='comment:244'>Comment 244:</a>
Replying to [@dimpase](#comment%3A243):
> one way or another, "real" Sage library code should not be polluted by checks of whether is is being doctested.
...
<a id='comment:251'>Comment 251:</a>
Replying to [@kiwifb](#comment%3A250):
> Testing something different in `test/startup.py`? That misses the point the test was introduced for. [https://github.com/sagemath/sage/commit/bff6915f037ef1d2acbda426f96cb6060509901c](https://github.com/sagemath/sage/commit/bff6915f037ef1d2acbda426f96cb6060509901c) last file on that commit.
...
<a id='comment:283'>Comment 283:</a>
Replying to [@dimpase](#comment%3A282):
> By the way, matplotlib 2.2.0 has been released.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23696",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23696#issuecomment-359756",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23696",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23696#issuecomment-359757",
