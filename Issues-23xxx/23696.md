...
```json
{
    "body": "<div id=\"comment:265\" align=\"right\">comment:265</div>\n\nPlease try the test the way I suggested in [comment:254](#comment:254) (`[\"sage\", \"-c\", cmd]` all in one set of square brackets). Does that work?",
