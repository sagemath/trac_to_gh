...
```json
{
    "body": "<a id='comment:4'></a>\nI don't think the exact cause of this is worth investigating too deeply, but this seems to be a reliable workaround.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[1ae1262](https://git.sagemath.org/sage.git/commit?id=1ae12629b46bd92f6107c57dd7a956d305fd89c5)|`Force 'make -j1' when runnign the yasm test suite to avoid non-deterministic failures`|",
