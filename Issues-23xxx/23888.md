...
```json
{
    ...
    "type": "issue",
    "updated_at": "2022-10-07T06:49:14Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23888#event-288472"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23888#event-288473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23888#event-288474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363066",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363067",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363068",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363069",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23888#event-288475"
}
```
