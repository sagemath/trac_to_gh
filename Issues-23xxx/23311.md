...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23311#event-306566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23311#event-306567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23311#event-306568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23311#issuecomment-352352",
    "user": "https://github.com/sagetrac-msaaltink"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23311#event-306569"
}
```
