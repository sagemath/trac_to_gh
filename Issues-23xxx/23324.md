...
```json
{
    "body": "<a id='comment:1'></a>The Set should not even be created.",
    "created_at": "2017-06-25T22:36:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438008",
    "user": "https://github.com/videlec"
}
```

<a id='comment:1'></a>The Set should not even be created.
...
```json
{
    "body": "<a id='comment:2'></a>The problem is that we *do* want to support certain infinite sets which cannot be listed, so simply listing all elements is not a solution.",
    "created_at": "2017-06-26T08:55:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438009",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>The problem is that we *do* want to support certain infinite sets which cannot be listed, so simply listing all elements is not a solution.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438011",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438012",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438014",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438015",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/mantepse/surprising_behaviour_of_set\"",
    "created_at": "2018-06-02T11:12:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438016",
    "user": "https://github.com/mantepse"
}
```

Changing branch from "" to "u/mantepse/surprising_behaviour_of_set"
...
```json
{
    "body": "Changing commit from \"\" to \"ba613e9de4136b386c156e6c1cb1c8fceebc9ecf\"",
    "created_at": "2018-06-02T11:12:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438017",
    "user": "https://github.com/mantepse"
}
```

Changing commit from "" to "ba613e9de4136b386c156e6c1cb1c8fceebc9ecf"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438018",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438019",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438020",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438021",
...
```json
{
    "body": "<a id='comment:10'></a>-1 from me. There should be a natural object in Sage that behaves like a set but that the (casual) user doesn't have to learn what \"hashable\" means.",
    "created_at": "2018-06-02T13:56:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438022",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>-1 from me. There should be a natural object in Sage that behaves like a set but that the (casual) user doesn't have to learn what "hashable" means.
...
```json
{
    "body": "<a id='comment:11'></a>Hm, I don't see how unhashable (more precisely: mutable) objects can possibly be turned into a set.  Just to make sure: the current `Set` does not behave like a mathematical set at all:\n\n```\nsage: s = Set([[1,2],[1,2]]); s\nSet of elements of [[1, 2], [1, 2]]\nsage: s.cardinality()\n2\nsage: s == Set([[1,2]])\nFalse\n```\n\nHow about telling the user explicitely what to do in the error message?  Something like\n\n```\nsage: Set([QQ, [3, 1], 5])\nValueError: the elements of a Set must be immutable, use tuples instead of lists.\n```",
    "created_at": "2018-06-02T18:31:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438023",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:11'></a>Hm, I don't see how unhashable (more precisely: mutable) objects can possibly be turned into a set.  Just to make sure: the current `Set` does not behave like a mathematical set at all:
...
```json
{
    "body": "<a id='comment:12'></a>Note that unhashable does not necessarily mean mutable in the sense that `==` changes. For instance, it may not be possible to devise a (reasonable) hash function such that `a == b` implies `hash(a) == hash(b)`.\n\nNote that I am not saying that it does not have bugs (and some features should be used sparingly), but removing something that is useful to the causal user (in a way, python breaks its own conventions with its builtin classes) and could potentially have use-cases in the wild is why this is a -1.",
    "created_at": "2018-06-03T07:58:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438024",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:12'></a>Note that unhashable does not necessarily mean mutable in the sense that `==` changes. For instance, it may not be possible to devise a (reasonable) hash function such that `a == b` implies `hash(a) == hash(b)`.
...
```json
{
    "body": "<a id='comment:13'></a>Well, I reported this, because it hit me as a casual user.  I did a (research) experiment, where I was counting the number of elements in a set.  I then found that the number that `Set` reported did not agree with my conjecture.\n\nLuckily, I found out that `Set` was wrong, not my conjecture.\n\nI think it would be good to have a use case where one really wants to make a `Set` of unhashable objects, so that we can incorporate it.\n\nI hope you agree that elements of a set should be immutable?",
    "created_at": "2018-06-03T09:47:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438025",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:13'></a>Well, I reported this, because it hit me as a casual user.  I did a (research) experiment, where I was counting the number of elements in a set.  I then found that the number that `Set` reported did not agree with my conjecture.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438026",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>You can work towards solving 1 by doing things like removing duplicates on construction, adding elements, etc. That's not to say that enforcing the hashability does not solve 1, but they are two different discussions.\n\nIf you wrap objects, you're likely in for a whole host of other problems, e.g., \"why cannot I add two vectors in this set?\"\n\nI do not think you can get around the non-hashability issue out by simply documenting hashability/immutability either. There is both too much to document/enforce/explain. Again, IMSO, such a user should not have to know/care about these things.\n\n+1 for having a better way to construct immutable vectors, matrices, etc. Separate ticket.",
    "created_at": "2018-06-05T09:10:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438030",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:18'></a>You can work towards solving 1 by doing things like removing duplicates on construction, adding elements, etc. That's not to say that enforcing the hashability does not solve 1, but they are two different discussions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23324#issuecomment-438033",
    "user": "https://github.com/mantepse"
}
```
