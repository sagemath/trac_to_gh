...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|\n|[bd2c806](https://git.sagemath.org/sage.git/commit/?id=bd2c806a88eb75c1d709b5194265ef6ea2b8159d)|`Python should be a dependency of Singular for building its pyobject module, especially on Cygwin`|",
