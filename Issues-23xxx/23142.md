...
```json
{
    "body": "<a id='comment:5'></a>\nOops; thanks for spotting this. Fixed!\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[fda6e26](https://git.sagemath.org/sage.git/commit?id=fda6e26cb2965c8d863062eaacaf6ac288106b96)|`23132: Fix missing synchronisation upon starting gap3 + doc + skip gap3 banner`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[5079877](https://git.sagemath.org/sage.git/commit/?id=50798771d9b30d558c9446699c2374667bf256ef)|`23142: trivial doctest update`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[529e4d3](https://git.sagemath.org/sage.git/commit/?id=529e4d3cc40f80dda2022a5ef4336d0ea8ed35fc)|`23142: another trivial doctest update`|",
