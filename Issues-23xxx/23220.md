...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323590"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323595"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-348616",
    "user": "https://github.com/sagetrac-dbisogno"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-348617",
    "user": "https://github.com/sagetrac-dbisogno"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-348618",
    "user": "https://github.com/sagetrac-dbisogno"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-323597"
}
```
