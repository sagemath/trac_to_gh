...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-305590"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-305591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-305592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-305593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-351250",
    "user": "https://github.com/sagetrac-dbisogno"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-351251",
    "user": "https://github.com/sagetrac-dbisogno"
}
```
