...
```json
{
    "body": "<a id='comment:1'></a>\nsome doctests are failing, needs to be investigated\n\n---\nNew commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[f227266](https://git.sagemath.org/sage.git/commit?id=f227266892a33010320a9b785dcd096d5b7f5c77)|`py3: rich comparison of ideals`|",
    "created_at": "2017-09-05T19:29:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23787",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[1815de6](https://git.sagemath.org/sage.git/commit/?id=1815de66ed2ffb1ff9e95ff2b947cbe5f31b3f0e)|`Merge branch 'u/chapoton/23787' in 8.1.b5`|\n|[b0a8866](https://git.sagemath.org/sage.git/commit/?id=b0a886665b973d75a1e476860ddc33498d193134)|`trac 23787 detail`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[5d2c453](https://git.sagemath.org/sage.git/commit/?id=5d2c453759ce8cb1f73e5f871b449bdc101153d9)|`Merge branch 'u/chapoton/23787' in 8.1.b8`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nOkay, I fixed that and a bug along the way now that the code is actually being tested.\n\nThe remaining failure is the same as the other number field because it was using `cmp_universal`. So I just updated the output.\n\nNeeds review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|\n|[4a0ed9c](https://git.sagemath.org/sage.git/commit?id=4a0ed9c9d36f5e0cda819374096187c641a3522b)|`Merge branch 'u/chapoton/23787' of git://trac.sagemath.org/sage into public/python3/richcmp_ideals-23787`|\n|[d183891](https://git.sagemath.org/sage.git/commit?id=d1838911ba8424748b79dc460324e028680f796f)|`Updating unit_group.py test.`|\n|[5b6624a](https://git.sagemath.org/sage.git/commit?id=5b6624af2fa76e8ee974eb1e51dd57b134912814)|`Actually test the _richcmp_ code and fixing a bug.`|\n|[b003684](https://git.sagemath.org/sage.git/commit?id=b003684f2eead00ca678a8b27db0235a64396d0a)|`Updating test because the ordering of ideals changed.`|",
    "created_at": "2017-10-31T00:09:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23787",
    "type": "issue_comment",
