...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322004"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350116",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350117",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350118",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322005"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322007"
}
```
...
```json
{
    "body": "<div id=\"comment:4\" align=\"right\">comment:4</div>\n\nI'm using the archlinux sagemath package, so I reported it as an archlinux bug (https://bugs.archlinux.org/task/54620). There, I was told the following:\n\nThis is caused by ecl 16.1.3. We are applying the patch from https://github.com/sagemath/sage/issues/22191 but apparently it doesn't fix all issues",
    "created_at": "2017-07-01T10:10:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350119",
    "user": "https://github.com/sagetrac-stassev"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350120",
...
```json
{
    "body": "Changed keywords from none to **eigenvalues**",
    "created_at": "2021-03-12T02:23:53Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350121",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350122",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322009"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322010"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350123",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322014"
}
```
...
```json
{
    "body": "<div id=\"comment:6\" align=\"right\">comment:6</div>\n\nThe archlinux ticket was closed long ago, so I think we can close this old ticket. The PR just adds the ticket's example as a regression doctest for `eigenvectors_left` and `eigenvectors_right`.\n\n---\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/f6500fbb327d56f6d75f9eb6d130ad39b224ef1e\"><code>f6500fb</code></a></td><td><code>trac 23332 doctests</code></td></tr></table>\n",
    "created_at": "2021-03-12T02:23:53Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350124",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350125",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322016"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350126",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350127",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350128",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-322018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-350129",
