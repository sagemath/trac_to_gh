...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-306837"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-306838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-306839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23332#event-306840"
}
```
...
```json
{
    "body": "Changed keywords from **** to **eigenvalues, linear algebra**",
...
Changed keywords from **** to **eigenvalues, linear algebra**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-352862",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23332#issuecomment-352863",
