...
```json
{
    "body": "<a id='comment:1'></a>This may well be unsolvable. Opinions?",
    "created_at": "2017-08-22T13:11:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445812",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>This may well be unsolvable. Opinions?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445813",
...
```json
{
    "body": "<a id='comment:3'></a>From a simple stand-alone experiment I just did, this should work with ``@`cython.binding(True)`",
    "created_at": "2017-08-22T13:31:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445814",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>From a simple stand-alone experiment I just did, this should work with ``@`cython.binding(True)`
...
```json
{
    "body": "<a id='comment:5'></a>Ah that is on top #23657 and may not apply cleanly to develop.",
    "created_at": "2017-08-22T15:16:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445816",
    "user": "https://github.com/rwst"
}
```

<a id='comment:5'></a>Ah that is on top #23657 and may not apply cleanly to develop.
...
```json
{
    "body": "<a id='comment:6'></a>Did you forget `cimport cython`?",
    "created_at": "2017-08-22T17:26:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445817",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>Did you forget `cimport cython`?
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [rws](#comment%3A4):\n> `sage/symbolic/expression.pyx:2344:4: Cdef functions/classes cannot take arbitrary decorators.`\n\n\nI see. The problem is that this is a `cpdef` method.",
    "created_at": "2017-08-22T18:25:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445818",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Replying to [rws](#comment%3A4):
> `sage/symbolic/expression.pyx:2344:4: Cdef functions/classes cannot take arbitrary decorators.`
...
```json
{
    "body": "<a id='comment:8'></a>With `binding(True)`, it is possible to have a working `doc_index` for `cpdef` methods, just not using the decorator syntax.",
    "created_at": "2017-08-22T18:37:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445819",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>With `binding(True)`, it is possible to have a working `doc_index` for `cpdef` methods, just not using the decorator syntax.
...
```json
{
    "body": "<a id='comment:9'></a>The problem even with `def` members is that, while it compiles, the doc will not build. The error given in the ticket description is still there.",
    "created_at": "2017-08-23T05:42:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445820",
    "user": "https://github.com/rwst"
}
```

<a id='comment:9'></a>The problem even with `def` members is that, while it compiles, the doc will not build. The error given in the ticket description is still there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445822",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445823",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Right, I see. In my \"stand-alone experiment\", I didn't actually use a decorator. I just tried to see if it would work conceptually.\n\nThis works:\n\n```\ncimport cython\nfrom sage.misc.rest_index_of_methods import doc_index\n\ncdef class X:\n    @cython.binding(True)\n    def meth(self):\n        return\n    \ndoc_index(\"foo\")(X.__dict__[\"meth\"])\n```\n\nBut with a decorator, it does *not* work:\n\n```\ncimport cython\nfrom sage.misc.rest_index_of_methods import doc_index\n\ncdef class X:\n    @doc_index(\"foo\")\n    @cython.binding(True)\n    def meth(self):\n        return \n```\nI would say that this is a Cython bug.",
    "created_at": "2017-08-23T09:56:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23670",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23670#issuecomment-445824",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>Right, I see. In my "stand-alone experiment", I didn't actually use a decorator. I just tried to see if it would work conceptually.
