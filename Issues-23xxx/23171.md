...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23171#event-304967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23171#event-304968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23171#event-304969"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23171#issuecomment-350100",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23171#issuecomment-350101",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23171#event-304970"
}
```
