...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23321#issuecomment-352589",
    "user": "https://github.com/sagetrac-jvlangen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23321#issuecomment-352590",
    "user": "https://github.com/sagetrac-jvlangen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23321#event-306704"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23321#event-306705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23321#event-306706"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23321#event-306707"
}
```
