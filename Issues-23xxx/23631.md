...
```json
{
    "body": "<a id='comment:1'></a>Maybe the same / a similar issue as #23629, but from the outside behavior it looks different; thus a new ticket.",
    "created_at": "2017-08-17T13:15:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23631",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23631#issuecomment-445088",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:1'></a>Maybe the same / a similar issue as #23629, but from the outside behavior it looks different; thus a new ticket.
