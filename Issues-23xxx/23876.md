...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330748",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330750",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>OK, the patch makes building the documentation fail with python2.7 so it will have to be more subtle than that.",
    "created_at": "2017-09-18T00:15:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330751",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>OK, the patch makes building the documentation fail with python2.7 so it will have to be more subtle than that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330753",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I am just finishing a build of sage-on-gentoo with both python2.7 and 3.6 - documentation build with 2.7 using this patch instead of what's in the branch\n\n```diff\ndiff --git a/src/sage/misc/sageinspect.py b/src/sage/misc/sageinspect.py\nindex f9dffc1ce3..d6013851fc 100644\n--- a/src/sage/misc/sageinspect.py\n+++ b/src/sage/misc/sageinspect.py\n@@ -1636,8 +1636,6 @@ def _sage_getdoc_unformatted(obj):\n     # not a 'getset_descriptor' or similar.\n     if not isinstance(r, string_types):\n         return ''\n-    elif isinstance(r, text_type):  # unicode (py2) = str (py3)\n-        return r.encode('utf-8', 'ignore')\n     else:\n         return r\n \n```\nI'll see if it survives doctesting in a couple of minutes.",
    "created_at": "2017-09-18T01:25:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330754",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>I am just finishing a build of sage-on-gentoo with both python2.7 and 3.6 - documentation build with 2.7 using this patch instead of what's in the branch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330755",
...
```json
{
    "body": "<a id='comment:7'></a>Survived doctesting with python2.7 so I pushed. I am fairly sure that's the only place `text_type` is used in the file so further edits should probably be done.",
    "created_at": "2017-09-18T01:33:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330756",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:7'></a>Survived doctesting with python2.7 so I pushed. I am fairly sure that's the only place `text_type` is used in the file so further edits should probably be done.
...
```json
{
    "body": "<a id='comment:10'></a>Ok Jeroen, it does work at runtime with python3. Doing a full build to see if work as intended with python2 including building documentation.",
    "created_at": "2017-09-18T09:19:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330758",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:10'></a>Ok Jeroen, it does work at runtime with python3. Doing a full build to see if work as intended with python2 including building documentation.
...
```json
{
    "body": "<a id='comment:11'></a>Looks like it does the job for both python2 and python3 so I made a clean branch.\n\n---\nNew commits:",
    "created_at": "2017-09-18T10:35:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330759",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:11'></a>Looks like it does the job for both python2 and python3 so I made a clean branch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330760",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>The comment `# unicode (py2) = str (py3)` no longer makes sense. Maybe write `# On Python 2, we want str, not unicode`.\n\nIf the comment is fixed and `make doc-clean && make ptestlong` passes, this can be set to positive_review.",
    "created_at": "2017-09-18T10:41:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330761",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:12'></a>The comment `# unicode (py2) = str (py3)` no longer makes sense. Maybe write `# On Python 2, we want str, not unicode`.
...
```json
{
    "body": "<a id='comment:13'></a>Although... maybe the code could be restructured to be more clear:\n\n```\n    if isinstance(r, str):\n        return r\n    elif isinstance(r, text_type):\n        # On Python 2, we want str, not unicode\n        return r.encode('utf-8', 'ignore')\n    else:\n        # Not a string of any kind\n        return ''\n```",
    "created_at": "2017-09-18T10:44:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330762",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>Although... maybe the code could be restructured to be more clear:
...
```json
{
    "body": "<a id='comment:14'></a>I'll give that a go in the morning, I agree it looks a bit better.",
    "created_at": "2017-09-18T10:46:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330763",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:14'></a>I'll give that a go in the morning, I agree it looks a bit better.
...
```json
{
    "body": "<a id='comment:15'></a>My problem in comment:3 is being taken care of in #23822.",
    "created_at": "2017-09-18T15:50:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330764",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:15'></a>My problem in comment:3 is being taken care of in #23822.
...
```json
{
    "body": "<a id='comment:17'></a>(Sorry, when I added my last comment, I messed up various other fields for this ticket: \"Reviewer\", \"Commit\", \"Branch\". I've tried to fix them.)",
    "created_at": "2017-09-18T17:18:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330765",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:17'></a>(Sorry, when I added my last comment, I messed up various other fields for this ticket: "Reviewer", "Commit", "Branch". I've tried to fix them.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330766",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330767",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Ok that works with python3 and pass `make doc-clean && make ptestlong` with python2. So this is ready to go.",
    "created_at": "2017-09-18T22:59:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330768",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:19'></a>Ok that works with python3 and pass `make doc-clean && make ptestlong` with python2. So this is ready to go.
...
```json
{
    "body": "<a id='comment:20'></a>+1",
    "created_at": "2017-09-19T08:29:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330769",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23876#issuecomment-330770",
