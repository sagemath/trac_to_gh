...
```json
{
    "body": "<a id='comment:4'></a>experimental branch ready!\n\n---\nNew commits:",
    "created_at": "2017-08-25T02:17:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23706",
    "type": "issue_comment",
...
<a id='comment:4'></a>experimental branch ready!
...
```json
{
    "body": "<a id='comment:5'></a>The title of the ticket could be a bit more specific.",
    "created_at": "2017-08-25T02:32:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23706",
    "type": "issue_comment",
...
<a id='comment:5'></a>The title of the ticket could be a bit more specific.
...
<a id='comment:17'></a>hum... got a lot of failures
...
```json
{
    "body": "<a id='comment:18'></a>Needs to fix #23721 first.",
    "created_at": "2017-08-25T22:35:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23706",
    "type": "issue_comment",
...
<a id='comment:18'></a>Needs to fix #23721 first.
...
```json
{
    "body": "<a id='comment:21'></a>I postponed the introduction of `Matrix_gap` in ticket #23714",
...
<a id='comment:21'></a>I postponed the introduction of `Matrix_gap` in ticket #23714
...
```json
{
    "body": "<a id='comment:22'></a>... wrong commits",
    "created_at": "2017-09-03T17:53:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23706",
    "type": "issue_comment",
...
<a id='comment:22'></a>... wrong commits
...
```json
{
    "body": "<a id='comment:25'></a>JP, do you feel up for the review?",
...
<a id='comment:25'></a>JP, do you feel up for the review?
...
<a id='comment:26'></a>Fucking root systems
...
```json
{
    "body": "<a id='comment:30'></a>Cartan matrices are fixed... waiting for patchbot verdict again.",
...
<a id='comment:30'></a>Cartan matrices are fixed... waiting for patchbot verdict again.
...
<a id='comment:32'></a>Ok, I'm "back on trac"!
...
<a id='comment:33'></a>In the description of the test:
...
```json
{
    "body": "<a id='comment:34'></a>I ran the test on the file `src/sage/matrix/matrix_gfpn_dense.pyx` and all tests passed...",
...
<a id='comment:34'></a>I ran the test on the file `src/sage/matrix/matrix_gfpn_dense.pyx` and all tests passed...
...
```json
{
    "body": "<a id='comment:36'></a>Just did some pep8 corrections... Otherwise, it looks good. Perhaps we should wait to get a proper bot to go over the changes as they touch many files...\n\n---\nNew commits:",
...
<a id='comment:36'></a>Just did some pep8 corrections... Otherwise, it looks good. Perhaps we should wait to get a proper bot to go over the changes as they touch many files...
...
```json
{
    "body": "<a id='comment:39'></a>Much cleaner now!!",
...
<a id='comment:39'></a>Much cleaner now!!
...
<a id='comment:40'></a>Replying to [jipilab](#comment%3A32):
> Ok, I'm "back on trac"!
> 
> I'll give a look at this today.
> 
...
```json
{
    "body": "<a id='comment:41'></a>The ticket does not apply on beta5. I'm compiling b5 right now and I'll check if I can diagnose further. I have to install `meataxe` and checkout testing. Give my machine some time and I get back here!",
...
<a id='comment:41'></a>The ticket does not apply on beta5. I'm compiling b5 right now and I'll check if I can diagnose further. I have to install `meataxe` and checkout testing. Give my machine some time and I get back here!
...
```json
{
    "body": "<a id='comment:42'></a>Is there a dependency to #23721?",
...
<a id='comment:42'></a>Is there a dependency to #23721?
...
<a id='comment:44'></a>Replying to [jipilab](#comment%3A41):
> The ticket does not apply on beta5. I'm compiling b5 right now and I'll check if I can diagnose further. I have to install `meataxe` and checkout testing. Give my machine some time and I get back here!
...
```json
{
    "body": "<a id='comment:47'></a>It's ok.",
...
```json
{
    "body": "<a id='comment:48'></a>There are some spurious doc errors, otherwise, it looks good.",
...
<a id='comment:48'></a>There are some spurious doc errors, otherwise, it looks good.
...
```json
{
    "body": "<a id='comment:50'></a>j'ai pouss\u00e9... reste plus qu'\u00e0 attendre les verdicts de madame patchbot.",
...
<a id='comment:50'></a>j'ai poussé... reste plus qu'à attendre les verdicts de madame patchbot.
...
```json
{
    "body": "<a id='comment:52'></a>Conflicts with #24096",
    "created_at": "2017-10-25T09:23:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23706",
    "type": "issue_comment",
...
<a id='comment:52'></a>Conflicts with #24096
...
```json
{
    "body": "<a id='comment:54'></a>rebased on 8.1.rc0",
...
<a id='comment:54'></a>rebased on 8.1.rc0
...
```json
{
    "body": "<a id='comment:55'></a>patchbot is happy! jipilab?",
...
<a id='comment:55'></a>patchbot is happy! jipilab?
...
<a id='comment:56'></a>I have a few comments:
...
<a id='comment:58'></a>Thanks Travis for having a look.
...
<a id='comment:60'></a>Replying to [vdelecroix](#comment%3A58):
> Thanks Travis for having a look.
> > Do we want m4ri to have precedence over trying meataxe when no implementation is given? (I'm cc-ing Simon to note that there might be a change in behavior.)
...
```json
{
    "body": "<a id='comment:61'></a>Documentation doesn't build",
...
<a id='comment:61'></a>Documentation doesn't build
...
```json
{
    "body": "<a id='comment:63'></a>With the rebasing I do not have any problem with the documentation.",
...
<a id='comment:63'></a>With the rebasing I do not have any problem with the documentation.
...
```json
{
    "body": "<a id='comment:66'></a>I don't understand why, but sphinx was in trouble with `NOTE` and `TESTS` being in the same documentation string.",
...
<a id='comment:66'></a>I don't understand why, but sphinx was in trouble with `NOTE` and `TESTS` being in the same documentation string.
...
```json
{
    "body": "<a id='comment:67'></a>It may not be Sphinx but our custom handling of the `TESTS` block (at least, IIRC we do something special there in order to hide the block).",
...
<a id='comment:67'></a>It may not be Sphinx but our custom handling of the `TESTS` block (at least, IIRC we do something special there in order to hide the block).
...
```json
{
    "body": "<a id='comment:68'></a>Anyways, the workaround is fine with me and there is a green patchbot. Back to positive review.",
    "created_at": "2017-12-15T04:59:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23706",
    "type": "issue_comment",
...
<a id='comment:68'></a>Anyways, the workaround is fine with me and there is a green patchbot. Back to positive review.
...
```json
{
    "body": "<a id='comment:69'></a>thanks Travis.",
...
<a id='comment:69'></a>thanks Travis.
