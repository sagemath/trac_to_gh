...
```json
{
    "body": "<a id='comment:1'></a>I don't think we should go that way. It should not be the goal of Sage to do that. Just use the Python 3 syntax in your own code, possibly with `from __future__ import print_function`.",
    "created_at": "2017-08-22T14:39:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446033",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>I don't think we should go that way. It should not be the goal of Sage to do that. Just use the Python 3 syntax in your own code, possibly with `from __future__ import print_function`.
...
```json
{
    "body": "<a id='comment:2'></a>I understand your point of view, however, with that approach, a lot of homemade code will get broken whenever we do the switch because of a print.\n\nJust consider the case of someone running a long term computation and at the end, it will fail because the user tried to print the result. However, his code run totally fine in the previous version of sage.",
    "created_at": "2017-08-22T14:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446034",
    "user": "https://github.com/edgarcosta"
}
```

<a id='comment:2'></a>I understand your point of view, however, with that approach, a lot of homemade code will get broken whenever we do the switch because of a print.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446035",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Another potential issue could be pre-made notebooks for educational purposes that aren't necessarily being actively maintained.\n\nI think there are lots of people using Sage that won't be reached without deprecation warnings in the code itself no matter how loudly we advertise.",
    "created_at": "2017-08-22T16:38:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446037",
    "user": "https://github.com/kevindilks"
}
```

<a id='comment:5'></a>Another potential issue could be pre-made notebooks for educational purposes that aren't necessarily being actively maintained.
...
```json
{
    "body": "<a id='comment:7'></a>> I think there are lots of people using Sage that won't be reached without deprecation warnings in the code itself no matter how loudly we advertise.\n\n\nI agree an alternative is to deprecate the \n\n```\nprint foo\n```\njust before we switch to python3.",
    "created_at": "2017-08-22T22:13:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446039",
    "user": "https://github.com/edgarcosta"
}
```

<a id='comment:7'></a>> I think there are lots of people using Sage that won't be reached without deprecation warnings in the code itself no matter how loudly we advertise.
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [edgarcosta](#comment%3A7):\n> just before we switch to python3.\n\n\nOr well before.",
    "created_at": "2017-08-22T22:23:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446040",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>Replying to [edgarcosta](#comment%3A7):
> just before we switch to python3.
...
```json
{
    "body": "<a id='comment:13'></a>I think this ticket is obsolete.",
    "created_at": "2021-02-24T05:47:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446044",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:13'></a>I think this ticket is obsolete.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446045",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23674#event-60536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446046",
...
```json
{
    "body": "<a id='comment:14'></a>I agree, let's close it",
    "created_at": "2021-02-24T06:12:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446047",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:14'></a>I agree, let's close it
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446048",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23674#event-60537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23674#issuecomment-446049",
    "user": "https://github.com/fchapoton"
}
```
