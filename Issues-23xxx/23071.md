...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23071#issuecomment-348187",
    "user": "https://github.com/enadeau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23071#issuecomment-348188",
    "user": "https://github.com/enadeau"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23071#event-303719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23071#event-303720"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23071#event-303721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23071",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23071#event-303722"
}
```
