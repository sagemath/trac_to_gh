...
```json
{
    "body": "<a id='comment:1'></a>The implementation should be something like\n\n```\ndef small_residue(self,f):\n    return f % self.gen()\n```",
    "created_at": "2017-06-16T19:58:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23260",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23260#issuecomment-321687",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:1'></a>The implementation should be something like
