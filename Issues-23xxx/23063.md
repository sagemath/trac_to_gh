...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23063",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23063#issuecomment-348066",
    "user": "https://github.com/sagetrac-rolandog"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23063",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23063#issuecomment-348067",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23063#event-303625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23063#event-303626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23063",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23063#event-303627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23063#event-303628"
}
```
