...
archive/attachments_021673.json:
```json
{
...
```json
{
    "body": "**Attachment:** [view_run_simplex_method.pdf](https://github.com/sagemath/sage/files/ticket23730/view_run_simplex_method.pdf)",
    "created_at": "2017-08-27T05:03:00Z",
    "issue": "https://github.com/sagemath/sage/issues/23730",
    "type": "issue_comment",
...
**Attachment:** [view_run_simplex_method.pdf](https://github.com/sagemath/sage/files/ticket23730/view_run_simplex_method.pdf)
...
archive/attachments_021674.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [jupyter_run_simplex_method.pdf](https://github.com/sagemath/sage/files/ticket23730/jupyter_run_simplex_method.pdf)",
    "created_at": "2017-08-27T05:12:00Z",
    "issue": "https://github.com/sagemath/sage/issues/23730",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nWell, the main problem is that it does not work in Jupyter, but I have no idea in what place MathJax extensions are enabled for it and nobody replied to my question on sage-devel so far. All that has to be done is enabling `color.js` as it is done for SageNB and [SageMathCell](../wikis/SageMathCell).",
