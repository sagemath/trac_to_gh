...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[10b8cd8](https://git.sagemath.org/sage.git/commit?id=10b8cd8aaf164a6ff41c2bd8d3a996d098370a63)|`trac 23897: minor cleanup with simplicial sets.`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[03a55e6](https://git.sagemath.org/sage.git/commit/?id=03a55e6fe74ab8c8a059eb5052066225ead7b8f4)|`Merge branch 'develop' into simplicial-set-cleanup`|\n|[bb8dc4c](https://git.sagemath.org/sage.git/commit/?id=bb8dc4ccadd937639d96416210807f9b94f9b332)|`trac 23897: add a little more documentation.`|",
