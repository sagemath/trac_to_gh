...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[0a40209](https://git.sagemath.org/sage.git/commit?id=0a402095fdbf3fb47018bd3fc54deccd8c745338)|`Fixed a docstring in morphism.py`|\n|[f6827d0](https://git.sagemath.org/sage.git/commit?id=f6827d03de0ce43df9c2bb431626581298137401)|`AffineSpace now accepts a univariate polynomial ring and constructs A^1`|\n|[586f17f](https://git.sagemath.org/sage.git/commit?id=586f17f73d79d48792e252555662ce36f19eab79)|`Improved dynamical system constructors in generic_ds module`|\n|[4950fcc](https://git.sagemath.org/sage.git/commit?id=4950fcc87670d8a7625b31627e3ceae1cca86b48)|`Streamlined dynamical system class init's after pushing hard work to the constructors in generic_ds module`|",
    "created_at": "2017-07-21T16:01:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23497",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[a018703](https://git.sagemath.org/sage.git/commit/?id=a018703902019d46b95f4dcee03e9b453f89560a)|`Fixed a coercion bug in the affine morphism constructor`|\n|[4650eb3](https://git.sagemath.org/sage.git/commit/?id=4650eb3968d3540fa2dcecdbd01aa779bc95cab4)|`Improved consistency and type checking in class constructors`|\n|[b9327f8](https://git.sagemath.org/sage.git/commit/?id=b9327f83f69e74707e3dc597ba19ec4f9b79b57d)|`Fixed argument handling in special class inits for efficiency`|",
    "created_at": "2017-07-21T21:34:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23497",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nI consider this ready for a review now.\n\nWhen we are happy with this new functionality, then we'll need to merge in the following tickets which will conflict: #23234, #23333, #23334. So don't mark it positive-reivew even if it is ready.\n\n---\nNew commits:\n|                                                                                                                                          |                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[f9f291c](https://git.sagemath.org/sage.git/commit?id=f9f291c42d889d69d884f99c71b5689b9ec894ab)|`23497: reinstate doctests for deprecated functions`|\n|[ae729ce](https://git.sagemath.org/sage.git/commit?id=ae729ce79d3b514e041873e516d58e5282cfae0b)|`23497: tests, docs, and init updates to generic_ds.py`|\n|[296dccd](https://git.sagemath.org/sage.git/commit?id=296dccdc9efe4c8b48e69cb10c4799bd94e6fa9e)|`23497: finish other dynamics files and all docs`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[2c604d0](https://git.sagemath.org/sage.git/commit/?id=2c604d062974dfb5241b8027ca06c0ce5c0cd2fe)|`Merge branch 8.1.beta0 into t/23497/arith_dyn`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[ba22abd](https://git.sagemath.org/sage.git/commit/?id=ba22abdc1b2d85f716c0512fcb7b0ec86fb8dbf1)|`Merge branch 8.1.beta1 into t/23497/arith_dyn`|",
