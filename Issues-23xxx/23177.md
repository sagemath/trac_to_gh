...
```json
{
    "body": "I'll wait for a decision on https://github.com/jupyter-widgets/ipywidgets/pull/1398",
...
```json
{
    "body": "I hope to release 7.1 today or tomorrow, FYI.",
...
```json
{
    "body": "ipywidgets 7.1 is now released.",
...
```json
{
    "body": "I'll confess to have missed that one during review.",
...
```json
{
    "body": "Very small change to the doctest and back to positive review.\n\n---\nNew commits:",
    "created_at": "2018-02-15T00:29:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23177",
    "type": "issue_comment",
...
```json
{
    "body": "And the problem is that the patchbot doesn't test these tickets because they include a package upgrade.",
