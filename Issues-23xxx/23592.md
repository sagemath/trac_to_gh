...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[34472e8](https://git.sagemath.org/sage.git/commit?id=34472e89cfdb36f96937cfdfd73b902e879d720d)|`Faster comparison of manifold points`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[bd717d9](https://git.sagemath.org/sage.git/commit/?id=bd717d91f2edc087036328d55d0b02627fbd0914)|`Better comparison of manifold points`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[48a66fc](https://git.sagemath.org/sage.git/commit/?id=48a66fcc1282ca7749d69550a15c60d0ae56c3de)|`Slight code simplification in manifold point comparison`|",
    "created_at": "2017-08-08T10:02:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23592",
    "type": "issue_comment",
