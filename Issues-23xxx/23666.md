...
```json
{
    "body": "What works is creating an RST link, i.e. a file in the current directory containing `.. include:: ../file`. This does not explain why referring to `../file` directly works in `en/prep`.",
