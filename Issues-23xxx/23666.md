...
```json
{
    "body": "<a id='comment:1'></a>What works is creating an RST link, i.e. a file in the current directory containing `.. include:: ../file`. This does not explain why referring to `../file` directly works in `en/prep`.",
    "created_at": "2018-02-28T09:38:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23666#issuecomment-327494",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>What works is creating an RST link, i.e. a file in the current directory containing `.. include:: ../file`. This does not explain why referring to `../file` directly works in `en/prep`.
