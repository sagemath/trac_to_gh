...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23465#event-308576"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23465#event-308577"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23465#event-308578"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23465#event-308579"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23465#issuecomment-355301",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23465#issuecomment-355302",
    "user": "https://github.com/embray"
}
```
