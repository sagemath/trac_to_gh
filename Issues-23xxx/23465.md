...
```json
{
    "body": "<a id='comment:1'></a>I'm working on a solution to #21524 that I'll probably rework this on top of if/when that's ready.",
    "created_at": "2017-07-20T12:32:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23465#issuecomment-441291",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>I'm working on a solution to #21524 that I'll probably rework this on top of if/when that's ready.
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23465#event-60242"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23465#event-60243"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23465#event-60244"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23465#event-60245"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23465#event-60246"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This would still be good to do, but I'm going to need to come back to it, esp. in the context of #24919.",
    "created_at": "2018-07-18T11:48:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23465#issuecomment-441292",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>This would still be good to do, but I'm going to need to come back to it, esp. in the context of #24919.
