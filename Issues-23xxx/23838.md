...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331175"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331178"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359696",
    "user": "https://github.com/sagetrac-karimvanaelst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331180"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359697",
    "user": "https://github.com/sagetrac-karimvanaelst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359698",
    "user": "https://github.com/sagetrac-karimvanaelst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331181"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359699",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359701",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359702",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359703",
    "user": "https://github.com/sagetrac-karimvanaelst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359704",
    "user": "https://github.com/sagetrac-karimvanaelst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331183"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359705",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "<div id=\"comment:8\" align=\"right\">comment:8</div>\n\nReplying to [@sagetrac-karimvanaelst](#comment:6):\n> Replying to [@sagetrac-git](#comment:5):\n> \n> Thank you for your comments.\n> Corrections did have to be made about `rk4_maxima` being the default algorithm of method `solve`, and the numerical evaluation of the step is then maintained until another ticket allows to remove it.\n\nThanks!",
    "created_at": "2017-09-13T12:24:53Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359706",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331184"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23838#event-331185"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23838#issuecomment-359707",
