...
```json
{
    "body": "<a id='comment:1'></a>\nlet us wait for a bot's opinion\n\n---\nNew commits:\n|                                                                                                                                          |                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[4e7d985](https://git.sagemath.org/sage.git/commit?id=4e7d98535d4a24395572f57e1131f471fab1ec66)|`trac 23044 conversion to unicode of sageinspect, relax doctest of strings`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|\n|[1a736be](https://git.sagemath.org/sage.git/commit/?id=1a736beefca12466c37319ba1947b59cba9dd9e5)|`trac 23044 better removal of u, fixing imports of six`|",
    "created_at": "2017-05-21T19:54:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23044",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[ea80844](https://git.sagemath.org/sage.git/commit/?id=ea80844217612fcca87cf34f90fe8502ae8d7a4a)|`trac 23044 fixing the easy failing doctests`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[81a8ca7](https://git.sagemath.org/sage.git/commit/?id=81a8ca78ea6c5557aed182f8a041cc54594d9190)|`trac 23044 one detail`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[45a3be7](https://git.sagemath.org/sage.git/commit/?id=45a3be70f51497c634d126693d802d235a3e8f97)|`trac 23044 do not switch to unicode yet`|",
    "created_at": "2017-05-23T07:08:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23044",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[04568d6](https://git.sagemath.org/sage.git/commit/?id=04568d6e40751ba4b27c28d2b95975166132b286)|`trac 23044 relax doctest of strings, preparation for unicode in sageinspect`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[7bb1929](https://git.sagemath.org/sage.git/commit/?id=7bb1929e40f337c4cf4c49032f044bbb1f0c6ae4)|`trac 23044 more explanation in remove_unicode_u`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[f314d07](https://git.sagemath.org/sage.git/commit/?id=f314d0745b23d606da9f9d49c87a7b60e2ecf9ca)|`trac 23044 support bytes as possible input`|",
    "created_at": "2017-05-23T14:27:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23044",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[ec37fd4](https://git.sagemath.org/sage.git/commit/?id=ec37fd4c1531cca3249674e5e40b51e45bb11475)|`trac 23044 let us try to always remove the offending u`|",
...
```json
{
    "body": "<a id='comment:33'></a>\nIn my last commit, I'm using `strip_string_literals()` to simplify and correct `remove_unicode_u()`. I just wanted to show how simple the function becomes; if you still feel that this isn't the right solution, feel free to remove that commit.\n\n---\nNew commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[6654974](https://git.sagemath.org/sage.git/commit?id=665497473c7577e4edb9e79c7538b807e8573dc7)|`No need for binary_type, bytes works`|\n|[d447eaa](https://git.sagemath.org/sage.git/commit?id=d447eaa790e8d03db15cc5cea3912674a6c836e4)|`Use strip_string_literals() in remove_unicode_u()`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nHere is a branch, on top of Jeroen's branch, that does not try the systematic replacement. I propose to do that later in another ticket, because there are some  issues in relation with our unicode-unfriendly doc-framework.\n\n---\nNew commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[56918aa](https://git.sagemath.org/sage.git/commit?id=56918aa6c64ce1af8508ccde92f996c94cdb9256)|`Merge branch 'u/jdemeyer/23044' in 8.0.b8`|\n|[18ff284](https://git.sagemath.org/sage.git/commit?id=18ff284c8ccbcfef2a75dd8d8d4c266230e96b91)|`trac 23044 back to not systematic removal of u`|",
...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[fbb5aa5](https://git.sagemath.org/sage.git/commit/?id=fbb5aa5ec8ec9b6ee3c79a98983f478cbf0e094d)|`trac 23044 moving import to the top of file`|",
...
```json
{
    "body": "<a id='comment:47'></a>\nNew commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[691a2de](https://git.sagemath.org/sage.git/commit?id=691a2dea644bed1749e224f53b9f9822aac39a43)|`py3: tolerance for u prefix in doctests`|",
    "created_at": "2017-06-06T09:47:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23044",
    "type": "issue_comment",
