...
```json
{
    "body": "<a id='comment:3'></a>Also, I missed pointing out some 404 links and a missing benchmark link on the symbench wiki article. At the very top of the article, the first three lines:\n1. I missed linking to https://wiki.sagemath.org/WesterBenchmarks\n   * The table is empty\n2. Sympy's Benchmarks:\n   * Inspired by the symbench article, these seem to be now located here: https://github.com/sympy/sympy/wiki/Sage-Symbench\n3. ODE Test Suite:\n   * I think (but I may be mistaken) that the link should point to: http://axiom.axiom-developer.org/axiom-website/CATS/index.html",
    "created_at": "2017-08-31T16:35:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23759#issuecomment-448298",
    "user": "https://trac.sagemath.org/admin/accounts/users/rolandog"
}
```

<a id='comment:3'></a>Also, I missed pointing out some 404 links and a missing benchmark link on the symbench wiki article. At the very top of the article, the first three lines:
1. I missed linking to https://wiki.sagemath.org/WesterBenchmarks
   * The table is empty
2. Sympy's Benchmarks:
   * Inspired by the symbench article, these seem to be now located here: https://github.com/sympy/sympy/wiki/Sage-Symbench
...
```json
{
    "body": "<a id='comment:4'></a>item 1., http://www.sagemath.org/tour-benchmarks.html , corresponds to\u00a0the issue in the sagemath webpage: https://github.com/sagemath/website/issues/29 , thus we need to submit a pull request there.\n\ni can produce numbers for Matlab r2016a which should be recent enough in a macbook pro. however, i don't have Mathematica software.\n\ni'm reading also: https://groups.google.com/forum/#!msg/sage-support/yAgl7JLgx-s/9QSNDguCHoAJ",
    "created_at": "2017-09-01T19:21:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23759#issuecomment-448299",
    "user": "https://github.com/mforets"
}
```

<a id='comment:4'></a>item 1., http://www.sagemath.org/tour-benchmarks.html , corresponds to the issue in the sagemath webpage: https://github.com/sagemath/website/issues/29 , thus we need to submit a pull request there.
...
```json
{
    "body": "<a id='comment:5'></a>thank you for pointing out the broken links in the wiki. i've double checked and updated them.",
    "created_at": "2017-09-01T19:57:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23759#issuecomment-448300",
    "user": "https://github.com/mforets"
}
```

<a id='comment:5'></a>thank you for pointing out the broken links in the wiki. i've double checked and updated them.
