...
```json
{
    "body": "<div id=\"comment:12\" align=\"right\">comment:12</div>\n\nI view `sage-python23` as a build-time tool. Actually, I view the setting of `SAGE_PYTHON3` as something which only affects the Sage build, not necessarily how things are run. The Sage community has not made any decisions about how to actually run Sage using Python 3. As a result, I am somewhat wary of just using `sage-python23` everywhere. I tried to explain this in [comment:2](#comment:2).",
