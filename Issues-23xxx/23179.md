...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[176356a](https://git.sagemath.org/sage.git/commit/?id=176356a43391a1d11e34eceac25627e6d01ce657)|`Remove this check as it is no longer needed`|",
    "created_at": "2017-06-08T14:51:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23179",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[f39f099](https://git.sagemath.org/sage.git/commit/?id=f39f0999b4e6aeebecc480e18de17260ed52d2f6)|`Mark all spkg-build|install|check as not executable`|\n|[94d2626](https://git.sagemath.org/sage.git/commit/?id=94d2626f2a9c902b31bf7792a6f45eb36b5c9fd4)|`Create wrapper script around spkg-build, spkg-check, and spkg-install`|\n|[7a7424b](https://git.sagemath.org/sage.git/commit/?id=7a7424bfa649dbf538ebda17f58d32b6c90fee3a)|`In accordance with the new restrictions, strips shebank lines from all spkg-install, spkg-build, and spkg-check`|\n|[d30624b](https://git.sagemath.org/sage.git/commit/?id=d30624b03cc6f62087e0c3c9a820148d46b67616)|`Remove this check as it is no longer needed`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[d5399f7](https://git.sagemath.org/sage.git/commit/?id=d5399f76b2905687fe78de35573d68b3536022b7)|`Don't use not entirely portable GNU grep features`|\n|[3c34582](https://git.sagemath.org/sage.git/commit/?id=3c34582918eb8e1ddd1455103a62d1b535b817d4)|`Instead of looking before we leap, always try sourcing sage-env, and handle any errors that might occur`|\n|[38647dc](https://git.sagemath.org/sage.git/commit/?id=38647dc23dd9986ec8080045c9ce850eceabc819)|`Pass write_script_wrapper the absolute path to the script it's writing`|\n|[8cd0049](https://git.sagemath.org/sage.git/commit/?id=8cd0049c3a56040758eaa6ad4b52b39023da7f67)|`Use a variable for the path to the temporary file for clarity's sake`|\n|[01e3c03](https://git.sagemath.org/sage.git/commit/?id=01e3c0398e9eac74eadab95ee8e199de48d376f4)|`Remove this check from sage-spkg since spkg-installs will no longer be written in Python`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|\n|[b05f707](https://git.sagemath.org/sage.git/commit/?id=b05f707269963cb5df58ed8caa92959676c788f6)|`Instead of looking before we leap, always try sourcing sage-env, and handle any errors that might occur`|\n|[d22768d](https://git.sagemath.org/sage.git/commit/?id=d22768df25f4128ab2739f8f2408a7125de9db37)|`Pass write_script_wrapper the absolute path to the script it's writing`|\n|[84cbd4e](https://git.sagemath.org/sage.git/commit/?id=84cbd4e5e94eb4bef775a47a436acf1a00648683)|`Use a variable for the path to the temporary file for clarity's sake`|\n|[e2362e1](https://git.sagemath.org/sage.git/commit/?id=e2362e1c2cc93293f1e206f8a95169995e9e4ea3)|`Remove this check from sage-spkg since spkg-installs will no longer be written in Python`|",
    "created_at": "2017-06-27T09:10:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23179",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[9c34d45](https://git.sagemath.org/sage.git/commit/?id=9c34d454be51adb3e0e1ff2de3f10bf8b08e15c6)|`Don't use not entirely portable GNU grep features`|\n|[e677e4e](https://git.sagemath.org/sage.git/commit/?id=e677e4e0c88c9492ced5d3b8e75d69c92636f752)|`Instead of looking before we leap, always try sourcing sage-env, and handle any errors that might occur`|\n|[a426c02](https://git.sagemath.org/sage.git/commit/?id=a426c0244b157f126aae85e49c3cac98c52c0bab)|`Pass write_script_wrapper the absolute path to the script it's writing`|\n|[1b66b8c](https://git.sagemath.org/sage.git/commit/?id=1b66b8c8ddb816097d888977876ef02e843663f3)|`Use a variable for the path to the temporary file for clarity's sake`|\n|[1d8b94e](https://git.sagemath.org/sage.git/commit/?id=1d8b94e22b6e501139e4efcf7992a1bce467ec62)|`Remove this check from sage-spkg since spkg-installs will no longer be written in Python`|",
    "created_at": "2017-06-27T09:31:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23179",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|\n|[6688823](https://git.sagemath.org/sage.git/commit/?id=66888230ed1976e7ca075464499ae3ce4e9a4951)|`Make it a mere warning on Cygwin if any of the scripts in build/pkgs are executable, but a hard error on other platforms`|",
    "created_at": "2017-06-30T08:07:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23179",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[932b859](https://git.sagemath.org/sage.git/commit/?id=932b85910f6ace2d8d2f806865f7ae73699300aa)|`Use a heredoc instead of a quoted variable, for clarity's sake.`|",
...
```json
{
    "body": "<a id='comment:42'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[8819114](https://git.sagemath.org/sage.git/commit/?id=8819114afb5494f4f25231fb183fb75b6209e476)|`Set some variables in the wrapper script itself.`|",
