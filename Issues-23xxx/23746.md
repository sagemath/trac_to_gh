...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23746#event-312089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23746#event-312090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23746#event-312091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23746#issuecomment-360889",
    "user": "https://github.com/sagetrac-dominic-else"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23746#issuecomment-360890",
    "user": "https://github.com/sagetrac-dominic-else"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23746#event-312092"
}
```
