...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23863#event-313463"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23863#event-313464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23863#event-313465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23863#event-313466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23863#issuecomment-362721",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23863#issuecomment-362722",
    "user": "https://github.com/edgarcosta"
}
```
