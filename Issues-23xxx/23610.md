...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326758",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326759",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Great!  This is definitely a feature that people have requested over the years.\n\nThe code mostly looks good.  Why do you need to add quotes around numbers in a few of the tests?\n\nPositive review once tests pass.",
    "created_at": "2017-08-11T16:55:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326760",
    "user": "https://github.com/roed314"
}
```

<a id='comment:4'></a>Great!  This is definitely a feature that people have requested over the years.
...
```json
{
    "body": "<a id='comment:5'></a>The quotes are not around numbers perse. It is there for the case that somewhere in the future someone adds an entry to `value_opt` that also accepts lists.  I had to do this first to make `--import` work since it accepts lists. But then later I realised that I had to special case` --import` since `options.import` is an invalid syntax.",
    "created_at": "2017-08-11T17:11:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326761",
    "user": "https://github.com/koffie"
}
```

<a id='comment:5'></a>The quotes are not around numbers perse. It is there for the case that somewhere in the future someone adds an entry to `value_opt` that also accepts lists.  I had to do this first to make `--import` work since it accepts lists. But then later I realised that I had to special case` --import` since `options.import` is an invalid syntax.
...
```json
{
    "body": "<a id='comment:7'></a>ps. thanks for the quick review!",
    "created_at": "2017-08-11T17:27:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326763",
    "user": "https://github.com/koffie"
}
```

<a id='comment:7'></a>ps. thanks for the quick review!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326764",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326765",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Proposal: close as wontfix.",
    "created_at": "2017-09-19T09:40:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326767",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Proposal: close as wontfix.
...
```json
{
    "body": "<a id='comment:12'></a>good for me. I would like to here Maarten comments about it.",
    "created_at": "2017-09-19T09:47:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326768",
    "user": "https://github.com/videlec"
}
```

<a id='comment:12'></a>good for me. I would like to here Maarten comments about it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23610",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23610#issuecomment-326769",
    "user": "https://github.com/koffie"
}
```
