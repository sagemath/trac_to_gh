...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23401#event-307720"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23401#event-307721"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23401#event-307722"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23401#event-307723"
}
```
...
```json
{
    "body": "Attachment: **[rawcode_tables.png.gz](https://github.com/sagemath/sage/files/ticket23401/rawcode_tables.png.gz)**",
    "created_at": "2017-07-11T11:56:17Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/23401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23401#issuecomment-354082",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23401#issuecomment-354083",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23401#event-307724"
}
```
