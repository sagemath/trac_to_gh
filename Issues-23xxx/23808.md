...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[8548426](https://git.sagemath.org/sage.git/commit/?id=85484263dbc54db00819386193c8784fff284b01)|`Added an example illustrating the fix`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[693578c](https://git.sagemath.org/sage.git/commit/?id=693578ca32ded36f9252988917b67aebf0d2dfcc)|`Changed _number_field_from_algebraics in projective point as well`|",
