...
```json
{
    "body": "<a id='comment:65'></a>\nLast call for patches. Please someone review. It would be good to have this in the next beta and be able to move on to #25532 and get it all done for 8.5.\n\n---\nNew commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[108d581](https://git.sagemath.org/sage.git/commit?id=108d5817f524a214e133198a75bf22c9cc7080b8)|`Merge branch 'develop' into lcalc_cxx11`|\n|[834e7a6](https://git.sagemath.org/sage.git/commit?id=834e7a6eb3c607a9ddd6fd384e0ca4b3bfd701a1)|`lcalc version bump for rebuild`|\n|[837732e](https://git.sagemath.org/sage.git/commit?id=837732e21257e3d2ad14bff15424ea9cae197e1b)|`remove enforcement of gnu++98 in lcalc bindings`|",
    "created_at": "2018-10-31T22:37:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23341",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:78'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[8190cef](https://git.sagemath.org/sage.git/commit/?id=8190cef7b754eeec86a7ee12395f5aa69fb74733)|`Correct inclusion of pari header so no extra -I flags are required.`|\n|[71f8bf2](https://git.sagemath.org/sage.git/commit/?id=71f8bf21c3db0dafb8276bf664f26fcb506f8614)|`update makefile patch and document it`|\n|[eb072d1](https://git.sagemath.org/sage.git/commit/?id=eb072d1119cd2305bb02cd8f8e00168e67f5cad6)|`update the patch according to Jeroen's review. Add a correction of a \"std:\" which should have been \"std::\"`|",
...
```json
{
    "body": "<a id='comment:80'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[3fb7f80](https://git.sagemath.org/sage.git/commit/?id=3fb7f80a02461137b5e1e80cfd5fae6ba9784b6a)|`std: was introduced in the clang patch. Correcting in that patch.`|",
...
```json
{
    "body": "<a id='comment:89'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|\n|[7cf967f](https://git.sagemath.org/sage.git/commit/?id=7cf967fa5f50daf67e9a910786970bf184c37ecb)|`make sure -std=c++11 is passed during build. Various improvement to spkg-build and spkg-install.`|",
