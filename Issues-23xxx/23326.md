...
```json
{
    "body": "Changing commit from \"\" to \"9dc381e2d05944b6aacd25c1b481584c7bae8f4b\"",
    "created_at": "2017-06-26T10:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438106",
    "user": "https://github.com/mforets"
}
```

Changing commit from "" to "9dc381e2d05944b6aacd25c1b481584c7bae8f4b"
...
```json
{
    "body": "Changing branch from \"\" to \"u/mforets/23326\"",
    "created_at": "2017-06-26T10:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438107",
    "user": "https://github.com/mforets"
}
```

Changing branch from "" to "u/mforets/23326"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438109",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I think one of the bugs is here, line 707 of `sage/rings/real_double.pyx`.\n\n```\nself._value = float(x)\n```\nIndeed, `float()` is Python float, it's not `RDF`.\n\nMore bugs(?) like this are in `MixedIntegerLinearProgram`, where `float` is used for no good reason, IMHO.",
    "created_at": "2017-06-26T11:35:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438110",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:3'></a>I think one of the bugs is here, line 707 of `sage/rings/real_double.pyx`.
...
```json
{
    "body": "Changing branch from \"u/mforets/23326\" to \"u/tmonteil/23326\"",
    "created_at": "2017-06-26T20:00:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438111",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

Changing branch from "u/mforets/23326" to "u/tmonteil/23326"
...
```json
{
    "body": "Changing commit from \"9dc381e2d05944b6aacd25c1b481584c7bae8f4b\" to \"c4b7a619fca34156d50e2ec66d8258c50b8ad283\"",
    "created_at": "2017-06-26T20:43:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438113",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

Changing commit from "9dc381e2d05944b6aacd25c1b481584c7bae8f4b" to "c4b7a619fca34156d50e2ec66d8258c50b8ad283"
...
```json
{
    "body": "<a id='comment:6'></a>Practically speaking, if one wants to study the polyhedron of an (MI)LP, then an appropriate (MI)LP backend should should be used: e.g. for rational inequalities one should use `ppl` backend, which does exact computations over `QQ`, and so the polyhedron constructed will be over `QQ`; there is also a backend that understands exact algebraic numbers, etc.\n\nConstructing an LP over floats/RDF and then investigating the underlying polyhedron is obviously not a very safe undertaking.",
    "created_at": "2017-06-26T21:00:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438114",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:6'></a>Practically speaking, if one wants to study the polyhedron of an (MI)LP, then an appropriate (MI)LP backend should should be used: e.g. for rational inequalities one should use `ppl` backend, which does exact computations over `QQ`, and so the polyhedron constructed will be over `QQ`; there is also a backend that understands exact algebraic numbers, etc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438116",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Then\u00a0if #22605 gets in, here we can just adapt the backend, `p = MixedIntegerLinearProgram(solver='ppl')`, in the doctests that involve rationals, while keeping the one i added with `solver='GLPK'`. Does it make sense?",
    "created_at": "2017-06-28T13:45:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438117",
    "user": "https://github.com/mforets"
}
```

<a id='comment:9'></a>Then if #22605 gets in, here we can just adapt the backend, `p = MixedIntegerLinearProgram(solver='ppl')`, in the doctests that involve rationals, while keeping the one i added with `solver='GLPK'`. Does it make sense?
...
```json
{
    "body": "Changing dependencies from \"\" to \"#22605\"",
    "created_at": "2017-07-27T14:16:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438118",
    "user": "https://github.com/mforets"
}
```

Changing dependencies from "" to "#22605"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438119",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438120",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "Changing branch from \"u/tmonteil/23326\" to \"u/mforets/23326\"",
    "created_at": "2017-07-27T15:10:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438121",
    "user": "https://github.com/mforets"
}
```

Changing branch from "u/tmonteil/23326" to "u/mforets/23326"
...
```json
{
    "body": "Changing commit from \"c4b7a619fca34156d50e2ec66d8258c50b8ad283\" to \"1c604ddcbe70c131c1b55eabb47befa87a3c477d\"",
    "created_at": "2017-07-27T15:10:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438122",
    "user": "https://github.com/mforets"
}
```

Changing commit from "c4b7a619fca34156d50e2ec66d8258c50b8ad283" to "1c604ddcbe70c131c1b55eabb47befa87a3c477d"
...
```json
{
    "body": "<a id='comment:12'></a>.. filling the authors field",
    "created_at": "2017-07-27T19:53:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438123",
    "user": "https://github.com/mforets"
}
```

<a id='comment:12'></a>.. filling the authors field
...
```json
{
    "body": "Changing author from \"\" to \"Marcelo Forets, Thierry Monteil\"",
    "created_at": "2017-07-27T19:53:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438124",
    "user": "https://github.com/mforets"
}
```

Changing author from "" to "Marcelo Forets, Thierry Monteil"
...
```json
{
    "body": "<a id='comment:14'></a>Would be simpler and cleaner to just rebase your 5 lines commit on the latest beta (8.1.beta3) which contains #22605.",
    "created_at": "2017-09-04T05:59:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438125",
    "user": "https://github.com/videlec"
}
```

<a id='comment:14'></a>Would be simpler and cleaner to just rebase your 5 lines commit on the latest beta (8.1.beta3) which contains #22605.
...
```json
{
    "body": "<a id='comment:15'></a>is it the same as `git checkout t/mforets/23326` followed by a `git merge develop`?",
    "created_at": "2017-09-04T13:05:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438126",
    "user": "https://github.com/mforets"
}
```

<a id='comment:15'></a>is it the same as `git checkout t/mforets/23326` followed by a `git merge develop`?
...
```json
{
    "body": "Changing commit from \"1c604ddcbe70c131c1b55eabb47befa87a3c477d\" to \"0f60749043b0d1b809456890e433f6a44eddf313\"",
    "created_at": "2017-09-04T18:44:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438128",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "1c604ddcbe70c131c1b55eabb47befa87a3c477d" to "0f60749043b0d1b809456890e433f6a44eddf313"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438129",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>great! that worked, thanks.",
    "created_at": "2017-09-04T18:53:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438130",
    "user": "https://github.com/mforets"
}
```

<a id='comment:18'></a>great! that worked, thanks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438131",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438132",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "Changing branch from \"u/mforets/23326\" to \"0f60749043b0d1b809456890e433f6a44eddf313\"",
    "created_at": "2017-09-10T11:57:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438133",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/mforets/23326" to "0f60749043b0d1b809456890e433f6a44eddf313"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23326#issuecomment-438134",
    "user": "https://github.com/vbraun"
}
```
