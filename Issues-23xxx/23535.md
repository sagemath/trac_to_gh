...
```json
{
    "body": "LGTM. Have you considered going to an absolute number field and calling Singular? Do you know if that could be better in practice?",
