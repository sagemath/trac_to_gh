...
```json
{
    "body": "<a id='comment:25'></a>\nNew commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[b591b78](https://git.sagemath.org/sage.git/commit?id=b591b78190f41d6073729a860868edf4ab95a05c)|`Support __richcmp__ in Python classes`|\n|[47f97ec](https://git.sagemath.org/sage.git/commit?id=47f97ec88f373697faafeb84579becb064213dc1)|`Implement RealSet comparisons using __richcmp__`|\n|[acfd0aa](https://git.sagemath.org/sage.git/commit?id=acfd0aaea4de51b64c21fdd1a7a8d6e9174448de)|`Typo`|\n|[1569dda](https://git.sagemath.org/sage.git/commit?id=1569dda377326cdae9cbae8649fed7fd36640e1f)|`Merge tag '8.0.beta10' into t/23102/acfd0aaea4de51b64c21fdd1a7a8d6e9174448de`|\n|[f52d5c3](https://git.sagemath.org/sage.git/commit?id=f52d5c341e965716f799530424cf242c6a5547c2)|`Install slot wrappers for rich comparison methods`|",
