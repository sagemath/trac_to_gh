...
archive/issue_events_327580.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327580"
}
```
...
archive/issue_events_327581.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2017-07-13T20:49:12Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327581"
}
```
...
archive/issue_events_327582.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2017-07-13T20:49:12Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327582"
}
```
...
archive/issue_events_327583.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2017-07-13T20:49:12Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327583"
}
```
...
archive/issue_events_327584.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327584"
}
```
...
archive/issue_events_327585.json:
```json
{
    "actor": "https://github.com/unhyperbolic",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327585"
}
```
...
archive/issue_events_327586.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2018-01-01T21:31:34Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327586"
}
```
...
archive/issue_events_327587.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2018-01-01T21:31:34Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327587"
}
```
...
archive/issue_events_327588.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327588"
}
```
...
archive/issue_events_327589.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/23426",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23426#event-327589"
}
```
