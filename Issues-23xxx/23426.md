...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits:\n|                                                                                                                                          |                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[6c0daf8](https://git.sagemath.org/sage.git/commit?id=6c0daf85e2ef75e875131f5cf7dec0617a192867)|`Moving arrangeIcons.applescript (used when building the .dmg for Mac OS).`|\n|[9d47f2e](https://git.sagemath.org/sage.git/commit?id=9d47f2e0d29fbc9ad1b8972c7cf07a583415abde)|`Makefile for Mac OS .dmg: marking non_app_files as .PHONY.`|\n|[4459c37](https://git.sagemath.org/sage.git/commit?id=4459c37cdb8b235d89b23e6e062829ca818a9a4a)|`When building the Mac .dmg, re-enabling createDSStore (first introduced in ticket 20119 and then removed in ticket 22739) to set the background image.`|",
