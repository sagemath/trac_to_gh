...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[e1b5b52](https://git.sagemath.org/sage.git/commit/?id=e1b5b52677d328a9bec0f664acb60216cf00f0b0)|`Don't fallback to slow implementation for polynomials over ZZ`|",
