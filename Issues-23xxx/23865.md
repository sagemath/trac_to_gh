...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[f62bf27](https://git.sagemath.org/sage.git/commit?id=f62bf2772454a0af69e5ed2723070c5936ecfdc8)|`23865: disable doctest in omega`|",
    "created_at": "2017-09-15T07:31:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23865",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nSmall reviewer patch added (`untested` --> `not tested`) and I've added a new, shorter doctest which needs a small cross review. [Good to go from my side.]\n\n---\nNew commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[1401a24](https://git.sagemath.org/sage.git/commit?id=1401a24b8d300c8714b03cefc4a2da41e5b1cabd)|`23865: untested --> not tested`|\n|[12734e4](https://git.sagemath.org/sage.git/commit?id=12734e4b684ac9eac6f7484169bb7c7e37ba5d62)|`23865: add one long time doctest`|",
