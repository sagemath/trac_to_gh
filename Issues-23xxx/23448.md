...
```json
{
    "body": "<a id='comment:1'></a>After much suffering, I found out the code at fault in `configure.ac`:\n\n```\n#---------------------------------------------------------\n# We need to run this configure script with bash\nif test -z \"$BASH_VERSION$CONFIG_SHELL\"\nthen\n    CONFIG_SHELL=bash\n    export CONFIG_SHELL\n    if $CONFIG_SHELL -c \"exit 0\"\n    then\n        exec $CONFIG_SHELL $0 \"$@\"\n[...]\n```\nintroduced by e03f296685f986f89e1e12974f4c5ead9a9ff440.\n\nI guess the idea is to re-run configure ($0) with the same arguments ($`@`) but using bash. However, by the time we reach the line `exec $CONFIG_SHELL $0 \"$`@`\"`, the positional parameters have been obliterated by previous tests. Indeed, in the example above it happens to run `bash ./configure x make` which produces the error.\n\nWhen using debian's dash, it turns out that before reaching this code configure decides to rerun itself and for that reason it sets `CONFIG_SHELL=/bin/sh` (to avoid a recursion).\n\nHence, the test above is wrong (IMO it should //only// test `$BASH_VERSION`).",
    "created_at": "2017-07-18T00:19:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440856",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:1'></a>After much suffering, I found out the code at fault in `configure.ac`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440857",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"60ac90025ebfb0b4a8617922d7e09346458b103a\"",
    "created_at": "2017-07-18T02:00:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440858",
    "user": "https://github.com/tornaria"
}
```

Changing commit from "" to "60ac90025ebfb0b4a8617922d7e09346458b103a"
...
```json
{
    "body": "Changing branch from \"\" to \"u/tornaria/23448\"",
    "created_at": "2017-07-18T02:00:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440859",
    "user": "https://github.com/tornaria"
}
```

Changing branch from "" to "u/tornaria/23448"
...
```json
{
    "body": "Changing commit from \"60ac90025ebfb0b4a8617922d7e09346458b103a\" to \"e77704be65648f5915df5f78573eb26fbc22cee8\"",
    "created_at": "2017-07-18T02:34:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440860",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "60ac90025ebfb0b4a8617922d7e09346458b103a" to "e77704be65648f5915df5f78573eb26fbc22cee8"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440861",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>The first patch makes `configure` work with new versions of dash, but it breaks with old versions of dash (unpatched 0.5.6, and also version `0.5.7-4+b1` from debian jessie.\n\nThis happens because `test -z \"$BASH_VERSION$CONFIG_SHELL\"` is incorrect, it should instead be `test -z \"$BASH_VERSION\"`, which is what the second patch does.",
    "created_at": "2017-07-18T02:38:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440862",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:4'></a>The first patch makes `configure` work with new versions of dash, but it breaks with old versions of dash (unpatched 0.5.6, and also version `0.5.7-4+b1` from debian jessie.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440863",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440864",
...
```json
{
    "body": "<a id='comment:7'></a>I'm a bit lost here. I think I understood the problem, and I understand what your patch does. However, I don't see how that actually fixes the problem.",
    "created_at": "2017-07-18T11:46:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440865",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>I'm a bit lost here. I think I understood the problem, and I understand what your patch does. However, I don't see how that actually fixes the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440866",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>General side comment: when fixing a bug, three things have to be asked:\n\n(1) what is the problem?\n\n(2) what does the patch do?\n\n(3) how does (2) actually fix (1)?\n\nIn this case, I am missing (3).",
    "created_at": "2017-07-18T11:48:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440867",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>General side comment: when fixing a bug, three things have to be asked:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440871",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440872",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440873",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Author name",
    "created_at": "2017-07-19T07:35:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440874",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>Author name
...
```json
{
    "body": "<a id='comment:14'></a>Wouldn't it make sense to move the block\n\n```\nif test -z \"$BASH_VERSION\"\n```\neven higher in the file, as early as possible?",
    "created_at": "2017-07-19T07:41:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440875",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>Wouldn't it make sense to move the block
...
```json
{
    "body": "Changing branch from \"u/tornaria/23448\" to \"u/tornaria/23448-v2\"",
    "created_at": "2017-07-19T20:33:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440876",
    "user": "https://github.com/tornaria"
}
```

Changing branch from "u/tornaria/23448" to "u/tornaria/23448-v2"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440878",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "Changing commit from \"e77704be65648f5915df5f78573eb26fbc22cee8\" to \"16d2c3a5bc98b45ec3174d2e30e06889705e0fa6\"",
    "created_at": "2017-07-19T20:33:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440879",
    "user": "https://github.com/tornaria"
}
```

Changing commit from "e77704be65648f5915df5f78573eb26fbc22cee8" to "16d2c3a5bc98b45ec3174d2e30e06889705e0fa6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440880",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "Changing commit from \"16d2c3a5bc98b45ec3174d2e30e06889705e0fa6\" to \"de73482e6cd4d6ea667c867a7b6197c8ef29ef8c\"",
    "created_at": "2017-07-19T21:07:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440882",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "16d2c3a5bc98b45ec3174d2e30e06889705e0fa6" to "de73482e6cd4d6ea667c867a7b6197c8ef29ef8c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440883",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Final list of commits for this ticket, on branch [u/tornaria/23448-v3](https://git.sagemath.org/sage.git/log/?h=u/tornaria/23448-v3):",
    "created_at": "2017-07-19T22:56:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440885",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:19'></a>Final list of commits for this ticket, on branch [u/tornaria/23448-v3](https://git.sagemath.org/sage.git/log/?h=u/tornaria/23448-v3):
...
```json
{
    "body": "Changing commit from \"de73482e6cd4d6ea667c867a7b6197c8ef29ef8c\" to \"89212b447cda068b0596de93e59ca93a9104ad1e\"",
    "created_at": "2017-07-19T22:56:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440886",
    "user": "https://github.com/tornaria"
}
```

Changing commit from "de73482e6cd4d6ea667c867a7b6197c8ef29ef8c" to "89212b447cda068b0596de93e59ca93a9104ad1e"
...
```json
{
    "body": "Changing branch from \"u/tornaria/23448-v2\" to \"u/tornaria/23448-v3\"",
    "created_at": "2017-07-19T22:56:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440887",
    "user": "https://github.com/tornaria"
}
```

Changing branch from "u/tornaria/23448-v2" to "u/tornaria/23448-v3"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440888",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440889",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440890",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440892",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440893",
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23448#event-60225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440894",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Would it be acceptable to simply add to `./bootstrap` the `sed` editing of the generated `./configure` to replace all the occurence of `/bin/sh` with the output of `command -v bash` ?",
    "created_at": "2018-01-07T12:00:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440896",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:27'></a>Would it be acceptable to simply add to `./bootstrap` the `sed` editing of the generated `./configure` to replace all the occurence of `/bin/sh` with the output of `command -v bash` ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440898",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440899",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440900",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>OK, sorry for noise. It looks good.",
    "created_at": "2018-01-07T15:05:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440901",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:29'></a>OK, sorry for noise. It looks good.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440902",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440903",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>I never said that I agreed with the current branch.",
    "created_at": "2018-01-07T15:43:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440904",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>I never said that I agreed with the current branch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440905",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing branch from \"u/tornaria/23448-v3\" to \"89212b447cda068b0596de93e59ca93a9104ad1e\"",
    "created_at": "2018-01-14T10:14:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440906",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/tornaria/23448-v3" to "89212b447cda068b0596de93e59ca93a9104ad1e"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23448#issuecomment-440907",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23448#event-60226"
}
```
