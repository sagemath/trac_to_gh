...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[de73482](https://git.sagemath.org/sage.git/commit/?id=de73482e6cd4d6ea667c867a7b6197c8ef29ef8c)|`Trac #23448: change the way we run bash`|",
    "created_at": "2017-07-19T21:07:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23448",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nFinal list of commits for this ticket, on branch [u/tornaria/23448-v3](https://git.sagemath.org/sage.git/log/?h=u/tornaria/23448-v3):\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[16d2c3a](https://git.sagemath.org/sage.git/commit?id=16d2c3a5bc98b45ec3174d2e30e06889705e0fa6)|`Trac #23448: fix configure when run with dash`|\n|[89212b4](https://git.sagemath.org/sage.git/commit?id=89212b447cda068b0596de93e59ca93a9104ad1e)|`Trac #23448: use full path for bash in configure`|",
