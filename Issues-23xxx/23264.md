...
```json
{
    "body": "<a id='comment:1'></a>This looks like the same as in #23134",
    "created_at": "2017-06-17T13:13:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23264#issuecomment-342918",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>This looks like the same as in #23134
...
```json
{
    "body": "<a id='comment:2'></a>The segfault went away after removing the old pynac 0.7.5 library libpynac10. Normally it shouldn't be a problem to have the old library still around...\nSince it's already reported in #23134 this can be closed. (Seems like I can't do this.)",
    "created_at": "2017-06-17T13:16:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23264#issuecomment-342919",
    "user": "https://github.com/tobihan"
}
```

<a id='comment:2'></a>The segfault went away after removing the old pynac 0.7.5 library libpynac10. Normally it shouldn't be a problem to have the old library still around...
Since it's already reported in #23134 this can be closed. (Seems like I can't do this.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23264#issuecomment-342920",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23264#issuecomment-342921",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23264#issuecomment-342922",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23264#issuecomment-342923",
    "user": "https://github.com/embray"
}
```
