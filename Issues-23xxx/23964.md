...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334350"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334353"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334354"
}
```
...
```json
{
    ...
    "title_was": "f.subs(I==...) does not work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334355"
}
```
...
```json
{
    ...
    "title_was": "f.subs(I=...) does not work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334356"
}
```
...
```json
{
    ...
    "title_was": "f.subs(I==...) does not work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334357"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23964#event-334358"
}
```
