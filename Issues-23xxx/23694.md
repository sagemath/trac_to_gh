...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446342",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [output.txt](tarball://root/attachments/some-uuid/ticket23694/output.txt) by @saliola created at 2017-08-24 04:01:41\n\nI do not know how to go about debugging this. Suggestions?",
    "created_at": "2017-08-24T04:01:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446343",
    "user": "https://github.com/saliola"
}
```

<a id='comment:1'></a>Attachment [output.txt](tarball://root/attachments/some-uuid/ticket23694/output.txt) by @saliola created at 2017-08-24 04:01:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446345",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Okay, I suspect this has to do with the fact that there are magic constants defining maximum values to be 100 (specifically, `RH_MAX` in `ko.c` (and `PR_RH_MAX` in `pr.c`). Basically, my assessment is symmetrica is really bad on memory management by just using things of a fixed length of 100.\n\nMy conclusion, short of rewriting parts (all?) of symmetrica, I think we might want to raise a `NotImplementedError` when someone uses a larger length composition going through this code.",
    "created_at": "2017-08-24T15:35:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446347",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>Okay, I suspect this has to do with the fact that there are magic constants defining maximum values to be 100 (specifically, `RH_MAX` in `ko.c` (and `PR_RH_MAX` in `pr.c`). Basically, my assessment is symmetrica is really bad on memory management by just using things of a fixed length of 100.
...
```json
{
    "body": "<a id='comment:5'></a>Another option would be a native (and probably na\u00efve) implementation when the size is too large.",
    "created_at": "2017-08-24T15:39:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446348",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>Another option would be a native (and probably naïve) implementation when the size is too large.
...
```json
{
    "body": "<a id='comment:6'></a>I think that the native implementation is a good idea or write something similar to lrcalc for semi-standard tableaux.  Switching to lrcalc was how we avoided some errors with Schur products.  The limits its hitting here are not that big for reasonable choices of partitions.\n\nI think a long term goal should be to replace symmetrica completely.  It has known bugs, the main author is no longer alive, and the c code is littered with fairly cryptic abbreviations.",
    "created_at": "2017-08-24T15:54:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446349",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:6'></a>I think that the native implementation is a good idea or write something similar to lrcalc for semi-standard tableaux.  Switching to lrcalc was how we avoided some errors with Schur products.  The limits its hitting here are not that big for reasonable choices of partitions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446351",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446352",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>`@`asbuch, `@`hivert see[comment:8](#comment%3A8)",
    "created_at": "2017-08-28T17:01:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23694#issuecomment-446353",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>`@`asbuch, `@`hivert see[comment:8](#comment%3A8)
