# Issue 31184: Cached methods of superclasses can overshadow subclass methods
...
```json
{
    "body": "Stopgap in #31422.",
    "created_at": "2021-02-21T01:01:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445297",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Thanks! I'm using this pattern elsewhere (which is why I thought it was related to the cartesian product) but I guess I've been extremely lucky so far, only using it for performance gains and not to change the actual output.\n\nI marked the stopgap WONTFIX.",
    "created_at": "2021-02-22T12:35:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445299",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Even copy/pasting the code doesn't work! I give up.",
    "created_at": "2021-02-22T13:19:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445300",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Also, we should instead call `cartesian_embedding` in the CFM code instead of `summand_embedding`.",
    "created_at": "2021-02-22T23:29:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445304",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445305",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445306",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445307",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "It is doing that because you are returning an `int` from the `return len(str(Pi))`.",
    "created_at": "2021-02-27T06:52:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445308",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "I have now tested it with changing\n\n```python\n    @cached_method \n    def cartesian_embedding(self, i): \n        Ji = self.cartesian_factors()[i] \n        Ei = Ji._module_morphism(lambda t: self.monomial((i, t)), \n                                 codomain=self) \n        print(len(str(Ei))) \n        return Ei \n```\nthis now works and I get\n\n```\nsage: A = MyAlgebra(QQ, 3)                                                                                        \nsage: B = MyAlgebra(QQ, 2)                                                                                        \nsage: C = cartesian_product([A,B])                                                                                \n250\n250\nB[(0, 0)] + B[(1, 0)]\n```",
    "created_at": "2021-02-27T06:55:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445309",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445310",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "For `basis()`, you shouldn't override that, but instead pass the appropriate data up to CFM. Perhaps we should talk about this in more detail off trac to see if we can find a good workaround.",
    "created_at": "2021-02-28T05:46:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445311",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445312",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445314",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445315",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82409"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82410"
}
```
...
```json
{
    "body": "This is reported in #17201 and #21281, too. Using ``@`cached_method(name=...)` in the superclass to specify a different dict key does work; but if (as in my original report) the superclass is part of the sage library, then that's not an option.",
    "created_at": "2021-10-04T23:53:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31184#issuecomment-445316",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82411"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82412"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82413"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82414"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82415"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/31184#event-82416"
}
```
