...
Failed example:
    g.obtain_nash()
Expected:
    [This is the Trac macro ** that was inherited from the migration called with arguments (0, 1), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
Got:
    []
**********************************************************************
...
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (2/3, 1/3), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
...
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (3/4, 1/4), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
...
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (1/3, 2/3), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
...
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (2/7, 5/7), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
...
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (1/6, 5/6), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
...
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (9/10, 1/10), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
...
Expected:
    [[(0, 1), (1, 0)], [(99/101, 2/101), (99/101, 2/101)],
     [(1, 0), (0, 1)]]
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (99/101, 2/101), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
...
Expected:
    [This is the Trac macro ** that was inherited from the migration called with arguments (0, 0, 0, 0, 0, 0, 0, 0, 1), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
Got:
    []
**********************************************************************
...
Failed example:
    g.obtain_nash()
Expected:
    [This is the Trac macro ** that was inherited from the migration called with arguments (0, 0, 0, 1), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
Got:
    []
**********************************************************************
...
Failed example:
    f.obtain_nash()
Expected:
    [This is the Trac macro ** that was inherited from the migration called with arguments (0, 0, 1), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)   
Got:
    []
**********************************************************************
...
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (2/3, 1/12, 1/4, 0), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
**********************************************************************
File "src/sage/game_theory/normal_form_game.py", line 1245, in sage.game_theory.normal_form_game.NormalFormGame.obtain_nash
Failed example:
    g.obtain_nash(algorithm='lrs')  # optional - lrslib
Expected:
    [This is the Trac macro ** that was inherited from the migration called with arguments (0, 0, 3/4, 1/4), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
Got:
    []
**********************************************************************
...
Expected:
    [This is the Trac macro ** that was inherited from the migration called with arguments (1, 0, 0, 0, 0), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
Got:
    []
**********************************************************************
...
Got:
    [This is the Trac macro *<type 'tuple'>, <type 'tuple'>* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#<type 'tuple'>, <type 'tuple'>-macro)
**********************************************************************
...
Expected:
    [This is the Trac macro ** that was inherited from the migration called with arguments (0, 0, 0, 20/21, 1/21), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)
Got:
    []
**********************************************************************
...
Expected:
    [[(1/2, 1/2), (0, 1)], [(0, 1), (0, 1)]]
Got:
    [This is the Trac macro ** that was inherited from the migration called with arguments (1/2, 1/2), )](https://trac.sagemath.org/wiki/WikiMacros#-macro)  
**********************************************************************
