...
which was [http://www.sagemath.org/doc/reference/sage/symbolic/expression.html#sage.symbolic.expression.Expression.N ok (see there)] in Sage 4.8. The problem seems to have been introduced between release 5.0beta2 and 5.0beta7.
