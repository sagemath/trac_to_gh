...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209647",
    "user": "ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209648",
    "user": "ppurka"
}
```
...
```json
{
    "body": "Attachment [sage-clean-upstream](tarball://root/attachments/some-uuid/ticket16327/sage-clean-upstream) by leif created at 2014-05-11 14:51:51\n\nOne problem is that currently not all packages have proper versions / \"fullnames\", cf. `sage-list-packages`.  I.e., e.g. `ver` may be empty and then `pkg_ver=\"$pkg-$ver\"` doesn't work.",
    "created_at": "2014-05-11T14:51:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209649",
    "user": "leif"
}
```

Attachment [sage-clean-upstream](tarball://root/attachments/some-uuid/ticket16327/sage-clean-upstream) by leif created at 2014-05-11 14:51:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209650",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209651",
    "user": "ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209652",
    "user": "ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209653",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209654",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209655",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209656",
    "user": "ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209657",
    "user": "mjo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16090#issuecomment-209658",
    "user": "ppurka"
}
```
