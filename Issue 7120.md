...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7120#issuecomment-58913",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7120#issuecomment-58914",
...
```json
{
    "body": "Attachment [trac_7120-simplicial.patch](tarball://root/attachments/some-uuid/ticket7120/trac_7120-simplicial.patch) by @maxthemouse created at 2009-10-10 10:44:14\n\nThe patch looks good to me and -docbuild works. I take it that is just an introduction and some information and not a conversion. I like the style though. Is the intent to slowly convert or to have both styles? ~Adam",
    "created_at": "2009-10-10T10:44:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7120#issuecomment-58915",
    "user": "https://github.com/maxthemouse"
}
```

Attachment [trac_7120-simplicial.patch](tarball://root/attachments/some-uuid/ticket7120/trac_7120-simplicial.patch) by @maxthemouse created at 2009-10-10 10:44:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7120#issuecomment-58916",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7120",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/7120#event-7341"
}
```
