...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421887",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421888",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "I'm not sure if this is a good way to update the doctests. Essentially you are disabling a test by marking it random; the only way it can fail is if it raises an error.\n\nI think it would be better to invent a new doctest tag such as \"# random_seed=0\" or whatever is syntactically convenient.",
    "created_at": "2020-06-25T18:45:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421889",
...
```json
{
    "body": "To advertise my point about testing this stuff random #29961. In this instance, the `get_random_element` thing really failed sometimes. It wasn't discovered before, because only seed 0 is tested.\n\nWhat's the point about testing this only at seed 0. This doesn't tell us anything about how stable the method is.\n\nBut I should add a test that illustrates that this is an element of the correct thing.",
    "created_at": "2020-06-25T18:51:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421890",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421891",
...
```json
{
    "body": "Is this better? I would say the test is now more valuable than the old tests. It tells us that `random_element` will give us an element (not just on random seed 0 and not just something that looks like an element).",
    "created_at": "2020-06-25T20:33:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421892",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421893",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "The other thing that one could do, if you really want to keep the old test, is add the old test in the `TESTS` block (starting with `set_random_seed(0)`).\n\nThis way one could keep the old test.",
    "created_at": "2020-06-26T06:16:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421894",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "I'm not sure if I like explicit `set_random_seed` calls in the doctests because they affect all following doctests in the same block. \n\nI would prefer a solution as proposed in comment 2 above if this can be done easily.",
    "created_at": "2020-06-26T16:44:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421895",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "How will the solution as in comment two work out if all testings are done with random seed. That would basically mean, it is never tested as well.\n\nI know that `set_random_seed(0)` will affect all other tests in the same block. This is why I propsed having it in the tests section (as last thing being run). Than it wouldn't affect anything.",
    "created_at": "2020-06-26T20:40:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421896",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "How about a Makefile target that runs tests with `random_seed=0`, or maybe a Makefile target that runs tests twice, once with `seed=0` and once with a random seed? Then make sure that people start thinking of that as the new default.\n\nOr as `@`gh-kliem suggests, double up on some doctests:\n\n```\n    sage: test1\n    sage: test2\n\nEnd of test block::\n\n    sage: test1 # random-seed=0\n    sage: test2 # random-seed=0\n```",
    "created_at": "2020-06-26T23:41:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421897",
...
```json
{
    "body": "I agree, discussing this on sage-devel and #29935 would probably be best.",
    "created_at": "2020-06-27T17:34:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421899",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421900",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421901",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421902",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421903",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "Note that elements of `C = FiniteEnumeratedSets().example()` are not elements of `C`, but integers.",
    "created_at": "2020-07-20T04:43:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421904",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421905",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421906",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421907",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29734#issuecomment-421908",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29734#event-76962"
}
```
