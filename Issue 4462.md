...
```json
{
    "body": "Attachment [implicit-plot-no-fill.patch](tarball://root/attachments/some-uuid/ticket4462/implicit-plot-no-fill.patch) by @jasongrout created at 2008-11-07 17:33:24",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4462",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4462#event-4710"
}
```
