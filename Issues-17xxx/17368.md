...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[107e511](http://git.sagemath.org/sage.git/commit/?id=107e511f3857ccef93a01d2c22a6caa51b9ecf23)|`#17368 forgot to modify install script.`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[013e2e2](http://git.sagemath.org/sage.git/commit/?id=013e2e27978d4b48dd38ee3a00825f385286b0ba)|`#17368 remove a test related to pip being optional.`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[bf37567](http://git.sagemath.org/sage.git/commit/?id=bf375679641dcd174babbc95f883551f3349b627)|`#17368 : add setuptools as a dependency.`|\n|[7380e00](http://git.sagemath.org/sage.git/commit/?id=7380e00fcfecfc5d563b82ba5383cdea9b8f8ba7)|`#17368 add pip to COPYING.txt`|",
