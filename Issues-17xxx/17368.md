...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294667",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294668",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294669",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294670",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294671",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294672",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294673",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294674",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294675",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294676",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294677",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294678",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Note that for pip to work, python must be built with OpenSSL support. Otherwise one gets\n\n```\nImportError: cannot import name HTTPSHandler\n```\nSo if we make pip a standard package, we would have to make OpenSSL a requirement for sage again (and/or use the openssl package for sage)",
    "created_at": "2014-12-03T09:05:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294679",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:7'></a>Note that for pip to work, python must be built with OpenSSL support. Otherwise one gets
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294680",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294681",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294682",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294683",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294684",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294685",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294686",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294687",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294688",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>But part of the argument for having pip as standard is precisely to use it to install some of the packages, isn't it? Maybe openssl has to be made into a standard dependency. Both sagenb and ipython notebooks have issues without it already.",
    "created_at": "2014-12-11T21:57:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294689",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:14'></a>But part of the argument for having pip as standard is precisely to use it to install some of the packages, isn't it? Maybe openssl has to be made into a standard dependency. Both sagenb and ipython notebooks have issues without it already.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294690",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>It has functionality to install pre-downloaded packages. Perhaps there will be no need for security library for this use.",
    "created_at": "2014-12-12T01:58:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294691",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:16'></a>It has functionality to install pre-downloaded packages. Perhaps there will be no need for security library for this use.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294692",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294694",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294695",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294696",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294697",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17368#event-50076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17368#issuecomment-294698",
    "user": "https://github.com/vbraun"
}
```
