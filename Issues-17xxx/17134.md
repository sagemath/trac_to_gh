...
```json
{
    "body": "Attachment [file.rst](tarball://root/attachments/some-uuid/ticket17371/file.rst) by @kcrisman created at 2014-11-21 17:39:20",
    "created_at": "2014-11-21T17:39:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17134#issuecomment-227526",
    "user": "https://github.com/kcrisman"
}
```

Attachment [file.rst](tarball://root/attachments/some-uuid/ticket17371/file.rst) by @kcrisman created at 2014-11-21 17:39:20
...
```json
{
    "body": "And yes it is true that docutils is just putting these things in order with id numbers.  So in that sense intra-doc links will not work properly, if they pre-existed - I guess one has to use Sphinx, I don't know?  But that might be a bit much to combine with sagenb.",
    "created_at": "2014-11-21T17:40:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17134#issuecomment-227527",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17134#issuecomment-227528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17134#issuecomment-227529",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17134#event-50079"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17134#issuecomment-227530",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17134",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17134#event-50080"
}
```
