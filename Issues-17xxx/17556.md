...
```json
{
    "body": "<a id='comment:1'></a>\nNot too much had to be changed for this. Since the 'one' algorithm was used for `simplify_log()` within `simplify_full()`, it rarely had any effect.\n\n---\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[fbc0a40](https://github.com/sagemath/sagetrac-mirror/commit/fbc0a401f2e984796aa9d6103fe5c2397c7d4d1a)|`Trac #17556: Remove simplify_log() from simplify_full().`|\n|[3ea1ded](https://github.com/sagemath/sagetrac-mirror/commit/3ea1ded198974490f5e93409947344f03798e25b)|`Trac #17556: Add simplify_rectform() to simplify_full().`|\n|[044db1d](https://github.com/sagemath/sagetrac-mirror/commit/044db1d2b7bc4e914e92ed7aa87629cbe958bc52)|`Trac #17556: Add Expression.simplify_log() to Expression.simplify_real().`|",
    "created_at": "2014-12-29T15:02:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17556",
    "type": "issue_comment",
