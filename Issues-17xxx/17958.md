...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308513",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308514",
...
```json
{
    "body": "<a id='comment:5'></a>I should have looked sooner: the catch is, I removed the `globals` injection in `calculus/var.pyx:var()` and the variables get still injected. And indeed the same with `SR.var()`, so that has side effects too and is no cure for the matter.\n\nEDIT: Noo, that's wrong, it's the expression on the lhs that gets injected!\n\nI still have to find a case where injection of the variable itself matters.",
    "created_at": "2015-03-17T17:07:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308516",
    "user": "https://github.com/rwst"
}
```

<a id='comment:5'></a>I should have looked sooner: the catch is, I removed the `globals` injection in `calculus/var.pyx:var()` and the variables get still injected. And indeed the same with `SR.var()`, so that has side effects too and is no cure for the matter.
...
```json
{
    "body": "<a id='comment:6'></a>I think I don't understand what you mean:\n\n```\nsage: SR.var('xyz')\nxyz\nsage: xyz\n...\nNameError: name 'xyz' is not defined\n```",
    "created_at": "2015-03-17T17:40:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308517",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:6'></a>I think I don't understand what you mean:
...
```json
{
    "body": "<a id='comment:7'></a>> I still have to find a case where injection of the variable itself matters.\n\nSorry, I should say... where injection via `globals` in the `var` function makes a difference versus `ex = SR.var(...)`, where presumably `globals` is filled by iPython with the `ex`.",
    "created_at": "2015-03-18T06:31:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308518",
    "user": "https://github.com/rwst"
}
```

<a id='comment:7'></a>> I still have to find a case where injection of the variable itself matters.
...
```json
{
    "body": "<a id='comment:8'></a>The name `var` by itself makes a lot of confusion. There are Python variables which are a very different concept. What about calling it `symbol` or `Symbol` as it is done in [sympy](http://www.sympy.org/en/index.html)?\n\nVincent",
    "created_at": "2015-03-26T08:05:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308519",
    "user": "https://github.com/videlec"
}
```

<a id='comment:8'></a>The name `var` by itself makes a lot of confusion. There are Python variables which are a very different concept. What about calling it `symbol` or `Symbol` as it is done in [sympy](http://www.sympy.org/en/index.html)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308520",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308521",
...
```json
{
    "body": "<a id='comment:11'></a>`SR.var` does exactly what the `declare_var` does without the drawbacks of an additional global, so as it stands I'm against the ticket description.\n\n`SR.symbol` and `SR.var` should probably be aliases but aren't. I wasn't even aware of `SR.symbol`, which is why I only fixed the comma parsing in `SR.var` in #7496.\n\nHow about something like `R.<x> = SR()` to get symbolic generators?",
    "created_at": "2015-03-26T12:34:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308522",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>`SR.var` does exactly what the `declare_var` does without the drawbacks of an additional global, so as it stands I'm against the ticket description.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308523",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308524",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308525",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Thierry, I agree fully but:\n> > How about something like `R.<x> = SR()` to get symbolic generators?\n\n> \n> This is non-pythonic, requires additional preparsing, needs to create the name `R` while the ring `SR` is already here, and will add even more confusion to newcomers that hardly understand the difference between a symbolic expression like `x^2+1` and a well defined polynomial over a well defined ring.\n\n\nBut it would be consistent and allow different ring types (later). Actually `declare_var` could be provided additionally.",
    "created_at": "2015-03-26T14:37:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308526",
    "user": "https://github.com/rwst"
}
```

<a id='comment:15'></a>Thierry, I agree fully but:
> > How about something like `R.<x> = SR()` to get symbolic generators?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308527",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308529",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308530",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308532",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308534",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308537",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308538",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308539",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>> Searching our current codebase and examples indicates you might not be right in that assumption. I didn't do a precise count, but the occurrences of `a=var('a')` and `c,d=var('c,d')` are quite frequent (half of the `var` occurrences maybe?), so there's definitely an immediate need for it to do an automatic replacement.\n> \n> The fact that this developed in the first place also suggests that a significant number of people were not aware of/did not trust the injecting behaviour of `var`, so it's probably \"surprising\" behaviour (it's certainly non-pythonic to go and scribble in the globals dictionary). That indicates to me that the routine doing it needs a name that makes explicit it's having a side effect. A normal way of doing that is making the name a verb or verbal phrase, hence `declare_var` or `declare_symbol`.\n\n\nWell, of course another reason is that in doctests it can be annoying to do\n\n```\nsage: var('a')\na\n```\nwhile \n\n```\nsage: a=var('a')\nsage:\n```\nseems cleaner.   Maybe it's not all due to confusion.",
    "created_at": "2015-03-29T01:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308541",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:32'></a>> Searching our current codebase and examples indicates you might not be right in that assumption. I didn't do a precise count, but the occurrences of `a=var('a')` and `c,d=var('c,d')` are quite frequent (half of the `var` occurrences maybe?), so there's definitely an immediate need for it to do an automatic replacement.
> 
> The fact that this developed in the first place also suggests that a significant number of people were not aware of/did not trust the injecting behaviour of `var`, so it's probably "surprising" behaviour (it's certainly non-pythonic to go and scribble in the globals dictionary). That indicates to me that the routine doing it needs a name that makes explicit it's having a side effect. A normal way of doing that is making the name a verb or verbal phrase, hence `declare_var` or `declare_symbol`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308542",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308544",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308546",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308547",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>Please change the description accordingly if no one has serious arguments (I think it's optimal). If asked about `%var`/`var` my purely personal preference would be the latter.",
    "created_at": "2015-03-29T12:43:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308549",
    "user": "https://github.com/rwst"
}
```

<a id='comment:40'></a>Please change the description accordingly if no one has serious arguments (I think it's optimal). If asked about `%var`/`var` my purely personal preference would be the latter.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308551",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>PS: The Sage doctests are preparsed but not run in IPython. So `var a` would work in a doctest, whereas `%var a` would not.",
    "created_at": "2015-03-29T16:53:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308552",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:43'></a>PS: The Sage doctests are preparsed but not run in IPython. So `var a` would work in a doctest, whereas `%var a` would not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308553",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>NOTE: I am making changes to the implementation of `var()` in #18083.",
    "created_at": "2015-03-29T17:52:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308554",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:45'></a>NOTE: I am making changes to the implementation of `var()` in #18083.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308555",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>See also #18084.",
    "created_at": "2015-03-29T19:50:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308557",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:48'></a>See also #18084.
...
```json
{
    "body": "<a id='comment:50'></a>Oh you mean the good old `var(', '.join(['x{0}'.format(i) for i in range(10)]))` trick. Calculus freshmen are going to love your class... In any case I don't mind having a way to inject multiple variables at once, but something like\n\n```\nsage: SR.inject_variables('x, y')    \nsage: SR.inject_variables('x', 'y')   # strings to variable names\nsage: SR.inject_variables('x{i}', i=range(10))    # use keyword arguments to format\nsage: SR.inject_variables(ex)     # inject all of ex.variables()\n```\nwould probably be a lot better.",
    "created_at": "2015-03-29T21:37:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308559",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:50'></a>Oh you mean the good old `var(', '.join(['x{0}'.format(i) for i in range(10)]))` trick. Calculus freshmen are going to love your class... In any case I don't mind having a way to inject multiple variables at once, but something like
...
```json
{
    "body": "<a id='comment:52'></a>I would favor an \"infinite\" deprecation period for `var()`: deprecate it but keep supporting it forever.",
    "created_at": "2015-03-30T20:17:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308561",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:52'></a>I would favor an "infinite" deprecation period for `var()`: deprecate it but keep supporting it forever.
...
```json
{
    "body": "<a id='comment:53'></a>Seems reasonable.",
    "created_at": "2015-03-31T01:19:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308562",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:53'></a>Seems reasonable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308563",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>I've announce this discussion on sage-devel https://groups.google.com/forum/#!topic/sage-devel/iy8Ck6BbhSE",
    "created_at": "2015-04-13T14:14:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308564",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:55'></a>I've announce this discussion on sage-devel https://groups.google.com/forum/#!topic/sage-devel/iy8Ck6BbhSE
...
```json
{
    "body": "<a id='comment:57'></a>os.system is a terrible example, its just a syscall wrapper. The subprocess module precisely tries to improve that interface by giving you separate check_output / check_call functions so you can create subprocesses in a more pythonic manner.",
    "created_at": "2015-04-13T14:49:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308566",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:57'></a>os.system is a terrible example, its just a syscall wrapper. The subprocess module precisely tries to improve that interface by giving you separate check_output / check_call functions so you can create subprocesses in a more pythonic manner.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308570",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:62'></a>To get this back on track, the minimal change that would satisfactorily resolve the issue would be a warning (but keep `var` indefinitely)\n\n```\nsage: var('x, y')    # warning but keep indefinitely\nWarning: var has side effects. Consider using %var x, y\n(x, y)\n```\nand\n\n```\nsage: %var x, y\nDefining x, y as symbolic variables.\n```\nThe latter would also have to work in doctests where percent-magics currently do not work.",
    "created_at": "2015-04-14T14:16:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308571",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:62'></a>To get this back on track, the minimal change that would satisfactorily resolve the issue would be a warning (but keep `var` indefinitely)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308572",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:64'></a>Replying to [nbruin](#comment%3A63):\n>  - I personally like the printing of a message by `%var` for novices, but[comment:32](#comment%3A32) suggests that the printing is a nuisance. So is it better for  `%var` to do its work silently?\n\n\nAn option may be to print it using `verbose(level=0)`, and document that the verbosity level may be set to negative to suppress such messages.",
    "created_at": "2015-04-14T14:33:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308573",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:64'></a>Replying to [nbruin](#comment%3A63):
>  - I personally like the printing of a message by `%var` for novices, but[comment:32](#comment%3A32) suggests that the printing is a nuisance. So is it better for  `%var` to do its work silently?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308575",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308576",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:68'></a>Related to this discussion, note that there is another (strange) way to declare variables in Sage that currently works:\n\n```\nsage: ,var x a b c\n(x, a, b, c)\nsage: type(a)\n<type 'sage.symbolic.expression.Expression'>\n```\n\nApparently, it is ipython that provides this. I learn about the existence of this when I recently read the [wikipedia page of Sage](http://en.wikipedia.org/wiki/Sage_(mathematics_software)):\n\n```\nx, a, b, c = var('x, a, b, c')\n# Note that IPython also supports a faster way to do this, by calling \n# this equivalent expression starting with a comma:\n# ,var x a b c\n```",
    "created_at": "2015-04-14T18:57:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308577",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:68'></a>Related to this discussion, note that there is another (strange) way to declare variables in Sage that currently works:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17958#issuecomment-308578",
    "user": "https://github.com/nbruin"
}
```
