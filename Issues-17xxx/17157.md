...
```json
{
    "body": "<a id='comment:7'></a>Replying to [fredrik.johansson](#comment%3A6):\n> Sage's current bell_number(n, algorithm='dobinski')\n\nWith or without this patch?",
...
<a id='comment:7'></a>Replying to [fredrik.johansson](#comment%3A6):
> Sage's current bell_number(n, algorithm='dobinski')
...
<a id='comment:8'></a>Replying to [fredrik.johansson](#comment%3A6):
> You might also consider wrapping flint's arith_bell_number.
