...
```json
{
    "body": "If I understand correctly, the leak is fixed in a later version of singular. Hope it will be in Sage soon...",
...
```json
{
    "body": "Maybe related: http://ask.sagemath.org/question/29444/high-memory-usage-when-substituting-variables/",
