...
```json
{
    "body": "<a id='comment:1'></a>Perhaps we should just cache the result of `.automorphism_group()`, given that we have immutable graphs. And we could have notes in the related functions saying that it uses the cache if the graph is immutable ?\n\nNathann",
    "created_at": "2015-01-09T10:34:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17611#issuecomment-231256",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:1'></a>Perhaps we should just cache the result of `.automorphism_group()`, given that we have immutable graphs. And we could have notes in the related functions saying that it uses the cache if the graph is immutable ?
...
```json
{
    "body": "<a id='comment:2'></a>Yes this looks like a good way to do it. Though it we would then need to address separately this new feature of testing transitivity on subgroups of Aut(G) ?",
    "created_at": "2015-01-09T10:38:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17611#issuecomment-231257",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:2'></a>Yes this looks like a good way to do it. Though it we would then need to address separately this new feature of testing transitivity on subgroups of Aut(G) ?
