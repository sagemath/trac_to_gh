...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300770",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300771",
...
```json
{
    "body": "<a id='comment:4'></a>I try to exactly what you are proposing. But I've struggle with the following:\n\n```\nfp_gap = libgap.FreeGroup(\"x\", \"y\")\nfp_sage = wrap_FreeGroup(fp_gap)\n\ng = fp_sage / [x^2*y^-1, x^3*y^2, x*y*x^-1*y^-1]\n*EXCEPTION*\nNameError: name 'y' is not defined\n```\n\nReplying to [vdelecroix](#comment%3A3):\n> Sorry, I should have been clearer. The only issue is that\n> \n> ```\n> sage: F.<x,y> = FreeGroup(2)\n> sage: G = F/[x**2*y,x*y]\n> sage: G\n> Finitely presented group < x, y | x^2*y, x*y >\n> sage: G_gap = G._gap_()\n> sage: from sage.groups.finitely_presented import FinitelyPresentedGroup\n> sage: FinitelyPresentedGroup(G_gap)\n> ** BOOM **\n> sage: FinitelyPresentedGroup(gap_group=G_gap)\n> ** BOOM **\n> ```\n> What are you trying to do?!\n> \n> In the mean time, I realized that there is a function `wrap_FpGroup` so I think that there is almost nothing to do to make it work.\n> \n> Vincent",
    "created_at": "2015-01-25T21:35:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300773",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```

<a id='comment:4'></a>I try to exactly what you are proposing. But I've struggle with the following:
...
```json
{
    "body": "<a id='comment:5'></a>Replying to [captaintrunky](#comment%3A4):\n> I try to exactly what you are proposing. But I've struggle with the following:\n\n\nGreat ;-)\n\nWhat I know\n\n```\nfp_gap = libgap.FreeGroup(\"x\", \"y\")\nsage: libgap.GeneratorsOfGroup(fp_gap)\n[ x, y ]\nsage: F = wrap_FreeGroup(fp_gap)\nsage: F.gen(0)\nx\nsage: F.gen(1)\ny\n```",
    "created_at": "2015-01-25T21:47:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300774",
    "user": "https://github.com/videlec"
}
```

<a id='comment:5'></a>Replying to [captaintrunky](#comment%3A4):
> I try to exactly what you are proposing. But I've struggle with the following:
...
```json
{
    "body": "<a id='comment:6'></a>I knew this too, but it does not work due to this exception. As I understand, the code:\n\n```\nf.<x,y> = FreeGroup()\n```\nmakes some magic and the code:\n\n```\nf = FreeGroup(\"x, y\")\n```\ndoesn't do this magic. This whole thing completely breaks relations addition. Probably, I should ask on sage-devel.\n\nReplying to [vdelecroix](#comment%3A5):\n> Replying to [captaintrunky](#comment%3A4):\n> > I try to exactly what you are proposing. But I've struggle with the following:\n\n> \n> Great ;-)\n> \n> What I know\n> \n> ```\n> fp_gap = libgap.FreeGroup(\"x\", \"y\")\n> sage: libgap.GeneratorsOfGroup(fp_gap)\n> [ x, y ]\n> sage: F = wrap_FreeGroup(fp_gap)\n> sage: F.gen(0)\n> x\n> sage: F.gen(1)\n> y\n> ```",
    "created_at": "2015-01-25T22:05:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300775",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```

<a id='comment:6'></a>I knew this too, but it does not work due to this exception. As I understand, the code:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300777",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300779",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300780",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300781",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300782",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300783",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300784",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300785",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17627#issuecomment-300786",
    "user": "https://github.com/videlec"
}
```
