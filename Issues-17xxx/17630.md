...
```json
{
    "body": "<a id='comment:6'></a>\nThis is definitely not really needs_reviex, in particular, OS X surely needs further tweaking, not sure that passing `-lblas` or `lcblas` would always work, or if one sometines needs to pass the `-framework` stuff...\nI've basically tested it on Linux and Cygwin and it looks ok.\n\nAnyway, I won't be able to do anything for at leasr one month, so here is the current state of affair.\nFeel free to finalize and merge it!\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[79c712c](http://git.sagemath.org/sage.git/commit/?id=79c712c9a807c01048afceadf461e91e9d6aa5ea)|`Simplify BLAS/LAPACK config for IML.`|\n|[030b90b](http://git.sagemath.org/sage.git/commit/?id=030b90bea83b1abbc0a503fa18d90b4b52d6fd6d)|`Simplify BLAS/LAPACK config for numpy.`|\n|[2a14692](http://git.sagemath.org/sage.git/commit/?id=2a14692c1a0a49efc4c54f6a52d29f9eaf7f7352)|`Simplify BLAS/LAPACK config for Sage library.`|\n|[355fff8](http://git.sagemath.org/sage.git/commit/?id=355fff8d9fab14fda3cd1c92e130a88f46a2b24a)|`Let ATLAS install script write cblas_config.`|\n|[14675a5](http://git.sagemath.org/sage.git/commit/?id=14675a5558cd36e837d1036d9f5753d8d88e6f69)|`Remove SAGE_CBLAS documentation.`|\n|[cf79fc3](http://git.sagemath.org/sage.git/commit/?id=cf79fc30c7710af88cf832d0812c2bbb223f1249)|`First try to simplify BLAS/LAPACK configuration for cvxopt.`|\n|[534ec94](http://git.sagemath.org/sage.git/commit/?id=534ec94bdc065c8c330c1848838fb65c2fbe28ec)|`Fix cblas_config mechanism.`|\n|[09e8128](http://git.sagemath.org/sage.git/commit/?id=09e8128480fdd4ffbec4c9db3e751d088a5ada36)|`Further modifications to numpy/scipy build systems.`|\n|[37abe37](http://git.sagemath.org/sage.git/commit/?id=37abe376db742dadbbaf208c2f799b7520c19147)|`Slight cleanup of cvxopt directory.`|\n|[b02e159](http://git.sagemath.org/sage.git/commit/?id=b02e1593daa51b92401eed7746efcdc665b31388)|`Fixes for cleaner BLAS config.`|",
    "created_at": "2015-01-17T18:44:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[091e941](http://git.sagemath.org/sage.git/commit/?id=091e941e88d7509f6fffe44785136ae27287aab2)|`Merge remote-tracking branch 'trac/develop' into ticket/17630`|",
    "created_at": "2015-04-17T09:38:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[882d720](http://git.sagemath.org/sage.git/commit/?id=882d72030492da6519301fc8fcadd36093251af4)|`Wrong conflict resolution for numpy.`|",
    "created_at": "2015-04-17T11:24:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[73a21a9](http://git.sagemath.org/sage.git/commit/?id=73a21a99499891e5b21552888da9cfa611e53061)|`Second try for numpy fixing.`|",
    "created_at": "2015-04-17T11:32:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[a9d2dcf](http://git.sagemath.org/sage.git/commit/?id=a9d2dcf1344c005d6796ec288181451447124718)|`And final fixes.`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[045266e](http://git.sagemath.org/sage.git/commit/?id=045266e53354e7f3badb2e2b7dcd4f2c0cea2fa2)|`Final fix for a correct conflict resolution.`|",
...
```json
{
    "body": "<a id='comment:45'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[d448831](http://git.sagemath.org/sage.git/commit/?id=d448831b044c43b1190ece92ac6c4b60eb332d7c)|`Forgot a very important \"+\" in module_list.py`|",
    "created_at": "2015-06-26T10:24:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:63'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[5c9e7a5](http://git.sagemath.org/sage.git/commit/?id=5c9e7a50cbc9b97db2c560e18d08294b33b768e7)|`Proper insertion in library_order`|",
    "created_at": "2015-06-26T13:07:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:68'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[cc5fefc](http://git.sagemath.org/sage.git/commit/?id=cc5fefccdd5afb8fef93aa89e9f1a6317da830f4)|`Introduce a finer grain of configuration between blas/cblas/lapack. In the future we want to move to .pc file and the configuration will have the same granularity.`|\n|[57cbf6f](http://git.sagemath.org/sage.git/commit/?id=57cbf6f5eda1b6315c05789710010ee6930645b7)|`Clean up spkg-install of all packages affected by the changes in the ATLAS spkg. The new model in anticipation of future changes is to not rely on autodetection of`|\n|[eda2eb6](http://git.sagemath.org/sage.git/commit/?id=eda2eb638d7c10f36053aa43474bb2fd21cd4db2)|`Centralize the reading of SAGE_SHARE/*_config files in sage/env.py where it can be accessed by setup.py/module_list.py and sage/misc/cython.py.`|",
...
```json
{
    "body": "<a id='comment:73'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[83fbfcf](http://git.sagemath.org/sage.git/commit/?id=83fbfcf79a435d04c1bc7c90b1ad7ff4510797db)|`Fix indent in ATLAS spkg-install, add a doctest for get_libs_config.`|",
    "created_at": "2015-06-29T09:02:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:79'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[2e78027](http://git.sagemath.org/sage.git/commit/?id=2e780270799ebe985039590431189dd5f3bde730)|`typo in atlas spkg-install, manifest itself on OS X`|",
...
```json
{
    "body": "<a id='comment:86'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[beeb264](http://git.sagemath.org/sage.git/commit/?id=beeb264e9929e335f64975028c95bc03cc4b7d81)|`Revert changes to sage-env`|",
...
```json
{
    "body": "<a id='comment:87'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[b2495dd](http://git.sagemath.org/sage.git/commit/?id=b2495dd4d55a4392e0d8224764e6eb7d5bc96f71)|`Improve portability of sed script so that it works on OS X.`|\n|[764c3b5](http://git.sagemath.org/sage.git/commit/?id=764c3b574a438ef36b3a8a29552a7691514a37fb)|`Forgot to close the conditional when reversing LDFLAGS changes in sage-env`|",
