...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[4476266](http://git.sagemath.org/sage.git/commit/?id=4476266587733622582d32b1b7015c56ae97bf69)|`Disallow pari(None), improve docs for Strexpand()`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[0bef47c](http://git.sagemath.org/sage.git/commit/?id=0bef47cbcd58df7d75a60048ed9a94818a8443c4)|`Mark Strexpand() doctests random`|",
