...
```json
{
    "body": "<a id='comment:6'></a>Here is a bunch of speed tests I am using in order to see whether some changes slow things down:\n\nhttps://www.dropbox.com/s/xp9dqzifbx8e685/diagnostic.py?dl=0",
...
<a id='comment:6'></a>Here is a bunch of speed tests I am using in order to see whether some changes slow things down:
