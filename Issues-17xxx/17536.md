...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232274"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17536#issuecomment-237722",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232280"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232281"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17536#issuecomment-237723",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17536",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17536#event-232285"
}
```
