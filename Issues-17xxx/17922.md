...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17922#event-237361"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17922#event-237362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17922#event-237363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17922#event-237364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17922#issuecomment-245373",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17922#issuecomment-245374",
    "user": "https://github.com/rwst"
}
```
