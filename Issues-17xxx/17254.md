...
```json
{
    "body": "<div id=\"comment:287\" align=\"right\">comment:287</div>\n\nWhat's the point of this commented-out code? Just remove it.\n\n```\n# C++11 workaround https://github.com/sagemath/sage/issues/20926\n# Since https://github.com/sagemath/sage/issues/17635 linbox passes a -std=gnu++11 flag, so we no longer need to add it\n# if [ \"$UNAME\" = CYGWIN ]; then\n     # Special case for Cygwin https://github.com/sagemath/sage/issues/21185\n#     CXXFLAGS=\"$CXXFLAGS -std=gnu++98\"\n# else\n#     CXXFLAGS=\"$CXXFLAGS -std=c++98\"\n#fi\n```",
