...
```json
{
    "body": "<a id='comment:6'></a>\nsomething like this should do the trick. Feel free to amend as needed.\n\n---\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[bc20667](http://git.sagemath.org/sage.git/commit/?id=bc20667184ca8209776d8c363df2aa3e65994287)|`trac #17320: fix some memory management for coin_backend`|",
    "created_at": "2014-11-13T06:36:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17320",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nHello again !\n\nTurns out that their license thing was greatly simplified since (or that I was lucky). Either way it went smoothly after I got a real internet connection.\n\nI did the fix for Gubori, though for some reason I don't quite get why it works... I actually *removed* a call to GRBfreeenv and the memory leak seems to have disappeared. While debugging I noticed that GRBmodel returned an error code.\n\nWell, here it is `:-)`\n\nNathann\n\n---\nNew commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[4da9aa3](http://git.sagemath.org/sage.git/commit/?id=4da9aa37899f2344ab1edc7a1acc27d652c8a562)|`trac #17320: Broken doctests`|\n|[4fcbc89](http://git.sagemath.org/sage.git/commit/?id=4fcbc893899a19c98268dc2dfb03d91f24313147)|`trac #17320: Memory leak`|\n|[520c6f1](http://git.sagemath.org/sage.git/commit/?id=520c6f155e8fe0743dc4b739f6ce136122d89fba)|`trac #17320: Merged with 6.5.beta0`|\n|[351f3e1](http://git.sagemath.org/sage.git/commit/?id=351f3e1448f8b18251296d93056736ded8517f19)|`trac #17320: Same fix for Gurobi`|",
    "created_at": "2014-11-17T15:17:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17320",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|\n|[5480f4e](http://git.sagemath.org/sage.git/commit/?id=5480f4e85c1a0ff96bd1502c78992073ccb854e5)|`trac 17320: tighten window for memory leak in CoinBackend.solve and ensure that function declared \"int\" actually has a return statement`|",
    "created_at": "2014-11-17T20:20:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17320",
    "type": "issue_comment",
