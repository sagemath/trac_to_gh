...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[a3ea596](http://git.sagemath.org/sage.git/commit/?id=a3ea5969dec0961259a68a9d2b44e3ef34e7b271)|`Added support for graded Hilbert series.`|",
    "created_at": "2014-11-06T11:33:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17298",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[d1703bc](http://git.sagemath.org/sage.git/commit/?id=d1703bc5ed9bb821b5401511b07e62de24db7b3e)|`Added support for graded Hilbert series and Hilbert numerators (graded and standard).`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nSo I've made some reviewer changes to clean up the code which better handles things like `grading=(2/2, int(3))`. It might be nice to add support for grading given as a vector or an additive abelian group, but that can be done later. So if you're happy with my changes, then you can set a positive review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[6a08c10](http://git.sagemath.org/sage.git/commit/?id=6a08c105e202cac068e7e9fa09ae8723b5188e79)|`Merge branch 'u/john_perry/adding_graded_weighted_hilbert_series_functionality_to_sage' of trac.sagemath.org:sage into public/ticket/17298-graded_hilbert_series`|\n|[d354cc5](http://git.sagemath.org/sage.git/commit/?id=d354cc55c95723a1dc6386aa434caccdcdfc36dc)|`Some reviewer changes.`|\n|[4e07152](http://git.sagemath.org/sage.git/commit/?id=4e0715238f3e086418c95b8cfcb3fea7a44e1ac0)|`Reworking some things.`|",
    "created_at": "2014-11-06T18:59:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17298",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------|\n|[40d897b](http://git.sagemath.org/sage.git/commit/?id=40d897b5c3419c8de07978be965e6c3e9c078b98)|`Fixed typo.`|",
