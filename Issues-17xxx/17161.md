...
```json
{
    "body": "<a id='comment:1'></a>A possible implementation could be based on:\n\n```\ndef lah_number(n, k):\n    if n == k: return 1\n    if n<0 and k<0: return lah_number(-k, -n)\n    if k<0 or  k>n: return 0    \n    return (k*n*gamma(n)^2)/(gamma(k+1)^2*gamma(n-k+1))\n```",
    "created_at": "2014-10-15T21:32:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17161#issuecomment-238572",
    "user": "https://github.com/PeterLuschny"
}
```

<a id='comment:1'></a>A possible implementation could be based on:
