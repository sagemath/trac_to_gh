...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[b0e5686](https://git.sagemath.org/sage.git/commit/?id=b0e568636be5546969483c0a3eb6a6b81a9a3dae)|`Faster basic poset structures.`|",
