...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -7,3 +7,6 @@\n Soooo let us fix this and use that feature !\n \n Nathann\n+\n+Associated sage-devel thread at:\n+https://github.com/sagemath/sage/issues/17498\n``````\n",
...
```json
{
    "body": "<div id=\"comment:25\" align=\"right\">comment:25</div>\n\nSee e.g. https://github.com/sagemath/sage/issues/12326 or http://ask.sagemath.org/question/9105/matplotlib-cannot-create-a-graph/",
