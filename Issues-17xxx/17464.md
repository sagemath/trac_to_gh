...
<a id='comment:44'></a>Replying to [ncohen](#comment%3A42):
> Hello !
...
<a id='comment:54'></a>Replying to [ncohen](#comment%3A52):
> Hello again !
...
<a id='comment:57'></a>Replying to [ncohen](#comment%3A55):
> Hello,
> 
> > Hm.. I need these things, especially canonical_label. Do you have any practical reasons to leave this out? I mean it doesn't look like it needs that much effort at this point.
...
```json
{
    "body": "<a id='comment:1'></a>As I said in[comment:97](#comment%3A97), the problem is that you first \"cd src\" and then iterate over \"patches/*.patch\". Which is the wrong path when you are in \"src\"",
...
<a id='comment:1'></a>As I said in[comment:97](#comment%3A97), the problem is that you first "cd src" and then iterate over "patches/*.patch". Which is the wrong path when you are in "src"
