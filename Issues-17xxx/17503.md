...
```json
{
    ...
    "type": "issue",
    "updated_at": "2014-12-27T23:58:06Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17503#event-214065"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17503#event-214066"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17503#event-214067"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17503#event-214068"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17503#event-214069"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17503#issuecomment-237127",
    "user": "https://github.com/sagetrac-wonder"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17503#issuecomment-237128",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17503#issuecomment-237129",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17503#issuecomment-237130",
    "user": "https://github.com/sagetrac-wonder"
}
```
