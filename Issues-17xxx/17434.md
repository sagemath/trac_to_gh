...
```json
{
    "body": "<a id='comment:2'></a>I think a good start would be to use [https://docs.python.org/2/library/tokenize.html](https://docs.python.org/2/library/tokenize.html)",
    "created_at": "2014-12-03T12:25:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17434#issuecomment-228303",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>I think a good start would be to use [https://docs.python.org/2/library/tokenize.html](https://docs.python.org/2/library/tokenize.html)
...
```json
{
    "body": "<a id='comment:3'></a>Issue is still open. Not sure if this one should get a stopgap",
    "created_at": "2017-03-04T02:13:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17434#issuecomment-228304",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```

<a id='comment:3'></a>Issue is still open. Not sure if this one should get a stopgap
