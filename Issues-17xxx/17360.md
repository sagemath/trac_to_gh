...
```json
{
    "body": "Changing branch from \"\" to \"u/nbruin/algebra_memoryleak\"",
    "created_at": "2014-11-18T00:51:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294474",
    "user": "https://github.com/nbruin"
}
```

Changing branch from "" to "u/nbruin/algebra_memoryleak"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294476",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"d486b71627014ee14955a61bdf8c64572cb49718\"",
    "created_at": "2014-11-18T00:58:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294477",
    "user": "https://github.com/nbruin"
}
```

Changing commit from "" to "d486b71627014ee14955a61bdf8c64572cb49718"
...
```json
{
    "body": "Changing commit from \"d486b71627014ee14955a61bdf8c64572cb49718\" to \"2c942ad50c3f9947b7d680d2f6cc708848ac9758\"",
    "created_at": "2014-11-18T01:04:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294478",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d486b71627014ee14955a61bdf8c64572cb49718" to "2c942ad50c3f9947b7d680d2f6cc708848ac9758"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294479",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294481",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Do you also want to fix this for other algebras (except Weyl and Clifford, I'll do that in #17096 since I'm editing that part of those files anyways)?",
    "created_at": "2014-11-18T03:35:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294482",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:6'></a>Do you also want to fix this for other algebras (except Weyl and Clifford, I'll do that in #17096 since I'm editing that part of those files anyways)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294483",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>`Algebras` is a subclass of `CategoryWithAxiom_over_base_ring` whereas `Modules` (and `VectorSpaces`) is a subclass of `Category_module`. I'm guessing that any subclass of `CategoryWithAxiom` gets nailed into memory because there is a link back to the list of axioms or the call to the strongly cached `axiom_of_nested_class`.",
    "created_at": "2014-11-18T19:38:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294485",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>`Algebras` is a subclass of `CategoryWithAxiom_over_base_ring` whereas `Modules` (and `VectorSpaces`) is a subclass of `Category_module`. I'm guessing that any subclass of `CategoryWithAxiom` gets nailed into memory because there is a link back to the list of axioms or the call to the strongly cached `axiom_of_nested_class`.
...
```json
{
    "body": "<a id='comment:11'></a>Should we or did someone open a ticket to fix that (general) nasty memory leak caused by `WithAxiom`?",
    "created_at": "2014-12-23T15:30:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17360#issuecomment-294486",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:11'></a>Should we or did someone open a ticket to fix that (general) nasty memory leak caused by `WithAxiom`?
