...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17360#event-229930"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17360#event-229931"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17360#event-229932"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17360#event-229933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17360#issuecomment-234539",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17360#issuecomment-234540",
    "user": "https://github.com/tscrim"
}
```
