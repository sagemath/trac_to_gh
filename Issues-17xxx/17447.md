...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246456"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246457"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246459"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,7 +14,7 @@\n ```\n f = function('f', x)\n ```\n-is also not documented. See also https://github.com/sagemath/sage/issues/17445 for sources of confusion. Need to explain what happens in the second case above (`f = function('f',x)`). A symbolic function `f` is first created and then overwritten by the expression `f`?\n+is also not documented. See also #17445 for sources of confusion. Need to explain what happens in the second case above (`f = function('f',x)`). A symbolic function `f` is first created and then overwritten by the expression `f`?\n See the following example, where f is first an expression, then becomes redefined to a function in the background, but does not contain any information about its variables. \n \n ```\n``````\n",
    "created_at": "2014-12-05T14:09:19Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233510",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233511",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233512",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233513",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233514",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233515",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233516",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246462"
}
```
...
```json
{
    "body": "<div id=\"comment:7\" align=\"right\">comment:7</div>\n\nNot really ready for *review* but is ready for input. And is mainly ready for someone else to rewrite documentation properly. People CC'd on this ticket look like good candidates to do so.\n\n---\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/b41248b13e18744ab9902adde9b7740832bb1724\"><code>b41248b</code></a></td><td><code>trac 17447: Deprecation of function('f',x) in favour of function('f')(x)</code></td></tr><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/fa3ebd6645eb2cae45c2218628eaa1d984f16506\"><code>fa3ebd6</code></a></td><td><code>trac 17447: Doctest changes to reflect deprecation of function('f',x)</code></td></tr></table>\n\n---\nnote that the doctest that apparently got removed in b41248b in reality gets moved to var.pyx because it tests the toplevel `function`, not the library `function`",
    "created_at": "2015-01-08T23:01:32Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233517",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233518",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233519",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233520",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233521",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233522",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233523",
...
```json
{
    "body": "<div id=\"comment:15\" align=\"right\">comment:15</div>\n\nThat fixes the three above marked doctests.\n\n---\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/e3ef9195793c87d54b088823e06438e647cc6d89\"><code>e3ef919</code></a></td><td><code>Merge branch 'develop' into t/17447/clarify_and_complete_documentation_of_function__</code></td></tr><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/e6a35343e5f712b88a5a9a80abd4e9302879c187\"><code>e6a3534</code></a></td><td><code>17447: reviewer's patch: fix rst doctests</code></td></tr></table>\n",
    "created_at": "2015-02-01T16:54:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233524",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233525",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<div id=\"comment:16\"></div>\n\nBranch pushed to git repo; I updated commit sha1. New commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/4585e74063e81a8c332a500d016e837069edf8eb\"><code>4585e74</code></a></td><td><code>17447: fix rest of doctests</code></td></tr></table>\n",
    "created_at": "2015-02-02T08:28:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233526",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233527",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233528",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233529",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233530",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233531",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233532",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233533",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233534",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233535",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233536",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233537",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233538",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246466"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246467"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233539",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233540",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246470"
}
```
...
```json
{
    "body": "<div id=\"comment:29\"></div>\n\nBranch pushed to git repo; I updated commit sha1. New commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/7956412cef63579521e6f8673a096c9952609a38\"><code>7956412</code></a></td><td><code>Merge branch 'public/17447' of git://trac.sagemath.org/sage into public/17447</code></td></tr><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/bdc154391e7ce6ceca1226f341ab62579bc3f4ee\"><code>bdc1543</code></a></td><td><code>trac 17447: further doctest adjustments</code></td></tr></table>\n",
    "created_at": "2015-11-09T23:57:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233541",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233542",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    "body": "<div id=\"comment:30\"></div>\n\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/7c029f3c98032a985c2ca0329dfe940271e9b86b\"><code>7c029f3</code></a></td><td><code>trac 17447: further doctest adjustments</code></td></tr></table>\n",
    "created_at": "2015-11-10T01:17:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233543",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233544",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233545",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246475"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233546",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233547",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17447#event-246478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17447#issuecomment-233548",
