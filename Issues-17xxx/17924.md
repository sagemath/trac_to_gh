...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[add3e53](https://github.com/sagemath/sagetrac-mirror/commit/add3e53a81dafd966b07727d87c3d441e1e2468f)|`17924: workaround doctest failure in docker`|",
