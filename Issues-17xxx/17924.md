...
```
There is a race condition in `pexpect`, which is worked around by the `SageSpawn` class from #17686. Apply [attachment:test17924.patch](https://github.com/sagemath/sage/files/ticket17924/test17924.patch) and rebuild `pexpect` to test this race condition.
