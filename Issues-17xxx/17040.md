...
```json
{
    "body": "<a id='comment:1'></a>Presumably the papers mentioned [here](http://mathoverflow.net/questions/23153/frobenius-number-for-three-numbers) will be useful - Wagon is pretty proud of the algorithm in Mma, but the paper points out lattE would work as well, and we have access to some such polytope things...",
    "created_at": "2014-09-25T16:03:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17040#issuecomment-222183",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Presumably the papers mentioned [here](http://mathoverflow.net/questions/23153/frobenius-number-for-three-numbers) will be useful - Wagon is pretty proud of the algorithm in Mma, but the paper points out lattE would work as well, and we have access to some such polytope things...
