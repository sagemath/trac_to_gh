...
```json
{
    "body": "This bug is still present in 7.5.beta3 but appears to be gone in 7.5.rc1.",
...
```json
{
    "body": "Hmmm...I don't see anything in the closed ticket descriptions that would have fixing this as a potential side-effect. Perhaps we should just add a doctest?",
