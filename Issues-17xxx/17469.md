...
```json
{
    "body": "https://sourceforge.net/p/maxima/bugs/2854/",
...
```json
{
    "body": "Apparently fixed again upstream, though still looooong time...",
...
```json
{
    "body": "Sorry, wrong ticket (and I don't know how to delete a comment in Trac...)",
