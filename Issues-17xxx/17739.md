...
```json
{
    "body": "<a id='comment:1'></a>This would yield (doctest):\n\n```\nsage: t = var('t')\nsage: y=function('y')(t)\nsage: desolve(diff(y,t)-y^2,y)\n-1/(_C + t)\nsage: desolve(diff(y,t)-y^2+y,y)\n-1/(e^(_C + t) - 1)\nsage: desolve(diff(y,t)-y^2-1,y)\ntan(_C + t)\n```",
    "created_at": "2015-02-06T09:20:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17739#issuecomment-303749",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>This would yield (doctest):
...
```json
{
    "body": "<a id='comment:2'></a>Do we resolve this in Sage, Maxima, or both?",
    "created_at": "2015-02-06T09:22:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17739#issuecomment-303750",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>Do we resolve this in Sage, Maxima, or both?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17739#issuecomment-303751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17739#issuecomment-303752",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17739#issuecomment-303753",
    "user": "https://github.com/rwst"
}
```
