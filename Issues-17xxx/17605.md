...
```json
{
    "body": "Changing branch from \"\" to \"public/17605\"",
    "created_at": "2015-01-08T16:38:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300338",
    "user": "https://github.com/nathanncohen"
}
```

Changing branch from "" to "public/17605"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300339",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"462b6e2ef174a80b33c06a18e999ec2a459d4700\"",
    "created_at": "2015-01-08T16:38:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300340",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "462b6e2ef174a80b33c06a18e999ec2a459d4700"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300341",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I don't know enough about this to say whether it is all correct, but it looks very helpful (at least, to me!).  Did you stop early, though?\n\n```\n+Calling a function defined in a library\n+---------------------------------------\n+\n+  ~/a$ gcc -c -fPIC double_vector.c -o libdoublevector.o\n```\nI guess you have compiled the library file, but where is the calling part?",
    "created_at": "2015-01-08T16:41:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300342",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>I don't know enough about this to say whether it is all correct, but it looks very helpful (at least, to me!).  Did you stop early, though?
...
```json
{
    "body": "<a id='comment:4'></a>I am an idiot. I made many attempts to link this .pyx file with a compiled library and failed, and this is just the beginning of the section that I do not know how to write. I will update my patch in a second to remove that.\n\nI would love to write it, but I just don't know how. There are quite some things that I know how to do by modifying sage, but not without that `:-P`\n\nNathann",
    "created_at": "2015-01-08T16:44:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300343",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>I am an idiot. I made many attempts to link this .pyx file with a compiled library and failed, and this is just the beginning of the section that I do not know how to write. I will update my patch in a second to remove that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300344",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"462b6e2ef174a80b33c06a18e999ec2a459d4700\" to \"a84624002490417b18adb6534a1c73843822306e\"",
    "created_at": "2015-01-08T16:44:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300345",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "462b6e2ef174a80b33c06a18e999ec2a459d4700" to "a84624002490417b18adb6534a1c73843822306e"
...
```json
{
    "body": "<a id='comment:6'></a>> I don't know enough about this to say whether it is all correct, but it looks very helpful (at least, to me!).\n\n\nWell, the point is actually that with this you can give it a try and witness that it does work `;-)`\n\nVolker? Do you know how to link to a compiled library while outside of Sage? Can you teach me? And I'll write the doc!\n\nNathann",
    "created_at": "2015-01-08T18:14:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300346",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>> I don't know enough about this to say whether it is all correct, but it looks very helpful (at least, to me!).
...
```json
{
    "body": "<a id='comment:8'></a>Note: An object file (.o) is not a library (.a / .so). \n\nYou can link compiled C/C++ code with a stand-alone Cython project like in https://github.com/vbraun/lattice_phi4. Then just import as module in Sage.",
    "created_at": "2015-01-08T21:16:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300347",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:8'></a>Note: An object file (.o) is not a library (.a / .so). 
...
```json
{
    "body": "Changing commit from \"a84624002490417b18adb6534a1c73843822306e\" to \"2ad9b510df07b6f97741f934e9830b3b405401e8\"",
    "created_at": "2015-01-09T05:50:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300349",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a84624002490417b18adb6534a1c73843822306e" to "2ad9b510df07b6f97741f934e9830b3b405401e8"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300350",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Okay found a way `;-)`\n\nNeeds review again !\n\nNathann",
    "created_at": "2015-01-09T05:51:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300351",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:11'></a>Okay found a way `;-)`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300352",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>There is probably some alternate reality where the new description is useful for others to read/search, I just lack the imagination for it.\n\nOnce you install the shared library into Sage you might just as well go through `module_list.py` as well.",
    "created_at": "2015-01-09T11:04:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300353",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>There is probably some alternate reality where the new description is useful for others to read/search, I just lack the imagination for it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300354",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>> There is probably some alternate reality where the new description is useful for others to read/search, I just lack the imagination for it.\n\n\nThere is probably one in which comments like that don't make people uselessly angry. Are we in the reality in which you also review the branch ?\n\n> Once you install the shared library into Sage you might just as well go through `module_list.py` as well. \n\n\nI do not understand this comment.\n\nNathann",
    "created_at": "2015-01-09T11:10:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300355",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:14'></a>> There is probably some alternate reality where the new description is useful for others to read/search, I just lack the imagination for it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300356",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Copying files to SAGE_ROOT/local/lib/ is modifying Sage in my book. E.g. on a global installation (like SMC) you just don't have permissions to do that.",
    "created_at": "2015-01-09T11:57:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300358",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>Copying files to SAGE_ROOT/local/lib/ is modifying Sage in my book. E.g. on a global installation (like SMC) you just don't have permissions to do that.
...
```json
{
    "body": "<a id='comment:18'></a>> Copying files to SAGE_ROOT/local/lib/ is modifying Sage in my book. E.g. on a global installation (like SMC) you just don't have permissions to do that. \n\n\nThe tutorial does not do that.\n\nNathann",
    "created_at": "2015-01-09T12:01:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300359",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:18'></a>> Copying files to SAGE_ROOT/local/lib/ is modifying Sage in my book. E.g. on a global installation (like SMC) you just don't have permissions to do that. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300361",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>> I saw Jeroen's home path in several documents of the developer's manual, so I thought it did not matter.\n\n\nProbably not that much, but might as well make it more generic if you have the opportunity.",
    "created_at": "2015-01-09T13:34:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300362",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:21'></a>> I saw Jeroen's home path in several documents of the developer's manual, so I thought it did not matter.
...
```json
{
    "body": "<a id='comment:22'></a>> Probably not that much, but might as well make it more generic if you have the opportunity.\n\nhttp://www.sagemath.org/doc/developer/doctesting.html\n\nI'll fix them all...\n\nNathann",
    "created_at": "2015-01-09T13:37:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300363",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:22'></a>> Probably not that much, but might as well make it more generic if you have the opportunity.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300365",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"2ad9b510df07b6f97741f934e9830b3b405401e8\" to \"96177d8ed62e5c88325c95f168406b27249b2ea1\"",
    "created_at": "2015-01-09T13:48:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300366",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "2ad9b510df07b6f97741f934e9830b3b405401e8" to "96177d8ed62e5c88325c95f168406b27249b2ea1"
...
```json
{
    "body": "<a id='comment:26'></a>> I hope that just changing the prompt will make it (more) obvious in this case.\n\nYes, this does a good job.",
    "created_at": "2015-01-09T14:04:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300368",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:26'></a>> I hope that just changing the prompt will make it (more) obvious in this case.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300369",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300370",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300373",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"96177d8ed62e5c88325c95f168406b27249b2ea1\" to \"bd0dae3b8577fe2e339fca82934a388639e95668\"",
    "created_at": "2015-01-09T15:05:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300374",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "96177d8ed62e5c88325c95f168406b27249b2ea1" to "bd0dae3b8577fe2e339fca82934a388639e95668"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300375",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"bd0dae3b8577fe2e339fca82934a388639e95668\" to \"23139b5ae0c7a8e5baa6fe6afd2efd52777dfaff\"",
    "created_at": "2015-01-10T05:11:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300376",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "bd0dae3b8577fe2e339fca82934a388639e95668" to "23139b5ae0c7a8e5baa6fe6afd2efd52777dfaff"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300377",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"23139b5ae0c7a8e5baa6fe6afd2efd52777dfaff\" to \"5f20f0a3872d2f3f12b3c716c9a4e445530969bc\"",
    "created_at": "2015-01-10T05:28:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300378",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "23139b5ae0c7a8e5baa6fe6afd2efd52777dfaff" to "5f20f0a3872d2f3f12b3c716c9a4e445530969bc"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300379",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300380",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"5f20f0a3872d2f3f12b3c716c9a4e445530969bc\" to \"2f37b6fc906262f0cda839734eec8ab6f9cbf389\"",
    "created_at": "2015-01-11T06:41:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300381",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "5f20f0a3872d2f3f12b3c716c9a4e445530969bc" to "2f37b6fc906262f0cda839734eec8ab6f9cbf389"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300382",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300383",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300384",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>So let's go ;)",
    "created_at": "2015-01-17T10:34:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300386",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:37'></a>So let's go ;)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300387",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>This also works for me now, though I have no idea why.  Maybe because we removed the original compilation and Sage compiled it wherever Sage compiles things.",
    "created_at": "2015-01-17T20:01:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300388",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:38'></a>This also works for me now, though I have no idea why.  Maybe because we removed the original compilation and Sage compiled it wherever Sage compiles things.
...
```json
{
    "body": "<a id='comment:39'></a>> This also works for me now, though I have no idea why.  Maybe because we removed the original compilation and Sage compiled it wherever Sage compiles things.\n\n\nAhahah. Well, remember? \"Theory is when you know everything but nothing works, practice is when everything works but nobody knows why\" `:-P`\n\nNathann",
    "created_at": "2015-01-17T23:03:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300389",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:39'></a>> This also works for me now, though I have no idea why.  Maybe because we removed the original compilation and Sage compiled it wherever Sage compiles things.
...
```json
{
    "body": "Changing branch from \"public/17605\" to \"2f37b6fc906262f0cda839734eec8ab6f9cbf389\"",
    "created_at": "2015-01-24T13:19:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300390",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/17605" to "2f37b6fc906262f0cda839734eec8ab6f9cbf389"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17605#issuecomment-300391",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17605",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17605#event-50486"
}
```
