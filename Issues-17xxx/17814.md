...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305044",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305045",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305046",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Fixing sageinspect won't be easy. I currently have absolutely no clue how to read off the number of arguments (or even the names of the arguments) of a function that is defined in a Cython file. Those functions don't seem to have any attributes holding useful information.\n\nHas someone else an idea? If not, then I don't see what we can do. We do want a special cached method implementation for methods without arguments, and thus we need to determine the number of arguments of the to-be-wrapped method. If that doesn't work without reading the sources, what could we possibly do?",
    "created_at": "2015-02-20T11:34:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305048",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>Fixing sageinspect won't be easy. I currently have absolutely no clue how to read off the number of arguments (or even the names of the arguments) of a function that is defined in a Cython file. Those functions don't seem to have any attributes holding useful information.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305049",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305051",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The two statements below seem like a contraction: using the example above, if you want to ensure that `obj.f()` and `obj.f(1)` and `obj.f(arg=1)` use the same cache entry, you do need to know the names and defaults of the arguments.\n\nReplying to [SimonKing](#comment%3A7):\n> Yes, we do require that. Equivalent inputs should result in identical output.\n\n\n> We don't need to know all argument names and all defaults, but we do need to know their number.",
    "created_at": "2015-02-20T14:05:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305052",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>The two statements below seem like a contraction: using the example above, if you want to ensure that `obj.f()` and `obj.f(1)` and `obj.f(arg=1)` use the same cache entry, you do need to know the names and defaults of the arguments.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305053",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305054",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305055",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305057",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Proposal: have 2 different implementations of `cached_function`:\n\n- one for *Python* methods, which works just like the current implementation.\n\n- one for *Cython* methods, which works on the level of `*args` and `**kwds`.",
    "created_at": "2015-02-20T14:47:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305059",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>Proposal: have 2 different implementations of `cached_function`:
...
```json
{
    "body": "<a id='comment:16'></a>This proposal would solve the issue on the ticket. Specializing for Cython, it might also be possible to speed-up things more.",
    "created_at": "2015-02-20T14:54:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305060",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>This proposal would solve the issue on the ticket. Specializing for Cython, it might also be possible to speed-up things more.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305062",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305064",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305066",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>With the correct `except` declaration, there is an error if the argument is not a \"built-in\" (Cython) method:\n\n```\nSystemError: Objects/methodobject.c:64: bad argument to internal function\n```",
    "created_at": "2015-02-21T14:45:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305067",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>With the correct `except` declaration, there is an error if the argument is not a "built-in" (Cython) method:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305068",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Apparently `PyCFunction_GetFlags` is the wrong tool (or we first need to extract the cfunction from the method), since always an error is raised.",
    "created_at": "2015-02-21T14:52:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305069",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:25'></a>Apparently `PyCFunction_GetFlags` is the wrong tool (or we first need to extract the cfunction from the method), since always an error is raised.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305070",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305072",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/SimonKing/make_calling_a_cached_method_independent_of_source_code_inspection\"",
    "created_at": "2015-02-21T19:47:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305073",
    "user": "https://github.com/simon-king-jena"
}
```

Changing branch from "" to "u/SimonKing/make_calling_a_cached_method_independent_of_source_code_inspection"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305074",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing branch from \"u/SimonKing/make_calling_a_cached_method_independent_of_source_code_inspection\" to \"\"",
    "created_at": "2015-02-21T19:52:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305076",
    "user": "https://github.com/simon-king-jena"
}
```

Changing branch from "u/SimonKing/make_calling_a_cached_method_independent_of_source_code_inspection" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305077",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"30543e7b283c52cad2fbeb060efe78a74c7b42ba\"",
    "created_at": "2015-02-21T19:53:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305078",
    "user": "https://github.com/simon-king-jena"
}
```

Changing commit from "" to "30543e7b283c52cad2fbeb060efe78a74c7b42ba"
...
```json
{
    "body": "<a id='comment:31'></a>Why has the branch field automatically been deleted?",
    "created_at": "2015-02-21T19:53:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305079",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:31'></a>Why has the branch field automatically been deleted?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305080",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305082",
...
```json
{
    "body": "<a id='comment:36'></a>Now I am totally puzzled. There are the Cython modules `sage.misc.function_mangling` and `sage.misc.cachefunc`, but they don't appear in `src/module_list.py`! So, why are they built at all? Is that a recent change? E.g.., is it not needed anymore to mention a `.pyx` file in `module_list.py` if it has no `.pxd` and no compile options?",
    "created_at": "2015-02-22T09:52:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305085",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:36'></a>Now I am totally puzzled. There are the Cython modules `sage.misc.function_mangling` and `sage.misc.cachefunc`, but they don't appear in `src/module_list.py`! So, why are they built at all? Is that a recent change? E.g.., is it not needed anymore to mention a `.pyx` file in `module_list.py` if it has no `.pxd` and no compile options?
...
```json
{
    "body": "<a id='comment:37'></a>Replying to [SimonKing](#comment%3A36):\n> Now I am totally puzzled. There are the Cython modules `sage.misc.function_mangling` and `sage.misc.cachefunc`, but they don't appear in `src/module_list.py`! So, why are they built at all? Is that a recent change? E.g.., is it not needed anymore to mention a `.pyx` file in `module_list.py` if it has no `.pxd` and no compile options?\n\nSee #17767",
    "created_at": "2015-02-22T10:15:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305086",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:37'></a>Replying to [SimonKing](#comment%3A36):
> Now I am totally puzzled. There are the Cython modules `sage.misc.function_mangling` and `sage.misc.cachefunc`, but they don't appear in `src/module_list.py`! So, why are they built at all? Is that a recent change? E.g.., is it not needed anymore to mention a `.pyx` file in `module_list.py` if it has no `.pxd` and no compile options?
...
```json
{
    "body": "Changing commit from \"30543e7b283c52cad2fbeb060efe78a74c7b42ba\" to \"a0b829dc10b4ccb00b99e073de8a1c0006aa1e51\"",
    "created_at": "2015-02-22T10:21:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305088",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "30543e7b283c52cad2fbeb060efe78a74c7b42ba" to "a0b829dc10b4ccb00b99e073de8a1c0006aa1e51"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305089",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305090",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Replying to [SimonKing](#comment%3A38):\n> Is it possible/reasonable to have a source file that is temporarily moved away by its own doctest?\n\nCertainly not :-)",
    "created_at": "2015-02-22T19:33:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305092",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:42'></a>Replying to [SimonKing](#comment%3A38):
> Is it possible/reasonable to have a source file that is temporarily moved away by its own doctest?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305097",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305098",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:49'></a>In other words, I think it needs a *Python* patch first to add the hooks which then Cython could use.",
    "created_at": "2015-02-22T20:27:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305099",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:49'></a>In other words, I think it needs a *Python* patch first to add the hooks which then Cython could use.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305100",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:54'></a>Can we perhaps instrument the caching machinery to log any cache hits that would have been misses if `*arg, **kwarg` would be processed into a cache key without transporting over keywords to positional parameters? Then we can see the extent of the problem.\n\nThe main one I expect there is from cases where people specify a default parameter, but with the default value, and that's a serious one:\n\n```\n@cached_function\ndef a(x,y=1)\n  return set([x,y])\n```\nThen `[a(1),a(1,1)]` should contain two identical sets, but only caching on `*arg` and `**kwarg` would return result in two non-identical sets, because the second would have an implicit keyword parameter `y` rather than a second positional parameter.\n\nI think this is potentially quite a serious issue, especially because in sage, much caching happens with the purpose of making things unique (but perhaps currently never in cython applications ...)",
    "created_at": "2015-02-23T16:33:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305104",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:54'></a>Can we perhaps instrument the caching machinery to log any cache hits that would have been misses if `*arg, **kwarg` would be processed into a cache key without transporting over keywords to positional parameters? Then we can see the extent of the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305106",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:57'></a>See #17847",
    "created_at": "2015-02-24T10:39:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305107",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:57'></a>See #17847
...
```json
{
    "body": "<a id='comment:58'></a>In other words: Because of Cython caching, we can not use the embedded argspec information, even if we could enable \"embedsignature(True)\" globally, and additionally, if \"embedsignature(True)\" was enabled globally, some valid Cython code wouldn't compile.",
    "created_at": "2015-02-24T11:56:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305108",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:58'></a>In other words: Because of Cython caching, we can not use the embedded argspec information, even if we could enable "embedsignature(True)" globally, and additionally, if "embedsignature(True)" was enabled globally, some valid Cython code wouldn't compile.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305109",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305110",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:61'></a>Let me mention that #17847 is now in Sage, which makes this ticket feasible.",
    "created_at": "2015-04-16T08:12:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305111",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:61'></a>Let me mention that #17847 is now in Sage, which makes this ticket feasible.
...
```json
{
    "body": "<a id='comment:62'></a>Would it be ok to rebase this branch on top of the current develop branch (and then force-push)? Or would it be ok if I merged this branch into the current develop and start with it? Or merge the current develop into this branch? I still don't get what is considered best praxis.",
    "created_at": "2015-04-17T18:06:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305112",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:62'></a>Would it be ok to rebase this branch on top of the current develop branch (and then force-push)? Or would it be ok if I merged this branch into the current develop and start with it? Or merge the current develop into this branch? I still don't get what is considered best praxis.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305113",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"a0b829dc10b4ccb00b99e073de8a1c0006aa1e51\" to \"b340eebb3cec1d5f273b9c382599f23736045e98\"",
    "created_at": "2015-04-18T13:50:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305114",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a0b829dc10b4ccb00b99e073de8a1c0006aa1e51" to "b340eebb3cec1d5f273b9c382599f23736045e98"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305115",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing commit from \"b340eebb3cec1d5f273b9c382599f23736045e98\" to \"0e8ef000e434b654c76299b2ea694ca15be965a3\"",
    "created_at": "2015-04-18T21:45:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305117",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b340eebb3cec1d5f273b9c382599f23736045e98" to "0e8ef000e434b654c76299b2ea694ca15be965a3"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305118",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:66'></a>On 6.7-beta2 I got \n\n```\nsage: K=GF(5)\nsage: K.factored_order\nCached version of <method 'factored_order' of\n'sage.rings.finite_rings.finite_field_base.FiniteField' objects>\n```",
    "created_at": "2015-04-24T21:58:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305119",
    "user": "https://github.com/videlec"
}
```

<a id='comment:66'></a>On 6.7-beta2 I got 
...
```json
{
    "body": "<a id='comment:67'></a>sorry already in [comment:27](#comment%3A27)... could you update the description then?",
    "created_at": "2015-04-24T21:59:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305120",
    "user": "https://github.com/videlec"
}
```

<a id='comment:67'></a>sorry already in [comment:27](#comment%3A27)... could you update the description then?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305121",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:68'></a>Replying to [vdelecroix](#comment%3A66):\n> On 6.7-beta2 I got \n> \n> ```\n> sage: K=GF(5)\n> sage: K.factored_order\n> Cached version of <method 'factored_order' of\n> 'sage.rings.finite_rings.finite_field_base.FiniteField' objects>\n> ```\n\n\nYou mean, you got it after removing `src/sage/rings/finite_rings/finite_field_base.pyx`? Then you say the problem is fixed.",
    "created_at": "2015-04-24T22:17:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305122",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:68'></a>Replying to [vdelecroix](#comment%3A66):
> On 6.7-beta2 I got 
> 
> ```
> sage: K=GF(5)
...
```json
{
    "body": "<a id='comment:69'></a>Replying to [vdelecroix](#comment%3A67):\n> sorry already in [comment:27](#comment%3A27)... could you update the description then?\n\n\nI don't understand what info you need.",
    "created_at": "2015-04-24T22:17:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305123",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:69'></a>Replying to [vdelecroix](#comment%3A67):
> sorry already in [comment:27](#comment%3A27)... could you update the description then?
...
```json
{
    "body": "<a id='comment:70'></a>Replying to [SimonKing](#comment%3A68):\n> Replying to [vdelecroix](#comment%3A66):\n> > On 6.7-beta2 I got \n> > \n> > ```\n> > sage: K=GF(5)\n> > sage: K.factored_order\n> > Cached version of <method 'factored_order' of\n> > 'sage.rings.finite_rings.finite_field_base.FiniteField' objects>\n> > ```\n\n> \n> You mean, you got it after removing `src/sage/rings/finite_rings/finite_field_base.pyx`? Then you say the problem is fixed.\n\n\nNope. Just starting from a fresh sage-6.7.beta2.",
    "created_at": "2015-04-24T22:19:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305124",
    "user": "https://github.com/videlec"
}
```

<a id='comment:70'></a>Replying to [SimonKing](#comment%3A68):
> Replying to [vdelecroix](#comment%3A66):
> > On 6.7-beta2 I got 
> > 
> > ```
...
```json
{
    "body": "<a id='comment:71'></a>Replying to [vdelecroix](#comment%3A70):\n> Replying to [SimonKing](#comment%3A68):\n> > Replying to [vdelecroix](#comment%3A66):\n> > > On 6.7-beta2 I got \n> > > \n> > > ```\n> > > sage: K=GF(5)\n> > > sage: K.factored_order\n> > > Cached version of <method 'factored_order' of\n> > > 'sage.rings.finite_rings.finite_field_base.FiniteField' objects>\n> > > ```\n\n> > \n> > You mean, you got it after removing `src/sage/rings/finite_rings/finite_field_base.pyx`? Then you say the problem is fixed.\n\n> \n> Nope. Just starting from a fresh sage-6.7.beta2.\n\n\nMy mistake... I read too fast!!",
    "created_at": "2015-04-24T22:20:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305125",
    "user": "https://github.com/videlec"
}
```

<a id='comment:71'></a>Replying to [vdelecroix](#comment%3A70):
> Replying to [SimonKing](#comment%3A68):
> > Replying to [vdelecroix](#comment%3A66):
> > > On 6.7-beta2 I got 
> > > 
...
```json
{
    "body": "<a id='comment:72'></a>I still don't see what info was requested. Hence, I change it back to \"needs review\".",
    "created_at": "2015-04-28T13:45:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305126",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:72'></a>I still don't see what info was requested. Hence, I change it back to "needs review".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305127",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305128",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305129",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"u/SimonKing/make_calling_a_cached_method_independent_of_source_code_inspection\" to \"0e8ef000e434b654c76299b2ea694ca15be965a3\"",
    "created_at": "2015-04-29T03:13:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305130",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/SimonKing/make_calling_a_cached_method_independent_of_source_code_inspection" to "0e8ef000e434b654c76299b2ea694ca15be965a3"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17814#issuecomment-305131",
    "user": "https://github.com/vbraun"
}
```
