...
```json
{
    ...
    "type": "issue",
    "updated_at": "2015-06-23T15:57:17Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17388#event-212628"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17388#event-212629"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17388#event-212630"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17388#issuecomment-234899",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17388#issuecomment-234900",
    "user": "https://github.com/nbruin"
}
```
