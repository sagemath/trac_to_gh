...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17640#event-233666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17640#event-233667"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17640#event-233668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17640#event-233669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17640#issuecomment-240317",
    "user": "https://github.com/sagetrac-ffoucaud"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17640#issuecomment-240318",
    "user": "https://github.com/nathanncohen"
}
```
