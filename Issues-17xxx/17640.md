...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301476",
...
```json
{
    "body": "<a id='comment:1'></a>Could you provide an instruction that triggers that bug ? We cannot do much with a function when we do not know how it should be called. Also, you cannot ask us to 'run computations for hours' in order to check it. Thanks for your understanding,\n\nNathann",
    "created_at": "2015-01-16T08:23:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301477",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:1'></a>Could you provide an instruction that triggers that bug ? We cannot do much with a function when we do not know how it should be called. Also, you cannot ask us to 'run computations for hours' in order to check it. Thanks for your understanding,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301478",
    "user": "https://trac.sagemath.org/admin/accounts/users/ffoucaud"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301479",
    "user": "https://trac.sagemath.org/admin/accounts/users/ffoucaud"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Yes, thanks. Could you give us the graphs `g` that your code found such that `g.odd_girth` produces a bug ?\n\nNathann",
    "created_at": "2015-01-16T08:40:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301480",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Yes, thanks. Could you give us the graphs `g` that your code found such that `g.odd_girth` produces a bug ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301481",
    "user": "https://trac.sagemath.org/admin/accounts/users/ffoucaud"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301482",
    "user": "https://trac.sagemath.org/admin/accounts/users/ffoucaud"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301483",
    "user": "https://trac.sagemath.org/admin/accounts/users/ffoucaud"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>This seems related to #15535 and #12883",
    "created_at": "2015-01-16T14:47:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301484",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:7'></a>This seems related to #15535 and #12883
...
```json
{
    "body": "<a id='comment:8'></a>Yeah it sees related to the number of calls, as other persons seem to have met the same problem when computing many characteristic polynomials `:-/`\n\nNathann",
    "created_at": "2015-01-16T14:50:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301485",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:8'></a>Yeah it sees related to the number of calls, as other persons seem to have met the same problem when computing many characteristic polynomials `:-/`
...
```json
{
    "body": "<a id='comment:9'></a>OK, thanks... At least it seems to be a known bug.",
    "created_at": "2015-01-16T15:31:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301486",
    "user": "https://trac.sagemath.org/admin/accounts/users/ffoucaud"
}
```

<a id='comment:9'></a>OK, thanks... At least it seems to be a known bug.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17640#event-50543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301487",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>This ticket corresponds to the bug reported at #15535. Should be closed as a 'duplicate'.\n\nNathann",
    "created_at": "2015-01-18T18:59:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301488",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:10'></a>This ticket corresponds to the bug reported at #15535. Should be closed as a 'duplicate'.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17640#issuecomment-301489",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17640",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17640#event-50544"
}
```
