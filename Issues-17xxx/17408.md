...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[ce577a9](http://git.sagemath.org/sage.git/commit/?id=ce577a909e3ac2835f975cc9515b54459174e8ca)|`trac #17408: Faster transitive_reduction (=> faster Poset creation)`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[253fc21](http://git.sagemath.org/sage.git/commit/?id=253fc21867d070748a2c6391fbddd960e98c1aaa)|`trac #17408: Faster transitive_reduction (=> faster Poset creation)`|",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[ade98aa](http://git.sagemath.org/sage.git/commit/?id=ade98aa90d2954a59a6fad342b92d23f01803308)|`trac #17408: Broken doctests`|",
