...
```json
{
    "body": "<a id='comment:8'></a>\nNew commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[6d2b63a](http://git.sagemath.org/sage.git/commit/?id=6d2b63ada25df1241cca248d26a4df51e3a5be5b)|`Cython: embed signatures in docstrings`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[98a5813](http://git.sagemath.org/sage.git/commit/?id=98a581300ec495b9c39ebe3484f407a491f8bb95)|`Nuke Cython cache when Cython version changes`|\n|[9cd65e1](http://git.sagemath.org/sage.git/commit/?id=9cd65e13a5ab68dc0da005240e2686bb6b63bda2)|`Merge commit '98a581300ec495b9c39ebe3484f407a491f8bb95' into t/17847/ticket/17847`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[1a36cc9](http://git.sagemath.org/sage.git/commit/?id=1a36cc96d1e9ebd5d46a3dd9c027a41e89da2ebc)|`Cython: embed signatures in docstrings`|",
    "created_at": "2015-04-07T09:41:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17847",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:43'></a>\nReplying to [SimonKing](#comment%3A39):\n> What about the additional blank line in a doc string?\n\nFixed by this extra commit.\n\nNote however that `make doc` still fails...\n\n---\nNew commits:\n|                                                                                                                                          |                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[21ecfad](http://git.sagemath.org/sage.git/commit/?id=21ecfada11dda015de204cb92c27916e561c726a)|`_extract_embedded_position() needs the whole docstring`|",
    "created_at": "2015-04-08T10:33:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17847",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:51'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[a33fac0](http://git.sagemath.org/sage.git/commit/?id=a33fac03c4ac766fde206bcbb387560fba2ac5fb)|`Add new function sage_getdoc_original() which strips embedding information`|",
    "created_at": "2015-04-08T16:11:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17847",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:52'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[104837a](http://git.sagemath.org/sage.git/commit/?id=104837abe3c6d5e0204f4d0ffa49293f14f885d6)|`sage_getdoc_original() does not return None`|",
...
```json
{
    "body": "<a id='comment:57'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[31fd5e5](http://git.sagemath.org/sage.git/commit/?id=31fd5e5c1323610539b85c7d5671601dfa32f2f4)|`Fix doc of cached functions`|",
...
```json
{
    "body": "<a id='comment:61'></a>\nReplying to [jdemeyer](#comment%3A58):\n> Replying to [SimonKing](#comment%3A56):\n> > Yep, I found the problem: cached_method's _sage_doc_ only looks for the first line of the original docstring to extract information from. Instead, the whole docstring should be passed to _extract_embedded_position.\n> > \n> > Let me fix it, please, I guess I'll be done in 5 minutes.\n\n> Too late...\n\nBad. I just pushed it.\n  \n---\nNew commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[19135c1](http://git.sagemath.org/sage.git/commit/?id=19135c15db9122693b8d8d023fe59749eb1a1d64)|`Fix extraction of embedding information in CachedFunction._sage_doc_`|",
...
```json
{
    "body": "<a id='comment:75'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|\n|[cced81b](http://git.sagemath.org/sage.git/commit/?id=cced81b8c06b2eeb436c7876e5fed356e868e334)|`Strip signature and embedding off docstring; use __init__ docstring, if the stripped docstring is empty`|",
...
```json
{
    "body": "<a id='comment:86'></a>\nNew commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[d379229](http://git.sagemath.org/sage.git/commit/?id=d37922950e682d81bd577f3eae2c9230fbb65675)|`Support old-style classes`|",
...
```json
{
    "body": "<a id='comment:88'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[23390a1](http://git.sagemath.org/sage.git/commit/?id=23390a1d85791bfe3a6f12ef667cf27d7bbf69a2)|`Support old-style classes without __init__ method`|",
    "created_at": "2015-04-09T12:28:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17847",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:95'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[51aa68c](http://git.sagemath.org/sage.git/commit/?id=51aa68c66b6a62675aa84f351a961e823e014fb3)|`Remove support for embedding information from sagedoc.format()`|",
    "created_at": "2015-04-09T13:28:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17847",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nWhy has the branch that I just pushed be reverted???\n\n---\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[934490a](http://git.sagemath.org/sage.git/commit/?id=934490a6d231c3a0028496f8e98b31faf6365d35)|`Add a comment; improve heuristics to strip the embedded signature`|",
    "created_at": "2015-04-09T16:01:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17847",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nSorry that I didn't fix that doctest.\n\n---\nNew commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[cc9e9f6](http://git.sagemath.org/sage.git/commit/?id=cc9e9f605faf0f7eabc8bfbed83889dc07119d90)|`Fix IPython doctest`|",
