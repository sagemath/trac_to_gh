...
```json
{
    "body": "This code is finished and seems to be working. How can I add doctest and examples although the output is random. For this reason, I didn't put a \"need review\" yet but anyone is welcome to start.",
...
```json
{
    "body": "Oops, I think I was looking at some outdated version of the file on the internet.",
...
```json
{
    "body": "PDF docs don't bulid (lfoor -> lfloor)",
