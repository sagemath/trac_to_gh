...
```json
{
    ...
    "url": "https://github.com/sagemath/sage/issues/17445",
...
```json
{
    ...
    "created_at": "2014-12-04T22:12:21Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "milestone_number": null,
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246431"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246432"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246434"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233480",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -7,10 +7,10 @@\n Unfortunately, the meaning of this notation is not documented anywhere, neither in diff(), nor in derivative() nor in function(). There is a ton of tickets about improving ambiguities and malfunctions related to this notation, but it would be very helpful to at least document how it is supposed to work and what it means if a user sees output as above.\n \n See here for related tickets:\n-https://github.com/sagemath/sage/issues/6344\n-https://github.com/sagemath/sage/issues/6480\n-https://github.com/sagemath/sage/issues/6756\n-https://github.com/sagemath/sage/issues/12796\n+* #6344\n+* #6480\n+* #6756\n+* #12796\n \n and this discussion:\n https://groups.google.com/forum/#!topic/sage-devel/_xD5lymnTuo\n``````\n",
    "created_at": "2014-12-05T02:24:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233481",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233482",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233483",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233484",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233485",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233486",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233487",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233488",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233489",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233490",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233491",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233492",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    "body": "<div id=\"comment:11\" align=\"right\">comment:11</div>\n\nReplying to [@nbruin](#comment%3A6):\n\n> the problem: f is not a function, but a function evaluated at `x`, whatever `x` is. I'm not going to defend that `function('f', x)` doesn't return a function. **THAT is the real source why this example seems confusing**.\n\n\nI created a ticket to improve the documentation of function(): https://github.com/sagemath/sage/issues/17447\nI put you and kcrisman cc on that ticket, I hope you don't mind.",
    "created_at": "2014-12-05T10:48:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233493",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233494",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233495",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233497",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233498",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233499",
    "user": "https://github.com/eviatarbach"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233502",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233504",
    "user": "https://github.com/sagetrac-schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233505",
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "title_is": "Document derivative operator and notations",
    "title_was": "Missing documentation of derivative operator/notation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233506",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246436"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17445#issuecomment-233507",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246438"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246439"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246440"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246441"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246442"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246443"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246444"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17445#event-246445"
}
```
