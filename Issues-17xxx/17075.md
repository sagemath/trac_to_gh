...
```json
{
    "body": "<a id='comment:1'></a>This is not yet finished, but if you have any design input then now would be the time ;-)",
    "created_at": "2014-09-30T11:21:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287424",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>This is not yet finished, but if you have any design input then now would be the time ;-)
...
```json
{
    "body": "<a id='comment:2'></a>Are we doing stages? First install a pc file for atlas (and OS X make it point to accelerate) and convert to that? Then work out how we replace ATLAS. Or do you plan to switch hard to something like openblas straight away?\n\nMy current patch for module_list.py and misc/cython.py live here https://github.com/cschwan/sage-on-gentoo/blob/master/sci-mathematics/sage/files/sage-6.4-blas.patch I considered that we basically needed two things:\n* the library to be linked (c)blas_lib\n* the folder containing the libraries (c)blas_dir\nI probably need to harmonise between the two files.\n\nWe could also want a cblas_inc for headers but that is probably not necessary.",
    "created_at": "2014-09-30T11:33:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287425",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>Are we doing stages? First install a pc file for atlas (and OS X make it point to accelerate) and convert to that? Then work out how we replace ATLAS. Or do you plan to switch hard to something like openblas straight away?
...
```json
{
    "body": "<a id='comment:3'></a>I don't want to do too much at once. For now ATLAS should stay the default. Though this ticket should work with at least one other BLAS implementation ;-)\n\nThere is no guarantee that all cblas libraries are in the same directory. What do you need `cblas_dir` for that can't be done with `pkgconfig --libs`?",
    "created_at": "2014-09-30T11:48:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287426",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>I don't want to do too much at once. For now ATLAS should stay the default. Though this ticket should work with at least one other BLAS implementation ;-)
...
```json
{
    "body": "<a id='comment:5'></a>My only comment so far is that we should take care of the strange variable LINBOX_BLAS set up by linbox/fflas-ffpack, written in share/cblas_config, and used in modules_list.py IIRC.",
    "created_at": "2014-09-30T12:23:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287428",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:5'></a>My only comment so far is that we should take care of the strange variable LINBOX_BLAS set up by linbox/fflas-ffpack, written in share/cblas_config, and used in modules_list.py IIRC.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287429",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287431",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287436",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Preliminary clean up of fflas-ffpack+linbox is now #17087.",
    "created_at": "2014-10-02T08:13:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287437",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:14'></a>Preliminary clean up of fflas-ffpack+linbox is now #17087.
...
```json
{
    "body": "<a id='comment:15'></a>For info, an old ticket I opened is at #14390.",
    "created_at": "2014-10-14T13:24:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287438",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:15'></a>For info, an old ticket I opened is at #14390.
...
```json
{
    "body": "<a id='comment:16'></a>Was looking at integrating coinor-cbc in sage-on-gentoo and then I noticed that in this one and only place we have a reference to lapack in module_list.py. So if we continue to support that particular binding we need to pull lapack as well.",
    "created_at": "2015-03-29T01:21:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287439",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:16'></a>Was looking at integrating coinor-cbc in sage-on-gentoo and then I noticed that in this one and only place we have a reference to lapack in module_list.py. So if we continue to support that particular binding we need to pull lapack as well.
...
```json
{
    "body": "Changing author from \"\" to \"Jean-Pierre Flori, Fran\u00e7ois Bissey\"",
    "created_at": "2015-07-03T05:03:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287440",
    "user": "https://github.com/kiwifb"
}
```

Changing author from "" to "Jean-Pierre Flori, François Bissey"
...
```json
{
    "body": "<a id='comment:17'></a>Putting the conversion of ATLAS to `.pc` files here. I should commit the sage bits in a few hours.\n\n---\nNew commits:",
    "created_at": "2015-07-03T05:03:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287441",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:17'></a>Putting the conversion of ATLAS to `.pc` files here. I should commit the sage bits in a few hours.
...
```json
{
    "body": "Changing branch from \"\" to \"u/fbissey/17075\"",
    "created_at": "2015-07-03T05:03:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287442",
    "user": "https://github.com/kiwifb"
}
```

Changing branch from "" to "u/fbissey/17075"
...
```json
{
    "body": "Changing commit from \"\" to \"56d419e6eab697b4faf168ba177b3dff4090cbaf\"",
    "created_at": "2015-07-03T05:03:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287443",
    "user": "https://github.com/kiwifb"
}
```

Changing commit from "" to "56d419e6eab697b4faf168ba177b3dff4090cbaf"
...
```json
{
    "body": "<a id='comment:18'></a>Cannot this get in by itself?\nAnd the \"sage bits\" be put into other ticekts?",
    "created_at": "2015-07-03T09:15:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287444",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:18'></a>Cannot this get in by itself?
And the "sage bits" be put into other ticekts?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287445",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I am fine with that, nice and progressive. I am putting to need review then and you can play with it. I have only tried on OS X and my linux box will be off soon because the university has some power outage planned for the week end. No sage-on-gentoo development until Monday either because of that.\n\nHum, will have to change the description at some point.",
    "created_at": "2015-07-03T09:20:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287446",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:19'></a>I am fine with that, nice and progressive. I am putting to need review then and you can play with it. I have only tried on OS X and my linux box will be off soon because the university has some power outage planned for the week end. No sage-on-gentoo development until Monday either because of that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287447",
...
```json
{
    "body": "<a id='comment:21'></a>You can easily test it using pkgconfig. Its a strategic goal for us to clean up *blas linking. We should do what gets us fastest to that goal. How does doing more here or stacking tickets help us achieve that goal faster?",
    "created_at": "2015-07-07T22:28:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287448",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:21'></a>You can easily test it using pkgconfig. Its a strategic goal for us to clean up *blas linking. We should do what gets us fastest to that goal. How does doing more here or stacking tickets help us achieve that goal faster?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287450",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287452",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>The ticket description doesn't seem to correspond with the code in the branch, can you please update the description?",
    "created_at": "2015-07-24T16:39:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287453",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:26'></a>The ticket description doesn't seem to correspond with the code in the branch, can you please update the description?
...
```json
{
    "body": "<a id='comment:28'></a>Well, I have commented in a related ticket that I had been somewhat demotivated to work on this. I think most stuff has to be thrown away or re-based. Jeroen was working on an ATLAS upgrade more recently because of power8.\n\nBut really the plan is to get something like the functionality I have now in sage-on-gentoo: \n* you can use one of many blas/lapack\n* Each blas/lapack install some .pc file\n* we use the .pc file to find the libraries and headers needed\n \n\nSo the first step is get ATLAS to install .pc files, then migrate spkg to use them including the sage library. Then we can start writing alternative blas/lapack spkg.",
    "created_at": "2016-02-10T20:23:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287455",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:28'></a>Well, I have commented in a related ticket that I had been somewhat demotivated to work on this. I think most stuff has to be thrown away or re-based. Jeroen was working on an ATLAS upgrade more recently because of power8.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287456",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing branch from \"u/fbissey/17075\" to \"u/vbraun/17075\"",
    "created_at": "2016-02-22T18:25:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287457",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/fbissey/17075" to "u/vbraun/17075"
...
```json
{
    "body": "<a id='comment:31'></a>Rebased onto latest beta\n\nThis seems to work so lets merge it\n\n---\nNew commits:",
    "created_at": "2016-02-22T18:29:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287458",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:31'></a>Rebased onto latest beta
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287459",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287460",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"56d419e6eab697b4faf168ba177b3dff4090cbaf\" to \"432eb258c5f1dc62a7eb50d54df82979894242cb\"",
    "created_at": "2016-02-22T18:29:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287461",
    "user": "https://github.com/vbraun"
}
```

Changing commit from "56d419e6eab697b4faf168ba177b3dff4090cbaf" to "432eb258c5f1dc62a7eb50d54df82979894242cb"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287462",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17075#event-49635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287463",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"u/vbraun/17075\" to \"432eb258c5f1dc62a7eb50d54df82979894242cb\"",
    "created_at": "2016-02-23T08:26:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17075#issuecomment-287464",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/vbraun/17075" to "432eb258c5f1dc62a7eb50d54df82979894242cb"
