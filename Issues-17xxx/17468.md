...
```json
{
    "body": "<a id='comment:1'></a>I'm getting pretty frustrated with `abs_integrate`, despite the many integral it allows us to do.  It may have to become an option, though that would be annoying to implement all by itself.   But it may be the only way to prevent these errors - see also #13733, #11590, #14591, and #16643.",
    "created_at": "2014-12-08T14:46:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296955",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>I'm getting pretty frustrated with `abs_integrate`, despite the many integral it allows us to do.  It may have to become an option, though that would be annoying to implement all by itself.   But it may be the only way to prevent these errors - see also #13733, #11590, #14591, and #16643.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296957",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>See also #12731.",
    "created_at": "2014-12-08T15:01:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296958",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>See also #12731.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296959",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Apparently upstream Commit:eb935150c3d2c7717601da5bce470cb7f95f15df fixes this.",
    "created_at": "2014-12-15T13:02:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296960",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Apparently upstream Commit:eb935150c3d2c7717601da5bce470cb7f95f15df fixes this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296961",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>> For the first example, with Maxima 5.35.1 (see #17514), I get the following error after a very long time (maybe 20 minutes):\n\n\nThis might be https://sourceforge.net/p/maxima/bugs/2860/, see also https://sourceforge.net/p/maxima/bugs/2859/",
    "created_at": "2014-12-16T15:56:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296963",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>> For the first example, with Maxima 5.35.1 (see #17514), I get the following error after a very long time (maybe 20 minutes):
...
```json
{
    "body": "<a id='comment:9'></a>Also, with the latest Git version of Maxima (and using GCL) the error has disappeared and there is just an \"encountered log(0)\" message:\n\n```\nMaxima branch_5_35_base_16_gfc3f8b9_dirty http://maxima.sourceforge.net\nusing Lisp GNU Common Lisp (GCL) GCL 2.6.12 (a.k.a. GCL)\nDistributed under the GNU Public License. See the file COPYING.\nDedicated to the memory of William Schelter.\nThe function bug_report() provides bug reporting information.\n(%i1) integrate(log(abs(2*sin(u))),u,0,%pi/3);\n                 sqrt(3) %i + 1                sqrt(3) %i + 1\n(%o1) (18 %i li (--------------) + 18 %i li (- --------------) - 3 %pi log(3)\n               2       2                   2         2\n                                                                              2\n                                                   2       %pi log(3)   %i %pi\n                                         + 2 %i %pi )/18 + ---------- - -------\n                                                               6          12\n(%i2) load(abs_integrate);\n(%o2) /home/bruinpj/src/maxima/share/contrib/integration/abs_integrate.mac\n(%i3) integrate(log(abs(2*sin(u))),u,0,%pi/3);\n\nlog: encountered log(0).\n                 sqrt(3) %i + 1                sqrt(3) %i + 1\n(%o3) (18 %i li (--------------) + 18 %i li (- --------------) - 3 %pi log(3)\n               2       2                   2         2\n                                                                              2\n                                                   2       %pi log(3)   %i %pi\n                                         + 2 %i %pi )/18 + ---------- - -------\n                                                               6          12\n```\nI guess the reason for the errors in[comment:5](#comment%3A5) and[comment:7](#comment%3A7) was that http://sourceforge.net/p/maxima/bugs/2853/ was only fixed after Maxima 5.35.1 was released.",
    "created_at": "2014-12-17T14:56:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296966",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:9'></a>Also, with the latest Git version of Maxima (and using GCL) the error has disappeared and there is just an "encountered log(0)" message:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296967",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296968",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"d1b90855e29f67423f404c18db74f2573c59446c\"",
    "created_at": "2019-10-08T07:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296969",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "" to "d1b90855e29f67423f404c18db74f2573c59446c"
...
```json
{
    "body": "Changing branch from \"\" to \"u/chapoton/17468\"",
    "created_at": "2019-10-08T07:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296970",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "" to "u/chapoton/17468"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296971",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296972",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17468#event-50250"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>bot is morally green, please review",
    "created_at": "2019-10-08T08:28:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296973",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:13'></a>bot is morally green, please review
...
```json
{
    "body": "<a id='comment:14'></a>Looks good.  I also did an independent numerical correctness check for these answers (using PARI/GP).",
    "created_at": "2019-10-08T11:16:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296974",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:14'></a>Looks good.  I also did an independent numerical correctness check for these answers (using PARI/GP).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296975",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296976",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296977",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Changing branch from \"u/chapoton/17468\" to \"d1b90855e29f67423f404c18db74f2573c59446c\"",
    "created_at": "2019-10-12T22:12:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296978",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/chapoton/17468" to "d1b90855e29f67423f404c18db74f2573c59446c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17468#event-50251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17468#issuecomment-296979",
    "user": "https://github.com/vbraun"
}
```
