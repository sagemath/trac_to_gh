...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223912",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223913",
...
```json
{
    "body": "<a id='comment:3'></a>Seems to work; now `top()` and `bottom()` on posets take same time. This also explains why timings with #13223 where little strange.\n\nUnfortunately I don't know enought Sage to be able to really review this.",
    "created_at": "2014-10-16T11:28:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223914",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:3'></a>Seems to work; now `top()` and `bottom()` on posets take same time. This also explains why timings with #13223 where little strange.
...
```json
{
    "body": "<a id='comment:4'></a>The patch is working well. However, there are several places in `src/sage/graphs/base/c_graph.pyx` where you have such instruction (this one from your patch):\n\n```\ncdef v_int = get_vertex(v,\n                        self.vertex_ints,\n                        self.vertex_labels,\n                        self._cg)\n```\n\nShouldn't you specify the *int* type ?",
    "created_at": "2014-10-18T11:29:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223915",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:4'></a>The patch is working well. However, there are several places in `src/sage/graphs/base/c_graph.pyx` where you have such instruction (this one from your patch):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223916",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>> Shouldn't you specify the *int* type ?\n\n\nIndeed. I just did, thanks.\n\nNathann",
    "created_at": "2014-10-18T11:58:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223917",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>> Shouldn't you specify the *int* type ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223918",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>All tests pass on `src/sage/graphs/`, so I give positive review.",
    "created_at": "2014-10-18T13:29:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223919",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>All tests pass on `src/sage/graphs/`, so I give positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223920",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17163#issuecomment-223921",
