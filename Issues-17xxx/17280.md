...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17280#event-228950"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17280#event-228951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17280#event-228952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17280#event-228953"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17280#issuecomment-233247",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17280#issuecomment-233248",
    "user": "https://github.com/vbraun"
}
```
