...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17767#event-235357"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17767#event-235358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17767#event-235359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17767#event-235360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17767#issuecomment-242523",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17767#issuecomment-242524",
    "user": "https://github.com/sagetrac-gouezel"
}
```
