...
```json
{
    "body": "<a id='comment:1'></a>I also have the same problem on my machine since one year. The problem seems to come from the function `sage.misc.attached_files.modified_file_iterator`. There is some sleep involved:\n\n```python\n    time.sleep(0.1)  # sleep 100ms to give the editor time to finish saving\n```\n\nbut it comes after checking the existence of the attached files which detach \"deleted\" files.\n\nWhen should the sleep be better done?",
    "created_at": "2015-02-16T18:57:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17698#issuecomment-248211",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:1'></a>I also have the same problem on my machine since one year. The problem seems to come from the function `sage.misc.attached_files.modified_file_iterator`. There is some sleep involved:
...
```json
{
    "body": "<a id='comment:2'></a>Using vim, the following tip fixed that problem for me:\n\nhttps://groups.google.com/d/msg/sage-devel/KZ-eiUNS2jg/PtwQMN-FLwAJ\n\nSo it was a problem of the text editor rather than a bug in sage. Should we close this ticket?",
    "created_at": "2016-08-25T16:01:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17698#issuecomment-248212",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:2'></a>Using vim, the following tip fixed that problem for me:
