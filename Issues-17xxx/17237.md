...
```json
{
    "body": "<a id='comment:2'></a>As another thought, perhaps at least updating documentation to talk about what to expect and when to use the other branch stuff might be useful...",
    "created_at": "2014-10-28T12:38:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17237#issuecomment-225221",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>As another thought, perhaps at least updating documentation to talk about what to expect and when to use the other branch stuff might be useful...
