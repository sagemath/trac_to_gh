...
```json
{
    ...
    "type": "issue",
    "updated_at": "2014-12-08T19:14:57Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17025#event-208424"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17025#event-208425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17025#event-208426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17025#event-208427"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17025#event-208428"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17025#issuecomment-227707",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17025#issuecomment-227708",
    "user": "https://github.com/kcrisman"
}
```
