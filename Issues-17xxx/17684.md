...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225862"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225866"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225867"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225869"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225870"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17684",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17684#event-225872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17684#issuecomment-241236",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17684#issuecomment-241237",
    "user": "https://github.com/DaveWitteMorris"
}
```
