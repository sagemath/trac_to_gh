...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17997#event-256029"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17997#event-256030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17997#event-256031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17997#event-256032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17997#issuecomment-244684",
    "user": "https://github.com/sagetrac-jpswanson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17997#issuecomment-244685",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17997#issuecomment-244686",
    "user": "https://github.com/sagetrac-jpswanson"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17997#event-256033"
}
```
