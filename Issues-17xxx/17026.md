...
```json
{
    "body": "<a id='comment:5'></a>\nAmended commit message.\n\n---\nNew commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[5613d35](http://git.sagemath.org/sage.git/commit/?id=5613d3539ac1030bf45033b38113a1750d842f46)|`Trac #17026: use cmp_universal() instead of gcmp_string()`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[85804fc](http://git.sagemath.org/sage.git/commit/?id=85804fc472017342a03c4f0ca45062060184e119)|`Improve sorting in splitting_field`|",
