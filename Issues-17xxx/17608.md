...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17608#event-233194"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17608#event-233195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17608#event-233196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17608#event-233197"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17608#event-233198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17608#issuecomment-239408",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17608#event-233199"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17608#issuecomment-239409",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17608#event-233200"
}
```
