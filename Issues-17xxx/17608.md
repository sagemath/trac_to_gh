...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17608#issuecomment-300415",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Fixed in [Maxima bug 2880](https://sourceforge.net/p/maxima/bugs/2880/), apparently.",
    "created_at": "2018-05-24T01:09:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17608#issuecomment-300416",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>Fixed in [Maxima bug 2880](https://sourceforge.net/p/maxima/bugs/2880/), apparently.
