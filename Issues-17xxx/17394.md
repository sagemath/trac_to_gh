...
```json
{
    "body": "<a id='comment:8'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/e7881fec5314b95497a27587e865fa93b939a12e\">e7881fe</a></td><td><code>17394: make sure that </code></td>(x+y+z).operator()<td><code> returns a function that accepts multiple arguments (and same for multiplication)</code></td></tr></table>\n",
