...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|\n|[e7881fe](http://git.sagemath.org/sage.git/commit/?id=e7881fec5314b95497a27587e865fa93b939a12e)|`17394: make sure that `(x+y+z).operator()` returns a function that accepts multiple arguments (and same for multiplication)`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|\n|[08349c6](http://git.sagemath.org/sage.git/commit/?id=08349c6520dae6fa631728fdadecec81e45a62a5)|`17394: doctest that add_vararg and mul_vararg get used by <symbolic-expression>.operator`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[c16d36f](http://git.sagemath.org/sage.git/commit/?id=c16d36f8c9b09bd467d209345df0c965dec5cf0a)|`17394: fixes to finite_state_machine_generators`|",
    "created_at": "2015-05-09T07:17:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17394",
    "type": "issue_comment",
