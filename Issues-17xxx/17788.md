...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238033",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238035",
    "user": "https://github.com/opechenik"
}
```
...
```json
{
    "body": "I changed 'force' to 'algorithm', which seems more common. I also cleaned up the code a bit, added error handling, and added a corresponding test. I'm not entirely convinced the output should be a `StandardTableau`, `SemistandardTableau`, or `Tableau` rather than just a `Tableau`, but I left that part as-is.\n\n---\nNew commits:",
    "created_at": "2015-04-09T04:48:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238041",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238042",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17788#event-51191"
}
```
...
```json
{
    "body": "If my last commit (94af4b0) looks good to you, please set this to positive_review. (The other commits that were added are from #18024 and reviewed.)\nThanks for this ticket!",
    "created_at": "2015-04-17T07:22:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238043",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "Hey guys, I'm traveling this week and don't have the proper setup to look at the code, but I looked over some of the changes you guys are making and I approve!  Nice work all.  (This is NOT a review, just a comment.)",
    "created_at": "2015-04-17T14:05:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238044",
    "user": "https://github.com/MariaMonks"
}
```
...
```json
{
    "body": "I don't quite like the `as_word` argument as you start mucking with the output type. I think the better thing to do would be to either explicitly factor out the `to_word` to `to_flat_list` and have\n\n```python\ndef to_word(self):\n    return Word(self.to_flat_list())\n```\nor just call `[x for row in self for x in row if x is not None]` instead of `self.to_word()`. My personal preference is the second option since it is a one-liner with the (nested list comprehension).",
    "created_at": "2015-04-17T22:04:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238045",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238046",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238048",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238049",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "I have removed the `as_word` argument in `to_word` as just using a simple list comprehension is easier and cleaner. If we find a need to not return a word and we are copying that list comprehension everywhere, then we will can add a separate method. Darij, if I understood you correctly, you were okay with allowing this and are ready to set a positive review, correct?",
    "created_at": "2015-10-10T19:14:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238050",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17788#event-51192"
}
```
...
```json
{
    ...
    "milestone": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17788#event-51193"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238051",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238052",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238053",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238054",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238055",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238056",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238057",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238058",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17788#event-51194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17788#issuecomment-238059",
    "user": "https://github.com/vbraun"
}
```
