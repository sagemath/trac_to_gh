...
```json
{
    "body": "<a id='comment:13'></a>\nReplying to [ncohen](#comment%3A11):\n\n> > But on documentation it seems that `rename_keyword` is only able to change name of argument. Here we should also change value from `True` to `pairs` and from `False` to `integers`.\n\n> \n> Oh. That's right. Then the deprecation will have to be done manually `^^;`\n\n\nHow? http://www.sagemath.org/doc/developer/coding_in_python.html#deprecation does not tell.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[57d243c](http://git.sagemath.org/sage.git/commit/?id=57d243c0c43488259eb065a7ec9d6bc3c2ecac82)|`Added functions for disjoint union and ordinal sum. Needs more work.`|",
    "created_at": "2014-09-29T14:45:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17053",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[abf4bbd](http://git.sagemath.org/sage.git/commit/?id=abf4bbd3c4f3f8210684abe44c6c824a1e7a914b)|`Changed parameter of disjoint_union on generic graphs from`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[4a13ab5](http://git.sagemath.org/sage.git/commit/?id=4a13ab545a6424a74a4ad6edc1ec54544e3c2a2b)|`Doing functions disjoint_union ordinal_sum.`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[7a801e8](http://git.sagemath.org/sage.git/commit/?id=7a801e8d3045ef87d8a35d8491ed2e76b18d30a3)|`Corrections to documentation.`|",
    "created_at": "2014-09-30T07:54:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17053",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|\n|[4b35a54](http://git.sagemath.org/sage.git/commit/?id=4b35a5413d0d18e075783484ff8079034e828d51)|`From 'is' to 'isinstance'. Code reformatted slightly.`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[5c8cf87](http://git.sagemath.org/sage.git/commit/?id=5c8cf87e90acdf4f956df024678c6d07203fe9b8)|`Docs; Now x<y if x \\in P and y \\in Q for P.ordinal_sum(Q).`|",
...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[7c73dcc](http://git.sagemath.org/sage.git/commit/?id=7c73dcc7ab52ec00634fb1f3f7ca23560c8c39b2)|`Merge branch 'sum_of_posets' into poset_sum`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[e5582b7](http://git.sagemath.org/sage.git/commit/?id=e5582b7de06d5b3516cc98b7742a0bdea35e52ea)|`Added sorted() to doctests.`|",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[b097c88](http://git.sagemath.org/sage.git/commit/?id=b097c8893dae7cd96f8f7064d0179842cc4aeaec)|`trac #17053 correct doctests in cluster stuff`|",
