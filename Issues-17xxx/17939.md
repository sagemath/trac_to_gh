...
```json
{
    "body": "Can you verify that this is only with Debian?",
...
```json
{
    "body": "See also #22499 which might make it easier to deal with such tickets.",
...
```json
{
    "body": "I seem to recall default image sizes getting a lot bigger a few years ago, but haven't seen any specific validation of this ticket.  Certainly downgrading status as it is fairly easy (if tedious) to fix on an image-by-image basis.",
    "created_at": "2019-01-08T14:13:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17939",
    "type": "issue_comment",
