...
<a id='comment:4'></a>Here is a first pass at reviewing this.
...
<a id='comment:7'></a>Looks like we are almost there with this one. The functionality all is in working order. But, I came across a few minor things to fix.
...
```json
{
    "body": "<a id='comment:11'></a>Ok. this looks good now.",
    "created_at": "2015-02-03T19:13:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17386",
    "type": "issue_comment",
...
<a id='comment:11'></a>Ok. this looks good now.
