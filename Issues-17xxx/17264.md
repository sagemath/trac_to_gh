...
```json
{
    "body": "<a id='comment:1'></a>Is this only true for floats, though?",
    "created_at": "2014-11-03T13:33:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292551",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Is this only true for floats, though?
...
```json
{
    "body": "<a id='comment:2'></a>Probably. `is_field(float)` does not work as well, by the way.\n\nThe fix is to either allow `float` though as the base field or replace it with RDF. I suspect the second option is less error-prone.",
    "created_at": "2014-11-05T21:37:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292552",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:2'></a>Probably. `is_field(float)` does not work as well, by the way.
...
```json
{
    "body": "<a id='comment:3'></a>Still breaks in 7.6.beta6...",
    "created_at": "2017-03-09T03:58:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292553",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:3'></a>Still breaks in 7.6.beta6...
...
```json
{
    "body": "<a id='comment:4'></a>This should be looked at after #18220 gets merged.",
    "created_at": "2017-03-10T11:45:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292554",
    "user": "https://github.com/jplab"
}
```

<a id='comment:4'></a>This should be looked at after #18220 gets merged.
...
```json
{
    "body": "<a id='comment:6'></a>The ticket #22605 aims to make the error messages for base ring more informative and suggested to redirect floats to the base ring `RDF`.",
    "created_at": "2017-03-17T13:32:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292556",
    "user": "https://github.com/jplab"
}
```

<a id='comment:6'></a>The ticket #22605 aims to make the error messages for base ring more informative and suggested to redirect floats to the base ring `RDF`.
...
```json
{
    "body": "<a id='comment:7'></a>Fixed (or at least coherent) in 8.1.beta2\n\n```\nsage: Polyhedron([(0.8370682893845995r, 0.2027977776670088r, 0.2547890063224252r)])\nA 0-dimensional polyhedron in RDF^3 defined as the convex hull of 1 vertex\nsage: Polyhedron([(0.8370682893845995, 0.2027977776670088, 0.2547890063224252)])\nTraceback (most recent call last):\n...\nValueError: no appropriate backend for computations with Real Field with 54 bits of precision\n```\n(see #22605)",
    "created_at": "2017-08-19T15:42:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292557",
    "user": "https://github.com/videlec"
}
```

<a id='comment:7'></a>Fixed (or at least coherent) in 8.1.beta2
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17264#event-49941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292558",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292559",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Indeed, #22605 seems to deal with that issue properly.",
    "created_at": "2017-08-21T19:44:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292560",
    "user": "https://github.com/jplab"
}
```

<a id='comment:8'></a>Indeed, #22605 seems to deal with that issue properly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292561",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Needs Author and Reviewer.",
    "created_at": "2017-08-21T21:13:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292562",
    "user": "https://github.com/kevindilks"
}
```

<a id='comment:9'></a>Needs Author and Reviewer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292563",
    "user": "https://github.com/jplab"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Nothing was written so we won't put authors...",
    "created_at": "2017-08-21T22:50:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292564",
    "user": "https://github.com/jplab"
}
```

<a id='comment:10'></a>Nothing was written so we won't put authors...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17264#issuecomment-292565",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17264",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17264#event-49942"
}
```
