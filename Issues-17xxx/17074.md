...
```json
{
    "body": "<a id='comment:1'></a>I have never seen it. Question: Is the code in `src/sage/combinat/cluster_algebra/` using the code from `src/sage/quivers/`? If yes, then I wonder if #16453 improves the situation. If not, then I have no idea whatsoever on the timeout.",
    "created_at": "2014-09-30T11:01:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17074#issuecomment-287419",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>I have never seen it. Question: Is the code in `src/sage/combinat/cluster_algebra/` using the code from `src/sage/quivers/`? If yes, then I wonder if #16453 improves the situation. If not, then I have no idea whatsoever on the timeout.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17074#issuecomment-287421",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17074#issuecomment-287422",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17074#issuecomment-287423",
