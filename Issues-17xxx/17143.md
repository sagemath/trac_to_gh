...
```json
{
    "body": "Attachment [ideal.sobj](tarball://root/attachments/some-uuid/ticket17143/ideal.sobj) by @simon-king-jena created at 2014-10-13 12:46:43",
...
Attachment [ideal.sobj](tarball://root/attachments/some-uuid/ticket17143/ideal.sobj) by @simon-king-jena created at 2014-10-13 12:46:43
...
```json
{
    "body": "There is still a bug though (for a different ticket), the result of a second call to `groebner_basis()` is different:\n\n```\nsage: I.groebner_basis()\nPolynomial Sequence with 22 Polynomials in 21 Variables\nsage: I.groebner_basis()\nPolynomial Sequence with 24 Polynomials in 21 Variables\n```",
...
```json
{
    "body": "And Jeroen, did you use a debug version of Sage? I don't see the segfault in the debug version, I only see it in a \"normal\" Sage version",
...
```json
{
    "body": "I see! I thought the number of variables coincides with the number of variables of the ring, but actually it only gives the number of *used* variables.\n\nWhat architecture are you using? I learnt that I am on 32 bit.",
...
```json
{
    "body": "On a different 32-bit system, it also works:\n\n```\nsage: G = I.groebner_basis()\nsage: G\nPolynomial Sequence with 22 Polynomials in 21 Variables\n```",
...
```json
{
    "body": "This might also be an instance of #17072.",
...
```json
{
    "body": "After pulling from develop, export SAGE_UPGRADE=yes, and make, the problem vanishes. So, probably this ticket can be closed.",
