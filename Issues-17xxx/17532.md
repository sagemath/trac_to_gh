...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298328",
...
```json
{
    "body": "<a id='comment:3'></a>> 1. By implementing a different algorithm and getting 4 as an answer\n> 2. By drawing the  solution given by sage and seeing that it does not give the whole graph\n> 3. Arguing as follows. In the Petersen graph any pair of vertices is connected by a UNIQUE shortest path and has diameter 2. Hence 3 vertices give you a hull of size at most 3+ (3 \\choose 2)*1 = 9\n> 4. By checking this paper http://ajc.maths.uq.edu.au/pdf/26/ajc_v26_p011.pdf where it says that the Petersen graph has hull number 4.\n\n\nThe paper you cite talks about the geodetic number, not the hull number. The computation that you do in 3 is only correct for the geodetic number. Thus I tend to think that the same reason explains 1 and 2 as well.\n\nNathann",
    "created_at": "2014-12-20T17:43:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298330",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:3'></a>> 1. By implementing a different algorithm and getting 4 as an answer
> 2. By drawing the  solution given by sage and seeing that it does not give the whole graph
> 3. Arguing as follows. In the Petersen graph any pair of vertices is connected by a UNIQUE shortest path and has diameter 2. Hence 3 vertices give you a hull of size at most 3+ (3 \choose 2)*1 = 9
> 4. By checking this paper http://ajc.maths.uq.edu.au/pdf/26/ajc_v26_p011.pdf where it says that the Petersen graph has hull number 4.
...
```json
{
    "body": "<a id='comment:4'></a>Ooooh, but what is the thing with the cited paper about the geodetic number? Isnt that the same thing?",
    "created_at": "2014-12-20T17:45:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298331",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:4'></a>Ooooh, but what is the thing with the cited paper about the geodetic number? Isnt that the same thing?
...
```json
{
    "body": "<a id='comment:6'></a>Ooooh. So the convex hull of S is *not* the set of all vertices that lie on a shortest path between any u,v in S?",
    "created_at": "2014-12-20T17:53:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298333",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:6'></a>Ooooh. So the convex hull of S is *not* the set of all vertices that lie on a shortest path between any u,v in S?
...
```json
{
    "body": "<a id='comment:7'></a>> Ooooh. So the convex hull of S is *not* the set of all vertices that lie on a shortest path between any u,v in S?\n\n\nIndeed, it is strictly larger than that in some cases. It is an iterated procedure.\n\nNathann",
    "created_at": "2014-12-20T17:55:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298334",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:7'></a>> Ooooh. So the convex hull of S is *not* the set of all vertices that lie on a shortest path between any u,v in S?
...
```json
{
    "body": "<a id='comment:8'></a>Ohhh I got confused by the cited paper then I thought its the same notion.\n\nClosing this as fixed!",
    "created_at": "2014-12-20T17:56:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298335",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:8'></a>Ohhh I got confused by the cited paper then I thought its the same notion.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298336",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298337",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298338",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298339",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298340",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17532#event-50369"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>The way to 'close' a ticket is to set its milestone to wontfix and to change its status to positive_review. THeeeeeen the release manager will close it.\n\nGood evening,\n\nNathann",
    "created_at": "2014-12-20T18:01:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298341",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:10'></a>The way to 'close' a ticket is to set its milestone to wontfix and to change its status to positive_review. THeeeeeen the release manager will close it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298342",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17532#event-50370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17532#issuecomment-298343",
