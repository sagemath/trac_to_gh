...
<a id='comment:2'></a>Replying to [comment:1 pbruin]:
> I wonder if there could be any link with #17527.
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [comment:1 pbruin]:\n> I wonder if there could be any link with #17527.\n\n\nNot fixed by my fix, so not related.",
...
<a id='comment:7'></a>Replying to [comment:1 pbruin]:
> I wonder if there could be any link with #17527.
