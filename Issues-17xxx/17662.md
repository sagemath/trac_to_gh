...
```json
{
    "body": "<a id='comment:8'></a>Here is the much better backtracker. I implemented the points that I did not discuss in my [comment:5 comment:5].",
...
<a id='comment:8'></a>Here is the much better backtracker. I implemented the points that I did not discuss in my [comment:5 comment:5].
...
```json
{
    "body": "<a id='comment:22'></a>Oops. I introduced wrong specifications in `._B_automorphisms()`. Now it is ok. I also advertised the BIBD from [comment:12 comment:12].",
...
<a id='comment:22'></a>Oops. I introduced wrong specifications in `._B_automorphisms()`. Now it is ok. I also advertised the BIBD from [comment:12 comment:12].
