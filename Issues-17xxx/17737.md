...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/17737",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17737",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17737#issuecomment-303730",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17737",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17737#issuecomment-303731",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50719"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Such a feature would be awesome, in particular in a combinatorial context, it could be nice if Sage were able to transform `gamma(n+1/2)` into `factorial(2n)/(4^n*factorial(n))*sqrt(pi)`, see e.g.\n\n```\nsage: var('k,n')\n(k, n)\nsage: assume(n,'integer')\nsage: symbolic_product((2*k)^2-1,k,1,n)\n2^(2*n + 1)*gamma(n + 3/2)*gamma(n + 1/2)/pi\n```",
    "created_at": "2018-04-24T02:16:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17737",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17737#issuecomment-303732",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:6'></a>Such a feature would be awesome, in particular in a combinatorial context, it could be nice if Sage were able to transform `gamma(n+1/2)` into `factorial(2n)/(4^n*factorial(n))*sqrt(pi)`, see e.g.
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50720"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17737",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17737#issuecomment-303734",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50722"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17737",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17737#issuecomment-303735",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50724"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50725"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50726"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50727"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50728"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50729"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50730"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17737#event-50731"
}
```
