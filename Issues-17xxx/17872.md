...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306687",
...
```json
{
    "body": "<a id='comment:2'></a>`@`vdelecroix: It works because it doesn't try to use the name, does it?\n\nWhat I find strange is that a name is set in function.pyx... (line 1156).",
    "created_at": "2015-03-01T21:53:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306688",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

<a id='comment:2'></a>`@`vdelecroix: It works because it doesn't try to use the name, does it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306689",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/Snark/singularkernelfunction_documentation_doesn_t_work\"",
    "created_at": "2015-03-02T21:02:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306690",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

Changing branch from "" to "u/Snark/singularkernelfunction_documentation_doesn_t_work"
...
```json
{
    "body": "<a id='comment:5'></a>Ok, I pushed a trivial patch which does the minimal amount of change... I'm pretty sure the right way would be to actually add the name somewhere, but since I don't know how to do that...\n\n---\nNew commits:",
    "created_at": "2015-03-02T21:09:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306691",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

<a id='comment:5'></a>Ok, I pushed a trivial patch which does the minimal amount of change... I'm pretty sure the right way would be to actually add the name somewhere, but since I don't know how to do that...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306692",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"4c41c1fa8c35c41d94ceaca86d17f49b630cda45\"",
    "created_at": "2015-03-02T21:09:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306693",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

Changing commit from "" to "4c41c1fa8c35c41d94ceaca86d17f49b630cda45"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306694",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Hmmm... that adds a new custom name to the objects, and adds code to use that in the documentation, so modifies things in two places. Isn't it possible to just add the name the documentation code already expects?",
    "created_at": "2015-03-02T21:56:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306696",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

<a id='comment:7'></a>Hmmm... that adds a new custom name to the objects, and adds code to use that in the documentation, so modifies things in two places. Isn't it possible to just add the name the documentation code already expects?
...
```json
{
    "body": "<a id='comment:8'></a>With code like\n\n```\npoly_reduce = singular_function(\"NF\")\n```\nI'm not sure how to recover the string \"poly_reduce\".",
    "created_at": "2015-03-02T22:15:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306697",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>With code like
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306698",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "Changing branch from \"u/Snark/singularkernelfunction_documentation_doesn_t_work\" to \"u/malb/t17872_singular_function_doc\"",
    "created_at": "2015-05-19T20:11:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306699",
    "user": "https://github.com/malb"
}
```

Changing branch from "u/Snark/singularkernelfunction_documentation_doesn_t_work" to "u/malb/t17872_singular_function_doc"
...
```json
{
    "body": "Changing commit from \"4c41c1fa8c35c41d94ceaca86d17f49b630cda45\" to \"5dea008c123fde440eac6e1c5e849348619a059e\"",
    "created_at": "2015-05-19T20:11:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306700",
    "user": "https://github.com/malb"
}
```

Changing commit from "4c41c1fa8c35c41d94ceaca86d17f49b630cda45" to "5dea008c123fde440eac6e1c5e849348619a059e"
...
```json
{
    "body": "<a id='comment:10'></a>Isn't the best solution to just add `__name__` to `SingularFunction` objects? I've created a branch with that fix applied and it seems to be working fine.\n\n---\nNew commits:",
    "created_at": "2015-05-19T20:11:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306701",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>Isn't the best solution to just add `__name__` to `SingularFunction` objects? I've created a branch with that fix applied and it seems to be working fine.
...
```json
{
    "body": "Changing commit from \"5dea008c123fde440eac6e1c5e849348619a059e\" to \"7fac2db140fd73567785d08af5af7cd18af82977\"",
    "created_at": "2015-05-19T20:15:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306702",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "5dea008c123fde440eac6e1c5e849348619a059e" to "7fac2db140fd73567785d08af5af7cd18af82977"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306703",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306704",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17872#issuecomment-306705",
    "user": "https://github.com/fchapoton"
}
```
