...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17120#issuecomment-223232",
...
```json
{
    "body": "<a id='comment:2'></a>In Sage-9.0.beta6:\n\n```\nsage: %time K.galois_group().ramification_breaks(K.primes_above(2)[0])\nCPU times: user 423 ms, sys: 8.12 ms, total: 431 ms\nWall time: 430 ms\n{1, 3, 5}\n```",
    "created_at": "2019-11-20T22:02:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17120#issuecomment-223233",
    "user": "https://github.com/roed314"
}
```

<a id='comment:2'></a>In Sage-9.0.beta6:
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17120#event-49713"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Agreed. This seems to be fast in 9.0.b9.",
    "created_at": "2019-12-14T13:20:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17120#issuecomment-223234",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>Agreed. This seems to be fast in 9.0.b9.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17120",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17120#event-49714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17120#issuecomment-223235",
    "user": "https://github.com/fchapoton"
}
```
