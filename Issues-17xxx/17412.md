...
```json
{
    "body": "<a id='comment:2'></a>\nWhat is about\n\n```\n solve_mod()\n solve_ineq_univar()\n solve_ineq_fourier()\n solve_ineq()\n```\nmay they also fail in some cases to return all solutions?\nWhich other routines need an explicit statement, that an empty result does not imply\nthat there are no solutions?\n\n\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|\n|[2d75747](http://git.sagemath.org/sage.git/commit/?id=2d7574794ae840b48a0f8841a8978157066982db)|`explicitly state that solve may not obtain all existing solutions and that an empty result does not imply there are no solutions`|",
    "created_at": "2014-11-28T10:36:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17412",
    "type": "issue_comment",
