...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17412#issuecomment-295577",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17412#issuecomment-295578",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17412#issuecomment-295579",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I think you should also give an explicit example in the doc. However, the one you provide does not work for me (on 6.5.beta0):\n\n```\nsage: solve(5^( x -1) == (1/25)^(2*x), x)\n...\nNotImplementedError: non-integral exponents not supported\n```",
    "created_at": "2014-11-28T16:27:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17412#issuecomment-295581",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:3'></a>I think you should also give an explicit example in the doc. However, the one you provide does not work for me (on 6.5.beta0):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17412#issuecomment-295582",
...
```json
{
    "body": "<a id='comment:5'></a>Uh my bad, i was using the wrong sage console where i used polynomials before. Sorry for the noise.\n\nThat said, adding an example showing explicitly the problem (e.g. that particular example, since it works) could be good to make things explicit. The existing example are somehow too optimistic, and we should point what does not work as well.",
    "created_at": "2014-11-29T00:21:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17412#issuecomment-295583",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:5'></a>Uh my bad, i was using the wrong sage console where i used polynomials before. Sorry for the noise.
