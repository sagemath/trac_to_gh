...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[e2d2920](http://git.sagemath.org/sage.git/commit/?id=e2d29209a8ca5c03ad8830596cc69578491df047)|`Remove debug stuff.`|",
    "created_at": "2014-10-27T15:26:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17184",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[cde2930](http://git.sagemath.org/sage.git/commit/?id=cde293057415ab28388bbdd43d813c5a21182392)|`Update doctest for Singular new behavior.`|",
    "created_at": "2014-10-27T15:52:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17184",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[badc6f7](http://git.sagemath.org/sage.git/commit/?id=badc6f73e349b6f7a3e95cd06f7a3ca5143ebe64)|`Merge remote-tracking branch 'trac/develop' into ticket/17184`|\n|[ac60a76](http://git.sagemath.org/sage.git/commit/?id=ac60a769503ec0ad4a227ad9cec0aa7cebd10bb6)|`Update Singular to 3-1-7p1.`|",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[9b3b933](http://git.sagemath.org/sage.git/commit/?id=9b3b9333ca798420edcfd07f03e2ace0991d1431)|`Use actual upstream version number for Singular.`|",
    "created_at": "2014-11-19T16:35:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17184",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:60'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[0a5f695](http://git.sagemath.org/sage.git/commit/?id=0a5f6951bd84d6596c292e26e8ad9b8101ca51f8)|`Try to prevent Singular from segfaulting.`|",
...
```json
{
    "body": "<a id='comment:65'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[4e287c4](http://git.sagemath.org/sage.git/commit/?id=4e287c4a5a72e1a23c35046c71bddde9786110cc)|`Remove useless explicit templates instantiations in Singular.`|",
    "created_at": "2014-11-21T17:03:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17184",
    "type": "issue_comment",
