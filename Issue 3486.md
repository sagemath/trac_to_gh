...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3486#issuecomment-24522",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "This problem turned out to be a NFS problem. gcc 4.3.x just triggered the error that has always been on that machine since `#if ` now produces an error.\n\nCheers,\n\nMichael",
    "created_at": "2008-06-26T03:50:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3486#issuecomment-24523",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3486#issuecomment-24524",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3486#event-3706"
}
```
