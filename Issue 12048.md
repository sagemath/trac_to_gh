...
Original creation time: 2011-12-22 09:16:48
...
Comment by ncohen created at 2011-12-22 09:18:34
...
Comment by ncohen created at 2011-12-22 09:19:58
...
Comment by john_perry created at 2011-12-22 16:12:13
...
Comment by ncohen created at 2011-12-22 16:14:34
...
Comment by john_perry created at 2012-01-05 21:49:30
...
Comment by john_perry created at 2012-01-05 21:57:29
...
Comment by ncohen created at 2012-01-05 22:10:16
...
Comment by john_perry created at 2012-01-05 22:25:49
...
Out of curiosity, _are_ those `ctypedef`s supposed to go in a certain order? Cython documentation doesn't seem clear on this.


---

Comment by john_perry created at 2012-01-05 22:27:27
...
Comment by ncohen created at 2012-01-05 22:30:07
...
Comment by john_perry created at 2012-01-06 22:34:41
...
What is this _number of threads_ business? Is it related to parallelism?
...
Comment by john_perry created at 2012-01-06 22:38:07
...
Comment by ncohen created at 2012-01-06 22:58:05
...
Comment by john_perry created at 2012-01-09 20:56:17
...
Comment by john_perry created at 2012-01-09 22:01:44
...
Comment by ncohen created at 2012-01-10 07:56:27
...
Comment by john_perry created at 2012-01-10 14:50:27
...
Comment by john_perry created at 2012-01-10 15:49:17
...
Comment by john_perry created at 2012-01-10 16:11:04
...
Comment by john_perry created at 2012-01-10 22:07:32
...
...the only thing I can't do right now is, uh, well, actually _solve_ an LP. Their example is a little funny there, though, so that doesn't surprise me. I'll have to examine their code a little more carefully, and figure out why on earth they do certain things.
...
Comment by john_perry created at 2012-01-11 01:44:03

Solving is working. Ironically, it was probably working when I said it wasn't; I just didn't realize that I needed to change to code to look for signals like `isAbandoned` from the _model_ and not from the _interface_.
...
Comment by john_perry created at 2012-01-11 18:48:00
...
Comment by john_perry created at 2012-01-11 20:46:53
...
Comment by john_perry created at 2012-01-11 22:31:24
...
Comment by ncohen created at 2012-01-12 08:37:18
...
Comment by john_perry created at 2012-01-12 13:41:18

Replying to [comment:26 ncohen]:
> When you talk about "the model", do you mean that you have to copy all the constraints and variables again if you ever want to 1) solve a LP 2) add a constraint 3) solve it again ?

Here's a rough sketch of what works.
  1. let _si_ = *new* _OsiClpSolverInterface_()
  2. *while not* _done_:
     a. add constraints, variables, whatnot to _si_
     b. let _model_ = *new* CbcModel(_si_)
     c. _model.branchAndCut_()
     d. extract solutions from _model.si_, evaluate _done_

Step 2b clones _si_, so I think the answer to your question is, _yes_. I find this deeply unsatisfying myself, but if I try to move that step outside the loop and modify Cbc's model after solving, Sage gives a `SIGSEV`.
...
Comment by ncohen created at 2012-01-12 13:53:03
...
Comment by ncohen created at 2012-01-12 14:07:28
...
Comment by john_perry created at 2012-01-12 15:08:47
...
Comment by ncohen created at 2012-01-12 15:39:31
...
Comment by john_perry created at 2012-01-12 16:55:48
...
Comment by john_perry created at 2012-01-12 17:39:10
...
Good news and bad news.
  ...
  1. Unfortunately, if I do add a constraint after solving once, `CbcModel` doesn't seem capable of solving the new system. Even if I add a constraint that maintains feasibility, I get the message,
...
Comment by john_perry created at 2012-01-12 18:15:25
...
Comment by john_perry created at 2012-01-13 00:20:48
...
One doctest doesn't pass: in `mip.pyx`, the test of the `write_lp()` method in line 685 raises a `NotImplementedError`. Since this was _never_ implemented with Coin, I don't consider it a deal breaker. I think I can fix it if you want; the `OsiSolverInterface` provides a `writeMps()` method that
...
Comment by john_perry created at 2012-01-13 00:27:37
...
Comment by john_perry created at 2012-01-13 00:28:18
...
Comment by john_perry created at 2012-01-13 15:38:42
...
Comment by john_perry created at 2012-01-13 22:56:03
...
(I wish there were a way to _delete_ attachments!)


---

Comment by ncohen created at 2012-01-31 11:50:54
...
Comment by john_perry created at 2012-01-31 16:40:06
...
Comment by ncohen created at 2012-01-31 17:08:51
...
Comment by john_perry created at 2012-01-31 17:24:29
...
Comment by ncohen created at 2012-01-31 17:25:50
...
Comment by john_perry created at 2012-02-02 01:50:27
...
Comment by ncohen created at 2012-02-02 09:35:31
...
Comment by john_perry created at 2012-02-02 13:04:29
...
Comment by ncohen created at 2012-02-06 09:19:22
...
Comment by ncohen created at 2012-02-06 15:54:22
...
Comment by ncohen created at 2012-02-06 22:09:56
...
Comment by john_perry created at 2012-02-07 18:25:54
...
Comment by ncohen created at 2012-02-07 18:34:41
...
Comment by john_perry created at 2012-02-07 19:24:09
...
Comment by ncohen created at 2012-02-07 19:31:54
...
Comment by john_perry created at 2012-02-07 19:51:05
...
Comment by ncohen created at 2012-02-07 20:02:40
...
Comment by john_perry created at 2012-02-07 20:18:41
...
Comment by john_perry created at 2012-02-07 20:32:32
...
Comment by ncohen created at 2012-02-07 20:39:07
...
Comment by john_perry created at 2012-02-07 20:49:46
...
Comment by ncohen created at 2012-02-08 00:14:08
...
Comment by john_perry created at 2012-02-08 17:00:31

I'm attaching a slightly different approach. I see what you did in CPLEX, but I think a more efficient approach is for the _client_ should do the rounding if it wants that. This avoids the function call to the backend to determine whether the variable is continuous. After all, the client already knows that.
...
Comment by john_perry created at 2012-02-08 19:00:05
...
Comment by ncohen created at 2012-02-08 23:54:27
...
Comment by ncohen created at 2012-02-25 15:43:03
...
Comment by john_perry created at 2012-02-25 16:27:30
...
If I want to add a constraint after solving once, the Cbc model crashes, hard. I don't remember if it crashes when I add to the model, or when I try to solve. The solution I had found, and which worked at _one_ point, was to delete the model, but since OsiClp stores the solution in the model (no joke) you lose the solutions. My solution was to store the values of the variables; I don't remember how, but a dictionary doesn't sound too wrong...
...
Comment by ncohen created at 2012-02-25 16:41:18
...
> The solution I had found, and which worked at _one_ point, was to delete the model, but since OsiClp stores the solution in the model (no joke) you lose the solutions. 
...
Comment by ncohen created at 2012-03-23 10:57:04
...
Comment by ncohen created at 2012-03-23 12:54:48
...
Comment by john_perry created at 2012-03-23 13:19:24
...
Comment by ncohen created at 2012-03-23 13:38:34
...
Comment by john_perry created at 2012-03-23 13:57:41
...
Comment by ncohen created at 2012-03-23 14:31:08
...
Comment by ncohen created at 2012-03-23 14:32:03
...
Comment by john_perry created at 2012-03-23 14:49:36
...
Comment by ncohen created at 2012-03-23 15:03:41
...
Comment by john_perry created at 2012-03-23 15:10:57
...
Comment by ncohen created at 2012-03-23 15:54:40
...
Comment by john_perry created at 2012-03-23 20:51:04
...
Comment by ncohen created at 2012-03-23 21:01:39
...
Comment by john_perry created at 2012-03-26 23:14:15
...
Comment by ncohen created at 2012-03-27 08:48:13
...
Comment by john_perry created at 2012-03-27 19:38:47
...
Comment by ncohen created at 2012-03-28 06:35:53
...
Comment by jdemeyer created at 2012-03-28 07:06:13
...
Comment by john_perry created at 2012-03-28 13:20:58
...
Comment by ncohen created at 2012-03-28 14:33:41
...
Comment by jdemeyer created at 2012-04-08 00:40:06
...
Comment by schilly created at 2012-04-08 01:12:13
...
Comment by ncohen created at 2012-04-08 08:51:27
