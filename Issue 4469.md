# Issue 4469: [with patch, positive review] Sage 3.2.a3: output ordering randomness in sage/rings/number_field/number_field.py
...
```json
{
    ...
    "title": "[with patch, positive review] Sage 3.2.a3: output ordering randomness in sage/rings/number_field/number_field.py",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4469",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4469#event-10097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4469",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4469#event-10098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4469",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4469#event-10099"
}
```
