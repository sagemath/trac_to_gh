...
```json
{
    "body": "Glad to see you taking the lead on that one. I was planning to do something about it post 6.2.\n----\nNew commits:",
    "created_at": "2014-04-17T11:41:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206673",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206675",
    "user": "https://github.com/gagern"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206676",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "In principle, I will put this as positive. It is not like we haven't been using the stuff for several months, and I did use it on OS X too.",
    "created_at": "2014-04-17T12:09:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206677",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "I wonder whether I should bump the patch level of the package version. If so, should I update `SPKG.txt` as well? If so, should I add a section about [`maxima-5.29.1.p4`](http://git.sagemath.org/sage.git/commit/?id=148fc5808c66d6d2a0eae8846de6d88fd332d5ff) as well? With what content?",
    "created_at": "2014-04-17T14:24:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206678",
    "user": "https://github.com/gagern"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206679",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206681",
    "user": "https://github.com/gagern"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206683",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206684",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Yes, that looks OK now. Let's get on with it.",
    "created_at": "2014-04-22T07:18:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206685",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206686",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15941#event-15528"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206687",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "asdf is the normal way to build Lisp packages, IMHO. Removing it is akin to removing makefiles and replacing them with hand-written scripts. Is it the way to go? asdf is actively developed and maintained. Perhaps one should ask for help instead?\n\nI only saw this ticket on sage-release, that's why a late reaction.",
    "created_at": "2014-04-23T06:34:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206688",
...
```json
{
    "body": "Don't worry. The wording may be a bit misleading. We don't ditch asdf but instead of doing a separate invocation at the end to build the maxima library we patch the build system to build it in parallel. So asdf is not gone ;)",
    "created_at": "2014-04-23T07:07:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206689",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206690",
    "user": "https://github.com/gagern"
}
```
...
```json
{
    "body": "If you edit a comment after a push then trac will helpfully suggest to remove the \"Commit:\" field. Right now you need to click on the \"revert\" link in the preview before sending off the comment. Its a bug in our workflow but does not prevent the ticket from being merged (at least until it is fixed).",
    "created_at": "2014-04-23T12:30:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206692",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "I've asked Maxima upstream to accept the FASL patch: https://sourceforge.net/p/maxima/patches/80/\n\nI don't know the surrounding Lisp ecosystem very well, so please help me with making points etc in case they have reservations about it.",
    "created_at": "2016-11-12T18:09:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15941#issuecomment-206693",
