# Issue 6122: [with patch, positive review] strip 'nodetex' from docstrings
...
```json
{
    ...
    "title": "[with patch, positive review] strip 'nodetex' from docstrings",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6122",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6122#event-14417"
}
```
