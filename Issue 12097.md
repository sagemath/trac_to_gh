...
```json
{
    "body": "Sorry, I'm messing up the patch numbers. I mean #11869 everywhere.",
    "created_at": "2012-01-06T10:33:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140018",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140019",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "See also #12271 (which is the same, but for relativize)",
    "created_at": "2012-01-06T11:10:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140020",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "I believe a solution similar to #11876 is in order: make `absolute_field` store an embedding (in this case an isomorphism) to the starting field.",
    "created_at": "2012-01-06T11:24:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140021",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140022",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140025",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140026",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140027",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "Hi, I agree that the error here is that O and P should not be given a coercion. Note that the code above does not work if P is given another generator name. On this example I would not expect a canonical isomorphism from O to P.",
    "created_at": "2012-01-30T11:01:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140028",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140030",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140032",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140033",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140034",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "For the typo in parent.pyx I have added a patch in #12990",
    "created_at": "2012-05-22T18:05:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12097#issuecomment-140035",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12097#event-32769"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12097#event-32770"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12097#event-32771"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12097#event-32772"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12097#event-32773"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12097#event-32774"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12097#event-32775"
}
```
