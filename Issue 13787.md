...
```json
{
    "body": "One very astonishing difference is that without #12313, Hom (or anything else from sage.categories.homset) is not called at all!!! Note that the list without #12313 is complete.\n\nI expected that it would be called once, and then cached. But why is no homset created, even though coercion maps should certainly be involved?",
    "created_at": "2013-01-23T12:11:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171211",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171212",
    "user": "nbruin"
}
```
...
```json
{
    "body": "In fact, you might try running the code in the python debugger and set a breakpoint on `Hom` (I've never done that, but I assume it's possible). The stackframes you're finding there might give you some indication for what the code is trying to construct (and aparently has lost compared to the reference case).",
    "created_at": "2013-01-23T18:38:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171213",
    "user": "nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171214",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171216",
    "user": "nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171217",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "A strange problem is the fact that `__cmp__` is inherited from `CombinatorialClass`, even if I let `Partitions_n` inherit from `UniqueRepresentation`. I have to check why this is the case - if it inherits from `UniqueRepresentation`, then it should inherit *both* `__hash__` and `__cmp__` from it, and not only `__hash__`.",
    "created_at": "2013-01-23T22:21:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171220",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "The following (in which I use `UniqueRepresentation` on Partitions_n) could also benefit from making `UniqueRepresentation` provide a cmp method as well:\n\n```\nsage: P = Partitions(1)\nsage: Q = Partitions(4)\nsage: %timeit P==Q  # this is how they do compare\n625 loops, best of 3: 2.33 \u00b5s per loop\nsage: %timeit P is Q # this is how UniqueRepresentation *should* compare\n625 loops, best of 3: 248 ns per loop\n```\n",
    "created_at": "2013-01-23T22:31:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171222",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Aha! It could actually be the overhead of calling `UniqueRepresentation.__eq__`, which is just a Python method. I see remarks like \"Should be cythoned\" in the code. Perhaps this should really be done, but on a different ticket.",
    "created_at": "2013-01-23T22:55:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171223",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171224",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Attachment [trac13991-UniqueRepresentation_for_partitions.patch](tarball://root/attachments/some-uuid/ticket13991/trac13991-UniqueRepresentation_for_partitions.patch) by SimonKing created at 2013-01-23 22:59:54\n\nI have attached an unfinished patch (if `UniqueRepresentation` is used, then I guess some doctests should be changed from using `==` to using `is`, and perhaps other tests will break).\n\nCan you test whether this patch would completely resolve the regression we are dealing with here?",
    "created_at": "2013-01-23T22:59:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171225",
    "user": "SimonKing"
}
```

Attachment [trac13991-UniqueRepresentation_for_partitions.patch](tarball://root/attachments/some-uuid/ticket13991/trac13991-UniqueRepresentation_for_partitions.patch) by SimonKing created at 2013-01-23 22:59:54
...
```json
{
    "body": "Aha. Cythoning `UniqueRepresentation` makes a lot of sense. Simply renaming `sage/structure/unique_representation.py` into `sage/structure/unique_representation.pyx` and updating module_list.py already yields (with the [attachment:trac13991-UniqueRepresentation_for_partitions.patch experimental patch]:\n\n```\nsage: P = Partitions(1)\nsage: Q = Partitions(4)\nsage: %timeit P==Q\n625 loops, best of 3: 986 ns per loop\n```\n\n\nI guess making `UniqueRepresentation` inherit its methods from a cdef class will improve it further.",
    "created_at": "2013-01-23T23:08:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171226",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171228",
    "user": "nthiery"
}
```
...
```json
{
    "body": "Other than that, a definite +1 on having Partitions_n have UniqueRepresentation and on cythoning UniqueRepresentation.",
    "created_at": "2013-01-24T00:02:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171229",
    "user": "nthiery"
}
```
...
```json
{
    "body": "Andrew Mathas has pointed us to #13605, which turns `Partitions` into unique parents anyway. So, it could be that #13605 fixes our problem, and even if it does not then we should still work on top of it.",
    "created_at": "2013-01-24T06:00:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171230",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "After looking at #13605, I am not sure if it will be fixed any time soon, partially because it depends on another ticket that currently needs work. Hence, as a short term solution, one could consider to finalise the experimental patch from here and make #13605 depend on it.\n\nAnyway, with the experimental patch, the speed regression (or at least the abundance of needless function calls for computing X*X) vanishes, and the only doctest failures are in partitions.py, which can probably easily be fixed.\n\nApply trac13991-UniqueRepresentation_for_partitions.patch",
    "created_at": "2013-01-24T21:13:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171231",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Just as a heads up, (we believe) we are done with #13605.",
    "created_at": "2013-02-22T23:10:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171232",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171233",
    "user": "leif"
}
```
...
```json
{
    "body": "Did you find an example or a method that became particularly slow?",
    "created_at": "2013-03-02T19:54:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171234",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171235",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171236",
    "user": "nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171237",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171238",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171239",
    "user": "nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171240",
    "user": "leif"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171242",
    "user": "leif"
}
```
...
```json
{
    "body": "Attachment [k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt](tarball://root/attachments/some-uuid/ticket13991/k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt) by leif created at 2013-03-03 01:36:53\n\nReplying to [comment:37 leif]:\n> Here are some timings I compiled \"manually\" for the tests marked \"long time\" (just as an example):\n> \n> {{{\n>   0.010s /   0.000s /  0.010s  [01165] dks4 = DualkSchurFunctions(Sym.kBoundedQuotient(Integer(4)))\n>   0.000s /   0.000s /  0.000s  [01166] dks4\n>  30.170s / 498.400s / 66.300s  [01168] TestSuite(dks4).run()  # long time (7s on sage.math, 2013)\n>   0.030s /   0.040s /  0.030s  [01169] dks4 = DualkSchurFunctions(Sym.kBoundedQuotient(Integer(4),t=Integer(1)))\n>  27.770s / 691.890s / 69.460s  [01170] TestSuite(dks4).run()  # long time (7s on sage.math, 2013)\n> \n>   0.020s /   0.040s /  0.010s  [01301] F = AffineSchurFunctions(SymmetricFunctions(QQ['t']).kBoundedQuotient(Integer(4),t=Integer(1)))\n>   0.000s /   0.000s /  0.000s  [01302] F\n>  20.860s / 142.690s / 33.710s  [01304] TestSuite(F).run()  # long time (5s on sage.math, 2013)\n> }}}\n> \n> (Wall time for Sage 5.7.beta4 / 5.8.beta2 / 5.8.beta2+#13605, line number in `k_dual.py`, code executed.  From the second, in whole better run for each installation.)\n\nI've now attached the [attachment:k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2%2B13605.txt full comparison], in case anybody's interested... ;-)",
    "created_at": "2013-03-03T01:36:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171243",
    "user": "leif"
}
```

Attachment [k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt](tarball://root/attachments/some-uuid/ticket13991/k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt) by leif created at 2013-03-03 01:36:53
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171244",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I will (try to) take a look at the symmetric functions code this week and see what we can optimize.",
    "created_at": "2013-03-04T18:22:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171247",
    "user": "tscrim"
}
```
...
```json
{
    "body": "`sage.combinat.partition.Partition.from_kbounded_to_grassmannian` is never seems to be called in `k_dual.py` (at least it is not mentioned in the code or anywhere in the `sf` directory).",
    "created_at": "2013-03-04T19:32:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171249",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171250",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I think it makes sense to change this ticket into a \"task\", and to create separate tickets for several independent aspects/ideas that make sense individually. See #14225 for one of these aspects.",
    "created_at": "2013-03-04T23:10:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171251",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171252",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171253",
    "user": "nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171254",
    "user": "nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171255",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Concerning \"modularity\": At #14225, I do both the `__classcall_private__` thing (which probably has very little influence on the running time) *and* the caching of Weyl groups. Shall I separate the two?",
    "created_at": "2013-03-05T08:29:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171256",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171257",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171259",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171260",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I have created #14228 for the caching.",
    "created_at": "2013-03-05T12:48:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171261",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Sorry for the typo in the ticket number.",
    "created_at": "2013-03-05T12:49:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171262",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171263",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171265",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "positive_review to what?",
    "created_at": "2013-03-06T13:40:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171266",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171267",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13787#issuecomment-171268",
    "user": "jdemeyer"
}
```
