# Issue 5232: [with patch; positive review] interact -- major bug in interact ranges due to str versus repr
...
```json
{
    ...
    "title": "[with patch; positive review] interact -- major bug in interact ranges due to str versus repr",
    "type": "issue",
