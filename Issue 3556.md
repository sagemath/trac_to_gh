# Issue 3556: [with patch, positive review] Bug in IntegerModRing(n) for very large n
...
```json
{
    ...
    "title": "[with patch, positive review] Bug in IntegerModRing(n) for very large n",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3556#issuecomment-25095",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3556#issuecomment-25096",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3556",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3556#event-8145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3556#issuecomment-25097",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
