...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193232"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14812#issuecomment-183631",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14812#issuecomment-183632",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193240"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-193241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14812#issuecomment-183633",
    "user": "https://github.com/jdemeyer"
}
```
