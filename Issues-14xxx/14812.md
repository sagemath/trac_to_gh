...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210527"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210528"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210529"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210530"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14812#issuecomment-181215",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210532"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210533"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14812#issuecomment-181216",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210535"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210536"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14812#event-210537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14812#issuecomment-181217",
    "user": "https://github.com/jdemeyer"
}
```
