...
{
    "assignees": [],
    "body": "This ticket implements factorization into a surjective, birational, and injective toric morphism.\n\n**Apply:**\n1. [attachment: trac_14353_fan_morphism_factoring.patch.gz](https://github.com/sagemath/sage/files/ticket14353/trac_14353_fan_morphism_factoring.patch.gz)\n2. [attachment: trac_14353_auxiliary_methods.patch.gz](https://github.com/sagemath/sage/files/ticket14353/trac_14353_auxiliary_methods.patch.gz)\n3. [attachment: trac_14353_toric_morphism_factoring.patch.gz](https://github.com/sagemath/sage/files/ticket14353/trac_14353_toric_morphism_factoring.patch.gz)\n4. [attachment: trac_14353_toric_morphism_composition.patch.gz](https://github.com/sagemath/sage/files/ticket14353/trac_14353_toric_morphism_composition.patch.gz)\n\nAssignee: **@aghitza**\n\nCC:  @novoselt\n\nKeywords: **toric, sd48**\n\nReviewer: **Andrey Novoseltsev, Volker Braun**\n\nAuthor: **Volker Braun, Andrey Novoseltsev**\n\nMerged: **sage-5.11.beta3**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/14353_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179468"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179482"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14353#issuecomment-174906",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179483"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14353",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14353#event-179484"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14353#issuecomment-174907",
    "user": "https://github.com/jdemeyer"
}
```
