...
```json
{
    "body": "<a id='comment:1'></a>Note that, technically speaking, there are two errors - the overflow issue, and the pointer exception.  Either one could be fixed here, and then a new ticket opened for the other, if necessary.",
    "created_at": "2013-03-30T01:29:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222695",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Note that, technically speaking, there are two errors - the overflow issue, and the pointer exception.  Either one could be fixed here, and then a new ticket opened for the other, if necessary.
...
```json
{
    "body": "<a id='comment:2'></a>We have seen such overflow errors before due to storing an unsigned long into a python int and then trying to put it in a signed long.",
    "created_at": "2013-03-30T02:22:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222696",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:2'></a>We have seen such overflow errors before due to storing an unsigned long into a python int and then trying to put it in a signed long.
...
```json
{
    "body": "<a id='comment:3'></a>> We have seen such overflow errors before due to storing an unsigned long into a python int and then trying to put it in a signed long.\n\nSo you think it could be basically the same type of problem as #14254?  Unfortunately this particular set of errors wasn't fixed by that ticket.",
    "created_at": "2013-03-30T02:24:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222697",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>> We have seen such overflow errors before due to storing an unsigned long into a python int and then trying to put it in a signed long.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222699",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>You might want to use the `signed_id()` function from `sage/structure/coerce_dict.pyx` (see #14254)",
    "created_at": "2013-03-30T03:55:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222700",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>You might want to use the `signed_id()` function from `sage/structure/coerce_dict.pyx` (see #14254)
...
```json
{
    "body": "<a id='comment:7'></a>Or yes, perhaps\n\n```\n    return <Py_hash_t><void*>self\n```\nis even better (and guaranteed to be safe).",
    "created_at": "2013-03-30T03:56:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222701",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Or yes, perhaps
...
```json
{
    "body": "<a id='comment:8'></a>Okay, I'll definitely try this soon.  I noticed that `id` was a problem before, but since #14254 didn't fix this particular one, and I'm still learning about all these C-type (no pun intended) things, I was reluctant to mess about in such dangerous waters.",
    "created_at": "2013-03-30T12:12:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222702",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Okay, I'll definitely try this soon.  I noticed that `id` was a problem before, but since #14254 didn't fix this particular one, and I'm still learning about all these C-type (no pun intended) things, I was reluctant to mess about in such dangerous waters.
...
```json
{
    "body": "<a id='comment:9'></a>Thanks for your help.  I'd love to use this, but I get a compilation error \n\n```\nError compiling Cython file:\n------------------------------------------------------------\n...\n            sage: P = A.g_algebra(relations={y*x:-x*y}, order = 'lex')\n            sage: {P:2}[P]            # indirect doctest\n            2\n\n        \"\"\"\n        return <Py_hash_t><void*>self\n               ^\n------------------------------------------------------------\n\nsage/rings/polynomial/plural.pyx:573:16: 'Py_hash_t' is not a type identifier\nError running command, failed with status 256.\n```\nand apparently this `Py_hash_t` doesn't even show up in the Sage source code!  Or so `search_src` says.",
    "created_at": "2013-03-30T13:32:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222703",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>Thanks for your help.  I'd love to use this, but I get a compilation error 
...
```json
{
    "body": "<a id='comment:10'></a>I cannot reproduce this one on 5.9.beta0 on (64 bits, but this should not really interfere) Windows 7.\nTrying a 32 bits W7 later.",
    "created_at": "2013-03-30T13:38:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222704",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:10'></a>I cannot reproduce this one on 5.9.beta0 on (64 bits, but this should not really interfere) Windows 7.
Trying a 32 bits W7 later.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222705",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222706",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Cygwin is 32 bits only so I don't think the fact that Windows is or not matters.\nAnyway I'll check on a completly 32 bits setup later.",
    "created_at": "2013-03-30T16:24:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222707",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:13'></a>Cygwin is 32 bits only so I don't think the fact that Windows is or not matters.
Anyway I'll check on a completly 32 bits setup later.
...
```json
{
    "body": "<a id='comment:14'></a>Same result with 5.9.beta1 on the completely 32 bits system, I mean no error for me.\n\nKarl-Dieter, I know it will take some time, but could you give sage-5.9.beta* a shot?\n\nAnyway, if the id(self) looks really fishy, we could just relpace it, even if the error disappear in 5.9.",
    "created_at": "2013-03-30T17:42:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222708",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:14'></a>Same result with 5.9.beta1 on the completely 32 bits system, I mean no error for me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222709",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222711",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>The last solution looks ok.",
    "created_at": "2013-03-30T19:29:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222712",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:18'></a>The last solution looks ok.
...
```json
{
    "body": "Attachment [trac_14388.patch](tarball://root/attachments/some-uuid/ticket14388/trac_14388.patch) by jpflori created at 2013-03-30 19:34:54",
    "created_at": "2013-03-30T19:34:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222713",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

Attachment [trac_14388.patch](tarball://root/attachments/some-uuid/ticket14388/trac_14388.patch) by jpflori created at 2013-03-30 19:34:54
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222714",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222715",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222716",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Ah, I see, the header files... I think this works fine, let's get it in.",
    "created_at": "2013-03-30T20:54:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222717",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:20'></a>Ah, I see, the header files... I think this works fine, let's get it in.
...
```json
{
    "body": "Changing author from \"\" to \"Nils Bruin, Jean-Pierre Flori\"",
    "created_at": "2013-03-30T20:54:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222718",
    "user": "https://github.com/kcrisman"
}
```

Changing author from "" to "Nils Bruin, Jean-Pierre Flori"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222719",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222720",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222721",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222722",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222723",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14388#issuecomment-222724",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14388",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14388#event-40839"
}
```
