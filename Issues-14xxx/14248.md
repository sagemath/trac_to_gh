...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177739"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177741"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177742"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177743"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177744"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,6 @@\n Currently all string values are converted to lowercase in global options, so checks are case insensitive. This will add an option to allow case distinctions.\n \n+Apply:\n \n+* [attachment: trac_14249-global_options_case-ts.patch.gz](https://github.com/sagemath/sage/files/ticket14248/trac_14249-global_options_case-ts.patch.gz)\n+\n``````\n",
    "created_at": "2013-04-30T21:59:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14248",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14248#issuecomment-172830",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14248",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14248#event-177746"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14248#issuecomment-172831",
    "user": "https://github.com/jdemeyer"
}
```
