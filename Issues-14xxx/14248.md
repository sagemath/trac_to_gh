...
archive/attachments_019891.json:
```json
{
...
archive/attachments_019892.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_14248-global_options_case-ts.patch](https://github.com/sagemath/sage/files/ticket14248/trac_14248-global_options_case-ts.patch)",
    "created_at": "2013-04-30T21:56:34Z",
    "issue": "https://github.com/sagemath/sage/issues/14248",
    "type": "issue_comment",
