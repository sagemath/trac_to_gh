...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219268",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219269",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>For all the non-Americans out there: \"Entree\" is the name for the main course in `Murrica",
    "created_at": "2013-04-12T09:07:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219270",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>For all the non-Americans out there: "Entree" is the name for the main course in `Murrica
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219271",
...
```json
{
    "body": "<a id='comment:5'></a>I like `case_sensitive=True/False` more! I don't really see the point if *forcing* the user to use either lower or upper case, while forcing/not forcing exact replication of the \"original\" makes sense.\n\nI also think that in automatically generated documentation things should show as entered no matter whether the case is forced or not, i.e. if I have in my code \"English\", it should show in documentation as \"English\" even if we accept \"english\" as well.",
    "created_at": "2013-04-13T05:13:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219272",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:5'></a>I like `case_sensitive=True/False` more! I don't really see the point if *forcing* the user to use either lower or upper case, while forcing/not forcing exact replication of the "original" makes sense.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219274",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Would it be too painful to make \"keep as is\" the default? All of python, and in particular string matching, is normally fully case sensitive. It feels very strange that this is not, even if it might be considered convenient by some.\n\nIn particular, by the time someone is setting options he/she is a stage beyond \"beginner\" and they'll have to look up the name of the option anyway, so I don't think in practice the convenience will really matter.\n\nIn most of python, ambiguity about case is removed by preferring all-lower-case. (I know, singletons `True`, `False`, `None` oddly deviate from that)\n\nIncidentally, the need for options has a code smell to me: I'd start to look for a design flaw if I felt the need to introduce one.",
    "created_at": "2013-04-15T19:41:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219275",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:8'></a>Would it be too painful to make "keep as is" the default? All of python, and in particular string matching, is normally fully case sensitive. It feels very strange that this is not, even if it might be considered convenient by some.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219276",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Here's a new version of the patch which gives the option for case sensitivity as per the discussion.\n\nThe implementation (if anyone cares) is easily extendable to what I was originally suggesting if it is decided to go that route (also this was the easiest way I could think of to do the implementation).",
    "created_at": "2013-04-16T15:35:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219277",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>Here's a new version of the patch which gives the option for case sensitivity as per the discussion.
...
```json
{
    "body": "<a id='comment:11'></a>I notice the patch makes a few of the options of partitions and tableaux  case sensitive but to me it is not obvious why some are and some  aren't. Could you please explain the rationale for this? \n\nCertainly  having some options being case sensitive and others not in a class of  options is potentially confusing...perhaps case sensitivity should apply  to all of the options so that they are either all case sensitive or all not.",
    "created_at": "2013-04-17T22:03:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219278",
    "user": "https://github.com/AndrewAtLarge"
}
```

<a id='comment:11'></a>I notice the patch makes a few of the options of partitions and tableaux  case sensitive but to me it is not obvious why some are and some  aren't. Could you please explain the rationale for this? 
...
```json
{
    "body": "<a id='comment:12'></a>The reason why the options for partitions are not case sensitive is because they are tied to the output (and they don't have a set of possible values). You don't want to be outputting `x`, then try to change it to `X`, but not see a difference. I would expect it to change.\n\nI don't want all options to be case (in)sensitive for this reason.",
    "created_at": "2013-04-17T22:26:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219279",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:12'></a>The reason why the options for partitions are not case sensitive is because they are tied to the output (and they don't have a set of possible values). You don't want to be outputting `x`, then try to change it to `X`, but not see a difference. I would expect it to change.
...
```json
{
    "body": "<a id='comment:13'></a>New patch which fixes output bug in `rigged_partition.py`.",
    "created_at": "2013-04-19T18:42:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219280",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:13'></a>New patch which fixes output bug in `rigged_partition.py`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219281",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Attachment [trac_14248-global_options_case-review--am.patch](tarball://root/attachments/some-uuid/ticket14248/trac_14248-global_options_case-review--am.patch) by @AndrewAtLarge created at 2013-04-30 02:55:39\n\nHi Travis,\n\nI finally got around to reviewing this. The attached review patch, which is also in the queue, fixes number of doc-string problems (most of which predate your patch) and makes case_sensitive into a proper boolean. The patch is also in the combinat queue. \n\nPlease have a look at the review patch. If you're happy with this then I'll make this a positive review.\n\nAndrew",
    "created_at": "2013-04-30T02:55:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219282",
    "user": "https://github.com/AndrewAtLarge"
}
```

<a id='comment:14'></a>Attachment [trac_14248-global_options_case-review--am.patch](tarball://root/attachments/some-uuid/ticket14248/trac_14248-global_options_case-review--am.patch) by @AndrewAtLarge created at 2013-04-30 02:55:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219283",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219284",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219285",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219286",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219287",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219289",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219290",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I'm not able to overwrite files the you've uploaded and wasn't sure if you were going to do it in the review patch or not. Anyways...we're done. Yay!",
    "created_at": "2013-04-30T23:57:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219291",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:19'></a>I'm not able to overwrite files the you've uploaded and wasn't sure if you were going to do it in the review patch or not. Anyways...we're done. Yay!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219293",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14248#event-40292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14248#issuecomment-219294",
    "user": "https://github.com/jdemeyer"
}
```
