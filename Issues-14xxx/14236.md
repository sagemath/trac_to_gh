...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172482",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172483",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172484",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172485",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172486",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [14236_bdist.patch](https://github.com/sagemath/sage/files/ticket14236/14236_bdist.patch) by @jhpalmieri created at 2013-03-06 23:30:55\n\nThis looks good to me. I'll try it out on OpenSolaris just to make sure. By the way, is there a good reason why the symbolic link `data` is not in the root repo?",
    "created_at": "2013-03-06T23:30:55Z",
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172487",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172488",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172489",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14236#issuecomment-172490",
    "user": "https://github.com/jdemeyer"
}
```
