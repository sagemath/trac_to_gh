...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14572#issuecomment-181287",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14572#issuecomment-181288",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14572#event-41505"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I agree (somehow I had missed this e-mail). I'm cc-ing Chris Berg to see if he has an opinion on this.",
    "created_at": "2013-12-29T05:05:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14572#issuecomment-181289",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>I agree (somehow I had missed this e-mail). I'm cc-ing Chris Berg to see if he has an opinion on this.
...
```json
{
    "body": "<a id='comment:4'></a>Oops, I forgot about this ticket. Everything I wanted to do about this is done and merged already in #15327. Sorry for the misdirection.",
    "created_at": "2013-12-29T12:47:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14572#issuecomment-181290",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:4'></a>Oops, I forgot about this ticket. Everything I wanted to do about this is done and merged already in #15327. Sorry for the misdirection.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14572#issuecomment-181291",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14572#issuecomment-181292",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14572#event-41506"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14572#event-41507"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14572",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14572#event-41508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14572#issuecomment-181293",
