...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14881/trac_14881-symmetric_group_algebra-dg.patch",
    "created_at": "2013-07-12T12:59:30Z",
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14881/trac_14881-symmetric_group_algebra-dg.patch",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "Attachment [trac_14881-symmetric_group_algebra-dg.patch](https://github.com/sagemath/sage/files/ticket14881/trac_14881-symmetric_group_algebra-dg.patch) by @darijgr created at 2013-07-12 12:59:30",
    "created_at": "2013-07-12T12:59:30Z",
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184803",
    "user": "https://github.com/darijgr"
}
```

Attachment [trac_14881-symmetric_group_algebra-dg.patch](https://github.com/sagemath/sage/files/ticket14881/trac_14881-symmetric_group_algebra-dg.patch) by @darijgr created at 2013-07-12 12:59:30
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184804",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14881#event-130449"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14881#event-130450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184805",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184806",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184807",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184808",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184809",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -15,3 +15,5 @@\n Second, I have only now noticed that **Sage is using Herstein's idiotic left-to-right convention for the product of permutations as default**! I think the only reason why I have missed this so far is that I haven't been multiplying permutations very often in the first place. That said, I'm not sure about this, and I feel sorry for the conjectures I have been discarding because I thought I was able to produce counterexamples with Sage. Can we do anything about this or at least document it in such a way that it can't be missed? I will open another ticket for this issue once I've done a quick search to see where these multiplications are being used; I wouldn't be surprised if there are bugs lurking in the code just because people expected that Sage would use the same conventions as everyone else in mathematics. I know about GAP, but part of the reason I've been using Sage is to not have to put up with crappy syntax.\n \n When I grep for ``PermutationOptions`` and ``permutation_options``, I only get hits from ``permutation.py`` and ``symmetric_group_algebra.py``, which suggests that all other files are either oblivious to the semantics of a product of permutations depending on a global variable, or they just work around this product method. I'm hoping it's the latter...\n+\n+* Apply: [attachment:trac_14881-symmetric_group_algebra_rebased-dg.patch](https://github.com/sagemath/sage/files/ticket14881/trac_14881-symmetric_group_algebra_rebased-dg.patch)\n``````\n",
    "created_at": "2013-07-12T14:21:20Z",
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184810",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184811",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184812",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184813",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14881#event-130451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184814",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184815",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184816",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184817",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184818",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184819",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184820",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184821",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184822",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14881/trac_14881-symmetric_group_algebra_rebased-dg.patch",
    "created_at": "2013-08-03T12:15:22Z",
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14881/trac_14881-symmetric_group_algebra_rebased-dg.patch",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>\nAttachment [trac_14881-symmetric_group_algebra_rebased-dg.patch](https://github.com/sagemath/sage/files/ticket14881/trac_14881-symmetric_group_algebra_rebased-dg.patch) by @darijgr created at 2013-08-03 12:15:22\n\nAdded the Etingof reference; removed the commented-out old code.",
    "created_at": "2013-08-03T12:15:22Z",
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184823",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184824",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184825",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184826",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14881/trac_14881-review-ts.patch",
    "created_at": "2013-08-09T21:04:54Z",
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14881/trac_14881-review-ts.patch",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>\nAttachment [trac_14881-review-ts.patch](https://github.com/sagemath/sage/files/ticket14881/trac_14881-review-ts.patch) by @tscrim created at 2013-08-09 21:04:54\n\nIt's the (new) python 2.6+ string formatting and will be replacing the `%` at some point in the near python future (in python 3 it is strongly suggested to not use the `%`).\n\nFor patchbot:\n\nApply: trac_14881-symmetric_group_algebra_rebased-dg.patch, trac_14881-review-ts.patch",
    "created_at": "2013-08-09T21:04:54Z",
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184827",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14881#event-130452"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14881#event-130453"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184828",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14881#event-130454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14881#event-130455"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184829",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14881#issuecomment-184830",
    "user": "https://github.com/fchapoton"
}
```
