...
```json
{
    "body": "<a id='comment:2'></a>I see no gain in the (not posted) patches I tried. Even though certain type errors are raised a couple of hundred times, it is still not noticeable if we save \"a couple of hundred times 1ms\" in a computation that takes a couple of seconds.\n\nDo you have a striking example, in which computing a string representation for creating an error message really hurts?",
    "created_at": "2013-05-16T10:45:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14592#issuecomment-181554",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>I see no gain in the (not posted) patches I tried. Even though certain type errors are raised a couple of hundred times, it is still not noticeable if we save "a couple of hundred times 1ms" in a computation that takes a couple of seconds.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14592#issuecomment-181555",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14592#event-41576"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14592#event-41577"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14592#event-41578"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14592#event-41579"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14592#event-41580"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14592#event-41581"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14592#event-41582"
}
```
