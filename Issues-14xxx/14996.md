...
```json
{
    "body": "<a id='comment:15'></a>\nI think this is fine. It tests --long OK in functions/ and builds all docs. The docs look good too. The branch is on top of 6.2.beta2.\n\nAuthor copied from patch header.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|\n|[a6ab7a4](http://git.sagemath.org/sage.git/commit/?id=a6ab7a4bde8b2ebe8e6b51a4fec7ff8828e033e3)|`Trac #14996: Rewriting Jacobi elliptic function code, new numeric evaluation, Jacobi amplitude function`|",
    "created_at": "2014-02-22T16:08:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14996",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nI've fixed the failing doctests and doc did not build, so I fixed that as well. I also did some formatting cleanup of the doc (while I was reading it over trying to find the docbuild issues).\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|\n|[db1980b](http://git.sagemath.org/sage.git/commit/?id=db1980b59587efa6393af2af662eb826461ad0d6)|`Merge branch 'u/rws/ticket/14996' of trac.sagemath.org:sage into u/tscrim/14996`|\n|[6df0d14](http://git.sagemath.org/sage.git/commit/?id=6df0d14c474715ac2565c2a9abea51022fc945dd)|`Fixed doctests and documentation. Additional doc cleanup.`|",
