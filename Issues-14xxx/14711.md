...
```json
{
    "body": "Work_Issues: Provide copy of composed maps",
    "created_at": "2013-10-04T10:36:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
...
```json
{
    "body": "Work_Issues: String repr. of weakened maps; copying/pickling of maps",
...
```json
{
    "body": "Work_Issues: Fix doctests errors after merging master",
...
Work_Issues: Fix doctests errors after merging master
