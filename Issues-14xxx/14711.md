...
```json
{
    "body": "<div id=\"comment:9\" align=\"right\">comment:9</div>\n\nSee [#8335 comment:69](https://github.com/sagemath/sage/issues/8335#comment:69) for another incarnation of this problem but with finite fields.",
...
Replying to [@jpflori](https://github.com/sagemath/sage/issues/14711#comment:0):
> `SchemeMorphism` can not inherit from `Morphism`, because of a bug with
> multiple inheritance of a Python class from Cython extension classes.
