...
```json
{
    "body": "<a id='comment:2'></a>I think at some point I tried to use `UniqueRepresentation` for the quadratic number fields (which would be enough to have a weak cache). However, this turned out to open a can of worms in all the number theory and elliptic curve code, if I recall correctly.",
    "created_at": "2013-06-10T09:58:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230008",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>I think at some point I tried to use `UniqueRepresentation` for the quadratic number fields (which would be enough to have a weak cache). However, this turned out to open a can of worms in all the number theory and elliptic curve code, if I recall correctly.
...
```json
{
    "body": "<a id='comment:3'></a>There is a cache option to the NumberField constructor, maybe I can live with that, not sure it is a good default behavior though.",
    "created_at": "2013-06-10T09:59:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230009",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:3'></a>There is a cache option to the NumberField constructor, maybe I can live with that, not sure it is a good default behavior though.
...
```json
{
    "body": "<a id='comment:4'></a>And trying\n\n```\nQuadraticField(-D, cache=False)\n```\ndoes not solve the problem anyway.",
    "created_at": "2013-06-10T10:04:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230010",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:4'></a>And trying
...
```json
{
    "body": "<a id='comment:5'></a>After a quick look (and apart from _nf_cache and _cyclo_cache in number_field.py), the culprit might be ComplexDoubleField doing too much caching of embeddings.",
    "created_at": "2013-06-10T10:13:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230011",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:5'></a>After a quick look (and apart from _nf_cache and _cyclo_cache in number_field.py), the culprit might be ComplexDoubleField doing too much caching of embeddings.
...
```json
{
    "body": "<a id='comment:6'></a>Indeed, there is a map created at initialization and stored in CDF/RDF's \"_convert_from_list\" which is a Python list so gives in the end a strong ref to the number field.",
    "created_at": "2013-06-10T16:03:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230012",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:6'></a>Indeed, there is a map created at initialization and stored in CDF/RDF's "_convert_from_list" which is a Python list so gives in the end a strong ref to the number field.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230013",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>See http://trac.sagemath.org/sage_trac/ticket/8335#comment:69 for another incarnation of this problem but with finite fields.",
    "created_at": "2013-06-20T17:25:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230015",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:9'></a>See http://trac.sagemath.org/sage_trac/ticket/8335#comment:69 for another incarnation of this problem but with finite fields.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42150"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Bumping Simon as requested.",
    "created_at": "2013-09-24T11:42:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230016",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:11'></a>Bumping Simon as requested.
...
```json
{
    "body": "<a id='comment:13'></a>I always thought of `_coerce_from_list` as a way to store *some* coercions (namely those explicitly registered during `__init__`) permanently, but all other coercions should only be weakly cached, in `_coerce_from_hash`.\n\nAnd I think `_convert_from_list` should have exactly the same r\u00f4le. I suggest to use `_convert_from_list` only in `Parent.register_conversion()` and nowhere else. This would be analogous to how we deal with `_coerce_from_list`.",
    "created_at": "2013-09-28T21:43:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230018",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>I always thought of `_coerce_from_list` as a way to store *some* coercions (namely those explicitly registered during `__init__`) permanently, but all other coercions should only be weakly cached, in `_coerce_from_hash`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230021",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230022",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/SimonKing/ticket/14711\"",
    "created_at": "2013-09-28T22:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230025",
    "user": "https://github.com/simon-king-jena"
}
```

Changing branch from "" to "u/SimonKing/ticket/14711"
...
```json
{
    "body": "<a id='comment:21'></a>Isn't there some tool that is able to show the reference graph? objgraph or so?",
    "created_at": "2013-09-28T22:03:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230026",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:21'></a>Isn't there some tool that is able to show the reference graph? objgraph or so?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230027",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230028",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230029",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230030",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230031",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>I had a similar problem (don't remember the ticket) with actions. I had to create a weak reference to the set that is being acted on. And spontaneously I only see one way to break the reference chain: Have a *weak* reference to the domain of maps.\n\nAnd I doubt that this would be any reasonable. Normally, we do want to be able to access the domain when we have a map. So, how can we protect the domain?",
    "created_at": "2013-09-28T22:31:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230032",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:26'></a>I had a similar problem (don't remember the ticket) with actions. I had to create a weak reference to the set that is being acted on. And spontaneously I only see one way to break the reference chain: Have a *weak* reference to the domain of maps.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230035",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230036",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230038",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230039",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>When we would do as I have suggested (strong reference from Q to phi, weak reference from CDF to phi) then we have of course the problem what happens if Q is immortal and we want to get rid of CDF, because then we have a strong reference from phi to the codomain CDF, keeping CDF alive.\n\nSo, in both approaches we are discussing here, sooner or later have to decide: Do we want that the domain of a coercion/conversion can be removed even if the codomain survives? Or do we want that the codomain of a coercion/conversion can be removed even if the domain survives?\n\nIsn't there any way to achieve both at the same time?",
    "created_at": "2013-09-29T08:17:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230040",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:34'></a>When we would do as I have suggested (strong reference from Q to phi, weak reference from CDF to phi) then we have of course the problem what happens if Q is immortal and we want to get rid of CDF, because then we have a strong reference from phi to the codomain CDF, keeping CDF alive.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230042",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230045",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230046",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230047",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230049",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230052",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:47'></a>Just a random thought about the coerce_to construction using strong references: we really have to make sure to pay attention to things like coercions from ZZ to GF(p) which could make finite fields live forever (once again).",
    "created_at": "2013-10-01T12:17:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230053",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:47'></a>Just a random thought about the coerce_to construction using strong references: we really have to make sure to pay attention to things like coercions from ZZ to GF(p) which could make finite fields live forever (once again).
...
```json
{
    "body": "<a id='comment:48'></a>Concerning a generic copy method for maps: It is of course possible to provide a generic method that takes care of all data in the `__dict__` and all slots common to maps (namels: those of Element plus domain and codomain). Everything else should be done in the subclasses.\n\nThe code I am experimenting with results in some crashes, I am afraid. Hopefully I will be able to fix this.",
    "created_at": "2013-10-01T13:43:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230054",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:48'></a>Concerning a generic copy method for maps: It is of course possible to provide a generic method that takes care of all data in the `__dict__` and all slots common to maps (namels: those of Element plus domain and codomain). Everything else should be done in the subclasses.
...
```json
{
    "body": "<a id='comment:49'></a>Example of a crash:\n\n```\nsage: s = ModularSymbols(11).2.modular_symbol_rep()[0][1]; s                                        \n{-1/9, 0}\nsage: loads(dumps(s)) == s\nTrue\nsage: s = ModularSymbols(11).2.modular_symbol_rep()[0][1]\n<BOOOM>\n```",
    "created_at": "2013-10-01T13:46:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230055",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:49'></a>Example of a crash:
...
```json
{
    "body": "<a id='comment:51'></a>Sorry, reduction is not to blame. Doing a garbage collection after the first line and then repeating the first line reproduces the crash. Hence, some parent is not correctly kept alive. Anyway, you can't see it, since I didn't post the code yet...",
    "created_at": "2013-10-01T14:13:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230057",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:51'></a>Sorry, reduction is not to blame. Doing a garbage collection after the first line and then repeating the first line reproduces the crash. Hence, some parent is not correctly kept alive. Anyway, you can't see it, since I didn't post the code yet...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230059",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230060",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230061",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230062",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:57'></a>I just found something crazy: Apparently the rational field got garbage collected in one of the crashing examples. Hard to believe. But it is in something using modular symbols, which is very old code, predating the unique parent paradigma. So, could be that it calls the constructor of the rational field, rather than a factory or whatever makes the rational field unique.",
    "created_at": "2013-10-01T20:58:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230063",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:57'></a>I just found something crazy: Apparently the rational field got garbage collected in one of the crashing examples. Hard to believe. But it is in something using modular symbols, which is very old code, predating the unique parent paradigma. So, could be that it calls the constructor of the rational field, rather than a factory or whatever makes the rational field unique.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230064",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:59'></a>Perhaps it would be a good idea to change `RationalField` to use `ClasscallMetaclass`, but of course on a new ticket. Anyway, it is not related to the problem here.",
    "created_at": "2013-10-01T21:22:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230065",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:59'></a>Perhaps it would be a good idea to change `RationalField` to use `ClasscallMetaclass`, but of course on a new ticket. Anyway, it is not related to the problem here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230066",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:65'></a>The proposed change does in fact fix the problem mentioned in comment:63",
    "created_at": "2013-10-03T11:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230071",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:65'></a>The proposed change does in fact fix the problem mentioned in comment:63
...
```json
{
    "body": "<a id='comment:66'></a>I have pushed the new commit. The example from comment:63 became a doctest.\n\nI am now running make ptest. Let us see how many problems persist. Depending on the result, we may worry later whether or not we want to add a safe user interface to the coercion system.",
    "created_at": "2013-10-03T11:36:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230072",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:66'></a>I have pushed the new commit. The example from comment:63 became a doctest.
...
```json
{
    "body": "<a id='comment:72'></a>I can confirm that with a strong reference to the codomain, the leak is still fixed. Now trying to see if it also prevents some of the crashes I've seen in the tests!",
    "created_at": "2013-10-03T19:40:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230078",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:72'></a>I can confirm that with a strong reference to the codomain, the leak is still fixed. Now trying to see if it also prevents some of the crashes I've seen in the tests!
...
```json
{
    "body": "<a id='comment:73'></a>Outch. Sage started, but the first four tests I've run have segfaulted. Very bad. How can that be?",
    "created_at": "2013-10-03T19:44:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230079",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:73'></a>Outch. Sage started, but the first four tests I've run have segfaulted. Very bad. How can that be?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230080",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230081",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:76'></a>I am now back at trying to trace down the errors mentioned in comment:68. Frustratingly, with my current local branch (not yet posted), I can not reproduce all the errors, even though the code during comment:68 looked nearly the same.",
    "created_at": "2013-10-03T21:46:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230082",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:76'></a>I am now back at trying to trace down the errors mentioned in comment:68. Frustratingly, with my current local branch (not yet posted), I can not reproduce all the errors, even though the code during comment:68 looked nearly the same.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230084",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:80'></a>PS: But why does it not crash if the coerce maps' codomains get weakref'd too?",
    "created_at": "2013-10-03T22:12:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230086",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:80'></a>PS: But why does it not crash if the coerce maps' codomains get weakref'd too?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230089",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230091",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230092",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Provide copy of composed maps\"",
    "created_at": "2013-10-04T10:36:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230094",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Provide copy of composed maps"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230096",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:88'></a>Too bad. Apparently the elliptic curve code does not like `SchemeMorphism` to be a `Morphism`...",
    "created_at": "2013-10-04T11:03:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230097",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:88'></a>Too bad. Apparently the elliptic curve code does not like `SchemeMorphism` to be a `Morphism`...
...
```json
{
    "body": "Changing work_issues from \"Provide copy of composed maps\" to \"Fix elliptic curves code\"",
    "created_at": "2013-10-04T11:03:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230098",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "Provide copy of composed maps" to "Fix elliptic curves code"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230099",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:89'></a>Namely:\n\n```\nsage: E=EllipticCurve('37a1')\nsage: P=E(0,0)\nsage: Q=5*P\n<Booom>\n```\napparently while trying to create an action.",
    "created_at": "2013-10-04T11:07:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230100",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:89'></a>Namely:
...
```json
{
    "body": "<a id='comment:91'></a>In `sage.schemes.elliptic_curves.heegner`, it also seems to me that `GaloisAutomorphism` should use `Morphism`. I don't know if I will change it here.",
    "created_at": "2013-10-04T12:40:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230102",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:91'></a>In `sage.schemes.elliptic_curves.heegner`, it also seems to me that `GaloisAutomorphism` should use `Morphism`. I don't know if I will change it here.
...
```json
{
    "body": "<a id='comment:92'></a>Hmm. If we are in very bad luck, then the current commit triggers a bug in Cython concerning confusion of different cpdef slots when one provides two different base classes (`ModuleElement` and `Morphism`). Namely, it pretty much seems that\n\n```\n   (<ModuleElement>left)._add_(<ModuleElement>right)\n```\ndoes not return\n\n```\n   left._add_(right)\n```",
    "created_at": "2013-10-04T12:59:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230103",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:92'></a>Hmm. If we are in very bad luck, then the current commit triggers a bug in Cython concerning confusion of different cpdef slots when one provides two different base classes (`ModuleElement` and `Morphism`). Namely, it pretty much seems that
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230105",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:94'></a>By the way, I was looking into my logs/ptest.log, and it seems that the total cpu time for the tests remained essentially the same. Hence, hopefully there is no bad slow-down. But we should probably take some old benchmarks used at, say, #11900, and see what my new commits do with them.",
    "created_at": "2013-10-04T19:32:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230106",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:94'></a>By the way, I was looking into my logs/ptest.log, and it seems that the total cpu time for the tests remained essentially the same. Hence, hopefully there is no bad slow-down. But we should probably take some old benchmarks used at, say, #11900, and see what my new commits do with them.
...
```json
{
    "body": "<a id='comment:97'></a>Congratulations on making such good headway! The main thing left is to determine how weakly referenced the coercion framework needs to be.",
    "created_at": "2013-10-05T00:39:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230109",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:97'></a>Congratulations on making such good headway! The main thing left is to determine how weakly referenced the coercion framework needs to be.
...
```json
{
    "body": "Changing commit from \"\" to \"05fb569cb132a8c89713021f1f4b25cd2dd7cb1c\"",
    "created_at": "2013-10-05T09:13:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230110",
    "user": "https://github.com/simon-king-jena"
}
```

Changing commit from "" to "05fb569cb132a8c89713021f1f4b25cd2dd7cb1c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230111",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"Fix elliptic curves code\" to \"\"",
    "created_at": "2013-10-05T12:28:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230114",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "Fix elliptic curves code" to ""
...
```json
{
    "body": "<a id='comment:2'></a>And I think I should do a further test: I will modify `Parent.__init__` so that it prints the type of self to a log file, and so I'll see how many parents are created with and without the patch. If we see a sudden change in the statistics for some types, then it might point us to code that implicitly relies on a permanent cache.",
    "created_at": "2013-10-05T12:45:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230115",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>And I think I should do a further test: I will modify `Parent.__init__` so that it prints the type of self to a log file, and so I'll see how many parents are created with and without the patch. If we see a sudden change in the statistics for some types, then it might point us to code that implicitly relies on a permanent cache.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230118",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>With vanilla public/sage-git/master, I find that `sage -t --all` results in 1083022 calls to `Parent.__init__`, while with the branch from here it is called 1129534 times.\n\nHence, there *is* an increase in the number of parents being created. No surprise, since this ticket is about making parents garbage collectable in some situations.\n\nNevertheless, it might make sense to see whether some types of parents show a particularly strong increase, so that we can then decide whether we should have some stronger cache for these types.",
    "created_at": "2013-10-05T19:38:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230119",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>With vanilla public/sage-git/master, I find that `sage -t --all` results in 1083022 calls to `Parent.__init__`, while with the branch from here it is called 1129534 times.
...
```json
{
    "body": "<a id='comment:8'></a>Concerning a new method `install_coercion`: Wouldn't it be easier to provide `register_coercion` with an optional argument `permanent=True`, so that using the method with `permanent=False` would do what you suggested for `install_coercion`? I guess having two methods `install_coercion` and `register_coercion` could confuse the user.",
    "created_at": "2013-10-05T20:45:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230121",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>Concerning a new method `install_coercion`: Wouldn't it be easier to provide `register_coercion` with an optional argument `permanent=True`, so that using the method with `permanent=False` would do what you suggested for `install_coercion`? I guess having two methods `install_coercion` and `register_coercion` could confuse the user.
...
```json
{
    "body": "<a id='comment:9'></a>Concerning documentation: I just found that the underscore methods of `sage.structure.parent.Parent` are documented in the reference manual. Hence it should be no problem to add documentation of `_coerce_map_from_` directly in-place.",
    "created_at": "2013-10-06T15:08:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230122",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>Concerning documentation: I just found that the underscore methods of `sage.structure.parent.Parent` are documented in the reference manual. Hence it should be no problem to add documentation of `_coerce_map_from_` directly in-place.
...
```json
{
    "body": "<a id='comment:0'></a>And I just notice that the documentation of the module `sage.structure.parent` starts with a \"simple example of registering coercions\", which I find rather obscure and which does things in a way that we would do differently today. E.g., it does not initialise the category, but overrides the method `category()`. And it calls `self._populate_coercion_lists_()`, which I have never seen in code created in the past few years.\n\nHence, I'll update this example.",
    "created_at": "2013-10-06T15:17:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230123",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:0'></a>And I just notice that the documentation of the module `sage.structure.parent` starts with a "simple example of registering coercions", which I find rather obscure and which does things in a way that we would do differently today. E.g., it does not initialise the category, but overrides the method `category()`. And it calls `self._populate_coercion_lists_()`, which I have never seen in code created in the past few years.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230124",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230125",
...
```json
{
    "body": "Changing commit from \"05fb569cb132a8c89713021f1f4b25cd2dd7cb1c\" to \"452d21629d4531d8e117e869b65bac0ab350c1ee\"",
    "created_at": "2013-10-06T16:29:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230126",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "05fb569cb132a8c89713021f1f4b25cd2dd7cb1c" to "452d21629d4531d8e117e869b65bac0ab350c1ee"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230127",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing commit from \"452d21629d4531d8e117e869b65bac0ab350c1ee\" to \"5168cfd15d4cdbaa3ffdbd4be0f7d783f77257c7\"",
    "created_at": "2013-10-06T18:17:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230128",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "452d21629d4531d8e117e869b65bac0ab350c1ee" to "5168cfd15d4cdbaa3ffdbd4be0f7d783f77257c7"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230129",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:116'></a>Replying to [comment:107 SimonKing]:\n> Even though the absolute differences in the creation of various kinds of homsets seem to be dramatic, the relative differences suggest that there is no serious problem here. There are only four classes that show an increase of at least 1%. Three of them are related with tableaux, that's why I add Nicolas to the ticket: Perhaps we want to change the cache for tableaux?\n\n\nCould you post a quick summary (say in the ticket description/title)\nof what the current patch does?\n\nThanks!",
    "created_at": "2013-10-06T20:17:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230131",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:116'></a>Replying to [comment:107 SimonKing]:
> Even though the absolute differences in the creation of various kinds of homsets seem to be dramatic, the relative differences suggest that there is no serious problem here. There are only four classes that show an increase of at least 1%. Three of them are related with tableaux, that's why I add Nicolas to the ticket: Perhaps we want to change the cache for tableaux?
...
```json
{
    "body": "<a id='comment:117'></a>Replying to [comment:116 nthiery]:\n> Could you post a quick summary (say in the ticket description/title)\n> of what the current patch does?\n\n\nDone. OK, the summary is actually not quick. Sorry.",
    "created_at": "2013-10-06T21:30:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230133",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:117'></a>Replying to [comment:116 nthiery]:
> Could you post a quick summary (say in the ticket description/title)
> of what the current patch does?
...
```json
{
    "body": "Changing work_issues from \"\" to \"String repr. of weakened maps; copying/pickling of maps\"",
    "created_at": "2013-10-07T11:25:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230134",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "String repr. of weakened maps; copying/pickling of maps"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230136",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230137",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I wonder: Would it make sense to implement a generic comparison for maps, based on the dictionary returned by `self._extra_slots({})`? Namely, these data are used for pickling and copying of maps, and thus it seems reasonable to me that two maps are equal if and only if the pickling data coincide.\n\nWhat do you think? Worth trying? Better be done on a different ticket?",
    "created_at": "2013-10-07T15:26:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230138",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>I wonder: Would it make sense to implement a generic comparison for maps, based on the dictionary returned by `self._extra_slots({})`? Namely, these data are used for pickling and copying of maps, and thus it seems reasonable to me that two maps are equal if and only if the pickling data coincide.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230141",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230142",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"5168cfd15d4cdbaa3ffdbd4be0f7d783f77257c7\" to \"364b9856b28d7060e3ea9825144de66c8f11ca2a\"",
    "created_at": "2013-10-07T20:47:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230143",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "5168cfd15d4cdbaa3ffdbd4be0f7d783f77257c7" to "364b9856b28d7060e3ea9825144de66c8f11ca2a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230145",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"String repr. of weakened maps; copying/pickling of maps\" to \"\"",
    "created_at": "2013-10-07T21:54:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230146",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "String repr. of weakened maps; copying/pickling of maps" to ""
...
```json
{
    "body": "<a id='comment:5'></a>With the new commit I have pushed today, all doctest should pass.",
    "created_at": "2013-10-07T21:54:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230147",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>With the new commit I have pushed today, all doctest should pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230148",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>PS: Since teaching will start next week for me, I will probably not be able to fix the leak from comment:124, even if you succeed to convince me that it *really* is a leak. So, I guess it is safe to start reviewing the attached branch, I think it will not change in the next few days...",
    "created_at": "2013-10-08T14:28:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230150",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>PS: Since teaching will start next week for me, I will probably not be able to fix the leak from comment:124, even if you succeed to convince me that it *really* is a leak. So, I guess it is safe to start reviewing the attached branch, I think it will not change in the next few days...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230152",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230153",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230156",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230159",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:137'></a>Replying to [comment:135 SimonKing]:\n> Replying to [comment:134 nbruin]:\n> > {{{\n> > A.register_coercion(BtoA)\n> > A.register_embedding(AtoC)\n> > \n> > C.coerce_map_from(A) #finds the right map\n> > A.coerce_map_from(B) #finds the right map\n> > C.coerce_map_from(B) #returns none!\n> > }}}\n\n> \n> *IF* this is a bug then it should be dealt with on a new ticket.\n\nThis is now #15303.",
    "created_at": "2013-10-17T22:08:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230160",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:137'></a>Replying to [comment:135 SimonKing]:
> Replying to [comment:134 nbruin]:
> > {{{
> > A.register_coercion(BtoA)
> > A.register_embedding(AtoC)
...
```json
{
    "body": "<a id='comment:8'></a>Any info what exactly slowed down the tableaux classes?",
    "created_at": "2013-11-15T03:27:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230161",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:8'></a>Any info what exactly slowed down the tableaux classes?
...
```json
{
    "body": "Changing commit from \"364b9856b28d7060e3ea9825144de66c8f11ca2a\" to \"23f18f23c38b104364ba499b4d4db8683480b895\"",
    "created_at": "2013-11-16T16:37:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230162",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "364b9856b28d7060e3ea9825144de66c8f11ca2a" to "23f18f23c38b104364ba499b4d4db8683480b895"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230163",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I'm not blaming your branch for slowing down tableaux! Actually, tableaux are probably doing a good job at slowing down themselves, and there's been a plan for quite a while now to rewrite their class hierarchy from scratch. But I want to know what exactly it is that causes these slowdowns in tableaux but nowhere else (kind of); that would probably an antipattern we should try to avoid.\n\nAre there good ways of finding out\n\n1) what causes the slowdown, and\n\n2) how the branches compare on more realistic measurements rather than doctests (say, by dropping the cache between every doctest and the next one?)?",
    "created_at": "2013-11-17T00:21:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230165",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:1'></a>I'm not blaming your branch for slowing down tableaux! Actually, tableaux are probably doing a good job at slowing down themselves, and there's been a plan for quite a while now to rewrite their class hierarchy from scratch. But I want to know what exactly it is that causes these slowdowns in tableaux but nowhere else (kind of); that would probably an antipattern we should try to avoid.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42151"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42152"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Can't get this thing to compile:\n\n```\ndarij@travis-virtualbox:~/gitsage/sage-5.13.beta1$ make build\ncd build && \\\n\t\"../build/pipestatus\" \\\n\t\t\"env SAGE_PARALLEL_SPKG_BUILD='' ./install all 2>&1\" \\\n\t\t\"tee -a ../logs/install.log\"\n```\nIt seems to hang at this place...",
    "created_at": "2013-11-30T06:39:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230166",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:3'></a>Can't get this thing to compile:
...
```json
{
    "body": "Changing work_issues from \"\" to \"Fix doctests errors after merging master\"",
    "created_at": "2013-11-30T19:58:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230168",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Fix doctests errors after merging master"
...
```json
{
    "body": "<a id='comment:5'></a>Some errors have emerged, at qsym.py, for example.",
    "created_at": "2013-11-30T19:58:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230169",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Some errors have emerged, at qsym.py, for example.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230170",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"23f18f23c38b104364ba499b4d4db8683480b895\" to \"d68c5df4618cc4fcf8ef215ee6b2f475be028209\"",
    "created_at": "2013-11-30T20:10:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230171",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "23f18f23c38b104364ba499b4d4db8683480b895" to "d68c5df4618cc4fcf8ef215ee6b2f475be028209"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230173",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I found how Gr\u00f6bner basis computation comes into play: When calling a scheme morphism, a scheme is called, which involves for some map `S` to test `S.codomain() == self`. This comparison involves comparing ideals, and this means one needs to compute a Gr\u00f6bner basis.\n\nI only wonder why this comparison does not happen with strong maps. Also I need to study why the comparison is not by identity.",
    "created_at": "2013-12-01T13:08:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230174",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>I found how Gröbner basis computation comes into play: When calling a scheme morphism, a scheme is called, which involves for some map `S` to test `S.codomain() == self`. This comparison involves comparing ideals, and this means one needs to compute a Gröbner basis.
...
```json
{
    "body": "<a id='comment:9'></a>Aha! It does not come from the weak maps, but it comes from the fact that my branch also changes the `__call__` method of scheme morphisms (namely copying what happens in sage.categories.map`). So, this could be the problem.",
    "created_at": "2013-12-01T13:12:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230175",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>Aha! It does not come from the weak maps, but it comes from the fact that my branch also changes the `__call__` method of scheme morphisms (namely copying what happens in sage.categories.map`). So, this could be the problem.
...
```json
{
    "body": "<a id='comment:0'></a>I will fix it, but this also means that conversion between different schemes will be more permissive. But I think this is consistent with the rest of Sage: Conversions are just supposed to somehow make sense of the input, whereas only coercions have to satisfy certain axioms.",
    "created_at": "2013-12-01T15:37:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230176",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:0'></a>I will fix it, but this also means that conversion between different schemes will be more permissive. But I think this is consistent with the rest of Sage: Conversions are just supposed to somehow make sense of the input, whereas only coercions have to satisfy certain axioms.
...
```json
{
    "body": "<a id='comment:1'></a>Too bad. We *have* to have `check=True` by default (that's convention in Sage). And since schemes are no unique parents, comparison of schemes will generally involve Gr\u00f6bner basis computations.\n\nI only hope that in this particular application we *know* that we are dealing with good input and thus can set `check=False`.",
    "created_at": "2013-12-01T18:11:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230177",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>Too bad. We *have* to have `check=True` by default (that's convention in Sage). And since schemes are no unique parents, comparison of schemes will generally involve Gröbner basis computations.
...
```json
{
    "body": "Changing commit from \"d68c5df4618cc4fcf8ef215ee6b2f475be028209\" to \"ee30c20b0adc9878a13c8286c96ee5e972e2b002\"",
    "created_at": "2013-12-01T18:37:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230178",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d68c5df4618cc4fcf8ef215ee6b2f475be028209" to "ee30c20b0adc9878a13c8286c96ee5e972e2b002"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230179",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>With the new commit, all tests in sage.schemes pass. I guess this means \"needs review\" again!",
    "created_at": "2013-12-01T18:48:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230180",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>With the new commit, all tests in sage.schemes pass. I guess this means "needs review" again!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230181",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"Fix doctests errors after merging master\" to \"\"",
    "created_at": "2013-12-01T18:48:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230182",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "Fix doctests errors after merging master" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230185",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42153"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42154"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The current `master` seems to merge cleanly (I didn't test `develop`, though). What is the policy (Volker?): Is it enough to review a ticket after merging with the current master branch? Or has the reviewer to take into account the develop branch, too?",
    "created_at": "2013-12-21T13:21:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230187",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>The current `master` seems to merge cleanly (I didn't test `develop`, though). What is the policy (Volker?): Is it enough to review a ticket after merging with the current master branch? Or has the reviewer to take into account the develop branch, too?
...
```json
{
    "body": "<a id='comment:0'></a>All tests pass after merging master. But there is a conflict with #12217 (in the develop branch). I am now testing the merge I just did, and will push the resulting branch in case of success.",
    "created_at": "2013-12-21T15:11:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230188",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:0'></a>All tests pass after merging master. But there is a conflict with #12217 (in the develop branch). I am now testing the merge I just did, and will push the resulting branch in case of success.
...
```json
{
    "body": "Changing commit from \"ee30c20b0adc9878a13c8286c96ee5e972e2b002\" to \"37bf59eac24eda1ece89aff7dde4a1db5d0cbb5c\"",
    "created_at": "2013-12-21T16:30:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230190",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "ee30c20b0adc9878a13c8286c96ee5e972e2b002" to "37bf59eac24eda1ece89aff7dde4a1db5d0cbb5c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230191",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:164'></a>Replying to [comment:158 mmezzarobba]:\n> It looks like there has already been plenty of discussion about this branch, and stupid merge conflicts with `develop` accumulate while it is waiting for review. Could someone please clarify which parts of the changes still need review?\n\n\nActually I don't know. Nils?",
    "created_at": "2013-12-28T09:19:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230193",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:164'></a>Replying to [comment:158 mmezzarobba]:
> It looks like there has already been plenty of discussion about this branch, and stupid merge conflicts with `develop` accumulate while it is waiting for review. Could someone please clarify which parts of the changes still need review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230194",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230196",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230199",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "Changing branch from \"u/SimonKing/ticket/14711\" to \"u/jpflori/ticket/14711\"",
    "created_at": "2013-12-30T15:03:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230200",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

Changing branch from "u/SimonKing/ticket/14711" to "u/jpflori/ticket/14711"
...
```json
{
    "body": "Changing commit from \"37bf59eac24eda1ece89aff7dde4a1db5d0cbb5c\" to \"0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca\"",
    "created_at": "2013-12-30T15:03:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230201",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

Changing commit from "37bf59eac24eda1ece89aff7dde4a1db5d0cbb5c" to "0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca"
...
```json
{
    "body": "<a id='comment:0'></a>FYI, this passes all tests when merged against 6.1.beta2.",
    "created_at": "2013-12-30T15:45:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230202",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:0'></a>FYI, this passes all tests when merged against 6.1.beta2.
...
```json
{
    "body": "<a id='comment:5'></a>PS: The review commit looks ok to me. I only wonder: Should a doc string ending with a test also end with a blank line? I thought that the usual thing to do in Sage (but not official standard) is this\n\n```python\ndef f1(...):\n    \"\"\"\n    This is some doc\n\n    EXAMPLES::\n\n        sage: ...\n        ...\n\n    The doc ends with normal text and hence without blank line\n    \"\"\"\n    return None\n```\nbut\n\n```python\ndef f2(...):\n    \"\"\"\n    Some doc\n\n    EXAMPLES::\n\n        sage: ...\n\n    There is a concluding example, and after the example is\n    a blank line::\n\n        sage: ...\n        ,,,\n\n    \"\"\"\n    return None\n```\nSo, I wonder if it is needed that the review commit removes trailing blank lines. On the other hand, I don't mind if they'll be removed.",
    "created_at": "2013-12-30T23:32:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230207",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>PS: The review commit looks ok to me. I only wonder: Should a doc string ending with a test also end with a blank line? I thought that the usual thing to do in Sage (but not official standard) is this
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230209",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230214",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Please also remove the \"...\" which were added previously to filter the warnings.\nI think of at least two of them in the combinat dir, maybe Simon remember more of them.",
    "created_at": "2014-01-02T21:28:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230215",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:3'></a>Please also remove the "..." which were added previously to filter the warnings.
I think of at least two of them in the combinat dir, maybe Simon remember more of them.
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42155"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42156"
}
```
...
```json
{
    "body": "Changing commit from \"0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca\" to \"6b233b52b8932cbe3a3f6ff9dabb0e5b5615b7e2\"",
    "created_at": "2014-02-25T09:21:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230218",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca" to "6b233b52b8932cbe3a3f6ff9dabb0e5b5615b7e2"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230219",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>First step toward rebasing.\nLots of work still needed, especially for p-adic stuff (at the very least).",
    "created_at": "2014-02-25T09:21:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230220",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:8'></a>First step toward rebasing.
Lots of work still needed, especially for p-adic stuff (at the very least).
...
```json
{
    "body": "Changing commit from \"6b233b52b8932cbe3a3f6ff9dabb0e5b5615b7e2\" to \"7d7f7ae03d3fd16e630c69fa863f9ce8e1ac01e3\"",
    "created_at": "2014-02-25T11:07:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230221",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6b233b52b8932cbe3a3f6ff9dabb0e5b5615b7e2" to "7d7f7ae03d3fd16e630c69fa863f9ce8e1ac01e3"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230222",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:0'></a>Some maps created for p-adics seem to get automatically gc'ed and make some doctests fail.",
    "created_at": "2014-02-25T11:10:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230223",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:0'></a>Some maps created for p-adics seem to get automatically gc'ed and make some doctests fail.
...
```json
{
    "body": "<a id='comment:2'></a>Is your branch based off the one I was working on?",
    "created_at": "2014-02-25T16:42:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230225",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>Is your branch based off the one I was working on?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230226",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"7d7f7ae03d3fd16e630c69fa863f9ce8e1ac01e3\" to \"d0c26b94039540688eb35e985ebd7b558cec62b1\"",
    "created_at": "2014-02-25T16:50:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230227",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "7d7f7ae03d3fd16e630c69fa863f9ce8e1ac01e3" to "d0c26b94039540688eb35e985ebd7b558cec62b1"
...
```json
{
    "body": "<a id='comment:4'></a>Ok, my bad, I wrongly resolved a commit in number_field.py the first time.",
    "created_at": "2014-02-25T17:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230228",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:4'></a>Ok, my bad, I wrongly resolved a commit in number_field.py the first time.
...
```json
{
    "body": "<a id='comment:195'></a>Replying to [comment:192 tscrim]:\n> Is your branch based off the one I was working on?\n\nYes it is.",
    "created_at": "2014-02-25T17:06:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230229",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:195'></a>Replying to [comment:192 tscrim]:
> Is your branch based off the one I was working on?
...
```json
{
    "body": "<a id='comment:6'></a>It seems plausible that a bunch of errors and segaults are caused by the fact that some calls to `copy` were discarded in the construction of \"conversion maps\" or something in that spirit.\n\nFor sure something similar to what was done whit `_internal_coerce...` should be done for `convert_map...`.",
    "created_at": "2014-02-25T17:21:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230230",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:6'></a>It seems plausible that a bunch of errors and segaults are caused by the fact that some calls to `copy` were discarded in the construction of "conversion maps" or something in that spirit.
...
```json
{
    "body": "<a id='comment:7'></a>Disregard my last comment, it seems I've forgotten to rebuild some files while switching between different branches...",
    "created_at": "2014-02-26T10:24:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230231",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:7'></a>Disregard my last comment, it seems I've forgotten to rebuild some files while switching between different branches...
...
```json
{
    "body": "<a id='comment:8'></a>One of the \"new\" problems when testing number_field.py seems to be that\n\n```\ndef _lift_cyclotomic_element(self, new_parent, bint check=True, int rel=0)\n```\nis called with rel of non-int type.\nThe call stems from number_field_morphism.py:\n\n```\nx._lift_cyclotomic_element(self.codomain(), False, self.ratio)\n```",
    "created_at": "2014-02-26T10:44:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230232",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:8'></a>One of the "new" problems when testing number_field.py seems to be that
...
```json
{
    "body": "<a id='comment:0'></a>Ok, it seems ratio is `None`.",
    "created_at": "2014-02-26T11:02:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230234",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:0'></a>Ok, it seems ratio is `None`.
...
```json
{
    "body": "<a id='comment:1'></a>I guess some update_slots magic has to be used to copy ratio for cyclotomic field morphims.",
    "created_at": "2014-02-26T11:09:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230235",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:1'></a>I guess some update_slots magic has to be used to copy ratio for cyclotomic field morphims.
...
```json
{
    "body": "<a id='comment:2'></a>It might also be worth checking why this used to work and where these new (defunct) copies occur.",
    "created_at": "2014-02-26T12:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230236",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:2'></a>It might also be worth checking why this used to work and where these new (defunct) copies occur.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230237",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"d0c26b94039540688eb35e985ebd7b558cec62b1\" to \"b21179f6631af835d01ed1f7f250bb2ac4c12f2b\"",
    "created_at": "2014-02-26T12:22:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230238",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d0c26b94039540688eb35e985ebd7b558cec62b1" to "b21179f6631af835d01ed1f7f250bb2ac4c12f2b"
...
```json
{
    "body": "<a id='comment:204'></a>Replying to [comment:196 jpflori]:\n> For sure something similar to what was done whit `_internal_coerce...` should be done for `convert_map...`.\n> \n\nThis should still be done. See for example `src/sage/rings/polynomial/polynomial_element.pyx`.",
    "created_at": "2014-02-26T12:34:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230239",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:204'></a>Replying to [comment:196 jpflori]:
> For sure something similar to what was done whit `_internal_coerce...` should be done for `convert_map...`.
> 
...
```json
{
    "body": "Changing commit from \"b21179f6631af835d01ed1f7f250bb2ac4c12f2b\" to \"6b2b2e51ea475059605450d14fb657496e7f7c78\"",
    "created_at": "2014-02-26T12:54:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230240",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b21179f6631af835d01ed1f7f250bb2ac4c12f2b" to "6b2b2e51ea475059605450d14fb657496e7f7c78"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230241",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"6b2b2e51ea475059605450d14fb657496e7f7c78\" to \"1cf51a4ce58fcc8620ac4158361567e73e7df9c5\"",
    "created_at": "2014-02-26T15:44:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230242",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6b2b2e51ea475059605450d14fb657496e7f7c78" to "1cf51a4ce58fcc8620ac4158361567e73e7df9c5"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230243",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230245",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"blankline, gc\"",
    "created_at": "2014-02-26T15:59:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230246",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

Changing work_issues from "" to "blankline, gc"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230247",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230248",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230249",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"1cf51a4ce58fcc8620ac4158361567e73e7df9c5\" to \"f5827666b700d3b8d245b20d2346c7110bd0c21d\"",
    "created_at": "2014-02-26T16:07:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230250",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "1cf51a4ce58fcc8620ac4158361567e73e7df9c5" to "f5827666b700d3b8d245b20d2346c7110bd0c21d"
...
```json
{
    "body": "Changing work_issues from \"blankline, gc\" to \"blankline\"",
    "created_at": "2014-02-26T16:08:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230251",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

Changing work_issues from "blankline, gc" to "blankline"
...
```json
{
    "body": "<a id='comment:9'></a>The padic issue was caused by a wrong doctest.\nFixed now.",
    "created_at": "2014-02-26T16:08:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230252",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:9'></a>The padic issue was caused by a wrong doctest.
Fixed now.
...
```json
{
    "body": "Changing commit from \"f5827666b700d3b8d245b20d2346c7110bd0c21d\" to \"c9cd7a46c1338b7e452ea8f4e5e26d189f43ddb8\"",
    "created_at": "2014-02-26T16:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230253",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "f5827666b700d3b8d245b20d2346c7110bd0c21d" to "c9cd7a46c1338b7e452ea8f4e5e26d189f43ddb8"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230254",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230256",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"c9cd7a46c1338b7e452ea8f4e5e26d189f43ddb8\" to \"4e4bdbb4abe71fd77529bfef5dadb12c473453af\"",
    "created_at": "2014-02-26T16:47:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230257",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "c9cd7a46c1338b7e452ea8f4e5e26d189f43ddb8" to "4e4bdbb4abe71fd77529bfef5dadb12c473453af"
...
```json
{
    "body": "<a id='comment:3'></a>Ok, this was some strange output from the doctesting framework not liking the new lines and `...` in the expected output.\n\nI guess we could set this to positive review if Travis or Simon is ok with my latest changes (_internal_convert_map_from and the combinat doctests) and avoid further painful rebasing.",
    "created_at": "2014-02-26T16:48:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230258",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:3'></a>Ok, this was some strange output from the doctesting framework not liking the new lines and `...` in the expected output.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230259",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230260",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I'll try to take a look at it tonight, otherwise I will do so tomorrow unless Simon beats me too it.",
    "created_at": "2014-02-27T00:46:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230261",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>I'll try to take a look at it tonight, otherwise I will do so tomorrow unless Simon beats me too it.
...
```json
{
    "body": "Changing branch from \"u/jpflori/ticket/14711\" to \"public/ticket/14711\"",
    "created_at": "2014-02-27T18:22:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230263",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "u/jpflori/ticket/14711" to "public/ticket/14711"
...
```json
{
    "body": "Changing commit from \"4e4bdbb4abe71fd77529bfef5dadb12c473453af\" to \"ea58b22f0bf2652e7d04b3d55e6217dcb8732cdf\"",
    "created_at": "2014-02-27T18:22:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230264",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "4e4bdbb4abe71fd77529bfef5dadb12c473453af" to "ea58b22f0bf2652e7d04b3d55e6217dcb8732cdf"
...
```json
{
    "body": "<a id='comment:6'></a>Is it normally the case that the error being raised by `TriangularModuleMorphism` will not be caught? Otherwise, copying the morphism just for getting its print representation would be a waste of time.\n\nCurrently I do not have the capacity to check details, and for about one week I won't be able to review the recent changes.",
    "created_at": "2014-02-27T21:21:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230265",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>Is it normally the case that the error being raised by `TriangularModuleMorphism` will not be caught? Otherwise, copying the morphism just for getting its print representation would be a waste of time.
...
```json
{
    "body": "<a id='comment:7'></a>I don't think so. It's for when trying to incorrectly use the (natural) inverse map, and as such, it shouldn't be caught much (if at all). At least I can't think of a case where it is...",
    "created_at": "2014-02-27T22:52:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230266",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>I don't think so. It's for when trying to incorrectly use the (natural) inverse map, and as such, it shouldn't be caught much (if at all). At least I can't think of a case where it is...
...
```json
{
    "body": "<a id='comment:8'></a>How about we add an optional argument `suppress_warning` to the `_repr_` for times like this but when the error is expected to be caught?",
    "created_at": "2014-03-01T15:35:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230267",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>How about we add an optional argument `suppress_warning` to the `_repr_` for times like this but when the error is expected to be caught?
...
```json
{
    "body": "<a id='comment:221'></a>Replying to [comment:220 jpflori]:\n> Replying to [comment:219 nthiery]:\n> > Replying to [comment:215 tscrim]:\n> > > I've actually changed `TriangularModuleMorphism` to print out a copy of itself when raising an error because I didn't like the WARNING message being displayed. (FTR, they were being used as expected since they are suppose to be internal coercions.)\n\n> > \n> > Sorry, I haven't been following the details.  Having to change the\n> > code of existing morphisms when the usage is as expected feels like a\n> > smell (one more thing to think about when using/implementing\n> > morphisms). If I understand properly, in certain circumstances, one\n> > has to make copies of morphisms. Is it described somewhere in the documentation what those\n\n> Not with Travis last changes.\n> Now the `coerce/convert_map_from` methods return \"safe\" objects for which the copying was automatically done.\n> It's only the `_internal_` prefixed methods which return weakened objects but might be faster as no copies are involved.\n\n\nYou mean that the change to `TriangularModuleMorphism` is not needed any more?",
    "created_at": "2014-03-03T11:26:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230270",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:221'></a>Replying to [comment:220 jpflori]:
> Replying to [comment:219 nthiery]:
> > Replying to [comment:215 tscrim]:
> > > I've actually changed `TriangularModuleMorphism` to print out a copy of itself when raising an error because I didn't like the WARNING message being displayed. (FTR, they were being used as expected since they are suppose to be internal coercions.)
...
```json
{
    "body": "<a id='comment:223'></a>Replying to [comment:222 jpflori]:\n> I'd say the change is needed.\n> But that's because the code there uses an internal method to go faster rather than the publicized safe and slower method.\n\n\nSorry, I am confused; which internal method?",
    "created_at": "2014-03-03T14:07:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230272",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:223'></a>Replying to [comment:222 jpflori]:
> I'd say the change is needed.
> But that's because the code there uses an internal method to go faster rather than the publicized safe and slower method.
...
```json
{
    "body": "<a id='comment:4'></a>In fact, the code in `Triangular...` does not use the new `_internal_coerce_map_from`, but the code here:\nhttp://git.sagemath.org/sage.git/diff/src/sage/combinat/sf/new_kschur.py?id=6110bb984403114b2ddb8410868472d1cfdc64df",
    "created_at": "2014-03-03T14:13:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230273",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:4'></a>In fact, the code in `Triangular...` does not use the new `_internal_coerce_map_from`, but the code here:
http://git.sagemath.org/sage.git/diff/src/sage/combinat/sf/new_kschur.py?id=6110bb984403114b2ddb8410868472d1cfdc64df
...
```json
{
    "body": "<a id='comment:5'></a>IMO the `TriangularModuleMorphism` should be an internal coercion map in these cases, and so the issue is the error messages includes the map. Hence there is a big, scary, but completely unrelated warning printed with the error message. So to suppress the warning, either we copy `self` or do (something like) comment:218.",
    "created_at": "2014-03-03T15:14:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230274",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>IMO the `TriangularModuleMorphism` should be an internal coercion map in these cases, and so the issue is the error messages includes the map. Hence there is a big, scary, but completely unrelated warning printed with the error message. So to suppress the warning, either we copy `self` or do (something like) comment:218.
...
```json
{
    "body": "<a id='comment:8'></a>PS: Why not use some kind of lazy string, that will copy the map only if the string representation is actually printed? Hence, if the error is caught somewhere, then the error message will not be expanded. But if the error appears on screen, then the lazy string will copy the map before printing it.",
    "created_at": "2014-03-03T17:31:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230277",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>PS: Why not use some kind of lazy string, that will copy the map only if the string representation is actually printed? Hence, if the error is caught somewhere, then the error message will not be expanded. But if the error appears on screen, then the lazy string will copy the map before printing it.
...
```json
{
    "body": "<a id='comment:232'></a>Replying to [comment:231 SimonKing]:\n> Is the suggestion to do something like this:\n> \n> ```\n>     raise TypeError(\"%s is totally doomed.\"%m)\n> ```\n> (which is when an optional parameter to `_repr_` can not make sense) or like this:\n> \n> ```\n>     raise TypeError(\"%s is totally doomed.\"%m._repr_(suppress_warning=False))\n> ```\n> (which works but is is clumsy)?\n\n\nThe latter one (so we don't have to do the copy unnecessarily).",
    "created_at": "2014-03-05T23:41:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230281",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:232'></a>Replying to [comment:231 SimonKing]:
> Is the suggestion to do something like this:
> 
> ```
>     raise TypeError("%s is totally doomed."%m)
...
```json
{
    "body": "<a id='comment:3'></a>Do you mean one would have to always pass the suppress_warning thing?",
    "created_at": "2014-03-18T14:04:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230282",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:3'></a>Do you mean one would have to always pass the suppress_warning thing?
...
```json
{
    "body": "<a id='comment:7'></a>PS: This \"`CopyOnPrint`\" would only provide the string representation of the map. The whole error message would then be a lazy format string, such that the copy would really *only* happen when printing the error message.\n\nProof of concept:\n\n```\nsage: class CopyOnPrint:\n....:     def __init__(self, x):\n....:         self.x = x\n....:     def __repr__(self):\n....:         print \"Now a copy is taken\"\n....:         return repr(x.__copy__())\n....:     \nsage: O = CopyOnPrint(x)\nsage: O\nNow a copy is taken\nx\nsage: msg = \"The map %s is doomed\"%O\nNow a copy is taken\n```\nThe last line shows that the copy happens even though the message is not printed. However, when combined with a lazy format string, the behaviour is as intended:\n\n```\nsage: from sage.misc.lazy_format import LazyFormat\nsage: lazy_msg = LazyFormat(\"The map %s is doomed\")%O\n```\nSo, the message is created without copying, but copying happens when printing the message:\n\n```\nsage: lazy_msg\nNow a copy is taken\nThe map x is doomed\n```",
    "created_at": "2014-03-18T16:08:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230286",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>PS: This "`CopyOnPrint`" would only provide the string representation of the map. The whole error message would then be a lazy format string, such that the copy would really *only* happen when printing the error message.
...
```json
{
    "body": "<a id='comment:8'></a>Ah, sorry about that Simon. However do you think we find this useful enough to not do the evils of copying or adding an optional arg to `_repr_`? Because having the lazy format and copy string seems to specific to our case.\n\nActually...what it we have a lazy string that takes an arbitrary function and prints the result? This might be useful for errors which want to do some (non-trivial) transformation to an object before adding it to the error.",
    "created_at": "2014-03-18T16:13:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230287",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>Ah, sorry about that Simon. However do you think we find this useful enough to not do the evils of copying or adding an optional arg to `_repr_`? Because having the lazy format and copy string seems to specific to our case.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230290",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:242'></a>Replying to [comment:241 tscrim]:\n> Why can't we just use that with `copy` as the function? Something like:\n> \n> ```\n> sage: from sage.misc.lazy_string import lazy_string\n> sage: LazyFormat('%s')%lazy_string(copy, 5)\n> 5\n> ```\n\n\nMakes sense to me.",
    "created_at": "2014-03-18T17:00:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230291",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:242'></a>Replying to [comment:241 tscrim]:
> Why can't we just use that with `copy` as the function? Something like:
> 
> ```
> sage: from sage.misc.lazy_string import lazy_string
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230292",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:246'></a>Replying to [comment:245 nbruin]:\n> Then you should probably just chop off the warning from the string, since that seems by far the cheapest option (other than coming up with an entirely new protocol):\n\n\nI'm happy with doing it this way. Simon, Nicolas, Jean-Pierre, any objections?",
    "created_at": "2014-03-18T22:48:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230295",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:246'></a>Replying to [comment:245 nbruin]:
> Then you should probably just chop off the warning from the string, since that seems by far the cheapest option (other than coming up with an entirely new protocol):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230296",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing commit from \"ea58b22f0bf2652e7d04b3d55e6217dcb8732cdf\" to \"f68550d17989e50adecc9c1d6634109095174003\"",
    "created_at": "2014-03-24T17:07:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230297",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "ea58b22f0bf2652e7d04b3d55e6217dcb8732cdf" to "f68550d17989e50adecc9c1d6634109095174003"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230298",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:250'></a>Replying to [comment:249 tscrim]:\n> Define `_repr_no_warning()` which does the main bulk of the string construction and then `_repr_` just adds the warning. Then for things which want to include the a possible internal map, they just call `_repr_no_warning()`.\n\nI would be ok with that one.\n\nAnd we should definitely merge this ticket, so some compromise has to be reached.",
    "created_at": "2014-03-31T13:04:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230300",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:250'></a>Replying to [comment:249 tscrim]:
> Define `_repr_no_warning()` which does the main bulk of the string construction and then `_repr_` just adds the warning. Then for things which want to include the a possible internal map, they just call `_repr_no_warning()`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230302",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"f68550d17989e50adecc9c1d6634109095174003\" to \"8e5fe42b226442ef1dc181de0838803f00b29638\"",
    "created_at": "2014-04-02T07:01:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230303",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "f68550d17989e50adecc9c1d6634109095174003" to "8e5fe42b226442ef1dc181de0838803f00b29638"
...
```json
{
    "body": "<a id='comment:3'></a>Okay, I've cut down the size of the warning and removed the printing of the map from the error message for `TriangularModuleMorphism` (which is more inline with python's error messages).",
    "created_at": "2014-04-02T07:04:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230304",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>Okay, I've cut down the size of the warning and removed the printing of the map from the error message for `TriangularModuleMorphism` (which is more inline with python's error messages).
...
```json
{
    "body": "<a id='comment:4'></a>These changes look good to me.",
    "created_at": "2014-04-02T07:13:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230305",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>These changes look good to me.
...
```json
{
    "body": "<a id='comment:5'></a>Jean-Pierre, any objections? Because I believe if you don't have any, we can set this to positive review and get this merged in.",
    "created_at": "2014-04-02T14:37:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230306",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>Jean-Pierre, any objections? Because I believe if you don't have any, we can set this to positive review and get this merged in.
...
```json
{
    "body": "<a id='comment:6'></a>Not any objection, I want this merged asap.",
    "created_at": "2014-04-02T16:04:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230307",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:6'></a>Not any objection, I want this merged asap.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230308",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230309",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230310",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230311",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>??? I tested `coerce.pyx` so many times I lost track. Anyways, I've fixed the doctests, but waiting on my sage to recompile to do a final check.",
    "created_at": "2014-04-04T14:50:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230312",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:9'></a>??? I tested `coerce.pyx` so many times I lost track. Anyways, I've fixed the doctests, but waiting on my sage to recompile to do a final check.
...
```json
{
    "body": "<a id='comment:0'></a>Anne, Mike - More changes to the k-schur book...",
    "created_at": "2014-04-04T14:52:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230313",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:0'></a>Anne, Mike - More changes to the k-schur book...
...
```json
{
    "body": "<a id='comment:2'></a>I really need to figure out how to get `ccache` to work, so as to avoid those long recompiles (I think I'm about 50/238 files in :/).",
    "created_at": "2014-04-04T15:08:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230315",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>I really need to figure out how to get `ccache` to work, so as to avoid those long recompiles (I think I'm about 50/238 files in :/).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230316",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"8e5fe42b226442ef1dc181de0838803f00b29638\" to \"00b3e2f3cf90b5e7a339367f8ad4e08e1f0fb3d7\"",
    "created_at": "2014-04-04T15:41:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230317",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "8e5fe42b226442ef1dc181de0838803f00b29638" to "00b3e2f3cf90b5e7a339367f8ad4e08e1f0fb3d7"
...
```json
{
    "body": "<a id='comment:4'></a>Fixed. Took 51 minutes for my Sage to recompile itself. Now to have it recompile again!",
    "created_at": "2014-04-04T15:42:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230318",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>Fixed. Took 51 minutes for my Sage to recompile itself. Now to have it recompile again!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230319",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:265'></a>Replying to [comment:262 tscrim]:\n> I really need to figure out how to get `ccache` to work\n\n\n`sage -i ccache` doesn't work for you?",
    "created_at": "2014-04-04T16:44:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230320",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:265'></a>Replying to [comment:262 tscrim]:
> I really need to figure out how to get `ccache` to work
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14711#event-42157"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230323",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"public/ticket/14711\" to \"00b3e2f3cf90b5e7a339367f8ad4e08e1f0fb3d7\"",
    "created_at": "2014-04-05T10:43:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230324",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/ticket/14711" to "00b3e2f3cf90b5e7a339367f8ad4e08e1f0fb3d7"
...
```json
{
    "body": "Changing commit from \"00b3e2f3cf90b5e7a339367f8ad4e08e1f0fb3d7\" to \"\"",
    "created_at": "2018-02-14T08:35:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230325",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "00b3e2f3cf90b5e7a339367f8ad4e08e1f0fb3d7" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230326",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:0'></a>There is comment:92 for a bit more specifics. It might also be some shadow of https://github.com/cython/cython/issues/1732 or have worked itself out in Cython upgrades. IDK, I could not explicitly reproduce any failures. (Although this was done before I was looking at this ticket.)",
    "created_at": "2018-02-14T12:17:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14711#issuecomment-230327",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:0'></a>There is comment:92 for a bit more specifics. It might also be some shadow of https://github.com/cython/cython/issues/1732 or have worked itself out in Cython upgrades. IDK, I could not explicitly reproduce any failures. (Although this was done before I was looking at this ticket.)
