...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[6110bb9](http://git.sagemath.org/sage.git/commit/?id=6110bb984403114b2ddb8410868472d1cfdc64df)|`Now using _internal_coerce_map_from.`|\n|[6f22299](http://git.sagemath.org/sage.git/commit/?id=6f22299a9a9353e445a67e6493b8686257880701)|`Initial attempt at _internal_coerce_map_from_() method.`|\n|[3b6ac30](http://git.sagemath.org/sage.git/commit/?id=3b6ac3098a96579ebb12b9dd4403d335d57a6924)|`Started transition.`|\n|[147b4f5](http://git.sagemath.org/sage.git/commit/?id=147b4f56b1e92df1c3b62068e80ca9698bd80186)|`Removed unneeded copying of maps.`|\n|[8c1ef83](http://git.sagemath.org/sage.git/commit/?id=8c1ef83b2680ac5cc1606ba9548fdc3a4c24042d)|`Merge branch 'develop' into public/ticket/14711`|\n|[21aa9bc](http://git.sagemath.org/sage.git/commit/?id=21aa9bc76e18893e5c26c633e0e17e44a5656402)|`Removed some more copy and some other formatting changes.`|\n|[6b233b5](http://git.sagemath.org/sage.git/commit/?id=6b233b52b8932cbe3a3f6ff9dabb0e5b5615b7e2)|`Merge remote-tracking branch 'trac/develop' into ticket/14711`|",
    "created_at": "2014-02-25T09:21:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[7d7f7ae](http://git.sagemath.org/sage.git/commit/?id=7d7f7ae03d3fd16e630c69fa863f9ce8e1ac01e3)|`Fixes for p-adic coercions.`|",
    "created_at": "2014-02-25T11:07:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[d0c26b9](http://git.sagemath.org/sage.git/commit/?id=d0c26b94039540688eb35e985ebd7b558cec62b1)|`Fix wrong conflict resolution in number_field.py.`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[b21179f](http://git.sagemath.org/sage.git/commit/?id=b21179f6631af835d01ed1f7f250bb2ac4c12f2b)|`Fix copying of some morphims.`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[6b2b2e5](http://git.sagemath.org/sage.git/commit/?id=6b2b2e51ea475059605450d14fb657496e7f7c78)|`Fix test for weakened morphisms.`|",
    "created_at": "2014-02-26T12:54:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[1cf51a4](http://git.sagemath.org/sage.git/commit/?id=1cf51a4ce58fcc8620ac4158361567e73e7df9c5)|`Introduce _internal_convert_map_from, use it and fix doctests.`|",
    "created_at": "2014-02-26T15:44:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[f582766](http://git.sagemath.org/sage.git/commit/?id=f5827666b700d3b8d245b20d2346c7110bd0c21d)|`Fix doctests for copy of conversion from QQ to Zp.`|",
...
```json
{
    "body": "<a id='comment:0'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[c9cd7a4](http://git.sagemath.org/sage.git/commit/?id=c9cd7a46c1338b7e452ea8f4e5e26d189f43ddb8)|`Fix doctests in combinat using coercion stuff.`|",
    "created_at": "2014-02-26T16:41:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[4e4bdbb](http://git.sagemath.org/sage.git/commit/?id=4e4bdbb4abe71fd77529bfef5dadb12c473453af)|`Fix for failing doctest in coerce.pyx.`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[c7d070f](http://git.sagemath.org/sage.git/commit/?id=c7d070f7622de8f907d54ed567600c24e46a4963)|`Merge branch 'public/ticket/14711' of trac.sagemath.org:sage into public/ticket/14711`|\n|[f68550d](http://git.sagemath.org/sage.git/commit/?id=f68550d17989e50adecc9c1d6634109095174003)|`Fixed bad doctests from merge.`|",
    "created_at": "2014-03-24T17:07:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14711",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[d91bfab](http://git.sagemath.org/sage.git/commit/?id=d91bfabb6d89333fb0237d1c97fbf830c3a7e2be)|`Merge branch 'develop' into public/ticket/14711`|\n|[8e5fe42](http://git.sagemath.org/sage.git/commit/?id=8e5fe42b226442ef1dc181de0838803f00b29638)|`Changed warning message to leaner version.`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|\n|[00b3e2f](http://git.sagemath.org/sage.git/commit/?id=00b3e2f3cf90b5e7a339367f8ad4e08e1f0fb3d7)|`Fixed doctests.`|",
