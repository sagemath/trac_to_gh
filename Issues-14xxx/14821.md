...
<a id='comment:3'></a>`-` *deleted dumb comment (look at the diff and comment:5 if you want to know why I deleted this :)* `-`
...
<a id='comment:16'></a>The `RuntimeError` at the start of the ticket description (and mentioned in comment:13) is gone:
