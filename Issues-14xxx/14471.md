...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224372",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224373",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224374",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Adding some debugging in `remove()` shows that the `wr.key` is still in `self.dict.keys()` but `del self.dict[wr.key]` fails with a KeyError. Presumably because the whole thing is running during the garbage collection cycle. I tried #14159 but it didn't change anything. \n\nI haven't figured out exactly which cache in the Sage library is the culprit, maybe Simon knows?",
    "created_at": "2013-04-21T15:43:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224376",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Adding some debugging in `remove()` shows that the `wr.key` is still in `self.dict.keys()` but `del self.dict[wr.key]` fails with a KeyError. Presumably because the whole thing is running during the garbage collection cycle. I tried #14159 but it didn't change anything. 
...
```json
{
    "body": "<a id='comment:5'></a>I agree and verified with `gc.get_referrers` that it is `sage.structure.unique_representation.CachedRepresentation.__classcall__.cache`\n\nIf I change the remove() callback to\n\n```\n                import sys\n                print >> sys.stderr, 'removing', wr.key in self.data.keys()\n                del self.data[wr.key]\n                print >> sys.stderr, 'finished removing'\n```\nthen I get \n\n```\n    ...\n    removing True\n    finished removing\n    removing True\n    Exception KeyError: (((<class 'sage.categories.algebras.Algebras'>, Callable function ring with arguments (x, y)), ()),) in <function remove at 0x1acf758> ignored\n    removing True\n    finished removing\n    removing True\n    finished removing\n    ...\n```\nSo the weakvaluedict (self.data) is in a bad state...",
    "created_at": "2013-04-21T19:46:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224378",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:5'></a>I agree and verified with `gc.get_referrers` that it is `sage.structure.unique_representation.CachedRepresentation.__classcall__.cache`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224379",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224381",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224382",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I've added an `unguarded_abort` to force a gdb backtrace but it looks as it should to me: A object is being deallocated and triggers the WeakValueDictionary remove callback. The only dict that is being cleaned at that time are the globals of the doctest runner.",
    "created_at": "2013-04-22T09:53:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224383",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:8'></a>I've added an `unguarded_abort` to force a gdb backtrace but it looks as it should to me: A object is being deallocated and triggers the WeakValueDictionary remove callback. The only dict that is being cleaned at that time are the globals of the doctest runner.
...
```json
{
    "body": "<a id='comment:10'></a>I've looked at the Python 3 code and there weakref keeps a separate list of keys to remove to work around this issue.\n\nAny further non-Sage related discussion should probably move to the Python bugtracker.\n\nAs for Sage, should we patch Python for this? I hit this bug in #14469 and its likely that we'll trip over it again.",
    "created_at": "2013-04-22T17:00:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224385",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>I've looked at the Python 3 code and there weakref keeps a separate list of keys to remove to work around this issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224386",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224387",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I did a very quick search for lines in source containing both `hash` and `__class__`. Lines 73 and 75 in `sage/combinat/species/recursive_species.py` are also guilty, so whoever is going to fix this might want to look at those lines too.",
    "created_at": "2013-04-23T15:38:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224389",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:15'></a>I did a very quick search for lines in source containing both `hash` and `__class__`. Lines 73 and 75 in `sage/combinat/species/recursive_species.py` are also guilty, so whoever is going to fix this might want to look at those lines too.
...
```json
{
    "body": "<a id='comment:16'></a>Isn't this super-dangerous, changing the hash can potentially give you wrong results.\n\nAlso, I thought it is already wrong to make the bare class (not `_with_category`) accessible through `parent()`? Of course that ought to be spelled out in the documentation.",
    "created_at": "2013-05-02T18:01:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224390",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:16'></a>Isn't this super-dangerous, changing the hash can potentially give you wrong results.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224391",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224392",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>See `sage.matrix.matrix_space.MatrixSpace.full_category_initialisation` for documentation. See #11900 for timings.\n\nThe difference of `MatrixSpace` with respect to other parents is that some code (namely on elliptic curves) creates many different matrix spaces, but uses them *only* as a container, but not as a fully grown parent.",
    "created_at": "2013-05-03T09:28:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224393",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:19'></a>See `sage.matrix.matrix_space.MatrixSpace.full_category_initialisation` for documentation. See #11900 for timings.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224396",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224397",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224398",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Ok, fixing the offending `__hash__` functions is easy of course. I thought long about how we can ensure that it doesn't happen again, and the best way I can see is to check that the hash does not change in `Parent._refine_category_' during doctests. The patch implements that.",
    "created_at": "2013-05-29T21:35:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224399",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:23'></a>Ok, fixing the offending `__hash__` functions is easy of course. I thought long about how we can ensure that it doesn't happen again, and the best way I can see is to check that the hash does not change in `Parent._refine_category_' during doctests. The patch implements that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224400",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224401",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224402",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224403",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>I'm setting the priority to critical since it is a structural issue that we must get right in order to trust computations.\n\nRediffed to sage-5.11.beta3",
    "created_at": "2013-06-26T14:31:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224404",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:27'></a>I'm setting the priority to critical since it is a structural issue that we must get right in order to trust computations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224405",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>patchbot:\n\napply trac_14471_dynamic_class_hash.patch",
    "created_at": "2013-06-26T14:32:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224406",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:28'></a>patchbot:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224407",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224409",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>Fixed. The debug flag was actually not set during doctests (initialization order). Now is being set explicitly. I added your doctest.",
    "created_at": "2013-06-27T04:54:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224411",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:31'></a>Fixed. The debug flag was actually not set during doctests (initialization order). Now is being set explicitly. I added your doctest.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224412",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224413",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment [trac_14471-review.patch](tarball://root/attachments/some-uuid/ticket14471/trac_14471-review.patch) by @simon-king-jena created at 2013-06-27 12:51:15",
    "created_at": "2013-06-27T12:51:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224414",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [trac_14471-review.patch](tarball://root/attachments/some-uuid/ticket14471/trac_14471-review.patch) by @simon-king-jena created at 2013-06-27 12:51:15
...
```json
{
    "body": "<a id='comment:33'></a>I think it would be a good idea to show that the hash actually did change. I extended the new test accordingly, in a review patch.\n\nPositive review, then!",
    "created_at": "2013-06-27T12:52:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224415",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:33'></a>I think it would be a good idea to show that the hash actually did change. I extended the new test accordingly, in a review patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224416",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224417",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>No, I spoke to soon. Now, as the debug flag is set, it makes sense to run the full doc tests. After all, it could be that the debug flag uncovers a bug.",
    "created_at": "2013-06-27T12:53:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224418",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:34'></a>No, I spoke to soon. Now, as the debug flag is set, it makes sense to run the full doc tests. After all, it could be that the debug flag uncovers a bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224419",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224420",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>Doctests pass on my machine, of course",
    "created_at": "2013-06-27T13:17:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224421",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:35'></a>Doctests pass on my machine, of course
...
```json
{
    "body": "<a id='comment:36'></a>Replying to [vbraun](#comment%3A35):\n> Doctests pass on my machine, of course\n\n\nConfirmed!",
    "created_at": "2013-06-27T14:59:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224422",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:36'></a>Replying to [vbraun](#comment%3A35):
> Doctests pass on my machine, of course
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224423",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14471#event-41137"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224424",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224426",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224427",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224428",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Fixed.",
    "created_at": "2013-07-25T14:47:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224429",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:38'></a>Fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224430",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14471#event-41138"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14471#issuecomment-224431",
    "user": "https://github.com/jdemeyer"
}
```
