...
<a id='comment:12'></a>Replying to [comment:5 vbraun]:
> {{{
>     Exception KeyError: (((<class 'sage.categories.algebras.Algebras'>, Callable function ring with arguments (x, y)), ()),) in <function remove at 0x1acf758> ignored
> }}}
