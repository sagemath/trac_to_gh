...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14732#event-191997"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14732#event-191998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14732#event-191999"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14732#event-192000"
}
```
...
```json
{
    "body": "Changed keywords from **** to **FindStatDays 01**",
...
Changed keywords from **** to **FindStatDays 01**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14732#issuecomment-182136",
    "user": "https://github.com/VivianePons"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14732#issuecomment-182137",
    "user": "https://github.com/nathanncohen"
}
```
