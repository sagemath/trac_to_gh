...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234797",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234798",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_14903_point_elliptic_curve.patch](tarball://root/attachments/some-uuid/ticket14903/trac_14903_point_elliptic_curve.patch) by @vbraun created at 2013-07-17 14:11:41\n\nThe elliptic curve's point homsets need to be harmonized with the rest of the schemes code in Sage. Though perhaps not right now, so in that sprit here is a fix until that rewrite happens.",
    "created_at": "2013-07-17T14:11:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234799",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>Attachment [trac_14903_point_elliptic_curve.patch](tarball://root/attachments/some-uuid/ticket14903/trac_14903_point_elliptic_curve.patch) by @vbraun created at 2013-07-17 14:11:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234800",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>An easy workaround is to define your E as over R.fraction_field().  Elliptic curves over rings have little support in Sage now.",
    "created_at": "2013-07-17T19:57:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234801",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>An easy workaround is to define your E as over R.fraction_field().  Elliptic curves over rings have little support in Sage now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234802",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The patch looks good as a fix until the elliptic curve code is reworked, it is a step towards solving the problem I needed this for (I just ran into difficulties elsewhere in Sage), and doctests pass.",
    "created_at": "2013-07-17T21:02:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234803",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:3'></a>The patch looks good as a fix until the elliptic curve code is reworked, it is a step towards solving the problem I needed this for (I just ran into difficulties elsewhere in Sage), and doctests pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234804",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234805",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234806",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14903#event-42876"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14903#issuecomment-234807",
    "user": "https://github.com/jdemeyer"
}
```
