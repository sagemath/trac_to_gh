...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174621"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174622"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174623"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174624"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -18,3 +18,12 @@\n [0 3]]\n ```\n This ticket aims to add a `_repr_option(key)` method to **parents** to be able to return meta-information on the `_repr_()` output. In particular, `_repr_option('element_ascii_art')` will return a boolean that switches between the list display hooks.\n+\n+I've also change the displayhook to switch to the list pretty printing if *any* entry is an ascii-art element, not just the first one. This upsets a handful of doctests, but is still quite low impact.\n+\n+Apply\n+\n+* [attachment: trac_14040_housekeeping.patch.gz](https://github.com/sagemath/sage/files/ticket14040/trac_14040_housekeeping.patch.gz)\n+* [attachment: trac_14040_repr_option.patch.gz](https://github.com/sagemath/sage/files/ticket14040/trac_14040_repr_option.patch.gz)\n+* [attachment: trac_14040_doctests.patch.gz](https://github.com/sagemath/sage/files/ticket14040/trac_14040_doctests.patch.gz)\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174626"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14040#issuecomment-169019",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14040",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14040#event-174633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14040#issuecomment-169020",
