...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14424#event-187135"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14424#event-187136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14424#event-187137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14424#event-187138"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14424#issuecomment-176180",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14424#issuecomment-176181",
    "user": "https://github.com/jdemeyer"
}
```
