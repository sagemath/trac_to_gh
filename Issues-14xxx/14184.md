...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176727"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176728"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176729"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176730"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176733"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -52,3 +52,5 @@\n # Fix specific files\n sed -i 's/# optional/# optional - gap_packages (Guava package)/' devel/sage/sage/coding/guava.py\n ```\n+\n+**Apply** [and [attachment: 14184_manual.patch.gz](https://github.com/sagemath/sage/files/ticket14184/14184_manual.patch.gz)(https://github.com/sagemath/sage/files/ticket14184/7ffd137bf7452fed0401966634678f72.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176737"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176739"
}
```
...
```json
{
    "body": "<a id='comment:24'>Comment 24:</a>\nAttachment: **[14184_manual.patch.gz](https://github.com/sagemath/sage/files/ticket14184/14184_manual.patch.gz)**\n\nNew version of [attachment: 14184_manual.patch.gz](https://github.com/sagemath/sage/files/ticket14184/14184_manual.patch.gz) needs review.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176741"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176742"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176743"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176744"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176745"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176747"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14184#issuecomment-171649",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176749"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14184",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14184#event-176751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14184#issuecomment-171650",
    "user": "https://github.com/jdemeyer"
}
```
