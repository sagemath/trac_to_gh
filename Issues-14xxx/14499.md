...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181654"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181657"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181658"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,7 @@\n As the title says.. Documentation and reorganisation.\n+\n+Apply:\n+\n+* [attachment: trac_14499.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499.patch.gz) -- documentation fixes everywhere\n+* [attachment: trac_14499-catalog.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-catalog.patch.gz) -- creates a new catalog for designs (like we already have for graphs, groups, simplicial complexes, ...). Many methods are moved, but not changed !\n+* [attachment: trac_14499-doctests.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-doctests.patch.gz) -- fixes the problems created by the previous patch i.e. some methods have been moved from a module to another.\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,3 +5,4 @@\n * [attachment: trac_14499.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499.patch.gz) -- documentation fixes everywhere\n * [attachment: trac_14499-catalog.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-catalog.patch.gz) -- creates a new catalog for designs (like we already have for graphs, groups, simplicial complexes, ...). Many methods are moved, but not changed !\n * [attachment: trac_14499-doctests.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-doctests.patch.gz) -- fixes the problems created by the previous patch i.e. some methods have been moved from a module to another.\n+* [attachment: trac_14499-db_internet.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-db_internet.patch.gz) -- Moves and renames `best_known_covering_design_from_LJCR` which downloads a design from http://www.ccrwest.org/\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181660"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,6 +3,4 @@\n Apply:\n \n * [attachment: trac_14499.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499.patch.gz) -- documentation fixes everywhere\n-* [attachment: trac_14499-catalog.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-catalog.patch.gz) -- creates a new catalog for designs (like we already have for graphs, groups, simplicial complexes, ...). Many methods are moved, but not changed !\n-* [attachment: trac_14499-doctests.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-doctests.patch.gz) -- fixes the problems created by the previous patch i.e. some methods have been moved from a module to another.\n-* [attachment: trac_14499-db_internet.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-db_internet.patch.gz) -- Moves and renames `best_known_covering_design_from_LJCR` which downloads a design from http://www.ccrwest.org/\n+* [attachment: trac_14499-catalog.patch.gz](https://github.com/sagemath/sage/files/ticket14499/trac_14499-catalog.patch.gz) -- creates a new catalog for designs (like we already have for graphs, groups, simplicial complexes, ...)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181661"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181664"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181665"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181667"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14499#issuecomment-177859",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14499",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14499#event-181670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14499#issuecomment-177860",
