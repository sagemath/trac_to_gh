...
```json
{
    "body": "<a id='comment:1'></a>Isn't this essentially a duplicate of #10285?",
...
<a id='comment:1'></a>Isn't this essentially a duplicate of #10285?
...
<a id='comment:2'></a>I guess its the same libc bug isn't it?
See http://trac.sagemath.org/sage_trac/ticket/10285#comment:36
and https://groups.google.com/d/msg/sage-devel/QACdziLhniU/nvBT-EwS4b4J
...
```json
{
    "body": "<a id='comment:5'></a>I propose this be closed as a duplicate.",
...
<a id='comment:5'></a>I propose this be closed as a duplicate.
