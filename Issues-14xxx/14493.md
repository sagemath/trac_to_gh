...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41207"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41208"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41209"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14493#issuecomment-192104",
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41210"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41211"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41212"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41213"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>assuming that this ticket is for documentation only (not for the feature itself), i find that the docstring is currently well and clear in this respect. \n\nthis is because it says:\n\n```\n    INPUT:\n\n    - ``func`` -- Either a symbolic function or a Python function whose\n      argument is a tuple with `n` components\n```\n\nfor this reason i suggest to either close this ticket, or to add an extra note:\n\n```\n- If you use a Python function, the argument must be a tuple with `n` components, e.g. \n``def func(x): return sin(x[0]) + cos(x[1])`` instead of ``def func(x,y): return sin(x) + cos(y)``.\n```",
    "created_at": "2017-05-27T17:32:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14493#issuecomment-192105",
    "user": "https://github.com/mforets"
}
```

<a id='comment:7'></a>assuming that this ticket is for documentation only (not for the feature itself), i find that the docstring is currently well and clear in this respect. 
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41214"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14493#event-41215"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The latter seems good, because I wouldn't have figured out that syntax from no example.",
    "created_at": "2017-05-30T12:36:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14493#issuecomment-192106",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>The latter seems good, because I wouldn't have figured out that syntax from no example.
