...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14036#event-180898"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14036#event-180899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14036#event-180900"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14036#issuecomment-168911",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14036#issuecomment-168912",
    "user": "https://github.com/jdemeyer"
}
```
