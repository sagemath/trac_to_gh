...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14242#issuecomment-172659",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14242#issuecomment-172660",
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [14242_gap_workspace_race.patch](https://github.com/sagemath/sage/files/ticket14242/14242_gap_workspace_race.patch) by @jdemeyer created at 2013-03-11 15:48:51\n\nUpdated.",
    "created_at": "2013-03-11T15:48:51Z",
    "issue": "https://github.com/sagemath/sage/issues/14242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14242#issuecomment-172661",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14242#issuecomment-172662",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14242#issuecomment-172663",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14242#issuecomment-172664",
    "user": "https://github.com/jdemeyer"
}
```
