...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227645",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_14600_lowercase_FLINT.patch](tarball://root/attachments/some-uuid/ticket14603/trac_14600_lowercase_FLINT.patch) by @vbraun created at 2013-05-17 11:48:40\n\nI've stripped out the wrong and unnecessary flint `include_dir`",
    "created_at": "2013-05-17T11:48:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227646",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>Attachment [trac_14600_lowercase_FLINT.patch](tarball://root/attachments/some-uuid/ticket14603/trac_14600_lowercase_FLINT.patch) by @vbraun created at 2013-05-17 11:48:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227647",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227648",
...
```json
{
    "body": "<a id='comment:6'></a>In fact, we could just let all modules linking to FLINT automatically depend on `flint.h`, like we do for GMP/MPIR; no need to \"manually\" specifiy `flint_depends`.  (See `$SAGE_SRC/setup.py`, `lib_headers = ...`).",
    "created_at": "2013-05-17T11:59:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227649",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>In fact, we could just let all modules linking to FLINT automatically depend on `flint.h`, like we do for GMP/MPIR; no need to "manually" specifiy `flint_depends`.  (See `$SAGE_SRC/setup.py`, `lib_headers = ...`).
...
```json
{
    "body": "<a id='comment:7'></a>> In fact, we could just let all modules linking to FLINT automatically depend on `flint.h`, \n\n\nSo is this patch still waiting for a review ? It does the job and it looks good to me, but if you think that it should be done in a different way...\n\nNathann",
    "created_at": "2013-05-17T12:12:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227650",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:7'></a>> In fact, we could just let all modules linking to FLINT automatically depend on `flint.h`, 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227651",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Well, if you feel like adding a reviewer's patch that does that then I will review both `:-)`\n\nNathann",
    "created_at": "2013-05-17T12:27:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227653",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:10'></a>Well, if you feel like adding a reviewer's patch that does that then I will review both `:-)`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227654",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Nathann Cohen, Leif Leonhardy\"",
    "created_at": "2013-05-17T13:19:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227655",
    "user": "https://github.com/nexttime"
}
```

Changing reviewer from "" to "Nathann Cohen, Leif Leonhardy"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227656",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227657",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227658",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14603#event-41613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227659",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Thanks. Leif's followup will be another ticket, then.",
    "created_at": "2013-05-19T09:01:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14603#issuecomment-227660",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>Thanks. Leif's followup will be another ticket, then.
