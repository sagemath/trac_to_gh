...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221113",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>One unrelated (ahem) bit: I added something to the documentation for `denominator`, which seems strange for integers -- so we might as well say that it just returns 1 for everything.",
    "created_at": "2013-03-20T21:25:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221114",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:1'></a>One unrelated (ahem) bit: I added something to the documentation for `denominator`, which seems strange for integers -- so we might as well say that it just returns 1 for everything.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221115",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Looks good.  Adding similar documentation to `digits` might be nice, but not necessary.",
    "created_at": "2013-03-20T21:42:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221116",
    "user": "https://github.com/roed314"
}
```

<a id='comment:3'></a>Looks good.  Adding similar documentation to `digits` might be nice, but not necessary.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221117",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221118",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221119",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221120",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14322#issuecomment-221121",
    "user": "https://github.com/jdemeyer"
}
```
