...
```json
{
    "body": "<a id='comment:3'></a>> For this reason, when the release version of sage-5.9 comes out, I am unlikely to upgrade the sage port.  We should delay in adding FreeBSD as a supported platform.\n\n\nThat's fine, I just felt like opening this ticket since so many of the tickets had been closed and a couple others just need us to package up your fixes (pycrypto and python).  Never hurts to have it available for people to comment on.",
    "created_at": "2013-04-25T17:16:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225157",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>> For this reason, when the release version of sage-5.9 comes out, I am unlikely to upgrade the sage port.  We should delay in adding FreeBSD as a supported platform.
...
```json
{
    "body": "<a id='comment:4'></a>> Also, for ANY version of the gcc-4.7 compiler to work (either the one that comes with FreeBSD, or the one that comes with sage), the following patch is needed for FreeBSD:\n\n\nI've reported this upstream [here](https://github.com/JohnCremona/eclib/issues/1) and cc:ed the author of eclib.",
    "created_at": "2013-04-25T17:24:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225158",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>> Also, for ANY version of the gcc-4.7 compiler to work (either the one that comes with FreeBSD, or the one that comes with sage), the following patch is needed for FreeBSD:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225159",
...
```json
{
    "body": "<a id='comment:6'></a>Yes we discussed the eclib issue extensively on sage-devel and John is aware of it.\nNot sure though he already commited anything upstream.\n\nI'll be in Warwick in two weeks for the FLINT workshop, so if that can give him enough motivation to push a patch :)",
    "created_at": "2013-04-25T18:46:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225160",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:6'></a>Yes we discussed the eclib issue extensively on sage-devel and John is aware of it.
Not sure though he already commited anything upstream.
...
```json
{
    "body": "<a id='comment:8'></a>Of course I also needed the fixes from stephen: the pycrypto fixes to build pycrypto, I did not need the python fix to build the spkg, not sure it was needed though for dependencies or for runtime.",
    "created_at": "2013-04-25T18:52:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225162",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:8'></a>Of course I also needed the fixes from stephen: the pycrypto fixes to build pycrypto, I did not need the python fix to build the spkg, not sure it was needed though for dependencies or for runtime.
...
```json
{
    "body": "<a id='comment:10'></a>jpflori - which sage beta version were you able to build?  The use of gcc-4.7 was only introduced very recently, maybe beta3.",
    "created_at": "2013-04-25T20:31:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225164",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```

<a id='comment:10'></a>jpflori - which sage beta version were you able to build?  The use of gcc-4.7 was only introduced very recently, maybe beta3.
...
```json
{
    "body": "<a id='comment:11'></a>> Also, for ANY version of the gcc-4.7 compiler to work (either the one that comes with FreeBSD, or the one that comes with sage), the following patch is needed for FreeBSD:\n\nJohn says at the eclib github site,\n> Can you see if it works OK to add this line in the file libsrc/eclib/interface.h, around line 50? I think that's a better place for it: the int64_t type is referred to in libsrc/smat.cc, smat_elim.cc and svec.cc in the current version.",
    "created_at": "2013-04-25T23:57:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225165",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:11'></a>> Also, for ANY version of the gcc-4.7 compiler to work (either the one that comes with FreeBSD, or the one that comes with sage), the following patch is needed for FreeBSD:
...
```json
{
    "body": "<a id='comment:13'></a>Replying to [stephen](#comment%3A12):\n> OK, two pieces of good news.\n> \n> 1.  The patch suggested by John worked.\n> \n> ```\n> --- eclib-20120830/src/libsrc/eclib/interface.h-orig    2013-04-26 23:46:24.000000000 +0000\n> +++ eclib-20120830/src/libsrc/eclib/interface.h 2013-04-26 23:47:09.000000000 +0000\n> @@ -48,6 +48,7 @@\n>  #include <iterator>\n>  using namespace std;\n>  #include \"templates.h\"\n> +#include <stdint.h>\n> \n>  #ifndef MININT\n>  #define MININT numeric_limits<int>::min()\n> ```\n> \n\n\nExcellent, I will make that change to eclib so that the next spkg will have it in.",
    "created_at": "2013-04-27T08:03:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225167",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:13'></a>Replying to [stephen](#comment%3A12):
> OK, two pieces of good news.
> 
> 1.  The patch suggested by John worked.
> 
...
```json
{
    "body": "<a id='comment:14'></a>> 2.  I was able to solve the library problems.  I used the FreeBSD gcc-4.7, and the FreeBSD atlas.  Then I linked everything in `/usr/local/lib/gcc47` to `$SAGE_ROOT/local/lib` before starting the build of sage.   The problem was in the build of `r-2.15.2.p2`.  At some point during the build, it runs `R`, which is a script.  My guess is that it tries to run the binary `R`, and the binary gets `libgcc_s.so.1` from `/lib` instead of `/usr/local/lib/gcc47`.  And unfortunately the version in `/lib` is incompatible with `/usr/local/lib/gcc47/libgfortran.so.3`.\n  \nCan you pinpoint exactly where that happens?  I'm not seeing anything obvious in the spkg-install, and we *should* have all R-related env vars now set properly so that only Sage stuff is seen... or maybe not?\n> So when sage-5.9 comes out, I will be able to update the FreeBSD port.\n\nGreat!",
    "created_at": "2013-04-30T01:10:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225168",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>> 2.  I was able to solve the library problems.  I used the FreeBSD gcc-4.7, and the FreeBSD atlas.  Then I linked everything in `/usr/local/lib/gcc47` to `$SAGE_ROOT/local/lib` before starting the build of sage.   The problem was in the build of `r-2.15.2.p2`.  At some point during the build, it runs `R`, which is a script.  My guess is that it tries to run the binary `R`, and the binary gets `libgcc_s.so.1` from `/lib` instead of `/usr/local/lib/gcc47`.  And unfortunately the version in `/lib` is incompatible with `/usr/local/lib/gcc47/libgfortran.so.3`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225169",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225170",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Replying to [stephen](#comment%3A16):\n> Replying to [kcrisman](#comment%3A14):\n> > Can you pinpoint exactly where that happens?  I'm not seeing anything obvious in the spkg-install, and we *should* have all R-related env vars now set properly so that only Sage stuff is seen... or maybe not?\n\n> \n> When were these changes made?  I tried to reproduce the error using sage-5.9.rc1, and now the error doesn't happen.  I think I was detecting the error trying to build beta5.\n\n\nThe only recent change I'm aware of was #9668, indeed just merged into Sage 5.9.rc0.",
    "created_at": "2013-04-30T22:07:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225171",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:17'></a>Replying to [stephen](#comment%3A16):
> Replying to [kcrisman](#comment%3A14):
> > Can you pinpoint exactly where that happens?  I'm not seeing anything obvious in the spkg-install, and we *should* have all R-related env vars now set properly so that only Sage stuff is seen... or maybe not?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225176",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225179",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>I've opened #14651 for the numpy/scipy/atlas issue.",
    "created_at": "2013-05-28T08:30:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225180",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:26'></a>I've opened #14651 for the numpy/scipy/atlas issue.
...
```json
{
    "body": "<a id='comment:27'></a>Replying to [jpflori](#comment%3A24):\n> Building the doc repeatedly failed at:\n> \n> ```\n> [tensor   ] writing output... [ 25%] index\n> [tensor   ] writing output... [ 50%] sage/tensor/coordinate_patch\n> [tensor   ] writing output... [ 75%] sage/tensor/differential_form_element\n> [tensor   ] writing output... [100%] sage/tensor/differential_forms\n> [tensor   ] dumping object inventory... done\n> [tensor   ] build succeeded.\n> [history_a] loading cross citations... looking for now-outdated files... none found\n> [history_a] no targets are out of date.\n> ```\n> so I tried Stephen's patch:\n> * http://www.freebsd.org/cgi/cvsweb.cgi/ports/math/sage/files/spkg-patch-sage_-_doc_common_builder.py\n> but then it failed at\n> \n> ```\n> [geometry ] writing output... [ 95%] sage/geometry/triangulation/point_configuration\n> [geometry ] writing output... [100%] sage/rings/polynomial/groebner_fan\n> [geometry ] dumping object inventory... done\n> [geometry ] build succeeded.\n> ```\n\nAfter a quite long time the doc finally got built.\n> \n> And indeed Python still fails\n> \n> ```\n> sage -t devel/sage/sage/parallel/decorate.py\n> **********************************************************************\n> File \"devel/sage/sage/parallel/decorate.py\", line 526, in sage.parallel.decorate.fork\n> Failed example:\n>     g(10^7, m=5)\n> Exception raised:\n>     Traceback (most recent call last):\n>       File \"/scratch/jpflori/sage-5.9+freebsd-83-amd64/local/lib/python2.7/site-packages/sage/doctest/forker.py\", line 466, in _run\n>         self.execute(example, compiled, test.globs)\n>       File \"/scratch/jpflori/sage-5.9+freebsd-83-amd64/local/lib/python2.7/site-packages/sage/doctest/forker.py\", line 825, in execute\n>         exec compiled in globs\n>       File \"<doctest sage.parallel.decorate.fork[6]>\", line 1, in <module>\n>         g(Integer(10)**Integer(7), m=Integer(5))\n>       File \"/scratch/jpflori/sage-5.9+freebsd-83-amd64/local/lib/python2.7/site-packages/sage/parallel/decorate.py\", line 475, in h\n>         return list(g([(args, kwds)]))[0][1]\n>     IndexError: list index out of range\n> **********************************************************************\n> ```\n\nThis is indeed fixed with the patches from #12400.",
    "created_at": "2013-05-28T09:43:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225181",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:27'></a>Replying to [jpflori](#comment%3A24):
> Building the doc repeatedly failed at:
> 
> ```
> [tensor   ] writing output... [ 25%] index
...
```json
{
    "body": "<a id='comment:28'></a>I received a suggestion for the FreeBSD port of sage, to use gcc46, and add to the make environment SAGE_INSTALL_GCC=no.  This way sage doesn't build its own gcc-4.7, and builds with the gcc-4.6 that comes with FreeBSD.\n\nEverything built and tested well, both for sage-5.9, and sage-5.10.rc0.  So I have switched the FreeBSD port to work in this way.",
    "created_at": "2013-06-01T22:34:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225182",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```

<a id='comment:28'></a>I received a suggestion for the FreeBSD port of sage, to use gcc46, and add to the make environment SAGE_INSTALL_GCC=no.  This way sage doesn't build its own gcc-4.7, and builds with the gcc-4.6 that comes with FreeBSD.
...
```json
{
    "body": "<a id='comment:29'></a>Something new: FreeBSD's binutils port has been updated to version 2.23.2.  Since this happened, the cephes patch for FreeBSD only works if the `-Wl,--copy-dt-needed-entries` option is added to any invocation of gcc or g++ that tries to link with libm.so.\n\nSee \"Changes in 2.22\" in http://sourceware.org/cgi-bin/cvsweb.cgi/~checkout~/src/ld/NEWS?rev=1.131.2.1&content-type=text/plain&cvsroot=src&only_with_tag=binutils-binutils-2_23_2",
    "created_at": "2013-06-29T02:54:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225183",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```

<a id='comment:29'></a>Something new: FreeBSD's binutils port has been updated to version 2.23.2.  Since this happened, the cephes patch for FreeBSD only works if the `-Wl,--copy-dt-needed-entries` option is added to any invocation of gcc or g++ that tries to link with libm.so.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41196"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>An issue has come up in sage-5.12.beta2, when trying to build sage using the port.  The port adds options like `-Wl,-rpath=lots-of-stuff` to `$(LDFLAGS)`.  This is a problem for the ncurses-5.9 subpackage, because in its FreeBSD build it uses /usr/local/bin/ld to create a shared library, and then these options cause errors.  The fix is very simple --- replace ld with cc.  The attached patch fixes this problem.  Nevertheless it is annoying to have to do this.\n\n```\n--- ncurses-5.9/src/configure.orig      2013-08-21 02:51:59.000000000 +0000\n+++ ncurses-5.9/src/configure   2013-08-21 02:53:23.000000000 +0000\n@@ -5719,7 +5719,7 @@\n                cf_cv_shared_soname='`basename $@`'\n        fi\n\n-               MK_SHARED_LIB='${LD} -shared -Bshareable -soname=`basename $@` -o $@'\n+               MK_SHARED_LIB='${CC} -shared -Bshareable -soname=`basename $@` -o $@'\n                ;;\n        netbsd*) #(vi\n                CC_SHARED_OPTS=\"$CC_SHARED_OPTS -DPIC\"\n```",
    "created_at": "2013-08-21T22:03:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225188",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```

<a id='comment:35'></a>An issue has come up in sage-5.12.beta2, when trying to build sage using the port.  The port adds options like `-Wl,-rpath=lots-of-stuff` to `$(LDFLAGS)`.  This is a problem for the ncurses-5.9 subpackage, because in its FreeBSD build it uses /usr/local/bin/ld to create a shared library, and then these options cause errors.  The fix is very simple --- replace ld with cc.  The attached patch fixes this problem.  Nevertheless it is annoying to have to do this.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41197"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41198"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41199"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41200"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41201"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41202"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41203"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14491#event-41205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225190",
...
```json
{
    "body": "<a id='comment:40'></a>Closing as duplicate of #22679",
    "created_at": "2018-02-03T19:56:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14491",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14491#issuecomment-225191",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:40'></a>Closing as duplicate of #22679
