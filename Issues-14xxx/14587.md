...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227290",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227292",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227293",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I cannot test the fixes (Debian doesn't have M2). I can address that one, but it's probably quicker if you or someone with M2 fixes them?",
    "created_at": "2013-05-15T14:58:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227294",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>I cannot test the fixes (Debian doesn't have M2). I can address that one, but it's probably quicker if you or someone with M2 fixes them?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227295",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_14587_doctests.patch](tarball://root/attachments/some-uuid/ticket14587/trac_14587_doctests.patch) by @vbraun created at 2013-05-15 17:39:53\n\nOk, done. Positive review to your half of the patch...",
    "created_at": "2013-05-15T17:39:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227296",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Attachment [trac_14587_doctests.patch](tarball://root/attachments/some-uuid/ticket14587/trac_14587_doctests.patch) by @vbraun created at 2013-05-15 17:39:53
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227297",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>works on Sage 5.9 with system-wide M2 1.6 (OSX 10.6.8)\n\n```\nsage -bt --optional=sage,macaulay2 --long sage/rings/\n...\nAll tests passed!\n----------------------------------------------------------------------\nTotal time for all tests: 862.0 seconds\n    cpu time: 774.6 seconds\n    cumulative wall time: 828.1 seconds\n```",
    "created_at": "2013-05-23T04:59:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227298",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>works on Sage 5.9 with system-wide M2 1.6 (OSX 10.6.8)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227299",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Which patch(es) should be applied?",
    "created_at": "2013-05-23T16:28:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227300",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Which patch(es) should be applied?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227301",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227302",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227303",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227304",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227305",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14587#issuecomment-227306",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14587",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14587#event-41549"
}
```
