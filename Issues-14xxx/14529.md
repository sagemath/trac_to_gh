...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[48f55bb](https://git.sagemath.org/sage.git/commit/?id=48f55bbdda57b95c982d033ac586188a5a63bef4)|`trac #14529: fix merge conflict`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[e35d6b1](https://git.sagemath.org/sage.git/commit/?id=e35d6b106bcca8cb09065da675dbb019a09a7a49)|`trac #14529: move parameter algorithm to the end`|",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[66708cc](https://git.sagemath.org/sage.git/commit/?id=66708ccafa726139f8d054365ae45919e6d0ce6a)|`trac #14529: several improvements`|",
