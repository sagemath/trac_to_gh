...
```json
{
    "body": "<a id='comment:2'></a>One option I just discussed with Robert is to by default only turn on ccache for files in the Sage library.  This could drop the space requirement substantially.",
    "created_at": "2013-03-28T02:19:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222313",
    "user": "https://github.com/roed314"
}
```

<a id='comment:2'></a>One option I just discussed with Robert is to by default only turn on ccache for files in the Sage library.  This could drop the space requirement substantially.
...
```json
{
    "body": "<a id='comment:3'></a>Being optional for a while doesn't imply it should get standard;  there are many packages that are optional since quite a while, and you certainly won't want to include all of them.\n\nIMHO we already have too many \"standard\" packages, some are only built on a few platforms, or under certain circumstances, some only useful to (or necessary for) a few people.",
    "created_at": "2013-03-28T02:27:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222314",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>Being optional for a while doesn't imply it should get standard;  there are many packages that are optional since quite a while, and you certainly won't want to include all of them.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222315",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Well, it perfectly fits an *optional* package -- it doesn't require any specific support by the Sage library, just like gdb, autotools, valgrind, also GCC, or whatever, which are mostly there for convenience, but not needed by most Sage users.\n\nShipping (and reinstalling) it with each and every Sage release doesn't make sense to me;  <flame> any serious developer would have it installed [system-wide] anyway if it's of use to him/her </flame>.\n\nDon't make the horse an elephant, otherwise it'll really lose its ability to fly.",
    "created_at": "2013-03-28T02:50:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222316",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:5'></a>Well, it perfectly fits an *optional* package -- it doesn't require any specific support by the Sage library, just like gdb, autotools, valgrind, also GCC, or whatever, which are mostly there for convenience, but not needed by most Sage users.
...
```json
{
    "body": "<a id='comment:6'></a>I essentially agree with leif here: it's a package which is essentially only useful for Sage *developers*, so why should we always use it?",
    "created_at": "2013-03-28T07:01:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222317",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I essentially agree with leif here: it's a package which is essentially only useful for Sage *developers*, so why should we always use it?
...
```json
{
    "body": "<a id='comment:8'></a>CCing a couple people I thought might be interested.",
    "created_at": "2013-03-28T07:22:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222319",
    "user": "https://github.com/kini"
}
```

<a id='comment:8'></a>CCing a couple people I thought might be interested.
...
```json
{
    "body": "<a id='comment:9'></a>I agree with the opinion that ccache shouldn't be a standard package. It is required only for developers, and maybe some developers will *not* want this to be default because of the 4G of storage it demands by default.\n\nFor those who are interested, it can be installed quite easily by setting the environment variable SAGE_INSTALL_CCACHE='yes'. This variable can be added to the `<SHELL>rc` since it doesn't clash with anything else, so that in every new sage installation or (re-)compilation ccache is used.",
    "created_at": "2013-03-28T12:47:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222320",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:9'></a>I agree with the opinion that ccache shouldn't be a standard package. It is required only for developers, and maybe some developers will *not* want this to be default because of the 4G of storage it demands by default.
...
```json
{
    "body": "<a id='comment:11'></a>-1 from me, too. If you are a serious developer then you hopefully use a distro that ships a working gcc+ccache by default.",
    "created_at": "2013-03-28T15:10:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222322",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>-1 from me, too. If you are a serious developer then you hopefully use a distro that ships a working gcc+ccache by default.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222323",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222326",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>It's automatic and makes `sage -b` faster, but it requires a lot of disk space (a few gigabytes), and the effect of making `sage -b` faster is most visible if you used ccache during your initial build of sage from the source tarball, I think.",
    "created_at": "2013-03-28T18:21:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222327",
    "user": "https://github.com/kini"
}
```

<a id='comment:16'></a>It's automatic and makes `sage -b` faster, but it requires a lot of disk space (a few gigabytes), and the effect of making `sage -b` faster is most visible if you used ccache during your initial build of sage from the source tarball, I think.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40786"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40787"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40788"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Now that we have moved to git, what is the opinion on this?",
    "created_at": "2014-04-15T10:49:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222330",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:21'></a>Now that we have moved to git, what is the opinion on this?
...
```json
{
    "body": "<a id='comment:22'></a>We do have the `SAGE_INSTALL_CCACHE` variable now and I personally think that is a perfect solution.",
    "created_at": "2014-04-15T11:42:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222331",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:22'></a>We do have the `SAGE_INSTALL_CCACHE` variable now and I personally think that is a perfect solution.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222332",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40789"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40790"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222333",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222334",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>So we have to open another ticket to prominently advertise it (in the Sage *Developer's* Guide)? ;-)",
    "created_at": "2014-04-15T13:44:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222335",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:25'></a>So we have to open another ticket to prominently advertise it (in the Sage *Developer's* Guide)? ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222336",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222337",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40791"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40792"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>> So we have to open another ticket to prominently advertise it (in the Sage *Developer's* Guide)? ;-)\n\nOr repurpose this one for that, which seems fine to me.  I do agree that 4 GB is nothing to sneeze at, and will reiterate[comment:17](#comment%3A17).",
    "created_at": "2014-04-15T19:10:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222338",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:26'></a>> So we have to open another ticket to prominently advertise it (in the Sage *Developer's* Guide)? ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222339",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222340",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>> > > So we have to open another ticket to prominently advertise it (in the Sage *Developer's* Guide)? ;-)\n\n> > Or repurpose this one for that, which seems fine to me.  I do agree that 4 GB is nothing to sneeze at, and will reiterate[comment:17](#comment%3A17).\n> \n> I don't think the necessary additions to the Developer's Guide will get *that* large.\n\nLOL",
    "created_at": "2014-04-15T19:43:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222341",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:28'></a>> > > So we have to open another ticket to prominently advertise it (in the Sage *Developer's* Guide)? ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222342",
...
```json
{
    "body": "<a id='comment:30'></a>Follow up on[comment:29](#comment%3A29): is there a way of caching results of Cythonization?",
    "created_at": "2014-04-24T15:52:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222343",
    "user": "https://github.com/videlec"
}
```

<a id='comment:30'></a>Follow up on[comment:29](#comment%3A29): is there a way of caching results of Cythonization?
...
```json
{
    "body": "<a id='comment:31'></a>Replying to [jdemeyer](#comment%3A18):\n> Replying to [kini](#comment%3A16):\n> > the effect of making sage-b faster is most visible if you used ccache during your initial build of sage from the source tarball, I think.\n\n> Sure, since it's a cache, it can only speed up compilation starting from the *second* time you build the same file.\nI'm pretty sure even the first compilation is faster, because some files are used multiple times within an install.",
    "created_at": "2014-04-25T07:33:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222344",
    "user": "https://github.com/rwst"
}
```

<a id='comment:31'></a>Replying to [jdemeyer](#comment%3A18):
> Replying to [kini](#comment%3A16):
> > the effect of making sage-b faster is most visible if you used ccache during your initial build of sage from the source tarball, I think.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222345",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>> > Follow up on[comment:29](#comment%3A29): is there a way of caching results of Cythonization?\n\n> \n> Yes, see #16148. I think every developer should use it (4GB of hard drive space really isn't that much these days) and I think every user should be considered at least a potential developer (at least the ones who compile from source). \n\nThough I don't think it should be in binaries anyway.  On a small USB key and some other situations 4 GB is quite a bit.\n\nThat said, I still don't know how to use this properly!  Taking a chance that just using the env var in my .profile was enough...",
    "created_at": "2014-05-29T17:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222346",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:33'></a>> > Follow up on[comment:29](#comment%3A29): is there a way of caching results of Cythonization?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222347",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222348",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40793"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222349",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222351",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40795"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222352",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>I agree, it can be closed as a dup.",
    "created_at": "2016-11-15T01:53:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222353",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:41'></a>I agree, it can be closed as a dup.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222354",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222355",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14372#event-40797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14372#issuecomment-222356",
    "user": "https://github.com/vbraun"
}
```
