...
```json
{
    "body": "I can verify that this bug still exists in sage 5.10.rc1. Using a mac, OS X 10.8.",
...
```json
{
    "body": "This is an actual useful suggestion - otherwise we just say it's more of a browser issue than Sage issue.",
    "created_at": "2014-09-17T02:52:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
...
```json
{
    "body": "Upstream!  https://github.com/sagemath/sagenb/issues/224",
