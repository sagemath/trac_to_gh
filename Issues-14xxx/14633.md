...
```json
{
    "body": "<a id='comment:1'></a>I can verify that this bug still exists in sage 5.10.rc1. Using a mac, OS X 10.8.",
    "created_at": "2013-06-14T11:04:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228216",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```

<a id='comment:1'></a>I can verify that this bug still exists in sage 5.10.rc1. Using a mac, OS X 10.8.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41727"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228217",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41728"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41729"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41730"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41731"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41732"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41733"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228218",
...
```json
{
    "body": "<a id='comment:7'></a>This is an actual useful suggestion - otherwise we just say it's more of a browser issue than Sage issue.",
    "created_at": "2014-09-17T02:52:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228219",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>This is an actual useful suggestion - otherwise we just say it's more of a browser issue than Sage issue.
...
```json
{
    "body": "<a id='comment:8'></a>Upstream!  https://github.com/sagemath/sagenb/issues/224",
    "created_at": "2014-09-17T02:54:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228220",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Upstream!  https://github.com/sagemath/sagenb/issues/224
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228221",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228223",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228224",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41734"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41735"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14633#event-41736"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14633#issuecomment-228225",
