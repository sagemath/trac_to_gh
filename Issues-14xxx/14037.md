...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39469"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39470"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39471"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39472"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39473"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39474"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39475"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39476"
}
```
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14037#event-39477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14037#issuecomment-183139",
...
```json
{
    "body": "<a id='comment:6'></a>Description modified. This is a bug in the old (deprecated in #14801) `Piecewise` (capital P).\nCan close this bug when the old `Piecewise` is removed completely.",
    "created_at": "2016-06-25T17:17:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14037#issuecomment-183140",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>Description modified. This is a bug in the old (deprecated in #14801) `Piecewise` (capital P).
Can close this bug when the old `Piecewise` is removed completely.
