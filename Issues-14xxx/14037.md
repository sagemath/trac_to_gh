...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14037#event-180920"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14037#event-180921"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14037#event-180922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14037#issuecomment-168914",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14037#issuecomment-168915",
    "user": "https://github.com/mkoeppe"
}
```
