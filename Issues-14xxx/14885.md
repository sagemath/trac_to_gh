...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234249",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I have just figured out why I can't join sage-devel: I'm on the group already *facepalm*.\n\nPosted: https://groups.google.com/forum/#!topic/sage-devel/tAAb42Edh9o .",
    "created_at": "2013-07-12T23:43:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234253",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:5'></a>I have just figured out why I can't join sage-devel: I'm on the group already *facepalm*.
...
```json
{
    "body": "Changing stopgaps from \"\" to \"#15174\"",
    "created_at": "2013-09-08T05:05:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234254",
    "user": "https://github.com/darijgr"
}
```

Changing stopgaps from "" to "#15174"
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42770"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42771"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42772"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42773"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42774"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Demoting from 'critical' to 'major'.",
    "created_at": "2020-10-08T21:37:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234255",
    "user": "https://github.com/slel"
}
```

<a id='comment:12'></a>Demoting from 'critical' to 'major'.
...
```json
{
    "body": "<a id='comment:13'></a>I must admit that I think that this one should stay critical.",
    "created_at": "2020-10-09T13:16:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234256",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:13'></a>I must admit that I think that this one should stay critical.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234257",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Can someone summarise the sage-devel discussion\nand propose a path forward?",
    "created_at": "2020-10-09T13:47:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234258",
    "user": "https://github.com/slel"
}
```

<a id='comment:14'></a>Can someone summarise the sage-devel discussion
and propose a path forward?
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42775"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42776"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I do not think it is critical. There is a problem with things not being well documented and things relying on a particular multiplication convention. However, the convention choice within Sage itself is not a critical issue.",
    "created_at": "2020-10-09T21:59:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234259",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:15'></a>I do not think it is critical. There is a problem with things not being well documented and things relying on a particular multiplication convention. However, the convention choice within Sage itself is not a critical issue.
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42777"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42778"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14885#issuecomment-234260",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42779"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42780"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42781"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42782"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42783"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42784"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42785"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14885#event-42786"
}
```
