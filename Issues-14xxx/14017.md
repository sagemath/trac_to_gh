...
```json
{
    "body": "<a id='comment:3'></a>I just realise that there is one more wrong expected result in the current doctests:\n\n```\n        sage: sgc('def _(x=\"):\"):')\n        (['x'], None, None, ('):',))\n```\n\nThe function specification states that the string representation of the default values is returned. But of course `'):'` is not the string representation of `\"):\"`. Instead, we should have\n\n```\nsage: sgc('def _(x=\"):\"):')\n(['x'], None, None, ['\"):\"'])\n```\nand this is actually done by my experimental code.",
    "created_at": "2013-01-27T11:14:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214033",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>I just realise that there is one more wrong expected result in the current doctests:
...
```json
{
    "body": "<a id='comment:4'></a>Here is some other doctest that currently has a very odd result. The docs say that \"In the case of a class or a class instance, the ``ArgSpec`` of the ``__new__`` or ``__init__`` methods are returned\". The example is\n\n```\n        sage: P.<x,y> = QQ[]\n        sage: sage_getargspec(P)\n        ArgSpec(args=['self', 'element'], varargs=None, keywords=None, defaults=None)\n        sage: sage_getargspec(P.__class__)\n        ArgSpec(args=['self', 'element'], varargs=None, keywords=None, defaults=None)\n```\nbut in fact we have\n\n```\nsage:  sage_getargspec(P.__init__)\nArgSpec(args=['self', 'base_ring', 'n', 'names', 'order'], varargs=None, keywords=None, defaults=(\"'degrevlex'\",))\n```\nand thus the expected answer looks suspicious to me.",
    "created_at": "2013-01-27T11:37:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214034",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>Here is some other doctest that currently has a very odd result. The docs say that "In the case of a class or a class instance, the ``ArgSpec`` of the ``__new__`` or ``__init__`` methods are returned". The example is
...
```json
{
    "body": "<a id='comment:5'></a>Probably it is better to have the defaults not as string, because `_sage_getargspec_from_ast` doesn't return strings either.",
    "created_at": "2013-01-27T14:33:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214035",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Probably it is better to have the defaults not as string, because `_sage_getargspec_from_ast` doesn't return strings either.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214037",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214039",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214041",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214043",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214044",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>The patch is updated - the uncommented chunk of code is removed, and I raise Exception(\"message\").",
    "created_at": "2013-01-30T21:25:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214045",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>The patch is updated - the uncommented chunk of code is removed, and I raise Exception("message").
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214046",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Looks good to me now. Thank you Simon.\n\nBest,\n\nTravis",
    "created_at": "2013-01-31T00:10:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214047",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:13'></a>Looks good to me now. Thank you Simon.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214049",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214050",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214052",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214053",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>PS: I have added more doctests, dealing with corner cases (no positional arguments, but only varargs or only keywords) and the good-in-Cython-but-bad-in-Python syntax.",
    "created_at": "2013-02-03T00:17:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214054",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:18'></a>PS: I have added more doctests, dealing with corner cases (no positional arguments, but only varargs or only keywords) and the good-in-Cython-but-bad-in-Python syntax.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214055",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Fix variable name in pbori, accept pointer types in function definitions\"",
    "created_at": "2013-02-03T01:02:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214056",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Fix variable name in pbori, accept pointer types in function definitions"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214058",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Attachment [trac14017_sage_getargspec_cython.patch](tarball://root/attachments/some-uuid/ticket14017/trac14017_sage_getargspec_cython.patch) by @simon-king-jena created at 2013-02-03 01:19:29\n\nIt was a rather easy change, so, I updated the patch already. _sage_getargspec_cython is still entitled to complain about pointer types, but an exception from raising an exception is made (and doctested) for pointers to char. And I changed the critical variable name in pbori.pyx.\n\nNeeds review again (including docs).",
    "created_at": "2013-02-03T01:19:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214059",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:20'></a>Attachment [trac14017_sage_getargspec_cython.patch](tarball://root/attachments/some-uuid/ticket14017/trac14017_sage_getargspec_cython.patch) by @simon-king-jena created at 2013-02-03 01:19:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214060",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Documentation rebuilt cleanly for me as well. Looks good to me.",
    "created_at": "2013-02-05T02:09:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214062",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:22'></a>Documentation rebuilt cleanly for me as well. Looks good to me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214063",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214064",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14017#issuecomment-214065",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14017",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14017#event-39412"
}
```
