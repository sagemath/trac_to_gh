...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216470",
    "user": "https://trac.sagemath.org/admin/accounts/users/csar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216471",
    "user": "https://trac.sagemath.org/admin/accounts/users/csar"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Patch does not apply and it's not clear why.",
    "created_at": "2013-02-15T02:25:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216472",
    "user": "https://trac.sagemath.org/admin/accounts/users/csar"
}
```

<a id='comment:3'></a>Patch does not apply and it's not clear why.
...
```json
{
    "body": "<a id='comment:4'></a>(this code should probably be stored in `from sage.combinat.posets.linear_extensions`. Besides, your code may be faster for small cases but can also require an exponential memory, which can be a problem too).",
    "created_at": "2013-02-15T09:26:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216473",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>(this code should probably be stored in `from sage.combinat.posets.linear_extensions`. Besides, your code may be faster for small cases but can also require an exponential memory, which can be a problem too).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216474",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216475",
    "user": "https://trac.sagemath.org/admin/accounts/users/csar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216476",
    "user": "https://trac.sagemath.org/admin/accounts/users/csar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216477",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>But for what it's worth, I was successfully able to apply the latest version of the patch.",
    "created_at": "2013-02-15T20:50:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216479",
    "user": "https://github.com/kevindilks"
}
```

<a id='comment:8'></a>But for what it's worth, I was successfully able to apply the latest version of the patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216481",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216482",
...
```json
{
    "body": "<a id='comment:12'></a>I will give `LinearExtensionsOfPoset` the choice of which method to count linear extensions.",
    "created_at": "2013-07-06T16:21:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216483",
    "user": "https://trac.sagemath.org/admin/accounts/users/csar"
}
```

<a id='comment:12'></a>I will give `LinearExtensionsOfPoset` the choice of which method to count linear extensions.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39848"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39849"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39850"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39851"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39852"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39853"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216485",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216486",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216487",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Well, counting linear extensions is #P-problem, I think. Of course it's complexity can still be `O(1.001^n)`...\n\nBut I will wait and see. At least my quick and dirty implementation gives a way to check the results of better code.",
    "created_at": "2015-10-09T17:28:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216490",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:23'></a>Well, counting linear extensions is #P-problem, I think. Of course it's complexity can still be `O(1.001^n)`...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216492",
...
```json
{
    "body": "<a id='comment:26'></a>?? Current version is written by me. (But of course it is trivial modification that just basically still counts all linear extensions.)",
    "created_at": "2016-07-12T08:23:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216493",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:26'></a>?? Current version is written by me. (But of course it is trivial modification that just basically still counts all linear extensions.)
...
```json
{
    "body": "<a id='comment:27'></a>I was just cleaning a few invalid author fields. Please change it.",
    "created_at": "2016-07-12T08:24:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216494",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:27'></a>I was just cleaning a few invalid author fields. Please change it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216495",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>I am still intending on figuring out the 'right' way to do this. After recently realizing I can make the method be on the Hasse diagram, and can assume that I'm working with a naturally labelled poset on `0...n-1` with a dictionary of covering relations, I should be able to make it work.",
    "created_at": "2016-07-12T13:27:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216496",
    "user": "https://github.com/kevindilks"
}
```

<a id='comment:29'></a>I am still intending on figuring out the 'right' way to do this. After recently realizing I can make the method be on the Hasse diagram, and can assume that I'm working with a naturally labelled poset on `0...n-1` with a dictionary of covering relations, I should be able to make it work.
...
```json
{
    "body": "<a id='comment:30'></a>I don't quite understand. AFAIK it is proved that counting linear extensions is in `#P`, and according to http://link.springer.com/chapter/10.1007%2F11537311_39 there is an algorithm that lists them in linear time.\n\nWe can trivially reduce time by doing series-parallel decomposition first. It won't help on average.\n\nSo do you have some good algorithm in mind? Being in `#P` does not mean that `k` could not be improved in `O(k^n)`.",
    "created_at": "2016-07-12T14:07:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216497",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:30'></a>I don't quite understand. AFAIK it is proved that counting linear extensions is in `#P`, and according to http://link.springer.com/chapter/10.1007%2F11537311_39 there is an algorithm that lists them in linear time.
...
```json
{
    "body": "<a id='comment:32'></a>?? Isn't the concept of `#P` about counting something? And http://link.springer.com/article/10.1007/BF00383444 seems to say that too. It is trivial to say that listing them takes more than polynomial time.\n\nOf course there are easy answers for some posets. For the ordinal sum of `P` and `Q` the count is just product.\n\nBut I will wait for the code and see.\n\nE: Something in lattice of ideals - but every ideal corresponds to an antichain, and counting antichains is in `#P` I think.",
    "created_at": "2016-07-12T18:07:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216499",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:32'></a>?? Isn't the concept of `#P` about counting something? And http://link.springer.com/article/10.1007/BF00383444 seems to say that too. It is trivial to say that listing them takes more than polynomial time.
...
```json
{
    "body": "<a id='comment:34'></a>Very interesting! Must think about this.\n\nAnd `as_ideals=False` will get still more speed.",
    "created_at": "2016-07-12T19:44:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216501",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:34'></a>Very interesting! Must think about this.
...
```json
{
    "body": "<a id='comment:36'></a>I guess this is worth reading about order ideals lattice: http://www.sciencedirect.com/science/article/pii/S0166218X00002584",
    "created_at": "2016-07-13T18:40:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216503",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:36'></a>I guess this is worth reading about order ideals lattice: http://www.sciencedirect.com/science/article/pii/S0166218X00002584
...
```json
{
    "body": "<a id='comment:38'></a>Does that mean that `order_ideals_lattice()` will have an option to get a lattice with plain integers as elements? If so, we should now deprecate `as_ideal` keyword, as it is plain Boolean value. Or at least it sounds funny to have `as_ideal` with possible values `True`, `False` and `'integers'`.",
    "created_at": "2016-07-15T06:32:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216505",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:38'></a>Does that mean that `order_ideals_lattice()` will have an option to get a lattice with plain integers as elements? If so, we should now deprecate `as_ideal` keyword, as it is plain Boolean value. Or at least it sounds funny to have `as_ideal` with possible values `True`, `False` and `'integers'`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216506",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216507",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>Shall we then accept this solution, and later think about optimizing this in two different ways?\n\nSeries-parallel decomposition could be a good thing anyways.",
    "created_at": "2016-07-15T06:59:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216508",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:40'></a>Shall we then accept this solution, and later think about optimizing this in two different ways?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216509",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39855"
}
```
...
```json
{
    ...
    "milestone": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39856"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>ok, looks good to me.",
    "created_at": "2016-07-28T07:38:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216512",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:43'></a>ok, looks good to me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216513",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216514",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216515",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14126#event-39857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14126#issuecomment-216516",
    "user": "https://github.com/vbraun"
}
```
