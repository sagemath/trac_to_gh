...
<a id='comment:1'></a>You should make sure to provide an interface to `simplicial_complexes.ChessboardComplex(r,s)`: your `Board` class could have a `simplicial_complex` method (or something similar) which returns the complex. Actually, you could do this:
