...
```json
{
    "body": "<a id='comment:8'></a>\nI've made `FreeAlgebra` inherit from `CombinatorialFreeModule`; it was close enough to it to begin with and is something Nicolas and I have wanted to do. I've had to hack together a combination of `CombinatorialFreeModuleElement` and `AlgebraElement` to pass a doctest in `matrix0.pyx` where `FreeAlgebra` is used as a base ring (this inspired #15947). So iterating through an element of `FreeAlgera` gives `index,coeff` now (finally consistency! this had bugged me a few times). I've also added a `variables` method as I don't think it does much harm to have it and `support` returns the monomials that occur.\n\nRegarding point 2, you can now use the `monomial_coefficients()` to iterate over pairs (monomial in free algebra, coefficient)] (well...TBH actually it's a `dict`, so you need an additional `items()`). Also I agree with Nils' opinion.\n\n---\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[771ac4c](http://git.sagemath.org/sage.git/commit/?id=771ac4cfefe832d4db2f24e5d5ee74b75b7447a8)|`Converted FreeAlgebra to inherit from CombinatrialFreeModule.`|\n|[a2d1f8d](http://git.sagemath.org/sage.git/commit/?id=a2d1f8df3751dc79eeab62ad65dbaf5f36c546a6)|`Fixes for coercion maps.`|\n|[5045cc5](http://git.sagemath.org/sage.git/commit/?id=5045cc5ffff734b87c76fe980ccbb8ec23e937a4)|`pyflakes cleanup of free_algebra.py.`|\n|[b52e779](http://git.sagemath.org/sage.git/commit/?id=b52e779d8a15c4ff277abc39bdc4e15e2f658f74)|`Merge branch 'develop' into public/algebras/fix_free_algebras-14848`|\n|[c250702](http://git.sagemath.org/sage.git/commit/?id=c25070237ed2ae8360999bc8b4c1f6aea1fe33c5)|`(Hack) Fix for making FreeAlgebraElement work as a base ring for matrices.`|\n|[0de106a](http://git.sagemath.org/sage.git/commit/?id=0de106a5831e0a06e9f8f050f35b15d2d3494981)|`Added variables() method to free module elements.`|",
    "created_at": "2014-04-02T01:22:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14848",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[23d8c7b](http://git.sagemath.org/sage.git/commit/?id=23d8c7b0b0204d3b93e67969bfc7f4dccaeb5be6)|`Merge branch 'develop' into public/algebras/fix_free_algebras-14848`|",
    "created_at": "2014-04-02T01:26:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14848",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[51b2e5f](http://git.sagemath.org/sage.git/commit/?id=51b2e5fc7e35b1bcfeedb5bc033f7d84db059345)|`Merge branch 'develop' into public/algebras/fix_free_algebras-14848`|\n|[9f49f2f](http://git.sagemath.org/sage.git/commit/?id=9f49f2f52c1125c8fd32f79a0f25f0032bd6ead3)|`Merge branch 'develop' into public/algebras/fix_free_algebras-14848`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[74734db](http://git.sagemath.org/sage.git/commit/?id=74734db11fe788440775741de7519e9f2b7f7956)|`Fixed failing doctests.`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[9899a9c](http://git.sagemath.org/sage.git/commit/?id=9899a9cfd908d43157791e39d31f73caa13a2dca)|`Fixing doctests in quotient_ring.py and ring.pyx.`|\n|[073b577](http://git.sagemath.org/sage.git/commit/?id=073b57717fe266dc3e6294a93438c0009f4416bc)|`Fixed dict ordering doctests.`|\n|[0f9bf9d](http://git.sagemath.org/sage.git/commit/?id=0f9bf9dbdd714429fd290f8c42811e143ca5d70e)|`Fixed remaining doctests.`|",
    "created_at": "2014-04-22T16:11:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14848",
    "type": "issue_comment",
