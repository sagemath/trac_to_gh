...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14356#issuecomment-221955",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>It seems that this is a rather common use of posets: You have some objects that refer back to their common container. Now label the poset elements with. This then keeps everything alive.\n\nQuestions:\n* Poset has an optional `key=` argument, but it is seems to be not used by UniqueRepresentation. Whats up with that?\n* Maybe Poset should support for weakly referenced labels?\n* UniqueRepresentations could check that the key does not have a reference to the value for debugging purposes",
    "created_at": "2013-03-25T21:30:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14356#issuecomment-221956",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>It seems that this is a rather common use of posets: You have some objects that refer back to their common container. Now label the poset elements with. This then keeps everything alive.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14356#issuecomment-221957",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14356#event-40702"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14356#event-40703"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14356#event-40704"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14356#event-40705"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14356#event-40706"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>> Poset seems to have explicitly designed to be UniqueRepresentation, so I assume someone really needed that. \n\n\nSomeone also needed those `UniqueRepresentation` objects to be mutable (#14019).\n\nNathann",
    "created_at": "2014-06-17T12:30:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14356#issuecomment-221959",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:9'></a>> Poset seems to have explicitly designed to be UniqueRepresentation, so I assume someone really needed that. 
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14356#event-40707"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14356#event-40708"
}
```
