...
```json
{
    "body": "<a id='comment:20'></a>Well the old branch should be still there, as I said in[comment:12](#comment%3A12)",
...
<a id='comment:20'></a>Well the old branch should be still there, as I said in[comment:12](#comment%3A12)
...
<a id='comment:34'></a>Replying to [jdemeyer](#comment%3A27):
> The result should be `y^3` as in:
> 
> ```
> sage: f(x) = y^3
