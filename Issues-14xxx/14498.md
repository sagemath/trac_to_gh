...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14498#event-188245"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14498#event-188246"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14498#event-188247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14498#event-188248"
}
```
...
```json
{
    "body": "<a id='comment:29'>Comment 29:</a>\nI have just uploaded [(to be applied after [attachment: trac_14498-algorithms_trees-rebased.patch.gz](https://github.com/sagemath/sage/files/ticket14498/trac_14498-algorithms_trees-rebased.patch.gz)(https://github.com/sagemath/sage/files/ticket14498/d7b0fb71dce22dc90217d4ddaaae317e.gz)) which should fix #15060 and clear up some of the vertex-vs.-node confusion on binary trees. Can anyone look over it and tell me if I got things right? I cannot really start reviewing this patch before this is sorted out.",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -24,3 +24,4 @@\n Apply:\n \n * [attachment: trac_14498-algorithms_trees-rebased.patch\u200b.gz](https://github.com/sagemath/sage/files/ticket14498/a9724994dc59e4f2e4bf8527b911d452.gz)\n+* [attachment: trac_14498-tree-imps-dg.patch\u200b.gz](https://github.com/sagemath/sage/files/ticket14498/2fac5418f8710942133dffa298017d13.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14498#issuecomment-177836",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14498#issuecomment-177837",
    "user": "https://github.com/fchapoton"
}
```
