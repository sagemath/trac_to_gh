...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237443",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237444",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237445",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237446",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237447",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237448",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237449",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237450",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237451",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237452",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237453",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>afa7de7Merge branch 'python_sage_build' into sagelib</tr><tr>848bef8Merge branch 'libgap_include' into sagelib</tr><tr>f77e13cpython-sage: env</tr><tr>29f8f3epython-sage build system continued/cleanup</tr><tr>f2d1c37integrate sagelib build systems into old toplevel</tr><tr>f5261c6bump libgap package patchlevel</tr><tr>318138eapply patches from patchdir</tr><tr>28b0da1python-sage build system</tr></table>\n",
    "created_at": "2013-09-01T11:23:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237454",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237455",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237456",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>d4e1833Merge branches 'sage_doc', 'python_sage_build' and 'csage_build_system' into sagelib</tr><tr>1f3f7e4Merge branches 'cython_dbg' and 'cython_deps' into python_sage_build</tr><tr>42449c1python-sage doctest path tolerance</tr><tr>ae8bb63python-sage: env</tr><tr>5a16d99python-sage build system</tr><tr>79cf599sage-bin env</tr><tr>3ff5c49sagelib: environment for check target</tr><tr>ffe9b9dsage-doc. use SAGE_DOC_SRC as doc source path</tr><tr>2df5bfcsage-doc: build system. mostly dist</tr><tr>510f8b7Merge branch 'gmp_mpir' into csage_build_system</tr><tr>0d50108provide gmpxx_or_mpirxx.h (required by sage-python)</tr><tr>1e4789fcsage: gmp_or_mpir fixup</tr><tr>926e3f7build autotools before csage</tr><tr>d4e9997Merge branch 'autotools' into csage_build_system</tr><tr>f82b422cython: patch: gdb output dir option</tr><tr>72c4538add more autotools executables</tr><tr>bd11c24cython: add -MF switch to write dependency files (#14728)</tr></table>\n",
    "created_at": "2013-09-02T20:14:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237457",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237458",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237459",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237460",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237461",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>2646f0dMerge branch 'runtime_paths' into sagelib</tr><tr>0d3cfcdbuild/deps</tr><tr>30fb726sagelib build system</tr><tr>b2415daprovide sage-sh within sage-the-distribution</tr><tr>8de880cfix a typo</tr><tr>39f7247ellcurve data dir fixup</tr><tr>0b9cb04doctests in src/sage/plot/misc.py</tr><tr>1ef62a1unhardwire cython.py completed</tr><tr>390e28bqepcard doctest fix: singular might well be in /usr/bin, not .../local/bin</tr><tr>0dcd721unhardwire ELLCURVES_DATA_DIR</tr><tr>591471dpython-sage: whitelist python2.7 multiprocessing in stackframes test</tr><tr>c19a5f3unhardwire sandpile</tr><tr>5746289unhardwire polymake path</tr></table>\n",
    "created_at": "2013-09-06T14:38:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237462",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>1c89552cython doctest</tr><tr>ef8771ddependency chain in build/deps</tr><tr>7aaf953Merge 'trac/u/ohanar/build_system' into sagelib</tr></table>\n",
    "created_at": "2013-09-08T09:27:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237463",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237464",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237465",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237466",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>0e91a83Merge branches 'sage-bin' and 'python_sage_build' into sagelib</tr><tr>e429991inject proper paths into autotools calls</tr><tr>41326b4sagelib: freeze (parts of) environment during configure</tr><tr>ec442e5always use autotools within sage (\"the distribution\")</tr><tr>26c67b2python-sage: make cython call more toolchain friendly</tr><tr>69fda9aMerge remote-tracking branch 'trac/u/ohanar/build_system' into sage-bin</tr><tr>f9f8d16sage-bin: remove PATH_REDUNDANCY cruft</tr><tr>3e2aeb1transition from old toplevel. create symlinks, for now.</tr><tr>e0064c9sage-bin expand SAGE_ETC correctly</tr><tr>fcb670fsimplify python byte compile rules</tr><tr>2af9070GMP_VS_MPIR fixup</tr><tr>45a30e1provide unhardwired SAGE_CFLAGS</tr><tr>e195725python-sage: Makefiles</tr><tr>c4562b3python_sage: build system continued</tr><tr>6d074eesage-bin: more config files</tr></table>\n",
    "created_at": "2013-09-12T08:36:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237467",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>fc097b0build/deps fixup</tr><tr>88a4478Merge branch 'python_sage_build' into sagelib</tr><tr>1dacfa5python-sage: Makefiles update for 512beta4</tr><tr>cb27876python-sage: Makefiles fix</tr></table>\n",
    "created_at": "2013-09-12T10:07:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237468",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237469",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237470",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237471",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48865"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48866"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48867"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48868"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48869"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237472",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237473",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237474",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237475",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237476",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237477",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237478",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237479",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237480",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237481",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237482",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237483",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237484",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237485",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237486",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237487",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237488",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237489",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237490",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48870"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237491",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237492",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237493",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14807#event-48872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14807#issuecomment-237494",
    "user": "https://github.com/kiwifb"
}
```
