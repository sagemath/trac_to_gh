...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182679",
...
```json
{
    "body": "<a id='comment:1'></a>Only one issue per ticket please. I've opened #14012 for your other issue.",
    "created_at": "2013-01-25T17:48:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182680",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>Only one issue per ticket please. I've opened #14012 for your other issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182681",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Does that work for you?",
    "created_at": "2013-01-25T18:39:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182682",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Does that work for you?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182683",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182684",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I've added a check for finitely presented groups that the values do satisfy the relations. Also, more documentation. I'm fine with the ticket, its your job to review now ;-)",
    "created_at": "2013-01-26T12:13:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182685",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>I've added a check for finitely presented groups that the values do satisfy the relations. Also, more documentation. I'm fine with the ticket, its your job to review now ;-)
...
```json
{
    "body": "<a id='comment:5'></a>The changes are good in my opinion. I am just waiting for my colleague, who is actually using these set of patches, to give me relevant feedback. If his feedback is positive then I will set this to a positive review.",
    "created_at": "2013-01-27T10:49:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182686",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:5'></a>The changes are good in my opinion. I am just waiting for my colleague, who is actually using these set of patches, to give me relevant feedback. If his feedback is positive then I will set this to a positive review.
...
```json
{
    "body": "<a id='comment:6'></a>Ok. My friend (doesn't have an account here) is happy with this implementation. So, setting it to positive review.",
    "created_at": "2013-01-28T13:26:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182687",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:6'></a>Ok. My friend (doesn't have an account here) is happy with this implementation. So, setting it to positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182688",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14010#issuecomment-182689",
