...
```json
{
    "body": "<a id='comment:1'></a>This is an IPython bug imho. It has been introduced in https://github.com/ipython/ipython/issues/1394/",
...
<a id='comment:1'></a>This is an IPython bug imho. It has been introduced in https://github.com/ipython/ipython/issues/1394/
...
```json
{
    "body": "<a id='comment:2'></a>Also, why is it a problem? We now check in the Python spkg that `_ctypes` can be imported.",
...
<a id='comment:2'></a>Also, why is it a problem? We now check in the Python spkg that `_ctypes` can be imported.
...
```json
{
    "body": "<a id='comment:8'></a>python3's `spkg-configure.m4` checks for ctypes.",
    "created_at": "2021-10-04T23:15:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14309",
    "type": "issue_comment",
...
<a id='comment:8'></a>python3's `spkg-configure.m4` checks for ctypes.
