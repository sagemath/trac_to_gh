...
```json
{
    "body": "<a id='comment:2'></a>I can indeed repodruce the problem.",
    "created_at": "2013-02-05T11:04:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215120",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:2'></a>I can indeed repodruce the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215123",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>What is the original purpose of fast_tp_dealloc? If I understand it correctly, if there is enough room left on the stack, then dead integers are put there (and I guess get freed in a whole bunch, which is cheaper than freeing them one by one), otherwise fast_tp_dealloc explicitly removes them.\n\nAnd I see that the Integer class has a `__dealloc__` method; but it seems that \n\n```\nhook_tp_functions(global_dummy_Integer, NULL, <newfunc>&fast_tp_new, NULL, &fast_tp_dealloc, False)\n```\nis then used to override the __dealloc__, or what?\n\nAnd concerning the global_dummy_Integer, I see the comment\n\n```\n# We use a global Integer element to steal all the references\n# from.  DO NOT INITIALIZE IT AGAIN and DO NOT REFERENCE IT!\ncdef Integer global_dummy_Integer\nglobal_dummy_Integer = Integer()\n```\n\nSounds like black magic to me. Robert, can you elaborate how it all works?",
    "created_at": "2013-02-05T12:03:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215124",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>What is the original purpose of fast_tp_dealloc? If I understand it correctly, if there is enough room left on the stack, then dead integers are put there (and I guess get freed in a whole bunch, which is cheaper than freeing them one by one), otherwise fast_tp_dealloc explicitly removes them.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215125",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Interesting. When I add a print statement to the beginning of fast_tp_new and fast_tp_dealloc then the crash vanishes.",
    "created_at": "2013-02-05T12:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215126",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>Interesting. When I add a print statement to the beginning of fast_tp_new and fast_tp_dealloc then the crash vanishes.
...
```json
{
    "body": "<a id='comment:9'></a>The Integer's `__cinit__` method gets called 7 times at startup -- even though it appears to get overriden by the hook_tp_functions line. When one creates an integer *after* startup, then only fast_tp_new is called, but not `__cinit__`. And `__dealloc__` never gets called.",
    "created_at": "2013-02-05T12:36:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215127",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>The Integer's `__cinit__` method gets called 7 times at startup -- even though it appears to get overriden by the hook_tp_functions line. When one creates an integer *after* startup, then only fast_tp_new is called, but not `__cinit__`. And `__dealloc__` never gets called.
...
```json
{
    "body": "<a id='comment:10'></a>I wonder about this message when Sage crashes:\n\n```\n    The 7 pad bytes at p-7 are not all FORBIDDENBYTE (0xfb):\n        at p-7: 0xcb *** OUCH\n        at p-6: 0xcb *** OUCH\n        at p-5: 0xcb *** OUCH\n        at p-4: 0xcb *** OUCH\n        at p-3: 0xcb *** OUCH\n        at p-2: 0xcb *** OUCH\n        at p-1: 0xcb *** OUCH\n```\nCould it be that fast_tp_new writes to the wrong location when it does\n\n```\n        (<__mpz_struct *>( <char *>new + mpz_t_offset) )._mp_d = <mp_ptr>mpz_alloc(GMP_LIMB_BITS >> 3)\n```\n?",
    "created_at": "2013-02-05T12:47:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215128",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>I wonder about this message when Sage crashes:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215131",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215132",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I did not say it could solve the segfault :)\nIn fact it should do basically the same thing as before, but using the proper functions.",
    "created_at": "2013-02-05T16:09:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215133",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:16'></a>I did not say it could solve the segfault :)
In fact it should do basically the same thing as before, but using the proper functions.
...
```json
{
    "body": "<a id='comment:17'></a>The problem occurs when deallocating ONE, which is allocated before the hooks are setup, with the hooked method.\n\nCreating ONE after hooking up the method (seemingly) solves the problem.",
    "created_at": "2013-02-05T16:17:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215134",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:17'></a>The problem occurs when deallocating ONE, which is allocated before the hooks are setup, with the hooked method.
...
```json
{
    "body": "<a id='comment:19'></a>Hummm, I don't see the Py_INCREF(ONE) you mention in the ticket description in my 5.7.beta1 and 5.7.beta2 install (it is in my 5.6 install).",
    "created_at": "2013-02-05T16:29:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215136",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:19'></a>Hummm, I don't see the Py_INCREF(ONE) you mention in the ticket description in my 5.7.beta1 and 5.7.beta2 install (it is in my 5.6 install).
...
```json
{
    "body": "<a id='comment:20'></a>That's \"because\" of #12615.",
    "created_at": "2013-02-05T16:30:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215137",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:20'></a>That's "because" of #12615.
...
```json
{
    "body": "<a id='comment:21'></a>And it was indeed merged in 5.7.beta1.",
    "created_at": "2013-02-05T16:30:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215138",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:21'></a>And it was indeed merged in 5.7.beta1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215139",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215140",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>I'm speaking of line 5651 which was removed in #12615 and was the fix of #2435.",
    "created_at": "2013-02-05T16:41:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215141",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:24'></a>I'm speaking of line 5651 which was removed in #12615 and was the fix of #2435.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215142",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>We should also get rid of ONE as we now have one.\n\nAnd I'm not sure what the remaining Py_INCREF really is for...\nDoes not the assignment automatically increase the refcount?",
    "created_at": "2013-02-05T16:48:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215143",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:26'></a>We should also get rid of ONE as we now have one.
...
```json
{
    "body": "<a id='comment:27'></a>Don't really now why, but the other integers are cdef'ed which I guess is why they don't cause trouble.\nSee http://trac.sagemath.org/sage_trac/ticket/2435#comment:4",
    "created_at": "2013-02-05T16:52:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215144",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:27'></a>Don't really now why, but the other integers are cdef'ed which I guess is why they don't cause trouble.
See http://trac.sagemath.org/sage_trac/ticket/2435#comment:4
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215145",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215146",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>About the other INCREF, unfortunately:\nhttp://trac.sagemath.org/sage_trac/ticket/2435#comment:6",
    "created_at": "2013-02-05T16:56:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215147",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:30'></a>About the other INCREF, unfortunately:
http://trac.sagemath.org/sage_trac/ticket/2435#comment:6
...
```json
{
    "body": "<a id='comment:31'></a>I think the removal of #12615 is a typo, it really makes no sense.",
    "created_at": "2013-02-05T16:59:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215148",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:31'></a>I think the removal of #12615 is a typo, it really makes no sense.
...
```json
{
    "body": "<a id='comment:32'></a>With the patch, sage starts and quits without a crash. I don't know if it is ready for review, but you may have a look.",
    "created_at": "2013-02-05T17:05:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215149",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:32'></a>With the patch, sage starts and quits without a crash. I don't know if it is ready for review, but you may have a look.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215150",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215151",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Anyway, I think we should wait for Robert feedback.",
    "created_at": "2013-02-05T17:12:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215153",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:34'></a>Anyway, I think we should wait for Robert feedback.
...
```json
{
    "body": "<a id='comment:36'></a>Any clue on how to speak with GDB before Sage is initialized?",
    "created_at": "2013-02-05T18:47:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215155",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:36'></a>Any clue on how to speak with GDB before Sage is initialized?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215158",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215160",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Robert, do you agree that letting global_dummy_Integer be the only integer created without pool and with `__cinit__` is a valid solution?",
    "created_at": "2013-02-05T21:43:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215161",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:42'></a>Robert, do you agree that letting global_dummy_Integer be the only integer created without pool and with `__cinit__` is a valid solution?
...
```json
{
    "body": "<a id='comment:43'></a>Concerning removal of the INCREF: I could imagine removing it is a bad idea. After all, the allocator appears to be of general use. Hence, we have no guarantee that in other (potential) uses of sage.misc.allocator we could guarantee *externally* that the dummy will live forever.\n\nPlus: hook_tp_functions (and thus Py_INCREF) is called exactly once. I don't think that the slowdown caused by it really matters...",
    "created_at": "2013-02-05T21:48:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215162",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:43'></a>Concerning removal of the INCREF: I could imagine removing it is a bad idea. After all, the allocator appears to be of general use. Hence, we have no guarantee that in other (potential) uses of sage.misc.allocator we could guarantee *externally* that the dummy will live forever.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215163",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>In fact I don't even feel that it is necessary to ensure that the global dummy never gets collected.\nI mean what's the matter if it gets collected when Sage quits and we are sure no other Integer will be created ?\nThis should be the case for a more general use of sage/misc/allocator.pyx whence the unnecessity of the INCREF in general.",
    "created_at": "2013-02-05T22:47:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215164",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:45'></a>In fact I don't even feel that it is necessary to ensure that the global dummy never gets collected.
I mean what's the matter if it gets collected when Sage quits and we are sure no other Integer will be created ?
This should be the case for a more general use of sage/misc/allocator.pyx whence the unnecessity of the INCREF in general.
...
```json
{
    "body": "<a id='comment:46'></a>Here comes another proposition of patch.",
    "created_at": "2013-02-05T22:57:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215165",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:46'></a>Here comes another proposition of patch.
...
```json
{
    "body": "<a id='comment:48'></a>The alternative patch is incomplete: It removes ONE, but it does not change the import line \"from sage.rings.integer import ONE\" in sage/structure/factorization_integer.py.\n\nIt seems to me that the alternative patch is not essentially different from the original patch, but mainly adds more comments - or did I miss something? Could you turn it into a referee patch?",
    "created_at": "2013-02-05T23:24:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215167",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:48'></a>The alternative patch is incomplete: It removes ONE, but it does not change the import line "from sage.rings.integer import ONE" in sage/structure/factorization_integer.py.
...
```json
{
    "body": "<a id='comment:49'></a>Yup, I'll do that.",
    "created_at": "2013-02-05T23:26:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215168",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:49'></a>Yup, I'll do that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215169",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:50'></a>Attachment [trac_14059.patch](tarball://root/attachments/some-uuid/ticket14059/trac_14059.patch) by jpflori created at 2013-02-05 23:37:05\n\nIf Robert has any comment, feel free to change the status of the ticket or enlighten us.",
    "created_at": "2013-02-05T23:37:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215170",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:50'></a>Attachment [trac_14059.patch](tarball://root/attachments/some-uuid/ticket14059/trac_14059.patch) by jpflori created at 2013-02-05 23:37:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215171",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215172",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215173",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:51'></a>One question: Why is it a problem that ONE was created via `__cinit__` but deleted via `fast_tp_dealloc`? After all, if the pool is not involved, this function does the same as `__dealloc__` plus decref. Isn't that the same as without the hooks?",
    "created_at": "2013-02-06T10:59:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215174",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:51'></a>One question: Why is it a problem that ONE was created via `__cinit__` but deleted via `fast_tp_dealloc`? After all, if the pool is not involved, this function does the same as `__dealloc__` plus decref. Isn't that the same as without the hooks?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215175",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:53'></a>So our workaround here is just to make sure that Integer allocated before the hooks are setup do not get deallocated, even when Sage start.\n\nIt has two flavours:\n* cdef the Integer, so there is no automatic collection,\n* artificially increase its refcount so that it never reaches zero.\n\nAnd we use both.",
    "created_at": "2013-02-06T11:11:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215176",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:53'></a>So our workaround here is just to make sure that Integer allocated before the hooks are setup do not get deallocated, even when Sage start.
...
```json
{
    "body": "<a id='comment:56'></a>Because I guess that all cdef'ed classes are created with GC enabled (by default?).",
    "created_at": "2013-02-06T16:24:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215179",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:56'></a>Because I guess that all cdef'ed classes are created with GC enabled (by default?).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215180",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:58'></a>Don't know.\nMaybe speed?\n\nAs you can see in sage/misc/allocator.pyx we pass a flag to explicitely disable GC.",
    "created_at": "2013-02-06T17:00:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215181",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:58'></a>Don't know.
Maybe speed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14059#issuecomment-215184",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14059",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14059#event-39561"
}
```
