...
```json
{
    "body": "<a id='comment:2'></a>\nHi Franco,\n\nThe patch is basically ready to go now. Could you please look over my changes? Also, there is one method which is currently broken (namely `_plot_color_`edges), which would still be good to have around.\n\nThanks!\n\nAnne",
