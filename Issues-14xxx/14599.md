...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14599#event-41591"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14599#event-41592"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14599#event-41593"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14599#event-41594"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14599#event-41595"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14599#event-41596"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14599#event-41597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227519",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227520",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227521",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227522",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227523",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227525",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227526",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227527",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Hmm, maybe you can add some of those to the tests/examples; at any rate, currently your branch has only one *non*-example, not examples of how to use this.  Or, if you have a pretty extensive suite, there are a couple testing-only files out there that could be added to - we love tests!",
    "created_at": "2014-11-12T18:23:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227528",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Hmm, maybe you can add some of those to the tests/examples; at any rate, currently your branch has only one *non*-example, not examples of how to use this.  Or, if you have a pretty extensive suite, there are a couple testing-only files out there that could be added to - we love tests!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227529",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227530",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227532",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>the problem is probably that the plot object is invalid (it can't actually show a plot). Because there is insufficient validation this only causes issues later when you actually try to plot it.",
    "created_at": "2015-02-04T01:04:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227533",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>the problem is probably that the plot object is invalid (it can't actually show a plot). Because there is insufficient validation this only causes issues later when you actually try to plot it.
...
```json
{
    "body": "<a id='comment:14'></a>Hmm, that makes sense.  I have to say that the error is a little cryptic.",
    "created_at": "2015-02-04T01:09:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227534",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>Hmm, that makes sense.  I have to say that the error is a little cryptic.
...
```json
{
    "body": "<a id='comment:15'></a>Removing the \"beginner\" tag from old tickets. Some could be returned to beginner-friendly status by adding a comment about what needs to be done. Some others might be easy for an experienced developer to finish.",
    "created_at": "2020-05-27T03:04:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227535",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:15'></a>Removing the "beginner" tag from old tickets. Some could be returned to beginner-friendly status by adding a comment about what needs to be done. Some others might be easy for an experienced developer to finish.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14599#issuecomment-227536",
    "user": "https://github.com/DaveWitteMorris"
}
```
