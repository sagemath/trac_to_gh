...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -3,3 +3,5 @@\n As shown in the paper, the cycle index of the arithmetic product F\u22a1G can be computed in terms of the cycle indices of the species F and G. The attached patch adds code to calculate the result of this operation. It includes a doctest which verifies a nontrivial computation related to the species of \"regular octopuses\".\n \n * Maia, Manuel and M\u00e9ndez, Miguel. On the arithmetic product of combinatorial species. 1 February 2008. http://arxiv.org/abs/math/0503436\n+\n+Apply [attachment:trac_14542_cycle_index_arithmetic_product.patch](https://github.com/sagemath/sage/files/ticket14542/trac_14542_cycle_index_arithmetic_product.patch)\n``````\n",
    "created_at": "2013-05-06T20:45:34Z",
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178533",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-126607"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178534",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178535",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178536",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178537",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178538",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14542/trac_14542_cycle_index_arithmetic_product.patch",
    "created_at": "2013-06-15T19:50:56Z",
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14542/trac_14542_cycle_index_arithmetic_product.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178540",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178541",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178542",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14542/trac_14542-review-dg.patch",
    "created_at": "2013-07-29T18:00:00Z",
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14542/trac_14542-review-dg.patch",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178544",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178545",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-126608"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-126609"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178546",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178547",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178548",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-126610"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-126611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178549",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178550",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178551",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178552",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-126612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-126613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178553",
    "user": "https://trac.sagemath.org/admin/accounts/users/agd"
}
```
