...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182281"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182284"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,3 +3,5 @@\n As shown in the paper, the cycle index of the arithmetic product F\u22a1G can be computed in terms of the cycle indices of the species F and G. The attached patch adds code to calculate the result of this operation. It includes a doctest which verifies a nontrivial computation related to the species of \"regular octopuses\".\n \n * Maia, Manuel and M\u00e9ndez, Miguel. On the arithmetic product of combinatorial species. 1 February 2008. http://arxiv.org/abs/math/0503436\n+\n+Apply [attachment: trac_14542_cycle_index_arithmetic_product.patch.gz](https://github.com/sagemath/sage/files/ticket14542/trac_14542_cycle_index_arithmetic_product.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182287"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182288"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178618",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14542#event-182291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14542#issuecomment-178619",
    "user": "https://github.com/sagetrac-agd"
}
```
