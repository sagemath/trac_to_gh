...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42787"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42788"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42789"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42790"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42791"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14886#issuecomment-199346",
    "user": "https://github.com/canozanoguz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14886#issuecomment-199347",
    "user": "https://github.com/canozanoguz"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42792"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42793"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>You should make that into a branch and upload it to trac (and add your real name to the authors field). :)",
    "created_at": "2018-07-27T13:45:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14886#issuecomment-199348",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>You should make that into a branch and upload it to trac (and add your real name to the authors field). :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14886#issuecomment-199349",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42794"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14886#event-42795"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14886#issuecomment-199350",
...
```json
{
    "body": "<a id='comment:10'></a>Here is a more basic bug:\n\n```\nsage: S = QQ['t'].fraction_field()                       \nsage: F.<x,y> = FreeAlgebra(S)                   \nsage: S(F.zero())\n```\n\nand even more simple:\n\n```\nsage: F=FreeAlgebra(QQ,'x')                                                     \nsage: QQ(F.zero()) \n```",
    "created_at": "2020-09-18T08:32:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14886#issuecomment-199351",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:10'></a>Here is a more basic bug:
...
```json
{
    "body": "<a id='comment:11'></a>#16567 solves this now. Please review it",
    "created_at": "2021-10-26T16:30:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14886#issuecomment-199352",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:11'></a>#16567 solves this now. Please review it
