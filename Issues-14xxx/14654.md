...
```json
{
    "body": "Changed assignee from **@sagetrac-sage-combinat** to **@sagetrac-graphcomponentowner**",
...
Changed assignee from **@sagetrac-sage-combinat** to **@sagetrac-graphcomponentowner**
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14654#event-190657"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14654#event-190658"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14654#event-190659"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14654",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14654#event-190660"
}
```
