...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221628",
...
```json
{
    "body": "<a id='comment:2'></a>This patch isn't compatible with #10508, and goodness knows that ticket doesn't need any more dependencies... is it okay to ask to rebase to a \"needs work\" ticket?   Maybe the version with `python` as John suggested?   Or the filter version you mentioned in the relevant thread, if you think that one is better (though perhaps it's harder to understand what it's doing).",
    "created_at": "2013-03-23T02:29:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221629",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>This patch isn't compatible with #10508, and goodness knows that ticket doesn't need any more dependencies... is it okay to ask to rebase to a "needs work" ticket?   Maybe the version with `python` as John suggested?   Or the filter version you mentioned in the relevant thread, if you think that one is better (though perhaps it's harder to understand what it's doing).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221630",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_14344-installed-packages.patch](tarball://root/attachments/some-uuid/ticket14344/trac_14344-installed-packages.patch) by @kini created at 2013-03-23 02:35:13\n\nHow's this patch?\n\nThe filter thing I posted on sage-devel is semantically nicer, IMO, but I agree it looks pretty ugly and hard to read in Python, and this test isn't exactly run in a tight loop so performance is sort of irrelevant :)",
    "created_at": "2013-03-23T02:35:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221631",
    "user": "https://github.com/kini"
}
```

<a id='comment:3'></a>Attachment [trac_14344-installed-packages.patch](tarball://root/attachments/some-uuid/ticket14344/trac_14344-installed-packages.patch) by @kini created at 2013-03-23 02:35:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221633",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221634",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221635",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221636",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>This is such a tiny patch, I really couldn't complain about any time being wasted :) Since you've given this positive review, I'll go rebase the patch at #10508 on this.",
    "created_at": "2013-03-23T03:35:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221637",
    "user": "https://github.com/kini"
}
```

<a id='comment:7'></a>This is such a tiny patch, I really couldn't complain about any time being wasted :) Since you've given this positive review, I'll go rebase the patch at #10508 on this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221638",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221639",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14344#issuecomment-221640",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14344",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14344#event-40659"
}
```
