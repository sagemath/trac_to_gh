...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174601",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174602",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174603",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_14344-installed-packages.patch](https://github.com/sagemath/sage/files/ticket14344/trac_14344-installed-packages.patch) by @kini created at 2013-03-23 02:35:13\n\nHow's this patch?\n\nThe filter thing I posted on sage-devel is semantically nicer, IMO, but I agree it looks pretty ugly and hard to read in Python, and this test isn't exactly run in a tight loop so performance is sort of irrelevant :)",
    "created_at": "2013-03-23T02:35:13Z",
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174604",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174605",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174606",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174607",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174608",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14344#issuecomment-174609",
