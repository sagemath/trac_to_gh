...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42138"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Isn't LIBRARY_PATH for runtime whereas LD_LIBRARY_PATH is for linking?",
    "created_at": "2013-10-24T06:51:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14709#issuecomment-195980",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:2'></a>Isn't LIBRARY_PATH for runtime whereas LD_LIBRARY_PATH is for linking?
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42139"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42140"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42141"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42142"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42143"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42144"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Not using LIBRARY_PATH any more",
    "created_at": "2017-07-08T22:09:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14709#issuecomment-195981",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>Not using LIBRARY_PATH any more
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14709#issuecomment-195982",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14709",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42145"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42146"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14709#event-42147"
}
```
