...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[5c6bf1c](http://git.sagemath.org/sage.git/commit/?id=5c6bf1ceabd0bc326b08d0c9dd0a74faab1f1d9a)|`hardening doctest against random order of dict keys`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[ba950d5](http://git.sagemath.org/sage.git/commit/?id=ba950d58e47f53f0b9213b6096f1990adb437ab8)|`moved self._clear_cache() into the underscored methods as someone may want to use them`|",
