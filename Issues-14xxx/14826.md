...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14826#issuecomment-183904",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14826#issuecomment-183905",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,6 @@\n This patch implements basic functions on Newton polygons.\n \n A small demo is available here: https://cethop.math.cnrs.fr:8443/home/pub/5/\n+\n+---\n+Apply only [attachment: trac_14826_structure.patch](https://github.com/sagemath/sage/files/ticket14826/trac_14826_structure.patch.gz)\n``````\n",
    "created_at": "2013-08-06T09:27:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14826",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14826#event-193469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14826#event-193470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14826#event-193471"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14826#event-193472"
}
```
