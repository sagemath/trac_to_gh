...
{
    "assignees": [],
    "body": "`sage-cleaner` got completely broken due to incompatible filenames between `sage-cleaner` and the Sage library.\n\n**Apply**:\n1. [attachment: 14055_cleaner_sagelib.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_sagelib.patch.gz) to the Sage library.\n2. [attachment: 14055_simplify_env.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_simplify_env.patch.gz) to the Sage library.\n3. [attachment: trac_14055_maxima_debug.patch.gz](https://github.com/sagemath/sage/files/ticket14055/trac_14055_maxima_debug.patch.gz) to the Sage library.\n4. [attachment: 14055_cleaner.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner.patch.gz) to `local/bin`.\n5. [attachment: 14055_cleaner_hostname.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_hostname.patch.gz) to `local/bin`.\n\nUpdate ECL spkg with http://boxen.math.washington.edu/home/vbraun/spkg/ecl-12.12.1.p3.spkg\n\nAssignee: **@nexttime**\n\nCC:  @ppurka @nbruin\n\nReviewer: **John Palmieri, Leif Leonhardy, Volker Braun**\n\nAuthor: **Jeroen Demeyer, Volker Braun**\n\nMerged: **sage-5.10.beta2**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/14055_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174832"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174835"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174836"
}
```
...
```json
{
    "body": "Changed keywords from **** to **orphans**",
    "created_at": "2013-03-20T15:46:53Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
...
Changed keywords from **** to **orphans**
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,5 @@\n `sage-cleaner` got completely broken due to incompatible filenames between `sage-cleaner` and the Sage library.\n+\n+**Apply**:\n+1. [attachment: 14055_cleaner_sagelib.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_sagelib.patch.gz) to the Sage library.\n+2. [attachment: 14055_cleaner.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner.patch.gz) to `local/bin`.\n``````\n",
...
```json
{
    "body": "Changed keywords from **orphans** to ****",
    "created_at": "2013-03-22T09:31:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
...
Changed keywords from **orphans** to ****
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174837"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174838"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,3 +3,4 @@\n **Apply**:\n 1. [attachment: 14055_cleaner_sagelib.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_sagelib.patch.gz) to the Sage library.\n 2. [attachment: 14055_cleaner.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner.patch.gz) to `local/bin`.\n+3. [attachment: 14055_cleaner_hostname.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_hostname.patch.gz) to `local/bin`.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174842"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,5 +2,6 @@\n \n **Apply**:\n 1. [attachment: 14055_cleaner_sagelib.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_sagelib.patch.gz) to the Sage library.\n-2. [attachment: 14055_cleaner.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner.patch.gz) to `local/bin`.\n-3. [attachment: 14055_cleaner_hostname.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_hostname.patch.gz) to `local/bin`.\n+2. [attachment: 14055_simplify_env.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_simplify_env.patch.gz) to the Sage library.\n+3. [attachment: 14055_cleaner.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner.patch.gz) to `local/bin`.\n+4. [attachment: 14055_cleaner_hostname.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_hostname.patch.gz) to `local/bin`.\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169302",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169303",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169304",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169305",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169306",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169307",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169308",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169309",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169310",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169311",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169312",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169313",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169314",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169315",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169316",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169317",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169318",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:90'>Comment 90:</a>\nCould you remove TAB characters from [attachment: 14055_cleaner_hostname.patch.gz](https://github.com/sagemath/sage/files/ticket14055/14055_cleaner_hostname.patch.gz)",
    "created_at": "2013-04-29T07:32:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169319",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169320",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169321",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169322",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169323",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169324",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174847"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169325",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169326",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169327",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169328",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169329",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169330",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169331",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169332",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169333",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169334",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169335",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169336",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169337",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169338",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169339",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169340",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169341",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169342",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169343",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14055#issuecomment-169344",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14055",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14055#event-174853"
}
```
