...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14634#issuecomment-179969",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14634#issuecomment-179970",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Attachment [trac_14634_fix_includes.patch](https://github.com/sagemath/sage/files/ticket14634/trac_14634_fix_includes.patch) by @vbraun created at 2013-05-23 17:52:29\n\nInitial patch",
    "created_at": "2013-05-23T17:52:29Z",
    "issue": "https://github.com/sagemath/sage/issues/14634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14634#issuecomment-179971",
    "user": "https://github.com/vbraun"
}
```

Attachment [trac_14634_fix_includes.patch](https://github.com/sagemath/sage/files/ticket14634/trac_14634_fix_includes.patch) by @vbraun created at 2013-05-23 17:52:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14634#issuecomment-179972",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14634#issuecomment-179973",
    "user": "https://github.com/vbraun"
}
```
