...
```json
{
    "body": "<a id='comment:2'></a>Fixed by adding missing dependency packages. Will upload spkg tomorrow. \n\nAlso, HAPprime was never included, fixed in the docs. \n\nThe packages cryst isn't included and therefore HAPcryst can't work. I'll leave this for later.",
    "created_at": "2013-07-19T03:31:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234882",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>Fixed by adding missing dependency packages. Will upload spkg tomorrow. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234883",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234884",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234885",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/niles/14909\"",
    "created_at": "2013-07-19T19:29:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234886",
    "user": "https://github.com/nilesjohnson"
}
```

Changing branch from "" to "u/niles/14909"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234888",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Actually, maybe I should leave the \"Branch\" field for the branch which the patch author might submit, so I can be the patch reviewer.  I guess someone who finds it useful can view my commits at\n\nhttp://trac.sagemath.org/browser/?rev=6b5515c48c7440a7c15e81937883a39130bbff8e\n\nand (somehow) merge the branch u/niles/14909.",
    "created_at": "2013-07-19T19:44:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234889",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:5'></a>Actually, maybe I should leave the "Branch" field for the branch which the patch author might submit, so I can be the patch reviewer.  I guess someone who finds it useful can view my commits at
...
```json
{
    "body": "Changing branch from \"u/niles/14909\" to \"\"",
    "created_at": "2013-07-19T19:44:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234890",
    "user": "https://github.com/nilesjohnson"
}
```

Changing branch from "u/niles/14909" to ""
...
```json
{
    "body": "<a id='comment:6'></a>I've updated the patch to only check for the failures and some misc cleanup. Since we don't have a way of working with optional spkgs yet I propose to stick to the old workflow in this ticket.\n\nStartup is probably slow since this makes use of libgap, which doesn't yet use cached workspaces (search trac if you want to know more)",
    "created_at": "2013-07-20T02:24:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234891",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>I've updated the patch to only check for the failures and some misc cleanup. Since we don't have a way of working with optional spkgs yet I propose to stick to the old workflow in this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234892",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234893",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234895",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I've fixed the guava package path and the trivial failures. There are still three failures in linear_code.py with guava that seem to be bugs in guava. For all of them we have native code that does the same, only the optional guava-based implementation fails. Needs to be debugged further by somebody else.",
    "created_at": "2013-07-22T21:11:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234896",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:8'></a>I've fixed the guava package path and the trivial failures. There are still three failures in linear_code.py with guava that seem to be bugs in guava. For all of them we have native code that does the same, only the optional guava-based implementation fails. Needs to be debugged further by somebody else.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234897",
...
```json
{
    "body": "<a id='comment:11'></a>None of the failing doctests uses libgap, its all ancient code using the gap pexpect interface. At least one of them works fine with prime finite fields but fails in the non-prime case:\n\n```\n            sage: F.<a> = GF(4)\n            sage: C = HammingCode(2,F)\n            sage: v = vector(F, [1,0,0,a,1])\n            sage: C.decode(v)\n            (a + 1, 0, 0, a, 1)\n            sage: C.decode(v, algorithm=\"nearest neighbor\")\n            (a + 1, 0, 0, a, 1)\n            sage: C.decode(v, algorithm=\"guava\")  # optional - gap_packages (Guava package)\n            BOOM!\n```",
    "created_at": "2013-07-23T14:53:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234899",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>None of the failing doctests uses libgap, its all ancient code using the gap pexpect interface. At least one of them works fine with prime finite fields but fails in the non-prime case:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234900",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234901",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234902",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234903",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>The remaining problems in `linear_code.py` have been reported at #14979.  The patch here resolves the issue in this ticket, and more!",
    "created_at": "2013-07-26T12:21:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234904",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:14'></a>The remaining problems in `linear_code.py` have been reported at #14979.  The patch here resolves the issue in this ticket, and more!
...
```json
{
    "body": "<a id='comment:15'></a>updated spkg landed on the servers \u2026",
    "created_at": "2013-07-30T10:36:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234905",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:15'></a>updated spkg landed on the servers …
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234906",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14909#issuecomment-234907",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14909",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14909#event-42886"
}
```
