...
```json
{
    "body": "<a id='comment:1'></a>happens on 5.10rc0 too.",
    "created_at": "2013-06-03T11:23:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229120",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:1'></a>happens on 5.10rc0 too.
...
```json
{
    "body": "<a id='comment:2'></a>... and of course Maxima (and probably also ECL) is to blame.\n\nSimilar issues were reported on the ticket dealing with the last Maxima upgrade IIRC.",
    "created_at": "2013-06-03T11:52:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229121",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>... and of course Maxima (and probably also ECL) is to blame.
...
```json
{
    "body": "<a id='comment:5'></a>Fixed by #13973.",
    "created_at": "2013-06-13T09:27:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229123",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Fixed by #13973.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41958"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41959"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41960"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41961"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41962"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229124",
...
```json
{
    "body": "<a id='comment:10'></a>One can avoid the crash by taking the limit for *x* -> 0 from above, but then the value of the limit is wrong, again due to the `domain: complex` setting:\n\n```\nsage: f(x) = (x^x - sin(x)^sin(x))/(x^3*log(x))\nsage: f.limit(x=0, dir='plus')\nx |--> -Infinity\nsage: sage.calculus.calculus.maxima('domain: real')\nreal\nsage: f.limit(x=0, dir='plus')\nx |--> 1/6\n```\nPlotting the function [edit: or reading the ask.sagemath.org question linked to above] suggests that 1/6 is the correct value.",
    "created_at": "2014-05-29T18:42:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229125",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:10'></a>One can avoid the crash by taking the limit for *x* -> 0 from above, but then the value of the limit is wrong, again due to the `domain: complex` setting:
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41963"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41964"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229126",
...
```json
{
    "body": "<a id='comment:13'></a>... at least.  (We're currently at 6.5.rc0; 6.4 has been released a while ago.)",
    "created_at": "2015-01-31T19:27:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229127",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:13'></a>... at least.  (We're currently at 6.5.rc0; 6.4 has been released a while ago.)
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41965"
}
```
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41966"
}
```
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41967"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41968"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229128",
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41969"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14677#event-41970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229129",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Note: a similar problem is reported at #26497.",
    "created_at": "2018-10-18T06:18:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14677#issuecomment-229130",
    "user": "https://github.com/slel"
}
```

<a id='comment:15'></a>Note: a similar problem is reported at #26497.
