...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14976#issuecomment-235558",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14976#issuecomment-235559",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14976#issuecomment-235560",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14976#event-42983"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14976#event-42984"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14976#event-42985"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14976#event-42986"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14976#event-42987"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Replying to [nbruin](#comment%3A4):\n> You're diagnosing a different problem, that integration with certain *symbolic* bounds is *also* broken. Compare:\n> \n> ```\n> sage: var('x,t,a,b')\n> (x, t, a, b)\n> sage: function('f')\n> f\n> sage: function('g')\n> g\n> sage: integrate(f(x),x,a,b)\n> integrate(f(x), x, a, b)\n> sage: integrate(f(x),x,sin(t),b)\n> integrate(f(x), x, sin(t), b)\n> sage: integrate(f(x),x,sin(1+i*t),b)\n> RuntimeError: ECL says: Error executing code in Maxima: defint: lower limit of integration must be real; found sin(%i*t+1)\n> sage: integrate(f(x),x,g(t),b)\n> RuntimeError: ECL says: Error executing code in Maxima: defint: lower limit of integration must be real; found g(t)\n> ```\n\nThis no longer gives an error.",
    "created_at": "2014-12-02T10:27:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14976#issuecomment-235562",
    "user": "https://github.com/rwst"
}
```

<a id='comment:12'></a>Replying to [nbruin](#comment%3A4):
> You're diagnosing a different problem, that integration with certain *symbolic* bounds is *also* broken. Compare:
> 
> ```
> sage: var('x,t,a,b')
