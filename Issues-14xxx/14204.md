...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218180",
...
```json
{
    "body": "<a id='comment:2'></a>For what it's worth, you can cut down on the build time by setting `MAKE=make -jN`, where `N` is somewhat larger than the number of processors, at least if nothing needs to be rebuilt. On my machine, which has 2 processors:\n\n```\n$ export MAKE='make -j2' \n$ time make doc\n...\nreal\t4m59.845s\nuser\t4m33.320s\nsys\t2m0.269s\n```\nand\n\n```\n$ export MAKE='make -j4' \n$ time make doc\n...\nreal\t4m4.408s\nuser\t4m41.729s\nsys\t1m59.842s\n```",
    "created_at": "2013-02-28T21:55:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218181",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>For what it's worth, you can cut down on the build time by setting `MAKE=make -jN`, where `N` is somewhat larger than the number of processors, at least if nothing needs to be rebuilt. On my machine, which has 2 processors:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218182",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>How long does the rest of `make ptestlong` take? Why does a few extra minutes matter that much?",
    "created_at": "2013-03-01T15:44:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218183",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>How long does the rest of `make ptestlong` take? Why does a few extra minutes matter that much?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218184",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Actually, it is importing sage.all every time.",
    "created_at": "2013-03-02T03:04:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218187",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>Actually, it is importing sage.all every time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218189",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218190",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218192",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Could we at the very least get rid of the `subprocess` call? It probably won't make the documentation build as fast as before, but there should be some considerable gain.",
    "created_at": "2013-03-04T07:28:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218194",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>Could we at the very least get rid of the `subprocess` call? It probably won't make the documentation build as fast as before, but there should be some considerable gain.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218195",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>This is a proof-of-concept patch for getting rid of `subprocess`, giving a speedup of roughly a factor 2.",
    "created_at": "2013-03-04T10:14:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218196",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>This is a proof-of-concept patch for getting rid of `subprocess`, giving a speedup of roughly a factor 2.
...
```json
{
    "body": "<a id='comment:18'></a>Perhaps more imports could be done it the master process, but I don't know how much there is to gain. Running `strace` shows that the docbuilder tries to `open()` a non-existing file 270200 times(!).",
    "created_at": "2013-03-04T10:23:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218197",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>Perhaps more imports could be done it the master process, but I don't know how much there is to gain. Running `strace` shows that the docbuilder tries to `open()` a non-existing file 270200 times(!).
...
```json
{
    "body": "<a id='comment:19'></a>Add a cache for the intersphinx inventory, reducing the total time again by more than a factor of 2. Still untested proof-of-concept.",
    "created_at": "2013-03-04T13:15:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218198",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>Add a cache for the intersphinx inventory, reducing the total time again by more than a factor of 2. Still untested proof-of-concept.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218199",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Patch seems to work, I'm setting it to needs_review very tentatively. Somebody who knows Sphinx better than me should look at it.\n\nWith this patch, building the documentation with 2 threads is now faster than before #6495, so it would fix the issue.",
    "created_at": "2013-03-04T14:45:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218200",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>Patch seems to work, I'm setting it to needs_review very tentatively. Somebody who knows Sphinx better than me should look at it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218201",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>The patch seems to work as advertised, and the changes make sense to me. Volker, do you concur? (Note that the commit message is not ideal ;)",
    "created_at": "2013-03-04T23:06:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218202",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:21'></a>The patch seems to work as advertised, and the changes make sense to me. Volker, do you concur? (Note that the commit message is not ideal ;)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218203",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Fixed commit message.",
    "created_at": "2013-03-05T09:35:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218204",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:22'></a>Fixed commit message.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218205",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218206",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218207",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218208",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14204#event-40089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218209",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>I have a followup question.  I'm working with a student on learning to develop, and his first patch is a pretty basic documentation upgrade. Changing just one file and then doing `sage -docbuild reference html` takes eons on a reasonably modern Ubuntu laptop because it checks ALL the files.  It's true that we didn't necessarily set the number of parallel cores.  But it still really slows down checking whether things look right.  Any thoughts, or is this a wontfix?  I'm hesitant to open a ticket until I know it really should be considered a bug, though I do think it is a pretty nasty (non-mathematical) regression.",
    "created_at": "2013-05-31T03:51:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218210",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:25'></a>I have a followup question.  I'm working with a student on learning to develop, and his first patch is a pretty basic documentation upgrade. Changing just one file and then doing `sage -docbuild reference html` takes eons on a reasonably modern Ubuntu laptop because it checks ALL the files.  It's true that we didn't necessarily set the number of parallel cores.  But it still really slows down checking whether things look right.  Any thoughts, or is this a wontfix?  I'm hesitant to open a ticket until I know it really should be considered a bug, though I do think it is a pretty nasty (non-mathematical) regression.
...
```json
{
    "body": "<a id='comment:26'></a>All the more reason to set `MAKE` so it uses multiple threads! On my (not reasonably modern) OS X machine, rebuilding the documentation after modifying one file, with `MAKE` unset, takes\n\n```\nreal\t2m44.637s\nuser\t2m7.278s\nsys\t0m22.776s\n```\nWith `MAKE` set to use two cores:\n\n```\nreal\t1m55.552s\nuser\t2m12.224s\nsys\t0m24.907s\n```\nOn sage.math, with `MAKE='make -j12'`:\n\n```\nreal\t0m34.899s\nuser\t1m34.650s\nsys\t0m16.800s\n```\nSo using multiple cores is very advantageous. Note also that if you are only modifying a single file, or files within one section of the reference manual, be aware that you can do\n\n```\nsage --docbuild reference/homology html\n```\n(or `reference/combinat` or `reference/matrices` or ...). This will be very fast (except when rebuilding the `combinat` docs ;), even with a single core.",
    "created_at": "2013-05-31T05:09:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218211",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:26'></a>All the more reason to set `MAKE` so it uses multiple threads! On my (not reasonably modern) OS X machine, rebuilding the documentation after modifying one file, with `MAKE` unset, takes
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218212",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>I see, so this isn't something we can fix more without getting rid of parallel documentation building.  I think this was a lot faster before because it only had to do a sweep through one directory.\n\nWith Sage 5.2, after touching one file and `sage -b`, the documentation build takes well under 15 seconds, but in 5.9 the same thing took about 80 seconds (I had to use a watch for this, since it didn't print it out).\n\nMaybe we could add something about *both* of John's solutions to [the Sage manuals developer page](http://www.sagemath.org/doc/developer/sage_manuals.html#building-the-manuals)?  I'd be open to opening such a ticket.  Maybe my student could even write the patch ;-)",
    "created_at": "2013-05-31T12:30:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14204#issuecomment-218213",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:28'></a>I see, so this isn't something we can fix more without getting rid of parallel documentation building.  I think this was a lot faster before because it only had to do a sweep through one directory.
