...
```json
{
    "body": "<a id='comment:6'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>f77e13cpython-sage: env</tr><tr>29f8f3epython-sage build system continued/cleanup</tr><tr>28b0da1python-sage build system</tr></table>\n",
    "created_at": "2013-09-02T18:54:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14834",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>1f3f7e4Merge branches 'cython_dbg' and 'cython_deps' into python_sage_build</tr><tr>42449c1python-sage doctest path tolerance</tr><tr>ae8bb63python-sage: env</tr><tr>5a16d99python-sage build system</tr><tr>f82b422cython: patch: gdb output dir option</tr><tr>bd11c24cython: add -MF switch to write dependency files (#14728)</tr></table>\n",
    "created_at": "2013-09-02T20:15:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14834",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>fcb670fsimplify python byte compile rules</tr><tr>2af9070GMP_VS_MPIR fixup</tr><tr>45a30e1provide unhardwired SAGE_CFLAGS</tr><tr>e195725python-sage: Makefiles</tr><tr>c4562b3python_sage: build system continued</tr></table>\n",
...
```json
{
    "body": "<a id='comment:11'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>ec442e5always use autotools within sage (\"the distribution\")</tr><tr>26c67b2python-sage: make cython call more toolchain friendly</tr></table>\n",
...
```json
{
    "body": "<a id='comment:12'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>4fd1863Makefiles update</tr><tr>40772baconfig.py</tr><tr>0af9952Merge branch 'build_system' into python_sage_build</tr><tr>1dacfa5python-sage: Makefiles update for 512beta4</tr><tr>cb27876python-sage: Makefiles fix</tr></table>\n",
