...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14365#event-186187"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14365#event-186188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14365#event-186189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14365#event-186190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14365#issuecomment-175084",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14365#issuecomment-175085",
    "user": "https://github.com/nexttime"
}
```
