...
```json
{
    ...
    "asset_name": "trac_14564-trivial-binary-tree.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket14564/trac_14564-trivial-binary-tree.patch",
...
```json
{
    "body": "Fixes graph() function. This automatically fixes show(). I have not checked all the other functions, though...",
    "created_at": "2013-05-11T02:22:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14564",
    "type": "issue_comment",
