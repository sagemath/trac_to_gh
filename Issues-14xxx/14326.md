...
```json
{
    "body": "<a id='comment:2'></a>Jeroen, do you have an idea who to include in cc to help isolate this?\n\nPaul",
    "created_at": "2013-05-07T09:04:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221163",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>Jeroen, do you have an idea who to include in cc to help isolate this?
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40591"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40592"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40593"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40594"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40595"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40596"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40597"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The problem looks similar to #17130, but that's about `__call__`.",
    "created_at": "2014-11-15T09:34:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221166",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>The problem looks similar to #17130, but that's about `__call__`.
...
```json
{
    "body": "<a id='comment:10'></a>do the patches from #17130 solve this ticket?\n\nPaul",
    "created_at": "2014-11-17T09:41:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221167",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:10'></a>do the patches from #17130 solve this ticket?
...
```json
{
    "body": "<a id='comment:13'></a>Looking at the code snippet from[comment:8](#comment%3A8) only, I don't think this is a bug in Ginac. The intended behavior is just different in Pynac, so we have to patch Pynac.\n\nGinac wants to keep unique reference counted expression objects for expressions that are equal. That is why they return `_ex1` on line 415. In Pynac, we do not have a unique \"one\", we should just return `ebasis` in this line to keep the precision/type of the base.",
    "created_at": "2014-11-21T10:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221170",
    "user": "https://github.com/burcin"
}
```

<a id='comment:13'></a>Looking at the code snippet from[comment:8](#comment%3A8) only, I don't think this is a bug in Ginac. The intended behavior is just different in Pynac, so we have to patch Pynac.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40598"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40599"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>This is fixed in pynac-0.3.6 (and a duplicate of #12257), please review #18362 and #12257.",
    "created_at": "2015-05-05T07:16:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221172",
    "user": "https://github.com/rwst"
}
```

<a id='comment:15'></a>This is fixed in pynac-0.3.6 (and a duplicate of #12257), please review #18362 and #12257.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221173",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221174",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-221175",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14326#event-40600"
}
```
