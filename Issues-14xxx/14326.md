...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188698",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188699",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188700",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188701",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188702",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188703",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188704",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Looking at the code snippet from comment:8 only, I don't think this is a bug in Ginac. The intended behavior is just different in Pynac, so we have to patch Pynac.\n\nGinac wants to keep unique reference counted expression objects for expressions that are equal. That is why they return `_ex1` on line 415. In Pynac, we do not have a unique \"one\", we should just return `ebasis` in this line to keep the precision/type of the base.",
    "created_at": "2014-11-21T10:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188705",
    "user": "https://github.com/burcin"
}
```

<a id='comment:13'></a>Looking at the code snippet from comment:8 only, I don't think this is a bug in Ginac. The intended behavior is just different in Pynac, so we have to patch Pynac.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188707",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188708",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188709",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14326#issuecomment-188710",
