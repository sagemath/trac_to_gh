...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186190",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186191",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186192",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186193",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186194",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186195",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,12 +1,12 @@\n The goal of this ticket is a basic implementation of algebraic closures of finite fields.  Most importantly, it provides the following:\n \n-- class `AlgebraicClosureFiniteField`\n+- class `AlgebraicClosureFiniteField_generic` (abstract base class)\n   - method `subfield(n)` returning a tuple consisting of the subfield of order *p<sup>n</sup>* and a `RingHomomorphism_im_gens` giving the canonical embedding into the algebraic closure\n+- class `AlgebraicClosureFiniteField_pseudo_conway` (implements the specific defining polynomials of the finite subfields and the relations between the generators of these subfields)\n - class `AlgebraicClosureFiniteFieldElement`\n   (mostly a wrapper around `FiniteFieldElement`, so actually an element of a finite subfield, but having the algebraic closure as its parent and taking care of coercion into larger subfields)\n-- method `FiniteField.algebraic_closure()`\n-\n-(Alternative names: `FiniteFieldAlgebraicClosure`, `FiniteFieldAlgebraicClosureElement`, maybe with aliases `FFpbar`, `FFpbarElement`?)\n+- factory class `AlgebraicClosureFiniteField` (to get unique parents)\n+- method `FiniteField.algebraic_closure()` (invokes the factory class)\n \n An example using the new functionality is the following analogue of the example from #8335:\n \n@@ -39,6 +39,7 @@\n True\n ```\n \n-(The above example shows that `AlgebraicClosureFiniteFieldElement` is printed in the same way as the underlying `FiniteFieldElement`.)\n+It is conceivable that there will be different coexisting implementations (deriving from `AlgebraicClosureFiniteField_generic`).  The current implementation uses Conway polynomials and the pseudo-Conway polynomials from #14958, as well as the functionality for finite field homomorphisms provided by #13214.\n \n-It is conceivable that there will be different coexisting implementations (classes deriving from an abstract `AlgebraicClosureFiniteField`).  The current implementation uses Conway polynomials and the pseudo-Conway polynomials from #14958, as well as the functionality for finite field homomorphisms provided by #13214.\n+Apply: [attachment:trac_14990-algebraic_closure_finite_field.patch](https://github.com/sagemath/sage/files/ticket14990/trac_14990-algebraic_closure_finite_field.patch)\n+\n``````\n",
    "created_at": "2013-08-15T15:17:41Z",
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186196",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131270"
}
```
...
```json
{
    ...
    "milestone": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186197",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14990/trac_14990-algebraic_closure_finite_field.patch",
    "created_at": "2013-11-03T16:50:05Z",
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14990/trac_14990-algebraic_closure_finite_field.patch",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Attachment [trac_14990-algebraic_closure_finite_field.patch](https://github.com/sagemath/sage/files/ticket14990/trac_14990-algebraic_closure_finite_field.patch) by @pjbruin created at 2013-11-03 16:50:05\n\nupdate (doctest coverage)",
    "created_at": "2013-11-03T16:50:05Z",
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186198",
    "user": "https://github.com/pjbruin"
}
```

Attachment [trac_14990-algebraic_closure_finite_field.patch](https://github.com/sagemath/sage/files/ticket14990/trac_14990-algebraic_closure_finite_field.patch) by @pjbruin created at 2013-11-03 16:50:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186199",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186200",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186201",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186202",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186203",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186204",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186205",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186206",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186207",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186208",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186209",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186210",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186211",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186212",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186213",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186214",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186215",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186216",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186217",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186218",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186219",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186220",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186221",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186222",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186223",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131272"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131273"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186224",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186225",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186226",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186227",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186228",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186229",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186230",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186231",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186232",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186233",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186234",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186235",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186236",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186237",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186238",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186239",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186240",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186241",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186242",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186243",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186244",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186245",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186246",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186247",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186248",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186249",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186250",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186251",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186252",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186253",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131274"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186254",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186255",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186256",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131276"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14990#issuecomment-186257",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131278"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131279"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131280"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131281"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131282"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131283"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131284"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131285"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131286"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131287"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131288"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131289"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14990",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14990#event-131291"
}
```
