...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14698#issuecomment-181060",
...
```json
{
    "body": "Changed assignee from **@jdemeyer** to **@sagetrac-mvngu**",
    "created_at": "2013-06-06T15:21:40Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14698#issuecomment-181061",
    "user": "https://github.com/nexttime"
}
```

Changed assignee from **@jdemeyer** to **@sagetrac-mvngu**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14698#event-191415"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14698#event-191416"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14698#event-191417"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14698#event-191418"
}
```
