...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14073#issuecomment-169699",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14073#issuecomment-169700",
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14073#event-181495"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14073#event-181496"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14073#event-181497"
}
```
