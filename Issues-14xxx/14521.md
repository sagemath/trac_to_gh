...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225957",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [14521_no_NSInteger.patch](tarball://root/attachments/some-uuid/ticket14521/14521_no_NSInteger.patch) by @jdemeyer created at 2013-05-03 09:05:15",
    "created_at": "2013-05-03T09:05:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225958",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Attachment [14521_no_NSInteger.patch](tarball://root/attachments/some-uuid/ticket14521/14521_no_NSInteger.patch) by @jdemeyer created at 2013-05-03 09:05:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225959",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225960",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225961",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225962",
    "user": "https://trac.sagemath.org/admin/accounts/users/yomcat"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I'm asking the dumb question... did anyone test the actual built Sage.app on these systems, not just building Sage.app?  Though I can't imagine this is going to be a problem, but still, without this patch\n\n```\n$ cd mac-app/\n$ grep -R NSInteger .\n./PreferencePanelController.m:- (void)alertDidEnd:(NSAlert *)alert returnCode:(NSInteger)returnCode contextInfo:(void *)contextInfo {\n$ grep -R long .\n./AppDelegate.m:// From here down are methods from NSApplicationDelegate, which probably do belong in another file.\n./loading-page.html:  <h3>If you think you have waited long enough...</h2>\n```\nfor what it's worth.\n\nI can try building the app on 10.7 later today.  I agree that it probably will not make a difference, though it's still worth trying on a few different ones *just* to make sure.",
    "created_at": "2013-05-03T12:50:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225964",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>I'm asking the dumb question... did anyone test the actual built Sage.app on these systems, not just building Sage.app?  Though I can't imagine this is going to be a problem, but still, without this patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225965",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>In particular, yomcat, did you actually try a bdisted Sage with this?  Just asking - I assume yes, in which case I'm wondering what went wrong with mine...",
    "created_at": "2013-05-03T17:41:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225967",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>In particular, yomcat, did you actually try a bdisted Sage with this?  Just asking - I assume yes, in which case I'm wondering what went wrong with mine...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225968",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225969",
    "user": "https://trac.sagemath.org/admin/accounts/users/yomcat"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225970",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Indeed, I was using the upstream sagenb linked in, which definitely has something to do with it.  This *does* actually work on 10.4 - I have tried a bdist!  I am going to try this on a non-corrupted one on 10.7 now, and if that works then I think we should be okay.",
    "created_at": "2013-05-07T16:46:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225971",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>Indeed, I was using the upstream sagenb linked in, which definitely has something to do with it.  This *does* actually work on 10.4 - I have tried a bdist!  I am going to try this on a non-corrupted one on 10.7 now, and if that works then I think we should be okay.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225972",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Okay, 10.7 looks good as well.  Strange business.  Ivan, do you have any idea on whether this could conceivably break anything?",
    "created_at": "2013-05-07T18:15:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225973",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Okay, 10.7 looks good as well.  Strange business.  Ivan, do you have any idea on whether this could conceivably break anything?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225974",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Or, Jeroen, do we need to somehow test for this build?  You mentioned this on the sage-devel thread, but I haven't got a clue how to do it.",
    "created_at": "2013-05-07T18:16:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225975",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:12'></a>Or, Jeroen, do we need to somehow test for this build?  You mentioned this on the sage-devel thread, but I haven't got a clue how to do it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225976",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14521#event-41329"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225978",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14521#issuecomment-225979",
    "user": "https://github.com/jdemeyer"
}
```
