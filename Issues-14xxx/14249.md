...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224352",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224353",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224354",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224355",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224356",
...
```json
{
    "body": "<a id='comment:3'></a>\nReplying to [nbruin](#comment%3A2):\n> Isn't it a logical flaw that there should even be elements for an action to exist? \n\n\nFor *general* actions I agree. But:\n \n> This particular scenario isn't particularly relevant for the coercion framework, but it does show that actions on empty sets are natural to consider, so if we're not supporting that, there may be something wrong with our model.\n\n\nDon't forget that what we are talking about here is in sage.structure.coerce_actions. So, this *is* for coercions, and it *is* to be applied to elements.\n\nsage.categories.action is of course more general.\n\n> Can't we just ditch the sanity check (or skip it if an element isn't easily obtained)?\n\n\nPart of the problem is that we have different ways to define an action on elements. There is `_rmul_`/_lmul_, there is `_l_`action/_r_action (at least according to sage.structure.coerce_actions, but it isn't used in sage.structure.coerce), there is `_act_on_`, and there is `_acted_upon_`. Moreover, there is `IntegerMulAction`. And since they are all acting *on elements*, I think it somehow does make sense to test which of the different flavours is available for the elements.",
    "created_at": "2013-03-13T16:07:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224357",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224358",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224359",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224360",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224361",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224362",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "asset_name": "trac14249-fix_doc.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket14249/trac14249-fix_doc.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224363",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224364",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224365",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224366",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224367",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224368",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224369",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224370",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224371",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224372",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224373",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224374",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224375",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224376",
    "user": "https://github.com/simon-king-jena"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_14249-coercion_without_an_element.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket14249/trac_14249-coercion_without_an_element.patch",
    "created_at": "2013-05-27T12:20:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-224377",
    "user": "https://github.com/simon-king-jena"
}
```
