...
```json
{
    "body": "Changing dependencies from \"\" to \"#14264\"",
    "created_at": "2013-03-13T10:50:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219296",
    "user": "https://github.com/simon-king-jena"
}
```

Changing dependencies from "" to "#14264"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219297",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219298",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219300",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>That said, it is possible for a parent to return an action on request (implement _get_action_). Here, I think it does make sense to offer an optional parameter ``check``, such that the elements are only tested if ``check=True`` (which should be the default, IMHO).\n\nAnd my patch *does* introduce such a ``check`` parameter!",
    "created_at": "2013-03-13T16:10:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219301",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>That said, it is possible for a parent to return an action on request (implement _get_action_). Here, I think it does make sense to offer an optional parameter ``check``, such that the elements are only tested if ``check=True`` (which should be the default, IMHO).
...
```json
{
    "body": "<a id='comment:5'></a>Since this is a prerequisite for #14279 (which would implement the coercion model for homsets), I am putting Nicolas on Cc. Needs review, hinthint...",
    "created_at": "2013-05-17T08:16:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219302",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Since this is a prerequisite for #14279 (which would implement the coercion model for homsets), I am putting Nicolas on Cc. Needs review, hinthint...
...
```json
{
    "body": "<a id='comment:6'></a>I agree, basic arithmetic should not require to construct an_element. In general the coercion model's approach of monkey calling a method with garbage to test if by chance it would accept that garbage is ugly and fragile; I am in favor of any step away of it.\n\nThat's a first step :-) \n\nI went through the patch, and it sounds reasonable. So if all test pass, I am fine with it.",
    "created_at": "2013-05-17T18:59:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219303",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:6'></a>I agree, basic arithmetic should not require to construct an_element. In general the coercion model's approach of monkey calling a method with garbage to test if by chance it would accept that garbage is ugly and fragile; I am in favor of any step away of it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219305",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac14249-fix_doc.patch](tarball://root/attachments/some-uuid/ticket14249/trac14249-fix_doc.patch) by @simon-king-jena created at 2013-05-21 13:56:10\n\nI have added a new patch that hopefully succeeds in addressing Travis' comments.",
    "created_at": "2013-05-21T13:56:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219306",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>Attachment [trac14249-fix_doc.patch](tarball://root/attachments/some-uuid/ticket14249/trac14249-fix_doc.patch) by @simon-king-jena created at 2013-05-21 13:56:10
...
```json
{
    "body": "<a id='comment:9'></a>The patchbot still complains about the old style line continuations in the first patch. However, the patchbot does not realise that the second patch changes these into new style line continuations. So, I guess the ticket is still ready for review...",
    "created_at": "2013-05-24T15:36:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219307",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>The patchbot still complains about the old style line continuations in the first patch. However, the patchbot does not realise that the second patch changes these into new style line continuations. So, I guess the ticket is still ready for review...
...
```json
{
    "body": "<a id='comment:10'></a>Sorry for falling (slightly) behind on reviewing this. From looking at the patch, it looks good. I'll test it later tonight due to the recompile, promise.",
    "created_at": "2013-05-24T16:50:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219308",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>Sorry for falling (slightly) behind on reviewing this. From looking at the patch, it looks good. I'll test it later tonight due to the recompile, promise.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219309",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219310",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>OK, the patches got folded.\n\nApply trac_14249-coercion_without_an_element.patch",
    "created_at": "2013-05-24T20:23:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219311",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>OK, the patches got folded.
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -35,6 +35,10 @@\n \n So, I propose to make it possible to pass the two elements being multiplied to the constructor of `Left/RightModuleAction`, and let `an_element()` be called *only* if no element is passed.\n \n+__Apply__\n+\n+* [attachment:trac_14249-coercion_without_an_element.patch]\n+\n Comment: 1\n \n Summary: There should be no need to have _an_element_ implement to multiply elements\n``````\n",
    "created_at": "2013-05-24T20:23:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219312",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219313",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Looks good to me. Thanks Simon.",
    "created_at": "2013-05-25T01:24:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219314",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:13'></a>Looks good to me. Thanks Simon.
...
```json
{
    "body": "<a id='comment:14'></a>Note that a failing plugin is not necessarily a blocker for positive review, especially if it can be explained. And more on topic, a big +1 to this change.",
    "created_at": "2013-05-25T05:31:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219315",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:14'></a>Note that a failing plugin is not necessarily a blocker for positive review, especially if it can be explained. And more on topic, a big +1 to this change.
...
```json
{
    "body": "<a id='comment:15'></a>The PDF documentation doesn't build:\n\n```\n! Missing { inserted.\n<to be read again> \n                   $\nl.15158 $_an_element_$ \n                       for the parent. But now, the following example works:\n?\n! Emergency stop.\n<to be read again> \n                   $\nl.15158 $_an_element_$ \n                       for the parent. But now, the following example works:\n!  ==> Fatal error occurred, no output PDF file produced!\n```",
    "created_at": "2013-05-27T11:24:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219316",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>The PDF documentation doesn't build:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219317",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219318",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219319",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Attachment [trac_14249-coercion_without_an_element.patch](tarball://root/attachments/some-uuid/ticket14249/trac_14249-coercion_without_an_element.patch) by @simon-king-jena created at 2013-05-27 12:20:20\n\nI hope double back ticks do the trick (I only changed single into double back tick, so, I hope I can directly revert to \"positive_review\")\n\nApply trac_14249-coercion_without_an_element.patch",
    "created_at": "2013-05-27T12:20:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219320",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:16'></a>Attachment [trac_14249-coercion_without_an_element.patch](tarball://root/attachments/some-uuid/ticket14249/trac_14249-coercion_without_an_element.patch) by @simon-king-jena created at 2013-05-27 12:20:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219321",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14249#issuecomment-219322",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14249",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14249#event-40293"
}
```
