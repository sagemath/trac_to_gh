...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172149",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14219/rational_preperiodic.patch",
    "created_at": "2013-03-06T12:50:20Z",
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14219/rational_preperiodic.patch",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [rational_preperiodic.patch](https://github.com/sagemath/sage/files/ticket14219/rational_preperiodic.patch) by @fchapoton created at 2013-03-06 12:50:20",
    "created_at": "2013-03-06T12:50:20Z",
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172150",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172151",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172152",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172153",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172154",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "milestone": "sage-5.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122781"
}
```
...
```json
{
    ...
    "milestone": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172155",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172156",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172157",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172158",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122783"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122784"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122785"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122786"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122787"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122788"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172159",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172160",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172161",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172162",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172163",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172164",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172165",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14219/trac_14219-optimize_root_order_computation.patch",
    "created_at": "2013-11-07T19:46:33Z",
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14219/trac_14219-optimize_root_order_computation.patch",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>\nAttachment [trac_14219-optimize_root_order_computation.patch](https://github.com/sagemath/sage/files/ticket14219/trac_14219-optimize_root_order_computation.patch) by @videlec created at 2013-11-07 19:46:33\n\nHi there,\n\nSome quick comments (I am not the person designed to review the mathematics in there):\n- the patch does not apply on sage-5.13.beta2\n- there are many trailing whitescaces that need to be removed\n- the indentation must be 4 spaces wide (it is 3 in many places)\n- sage convention is that `CamelCaseConvention` is somewhat reserved to classes and it would be better to not use it as variables names (I think this is too much pain to change it right now)\n- in the examples one should use \"a = bla()\" instead of \"a=bla()\"\n\nWe also discussed a very specific issue in the code (line 2588 to 2601). The [attachment:trac_14219-optimize_root_order_computation.patch](https://github.com/sagemath/sage/files/ticket14219/trac_14219-optimize_root_order_computation.patch) proposes a much direct version with, as a consequence, a little bit of speedup.",
    "created_at": "2013-11-07T19:46:33Z",
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172166",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122789"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122790"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172167",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172168",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172169",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172170",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172171",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122791"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122792"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122793"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172172",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172173",
    "user": "https://trac.sagemath.org/admin/accounts/users/atowsley"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172174",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172175",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172176",
    "user": "https://trac.sagemath.org/admin/accounts/users/atowsley"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14219/trac_14219_rational_preperiodic.patch",
    "created_at": "2013-11-12T15:34:11Z",
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14219/trac_14219_rational_preperiodic.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/atowsley"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>\nAttachment [trac_14219_rational_preperiodic.patch](https://github.com/sagemath/sage/files/ticket14219/trac_14219_rational_preperiodic.patch) by atowsley created at 2013-11-12 15:34:11\n\nAll tests passed. Everything looks good.",
    "created_at": "2013-11-12T15:34:11Z",
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172177",
    "user": "https://trac.sagemath.org/admin/accounts/users/atowsley"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122795"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172178",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14219#event-122798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172179",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14219#issuecomment-172180",
    "user": "https://github.com/fchapoton"
}
```
