...
```json
{
    "body": "<a id='comment:1'></a>Attachment [rational_preperiodic.patch](tarball://root/attachments/some-uuid/ticket14219/rational_preperiodic.patch) by @fchapoton created at 2013-03-06 12:50:20",
    "created_at": "2013-03-06T12:50:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14219",
    "type": "issue_comment",
...
<a id='comment:1'></a>Attachment [rational_preperiodic.patch](tarball://root/attachments/some-uuid/ticket14219/rational_preperiodic.patch) by @fchapoton created at 2013-03-06 12:50:20
...
```json
{
    "body": "<a id='comment:5'></a>Finished cleaning it up. Ready for review.\n\nChanged the milestone to something more realistic.",
    "created_at": "2013-04-15T16:26:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14219",
    "type": "issue_comment",
...
<a id='comment:5'></a>Finished cleaning it up. Ready for review.
...
```json
{
    "body": "<a id='comment:6'></a>apply trac_14219_rational_preperiodic.patch",
...
<a id='comment:6'></a>apply trac_14219_rational_preperiodic.patch
...
```json
{
    "body": "<a id='comment:7'></a>There is one doctest missing.",
...
<a id='comment:7'></a>There is one doctest missing.
...
<a id='comment:9'></a>Fixed the missing doctest.
...
```json
{
    "body": "<a id='comment:10'></a>apply trac_14219_rational_preperiodic.patch",
...
<a id='comment:10'></a>apply trac_14219_rational_preperiodic.patch
...
```json
{
    "body": "<a id='comment:11'></a>apply trac_14219_rational_preperiodic.patch",
...
<a id='comment:11'></a>apply trac_14219_rational_preperiodic.patch
...
```json
{
    "body": "<a id='comment:12'></a>apply trac_14219_rational_preperiodic.patch",
...
<a id='comment:12'></a>apply trac_14219_rational_preperiodic.patch
...
```json
{
    "body": "<a id='comment:13'></a>apply trac_14219_rational_preperiodic.patch",
...
<a id='comment:13'></a>apply trac_14219_rational_preperiodic.patch
...
<a id='comment:14'></a>Attachment [trac_14219-optimize_root_order_computation.patch](tarball://root/attachments/some-uuid/ticket14219/trac_14219-optimize_root_order_computation.patch) by @videlec created at 2013-11-07 19:46:33
...
<a id='comment:16'></a>The change for the eigenvalue computation looks fine, I've folded that into the main patch.
...
<a id='comment:17'></a>To be modified in projective_morphism.py
...
<a id='comment:18'></a>fixed: 1,2,3,4,7
...
```json
{
    "body": "<a id='comment:20'></a>The multiplier (and multipliermod) functions should have a check that the point P does have period n.",
    "created_at": "2013-11-10T16:41:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14219",
    "type": "issue_comment",
...
<a id='comment:20'></a>The multiplier (and multipliermod) functions should have a check that the point P does have period n.
...
<a id='comment:21'></a>Here are a few more comments:
...
```json
{
    "body": "<a id='comment:22'></a>Multiplier check added for the (2)-previous comment. I added a parameter to specify whether to do this or not as this function is called many times for `rational_periodic` and it would be better not to check if you known the input is good.\n\n1,2,3,4,5,6 all done\n\n7) Not possible since the points are rational projective points and they are not hashable (only hashable over finite fields)\n\nI also changed the mrange to xmrange in `lift_to_rational` to help improve the higher dimension performance.",
...
<a id='comment:22'></a>Multiplier check added for the (2)-previous comment. I added a parameter to specify whether to do this or not as this function is called many times for `rational_periodic` and it would be better not to check if you known the input is good.
...
```json
{
    "body": "<a id='comment:23'></a>Attachment [trac_14219_rational_preperiodic.patch](tarball://root/attachments/some-uuid/ticket14219/trac_14219_rational_preperiodic.patch) by atowsley created at 2013-11-12 15:34:11\n\nAll tests passed. Everything looks good.",
    "created_at": "2013-11-12T15:34:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14219",
    "type": "issue_comment",
...
<a id='comment:23'></a>Attachment [trac_14219_rational_preperiodic.patch](tarball://root/attachments/some-uuid/ticket14219/trac_14219_rational_preperiodic.patch) by atowsley created at 2013-11-12 15:34:11
