...
<a id='comment:1'></a>As a comparison, with
...
<a id='comment:4'></a>Attachment [trac_14615-cythonize_lazy_attribute-v2.patch](tarball://root/attachments/some-uuid/ticket14615/trac_14615-cythonize_lazy_attribute-v2.patch) by @tscrim created at 2013-05-25 04:06:53
...
<a id='comment:5'></a>Great! thank you. I tried but failed to coerce hg into producing such a patch. I'm definitely happy with your changes. I'm just not sure that merging this ticket is actually an improvement. The only `*.pyx` file in which I was able to find a use of `lazy_attribute` is for `_element_class` on `Parent`.
