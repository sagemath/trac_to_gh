...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14975#issuecomment-185934",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14975#issuecomment-185935",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_14975_cmp_in_toric_morphism.patch](https://github.com/sagemath/sage/files/ticket14975/trac_14975_cmp_in_toric_morphism.patch) by @novoselt created at 2013-07-26 06:23:51\n\nWas hit by it before but apparently forgot...",
    "created_at": "2013-07-26T06:23:51Z",
    "issue": "https://github.com/sagemath/sage/issues/14975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14975#issuecomment-185936",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14975#issuecomment-185937",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14975#issuecomment-185938",
    "user": "https://github.com/jdemeyer"
}
```
