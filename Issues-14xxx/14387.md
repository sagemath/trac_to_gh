...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181544",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14387#event-41569"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14387#event-41570"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14387#event-41571"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14387#event-41572"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14387#event-41573"
}
```
...
```json
{
    "body": "As Thierry pointed out on the ask.sagemath question.  So, does #13973 fix this or not?",
    "created_at": "2014-05-28T15:25:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181546",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181547",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Reported upstream: https://sourceforge.net/p/maxima/bugs/2737/",
    "created_at": "2014-05-28T17:43:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181548",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14387#event-41574"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14387#event-41575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181549",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181550",
...
```json
{
    "body": "Works (no wrong answer) in sage 8.9.b7 with py3:\n\n```\nsage: sage: a = integrate(sqrt(1-1/4*cosh(x)^2),x)\n1/2*integrate(sqrt(-cosh(x)^2 + 4), x)\n```",
    "created_at": "2019-08-24T14:25:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181551",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14387#issuecomment-181552",
    "user": "https://github.com/pjbruin"
}
```
