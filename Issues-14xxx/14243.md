...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14243#event-184142"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14243#event-184143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14243#event-184144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14243#event-184145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14243#issuecomment-172748",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14243#issuecomment-172749",
    "user": "https://github.com/williamstein"
}
```
