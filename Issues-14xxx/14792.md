...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210192"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210195"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180754",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180755",
    "user": "https://github.com/sagetrac-felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180756",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180757",
    "user": "https://github.com/sagetrac-felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180758",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180759",
    "user": "https://github.com/sagetrac-felixs"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210199"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14792#event-210200"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180760",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180761",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<div id=\"comment:7\" align=\"right\">comment:7</div>\n\nReplying to [@sagetrac-felixs](#comment:6):\n> it will not solve the problem. before you notice, the source has gone.\n> \n> go ahead and close the ticket. try to make sure that i am the only one.\n\nYou speak in mysteries to me. But I will do as you suggested and close the ticket.",
    "created_at": "2013-12-10T15:54:40Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14792#issuecomment-180762",
    "user": "https://github.com/jdemeyer"
}
```
