...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14132#issuecomment-170684",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14132#issuecomment-170685",
    "user": "https://github.com/sagetrac-ManDay"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14132#event-182424"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14132#event-182425"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14132#event-182426"
}
```
