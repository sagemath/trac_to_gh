...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14443#event-187412"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14443#event-187413"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14443#event-187414"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14443#event-187415"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14443#issuecomment-176431",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14443#issuecomment-176432",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
