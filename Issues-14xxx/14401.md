...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14401#issuecomment-175680",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14401#event-186751"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14401#event-186752"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14401#event-186753"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14401#issuecomment-175681",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14401#event-186754"
}
```
