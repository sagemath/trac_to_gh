...
```json
{
    "body": "**Changing work issues** from \"Update `SPKG.txt`, add `src/` to `.hgignore`, probably remove upstream history\" to \"\".",
    "created_at": "2013-05-21T05:19:21Z",
    "issue": "https://github.com/sagemath/sage/issues/14594",
    "type": "issue_comment",
...
**Changing work issues** from "Update `SPKG.txt`, add `src/` to `.hgignore`, probably remove upstream history" to "".
