...
```json
{
    "body": "<a id='comment:19'></a>\nReplying to [leif](#comment%3A17):\n> They're (now) in `patches/libtool_flag.patch`.\n\nI don't see that file in [attachment:ntl-5.5.2.p2.patch](https://github.com/sagemath/sage/files/ticket14692/ntl-5.5.2.p2.patch). Did you forget to `hg add` that file?",
