...
archive/attachments_020408.json:
```json
{
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_14640_refactor_plot_expose.patch](https://github.com/sagemath/sage/files/ticket14640/trac_14640_refactor_plot_expose.patch)",
    "created_at": "2013-05-25T11:26:28Z",
    "issue": "https://github.com/sagemath/sage/issues/14640",
    "type": "issue_comment",
...
archive/attachments_020409.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:12'></a>\n**Attachment:** [trac_14640-refactor_plot_expose-review-ts.patch](https://github.com/sagemath/sage/files/ticket14640/trac_14640-refactor_plot_expose-review-ts.patch)\n\nI've uploaded a review patch which changes `describe()` which prints to `description()` which returns a string as per Nicolas' request. Needs a review.",
    "created_at": "2013-05-28T05:07:02Z",
    "issue": "https://github.com/sagemath/sage/issues/14640",
    "type": "issue_comment",
