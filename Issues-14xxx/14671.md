...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14671#issuecomment-180677",
    "user": "https://github.com/sagetrac-Zaxis"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14671#issuecomment-180678",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14671#event-190927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14671#event-190928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14671#event-190929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14671",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14671#event-190930"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-Zaxis** to **@sagetrac-bmanion**",
...
Changed assignee from **@sagetrac-Zaxis** to **@sagetrac-bmanion**
