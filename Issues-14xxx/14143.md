...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14143#event-182565"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14143#event-182566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14143#event-182567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14143#issuecomment-170904",
    "user": "https://github.com/sagetrac-alubovsky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14143#issuecomment-170905",
    "user": "https://github.com/jdemeyer"
}
```
