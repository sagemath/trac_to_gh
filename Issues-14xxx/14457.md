...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14457#issuecomment-176656",
    "user": "https://github.com/sagetrac-dshurbert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14457#issuecomment-176657",
    "user": "https://github.com/sagetrac-dshurbert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14457#event-187624"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14457#event-187625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14457#event-187626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14457",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14457#event-187627"
}
```
