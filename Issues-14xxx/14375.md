...
{
    "assignees": [],
    "body": "Split off from #14290.\n\n**Apply** [and [attachment: 14375_review.patch.gz](https://github.com/sagemath/sage/files/ticket14375/14375_review.patch.gz)(https://github.com/sagemath/sage/files/ticket14375/e49f4fad5e2b7283145791890eddc6fb.gz)\n\nAssignee: **@roed314**\n\nCC:  @vbraun\n\nReviewer: **Jeroen Demeyer, Volker Braun**\n\nAuthor: **Volker Braun**\n\nMerged: **sage-5.10.beta3**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/14375_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14375#event-186378"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14375#event-186379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14375#event-186380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14375#event-186381"
}
```
...
```json
{
    "body": "<a id='comment:25'>Comment 25:</a>\n*** ping ***\n\n[attachment: 14375_review.patch.gz](https://github.com/sagemath/sage/files/ticket14375/14375_review.patch.gz) needs review.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14375#issuecomment-175321",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14375#issuecomment-175322",
    "user": "https://github.com/jdemeyer"
}
```
