...
archive/attachments_020444.json:
```json
{
...
archive/attachments_020445.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [chromebook.cpuinfo](https://github.com/sagemath/sage/files/ticket14689/chromebook.cpuinfo)\n\ncpuinfo of the box",
    "created_at": "2013-06-05T09:06:18Z",
    "issue": "https://github.com/sagemath/sage/issues/14689",
    "type": "issue_comment",
...
**Attachment:** [chromebook.cpuinfo](https://github.com/sagemath/sage/files/ticket14689/chromebook.cpuinfo)
