...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14646#issuecomment-228543",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14646#issuecomment-228544",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>We could run a script (after building, after the usual docbuilding, and/or from `sage-location`) to collect top-level HTML pages below `$SAGE_SHARE/doc/` and create an index file from those.\n\nWe could also create more symbolic links, e.g. `$SAGE_SHARE/cvxopt/doc` -> `$SAGE_SHARE/doc/cvxopt/...`.",
    "created_at": "2013-05-26T18:20:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14646#issuecomment-228545",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>We could run a script (after building, after the usual docbuilding, and/or from `sage-location`) to collect top-level HTML pages below `$SAGE_SHARE/doc/` and create an index file from those.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14646#issuecomment-228546",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14646#event-41816"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14646#event-41817"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14646#event-41818"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14646#event-41819"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14646#event-41820"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14646#event-41821"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14646#event-41822"
}
```
