...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/pretty_console_print-EliX-jbp.patch",
...
```json
{
    "body": "several examples (some not in the patch)",
    "created_at": "2013-03-13T15:27:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14266",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/pcp_monkey_patch.py",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266_pretty_console_print-EliX-jbp.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266_ascii_art_module-EliX-jbp.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266_ascii_art_module-EliX-jbp (1).patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266_ascii_art_module-EliX-jbp.2.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266_ascii_art_13_05_14_EliX-jbp.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266_ascii_art_13_05_15_EliX-jbp.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266-ascii_art-review-ts.patch",
    "created_at": "2013-05-27T21:00:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14266",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket14266/trac_14266_terminal_width.patch",
