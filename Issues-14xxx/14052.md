...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183327",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Travis wrote a review patch which has been incorporated. The patch is ready for review!\n\nAnne",
    "created_at": "2013-02-05T02:02:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183328",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:2'></a>Travis wrote a review patch which has been incorporated. The patch is ready for review!
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_14052-infinite-crystal-as.patch](tarball://root/attachments/some-uuid/ticket14052/trac_14052-infinite-crystal-as.patch) by @anneschilling created at 2013-02-05 02:42:56\n\nRemoved trailing white spaces.\n\nAnne",
    "created_at": "2013-02-05T02:42:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183329",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:3'></a>Attachment [trac_14052-infinite-crystal-as.patch](tarball://root/attachments/some-uuid/ticket14052/trac_14052-infinite-crystal-as.patch) by @anneschilling created at 2013-02-05 02:42:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183330",
...
```json
{
    "body": "<a id='comment:4'></a>Everything looks good. Thanks.",
    "created_at": "2013-02-05T02:43:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183331",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>Everything looks good. Thanks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183332",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183333",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183334",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The patch I just uploaded shows how I think it should be done : adding an argument to the iterator method. My patch should create some conflicts with yours, I am sorry for that. Do you want to rebase your patch on mine?\n\nWhat my patch do not do for now is to deprecate this `TransitiveIdealGraded` class. This could be done in another ticket (in #6637 perhaps?). Anyhow, since I believe we should deprecate that class, I also think we should avoid to add new features to it.",
    "created_at": "2013-02-08T22:17:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183335",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:6'></a>The patch I just uploaded shows how I think it should be done : adding an argument to the iterator method. My patch should create some conflicts with yours, I am sorry for that. Do you want to rebase your patch on mine?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183337",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183339",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183340",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Salut Anne, Travis and Nicolas,\n\nYou convinced me. I will rebase my patch over yours and start the refactorization.\n\nS\u00e9bastien",
    "created_at": "2013-02-09T17:03:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183341",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:11'></a>Salut Anne, Travis and Nicolas,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183342",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183344",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39525"
}
```
...
```json
{
    ...
    "milestone": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39526"
}
```
...
```json
{
    ...
    "milestone": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39527"
}
```
...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39528"
}
```
...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39529"
}
```
...
```json
{
    ...
    "milestone": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14052#issuecomment-183345",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14052",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14052#event-39531"
}
```
