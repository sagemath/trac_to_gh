...
<a id='comment:10'></a>Replying to [felixs](#comment%3A8):
> I am not so sure whether experiments without libgap are necessary
...
<a id='comment:18'></a>Replying to [felixs](#comment%3A14):
> isn't sage gcc only? are there any limitations to libtool that i should know about?
...
<a id='comment:22'></a>Replying to [felixs](#comment%3A21):
> i don't know.
