...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189006",
    "user": "https://trac.sagemath.org/admin/accounts/users/mbejger"
}
```
...
```json
{
    "body": "Attachment [trac_15074_textbook_style_deriv_pynac_v2.patch](tarball://root/attachments/some-uuid/ticket15074/trac_15074_textbook_style_deriv_pynac_v2.patch) by mbejger created at 2013-09-10 21:03:24\n\nDear All, I have added a newer patch with an additional switch that allows for omitting the arguments of a function: \n\n```\nvar('x y z'); f = function('f', x, y, z)\nf.diff(x,z,y,z)\nD[0, 1, 2, 2](f)(x, y, z)\nfrom sage.symbolic.pynac import omit_function_args\nomit_function_args(True)\nD[0, 1, 2, 2](f)\n```",
    "created_at": "2013-09-10T21:03:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189007",
    "user": "https://trac.sagemath.org/admin/accounts/users/mbejger"
}
```

Attachment [trac_15074_textbook_style_deriv_pynac_v2.patch](tarball://root/attachments/some-uuid/ticket15074/trac_15074_textbook_style_deriv_pynac_v2.patch) by mbejger created at 2013-09-10 21:03:24
...
```json
{
    "body": "I agree that the arguments must be kept if the output is subject to further manipulations (e.g. the output is a symbolic expression). But it would be nice to remove them for *final* outputs, like LaTeX printing: this would greatly improve human readability of lengthy expressions.",
    "created_at": "2013-09-11T08:07:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189009",
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43357"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43358"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43359"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43360"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43361"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43362"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189010",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "I think this can be closed as \"invalid/fixed/obsolete\". This is how it works nowadays:\n\n```\nsage: var('x,y,z')                                                                                                          \n(x, y, z)\nsage: function('f')                                                                                                         \nf\nsage: f(x,y,z).diff(x,z,y,z)                                                                                                \ndiff(f(x, y, z), x, y, z, z)\n```",
    "created_at": "2021-09-23T17:19:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189011",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189012",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189013",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14837#event-43364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14837#issuecomment-189014",
