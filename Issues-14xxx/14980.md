...
```json
{
    ...
    "type": "issue",
    "updated_at": "2013-09-04T08:06:47Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195238"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195239"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195241"
}
```
...
```json
{
    "body": "Attachment: **[trac_14980-part3_miscellaneous.patch.gz](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part3_miscellaneous.patch.gz)**",
    "created_at": "2013-07-29T20:21:49Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186068",
    "user": "https://github.com/sagetrac-eisermbi"
}
```

Attachment: **[trac_14980-part3_miscellaneous.patch.gz](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part3_miscellaneous.patch.gz)**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186069",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195243"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186070",
    "user": "https://github.com/sagetrac-eisermbi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186071",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Attachment: **[trac_14980-part1_docu.patch.gz](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part1_docu.patch.gz)**\n\nAttachment: **[trac_14980-part2_docu.patch.gz](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part2_docu.patch.gz)**",
    "created_at": "2013-08-22T13:11:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186072",
    "user": "https://github.com/sagetrac-eisermbi"
}
```

Attachment: **[trac_14980-part1_docu.patch.gz](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part1_docu.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186073",
    "user": "https://github.com/sagetrac-eisermbi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186075",
    "user": "https://github.com/sagetrac-eisermbi"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195245"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195246"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186076",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186077",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186078",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186079",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195250"
}
```
...
```json
{
    "body": "<div id=\"comment:9\" align=\"right\">Comment 9</div>\n\nAttachment: **[trac_14980-part5_doctests.patch.gz](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part5_doctests.patch.gz)**\n\nReplying to [@jdemeyer](#comment%3A7):\n> Since you're cleaning up a lot anyway, how about changing `...` to `....:` in doctests?\n\nOkay, I added part 5: [attachment: trac_14980-part5_doctests.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part5_doctests.patch.gz).\n\n(1) It improves the formatting of the doctests.\n\n(2) As far as I know, there is no difference between\n\n```\nfrom sage.graphs.graph import Graph\nfrom sage.graphs import graph\n\ndef ........\n    import networkx\n    g=graph.Graph(.....\n```\n\nand\n\n```\nfrom sage.graphs.graph import Graph\n\ndef ........\n    import networkx\n    g = Graph(.....\n```\n\nHence, I replaced the former with the latter. (There were only `graph.Graph` expressions starting with `graph.`.)",
    "created_at": "2013-08-27T17:25:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186080",
    "user": "https://github.com/sagetrac-eisermbi"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195252"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -34,11 +34,14 @@\n \n * NEW: `benzenoids` is replaced by `fusenes` in `__append_to_doc`.\n \n-Part 3 (not applied anymore)\n+Part 3 (not to be applied anymore)\n \n Part 4\n * \"Basic structures\": Actually these graphs could be listed in the other classes. Three not so basic graphs are moved: \"BarbellGraph\", \"WheelGraph\" to families and \"BuckyGraph\" to small graphs. The example at the beginning of the module is expanded.\n \n+Part 5\n+* replaces `...` by `....:`  in doctests;\n+* replaces `graph.Graph(......)` by `Graph(......)`.\n \n ---\n \n@@ -47,5 +50,6 @@\n - [attachment: trac_14980-part1_docu.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part1_docu.patch.gz)\n - [attachment: trac_14980-part2_docu.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part2_docu.patch.gz)\n - [attachment: trac_14980-part4_basic.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part4_basic.patch.gz)\n+- [attachment: trac_14980-part5_doctests.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part5_doctests.patch.gz)\n \n (The 'part3' patch is *NOT* to be applied)\n``````\n",
    "created_at": "2013-08-27T17:25:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186081",
    "user": "https://github.com/sagetrac-eisermbi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186082",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -32,7 +32,7 @@\n \n * RandomGNP returns graph, hence, \"n\" -- number of nodes of the graph (not: *digraph*)\n \n-* NEW: `benzenoids` is replaced by `fusenes` in `__append_to_doc`.\n+* `benzenoids` is replaced by `fusenes` in `__append_to_doc`.\n \n Part 3 (not to be applied anymore)\n \n@@ -40,7 +40,7 @@\n * \"Basic structures\": Actually these graphs could be listed in the other classes. Three not so basic graphs are moved: \"BarbellGraph\", \"WheelGraph\" to families and \"BuckyGraph\" to small graphs. The example at the beginning of the module is expanded.\n \n Part 5\n-* replaces `...` by `....:`  in doctests;\n+* replaces `...` by `....:`  in doctests and removes some empty \"....:\" lines after loops;\n * replaces `graph.Graph(......)` by `Graph(......)`.\n \n ---\n@@ -50,6 +50,6 @@\n - [attachment: trac_14980-part1_docu.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part1_docu.patch.gz)\n - [attachment: trac_14980-part2_docu.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part2_docu.patch.gz)\n - [attachment: trac_14980-part4_basic.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part4_basic.patch.gz)\n-- [attachment: trac_14980-part5_doctests.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part5_doctests.patch.gz)\n+- [attachment: trac_14980-part5_doctests_noemptylines.patch](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part5_doctests_noemptylines.patch.gz)\n \n (The 'part3' patch is *NOT* to be applied)\n``````\n",
    "created_at": "2013-08-28T15:39:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186083",
    "user": "https://github.com/sagetrac-eisermbi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186084",
    "user": "https://github.com/sagetrac-eisermbi"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195253"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195254"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186085",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<div id=\"comment:13\" align=\"right\">Comment 13</div>\n\nAttachment: **[trac_14980-part5_doctests_noemptylines.patch.gz](https://github.com/sagemath/sage/files/ticket14980/trac_14980-part5_doctests_noemptylines.patch.gz)**",
    "created_at": "2013-09-04T08:06:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186086",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195255"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14980#event-195256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14980#issuecomment-186087",
    "user": "https://github.com/jdemeyer"
}
```
