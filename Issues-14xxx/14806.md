...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183448",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183449",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183450",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -9,6 +9,16 @@\n 10 loops, best of 3: 30.3 ms per loop\n ```\n \n+Content of [attachment:trac_14806.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806.patch) :\n+* Creates a new sage.graphs.base.static_sparse_backend modules containing two classes, StaticSparseCGraph and StaticSparseBackend, as it is done for the current sparse/dense backends.\n+* Updates the static_sparse_graph data structure to handle labels\n+* Updates the constructors of Graph and DiGraph by renaming the ``sparse`` keyword to ``data_structure`` which can now be set to ``sparse,dense`` or ``static_sparse`` (and others later)\n+\n+Content of [attachment:trac_14806-keyword.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch) :\n+* Deals with the consequences of renaming the keyword, i.e. changes doctests everywhere in the graph/ files, and into some other files of Sage too.\n+\n Nathann\n \n-(not ready for a review yet)\n+Apply:\n+* [attachment:trac_14806.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806.patch)\n+* [attachment:trac_14806-keyword.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch)\n``````\n",
    "created_at": "2013-06-22T14:00:50Z",
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183451",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183452",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -14,11 +14,11 @@\n * Updates the static_sparse_graph data structure to handle labels\n * Updates the constructors of Graph and DiGraph by renaming the ``sparse`` keyword to ``data_structure`` which can now be set to ``sparse,dense`` or ``static_sparse`` (and others later)\n \n-Content of [attachment:trac_14806-keyword.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch) :\n+Content of [attachment:trac_14806-update_keyword.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806-update_keyword.patch) :\n * Deals with the consequences of renaming the keyword, i.e. changes doctests everywhere in the graph/ files, and into some other files of Sage too.\n \n Nathann\n \n Apply:\n * [attachment:trac_14806.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806.patch)\n-* [attachment:trac_14806-keyword.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch)\n+* [attachment:trac_14806-update_keyword.patch](https://github.com/sagemath/sage/files/ticket14806/trac_14806-update_keyword.patch)\n``````\n",
    "created_at": "2013-06-22T14:20:57Z",
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183453",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183454",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129656"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183455",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183456",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183457",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183458",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183459",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183460",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183461",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183462",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183463",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129658"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129659"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183464",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183465",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129660"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183466",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129662"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129663"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14806/sparselabel.patch",
    "created_at": "2013-08-20T14:58:39Z",
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14806/sparselabel.patch",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>\nAttachment [sparselabel.patch](https://github.com/sagemath/sage/files/ticket14806/sparselabel.patch) by @nathanncohen created at 2013-08-20 14:58:39\n\nDone !",
    "created_at": "2013-08-20T14:58:39Z",
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183467",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183468",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-129665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183469",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183470",
    "user": "https://github.com/nathanncohen"
}
```
