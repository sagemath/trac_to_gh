...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193133"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183516",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183517",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183518",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,6 +9,16 @@\n 10 loops, best of 3: 30.3 ms per loop\n ```\n \n+Content of [attachment: trac_14806.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806.patch.gz) :\n+* Creates a new sage.graphs.base.static_sparse_backend modules containing two classes, StaticSparseCGraph and StaticSparseBackend, as it is done for the current sparse/dense backends.\n+* Updates the static_sparse_graph data structure to handle labels\n+* Updates the constructors of Graph and DiGraph by renaming the ``sparse`` keyword to ``data_structure`` which can now be set to ``sparse,dense`` or ``static_sparse`` (and others later)\n+\n+Content of [attachment: trac_14806-keyword.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch.gz) :\n+* Deals with the consequences of renaming the keyword, i.e. changes doctests everywhere in the graph/ files, and into some other files of Sage too.\n+\n Nathann\n \n-(not ready for a review yet)\n+Apply:\n+* [attachment: trac_14806.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806.patch.gz)\n+* [attachment: trac_14806-keyword.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch.gz)\n``````\n",
    "created_at": "2013-06-22T14:00:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183519",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183520",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,11 +14,11 @@\n * Updates the static_sparse_graph data structure to handle labels\n * Updates the constructors of Graph and DiGraph by renaming the ``sparse`` keyword to ``data_structure`` which can now be set to ``sparse,dense`` or ``static_sparse`` (and others later)\n \n-Content of [attachment: trac_14806-keyword.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch.gz) :\n+Content of [attachment: trac_14806-update_keyword.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806-update_keyword.patch.gz) :\n * Deals with the consequences of renaming the keyword, i.e. changes doctests everywhere in the graph/ files, and into some other files of Sage too.\n \n Nathann\n \n Apply:\n * [attachment: trac_14806.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806.patch.gz)\n-* [attachment: trac_14806-keyword.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806-keyword.patch.gz)\n+* [attachment: trac_14806-update_keyword.patch.gz](https://github.com/sagemath/sage/files/ticket14806/trac_14806-update_keyword.patch.gz)\n``````\n",
    "created_at": "2013-06-22T14:20:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183521",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183522",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193136"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183523",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183524",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193137"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183525",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183526",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183527",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183528",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183529",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183530",
    "user": "https://github.com/sagetrac-azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183531",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183532",
    "user": "https://github.com/sagetrac-azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183533",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183534",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193143"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183535",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183536",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14806#event-193145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183537",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14806#issuecomment-183538",
    "user": "https://github.com/nathanncohen"
}
```
