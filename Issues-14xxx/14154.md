...
```json
{
    "body": "<a id='comment:1'></a>It would be good to provide more minimal code exhibiting the problem.\n\nI'm setting the dependency simply because because any patch here might conflict with #14150.",
    "created_at": "2013-02-20T22:45:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14154#issuecomment-217221",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>It would be good to provide more minimal code exhibiting the problem.
...
```json
{
    "body": "Changing dependencies from \"\" to \"#14150\"",
    "created_at": "2013-02-20T22:45:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14154#issuecomment-217222",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "" to "#14150"
...
```json
{
    "body": "<a id='comment:2'></a>Also, it seems you are running in the notebook. Does running it in the command-line make a difference?",
    "created_at": "2013-02-20T22:47:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14154#issuecomment-217223",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>Also, it seems you are running in the notebook. Does running it in the command-line make a difference?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14154#issuecomment-217224",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>If would be really good if you could simplify the code to better find out where it goes wrong.",
    "created_at": "2013-04-01T10:30:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14154#issuecomment-217226",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>If would be really good if you could simplify the code to better find out where it goes wrong.
...
```json
{
    "body": "<a id='comment:7'></a>The expected is basically no output (the trenza function returns nothing, it is just to trigger the problem). As i said, the problem appears somehow randomly. Did you try to run it several times?\n\nAnd as Murphy's law dictates, now the problem doesn't show in my system either ;)\n\nI checked in both a Mageia server and my gentoo box. Both x86_64, with sage-5.7 compiled from source.",
    "created_at": "2013-04-01T18:38:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14154#issuecomment-217228",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:7'></a>The expected is basically no output (the trenza function returns nothing, it is just to trigger the problem). As i said, the problem appears somehow randomly. Did you try to run it several times?
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14154#event-39949"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14154#event-39950"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14154#event-39951"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14154#event-39952"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14154#event-39953"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14154#event-39954"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14154#event-39955"
}
```
