...
<a id='comment:37'></a>Replying to [tmonteil](#comment%3A33):
> `CFF` is not fully autonomous and behaves like an overlay over other Sage
> fields, thus sacrificing reliability over expressivity.
...
```json
{
    "body": "<a id='comment:54'></a>Branch passes `make ptestlong`. I added an early example of `continued_fraction_list` to the docs for convenience. I think the issue with exactifying reals should be addressed with a `GoodRealField` as mentioned in[comment:33](#comment%3A33), anyway a different ticket, as are extensions to symbolic expressions.",
    "created_at": "2014-12-18T07:52:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14567",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:65'></a>Replying to [vdelecroix](#comment%3A64):\n> Indeed... did you open a ticket?\n\n\nNo, can you?",
...
<a id='comment:65'></a>Replying to [vdelecroix](#comment%3A64):
> Indeed... did you open a ticket?
