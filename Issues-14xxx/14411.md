...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14411#issuecomment-175961",
    "user": "https://github.com/sagetrac-elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14411#issuecomment-175962",
    "user": "https://github.com/sagetrac-elixyre"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14411#event-186932"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14411#event-186933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14411",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14411#event-186934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14411#event-186935"
}
```
