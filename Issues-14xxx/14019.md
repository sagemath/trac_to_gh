...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                         |\n|---------------------------------------------------------------------------------------------------------|-------------------------|\n|[d10a6ef](http://git.sagemath.org/sage.git/commit/?id=d10a6ef)|Importing Nathann's patch|",
    "created_at": "2013-12-06T14:11:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:41'></a>\nThe current branch fixes the bug. The rationale is to allow posets to not have a specified linear extension. This is achieved by changing the input behavior of `FinitePoset`. If `elements` is specified, this is used for the underlying linear extension. If `elements` is None, then the default linear extension is now computed in the `__init__`, so that posets where linear extensions are not specified now compare equal.\n\nTravis and Anne\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[691807b](http://git.sagemath.org/sage.git/commit/?id=691807bd10ca2f1fd6351ce5e4460ac08027e0fa)|`Fixed issues with relabeling and elements. Fixed some doctests.`|\n|[d5c570c](http://git.sagemath.org/sage.git/commit/?id=d5c570c6960045b77db891bd08de0bc78fc706c0)|`Some more fixes.`|\n|[a1eca30](http://git.sagemath.org/sage.git/commit/?id=a1eca30f4845675ac76613852357787b6576cf3f)|`reinstated linear_extension`|\n|[95f735b](http://git.sagemath.org/sage.git/commit/?id=95f735bfc9dd5f054867448c6c0f7a40688a2496)|`getting the interface right!`|\n|[01dc92d](http://git.sagemath.org/sage.git/commit/?id=01dc92d22e2a323b4d66d0b8e80d1c9738ca663c)|`needed one more relabelling for correct linear extensions`|\n|[f1511c0](http://git.sagemath.org/sage.git/commit/?id=f1511c0ded4cd1e7ca852d5ff4cb29dd69796cdd)|`Fixing bugs in relabeling by not doing it automatically in __classcall__.`|\n|[6f86a9a](http://git.sagemath.org/sage.git/commit/?id=6f86a9a0b2fe4f4d75e9407b9b6b8bde2664c0fd)|`fixed some docs`|\n|[c7e7107](http://git.sagemath.org/sage.git/commit/?id=c7e710738c8e451f103dc2bb25b72e609452a0dd)|`Fixed last issues. All doctests pass.`|\n|[ed7f091](http://git.sagemath.org/sage.git/commit/?id=ed7f0910616d397db2320bfcb0994f6ae4f0e5b8)|`more doc test fixes`|\n|[b1eefd7](http://git.sagemath.org/sage.git/commit/?id=b1eefd78cd65736b44153761b929de1c4387cb70)|`Some more documentation as reference.`|",
    "created_at": "2014-10-10T19:32:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[e575742](http://git.sagemath.org/sage.git/commit/?id=e575742951572b4b383abeae1e21e934b9e1683f)|`fixed failing doc tests`|",
...
```json
{
    "body": "<a id='comment:52'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[68c2902](http://git.sagemath.org/sage.git/commit/?id=68c2902122a52cc16a13831b80d7a52c4e98fe86)|`fixed more spots where FinitePoset was used directly`|",
    "created_at": "2014-10-11T02:22:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:61'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|\n|[eff9b60](http://git.sagemath.org/sage.git/commit/?id=eff9b6093b060eeaba124c94cf2045ff96662676)|`fixed doc tests`|",
    "created_at": "2014-10-11T22:52:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:62'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[8dddb16](http://git.sagemath.org/sage.git/commit/?id=8dddb16ee9bce94fab03989228cf83dd567f8ac0)|`changes to canonical_label`|",
...
```json
{
    "body": "<a id='comment:67'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[f4e8c06](http://git.sagemath.org/sage.git/commit/?id=f4e8c0693b98dedc3466d44d33efd0b0f58cd6eb)|`Fixing doctests.`|\n|[63b1156](http://git.sagemath.org/sage.git/commit/?id=63b11563a09037677fdc55167ff4440e6a0a6d8e)|`Merge branch 'develop' into public/combinat/poset/fix_equality-14019`|\n|[115a325](http://git.sagemath.org/sage.git/commit/?id=115a32500018148858b06dc0040fc0a4e506041a)|`Fixing trivial doctest failures.`|",
...
```json
{
    "body": "<a id='comment:69'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[aa1cc73](http://git.sagemath.org/sage.git/commit/?id=aa1cc73510663efb9552f12dd432109c8fd0d20d)|`two more doc fixes in order_tree`|",
...
```json
{
    "body": "<a id='comment:71'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[c5c6a0c](http://git.sagemath.org/sage.git/commit/?id=c5c6a0c6c0cc48a2ce6a89652aaccb48b35b987a)|`oops, undid the ipython change`|",
    "created_at": "2014-10-13T01:13:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:89'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[02e3dab](http://git.sagemath.org/sage.git/commit/?id=02e3dabb60bd4b7e63622966b6f4bfe07f94439f)|`Reverted change in hasse_diagram() to fix poset show(). Fixed related issue in dual().`|",
    "created_at": "2014-10-14T02:25:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
