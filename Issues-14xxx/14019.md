...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214081",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Oh, yeah. And this patch also fixes this :\n\n```\ndef hasse_diagram(self, wrapped = True):\n    return DiGraph(self._hasse_diagram).relabel(self._list, inplace = False)\n```\n\nCombinat-Style.\n\nNathann",
    "created_at": "2013-01-26T15:36:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214082",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>Oh, yeah. And this patch also fixes this :
...
```json
{
    "body": "<a id='comment:3'></a>fixed by removing the useless keyword (it is useless, as it cannot be used and hence has never been). Casting the `HasseDiagram` to a digraph first is useless copy, as relabeling with `inplace = False` already makes a copy.\n\nAnd also because for some reason, up to now, a call to `.hasse_diagram()` returned a `DiGraph` and not a `HasseDiagram` object.\n\nNathann",
    "created_at": "2013-01-26T15:41:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214083",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:3'></a>fixed by removing the useless keyword (it is useless, as it cannot be used and hence has never been). Casting the `HasseDiagram` to a digraph first is useless copy, as relabeling with `inplace = False` already makes a copy.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214085",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214086",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Ok guys, you did it, I have no way to write a new `__eq__` method in `Poset` which is not \"self is other\" without getting an infinite loop. \n\nIf I want to actually compare the data of the posets (hasse diagram, vertices), then  comparing the data will raise a call to compare their parents, and I'm gone for another loop.\n\nNow what ?\n\nNathann",
    "created_at": "2013-01-26T16:21:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214087",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>Ok guys, you did it, I have no way to write a new `__eq__` method in `Poset` which is not "self is other" without getting an infinite loop. 
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_14019.patch](tarball://root/attachments/some-uuid/ticket14019/trac_14019.patch) by @anneschilling created at 2013-01-26 16:26:09\n\nWe discussed this at the Sage Days last week (unfortunately you were not there). The best way might be to have an option in Posets which would allow to create posets with and without an attached linear extension. Your use case would be in the new default case of no linear extension attached.\n\nBest,\n\nAnne",
    "created_at": "2013-01-26T16:26:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214088",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:7'></a>Attachment [trac_14019.patch](tarball://root/attachments/some-uuid/ticket14019/trac_14019.patch) by @anneschilling created at 2013-01-26 16:26:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214090",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214092",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214094",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Generally, `==` should mean identical and not just isomorphic. Up to automorphism there is only one set of a given size. But surely we don't want all sets of fixed size to compare equal, right? \n\nAny two objects that satisfy `==` may be substituted for each other in cached method calls. \n\nIf you want \"isomorphic with possibly non-unique isomorphism\" then just implement a `is_isomorphic()` method.",
    "created_at": "2013-01-28T15:30:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214096",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:16'></a>Generally, `==` should mean identical and not just isomorphic. Up to automorphism there is only one set of a given size. But surely we don't want all sets of fixed size to compare equal, right? 
...
```json
{
    "body": "<a id='comment:17'></a>There's nothing related to isomorphism in what I said. The same way that you expect that int(1) == Integer(1) is True, I would like that two posets that represent the very same partially ordered set be equal. This is totally linear, and consists in checking that i<j in one poset if and only if i<j in the other one. That's not an isomorphism, there is no relabeling involved.\n\nThis being said, I would like to have an answer to my question above. Not being able to define an `__eq__` function as you see fit because of the parent stuff looks to me like a problem.\n\nNathann",
    "created_at": "2013-01-28T15:58:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214097",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:17'></a>There's nothing related to isomorphism in what I said. The same way that you expect that int(1) == Integer(1) is True, I would like that two posets that represent the very same partially ordered set be equal. This is totally linear, and consists in checking that i<j in one poset if and only if i<j in the other one. That's not an isomorphism, there is no relabeling involved.
...
```json
{
    "body": "<a id='comment:18'></a>> But surely we don't want all sets of fixed size to compare equal, right? \n\n\nAnd surely we don't want all Sage objects to be UniqueRepresentation.\n\nNathann",
    "created_at": "2013-01-28T16:05:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214098",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:18'></a>> But surely we don't want all sets of fixed size to compare equal, right? 
...
```json
{
    "body": "<a id='comment:20'></a>What is the expected output of the following:\n\n```\nsage: d = DiGraph({2:[1],3:[1]})   \nsage: p1 = Poset(d)\nsage: p2 = p1.relabel({1:1,2:3,3:2})\nsage: p1[0] \n3\nsage: p2[0]\n2\nsage: @cached_function\n....: def first_element(poset): \n....:     return poset[0]\n....: \nsage: first_element(p1)\n3\nsage: first_element(p2)\n???\n```",
    "created_at": "2013-01-30T14:07:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214100",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:20'></a>What is the expected output of the following:
...
```json
{
    "body": "Changing stopgaps from \"\" to \"#14185\"",
    "created_at": "2013-02-26T17:03:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214101",
    "user": "https://github.com/lftabera"
}
```

Changing stopgaps from "" to "#14185"
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39423"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/andrew.mathas/ticket/14019\"",
    "created_at": "2013-12-06T09:59:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214102",
    "user": "https://github.com/AndrewAtLarge"
}
```

Changing branch from "" to "u/andrew.mathas/ticket/14019"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214103",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"a1a85ff09dcc34a56b9362a9d4461d907296718e\"",
    "created_at": "2013-12-06T10:05:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214104",
    "user": "https://github.com/AndrewAtLarge"
}
```

Changing commit from "" to "a1a85ff09dcc34a56b9362a9d4461d907296718e"
...
```json
{
    "body": "<a id='comment:25'></a>Hmm, not sure why the commit for #15479 is also on this ticket. Probably I screwed up and didn't branch off the master:(",
    "created_at": "2013-12-06T10:08:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214105",
    "user": "https://github.com/AndrewAtLarge"
}
```

<a id='comment:25'></a>Hmm, not sure why the commit for #15479 is also on this ticket. Probably I screwed up and didn't branch off the master:(
...
```json
{
    "body": "Changing commit from \"a1a85ff09dcc34a56b9362a9d4461d907296718e\" to \"d10a6efa75561632cdc76b2c98c5eca4312372ec\"",
    "created_at": "2013-12-06T14:11:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214107",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a1a85ff09dcc34a56b9362a9d4461d907296718e" to "d10a6efa75561632cdc76b2c98c5eca4312372ec"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214108",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>I have just undone my mistaken branching off #15479",
    "created_at": "2013-12-06T14:13:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214109",
    "user": "https://github.com/AndrewAtLarge"
}
```

<a id='comment:28'></a>I have just undone my mistaken branching off #15479
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39424"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39425"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39426"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39427"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39428"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39429"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214110",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214112",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>> Hopefully before you have gotten angry, I think better standardization could be used here too.\n\n\nCan you implement your idea this week ? If you can't I will implement the simple idea I understand (just give the relabelled Hasse Diagram) to fix the bug. If you can, tell me and so that I do not implement this for nothing.\n\nThanks,\n\nNathann",
    "created_at": "2014-09-27T13:49:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214113",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:35'></a>> Hopefully before you have gotten angry, I think better standardization could be used here too.
...
```json
{
    "body": "<a id='comment:38'></a>See https://groups.google.com/d/topic/sage-devel/WXNmH3PL7kY/discussion",
    "created_at": "2014-09-29T11:59:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214116",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:38'></a>See https://groups.google.com/d/topic/sage-devel/WXNmH3PL7kY/discussion
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214119",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214120",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214121",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214122",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>The current branch fixes the bug. The rationale is to allow posets to not have a specified linear extension. This is achieved by changing the input behavior of `FinitePoset`. If `elements` is specified, this is used for the underlying linear extension. If `elements` is None, then the default linear extension is now computed in the `__init__`, so that posets where linear extensions are not specified now compare equal.\n\nTravis and Anne\n\n---\nLast 10 new commits:",
    "created_at": "2014-10-10T19:32:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214123",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:41'></a>The current branch fixes the bug. The rationale is to allow posets to not have a specified linear extension. This is achieved by changing the input behavior of `FinitePoset`. If `elements` is specified, this is used for the underlying linear extension. If `elements` is None, then the default linear extension is now computed in the `__init__`, so that posets where linear extensions are not specified now compare equal.
...
```json
{
    "body": "Changing commit from \"d10a6efa75561632cdc76b2c98c5eca4312372ec\" to \"b1eefd78cd65736b44153761b929de1c4387cb70\"",
    "created_at": "2014-10-10T19:32:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214124",
    "user": "https://github.com/anneschilling"
}
```

Changing commit from "d10a6efa75561632cdc76b2c98c5eca4312372ec" to "b1eefd78cd65736b44153761b929de1c4387cb70"
...
```json
{
    "body": "Changing branch from \"u/andrew.mathas/ticket/14019\" to \"public/combinat/poset/fix_equality-14019\"",
    "created_at": "2014-10-10T19:32:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214125",
    "user": "https://github.com/anneschilling"
}
```

Changing branch from "u/andrew.mathas/ticket/14019" to "public/combinat/poset/fix_equality-14019"
...
```json
{
    "body": "<a id='comment:42'></a>FTR, we also did some minor cleanup of the file.",
    "created_at": "2014-10-10T19:33:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214126",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:42'></a>FTR, we also did some minor cleanup of the file.
...
```json
{
    "body": "Changing dependencies from \"\" to \"#17059\"",
    "created_at": "2014-10-10T19:33:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214127",
    "user": "https://github.com/tscrim"
}
```

Changing dependencies from "" to "#17059"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214128",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>Positive review ? On my computer this code breaks a *LOT* of doctests in the combinat folder.\n\nNathann",
    "created_at": "2014-10-10T19:46:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214129",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:43'></a>Positive review ? On my computer this code breaks a *LOT* of doctests in the combinat folder.
...
```json
{
    "body": "<a id='comment:44'></a>Also, I do not understand what you do in the `.dual()` function. You seem to define a `elements` variable that you do not use. As a result the dual of a Poset with a linear extension becomes a poset without linear extension.\n\nWould it also be possible to change the `__repr__` function so that is says explicitly that the poset is a `poset with a linear extension` ? The two posets behave as if they were of different type (they can never be equal), and if such a poset is returned by a function it may surprise the user that the poset is never equal to a poset he built himself.\n\nNathann",
    "created_at": "2014-10-10T20:05:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214130",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:44'></a>Also, I do not understand what you do in the `.dual()` function. You seem to define a `elements` variable that you do not use. As a result the dual of a Poset with a linear extension becomes a poset without linear extension.
...
```json
{
    "body": "<a id='comment:45'></a>Merge conflict, too",
    "created_at": "2014-10-10T20:13:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214131",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:45'></a>Merge conflict, too
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214132",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>Merge conflict ? Oh, yes probably with all the Poset tickets Jori wrote. Their code is based on the latest beta though.\n\nNathann",
    "created_at": "2014-10-10T20:14:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214133",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:46'></a>Merge conflict ? Oh, yes probably with all the Poset tickets Jori wrote. Their code is based on the latest beta though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214135",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"b1eefd78cd65736b44153761b929de1c4387cb70\" to \"e575742951572b4b383abeae1e21e934b9e1683f\"",
    "created_at": "2014-10-10T21:17:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214136",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b1eefd78cd65736b44153761b929de1c4387cb70" to "e575742951572b4b383abeae1e21e934b9e1683f"
...
```json
{
    "body": "<a id='comment:50'></a>Replying to [vbraun](#comment%3A45):\n> Merge conflict, too\n\n\nWhat tickets does it conflict with?",
    "created_at": "2014-10-10T23:16:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214138",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:50'></a>Replying to [vbraun](#comment%3A45):
> Merge conflict, too
...
```json
{
    "body": "<a id='comment:51'></a>I get lots of doctest failures with this. See http://sage.math.washington.edu/home/palmieri/misc/ptest-14019-OSX.log. (This is on an OS X machine, but I see the same failures on sage.math.)",
    "created_at": "2014-10-11T01:08:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214139",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:51'></a>I get lots of doctest failures with this. See http://sage.math.washington.edu/home/palmieri/misc/ptest-14019-OSX.log. (This is on an OS X machine, but I see the same failures on sage.math.)
...
```json
{
    "body": "Changing commit from \"e575742951572b4b383abeae1e21e934b9e1683f\" to \"68c2902122a52cc16a13831b80d7a52c4e98fe86\"",
    "created_at": "2014-10-11T02:22:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214140",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e575742951572b4b383abeae1e21e934b9e1683f" to "68c2902122a52cc16a13831b80d7a52c4e98fe86"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214141",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:54'></a>Replying to [jhpalmieri](#comment%3A47):\n> I can't even get to the point of running doctests: if I run `make`, then docbuilding fails with\n> \n> ```\n> [modmisc  ] loading pickled environment... not yet created\n> [modmisc  ] building [inventory]: targets for 16 source files that are out of date\n> [modmisc  ] updating environment: 16 added, 0 changed, 0 removed\n> [modmisc  ] reading sources... [  6%] index\n> [modmisc  ] reading sources... [ 12%] sage/modular/buzzard\n> Error building the documentation.\n> \n> Note: incremental documentation builds sometimes cause spurious\n> error messages. To be certain that these are real errors, run\n> \"make doc-clean\" first and try again.\n> Traceback (most recent call last):\n>   File \"/Users/palmieri/Desktop/Sage_stuff/git/sage/src/doc/common/builder.py\", line 1491, in <module>\n>     getattr(get_builder(name), type)()\n>   File \"/Users/palmieri/Desktop/Sage_stuff/git/sage/src/doc/common/builder.py\", line 292, in _wrapper\n>     getattr(get_builder(document), 'inventory')(*args, **kwds)\n>   File \"/Users/palmieri/Desktop/Sage_stuff/git/sage/src/doc/common/builder.py\", line 503, in _wrapper\n>     x.get(99999)\n>   File \"/Users/palmieri/Desktop/Sage_stuff/git/sage/local/lib/python/multiprocessing/pool.py\", line 558, in get\n>     raise self._value\n> NotImplementedError: Non injective relabeling\n> make: *** [doc-html] Error 1\n> ```\n\n\nI am not sure why/how this would be caused by this branch.\n\nAnne",
    "created_at": "2014-10-11T02:59:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214143",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:54'></a>Replying to [jhpalmieri](#comment%3A47):
> I can't even get to the point of running doctests: if I run `make`, then docbuilding fails with
> 
> ```
> [modmisc  ] loading pickled environment... not yet created
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214145",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:57'></a>You are right (I was in the wrong branch when running the tests whilst trying to investigate the doc build failure). I get the same doc failures.\n\nPosets are used in `src/sage/modular/modform_hecketriangle/analytic_type.py`\n\nAnne",
    "created_at": "2014-10-11T06:01:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214146",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:57'></a>You are right (I was in the wrong branch when running the tests whilst trying to investigate the doc build failure). I get the same doc failures.
...
```json
{
    "body": "Changing commit from \"68c2902122a52cc16a13831b80d7a52c4e98fe86\" to \"eff9b6093b060eeaba124c94cf2045ff96662676\"",
    "created_at": "2014-10-11T22:52:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214150",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "68c2902122a52cc16a13831b80d7a52c4e98fe86" to "eff9b6093b060eeaba124c94cf2045ff96662676"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214151",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214152",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"eff9b6093b060eeaba124c94cf2045ff96662676\" to \"8dddb16ee9bce94fab03989228cf83dd567f8ac0\"",
    "created_at": "2014-10-12T00:13:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214153",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "eff9b6093b060eeaba124c94cf2045ff96662676" to "8dddb16ee9bce94fab03989228cf83dd567f8ac0"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214155",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214158",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"8dddb16ee9bce94fab03989228cf83dd567f8ac0\" to \"115a32500018148858b06dc0040fc0a4e506041a\"",
    "created_at": "2014-10-12T19:30:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214159",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "8dddb16ee9bce94fab03989228cf83dd567f8ac0" to "115a32500018148858b06dc0040fc0a4e506041a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214161",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"115a32500018148858b06dc0040fc0a4e506041a\" to \"aa1cc73510663efb9552f12dd432109c8fd0d20d\"",
    "created_at": "2014-10-13T00:42:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214162",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "115a32500018148858b06dc0040fc0a4e506041a" to "aa1cc73510663efb9552f12dd432109c8fd0d20d"
...
```json
{
    "body": "<a id='comment:70'></a>There were two more doc test failures in `combinat/ordered_trees.py` due to the non-canonical way of labeling the vertices in `canonical_label`. I fixed those. Everything else looks ok to me.\n\n>However the labeling itself is not unique. Consider the path on 3 vertices with \n>labelings 0 - 1 - 2 and 1 - 0 - 2. The first one is no more canonical than the second.\n\n\nPrecisely!\n\nJohn: if you are happy now, can we set it back to positive review?\n\nNathann: if you are still unhappy, please change the behavior in a different ticket. In this ticket we wanted to keep the behavior of the posets with `_linear_extension = True` as previous.",
    "created_at": "2014-10-13T00:55:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214163",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:70'></a>There were two more doc test failures in `combinat/ordered_trees.py` due to the non-canonical way of labeling the vertices in `canonical_label`. I fixed those. Everything else looks ok to me.
...
```json
{
    "body": "Changing commit from \"aa1cc73510663efb9552f12dd432109c8fd0d20d\" to \"c5c6a0c6c0cc48a2ce6a89652aaccb48b35b987a\"",
    "created_at": "2014-10-13T01:13:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214164",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "aa1cc73510663efb9552f12dd432109c8fd0d20d" to "c5c6a0c6c0cc48a2ce6a89652aaccb48b35b987a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214165",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:72'></a>Oops, sorry, I accidentally pushed the ipython change (without which my sage does not even start any longer) ... but that is a problem with the most recent develop branch.",
    "created_at": "2014-10-13T01:14:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214166",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:72'></a>Oops, sorry, I accidentally pushed the ipython change (without which my sage does not even start any longer) ... but that is a problem with the most recent develop branch.
...
```json
{
    "body": "<a id='comment:73'></a>Should I complain here that `relabel` is also broken with return type:\n\n```\nP=LatticePoset({1:[2]})\nP.relabel(lambda x: x+1)\n```\n\noutputs \"Finite **poset** containing 2 elements\".",
    "created_at": "2014-10-13T07:41:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214167",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:73'></a>Should I complain here that `relabel` is also broken with return type:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214168",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:77'></a>No, `self._list` are wrapped elements (if not a facade), whereas `self._elements` are always the unwrapped elements, and we always want to label the digraph by the unwrapped elements.\n\nThe return type of relabel should be another ticket IMO.",
    "created_at": "2014-10-13T14:40:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214171",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:77'></a>No, `self._list` are wrapped elements (if not a facade), whereas `self._elements` are always the unwrapped elements, and we always want to label the digraph by the unwrapped elements.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214172",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:81'></a>Replying to [tscrim](#comment%3A77):\n\n> The return type of relabel should be another ticket IMO.\n\n\nOK, let it be part of #17142.",
    "created_at": "2014-10-13T17:35:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214176",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:81'></a>Replying to [tscrim](#comment%3A77):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214177",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:82'></a>> Go ahead and write a review patch which makes these changes!\n\n\nI will. The branch still does not pass tests though\n\n```\nsage -t --long src/sage/categories/finite_coxeter_groups.py\n```\n\nNathann",
    "created_at": "2014-10-13T21:01:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214178",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:82'></a>> Go ahead and write a review patch which makes these changes!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214179",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:85'></a>Do you get these errors without the branch applied?\n\nAnne",
    "created_at": "2014-10-13T21:42:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214181",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:85'></a>Do you get these errors without the branch applied?
...
```json
{
    "body": "<a id='comment:86'></a>> Do you get these errors without the branch applied?\n\n\nI do not.",
    "created_at": "2014-10-13T21:45:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214182",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:86'></a>> Do you get these errors without the branch applied?
...
```json
{
    "body": "<a id='comment:87'></a>Works for me in a sage session too; same for `view(P, tightpage=True)`.\n\nFTR, I have Coxeter3, dot2tex, database_gap, and gap_packages installed on my machine.",
    "created_at": "2014-10-13T21:54:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214183",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:87'></a>Works for me in a sage session too; same for `view(P, tightpage=True)`.
...
```json
{
    "body": "<a id='comment:88'></a>For what it's worth, I see the same errors as Nathann both on sage.math and on an OS X 10.9 machine.",
    "created_at": "2014-10-13T23:05:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214184",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:88'></a>For what it's worth, I see the same errors as Nathann both on sage.math and on an OS X 10.9 machine.
...
```json
{
    "body": "Changing commit from \"c5c6a0c6c0cc48a2ce6a89652aaccb48b35b987a\" to \"02e3dabb60bd4b7e63622966b6f4bfe07f94439f\"",
    "created_at": "2014-10-14T02:25:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214185",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "c5c6a0c6c0cc48a2ce6a89652aaccb48b35b987a" to "02e3dabb60bd4b7e63622966b6f4bfe07f94439f"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214186",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214187",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:91'></a>FTR, this conflicts with #16933 which also removes the `p(i)` for `p[i]` thing.",
    "created_at": "2014-10-14T06:41:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214189",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:91'></a>FTR, this conflicts with #16933 which also removes the `p(i)` for `p[i]` thing.
...
```json
{
    "body": "<a id='comment:92'></a>Okay, after having tried again I will not rename those attributes `._list` and `._elements`, for it breaks doctests everywhere as everybody calls the private parameters directly.\n\nNathann",
    "created_at": "2014-10-14T13:34:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214190",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:92'></a>Okay, after having tried again I will not rename those attributes `._list` and `._elements`, for it breaks doctests everywhere as everybody calls the private parameters directly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214191",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"02e3dabb60bd4b7e63622966b6f4bfe07f94439f\" to \"e677d31fa4e40822bcd00c509dd1ca94ed6de52d\"",
    "created_at": "2014-10-14T13:37:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214192",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "02e3dabb60bd4b7e63622966b6f4bfe07f94439f" to "e677d31fa4e40822bcd00c509dd1ca94ed6de52d"
...
```json
{
    "body": "<a id='comment:95'></a>> Just one thing: I would prefer `_with_linear_extension rather` than `_carries_linear_extensions` since we already use this convention in our \"WithBasis\" and friends. I can do this change if you wish.\n\n\nThat is fine with me! Travis and I are done with the patch, so you can change whatever you two agree on!\n\nBest,\n\nAnne",
    "created_at": "2014-10-14T18:56:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214194",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:95'></a>> Just one thing: I would prefer `_with_linear_extension rather` than `_carries_linear_extensions` since we already use this convention in our "WithBasis" and friends. I can do this change if you wish.
...
```json
{
    "body": "<a id='comment:96'></a>> That is fine with me! Travis and I are done with the patch, so you can change whatever you two agree on!\n\n\nNo prob !\n\nNathann",
    "created_at": "2014-10-15T07:55:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214195",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:96'></a>> That is fine with me! Travis and I are done with the patch, so you can change whatever you two agree on!
...
```json
{
    "body": "<a id='comment:97'></a>Replying to [ncohen](#comment%3A96):\n> > That is fine with me! Travis and I are done with the patch, so you can change whatever you two agree on!\n\n> \n> No prob !\n\n\nAre we done now and can set positive review?\n\nAnne",
    "created_at": "2014-10-16T05:05:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214196",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:97'></a>Replying to [ncohen](#comment%3A96):
> > That is fine with me! Travis and I are done with the patch, so you can change whatever you two agree on!
...
```json
{
    "body": "<a id='comment:98'></a>> Are we done now and can set positive review?\n\n\nNicolas wants to rename something.\n\nNathann",
    "created_at": "2014-10-16T05:07:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214197",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:98'></a>> Are we done now and can set positive review?
...
```json
{
    "body": "Changing commit from \"e677d31fa4e40822bcd00c509dd1ca94ed6de52d\" to \"3afec891b4d2d75b659c163c540bf02606477810\"",
    "created_at": "2014-10-16T21:28:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214198",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e677d31fa4e40822bcd00c509dd1ca94ed6de52d" to "3afec891b4d2d75b659c163c540bf02606477810"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214199",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:100'></a>I renamed `_carries_linear_extension` to `_with_linear_extension`. Please set a positive review now if you are happy!\n\nAnne",
    "created_at": "2014-10-16T21:29:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214200",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:100'></a>I renamed `_carries_linear_extension` to `_with_linear_extension`. Please set a positive review now if you are happy!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214201",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"3afec891b4d2d75b659c163c540bf02606477810\" to \"1c0d02dd479f1805b3250bd8d79257e94369bffd\"",
    "created_at": "2014-10-17T01:55:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214202",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "3afec891b4d2d75b659c163c540bf02606477810" to "1c0d02dd479f1805b3250bd8d79257e94369bffd"
...
```json
{
    "body": "<a id='comment:2'></a>I've handled the conflict from #16933, so we're back to positive review.",
    "created_at": "2014-10-17T01:56:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214203",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>I've handled the conflict from #16933, so we're back to positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214204",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214205",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214206",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Breaks docbuild after #16933 is applied.",
    "created_at": "2014-10-17T14:41:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214207",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>Breaks docbuild after #16933 is applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214208",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214209",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214210",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"1c0d02dd479f1805b3250bd8d79257e94369bffd\" to \"23de9f5da6ad88e771740e0ecc9404d9b39d283f\"",
    "created_at": "2014-10-17T20:01:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214211",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "1c0d02dd479f1805b3250bd8d79257e94369bffd" to "23de9f5da6ad88e771740e0ecc9404d9b39d283f"
...
```json
{
    "body": "<a id='comment:6'></a>Fixed. What had happened is we removed a reference (because it was a duplicate), but without deleting the doc first, there was still a reference for sphinx, which is why we didn't catch it before when we checked that the doc builds.",
    "created_at": "2014-10-17T20:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214212",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:6'></a>Fixed. What had happened is we removed a reference (because it was a duplicate), but without deleting the doc first, there was still a reference for sphinx, which is why we didn't catch it before when we checked that the doc builds.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214213",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214214",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214215",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214216",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214217",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214218",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "Changing branch from \"public/combinat/poset/fix_equality-14019\" to \"23de9f5da6ad88e771740e0ecc9404d9b39d283f\"",
    "created_at": "2014-10-18T18:19:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214219",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/combinat/poset/fix_equality-14019" to "23de9f5da6ad88e771740e0ecc9404d9b39d283f"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14019#event-39430"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214220",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"23de9f5da6ad88e771740e0ecc9404d9b39d283f\" to \"\"",
    "created_at": "2014-10-19T17:05:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214221",
    "user": "https://github.com/nthiery"
}
```

Changing commit from "23de9f5da6ad88e771740e0ecc9404d9b39d283f" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214222",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Thanks Anne for finalizing!",
    "created_at": "2014-10-19T17:05:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14019#issuecomment-214223",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:9'></a>Thanks Anne for finalizing!
