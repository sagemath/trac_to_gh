...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226098",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>HMmm... This, on the other hand, is probably a bad idea... You make some tests very long to check and we are supposed to run tests very often (I got yelled at recently for not doing it). \n\nMost of the tests you added are good, but you increased several constants a lot : `trees(6)` bbecomes `trees(15)`, and you test twice that a bipartite graph with more than 1000 vertices is bipartite `:-P`\n\nAnd computer the chromatic number of Kneser graphs is very slow if I remember correctly `O_o`\n\nPlus I'm not very sure that Jeroen would like that ... `:-P`\n\nNathann",
    "created_at": "2013-05-04T09:04:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226099",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>HMmm... This, on the other hand, is probably a bad idea... You make some tests very long to check and we are supposed to run tests very often (I got yelled at recently for not doing it). 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226102",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226103",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226104",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226106",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Helloooooooooooooo !!!\n\nHmmmm.. The second patch cannot be applied by itself.\n\nNathann",
    "created_at": "2013-05-08T08:47:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226107",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:10'></a>Helloooooooooooooo !!!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226108",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Didn't you say before that only `trac_14528_newtests.2.patch` had to be considered, and not `trac_14528_newtests.patch` ?\n\nNathann",
    "created_at": "2013-05-08T08:53:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226109",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:12'></a>Didn't you say before that only `trac_14528_newtests.2.patch` had to be considered, and not `trac_14528_newtests.patch` ?
...
```json
{
    "body": "<a id='comment:13'></a>There was some mess introduced by TRAC since I uploaded a fresh patch with exactly the same name. The newly attached patch should be good!\n\nSorry for the confusion!\n\nJernej",
    "created_at": "2013-05-10T17:52:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226110",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:13'></a>There was some mess introduced by TRAC since I uploaded a fresh patch with exactly the same name. The newly attached patch should be good!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226114",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [trac_XXX_no_mess.patch](tarball://root/attachments/some-uuid/ticket14528/trac_XXX_no_mess.patch) by @nathanncohen created at 2013-05-12 17:19:00\n\nHellooooooooooooo !!\n\n> Yes correct. I am making this random mistakes all the time. Your suggestion for is_perfect makes sense in this case. Though I think it still covers only a small % of input graphs.\n\n\nAgreed. Though I really have no idea what someone who has a use for this method will run it on.\n\n> Yeah! I think it *should* not be that hard to implement but I don't think anyone is really using this test that much...\n\n\nAgreed too. But at this level, we mostly code algorithms for our own pleasure, even if sometimes, much later, some guys comes up saying that it helped him.\n\nI spent a crazy amount of time writing #14562 and I really have no use for it `:-P`\n\n> PS. I have updated the patch, could you please check if its fine with you?\n\n\nImmediately !\n\nNathann",
    "created_at": "2013-05-12T17:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226115",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:18'></a>Attachment [trac_XXX_no_mess.patch](tarball://root/attachments/some-uuid/ticket14528/trac_XXX_no_mess.patch) by @nathanncohen created at 2013-05-12 17:19:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226116",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226117",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226118",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Goooooooood to go !\n\nNathann",
    "created_at": "2013-05-12T17:26:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226119",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:19'></a>Goooooooood to go !
...
```json
{
    "body": "<a id='comment:20'></a>Thank you for the review! Should we say to someone which patch to actually apply?",
    "created_at": "2013-05-12T17:56:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226120",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:20'></a>Thank you for the review! Should we say to someone which patch to actually apply?
...
```json
{
    "body": "<a id='comment:21'></a>OOps, you are right !\n\nJust added the information to the ticket's description.\n\nNathann",
    "created_at": "2013-05-12T17:57:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226121",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:21'></a>OOps, you are right !
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226122",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226123",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226124",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226125",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14528#event-41344"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14528#issuecomment-226126",
    "user": "https://github.com/jdemeyer"
}
```
