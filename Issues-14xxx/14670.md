...
<a id='comment:1'></a>How do we know when we can close this ticket?
...
```json
{
    "body": "<a id='comment:2'></a>Fair enough, how about closing this ticket once the two error messages above have been adressed (assuming you agree that this is indeed a problem)?",
...
<a id='comment:2'></a>Fair enough, how about closing this ticket once the two error messages above have been adressed (assuming you agree that this is indeed a problem)?
...
<a id='comment:3'></a>These error messages don't appear anywhere in the Sage code:
...
<a id='comment:4'></a>The error message about negative numbers is the same you get when
