...
```json
{
    "body": "<a id='comment:21'></a>\nGitified, doctested and fixed some minor problems. `sage/coding/decoder` didn't use to show up in the reference manual, I added it to the \"Coding theory\" section and fixed some docstring bugs.\n\nThere where conflicts while importing the mercurial patches. It'd be better if the original author could check the merge was done right.\n\n---\nNew commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[bbbdf5a](http://git.sagemath.org/sage.git/commit/?id=bbbdf5a339570b1c31b76cb72f9b6ba90146329c)|`Add new decoding algorithms for linear codes.`|\n|[fba788b](http://git.sagemath.org/sage.git/commit/?id=fba788bc1b59bc4dd245fbde99094bb3cb48fa3d)|`Fixed deprecation warnings`|\n|[d21956c](http://git.sagemath.org/sage.git/commit/?id=d21956ca00caf389801f84ecadc15059e1fb4f8e)|`Expose sage/coding/decoder in the ref manual, and doc fixes`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[d02a468](http://git.sagemath.org/sage.git/commit/?id=d02a468d88d1a64915c1bf7873bbd22dc06cbd37)|`merge develop on to #14973; resolved merge conflicts`|\n|[9f31603](http://git.sagemath.org/sage.git/commit/?id=9f31603bc9cc8a60384d689a7e408bfac577f369)|`fix docstrings in decoder.py`|\n|[32d9c4f](http://git.sagemath.org/sage.git/commit/?id=32d9c4fbeab3639d9cf11344ef058accbbde1c7d)|`fix some docstrings in linear_code.py`|\n|[bf4094d](http://git.sagemath.org/sage.git/commit/?id=bf4094d2d0bb63e5a2e8d34249f235e33e7e34c9)|`remove deprecation message about method to algorithm from sage/coding`|\n|[eba4566](http://git.sagemath.org/sage.git/commit/?id=eba456606f0126b27f51d1e54ecf7104920cf459)|`one more merge conflict that was missed`|\n|[b1850ba](http://git.sagemath.org/sage.git/commit/?id=b1850ba30e81c0772974187818c1c50b6e06d72c)|`groebner -> Groebner`|",
    "created_at": "2014-05-24T14:02:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14973",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[743826b](http://git.sagemath.org/sage.git/commit/?id=743826b1c73c946be9b8ff4fdb97819879fc07ac)|`fix some documentation build problems`|",
    "created_at": "2014-05-24T15:02:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14973",
    "type": "issue_comment",
