...
```json
{
    "body": "<a id='comment:1'></a>NetworkX should have a pretty decent test for distance regular graphs. Could you perhaps just verify the performance of yours vs NetworkX?\n\nAlso is there a chance we would want to have a certificate for this function as well?",
    "created_at": "2013-05-20T13:01:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227941",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:1'></a>NetworkX should have a pretty decent test for distance regular graphs. Could you perhaps just verify the performance of yours vs NetworkX?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227944",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227945",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>> Well for the certificate.. Perhaps not really a certificate but a distance partition.\n\n\nA distance partition ? `O_o`\n\nWhat do you mean ? You can already get the distribution of distances with ``parameters=True``, but I don't see what else we could return...\n\nNathann",
    "created_at": "2013-05-20T13:14:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227946",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>> Well for the certificate.. Perhaps not really a certificate but a distance partition.
...
```json
{
    "body": "<a id='comment:9'></a>From what I know the guys doing distance-regular graphs they use to write \"bubbles.\" They pick a vertex v which is the first \"bubble\", then they take the neighborhood of v to be the second bubble and then the neighbors at distance 3 from $v$ and so on...",
    "created_at": "2013-05-20T16:56:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227949",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:9'></a>From what I know the guys doing distance-regular graphs they use to write "bubbles." They pick a vertex v which is the first "bubble", then they take the neighborhood of v to be the second bubble and then the neighbors at distance 3 from $v$ and so on...
...
```json
{
    "body": "<a id='comment:11'></a>Yoooooooooo !\n\n> And you have this kind of info when checking distance regularity anyway, so why not have a corresponding function?\n\n\nIt is already available in the patch\n\n```\nsage: graphs.CubeGraph(4).is_distance_regular(parameters = True)\n{1: 4, 2: 6, 3: 4, 4: 1}\n```\n\nnathann",
    "created_at": "2013-05-21T07:45:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227951",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:11'></a>Yoooooooooo !
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227952",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14619#event-41669"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>almost good to go. I would like this function to appear in the doc !",
    "created_at": "2013-08-29T15:33:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227956",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:17'></a>almost good to go. I would like this function to appear in the doc !
...
```json
{
    "body": "<a id='comment:18'></a>> almost good to go. I would like this function to appear in the doc !\n\n\nYeah ?... Well it does, doesn't it ?\n\nNathann",
    "created_at": "2013-08-29T15:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227957",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:18'></a>> almost good to go. I would like this function to appear in the doc !
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227958",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227959",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227960",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>ok, I have found it in undirected graphs documentation\n\nI am giving a positive review, not waiting for the bot to do its job.",
    "created_at": "2013-08-29T16:02:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227961",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:19'></a>ok, I have found it in undirected graphs documentation
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227962",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Cool. Thaaaaaaaaaaaaaaaaaanks ! `:-)`\n\nNathann",
    "created_at": "2013-08-29T16:05:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227963",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:20'></a>Cool. Thaaaaaaaaaaaaaaaaaanks ! `:-)`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227964",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227965",
...
```json
{
    "body": "<a id='comment:23'></a>There is something wrong with the filenames of these patches, there are some weird characters at the end. The same issue also happened with the \"part5\" patch of #14980. Please find out why and fix it.",
    "created_at": "2013-08-30T08:35:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227966",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>There is something wrong with the filenames of these patches, there are some weird characters at the end. The same issue also happened with the "part5" patch of #14980. Please find out why and fix it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227967",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"patch filenames\"",
    "created_at": "2013-08-30T08:35:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227968",
    "user": "https://github.com/jdemeyer"
}
```

Changing work_issues from "" to "patch filenames"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227969",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227970",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227971",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>It seems to be a very rare bug that happens when a file is named \"trac_14619.patch\". No idea on earth of what is happening.\n\nI \"fixed\" it.\n\nNathann",
    "created_at": "2013-08-30T08:45:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227972",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:24'></a>It seems to be a very rare bug that happens when a file is named "trac_14619.patch". No idea on earth of what is happening.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227973",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227974",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14619#event-41670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227975",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227976",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>see #15864 for a fix.",
    "created_at": "2014-02-27T10:29:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14619",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14619#issuecomment-227979",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:28'></a>see #15864 for a fix.
