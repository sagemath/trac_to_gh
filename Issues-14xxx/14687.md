...
archive/attachments_020441.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_14687-scripts.patch](https://github.com/sagemath/sage/files/ticket14687/trac_14687-scripts.patch)\n\nTo scripts repository",
    "created_at": "2013-06-05T02:57:12Z",
    "issue": "https://github.com/sagemath/sage/issues/14687",
    "type": "issue_comment",
...
archive/attachments_020442.json:
```json
{
    "asset_content_type": "application/octet-stream",
