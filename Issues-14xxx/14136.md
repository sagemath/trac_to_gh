...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14136#event-182468"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14136#event-182469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14136#event-182470"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n Or did someone already implement them?\n \n Here's my code. Its weakest point is probably the input; instead of an actual pair of a poset and a map from its elements to {1,2,3,...}, it takes a pair of a poset and a linear order on it represented as a tuple of its elements. (See docstring for details. By the way, I'm hoping the LaTeX does work... no idea how to check that.)\n+\n+* Apply: [attachment: trac_14136-p_partition_enumerator-review-ts.patch.gz](https://github.com/sagemath/sage/files/ticket14136/trac_14136-p_partition_enumerator-review-ts.patch.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14136#issuecomment-170742",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14136#issuecomment-170743",
    "user": "https://github.com/fchapoton"
}
```
