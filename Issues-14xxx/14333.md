...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124241"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124242"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124243"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124244"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124245"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14333/trac_14333-singular_function_interface.patch",
    "created_at": "2013-09-28T17:24:53Z",
    "issue": "https://github.com/sagemath/sage/issues/14333",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14333/trac_14333-singular_function_interface.patch",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "**Attachment:** [trac_14333-singular_function_interface.patch](https://github.com/sagemath/sage/files/ticket14333/trac_14333-singular_function_interface.patch)",
    "created_at": "2013-09-28T17:24:53Z",
    "issue": "https://github.com/sagemath/sage/issues/14333",
    "type": "issue_comment",
...
**Attachment:** [trac_14333-singular_function_interface.patch](https://github.com/sagemath/sage/files/ticket14333/trac_14333-singular_function_interface.patch)
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124246"
}
```
...
```json
{
    ...
    "milestone": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124247"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124248"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124249"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124250"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124251"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124252"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124253"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14333",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14333#event-124254"
}
```
