...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226047",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>+1 for TypeError, or perhaps subclass `MutabilityError(TypeError)` so you can just try/except on the mutability.\n\nIf you also want to change the mutability in the decorator then you should provide additional ones like ``@`force_immutable`. Though this might be overengineering things.",
    "created_at": "2013-05-03T20:44:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226048",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>+1 for TypeError, or perhaps subclass `MutabilityError(TypeError)` so you can just try/except on the mutability.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226049",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I have changed it into `ValueError`, because this is what is raised in `Mutability._require_mutable` as well.\n\nI agree that it would be over-engineering to change mutability when hash is called.",
    "created_at": "2013-05-06T07:19:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226050",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>I have changed it into `ValueError`, because this is what is raised in `Mutability._require_mutable` as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226052",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226053",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226054",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14524#event-41333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226055",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226056",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14524#issuecomment-226057",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14524",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14524#event-41334"
}
```
