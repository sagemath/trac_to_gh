...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14868#event-194097"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14868#event-194098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14868#event-194099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14868#event-194100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14868#issuecomment-184699",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14868#issuecomment-184700",
    "user": "https://github.com/jdemeyer"
}
```
