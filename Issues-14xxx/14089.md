...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_14089-crystal-speed-up-as.patch](tarball://root/attachments/some-uuid/ticket14089/trac_14089-crystal-speed-up-as.patch) by @anneschilling created at 2013-02-10 07:26:38",
    "created_at": "2013-02-10T07:26:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215661",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:2'></a>Attachment [trac_14089-crystal-speed-up-as.patch](tarball://root/attachments/some-uuid/ticket14089/trac_14089-crystal-speed-up-as.patch) by @anneschilling created at 2013-02-10 07:26:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215662",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Does this also speed up the type `['D', n, 1]` spin KR crystals (right now they take a long time because `promotion_on_highest_weight_vectors()` iterates over the entire crystal and is called 3 times)?\n\nAlso, for the `index_set()` method in `categories/crystals.py`, could we change it so that it returns `self._cartan_type.index_set()`? It seems that `CrystalOfTableaux` is the only crystal which directly implements `cartan_matrix()` and does not have the `_cartan_matrix` attribute. This seems to drop the number of function calls when iterating over crystals by about 10%.\n\nThanks,\n\nTravis",
    "created_at": "2013-02-10T18:44:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215663",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>Does this also speed up the type `['D', n, 1]` spin KR crystals (right now they take a long time because `promotion_on_highest_weight_vectors()` iterates over the entire crystal and is called 3 times)?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215664",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> > Also, for the `index_set()` method in `categories/crystals.py`, could we change it so that it returns `self._cartan_type.index_set()`? It seems that `CrystalOfTableaux` is the only crystal which directly implements `cartan_matrix()` and does not have the `_cartan_matrix` attribute. This seems to drop the number of function calls when iterating over crystals by about 10%.\n\n> \n> I can cache index_set, which should make it faster.\n\n\nIn fact, this breaks some doc tests since caching an object that is not immutable is dangerous. Unless there is really a significant speedup, I won't make this change for now.\n\nAnne",
    "created_at": "2013-02-11T00:27:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215665",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:5'></a>> > Also, for the `index_set()` method in `categories/crystals.py`, could we change it so that it returns `self._cartan_type.index_set()`? It seems that `CrystalOfTableaux` is the only crystal which directly implements `cartan_matrix()` and does not have the `_cartan_matrix` attribute. This seems to drop the number of function calls when iterating over crystals by about 10%.
...
```json
{
    "body": "<a id='comment:7'></a>> So it does help, but they still take a long time to initialize compared to their counterparts. However this can be an issue for another ticket.\n\n\nUnless you have a specific suggestion on how to improve this, I would leave it for another ticket.\n\n> As for the caching of the `index_set()`, the problem is (as you stated) this returns a mutable list rather than an immutable tuple. I tried doing this once and from what I recall, the rigged configurations code broke because it does something like\n> \n> ```\n> I = self.index_set()\n> I.pop(0)\n> ```\n> which would have to be tweaked to\n> \n> ```\n> I = self.index_set()[1:]\n> ```\n> but IDK if this behavior occurs anywhere else.\n\n\nYes, this also occurs in tensor_product in /combinat/crystals\n\nAnne",
    "created_at": "2013-02-11T01:31:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215667",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:7'></a>> So it does help, but they still take a long time to initialize compared to their counterparts. However this can be an issue for another ticket.
...
```json
{
    "body": "<a id='comment:8'></a>> As for the caching of the `index_set()`, the problem is (as you stated) this returns a mutable list rather than an immutable tuple. I tried doing this once and from what I recall, the rigged configurations code broke because it does something like\n> \n> ```\n> I = self.index_set()\n> I.pop(0)\n> ```\n> which would have to be tweaked to\n> \n> ```\n> I = self.index_set()[1:]\n> ```\n\n\nOr just: `self.cartan_type().classical().index_set()` (which would\nby the way be safer w.r.t. affine types where the special node would\nnot be 0).",
    "created_at": "2013-02-11T03:41:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215668",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:8'></a>> As for the caching of the `index_set()`, the problem is (as you stated) this returns a mutable list rather than an immutable tuple. I tried doing this once and from what I recall, the rigged configurations code broke because it does something like
> 
> ```
> I = self.index_set()
> I.pop(0)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215669",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Looks good to me as well.",
    "created_at": "2013-02-12T19:12:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215670",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>Looks good to me as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215671",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215672",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215673",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215674",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215675",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14089#event-39679"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14089#issuecomment-215676",
    "user": "https://github.com/jdemeyer"
}
```
