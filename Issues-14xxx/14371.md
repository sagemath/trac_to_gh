...
```
On hawk (OpenSolaris), after applying [attachment: 14371_traceback_dont_catch.patch.gz](https://github.com/sagemath/sage/files/ticket14371/14371_traceback_dont_catch.patch.gz) to get a useful traceback:
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14371#event-186309"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14371#event-186310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14371#event-186311"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14371#event-186312"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n-On hawk (OpenSolaris), after applying [attachment: 14371:traceback.patch.gz](https://github.com/sagemath/sage/files/ticket14371/368e8460a164a4a3013b6e8a7d4d071d.gz) to get a useful traceback:\n+On hawk (OpenSolaris), after applying [attachment: 14371_traceback.patch.gz](https://github.com/sagemath/sage/files/ticket14371/14371_traceback.patch.gz) to get a useful traceback:\n \n ```\n sage -t devel/sage/sage/interfaces/expect.py\n``````\n",
...
```json
{
    "body": "<a id='comment:12'>Comment 12:</a>\n[= [attachment: trac_14371_dont_catch_runtimeerror.patch.gz](https://github.com/sagemath/sage/files/ticket14371/trac_14371_dont_catch_runtimeerror.patch.gz) + [attachment: 14371_traceback.patch.gz](https://github.com/sagemath/sage/files/ticket14371/14371_traceback.patch.gz)(https://github.com/sagemath/sage/files/ticket14371/8c5f4fe9d87cf7358fbf79cb9907068d.gz) with 1 change: inherit `SingularError` from `RuntimeError` for backwards compatibility.",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,3 +36,5 @@\n     Error evaluating def sage51=2+3; in Singular\n **********************************************************************\n ```\n+\n+**Apply** [and [attachment: 14371_singular_race.patch.gz](https://github.com/sagemath/sage/files/ticket14371/14371_singular_race.patch.gz)(https://github.com/sagemath/sage/files/ticket14371/8c5f4fe9d87cf7358fbf79cb9907068d.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -37,4 +37,4 @@\n **********************************************************************\n ```\n \n-**Apply** [and [attachment: 14371_singular_race.patch.gz](https://github.com/sagemath/sage/files/ticket14371/14371_singular_race.patch.gz)(https://github.com/sagemath/sage/files/ticket14371/8c5f4fe9d87cf7358fbf79cb9907068d.gz)\n+**Apply** [and [attachment: 14371_sleep_isalive.patch.gz](https://github.com/sagemath/sage/files/ticket14371/14371_sleep_isalive.patch.gz)(https://github.com/sagemath/sage/files/ticket14371/8c5f4fe9d87cf7358fbf79cb9907068d.gz)\n``````\n",
...
```json
{
    "body": "<a id='comment:35'>Comment 35:</a>\nVolker, for the record: do you give positive review to [attachment: 14371_traceback_dont_catch.patch.gz](https://github.com/sagemath/sage/files/ticket14371/14371_traceback_dont_catch.patch.gz)?",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14371#issuecomment-175220",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14371#issuecomment-175221",
    "user": "https://github.com/jdemeyer"
}
```
