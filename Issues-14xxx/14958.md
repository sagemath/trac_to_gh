...
archive/attachments_020753.json:
```json
{
...
archive/attachments_020754.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_020755.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_14958-pseudo_conway_simplified.patch](https://github.com/sagemath/sage/files/ticket14958/trac_14958-pseudo_conway_simplified.patch)\n\nimplement pseudo-Conway polynomials (replaces both previous patches)",
    "created_at": "2013-08-06T00:26:32Z",
    "issue": "https://github.com/sagemath/sage/issues/14958",
    "type": "issue_comment",
...
**Attachment:** [trac_14958-pseudo_conway_simplified.patch](https://github.com/sagemath/sage/files/ticket14958/trac_14958-pseudo_conway_simplified.patch)
