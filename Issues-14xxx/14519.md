...
```json
{
    "body": "Changing dependencies from \"\" to \"#14143 #14516\"",
    "created_at": "2013-05-03T19:50:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225935",
    "user": "https://github.com/tscrim"
}
```

Changing dependencies from "" to "#14143 #14516"
...
```json
{
    "body": "<a id='comment:1'></a>Initial version which has a dependencies on #14143 (minor reject) and #14516 (since `Letter` no longer inherits from `ElementWrapper`, there is nothing to do there). Both of which this can be moved past with minor-moderate cost.",
    "created_at": "2013-05-03T19:50:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225936",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>Initial version which has a dependencies on #14143 (minor reject) and #14516 (since `Letter` no longer inherits from `ElementWrapper`, there is nothing to do there). Both of which this can be moved past with minor-moderate cost.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225937",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225938",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"fix segfault in UCF\"",
    "created_at": "2013-05-09T23:45:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225939",
    "user": "https://github.com/tscrim"
}
```

Changing work_issues from "" to "fix segfault in UCF"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225940",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing work_issues from \"fix segfault in UCF\" to \"\"",
    "created_at": "2013-06-27T15:44:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225941",
    "user": "https://github.com/tscrim"
}
```

Changing work_issues from "fix segfault in UCF" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225942",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This is likely the same issue; luckily I could work (hack) around it here.",
    "created_at": "2013-06-28T15:05:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225944",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>This is likely the same issue; luckily I could work (hack) around it here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225945",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225947",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225948",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Okay, I figured out what was going wrong. For the nested class, `TestParent4` did not implement a `__ne__` and is not a `UniqueRepresentation`, so it does not by default check `not __eq__`. In the `ElementWrapper`, I'm testing using `__ne__`.\n\nFor the posets, the problem was that `ElementWrapper` was checking if the second argument was a `Parent` class, rather than if the first argument is not a `Parent`. Thus wrapping a `Set`, which is a `Parent`, caused the deprecation warning and a swap to occur.\n\nThe rest of the errors were trivial in the sense I needed to put a parent as the first argument. In summary: err0rz b3 pwnd.\n\nBest,\n\nTravis",
    "created_at": "2013-07-09T12:30:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225949",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>Okay, I figured out what was going wrong. For the nested class, `TestParent4` did not implement a `__ne__` and is not a `UniqueRepresentation`, so it does not by default check `not __eq__`. In the `ElementWrapper`, I'm testing using `__ne__`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225950",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225951",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Thanks for doing the review Nicolas.",
    "created_at": "2013-07-13T12:23:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225952",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>Thanks for doing the review Nicolas.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14519#event-41319"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14519#event-41320"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14519#event-41321"
}
```
...
```json
{
    ...
    "milestone": "sage-pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14519#event-41322"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14519#event-41323"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14519#event-41324"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225953",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14519#issuecomment-225954",
    "user": "https://github.com/jdemeyer"
}
```
