...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226073",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Looks right ! Is there any reason why every `coeffs[i]` and `m` should not be cleared too ?\n\nNathann",
    "created_at": "2013-05-04T08:51:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226074",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>Looks right ! Is there any reason why every `coeffs[i]` and `m` should not be cleared too ?
...
```json
{
    "body": "<a id='comment:3'></a>m is a single mpz_t variable and is correctly freed in this patch. As for coeffs[i] you're right - nice catch. That should be freed as well IMO.\n\nI've attached a patch fixing this remark as well. Can you check if it makes sense to stack patches like that?\n\nPS. What is the status of the edge contraction code? I would like to test this memonization thing that I talk about..",
    "created_at": "2013-05-04T09:24:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226075",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:3'></a>m is a single mpz_t variable and is correctly freed in this patch. As for coeffs[i] you're right - nice catch. That should be freed as well IMO.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226078",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226079",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226081",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Quickly contract an edge `uv` ? What about that ?\n\n```\ng.add_edges([(u,x) for x in g.neighbors(v)])\ng.delete_vertex(v)\n```",
    "created_at": "2013-05-04T10:30:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226082",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:10'></a>Quickly contract an edge `uv` ? What about that ?
...
```json
{
    "body": "<a id='comment:11'></a>Oh. I mean, in a graph that does not allow multiple edges `:-P`\n\nNathann",
    "created_at": "2013-05-04T10:31:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226083",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:11'></a>Oh. I mean, in a graph that does not allow multiple edges `:-P`
...
```json
{
    "body": "<a id='comment:12'></a>So, what do you decide with this patch ? If you make this 13 a 10 I agree with it, otherwise I will let somebody else give it a review. You tell me !\n\nNathann",
    "created_at": "2013-05-04T10:46:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226084",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:12'></a>So, what do you decide with this patch ? If you make this 13 a 10 I agree with it, otherwise I will let somebody else give it a review. You tell me !
...
```json
{
    "body": "<a id='comment:13'></a>10 it is!",
    "created_at": "2013-05-04T10:53:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226085",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:13'></a>10 it is!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226087",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>And the following message is there to tell the patchbot (the circle that you see at the top of each ticket's page) how to apply the patches.",
    "created_at": "2013-05-04T10:57:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226088",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:15'></a>And the following message is there to tell the patchbot (the circle that you see at the top of each ticket's page) how to apply the patches.
...
```json
{
    "body": "<a id='comment:16'></a>Apply trac_14527_chrompoly.patch, trac_14527_chrompoly2.patch",
    "created_at": "2013-05-04T10:57:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226089",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:16'></a>Apply trac_14527_chrompoly.patch, trac_14527_chrompoly2.patch
...
```json
{
    "body": "<a id='comment:17'></a>Oh `O_o`\n\nLooks like your new example is missing a `::`\n\nNathann",
    "created_at": "2013-05-04T10:58:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226090",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:17'></a>Oh `O_o`
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [trac_14527_chrompoly.patch](tarball://root/attachments/some-uuid/ticket14527/trac_14527_chrompoly.patch) by azi created at 2013-05-04 11:02:43\n\nFixed.",
    "created_at": "2013-05-04T11:02:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226091",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:18'></a>Attachment [trac_14527_chrompoly.patch](tarball://root/attachments/some-uuid/ticket14527/trac_14527_chrompoly.patch) by azi created at 2013-05-04 11:02:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226092",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226093",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226094",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226095",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226096",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14527#event-41343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14527",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14527#issuecomment-226097",
    "user": "https://github.com/jdemeyer"
}
```
