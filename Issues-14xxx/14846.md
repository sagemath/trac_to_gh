...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14846#event-193762"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14846#event-193763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14846#event-193764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14846#event-193765"
}
```
...
```json
{
    "body": "Changed keywords from **** to **LazyPowerSeries, species**",
...
Changed keywords from **** to **LazyPowerSeries, species**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14846#issuecomment-184353",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14846#issuecomment-184354",
    "user": "https://github.com/vbraun"
}
```
