...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233907",
...
```json
{
    "body": "<a id='comment:1'></a>here is a patch, that hopefully does the job.",
    "created_at": "2013-07-08T19:19:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233908",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>here is a patch, that hopefully does the job.
...
```json
{
    "body": "<a id='comment:2'></a>ok, bot is happy, is there anybody for a review ?",
    "created_at": "2013-07-12T15:46:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233909",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:2'></a>ok, bot is happy, is there anybody for a review ?
...
```json
{
    "body": "<a id='comment:3'></a>By doing it this way, there is not a significant improvement to startup time, even though all 3 modules are not imported at startup. Also what is your criterion for lazily importing these three modules and not others (such as the Jack symmetric functions)? It feels kind of arbitrary to me.\n\nI think we should do the following:\n\n- Move the import of `kfpoly.py` into the appropriate method (as per the current patch)\n- Remove the `global_t` in `kfpoly.py` which will remove the creation (from `kfpoly.py` at least) of the poylnomial ring.\n- Have a well-defined set of criterion for when we should lazily import modules.\n\nBest,\n\nTravis",
    "created_at": "2013-07-13T12:54:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233910",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>By doing it this way, there is not a significant improvement to startup time, even though all 3 modules are not imported at startup. Also what is your criterion for lazily importing these three modules and not others (such as the Jack symmetric functions)? It feels kind of arbitrary to me.
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_14866_first_step.patch](tarball://root/attachments/some-uuid/ticket14866/trac_14866_first_step.patch) by @fchapoton created at 2013-07-16 16:45:21\n\nok, I have (maybe) taken care of the global_t in kf_poly\n\nconcerning the policy for \"lazy_import\", I would vote for lazy_importing everybody, but I do not understand if it is good or not for the starting time.",
    "created_at": "2013-07-16T16:45:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233911",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>Attachment [trac_14866_first_step.patch](tarball://root/attachments/some-uuid/ticket14866/trac_14866_first_step.patch) by @fchapoton created at 2013-07-16 16:45:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233912",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233913",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233914",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233915",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233916",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14866#issuecomment-233917",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14866",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14866#event-42710"
}
```
