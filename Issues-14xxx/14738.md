...
```json
{
    "body": "<a id='comment:2'></a>As to the first one, [it sounds like](http://www.math.utexas.edu/pipermail/maxima/2013/033254.html) setting `algexact:true` would be one way to avoid this, though at the cost of horrendously ridiculous stuff.",
    "created_at": "2013-06-13T18:38:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14738",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14738#issuecomment-230912",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>As to the first one, [it sounds like](http://www.math.utexas.edu/pipermail/maxima/2013/033254.html) setting `algexact:true` would be one way to avoid this, though at the cost of horrendously ridiculous stuff.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14738#event-42244"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14738#event-42245"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14738#event-42246"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14738#event-42247"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14738#event-42248"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14738#event-42249"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14738#event-42250"
}
```
