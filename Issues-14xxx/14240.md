...
<a id='comment:1'></a>I think the code tries to put denominators in `cdef int` which of course quickly goes wrong:
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [14240-universal_cyclotomic_field_mpq.patch](tarball://root/attachments/some-uuid/ticket14240/14240-universal_cyclotomic_field_mpq.patch) by mraum created at 2013-04-27 05:04:38",
...
<a id='comment:2'></a>Attachment [14240-universal_cyclotomic_field_mpq.patch](tarball://root/attachments/some-uuid/ticket14240/14240-universal_cyclotomic_field_mpq.patch) by mraum created at 2013-04-27 05:04:38
...
<a id='comment:3'></a>Replying to [mraum](#comment%3A2):
...
<a id='comment:4'></a>You can check whether malloc's and free's match and whether for each init there is one clear.
...
```json
{
    "body": "<a id='comment:12'></a>now works with the libgap version.",
    "created_at": "2015-05-24T13:35:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14240",
    "type": "issue_comment",
...
<a id='comment:12'></a>now works with the libgap version.
