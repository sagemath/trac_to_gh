...
```json
{
    "body": "<a id='comment:12'></a>Replying to [comment:8 jpflori]:\n> Maybe a direct indication of what the bug is could help, e.g. adding \"which let sig_on() miscompile\" after \"bug\".\n\n\nDone.",
...
<a id='comment:12'></a>Replying to [comment:8 jpflori]:
> Maybe a direct indication of what the bug is could help, e.g. adding "which let sig_on() miscompile" after "bug".
...
<a id='comment:30'></a>Replying to [comment:29 jpflori]:
> Or that it is not true?
