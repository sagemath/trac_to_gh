...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14279#issuecomment-220037",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14279#issuecomment-220038",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_14279-new_coercion_for_homsets.patch](tarball://root/attachments/some-uuid/ticket14279/trac_14279-new_coercion_for_homsets.patch) by @simon-king-jena created at 2013-03-15 17:06:43\n\nI change it into \"needs review\", in order to let the patchbot do some work.\n\nHowever, it will need a second patch, that improves documentation. But I certainly would like to get some input at that point.",
    "created_at": "2013-03-15T17:06:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14279#issuecomment-220039",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>Attachment [trac_14279-new_coercion_for_homsets.patch](tarball://root/attachments/some-uuid/ticket14279/trac_14279-new_coercion_for_homsets.patch) by @simon-king-jena created at 2013-03-15 17:06:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14279#issuecomment-220040",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14279#event-40410"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14279#event-40411"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14279#event-40412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14279#issuecomment-220042",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14279#issuecomment-220043",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14279#event-40413"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14279#event-40414"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14279#event-40415"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14279#event-40416"
}
```
