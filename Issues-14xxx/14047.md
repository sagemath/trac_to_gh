...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14047#issuecomment-168988",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket14047/trac_14047_conjugate_method_for_AlgebraicReal_and_doctest_gram_schmidt.patch",
    "created_at": "2013-04-08T13:54:48Z",
    "issue": "https://github.com/sagemath/sage/issues/14047",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket14047/trac_14047_conjugate_method_for_AlgebraicReal_and_doctest_gram_schmidt.patch",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_14047_conjugate_method_for_AlgebraicReal_and_doctest_gram_schmidt.patch](https://github.com/sagemath/sage/files/ticket14047/trac_14047_conjugate_method_for_AlgebraicReal_and_doctest_gram_schmidt.patch) by @rharron created at 2013-04-08 13:54:48\n\nThe algebraic reals should definitely have a conjugate method, so I've added that. I also added a doctest in gram_schmidt to test that it now works with algebraic reals (I used the example for QQbar that only has integers and doing the computation with algebraic reals instead of QQbar is in fact faster!).",
    "created_at": "2013-04-08T13:54:48Z",
    "issue": "https://github.com/sagemath/sage/issues/14047",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14047#issuecomment-168989",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14047",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14047#issuecomment-168990",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14047",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14047#issuecomment-168991",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14047",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14047#issuecomment-168992",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14047",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14047#issuecomment-168993",
    "user": "https://trac.sagemath.org/admin/accounts/users/christelle"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14047",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14047#issuecomment-168994",
    "user": "https://github.com/jdemeyer"
}
```
