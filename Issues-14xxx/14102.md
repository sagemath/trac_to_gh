...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14102#event-181923"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14102#event-181924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14102#event-181925"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,4 +14,8 @@\n \n In a follow-up ticket #14847 Whittaker functions and other features will become available.\n \n+Apply: [attachment: trac_14102-nonsymmetric-macdonald.2.patch\u200b.gz](https://github.com/sagemath/sage/files/ticket14102/16e6a3040c09202507d2c3ab2af41d41.gz)\n \n+\n+\n+\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14102#issuecomment-170243",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14102#issuecomment-170244",
    "user": "https://github.com/vbraun"
}
```
