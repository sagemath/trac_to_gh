...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228123",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228124",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>MathJAX is throwing a \"Math Processing Error\" -- I'm not sure whether it's busted or I screwed up but the docs definitely need a review.",
    "created_at": "2013-05-23T00:53:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228125",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:1'></a>MathJAX is throwing a "Math Processing Error" -- I'm not sure whether it's busted or I screwed up but the docs definitely need a review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228127",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228128",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>What about adding a parameter to all the simplify_* functions instead of adding more functions? \nLike \"def simplify(real_domain=False):...\"",
    "created_at": "2013-05-29T13:44:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228129",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```

<a id='comment:4'></a>What about adding a parameter to all the simplify_* functions instead of adding more functions? 
Like "def simplify(real_domain=False):..."
...
```json
{
    "body": "<a id='comment:7'></a>Instead of adding a new function `simplify_real()` or a `domain` parameter to the existing functions, can we use a context manager instead?\n\nExample use would be:\n\n```\nsage: t = sqrt(x^2)\nsage: t.simplify()\nsqrt(x^2)\nsage: with maxima_domain(RR):\n....:    u = t.simplify()\n....:\nsage: u\nabs(x)\nsage: t.simplify()\nsqrt(x^2)\n```",
    "created_at": "2013-05-30T19:57:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228132",
    "user": "https://github.com/burcin"
}
```

<a id='comment:7'></a>Instead of adding a new function `simplify_real()` or a `domain` parameter to the existing functions, can we use a context manager instead?
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41712"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41713"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41714"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41715"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41716"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41717"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41718"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I think the form/domain-simplify design issue has not been resolved and should be discussed/decided first: the/an author may benefit from presenting a solution to sage-devel, and if the crowd has no opinion then it should be implemented. Thus, I'm setting to needs_info.",
    "created_at": "2014-11-02T09:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228136",
    "user": "https://github.com/rwst"
}
```

<a id='comment:15'></a>I think the form/domain-simplify design issue has not been resolved and should be discussed/decided first: the/an author may benefit from presenting a solution to sage-devel, and if the crowd has no opinion then it should be implemented. Thus, I'm setting to needs_info.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228137",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"24cc55466abd2f02a9187186364fb4373d7900e9\"",
    "created_at": "2014-11-05T19:04:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228138",
    "user": "https://github.com/orlitzky"
}
```

Changing commit from "" to "24cc55466abd2f02a9187186364fb4373d7900e9"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228139",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/mjo/ticket/14630\"",
    "created_at": "2014-11-05T19:04:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228140",
    "user": "https://github.com/orlitzky"
}
```

Changing branch from "" to "u/mjo/ticket/14630"
...
```json
{
    "body": "<a id='comment:18'></a>This seems fine, given that it is extremely unlikely a context manager will appear and that having many options seems undesirable.  However, if someone gets a sage-devel discussion on this going I'm not going to stop them.\n\n```\nsage: A = e^(sqrt(x^2))\nsage: A\ne^(sqrt(x^2))\nsage: A.simplify_real()\ne^abs(x)\n```\nI was pleased this worked, wasn't sure how much it would do.  Maybe the following would be a useful test to show what it does and doesn't do.\n\n```\nsage: var('y z')\n(y, z)\nsage: A = e^(sqrt(x^2)+sqrt(y^2)+sqrt(i*z^2))\nsage: A.simplify_real()\ne^((-1)^(1/4)*abs(z) + abs(x) + abs(y))\n```\nHere's another one that, again, pleasantly works as one would think.\n\n```\nsage: C = (x^2+y^2).imag()\nsage: C\n2*imag_part(x)*real_part(x) + 2*imag_part(y)*real_part(y)\nsage: C.simplify_real()\n0\n```\nNow if only we *had* to use this for the following simplification!\n\n```\nsage: B = conjugate(z)\nsage: B.simplify_real()\nz\nsage: B.simplify()  # wa-wa \"you lose\" noise - #6862\nz\n```",
    "created_at": "2014-11-18T03:35:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228141",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:18'></a>This seems fine, given that it is extremely unlikely a context manager will appear and that having many options seems undesirable.  However, if someone gets a sage-devel discussion on this going I'm not going to stop them.
...
```json
{
    "body": "<a id='comment:19'></a>Also note this probably conflicts slightly with #11912.",
    "created_at": "2014-11-18T03:38:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228142",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:19'></a>Also note this probably conflicts slightly with #11912.
...
```json
{
    "body": "<a id='comment:20'></a>Just making a note to myself here to update all of the \"see also\" references in the other `simplify_*` methods. We should mention `simplify_real()`, `simplify_rectform()`, and any other new similar methods.",
    "created_at": "2014-11-18T16:57:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228143",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:20'></a>Just making a note to myself here to update all of the "see also" references in the other `simplify_*` methods. We should mention `simplify_real()`, `simplify_rectform()`, and any other new similar methods.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228144",
...
```json
{
    "body": "Changing commit from \"24cc55466abd2f02a9187186364fb4373d7900e9\" to \"612f8ede28c281e6e5f4bb0e3864ca35ff3906c3\"",
    "created_at": "2014-11-22T14:57:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228145",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "24cc55466abd2f02a9187186364fb4373d7900e9" to "612f8ede28c281e6e5f4bb0e3864ca35ff3906c3"
...
```json
{
    "body": "<a id='comment:22'></a>I just force-pushed a branch that's rebased on top of #11912 because of a conflict. That one has a positive review, so I guess when it's merged I could rebase this on top of the develop branch? Not sure what's easiest for the release manager.",
    "created_at": "2014-11-22T15:00:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228146",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:22'></a>I just force-pushed a branch that's rebased on top of #11912 because of a conflict. That one has a positive review, so I guess when it's merged I could rebase this on top of the develop branch? Not sure what's easiest for the release manager.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228147",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#11912\"",
    "created_at": "2014-11-22T15:00:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228148",
    "user": "https://github.com/orlitzky"
}
```

Changing dependencies from "" to "#11912"
...
```json
{
    "body": "Changing commit from \"612f8ede28c281e6e5f4bb0e3864ca35ff3906c3\" to \"649e3b3eece6daea3d3c043d2034f3416a85fb09\"",
    "created_at": "2014-11-22T15:09:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228149",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "612f8ede28c281e6e5f4bb0e3864ca35ff3906c3" to "649e3b3eece6daea3d3c043d2034f3416a85fb09"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228150",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>And per my note, I've included another left-out function in the `simplify()` \"see also\" list.",
    "created_at": "2014-11-22T15:10:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228151",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:24'></a>And per my note, I've included another left-out function in the `simplify()` "see also" list.
...
```json
{
    "body": "<a id='comment:25'></a>I think it is fine now and certainly should be included, test pass in `expression.pyx`.",
    "created_at": "2014-12-12T16:38:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228152",
    "user": "https://github.com/rwst"
}
```

<a id='comment:25'></a>I think it is fine now and certainly should be included, test pass in `expression.pyx`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228153",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228154",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "Changing branch from \"u/mjo/ticket/14630\" to \"649e3b3eece6daea3d3c043d2034f3416a85fb09\"",
    "created_at": "2014-12-15T17:50:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228155",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/mjo/ticket/14630" to "649e3b3eece6daea3d3c043d2034f3416a85fb09"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14630#event-41719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14630#issuecomment-228156",
    "user": "https://github.com/vbraun"
}
```
