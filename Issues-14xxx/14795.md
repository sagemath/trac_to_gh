...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14795#event-42438"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14795#event-42439"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14795#event-42440"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14795#event-42441"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14795#event-42442"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>`git grep 'def.*=[[]'` reveals that we still have many of these as of 9.7.rc2",
    "created_at": "2022-09-17T17:01:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14795#issuecomment-232198",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>`git grep 'def.*=[[]'` reveals that we still have many of these as of 9.7.rc2
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14795#event-42443"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14795#event-42444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14795#issuecomment-232199",
    "user": "https://github.com/mkoeppe"
}
```
