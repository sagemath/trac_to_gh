...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178362"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178364"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178365"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178366"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178367"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178368"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178369"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14795#issuecomment-183220",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178371"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14795#event-178372"
}
```
...
```json
{
    "body": "**Changing author** from \"Mathieu Guay-Paquet\" to \"\".",
    "created_at": "2022-09-17T17:01:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/14795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14795#issuecomment-183221",
    "user": "https://github.com/mkoeppe"
}
```

**Changing author** from "Mathieu Guay-Paquet" to "".
