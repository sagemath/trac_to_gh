...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14069",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14069#issuecomment-169679",
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14069#event-181435"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14069#event-181436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14069",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14069#issuecomment-169680",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14069#event-181437"
}
```
