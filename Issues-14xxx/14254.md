...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14254#event-40299"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>PS: Note the discussion that we had on #715 on that matter.\n\nIs there a reason why we use ssize_t and not size_t?",
    "created_at": "2013-03-11T10:41:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219383",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>PS: Note the discussion that we had on #715 on that matter.
...
```json
{
    "body": "<a id='comment:4'></a>Any idea on how to debug this? The problem is that currently we have no idea where this exception is generated.",
    "created_at": "2013-03-11T10:45:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219384",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>Any idea on how to debug this? The problem is that currently we have no idea where this exception is generated.
...
```json
{
    "body": "<a id='comment:5'></a>Google seems to tell me that one should use size_t and not ssize_t here anyway. Not sure though.\n\nNils, do you think it could help to consistently replace ssize_t and Py_ssize_t by size_t?",
    "created_at": "2013-03-11T10:46:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219385",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Google seems to tell me that one should use size_t and not ssize_t here anyway. Not sure though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219386",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219388",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219389",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219391",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Does Py_intptr_t even exist in Sage? I did a grep for it, to no avail.",
    "created_at": "2013-03-11T12:20:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219393",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>Does Py_intptr_t even exist in Sage? I did a grep for it, to no avail.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219394",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219395",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219396",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Can you test `sizeof(Py_ssize_t)==sizeof(void*)` on those machines that exposed the error? Namely, this equality would falsify my guess.",
    "created_at": "2013-03-11T13:32:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219398",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:18'></a>Can you test `sizeof(Py_ssize_t)==sizeof(void*)` on those machines that exposed the error? Namely, this equality would falsify my guess.
...
```json
{
    "body": "<a id='comment:19'></a>Replying to [SimonKing](#comment%3A15):\n> Lacking more information, my guess was that an overflow could occur on systems where `sizeof(Py_ssize_t)==sizeof(size_t)` differs from `sizeof(Py_intptr_t)==sizeof(void*)`. So, why are you sure that the problem is *not* related with conversion between size_t and pointers?\n\n\nThis is a typical 32-bit system where the types `int`, `long`, `size_t`, `Py_ssize_t`, `void*`, `intptr_t` are all 4 bytes.",
    "created_at": "2013-03-11T13:34:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219399",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>Replying to [SimonKing](#comment%3A15):
> Lacking more information, my guess was that an overflow could occur on systems where `sizeof(Py_ssize_t)==sizeof(size_t)` differs from `sizeof(Py_intptr_t)==sizeof(void*)`. So, why are you sure that the problem is *not* related with conversion between size_t and pointers?
...
```json
{
    "body": "<a id='comment:20'></a>Besides, even if `void*` would be larger than `Py_ssize_t`, I still don't see how it could cause the error that we're seeing. The cast `void*` -> `Py_ssize_t` is pure C, so it couldn't overflow.",
    "created_at": "2013-03-11T13:36:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219400",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>Besides, even if `void*` would be larger than `Py_ssize_t`, I still don't see how it could cause the error that we're seeing. The cast `void*` -> `Py_ssize_t` is pure C, so it couldn't overflow.
...
```json
{
    "body": "<a id='comment:21'></a>I am debugging building the docs, as I can reliably get the failure this way.",
    "created_at": "2013-03-11T13:37:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219401",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:21'></a>I am debugging building the docs, as I can reliably get the failure this way.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219403",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>I can't find this code, where is it?",
    "created_at": "2013-03-11T13:55:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219405",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:25'></a>I can't find this code, where is it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219406",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>In sage/categories/homset.py:\n\n```\n    _cache[key] = KeyedRef(H, _cache.eraser, (id(X),id(Y),id(category)))\n```\n\n`id()` returns `<type 'int'>`. I don't know if assigning `int` to `Py_ssize_t` can be a problem.",
    "created_at": "2013-03-11T14:00:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219407",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:27'></a>In sage/categories/homset.py:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219408",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219409",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219410",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>But I would really like a quick fix independently of #14159. Then this quick fix here could be merged in sage-5.8.rc0 while #14159 wouldn't. Would you mind if I create a patch?",
    "created_at": "2013-03-11T14:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219411",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>But I would really like a quick fix independently of #14159. Then this quick fix here could be merged in sage-5.8.rc0 while #14159 wouldn't. Would you mind if I create a patch?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219412",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219413",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219414",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219415",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Attachment [14254_signed_id.patch](tarball://root/attachments/some-uuid/ticket14254/14254_signed_id.patch) by @jdemeyer created at 2013-03-11 14:57:20",
    "created_at": "2013-03-11T14:57:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219416",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:34'></a>Attachment [14254_signed_id.patch](tarball://root/attachments/some-uuid/ticket14254/14254_signed_id.patch) by @jdemeyer created at 2013-03-11 14:57:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219417",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>The patch looks fine to me, and it applies cleanly after #13387. Now I wonder what the patchbots have to tell.\n\nProblem: I have no 32-bit machine available. Will the machines on which you first noticed the problem report here, in the hopefully green) blob?",
    "created_at": "2013-03-11T15:17:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219418",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:36'></a>The patch looks fine to me, and it applies cleanly after #13387. Now I wonder what the patchbots have to tell.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219419",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>OK, I believe Jeroen when he says that building the documentation on his 32-bit systems works with the patch, while it reproducibly failed without the patch.\n\nI think the solution makes sense: id(X) returns a positive number, and this may very well be beyond what a signed number type of the same size (such as Py_ssize_t) can take.\n\nThe patchbot gives a green blob, too. Hence, I hope it is safe to give this a positive review (but I think #14159 will be better, on the long run).",
    "created_at": "2013-03-11T16:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219421",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:39'></a>OK, I believe Jeroen when he says that building the documentation on his 32-bit systems works with the patch, while it reproducibly failed without the patch.
...
```json
{
    "body": "Changing reviewer from \"\" to \"SimonKing\"",
    "created_at": "2013-03-11T16:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219422",
    "user": "https://github.com/simon-king-jena"
}
```

Changing reviewer from "" to "SimonKing"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219423",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219424",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219425",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14254#event-40300"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14254#issuecomment-219426",
    "user": "https://github.com/jdemeyer"
}
```
