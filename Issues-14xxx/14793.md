...
```json
{
    "body": "<a id='comment:36'></a>\nMade this into a branch and added doctests to added functions and some other misc review changes. If you're happy with my changes Simon, then this is a positive review.\n\n---\nNew commits:\n|                                                                                                         |                      |\n|---------------------------------------------------------------------------------------------------------|----------------------|\n|[ea3ecfb](http://git.sagemath.org/sage.git/commit/?id=ea3ecfb)|`Some review changes.`|\n|[1411319](http://git.sagemath.org/sage.git/commit/?id=1411319)|`#14793: Use __reduce__ for pickling homsets, and use WithEqualityById for them`|",
    "created_at": "2013-12-27T18:49:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                   |\n|---------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[e2d2f16](http://git.sagemath.org/sage.git/commit/?id=e2d2f16)|`Trac 14793: Add a missing doctest`|",
    "created_at": "2013-12-28T07:24:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:46'></a>\nBranch pushed to git repo; I updated commit sha1. Last 10 new commits:\n|                                                                                                         |                     |\n|---------------------------------------------------------------------------------------------------------|---------------------|\n|[17fe8ee](http://git.sagemath.org/sage.git/commit/?id=17fe8ee)|`Started transition.`|\n|[0ae3289](http://git.sagemath.org/sage.git/commit/?id=0ae3289)|`Initial attempt at _internal_coerce_map_from_() method.`|\n|[45597e1](http://git.sagemath.org/sage.git/commit/?id=45597e1)|`Merge branch 'u/jpflori/ticket/14711' of trac.sagemath.org:sage into public/structure/unique_repr_homsets-14793`|\n|[0af59ea](http://git.sagemath.org/sage.git/commit/?id=0af59ea)|`Reviewer changes. Mostly formatting.`|\n|[37bf59e](http://git.sagemath.org/sage.git/commit/?id=37bf59e)|`Merge branch 'develop' into ticket/14711, resolving conflicts with Trac 12217`|\n|[ee30c20](http://git.sagemath.org/sage.git/commit/?id=ee30c20)|`Address the \"check\" keyword of scheme morphisms by name, not position`|\n|[d68c5df](http://git.sagemath.org/sage.git/commit/?id=d68c5df)|`Minor fixes, that became needed since #14711 was not merged quickly enough`|\n|[c42b539](http://git.sagemath.org/sage.git/commit/?id=c42b539)|`Merge branch 'master' into ticket/14711`|\n|[23f18f2](http://git.sagemath.org/sage.git/commit/?id=23f18f2)|`Merge branch 'master' into ticket/14711`|\n|[364b985](http://git.sagemath.org/sage.git/commit/?id=364b985)|`Add warning to string repr of weakened maps. Implement copying for *all* kinds of maps.`|",
    "created_at": "2014-01-02T05:29:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
