...
```json
{
    "body": "<a id='comment:1'></a>To discuss: the exact semantic for homsets of non unique parents",
    "created_at": "2013-06-21T09:06:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232102",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:1'></a>To discuss: the exact semantic for homsets of non unique parents
...
```json
{
    "body": "<a id='comment:2'></a>Observation: If one uses `WithEqualityById`, many tests in sage.modular and sage.schemes fail with unprintable assertion errors.\n\nWe need to discuss whether we \"simply\" fix them, or better continue to compare homsets by *equality* (not identity) of domain and codomain.\n\nIn other words, we might end up with just providing a default pickling for homsets, which is currently missing.",
    "created_at": "2013-06-21T09:29:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232103",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>Observation: If one uses `WithEqualityById`, many tests in sage.modular and sage.schemes fail with unprintable assertion errors.
...
```json
{
    "body": "<a id='comment:8'></a>I think I've hit this one before when working on homsets. Perhaps I'll find my old solution somewhere.",
    "created_at": "2013-06-21T12:26:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232109",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>I think I've hit this one before when working on homsets. Perhaps I'll find my old solution somewhere.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232114",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232115",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232118",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232119",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>PS: With the idea exposed in the previous post, the following previously failing examples would work:\n\n```\nage: M = ModularSymbols(6)\nsage: sage.modular.hecke.morphism.is_HeckeModuleMorphism_matrix(ModularSymbols(6).hecke_operator(7).matrix_form().hecke_module_morphism())\nTrue\nsage: loads(dumps(M)) == M\nTrue\nsage: A = J0(33)\nsage: D = A.decomposition(); D\n[\nSimple abelian subvariety 11a(1,33) of dimension 1 of J0(33),\nSimple abelian subvariety 11a(3,33) of dimension 1 of J0(33),\nSimple abelian subvariety 33a(1,33) of dimension 1 of J0(33)\n]\nsage: loads(dumps(D))\n[\nSimple abelian subvariety 11a(1,33) of dimension 1 of J0(33),\nSimple abelian subvariety 11a(3,33) of dimension 1 of J0(33),\nSimple abelian subvariety 33a(1,33) of dimension 1 of J0(33)\n]\n```",
    "created_at": "2013-06-24T15:32:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232123",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:22'></a>PS: With the idea exposed in the previous post, the following previously failing examples would work:
...
```json
{
    "body": "<a id='comment:24'></a>I have attached an experimental patch that implements the new suggestion. With it, the only error in sage.modular is:\n\n```\nsage -t sage/modular/abvar/homspace.py  # 1 doctest failed\n```\nwhich is some automatic test suite.\n\nThe situation in sage.schemes is still not good, as we get:\n\n```\nsage -t sage/schemes/elliptic_curves/ell_curve_isogeny.py  # 8 doctests failed\nsage -t sage/schemes/elliptic_curves/ell_point.py  # 8 doctests failed\nsage -t sage/schemes/elliptic_curves/ell_finite_field.py  # 1 doctest failed\nsage -t sage/schemes/elliptic_curves/isogeny_class.py  # 1 doctest failed\nsage -t sage/schemes/projective/projective_space.py  # 2 doctests failed\nsage -t sage/schemes/affine/affine_space.py  # 1 doctest failed\nsage -t sage/schemes/generic/homset.py  # 1 doctest failed\n```\n\nIf we are lucky, this boils down to an improper initialisation of the category of some schemes.",
    "created_at": "2013-06-24T15:49:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232125",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:24'></a>I have attached an experimental patch that implements the new suggestion. With it, the only error in sage.modular is:
...
```json
{
    "body": "<a id='comment:26'></a>No, it turns out that the reason was different. Schemes create their homsets without using `sage.categories.homset.Hom` (instead, a `UniqueFactory` is used), and thus one has to overload `Homset.__reduce__` to something that uses the custom `UniqueFactory`---unless someone has the energy to remove this unique factory :)",
    "created_at": "2013-06-24T16:53:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232127",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:26'></a>No, it turns out that the reason was different. Schemes create their homsets without using `sage.categories.homset.Hom` (instead, a `UniqueFactory` is used), and thus one has to overload `Homset.__reduce__` to something that uses the custom `UniqueFactory`---unless someone has the energy to remove this unique factory :)
...
```json
{
    "body": "<a id='comment:27'></a>Hooray! With the updated patch, all tests in sage.schemes pass!!\n\nSo, now I am confident that the general approach will work.",
    "created_at": "2013-06-24T17:00:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232128",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:27'></a>Hooray! With the updated patch, all tests in sage.schemes pass!!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232130",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>I just notice that the other one is a real error, too. We want that `Hom(X,Y)` is identical with `Hom(X1,Y1)` only if `X is X1` and `Y is Y1`. But in this example, the homsets are identical even though domain and codomain are equal but not identical.",
    "created_at": "2013-06-25T13:52:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232132",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:30'></a>I just notice that the other one is a real error, too. We want that `Hom(X,Y)` is identical with `Hom(X1,Y1)` only if `X is X1` and `Y is Y1`. But in this example, the homsets are identical even though domain and codomain are equal but not identical.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232133",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232134",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>I'm just thinking: Perhaps one should rather define\n\n```\n    unpickle_X = hasattr(X, '_is_category_initialized') and (not X._is_category_initialized()) and isinstance(X,category.parent_class)\n```",
    "created_at": "2013-06-25T15:01:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232136",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:32'></a>I'm just thinking: Perhaps one should rather define
...
```json
{
    "body": "<a id='comment:33'></a>Attachment [trac14793-homset_default_pickling.patch](tarball://root/attachments/some-uuid/ticket14793/trac14793-homset_default_pickling.patch) by @simon-king-jena created at 2013-06-25 16:16:13\n\nI needed to replace the old `Hom()` method of `FGP_Modules` by a `_Hom_()` method. While I was at it, I provided their homsets with an element class. However, I did not fix it to the extent that `TestSuite(...).run()` would pass.\n\nApply trac14793-homset_default_pickling.patch",
    "created_at": "2013-06-25T16:16:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232137",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:33'></a>Attachment [trac14793-homset_default_pickling.patch](tarball://root/attachments/some-uuid/ticket14793/trac14793-homset_default_pickling.patch) by @simon-king-jena created at 2013-06-25 16:16:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232139",
...
```json
{
    "body": "Changing branch from \"\" to \"public/structure/unique_repr_homsets-14793\"",
    "created_at": "2013-12-27T18:49:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232140",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "" to "public/structure/unique_repr_homsets-14793"
...
```json
{
    "body": "Changing commit from \"\" to \"ea3ecfbc644fa6b53441c25cce73720f9a0ffeee\"",
    "created_at": "2013-12-27T18:49:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232141",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "" to "ea3ecfbc644fa6b53441c25cce73720f9a0ffeee"
...
```json
{
    "body": "<a id='comment:36'></a>Made this into a branch and added doctests to added functions and some other misc review changes. If you're happy with my changes Simon, then this is a positive review.\n\n---\nNew commits:",
    "created_at": "2013-12-27T18:49:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232142",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:36'></a>Made this into a branch and added doctests to added functions and some other misc review changes. If you're happy with my changes Simon, then this is a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232143",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Travis, how difficult has it been to apply the old patch? Certainly there have been a bunch of conflicts.",
    "created_at": "2013-12-27T20:11:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232144",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:37'></a>Travis, how difficult has it been to apply the old patch? Certainly there have been a bunch of conflicts.
...
```json
{
    "body": "<a id='comment:38'></a>For the record: I am happy with your changes, Travis. To be on the safe side, I am running tests on my laptop now, but after all *you* are the reviewer... And sorry that I forgot to add tests for some new methods.",
    "created_at": "2013-12-27T21:44:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232145",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:38'></a>For the record: I am happy with your changes, Travis. To be on the safe side, I am running tests on my laptop now, but after all *you* are the reviewer... And sorry that I forgot to add tests for some new methods.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232147",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing commit from \"ea3ecfbc644fa6b53441c25cce73720f9a0ffeee\" to \"e2d2f167429b625b12690f91d1d8d69aaf69f91b\"",
    "created_at": "2013-12-28T07:24:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232148",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "ea3ecfbc644fa6b53441c25cce73720f9a0ffeee" to "e2d2f167429b625b12690f91d1d8d69aaf69f91b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232149",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Test added.",
    "created_at": "2013-12-28T07:25:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232150",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:42'></a>Test added.
...
```json
{
    "body": "<a id='comment:43'></a>PS: I verified that the homsets in the test really use *this* and no other method for pickling.",
    "created_at": "2013-12-28T07:27:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232151",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:43'></a>PS: I verified that the homsets in the test really use *this* and no other method for pickling.
...
```json
{
    "body": "<a id='comment:44'></a>Good news: #10963 merges cleanly.",
    "created_at": "2013-12-28T09:08:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232152",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:44'></a>Good news: #10963 merges cleanly.
...
```json
{
    "body": "<a id='comment:45'></a>I put sleep > sage last night, so `:p` and thanks for adding that. It's also good to know that there are no conflicts with #10963. I've gone through your changes, tests pass, and everything is documented. The `TestSuite` and things is #14279. What else is left here to review?",
    "created_at": "2013-12-28T17:17:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232153",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:45'></a>I put sleep > sage last night, so `:p` and thanks for adding that. It's also good to know that there are no conflicts with #10963. I've gone through your changes, tests pass, and everything is documented. The `TestSuite` and things is #14279. What else is left here to review?
...
```json
{
    "body": "Changing commit from \"e2d2f167429b625b12690f91d1d8d69aaf69f91b\" to \"17fe8ee3ed896c7f6ffb83e002251e7087ef1df3\"",
    "created_at": "2014-01-02T05:29:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232154",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e2d2f167429b625b12690f91d1d8d69aaf69f91b" to "17fe8ee3ed896c7f6ffb83e002251e7087ef1df3"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232155",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:47'></a>Branch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:",
    "created_at": "2014-01-02T05:31:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232156",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

<a id='comment:47'></a>Branch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:
...
```json
{
    "body": "Changing commit from \"17fe8ee3ed896c7f6ffb83e002251e7087ef1df3\" to \"0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca\"",
    "created_at": "2014-01-02T05:31:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232157",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "17fe8ee3ed896c7f6ffb83e002251e7087ef1df3" to "0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca"
...
```json
{
    "body": "<a id='comment:48'></a>Branch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:",
    "created_at": "2014-01-02T05:33:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232158",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

<a id='comment:48'></a>Branch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:
...
```json
{
    "body": "Changing commit from \"0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca\" to \"e2d2f167429b625b12690f91d1d8d69aaf69f91b\"",
    "created_at": "2014-01-02T05:33:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232159",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0af59ea93689cb6abb9d3fae0f1cf11f2aee5cca" to "e2d2f167429b625b12690f91d1d8d69aaf69f91b"
...
```json
{
    "body": "<a id='comment:49'></a>I'm an idiot and merged the wrong branches...",
    "created_at": "2014-01-02T05:34:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232160",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:49'></a>I'm an idiot and merged the wrong branches...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232161",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:51'></a>It's not changing history, just taking a different path `:p`.",
    "created_at": "2014-01-02T17:22:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232162",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:51'></a>It's not changing history, just taking a different path `:p`.
...
```json
{
    "body": "<a id='comment:52'></a>I think we're good to go here unless there's something else you can see or think of?",
    "created_at": "2014-01-09T02:41:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232163",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:52'></a>I think we're good to go here unless there's something else you can see or think of?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232164",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232165",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232166",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14793#event-42435"
}
```
...
```json
{
    "body": "Changing branch from \"public/structure/unique_repr_homsets-14793\" to \"e2d2f167429b625b12690f91d1d8d69aaf69f91b\"",
    "created_at": "2014-03-03T18:55:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232167",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/structure/unique_repr_homsets-14793" to "e2d2f167429b625b12690f91d1d8d69aaf69f91b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/14793#event-42436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/14793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/14793#issuecomment-232168",
    "user": "https://github.com/vbraun"
}
```
