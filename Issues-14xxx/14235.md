...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172472",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172473",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172474",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172475",
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac_14235_hopf_kschur-mz.patch](https://github.com/sagemath/sage/files/ticket14235/trac_14235_hopf_kschur-mz.patch) by @zabrocki created at 2013-03-17 22:16:20\n\nI've corrected this typo.",
    "created_at": "2013-03-17T22:16:20Z",
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172476",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [trac_14235-hopf_kschur-review-ts.patch](https://github.com/sagemath/sage/files/ticket14235/trac_14235-hopf_kschur-review-ts.patch) by @tscrim created at 2013-05-19 22:40:47\n\nHey Mike,\n\nI've uploaded a review patch which makes some minor tweaks to the doc. If you're happy with the changes, you can set this to positive review.\n\nBest,\n\nTravis",
    "created_at": "2013-05-19T22:40:47Z",
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172477",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172478",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172479",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172480",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14235#issuecomment-172481",
