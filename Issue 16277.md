...
```json
{
    "body": "I am not sure what's the best way to implement this, so suggestions or implementations are most welcome!",
    "created_at": "2014-06-22T16:14:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16277",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16277#issuecomment-212691",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16277#event-48509"
}
```
