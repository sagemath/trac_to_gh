...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37270"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37271"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37272"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37273"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37274"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37275"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37276"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37277"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37278"
}
```
...
```json
{
    "body": "See also #22190 and #22244.",
    "created_at": "2017-03-14T09:48:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162207",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162208",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162209",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162210",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "`AtlasRep` is problematic in global installs. Debian has a package for it that does something but I may miss some bits that they put in gap itself. The problem is that `AtlasRep` fetch data from the net and tries to dump it where the package is installed. If you are a regular user and gap is installed in location belonging to root you are in trouble.\n\n`AtlasRep` really need to dump data in `~/.gap`.",
    "created_at": "2017-03-17T09:10:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162212",
...
```json
{
    "body": "Let me reformulate that better as a question: What would you want to see included that currently is not?",
    "created_at": "2017-07-13T02:47:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162214",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37279"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37280"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162219",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162220",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162221",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162222",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "A clean way to resolve this seems to be to pass the token upstream: ask them for a variant of `gap -i` facility to install GAPs packages.\n\nI have opened up an issue [#1499](https://github.com/gap-system/gap/issues/1499) on GAP's github repo.",
    "created_at": "2017-07-13T06:55:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162223",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162224",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162227",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162228",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162229",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162230",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162231",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "What is the status of this ticket? It appears to work, and I'd like to have qpa easily accessible. Can I have some cake?",
    "created_at": "2018-04-28T10:54:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162232",
...
```json
{
    "body": "So these added packages don't do any GAP kernel modules, right?\nJust checking---otherwise it looks good.",
    "created_at": "2018-04-30T16:30:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162233",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37281"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37282"
}
```
...
```json
{
    "body": "I believe so. The only thing that needs to be compiled is cohomolo (https://www.gap-system.org/Packages/cohomolo.html), but that is because of some extra C bindings IIRC.",
    "created_at": "2018-04-30T22:53:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162234",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162235",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "OK, send it to the bots then. I hope they can get the tar file.",
    "created_at": "2018-04-30T22:56:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162236",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Volker, is there a reason why this ticket did not get merged in the past beta?",
    "created_at": "2018-05-28T04:53:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162237",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13254#issuecomment-162238",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13254#event-37283"
}
```
