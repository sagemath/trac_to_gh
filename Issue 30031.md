...
```json
{
    ...
    "title": "Use \"./sage -t\", not \"sage -t\" in test output",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30031#issuecomment-426898",
    "user": "@kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30031#issuecomment-426899",
    "user": "@slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30031#issuecomment-426900",
    "user": "@mkoeppe"
}
```
