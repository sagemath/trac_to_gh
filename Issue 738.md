# Issue 738: [with patch] probably easy-to-fix bug in matrix2.pyx
...
```json
{
    ...
    "title": "[with patch] probably easy-to-fix bug in matrix2.pyx",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/738",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/738#event-2013"
}
```
