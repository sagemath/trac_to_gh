...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78761"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78762"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78763"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30148#issuecomment-429092",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78764"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78765"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78766"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78767"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78768"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78769"
}
```
...
```json
{
    "body": "In Example 1, the determinant is calculated as `A.dense_matrix().charpoly()(0)`. We get the poor answer `O(s^-52)` because the coefficients of the characteristic polynomial are calculated to be:\n\n```\nsage: list(A.dense_matrix().charpoly())\n[O(s^-52), O(s^-34), 3*s^-18 + O(s^-16), 4*s^-18 + 2 + O(s^2), 1]\n```\n\nI don't know how this should be fixed, but perhaps the determinant should be calculated directly, instead of coming from the characteristic polynomial.",
    "created_at": "2022-07-09T00:03:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30148#issuecomment-429093",
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78770"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30148#event-78771"
}
```
