...
sage: for t in KRT:
    ...
    if not t==rc.to_tensor_product_of_Kirillov_Reshetikhin_tableaux():
        print t
....:
[[[1], [0], [0]], [[1, 2], [2, -2]], [This is the Trac macro *1, E* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1, E-macro)]
---------------------------------------------------------------------------
...
Expected:
    [This is the Trac macro *5, 2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#5, 2-macro)
Got:
    [[2], [5]]
**********************************************************************
1 item had failures:
...
Expected:
    [This is the Trac macro *0, 3* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 3-macro)
Got:
    [[3], [0]]
**********************************************************************
...
Expected:
    [This is the Trac macro *-2, 3, 1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#-2, 3, 1-macro)
Got:
    [[1], [3], [-2]]
**********************************************************************
1 item had failures:
