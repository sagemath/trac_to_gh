...
sage: B=A.span([This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro))
sage: B==B.ambient_vector_space()
True
sage: B=A.span([This is the Trac macro *1/2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1/2-macro))
sage: B==B.ambient_vector_space()
False
```
