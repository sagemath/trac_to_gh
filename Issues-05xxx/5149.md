...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_5149.patch](tarball://root/attachments/some-uuid/ticket5149/trac_5149.patch) by @JohnCremona created at 2009-02-01 10:59:51\n\nPatch applies cleanly to 3.33.alpha2 and all tests pass.  Code looks good, so pass!",
...
<a id='comment:1'></a>Attachment [trac_5149.patch](tarball://root/attachments/some-uuid/ticket5149/trac_5149.patch) by @JohnCremona created at 2009-02-01 10:59:51
