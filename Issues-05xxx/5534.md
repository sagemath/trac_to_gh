...
```json
{
    "body": "<a id='comment:1'></a>Fixed (see the attached patch):\n\nNow:\n\n```\nsage: w = [\"a\", \"b\", \"c\", \"d\"]\nsage: ww = [\"b\", \"d\"]\nsage: sage.combinat.subword.smallest_positions(w, ww)\n[1, 3]\nsage: w\n['a', 'b', 'c', 'd']\nsage: ww\n['b', 'd']\n```\n\nNote the patch only applies on top of #5200\n\nAuthor : Florent Hivert",
    "created_at": "2009-03-17T09:59:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44093",
    "user": "https://github.com/hivert"
}
```

<a id='comment:1'></a>Fixed (see the attached patch):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44094",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44095",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44096",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44098",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Oups !!! It looks like Nicolas last review requirement was simply syntactically wrong. He required to write\n`res = [None] * subword.length()` where he meant  `res = [None] * len(subword)`. The bad think is that no one of use take care to even launch the tests. Shame on us !!!\n\nThe re-sumbmitted patch should work. \n\nCheers,\n\nFlorent",
    "created_at": "2009-03-28T18:47:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44099",
    "user": "https://github.com/hivert"
}
```

<a id='comment:5'></a>Oups !!! It looks like Nicolas last review requirement was simply syntactically wrong. He required to write
`res = [None] * subword.length()` where he meant  `res = [None] * len(subword)`. The bad think is that no one of use take care to even launch the tests. Shame on us !!!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44100",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-44101",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
