...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45966",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45967",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45968",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] sage.combinat.subword.smallest_positions modifying its input (use #5200)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45969",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "rename": {
        "from": "[with patch, needs review] sage.combinat.subword.smallest_positions modifying its input (use #5200)",
        "to": "[with patch, positive review] sage.combinat.subword.smallest_positions modifying its input (use #5200)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "rename": {
        "from": "[with patch, positive review] sage.combinat.subword.smallest_positions modifying its input (use #5200)",
        "to": "[with patch, needs work] sage.combinat.subword.smallest_positions modifying its input (use #5200)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21883"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45970",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45971",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "rename": {
        "from": "[with patch, needs work] sage.combinat.subword.smallest_positions modifying its input (use #5200)",
        "to": "[with patch, needs review] sage.combinat.subword.smallest_positions modifying its input (use #5200)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45972",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21885"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21886"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21887"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21888"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45973",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5534#event-21889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5534#issuecomment-45974",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
