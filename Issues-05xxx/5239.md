...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5239#issuecomment-42674",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "rename": {
        "from": "Sage 3.3.rc0: even more numerical noise in sage/sage/plot/plot.py",
        "to": "[with patch, needs review] Sage 3.3.rc0: even more numerical noise in sage/sage/plot/plot.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5239#event-20501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5239#issuecomment-42675",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5239#issuecomment-42676",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5239#issuecomment-42677",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "rename": {
        "from": "[with patch, needs review] Sage 3.3.rc0: even more numerical noise in sage/sage/plot/plot.py",
        "to": "[with patch, positive review] Sage 3.3.rc0: even more numerical noise in sage/sage/plot/plot.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5239#event-20502"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5239#issuecomment-42678",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5239#event-20503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5239#issuecomment-42679",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5239",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5239#issuecomment-42680",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
