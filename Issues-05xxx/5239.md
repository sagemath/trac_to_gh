# Issue 5239: [with patch, positive review] Sage 3.3.rc0: even more numerical noise in sage/sage/plot/plot.py
...
```json
{
    ...
    "title": "[with patch, positive review] Sage 3.3.rc0: even more numerical noise in sage/sage/plot/plot.py",
    "type": "issue",
