...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36871",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36872",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36873",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36874",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36875",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36876",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [quaternion.patch](https://github.com/sagemath/sage/files/ticket5632/quaternion.patch) by @jhpalmieri created at 2009-03-31 15:38:05\n\nrebased post #5520, positive review for this patch",
    "created_at": "2009-03-31T15:38:05Z",
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36877",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [quaternion.patch](https://github.com/sagemath/sage/files/ticket5632/quaternion.patch) by @jhpalmieri created at 2009-03-31 15:38:05
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [quatalg-reference.patch](https://github.com/sagemath/sage/files/ticket5632/quatalg-reference.patch) by mabshoff created at 2009-03-31 19:57:42\n\nFor the record: positive review quatalg-reference.patch.\n\nCheers,\n\nMichael",
    "created_at": "2009-03-31T19:57:42Z",
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5632#issuecomment-36879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
