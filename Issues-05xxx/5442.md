...
<a id='comment:1'></a>> The problem is that either preparse_ipython or magma.eval is too 
> naive, inserting a ';' rather than waiting for the completion
>  of the expression. 
