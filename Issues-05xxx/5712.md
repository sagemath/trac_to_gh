...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67766"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67769"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67770"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36184",
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67771"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36185",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36186",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36187",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36188",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36189",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36190",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36191",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36192",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36193",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36194",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<div id=\"comment:9\" align=\"right\">comment:9</div>\n\nReplying to [@TimDumol](#comment:8):\n> Replying to [@qed777](#comment:7):\n> > * I get a doctest failure from `Worksheet.interrupt`.\n> > \n> > * Just to check: Is `_ui-achtung.sass` just `ui.achtung.css` run through `css2sass`?  I suggest describing the conversion method briefly in `sass/readme.txt`.\n\n> \n> Yes. Sure, I'll do so.\n\nIn another ticket, that is.\n\n> \n> > \n> > * Interrupting an idle worksheet also brings up the alert.\n\n> \n> Good catch.\n> \n> > \n> > * V2 does not fix #7702's example (`interrupt test.sws`).  A new alert appears every time I try to interrupt the calculation, but the calculation keeps going (e.g., according to `top`).  (I stopped after about 10 attempts.)  Restarting the worksheet does stop the calculation.  But this need not hold up this ticket, as I can interrupt other examples, such as `import time; time.sleep(10)` and `factor(factorial(100000000))`.\n> > \n\n> \n> The point of #7702 is not to interrupt uninterruptible calculations, but to recognize that a calculation cannot be interrupted and display an appropriate alert.\n> \n> > * When we do show the alert (with #7702's example or a different one), maybe we should add, e.g., \"Please try again in a few seconds.  If that doesn't work, please try restarting the worksheet.\"?\n\nWill do so.",
    "created_at": "2010-01-20T11:46:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36195",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36196",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36197",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36198",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36199",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36200",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36201",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36202",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36203",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36204",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36205",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36206",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36207",
    "user": "https://github.com/sagetrac-acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5712#issuecomment-36208",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5712",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5712#event-67777"
}
```
