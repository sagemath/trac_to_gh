# Issue 5373: [with patch, positive review] fix problem in builder.copytree
...
```json
{
    ...
    "title": "[with patch, positive review] fix problem in builder.copytree",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5373",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5373#event-12525"
}
```
