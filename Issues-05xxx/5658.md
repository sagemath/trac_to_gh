...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5658#issuecomment-47372",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5658#issuecomment-47373",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "rename": {
        "from": "Efficiency improvement in generic order_from_multiple()",
        "to": "[with patch, needs review] Efficiency improvement in generic order_from_multiple()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5658#event-22478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5658#issuecomment-47374",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5658#issuecomment-47375",
    "user": "https://github.com/rhinton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "rename": {
        "from": "[with patch, needs review] Efficiency improvement in generic order_from_multiple()",
        "to": "[with patch, positive review] Efficiency improvement in generic order_from_multiple()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5658#event-22479"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5658#issuecomment-47376",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5658#event-22480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5658#issuecomment-47377",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
