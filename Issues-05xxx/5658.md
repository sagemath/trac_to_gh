...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5658/generic_order.patch",
    "created_at": "2009-04-01T15:05:19Z",
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5658/generic_order.patch",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "Attachment [generic_order.patch](https://github.com/sagemath/sage/files/ticket5658/generic_order.patch) by @JohnCremona created at 2009-04-01 15:05:19\n\nbased on 3.4.1.alpha0",
    "created_at": "2009-04-01T15:05:19Z",
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5658#issuecomment-37117",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [generic_order.patch](https://github.com/sagemath/sage/files/ticket5658/generic_order.patch) by @JohnCremona created at 2009-04-01 15:05:19
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5658#issuecomment-37118",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5658#issuecomment-37119",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5658#issuecomment-37120",
    "user": "https://github.com/rhinton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5658#issuecomment-37121",
