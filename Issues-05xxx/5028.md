...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5028#issuecomment-40649",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5028",
    "rename": {
        "from": "point2d? says point.options instead of point2d.options",
        "to": "[with patch, needs review] point2d? says point.options instead of point2d.options"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5028#event-19474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5028#issuecomment-40650",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5028",
    "rename": {
        "from": "[with patch, needs review] point2d? says point.options instead of point2d.options",
        "to": "[with patch, positive review] point2d? says point.options instead of point2d.options"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5028#event-19475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5028#issuecomment-40651",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5028",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5028#event-19476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5028#issuecomment-40652",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
