...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5836#issuecomment-49230",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5836#event-23290"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5836#event-23291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5836#issuecomment-49231",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5836#event-23292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5836#issuecomment-49232",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "rename": {
        "from": "pwith patch, needs review] Make show() immediately show an image in the notebook",
        "to": "[with patch, needs review] Make show() immediately show an image in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5836#event-23293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5836",
    "rename": {
        "from": "[with patch, needs review] Make show() immediately show an image in the notebook",
        "to": "[with patch, positive review] Make show() immediately show an image in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5836#event-23294"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5836",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5836#event-23295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5836#event-23296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5836#issuecomment-49233",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5836#issuecomment-49234",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
