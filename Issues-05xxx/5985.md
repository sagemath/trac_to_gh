...
```json
{
    "body": "<a id='comment:10'></a>\nThis patch needs an explicit addition of sage/misc/cPickle.c to MANIFEST.in for -sdist to work. It is also listed to have a positive review in the [CategoriesRoadMap](../wikis/CategoriesRoadMap), but it isn't on the ticket.\n\nCheers,\n\nMichael",
...
```json
{
    "body": "**Attachment:** [cPickle-5985-import-submitted.patch](https://github.com/sagemath/sage/files/ticket5985/cPickle-5985-import-submitted.patch)",
    "created_at": "2009-05-23T07:42:38Z",
    "issue": "https://github.com/sagemath/sage/issues/5985",
    "type": "issue_comment",
...
**Attachment:** [cPickle-5985-import-submitted.patch](https://github.com/sagemath/sage/files/ticket5985/cPickle-5985-import-submitted.patch)
...
```json
{
    "body": "**Attachment:** [trac_5985_test_class_pickling.patch](https://github.com/sagemath/sage/files/ticket5985/trac_5985_test_class_pickling.patch)\n\nApply only this patch, after updating the python spkg linked to below",
    "created_at": "2009-10-15T06:55:09Z",
    "issue": "https://github.com/sagemath/sage/issues/5985",
    "type": "issue_comment",
...
**Attachment:** [trac_5985_test_class_pickling.patch](https://github.com/sagemath/sage/files/ticket5985/trac_5985_test_class_pickling.patch)
