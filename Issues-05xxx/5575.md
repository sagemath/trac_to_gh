...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5575#issuecomment-46477",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        "from": "bug in span",
        "to": "[with patch; needs review] bug in span"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5575#event-22138"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5575",
    "rename": {
        "from": "[with patch; needs review] bug in span",
        "to": "[with patch; with positive review] bug in span"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5575#event-22139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5575#issuecomment-46478",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5575#issuecomment-46479",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5575#issuecomment-46480",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5575",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5575#event-22140"
}
```
