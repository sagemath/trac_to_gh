...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51970"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51971"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51975"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51976"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5111#issuecomment-32374",
    "user": "https://github.com/sagetrac-bpage"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5111#issuecomment-32375",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5111#issuecomment-32376",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5111#issuecomment-32377",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51980"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5111",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-51983"
}
```
