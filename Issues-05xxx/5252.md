...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5252#issuecomment-42848",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5252#issuecomment-42849",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5252",
    "rename": {
        "from": "elliptic curves: P.height() lies about its precision",
        "to": "[with patch, needs review] elliptic curves: P.height() lies about its precision"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5252#event-20575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5252",
    "rename": {
        "from": "[with patch, needs review] elliptic curves: P.height() lies about its precision",
        "to": "[with patch, positive review] elliptic curves: P.height() lies about its precision"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5252#event-20576"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5252#event-20577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5252#issuecomment-42850",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5252#issuecomment-42851",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5252",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5252#event-20578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5252#issuecomment-42852",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
