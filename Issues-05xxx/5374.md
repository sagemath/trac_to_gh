...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5374#issuecomment-44067",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5374#issuecomment-44068",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5374",
    "rename": {
        "from": "[with patch, needs review] minor problem with ReST in misc/hg.py",
        "to": "[with patch, positive review] minor problem with ReST in misc/hg.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5374#event-21118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5374#issuecomment-44069",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5374#issuecomment-44070",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5374",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5374#event-21119"
}
```
