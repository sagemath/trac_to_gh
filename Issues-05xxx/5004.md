...
```json
{
    ...
    "asset_name": "trac_5004.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket5004/trac_5004.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5004#issuecomment-31607",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5004#event-30629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5004#issuecomment-31608",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5004#event-30630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5004#event-30631"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5004#event-30632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5004",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5004#event-30633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5004#issuecomment-31609",
