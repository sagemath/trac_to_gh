...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5678#issuecomment-47573",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5678#issuecomment-47574",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5678",
    "rename": {
        "from": "LaTeX typesetting for two letters phi and Phi",
        "to": "[with patch, positive review] LaTeX typesetting for two letters phi and Phi"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5678#event-22569"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5678",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5678#event-22570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5678#issuecomment-47575",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5678#issuecomment-47576",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5678#event-22571"
}
```
