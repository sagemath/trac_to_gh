...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45492",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45494",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>robertwb,  Thanks for your patch (which needs a typo fixing: change 3 to 2 in line 113 or the test does not pass! -- I have attached a fixed patch).  I am happy to give your patch a positive review, but did you review mine?",
    "created_at": "2009-04-06T10:42:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45495",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>robertwb,  Thanks for your patch (which needs a typo fixing: change 3 to 2 in line 113 or the test does not pass! -- I have attached a fixed patch).  I am happy to give your patch a positive review, but did you review mine?
...
```json
{
    "body": "<a id='comment:2'></a>It looks good (and works) for me.",
    "created_at": "2009-04-12T09:44:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45496",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>It looks good (and works) for me.
...
```json
{
    "body": "<a id='comment:3'></a>The only suggestion I have is that it might be better to return `False` rather than `0` for non-twists.",
    "created_at": "2009-04-12T09:48:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45497",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>The only suggestion I have is that it might be better to return `False` rather than `0` for non-twists.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45498",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45499",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I am about to start fixing the rst failures which should not take long.\n\nNB the sha_tate failures were there when I posted this, and (via a message to sage-nt) I had hoped that Chris Wuthrich might have helped track that down.  I'll have a go myself now anyway.",
    "created_at": "2009-04-13T16:50:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45501",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>I am about to start fixing the rst failures which should not take long.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45502",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_5763_rst.patch](tarball://root/attachments/some-uuid/ticket5673/trac_5763_rst.patch) by @JohnCremona created at 2009-04-13 17:20:05\n\nPatch trac_5763_rst.patch fixes the rst failures.  Now for sha_tate....",
    "created_at": "2009-04-13T17:20:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45503",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>Attachment [trac_5763_rst.patch](tarball://root/attachments/some-uuid/ticket5673/trac_5763_rst.patch) by @JohnCremona created at 2009-04-13 17:20:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45504",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45506",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5673#event-13344"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Merged \n\n* trac_5673_part_1_twist.patch\n* trac_5673_part_2-j-keyword.2.patch\n* trac_5673_part_3_rst.patch\n* trac_5673_part_4_review.patch\n\nin Sage 3.4.1.rc3.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-16T12:06:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45507",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Merged 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5673#issuecomment-45508",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5673",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5673#event-13345"
}
```
