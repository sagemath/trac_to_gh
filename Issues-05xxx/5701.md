...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48807",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_5701-ref-suggestions.patch](tarball://root/attachments/some-uuid/ticket5701/trac_5701-ref-suggestions.patch) by @rlmill created at 2009-05-20 18:34:06\n\nI have run tests and checked the code here, and everything seems fine, with the following caveat: I did not run tests on a fresh install, i.e. I ran tests on a system with Guava still installed.\n\nI will give this a positive review, pending the tests passing on a system with the right GAP spkg and workspace setup, and  wdj will follow up on #6094.",
    "created_at": "2009-05-20T18:34:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48808",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:1'></a>Attachment [trac_5701-ref-suggestions.patch](tarball://root/attachments/some-uuid/ticket5701/trac_5701-ref-suggestions.patch) by @rlmill created at 2009-05-20 18:34:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48809",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I just added a third patch. If you remove guava from gap*/pkg, reset the GAP workspace, and then apply these three patches then all tests pass on a 64bit ubuntu 9.04 machine.",
    "created_at": "2009-05-26T02:08:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48810",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:2'></a>I just added a third patch. If you remove guava from gap*/pkg, reset the GAP workspace, and then apply these three patches then all tests pass on a 64bit ubuntu 9.04 machine.
...
```json
{
    "body": "<a id='comment:3'></a>Since you are adding an input to `wtdist_gap`, you also need to add a description to the INPUT section.",
    "created_at": "2009-05-26T06:36:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48811",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>Since you are adding an input to `wtdist_gap`, you also need to add a description to the INPUT section.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48812",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Adds 2 line description to linear_code.py docstring following referees suggestion.",
    "created_at": "2009-06-05T11:55:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48813",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:4'></a>Adds 2 line description to linear_code.py docstring following referees suggestion.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48814",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48815",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48816",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48817",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48818",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48819",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5701#issuecomment-48820",
    "user": "https://github.com/fchapoton"
}
```
