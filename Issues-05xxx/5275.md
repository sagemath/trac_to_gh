...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5275#issuecomment-44076",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is certainly possible (I bet I could do it rather quickly). \n\nDiscussion at http://groups.google.com/group/sage-devel/browse_thread/thread/7136f15aab6f6644?hl=en",
    "created_at": "2009-02-14T23:42:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5275",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5275#issuecomment-44078",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>This is certainly possible (I bet I could do it rather quickly). 
