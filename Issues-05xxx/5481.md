...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35439",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35440",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac_5481_scripts.patch](https://github.com/sagemath/sage/files/ticket5481/trac_5481_scripts.patch) by @jhpalmieri created at 2009-06-16 03:28:03\n\nHere's a patch.  (The first change -- deleting all.py and __init__.py -- comes from #6108.)",
    "created_at": "2009-06-16T03:28:03Z",
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35441",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35442",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35443",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35444",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35445",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35446",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5481#issuecomment-35447",
