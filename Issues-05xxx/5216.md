...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5216#issuecomment-33159",
...
```json
{
    "body": "Attachment [trac_5216-spkg-base.patch](https://github.com/sagemath/sage/files/ticket5216/trac_5216-spkg-base.patch) by mabshoff created at 2009-02-20 14:21:18\n\nThis is Mike's patch slightly modified",
    "created_at": "2009-02-20T14:21:18Z",
    "issue": "https://github.com/sagemath/sage/issues/5216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5216#issuecomment-33160",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

Attachment [trac_5216-spkg-base.patch](https://github.com/sagemath/sage/files/ticket5216/trac_5216-spkg-base.patch) by mabshoff created at 2009-02-20 14:21:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5216#issuecomment-33161",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5216#issuecomment-33162",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5216#issuecomment-33163",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
