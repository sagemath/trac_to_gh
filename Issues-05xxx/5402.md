...
```json
{
    "body": "<a id='comment:1'></a>I would tend to avoid converting to a dense matrix by default since one often uses sparse matrices because they don't have enough memory to store the dense ones.",
    "created_at": "2009-02-28T20:34:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45472",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>I would tend to avoid converting to a dense matrix by default since one often uses sparse matrices because they don't have enough memory to store the dense ones.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45475",
...
```json
{
    "body": "<a id='comment:4'></a>Apparently, this issue has been fixed. The determinant that used to take 15 minutes now takes 0.05s...",
    "created_at": "2013-01-03T14:41:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45476",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```

<a id='comment:4'></a>Apparently, this issue has been fixed. The determinant that used to take 15 minutes now takes 0.05s...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45477",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45479",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45480",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45481",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Fair enough. I'll post a patch this week-end.",
    "created_at": "2013-01-04T15:09:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45483",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```

<a id='comment:8'></a>Fair enough. I'll post a patch this week-end.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45484",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45485",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [5402_faster_dumber_det.patch](tarball://root/attachments/some-uuid/ticket5402/5402_faster_dumber_det.patch) by Bouillaguet created at 2013-01-04 17:26:04\n\nWith patch applied:\n\n```\nsage: dd = {(0,0):1}\nsage: %timeit matrix(100,dd).det()\n125 loops, best of 3: 7.04 ms per loop\nsage: %timeit matrix(100,dd,sparse = False).det()\n25 loops, best of 3: 16.3 ms per loop\n```\n\nSo that now the sparse case is faster! I really don't understand why tough, because it converts the matrix to a dense representation before computing the (dense) det...",
    "created_at": "2013-01-04T17:26:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45486",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```

<a id='comment:9'></a>Attachment [5402_faster_dumber_det.patch](tarball://root/attachments/some-uuid/ticket5402/5402_faster_dumber_det.patch) by Bouillaguet created at 2013-01-04 17:26:04
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45487",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Well, there you have it.  And the way to test it worked was perfect.\n\nOkay, open that other ticket, and then you have yourself a positive review.  Still unclear as to why it's *faster* than the dense case...",
    "created_at": "2013-01-04T18:09:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45490",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:12'></a>Well, there you have it.  And the way to test it worked was perfect.
...
```json
{
    "body": "<a id='comment:13'></a>http://trac.sagemath.org/sage_trac/ticket/13915 is opened",
    "created_at": "2013-01-06T09:08:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45491",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```

<a id='comment:13'></a>http://trac.sagemath.org/sage_trac/ticket/13915 is opened
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45492",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45493",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45494",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5402",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5402#issuecomment-45495",
    "user": "https://github.com/jdemeyer"
}
```
