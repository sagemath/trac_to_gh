# Issue 5012: [with patch, with positive review] Solaris 10/x86: Numerical noise in sage/rings/qqbar.py
...
```json
{
    ...
    "title": "[with patch, with positive review] Solaris 10/x86: Numerical noise in sage/rings/qqbar.py",
    "type": "issue",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Solaris 10/x86: Numerical noise in sage/rings/qqbar.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5012#event-19412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5012#issuecomment-40543",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5012#issuecomment-40544",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "rename": {
        "from": "[with patch, needs review] Solaris 10/x86: Numerical noise in sage/rings/qqbar.py",
        "to": "[with patch, with positive review modulo typo] Solaris 10/x86: Numerical noise in sage/rings/qqbar.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5012#event-19413"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "rename": {
        "from": "[with patch, with positive review modulo typo] Solaris 10/x86: Numerical noise in sage/rings/qqbar.py",
        "to": "[with patch, with positive review] Solaris 10/x86: Numerical noise in sage/rings/qqbar.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5012#event-19414"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5012#issuecomment-40545",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5012#event-19415"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5012#issuecomment-40546",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5012#issuecomment-40547",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
