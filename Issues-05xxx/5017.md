...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5017#issuecomment-40572",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5017",
    "rename": {
        "from": "graph.automorphism_group(translation=True) gives error in 3.2.3",
        "to": "[with patch, needs review] graph.automorphism_group(translation=True) gives error in 3.2.3"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5017#event-19427"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5017#issuecomment-40573",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5017",
    "rename": {
        "from": "[with patch, needs review] graph.automorphism_group(translation=True) gives error in 3.2.3",
        "to": "[with patch, positive review] graph.automorphism_group(translation=True) gives error in 3.2.3"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5017#event-19428"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5017#issuecomment-40574",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5017",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5017#event-19429"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5017#issuecomment-40575",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5017#issuecomment-40576",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
