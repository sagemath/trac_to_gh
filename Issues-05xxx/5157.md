...
```json
{
    ...
    "rename": {
        "from": "if the mwrank interface is interrupted from the notebook (!) it stays broken for the rest of the sage session",
        "to": "[with patch; needs review] if the mwrank interface is interrupted from the notebook (!) it stays broken for the rest of the sage session"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5157#event-20120"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5157#issuecomment-41983",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5157#issuecomment-41984",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5157#issuecomment-41985",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5157#issuecomment-41986",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5157#issuecomment-41987",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "rename": {
        "from": "[with patch; needs review] if the mwrank interface is interrupted from the notebook (!) it stays broken for the rest of the sage session",
        "to": "[with patch; positive review] if the mwrank interface is interrupted from the notebook (!) it stays broken for the rest of the sage session"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5157#event-20121"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5157#issuecomment-41988",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5157#issuecomment-41989",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5157",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5157#event-20122"
}
```
