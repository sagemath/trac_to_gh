...
```json
{
    "body": "<a id='comment:2'></a>It seems to be okay, but do we really want the \"print '*'*1000\" in there?",
...
<a id='comment:2'></a>It seems to be okay, but do we really want the "print '*'*1000" in there?
...
```json
{
    "body": "<a id='comment:3'></a>This should be refereed by someone who knows pexpect!",
...
<a id='comment:3'></a>This should be refereed by someone who knows pexpect!
...
<a id='comment:4'></a>> It seems to be okay, but do we really want the "print '*'*1000" in there? 
...
```json
{
    "body": "<a id='comment:5'></a>Since Mike gave this the heads up and William removed the debug print statement I am changing this to a positive review.\n\nCheers,\n\nMichael",
...
<a id='comment:5'></a>Since Mike gave this the heads up and William removed the debug print statement I am changing this to a positive review.
...
```json
{
    "body": "<a id='comment:6'></a>Merged in Sage 3.3.alpha4.\n\nCheers,\n\nMichael",
...
<a id='comment:6'></a>Merged in Sage 3.3.alpha4.
