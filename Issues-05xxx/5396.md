...
```json
{
    "body": "Changed assignee from **Rishi** to **@rishikesha**",
...
Changed assignee from **Rishi** to **@rishikesha**
...
```json
{
    "body": "<a id='comment:83'>Comment 83:</a>\nAm I correct that only [attachment: trac_5396_combined_rebased_4.3.4.patch.gz](https://github.com/sagemath/sage/files/ticket5396/trac_5396_combined_rebased_4.3.4.patch.gz) should be merged?\n\nIf so, please add the ticket number to that patch's commit message and switch this back to positive review!",
    "created_at": "2010-07-22T07:33:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5396",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5396#issuecomment-34665",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5396#issuecomment-34666",
    "user": "https://github.com/rishikesha"
}
```
