...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] new section for tutorial about functions vs. expressions, etc.",
        "to": "[with patch, positive review] new section for tutorial about functions vs. expressions, etc."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5463#event-21538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5463#issuecomment-45230",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5463#issuecomment-45231",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5463#issuecomment-45232",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5463",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5463#event-21539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5463#issuecomment-45233",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5463#issuecomment-45234",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5463#event-21540"
}
```
