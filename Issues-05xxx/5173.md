...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac5173-cmp-complex-converts.patch](tarball://root/attachments/some-uuid/ticket5173/trac5173-cmp-complex-converts.patch) by cwitty created at 2009-02-05 04:17:20\n\nThe code didn't do the right thing at all with ComplexIntervalField(200), because it was trying to compare incomparable values, so it fell back to comparing the types.  Fixed in the attached patch by adding an explicit conversion to the appropriate type.",
    "created_at": "2009-02-05T04:17:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5173#issuecomment-40593",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:1'></a>Attachment [trac5173-cmp-complex-converts.patch](tarball://root/attachments/some-uuid/ticket5173/trac5173-cmp-complex-converts.patch) by cwitty created at 2009-02-05 04:17:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5173#issuecomment-40594",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5173#issuecomment-40595",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5173#event-11970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5173#issuecomment-40596",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
