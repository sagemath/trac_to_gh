...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5372#issuecomment-42376",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5372#issuecomment-42377",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5372#issuecomment-42378",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>After applying the patch:\n\n\n```\nsage -t -long \"devel/sage/sage/libs/mwrank/all.py\"          \n\t [7.5 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 7.5 seconds\n\n```\n\nSo a positive review.\n\nJaap",
    "created_at": "2009-02-26T14:31:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5372#issuecomment-42379",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:2'></a>After applying the patch:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5372#issuecomment-42380",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5372#issuecomment-42381",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
