...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58633"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58635"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58636"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58637"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58643"
}
```
...
```json
{
    "body": "<a id='comment:41'>Comment 41:</a>\nI applied the rejected pieces by hand and exported anew.  See [attachment: trac_5653_pretty_docstrings_v7.patch.gz](https://github.com/sagemath/sage/files/ticket5653/trac_5653_pretty_docstrings_v7.patch.gz).  A diff of the diffs does not reveal any surprises, but let me know...",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58644"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58647"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58651"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58652"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58653"
}
```
...
```json
{
    "body": "<a id='comment:59'>Comment 59:</a>\nDid [attachment: trac_5653_pretty_docstrings_v7.patch.gz](https://github.com/sagemath/sage/files/ticket5653/trac_5653_pretty_docstrings_v7.patch.gz) merge without incident?  The patch includes, e.g., `doc/en/introspect/templates/layout.html`, but it appears to be missing in v4.1.1.alpha1.  Or am I mistaken?",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58655"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5653#issuecomment-37118",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58656"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5653#issuecomment-37119",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5653#issuecomment-37120",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5653#issuecomment-37121",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5653#issuecomment-37122",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5653#issuecomment-37123",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58658"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5653",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5653#event-58659"
}
```
