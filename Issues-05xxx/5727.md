...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37586",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [modular_docs.patch](https://github.com/sagemath/sage/files/ticket5727/modular_docs.patch) by mabshoff created at 2009-04-09 18:36:10\n\nLet's change the status so the right reports pick up this ticket :)\n\nCheers,\n\nMichael",
    "created_at": "2009-04-09T18:36:10Z",
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37587",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37588",
...
```json
{
    "body": "Attachment [trac_5727_referee.patch](https://github.com/sagemath/sage/files/ticket5727/trac_5727_referee.patch) by @williamstein created at 2009-04-10 00:51:29\n\napply this after applying the above patch",
    "created_at": "2009-04-10T00:51:29Z",
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37589",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac_5727_referee.patch](https://github.com/sagemath/sage/files/ticket5727/trac_5727_referee.patch) by @williamstein created at 2009-04-10 00:51:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37590",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37591",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37592",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37593",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37594",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5727",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5727#issuecomment-37595",
    "user": "https://github.com/loefflerd"
}
```
