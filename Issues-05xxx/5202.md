...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5202#issuecomment-43398",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Looks good.  Passes all tests for me.",
    "created_at": "2009-02-08T01:48:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5202#issuecomment-43400",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:3'></a>Looks good.  Passes all tests for me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5202#issuecomment-43401",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5202#issuecomment-43402",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5202",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5202#event-12048"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> I can supply you with the config.guess output of all the machines above in case you want it for the MPFR website. I can also test on MIPS64/Linux.\n\n\nyes please supply it for configurations not already listed for mpfr-2.4.0.\n\nPaul",
    "created_at": "2009-02-08T09:47:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5202#issuecomment-43403",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:5'></a>> I can supply you with the config.guess output of all the machines above in case you want it for the MPFR website. I can also test on MIPS64/Linux.
