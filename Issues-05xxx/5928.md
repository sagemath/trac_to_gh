...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5928#issuecomment-50470",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5928#issuecomment-50471",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] binary operations on factorisations should coerce factors into a common universe"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5928#event-23685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5928",
    "rename": {
        "from": "[with patch, needs review] binary operations on factorisations should coerce factors into a common universe",
        "to": "[with patch, positive review] binary operations on factorisations should coerce factors into a common universe"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5928#event-23686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5928#issuecomment-50472",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5928#issuecomment-50473",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5928",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5928#event-23687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5928#issuecomment-50474",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5928#event-23688"
}
```
