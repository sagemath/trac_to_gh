...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5011#issuecomment-40539",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5011#issuecomment-40540",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5011",
    "rename": {
        "from": "[with patch, needs review] Solaris: fix get_memory_usage() to use top",
        "to": "[with patch, with positive review] Solaris: fix get_memory_usage() to use top"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5011#event-19410"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5011#issuecomment-40541",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5011#issuecomment-40542",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5011",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5011#event-19411"
}
```
