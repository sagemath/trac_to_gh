...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5679#issuecomment-48654",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>> Incidentally, we never get to the `args[0]` because you are solving a single expression, so it goes to `ex.solve(*args)`.  So maybe we should check for that...  But in any case the syntax is now\n> Weirdly, \n> \n> ```\n> sage: solve([symbolic_expression(x0) == 0], SR(x0), SR(x1), SR(x2))\n> ([x0 == 0], [1])\n> ```\n\n\nThese (tangential) things are both addressed at #10750, as it turns out.",
    "created_at": "2011-09-13T17:01:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5679#issuecomment-48655",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>> Incidentally, we never get to the `args[0]` because you are solving a single expression, so it goes to `ex.solve(*args)`.  So maybe we should check for that...  But in any case the syntax is now
> Weirdly, 
> 
> ```
> sage: solve([symbolic_expression(x0) == 0], SR(x0), SR(x1), SR(x2))
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5679#event-13354"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5679#event-13355"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5679#event-13356"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5679#event-13357"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5679#event-13358"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5679#event-13359"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5679#event-13360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5679#issuecomment-48656",
