...
archive/attachments_006228.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_5350-clone_hardlink.patch](https://github.com/sagemath/sage/files/ticket5350/trac_5350-clone_hardlink.patch)\n\nI don't think we want this in a critical stable release :)\n\nCheers,\n\nMichael",
    "created_at": "2009-02-23T19:00:38Z",
    "issue": "https://github.com/sagemath/sage/issues/5350",
    "type": "issue_comment",
...
archive/attachments_006229.json:
```json
{
    "asset_content_type": "application/octet-stream",
