...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44866",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -12,12 +12,9 @@\n ```\n Timings (user + system):\n \n-11.94s : Stock 3.3\n-\n-11.20s : No multiplication\n-\n-10.18s : No multiplication, with _list()\n-\n+* 11.94s : Stock 3.3\n+* 11.20s : No multiplication\n+* 10.18s : No multiplication, with _list()\n \n Summary: Optimize transpose for dense matrices\n \n``````\n",
    "created_at": "2009-02-23T07:32:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44867",
...
```json
{
    "body": "<a id='comment:2'></a>A 18% speed improvement is never \"trivial\" for something like a basic operation like this :)\n\nCheers,\n\nMichael",
    "created_at": "2009-02-23T07:32:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44868",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>A 18% speed improvement is never "trivial" for something like a basic operation like this :)
...
```json
{
    "body": "<a id='comment:3'></a>I think we can obtain a much bigger speedup if we replace the inner loop:\n\n```\n...\n    for i in xrange(nr):\n        f.append(e[i*nc+j])\n...\n```\nwith\n\n```\n...\n    f.extend(e[j::nc])\n...\n```\n\nand we should do just the same thing for antitranspose a few lines further",
    "created_at": "2009-02-23T20:07:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44869",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:3'></a>I think we can obtain a much bigger speedup if we replace the inner loop:
...
```json
{
    "body": "<a id='comment:5'></a>This transpose function has another problem, it copies the entries multiple times which is very bad for memory usage. For example I can't transpose a 5000x5000 matrix on my laptop.\nI suggest something like this (but maybe I'm missing something here?)\n\n```\n        (nc, nr) = (self.ncols(), self.nrows())\n        trans = self.new_matrix(nrows = nc, ncols = nr,\n                                copy=False,\n                                coerce=False)\n        for j in xrange(nc):\n            for i in xrange(nr):\n                trans[j,i]=self[i,j]\n\n        if self.subdivisions is not None:\n            row_divs, col_divs = self.get_subdivisions()\n            trans.subdivide(col_divs, row_divs)\n        return trans\n```\n(sorry, no time to do a proper patch right now)\n\nPS: I also think that there should be an optimized version af transpose in matrix_integer_dense.pyx, but it's probably for another ticket.",
    "created_at": "2009-02-24T18:38:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44871",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:5'></a>This transpose function has another problem, it copies the entries multiple times which is very bad for memory usage. For example I can't transpose a 5000x5000 matrix on my laptop.
I suggest something like this (but maybe I'm missing something here?)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44872",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I had no time to do it, but of course I did it... Patch added implementing the idea above, plus unsafe access. It's a standalone patch (no need to apply yours) based on sage-3.3.\n\nsage -testall successful.\n\nAnd some statistics:\n\n```\nBefore:\n\nsage: m=identity_matrix(3000)\nsage: time m2=m.transpose(); m3=m.antitranspose()\nCPU times: user 14.13 s, sys: 1.11 s, total: 15.44 s\nWall time: 15.44 s\nsage: get_memory_usage()\n1254.28125\n\nAfter:\n\nsage: m=identity_matrix(3000)\nsage: time m2=m.transpose(); m3=m.antitranspose()\nCPU times: user 2.92 s, sys: 0.46 s, total: 3.38 s\nWall time: 3.38 s\nsage: get_memory_usage()\n835.6171875\n```\n\nI hope it's not too rude to make a patch for your ticket...\n\nCheers,\n      Yann",
    "created_at": "2009-02-24T21:27:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44873",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:6'></a>I had no time to do it, but of course I did it... Patch added implementing the idea above, plus unsafe access. It's a standalone patch (no need to apply yours) based on sage-3.3.
...
```json
{
    "body": "<a id='comment:8'></a>(if someone is interested, a patch for matrix_integer_dense is proposed in #5369)",
    "created_at": "2009-02-25T10:09:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44875",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:8'></a>(if someone is interested, a patch for matrix_integer_dense is proposed in #5369)
...
```json
{
    "body": "<a id='comment:9'></a>Looks good.  Apply only trac-5345-transpose-matrix-dense.patch",
    "created_at": "2009-02-25T18:24:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44876",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:9'></a>Looks good.  Apply only trac-5345-transpose-matrix-dense.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44877",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Merged trac-5345-transpose-matrix-dense.patch in Sage 3.4.rc0.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-28T21:03:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Merged trac-5345-transpose-matrix-dense.patch in Sage 3.4.rc0.
...
```json
{
    "body": "<a id='comment:12'></a>Replying to [comment:11 mvngu]:\n> Replying to [comment:6 ylchapuy]:\n> > And some statistics:\n> > \n> > ```\n> > Before:\n> > \n> > sage: m=identity_matrix(3000)\n> > sage: time m2=m.transpose(); m3=m.antitranspose()\n> > CPU times: user 14.13 s, sys: 1.11 s, total: 15.44 s\n> > Wall time: 15.44 s\n> > sage: get_memory_usage()\n> > 1254.28125\n> > \n> > After:\n> > \n> > sage: m=identity_matrix(3000)\n> > sage: time m2=m.transpose(); m3=m.antitranspose()\n> > CPU times: user 2.92 s, sys: 0.46 s, total: 3.38 s\n> > Wall time: 3.38 s\n> > sage: get_memory_usage()\n> > 835.6171875\n> > ```\n\n> Is it possible for you to provide some information on the computer/system architecture that you used to get the above statistics? The improved performance is great news and I'll include this in the release tour at\n> [http://wiki.sagemath.org/sage-3.4](http://wiki.sagemath.org/sage-3.4)\n> And it would also be good to have some info about the hardware under which you arrived at the above statistics.\n\n\nIt was on my laptop:\n\n```\nIntel(R) Core(TM)2 Duo CPU     T5450  @ 1.66GHz\nMemTotal:      2066004 kB\nLinux my-laptop 2.6.24-23-generic #1 SMP Thu Feb 5 15:00:25 UTC 2009 i686 GNU/Linux\n```",
    "created_at": "2009-03-01T09:51:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44880",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:12'></a>Replying to [comment:11 mvngu]:
> Replying to [comment:6 ylchapuy]:
> > And some statistics:
> > 
> > ```
...
```json
{
    "body": "<a id='comment:14'></a>Thanks to Rob and Yann for the architecture info. For future reference, any optimization is very welcome. But for people who don't live on trac, a summary including timing and memory statistics as well as system architectures can be very useful. Of course any developer who has an account on sage.math can get the timing and memory statistics. But sage.math is not a regular PC or laptop; it's a powerful multi-core (over 20 cores, I think) machine with over *100* GB of RAM.",
    "created_at": "2009-03-02T01:11:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44882",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:14'></a>Thanks to Rob and Yann for the architecture info. For future reference, any optimization is very welcome. But for people who don't live on trac, a summary including timing and memory statistics as well as system architectures can be very useful. Of course any developer who has an account on sage.math can get the timing and memory statistics. But sage.math is not a regular PC or laptop; it's a powerful multi-core (over 20 cores, I think) machine with over *100* GB of RAM.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44883",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44886",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5345#issuecomment-44887",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
