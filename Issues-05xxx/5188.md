...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5188#issuecomment-43323",
...
```json
{
    "body": "<a id='comment:4'></a>This is now invalid.\n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nsage: sage: factor(-1)\n-1\nsage: sage: (factor(-1))^2\n1\nsage: sage: (factor(-1)^2).value() == -1 \nFalse\n```",
    "created_at": "2009-06-04T20:46:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5188#issuecomment-43324",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>This is now invalid.
