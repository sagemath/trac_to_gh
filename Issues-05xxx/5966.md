...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5966#issuecomment-50968",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5966#issuecomment-50969",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5966",
    "rename": {
        "from": "sage/sets/primes.py: change doctest so that we check for Primes being != to x^2+x",
        "to": "[with patch, needs review] sage/sets/primes.py: change doctest so that we check for Primes being != to x^2+x"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5966#event-23851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5966",
    "rename": {
        "from": "[with patch, needs review] sage/sets/primes.py: change doctest so that we check for Primes being != to x^2+x",
        "to": "[with patch, positive review] sage/sets/primes.py: change doctest so that we check for Primes being != to x^2+x"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5966#event-23852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5966#issuecomment-50970",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5966#issuecomment-50971",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5966",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5966#event-23853"
}
```
