...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51086",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51087",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51088",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51089",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51090",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "rename": {
        "from": "[with patch; needs review] the generic linear_combination_of_rows and linear_combination_of_columns functions for matrices are very stupidly slotch",
        "to": "[with patch; needs work] the generic linear_combination_of_rows and linear_combination_of_columns functions for matrices are very stupidly slotch"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5974#event-23880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "rename": {
        "from": "[with patch; needs work] the generic linear_combination_of_rows and linear_combination_of_columns functions for matrices are very stupidly slotch",
        "to": "[with patch; needs review] the generic linear_combination_of_rows and linear_combination_of_columns functions for matrices are very stupidly slotch"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5974#event-23881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51091",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51092",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] the generic linear_combination_of_rows and linear_combination_of_columns functions for matrices are very stupidly slotch",
        "to": "[with patch; positive review] the generic linear_combination_of_rows and linear_combination_of_columns functions for matrices are very stupidly slotch"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5974#event-23882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51093",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51094",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5974#event-23883"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5974#issuecomment-51095",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
