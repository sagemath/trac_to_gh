...
```json
{
    "body": "<a id='comment:1'></a>Disagree, primarily because it's been this way for quite a while now, and because a lot of users would be *really* confused by the question mark.  We certainly could update the documentation to make it clear how to get much more accurate answers using RIF.",
    "created_at": "2011-03-16T15:54:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5993#issuecomment-52539",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Disagree, primarily because it's been this way for quite a while now, and because a lot of users would be *really* confused by the question mark.  We certainly could update the documentation to make it clear how to get much more accurate answers using RIF.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5993#issuecomment-52540",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5993#issuecomment-52541",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5993#issuecomment-52542",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5993#issuecomment-52543",
    "user": "https://github.com/rwst"
}
```
