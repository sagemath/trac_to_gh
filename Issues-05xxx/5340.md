...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5340#issuecomment-44830",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5340#issuecomment-44832",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Positive review. I did valgrind all of the Sage 3.3 doctests + this patch (while testing gsw's libSingular work) and no issue popped up. It also passes doctests on top of the ReST patches.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-24T20:30:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5340#issuecomment-44833",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Positive review. I did valgrind all of the Sage 3.3 doctests + this patch (while testing gsw's libSingular work) and no issue popped up. It also passes doctests on top of the ReST patches.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5340#issuecomment-44834",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5340#issuecomment-44835",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
