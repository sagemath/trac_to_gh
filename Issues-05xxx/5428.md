...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64123"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64125"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64126"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64128"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64129"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64130"
}
```
...
```json
{
    ...
    "title_was": "Doctest failure in devel/sage/doc/en/bordeaux_2008/method_of_graphs.rst",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64131"
}
```
...
```json
{
    ...
    "title_was": "[not ready for review] Doctest failure in devel/sage/doc/en/bordeaux_2008/method_of_graphs.rst",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64132"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-64136"
}
```
