...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55820"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55824"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55825"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55826"
}
```
...
```json
{
    ...
    "title_was": "Doctest failure in devel/sage/doc/en/bordeaux_2008/method_of_graphs.rst",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55827"
}
```
...
```json
{
    ...
    "title_was": "[not ready for review] Doctest failure in devel/sage/doc/en/bordeaux_2008/method_of_graphs.rst",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55831"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-55832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5428#issuecomment-34974",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5428#issuecomment-34975",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
