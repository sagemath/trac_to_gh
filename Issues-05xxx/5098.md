...
```json
{
    "body": "<a id='comment:2'></a>I don't really know what makes it slow. I suspect the use of \"hash\" is costly but I see no other way to partition generically a group in approximately equal size chunks.",
    "created_at": "2009-01-25T16:14:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42272",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:2'></a>I don't really know what makes it slow. I suspect the use of "hash" is costly but I see no other way to partition generically a group in approximately equal size chunks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42273",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42274",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>argh, sorry, trac-5098-review.2.patch are the same trac-5098-review.patch, only one of them needs to be applied",
    "created_at": "2009-01-26T08:21:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42277",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:7'></a>argh, sorry, trac-5098-review.2.patch are the same trac-5098-review.patch, only one of them needs to be applied
...
```json
{
    "body": "<a id='comment:8'></a>if someone reviews this patch, he might have a look at #5112 implementing Pollard lambda algorithm",
    "created_at": "2009-01-27T20:54:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42278",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:8'></a>if someone reviews this patch, he might have a look at #5112 implementing Pollard lambda algorithm
...
```json
{
    "body": "<a id='comment:10'></a>brand new standalone patch, based on a fresh alpha2 build.\nI hope everything is ok this time :)",
    "created_at": "2009-01-29T11:40:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42280",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:10'></a>brand new standalone patch, based on a fresh alpha2 build.
I hope everything is ok this time :)
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [trac-5098-alpha2based.patch](tarball://root/attachments/some-uuid/ticket5098/trac-5098-alpha2based.patch) by @JohnCremona created at 2009-02-01 15:15:54\n\nThanks -- I am quite happy now, and give this a positive review!  Now I will go and look at the lambda patch too.",
    "created_at": "2009-02-01T15:15:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42281",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:11'></a>Attachment [trac-5098-alpha2based.patch](tarball://root/attachments/some-uuid/ticket5098/trac-5098-alpha2based.patch) by @JohnCremona created at 2009-02-01 15:15:54
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42283",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42285",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Attachment [trac-5098-doctest.patch](tarball://root/attachments/some-uuid/ticket5098/trac-5098-doctest.patch) by ylchapuy created at 2009-02-11 10:12:55\n\nadded a small patch to fix doctest, and return a NotImplementedError explaining the problem which is that we can't get the order of the base (in the example it's not a unit).",
    "created_at": "2009-02-11T10:12:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42287",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:17'></a>Attachment [trac-5098-doctest.patch](tarball://root/attachments/some-uuid/ticket5098/trac-5098-doctest.patch) by ylchapuy created at 2009-02-11 10:12:55
...
```json
{
    "body": "<a id='comment:19'></a>the last patch only change the behaviour in case the order of the base can't be computed. If all the patches apply cleanly I think it doesn't need another review (correct me if I'm wrong).",
    "created_at": "2009-02-11T12:27:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42288",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:19'></a>the last patch only change the behaviour in case the order of the base can't be computed. If all the patches apply cleanly I think it doesn't need another review (correct me if I'm wrong).
...
```json
{
    "body": "<a id='comment:27'></a>I am cleaning up the 3.3 milestone. If a patch with positive review is put up to this ticket on time it might make it into 3.3.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-16T05:00:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42295",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:27'></a>I am cleaning up the 3.3 milestone. If a patch with positive review is put up to this ticket on time it might make it into 3.3.
...
```json
{
    "body": "<a id='comment:28'></a>Any movement on this?\n\nCheers,\n\nMichael",
    "created_at": "2009-03-25T07:38:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42296",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:28'></a>Any movement on this?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42299",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>I renamed the function to \"discrete_log_rho\", removed the unnecessary parameters (partition_size and memory_size don't change that much the behavior), added an example of user set hash function, and forgot to add an exemple for check_prime... I will fix this in 2 minutes!",
    "created_at": "2009-09-05T15:36:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42300",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:32'></a>I renamed the function to "discrete_log_rho", removed the unnecessary parameters (partition_size and memory_size don't change that much the behavior), added an example of user set hash function, and forgot to add an exemple for check_prime... I will fix this in 2 minutes!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42301",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>I finally choose to remove the parameter check_prime because the complexity of Pollard Rho algorithm is a lot bigger than primality testing.",
    "created_at": "2009-09-05T15:45:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42302",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```

<a id='comment:33'></a>I finally choose to remove the parameter check_prime because the complexity of Pollard Rho algorithm is a lot bigger than primality testing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42303",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42304",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42305",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>This gets a positive review from me with the small changes in the review patch. All tests pass. For transparency I just added one tiny comment on the fall back and completed the type of a raised error.",
    "created_at": "2009-12-08T09:06:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42306",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```

<a id='comment:35'></a>This gets a positive review from me with the small changes in the review patch. All tests pass. For transparency I just added one tiny comment on the fall back and completed the type of a raised error.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42307",
    "user": "https://trac.sagemath.org/admin/accounts/users/mraum"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>Attachment [trac-5098-pollard_review.patch](tarball://root/attachments/some-uuid/ticket5098/trac-5098-pollard_review.patch) by @mwhansen created at 2009-12-20 07:23:32",
    "created_at": "2009-12-20T07:23:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42308",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:36'></a>Attachment [trac-5098-pollard_review.patch](tarball://root/attachments/some-uuid/ticket5098/trac-5098-pollard_review.patch) by @mwhansen created at 2009-12-20 07:23:32
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42309",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5098#issuecomment-42310",
    "user": "https://github.com/mwhansen"
}
```
