...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51762"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51765"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51766"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51769"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51772"
}
```
...
```json
{
    ...
    "title_was": "Pollard rho algorithm for generic discrete logarithm",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51773"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51776"
}
```
...
```json
{
    ...
    "title_was": "Pollard rho algorithm for generic discrete logarithm",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51777"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51779"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51780"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51781"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51782"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51783"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51784"
}
```
...
```json
{
    ...
    "title_was": "Pollard rho algorithm for generic discrete logarithm",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51785"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51786"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51787"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51788"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51791"
}
```
...
```json
{
    ...
    "title_was": "Pollard rho algorithm for generic discrete logarithm",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51792"
}
```
...
```json
{
    ...
    "title_was": "[with review] Pollard rho algorithm for generic discrete logarithm",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51795"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51796"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5098#issuecomment-32248",
    "user": "https://github.com/sagetrac-mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5098#issuecomment-32249",
    "user": "https://github.com/sagetrac-mraum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5098#issuecomment-32250",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5098#issuecomment-32251",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5098",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51799"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51800"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5098#event-51801"
}
```
