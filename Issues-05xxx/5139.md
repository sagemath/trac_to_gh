...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5139#issuecomment-41737",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5139",
    "rename": {
        "from": "add computation of Bach bound of number fields to Sage",
        "to": "[with patch; needs review] add computation of Bach bound of number fields to Sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5139#event-20030"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5139#issuecomment-41738",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5139",
    "rename": {
        "from": "[with patch; needs review] add computation of Bach bound of number fields to Sage",
        "to": "[with patch; positive review] add computation of Bach bound of number fields to Sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5139#event-20031"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5139",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5139#event-20032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5139#issuecomment-41739",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5139#issuecomment-41740",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
