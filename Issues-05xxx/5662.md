# Issue 5662: [with patch, positive review] Fix timing issue in clisp-readline in maxima pexpect
...
```json
{
    ...
    "title": "[with patch, positive review] Fix timing issue in clisp-readline in maxima pexpect",
    "type": "issue",
...
```json
{
    "body": "<a id='comment:2'></a>I've run the script, and it always fails. Over ten runs, on average it hung on run 19.3 and never got past 50 runs. I'll change the script and see what happens when the threads share some L2.",
    "created_at": "2009-04-01T23:31:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48476",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:2'></a>I've run the script, and it always fails. Over ten runs, on average it hung on run 19.3 and never got past 50 runs. I'll change the script and see what happens when the threads share some L2.
...
```json
{
    "body": "<a id='comment:5'></a>When change the script do use cores 0 and 1, I still get timeouts, but on average it takes 229 runs before the process hangs. So it does seem like the choice of cores affects this.",
    "created_at": "2009-04-02T05:43:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48478",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:5'></a>When change the script do use cores 0 and 1, I still get timeouts, but on average it takes 229 runs before the process hangs. So it does seem like the choice of cores affects this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48480",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48482",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48483",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48484",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48485",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>A (minor) quirk with this fix is that after the maxima pexpect interface is run at least once, the environment variable `SAGE_CLISP_DISABLE_READLINE_HACK` will be globally set in the Sage process. Hence, if we launch a shell from Sage, the variable will be set, and thus maxima will have readline disabled in the shell.",
    "created_at": "2009-04-04T04:42:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48487",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:10'></a>A (minor) quirk with this fix is that after the maxima pexpect interface is run at least once, the environment variable `SAGE_CLISP_DISABLE_READLINE_HACK` will be globally set in the Sage process. Hence, if we launch a shell from Sage, the variable will be set, and thus maxima will have readline disabled in the shell.
...
```json
{
    "body": "<a id='comment:12'></a>After talking to William about this: We will merge the fix, but use a different solution to the env variable problem by creating a special maxima-no-readline script that just sets the env variable before calling Maxima.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-05T22:48:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48488",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>After talking to William about this: We will merge the fix, but use a different solution to the env variable problem by creating a special maxima-no-readline script that just sets the env variable before calling Maxima.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48490",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Auch... disabling readline in lisp pexpect interface causes some issues (doctest failures in lisp.py) which I don't understand...",
    "created_at": "2009-04-06T05:43:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48492",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:16'></a>Auch... disabling readline in lisp pexpect interface causes some issues (doctest failures in lisp.py) which I don't understand...
...
```json
{
    "body": "<a id='comment:17'></a>Note that the lisp interface had a couple of issues before, which were not tested. The part2 patch above adds two doctests which *fail* in sage-3.4, and fixes those as well. Somebody should read the documentation for function `str.lstrip()` more carefully :-)\n\nHint: try\n\n```\n\"20.085537\".strip(\"sage2\")\n```\n\nThe following exhibits these bugs, as tested on sage.math /usr/local/bin/sage which is stock 3.4:\n\n```\nsage: lisp.eval(\"2\")\n''\nsage: lisp.set(\"x\", 2)\nsage: lisp.get(\"x\")\n'2'\nsage: lisp.eval(\"x\")\n'x\\n2'\n```",
    "created_at": "2009-04-06T16:01:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48493",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:17'></a>Note that the lisp interface had a couple of issues before, which were not tested. The part2 patch above adds two doctests which *fail* in sage-3.4, and fixes those as well. Somebody should read the documentation for function `str.lstrip()` more carefully :-)
...
```json
{
    "body": "<a id='comment:18'></a>This is a 3.4.1 blocker.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-06T18:29:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48494",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:18'></a>This is a 3.4.1 blocker.
...
```json
{
    "body": "<a id='comment:20'></a>William asked me to change this to positive review, so I'm doing that, although I haven't in any real sense reviewed the spkg updates. But the basic idea of disabling readline when it should be disabled is sound, and the problem is gone, so I suppose a positive review is reasonable.",
    "created_at": "2009-04-13T02:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48496",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:20'></a>William asked me to change this to positive review, so I'm doing that, although I haven't in any real sense reviewed the spkg updates. But the basic idea of disabling readline when it should be disabled is sound, and the problem is gone, so I suppose a positive review is reasonable.
...
```json
{
    "body": "<a id='comment:23'></a>Ok, I have deleted various patches and changed the summary. I will post a patch in Gonzalo's name shortly. You need the two spkgs from #5823 to make this work.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-19T07:19:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48499",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:23'></a>Ok, I have deleted various patches and changed the summary. I will post a patch in Gonzalo's name shortly. You need the two spkgs from #5823 to make this work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48500",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Attachment [trac_5662.patch](tarball://root/attachments/some-uuid/ticket5662/trac_5662.patch) by @tornaria created at 2009-04-20 01:17:44\n\nFor the record, I had a look and tested the latest version of the patch posted by mabshoff above and it looks and behaves fine for me (when used with the new spkgs from #5823).",
    "created_at": "2009-04-20T01:17:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48501",
    "user": "https://github.com/tornaria"
}
```

<a id='comment:24'></a>Attachment [trac_5662.patch](tarball://root/attachments/some-uuid/ticket5662/trac_5662.patch) by @tornaria created at 2009-04-20 01:17:44
...
```json
{
    "body": "<a id='comment:25'></a>Merged trac_5662.patch in Sage 3.4.1.rc4.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-20T03:46:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48502",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:25'></a>Merged trac_5662.patch in Sage 3.4.1.rc4.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5662",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5662#issuecomment-48503",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
