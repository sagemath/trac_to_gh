...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5179/delete-getslice.patch",
    "created_at": "2009-02-04T18:32:33Z",
    "issue": "https://github.com/sagemath/sage/issues/5179",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5179/delete-getslice.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [delete-getslice.patch](https://github.com/sagemath/sage/files/ticket5179/delete-getslice.patch) by @jasongrout created at 2009-02-04 18:32:33",
    "created_at": "2009-02-04T18:32:33Z",
    "issue": "https://github.com/sagemath/sage/issues/5179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5179#issuecomment-32960",
    "user": "https://github.com/jasongrout"
}
```

Attachment [delete-getslice.patch](https://github.com/sagemath/sage/files/ticket5179/delete-getslice.patch) by @jasongrout created at 2009-02-04 18:32:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5179#issuecomment-32961",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5179#issuecomment-32962",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5179#issuecomment-32963",
