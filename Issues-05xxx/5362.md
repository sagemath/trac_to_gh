...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] bug in transpose for matrix_double_dense",
        "to": "[with patch, positive review] bug in transpose for matrix_double_dense"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5362#event-21074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5362#issuecomment-43983",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5362#issuecomment-43984",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5362",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5362#event-21075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5362#issuecomment-43985",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5362#issuecomment-43986",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5362#event-21076"
}
```
