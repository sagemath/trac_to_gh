...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5655#issuecomment-45336",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Ok, can either one of you add a not to what changed at\n\n  http://wiki.sagemath.org/sage-3.4.1\n\nso that we can point people to that in case they complain?\n\nCheers,\n\nMichael",
    "created_at": "2009-04-15T01:01:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5655#issuecomment-45338",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Ok, can either one of you add a not to what changed at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5655#issuecomment-45339",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5655#issuecomment-45340",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
