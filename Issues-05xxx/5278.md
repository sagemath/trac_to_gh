...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41475",
...
```json
{
    "body": "<a id='comment:6'></a>But it looks like mALLOc might also be a regular function, defined in dlmalloc.c.  And that function calls malloc_extend_top(), which calls MORECORE, which may be defined to be sbrk.",
    "created_at": "2009-02-16T05:20:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41479",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:6'></a>But it looks like mALLOc might also be a regular function, defined in dlmalloc.c.  And that function calls malloc_extend_top(), which calls MORECORE, which may be defined to be sbrk.
...
```json
{
    "body": "<a id='comment:9'></a>Well, one has to patch that other file \"dlmalloc.c\", because in the make run, it is copied over \"omMalloc.c\".",
    "created_at": "2009-02-19T21:29:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41482",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:9'></a>Well, one has to patch that other file "dlmalloc.c", because in the make run, it is copied over "omMalloc.c".
...
```json
{
    "body": "<a id='comment:10'></a>A first quick test did show no difference in behaviour (for the #4181 problem on my MacIntel 32bit). But I am unsure whether I did build the new patched code correctly, resp. whether it was really executed in the end.\n\nThat means I have to instrument the code changes (e.g. printf) and look deeper into where in a library that goes etc.",
    "created_at": "2009-02-20T07:58:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41483",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:10'></a>A first quick test did show no difference in behaviour (for the #4181 problem on my MacIntel 32bit). But I am unsure whether I did build the new patched code correctly, resp. whether it was really executed in the end.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41484",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>An updated python.spkg is now at\n\nhttp://sage.math.washington.edu/home/mabshoff/release-cycles-3.4/alpha0/python-2.5.2.p9.spkg\n\nCheers,\n\nMichael",
    "created_at": "2009-02-24T22:00:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41486",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:13'></a>An updated python.spkg is now at
...
```json
{
    "body": "<a id='comment:14'></a>Looks good.  Great work on this fix!",
    "created_at": "2009-02-24T22:06:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41487",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:14'></a>Looks good.  Great work on this fix!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41488",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41489",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I change the subject of the ticket since this is a followup issue after the libSingular problem was fixed by Georg via another ticket. Credit has been distributed via #3760, #5344 and #4181. Please check in the 3.4.alpha0 release notes that I got it all right :)\n\nCheers,\n\nMichael",
    "created_at": "2009-02-24T22:16:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41490",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>I change the subject of the ticket since this is a followup issue after the libSingular problem was fixed by Georg via another ticket. Credit has been distributed via #3760, #5344 and #4181. Please check in the 3.4.alpha0 release notes that I got it all right :)
...
```json
{
    "body": "<a id='comment:16'></a>Merged in Sage 3.4.alpha0.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-24T22:16:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41491",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:16'></a>Merged in Sage 3.4.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5278#issuecomment-41492",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
