...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55415"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55418"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55419"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55421"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5278#issuecomment-33642",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5278#issuecomment-33643",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55424"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5278#issuecomment-33644",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "title_was": "On modern fedora 64 installs, sage exists frequently when omalloc thinks there is no memory left",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55426"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5278#issuecomment-33645",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55427"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55428"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-55430"
}
```
