...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54392"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54395"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54396"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54397"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54398"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54399"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54402"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54403"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54404"
}
```
...
```json
{
    "body": "<a id='comment:15'>Comment 15:</a>\nThe patch needed a trivial rebase because of my review patch on #4549.\nThe rebased patch should apply cleanly on top of [attachment: ticket:4549:integer_lists_lex-4549-submitted.patch.gz](https://github.com/sagemath/sage/files/ticket5308/de0d2b60ea479ef309df3fe50f5c7bd3.gz) and\n[attachment: ticket:4549:integer_lists_lex-4549-review.patch.gz](https://github.com/sagemath/sage/files/ticket5308/ba161686260e02811a51b0a774dcdfe8.gz)\n\nCheers,\n\nFlorent",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54406"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5308#issuecomment-33957",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54407"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5308#issuecomment-33958",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5308#issuecomment-33959",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54409"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5308",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5308#event-54410"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5308#issuecomment-33960",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5308#issuecomment-33961",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
