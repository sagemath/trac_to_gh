...
```json
{
    "body": "Description changed:\n```diff\n--- \n+++ \n@@ -25,6 +25,28 @@\n False\n \\`\\`\\`\n \n+Also, the restrict_domain() function is broken:\n+\n+\\`\\`\\`\n+sage: V = ZZ^2; phi = V.hom([3*V.0, 2*V.1])\n+sage: phi.restrict_domain(V.span([V.0]))\n+---------------------------------------------------------------------------\n+AttributeError                            Traceback (most recent call last)\n+\n+/Users/wstein/.sage/temp/teragon.local/5779/_Users_wstein__sage_init_sage_0.py in <module>()\n+\n+/Users/wstein/build/sage-3.4.1/local/lib/python2.5/site-packages/sage/modules/matrix_morphism.pyc in restrict_domain(self, sub)\n+    383         D  = self.domain()\n+    384         B  = sub.basis()\n+--> 385         ims= sum([(self(D(b)).coordinate_vector()).list() for b in B],[])\n+    386         \n+    387         MS = matrix.MatrixSpace(self.base_ring(), len(B), self.codomain().rank())\n+\n+AttributeError: 'sage.modules.vector_integer_dense.Vector_integer_d' object has no attribute 'coordinate_vector'\n+\\`\\`\\`\n+\n+DEPENDENCIES: This patch depends on #5886.\n+\n Comment: 1\n \n Summary: major bug in images of homorphisms of R-modules\n```\n",
    "created_at": "2009-04-24T05:32:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47765",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_5887.patch](tarball://root/attachments/some-uuid/ticket5887/trac_5887.patch) by @williamstein created at 2009-04-24 07:03:49\n\nOK, I fixed the patch.",
    "created_at": "2009-04-24T07:03:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47767",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Attachment [trac_5887.patch](tarball://root/attachments/some-uuid/ticket5887/trac_5887.patch) by @williamstein created at 2009-04-24 07:03:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47769",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47770",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_5887-rebased_3.4.2.rc0.2.patch](tarball://root/attachments/some-uuid/ticket5887/trac_5887-rebased_3.4.2.rc0.2.patch) by @williamstein created at 2009-05-02 08:43:57\n\nThis isn't being folded into #5882, and I do not view the \"current situation\" as at all messed up. There are three tickets: \n    #5886, #5887, and #5882.  \n\n#5886 is first, then #5887, then finally #5882.   \n\nI just applied #5886 and this rebased #5887 to my 3.4.2.rc0 tree on sage.math, and \"sage -t devel/sage/sage\" passes all tests.",
    "created_at": "2009-05-02T08:43:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47771",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:7'></a>Attachment [trac_5887-rebased_3.4.2.rc0.2.patch](tarball://root/attachments/some-uuid/ticket5887/trac_5887-rebased_3.4.2.rc0.2.patch) by @williamstein created at 2009-05-02 08:43:57
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [trac_5887-part2-referee_comments.patch](tarball://root/attachments/some-uuid/ticket5887/trac_5887-part2-referee_comments.patch) by @williamstein created at 2009-05-02 22:56:20",
    "created_at": "2009-05-02T22:56:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47773",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>Attachment [trac_5887-part2-referee_comments.patch](tarball://root/attachments/some-uuid/ticket5887/trac_5887-part2-referee_comments.patch) by @williamstein created at 2009-05-02 22:56:20
...
```json
{
    "body": "<a id='comment:11'></a>Merged  trac_5887-rebased_3.4.2.rc0.2.patch and trac_5887-part2-referee_comments.patch in Sage 4.0.alpha0.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-04T16:13:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47774",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged  trac_5887-rebased_3.4.2.rc0.2.patch and trac_5887-part2-referee_comments.patch in Sage 4.0.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5887#issuecomment-47775",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
