...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44737",
...
```json
{
    "body": "Oops. Mea culpa. The quotes were added because I was trying to hunt down some funny behaviour in a doctest which I suspected was because the output of the doctest ended in \"...\", which I suspected conflicted with the use of ... as an abbreviation in example docstring output. It turned out to be something completely different causing the problems, but I forgot to take the quotes out again.\n\nHere is a new patch, without the quotes (and with one small additional change: the tests in bordeaux_2008/generators_for_rings now work, as a consequence of the work I did on find_generators.py, so I've removed the ..skip:: directives in that file.)",
    "created_at": "2009-04-13T09:21:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44738",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44739",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44740",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44741",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44742",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44743",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Hold it, I accidentally introduced a bug (the doctests for supersingular modules fail).",
    "created_at": "2009-04-14T13:09:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44744",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Turns out that the doctests fail as a knock-on effect of #4306: the basis_matrix method fails for SupersingularModules, and the changes I made to the HeckeAlgebra factory function exposed that. The tiny patch trac_5736-3.patch adds a workaround.",
    "created_at": "2009-04-14T14:01:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44745",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44746",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "I have added a new patch that is equivalent to the three patches above combined, rebased to apply over 3.4.2.alpha0. (Isn't the Mercurial Queues add-on wonderful?)",
    "created_at": "2009-04-26T09:09:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44747",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44748",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "I am unable to replicate these failures: it works fine for me both on my laptop (32-bit Linux) and on sage.math.washington.edu. Which system are you using? Could you tell me exactly which doctests are failing, and how?",
    "created_at": "2009-04-27T09:00:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44749",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44752",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Changing back to \"needs work\" for the hashing issue. Just grep the Sage library tree for either `32-bit` or `64-bit` to see how to create 32 and 64 bit specific output.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-30T22:15:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44753",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44754",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44755",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "Here's a tiny patch that addresses the two issues raised by mabshoff.",
    "created_at": "2009-04-30T22:50:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44756",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44757",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44758",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44759",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44760",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "OK, you are right.  Positive review, since when reading the patches everything looks good to me.  Thanks!!",
    "created_at": "2009-05-04T03:48:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44761",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44762",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5736#issuecomment-44763",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5736",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5736#event-13464"
}
```
