...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [congroups.patch](https://github.com/sagemath/sage/files/ticket5180/congroups.patch)\n\nOK, that's the right patch (replacing the old one).",
    "created_at": "2009-02-04T19:10:27Z",
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [5180-arithgroups.patch](https://github.com/sagemath/sage/files/ticket5180/5180-arithgroups.patch)\n\nreplaces previous patch; rebased to 3.4",
    "created_at": "2009-03-23T17:34:46Z",
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
...
**Attachment:** [5180-arithgroups.patch](https://github.com/sagemath/sage/files/ticket5180/5180-arithgroups.patch)
...
archive/attachments_006050.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [5180-patch2.patch](https://github.com/sagemath/sage/files/ticket5180/5180-patch2.patch)\n\nmicro-patch: apply on top of previous patch",
    "created_at": "2009-03-23T18:39:24Z",
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
...
**Attachment:** [5180-patch2.patch](https://github.com/sagemath/sage/files/ticket5180/5180-patch2.patch)
...
archive/attachments_006051.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [5180-patch3-unpickling.patch](https://github.com/sagemath/sage/files/ticket5180/5180-patch3-unpickling.patch)\n\nApply over previous two patches",
    "created_at": "2009-03-25T12:09:34Z",
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
...
**Attachment:** [5180-patch3-unpickling.patch](https://github.com/sagemath/sage/files/ticket5180/5180-patch3-unpickling.patch)
...
archive/attachments_006052.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [5180-patch0.patch](https://github.com/sagemath/sage/files/ticket5180/5180-patch0.patch)\n\nneeded before 5180-arithgroup.patch, only then the latter applies cleanly to Sage-3.4.1.alpha0",
    "created_at": "2009-03-31T17:53:07Z",
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
...
**Attachment:** [5180-patch0.patch](https://github.com/sagemath/sage/files/ticket5180/5180-patch0.patch)
...
archive/attachments_006053.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_5180-patch4-extra-doctests.patch](https://github.com/sagemath/sage/files/ticket5180/trac_5180-patch4-extra-doctests.patch)\n\napply after the other ones and as well after the trac #5520 ones",
    "created_at": "2009-04-01T20:31:28Z",
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
...
**Attachment:** [trac_5180-patch4-extra-doctests.patch](https://github.com/sagemath/sage/files/ticket5180/trac_5180-patch4-extra-doctests.patch)
...
archive/attachments_006054.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:14'></a>\n**Attachment:** [trac_5180-patch5-overconvergent-import-fix.patch](https://github.com/sagemath/sage/files/ticket5180/trac_5180-patch5-overconvergent-import-fix.patch)\n\ntrac_5180-patch5-overconvergent-import-fix.patch is needed to fix the imports for the overconvergent modular forms of genus 0.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-05T01:08:12Z",
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
