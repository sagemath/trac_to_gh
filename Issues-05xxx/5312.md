...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5312#issuecomment-44568",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5312#issuecomment-44569",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5312#issuecomment-44570",
...
```json
{
    "body": "<a id='comment:2'></a>I think we can just mark it as invalid since \"%time\" is now handled by IPython.",
    "created_at": "2013-07-23T12:21:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5312#issuecomment-44571",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>I think we can just mark it as invalid since "%time" is now handled by IPython.
