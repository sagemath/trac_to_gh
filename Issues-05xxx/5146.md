...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20071"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20072"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41804",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] implement MPolynomial_ideal.variety() for GF(p) with p > than what Singular supports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20073"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41805",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41807",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41808",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "rename": {
        "from": "[with patch; needs review] implement MPolynomial_ideal.variety() for GF(p) with p > than what Singular supports",
        "to": "[with patch; needs some work] implement MPolynomial_ideal.variety() for GF(p) with p > than what Singular supports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41809",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41810",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41811",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "rename": {
        "from": "[with patch; needs some work] implement MPolynomial_ideal.variety() for GF(p) with p > than what Singular supports",
        "to": "[with patch; needs review] implement MPolynomial_ideal.variety() for GF(p) with p > than what Singular supports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41812",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41813",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41814",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41815",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] implement MPolynomial_ideal.variety() for GF(p) with p > than what Singular supports",
        "to": "[with patch; positive review] implement MPolynomial_ideal.variety() for GF(p) with p > than what Singular supports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41816",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20077"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20078"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41817",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5146#event-20079"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5146#issuecomment-41818",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
