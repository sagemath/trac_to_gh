...
archive/attachments_007144.json:
```json
{
...
```json
{
    "body": "**Attachment:** [5948-coleman-reduce-forms.patch](https://github.com/sagemath/sage/files/ticket5948/5948-coleman-reduce-forms.patch)",
    "created_at": "2009-05-20T07:43:06Z",
    "issue": "https://github.com/sagemath/sage/issues/5948",
    "type": "issue_comment",
...
**Attachment:** [5948-coleman-reduce-forms.patch](https://github.com/sagemath/sage/files/ticket5948/5948-coleman-reduce-forms.patch)
...
archive/attachments_007145.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:11'></a>\n**Attachment:** [5948-v2.patch](https://github.com/sagemath/sage/files/ticket5948/5948-v2.patch)\n\nHere's a new patch adding the one-line fix to the doctest.",
    "created_at": "2009-05-22T20:48:44Z",
    "issue": "https://github.com/sagemath/sage/issues/5948",
    "type": "issue_comment",
