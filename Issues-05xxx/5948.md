...
```json
{
    "body": "<a id='comment:2'></a>There already seems to be trouble with tiny integrals. Check this out:\n\n```\nsage: R.<x> = QQ['x']\nsage: E= HyperellipticCurve(x^3-4*x+4)\nsage: K = Qp(5,10)\nsage: EK = E.change_ring(K)\nsage: P = EK(2, 2)\nsage: Q = EK.teichmuller(P)\nsage: import sage.schemes.elliptic_curves.monsky_washnitzer as monsky_washnitzer\nsage: M_frob, forms = monsky_washnitzer.matrix_of_frobenius_hyperelliptic(EK)\nsage: f = forms[0]\nsage: u = f.parent().gens()[0]\nsage: u\nx\nsage: u.diff()\n2*y*1 dx/2y\nsage: EK.coleman_integral(-u.diff(), P, Q)\n5 + 5^2 + 5^3 + 2*5^4 + 5^5 + 3*5^6 + 3*5^7 + 4*5^8 + O(5^10) # wrong\nsage: u(Q[0], Q[1]) - u(P[0], P[1])\n5 + 2*5^2 + 5^3 + 3*5^4 + 4*5^5 + 2*5^6 + 3*5^7 + 3*5^9 + O(5^10) # right",
    "created_at": "2009-05-19T05:07:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48322",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:2'></a>There already seems to be trouble with tiny integrals. Check this out:
...
```json
{
    "body": "<a id='comment:3'></a>I think line 65 in hyperelliptic_padic_field:62 should be\n\n```\n            I = sum([f_dt[n]/(n+1) for n in xrange(f_dt.degree()+1)]) # \\int_0^1 f dt\n```\nthough this doesn't solve the issue...",
    "created_at": "2009-05-19T09:41:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48323",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>I think line 65 in hyperelliptic_padic_field:62 should be
...
```json
{
    "body": "<a id='comment:5'></a>Negation bug at #5947",
    "created_at": "2009-05-20T06:43:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48324",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>Negation bug at #5947
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48325",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Also has fix for #5947",
    "created_at": "2009-05-20T07:43:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48326",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:6'></a>Also has fix for #5947
...
```json
{
    "body": "<a id='comment:7'></a>The patch looks good and fixes the problems I had with iterated integrals.",
    "created_at": "2009-05-21T06:06:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48327",
    "user": "https://github.com/jbalakrishnan"
}
```

<a id='comment:7'></a>The patch looks good and fixes the problems I had with iterated integrals.
...
```json
{
    "body": "<a id='comment:9'></a>Thinking about this for a minute: This is probably due to new symbolics, but I am still hesitant to merge this until the symbolics issue is resolved. Once it is the positive review should be reinstated.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-22T14:14:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48329",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Thinking about this for a minute: This is probably due to new symbolics, but I am still hesitant to merge this until the symbolics issue is resolved. Once it is the positive review should be reinstated.
...
```json
{
    "body": "<a id='comment:10'></a>This is unrelated to the new symbolics, and the doctest should be changed. (Here the results is an element of the special hyperelliptic quotient ring, which has sub-optimal but still correct printing for trivial elements.)",
    "created_at": "2009-05-22T19:28:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48330",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:10'></a>This is unrelated to the new symbolics, and the doctest should be changed. (Here the results is an element of the special hyperelliptic quotient ring, which has sub-optimal but still correct printing for trivial elements.)
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [5948-v2.patch](tarball://root/attachments/some-uuid/ticket5948/5948-v2.patch) by @kedlaya created at 2009-05-22 20:48:44\n\nHere's a new patch adding the one-line fix to the doctest.",
    "created_at": "2009-05-22T20:48:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48331",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:11'></a>Attachment [5948-v2.patch](tarball://root/attachments/some-uuid/ticket5948/5948-v2.patch) by @kedlaya created at 2009-05-22 20:48:44
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48332",
    "user": "https://github.com/jbalakrishnan"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Merged in 4.0.1.alpha0.",
    "created_at": "2009-06-01T05:33:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48333",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:13'></a>Merged in 4.0.1.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5948#issuecomment-48334",
    "user": "https://github.com/mwhansen"
}
```
