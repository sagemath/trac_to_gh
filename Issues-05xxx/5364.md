...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5364#issuecomment-42322",
...
```json
{
    "body": "<a id='comment:1'></a>This was fixed by converting symbolic matrices to use Sage's generic dense matrix backend:\n\n```\nsage: m = MatrixSpace(SR, 1000, 1000)\nsage: %time a = m.identity_matrix()\nCPU times: user 0.04 s, sys: 0.00 s, total: 0.04 s\nWall time: 0.04 s\nsage: %time b = a.transpose()\nCPU times: user 0.05 s, sys: 0.01 s, total: 0.06 s\nWall time: 0.06 s\n```",
    "created_at": "2009-06-05T01:35:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5364#issuecomment-42323",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>This was fixed by converting symbolic matrices to use Sage's generic dense matrix backend:
