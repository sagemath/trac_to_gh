...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5416#event-33921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5416",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5416#issuecomment-34875",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5416#event-33922"
}
```
...
```json
{
    "body": "Attachment [misc-doc-fixes-rebased.patch](https://github.com/sagemath/sage/files/ticket5416/misc-doc-fixes-rebased.patch) by cwitty created at 2009-03-03 17:14:39",
    "created_at": "2009-03-03T17:14:39Z",
    "issue": "https://github.com/sagemath/sage/issues/5416",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5416#issuecomment-34876",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

Attachment [misc-doc-fixes-rebased.patch](https://github.com/sagemath/sage/files/ticket5416/misc-doc-fixes-rebased.patch) by cwitty created at 2009-03-03 17:14:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5416",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5416#issuecomment-34877",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5416#event-33923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5416",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5416#issuecomment-34878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5416",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5416#issuecomment-34879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5416#event-33924"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5416",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5416#event-33925"
}
```
