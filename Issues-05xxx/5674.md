...
```json
{
    "body": "Attachment [twist.patch](https://github.com/sagemath/sage/files/ticket5674/twist.patch) by @JohnCremona created at 2009-04-03 11:09:50\n\napply to 3.4.1.apha0 + #4667 patches",
    "created_at": "2009-04-03T11:09:50Z",
    "issue": "https://github.com/sagemath/sage/issues/5674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5674#issuecomment-37261",
    "user": "https://github.com/JohnCremona"
}
```

Attachment [twist.patch](https://github.com/sagemath/sage/files/ticket5674/twist.patch) by @JohnCremona created at 2009-04-03 11:09:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5674#issuecomment-37262",
    "user": "https://github.com/JohnCremona"
}
```
