...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5058#event-19586"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5058#issuecomment-40903",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5058#issuecomment-40904",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5058",
    "rename": {
        "from": "sage -f and sage -i is broken for local files with \".spkg\" elsewhere in the path",
        "to": "[with patch, positive review] sage -f and sage -i is broken for local files with \".spkg\" elsewhere in the path"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5058#event-19587"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5058#issuecomment-40905",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5058",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5058#event-19588"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5058#issuecomment-40906",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
