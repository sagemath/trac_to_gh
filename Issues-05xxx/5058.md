# Issue 5058: [with patch, positive review] sage -f and sage -i is broken for local files with ".spkg" elsewhere in the path
...
```json
{
    ...
    "title": "[with patch, positive review] sage -f and sage -i is broken for local files with \".spkg\" elsewhere in the path",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5058",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5058#event-11659"
}
```
