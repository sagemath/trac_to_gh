...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5368#issuecomment-34358",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5368#issuecomment-34359",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5368#issuecomment-34361",
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [trac_5368-rebased.patch](https://github.com/sagemath/sage/files/ticket5368/trac_5368-rebased.patch) by mabshoff created at 2009-03-05 00:45:59\n\nMerged  trac_5368-rebased.patch in Sage 3.4.rc1.\n\nCheers,\n\nMichael",
    "created_at": "2009-03-05T00:45:59Z",
    "issue": "https://github.com/sagemath/sage/issues/5368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5368#issuecomment-34362",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
