...
```json
{
    "body": "Attachment [installpackage2.patch](https://github.com/sagemath/sage/files/ticket5390/installpackage2.patch) by @simon-king-jena created at 2009-02-27 09:53:55\n\nMake sure that install_package picks the right sage version (sorry, it seems the previous attachment was corrupted)",
    "created_at": "2009-02-27T09:53:55Z",
    "issue": "https://github.com/sagemath/sage/issues/5390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5390#issuecomment-34495",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [installpackage2.patch](https://github.com/sagemath/sage/files/ticket5390/installpackage2.patch) by @simon-king-jena created at 2009-02-27 09:53:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5390#issuecomment-34496",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5390#issuecomment-34497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5390#issuecomment-34498",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5390#issuecomment-34499",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
