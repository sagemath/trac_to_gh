...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] RealIntervalField creates non-unique RealFields",
        "to": "[with patch, with positive review] RealIntervalField creates non-unique RealFields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5446#event-21450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5446#issuecomment-44866",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5446#issuecomment-44867",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5446",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5446#event-21451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5446",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5446#issuecomment-44868",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
