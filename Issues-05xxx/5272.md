...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5272#issuecomment-43035",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5272",
    "rename": {
        "from": "[with patch, needs review] extend sage_input to work with RIF, CIF, AA, and QQbar",
        "to": "[with patch, positive review] extend sage_input to work with RIF, CIF, AA, and QQbar"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5272#event-20666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5272#issuecomment-43036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5272#issuecomment-43037",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5272",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5272#event-20667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5272#issuecomment-43038",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
