...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Improve efficiency of multiplcative_order() for number field elements"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5518#event-21810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5518#issuecomment-45804",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5518#event-21811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5518#issuecomment-45805",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5518",
    "rename": {
        "from": "[with patch, needs review] Improve efficiency of multiplcative_order() for number field elements",
        "to": "[with patch, positive review] Improve efficiency of multiplicative_order() for number field elements"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5518#event-21812"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5518#event-21813"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5518#issuecomment-45806",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5518#issuecomment-45807",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5518",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5518#event-21814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5518#issuecomment-45808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
