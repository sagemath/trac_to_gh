...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5748#issuecomment-48172",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5748#issuecomment-48173",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5748#issuecomment-48174",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5748",
    "rename": {
        "from": "Sage 3.4.1.rc2: isinf() related doctest failure in sage/rings/infinity.py",
        "to": "[with patch, positive review] Sage 3.4.1.rc2: isinf() related doctest failure in sage/rings/infinity.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5748#event-22849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5748#issuecomment-48175",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5748",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5748#event-22850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5748#issuecomment-48176",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
