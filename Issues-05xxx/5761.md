...
{
    "assignees": [],
    "body": "Apply only [attachment:trac_5761-latex_docstrings-ts.patch](https://github.com/sagemath/sage/files/ticket5761/trac_5761-latex_docstrings-ts.patch).\n\n**Assignee:** @rbeezer\n\n**Keywords:** documentation, coverage, latex\n\n**Reviewer:** Andr\u00e9 Apitzsch\n\n**Author:** Travis Scrimshaw\n\n**Merged:** sage-5.7.beta4\n\nIssue created by migration from https://trac.sagemath.org/ticket/5761\n\n",
...
```
Apply only [attachment:trac_5761-latex_docstrings-ts.patch](https://github.com/sagemath/sage/files/ticket5761/trac_5761-latex_docstrings-ts.patch).
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56441"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56442"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56443"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5761#issuecomment-37855",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5761#issuecomment-37856",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56444"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5761#issuecomment-37857",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56450"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1 +1 @@\n-\n+Apply only [attachment:trac_5791-latex_docstrings-ts.patch](https://github.com/sagemath/sage/files/ticket5761/trac_5791-latex_docstrings-ts.patch).\n``````\n",
    "created_at": "2013-02-05T23:16:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5761",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56453"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5761",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5761#event-56454"
}
```
