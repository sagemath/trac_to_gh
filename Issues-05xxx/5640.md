...
<a id='comment:1'></a>Attachment [trac_5640.patch](tarball://root/attachments/some-uuid/ticket5640/trac_5640.patch) by @kcrisman created at 2009-06-20 01:16:31
...
<a id='comment:2'></a>Some hunk failures when applied against Sage 4.1.alpha0:
...
<a id='comment:4'></a>Attachment [trac_5640-rebased.patch](tarball://root/attachments/some-uuid/ticket5640/trac_5640-rebased.patch) by mvngu created at 2009-06-26 00:10:25
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -12,7 +12,6 @@\n \n ```\n sage: matrix(QQ,1,1).plot(cmap0=0)\n-          \t\n \n verbose 0 (84: primitive.py, options) WARNING: Ignoring option 'cmap0'=0\n verbose 0 (84: primitive.py, options) \n@@ -23,8 +22,6 @@\n     zorder         The layer level in which to draw                     \n ```\n \n-Assignee: @williamstein\n-\n Summary: no way to figure out list of colormaps from matrix plot's docstring\n \n Issue created by migration from https://trac.sagemath.org/ticket/5640\n``````\n",
