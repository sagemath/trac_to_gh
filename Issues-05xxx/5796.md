...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49861",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Please delete the .2.patch file.",
    "created_at": "2009-04-16T03:30:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49862",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>Please delete the .2.patch file.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49863",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Robert and Robert: could one or both of you review this?  Thanks!",
    "created_at": "2009-04-16T03:30:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49864",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>Robert and Robert: could one or both of you review this?  Thanks!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49865",
...
```json
{
    "body": "<a id='comment:5'></a>BTW, followup at #5800",
    "created_at": "2009-04-16T05:04:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49866",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>BTW, followup at #5800
...
```json
{
    "body": "<a id='comment:7'></a>3.4.2 is fine, we need to get 3.4.1 out (I'm getting ready to assemble the release notes for Cython right now :). No, I didn't valgrind it. \n\nThe old functions are still there in the \"Aliases for functions\" section. (I don't think any got removed...) Actually, I would be happier if the aliases were placed right next to the implementations, rather than elsewhere.",
    "created_at": "2009-04-16T06:12:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49868",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>3.4.2 is fine, we need to get 3.4.1 out (I'm getting ready to assemble the release notes for Cython right now :). No, I didn't valgrind it. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49871",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Thanks, looks good.",
    "created_at": "2009-04-16T07:46:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49873",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:12'></a>Thanks, looks good.
...
```json
{
    "body": "<a id='comment:14'></a>Okay, so we have one strong vote against deprecation (rlm), one mild vote against deprecation (me---I think both ways are equally valid ways to think about it), and some not-sure-how-to-count votes.  Sounds like we keep two interfaces, which I think is great.\n\nrlm, seeing your feelings, I apologize for changing all of the partitioning code to use symmetric_difference instead of xor.  I'll change it back.  How about I revert the patch so that it just makes the following changes in the groups/perm_gps/partn_ref/*.pyx and coding/binary_code.pyx:\n\nbitset_clear -> bitset_free\n\nbitset_zero -> bitset_clear\n\nWill that make you happier?",
    "created_at": "2009-04-16T17:27:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49875",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:14'></a>Okay, so we have one strong vote against deprecation (rlm), one mild vote against deprecation (me---I think both ways are equally valid ways to think about it), and some not-sure-how-to-count votes.  Sounds like we keep two interfaces, which I think is great.
...
```json
{
    "body": "<a id='comment:15'></a>In fact, how about just the following change:\n\nbitset_clear -> bitset_free\n\n(so that we can use clear() the way python sets use it)\n\nI'll leave bitset_zero alone.",
    "created_at": "2009-04-16T17:28:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49876",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:15'></a>In fact, how about just the following change:
...
```json
{
    "body": "<a id='comment:16'></a>I definitely like the use of the word \"free\" there. It's more obvious that you're deallocating.\n\nI'm happy with less changes in partn_ref. Thanks for offering to do that.",
    "created_at": "2009-04-16T17:31:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49877",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:16'></a>I definitely like the use of the word "free" there. It's more obvious that you're deallocating.
...
```json
{
    "body": "<a id='comment:18'></a>I was just writing a comment to that effect. I think we should definitely keep the xor, etc. methods around (somehow I missed that you were going to get rid of them). \n\nI reaffirm my positive review, and think it's even better now.",
    "created_at": "2009-04-16T19:04:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49879",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:18'></a>I was just writing a comment to that effect. I think we should definitely keep the xor, etc. methods around (somehow I missed that you were going to get rid of them). 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49880",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49882",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Moving to 3.4.2 now that it has a positive review to keep things cleaner.",
    "created_at": "2009-04-27T17:04:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49884",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:23'></a>Moving to 3.4.2 now that it has a positive review to keep things cleaner.
...
```json
{
    "body": "<a id='comment:24'></a>Unfortunately with both patches applied on sage.math I get one doctest failure in \n\n```\nsage -t -long devel/sage/sage/misc/misc_c.pyx\n```\n\nCheers,\n\nMichael",
    "created_at": "2009-04-30T02:11:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49885",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:24'></a>Unfortunately with both patches applied on sage.math I get one doctest failure in 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49886",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Attachment [64-bit-doctest.patch](tarball://root/attachments/some-uuid/ticket5796/64-bit-doctest.patch) by @jasongrout created at 2009-05-06 04:12:44\n\nThe 64-bit-doctest.patch addresses the doctest failure on 64-bit machines.",
    "created_at": "2009-05-06T04:12:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49887",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:25'></a>Attachment [64-bit-doctest.patch](tarball://root/attachments/some-uuid/ticket5796/64-bit-doctest.patch) by @jasongrout created at 2009-05-06 04:12:44
...
```json
{
    "body": "<a id='comment:26'></a>Ok, positive review for 64-bit-doctest.patch resulting in a combined positive review.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-06T04:23:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49888",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:26'></a>Ok, positive review for 64-bit-doctest.patch resulting in a combined positive review.
...
```json
{
    "body": "<a id='comment:27'></a>Merged all three patches in Sage 4.0.alpha0.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-11T11:41:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49889",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:27'></a>Merged all three patches in Sage 4.0.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5796#issuecomment-49890",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
