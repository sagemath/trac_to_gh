...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5303#issuecomment-43396",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5303#issuecomment-43397",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "rename": {
        "from": "Sage 3.3.rc2: numerical noise in sage/schemes/elliptic_curves/sha_tate.py",
        "to": "[with patch, needs review] Sage 3.3.rc2: numerical noise in sage/schemes/elliptic_curves/sha_tate.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5303#event-20810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5303#issuecomment-43398",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5303#issuecomment-43399",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "rename": {
        "from": "[with patch, needs review] Sage 3.3.rc2: numerical noise in sage/schemes/elliptic_curves/sha_tate.py",
        "to": "[with patch,positive review] Sage 3.3.rc2: numerical noise in sage/schemes/elliptic_curves/sha_tate.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5303#event-20811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5303#issuecomment-43400",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5303#event-20812"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5303#issuecomment-43401",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5303#issuecomment-43402",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
