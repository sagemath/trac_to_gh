...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58166"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58167"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58168"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58169"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58170"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58172"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58173"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **@mmasdeu**",
...
Changed assignee from **@williamstein** to **@mmasdeu**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58175"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58176"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5612#issuecomment-36761",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5612#issuecomment-36762",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58180"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58182"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5612#issuecomment-36763",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58183"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58186"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5612#issuecomment-36764",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-58188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5612#issuecomment-36765",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5612#issuecomment-36766",
    "user": "https://github.com/jdemeyer"
}
```
