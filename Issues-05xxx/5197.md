...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60712"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60714"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60715"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60716"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5197#issuecomment-31869",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5197",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5197#issuecomment-31870",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60720"
}
```
