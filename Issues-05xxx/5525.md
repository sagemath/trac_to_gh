...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_5525.patch](tarball://root/attachments/some-uuid/ticket5525/trac_5525.patch) by @williamstein created at 2009-03-15 08:22:26",
...
<a id='comment:1'></a>Attachment [trac_5525.patch](tarball://root/attachments/some-uuid/ticket5525/trac_5525.patch) by @williamstein created at 2009-03-15 08:22:26
...
<a id='comment:3'></a>This patch causes a massive number of failures:
...
```json
{
    "body": "<a id='comment:4'></a>This has been fixed via the patch at #5520.\n\nCheers,\n\nMichael",
...
<a id='comment:4'></a>This has been fixed via the patch at #5520.
