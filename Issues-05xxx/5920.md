...
<a id='comment:6'></a>Replying to [was](#comment%3A4):
> It should be 
> 
> ```
> sage: view(object, viewer='pdf')
...
<a id='comment:20'></a>Replying to [nthiery](#comment%3A15):
