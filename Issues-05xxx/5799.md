...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket5799/trac_5799_ext_sageicon.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket5799/trac_5799_sage_jsmath_doc_alt.patch",
...
```json
{
    "body": "Somewhat less efficient alternative to trac_5799_sage_jsmath_doc.patch.",
    "created_at": "2009-04-16T08:23:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5799",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket5799/trac_5799_sage_jsmath_doc_v2.patch",
...
```json
{
    "body": "Better cross-browser favicon support, auto relative paths. Apply trac_5799_ext_icons_v2.patch first.",
    "created_at": "2009-06-10T09:26:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5799",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket5799/trac_5799_manifest.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket5799/trac_5799-redux_setup_py.patch",
