...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42521",
    "user": "https://trac.sagemath.org/admin/accounts/users/sbarthelemy"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [remove_union.diff](tarball://root/attachments/some-uuid/ticket5117/remove_union.diff) by mhampton created at 2009-01-28 16:01:07\n\nI disagree that this should be removed.  I created it because I use it!\n\nI think the docstring makes it pretty clear what it does, but I do not object to renaming it.  Perhaps union_of_vertices? Or union_by_vertices?\n\nMarshall",
    "created_at": "2009-01-28T16:01:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42522",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:1'></a>Attachment [remove_union.diff](tarball://root/attachments/some-uuid/ticket5117/remove_union.diff) by mhampton created at 2009-01-28 16:01:07
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42523",
    "user": "https://trac.sagemath.org/admin/accounts/users/sbarthelemy"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Renaming in convex_hull is fine with me.  The extension to rays is a good idea.",
    "created_at": "2009-01-28T16:36:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42524",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:3'></a>Renaming in convex_hull is fine with me.  The extension to rays is a good idea.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42525",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42527",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>So we could make a convex_hull method and deprecate the union function.  To make a union function in the sense that you and sbarthelemy want, I think we need to make some sort of PolyhedralUnion class to do computations on such objects.",
    "created_at": "2010-04-03T19:05:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42528",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:6'></a>So we could make a convex_hull method and deprecate the union function.  To make a union function in the sense that you and sbarthelemy want, I think we need to make some sort of PolyhedralUnion class to do computations on such objects.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42529",
...
```json
{
    "body": "<a id='comment:7'></a>Patch renames `self.union()` to `self.convex_hull()` and improves the handling of the underlying field for various operations, for example\n\n```\nsage: triangle = Polyhedron(vertices=[[1,0],[0,1],[-1,-1]])\nsage: (1 * triangle).field()\nRational Field\nsage: (1.0 * triangle).field()\nReal Double Field\n```",
    "created_at": "2010-05-09T14:12:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42530",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:7'></a>Patch renames `self.union()` to `self.convex_hull()` and improves the handling of the underlying field for various operations, for example
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42531",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42532",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42533",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_5117_reviewer_docfixes.patch](tarball://root/attachments/some-uuid/ticket5117/trac_5117_reviewer_docfixes.patch) by @novoselt created at 2010-05-09 15:45:03\n\nLooks good to me. I have renamed the original patch file to include the ticket number and its description. On top of that I have made the documentation look nicer and added a message to the TyperError exception. Passes all doctests, so I am giving this a positive review.\n\nMy only concern is whether or not we need to use some framework for deprecating functions or what is done for \"union\" is enough.",
    "created_at": "2010-05-09T15:45:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42534",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:8'></a>Attachment [trac_5117_reviewer_docfixes.patch](tarball://root/attachments/some-uuid/ticket5117/trac_5117_reviewer_docfixes.patch) by @novoselt created at 2010-05-09 15:45:03
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42535",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42536",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42537",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42538",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5117#issuecomment-42539",
    "user": "https://github.com/mwhansen"
}
```
