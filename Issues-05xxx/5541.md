...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47117",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_5541-docstring-fixes.patch](tarball://root/attachments/some-uuid/ticket5541/trac_5541-docstring-fixes.patch) by mvngu created at 2009-03-17 04:46:39\n\nThe patch **trac_5541-docstring-fixes.patch** fixes some more docstring formatting problems in `sage/algebras/quaternion_algebra.py`. It also resolves this indentation warning:\n\n```\nWARNING: <autodoc>:0: (ERROR/3) Unexpected indentation.\n```\nwhich I received after applying the patch for ticket #5531 and building the reference manual.",
    "created_at": "2009-03-17T04:46:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47118",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:1'></a>Attachment [trac_5541-docstring-fixes.patch](tarball://root/attachments/some-uuid/ticket5541/trac_5541-docstring-fixes.patch) by mvngu created at 2009-03-17 04:46:39
...
```json
{
    "body": "<a id='comment:2'></a>I should mention that this ticket depends on #5531.",
    "created_at": "2009-03-17T04:57:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47119",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:2'></a>I should mention that this ticket depends on #5531.
...
```json
{
    "body": "<a id='comment:3'></a>Looks good to me except for two very minor issues, which are taken care of in the referee's patch.\n\n(By the way, see #5632 for a somewhat related ticket.)",
    "created_at": "2009-03-29T16:27:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47120",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Looks good to me except for two very minor issues, which are taken care of in the referee's patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47121",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47122",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Please see [my most recent comment on #5632](http://trac.sagemath.org/sage_trac/ticket/5632#comment:6) for a reference manual issue which is also relevant here.",
    "created_at": "2009-03-31T15:40:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47124",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>Please see [my most recent comment on #5632](http://trac.sagemath.org/sage_trac/ticket/5632#comment:6) for a reference manual issue which is also relevant here.
...
```json
{
    "body": "<a id='comment:7'></a>Here's a rebased version, plus more.  This includes all of mvngu's work, so he should obviously get a lot of credit for this; this covers the file up to line 700 or so. #5520 added a lot of code to this file with many of the same issues, so starting at line 741, there are new fixes.",
    "created_at": "2009-04-01T02:54:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47125",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>Here's a rebased version, plus more.  This includes all of mvngu's work, so he should obviously get a lot of credit for this; this covers the file up to line 700 or so. #5520 added a lot of code to this file with many of the same issues, so starting at line 741, there are new fixes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47126",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>mvngu: the first half of my patch is just a rebased version of yours, and it already has a positive review.  If you are willing to review the second half, then that should do it for this ticket.",
    "created_at": "2009-04-05T22:48:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47127",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>mvngu: the first half of my patch is just a rebased version of yours, and it already has a positive review.  If you are willing to review the second half, then that should do it for this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47128",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47129",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47130",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Oh, and mabshoff: this should fix the warnings for this file when building the reference manual.",
    "created_at": "2009-04-17T03:25:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47131",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>Oh, and mabshoff: this should fix the warnings for this file when building the reference manual.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47132",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Ok, this should go into 3.4.1.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-17T06:14:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47133",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:14'></a>Ok, this should go into 3.4.1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47134",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Merged  5541-rebased.patch and 5541-second.patch in Sage 3.4.1.rc4.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-18T01:07:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5541#issuecomment-47135",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>Merged  5541-rebased.patch and 5541-second.patch in Sage 3.4.1.rc4.
