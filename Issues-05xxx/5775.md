...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68639"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5775#issuecomment-36672",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68644"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68645"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5775#issuecomment-36673",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5775#issuecomment-36674",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5775",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5775#event-68646"
}
```
