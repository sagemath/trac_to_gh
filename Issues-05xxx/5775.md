...
```json
{
    "body": "<a id='comment:1'></a>To reproduce this: **-bdist**, unpack in some other place, run **make** -> **boom**.\n\nNote that deleting the output directory and restarting **make** gets past this problem.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-13T08:24:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5775#issuecomment-49521",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>To reproduce this: **-bdist**, unpack in some other place, run **make** -> **boom**.
...
```json
{
    "body": "<a id='comment:2'></a>I don't care too much about this, so I am bumping it to 3.4.2 for now.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-17T22:54:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5775#issuecomment-49522",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>I don't care too much about this, so I am bumping it to 3.4.2 for now.
...
```json
{
    "body": "<a id='comment:3'></a>I don't see this problem any more. The process of \"-bdist\", unpack at a different directory, then run \"make\" works for me with Sage 4.3.2.alpha1. I'm closing this as fixed.",
    "created_at": "2010-02-02T23:50:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5775#issuecomment-49523",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:3'></a>I don't see this problem any more. The process of "-bdist", unpack at a different directory, then run "make" works for me with Sage 4.3.2.alpha1. I'm closing this as fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5775#issuecomment-49524",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5775#issuecomment-49525",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
