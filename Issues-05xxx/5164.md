...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5164#issuecomment-42057",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5164",
    "rename": {
        "from": "NTL.spkg: Set SHAREDFALGS to -fnocommon on Darwin",
        "to": "[with spkg, needs review] NTL.spkg: Set SHAREDFALGS to -fnocommon on Darwin"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5164#event-20152"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5164#issuecomment-42058",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5164",
    "rename": {
        "from": "[with spkg, needs review] NTL.spkg: Set SHAREDFALGS to -fnocommon on Darwin",
        "to": "[with spkg, positive review] NTL.spkg: Set SHAREDFALGS to -fnocommon on Darwin"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5164#event-20153"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5164#issuecomment-42059",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5164#issuecomment-42060",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5164#issuecomment-42061",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5164",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5164#event-20154"
}
```
