...
archive/attachments_006759.json:
```json
{
...
archive/attachments_006760.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac5705_doctest.patch](https://github.com/sagemath/sage/files/ticket5705/trac5705_doctest.patch)\n\nMerged both patches in Sage 3.4.1.rc2. Thanks Alex.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-09T08:45:36Z",
    "issue": "https://github.com/sagemath/sage/issues/5705",
    "type": "issue_comment",
