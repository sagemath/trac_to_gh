...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5040#issuecomment-40747",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5040#issuecomment-40748",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, needs review] NTL's DoConfig errors out when NTL is build with dependencies in a directory containing [-h|help|-help|--help]"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5040#event-19516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5040",
    "rename": {
        "from": "[with spkg, needs review] NTL's DoConfig errors out when NTL is build with dependencies in a directory containing [-h|help|-help|--help]",
        "to": "[with spkg, positive review] NTL's DoConfig errors out when NTL is build with dependencies in a directory containing [-h|help|-help|--help]"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5040#event-19517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5040#issuecomment-40749",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5040#issuecomment-40750",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5040#issuecomment-40751",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5040",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5040#event-19518"
}
```
