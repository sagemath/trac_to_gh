...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43749",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Nicolas is rewiewing it rigth there. I currently taking case of its remark.",
    "created_at": "2009-02-12T18:39:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43750",
    "user": "https://github.com/hivert"
}
```

<a id='comment:1'></a>Nicolas is rewiewing it rigth there. I currently taking case of its remark.
...
```json
{
    "body": "<a id='comment:2'></a>I modified my patch according to Nicolas remarks. I took the occasion to adapt this patch to the design change of patch #5255.",
    "created_at": "2009-02-13T16:25:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43751",
    "user": "https://github.com/hivert"
}
```

<a id='comment:2'></a>I modified my patch according to Nicolas remarks. I took the occasion to adapt this patch to the design change of patch #5255.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43752",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43753",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43754",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The patch is now rebased an finalized. Ready for review. \n\nFlorent",
    "created_at": "2009-04-05T16:51:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43755",
    "user": "https://github.com/hivert"
}
```

<a id='comment:5'></a>The patch is now rebased an finalized. Ready for review. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43756",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [non_decreasing_parking_function-5243-submitted.patch](tarball://root/attachments/some-uuid/ticket5243/non_decreasing_parking_function-5243-submitted.patch) by @nthiery created at 2009-04-14 02:14:33",
    "created_at": "2009-04-14T02:14:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43757",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:6'></a>Attachment [non_decreasing_parking_function-5243-submitted.patch](tarball://root/attachments/some-uuid/ticket5243/non_decreasing_parking_function-5243-submitted.patch) by @nthiery created at 2009-04-14 02:14:33
...
```json
{
    "body": "<a id='comment:7'></a>Florent, I'm working on reviewing this, and I already see a bunch of things in the docstrings that I'd like changed -- these range from grammar and usage changes to different formatting suggestions. Would you like me to list all the changes, and have you edit the patch, or should I upload a \"referee patch\" that changes the bits I'd like changed?\n\nBTW, I can already say that you've got some lovely ASCII art in your docstrings!",
    "created_at": "2009-04-16T08:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43758",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:7'></a>Florent, I'm working on reviewing this, and I already see a bunch of things in the docstrings that I'd like changed -- these range from grammar and usage changes to different formatting suggestions. Would you like me to list all the changes, and have you edit the patch, or should I upload a "referee patch" that changes the bits I'd like changed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43759",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I uploaded my documentation fixes patch, since there's no reason to keep it secret; it only fixes docstring bits (mostly it changes \"non decreasing\" to \"non-decreasing\" :) except in three places:\n\n* changes two \"`assert(foo)`\" statements to \"`assert foo, 'what went wrong'`\"\n* changes the `is_a()` function as I described above. If the consensus is that we should keep it the way it was, I have no problem removing this change from my patch.",
    "created_at": "2009-05-06T04:26:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43761",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:10'></a>I uploaded my documentation fixes patch, since there's no reason to keep it secret; it only fixes docstring bits (mostly it changes "non decreasing" to "non-decreasing" :) except in three places:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43762",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43763",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43764",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Dan's changes look good to me, and I've added a patch which switches the behavior of __getitem__.  I think with these, it can go in.  Dan, do you want to sign off on the rest?",
    "created_at": "2009-09-26T04:19:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43765",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:11'></a>Dan's changes look good to me, and I've added a patch which switches the behavior of __getitem__.  I think with these, it can go in.  Dan, do you want to sign off on the rest?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43766",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Looks good to me. Positive review. I think this will have to wait for 4.1.3, since 4.1.2 is now in feature freeze.",
    "created_at": "2009-09-28T02:46:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43767",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:12'></a>Looks good to me. Positive review. I think this will have to wait for 4.1.3, since 4.1.2 is now in feature freeze.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43768",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Merged all 3 patches.",
    "created_at": "2009-10-15T07:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43769",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:14'></a>Merged all 3 patches.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5243#issuecomment-43770",
    "user": "https://github.com/mwhansen"
}
```
