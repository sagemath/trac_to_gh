...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5703#issuecomment-37414",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5703/trac_5703.patch",
    "created_at": "2009-04-07T17:18:52Z",
    "issue": "https://github.com/sagemath/sage/issues/5703",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5703/trac_5703.patch",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_5703.patch](https://github.com/sagemath/sage/files/ticket5703/trac_5703.patch) by @jaapspies created at 2009-04-07 17:18:52\n\nLooking at the code this patch looks ok.\n\nIt applies cleanly.\n\nTested this on my Fedora installs. Don't know whether this qualifies as a positive review :)\n\nJaap",
    "created_at": "2009-04-07T17:18:52Z",
    "issue": "https://github.com/sagemath/sage/issues/5703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5703#issuecomment-37415",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5703#issuecomment-37416",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5703#event-36251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5703#issuecomment-37417",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5703#event-36252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5703",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5703#event-36253"
}
```
