...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51086",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51087",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>NOTE: trac_5882-part2.patch (which I'll post soon) fixes numerous *major* bugs in matrix_morphism.py, e.g., in restrict_domain and restrict_codomain.  I noticed these issues while reading the code and thinking about what it did...",
    "created_at": "2009-05-01T01:01:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51088",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>NOTE: trac_5882-part2.patch (which I'll post soon) fixes numerous *major* bugs in matrix_morphism.py, e.g., in restrict_domain and restrict_codomain.  I noticed these issues while reading the code and thinking about what it did...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51089",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>This is likely ready for review, but I want to do some additional testing before labeling it as such.",
    "created_at": "2009-05-02T09:16:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51090",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>This is likely ready for review, but I want to do some additional testing before labeling it as such.
...
```json
{
    "body": "<a id='comment:8'></a>I've changed this back to \"not ready for review\", since I think it's more likely to be higher quality code if I implement something nontrivial on top of it first, and fix any issues I find.  So I'm doing #5969 first.   Once that's done and I fixed all issues that crop up, then #5882 will be ready for review.",
    "created_at": "2009-05-03T06:06:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51091",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>I've changed this back to "not ready for review", since I think it's more likely to be higher quality code if I implement something nontrivial on top of it first, and fix any issues I find.  So I'm doing #5969 first.   Once that's done and I fixed all issues that crop up, then #5882 will be ready for review.
...
```json
{
    "body": "<a id='comment:9'></a>The one remaining problem: Some of the bug fixes in linear algebra included in this patch (or possibly, but unlikely, the dependency patches), cause a serious performance regression:\n\nIN SAGE-3.4.1:\n\n```\nsage: time EllipticCurve('858k2').sha().an_padic(Integer(7))\nCPU times: user 8.65 s, sys: 0.37 s, total: 9.02 s\n```\n\nAfter these patches the same takes much much longer (many minutes).  Using `set_verbose(2)` one sees that the codepaths are different.\n\nIt's not surprising that fixing bugs would uncover other buggy code and major performance issues, since buggy code is often very fast :-).",
    "created_at": "2009-05-04T14:27:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51092",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>The one remaining problem: Some of the bug fixes in linear algebra included in this patch (or possibly, but unlikely, the dependency patches), cause a serious performance regression:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51093",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>With these patches and dependencies installed, make ptestlong:\n\n```\nAll tests passed!\nTimings have been updated.\nTotal time for all tests: 331.9 seconds\nwstein@sage:~/build/sage-3.4.2.rc0$ \n```",
    "created_at": "2009-05-04T15:31:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51094",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>With these patches and dependencies installed, make ptestlong:
...
```json
{
    "body": "<a id='comment:13'></a>Any chance you could combine the 7 (!) patches into one?  That will make it a lot easier to read & judge, and to apply, of course!",
    "created_at": "2009-05-06T21:27:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51096",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:13'></a>Any chance you could combine the 7 (!) patches into one?  That will make it a lot easier to read & judge, and to apply, of course!
...
```json
{
    "body": "<a id='comment:14'></a>> Any chance you could combine the 7 (!) patches into one? That will make it a \n> lot easier to read & judge, and to apply, of course! \n\n\nYes, I will, when it is ready for review.\n\nAlso, I'll rename the V, W methods to cover and relations, with C() and R() as aliases.",
    "created_at": "2009-05-06T23:32:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51097",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:14'></a>> Any chance you could combine the 7 (!) patches into one? That will make it a 
> lot easier to read & judge, and to apply, of course! 
...
```json
{
    "body": "<a id='comment:17'></a>I like what I see in this patch. Especially the ability to lift an element of a quotient. Using this, one can create the long exact sequence associated to an exact sequence of chain complexes.",
    "created_at": "2009-05-21T04:31:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51098",
    "user": "https://github.com/antieau"
}
```

<a id='comment:17'></a>I like what I see in this patch. Especially the ability to lift an element of a quotient. Using this, one can create the long exact sequence associated to an exact sequence of chain complexes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51099",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>OK, this should get reviewed.  I think it's probably quite *slow* right now -- I make no claims to speed at all.  But as far as I know it is right.",
    "created_at": "2009-06-18T23:38:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51100",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:18'></a>OK, this should get reviewed.  I think it's probably quite *slow* right now -- I make no claims to speed at all.  But as far as I know it is right.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51101",
...
```json
{
    "body": "<a id='comment:19'></a>Since underscore methods don't show up under ReST documentation, I think all the documentation which falls under `__init__` methods should be either moved or copied to the class level documentation.",
    "created_at": "2009-06-19T09:31:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51102",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:19'></a>Since underscore methods don't show up under ReST documentation, I think all the documentation which falls under `__init__` methods should be either moved or copied to the class level documentation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51103",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Some typos maybe: Should \"optimization representation\" be \"optimized representation?\"",
    "created_at": "2009-06-19T09:55:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51104",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:20'></a>Some typos maybe: Should "optimization representation" be "optimized representation?"
...
```json
{
    "body": "<a id='comment:21'></a>Applied to Sage-4.0.2, all doctests pass with `-long`.",
    "created_at": "2009-06-19T17:29:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51105",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:21'></a>Applied to Sage-4.0.2, all doctests pass with `-long`.
...
```json
{
    "body": "<a id='comment:23'></a>Replying to [was](#comment%3A14):\n>\n> Also, I'll rename the V, W methods to cover and relations, with C() and R() as aliases.\n> \n\n\nIt looks like this didn't happen...",
    "created_at": "2009-06-19T17:58:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51107",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>Replying to [was](#comment%3A14):
>
> Also, I'll rename the V, W methods to cover and relations, with C() and R() as aliases.
> 
...
```json
{
    "body": "<a id='comment:24'></a>OK, and how about lowercase c and r instead of uppercase?",
    "created_at": "2009-06-19T18:00:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51108",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:24'></a>OK, and how about lowercase c and r instead of uppercase?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51110",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>> OK, and how about lowercase c and r instead of uppercase? \n\n\nI don't like that more, because they are modules.  In mathematics, modules are usually upper case and *elements* of modules are lower case.",
    "created_at": "2009-06-20T10:19:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51112",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:27'></a>> OK, and how about lowercase c and r instead of uppercase? 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51113",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51115",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51117",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Replying to [rlm](#comment%3A31):\n> \n> To my understanding, it is the lack of an implementation of Hermite normal form for general PIDs.\n\n\nWe have this now -- see ticket #6178.",
    "created_at": "2009-06-22T06:59:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51118",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:32'></a>Replying to [rlm](#comment%3A31):
> 
> To my understanding, it is the lack of an implementation of Hermite normal form for general PIDs.
...
```json
{
    "body": "<a id='comment:34'></a>(sorry, there is a ZZ missing in the second line of the example, I cut + pasted wrongly)",
    "created_at": "2009-06-23T17:36:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51120",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:34'></a>(sorry, there is a ZZ missing in the second line of the example, I cut + pasted wrongly)
...
```json
{
    "body": "<a id='comment:36'></a>OK, I've now read the docstrings and it looks like that was the intended behaviour; but I really don't like the idea of Z/6 being a submodule of Z/3. I suggest we have a new method called something like \"maps_into\" which does what \"is_submodule\" previously did, and reserve \"is_submodule\" for cases where the obvious map both exists and is injective.",
    "created_at": "2009-06-24T09:34:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51122",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:36'></a>OK, I've now read the docstrings and it looks like that was the intended behaviour; but I really don't like the idea of Z/6 being a submodule of Z/3. I suggest we have a new method called something like "maps_into" which does what "is_submodule" previously did, and reserve "is_submodule" for cases where the obvious map both exists and is injective.
...
```json
{
    "body": "<a id='comment:41'></a>Great, that all makes sense.  For annihilator, then, you could the docstring from \"Return the ideal\" to \"Return the generator of the ideal\".",
    "created_at": "2009-07-01T14:48:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51127",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:41'></a>Great, that all makes sense.  For annihilator, then, you could the docstring from "Return the ideal" to "Return the generator of the ideal".
...
```json
{
    "body": "<a id='comment:42'></a>Attachment [trac_5882-additions.patch](tarball://root/attachments/some-uuid/ticket5882/trac_5882-additions.patch) by @loefflerd created at 2009-07-02 12:49:09\n\nI've uploaded a new patch taking into account John's suggestions.",
    "created_at": "2009-07-02T12:49:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51128",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:42'></a>Attachment [trac_5882-additions.patch](tarball://root/attachments/some-uuid/ticket5882/trac_5882-additions.patch) by @loefflerd created at 2009-07-02 12:49:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51130",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51131",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51133",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51134",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>Attachment [trac_5882-all-in-one.patch](tarball://root/attachments/some-uuid/ticket5882/trac_5882-all-in-one.patch) by @rlmill created at 2009-07-02 22:15:52\n\nThere is one doctest failure:\n\n```\nsage -t  sage/modules/fg_pid/fgp_module.py\n**********************************************************************\nFile \"/space/rlm/sage-4.1.alpha3/devel/sage-main/sage/modules/fg_pid/fgp_module.py\", line 1453:\n    sage: hash(A)\nExpected nothing\nGot:\n    -7071641102956720018\n**********************************************************************\n```",
    "created_at": "2009-07-02T22:15:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51135",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:45'></a>Attachment [trac_5882-all-in-one.patch](tarball://root/attachments/some-uuid/ticket5882/trac_5882-all-in-one.patch) by @rlmill created at 2009-07-02 22:15:52
...
```json
{
    "body": "<a id='comment:46'></a>Sorry, that's what I get for only doctesting on a 32-bit machine.  Here's a patch.",
    "created_at": "2009-07-02T22:37:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51136",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:46'></a>Sorry, that's what I get for only doctesting on a 32-bit machine.  Here's a patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51137",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51139",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5882#issuecomment-51140",
    "user": "https://github.com/rlmill"
}
```
