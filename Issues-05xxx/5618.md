...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58228"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58229"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58233"
}
```
...
```json
{
    "body": "Changed keywords from **** to **gap interface cyclotomic field**",
    "created_at": "2010-07-04T18:46:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_comment",
...
Changed keywords from **** to **gap interface cyclotomic field**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5618#issuecomment-36793",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5618#issuecomment-36794",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5618#issuecomment-36795",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5618#issuecomment-36796",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5618#issuecomment-36797",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5618#issuecomment-36798",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5618",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5618#event-58241"
}
```
