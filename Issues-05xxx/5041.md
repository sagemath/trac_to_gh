...
```json
{
    ...
    "rename": {
        "from": "make it so the magma .sig files in extcode don't get written there by magma",
        "to": "[with patch; needs review] make it so the magma .sig files in extcode don't get written there by magma"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5041#event-19519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5041#issuecomment-40752",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5041#issuecomment-40753",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5041",
    "rename": {
        "from": "[with patch; needs review] make it so the magma .sig files in extcode don't get written there by magma",
        "to": "[with patch; positive review] make it so the magma .sig files in extcode don't get written there by magma"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5041#event-19520"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5041#issuecomment-40754",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5041#issuecomment-40755",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5041#issuecomment-40756",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5041",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5041#event-19521"
}
```
