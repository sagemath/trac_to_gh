...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5957#issuecomment-50838",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5957#issuecomment-50839",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "rename": {
        "from": "3.4.2.rc0: Maxima related doctest failure in matrix/matrix_symbolic_dense.pyx",
        "to": "[with patch, needs review] 3.4.2.rc0: Maxima related doctest failure in matrix/matrix_symbolic_dense.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5957#event-23802"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5957#issuecomment-50840",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "rename": {
        "from": "[with patch, needs review] 3.4.2.rc0: Maxima related doctest failure in matrix/matrix_symbolic_dense.pyx",
        "to": "[with patch, positive review] 3.4.2.rc0: Maxima related doctest failure in matrix/matrix_symbolic_dense.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5957#event-23803"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5957#issuecomment-50841",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5957#event-23804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5957#issuecomment-50842",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5957#issuecomment-50843",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
