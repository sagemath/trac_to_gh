...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5267#issuecomment-33567",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5267#issuecomment-33568",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5267/trac_5267-const_mpoly.patch",
    "created_at": "2009-02-14T11:53:00Z",
    "issue": "https://github.com/sagemath/sage/issues/5267",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5267/trac_5267-const_mpoly.patch",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_5267-const_mpoly.patch](https://github.com/sagemath/sage/files/ticket5267/trac_5267-const_mpoly.patch) by @aghitza created at 2009-02-14 11:53:00",
    "created_at": "2009-02-14T11:53:00Z",
    "issue": "https://github.com/sagemath/sage/issues/5267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5267#issuecomment-33569",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5267#issuecomment-33570",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5267#issuecomment-33571",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5267#issuecomment-33572",
