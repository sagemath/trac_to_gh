...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5909#issuecomment-51391",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Fixed via the new symbolics at #5930:\n\n```\nmabshoff@sage:/scratch/mabshoff/sage-4.0.rc0$ ./sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nsage: x.subs_expr({x:1})\n1\nsage: x.subs_expr({})\nx\nsage: \n```\n| Sage Version 4.0.alpha0, Release Date: 2009-05-15                  |\n| Type notebook() for the GUI, and license() for information.        |\nIf someone wants to take credit for this personally let me know.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-20T23:50:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5909#issuecomment-51392",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Fixed via the new symbolics at #5930:
