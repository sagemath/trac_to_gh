...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70554"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5909",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5909#issuecomment-38169",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70559"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70560"
}
```
