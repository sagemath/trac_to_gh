...
```json
{
    "body": "<a id='comment:3'></a>No idea really what this is about...",
    "created_at": "2013-12-19T12:12:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5062",
    "type": "issue_comment",
...
<a id='comment:3'></a>No idea really what this is about...
...
```json
{
    "body": "<a id='comment:5'></a>E.g. on skynet one could print an error when trying to run a sparc binary on x86. Though I can assure you there will be an error even without the theck ;-)  In any case, implementation would just have to compare some uname entries, no need for a C program.",
...
<a id='comment:5'></a>E.g. on skynet one could print an error when trying to run a sparc binary on x86. Though I can assure you there will be an error even without the theck ;-)  In any case, implementation would just have to compare some uname entries, no need for a C program.
