...
archive/attachments_006244.json:
```json
{
...
```json
{
    "body": "**Attachment:** [5359.patch](https://github.com/sagemath/sage/files/ticket5359/5359.patch)\n\n(will have to be rebased against sage 3.4)",
    "created_at": "2009-02-24T20:00:18Z",
    "issue": "https://github.com/sagemath/sage/issues/5359",
    "type": "issue_comment",
...
**Attachment:** [5359.patch](https://github.com/sagemath/sage/files/ticket5359/5359.patch)
...
archive/attachments_006245.json:
```json
{
    "asset_content_type": "application/octet-stream",
