...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5719#issuecomment-47886",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5719",
    "rename": {
        "from": "[with patch, needs review] Corrected a bad deprecation message.",
        "to": "[with patch, positive review] Corrected a bad deprecation message."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5719#event-22718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5719#issuecomment-47887",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5719",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5719#event-22719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5719#issuecomment-47888",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5719#issuecomment-47889",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
