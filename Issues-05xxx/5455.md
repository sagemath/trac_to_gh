...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-45053",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5455#event-21497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-45054",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "rename": {
        "from": "gap-4.4.12 -- workspaces broken on iras (itanium Linux)",
        "to": "[with patch; needs review] gap-4.4.12 -- workspaces broken on iras (itanium Linux)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5455#event-21498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-45055",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-45056",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-45057",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "rename": {
        "from": "[with patch; needs review] gap-4.4.12 -- workspaces broken on iras (itanium Linux)",
        "to": "[with patch; positive review] gap-4.4.12 -- workspaces broken on iras (itanium Linux)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5455#event-21499"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5455#event-21500"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-45058",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-45059",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5455#event-21501"
}
```
