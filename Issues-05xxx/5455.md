...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-43301",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Basically the filename option to SaveWorkspace seems to be randomly corrupted.",
    "created_at": "2009-03-08T06:09:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-43302",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Basically the filename option to SaveWorkspace seems to be randomly corrupted.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_5455.patch](tarball://root/attachments/some-uuid/ticket5455/trac_5455.patch) by @williamstein created at 2009-03-08 06:13:18\n\nI've posted a patch that just disables the workspace caching optimization completely for Itanium.    I wrote workspace caching for gap (long ago) and it is 100% just an optimization -- things should be functionally equivalent but just the first time one does \"gap(...)\" it is slower.  \n\n\nNOTE: I also tried compiling gap with -O0 and that didn't fix this problem.",
    "created_at": "2009-03-08T06:13:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-43303",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Attachment [trac_5455.patch](tarball://root/attachments/some-uuid/ticket5455/trac_5455.patch) by @williamstein created at 2009-03-08 06:13:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-43304",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-43306",
...
```json
{
    "body": "<a id='comment:6'></a>Merged in Sage 3.4.final.\n\nCheers,\n\nMichael",
    "created_at": "2009-03-10T16:23:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-43307",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Merged in Sage 3.4.final.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5455#issuecomment-43308",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
