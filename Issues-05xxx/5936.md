...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5936#issuecomment-39739",
...
```json
{
    "body": "Attachment [trac5936_graphdatabase.patch](https://github.com/sagemath/sage/files/ticket5936/trac5936_graphdatabase.patch) by @rlmill created at 2009-05-21 22:27:00\n\nReferee edit of Emily's patch",
    "created_at": "2009-05-21T22:27:00Z",
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5936#issuecomment-39740",
    "user": "https://github.com/rlmill"
}
```

Attachment [trac5936_graphdatabase.patch](https://github.com/sagemath/sage/files/ticket5936/trac5936_graphdatabase.patch) by @rlmill created at 2009-05-21 22:27:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5936#issuecomment-39741",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5936#issuecomment-39742",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5936#issuecomment-39743",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5936#issuecomment-39744",
    "user": "https://github.com/mwhansen"
}
```
