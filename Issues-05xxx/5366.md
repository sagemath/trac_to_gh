...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5366#issuecomment-45041",
    "user": "https://trac.sagemath.org/admin/accounts/users/ekirkman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5366#issuecomment-45042",
    "user": "https://trac.sagemath.org/admin/accounts/users/ekirkman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5366#issuecomment-45043",
    "user": "https://trac.sagemath.org/admin/accounts/users/ekirkman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5366#issuecomment-45045",
...
```json
{
    "body": "<a id='comment:4'></a>I was testing in parallel, so that must have been what happened, since testing the individually failing files with -t worked fine.",
    "created_at": "2009-02-26T23:38:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5366#issuecomment-45046",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>I was testing in parallel, so that must have been what happened, since testing the individually failing files with -t worked fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5366#issuecomment-45047",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5366#issuecomment-45048",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
