...
<a id='comment:2'></a>There is a confusion of terminology here.  It's the "field norm" that's defined for p-adics.  Thus
...
<a id='comment:4'></a>I thought this looked good, and it applied ok to 3.4.1.rc1, but I got a whole lot of doctest failures in sage/rings/padics:
...
```json
{
    "body": "<a id='comment:6'></a>I guess this is reviewed by #5778 and the issues reported here due to doctest failures have been fixed there.\n\nCheers,\n\nMichael",
...
<a id='comment:6'></a>I guess this is reviewed by #5778 and the issues reported here due to doctest failures have been fixed there.
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_5105.patch](tarball://root/attachments/some-uuid/ticket5105/trac_5105.patch) by mabshoff created at 2009-05-11 10:33:04\n\nPositive review due to #5778 - credit goes to RobertWB.\n\nCheers,\n\nMichael",
...
<a id='comment:7'></a>Attachment [trac_5105.patch](tarball://root/attachments/some-uuid/ticket5105/trac_5105.patch) by mabshoff created at 2009-05-11 10:33:04
...
```json
{
    "body": "<a id='comment:8'></a>Merged in Sage 4.0.alpha0.\n\nCheers,\n\nMichael",
...
<a id='comment:8'></a>Merged in Sage 4.0.alpha0.
