...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51163"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51164"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51165"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51166"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51167"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51168"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51172"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51173"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51175"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -22,7 +22,7 @@\n ```\n Apply *either*\n \n-* [attachment: trac_5048-sl2z_coercion-rebased_for_10452.patch] (which should apply cleanly to any recent Sage version -- current is 4.7.2.alpha2 as I write this)\n-* or the patches at #10335 and #11422, together with [attachment: trac_5048-rebased_for_11422.patch].\n+* [attachment: trac_5048-sl2z_coercion-rebased_for_10452.patch.gz](https://github.com/sagemath/sage/files/ticket5048/trac_5048-sl2z_coercion-rebased_for_10452.patch.gz) (which should apply cleanly to any recent Sage version -- current is 4.7.2.alpha2 as I write this)\n+* or the patches at #10335 and #11422, together with [attachment: trac_5048-rebased_for_11422.patch.gz](https://github.com/sagemath/sage/files/ticket5048/trac_5048-rebased_for_11422.patch.gz).\n \n (There is no difference in functionality either way, it's just that the original patch won't apply because some context lines changed.)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -22,7 +22,7 @@\n ```\n Apply *either*\n \n-* [attachment: trac_5048-sl2z_coercion-rebased_for_10452.patch.gz](https://github.com/sagemath/sage/files/ticket5048/trac_5048-sl2z_coercion-rebased_for_10452.patch.gz) (which should apply cleanly to any recent Sage version -- current is 4.7.2.alpha2 as I write this)\n-* or the patches at #10335 and #11422, together with [attachment: trac_5048-rebased_for_11422.patch.gz](https://github.com/sagemath/sage/files/ticket5048/trac_5048-rebased_for_11422.patch.gz).\n+* [attachment: trac_5048-sl2z_coercion-rebased_for_10452.patch.gz](https://github.com/sagemath/sage/files/ticket5048/trac_5048-sl2z_coercion-rebased_for_10452.patch.gz) if using Sage 4.7.2.alpha2 or earlier,\n+* [attachment: trac_5048-rebased_for_11422.patch.gz](https://github.com/sagemath/sage/files/ticket5048/trac_5048-rebased_for_11422.patch.gz) if using Sage 4.7.2.alpha3 or later.\n \n (There is no difference in functionality either way, it's just that the original patch won't apply because some context lines changed.)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51180"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51183"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5048#issuecomment-31872",
    "user": "https://github.com/sagetrac-johanbosman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5048#issuecomment-31873",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51184"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51186"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5048",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5048#event-51187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5048#issuecomment-31874",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5048",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5048#issuecomment-31875",
    "user": "https://github.com/loefflerd"
}
```
