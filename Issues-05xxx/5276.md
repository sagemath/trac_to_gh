...
```json
{
    "body": "<a id='comment:1'></a>The problem is solved by changes to `__call__` for the class `RelativeOrder` in `sage/rings/number_theory/order.py` to be found in #5508.",
    "created_at": "2009-03-13T19:05:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5276#issuecomment-41465",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```

<a id='comment:1'></a>The problem is solved by changes to `__call__` for the class `RelativeOrder` in `sage/rings/number_theory/order.py` to be found in #5508.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5276#issuecomment-41466",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5276#issuecomment-41467",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5276#issuecomment-41468",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5276#issuecomment-41469",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
