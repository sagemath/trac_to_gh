...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56100"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-35165",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56104"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-35166",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-35167",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-35168",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56105"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56106"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56107"
}
```
...
```json
{
    "body": "<a id='comment:8'>Comment 8:</a>\nRight, nothing gets past you. :)\n\n[attachment: trac_5451-ratfun_doctest.patch.gz](https://github.com/sagemath/sage/files/ticket5451/trac_5451-ratfun_doctest.patch.gz) adds the doctest.\n\nCheers,\nBurcin",
    "created_at": "2009-03-25T20:33:16Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-35169",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56108"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56109"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-35170",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-35171",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56110"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-56111"
}
```
