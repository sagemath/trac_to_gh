...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5811#issuecomment-48973",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5811#issuecomment-48974",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "rename": {
        "from": "Sage 3.4.1.rc3: Fedora 10/64 - type_reducible.py doctest failure due to '__cmp__\"",
        "to": "[with patch, needs review] Sage 3.4.1.rc3: Fedora 10/64 - type_reducible.py doctest failure due to '__cmp__\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5811#event-23178"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5811#issuecomment-48975",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5811#issuecomment-48976",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5811#issuecomment-48977",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "rename": {
        "from": "[with patch, needs review] Sage 3.4.1.rc3: Fedora 10/64 - type_reducible.py doctest failure due to '__cmp__\"",
        "to": "[with patch, positive review] Sage 3.4.1.rc3: Fedora 10/64 - type_reducible.py doctest failure due to '__cmp__\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5811#event-23179"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5811#event-23180"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5811#issuecomment-48978",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5811#issuecomment-48979",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
