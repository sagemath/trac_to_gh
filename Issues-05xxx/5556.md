...
```json
{
    "body": "<a id='comment:3'></a>Actually, belay that.  There are a few such functions out there.  E.g., \n\n```\nsage: sin(SR(3/4))\nsin(3/4)\nsage: sin(3/4)\nsin(3/4)\nsage: gamma(SR(3/4))\ngamma(3/4)\nsage: gamma(3/4)\n1.22541670246518\nsage: zeta(SR(3/4))\nzeta(3/4)\nsage: zeta(3/4)\n-3.44128538694522\n```\nSo the problem lies in gamma itself (and friends).  Most likely fix at this point is adding a prec keyword, as in sqrt.",
    "created_at": "2009-09-30T14:02:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47263",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Actually, belay that.  There are a few such functions out there.  E.g., 
...
```json
{
    "body": "<a id='comment:4'></a>This should fix all such things, with the change that rationals now default to symbolic output.  The sage-devel discussion above didn't seem to think this was a problem, so hopefully it won't be, as one can still use prec or .n() to get exact values when the input isn't a multiple of 1/2.\n\nNote that this patch also fixes a NASTY hang error with negative integer CDF input into gamma.",
    "created_at": "2009-09-30T17:00:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47264",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>This should fix all such things, with the change that rationals now default to symbolic output.  The sage-devel discussion above didn't seem to think this was a problem, so hopefully it won't be, as one can still use prec or .n() to get exact values when the input isn't a multiple of 1/2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47265",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47266",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47267",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47268",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47269",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Yup, those are all good changes.  I never know exactly how many characters are okay for the width of docstrings; it varies wildly by file, so I go short to be safe.  Also good eye with the n-1.",
    "created_at": "2009-10-05T13:20:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47270",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Yup, those are all good changes.  I never know exactly how many characters are okay for the width of docstrings; it varies wildly by file, so I go short to be safe.  Also good eye with the n-1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47271",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5556#issuecomment-47272",
    "user": "https://github.com/mwhansen"
}
```
