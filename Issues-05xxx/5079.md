...
```json
{
    "body": "**Attachment:** [5079-preparse-1.patch](https://github.com/sagemath/sage/files/ticket5079/5079-preparse-1.patch)",
    "created_at": "2009-01-24T09:55:08Z",
    "issue": "https://github.com/sagemath/sage/issues/5079",
    "type": "issue_comment",
...
**Attachment:** [5079-preparse-1.patch](https://github.com/sagemath/sage/files/ticket5079/5079-preparse-1.patch)



---

archive/attachments_005905.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [5079-preparse-2.patch](https://github.com/sagemath/sage/files/ticket5079/5079-preparse-2.patch)",
    "created_at": "2009-01-24T10:25:59Z",
    "issue": "https://github.com/sagemath/sage/issues/5079",
    "type": "issue_comment",
...
**Attachment:** [5079-preparse-2.patch](https://github.com/sagemath/sage/files/ticket5079/5079-preparse-2.patch)



---

archive/attachments_005906.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_005907.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:6'></a>\n**Attachment:** [trac_5079.patch](https://github.com/sagemath/sage/files/ticket5079/trac_5079.patch)\n\nI added a patch which folds all of the above ones together.\n\n+1 on Tom's changes.",
    "created_at": "2009-01-24T22:58:07Z",
    "issue": "https://github.com/sagemath/sage/issues/5079",
    "type": "issue_comment",
