...
```json
{
    "body": "Attachment [symb_ring_is_unit-fh.patch](https://github.com/sagemath/sage/files/ticket5244/symb_ring_is_unit-fh.patch) by @hivert created at 2009-02-13 15:59:40\n\nPatch proposal for is_unit is SR",
    "created_at": "2009-02-13T15:59:40Z",
    "issue": "https://github.com/sagemath/sage/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5244#issuecomment-33368",
    "user": "https://github.com/hivert"
}
```

Attachment [symb_ring_is_unit-fh.patch](https://github.com/sagemath/sage/files/ticket5244/symb_ring_is_unit-fh.patch) by @hivert created at 2009-02-13 15:59:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5244#issuecomment-33369",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5244#issuecomment-33370",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5244#issuecomment-33371",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5244#issuecomment-33372",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5244#issuecomment-33373",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
