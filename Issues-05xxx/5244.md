...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42747",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20534"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42748",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] is_unit for symbolic ring."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20535"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20536"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42749",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42750",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20538"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42751",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42752",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "rename": {
        "from": "[with patch, needs review] is_unit for symbolic ring.",
        "to": "[with patch, positive review] is_unit for symbolic ring."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20540"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5244#event-20541"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42753",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5244#issuecomment-42754",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
