...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5355#event-62925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5355#event-62926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5355#event-62927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5355#event-62928"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5355#event-62929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5355#issuecomment-33060",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5355#issuecomment-33061",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5355#issuecomment-33062",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5355#issuecomment-33063",
...
```json
{
    "body": "Changed keywords from none to **qqbar, coercion**",
    "created_at": "2019-04-22T13:48:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5355#issuecomment-33064",
    "user": "https://github.com/jplab"
}
```

Changed keywords from none to **qqbar, coercion**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5355#issuecomment-33065",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5355#issuecomment-33066",
