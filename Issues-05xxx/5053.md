...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40873",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] If the hostname of the computer has a \"-\" in it, then no tempfiles will ever be deleted from $DOT_SAGE/temp!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5053#event-19562"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40874",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40875",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40876",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40877",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "rename": {
        "from": "[with patch, needs review] If the hostname of the computer has a \"-\" in it, then no tempfiles will ever be deleted from $DOT_SAGE/temp!",
        "to": "[with patch, needs review] If the hostname of the computer has a \"-\"  in it, then no tempfiles will ever be deleted from $DOT_SAGE/temp!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5053#event-19563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40878",
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] If the hostname of the computer has a \"-\"  in it, then no tempfiles will ever be deleted from $DOT_SAGE/temp!",
        "to": "[with patch, positive review] If the hostname of the computer has a \"-\"  in it, then no tempfiles will ever be deleted from $DOT_SAGE/temp!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5053#event-19564"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5053#event-19565"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5053#issuecomment-40880",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
