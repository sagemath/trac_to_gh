...
```json
{
    "body": "Attachment [cleaner.patch](https://github.com/sagemath/sage/files/ticket5053/cleaner.patch) by @simon-king-jena created at 2009-01-24 21:02:45\n\nFor being consistent, replace '-' with '_'. This yields a proper cleaning of temp-files",
    "created_at": "2009-01-24T21:02:45Z",
    "issue": "https://github.com/sagemath/sage/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5053#issuecomment-31877",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [cleaner.patch](https://github.com/sagemath/sage/files/ticket5053/cleaner.patch) by @simon-king-jena created at 2009-01-24 21:02:45
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5053#issuecomment-31878",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5053#issuecomment-31879",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment [hostnameSCRIPTS.patch](https://github.com/sagemath/sage/files/ticket5053/hostnameSCRIPTS.patch) by @simon-king-jena created at 2009-01-25 08:00:14\n\nTo be applied after the first patch. Allows hostnames that contain '/' or '\\'",
    "created_at": "2009-01-25T08:00:14Z",
    "issue": "https://github.com/sagemath/sage/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5053#issuecomment-31880",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [hostnameSCRIPTS.patch](https://github.com/sagemath/sage/files/ticket5053/hostnameSCRIPTS.patch) by @simon-king-jena created at 2009-01-25 08:00:14
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5053#issuecomment-31881",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5053#issuecomment-31882",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5053",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5053#issuecomment-31883",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
