...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5803#issuecomment-48883",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5803",
    "rename": {
        "from": "[with patch, needs review] Upgrade Cython to 0.11.1",
        "to": "[with patch, spkg; needs review] Upgrade Cython to 0.11.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5803#event-23140"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5803#event-23141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5803#issuecomment-48884",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5803",
    "rename": {
        "from": "[with patch, spkg; needs review] Upgrade Cython to 0.11.1",
        "to": "[with patch, spkg; positive review] Upgrade Cython to 0.11.1"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5803#event-23142"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5803#issuecomment-48885",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5803",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5803#event-23143"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5803",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5803#issuecomment-48886",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
