...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5781#issuecomment-48542",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5781#issuecomment-48543",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5781",
    "rename": {
        "from": "[with patch, need review] The empty standard tableau exists ! :-)",
        "to": "[with patch, positive review] The empty standard tableau exists ! :-)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5781#event-23014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5781#issuecomment-48544",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5781#issuecomment-48545",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5781#event-23015"
}
```
