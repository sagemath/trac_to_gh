...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5578#issuecomment-47569",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Positive review:  applies ok to 3.4 and all tests in elliptic_curves pass.\n\nApologies (for being responsible for the bug)!",
    "created_at": "2009-03-21T19:23:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5578#issuecomment-47570",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>Positive review:  applies ok to 3.4 and all tests in elliptic_curves pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5578#issuecomment-47571",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5578#issuecomment-47572",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
