...
```json
{
    "body": "<a id='comment:2'></a>If we've released for 2 months without fixing this, it doesn't make sense to keep it as a blocker.",
    "created_at": "2009-06-15T23:26:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51146",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>If we've released for 2 months without fixing this, it doesn't make sense to keep it as a blocker.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51147",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Given that #7809 has positive review and has changed this particular doctest, AND given that region_plot in this format has existed for close to a year with no complaints, and given that #7809 now makes clear what we *want* the behavior to be, I think it's time to close this ticket.  If jason or was concurs, then let's do it.",
    "created_at": "2010-01-08T16:23:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51148",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51149",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>(to take care of a reviewer comment) -- I feel that we don't have to put in a DeprecationWarning doctest since the deprecation warning happens not in the region_plot function, but at a lower level, and it is already doctested there.\n\nI think this ticket can be closed as fixed once #7809 is merged.",
    "created_at": "2010-01-09T05:38:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51151",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>(to take care of a reviewer comment) -- I feel that we don't have to put in a DeprecationWarning doctest since the deprecation warning happens not in the region_plot function, but at a lower level, and it is already doctested there.
...
```json
{
    "body": "<a id='comment:6'></a>uh, I'll put this as \"needs review\", and maybe kcrisman can give it a positive review?",
    "created_at": "2010-01-09T05:38:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51152",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:6'></a>uh, I'll put this as "needs review", and maybe kcrisman can give it a positive review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51153",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Sorry, I didn't see this recently.  Yes, we do get an appropriate deprecation warning.  I don't know that there is really an author or reviewer for this... just a closure.\n\nAlso, the plot is still one pixel off :)",
    "created_at": "2010-01-19T16:29:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51154",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>Sorry, I didn't see this recently.  Yes, we do get an appropriate deprecation warning.  I don't know that there is really an author or reviewer for this... just a closure.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51155",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Fixed due to #7809.",
    "created_at": "2010-01-22T21:42:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51156",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:8'></a>Fixed due to #7809.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5885#issuecomment-51157",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
