...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59510"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59521"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59522"
}
```
...
```json
{
    "body": "Changed keywords from **** to **actions, left actions, right actions**",
    "created_at": "2009-10-15T12:15:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
...
Changed keywords from **** to **actions, left actions, right actions**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59523"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5597#issuecomment-36535",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:13'>Comment 13:</a>\nI applied just [attachment: trac_5597-infinite_polynomial_ring.patch.gz](https://github.com/sagemath/sage/files/ticket5597/trac_5597-infinite_polynomial_ring.patch.gz) to 4.2.alpha0 and doctested `sage/rings/polynomial/infinite_polynomial_ring.py`.  Positive review for this patch.",
    "created_at": "2009-10-21T06:16:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5597#issuecomment-36536",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-59525"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5597#issuecomment-36537",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5597#issuecomment-36538",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5597#issuecomment-36539",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5597#issuecomment-36540",
    "user": "https://github.com/mwhansen"
}
```
