...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65253"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65256"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5521#issuecomment-34599",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5521#issuecomment-34600",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65259"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65260"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5521",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5521#event-65261"
}
```
