...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33579",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "rename": {
        "from": "implement plotting of affine and projective algebraic curves",
        "to": "[with review] implement plotting of affine and projective algebraic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32761"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32762"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33580",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33581",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33582",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "rename": {
        "from": "[with review] implement plotting of affine and projective algebraic curves",
        "to": "implement plotting of affine and projective algebraic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32763"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32764"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32765"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32766"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33583",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        "from": "implement plotting of affine and projective algebraic curves",
        "to": "[needs rebase] implement plotting of affine and projective algebraic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32767"
}
```
...
archive/attachments_005932.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_5270.patch",
    "asset_url": "tarball://root/attachments/ticket5270/trac_5270.patch",
    "created_at": "2009-03-16T02:52:26Z",
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5270/trac_5270.patch",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "Attachment [trac_5270.patch](https://github.com/sagemath/sage/files/ticket5270/trac_5270.patch) by @aghitza created at 2009-03-16 02:52:26",
    "created_at": "2009-03-16T02:52:26Z",
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33585",
    "user": "https://github.com/aghitza"
}
```

Attachment [trac_5270.patch](https://github.com/sagemath/sage/files/ticket5270/trac_5270.patch) by @aghitza created at 2009-03-16 02:52:26
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33586",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "rename": {
        "from": "[needs rebase] implement plotting of affine and projective algebraic curves",
        "to": "implement plotting of affine and projective algebraic curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32768"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33587",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5270#issuecomment-33588",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32773"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5270",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5270#event-32775"
}
```
