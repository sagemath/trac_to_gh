...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42861",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Mac app bundle: check for relocation at startup since the bundle version does not trigger the move check"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20582"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42862",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42863",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42864",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20583"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "rename": {
        "from": "[with patch, needs review] Mac app bundle: check for relocation at startup since the bundle version does not trigger the move check",
        "to": "[with patch, patch needs work, needs review] Mac app bundle: check for relocation at startup since the bundle version does not trigger the move check"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20584"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42865",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "rename": {
        "from": "[with patch, patch needs work, needs review] Mac app bundle: check for relocation at startup since the bundle version does not trigger the move check",
        "to": "[with patch, needs work] Mac app bundle: check for relocation at startup since the bundle version does not trigger the move check"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20585"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42866",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42867",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42868",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42869",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42870",
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20586"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20587"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20588"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5254#issuecomment-42871",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5254",
    "rename": {
        "from": "[with patch, needs work] Mac app bundle: check for relocation at startup since the bundle version does not trigger the move check",
        "to": "Mac app bundle: check for relocation at startup since the bundle version does not trigger the move check"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5254#event-20589"
}
```
