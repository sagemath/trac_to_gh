...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5269#issuecomment-43011",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5269#issuecomment-43012",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5269#issuecomment-43013",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "rename": {
        "from": "coordinate ring of an affine patch on a hyperelliptic curve is broken",
        "to": "[with patch, needs review] coordinate ring of an affine patch on a hyperelliptic curve is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5269#event-20653"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5269#event-20654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "rename": {
        "from": "[with patch, needs review] coordinate ring of an affine patch on a hyperelliptic curve is broken",
        "to": "[with patch, positive review] coordinate ring of an affine patch on a hyperelliptic curve is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5269#event-20655"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5269#issuecomment-43014",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5269#event-20656"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5269#issuecomment-43015",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5269#issuecomment-43016",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
