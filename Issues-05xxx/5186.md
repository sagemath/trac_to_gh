...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60588"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60591"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60592"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5186#issuecomment-31835",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5186",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5186#issuecomment-31836",
    "user": "https://github.com/wjp"
}
```
