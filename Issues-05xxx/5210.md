# Issue 5210: [with spkg, positive review] gmp-mpir-0.9.rc3: make check failure on various OSX boxen
...
```json
{
    ...
    "title": "[with spkg, positive review] gmp-mpir-0.9.rc3: make check failure on various OSX boxen",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5210#issuecomment-42439",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5210#issuecomment-42440",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "rename": {
        "from": "gmp-mpir-0.9.rc3: make check failure on various OSX boxen",
        "to": "[with spkg, needs review] gmp-mpir-0.9.rc3: make check failure on various OSX boxen"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5210#event-20336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5210#issuecomment-42441",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5210#issuecomment-42442",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "rename": {
        "from": "[with spkg, needs review] gmp-mpir-0.9.rc3: make check failure on various OSX boxen",
        "to": "[with spkg, positive review] gmp-mpir-0.9.rc3: make check failure on various OSX boxen"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5210#event-20337"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5210#event-20338"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5210#issuecomment-42443",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5210#issuecomment-42444",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
