# Issue 5698: [with patch; positive review] Sage 3.4.1.rc1: doctest failure in schemes/elliptic_curves/monsky_washnitzer.py
...
```json
{
    ...
    "title": "[with patch; positive review] Sage 3.4.1.rc1: doctest failure in schemes/elliptic_curves/monsky_washnitzer.py",
    "type": "issue",
