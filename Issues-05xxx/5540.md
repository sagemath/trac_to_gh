...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5540#issuecomment-36006",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5540#issuecomment-36007",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [5540.patch](https://github.com/sagemath/sage/files/ticket5540/5540.patch) by @nbruin created at 2009-03-17 04:06:43\n\nPatch solves the problem for me. The patch is also tiny, so while I'm not familiar with the code, I wouldn't expect it to cause any regressions.",
    "created_at": "2009-03-17T04:06:43Z",
    "issue": "https://github.com/sagemath/sage/issues/5540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5540#issuecomment-36008",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5540#issuecomment-36009",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5540#issuecomment-36010",
