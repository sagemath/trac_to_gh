...
```json
{
    "body": "<a id='comment:1'></a>Boy, that was all mes",
    "created_at": "2009-03-13T16:26:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46761",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>Boy, that was all mes
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46762",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46763",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46764",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [Arbitrary_Mesh_Functions.sws](tarball://root/attachments/some-uuid/ticket5511/Arbitrary_Mesh_Functions.sws) by @jasongrout created at 2009-03-13 16:44:03",
    "created_at": "2009-03-13T16:44:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46765",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>Attachment [Arbitrary_Mesh_Functions.sws](tarball://root/attachments/some-uuid/ticket5511/Arbitrary_Mesh_Functions.sws) by @jasongrout created at 2009-03-13 16:44:03
...
```json
{
    "body": "<a id='comment:3'></a>See the images at the bottom of http://sagenb.org/home/pub/361/ for examples!",
    "created_at": "2009-03-14T09:16:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46766",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>See the images at the bottom of http://sagenb.org/home/pub/361/ for examples!
...
```json
{
    "body": "<a id='comment:5'></a>This is really neat. So is an arbitrary mesh function like the intersection between the contour of a function and another graph? It looks like your method is generic enough to apply to any IndexFaceSet. Would that be accurate? I will let you know if I can find time to work on this; I would like to!",
    "created_at": "2009-04-23T00:09:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46768",
    "user": "https://trac.sagemath.org/admin/accounts/users/wcauchois"
}
```

<a id='comment:5'></a>This is really neat. So is an arbitrary mesh function like the intersection between the contour of a function and another graph? It looks like your method is generic enough to apply to any IndexFaceSet. Would that be accurate? I will let you know if I can find time to work on this; I would like to!
...
```json
{
    "body": "<a id='comment:6'></a>Yes, it should be generic enough for any IndexFaceSet.  See http://reference.wolfram.com/mathematica/ref/MeshFunctions.html.",
    "created_at": "2009-04-23T02:59:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46769",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:6'></a>Yes, it should be generic enough for any IndexFaceSet.  See http://reference.wolfram.com/mathematica/ref/MeshFunctions.html.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46770",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46771",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46773",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I guess one advantage to Wolfram's approach is that if you want fine mesh lines, you probably also want the detail afforded by lots of triangles.",
    "created_at": "2010-11-06T01:11:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46774",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:9'></a>I guess one advantage to Wolfram's approach is that if you want fine mesh lines, you probably also want the detail afforded by lots of triangles.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5511#issuecomment-46775",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5511#event-12910"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5511#event-12911"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5511#event-12912"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5511#event-12913"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5511#event-12914"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5511#event-12915"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5511#event-12916"
}
```
