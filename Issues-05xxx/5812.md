...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50075",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I also just tripped over this bug. I checked that the no-brainer patch fixes it. There is no easy way to doctest the graphical output. \n\nSince the correct patch just sat around for half a year, I will change it to \"positive review\" in hopes that the patch will be applied.\n\nIn case the philosophical issue of how to handle equal zorders ever gets sorted out, please report in bug #6249. But this bug has served its purpose and the patch should be applied asap.",
    "created_at": "2009-10-08T19:34:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50077",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>I also just tripped over this bug. I checked that the no-brainer patch fixes it. There is no easy way to doctest the graphical output. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50078",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50079",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Dear vbraun,\n\nCan you put your full name here?  The release managers like that, as it makes things easier.",
    "created_at": "2009-10-08T19:37:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50080",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Dear vbraun,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50081",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50082",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Then you can also move it to the \"positive review\" button below.  The new trac workflow will take some getting used to, it's true...",
    "created_at": "2009-10-08T19:38:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50083",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>Then you can also move it to the "positive review" button below.  The new trac workflow will take some getting used to, it's true...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50084",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50085",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50086",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5812",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5812#issuecomment-50087",
    "user": "https://github.com/mwhansen"
}
```
