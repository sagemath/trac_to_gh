...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5094#issuecomment-32165",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5094/COPYING.txt",
    "created_at": "2009-01-29T15:35:06Z",
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5094/COPYING.txt",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Attachment [COPYING.txt](https://github.com/sagemath/sage/files/ticket5094/COPYING.txt) by @kcrisman created at 2009-01-29 15:35:06\n\nThis is a one-word change of SageX to Cython from the 3.3.alpha0 version of this file.",
    "created_at": "2009-01-29T15:35:06Z",
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5094#issuecomment-32166",
    "user": "https://github.com/kcrisman"
}
```

Attachment [COPYING.txt](https://github.com/sagemath/sage/files/ticket5094/COPYING.txt) by @kcrisman created at 2009-01-29 15:35:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5094#issuecomment-32167",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5094#issuecomment-32168",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5094/trac_5094.patch",
    "created_at": "2009-02-02T16:40:07Z",
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5094/trac_5094.patch",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_5094.patch](https://github.com/sagemath/sage/files/ticket5094/trac_5094.patch) by @kcrisman created at 2009-02-02 16:40:07",
    "created_at": "2009-02-02T16:40:07Z",
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5094#issuecomment-32169",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5094#issuecomment-32170",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5094#issuecomment-32171",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
