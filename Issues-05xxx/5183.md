...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5183#issuecomment-43277",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>These two examples seem to work now, so I think we can close this.",
    "created_at": "2010-02-20T00:49:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5183#issuecomment-43278",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>These two examples seem to work now, so I think we can close this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5183#issuecomment-43279",
    "user": "https://github.com/jhpalmieri"
}
```
