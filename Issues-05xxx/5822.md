# Issue 5822: [with positive review] cusps -- implement action of the Galois group on cusps for congruence subgroups as on page 12 of Steven's "Arithmetic on Modular Curves"
...
```json
{
    ...
    "title": "[with positive review] cusps -- implement action of the Galois group on cusps for congruence subgroups as on page 12 of Steven's \"Arithmetic on Modular Curves\"",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55217",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket5822/trac_5822.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55218",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55219",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55220",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "rename": {
        "from": "cusps -- implement action of the Galois group on cusps for congruence subgroups as on page 12 of Steven's \"Arithmetic on Modular Curves\"",
        "to": "[with positive review] cusps -- implement action of the Galois group on cusps for congruence subgroups as on page 12 of Steven's \"Arithmetic on Modular Curves\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5822#event-17674"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55221",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55222",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5822#event-17675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55223",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5822#issuecomment-55224",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5822#event-17676"
}
```
