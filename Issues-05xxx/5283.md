...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5283#issuecomment-43183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "rename": {
        "from": "problem with posets: iterating the subposet construction",
        "to": "[with patch; needs review] problem with posets: iterating the subposet construction"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-20721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5283#issuecomment-43184",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "rename": {
        "from": "[with patch; needs review] problem with posets: iterating the subposet construction",
        "to": "[with patch; positive review] problem with posets: iterating the subposet construction"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-20722"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5283#issuecomment-43185",
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-20723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5283#issuecomment-43186",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-20724"
}
```
