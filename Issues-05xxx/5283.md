...
```json
{
    ...
    "asset_name": "trac_5283.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket5283/trac_5283.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5283#issuecomment-34467",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-33612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5283#issuecomment-34468",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-33613"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-33614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5283#issuecomment-34469",
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-33615"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-33616"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-33617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5283",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5283#event-33618"
}
```
