# Issue 5886: [with patch; positive review] Bug in free module homomorphism creation
...
```json
{
    ...
    "title": "[with patch; positive review] Bug in free module homomorphism creation",
    "type": "issue",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] Bug in free module homomorphism creation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5886#event-23529"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "rename": {
        "from": "[with patch; needs review] Bug in free module homomorphism creation",
        "to": "[with patch; positive review pending no doctest breakage] Bug in free module homomorphism creation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5886#event-23530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5886#issuecomment-50043",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5886#issuecomment-50044",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "rename": {
        "from": "[with patch; positive review pending no doctest breakage] Bug in free module homomorphism creation",
        "to": "[with patch; positive review] Bug in free module homomorphism creation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5886#event-23531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5886#issuecomment-50045",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5886#issuecomment-50046",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5886#issuecomment-50047",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5886#event-23532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5886#issuecomment-50048",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
