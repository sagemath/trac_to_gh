...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5289#issuecomment-48437",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
archive/attachments_005951.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "gdmodule_Setup.py-fix.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket5289/gdmodule_Setup.py-fix.patch",
...
```json
{
    "body": "This is the fix I am applying inside the spkg - it will make it easier for the reviewer",
    "created_at": "2009-02-17T06:42:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5289#issuecomment-48438",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5289#issuecomment-48439",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5289#issuecomment-48440",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5289#issuecomment-48441",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5289#issuecomment-48442",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5289#issuecomment-48443",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
