...
```json
{
    "body": "**Attachment:** [gdmodule_Setup.py-fix.patch](https://github.com/sagemath/sage/files/ticket5289/gdmodule_Setup.py-fix.patch)\n\nThis is the fix I am applying inside the spkg - it will make it easier for the reviewer",
    "created_at": "2009-02-17T06:42:51Z",
    "issue": "https://github.com/sagemath/sage/issues/5289",
    "type": "issue_comment",
...
**Attachment:** [gdmodule_Setup.py-fix.patch](https://github.com/sagemath/sage/files/ticket5289/gdmodule_Setup.py-fix.patch)
