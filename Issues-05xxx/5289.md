...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5289/gdmodule_Setup.py-fix.patch",
    "created_at": "2009-02-17T06:42:51Z",
    "issue": "https://github.com/sagemath/sage/issues/5289",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5289/gdmodule_Setup.py-fix.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Attachment [gdmodule_Setup.py-fix.patch](https://github.com/sagemath/sage/files/ticket5289/gdmodule_Setup.py-fix.patch) by mabshoff created at 2009-02-17 06:42:51\n\nThis is the fix I am applying inside the spkg - it will make it easier for the reviewer",
    "created_at": "2009-02-17T06:42:51Z",
    "issue": "https://github.com/sagemath/sage/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5289#issuecomment-33756",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

Attachment [gdmodule_Setup.py-fix.patch](https://github.com/sagemath/sage/files/ticket5289/gdmodule_Setup.py-fix.patch) by mabshoff created at 2009-02-17 06:42:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5289#issuecomment-33757",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5289#issuecomment-33758",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5289",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5289#issuecomment-33759",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
