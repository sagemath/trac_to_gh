...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44352",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44354",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44355",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44356",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [bug5295.patch](tarball://root/attachments/some-uuid/ticket5295/bug5295.patch) by @nbruin created at 2010-01-17 00:43:55",
    "created_at": "2010-01-17T00:43:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44357",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:2'></a>Attachment [bug5295.patch](tarball://root/attachments/some-uuid/ticket5295/bug5295.patch) by @nbruin created at 2010-01-17 00:43:55
...
```json
{
    "body": "<a id='comment:5'></a>> If someone wants the maxima distributed with sage to *never* look at `$HOME/.maxima` then one should edit the `sage/local/bin/maxima` script to use the {{{--userdir}} command line option by default. I think that is wrong.\n\n\nHowever, should someone want to do this anyway, then the environment variable $MAXIMA_USERDIR should do the trick. Thus,\n\n```\nMAXIMA_USERDIR=$DOT_SAGE/maxima\nexport MAXIMA_USERDIR\n```\ncould just go into sage_env or something similar. This would be an alternative to the attached patch.",
    "created_at": "2010-01-20T00:21:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44360",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:5'></a>> If someone wants the maxima distributed with sage to *never* look at `$HOME/.maxima` then one should edit the `sage/local/bin/maxima` script to use the {{{--userdir}} command line option by default. I think that is wrong.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44361",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Looks good. Work as advertised.",
    "created_at": "2010-01-20T18:45:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44362",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:6'></a>Looks good. Work as advertised.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44363",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44364",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44365",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5295#event-12312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5295#issuecomment-44366",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
