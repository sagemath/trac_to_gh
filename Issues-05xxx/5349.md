...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5349#issuecomment-42204",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5349#issuecomment-42205",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I tested it; it works.  Positive review.",
    "created_at": "2009-02-23T19:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5349#issuecomment-42206",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:2'></a>I tested it; it works.  Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5349#issuecomment-42207",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5349#issuecomment-42208",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
