...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5694#issuecomment-47685",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5694",
    "rename": {
        "from": "[with patch; needs review] _ for previous output is completely broken in the notebook due to the preparser",
        "to": "[with patch; positive review] _ for previous output is completely broken in the notebook due to the preparser"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5694#event-22628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5694#issuecomment-47686",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5694#event-22629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5694",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5694#event-22630"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5694#issuecomment-47687",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5694#issuecomment-47688",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
