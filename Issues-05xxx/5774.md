...
```json
{
    "body": "<a id='comment:1'></a>Well, this is only an issue of annoyance, so bumping it to 3.4.2.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-21T23:37:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5774",
    "type": "issue_comment",
...
<a id='comment:1'></a>Well, this is only an issue of annoyance, so bumping it to 3.4.2.
...
```json
{
    "body": "<a id='comment:2'></a>As a mere annoyance, it doesn't make sense to keep it as a blocker.",
...
<a id='comment:2'></a>As a mere annoyance, it doesn't make sense to keep it as a blocker.
...
```json
{
    "body": "<a id='comment:3'></a>This doesn't happen anymore.",
    "created_at": "2012-05-17T22:02:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5774",
    "type": "issue_comment",
...
<a id='comment:3'></a>This doesn't happen anymore.
