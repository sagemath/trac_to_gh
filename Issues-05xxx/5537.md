...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47059",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This will fix the error, but doesn't fix the underlying issue that the coercions should happen *before* cmp gets called. Also, I anticipate it will be a massive speed regression--if the sizes are inequal then the longer one should simply be checked to make sure it fixes the larger elements. \n\nI'll post a patch.",
    "created_at": "2009-03-17T18:47:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47060",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>This will fix the error, but doesn't fix the underlying issue that the coercions should happen *before* cmp gets called. Also, I anticipate it will be a massive speed regression--if the sizes are inequal then the longer one should simply be checked to make sure it fixes the larger elements. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47061",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47062",
...
```json
{
    "body": "<a id='comment:4'></a>There is no such thing as \"negative review\".\n\nCheers,\n\nMichael",
    "created_at": "2009-03-18T00:03:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47063",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>There is no such thing as "negative review".
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [5537-perm-cmp.patch](tarball://root/attachments/some-uuid/ticket5537/5537-perm-cmp.patch) by @robertwb created at 2009-03-18 05:23:22\n\n\n```\nsage: a = SymmetricGroup(20).random_element(); b = SymmetricGroup(10).random_element()\nsage: time v = [a == b for _ in xrange(2000)]\nCPU times: user 0.00 s, sys: 0.00 s, total: 0.00 s\nWall time: 0.00 s\nsage: timeit(\"a==b\")\n625 loops, best of 3: 240 ns per loop\n```\n\nvs. the old code\n\n```\nsage: a = SymmetricGroup(20).random_element(); b = SymmetricGroup(10).random_element()\nsage: timeit(\"a==b\")\n625 loops, best of 3: 3.19 \u00b5s per loop\n```",
    "created_at": "2009-03-18T05:23:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47064",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:5'></a>Attachment [5537-perm-cmp.patch](tarball://root/attachments/some-uuid/ticket5537/5537-perm-cmp.patch) by @robertwb created at 2009-03-18 05:23:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47065",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47066",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47068",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47070",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>RE ::, good point. I agree about the doctests, the most important point is that they get tested (so comparison of permutation group elements doesn't silently break one of these releases).",
    "created_at": "2009-03-18T19:09:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47071",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:11'></a>RE ::, good point. I agree about the doctests, the most important point is that they get tested (so comparison of permutation group elements doesn't silently break one of these releases).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47073",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Yes, I'm fine with those changes. As for what I ran timings on, OS X 10.4 intel core 2 duo 2.33 Ghz.",
    "created_at": "2009-03-19T02:54:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47074",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:14'></a>Yes, I'm fine with those changes. As for what I ran timings on, OS X 10.4 intel core 2 duo 2.33 Ghz.
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [trac_5537_perm_compare.patch](tarball://root/attachments/some-uuid/ticket5537/trac_5537_perm_compare.patch) by @rbeezer created at 2009-03-19 04:30:31\n\nReplying to [robertwb](#comment%3A14):\n\nOK, final patch (trac_5537_perm_compare) has Robert's \"perm-cmp\" patch, John's \"referee\" patch, and my code changes listed above all in one.  So this should be the only file Michael Abshoff will have to deal with.\n\nI think the ball is in your court now, John.\n\nRob",
    "created_at": "2009-03-19T04:30:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47075",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:15'></a>Attachment [trac_5537_perm_compare.patch](tarball://root/attachments/some-uuid/ticket5537/trac_5537_perm_compare.patch) by @rbeezer created at 2009-03-19 04:30:31
...
```json
{
    "body": "<a id='comment:16'></a>Looks good to me.  Positive review.",
    "created_at": "2009-03-19T18:16:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47076",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>Looks good to me.  Positive review.
...
```json
{
    "body": "<a id='comment:17'></a>Merged trac_5537_perm_compare.patch in Sage 3.4.1.alpha0.\n\nCheers,\n\nMichael",
    "created_at": "2009-03-23T22:13:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47077",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:17'></a>Merged trac_5537_perm_compare.patch in Sage 3.4.1.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5537#issuecomment-47078",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
