...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] more types for sage_input: vectors, matrices, etc.",
        "to": "[with patch, positive review] more types for sage_input: vectors, matrices, etc."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5101#event-19824"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5101#issuecomment-41361",
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5101#event-19825"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5101#issuecomment-41362",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5101",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5101#event-19826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5101#issuecomment-41363",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5101#issuecomment-41364",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
