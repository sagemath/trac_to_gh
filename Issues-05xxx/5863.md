...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5863#issuecomment-47536",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>If anybody wants these to be in Sage, they should revert this patch, then get the coverage to 100% and get everything up to how things work in Sage now (e.g., coercion model, etc.).  Right now they are used nowhere and have no tests.",
    "created_at": "2009-04-23T06:32:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5863#issuecomment-47537",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>If anybody wants these to be in Sage, they should revert this patch, then get the coverage to 100% and get everything up to how things work in Sage now (e.g., coercion model, etc.).  Right now they are used nowhere and have no tests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5863#issuecomment-47538",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5863#issuecomment-47539",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
