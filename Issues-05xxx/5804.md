...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-48887",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-48888",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-48889",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "rename": {
        "from": "Solaris 10/Sparc: number_of_partitions(100000) is broken",
        "to": "[with patch; needs review] Solaris 10/Sparc: number_of_partitions(100000) is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5804#event-23144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-48890",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5804#event-23145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "rename": {
        "from": "[with patch; needs review] Solaris 10/Sparc: number_of_partitions(100000) is broken",
        "to": "[with patch; positive review] Solaris 10/Sparc: number_of_partitions(100000) is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5804#event-23146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-48891",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-48892",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-48893",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5804#event-23147"
}
```
