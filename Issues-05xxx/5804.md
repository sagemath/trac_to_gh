# Issue 5804: [with patch; positive review] Solaris 10/Sparc: number_of_partitions(100000) is broken
...
```json
{
    ...
    "title": "[with patch; positive review] Solaris 10/Sparc: number_of_partitions(100000) is broken",
    "type": "issue",
...
```json
{
    "body": "<a id='comment:1'></a>I suspect that the use of sqrtl() for the computation of some constants causes the trouble here. Note that it also fails on FreeBSD where Peter has to use sqrt() there since sqrtl() is not available. One potential fix I have in mind is to use MPFR to compute those constants, but I have not investigated the problem.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-16T09:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-46724",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>I suspect that the use of sqrtl() for the computation of some constants causes the trouble here. Note that it also fails on FreeBSD where Peter has to use sqrt() there since sqrtl() is not available. One potential fix I have in mind is to use MPFR to compute those constants, but I have not investigated the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-46726",
...
```json
{
    "body": "<a id='comment:4'></a>Give Bill hart credit too!",
    "created_at": "2009-04-29T01:21:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-46727",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Give Bill hart credit too!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-46728",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-46729",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-46730",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5804#issuecomment-46731",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
