...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64751"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64752"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64753"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64754"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64755"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64757"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5486#issuecomment-34243",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5486#issuecomment-34244",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64758"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64759"
}
```
