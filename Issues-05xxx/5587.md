...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5587#event-66401"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5587#event-66402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5587#event-66403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5587#event-66404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5587",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5587#event-66405"
}
```
