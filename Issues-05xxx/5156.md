...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46948",
    "user": "https://github.com/williamstein"
}
```
...
archive/attachments_005801.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_5156.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket5156/trac_5156.patch",
    "created_at": "2009-02-02T08:35:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "attachment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46949",
    "user": "https://github.com/williamstein"
}
```
...
archive/attachments_005802.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_5156-part2.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket5156/trac_5156-part2.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46950",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46951",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46952",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46953",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46954",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46955",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5156#event-15525"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46956",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46957",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5156#event-15526"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46958",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46959",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46960",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46961",
...
```json
{
    "body": "<a id='comment:12'></a>\nPS I meant to say -- beautiful patch!  Useful functions, well implemented and documented.\n\nThe function `_heegner_index_in_`EK() does not really need the Heegned hypothesis, I think.  You do use the fact that K is imaginary quadratic in the algorithm, but that is all.  So you could change checking Heegner hyp. into checking D<0.  It is also tempting to suggest writing a version which works OK for real quadratic extensions, but I cannot think of a situation when that would be used (though I guess that Darmon might!)\n\nJohn",
    "created_at": "2009-02-15T18:00:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46962",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5156#event-15527"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46963",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5156#event-15528"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46964",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5156#event-15529"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5156#event-15530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46965",
    "user": "https://github.com/rlmill"
}
```
...
archive/attachments_005803.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_5156-rebased_and_flattened.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket5156/trac_5156-rebased_and_flattened.patch",
    "created_at": "2009-04-08T21:24:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46966",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46967",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5156#issuecomment-46968",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5156",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5156#event-15531"
}
```
