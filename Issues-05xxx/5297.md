...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5297#issuecomment-43356",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5297",
    "rename": {
        "from": "[with patch, needs review] sparse vectors and free module elements: pairwise_product is broken",
        "to": "[with patch, positive review] sparse vectors and free module elements: pairwise_product is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5297#event-20786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5297#issuecomment-43357",
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5297#event-20787"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5297#issuecomment-43358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5297#issuecomment-43359",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5297",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5297#event-20788"
}
```
