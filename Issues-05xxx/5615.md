...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5615#event-59746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5615#event-59747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5615#event-59748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5615#event-59749"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5615#event-59750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5615#issuecomment-36771",
    "user": "https://github.com/sagetrac-cwitty"
}
```
