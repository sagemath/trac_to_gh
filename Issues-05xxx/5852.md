...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61120"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61125"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61126"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61127"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61128"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61132"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61134"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61135"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61136"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61137"
}
```
...
```json
{
    ...
    "title_was": "The detection of SAGE_ROOT in $SAGE_ROOT/sage script should expand symlinks recursively",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61142"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61143"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61144"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61145"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61146"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61147"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,3 +11,4 @@\n Apply:\n 1. [attachment: 5852_sage_root.patch.gz](https://github.com/sagemath/sage/files/ticket5852/5852_sage_root.patch.gz) to `SAGE_ROOT`\n 2. [attachment: 5852_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket5852/5852_scripts.patch.gz) to `local/bin`\n+3. [attachment: 5852_doc.patch.gz](https://github.com/sagemath/sage/files/ticket5852/5852_doc.patch.gz) to `devel/sage`\n``````\n",
...
```json
{
    "body": "<a id='comment:42'>Comment 42:</a>\nAdded documentation patch [attachment: 5852_doc.patch.gz](https://github.com/sagemath/sage/files/ticket5852/5852_doc.patch.gz)",
    "created_at": "2011-11-18T09:09:49Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5852",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5852#issuecomment-39015",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61149"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5852#issuecomment-39016",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5852#event-61151"
}
```
