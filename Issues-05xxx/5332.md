...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[a3c87e0](http://git.sagemath.org/sage.git/commit/?id=a3c87e014ae7e7cbbdf1cbef9ca98cf22f71a852)|`#5332 Modernize some examples in rings.polynomial`|",
    "created_at": "2015-04-14T08:19:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5332",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[c098677](http://git.sagemath.org/sage.git/commit/?id=c098677d560ea8b2d7e9ee5a12f58cb89193be3a)|`#5332 Prefer R.<x> = ... to R, x = ....objgen() in examples`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nRebased on sge-6.7.beta0 with a new commit.\n\n---\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[0df8036](http://git.sagemath.org/sage.git/commit/?id=0df8036ad85f000b12875db85bdb42425f8d85f0)|`#5332 Prefer R.<x> = ... to R, x = ....objgen() in examples`|\n|[be20eb8](http://git.sagemath.org/sage.git/commit/?id=be20eb88e7e55711cd67cea4a7848043eb11e92d)|`Trac 5332: remove more objgen(s) from the doc`|",
    "created_at": "2015-04-15T17:57:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5332",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[485ae68](http://git.sagemath.org/sage.git/commit/?id=485ae68429ba1bec374c1aa7b666f2737174189a)|`Trac 5332: fix doctests and documentation`|",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[3a1e77e](http://git.sagemath.org/sage.git/commit/?id=3a1e77e24d49124e0bad4456f0ff8092845a124c)|`#5332 fix doctest fix`|",
    "created_at": "2015-04-18T17:59:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5332",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[ea55f2a](http://git.sagemath.org/sage.git/commit/?id=ea55f2a0b4a31e6cd8cd92163009f25a90eeca1c)|`#5332 fix errors in the last two commits`|",
    "created_at": "2015-04-19T06:08:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5332",
    "type": "issue_comment",
