...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_5845.patch](tarball://root/attachments/some-uuid/ticket5845/trac_5845.patch) by @JohnCremona created at 2009-04-21 10:47:00",
...
<a id='comment:1'></a>Attachment [trac_5845.patch](tarball://root/attachments/some-uuid/ticket5845/trac_5845.patch) by @JohnCremona created at 2009-04-21 10:47:00
...
<a id='comment:3'></a>All doctests pass. It works very well and is a sorely needed addition to sage.
...
```json
{
    "body": "<a id='comment:4'></a>Thanks for the report.  I don't have access to Enge's paper at the moment but I'll see him in person tomorrow so I can perhaps check up on that type (recall that one of his papers had a lot of typos in it, and I took the \"official\" bounds from correspondence with him).",
...
<a id='comment:4'></a>Thanks for the report.  I don't have access to Enge's paper at the moment but I'll see him in person tomorrow so I can perhaps check up on that type (recall that one of his papers had a lot of typos in it, and I took the "official" bounds from correspondence with him).
...
```json
{
    "body": "<a id='comment:5'></a>This needs to rebased against 4.0 since functions/special.py has changed.  The elliptic_j function should be written to match those.",
...
<a id='comment:5'></a>This needs to rebased against 4.0 since functions/special.py has changed.  The elliptic_j function should be written to match those.
...
```json
{
    "body": "<a id='comment:7'></a>I have done the rebasing -- not sure whether it's ok to put back \"with positive review\" to I have marked it \"needs review\" again.",
...
<a id='comment:7'></a>I have done the rebasing -- not sure whether it's ok to put back "with positive review" to I have marked it "needs review" again.
