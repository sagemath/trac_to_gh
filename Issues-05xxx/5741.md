...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5741#issuecomment-48130",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5741#issuecomment-48131",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg; positive review] Detect Atom CPUs as Core2 in the ATLAS detection script"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5741#event-22818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5741",
    "rename": {
        "from": "[with spkg; positive review] Detect Atom CPUs as Core2 in the ATLAS detection script",
        "to": "Detect Atom CPUs as Core2 in the ATLAS detection script"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5741#event-22819"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5741#issuecomment-48132",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5741#issuecomment-48133",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5741#event-22820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5741",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5741#event-22821"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5741#issuecomment-48134",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5741",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5741#issuecomment-48135",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
