...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5980#event-14031"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5980",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5980#event-14032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5980#issuecomment-47403",
...
```json
{
    "body": "Ahh, I looked at the timeline to make sure there wasn't a ticket already, but Jaap did open this more or less at the same time. And he beat me to it, but since I attached a workaround patch to #5981 I am closing this one as a dupe ;)\n\nCheers,\n\nMichael",
    "created_at": "2009-05-04T16:49:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5980",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5980#issuecomment-47404",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
