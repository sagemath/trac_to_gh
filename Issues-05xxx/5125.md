# Issue 5125: [with patch, positive review] Ideal.basis_is_groebner() may return wrong results
...
```json
{
    ...
    "title": "[with patch, positive review] Ideal.basis_is_groebner() may return wrong results",
    "type": "issue",
