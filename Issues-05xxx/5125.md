...
archive/attachments_005967.json:
```json
{
...
```json
{
    "body": "**Attachment:** [B.sobj](https://github.com/sagemath/sage/files/ticket5125/B.sobj)\n\nload(\"B.sobj\") this file to test if the bug is fixed.",
    "created_at": "2009-01-29T00:02:41Z",
    "issue": "https://github.com/sagemath/sage/issues/5125",
    "type": "issue_comment",
...
**Attachment:** [B.sobj](https://github.com/sagemath/sage/files/ticket5125/B.sobj)
...
archive/attachments_005968.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [basis_is_groebner.patch](https://github.com/sagemath/sage/files/ticket5125/basis_is_groebner.patch)\n\nnow it works on `B.sobj` as well as on its groebner basis",
    "created_at": "2009-01-30T23:24:11Z",
    "issue": "https://github.com/sagemath/sage/issues/5125",
    "type": "issue_comment",
...
**Attachment:** [basis_is_groebner.patch](https://github.com/sagemath/sage/files/ticket5125/basis_is_groebner.patch)
...
archive/attachments_005969.json:
```json
{
    "asset_content_type": "application/octet-stream",
