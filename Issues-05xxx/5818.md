...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50176",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This is also very useful for binaries, i.e. if SAGE_SIMD_MODE is set to SSE2 we should only build for a P4 for example.\n\nCheers,\n\nMichael",
    "created_at": "2009-05-15T14:29:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50177",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>This is also very useful for binaries, i.e. if SAGE_SIMD_MODE is set to SSE2 we should only build for a P4 for example.
...
```json
{
    "body": "<a id='comment:3'></a>This isn't critical for 4.0.",
    "created_at": "2009-05-28T06:51:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50179",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>This isn't critical for 4.0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50180",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>outdated after mpir removal",
    "created_at": "2021-12-02T01:01:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50181",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:10'></a>outdated after mpir removal
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50182",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50183",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50184",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50185",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5818#issuecomment-50186",
    "user": "https://github.com/mkoeppe"
}
```
