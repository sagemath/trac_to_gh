...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5068#issuecomment-40974",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5068",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5068#issuecomment-40975",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5068",
    "rename": {
        "from": "change_ring fails for polynomials over finite fields in many cases",
        "to": "[with patch; needs review] change_ring fails for polynomials over finite fields in many cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5068#event-19645"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5068",
    "rename": {
        "from": "[with patch; needs review] change_ring fails for polynomials over finite fields in many cases",
        "to": "[with patch; positive review] change_ring fails for polynomials over finite fields in many cases"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5068#event-19646"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5068",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5068#issuecomment-40976",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5068",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5068#issuecomment-40977",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5068",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5068#issuecomment-40978",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5068",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5068#event-19647"
}
```
