...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5099#issuecomment-32234",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5099#issuecomment-32235",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5099/matrix_fix_again-fh.patch",
    "created_at": "2009-03-01T22:09:20Z",
    "issue": "https://github.com/sagemath/sage/issues/5099",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5099/matrix_fix_again-fh.patch",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "Attachment [matrix_fix_again-fh.patch](https://github.com/sagemath/sage/files/ticket5099/matrix_fix_again-fh.patch) by @hivert created at 2009-03-01 22:09:20\n\nPatch proposal",
    "created_at": "2009-03-01T22:09:20Z",
    "issue": "https://github.com/sagemath/sage/issues/5099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5099#issuecomment-32236",
    "user": "https://github.com/hivert"
}
```

Attachment [matrix_fix_again-fh.patch](https://github.com/sagemath/sage/files/ticket5099/matrix_fix_again-fh.patch) by @hivert created at 2009-03-01 22:09:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5099#issuecomment-32237",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5099#issuecomment-32238",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5099",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5099#issuecomment-32239",
