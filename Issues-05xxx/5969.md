...
```json
{
    ...
    "asset_name": "trac_5969-part1.patch",
    "asset_url": "tarball://root/attachments/ticket5969/trac_5969-part1.patch",
    "created_at": "2009-09-16T04:50:01Z",
    "issue": "https://github.com/sagemath/sage/issues/5969",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5969/trac_5969-part1.patch",
    "user": "https://github.com/williamstein"
}
```
...
archive/attachments_007171.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_5969-part1.patch](https://github.com/sagemath/sage/files/ticket5969/trac_5969-part1.patch)\n\n**Attachment:** [trac_5969-part2.patch](https://github.com/sagemath/sage/files/ticket5969/trac_5969-part2.patch)",
    "created_at": "2009-09-16T04:50:01Z",
    "issue": "https://github.com/sagemath/sage/issues/5969",
    "type": "issue_comment",
...
**Attachment:** [trac_5969-part1.patch](https://github.com/sagemath/sage/files/ticket5969/trac_5969-part1.patch)
...
archive/attachments_007172.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac-5969-part3.patch](https://github.com/sagemath/sage/files/ticket5969/trac-5969-part3.patch)",
    "created_at": "2010-01-21T19:36:24Z",
    "issue": "https://github.com/sagemath/sage/issues/5969",
    "type": "issue_comment",
...
**Attachment:** [trac-5969-part3.patch](https://github.com/sagemath/sage/files/ticket5969/trac-5969-part3.patch)
...
archive/attachments_007173.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_5969-part4.patch](https://github.com/sagemath/sage/files/ticket5969/trac_5969-part4.patch)\n\nI just checked that all four patches apply fine to sage-4.3.5 still with no rebasing necessary.",
    "created_at": "2010-03-30T00:47:12Z",
    "issue": "https://github.com/sagemath/sage/issues/5969",
    "type": "issue_comment",
...
archive/attachments_007174.json:
```json
{
    "asset_content_type": "application/octet-stream",
