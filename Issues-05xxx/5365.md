...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [t2.png](https://github.com/sagemath/sage/files/ticket5365/t2.png) by ekirkman created at 2009-02-24 23:48:52\n\nThe picture attachment (t2.png) is the current buggy output.  I will post another picture example with my patch this evening.",
    "created_at": "2009-02-24T23:48:52Z",
    "issue": "https://github.com/sagemath/sage/issues/5365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5365#issuecomment-34342",
    "user": "https://trac.sagemath.org/admin/accounts/users/ekirkman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5365#issuecomment-34343",
    "user": "https://trac.sagemath.org/admin/accounts/users/ekirkman"
}
```
