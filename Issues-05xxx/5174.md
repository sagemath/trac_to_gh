...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43138",
...
```json
{
    "body": "<a id='comment:1'></a>Idea:\n\n```\nsage: obj = random_matrix(ZZ,100)\nsage: str(obj) + \" ('print obj.str()' to see all entries)\"\n```",
    "created_at": "2009-12-11T23:29:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43139",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Idea:
...
```json
{
    "body": "<a id='comment:2'></a>Change this function in matrix/matrix0.pyx:\n\n```\n    def __repr__(self):\n        if self._nrows < max_rows and self._ncols < max_cols:\n            return self.str()\n        if self.is_sparse():\n            s = 'sparse'\n        else:\n            s = 'dense'\n        return \"%s x %s %s matrix over %s\"%(self._nrows, self._ncols, s, self.base_ring())\n```",
    "created_at": "2009-12-11T23:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43140",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Change this function in matrix/matrix0.pyx:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43141",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43142",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43145",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Here's a new version of the patch.  This is similar to the old one, but it behaves like this:\n\n```\n     sage: C.differential()\n     {0: 40 x 40 dense matrix over Integer Ring, 1: []}\n```",
    "created_at": "2009-12-20T06:32:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43146",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>Here's a new version of the patch.  This is similar to the old one, but it behaves like this:
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_5174-matrixrep-v2.patch](tarball://root/attachments/some-uuid/ticket5174/trac_5174-matrixrep-v2.patch) by @mwhansen created at 2009-12-27 15:38:23\n\nThe second patch looks good to me.",
    "created_at": "2009-12-27T15:38:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43147",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>Attachment [trac_5174-matrixrep-v2.patch](tarball://root/attachments/some-uuid/ticket5174/trac_5174-matrixrep-v2.patch) by @mwhansen created at 2009-12-27 15:38:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43148",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43149",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43150",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5174#issuecomment-43151",
    "user": "https://github.com/mwhansen"
}
```
