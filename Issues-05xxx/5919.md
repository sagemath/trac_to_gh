...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5919#issuecomment-50368",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5919#issuecomment-50369",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5919",
    "rename": {
        "from": "[with patch, needs review] bug in conversion of polys over GF(2,e) from NTL to singular",
        "to": "[with patch, positive review] bug in conversion of polys over GF(2,e) from NTL to singular"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5919#event-23639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5919#issuecomment-50370",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5919#issuecomment-50371",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5919",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5919#event-23640"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5919#issuecomment-50372",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
