...
```json
{
    "body": "Changed keywords from **** to **discrete logarithm, speedup**",
...
Changed keywords from **** to **discrete logarithm, speedup**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5088#issuecomment-32121",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5088#issuecomment-32122",
    "user": "https://github.com/slel"
}
```
