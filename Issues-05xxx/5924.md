...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39639",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39640",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5924/trac_5924.patch",
    "created_at": "2009-05-01T11:16:36Z",
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5924/trac_5924.patch",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_5924.patch](https://github.com/sagemath/sage/files/ticket5924/trac_5924.patch) by @loefflerd created at 2009-05-01 11:16:36\n\nPositive review. The above code works fine for me (modulo a tiny typo fix), so I've made a proper patch for it. Note that although this has my mercurial username on the patch, credit should go to Lloyd.",
    "created_at": "2009-05-01T11:16:36Z",
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39641",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39642",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39643",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39644",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39645",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39646",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-39647",
    "user": "https://github.com/loefflerd"
}
```
