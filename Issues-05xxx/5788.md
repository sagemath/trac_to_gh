...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, needs review] Fix MPIR build problem on OSX 10.4 exposed by linbox, update to latest upstream"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5788#event-23040"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5788#issuecomment-48599",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5788#issuecomment-48600",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5788",
    "rename": {
        "from": "[with spkg, needs review] Fix MPIR build problem on OSX 10.4 exposed by linbox, update to latest upstream",
        "to": "[with spkg, positive review] Fix MPIR build problem on OSX 10.4 exposed by linbox, update to latest upstream"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5788#event-23041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5788#issuecomment-48601",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5788#issuecomment-48602",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5788",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5788#event-23042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5788#issuecomment-48603",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
