...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50275",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50276",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50277",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50278",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is solved now (4.4.4)\n\n```\nsage: K.<w> = QuadraticField(-1)\nsage: KX.<X> = K[]\nsage: H.<h> = K.extension(X-1)\nsage: H(w)\nw\nsage: H._NumberField_relative__base_inclusion(w)\nw\n```\n\n```\nsage: K.<w> = QuadraticField(-1);\nsage: KX.<X> = K[]\nsage: H.<h> =K.hilbert_class_field()\nsage: (X + w + 1).base_extend(H)\nX + w + 1\n```\n\nThe bug should be closed, at most add the attached doctest.",
    "created_at": "2010-07-02T13:27:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50279",
    "user": "https://github.com/lftabera"
}
```

<a id='comment:3'></a>This is solved now (4.4.4)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50280",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50281",
...
```json
{
    "body": "<a id='comment:4'></a>The tests should be indented, and you should only have \"::\" only on the last line before the test.\nThe patch now has\n\n```\n        TESTS::\n\n        Check that #5828 is solved::\n\n        sage: K.<w> = QuadraticField(-1)\n        sage: KX.<X> = K[]\n        sage: H.<h> = K.extension(X-1)\n        sage: H(w)\n        w\n```\nbut I think it should be\n\n```\n        TESTS:\n\n        Check that #5828 is solved::\n\n            sage: K.<w> = QuadraticField(-1)\n            sage: KX.<X> = K[]\n            sage: H.<h> = K.extension(X-1)\n            sage: H(w)\n            w\n```",
    "created_at": "2010-07-22T17:54:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50282",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:4'></a>The tests should be indented, and you should only have "::" only on the last line before the test.
The patch now has
...
```json
{
    "body": "Changing work_issues from \"\" to \"reST formatting\"",
    "created_at": "2010-07-22T17:54:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50283",
    "user": "https://github.com/mstreng"
}
```

Changing work_issues from "" to "reST formatting"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50284",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50285",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac_5828_already_solved.patch](tarball://root/attachments/some-uuid/ticket5828/trac_5828_already_solved.patch) by @lftabera created at 2010-07-26 12:52:15\n\nYou are right, \n\nI have updated the patch accordingly.\n\nThanks",
    "created_at": "2010-07-26T12:52:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50286",
    "user": "https://github.com/lftabera"
}
```

<a id='comment:5'></a>Attachment [trac_5828_already_solved.patch](tarball://root/attachments/some-uuid/ticket5828/trac_5828_already_solved.patch) by @lftabera created at 2010-07-26 12:52:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50287",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50288",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50289",
...
```json
{
    "body": "Changing work_issues from \"reST formatting\" to \"\"",
    "created_at": "2010-08-09T09:41:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50290",
    "user": "https://github.com/qed777"
}
```

Changing work_issues from "reST formatting" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5828",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5828#issuecomment-50291",
    "user": "https://github.com/qed777"
}
```
