...
```json
{
    "body": "<a id='comment:2'></a>A closely related issue is #3979.",
...
<a id='comment:2'></a>A closely related issue is #3979.
...
```json
{
    "body": "<a id='comment:3'></a>I tried to apply this against 4.7.1.rc1 and got a bunch of merge failures in power_series_poly.pyx. Probably another trivial rebase is needed.",
    "created_at": "2011-08-01T08:12:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5075",
    "type": "issue_comment",
...
<a id='comment:3'></a>I tried to apply this against 4.7.1.rc1 and got a bunch of merge failures in power_series_poly.pyx. Probably another trivial rebase is needed.
...
```json
{
    "body": "<a id='comment:10'></a>Ping. Is this issue due to be resolved by other developments on p-adics?",
...
<a id='comment:10'></a>Ping. Is this issue due to be resolved by other developments on p-adics?
...
```json
{
    "body": "<a id='comment:11'></a>Ping again. The original example still behaves the same way in Sage 8.0.",
...
<a id='comment:11'></a>Ping again. The original example still behaves the same way in Sage 8.0.
