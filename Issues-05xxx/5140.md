...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42746",
    "user": "https://trac.sagemath.org/admin/accounts/users/lars.fischer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42748",
    "user": "https://trac.sagemath.org/admin/accounts/users/lars.fischer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Hello Michael,\n\nI exported the modification and attached the file as irred_bug_fix.export.patch. \nSorry for the inconvenience.\n\nWith best regards,\nLars",
    "created_at": "2009-01-31T13:14:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42749",
    "user": "https://trac.sagemath.org/admin/accounts/users/lars.fischer"
}
```

<a id='comment:2'></a>Hello Michael,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42751",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42752",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42753",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Since John posted an updated patch I am marking this as \"needs review\". From the history it seems that there are some unresolved issues, so feel free to change it to \"needs work\".\n\nCheers,\n\nMichael",
    "created_at": "2009-04-06T06:02:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42755",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Since John posted an updated patch I am marking this as "needs review". From the history it seems that there are some unresolved issues, so feel free to change it to "needs work".
...
```json
{
    "body": "<a id='comment:6'></a>I just checked that my patch trac_5140_rebase.patch still applies fine to 3.4.rc0, and tests still pass.  That patch dealt with all the issues which I came up against when testing, so as far as I am concerned it is ready to go, but I agree that an independent reviewer is needed since I touched quite a few other things.  Anyone familiar with basic ring stuff could do it!",
    "created_at": "2009-04-06T10:26:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42756",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:6'></a>I just checked that my patch trac_5140_rebase.patch still applies fine to 3.4.rc0, and tests still pass.  That patch dealt with all the issues which I came up against when testing, so as far as I am concerned it is ready to go, but I agree that an independent reviewer is needed since I touched quite a few other things.  Anyone familiar with basic ring stuff could do it!
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [AlexGhitza](#comment%3A7):  Thanks, Alex!",
    "created_at": "2009-04-09T08:45:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42757",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>Replying to [AlexGhitza](#comment%3A7):  Thanks, Alex!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42758",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Merged trac_5140_rebase.patch in Sage 3.4.1.rc2.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-09T09:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5140#issuecomment-42759",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Merged trac_5140_rebase.patch in Sage 3.4.1.rc2.
