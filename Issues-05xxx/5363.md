...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43987",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "rename": {
        "from": "Sage 3.4.alpha0: -sdist issue: MANIFEST.in needs to add the missing 186 files",
        "to": "[with patch, needs review] Sage 3.4.alpha0: -sdist issue: MANIFEST.in needs to add the missing 186 files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5363#event-21077"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43988",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43989",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "rename": {
        "from": "[with patch, needs review] Sage 3.4.alpha0: -sdist issue: MANIFEST.in needs to add the missing 186 files",
        "to": "[with patch,positive review] Sage 3.4.alpha0: -sdist issue: MANIFEST.in needs to add the missing 186 files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5363#event-21078"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43990",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "rename": {
        "from": "[with patch,positive review] Sage 3.4.alpha0: -sdist issue: MANIFEST.in needs to add the missing 186 files",
        "to": "[with patch, positive review] Sage 3.4.alpha0: -sdist issue: MANIFEST.in needs to add the missing 186 files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5363#event-21079"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43991",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43992",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43993",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5363#issuecomment-43994",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5363",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5363#event-21080"
}
```
