...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5144#issuecomment-41788",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5144",
    "rename": {
        "from": "[with patch, needs review] speed up right_nullity for matrices",
        "to": "[with patch, positive review] speed up right_nullity for matrices"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5144#event-20064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5144",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5144#issuecomment-41789",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5144",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5144#issuecomment-41790",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5144",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5144#event-20065"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5144",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5144#issuecomment-41791",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
