...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[a2ae8c8](http://git.sagemath.org/sage.git/commit/?id=a2ae8c869553c8aff5404ef2cfcaf95d2f8eac52)|`Fix error in singular_version()`|",
