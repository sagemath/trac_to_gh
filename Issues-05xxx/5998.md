...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64585"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64586"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64587"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64588"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5998#issuecomment-40557",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5998#issuecomment-40558",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5998",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64591"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5998#event-64592"
}
```
