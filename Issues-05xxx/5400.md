...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5400#event-55463"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5400#event-55464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5400#event-55465"
}
```
...
```json
{
    "body": "Changed assignee from **cwitty** to **@robertwb**",
...
Changed assignee from **cwitty** to **@robertwb**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5400#event-55466"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5400#event-55467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5400#issuecomment-34695",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5400",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5400#event-55468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5400#issuecomment-34696",
    "user": "https://github.com/sagetrac-mvngu"
}
```
