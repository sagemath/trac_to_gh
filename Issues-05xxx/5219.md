...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42518",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42519",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42520",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42521",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20385"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20386"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42522",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20388"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "rename": {
        "from": "Build ATLAS in dist mode with SSE2 only",
        "to": "[with spkg, needs review] Build ATLAS in dist mode with SSE2 only"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42523",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42524",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "rename": {
        "from": "[with spkg, needs review] Build ATLAS in dist mode with SSE2 only",
        "to": "[with spkg, positive review] Build ATLAS in dist mode with SSE2 only"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20391"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-20392"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42525",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-42526",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
