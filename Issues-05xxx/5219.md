...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40964",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40967",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-12087"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-12088"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-12089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40968",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-12090"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-12091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40969",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The spkg that fixes three tickets (#5219, #5741, #5742) is at\n\n  http://sage.math.washington.edu/home/mabshoff/release-cycles-3.4.1/rc4/atlas-3.8.3.p1.spkg\n\nTo test SSE2 only builds set SAGE_SIMD_MODE to \"SSE2\".\n\nCheers,\n\nMichael",
    "created_at": "2009-04-18T06:55:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40970",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>The spkg that fixes three tickets (#5219, #5741, #5742) is at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40971",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5219#event-12092"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Merged in Sage 3.4.1.rc4.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-18T23:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40972",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged in Sage 3.4.1.rc4.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5219#issuecomment-40973",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
