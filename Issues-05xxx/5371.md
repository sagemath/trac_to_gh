...
```json
{
    "body": "<a id='comment:1'></a>I like Marshall's suggestion of 5 minutes for autosave and a history of length say 100.   Decreasing the history length likely won't have much of an impact on space usage, since the history is 1-file per user.",
    "created_at": "2009-02-26T01:23:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45076",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>I like Marshall's suggestion of 5 minutes for autosave and a history of length say 100.   Decreasing the history length likely won't have much of an impact on space usage, since the history is 1-file per user.
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_5371_worsheet_save_time.patch](tarball://root/attachments/some-uuid/ticket5371/trac_5371_worsheet_save_time.patch) by @rbeezer created at 2009-03-07 20:01:10\n\nReplying to [comment:1 was]:\nSince I was working through this in my own setup, I've added a patch increasing default save time to 1 hour (William Stein's latest suggestion on sage-support) and taking history length down to 100.\n\nI've added documentation on how to change these values for an existing notebook.\n\nSee related #5291 and #5300",
    "created_at": "2009-03-07T20:01:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45077",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:2'></a>Attachment [trac_5371_worsheet_save_time.patch](tarball://root/attachments/some-uuid/ticket5371/trac_5371_worsheet_save_time.patch) by @rbeezer created at 2009-03-07 20:01:10
...
```json
{
    "body": "<a id='comment:4'></a>Well, these are trivial doctest failures since the defaults have been changed, patch coming up.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-13T03:42:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45079",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Well, these are trivial doctest failures since the defaults have been changed, patch coming up.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45080",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45081",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Bouncing this since no one seems to be working on this.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-17T22:48:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45082",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Bouncing this since no one seems to be working on this.
...
```json
{
    "body": "<a id='comment:7'></a>That second reviewer patch fails for me since I don't have a directory \"/home/mabshoff/\".  I think that's why the original patch didn't have sage: lines there.  What do you think, mabshoff?",
    "created_at": "2009-04-22T10:54:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45083",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:7'></a>That second reviewer patch fails for me since I don't have a directory "/home/mabshoff/".  I think that's why the original patch didn't have sage: lines there.  What do you think, mabshoff?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45084",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45085",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I was looking at this because I've been having problems with the notebook lately due to excessive creation of snapshots. I applied the original patch and the first reviewer patch against 4.0.rc2. They look fine, pass doctests in sage/server, and perform as expected. Positive review for them. \n\nI didn't apply the second reviewer patch, and I agree with Rob's argument that it isn't necessary. I should add that I did find the docstring extremely helpful in clearing up a problem with my existing notebook server, so I'd like that to stay in.",
    "created_at": "2009-05-31T01:59:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45086",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:10'></a>I was looking at this because I've been having problems with the notebook lately due to excessive creation of snapshots. I applied the original patch and the first reviewer patch against 4.0.rc2. They look fine, pass doctests in sage/server, and perform as expected. Positive review for them. 
...
```json
{
    "body": "<a id='comment:11'></a>I think the initial \"doctest\" at the beginning of the file should be removed.  As it is, none of the patches have valid rest markup.\n\nSo, just remove the bit at the beginning of the first patch and I'll merge it along with the patch that has the simple doctest fixes.",
    "created_at": "2009-06-04T18:08:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45087",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:11'></a>I think the initial "doctest" at the beginning of the file should be removed.  As it is, none of the patches have valid rest markup.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45088",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [trac_5371_worksheet_save_time_version2.patch](tarball://root/attachments/some-uuid/ticket5371/trac_5371_worksheet_save_time_version2.patch) by @rbeezer created at 2009-06-05 04:10:17\n\nFourth patch is identical to first, but with docstring removed, so it only changes default values for a newly created notebook.\n\nPresumably this will all get sorted out with a notebook overhaul.  If not, the content of that docstring should probably go somewhere (the wiki?) where folks can find it, since it gives instructions for a fix that cannot be enacted to existing servers through a patch.",
    "created_at": "2009-06-05T04:10:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45089",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:12'></a>Attachment [trac_5371_worksheet_save_time_version2.patch](tarball://root/attachments/some-uuid/ticket5371/trac_5371_worksheet_save_time_version2.patch) by @rbeezer created at 2009-06-05 04:10:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45091",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Rob Beezer, Kiran Kedlaya\"",
    "created_at": "2009-06-13T23:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45092",
    "user": "https://github.com/ncalexan"
}
```

Changing reviewer from "" to "Rob Beezer, Kiran Kedlaya"
...
```json
{
    "body": "Changing author from \"\" to \"Michael Abshoff, Rob Beezer\"",
    "created_at": "2009-06-13T23:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45093",
    "user": "https://github.com/ncalexan"
}
```

Changing author from "" to "Michael Abshoff, Rob Beezer"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5371#issuecomment-45094",
    "user": "https://github.com/ncalexan"
}
```
