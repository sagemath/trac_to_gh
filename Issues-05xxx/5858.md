...
```json
{
    "body": "<a id='comment:2'></a>Attachment [octave-native-execute.patch](tarball://root/attachments/some-uuid/ticket5858/octave-native-execute.patch) by jjh created at 2009-09-11 04:46:47",
...
<a id='comment:2'></a>Attachment [octave-native-execute.patch](tarball://root/attachments/some-uuid/ticket5858/octave-native-execute.patch) by jjh created at 2009-09-11 04:46:47
...
```json
{
    "body": "<a id='comment:3'></a>This seems to fix the problem. Octave passes all doctests on my machine.",
...
<a id='comment:3'></a>This seems to fix the problem. Octave passes all doctests on my machine.
...
```json
{
    "body": "<a id='comment:4'></a>The fix looks right, applies to my tree, and -optional doctests pass.",
...
<a id='comment:4'></a>The fix looks right, applies to my tree, and -optional doctests pass.
...
```json
{
    "body": "<a id='comment:5'></a>(-optional on octave.py, that is).",
...
<a id='comment:5'></a>(-optional on octave.py, that is).
