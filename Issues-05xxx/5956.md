...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62278"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62280"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62291"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -41,3 +41,7 @@\n ValueError: width and height must each be below 32768\n ```\n Essentially, the documentation for `show()` needs to be updated, especially the optional arguments, to clearly explain the units of measurement of the width and height of the image size. Also, it would be a good idea to specify how one can pass in values for those dimensions. For example, can one do this `figsize=[124,124]`?\n+\n+---\n+\n+Apply only [attachment: trac_5956_figsize_units.1.patch.gz](https://github.com/sagemath/sage/files/ticket5956/trac_5956_figsize_units.1.patch.gz) to devel/sage.\n``````\n",
    "created_at": "2013-02-02T08:46:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -44,4 +44,4 @@\n \n ---\n \n-Apply only [attachment: trac_5956_figsize_units.1.patch.gz](https://github.com/sagemath/sage/files/ticket5956/trac_5956_figsize_units.1.patch.gz) to devel/sage.\n+Apply [and [attachment: trac_5956-reviewer.patch.gz](https://github.com/sagemath/sage/files/ticket5956/trac_5956-reviewer.patch.gz)(https://github.com/sagemath/sage/files/ticket5956/69d51365e232ce6d43efa0dbb15a31d8.gz) to devel/sage.\n``````\n",
    "created_at": "2013-03-23T02:24:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62296"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62297"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62298"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62299"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62300"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62301"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62302"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62305"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62306"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62307"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5956#issuecomment-39977",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5956#issuecomment-39978",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5956#issuecomment-39979",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62311"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5956#event-62313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5956#issuecomment-39980",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5956#issuecomment-39981",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5956#issuecomment-39982",
    "user": "https://github.com/kcrisman"
}
```
