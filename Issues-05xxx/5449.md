...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56077"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56078"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56079"
}
```
...
```json
{
    "body": "Changed keywords from **** to **cached_method, cache**",
...
Changed keywords from **** to **cached_method, cache**
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56080"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56081"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56084"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5449#issuecomment-35153",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56085"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5449#issuecomment-35154",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5449",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56086"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56087"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-56088"
}
```
