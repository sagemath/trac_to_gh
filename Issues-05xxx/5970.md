...
archive/attachments_007175.json:
```json
{
...
```json
{
    "body": "**Attachment:** [WeakReferences.patch](https://github.com/sagemath/sage/files/ticket5970/WeakReferences.patch)\n\nIntroduce Weak Reference to the cache of PolynomialRing",
    "created_at": "2009-05-03T07:22:11Z",
    "issue": "https://github.com/sagemath/sage/issues/5970",
    "type": "issue_comment",
...
**Attachment:** [WeakReferences.patch](https://github.com/sagemath/sage/files/ticket5970/WeakReferences.patch)
...
archive/attachments_007176.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [test.sage](https://github.com/sagemath/sage/files/ticket5970/test.sage)\n\nsimple-minded test suite",
    "created_at": "2009-05-03T08:02:38Z",
    "issue": "https://github.com/sagemath/sage/issues/5970",
    "type": "issue_comment",
...
**Attachment:** [test.sage](https://github.com/sagemath/sage/files/ticket5970/test.sage)
...
archive/attachments_007177.json:
```json
{
    "asset_content_type": "application/octet-stream",
