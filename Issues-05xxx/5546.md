...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58848"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5546#issuecomment-36070",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5546#issuecomment-36072",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58856"
}
```
...
```json
{
    "body": "<a id='comment:5'>Comment 5:</a>\nThe necessary changes for pynac, i.e., [attachment: pynac-hash_exception.patch,.gz](https://github.com/sagemath/sage/files/ticket5546/f714254b17b1f111c6fe31661bc7950e.gz) is included in the new package for pynac-0.1.6 at #5777. The doctests in [attachment: 5546_doctests.patch.gz](https://github.com/sagemath/sage/files/ticket5546/5546_doctests.patch.gz) are also posted in #5777.\n\nThis now introduces a circular dependency in trac. I hope this won't cause problems, since all these patches will go in together. Faster reviews in the future may prevent this from happening again.\n\n\nNote that only:\n\n* [attachment: trac_5546-1-pynac_matrix_vector.patch.gz](https://github.com/sagemath/sage/files/ticket5546/trac_5546-1-pynac_matrix_vector.patch.gz)\n* [attachment: trac_5546-2-pynac_derivative.patch.gz](https://github.com/sagemath/sage/files/ticket5546/trac_5546-2-pynac_derivative.patch.gz)\n\nneeds to be applied from this ticket.",
    "created_at": "2009-05-05T23:30:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5546#issuecomment-36073",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5546#issuecomment-36074",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58857"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58859"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5546#event-58860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5546#issuecomment-36075",
