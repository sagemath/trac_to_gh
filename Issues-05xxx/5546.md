...
```json
{
    ...
    "asset_name": "trac_5546-1-pynac_matrix_vector.patch",
    "asset_url": "tarball://root/attachments/ticket5546/trac_5546-1-pynac_matrix_vector.patch",
    "created_at": "2009-03-24T16:33:56Z",
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5546/trac_5546-1-pynac_matrix_vector.patch",
    "user": "https://github.com/burcin"
}
```
...
archive/attachments_006531.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [pynac-hash_exception.patch](https://github.com/sagemath/sage/files/ticket5546/pynac-hash_exception.patch)\n\npatch to pynac to handle exceptions during hashing",
    "created_at": "2009-04-24T15:34:24Z",
    "issue": "https://github.com/sagemath/sage/issues/5546",
    "type": "issue_comment",
...
**Attachment:** [pynac-hash_exception.patch](https://github.com/sagemath/sage/files/ticket5546/pynac-hash_exception.patch)
...
archive/attachments_006532.json:
```json
{
    "asset_content_type": "application/octet-stream",
