...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66961"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66964"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66965"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5645#issuecomment-35687",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5645#issuecomment-35688",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5645#issuecomment-35689",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66966"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5645#issuecomment-35690",
    "user": "https://github.com/sagetrac-mvngu"
}
```
