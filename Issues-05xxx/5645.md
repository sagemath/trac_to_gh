...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-58550"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-58551"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-58552"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-58553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5645#issuecomment-36989",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-58554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5645#issuecomment-36990",
    "user": "https://github.com/sagetrac-mvngu"
}
```
