...
archive/attachments_007116.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_5929-fix_assumption_hang.patch](https://github.com/sagemath/sage/files/ticket5929/trac_5929-fix_assumption_hang.patch)\n\nfix (workaround) for out of sync hang which timeouts a doctest",
    "created_at": "2009-05-11T03:32:52Z",
    "issue": "https://github.com/sagemath/sage/issues/5929",
    "type": "issue_comment",
...
**Attachment:** [trac_5929-fix_assumption_hang.patch](https://github.com/sagemath/sage/files/ticket5929/trac_5929-fix_assumption_hang.patch)
...
archive/attachments_007117.json:
```json
{
    "asset_content_type": "application/octet-stream",
