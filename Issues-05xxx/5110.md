...
```json
{
    "body": "<a id='comment:5'></a>What exactly should be added to diagonal_matrix? I'd be happy to work on this ticket but it looks like the other patches in #3704 add doctests.",
...
<a id='comment:5'></a>What exactly should be added to diagonal_matrix? I'd be happy to work on this ticket but it looks like the other patches in #3704 add doctests.
...
```json
{
    "body": "<a id='comment:6'></a>I think the idea is to use attachment:trac-3704-diagonal_matrix.patch:ticket:3704 to make a more generally applicable function.\n\nThat said, there are probably more important tickets to work on, notably reviewing many in symbolics ...",
...
<a id='comment:6'></a>I think the idea is to use attachment:trac-3704-diagonal_matrix.patch:ticket:3704 to make a more generally applicable function.
...
<a id='comment:7'></a>I did see that patch, but looking at the source code for diagonal_matrix(), the differences seem to be
...
```json
{
    "body": "<a id='comment:8'></a>This is probably solved by #10604 (please check).",
    "created_at": "2019-12-14T00:07:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5110",
    "type": "issue_comment",
...
<a id='comment:8'></a>This is probably solved by #10604 (please check).
...
```json
{
    "body": "<a id='comment:9'></a>I think so as well.",
    "created_at": "2019-12-27T17:13:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5110",
    "type": "issue_comment",
...
<a id='comment:9'></a>I think so as well.
