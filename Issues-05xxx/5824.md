...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50224",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50226",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50227",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50228",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50229",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>If we're deprecating dsage, I think we should remove its section from the tutorial.  (Remove the file 'distributed.rst' and delete the appropriate line from 'index.rst'.) I can provide a patch if you think it's a good idea.\n\nI've never been convinced that it belonged there anyway, but that's another issue...",
    "created_at": "2009-04-19T20:21:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50230",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>If we're deprecating dsage, I think we should remove its section from the tutorial.  (Remove the file 'distributed.rst' and delete the appropriate line from 'index.rst'.) I can provide a patch if you think it's a good idea.
...
```json
{
    "body": "<a id='comment:7'></a>Michael did have one interesting point in chat, which is that if you do\n\n```\nrm -rf devel/sage/build\n```\nthen dsage is gone too, so it has to be reinstalled.\n\nNote that `sage -ba` does not do `rm -rf devel/sage/build`, but instead just touches all cython files.",
    "created_at": "2009-04-19T23:50:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50233",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:7'></a>Michael did have one interesting point in chat, which is that if you do
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50234",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50235",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Positive review. Some of the files removed had some slight rejects, but I rebased the patch :)\n\nCheers,\n\nMichael",
    "created_at": "2009-04-30T09:56:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50236",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Positive review. Some of the files removed had some slight rejects, but I rebased the patch :)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5824#event-13689"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5824#event-13690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50237",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5824#issuecomment-50238",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
