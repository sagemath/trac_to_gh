...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5569#issuecomment-36286",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5569/weil_restriction.patch",
    "created_at": "2009-03-20T00:06:15Z",
    "issue": "https://github.com/sagemath/sage/issues/5569",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5569/weil_restriction.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "Attachment [weil_restriction.patch](https://github.com/sagemath/sage/files/ticket5569/weil_restriction.patch) by @malb created at 2009-03-20 00:06:15",
    "created_at": "2009-03-20T00:06:15Z",
    "issue": "https://github.com/sagemath/sage/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5569#issuecomment-36287",
    "user": "https://github.com/malb"
}
```

Attachment [weil_restriction.patch](https://github.com/sagemath/sage/files/ticket5569/weil_restriction.patch) by @malb created at 2009-03-20 00:06:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5569#issuecomment-36288",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5569#issuecomment-36289",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5569#issuecomment-36290",
