...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] weil restriction of scalars",
        "to": "[with patch, needs work] weil restriction of scalars"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5569#event-22094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5569#issuecomment-46370",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5569#issuecomment-46371",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "rename": {
        "from": "[with patch, needs work] weil restriction of scalars",
        "to": "[with patch, needs review] weil restriction of scalars"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5569#event-22095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5569#issuecomment-46372",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] weil restriction of scalars",
        "to": "[with patch, positive review] weil restriction of scalars"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5569#event-22096"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5569#issuecomment-46373",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5569#issuecomment-46374",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5569#event-22097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5569#issuecomment-46375",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
