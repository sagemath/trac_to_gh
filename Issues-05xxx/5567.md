...
<a id='comment:2'></a>This has bitrottet, please rebase:
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [region_plot.patch](tarball://root/attachments/some-uuid/ticket5567/region_plot.patch) by whuss created at 2009-04-17 14:55:20",
...
<a id='comment:3'></a>Attachment [region_plot.patch](tarball://root/attachments/some-uuid/ticket5567/region_plot.patch) by whuss created at 2009-04-17 14:55:20
...
```json
{
    "body": "<a id='comment:5'></a>Merged in Sage 3.4.2.alpha0.\n\nCheers,\n\nMichael",
...
<a id='comment:5'></a>Merged in Sage 3.4.2.alpha0.
...
<a id='comment:6'></a>Shouldn't the code in the doctest be deprecated in light of http://trac.sagemath.org/sage_trac/ticket/5413 ?
