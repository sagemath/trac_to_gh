...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5050#issuecomment-38407",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5050#issuecomment-38409",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>In the above glitch, I mean to say that I closed the *worksheet*, reopened it, etc...",
    "created_at": "2009-01-22T16:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5050#issuecomment-38411",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>In the above glitch, I mean to say that I closed the *worksheet*, reopened it, etc...
...
```json
{
    "body": "<a id='comment:4'></a>Applies cleanly to Sage 3.3.alpha0, passes doctests, and seems to be working when I test it out. This is on Intel OSX 10.5.",
    "created_at": "2009-01-22T16:12:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5050#issuecomment-38412",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>Applies cleanly to Sage 3.3.alpha0, passes doctests, and seems to be working when I test it out. This is on Intel OSX 10.5.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5050#issuecomment-38413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5050#issuecomment-38414",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5050",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5050#event-11643"
}
```
