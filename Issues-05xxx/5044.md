...
```json
{
    ...
    "rename": {
        "from": "on some systems mwrank dumps core and crashes on exit when run under pexpect",
        "to": "[with patch; needs review] on some systems mwrank dumps core and crashes on exit when run under pexpect"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5044#event-19537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5044#issuecomment-40784",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5044#issuecomment-40785",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5044",
    "rename": {
        "from": "[with patch; needs review] on some systems mwrank dumps core and crashes on exit when run under pexpect",
        "to": "[with patch; positive review] on some systems mwrank dumps core and crashes on exit when run under pexpect"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5044#event-19538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5044",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5044#event-19539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5044#issuecomment-40786",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5044#issuecomment-40787",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
