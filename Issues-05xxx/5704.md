...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5704#issuecomment-47754",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "rename": {
        "from": "Implementation of finding elliptic curves with prescribed reduction over QQ",
        "to": "[with patch, needs review] Implementation of finding elliptic curves with prescribed reduction over QQ"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5704#event-22659"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5704#issuecomment-47755",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "rename": {
        "from": "[with patch, needs review] Implementation of finding elliptic curves with prescribed reduction over QQ",
        "to": "[with patch, positive review] Implementation of finding elliptic curves with prescribed reduction over QQ"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5704#event-22660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5704#issuecomment-47756",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5704#event-22661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5704#event-22662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5704#issuecomment-47757",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5704#issuecomment-47758",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5704#issuecomment-47759",
    "user": "https://github.com/JohnCremona"
}
```
