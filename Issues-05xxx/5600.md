...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58021"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58025"
}
```
...
```json
{
    "body": "Changed keywords from **** to **integer compositions**",
    "created_at": "2009-05-03T02:17:01Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5600",
    "type": "issue_comment",
...
Changed keywords from **** to **integer compositions**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58027"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58029"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5600#issuecomment-36593",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58034"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5600",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-58035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5600#issuecomment-36594",
    "user": "https://github.com/sagetrac-mvngu"
}
```
