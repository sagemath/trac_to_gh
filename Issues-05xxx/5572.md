...
archive/attachments_006566.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:10'></a>\n**Attachment:** [improve_fast_callable.2.patch](https://github.com/sagemath/sage/files/ticket5572/improve_fast_callable.2.patch)\n\nI think it might be best just to fix #7512 in this ticket.",
    "created_at": "2010-05-26T19:36:52Z",
    "issue": "https://github.com/sagemath/sage/issues/5572",
    "type": "issue_comment",
...
archive/attachments_006568.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [improve_fast_callable.3.patch](https://github.com/sagemath/sage/files/ticket5572/improve_fast_callable.3.patch)\n\napply instead of previous patches",
    "created_at": "2010-05-27T07:55:39Z",
    "issue": "https://github.com/sagemath/sage/issues/5572",
    "type": "issue_comment",
...
**Attachment:** [improve_fast_callable.3.patch](https://github.com/sagemath/sage/files/ticket5572/improve_fast_callable.3.patch)
...
archive/attachments_006569.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [improve_fast_callable.4.patch](https://github.com/sagemath/sage/files/ticket5572/improve_fast_callable.4.patch)\n\napply instead of previous patches (now doctests in plot/*.py[x] pass)",
    "created_at": "2010-05-27T08:27:03Z",
    "issue": "https://github.com/sagemath/sage/issues/5572",
    "type": "issue_comment",
...
**Attachment:** [improve_fast_callable.4.patch](https://github.com/sagemath/sage/files/ticket5572/improve_fast_callable.4.patch)
...
archive/attachments_006570.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_006571.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [improve_fast_callable.6.patch](https://github.com/sagemath/sage/files/ticket5572/improve_fast_callable.6.patch)\n\napply instead of previous patches (fixed a bunch of stuff so even more doctests pass)",
    "created_at": "2010-05-28T06:20:39Z",
    "issue": "https://github.com/sagemath/sage/issues/5572",
    "type": "issue_comment",
...
**Attachment:** [improve_fast_callable.6.patch](https://github.com/sagemath/sage/files/ticket5572/improve_fast_callable.6.patch)
