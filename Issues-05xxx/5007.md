...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5007#issuecomment-31613",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_5007_bashism.patch](https://github.com/sagemath/sage/files/ticket5007/trac_5007_bashism.patch) by @craigcitro created at 2009-01-18 06:25:56",
    "created_at": "2009-01-18T06:25:56Z",
    "issue": "https://github.com/sagemath/sage/issues/5007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5007#issuecomment-31614",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5007#event-30644"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5007#event-30645"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5007",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5007#event-30646"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5007#issuecomment-31615",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
