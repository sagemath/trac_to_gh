...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47079",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47081",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Since the file is moved, the patch is not very useful. I added a diff from the former `sage/combinat/family.py` to the new `sage/sets/family.py`. It is *not* a patch and should not be applied.",
    "created_at": "2009-04-09T20:43:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47083",
    "user": "https://github.com/hivert"
}
```

<a id='comment:3'></a>Since the file is moved, the patch is not very useful. I added a diff from the former `sage/combinat/family.py` to the new `sage/sets/family.py`. It is *not* a patch and should not be applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47084",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47087",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47088",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [family_review.patch](tarball://root/attachments/some-uuid/ticket5538/family_review.patch) by @nthiery created at 2009-04-14 18:09:51\n\nPositive review.\n\nFlorent: please update the summary accordingly, after double checking my (trivial) review patch. It needs to be applied last.\n\nMichael: do you mind setting the gard +3_4_1 on the patch server just after the merge?\n(and possibly also for the other recently merged in sage-combinat patches). Thanks!",
    "created_at": "2009-04-14T18:09:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47090",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:8'></a>Attachment [family_review.patch](tarball://root/attachments/some-uuid/ticket5538/family_review.patch) by @nthiery created at 2009-04-14 18:09:51
...
```json
{
    "body": "<a id='comment:9'></a>I meant: +3_4_1 or +3_4_2 depending on where it goes of course.",
    "created_at": "2009-04-14T18:10:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47091",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:9'></a>I meant: +3_4_1 or +3_4_2 depending on where it goes of course.
...
```json
{
    "body": "<a id='comment:10'></a>Reviewed the review patch. All light green\n\nFlorent",
    "created_at": "2009-04-14T19:00:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47092",
    "user": "https://github.com/hivert"
}
```

<a id='comment:10'></a>Reviewed the review patch. All light green
...
```json
{
    "body": "<a id='comment:11'></a>Dear Michael, \n\nIf it's still possible I'd like to see this one merged in 3.4.1.\nThis is a basic stuff that is useful and should be advertised.\n\nCheers,\n\nFlorent",
    "created_at": "2009-04-14T22:13:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47093",
    "user": "https://github.com/hivert"
}
```

<a id='comment:11'></a>Dear Michael, 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47094",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Oups ! The problem is due to a file which has been moved and a class which has been renamed. Everything was ready to correctly pickle, but I mixed things up in my backward compatibility import links. I just updated a simple patch which solve the problem on my machine.\n\nMichael: can you review it ? You are the master of checking pickle !\n\nI'm still hoping to be in time for 3.4.1 ...\n\nSorry for the mess,\n\nFlorent",
    "created_at": "2009-04-15T10:03:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47096",
    "user": "https://github.com/hivert"
}
```

<a id='comment:14'></a>Oups ! The problem is due to a file which has been moved and a class which has been renamed. Everything was ready to correctly pickle, but I mixed things up in my backward compatibility import links. I just updated a simple patch which solve the problem on my machine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47097",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Attachment [family_pickle_fix-fh.patch](tarball://root/attachments/some-uuid/ticket5538/family_pickle_fix-fh.patch) by mabshoff created at 2009-04-15 22:21:51\n\nPositive review for the pickle fix patch. The five patches together make the test suite pass.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-15T22:21:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47098",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>Attachment [family_pickle_fix-fh.patch](tarball://root/attachments/some-uuid/ticket5538/family_pickle_fix-fh.patch) by mabshoff created at 2009-04-15 22:21:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5538#issuecomment-47099",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
