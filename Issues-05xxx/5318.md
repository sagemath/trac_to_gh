...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5318#issuecomment-43575",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "rename": {
        "from": "ideas for improving random testers (like #4779)",
        "to": "[with patch, needs review] ideas for improving random testers (like #4779)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20896"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20897"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20898"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20899"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5318#issuecomment-43576",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5318#issuecomment-43577",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5318#issuecomment-43578",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "rename": {
        "from": "[with patch, needs review] ideas for improving random testers (like #4779)",
        "to": "[with patch, positive review] ideas for improving random testers (like #4779)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20900"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5318#issuecomment-43579",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5318#issuecomment-43580",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5318#issuecomment-43581",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5318",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20901"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20902"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5318#event-20903"
}
```
