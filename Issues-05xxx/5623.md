...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45016",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45017",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45018",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45019",
    "user": "https://trac.sagemath.org/admin/accounts/users/carlohamalainen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45020",
    "user": "https://trac.sagemath.org/admin/accounts/users/carlohamalainen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45021",
    "user": "https://trac.sagemath.org/admin/accounts/users/carlohamalainen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45022",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45023",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45024",
    "user": "https://trac.sagemath.org/admin/accounts/users/carlohamalainen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45025",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45026",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45027",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45028",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,20 +5,24 @@\n * Roughly 5x speedup on some random graphs (see test.sage):\n \n Sage 3.4 timing:\n-carlo`@`ka37:~/work/code/graphdlx$ sage test.sage \n+\n+```\n+carlo@ka37:~/work/code/graphdlx$ sage test.sage \n 5 loops, best of 3: 158 ms per loop\n-carlo`@`ka37:~/work/code/graphdlx$ sage test.sage \n+carlo@ka37:~/work/code/graphdlx$ sage test.sage \n 5 loops, best of 3: 158 ms per loop\n-carlo`@`ka37:~/work/code/graphdlx$ sage test.sage \n+carlo@ka37:~/work/code/graphdlx$ sage test.sage \n 5 loops, best of 3: 157 ms per loop\n-\n+```\n Sage 3.4 with patch timing:\n \n+```\n 5 loops, best of 3: 33.5 ms per loop\n-carlo`@`ka37:~/work/code/graphdlx$ sage test.sage \n+carlo@ka37:~/work/code/graphdlx$ sage test.sage \n 5 loops, best of 3: 33.1 ms per loop\n-carlo`@`ka37:~/work/code/graphdlx$ sage test.sage \n+carlo@ka37:~/work/code/graphdlx$ sage test.sage \n 5 loops, best of 3: 33.3 ms per loop\n+```\n \n Summary: 5x speedup in all_graph_colorings\n \n``````\n",
    "created_at": "2009-04-01T02:25:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5623",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5623#issuecomment-45029",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
