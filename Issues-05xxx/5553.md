...
```json
{
    "body": "<a id='comment:1'></a>plot_vector_field is already fixed.  See #5259.",
...
<a id='comment:1'></a>plot_vector_field is already fixed.  See #5259.
...
```json
{
    "body": "<a id='comment:2'></a>That said, it'd be great to fix plot_slope_field to detect when you have a vertical slope and have it change things accordingly.  I think this should be easy: just see what vectors have finite X, infinite Y, and set them to be zero X, one Y.",
...
<a id='comment:2'></a>That said, it'd be great to fix plot_slope_field to detect when you have a vertical slope and have it change things accordingly.  I think this should be easy: just see what vectors have finite X, infinite Y, and set them to be zero X, one Y.
...
<a id='comment:3'></a>I see, I thought that there was also a question of allowing infinite vectors, which I thought was weird.  I didn't realize it didn't return a plot at *all* before!
