...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5636#issuecomment-48178",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Fixes the problem, simple code, all tests pass.  Positive review.",
    "created_at": "2009-03-30T00:40:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5636#issuecomment-48179",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Fixes the problem, simple code, all tests pass.  Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5636#issuecomment-48180",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5636#issuecomment-48181",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
