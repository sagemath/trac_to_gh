...
```json
{
    "body": "<a id='comment:1'></a>Attachment [fix-max-matrix-size.patch](tarball://root/attachments/some-uuid/ticket5193/fix-max-matrix-size.patch) by @jasongrout created at 2009-02-06 08:20:41\n\nI think the reasoning is that Py_ssize_t is a signed integer to allow for negative indices.",
...
<a id='comment:1'></a>Attachment [fix-max-matrix-size.patch](tarball://root/attachments/some-uuid/ticket5193/fix-max-matrix-size.patch) by @jasongrout created at 2009-02-06 08:20:41
...
```json
{
    "body": "<a id='comment:2'></a>Yep, the reasoning is explained in the patch.  Doctests in matrixspace.py pass on my 32 bit computer.  Positive review.",
...
<a id='comment:2'></a>Yep, the reasoning is explained in the patch.  Doctests in matrixspace.py pass on my 32 bit computer.  Positive review.
