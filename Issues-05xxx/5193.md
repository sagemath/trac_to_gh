...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5193#issuecomment-42321",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5193#issuecomment-42322",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5193",
    "rename": {
        "from": "[with patch, needs review] maximum allowed matrix size is too big",
        "to": "[with patch, positive review] maximum allowed matrix size is too big"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5193#event-20258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5193",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5193#event-20259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5193#issuecomment-42323",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5193#issuecomment-42324",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
