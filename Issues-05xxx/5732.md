...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49088",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is quote a nice speedup, but unless it gets reviewed soon it will not be in 3.4.1. Since I do not consider this a blocker I am reassigning this to 3.4.2 until it gets a review.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-11T00:32:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49089",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>This is quote a nice speedup, but unless it gets reviewed soon it will not be in 3.4.1. Since I do not consider this a blocker I am reassigning this to 3.4.2 until it gets a review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49090",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49092",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49093",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49094",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49095",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5732#issuecomment-49096",
    "user": "https://github.com/mwhansen"
}
```
