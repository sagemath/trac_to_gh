# Issue 5475: [with patch, needs work] make it so ipython isn't imported when one does "sage -python"
...
```json
{
    ...
    "title": "[with patch, needs work] make it so ipython isn't imported when one does \"sage -python\"",
    "type": "issue",
