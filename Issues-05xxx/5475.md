...
```json
{
    ...
    "rename": {
        "from": "make it so ipython isn't imported when one does \"sage -python\"",
        "to": "[with patch, needs review] make it so ipython isn't imported when one does \"sage -python\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5475#event-21578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5475#issuecomment-45300",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5475#issuecomment-45301",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5475",
    "rename": {
        "from": "[with patch, needs review] make it so ipython isn't imported when one does \"sage -python\"",
        "to": "[with patch, needs work] make it so ipython isn't imported when one does \"sage -python\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5475#event-21579"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5475#event-21580"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5475#issuecomment-45302",
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5475#event-21581"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5475#event-21582"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5475",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5475#event-21583"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5475#issuecomment-45303",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5475#issuecomment-45304",
    "user": "https://github.com/mwhansen"
}
```
