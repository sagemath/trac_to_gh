# Issue 5072: [with patch, positive review] segfault in libsingular gcd when base rings aren't identical
...
```json
{
    ...
    "title": "[with patch, positive review] segfault in libsingular gcd when base rings aren't identical",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5072#issuecomment-38549",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5072#issuecomment-38550",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5072#event-11700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5072#issuecomment-38551",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
