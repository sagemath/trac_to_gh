...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5072#issuecomment-40992",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "rename": {
        "from": "segfault in libsingular gcd when base rings aren't identical",
        "to": "[with patch, needs review] segfault in libsingular gcd when base rings aren't identical"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5072#event-19667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "rename": {
        "from": "[with patch, needs review] segfault in libsingular gcd when base rings aren't identical",
        "to": "[with patch, positive review] segfault in libsingular gcd when base rings aren't identical"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5072#event-19668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5072#issuecomment-40993",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5072#event-19669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5072#issuecomment-40994",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
