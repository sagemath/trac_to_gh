...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] linear_code -- four doctest failures in specture method='leon' exposed by #4588"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5067#event-19639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "rename": {
        "from": "[with patch, needs review] linear_code -- four doctest failures in specture method='leon' exposed by #4588",
        "to": "[with patch, needs review] linear_code -- four doctest failures in spectrum method='leon' exposed by #4588"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5067#event-19640"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "rename": {
        "from": "[with patch, needs review] linear_code -- four doctest failures in spectrum method='leon' exposed by #4588",
        "to": "[with patch, needs work] linear_code -- four doctest failures in spectrum method='leon' exposed by #4588"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5067#event-19641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5067#issuecomment-40968",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5067#issuecomment-40969",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5067#issuecomment-40970",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "rename": {
        "from": "[with patch, needs work] linear_code -- four doctest failures in spectrum method='leon' exposed by #4588",
        "to": "[with patch, needs review] linear_code -- four doctest failures in spectrum method='leon' exposed by #4588"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5067#event-19642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5067#issuecomment-40971",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] linear_code -- four doctest failures in spectrum method='leon' exposed by #4588",
        "to": "[with patch, positive review] linear_code -- four doctest failures in spectrum method='leon' exposed by #4588"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5067#event-19643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5067#event-19644"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5067#issuecomment-40972",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5067",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5067#issuecomment-40973",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
