...
```json
{
    "body": "<a id='comment:1'></a>`CombinatorialObject` (and hence also its many subclasses) does this; see `__hash__` at line 769 of sage/combinat/combinat.py",
    "created_at": "2009-03-28T16:41:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5624",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5624#issuecomment-48073",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:1'></a>`CombinatorialObject` (and hence also its many subclasses) does this; see `__hash__` at line 769 of sage/combinat/combinat.py
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5624#event-13232"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5624#event-13233"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5624#event-13234"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5624#event-13235"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5624#event-13236"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5624#event-13237"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5624#event-13238"
}
```
