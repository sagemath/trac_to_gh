...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53894"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53895"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53896"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53897"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53898"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53900"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53901"
}
```
...
```json
{
    "body": "Changed assignee from **mabshoff** to **@jdemeyer**",
    "created_at": "2011-10-17T12:24:04Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5155",
    "type": "issue_comment",
...
Changed assignee from **mabshoff** to **@jdemeyer**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53902"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53903"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -27,3 +27,7 @@\n This seems to be because of:\n 1. Installing an rc file for the **experimental package** qepcad (in a very odd location `$SAGE_ROOT/local/default.qepcadrc`)\n 2. Sympow which needs to create datafiles.  This should probably be done in sympow's `spkg-install` instead.\n+\n+**Apply**:\n+1. [attachment: 5155_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_scripts.patch.gz) to the scripts repository.\n+2. [attachment: 5155_qepcad.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_qepcad.patch.gz) to the Sage library.\n``````\n",
    "created_at": "2011-10-17T16:09:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5155",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone_title": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53904"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53905"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -29,5 +29,5 @@\n 2. Sympow which needs to create datafiles.  This should probably be done in sympow's `spkg-install` instead.  See #11920.\n \n **Apply**:\n-1. [attachment: 5155_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_scripts.patch.gz) to the scripts repository.\n+1. [[attachment: trac_5155-permissions.patch.gz](https://github.com/sagemath/sage/files/ticket5155/trac_5155-permissions.patch.gz)(https://github.com/sagemath/sage/files/ticket5155/dca7d491c0d86442df44602522a8bc86.gz) to the scripts repository.\n 2. [attachment: 5155_qepcad.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_qepcad.patch.gz) to the Sage library.\n``````\n",
    "created_at": "2011-10-17T21:01:31Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5155",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53906"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53907"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53908"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -24,5 +24,6 @@\n 2. Sympow which needs to create datafiles.  This should probably be done in sympow's `spkg-install` instead.  This is dealt with at #11920.\n \n **Apply**:\n-1. [[attachment: trac_5155-permissions.patch.gz](https://github.com/sagemath/sage/files/ticket5155/trac_5155-permissions.patch.gz)(https://github.com/sagemath/sage/files/ticket5155/dca7d491c0d86442df44602522a8bc86.gz) to the scripts repository.\n-2. [attachment: 5155_qepcad.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_qepcad.patch.gz) to the Sage library.\n+1. [[attachment: trac_5155-permissions.patch.gz](https://github.com/sagemath/sage/files/ticket5155/trac_5155-permissions.patch.gz)(https://github.com/sagemath/sage/files/ticket5155/f8c6d35384b28dd9be3e1ded1f05e8e2.gz) to the scripts repository.\n+2. [attachment: 5155_root.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_root.patch.gz) to the `SAGE_ROOT` repository.\n+3. [attachment: 5155_qepcad.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_qepcad.patch.gz) to the Sage library.\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -26,4 +26,4 @@\n **Apply**:\n 1. [attachment: 5155_sage_location.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_sage_location.patch.gz) to the scripts repository.\n 2. [attachment: 5155_root.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_root.patch.gz) to the `SAGE_ROOT` repository.\n-3. [attachment: 5155_qepcad.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_qepcad.patch.gz) to the Sage library.\n+3. [and [attachment: 5155_fortran.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_fortran.patch.gz)(https://github.com/sagemath/sage/files/ticket5155/070fb418cddaa3c9bd600c39afa9adf1.gz) to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53909"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53910"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53912"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -17,4 +17,4 @@\n **Apply**:\n 1. [attachment: 5155_sage_location.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_sage_location.patch.gz) to the scripts repository.\n 2. [attachment: 5155_root.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_root.patch.gz) to the `SAGE_ROOT` repository.\n-3. [and [attachment: 5155_fortran.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_fortran.patch.gz)(https://github.com/sagemath/sage/files/ticket5155/070fb418cddaa3c9bd600c39afa9adf1.gz) to the Sage library.\n+3. [and [attachment: 5155_fortran.patch.gz](https://github.com/sagemath/sage/files/ticket5155/5155_fortran.patch.gz)(https://github.com/sagemath/sage/files/ticket5155/7bce6882ffaba00ea5d488a8602f0e23.gz) to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53916"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5155#issuecomment-32777",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53917"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53918"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53919"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5155",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5155#event-53920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5155#issuecomment-32778",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5155#issuecomment-32779",
    "user": "https://github.com/jdemeyer"
}
```
