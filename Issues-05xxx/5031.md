...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5031#issuecomment-40665",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5031#issuecomment-40666",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] get doctesting of matrix/misc.pyx up to 100%; also make A.lift() 20 times faster by moving it"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5031#event-19483"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5031#issuecomment-40667",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5031#issuecomment-40668",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "rename": {
        "from": "[with patch; needs review] get doctesting of matrix/misc.pyx up to 100%; also make A.lift() 20 times faster by moving it",
        "to": "[with patch; positive review] get doctesting of matrix/misc.pyx up to 100%; also make A.lift() 20 times faster by moving it"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5031#event-19484"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5031#issuecomment-40669",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5031#issuecomment-40670",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5031#event-19485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5031#issuecomment-40671",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
