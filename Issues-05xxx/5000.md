# Issue 5000: [with patch, with positive review] Solaris 10/x86: fix numerical noise in schemes/elliptic_curves/ell_rational_field.py
...
```json
{
    ...
    "title": "[with patch, with positive review] Solaris 10/x86: fix numerical noise in schemes/elliptic_curves/ell_rational_field.py",
    "type": "issue",
