...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36684",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36685",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36686",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36687",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36688",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5609/pbori_interred.patch",
    "created_at": "2009-05-12T01:16:24Z",
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5609/pbori_interred.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [pbori_interred.patch](https://github.com/sagemath/sage/files/ticket5609/pbori_interred.patch) by @malb created at 2009-05-12 01:16:24\n\nrebased the attached patch to 3.4.2",
    "created_at": "2009-05-12T01:16:24Z",
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36689",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36690",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36691",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5609#issuecomment-36692",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
