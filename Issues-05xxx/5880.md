...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5880#issuecomment-49961",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5880#issuecomment-49962",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5880#issuecomment-49963",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "rename": {
        "from": "[with patch; needs review] notebook -- greatly reduce the number of actions that trigger taking a snapshot",
        "to": "[with patch; needs work] notebook -- greatly reduce the number of actions that trigger taking a snapshot"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5880#event-23499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5880#issuecomment-49964",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "rename": {
        "from": "[with patch; needs work] notebook -- greatly reduce the number of actions that trigger taking a snapshot",
        "to": "[with patch; positive review] notebook -- greatly reduce the number of actions that trigger taking a snapshot"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5880#event-23500"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5880#issuecomment-49965",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5880#event-23501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5880#issuecomment-49966",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5880#issuecomment-49967",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
