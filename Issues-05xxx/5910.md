...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51393",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Please make sure to convert the newlines to standard Unix convention since it seems that some newlines are in Windows format. It would also be good to get all this restified, get the coverage of logic.py up and get the code into the reference manual post ReST conversion - not that this all has to happen on this ticket. I am just glad we are done wioth #545 :)\n\nCheers,\n\nMichael",
    "created_at": "2009-04-30T03:30:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51394",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Please make sure to convert the newlines to standard Unix convention since it seems that some newlines are in Windows format. It would also be good to get all this restified, get the coverage of logic.py up and get the code into the reference manual post ReST conversion - not that this all has to happen on this ticket. I am just glad we are done wioth #545 :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51395",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51396",
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_5910-boolopt.patch](tarball://root/attachments/some-uuid/ticket5910/trac_5910-boolopt.patch) by @aghitza created at 2010-01-02 03:18:33",
    "created_at": "2010-01-02T03:18:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51397",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:3'></a>Attachment [trac_5910-boolopt.patch](tarball://root/attachments/some-uuid/ticket5910/trac_5910-boolopt.patch) by @aghitza created at 2010-01-02 03:18:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51398",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51399",
...
```json
{
    "body": "<a id='comment:4'></a>Given http://comments.gmane.org/gmane.comp.mathematics.sage.devel/67430 , I think we can close this.  The file is still here for reference if we ever need it.",
    "created_at": "2013-07-23T14:55:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5910#issuecomment-51400",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>Given http://comments.gmane.org/gmane.comp.mathematics.sage.devel/67430 , I think we can close this.  The file is still here for reference if we ever need it.
