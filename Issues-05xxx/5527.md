...
```json
{
    "body": "<a id='comment:1'></a>The patch **trac_5527_sr-sphinx.patch** is based on Sage 3.4 and should be applied after #5493.",
...
<a id='comment:1'></a>The patch **trac_5527_sr-sphinx.patch** is based on Sage 3.4 and should be applied after #5493.
...
```json
{
    "body": "<a id='comment:2'></a>Patch looks good, applies, doctests pass.",
...
<a id='comment:2'></a>Patch looks good, applies, doctests pass.
