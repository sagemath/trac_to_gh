...
```json
{
    ...
    "rename": {
        "from": "apply_map skips zeroes in sparse vectors and matrices",
        "to": "[with patch, needs review] apply_map skips zeroes in sparse vectors and matrices"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5198#event-20278"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5198#issuecomment-42350",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5198#issuecomment-42351",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5198",
    "rename": {
        "from": "[with patch, needs review] apply_map skips zeroes in sparse vectors and matrices",
        "to": "[with patch, positive review] apply_map skips zeroes in sparse vectors and matrices"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5198#event-20279"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5198#issuecomment-42352",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5198",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5198#event-20280"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5198#issuecomment-42353",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
