...
```json
{
    "body": "Changed assignee from **@robertwb** to **@sagetrac-prateek-cs14**",
...
Changed assignee from **@robertwb** to **@sagetrac-prateek-cs14**
...
```json
{
    "body": "Removed assignee **@sagetrac-prateek-cs14**",
...
Removed assignee **@sagetrac-prateek-cs14**
