# Issue 5344: [with patch, positive review] Singular/omalloc "double free" problem
...
```json
{
    ...
    "title": "[with patch, positive review] Singular/omalloc \"double free\" problem",
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/5344",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41078",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5344#event-12466"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This is definitely needs work and is not a blocker against 3.4.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-22T22:24:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41080",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This is definitely needs work and is not a blocker against 3.4.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41081",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Wait, maybe I was too hasty, so let me put this back to needs review and test some of the code I have around.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-22T23:13:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41082",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Wait, maybe I was too hasty, so let me put this back to needs review and test some of the code I have around.
...
```json
{
    "body": "<a id='comment:4'></a>Unfortunately while this patch does indeed fix two of the three problems the minpoly issue mentioned above does still occur. Switching back to mmap makes that problem go away, so this is \"needs work\" until that issue is resolved. Obviously switching back to mmap makes the \"666 rings make Sage fail with out of memory conditions on OSX 32 bit\" reappear.  \n\nNote that it is likely a scope issues with Cython and unrelated to memory management issues with libSingular, but it is a show stopper for this patch until that problem is resolved\n\nCheers,\n\nMichael",
    "created_at": "2009-02-23T07:29:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41083",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Positive review. Build on OSX 32 bit, OSX 64 bit, FC 10 and also sage.math. I did valgrind the *entire* test suite on sage.math.\n\nGeorge's patch is integrated into\n\nhttp://sage.math.washington.edu/home/mabshoff/SPKG/singular-3-0-4-4-20080711.p4.spkg\n\nExcellent work!\n\nCheers,\n\nMichael",
    "created_at": "2009-02-23T22:48:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41087",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Positive review. Build on OSX 32 bit, OSX 64 bit, FC 10 and also sage.math. I did valgrind the *entire* test suite on sage.math.
...
```json
{
    "body": "<a id='comment:9'></a>Merged in Sage 3.4.alpha0.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-24T19:36:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41088",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Merged in Sage 3.4.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5344#issuecomment-41089",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5344",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5344#event-12467"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5344#event-12468"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5344#event-12469"
}
```
