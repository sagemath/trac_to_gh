...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5780#issuecomment-48538",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5780",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5780#issuecomment-48539",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5780",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5780#issuecomment-48540",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5780",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5780#event-23012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5780",
    "rename": {
        "from": "[with patch; needs review] plotting -- deal with NaN's in plot range",
        "to": "[with patch; positive review] plotting -- deal with NaN's in plot range"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5780#event-23013"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5780",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5780#issuecomment-48541",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
