...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5166#issuecomment-42076",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5166",
    "rename": {
        "from": "Sage 3.3.a4: sage/symbolic/function.pyx doctest failure on OSX",
        "to": "[with patch, needs review] Sage 3.3.a4: sage/symbolic/function.pyx doctest failure on OSX"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5166#event-20156"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5166#issuecomment-42077",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5166",
    "rename": {
        "from": "[with patch, needs review] Sage 3.3.a4: sage/symbolic/function.pyx doctest failure on OSX",
        "to": "[with patch, positive review] Sage 3.3.a4: sage/symbolic/function.pyx doctest failure on OSX"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5166#event-20157"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5166#issuecomment-42078",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5166",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5166#issuecomment-42079",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5166",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5166#event-20158"
}
```
