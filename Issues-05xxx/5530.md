...
```json
{
    "body": "<a id='comment:1'></a>Is that the right definition for relative_diameter?  Another possibility would be the absolute diameter divided by the absolute value of the center of the interval.\n\nFor example, a tiny interval centered at 1+eps*I (for tiny eps) would have a huge relative diameter under Nick's definition and a tiny relative diameter under mine.",
...
<a id='comment:1'></a>Is that the right definition for relative_diameter?  Another possibility would be the absolute diameter divided by the absolute value of the center of the interval.
