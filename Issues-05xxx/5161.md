...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] Remove outdated SHAREDFLAGS and Solaris specific injected flags from sage-env",
        "to": "[with patch, positive review] Remove outdated SHAREDFLAGS and Solaris specific injected flags from sage-env"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5161#event-20145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5161#issuecomment-42043",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5161",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5161#event-20146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5161#issuecomment-42044",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5161#issuecomment-42045",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
