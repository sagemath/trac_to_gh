...
```json
{
    "body": "<a id='comment:1'></a>just an fyi, i just issued the command on sagenb.org to install latex, so it will be there soon...",
    "created_at": "2009-04-13T14:19:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49485",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>just an fyi, i just issued the command on sagenb.org to install latex, so it will be there soon...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49486",
...
```json
{
    "body": "<a id='comment:2'></a>Here's a patch.  This depends on #6089.",
    "created_at": "2009-06-11T01:38:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49487",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Here's a patch.  This depends on #6089.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49488",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49490",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49491",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Here's a new patch.  This deletes the initial doctests for have_dvipng (etc.); I think the remaining doctests still adequately test whether the functions are working, and should work in any order of execution.  For the doctest failures when latex is missing, I just changed the doctests like this:\n\n```\n-        sage: _run_latex_(file)\n+        sage: _run_latex_(file) # random - depends on whether latex is installed\n``` \nand similarly for the `png` doctest.  Do you think that's good enough?  It now passes all tests for me if latex and pdflatex are missing.",
    "created_at": "2009-06-11T19:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49492",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>Here's a new patch.  This deletes the initial doctests for have_dvipng (etc.); I think the remaining doctests still adequately test whether the functions are working, and should work in any order of execution.  For the doctest failures when latex is missing, I just changed the doctests like this:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49493",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Oh, I see, that's a nice idea.",
    "created_at": "2009-06-12T01:36:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49495",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>Oh, I see, that's a nice idea.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49496",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5771#issuecomment-49498",
    "user": "https://github.com/ncalexan"
}
```
