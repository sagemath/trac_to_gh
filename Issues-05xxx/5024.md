...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5024#issuecomment-40610",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5024#issuecomment-40611",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5024",
    "rename": {
        "from": "[with spkg, needs review] Solaris 10: Do not create dynamic liblpack on non-Linux",
        "to": "[with spkg, positive review] Solaris 10: Do not create dynamic liblpack on non-Linux"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5024#event-19457"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5024#issuecomment-40612",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5024#issuecomment-40613",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5024#event-19458"
}
```
