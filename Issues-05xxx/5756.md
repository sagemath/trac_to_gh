...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46130",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46131",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>BUGS FOUND:\n5. im_gens() returns a mutable list, which makes it trivial to *break* a morphism after it is created:\n\n```\nsage: R.<x,y> = QQ[]\nsage: f = R.hom([x,x+y])\nsage: f(x)\nx\nsage: f.im_gens()[0] = 5\nsage: f.im_gens()\n[5, x + y]\nsage: f(x)\n5\n```",
    "created_at": "2009-04-11T23:28:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46133",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>BUGS FOUND:
5. im_gens() returns a mutable list, which makes it trivial to *break* a morphism after it is created:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46134",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Robert: In case you are reviewing this - all doctest in my rc3 merge tree with this patch applied pass.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-15T03:58:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46136",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Robert: In case you are reviewing this - all doctest in my rc3 merge tree with this patch applied pass.
...
```json
{
    "body": "<a id='comment:6'></a>I agree that the notation could be made more consistent, but this patch simply documents what is there (which is good) and fixes some bugs. \n\nOne thing I noticed, which is not just common to this patch, is that when we return a list that we don't want people to change (e.g. im_gens) we (hopefully) make a copy. This is why tuples were invited, shouldn't we just be using those instead?",
    "created_at": "2009-04-15T23:06:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46137",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:6'></a>I agree that the notation could be made more consistent, but this patch simply documents what is there (which is good) and fixes some bugs. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46138",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Merged in Sage 3.4.1.rc3.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-16T02:54:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46139",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Merged in Sage 3.4.1.rc3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46140",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I meant invented...\n\nFollowup at #5802, perhaps there should be a followup to John Cremona's comments as well.",
    "created_at": "2009-04-16T07:22:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5756#issuecomment-46141",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:9'></a>I meant invented...
