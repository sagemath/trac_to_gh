...
```json
{
    ...
    "asset_name": "trac_5573.patch",
    "asset_url": "tarball://root/attachments/ticket5573/trac_5573.patch",
    "created_at": "2009-04-05T22:30:54Z",
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5573/trac_5573.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_5573.patch](https://github.com/sagemath/sage/files/ticket5573/trac_5573.patch) by @williamstein created at 2009-04-05 22:30:54\n\nNew spkg here:\n\nhttp://sage.math.washington.edu/home/wstein/patches/genus2reduction-0.3.p5.spkg",
    "created_at": "2009-04-05T22:30:54Z",
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5573#issuecomment-36336",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-35303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5573#issuecomment-36338",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5573#issuecomment-36339",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5573#issuecomment-36340",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-35304"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-35305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5573#issuecomment-36341",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-35306"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-35307"
}
```
