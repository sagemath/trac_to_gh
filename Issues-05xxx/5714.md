...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5714#event-67792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5714#event-67793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5714#event-67794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5714#issuecomment-36213",
    "user": "https://github.com/RalphieBoy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5714#issuecomment-36214",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5714#issuecomment-36215",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5714#event-67795"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5714#event-67796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5714",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5714#event-67797"
}
```
