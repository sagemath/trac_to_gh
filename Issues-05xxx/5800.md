...
archive/attachments_006931.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac-5800-bitset-class.patch](https://github.com/sagemath/sage/files/ticket5800/trac-5800-bitset-class.patch)",
    "created_at": "2009-10-16T11:45:37Z",
    "issue": "https://github.com/sagemath/sage/issues/5800",
    "type": "issue_comment",
...
**Attachment:** [trac-5800-bitset-class.patch](https://github.com/sagemath/sage/files/ticket5800/trac-5800-bitset-class.patch)
...
archive/attachments_006932.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:15'></a>\n**Attachment:** [trac-5800-bitset-class-docs.patch](https://github.com/sagemath/sage/files/ticket5800/trac-5800-bitset-class-docs.patch)\n\nApologies: that last patch had a bit of another unrelated patch in it.  I've just uploaded the corrected patch.",
    "created_at": "2009-10-23T00:47:51Z",
    "issue": "https://github.com/sagemath/sage/issues/5800",
    "type": "issue_comment",
