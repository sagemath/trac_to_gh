...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5003#issuecomment-40502",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "rename": {
        "from": "[with patch, needs review] equality testing in graphs should check \"weighted\" property",
        "to": "[with patch, needs work] equality testing in graphs should check \"weighted\" property"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5003#event-19386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5003#issuecomment-40503",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "rename": {
        "from": "[with patch, needs work] equality testing in graphs should check \"weighted\" property",
        "to": "[with patch, needs review] equality testing in graphs should check \"weighted\" property"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5003#event-19387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5003#issuecomment-40504",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5003#issuecomment-40505",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] equality testing in graphs should check \"weighted\" property",
        "to": "[with patch, positive review] equality testing in graphs should check \"weighted\" property"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5003#event-19388"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5003#issuecomment-40506",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5003#issuecomment-40507",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5003#issuecomment-40508",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5003",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5003#event-19389"
}
```
