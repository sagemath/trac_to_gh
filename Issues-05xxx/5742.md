...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5742#issuecomment-46038",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5742",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5742#issuecomment-46039",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5742",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5742#event-13471"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Fixed in Sage 3.4.1.rc4 via #5219.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-18T23:24:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5742",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5742#issuecomment-46040",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Fixed in Sage 3.4.1.rc4 via #5219.
