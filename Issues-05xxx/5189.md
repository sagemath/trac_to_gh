...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5189#issuecomment-33028",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [delete-all-cells.patch](https://github.com/sagemath/sage/files/ticket5189/delete-all-cells.patch) by @jasongrout created at 2009-02-06 08:18:30",
    "created_at": "2009-02-06T08:18:30Z",
    "issue": "https://github.com/sagemath/sage/issues/5189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5189#issuecomment-33029",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5189#issuecomment-33030",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5189#issuecomment-33031",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
