...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-49997",
...
```json
{
    "body": "<a id='comment:4'></a>Thanks for tracking this down. I am surprised it works on various boxen I tested, but not on yours. Oh well, doctests must be evil :)\n\nI am making this a blocker and also CCed John - maybe something obvious is jumping out at him :)\n\nCheers,\n\nMichael",
    "created_at": "2009-04-17T08:56:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-49998",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Thanks for tracking this down. I am surprised it works on various boxen I tested, but not on yours. Oh well, doctests must be evil :)
...
```json
{
    "body": "<a id='comment:5'></a>#5764 is somehow involved in this, too. I've poked around a bit, and there is some strange interaction between sagedoc.py and sageinspect.py related to formatting strings, I think. I haven't looked any further than that.",
    "created_at": "2009-04-17T09:34:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-49999",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:5'></a>#5764 is somehow involved in this, too. I've poked around a bit, and there is some strange interaction between sagedoc.py and sageinspect.py related to formatting strings, I think. I haven't looked any further than that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50001",
...
```json
{
    "body": "<a id='comment:9'></a>Okay, I think I've figured out one of these, but not the other two: I think ddrake's problem is caused because he is using a binary-only distribution, and so source codes are not available.  Or something like that. Anyway, adding a #random tag to those tests ought to fix this issue.\n\nI don't know what to do about the other two issues...",
    "created_at": "2009-04-17T21:12:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50003",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>Okay, I think I've figured out one of these, but not the other two: I think ddrake's problem is caused because he is using a binary-only distribution, and so source codes are not available.  Or something like that. Anyway, adding a #random tag to those tests ought to fix this issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50004",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>For `search_doc('this creates a polynomial ring')`, at least, the problem seems to be that `ncadoctest.py`'s spoofed version of `sys.stdout` is missing a `fileno()` method.  `IPython.genutils.page` calls this implicitly (line 1664 of `genutils.py`), when it tries to determine the screen size.  Replacing\n\n```\n        from sage.misc.all import pager\n        pager()(r)\n```\n\nwith something like\n\n```\n        from IPython.genutils import page\n        page(r, screen_lines = 1)\n```\n\ndisables the check.  The doctest then passes.",
    "created_at": "2009-04-18T05:56:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50005",
    "user": "https://github.com/qed777"
}
```

<a id='comment:11'></a>For `search_doc('this creates a polynomial ring')`, at least, the problem seems to be that `ncadoctest.py`'s spoofed version of `sys.stdout` is missing a `fileno()` method.  `IPython.genutils.page` calls this implicitly (line 1664 of `genutils.py`), when it tries to determine the screen size.  Replacing
...
```json
{
    "body": "<a id='comment:13'></a>Just for the record, mine was from a fresh build.  It happens nearly every time, but not with \"-verbose\" usually.  Just sometimes...",
    "created_at": "2009-04-18T15:34:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50007",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:13'></a>Just for the record, mine was from a fresh build.  It happens nearly every time, but not with "-verbose" usually.  Just sometimes...
...
```json
{
    "body": "<a id='comment:14'></a>On the \"fetch\" tests:  I'm not sure why, but the problem seems to be os.popen, which is deprecated in favor of the subprocess module:\n\nhttp://docs.python.org/library/subprocess.html\n\nHere's a potential fix:\n\nAt the top of `sagedoc.py` add\n\n```\nfrom subprocess import Popen, PIPE\n```\nThen replace\n\n```\nr = os.popen(cmd).read()\n```\nwith\n\n```\nr = Popen(cmd, shell=True, stdout=PIPE).communicate()[0]\n```\n\nThere's still an issue with `\\n`'s, though.",
    "created_at": "2009-04-18T17:10:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50008",
    "user": "https://github.com/qed777"
}
```

<a id='comment:14'></a>On the "fetch" tests:  I'm not sure why, but the problem seems to be os.popen, which is deprecated in favor of the subprocess module:
...
```json
{
    "body": "<a id='comment:15'></a>At the moment I am tempted to reinstate the nodoctest for this file and then have the issues for this patch sorted out post 3.4.1.\n\nThoughts?\n\nCheers,\n\nMichael",
    "created_at": "2009-04-19T01:49:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50009",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>At the moment I am tempted to reinstate the nodoctest for this file and then have the issues for this patch sorted out post 3.4.1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50010",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Please be aware that #5826 adds a nodoctest to this file to get 3.4.1 out the door. This should be reverted in this patch so we do actually doctest something :)\n\nBumped to 3.4.2.\n\nCheers,\n\nMichael",
    "created_at": "2009-04-20T03:09:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50011",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:17'></a>Please be aware that #5826 adds a nodoctest to this file to get 3.4.1 out the door. This should be reverted in this patch so we do actually doctest something :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50013",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50015",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50016",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50017",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>All tests pass (with -long) on my mac, on sage.math, and on an ubuntu machine.  Is this enough for a positive review, or do we need more people to test on other types of machines?",
    "created_at": "2009-05-20T14:08:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50018",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>All tests pass (with -long) on my mac, on sage.math, and on an ubuntu machine.  Is this enough for a positive review, or do we need more people to test on other types of machines?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50021",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Looks good except for one doctest failure.  trac_5806_part3.patch should fix this.\n\nWith all three patches, I have no doctest failures on Mac OS X 10.5 and on sage.math.  People should test out other platforms, too.",
    "created_at": "2009-05-23T19:24:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50022",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:26'></a>Looks good except for one doctest failure.  trac_5806_part3.patch should fix this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50023",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50027",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>If we've released for 2 months without fixing this, it doesn't make sense to keep it as a blocker.",
    "created_at": "2009-06-15T23:25:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50028",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:31'></a>If we've released for 2 months without fixing this, it doesn't make sense to keep it as a blocker.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50029",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50030",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Works for me on several different linux boxes as well as Mac OS X 10.5 (intel).  Apply all three patches.\n\n(I wrote one of the three patches, but it's a one-liner, and ddrake approved of it above (\"Ah, perfect\").  So positive review for the whole thing.)",
    "created_at": "2009-06-19T23:47:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50031",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:32'></a>Works for me on several different linux boxes as well as Mac OS X 10.5 (intel).  Apply all three patches.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50032",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50033",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50034",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50035",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5806#issuecomment-50036",
    "user": "https://github.com/fchapoton"
}
```
