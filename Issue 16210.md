...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16210#issuecomment-211374",
...
```json
{
    "body": "Definitely no to automatic change of names: it can have any sense only when working interactively when the user can notice a substitution. If it is in the code, the name supplied to the constructor may be used later in exactly the same form rather than requesting generators of the new ring.\n\nI also want to point out that **`SR[\"t\"]` is still a useful construction**, at least I have found it useful and I think some other people as well. So prohibiting it without a clear replacement is not ideal. And a clear replacement would be, I think, a symbolic ring with either whitelisted or blacklisted names.",
    "created_at": "2014-06-05T22:43:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16210#issuecomment-211376",
...
```json
{
    "body": "The SR issue is different from this commutative algebra ticket. There are also too many cryptic tracebacks in Sage IMO, so I think a warning should be it.",
    "created_at": "2014-06-06T06:44:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16210#issuecomment-211377",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16210#event-48365"
}
```
