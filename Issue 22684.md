...
```
sage: ShiftedPrimedTableau([This is the Trac macro *None, None, "1p",None, 2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#None, None, "1p",None, 2-macro))
[(None, None, None, 1', 2)]                                                                                                                           
```
...
```
sage: ShiftedPrimedTableau([This is the Trac macro *None* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#None-macro)).pp()
---------------------------------------------------------------------------
ValueError                                Traceback (most recent call last)
<ipython-input-2-d20e95e0a9ff> in <module>()
----> 1 ShiftedPrimedTableau([This is the Trac macro *None* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#None-macro)).pp()
...
sage: ShiftedPrimedTableau([This is the Trac macro *None* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#None-macro))
[(None,)]
```
...
-            sage: ShiftedPrimedTableau._preprocess([This is the Trac macro *2'", "3p* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2'", "3p-macro),
-            ....: skew=[1])
+            sage: ShiftedPrimedTableau._preprocess([This is the Trac macro *2'", "3p* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2'", "3p-macro), skew=[1])
             [(None, 2', 3', 4')]
+
...
+            0
+
+            sage: Tab = ShiftedPrimedTableau([This is the Trac macro *1p* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1p-macro), skew=[2,1])
+            sage: Tab.max_entry()
+            1
+        """
+        return max([entry.unprimed() for row in self
