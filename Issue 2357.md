...
```json
{
    "body": "I think Tom wanted to look into this.",
    "created_at": "2008-06-03T14:21:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
...
```json
{
    "body": "Now wait a second.... what if I *want* to use the NTL backend? Don't I even have that option any more? Why are we deleting all that code?",
    "created_at": "2008-06-20T23:18:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2357#issuecomment-15884",
    "user": "dmharvey"
}
```
...
```json
{
    "body": "No, no, we're not. Don't worry. There was some miscommunication about this at some point, but we're definitely keeping all the code, and we're going to have the polynomial ring constructor take a flag that lets you choose between FLINT and NTL, with FLINT being the new default.\n\nI'm going to implement this soon (within a week, I think).",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2357#issuecomment-15886",
    "user": "dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2357#issuecomment-15887",
    "user": "boothby"
}
```
...
```json
{
    "body": "This needs someone (I'm going to do it soon, unless someone does it before me) to write some code that allows one to use `ZZ['x']` via NTL if one wishes, as a flag to the polynomial constructor.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2357#issuecomment-15889",
    "user": "cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2357#issuecomment-15890",
    "user": "cwitty"
}
```
...
```json
{
    "body": "I looked over the new patch added by Craig (the referee) and I'm happy with it.",
...
```json
{
    "body": "Merged default-flint-polys.hg in Sage 3.0.4.alpha2",
    "created_at": "2008-07-02T19:07:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2357#issuecomment-15898",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2357#issuecomment-15899",
    "user": "mabshoff"
}
```
