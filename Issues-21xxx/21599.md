...
<a id='comment:2'></a>1. If the final try failed, the exception should be raised!
...
```json
{
    "body": "<a id='comment:3'></a>D'oh! Agreed with all of the above.",
...
<a id='comment:3'></a>D'oh! Agreed with all of the above.
...
```json
{
    "body": "<a id='comment:4'></a>And yes it's an ugly hack but not an uncommon one.  I feel like I've done this a dozen other times for Windows support in various places.",
...
<a id='comment:4'></a>And yes it's an ugly hack but not an uncommon one.  I feel like I've done this a dozen other times for Windows support in various places.
...
<a id='comment:7'></a>Two minor things again:
...
<a id='comment:8'></a>Agreed again on all of the above.
