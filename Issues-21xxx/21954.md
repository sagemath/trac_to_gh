...
```json
{
    "body": "https://github.com/sagemath/sage/blob/1b1e6f608d1ef8ee664bb19e991efbbc68cbd51f/src/sage/plot/colors.py#L1442 should perhaps use `cmap_d` instead of `datad` as well.",
