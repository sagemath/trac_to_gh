...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21363#event-282232"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21363#event-282233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21363#event-282234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21363#event-282235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21363#issuecomment-315259",
    "user": "https://github.com/sagetrac-kalmar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21363#issuecomment-315260",
    "user": "https://github.com/tscrim"
}
```
