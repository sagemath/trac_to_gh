...
```json
{
    "body": "<a id='comment:2'></a>\nIn fact the doctest was not using the result computed by giac but was recomputing everything with singular so I have changed this.\n\nI have not yet changed the output doc string because it seems not coherent with the documentation of\ninterreduced_basis:\n\n```\n   If this ideal is spanned by (f_1, ..., f_n) this method returns\n   (g_1, ..., g_s) such that:\n\n   * (f_1,...,f_n) = (g_1,...,g_s)\n\n   * LT(g_i) != LT(g_j) for all i != j\n\n   * LT(g_i) does not divide m for all monomials m of\n\n        {g_1,...,g_{i-1},g_{i+1},...,g_s}\n\n   * LC(g_i) == 1 for all i if the coefficient ring is a field.\n\n```\nbut\n\n```\nsage: P.<a,b,c> = PolynomialRing(QQ,3, order='lex')\nsage: toto=ideal([7*a - 420*c^3 + 158*c^2 + 8*c - 7, 7*b + 210*c^3 - 79*c^2 + 3*c, 84*c^4 - 40*c^3 + c^2 + c])\n....: \nsage: g=toto.interreduced_basis()\nsage: g[0].lc()\n7\nsage: toto.base_ring()\nRational Field\n```\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[b613d7d](https://git.sagemath.org/sage.git/commit?id=b613d7d26d8434c16c6425caa6ff20cedb249d69)|`Merge branch 'public/giacpyGB' of git://trac.sagemath.org/sage into develop`|\n|[eb69ec5](https://git.sagemath.org/sage.git/commit?id=eb69ec52218caa5a7bb52e048ed2ea51e321482f)|`Merge branch 'master' of git://trac.sagemath.org/sage into develop`|\n|[5e4cb99](https://git.sagemath.org/sage.git/commit?id=5e4cb9970ccb17c6a8d826451637d7502e0e0e0c)|`Merge branch 'public/giacpyGB' of git://trac.sagemath.org/sage into develop`|\n|[d17e348](https://git.sagemath.org/sage.git/commit?id=d17e34825d159926bcd1c5e5b8cd3287ca53fabb)|`Merge branch 'develop' of git://trac.sagemath.org/sage into develop`|\n|[ff5a753](https://git.sagemath.org/sage.git/commit?id=ff5a75359e87a04537c1fcfb2e5c396d87703e57)|`Merge branch 'develop' of git://github.com/sagemath/sage into develop`|\n|[3ddf1ca](https://git.sagemath.org/sage.git/commit?id=3ddf1ca3baeb8928ba87075271ef61b242c6a336)|`Merge branch 'develop' of git://github.com/sagemath/sage into develop`|\n|[b2d156f](https://git.sagemath.org/sage.git/commit?id=b2d156f510476bdcff8ba7e6368aaf3ecbbf8401)|`Merge branch 'develop' of git://trac.sagemath.org/sage into develop`|\n|[428ab26](https://git.sagemath.org/sage.git/commit?id=428ab264a5471206be223990f0af65ed37b740ea)|`Merge branch 'develop' of git://trac.sagemath.org/sage into develop`|\n|[0b6ebcd](https://git.sagemath.org/sage.git/commit?id=0b6ebcd75e538dde7a1e3900510c55c396fe10c4)|`Merge branch 'develop' of git://github.com/sagemath/sage into develop`|\n|[7accb23](https://git.sagemath.org/sage.git/commit?id=7accb23f1cdc56138d12e8145fc4d378f0fdf077)|`The doctest was not using the result computed by giacpy`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nsorry for the messy branch, here is a new one\n\n---\nNew commits:\n|                                                                                                                                          |                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[226744d](https://git.sagemath.org/sage.git/commit?id=226744dcf00938804e5de4fa692f9ea6c43db39f)|`The result computed by giacpy was not used in the doc and confused the reader`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[bde7be0](https://git.sagemath.org/sage.git/commit/?id=bde7be034769b603ffadbe827d8db2b801847a4b)|`change test on cf.type in interred`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[90cc488](https://git.sagemath.org/sage.git/commit/?id=90cc4887b26256473c2c9d90202131c49a69a29c)|`The result computed by giacpy was not used in the doc and confused the reader`|\n|[fd60c06](https://git.sagemath.org/sage.git/commit/?id=fd60c06465050a1117e2ef9d93dd6ab8ed2e2550)|`change test on cf.type in interred`|",
