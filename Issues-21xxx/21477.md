...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21477#event-283764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21477#event-283765"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21477#event-283766"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21477#issuecomment-317437",
    "user": "https://github.com/sagetrac-zonova"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21477#issuecomment-317438",
    "user": "https://github.com/sagetrac-zonova"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21477#event-283767"
}
```
