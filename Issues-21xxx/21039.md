...
```json
{
    "body": "<a id='comment:2'></a>Returning not a polynomial but the GF(2) element might cause unexpected errors, where code relies on methods offered by the polynomial class (e.g. `degree()`).",
    "created_at": "2018-03-12T10:03:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21039",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21039#issuecomment-287091",
    "user": "https://github.com/pfasante"
}
```

<a id='comment:2'></a>Returning not a polynomial but the GF(2) element might cause unexpected errors, where code relies on methods offered by the polynomial class (e.g. `degree()`).
