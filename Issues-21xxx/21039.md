...
```json
{
    "body": "Returning not a polynomial but the GF(2) element might cause unexpected errors, where code relies on methods offered by the polynomial class (e.g. `degree()`).",
