...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[ade0a42](https://git.sagemath.org/sage.git/commit/?id=ade0a42757aa70f4d1e647933ee8c14fe1461c21)|`Refactor the rst2ipynb package to use the new pip-installable package`|",
