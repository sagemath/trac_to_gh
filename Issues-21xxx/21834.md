...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[613c782](https://git.sagemath.org/sage.git/commit/?id=613c78249818205abbe6c4126814232fd2e76f05)|`Use PARI for finite fields element minpoly computations.`|",
    "created_at": "2016-11-07T16:11:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21834",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[4174d3e](https://git.sagemath.org/sage.git/commit/?id=4174d3e9e5b561a6c0baca61f2af97a9522c8ec1)|`Let FF using PARI use PARI minpoly function.`|\n|[d99cd71](https://git.sagemath.org/sage.git/commit/?id=d99cd71f93904cb7e1cce8c85ada4ce402c9e5d0)|`Use PARI charpoly by default for finite fields elements.`|",
    "created_at": "2016-11-07T17:11:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21834",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[bdc6af1](https://git.sagemath.org/sage.git/commit/?id=bdc6af176a407d5765e5f2562d774ea59d7e75b4)|`Only pari and matrix options for minpoly and charpoly in FF.`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[d5ef125](https://git.sagemath.org/sage.git/commit/?id=d5ef1257a56a16e1b5185916a5f01cb7209950e4)|`Make sure FF tests for pari FF implem use that implem.`|\n|[eb4fe64](https://git.sagemath.org/sage.git/commit/?id=eb4fe64311d25c5eded558ade89c8930aba824ef)|`Remove superfluous type decl in FF implem using pari FF for two functions.`|\n|[42b174f](https://git.sagemath.org/sage.git/commit/?id=42b174f0ff94b26aa38adffaf7d236de2a37632e)|`Doctest for class' methods (and not superclass') in FinitePolyExtElement.`|",
