...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[7b77cad](https://git.sagemath.org/sage.git/commit?id=7b77cada90c47df4301480a298fc2f95c7eaf79f)|`Improve warnings in doctester`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[2c5dae8](https://git.sagemath.org/sage.git/commit/?id=2c5dae819d7ec13774f4e7a19925e7b844f7285a)|`Print warnings to stdout instead of stderr`|",
