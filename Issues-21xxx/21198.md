...
```json
{
    "body": "We currently don't have a fast callable interpreter that is specialized for ComplexField. The obvious candidate is to base one on the mpc library (although sage's [ComplexNumber](../wikis/ComplexNumber) is not based on mpc!!)\n\n**CC:**  @robertwb\n\n**Keywords:** sd86.5\n\n**Branch/Commit:** [6789aeca7204cbeeeecce566f86ab3ca93e75919](https://github.com/sagemath/sagetrac-mirror/commit/6789aeca7204cbeeeecce566f86ab3ca93e75919)\n\n**Reviewer:** Aly Deines\n\n**Author:** Nils Bruin\n\nIssue created by migration from https://trac.sagemath.org/ticket/21198\n\n",
...
```
We currently don't have a fast callable interpreter that is specialized for ComplexField. The obvious candidate is to base one on the mpc library (although sage's [ComplexNumber](../wikis/ComplexNumber) is not based on mpc!!)
