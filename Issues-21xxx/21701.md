...
```json
{
    "body": "<a id='comment:1'></a>Do you have a clue Ralph? I have a feeling this will require some work `pynac` side rather than `sage` side, but I don't mix very well with `c++`.",
    "created_at": "2016-10-14T01:49:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400458",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>Do you have a clue Ralph? I have a feeling this will require some work `pynac` side rather than `sage` side, but I don't mix very well with `c++`.
...
```json
{
    "body": "<a id='comment:2'></a>Can you try with `clang -stdlib=libstdc++ ...`?",
    "created_at": "2016-10-14T06:39:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400459",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>Can you try with `clang -stdlib=libstdc++ ...`?
...
```json
{
    "body": "<a id='comment:3'></a>I just noticed that clang is used instead of clang++, that may have an impact. I will try to rectify that and if it doesn't work try what you said.",
    "created_at": "2016-10-14T07:01:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400460",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:3'></a>I just noticed that clang is used instead of clang++, that may have an impact. I will try to rectify that and if it doesn't work try what you said.
...
```json
{
    "body": "<a id='comment:6'></a>Is this Mac or Linux? Please state in the description.",
    "created_at": "2016-10-14T07:51:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400463",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>Is this Mac or Linux? Please state in the description.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400465",
...
```json
{
    "body": "<a id='comment:11'></a>Cannot dismiss that I guess. That would be a big blow on apple's part.",
    "created_at": "2016-10-14T19:44:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400467",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:11'></a>Cannot dismiss that I guess. That would be a big blow on apple's part.
...
```json
{
    "body": "<a id='comment:12'></a>OK it is there: `/usr/include/c++/4.2.1/bits/stl_list.h` on OS X and it has the right operator. Of course anything with `bits` is an internal header and apparently the proper way to include it is with `<list>`. So I am guessing some inclusion is either using a non-standard header or rely on some indirect inclusion. Digging...",
    "created_at": "2016-10-15T02:46:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400468",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:12'></a>OK it is there: `/usr/include/c++/4.2.1/bits/stl_list.h` on OS X and it has the right operator. Of course anything with `bits` is an internal header and apparently the proper way to include it is with `<list>`. So I am guessing some inclusion is either using a non-standard header or rely on some indirect inclusion. Digging...
...
```json
{
    "body": "<a id='comment:13'></a>Even manually adding `#include <list>` in the cpp file doesn't solve the problem. There must something subtle at work.",
    "created_at": "2016-10-15T04:31:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400469",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:13'></a>Even manually adding `#include <list>` in the cpp file doesn't solve the problem. There must something subtle at work.
...
```json
{
    "body": "<a id='comment:14'></a>My understanding of some C++ matters is shaky at best. Does it make a difference that `operator!=` is a \"non-member\" function? http://en.cppreference.com/w/cpp/container/list",
    "created_at": "2016-10-15T04:39:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400470",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:14'></a>My understanding of some C++ matters is shaky at best. Does it make a difference that `operator!=` is a "non-member" function? http://en.cppreference.com/w/cpp/container/list
...
```json
{
    "body": "<a id='comment:15'></a>Note that the missing `operator!=()` is not a member of `list` but of `list::const_iterator`, see line 266 in https://gcc.gnu.org/onlinedocs/gcc-4.6.3/libstdc++/api/a01055_source.html\n\nDoes the exact equivalent exist in your stl_list.h?",
    "created_at": "2016-10-15T05:16:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400471",
    "user": "https://github.com/rwst"
}
```

<a id='comment:15'></a>Note that the missing `operator!=()` is not a member of `list` but of `list::const_iterator`, see line 266 in https://gcc.gnu.org/onlinedocs/gcc-4.6.3/libstdc++/api/a01055_source.html
...
```json
{
    "body": "<a id='comment:16'></a>It appears to be in the header - which bears a lot of similarities with your link. We are talking about this section?\n\n```\n00198   template<typename _Tp>\n00199     struct _List_const_iterator\n```",
    "created_at": "2016-10-15T05:52:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400472",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:16'></a>It appears to be in the header - which bears a lot of similarities with your link. We are talking about this section?
...
```json
{
    "body": "<a id='comment:17'></a>Yes.",
    "created_at": "2016-10-15T05:56:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400473",
    "user": "https://github.com/rwst"
}
```

<a id='comment:17'></a>Yes.
...
```json
{
    "body": "<a id='comment:19'></a>It's different. Before it was list, now it's tree. BTW the warning is fixed in flint git master.",
    "created_at": "2016-11-11T06:34:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400475",
    "user": "https://github.com/rwst"
}
```

<a id='comment:19'></a>It's different. Before it was list, now it's tree. BTW the warning is fixed in flint git master.
...
```json
{
    "body": "<a id='comment:20'></a>Ah no sorry, different warning, not flint.",
    "created_at": "2016-11-11T06:35:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400476",
    "user": "https://github.com/rwst"
}
```

<a id='comment:20'></a>Ah no sorry, different warning, not flint.
...
```json
{
    "body": "<a id='comment:21'></a>The original one had three errors, 2 \"list\" and one \"tree\". In any case it is extremely vexing. I need to find a C++ expert that could have a clue.",
    "created_at": "2016-11-11T07:14:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400477",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:21'></a>The original one had three errors, 2 "list" and one "tree". In any case it is extremely vexing. I need to find a C++ expert that could have a clue.
...
```json
{
    "body": "<a id='comment:22'></a>C++ guru needed...",
    "created_at": "2016-11-22T22:41:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400478",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:22'></a>C++ guru needed...
...
```json
{
    "body": "<a id='comment:24'></a>That appears to be effective, let's see how far I can go with it.",
    "created_at": "2016-11-23T23:55:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400480",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:24'></a>That appears to be effective, let's see how far I can go with it.
...
```json
{
    "body": "<a id='comment:25'></a>Had a new C/C++ conflict but I was still on 7.5.beta2. Switched to beta3 and rebuilding now.",
    "created_at": "2016-11-24T00:34:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400481",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:25'></a>Had a new C/C++ conflict but I was still on 7.5.beta2. Switched to beta3 and rebuilding now.
...
```json
{
    "body": "<a id='comment:26'></a>OK that changes definitely get me past the compiling of `sage/libs/pynac/pynac.so`, the new issue in beta3 means that I haven't reach the initial problem in `sage/symbolyc/expression.pyx`. Since there were several errors that particular fix may be insufficient. I should put a temporary branch here for other people interested in testing at some point.",
    "created_at": "2016-11-24T01:02:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400482",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:26'></a>OK that changes definitely get me past the compiling of `sage/libs/pynac/pynac.so`, the new issue in beta3 means that I haven't reach the initial problem in `sage/symbolyc/expression.pyx`. Since there were several errors that particular fix may be insufficient. I should put a temporary branch here for other people interested in testing at some point.
...
```json
{
    "body": "<a id='comment:27'></a>After sorting the `m4ri` problems I am back at the original error in expression.pyx. I will see if I can apply Dima's suggestion again.",
    "created_at": "2016-11-24T01:45:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400483",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:27'></a>After sorting the `m4ri` problems I am back at the original error in expression.pyx. I will see if I can apply Dima's suggestion again.
...
```json
{
    "body": "<a id='comment:28'></a>Had to apply Dima's suggestion 3 times. We have compile!",
    "created_at": "2016-11-24T01:50:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400484",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:28'></a>Had to apply Dima's suggestion 3 times. We have compile!
...
```json
{
    "body": "<a id='comment:29'></a>Nice. Looks like another example where gcc is more generous than clang with template function creation.",
    "created_at": "2016-11-24T04:20:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400485",
    "user": "https://github.com/rwst"
}
```

<a id='comment:29'></a>Nice. Looks like another example where gcc is more generous than clang with template function creation.
...
```json
{
    "body": "<a id='comment:31'></a>Ideally, all those `cdef struct` in `pynac.pxd` should be replaced by `cdef cppclass`.",
    "created_at": "2016-11-24T08:31:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400487",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>Ideally, all those `cdef struct` in `pynac.pxd` should be replaced by `cdef cppclass`.
...
```json
{
    "body": "<a id='comment:32'></a>Yes, I have numerous warning about `struct` that should `class`. \n\nI am doing a new compile from scratch, doctests of the first build has shown a few issues but it started as 7.5.beta2 switched to beta3 in flight so everything will be cross-checked with a new build.",
    "created_at": "2016-11-24T08:36:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400488",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:32'></a>Yes, I have numerous warning about `struct` that should `class`. 
...
```json
{
    "body": "<a id='comment:33'></a>I have been grepping `is_not_equal` over the entire sage tree and apart from the one occurence in `pynac.pyx` and 3 in `symbolic/expression.pyx` I found 3 in `pynac.pxd`\n\n```\ngrep -rI is_not_equal src/sage/*\nsrc/sage/libs/pynac/pynac.pxd:        bint is_not_equal \"operator!=\" (GExListIter i)\nsrc/sage/libs/pynac/pynac.pxd:        bint is_not_equal \"operator!=\" (GParamSetIter i)\nsrc/sage/libs/pynac/pynac.pxd:        bint is_not_equal \"operator!=\" (GExSetIter i)\n```\nI am guessing they can go as well if I remove all the instances of `is_not_equal`. Second opinion? Ralf?",
    "created_at": "2016-11-24T20:58:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400489",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:33'></a>I have been grepping `is_not_equal` over the entire sage tree and apart from the one occurence in `pynac.pyx` and 3 in `symbolic/expression.pyx` I found 3 in `pynac.pxd`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400490",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400492",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Can you explain to me how something that is not used can prevent memory leaks? May be I shouldn't ask, it is C++ after all.",
    "created_at": "2016-11-25T00:04:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400493",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:37'></a>Can you explain to me how something that is not used can prevent memory leaks? May be I shouldn't ask, it is C++ after all.
...
```json
{
    "body": "<a id='comment:38'></a>I should answer the question: No I didn't need to remove it to compile. I discovered them as an afterthought. I started to wonder if there were many other instances, and that's when I discovered those.",
    "created_at": "2016-11-25T00:21:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400494",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:38'></a>I should answer the question: No I didn't need to remove it to compile. I discovered them as an afterthought. I started to wonder if there were many other instances, and that's when I discovered those.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400495",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>I think we are not talking about the same thing Dima! You are talking about removing `operator!=` definitions. I am only talking about removing the three instances of `is_not_equal`. `is_not_equal` was only used in the places that caused `clang` to fail.",
    "created_at": "2016-11-25T00:25:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400496",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:40'></a>I think we are not talking about the same thing Dima! You are talking about removing `operator!=` definitions. I am only talking about removing the three instances of `is_not_equal`. `is_not_equal` was only used in the places that caused `clang` to fail.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400497",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400498",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400499",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>I am not going to fight that fight. If a reviewer think they should not go, fine with me. Still needs some testing on normal setups. Not expecting problems but we never know.\n\n---\nNew commits:",
    "created_at": "2016-11-25T01:01:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400500",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:42'></a>I am not going to fight that fight. If a reviewer think they should not go, fine with me. Still needs some testing on normal setups. Not expecting problems but we never know.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400501",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400502",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>If I want to test this on OS X, do I just do `export CC=clang` and then `make`?",
    "created_at": "2016-11-25T04:35:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400503",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:43'></a>If I want to test this on OS X, do I just do `export CC=clang` and then `make`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400504",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>I forgot there is one more problem to build sage with clang that is not included in this ticket. The first line `src/sage/libs/pynac/pynac.pxd` has to be edited out.",
    "created_at": "2016-11-25T05:13:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400505",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:45'></a>I forgot there is one more problem to build sage with clang that is not included in this ticket. The first line `src/sage/libs/pynac/pynac.pxd` has to be edited out.
...
```json
{
    "body": "<a id='comment:47'></a>I think it's possible that the code in `pynac.pxd` was written because at the time there was no `std::multiset` support in Cython.",
    "created_at": "2016-11-25T07:09:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400507",
    "user": "https://github.com/rwst"
}
```

<a id='comment:47'></a>I think it's possible that the code in `pynac.pxd` was written because at the time there was no `std::multiset` support in Cython.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400510",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400511",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400512",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400513",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>claiming co-authorship ;-)",
    "created_at": "2016-11-25T10:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400514",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:52'></a>claiming co-authorship ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400515",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:53'></a>Honestly, I only typed, so you are very welcome.",
    "created_at": "2016-11-25T10:40:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400516",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:53'></a>Honestly, I only typed, so you are very welcome.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400519",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:57'></a>This is on OS X 10.12, Xcode 8.1.",
    "created_at": "2016-11-25T17:57:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400520",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:57'></a>This is on OS X 10.12, Xcode 8.1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400521",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:59'></a>My fault I said to edit `pynac.pxd` instead of `m4ri.pxd` I was busy with something else at the time.",
    "created_at": "2016-11-25T18:18:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400522",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:59'></a>My fault I said to edit `pynac.pxd` instead of `m4ri.pxd` I was busy with something else at the time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400523",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400525",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:63'></a>I plan to test what happens if we remove those lines and just set `MACOSX_DEPLOYMENT_TARGET` correctly. It may take me a few days to get to it, though.",
    "created_at": "2016-11-25T18:36:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400526",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:63'></a>I plan to test what happens if we remove those lines and just set `MACOSX_DEPLOYMENT_TARGET` correctly. It may take me a few days to get to it, though.
...
```json
{
    "body": "<a id='comment:64'></a>`MACOSX_DEPLOYMENT_TARGET` was set that way on purpose some time ago. That makes binaries backward compatible for example. There is nothing wrong with it in itself. And at the time there were difficulties for putting it at `10.10` (because two digits instead of one). By any means we can see what happens when we raise it.",
    "created_at": "2016-11-25T18:54:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400527",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:64'></a>`MACOSX_DEPLOYMENT_TARGET` was set that way on purpose some time ago. That makes binaries backward compatible for example. There is nothing wrong with it in itself. And at the time there were difficulties for putting it at `10.10` (because two digits instead of one). By any means we can see what happens when we raise it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21701#issuecomment-400529",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21701",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21701#event-57470"
}
```
