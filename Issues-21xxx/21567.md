...
```json
{
    "body": "<div id=\"comment:29\" align=\"right\">comment:29</div>\n\nI can push my current branch with the changes in [comment:23](#comment%3A23) if you think that's a good idea.",
...
```json
{
    "body": "<div id=\"comment:54\" align=\"right\">comment:54</div>\n\nThe failure in matrix_integer_dense.pyx is also very common on OSX 10.11 right now (possibly related to openblas, not sure). Why not go with [comment:23](#comment%3A23), its definitely an improvement over not building.",
