...
```json
{
    "body": "<a id='comment:1'></a>Such partial build of the doc is not possible. You should first do `make doc`",
    "created_at": "2017-03-16T21:12:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21611",
    "type": "issue_comment",
...
<a id='comment:1'></a>Such partial build of the doc is not possible. You should first do `make doc`
...
```json
{
    "body": "<a id='comment:2'></a>I think you can run the `inv` (or was it `inventory`?) version of the doc first, but yes, it is basically impossible (for now) because it needs other info that a partial build doesn't provide.",
    "created_at": "2017-03-16T21:55:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21611",
    "type": "issue_comment",
...
<a id='comment:2'></a>I think you can run the `inv` (or was it `inventory`?) version of the doc first, but yes, it is basically impossible (for now) because it needs other info that a partial build doesn't provide.
