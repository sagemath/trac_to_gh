...
```json
{
    "body": "<a id='comment:1'></a>Use a non-broken compiler to build Sage :-)",
    "created_at": "2016-10-02T09:51:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21620#issuecomment-296555",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Use a non-broken compiler to build Sage :-)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21620#event-57361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21620#issuecomment-296556",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21620#event-57362"
}
```
