...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390484",
    "user": "https://github.com/arpitdm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390485",
    "user": "https://github.com/arpitdm"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Please also note that the current code is more or less just what was in the original patch for #13215 related to Center related methods and classes. No effort has e.g. been made yet to accommodate for changes in #13215 since this addition was factored out.\n\n---\nLast 10 new commits:",
    "created_at": "2016-08-17T10:07:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390486",
    "user": "https://github.com/arpitdm"
}
```

<a id='comment:2'></a>Please also note that the current code is more or less just what was in the original patch for #13215 related to Center related methods and classes. No effort has e.g. been made yet to accommodate for changes in #13215 since this addition was factored out.
...
```json
{
    "body": "<a id='comment:3'></a>The methods `is_central` and `optimal_bound` make sense for skew polynomials over any ring, right? So it is a bit weird (according to me) to define them only in the class `SkewPolynomial_finite_field_dense` (through *I* very probably do this first).\n\nSimilarly the reduced norm makes sense as soon as the twist map has finite order (and in addition I am very interested in using it over a finite extension of Qp). So, I would suggest to move it to the class `SkewPolynomial_generic_dense` and to raise `ValueError` or `TypeError` when the twist map has not finite order.",
    "created_at": "2016-08-17T12:51:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390487",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:3'></a>The methods `is_central` and `optimal_bound` make sense for skew polynomials over any ring, right? So it is a bit weird (according to me) to define them only in the class `SkewPolynomial_finite_field_dense` (through *I* very probably do this first).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390488",
    "user": "https://github.com/arpitdm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390489",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>As I said before, the features provided by this ticket do not only make sense for finite fields but more generally for fields on which the twisting endomorphism has finite order. I then renamed the class `SkewPolynomial_finite_field_dense` and called it `SkewPolynomial_finite_order_dense`. \nMoreover, I polished the code and made all methods work (e.g. some imports were missing). \n\nTicket ready for review.\n\n---\nNew commits:",
    "created_at": "2016-08-25T22:03:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390490",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:6'></a>As I said before, the features provided by this ticket do not only make sense for finite fields but more generally for fields on which the twisting endomorphism has finite order. I then renamed the class `SkewPolynomial_finite_field_dense` and called it `SkewPolynomial_finite_order_dense`. 
Moreover, I polished the code and made all methods work (e.g. some imports were missing). 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390491",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390492",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390493",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390494",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390495",
...
```json
{
    "body": "<a id='comment:7'></a>branch does not merge.",
    "created_at": "2017-01-07T06:45:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390496",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:7'></a>branch does not merge.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390498",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390499",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390500",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Ready for review again?",
    "created_at": "2020-04-02T23:26:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390501",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>Ready for review again?
...
```json
{
    "body": "<a id='comment:11'></a>Not yet. There are issues with pickling, I'm working on this.\n\nSome of these problems come from issues with Frobenius endomorphisms and embeddings which are fixed in ticket #29452. So meanwhile, I encourage you to review #29452 :-)",
    "created_at": "2020-04-03T07:12:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390502",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:11'></a>Not yet. There are issues with pickling, I'm working on this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390503",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390504",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390505",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390506",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>There are still some issues with `_test_category` for the embedding `Z(K[X;theta]) -> K[X;theta]` and its section. But I don't know how to fix it (I poorly understand the mecanism of categories), so I skip the test :-). If you know how one has to fix this, please teach me.",
    "created_at": "2020-04-03T16:40:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390507",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:13'></a>There are still some issues with `_test_category` for the embedding `Z(K[X;theta]) -> K[X;theta]` and its section. But I don't know how to fix it (I poorly understand the mecanism of categories), so I skip the test :-). If you know how one has to fix this, please teach me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390508",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390509",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I am a strong -1 on using `UniqueFactory` in place of `UniqueRepresentation`. All of that code should be in `SkewPolynomialRing_general`, and it would be better to make it a `__classcall_private__` so you don't have to handle the `element_class` in the key and the input data is only normalized on the main entry point. Actually, I don't immediately see the need for this and why it cannot just be set in subclasses...\n\nYou can also do away with the `self._polynomial_class` attribute in place of `self.Element`.\n\nFor the coercions, it probably would be better to use\n\n```\ncenter_inject.register_as_coercion()\n```\nThere also is a new mechanism for doing base ring injections. See #29247 and #19225. So you should use\n\n```\ndef _coerce_map_from_base_ring(self):\n```",
    "created_at": "2020-04-04T12:54:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390510",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:15'></a>I am a strong -1 on using `UniqueFactory` in place of `UniqueRepresentation`. All of that code should be in `SkewPolynomialRing_general`, and it would be better to make it a `__classcall_private__` so you don't have to handle the `element_class` in the key and the input data is only normalized on the main entry point. Actually, I don't immediately see the need for this and why it cannot just be set in subclasses...
...
```json
{
    "body": "<a id='comment:16'></a>I have no problem with switching back to `UniqueRepresentation` but why don't you like `UniqueFactory`? It seems that it offers more flexibility and, at least for me, it is more comprehensible than `__classcall__`",
    "created_at": "2020-04-04T19:01:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390511",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:16'></a>I have no problem with switching back to `UniqueRepresentation` but why don't you like `UniqueFactory`? It seems that it offers more flexibility and, at least for me, it is more comprehensible than `__classcall__`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390512",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390513",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390514",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390515",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390516",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>OK. I re-read the documentation in `sage.strcture.unique_representation` and I now understand better the mecanism behind `__classcall__` and `__classcall_private__`. I'm still not entirely convinced that it's better/simpler than `UniqueFactory` (especially I'm still not that confortable with using metaclasses), but I followed your recommandations.",
    "created_at": "2020-04-06T13:54:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390517",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:21'></a>OK. I re-read the documentation in `sage.strcture.unique_representation` and I now understand better the mecanism behind `__classcall__` and `__classcall_private__`. I'm still not entirely convinced that it's better/simpler than `UniqueFactory` (especially I'm still not that confortable with using metaclasses), but I followed your recommandations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390520",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390521",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>OK, I addressed all your comments. I finally decided to remove the class `CenterSkewPolynomialRing` and to add the keyword argument `coerce` to the method `center` to let the user choose if he/she wants to set a coercion map or not.\n\nI don't understand why:\n\n```\nElement = sage.rings.polynomial.skew_polynomial_finite_order.SkewPolynomial_finite_order_dense\n```\nfails (see line 1301 of `skew_polynomial_ring.py`), giving the error\n\n```\nAttributeError: module 'sage.rings.polynomial' has no attribute 'skew_polynomial_finite_order'\n```\nAny idea?",
    "created_at": "2020-04-08T13:03:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390522",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:25'></a>OK, I addressed all your comments. I finally decided to remove the class `CenterSkewPolynomialRing` and to add the keyword argument `coerce` to the method `center` to let the user choose if he/she wants to set a coercion map or not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390523",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390524",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390526",
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21262#event-56668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390527",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390528",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390529",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390532",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390534",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390535",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390536",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390537",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390538",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390540",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390541",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390542",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390544",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390545",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390546",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390548",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390549",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390550",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390551",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390552",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390553",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390555",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390557",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390558",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390559",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390560",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390561",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390563",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390564",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390566",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390567",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390568",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390569",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390570",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390573",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390574",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:61'></a>Okay, that is a reasonable enough thing to happen, and I am okay with this solution. Thank you.",
    "created_at": "2020-04-15T22:59:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390575",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:61'></a>Okay, that is a reasonable enough thing to happen, and I am okay with this solution. Thank you.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390576",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:63'></a>Maybe the right thing to do is to use to construction `over` I've introduced in ticket #21413. However, if so, I perfer delaying this for another ticket.",
    "created_at": "2020-04-16T07:34:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390578",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:63'></a>Maybe the right thing to do is to use to construction `over` I've introduced in ticket #21413. However, if so, I perfer delaying this for another ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390579",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390580",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390581",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:65'></a>So, I added a test to ensure that no coercion map already exists. (See also ticket #29517)",
    "created_at": "2020-04-16T09:25:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390582",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:65'></a>So, I added a test to ensure that no coercion map already exists. (See also ticket #29517)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390583",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390584",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390585",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390586",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390587",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390588",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390589",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    "body": "<a id='comment:69'></a>I give back a positive review to this ticket.",
    "created_at": "2020-04-16T14:33:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390590",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:69'></a>I give back a positive review to this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390591",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21262#event-56669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21262#issuecomment-390592",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21262#event-56670"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21262#event-56671"
}
```
