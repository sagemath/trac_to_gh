...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314540",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314541",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I guess I should say in the case of parallel make. In which the parallelism of make is translated into installing packages concurrently.",
    "created_at": "2016-09-19T00:52:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314543",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>I guess I should say in the case of parallel make. In which the parallelism of make is translated into installing packages concurrently.
...
```json
{
    "body": "<a id='comment:6'></a>Yes, these issues need addressing in documentation and/or implementation.",
    "created_at": "2016-09-19T01:04:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314544",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>Yes, these issues need addressing in documentation and/or implementation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314545",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314547",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314548",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314549",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314550",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314551",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Rebased on 7.4.beta6. \nNeeds review.",
    "created_at": "2016-09-27T19:27:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314552",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:14'></a>Rebased on 7.4.beta6. 
Needs review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314553",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Fine with me to wait for #21441 and its `sage-pip-install`. Is that ticket moving forward, by the way?",
    "created_at": "2016-09-29T07:04:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314555",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:16'></a>Fine with me to wait for #21441 and its `sage-pip-install`. Is that ticket moving forward, by the way?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314556",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314557",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Right, regardless of how make is invoked, if there are separate `spkg-build` and `spkg-install` scripts the former can be run unprivileged.  Then, at least in the current system, you would call `$SAGE_SUDO spkg-install`.\n\nI think most packages would be easy enough to split up their `spkg-install` into two scripts.  Though as I think I wrote in another ticket one might actually want a third `spkg-env` script that sets environment variables needed for both the build and install steps (fortunately for most autotools packages most relevant environment variables are only needed for the build step, I think).",
    "created_at": "2016-09-30T10:04:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314558",
    "user": "https://github.com/embray"
}
```

<a id='comment:19'></a>Right, regardless of how make is invoked, if there are separate `spkg-build` and `spkg-install` scripts the former can be run unprivileged.  Then, at least in the current system, you would call `$SAGE_SUDO spkg-install`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314559",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314560",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314561",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314562",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314563",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>This was implemented in #21726. The present ticket can be closed",
    "created_at": "2020-09-15T18:40:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314564",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:24'></a>This was implemented in #21726. The present ticket can be closed
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314565",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314566",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21537#issuecomment-314567",
    "user": "https://github.com/mkoeppe"
}
```
