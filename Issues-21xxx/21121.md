...
```json
{
    "body": "Changing dependencies from \"\" to \"#21124\"",
    "created_at": "2016-07-29T10:23:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386734",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "" to "#21124"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386735",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>(As is, `failstr()` truncates the mantissa to *just one digit*, i.e., the digit before the decimal point.)",
    "created_at": "2016-08-13T13:01:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386737",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>(As is, `failstr()` truncates the mantissa to *just one digit*, i.e., the digit before the decimal point.)
...
```json
{
    "body": "<a id='comment:5'></a>I.e., we should **at least** make sure `\"%.0e\" % RIFtol(actual).center()` doesn't give the same as `\"%.0e\" % RIFtol(desired).center()`.  (Not sure whether using `.center()` here is at all the right thing, or whether we should at all use `RIF` for the *tolerance values* themselves; see also below.)\n\nIf it does, we may increase the number of (mantissa) digits in the former.  Or in both, until they differ.\n\nAnd that's orthogonal to improving hints regarding the actual deviation, i.e., if one wants to adjust the *expected figures* rather than (just) the tolerance.\n\nIf the intervals of *want* and *got* do not overlap (i.e., when the tolerance is exceeded), we could also give `.upper()` and `.lower()` (or vice versa, depending on whether *want* is smaller or larger than *got*).",
    "created_at": "2016-08-13T13:39:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386738",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:5'></a>I.e., we should **at least** make sure `"%.0e" % RIFtol(actual).center()` doesn't give the same as `"%.0e" % RIFtol(desired).center()`.  (Not sure whether using `.center()` here is at all the right thing, or whether we should at all use `RIF` for the *tolerance values* themselves; see also below.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386739",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386740",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>... and the mentioned doctests for the doctest framework itself of course need to get adjusted to the new output.",
    "created_at": "2016-08-13T14:59:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386742",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:9'></a>... and the mentioned doctests for the doctest framework itself of course need to get adjusted to the new output.
...
```json
{
    "body": "<a id='comment:10'></a>You just need to print the numbers with directed roundings (up/down). But that needs #21124 to properly print the numbers.",
    "created_at": "2016-08-15T08:05:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386743",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>You just need to print the numbers with directed roundings (up/down). But that needs #21124 to properly print the numbers.
...
```json
{
    "body": "Changing branch from \"\" to \"u/jdemeyer/precision_in_doctest_tolerance__x___x\"",
    "created_at": "2018-08-29T09:28:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386744",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "" to "u/jdemeyer/precision_in_doctest_tolerance__x___x"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386745",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"a9909ab60eb35282534e545ee1e7ec633601c779\"",
    "created_at": "2018-08-29T10:36:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386746",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "a9909ab60eb35282534e545ee1e7ec633601c779"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386747",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"a9909ab60eb35282534e545ee1e7ec633601c779\" to \"e1ba5b73f39a47446d01581550ccf2a4259f14ca\"",
    "created_at": "2018-08-29T10:43:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386748",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a9909ab60eb35282534e545ee1e7ec633601c779" to "e1ba5b73f39a47446d01581550ccf2a4259f14ca"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386749",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386750",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"e1ba5b73f39a47446d01581550ccf2a4259f14ca\" to \"a636d1ee3c389f7270652db664e4b5ecfc388fd2\"",
    "created_at": "2018-08-29T11:14:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386751",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e1ba5b73f39a47446d01581550ccf2a4259f14ca" to "a636d1ee3c389f7270652db664e4b5ecfc388fd2"
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21121#event-56376"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386752",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386753",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386754",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386755",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386756",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"a636d1ee3c389f7270652db664e4b5ecfc388fd2\" to \"cb741123f8dec1849052c88b47dbc50caf3f6ab1\"",
    "created_at": "2018-08-29T12:05:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386757",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a636d1ee3c389f7270652db664e4b5ecfc388fd2" to "cb741123f8dec1849052c88b47dbc50caf3f6ab1"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386758",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386759",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386760",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"cb741123f8dec1849052c88b47dbc50caf3f6ab1\" to \"dd60a2e10199532a02bf591a41644df64d9ebef6\"",
    "created_at": "2018-08-29T12:20:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386761",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "cb741123f8dec1849052c88b47dbc50caf3f6ab1" to "dd60a2e10199532a02bf591a41644df64d9ebef6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386762",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386763",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"dd60a2e10199532a02bf591a41644df64d9ebef6\" to \"5535d2de60d94021d0332369e9cbe9ddc9e32cfd\"",
    "created_at": "2018-08-29T14:17:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386764",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "dd60a2e10199532a02bf591a41644df64d9ebef6" to "5535d2de60d94021d0332369e9cbe9ddc9e32cfd"
...
```json
{
    "body": "Changing commit from \"5535d2de60d94021d0332369e9cbe9ddc9e32cfd\" to \"b76623dc03e4d81ff303eac219ad5c907a4c2360\"",
    "created_at": "2019-01-11T13:12:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386765",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "5535d2de60d94021d0332369e9cbe9ddc9e32cfd" to "b76623dc03e4d81ff303eac219ad5c907a4c2360"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386766",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386767",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"b76623dc03e4d81ff303eac219ad5c907a4c2360\" to \"e62891b0edc5754465df192ebb174938a7706e9e\"",
    "created_at": "2019-01-25T10:55:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386768",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b76623dc03e4d81ff303eac219ad5c907a4c2360" to "e62891b0edc5754465df192ebb174938a7706e9e"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386769",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386770",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386771",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>LGTM (except that \u201cit is carries\u201d in the comment should be \u201cit carries\u201d).",
    "created_at": "2019-01-26T09:39:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386772",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:25'></a>LGTM (except that “it is carries” in the comment should be “it carries”).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386773",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Branch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. This was a forced push. New commits:",
    "created_at": "2019-01-26T09:55:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386774",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

<a id='comment:26'></a>Branch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. This was a forced push. New commits:
...
```json
{
    "body": "Changing commit from \"e62891b0edc5754465df192ebb174938a7706e9e\" to \"d7f08627df8903903f2b42ed461e4ba0b477b216\"",
    "created_at": "2019-01-26T09:55:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386775",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e62891b0edc5754465df192ebb174938a7706e9e" to "d7f08627df8903903f2b42ed461e4ba0b477b216"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386776",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Fixed typo",
    "created_at": "2019-01-26T09:55:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386777",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:27'></a>Fixed typo
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/precision_in_doctest_tolerance__x___x\" to \"d7f08627df8903903f2b42ed461e4ba0b477b216\"",
    "created_at": "2019-01-27T10:50:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386778",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jdemeyer/precision_in_doctest_tolerance__x___x" to "d7f08627df8903903f2b42ed461e4ba0b477b216"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21121#issuecomment-386779",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21121",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21121#event-56377"
}
```
