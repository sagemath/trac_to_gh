...
```json
{
    "body": "<a id='comment:1'></a>Manually going into the automake-1.9 source directory and copying the `config.guess` from my system's `/usr/share/automake-1.15` allowed it to build.\n\nActually, ended up just\n\n```\nfind . -name 'config.guess' -exec cp /usr/share/automake-1.15/config.guess {} \\;\n```\n\nI wonder if some variant of this wouldn't be good to include in the build scripts for the spkg (without hard-coding `automake-1.15` of course).  In other words, just take the latest `config.guess` from the system, if it exists.",
    "created_at": "2016-11-18T10:05:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404942",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>Manually going into the automake-1.9 source directory and copying the `config.guess` from my system's `/usr/share/automake-1.15` allowed it to build.
...
```json
{
    "body": "<a id='comment:2'></a>After a closer look at the different `config.guess` scripts, the old ones would have worked on 32-bit Cygwin, but not on 64-bit Cygwin (they lack wildcard patterns that would match \"x86_64\" as the machine name).",
    "created_at": "2016-11-18T10:13:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404943",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>After a closer look at the different `config.guess` scripts, the old ones would have worked on 32-bit Cygwin, but not on 64-bit Cygwin (they lack wildcard patterns that would match "x86_64" as the machine name).
...
```json
{
    "body": "<a id='comment:3'></a>Sage provides more or less up to date config.* scripts.\nYou can try to modify the spkg-install script to copy them at build time to let the build proceed...\nBut maybe installing autotools on a cygwin setup is not the best idea :/",
    "created_at": "2016-11-18T10:22:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404944",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:3'></a>Sage provides more or less up to date config.* scripts.
You can try to modify the spkg-install script to copy them at build time to let the build proceed...
But maybe installing autotools on a cygwin setup is not the best idea :/
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404945",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404946",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>For now I hand-edited the Makefile.build to copy my working config.guess to the proper place when building all the automakes, so I've kicked off that build.\n\nIn the meantime I've edited `spkg-write-makefile` (will post a patch soon) to add such a step to the makefile (the details are subject to debate; I haven't thought it through fully).  Once I've bootstrapped my $SAGE_LOCAL with a working autotools build I can re-run `spkg-write-makefile` to provide an updated `Makefile.build` as well.",
    "created_at": "2016-11-18T12:16:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404947",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>For now I hand-edited the Makefile.build to copy my working config.guess to the proper place when building all the automakes, so I've kicked off that build.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21896#event-57790"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21896#event-57791"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21896#event-57792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404948",
...
```json
{
    "body": "<a id='comment:9'></a>Outdated - we removed the spkg",
    "created_at": "2020-08-13T14:36:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404949",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:9'></a>Outdated - we removed the spkg
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404950",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404951",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21896#event-57793"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21896",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21896#issuecomment-404952",
    "user": "https://github.com/embray"
}
```
