...
```json
{
    "body": "<a id='comment:1'></a>\nDo you have a doctest to propose that takes less time to run?\n\n---\nNew commits:\n|                                                                                                                                          |                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[bb91260](https://git.sagemath.org/sage.git/commit?id=bb912600c0f96279db35b7d93664cbd5d2be72f0)|`21993: int -> long`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nHere's a fix (with doctest) for the actual bug.\nNeeds review.\n\n---\nNew commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[773c43a](https://git.sagemath.org/sage.git/commit?id=773c43a725c0c46feb1be301269d37ea34fe6629)|`#21993: Add doctest`|\n|[76cd1ea](https://git.sagemath.org/sage.git/commit?id=76cd1ea370076c04901fe331760839d6c0166cf4)|`#21993: Fix test for possible overflow during enumeration`|",
    "created_at": "2017-05-07T04:11:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21993",
    "type": "issue_comment",
