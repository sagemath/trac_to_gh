...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[b5621b4](https://git.sagemath.org/sage.git/commit?id=b5621b47df6ed2a6ee7836e187731d367ba9fe37)|`If spkg-build exists, run it, followed by $SAGE_SUDO spkg-install`|\n|[b595edd](https://git.sagemath.org/sage.git/commit?id=b595edd736421531903af3e29817bb41465b47a5)|`4ti2: Call make install within $SUDO`|\n|[48053d0](https://git.sagemath.org/sage.git/commit?id=48053d0af7bef79e41a581aa492e58a285c9feb6)|`lcalc: Split out spkg-build from spkg-install`|",
    "created_at": "2016-10-19T03:49:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21726",
    "type": "issue_comment",
