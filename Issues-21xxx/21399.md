...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[050cf18](https://git.sagemath.org/sage.git/commit/?id=050cf181716755898058a925396fbed919ecf7f6)|`Provide ctypes.util.find_library replacement that works on Cygwin`|\n|[34c3734](https://git.sagemath.org/sage.git/commit/?id=34c373496e52e76c7167ff8bf9559a1a7b005d86)|`Use find_library from sage instead of direct from ctypes`|\n|[986ee8a](https://git.sagemath.org/sage.git/commit/?id=986ee8ac474d60739b7c0303ec5ca95c7ac9992b)|`Make this test more portable`|",
    "created_at": "2016-09-02T14:28:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21399",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[0e04da0](https://git.sagemath.org/sage.git/commit/?id=0e04da0aff71ce1ba5cd4096db0a036e10faf96f)|`Provide ctypes.util.find_library replacement that works on Cygwin`|\n|[9e736a4](https://git.sagemath.org/sage.git/commit/?id=9e736a4862c6dad8725bbfe284fd53cbfeac3cc9)|`Use find_library from sage instead of direct from ctypes`|\n|[c980249](https://git.sagemath.org/sage.git/commit/?id=c9802499f681607aeaa418c85a67ade72d30751a)|`Make this test more portable`|\n|[1ea7b76](https://git.sagemath.org/sage.git/commit/?id=1ea7b764955f01fa315383d3bc6465c1a984fc8e)|`Went ahead with my earlier instinct of creating a new 'compat' module.`|\n|[70c3677](https://git.sagemath.org/sage.git/commit/?id=70c3677bb5433d8fd1f6b3e409969804b11af0f6)|`Just use Popen.communicate to get the result.`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[ae96276](https://git.sagemath.org/sage.git/commit/?id=ae962763fdb41219eb825e141e8d1be5fa6559d3)|`Wrap find_library on all platforms; include an example doctest`|\n|[0ed913a](https://git.sagemath.org/sage.git/commit/?id=0ed913aafd2fd202e95b3fdc024f5db30c6ebce0)|`Don't start this line with ... so as to not confuse the doctest parser`|",
    "created_at": "2017-03-30T14:08:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21399",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[bb90642](https://git.sagemath.org/sage.git/commit/?id=bb9064269c3d3848fbe7c39da6c5d91c4a688d19)|`Provide ctypes.util.find_library replacement that works on Cygwin`|\n|[147eb09](https://git.sagemath.org/sage.git/commit/?id=147eb09aca417f14d3ac466a981c69e57cc8e5b0)|`Use find_library from sage instead of direct from ctypes`|\n|[80db468](https://git.sagemath.org/sage.git/commit/?id=80db468bdc9707c11b0c25e9c915c15885d10185)|`Make this test more portable`|\n|[e76a826](https://git.sagemath.org/sage.git/commit/?id=e76a826d9e75ad8dd2f546807acc18a9395d1276)|`Went ahead with my earlier instinct of creating a new 'compat' module.`|\n|[ab684c2](https://git.sagemath.org/sage.git/commit/?id=ab684c2c4fb32ce1625b7e38f8adfbe7ac92a032)|`Just use Popen.communicate to get the result.`|\n|[367dd61](https://git.sagemath.org/sage.git/commit/?id=367dd61139de1f87883843d04c4a7e793697f3ca)|`Wrap find_library on all platforms; include an example doctest`|\n|[125dc58](https://git.sagemath.org/sage.git/commit/?id=125dc58446e374e02306163a19afa983d27d58a1)|`Don't start this line with ... so as to not confuse the doctest parser`|",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[8a09f15](https://git.sagemath.org/sage.git/commit/?id=8a09f157eea4ec50ff45d8d7ce2165c6cac21f4f)|`Wrap find_library on OSX so that libraries in SAGE_LOCAL can be found`|",
    "created_at": "2017-05-02T07:44:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21399",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:49'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[83b7f76](https://git.sagemath.org/sage.git/commit/?id=83b7f7657dd6c846db17df8863180ec6c31261e7)|`Don't use sage_wraps here as there's little benefit.  In particular the`|",
    "created_at": "2017-05-09T13:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21399",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:52'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[efd8f13](https://git.sagemath.org/sage.git/commit/?id=efd8f13e8bc2a98d4d675dc4d567da6891165739)|`Don't use sage_wraps here as there's little benefit.  In particular the`|",
...
```json
{
    "body": "<a id='comment:57'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[f2691a8](https://git.sagemath.org/sage.git/commit/?id=f2691a86a6ee6d486965c9e120cff62160c5e5a5)|`Unset DYLD_LIBRARY_PATH if it was not already set`|",
    "created_at": "2017-06-26T13:53:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21399",
    "type": "issue_comment",
