...
```json
{
    ...
    "type": "issue",
    "updated_at": "2016-11-26T11:17:49Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21974#event-266892"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21974#event-266893"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21974#event-266894"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21974#issuecomment-326249",
    "user": "https://github.com/pelegm"
}
```
