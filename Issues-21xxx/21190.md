...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[97a2ce4](https://git.sagemath.org/sage.git/commit/?id=97a2ce4eb2a81977c261f5f0d4668c7717bb0451)|`On Cygwin only, make PPL think setitimer is not supported, to prevent it`|\n|[f8dbb74](https://git.sagemath.org/sage.git/commit/?id=f8dbb749ee4f9ee621c15dd75639c6128d35dba8)|`Add a comment referencing the ticket`|",
