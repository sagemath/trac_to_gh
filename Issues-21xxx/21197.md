...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[de0e9db](https://git.sagemath.org/sage.git/commit/?id=de0e9dbb3b8c66cd871caa96c2824943399ddc88)|`Some bikeshedding to poset functions that return a graph.`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[cd39820](https://git.sagemath.org/sage.git/commit/?id=cd3982022709c7fcb322a38ebadd7f4babe5b256)|`A correction.`|",
