...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306673",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306674",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306675",
    "user": "https://trac.sagemath.org/admin/accounts/users/gjorgenson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306676",
    "user": "https://trac.sagemath.org/admin/accounts/users/gjorgenson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306677",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306678",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306680",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306681",
    "user": "https://trac.sagemath.org/admin/accounts/users/gjorgenson"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>THis new resolution functionality looks fine to me.\n\nFor the blow-up, yes that should be the correct ideal to blow up not at the origin. That is almost certainly easier than translating.",
    "created_at": "2016-08-14T14:38:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306683",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:9'></a>THis new resolution functionality looks fine to me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306684",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306685",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Yes, that is a bug. In that case the coordinate ring of the map was a fraction field, so it failed to create the hom. It is now fixed in #21285, which needs review.",
    "created_at": "2016-08-18T14:51:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306687",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:13'></a>Yes, that is a bug. In that case the coordinate ring of the map was a fraction field, so it failed to create the hom. It is now fixed in #21285, which needs review.
...
```json
{
    "body": "<a id='comment:14'></a>This is getting a little beyond my expertise, but what are describing sounds correct to me. As for what to do with the empty chart. I would prefer to return it so that there are 'right' number of charts. It is clearly empty based on the defining equations.\n\nFor the blow-up at points. A couple things. While it is fine to accept a list as input and do the coercision in the function, I think it would be better to pass in actual points in the examples, maybe a curve point for one and an affine space point for another. Also, I'd like to see it default to the origin, so that the point parameter is optional.",
    "created_at": "2016-08-18T15:33:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306688",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:14'></a>This is getting a little beyond my expertise, but what are describing sounds correct to me. As for what to do with the empty chart. I would prefer to return it so that there are 'right' number of charts. It is clearly empty based on the defining equations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306689",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306690",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306692",
    "user": "https://trac.sagemath.org/admin/accounts/users/gjorgenson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306694",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306695",
...
```json
{
    "body": "<a id='comment:19'></a>Any chance some of you have a look at #17254#comment:364 ?\nWith the Singular upgrade a few signs changed in the doctests from here and we have no idea if the result is still valid (although it does not look obviously false).",
    "created_at": "2016-09-07T14:55:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21085#issuecomment-306696",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:19'></a>Any chance some of you have a look at #17254#comment:364 ?
With the Singular upgrade a few signs changed in the doctests from here and we have no idea if the result is still valid (although it does not look obviously false).
