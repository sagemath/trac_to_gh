...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[c825262](https://git.sagemath.org/sage.git/commit/?id=c825262775a13aab8ca39acfd5257fe242d05298)|`Numerical noise on Haswell:  Increase the tolerence by even less`|",
