...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[274d8b3](https://git.sagemath.org/sage.git/commit?id=274d8b378586814a35d67ce342192f617bcbe97e)|`Clean up stale installed files in install command`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[e50f978](https://git.sagemath.org/sage.git/commit/?id=e50f978de0967be95d76534f7e9a5cfd740f8008)|`Add some documentation`|",
