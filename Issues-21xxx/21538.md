...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320279",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nWhy not an argument `--enable-foo` (and/or perhaps `--with-foo=/path/where/installed`, depending on the answer to ticket:21566#comment:3) for each package `foo`?",
    "created_at": "2016-09-23T13:43:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320280",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320281",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320282",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21538#event-196692"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320283",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320284",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21538#event-196693"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21538#event-196694"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21538#event-196695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320285",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21538#issuecomment-320286",
    "user": "https://github.com/mkoeppe"
}
```
