...
```json
{
    "body": "<a id='comment:1'></a>\nWhether 1 or 3 packages, I suggest a fork placed on [GitHub](../wikis/GitHub) to be a good approach, with sage being switched to use the forked project as the upstream.",
