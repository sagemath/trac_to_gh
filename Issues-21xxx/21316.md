...
<a id='comment:1'></a>From `sage.matrix.matrix_dense`:
...
<a id='comment:2'></a>Non-cryptographic hashes don't have to be resilient to collision attacks, but should indeed give good hash value spread for the input space - which this implementation doesn't.
...
```json
{
    "body": "<a id='comment:6'></a>Looks like major work was put into this issue in #19050, rendering this ticket a duplicate.",
...
<a id='comment:6'></a>Looks like major work was put into this issue in #19050, rendering this ticket a duplicate.
...
```json
{
    "body": "<a id='comment:7'></a>Duplicate of #10950.",
    "created_at": "2017-11-22T12:43:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21316",
    "type": "issue_comment",
...
<a id='comment:7'></a>Duplicate of #10950.
