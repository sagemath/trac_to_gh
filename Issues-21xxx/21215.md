...
```json
{
    "body": "<a id='comment:1'></a>My vote is for 1). As you seem to have a use case can you be please more detailed?",
    "created_at": "2016-08-11T07:53:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389173",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>My vote is for 1). As you seem to have a use case can you be please more detailed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389174",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389175",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389176",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389177",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Or did you mean decomposition into piecewise+linear. Better question: how should the piecewise quasiperiodic be represented textually? What preferred way to input them?",
    "created_at": "2016-08-12T08:24:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389178",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>Or did you mean decomposition into piecewise+linear. Better question: how should the piecewise quasiperiodic be represented textually? What preferred way to input them?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389179",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389180",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21215#event-56577"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>By the way, I have some existing code for piecewise linear and quasiperiodic piecewise linear that could probably be adapted. It is based on the old piecewise implementation.\n- https://github.com/mkoeppe/infinite-group-relaxation-code/blob/master/functions.sage#L1183\n- https://github.com/mkoeppe/infinite-group-relaxation-code/blob/master/quasi_periodic.sage",
    "created_at": "2016-08-12T19:17:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389181",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:9'></a>By the way, I have some existing code for piecewise linear and quasiperiodic piecewise linear that could probably be adapted. It is based on the old piecewise implementation.
- https://github.com/mkoeppe/infinite-group-relaxation-code/blob/master/functions.sage#L1183
- https://github.com/mkoeppe/infinite-group-relaxation-code/blob/master/quasi_periodic.sage
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389182",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389183",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389184",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21215#issuecomment-389185",
    "user": "https://github.com/mkoeppe"
}
```
