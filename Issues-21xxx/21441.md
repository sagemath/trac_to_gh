...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[ea52ac9](https://git.sagemath.org/sage.git/commit/?id=ea52ac9527aebf6ac967b6aa6cf56aed18b733d8)|`Make sure to consume additional flags passed to the PIP_INSTALL command`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[a6e0538](https://git.sagemath.org/sage.git/commit/?id=a6e053839fe27837626791d65efd87c9bcf55e14)|`Ensure stderr is captured for repeat uninstalls`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[2ee51db](https://git.sagemath.org/sage.git/commit/?id=2ee51db6b2f2e841b052cb6216b711deba51101b)|`Change the shebang line to user /usr/bin/env`|",
    "created_at": "2016-09-09T13:27:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21441",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:33'></a>\nNew commits:\n|                                                                                                                                          |                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[ccd9442](https://git.sagemath.org/sage.git/commit?id=ccd94425cd0d5a89751269059a6ce508fa0265bf)|`Add a sage-pip-install wrapper for pip which handles uninstallation better.`|\n|[3b61291](https://git.sagemath.org/sage.git/commit?id=3b61291db3c028bcac9741552c80bd179a0844d4)|`Directly call sage-pip-install instead of using $PIP_INSTALL`|\n|[f4ca23a](https://git.sagemath.org/sage.git/commit?id=f4ca23af1de4fcd0158fa3b0f459f625faec5ce9)|`Re-install all pip-installed packages`|\n|[92ae7d7](https://git.sagemath.org/sage.git/commit?id=92ae7d7e63ca5ad97603d208de351bef7a2085e3)|`Minor fixes to sage-pip-install`|",
    "created_at": "2016-09-20T10:13:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21441",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[8afdf21](https://git.sagemath.org/sage.git/commit/?id=8afdf212e25c9fd815d306ad89357f86309933aa)|`Fix various dependencies`|",
    "created_at": "2016-09-20T13:08:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21441",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|\n|[4d4d72c](https://git.sagemath.org/sage.git/commit/?id=4d4d72c0fd05a5fb1371ee02e1eab419a11fd4f7)|`Various fixes and simplifications to sage-pip-install`|\n|[2b28dd9](https://git.sagemath.org/sage.git/commit/?id=2b28dd992c8c3f256c2329cab617858447bdeee3)|`Re-install all pip-installed packages`|\n|[e351c98](https://git.sagemath.org/sage.git/commit/?id=e351c98d94505343082bc16d9397a87f7058eef5)|`Fix various dependencies`|",
