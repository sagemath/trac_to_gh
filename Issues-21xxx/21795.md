...
```json
{
    "body": "<a id='comment:2'></a>\nAlso, should it perhaps be installed using pip instead of directly using `setup.py`?\n\n---\nNew commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[2273b2d](https://git.sagemath.org/sage.git/commit?id=2273b2d9f4e6aaf2a6744fdf8bb98642698362a8)|`fpylll: Add Python and Cython as dependencies`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[bdf6a00](https://git.sagemath.org/sage.git/commit/?id=bdf6a006ea7df95f3b71c2f6ad4f273a415e5fa0)|`fpylll: Add cysignals dependency`|",
    "created_at": "2016-11-02T19:02:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21795",
    "type": "issue_comment",
