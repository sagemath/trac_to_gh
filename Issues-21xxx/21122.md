...
```json
{
    "body": "<a id='comment:1'></a>\nThis is at least a much better solution than the hack I had to do on #21054.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|\n|[322ea9c](https://git.sagemath.org/sage.git/commit?id=322ea9cae16a930121847144c4128b242069b21e)|`Merge branch 'public/21043' of trac.sagemath.org:sage into public/combinat/moebius_algebra_triangularity-TBA`|\n|[c09d3b0](https://git.sagemath.org/sage.git/commit?id=c09d3b086d3ba180743d7bc02ba150783ca76d4d)|`Using a dedicated key class instead of non-facade posets.`|",
    "created_at": "2016-07-28T21:58:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21122",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[499bbe6](https://git.sagemath.org/sage.git/commit/?id=499bbe65ec6fd20546c15f815f2a40faf29eb972)|`Addressing Darij's comments.`|",
    "created_at": "2016-07-29T01:36:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21122",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[872f3c0](https://git.sagemath.org/sage.git/commit/?id=872f3c0e21ab0d8608257f980c7ce6867dbcca8b)|`Fixing pickleability for Moebius algebra morphisms.`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[56e4fb3](https://git.sagemath.org/sage.git/commit/?id=56e4fb38f47ee24a88a2752393cf2a0b16eead0b)|`Using the Hasse diagram's promise that 0..n is a linear extension.`|",
