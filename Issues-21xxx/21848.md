...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -13,6 +13,19 @@\n \n Manually adding `-lreadline` worked around the problem, but I haven't looked deeply into why this is needed.\n \n+Now I'm also getting similar problems with functions from omalloc:\n+\n+```\n+g++ -shared -Wl,--enable-auto-image-base -L/home/embray/src/sagemath/sage/local/lib -Wl,-rpath,/home/embray/src/sagemath/sage/local/lib -L/home/embray/src/sagemath/sage/local/lib -Wl,-rpath,/home/embray/src/sagemath/sage/local/lib build/temp.cygwin-2.5.1-x86_64-2.7/home/embray/src/sagemath/sage/src/build/cythonized/sage/libs/singular/option.o -L/home/embray/src/sagemath/sage/local/lib -L/home/embray/src/sagemath/sage/local/lib/python2.7/config -L/home/embray/src/sagemath/sage/local/lib -lomalloc -lSingular -lpolys -lfactory -lresources -lntl -lflint -lmpfr -lgmp -lreadline -lstdc++ -lpython2.7 -o build/lib.cygwin-2.5.1-x86_64-2.7/sage/libs/singular/option.dll\n+[sagelib-7.5.beta1] /home/embray/src/sagemath/sage/local/lib/libSingular.a(kutil.o): In function `p_Init':\n+[sagelib-7.5.beta1] /home/embray/src/sagemath/sage/local/var/tmp/sage/build/singular-4.0.3p3/src/latest/kernel/GBEngine/../../libpolys/polys/monomials/p_polys.h:1248: undefined reference to `omAllocBinFromFullPage'\n+[sagelib-7.5.beta1] /home/embray/src/sagemath/sage/local/var/tmp/sage/build/singular-4.0.3p3/src/latest/kernel/GBEngine/../../libpolys/polys/monomials/p_polys.h:1248:(.text+0x8abc): relocation truncated to fit: R_X86_64_PC32 against undefined symbol `omAllocBinFromFullPage'\n+```\n+\n+This one is a bit simpler I think--`-lomalloc` should be coming after `-lSingular` if there are symbols in libSingular that need to be resolved in libomalloc.  We've had issues like this before on Cygwin.\n+\n+Not sure why `-lreadline` was needed though when it wasn't needed elsewhere.\n+\n Comment: 1\n \n Summary: Build failure on Cygwin when linking with Singular 4\n``````\n",
    "created_at": "2016-11-09T12:51:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21848#issuecomment-403547",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Part of the issue here is that libSingular is not being built as a shared library (at least on on Cygwin).  Is this supposed to be the case, or is there an issue with Singular 4?",
    "created_at": "2016-11-10T12:19:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21848#issuecomment-403548",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>Part of the issue here is that libSingular is not being built as a shared library (at least on on Cygwin).  Is this supposed to be the case, or is there an issue with Singular 4?
...
```json
{
    "body": "<a id='comment:3'></a>I think, at a bare minimum, the `LT_INIT` calls in all the `configure.ac`s in singular should look like:\n\n```\nLT_INIT([win32-dll])\n```\n\nin order to support properly linking and building DLLs with libtool on Windows.",
    "created_at": "2016-11-10T14:23:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21848#issuecomment-403549",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>I think, at a bare minimum, the `LT_INIT` calls in all the `configure.ac`s in singular should look like:
...
```json
{
    "body": "Changing dependencies from \"\" to \"#21957\"",
    "created_at": "2016-12-12T14:38:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21848#issuecomment-403552",
    "user": "https://github.com/embray"
}
```

Changing dependencies from "" to "#21957"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21848",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21848#event-57728"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21848#event-57729"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>This should actually be fixed in #22425.  I'm not directly aware of any build issues in the current version of Singular that wouldn't have been fixed by that upgrade.",
    "created_at": "2017-04-11T14:14:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21848#issuecomment-403553",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>This should actually be fixed in #22425.  I'm not directly aware of any build issues in the current version of Singular that wouldn't have been fixed by that upgrade.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21848#issuecomment-403554",
    "user": "https://github.com/embray"
}
```
