...
```json
{
    "body": "<a id='comment:1'></a>may be related to #21289",
    "created_at": "2016-08-27T11:13:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392613",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>may be related to #21289
...
```json
{
    "body": "<a id='comment:2'></a>Note that the file doesn't even have long tests.\n\nFor me still passes quickly in 7.4.beta0, but not beta2.  (Don't have a beta1 at hand right now.)",
    "created_at": "2016-08-27T19:14:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392614",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>Note that the file doesn't even have long tests.
...
```json
{
    "body": "<a id='comment:4'></a>The only test that follows doesn't take time either:\n\n```\nsage: P = graphs.CycleGraph(5)\nsage: P.tutte_polynomial() # indirect doctest\nx^4 + x^3 + x^2 + x + y\n```",
    "created_at": "2016-08-27T19:37:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392616",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:4'></a>The only test that follows doesn't take time either:
...
```json
{
    "body": "<a id='comment:6'></a>Much the same here. With verbose turned on the first `odd` looking test is at `line 495`\n\n```\nTrying (line 493):    from sage.graphs.tutte_polynomial import tutte_polynomial\nExpecting nothing\nok [0.00 s]\nTrying (line 494):    G = graphs.PetersenGraph()\nExpecting nothing\nok [0.00 s]\nTrying (line 495):    T = tutte_polynomial(G)  #indirect doctest\nExpecting nothing\nok [86.19 s]\nTrying (line 496):    tutte_polynomial(G)(1,1)  #indirect doctest\nExpecting:\n    2000\nok [86.19 s]\nTrying (line 498):    sig_on_count() # check sig_on/off pairings (virtual doctest)\nExpecting:\n    0\nok [0.00 s]\nTrying (line 534):    all(T.tutte_polynomial() == x**9 for T in graphs.trees(10))\nExpecting:\n    True\nok [190.56 s]\nTrying (line 539):    P = graphs.PetersenGraph()\nExpecting nothing\nok [0.00 s]\nTrying (line 540):    P.tutte_polynomial()\nExpecting:\n    x^9 + 6*x^8 + 21*x^7 + 56*x^6 + 12*x^5*y + y^6 + 114*x^5 + 70*x^4*y\n    + 30*x^3*y^2 + 15*x^2*y^3 + 10*x*y^4 + 9*y^5 + 170*x^4 + 170*x^3*y\n    + 105*x^2*y^2 + 65*x*y^3 + 35*y^4 + 180*x^3 + 240*x^2*y + 171*x*y^2\n    + 75*y^3 + 120*x^2 + 168*x*y + 84*y^2 + 36*x + 36*y\nok [86.41 s]\n```",
    "created_at": "2016-08-27T20:04:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392618",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:6'></a>Much the same here. With verbose turned on the first `odd` looking test is at `line 495`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392620",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Sure, I meant backends...  (Not sure what's used at all.)",
    "created_at": "2016-08-27T20:34:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392621",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:9'></a>Sure, I meant backends...  (Not sure what's used at all.)
...
```json
{
    "body": "<a id='comment:10'></a>Ah, while there's not a single process actually doing something, I now see frequent calls of `$SAGE_LOCAL/bin/pip list`...  WTF?\n\n(So apparently it is continually looked up whether an optional backend is available / installed.)",
    "created_at": "2016-08-27T21:01:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392622",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:10'></a>Ah, while there's not a single process actually doing something, I now see frequent calls of `$SAGE_LOCAL/bin/pip list`...  WTF?
...
```json
{
    "body": "<a id='comment:11'></a>Steve, do you have the `bliss` useflag on in SoG?",
    "created_at": "2016-08-27T21:04:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392623",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:11'></a>Steve, do you have the `bliss` useflag on in SoG?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392624",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392625",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392628",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Stuff using `is_package_installed` is broken inside vanilla sagemath? Do you know how much it makes me my day :) I don't think I need to plug #20382, most people here are aware of it.",
    "created_at": "2016-08-27T22:19:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392629",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:17'></a>Stuff using `is_package_installed` is broken inside vanilla sagemath? Do you know how much it makes me my day :) I don't think I need to plug #20382, most people here are aware of it.
...
```json
{
    "body": "<a id='comment:21'></a>Please review #21289",
    "created_at": "2016-08-28T06:11:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392633",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:21'></a>Please review #21289
...
```json
{
    "body": "<a id='comment:22'></a>This should be solved by #21289, to be confirmed",
    "created_at": "2016-08-30T13:35:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392634",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:22'></a>This should be solved by #21289, to be confirmed
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392635",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21355#event-56822"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392637",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>so let us close this one",
    "created_at": "2016-08-30T18:10:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392638",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:24'></a>so let us close this one
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392639",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Fixed by #21289.",
    "created_at": "2016-08-30T19:04:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392640",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:25'></a>Fixed by #21289.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21355#event-56823"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392641",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Fr\u00e9d\u00e9ric Chapoton, Steven Trogdon\"",
    "created_at": "2016-08-30T19:10:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21355#issuecomment-392642",
    "user": "https://github.com/nexttime"
}
```

Changing reviewer from "" to "Frédéric Chapoton, Steven Trogdon"
