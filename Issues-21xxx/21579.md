...
<a id='comment:15'></a>Replying to [comment:11 bober]:
> I wonder if the result will be a polynomial which has the correct reduction mod p for lots of p but is wrong somewhere and for which the CRT will miraculously stabilize.
...
```json
{
    "body": "<a id='comment:24'></a>Replying to [comment:23 cpernet]:\n> #24214 should fix it.\n\n\nSure. bober's all tests now pass. So we close this?",
    "created_at": "2018-03-23T07:51:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21579",
    "type": "issue_comment",
...
<a id='comment:24'></a>Replying to [comment:23 cpernet]:
> #24214 should fix it.
