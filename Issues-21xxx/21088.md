# Issue 21088: k-regular sequences: subsequences, forward/backward difference, partial sums
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21088#event-56768"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21088#event-56769"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21088#event-56770"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21088#event-56771"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21088#event-56772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21088",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21088#event-56773"
}
```
