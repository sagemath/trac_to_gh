...
```json
{
    "body": "<a id='comment:2'></a>\nI've added the relevant classes and methods fixed all doctest errors that remained, added missing documentation and tests, and cleaned up the code. I am facing a couple of tiny issues with the minimum subspace polynomial (MSP), multi-point evaluation (MPE) and interpolation methods. I think I should have them ready in a short while. \nPlease let me know what else I can add to this ticket. If there isn't anything, then I'll open the ticket for review once I add MSP, MPE and interpolation.\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|\n|[e189fec](https://git.sagemath.org/sage.git/commit?id=e189fec13d005a7fba39a429876c501fe95c05da)|`removed side.py`|\n|[1f62ef4](https://git.sagemath.org/sage.git/commit?id=1f62ef479a43b2402d4cf824c8b476aea40b9402)|`added a section related to skew polynomils in the index file.`|\n|[abbd05e](https://git.sagemath.org/sage.git/commit?id=abbd05ee2ed097aac032318d79001134f87fa9e7)|`removed double imports and unused classes and methods`|\n|[8b337c5](https://git.sagemath.org/sage.git/commit?id=8b337c5eb2e3f3d88864660487ce93db06fba517)|`improved description of module, definition of skew polynomial, removed unnecessary imports, improved informativeness of docstrings, input sanitization and documentation of a couple of methods.`|\n|[e0f3f42](https://git.sagemath.org/sage.git/commit?id=e0f3f421848b9a594a09e431d4eb0ac58e2b1d46)|`changes to incorporate merging  and  into`|\n|[0c8f6ec](https://git.sagemath.org/sage.git/commit?id=0c8f6ec5fdae4746ce5b2989b426f78733ad3385)|`removed unnecessary imports`|\n|[0641ecf](https://git.sagemath.org/sage.git/commit?id=0641ecf3c9652b5479b967874a600cfd8a81c967)|`improved description of module, definition of skew polynomial ring, removed unnecessary imports, improved informativeness of docstrings, input sanitization and documentation of some methods. cleaned up code.`|\n|[22eab5d](https://git.sagemath.org/sage.git/commit?id=22eab5df8c479f46d780c09625d3c7b790b3c816)|`same as previous commit`|\n|[e46f778](https://git.sagemath.org/sage.git/commit?id=e46f7785524ade7db547b89dc27ab20f6459d368)|`added the finite field files without karatsuba, center, irreducibility and factor stuff. cleaned up code. fixed doctest errors.`|\n|[f4b8413](https://git.sagemath.org/sage.git/commit?id=f4b841336eb6c557013e3684668dbd5db851c343)|`added missing documentation and some tests. added class SkewPolynomialRing_finite_field.`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[d49392e](https://git.sagemath.org/sage.git/commit/?id=d49392ef39ca1d25cf48be649f0c2540b6e6cc48)|`resolved single and double back tick formatting inconsistencies.`|\n|[1a06b09](https://git.sagemath.org/sage.git/commit/?id=1a06b095a569eba51bf2efdc2f86712cfa7b49aa)|`added methods for multi-point evaluation, minimum subspace polynomial and interpolation`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. Last 10 new commits:\n|                                                                                                                                           |                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|\n|[b52fc95](https://git.sagemath.org/sage.git/commit/?id=b52fc9528249625e9498ac43f48376d4235f8b9d)|`using cached versions of 0 and 1 wherever applicable.`|\n|[6fb186a](https://git.sagemath.org/sage.git/commit/?id=6fb186ab4b9eedb41596053854996263e85c5fe7)|`changed Returns to Return and Note to NOTE for consistency. Removed trailing whitespaces. codeformatting for True, False and None objects.`|\n|[1204f2d](https://git.sagemath.org/sage.git/commit/?id=1204f2d240bedaa2c7eef1bcba144b73150d9308)|`the current implementation of the :meth: __call__ was incorrect. added the correct and cythonized version.`|\n|[7e076fa](https://git.sagemath.org/sage.git/commit/?id=7e076fa503d41f940a4a363d92621369c128a0a5)|`moved module level docs to user entry point at the class level so that they are accessible at command line. added a SEEALSO block.`|\n|[69fecc4](https://git.sagemath.org/sage.git/commit/?id=69fecc4c93cfb17f0e348069a95b44e53ac79236)|`converted :meth: into a cpdef method with output type list. removed  and directly use the  attribute.`|\n|[271bfac](https://git.sagemath.org/sage.git/commit/?id=271bface01f93c8dca5a1fb104da139224ae1e66)|`removed some commented code and trailing whitespaces.`|\n|[9a2fad2](https://git.sagemath.org/sage.git/commit/?id=9a2fad2d0183dd5b3f5dae7da2628f9d8b52bf26)|`merged changes from Tickets 13215 and 21088`|\n|[eaca253](https://git.sagemath.org/sage.git/commit/?id=eaca2535762165b7ace9896a3993d8ae7fb03eb8)|`integrated skew polynomial finite field into sage. removed some compile and doctest errors.`|\n|[7664060](https://git.sagemath.org/sage.git/commit/?id=76640607bcbecccf6b969483cc112db06c6dd0d5)|`removed leftpow and rightpow methods from SkewPolynomial_finite_field_dense class because they require the 'bound' method which in turn requires 'center'. this will be added in another separate ticket with the rest of the center stuff.`|\n|[a6e93e1](https://git.sagemath.org/sage.git/commit/?id=a6e93e12c1fefffde3615c8eab75a45b3c277ab2)|`added SEEALSO and TODO blocks and made small polishes to the documentation.`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[130b173](https://git.sagemath.org/sage.git/commit/?id=130b1737fa64fe1613c53257ef0a74d24f8eadad)|`improved documentation for skew_polynomials_finite_field.pyx file`|",
    "created_at": "2016-07-28T21:44:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21088",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[15861b9](https://git.sagemath.org/sage.git/commit/?id=15861b92f34893114ce4f12cf9c83ecda98223ce)|`documentation builds successfully.`|",
    "created_at": "2016-07-28T23:12:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21088",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[c38c99a](https://git.sagemath.org/sage.git/commit/?id=c38c99a707b5f094c11223084af2ca2212e7736d)|`merged previous conflicts`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[b0bc8cf](https://git.sagemath.org/sage.git/commit/?id=b0bc8cfa87b1d99907ded38cb600b7ebc5e6bfcc)|`fixed doctest errors.`|",
    "created_at": "2017-02-07T17:04:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21088",
    "type": "issue_comment",
