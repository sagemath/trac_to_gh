...
<a id='comment:10'></a>Replying to [vdelecroix](#comment%3A7):
...
<a id='comment:13'></a>Replying to [pelegm](#comment%3A11):
> `sample` yields an `OverflowError`:
> 
> 
> ```python
...
<a id='comment:20'></a>Replying to [pelegm](#comment%3A17):
> OK, so this is my plan for the uniform model:
> [SNIP CODE]
