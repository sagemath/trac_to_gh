...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|\n|[c4f4952](https://git.sagemath.org/sage.git/commit/?id=c4f49522e20a4b66d6ce5cd055ed1fdf39b25ac1)|`Merge branch 'develop' into t/21360/numerics_in_nested_symbolic_powers_not_combined`|",
