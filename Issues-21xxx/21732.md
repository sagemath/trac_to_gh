...
```json
{
    "body": "<a id='comment:15'></a>\nHere's my attempt at solving this.  It included a few other changes that I felt were needed (in addition to #22061), but that are not directly relevant either, so might be worth moving to another ticket.\n\nI don't feel strongly about the choice of `sage.misc.docs`, but I am convinced that these files should be somewhere (for now) in the `sage` package.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[9175036](https://git.sagemath.org/sage.git/commit?id=91750364453a3ecf4446a5566029c0eb963aa6cf)|`Don't hard-code (in the form of a symlink) the path to thebe.js.`|\n|[ba840c6](https://git.sagemath.org/sage.git/commit?id=ba840c6934228dc3c35e706f7e79f6ea22ac9f58)|`A couple enhancements to find_extra_files:`|\n|[9e1bdc3](https://git.sagemath.org/sage.git/commit?id=9e1bdc349da2b3cde52be1131638fb74bd7a7e38)|`Adds a sage_build_py command in setup.py`|\n|[334da54](https://git.sagemath.org/sage.git/commit?id=334da540bf3c33a51cd85ef83be9aca37b570ec3)|`Fix some tests that broken in sage_setup`|\n|[2983351](https://git.sagemath.org/sage.git/commit?id=2983351b1116ed29f08d5fc95c6c11dbcddeec64)|`Fully move src/doc/common and src/doc/en/introspect to subpackages of a new sage.misc.docs subpackage.`|\n|[31a3989](https://git.sagemath.org/sage.git/commit?id=31a398946cc2ec9d6407403ccc1a6b3ade131a9f)|`Fix no longer accurate reference to SAGE_DOC_SRC in a docstring`|\n|[6194785](https://git.sagemath.org/sage.git/commit?id=6194785e2d9965614f5698a7538026b1f854e454)|`As mentioned in #21732, 'introspect' is no longer needed in OMIT, as 'introspect' is no longer in the doc source tree.`|",
    "created_at": "2016-12-16T13:48:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21732",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nI Handled the (trivial) merge.\n\nFlorent\n\n---\nNew commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[8c3b6a1](https://git.sagemath.org/sage.git/commit?id=8c3b6a10dc67f33d58a897bc928b9db145e93d9f)|`Merged with 7.6.beta6`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[1e372a8](https://git.sagemath.org/sage.git/commit/?id=1e372a8e0cd5cab6523f6cafba7698bfa0761a07)|`Merge branch 'develop' into t/21732/ticket-21732`|",
