...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21340#event-191210"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21340#event-191211"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21340#event-191212"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>\nReplying to [chapoton](#comment%3A26):\n> It would have been better to put this log2 in some other place.\n\nBut I think that someone, \"Fr\u00e9d\u00e9ric\" if I remember the name correctly, is converting [SageMath](../wikis/SageMath) to Python 3. `:=)` Then we will have `math.log2()`.",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21340#event-191213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21340",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21340#event-191214"
}
```
