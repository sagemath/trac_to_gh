...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299181"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299183"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299184"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311251",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311252",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311253",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311254",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311255",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311256",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311257",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311258",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311259",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311260",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311261",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311262",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311263",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311264",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311265",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299185"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299186"
}
```
...
```json
{
    "body": "<div id=\"comment:13\" align=\"right\">comment:13</div>\n\nPing. Something has changed in the interim, as my example from [comment:4](#comment:4) is no longer applicable:\n\n```\nsage: R.<t> = QQ[]\n....: u = 2*t^3 + t^2; v = t^3 + 2*t + 1\n....: hash(u), hash(v)\n(-7745487741690187698, -7745487741690187694)\n```\nbut there is still an overall issue:\n\n```\nsage: S.<t> = QQ[]\nsage: from itertools import product\nsage: values = [S(t) for t in product((0,1/2,1,2), repeat=5)]\nsage: len(set(map(hash,values)))\n491\nsage: len(values)\n1024\n```",
    "created_at": "2019-12-12T20:59:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311266",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299187"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311268",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311269",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311270",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311271",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311272",
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299189"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299190"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299191"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299192"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299193"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311273",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299195"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299196"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299197"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299198"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299199"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299200"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299201"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21284#event-299202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21284#issuecomment-311274",
