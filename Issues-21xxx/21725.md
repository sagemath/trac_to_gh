...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400925",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400926",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400927",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400928",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57533"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57534"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I mean, how could it ever be possible to convert something to Sage types (I assume you mean with an efficient C interface) without depending on Sage?",
    "created_at": "2016-10-19T06:44:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400929",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I mean, how could it ever be possible to convert something to Sage types (I assume you mean with an efficient C interface) without depending on Sage?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400931",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400933",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400934",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400935",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400936",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400937",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>There is this thing: https://pypi.python.org/pypi/gmpy2 which provides an interface to GMP and MPFR. It implements wrappers around the GMP/MPFR types, so it could probably be used to pass around `mpz_t` pointers.\n\nI don't think it was created with this use case in mind, but I still think that this could be a good starting point. We obviously would need to add a Cython interface.",
    "created_at": "2016-10-19T08:22:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400938",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>There is this thing: https://pypi.python.org/pypi/gmpy2 which provides an interface to GMP and MPFR. It implements wrappers around the GMP/MPFR types, so it could probably be used to pass around `mpz_t` pointers.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400940",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>I am going to add a `gmpy2` optional package to check whether we can do something with it: #21727",
    "created_at": "2016-10-19T08:37:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400941",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>I am going to add a `gmpy2` optional package to check whether we can do something with it: #21727
...
```json
{
    "body": "<a id='comment:19'></a>I have been looking at `gmpy2` for the last hour or so. I think it could work to use the `gmpy2` types as intermediates for the proposed conversions.\n\nThe big issue is that `gmpy2` currently does not expose a C or Cython interface. So either we need to work with upstream to implement that or we need to fork `gmpy2`.",
    "created_at": "2016-10-19T09:55:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400942",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>I have been looking at `gmpy2` for the last hour or so. I think it could work to use the `gmpy2` types as intermediates for the proposed conversions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400944",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400945",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400946",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400949",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400950",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400952",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400953",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400954",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>And actually, 2. is totally trivial to implement in like 10 lines of Cython code (you just need to store a pointer to a conversion function in a global variable). Ideally, this would be added to some existing project because it seems a bit overkill to create a separate Python project for just those 10 lines.",
    "created_at": "2016-10-23T10:08:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400956",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:35'></a>And actually, 2. is totally trivial to implement in like 10 lines of Cython code (you just need to store a pointer to a conversion function in a global variable). Ideally, this would be added to some existing project because it seems a bit overkill to create a separate Python project for just those 10 lines.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400957",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>It's a cleaner design to pass an extra argument around. \n\nIn my experience, global variables never solve a problem but only create new ones.",
    "created_at": "2016-10-27T22:37:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400959",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:39'></a>It's a cleaner design to pass an extra argument around. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400960",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57535"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57536"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>Given the unclear ticket description and the lack of interest, I suggest to close this as invalid.\n\nI am not saying that there is nothing to be done here, just that this ticket is too vague. It seems that everybody has a different idea about what it means.\n\nIf you want some feature in the spirit of this ticket, please open a new ticket, clearly stating what you want.",
    "created_at": "2017-03-01T11:39:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400961",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:44'></a>Given the unclear ticket description and the lack of interest, I suggest to close this as invalid.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400962",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>Uh, we are working on it. Greeting from Sage Days.",
    "created_at": "2017-03-01T11:42:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400963",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:45'></a>Uh, we are working on it. Greeting from Sage Days.
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57537"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400964",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>**ping**",
    "created_at": "2017-03-08T12:43:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400966",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:48'></a>**ping**
...
```json
{
    "body": "<a id='comment:49'></a>These are two weeks Sage days. Why are you so picky about this ticket?",
    "created_at": "2017-03-08T22:40:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400967",
    "user": "https://github.com/videlec"
}
```

<a id='comment:49'></a>These are two weeks Sage days. Why are you so picky about this ticket?
...
```json
{
    "body": "<a id='comment:51'></a>Another case at hand is #23024...",
    "created_at": "2018-02-06T08:05:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400969",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:51'></a>Another case at hand is #23024...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400970",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57539"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57540"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>11 months and still no explanation.",
    "created_at": "2018-02-06T11:33:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400971",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:52'></a>11 months and still no explanation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21725#event-57541"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21725#issuecomment-400972",
    "user": "https://github.com/jdemeyer"
}
```
