...
archive/attachments_021522.json:
```json
{
...
```json
{
    "body": "**Attachment:** [0001-remove-def-integral-from-functional.py.patch](https://github.com/sagemath/sage/files/ticket21667/0001-remove-def-integral-from-functional.py.patch)\n\nRemove redundant definition of integral from functional.py",
    "created_at": "2016-10-08T17:48:22Z",
    "issue": "https://github.com/sagemath/sage/issues/21667",
    "type": "issue_comment",
...
**Attachment:** [0001-remove-def-integral-from-functional.py.patch](https://github.com/sagemath/sage/files/ticket21667/0001-remove-def-integral-from-functional.py.patch)
