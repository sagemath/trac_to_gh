...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21667#issuecomment-320879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mafra"
}
```
...
```json
{
    ...
    "asset_name": "0001-remove-def-integral-from-functional.py.patch",
    "asset_url": "tarball://root/attachments/ticket21667/0001-remove-def-integral-from-functional.py.patch",
    "created_at": "2016-10-08T17:48:22Z",
    "issue": "https://github.com/sagemath/sage/issues/21667",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket21667/0001-remove-def-integral-from-functional.py.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mafra"
}
```
...
```json
{
    "body": "Attachment [0001-remove-def-integral-from-functional.py.patch](https://github.com/sagemath/sage/files/ticket21667/0001-remove-def-integral-from-functional.py.patch) by mafra created at 2016-10-08 17:48:22\n\nRemove redundant definition of integral from functional.py",
    "created_at": "2016-10-08T17:48:22Z",
    "issue": "https://github.com/sagemath/sage/issues/21667",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21667#issuecomment-320880",
    "user": "https://trac.sagemath.org/admin/accounts/users/mafra"
}
```

Attachment [0001-remove-def-integral-from-functional.py.patch](https://github.com/sagemath/sage/files/ticket21667/0001-remove-def-integral-from-functional.py.patch) by mafra created at 2016-10-08 17:48:22
