...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket21667/0001-remove-def-integral-from-functional.py.patch",
...
```json
{
    "body": "Remove redundant definition of integral from functional.py",
    "created_at": "2016-10-08T17:48:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21667",
    "type": "issue_comment",
