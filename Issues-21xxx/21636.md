...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399221",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This is a much more general problem: imports in Sage are a huge can of worms: they have to be done in a very specific order or they break.\n\nWe often try to work around this problem by importing inside methods/functions:\n\n```\ndef foo():\n    import something\n    something()\n```\ninstead of\n\n```\nimport something\n\ndef foo():\n    something()\n```\nor various tricks with lazy/late imports.\n\nAnd Cython makes it even harder than it would otherwise be, since Cython's imports are always done first, before anything else.",
    "created_at": "2016-10-04T09:58:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399222",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>This is a much more general problem: imports in Sage are a huge can of worms: they have to be done in a very specific order or they break.
...
```json
{
    "body": "<a id='comment:3'></a>I kind of figured that was the case--even if I resolved this one I wouldn't be surprised if there were others.  Still, it should be fixed/worked around where found because it otherwise makes Sage unusable as a \"normal\" library.",
    "created_at": "2016-10-04T10:55:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399223",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>I kind of figured that was the case--even if I resolved this one I wouldn't be surprised if there were others.  Still, it should be fixed/worked around where found because it otherwise makes Sage unusable as a "normal" library.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399224",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Yes, but I don't think that's a valid solution.",
    "created_at": "2016-10-04T11:59:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399225",
    "user": "https://github.com/embray"
}
```

<a id='comment:5'></a>Yes, but I don't think that's a valid solution.
...
```json
{
    "body": "<a id='comment:8'></a>I'd still be interested in working on improving the situation here, but it's pretty low priority right now.",
    "created_at": "2017-02-27T11:40:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399227",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>I'd still be interested in working on improving the situation here, but it's pretty low priority right now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399228",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21636#event-57380"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Definitely a lot of work by hand to move things around.  Would you like me to take a stab at it?\n\nOne thing that is ugly, but that you can often get pretty far with, is moving some imports to the bottom of the module.  I'm not sure how that will play with Cython though.",
    "created_at": "2017-04-04T11:32:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399229",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>Definitely a lot of work by hand to move things around.  Would you like me to take a stab at it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399230",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>How exactly do lazy imports work in Sage?  Is there a custom `module` subclass?  I never really looked into it much.",
    "created_at": "2017-04-04T12:40:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399231",
    "user": "https://github.com/embray"
}
```

<a id='comment:12'></a>How exactly do lazy imports work in Sage?  Is there a custom `module` subclass?  I never really looked into it much.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399232",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399233",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Good news for myself: I think I can get #22747 to work without requiring this.",
    "created_at": "2017-04-21T15:27:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21636#issuecomment-399234",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>Good news for myself: I think I can get #22747 to work without requiring this.
