...
```json
{
    "body": "Changing branch from \"\" to \"u/mkoeppe/develop-travis-squashed\"",
    "created_at": "2016-10-25T18:07:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21724#issuecomment-400921",
    "user": "https://github.com/mkoeppe"
}
```

Changing branch from "" to "u/mkoeppe/develop-travis-squashed"
...
```json
{
    "body": "<a id='comment:2'></a>This seems to be combining several things....  Since when are we trying to build Sage on Travis?  \n\n---\nNew commits:",
    "created_at": "2016-11-07T13:12:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21724#issuecomment-400922",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>This seems to be combining several things....  Since when are we trying to build Sage on Travis?  
...
```json
{
    "body": "Changing commit from \"\" to \"c75a24d40dcbfffacd5563e42bc485fc455f4375\"",
    "created_at": "2016-11-07T13:12:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21724#issuecomment-400923",
    "user": "https://github.com/embray"
}
```

Changing commit from "" to "c75a24d40dcbfffacd5563e42bc485fc455f4375"
...
```json
{
    "body": "<a id='comment:3'></a>Yes, it's combining it with some experimental Travis build scripts, because this was my main use case for the progress meter. The ticket is not ready for review.",
    "created_at": "2016-11-10T06:42:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21724#issuecomment-400924",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>Yes, it's combining it with some experimental Travis build scripts, because this was my main use case for the progress meter. The ticket is not ready for review.
