...
```json
{
    "body": "Changing branch from \"\" to \"u/saraedum/conversion_from_a_function_field_to_its_field_of_constants\"",
    "created_at": "2016-11-13T14:55:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404528",
    "user": "https://github.com/saraedum"
}
```

Changing branch from "" to "u/saraedum/conversion_from_a_function_field_to_its_field_of_constants"
...
```json
{
    "body": "Changing commit from \"\" to \"69bcf160a9f7dcbedcb8e621d6c0c427dea7c278\"",
    "created_at": "2016-11-13T14:56:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404529",
    "user": "https://github.com/saraedum"
}
```

Changing commit from "" to "69bcf160a9f7dcbedcb8e621d6c0c427dea7c278"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404530",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404531",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404532",
...
```json
{
    "body": "Changing commit from \"69bcf160a9f7dcbedcb8e621d6c0c427dea7c278\" to \"bb2e08e7ea03c06c03762c0226531d2f7768650f\"",
    "created_at": "2016-11-13T14:58:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404533",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "69bcf160a9f7dcbedcb8e621d6c0c427dea7c278" to "bb2e08e7ea03c06c03762c0226531d2f7768650f"
...
```json
{
    "body": "<a id='comment:4'></a>I ran doctests in `function_fields/`. The documentation builds without errors. Let's see whether the patchbot likes it as well\u2026",
    "created_at": "2016-11-13T15:06:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404534",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:4'></a>I ran doctests in `function_fields/`. The documentation builds without errors. Let's see whether the patchbot likes it as well…
...
```json
{
    "body": "<a id='comment:7'></a>I believe that installing a conversion map down to the constant base field is necessary. For the intermediate fields, one could also change `_element_constructor_` to make sense of function field elements but then the `_to_constant_field` would get quite a bit more complicated.",
    "created_at": "2016-11-13T17:31:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404537",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:7'></a>I believe that installing a conversion map down to the constant base field is necessary. For the intermediate fields, one could also change `_element_constructor_` to make sense of function field elements but then the `_to_constant_field` would get quite a bit more complicated.
...
```json
{
    "body": "<a id='comment:8'></a>I agree with Julian that there's no problem having cycles in the conversion graph, and many rings in Sage with a concept of base ring have a conversion back to it for constants.\n\nJulian, have you looked at how this change impacts object creation time for function fields?  Maybe it would be better to implement this in `_convert_map_from_` rather than calling `register_conversion` in `__init__`.  I think `register_conversion` is available for end users who aren't able to modify `_convert_map_from_`.\n\nOtherwise, I'm happy with this change, and willing to give a positive review once we hear back from the patchbot.",
    "created_at": "2016-11-13T17:34:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404538",
    "user": "https://github.com/roed314"
}
```

<a id='comment:8'></a>I agree with Julian that there's no problem having cycles in the conversion graph, and many rings in Sage with a concept of base ring have a conversion back to it for constants.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404542",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404543",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Note that #14711 has a TODO of adding an option to `register_conversion` to use weak references as well.  I think we need that option here, but that should solve the problem you've pointed out.",
    "created_at": "2016-11-14T00:35:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404544",
    "user": "https://github.com/roed314"
}
```

<a id='comment:14'></a>Note that #14711 has a TODO of adding an option to `register_conversion` to use weak references as well.  I think we need that option here, but that should solve the problem you've pointed out.
...
```json
{
    "body": "<a id='comment:16'></a>Thanks for all the input. I had not thought about leaks here.\nSadly, `_make_weak_references()` does not do the trick.\nThe `register_convert_map` implementation has a line that says `self._convert_from_hash.set(mor.domain(),mor)` which does not seem to use weak references.",
    "created_at": "2016-11-14T19:43:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404546",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:16'></a>Thanks for all the input. I had not thought about leaks here.
Sadly, `_make_weak_references()` does not do the trick.
The `register_convert_map` implementation has a line that says `self._convert_from_hash.set(mor.domain(),mor)` which does not seem to use weak references.
...
```json
{
    "body": "<a id='comment:17'></a>Actually `_convert_from_hash` does use weak references, so it must be leaking somewhere else\u2026",
    "created_at": "2016-11-14T19:59:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404547",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:17'></a>Actually `_convert_from_hash` does use weak references, so it must be leaking somewhere else…
...
```json
{
    "body": "<a id='comment:18'></a>Ok. The problem is the `SetMorphism` that I have been using. The parameter `self._to_constant_base_field` that I pass in holds a reference to the function field. I am going to upload a version that uses a proper `FunctionFieldConversionToConstantBaseField` map. Also, I found a way to implement `_conversion_map_from_` that makes the code not unreadable.",
    "created_at": "2016-11-14T20:24:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404548",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:18'></a>Ok. The problem is the `SetMorphism` that I have been using. The parameter `self._to_constant_base_field` that I pass in holds a reference to the function field. I am going to upload a version that uses a proper `FunctionFieldConversionToConstantBaseField` map. Also, I found a way to implement `_conversion_map_from_` that makes the code not unreadable.
...
```json
{
    "body": "Changing commit from \"bb2e08e7ea03c06c03762c0226531d2f7768650f\" to \"0b87e90806da4aaddec4948c0c531d41762483f7\"",
    "created_at": "2016-11-14T20:34:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404549",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "bb2e08e7ea03c06c03762c0226531d2f7768650f" to "0b87e90806da4aaddec4948c0c531d41762483f7"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404550",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>This needs review again.",
    "created_at": "2016-11-14T20:34:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404551",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:20'></a>This needs review again.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404553",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"0b87e90806da4aaddec4948c0c531d41762483f7\" to \"21a6a105637a9ecafe6b103e8dfae54c59b82653\"",
    "created_at": "2016-11-15T01:45:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404554",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0b87e90806da4aaddec4948c0c531d41762483f7" to "21a6a105637a9ecafe6b103e8dfae54c59b82653"
...
```json
{
    "body": "<a id='comment:23'></a>The patchbot complains about `modsym/space.py`. I checked locally and it works fine. (It would also have been very suprising if this made a difference there.)",
    "created_at": "2016-11-17T23:11:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404555",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:23'></a>The patchbot complains about `modsym/space.py`. I checked locally and it works fine. (It would also have been very suprising if this made a difference there.)
...
```json
{
    "body": "<a id='comment:24'></a>I'm happy with the changes.  Nils, thanks for the suggestions: feel free to add yourself as a reviewer.",
    "created_at": "2016-11-18T03:58:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404556",
    "user": "https://github.com/roed314"
}
```

<a id='comment:24'></a>I'm happy with the changes.  Nils, thanks for the suggestions: feel free to add yourself as a reviewer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404557",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404558",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    "body": "Changing branch from \"u/saraedum/conversion_from_a_function_field_to_its_field_of_constants\" to \"21a6a105637a9ecafe6b103e8dfae54c59b82653\"",
    "created_at": "2016-11-19T22:09:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404559",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/saraedum/conversion_from_a_function_field_to_its_field_of_constants" to "21a6a105637a9ecafe6b103e8dfae54c59b82653"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21872#issuecomment-404560",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21872",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21872#event-57754"
}
```
