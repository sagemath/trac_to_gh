...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[75223db](https://git.sagemath.org/sage.git/commit?id=75223db8497c155a2f44b01d9d79542d26631967)|`Silence some make rules`|\n|[0361466](https://git.sagemath.org/sage.git/commit?id=03614668f49b0be8f1c51d8b6f5300e4e12a6bc0)|`Use /dev/tty for interaction`|\n|[2322391](https://git.sagemath.org/sage.git/commit?id=23223919aee6b54835de648ce65f471a177385c5)|`If V=0, redirect (not tee) to logfile`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[04aa4f7](https://git.sagemath.org/sage.git/commit/?id=04aa4f755a340124c0d9670b7b42a72dfdb90b4c)|`Merge tag '7.4.beta6' into t/21539/make_v_0_should_silence_the_build`|\n|[850eb86](https://git.sagemath.org/sage.git/commit/?id=850eb86a8e4e15d0761e49e2eb660a0020f1c86e)|`Only silence rules when V=0`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nHere's a branch that makes the easy parts of those changes but does not change how the log file is printed.\n\n---\nNew commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[57faa5b](https://git.sagemath.org/sage.git/commit?id=57faa5bbff420bc7f1cfcd89c2afb7d2da4bd533)|`trac 21539: change format of output to screen`|",
    "created_at": "2016-09-28T17:06:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21539",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nReplying to [jhpalmieri](#comment%3A20):\n> I'm also seeing many lines of the form\n> \n> ```\n> cp /Users/jpalmier/Desktop/Sage_stuff/sage_builds/TESTING/sage/src/ext/doctest/invalid/syntax_error.tachyon /Users/jpalmier/Desktop/Sage_stuff/sage_builds/TESTING/sage/local/share/sage/ext/doctest/invalid/syntax_error.tachyon\n> ```\n> I guess they come from the target `$(SAGE_EXTCODE)`. I think that output should be silenced, too, or at least abbreviated (\"[sage-extcode] installing...\").\n\n\nI've added some more `$(AM_V_at)` for that.\n\n---\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[1d033ad](https://git.sagemath.org/sage.git/commit?id=1d033adc4ffe636b6282d95e1ff6414d3520a072)|`If V=0, silence 'cp' for scripts and extcode`|",
    "created_at": "2016-10-03T18:37:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21539",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[119b34e](https://git.sagemath.org/sage.git/commit/?id=119b34e60d042c221da257526d834f9df1846511)|`Merge tag '7.4.rc0' into t/21539/make_v_0_should_silence_the_build`|\n|[740ecfb](https://git.sagemath.org/sage.git/commit/?id=740ecfb6fc6b70834fffad30d0d3d1ee45291042)|`In V=0 mode, append to logfiles`|",
