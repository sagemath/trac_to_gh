...
```json
{
    "body": "<a id='comment:1'></a>It works with digits provided the number is big enough\n\n```\nsage: (1/(1006987929*pi - 3163545880)).n(digits=14)\nTraceback (most recent call last):\n...\nValueError: power::eval(): division by zero\n```\nThe default precision is 2<sup>53</sup> which is roughly 16 digits in base 10.",
    "created_at": "2016-10-31T14:33:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402314",
    "user": "https://github.com/videlec"
}
```

<a id='comment:1'></a>It works with digits provided the number is big enough
...
```json
{
    "body": "<a id='comment:2'></a>You can also see that\n\n```\nsage: 1 / (1006987929*RR.pi() - 3163545880)\n+infinity\n```",
    "created_at": "2016-10-31T14:35:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402315",
    "user": "https://github.com/videlec"
}
```

<a id='comment:2'></a>You can also see that
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402316",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402317",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402318",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402319",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402320",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Maybe I created that ticket too fast: I wrongly thought that inputs given to `numerical_approx` was about the number of digits (or bits) of precision of the output, not of the intermediate computations.\n\nMaybe that ticket could be closed as won't fix. Or maybe this ticket goal could be to improve the documentation of `numerical_approx` to explain the meaning of the inputs, because I believe this is misleading:\n\n```\n   Return a numerical approximation of \"self\" with \"prec\" bits (or\n   decimal \"digits\") of precision.\n```",
    "created_at": "2016-11-02T10:10:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402321",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:9'></a>Maybe I created that ticket too fast: I wrongly thought that inputs given to `numerical_approx` was about the number of digits (or bits) of precision of the output, not of the intermediate computations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402322",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21788#issuecomment-402323",
    "user": "https://github.com/seblabbe"
}
```
