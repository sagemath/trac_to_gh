...
```json
{
    "body": "<a id='comment:28'></a>\nNew commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[7879f08](https://git.sagemath.org/sage.git/commit?id=7879f089f19730a902da28c5a072e31b0d0d2f11)|`Add PARI patch to fix is_universal_constant()`|",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[fb8b1d2](https://git.sagemath.org/sage.git/commit/?id=fb8b1d22fefc72faf5932bab9327df6e4c7c7f61)|`Add PARI patch to fix is_universal_constant()`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                           |                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[0e7d231](https://git.sagemath.org/sage.git/commit/?id=0e7d231ec555f0c320add18d2cbc75b028cfb510)|`Merge tag '7.4.rc0' into t/21637/bug_with_pari_interface_gen_eval_on_cygwin`|",
