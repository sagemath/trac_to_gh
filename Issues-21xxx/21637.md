...
<a id='comment:43'></a>Replying to [charpent](#comment%3A42):
> Replying to [jdemeyer](#comment%3A41):
> > `pari-2.8-2771-gb70b447` is an old version. Please delete that log file such that you are no longer confused by it.
...
<a id='comment:45'></a>Replying to [charpent](#comment%3A42), because my edit didn't went through the mail...
...
<a id='comment:46'></a>Replying to [charpent](#comment%3A44):
> `develop`##20523+#21744
