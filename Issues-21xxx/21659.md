...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21659#event-286119"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21659#event-286120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21659#event-286121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21659#event-286122"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21659#issuecomment-320946",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21659#issuecomment-320947",
    "user": "https://github.com/dkrenn"
}
```
