...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399987",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399988",
...
```json
{
    "body": "<a id='comment:2'></a>The branch is just `sage-7.4.rc0` without any extra commits... was this intentional?\n\nAs explained on the `sage-devel` post, I am curious to see if you can make this work on Python 3.",
    "created_at": "2016-10-11T15:04:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399989",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>The branch is just `sage-7.4.rc0` without any extra commits... was this intentional?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399990",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399991",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399992",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399993",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399994",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>One comment: since this isn't really Sage-specific, could you use a different name instead of `SageMetaclass`, something which does not refer to Sage?",
    "created_at": "2016-10-12T15:02:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399995",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>One comment: since this isn't really Sage-specific, could you use a different name instead of `SageMetaclass`, something which does not refer to Sage?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399997",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399998",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-399999",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Did you already test on Python 3? Because personally, I am still thinking that you are wasting your time to implement something which won't work anyway. But of course, I am gladly proven wrong.",
    "created_at": "2016-10-13T06:25:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400000",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:12'></a>Did you already test on Python 3? Because personally, I am still thinking that you are wasting your time to implement something which won't work anyway. But of course, I am gladly proven wrong.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400001",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Attachment [metatest3.py](tarball://root/attachments/some-uuid/ticket21681/metatest3.py) by @simon-king-jena created at 2016-10-13 11:34:54\n\nThe attachment:metatest3.py is an attempt to port stuff to Python3 --- which sadly fails. In Python3, I get\n\n```\n>>> exec(open(\"/home/king/Sage/work/metaclass/metatest3.py\").read())\n>>> class MyCombinedExample(MyNestedClass, MyUniqueRepresentation):\n...     class SomeClass:\n...         pass\n...     class SomeCachedClass(MyUniqueRepresentation):\n...         def __init__(self, x):\n...             self.x = x\n... \nTraceback (most recent call last):\n  File \"<stdin>\", line 1, in <module>\nTypeError: metaclass conflict: the metaclass of a derived class must be a (non-strict) subclass of the metaclasses of all its bases\n```\nwhereas the analogous example in Sage works.",
    "created_at": "2016-10-13T11:34:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400002",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>Attachment [metatest3.py](tarball://root/attachments/some-uuid/ticket21681/metatest3.py) by @simon-king-jena created at 2016-10-13 11:34:54
...
```json
{
    "body": "<a id='comment:14'></a>I am now trying whether using !ABCMeta (from Python's abc module) can help. It would hopefully fool Python into believing that the different metaclasses are subclasses of each other and thus would make it stop complaining about metaclass conflicts.",
    "created_at": "2016-10-13T12:10:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400003",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:14'></a>I am now trying whether using !ABCMeta (from Python's abc module) can help. It would hopefully fool Python into believing that the different metaclasses are subclasses of each other and thus would make it stop complaining about metaclass conflicts.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400006",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400007",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400008",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Should we close this?",
    "created_at": "2018-09-08T09:29:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400010",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:21'></a>Should we close this?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21681#issuecomment-400011",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21681#event-57431"
}
```
