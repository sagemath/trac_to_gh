...
```json
{
    "body": "<a id='comment:3'></a>\nHere it is.\n\nFeel free to vote for the second commit; the third is less restrictive.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|\n|[0348d59](https://github.com/sagemath/sagetrac-mirror/commit/0348d59c9628e684303b87f4869df2804dbee578)|`NTL: Don't enable NATIVE (also) when Sage's GCC is used (because the assembler *might* not be capable enough).`|\n|[3c9ee18](https://github.com/sagemath/sagetrac-mirror/commit/3c9ee18e891467b473ac90544b59411afb025c12)|`NTL: Bump patchlevel, add some messages and prepare for improvement regarding NATIVE=on/off (in spkg-install).`|\n|[7e1ceb2](https://github.com/sagemath/sagetrac-mirror/commit/7e1ceb270804b7525db553d35be29ccecc03206a)|`NTL: Do not entirely disable NATIVE when Sage's GCC is used, white-list some assemblers instead (including LLVM's).`|",
    "created_at": "2016-07-20T23:55:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21064",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|\n|[3cccfbb](https://github.com/sagemath/sagetrac-mirror/commit/3cccfbbe23776c2fc682a6dce73b1efee23a8339)|`NTL: Don't encourage people to pass '-q' to Apple's old GAS just in NTL's spkg-install.`|",
    "created_at": "2016-07-21T03:32:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21064",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|\n|[41ea5da](https://github.com/sagemath/sagetrac-mirror/commit/41ea5daf35f02a6e53bd62a08a423a472edbb2d4)|`NTL: Do not consider GAS 2.3 as recent, warn if it's still (Apple's) 1.38 in spkg-install`|",
    "created_at": "2016-07-22T09:21:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21064",
    "type": "issue_comment",
