...
<a id='comment:8'></a>Replying to [dunfield](#comment%3A6):
> One very minor quibble with the OS X-specific comment in the spkg-install file:
> 
> 
> ```
...
```json
{
    "body": "<a id='comment:12'></a>Replying to [dunfield](#comment%3A10):\n> Replying to [leif](#comment%3A8):\n> > Better this way?\n\n> \n> Yes, that looks good to me.\n\n\nCommitted.",
...
<a id='comment:12'></a>Replying to [dunfield](#comment%3A10):
> Replying to [leif](#comment%3A8):
> > Better this way?
...
<a id='comment:21'></a>Replying to [leif](#comment%3A5):
> Replying to [fbissey](#comment%3A4):
> > Anyone has contacted Victor to see if he could make a check that would also test the assembler in a new version?
