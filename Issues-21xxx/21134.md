...
```json
{
    "body": "<a id='comment:1'></a>Even after just **downloading** an upstream package tarball (`./sage -i -d <package>`), Sage afterwards says *\"Sage **build**/upgrade complete\"*, which is simply plain wrong and misleading.",
    "created_at": "2016-08-07T12:38:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21134#issuecomment-307492",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Even after just **downloading** an upstream package tarball (`./sage -i -d <package>`), Sage afterwards says *"Sage **build**/upgrade complete"*, which is simply plain wrong and misleading.
