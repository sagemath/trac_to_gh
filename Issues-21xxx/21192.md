...
```json
{
    "body": "Assignee: **@sagetrac-drupel**",
    "created_at": "2016-08-08T14:42:25Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/21192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21192#issuecomment-311643",
    "user": "https://github.com/sagetrac-drupel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21192#issuecomment-311644",
    "user": "https://github.com/sagetrac-drupel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21192#event-280059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21192#event-280060"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21192#event-280061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21192",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21192#event-280062"
}
```
