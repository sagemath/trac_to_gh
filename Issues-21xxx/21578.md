...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|\n|[2b8c52c](https://git.sagemath.org/sage.git/commit/?id=2b8c52c7f4a03011b29a3ba01b49e5cd7c796597)|`Replace my patch with the patch from the upstream fix, which simply renames the offending variable (and its siblings).`|",
