...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket21093/constructor.py.patch",
    "created_at": "2016-07-25T15:57:58Z",
    "issue": "https://github.com/sagemath/sage/issues/21093",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket21093/constructor.py.patch",
...
```json
{
    "body": "Attachment [constructor.py.patch](https://github.com/sagemath/sage/files/ticket21093/constructor.py.patch) by @nexttime created at 2016-07-25 15:57:58\n\nPatch by Robin Houston as posted on sage-devel.",
    "created_at": "2016-07-25T15:57:58Z",
    "issue": "https://github.com/sagemath/sage/issues/21093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21093#issuecomment-309694",
    "user": "https://github.com/nexttime"
}
```

Attachment [constructor.py.patch](https://github.com/sagemath/sage/files/ticket21093/constructor.py.patch) by @nexttime created at 2016-07-25 15:57:58
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21093#issuecomment-309695",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21093#issuecomment-309696",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21093#issuecomment-309697",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21093#issuecomment-309698",
