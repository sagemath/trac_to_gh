...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297914"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297917"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-308999",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309000",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309001",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309002",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309003",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309004",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309005",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309006",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297918"
}
```
...
```json
{
    "body": "<div id=\"comment:8\"></div>\n\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/fb9ddc388107875fbc6ddbc1d68b5ec42518f4c1\"><code>fb9ddc3</code></a></td><td><code>In py_get_parent_char(), return 3 if characteristic is > 2</code></td></tr><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/2c0ea8fc2660bbd0dde7e4f98c800e4b664fbaa0\"><code>2c0ea8f</code></a></td><td><code>This test takes about 30s</code></td></tr></table>\n",
    "created_at": "2016-08-10T10:26:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309007",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309008",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309009",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297919"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21187#issuecomment-309010",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21187",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21187#event-297922"
}
```
