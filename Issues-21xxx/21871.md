...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300178",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300179",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Ready to be reviewed.",
    "created_at": "2016-11-13T12:19:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300180",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:2'></a>Ready to be reviewed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300181",
...
```json
{
    "body": "<a id='comment:5'></a>I think that just `if certificate:` would be good. It is how many certificate-options are currently done, i.e. for example `P.dimension(certificate=[])` works a poset `P`. It is \"pythonic\" way to code.\n\nI am not sure about the design where `certificate` kind of returns list of all possible \"certificates\". I would make two functions, other to be `apex_vertices()` or something like that. But maybe others can comment this too.",
    "created_at": "2016-11-13T14:36:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300182",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:5'></a>I think that just `if certificate:` would be good. It is how many certificate-options are currently done, i.e. for example `P.dimension(certificate=[])` works a poset `P`. It is "pythonic" way to code.
...
```json
{
    "body": "<a id='comment:6'></a>Fails for immutable graphs --> *needs_work*.",
    "created_at": "2016-11-13T14:44:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300183",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:6'></a>Fails for immutable graphs --> *needs_work*.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300184",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300185",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I would prefer adding `apex_vertices()`. (With SEEALSO-crosslinks in docstrings of course. I would also crosslink `is_planar` <-> `is_apex`.)",
    "created_at": "2016-11-13T16:28:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300187",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:9'></a>I would prefer adding `apex_vertices()`. (With SEEALSO-crosslinks in docstrings of course. I would also crosslink `is_planar` <-> `is_apex`.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300188",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300189",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I have added method `apex_vertices` with a parameter to limit the number of returned apex vertices. This is mostly useful for the `is_apex` method which only ask for one apex vertex.\n\nI have also added the see also sections.",
    "created_at": "2016-11-13T18:06:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300190",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:11'></a>I have added method `apex_vertices` with a parameter to limit the number of returned apex vertices. This is mostly useful for the `is_apex` method which only ask for one apex vertex.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300192",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300193",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300194",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300195",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300198",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Thank you for the review.",
    "created_at": "2016-11-14T08:04:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300199",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:17'></a>Thank you for the review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21871#issuecomment-300200",
