...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[f9db843](https://git.sagemath.org/sage.git/commit?id=f9db8433c07ec7c3c352e6660f0f314a0a0d35a5)|`Improve support for comparisons in plain Python modules`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[2585c4f](https://git.sagemath.org/sage.git/commit/?id=2585c4f4b273bc82c0c60683540e42417dd5f56c)|`Make py_rich_to_bool a deprecated alias for rich_to_bool`|",
