...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[db6085b](https://git.sagemath.org/sage.git/commit/?id=db6085b7df8080929629b4c6d1e75696ddc4d00e)|`Add improved process shutdown code for PALPreader._iterate_list`|",
    "created_at": "2016-08-10T14:38:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21206",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nAs suggested I combined the `terminate` context manager and the `ContainChildren` context manager into a single module called `sage.interfaces.process` (to me that still seems like an odd place for it but I don't have a better suggestion).\n\nStill an open question is what to do with `sage.parallel.safefork` and it should be kept for backwards compatibility?\n\n---\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[448a9f8](https://git.sagemath.org/sage.git/commit?id=448a9f87d41a3424f4aaef145233dbe4f3eb4401)|`Add improved process shutdown code for PALPreader._iterate_list`|\n|[cb3d195](https://git.sagemath.org/sage.git/commit?id=cb3d195f1dd24ecf4ef9470f1ce703d10481b70b)|`Move the terminate and ContainChildren context managers into a new sage.interfaces.process module`|\n|[f1ecb0e](https://git.sagemath.org/sage.git/commit?id=f1ecb0ebfb6c20f22df87b6aa4dd392c76435b49)|`Updated terminate() to add a little more customizability in its behavior, with I think reasonable defaults.`|",
    "created_at": "2016-11-29T13:37:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21206",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[b24d072](https://git.sagemath.org/sage.git/commit/?id=b24d072ac08859fe4b2eaa532ddda9589a3c5bcd)|`Add improved process shutdown code for PALPreader._iterate_list`|\n|[03c5e01](https://git.sagemath.org/sage.git/commit/?id=03c5e01841d9669eb70c1b9ff09cc1d3d9748fd4)|`Move the terminate and ContainChildren context managers into a new sage.interfaces.process module`|\n|[973313c](https://git.sagemath.org/sage.git/commit/?id=973313cfe8c24261646d3752f9245c6bcdcdbb6d)|`Updated terminate() to add a little more customizability in its behavior, with I think reasonable defaults.`|\n|[bcbe8e9](https://git.sagemath.org/sage.git/commit/?id=bcbe8e90bd75c89a0a7a0bc6daed9eb8ab395a5b)|`some simplifications: got rid of the unecessary 'retry' option; add delay after closing streams`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nNew commits:\n|                                                                                                                                          |                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------|\n|[c89d7ef](https://git.sagemath.org/sage.git/commit?id=c89d7eff3178b79b8e51e221cea13ea209991422)|`Fix compiler warning`|\n|[87623c2](https://git.sagemath.org/sage.git/commit?id=87623c2f4cfee74c465000ff8df5eaf5e61e0e94)|`Improve shutdown code`|",
    "created_at": "2017-04-13T14:32:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21206",
    "type": "issue_comment",
