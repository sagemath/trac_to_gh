...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391536",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Maybe using `sig_check`, we can fix this?\n\nhttps://github.com/sagemath/cysignals/blob/master/docs/source/index.rst#using-sig_check",
    "created_at": "2016-08-23T09:04:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391537",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:2'></a>Maybe using `sig_check`, we can fix this?
...
```json
{
    "body": "<a id='comment:3'></a>It goes down to `graded_component_iterator` method:\n\n```python\nsage: def f(a):\n....:     sleep(0.05)\n....:     return [a-1,a+1]\nsage: C = RecursivelyEnumeratedSet([0], f, structure='symmetric')\nsage: it = C.graded_component_iterator()\nsage: next(it)\n{0}\nsage: next(it)\n{-1, 1}\nsage: next(it)\n{-2, 2}\nsage: next(it)\n{-3, 3}\nsage: from cysignals.alarm import alarm\nsage: alarm(0.02); next(it)\nTraceback (most recent call last):\n...\nAlarmInterrupt: \nsage: next(it)\nTraceback (most recent call last):\n...\nStopIteration: \n```",
    "created_at": "2016-08-23T09:17:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391538",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:3'></a>It goes down to `graded_component_iterator` method:
...
```json
{
    "body": "<a id='comment:4'></a>In essence this seems to be the same issue I came with in sage-devel: \ngraded_component_iterator constructs an iterator using yield and these do not behave nicely when they get interrupted.",
    "created_at": "2016-08-23T09:34:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391539",
    "user": "https://github.com/etn40ff"
}
```

<a id='comment:4'></a>In essence this seems to be the same issue I came with in sage-devel: 
graded_component_iterator constructs an iterator using yield and these do not behave nicely when they get interrupted.
...
```json
{
    "body": "<a id='comment:5'></a>I think I have an idea. We simply need to get rid of the `graded_component_iterator` in the code of `graded_component`. Then, this will not be the same code for structure graded and structure symmetric. I will try this as soon as I get a compiled sage in a few minutes.",
    "created_at": "2016-08-23T09:41:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391540",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:5'></a>I think I have an idea. We simply need to get rid of the `graded_component_iterator` in the code of `graded_component`. Then, this will not be the same code for structure graded and structure symmetric. I will try this as soon as I get a compiled sage in a few minutes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391541",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391542",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"6634754063f50147ed813b34a4f822f3b616945a\"",
    "created_at": "2016-08-23T11:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391543",
    "user": "https://github.com/seblabbe"
}
```

Changing commit from "" to "6634754063f50147ed813b34a4f822f3b616945a"
...
```json
{
    "body": "Changing branch from \"\" to \"u/slabbe/21312\"",
    "created_at": "2016-08-23T11:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391544",
    "user": "https://github.com/seblabbe"
}
```

Changing branch from "" to "u/slabbe/21312"
...
```json
{
    "body": "<a id='comment:12'></a>Can you try with my code but with line 1961 commented out and j!= i instead of j>i in line 1968?\nI think I ran this once for E8 and runtime almost doubled.",
    "created_at": "2016-08-23T22:49:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391550",
    "user": "https://github.com/etn40ff"
}
```

<a id='comment:12'></a>Can you try with my code but with line 1961 commented out and j!= i instead of j>i in line 1968?
I think I ran this once for E8 and runtime almost doubled.
...
```json
{
    "body": "<a id='comment:15'></a>Ah! I am not sure how `RecursivelyEnumeratedSet` does things but there is one\nlast assumption I am using:\nI know which is the last direction I walked to get to any vertex so at the next pass I am not travelling in that direction.",
    "created_at": "2016-08-24T07:56:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391553",
    "user": "https://github.com/etn40ff"
}
```

<a id='comment:15'></a>Ah! I am not sure how `RecursivelyEnumeratedSet` does things but there is one
last assumption I am using:
I know which is the last direction I walked to get to any vertex so at the next pass I am not travelling in that direction.
...
```json
{
    "body": "<a id='comment:17'></a>ok 5% may depend on your code being more general or storing more info. I'd be happy to live with it. Now the problem is: how do I enforce the other two assumptions?\n\nPS: This ticket was meant to solve an issue and we are discussing something else. I guess we better leave this open till we are done.",
    "created_at": "2016-08-24T19:51:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391555",
    "user": "https://github.com/etn40ff"
}
```

<a id='comment:17'></a>ok 5% may depend on your code being more general or storing more info. I'd be happy to live with it. Now the problem is: how do I enforce the other two assumptions?
...
```json
{
    "body": "<a id='comment:20'></a>I had a look at the code and it seems good to me. I am waiting for sage to finish building before running `sage -t --long` to give a positive review.\n\nOn the other topic discussed in the comments of this ticket: I ended up keeping the implementation I had in #21254 with a `try` statement to catch `KeyboardIntterrupt`. At the moment it is faster and I do not have much time to refactor the code to use `RecursivelyEnumeratedSet`. I will probably leave this as a task for a future ticket.",
    "created_at": "2016-08-26T08:49:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391558",
    "user": "https://github.com/etn40ff"
}
```

<a id='comment:20'></a>I had a look at the code and it seems good to me. I am waiting for sage to finish building before running `sage -t --long` to give a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391559",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>No problem. `RecursivelyEnumeratedSet` should be fast so that people really want to use it. So your example raises good questions.",
    "created_at": "2016-08-26T09:19:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391560",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:21'></a>No problem. `RecursivelyEnumeratedSet` should be fast so that people really want to use it. So your example raises good questions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391561",
    "user": "https://github.com/etn40ff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391562",
    "user": "https://github.com/etn40ff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391563",
    "user": "https://github.com/etn40ff"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>> Well you can set structure='forest' and see what happens.\n\n\nNothing good: say your function is symmetric then it will continuously bounce in between two elements. If I am not mistaken `'forest'` does not check for already produced elements.",
    "created_at": "2016-08-26T15:36:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391565",
    "user": "https://github.com/etn40ff"
}
```

<a id='comment:24'></a>> Well you can set structure='forest' and see what happens.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391567",
...
```json
{
    "body": "Changing branch from \"u/slabbe/21312\" to \"6634754063f50147ed813b34a4f822f3b616945a\"",
    "created_at": "2016-08-27T08:36:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391568",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/slabbe/21312" to "6634754063f50147ed813b34a4f822f3b616945a"
...
```json
{
    "body": "Changing commit from \"6634754063f50147ed813b34a4f822f3b616945a\" to \"\"",
    "created_at": "2016-08-27T16:59:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21312#issuecomment-391569",
    "user": "https://github.com/etn40ff"
}
```

Changing commit from "6634754063f50147ed813b34a4f822f3b616945a" to ""
