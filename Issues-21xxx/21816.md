...
```json
{
    "body": "<a id='comment:1'></a>Likely outdated, and #30306 tracks the tasks of making Sage speak to system Jupyter",
    "created_at": "2020-08-17T03:24:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21816#issuecomment-318841",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>Likely outdated, and #30306 tracks the tasks of making Sage speak to system Jupyter
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21816#issuecomment-318842",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21816#event-57668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21816",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21816#event-57669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21816#issuecomment-318843",
