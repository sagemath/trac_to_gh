...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21617#event-303588"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21617#event-303589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21617#event-303590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21617#event-303591"
}
```
...
```json
{
    "body": "Changed keywords from **p-adics, padic, p-adic** to **p-adics, p-adic, padic, padics**",
    "created_at": "2016-09-30T23:20:59Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/21617",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21617#issuecomment-317747",
    "user": "https://github.com/sagetrac-jferrara"
}
```

Changed keywords from **p-adics, padic, p-adic** to **p-adics, p-adic, padic, padics**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21617",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21617#issuecomment-317748",
...
```json
{
    "body": "Changed keywords from **p-adics, p-adic, padic, padics** to **padics, padicIMA**",
    "created_at": "2018-07-26T01:02:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/21617",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21617#issuecomment-317749",
    "user": "https://github.com/xcaruso"
}
```

Changed keywords from **p-adics, p-adic, padic, padics** to **padics, padicIMA**
...
```json
{
    ...
    "milestone_title": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21617#event-303592"
}
```
