...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21762#issuecomment-401616",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [ncurses-5.9.20131221.log](tarball://root/attachments/some-uuid/ticket21762/ncurses-5.9.20131221.log) by @orlitzky created at 2019-08-06 18:40:36\n\nThis probably got fixed upstream. I still use dash as my /bin/sh, so I'll come find this later and reopen it if I'm wrong.",
    "created_at": "2019-08-06T18:40:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21762#issuecomment-401617",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:1'></a>Attachment [ncurses-5.9.20131221.log](tarball://root/attachments/some-uuid/ticket21762/ncurses-5.9.20131221.log) by @orlitzky created at 2019-08-06 18:40:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21762#issuecomment-401618",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21762#event-57577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21762#issuecomment-401619",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21762",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/21762#event-57578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21762#issuecomment-401620",
