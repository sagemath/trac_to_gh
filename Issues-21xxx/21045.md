...
```json
{
    "body": "<a id='comment:1'></a>Add link to Sirocco library in ticket description.",
    "created_at": "2016-07-18T09:07:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21045",
    "type": "issue_comment",
...
<a id='comment:1'></a>Add link to Sirocco library in ticket description.
...
```json
{
    "body": "<a id='comment:4'></a>This does no longer merge with current sage releases.",
    "created_at": "2017-01-12T06:48:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21045",
    "type": "issue_comment",
...
<a id='comment:4'></a>This does no longer merge with current sage releases.
...
<a id='comment:7'></a>I think it is ready for review.
...
<a id='comment:8'></a>The quick comments:
...
```json
{
    "body": "<a id='comment:11'></a>I can do a first attempt at cythonizing. Do you have a good test case that is not too slow nor too fast to do profiling on to see where the current bottlenecks are?\n\nThe reason I bring up the list comprehension is Cython cannot handle them in c(p)def (maybe just cpdef) functions.",
...
<a id='comment:11'></a>I can do a first attempt at cythonizing. Do you have a good test case that is not too slow nor too fast to do profiling on to see where the current bottlenecks are?
...
<a id='comment:13'></a>I fixed some doctest and a bug that prevented it to work when the variables where not x and y.
...
<a id='comment:14'></a>I've hit that list comprehension problem before. *shrugs*
...
```json
{
    "body": "<a id='comment:18'></a>I guess that is a discrpancy on the rounding unit. Added some tolerance to the doctest.",
...
<a id='comment:18'></a>I guess that is a discrpancy on the rounding unit. Added some tolerance to the doctest.
