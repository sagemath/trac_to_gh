...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|\n|[c80277a](https://git.sagemath.org/sage.git/commit?id=c80277a2ea1663d4803e4974985f829d27d5259c)|`Make sure the WINDOWS64_ABI flag is set on Cygwin as well, otherwise the assembly routines use the wrong calling convention.`|",
    "created_at": "2016-08-11T12:21:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21223",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[6361e6c](https://git.sagemath.org/sage.git/commit/?id=6361e6cdac8484964b9e952f5b482b986113aaee)|`Bump patch level`|",
    "created_at": "2016-08-11T13:21:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21223",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[a4adca5](https://git.sagemath.org/sage.git/commit/?id=a4adca5f24de505dfe56316ddc9bd47954746415)|`Change the patch order so that configure gets touched after configure.in`|",
    "created_at": "2016-08-16T09:08:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21223",
    "type": "issue_comment",
