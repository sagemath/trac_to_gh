...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[21d4004](https://git.sagemath.org/sage.git/commit/?id=21d4004b7927bfc498273e9d3738b7e02784a311)|`src/sage/features/imagemagick.py: Remove an is_functional doctest`|\n|[f9232e8](https://git.sagemath.org/sage.git/commit/?id=f9232e8c15911f4a1434359d551372024db83f59)|`src/sage/features/join_feature.py: Update doctest output with deprecation warning`|",
