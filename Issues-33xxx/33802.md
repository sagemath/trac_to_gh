...
archive/issue_comments_674090.json:
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33802#issuecomment-674090",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_674091.json:
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,3 +4,6 @@\n \n It is also used by `sage_input` to verify inputs. We run the verification with a smaller module first before falling back to `sage.all`\n \n+See also:\n+- #30977, #32129, #26155 - issues with `sage_eval`, `sage_input`\n+- #18083 Stop using `old_style_globals`\n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33802",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33802#issuecomment-674091",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_674092.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33802",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33802#issuecomment-674092",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_674094.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33802",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33802#issuecomment-674094",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33802#event-88781"
}
```
