...
archive/issue_events_467540.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33951#event-467540"
}
```
...
archive/issue_events_467541.json:
```json
{
    "actor": "https://github.com/saraedum",
    "created_at": "2022-06-04T16:06:11Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33951#event-467541"
}
```
...
archive/issue_events_467542.json:
```json
{
    "actor": "https://github.com/saraedum",
    "created_at": "2022-06-04T16:06:11Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33951#event-467542"
}
```
...
archive/issue_events_467543.json:
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33951#event-467543"
}
```
...
archive/issue_events_467544.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-09-19T18:58:47Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33951#event-467544"
}
```
