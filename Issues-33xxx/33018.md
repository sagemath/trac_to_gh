...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33018#issuecomment-658361",
    "user": "https://github.com/tobihan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33018#issuecomment-658362",
    "user": "https://github.com/tobihan"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This is the issue in nbconvert:\n\nhttps://github.com/jupyter/nbconvert/issues/1685",
    "created_at": "2021-12-13T11:28:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33018#issuecomment-658363",
    "user": "https://github.com/tobihan"
}
```

<a id='comment:2'></a>This is the issue in nbconvert:
...
```json
{
    "body": "<a id='comment:3'></a>Nothing we can do here until `nbconvert` supports that version of `mistune`.",
    "created_at": "2021-12-14T03:02:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33018",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33018#issuecomment-658364",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>Nothing we can do here until `nbconvert` supports that version of `mistune`.
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33018#event-87251"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33018#event-87252"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33018#event-87253"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33018#event-87254"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33018#event-87255"
}
```
