...
archive/issue_events_406201.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406201"
}
```
...
archive/issue_events_406202.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2022-03-26T15:23:27Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33569",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33569#event-406208"
}
```
