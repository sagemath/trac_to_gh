...
```json
{
    "body": "<a id='comment:1'></a>\nIt can certainly be even faster if done in the backends, but it's already an improvement.\n\n---\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[02cfa0c](https://git.sagemath.org/sage.git/commit?id=02cfa0cb2b5d40922858f3a2eccdd4772e51b301)|`trac #33569: speed up allow_multiple_edges and multiple_edges`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[f3fd774](https://git.sagemath.org/sage.git/commit/?id=f3fd774ab61b02d5043795cbd95f7112c3eb2b34)|`trac #33569: alternative implementation of multiple_edges`|",
