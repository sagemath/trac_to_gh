...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432884"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432885"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432886"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432887"
}
```
...
```json
{
    ...
    "title_was": "Y",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432888"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33998#issuecomment-552539",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33998#issuecomment-552540",
    "user": "https://github.com/thecaligarmo"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432890"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33998#event-432891"
}
```
