...
<a id='comment:26'></a>Replying to [comment:24 Matthias Köppe]:
> You may want to try this with a better IP solver - see #31329 for SCIP
...
<a id='comment:29'></a>With the simple fix from #31329, comment:45:ticket:31329, this now also seems to work with SCIP.  However, SCIP seems to be much slower, by far.  In particular, GLPK finishes the doctest in line 3157-3171
