...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[f67476f](https://git.sagemath.org/sage.git/commit/?id=f67476f065a2ef7c4b03fcad486ace6e08d9230c)|`Add some test and prelimary code`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[9385501](https://git.sagemath.org/sage.git/commit/?id=93855017ba6d46a7e83c289b29defc9e82a24d55)|`src/bin/sage: Implement 'sage --pytest'`|\n|[abbb61f](https://git.sagemath.org/sage.git/commit/?id=abbb61fd2cb99836ab37448326dab7e7e7f37fd7)|`src/conftest.py: import sage.all to avoid cyclic import errors`|\n|[9bb72ea](https://git.sagemath.org/sage.git/commit/?id=9bb72ea9ec314940f3c874d492de241fdec96548)|`src/conftest.py: Add # type: ignore, add reference to trac ticket`|\n|[2c16704](https://git.sagemath.org/sage.git/commit/?id=2c167045d66e049751876ddc755304940265c32a)|`src/conftest.py: Remove outdated text`|\n|[30642ba](https://git.sagemath.org/sage.git/commit/?id=30642ba190ae9a6a6090b11e51a317a2534028db)|`src/bin/sage: Handle 'sage -pytest' without file args`|\n|[f805567](https://git.sagemath.org/sage.git/commit/?id=f80556745230bb13562c7501f5c736a35ba48b44)|`Merge remote-tracking branch 'origin/u/mkoeppe/sage__pytest' into public/tests/pytest_doctests`|\n|[538ead3](https://git.sagemath.org/sage.git/commit/?id=538ead395132b0fde5b9e4ee0738c1883610e82f)|`First working prototype`|",
    "created_at": "2022-03-29T16:28:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33546",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. Last 10 new commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[d881a5a](https://git.sagemath.org/sage.git/commit/?id=d881a5a154c751e79cfb68ecaf60653d8e6bdc65)|`src/conftest.py: Add # type: ignore, add reference to trac ticket`|\n|[1242e1f](https://git.sagemath.org/sage.git/commit/?id=1242e1f5daedfac348824f47b988f55ad653b107)|`src/conftest.py: Remove outdated text`|\n|[0d9225d](https://git.sagemath.org/sage.git/commit/?id=0d9225d87c57f7bda7247836194ec962de476e7b)|`src/bin/sage: Handle 'sage -pytest' without file args`|\n|[05bc58f](https://git.sagemath.org/sage.git/commit/?id=05bc58f97cb8b3a8712f7fb129b40d0446bc35de)|`src/tox.ini (pytest): Set --import-mode importlib here, not in src/bin/sage, src/bin/sage-runtests`|\n|[8825079](https://git.sagemath.org/sage.git/commit/?id=8825079d65f07e9cf13bb3e65197d276a43b9591)|`src/doc/en/developer/tools.rst: Update section on pytest`|\n|[5e6bc87](https://git.sagemath.org/sage.git/commit/?id=5e6bc871ab72e1f1fd11caf14baeeea9466feaa1)|`Merge remote-tracking branch 'origin/u/mkoeppe/sage__pytest' into public/tests/pytest_doctests`|\n|[d36adf4](https://git.sagemath.org/sage.git/commit/?id=d36adf4084c117fbb3da87232c74ba6b155d0307)|`Fix import of sage.all in tests`|\n|[813a541](https://git.sagemath.org/sage.git/commit/?id=813a5416f05702eecfe5fd1b54f3ae379ca1981a)|`Add vs code config to debug pytest`|\n|[d3fdd95](https://git.sagemath.org/sage.git/commit/?id=d3fdd951e5c37ebdac17f8d1fbc86ed8f36dff7e)|`Cleanup vscode config`|\n|[58e11d7](https://git.sagemath.org/sage.git/commit/?id=58e11d707764c4e7c85bf1c5beb8bf257c0318d8)|`Fix checker and namespace injection`|",
    "created_at": "2022-04-05T19:44:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33546",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[ff4056b](https://git.sagemath.org/sage.git/commit/?id=ff4056befc38459ff992a7ecb4a4de0fd5f26686)|`Merge branch 'develop' into public/tests/pytest_doctests`|\n|[e62c29b](https://git.sagemath.org/sage.git/commit/?id=e62c29b48b8fb6e23a597cc12584fe1a209092d3)|`Cleanup imports`|\n|[3ee9815](https://git.sagemath.org/sage.git/commit/?id=3ee9815f55793429d2ea444a5b823ed18b006d6a)|`Add test that pytest correctly fails on example`|\n|[f863428](https://git.sagemath.org/sage.git/commit/?id=f863428150c03430bbc072d7386f3c8dd9a64221)|`Only run doctests in pytest when doctest-modules is specified`|",
    "created_at": "2022-05-06T22:33:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33546",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[428a18c](https://git.sagemath.org/sage.git/commit/?id=428a18ca7d8cd9d2423aa2f66dbd069a906ac144)|`Remove nonexisting paths from config`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[cc19e92](https://git.sagemath.org/sage.git/commit/?id=cc19e927a49efbd31d693b2f70bad48203ea8a25)|`Specify importlib as import mode to be consistent`|",
