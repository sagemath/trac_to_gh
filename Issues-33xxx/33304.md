...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33304#issuecomment-503379",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I don't know if it is related, but the `KeyError` part reminds me of a failure reported by Justin on 9.5.rc4, see #33231.",
    "created_at": "2022-02-07T12:48:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33304#issuecomment-503380",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:2'></a>I don't know if it is related, but the `KeyError` part reminds me of a failure reported by Justin on 9.5.rc4, see #33231.
...
```json
{
    "body": "<a id='comment:3'></a>The KeyError is just because the value isn't cached, in response to it we try to compute the value and thats where things go wrong. So I don't think it has anything to do with the KeyError.\n\nThe inner traceback was truncated, is now complete.",
    "created_at": "2022-02-07T23:48:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33304#issuecomment-503381",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>The KeyError is just because the value isn't cached, in response to it we try to compute the value and thats where things go wrong. So I don't think it has anything to do with the KeyError.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33304#issuecomment-503382",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33304#event-87904"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33304#event-87905"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33304#event-87906"
}
```
