...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------|\n|[9361a33](https://git.sagemath.org/sage.git/commit/?id=9361a337924203c14a4fdffc1194d50f12e2c15f)|`Cleanup`|",
    "created_at": "2022-04-21T11:26:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33739",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[bd2f3d3](https://git.sagemath.org/sage.git/commit/?id=bd2f3d3bc7829f1ccc30f1aa274259d8ab138603)|`Remove gitpod docker image build`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[f56a535](https://git.sagemath.org/sage.git/commit/?id=f56a535d712eb598b207c5d88d3c2f32fbbcafaa)|`Install esbonio using conda`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[5748c21](https://git.sagemath.org/sage.git/commit/?id=5748c2157b28ef12311062743d2e830ec7f79a85)|`Merge tag '9.7.beta1' into t/33739/public/build/conda_gitpod`|",
