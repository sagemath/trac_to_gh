...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676628",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676629",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676630",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676631",
...
```json
{
    "body": "<a id='comment:3'></a>The problem was due to a change in one of the libraries that I was using and was easy to fix.\nThe test in the description of the ticket passed successfully on my computer with the new version of phitigra (0.2.6) that I just uploaded on pypi.",
    "created_at": "2022-06-21T11:37:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676632",
    "user": "https://github.com/jfraymond"
}
```

<a id='comment:3'></a>The problem was due to a change in one of the libraries that I was using and was easy to fix.
The test in the description of the ticket passed successfully on my computer with the new version of phitigra (0.2.6) that I just uploaded on pypi.
...
```json
{
    "body": "<a id='comment:4'></a>We will also need a branch that tells Sage to use the newer version IIRC.",
    "created_at": "2022-06-22T01:53:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676633",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>We will also need a branch that tells Sage to use the newer version IIRC.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676634",
    "user": "https://github.com/jfraymond"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676635",
    "user": "https://github.com/jfraymond"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676636",
    "user": "https://github.com/jfraymond"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I added a version requirement in\n`build/pkgs/phitigra/requirements.txt`.\n\n---\nNew commits:",
    "created_at": "2022-06-22T07:57:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676637",
    "user": "https://github.com/jfraymond"
}
```

<a id='comment:5'></a>I added a version requirement in
`build/pkgs/phitigra/requirements.txt`.
...
```json
{
    "body": "<a id='comment:6'></a>Is the component really padics!?",
    "created_at": "2022-06-25T10:15:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676638",
    "user": "https://github.com/videlec"
}
```

<a id='comment:6'></a>Is the component really padics!?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676639",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676640",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676641",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676642",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676643",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676644",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33928#issuecomment-676645",
    "user": "https://github.com/vbraun"
}
```
