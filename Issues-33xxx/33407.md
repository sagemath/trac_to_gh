...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[de649be](https://git.sagemath.org/sage.git/commit?id=de649beca7dee12c51d3d8838e9c406d763859e3)|`src/sage/doctest/control.py, src/bin/sage-runtests: Implement sage -t --installed`|",
    "created_at": "2022-02-24T22:40:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33407",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|\n|[5dd2dd2](https://git.sagemath.org/sage.git/commit/?id=5dd2dd24db56ed7e05e0be39e4a1fdde8ad7a269)|`src/sage/doctest/control.py: In sage -t --installed, also handle sage_setup, sage_docbuild`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[07f37d0](https://git.sagemath.org/sage.git/commit/?id=07f37d099a77db4f99b5d723ec487248eda5ffdf)|`src/sage/doctest/{control,sources}.py: Handle .rst.txt files like .rst files`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[e837614](https://git.sagemath.org/sage.git/commit/?id=e8376142493b17eccb95a8e850e26a6320e7fdff)|`src/sage/doctest/control.py: In sage -t --installed, also test SAGE_DOC`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[f1c4ee7](https://git.sagemath.org/sage.git/commit/?id=f1c4ee73ddd1d555b98bf640b0866fa4cfd3e3f4)|`src/sage/doctest/sources.py: Update doctest output`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[1627cc9](https://git.sagemath.org/sage.git/commit/?id=1627cc98a1dcb42ca2416b2b958198fabb70f710)|`src/sage/doctest/control.py: Fall back from --all to --installed explicitly`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[e80c135](https://git.sagemath.org/sage.git/commit/?id=e80c13562299dd2eea02d679f9a4e9ea19e028c2)|`src/sage/doctest/control.py: Use elif because options are exclusive`|",
...
```json
{
    "body": "<a id='comment:38'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[b4d2b8e](https://git.sagemath.org/sage.git/commit/?id=b4d2b8ebb98eff0e5931ffc19fa15a5adb463158)|`src/sage/doctest/control.py: Update doctest output`|",
