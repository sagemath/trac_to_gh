...
```json
{
    "body": "<a id='comment:2'></a>These are pretty faily on Gentoo, too, where the system ffmpeg is often built without support for (say) ogg files. I think the `spkg-configure.m4` for ffmpeg should check for any features needed by an `#optional - ffmpeg` test.",
    "created_at": "2021-12-27T12:41:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658817",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:2'></a>These are pretty faily on Gentoo, too, where the system ffmpeg is often built without support for (say) ogg files. I think the `spkg-configure.m4` for ffmpeg should check for any features needed by an `#optional - ffmpeg` test.
...
```json
{
    "body": "<a id='comment:3'></a>I've opened #33092 for the missing spkg-configure feature checks, since that's a different issue and affects imagemagick too.",
    "created_at": "2021-12-29T00:36:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658818",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:3'></a>I've opened #33092 for the missing spkg-configure feature checks, since that's a different issue and affects imagemagick too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658820",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658821",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>These tests were originally included 11 years ago in #11170. A follow-up ticket #11650 changed the default back to `convert` because the gif generated by ffmpeg were very large.",
    "created_at": "2022-01-06T11:52:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658822",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:6'></a>These tests were originally included 11 years ago in #11170. A follow-up ticket #11650 changed the default back to `convert` because the gif generated by ffmpeg were very large.
...
```json
{
    "body": "<a id='comment:7'></a>I am adding #33092 here as a dependency, because after #33092 (which I hope will make it to 9.5?) the feature ffmpeg is now doctested only if it is functional, which may have an impact on the issue reported here.",
    "created_at": "2022-01-14T08:01:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658823",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:7'></a>I am adding #33092 here as a dependency, because after #33092 (which I hope will make it to 9.5?) the feature ffmpeg is now doctested only if it is functional, which may have an impact on the issue reported here.
...
```json
{
    "body": "Changing dependencies from \"\" to \"#33092\"",
    "created_at": "2022-01-14T08:01:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658824",
    "user": "https://github.com/seblabbe"
}
```

Changing dependencies from "" to "#33092"
...
```json
{
    "body": "<a id='comment:8'></a>`@`mjo: you said you were able to reproduce the time out for this file after the application of #33092 ? If yes, could you post here the output of\n\n```\nsage -t --warn-long --long src/sage/plot/animate.py \n```\njust so that we have a clearer idea of which tests are long. In my case, almost none of the ffmpeg tests are warned to be long (see #33045#comment:4).",
    "created_at": "2022-01-14T08:07:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658825",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:8'></a>`@`mjo: you said you were able to reproduce the time out for this file after the application of #33092 ? If yes, could you post here the output of
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658826",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658827",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Ok, here a branch doing that. Maybe that fixes the issue for the machine having the problem. `@`Volker?\n\n---\nNew commits:",
    "created_at": "2022-01-14T14:48:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658828",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:10'></a>Ok, here a branch doing that. Maybe that fixes the issue for the machine having the problem. `@`Volker?
...
```json
{
    "body": "Changing branch from \"\" to \"public/33045\"",
    "created_at": "2022-01-14T14:48:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658829",
    "user": "https://github.com/seblabbe"
}
```

Changing branch from "" to "public/33045"
...
```json
{
    "body": "Changing commit from \"\" to \"8bb3a23c3edf9211b558f0d4d923273d5f2c5ac0\"",
    "created_at": "2022-01-14T14:48:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658830",
    "user": "https://github.com/seblabbe"
}
```

Changing commit from "" to "8bb3a23c3edf9211b558f0d4d923273d5f2c5ac0"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658831",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Set milestone to sage-9.6 after Sage 9.5 release.",
    "created_at": "2022-01-30T15:44:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658833",
    "user": "https://github.com/slel"
}
```

<a id='comment:12'></a>Set milestone to sage-9.6 after Sage 9.5 release.
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33045#event-87311"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>I have not seen the reported failures in environments provisioned using `tox`, as for example the automatic runs on GH Actions... because `ffmpeg` is not installed by either the `-minimal` and `-standard` configurations.\n\nWe can't guess what packages may be installed on the machine where the reported failures occurred. \n\nIn any case the fix looks reasonable to me and here on macOS with homebrew, `./sage -t --optional=sage,optional,external src/sage/plot/animate.py` gives \n\n```\nsage -t --random-seed=278059732320647035924475847071326670064 src/sage/plot/animate.py\n    [231 tests, 126.60 s]\n----------------------------------------------------------------------\nAll tests passed!\n----------------------------------------------------------------------\nTotal time for all tests: 131.5 seconds\n    cpu time: 67.1 seconds\n    cumulative wall time: 126.6 seconds\nFeatures detected for doctesting: ffmpeg,imagemagick\n```",
    "created_at": "2022-02-02T22:54:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658834",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:13'></a>I have not seen the reported failures in environments provisioned using `tox`, as for example the automatic runs on GH Actions... because `ffmpeg` is not installed by either the `-minimal` and `-standard` configurations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658835",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658836",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing branch from \"public/33045\" to \"8bb3a23c3edf9211b558f0d4d923273d5f2c5ac0\"",
    "created_at": "2022-02-12T22:05:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658837",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/33045" to "8bb3a23c3edf9211b558f0d4d923273d5f2c5ac0"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33045#event-87312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33045#issuecomment-658838",
    "user": "https://github.com/vbraun"
}
```
