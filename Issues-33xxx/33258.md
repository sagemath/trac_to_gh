...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403107"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403108"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403109"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403110"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33258",
    "rename": {
        "from": "tiny tiny difference, Colors example and output",
        "to": "Clarify how actual output can vary from documented output"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33258#issuecomment-540194",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33258#issuecomment-540195",
    "user": "https://github.com/umedoblock"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33258#issuecomment-540196",
    "user": "https://github.com/umedoblock"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33258#issuecomment-540197",
    "user": "https://github.com/umedoblock"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33258#issuecomment-540198",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33258#issuecomment-540199",
    "user": "https://github.com/umedoblock"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403112"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403113"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403114"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33258#event-403115"
}
```
