...
```json
{
    "body": "<a id='comment:27'></a>The issue is that the dictionary `pip_installed_packages()` now has a key `\"SciPy\"` rather than `\"scipy\"`. I suggested several possible fixes atticket: ticket:33530#comment:68#comment:33530 andticket: ticket:33530#comment:69#comment:33530.",
...
<a id='comment:27'></a>The issue is that the dictionary `pip_installed_packages()` now has a key `"SciPy"` rather than `"scipy"`. I suggested several possible fixes atticket: ticket:33530#comment:68#comment:33530 andticket: ticket:33530#comment:69#comment:33530.
