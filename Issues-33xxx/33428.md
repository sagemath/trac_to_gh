...
```json
{
    "body": "Let's put in an upper version bound in `build/pkgs/prompt_toolkit/install-requires.txt` to document this",
...
```json
{
    "body": "Upstream has merged https://github.com/prompt-toolkit/python-prompt-toolkit/pull/1582 - do we know if it fixes the issue?",
...
```json
{
    "body": "Confirmed: I just downloaded and installed 3.0.30 (OS X) and it does not seem to have fixed the interrupt problems.",
    "created_at": "2022-07-16T20:30:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33428",
    "type": "issue_comment",
...
```json
{
    "body": "Is this going to cause problems with the IPython upgrade (#33530)? That branch uses version 3.0.29.",
