...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663434",
    "user": "https://github.com/maxale"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663435",
    "user": "https://github.com/maxale"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663436",
    "user": "https://github.com/maxale"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663438",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663440",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The manipulation of edge labels is not simple since labels might not be hashable. For instance, a label can be a `Graph` or a dictionary.\nIn general, I prefer when the decision to consider labels is explicit (an argument set to `True` or `False`). \nDo you have any proposal to improve the documentation ?",
    "created_at": "2022-01-31T10:46:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663441",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:6'></a>The manipulation of edge labels is not simple since labels might not be hashable. For instance, a label can be a `Graph` or a dictionary.
In general, I prefer when the decision to consider labels is explicit (an argument set to `True` or `False`). 
Do you have any proposal to improve the documentation ?
...
```json
{
    "body": "<a id='comment:7'></a>A related issue is the name of this option. What is called `weighted=` in `BipartiteGraph()` in many other methods (like `.is_isomorphic()`, `.canonical_label()`, `.automorphism_group()` etc.) is called `edge_labels=`. \n\nShould there be consistency in the naming of this option?",
    "created_at": "2022-01-31T14:09:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663442",
    "user": "https://github.com/maxale"
}
```

<a id='comment:7'></a>A related issue is the name of this option. What is called `weighted=` in `BipartiteGraph()` in many other methods (like `.is_isomorphic()`, `.canonical_label()`, `.automorphism_group()` etc.) is called `edge_labels=`. 
...
```json
{
    "body": "<a id='comment:10'></a>Replying to [gh-enjeck](#comment%3A9):\n> I want to clarify what fix is expected for this ticket:\n> - Either replace `edge_labels` with `weighted` or vice versa for consistency\n> - When `weighted=None`, assign `True` or `False` to `weighted` after checking the input data for labels. For example, if the input is an edge list, just check if at least one edge is a triple (and the third item is not `None`). \n> Is this right? \n\n\nYes, this would be great!",
    "created_at": "2022-04-12T23:00:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663445",
    "user": "https://github.com/maxale"
}
```

<a id='comment:10'></a>Replying to [gh-enjeck](#comment%3A9):
> I want to clarify what fix is expected for this ticket:
> - Either replace `edge_labels` with `weighted` or vice versa for consistency
> - When `weighted=None`, assign `True` or `False` to `weighted` after checking the input data for labels. For example, if the input is an edge list, just check if at least one edge is a triple (and the third item is not `None`). 
> Is this right? 
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33255#event-87817"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33255#event-87818"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33255#event-87819"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663447",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663448",
    "user": "https://github.com/Bruno-TT"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/gh-Bruno-TT/bipartite-hashes\"",
    "created_at": "2022-10-31T17:56:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663449",
    "user": "https://github.com/Bruno-TT"
}
```

Changing branch from "" to "u/gh-Bruno-TT/bipartite-hashes"
...
```json
{
    "body": "<a id='comment:14'></a>There was never a unanimous consensus on how to handle the weight/labelling logic, so I've implemented a suggestion.\n\nMy implementation adds an optional boolean parameter hash_labels to the class constructor, which if left empty will default to None and warn the user upon hash() invocation, and then include labels in the hash.\n\nLet me know what you guys think.\n\n(I'm new to the project so please feel free to give criticism, I'm assuming I've somehow misused trac).",
    "created_at": "2022-10-31T17:56:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663450",
    "user": "https://github.com/Bruno-TT"
}
```

<a id='comment:14'></a>There was never a unanimous consensus on how to handle the weight/labelling logic, so I've implemented a suggestion.
...
```json
{
    "body": "Changing commit from \"6d31aad9f67f9ff414b4dbdce70444d9f0b69004\" to \"e49602d2a4cf2bf2eda0dbeff47ba787aeed8156\"",
    "created_at": "2022-10-31T17:58:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663451",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6d31aad9f67f9ff414b4dbdce70444d9f0b69004" to "e49602d2a4cf2bf2eda0dbeff47ba787aeed8156"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663452",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663455",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"e49602d2a4cf2bf2eda0dbeff47ba787aeed8156\" to \"33206afda26e6e74bbf434eeaceef31be65ed014\"",
    "created_at": "2022-11-01T16:03:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663456",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e49602d2a4cf2bf2eda0dbeff47ba787aeed8156" to "33206afda26e6e74bbf434eeaceef31be65ed014"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663459",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"33206afda26e6e74bbf434eeaceef31be65ed014\" to \"aca2b6366fdc174aa0f17d327731748dea9f1952\"",
    "created_at": "2022-11-01T17:19:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663460",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "33206afda26e6e74bbf434eeaceef31be65ed014" to "aca2b6366fdc174aa0f17d327731748dea9f1952"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663462",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"aca2b6366fdc174aa0f17d327731748dea9f1952\" to \"eafaf288bf0b6fc26a81f290aa93080f185d356c\"",
    "created_at": "2022-11-08T16:55:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663463",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "aca2b6366fdc174aa0f17d327731748dea9f1952" to "eafaf288bf0b6fc26a81f290aa93080f185d356c"
...
```json
{
    "body": "<a id='comment:24'></a>Have your tried the method I proposed to hash a `BipartiteGraph` ? it is very similar to the hash function for `Graph`. It makes a frozenset of the list of edges which prevents ordering issues.\n\nConcerning copy, you must ensure in method copy of `src/sage/graphs/generic_graph.py` that attribute `hash_labels` is copied (if it exists).\n\nIf you want to generalize the idea to `Graph`, `DiGraph`, `GenericGraph`, the parameter should be set in the constructor of each of these classes and that the hash method of  `src/sage/graphs/generic_graph.py` should be updated accordingly.",
    "created_at": "2022-11-08T17:34:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663464",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:24'></a>Have your tried the method I proposed to hash a `BipartiteGraph` ? it is very similar to the hash function for `Graph`. It makes a frozenset of the list of edges which prevents ordering issues.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663465",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"eafaf288bf0b6fc26a81f290aa93080f185d356c\" to \"f801dbd83f20e88b27f2c428488b40978733ccfd\"",
    "created_at": "2022-11-24T14:46:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663466",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "eafaf288bf0b6fc26a81f290aa93080f185d356c" to "f801dbd83f20e88b27f2c428488b40978733ccfd"
...
```json
{
    "body": "<a id='comment:27'></a>There is a merge conflict with the last beta version.",
    "created_at": "2022-11-24T15:47:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663468",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:27'></a>There is a merge conflict with the last beta version.
...
```json
{
    "body": "Changing commit from \"f801dbd83f20e88b27f2c428488b40978733ccfd\" to \"c379a13508c98291c090764422839b381ea03772\"",
    "created_at": "2022-11-24T18:17:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663469",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "f801dbd83f20e88b27f2c428488b40978733ccfd" to "c379a13508c98291c090764422839b381ea03772"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663470",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>Replying to [David Coudert](#comment%3A27):\n> There is a merge conflict with the last beta version.\n\nthink I've resolved it",
    "created_at": "2022-11-24T18:18:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663471",
    "user": "https://github.com/Bruno-TT"
}
```

<a id='comment:29'></a>Replying to [David Coudert](#comment%3A27):
> There is a merge conflict with the last beta version.
...
```json
{
    "body": "<a id='comment:30'></a>Some of the text in the commits should be in the ticket to ease the discussion. For instance I agree that returning `self` is not a good idea as one may for instance want to manipulate copies with different embedding.\n\nAlso, can you push the branch in public (e.g., `public/graphs/33255`) so that I can push review commits. It's faster for me that listing all the details that must be improved.\n\nThanks.",
    "created_at": "2022-11-26T16:11:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33255#issuecomment-663472",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:30'></a>Some of the text in the commits should be in the ticket to ease the discussion. For instance I agree that returning `self` is not a good idea as one may for instance want to manipulate copies with different embedding.
