...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33340#issuecomment-665077",
...
```json
{
    "body": "<a id='comment:2'></a>I agree for changing the behaviour of `expansion` as you propose, expect that I think that it does not really make sense to return something in the residue field since the expansion really depends on the liftings we are selecting.",
    "created_at": "2022-02-14T07:22:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33340#issuecomment-665078",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:2'></a>I agree for changing the behaviour of `expansion` as you propose, expect that I think that it does not really make sense to return something in the residue field since the expansion really depends on the liftings we are selecting.
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33340#event-87972"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33340#event-87973"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33340#event-87974"
}
```
