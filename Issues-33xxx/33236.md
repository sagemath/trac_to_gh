...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663103",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663104",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663106",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663107",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663108",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663109",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663110",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I haven't been able to reproduce the failure, but I stared at the code long enough that I believe Option 1 is at best the simplest fix, and at worst harmless.\n\nFor posterity, it also looks like we could pass in our own `multiprocessing.Lock` object, which we could then `release()` manually while we are terminating the workers: at that point, the value of `_aborted` is fixed and should only be read.",
    "created_at": "2022-02-05T01:26:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663111",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:4'></a>I haven't been able to reproduce the failure, but I stared at the code long enough that I believe Option 1 is at best the simplest fix, and at worst harmless.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663112",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663113",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33236#issuecomment-663114",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33236",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33236#event-87779"
}
```
