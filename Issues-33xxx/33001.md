...
```
Inspired by the discussion in #30362, [ticket:30362#comment:77 [comment:77](#comment%3A77)], we change the `Manifold` constructor so that once can omit the `structure` parameter when parameters such as `diff_degree` or `metric_name` are given:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658004",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658005",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658006",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658007",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658008",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658009",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,3 +1,2 @@\n-As discussed in #30362, [ticket:30362#comment:77 [comment:77](#comment%3A77)], we add `TopologicalManifold`, `DifferentiableManifold`, `RiemannianManifold` etc. to the `manifolds` namespace.\n+Inspired by the discussion in #30362, [ticket:30362#comment:77 [comment:77](#comment%3A77)], we change the `Manifold` constructor so that once can omit the `structure` parameter when parameters such as `diff_degree` or `metric_name` are given.\n \n-This shall represent an additional and more convenient syntax opposed to `Manifold(..., structure=...)`.\n``````\n",
    "created_at": "2021-12-13T00:56:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658010",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658011",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658012",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658013",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658014",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33001#event-98088"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658015",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658016",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658017",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658018",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658019",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658020",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33001#issuecomment-658021",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33001",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33001#event-98089"
}
```
