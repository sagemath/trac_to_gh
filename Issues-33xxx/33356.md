...
```json
{
    "body": "A `hold context` is supposed to prevent evaluation, but it is buggy (see #31607, for example) and it does not seem to work for your example.",
