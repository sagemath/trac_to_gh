...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33356#issuecomment-504119",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33356#issuecomment-504120",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33356#issuecomment-504122",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33356#issuecomment-504123",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Yes, this is a problem if latex() command tries to evaluate the math it is trying to convert to Latex. In this case I will modify my code to avoid calling latex() on result which contains integrate in it to bypass this problem.\n\nBut does not sagemath has a way to prevent evaluation?  For example, in Mathematica one can do the following\n\n\n```\nTeXForm[HoldForm[Integrate[Sin[x], x]]]\n\n   \\int \\sin (x) \\, dx\n```\n\nThe command `HoldForm` tells it not to evaluate what is inside.  Without this, it will evaluate first. \n\n\n```\nTeXForm[Integrate[Sin[x], x]]\n\n    -\\cos (x)\n\n```",
    "created_at": "2022-02-16T03:24:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33356#issuecomment-504125",
    "user": "https://github.com/nasser1"
}
```

<a id='comment:4'></a>Yes, this is a problem if latex() command tries to evaluate the math it is trying to convert to Latex. In this case I will modify my code to avoid calling latex() on result which contains integrate in it to bypass this problem.
...
```json
{
    "body": "<a id='comment:7'></a>A `hold context` is supposed to prevent evaluation, but it is buggy (see #31607, for example) and it does not seem to work for your example.",
    "created_at": "2022-02-16T04:11:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33356#issuecomment-504128",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:7'></a>A `hold context` is supposed to prevent evaluation, but it is buggy (see #31607, for example) and it does not seem to work for your example.
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33356#event-88003"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33356#event-88004"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33356#event-88005"
}
```
