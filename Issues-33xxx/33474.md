...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659092",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659093",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659094",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nWith these patches, building still fails, at extension building, as it can't find `libmodred.so`.\n\nIt is fixed by exporting, before build, `LDFLAGS=\"-L<SAGE_ROOT>/venv/lib\"`,\nas that's where `libmodres.so` gets installed.\n\nWhat's the correct way to fix this?\n\n \n---\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[071e29d](https://github.com/sagemath/sagetrac-mirror/commit/071e29d77396d2e8517122443e3c038ebbed2357)|`p_group_cohomology patches by `@`culler from #30787`|",
    "created_at": "2022-03-07T06:25:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659095",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659096",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659097",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33474#event-107144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659098",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659099",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33474#issuecomment-659100",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33474",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33474#event-107145"
}
```
