...
```json
{
    "body": "How does this compare against the old algorithm for small values? I am wondering if we want to impose a cutoff and do the dumb way when `n` is small. (Cf. bubble sort versus more efficient search algorithms for small lists.)",
