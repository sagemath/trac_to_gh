...
archive/attachments_021574.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "ffmpeg-imagemagick.log",
    "asset_url": "tarball://root/attachments/some-uuid/ticket33092/ffmpeg-imagemagick.log",
...
archive/attachments_021575.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "ffmpeg.log",
    "asset_url": "tarball://root/attachments/some-uuid/ticket33092/ffmpeg.log",
