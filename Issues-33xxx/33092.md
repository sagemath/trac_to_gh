...
archive/issue_comments_659845.json:
```json
{
    "body": "<a id='comment:1'></a>I don't think we need to tighten `spkg-configure.m4` -- this does not influence the `ffmpeg` optional tag at all.\n\nThese tags are added by runtime `Feature` checks, not via `spkg-configure.m4`",
    "created_at": "2021-12-29T19:30:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659845",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>I don't think we need to tighten `spkg-configure.m4` -- this does not influence the `ffmpeg` optional tag at all.
...
archive/issue_comments_659846.json:
```json
{
    "body": "<a id='comment:2'></a>(this code is from #32174)",
    "created_at": "2021-12-29T19:31:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659846",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>(this code is from #32174)



---

archive/issue_comments_659847.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659847",
    "user": "https://github.com/orlitzky"
}
```
...
archive/issue_comments_659848.json:
```json
{
    "body": "<a id='comment:4'></a>If these doctests are the only ways that we \"need\" these features, perhaps it would be enough to just mark them as \"not tested\"?",
    "created_at": "2021-12-29T19:51:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659848",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>If these doctests are the only ways that we "need" these features, perhaps it would be enough to just mark them as "not tested"?



---

archive/issue_comments_659849.json:
```json
{
    "body": "<a id='comment:5'></a>There are like 79 optional imagemagick doctests and 19 optional ffmpeg doctests:\n\n```\n$ git grep \"optional -* ImageMagick\" | wc\n     76     678    7649\n$ git grep \"optional -* imagemagick\" | wc\n      3      23     305\n$ git grep \"optional -* ffmpeg\" | wc\n     19     151    1895\n```\n\nWe can mark two of them as \"not tested\" if they do not work with all versions of ffmpeg/imagemagick. But I still think it is a good thing to test that the remaining `79 + 19 - 2` doctests still work on all versions of ffmpeg.\n\nMy opinion is that either we expect doctests to work and we test them or we expect doctests not to work and we do not test them.",
    "created_at": "2021-12-29T20:28:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659849",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:5'></a>There are like 79 optional imagemagick doctests and 19 optional ffmpeg doctests:
...
archive/issue_comments_659850.json:
```json
{
    "body": "<a id='comment:6'></a>Replying to [slabbe](#comment%3A5):\n> We can mark two of them as \"not tested\" if they do not work with all versions of ffmpeg/imagemagick. But I still think it is a good thing to test that the remaining `79 + 19 - 2` doctests still work on all versions of ffmpeg.\n\n\nI agree, I meant these 2 failing ones only.",
    "created_at": "2021-12-29T20:56:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659850",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>Replying to [slabbe](#comment%3A5):
> We can mark two of them as "not tested" if they do not work with all versions of ffmpeg/imagemagick. But I still think it is a good thing to test that the remaining `79 + 19 - 2` doctests still work on all versions of ffmpeg.
...
```json
{
    "body": "<a id='comment:8'></a>I see. Can you provide the log of the failing doctests here or somewhere?",
    "created_at": "2021-12-31T20:56:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659852",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:8'></a>I see. Can you provide the log of the failing doctests here or somewhere?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659853",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33092#issuecomment-659854",
    "user": "https://github.com/orlitzky"
}
```
...
<a id='comment:11'></a>It looks like most of the disabled formats are absent from the list, but SVG and SVGZ (also disabled) appear with mode `---`:
...
<a id='comment:12'></a>The content of the second column is not the same in my case:
...
```json
{
    "body": "<a id='comment:14'></a>Good idea, I will post a branch soon.",
...
<a id='comment:14'></a>Good idea, I will post a branch soon.
...
```json
{
    "body": "<a id='comment:19'></a>Most of the errors in the attached log were coming from imagemagick. I wait to get new inputs before touching ffmpeg features.",
...
<a id='comment:19'></a>Most of the errors in the attached log were coming from imagemagick. I wait to get new inputs before touching ffmpeg features.
...
<a id='comment:20'></a>I get "not functional",
...
<a id='comment:23'></a>Okay, I found an alternate way of doing it. I moved the `is_functional` method into a class Executable for the `convert` as it is done within the file `features/graphviz.py`.
...
<a id='comment:24'></a>Replying to [slabbe](#comment%3A23):
> Maybe changes needs to be done with respect to `is_present()`, `is_functional()` and `require()`. In particular, I have the following questions for `@`mkoeppe:
> - why `Feature.require()` does not check that `is_functional()` is True?
> - should `is_present()` always return False when `is_functional` return False (even if the vocabulary that is used should logically allow it)?
> But this discussion should be done in another ticket.
...
<a id='comment:25'></a>I don't think you are cleaning up the temporary files.
...
<a id='comment:29'></a>Replying to [mjo](#comment%3A27):
> And the test failures are gone.
...
<a id='comment:30'></a>Replying to [slabbe](#comment%3A29):
> Replying to [mjo](#comment%3A27):
> > And the test failures are gone.
...
<a id='comment:32'></a>Replying to [saraedum](#comment%3A25):
> I don't think you are cleaning up the temporary files.
...
<a id='comment:33'></a>I spoke too soon. I re-enabled PNG support in my imagemagick and now these fail:
...
<a id='comment:34'></a>Replying to [mjo](#comment%3A33):
> I wonder what those tests are trying to check. 
...
```json
{
    "body": "<a id='comment:35'></a>Replying to [slabbe](#comment%3A34):\n> \n> So if it is False, my first advice would be to actually look at the animation with your eyes, because possibly they are broken. Are they?\n\n\nNo, they look fine.",
...
<a id='comment:35'></a>Replying to [slabbe](#comment%3A34):
> 
> So if it is False, my first advice would be to actually look at the animation with your eyes, because possibly they are broken. Are they?
...
<a id='comment:36'></a>Replying to [mjo](#comment%3A33):
> 
> I wonder what those tests are trying to check. Maybe instead we should just check for the magic "GIF8" bits at the beginning of the file...
...
<a id='comment:37'></a>Replying to [slabbe](#comment%3A32):
> Replying to [saraedum](#comment%3A25):
> > I don't think you are cleaning up the temporary files.
...
<a id='comment:38'></a>Replying to [saraedum](#comment%3A37):
> Ok. Maybe that's the [SageMath](SageMath) way of doing things. (I guess all this functionality is from Python <3.2 when there was no good support for temporary directories in Python.) If [SageMath](SageMath) is cleaning up already, that's probably fine then. (For me $SAGE_TMP is annoying because it is often located on a remote drive...)
...
```json
{
    "body": "<a id='comment:39'></a>> Ok, I will check if it works without. If it's there, it was for a reason I think. But let me check this tomorrow.\n\n\nThe shell=True is only there to make the `*.png` work I think.",
...
<a id='comment:39'></a>> Ok, I will check if it works without. If it's there, it was for a reason I think. But let me check this tomorrow.
...
```json
{
    "body": "<a id='comment:40'></a>I attached another log file with just the remaining ffmpeg failures.",
...
<a id='comment:40'></a>I attached another log file with just the remaining ffmpeg failures.
...
```json
{
    "body": "<a id='comment:43'></a>It is not ready for review. In the current state, the doctest framework is stock in an infinite loop with the command `sage -t src/sage/features/ffmpeg.py`, but it is fine with `sage -t src/sage/features/imagemagick.py`?",
...
<a id='comment:43'></a>It is not ready for review. In the current state, the doctest framework is stock in an infinite loop with the command `sage -t src/sage/features/ffmpeg.py`, but it is fine with `sage -t src/sage/features/imagemagick.py`?
...
<a id='comment:44'></a>I still do not understand how the command `sage -t src/sage/features/ffmpeg.py` get stuck:
...
<a id='comment:45'></a>Regardless of the infinite loop bug while doctesting, the current state makes the following to work:
...
<a id='comment:46'></a>Replying to [slabbe](#comment%3A45):
> 
> `@`mjo: Can you provide the output of the above for your machine?
...
<a id='comment:47'></a>Replying to [mjo](#comment%3A46):
> {{{
> FeatureNotPresentError                    Traceback (most recent call last)
> ...
> }}}
...
<a id='comment:49'></a>You can eliminate the hang with,
...
<a id='comment:50'></a>Ok, I think I have found the loop which loops over and over. With the following change
...
```json
{
    "body": "<a id='comment:51'></a>Replying to [slabbe](#comment%3A50):\n> Also, the log of `forker.py` indicates that a recent change was made on it at #33032. I don't know if it is related.\n\n\nUndoing #33032 does not change anything. It is unrelated.",
...
<a id='comment:51'></a>Replying to [slabbe](#comment%3A50):
> Also, the log of `forker.py` indicates that a recent change was made on it at #33032. I don't know if it is related.
...
<a id='comment:52'></a>Replying to [mjo](#comment%3A49):
> You can eliminate the hang with,
> [...] 
> which is pretty amazing to me.
...
<a id='comment:53'></a>Something seems to be wrong in the `parallel_dispatch` method of the `doctest/forker.py` file because using `serial_dispatch` works fine:
...
<a id='comment:54'></a>Doing small progres... It seems the chosen command to test ffmpeg hangs when called within the doctest framework in a non serial way (which is the default):
...
```json
{
    "body": "<a id='comment:55'></a>Replacing the ffmpeg test command by something simpler like `cmd = ['ffmpeg', '-i', filename_png, filename_gif]` still hangs.",
...
<a id='comment:55'></a>Replacing the ffmpeg test command by something simpler like `cmd = ['ffmpeg', '-i', filename_png, filename_gif]` still hangs.
...
```json
{
    "body": "<a id='comment:56'></a>The documentation of [subprocess.run](https://docs.python.org/3/library/subprocess.html#subprocess.run) says that it *\"run the command described by args. Wait for command to complete, then return a CompletedProcess instance.\"*\n\nMaybe the fact of running the doctests within parallel threads makes it so that the `ffmpeg` command run by `run` does not complete?",
...
<a id='comment:56'></a>The documentation of [subprocess.run](https://docs.python.org/3/library/subprocess.html#subprocess.run) says that it *"run the command described by args. Wait for command to complete, then return a CompletedProcess instance."*
...
```json
{
    "body": "<a id='comment:59'></a>`@`mjo: Are the only remainings issues the one reported in #33092#comment:33 ?",
...
<a id='comment:59'></a>`@`mjo: Are the only remainings issues the one reported in #33092#comment:33 ?
...
<a id='comment:60'></a>Replying to [slabbe](#comment%3A59):
> Got it!
> https://stackoverflow.com/questions/16523746/ffmpeg-hangs-when-run-in-background
...
```json
{
    "body": "<a id='comment:62'></a>I added all outputs that I can see in the `ffmpeg.log` in which we can see two different kind of commands invoking ffmpeg. Only the format `'.mpg'` is incompatible with `rbg24` parameter.\n\nOn my machine, `require()` now takes 1s, but it is cached:\n\n```\nsage: from sage.features.ffmpeg import FFmpeg\nsage: %time FFmpeg().require()\nCPU times: user 15.5 ms, sys: 69.2 ms, total: 84.7 ms\nWall time: 1.02 s\nsage: %time FFmpeg().require()\nCPU times: user 16 \u00b5s, sys: 0 ns, total: 16 \u00b5s\nWall time: 17.6 \u00b5s\n```",
...
<a id='comment:62'></a>I added all outputs that I can see in the `ffmpeg.log` in which we can see two different kind of commands invoking ffmpeg. Only the format `'.mpg'` is incompatible with `rbg24` parameter.
...
```json
{
    "body": "<a id='comment:63'></a>The latest commit is working for me (at least as far as ffmpeg is concerned). The only other test that I was able to make fail was the ogg one. The others like flash and wmv seem to pass anyway even though I definitely don't have support for those formats.",
...
<a id='comment:63'></a>The latest commit is working for me (at least as far as ffmpeg is concerned). The only other test that I was able to make fail was the ogg one. The others like flash and wmv seem to pass anyway even though I definitely don't have support for those formats.
...
```json
{
    "body": "<a id='comment:64'></a>I would rather have this once during `./configure` than in each invocation of `sage -t`, but that's a problem for another day:\n\n```\nsage: from sage.features.ffmpeg import FFmpeg\nsage: %time FFmpeg().require()\nCPU times: user 89.6 ms, sys: 288 ms, total: 378 ms\nWall time: 3 s\n```\n\nIn other news, I finally figured out how to get ffmpeg to write a webm file.",
...
<a id='comment:64'></a>I would rather have this once during `./configure` than in each invocation of `sage -t`, but that's a problem for another day:
...
<a id='comment:65'></a>One more thing. If I build both a working ffmpeg AND a working imagemagick... the whole thing times out because the file takes ~440s and the default timeout is 300s:
...
```json
{
    "body": "<a id='comment:66'></a>ffmpeg tests that times out are tracked at #33045. Should these be dealt here or there?",
...
<a id='comment:66'></a>ffmpeg tests that times out are tracked at #33045. Should these be dealt here or there?
...
<a id='comment:67'></a>Replying to [mjo](#comment%3A64):
> I would rather have this once during `./configure` than in each invocation of `sage -t`, but that's a problem for another day:
> 
> 
> ```
...
<a id='comment:68'></a>Replying to [slabbe](#comment%3A67):
> 
> Maybe the current `is_functional()` for ffmpeg is exagerated. Maybe we can simplify and test only few well-chosen formats? If so, which formats do you think?
...
<a id='comment:69'></a>[ffmpeg without theora](https://github.com/sheerluck/sage/runs/4742160208?check_suite_focus=true) fails with **Default encoder for format ogg (codec theora) is probably disabled**
...
<a id='comment:70'></a>Replying to [gh-sheerluck](#comment%3A69):
> [ffmpeg without theora](https://github.com/sheerluck/sage/runs/4742160208?check_suite_focus=true) fails with **Default encoder for format ogg (codec theora) is probably disabled**
...
<a id='comment:71'></a>Replying to [slabbe](#comment%3A70):
> So why are the optional ffmpeg tags gone?
...
<a id='comment:72'></a>Replying to [gh-sheerluck](#comment%3A71):
> Replying to [slabbe](#comment%3A70):
> > So why are the optional ffmpeg tags gone?
...
<a id='comment:73'></a>Thank you, with very long
...
<a id='comment:74'></a>Replying to [gh-sheerluck](#comment%3A73):
> 
> I'm positive this ticket is ready for positive review :)
...
<a id='comment:75'></a>Replying to [gh-sheerluck](#comment%3A73):
> Thank you, with very long
> 
> ```
> --optional=arch,mathics,argcomplete,build,dochtml,pip,sage,sage_spkg,polymake,ffmpeg,imagemagick,latex,pandoc
...
<a id='comment:77'></a>Replying to [mjo](#comment%3A74):
> I still have the failures in[comment:33](#comment%3A33) with my "normal" imagemagick. I would try `b"GIF8" in f.read()` rather than looking for a specific binary sequence.
...
<a id='comment:78'></a>All passing now, thank you!
...
```json
{
    "body": "<a id='comment:80'></a>Thanks for catching these. I did 2 commits.",
...
<a id='comment:80'></a>Thanks for catching these. I did 2 commits.
...
```json
{
    "body": "<a id='comment:81'></a>Thanks again.",
...
<a id='comment:81'></a>Thanks again.
...
```json
{
    "body": "<a id='comment:82'></a>I think this ticket should go to 9.5, but it seems for the 9.5 cycle, there was no period within the early rc candidates which was devoted to merging a bunch of tickets fixing just \"defects\". I think the 9.5 version would be better if more tickets of type \"defect\" with positive review were merged.",
...
<a id='comment:82'></a>I think this ticket should go to 9.5, but it seems for the 9.5 cycle, there was no period within the early rc candidates which was devoted to merging a bunch of tickets fixing just "defects". I think the 9.5 version would be better if more tickets of type "defect" with positive review were merged.
...
```json
{
    "body": "<a id='comment:83'></a>Yes, otherwise the 9.5 test suite is going to fail all over the place. Same for the lrslib ticket.",
    "created_at": "2022-01-21T17:14:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_comment",
...
<a id='comment:83'></a>Yes, otherwise the 9.5 test suite is going to fail all over the place. Same for the lrslib ticket.
...
```json
{
    "body": "<a id='comment:84'></a>(and it's a regression, since ffmpeg tests weren't enabled in 9.4 when ffmpeg was disabled)",
...
<a id='comment:84'></a>(and it's a regression, since ffmpeg tests weren't enabled in 9.4 when ffmpeg was disabled)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33092#event-87439"
}
```
...
```json
{
    "body": "<a id='comment:86'></a>Probably an improvement but still broken on the buildbot: followup at #33219",
...
<a id='comment:86'></a>Probably an improvement but still broken on the buildbot: followup at #33219
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33092#event-87440"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33092",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33092#event-87441"
}
```
...
```json
{
    "body": "<a id='comment:88'></a>Another follow-up to fix an issue observed by Justin on MacOSX needs review at #33231",
...
<a id='comment:88'></a>Another follow-up to fix an issue observed by Justin on MacOSX needs review at #33231
