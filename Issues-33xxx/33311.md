...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503529",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503530",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503531",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Note: reference ticket changed",
    "created_at": "2022-02-08T05:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503532",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:4'></a>Note: reference ticket changed
...
```json
{
    "body": "<a id='comment:6'></a>But for the changes of #31578 to really work, we need to have a .pc file for NTL. And right now it doesn't exist. My PR for a NTL .pc file is still pending. Fighting with an unrelated PR from Matthias that touch a similar bit of code last time I checked.",
    "created_at": "2022-02-08T06:23:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503534",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:6'></a>But for the changes of #31578 to really work, we need to have a .pc file for NTL. And right now it doesn't exist. My PR for a NTL .pc file is still pending. Fighting with an unrelated PR from Matthias that touch a similar bit of code last time I checked.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503535",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503536",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33311#event-87916"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>NTL installs one library, libntl, that doesn't conflict with any other software. It's in the library search path (`-lntl`) whether installed on the system or via SPKG.\n\nSo AFAIK, the only reason we guess `NTL_LIBDIR` in the first place is for homebrew users who forget to source their homebrew config and then try to use the C compiler in a broken environment. It continues to waste everyone's time and should just be deleted.",
    "created_at": "2022-02-09T03:49:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33311#issuecomment-503537",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:8'></a>NTL installs one library, libntl, that doesn't conflict with any other software. It's in the library search path (`-lntl`) whether installed on the system or via SPKG.
