...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403360"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33283#issuecomment-540581",
    "user": "https://github.com/real-or-random"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33283",
    "rename": {
        "from": "Inconsistent position of sign in factorization of rational polynominals",
        "to": "Improve sign consistency in rational polynomial factorization"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33283#issuecomment-540582",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403365"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403366"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403367"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-403368"
}
```
