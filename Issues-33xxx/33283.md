...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33283#issuecomment-541048",
    "user": "https://github.com/real-or-random"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33283#issuecomment-541049",
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-439481"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-439482"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-439483"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33283#event-439484"
}
```
