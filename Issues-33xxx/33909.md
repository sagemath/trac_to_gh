...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket33909/configure.log",
    "created_at": "2022-05-26T16:52:17Z",
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket33909/configure.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "Attachment [configure.log](https://github.com/sagemath/sage/files/ticket33909/configure.log) by tmonteil created at 2022-05-26 16:52:17",
    "created_at": "2022-05-26T16:52:17Z",
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550932",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

Attachment [configure.log](https://github.com/sagemath/sage/files/ticket33909/configure.log) by tmonteil created at 2022-05-26 16:52:17
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket33909/config.log",
    "created_at": "2022-05-26T16:52:35Z",
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket33909/config.log",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "Attachment [config.log](https://github.com/sagemath/sage/files/ticket33909/config.log) by tmonteil created at 2022-05-26 16:52:35",
    "created_at": "2022-05-26T16:52:35Z",
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550933",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

Attachment [config.log](https://github.com/sagemath/sage/files/ticket33909/config.log) by tmonteil created at 2022-05-26 16:52:35
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket33909/config.status",
    "created_at": "2022-05-26T16:53:43Z",
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket33909/config.status",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302818"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302819"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550935",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550936",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550937",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550938",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302821"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302822"
}
```
...
```json
{
    ...
    "label": "invalid",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302823"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302824"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302825"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550939",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550940",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550941",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550942",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302827"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550943",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33909#issuecomment-550944",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302828"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302829"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302830"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33909#event-302831"
}
```
