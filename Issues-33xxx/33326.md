...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33326#issuecomment-664922",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This is now [maxima bug #3940](https://sourceforge.net/p/maxima/bugs/3940/).",
    "created_at": "2022-02-12T05:37:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33326#issuecomment-664923",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:2'></a>This is now [maxima bug #3940](https://sourceforge.net/p/maxima/bugs/3940/).
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33326#event-87946"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33326#event-87947"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33326#event-87948"
}
```
