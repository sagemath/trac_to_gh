...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664509",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nI noticed that `_small_primes_`table is just bits and then I found http://oeis.org/A133155 \n\nI updated their code to\n\n```\na = gmpy2.mpz(0)\nfor p in range(3, 500, 2):\n    if gmpy2.is_prime(p):\n        a = setBit(a, (p - 1) / 2)\n        print(a)\n```\n\nand then used `format(large_x, \"b\").zfill(9000)` to get long bitstring of `_small_primes_`table.\n\nAfter that I splitted bitstring into 32-bit chunks and recreated `_small_primes_`table this way:\n\n```\n`_small_primes_`table = [ \n    1689570158, 2171409050, 2253016114,  563511821, #   1,   3,..., 255\n    1510225097, 2760466720,  696652100, 1244168913, # 257, 259,..., 511\n    ...\n```\n\nand oneliner `return `_small_primes_`table[u >> 1]` turns to something like\n\n```\n        index = u >> 1\n        mask = 1 << index % 32\n        return (_small_primes_table[index >> 5] & mask) != 0\n```\nWhen I finish with filling `_small_primes_table` I will benchmark my alternative too.",
    "created_at": "2022-02-10T17:10:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664510",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664511",
    "user": "https://github.com/sheerluck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664512",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664513",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664514",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664515",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33318#event-98927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33318",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33318#issuecomment-664516",
    "user": "https://github.com/vbraun"
}
```
