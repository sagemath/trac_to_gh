...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664592",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    "body": "Changing commit from \"97ebc34207bacb31cab915c1e7179ed15e1d088a\" to \"af4c3e207a178b7f414925c913619d353d267553\"",
    "created_at": "2022-02-09T15:05:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664593",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "97ebc34207bacb31cab915c1e7179ed15e1d088a" to "af4c3e207a178b7f414925c913619d353d267553"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664594",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Does this duplicate #30639? If so, let's close #30639, since there is no branch there.",
    "created_at": "2022-02-09T16:46:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664595",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:3'></a>Does this duplicate #30639? If so, let's close #30639, since there is no branch there.
...
```json
{
    "body": "<a id='comment:4'></a>If I'm reading the old code right, the default number of threads was 2, but you've changed it to 10. At least one reason to keep the default low was for the case of shared machines, where a single user should only use many cores at a time intentionally.",
    "created_at": "2022-02-09T16:50:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664596",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>If I'm reading the old code right, the default number of threads was 2, but you've changed it to 10. At least one reason to keep the default low was for the case of shared machines, where a single user should only use many cores at a time intentionally.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664597",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664598",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>ALL_CAPS variables in `sage.env` should be strings, not integers.\nIs it really necessary to introduce `THREAD_COUNT` as a variable? Having a function that returns this value should be enough.",
    "created_at": "2022-02-09T17:49:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664599",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:7'></a>ALL_CAPS variables in `sage.env` should be strings, not integers.
Is it really necessary to introduce `THREAD_COUNT` as a variable? Having a function that returns this value should be enough.
...
```json
{
    "body": "<a id='comment:8'></a>Also, I don't see why the words `num_threads` (which developers are familiar with) should be replaced by `thread_count`.",
    "created_at": "2022-02-09T17:52:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664600",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:8'></a>Also, I don't see why the words `num_threads` (which developers are familiar with) should be replaced by `thread_count`.
...
```json
{
    "body": "<a id='comment:9'></a>Also, the point of `build/bin/sage-build-num-threads` (called in build/make/install) is that it initializes the number of threads in a build context based on the user's use of `make -jNUM`.\nPlease don't delete this.",
    "created_at": "2022-02-09T17:56:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664601",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:9'></a>Also, the point of `build/bin/sage-build-num-threads` (called in build/make/install) is that it initializes the number of threads in a build context based on the user's use of `make -jNUM`.
Please don't delete this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664602",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664604",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664605",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664606",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664607",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664608",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664609",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Replying to [gh-tobiasdiez](#comment%3A14):\n> Replying to [mkoeppe](#comment%3A8):\n> > Also, I don't see why the words `num_threads` (which developers are familiar with) should be replaced by `thread_count`. \n\n> \n> I [...] can change the naming of course \n\n\nYes, please change it back.",
    "created_at": "2022-02-10T23:58:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664610",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:18'></a>Replying to [gh-tobiasdiez](#comment%3A14):
> Replying to [mkoeppe](#comment%3A8):
> > Also, I don't see why the words `num_threads` (which developers are familiar with) should be replaced by `thread_count`. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33317#issuecomment-664611",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33317#event-87924"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33317#event-87925"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33317#event-87926"
}
```
