...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33003#event-87205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33003#issuecomment-658050",
    "user": "https://github.com/collares"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This could have to do with the fact that NixOS uses cysignals 1.11.1.",
    "created_at": "2021-12-21T21:33:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33003#issuecomment-658051",
    "user": "https://github.com/collares"
}
```

<a id='comment:3'></a>This could have to do with the fact that NixOS uses cysignals 1.11.1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33003#issuecomment-658053",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33003#event-87206"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33003#event-87207"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33003#event-87208"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33003#event-87209"
}
```
