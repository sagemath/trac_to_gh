...
```json
{
    "body": "Note `SAGE_LIB` is on its way out, see #33037.",
...
```json
{
    "body": "I do agree though that using `SAGE_VENV/bin` can be problematic, for example if the Sage library is installed using `pip install --user ...`.",
