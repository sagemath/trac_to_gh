...
```json
{
    "body": "Changing commit from \"\" to \"9db7fb1cada1d75c98bc5b9792bf0a0459ab67b2\"",
...
Changing commit from "" to "9db7fb1cada1d75c98bc5b9792bf0a0459ab67b2"
...
```json
{
    "body": "Changing branch from \"\" to \"u/slabbe/33169\"",
    "created_at": "2022-01-14T15:19:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
...
Changing branch from "" to "u/slabbe/33169"
...
```json
{
    "body": "<a id='comment:2'></a>Needs `upstream_url` in `checksums.ini`",
...
<a id='comment:2'></a>Needs `upstream_url` in `checksums.ini`
...
<a id='comment:3'></a>I first put it, and then removed it before the commit because the url 
...
```json
{
    "body": "Changing commit from \"9db7fb1cada1d75c98bc5b9792bf0a0459ab67b2\" to \"e44d4d9b21b04eb7ef6f7fea7b6a66e9506d9a00\"",
...
Changing commit from "9db7fb1cada1d75c98bc5b9792bf0a0459ab67b2" to "e44d4d9b21b04eb7ef6f7fea7b6a66e9506d9a00"
...
```json
{
    "body": "<a id='comment:6'></a>and rebased on top of 9.5.rc1",
    "created_at": "2022-01-14T17:06:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
...
<a id='comment:6'></a>and rebased on top of 9.5.rc1
...
<a id='comment:7'></a>oups, spkg-install needs to be updated:
...
```json
{
    "body": "Changing commit from \"e44d4d9b21b04eb7ef6f7fea7b6a66e9506d9a00\" to \"88308ff0f2a1c55f9050c3e5d70c72094e99d0dc\"",
...
Changing commit from "e44d4d9b21b04eb7ef6f7fea7b6a66e9506d9a00" to "88308ff0f2a1c55f9050c3e5d70c72094e99d0dc"
...
<a id='comment:9'></a>The change is not sufficient. I now get
...
archive/issue_comments_661908.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661908",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661909",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"88308ff0f2a1c55f9050c3e5d70c72094e99d0dc\" to \"9c9510bc634bb5040f9b4c86e6c391dca39d3b68\"",
    "created_at": "2022-01-26T20:00:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661910",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "88308ff0f2a1c55f9050c3e5d70c72094e99d0dc" to "9c9510bc634bb5040f9b4c86e6c391dca39d3b68"
...
```json
{
    "body": "<a id='comment:13'></a>Merci Victor, I made the changes you suggested in[comment:11](#comment%3A11).",
    "created_at": "2022-01-26T20:01:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661911",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:13'></a>Merci Victor, I made the changes you suggested in[comment:11](#comment%3A11).
...
```json
{
    "body": "<a id='comment:17'></a>I agree; `cmake` older than 3.12 is still widespread on many of our supported platforms (see https://repology.org/project/cmake/versions). We could probably increase the lower bound 3.4 a bit, but not by much unless well motivated",
    "created_at": "2022-01-27T20:19:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661915",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:17'></a>I agree; `cmake` older than 3.12 is still widespread on many of our supported platforms (see https://repology.org/project/cmake/versions). We could probably increase the lower bound 3.4 a bit, but not by much unless well motivated
...
```json
{
    "body": "<a id='comment:18'></a>Version 2.1.3 of awali was released earlier today: http://files.vaucanson-project.org/tarballs/awali-all-v2.1.3-220128.tgz\n\nIt is compatible with CMake 3.1.0 so the above problem should no longer happen.",
    "created_at": "2022-01-28T19:29:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661916",
    "user": "https://github.com/marsault"
}
```

<a id='comment:18'></a>Version 2.1.3 of awali was released earlier today: http://files.vaucanson-project.org/tarballs/awali-all-v2.1.3-220128.tgz
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33169#event-87631"
}
```
...
```json
{
    "body": "Changing commit from \"9c9510bc634bb5040f9b4c86e6c391dca39d3b68\" to \"725afa7ca05139c7de4816ee91484f698512db97\"",
    "created_at": "2022-05-05T09:34:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661917",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "9c9510bc634bb5040f9b4c86e6c391dca39d3b68" to "725afa7ca05139c7de4816ee91484f698512db97"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661918",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I rebased the branch and updated the url and version and checksums to the 2.1.3 version.",
    "created_at": "2022-05-05T09:35:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33169#issuecomment-661919",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:21'></a>I rebased the branch and updated the url and version and checksums to the 2.1.3 version.
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33169#event-87632"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33169#event-87633"
}
```
