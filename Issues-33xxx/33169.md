...
```json
{
    "body": "<a id='comment:13'></a>Merci Victor, I made the changes you suggested in comment:11.",
...
<a id='comment:13'></a>Merci Victor, I made the changes you suggested in comment:11.
