...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33038#issuecomment-658719",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>FWIW, I am not seeing this problem (with 9.5b8 on MacOS 11.5.2):\n\n```\nsage: pari(2^64)\n18446744073709551616\nsage: pari(2^64+1)\n18446744073709551617\nsage: pari(2^64+1)\n18446744073709551617\n```",
    "created_at": "2021-12-17T17:38:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33038#issuecomment-658720",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:2'></a>FWIW, I am not seeing this problem (with 9.5b8 on MacOS 11.5.2):
...
```json
{
    "body": "<a id='comment:3'></a>Also no problem with 9.5b8 on Ubuntu 20.04 (CoCalc).",
    "created_at": "2021-12-18T07:19:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33038#issuecomment-658721",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:3'></a>Also no problem with 9.5b8 on Ubuntu 20.04 (CoCalc).
...
```json
{
    "body": "<a id='comment:5'></a>Indeed, this crash only happens on one of the two (Linux) machines I am using.\n\nFrom the stack trace, it looks like it might be related to the fact that PARI is now configured to use `libpthread`; see #30537.  Also[comment:98](#comment%3A98):ticket:30423 might be related.",
    "created_at": "2021-12-21T18:56:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33038#issuecomment-658722",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:5'></a>Indeed, this crash only happens on one of the two (Linux) machines I am using.
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33038#event-87298"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33038#event-87299"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33038#event-87300"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33038#event-87301"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33038#event-87302"
}
```
