...
```json
{
    "body": "<a id='comment:2'></a>This might not be entirely related, but I have just seen the same test fail with another error on a [patchbot](https://patchbot.sagemath.org/log/32364/Linux/1_SMP_Debian_5.10.70-1_(2021-09-30)/x86_64/5.10.0-9-amd64/labri-vindelecroix-1/2022-01-23%2002:17:33):\n\n```\nsage -t --long --random-seed=249317294624714313432109516979551245556 src/sage/rings/integer.pyx\n**********************************************************************\nFile \"src/sage/rings/integer.pyx\", line 3006, in sage.rings.integer.Integer.divisors\nFailed example:\n    for i in range(20):  # long time\n        try:\n            alarm(RDF.random_element(1e-3, 0.5))\n            _ = n.divisors()\n            cancel_alarm()  # we never get here\n        except AlarmInterrupt:\n            pass\nException raised:\n    Traceback (most recent call last):\n      File \"/home/debian/sage/local/lib/python3.9/site-packages/sage/doctest/forker.py\", line 694, in _run\n        self.compile_and_execute(example, compiler, test.globs)\n      File \"/home/debian/sage/local/lib/python3.9/site-packages/sage/doctest/forker.py\", line 1088, in compile_and_execute\n        exec(compiled, globs)\n      File \"<doctest sage.rings.integer.Integer.divisors[20]>\", line 4, in <module>\n        _ = n.divisors()\n      File \"sage/rings/integer.pyx\", line 3108, in sage.rings.integer.Integer.divisors (build/cythonized/sage/rings/integer.c:20364)\n        sig_on()\n    SystemError: calling remove_from_pari_stack() inside sig_on()\n```",
    "created_at": "2022-02-03T21:57:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33230#issuecomment-469972",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:2'></a>This might not be entirely related, but I have just seen the same test fail with another error on a [patchbot](https://patchbot.sagemath.org/log/32364/Linux/1_SMP_Debian_5.10.70-1_(2021-09-30)/x86_64/5.10.0-9-amd64/labri-vindelecroix-1/2022-01-23%2002:17:33):
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33230#event-87767"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33230#event-87768"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33230#event-87769"
}
```
