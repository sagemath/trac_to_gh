...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33065#event-87369"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>A setuptools replacement is in the works: https://github.com/pypa/setuptools/issues/2973",
    "created_at": "2021-12-27T12:37:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33065",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33065#issuecomment-659181",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:2'></a>A setuptools replacement is in the works: https://github.com/pypa/setuptools/issues/2973
...
```json
{
    "body": "<a id='comment:3'></a>Now in 60.2.0 - https://setuptools.pypa.io/en/latest/history.html#v60-2-0",
    "created_at": "2022-01-02T19:41:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33065",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33065#issuecomment-659182",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>Now in 60.2.0 - https://setuptools.pypa.io/en/latest/history.html#v60-2-0
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33065#event-87370"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33065#event-87371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33065",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33065#issuecomment-659183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33065",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33065#issuecomment-659184",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33065#event-87372"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33065#event-87373"
}
```
