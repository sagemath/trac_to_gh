...
<a id='comment:10'></a>Replying to [lorenz](#comment%3A9):
> The patch looks good as far as I can tell.
> 
> Just one question: How much faster is `idealismaximal()` when using a non-broken version of PARI? Could it be worthwhile to detect the PARI version at runtime to switch between `idealismaximal()` and the workaround?
...
```json
{
    "body": "<a id='comment:15'></a>I implemented my suggestions from[comment:9](#comment%3A9) and[comment:12](#comment%3A12). Someone else will have to review the new changes.\n\n---\nNew commits:",
    "created_at": "2022-09-28T15:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33360",
    "type": "issue_comment",
...
<a id='comment:15'></a>I implemented my suggestions from[comment:9](#comment%3A9) and[comment:12](#comment%3A12). Someone else will have to review the new changes.
...
```json
{
    "body": "<a id='comment:20'></a>Reverted earlier changes from[comment:16](#comment%3A16) as #34537 appears to be stuck. Can we get this in?",
    "created_at": "2022-11-10T02:34:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33360",
    "type": "issue_comment",
...
<a id='comment:20'></a>Reverted earlier changes from[comment:16](#comment%3A16) as #34537 appears to be stuck. Can we get this in?
