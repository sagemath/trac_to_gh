...
```json
{
    "body": "<a id='comment:15'></a>\nI implemented my suggestions from[comment:9](#comment%3A9) and[comment:12](#comment%3A12). Someone else will have to review the new changes.\n\n---\nNew commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[6330cee](https://git.sagemath.org/sage.git/commit?id=6330cee1a69229b2f5d8ac4a09a73d8152f5e14d)|`trac 33360: avoid factoring in is_prime()`|\n|[7f19cea](https://git.sagemath.org/sage.git/commit?id=7f19cea54279fd9632f64707dead67f40c61f660)|`Merge branch 'u/tornaria/33360-ideal.is_prime' into public/33360`|\n|[b938f7b](https://git.sagemath.org/sage.git/commit?id=b938f7b81edb954aa3639043f0e09f15b2b98d1a)|`opportunistically use idealismaximal() when PARI version is recent enough`|",
    "created_at": "2022-09-28T15:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33360",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[647bd45](https://git.sagemath.org/sage.git/commit/?id=647bd454b78aba100286e74c60c876c70a83a596)|`Merge tag '9.8.beta1' into public/33360`|\n|[e3af4e3](https://git.sagemath.org/sage.git/commit/?id=e3af4e3a1e11be18a340946dd97909bd911af1e5)|` #34537 requires PARI >= 2.15`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------|\n|[58511ea](https://git.sagemath.org/sage.git/commit/?id=58511ea3015159e1c1533cda12281aa9289e36c0)|`remove unused import`|",
    "created_at": "2022-10-04T07:37:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33360",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[a9051b1](https://git.sagemath.org/sage.git/commit/?id=a9051b1a1569a0c7937529e89d7668a8d862ed97)|`Merge branch 'u/tornaria/33360-ideal.is_prime' into public/33360`|\n|[7eee1c4](https://git.sagemath.org/sage.git/commit/?id=7eee1c4317586bc31dcded5e82837148c4bf8d54)|`opportunistically use idealismaximal() when PARI version is recent enough`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------|\n|[689eb88](https://git.sagemath.org/sage.git/commit/?id=689eb880afd39b6bb8916be32c1b92df5c425bf3)|`fix docstring markup`|",
    "created_at": "2022-11-10T02:40:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33360",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[4ac2c9b](https://git.sagemath.org/sage.git/commit/?id=4ac2c9ba19ccdb80b227d02920d128fe360101e5)|`fix docstring markup some more`|",
