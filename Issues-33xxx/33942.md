...
```json
{
    "body": "<a id='comment:1'></a>The Sage preparser has known issues with multiline input.\n\n- https://trac.sagemath.org/query?order=id&desc=1&summary=~multiline&summary=~multi-line",
    "created_at": "2022-07-02T09:54:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33942#issuecomment-478935",
    "user": "https://github.com/slel"
}
```

<a id='comment:1'></a>The Sage preparser has known issues with multiline input.
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33942#event-88950"
}
```
