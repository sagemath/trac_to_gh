...
```json
{
    "body": "This looks like a good fix",
...
```json
{
    "body": "#30748 does not describe itself as fixing a bug.",
...
```json
{
    "body": "I have a fix in #31924, please review",
...
```json
{
    "body": "I believe #31924 makes this unnecessary.",
...
```json
{
    "body": "Is there still brokenness, or can we close this ticket?",
...
```json
{
    "body": "I take \ud83d\udc4d\ufe0f as positive review",
    "created_at": "2022-05-02T22:59:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33531",
    "type": "issue_comment",
