...
archive/issue_events_465759.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465759"
}
```
...
archive/issue_events_465760.json:
```json
{
    "actor": "https://github.com/mezzarobba",
    "created_at": "2022-06-14T12:16:38Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465760"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465761"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465762"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465763"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33994#issuecomment-549520",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465765"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33994#issuecomment-549521",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465766"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33994#event-465767"
}
```
