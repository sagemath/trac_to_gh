...
```
This is for [SageMath](../wikis/SageMath) version 9.5.rc3 built on two M1 Macs, one with macOS 11.6.2 (Big Sur) and the other with macOS 12.1 (Monterey).
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n-This is for [SageMath](../wikis/SageMath) version 9.5.rc3 built on an M1 Mac with macOS 12.1 (Monterey).\n+This is for [SageMath](../wikis/SageMath) version 9.5.rc3 built on two M1 Macs, one with macOS 11.6.2 (Big Sur) and the other with macOS 12.1 (Monterey).\n \n One test in\n \n``````\n",
...
```json
{
    "body": "<a id='comment:8'></a>\nIt should be possible, but I do not know how to do it when making [SageMath](../wikis/SageMath).",
