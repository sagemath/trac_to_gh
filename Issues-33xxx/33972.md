...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33972#event-447214"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33972#event-447215"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33972#event-447216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33972#event-447217"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33972#issuecomment-552264",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33972#issuecomment-552265",
    "user": "https://github.com/vbraun"
}
```
