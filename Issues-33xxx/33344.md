...
```json
{
    "body": "FWIW, the problem also exists when running in Sage's `fricas_console()`.\n\nHTH,",
...
```json
{
    "body": "actually, I also noticed a (very likely new) communication problem between FriCAS and sage recently: https://mathoverflow.net/questions/415887/generating-function-of-the-square-of-jacobi-polynomial/415912#415912",
