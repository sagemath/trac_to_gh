...
```json
{
    "body": "<a id='comment:2'></a>FWIW, the problem also exists when running in Sage's `fricas_console()`.\n\nHTH,",
    "created_at": "2022-02-15T04:30:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33344#issuecomment-471291",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:2'></a>FWIW, the problem also exists when running in Sage's `fricas_console()`.
...
```json
{
    "body": "<a id='comment:5'></a>actually, I also noticed a (very likely new) communication problem between FriCAS and sage recently: https://mathoverflow.net/questions/415887/generating-function-of-the-square-of-jacobi-polynomial/415912#415912",
    "created_at": "2022-02-15T09:15:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33344#issuecomment-471292",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:5'></a>actually, I also noticed a (very likely new) communication problem between FriCAS and sage recently: https://mathoverflow.net/questions/415887/generating-function-of-the-square-of-jacobi-polynomial/415912#415912
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33344#event-87980"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33344#event-87981"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33344#event-87982"
}
```
