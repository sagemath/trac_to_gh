...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33327#issuecomment-664925",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Correction: that \"minimal\" example isn't actually minimal, because replacing `a^2` with `a` still gives the error.\n\n```\nsage: A.<a,c> = QQbar[]\nsage: factor(a)\n    ...\nValueError: variable name '@c' is not alphanumeric\n```",
    "created_at": "2022-02-13T08:45:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33327#issuecomment-664927",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:3'></a>Correction: that "minimal" example isn't actually minimal, because replacing `a^2` with `a` still gives the error.
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33327#event-87949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33327#issuecomment-664928",
...
```json
{
    "body": "<a id='comment:5'></a>An even smaller reproducer:\n\n```\nsage: A.<c> = PolynomialRing(QQbar, 1)\nsage: factor(c)\nTraceback (most recent call last):\n...\nValueError: variable name '@c' is not alphanumeric\n```",
    "created_at": "2022-05-16T13:47:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33327#issuecomment-664929",
    "user": "https://github.com/slel"
}
```

<a id='comment:5'></a>An even smaller reproducer:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33327#issuecomment-664930",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33327#event-87950"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33327#event-87951"
}
```
