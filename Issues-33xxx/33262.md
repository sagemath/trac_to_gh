...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33262#event-439220"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33262#event-439221"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33262#event-439222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33262#event-439223"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33262#issuecomment-540751",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33262#issuecomment-540752",
    "user": "https://github.com/sagetrac-git"
}
```
