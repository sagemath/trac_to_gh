...
```json
{
    "body": "Thanks for doing this.  I won't have time to review properly for a while, but as I wrote a lot of code (in Sage library for isogenies over Q and number fields) which uses this, if all those tests pass I'm sure I'll be happy.  I have wanted to do some of the things suggested here since this class was created.",
...
```json
{
    "body": "Same here. This looks like very good work, but it will take to look through all and I doubt I have time to do it soon.",
...
```json
{
    "body": "I'll be able to look at some of this, if not all, over the next couple of days",
...
```json
{
    "body": "Just a quick comment from a very quick look: Removing arguments from public functions breaks backwards compatibility. They should be deprecated (with saying it is unused).",
...
```json
{
    "body": "Done. Also removed some unnecessary calls to `Polynomial.list()`.",
