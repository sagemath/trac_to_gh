...
```json
{
    "body": "`numpy` is of course an important data point. Indeed https://numpy.org/doc/stable/reference/generated/numpy.sort.html#numpy-sort explains that they use lexicographic sort order for complex numbers too.",
