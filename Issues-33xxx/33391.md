...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33391#issuecomment-471777",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33391#issuecomment-471779",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>For the larger instances, would using a generic sparse matrix be faster?",
    "created_at": "2022-02-21T06:44:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33391#issuecomment-471780",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>For the larger instances, would using a generic sparse matrix be faster?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33391#issuecomment-471781",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This seems to work well, thanks a lot!",
    "created_at": "2022-02-21T20:18:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33391#issuecomment-471782",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>This seems to work well, thanks a lot!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33391#issuecomment-471783",
