...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33534#issuecomment-660217",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#33533\"",
    "created_at": "2022-04-01T18:19:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33534#issuecomment-660218",
    "user": "https://github.com/mkoeppe"
}
```

Changing dependencies from "" to "#33533"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33534#issuecomment-660219",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33534#event-107244"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33534#event-107245"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33534#event-107246"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33534#event-107247"
}
```
