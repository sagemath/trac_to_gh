...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,6 +14,13 @@\n \n    When you run pyppeteer for the first time, it downloads the latest version of Chromium (~150MB) if it is not found on your system. If you don't prefer this behavior, ensure that a suitable Chrome binary is installed. One way to do this is to run `pyppeteer-install` command before prior to using this library. (https://github.com/pyppeteer/pyppeteer#usage)\n \n+References:\n+- https://stackoverflow.com/questions/26193702/three-js-how-can-i-make-a-2d-snapshot-of-a-scene-as-a-jpg-image\n+- https://threejs.org/docs/#api/en/renderers/WebGLRenderer.domElement\n+- https://developer.mozilla.org/en-US/docs/Web/API/HTMLCanvasElement/toDataURL\n+- https://betterprogramming.pub/saving-an-html5-canvas-as-an-image-with-todataurl-f9b7cb61595d\n+- https://github.com/jupyter-widgets/pythreejs/issues/22\n+\n Comment: 1\n \n Summary: Save threejs 3D graphics as png using pyppeteer or kaleido\n``````\n",
    "created_at": "2022-03-20T02:41:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33534#issuecomment-668488",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33534#issuecomment-668489",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33534#issuecomment-668490",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33534#event-88284"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33534#event-88285"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33534#event-88286"
}
```
