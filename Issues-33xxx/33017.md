# Issue 33017: Fix segmentation fault when plotting `prime_pi`
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33017#event-87813"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33017#event-87814"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33017#event-87815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33017",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33017#event-87816"
}
```
