...
```json
{
    "body": "Let me know when its ready for review.",
...
```json
{
    "body": "It is a very technical issue, but I do understand it. For aliases, the documentation is included twice. Since `gessel_reutenauer` defines its own references, the reference gets defined twice, leading to the error. If you move these references (their definitions) to the master reference file and then only link them in `gessel_reutenauer`, the problem will disappear.",
...
```json
{
    "body": "I had to make one trivial change in order for the doc to build for me.",
...
```json
{
    "body": "Since this change is fundamentally trivial and the doc builds for me, I am allowing myself to set a positive review.\n\n---\nNew commits:",
...
```json
{
    "body": "I need to actually push my change...",
    "created_at": "2022-03-08T23:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33436",
    "type": "issue_comment",
