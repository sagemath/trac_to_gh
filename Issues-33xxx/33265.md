...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33265",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33265#issuecomment-540805",
...
archive/issue_events_424862.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424862"
}
```
...
archive/issue_events_424863.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-02-01T12:41:26Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424863"
}
```
...
archive/issue_events_424864.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-02-01T12:41:26Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424864"
}
```
...
archive/issue_events_424865.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-02-01T12:41:26Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424865"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33265",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33265#issuecomment-540806",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33265",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33265#issuecomment-540807",
    "user": "https://github.com/tscrim"
}
```
...
archive/issue_events_424866.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424866"
}
```
...
archive/issue_events_424867.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-02-15T06:37:43Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424867"
}
```
...
archive/issue_events_424868.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424868"
}
```
...
archive/issue_events_424869.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-02-26T18:53:04Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/33265",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33265#event-424869"
}
```
