...
```json
{
    "body": "I think something got accidentally changed from the default (although IMO the doctests should specify what `x` is; I think there was a ticket about that recently?). Perhaps you have something in your `init.sage`?",
