...
```json
{
    "body": "<a id='comment:5'></a>I did one additional optimization I noticed while reviewing #33257.",
...
<a id='comment:5'></a>I did one additional optimization I noticed while reviewing #33257.
...
<a id='comment:6'></a>Ok, it does what it says. I've been testing it on my own CFM code with no problems.
