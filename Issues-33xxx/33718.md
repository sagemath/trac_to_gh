...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/33718",
...
```json
{
    "body": "<a id='comment:3'></a>This looks like a bug to me rather than intentional behavior. Reported it upstream for clarification https://sourceforge.net/p/maxima/bugs/3964/",
    "created_at": "2022-04-19T19:55:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33718#issuecomment-672572",
    "user": "https://github.com/antonio-rojas"
}
```

<a id='comment:3'></a>This looks like a bug to me rather than intentional behavior. Reported it upstream for clarification https://sourceforge.net/p/maxima/bugs/3964/
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33718#event-88626"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33718#event-88627"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33718#event-88628"
}
```
