...
```json
{
    "body": "\n\nCC:  @jplab @mkoeppe @yuan-zhou\n\nAuthor: Jonathan Kliem\n\nBranch: u/gh-kliem/adding_generators_constraints_ppl\n\nStatus: needs_info\n\nDependencies: #33666, #33678, #33679\n\nCommit: 1a0013794d7d762c40d630d611d43eca883937c2\n\nIssue created by migration from https://trac.sagemath.org/ticket/33709\n\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33709#issuecomment-672203",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33709#issuecomment-672204",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33709#event-88603"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33709#event-88604"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33709#event-88605"
}
```
