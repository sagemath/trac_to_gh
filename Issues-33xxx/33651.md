...
```json
{
    "body": "<a id='comment:4'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/b4e789569eb7178dde7c7d87bae7740d44818d0d\">b4e7895</a></td><td><code>src/bin/sage-notebook, src/sage/repl/ipython_kernel/install.py: Check that the [SageMath](../wikis/SageMath) kernel can be discovered</code></td></tr></table>\n",
