...
```json
{
    "body": "<a id='comment:1'></a>If it sounds good, I'd love to work on implementing these ideas in a separate function.",
    "created_at": "2022-04-03T05:03:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33634#issuecomment-507830",
    "user": "https://github.com/shivensinha4"
}
```

<a id='comment:1'></a>If it sounds good, I'd love to work on implementing these ideas in a separate function.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33634#issuecomment-507832",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33634#event-88462"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This seems like something that could be ripe for a medium-size GSoC idea.",
    "created_at": "2022-04-19T17:39:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33634#issuecomment-507833",
    "user": "https://github.com/georgiachanning"
}
```

<a id='comment:4'></a>This seems like something that could be ripe for a medium-size GSoC idea.
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33634#event-88463"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33634#event-88464"
}
```
