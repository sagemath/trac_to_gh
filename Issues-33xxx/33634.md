...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33634#issuecomment-546515",
    "user": "https://github.com/shivensinha4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33634#issuecomment-546516",
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443456"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443457"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443458"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443459"
}
```
