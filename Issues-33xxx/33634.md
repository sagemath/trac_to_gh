...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443448"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33634#issuecomment-546517",
    "user": "https://github.com/shivensinha4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33634#issuecomment-546518",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33634#issuecomment-546519",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443452"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443453"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33634#issuecomment-546520",
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443454"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33634#event-443455"
}
```
