...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658934",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658935",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Does `giac` even start and work on that machine - without going through sage.",
    "created_at": "2021-12-21T06:38:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658936",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:3'></a>Does `giac` even start and work on that machine - without going through sage.
...
```json
{
    "body": "<a id='comment:5'></a>OK, that's one suspicion correct from the doctest failure. It is still quite strange, it starts and then breaks down rather than just going straight to segfault. Multiple versions of some libraries trying to load?",
    "created_at": "2021-12-21T06:49:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658938",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:5'></a>OK, that's one suspicion correct from the doctest failure. It is still quite strange, it starts and then breaks down rather than just going straight to segfault. Multiple versions of some libraries trying to load?
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33056#event-87348"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658939",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658940",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658941",
    "user": "https://github.com/isuruf"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33056#event-87349"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33056#event-87350"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658943",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658944",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33056#issuecomment-658945",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33056",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33056#event-87351"
}
```
