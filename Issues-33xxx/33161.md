...
```json
{
    "body": "<a id='comment:1'></a>This is a duplicate of #33050, but with more information.",
    "created_at": "2022-01-13T17:42:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33161#issuecomment-501538",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:1'></a>This is a duplicate of #33050, but with more information.
...
```json
{
    "body": "<a id='comment:3'></a>It's very weird and I can reproduce it now. We hit a similar issue in #33092; see the discussion starting around comment 45. Does using `sage -t --serial` fix the problem?",
    "created_at": "2022-01-13T18:36:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33161#issuecomment-501540",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:3'></a>It's very weird and I can reproduce it now. We hit a similar issue in #33092; see the discussion starting around comment 45. Does using `sage -t --serial` fix the problem?
...
```json
{
    "body": "<a id='comment:4'></a>Using `--serial` worked fine exactly once. Every subsequent run hangs even with `--serial`",
    "created_at": "2022-01-13T19:07:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33161#issuecomment-501541",
    "user": "https://github.com/antonio-rojas"
}
```

<a id='comment:4'></a>Using `--serial` worked fine exactly once. Every subsequent run hangs even with `--serial`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33161#issuecomment-501542",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I can't reproduce the problem with `9.5.rc0` with:\n\n```\n$ lsb_release -a\nNo LSB modules are available.\nDistributor ID:\tUbuntu\nDescription:\tUbuntu 20.04.2 LTS\nRelease:\t20.04\nCodename:\tfocal\n$ giac -v\n// Using locale /usr/share/locale/\n// fr_CA.UTF-8\n// /usr/share/locale/\n// giac\n// UTF-8\n// Maximum number of parallel threads 8\n// (c) 2001, 2018 B. Parisse & others\n1.5.0\n```",
    "created_at": "2022-01-13T19:36:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33161#issuecomment-501543",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:6'></a>I can't reproduce the problem with `9.5.rc0` with:
...
```json
{
    "body": "<a id='comment:8'></a>bump to 9.6",
    "created_at": "2022-01-29T08:58:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33161#issuecomment-501545",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:8'></a>bump to 9.6
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33161#event-87611"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33161#event-87612"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33161#event-87613"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Another instance with another random seed, timing out with sage 9.7.rc1:\n\n```\nsage -t --long --warn-long 59.5 --random-seed=14952671518664531990234514377169608802 src/sage/libs/giac/__init__.py\n```",
    "created_at": "2022-09-09T07:34:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33161#issuecomment-501546",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:11'></a>Another instance with another random seed, timing out with sage 9.7.rc1:
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33161#event-87614"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33161#event-87615"
}
```
