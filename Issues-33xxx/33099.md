...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[5e0ae74](https://git.sagemath.org/sage.git/commit/?id=5e0ae74bb0d1467a0ba16242df22c8eb95da6a02)|`.github/workflows/docker.yml: New`|",
    "created_at": "2021-12-30T18:52:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33099",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[cd9ec81](https://git.sagemath.org/sage.git/commit/?id=cd9ec81a81aa04705cc9d7d9afe85a5e6277b541)|`.github/workflows/docker.yml: Set fetch-depth`|",
    "created_at": "2021-12-30T22:38:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33099",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[931926d](https://git.sagemath.org/sage.git/commit/?id=931926d1a3c501642c4ebbd8b8ce71de6b5008dd)|`.github/workflows/docker.yml: Also set CI_COMMIT_SHA`|",
    "created_at": "2021-12-30T23:43:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33099",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[86eca94](https://git.sagemath.org/sage.git/commit/?id=86eca94de9857fe23e74d06243cce8633f7b6c25)|`docker/Dockerfile: Use patch --verbose`|",
    "created_at": "2021-12-31T00:26:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33099",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[be139ca](https://git.sagemath.org/sage.git/commit/?id=be139ca97f43b139b2af88f7b387033574cacc9e)|`.github/workflows/docker.yml: Try with fetch-depth=0`|",
    "created_at": "2021-12-31T00:54:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33099",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[ab0c87d](https://git.sagemath.org/sage.git/commit/?id=ab0c87d9cbc54268c7fe198ed9dc742cad7fea0f)|`docker/Dockerfile: Use V=0 with make`|\n|[58d3b53](https://git.sagemath.org/sage.git/commit/?id=58d3b536d1fdfe2e589b37658baca21262883640)|`docker/Dockerfile: Install gettext for bootstrap`|\n|[4f03c06](https://git.sagemath.org/sage.git/commit/?id=4f03c06d41fc524a19ce80ce950c6963c57b2af4)|`docker/Dockerfile: Use DEBIAN_FRONTEND=noninteractive with apt-get install`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[d1db07e](https://git.sagemath.org/sage.git/commit/?id=d1db07ebd20789773742bdf1b0369264a6f028f1)|`docker/Dockerfile (make-build): Make sure build deps are present`|\n|[a4f05e2](https://git.sagemath.org/sage.git/commit/?id=a4f05e2bd25edcef9987ef581e9c3dc363fef12a)|`.github/workflows/docker.yml: Add deployment step`|",
