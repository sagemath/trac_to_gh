...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33139#event-437674"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33139#event-437675"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33139#event-437676"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33139#event-437677"
}
```
...
```json
{
    "body": "Changed keywords from **cygwin** to ****",
...
Changed keywords from **cygwin** to ****
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33139#issuecomment-538568",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33139#issuecomment-538569",
    "user": "https://github.com/vbraun"
}
```
