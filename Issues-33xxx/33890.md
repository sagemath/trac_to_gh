...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33890#issuecomment-511754",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33890#issuecomment-511755",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I can't reproduce this on OS X or on an Ubuntu virtual machine. I'll try a little bit more.",
    "created_at": "2022-08-05T22:17:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33890#issuecomment-511756",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>I can't reproduce this on OS X or on an Ubuntu virtual machine. I'll try a little bit more.
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33890#event-88887"
}
```
