...
```json
{
    "body": "<a id='comment:27'></a>I added a deprecation of the format argument in groebner_fan.py file. I checked that it fixes the issues listed in[comment:22](#comment%3A22).\n\nNeeds review!",
...
<a id='comment:27'></a>I added a deprecation of the format argument in groebner_fan.py file. I checked that it fixes the issues listed in[comment:22](#comment%3A22).
...
```json
{
    "body": "<a id='comment:29'></a>Is[comment:28](#comment%3A28) suppose to be a positive review?",
...
<a id='comment:29'></a>Is[comment:28](#comment%3A28) suppose to be a positive review?
