...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[b24764b](https://git.sagemath.org/sage.git/commit?id=b24764b905d39123066a34e6b73abd64638d5fe1)|`src/sage/features/gfan.py: New, use it in sage.interfaces.gfan`|",
    "created_at": "2022-03-25T19:19:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33468",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[e6c61eb](https://git.sagemath.org/sage.git/commit/?id=e6c61eb3d43ebcff4bf9bd99437968af3acd5d97)|`src/sage/features/gfan.py: Remove unused import`|",
    "created_at": "2022-03-27T15:58:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33468",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nI added a commit on top to add docstring and doctest for the `__call__` method (after merging with beta6). It made me realize that the `format` argument is just ignored in the code of `__call__`. Should we remove/deprecate it?\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[a091fe3](https://git.sagemath.org/sage.git/commit?id=a091fe34fb791f6dbad57608aacdfecfddda1bc5)|`Merge branch 'u/mkoeppe/feature_for_gfan' of trac.sagemath.org:sage into 33468`|\n|[25674e4](https://git.sagemath.org/sage.git/commit?id=25674e4aa8cc4d61b90073d7c8426e6b0b403a7a)|`33468: adding doctest to gfan interface call method`|",
    "created_at": "2022-03-29T13:23:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33468",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[e6e3a38](https://git.sagemath.org/sage.git/commit/?id=e6e3a38d59d67218fbc2c4b6b9890feb54e1fd38)|`33468: deprecate format argument`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[eed35ab](https://git.sagemath.org/sage.git/commit/?id=eed35ab0d373abe581f9ad8e14e5549f56e85652)|`33468: fixing pycodestyle warnings`|",
    "created_at": "2022-03-31T09:17:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33468",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[1a860db](https://git.sagemath.org/sage.git/commit/?id=1a860dbfdc46244f1febffdd10e13a71ba367e80)|`33468: `@`rename_keyword(I='input')`|",
    "created_at": "2022-04-01T07:53:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33468",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[c415f70](https://git.sagemath.org/sage.git/commit/?id=c415f70c809f773d816368421c72cb890017c4ea)|`src/sage/features/gfan.py: New, use it in sage.interfaces.gfan`|\n|[e3df154](https://git.sagemath.org/sage.git/commit/?id=e3df154ce82fac7a0d3283717402c64e64bfa13f)|`src/sage/features/gfan.py: Remove unused import`|\n|[fc0ff51](https://git.sagemath.org/sage.git/commit/?id=fc0ff5133d6871fd76c7e1539eff43f4f8c5d9cb)|`33468: adding doctest to gfan interface call method`|\n|[b86f85b](https://git.sagemath.org/sage.git/commit/?id=b86f85bbfc57b7394a48c5205ad6951b1c05ca9e)|`33468: deprecate format argument`|\n|[a47a6d2](https://git.sagemath.org/sage.git/commit/?id=a47a6d2be12a7b65ca485b3b2be91d94fa31ca1e)|`33468: fixing pycodestyle warnings`|\n|[bab4d8a](https://git.sagemath.org/sage.git/commit/?id=bab4d8ae03e06a8a3d311c39f992f52b1884d6b5)|`33468: `@`rename_keyword(I='input')`|",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[7fd1d61](https://git.sagemath.org/sage.git/commit/?id=7fd1d61429d107a197a80a855516f27c09ff3d37)|`33468: deprecating argument format in groebner_fan.py file`|",
