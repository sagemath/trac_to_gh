...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[2eae592](https://git.sagemath.org/sage.git/commit?id=2eae5920e2ad64b5d61e118f1607eed9bd295a95)|`change \"hasattr(x, '__call__')\" to \"callable(x)\"`|\n|[4b92197](https://git.sagemath.org/sage.git/commit?id=4b921977b7f0e61bee5454c7a34a168399edbda4)|`Change \"hasattr(x, '__iter__')\" to \"isinstance(x, Iterable)\",`|",
    "created_at": "2022-03-02T18:57:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33451",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[69173e9](https://git.sagemath.org/sage.git/commit/?id=69173e91e2603c4401374b987bb3c312cd8d171a)|`Change \"hasattr(x, '__iter__')\" to \"isinstance(x, Iterable)\",`|",
    "created_at": "2022-03-02T20:43:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33451",
    "type": "issue_comment",
