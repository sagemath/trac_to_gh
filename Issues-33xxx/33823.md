...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[8000320](https://git.sagemath.org/sage.git/commit?id=800032050b15c7b743635b7c08892375f7f5c563)|`sage -t: Handle --optional=!FEATURE`|",
    "created_at": "2022-05-09T00:22:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33823",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[d0a52ed](https://git.sagemath.org/sage.git/commit/?id=d0a52ed409ed07ae060c305f7481ab41479d3403)|`src/bin/sage-runtests: Update documentation of --optional`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[b1ce8d6](https://git.sagemath.org/sage.git/commit/?id=b1ce8d6cb361701b388e3c2c3be7e1c831ee85ff)|`sage -t: Handle --optional=!FEATURE`|\n|[a670ae8](https://git.sagemath.org/sage.git/commit/?id=a670ae8ac34dff7c29f84744463a1c4aeb6892d4)|`src/bin/sage-runtests: Update documentation of --optional`|\n|[ba86146](https://git.sagemath.org/sage.git/commit/?id=ba86146e5a5e3308026aac49d87d2716a80c6a93)|`src/bin/sage-runtests --help: Say that ! needs to be quoted`|",
