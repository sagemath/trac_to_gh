# Issue 33672: Various packages in Debian stable (bullseye) are unusable for Sage
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478633",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478634",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478636",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478637",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478639",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478640",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33672#event-88912"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33672#event-88913"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33672#event-88914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478641",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478642",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478645",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "There is another related issue: some packages have a `distro/debian.txt` file and no `spkg-configure.m4` file: `gap, lie, maxima, rubiks`, so that the semantics of those files is unclear to me.",
    "created_at": "2022-05-27T20:23:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478646",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478647",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33672#issuecomment-478648",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33672#event-88915"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33672#event-88916"
}
```
