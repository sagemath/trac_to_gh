...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-455826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-455827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-455828"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33126#issuecomment-535303",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33126#issuecomment-535304",
    "user": "https://github.com/dreitzle"
}
```
