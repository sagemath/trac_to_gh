...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-437515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-437516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-437517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33126#issuecomment-538255",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33126#issuecomment-538256",
    "user": "https://github.com/dreitzle"
}
```
