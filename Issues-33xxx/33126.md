...
```json
{
    "body": "<a id='comment:1'></a>one again a matter of domain:real versus domain:complex ?\n\n```\nmaxima: domain:complex;\ncomplex\nmaxima: trigreduce(cos(acos(sqrt(x^2 + 1))/2)^5*sin(acos(sqrt(x^2 + 1))/2)^3);\n((-%i*sqrt(x^2+1))-%i)/16\n```",
    "created_at": "2022-01-07T19:21:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33126#issuecomment-468473",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>one again a matter of domain:real versus domain:complex ?
