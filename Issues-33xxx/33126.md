...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-437511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-437512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33126#event-437513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33126#issuecomment-538257",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33126#issuecomment-538258",
    "user": "https://github.com/dreitzle"
}
```
