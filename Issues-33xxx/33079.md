...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436871"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436872"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436873"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436874"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33079#issuecomment-537178",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33079#issuecomment-537179",
    "user": "https://github.com/slel"
}
```
