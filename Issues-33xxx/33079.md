...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436875"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436877"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436878"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436879"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33079#event-436880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33079#issuecomment-537175",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33079#issuecomment-537176",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33079#issuecomment-537177",
    "user": "https://github.com/slel"
}
```
