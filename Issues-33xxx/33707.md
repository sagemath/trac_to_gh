...
<a id='comment:4'></a>I did some edits mostly improving readability of the code. I also wanted to change the added line in AUTHORS section to `...: added montgomery_model()`, but did not, to respect your taste. But the added line still looks difficult to read in the file. My taste is such that the AUTHORS section should contain plain text. But you may object.
...
```json
{
    "body": "<a id='comment:7'></a>Thank you! I just applied a few more small stylistic tweaks (including the one you suggested above).",
...
<a id='comment:7'></a>Thank you! I just applied a few more small stylistic tweaks (including the one you suggested above).
