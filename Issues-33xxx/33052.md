...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33052#event-87334"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>can this be fixed in our .homebrew... script?",
    "created_at": "2021-12-22T11:32:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33052#issuecomment-658889",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:2'></a>can this be fixed in our .homebrew... script?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33052#issuecomment-658890",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I am a bit concerned that something in a standard location like `/usr/local/` is not found. If this is the case, there must be something wrong in `brial`'s own build system.\n\nSince `boost` should be checked by `brial`'s `configure`, this is all the more confusing that things break down during compilation. I'd like to have more of the `brial` build log.",
    "created_at": "2021-12-22T21:23:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33052#issuecomment-658891",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:4'></a>I am a bit concerned that something in a standard location like `/usr/local/` is not found. If this is the case, there must be something wrong in `brial`'s own build system.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33052#issuecomment-658893",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33052#event-87335"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33052#event-87336"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33052#event-87337"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33052#event-87338"
}
```
