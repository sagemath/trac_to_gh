...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460829"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460832"
}
```
...
archive/issue_events_460833.json:
```json
{
    "actor": "https://github.com/orlitzky",
    "created_at": "2022-02-26T13:25:29Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460833"
}
```
...
archive/issue_events_460834.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460834"
}
```
...
archive/issue_events_460835.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-02-28T04:01:40Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460835"
}
```
...
archive/issue_events_460836.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460836"
}
```
...
archive/issue_events_460837.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/33363",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33363#event-460837"
}
```
