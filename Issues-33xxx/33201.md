...
```json
{
    "body": "Changing commit from \"\" to \"0ee6b705fbf3f0b3520e09658c89ba0f5d69f526\"",
    "created_at": "2022-01-17T20:07:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662357",
    "user": "https://github.com/orlitzky"
}
```

Changing commit from "" to "0ee6b705fbf3f0b3520e09658c89ba0f5d69f526"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662358",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/mjo/ticket/33201\"",
    "created_at": "2022-01-17T20:07:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662359",
    "user": "https://github.com/orlitzky"
}
```

Changing branch from "" to "u/mjo/ticket/33201"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662360",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662361",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Normally, one does not write sub-optimal code just to satisfy a compiler. There had better be a very convincing reason! In this case I am even less convinced that a fix on our side is required, since there is an issue open in cython pertaining this: https://github.com/cython/cython/issues/1269\n\nThe \"proper\" solution would be a cython indicator that the first use site actually is an initialization. A little less precise, but perhaps a little easier to implement in cython: some indicator in the declaration that marks the variable as \"don't check initialization-before-reference\"; probably implemented as \"treat this as initialized\" (without generating actual initialization code).\n\nUnless the cython issue is resolved satisfactorily, these examples show the application of a feature like that, and the cython folk may well be willing to implement it.",
    "created_at": "2022-01-17T21:45:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662362",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:2'></a>Normally, one does not write sub-optimal code just to satisfy a compiler. There had better be a very convincing reason! In this case I am even less convinced that a fix on our side is required, since there is an issue open in cython pertaining this: https://github.com/cython/cython/issues/1269
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662363",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I would expect this initialization to get eliminated during compilation: The `F.init()` calls should get inlined, so the compiler can see that the value gets written to again immediately after (without ever being read from), which means the assignment can be omitted.\n\nI don't think this has to do with zero pages (the compiler can't assume much about what happened to the stack before we got called).",
    "created_at": "2022-01-19T02:54:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662365",
    "user": "https://github.com/yyyyx4"
}
```

<a id='comment:5'></a>I would expect this initialization to get eliminated during compilation: The `F.init()` calls should get inlined, so the compiler can see that the value gets written to again immediately after (without ever being read from), which means the assignment can be omitted.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662366",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>(And the `init` method is marked \"inline\", so this should happen reliably.)",
    "created_at": "2022-01-19T16:15:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33201#issuecomment-662367",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:7'></a>(And the `init` method is marked "inline", so this should happen reliably.)
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33201#event-87707"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33201#event-87708"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33201#event-87709"
}
```
