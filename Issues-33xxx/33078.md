...
<a id='comment:21'></a>Replying to [gh-darijgr](#comment%3A20):
>  There is no `python39-devel-3.9.9-3` on the cygwin package list.
...
```json
{
    "body": "<a id='comment:36'></a>Replying to [gh-darijgr](#comment%3A34):\n> I assume I don't need to go back to the old version, seeing that it has worked?\n\n\nI agree",
...
<a id='comment:36'></a>Replying to [gh-darijgr](#comment%3A34):
> I assume I don't need to go back to the old version, seeing that it has worked?
