...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33060#issuecomment-536753",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33060#issuecomment-536754",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-436599"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-436600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-436601"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33060",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-436602"
}
```
