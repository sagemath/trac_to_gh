...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457083"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457084"
}
```
...
archive/issue_events_457085.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2021-12-21T16:18:20Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457085"
}
```
...
archive/issue_events_457086.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2021-12-21T16:18:20Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457086"
}
```
...
archive/issue_events_457087.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2021-12-21T16:26:42Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457087"
}
```
...
archive/issue_events_457088.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457088"
}
```
...
archive/issue_events_457089.json:
```json
{
    "actor": "https://github.com/orlitzky",
    "created_at": "2021-12-21T17:25:29Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457089"
}
```
...
archive/issue_events_457090.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2021-12-23T00:22:08Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457090"
}
```
...
archive/issue_events_457091.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2021-12-23T00:22:08Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457091"
}
```
...
archive/issue_events_457092.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457092"
}
```
...
archive/issue_events_457093.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/33060",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33060#event-457093"
}
```
