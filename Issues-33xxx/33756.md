...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33756#issuecomment-548814",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33756#issuecomment-548815",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33756#event-444910"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33756#event-444911"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33756#event-444912"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33756#event-444913"
}
```
