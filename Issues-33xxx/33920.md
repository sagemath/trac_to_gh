...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33920#event-446695"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33920#event-446696"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33920#event-446697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33920#event-446698"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33920#issuecomment-551579",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33920#issuecomment-551580",
    "user": "https://github.com/mkoeppe"
}
```
