...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33084#event-87416"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>is the date correctly set?\ncould you try again?",
    "created_at": "2022-01-14T16:31:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33084#issuecomment-467758",
    "user": "https://github.com/dkwo"
}
```

<a id='comment:2'></a>is the date correctly set?
could you try again?
...
```json
{
    "body": "<a id='comment:4'></a>https://hub.docker.com/r/voidlinux/masterdir-x86_64-musl/tags does not seem to be updated lately",
    "created_at": "2022-01-14T17:05:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33084#issuecomment-467759",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>https://hub.docker.com/r/voidlinux/masterdir-x86_64-musl/tags does not seem to be updated lately
...
```json
{
    "body": "<a id='comment:5'></a>I was recommended to use ghcr instead, see https://github.com/void-linux/void-docker\nCould you try with ghcr.io/void-linux/void-linux (20210220rc01-full-x86_64-musl) instead?",
    "created_at": "2022-01-15T15:49:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33084#issuecomment-467760",
    "user": "https://github.com/dkwo"
}
```

<a id='comment:5'></a>I was recommended to use ghcr instead, see https://github.com/void-linux/void-docker
Could you try with ghcr.io/void-linux/void-linux (20210220rc01-full-x86_64-musl) instead?
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33084#event-87417"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33084#event-87418"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33084#event-87419"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33084#event-87420"
}
```
