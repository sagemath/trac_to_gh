...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463771"
}
```
...
archive/issue_events_463772.json:
```json
{
    "actor": "https://github.com/collares",
    "created_at": "2022-05-05T12:11:10Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463772"
}
```
...
archive/issue_events_463773.json:
```json
{
    "actor": "https://github.com/collares",
    "created_at": "2022-05-05T12:11:10Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33806#issuecomment-546556",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33806#issuecomment-546557",
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463776"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-463777"
}
```
