...
<a id='comment:4'></a>I don't know if it is a good idea to remove the compile time dependency on `sage.matrix.matrix_integer_dense`. I'm curious about the penalty of doing this. E.g. it would be nice to somewhat keep benchmarks for the following steps:
...
```json
{
    "body": "<a id='comment:5'></a>Thanks for the benchmarks! Of course I agree performance is important.",
...
<a id='comment:5'></a>Thanks for the benchmarks! Of course I agree performance is important.
...
```json
{
    "body": "<a id='comment:8'></a>Not sure what to do about caching when `immutable=False` is given\n\n---\nLast 10 new commits:",
    "created_at": "2022-02-22T01:37:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33385",
    "type": "issue_comment",
...
<a id='comment:8'></a>Not sure what to do about caching when `immutable=False` is given
