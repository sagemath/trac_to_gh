...
```json
{
    "body": "<a id='comment:1'></a>Note that this was built on a Core2 Duo CPU (the goal is to have SDL run on old machines with fewer CPU flags).",
    "created_at": "2022-05-28T20:40:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676646",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:1'></a>Note that this was built on a Core2 Duo CPU (the goal is to have SDL run on old machines with fewer CPU flags).
...
```json
{
    "body": "<a id='comment:2'></a>dup of #30635, I guess",
    "created_at": "2022-05-28T21:26:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676647",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>dup of #30635, I guess
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676648",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>There were multiple things wrong. Meta-ticket #32191 has a large number tickets that fixed how various Sage code was using the numerical results from solvers.\n\nIn addition, it appears that sage-numerical-backend-coin is not compatible with the CBC 2.10 series. I haven't had the time to look into this issue.\n\nAs the way forward I want to use #31962, which makes sage-numerical-backend-coin obsolete.",
    "created_at": "2022-05-31T02:48:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676649",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>There were multiple things wrong. Meta-ticket #32191 has a large number tickets that fixed how various Sage code was using the numerical results from solvers.
...
```json
{
    "body": "<a id='comment:5'></a>In the meantime, you can use `--without-system-cbc`. Our spkg is still using CBC 2.9.x, as the update ticket #30644 has stalled",
    "created_at": "2022-05-31T02:58:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676650",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>In the meantime, you can use `--without-system-cbc`. Our spkg is still using CBC 2.9.x, as the update ticket #30644 has stalled
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676651",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676652",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>#34251 solves this, needs review",
    "created_at": "2022-08-06T18:38:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33929",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33929#issuecomment-676653",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>#34251 solves this, needs review
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33929#event-88935"
}
```
