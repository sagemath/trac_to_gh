...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439677"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439678"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33303#issuecomment-541284",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33303#issuecomment-541285",
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439682"
}
```
...
archive/issue_events_439683.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-02-11T12:46:09Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439683"
}
```
...
archive/issue_events_439684.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-02-11T12:46:09Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439684"
}
```
...
archive/issue_events_439685.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-02-11T17:30:44Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439685"
}
```
...
archive/issue_events_439686.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-02-11T17:30:44Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439686"
}
```
...
archive/issue_events_439687.json:
```json
{
    "actor": "https://github.com/fchapoton",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439687"
}
```
...
archive/issue_events_439688.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-02-11T19:02:55Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/33303",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-439688"
}
```
