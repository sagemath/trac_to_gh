...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460184"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460186"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460187"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460192"
}
```
...
archive/issue_events_460193.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-02-11T17:30:44Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460193"
}
```
...
archive/issue_events_460194.json:
```json
{
    "actor": "https://github.com/fchapoton",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460194"
}
```
...
archive/issue_events_460195.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-02-11T19:02:55Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/33303",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33303#event-460195"
}
```
