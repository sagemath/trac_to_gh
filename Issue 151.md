...
```json
{
    "body": "I wrote a \"sage-cleaner\" daemon, which I *think* totally deals with this problem and more very nicely (and gets rid of the need for the monitor process).  I have tested it extensively on OS X and it works perfectly.   Only further testing will tell for sure, but for now (and for SAGE-1.8) this bug is closed.",
    "created_at": "2007-01-22T21:37:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/151",
    "type": "issue_comment",
