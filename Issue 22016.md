...
```json
{
    "body": "Attachment [example.canvas3d](tarball://root/attachments/some-uuid/ticket22253/example.canvas3d) by chapoton created at 2017-01-28 10:10:03\n\nI have attached the modified example file. What now ?",
...
Attachment [example.canvas3d](tarball://root/attachments/some-uuid/ticket22253/example.canvas3d) by chapoton created at 2017-01-28 10:10:03
