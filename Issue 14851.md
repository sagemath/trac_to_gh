...
```json
{
    "body": "Attachment [trac_15088_valuation_zero_laurent_series.patch](tarball://root/attachments/some-uuid/ticket15088/trac_15088_valuation_zero_laurent_series.patch) by caruso created at 2013-08-28 08:33:05\n\nOk. I was thinking that `a.valuation() == Infinity` implies `y_offset == 0` but I'm also not completely sure. So let's do as you propose.",
...
Attachment [trac_15088_valuation_zero_laurent_series.patch](tarball://root/attachments/some-uuid/ticket15088/trac_15088_valuation_zero_laurent_series.patch) by caruso created at 2013-08-28 08:33:05
