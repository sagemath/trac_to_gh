# Issue 29773: Split sage_setup.docbuild out to a separate distribution sage_docbuild
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29773#event-77120"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29773#event-77121"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29773#event-77122"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29773#event-77123"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29773#event-77124"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29773",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29773#event-77125"
}
```
