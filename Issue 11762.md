...
```json
{
    "body": "Attachment [simplify_error.sage](tarball://root/attachments/some-uuid/ticket11934/simplify_error.sage) by mjo created at 2011-10-17 19:19:29\n\nA sage file that displays and attempts to plot the simplification",
...
Attachment [simplify_error.sage](tarball://root/attachments/some-uuid/ticket11934/simplify_error.sage) by mjo created at 2011-10-17 19:19:29
...
```json
{
    "body": "Attachment [sage-trac_11934.patch](tarball://root/attachments/some-uuid/ticket11934/sage-trac_11934.patch) by mjo created at 2013-08-17 01:42:06\n\nDoctest for a subexpression of the one in the ticket",
...
Attachment [sage-trac_11934.patch](tarball://root/attachments/some-uuid/ticket11934/sage-trac_11934.patch) by mjo created at 2013-08-17 01:42:06
