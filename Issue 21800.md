...
```
CC:  simonking hivert slelievre charpent
...
```json
{
    "body": "Attachment [example.tar.gz](tarball://root/attachments/some-uuid/ticket22037/example.tar.gz) by thansen created at 2016-12-08 23:22:59\n\nThis is a small example showing how the ClasscallMetaclass leads to the error.",
...
Attachment [example.tar.gz](tarball://root/attachments/some-uuid/ticket22037/example.tar.gz) by thansen created at 2016-12-08 23:22:59
...
Attachment [python2-2.7.13.p0.log.gz](tarball://root/attachments/some-uuid/ticket22037/python2-2.7.13.p0.log.gz) by charpent created at 2017-01-04 18:57:19
...
```json
{
    "body": "Attachment [ptestlong.log.gz](tarball://root/attachments/some-uuid/ticket22037/ptestlong.log.gz) by charpent created at 2017-01-04 21:49:13\n\nresult of make ptestlong, first attempt on 2.7.13",
...
Attachment [ptestlong.log.gz](tarball://root/attachments/some-uuid/ticket22037/ptestlong.log.gz) by charpent created at 2017-01-04 21:49:13
