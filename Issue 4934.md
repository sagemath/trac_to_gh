# Issue 4934: [with patch; positive review] matrix1.pyx reference related doctest crash on cicero
...
```json
{
    ...
    "title": "[with patch; positive review] matrix1.pyx reference related doctest crash on cicero",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4934",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4934#event-11371"
}
```
