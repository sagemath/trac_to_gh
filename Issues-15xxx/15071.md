...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237456",
    "user": "https://github.com/eviatarbach"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237457",
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [trac15071_2.patch](tarball://root/attachments/some-uuid/ticket15071/trac15071_2.patch) by @eviatarbach created at 2013-08-31 17:59:39\n\nActually I meant all the changes to `hyperbolic.py` could be reverted (now #15134), but not the one to `expression.pyx`. New patch removes everything not necessary for passing doctests.\n\nNote that I changed the `cot` tests to `coth` since `cot` wasn't actually testing the function, because it doesn't use `_eval_default`.\n\nPatchbot apply trac15071_2.patch\u200b",
    "created_at": "2013-08-31T17:59:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237459",
    "user": "https://github.com/eviatarbach"
}
```

<a id='comment:5'></a>Attachment [trac15071_2.patch](tarball://root/attachments/some-uuid/ticket15071/trac15071_2.patch) by @eviatarbach created at 2013-08-31 17:59:39
...
```json
{
    "body": "<a id='comment:7'></a>Thank you! Here's a version with more tests.",
    "created_at": "2013-09-01T19:42:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237461",
    "user": "https://github.com/eviatarbach"
}
```

<a id='comment:7'></a>Thank you! Here's a version with more tests.
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac15071_3.patch](tarball://root/attachments/some-uuid/ticket15071/trac15071_3.patch) by @eviatarbach created at 2013-09-01 19:53:45\n\nApparently excepting the `AttributeError` fixes other issues; see http://ask.sagemath.org/question/2957/strange-attributeerror. I would add a test for that but I guess it's not within the scope of the patch; maybe I'll just create a new ticket and mark it as fixed by this one.",
    "created_at": "2013-09-01T19:53:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237462",
    "user": "https://github.com/eviatarbach"
}
```

<a id='comment:8'></a>Attachment [trac15071_3.patch](tarball://root/attachments/some-uuid/ticket15071/trac15071_3.patch) by @eviatarbach created at 2013-09-01 19:53:45
...
```json
{
    "body": "<a id='comment:9'></a>It looks like now, only the second branch (the else) is being tested. Can we add the original test you had as well as the new one?\n\nAbout the `AttributeError` issue, what you propose sounds reasonable to me, but it excludes the possibility of getting a test in the codebase (since the other ticket wouldn't get to include a patch). Since excepting the error is done here I think it's probably okay to include a test as an \"aside\". What do you think?",
    "created_at": "2013-09-07T17:50:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237463",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:9'></a>It looks like now, only the second branch (the else) is being tested. Can we add the original test you had as well as the new one?
...
```json
{
    "body": "<a id='comment:10'></a>Sounds good! New patch makes the suggested changes.",
    "created_at": "2013-09-10T02:09:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237464",
    "user": "https://github.com/eviatarbach"
}
```

<a id='comment:10'></a>Sounds good! New patch makes the suggested changes.
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [trac15071_4.patch](tarball://root/attachments/some-uuid/ticket15071/trac15071_4.patch) by @benjaminfjones created at 2013-09-10 05:54:55\n\nLooks great. After tests come back positive from the bot, I'll give this a positive review.\n\n---\n\npatchbot, apply trac15071_4.patch",
    "created_at": "2013-09-10T05:54:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237465",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:11'></a>Attachment [trac15071_4.patch](tarball://root/attachments/some-uuid/ticket15071/trac15071_4.patch) by @benjaminfjones created at 2013-09-10 05:54:55
...
```json
{
    "body": "<a id='comment:12'></a>Old patchbot seems to be on vacation. I'll do the testing myself..",
    "created_at": "2013-09-10T20:41:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237466",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:12'></a>Old patchbot seems to be on vacation. I'll do the testing myself..
...
```json
{
    "body": "<a id='comment:13'></a>All tests pass! Positive review.",
    "created_at": "2013-09-10T22:25:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237467",
    "user": "https://github.com/benjaminfjones"
}
```

<a id='comment:13'></a>All tests pass! Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237468",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237469",
    "user": "https://github.com/benjaminfjones"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Thank you so much for reviewing! Now functions that are doing this manually can be transitioned.",
    "created_at": "2013-09-11T01:42:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237470",
    "user": "https://github.com/eviatarbach"
}
```

<a id='comment:14'></a>Thank you so much for reviewing! Now functions that are doing this manually can be transitioned.
...
```json
{
    ...
    "milestone": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15071#event-43353"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Please add your real names as Author and Reviewer.",
    "created_at": "2013-09-26T15:44:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237471",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>Please add your real names as Author and Reviewer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237472",
    "user": "https://github.com/eviatarbach"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Benjamin F. Jones\"",
    "created_at": "2013-09-26T16:25:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237473",
    "user": "https://github.com/eviatarbach"
}
```

Changing reviewer from "" to "Benjamin F. Jones"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237474",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237475",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15071#event-43354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15071#issuecomment-237476",
    "user": "https://github.com/jdemeyer"
}
```
