...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15788#event-46436"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15788#event-46437"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15788#event-46438"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/msaaltink/dense_polynomials_over_z_nz___with_n_composite_and_using_ntl__failed_to_execute_inverse_mod\"",
    "created_at": "2017-02-26T20:17:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254564",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```

Changing branch from "" to "u/msaaltink/dense_polynomials_over_z_nz___with_n_composite_and_using_ntl__failed_to_execute_inverse_mod"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254565",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"87499b24aa4694f1425ba1ee3f1af8a3b791c636\"",
    "created_at": "2017-02-26T20:20:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254566",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```

Changing commit from "" to "87499b24aa4694f1425ba1ee3f1af8a3b791c636"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254567",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254568",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>ntl has its own implementation of invmod, so we use should use that, note also that ntl allows to use xgcd ever for composite n.\n\n```\nsage: from sage.libs.ntl.ntl_ZZ_pX import ntl_ZZ_pContext, ntl_ZZ_pX\nsage: c = ntl_ZZ_pContext(42)\nsage: f = ntl_ZZ_pX([1, 0, 1],c)\nsage: g = ntl_ZZ_pX([0, 0, 1],c)\nsage: f.xgcd(g)\n([1], [1], [41])\n```\n\nthere is also invmod but it seems that does not work right now in my computer...",
    "created_at": "2018-06-30T17:16:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254569",
    "user": "https://github.com/lftabera"
}
```

<a id='comment:6'></a>ntl has its own implementation of invmod, so we use should use that, note also that ntl allows to use xgcd ever for composite n.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15788#event-46439"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15788#event-46440"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254570",
    "user": "https://github.com/lftabera"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15788#event-46441"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15788#event-46442"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>update milestone 8.3 -> 8.4",
    "created_at": "2018-08-03T19:20:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15788#issuecomment-254571",
    "user": "https://github.com/videlec"
}
```

<a id='comment:8'></a>update milestone 8.3 -> 8.4
