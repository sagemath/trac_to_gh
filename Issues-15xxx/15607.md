...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|\n|[4cd8ed3](http://git.sagemath.org/sage.git/commit/?id=4cd8ed3ddf216c60b7bbca7820df3bfb1f36cfb7)|`fixed checksums`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[8ecf61c](http://git.sagemath.org/sage.git/commit/?id=8ecf61c3a31e1de77b95cecdf6a0206d5760cd86)|`trac 15607: fixed checksums again`|",
