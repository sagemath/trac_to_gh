...
```json
{
    "body": "<a id='comment:1'></a>As reported in #15397 these errors are reproducible on the [website](http://www.mathe2.uni-bayreuth.de/cgi-bin/axel/gensym.exe?outerproduct_schur?2?1?PARTITION?PARTITION) for symmetrica.",
    "created_at": "2013-11-13T03:21:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15407#issuecomment-245396",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:1'></a>As reported in #15397 these errors are reproducible on the [website](http://www.mathe2.uni-bayreuth.de/cgi-bin/axel/gensym.exe?outerproduct_schur?2?1?PARTITION?PARTITION) for symmetrica.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15407#issuecomment-245397",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44811"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44812"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44813"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44814"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44815"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44816"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15407#issuecomment-245398",
...
```json
{
    "body": "<a id='comment:5'></a>This is an upstream bug that no longer affects Sage (since lrcalc is now used):\n\nhttps://gitlab.com/sagemath/symmetrica/issues/11\n\nAs a result, I think we can close this here. If someone knows how to fix the bug in symmetrica, please send a pull request.",
    "created_at": "2020-01-21T16:10:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15407#issuecomment-245399",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:5'></a>This is an upstream bug that no longer affects Sage (since lrcalc is now used):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15407#issuecomment-245400",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15407",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15407#event-44818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15407",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15407#issuecomment-245401",
