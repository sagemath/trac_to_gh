...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239214",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239215",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239216",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239217",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I've pushed a small patch and would be grateful for any comments. Thank you!",
    "created_at": "2013-09-04T08:11:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239218",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```

<a id='comment:3'></a>I've pushed a small patch and would be grateful for any comments. Thank you!
...
```json
{
    "body": "<a id='comment:4'></a>I think thats not good enough, sometimes we set the `_embedding_morphism` attribute directly. This would then change the already-cached class. The proper way would be a derived class for toric variety with embedding, and then make those unique.",
    "created_at": "2013-09-04T09:50:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239219",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>I think thats not good enough, sometimes we set the `_embedding_morphism` attribute directly. This would then change the already-cached class. The proper way would be a derived class for toric variety with embedding, and then make those unique.
...
```json
{
    "body": "<a id='comment:5'></a>We definitely want to have isomorphic varieties with different embedding and varieties probably have to be unique as well. Should then `embedding_morphism` become a part of the constructor (with default value `None`) and setting it generate a new instance? I am not sure if a derived class will simplify the situation here.",
    "created_at": "2013-09-04T19:34:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239220",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:5'></a>We definitely want to have isomorphic varieties with different embedding and varieties probably have to be unique as well. Should then `embedding_morphism` become a part of the constructor (with default value `None`) and setting it generate a new instance? I am not sure if a derived class will simplify the situation here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239221",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239222",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>To always compare embeddings varieties without embedding should be aware of there existence, in which case it really seems to me that they are of the same class, but with different values of attributes.\n\nAdjusting `_repr_` is a great idea!",
    "created_at": "2013-09-04T21:41:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239226",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:10'></a>To always compare embeddings varieties without embedding should be aware of there existence, in which case it really seems to me that they are of the same class, but with different values of attributes.
...
```json
{
    "body": "<a id='comment:13'></a>That actually sounds very nice. Having two separate classes may really be the cleanest option. I think one would have to have to `compare` methods for ToricVariety anyway because of the following scenario:\n\nLet f_i be the embedding of A_i into B_i. When comparing f_1 to f_2 the `SchemeMorphism_something.__cmp__` method must use the old `ToricVariety_field.__cmp__` method to avoid falling into an infinite loop.\n\nUnless there are objections, I think I'll try and implement something along these lines and push it here once there is some progress. \n\nThanks for all the help so far!",
    "created_at": "2013-09-05T11:49:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239229",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```

<a id='comment:13'></a>That actually sounds very nice. Having two separate classes may really be the cleanest option. I think one would have to have to `compare` methods for ToricVariety anyway because of the following scenario:
...
```json
{
    "body": "<a id='comment:16'></a>OK, hard to argue ;-) Although new classes probably have to include docstrings with doctests.",
    "created_at": "2013-09-05T15:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239232",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:16'></a>OK, hard to argue ;-) Although new classes probably have to include docstrings with doctests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239233",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239234",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239236",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239237",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239238",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239239",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239240",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239241",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I am confused by this branch (which is very likely to be my problem) - I try to look at changes since the last Voker's commit and the very last one, but there is a lot of changes to makefile and other general stuff. If I try to start with the next commit, it seems that some embedding-related changes were already done before. So - how do I look at changes related to this ticket only?",
    "created_at": "2013-09-28T17:43:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239242",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:21'></a>I am confused by this branch (which is very likely to be my problem) - I try to look at changes since the last Voker's commit and the very last one, but there is a lot of changes to makefile and other general stuff. If I try to start with the next commit, it seems that some embedding-related changes were already done before. So - how do I look at changes related to this ticket only?
...
```json
{
    "body": "<a id='comment:22'></a>This is very likely due to my poor handling of git. I wanted to carry over code from the previous patch for the comparison method, but I had already merged an update from the master branch into that. When I therefore merged the comparison method code into Volker's fibrations, it included the changes unrelated to my patch.\nIn the future, I won't do that anymore, but in the mean time you'll probably just have to ignore the changes to the makefile. Sorry about that!",
    "created_at": "2013-09-28T17:49:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239243",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```

<a id='comment:22'></a>This is very likely due to my poor handling of git. I wanted to carry over code from the previous patch for the comparison method, but I had already merged an update from the master branch into that. When I therefore merged the comparison method code into Volker's fibrations, it included the changes unrelated to my patch.
In the future, I won't do that anymore, but in the mean time you'll probably just have to ignore the changes to the makefile. Sorry about that!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239244",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239245",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Okay, I think this should now work with all the changes Andrey made while reviewing #12892.",
    "created_at": "2013-09-29T13:27:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239246",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```

<a id='comment:24'></a>Okay, I think this should now work with all the changes Andrey made while reviewing #12892.
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15153#event-43668"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15153#event-43669"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15153#event-43670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239247",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239248",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Does not merge cleanly. Please rebase.",
    "created_at": "2014-04-14T09:12:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239249",
    "user": "https://github.com/rwst"
}
```

<a id='comment:27'></a>Does not merge cleanly. Please rebase.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239250",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239251",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239252",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239253",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239254",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239255",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239256",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>I have rebased the patch against 6.2.rc2 and added the remaining doctests. All doctests pass for me and the documentation builds.",
    "created_at": "2014-05-06T14:52:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239257",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```

<a id='comment:31'></a>I have rebased the patch against 6.2.rc2 and added the remaining doctests. All doctests pass for me and the documentation builds.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239258",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15153#event-43671"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15153#event-43672"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>patchbot:\n\n```\nsage -t --long src/sage/schemes/generic/algebraic_scheme.py  # 10 doctests failed\n```",
    "created_at": "2014-05-13T06:09:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239259",
    "user": "https://github.com/rwst"
}
```

<a id='comment:33'></a>patchbot:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239260",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239261",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239262",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239263",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>There are some docstrings with no input/output, which is fine since there is a reference to another docstring, but there are also no examples. Shouldn't they be added so that e.g. `TestSuite` is applied to resulting classes?",
    "created_at": "2014-05-13T18:16:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239265",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:36'></a>There are some docstrings with no input/output, which is fine since there is a reference to another docstring, but there are also no examples. Shouldn't they be added so that e.g. `TestSuite` is applied to resulting classes?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239267",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15153#issuecomment-239268",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15153#event-43673"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15153#event-43674"
}
```
