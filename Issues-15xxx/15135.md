...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15135#event-132816"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_15135_open_your_brower_message_unicode.patch](https://github.com/sagemath/sage/files/ticket15135/trac_15135_open_your_brower_message_unicode.patch) by @fchapoton created at 2013-09-21 16:11:11\n\nI think it is better to close this ticket, as it deals only with obsolete code, which should be removed sooner or later.\n\nI have proposed the main change directly to sagenb, where it belongs.",
    "created_at": "2013-09-21T16:11:11Z",
    "issue": "https://github.com/sagemath/sage/issues/15135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15135#issuecomment-188490",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15135#event-132817"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15135#event-132818"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15135#event-132819"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15135#issuecomment-188491",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15135#issuecomment-188492",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15135#event-132820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15135",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15135#event-132821"
}
```
