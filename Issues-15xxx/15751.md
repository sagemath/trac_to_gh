...
```json
{
    "body": "<a id='comment:1'></a>Not a major thing since it is a rare event to me, but it is still an annoying error message and it kills my for loop.",
    "created_at": "2014-01-28T16:41:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15751#issuecomment-200144",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>Not a major thing since it is a rare event to me, but it is still an annoying error message and it kills my for loop.
...
```json
{
    "body": "<a id='comment:2'></a>I guess we should disable the idle loop callback while we are in a IPython stateful block...",
    "created_at": "2014-01-28T16:48:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15751#issuecomment-200145",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>I guess we should disable the idle loop callback while we are in a IPython stateful block...
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15751#event-46297"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15751#event-46298"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15751#event-46299"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15751#event-46300"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15751#event-46301"
}
```
