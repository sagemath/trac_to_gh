...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                             |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[e23ec99](http://git.sagemath.org/sage.git/commit/?id=e23ec99)|Merge branch 'ticket/15432' into ticket/15506|\n|[4ac6866](http://git.sagemath.org/sage.git/commit/?id=4ac6866)|trac #15432: Code context manager in iterator via try/finally. This saves an entire class and some reference management.Z|\n|[8b70d1d](http://git.sagemath.org/sage.git/commit/?id=8b70d1d)|trac #15432: also equip iteration context with a weak reference|\n|[9bb9241](http://git.sagemath.org/sage.git/commit/?id=9bb9241)|trac #15432: use a callback class object holding a weak reference for sage.misc.weak_dict.WeakValueDictionary|",
    "created_at": "2013-12-10T08:21:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15506",
    "type": "issue_comment",
