...
```json
{
    "body": "<a id='comment:3'></a>Make your own tarball for \"upstream sources\". You are upstream for any code that is not available anywhere else or for forks that you are maintaining. Publish the tarball, ideally tracking its contents in one of your own repositories. \n\nPS: it goes without saying, but it would be nice if your meataxe fork were to not conflict with the new meataxe.",
    "created_at": "2014-01-14T03:54:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251836",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Make your own tarball for "upstream sources". You are upstream for any code that is not available anywhere else or for forks that you are maintaining. Publish the tarball, ideally tracking its contents in one of your own repositories. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251837",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251839",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251840",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15666#event-45942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251841",
...
```json
{
    "body": "<a id='comment:7'></a>I have different things on my plate at the moment, so that I would like to postpone the switch to the new spkg layout. So, from my perspective, making it work again has priority. All tests should pass on both pre and post git-switch Sage.\n\nSo, if you don't mind, I think one can review it, but of course I should document the switch from v2.1.4 to v2.1.4.p1 in SPKG.txt.",
    "created_at": "2014-02-02T16:05:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251842",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>I have different things on my plate at the moment, so that I would like to postpone the switch to the new spkg layout. So, from my perspective, making it work again has priority. All tests should pass on both pre and post git-switch Sage.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251843",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [SimonKing](#comment%3A4):\n> - Transition to git. Here I'd really need some guidance how to \"track its contents in my own repository\": How to set up a repository at university of Washington (I think there is the \"official\" home of the package: public documentation, download site and database), so that people can pull from it? How to set it up such that I can push to it from Jena?\n\n\nWhy don't you put it on github (or bitbucket - you can host git repos there too) ? \nThis is really easy...",
    "created_at": "2014-02-02T21:43:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251844",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:8'></a>Replying to [SimonKing](#comment%3A4):
> - Transition to git. Here I'd really need some guidance how to "track its contents in my own repository": How to set up a repository at university of Washington (I think there is the "official" home of the package: public documentation, download site and database), so that people can pull from it? How to set it up such that I can push to it from Jena?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251845",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251846",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Harald, can you mirror this? whats the process for old-style spkgs, just manually put in the right folder on boxen?",
    "created_at": "2014-02-09T01:48:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251847",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>Harald, can you mirror this? whats the process for old-style spkgs, just manually put in the right folder on boxen?
...
```json
{
    "body": "<a id='comment:10'></a>ok, spkg is mirrored",
    "created_at": "2014-02-09T11:01:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251848",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:10'></a>ok, spkg is mirrored
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15666#event-45943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15666",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15666#issuecomment-251849",
    "user": "https://github.com/vbraun"
}
```
