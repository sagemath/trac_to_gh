...
```json
{
    "body": "<a id='comment:6'></a>My changes fromticket: ticket:16014#comment:2#comment:16014 make `P.discriminant()` work.",
...
<a id='comment:6'></a>My changes fromticket: ticket:16014#comment:2#comment:16014 make `P.discriminant()` work.
...
<a id='comment:7'></a>Replying to [pbruin](#comment%3A4):
> It would be good to have another example that still fails after applying #15601.
...
<a id='comment:17'></a>Replying to [gagern](#comment%3A16):
> All tests in `src/sage/rings` passed here. And the code still looks sane at second glance. Am I qualified to give this a positive review?
