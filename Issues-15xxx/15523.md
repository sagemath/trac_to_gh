...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                |\n|---------------------------------------------------------------------------------------------------------|----------------|\n|[3c26444](http://git.sagemath.org/sage.git/commit/?id=3c26444)|Fix double colon|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                            |\n|---------------------------------------------------------------------------------------------------------|----------------------------|\n|[f0ecb06](http://git.sagemath.org/sage.git/commit/?id=f0ecb06)|Set gpd_TEST flag in GP_DATA|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                              |\n|---------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[96d3280](http://git.sagemath.org/sage.git/commit/?id=96d3280)|Changed precision arguments to \"unsigned long\"|",
    "created_at": "2013-12-17T14:57:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15523",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                               |\n|---------------------------------------------------------------------------------------------------------|-------------------------------|\n|[520f043](http://git.sagemath.org/sage.git/commit/?id=520f043)|Fix doctests on 32-bit machines|",
    "created_at": "2013-12-17T15:22:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15523",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                   |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[99450f4](http://git.sagemath.org/sage.git/commit/?id=99450f4)|`Mention that PARI supports conversion from tuples`|",
    "created_at": "2013-12-18T16:17:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15523",
    "type": "issue_comment",
