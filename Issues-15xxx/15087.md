...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189174",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>We probably want a `/etc/sage/env.d` directory instead of `/etc/env.d` if this would be installed to the fs root...",
    "created_at": "2013-12-05T20:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189175",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>We probably want a `/etc/sage/env.d` directory instead of `/etc/env.d` if this would be installed to the fs root...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189176",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189178",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189179",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189180",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189181",
...
```json
{
    "body": "<a id='comment:11'></a>Packages can now set environment variables by means of the `spkg-configure.m4` mechanism, and old-style (out-of-tree) packages have been eliminated. So this ticket can be closed as outdated.",
    "created_at": "2020-01-15T23:52:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189182",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:11'></a>Packages can now set environment variables by means of the `spkg-configure.m4` mechanism, and old-style (out-of-tree) packages have been eliminated. So this ticket can be closed as outdated.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189183",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15087#issuecomment-189184",
