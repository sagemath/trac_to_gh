...
```json
{
    "body": "<a id='comment:36'></a>Replying to [comment:32 slabbe]:\n> \n> - An easy one: for now `__mul__` is chosen for intersection. It should be `__and__`. Also `__add__` is chosen for union. It should be `__or__`.\n\nIn #16016 these names are changed.",
...
<a id='comment:36'></a>Replying to [comment:32 slabbe]:
> 
> - An easy one: for now `__mul__` is chosen for intersection. It should be `__and__`. Also `__add__` is chosen for union. It should be `__or__`.
...
<a id='comment:38'></a>Replying to [comment:32 slabbe]:
>  - The basics operations (union, concatenation, intersection, complement, Kleene star) on automaton are not implemented.
...
```json
{
    "body": "<a id='comment:39'></a>Replying to [comment:32 slabbe]:\n>  - The basics operations (union, concatenation, intersection, complement, Kleene star) on automaton are not implemented.\n\n\nconcatenation: #18965\ncomplement: #18966\nKleene star: #18964",
...
<a id='comment:39'></a>Replying to [comment:32 slabbe]:
>  - The basics operations (union, concatenation, intersection, complement, Kleene star) on automaton are not implemented.
