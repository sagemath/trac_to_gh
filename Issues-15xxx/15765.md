...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15765#event-207582"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15765#event-207583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15765#event-207584"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15765#event-207585"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15765#issuecomment-201154",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15765#issuecomment-201155",
    "user": "https://github.com/pjbruin"
}
```
