...
```json
{
    "body": "<a id='comment:1'></a>Could be a change in how Maxima does these.",
    "created_at": "2013-12-09T18:10:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15499#issuecomment-247447",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Could be a change in how Maxima does these.
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15499#event-45263"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15499#event-45264"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15499#event-45265"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15499#event-45266"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15499#event-45267"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15499#issuecomment-247449",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15499#issuecomment-247450",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```
