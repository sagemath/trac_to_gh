...
```json
{
    "body": "<a id='comment:1'></a>#15315 is a dup with more information, so perhaps this one should be closed?  Sorry :(",
...
<a id='comment:1'></a>#15315 is a dup with more information, so perhaps this one should be closed?  Sorry :(
...
```json
{
    "body": "<a id='comment:3'></a>Dupe, of the more general #15315",
    "created_at": "2013-10-22T02:01:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15314",
    "type": "issue_comment",
...
<a id='comment:3'></a>Dupe, of the more general #15315
