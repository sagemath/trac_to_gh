...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15776#event-46401"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15776#event-46402"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15776#event-46403"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15776#event-46404"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15776#event-46405"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>See https://ask.sagemath.org/question/62615/ for a related bug.",
    "created_at": "2022-05-26T10:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15776#issuecomment-200488",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:4'></a>See https://ask.sagemath.org/question/62615/ for a related bug.
