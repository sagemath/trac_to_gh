...
```json
{
    "body": "<a id='comment:2'></a>Would be nice to add a comment on what is tested and mention the ticket!",
...
<a id='comment:2'></a>Would be nice to add a comment on what is tested and mention the ticket!
...
```json
{
    "body": "<a id='comment:3'></a>I think its pretty clear what the doctests is for, even if there is no link to this ticket: We test the function on immutable input. Commenting the obvious is bad style.",
...
<a id='comment:3'></a>I think its pretty clear what the doctests is for, even if there is no link to this ticket: We test the function on immutable input. Commenting the obvious is bad style.
