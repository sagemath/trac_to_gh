...
```json
{
    "body": "<a id='comment:11'></a>\nHere's an attempt.\n\n---\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[eace780](http://git.sagemath.org/sage.git/commit/?id=eace780090b0bcc6445542589ab72c09ee6af4eb)|`Errors in docbuilding should raise an error.`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[e70986e](http://git.sagemath.org/sage.git/commit/?id=e70986ee307a64853b40f86f0139e7ad3aa5a285)|`When parallel docbuilding, terminate all workers if an error occurs.`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[7a0c4ba](http://git.sagemath.org/sage.git/commit/?id=7a0c4ba6bf7f52da7bf00973695bc13df7d78439)|`Fix whitespace errors.`|",
    "created_at": "2014-01-30T22:59:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15727",
    "type": "issue_comment",
