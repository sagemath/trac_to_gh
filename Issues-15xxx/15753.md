...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253732",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Made a first implementation by modifying the existing _is_isomorphic. It compiles and the doctests work. I will run a few tests before I put it up for review.\n\n---\nNew commits:",
    "created_at": "2014-01-28T20:54:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253733",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```

<a id='comment:2'></a>Made a first implementation by modifying the existing _is_isomorphic. It compiles and the doctests work. I will run a few tests before I put it up for review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253734",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253735",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253736",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15753#event-46304"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I'm happy with this implementation, so have a look.",
    "created_at": "2014-01-31T07:58:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253737",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```

<a id='comment:5'></a>I'm happy with this implementation, so have a look.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253738",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253740",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253741",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Thanks for catching that, Rohan. I changed the rank=0 case as you suggested and removed the separate handling of rank=1.",
    "created_at": "2014-04-04T06:58:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253742",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```

<a id='comment:8'></a>Thanks for catching that, Rohan. I changed the rank=0 case as you suggested and removed the separate handling of rank=1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253743",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15753#event-46305"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15753#event-46306"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15753#event-46307"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15753#event-46308"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Given that `BasisExchangeMatroid` and `BasisMatroid` both inherit from `Matroid`, there is no point in adding `cpdef _isomorphism(self, other)` in the `.pxd` files for those.\n\nAlso, what's the advantage of making `isomorphism()` (without underscore) a `cpdef` method as opposed to just `def`?",
    "created_at": "2014-10-17T14:03:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253744",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:12'></a>Given that `BasisExchangeMatroid` and `BasisMatroid` both inherit from `Matroid`, there is no point in adding `cpdef _isomorphism(self, other)` in the `.pxd` files for those.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253745",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253746",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>This is an old ticket. It'll probably build on the branch after you do a \"make distclean\" or something. Alternatively, you can merge the ticket with the current develop branch. The easiest way (as a reviewer) is to do\n\ngit trac try 15753\n\n(assuming you have the git-trac command installed correctly). For working on the ticket, I'd probably stay on this branch, or look into rebasing (I'm still not sure what the policy is, read up on it in the developer manual).",
    "created_at": "2015-05-05T15:43:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253748",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```

<a id='comment:16'></a>This is an old ticket. It'll probably build on the branch after you do a "make distclean" or something. Alternatively, you can merge the ticket with the current develop branch. The easiest way (as a reviewer) is to do
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253749",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253750",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Thanks, Stefan, for pointing out that I should rebase. Very happy that this problem is out of the way.\n\nI rebased, then made my final edits, and tried to push. Another merge was necessary before I could finally push. Hope it all worked out correctly.",
    "created_at": "2015-05-06T19:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253751",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```

<a id='comment:18'></a>Thanks, Stefan, for pointing out that I should rebase. Very happy that this problem is out of the way.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253752",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253754",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253755",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>This one's good to go!",
    "created_at": "2015-05-11T15:53:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253757",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```

<a id='comment:22'></a>This one's good to go!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253758",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253759",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15753#event-46309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253760",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15753#issuecomment-253761",
    "user": "https://github.com/vbraun"
}
```
