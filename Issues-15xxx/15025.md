...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43188"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43189"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43190"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43191"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43192"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Thanks for the pointers !",
    "created_at": "2015-01-30T15:05:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15025#issuecomment-236642",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:7'></a>Thanks for the pointers !
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15025#issuecomment-236643",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I think it's a duplicate of #17701 (ready for review). True?",
    "created_at": "2016-03-19T15:45:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15025#issuecomment-236644",
    "user": "https://github.com/rwst"
}
```

<a id='comment:8'></a>I think it's a duplicate of #17701 (ready for review). True?
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43193"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15025#issuecomment-236645",
...
```json
{
    "body": "<a id='comment:9'></a>outdated, closing",
    "created_at": "2021-12-04T12:39:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15025#issuecomment-236646",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:9'></a>outdated, closing
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15025#issuecomment-236647",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15025#issuecomment-236648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15025",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15025#event-43195"
}
```
