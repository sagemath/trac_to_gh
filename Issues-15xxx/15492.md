...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247333",
    "user": "https://trac.sagemath.org/admin/accounts/users/stassev"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247334",
    "user": "https://trac.sagemath.org/admin/accounts/users/stassev"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247337",
    "user": "https://trac.sagemath.org/admin/accounts/users/stassev"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247346",
    "user": "https://trac.sagemath.org/admin/accounts/users/stassev"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>-- Updating patch against sage 5.13. \n\n-- Removing left over unnecessary imports.",
    "created_at": "2013-12-17T15:36:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247347",
    "user": "https://trac.sagemath.org/admin/accounts/users/stassev"
}
```

<a id='comment:13'></a>-- Updating patch against sage 5.13. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247348",
    "user": "https://trac.sagemath.org/admin/accounts/users/stassev"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15492#event-45228"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15492#event-45229"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15492#event-45230"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/rws/implement_multidimensional_numerical_integration\"",
    "created_at": "2014-05-12T14:17:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247349",
    "user": "https://github.com/rwst"
}
```

Changing branch from "" to "u/rws/implement_multidimensional_numerical_integration"
...
```json
{
    "body": "<a id='comment:17'></a>I have made a branch so that people can work better with your code. It however depends on the existence of the cuba package, which isn't even optional at the moment. So this needs work in that both the package needs to be included in Sage (please open a separate ticket) and this code should fail gracefully if the package is not install. This is all detailed in the developer manual.\n\n---\nNew commits:",
    "created_at": "2014-05-12T14:23:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247350",
    "user": "https://github.com/rwst"
}
```

<a id='comment:17'></a>I have made a branch so that people can work better with your code. It however depends on the existence of the cuba package, which isn't even optional at the moment. So this needs work in that both the package needs to be included in Sage (please open a separate ticket) and this code should fail gracefully if the package is not install. This is all detailed in the developer manual.
...
```json
{
    "body": "Changing commit from \"\" to \"a9b78d7cf0c69cb67098a4882a42957e390906d3\"",
    "created_at": "2014-05-12T14:23:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247351",
    "user": "https://github.com/rwst"
}
```

Changing commit from "" to "a9b78d7cf0c69cb67098a4882a42957e390906d3"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15492#issuecomment-247352",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15492#event-45231"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15492#event-45232"
}
```
