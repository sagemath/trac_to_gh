...
```json
{
    ...
    "type": "issue",
    "updated_at": "2017-06-28T11:39:44Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187927"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187930"
}
```
...
```json
{
    "body": "**Attachment:** [cuba-3.2p0.spkg.gz](https://github.com/sagemath/sage/files/ticket15492/cuba-3.2p0.spkg.gz)\n\nupdated to install cuba.h",
...
```json
{
    "body": "**Attachment:** [trac_15492_multidim_numerical_integrator.patch.gz](https://github.com/sagemath/sage/files/ticket15492/trac_15492_multidim_numerical_integrator.patch.gz)\n\nupdating patch according to Volker Braun's comments",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187931"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187932"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187933"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187936"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187937"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-187938"
}
```
