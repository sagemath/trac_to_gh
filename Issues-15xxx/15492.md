...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15492#issuecomment-195703",
    "user": "https://github.com/sagetrac-stassev"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15492#issuecomment-195704",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-203324"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-203325"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-203326"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15492#event-203327"
}
```
