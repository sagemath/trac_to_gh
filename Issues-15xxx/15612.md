...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15612#issuecomment-250521",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15612#issuecomment-250522",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Oh, I didn't know of #11529. Looks like things are on a good way forward then, at least once the latest memory leak from #10963 is plugged.",
    "created_at": "2013-12-31T20:40:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15612#issuecomment-250524",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:6'></a>Oh, I didn't know of #11529. Looks like things are on a good way forward then, at least once the latest memory leak from #10963 is plugged.
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15612#event-45706"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15612#event-45707"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15612#event-45708"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15612#event-45709"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15612#event-45710"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15612#event-45711"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15612#event-45712"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>or should it be duplicate ?",
    "created_at": "2015-06-22T18:18:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15612#issuecomment-250525",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:10'></a>or should it be duplicate ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15612#issuecomment-250527",
