...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15923#issuecomment-204410",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15923#event-209821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15923#event-209822"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15923#issuecomment-204411",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15923#event-209823"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15923",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15923#event-209824"
}
```
