...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241875",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241876",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241877",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241878",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241879",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241880",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This sounds like a merge that went wrong, so +1 on the change. You might want to add a test if this impacts non crystalographic root systems (yes we want to progressively support them!!!).\n\nIn the long run, we would want something better than just trying and hoping for the best. We should be able to tell exactly when the dual should be defined or not.",
    "created_at": "2013-10-16T21:49:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241881",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:4'></a>This sounds like a merge that went wrong, so +1 on the change. You might want to add a test if this impacts non crystalographic root systems (yes we want to progressively support them!!!).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241882",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241883",
...
```json
{
    "body": "<a id='comment:7'></a>There is also this suspicious commit, which was never actually reverted.\n\n```\nchangeset:   13363:359efb582d39\nuser:        Mike Hansen <mhansen@gmail.com>\ndate:        Thu Nov 19 08:25:56 2009 -0800\nsummary:     this temporary patch to be taken down when root system and 5794 patches stabilize.\n```",
    "created_at": "2013-10-17T07:28:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241884",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>There is also this suspicious commit, which was never actually reverted.
...
```json
{
    "body": "<a id='comment:8'></a>More generally, the patches on Trac from #5794 are not the ones which were merged. I don't plan to further investigate this, but perhaps somebody should.",
    "created_at": "2013-10-17T07:32:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241885",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>More generally, the patches on Trac from #5794 are not the ones which were merged. I don't plan to further investigate this, but perhaps somebody should.
...
```json
{
    "body": "<a id='comment:9'></a>Is there a way to see the patches which were merged? This is spooky. Thanks for getting to the roots (oops) of this, Jeroen!",
    "created_at": "2013-10-17T17:37:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241886",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:9'></a>Is there a way to see the patches which were merged? This is spooky. Thanks for getting to the roots (oops) of this, Jeroen!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241887",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241888",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241889",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241890",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241891",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15279#event-44239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15279#issuecomment-241892",
    "user": "https://github.com/jdemeyer"
}
```
