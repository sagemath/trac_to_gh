...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250320",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250321",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45678"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Seems to be a problem about \"even\" powers:\n\n```\nsage: [(-1)^(i/77) for i in range(9)]\n[1, (-1)^(1/77), 1, (-1)^(3/77), 1, (-1)^(5/77), 1, (-1)^(1/11), 1]\n```",
    "created_at": "2014-03-07T21:22:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250322",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>Seems to be a problem about "even" powers:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250323",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45679"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45680"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45681"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45682"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250324",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250327",
...
```json
{
    "body": "<a id='comment:12'></a>Just to give some concrete motivations, in #16222 (and #17516) we need a rather small subsets of symbolic expressions that modelize (some) algebraic numbers. Namely:\n- no variable\n- rational coefficients\n- I\n- exp(2*I*pi*a), cos(2*pi*a), sin(2*pi*a) with a rational\n- rational powers\n- taking real and imaginary parts\n\nAn example of such expression is\n\n```\n((cos(pi/7) + (-1)^(1/3))^(2/3)).real()\n```\n\nDo you think this must be out of the symbolic ring?\n\nVincent",
    "created_at": "2015-04-08T09:10:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250328",
    "user": "https://github.com/videlec"
}
```

<a id='comment:12'></a>Just to give some concrete motivations, in #16222 (and #17516) we need a rather small subsets of symbolic expressions that modelize (some) algebraic numbers. Namely:
- no variable
- rational coefficients
- I
- exp(2*I*pi*a), cos(2*pi*a), sin(2*pi*a) with a rational
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250329",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250331",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250332",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Replying to [mmezzarobba](#comment%3A15):\n> Replying to [vdelecroix](#comment%3A14):\n> > Here is one problem with using the symbolic ring for constants:\n> > \n> > ```\n> > sage: 0.1 * cos(pi/13)\n> > 0.100000000000000*cos(1/13*pi)\n> > ```\n> > The answer should be a floating point real number!\n\n> \n> Yes, perhaps, I'm not sure. Perhaps it should be a symbolic expression wrapping a FP number. Or perhaps it should just stay unevaluated. For instance, if `0.1 * cos(pi/13)` evaluates to a FP number, what should  `0.1 * x * cos(pi/13)` do?\n\nBut that would be then a different case? Anyway, the non-symbolic issue is now #18697.",
    "created_at": "2015-06-14T07:08:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250333",
    "user": "https://github.com/rwst"
}
```

<a id='comment:17'></a>Replying to [mmezzarobba](#comment%3A15):
> Replying to [vdelecroix](#comment%3A14):
> > Here is one problem with using the symbolic ring for constants:
> > 
> > ```
...
```json
{
    "body": "<a id='comment:19'></a>The symbolic issue is https://github.com/pynac/pynac/issues/221. We can then fix the Cython code in the rational ring, as well.",
    "created_at": "2016-12-05T16:40:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250335",
    "user": "https://github.com/rwst"
}
```

<a id='comment:19'></a>The symbolic issue is https://github.com/pynac/pynac/issues/221. We can then fix the Cython code in the rational ring, as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250336",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250337",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250338",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250339",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250340",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Actually fixing this in `rational.pyx` fixes both instances.",
    "created_at": "2016-12-07T07:48:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250341",
    "user": "https://github.com/rwst"
}
```

<a id='comment:22'></a>Actually fixing this in `rational.pyx` fixes both instances.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45683"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45684"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250342",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250343",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250344",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250345",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>good enough. Thanks for the fix!",
    "created_at": "2016-12-12T14:06:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250346",
    "user": "https://github.com/videlec"
}
```

<a id='comment:25'></a>good enough. Thanks for the fix!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250347",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250348",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15605#event-45685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250350",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250351",
...
```json
{
    "body": "<a id='comment:28'></a>I disagree with the fix here. It seems to me that we really should catch more generally `(-a)^(even rational)` instead of only `(-1)^(even rational)`.",
    "created_at": "2018-10-05T15:26:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250352",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:28'></a>I disagree with the fix here. It seems to me that we really should catch more generally `(-a)^(even rational)` instead of only `(-1)^(even rational)`.
...
```json
{
    "body": "<a id='comment:29'></a>See #26414 for a follow-up.",
    "created_at": "2018-10-05T17:03:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15605#issuecomment-250353",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:29'></a>See #26414 for a follow-up.
