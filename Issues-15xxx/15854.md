...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15854#event-46646"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15854#event-46647"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15854#event-46648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15854#issuecomment-256326",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Could you please specify what output exactly to expect?",
    "created_at": "2015-06-14T06:38:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15854#issuecomment-256327",
    "user": "https://github.com/rwst"
}
```

<a id='comment:4'></a>Could you please specify what output exactly to expect?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15854#issuecomment-256328",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15854#issuecomment-256329",
