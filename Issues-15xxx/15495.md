...
```json
{
    "body": "<a id='comment:2'></a>\nI set this to \"needs review\" -- I mainly did this to test how I can make create a new ticket and implement a new feature with git. Anyway, there is still quite some code duplication between `flip_graph` and `is_pseudomanifold`, so it might be better to first make this nicer before finalizing this ticket.\n\n---\n**New commits:**\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/10ab84b\">10ab84b</a></td>added examples</tr><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/37a26e7\">37a26e7</a></td>still trying to understand how to use git</tr><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/3b129ca\">3b129ca</a></td>working on the flip graph</tr></table>\n",
    "created_at": "2013-12-09T09:38:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15495",
    "type": "issue_comment",
