...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15865#event-209041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15865#event-209042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15865#event-209043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15865#issuecomment-203355",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15865#issuecomment-203356",
    "user": "https://github.com/darijgr"
}
```
