...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15865#event-226543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15865#event-226544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15865#event-226545"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15865#issuecomment-200907",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15865#issuecomment-200908",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15865#issuecomment-200909",
    "user": "https://github.com/tscrim"
}
```
