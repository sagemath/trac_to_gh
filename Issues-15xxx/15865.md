...
```json
{
    "body": "<a id='comment:1'></a>There's the somewhat unclearly named `base()` method:\n\n```\nsage: g = FractionField(QQ['x'])\nsage: g.base()\nUnivariate Polynomial Ring in x over Rational Field\nsage: g.base_ring()\nRational Field\n```",
    "created_at": "2014-02-27T01:33:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15865#issuecomment-256569",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>There's the somewhat unclearly named `base()` method:
