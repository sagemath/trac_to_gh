...
```json
{
    "body": "Actually, I don't understand why you moved the two underscored methods; it doesn't look like the underscored methods in this class tend to cluster together...",
...
```json
{
    "body": "Ah! That makes sense, of course; sorry.",
...
```json
{
    "body": "Diff looks good to me now as well. Thanks for catching this, Mike!",
...
```json
{
    "body": "I'm happy with your edits if you want to set to a positive review.  Thanks Franco and Darij. -Mike",
