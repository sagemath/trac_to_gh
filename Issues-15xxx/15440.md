...
```json
{
    "body": "Example strace collected from eno: http://boxen.math.washington.edu/home/vbraun/testing/",
...
```json
{
    "body": "Attachment [strace.5422](tarball://root/attachments/some-uuid/ticket15440/strace.5422) by @vbraun created at 2013-11-21 03:16:48\n\nNew commits:",
...
```json
{
    "body": "The fix is of course to read the trailing space, too...",
...
```json
{
    "body": "I have seen doctest failures caused by this quite a few times in `maxima_abstract.py`.  With this fix applied, I have run doctests 1200 times without a single failure.",
    "created_at": "2013-12-14T12:44:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15440",
    "type": "issue_comment",
