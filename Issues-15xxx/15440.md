...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15440#event-202464"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15440#event-202465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15440#event-202466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15440#event-202467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15440#issuecomment-194686",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15440#issuecomment-194687",
    "user": "https://github.com/pjbruin"
}
```
