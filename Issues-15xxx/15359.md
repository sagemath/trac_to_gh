...
```json
{
    "body": "The problem seems to be that Sage picks up my systems ncurses instead of sage-5.13.beta2/local/lib/libncurses.so.\n\nI don't have a wide version of ncurses in sage-5.13.beta2/local/lib, so it might be that #15080 would fix my problems.",
...
```json
{
    "body": "And, is it fixed now with #15268?",
...
```json
{
    "body": "Yes. 5.13.beta3 with #15268 fixed works fine.",
