...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-201070"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-201071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-201072"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-201073"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15359#issuecomment-192922",
    "user": "https://github.com/sagetrac-fschulze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15359#issuecomment-192923",
    "user": "https://github.com/jdemeyer"
}
```
