...
```json
{
    "body": "I'll provide a patch which hopefully fixes this within the next days...",
...
```json
{
    "body": "When you fix this, please put a comment near your fix that in general the ticket #15002 should be fixed.",
...
```json
{
    "body": "I tried to improve the two points of metioned by ppurka in the last patch and was waiting for a review.\n\nIs it still possible to merge these patches now that we moved to git?",
...
```json
{
    "body": "Indeed. This is good to go. I never realized that the patch was corrected and uploaded here. As Nathann said, just uploading a patch doesn't trigger emails. :)",
...
```json
{
    "body": "> Nathann, thanks for the `ping ?`!\n\n\nhttp://goo.gl/2vkrfQ\n\nNathann",
