...
```json
{
    "body": "<a id='comment:31'></a>\nNew commits:\n|                                                                                                         |                                                                            |\n|---------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[cce6119](http://git.sagemath.org/sage.git/commit/?id=cce6119)|better hashing for TripleDict, use PyCapsule for callbacks, and fix KeyedRef|",
    "created_at": "2013-11-13T17:29:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15367",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                 |\n|---------------------------------------------------------------------------------------------------------|---------------------------------|\n|[b95fa73](http://git.sagemath.org/sage.git/commit/?id=b95fa73)|Faster type checking for KeyedRef|",
...
```json
{
    "body": "<a id='comment:38'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:\n|                                                                                                         |                                                                        |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[9022b32](http://git.sagemath.org/sage.git/commit/?id=9022b32)|trac #15367: faster type checking by declaring fixed_KeyedRef to be type|\n|[cce6119](http://git.sagemath.org/sage.git/commit/?id=cce6119)|better hashing for TripleDict, use PyCapsule for callbacks, and fix KeyedRef|\n|[a2852e9](http://git.sagemath.org/sage.git/commit/?id=a2852e9)|Remove unused debug method CoercionModel_cache_maps.get_stats()|\n|[1724e0e](http://git.sagemath.org/sage.git/commit/?id=1724e0e)|An improved implementation of MonoDict and TripleDict|",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:\n|                                                                                                         |                                                               |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[b8d5a5a](http://git.sagemath.org/sage.git/commit/?id=b8d5a5a)|Remove unused debug method CoercionModel_cache_maps.get_stats()|\n|[8144996](http://git.sagemath.org/sage.git/commit/?id=8144996)|trac #15367: Improved implementation of TripleDict and MonoDict, based on open addressing. This implementation should be faster for all operations and have a smaller memory footprint.|",
...
```json
{
    "body": "<a id='comment:42'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                           |\n|---------------------------------------------------------------------------------------------------------|---------------------------|\n|[9aeb4f5](http://git.sagemath.org/sage.git/commit/?id=9aeb4f5)|trac #15367: fix whitespace|",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Recent commits:\n|                                                                                                         |                                                               |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[719cdec](http://git.sagemath.org/sage.git/commit/?id=719cdec)|Remove unused debug method CoercionModel_cache_maps.get_stats()|\n|[0550ecb](http://git.sagemath.org/sage.git/commit/?id=0550ecb)|trac #15367: Improved implementation of TripleDict and MonoDict, based on open addressing. This implementation should be faster for all operations and have a smaller memory footprint.|",
    "created_at": "2013-11-19T19:04:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15367",
    "type": "issue_comment",
