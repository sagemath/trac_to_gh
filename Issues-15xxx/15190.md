...
```json
{
    "body": "<a id='comment:4'></a>\n**Branch pushed to git repo; I updated commit sha1.** **Last 10 new commits:**\n<table><tr>c638bd6Merge branch 'u/saraedum/ticket/15232' of git://trac.sagemath.org/sage into ticket/15190</tr><tr>0b40946Fixed doc warnings in the dev scripts.</tr><tr>b85954arenamed reset_to_clean_working_directory() to clean() in the dev scripts</tr><tr>e113ba9Fixed a help string in the dev scripts.</tr><tr>5e33590Fixed an error in push()</tr><tr>f45cb83Renamed commands in docstring in sagedev.py</tr><tr>95b539eMade create_ticket() not switch to branch for the ticket automatically.</tr><tr>d9fdd82Renamed several commands in the dev scripts.</tr><tr>28d5e0eMade the sage-dev script more robust.</tr><tr>be8e3ffSpeed up local_tickets() by caching trac data</tr></table>\n",
    "created_at": "2013-09-27T00:15:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15190",
    "type": "issue_comment",
