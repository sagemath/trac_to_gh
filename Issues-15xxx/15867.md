...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[ff56f10](https://git.sagemath.org/sage.git/commit/?id=ff56f1041130acc517426cdd788dd65f6308b55d)|`Implement modular exponentiation in polynomial rings Flint.`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[c2a7b16](https://git.sagemath.org/sage.git/commit/?id=c2a7b16db55073c168ab0512e574740c3cdfd984)|`Implement modular exponentiation in polynomial rings Flint.`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[8293154](https://git.sagemath.org/sage.git/commit/?id=82931546c7580795b0cfdea2906af5f8d61a91d1)|`Implement modular exponentiation in polynomial rings Flint.`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[c5054ad](https://git.sagemath.org/sage.git/commit/?id=c5054adcd44b30c16ab9b38ebe2c95ae454ac051)|`Implement modular exponentiation in polynomial rings Flint.`|\n|[c37ccc8](https://git.sagemath.org/sage.git/commit/?id=c37ccc82230f9a45444a7d7e7096c8dbf50c496f)|`modular exponentiation using power_mod() in FLINT`|",
    "created_at": "2022-01-29T11:37:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15867",
    "type": "issue_comment",
