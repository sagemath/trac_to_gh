...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15867#event-209059"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15867#event-209060"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15867#event-209061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15867#event-209062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15867#issuecomment-203389",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15867#issuecomment-203390",
    "user": "https://github.com/shashwat1002"
}
```
