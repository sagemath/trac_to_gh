...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[a278bc9](http://git.sagemath.org/sage.git/commit/?id=a278bc91cc19a43f6f8bcfe5c08db486e804f8cc)|`Let gf2x use --libdir and make SAGE_FAT_BINARY work.`|",
    "created_at": "2014-01-06T19:57:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[2371b35](http://git.sagemath.org/sage.git/commit/?id=2371b3586b7b656293f036dc6e0d467946d02ad8)|`Replace symlink in a more portable way.`|",
    "created_at": "2014-01-06T21:53:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[0086d4a](http://git.sagemath.org/sage.git/commit/?id=0086d4a6c8ca1e1fa3da40a6bdcee21758c2331c)|`Make generic build of gf2x smarter.`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[59925a5](http://git.sagemath.org/sage.git/commit/?id=59925a5bd36ff9abae20f6aa54c5b002ba37db55)|`More fixes for gf2x generic build.`|\n|[5159831](http://git.sagemath.org/sage.git/commit/?id=5159831b64a5a5a3f9c83480f61f031224cd6f5f)|`Support SSE2 on x86_64 for gf2x.`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[ddee57e](http://git.sagemath.org/sage.git/commit/?id=ddee57e91708e8599f7c5d8d94aeffe5f0ae2cc5)|`Simplify generic build of gf2x.`|",
    "created_at": "2014-01-13T16:25:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[fdd7694](http://git.sagemath.org/sage.git/commit/?id=fdd76942417b05350d5a0d05e91673b00958e3ce)|`Properly autoreconfed patches.`|\n|[75888b1](http://git.sagemath.org/sage.git/commit/?id=75888b131d6dbf68506a0096bec7c8b3cd28db34)|`Document new gf2x patch.`|",
    "created_at": "2014-01-14T11:31:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:33'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[1fb1afe](http://git.sagemath.org/sage.git/commit/?id=1fb1afe23d755de863d6c8f17b317f2349b8955b)|`Prevent autotools to regenerate files.`|",
...
```json
{
    "body": "<a id='comment:54'></a>\nI've implemented the changes suggested above.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[a231689](http://git.sagemath.org/sage.git/commit/?id=a23168950a9901003604b85a765379d24ac63fb3)|`Make the SSE2 stuff work if the compiler does not support SSE2.`|",
    "created_at": "2014-01-28T18:16:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:66'></a>\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[9ba330e](http://git.sagemath.org/sage.git/commit/?id=9ba330eaf20a63d36a6dab5de1667f5a52ad1d63)|`Merge remote-tracking branch 'trac/develop' into ticket/15316`|\n|[969de52](http://git.sagemath.org/sage.git/commit/?id=969de52313ee407d874e9f7b318111c144de534e)|`Update git branch for gf2x SSE2 and Cygwin fixes.`|",
    "created_at": "2014-11-12T10:15:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15316",
    "type": "issue_comment",
