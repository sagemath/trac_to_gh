...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15209",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15209#issuecomment-189792",
    "user": "https://github.com/sagetrac-Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15209",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15209#issuecomment-189793",
    "user": "https://github.com/sagetrac-Bouillaguet"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15209#event-198749"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15209#event-198750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15209#event-198751"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15209#event-198752"
}
```
