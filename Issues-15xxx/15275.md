...
<a id='comment:5'></a>Problem was introduced by #508.
Since I couldn't find an answer why `./sage -c "attach file.sage"` was supposed to work, I suggest to revert the changes made in #508.
...
```json
{
    "body": "<a id='comment:6'></a>+1 to undo the \"something clever\"",
...
<a id='comment:6'></a>+1 to undo the "something clever"
