...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15732#issuecomment-200706",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15732#issuecomment-200707",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15732#event-207126"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15732#event-207127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15732#event-207128"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15732#event-207129"
}
```
