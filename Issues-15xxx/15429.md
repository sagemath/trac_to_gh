...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15429#issuecomment-245805",
    "user": "https://trac.sagemath.org/admin/accounts/users/afiori"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15429#event-44957"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15429#event-44958"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15429#event-44959"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15429#event-44960"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15429#event-44961"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>on 8.8.b7:\n\n```\nsage: %timeit [z.__invert__() for z in QPrim]\n10 loops, best of 5: 176 ms per loop\nsage: %timeit [z.__invert__() for z in ZPrim]\n1 loop, best of 5: 506 ms per loop\n```",
    "created_at": "2019-06-01T08:58:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15429",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15429#issuecomment-245806",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>on 8.8.b7:
