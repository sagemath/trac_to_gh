...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-51012"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-51013"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-51014"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-51015"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-51016"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-51017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15354#issuecomment-248759",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15354#issuecomment-248760",
    "user": "https://github.com/rwst"
}
```
