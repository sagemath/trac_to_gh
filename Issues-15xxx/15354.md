...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-50597"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-50598"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-50599"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-50600"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-50601"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15354#event-50602"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15354#issuecomment-234571",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15354",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15354#issuecomment-234572",
    "user": "https://github.com/rwst"
}
```
