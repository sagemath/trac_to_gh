...
```json
{
    "body": "<a id='comment:2'></a>Oops. We need to suppress warnings on the \"latex\" build, not the \"pdf\" build.\n  \n---\nNew commits:",
    "created_at": "2014-02-10T17:03:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15800",
    "type": "issue_comment",
...
<a id='comment:2'></a>Oops. We need to suppress warnings on the "latex" build, not the "pdf" build.
