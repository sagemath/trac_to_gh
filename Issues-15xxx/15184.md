...
```json
{
    "body": "<a id='comment:2'></a>I think the current code is fragile, in particular if soft links are used (os.path.realpath might be needed at some point). os.path.exists might also come in handy.\n\nThe proposed fix expects the path separator \"/\", which should be os.path.pathsep.\n\nSo, there is enough reason to use os.path, rather than re-inventing its functionality in a non-portable way.",
    "created_at": "2013-09-10T21:56:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239749",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>I think the current code is fragile, in particular if soft links are used (os.path.realpath might be needed at some point). os.path.exists might also come in handy.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239750",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239751",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Something along these lines then? Note that this may be a good motivation to refactor sageinspect a little, so that getting \"source file and line\" is a little cheaper in many cases. Getting just a docstring should be fairly cheap (and usually should not involve reading source files), and here we're usually triggering a full fetch of the source code, only to throw it away. The reason is that sage_getsourcelines has a lot of logic that also applies to just fetching (file,lineno), but that logic is not available separately.",
    "created_at": "2013-09-11T18:21:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239752",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239753",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239754",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Aha, I see your comments in the patch. So, perhaps you are right, it would be a good idea to have a separate function dedicated to getting file and line number.",
    "created_at": "2013-09-11T18:58:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239755",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>Aha, I see your comments in the patch. So, perhaps you are right, it would be a good idea to have a separate function dedicated to getting file and line number.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239756",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239758",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239759",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Some stupid typos in the old version. Sorry about that. New version should be better. Incidentally, to see that presently things are a bit on the slow side:\n\n```\nsage -t cachefunc.pyx\n    [596 tests, 28.50 s]\n```\nand that's for testing a module that doesn't implement any significant computation! I suspect that it's because of extensive testing of incredibly slow introspection tools.",
    "created_at": "2013-09-12T16:26:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239760",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:9'></a>Some stupid typos in the old version. Sorry about that. New version should be better. Incidentally, to see that presently things are a bit on the slow side:
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15184#event-43808"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15184#event-43809"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15184#event-43810"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15184#event-43811"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15184#event-43812"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239762",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>*PING* I got bitten by this issue once again, so I adapted the patch here as a branch. Can we review and incorporate this change?\n\n---\nNew commits:",
    "created_at": "2014-09-20T00:10:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239763",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:15'></a>*PING* I got bitten by this issue once again, so I adapted the patch here as a branch. Can we review and incorporate this change?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239764",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Moreover, you will notice that you call `sage_getsourclines` twice. So, instead of doing\n\n```\n+ _, lineno = sage_getsourcelines(f)\n+ file_info = \"File: %s (starting at line %d)\\n\"%(filename,lineno)\n```\nyou should do\n\n```\n+ file_info = \"File: %s (starting at line %d)\\n\"%(filename,sourcelines[1])\n```",
    "created_at": "2014-09-21T10:09:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239766",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:17'></a>Moreover, you will notice that you call `sage_getsourclines` twice. So, instead of doing
...
```json
{
    "body": "<a id='comment:18'></a>I just pushed an additional commit, hopefully improving the code a little bit. Strange that the commit cannot be seen yet. `git trac push` told me\n\n```\nPushing to Trac #15184...\nGuessed remote branch: u/SimonKing/ticket/15184\nEnter passphrase for key '/home/king/.ssh/id_rsa': \n\nTo git@trac.sagemath.org:sage.git\n * [new branch]      HEAD -> u/SimonKing/ticket/15184\n\nChanging the trac \"Branch:\" field...\n```\nbut apparently it did *not* change the branch field.",
    "created_at": "2014-09-21T11:04:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239767",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:18'></a>I just pushed an additional commit, hopefully improving the code a little bit. Strange that the commit cannot be seen yet. `git trac push` told me
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239768",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239769",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239771",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239772",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>All tests pass for me, you accept my review patch. So, I'd say it is a positive review.\n\nPlease check if I spelled your name correctly. And Volker will hopefully be able to explain why the patchbot reports a failure...",
    "created_at": "2014-09-22T04:55:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239773",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:21'></a>All tests pass for me, you accept my review patch. So, I'd say it is a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239774",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239775",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239777",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239778",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239779",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239780",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239781",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239782",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239783",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15184#issuecomment-239784",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15184",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15184#event-43813"
}
```
