...
```json
{
    "body": "<a id='comment:15'></a>\n*PING* I got bitten by this issue once again, so I adapted the patch here as a branch. Can we review and incorporate this change?\n\n---\nNew commits:\n|                                                                                                                                          |                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[41318d7](http://git.sagemath.org/sage.git/commit/?id=41318d7bc7b13466ee14cf87b559fa860499f48f)|`trac #15184: fix path insertion in docstring generation for cached functions.`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                          |                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[2ce7e4d](http://git.sagemath.org/sage.git/commit/?id=2ce7e4ddfab4a1216537d099e1589563778cbd65)|`Use the :trac: directive`|",
