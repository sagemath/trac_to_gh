...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15023#event-195863"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15023#event-195864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15023#event-195865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15023#event-195866"
}
```
...
```json
{
    "body": "Changed keywords from **** to **\"branching rule\"**",
    "created_at": "2013-08-13T00:27:53Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/15023",
    "type": "issue_comment",
...
Changed keywords from **** to **"branching rule"**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15023",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15023#issuecomment-186837",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15023",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15023#issuecomment-186838",
