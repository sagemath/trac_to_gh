...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249040",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249041",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249042",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249043",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249044",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249045",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249046",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249047",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Okay, what this commit does makes sense, and once this is done `sage -sync-build` raises no exception, but the `sage.schemes.toric.library.ToricVarietyFactory.torus` object from #15564 still seems to exist !?...\n\nNathann",
    "created_at": "2013-12-22T15:43:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249049",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:5'></a>Okay, what this commit does makes sense, and once this is done `sage -sync-build` raises no exception, but the `sage.schemes.toric.library.ToricVarietyFactory.torus` object from #15564 still seems to exist !?...
...
```json
{
    "body": "<a id='comment:6'></a>Oh, by the way, I did not just checkout your branch but merged it with 6.0.rc1.\n\nNathann",
    "created_at": "2013-12-22T15:51:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249050",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>Oh, by the way, I did not just checkout your branch but merged it with 6.0.rc1.
...
```json
{
    "body": "<a id='comment:7'></a>Ok, the `torus()` was merged in f00af8f6 and is a normal method in src/sage/schemes/toric/library.py",
    "created_at": "2013-12-22T15:52:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249051",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:7'></a>Ok, the `torus()` was merged in f00af8f6 and is a normal method in src/sage/schemes/toric/library.py
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249053",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249054",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15566#issuecomment-249055",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15566",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15566#event-45504"
}
```
