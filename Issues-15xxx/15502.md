...
<a id='comment:1'></a>More to the point:
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [sage0.png](tarball://root/attachments/some-uuid/ticket15502/sage0.png) by vbraun_spam created at 2014-01-30 21:20:52",
    "created_at": "2014-01-30T21:20:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15502",
    "type": "issue_comment",
...
<a id='comment:2'></a>Attachment [sage0.png](tarball://root/attachments/some-uuid/ticket15502/sage0.png) by vbraun_spam created at 2014-01-30 21:20:52
...
<a id='comment:5'></a>can this ticket be classified as wrong answer or not?
(I would say clearly wrong answer,
 but different opinions with arguments are welcome)
...
```json
{
    "body": "<a id='comment:6'></a>Nah, I think this is more to enhance - sometimes such plots are not so easy to generate.",
...
<a id='comment:6'></a>Nah, I think this is more to enhance - sometimes such plots are not so easy to generate.
