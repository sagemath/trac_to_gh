...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-201819"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-201820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-201821"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15885#issuecomment-203744",
    "user": "https://github.com/mezzarobba"
}
```
