...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-209306"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-209307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-209308"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15885#issuecomment-203742",
    "user": "https://github.com/mezzarobba"
}
```
