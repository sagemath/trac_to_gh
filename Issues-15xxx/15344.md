...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15344#event-200854"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15344#event-200855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15344#event-200856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15344#event-200857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15344#issuecomment-192672",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15344#issuecomment-192673",
    "user": "https://github.com/rwst"
}
```
