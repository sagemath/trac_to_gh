...
```json
{
    "body": "<a id='comment:15'></a>\nNote also [that the mpl ticket has been closed](https://github.com/matplotlib/matplotlib/issues/2540) as a wontfix.\n\n---\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[9980c6e](http://git.sagemath.org/sage.git/commit/?id=9980c6e1c74473151ec84e123e4865c736986a09)|`fix aspect_ratio for density_plot`|\n|[bc5e512](http://git.sagemath.org/sage.git/commit/?id=bc5e5126ee9047f0ece1b321f13e735a2e06b52f)|`make sure that matrix plots have aspect ratio 1`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|\n|[a0316b8](http://git.sagemath.org/sage.git/commit/?id=a0316b80ec189d7d0fc6d519bfa2efd636d1acb5)|`Merge branch 'u/ppurka/ticket/15315' of trac.sagemath.org:sage into ticket/15315`|\n|[2cc1beb](http://git.sagemath.org/sage.git/commit/?id=2cc1beba873ee5898fadaa206cee23cd9be5455f)|`fix documentation string`|",
