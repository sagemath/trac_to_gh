...
archive/attachments_021008.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_15233_q_analogues.patch](https://github.com/sagemath/sage/files/ticket15233/trac_15233_q_analogues.patch)",
    "created_at": "2013-09-27T03:04:44Z",
    "issue": "https://github.com/sagemath/sage/issues/15233",
    "type": "issue_comment",
...
archive/attachments_021009.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_021010.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_15233-review-ts.patch](https://github.com/sagemath/sage/files/ticket15233/trac_15233-review-ts.patch)",
    "created_at": "2013-10-02T14:19:15Z",
    "issue": "https://github.com/sagemath/sage/issues/15233",
    "type": "issue_comment",
...
archive/attachments_021011.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_15233_q_analogues_folded.patch](https://github.com/sagemath/sage/files/ticket15233/trac_15233_q_analogues_folded.patch)",
    "created_at": "2013-10-03T23:34:41Z",
    "issue": "https://github.com/sagemath/sage/issues/15233",
    "type": "issue_comment",
...
archive/attachments_021012.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_021013.json:
```json
{
    "asset_content_type": "application/octet-stream",
