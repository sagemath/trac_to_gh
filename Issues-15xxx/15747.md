...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46279"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46280"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46281"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46282"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46283"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253657",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46284"
}
```
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46285"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Still an issue",
    "created_at": "2017-03-03T23:36:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253658",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```

<a id='comment:6'></a>Still an issue
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253659",
...
```json
{
    "body": "<a id='comment:7'></a>appears to be fixed in Sage 9.4",
    "created_at": "2021-08-27T18:38:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253660",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:7'></a>appears to be fixed in Sage 9.4
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46286"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15747#event-46287"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253661",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253662",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253663",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>It is still broken on my computer (running 9.4) :(",
    "created_at": "2021-08-27T19:24:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15747#issuecomment-253664",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:9'></a>It is still broken on my computer (running 9.4) :(
