...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------|\n|[2f375c7](http://git.sagemath.org/sage.git/commit/?id=2f375c76580bdd5a66faef9e46f32fee2b492684)|`Add doctest`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[3131a68](http://git.sagemath.org/sage.git/commit/?id=3131a68c618ddf5ec4ecae9c602b1509654f7ce3)|`Fix documentation build`|\n|[06e7dbf](http://git.sagemath.org/sage.git/commit/?id=06e7dbf62c21a536ac1b5b034f7c9e30e170b655)|`Add explanatory note`|",
