...
```json
{
    "body": "<a id='comment:1'></a>Thinking about it, I'm not sure if `gens` can be trusted at all, particularly in the case of algebras over different ground rings. Radical suggestion: deprecate it in favor of `group_gens(self)`, `module_gens(self, base_ring)`, `ring_gens(self)` and `algebra_gens(self, base_ring)`?",
    "created_at": "2013-11-08T02:07:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15381#issuecomment-244689",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:1'></a>Thinking about it, I'm not sure if `gens` can be trusted at all, particularly in the case of algebras over different ground rings. Radical suggestion: deprecate it in favor of `group_gens(self)`, `module_gens(self, base_ring)`, `ring_gens(self)` and `algebra_gens(self, base_ring)`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15381#issuecomment-244691",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15381#event-44693"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15381#event-44694"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15381#event-44695"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15381#event-44696"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15381#event-44697"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Related (duplicate?): #17768",
    "created_at": "2015-02-11T17:42:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15381#issuecomment-244694",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:9'></a>Related (duplicate?): #17768
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15381#issuecomment-244695",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15381#issuecomment-244696",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15381#issuecomment-244697",
