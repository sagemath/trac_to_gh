...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket15437/trac_15437_laurent_ideals.patch",
    "created_at": "2013-11-19T14:50:15Z",
    "issue": "https://github.com/sagemath/sage/issues/15437",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15437/trac_15437_laurent_ideals.patch",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15437#issuecomment-194560",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15437#event-136321"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15437#event-136322"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15437#event-136323"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15437#event-136324"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15437#event-136325"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15437#event-136326"
}
```
