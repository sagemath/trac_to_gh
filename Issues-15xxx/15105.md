...
```json
{
    "body": "<a id='comment:59'></a>\nThese seem unused:\n\n```\n# used by cython.py\n`_add_variable_or_`fallback('SINGULAR_INCLUDEDIR', opj('$SAGE_LOCAL','include','singular'))\n`_add_variable_or_`fallback('FACTORY_INCLUDEDIR',  opj('$SAGE_LOCAL','include','factory'))\n```",
