...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[faa99e7](https://git.sagemath.org/sage.git/commit/?id=faa99e72f8e4edc28f5e34366ee636033ff54976)|`Merge branch 'master' into runtime_paths`|\n|[12f6985](https://git.sagemath.org/sage.git/commit/?id=12f698526f1385923acc5c1b2b0c855ea908e3c1)|`refresh more runtime_paths commits`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[8149a85](https://git.sagemath.org/sage.git/commit/?id=8149a85cae9ea41685a0954a8d5b275caef16807)|`Merge 'develop' into runtime_paths`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[4846a73](https://git.sagemath.org/sage.git/commit/?id=4846a73aad7cf7361c69a6ae43628b8cae821b9f)|`merge develop into runtime_paths`|",
...
```json
{
    "body": "<a id='comment:42'></a>\nHere's my version of Felix's branch, rebased on a recent develop branch.  I think I preserved all the changes between the original version of his branch, and the more recent version from https://git.sagemath.org/sage.git/commit/?id=4846a73aad7cf7361c69a6ae43628b8cae821b9f  So this removed many changes from the original branch, such as the change to how sage-maxima.lisp is located.\n\nIt would still be good to have a solution for that.  But for now, this will let us look at what changes this branch does make (that are still relevant).\n\n---\nNew commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[8cb6f9f](https://git.sagemath.org/sage.git/commit?id=8cb6f9fe5c68e2d1a36010754ea19bf460432fad)|`unhardwire runtime paths in various cases`|\n|[75cb534](https://git.sagemath.org/sage.git/commit?id=75cb53411ddd6bf1ffa038906748eab50fdf1a6a)|`fix qepcadrc path`|\n|[c484537](https://git.sagemath.org/sage.git/commit?id=c484537601aa21404f516d99df4b907cfd40eee4)|`don't rely on $SAGE_LOCAL/bin/python.`|\n|[ffed9de](https://git.sagemath.org/sage.git/commit?id=ffed9dee9b9aa6b9c543dd6b95171a32228485a8)|`cython.py: don't rely in $SAGE_LOCAL`|\n|[4278025](https://git.sagemath.org/sage.git/commit?id=42780252fc0c105fb9bd9e6dd1cdf7285b4192dc)|`python-sage: remove sage-location check`|\n|[807588e](https://git.sagemath.org/sage.git/commit?id=807588ebd019f99f2c3e9ed82207a1d5c1d50a67)|`initialize SAGE_ETC (from environ) in sage-location before use`|",
    "created_at": "2016-10-03T10:00:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15105",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:94'></a>\nI've split out some commits to #21783 and #21784.\n\nRebased the remaining commits on top of 7.5.beta0.\n\n---\nNew commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[437827b](https://git.sagemath.org/sage.git/commit?id=437827b89af4dcf6842dd5d343489247fb779b16)|`unhardwire runtime paths in various cases`|",
...
```json
{
    "body": "<a id='comment:0'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[5db9663](https://git.sagemath.org/sage.git/commit/?id=5db9663890c11981bbf9af923ea6fd80cdcf74c4)|`lattice_polytope: Use POLYTOPE_DATA_DIR directly`|\n|[b011153](https://git.sagemath.org/sage.git/commit/?id=b011153b2e729045712c62e7b67d5e26f6f0d6ed)|`ec_database: Use ELLCURVE_DATA_DIR directly`|\n|[171e139](https://git.sagemath.org/sage.git/commit/?id=171e139519ed48a58ca42c059f91aecfa858c8e1)|`Rename CONWAY_DATA_DIR to CONWAY_POLYNOMIALS_DATA_DIR`|\n|[a222fc9](https://git.sagemath.org/sage.git/commit/?id=a222fc9b68e80f274e8a77dae98ac0fdef06b767)|`Rename GAP_DATA_DIR to GAP_ROOT_DIR`|\n|[a80df36](https://git.sagemath.org/sage.git/commit/?id=a80df367fbddcbcb7e4df637efdc38e5a2e22eff)|`Import GRAPHS_DATA_DIR from sage.env, not sage.misc.misc`|",
...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[41b40fd](https://git.sagemath.org/sage.git/commit/?id=41b40fd6169187972094538df26f5e4884f908e6)|`unhardwire runtime paths in various cases`|\n|[6e0738e](https://git.sagemath.org/sage.git/commit/?id=6e0738ebbee60f5a11ce333e7d6b511d4715b607)|`lattice_polytope: Use POLYTOPE_DATA_DIR directly`|\n|[82f9882](https://git.sagemath.org/sage.git/commit/?id=82f98827ad7852f941fec0795d3f4898665788c3)|`ec_database: Use ELLCURVE_DATA_DIR directly`|\n|[0d56551](https://git.sagemath.org/sage.git/commit/?id=0d56551aec8ad65c6b42029f647a035749f74979)|`Rename CONWAY_DATA_DIR to CONWAY_POLYNOMIALS_DATA_DIR`|\n|[f7a462e](https://git.sagemath.org/sage.git/commit/?id=f7a462edf41efd41ee5179e649a2e0bc68bf8213)|`Rename GAP_DATA_DIR to GAP_ROOT_DIR`|\n|[cf810a2](https://git.sagemath.org/sage.git/commit/?id=cf810a2203c8b6bb75f2e2539fe21bb3187b9558)|`Import GRAPHS_DATA_DIR from sage.env, not sage.misc.misc`|",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[a2c3798](https://git.sagemath.org/sage.git/commit/?id=a2c3798e7c3e0da3ead876ffd9b093e947b8f6c7)|`GraphClasses: fixup use of GRAPHS_DATA_DIR`|\n|[65a00a5](https://git.sagemath.org/sage.git/commit/?id=65a00a5b5a724fab0685def2ef103a299c740ac4)|`Remove unused variables SINGULAR_INCLUDEDIR, FACTORY_INCLUDEDIR`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[ae20d15](https://git.sagemath.org/sage.git/commit/?id=ae20d153f2b3ec5484b23c4ce9e188358dbcf170)|`Remove duplicate assignment to UNAME`|\n|[45c5dd0](https://git.sagemath.org/sage.git/commit/?id=45c5dd010981c26d99773e97b9589a305326b90b)|`gap_root: slight simplification`|",
    "created_at": "2016-11-03T04:01:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15105",
    "type": "issue_comment",
