...
Replying to [@mstreng](https://github.com/sagemath/sage/issues/15114#comment:0):
> For example, one could easily do the following by accident.
> 
> ```
>     sage: iv = 1 + 2^(-55) + 0. + RIF(1)
