...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15477#event-203040"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15477#event-203041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15477#event-203042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15477#event-203043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15477#issuecomment-195372",
    "user": "https://github.com/vbraun"
}
```
