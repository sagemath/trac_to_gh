...
archive/attachments_020505.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage_crash_gi_YAQ.log",
    "asset_url": "tarball://root/attachments/some-uuid/ticket15917/sage_crash_gi_YAQ.log",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15917",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15917#issuecomment-205796",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15917",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15917#issuecomment-205797",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144510"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144511"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144512"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144513"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144514"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144515"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15917",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15917#event-144517"
}
```
