...
```json
{
    "body": "<a id='comment:13'></a>\nI've moved it to a git branch, rebased, and fixed the failing doctest.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|\n|[30776eb](http://git.sagemath.org/sage.git/commit/?id=30776eb9eea1fdaba9e81c906f2c0e3f3f4f965f)|`Make matrix repr for large matrices not trawl the call stack and move that functionality to displayhook instead.`|\n|[e852ce1](http://git.sagemath.org/sage.git/commit/?id=e852ce10285877db93309db156139a7bf3b8bc54)|`Fixed failing doctest.`|",
    "created_at": "2014-02-05T00:04:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15036",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nReplying to [jhpalmieri](#comment%3A21):\n> I think you should remove the [import]\n\nGood point. Done.\n\n---\nNew commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[fdb3282](http://git.sagemath.org/sage.git/commit/?id=fdb32821fa9382cb3bd468d1d0615f8f246470b0)|`trac #15036: remove redundant import statement`|",
    "created_at": "2014-02-08T20:51:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15036",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|\n|[508e858](http://git.sagemath.org/sage.git/commit/?id=508e858b0cc01d81547fe4b230863ad024d3c338)|`Make matrix repr for large matrices not trawl the call stack and move that functionality to displayhook instead.`|\n|[6edd34f](http://git.sagemath.org/sage.git/commit/?id=6edd34f0c30e4f8459352e5769a215c6c499a097)|`Fixed failing doctest.`|\n|[0eb5514](http://git.sagemath.org/sage.git/commit/?id=0eb5514f1ac278288abede2a69f0dad819d9d1ef)|`trac #15036: remove redundant import statement`|\n|[d41816c](http://git.sagemath.org/sage.git/commit/?id=d41816c57ede520353ed24ea9534c1219137d295)|`trac 15036: make some changes for rebase on 6.2`|",
...
```json
{
    "body": "<a id='comment:30'></a>\nI've fixed the broken doctests that I found (`matrix_space.py` and the `combinat/designs/latin_squares.py`). If someone could double-check, I think it's positive review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|\n|[30776eb](http://git.sagemath.org/sage.git/commit/?id=30776eb9eea1fdaba9e81c906f2c0e3f3f4f965f)|`Make matrix repr for large matrices not trawl the call stack and move that functionality to displayhook instead.`|\n|[e852ce1](http://git.sagemath.org/sage.git/commit/?id=e852ce10285877db93309db156139a7bf3b8bc54)|`Fixed failing doctest.`|\n|[fdb3282](http://git.sagemath.org/sage.git/commit/?id=fdb32821fa9382cb3bd468d1d0615f8f246470b0)|`trac #15036: remove redundant import statement`|\n|[a53d28f](http://git.sagemath.org/sage.git/commit/?id=a53d28f9903c669105443f1af97ae3beae9c785b)|`Merge branch 'u/nbruin/ticket/15036' of trac.sagemath.org:sage into public/ticket/large_matrix_repr-15036`|\n|[f2d8c36](http://git.sagemath.org/sage.git/commit/?id=f2d8c363fc26c1dfff9a868714cbc22bfc4759dc)|`Fixed failing doctests.`|",
    "created_at": "2014-05-12T15:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15036",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[f1b2742](http://git.sagemath.org/sage.git/commit/?id=f1b274282301f0b999969e77a620293235cedd8f)|`trac #15036: fix late import of is_Matrix to avoid startup problems`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[3b0cc7a](http://git.sagemath.org/sage.git/commit/?id=3b0cc7a1fc5c45effa3adf72c7e4411ea3a93740)|`Use lazy_import instead`|",
    "created_at": "2014-05-12T22:01:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15036",
    "type": "issue_comment",
