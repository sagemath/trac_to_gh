...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15457#event-202731"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15457#event-202732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15457#event-202733"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15457#event-202734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15457#issuecomment-195002",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15457#issuecomment-195003",
    "user": "https://github.com/vbraun"
}
```
