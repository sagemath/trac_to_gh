...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits:\n|                                                                                                         |                                                                    |\n|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[cab931b](http://git.sagemath.org/sage.git/commit/?id=cab931b)|Fix bug where sage-cleaner does not quit under certain circumstances|",
...
```json
{
    "body": "<a id='comment:16'></a>\nAdditional commit needs review.\n\n---\nNew commits:\n|                                                                                                         |                           |\n|---------------------------------------------------------------------------------------------------------|---------------------------|\n|[7a16247](http://git.sagemath.org/sage.git/commit/?id=7a16247)|`sage-cleaner review patch`|\n|[abfca17](http://git.sagemath.org/sage.git/commit/?id=abfca17)|`Merge branch 'develop' into ticket/15457`|",
    "created_at": "2014-01-01T17:32:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15457",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                             |\n|---------------------------------------------------------------------------------------------------------|-----------------------------|\n|[15c3964](http://git.sagemath.org/sage.git/commit/?id=15c3964)|`Use \"with\" to write pidfile`|",
