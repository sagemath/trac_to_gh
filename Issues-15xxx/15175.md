...
```json
{
    "body": "<a id='comment:1'></a>There's `edit` that relies on looked up files, but it seems to not care about whether a `py` or a `pyc` gets returned.\n\nNote, by the way, that changing anything in `local/lib/python2.7/site-packages/sage/` is a really bad idea: those changes just get overwritten the next time the sage library is \"installed\" (built).",
    "created_at": "2013-09-08T19:41:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239606",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:1'></a>There's `edit` that relies on looked up files, but it seems to not care about whether a `py` or a `pyc` gets returned.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239607",
    "user": "https://trac.sagemath.org/admin/accounts/users/felixs"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43760"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43761"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43762"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43763"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43764"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239608",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43765"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43766"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I remember fixing this in some other ticket.",
    "created_at": "2015-09-16T08:14:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239609",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I remember fixing this in some other ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239610",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"Jeroen Demeyer, Felix Salfelder\"",
    "created_at": "2015-09-16T08:14:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239611",
    "user": "https://github.com/jdemeyer"
}
```

Changing reviewer from "" to "Jeroen Demeyer, Felix Salfelder"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239612",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15175#issuecomment-239613",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15175",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15175#event-43767"
}
```
