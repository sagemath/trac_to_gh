...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15878#event-46721"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15878#event-46722"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15878#event-46723"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Maybe we could also fix the following at the same time?\n\n```\nsage: QQbar.is_subring(QQbar)\n...\nNotImplementedError\n\nsage: RR.is_subring(RR)\n..\nNotImplementedError\n\nsage: CC.is_subring(CC)\n..\nNotImplementedError\n```\n\netc.",
    "created_at": "2014-11-04T03:21:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15878#issuecomment-256865",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:3'></a>Maybe we could also fix the following at the same time?
...
```json
{
    "body": "<a id='comment:4'></a>I propose this to close as \"won't fix/not valid\" for the reason that if R is *isomorphic* to a subring of S, we don't have that R is canonically identified with a subring of S. There can be a choice of isomorphism.\n\nIt may be OK to consider R a subring of S if sage has an injective coercion from R to S registered, but I'm not even sure this should always be the case even then.",
    "created_at": "2014-11-04T05:08:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15878#issuecomment-256866",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:4'></a>I propose this to close as "won't fix/not valid" for the reason that if R is *isomorphic* to a subring of S, we don't have that R is canonically identified with a subring of S. There can be a choice of isomorphism.
...
```json
{
    "body": "<a id='comment:5'></a>I opened #17287 separately for my issue, just in case.",
    "created_at": "2014-11-04T13:40:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15878#issuecomment-256867",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:5'></a>I opened #17287 separately for my issue, just in case.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15878#issuecomment-256868",
