...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15459#event-202751"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15459#event-202752"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15459#event-202753"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15459#event-202754"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15459#issuecomment-195022",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15459#issuecomment-195023",
    "user": "https://github.com/vbraun"
}
```
