...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                                |\n|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[2eb2c95](http://git.sagemath.org/sage.git/commit/?id=2eb2c95)|`trac #15619: bug in the former definition; exception to avoid it in the future`|",
...
```json
{
    "body": "<a id='comment:65'></a>\nBranch pushed to git repo; I updated commit sha1. Last 10 new commits:\n|                                                                                                         |                                                         |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[e761346](http://git.sagemath.org/sage.git/commit/?id=e761346)|`trac #15619: Pickling multigraphs with loops and labels`|\n|[cabc969](http://git.sagemath.org/sage.git/commit/?id=cabc969)|`Trac 15619: Review commit`|\n|[c441178](http://git.sagemath.org/sage.git/commit/?id=c441178)|`trac #15619: bug in the former definition; exception to avoid it in the future`|\n|[0229348](http://git.sagemath.org/sage.git/commit/?id=0229348)|`trac #15619: Pickling of immutable graphs`|\n|[7860f39](http://git.sagemath.org/sage.git/commit/?id=7860f39)|`trac #15603: \"immutable=True\" for Graph/Digraph __init__ and copy()`|\n|[2525d22](http://git.sagemath.org/sage.git/commit/?id=2525d22)|`Trac 15278: Fix syntax error in doc test`|\n|[fcf9e30](http://git.sagemath.org/sage.git/commit/?id=fcf9e30)|`Trac 15278: Only graphs that use the static backend are identical with their copy`|\n|[8fc9c94](http://git.sagemath.org/sage.git/commit/?id=8fc9c94)|`Merge branch 'develop' into ticket/15278`|\n|[51d6328](http://git.sagemath.org/sage.git/commit/?id=51d6328)|`Trac 15278: Error messages explain how to create (im)mutable graph copy`|\n|[2fc8a77](http://git.sagemath.org/sage.git/commit/?id=2fc8a77)|`Make digraphs using the static backend immutable and hashable`|",
    "created_at": "2014-01-03T13:11:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15619",
    "type": "issue_comment",
