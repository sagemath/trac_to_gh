...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252443",
    "user": "https://trac.sagemath.org/admin/accounts/users/barbules"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252444",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252445",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46029"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46030"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46031"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46032"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46033"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Now the computation fails. Is that the expected behaviour?",
    "created_at": "2017-03-03T22:56:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252447",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```

<a id='comment:6'></a>Now the computation fails. Is that the expected behaviour?
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46034"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46035"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>The reason is that there is no sensible common parent of QQ to GF(q). Simply because 1/q is not invertible in GF(q). So there is no sensible coercion. Just conversion.\n\nI get. \nTypeError: unsupported operand parent(s) for *: 'Full MatrixSpace of 1 by 17 dense matrices over Finite Field of size 3571' and 'Vector space of dimension 17 over Rational Field'\n\nCertainly, this seems ok. Lets close this.",
    "created_at": "2017-10-06T07:17:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252448",
    "user": "https://github.com/simonbrandhorst"
}
```

<a id='comment:7'></a>The reason is that there is no sensible common parent of QQ to GF(q). Simply because 1/q is not invertible in GF(q). So there is no sensible coercion. Just conversion.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252449",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252450",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15688#issuecomment-252451",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15688",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15688#event-46036"
}
```
