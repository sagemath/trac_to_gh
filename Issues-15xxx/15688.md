...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15688#issuecomment-199942",
    "user": "https://github.com/sagetrac-barbules"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15688#issuecomment-199943",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15688#event-206415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15688#event-206416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15688#event-206417"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15688",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15688#event-206418"
}
```
