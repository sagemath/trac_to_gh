...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15371#event-201265"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15371#event-201266"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15371#event-201267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15371#event-201268"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15371#issuecomment-193239",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15371#issuecomment-193240",
    "user": "https://github.com/vbraun"
}
```
