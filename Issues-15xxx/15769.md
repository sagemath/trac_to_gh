...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15769#event-207663"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15769#event-207664"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15769#event-207665"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15769#event-207666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15769#issuecomment-201389",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15769#issuecomment-201390",
    "user": "https://github.com/sagetrac-Rudi"
}
```
