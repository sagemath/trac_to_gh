...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                                                           |\n|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|\n|[c70498b](http://git.sagemath.org/sage.git/commit/?id=c70498b)|`buid/deps : added a dependency of freetype on libpng in order to work around a build-time race condition.`|\n|[bedf0d8](http://git.sagemath.org/sage.git/commit/?id=bedf0d8)|`Merge branch 'pillow' into ticket/15561`|\n|[f005905](http://git.sagemath.org/sage.git/commit/?id=f005905)|`pillow: depends on setuptools`|\n|[adc90ce](http://git.sagemath.org/sage.git/commit/?id=adc90ce)|`Pillow -> pillow`|\n|[8987381](http://git.sagemath.org/sage.git/commit/?id=8987381)|`remove PIL (it has been replaced by Pillow)`|\n|[2c055bd](http://git.sagemath.org/sage.git/commit/?id=2c055bd)|`Pillow: fix patch to work against 2.2.2`|\n|[6690d97](http://git.sagemath.org/sage.git/commit/?id=6690d97)|`doc: remove now unused environment variables`|\n|[3778f42](http://git.sagemath.org/sage.git/commit/?id=3778f42)|`Pillow: re-resolve #9864`|\n|[6df0adb](http://git.sagemath.org/sage.git/commit/?id=6df0adb)|`replace PIL with Pillow`|",
