...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15005#issuecomment-236253",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15005#issuecomment-236254",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15005#issuecomment-236255",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nlgtm\n\n---\nNew commits:\n|                                                                                                         |                                                  |\n|---------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[c352b1d](http://git.sagemath.org/sage.git/commit/?id=c352b1d)|Trac #15005: fix ref to SAGE_ROOT that broke %edit|",
    "created_at": "2013-11-27T14:46:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15005#issuecomment-236256",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15005#issuecomment-236257",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15005#event-43126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15005#issuecomment-236258",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15005",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15005#event-43127"
}
```
