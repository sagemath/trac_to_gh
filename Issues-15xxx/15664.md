...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15664#event-206001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15664#event-206002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15664#event-206003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15664#event-206004"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15664#issuecomment-199441",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15664",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15664#issuecomment-199442",
    "user": "https://github.com/nathanncohen"
}
```
