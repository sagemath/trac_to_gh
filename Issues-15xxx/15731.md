...
<a id='comment:4'></a>Replying to [comment:3 strenner]:
...
<a id='comment:6'></a>Replying to [comment:5 strenner]:
> The only way I can explain this behavior is the `SpecialNumber.__gt__` is called at some point.
