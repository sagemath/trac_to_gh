...
```json
{
    ...
    "user": "https://trac.sagemath.org/admin/accounts/users/strenner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15731#issuecomment-253374",
    "user": "https://trac.sagemath.org/admin/accounts/users/strenner"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Well, I am not sure how it works either, but I did experiments in a python interpreter (with the `SpecialNumber` being defined as the original description), and I got this:\n\n```python: \n>>> a = SpecialNumber(3)\n>>> 4 < a\nFalse\n>>> 2 < a\nTrue\n```\n\nThe only way I can explain this behavior is the `SpecialNumber.__gt__` is called at some point.",
    "created_at": "2014-01-25T21:42:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15731#issuecomment-253376",
    "user": "https://trac.sagemath.org/admin/accounts/users/strenner"
}
```

<a id='comment:5'></a>Well, I am not sure how it works either, but I did experiments in a python interpreter (with the `SpecialNumber` being defined as the original description), and I got this:
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46225"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46226"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46227"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46228"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46229"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>> the sage implementations try quite hard to return True or False\n\n\nIMHO this behaviour will pretty easy break most of the math... \nThus for me it is worth to open a blocker ticket for  that issue",
    "created_at": "2017-03-03T23:24:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15731#issuecomment-253378",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```

<a id='comment:10'></a>> the sage implementations try quite hard to return True or False
...
```json
{
    "body": "<a id='comment:11'></a>Duplicate of #21163.",
    "created_at": "2017-03-08T12:41:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15731#issuecomment-253379",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Duplicate of #21163.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15731",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46230"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15731#issuecomment-253380",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15731#event-46232"
}
```
