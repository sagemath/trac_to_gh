...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[fa688d0](http://git.sagemath.org/sage.git/commit/?id=fa688d0e9303b18abb68ef54c238b186282cdbb4)|`Changed doctest to reflect coxeter3/Chevie being installed.`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[952cfa7](http://git.sagemath.org/sage.git/commit/?id=952cfa79627a35ce36585430b4dcd3c9327d9de0)|`Changed default implementation for CoxeterGroup.`|",
