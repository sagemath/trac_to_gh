...
```json
{
    "body": "<a id='comment:1'></a>Attachment [fix_inversion_for_matrix_with_unital_det-nb.patch](tarball://root/attachments/some-uuid/ticket15160/fix_inversion_for_matrix_with_unital_det-nb.patch) by nborie created at 2013-09-05 15:13:24\n\nThis ticket follow the conversation on Sage-combinat-devel :\n\nhttps://groups.google.com/forum/#!topic/sage-combinat-devel/CJRnG1ppBe0",
    "created_at": "2013-09-05T15:13:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15160#issuecomment-203321",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```

<a id='comment:1'></a>Attachment [fix_inversion_for_matrix_with_unital_det-nb.patch](tarball://root/attachments/some-uuid/ticket15160/fix_inversion_for_matrix_with_unital_det-nb.patch) by nborie created at 2013-09-05 15:13:24
...
```json
{
    "body": "<a id='comment:4'></a>A fix for this would likely include/fix #15947.",
    "created_at": "2014-06-22T04:43:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15160#issuecomment-203322",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>A fix for this would likely include/fix #15947.
...
```json
{
    "body": "<a id='comment:6'></a>Actually, to define the `R`-algebra `(MatrixSpace(R,m,n), +, *)` one only needs a semi-ring `R`... would be useful when R is the max-plus semiring! But in this more general situation, many feature of linear algebra do not make sense (e.g. rank, determinant, etc).",
    "created_at": "2018-02-16T12:21:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15160#issuecomment-203323",
    "user": "https://github.com/videlec"
}
```

<a id='comment:6'></a>Actually, to define the `R`-algebra `(MatrixSpace(R,m,n), +, *)` one only needs a semi-ring `R`... would be useful when R is the max-plus semiring! But in this more general situation, many feature of linear algebra do not make sense (e.g. rank, determinant, etc).
...
```json
{
    "body": "<a id='comment:7'></a>Do you have a concrete example of something that doesn't work currently?",
    "created_at": "2018-02-21T22:58:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15160#issuecomment-203324",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Do you have a concrete example of something that doesn't work currently?
...
```json
{
    "body": "<a id='comment:10'></a>nborie: I understand your last comments, but my impression was that the ticket was talking also about much more elementary stuff than inverting matrices.\n\nFor example, one of the \"goals\" stated is \"Try to modify `MatrixSpace` and `Matrix` such that all basic operation can be done with special rings\". It would be good to have an example of something that doesn't work for this \"goal\".",
    "created_at": "2018-02-22T06:24:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15160#issuecomment-203327",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>nborie: I understand your last comments, but my impression was that the ticket was talking also about much more elementary stuff than inverting matrices.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15160#issuecomment-203330",
    "user": "https://github.com/jdemeyer"
}
```
