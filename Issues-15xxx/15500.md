...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[4c4826e](http://git.sagemath.org/sage.git/commit/?id=4c4826e0a769950c2a212349c77a13a6cb7767a8)|`Added is_integral() function to integer class`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[6ca987d](http://git.sagemath.org/sage.git/commit/?id=6ca987dfb31faf98e1e1b4da18e7ac854903ce53)|`Added is_integer() method to integer class`|",
    "created_at": "2014-02-12T17:12:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15500",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[36fab41](http://git.sagemath.org/sage.git/commit/?id=36fab4119b1ff7c87e3c9117f395ef30e716b038)|`Added alias function is_integer() in rational.pyx`|\n|[4a87fae](http://git.sagemath.org/sage.git/commit/?id=4a87faeca75f6868ed73775fec1fff363bb80623)|`Added is_integer() function to QQbar.py`|\n|[23a67be](http://git.sagemath.org/sage.git/commit/?id=23a67be5d7bec21e50e0cf9dc175dbfb1064d872)|`Added is_integer() function to check if its an integer,in real_double.pyx`|\n|[9ed3084](http://git.sagemath.org/sage.git/commit/?id=9ed30846de776aff85561be6162006fce1393298)|`Added is_integer() function to complex_double.pyx`|\n|[db07cb1](http://git.sagemath.org/sage.git/commit/?id=db07cb1c194db7667768eba6b8b1287db2271080)|`Added is_integer() function to complex_number.pyx`|",
    "created_at": "2014-02-13T13:22:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15500",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[85f8025](http://git.sagemath.org/sage.git/commit/?id=85f8025244f1b273781780a922332bb2605d5f1f)|`Added is_integer() function to Real Number class`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[9408464](http://git.sagemath.org/sage.git/commit/?id=940846455c0015106df40ca03974744e6a94822d)|`Made changes in element.pyx to pass the doc-test.`|",
    "created_at": "2014-02-14T12:56:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15500",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[379511d](http://git.sagemath.org/sage.git/commit/?id=379511d1410a8c4fa45edd8ceb792d0c0598c082)|`Made formatting changes`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nDidn't notice the update by Rajesh several weeks ago. Merged 6.2.beta8.\n\n---\nNew commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[4d00b30](http://git.sagemath.org/sage.git/commit/?id=4d00b30703c62824039605d95f6f03f13a2e36cf)|`Merge branch 'develop' into ticket/15500`|",
    "created_at": "2014-04-15T12:46:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15500",
    "type": "issue_comment",
