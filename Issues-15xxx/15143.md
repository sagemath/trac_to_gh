...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238892",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Oops, I didn't realize `__mul__` was there before you. Anyway, I'll take a look at it if you don't; it sounds like a cheap speedup one can get from just throwing away old code.\n\nThe Bergeron-Zabrocki paper you linked me to (thank you!) says \"A is called atomic if it is non-empty and not splittable\"; note the \"non-empty\" here. But apparently some other sources don't require non-emptiness. As far as I am concerned, the \"non-empty\" convention makes more sense; these are supposed to be a free monoid generating set of the monoid of all set partitions, so there is no reason the unity of the monoid should be there.",
    "created_at": "2013-09-07T15:12:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238895",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:4'></a>Oops, I didn't realize `__mul__` was there before you. Anyway, I'll take a look at it if you don't; it sounds like a cheap speedup one can get from just throwing away old code.
...
```json
{
    "body": "<a id='comment:6'></a>I started testing parts of this patch and found a minor bug that the partition type isn't checked.\n\n```\nsage: SetPartition([[1,2],[4]]) in SetPartitions([1,2,4],[3])\nTrue\n```\nThe other parts that I did test are looking good.",
    "created_at": "2013-09-09T18:32:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238896",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:6'></a>I started testing parts of this patch and found a minor bug that the partition type isn't checked.
...
```json
{
    "body": "<a id='comment:7'></a>Also, I've found that `SetPartition` accepts the following bad input.  Maybe it should raise an error.\n\n```\nsage: SetPartition([[1,2],[2,3]])\n{{1, 2}, {2, 3}}\n```",
    "created_at": "2013-09-09T18:51:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238897",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:7'></a>Also, I've found that `SetPartition` accepts the following bad input.  Maybe it should raise an error.
...
```json
{
    "body": "<a id='comment:8'></a>I understand this as a tradeoff with speed -- maybe add a check variable which is set to True by default, and go over all existing code that involves set partitions (hopefully not that much, and some of it will have to be modified anyway since #15143 breaks some doctests by changing output order) to make all calls to `SetPartition` call it with False?\n\nPartition algebras are HUGE; I definitely wouldn't want to see them slowed down by input sanitizing.",
    "created_at": "2013-09-09T18:58:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238898",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:8'></a>I understand this as a tradeoff with speed -- maybe add a check variable which is set to True by default, and go over all existing code that involves set partitions (hopefully not that much, and some of it will have to be modified anyway since #15143 breaks some doctests by changing output order) to make all calls to `SetPartition` call it with False?
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [trac_15143-set_partitions-ts.patch](tarball://root/attachments/some-uuid/ticket15143/trac_15143-set_partitions-ts.patch) by @tscrim created at 2013-09-10 16:19:15\n\nHere's the new version with better containment checks and doctest corrects to partition algebras.\n\nFor patchbot:\n\nApply: trac_15143-set_partitions-ts.patch",
    "created_at": "2013-09-10T16:19:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238899",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:9'></a>Attachment [trac_15143-set_partitions-ts.patch](tarball://root/attachments/some-uuid/ticket15143/trac_15143-set_partitions-ts.patch) by @tscrim created at 2013-09-10 16:19:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238900",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238902",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238903",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238905",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238906",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238908",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238910",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>For patchbot:\n\nApply: trac_15143-set_partitions-folded-ts.patch",
    "created_at": "2013-09-12T15:51:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238911",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:15'></a>For patchbot:
...
```json
{
    "body": "<a id='comment:16'></a>I think that this looks great and I am ready to put a positive review but I am getting a doc test failure \"File \"combinat/diagram_algebras.py\", line 193\"",
    "created_at": "2013-09-12T16:38:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238912",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:16'></a>I think that this looks great and I am ready to put a positive review but I am getting a doc test failure "File "combinat/diagram_algebras.py", line 193"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238913",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [trac_15143-set_partitions-folded-ts.patch](tarball://root/attachments/some-uuid/ticket15143/trac_15143-set_partitions-folded-ts.patch) by @tscrim created at 2013-09-12 18:50:42\n\nHey Darij,\n\nYes, good point. Fixed.\n\nHey Mike,\n\nIt seems like a failure due to dictionary display. I'm returning a sorted list, so it should be fixed now.",
    "created_at": "2013-09-12T18:50:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238914",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:18'></a>Attachment [trac_15143-set_partitions-folded-ts.patch](tarball://root/attachments/some-uuid/ticket15143/trac_15143-set_partitions-folded-ts.patch) by @tscrim created at 2013-09-12 18:50:42
...
```json
{
    "body": "<a id='comment:19'></a>Looks great to me and all tests pass.",
    "created_at": "2013-09-12T19:00:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238915",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:19'></a>Looks great to me and all tests pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238916",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Thank you both!",
    "created_at": "2013-09-12T19:40:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238917",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:20'></a>Thank you both!
...
```json
{
    "body": "<a id='comment:21'></a>for **patchbots**\n\napply trac_15143-set_partitions-folded-ts.patch",
    "created_at": "2013-09-20T19:16:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238918",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:21'></a>for **patchbots**
...
```json
{
    ...
    "milestone": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15143#event-43627"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Please add a proper commit message. In particular, `imported patch trac_15143-docchanges-mz.patch` shouldn't be there.",
    "created_at": "2013-09-26T16:24:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238919",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>Please add a proper commit message. In particular, `imported patch trac_15143-docchanges-mz.patch` shouldn't be there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238920",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Also, the pdf documentation doesn't build:\n\n```\n! LaTeX Error: Bad math environment delimiter.\n\nSee the LaTeX manual or LaTeX Companion for explanation.\nType  H <return>  for immediate help.\n ...\n\nl.48086 where $s = \\(\n                     s_1, s_2, \\ldots, s_q\\)$. Here, the pipe symbol\n```",
    "created_at": "2013-09-27T16:18:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238921",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>Also, the pdf documentation doesn't build:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238922",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238923",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238924",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238925",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Thanks Darij.",
    "created_at": "2013-09-27T18:56:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238926",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:27'></a>Thanks Darij.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15143#event-43628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238927",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15143#issuecomment-238928",
    "user": "https://github.com/jdemeyer"
}
```
