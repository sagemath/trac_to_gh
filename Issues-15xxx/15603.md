...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                     |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[5a4d634](http://git.sagemath.org/sage.git/commit/?id=5a4d634)|`trac #15603: \"immutable=True\" for Graph/Digraph __init__ and copy()`|\n|[9df004b](http://git.sagemath.org/sage.git/commit/?id=9df004b)|`rebasing #15278 on 6.1.beta2`|\n|[51d6328](http://git.sagemath.org/sage.git/commit/?id=51d6328)|`Trac 15278: Error messages explain how to create (im)mutable graph copy`|\n|[2fc8a77](http://git.sagemath.org/sage.git/commit/?id=2fc8a77)|`Make digraphs using the static backend immutable and hashable`|\n|[07bad46](http://git.sagemath.org/sage.git/commit/?id=07bad46)|`Merge branch 'u/ncohen/15491' of git://trac.sagemath.org/sage into ticket/15278`|\n|[126b036](http://git.sagemath.org/sage.git/commit/?id=126b036)|`Merge branch 'master' into ticket/15278`|\n|[c774057](http://git.sagemath.org/sage.git/commit/?id=c774057)|`Prepare hash and copy for immutable graphs. Let .weighted() respect mutability.`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                     |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[0dd973a](http://git.sagemath.org/sage.git/commit/?id=0dd973a)|`trac #15603: \"immutable=True\" for Graph/Digraph __init__ and copy()`|\n|[9df004b](http://git.sagemath.org/sage.git/commit/?id=9df004b)|`rebasing #15278 on 6.1.beta2`|\n|[51d6328](http://git.sagemath.org/sage.git/commit/?id=51d6328)|`Trac 15278: Error messages explain how to create (im)mutable graph copy`|\n|[2fc8a77](http://git.sagemath.org/sage.git/commit/?id=2fc8a77)|`Make digraphs using the static backend immutable and hashable`|\n|[07bad46](http://git.sagemath.org/sage.git/commit/?id=07bad46)|`Merge branch 'u/ncohen/15491' of git://trac.sagemath.org/sage into ticket/15278`|\n|[126b036](http://git.sagemath.org/sage.git/commit/?id=126b036)|`Merge branch 'master' into ticket/15278`|\n|[c774057](http://git.sagemath.org/sage.git/commit/?id=c774057)|`Prepare hash and copy for immutable graphs. Let .weighted() respect mutability.`|",
