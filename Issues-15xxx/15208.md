...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15208#event-43926"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15208#event-43927"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15208#event-43928"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I cannot reproduce this on 6.3.beta1.",
    "created_at": "2014-06-11T08:00:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15208#issuecomment-240250",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:3'></a>I cannot reproduce this on 6.3.beta1.
...
```json
{
    "body": "<a id='comment:4'></a>Neither do I",
    "created_at": "2014-06-11T12:40:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15208#issuecomment-240251",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```

<a id='comment:4'></a>Neither do I
...
```json
{
    "body": "<a id='comment:5'></a>Same.",
    "created_at": "2014-06-11T16:16:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15208#issuecomment-240252",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>Same.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15208#issuecomment-240253",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15208#event-43929"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15208#event-43930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15208#issuecomment-240254",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15208#issuecomment-240255",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15208#issuecomment-240256",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15208",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15208#event-43931"
}
```
