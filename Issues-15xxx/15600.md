...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15600#issuecomment-198012",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15600#issuecomment-198013",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15600#event-205030"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15600#event-205031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15600#event-205032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15600",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15600#event-205033"
}
```
