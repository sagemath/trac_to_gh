...
```json
{
    "body": "<a id='comment:1'></a>What exactly are you doing to start the notebook? `notebook(server_pool=['vbraun`@`localhost'])` works for me, plots are displayed immediately. Both the compute server and the notebook web server version of Sage must match.",
    "created_at": "2013-09-06T19:12:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203397",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>What exactly are you doing to start the notebook? `notebook(server_pool=['vbraun`@`localhost'])` works for me, plots are displayed immediately. Both the compute server and the notebook web server version of Sage must match.
...
```json
{
    "body": "<a id='comment:2'></a>Are you running the notebook as vbraun as well? I use two separate accounts in the same group and they do run on the same machine, so versions of sage for the notebook and worker are the same.",
    "created_at": "2013-09-06T19:19:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203398",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:2'></a>Are you running the notebook as vbraun as well? I use two separate accounts in the same group and they do run on the same machine, so versions of sage for the notebook and worker are the same.
...
```json
{
    "body": "<a id='comment:3'></a>It also works if I use a different account, i.e. `notebook(server_pool=['other`@`localhost'])` works with the current git and with vanilla sage-5.12.beta3.",
    "created_at": "2013-09-06T19:35:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203399",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>It also works if I use a different account, i.e. `notebook(server_pool=['other`@`localhost'])` works with the current git and with vanilla sage-5.12.beta3.
...
```json
{
    "body": "<a id='comment:4'></a>OK, I am not completely out of my mind, it just takes more effort to trigger it: all was ok in my freshly started beta4, until I checked \"Typeset\", which prints a string for a plot. Unchecking it did not help - still prints a string. Unchecking AND restarting the worksheet lets plots show up again.\n\nThis is actually not related to multi-user setup or anything with security, I think it is a blocker then, but probably should not be hard to fix for people in the know ;-)",
    "created_at": "2013-09-06T19:57:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203400",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:4'></a>OK, I am not completely out of my mind, it just takes more effort to trigger it: all was ok in my freshly started beta4, until I checked "Typeset", which prints a string for a plot. Unchecking it did not help - still prints a string. Unchecking AND restarting the worksheet lets plots show up again.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203401",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203402",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Verified that the errors in my comment:6 occurs in the prerelease version of sage-5.12.beta4. Haven't seen the exceptions in comment:7.",
    "created_at": "2013-09-07T12:29:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203405",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:8'></a>Verified that the errors in my comment:6 occurs in the prerelease version of sage-5.12.beta4. Haven't seen the exceptions in comment:7.
...
```json
{
    "body": "<a id='comment:10'></a>This has nothing to do with the sagenb code, the `pretty_print_default` command in Sage doesn't clean up after itself:\n\n```\nsage: plot(sin)   # works as expected, displays graphics\n\nsage: pretty_print_default(True)\nsage: plot(sin)\nGraphics object consisting of 1 graphics primitive\nsage: pretty_print_default(False)\nsage: plot(sin)\nGraphics object consisting of 1 graphics primitive \n```",
    "created_at": "2013-09-07T15:57:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203407",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>This has nothing to do with the sagenb code, the `pretty_print_default` command in Sage doesn't clean up after itself:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203408",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203409",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Attachment [trac_15168_typeset_displayhook.patch](tarball://root/attachments/some-uuid/ticket15168/trac_15168_typeset_displayhook.patch) by @vbraun created at 2013-09-09 10:03:02\n\nUpdated patch",
    "created_at": "2013-09-09T10:03:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203412",
    "user": "https://github.com/vbraun"
}
```

Attachment [trac_15168_typeset_displayhook.patch](tarball://root/attachments/some-uuid/ticket15168/trac_15168_typeset_displayhook.patch) by @vbraun created at 2013-09-09 10:03:02
...
```json
{
    "body": "<a id='comment:15'></a>Works for me, thanks Volker!\n\n(I'll leave nitpicking for ppurka ;-))",
    "created_at": "2013-09-09T17:25:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203413",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:15'></a>Works for me, thanks Volker!
...
```json
{
    "body": "<a id='comment:17'></a>The `server_pool` should be a list of strings, not a string that evaluates to a list of strings:\n\n```\nnotebook(server_pool=['sagenb@localhost'])\n```\nThough some argument checking would have been nice...",
    "created_at": "2013-09-10T13:11:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203415",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>The `server_pool` should be a list of strings, not a string that evaluates to a list of strings:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203416",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Oops. So sorry. It does work. I had to quote it because of the shell and apparently it is passed in quoted to the python process that actually launches the notebook.\n\nI had tested it on `sage/{misc,groups/matrix_gps}` and it passed all tests. Since the patchbot was also ok with the previous patch (except for some weird startup stuff) it should be good to go. Thanks for the quick fix!",
    "created_at": "2013-09-10T15:21:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203417",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:18'></a>Oops. So sorry. It does work. I had to quote it because of the shell and apparently it is passed in quoted to the python process that actually launches the notebook.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203418",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15168#event-43748"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15168#issuecomment-203419",
