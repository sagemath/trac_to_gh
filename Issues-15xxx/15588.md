...
<a id='comment:2'></a>Ahahaahah. Funny. I barely know what all these functions do, though I was always able to check that the code was equivalent to what it was previously. Sooooooo it's all good.
...
```json
{
    "body": "<a id='comment:5'></a>I am the reviewer of this ticket, and I try to make efforts to not create arguments with everybody around me every time we have to agree on something. I find it quite hard. I agree with Jeroen. But it's already hell to get people to acknowledge the existence of bugs and fix them, soooooo well... `:-P`\n\nNathann",
...
<a id='comment:5'></a>I am the reviewer of this ticket, and I try to make efforts to not create arguments with everybody around me every time we have to agree on something. I find it quite hard. I agree with Jeroen. But it's already hell to get people to acknowledge the existence of bugs and fix them, soooooo well... `:-P`
