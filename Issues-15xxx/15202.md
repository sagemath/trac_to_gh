...
```
CC:  @nathanncohen sage-combinat @nthiery fhivert
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195040",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195041",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195042",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195044",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195045",
...
```json
{
    "body": "Review patch uploaded. I'd rather have put it into the `public` namespace, but I've forgotten how to do that using the dev scripts (and if I use git manually, how do I reset the Branch field on the ticket?).\n\nI put back one newline you removed since I found it reasonable.\n\nmeld seems to do creepy stuff; I have checked the sanity of the merge manually using diff.",
    "created_at": "2013-12-10T08:02:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195046",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195048",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15202#event-44981"
}
```
...
```json
{
    "body": "HMmmmmm... Actually I would be quite glad to rewrite this branch and make it cleaner. Would it be fine if I just take my old branch, add your typo fixes into it, with all this atop beta5 ?\n\nNathann",
    "created_at": "2013-12-10T18:50:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195050",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "I won't mind... I hope noone hangs on this branch now (is there a good way to find this out at least for branches on the trac server?).",
    "created_at": "2013-12-11T21:45:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195051",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195052",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Looks good and tests well. positive_review is right. Thanks!",
    "created_at": "2013-12-17T05:05:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195053",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195054",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15202#event-44982"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15202#event-44983"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15202#event-44984"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15202#event-44985"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15202#event-44986"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15202#issuecomment-195055",
