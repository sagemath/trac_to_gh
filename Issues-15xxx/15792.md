...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254635",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>An amazing amount of time is spent for the initialisation of free modules when computing `E.gens()`. So, perhaps this is the culprit.",
    "created_at": "2014-02-06T14:46:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254636",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>An amazing amount of time is spent for the initialisation of free modules when computing `E.gens()`. So, perhaps this is the culprit.
...
```json
{
    "body": "<a id='comment:4'></a>Aha! Very good news. At #11900, an incomplete category initialisation has been introduced for matrix spaces, to prevent some regression. But I just tested: If we now *always* fully initialise the matrix space, we get\n\n```\nsage: %time D = J0(46).endomorphism_ring().discriminant()\nCPU times: user 10.16 s, sys: 0.22 s, total: 10.39 s\nWall time: 10.40 s\nsage: %time TestSuite(CrystalOfTableaux(['B',4],shape=[2,1,1,0])).run()\nCPU times: user 3.16 s, sys: 0.09 s, total: 3.25 s\nWall time: 3.26 s\nsage: W.<z> = CyclotomicField(13)\nsage: %time M = Matrix(W, 2, 3, [10^30*(1-z)^13, 1, 2, 3, 4, z]).echelon_form()\nCPU times: user 2.05 s, sys: 0.04 s, total: 2.08 s\nWall time: 2.08 s\nsage: %time L = EllipticCurve('960d1').prove_BSD()\nCPU times: user 4.70 s, sys: 0.06 s, total: 4.75 s\nWall time: 4.78 s\nsage: def test(E):\n....:     for p in prime_range(10000):\n....:         if p != 389:\n....:             G = E.change_ring(GF(p)).abelian_group()\n....:             \nsage: E = EllipticCurve('389a')\nsage: %time test(E)\nCPU times: user 26.96 s, sys: 0.24 s, total: 27.20 s\nWall time: 27.26 s\nsage: E = J0(46).endomorphism_ring()\nsage: %time g = E.gens()\nCPU times: user 9.51 s, sys: 0.37 s, total: 9.88 s\nWall time: 9.90 s\n```\nIn other words, it seems that we can now afford full category initialisation!!\n\nThat said, we should find other ways to speed up the `E.gens()` and `E.discriminant()` tests, as they used to be faster.",
    "created_at": "2014-02-06T14:59:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254638",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>Aha! Very good news. At #11900, an incomplete category initialisation has been introduced for matrix spaces, to prevent some regression. But I just tested: If we now *always* fully initialise the matrix space, we get
...
```json
{
    "body": "<a id='comment:6'></a>So, the plan is: Remove the ugly hack and finally do a full initialisation of matrix spaces. And then see why everything is so slow.",
    "created_at": "2014-02-06T15:11:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254640",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>So, the plan is: Remove the ugly hack and finally do a full initialisation of matrix spaces. And then see why everything is so slow.
...
```json
{
    "body": "<a id='comment:7'></a>Adding John to Cc, since the examples seemingly showing a regression since #11900 belong (I think) to his field of expertise.",
    "created_at": "2014-02-06T15:22:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254641",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>Adding John to Cc, since the examples seemingly showing a regression since #11900 belong (I think) to his field of expertise.
...
```json
{
    "body": "<a id='comment:8'></a>There's another open ticket on integer points at #1-973 which I am working on when I have time.  I don't have time to look at this now but it seems fomr the above comments that something has changed outside the ellipticv curve code, is that right?",
    "created_at": "2014-02-06T15:53:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254642",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>There's another open ticket on integer points at #1-973 which I am working on when I have time.  I don't have time to look at this now but it seems fomr the above comments that something has changed outside the ellipticv curve code, is that right?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254643",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>That looks completely crazily over the top for an integer points computation.  Why qqbar?  Why abelian groups?  I will look but it will take time and I have less than none for a while.",
    "created_at": "2014-02-06T17:41:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254644",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:10'></a>That looks completely crazily over the top for an integer points computation.  Why qqbar?  Why abelian groups?  I will look but it will take time and I have less than none for a while.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254645",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>There also is a regression in a different example (unrelated with elliptic curves, but part of #11900).",
    "created_at": "2014-02-07T10:00:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254646",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:11'></a>There also is a regression in a different example (unrelated with elliptic curves, but part of #11900).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254647",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Note that in the second example from the ticket description, finite fields are involved. But their creation (in a freshly started Sage session, of course) is fast:\n\n```\nsage: def test():\n....:     for p in prime_range(10000):\n....:         P = GF(p)\n....:         \nsage: %time test()\nCPU times: user 0.52 s, sys: 0.01 s, total: 0.53 s\nWall time: 0.53 s\n```",
    "created_at": "2014-02-07T10:06:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254648",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>Note that in the second example from the ticket description, finite fields are involved. But their creation (in a freshly started Sage session, of course) is fast:
...
```json
{
    "body": "<a id='comment:14'></a>This one might be slower than in the good old times:\n\n```\nsage: def test():\n....:     for i in xrange(5000):\n....:         MS = MatrixSpace(QQ,i)\n....:         \nsage: %time test()\nCPU times: user 0.49 s, sys: 0.02 s, total: 0.51 s\nWall time: 0.49 s\n```",
    "created_at": "2014-02-07T10:08:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254649",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:14'></a>This one might be slower than in the good old times:
...
```json
{
    "body": "<a id='comment:16'></a>#10963 makes the situation even worse. I am commenting there.",
    "created_at": "2014-02-07T10:54:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254651",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:16'></a>#10963 makes the situation even worse. I am commenting there.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15792#event-46453"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15792#event-46454"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15792#event-46455"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Bump.",
    "created_at": "2014-10-14T14:45:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254652",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:19'></a>Bump.
...
```json
{
    "body": "<a id='comment:20'></a>The large contribution from `dynamic_class_internal` in [comment:15] doesn't seem to be there in 6.4beta5 anymore. In fact, the relevant line now is:\n\n```\n        7    0.001    0.000    0.001    0.000 dynamic_class.py:324(dynamic_class_internal)\n```\nso I expect that this unfortunate artifact was fixed by #15801. Looking at the present profile, as well as the runsnake boxchart, I don't see anything jumping out as problematic. Close?",
    "created_at": "2014-10-14T18:07:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254653",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:20'></a>The large contribution from `dynamic_class_internal` in [comment:15] doesn't seem to be there in 6.4beta5 anymore. In fact, the relevant line now is:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254654",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254655",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254656",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15792#event-46456"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15792#event-46457"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15792#event-46458"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254657",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15792#issuecomment-254658",
    "user": "https://github.com/vbraun"
}
```
