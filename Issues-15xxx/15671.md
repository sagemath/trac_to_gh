...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[84ef4e5](http://git.sagemath.org/sage.git/commit/?id=84ef4e5fc1bb75cc74ea9147e36efc243dc1a6ab)|`Add back deleted declaration for richcmpfunc`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[322ee23](http://git.sagemath.org/sage.git/commit/?id=322ee2377078fc072e0a07f68305a3ff5adcd65c)|`Error handling in tp_new function`|",
