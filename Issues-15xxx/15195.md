...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15195#issuecomment-189502",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket15195/trac_15195-family_cardinality-ts.patch",
    "created_at": "2013-10-23T11:38:51Z",
    "issue": "https://github.com/sagemath/sage/issues/15195",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15195/trac_15195-family_cardinality-ts.patch",
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_15195-family_cardinality-ts.patch](https://github.com/sagemath/sage/files/ticket15195/trac_15195-family_cardinality-ts.patch) by @nathanncohen created at 2013-10-23 11:38:51\n\nHmmm... It fixes the bug indeed, but why wouldn't we do the opposite and first try to call `.set.cardinality()` and on `AttributeError` run the `len` version ? Is this a speed problem ?\n\nNathann",
    "created_at": "2013-10-23T11:38:51Z",
    "issue": "https://github.com/sagemath/sage/issues/15195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15195#issuecomment-189503",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15195#issuecomment-189504",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15195#issuecomment-189505",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15195#issuecomment-189506",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15195#issuecomment-189507",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15195#issuecomment-189508",
