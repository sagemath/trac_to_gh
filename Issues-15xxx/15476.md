...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                    |\n|---------------------------------------------------------------------------------------------------------|--------------------|\n|[0cda84b](http://git.sagemath.org/sage.git/commit/?id=0cda84b)|really minor changes|\n|[0606af3](http://git.sagemath.org/sage.git/commit/?id=0606af3)|Merge branch 'public/combinat/ncsf_qsym/involutions-15476' of trac.sagemath.org:sage into NSym1|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |     |\n|---------------------------------------------------------------------------------------------------------|-----|\n|[a88a476](http://git.sagemath.org/sage.git/commit/?id=a88a476)|ooops|",
    "created_at": "2013-12-17T02:49:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15476",
    "type": "issue_comment",
