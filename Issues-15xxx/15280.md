...
```json
{
    "body": "<a id='comment:1'></a>\n**Branch pushed to git repo; I updated commit sha1.** **Last 10 new commits:**\n<table><tr>8d4c117Small change for affine case.</tr><tr>d890cb6Normal form for lattice polytopes of non-zero codimension.</tr><tr>07152d8Merge important bugfix for dev scripts</tr><tr>8237337Merging Sage-5.12.rc0 and sage-git fixes</tr><tr>1ccb8e5Ignoring selection of temporary files taken from https://github.com/github/gitignore/tree/master/Global</tr><tr>383c35aMakefile target to download upstream sources.</tr><tr>3b15578Merging Sage-5.12.beta5, newest dev scripts, and the doctest fixes.</tr><tr>1456c52Merge branch 'ticket/14482' into public/sage-git/master</tr><tr>b890215Merge branch 'ticket/14482' into public/sage-git/master</tr><tr>d8713ebMerge remote-tracking branch 'origin/build_system' into public/sage-git/master</tr></table>\n",
    "created_at": "2013-10-15T14:07:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15280",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>b237240Fixed normal form of origin.</tr><tr>3f7996eImproved isomorphim check.</tr><tr>f64a7eeMerge branch 'normal_form_codimension' into maximal_polytopes</tr><tr>bbb1bc7Caching for affine normal form.</tr><tr>7bf8ebbMerged affine normal transform.</tr><tr>22828ceAffine normal form</tr><tr>604ad66Treat case with single vertex at origin.</tr><tr>4a62c1dMade subpolytopes a bit faster.</tr><tr>e667148Subpolytopes for PPL</tr></table>\n",
...
```json
{
    "body": "<a id='comment:10'></a>\n**Branch pushed to git repo; I updated commit sha1.** **New commits:**\n<table><tr>cbb3232Caching for affine normal form.</tr></table>\n",
...
```json
{
    "body": "<a id='comment:12'></a>\n**Branch pushed to git repo; I updated commit sha1.** **Last 10 new commits:**\n<table><tr>0828630Merge with updates from PALP normal form and clean up.</tr><tr>7b85f7eAdded more doctests and longer descriptions.</tr><tr>a0ca816Inverse and affine transformations for normal forms.</tr><tr>f77942aWorking on linear transformations for normal form.</tr><tr>9a18837Attempt at merging PALP normal form.</tr><tr>6938bacAdded normal form permutation read out from PALP.</tr><tr>00dcc4aEmbedding matrix must be over ZZ.</tr><tr>21dc3ecDirect call to PALP for affine normal form.</tr><tr>0f328caRemoved normal form for Laurent polynomials.</tr><tr>1051207Removed auto- and isomorphism code for the time being.</tr></table>\n",
