...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15207#issuecomment-189714",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15207#issuecomment-189715",
    "user": "https://github.com/nbruin"
}
```
...
archive/attachments_020325.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "richpickle.py",
    "asset_url": "tarball://root/attachments/ticket15207/richpickle.py",
    "created_at": "2013-09-18T05:27:37Z",
    "issue": "https://github.com/sagemath/sage/issues/15207",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15207/richpickle.py",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15207#issuecomment-189717",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15207#issuecomment-189718",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15207#issuecomment-189719",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15207#event-133604"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15207#event-133605"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15207#event-133606"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15207#event-133607"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15207#event-133608"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15207#event-133609"
}
```
