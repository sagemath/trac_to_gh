...
```json
{
    "body": "<a id='comment:1'></a>This looks to me like a problem with IPython's functions, not Sage directly.",
    "created_at": "2014-03-13T02:37:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257394",
    "user": "https://trac.sagemath.org/admin/accounts/users/nkprasad12"
}
```

<a id='comment:1'></a>This looks to me like a problem with IPython's functions, not Sage directly.
...
```json
{
    "body": "<a id='comment:3'></a>https://github.com/ipython/ipython/issues/5347",
    "created_at": "2014-03-13T09:01:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257396",
    "user": "https://github.com/rwst"
}
```

<a id='comment:3'></a>https://github.com/ipython/ipython/issues/5347
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257397",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257398",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257399",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257400",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Fixed in IPython 2.0, see #16053.",
    "created_at": "2014-04-15T08:29:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257401",
    "user": "https://github.com/rwst"
}
```

<a id='comment:7'></a>Fixed in IPython 2.0, see #16053.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15912#event-46805"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15912#event-46806"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15912#event-46807"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Now that we have IPython-2.3 the `range(10**6)` issue mentioned is indeed fixed there, but `divisors(...)` is still much slower than `print divisors(...)`.",
    "created_at": "2014-11-02T15:11:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257402",
    "user": "https://github.com/rwst"
}
```

<a id='comment:10'></a>Now that we have IPython-2.3 the `range(10**6)` issue mentioned is indeed fixed there, but `divisors(...)` is still much slower than `print divisors(...)`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15912#issuecomment-257403",
    "user": "https://github.com/rwst"
}
```
