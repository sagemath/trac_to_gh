...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15912#event-209633"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15912#event-209634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15912#event-209635"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15912#event-209636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15912#issuecomment-204029",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15912#issuecomment-204030",
    "user": "https://github.com/rwst"
}
```
