...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15481#issuecomment-246991",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15481#issuecomment-246992",
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15481#event-45167"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15481#event-45168"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15481#event-45169"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15481#event-45170"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15481#event-45171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15481#issuecomment-246994",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>in recent sage (7.6.beta4) some of the issues above seems fixed;\n\nThe following examples run forever\n\n```\nwords.FibonacciWord() in Words([0,1])\nwords.FibonacciWord() in Words([0,1,2])\n```",
    "created_at": "2017-03-03T22:28:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15481#issuecomment-246995",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```

<a id='comment:8'></a>in recent sage (7.6.beta4) some of the issues above seems fixed;
