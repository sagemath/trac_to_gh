...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45559"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45560"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45561"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45562"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249617",
...
```json
{
    "body": "<a id='comment:5'></a>Added example to the description.",
    "created_at": "2016-04-03T20:15:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249618",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Added example to the description.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249619",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45564"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45565"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249621",
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45566"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249622",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249623",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>IMHO, typically solvers are able to deal with multiple constraints, etc.\n\nAlso, constraints are really held in the backend, and in fact they can get modified once they are processed.",
    "created_at": "2017-04-06T21:43:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249624",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:9'></a>IMHO, typically solvers are able to deal with multiple constraints, etc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249625",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15583#issuecomment-249626",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15583",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15583#event-45568"
}
```
