...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189494",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189495",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket15194/exception_imports.patch",
    "created_at": "2013-09-13T17:10:43Z",
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15194/exception_imports.patch",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [exception_imports.patch](https://github.com/sagemath/sage/files/ticket15194/exception_imports.patch) by @dimpase created at 2013-09-13 17:10:43\n\nPurely my oversight in #12418...",
    "created_at": "2013-09-13T17:10:43Z",
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189496",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189498",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189499",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189500",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15194#issuecomment-189501",
