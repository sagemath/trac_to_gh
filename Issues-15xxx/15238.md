...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15238#issuecomment-190323",
    "user": "https://trac.sagemath.org/admin/accounts/users/smueller"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15238#issuecomment-190324",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15238#issuecomment-190325",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15238#issuecomment-190326",
    "user": "https://trac.sagemath.org/admin/accounts/users/smueller"
}
```
