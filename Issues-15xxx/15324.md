...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192302",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192303",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192304",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_15324_remove_circular_imports.patch](https://github.com/sagemath/sage/files/ticket15324/trac_15324_remove_circular_imports.patch) by Stefan created at 2013-10-25 21:20:04\n\nOk, this should fix it. There are no more circular imports in sage.matroids (all the ones that used to be there are now imported at method level). Doctests pass.",
    "created_at": "2013-10-25T21:20:04Z",
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192305",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192306",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192307",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192308",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192309",
    "user": "https://github.com/jdemeyer"
}
```
