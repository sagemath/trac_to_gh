...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15427#issuecomment-194328",
    "user": "https://trac.sagemath.org/admin/accounts/users/afiori"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [FiniteFieldPolyCast.patch](https://github.com/sagemath/sage/files/ticket15427/FiniteFieldPolyCast.patch) by afiori created at 2013-11-17 00:42:15",
    "created_at": "2013-11-17T00:42:15Z",
    "issue": "https://github.com/sagemath/sage/issues/15427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15427#issuecomment-194329",
    "user": "https://trac.sagemath.org/admin/accounts/users/afiori"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-136221"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-136222"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-136223"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-136224"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-136225"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-136226"
}
```
