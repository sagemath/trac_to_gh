...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15427#issuecomment-194400",
    "user": "https://github.com/sagetrac-afiori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15427#issuecomment-194401",
    "user": "https://github.com/sagetrac-afiori"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-202293"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-202294"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-202295"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-202296"
}
```
