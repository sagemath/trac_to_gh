...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15427#issuecomment-245763",
    "user": "https://trac.sagemath.org/admin/accounts/users/afiori"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [FiniteFieldPolyCast.patch](tarball://root/attachments/some-uuid/ticket15427/FiniteFieldPolyCast.patch) by afiori created at 2013-11-17 00:42:15",
    "created_at": "2013-11-17T00:42:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15427#issuecomment-245764",
    "user": "https://trac.sagemath.org/admin/accounts/users/afiori"
}
```

<a id='comment:1'></a>Attachment [FiniteFieldPolyCast.patch](tarball://root/attachments/some-uuid/ticket15427/FiniteFieldPolyCast.patch) by afiori created at 2013-11-17 00:42:15
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15427#event-44950"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15427#event-44951"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15427#event-44952"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15427#event-44953"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15427#event-44954"
}
```
