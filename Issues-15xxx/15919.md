...
```json
{
    "body": "<a id='comment:9'></a>\nHey Nicolas,\n\nI've expanded upon what `unrank` can accept (all iterables, even if not in enumerated sets, should now work). I agree the sampling should not use `[i]` to do unranking, but should we push that to another ticket?\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|\n|[5dfb2a2](http://git.sagemath.org/sage.git/commit/?id=5dfb2a2b25e60b0aa46006ecf73a6dc9ac014d46)|`Merge branch 'u/nthiery/ticket/15919' of trac.sagemath.org:sage into u/tscrim/ticket/15919`|\n|[9b8d022](http://git.sagemath.org/sage.git/commit/?id=9b8d022b2651e7f5b40f4a8364c2f29ffb3b55f1)|`Expanded what unrank can handle.`|\n|[d9b5fcd](http://git.sagemath.org/sage.git/commit/?id=d9b5fcd5df001b38300788a963279bc0c8edf4b6)|`Added warning about iterator objects.`|",
    "created_at": "2014-04-22T19:36:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15919",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[2a5eaa5](http://git.sagemath.org/sage.git/commit/?id=2a5eaa5afc10079d97a122e50372eb19c06d390a)|`Fixed double-colon.`|",
    "created_at": "2014-04-23T12:25:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15919",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nReplying to [tscrim](#comment%3A9):\n> I agree the sampling should not use `[i]` to do unranking, but should we push that to another ticket?\n\n\n+1. Let's focus here on what's needed for #10963.\n  \n---\nNew commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[f9b59fa](http://git.sagemath.org/sage.git/commit/?id=f9b59fac8d518a946debc3555a43bdfaea4f1f90)|`Merge branch 'develop=6.2.rc0' into ticket/15919-unrank`|\n|[bbd22f1](http://git.sagemath.org/sage.git/commit/?id=bbd22f1422f7b643a55afabeb44cfd8204b7dd3b)|`- Use __getitem__ only on sequences and Parents not in EnumeratedSets`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[5d2d335](http://git.sagemath.org/sage.git/commit/?id=5d2d335a2e833dfa58589a6453cd011ce05ccb4b)|`Merge branch 'develop' into u/tscrim/ticket/15919`|\n|[382b9ff](http://git.sagemath.org/sage.git/commit/?id=382b9ff1fb969c6f9e01318c654a0e57cc74c89a)|`Merge branch 'u/nthiery/ticket/15919' of trac.sagemath.org:sage into u/tscrim/ticket/15919`|\n|[79d4698](http://git.sagemath.org/sage.git/commit/?id=79d469861431ac8d6be5ad4edeace1c6ac8a62c8)|`Some last very minor tweaks to ranker.py.`|",
