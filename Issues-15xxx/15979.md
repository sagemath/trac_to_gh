...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15979#issuecomment-203539",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkeitel"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Should always be `base_ring` for consistency. Even if we currently only support fields...",
    "created_at": "2014-03-20T12:58:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15979#issuecomment-203540",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Should always be `base_ring` for consistency. Even if we currently only support fields...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15979#issuecomment-203541",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15979#issuecomment-203542",
    "user": "https://github.com/vbraun"
}
```
