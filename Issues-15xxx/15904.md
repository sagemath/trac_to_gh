...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257283",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257286",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257288",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Also outside sage/combinat:\n\n```\nsage: Q = QuadraticForm(ZZ, 3, [1,2,3,4,5,6])\nsage: R = QuadraticForm(ZZ, 3, [1,2,3,4,5,6])\nsage: Q == R\nTrue\nsage: Q != R\nTrue\n```",
    "created_at": "2014-03-30T21:53:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257289",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:7'></a>Also outside sage/combinat:
...
```json
{
    "body": "<a id='comment:8'></a>What do you think about fixing all known cases by hand (fast and kinda urgent) before trying any general approaches?",
    "created_at": "2014-03-30T21:54:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257290",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:8'></a>What do you think about fixing all known cases by hand (fast and kinda urgent) before trying any general approaches?
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15904#event-46779"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15904#event-46780"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15904#event-46781"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257291",
...
```json
{
    "body": "<a id='comment:12'></a>The examples in the ticket description work in Sage 9.7.rc1:\n\n```\nsage: ContreTableaux(4) == ContreTableaux(4)\nTrue\nsage: ContreTableaux(4) != ContreTableaux(4)\nFalse\nsage: Core([1,1],3) != Core([1,1],4)\nTrue\nsage: Core([1,1],3) == Core([1,1],4)\nFalse\n```\n... and as all comparison stuff was changed in the Python 3 transition, I think we can close this ticket as outdated.",
    "created_at": "2022-09-16T22:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257292",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:12'></a>The examples in the ticket description work in Sage 9.7.rc1:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257293",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15904#event-46782"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15904#event-46783"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257294",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257295",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>I didn't see anything in the Python3 docs that seems to have changed this, but it is good Python3 has done something much more sensible:\n\n```\nsage: class Foo:\n....:     def __init__(self, x):\n....:         self.x = x\n....:     def __eq__(self, other):\n....:         return (self.x - other.x) % 2 == 0\n....:         \nsage: F2 = Foo(2)\nsage: F4 = Foo(4)\nsage: F2 == F4\nTrue\nsage: F2 != F4\nFalse\nsage: F2 != None\n---------------------------------------------------------------------------\nAttributeError                            Traceback (most recent call last)\nInput In [6], in <cell line: 1>()\n----> 1 F2 != None\n\nInput In [1], in Foo.__eq__(self, other)\n      4 def __eq__(self, other):\n----> 5     return (self.x - other.x) % Integer(2) == Integer(0)\n\nAttributeError: 'NoneType' object has no attribute 'x'\n```\nGood to know.\n\nSo yes, this can be closed, even for the classes that have not implemented a `__ne__`.",
    "created_at": "2022-09-18T02:45:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257296",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:13'></a>I didn't see anything in the Python3 docs that seems to have changed this, but it is good Python3 has done something much more sensible:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15904#event-46784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15904#issuecomment-257297",
    "user": "https://github.com/mkoeppe"
}
```
