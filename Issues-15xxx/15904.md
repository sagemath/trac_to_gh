...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15904#event-209530"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15904#event-209531"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15904#event-209532"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15904#event-209533"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15904#issuecomment-203948",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15904#issuecomment-203949",
    "user": "https://github.com/tscrim"
}
```
