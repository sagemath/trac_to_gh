...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15837#issuecomment-256070",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I've learned this is a duplicate of #14428.  Let's move to that ticket.",
    "created_at": "2014-04-24T13:02:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15837#issuecomment-256071",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:1'></a>I've learned this is a duplicate of #14428.  Let's move to that ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15837",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15837#event-46597"
}
```
