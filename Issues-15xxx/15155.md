...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15155#issuecomment-239291",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15155#issuecomment-239292",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15155#issuecomment-239293",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15155#issuecomment-239294",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Is it possible to \"give up on pickling\" automatically, i.e. so that there is no need to explicitly clear cache as it was done with toric varieties?",
    "created_at": "2013-09-04T15:45:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15155#issuecomment-239295",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:2'></a>Is it possible to "give up on pickling" automatically, i.e. so that there is no need to explicitly clear cache as it was done with toric varieties?
...
```json
{
    "body": "<a id='comment:9'></a>OK, fair enough. Though thats a bug in Python http://bugs.python.org/issue1761028, though not one that is going to be fixed. It fails for the same reason: the two dictionary keys may have to be identified, but to decide that you need the full object.",
    "created_at": "2013-09-04T20:16:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15155#issuecomment-239302",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>OK, fair enough. Though thats a bug in Python http://bugs.python.org/issue1761028, though not one that is going to be fixed. It fails for the same reason: the two dictionary keys may have to be identified, but to decide that you need the full object.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15155#issuecomment-239305",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15155#event-43687"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15155#event-43688"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15155#event-43689"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15155#event-43690"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15155#event-43691"
}
```
