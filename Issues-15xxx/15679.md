...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[b19dde1](http://git.sagemath.org/sage.git/commit/?id=b19dde1ec37019189d4e986f7de1260846f0b429)|`Moved patch for Singular went untracked.`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[3a72203](http://git.sagemath.org/sage.git/commit/?id=3a7220348f2b5befd5f382fc5a818b9275f78f41)|`Merge remote-tracking branch 'trac/develop' into ticket/15679`|",
