...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15711#issuecomment-200372",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15711#issuecomment-200373",
    "user": "https://github.com/sagetrac-msaaltink"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15711#event-206786"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15711#event-206787"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15711#event-206788"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15711",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15711#event-206789"
}
```
