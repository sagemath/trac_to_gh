...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15443#event-202503"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15443#event-202504"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15443#event-202505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15443#event-202506"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15443#issuecomment-194754",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15443#issuecomment-194755",
    "user": "https://github.com/vbraun"
}
```
