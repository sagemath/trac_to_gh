...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15863#event-209011"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15863#event-209012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15863#event-209013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15863#event-209014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15863#issuecomment-203311",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15863#issuecomment-203312",
    "user": "https://github.com/vbraun"
}
```
