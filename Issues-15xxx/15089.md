...
```json
{
    "body": "<a id='comment:1'></a>The init methods of `RealDistribution`, `GeneralDiscreteDistribution` and `SphericalDistribution` all handle the `seed == None` case, but otherwise fail to copy a value of the seed keyword into `self.seed` before making use of it.  Could be three one-line fixes, just capture this value from the keyword into the class.",
    "created_at": "2013-08-24T00:50:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237769",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:1'></a>The init methods of `RealDistribution`, `GeneralDiscreteDistribution` and `SphericalDistribution` all handle the `seed == None` case, but otherwise fail to copy a value of the seed keyword into `self.seed` before making use of it.  Could be three one-line fixes, just capture this value from the keyword into the class.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237770",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237771",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237772",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_15089-gsl-seed-keyword.patch](tarball://root/attachments/some-uuid/ticket15089/trac_15089-gsl-seed-keyword.patch) by @rbeezer created at 2013-08-24 04:10:47\n\nHad to fix one other doctest, which was previously passing only because of the bug fixed here.  Patch passes all tests, etc on 5.11.\n\nLots of places where this module could use some love.",
    "created_at": "2013-08-24T04:10:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237773",
    "user": "https://github.com/rbeezer"
}
```

<a id='comment:2'></a>Attachment [trac_15089-gsl-seed-keyword.patch](tarball://root/attachments/some-uuid/ticket15089/trac_15089-gsl-seed-keyword.patch) by @rbeezer created at 2013-08-24 04:10:47
...
```json
{
    "body": "<a id='comment:3'></a>ok, looks good to me. And indeed the code needs more attention and care..",
    "created_at": "2013-09-07T17:32:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237774",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>ok, looks good to me. And indeed the code needs more attention and care..
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237775",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237776",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237777",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15089#issuecomment-237778",
    "user": "https://github.com/jdemeyer"
}
```
