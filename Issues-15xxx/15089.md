...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15089#issuecomment-187713",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15089#issuecomment-187714",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15089#issuecomment-187715",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket15089/trac_15089-gsl-seed-keyword.patch",
    "created_at": "2013-08-24T04:10:47Z",
    "issue": "https://github.com/sagemath/sage/issues/15089",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15089/trac_15089-gsl-seed-keyword.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_15089-gsl-seed-keyword.patch](https://github.com/sagemath/sage/files/ticket15089/trac_15089-gsl-seed-keyword.patch) by @rbeezer created at 2013-08-24 04:10:47\n\nHad to fix one other doctest, which was previously passing only because of the bug fixed here.  Patch passes all tests, etc on 5.11.\n\nLots of places where this module could use some love.",
    "created_at": "2013-08-24T04:10:47Z",
    "issue": "https://github.com/sagemath/sage/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15089#issuecomment-187716",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15089#issuecomment-187717",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15089#issuecomment-187718",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15089#issuecomment-187719",
