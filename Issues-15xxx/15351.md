...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket15351/failed_import_statements",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket15351/fix_import_statements.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket15351/answer_sage_all",
...
```json
{
    "body": "the list of import_statements that answer \"from sage.all import XXX\"",
    "created_at": "2013-11-03T23:29:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15351",
    "type": "issue_comment",
