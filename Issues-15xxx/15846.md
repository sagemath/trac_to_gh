...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15846#event-46623"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15846#event-46624"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15846#event-46625"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Well, although there definitely is that problem in SymPy, the erronous expansion in sage seems to originate from Ginac:\n\n```\nbehackl@Jethro ~ $ ginsh\nginsh - GiNaC Interactive Shell (GiNaC V1.6.3)\n  __,  _______  Copyright (C) 1999-2014 Johannes Gutenberg University Mainz,\n (__) *       | Germany.  This is free software with ABSOLUTELY NO WARRANTY.\n  ._) i N a C | You are welcome to redistribute it under certain conditions.\n<-------------' For details type `warranty;'.\n\nType ?? for a list of help topics.\n> series(zeta(x+1), x, 2);\n(zeta(1))+(zetaderiv(1,1))*x+Order(x^2)\n```\n\nThis is exactly the output as in sage itself.\n\nThe zeta function does not seem to be very popular in that matter. ;-)",
    "created_at": "2015-04-07T17:49:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256167",
    "user": "https://github.com/behackl"
}
```

<a id='comment:4'></a>Well, although there definitely is that problem in SymPy, the erronous expansion in sage seems to originate from Ginac:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256169",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256171",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256172",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [zeta_expansion.patch](tarball://root/attachments/some-uuid/ticket15846/zeta_expansion.patch) by @behackl created at 2015-04-08 08:51:34\n\nReplying to [rws](#comment%3A8):\n\n\n> Replying to [behackl](#comment%3A7):\n> \n> > I managed to find a fix for the problem in GiNaC, which should -- more or less -- directly translate into a fix for Pynac, which Sage uses as a substitute for GiNaC.\n> > \n\n> What do you mean? If it's a patch on top of recent GiNaC it might not be applicable to Pynac.\n\nWell, I just implemented `zeta1_series` in `ginac/inifcns_nstdsums.cpp` -- I don't really know, do you think that would fix the problem in Pynac too? (See attachment.)",
    "created_at": "2015-04-08T08:51:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256173",
    "user": "https://github.com/behackl"
}
```

<a id='comment:9'></a>Attachment [zeta_expansion.patch](tarball://root/attachments/some-uuid/ticket15846/zeta_expansion.patch) by @behackl created at 2015-04-08 08:51:34
...
```json
{
    "body": "<a id='comment:11'></a>> I do not have the impression that Pynac has ever upgraded its GiNaC part since the point in time the fork was made.\n\nAh okay, I thought you made a patch on top of The Official GiNaC, i.e., http://www.ginac.de/ginac.git/",
    "created_at": "2015-04-08T09:22:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256175",
    "user": "https://github.com/rwst"
}
```

<a id='comment:11'></a>> I do not have the impression that Pynac has ever upgraded its GiNaC part since the point in time the fork was made.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256177",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256178",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256179",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I have posted at https://groups.google.com/forum/?hl=en#!topic/sage-devel/hwQXxFmutcU",
    "created_at": "2015-04-08T12:57:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256180",
    "user": "https://github.com/rwst"
}
```

<a id='comment:15'></a>I have posted at https://groups.google.com/forum/?hl=en#!topic/sage-devel/hwQXxFmutcU
...
```json
{
    "body": "<a id='comment:16'></a>Thanks! Let me know if there is anything I can do to help.",
    "created_at": "2015-04-08T14:58:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256181",
    "user": "https://github.com/behackl"
}
```

<a id='comment:16'></a>Thanks! Let me know if there is anything I can do to help.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256182",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Done. For the sake of completeness: the upstream fix can be found at https://github.com/pynac/pynac/pull/1\n\nI'll leave this ticket's status as `new` until I can set the Pynac-update ticket as a dependency.",
    "created_at": "2015-04-10T13:33:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256183",
    "user": "https://github.com/behackl"
}
```

<a id='comment:18'></a>Done. For the sake of completeness: the upstream fix can be found at https://github.com/pynac/pynac/pull/1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256184",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256185",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256186",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Oh, sorry -- I did not read the part with the doctest that should demonstrate numerics. \n\nDo you mean something like\n\n```\nsage: zeta(x).series(x==1, 1).coefficient(x, 0).n()\n0.577215664901533\n```",
    "created_at": "2015-04-10T13:36:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256187",
    "user": "https://github.com/behackl"
}
```

<a id='comment:19'></a>Oh, sorry -- I did not read the part with the doctest that should demonstrate numerics. 
...
```json
{
    "body": "<a id='comment:20'></a>Not sure if it's necessary, or even correct, to compare `zeta(x).series(x=1,3).subs(x=.999).n()` with `zeta(.999)`.",
    "created_at": "2015-04-10T13:39:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256188",
    "user": "https://github.com/rwst"
}
```

<a id='comment:20'></a>Not sure if it's necessary, or even correct, to compare `zeta(x).series(x=1,3).subs(x=.999).n()` with `zeta(.999)`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256189",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256190",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15846#event-46626"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15846#event-46627"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256191",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256192",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256193",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256194",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Is fine, thanks.",
    "created_at": "2015-04-11T14:51:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256195",
    "user": "https://github.com/rwst"
}
```

<a id='comment:24'></a>Is fine, thanks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256196",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256197",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15846#issuecomment-256198",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15846",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15846#event-46628"
}
```
