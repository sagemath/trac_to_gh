...
```json
{
    "body": "At least the behaviour is intentional, so it's by definition not a bug. Perhaps it's a bad design decision. But if you want to argue for that, please do it on `sage-devel`, not this ticket.",
...
```json
{
    "body": "If you care about this, please discuss it on `sage-devel`.",
...
```json
{
    "body": "I'm closing this ticket, please direct any future discussion to sage-devel thread at\nhttps://groups.google.com/d/msg/sage-devel/c2Ih4uglTgQ/iGSIpTwuoBsJ",
