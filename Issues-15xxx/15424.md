...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15424#event-202210"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15424#event-202211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15424#event-202212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15424#event-202213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15424#issuecomment-194362",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15424#issuecomment-194363",
    "user": "https://github.com/jdemeyer"
}
```
