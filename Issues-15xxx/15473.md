...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136729"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136730"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket15473/trac_15473-sym-dg.patch",
    "created_at": "2013-12-01T01:31:40Z",
    "issue": "https://github.com/sagemath/sage/issues/15473",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15473/trac_15473-sym-dg.patch",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>\n**Attachment:** [trac_15473-sym-dg.patch](https://github.com/sagemath/sage/files/ticket15473/trac_15473-sym-dg.patch)",
    "created_at": "2013-12-01T01:31:40Z",
    "issue": "https://github.com/sagemath/sage/issues/15473",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136731"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136732"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136733"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136734"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136735"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136736"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15473",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15473#event-136737"
}
```
