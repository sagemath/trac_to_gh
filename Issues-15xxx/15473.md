...
```json
{
    "body": "<a id='comment:12'></a>\nHey Darij,\n\nI've converted this to a branch, removed the deprecated functions (15 months old) except the k-Schurs (they are more tricky), and formally deprecated `SymmetricFunctionAlgebra`. If you agree with my changes, then we can set this to positive review.\n\nBest,\n\nTravis\n\nFor the record, the doctests are re-enabled at #15475.\n\n---\nNew commits:\n|                                                                                                         |                                                              |\n|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[4277d46](http://git.sagemath.org/sage.git/commit/?id=4277d46)|Removed deprecated functions from HL, Jack, an Macdonald SF's.|\n|[df59b0a](http://git.sagemath.org/sage.git/commit/?id=df59b0a)|Removed deprecated LLT functions and fixed kschur.py doctests.|\n|[ddea29a](http://git.sagemath.org/sage.git/commit/?id=ddea29a)|Removed additional SymmetricFunctionAlgebras in symmetrica.pxi.|\n|[35e6b34](http://git.sagemath.org/sage.git/commit/?id=35e6b34)|trac #15473: symmetric function fixes|",
    "created_at": "2013-12-16T19:02:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15473",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                                                          |\n|---------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|\n|[7f9be88](http://git.sagemath.org/sage.git/commit/?id=7f9be88)|reinstating a couple doctests, and removing a superficial Qqt definition (there were two in the same file)|\n|[ca45cad](http://git.sagemath.org/sage.git/commit/?id=ca45cad)|Merge branch 'public/combinat/sf/fixes-15473' of trac.sagemath.org:sage into 15473|",
