...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15696#event-139346"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15696#event-139347"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15696#event-139348"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15696#event-139349"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15696#event-139350"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15696#event-139351"
}
```
...
archive/attachments_020486.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "all_categories.py",
    "asset_url": "tarball://root/attachments/some-uuid/ticket15696/all_categories.py",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15696",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15696#issuecomment-199996",
    "user": "https://github.com/nthiery"
}
```
