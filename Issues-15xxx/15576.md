...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15576#issuecomment-197348",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15576#issuecomment-197349",
    "user": "https://github.com/sagetrac-tfeulner"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15576#event-204595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15576#event-204596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15576#event-204597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15576",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15576#event-204598"
}
```
