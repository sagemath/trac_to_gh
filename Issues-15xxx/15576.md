...
```json
{
    "body": "I think there should be only this single occurrence of the `__mul__` method in the file. Maybe you can check this with your tests?\n\n---\nNew commits:\n|                                                                                                         |                                                                                                                  |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|\n|[c297a9a](http://git.sagemath.org/sage.git/commit/?id=c297a9a)|`Make semimonomial transformations independent on the global variable governing product order of multiplications.`|",
    "created_at": "2013-12-27T10:26:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15576",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                     |\n|---------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[d8cd6e3](http://git.sagemath.org/sage.git/commit/?id=d8cd6e3)|`Minor changes to the documentation.`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                        |\n|---------------------------------------------------------------------------------------------------------|------------------------|\n|[6155cf9](http://git.sagemath.org/sage.git/commit/?id=6155cf9)|`Improved documentation`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nNew commits:\n|                                                                                                                                          |                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[adac1c9](http://git.sagemath.org/sage.git/commit/?id=adac1c9aaf08cd237085ec5c198fb1297f676e3f)|`Merge branch 'u/tfeulner/ticket/15576' of trac.sagemath.org:sage into 15576`|\n|[cbb5110](http://git.sagemath.org/sage.git/commit/?id=cbb5110ab7080629764e9ebeee44e117ad380ca6)|`some more doc fixes`|",
    "created_at": "2014-01-06T19:27:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15576",
    "type": "issue_comment",
