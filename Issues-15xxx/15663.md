...
```json
{
    "body": "<a id='comment:8'></a>Oooops! There were no `l`s. I mistook one of my `i`s for an `l` on cursory reading (good argument in favor of your change).\n\nPositive review; thanks again!\n\nBest regards,\\\\\nDarij",
    "created_at": "2014-01-16T16:32:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15663",
    "type": "issue_comment",
...
<a id='comment:8'></a>Oooops! There were no `l`s. I mistook one of my `i`s for an `l` on cursory reading (good argument in favor of your change).
