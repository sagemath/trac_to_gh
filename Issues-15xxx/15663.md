...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15663#event-205992"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15663#event-205993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15663#event-205994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15663#event-205995"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15663#issuecomment-199427",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15663#issuecomment-199428",
    "user": "https://github.com/tscrim"
}
```
