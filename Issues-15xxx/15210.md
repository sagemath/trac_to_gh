...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15210#issuecomment-189759",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15210#issuecomment-189760",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15210#issuecomment-189761",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15210#issuecomment-189762",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket15210/trac_15210-operation_table-latex-nt.patch",
    "created_at": "2013-11-05T14:06:32Z",
    "issue": "https://github.com/sagemath/sage/issues/15210",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15210/trac_15210-operation_table-latex-nt.patch",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac_15210-operation_table-latex-nt.patch](https://github.com/sagemath/sage/files/ticket15210/trac_15210-operation_table-latex-nt.patch) by @nthiery created at 2013-11-05 14:06:32\n\nOops, how did I missed this??? Thanks for the report ... Fixed in the updated patch.",
    "created_at": "2013-11-05T14:06:32Z",
    "issue": "https://github.com/sagemath/sage/issues/15210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15210#issuecomment-189763",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15210#issuecomment-189764",
    "user": "https://github.com/jdemeyer"
}
```
