...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[f654144](http://git.sagemath.org/sage.git/commit/?id=f6541444499809d3af167c9a3632baa98449b0f2)|`trac #15864: Graph.is_distance_regular is awfully wrong`|",
    "created_at": "2014-02-26T15:15:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15864",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nReplying to [dimpase](#comment%3A8):\nNathann, if you're happy with my changes, I'll make it positive review.\nLet's postpone ```foo.is_bla...``` cleanup to another ticket.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[e5a990d](http://git.sagemath.org/sage.git/commit/?id=e5a990dd8f2b0ff38dcee683e9d59182d2614eb1)|`fixed typos, corrected the definitions of b, c, chnaged the way they are returned, one more example`|",
    "created_at": "2014-02-28T10:49:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15864",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[0b540be](http://git.sagemath.org/sage.git/commit/?id=0b540be503548ad881305f820552bc06d14b0771)|`docs fix: returning (b,c), not (c,b)`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[e5a990d](http://git.sagemath.org/sage.git/commit/?id=e5a990dd8f2b0ff38dcee683e9d59182d2614eb1)|`fixed typos, corrected the definitions of b, c, chnaged the way they are returned, one more example`|\n|[0b540be](http://git.sagemath.org/sage.git/commit/?id=0b540be503548ad881305f820552bc06d14b0771)|`docs fix: returning (b,c), not (c,b)`|\n|[20c5a2a](http://git.sagemath.org/sage.git/commit/?id=20c5a2ad3ec2074eb2c89ca27622907a2e115557)|`trac #15864: bugfix et None dans bi et ci`|",
    "created_at": "2014-03-03T14:04:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15864",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[f654144](http://git.sagemath.org/sage.git/commit/?id=f6541444499809d3af167c9a3632baa98449b0f2)|`trac #15864: Graph.is_distance_regular is awfully wrong`|\n|[e5a990d](http://git.sagemath.org/sage.git/commit/?id=e5a990dd8f2b0ff38dcee683e9d59182d2614eb1)|`fixed typos, corrected the definitions of b, c, chnaged the way they are returned, one more example`|\n|[0b540be](http://git.sagemath.org/sage.git/commit/?id=0b540be503548ad881305f820552bc06d14b0771)|`docs fix: returning (b,c), not (c,b)`|\n|[1555dc7](http://git.sagemath.org/sage.git/commit/?id=1555dc73342281eceff49b0c0fc66d78b58bdbc6)|`trac #15854: consistency between code and doc, and None in bi and ci`|",
    "created_at": "2014-03-03T15:09:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15864",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[f654144](http://git.sagemath.org/sage.git/commit/?id=f6541444499809d3af167c9a3632baa98449b0f2)|`trac #15864: Graph.is_distance_regular is awfully wrong`|\n|[e5a990d](http://git.sagemath.org/sage.git/commit/?id=e5a990dd8f2b0ff38dcee683e9d59182d2614eb1)|`fixed typos, corrected the definitions of b, c, chnaged the way they are returned, one more example`|\n|[0b540be](http://git.sagemath.org/sage.git/commit/?id=0b540be503548ad881305f820552bc06d14b0771)|`docs fix: returning (b,c), not (c,b)`|\n|[faffd86](http://git.sagemath.org/sage.git/commit/?id=faffd868037a80a5ad04a5a7cf260f13da4a0e35)|`trac #15864: consistency between code and doc, and None in bi and ci`|",
