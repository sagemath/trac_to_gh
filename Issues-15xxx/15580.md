...
```json
{
    "body": "<a id='comment:5'></a>\nI've exported `prereq-1.2`'s history to the root directory with no cleanup (e.g. there is still the hgignore).\n\n---\nNew commits:\n|                                                                                                         |                     |\n|---------------------------------------------------------------------------------------------------------|---------------------|\n|[0881c74](http://git.sagemath.org/sage.git/commit/?id=0881c74)|`Merge in prereq-1.2`|\n|[cb5e072](http://git.sagemath.org/sage.git/commit/?id=cb5e072)|`Trac #14406: remove sqrtl() and SAGE_FORTRAN/SAGE_FORTRAN_LIB checks`|\n|[e98db82](http://git.sagemath.org/sage.git/commit/?id=e98db82)|`trac 13385: Remove check for openssl.`|\n|[e63837b](http://git.sagemath.org/sage.git/commit/?id=e63837b)|`Trac #13329: Add -lcrypto and -ldl (needed for -lssl), support SAGE_LOCAL`|\n|[48b54aa](http://git.sagemath.org/sage.git/commit/?id=48b54aa)|`Trac #13329: small reviewer fixes`|\n|[ac675c6](http://git.sagemath.org/sage.git/commit/?id=ac675c6)|`make dpgk-architecture check error out, its at least in Ubuntu 8.04`|\n|[73f867d](http://git.sagemath.org/sage.git/commit/?id=73f867d)|`added openssl and dpkg-architecture check`|\n|[6b9c3e9](http://git.sagemath.org/sage.git/commit/?id=6b9c3e9)|`Trac #12112: Support --disable-compiler-checks option`|\n|[ea08e9b](http://git.sagemath.org/sage.git/commit/?id=ea08e9b)|`Initialization of repository`|",
...
```json
{
    "body": "<a id='comment:77'></a>\nNew commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[d042722](http://git.sagemath.org/sage.git/commit/?id=d0427228339f59811fc41d0ecb861d7e5e64a99a)|`bootstrap configure: small fixes`|",
    "created_at": "2014-01-12T19:45:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15580",
    "type": "issue_comment",
