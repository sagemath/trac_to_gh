...
```json
{
    "body": "<a id='comment:1'></a>Could you please post code (namely a class definition of parents and elements), showcasing what the sage-devel discussion is about (namely `x in X` requiring that `x.parent()` and/or `X` implement `_an_element_()`)?",
    "created_at": "2014-02-14T20:08:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255787",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>Could you please post code (namely a class definition of parents and elements), showcasing what the sage-devel discussion is about (namely `x in X` requiring that `x.parent()` and/or `X` implement `_an_element_()`)?
...
```json
{
    "body": "<a id='comment:4'></a>Blimy, it already **is** tested whether self._convert_method_name is None!\n\nSo, why is this code executed???",
    "created_at": "2014-02-14T20:55:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255790",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>Blimy, it already **is** tested whether self._convert_method_name is None!
...
```json
{
    "body": "<a id='comment:5'></a>Me stupid: The _convert_method_name of the codomain is requested, which is not None for ZZ.\n\nSo, forget what I suggested above.",
    "created_at": "2014-02-14T20:58:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255791",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Me stupid: The _convert_method_name of the codomain is requested, which is not None for ZZ.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15821#event-46532"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15821#event-46533"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15821#event-46534"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255793",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15821#event-46535"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15821#event-46536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255794",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Hello Simon,\n\nindeed the bug seems to be fixed. Do I just need to \"review\" the empty ticket in order to close it ?\n\nAladin",
    "created_at": "2015-07-24T17:16:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255795",
    "user": "https://github.com/avirmaux"
}
```

<a id='comment:9'></a>Hello Simon,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255797",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15821#event-46537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15821#issuecomment-255798",
