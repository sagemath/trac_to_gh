...
```json
{
    "body": "<a id='comment:2'></a>\nI know it's not needs_review, but you cannot yet rely on C++11. With GCC 4.6.3:\n\n```\ncc1plus: error: unrecognized command line option \u2018-std=c++11\u2019\n```\n\n---\nLast 10 new commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[2843bf3](http://git.sagemath.org/sage.git/commit/?id=2843bf3ac74d1775d7a4183b2bd9ef9f7e2109a6)|`Add enumeration of short vectors to sage.`|\n|[f337fae](http://git.sagemath.org/sage.git/commit/?id=f337fae187c4e1b6dfaa5377d40f0a68bf9cbdaa)|`Refactor enumeration of short vectors`|\n|[a6d5ce8](http://git.sagemath.org/sage.git/commit/?id=a6d5ce8a6825e192975f657ec42f886674837c25)|`Sketch wrapper for enumeration of short vectors`|\n|[b7dbede](http://git.sagemath.org/sage.git/commit/?id=b7dbedecb9a50b2fbab9b7fb7e4937debaf5d46d)|`Add cython wrapper to enumeration of short vectors.`|\n|[269cc4b](http://git.sagemath.org/sage.git/commit/?id=269cc4bed96fcdf8456ba8f38597671987e27588)|`Complete python interface for enumeration of short vectors.`|\n|[aef8cf1](http://git.sagemath.org/sage.git/commit/?id=aef8cf137b413ee9c478797c8941fc2d394ee4a2)|`Remove cython wrapper for enumeration of short vectors.`|\n|[3d33d53](http://git.sagemath.org/sage.git/commit/?id=3d33d532b70e3b733f775b0adfb864a790201361)|`Update header and add missing implementation of enumeration internals.`|\n|[46f4d25](http://git.sagemath.org/sage.git/commit/?id=46f4d254c20d1ed0e66586318fd9ec7ef23eb1d0)|`Add enumeration of short vectors to the modulue list.`|\n|[1557395](http://git.sagemath.org/sage.git/commit/?id=1557395f2314905208edc72461358850891b1630)|`Update python wrapper for enumeration of short vectors.`|\n|[338ad31](http://git.sagemath.org/sage.git/commit/?id=338ad317d9a6267c8f0ae343e8663ed32f229477)|`Use new short vectors implementation in QuadraticForm(...).short_vector_list_up_to_length(...).`|",
