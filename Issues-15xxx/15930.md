...
```json
{
    "body": "<a id='comment:3'></a>Seems fixed now (sage 7.6 beta 4). Needs a test?\nThen needs review.",
...
<a id='comment:3'></a>Seems fixed now (sage 7.6 beta 4). Needs a test?
Then needs review.
...
```json
{
    "body": "<a id='comment:4'></a>I propose to close this one as \"garbage in, garbage out\".",
...
<a id='comment:4'></a>I propose to close this one as "garbage in, garbage out".
...
<a id='comment:5'></a>I actually get a now:
