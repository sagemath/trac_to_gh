...
<a id='comment:12'></a>Rebased this. Funny, I was coding something along the same lines at the moment, before[comment:34](#comment%3A34):ticket:16533 made me aware of this ticket here.
...
<a id='comment:13'></a>Replying to [gagern](#comment%3A12):
> If I were to fix this, I would be using my own code for this. Jeroen, could we review one another's code for this?
...
<a id='comment:19'></a>Replying to [jdemeyer](#comment%3A13):
>> Jeroen, could we review one another's code for this?
