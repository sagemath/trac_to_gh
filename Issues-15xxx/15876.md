...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15876#event-209196"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15876#event-209197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15876#event-209198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15876#event-209199"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15876#issuecomment-203601",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15876#issuecomment-203602",
    "user": "https://github.com/vbraun"
}
```
