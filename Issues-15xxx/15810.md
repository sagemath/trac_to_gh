...
```json
{
    "body": "<a id='comment:7'></a>\nNew commits:\n|                                                                                                                                          |                                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|\n|[175027d](http://git.sagemath.org/sage.git/commit/?id=175027d2d3c94fc973c2100e8cc3576c0c06d0ef)|`Merge branch 'u/SimonKing/ticket/15623' of git://trac.sagemath.org/sage into ticket/15810`|\n|[1382f4f](http://git.sagemath.org/sage.git/commit/?id=1382f4f40bea6fbf32af4f0f745aa2f645a235af)|`Trac 15810: Replace ._directed by .directed for immutable graph backend`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nI updated the branch with a new commit. I set it as this ticket's branch so that you can see it more easily. The only `.directed` that remain are those of SubgraphSearch in `generic_graph_pyx.pyx`.\n\nNathann\n\n---\nNew commits:\n|                                                                                                                                          |                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[e9796a1](http://git.sagemath.org/sage.git/commit/?id=e9796a13f5f8304f42cebc07728bcefb32c83e0a)|`trac #15810: Immutable directed graphs should know that they are directed`|\n|[d6ca86c](http://git.sagemath.org/sage.git/commit/?id=d6ca86c1d6984bc7a468b80905ddec01323cc9b6)|`trac #15810: The graph data structures may have a ._directed but no .directed`|",
