# Issue 15579: improve documentation for reviewers
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15579#event-46515"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15579#event-46516"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15579#event-46517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15579",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15579#event-46518"
}
```
