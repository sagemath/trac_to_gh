...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196430",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196431",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15290#event-45363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196432",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196433",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196434",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196435",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15290#event-45364"
}
```
...
```json
{
    "body": "When you make the commit you can't know for sure in which ticket the commit ends up. You can guess, but if you guess wrong its impossible to change (commits are immutable after all). The ticket can easily be found by following forward to the next release manager commit, e.g. automatized by \"git trac find <sha1>\"",
    "created_at": "2014-08-12T11:13:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196437",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196438",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196439",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196441",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "By the way, I think this shows that the optional directory argument no longer works properly, or so it seems from the way it tries to cd into the temp directory twice... :-(",
    "created_at": "2014-08-14T13:36:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15290#issuecomment-196442",
    "user": "https://github.com/kcrisman"
}
```
