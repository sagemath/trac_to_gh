...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|\n|[54668ef](http://git.sagemath.org/sage.git/commit/?id=54668ef30af357ee362c2ed0ec05b8ac8dd2f049)|`Delete #random on some matrix constructor doctests that now depend on Sage's random state`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[a488b58](http://git.sagemath.org/sage.git/commit/?id=a488b585b5afaaab46d1eea53671c4c87e83a8c5)|`Merge branch 'develop' into t/15887/ticket/15887`|",
    "created_at": "2014-10-20T23:52:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15887",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[8e059c4](http://git.sagemath.org/sage.git/commit/?id=8e059c46a1efc72cf9a8eb3253ae88bb24b7c611)|`Fix output precision.`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[0de2c9a](http://git.sagemath.org/sage.git/commit/?id=0de2c9a00ca58d05e12f63a0a09cb688e59519c1)|`Change the max seed to 2^31.`|\n|[9a7bc85](http://git.sagemath.org/sage.git/commit/?id=9a7bc85f68d1ab0b291edddfadea888f6a536b99)|`Fix doctests for new random output.`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[a5e39f8](http://git.sagemath.org/sage.git/commit/?id=a5e39f86d5e4772f0d0a3b67fd5a9cd44fe21c6b)|`Add rel tol for numeric noise.`|",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[2f0e3fb](http://git.sagemath.org/sage.git/commit/?id=2f0e3fbe1d3b07e2f91e753268419dff9f0da3f4)|`Add numerical tolerance settings`|\n|[3b993ee](http://git.sagemath.org/sage.git/commit/?id=3b993ee0ebc93555634876b6f3fe3938854530c0)|`Fix numerical deviation reported on sage-release`|\n|[3b66fb5](http://git.sagemath.org/sage.git/commit/?id=3b66fb5c55830e6a3243cbbcaeae7b643b6d48c5)|`Merge commit '3b993ee0ebc93555634876b6f3fe3938854530c0' into t/15887/ticket/15887`|",
    "created_at": "2014-11-05T19:02:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15887",
    "type": "issue_comment",
