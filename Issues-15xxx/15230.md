...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44037"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44038"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44039"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44040"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44041"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44042"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44043"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This appears to have been fixed at some point; probably by #15623.",
    "created_at": "2019-01-07T13:10:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15230#issuecomment-240848",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>This appears to have been fixed at some point; probably by #15623.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15230",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15230#event-44044"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15230#issuecomment-240849",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15230#issuecomment-240850",
    "user": "https://github.com/embray"
}
```
