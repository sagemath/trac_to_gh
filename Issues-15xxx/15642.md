...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[3967968](http://git.sagemath.org/sage.git/commit/?id=39679681f304dcdf6df195fbc71254cebd395444)|`Merge tag '6.1.beta4' into 'u/vbraun/use_mirrors_for_tarballs'`|\n|[dd4abcb](http://git.sagemath.org/sage.git/commit/?id=dd4abcb7757c17e5a7bae9cf347c9d34e154503d)|`py3 fix, also try testing packages`|",
    "created_at": "2014-01-13T06:14:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15642",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[b1ef0b6](http://git.sagemath.org/sage.git/commit/?id=b1ef0b663cff6fdbcb2ae9cefad7d72c14605b49)|`prefer SAGE_DISTFILES for upstream directory`|",
    "created_at": "2014-01-13T19:17:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15642",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[cd155cf](http://git.sagemath.org/sage.git/commit/?id=cd155cf944bcdede7c6489fc489511703c10c8ad)|`more general tarball regex`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nI added a few extra commits to resolve a couple of small bugs I noticed. Pending someone signing off on those, and testing on various versions of python, this looks good to me.\n\n---\nNew commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[f647251](http://git.sagemath.org/sage.git/commit/?id=f647251e0ab3ac78220005f48c2883f16a94a974)|`remove commented out old code`|\n|[905df09](http://git.sagemath.org/sage.git/commit/?id=905df0918db48496ca824879cdb22da2d683f54c)|`rework environment stuff a bit`|\n|[991de26](http://git.sagemath.org/sage.git/commit/?id=991de268a9fd9bc0ff4bd94295d8b6cfbe78015e)|`don't actually write unsorted mirror list to disk`|",
    "created_at": "2014-01-21T09:05:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15642",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[d9c0318](http://git.sagemath.org/sage.git/commit/?id=d9c0318daf085da3f96a66a8450721b5dfe800a2)|`Merge 6.7.beta4 into #15642`|\n|[a4f9892](http://git.sagemath.org/sage.git/commit/?id=a4f9892ffa9c1bd83be490253a9abbd3a5c9e4cc)|`Ignore the single ftp-only mirror for now`|\n|[33bf83f](http://git.sagemath.org/sage.git/commit/?id=33bf83f60c6332bd06d19c177638b00e0e918354)|`Use the new sage-download-file script to download all packages`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[a7afa48](http://git.sagemath.org/sage.git/commit/?id=a7afa48370ccba8b406a3f820b76ff522bea600c)|`Add a SAGE_MIRROR environment variable`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[9a06850](http://git.sagemath.org/sage.git/commit/?id=9a06850aa7e90080cd1841ce7a4aea46da25ccc1)|`fix usage doc`|",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[d9e66ac](http://git.sagemath.org/sage.git/commit/?id=d9e66acabedfe0ae55b961482bfa4ec3515257ec)|`no backtrace on IOError`|",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------|\n|[30b1647](http://git.sagemath.org/sage.git/commit/?id=30b1647e7b6a527e72daa7835f26a710306a6099)|`fix mirror uri`|",
...
```json
{
    "body": "<a id='comment:60'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[27b71e5](http://git.sagemath.org/sage.git/commit/?id=27b71e517fef3594dffe282b99c2538d02ebf5a8)|`remove ftp from docs for now`|\n|[a103ab5](http://git.sagemath.org/sage.git/commit/?id=a103ab5dd842e5a6f24970a42649e4df8935a9da)|`Use SAGE_SERVER instead of SAGE_MIRROR`|",
...
```json
{
    "body": "<a id='comment:65'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[a259f27](http://git.sagemath.org/sage.git/commit/?id=a259f27b95e1b69fbdde1a4b0e8496996cd427fe)|`rename SAGE_SERVER/packages to SAGE_SERVER/spkg`|",
    "created_at": "2015-05-09T15:16:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15642",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:68'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[d79364b](http://git.sagemath.org/sage.git/commit/?id=d79364b9fc5131199eaed14340582715f2f937fb)|`fix sage-list-packages`|",
    "created_at": "2015-05-09T15:24:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15642",
    "type": "issue_comment",
