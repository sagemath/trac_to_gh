...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246064",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246065",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/ncohen/15439\"",
    "created_at": "2013-12-05T11:19:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246066",
    "user": "https://github.com/nathanncohen"
}
```

Changing branch from "" to "u/ncohen/15439"
...
```json
{
    "body": "<a id='comment:4'></a>Hello ! I tried twice to update the constructor of `Permutation` to add a `shift_input_by_one=False` flag, but each time it convinced me that it was bad work. Plus I don't think that this is the good way out -- the good way out is to have permutations on arbitrary objects.\n\nHence I did not touch permutation.py. Err, I just changed a few calls to `all()` to prevent them from building a long useless list of `[False, False, False, False]`. And I wrote the doc of this isotopism thing, and avoided this `*` on multiplications.\n\nBut honestly, I think you have no way to ensure that nobody will ever use this `*` in Sage code without worrying over this multiplication order.\n\nNathann",
    "created_at": "2013-12-05T11:19:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246067",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Hello ! I tried twice to update the constructor of `Permutation` to add a `shift_input_by_one=False` flag, but each time it convinced me that it was bad work. Plus I don't think that this is the good way out -- the good way out is to have permutations on arbitrary objects.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246068",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246069",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"a1b05a808faf8052618f31f2eebd855082b7da29\"",
    "created_at": "2013-12-05T11:20:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246070",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "a1b05a808faf8052618f31f2eebd855082b7da29"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246071",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing branch from \"u/ncohen/15439\" to \"u/darij/ticket/15439\"",
    "created_at": "2013-12-10T08:00:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246072",
    "user": "https://github.com/darijgr"
}
```

Changing branch from "u/ncohen/15439" to "u/darij/ticket/15439"
...
```json
{
    "body": "<a id='comment:7'></a>Review patch uploaded. I'd rather have put it into the `public` namespace, but I've forgotten how to do that using the dev scripts (and if I use git manually, how do I reset the Branch field on the ticket?).\n\nI put back one newline you removed since I found it reasonable.\n\nmeld seems to do creepy stuff; I have checked the sanity of the merge manually using diff.",
    "created_at": "2013-12-10T08:02:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246073",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:7'></a>Review patch uploaded. I'd rather have put it into the `public` namespace, but I've forgotten how to do that using the dev scripts (and if I use git manually, how do I reset the Branch field on the ticket?).
...
```json
{
    "body": "Changing branch from \"u/darij/ticket/15439\" to \"u/ncohen/15439\"",
    "created_at": "2013-12-10T08:02:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246074",
    "user": "https://github.com/darijgr"
}
```

Changing branch from "u/darij/ticket/15439" to "u/ncohen/15439"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246075",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "Changing commit from \"a1b05a808faf8052618f31f2eebd855082b7da29\" to \"b484c8a59a690c0232097e4ae40ef58c6e813837\"",
    "created_at": "2013-12-10T09:27:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246077",
    "user": "https://github.com/nathanncohen"
}
```

Changing commit from "a1b05a808faf8052618f31f2eebd855082b7da29" to "b484c8a59a690c0232097e4ae40ef58c6e813837"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246078",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15439#event-44981"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Well, the edits to `permutation.py` conflicted with my patch that was merged into beta5. So there was some merging involved. But apparently I cannot trust meld, since I tell it to merge all changes from the left version and it does not, in fact, merge all changes from the left version. (That or I did something wrong.)\n\nI guess it's positive_review then?",
    "created_at": "2013-12-10T16:33:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246079",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:10'></a>Well, the edits to `permutation.py` conflicted with my patch that was merged into beta5. So there was some merging involved. But apparently I cannot trust meld, since I tell it to merge all changes from the left version and it does not, in fact, merge all changes from the left version. (That or I did something wrong.)
...
```json
{
    "body": "<a id='comment:11'></a>HMmmmmm... Actually I would be quite glad to rewrite this branch and make it cleaner. Would it be fine if I just take my old branch, add your typo fixes into it, with all this atop beta5 ?\n\nNathann",
    "created_at": "2013-12-10T18:50:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246080",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:11'></a>HMmmmmm... Actually I would be quite glad to rewrite this branch and make it cleaner. Would it be fine if I just take my old branch, add your typo fixes into it, with all this atop beta5 ?
...
```json
{
    "body": "<a id='comment:12'></a>I won't mind... I hope noone hangs on this branch now (is there a good way to find this out at least for branches on the trac server?).",
    "created_at": "2013-12-11T21:45:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246081",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:12'></a>I won't mind... I hope noone hangs on this branch now (is there a good way to find this out at least for branches on the trac server?).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246083",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Changing commit from \"b484c8a59a690c0232097e4ae40ef58c6e813837\" to \"400bdc1a102cedffd2170e5d21deebd11ec5b9ed\"",
    "created_at": "2013-12-12T13:12:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246084",
    "user": "https://github.com/nathanncohen"
}
```

Changing commit from "b484c8a59a690c0232097e4ae40ef58c6e813837" to "400bdc1a102cedffd2170e5d21deebd11ec5b9ed"
...
```json
{
    "body": "<a id='comment:14'></a>Looks good and tests well. positive_review is right. Thanks!",
    "created_at": "2013-12-17T05:05:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246085",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:14'></a>Looks good and tests well. positive_review is right. Thanks!
...
```json
{
    "body": "<a id='comment:15'></a>Thaaaaaaaaaanks !\n\nNathann",
    "created_at": "2013-12-17T10:43:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246086",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:15'></a>Thaaaaaaaaaanks !
...
```json
{
    ...
    "milestone": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15439#event-44982"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15439#event-44983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246087",
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15439#event-44984"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15439#event-44985"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15439#event-44986"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15439",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15439#issuecomment-246088",
    "user": "https://github.com/vbraun"
}
```
