...
```json
{
    ...
    "asset_name": "trac_15074_textbook_style_deriv_pynac.patch",
    "asset_url": "tarball://root/attachments/ticket15074/trac_15074_textbook_style_deriv_pynac.patch",
    "created_at": "2013-08-21T14:42:23Z",
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15074/trac_15074_textbook_style_deriv_pynac.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187529",
    "user": "https://trac.sagemath.org/admin/accounts/users/mbejger"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_15074_textbook_style_deriv_pynac_v2.patch",
    "asset_url": "tarball://root/attachments/ticket15074/trac_15074_textbook_style_deriv_pynac_v2.patch",
    "created_at": "2013-09-10T21:03:24Z",
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket15074/trac_15074_textbook_style_deriv_pynac_v2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mbejger"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac_15074_textbook_style_deriv_pynac_v2.patch](https://github.com/sagemath/sage/files/ticket15074/trac_15074_textbook_style_deriv_pynac_v2.patch) by mbejger created at 2013-09-10 21:03:24\n\nDear All, I have added a newer patch with an additional switch that allows for omitting the arguments of a function: \n\n```\nvar('x y z'); f = function('f', x, y, z)\nf.diff(x,z,y,z)\nD[0, 1, 2, 2](f)(x, y, z)\nfrom sage.symbolic.pynac import omit_function_args\nomit_function_args(True)\nD[0, 1, 2, 2](f)\n```",
    "created_at": "2013-09-10T21:03:24Z",
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187530",
    "user": "https://trac.sagemath.org/admin/accounts/users/mbejger"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187532",
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132136"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132137"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132138"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132139"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132140"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132141"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132142"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132143"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187533",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187534",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187535",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132144"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132145"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15074#event-132147"
}
```
