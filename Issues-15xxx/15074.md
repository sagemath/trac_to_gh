...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187555",
    "user": "https://trac.sagemath.org/admin/accounts/users/mbejger"
}
```
...
archive/attachments_020869.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac_15074_textbook_style_deriv_pynac_v2.patch](https://github.com/sagemath/sage/files/ticket15074/trac_15074_textbook_style_deriv_pynac_v2.patch)\n\nDear All, I have added a newer patch with an additional switch that allows for omitting the arguments of a function: \n\n```\nvar('x y z'); f = function('f', x, y, z)\nf.diff(x,z,y,z)\nD[0, 1, 2, 2](f)(x, y, z)\nfrom sage.symbolic.pynac import omit_function_args\nomit_function_args(True)\nD[0, 1, 2, 2](f)\n```",
    "created_at": "2013-09-10T21:03:24Z",
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187556",
    "user": "https://trac.sagemath.org/admin/accounts/users/mbejger"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187557",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187558",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187559",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187560",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15074#issuecomment-187561",
    "user": "https://github.com/egourgoulhon"
}
```
