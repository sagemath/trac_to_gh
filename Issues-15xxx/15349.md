...
<a id='comment:3'></a>I think it's CombinatorialFreeModule that should be fixed to not use `.values()` but instead
...
```json
{
    "body": "<a id='comment:4'></a>OK; I'll rather leave this to you people. But are the changes I've done here any good?",
...
<a id='comment:4'></a>OK; I'll rather leave this to you people. But are the changes I've done here any good?
