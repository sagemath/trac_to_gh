...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                            |\n|---------------------------------------------------------------------------------------------------------|----------------------------|\n|[3ad56a4](http://git.sagemath.org/sage.git/commit/?id=3ad56a4)|build/install: add missing ;|",
    "created_at": "2013-11-18T18:03:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15433",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                              |\n|---------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[119372b](http://git.sagemath.org/sage.git/commit/?id=119372b)|gcc: version bump to force rebuild on OSX 10.9|",
    "created_at": "2013-11-19T18:43:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15433",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                      |\n|---------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[9fb89a2](http://git.sagemath.org/sage.git/commit/?id=9fb89a2)|build/install: add comment explaining why we don't build sqlite on OSX|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                     |\n|---------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[cfc31f3](http://git.sagemath.org/sage.git/commit/?id=cfc31f3)|sqlite: move platform disabling to spkg-install like atlas and cephes|",
    "created_at": "2013-11-24T02:49:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15433",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                  |\n|---------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[3f36a9e](http://git.sagemath.org/sage.git/commit/?id=3f36a9e)|remove --sqlite3 option if sqlite is not installed|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                        |\n|---------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[2766ab3](http://git.sagemath.org/sage.git/commit/?id=2766ab3)|gcc: fix comment typos in install script|\n|[a64c2d7](http://git.sagemath.org/sage.git/commit/?id=a64c2d7)|symlink system sqlite3 on OS X|",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                   |\n|---------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[7547fce](http://git.sagemath.org/sage.git/commit/?id=7547fce)|remove a couple of now unused lines|",
