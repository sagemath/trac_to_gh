...
```json
{
    "body": "Changing branch from \"\" to \"u/vbraun/banner_version\"",
    "created_at": "2013-12-16T17:30:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248114",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "" to "u/vbraun/banner_version"
...
```json
{
    "body": "Changing commit from \"\" to \"40446e20ffdfbe0360059a6b9e1e494d4eab0c45\"",
    "created_at": "2013-12-16T17:34:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248115",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "40446e20ffdfbe0360059a6b9e1e494d4eab0c45"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248116",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248117",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248118",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248119",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15526#event-45360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248120",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248121",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248122",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15526#event-45361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248123",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Sorry wrong button... needs review",
    "created_at": "2013-12-16T18:08:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248124",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>Sorry wrong button... needs review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248127",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>OK, so after applying the patch (in oldspeak) i.e. creating the branch from this ticket and waiting for \"make\" to finish, the banner is exactly the same: 5.13.  So, I don't know what to do to test this.  At least it passes the \"patch applies ok\"  test since that seens automatic with git.\n\nI am running a \"make ptestlong\" and see the string \"sage-6.0.rc0\" appearing,  but I don't know if that is a waste of time.",
    "created_at": "2013-12-16T20:42:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248128",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:10'></a>OK, so after applying the patch (in oldspeak) i.e. creating the branch from this ticket and waiting for "make" to finish, the banner is exactly the same: 5.13.  So, I don't know what to do to test this.  At least it passes the "patch applies ok"  test since that seens automatic with git.
...
```json
{
    "body": "<a id='comment:11'></a>Correct. The point of this ticket is that the `sage-update-version` script writes the correct banner. The script is run as part of the release process, not whenever you build sage.",
    "created_at": "2013-12-16T20:50:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248129",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>Correct. The point of this ticket is that the `sage-update-version` script writes the correct banner. The script is run as part of the release process, not whenever you build sage.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248130",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248131",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>The test failures are to be expected...  I guess there is nothing to review here after all ;-)",
    "created_at": "2013-12-16T22:51:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248132",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>The test failures are to be expected...  I guess there is nothing to review here after all ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248133",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15526#event-45362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15526#issuecomment-248134",
    "user": "https://github.com/vbraun"
}
```
