...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219202"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193853",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193854",
...
```json
{
    "body": "<div id=\"comment:2\"></div>\n\nBranch pushed to git repo; I updated commit sha1. New commits:\n<table><tr><td><code>[40446e2](https://github.com/sagemath/sagetrac-mirror/commit/40446e2)</code></td><td><code>Use the updated version for the banner, not the old one</code></td></tr></table>\n",
    "created_at": "2013-12-16T17:34:12Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193855",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193856",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193857",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219210"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193858",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193859",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193860",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193861",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193862",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193863",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193864",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193865",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15526#issuecomment-193866",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15526#event-219214"
}
```
