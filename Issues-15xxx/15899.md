...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15899#event-46762"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15899#issuecomment-216054",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15899#event-46763"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15899#event-46764"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I wonder if this is related to #18741.",
    "created_at": "2015-06-20T12:51:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15899#issuecomment-216055",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>I wonder if this is related to #18741.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15899#issuecomment-216056",
    "user": "https://github.com/vbraun"
}
```
