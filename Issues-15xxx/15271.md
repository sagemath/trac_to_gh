...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217144"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217146"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217147"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188511",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188512",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188513",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188514",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188515",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188516",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188517",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<div id=\"comment:8\" align=\"right\">comment:8</div>\n\nReplying to [@gvol](#comment:7):\n> Replying to [@ppurka](#comment:6):\n> > @gvol - Would the emacs interface work if you set `sys.displayhook = sage.misc.displayhook.DisplayHook` from emacs?\n\n> \n> Yes that works.  Just to be clear, `sage.misc.displayhook.DisplayHook` only exists in 5.12 (and later), right?  \n\nNo. That exists from earlier, probably sage-5.11 (#12719).",
    "created_at": "2013-10-12T14:16:49Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188518",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188519",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188520",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217148"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217149"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217150"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188521",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217152"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217153"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188522",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217154"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217155"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217156"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217157"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15271#issuecomment-188523",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217158"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217159"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217160"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15271",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217161"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15271#event-217162"
}
```
