...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15811#event-208257"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15811#event-208258"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15811#event-208259"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15811#event-208260"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15811#issuecomment-202165",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15811#issuecomment-202166",
    "user": "https://github.com/vbraun"
}
```
