...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34220#issuecomment-485431",
    "user": "charpent"
}
```
...
```json
{
    "body": "In all failures reported above, the error is triggered on the `assert len(args) == 3` error. This my be an error specific to `gamma`.\n\nSome specific, systematic testing may be in order...",
    "created_at": "2022-08-30T15:28:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34220#issuecomment-485432",
    "user": "charpent"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34220#issuecomment-485434",
    "user": "chapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34220#issuecomment-485435",
    "user": "charpent"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34220#issuecomment-485436",
    "user": "charpent"
}
```
