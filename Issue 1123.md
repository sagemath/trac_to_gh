...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1123#event-2999"
}
```
...
```json
{
    "body": "After discussion during Bug Day 7 we came to the conclusion that this is an invalid report.\n\nCheers,\n\nMichael",
    "created_at": "2007-12-15T03:34:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1123#issuecomment-6766",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1123#issuecomment-6767",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1123",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1123#event-3000"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1123#event-3001"
}
```
