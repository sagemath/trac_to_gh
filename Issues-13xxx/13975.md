...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213102",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>You missed a test for `rings/real_lazy.pyx` (see patchbot log) and I think you should pick a convention and stick with it (the associativity test differs from the others).\n\nBest,\n\nTravis",
    "created_at": "2013-02-07T00:00:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213103",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>You missed a test for `rings/real_lazy.pyx` (see patchbot log) and I think you should pick a convention and stick with it (the associativity test differs from the others).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213104",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213105",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213106",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213107",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Looks good to me now. Thank you.\n\nBest,\n\nTravis",
    "created_at": "2013-02-07T14:12:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213108",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>Looks good to me now. Thank you.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213109",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213110",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213111",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213112",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213113",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Replying to [cnassau](#comment%3A8):\n> Thank you very much for these explanations - you've clearly put a lot of work and thought into these issues so I won't argue with you. But do I understand you correctly, that \n> \n> \n> ```python\n> tester.assert_(   (x * y) * z == x * (y * z) ,\n>                LazyFormat(\"(x*y)*z != x*(y*z) for (x,y,z) = (%s,%s,%s)\") % (x,y,z) )\n> ``` \n> \n> would find your approval? Because I then just might re-format my patch in this style and set it to \"need review\" again... ;-)\n\n\nOops, sorry, I let that slip away in my mailbox.\n\nYes, that would be alright indeed!",
    "created_at": "2013-03-13T14:35:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13975#issuecomment-213117",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:9'></a>Replying to [cnassau](#comment%3A8):
> Thank you very much for these explanations - you've clearly put a lot of work and thought into these issues so I won't argue with you. But do I understand you correctly, that 
> 
> 
> ```python
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13975#event-39244"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13975#event-39245"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13975#event-39246"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13975#event-39247"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13975#event-39248"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13975#event-39249"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13975#event-39250"
}
```
