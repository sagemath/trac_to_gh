...
```json
{
    "body": "This looks like a duplicate of #13054.",
    "created_at": "2013-02-22T13:12:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13652",
    "type": "issue_comment",
...
```json
{
    "body": "The Galois group of the polynomial `x<sup>7-x</sup>3+5*x^2+1` is S_7, so the computation is never going to finish: the field defined by 4 roots has degree 840.",
