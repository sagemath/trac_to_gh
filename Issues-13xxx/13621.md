...
```json
{
    "body": "<a id='comment:5'></a>I see what was going on here now.  The [phrasing here](https://github.com/sagemath/sagenb/blob/master/sagenb/notebook/notebook_object.py#L66) could make it clear that `dir` doesn't work.\n\nI've opened [this sagenb pull request](https://github.com/sagemath/sagenb/pull/166).",
...
<a id='comment:5'></a>I see what was going on here now.  The [phrasing here](https://github.com/sagemath/sagenb/blob/master/sagenb/notebook/notebook_object.py#L66) could make it clear that `dir` doesn't work.
...
```json
{
    "body": "<a id='comment:6'></a>And already merged!  Now pending whenever that gets in the sagenb in Sage.",
    "created_at": "2013-06-14T20:07:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13621",
    "type": "issue_comment",
...
<a id='comment:6'></a>And already merged!  Now pending whenever that gets in the sagenb in Sage.
...
```json
{
    "body": "<a id='comment:8'></a>(Long since merged.)",
    "created_at": "2014-08-14T13:59:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13621",
    "type": "issue_comment",
...
<a id='comment:8'></a>(Long since merged.)
