...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13843#event-178140"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13843#event-178141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13843#event-178142"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13843#issuecomment-165576",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13843#issuecomment-165577",
    "user": "https://github.com/greg-minshall"
}
```
