...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13516#event-172820"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13516#event-172821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13516#event-172822"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -30,6 +30,4 @@\n ```\n Yeah, this seems problematic.  The code in question is *old*, too, so perhaps there is a more efficient way to do it in the meantime...\n \n-**Apply**\n-\n-1. [patch](https://github.com/sagemath/sage/files/ticket13516/13516_primepowers.patch.gz)\n+**Apply** to `devel/sage`: [attachment: 13516_reviewer.2.patch.gz](https://github.com/sagemath/sage/files/ticket13516/13516_reviewer.2.patch.gz).\n``````\n",
    "created_at": "2012-11-22T06:19:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13516",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13516#issuecomment-160018",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13516",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13516#issuecomment-160019",
