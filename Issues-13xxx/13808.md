...
{
    "assignees": [],
    "body": "This patch implements algorithms for computing the Gromov hyperbolicity of a graph. Although the worst case time complexity is in `O(n^4)`, the proposed implementation performs quite well in practice. It has been used on graphs with more than 10.000 vertices.\n\n\nAPPLY:\n* [attachment:trac_13808-v3.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-v3.patch)\n* [attachment:trac_13808-revb.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-revb.patch)\n* [attachment:trac_13808-rev2.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-rev2.patch)\n* [attachment:trac_13808-combinations.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-combinations.patch)\n\n\n\nDepends on #13821\n\n**Assignee:** @jasongrout, @nathanncohen, @rlmill\n\n**CC:**  @nathanncohen\n\n**Keywords:** graph, hyperbolicity\n\n**Reviewer:** Nathann Cohen\n\n**Author:** David Coudert\n\n**Merged:** sage-5.6.rc0\n\nIssue created by migration from https://trac.sagemath.org/ticket/13808\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164135"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164142"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,2 +1,6 @@\n This patch implements algorithms for computing the Gromov hyperbolicity of a graph. Although the worst case time complexity is in `O(n^4)`, the proposed implementation performs quite well in practice. It has been used on graphs with more than 10.000 vertices.\n \n+\n+APPLY:\n+* [attachment:trac_13808-v2.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-v2.patch)\n+\n``````\n",
    "created_at": "2012-12-15T15:06:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165026",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165027",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165028",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165029",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165030",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -3,4 +3,6 @@\n \n APPLY:\n * [attachment:trac_13808-v3.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-v3.patch)\n+* [attachment:trac_13808-rev.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-rev.patch)\n+* [attachment:trac_13808-rev2.patch](https://github.com/sagemath/sage/files/ticket13808/trac_13808-rev2.patch)\n \n``````\n",
    "created_at": "2012-12-21T20:14:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165031",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165032",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165033",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164148"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165034",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165035",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165036",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164152"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164154"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165037",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165038",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165039",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165040",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164155"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164156"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165041",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165042",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165043",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165044",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165045",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164157"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164158"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165046",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165047",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164159"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13808#event-164160"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13808#issuecomment-165048",
    "user": "https://github.com/jdemeyer"
}
```
