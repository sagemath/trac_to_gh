...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155527",
    "user": "https://github.com/sagetrac-Hester"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155528",
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-169406"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-169407"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-169408"
}
```
