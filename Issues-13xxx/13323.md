...
```json
{
    "body": "<a id='comment:3'></a>This seems to be fixed here\n\nhttps://bitbucket.org/birkenfeld/sphinx/changeset/bab0b83c9e02\n\nand available in Sphinx v1.1.3 (Mar 10, 2012).",
    "created_at": "2012-08-01T21:23:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13323#issuecomment-199058",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:3'></a>This seems to be fixed here
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13323#issuecomment-199059",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36884"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36885"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36886"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36887"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36888"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36889"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36890"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36891"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36892"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13323#issuecomment-199061",
...
```json
{
    "body": "<a id='comment:10'></a>Superseded by #16733.",
    "created_at": "2014-11-13T14:00:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13323#issuecomment-199062",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>Superseded by #16733.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13323#issuecomment-199063",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13323#issuecomment-199064",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13323#event-36893"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13323#issuecomment-199065",
