...
```json
{
    "body": "<a id='comment:1'></a>Before you can do any of those specific imports, you need to do\n\n```\nimport sage.all\n```\n\nwhich will import things in the correct order and make sure everything is initialized.  After that, you can import what you need.",
    "created_at": "2012-06-04T21:05:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13083#issuecomment-192923",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>Before you can do any of those specific imports, you need to do
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13083#issuecomment-192924",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13083#issuecomment-192925",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13083#issuecomment-192926",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13083#issuecomment-192927",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13083#event-35943"
}
```
