...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-166222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-166223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-166224"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151548",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151549",
...
```json
{
    "body": "Changed assignee from **@sagetrac-GeorgSWeber** to **@jasongrout**",
    "created_at": "2015-09-16T08:22:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151550",
    "user": "https://github.com/jdemeyer"
}
```

Changed assignee from **@sagetrac-GeorgSWeber** to **@jasongrout**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-166225"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-166226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151551",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-166227"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-166228"
}
```
