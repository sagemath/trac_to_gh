...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198629",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198630",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198631",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198632",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I'd think in directions. There are two types. The first type is defined by the nearest neighbours in the d-dimensional lattice, i.e. those points that change one coordinate by one.\nThe second type is defined by the second nearest heighbours, i.e. those points that change the coordinate in two different dimensions by one each.\n\nThe allowed directions then are:\n\nKing: 1 + 2 \\\\\nRook: 1 \\\\\nBishop: 2 \\\\\nQueen: 1 + 2 \\\\\n\nYour definition for the knight makes sense.",
    "created_at": "2012-07-28T07:04:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198633",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```

<a id='comment:4'></a>I'd think in directions. There are two types. The first type is defined by the nearest neighbours in the d-dimensional lattice, i.e. those points that change one coordinate by one.
The second type is defined by the second nearest heighbours, i.e. those points that change the coordinate in two different dimensions by one each.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198635",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Thanks for the propositions. I have incorporated all of them but the following which causes a type error\n\n```\nsage: dim = [2,3,4,5]\nsage: dimstr = '(%s)' % \"\".join(dim)\n---------------------------------------------------------------------------\nTypeError                                 Traceback (most recent call last)\n\n/Users/dcoudert/<ipython console> in <module>()\n\nTypeError: sequence item 0: expected string, int found\n```\nInstead, I use the following code which is in fact easier:\n\n``` \ndimstr = str(tuple(dim)) \n```\n\nThis is much better now !",
    "created_at": "2012-07-29T19:12:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198637",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>Thanks for the propositions. I have incorporated all of them but the following which causes a type error
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198640",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>We said before (#comment:4) that the Queen could move either in 1 dimension or in 2 dimensions, and adding an edge from (1,1,1) to (2,2,2) means moving in the 3 dimensions. That's why 8 points are not reachable from (1,1,1).\n\n> In general I would expect `3**d -1` directions. They are defined by the `3^d` points in `{-1,0,1}^d`. Only the central point doesn't define a direction. \n\nI don't understand.",
    "created_at": "2012-07-31T07:39:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198641",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:11'></a>We said before (#comment:4) that the Queen could move either in 1 dimension or in 2 dimensions, and adding an edge from (1,1,1) to (2,2,2) means moving in the 3 dimensions. That's why 8 points are not reachable from (1,1,1).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198642",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198644",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>The `n\\equiv 1,5 \\pmod(6)` in the QueenGraph doc string looks strange, both on the command line and in the html doc.\n\nOnce this is fixed, I'll give it a positive review.",
    "created_at": "2012-08-01T11:17:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198645",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```

<a id='comment:14'></a>The `n\equiv 1,5 \pmod(6)` in the QueenGraph doc string looks strange, both on the command line and in the html doc.
...
```json
{
    "body": "<a id='comment:15'></a>I changed it to `n\\equiv 1,5 \\bmod{6}` and the output is now correct: n\\equiv 1,5 (mod 6).",
    "created_at": "2012-08-01T22:38:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198646",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:15'></a>I changed it to `n\equiv 1,5 \bmod{6}` and the output is now correct: n\equiv 1,5 (mod 6).
...
```json
{
    "body": "<a id='comment:16'></a>Tests good, docs good -> positive review",
    "created_at": "2012-08-02T11:42:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198647",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```

<a id='comment:16'></a>Tests good, docs good -> positive review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198648",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Many thanks for the help improving this patch.",
    "created_at": "2012-08-02T11:45:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198649",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:17'></a>Many thanks for the help improving this patch.
...
```json
{
    "body": "<a id='comment:18'></a>This patch adds again a considerable amount of code to `sage/graphs/graph_generators.py`.\n\nAt some point, I will have to refuse such patches before that file gets really too big.",
    "created_at": "2012-08-02T12:18:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198650",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>This patch adds again a considerable amount of code to `sage/graphs/graph_generators.py`.
...
```json
{
    "body": "<a id='comment:19'></a>Then what could be the solution: split the file into several pieces (graph_generators_1.py, graph_generators_2.py, etc...) with a bounded number of lines per file ?",
    "created_at": "2012-08-02T13:07:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198651",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:19'></a>Then what could be the solution: split the file into several pieces (graph_generators_1.py, graph_generators_2.py, etc...) with a bounded number of lines per file ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198652",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I can try to do that, but I don't know how to expose the functions inside the GraphGenerators class. \nShould I use something like \n\n```\nimport types\nimport sage.graphs.generators.chessboard \nGraphGenerators.QueenGraph = types.MethodType(sage.graphs.generators.chessboard.QueenGraph, None, Graph) \n```\nI tried but it produces an error: `ImportError: No module named generators.chessboard`\n\nAny help is more than welcome.",
    "created_at": "2012-08-02T15:18:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198653",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:21'></a>I can try to do that, but I don't know how to expose the functions inside the GraphGenerators class. 
Should I use something like 
...
```json
{
    "body": "<a id='comment:22'></a>Did you add an `__init__.py` to sage/graphs/generators?",
    "created_at": "2012-08-03T05:57:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198654",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```

<a id='comment:22'></a>Did you add an `__init__.py` to sage/graphs/generators?
...
```json
{
    "body": "<a id='comment:23'></a>I added such a file but it's still not working.\n\nIs the procedure documented somewhere? I haven't find it in the documentation yet.",
    "created_at": "2012-08-03T08:23:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198655",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:23'></a>I added such a file but it's still not working.
...
```json
{
    "body": "<a id='comment:24'></a>See [1] for how to add a new directory. But I'd say you should skip the addition of all.py and the addition to the existing all.py files as you want these things to be visible through the GraphGenerators class only.\n\nAfter that add an import like \"import sage.graphs.generators.chessboard\" to graph_generators.py.\n\nThen:\n\n```\nclass GraphGenerators():\n   [...]\n   QueenGraph = sage.graphs.generators.chessboard.QueenGraph\n```\n\n\n[1] http://www.sagemath.org/doc/developer/coding_in_python.html#creating-a-new-directory",
    "created_at": "2012-08-03T11:30:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198656",
    "user": "https://trac.sagemath.org/admin/accounts/users/sluther"
}
```

<a id='comment:24'></a>See [1] for how to add a new directory. But I'd say you should skip the addition of all.py and the addition to the existing all.py files as you want these things to be visible through the GraphGenerators class only.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198658",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198659",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198660",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198661",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Addition of line ```# This file is not empty !``` in file ```__init__.py``` as Nathann told me we should not have empty files.",
    "created_at": "2012-08-03T13:49:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198662",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:27'></a>Addition of line ```# This file is not empty !``` in file ```__init__.py``` as Nathann told me we should not have empty files.
...
```json
{
    "body": "<a id='comment:28'></a>Could anyone review this patch ?\nThanks.",
    "created_at": "2012-08-18T00:58:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198663",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:28'></a>Could anyone review this patch ?
Thanks.
...
```json
{
    "body": "<a id='comment:29'></a>(cc me)",
    "created_at": "2012-10-02T13:54:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198664",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:29'></a>(cc me)
...
```json
{
    "body": "<a id='comment:30'></a>Do we really need to import sage.graphs.generators.chessboard at startup?",
    "created_at": "2012-10-02T17:37:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198665",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:30'></a>Do we really need to import sage.graphs.generators.chessboard at startup?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198666",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>You could try using lazy import. However, ignore that for now, as I think all of graph_generators should be lazily imported. #13562",
    "created_at": "2012-10-02T23:59:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198667",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:32'></a>You could try using lazy import. However, ignore that for now, as I think all of graph_generators should be lazily imported. #13562
...
```json
{
    "body": "<a id='comment:33'></a>Mostly looks good, but I would remove the double underscores around __ChessboardGraphGenerator__",
    "created_at": "2012-10-03T00:24:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198668",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:33'></a>Mostly looks good, but I would remove the double underscores around __ChessboardGraphGenerator__
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198669",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Done.",
    "created_at": "2012-10-03T07:31:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198670",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:34'></a>Done.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198672",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>I'm unable to install the review patch. Have you make it using the file I have uploaded this morning in which I have removed double underscores ?\n\n>     * Default values : rook = True, bishop = True, knight = False : that's weird. Why not set them all to True or all to False ?\n \nThat way the default behavior is QueenGraph, which is the most common chessboard graph. But all default parameters are OK for me.\n\n>     * dim_list : it takes any iterable as an input, and you say that it takes sets or even dicts ! That's asking for trouble because the order in which the elements are listed in sets and dicts is platform-dependent, but then you specifically SORT the elements by key value when the inout is a dict, and take the VALUES into account. That's not what it is expected. A dict is an iterable, but list(my_dict) lists its keys, not values ! It would make more sense to remove the part of the code that deals with dict (why especially dicts, by the way ? One can make custom iterables !), and just use your ``dim = list(dim_list)`` which is perfect as it is.\n\n\nThat's right. Can you insert this in the review patch?\n\n>     * I replaced \"at least\" or \"least\" by \">=\". This way you know whether \">=\" or \">\" is intended, which is never clear with \"at least\" :-P\n>     * Replaced a block of code by itertools.product\n \nI didn't know that command. Very nice.\n\n>     * Added many \"`\" for tuples that could appear in LaTeX instead.",
    "created_at": "2012-10-03T11:14:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198673",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:37'></a>I'm unable to install the review patch. Have you make it using the file I have uploaded this morning in which I have removed double underscores ?
...
```json
{
    "body": "<a id='comment:38'></a>> I'm unable to install the review patch. Have you make it using the file I have uploaded this morning in which I have removed double underscores ?\n\n`O_o`\nI thought I did. And none of the patch I had applied before changed chessboard.py. Well, I saw the errors when applying the patches and rebased it. Weird, but done.\n\n> That way the default behavior is QueenGraph, which is the most common chessboard graph. But all default parameters are OK for me.\n\n\nJust set them all to ``True``\n\n> That's right. Can you insert this in the review patch?\n\nDone.\n\nPatch updated !\n\nNathann",
    "created_at": "2012-10-03T14:15:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198674",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:38'></a>> I'm unable to install the review patch. Have you make it using the file I have uploaded this morning in which I have removed double underscores ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198675",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Now it's working and the doc is nicer. Thanks.\nI didn't know the `product` function and the way you use it is really nice.",
    "created_at": "2012-10-03T14:44:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198676",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:39'></a>Now it's working and the doc is nicer. Thanks.
I didn't know the `product` function and the way you use it is really nice.
...
```json
{
    "body": "<a id='comment:40'></a>Well.. Then \"if you agree with those changes\", let's get this ticket in `:-)`\n\nNathann",
    "created_at": "2012-10-03T15:18:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198677",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:40'></a>Well.. Then "if you agree with those changes", let's get this ticket in `:-)`
...
```json
{
    "body": "<a id='comment:41'></a>I agree with your changes. Thanks.",
    "created_at": "2012-10-03T15:36:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198678",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:41'></a>I agree with your changes. Thanks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198679",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Arf. I thought you would change the ticket's status `:-)`\n\nNathann",
    "created_at": "2012-10-03T15:40:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198680",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:42'></a>Arf. I thought you would change the ticket's status `:-)`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198681",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198682",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13306#event-36825"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198683",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13306#event-36826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13306#issuecomment-198684",
    "user": "https://github.com/jdemeyer"
}
```
