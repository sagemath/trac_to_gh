...
```json
{
    "body": "<a id='comment:1'></a>As another point of reference: If I run `sage -ipython` and then try `str?`, I get the docstring immediately. If I then do\n\n`from sage.all import *`\n\nthe same thing now takes a second or two.",
    "created_at": "2012-05-29T07:44:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192278",
    "user": "https://trac.sagemath.org/admin/accounts/users/bober"
}
```

<a id='comment:1'></a>As another point of reference: If I run `sage -ipython` and then try `str?`, I get the docstring immediately. If I then do
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192279",
...
```json
{
    "body": "<a id='comment:4'></a>Could you produce a similar report for sage-4.8? If the slow down happened in sage-5.0 the most likely candidate would be python itself.",
    "created_at": "2012-05-29T09:01:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192281",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:4'></a>Could you produce a similar report for sage-4.8? If the slow down happened in sage-5.0 the most likely candidate would be python itself.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192283",
    "user": "https://trac.sagemath.org/admin/accounts/users/bober"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Ok. Here they are again. Haven't dropped caches this time. The sage libraries are already loaded so, the `sage -q` gives the sage prompt quickly.\n\n```\n~\u00bb Installations/sage-5.1beta0/sage -q\nLoading Sage library. Current Mercurial branch is: trac\nsage: from sage.misc.sageinspect import sage_getdoc\nsage: %time L = sage_getdoc(gcd)                   \nCPU times: user 1.02 s, sys: 0.05 s, total: 1.07 s\nWall time: 1.11 s\nsage: \nExiting Sage (CPU time 0m1.10s, Wall time 0m6.96s).\n~\u00bb Installations/sage-5.0.rc0.good/sage -q\nsage: from sage.misc.sageinspect import sage_getdoc\nsage: %time L = sage_getdoc(gcd)                   \nCPU times: user 1.02 s, sys: 0.05 s, total: 1.07 s\nWall time: 1.09 s\nsage: \nExiting Sage (CPU time 0m1.10s, Wall time 0m5.61s).\n~\u00bb Installations/sage-5.0.beta2/sage -q\nLoading Sage library. Current Mercurial branch is: main-backup\nsage: from sage.misc.sageinspect import sage_getdoc\nsage: %time L = sage_getdoc(gcd)                   \nCPU times: user 0.44 s, sys: 0.03 s, total: 0.48 s\nWall time: 0.50 s\nsage: \nExiting Sage (CPU time 0m0.52s, Wall time 0m5.43s).\n~\u00bb Installations/sage-4.8.good/sage -q\nsage: from sage.misc.sageinspect import sage_getdoc\nsage: %time L = sage_getdoc(gcd)                   \nCPU times: user 0.48 s, sys: 0.04 s, total: 0.52 s\nWall time: 0.54 s\nsage: \nExiting Sage (CPU time 0m0.56s, Wall time 0m4.47s).\n```",
    "created_at": "2012-05-29T09:36:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192284",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:7'></a>Ok. Here they are again. Haven't dropped caches this time. The sage libraries are already loaded so, the `sage -q` gives the sage prompt quickly.
...
```json
{
    "body": "<a id='comment:8'></a>So it appears that the regression happened somewhere in 5.0beta8. #9128 seems like it touched a lot of stuff related to this, so it is a possible candidate for the cause of the regression.\n\n(Adding hivert to cc, since he was the author on that ticket.)",
    "created_at": "2012-05-29T09:45:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192285",
    "user": "https://trac.sagemath.org/admin/accounts/users/bober"
}
```

<a id='comment:8'></a>So it appears that the regression happened somewhere in 5.0beta8. #9128 seems like it touched a lot of stuff related to this, so it is a possible candidate for the cause of the regression.
...
```json
{
    "body": "<a id='comment:9'></a>The sphinx ticket. That should be testable starting from beta7 and adding this single ticket.",
    "created_at": "2012-05-29T09:48:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192286",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:9'></a>The sphinx ticket. That should be testable starting from beta7 and adding this single ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192288",
    "user": "https://trac.sagemath.org/admin/accounts/users/bober"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Just tested on sage-5.0beta7. The patch responsible for the slowdown is the second one from that ticket:\nhttp://trac.sagemath.org/sage_trac/attachment/ticket/9128/trac_9128-sphinx_links_all-fh.patch",
    "created_at": "2012-05-29T10:58:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192291",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:14'></a>Just tested on sage-5.0beta7. The patch responsible for the slowdown is the second one from that ticket:
http://trac.sagemath.org/sage_trac/attachment/ticket/9128/trac_9128-sphinx_links_all-fh.patch
...
```json
{
    "body": "<a id='comment:16'></a>For me, without this change:\n\n```\nsage: from sage.misc.sageinspect import sage_getdoc\nsage: timeit('L = sage_getdoc(gcd)')\n5 loops, best of 3: 888 ms per loop\n```\nWith the change:\n\n```\nsage: from sage.misc.sageinspect import sage_getdoc\nsage: timeit('L = sage_getdoc(gcd)')\n5 loops, best of 3: 26 ms per loop\n```",
    "created_at": "2012-05-29T18:58:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192293",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>For me, without this change:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192294",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Here is essentially the above patch (although I've now also included the last line in the \"if\" block). Please test it from the command line and in the notebook, and you should probably also build the regular documentation and make sure it still looks okay.\n\nWhen I was testing this, I added a line to try to verify that app.srcdir is as I'm claiming in the patch (this applies on top of the attached patch):\n\n```diff\ndiff --git a/doc/common/conf.py b/doc/common/conf.py\n--- a/doc/common/conf.py\n+++ b/doc/common/conf.py\n@@ -608,6 +608,8 @@ def setup(app):\n     app.connect('autodoc-process-docstring', process_inherited)\n     app.connect('autodoc-skip-member', skip_member)\n \n+    print \"************* %s **************\" % app.srcdir\n+\n     # When building the standard docs, app.srcdir is set to SAGE_DOC +\n     # 'LANGUAGE/DOCNAME', but when doing introspection, app.srcdir is\n     # set to a temporary directory.  We don't want to use intersphinx,\n```\n\nFlorent: is this a good solution (i.e., not using intersphinx, etc., when doing introspection)?",
    "created_at": "2012-05-30T17:12:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192295",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:17'></a>Here is essentially the above patch (although I've now also included the last line in the "if" block). Please test it from the command line and in the notebook, and you should probably also build the regular documentation and make sure it still looks okay.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192296",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192297",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>As I just reported [on sage-devel](http://thread.gmane.org/gmane.comp.mathematics.sage.devel/59498), #9128 apparently also introduced a pretty large memory leak - every docstring lookup with \"?\" in the console leaks 56 MB of memory. This patch fixes the leak.",
    "created_at": "2012-05-31T18:48:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192298",
    "user": "https://github.com/kini"
}
```

<a id='comment:18'></a>As I just reported [on sage-devel](http://thread.gmane.org/gmane.comp.mathematics.sage.devel/59498), #9128 apparently also introduced a pretty large memory leak - every docstring lookup with "?" in the console leaks 56 MB of memory. This patch fixes the leak.
...
```json
{
    "body": "<a id='comment:19'></a>This patch seems to take care of my complaints nicely. I don't know what is actually going on with it, though, so I hope that someone who does know will give it a review.\n\nThe 56 MB memory leak is worrying, though, and we should figure out why that was happening. Does someone know?",
    "created_at": "2012-05-31T22:18:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192299",
    "user": "https://trac.sagemath.org/admin/accounts/users/bober"
}
```

<a id='comment:19'></a>This patch seems to take care of my complaints nicely. I don't know what is actually going on with it, though, so I hope that someone who does know will give it a review.
...
```json
{
    "body": "<a id='comment:20'></a>Should this ticket be priority critical? Users use introspection a *lot*, in my experience. This is not just some obscure memory leak.",
    "created_at": "2012-06-03T00:15:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192300",
    "user": "https://github.com/kini"
}
```

<a id='comment:20'></a>Should this ticket be priority critical? Users use introspection a *lot*, in my experience. This is not just some obscure memory leak.
...
```json
{
    "body": "<a id='comment:22'></a>Nevermind, the doc building problem is already present in 4.8 so is completely unrelated, I mixed two different threads on sage-devel.\nSorry for the noise.",
    "created_at": "2012-06-06T08:42:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192302",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:22'></a>Nevermind, the doc building problem is already present in 4.8 so is completely unrelated, I mixed two different threads on sage-devel.
Sorry for the noise.
...
```json
{
    "body": "<a id='comment:23'></a>This is related to docbuilding using a lot of memory, but it doesn't solve that problem. It suggests that the problem comes from using intersphinx, and this might help someone track down the exact issue. Is there a ticket open for this issue?",
    "created_at": "2012-06-06T15:50:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192303",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>This is related to docbuilding using a lot of memory, but it doesn't solve that problem. It suggests that the problem comes from using intersphinx, and this might help someone track down the exact issue. Is there a ticket open for this issue?
...
```json
{
    "body": "<a id='comment:24'></a>I agree with Keshav: this ticket should have a higher priority. Any possible reviewers?",
    "created_at": "2012-06-13T23:29:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192304",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:24'></a>I agree with Keshav: this ticket should have a higher priority. Any possible reviewers?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192305",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>I can confirm that this patch works, and fixes all the issues raised here. But I know nothing about sphinx, so I am not sure about setting it to positive review.",
    "created_at": "2012-06-14T00:53:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192306",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:25'></a>I can confirm that this patch works, and fixes all the issues raised here. But I know nothing about sphinx, so I am not sure about setting it to positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192307",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192309",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>The leak is ridiculously bad. I'm going to give this positive review - whatever else this patch might do, it does fix that, at least.",
    "created_at": "2012-06-15T19:39:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192310",
    "user": "https://github.com/kini"
}
```

<a id='comment:28'></a>The leak is ridiculously bad. I'm going to give this positive review - whatever else this patch might do, it does fix that, at least.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192311",
    "user": "https://github.com/kini"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>See #13127 and #13128 for follow-ups: fixing the memory leak, and fixing the links in introspection combined with intersphinx.",
    "created_at": "2012-06-17T20:21:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192312",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:29'></a>See #13127 and #13128 for follow-ups: fixing the memory leak, and fixing the links in introspection combined with intersphinx.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192313",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13057#issuecomment-192314",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13057",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13057#event-35825"
}
```
