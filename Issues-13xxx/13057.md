...
```json
{
    ...
    "asset_name": "trac_13057-no-intersphinx.patch",
    "asset_url": "tarball://root/attachments/ticket13057/trac_13057-no-intersphinx.patch",
    "created_at": "2012-05-30T17:03:36Z",
    "issue": "https://github.com/sagemath/sage/issues/13057",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13057/trac_13057-no-intersphinx.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "**Attachment:** [trac_13057-no-intersphinx.patch](https://github.com/sagemath/sage/files/ticket13057/trac_13057-no-intersphinx.patch)",
    "created_at": "2012-05-30T17:03:36Z",
    "issue": "https://github.com/sagemath/sage/issues/13057",
    "type": "issue_comment",
...
**Attachment:** [trac_13057-no-intersphinx.patch](https://github.com/sagemath/sage/files/ticket13057/trac_13057-no-intersphinx.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13057#event-109691"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13057#event-109692"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13057#event-109693"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13057#event-109694"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13057#event-109695"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13057#event-109696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13057",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13057#event-109697"
}
```
