...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165658"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165661"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165662"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165664"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165665"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165667"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -135,3 +135,21 @@\n     Sym in the level 3 LLT cospin basis\n ```\n \n+```\n+    sage: Sym.kBoundedSubspace(3,1)\n+    3-bounded Symmetric Functions over Rational Field with t=1\n+    sage: SymmetricFunctions(QQ['t']).kBoundedSubspace(3)\n+    3-bounded Symmetric Functions over Univariate Polynomial Ring in t over Rational Field\n+    sage: Sym.kschur(3,1)                                \n+    3-bounded Symmetric Functions over Rational Field with t=1 in the 3-Schur basis also with t=1\n+    sage: Sym.khomogeneous(3)  \n+    3-bounded Symmetric Functions over Rational Field with t=1 in the 3-bounded homogeneous basis\n+    sage: SymmetricFunctions(QQ['t']).kschur(3)\n+    3-bounded Symmetric Functions over Univariate Polynomial Ring in t over Rational Field in the 3-Schur basis\n+```\n+\n+\n+**Apply**:\n+* [attachment: trac_13404-sf-nt.2.patch.gz](https://github.com/sagemath/sage/files/ticket13404/trac_13404-sf-nt.2.patch.gz)\n+* [attachment: trac_13404_kschur_rename-mz.patch.gz](https://github.com/sagemath/sage/files/ticket13404/trac_13404_kschur_rename-mz.patch.gz)\n+\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165669"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165671"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165672"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165673"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165674"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13404#issuecomment-158566",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13404",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13404#event-165677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13404#issuecomment-158567",
