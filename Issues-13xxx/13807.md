...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179193",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179194",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179195",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13807#event-38698"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179198",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_13807_graphics_filename.patch](tarball://root/attachments/some-uuid/ticket13807/trac_13807_graphics_filename.patch) by @jhpalmieri created at 2012-12-08 05:42:59\n\nI've added a doctest (not a perfect one, but the best I can think of) in matrix_modn_sparse.pyx. I don't think it's possible to add a doctest to animate.py, since those require ImageMagick or similar to run.\n\nFor the `sage -n` problem, see #13794. I think the scripts patch at #11409 will fix it.",
    "created_at": "2012-12-08T05:42:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179200",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>Attachment [trac_13807_graphics_filename.patch](tarball://root/attachments/some-uuid/ticket13807/trac_13807_graphics_filename.patch) by @jhpalmieri created at 2012-12-08 05:42:59
...
```json
{
    "body": "<a id='comment:8'></a>It looks like `visualize_matrix` does one thing that `matrix_plot` does not: it lets you put a bound on the size of the figure, and then scales the picture accordingly. So if you have a 20x20 matrix and plot it in a 10x10 picture, each pixel corresponds to the entries in a 2x2 block. Maybe it would make sense to merge this functionality into `matrix_plot` and then deprecate `visualize_matrix`. Then we wouldn't have to worry about what this should do in the notebook. I agree that it would be more consistent for it to display the picture, but at least the current behavior is documented.\n\nI have no idea about those warnings about unreachable code, by the way.",
    "created_at": "2012-12-08T17:54:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179202",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>It looks like `visualize_matrix` does one thing that `matrix_plot` does not: it lets you put a bound on the size of the figure, and then scales the picture accordingly. So if you have a 20x20 matrix and plot it in a 10x10 picture, each pixel corresponds to the entries in a 2x2 block. Maybe it would make sense to merge this functionality into `matrix_plot` and then deprecate `visualize_matrix`. Then we wouldn't have to worry about what this should do in the notebook. I agree that it would be more consistent for it to display the picture, but at least the current behavior is documented.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179203",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Okay, sounds good enough.  I'll open a new ticket to ask about this other stuff for `visualize_matrix`, then.  Thanks for the quick patch!",
    "created_at": "2012-12-09T03:02:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179204",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>Okay, sounds good enough.  I'll open a new ticket to ask about this other stuff for `visualize_matrix`, then.  Thanks for the quick patch!
...
```json
{
    "body": "<a id='comment:10'></a>That is now #13812.\n\nPatchbot, apply trac_13807_graphics_filename.patch",
    "created_at": "2012-12-09T03:07:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179205",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>That is now #13812.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179206",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13807#issuecomment-179207",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13807",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13807#event-38699"
}
```
