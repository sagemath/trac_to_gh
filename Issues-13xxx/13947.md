...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/13947",
...
```json
{
    "body": "<a id='comment:2'></a>P.S.:  I was actually going to create a zn_poly spkg which simply saves the tuning parameters in case the tests fail, asking the user for submitting them to sage-devel or sage-release... (and probably doing a few more attempts to get working tuning parameters, and/or inform the user that he/she should reinstall the spkg when the sysload is lower).  :-)",
    "created_at": "2013-01-12T08:24:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212490",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>P.S.:  I was actually going to create a zn_poly spkg which simply saves the tuning parameters in case the tests fail, asking the user for submitting them to sage-devel or sage-release... (and probably doing a few more attempts to get working tuning parameters, and/or inform the user that he/she should reinstall the spkg when the sysload is lower).  :-)
...
```json
{
    "body": "<a id='comment:3'></a>P.P.S.:  John, is it always (just) `nuss_mul()` that fails the test?",
    "created_at": "2013-01-12T08:26:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212491",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>P.P.S.:  John, is it always (just) `nuss_mul()` that fails the test?
...
```json
{
    "body": "<a id='comment:4'></a>I also reproduced it on bsd.math.",
    "created_at": "2013-01-12T08:36:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212492",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>I also reproduced it on bsd.math.
...
```json
{
    "body": "<a id='comment:5'></a>Also reproduced on hawk (OpenSolaris i386).",
    "created_at": "2013-01-12T08:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212493",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Also reproduced on hawk (OpenSolaris i386).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212494",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212495",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212496",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212499",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>IIRC (and I'm quite sure I am) I got segfault as well during the tuning itself on Cygwin (64bits Windows 7), mostly when issuing make with MAKE=\"make -j4\" so the system must have been busy as well, but IIRC (less sure) it also happened when building zn_poly alone.\n\nThe segfaults happened while tuning KS/FFT things, mostly the last one which is mulmid, but I seem to tremember it also happened during the previous KS/FFT things sometimes.\n\nOf course I tried to reproduce that this morning and could not (I let ATLAS build in parallel to keep the system busy but that did not seem to do the trick).\n\nI'll give it another shot in the next couple of days.",
    "created_at": "2013-01-12T19:02:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212500",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:12'></a>IIRC (and I'm quite sure I am) I got segfault as well during the tuning itself on Cygwin (64bits Windows 7), mostly when issuing make with MAKE="make -j4" so the system must have been busy as well, but IIRC (less sure) it also happened when building zn_poly alone.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212501",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>The offending parameter in John's `tuning.c` seems to be `tuning_info[62].mul_fft_thresh` (=90, which is extraordinarily low), i.e., that's the one that (for me) causes the `nuss_mul()` test failures here.\n\n(There are others, but those aren't relevant for the tests, apparently.)",
    "created_at": "2013-01-12T22:49:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212503",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:15'></a>The offending parameter in John's `tuning.c` seems to be `tuning_info[62].mul_fft_thresh` (=90, which is extraordinarily low), i.e., that's the one that (for me) causes the `nuss_mul()` test failures here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212505",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Ok, leif, can you put your recipe to trigger the failure in the summary?",
    "created_at": "2013-02-25T00:55:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212506",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:19'></a>Ok, leif, can you put your recipe to trigger the failure in the summary?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212507",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212508",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212509",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212510",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212512",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>> > > IIRC (and I'm quite sure I am) I got segfault as well during the tuning itself on Cygwin (64bits Windows 7), mostly when issuing make with MAKE=\"make -j4\" so the system must have been busy as well, but IIRC (less sure) it also happened when building zn_poly alone.\n\n> > Just as a data point, I can confirm this, even with `make -j2`, on Cygwin Win 7.\n> Confirm what exactly?\n> Tuning fails if the box is too busy?  And if so, how?\n\nCorrect; with one other spkg being built it was too much.  Segfault during tuning in KS/FFT mul, repeatable.  No problems during short self-test, though of course I couldn't try that without using just one thread in any case.\n> Building itself (before and/or after tuning) can also fail?\n\nI guess not.",
    "created_at": "2013-03-12T13:07:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212513",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:25'></a>> > > IIRC (and I'm quite sure I am) I got segfault as well during the tuning itself on Cygwin (64bits Windows 7), mostly when issuing make with MAKE="make -j4" so the system must have been busy as well, but IIRC (less sure) it also happened when building zn_poly alone.
...
```json
{
    "body": "<a id='comment:26'></a>#14268 contains a patched zn_poly spkg for a totally unrelated problem. Just pointing this out in case somebody here plans to patch zn_poly.",
    "created_at": "2013-03-14T17:00:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212514",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:26'></a>#14268 contains a patched zn_poly spkg for a totally unrelated problem. Just pointing this out in case somebody here plans to patch zn_poly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212515",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>pong",
    "created_at": "2013-04-30T18:04:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212516",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:29'></a>pong
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212517",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Tracebacks of segfaults, anyone?\n\n(As mentioned, I can only reproduce *failing comparisons* -- with *faked* tuning parameters.)",
    "created_at": "2013-04-30T19:38:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212518",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:30'></a>Tracebacks of segfaults, anyone?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212519",
...
```json
{
    "body": "<a id='comment:33'></a>So the problem is only in the *testing* code?\n\nWe should really try to fix this ASAP.",
    "created_at": "2013-05-24T06:22:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212521",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:33'></a>So the problem is only in the *testing* code?
...
```json
{
    "body": "<a id='comment:36'></a>P.S.:  I'll probably update it later to allow conditional faking of thresholds...  (as I don't get \"appropriate\" thresholds on Linux, and only rarely on the MacOS X box I have access to).",
    "created_at": "2013-05-24T07:05:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212524",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:36'></a>P.S.:  I'll probably update it later to allow conditional faking of thresholds...  (as I don't get "appropriate" thresholds on Linux, and only rarely on the MacOS X box I have access to).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212526",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>leif: can you make a proper spkg and put a link to that spkg in the ticket description?",
    "created_at": "2013-05-24T09:42:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212527",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:38'></a>leif: can you make a proper spkg and put a link to that spkg in the ticket description?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212528",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212529",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>(I could leave it as is and just update `SPKG.txt` accordingly, of course also committing the changes.)",
    "created_at": "2013-05-24T09:53:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212530",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:40'></a>(I could leave it as is and just update `SPKG.txt` accordingly, of course also committing the changes.)
...
```json
{
    "body": "<a id='comment:41'></a>I would just include the patch and see if people still report problems.",
    "created_at": "2013-05-24T09:55:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212531",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:41'></a>I would just include the patch and see if people still report problems.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212532",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212533",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Attachment [zn_poly-0.9.p10-p11.diff](tarball://root/attachments/some-uuid/ticket13947/zn_poly-0.9.p10-p11.diff) by @nexttime created at 2013-05-24 10:36:11",
    "created_at": "2013-05-24T10:36:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212534",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:42'></a>Attachment [zn_poly-0.9.p10-p11.diff](tarball://root/attachments/some-uuid/ticket13947/zn_poly-0.9.p10-p11.diff) by @nexttime created at 2013-05-24 10:36:11
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212535",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212536",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>Somebody should take a look at tuning on MacOS X and Cygwin though, as the failures were apparently triggered by *\"random\" tuning parameters*... (which the patch obviously doesn't affect).",
    "created_at": "2013-05-24T10:43:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212537",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:44'></a>Somebody should take a look at tuning on MacOS X and Cygwin though, as the failures were apparently triggered by *"random" tuning parameters*... (which the patch obviously doesn't affect).
...
```json
{
    "body": "<a id='comment:45'></a>`@`David - thank you so much for helping track this down in \"stable\" code!  I hope this is the only one...\n\n> Somebody should take a look at tuning on MacOS X and Cygwin though\nAgreed.  I may be able to do this on OS X today, but not Cygwin until later.",
    "created_at": "2013-05-24T12:30:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212538",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:45'></a>`@`David - thank you so much for helping track this down in "stable" code!  I hope this is the only one...
...
```json
{
    "body": "<a id='comment:46'></a>I can't reproduce it on my Mac box, but I don't think I ever did.  Maybe John can try it on bsd again...",
    "created_at": "2013-05-24T15:35:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212539",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:46'></a>I can't reproduce it on my Mac box, but I don't think I ever did.  Maybe John can try it on bsd again...
...
```json
{
    "body": "<a id='comment:50'></a>Yes, this is a very occasional OS X error that I haven't been able to track down, and that has nothing to do with this ticket.",
    "created_at": "2013-05-25T13:29:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212543",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:50'></a>Yes, this is a very occasional OS X error that I haven't been able to track down, and that has nothing to do with this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212546",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:54'></a>... where \"you\" addresses Kwankyu, in case that wasn't clear.",
    "created_at": "2013-05-25T16:59:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212547",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:54'></a>... where "you" addresses Kwankyu, in case that wasn't clear.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212548",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212551",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:59'></a>At least this spkg fixes *some* bug, so it's good to have.",
    "created_at": "2013-05-26T19:53:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212552",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:59'></a>At least this spkg fixes *some* bug, so it's good to have.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212553",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212554",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212555",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13947#event-39178"
}
```
...
```json
{
    "body": "<a id='comment:60'></a>> At least this spkg fixes *some* bug, so it's good to have.\n\nTrue!  But did you open a new ticket for the original bug, which is probably not resolved by this?  (JP, I assume that on a loaded Cygwin system we still get the original issue.)",
    "created_at": "2013-05-28T02:12:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212556",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:60'></a>> At least this spkg fixes *some* bug, so it's good to have.
...
```json
{
    "body": "<a id='comment:61'></a>I successfully installed Sage-5.10.rc0 without the zn_poly failure issue. (the error after starting Sage as reported in a previous comment was just because of my own out-dated scripts, and is irrelevant with this ticket. Sorry for the noise.)\n\nThanks a lot!",
    "created_at": "2013-05-30T08:18:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13947#issuecomment-212557",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:61'></a>I successfully installed Sage-5.10.rc0 without the zn_poly failure issue. (the error after starting Sage as reported in a previous comment was just because of my own out-dated scripts, and is irrelevant with this ticket. Sorry for the noise.)
