...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172936",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "There is a similar command \"html.table\" in sage already.  I was recently reading it since I guess I have to rewrite it for salvus... and I didn't like it.  Could your code somehow address the existence of that code?  (This could be for another ticket, of course.)\n\nIN the sage notebook now putting '<html>...</html>\" in output makes it display as html.\nIn salvus there is a completely different way of doing this, which involves sending messages... From a code point of view there is a function \"html\", which does the right thing for any notebook client.",
    "created_at": "2013-02-12T19:08:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172937",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172938",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "> Could your code somehow address the existence of that code? (This could be for another ticket, of course.)\n\n\nSee also #13131.",
    "created_at": "2013-02-12T21:03:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172939",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172940",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172941",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172944",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "Note that #13131 adds the processing of an `_html_` method (in a naive way) to the existing html() command.",
    "created_at": "2013-02-14T15:40:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172945",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172946",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172947",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "I think I agree that they serve different functions. I was addressing the point in [comment:10] that \"The existing html() already returns html for the object if it has an _html_ method\" -- I don't think this is accurate, I think that the _html_ method was introduced in #13131.\n\nI will try to look at your patch in detail. Meanwhile, you should know that the entire directory `devel/sage/doc/output` is not part of the Sage distribution, so you shouldn't put any files there. Maybe your files should instead go into `devel/sage/doc/common/themes/sage/static`? I'm not sure...",
    "created_at": "2013-02-14T23:54:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172948",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172950",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172951",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13900#issuecomment-172952",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13900#event-39740"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13900#event-39741"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13900#event-39742"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13900#event-39743"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13900#event-39744"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13900#event-39745"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13900#event-39746"
}
```
