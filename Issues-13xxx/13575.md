...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160841",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160842",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160843",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [boolean_polynomials.py.2.patch](https://github.com/sagemath/sage/files/ticket13575/boolean_polynomials.py.2.patch) by @daeinar created at 2012-10-08 13:49:07\n\nMade all the changes. Above is the new version.",
    "created_at": "2012-10-08T13:49:07Z",
    "issue": "https://github.com/sagemath/sage/issues/13575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160844",
    "user": "https://github.com/daeinar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160845",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160846",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160847",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13575#issuecomment-160848",
