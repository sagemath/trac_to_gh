...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171563"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171564"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171567"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,6 +3,10 @@\n The result of this change in the code will be that\n 1. It will also speed up the function considerably, partly because it won't depend on string parsing from GAP.\n 2. It will be able to handle Sage objects much better.\n-3. If and when #10534 is merged, the function will automatically gain at least 10x speed.\n \n Similarly, `combinations_iterator` should directly return a `Combinations` object, instead of duplicating stuff.\n+\n+The attached patch performs this change.\n+\n+---\n+Apply [attachment: trac_13821-change_combinations.patch.gz](https://github.com/sagemath/sage/files/ticket13821/trac_13821-change_combinations.patch.gz) to devel/sage.\n``````\n",
    "created_at": "2012-12-11T16:02:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13821",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171570"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171571"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171572"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171573"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171574"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171575"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171576"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171577"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171578"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171579"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171580"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171581"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171582"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171583"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13821#issuecomment-165295",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171584"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13821",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13821#event-171585"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13821",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13821#issuecomment-165296",
    "user": "https://github.com/jdemeyer"
}
```
