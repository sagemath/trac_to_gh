...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13966#issuecomment-167712",
    "user": "https://github.com/pipedream"
}
```
...
```json
{
    "body": "Assignee: **@sagetrac-mvngu, @haraldschilly**",
    "created_at": "2013-01-18T10:17:32Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13966#issuecomment-167713",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13966#event-179881"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13966#event-179882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13966",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13966#event-179883"
}
```
