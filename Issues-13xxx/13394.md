...
```json
{
    ...
    "type": "issue",
    "updated_at": "2014-03-16T22:32:45Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158470"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158472"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158473"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158474"
}
```
...
```json
{
    "body": "**Attachment:** [weak_value_dictionary.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/weak_value_dictionary.pyx.gz)\n\nProof of concept",
...
**Attachment:** [weak_value_dictionary.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/weak_value_dictionary.pyx.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158475"
}
```
...
```json
{
    "body": "**Attachment:** [deldict_exact.2.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/deldict_exact.2.pyx.gz)\n\nproof of concept delete-by-id for python dicts",
...
**Attachment:** [deldict_exact.2.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/deldict_exact.2.pyx.gz)
...
```json
{
    "body": "**Attachment:** [weak_dict_nb.2.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/weak_dict_nb.2.pyx.gz)\n\nUpdated git commit",
...
**Attachment:** [weak_dict_nb.2.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/weak_dict_nb.2.pyx.gz)
...
```json
{
    "body": "**Attachment:** [weak_dict.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/weak_dict.pyx.gz)\n\nupdate",
...
**Attachment:** [weak_dict.pyx.gz](https://github.com/sagemath/sage/files/ticket13394/weak_dict.pyx.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158477"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158478"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158479"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158480"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158481"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158482"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158483"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158484"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158485"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158486"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158489"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158490"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158491"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158493"
}
```
...
```json
{
    "body": "**Attachment:** [trac13394-weak_value_dictionary.patch.gz](https://github.com/sagemath/sage/files/ticket13394/trac13394-weak_value_dictionary.patch.gz)\n\nMercuarial patch in old folder layout",
...
**Attachment:** [trac13394-weak_value_dictionary.patch.gz](https://github.com/sagemath/sage/files/ticket13394/trac13394-weak_value_dictionary.patch.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13394",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13394#event-158499"
}
```
