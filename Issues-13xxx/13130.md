...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166247",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Updated so that it applies on Sage-5.1",
    "created_at": "2012-07-17T12:10:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166248",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:4'></a>Updated so that it applies on Sage-5.1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166249",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166251",
    "user": "https://github.com/annahaensch"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>What is the reason for `needs_work`?\n\nMore importantly - what is the reason for replacing the original patch? Do you propose a different implementation? Why? What are the differences?",
    "created_at": "2012-08-04T20:12:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166252",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:7'></a>What is the reason for `needs_work`?
...
```json
{
    "body": "<a id='comment:8'></a>As I describe in the comment above, the new patch reflects some minor changes to bring doctest coverage up to 100% and fix the docbuild errors.  Also, mentioned above, it still fails to pass the long test, due to some errors in r functionality, which is why the patch needs_work.",
    "created_at": "2012-08-04T22:11:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166253",
    "user": "https://github.com/annahaensch"
}
```

<a id='comment:8'></a>As I describe in the comment above, the new patch reflects some minor changes to bring doctest coverage up to 100% and fix the docbuild errors.  Also, mentioned above, it still fails to pass the long test, due to some errors in r functionality, which is why the patch needs_work.
...
```json
{
    "body": "<a id='comment:9'></a>Thanks for reviewing this Anna (and the doc fix).  Just to be sure I understand the current situation:\n\nwhen you run --testall --long you get an error in r.py, but when you run -t --long on r.py you get all passed?",
    "created_at": "2012-08-04T22:31:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166254",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:9'></a>Thanks for reviewing this Anna (and the doc fix).  Just to be sure I understand the current situation:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166255",
    "user": "https://github.com/annahaensch"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>If the new patch reflect some minor changes, it should be a small reviewer patch on top of the original (quite big) one. If the original patch cannot be applied anymore at all, that's another issue.\n\nIt is also not clear if failures in `r.py` are related to this ticket. Do you always get an error with `--testall` when this patch is installed and never without it?",
    "created_at": "2012-08-04T22:47:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166256",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:11'></a>If the new patch reflect some minor changes, it should be a small reviewer patch on top of the original (quite big) one. If the original patch cannot be applied anymore at all, that's another issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166257",
    "user": "https://github.com/annahaensch"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Usually it is OK to replace your patch with an updated one. When there is more than one patch on the ticket, it is also a good idea to include \"Apply\" section in the description, see e.g. #11763. This is for reviewers and the release manager, who should not go through all the comments once this ticket is ready to be merged. You can also add a comment \"Apply ...\" for the patchbot, but it is moody and does not always pick it up.",
    "created_at": "2012-08-05T16:44:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166263",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:18'></a>Usually it is OK to replace your patch with an updated one. When there is more than one patch on the ticket, it is also a good idea to include "Apply" section in the description, see e.g. #11763. This is for reviewers and the release manager, who should not go through all the comments once this ticket is ready to be merged. You can also add a comment "Apply ..." for the patchbot, but it is moody and does not always pick it up.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166264",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166265",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>I went to check this on 5.3 and noticed that I had implemented scale_by() and normalize_coordinates() in class::SchemeMorphism_polynomial. That was wrong since they should only apply to projective maps. So I've moved those to SchemeMorphism_polynomial_projective_space.\n\nThey modify the _ _polys attribute of the SchememMorphism_polynomial, but a _ _ attribute is private. Since it makes sense to inherit the polys attribute, I changed it to ._polys. I checked through the source and found no place where that created an issue and all tests currently pass.\n\nAlso, I noticed that somehow I've created a bunch of\n\n_ 'blank line'\n\n+ 'blank line'\n\nI tried to removed those directly from the patch file and wrecked patch. If someone could tell me how to get those out of there, I'd like to remove them.",
    "created_at": "2012-10-05T13:51:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166266",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:22'></a>I went to check this on 5.3 and noticed that I had implemented scale_by() and normalize_coordinates() in class::SchemeMorphism_polynomial. That was wrong since they should only apply to projective maps. So I've moved those to SchemeMorphism_polynomial_projective_space.
...
```json
{
    "body": "<a id='comment:23'></a>Updated to work with Sage 5.5.",
    "created_at": "2013-01-03T17:19:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166267",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:23'></a>Updated to work with Sage 5.5.
...
```json
{
    "body": "<a id='comment:24'></a>While working on something else, I found a bug in the patch. It's been fixed and the new patch uploaded.",
    "created_at": "2013-01-08T16:07:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166268",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:24'></a>While working on something else, I found a bug in the patch. It's been fixed and the new patch uploaded.
...
```json
{
    "body": "<a id='comment:25'></a>Patch needs to be rediffed for current sage...",
    "created_at": "2013-02-24T04:09:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166269",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:25'></a>Patch needs to be rediffed for current sage...
...
```json
{
    "body": "<a id='comment:26'></a>All seems good on 5.7",
    "created_at": "2013-02-24T21:29:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166270",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:26'></a>All seems good on 5.7
...
```json
{
    "body": "<a id='comment:27'></a>Patchbot:\napply trac_13130_rings_for_projective_space.patch",
    "created_at": "2013-02-25T01:59:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166271",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:27'></a>Patchbot:
apply trac_13130_rings_for_projective_space.patch
...
```json
{
    "body": "<a id='comment:28'></a>Minor changes from review.",
    "created_at": "2013-02-28T02:24:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166272",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:28'></a>Minor changes from review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166273",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166275",
    "user": "https://trac.sagemath.org/admin/accounts/users/mmanes"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166276",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13130#event-36162"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Well, this is closed, but you still need to correct the doc : there are wrong \"INPUT::\" everywhere.",
    "created_at": "2013-03-06T13:05:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166277",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:32'></a>Well, this is closed, but you still need to correct the doc : there are wrong "INPUT::" everywhere.
...
```json
{
    "body": "<a id='comment:33'></a>I agree, the documentation formatting is horrible.",
    "created_at": "2013-03-06T13:12:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166278",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:33'></a>I agree, the documentation formatting is horrible.
...
```json
{
    "body": "<a id='comment:34'></a>Ok. This will be fixed as part of #14217.",
    "created_at": "2013-03-06T13:52:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13130#issuecomment-166279",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:34'></a>Ok. This will be fixed as part of #14217.
