...
```json
{
    "body": "<a id='comment:2'></a>I tried `gcc -munaligned-doubles` but that didn't help.\n\nThe problem seems to be that malloc on 32-bit SPARC solaris generally returns 4-byte aligned buffers.",
    "created_at": "2012-06-22T10:27:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194744",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>I tried `gcc -munaligned-doubles` but that didn't help.
...
```json
{
    "body": "<a id='comment:3'></a>I've built 32-bit Sage on OpenIndiana and it works fine, for the record.",
    "created_at": "2012-06-22T11:58:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194745",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>I've built 32-bit Sage on OpenIndiana and it works fine, for the record.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194746",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194747",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194748",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Some more testing reveals that a) malloc on SPARC is in fact 8-byte aligned (as specified by the C99 standard), and b) the **output of `PyString_FromStringAndSize` is never 8-byte aligned,** not on SPARC 32-bit, OI 32-bit, Linux 64-bit:\n\n```\nsage: cython(\"\"\"\n....: def f():\n....:         cdef char* buf\n....:     s = PyString_FromStringAndSize(NULL, 1*8)\n....:     buf = <char*>s\n....:     return <int>buf\n....: \"\"\")\nsage: \nsage: set([ f() % 8 for i in range(100) ])\nset([4])\n```",
    "created_at": "2012-06-22T13:24:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194750",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:8'></a>Some more testing reveals that a) malloc on SPARC is in fact 8-byte aligned (as specified by the C99 standard), and b) the **output of `PyString_FromStringAndSize` is never 8-byte aligned,** not on SPARC 32-bit, OI 32-bit, Linux 64-bit:
...
```json
{
    "body": "<a id='comment:9'></a>For debugging purposes it might be useful to know that you can turn off the misalignment support and trigger bus errors on x86 processors:\n\n```c\n#include <stdio.h>\n#include <stdlib.h>\n#include <string.h>\n#include <inttypes.h>\n\n/* Run as (on x86 processors):\n * $ gcc -o test test.c && ./test\n * Bus error (core dumped)\n */\n\n\nint main(void)\n{\n  __asm__(\"pushf\\n\"\n\t  \"orl $0x40000, (%rsp)\\n\"\n\t  \"popf\");\n \n    char *ptr = malloc(20);\n    ptr += 4;\n\n    uint64_t *uint64_ptr = (uint64_t*)ptr;\n    (*uint64_ptr) = (uint64_t)1;\n\n    return 0;\n}\n```",
    "created_at": "2012-06-22T14:00:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194751",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>For debugging purposes it might be useful to know that you can turn off the misalignment support and trigger bus errors on x86 processors:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194752",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194753",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194754",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194755",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I can confirm the `hg` problem, but don't feel like investigating that now.\n\nYou could try building the current Sage with that `gcc` version instead of using the GCC spkg (note that we currently only support the Sun linker on Solaris, but that's okay).",
    "created_at": "2012-06-22T21:48:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194757",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:12'></a>I can confirm the `hg` problem, but don't feel like investigating that now.
...
```json
{
    "body": "<a id='comment:13'></a>Back to the pickling issue, why do cast double to uint64_t at all? Since we clearly don't care about endianness, why not just memcpy the bare data?",
    "created_at": "2012-06-22T23:24:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194758",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>Back to the pickling issue, why do cast double to uint64_t at all? Since we clearly don't care about endianness, why not just memcpy the bare data?
...
```json
{
    "body": "<a id='comment:14'></a>When we load a pickle from machine A on machine B and they have different endianness, then we care about fixing that.",
    "created_at": "2012-06-23T10:17:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194759",
    "user": "https://github.com/malb"
}
```

<a id='comment:14'></a>When we load a pickle from machine A on machine B and they have different endianness, then we care about fixing that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194760",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194762",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194763",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Replying to [vbraun](#comment%3A11):\n> I noticed another oddity: `sage -hg` works with my sage-4.7.2.alpha3 build, [...]\n\n\nDoesn't really surprise me... ;-)\n\n(I've tested it with GCC 4.5.1 and 4.6.1.)",
    "created_at": "2013-04-01T14:00:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194764",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:21'></a>Replying to [vbraun](#comment%3A11):
> I noticed another oddity: `sage -hg` works with my sage-4.7.2.alpha3 build, [...]
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194765",
...
```json
{
    "body": "<a id='comment:23'></a>Replying to [jdemeyer](#comment%3A7):\n> eplying to [vbraun](#comment%3A2):\n> > I tried `gcc -munaligned-doubles` but that didn't help.\n> > \n> > The problem seems to be that malloc on 32-bit SPARC solaris generally returns 4-byte aligned buffers.\n\n> That's not necessarily the case.  The string `<char*>s` isn't directly generated from a `malloc`, instead it is the result of a `PyString_AsString()` call.  That isn't guaranteed to be 8-bytes aligned.\n> \n> The obvious solution is to allocate a buffer ourselves, fill that and pass the result to `PyString_FromStringAndSize(buf, size)`. This will cause an extra `memcpy()` but that might be unavoidable.\n\nSo should we go with that solution?",
    "created_at": "2013-04-03T14:10:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194766",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:23'></a>Replying to [jdemeyer](#comment%3A7):
> eplying to [vbraun](#comment%3A2):
> > I tried `gcc -munaligned-doubles` but that didn't help.
> > 
> > The problem seems to be that malloc on 32-bit SPARC solaris generally returns 4-byte aligned buffers.
...
```json
{
    "body": "<a id='comment:24'></a>Not that we really care if matrix unpickling is a little slower...",
    "created_at": "2013-04-03T14:11:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194767",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:24'></a>Not that we really care if matrix unpickling is a little slower...
...
```json
{
    "body": "<a id='comment:25'></a>OK, you write the patch or me (just asking to avoid duplicating effort).\n\nIt would be really cool if we could have full SPARC suppport in sage-5.9, and maybe even full Cygwin support also.",
    "created_at": "2013-04-04T07:09:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194768",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:25'></a>OK, you write the patch or me (just asking to avoid duplicating effort).
...
```json
{
    "body": "<a id='comment:26'></a>I won't have time before late tonight, so please go ahead and I'll review it later if that suits you.",
    "created_at": "2013-04-04T07:45:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194769",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:26'></a>I won't have time before late tonight, so please go ahead and I'll review it later if that suits you.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194770",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194771",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194772",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>See #14429 for another SPARC-related ticket. When applying #13151 and #14429, there should be no more doctest failures on Solaris SPARC, i.e. Solaris SPARC would become fully supported with these two tickets.",
    "created_at": "2013-04-09T10:28:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194773",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:29'></a>See #14429 for another SPARC-related ticket. When applying #13151 and #14429, there should be no more doctest failures on Solaris SPARC, i.e. Solaris SPARC would become fully supported with these two tickets.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194774",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194775",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>This works fine and the patch looks ok, implementing the solution which was suggested here.",
    "created_at": "2013-04-10T08:52:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194776",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:30'></a>This works fine and the patch looks ok, implementing the solution which was suggested here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194777",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>I fixed a small mistake: the `sig_on()` should be *outside* the `try/finally` statement. I assume that the positive review still stands.",
    "created_at": "2013-04-10T10:24:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194778",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>I fixed a small mistake: the `sig_on()` should be *outside* the `try/finally` statement. I assume that the positive review still stands.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13151#event-36239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194779",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13151#issuecomment-194780",
    "user": "https://github.com/jdemeyer"
}
```
