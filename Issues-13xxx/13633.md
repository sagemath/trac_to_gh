...
```json
{
    ...
    "type": "issue",
    "updated_at": "2014-05-12T09:26:33Z",
    "url": "https://github.com/sagemath/sage/issues/13633",
...
```json
{
    ...
    "created_at": "2012-10-21T04:37:28Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "milestone_number": null,
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174840"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162299",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162300",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162301",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162303",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    "body": "<div id=\"comment:6\" align=\"right\">Comment 6</div>\n\nAlso, there appears to be a related problem at Trac [13445](https://github.com/sagemath/sage/issues/13445). There, if I run S.hecke_polynomial(29), I get a \"RuntimeError: maximum recursion depth exceeded in cmp\".",
    "created_at": "2012-10-22T16:19:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162304",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162305",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162306",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162308",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174844"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174845"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174847"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13633#issuecomment-162309",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174848"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174849"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174852"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13633",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13633#event-174858"
}
```
