...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176261",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Ah, I see. I'm using version 5.2 released near the end of July. I had wanted to wait until upgrading (to 5.4) before posting this bug, but then I didn't see anything merged in 5.3 that seemed at all related to it. Thanks.",
    "created_at": "2012-10-21T15:56:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176263",
    "user": "https://github.com/rharron"
}
```

<a id='comment:3'></a>Ah, I see. I'm using version 5.2 released near the end of July. I had wanted to wait until upgrading (to 5.4) before posting this bug, but then I didn't see anything merged in 5.3 that seemed at all related to it. Thanks.
...
```json
{
    "body": "<a id='comment:6'></a>Also, there appears to be a related problem at Trac [13445](http://trac.sagemath.org/sage_trac/ticket/13445). There, if I run S.hecke_polynomial(29), I get a \"RuntimeError: maximum recursion depth exceeded in cmp\".",
    "created_at": "2012-10-22T16:19:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176266",
    "user": "https://github.com/rharron"
}
```

<a id='comment:6'></a>Also, there appears to be a related problem at Trac [13445](http://trac.sagemath.org/sage_trac/ticket/13445). There, if I run S.hecke_polynomial(29), I get a "RuntimeError: maximum recursion depth exceeded in cmp".
...
```json
{
    "body": "<a id='comment:8'></a>Wait, but no, I don't have OS X 10.8, I have 10.6. And I built sage from the source on this computer.",
    "created_at": "2012-10-22T17:01:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176268",
    "user": "https://github.com/rharron"
}
```

<a id='comment:8'></a>Wait, but no, I don't have OS X 10.8, I have 10.6. And I built sage from the source on this computer.
...
```json
{
    "body": "<a id='comment:10'></a>Wow!",
    "created_at": "2012-10-22T17:09:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176270",
    "user": "https://github.com/rharron"
}
```

<a id='comment:10'></a>Wow!
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38042"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38043"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38044"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>The discussion above seems to indicate that this is an issue that's very specific to OS X 10.6.\n\nI suggest that we close the ticket as \"worksforme\".",
    "created_at": "2014-04-18T23:33:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176271",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:13'></a>The discussion above seems to indicate that this is an issue that's very specific to OS X 10.6.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176272",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38045"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38046"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176273",
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38047"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38048"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13633#event-38049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13633#issuecomment-176274",
