...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213491",
...
```json
{
    "body": "<a id='comment:6'></a>One very astonishing difference is that without #12313, Hom (or anything else from sage.categories.homset) is not called at all!!! Note that the list without #12313 is complete.\n\nI expected that it would be called once, and then cached. But why is no homset created, even though coercion maps should certainly be involved?",
    "created_at": "2013-01-23T12:11:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213494",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>One very astonishing difference is that without #12313, Hom (or anything else from sage.categories.homset) is not called at all!!! Note that the list without #12313 is complete.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213495",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>In fact, you might try running the code in the python debugger and set a breakpoint on `Hom` (I've never done that, but I assume it's possible). The stackframes you're finding there might give you some indication for what the code is trying to construct (and aparently has lost compared to the reference case).",
    "created_at": "2013-01-23T18:38:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213496",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:8'></a>In fact, you might try running the code in the python debugger and set a breakpoint on `Hom` (I've never done that, but I assume it's possible). The stackframes you're finding there might give you some indication for what the code is trying to construct (and aparently has lost compared to the reference case).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213497",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213499",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213500",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>A strange problem is the fact that `__cmp__` is inherited from `CombinatorialClass`, even if I let `Partitions_n` inherit from `UniqueRepresentation`. I have to check why this is the case - if it inherits from `UniqueRepresentation`, then it should inherit *both* `__hash__` and `__cmp__` from it, and not only `__hash__`.",
    "created_at": "2013-01-23T22:21:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213503",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:15'></a>A strange problem is the fact that `__cmp__` is inherited from `CombinatorialClass`, even if I let `Partitions_n` inherit from `UniqueRepresentation`. I have to check why this is the case - if it inherits from `UniqueRepresentation`, then it should inherit *both* `__hash__` and `__cmp__` from it, and not only `__hash__`.
...
```json
{
    "body": "<a id='comment:17'></a>The following (in which I use `UniqueRepresentation` on Partitions_n) could also benefit from making `UniqueRepresentation` provide a cmp method as well:\n\n```\nsage: P = Partitions(1)\nsage: Q = Partitions(4)\nsage: %timeit P==Q  # this is how they do compare\n625 loops, best of 3: 2.33 \u00b5s per loop\nsage: %timeit P is Q # this is how UniqueRepresentation *should* compare\n625 loops, best of 3: 248 ns per loop\n```",
    "created_at": "2013-01-23T22:31:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213505",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:17'></a>The following (in which I use `UniqueRepresentation` on Partitions_n) could also benefit from making `UniqueRepresentation` provide a cmp method as well:
...
```json
{
    "body": "<a id='comment:18'></a>Aha! It could actually be the overhead of calling `UniqueRepresentation.__eq__`, which is just a Python method. I see remarks like \"Should be cythoned\" in the code. Perhaps this should really be done, but on a different ticket.",
    "created_at": "2013-01-23T22:55:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213506",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:18'></a>Aha! It could actually be the overhead of calling `UniqueRepresentation.__eq__`, which is just a Python method. I see remarks like "Should be cythoned" in the code. Perhaps this should really be done, but on a different ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213507",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Attachment [trac13991-UniqueRepresentation_for_partitions.patch](tarball://root/attachments/some-uuid/ticket13991/trac13991-UniqueRepresentation_for_partitions.patch) by @simon-king-jena created at 2013-01-23 22:59:54\n\nI have attached an unfinished patch (if `UniqueRepresentation` is used, then I guess some doctests should be changed from using `==` to using `is`, and perhaps other tests will break).\n\nCan you test whether this patch would completely resolve the regression we are dealing with here?",
    "created_at": "2013-01-23T22:59:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213508",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:19'></a>Attachment [trac13991-UniqueRepresentation_for_partitions.patch](tarball://root/attachments/some-uuid/ticket13991/trac13991-UniqueRepresentation_for_partitions.patch) by @simon-king-jena created at 2013-01-23 22:59:54
...
```json
{
    "body": "<a id='comment:20'></a>Aha. Cythoning `UniqueRepresentation` makes a lot of sense. Simply renaming `sage/structure/unique_representation.py` into `sage/structure/unique_representation.pyx` and updating module_list.py already yields (with the [attachment:trac13991-UniqueRepresentation_for_partitions.patch experimental patch]:\n\n```\nsage: P = Partitions(1)\nsage: Q = Partitions(4)\nsage: %timeit P==Q\n625 loops, best of 3: 986 ns per loop\n```\n\nI guess making `UniqueRepresentation` inherit its methods from a cdef class will improve it further.",
    "created_at": "2013-01-23T23:08:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213509",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:20'></a>Aha. Cythoning `UniqueRepresentation` makes a lot of sense. Simply renaming `sage/structure/unique_representation.py` into `sage/structure/unique_representation.pyx` and updating module_list.py already yields (with the [attachment:trac13991-UniqueRepresentation_for_partitions.patch experimental patch]:
...
```json
{
    "body": "<a id='comment:21'></a>Great! When implementing comparison of `UniqueRepresentation` via the `__richcmp__` method of a cdef class, one gets:\n\n```\nsage: P = Partitions(1)\nsage: Q = Partitions(4)\nsage: %timeit P==Q\n625 loops, best of 3: 696 ns per loop\nsage: %timeit P is Q\n625 loops, best of 3: 318 ns per loop\n```\n\nStill, I am not totally happy that it takes longer than 400 ns, but certainly 696 ns is a lot better than 2.33 \u00b5s. I will try to make cythoned unique representations work, but that will be on a different ticket.",
    "created_at": "2013-01-23T23:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213510",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:21'></a>Great! When implementing comparison of `UniqueRepresentation` via the `__richcmp__` method of a cdef class, one gets:
...
```json
{
    "body": "<a id='comment:23'></a>Other than that, a definite +1 on having Partitions_n have UniqueRepresentation and on cythoning UniqueRepresentation.",
    "created_at": "2013-01-24T00:02:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213512",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:23'></a>Other than that, a definite +1 on having Partitions_n have UniqueRepresentation and on cythoning UniqueRepresentation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213513",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Andrew Mathas has pointed us to #13605, which turns `Partitions` into unique parents anyway. So, it could be that #13605 fixes our problem, and even if it does not then we should still work on top of it.",
    "created_at": "2013-01-24T06:00:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213514",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:24'></a>Andrew Mathas has pointed us to #13605, which turns `Partitions` into unique parents anyway. So, it could be that #13605 fixes our problem, and even if it does not then we should still work on top of it.
...
```json
{
    "body": "<a id='comment:25'></a>After looking at #13605, I am not sure if it will be fixed any time soon, partially because it depends on another ticket that currently needs work. Hence, as a short term solution, one could consider to finalise the experimental patch from here and make #13605 depend on it.\n\nAnyway, with the experimental patch, the speed regression (or at least the abundance of needless function calls for computing X*X) vanishes, and the only doctest failures are in partitions.py, which can probably easily be fixed.\n\nApply trac13991-UniqueRepresentation_for_partitions.patch",
    "created_at": "2013-01-24T21:13:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213515",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:25'></a>After looking at #13605, I am not sure if it will be fixed any time soon, partially because it depends on another ticket that currently needs work. Hence, as a short term solution, one could consider to finalise the experimental patch from here and make #13605 depend on it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213516",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Just as a heads up, (we believe) we are done with #13605.",
    "created_at": "2013-02-22T23:10:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213517",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:28'></a>Just as a heads up, (we believe) we are done with #13605.
...
```json
{
    "body": "<a id='comment:30'></a>Did you find an example or a method that became particularly slow?",
    "created_at": "2013-03-02T19:54:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213519",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:30'></a>Did you find an example or a method that became particularly slow?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213520",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213521",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213523",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213524",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213525",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213527",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Attachment [k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt](tarball://root/attachments/some-uuid/ticket13991/k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt) by @nexttime created at 2013-03-03 01:36:53\n\nReplying to [leif](#comment%3A37):\n> Here are some timings I compiled \"manually\" for the tests marked \"long time\" (just as an example):\n> \n> \n> ```\n>   0.010s /   0.000s /  0.010s  [01165] dks4 = DualkSchurFunctions(Sym.kBoundedQuotient(Integer(4)))\n>   0.000s /   0.000s /  0.000s  [01166] dks4\n>  30.170s / 498.400s / 66.300s  [01168] TestSuite(dks4).run()  # long time (7s on sage.math, 2013)\n>   0.030s /   0.040s /  0.030s  [01169] dks4 = DualkSchurFunctions(Sym.kBoundedQuotient(Integer(4),t=Integer(1)))\n>  27.770s / 691.890s / 69.460s  [01170] TestSuite(dks4).run()  # long time (7s on sage.math, 2013)\n> \n>   0.020s /   0.040s /  0.010s  [01301] F = AffineSchurFunctions(SymmetricFunctions(QQ['t']).kBoundedQuotient(Integer(4),t=Integer(1)))\n>   0.000s /   0.000s /  0.000s  [01302] F\n>  20.860s / 142.690s / 33.710s  [01304] TestSuite(F).run()  # long time (5s on sage.math, 2013)\n> ```\n> \n> (Wall time for Sage 5.7.beta4 / 5.8.beta2 / 5.8.beta2+#13605, line number in `k_dual.py`, code executed.  From the second, in whole better run for each installation.)\n\n\nI've now attached the [attachment:k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2%2B13605.txt full comparison], in case anybody's interested... ;-)",
    "created_at": "2013-03-03T01:36:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213528",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:38'></a>Attachment [k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt](tarball://root/attachments/some-uuid/ticket13991/k_dual.test-long-verbose-walltime.sage-5.7.beta4_vs_5.8.beta2_vs_5.8.beta2+13605.txt) by @nexttime created at 2013-03-03 01:36:53
...
```json
{
    "body": "<a id='comment:42'></a>I will (try to) take a look at the symmetric functions code this week and see what we can optimize.",
    "created_at": "2013-03-04T18:22:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213532",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:42'></a>I will (try to) take a look at the symmetric functions code this week and see what we can optimize.
...
```json
{
    "body": "<a id='comment:44'></a>`sage.combinat.partition.Partition.from_kbounded_to_grassmannian` is never seems to be called in `k_dual.py` (at least it is not mentioned in the code or anywhere in the `sf` directory).",
    "created_at": "2013-03-04T19:32:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213534",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:44'></a>`sage.combinat.partition.Partition.from_kbounded_to_grassmannian` is never seems to be called in `k_dual.py` (at least it is not mentioned in the code or anywhere in the `sf` directory).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213536",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>I think it makes sense to change this ticket into a \"task\", and to create separate tickets for several independent aspects/ideas that make sense individually. See #14225 for one of these aspects.",
    "created_at": "2013-03-04T23:10:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213537",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:46'></a>I think it makes sense to change this ticket into a "task", and to create separate tickets for several independent aspects/ideas that make sense individually. See #14225 for one of these aspects.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213538",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213541",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:50'></a>Concerning \"modularity\": At #14225, I do both the `__classcall_private__` thing (which probably has very little influence on the running time) *and* the caching of Weyl groups. Shall I separate the two?",
    "created_at": "2013-03-05T08:29:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213542",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:50'></a>Concerning "modularity": At #14225, I do both the `__classcall_private__` thing (which probably has very little influence on the running time) *and* the caching of Weyl groups. Shall I separate the two?
...
```json
{
    "body": "<a id='comment:52'></a>In fact, sage.combinat.sf.k_dual uses `Partitions` in a rather restricted way: There is precisely one instance of `Partitions_all_bounded` used, and `Partitions` is also used in a restricted way, namely *always* with `max_part = self.k`.\n\nI think it really makes sense to cache this, because the cache will be limited (and will live in the objects that really use the cached data).\n\nWith this, I obtain:\n\n```\nsage: from sage.combinat.sf.k_dual import AffineSchurFunctions\nsage: F = AffineSchurFunctions(SymmetricFunctions(QQ['t']).kBoundedQuotient(Integer(4),t=Integer(1)))\nsage: %time TestSuite(F).run()\nCPU times: user 5.93 s, sys: 0.06 s, total: 5.99 s\nWall time: 6.10 s\n```\non the same machine as with the timings mentioned above. Hence, I think there is hope to solve the problem in a convenient way.\n\nSince this ticket is now a \"task\", I will post my patch on a new ticket.",
    "created_at": "2013-03-05T11:31:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213544",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:52'></a>In fact, sage.combinat.sf.k_dual uses `Partitions` in a rather restricted way: There is precisely one instance of `Partitions_all_bounded` used, and `Partitions` is also used in a restricted way, namely *always* with `max_part = self.k`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213545",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213546",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213547",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:56'></a>I have created #14228 for the caching.",
    "created_at": "2013-03-05T12:48:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213548",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:56'></a>I have created #14228 for the caching.
...
```json
{
    "body": "<a id='comment:57'></a>Sorry for the typo in the ticket number.",
    "created_at": "2013-03-05T12:49:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213549",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:57'></a>Sorry for the typo in the ticket number.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213550",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213551",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213552",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213554",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:60'></a>positive_review to what?",
    "created_at": "2013-03-06T13:40:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213555",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:60'></a>positive_review to what?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213556",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13991#issuecomment-213557",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13991",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13991#event-39336"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13991#event-39337"
}
```
