...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13518#event-172899"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13518#event-172900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13518#event-172901"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13518#issuecomment-160138",
    "user": "https://github.com/sagetrac-christiankuper"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13518#issuecomment-160139",
    "user": "https://github.com/jdemeyer"
}
```
