...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156318",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156319",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-112995"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156320",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,3 +1,3 @@\n There are some obvious improvements and simplifications to be done to `devel/sage/MANIFEST.in` and `devel/sage/spkg-dist`.\n \n-**Apply** [http://boxen.math.washington.edu/home/jdemeyer/patches/13315_manifest.patch](http://boxen.math.washington.edu/home/jdemeyer/patches/13315_manifest.patch) (for totally unknown reasons, this file can't be uploaded to Trac).\n+**Apply** [and [attachment:13315_dist_delauto.patch](https://github.com/sagemath/sage/files/ticket13315/e85f24e213f299f43c81da8ff71538a5.patch](https://github.com/sagemath/sage/files/ticket13315/3aae787d2a0b1a01cf0f78af13d61713.patch))\n``````\n",
    "created_at": "2012-07-31T21:11:13Z",
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156321",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-112996"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-112997"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156322",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156323",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156324",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156325",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-112998"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-112999"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113000"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113001"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156326",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156327",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113002"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113003"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113004"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113005"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket13315/13315_manifest.patch",
    "created_at": "2012-08-03T11:14:23Z",
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13315/13315_manifest.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>\nAttachment [13315_manifest.patch](https://github.com/sagemath/sage/files/ticket13315/13315_manifest.patch) by @jdemeyer created at 2012-08-03 11:14:23",
    "created_at": "2012-08-03T11:14:23Z",
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156328",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156329",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113006"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156330",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156331",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-113009"
}
```
