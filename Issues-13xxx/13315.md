...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-170181"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-170182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13315#event-170183"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,3 @@\n There are some obvious improvements and simplifications to be done to `devel/sage/MANIFEST.in` and `devel/sage/spkg-dist`.\n \n-**Apply** [http://boxen.math.washington.edu/home/jdemeyer/patches/13315_manifest.patch](http://boxen.math.washington.edu/home/jdemeyer/patches/13315_manifest.patch) (for totally unknown reasons, this file can't be uploaded to Trac).\n+**Apply** [and [attachment: 13315_dist_delauto.patch.gz](https://github.com/sagemath/sage/files/ticket13315/13315_dist_delauto.patch.gz)(https://github.com/sagemath/sage/files/ticket13315/619036be8d89c51da5ce32a6280d5dd2.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156395",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13315#issuecomment-156396",
    "user": "https://github.com/jdemeyer"
}
```
