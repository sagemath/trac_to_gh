...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198886",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198887",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198888",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198889",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198890",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I tested this patch by creating a new sdist (starting from sage-5.2), and these are the only differences in files being added or not (this is the diff of `ls -a1RF` output):\n\n```diff\n--- sage-5.2.ls 2012-08-01 18:31:34.000000000 +0200\n+++ sage-5.2.trac13315.ls       2012-08-01 18:31:39.000000000 +0200\n@@ -30,6 +30,7 @@\n branch\n branch.cache\n branchheads.cache\n+cache/\n dirstate\n hgrc\n last-message.txt\n@@ -41,6 +42,12 @@\n undo.desc\n undo.dirstate\n\n+./.hg/cache:\n+./\n+../\n+branchheads\n+tags\n+\n ./.hg/store:\n ./\n ../\n@@ -49,6 +56,10 @@\n 00manifest.d\n 00manifest.i\n data/\n+fncache\n+phaseroots\n+undo\n+undo.phaseroots\n\n ./.hg/store/data:\n ./\n@@ -5178,7 +5189,6 @@\n ./c_lib:\n ./\n ../\n-.sconsign.dblite\n SConstruct\n include/\n src/\n```",
    "created_at": "2012-08-01T16:34:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198891",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I tested this patch by creating a new sdist (starting from sage-5.2), and these are the only differences in files being added or not (this is the diff of `ls -a1RF` output):
...
```json
{
    "body": "<a id='comment:9'></a>Good points.",
    "created_at": "2012-08-02T06:15:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198894",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>Good points.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198895",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198896",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198897",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>In line 1 of MANIFEST.in, should we replace `recursive-include * ...` with `global-include ...`? Then I think we can delete line 8 (`include fpickle_setup.py module_list.py`). In my testing, the results are the same with these changes.",
    "created_at": "2012-08-03T03:42:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198898",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>In line 1 of MANIFEST.in, should we replace `recursive-include * ...` with `global-include ...`? Then I think we can delete line 8 (`include fpickle_setup.py module_list.py`). In my testing, the results are the same with these changes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198899",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198900",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Attachment [13315_manifest.patch](tarball://root/attachments/some-uuid/ticket13315/13315_manifest.patch) by @jdemeyer created at 2012-08-03 11:14:23",
    "created_at": "2012-08-03T11:14:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198901",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>Attachment [13315_manifest.patch](tarball://root/attachments/some-uuid/ticket13315/13315_manifest.patch) by @jdemeyer created at 2012-08-03 11:14:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198902",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198903",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Okay, this looks good to me.",
    "created_at": "2012-08-03T16:24:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198904",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:14'></a>Okay, this looks good to me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198905",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13315#issuecomment-198906",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13315",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13315#event-36845"
}
```
