...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13072#event-165981"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13072#event-165982"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13072#event-165983"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -33,4 +33,5 @@\n Finally, in addition to these new classes as discussed previously on sage-combinat I have removed a bunch functions which were depreciated years ago. I also added normal_nodes() and good_nodes methods to Partition_class and reinstated the beta_numbers() methods which were removed in the last patch to partition.py (this patch said that beta_numbers and frobenius_coordinates are identical objects, but they are actually different).\n \n \n-Apply: trac_13072-tuples-of-partitions_am.patch\n+\n+**Apply:** [attachment: trac_13072-tuples-of-tableaux-am.patch.gz](https://github.com/sagemath/sage/files/ticket13072/trac_13072-tuples-of-tableaux-am.patch.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13072#issuecomment-151337",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13072#issuecomment-151338",
    "user": "https://github.com/AndrewAtLarge"
}
```
