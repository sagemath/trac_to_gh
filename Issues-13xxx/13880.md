...
```json
{
    ...
    "asset_name": "trac_13880_swap_doctest_fix.patch",
    "asset_url": "tarball://root/attachments/ticket13880/trac_13880_swap_doctest_fix.patch",
    "created_at": "2012-12-29T19:22:54Z",
    "issue": "https://github.com/sagemath/sage/issues/13880",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13880/trac_13880_swap_doctest_fix.patch",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "**Attachment:** [trac_13880_swap_doctest_fix.patch](https://github.com/sagemath/sage/files/ticket13880/trac_13880_swap_doctest_fix.patch)\n\nUpdated patch",
    "created_at": "2012-12-29T19:22:54Z",
    "issue": "https://github.com/sagemath/sage/issues/13880",
    "type": "issue_comment",
...
**Attachment:** [trac_13880_swap_doctest_fix.patch](https://github.com/sagemath/sage/files/ticket13880/trac_13880_swap_doctest_fix.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119164"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119165"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119166"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119167"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119168"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119169"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119170"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_13880_gap_pool_RLIMIT_AS.patch",
    "asset_url": "tarball://root/attachments/ticket13880/trac_13880_gap_pool_RLIMIT_AS.patch",
    "created_at": "2013-01-04T16:00:19Z",
    "issue": "https://github.com/sagemath/sage/issues/13880",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13880/trac_13880_gap_pool_RLIMIT_AS.patch",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "**Attachment:** [trac_13880_gap_pool_RLIMIT_AS.patch](https://github.com/sagemath/sage/files/ticket13880/trac_13880_gap_pool_RLIMIT_AS.patch)\n\nUpdated patch",
    "created_at": "2013-01-04T16:00:19Z",
    "issue": "https://github.com/sagemath/sage/issues/13880",
    "type": "issue_comment",
...
**Attachment:** [trac_13880_gap_pool_RLIMIT_AS.patch](https://github.com/sagemath/sage/files/ticket13880/trac_13880_gap_pool_RLIMIT_AS.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119171"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119172"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119173"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13880#event-119174"
}
```
