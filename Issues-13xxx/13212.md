...
```json
{
    "body": "<a id='comment:1'></a>This can be corrected in one line by replacing the call to `hecke_bound` with `sturm_bound`.",
    "created_at": "2013-07-22T17:25:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13212",
    "type": "issue_comment",
...
<a id='comment:1'></a>This can be corrected in one line by replacing the call to `hecke_bound` with `sturm_bound`.
