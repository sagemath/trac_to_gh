...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13790#issuecomment-209342",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I see. I didn't know `SR.var` and `var` behaved differently. Sorry for the noise.",
    "created_at": "2012-12-02T21:23:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13790#issuecomment-209343",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:2'></a>I see. I didn't know `SR.var` and `var` behaved differently. Sorry for the noise.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13790#issuecomment-209344",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13790#event-38661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13790",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13790#event-38662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13790#issuecomment-209345",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13790#issuecomment-209346",
    "user": "https://github.com/jdemeyer"
}
```
