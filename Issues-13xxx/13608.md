...
```json
{
    "body": "I feel like we should have a more solid workaround for mpmath numbers.  Are there other things which don't work?  Plus, what about those people who **DO** want this `exp` attribute?",
...
```json
{
    "body": "Marking as \"needs review\" in case that attracts attention of someone who has a better solution...",
...
```json
{
    "body": "Sorry, appears I lost track of this one here. As I'm pretty busy just now, is there any chance someone will pick up my patch and polish it ready for inclusion? If not, it might still be some time before I get around to that.",
...
```json
{
    "body": "yes, in principle anybody can tell the bot which patch to apply. But the bot may choose not to obey its orders... :)\n\napply trac_13608_mpmath.patch",
...
```json
{
    "body": "OK, I finally got my sage git set up properly.\n\n---\nNew commits:",
    "created_at": "2014-03-27T15:25:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13608",
    "type": "issue_comment",
...
```json
{
    "body": "Rebased on 6.2.beta6. Long tests pass in symbolic/ and functions/ (and tutorials).\n\n---\nNew commits:",
    "created_at": "2014-04-05T08:18:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13608",
    "type": "issue_comment",
