...
```json
{
    "body": "<a id='comment:14'></a>\nHere is a minimal fix\n\nbut CartesianProduct was deprecated in #18411 and should rather be fully removed\n\n---\nNew commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[88c38d9](https://git.sagemath.org/sage.git/commit?id=88c38d9ebbaa39441795d648dcdef78c86c90c68)|`trac 13979 changes in CartesianProduct`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[0c41d46](https://git.sagemath.org/sage.git/commit/?id=0c41d46d6c8dfc32ed1858db5ea38a3c2529f883)|`trac 13979 fixing doctests in dev_tools`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nSorry it took a little bit. Here is an example using `sage.monoids`.\n\n---\nNew commits:\n|                                                                                                                                          |                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[dd38671](https://git.sagemath.org/sage.git/commit?id=dd386711b472cb5ac2250c5bce8d1492aae6a8c3)|`Changing test in dev_tools.py.`|",
