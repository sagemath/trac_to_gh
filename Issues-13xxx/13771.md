...
```json
{
    "body": "<a id='comment:27'></a>\nReplying to [vbraun](#comment%3A24):\n\nrebased to sage-6.1.beta2\n\n---\nNew commits:\n|                                                                                                         |                           |\n|---------------------------------------------------------------------------------------------------------|---------------------------|\n|[ae9acc6](http://git.sagemath.org/sage.git/commit/?id=ae9acc6)|`Rebased on sage-6.1.beta2`|\n|[82d2c10](http://git.sagemath.org/sage.git/commit/?id=82d2c10)|`# User Thomas Feulner <thomas.feulner`@`uni-bayreuth.de>`|",
