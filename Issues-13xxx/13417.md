...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165807"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165808"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165809"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165810"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165811"
}
```
...
```json
{
    "body": "<a id='comment:4'>Comment 4:</a>\nThe attachment [attachment: trac_13417-submodule_iter.patch.gz](https://github.com/sagemath/sage/files/ticket13417/trac_13417-submodule_iter.patch.gz) contains an update to the patch that we arrived at after a long (off-ticket) discussion with tfeulner. Needs review. :)\n\nPatchbot: apply trac_13417-submodule_iter.patch",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,4 +9,6 @@\n     sage: x = [0 for _ in X] #long time #takes 7.12 seconds\n     sage: y = [0 for _ in FiniteFieldsubspace_iterator(A)] # takes 0.05 seconds\n ```\n- \n+\n+---\n+Apply only [attachment: trac_13417-submodule_iter.patch.gz](https://github.com/sagemath/sage/files/ticket13417/trac_13417-submodule_iter.patch.gz)\n``````\n",
    "created_at": "2012-11-09T10:22:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13417",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,4 +11,4 @@\n ```\n \n ---\n-Apply only [attachment: trac_13417-submodule_iter.patch.gz](https://github.com/sagemath/sage/files/ticket13417/trac_13417-submodule_iter.patch.gz)\n+Apply only [attachment: trac_13417-submodule_iter.2.patch.gz](https://github.com/sagemath/sage/files/ticket13417/trac_13417-submodule_iter.2.patch.gz)\n``````\n",
    "created_at": "2012-11-12T11:02:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13417",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165812"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165813"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165814"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13417#issuecomment-158783",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165816"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13417#issuecomment-158784",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13417",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13417#event-165819"
}
```
