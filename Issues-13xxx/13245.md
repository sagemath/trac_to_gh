...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156176"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156180"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>\nI think that rebuilding the files in `sage/ext/interpreters/` is because of code in `devel/sage/setup.py`, and any changes to this should be on another ticket.\n\nMeanwhile, the patch [attachment:trac_13245-clone-cython.patch](https://github.com/sagemath/sage/files/ticket13245/trac_13245-clone-cython.patch) seems to fix the main cloning problem. I'm happy with that one.",
    "created_at": "2013-05-31T18:55:14Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13245",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156183"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156186"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13245",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13245#event-156189"
}
```
