...
```json
{
    "body": "<a id='comment:2'></a>As I said on sage-devel, this computation will require a very large number of L-series coefficients, so this does not surprise me.  I think that the only sensible way out is for the analytic rank function to quit gracefully for curve like this.",
    "created_at": "2012-11-13T09:28:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13705#issuecomment-207508",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>As I said on sage-devel, this computation will require a very large number of L-series coefficients, so this does not surprise me.  I think that the only sensible way out is for the analytic rank function to quit gracefully for curve like this.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13705#event-38354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13705#issuecomment-207510",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13705#event-38355"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13705#event-38356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13705#issuecomment-207511",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13705#issuecomment-207512",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Note also that the ticket reports a segmentation fault in `lcalc`, not Sage itself.",
    "created_at": "2014-01-06T14:13:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13705#issuecomment-207513",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>Note also that the ticket reports a segmentation fault in `lcalc`, not Sage itself.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13705#issuecomment-207515",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13705",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13705#event-38357"
}
```
