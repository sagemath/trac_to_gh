...
```json
{
    "body": "<a id='comment:2'></a>I tried to uncomment both these lines in integer.pyx and real_double.pyx but this lead to segfaults when starting Sage.\n\nIf I prevent the use of the fast tp_*, Sage starts (although I get a TypeError in sage/libs/gen/late_import, I've not recompiled everything after rebuilding Python)\n\nSo this will need more work.",
    "created_at": "2012-12-27T16:48:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210925",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:2'></a>I tried to uncomment both these lines in integer.pyx and real_double.pyx but this lead to segfaults when starting Sage.
...
```json
{
    "body": "<a id='comment:3'></a>I found the bug, the `PyObject_INIT` was only called when a new integer / real object was created and not when a recycled object from the pool was used. You have to call it in both branches, of course. I'll work out a fix where the debug preprocessor macro is used to conditionally compile it in.",
    "created_at": "2012-12-27T22:01:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210926",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210927",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210928",
...
```json
{
    "body": "<a id='comment:5'></a>Anyway, using your patch plus the new cython plus the latest version of the python spkg in debug mode, I am now able to start Sage without a crash. It \"only\" reports\n\n```\nImportError: /home/simon/SAGE/debug/sage-5.5.rc0/local/lib/python2.7/site-packages/sage/rings/polynomial/multi_polynomial_libsingular.so: undefined symbol: _Z7_p_TestP8spolyrecP9sip_sringi\n```\nBut on #13867 you said that for this one needs a new Singular spkg (hopefully one that still allows for using xalloc!).",
    "created_at": "2012-12-28T12:41:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210929",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Anyway, using your patch plus the new cython plus the latest version of the python spkg in debug mode, I am now able to start Sage without a crash. It "only" reports
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210930",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210931",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210932",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210933",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Did you compile everything from scratch? You definitely need to recompile pynac with debugging, maybe more?",
    "created_at": "2012-12-28T13:17:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210935",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:9'></a>Did you compile everything from scratch? You definitely need to recompile pynac with debugging, maybe more?
...
```json
{
    "body": "<a id='comment:10'></a>I did sage -ba after installing all stuff on top of an existing sage-5.5.",
    "created_at": "2012-12-28T13:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210936",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>I did sage -ba after installing all stuff on top of an existing sage-5.5.
...
```json
{
    "body": "<a id='comment:11'></a>If you start on sage-5.5 you at least need the patch from #13740, maybe more...",
    "created_at": "2012-12-28T13:29:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210937",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>If you start on sage-5.5 you at least need the patch from #13740, maybe more...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210938",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>I don't know whether *indented* preprocessor directives like\n\n```\n#if ...\n    #define ...\n#endif\n```\nare standard C. Maybe they are (GCC accepts them and documents this), but usually this is written as\n\n```\n#if ...\n#define ...\n#endif\n```",
    "created_at": "2012-12-28T16:16:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210939",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>I don't know whether *indented* preprocessor directives like
...
```json
{
    "body": "<a id='comment:14'></a>Pre-ANSI C did not allow for space, but those compilers are long dead (even by skynet standards). Its legal in all C versions that will at least start building Sage. I prefer the Cython-style indentation, then you don't have to mentally switch when reading it.",
    "created_at": "2012-12-28T17:01:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210940",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:14'></a>Pre-ANSI C did not allow for space, but those compilers are long dead (even by skynet standards). Its legal in all C versions that will at least start building Sage. I prefer the Cython-style indentation, then you don't have to mentally switch when reading it.
...
```json
{
    "body": "<a id='comment:15'></a>It would be nice if we could review and merge this ticket as it is the cause for the segfault during Sage \"make\" with `SAGE_DEBUG=yes`",
    "created_at": "2013-01-04T11:36:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210941",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:15'></a>It would be nice if we could review and merge this ticket as it is the cause for the segfault during Sage "make" with `SAGE_DEBUG=yes`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210942",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210943",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210944",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Attachment [trac_13868_tp_hooks_and_debug-typo.patch](tarball://root/attachments/some-uuid/ticket13868/trac_13868_tp_hooks_and_debug-typo.patch) by jpflori created at 2013-01-04 13:18:48\n\nWorks fine and seems correct to me.\nI just added a missing u in some comment.",
    "created_at": "2013-01-04T13:18:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210945",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:17'></a>Attachment [trac_13868_tp_hooks_and_debug-typo.patch](tarball://root/attachments/some-uuid/ticket13868/trac_13868_tp_hooks_and_debug-typo.patch) by jpflori created at 2013-01-04 13:18:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210946",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210947",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210948",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13868#event-38909"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13868#issuecomment-210949",
    "user": "https://github.com/jdemeyer"
}
```
