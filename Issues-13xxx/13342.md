...
<a id='comment:1'></a>I'm unable to build the documentation :( 
Any help to find the missing instructions is more than welcome.
...
<a id='comment:2'></a>I was unable to apply the patch.  Running hg_sage.apply('trac_13342-adds-sandpile-to-reference-manual.patch') produced an error:
...
<a id='comment:4'></a>I don't use the hg_sage.apply('...') function to apply a patch but
...
```json
{
    "body": "<a id='comment:5'></a>Why are you changing `setup.py`?",
...
<a id='comment:5'></a>Why are you changing `setup.py`?
...
<a id='comment:6'></a>When I was trying to build this documentation, I did some cleaning to setup.py, but you are right this should not be in this patch. I will remove it.
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_13342-adds-sandpile-to-reference-manual.patch](tarball://root/attachments/some-uuid/ticket13342/trac_13342-adds-sandpile-to-reference-manual.patch) by @jdemeyer created at 2013-08-13 15:35:53",
...
<a id='comment:7'></a>Attachment [trac_13342-adds-sandpile-to-reference-manual.patch](tarball://root/attachments/some-uuid/ticket13342/trac_13342-adds-sandpile-to-reference-manual.patch) by @jdemeyer created at 2013-08-13 15:35:53
...
<a id='comment:11'></a>They are now included in the doc.
