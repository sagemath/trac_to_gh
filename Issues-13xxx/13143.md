...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161416"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161417"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161420"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -28,3 +28,7 @@\n ```\n When building all of the documentation, the disk space actually drops, going from about 320M (without MathJax) to about 295M (with). \n \n+---\n+\n+- Apply [attachment: trac_13143-root.v2.patch.gz](https://github.com/sagemath/sage/files/ticket13143/trac_13143-root.v2.patch.gz) to the root repo.\n+- Apply [attachment: trac_13143-sage.v2.patch.gz](https://github.com/sagemath/sage/files/ticket13143/trac_13143-sage.v2.patch.gz) to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161421"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161428"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161429"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161430"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13143#issuecomment-152886",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13143",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13143#event-161432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13143#issuecomment-152887",
