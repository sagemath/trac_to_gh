...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38207"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38208"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38209"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38210"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38211"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38212"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206799",
...
```json
{
    "body": "<a id='comment:5'></a>I have a solution implemented at https://github.com/bollu/sage/tree/u/gh-bollu/jan-24-cholesky-for-sparse-numerical-matrices.",
    "created_at": "2021-01-23T22:14:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206800",
    "user": "https://github.com/bollu"
}
```

<a id='comment:5'></a>I have a solution implemented at https://github.com/bollu/sage/tree/u/gh-bollu/jan-24-cholesky-for-sparse-numerical-matrices.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206801",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206802",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206803",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206804",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206805",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206807",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38214"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38215"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Thanks a lot for the link! My only concern is with that of sparseness; the reason I choose to jump hoops with `cvxopt` is for the performance wins for *large* sparse matrices, that I get from running discrete differential geometry algorithms such as geodesics in heat: https://arxiv.org/abs/1204.6216\n\nI'll be glad to benchmark the code, and see which method is faster; I think the route you propose is performant for dense inexact matrices for sure. I'm unsure about the sparse case. Could you please shed some light on the performance characteristics of the linked implementation?",
    "created_at": "2021-01-26T17:37:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206809",
    "user": "https://github.com/bollu"
}
```

<a id='comment:11'></a>Thanks a lot for the link! My only concern is with that of sparseness; the reason I choose to jump hoops with `cvxopt` is for the performance wins for *large* sparse matrices, that I get from running discrete differential geometry algorithms such as geodesics in heat: https://arxiv.org/abs/1204.6216
...
```json
{
    "body": "<a id='comment:12'></a>`block_ldlt()` will be pretty slow on large sparse matrices since the implementation scans the matrix (without regard for sparsity) looking for pivots. It's main benefit (with respect to `cholmod`) is that it would work for other fields, like sparse matrices over `RR`.\n\nIf you need the performance for sparse matrices over `RDF` then something like `cholmod` is indeed the way to go. I'm surprised we don't have a special matrix subclass for sparse `RDF` matrices already; my first attempt would be to override `cholesky()` there, similar to how `cholesky()` is overridden in `matrix_double_dense.pyx` for dense matrices.",
    "created_at": "2021-01-26T18:33:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206810",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:12'></a>`block_ldlt()` will be pretty slow on large sparse matrices since the implementation scans the matrix (without regard for sparsity) looking for pivots. It's main benefit (with respect to `cholmod`) is that it would work for other fields, like sparse matrices over `RR`.
...
```json
{
    "body": "<a id='comment:13'></a>Indeed, for sparse matrices over RDF the cholmod interface of cvxopt is probably as fast as it can get (precision is of course another question).\n\nIn general, I'd be looking at wrapping up arb's [cholesky](https://arblib.org/arb_mat.html#cholesky-decomposition-and-solving) and LDLs,\nas something more robust than a naive attempt to implement this stuff.",
    "created_at": "2021-01-26T18:53:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206811",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:13'></a>Indeed, for sparse matrices over RDF the cholmod interface of cvxopt is probably as fast as it can get (precision is of course another question).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206813",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206814",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38216"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38217"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Ticket #31619 allows `cholesky()` and `is_positive_definite()` to work over inexact rings as promised, but it will be slower than necessary for sparse RDF matrices. A matrix subclass that delegates to `cholmod()` in that case is the last missing piece.",
    "created_at": "2021-04-29T12:46:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206815",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:17'></a>Ticket #31619 allows `cholesky()` and `is_positive_definite()` to work over inexact rings as promised, but it will be slower than necessary for sparse RDF matrices. A matrix subclass that delegates to `cholmod()` in that case is the last missing piece.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38218"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206816",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>cvxopt is now a pseudo-optional package, but we should still be able to use the approach in[comment:14](#comment%3A14). We can `super()` if cvxopt isn't available.",
    "created_at": "2021-11-20T21:24:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206817",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:19'></a>cvxopt is now a pseudo-optional package, but we should still be able to use the approach in[comment:14](#comment%3A14). We can `super()` if cvxopt isn't available.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206818",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206819",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206820",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206821",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>This should work for both `RDF` and `CDF`, but it would be nice to have some more serious examples for test cases. The cvxopt interface is a little sketchy so I'd like to be *sure* that we're using it \"correctly,\" insofar as is possible for an undocumented interface.",
    "created_at": "2021-11-23T00:17:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206822",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:20'></a>This should work for both `RDF` and `CDF`, but it would be nice to have some more serious examples for test cases. The cvxopt interface is a little sketchy so I'd like to be *sure* that we're using it "correctly," insofar as is possible for an undocumented interface.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206823",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206824",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206825",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206826",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13674#event-38220"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206827",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206829",
    "user": "https://github.com/collares"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>`@`gh-collares - please open a new ticket for this.",
    "created_at": "2021-12-14T22:59:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206830",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:24'></a>`@`gh-collares - please open a new ticket for this.
...
```json
{
    "body": "<a id='comment:25'></a>Opened #33023 for the test failure, thanks for letting me know about the correct procedure. I didn't know the \"Commit\" field would be cleared when I posted my first comment, sorry about that.",
    "created_at": "2021-12-14T23:07:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13674#issuecomment-206831",
    "user": "https://github.com/collares"
}
```

<a id='comment:25'></a>Opened #33023 for the test failure, thanks for letting me know about the correct procedure. I didn't know the "Commit" field would be cleared when I posted my first comment, sorry about that.
