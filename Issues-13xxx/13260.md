...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13260#event-169297"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13260#event-169298"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13260#event-169299"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,15 @@\n We've long needed a substantial, graded set of tutorials starting from absolute scratch geared toward new mathematical users of Sage who do not have any particular programming background.  In the PREP workshops the last three years, such a series of tutorials, including eight disciplinary \"quickstarts\" and an intro to interacts, have taken good shape, and are ready for inclusion.\n+\n+Apply [[attachment: trac_13260-quickstarts.patch.gz](https://github.com/sagemath/sage/files/ticket13260/trac_13260-quickstarts.patch.gz), and [attachment: trac_13260-images.patch.gz](https://github.com/sagemath/sage/files/ticket13260/trac_13260-images.patch.gz)(https://github.com/sagemath/sage/files/ticket13260/091ae97fa21137daa1a784466ffdbd86.gz).\n+\n+The first patch has just the main tutorials, the second has the disciplinary \"quickstarts\", and the third should only have the image files.\n+\n+\n+Recommended reviewing method is to apply all three patches, build the documentation, and then look at it.  Then one can refer to the relevant patch in review.\n+\n+```\n+sage -docbuild prep html\n+sage -docbuild website html\n+```\n+is what I usually do.\n+\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,6 +1,6 @@\n We've long needed a substantial, graded set of tutorials starting from absolute scratch geared toward new mathematical users of Sage who do not have any particular programming background.  In the PREP workshops the last three years, such a series of tutorials, including eight disciplinary \"quickstarts\" and an intro to interacts, have taken good shape, and are ready for inclusion.\n \n-Apply [[attachment: trac_13260-quickstarts.patch.gz](https://github.com/sagemath/sage/files/ticket13260/trac_13260-quickstarts.patch.gz), and [attachment: trac_13260-images.patch.gz](https://github.com/sagemath/sage/files/ticket13260/trac_13260-images.patch.gz)(https://github.com/sagemath/sage/files/ticket13260/091ae97fa21137daa1a784466ffdbd86.gz).\n+Apply [[attachment: trac_13260-quickstarts.patch.gz](https://github.com/sagemath/sage/files/ticket13260/trac_13260-quickstarts.patch.gz), and [attachment: trac_13260-images-rebased.patch.gz](https://github.com/sagemath/sage/files/ticket13260/trac_13260-images-rebased.patch.gz)(https://github.com/sagemath/sage/files/ticket13260/091ae97fa21137daa1a784466ffdbd86.gz).\n \n The first patch has just the main tutorials, the second has the disciplinary \"quickstarts\", and the third should only have the image files.\n \n``````\n",
    "created_at": "2012-08-15T22:15:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13260",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13260",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13260#issuecomment-155487",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13260",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13260#issuecomment-155488",
