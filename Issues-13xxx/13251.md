...
```json
{
    "body": "Looks great. I went through your code closely and it looks nice and straightforward. I'm looking at the HTML docs now and pending that and long tests passing I'll give this a positive review. \n\nNice work.",
...
```json
{
    "body": "Everything came back good. I attached a reviewer patch to clean up some trailing whitespace from your most recent patch. This isn't a bug deal, just a cosmetic thing (and not everyone agrees on what should be done about it).",
