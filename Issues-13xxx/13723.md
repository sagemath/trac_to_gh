...
```json
{
    "body": "<a id='comment:1'></a>You need to deprecate the top level function (which you have already done) and not remove it entirely. The removal can happen after the deprecation period is over (typically 1 year).\n\nAnyway, the question is whether it should be deprecated. There is nothing wrong with having it both as `v.hamming_weight()` and as a global function `hamming_weight(v)`. In the latter case, you could modify the function to use the attribute if it is available:\n\n```python\ndef hamming_weight(v): # the function in sage/coding/\n    try:\n        return v.hamming_weight()\n    except AttributeError:\n        # the old code comes here\n```",
    "created_at": "2012-11-19T16:19:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207899",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:1'></a>You need to deprecate the top level function (which you have already done) and not remove it entirely. The removal can happen after the deprecation period is over (typically 1 year).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207902",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207903",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207904",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Patchbot: apply trac_13723-hamming_weight.patch",
    "created_at": "2012-11-20T10:28:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207906",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```

<a id='comment:6'></a>Patchbot: apply trac_13723-hamming_weight.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207907",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Looks good to me, though I am not particularly fond of using \"self\" in documentation. Anyway, positive review from my side. Everything seems to work here.",
    "created_at": "2012-11-20T12:55:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207908",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:7'></a>Looks good to me, though I am not particularly fond of using "self" in documentation. Anyway, positive review from my side. Everything seems to work here.
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13723#event-38444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207909",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207910",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207912",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207913",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207914",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13723#event-38445"
}
```
...
```json
{
    ...
    "milestone": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13723#event-38446"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207915",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207916",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207917",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207918",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13723#event-38447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13723#issuecomment-207919",
    "user": "https://github.com/jdemeyer"
}
```
