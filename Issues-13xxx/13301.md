...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13301#issuecomment-195711",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13301#issuecomment-195712",
    "user": "https://trac.sagemath.org/admin/accounts/users/lucaspastor"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13301#issuecomment-195713",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13301#event-50563"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13301#event-50564"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13301#event-50565"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13301#event-50566"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13301#event-50567"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13301#event-50568"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13301#event-50569"
}
```
