...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13141#event-167202"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13141#event-167203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13141#event-167204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13141",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13141#issuecomment-152834",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13141",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13141#issuecomment-152835",
    "user": "https://github.com/dimpase"
}
```
