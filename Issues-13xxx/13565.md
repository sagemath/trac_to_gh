...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13565",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13565#issuecomment-160758",
    "user": "https://github.com/sagetrac-r-gaia-cs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13565",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13565#issuecomment-160759",
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13565#event-173657"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13565#event-173658"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13565#event-173659"
}
```
