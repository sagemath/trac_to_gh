...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207846",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207848",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207849",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>1. If I understand correctly, modifying the code to make use of edge labels would break in the following scenario\n\n```\nsage: G = graphs.PetersenGraph()\nsage: L = G.line_graph()\nsage: L.is_arc_transitive()\n```\n\nIf so, then I believe this is a serious limitation that needs to be solved. I can see many real life scenarios in which one needs to these types of things on line graphs.\n\n2. I agree! I am for both options depending on what others think.",
    "created_at": "2012-11-20T09:32:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207851",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:5'></a>1. If I understand correctly, modifying the code to make use of edge labels would break in the following scenario
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207854",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Argggggggg.... Nasty TRAC. There is no \"question mark\". They keywords are ``OnSets``, ``OnTuples`` and ``OnPairs``.\n\nNathann",
    "created_at": "2012-11-21T13:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207855",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:9'></a>Argggggggg.... Nasty TRAC. There is no "question mark". They keywords are ``OnSets``, ``OnTuples`` and ``OnPairs``.
...
```json
{
    "body": "<a id='comment:10'></a>`>_<`\n\nAnother try :  `OnSets`,`OnTuples` and `OnPairs`.",
    "created_at": "2012-11-21T13:33:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207856",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>~~Okay, I just realized something stupid...  I think I'll go with the excuse that I had a fever for why I didn't notice this sooner.  If there are two different edge labels, then `G` is not edge transitive.  Otherwise, we can safely ignore the labels.~~\n\nEdit: this is all wrong.  TIL: a fever is not as stupid-making as a lack of coffee.",
    "created_at": "2012-11-21T18:08:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207857",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

<a id='comment:11'></a>~~Okay, I just realized something stupid...  I think I'll go with the excuse that I had a fever for why I didn't notice this sooner.  If there are two different edge labels, then `G` is not edge transitive.  Otherwise, we can safely ignore the labels.~~
...
```json
{
    "body": "<a id='comment:14'></a>This being said, you do not really want to get the output of `Orbit` with `OnSets` or `OnTuple` inside of Sage : it takes some time to build this Sage version of the output, and you just want to obtain the cardinality of it `:-)`\n\nNathann",
    "created_at": "2012-12-02T09:39:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207860",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:14'></a>This being said, you do not really want to get the output of `Orbit` with `OnSets` or `OnTuple` inside of Sage : it takes some time to build this Sage version of the output, and you just want to obtain the cardinality of it `:-)`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207861",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207862",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207864",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Patch rebased on 5.6.beta2 (which includes #8952)",
    "created_at": "2012-12-29T11:42:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207866",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:19'></a>Patch rebased on 5.6.beta2 (which includes #8952)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207867",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>hm... Sorry Nathan for causing you some extra work with this mess! I have no clue how come it worked before swiftly... \n\nAnyhow I have integrated your changes and fixed the gap issue\n\n```\nazi@bodysnatcher:~$ sage -t ./sage-5.4.rc2/devel/sage-gsym/sage/graphs/graph.py \nsage -t  \"devel/sage-gsym/sage/graphs/graph.py\"             \n         [14.3 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 14.3 seconds\n\n```",
    "created_at": "2012-12-29T16:11:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207869",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:21'></a>hm... Sorry Nathan for causing you some extra work with this mess! I have no clue how come it worked before swiftly... 
...
```json
{
    "body": "<a id='comment:22'></a>Attachment [trac_13721_graph_symmetries.2.patch](tarball://root/attachments/some-uuid/ticket13721/trac_13721_graph_symmetries.2.patch) by @nathanncohen created at 2012-12-30 18:50:40\n\nApply trac_13721_graph_symmetries.2.patch",
    "created_at": "2012-12-30T18:50:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207870",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:22'></a>Attachment [trac_13721_graph_symmetries.2.patch](tarball://root/attachments/some-uuid/ticket13721/trac_13721_graph_symmetries.2.patch) by @nathanncohen created at 2012-12-30 18:50:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207872",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207874",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207875",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Well, the patch that you just uploaded still contains the following line `O_o`\n\n```\nif new_partition.is_transitive(domain=[T[x] for x in cell]) == False:\n```\n\nNathann",
    "created_at": "2013-01-21T18:39:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207876",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:27'></a>Well, the patch that you just uploaded still contains the following line `O_o`
...
```json
{
    "body": "<a id='comment:28'></a>Attachment [trac_13721_graph_symmetries.4.patch](tarball://root/attachments/some-uuid/ticket13721/trac_13721_graph_symmetries.4.patch) by azi created at 2013-01-21 19:04:11\n\nFML. I am so bad with this revision system thing (somehow it produced the wrong patch)\n\nI have now removed the vertex-transitive thing out completely. Let us ship just the additional symmetries test here and consider the VT case separately. \n\nThank you for you patience Nathann",
    "created_at": "2013-01-21T19:04:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207877",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```

<a id='comment:28'></a>Attachment [trac_13721_graph_symmetries.4.patch](tarball://root/attachments/some-uuid/ticket13721/trac_13721_graph_symmetries.4.patch) by azi created at 2013-01-21 19:04:11
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207879",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207880",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207882",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Apply trac_13721_graph_symmetries.5.patch, trac_13721-rev.2.patch\n\nNathann",
    "created_at": "2013-01-22T12:24:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207883",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:32'></a>Apply trac_13721_graph_symmetries.5.patch, trac_13721-rev.2.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207884",
    "user": "https://trac.sagemath.org/admin/accounts/users/azi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207885",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207886",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>Attachment [trac_13721-rev.2.patch](tarball://root/attachments/some-uuid/ticket13721/trac_13721-rev.2.patch) by @nathanncohen created at 2013-01-22 12:54:24",
    "created_at": "2013-01-22T12:54:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207887",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:35'></a>Attachment [trac_13721-rev.2.patch](tarball://root/attachments/some-uuid/ticket13721/trac_13721-rev.2.patch) by @nathanncohen created at 2013-01-22 12:54:24
...
```json
{
    ...
    "milestone": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13721#event-38436"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Please clarify which patch(es) have to be applied.",
    "created_at": "2013-01-22T19:46:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207888",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:37'></a>Please clarify which patch(es) have to be applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207889",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Apply trac_13721_graph_symmetries.5.patch, trac_13721-rev.2.patch",
    "created_at": "2013-01-23T01:18:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207890",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:39'></a>Apply trac_13721_graph_symmetries.5.patch, trac_13721-rev.2.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207891",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207892",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13721#issuecomment-207893",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13721",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13721#event-38437"
}
```
