...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174509"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174512"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161850",
    "user": "https://github.com/sagetrac-khalasz"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161851",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161852",
    "user": "https://github.com/sagetrac-khalasz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161853",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161854",
    "user": "https://github.com/sagetrac-khalasz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161855",
    "user": "https://github.com/sagetrac-khalasz"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n Adds a table to constructions/groups that explains how to create every group of order less than 32. Each such group can now be created with just a few easy commands thanks to the patches listed here as dependencies. \n \n **Apply**\n-1. [attachment: 13641_grouptable.patch]\n+1. [attachment: 13641_grouptable.patch.gz](https://github.com/sagemath/sage/files/ticket13614/13641_grouptable.patch.gz)\n``````\n",
    "created_at": "2013-04-10T13:43:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161856",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161857",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161858",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161859",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161860",
    "user": "https://github.com/sagetrac-khalasz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13614#issuecomment-161861",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13614",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13614#event-174517"
}
```
