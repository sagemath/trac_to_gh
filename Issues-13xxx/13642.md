...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168849"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162418",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162419",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162420",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162421",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162422",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162423",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162424",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168859"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162425",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162426",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162427",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168862"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168863"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162428",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162429",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n This implementation is used to improve speed in factorisation of skew polynomials (see ticket #13215).\n \n ---\n-Apply: [attachment: trac_13642_modular_exp_polynomial-2.patch]\n+Apply: [attachment: trac_13642_modular_exp_polynomial-2.patch.gz](https://github.com/sagemath/sage/files/ticket13642/trac_13642_modular_exp_polynomial-2.patch.gz)\n``````\n",
    "created_at": "2013-10-02T12:19:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162430",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168865"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162431",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168866"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168867"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162432",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168869"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162433",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162434",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162435",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162436",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168870"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162437",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162438",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13642#issuecomment-162439",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13642",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13642#event-168873"
}
```
