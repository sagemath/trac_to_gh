...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,4 +2,12 @@\n \n The present work-around is to permanently store references to these upon creation, thus preventing collection. It would be nice if we could properly solve the problem (or at least establish that the problem is specific to `bsd.math`)\n \n-Apply [attachment: trac_13447-consolidated_refcount.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-consolidated_refcount.patch.gz)\n+**Unmerge** #13145\n+\n+Apply\n+\n+* [attachment: trac_13447-consolidated_refcount.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-consolidated_refcount.patch.gz)\n+* [attachment: trac_13447-modulus_fix.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-modulus_fix.patch.gz)\n+* [attachment: trac_13447-rely_on_singular_refcount.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-rely_on_singular_refcount.patch.gz)\n+\n+**Merge together with** #715, #11521\n``````\n",
    "created_at": "2012-09-17T09:32:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,5 +9,6 @@\n * [attachment: trac_13447-consolidated_refcount.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-consolidated_refcount.patch.gz)\n * [attachment: trac_13447-modulus_fix.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-modulus_fix.patch.gz)\n * [attachment: trac_13447-rely_on_singular_refcount.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-rely_on_singular_refcount.patch.gz)\n+* [attachment: trac_13447-refcount_cleanup.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-refcount_cleanup.patch.gz)\n \n **Merge together with** #715, #11521\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,8 +2,4 @@\n \n The present work-around is to permanently store references to these upon creation, thus preventing collection. It would be nice if we could properly solve the problem (or at least establish that the problem is specific to `bsd.math`)\n \n-**Apply**\n-\n-#13145, #715, #11521, and then [attachment:trac_13447-sanitise_ring_refcount.patch\n-\n-**Merge together with** #715, #11521\n+**Apply** [attachment: trac_13447-sanitise_ring_refcount.patch](https://github.com/sagemath/sage/files/ticket13447/trac_13447-sanitise_ring_refcount.patch.gz)\n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172323"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172324"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172325"
}
```
