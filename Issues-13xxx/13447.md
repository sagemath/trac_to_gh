...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172265"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172266"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172268"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172269"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172270"
}
```
...
```json
{
    "body": "<a id='comment:16'>Comment 16:</a>\nReplying to [@nbruin](#comment%3A14):\n> If I'm correctly understanding the problem, [attachment: trac_13447-consolidated_refcount.patch.gz](https://github.com/sagemath/sage/files/ticket13447/trac_13447-consolidated_refcount.patch.gz) should be the preferred solution.\n\nI didn't test the patch yet. However, it seems very straight forward to me: There already is a refcounting, and thus one should use it. I am Cc'ing Volker Braun and Martin von Gagern, the authors of #11339. Does [attachment: trac_13447-consolidated_refcount.patch.gz](https://github.com/sagemath/sage/files/ticket13447/trac_13447-consolidated_refcount.patch.gz) make sense to you as well?\n\nKeeping a double refcount (as with [attachment: trac_13447-double_refcount.patch.gz](https://github.com/sagemath/sage/files/ticket13447/trac_13447-double_refcount.patch.gz) seems suspicious to me.\n\nPerhaps one should let the patchbots test it? Thus, I'll add this as dependency for #715, and for the patchbot:\n\nApply trac_13447-consolidated_refcount.patch\n\nPS: You really deserve a badge for debugging excellence! Do I understand correctly that the bug is *not* on the side of Singular? I'll inform Hans accordingly.",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n Presently, #715 + #11521 help not permanently keeping parent in memory. In the process we uncovered a hard-but-consistently triggerable problem with the collection of `MPolynomialRing_libsingular`. We have only observed the problem on `bsd.math.washington.edu`, MacOSX 10.6 on x86_64.\n \n The present work-around is to permanently store references to these upon creation, thus preventing collection. It would be nice if we could properly solve the problem (or at least establish that the problem is specific to `bsd.math`)\n+\n+Apply [attachment: trac_13447-consolidated_refcount.patch.gz](https://github.com/sagemath/sage/files/ticket13447/trac_13447-consolidated_refcount.patch.gz)\n``````\n",
    "created_at": "2012-09-15T17:42:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172272"
}
```
...
```json
{
    "body": "Changed work issues from **Input from libsingular experts** to **Input from a libsingular expert**",
    "created_at": "2012-09-17T09:32:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172273"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172277"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172280"
}
```
...
```json
{
    "body": "Changed work issues from **Input from a libsingular expert** to none",
    "created_at": "2012-09-19T11:27:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172284"
}
```
...
```json
{
    "body": "Changed work issues from **Replace rDelete by rKill. Only create currRingHdl if currRing is not null** to none",
    "created_at": "2012-09-19T13:40:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172286"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -2,8 +2,4 @@\n \n The present work-around is to permanently store references to these upon creation, thus preventing collection. It would be nice if we could properly solve the problem (or at least establish that the problem is specific to `bsd.math`)\n \n-**Apply**\n-\n-#13145, #715, #11521, and then [attachment:trac_13447-sanitise_ring_refcount.patch\n-\n-**Merge together with** #715, #11521\n+**Apply** [attachment: trac_13447-sanitise_ring_refcount.patch.gz](https://github.com/sagemath/sage/files/ticket13447/trac_13447-sanitise_ring_refcount.patch.gz)\n``````\n",
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172287"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172288"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172289"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172290"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172291"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172292"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172293"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172294"
}
```
...
```json
{
    "body": "Commit: **[d6a3d48](https://github.com/sagemath/sagetrac-mirror/commit/d6a3d48d2a3705e52de6b6ec6b4cacd7bbd1ffa0)**",
    "created_at": "2019-01-12T21:00:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
Commit: **[d6a3d48](https://github.com/sagemath/sagetrac-mirror/commit/d6a3d48d2a3705e52de6b6ec6b4cacd7bbd1ffa0)**
...
```json
{
    "body": "Changed work issues from **Understand why sometimes `new_RingWrap` needs an incref and sometimes not** to none",
    "created_at": "2019-01-12T21:09:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
Changed work issues from **Understand why sometimes `new_RingWrap` needs an incref and sometimes not** to none
...
```json
{
    "body": "Changed author from **Nils Bruin, Simon King** to **Simon King**",
    "created_at": "2019-01-12T21:09:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
```json
{
    "body": "Changed commit from **[d6a3d48](https://github.com/sagemath/sagetrac-mirror/commit/d6a3d48d2a3705e52de6b6ec6b4cacd7bbd1ffa0)** to **[281fcf9](https://github.com/sagemath/sagetrac-mirror/commit/281fcf9085fe16b8e2e7b0e37a214f44f0e1ebd7)**",
    "created_at": "2019-01-13T16:39:43Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
...
Changed commit from **[d6a3d48](https://github.com/sagemath/sagetrac-mirror/commit/d6a3d48d2a3705e52de6b6ec6b4cacd7bbd1ffa0)** to **[281fcf9](https://github.com/sagemath/sagetrac-mirror/commit/281fcf9085fe16b8e2e7b0e37a214f44f0e1ebd7)**
...
```json
{
    "body": "Changed commit from **[281fcf9](https://github.com/sagemath/sagetrac-mirror/commit/281fcf9085fe16b8e2e7b0e37a214f44f0e1ebd7)** to **[70c08b0](https://github.com/sagemath/sagetrac-mirror/commit/70c08b09315f9e897fb2dbc6ba748ed6cc681b06)**",
...
Changed commit from **[281fcf9](https://github.com/sagemath/sagetrac-mirror/commit/281fcf9085fe16b8e2e7b0e37a214f44f0e1ebd7)** to **[70c08b0](https://github.com/sagemath/sagetrac-mirror/commit/70c08b09315f9e897fb2dbc6ba748ed6cc681b06)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159490",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159491",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159492",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159493",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changed commit from **[70c08b0](https://github.com/sagemath/sagetrac-mirror/commit/70c08b09315f9e897fb2dbc6ba748ed6cc681b06)** to **[ed736bd](https://github.com/sagemath/sagetrac-mirror/commit/ed736bd8651888944e4bd56149b696c54607e290)**",
    "created_at": "2019-01-13T21:14:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159494",
    "user": "https://github.com/sagetrac-git"
}
```

Changed commit from **[70c08b0](https://github.com/sagemath/sagetrac-mirror/commit/70c08b09315f9e897fb2dbc6ba748ed6cc681b06)** to **[ed736bd](https://github.com/sagemath/sagetrac-mirror/commit/ed736bd8651888944e4bd56149b696c54607e290)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159495",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159496",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changed commit from **[ed736bd](https://github.com/sagemath/sagetrac-mirror/commit/ed736bd8651888944e4bd56149b696c54607e290)** to **[17ff3af](https://github.com/sagemath/sagetrac-mirror/commit/17ff3afc62baf1f149e3338dcf4897df8d7ad1f1)**",
    "created_at": "2019-01-13T21:20:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159497",
    "user": "https://github.com/sagetrac-git"
}
```

Changed commit from **[ed736bd](https://github.com/sagemath/sagetrac-mirror/commit/ed736bd8651888944e4bd56149b696c54607e290)** to **[17ff3af](https://github.com/sagemath/sagetrac-mirror/commit/17ff3afc62baf1f149e3338dcf4897df8d7ad1f1)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159498",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159499",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159500",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changed commit from **[17ff3af](https://github.com/sagemath/sagetrac-mirror/commit/17ff3afc62baf1f149e3338dcf4897df8d7ad1f1)** to **[6e2487d](https://github.com/sagemath/sagetrac-mirror/commit/6e2487dbf8df2c82f2ca1282625f9f1b29a02529)**",
    "created_at": "2019-01-13T22:42:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159501",
    "user": "https://github.com/sagetrac-git"
}
```

Changed commit from **[17ff3af](https://github.com/sagemath/sagetrac-mirror/commit/17ff3afc62baf1f149e3338dcf4897df8d7ad1f1)** to **[6e2487d](https://github.com/sagemath/sagetrac-mirror/commit/6e2487dbf8df2c82f2ca1282625f9f1b29a02529)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159502",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159503",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159504",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    "body": "Changed commit from **[6e2487d](https://github.com/sagemath/sagetrac-mirror/commit/6e2487dbf8df2c82f2ca1282625f9f1b29a02529)** to **[019ca38](https://github.com/sagemath/sagetrac-mirror/commit/019ca385039f8628a5ed5f16de341efeaf02aa7a)**",
    "created_at": "2019-01-23T12:31:32Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159505",
    "user": "https://github.com/sagetrac-git"
}
```

Changed commit from **[6e2487d](https://github.com/sagemath/sagetrac-mirror/commit/6e2487dbf8df2c82f2ca1282625f9f1b29a02529)** to **[019ca38](https://github.com/sagemath/sagetrac-mirror/commit/019ca385039f8628a5ed5f16de341efeaf02aa7a)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159506",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159507",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changed commit from **[019ca38](https://github.com/sagemath/sagetrac-mirror/commit/019ca385039f8628a5ed5f16de341efeaf02aa7a)** to **[c978ef1](https://github.com/sagemath/sagetrac-mirror/commit/c978ef1d0d5f1b3695eef827c2f6c1983bd3059a)**",
    "created_at": "2019-01-23T22:09:49Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159508",
    "user": "https://github.com/sagetrac-git"
}
```

Changed commit from **[019ca38](https://github.com/sagemath/sagetrac-mirror/commit/019ca385039f8628a5ed5f16de341efeaf02aa7a)** to **[c978ef1](https://github.com/sagemath/sagetrac-mirror/commit/c978ef1d0d5f1b3695eef827c2f6c1983bd3059a)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159509",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159510",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159511",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159512",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159513",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    "body": "Changed commit from **[c978ef1](https://github.com/sagemath/sagetrac-mirror/commit/c978ef1d0d5f1b3695eef827c2f6c1983bd3059a)** to **[7feae99](https://github.com/sagemath/sagetrac-mirror/commit/7feae99bbda7b0eb54c9397c866119f9ccfc320e)**",
    "created_at": "2019-01-25T21:28:24Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159514",
    "user": "https://github.com/sagetrac-git"
}
```

Changed commit from **[c978ef1](https://github.com/sagemath/sagetrac-mirror/commit/c978ef1d0d5f1b3695eef827c2f6c1983bd3059a)** to **[7feae99](https://github.com/sagemath/sagetrac-mirror/commit/7feae99bbda7b0eb54c9397c866119f9ccfc320e)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159515",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159516",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159517",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172297"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159518",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159519",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159520",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    "body": "Changed commit from **[7feae99](https://github.com/sagemath/sagetrac-mirror/commit/7feae99bbda7b0eb54c9397c866119f9ccfc320e)** to **[c2b0bf6](https://github.com/sagemath/sagetrac-mirror/commit/c2b0bf61272c2062b2a4e47232f699fe306d1b21)**",
    "created_at": "2019-01-26T21:20:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159521",
    "user": "https://github.com/sagetrac-git"
}
```

Changed commit from **[7feae99](https://github.com/sagemath/sagetrac-mirror/commit/7feae99bbda7b0eb54c9397c866119f9ccfc320e)** to **[c2b0bf6](https://github.com/sagemath/sagetrac-mirror/commit/c2b0bf61272c2062b2a4e47232f699fe306d1b21)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159522",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172299"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172300"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159523",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159524",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172303"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172304"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159525",
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172305"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172306"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159526",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172307"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172308"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159527",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172309"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159528",
...
```json
{
    "body": "Changed branch from **[u/SimonKing/make_libsingular_multivariate_polynomial_rings_collectable](https://github.com/sagemath/sagetrac-mirror/tree/u/SimonKing/make_libsingular_multivariate_polynomial_rings_collectable)** to **[public/make_libsingular_multivariate_polynomial_rings_collectable](https://github.com/sagemath/sagetrac-mirror/tree/public/make_libsingular_multivariate_polynomial_rings_collectable)**",
    "created_at": "2020-06-06T12:37:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159529",
    "user": "https://github.com/mwageringel"
}
```

Changed branch from **[u/SimonKing/make_libsingular_multivariate_polynomial_rings_collectable](https://github.com/sagemath/sagetrac-mirror/tree/u/SimonKing/make_libsingular_multivariate_polynomial_rings_collectable)** to **[public/make_libsingular_multivariate_polynomial_rings_collectable](https://github.com/sagemath/sagetrac-mirror/tree/public/make_libsingular_multivariate_polynomial_rings_collectable)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159530",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "Changed commit from **[c2b0bf6](https://github.com/sagemath/sagetrac-mirror/commit/c2b0bf61272c2062b2a4e47232f699fe306d1b21)** to **[b4df239](https://github.com/sagemath/sagetrac-mirror/commit/b4df239ee6d7d9540263108d5c4230822e1f1b5e)**",
    "created_at": "2020-06-06T12:37:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159531",
    "user": "https://github.com/mwageringel"
}
```

Changed commit from **[c2b0bf6](https://github.com/sagemath/sagetrac-mirror/commit/c2b0bf61272c2062b2a4e47232f699fe306d1b21)** to **[b4df239](https://github.com/sagemath/sagetrac-mirror/commit/b4df239ee6d7d9540263108d5c4230822e1f1b5e)**
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172311"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172312"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172313"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159532",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13447#issuecomment-159533",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172315"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172316"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172317"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172318"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172319"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172320"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172321"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13447#event-172322"
}
```
