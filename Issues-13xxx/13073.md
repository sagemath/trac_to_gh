...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160221"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160224"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160225"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160226"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160228"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160229"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160232"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160235"
}
```
...
```json
{
    "body": "<a id='comment:22'>Comment 22:</a>\n> Why? \n\n........ Because I *HAD TO* when I wrote the patch, it wouldn't compile otherwise.\n\nThough I just reverted those changes back to the \"``from sage.graphs.all [...]``\" and nothing went wrong.\n\nBig mystery to me, but [attachment: trac_13073-all2.patch.gz](https://github.com/sagemath/sage/files/ticket13073/trac_13073-all2.patch.gz) is a new rebased patch that compiles and does not make those changes anymore `^^;`\n\nNathann",
    "created_at": "2012-07-04T11:39:18Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13073#issuecomment-151372",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13073#issuecomment-151373",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13073",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13073#event-160239"
}
```
