...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13999#issuecomment-213653",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I left a todo in #12510 deactivating some generic tests (`TestSuite`) in\n\n```\nsage/rings/quotient_ring.py\n```\nThose generic test should be reinstated when this ticket is fixed.\n\nFlorent",
    "created_at": "2013-01-24T12:44:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13999#issuecomment-213654",
    "user": "https://github.com/hivert"
}
```

<a id='comment:2'></a>I left a todo in #12510 deactivating some generic tests (`TestSuite`) in
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13999#event-39351"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13999#event-39352"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13999#event-39353"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13999#event-39354"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13999#event-39355"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13999#event-39356"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13999#event-39357"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13999#issuecomment-213655",
...
```json
{
    "body": "<a id='comment:9'></a>See also #23621.",
    "created_at": "2021-12-07T15:44:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13999#issuecomment-213656",
    "user": "https://github.com/slel"
}
```

<a id='comment:9'></a>See also #23621.
