...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1 +1,5 @@\n When Sage encounters a SIGSEGV, it uses the glibc backtrace. This is sometimes seen in doctests that are not reproducible, making it hard to debug. The aim of this ticket is to return better automatic stack traces by automatically attaching gdb and running scripts in gdb's Python interpreter. This will will pinpoint the cause much easier, especially in a debug build.\n+\n+Apply\n+* [attachment:trac_13889_enhanced_backtrace.patch](https://github.com/sagemath/sage/files/ticket13889/trac_13889_enhanced_backtrace.patch) to Sage library\n+* [attachment:trac_13889_crime_scene_inspector.patch](https://github.com/sagemath/sage/files/ticket13889/trac_13889_crime_scene_inspector.patch) to the `$SAGE_LOCAL/bin` repo\n``````\n",
    "created_at": "2012-12-30T18:12:23Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166399",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166400",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166401",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166402",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166403",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166404",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166405",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166406",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166407",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166408",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166409",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166410",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166411",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166412",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166413",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119262"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119263"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -3,5 +3,5 @@\n The log is printed to stdout and automatically saved to a log file in `$DOT_SAGE/crash_logs` with logs older than a week automatically deleted. A sample log is [attachment:sage_crash_wKcUKj.log](https://github.com/sagemath/sage/files/ticket13889/sage_crash_wKcUKj.log)\n \n Apply\n-* [attachment:trac_13889_enhanced_backtrace.patch](https://github.com/sagemath/sage/files/ticket13889/trac_13889_enhanced_backtrace.patch) to Sage library\n+* [and [attachment:13889_sagelib_review.patch](https://github.com/sagemath/sage/files/ticket13889/e2b39940f9cb908734d84532a8952cd3.patch](https://github.com/sagemath/sage/files/ticket13889/6446b80bc7052e1ba07aec02a091d908.patch)) to Sage library\n * [attachment:trac_13889_crime_scene_inspector.patch](https://github.com/sagemath/sage/files/ticket13889/trac_13889_crime_scene_inspector.patch) to the `$SAGE_LOCAL/bin` repo\n``````\n",
    "created_at": "2013-01-12T21:44:00Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166414",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166415",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166416",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166417",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166418",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166419",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166420",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166421",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166422",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166423",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166424",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166425",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "asset_name": "sage_crash_Ho8Cji.log",
    "asset_url": "tarball://root/attachments/ticket13889/sage_crash_Ho8Cji.log",
    "created_at": "2013-01-14T10:26:18Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13889/sage_crash_Ho8Cji.log",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>\nAttachment [sage_crash_Ho8Cji.log](https://github.com/sagemath/sage/files/ticket13889/sage_crash_Ho8Cji.log) by @jdemeyer created at 2013-01-14 10:26:18\n\nWith the `gdb` spkg: [attachment:sage_crash_Ho8Cji.log](https://github.com/sagemath/sage/files/ticket13889/sage_crash_Ho8Cji.log)",
    "created_at": "2013-01-14T10:26:18Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166426",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166427",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166428",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166429",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166430",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166431",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166432",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166433",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166434",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119264"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119265"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>\nLooks good so far.  I'm going to test it on a few different systems (in particular OS X).\n\nDo you agree with [attachment:13889_sagelib_review.patch](https://github.com/sagemath/sage/files/ticket13889/13889_sagelib_review.patch)?",
    "created_at": "2013-01-14T12:42:27Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166435",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166436",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166437",
    "user": "https://github.com/jdemeyer"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_13889_crime_scene_inspector.patch",
    "asset_url": "tarball://root/attachments/ticket13889/trac_13889_crime_scene_inspector.patch",
    "created_at": "2013-01-15T10:15:21Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13889/trac_13889_crime_scene_inspector.patch",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Attachment [trac_13889_crime_scene_inspector.patch](https://github.com/sagemath/sage/files/ticket13889/trac_13889_crime_scene_inspector.patch) by @vbraun created at 2013-01-15 10:15:21\n\nUpdated patch",
    "created_at": "2013-01-15T10:15:21Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166438",
    "user": "https://github.com/vbraun"
}
```

Attachment [trac_13889_crime_scene_inspector.patch](https://github.com/sagemath/sage/files/ticket13889/trac_13889_crime_scene_inspector.patch) by @vbraun created at 2013-01-15 10:15:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166439",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166440",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166441",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166442",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166443",
    "user": "https://github.com/jdemeyer"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_13889_enhanced_backtrace.patch",
    "asset_url": "tarball://root/attachments/ticket13889/trac_13889_enhanced_backtrace.patch",
    "created_at": "2013-01-15T16:22:03Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13889/trac_13889_enhanced_backtrace.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>\nAttachment [trac_13889_enhanced_backtrace.patch](https://github.com/sagemath/sage/files/ticket13889/trac_13889_enhanced_backtrace.patch) by @jdemeyer created at 2013-01-15 16:22:03\n\nI merged both sagelib patches and removed the unneeded change to `sage/tests/interrupt.pyx`.",
    "created_at": "2013-01-15T16:22:03Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166444",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166445",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119266"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119267"
}
```
...
```json
{
    ...
    "milestone": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119268"
}
```
...
```json
{
    ...
    "milestone": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119269"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119270"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166446",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166447",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119272"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119273"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166448",
    "user": "https://github.com/vbraun"
}
```
...
archive/attachments_018763.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "13889_disable_osx.patch",
    "asset_url": "tarball://root/attachments/ticket13889/13889_disable_osx.patch",
    "created_at": "2013-01-20T21:12:57Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13889/13889_disable_osx.patch",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>\nAttachment [13889_disable_osx.patch](https://github.com/sagemath/sage/files/ticket13889/13889_disable_osx.patch) by @vbraun created at 2013-01-20 21:12:57\n\nfixed",
    "created_at": "2013-01-20T21:12:57Z",
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166449",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166450",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119274"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166451",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119276"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13889#event-119277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166452",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13889#issuecomment-166453",
    "user": "https://github.com/vbraun"
}
```
