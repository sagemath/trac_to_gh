...
```json
{
    ...
    "milestone": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36168"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194199",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194200",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This takes 0.18s on my laptop in sage-5.1.beta5. I don't see why it should take >5s on some other hardware unless the hardware is really that slow.\n\n```\nsage: l=[]\nsage: for i in range(-5,5):\n          for j in range(-5,5):\n              l.append((normalvariate(0,1),normalvariate(0,1),normalvariate(0,1)))\n\nsage: %time list_plot3d(l,interpolation_type='nn',texture='yellow',num_points=100)\nCPU times: user 0.16 s, sys: 0.01 s, total: 0.18 s\nWall time: 0.18 s\n```",
    "created_at": "2012-06-23T01:33:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194201",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:4'></a>This takes 0.18s on my laptop in sage-5.1.beta5. I don't see why it should take >5s on some other hardware unless the hardware is really that slow.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194202",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194204",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Here's an other weird thing: the test takes *much* longer when running the doctests than when run individually.  Inside Sage, there is not much difference with/without the #12798 patches.  But when running the doctest, there is a huge difference.\n\nCould there be a resource leak of some kind?",
    "created_at": "2012-06-23T07:28:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194205",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>Here's an other weird thing: the test takes *much* longer when running the doctests than when run individually.  Inside Sage, there is not much difference with/without the #12798 patches.  But when running the doctest, there is a huge difference.
...
```json
{
    ...
    "milestone": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36169"
}
```
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36170"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194207",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36171"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36172"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36173"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36174"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36175"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36176"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36177"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36178"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194208",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194209",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194210",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194211",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [tachyon.dat](tarball://root/attachments/some-uuid/ticket13135/tachyon.dat) by @jdemeyer created at 2018-02-28 11:35:10\n\nI'm attaching an example Tachyon input file generated by `list_plot3d`.",
    "created_at": "2018-02-28T11:35:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194212",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>Attachment [tachyon.dat](tarball://root/attachments/some-uuid/ticket13135/tachyon.dat) by @jdemeyer created at 2018-02-28 11:35:10
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194213",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36179"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36180"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Attachment [nancount.patch](tarball://root/attachments/some-uuid/ticket13135/nancount.patch) by @jdemeyer created at 2018-02-28 12:59:40",
    "created_at": "2018-02-28T12:59:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194214",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>Attachment [nancount.patch](tarball://root/attachments/some-uuid/ticket13135/nancount.patch) by @jdemeyer created at 2018-02-28 12:59:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194215",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194216",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194217",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>simpler case maybe\n\n```\nsage: var('x,y')\nsage: f = lambda x,y: x+y if x*x+y*y<=1 else NaN\nsage: plot3d(f,(x,-2,2),(y,-2,2)).tachyon()  \n```",
    "created_at": "2018-02-28T16:52:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194218",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:22'></a>simpler case maybe
...
```json
{
    "body": "<a id='comment:24'></a>Replying to [chapoton](#comment%3A23):\n> Maybe we should filter this out of tachyon input ? or more generally ?\n\n\nThat doesn't solve the underlying problem. Why are `NaN`s suddenly appearing? That didn't happen before #23696.",
    "created_at": "2018-02-28T19:14:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194220",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>Replying to [chapoton](#comment%3A23):
> Maybe we should filter this out of tachyon input ? or more generally ?
...
```json
{
    "body": "<a id='comment:28'></a>OK in the case of `clough` and `linear` we could able to filter `NaN` at a cost. Both define a function `g` like so\n\n```\n        def g(x, y):\n            z = f([x, y])\n            return (x, y, z)\n```\nI guess `g` could return empty if `z` turns to be a `NaN`. Is it even doable?",
    "created_at": "2018-02-28T22:01:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194222",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:28'></a>OK in the case of `clough` and `linear` we could able to filter `NaN` at a cost. Both define a function `g` like so
...
```json
{
    "body": "<a id='comment:29'></a>Filtering `NaN`s is easy, but that is really ignoring the problem. The real problem is that `NaN`s are appearing in a computation which did not produce `NaN`s before #23696.",
    "created_at": "2018-03-01T06:16:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194223",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:29'></a>Filtering `NaN`s is easy, but that is really ignoring the problem. The real problem is that `NaN`s are appearing in a computation which did not produce `NaN`s before #23696.
...
```json
{
    "body": "<a id='comment:31'></a>It may be that the `nan` are a feature of using scipy.interpolate.CloughTocher2DInterpolator. The documentation indicates that if requested points are outside the convex hull then, unless specified, they are filled in with `nan`.",
    "created_at": "2018-03-01T06:22:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194225",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:31'></a>It may be that the `nan` are a feature of using scipy.interpolate.CloughTocher2DInterpolator. The documentation indicates that if requested points are outside the convex hull then, unless specified, they are filled in with `nan`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194227",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Replying to [chapoton](#comment%3A23):\n> Maybe we should filter this out of tachyon input ? or more generally ?\n\n\nIf you want to filter them, I think the right place is the `triangulate()` method.",
    "created_at": "2018-03-01T08:35:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194228",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:34'></a>Replying to [chapoton](#comment%3A23):
> Maybe we should filter this out of tachyon input ? or more generally ?
...
```json
{
    "body": "<a id='comment:35'></a>I just spent some time with matplotlib code to check what it does for extrapolation. And it looks like it returns `NaN` for those points as well. So the problem should be present as well for `linear` interpolation. I couldn't find anything in the documentation about what the stuff behind `spline` do for extrapolation - by the look of the output picture it just extrapolates.",
    "created_at": "2018-03-01T21:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194229",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:35'></a>I just spent some time with matplotlib code to check what it does for extrapolation. And it looks like it returns `NaN` for those points as well. So the problem should be present as well for `linear` interpolation. I couldn't find anything in the documentation about what the stuff behind `spline` do for extrapolation - by the look of the output picture it just extrapolates.
...
```json
{
    "body": "<a id='comment:36'></a>There is some discussion also on #12798 about `NaN` coordinates and even a patch.",
    "created_at": "2018-03-02T13:54:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194230",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:36'></a>There is some discussion also on #12798 about `NaN` coordinates and even a patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194231",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194233",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>Replying to [strogdon](#comment%3A37):\n> The patch does remove the `NaN` values but in so doing it appears the surface is cropped such that it is not displayed over the entire convex hull.\n\nThat is, most of them are gone. There are still a few `corner` ones left.",
    "created_at": "2018-03-02T19:15:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194234",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:40'></a>Replying to [strogdon](#comment%3A37):
> The patch does remove the `NaN` values but in so doing it appears the surface is cropped such that it is not displayed over the entire convex hull.
...
```json
{
    "body": "<a id='comment:41'></a>Replying to [strogdon](#comment%3A40):\n> Replying to [strogdon](#comment%3A37):\n> > The patch does remove the `NaN` values but in so doing it appears the surface is cropped such that it is not displayed over the entire convex hull.\n\n> That is, most of them are gone. There are still a few `corner` ones left.\n\nCan you elaborate on that. I thought `NaN` were not displayed anyway, so I didn't expect a difference before and after stripping them.",
    "created_at": "2018-03-02T19:20:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194235",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:41'></a>Replying to [strogdon](#comment%3A40):
> Replying to [strogdon](#comment%3A37):
> > The patch does remove the `NaN` values but in so doing it appears the surface is cropped such that it is not displayed over the entire convex hull.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194237",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>Patch to see changes before and after stripping the `NaN`s. Apply as `patch -p1 < before_after_stripping_nan.patch` and then rebuild sage, `./sage -b`. To test use that in\ncomment:26 without the `timeit`.",
    "created_at": "2018-03-02T20:18:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194238",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:43'></a>Patch to see changes before and after stripping the `NaN`s. Apply as `patch -p1 < before_after_stripping_nan.patch` and then rebuild sage, `./sage -b`. To test use that in
comment:26 without the `timeit`.
...
```json
{
    "body": "<a id='comment:44'></a>Yes, I can see there is some differences. What does the plotting do with `NaN`?",
    "created_at": "2018-03-07T21:59:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194239",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:44'></a>Yes, I can see there is some differences. What does the plotting do with `NaN`?
...
```json
{
    "body": "<a id='comment:47'></a>I must say that in a previous comment I mentioned the possibility of using `fill_value`. If `0` reproduce the old behavior we could go with that but I don't think it is an especially good or always appropriate value. As you said if `NaN` means do not plot, then it is more appropriate.\n\nThe problem is not with older hardware, power8 is not especially old, but its handling of NaN is currently poor. I don't know if it can be improved at the software level eventually but I would hope so.",
    "created_at": "2018-03-12T22:37:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194242",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:47'></a>I must say that in a previous comment I mentioned the possibility of using `fill_value`. If `0` reproduce the old behavior we could go with that but I don't think it is an especially good or always appropriate value. As you said if `NaN` means do not plot, then it is more appropriate.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194243",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194245",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:51'></a>What's your point? That example is showing a `Line2D` object which is a high-level object: it's a collection of lines, which the low-level renderer will treat as individual lines to be drawn.\n\nIt's precisely the transformation of a high-level object (the input to `list_plot3d`) to a low-level object (a collection of triangles) that is going wrong in this ticket.",
    "created_at": "2018-03-14T10:55:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194246",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:51'></a>What's your point? That example is showing a `Line2D` object which is a high-level object: it's a collection of lines, which the low-level renderer will treat as individual lines to be drawn.
...
```json
{
    "body": "<a id='comment:52'></a>In other words: the bug is not about a `NaN` appearing in the input of `list_plot3d`. It is about a `NaN` appearing in the processing of otherwise valid input and being sent to the rendering engine.",
    "created_at": "2018-03-14T10:58:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194247",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:52'></a>In other words: the bug is not about a `NaN` appearing in the input of `list_plot3d`. It is about a `NaN` appearing in the processing of otherwise valid input and being sent to the rendering engine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194248",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>Doesn't strike me as a release blocker bug...",
    "created_at": "2018-03-25T00:43:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194250",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:55'></a>Doesn't strike me as a release blocker bug...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194251",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:56'></a>It is. It yields a **massive** (orders of magnitude) slowdown on most platforms (x86_64 is the exception here), causing `make ptest` to timeout consistently and it is a recent regression.",
    "created_at": "2018-03-26T05:17:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194252",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:56'></a>It is. It yields a **massive** (orders of magnitude) slowdown on most platforms (x86_64 is the exception here), causing `make ptest` to timeout consistently and it is a recent regression.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194253",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194254",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/jdemeyer/list_plot3d_py_should_not_generate_nan_coordinates\"",
    "created_at": "2018-03-27T09:29:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194255",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "" to "u/jdemeyer/list_plot3d_py_should_not_generate_nan_coordinates"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194256",
...
```json
{
    "body": "Changing commit from \"\" to \"4c5a3736ed18c692f0d63ba6b22e52ff1d7cd9a8\"",
    "created_at": "2018-03-27T10:31:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194257",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "4c5a3736ed18c692f0d63ba6b22e52ff1d7cd9a8"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194258",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194259",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:61'></a>I thought all along that if there was a problem it had to be with the code that does the triangulation, not with the inputs. It's good that someone was capable of sorting through the code. I see no `NaN`s in the output and the surfaces appear to be drawn over the full convex hull. It may be interesting to see what are the CPU savings? But I do see at least one failure\n\n```\nsage -t --long src/sage/plot/plot3d/parametric_surface.pyx\n**********************************************************************\nFile \"src/sage/plot/plot3d/parametric_surface.pyx\", line 257, in sage.plot.plot3d.parametric_surface.ParametricSurface.obj_repr\nFailed example:\n    s[:2]+s[2][:3]+s[3][:3]\nExpected:\n    ['g obj_1',\n     'usemtl texture91',\n     'v -2 -2 0',\n     'v -2 -1.89744 0.399737',\n     'v -1.89744 -1.89744 0',\n     'f 1 2 3 4',\n     'f 2 5 6 3',\n     'f 5 7 8 6']\nGot:\n    ['g obj_1',\n     'usemtl texture111',\n     'v -2 -2 0',\n     'v -2 -1.89744 0.399737',\n     'v -1.89744 -1.89744 0',\n     'f 1 2 3 4',\n     'f 2 5 6 3',\n     'f 5 7 8 6']\n**********************************************************************\n1 item had failures:\n   1 of   5 in sage.plot.plot3d.parametric_surface.ParametricSurface.obj_repr\n```",
    "created_at": "2018-03-27T16:26:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194260",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:61'></a>I thought all along that if there was a problem it had to be with the code that does the triangulation, not with the inputs. It's good that someone was capable of sorting through the code. I see no `NaN`s in the output and the surfaces appear to be drawn over the full convex hull. It may be interesting to see what are the CPU savings? But I do see at least one failure
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194261",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing commit from \"4c5a3736ed18c692f0d63ba6b22e52ff1d7cd9a8\" to \"4d17a73d3e0b7f7151acc4e29146c3992f3ac43c\"",
    "created_at": "2018-03-27T18:58:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194262",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "4c5a3736ed18c692f0d63ba6b22e52ff1d7cd9a8" to "4d17a73d3e0b7f7151acc4e29146c3992f3ac43c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194263",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194264",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194265",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194267",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194268",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13135#event-36181"
}
```
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/list_plot3d_py_should_not_generate_nan_coordinates\" to \"4d17a73d3e0b7f7151acc4e29146c3992f3ac43c\"",
    "created_at": "2018-03-28T18:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13135#issuecomment-194269",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jdemeyer/list_plot3d_py_should_not_generate_nan_coordinates" to "4d17a73d3e0b7f7151acc4e29146c3992f3ac43c"
