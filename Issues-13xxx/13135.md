...
archive/attachments_018376.json:
```json
{
...
```json
{
    "body": "<a id='comment:18'></a>\n**Attachment:** [tachyon.dat](https://github.com/sagemath/sage/files/ticket13135/tachyon.dat)\n\nI'm attaching an example Tachyon input file generated by `list_plot3d`.",
    "created_at": "2018-02-28T11:35:10Z",
    "issue": "https://github.com/sagemath/sage/issues/13135",
    "type": "issue_comment",
...
archive/attachments_018377.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:19'></a>\n**Attachment:** [nancount.patch](https://github.com/sagemath/sage/files/ticket13135/nancount.patch)",
    "created_at": "2018-02-28T12:59:40Z",
    "issue": "https://github.com/sagemath/sage/issues/13135",
    "type": "issue_comment",
...
archive/attachments_018378.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [before_after_stripping_nan.patch](https://github.com/sagemath/sage/files/ticket13135/before_after_stripping_nan.patch)\n\nbefore and after stripping NaN patch",
    "created_at": "2018-03-02T20:17:35Z",
    "issue": "https://github.com/sagemath/sage/issues/13135",
    "type": "issue_comment",
...
**Attachment:** [before_after_stripping_nan.patch](https://github.com/sagemath/sage/files/ticket13135/before_after_stripping_nan.patch)
