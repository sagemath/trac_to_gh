...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13680#event-38242"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13680#event-38243"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13680#event-38244"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13680#event-38245"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13680#event-38246"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13680#event-38247"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13680#event-38248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13680#issuecomment-206943",
...
```json
{
    "body": "<a id='comment:5'></a>This is an upstream issue, not necessarily a sage problem:\n\nhttps://gitlab.com/federicomenaquintero/bzip2/-/issues/31",
    "created_at": "2020-08-31T01:51:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13680#issuecomment-206944",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:5'></a>This is an upstream issue, not necessarily a sage problem:
