...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13347#issuecomment-199793",
...
```json
{
    "body": "<a id='comment:1'></a>Wow, that's a long list of faulty quotient rings in the documentation! Can you add the examples themselves, as line numbers tend to change a lot as Sage evolves?",
    "created_at": "2012-08-07T08:32:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13347#issuecomment-199794",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:1'></a>Wow, that's a long list of faulty quotient rings in the documentation! Can you add the examples themselves, as line numbers tend to change a lot as Sage evolves?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13347#issuecomment-199795",
    "user": "https://trac.sagemath.org/admin/accounts/users/tfeulner"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13347#event-36992"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13347#event-36993"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13347#event-36994"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13347#event-36995"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13347#event-36996"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13347#event-36997"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13347#event-36998"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13347#issuecomment-199796",
