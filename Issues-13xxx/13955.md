...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13955#event-179738"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13955#event-179739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13955#event-179740"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13955#issuecomment-167583",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13955#issuecomment-167584",
    "user": "https://github.com/jdemeyer"
}
```
