...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13861#issuecomment-165752",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_13861_prime_phi_segfault.patch](https://github.com/sagemath/sage/files/ticket13861/trac_13861_prime_phi_segfault.patch) by @vbraun created at 2012-12-24 13:47:21\n\nWith the patch I don't get any error in electric fence any more.",
    "created_at": "2012-12-24T13:47:21Z",
    "issue": "https://github.com/sagemath/sage/issues/13861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13861#issuecomment-165753",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13861#issuecomment-165754",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13861#issuecomment-165755",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13861#issuecomment-165756",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13861#issuecomment-165757",
    "user": "https://github.com/jdemeyer"
}
```
