...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13725#issuecomment-207945",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13725#issuecomment-207946",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13725#issuecomment-207947",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13725#issuecomment-207949",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_13725-sum-complex-review-ts.patch](tarball://root/attachments/some-uuid/ticket13725/trac_13725-sum-complex-review-ts.patch) by @jhpalmieri created at 2012-12-11 23:47:32\n\nYour patch looks good to me. By the way, since writing my patch, I found an example, `simplicial_complexes.SumComplex(13, [0,1,2,3,4,7])`, whose fourth homology group is\n\n```\nC3 x C3 x C37209 x C14755222692546209667\n```\nIt takes Sage several minutes to calculate this, so we shouldn't add it to the examples, but it's interesting to see how large the torsion can be for a complex with 13 vertices.",
    "created_at": "2012-12-11T23:47:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13725#issuecomment-207950",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>Attachment [trac_13725-sum-complex-review-ts.patch](tarball://root/attachments/some-uuid/ticket13725/trac_13725-sum-complex-review-ts.patch) by @jhpalmieri created at 2012-12-11 23:47:32
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13725",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13725#event-38449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13725#issuecomment-207951",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13725#issuecomment-207952",
    "user": "https://github.com/jdemeyer"
}
```
