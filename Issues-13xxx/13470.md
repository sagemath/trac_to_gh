...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/13470",
...
```json
{
    ...
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38207"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38208"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38209"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38210"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38211"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38212"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165844",
...
```json
{
    "body": "I have a solution implemented at https://github.com/bollu/sage/tree/u/gh-bollu/jan-24-cholesky-for-sparse-numerical-matrices.",
    "created_at": "2021-01-23T22:14:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165845",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165846",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165847",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38214"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38215"
}
```
...
```json
{
    "body": "Thanks a lot for the link! My only concern is with that of sparseness; the reason I choose to jump hoops with `cvxopt` is for the performance wins for *large* sparse matrices, that I get from running discrete differential geometry algorithms such as geodesics in heat: https://arxiv.org/abs/1204.6216\n\nI'll be glad to benchmark the code, and see which method is faster; I think the route you propose is performant for dense inexact matrices for sure. I'm unsure about the sparse case. Could you please shed some light on the performance characteristics of the linked implementation?",
    "created_at": "2021-01-26T17:37:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165850",
    "user": "https://github.com/bollu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165854",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165855",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38216"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38217"
}
```
...
```json
{
    "body": "Ticket #31619 allows `cholesky()` and `is_positive_definite()` to work over inexact rings as promised, but it will be slower than necessary for sparse RDF matrices. A matrix subclass that delegates to `cholmod()` in that case is the last missing piece.",
    "created_at": "2021-04-29T12:46:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165856",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38218"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165857",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "cvxopt is now a pseudo-optional package, but we should still be able to use the approach in comment:14. We can `super()` if cvxopt isn't available.",
    "created_at": "2021-11-20T21:24:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165858",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165859",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165860",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "This should work for both `RDF` and `CDF`, but it would be nice to have some more serious examples for test cases. The cvxopt interface is a little sketchy so I'd like to be *sure* that we're using it \"correctly,\" insofar as is possible for an undocumented interface.",
    "created_at": "2021-11-23T00:17:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165861",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165862",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165863",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13470#event-38220"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165864",
...
```json
{
    "body": "`@`gh-collares - please open a new ticket for this.",
    "created_at": "2021-12-14T22:59:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165866",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Opened #33023 for the test failure, thanks for letting me know about the correct procedure. I didn't know the \"Commit\" field would be cleared when I posted my first comment, sorry about that.",
    "created_at": "2021-12-14T23:07:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13470#issuecomment-165867",
    "user": "https://github.com/collares"
}
```
