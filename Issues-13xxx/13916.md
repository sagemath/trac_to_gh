...
```json
{
    "body": "<a id='comment:4'></a>With the attached patch, the following doctest works.\n\n```\n        sage: cython('''cpdef test_funct(x,y): return''')\n        sage: print open(_extract_embedded_position(inspect.getdoc(test_funct))[1]).read()\n        <BLANKLINE>\n        include \"interrupt.pxi\"  # ctrl-c interrupt block support\n        include \"stdsage.pxi\"  # ctrl-c interrupt block support\n        <BLANKLINE>\n        include \"cdefs.pxi\"\n        cpdef test_funct(x,y): return\n```\nThe tests of sage/misc/sageinspect.py pass. Needs review!",
    "created_at": "2013-01-06T13:57:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212059",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>With the attached patch, the following doctest works.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212060",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212061",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212063",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212064",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>The patch is updated, still needs review.",
    "created_at": "2013-01-06T15:12:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212065",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>The patch is updated, still needs review.
...
```json
{
    "body": "<a id='comment:8'></a>I found a problem in my own patch, so this trac ticket is independent from #12728.\n\nSimon, your patch looks nice, applies nice and compiles nice ; but since I'm going to get another round of rebuilding and full doctesting sage, I'll report what happens later (I'm not doing that on the arm box, so it shouldn't take two days :-P).",
    "created_at": "2013-01-06T16:00:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212066",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

<a id='comment:8'></a>I found a problem in my own patch, so this trac ticket is independent from #12728.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212067",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Since the coverage script complains, I'll try to add some new tests in sageinspect.py",
    "created_at": "2013-01-21T10:52:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212068",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>Since the coverage script complains, I'll try to add some new tests in sageinspect.py
...
```json
{
    "body": "<a id='comment:11'></a>PS: The error reported by the patchbot seems unrelated.",
    "created_at": "2013-01-21T10:54:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212069",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:11'></a>PS: The error reported by the patchbot seems unrelated.
...
```json
{
    "body": "<a id='comment:12'></a>PPS: The coverage script reports nonsense. It says that the number of tests did not increase, but the number of functions did increase. But that's plain wrong: My patch does not introduce new functions, it only fixes existing functions. And it does add tests. So, I'll keep it like that, if you don't mind.",
    "created_at": "2013-01-21T10:56:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212070",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>PPS: The coverage script reports nonsense. It says that the number of tests did not increase, but the number of functions did increase. But that's plain wrong: My patch does not introduce new functions, it only fixes existing functions. And it does add tests. So, I'll keep it like that, if you don't mind.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13916#event-39079"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13916#event-39080"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13916#event-39081"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/mmezzarobba/13916-inspect_interactive_cython\"",
    "created_at": "2014-03-14T10:29:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212071",
    "user": "https://github.com/mezzarobba"
}
```

Changing branch from "" to "u/mmezzarobba/13916-inspect_interactive_cython"
...
```json
{
    "body": "<a id='comment:15'></a>Didn't apply cleanly to 6.0+; updated; needs review again.",
    "created_at": "2014-03-14T10:29:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212072",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:15'></a>Didn't apply cleanly to 6.0+; updated; needs review again.
...
```json
{
    "body": "Changing commit from \"\" to \"69169ab524e3273bfa36cad94dc735fe80cf029b\"",
    "created_at": "2014-03-14T10:29:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212073",
    "user": "https://github.com/mezzarobba"
}
```

Changing commit from "" to "69169ab524e3273bfa36cad94dc735fe80cf029b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212074",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212075",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212076",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212077",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing branch from \"u/mmezzarobba/13916-inspect_interactive_cython\" to \"69169ab524e3273bfa36cad94dc735fe80cf029b\"",
    "created_at": "2014-04-08T10:17:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212078",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/mmezzarobba/13916-inspect_interactive_cython" to "69169ab524e3273bfa36cad94dc735fe80cf029b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13916#issuecomment-212079",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13916",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13916#event-39082"
}
```
