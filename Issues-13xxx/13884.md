...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172431"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172432"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172435"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,3 +10,5 @@\n ```\n \n Of these, two are really covered by #10358, and another is a situation needing clarification at #7771.   This ticket is to fix the minor issues in the integral, preparer, and stock files.\n+\n+**Apply** [attachment: trac_13884.patch.gz](https://github.com/sagemath/sage/files/ticket13884/trac_13884.patch.gz).\n``````\n",
    "created_at": "2013-01-03T19:20:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13884",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172437"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172438"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172439"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172440"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172441"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172442"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172446"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13884",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13884#event-172447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13884#issuecomment-166435",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13884#issuecomment-166436",
    "user": "https://github.com/fchapoton"
}
```
