...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13034#issuecomment-150716",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13034#issuecomment-150717",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket13034/trac_13034_fix_index_in_saturation.patch",
    "created_at": "2012-05-27T17:52:23Z",
    "issue": "https://github.com/sagemath/sage/issues/13034",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13034/trac_13034_fix_index_in_saturation.patch",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac_13034_fix_index_in_saturation.patch](https://github.com/sagemath/sage/files/ticket13034/trac_13034_fix_index_in_saturation.patch) by @novoselt created at 2012-05-27 17:52:23\n\nI've changed 1 to ZZ(1), but didn't rebase - it applies smoothly to sage-5.1.beta0 with Python-2.7.3 from #13013 (I can't pop Python upgrade patch)",
    "created_at": "2012-05-27T17:52:23Z",
    "issue": "https://github.com/sagemath/sage/issues/13034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13034#issuecomment-150718",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13034#issuecomment-150719",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13034#issuecomment-150720",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13034#issuecomment-150721",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13034#issuecomment-150722",
    "user": "https://github.com/jdemeyer"
}
```
