...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13175#issuecomment-153316",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "**Attachment:** [mercurial-2.2.2.p0.diff](https://github.com/sagemath/sage/files/ticket13175/mercurial-2.2.2.p0.diff)\n\nDiff between the 1.8.4.p1 and 2.2.2.p0 spkgs. For reference / review only.",
    "created_at": "2012-06-28T11:36:45Z",
    "issue": "https://github.com/sagemath/sage/issues/13175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13175#issuecomment-153317",
    "user": "https://github.com/jdemeyer"
}
```

**Attachment:** [mercurial-2.2.2.p0.diff](https://github.com/sagemath/sage/files/ticket13175/mercurial-2.2.2.p0.diff)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13175#issuecomment-153318",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13175#issuecomment-153319",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13175#issuecomment-153320",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13175#issuecomment-153321",
    "user": "https://github.com/jdemeyer"
}
```
