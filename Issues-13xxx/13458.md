...
```json
{
    "body": "<a id='comment:16'></a>The issue in comment:13 (bug in looping over reflexive polygons) is fixed in #14210",
...
<a id='comment:16'></a>The issue in comment:13 (bug in looping over reflexive polygons) is fixed in #14210
