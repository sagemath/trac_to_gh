...
```json
{
    "body": "<div id=\"comment:16\" align=\"right\">comment:16</div>\n\nWe can have both, can't we?\n\nMake `plot()` be able to take multiple arguments and set them using the other custom functions. This will take care of my concerns in [comment:13](#comment:13)",
