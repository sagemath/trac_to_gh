...
```json
{
    "body": "<a id='comment:21'></a>\nThis should address the `a==b` issue and avoid the coercions.\n\n---\nNew commits:\n|                                                                                                         |                                                                        |\n|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[ce0a457](http://git.sagemath.org/sage.git/commit/?id=ce0a457)|Trac #13720: Allow scaling of legendre_P to an arbitrary interval [a,b].|",
    "created_at": "2013-12-11T17:34:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13720",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[36b4c29](http://git.sagemath.org/sage.git/commit/?id=36b4c29920bc4cfbc09b8b7a1fd9de757f8179d3)|`Trac #13720: Allow scaling of legendre_P to an arbitrary interval [a,b].`|",
...
```json
{
    "body": "<a id='comment:32'></a>\nI have corrected the problem (and also make a little cleanup). Back to needs review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|\n|[09ed77c](http://git.sagemath.org/sage.git/commit/?id=09ed77c084435f1e73e0b6bafcc33c265b2479ab)|`Merge branch 'u/mjo/ticket/13720' of ssh://trac.sagemath.org:22/sage into 13720`|\n|[1de3cf4](http://git.sagemath.org/sage.git/commit/?id=1de3cf47ac8d5d696d2ccf8f1e46281eba4564b4)|`trac #13720 pep8 and pyflakes cleanup`|",
    "created_at": "2014-05-09T20:00:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13720",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[0843342](http://git.sagemath.org/sage.git/commit/?id=0843342b41d1ce501cab9b84c89e2ef1d84e5dba)|`Merge branch 'u/chapoton/13720' into 6.5.b2`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nNew commits:\n|                                                                                                                                          |                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------|\n|[8d1354c](http://git.sagemath.org/sage.git/commit/?id=8d1354cf63bcca9b01733e4f57aaa16556e3ba0f)|`fixed merge conflict`|",
    "created_at": "2015-10-11T20:11:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13720",
    "type": "issue_comment",
