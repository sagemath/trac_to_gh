...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160538",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160539",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160540",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
archive/attachments_018226.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "13427.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket13427/13427.patch",
...
```json
{
    "body": "Patch to fix two issues - numerical noise, and the fact there are two maximum in the range 0 to 8.",
    "created_at": "2012-09-04T10:37:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160541",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13427#event-116796"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13427#event-116797"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13427#event-116798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160542",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160543",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160544",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13427#event-116799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13427#event-116800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13427#issuecomment-160545",
