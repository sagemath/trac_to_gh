...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket13464/working_mirrors_in_sage-list-packages.patch",
    "created_at": "2012-09-15T09:13:45Z",
    "issue": "https://github.com/sagemath/sage/issues/13464",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13464/working_mirrors_in_sage-list-packages.patch",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [working_mirrors_in_sage-list-packages.patch](https://github.com/sagemath/sage/files/ticket13464/working_mirrors_in_sage-list-packages.patch) by @haraldschilly created at 2012-09-15 09:13:45",
    "created_at": "2012-09-15T09:13:45Z",
    "issue": "https://github.com/sagemath/sage/issues/13464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13464#issuecomment-159651",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13464#issuecomment-159652",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13464#issuecomment-159653",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13464#issuecomment-159654",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13464#issuecomment-159655",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13464#issuecomment-159656",
