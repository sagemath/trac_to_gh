...
```json
{
    "body": "<a id='comment:9'></a>\nAny chance to get docstrings on `_sum_generator_`gen and/or sum_generator? Andrew and me are wondering what precisely these functions do in http://trac.sagemath.org/sage_trac/ticket/14542 . Thank you!",
