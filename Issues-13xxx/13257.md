...
```json
{
    "body": "<a id='comment:2'></a>As a point of comparison, if we convert the polynomial back into a list then the operation runs about 500x faster:\n\n```\nsage: %time R(list(a));\nCPU times: user 0.12 s, sys: 0.02 s, total: 0.14 s\nWall time: 0.14 s\n```\nSo we probably have a 'lost in coercion' situation here.",
    "created_at": "2012-07-15T10:33:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197669",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```

<a id='comment:2'></a>As a point of comparison, if we convert the polynomial back into a list then the operation runs about 500x faster:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197670",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>The main problem is in compiled files (which is why `%prun` doesn't see it). In particular `polynomial_modz_flint.pyx` `_element_constructor_` calls `Polynomial_template`'s `__init__()` which converts `a` into a list of coefficients, which then reconstructs the polynomial by adding individual monomials together.\n\nWhere the time is taken is each time a monomial is added, a new polynomial is created. A partial solution is to convert polynomial inputs in `_element_consturctor_` to a list and do that (this runs fast because it just does the coefficient coercion and sets the coefficient list of the new polynomial). I haven't looked too deeply into a general solution yet (I don't quite know if this is the only case where this slowdown occurs), but I would suspect one exists.\n\nBest,\n\nTravis",
    "created_at": "2013-02-05T14:43:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197671",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>The main problem is in compiled files (which is why `%prun` doesn't see it). In particular `polynomial_modz_flint.pyx` `_element_constructor_` calls `Polynomial_template`'s `__init__()` which converts `a` into a list of coefficients, which then reconstructs the polynomial by adding individual monomials together.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197672",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197673",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197675",
...
```json
{
    "body": "<a id='comment:6'></a>Won't this patch break\n\n```\nsage: R.<x> = ZZ[]\nsage: S.<y> = R[]\nsage: S._element_constructor_(x^2)\n x^2\n```\n\nI think polynomial_template should be fixed, at the cost of requiring a couple more special methods.",
    "created_at": "2013-02-12T07:43:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197676",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:6'></a>Won't this patch break
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197677",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197678",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197679",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197680",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13257#event-36620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197682",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197683",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I think the horrible horror has been fixed in #12173 itself.\nAt least it takes 0 sec on my computer to perform this (except for Integers(2) where it is slightly solwer, 0.41 sec, surely because NTL is slow :)).\n\nSo I propose to close this as duplicate.",
    "created_at": "2013-06-04T13:07:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197684",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:9'></a>I think the horrible horror has been fixed in #12173 itself.
At least it takes 0 sec on my computer to perform this (except for Integers(2) where it is slightly solwer, 0.41 sec, surely because NTL is slow :)).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197685",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Agreed. On `5.10.beta5`:\n\n```\nsage: %time L = R(a)\nCPU times: user 0.06 s, sys: 0.00 s, total: 0.07 s\nWall time: 0.07 s\n```",
    "created_at": "2013-06-04T14:08:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197686",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>Agreed. On `5.10.beta5`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13257#issuecomment-197687",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13257",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13257#event-36621"
}
```
