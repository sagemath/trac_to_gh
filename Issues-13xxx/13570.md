...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13570#event-37780"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13570#event-37781"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13570#event-37782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13570#issuecomment-174859",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13570#issuecomment-174860",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13570#issuecomment-174861",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13570#event-37783"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13570#event-37784"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Thanks.  I ended up solving what I needed to solve and ultimately defined class on which there exists multiplication and addition, and that multiplication is cartesian product and addition is disjoint unions, and it works well.",
    "created_at": "2014-02-25T00:56:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13570#issuecomment-174862",
    "user": "https://trac.sagemath.org/admin/accounts/users/startakovsky"
}
```

<a id='comment:4'></a>Thanks.  I ended up solving what I needed to solve and ultimately defined class on which there exists multiplication and addition, and that multiplication is cartesian product and addition is disjoint unions, and it works well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13570#issuecomment-174863",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13570#issuecomment-174864",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13570",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13570#event-37785"
}
```
