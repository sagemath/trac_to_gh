...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/13295",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198377",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198378",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The tests on bsd.math pass. Building the documentation, I found a typo (wrong indentation) in the docs of the new method. Hence, unfortunately, I had to repost the package again (I am sorry).\n\nThe documentation is now put on the [project page](http://sage.math.washington.edu/home/SimonKing/Cohomology/).",
    "created_at": "2012-07-30T00:48:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198380",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>The tests on bsd.math pass. Building the documentation, I found a typo (wrong indentation) in the docs of the new method. Hence, unfortunately, I had to repost the package again (I am sorry).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198383",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198384",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Otherwise, this looks good to me. It builds and passes tests on several different platforms (linux, OS X 10.7, OpenSolaris). So if you fix the two small issues, positive review.",
    "created_at": "2012-09-03T17:23:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198385",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>Otherwise, this looks good to me. It builds and passes tests on several different platforms (linux, OS X 10.7, OpenSolaris). So if you fix the two small issues, positive review.
...
```json
{
    "body": "Changing work_issues from \"\" to \"Find SAGE_DATA\"",
    "created_at": "2012-10-10T10:35:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198387",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Find SAGE_DATA"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198388",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198390",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Apparently #13123 has changed SAGE_DATA. In particular, it seems that it is still available as an environment variable, but is not available from sage.misc.misc (which used to be the case until recently).",
    "created_at": "2012-10-10T10:42:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198391",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:11'></a>Apparently #13123 has changed SAGE_DATA. In particular, it seems that it is still available as an environment variable, but is not available from sage.misc.misc (which used to be the case until recently).
...
```json
{
    "body": "Changing work_issues from \"Find SAGE_DATA\" to \"Fix tests\"",
    "created_at": "2012-10-10T11:16:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198392",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "Find SAGE_DATA" to "Fix tests"
...
```json
{
    "body": "<a id='comment:12'></a>The spkg is now updated again. The package and its documentation build fine on bsd.math.\n\nI am now running the tests on bsd.math, and i already found some that fail (although most seem to pass). No idea if that is due to a recent Singular upgrade...\n\nAnyway, it again needs work, because of the test failures.",
    "created_at": "2012-10-10T11:16:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198393",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>The spkg is now updated again. The package and its documentation build fine on bsd.math.
...
```json
{
    "body": "<a id='comment:15'></a>Rerunning the tests with a single thread, I get less errors:\n\n```\nThe following tests fail:\n  pGroupCohomology\n  pGroupCohomology.barcode\n  pGroupCohomology.cohomology.COHO.bar_code\n  pGroupCohomology.cohomology.COHO.essential_ideal\n  pGroupCohomology.factory.CohomologyRingFactory.set_web_db\nTotal time: 2656.55 sec\n```\nNext, I'll try again after wiping the .sage/pGroupCohomology/db/.",
    "created_at": "2012-10-10T13:44:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198396",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:15'></a>Rerunning the tests with a single thread, I get less errors:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198398",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Strange. I can not reproduce the problem in pure Singular. I don't know if there is any nasty side effect of a loaded library or so.",
    "created_at": "2012-10-10T14:41:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198399",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:17'></a>Strange. I can not reproduce the problem in pure Singular. I don't know if there is any nasty side effect of a loaded library or so.
...
```json
{
    "body": "<a id='comment:18'></a>Spoke too soon. I *can* reproduce it in Singular, when I add the option `redSB`. Interesting that `redSB` is responsible for an *incomplete* reduction! I have opened this [Singular ticket](http://www.singular.uni-kl.de:8002/trac/ticket/456).\n\nBut what does that mean to us? Of course, I could work around by temporarily switch off `redSB`.",
    "created_at": "2012-10-10T15:00:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198400",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:18'></a>Spoke too soon. I *can* reproduce it in Singular, when I add the option `redSB`. Interesting that `redSB` is responsible for an *incomplete* reduction! I have opened this [Singular ticket](http://www.singular.uni-kl.de:8002/trac/ticket/456).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198401",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Regarding the Singular problems: you could also include the original doctest, marked as `# known bug in Singular`. \"known bug\" should tell Sage to skip the doctest. In any case, you should put in a comment about the fact that Singular has a bug which requires a workaround. \n\nShould we test this spkg with the new GAP spkg from #13211?",
    "created_at": "2012-10-10T15:21:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198402",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:20'></a>Regarding the Singular problems: you could also include the original doctest, marked as `# known bug in Singular`. "known bug" should tell Sage to skip the doctest. In any case, you should put in a comment about the fact that Singular has a bug which requires a workaround. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198403",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198404",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198405",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>I modified the ticket description, since `SAGE_NUMBER_THREADS` now became `SAGE_NUM_THREADS`.",
    "created_at": "2012-10-10T15:34:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198406",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:22'></a>I modified the ticket description, since `SAGE_NUMBER_THREADS` now became `SAGE_NUM_THREADS`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198407",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198408",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>All tests passed for me on sage.math and on OS X 10.8 (Mountain Lion) with the new scipy spkg from #13541. I haven't tested on a 32-bit machine, but I'm going to give it a positive review anyway.",
    "created_at": "2012-10-10T22:22:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198409",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:24'></a>All tests passed for me on sage.math and on OS X 10.8 (Mountain Lion) with the new scipy spkg from #13541. I haven't tested on a 32-bit machine, but I'm going to give it a positive review anyway.
...
```json
{
    "body": "<a id='comment:25'></a>All tests also pass on OpenSolaris.",
    "created_at": "2012-10-11T01:28:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198410",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:25'></a>All tests also pass on OpenSolaris.
...
```json
{
    "body": "<a id='comment:26'></a>Just for the record: Hans Sch\u00f6nemann apparently was able to fix the bug in Singular - so, it will be fine in future, even without temporarily disabling `redSB`.",
    "created_at": "2012-10-11T15:56:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198411",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:26'></a>Just for the record: Hans Schönemann apparently was able to fix the bug in Singular - so, it will be fine in future, even without temporarily disabling `redSB`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198412",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198413",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>i just updated this optional spkg!",
    "created_at": "2012-10-14T19:05:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198414",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:27'></a>i just updated this optional spkg!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13295#event-36782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198415",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13295#issuecomment-198416",
    "user": "https://github.com/jdemeyer"
}
```
