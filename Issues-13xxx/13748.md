...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13748#issuecomment-164210",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket13748/13748_fix_sig_block_test.patch",
    "created_at": "2013-01-03T18:38:57Z",
    "issue": "https://github.com/sagemath/sage/issues/13748",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13748/13748_fix_sig_block_test.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [13748_fix_sig_block_test.patch](https://github.com/sagemath/sage/files/ticket13748/13748_fix_sig_block_test.patch) by @jdemeyer created at 2013-01-03 18:38:57\n\nApparently, it is illegal to exit a `try` block while `sig_on()` is in effect.\n\nPatch (which also adds some debug code for `sig_block()`/`sig_unblock()`) needs review.",
    "created_at": "2013-01-03T18:38:57Z",
    "issue": "https://github.com/sagemath/sage/issues/13748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13748#issuecomment-164211",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13748#issuecomment-164212",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13748#issuecomment-164213",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13748#issuecomment-164214",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13748#issuecomment-164215",
    "user": "https://github.com/jdemeyer"
}
```
