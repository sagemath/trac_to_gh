...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181718"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181720"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181721"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181722"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-aginiewicz",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13096#issuecomment-149398",
    "user": "https://github.com/sagetrac-aginiewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13096#issuecomment-149399",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181724"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181725"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181726"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181727"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181728"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181729"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13096#issuecomment-149400",
...
```json
{
    "body": "<div id=\"comment:4\" align=\"right\">comment:4</div>\n\nI looked at both of those before openning this ticket, but though #12032 is more general and not that easily fixed, and #2607 is about name/docs instead of working vs non-working. Anyway, I agree that this ticket is a duplicate (of #3955). I uploaded patch based on [comment:1](#comment:1) there.",
    "created_at": "2012-06-09T10:43:31Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13096#issuecomment-149401",
    "user": "https://github.com/sagetrac-aginiewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13096",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13096#issuecomment-149402",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181730"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13096",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13096#event-181732"
}
```
