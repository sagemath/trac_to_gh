...
```json
{
    "body": "<a id='comment:4'></a>I looked at both of those before openning this ticket, but though #12032 is more general and not that easily fixed, and #2607 is about name/docs instead of working vs non-working. Anyway, I agree that this ticket is a duplicate (of #3955). I uploaded patch based on[comment:1](#comment%3A1) there.",
...
<a id='comment:4'></a>I looked at both of those before openning this ticket, but though #12032 is more general and not that easily fixed, and #2607 is about name/docs instead of working vs non-working. Anyway, I agree that this ticket is a duplicate (of #3955). I uploaded patch based on[comment:1](#comment%3A1) there.
