...
```json
{
    "body": "<a id='comment:32'></a>\nI just checked Valgrind svn and the fix from [attachment:glibc-2.15.diff](https://github.com/sagemath/sage/files/ticket13060/glibc-2.15.diff) is also used for 2.16-18 so providing a fixed spkg will be easy.\nIn fact, it seems glibc 2.>=12 get the exact same treatment, and the only difference with glibc 2.>=3/<=11 lies in coregrind/m_redir.c (and is indeed needed).",
