...
```json
{
    "body": "<a id='comment:2'></a>Note to myself: Fix this.",
...
<a id='comment:2'></a>Note to myself: Fix this.
...
```json
{
    "body": "<a id='comment:6'></a>This is very likely a duplicate of #17890.",
...
<a id='comment:6'></a>This is very likely a duplicate of #17890.
