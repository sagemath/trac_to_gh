...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13609#event-174424"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13609#event-174425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13609#event-174426"
}
```
...
```json
{
    "body": "Changed keywords from **** to **pynac segfault**",
    "created_at": "2012-11-20T15:51:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13609",
    "type": "issue_comment",
...
Changed keywords from **** to **pynac segfault**
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -58,3 +58,5 @@\n Then it works again for the first two expressions but produces a segmentation fault for the third too.\n \n Any idea of what is going wrong here?\n+\n+Apply [attachment: trac_13609-gf2_content.take2.patch.gz](https://github.com/sagemath/sage/files/ticket13609/trac_13609-gf2_content.take2.patch.gz)\n``````\n",
    "created_at": "2012-11-21T15:54:50Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13609",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13609#issuecomment-161811",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13609#issuecomment-161812",
    "user": "https://github.com/vbraun"
}
```
