...
```json
{
    "body": "<a id='comment:2'></a>Could not reproduce in sage-on-gentoo but we don't have \"--with-pydebug\" by default (can still build python with debugging symbols for gdb but not the stuff from pydebug). Investigating further.",
    "created_at": "2012-12-30T09:52:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211271",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>Could not reproduce in sage-on-gentoo but we don't have "--with-pydebug" by default (can still build python with debugging symbols for gdb but not the stuff from pydebug). Investigating further.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211272",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211273",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The difference between my crashing example and Jean-Pierre's non-crashing example is that I test `z > y > x`. No idea what that means.",
    "created_at": "2012-12-30T17:27:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211277",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>The difference between my crashing example and Jean-Pierre's non-crashing example is that I test `z > y > x`. No idea what that means.
...
```json
{
    "body": "<a id='comment:10'></a>I suggest to \n\nApply FGLMStrategy_sigon.patch\n\nand use the patched spkg here:\nhttp://boxen.math.washington.edu/home/dreyer/spkg/polybori-0.8.2.p0.spkg",
    "created_at": "2012-12-30T23:08:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211279",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:10'></a>I suggest to 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211281",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211282",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Replying to [AlexanderDreyer](#comment%3A9):\n> I was able to reproduce Simon's example now with plain polybori. The problem is that the input ideal must be a reduced Gr\u00f6bner basis (fglm does not compute a Groebner basis itself, it just converts). This is what the assertion complains about. But since a user can trigger this, an assertion is probably not the best idea. \n> \n> I could patch polybori to throw an exception here. What do you think?\n\nGood idea!\nNow we have just to make sure that Sage catch the exception (which it did not seem to do in my example at least).",
    "created_at": "2012-12-31T09:12:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211283",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:14'></a>Replying to [AlexanderDreyer](#comment%3A9):
> I was able to reproduce Simon's example now with plain polybori. The problem is that the input ideal must be a reduced Gröbner basis (fglm does not compute a Groebner basis itself, it just converts). This is what the assertion complains about. But since a user can trigger this, an assertion is probably not the best idea. 
> 
> I could patch polybori to throw an exception here. What do you think?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211284",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Also, perhaps the exception is not thrown at all. This is the case if `PBORI_NDEBUG` is still set when building polybori. Did you re-install polybori with SAGE_DEBUG=yes in the environment?",
    "created_at": "2013-01-01T23:23:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211285",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:16'></a>Also, perhaps the exception is not thrown at all. This is the case if `PBORI_NDEBUG` is still set when building polybori. Did you re-install polybori with SAGE_DEBUG=yes in the environment?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211286",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Ah, and of course, we have to fix the broken doctest. So please apply the recent FGLMStrategy_sigon.patch. I've also added an optional - debug doctest for the case above.\n\nApply FGLMStrategy_sigon.patch",
    "created_at": "2013-01-02T00:20:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211287",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:17'></a>Ah, and of course, we have to fix the broken doctest. So please apply the recent FGLMStrategy_sigon.patch. I've also added an optional - debug doctest for the case above.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211288",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211289",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Everything looks fine to me except for a spurious .orig file in the patches dir of the spkg.",
    "created_at": "2013-01-02T10:14:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211290",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:19'></a>Everything looks fine to me except for a spurious .orig file in the patches dir of the spkg.
...
```json
{
    "body": "<a id='comment:20'></a>Ah, sorry! I fixed that and replaced the spkg above.",
    "created_at": "2013-01-02T15:10:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211291",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:20'></a>Ah, sorry! I fixed that and replaced the spkg above.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211292",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>It's fine now.\n\nI think we should also open a follow up ticket to deprecate _change_ordering in Sage.",
    "created_at": "2013-01-02T15:19:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211293",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:21'></a>It's fine now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211294",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>!`_change_ordering` is a private method, i.e., it starts with an underscore. We don't need to deprecate it, we can simply remove it.",
    "created_at": "2013-01-02T15:27:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211295",
    "user": "https://github.com/malb"
}
```

<a id='comment:22'></a>!`_change_ordering` is a private method, i.e., it starts with an underscore. We don't need to deprecate it, we can simply remove it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211296",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211298",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Replying to [AlexanderDreyer](#comment%3A25):.\n> No problem, I'd prefer a new ticket, too.\n\nI created #13900 for this purpose.",
    "created_at": "2013-01-02T21:52:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211299",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:26'></a>Replying to [AlexanderDreyer](#comment%3A25):.
> No problem, I'd prefer a new ticket, too.
...
```json
{
    "body": "<a id='comment:27'></a>Indeed, `_change_ordering` can simply be removed now (see #13900).",
    "created_at": "2013-01-02T22:16:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211300",
    "user": "https://github.com/alexanderdreyer"
}
```

<a id='comment:27'></a>Indeed, `_change_ordering` can simply be removed now (see #13900).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211301",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13883#event-38950"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211302",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13883#issuecomment-211303",
    "user": "https://github.com/jdemeyer"
}
```
