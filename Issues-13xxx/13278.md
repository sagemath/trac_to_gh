...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163686"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163690"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,7 @@\n From a discussion on [sage-combinat-devel](https://groups.google.com/d/topic/sage-combinat-devel/-8d0a3AJYoQ/discussion):\n \n Optionally print extra information after doctesting: how many optional doctests were skipped, and how they were labeled (\"skipped 5 doctests marked \"optional -- bug\").\n+\n+**Apply** [attachment: 13278.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278.patch.gz)\n+\n+**Apply** [attachment: 13278_script.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278_script.patch.gz) to the script repo\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163692"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,6 +4,6 @@\n \n See also #14276.\n \n-**Apply** [attachment: 13278.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278.patch.gz)\n+**Apply** [[attachment: 13278_review.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278_review.patch.gz)(https://github.com/sagemath/sage/files/ticket13278/50c6e9ad5b149f5e351ffc4bf1c43dfb.gz)\n \n **Apply** [attachment: 13278_script.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278_script.patch.gz) to the script repo\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163696"
}
```
...
```json
{
    "body": "<a id='comment:13'>Comment 13:</a>\n[(which replaces [attachment: 13278_review.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278_review.patch.gz)(https://github.com/sagemath/sage/files/ticket13278/a6f6ae6304ec244632b70840ee044699.gz)) needs review.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163698"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,6 +4,6 @@\n \n See also #14276.\n \n-**Apply** [[attachment: 13278_review.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278_review.patch.gz)(https://github.com/sagemath/sage/files/ticket13278/50c6e9ad5b149f5e351ffc4bf1c43dfb.gz)\n+**Apply** [[attachment: 13278_review2.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278_review2.patch.gz)(https://github.com/sagemath/sage/files/ticket13278/50c6e9ad5b149f5e351ffc4bf1c43dfb.gz)\n \n **Apply** [attachment: 13278_script.patch.gz](https://github.com/sagemath/sage/files/ticket13278/13278_script.patch.gz) to the script repo\n``````\n",
    "created_at": "2013-03-27T00:07:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13278",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163699"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13278#issuecomment-155739",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13278#issuecomment-155740",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163703"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13278#event-163704"
}
```
