...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13776#event-38627"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13776#event-38628"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13776#event-38629"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13776#event-38630"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13776#event-38631"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13776#event-38632"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13776#event-38633"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>is the issue fixed in general?",
    "created_at": "2016-07-09T11:08:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13776#issuecomment-167644",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```

<a id='comment:5'></a>is the issue fixed in general?
...
```json
{
    "body": "<a id='comment:6'></a>No, IIRC it was handled for this specific implementation.",
    "created_at": "2016-07-09T16:23:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13776#issuecomment-167645",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:6'></a>No, IIRC it was handled for this specific implementation.
