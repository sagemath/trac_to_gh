...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13273#event-169495"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13273#event-169496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13273#event-169497"
}
```
...
```json
{
    "body": "Changed assignee from **@jasongrout, jkantor** to **hackstein**",
...
Changed assignee from **@jasongrout, jkantor** to **hackstein**
...
```json
{
    "body": "Removed assignee **hackstein**",
    "created_at": "2012-07-31T16:17:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13273",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13273#issuecomment-155682",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13273#issuecomment-155683",
