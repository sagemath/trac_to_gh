...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200642",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200644",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200647",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200648",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200649",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I am not totally sure if the patch has dependencies, but let's test. With the patch, it is tested whether the input is valid as the domain of a conversion map or a coercion map. There is a difference between the two cases! Namely, Sequences are OK for a conversion map, but not for a coercion map.\n\nIf the input S is invalid, `P.coerce_map_from(S)` returns None, which is the expected answer if there is no coercion (hence, no error is raised). Because the short-cut is quick enough and in order to not pollute the cache, the answer is *not* cached.",
    "created_at": "2012-08-28T09:55:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200650",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>I am not totally sure if the patch has dependencies, but let's test. With the patch, it is tested whether the input is valid as the domain of a conversion map or a coercion map. There is a difference between the two cases! Namely, Sequences are OK for a conversion map, but not for a coercion map.
...
```json
{
    "body": "<a id='comment:8'></a>Could you clarify under what circumstances not having this code pollutes the cache? In particular, it seems that [coerce|convert]_map_from is always called with parent(x) which should always return a Parent or type? Perhaps what I'm asking is what object violate this in their parent() method.",
    "created_at": "2013-01-15T08:19:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200651",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:8'></a>Could you clarify under what circumstances not having this code pollutes the cache? In particular, it seems that [coerce|convert]_map_from is always called with parent(x) which should always return a Parent or type? Perhaps what I'm asking is what object violate this in their parent() method.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200652",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>PS: If P is not a category object nor a type, it is impossible that there is a coercion map from P to self. Therefore the patch introduces a short cut: ``self.coerce_map_from(P)`` immediately returns None, and does not try to find a coercion map by a costly backtrack algorithm.",
    "created_at": "2013-01-15T08:47:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200653",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>PS: If P is not a category object nor a type, it is impossible that there is a coercion map from P to self. Therefore the patch introduces a short cut: ``self.coerce_map_from(P)`` immediately returns None, and does not try to find a coercion map by a costly backtrack algorithm.
...
```json
{
    "body": "<a id='comment:11'></a>Didn't it happen with integer ? (I think python ints.)",
    "created_at": "2013-01-15T08:56:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200654",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:11'></a>Didn't it happen with integer ? (I think python ints.)
...
```json
{
    "body": "<a id='comment:12'></a>Some info here http://trac.sagemath.org/sage_trac/ticket/13400#comment:31 but this ticket was opened before so...",
    "created_at": "2013-01-15T08:59:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200655",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:12'></a>Some info here http://trac.sagemath.org/sage_trac/ticket/13400#comment:31 but this ticket was opened before so...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200656",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Did you apply #12313?\nIt seems after a really quick read that #13400 is a follow up to #12313 to mitigate a speed regression.",
    "created_at": "2013-01-15T10:01:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200658",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:15'></a>Did you apply #12313?
It seems after a really quick read that #13400 is a follow up to #12313 to mitigate a speed regression.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200659",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200660",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Straightforward patch that applies (with slight whitespace fuzz for me) and doctests succeed. Plus it solves a real regression. At this pace, Sage 5.7 will have a negative memory footprint! yay.\n\nPositive review.",
    "created_at": "2013-01-18T20:14:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200661",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:18'></a>Straightforward patch that applies (with slight whitespace fuzz for me) and doctests succeed. Plus it solves a real regression. At this pace, Sage 5.7 will have a negative memory footprint! yay.
...
```json
{
    ...
    "milestone": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13378#event-37111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200662",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200663",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#12313, #12215\"",
    "created_at": "2013-01-19T09:31:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200664",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "" to "#12313, #12215"
...
```json
{
    "body": "<a id='comment:21'></a>Please don't add dependencies that aren't required for the patches to apply. The fix here can be applied independently of other tickets and makes sense too. It might solve a problem that doesn't become quite as apparent without those other tickets, but that has little to do with its applicability.\n\nWe've had problems before where tickets were unnecessarily dequeued due to superfluous dependencies on tickets that turned out to need further work. Also, #12313 already states it's dependent on #12215, so there's no need to repeat that dependence here.",
    "created_at": "2013-01-19T20:29:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200665",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:21'></a>Please don't add dependencies that aren't required for the patches to apply. The fix here can be applied independently of other tickets and makes sense too. It might solve a problem that doesn't become quite as apparent without those other tickets, but that has little to do with its applicability.
...
```json
{
    "body": "<a id='comment:22'></a>Yes, neither #12313 nor #12215 are dependencies for my patch. They should be merged together, because #13378 avoids a regression that #12313 would introduce, but #13378 makes perfectly sense without #12313.",
    "created_at": "2013-01-19T20:37:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200666",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:22'></a>Yes, neither #12313 nor #12215 are dependencies for my patch. They should be merged together, because #13378 avoids a regression that #12313 would introduce, but #13378 makes perfectly sense without #12313.
...
```json
{
    "body": "Changing dependencies from \"#12313, #12215\" to \"\"",
    "created_at": "2013-01-19T20:47:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200668",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "#12313, #12215" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200669",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13378#issuecomment-200670",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13378",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13378#event-37112"
}
```
