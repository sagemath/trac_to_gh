...
{
    "assignees": [],
    "body": "The following works right after extracting the Sage source tarball:\n\n```\n./sage -i /path/to/foo.spkg\n```\nBut this doesn't work for remote packages:\n\n```\n./sage -i http://example.com/foo.spkg\n```\nor\n\n```\n./sage -i foo\n```\nUsing either `wget`, `curl` or system Python, we should also make this work.\n\n**Apply**:\n1. [attachment: 13373_sage-i.patch.gz](https://github.com/sagemath/sage/files/ticket13373/13373_sage-i.patch.gz) to `SAGE_ROOT`.\n2. [attachment: 13373_remove_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket13373/13373_remove_scripts.patch.gz) to `SAGE_LOCAL/bin`.\n3. [attachment: 13373_doc.patch.gz](https://github.com/sagemath/sage/files/ticket13373/13373_doc.patch.gz) to the Sage library.\n\nAssignee: **@nexttime**\n\nReviewer: **John Palmieri**\n\nAuthor: **Leif Leonhardy, Jeroen Demeyer**\n\nMerged: **sage-5.3.rc0**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/13373_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13373#event-171113"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13373#event-171114"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13373#event-171115"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,3 +14,5 @@\n ./sage -i foo\n ```\n Using either `wget`, `curl` or system Python, we should also make this work.\n+\n+**Apply** [attachment: 13373_sage-i.patch.gz](https://github.com/sagemath/sage/files/ticket13373/13373_sage-i.patch.gz) to `SAGE_ROOT`.\n``````\n",
    "created_at": "2012-08-16T18:46:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13373",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13373#issuecomment-157807",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13373#issuecomment-157808",
    "user": "https://github.com/jdemeyer"
}
```
