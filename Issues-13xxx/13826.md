...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210002",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210003",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210004",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I agree that one should always `open()` and then ask for forgiveness. Fixed, too.",
    "created_at": "2012-12-12T21:36:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210006",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>I agree that one should always `open()` and then ask for forgiveness. Fixed, too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210008",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac_13826_star_imports_race.patch](tarball://root/attachments/some-uuid/ticket13826/trac_13826_star_imports_race.patch) by @vbraun created at 2012-12-13 13:55:39\n\nI've added a warning if the pickle is corrupted and converted `sage.sandpiles` to lazily import so we actually have something to test. Though neither of these changes is anywhere near as important as fixing the race condition.",
    "created_at": "2012-12-13T13:55:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210009",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>Attachment [trac_13826_star_imports_race.patch](tarball://root/attachments/some-uuid/ticket13826/trac_13826_star_imports_race.patch) by @vbraun created at 2012-12-13 13:55:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210010",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210012",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210013",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210014",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>OK, it seems the issues I pointed out are a little less straightforward than I thought, so they should probably be cleared up before this ticket gets merged.\n\n> So? Go ahead and design a workflow that takes care of it automatically if it bothers you.\n\n\nIt's a space after a colon on a line you introduce, not some whitespace on an empty line left by an auto-indenting editor.\n\n> Because os.rename() will fail if the destination exists on Windows (thanks for the well-thought out filesystem semantics, Bill G.!)\n\n\nThat's not what I meant. You can first write the temp file and then unlink the old one and move the new one in place. Presently the old cache file is already gone while you're writing the new one. An old cache file is better than none at all, it seems in this setting?",
    "created_at": "2012-12-14T06:10:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210015",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:9'></a>OK, it seems the issues I pointed out are a little less straightforward than I thought, so they should probably be cleared up before this ticket gets merged.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210016",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210018",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210019",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Yes, `sage -b` deletes the cache file, so the cache should never be stale.  Making the replacement atomic should be fixed though, and this patch does that.\n\nThe code looks good, except that I think the explicit unlink of the cache file before writing a new one is unnecessary (and could cause issues with multiple stage startups at the same time).  We've decided to ignore whitespace, so modulo that one issue, positive review.",
    "created_at": "2012-12-14T20:31:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210021",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:13'></a>Yes, `sage -b` deletes the cache file, so the cache should never be stale.  Making the replacement atomic should be fixed though, and this patch does that.
...
```json
{
    "body": "<a id='comment:14'></a>As I said before, `os.rename()` will fail on Windows if the target exists. We could count on `os.rename()` fail on Windows and succeed on Unix, but thats also a bit wonky. Explicitly deleting the cache ensures that `save_cache_file()` does what you would think it does.",
    "created_at": "2012-12-14T21:36:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210022",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:14'></a>As I said before, `os.rename()` will fail on Windows if the target exists. We could count on `os.rename()` fail on Windows and succeed on Unix, but thats also a bit wonky. Explicitly deleting the cache ensures that `save_cache_file()` does what you would think it does.
...
```json
{
    "body": "<a id='comment:17'></a>I think we should plug this obvious race with the patch I posted. So please review if you care about patchbot results :-P",
    "created_at": "2013-01-24T12:17:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210025",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>I think we should plug this obvious race with the patch I posted. So please review if you care about patchbot results :-P
...
```json
{
    "body": "<a id='comment:18'></a>See #14292 for a general approach to solving the problem of race conditions when writing to a file, which should probably be used here.",
    "created_at": "2013-04-04T13:37:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210026",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>See #14292 for a general approach to solving the problem of race conditions when writing to a file, which should probably be used here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210027",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210028",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210029",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210030",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210031",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13826#event-38773"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Attachment [13826_star_imports_race_v2.patch](tarball://root/attachments/some-uuid/ticket13826/13826_star_imports_race_v2.patch) by @jdemeyer created at 2013-04-13 15:53:56",
    "created_at": "2013-04-13T15:53:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210033",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>Attachment [13826_star_imports_race_v2.patch](tarball://root/attachments/some-uuid/ticket13826/13826_star_imports_race_v2.patch) by @jdemeyer created at 2013-04-13 15:53:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210034",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210035",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210036",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13826#event-38774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210037",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210038",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13826#event-38775"
}
```
...
```json
{
    ...
    "milestone": "sage-5.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13826#event-38776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13826#issuecomment-210039",
    "user": "https://github.com/jdemeyer"
}
```
