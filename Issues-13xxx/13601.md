...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13601#issuecomment-161617",
    "user": "https://github.com/sagetrac-r-gaia-cs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13601#issuecomment-161618",
    "user": "https://github.com/sagetrac-r-gaia-cs"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13601#event-174308"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13601#event-174309"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13601#event-174310"
}
```
