...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13990#event-180282"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13990#event-180283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13990#event-180284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13990#issuecomment-168138",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13990#issuecomment-168139",
    "user": "https://github.com/jdemeyer"
}
```
