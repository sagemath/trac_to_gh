...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13932#issuecomment-212305",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39123"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39124"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39125"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39126"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39127"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39128"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39129"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Since #12406, the `check` is ignored for inexact rings, so this problem does not exist anymore. A doctest for this example has also been added in that ticket, so this ticket can be closed.",
    "created_at": "2020-04-18T17:52:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13932#issuecomment-212306",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:6'></a>Since #12406, the `check` is ignored for inexact rings, so this problem does not exist anymore. A doctest for this example has also been added in that ticket, so this ticket can be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13932#issuecomment-212307",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39130"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13932#issuecomment-212308",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13932#issuecomment-212309",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13932",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13932#event-39132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13932#issuecomment-212310",
