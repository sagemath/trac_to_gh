...
```json
{
    "body": "<a id='comment:1'></a>Attachment [diagonal.patch](tarball://root/attachments/some-uuid/ticket13564/diagonal.patch) by @mwhansen created at 2012-10-06 03:55:29",
    "created_at": "2012-10-06T03:55:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204192",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>Attachment [diagonal.patch](tarball://root/attachments/some-uuid/ticket13564/diagonal.patch) by @mwhansen created at 2012-10-06 03:55:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204193",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204194",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Hello, this comment is with respect to the statement \"- Unknown: No author specified in the file from 2012-10-03\" in your patch. The authors are mentioned in the beginning of the file.\n\nAs such, I think typically no authors are added at the top unless some major change is effected. The author names and history is preserved in mercurial anyway. You can run `sage -hg blame filename` to see which revision modified which line of the file `filename`. The revision number can then be used to pinpoint the author.",
    "created_at": "2012-10-08T09:18:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204195",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:2'></a>Hello, this comment is with respect to the statement "- Unknown: No author specified in the file from 2012-10-03" in your patch. The authors are mentioned in the beginning of the file.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204196",
    "user": "https://trac.sagemath.org/admin/accounts/users/r.gaia.cs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204197",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_13564-diagonal.patch](tarball://root/attachments/some-uuid/ticket13564/trac_13564-diagonal.patch) by @ppurka created at 2012-10-10 13:21:04",
    "created_at": "2012-10-10T13:21:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204198",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:3'></a>Attachment [trac_13564-diagonal.patch](tarball://root/attachments/some-uuid/ticket13564/trac_13564-diagonal.patch) by @ppurka created at 2012-10-10 13:21:04
...
```json
{
    "body": "<a id='comment:4'></a>Have to force the patchbot :(\nPatchbot apply trac_13564-diagonal.patch",
    "created_at": "2012-10-12T08:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204199",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:4'></a>Have to force the patchbot :(
Patchbot apply trac_13564-diagonal.patch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204200",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204201",
...
```json
{
    "body": "<a id='comment:6'></a>I am changing this to \"needs_info\" for now as it seems to me that, there is still some design decisions to make. I am adding cc: sage-devel so that this could be discussed.",
    "created_at": "2013-02-10T22:24:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204202",
    "user": "https://github.com/KPanComputes"
}
```

<a id='comment:6'></a>I am changing this to "needs_info" for now as it seems to me that, there is still some design decisions to make. I am adding cc: sage-devel so that this could be discussed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13564#issuecomment-204204",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13564#event-37738"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13564#event-37739"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13564#event-37740"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13564#event-37741"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13564#event-37742"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13564#event-37743"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13564#event-37744"
}
```
