...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195213",
    "user": "https://trac.sagemath.org/admin/accounts/users/JoalHeagney"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195214",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195215",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>The offending expression is `limit(-1/2*(I*expintegral_e(1/2, -I*t + I*x) - I*expintegral_e(1/2, I*t - I*x))*sqrt(-t + x)*cos(x) + 1/2*(expintegral_e(1/2, -I*t + I*x) + expintegral_e(1/2, I*t - I*x))*sqrt(-t + x)*sin(x), t, x, minus)`. Our `_limit_latex_()` function does not expect the last direction argument.",
    "created_at": "2012-11-19T12:46:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195216",
    "user": "https://github.com/burcin"
}
```

<a id='comment:2'></a>The offending expression is `limit(-1/2*(I*expintegral_e(1/2, -I*t + I*x) - I*expintegral_e(1/2, I*t - I*x))*sqrt(-t + x)*cos(x) + 1/2*(expintegral_e(1/2, -I*t + I*x) + expintegral_e(1/2, I*t - I*x))*sqrt(-t + x)*sin(x), t, x, minus)`. Our `_limit_latex_()` function does not expect the last direction argument.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195217",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Patch up, please review.\n\nApply [attachment:trac_13181-limit_latex_direction.patch]",
    "created_at": "2012-11-19T13:29:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195218",
    "user": "https://github.com/burcin"
}
```

<a id='comment:3'></a>Patch up, please review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195219",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195220",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195221",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I like this.  Can you add a doctest that shows that both possible ways of input for the limit direction works?  Something like\n\n```\nsage: latex(limit(f,x=a,dir='right'))\n\\lim_{x \\to a^+}\\, f\\left(x\\right)\n```\nI guess we don't need `'above'` since that's deprecated!\n\nOtherwise I think this is nice.  Glad you figured out what was going on - I was too worried about the fractions and got distracted when I looked at this.",
    "created_at": "2012-11-19T15:24:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195222",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>I like this.  Can you add a doctest that shows that both possible ways of input for the limit direction works?  Something like
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195223",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195224",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195225",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195226",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195227",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195228",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13181#event-36333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13181#issuecomment-195229",
    "user": "https://github.com/jdemeyer"
}
```
