...
```json
{
    "body": "+1 on fixing this. I don't think it is worth the trouble of being more precise about what could not be ambiguous. Although the ambiguity actually comes from higher up with printing the words:\n\n```\nsage: a(1)\nword: 12\nsage: a(2)\nword: 12\nsage: list(a(1))\n[1, 2]\nsage: list(a(2))\n[12]\n```\nSo I think it should be changed in printing the word to resolve ambiguities there.",
    "created_at": "2022-03-18T01:35:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13707",
    "type": "issue_comment",
