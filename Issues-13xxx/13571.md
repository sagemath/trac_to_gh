...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13571#issuecomment-162409",
    "user": "https://trac.sagemath.org/admin/accounts/users/startakovsky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13571#issuecomment-162410",
    "user": "https://trac.sagemath.org/admin/accounts/users/startakovsky"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13571#event-118141"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13571#event-118142"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13571",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13571#event-118143"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13571#issuecomment-162411",
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13571#event-118144"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13571#event-118145"
}
```
