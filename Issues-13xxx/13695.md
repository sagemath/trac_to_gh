...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38292"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38293"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38294"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38295"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38296"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38297"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13695",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13695#issuecomment-207236",
...
```json
{
    "body": "<a id='comment:5'></a>Input is now checked, and the original issue now works. Let us close that old ticket.\n\n```\nsage: A = Subsets(1);\n....: sum((-1)^(A[k].cardinality()) for k in range(A.cardinality()))\n\n0\n```",
    "created_at": "2018-04-30T08:41:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13695",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13695#issuecomment-207237",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:5'></a>Input is now checked, and the original issue now works. Let us close that old ticket.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38300"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13695",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13695#issuecomment-207238",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13695",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13695#issuecomment-207239",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13695",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13695#event-38301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13695",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13695#issuecomment-207240",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13695",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13695#issuecomment-207241",
    "user": "https://github.com/videlec"
}
```
