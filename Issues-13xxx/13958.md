...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212801",
...
```json
{
    "body": "<a id='comment:3'></a>i just wrote a patch and will upload it shortly. Just a message to avoid duplication of effort.",
    "created_at": "2013-01-17T16:28:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212803",
    "user": "https://github.com/koffie"
}
```

<a id='comment:3'></a>i just wrote a patch and will upload it shortly. Just a message to avoid duplication of effort.
...
```json
{
    "body": "<a id='comment:4'></a>Ok, here is the patch. I did not do anything with the !__add!__ method. The reason being that I think that the memory usage doesn't blow up to bad (the memory needed to store the sum(list_of_ideals) is linear in len(list_of_ideals) while the memory needed for prod(list_of_ideals) was exponential in len(list_of_ideals). And reducing the amount of generators after each addition is probably slower then reducing the amount of generators only when you need to do something more fancy with the Ideal.",
    "created_at": "2013-01-18T10:56:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212804",
    "user": "https://github.com/koffie"
}
```

<a id='comment:4'></a>Ok, here is the patch. I did not do anything with the !__add!__ method. The reason being that I think that the memory usage doesn't blow up to bad (the memory needed to store the sum(list_of_ideals) is linear in len(list_of_ideals) while the memory needed for prod(list_of_ideals) was exponential in len(list_of_ideals). And reducing the amount of generators after each addition is probably slower then reducing the amount of generators only when you need to do something more fancy with the Ideal.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212805",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212806",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>off-trac comments sent to mderickx",
    "created_at": "2013-01-21T15:48:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212807",
    "user": "https://github.com/mstreng"
}
```

<a id='comment:6'></a>off-trac comments sent to mderickx
...
```json
{
    "body": "<a id='comment:7'></a>There is one reaction to the off-trac comments of which I think it deserves to be on trac. Namely why the implementation in the attachement is different from what turned out to be fastest one in the timings in the previous one.\n\nThe reason that it is different is that I tried some other strategy (namely just let pari figure everything out), and I found one that this one was even faster. See: http://pastebin.com/xRhq3mrX\n\nSo that is why I changed the code to do it this way. This has an extra bonus, namely if the pari ideal mul gets improved, then we automatically benefit from this.",
    "created_at": "2013-01-23T11:21:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212808",
    "user": "https://github.com/koffie"
}
```

<a id='comment:7'></a>There is one reaction to the off-trac comments of which I think it deserves to be on trac. Namely why the implementation in the attachement is different from what turned out to be fastest one in the timings in the previous one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212809",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212810",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212811",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212812",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Replying to [nbruin](#comment%3A1):\n> representing an ideal with 2 generators is not always cheaply done.\n\n[citation needed]",
    "created_at": "2013-01-25T12:22:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212813",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>Replying to [nbruin](#comment%3A1):
> representing an ideal with 2 generators is not always cheaply done.
...
```json
{
    "body": "<a id='comment:11'></a>This patch needs a proper commit message.",
    "created_at": "2013-01-25T12:25:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212814",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>This patch needs a proper commit message.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212815",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Sorry for the inconvenience. I added a commit message.",
    "created_at": "2013-01-26T21:53:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212816",
    "user": "https://github.com/koffie"
}
```

<a id='comment:12'></a>Sorry for the inconvenience. I added a commit message.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212817",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13958#issuecomment-212818",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13958",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13958#event-39201"
}
```
