...
```json
{
    "body": "<a id='comment:6'></a>\nI agree that this should be solved by #5355/#12715, but #5355 has been open for seven years now... The attached branch provides a temporary fix that at least makes the most common use case work, and shouldn't be hard to remove once a proper solution is in place.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[b0cbce7](http://git.sagemath.org/sage.git/commit/?id=b0cbce7241abd227f55cb6d5a8e61c2388b02503)|`conversion of number field elts with real/complex embeddings to algebraic numbers`|\n|[526e66c](http://git.sagemath.org/sage.git/commit/?id=526e66c778c58e34086efd6ad5871ea84186520d)|`add test from #13041`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[ee1fc05](http://git.sagemath.org/sage.git/commit/?id=ee1fc05236e7a68d09bcd0070a58e3b038f69c5e)|`conversion of number field elts with real/complex embeddings to algebraic numbers`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|\n|[b28381a](http://git.sagemath.org/sage.git/commit/?id=b28381af685fb5238ce1e68af834bf61ba23e936)|`conversion of number field elts with real/complex embeddings to algebraic numbers`|",
