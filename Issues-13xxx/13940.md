...
```json
{
    "body": "> `sig_on` switch is expensive\n\n*[citation needed]*",
...
```json
{
    "body": "I had initially listed this as part of #13786, but will leave it until this ticket is fixed. Whoever fixes this should just make `0^0 == 1`.",
...
```json
{
    "body": "I guess I should finally fix this.\n\n---\nNew commits:",
    "created_at": "2020-02-09T00:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13940",
    "type": "issue_comment",
