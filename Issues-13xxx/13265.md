...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13265#event-169376"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13265#event-169377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13265#event-169378"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -18,4 +18,4 @@\n \n The reason is that Sage's reimplementation of `PolyBoRi`'s `BooleConstant` misses some routines.\n \n-* **Apply:** attachment:\n+* **Apply:** [attachment: BooleConstant.patch.gz](https://github.com/sagemath/sage/files/ticket13265/BooleConstant.patch.gz)\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13265",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13265#issuecomment-155527",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13265",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13265#issuecomment-155528",
