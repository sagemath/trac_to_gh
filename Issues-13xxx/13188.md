...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195353",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195354",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195355",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195356",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195357",
    "user": "https://trac.sagemath.org/admin/accounts/users/jlopez"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Rebased ! (I leave tomorrow for 2 months `:-p`)\n\nNathann",
    "created_at": "2012-07-06T21:19:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195358",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Rebased ! (I leave tomorrow for 2 months `:-p`)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195359",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>This fails to apply for me on Sage 5.4.beta1. Additionally the deprecations changed in 5.2 and so sage fails to start properly. Also for line 120 in cliquer.py:\n\n```\nsage: C = Graph('DJ{')\n```\nis that brace `{` suppose to be there?",
    "created_at": "2012-10-01T15:04:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195360",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>This fails to apply for me on Sage 5.4.beta1. Additionally the deprecations changed in 5.2 and so sage fails to start properly. Also for line 120 in cliquer.py:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195361",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195362",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195365",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195366",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195368",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [trac_13188.patch](tarball://root/attachments/some-uuid/ticket13188/trac_13188.patch) by @tscrim created at 2012-10-03 22:44:37\n\nIt is good now. I ran build the first time, got the duplicate reference. Popped the patch off, recompiled sage, pushed the patch, recompiled, then rebuilt the docstrings and it was clean.\n\nTravis",
    "created_at": "2012-10-03T22:44:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195369",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:9'></a>Attachment [trac_13188.patch](tarball://root/attachments/some-uuid/ticket13188/trac_13188.patch) by @tscrim created at 2012-10-03 22:44:37
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195370",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195371",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195372",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13188#event-36356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195373",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13188#issuecomment-195374",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13188",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13188#event-36357"
}
```
