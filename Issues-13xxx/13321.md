...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199019",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199020",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199021",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36871"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36872"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36873"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36874"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36875"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36876"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36877"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>why should the following example not work?\n\n```\n   sage: (GF(7)^2).hom([[20,0],[0,21]],ZZ^2)\n```\nall other mentioned ticket issues are fixed",
    "created_at": "2016-07-09T10:06:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199022",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```

<a id='comment:7'></a>why should the following example not work?
...
```json
{
    "body": "<a id='comment:8'></a>It is not mathematically well-defined. See:\n\n```\nsage: ZZ.has_coerce_map_from(GF(7))\nFalse\n```",
    "created_at": "2016-07-09T16:26:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199023",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>It is not mathematically well-defined. See:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199024",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199025",
    "user": "https://trac.sagemath.org/admin/accounts/users/jakobkroeker"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199028",
    "user": "https://github.com/koffie"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36878"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36879"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Should we add a doctest to guard against changes to the current behavior?",
    "created_at": "2021-11-29T00:54:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199029",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:14'></a>Should we add a doctest to guard against changes to the current behavior?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199030",
...
```json
{
    "body": "Changing branch from \"\" to \"u/chapoton/13321\"",
    "created_at": "2022-07-08T14:15:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199031",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "" to "u/chapoton/13321"
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36880"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36881"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I have added a doctest and refreshed the file.\n\n---\nNew commits:",
    "created_at": "2022-07-08T14:15:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199032",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:15'></a>I have added a doctest and refreshed the file.
...
```json
{
    "body": "Changing commit from \"\" to \"caae8a79e537a8324ff6d3bf1bdc4e87fe3ec9fa\"",
    "created_at": "2022-07-08T14:15:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199033",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "" to "caae8a79e537a8324ff6d3bf1bdc4e87fe3ec9fa"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199034",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199035",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199036",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing branch from \"u/chapoton/13321\" to \"caae8a79e537a8324ff6d3bf1bdc4e87fe3ec9fa\"",
    "created_at": "2022-07-09T22:33:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199037",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/chapoton/13321" to "caae8a79e537a8324ff6d3bf1bdc4e87fe3ec9fa"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13321#issuecomment-199038",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13321",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13321#event-36882"
}
```
