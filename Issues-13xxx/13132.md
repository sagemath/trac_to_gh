...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_13132.patch](tarball://root/attachments/some-uuid/ticket13132/trac_13132.patch) by @dcoudert created at 2012-08-09 23:50:13\n\nThis patch solves the problem for Graph and DiGraph since the function is in `generic_graph.py`. The `delete_vertices` also add the same bug.",
...
<a id='comment:1'></a>Attachment [trac_13132.patch](tarball://root/attachments/some-uuid/ticket13132/trac_13132.patch) by @dcoudert created at 2012-08-09 23:50:13
...
```json
{
    "body": "<a id='comment:4'></a>You are welcome.",
...
<a id='comment:4'></a>You are welcome.
