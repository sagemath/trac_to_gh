...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_13132.patch](https://github.com/sagemath/sage/files/ticket13132/trac_13132.patch) by @dcoudert created at 2012-08-09 23:50:13\n\nThis patch solves the problem for Graph and DiGraph since the function is in `generic_graph.py`. The `delete_vertices` also add the same bug.",
    "created_at": "2012-08-09T23:50:13Z",
    "issue": "https://github.com/sagemath/sage/issues/13132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13132#issuecomment-152509",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13132#issuecomment-152510",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13132#issuecomment-152511",
    "user": "https://trac.sagemath.org/admin/accounts/users/tjolivet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13132#issuecomment-152512",
    "user": "https://trac.sagemath.org/admin/accounts/users/tjolivet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13132#issuecomment-152513",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13132#issuecomment-152514",
