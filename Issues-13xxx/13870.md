...
```json
{
    "body": "<a id='comment:2'></a>Details? Is this post #13832?",
...
<a id='comment:2'></a>Details? Is this post #13832?
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [13870.patch](tarball://root/attachments/some-uuid/ticket13870/13870.patch) by @jdemeyer created at 2012-12-27 23:16:12",
...
<a id='comment:3'></a>Attachment [13870.patch](tarball://root/attachments/some-uuid/ticket13870/13870.patch) by @jdemeyer created at 2012-12-27 23:16:12
...
```json
{
    "body": "<a id='comment:5'></a>I'm going to silently close this, it was never really meant to be merged anyway...",
...
<a id='comment:5'></a>I'm going to silently close this, it was never really meant to be merged anyway...
