...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13380#event-171204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13380#event-171205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13380#event-171206"
}
```
...
```json
{
    "body": "Changed keywords from **** to **graph, disjoint paths**",
    "created_at": "2012-08-18T18:07:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13380",
    "type": "issue_comment",
...
Changed keywords from **** to **graph, disjoint paths**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13380#issuecomment-157931",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13380#issuecomment-157932",
    "user": "https://github.com/dcoudert"
}
```
