...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13380#issuecomment-200702",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13380#issuecomment-200703",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_13380_suurballe.patch](tarball://root/attachments/some-uuid/ticket13380/trac_13380_suurballe.patch) by @dcoudert created at 2012-10-20 13:13:00\n\nAfter discussions with Nathann, the suurballe tarjan function is now hidden. It is now called by the `edge_disjoint_paths`, `vertex_disjoint_paths`, and `disjoint_routed_paths` when appropriate.",
    "created_at": "2012-10-20T13:13:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13380#issuecomment-200704",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:2'></a>Attachment [trac_13380_suurballe.patch](tarball://root/attachments/some-uuid/ticket13380/trac_13380_suurballe.patch) by @dcoudert created at 2012-10-20 13:13:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13380#issuecomment-200705",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13380#issuecomment-200709",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>> Honestly I would sleep much better if those functions return raised an exception on graphs with multiple edges. Dealing with those is a waste of computations on the usual cases, and it will add scores of stupid \"if\" in the code. I hate this `-_-`\n\n\nSo should I raise an exception in all cases or only for edge-disjoint paths? \n\n> > Well, it depends on the situation. Sometimes you have several labels per edge stored in a dictionary, or you have only one numerical value. We need at least 2 ways to store edge data.\n> > Now I agree that I was a bit extreme in the options offered to the user (but strings were useful for Kautz :-P ). \n> > \n> > I can certainly reduce, but which are the options to keep ?\n\n> \n> Well.. All other graphs methods just accept as input a edge whose label is a weight.. Why would we need anything else ?\n\n\nNetworkx stores edge weights in a dictionary (default key: 'weight'). I have also examples of graphs where it is convenient to use a dictionary to store weights, labels, colors, etc. So I can let dictionary and numbers and remove other options.",
    "created_at": "2013-01-03T16:32:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13380#issuecomment-200711",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>> Honestly I would sleep much better if those functions return raised an exception on graphs with multiple edges. Dealing with those is a waste of computations on the usual cases, and it will add scores of stupid "if" in the code. I hate this `-_-`
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13380#event-37115"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13380#event-37116"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13380#event-37117"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13380#event-37118"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13380#event-37119"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13380#event-37120"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13380#event-37121"
}
```
