...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket13942/trac_13942.patch",
    "created_at": "2013-01-11T09:02:37Z",
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13942/trac_13942.patch",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_13942.patch](https://github.com/sagemath/sage/files/ticket13942/trac_13942.patch) by @kwankyu created at 2013-01-11 09:02:37\n\nThe patch cleans up the explanation of the Magma interface, correcting some wrong statements.",
    "created_at": "2013-01-11T09:02:37Z",
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13942#issuecomment-167213",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13942#issuecomment-167214",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13942#issuecomment-167215",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13942#issuecomment-167216",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13942#issuecomment-167217",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13942#issuecomment-167218",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13942#issuecomment-167219",
    "user": "https://github.com/vbraun"
}
```
