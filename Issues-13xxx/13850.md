...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                                        |\n|---------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[02a4a87](http://git.sagemath.org/sage.git/commit/?id=02a4a87)|`bug fix : importing BooleanPolynomialRing at the top-level prevents sage from starting`|\n|[6c846ed](http://git.sagemath.org/sage.git/commit/?id=6c846ed)|`Merge branch 'master' into 13850`|",
