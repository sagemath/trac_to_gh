...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13272#event-169476"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13272#event-169477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13272#event-169478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13272#issuecomment-155669",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13272#issuecomment-155670",
    "user": "https://github.com/jdemeyer"
}
```
