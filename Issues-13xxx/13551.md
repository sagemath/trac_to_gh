...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13551#event-37656"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203977",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203978",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203979",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>(that being said, I agree that proper dependency checking in the `autotools` spkg would be better)",
    "created_at": "2012-09-30T09:16:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203980",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>(that being said, I agree that proper dependency checking in the `autotools` spkg would be better)
...
```json
{
    "body": "<a id='comment:3'></a>Ok, I had a proper look at the spkg-install script and I guess the point of the \"brute-force\" multiple phase loop is about this.It is just that everything is so slow on Cygwin for that kind of things that I was too bored to really think about it.\nAnd indeed, as you mention here and in the script a proper dependency check would be nicer and could speed up things a little?\nAnyway, sorry about the noise, I'll put this as positive review and let you close the ticket as won't fix/duplicate.\n\nBy the way, the build did not finish because Windows decided to restart in the middle of the night for updates, and then the memory got exhausted...\nAnyway I'll use your spkg form linux where everything just works.",
    "created_at": "2012-09-30T10:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203981",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:3'></a>Ok, I had a proper look at the spkg-install script and I guess the point of the "brute-force" multiple phase loop is about this.It is just that everything is so slow on Cygwin for that kind of things that I was too bored to really think about it.
And indeed, as you mention here and in the script a proper dependency check would be nicer and could speed up things a little?
Anyway, sorry about the noise, I'll put this as positive review and let you close the ticket as won't fix/duplicate.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203982",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I added proper dependency checking to the autotools spkg at #13557, it needs review.",
    "created_at": "2012-10-01T19:12:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203983",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>I added proper dependency checking to the autotools spkg at #13557, it needs review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13551#event-37657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13551#issuecomment-203984",
    "user": "https://github.com/jdemeyer"
}
```
