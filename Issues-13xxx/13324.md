...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170337"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170338"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170339"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170341"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170342"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,10 +1,12 @@\n On my 1.7.16 installation of Cygwin, the ecl spkg does not build because it defines unconditionaly `_WINSOCKAPI_` in h/ecl-cmp.h which then prevents the definition of fd_set in /usr/include/sys/types.h.\n-I guess this is harmless on linux, intended on Windows, but on Cygwin this breaks the build of ECL.\n+I guess this is harmless on Linux, intended on Windows, but on Cygwin this breaks the build of ECL.\n \n The proposed spkg patches h/ecl-cmp.h so that `_WINSOCKAPI_` is not defined on CYGWIN.\n This has been merged upstream:\n https://sourceforge.net/p/ecls/ecl/ci/07c4ab7db83eda2eed7fa4a5ddeec2e28c7eb58b/\n \n Try spkg at\n-http://perso.telecom-paristech.fr/~flori/sage/ecl-11.1.2.cvs20111120.p2.spkg\n+http://perso.telecom-paristech.fr/~flori/sage/ecl-12.7.1.p0.spkg\n+which includes upstream version 12.7.1 and the above fix.\n \n+Apply [attachment: trac_13324.patch.gz](https://github.com/sagemath/sage/files/ticket13324/trac_13324.patch.gz)\n``````\n",
    "created_at": "2012-08-20T14:41:03Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170344"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170345"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170346"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170348"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -12,3 +12,6 @@\n Try spkg at\n http://boxen.math.washington.edu/home/jpflori/ecl-12.7.1.p0.spkg\n which includes upstream version 12.7.1 and the above fixes.\n+\n+Apply:\n+* [attachment: trac_1332.patch.gz](https://github.com/sagemath/sage/files/ticket13324/trac_1332.patch.gz).\n``````\n",
    "created_at": "2012-11-27T20:35:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
...
```json
{
    "body": "Changed work issues from **test if issues remain with new patches** to **fix lisp.py issue**",
    "created_at": "2012-11-27T23:47:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -15,4 +15,4 @@\n which includes upstream version 12.7.1 and the above fixes.\n \n Apply:\n-* [attachment: trac_1332.patch.gz](https://github.com/sagemath/sage/files/ticket13324/trac_1332.patch.gz).\n+* [attachment: trac_1334.patch.gz](https://github.com/sagemath/sage/files/ticket13324/trac_1334.patch.gz).\n``````\n",
...
```json
{
    "body": "Changed work issues from **fix lisp.py issue** to none",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170350"
}
```
...
```json
{
    "body": "<a id='comment:72'>Comment 72:</a>\nOh, I see what you mean!  I was thinking it was something else, but you mean that in [attachment: ecl-12.7.1.p0.diff.gz](https://github.com/sagemath/sage/files/ticket13324/ecl-12.7.1.p0.diff.gz) you have the same configure options in both cases, but need to remove `--with-dffi=no` from the `else` clause?",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170353"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170354"
}
```
...
```json
{
    "body": "Changed work issues from **correct options passed to configure** to none",
    "created_at": "2012-12-14T17:28:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "title_is": "Upgrade ECL to 12.12.1 and let it build on (recent) Cygwins",
    "title_was": "Upgrade ECL to 12.7.1 and let it build on (recent) Cygwins",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170355"
}
```
...
```json
{
    "body": "Changed dependencies from **#13364** to **#13860**",
    "created_at": "2012-12-24T17:14:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
...
Changed dependencies from **#13364** to **#13860**
...
```json
{
    "body": "Changed reviewer from **Fran\u00e7ois Bissey, Karl-Dieter Crisman** to **Fran\u00e7ois Bissey, Karl-Dieter Crisman, Dmitrii Pasechnik**",
...
Changed reviewer from **François Bissey, Karl-Dieter Crisman** to **François Bissey, Karl-Dieter Crisman, Dmitrii Pasechnik**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170357"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170358"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170359"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170360"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170363"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170364"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156688",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156689",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156690",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156691",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156692",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156693",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156694",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156695",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156696",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156697",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156698",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156699",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156700",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156701",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156702",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156703",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156704",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156705",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156706",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156707",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156708",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156709",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156710",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156711",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156712",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156713",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156714",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156715",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156716",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156717",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170366"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170367"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156718",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156719",
    "user": "https://github.com/sagetrac-jpflori"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156720",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156721",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156722",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156723",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156724",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156725",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156726",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156727",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156728",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13324#issuecomment-156729",
    "user": "https://github.com/kcrisman"
}
```
