...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157410"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157411"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157412"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157413"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157414"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157416"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157421"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157426"
}
```
...
```json
{
    "body": "<a id='comment:88'></a>\n**Attachment:** [ecl-12.7.1.p0.diff.gz](https://github.com/sagemath/sage/files/ticket13324/ecl-12.7.1.p0.diff.gz)\n\nThe new 12.7.1 spkg looks fine on Linux.",
...
```json
{
    "body": "**Attachment:** [ecl-12.2.1.p0.diff.gz](https://github.com/sagemath/sage/files/ticket13324/ecl-12.2.1.p0.diff.gz)\n\nSpkg diff, for review only.",
...
**Attachment:** [ecl-12.2.1.p0.diff.gz](https://github.com/sagemath/sage/files/ticket13324/ecl-12.2.1.p0.diff.gz)
...
```json
{
    "body": "**Attachment:** [ecl-12.12.1.p0.2.diff.gz](https://github.com/sagemath/sage/files/ticket13324/ecl-12.12.1.p0.2.diff.gz)\n\nSpkg diff, for review only.",
...
**Attachment:** [ecl-12.12.1.p0.2.diff.gz](https://github.com/sagemath/sage/files/ticket13324/ecl-12.12.1.p0.2.diff.gz)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157429"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157430"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157431"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157432"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157435"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157436"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157437"
}
```
...
```json
{
    "body": "<a id='comment:0'></a>\n**Attachment:** [trac_13324.2.patch.gz](https://github.com/sagemath/sage/files/ticket13324/trac_13324.2.patch.gz)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157438"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157439"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157440"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157442"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-157443"
}
```
