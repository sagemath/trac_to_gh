...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,9 +10,11 @@\n * http://sourceforge.net/p/ecls/ecl/ci/15033d5a8ad7297e5f76e2e70446b0eea2f2d2a7/\n * http://sourceforge.net/p/ecls/ecl/ci/ec1fe8781a5f137284cc6c0d0cfa6b0cc9b9b291/\n \n+We build ECL single threaded to get hopefully more correct signal handling in library mode and avoid problems with the pexpect interface.\n+\n Try spkg at\n http://boxen.math.washington.edu/home/jpflori/ecl-12.7.1.p0.spkg\n which includes upstream version 12.7.1 and the above fixes.\n \n Apply:\n-* [attachment: trac_1334.patch](https://github.com/sagemath/sage/files/ticket13324/trac_1334.patch.gz).\n+* [attachment: trac_13324.patch](https://github.com/sagemath/sage/files/ticket13324/trac_13324.patch.gz).\n``````\n",
...
```json
{
    "body": "<div id=\"comment:72\" align=\"right\">Comment 72</div>\n\nOh, I see what you mean!  I was thinking it was something else, but you mean that in [attachment: ecl-12.7.1.p0.diff](https://github.com/sagemath/sage/files/ticket13324/ecl-12.7.1.p0.diff.gz) you have the same configure options in both cases, but need to remove `--with-dffi=no` from the `else` clause?",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13324#event-170374"
}
```
