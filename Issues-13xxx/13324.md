...
```json
{
    "body": "Attachment [ecl-12.7.1.p0.diff](tarball://root/attachments/some-uuid/ticket13324/ecl-12.7.1.p0.diff) by jpflori created at 2012-12-14 17:52:38\n\nThe new 12.7.1 spkg looks fine on Linux.",
...
```json
{
    "body": "Attachment [trac_13324.2.patch](tarball://root/attachments/some-uuid/ticket13324/trac_13324.2.patch) by jpflori created at 2013-01-11 14:49:49",
