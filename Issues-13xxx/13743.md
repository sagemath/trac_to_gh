...
```json
{
    "body": "<a id='comment:2'></a>You can just do \n\n```\nsage: ks = SymmetricFunctions(QQ).kschur(3,1)\nsage: f = ks[2,1]\nsage: f[Partition([2,1])]\n1\n```\n\nAnne",
    "created_at": "2012-11-22T16:25:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208481",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:2'></a>You can just do 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208482",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208483",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> Do you mean `Partitions(NonNegativeIntegers(), max_part=k)` with the `s`'s? If so, this has some quirks noted in the wierdness page. However, if you mean exactly what you wrote, then I believe that should raise an exception since `Partition()` should return a single partition, although maybe with that input, one should get a random partition with max part `k`...\n\n\nI meant `Partitions(NonNegativeIntegers(), max_part=k)`.  Sorry for the double typos (corrected in comment).",
    "created_at": "2012-11-24T18:02:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208485",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:5'></a>> Do you mean `Partitions(NonNegativeIntegers(), max_part=k)` with the `s`'s? If so, this has some quirks noted in the wierdness page. However, if you mean exactly what you wrote, then I believe that should raise an exception since `Partition()` should return a single partition, although maybe with that input, one should get a random partition with max part `k`...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208486",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Found another bug which is really related to this one. If we give an input to a kSchur function which isn't k-bounded, then it should return an error:\n\n```\nks = SymmetricFunctions(QQ).kBoundedSubspace(3,1).kschur()\nks([4,1])\nTraceback (click to the left of this block for traceback)\n...\nTypeError: do not know how to make x (= [4, 1]) an element of self\n(=3-bounded Symmetric Functions over Rational Field with t=1 in the\n3-Schur basis also with t=1)\n```\n\nBut this should also return an error:\n\n```\nks(Partition([4,1]))\nks3[4, 1]\n```",
    "created_at": "2012-11-26T05:34:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208489",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```

<a id='comment:9'></a>Found another bug which is really related to this one. If we give an input to a kSchur function which isn't k-bounded, then it should return an error:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208490",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208491",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208492",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>We both end up deleting the `NonNegativeIntegers` import (which is essentially trivial cleanup for both our patches), but other than that, the patches should<sup>(tm)</sup> commute.",
    "created_at": "2013-03-07T23:20:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208493",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:12'></a>We both end up deleting the `NonNegativeIntegers` import (which is essentially trivial cleanup for both our patches), but other than that, the patches should<sup>(tm)</sup> commute.
...
```json
{
    "body": "<a id='comment:13'></a>Everything looks good.  This seems to catch all the issues with having the correct indices in k-Schur functions that I can find.  Thanks for coming back to this one.",
    "created_at": "2013-03-11T20:08:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208494",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:13'></a>Everything looks good.  This seems to catch all the issues with having the correct indices in k-Schur functions that I can find.  Thanks for coming back to this one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208495",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Thank you for doing the review.",
    "created_at": "2013-03-11T20:35:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208496",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:14'></a>Thank you for doing the review.
...
```json
{
    ...
    "milestone": "sage-5.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13743#event-38491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208498",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208499",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>This should be rebased to sage-5.8.rc0.",
    "created_at": "2013-03-14T08:10:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208500",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>This should be rebased to sage-5.8.rc0.
...
```json
{
    "body": "<a id='comment:18'></a>I've rebased to 5.8.rc0.\n\nApply: trac_13743-fix_kschur-ts.2.patch",
    "created_at": "2013-03-14T16:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208501",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:18'></a>I've rebased to 5.8.rc0.
...
```json
{
    "body": "<a id='comment:19'></a>It still doesn't apply properly, are you sure you have a clean build of sage-5.8.rc0?\n\n```\napplying /release/merger/patches/trac_13743-fix_kschur-ts.2.patch\npatching file sage/combinat/partition.py\nHunk #3 succeeded at 304 with fuzz 2 (offset -1 lines).\n```",
    "created_at": "2013-03-14T23:25:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208502",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>It still doesn't apply properly, are you sure you have a clean build of sage-5.8.rc0?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208503",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208504",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I am restoring positive review.  I had to recompile sage-5.8.rc0 to ensure that I didn't have a problem.  This patch now applies cleanly.",
    "created_at": "2013-03-16T16:05:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208505",
    "user": "https://github.com/zabrocki"
}
```

<a id='comment:20'></a>I am restoring positive review.  I had to recompile sage-5.8.rc0 to ensure that I didn't have a problem.  This patch now applies cleanly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208506",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13743#issuecomment-208507",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13743",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13743#event-38492"
}
```
