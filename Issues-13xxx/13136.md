...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13136#issuecomment-194270",
    "user": "https://trac.sagemath.org/admin/accounts/users/okazymyrov"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13136#issuecomment-194271",
    "user": "https://trac.sagemath.org/admin/accounts/users/okazymyrov"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Looks like a bug has been resolved. The previous code works fine on Mac OS X 10.8.4 with Sage 5.10.",
    "created_at": "2013-08-01T19:52:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13136#issuecomment-194272",
    "user": "https://trac.sagemath.org/admin/accounts/users/okazymyrov"
}
```

<a id='comment:1'></a>Looks like a bug has been resolved. The previous code works fine on Mac OS X 10.8.4 with Sage 5.10.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13136#event-36182"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13136#issuecomment-194273",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13136#issuecomment-194274",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13136#issuecomment-194275",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13136",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13136#event-36183"
}
```
