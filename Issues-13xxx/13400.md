...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172424",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Putting a print statement into the lazy attribute `_set_of_super_categories`, the command\n\n```\nN=20; matrix(QQ,N,N,srange(N*N)).echelon_form()\n```\nactually prints *nothing*. Hence, all the work for the subcategory test seems to be done in the `_subcategory_hook_` methods. So, we should focus on them.",
    "created_at": "2012-08-25T18:13:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172425",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Putting a print statement into the lazy attribute `_set_of_super_categories`, the command
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172426",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I just notice: Apparently in your example, the is_subcategory function is not the usual one (sage/categories/category.py), but the one in sage/categories/covariant_functorial_construction.py.\n\nIt says\n\n```python\n    def is_subcategory(self, C):\n        \"\"\"\n        .. todo:: doctests + explain why this method is needed\n        \"\"\"\n        if C is self:\n            return True\n        return any(X.is_subcategory(C) for X in self._super_categories)\n```\nActually I wonder why is it needed, myself.\n\nNicolas, is it not possible to use the default is_subcategory, by #11943?\n\nAnyway, I think the real speed-up will not come from is_subcategory, but from a more intelligent caching.",
    "created_at": "2012-08-25T19:23:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172429",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:9'></a>I just notice: Apparently in your example, the is_subcategory function is not the usual one (sage/categories/category.py), but the one in sage/categories/covariant_functorial_construction.py.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172433",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172436",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172437",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Attachment [trac_13400_subclass_hook_cython.patch](tarball://root/attachments/some-uuid/ticket13400/trac_13400_subclass_hook_cython.patch) by @simon-king-jena created at 2012-08-26 22:05:27\n\nCythonise _subcategory_hook_. Experimental, and a bit off-topic",
    "created_at": "2012-08-26T22:05:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172444",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [trac_13400_subclass_hook_cython.patch](tarball://root/attachments/some-uuid/ticket13400/trac_13400_subclass_hook_cython.patch) by @simon-king-jena created at 2012-08-26 22:05:27
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172447",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172449",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172452",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172453",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Attachment [trac_13400_cache_small_rings.patch](tarball://root/attachments/some-uuid/ticket13400/trac_13400_cache_small_rings.patch) by @simon-king-jena created at 2012-08-28 07:19:08\n\nProvide a short-cut for the creation of ideals in ZZ",
    "created_at": "2012-08-28T07:19:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172454",
    "user": "https://github.com/simon-king-jena"
}
```

Attachment [trac_13400_cache_small_rings.patch](tarball://root/attachments/some-uuid/ticket13400/trac_13400_cache_small_rings.patch) by @simon-king-jena created at 2012-08-28 07:19:08
...
```json
{
    "body": "<a id='comment:32'></a>Attachment [trac_13400_quick_ZZ_ideal.patch](tarball://root/attachments/some-uuid/ticket13400/trac_13400_quick_ZZ_ideal.patch) by @simon-king-jena created at 2012-08-28 07:22:13\n\nI have updated the last two of my patches. The doctests should all pass with them.",
    "created_at": "2012-08-28T07:22:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13400#issuecomment-172455",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:32'></a>Attachment [trac_13400_quick_ZZ_ideal.patch](tarball://root/attachments/some-uuid/ticket13400/trac_13400_quick_ZZ_ideal.patch) by @simon-king-jena created at 2012-08-28 07:22:13
