...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13400#event-158567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13400#event-158568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13400#event-158569"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13400#event-158570"
}
```
...
```json
{
    "body": "**Attachment:** [trac_13400_subclass_hook_cython.patch.gz](https://github.com/sagemath/sage/files/ticket13400/trac_13400_subclass_hook_cython.patch.gz)\n\nCythonise _subcategory_hook_. Experimental, and a bit off-topic",
...
**Attachment:** [trac_13400_subclass_hook_cython.patch.gz](https://github.com/sagemath/sage/files/ticket13400/trac_13400_subclass_hook_cython.patch.gz)
...
```json
{
    "body": "**Attachment:** [trac_13400_cache_small_rings.patch.gz](https://github.com/sagemath/sage/files/ticket13400/trac_13400_cache_small_rings.patch.gz)\n\nProvide a short-cut for the creation of ideals in ZZ",
...
**Attachment:** [trac_13400_cache_small_rings.patch.gz](https://github.com/sagemath/sage/files/ticket13400/trac_13400_cache_small_rings.patch.gz)
...
```json
{
    "body": "<a id='comment:32'></a>\n**Attachment:** [trac_13400_quick_ZZ_ideal.patch.gz](https://github.com/sagemath/sage/files/ticket13400/trac_13400_quick_ZZ_ideal.patch.gz)\n\nI have updated the last two of my patches. The doctests should all pass with them.",
