...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162794",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162795",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162796",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162797",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162798",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162799",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162800",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162801",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162802",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162803",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162804",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162805",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162806",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162807",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162808",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket13675/13675_add_inversemod_method.patch",
    "created_at": "2012-11-06T00:01:25Z",
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13675/13675_add_inversemod_method.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>\nAttachment [13675_add_inversemod_method.patch](https://github.com/sagemath/sage/files/ticket13675/13675_add_inversemod_method.patch) by Bouillaguet created at 2012-11-06 00:01:25\n\nReplying to [mstreng](#comment%3A12):\n> You fixed the output of a test for `__invert__` in quotient_ring_element.py, but actually the whole test is incorrect.\n> \n> The element x mod `(x<sup>2+y</sup>2)` has no inverse, and this is not because \"extending the base field is implemented yet\" as claimed in quotient_ring_element.py, neither is it because \"extending the base field is *not* implemented yet\". This element has no inverse, even if the base field is extended. This element is simply not invertible. Could you remove the words \"`, and extending the base field is implemented yet`\"?\n\n\nDone. The incriminated doctest was here from before... and the culprit is... #9500.",
    "created_at": "2012-11-06T00:01:25Z",
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162809",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162810",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162811",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13675#issuecomment-162812",
