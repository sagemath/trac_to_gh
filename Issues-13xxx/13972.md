...
<a id='comment:4'></a>Replying to [zabrocki](#comment%3A1):
...
<a id='comment:9'></a>Replying to [zabrocki](#comment%3A5):
> Doesn't that require #11641 to add combinatorial decorator?
