...
```json
{
    "body": "<a id='comment:30'></a>\nI pushed the rebased branch (only whitespace errors apparently). The error mentioned about complex numbers is not introduced by the plot code.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[4193ca4](http://git.sagemath.org/sage.git/commit/?id=4193ca40b72511064c5f71e451308cac4de2fd1d)|`This patch fixes two things, both related to exclusion of invalid plot points.`|\n|[c31f63e](http://git.sagemath.org/sage.git/commit/?id=c31f63ed3860dbf2368ed17b3f54d8dd0ebf0331)|`fix parametric plots that fail due to invalid plot points`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|\n|[a18bf04](http://git.sagemath.org/sage.git/commit/?id=a18bf04b889e2b65fc5af0753fe2f094073d7663)|`Merge branch 'develop' into t/13246/automatic_exclusion_of_non_domain_points_in_things_like_arcsec`|\n|[b34ee39](http://git.sagemath.org/sage.git/commit/?id=b34ee393ad0e55dea7b6a384eb7d96ca2d059c11)|`allow some trigonometric functions to take complex as input`|\n|[c4ba30d](http://git.sagemath.org/sage.git/commit/?id=c4ba30d802f932b29205ec3f49f3eeeeb0942e76)|`add couple of doctests for complex input`|\n|[dd2ac84](http://git.sagemath.org/sage.git/commit/?id=dd2ac84bf4068aefae5b1d5985c3982fe593b4e2)|`Merge branch 't/16439/allow_inverse_trig_functions_to_all_take_complex_input' into t/13246/automatic_exclusion_of_non_domain_points_in_things_like_arcsec`|\n|[148aafb](http://git.sagemath.org/sage.git/commit/?id=148aafbc155f5fceb9f156a725067e1b9f5c5436)|`add more doctests for auto exclusion functionality`|",
...
```json
{
    "body": "<a id='comment:47'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[a01095e](http://git.sagemath.org/sage.git/commit/?id=a01095ea161f0adae68692c67174771232c80675)|`fix latex according to reviewer comments`|",
    "created_at": "2014-06-17T12:55:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13246",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:54'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[5c7fb75](http://git.sagemath.org/sage.git/commit/?id=5c7fb75e184b2e034d53acf1807c58e2165ac7d0)|`do not use exclude both as list and as None`|",
    "created_at": "2014-06-18T06:39:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13246",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:56'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[b90cb76](http://git.sagemath.org/sage.git/commit/?id=b90cb76eb10225c28257081feafdd4bb3effbd40)|`sort and reverse the excluded_points in one command`|",
...
```json
{
    "body": "<a id='comment:57'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[e79bdb8](http://git.sagemath.org/sage.git/commit/?id=e79bdb8e73d8ebdca5cb6782ca1e4ae7cd17b96e)|`fix parametric and polar plots if exclude point is outside the domain`|",
    "created_at": "2014-06-20T09:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13246",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:64'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[384b5a2](http://git.sagemath.org/sage.git/commit/?id=384b5a23011b43380be2c434e2487121aaa7dea8)|`catch TypeError after #16439 is applied`|",
    "created_at": "2014-06-22T07:45:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13246",
    "type": "issue_comment",
