...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13246#event-169027"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13246#event-169028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13246#event-169029"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -41,5 +41,7 @@\n \n Anyway, it's at least doable in principle, but would take some time and care to implement, making sure it didn't cause any other regressions.\n \n- \n+---\n \n+Apply [attachment: trac_13246-automatic-exclusion.patch.gz](https://github.com/sagemath/sage/files/ticket13246/trac_13246-automatic-exclusion.patch.gz) to devel/sage\n+\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13246",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13246#issuecomment-155172",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13246",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13246#issuecomment-155173",
    "user": "https://github.com/vbraun"
}
```
