...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152032",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152033",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152034",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152035",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152036",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket13119/trac_13119_apply_module_morphism_bugfix-mz.patch",
    "created_at": "2012-12-17T15:30:51Z",
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket13119/trac_13119_apply_module_morphism_bugfix-mz.patch",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac_13119_apply_module_morphism_bugfix-mz.patch](https://github.com/sagemath/sage/files/ticket13119/trac_13119_apply_module_morphism_bugfix-mz.patch) by @zabrocki created at 2012-12-17 15:30:51\n\nHi Travis,\nThanks for picking this up.  I made your changes and caught one or two more fixes in the docstring.\n-Mike",
    "created_at": "2012-12-17T15:30:51Z",
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152037",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152038",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13119#issuecomment-152039",
