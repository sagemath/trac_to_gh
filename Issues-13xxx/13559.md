...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204115",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204117",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>> > FYI, the change to loglog/semilog* scale happens only during the very end when `show()` is called. This happens *after* the generation of the plot points.\n\n> \n> Really??? Ouch! In a x log scale one certainly would want to disperse ploting points differently.\n\nTrue, but that would be another ticket.  And sometimes one would want to plot the same data in two different ways, so we wouldn't want to remove that entirely.",
    "created_at": "2012-10-04T15:39:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204118",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>> > FYI, the change to loglog/semilog* scale happens only during the very end when `show()` is called. This happens *after* the generation of the plot points.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204119",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204120",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204123",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204124",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13559#event-37719"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#15030\"",
    "created_at": "2013-09-14T15:04:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204125",
    "user": "https://github.com/ppurka"
}
```

Changing dependencies from "" to "#15030"
...
```json
{
    "body": "<a id='comment:11'></a>The solution of this ticket depends on #15030 and [this ask.sagemath](http://ask.sagemath.org/question/3001/contour_plot-issue-with-large-numbers) thread.\n\nHow? I suppose we can introduce a plot keyword `precision=53` that gets passed on to `fast_callable` and one can increase that to get higher precision but slower plots.",
    "created_at": "2013-09-14T15:04:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/13559",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13559#issuecomment-204126",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:11'></a>The solution of this ticket depends on #15030 and [this ask.sagemath](http://ask.sagemath.org/question/3001/contour_plot-issue-with-large-numbers) thread.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13559#event-37720"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13559#event-37721"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13559#event-37722"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13559#event-37723"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13559#event-37724"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13559#event-37725"
}
```
