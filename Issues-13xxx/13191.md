...
```json
{
    "body": "<a id='comment:8'></a>\n**Attachment:** [trac_13191_auto_fan_2d.patch](https://github.com/sagemath/sage/files/ticket13191/trac_13191_auto_fan_2d.patch)",
    "created_at": "2012-07-08T16:38:51Z",
    "issue": "https://github.com/sagemath/sage/issues/13191",
    "type": "issue_comment",
...
archive/attachments_018448.json:
```json
{
    "asset_content_type": "application/octet-stream",
