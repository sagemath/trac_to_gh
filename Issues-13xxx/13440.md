...
```json
{
    ...
    "body": "Adding reverse_edge() function to DiGraph\n\nApply:\n\n*  [attachment: trac_13440-reverse-edge.patch](https://github.com/sagemath/sage/files/ticket13440/trac_13440-reverse-edge.patch.gz)\n*  [attachment: trac_13440-review.patch](https://github.com/sagemath/sage/files/ticket13440/trac_13440-review.patch.gz)\n*  [attachment: trac_13440-second-review.patch](https://github.com/sagemath/sage/files/ticket13440/trac_13440-second-review.patch.gz)\n\nCC:  @sagetrac-gmoose05 @dcoudert @nathanncohen\n\nKeywords: **digraph, sd40**\n\nReviewer: **Gregg Musiker, Nathann Cohen**\n\nAuthor: **Emily Gunawan**\n\nMerged: **sage-5.8.beta0**\n\nComponent: **graph theory**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/13440_\n\n",
    ...
    "type": "issue",
    "updated_at": "2013-06-01T20:46:40Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186019"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186022"
}
```
...
```json
{
    ...
    "event": "assigned",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "subject": "https://github.com/egunawan",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186023"
}
```
...
```json
{
    ...
    "subject": "https://github.com/egunawan",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186024"
}
```
...
```json
{
    ...
    "subject": "https://github.com/egunawan",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186025"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156829",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    "body": "Attachment: **[trac13440-reverse-edge.patch.gz](https://github.com/sagemath/sage/files/ticket13440/trac13440-reverse-edge.patch.gz)**",
    "created_at": "2012-11-29T03:37:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156830",
    "user": "https://github.com/egunawan"
}
```

Attachment: **[trac13440-reverse-edge.patch.gz](https://github.com/sagemath/sage/files/ticket13440/trac13440-reverse-edge.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156831",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186026"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156832",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156833",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156834",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    "body": "Attachment: **[trac_13440-rev_edge-gm.patch.gz](https://github.com/sagemath/sage/files/ticket13440/trac_13440-rev_edge-gm.patch.gz)**",
    "created_at": "2012-11-30T05:32:31Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156835",
    "user": "https://github.com/sagetrac-gmoose05"
}
```

Attachment: **[trac_13440-rev_edge-gm.patch.gz](https://github.com/sagemath/sage/files/ticket13440/trac_13440-rev_edge-gm.patch.gz)**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186027"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186030"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n Adding reverse_edge() function to DiGraph (related to #7720)\n \n-Apply third patch only.\n+Apply:\n+\n+*  [attachment: trac_13440-rev_edge-gm.patch](https://github.com/sagemath/sage/files/ticket13440/trac_13440-rev_edge-gm.patch.gz)\n``````\n",
    "created_at": "2012-12-01T16:44:48Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156836",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156837",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156838",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    "body": "Changed reviewer from **gmoose05** to **Gregg Musiker**",
    "created_at": "2012-12-01T18:07:32Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156839",
    "user": "https://github.com/sagetrac-gmoose05"
}
```

Changed reviewer from **gmoose05** to **Gregg Musiker**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156840",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156841",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156842",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156843",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    "body": "<div id=\"comment:12\" align=\"right\">comment:12</div>\n\nAttachment: **[trac_13440-rev_edge-gm.gz](https://github.com/sagemath/sage/files/ticket13440/trac_13440-rev_edge-gm.gz)**",
    "created_at": "2013-01-17T03:37:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156844",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156845",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156846",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156848",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156849",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186034"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156850",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186036"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156851",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156852",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156853",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156854",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156855",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156856",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156857",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156858",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156859",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156860",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156861",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    "body": "<div id=\"comment:30\" align=\"right\">comment:30</div>\n\nAttachment: **[trac_13440-reverse-edge.patch.gz](https://github.com/sagemath/sage/files/ticket13440/trac_13440-reverse-edge.patch.gz)**\n\nModified reverse_edge and reverse_edges methods per Nathann's comments \nhttps://github.com/sagemath/sage/issues/13440#comment:29",
    "created_at": "2013-02-11T06:08:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156862",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186044"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156863",
    "user": "https://github.com/egunawan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156864",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Changed reviewer from **Gregg Musiker** to **Gregg Musiker, Nathann Cohen**",
    "created_at": "2013-02-12T12:39:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156865",
    "user": "https://github.com/nathanncohen"
}
```

Changed reviewer from **Gregg Musiker** to **Gregg Musiker, Nathann Cohen**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156866",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156867",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Attachment: **[trac_13440-second-review.patch.gz](https://github.com/sagemath/sage/files/ticket13440/trac_13440-second-review.patch.gz)**",
    "created_at": "2013-02-14T03:07:29Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156869",
    "user": "https://github.com/sagetrac-gmoose05"
}
```

Attachment: **[trac_13440-second-review.patch.gz](https://github.com/sagemath/sage/files/ticket13440/trac_13440-second-review.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156870",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156871",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156872",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186046"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156873",
    "user": "https://github.com/sagetrac-gmoose05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156874",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186047"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186048"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156875",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13440#event-186050"
}
```
...
```json
{
    "body": "Changed keywords from **digraph** to **digraph, sd40**",
    "created_at": "2013-06-01T20:46:40Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/13440",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13440#issuecomment-156876",
    "user": "https://github.com/sagetrac-gmoose05"
}
```

Changed keywords from **digraph** to **digraph, sd40**
