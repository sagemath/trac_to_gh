...
```json
{
    "body": "<a id='comment:9'></a>Replying to [jtremblay](#comment%3A8):\n> The patch worked for me.\n\n\nThe patch or the spkg ? On which machine ?",
...
<a id='comment:9'></a>Replying to [jtremblay](#comment%3A8):
> The patch worked for me.
...
<a id='comment:11'></a>Replying to [jtremblay](#comment%3A10):
> The spkg, on OSX 10.7.3 with Sage 5.2 binaries.
...
<a id='comment:13'></a>Replying to [jtremblay](#comment%3A12):
> Apparently not, zmq was not installed when I tried installing pyzmq :
