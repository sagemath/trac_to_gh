...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58622",
    "user": "was"
}
```
...
```json
{
    "body": "Major progress -- a lot of problems appear to just \"go away\" when using GCC-4.0.x!  In particular, the above issue with \"Abort Trap\" goes away.  The main problem is that some of the fixes I put in for OS X 10.6 with GCC-4.2.x actually break the 4.0.x build....  anyway, I'm very optimistic for a complete resolution to the problem of building Sage on OS X 10.6 using GCC 4.0.x.",
    "created_at": "2009-10-07T17:00:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58625",
    "user": "was"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58626",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "The `factorial(factorial(x))` error above is really from `factorial(CIF(1))` which leads to the same error.  Combining this with  fwclarke's remark above, suggests complex interval fields are somehow the one place where things are broken somehow.",
    "created_at": "2009-10-11T01:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58628",
    "user": "was"
}
```
...
```json
{
    "body": "Since we still have no clue, I'm targeting this for 4.3.",
    "created_at": "2009-11-11T17:44:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58631",
    "user": "was"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58635",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "See #7022 for perhaps the same matplotlib issue.",
    "created_at": "2009-12-21T17:44:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58637",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58638",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58639",
    "user": "was"
}
```
...
```json
{
    "body": "I'm declaring a total feature freeze on sage-4.3.  Also, this is clearly not a blocker for making a release so I changed it to critical.",
    "created_at": "2009-12-24T07:07:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58640",
    "user": "was"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58641",
    "user": "was"
}
```
...
```json
{
    "body": "> By the way, with an ordinary (gcc 4.2.1) build of 4.3.1.alpha0, I'm now getting over 90 files with failures\n\nI'm seeing this on one OS X 10.6 machine, but not another one, so I'm confused...\n\n> I don't know if this Intel compiler takes the same options as gcc, but I suspect it would.  http://software.intel.com/en-us/articles/intel-software-development-products-for-mac-os-x/ You can get a free trial.\n\nUnfortunately, for OS X, I only see a C++ compiler, not a C compiler.",
    "created_at": "2010-01-06T03:01:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58644",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58645",
    "user": "was"
}
```
...
```json
{
    "body": "You're right.  I replaced the file \".matplotlib/fontList.cache\" on the broken machine with the one from the working machine, and now more doctests pass.  (I haven't run the full doctesting suite, but I'll do that next.)",
    "created_at": "2010-01-06T04:11:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58646",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "This webpage could be very, very helpful:   http://blog.hyperjeff.net/?p=160\n   \nThe guy claims to be able to get numpy+scipy+matplotlib to actually work from source on Snow Leopard (OS X 10.6)!\n\nWilliam",
    "created_at": "2010-01-06T04:15:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58647",
    "user": "was"
}
```
...
```json
{
    "body": "See #7856 for a new matplotlib spkg.",
    "created_at": "2010-01-06T17:59:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58651",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58654",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "I should have said I don't use OS X a lot. I do sometimes test on bsd.math, but I don't own a Mac.",
    "created_at": "2010-01-08T02:53:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58655",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58657",
    "user": "craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58658",
    "user": "craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58659",
    "user": "craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58661",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58662",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "For what it's worth, the following article provides some information on the \"clever\" trickery:\n\nhttp://developer.apple.com/mac/library/releasenotes/Darwin/SymbolVariantsRelNotes/",
    "created_at": "2010-01-14T22:57:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58663",
    "user": "GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58664",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58666",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58667",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "Yes you are correct, the *if-else-fi* should take care of that. Don't bother about my name. I can live with that error!",
    "created_at": "2010-01-15T01:37:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58668",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58670",
    "user": "rlm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58671",
    "user": "rlm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58673",
    "user": "rlm"
}
```
...
```json
{
    "body": "When we transition from Python 2.6.2 to 2.6.4, do we need to maintain the patch numbering?  2.6.4.p3 contains all of the patches from 2.6.2.p5.",
    "created_at": "2010-01-16T05:50:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58674",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58675",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58676",
    "user": "rlm"
}
```
...
```json
{
    "body": "Oh! I didn't realize you upgraded Python also, I just saw the p*'s.",
    "created_at": "2010-01-16T05:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58677",
    "user": "rlm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58678",
    "user": "GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58680",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58681",
    "user": "GeorgSWeber"
}
```
...
```json
{
    "body": "Update: The scipy spkg has the same problem (with the same solution) as the numpy spkg.",
    "created_at": "2010-01-16T22:44:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58682",
    "user": "GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58683",
    "user": "craigcitro"
}
```
...
```json
{
    "body": "Since I'd made a major update to sage-env which went wrong, as setting CFLAGS had an inadvertant side effect, I'd like to change to do what it does now, but not export CFLAGS, CXXFLATS etc. \n\nI can easily tac those on at the same time. And rolls that out as a refinement of #7817. \n\nI can do that tonight if you want. \n\nDave",
    "created_at": "2010-01-17T01:04:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58684",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "Well, I'd like this to get into the next rc, and it sounds like #7818 may get pushed to the next release for more serious testing. So I'd like to go ahead and get something pushed for this ticket ...",
    "created_at": "2010-01-17T01:06:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58685",
    "user": "craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58686",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58687",
    "user": "craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58688",
    "user": "craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58689",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "No sweat -- I actually didn't know there was a second copy. (Does sdist and/or bdist do something where it copies the one from local/bin into spkg/base when making a tarball? If not, someone should file an enhancement ticket ...)",
    "created_at": "2010-01-17T18:37:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58690",
    "user": "craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58691",
    "user": "craigcitro"
}
```
...
```json
{
    "body": "The sage-env in local/bin does not start there - it gets copied there from spkg/base\n\nDave",
    "created_at": "2010-01-17T18:43:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58692",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58693",
    "user": "GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58694",
    "user": "GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58695",
    "user": "rlm"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/7095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7095#issuecomment-58696",
    "user": "rlm"
}
```
