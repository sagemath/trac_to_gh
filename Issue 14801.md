...
```json
{
    "body": "Attachment [trac15038-postpone_argspec_of_cached_functions.patch](tarball://root/attachments/some-uuid/ticket15038/trac15038-postpone_argspec_of_cached_functions.patch) by SimonKing created at 2013-08-12 14:25:43\n\nIt seems to me that I observe a decrease of startup time of 4 or 5 percent with my patch, but I'd like to know whether the patchbots confirm this.",
...
Attachment [trac15038-postpone_argspec_of_cached_functions.patch](tarball://root/attachments/some-uuid/ticket15038/trac15038-postpone_argspec_of_cached_functions.patch) by SimonKing created at 2013-08-12 14:25:43
