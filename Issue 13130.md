...
```
sage: MatrixSpace(Qp(3),1)([This is the Trac macro *Qp* that was inherited from the migration called with arguments (3).zero)](https://trac.sagemath.org/wiki/WikiMacros#Qp-macro))
[0]
sage: MatrixSpace(Qp(3),1,1)([This is the Trac macro *Qp* that was inherited from the migration called with arguments (3))](https://trac.sagemath.org/wiki/WikiMacros#Qp-macro))
[3^-1 + 1 + O(3^19)]
```
