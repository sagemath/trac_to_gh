...
```json
{
    "body": "Attachment [pip8-patch-parallel-install.log.gz](tarball://root/attachments/some-uuid/ticket21835/pip8-patch-parallel-install.log.gz) by charpent created at 2016-11-07 19:10:04\n\nFailed parallel build log with pip 8 and #21812.",
...
Attachment [pip8-patch-parallel-install.log.gz](tarball://root/attachments/some-uuid/ticket21835/pip8-patch-parallel-install.log.gz) by charpent created at 2016-11-07 19:10:04
...
```json
{
    "body": "Attachment [pip8-patch-parallel-singular-4.0.3p3.log](tarball://root/attachments/some-uuid/ticket21835/pip8-patch-parallel-singular-4.0.3p3.log) by charpent created at 2016-11-07 19:13:13\n\nLog of failed Singular build with pip8, #21812 and parallel building",
...
Attachment [pip8-patch-parallel-singular-4.0.3p3.log](tarball://root/attachments/some-uuid/ticket21835/pip8-patch-parallel-singular-4.0.3p3.log) by charpent created at 2016-11-07 19:13:13
...
```json
{
    "body": "Attachment [pip8-patch-serial-ptestlong.log.gz](tarball://root/attachments/some-uuid/ticket21835/pip8-patch-serial-ptestlong.log.gz) by charpent created at 2016-11-07 19:16:30\n\nptestlong log with pip 8 and #21812 exhibiting the desired result (no spurious doctest failures)",
...
Attachment [pip8-patch-serial-ptestlong.log.gz](tarball://root/attachments/some-uuid/ticket21835/pip8-patch-serial-ptestlong.log.gz) by charpent created at 2016-11-07 19:16:30
...
```json
{
    "body": "Attachment [pip9-nopatch-ptestlong.log](tarball://root/attachments/some-uuid/ticket21835/pip9-nopatch-ptestlong.log) by charpent created at 2016-11-07 19:18:31\n\nptestlong log with pip 9 (manuallu upgraded), without #21812 : spurios doctest failures caused by \"Deprecation\" messages from pip.",
...
Attachment [pip9-nopatch-ptestlong.log](tarball://root/attachments/some-uuid/ticket21835/pip9-nopatch-ptestlong.log) by charpent created at 2016-11-07 19:18:31
...
```json
{
    "body": "Attachment [pip9-patch-ptestlong.log](tarball://root/attachments/some-uuid/ticket21835/pip9-patch-ptestlong.log) by charpent created at 2016-11-07 19:20:31\n\nptestlong log obtained with pip9 (manually upgraded) and #21812, showing the spurious doctest failures due to \"Deprecation\" pip complaints not fixed by #21812.",
...
Attachment [pip9-patch-ptestlong.log](tarball://root/attachments/some-uuid/ticket21835/pip9-patch-ptestlong.log) by charpent created at 2016-11-07 19:20:31
