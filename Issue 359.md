...
```json
{
    "body": "See #6973 (use SVG or canvas).",
    "created_at": "2010-03-29T21:14:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/359#issuecomment-1726",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/359#issuecomment-1727",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/359",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/359#event-843"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/359#event-844"
}
```
