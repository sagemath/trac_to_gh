...
Expected:
    [1,
     ...
     6128487/10351,
     [1],
     [This is the Trac macro *128, -1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#128, -1-macro),
     [0, 0, 0, 0, 0, 0, 0, 0]]
Got:
    [1,
     2,
     ...
     6128487/10351,
     [1],
     [This is the Trac macro *96, -1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#96, -1-macro),
     [0, 0, 0, 0, 0, 0, 0, 0]]
**********************************************************************
1 item had failures:
