...
```json
{
    "body": "Blindly doing `save(x.sage(),\"blah\")` is not quite right, as this would e.g. break saving/loading Python objects (something that works just fine).\n\nIdeas?",
    "created_at": "2015-07-03T10:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253081",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253082",
...
```json
{
    "body": "Or perhaps one should do a compromise: If `self.sage()` throws an error, then we should try if the string representation is good enough to reconstruct the object. If it does then use it, otherwise throw an error upon pickling.\n\nIt would be better than nothing. But it could be quite costly to first check, for each interface element to be pickled, if the string representation is good enough.",
    "created_at": "2015-07-03T10:41:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253083",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "PPPS: Both Singular and GAP can dump a complete session. I don't know if that has been wrapped in Sage's interface. But it could be useful for some. Not for pickling individual objects, though.",
    "created_at": "2015-07-03T11:01:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253085",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253086",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253087",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253088",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Something totally different: Why is there a `.save()` and `.dumps()` method? Since `__reduce__` is implemented, `save(Foo, \"bar\")` would be the recommended way to store `Foo` in \"bar.sobj\", and `Foo.save(\"bar\")` isn't really adding anything. Can we deprecate these methods?",
    "created_at": "2015-07-03T12:28:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253089",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253090",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253092",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253093",
...
```json
{
    "body": "What I don't understand is why Lisp interface does not suffer from this issue:\n\n```\nsage: x=lisp(1)\nsage: x\n1\nsage: type(x)\n<class 'sage.interfaces.lisp.LispElement'>\nsage: x.save(\"/tmp/foo\")\nsage: load(\"/tmp/foo\")\n1\nsage: y=load(\"/tmp/foo\")\nsage: y==x\nTrue\n```\n\nAnd in fact `/tmp/foo.sobj` is loadable in a fresh Sage session.",
    "created_at": "2015-07-04T15:20:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253095",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253098",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "There were tests to be fixed. Actually one of the failing tests tried to make sure that the unpickled element is invalid...\n----\nNew commits:",
    "created_at": "2015-07-04T17:21:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253099",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "I am just wondering: Should we perhaps get rid of `reduce_load`? After all, an interface is callable, and hence there is no need to have a function that calls the interface when we can do it directly.",
    "created_at": "2015-07-04T18:34:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253100",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253101",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253102",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253103",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253104",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253105",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253106",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "I guess it would be better to ask on sage-nt or sage-algebra, since it appears to be about elliptic curves.",
    "created_at": "2015-07-09T09:22:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253107",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "PS: Or even better, we should just replace the test by \n\n```\nsage: E = gp('ellinit([1,2,3,4,5])')\nsage: loads(dumps(E)) == E\nTrue\n```\n\nI'll commit and push it now.",
    "created_at": "2015-07-09T09:37:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253109",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253110",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253111",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253112",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253113",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253114",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/18611#issuecomment-253115",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/18611",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/18611#event-17797"
}
```
