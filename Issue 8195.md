...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-72274",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "Oops, I forgot to put braces around the commands. \n\n\n```\n$ p7zip -d sage-....tar.7z (if you used the recommended .7z file) \n$ gzip -d sage-....tar.gz (if you downloaded the larger .gz file) \n```\n\nSun's version of tar will not extract the binaries, so use the GNU tar. \n\n```\n$ /usr/sfw/bin/gtar xf sage-..tar \n$ LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/sfw/lib \n$ export LD_LIBRARY_PATH\n\nChange to the directory where the files were extract, then run\n\n$ ./sage",
    "created_at": "2010-02-05T23:34:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-72275",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-72277",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-72278",
    "user": "drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/8195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8195#issuecomment-72280",
    "user": "drkirkby"
}
```
...
```json
{
    "body": "Sage 5.0 \"almost works\" on Solaris SPARC (it builds but there are a few doctest errors) and it works fully on OpenSolaris i386.  See [SupportedPlatforms](http://wiki.sagemath.org/SupportedPlatforms).  Currently, we don't build (Open)Solaris binaries on the buildbot.  Should this be changed?",
