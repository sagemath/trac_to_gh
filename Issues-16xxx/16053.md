...
```json
{
    "body": "+1 on bundling pyzmq and tornado.",
...
```json
{
    "body": "We already build tornado, since matplotlib uses it.",
...
```json
{
    "body": "Ticket #16455 updates zeromq and pyzmq to latest version and new git layout, so if they become standard packages, IPython notebook will work out of the box within Sage.",
...
```json
{
    "body": "It seems this ticket became a duplicate of #16488.",
    "created_at": "2014-06-18T10:22:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16053",
    "type": "issue_comment",
