...
```json
{
    "body": "<a id='comment:1'></a>Attachment [singular-3.1.6-fix_mpoly_factor_segfault.patch](tarball://root/attachments/some-uuid/ticket16462/singular-3.1.6-fix_mpoly_factor_segfault.patch) by @nexttime created at 2014-06-09 18:54:48",
    "created_at": "2014-06-09T18:54:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16462",
    "type": "issue_comment",
...
<a id='comment:1'></a>Attachment [singular-3.1.6-fix_mpoly_factor_segfault.patch](tarball://root/attachments/some-uuid/ticket16462/singular-3.1.6-fix_mpoly_factor_segfault.patch) by @nexttime created at 2014-06-09 18:54:48
...
```json
{
    "body": "<a id='comment:2'></a>Haven't added a corresponding doctest [yet]; the given test case is pretty lengthy...\n\n(Feel free to add one. `:P`)\n\n---\nNew commits:",
    "created_at": "2014-06-09T19:25:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16462",
    "type": "issue_comment",
...
<a id='comment:2'></a>Haven't added a corresponding doctest [yet]; the given test case is pretty lengthy...
...
```json
{
    "body": "<a id='comment:3'></a>Oooops...  (Fixed URL of upstream bug report.)",
...
<a id='comment:3'></a>Oooops...  (Fixed URL of upstream bug report.)
...
```json
{
    "body": "<a id='comment:4'></a>We don't do the hand-maintained changelog any more, but doesn't really matter now",
...
<a id='comment:4'></a>We don't do the hand-maintained changelog any more, but doesn't really matter now
