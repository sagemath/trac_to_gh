...
```json
{
    "body": "(just updated the code above, there was an useless waste of time)",
...
```json
{
    "body": "Right ! Please set the ticket's status back to `needs_review` once it is ready again !\n\nNathann\n\n---\nNew commits:",
...
```json
{
    "body": "If you agree with the code, you can set the ticket to `needs_review`. The \"procedure\" is : I reviewed your changes, you reviewed mine, so it is good to go.\n\nNathann\n\n---\nNew commits:",
    "created_at": "2014-05-15T12:08:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16246",
    "type": "issue_comment",
