...
<a id='comment:19'></a>Replying to [brett](#comment%3A18):
> As suggestedin the developers guide, I just ran 
> 
> 
> 
...
<a id='comment:20'></a>Replying to [brett](#comment%3A17):
> To look at the new code for this patch, I updated master and develop.  Then I tried 
> 
> 
> ```
...
<a id='comment:23'></a>Replying to [brett](#comment%3A21):
...
<a id='comment:24'></a>Replying to [brett](#comment%3A22):
> Replying to [dimpase](#comment%3A20):
> > Replying to [brett](#comment%3A17):
> > > To look at the new code for this patch, I updated master and develop.  Then I tried 
> > > 
...
<a id='comment:34'></a>Replying to [brett](#comment%3A33):
> Does this data show that it is faster to simply do the multiplications?  
...
<a id='comment:42'></a>Replying to [brett](#comment%3A40):
> My plan is to produce a patch on top of this that [...]  does some small work on English and once I commit it and if you are OK with my changes we can finish with this patch.
...
<a id='comment:58'></a>Replying to [brett](#comment%3A56):
> your command worked but it creates a new branch and that is inoptimal
> 
> 
> ```
...
<a id='comment:59'></a>Replying to [dimpase](#comment%3A58):
...
<a id='comment:60'></a>Replying to [brett](#comment%3A54):
> The Sage developers guide says "git trac puch" not "git push trac"
