...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16006#event-47090"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16006#event-47091"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16006#event-47092"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16006#event-47093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16006#event-47094"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I'm assuming that this bug is obsolete.",
    "created_at": "2017-09-22T13:36:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16006#issuecomment-217812",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>I'm assuming that this bug is obsolete.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16006#issuecomment-217813",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16006",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16006#event-47095"
}
```
