...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266960",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Actually, I think I do have git installed systemwide. At least this works outside sage\n\n```\nlolita-4:/ anne$ git --version\ngit version 1.8.4.2\n```",
    "created_at": "2014-05-07T16:35:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266961",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:2'></a>Actually, I think I do have git installed systemwide. At least this works outside sage
...
```json
{
    "body": "<a id='comment:4'></a>I like the idea of adding a dash to the last line. That git command looks like a last resort anyway: the earlier part of the recipe deletes all of the autogenerated stuff. In the past, if someone did `sage --docbuild reference/junk html`, then it would create a directory `doc/en/reference/junk` (I think) which would then mess up later docbuilding, but this was fixed recently. I'm not sure how else we'd get anything that git would need to clean up.",
    "created_at": "2014-05-07T17:12:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266963",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>I like the idea of adding a dash to the last line. That git command looks like a last resort anyway: the earlier part of the recipe deletes all of the autogenerated stuff. In the past, if someone did `sage --docbuild reference/junk html`, then it would create a directory `doc/en/reference/junk` (I think) which would then mess up later docbuilding, but this was fixed recently. I'm not sure how else we'd get anything that git would need to clean up.
...
```json
{
    "body": "<a id='comment:5'></a>I like one-character fixes.",
    "created_at": "2014-05-07T17:26:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266964",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:5'></a>I like one-character fixes.
...
```json
{
    "body": "<a id='comment:6'></a>And while doing so doesn't fix anything related to docbuilding, it will indeed fix `make distclean` (in the cases where no system-wide `git` is available)... :-)",
    "created_at": "2014-05-07T17:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266965",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:6'></a>And while doing so doesn't fix anything related to docbuilding, it will indeed fix `make distclean` (in the cases where no system-wide `git` is available)... :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266966",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Haha, apparently actually Volker added that... XD",
    "created_at": "2014-05-07T17:51:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266967",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:9'></a>Haha, apparently actually Volker added that... XD
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266969",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266970",
...
```json
{
    "body": "<a id='comment:12'></a>I don't see any branch here, hence it has not been fixed. I'm fine with hiding the git error; if you can post code instead of comments then we can fix it ;-)",
    "created_at": "2014-06-01T17:10:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266971",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>I don't see any branch here, hence it has not been fixed. I'm fine with hiding the git error; if you can post code instead of comments then we can fix it ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266972",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>We could of course add `find . -name static -o -name templates -exec rm -rf {} \\;` (above the `[-]git clean ...`), but should we?",
    "created_at": "2014-06-01T17:50:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266973",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:14'></a>We could of course add `find . -name static -o -name templates -exec rm -rf {} \;` (above the `[-]git clean ...`), but should we?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266974",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>We certainly don't want to delete `common/themes/sage/static`, for example. But maybe \n\n```\nrm -rf common/static\nrm -rf en/*/static\nrm -rf en/*/templates\nrm -rf en/reference/*/static\nrm -rf en/reference/*/templates\n```\n?\n\nIn any case, it looks like these are empty directories, so I don't think their presence should break docbuilding.",
    "created_at": "2014-06-01T18:06:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266975",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>We certainly don't want to delete `common/themes/sage/static`, for example. But maybe 
...
```json
{
    "body": "<a id='comment:17'></a>Git does not try to remove empty directories when changing branches, but sphinx is sensitive to empty directories and they will break docbuilds.\n\nThere are various ways to clean up empty directories, but imho there is no portable and readable way in a shell script.",
    "created_at": "2014-06-01T18:07:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266976",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>Git does not try to remove empty directories when changing branches, but sphinx is sensitive to empty directories and they will break docbuilds.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266977",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266978",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266979",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>We could erase empty directories in `custom-sphinx-build.py`...",
    "created_at": "2014-06-01T19:28:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266980",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:21'></a>We could erase empty directories in `custom-sphinx-build.py`...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266981",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266984",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>`sage --docbuild reference html` is the second stage of the reference manual docbuild and works as long as you have a pre-built intersphinx inventory. If you don't you need to run the first stage, that is, `sage --docbuild reference inventory`, before that. If you think that is too complicated then you should stick to `make doc`.",
    "created_at": "2014-06-02T12:04:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266985",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:27'></a>`sage --docbuild reference html` is the second stage of the reference manual docbuild and works as long as you have a pre-built intersphinx inventory. If you don't you need to run the first stage, that is, `sage --docbuild reference inventory`, before that. If you think that is too complicated then you should stick to `make doc`.
...
```json
{
    "body": "Changing branch from \"\" to \"u/vbraun/sphnix_clean_empty_dirs\"",
    "created_at": "2014-06-02T12:21:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266986",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "" to "u/vbraun/sphnix_clean_empty_dirs"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266987",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"2118554d2c99f30350e7867aebe126da6fbb7236\"",
    "created_at": "2014-06-02T12:21:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266988",
    "user": "https://github.com/vbraun"
}
```

Changing commit from "" to "2118554d2c99f30350e7867aebe126da6fbb7236"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266989",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266990",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266991",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266992",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266993",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>(And I'd rather go with John's suggestion, as `make doc-clean` is supposed to clean up, *plus* perhaps the deletion in `builder.py` as well, although probably more could be done / checked there.)",
    "created_at": "2014-06-02T14:00:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266994",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:31'></a>(And I'd rather go with John's suggestion, as `make doc-clean` is supposed to clean up, *plus* perhaps the deletion in `builder.py` as well, although probably more could be done / checked there.)
...
```json
{
    "body": "Changing commit from \"2118554d2c99f30350e7867aebe126da6fbb7236\" to \"fe08e3f634d2cd76fb789e39fcbff4e784e87cbc\"",
    "created_at": "2014-06-02T14:01:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266995",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "2118554d2c99f30350e7867aebe126da6fbb7236" to "fe08e3f634d2cd76fb789e39fcbff4e784e87cbc"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266996",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266997",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Dear trac, I didn't make a new commit...\n\nBesides that, it's ok.  I still would do more in the `make` receipt.",
    "created_at": "2014-06-02T14:09:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266998",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:34'></a>Dear trac, I didn't make a new commit...
...
```json
{
    "body": "<a id='comment:35'></a>IMHO at least the `sage --docbuild reference html` error is spot-on, is says that it can't load the inventory.\n\nWith my patch there is no need to clean up empty directories from the `doc-clean` target, nor do we do that for any other `*-clean` target.",
    "created_at": "2014-06-02T14:17:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-266999",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:35'></a>IMHO at least the `sage --docbuild reference html` error is spot-on, is says that it can't load the inventory.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267000",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>The real issue is that the docs should be built under `SAGE_LOCAL`. \n\nTriple-safe is bullshit, do it once right.",
    "created_at": "2014-06-02T15:10:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267001",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:37'></a>The real issue is that the docs should be built under `SAGE_LOCAL`. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267002",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>P.S.:  John should be up soon; waiting for his opinion... (and of course those of any others)",
    "created_at": "2014-06-02T16:09:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267003",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:39'></a>P.S.:  John should be up soon; waiting for his opinion... (and of course those of any others)
...
```json
{
    "body": "<a id='comment:40'></a>I've been up for a while, actually. I tried (not very hard) to build the docs in `SAGE_LOCAL` but ran into problems. Is the issue moving just the output directory there, or also the other temporary directories (like `static` and `templates`) into `SAGE_LOCAL`?\n\nAnyway, I think the proposed change is fine, although I would also include `-git clean -f -d .` in the `Makefile` recipe.",
    "created_at": "2014-06-02T18:02:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267004",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:40'></a>I've been up for a while, actually. I tried (not very hard) to build the docs in `SAGE_LOCAL` but ran into problems. Is the issue moving just the output directory there, or also the other temporary directories (like `static` and `templates`) into `SAGE_LOCAL`?
...
```json
{
    "body": "<a id='comment:41'></a>I'm against independent code paths that depend on whether or not there is a system-wide git installed. That'll just be unnecessarily difficult to debug if it breaks. Do it once, and do it right.",
    "created_at": "2014-06-02T18:10:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267005",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:41'></a>I'm against independent code paths that depend on whether or not there is a system-wide git installed. That'll just be unnecessarily difficult to debug if it breaks. Do it once, and do it right.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267006",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:43'></a>There was a conflicting idea to build the Sage library in place, rather than copy it to `local/lib/python/site-package/sage`. I forget which ticket that is, but in any case, I'm not sure everyone agrees that \"ideally `src/` should be read-only ...\"",
    "created_at": "2014-06-02T18:43:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267007",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:43'></a>There was a conflicting idea to build the Sage library in place, rather than copy it to `local/lib/python/site-package/sage`. I forget which ticket that is, but in any case, I'm not sure everyone agrees that "ideally `src/` should be read-only ..."
...
```json
{
    "body": "<a id='comment:44'></a>Any news on reviewing this ticket?",
    "created_at": "2014-06-18T12:56:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267008",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:44'></a>Any news on reviewing this ticket?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267009",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267010",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267011",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>Well, as John P., I would have left the `git clean`, ignoring errors, but I don't care much.\n\nBetter than no fix....",
    "created_at": "2014-06-18T18:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267012",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:46'></a>Well, as John P., I would have left the `git clean`, ignoring errors, but I don't care much.
...
```json
{
    "body": "<a id='comment:47'></a>P.S.:  And Volker now has the necessary pence to work on a follow-up ticket for building the docs below `$SAGE_LOCAL/`...  Gl\u00fcckwunsch auch von mir!",
    "created_at": "2014-06-18T18:22:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267013",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:47'></a>P.S.:  And Volker now has the necessary pence to work on a follow-up ticket for building the docs below `$SAGE_LOCAL/`...  Glückwunsch auch von mir!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267014",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16303#event-48055"
}
```
...
```json
{
    "body": "Changing branch from \"u/vbraun/sphnix_clean_empty_dirs\" to \"fe08e3f634d2cd76fb789e39fcbff4e784e87cbc\"",
    "created_at": "2014-06-19T13:12:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16303#issuecomment-267015",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/vbraun/sphnix_clean_empty_dirs" to "fe08e3f634d2cd76fb789e39fcbff4e784e87cbc"
