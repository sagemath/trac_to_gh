...
<a id='comment:3'></a>I iterate over partitions `l` of `n` and construct a permutation representative by
...
<a id='comment:5'></a>Ah, so the description should have been something like:
...
```json
{
    "body": "<a id='comment:11'></a>Looks good to me. I tested it out for some examples and it seemed to work correctly. There seemed to be one small issue in the documentation for index_set() which I corrected.\n\n---\nNew commits:",
...
<a id='comment:11'></a>Looks good to me. I tested it out for some examples and it seemed to work correctly. There seemed to be one small issue in the documentation for index_set() which I corrected.
...
```json
{
    "body": "<a id='comment:12'></a>Thanks Amri. You're change is good with me.",
    "created_at": "2014-12-03T16:13:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16018",
    "type": "issue_comment",
...
<a id='comment:12'></a>Thanks Amri. You're change is good with me.
...
<a id='comment:13'></a>Doctests fail:
...
```json
{
    "body": "<a id='comment:16'></a>Trivial fixes.",
...
<a id='comment:16'></a>Trivial fixes.
