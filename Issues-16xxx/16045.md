...
```json
{
    "body": "minor remark: ticket #20887 also touches the polyhedron volume function",
...
```json
{
    "body": "If you merge commits from #20887 here you should set it as a dependency.",
...
```json
{
    "body": "Note that it's also defined for rational polytopes; and more generally for any (possibly irrational) translation of those.",
...
```json
{
    "body": "Use [# abs tol](https://github.com/sagemath/sage/blob/develop/src/sage/symbolic/integration/integral.py#L726) marker in the comment. See [Special Markup to Influence Doctests](http://doc.sagemath.org/html/en/developer/coding_basics.html#special-markup-to-influence-doctests) in the documentation.",
...
```json
{
    "body": "> The only way that sage accesses normaliz is via pynormaliz, so this is correct.\n\n\nMy bad, I confused both and only installed normaliz. Oh well...",
...
```json
{
    "body": "Thanks for the review, JP! I don't think we should put a dependency for the pynormaliz-set-thing.",
