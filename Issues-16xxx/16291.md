...
```json
{
    "body": "<a id='comment:3'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                          |                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[4e90074](https://github.com/sagemath/sagetrac-mirror/commit/4e90074d27dcb6a6f0f67a8f67c387b75aa6a0cc)|<code>Replace :meth:`list` by :meth:`__getitem__` in FormalCompositeMap</code>|",
...
```json
{
    "body": "<a id='comment:11'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                          |                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|\n|[cbbe0b3](https://github.com/sagemath/sagetrac-mirror/commit/cbbe0b36056b9eac2f18bad0d7ed582603f7cc06)|<code>Change `FormalMapComposition.tail` (former `.second`) to `.then`.</code>|",
    "created_at": "2014-06-02T13:38:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16291",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                          |                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[7bcc80d](https://github.com/sagemath/sagetrac-mirror/commit/7bcc80d4272fbe8b822524d9362145dda9f2e5da)|<code>Modify the name `FormalCompositeMap.head()` to `.first()`.</code>|",
