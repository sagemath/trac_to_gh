...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[b935593](http://git.sagemath.org/sage.git/commit/?id=b9355939dca87f7c362abfdc0998566417b7d5be)|`Correct the previous commit`|",
    "created_at": "2014-05-05T16:25:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16291",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[4e90074](http://git.sagemath.org/sage.git/commit/?id=4e90074d27dcb6a6f0f67a8f67c387b75aa6a0cc)|`Replace :meth:`list` by :meth:`__getitem__` in FormalCompositeMap`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[198085b](http://git.sagemath.org/sage.git/commit/?id=198085bda26743ebcb442f3b70698c3055395cd1)|`Depreciate first and second methods.`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[cbbe0b3](http://git.sagemath.org/sage.git/commit/?id=cbbe0b36056b9eac2f18bad0d7ed582603f7cc06)|`Change `FormalMapComposition.tail` (former `.second`) to `.then`.`|",
    "created_at": "2014-06-02T13:38:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16291",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[7bcc80d](http://git.sagemath.org/sage.git/commit/?id=7bcc80d4272fbe8b822524d9362145dda9f2e5da)|`Modify the name `FormalCompositeMap.head()` to `.first()`.`|",
