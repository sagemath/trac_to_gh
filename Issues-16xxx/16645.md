...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[2c5f58b](http://git.sagemath.org/sage.git/commit/?id=2c5f58bd16352a82c7c7b9ad6f1c17cd86a33571)|`Avoid unneccessary qualification of tmp_filename in doctests.`|",
