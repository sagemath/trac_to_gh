...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[596e59a](http://git.sagemath.org/sage.git/commit/?id=596e59a597b3f8e499f604f7bd50393e08f83a07)|`#16434 : use $SAGE_ROOT instead of ../../../../`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[e0a214c](http://git.sagemath.org/sage.git/commit/?id=e0a214cc3324d36a5b87b6969acacc806c5427df)|`#16434 files in tarball are in a d3js-$VERSION subdirectory`|",
    "created_at": "2014-06-05T10:03:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16434",
    "type": "issue_comment",
