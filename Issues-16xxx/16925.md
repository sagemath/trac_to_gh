...
```json
{
    "body": "I have a request. Could you add the fact that `SymmetricGroup.algebra() != SymmetricGroupAlgebra` to the doc, along with an explanation of how to get the `SymmetricGroupAlgebra`? Thanks.\n\n---\nNew commits:",
...
```json
{
    "body": "Oops, I meant adding a mention of this to the class-wide doc. Overshadowing the method solely for this sake is too much of a hassle, sorry.",
...
```json
{
    "body": "With the last commit, all tests passed. Haven't run long tests pass. Let's see what the bot says.",
    "created_at": "2014-09-03T12:51:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16925",
    "type": "issue_comment",
...
```json
{
    "body": "Minor technical challenge (or perhaps question), we will have to deal with handling backwards compatibility with giving the basis an instance of our `Permutation` class.",
...
```json
{
    "body": "This can be set to duplicate of #16926 which is ready to go. We don't need anymore this intermediate step.",
    "created_at": "2015-03-20T05:45:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16925",
    "type": "issue_comment",
...
```json
{
    "body": "Thanks Volker for the notice.",
    "created_at": "2015-03-20T06:54:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16925",
    "type": "issue_comment",
...
```json
{
    "body": "there is no branch, did you delete it accidentally?",
...
```json
{
    "body": "I deleted it because this branch is obsolete and a dead end. Or was this a wrong assumption?",
...
```json
{
    "body": "The milestone wasn't changed to duplicate.",
    "created_at": "2015-03-20T19:41:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16925",
    "type": "issue_comment",
