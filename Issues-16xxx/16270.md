...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16270#event-47974"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16270#event-47975"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16270#event-47976"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Is this a duplicate of #16444?",
    "created_at": "2014-09-17T03:01:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265986",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Is this a duplicate of #16444?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265987",
...
```json
{
    "body": "<a id='comment:4'></a>Well I don't know if latex is going to work right away... I propose you'll try after #16444 hits and we'll take it from there.",
    "created_at": "2014-09-18T00:12:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265988",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>Well I don't know if latex is going to work right away... I propose you'll try after #16444 hits and we'll take it from there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265989",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16270#event-47977"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16270#event-47978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265990",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265991",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>According to [comment:8:ticket:16444 this comment] by the reporter of this ticket, this is a duplicate of #16444.  I'll let him confirm that.",
    "created_at": "2014-09-19T12:35:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265992",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>According to [comment:8:ticket:16444 this comment] by the reporter of this ticket, this is a duplicate of #16444.  I'll let him confirm that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265993",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16270#issuecomment-265994",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16270",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16270#event-47979"
}
```
