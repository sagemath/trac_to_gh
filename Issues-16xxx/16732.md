...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,13 +5,25 @@\n sage: maxima_calculus(psi(x,y))\n psi[x](y)\n ```\n-The conversion doesn't seem to completely recurse on the first argument, though:\n+The conversion doesn't seem to recurse on either argument, though:\n \n ```\n sage: maxima_calculus(psi(psi(x,y),y))\n psi[psi(x,y)](y)\n+sage: maxima_calculus(psi(x,psi(x,y)))\n+psi[x](psi(x,y))\n ```\n-(note that the inner psi does not have the square brackets)\n+(note that the inner psi does not have the square brackets in either case.)\n+Perhaps even worse:\n+\n+```\n+sage: maxima_calculus(psi(x,polylog(3,x)))\n+psi[x](polylog(3,x))\n+sage: maxima_calculus(polylog(3,x))\n+li[3](x)\n+```\n+As you see, the polylog doesn't get translated properly! This indicates misimplemented `_maxima_init_evaled_`, and probably those occur in several spots. Perhaps the way `_maxima_init_evaled_` gets called by the translator needs amendment? (the arguments need processing). The problem seems to occur in [sage/functions/special.py line 502](https://github.com/sagemath/sagetrac-mirror/blob/master/src/sage/functions/special.py#n502), where the arguments are apparently fed raw into `_maxima_init_evaled_` and where `_maxima_init_evaled_` is usually implemented as some basic string manipulation.\n+\n \n Round-tripping only works for completely numeric first arguments (as per how the responsible regexp is designed):\n \n``````\n",
    "created_at": "2014-07-29T19:52:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221361",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16732#event-149929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221362",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16732#event-149930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221363",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221364",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221365",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221366",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16732#event-149931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221367",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221368",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221369",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16732#event-149932"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16732#event-149933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221370",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221371",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16732#issuecomment-221372",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16732#event-149934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16732#event-149935"
}
```
