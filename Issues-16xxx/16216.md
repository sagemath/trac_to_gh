...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264376",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Hi Travis, these are the changes you suggested in ticket:15984.\n\n\nWould you like to review this ticket?\n\n---\nNew commits:",
    "created_at": "2014-04-24T05:24:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264377",
    "user": "https://github.com/wluebbe"
}
```

<a id='comment:1'></a>Hi Travis, these are the changes you suggested in ticket:15984.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264378",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264379",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264380",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I guess something like the following would do the job (trickier than what I thought... I edited twice my answer)\n\n```/usr/bin/env bash\n\nfor f in $(find . -name \"*py\");\ndo\n    echo \"processing $f\"\n    sed -i -e's/==\\ *None$/is None/g' $f\n    sed -i -e's/==\\ *None\\([ :)]\\)/is None\\1/g' $f\n    sed -i -e's/!=\\ *None$/is not None/g' $f\n    sed -i -e's/!=\\ *None\\([ :)]\\)/is not None\\1/g' $f\ndone\n```",
    "created_at": "2014-04-24T08:19:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264382",
    "user": "https://github.com/videlec"
}
```

<a id='comment:3'></a>I guess something like the following would do the job (trickier than what I thought... I edited twice my answer)
...
```json
{
    "body": "<a id='comment:4'></a>I did it with a small Python script, but instead of \"\\w*\" I had \"\\w+\"  :-(\n\n\nWait a minute ... ;-)",
    "created_at": "2014-04-24T09:12:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264383",
    "user": "https://github.com/wluebbe"
}
```

<a id='comment:4'></a>I did it with a small Python script, but instead of "\w*" I had "\w+"  :-(
...
```json
{
    "body": "<a id='comment:5'></a>In [that thread](https://groups.google.com/forum/#!topic/sage-devel/SN93zx3YnAA) on sage-devel I asked the question of whether we can provide a script rather than a branch... it would make more sense here.\n\nVincent",
    "created_at": "2014-04-24T09:16:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264384",
    "user": "https://github.com/videlec"
}
```

<a id='comment:5'></a>In [that thread](https://groups.google.com/forum/#!topic/sage-devel/SN93zx3YnAA) on sage-devel I asked the question of whether we can provide a script rather than a branch... it would make more sense here.
...
```json
{
    "body": "<a id='comment:6'></a>See also [this thread](https://groups.google.com/forum/#!msg/sage-devel/r-85whQZGhY/KkUkGMzg7tgJ)",
    "created_at": "2014-04-24T09:28:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264385",
    "user": "https://github.com/videlec"
}
```

<a id='comment:6'></a>See also [this thread](https://groups.google.com/forum/#!msg/sage-devel/r-85whQZGhY/KkUkGMzg7tgJ)
...
```json
{
    "body": "<a id='comment:7'></a>Such scripts should ideally be applied by the release manager right before doing a new stable release.  Not sure whether Volker is aware of this ticket.\n\nFor new code / changes, it's up to the reviewers to check no new instances get introduced. ;-)",
    "created_at": "2014-04-24T10:11:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264386",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>Such scripts should ideally be applied by the release manager right before doing a new stable release.  Not sure whether Volker is aware of this ticket.
...
```json
{
    "body": "<a id='comment:8'></a>Thanks Leif. I will ask Volker directly if he does not answer on sage-devel.\n\nThe script was not the good one (because of things like \"my_variable!=None\"), new try\n\n```/usr/bin/env bash\n\nfor f in $(find . -name \"*py\");\ndo\n    echo \"processing $f\"\n    sed -i -e's/\\ *==\\ *None$/ is None/g' $f\n    sed -i -e's/\\ *==\\ *None\\([ :)]\\)/ is None\\1/g' $f\n    sed -i -e's/\\ *!=\\ *None$/ is not None/g' $f\n    sed -i -e's/\\ *!=\\ *None\\([ :)]\\)/ is not None\\1/g' $f\ndone\n```\nI applied it to Sage source code, and obtain 505 occurrences... and Sage even starts after that!!",
    "created_at": "2014-04-24T10:42:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264387",
    "user": "https://github.com/videlec"
}
```

<a id='comment:8'></a>Thanks Leif. I will ask Volker directly if he does not answer on sage-devel.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264389",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264390",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>The update also includes some pyx modules. And a few py modules not in your list.\n\nThe regexp now looks like\n\n```\n  c_pat_1 = re.compile(r\"\"\"\\s? == \\s* None \\b\"\"\", re.VERBOSE)\n  contents_1, n1 = re.subn(c_pat_1, \" is None\", contents_0)\n  c_pat_2 = re.compile(r\"\"\"\\s? != \\s* None \\b\"\"\", re.VERBOSE)\n  new_contents, n2 = re.subn(c_pat_2, \" is not None\", contents_1)\n```",
    "created_at": "2014-04-24T10:59:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264392",
    "user": "https://github.com/wluebbe"
}
```

<a id='comment:12'></a>The update also includes some pyx modules. And a few py modules not in your list.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264393",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>There's also at least one occurrence in `.rst` source (as opposed to generated) files:\n\n```\nsrc/doc/en/thematic_tutorials/lie/crystals.rst:421:    sage: v.f(1).f(1) == None\n```",
    "created_at": "2014-04-24T11:38:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264394",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:14'></a>There's also at least one occurrence in `.rst` source (as opposed to generated) files:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264395",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264396",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>This was also the only `.rst` I could find.",
    "created_at": "2014-04-24T13:26:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264397",
    "user": "https://github.com/wluebbe"
}
```

<a id='comment:16'></a>This was also the only `.rst` I could find.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264398",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Thanks Vincent, I guess I have to learn these tools :-))\n\nBut I am also still learning git, vim, Linux ... and often even Python. Not to mention Sage!!",
    "created_at": "2014-04-24T14:03:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264400",
    "user": "https://github.com/wluebbe"
}
```

<a id='comment:18'></a>Thanks Vincent, I guess I have to learn these tools :-))
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264402",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264403",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264405",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264406",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264407",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16216#event-47792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264408",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264409",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264410",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264412",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264413",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264414",
...
```json
{
    "body": "<a id='comment:28'></a>I've eyeballed it all and patchbot is happy, too. So, if you remove that unrelated change in combinat/backtrack you can set positive.",
    "created_at": "2014-05-20T06:44:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264415",
    "user": "https://github.com/rwst"
}
```

<a id='comment:28'></a>I've eyeballed it all and patchbot is happy, too. So, if you remove that unrelated change in combinat/backtrack you can set positive.
...
```json
{
    "body": "<a id='comment:29'></a>That //unrelated change in combinat/backtrack// resulted from resolving the merge conflict (comment 27). So it is not mine ;-) and I am reluctant removing it.\n\nPositive review anyway?",
    "created_at": "2014-05-20T09:12:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264416",
    "user": "https://github.com/wluebbe"
}
```

<a id='comment:29'></a>That //unrelated change in combinat/backtrack// resulted from resolving the merge conflict (comment 27). So it is not mine ;-) and I am reluctant removing it.
...
```json
{
    "body": "<a id='comment:30'></a>But develop doesn't have this code so you introduced (or re-introduced) it.",
    "created_at": "2014-05-20T09:39:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264417",
    "user": "https://github.com/rwst"
}
```

<a id='comment:30'></a>But develop doesn't have this code so you introduced (or re-introduced) it.
...
```json
{
    "body": "<a id='comment:31'></a>If you don't know the best way to check it: `git diff develop` when in your up-to-date branch should show only your own changes.",
    "created_at": "2014-05-20T09:53:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264418",
    "user": "https://github.com/rwst"
}
```

<a id='comment:31'></a>If you don't know the best way to check it: `git diff develop` when in your up-to-date branch should show only your own changes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264419",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264420",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264421",
    "user": "https://github.com/wluebbe"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Thanks Ralf, for the help! The merge error is fixed.\n\nI set to positive as you suggested in comment 28.",
    "created_at": "2014-05-20T13:11:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264422",
    "user": "https://github.com/wluebbe"
}
```

<a id='comment:33'></a>Thanks Ralf, for the help! The merge error is fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16216#event-47793"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264423",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16216#issuecomment-264424",
    "user": "https://github.com/vbraun"
}
```
