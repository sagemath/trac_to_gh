...
```json
{
    "body": "PS: Thanks again for your comments and sorry for taking so long to reply!",
...
```json
{
    "body": "`./sage --docbuild reference pdf` went through without errors with Jakob's fix.",
...
```json
{
    "body": "I can confirm than `make doc-pdf` succeeds. I think this should be all :).",
