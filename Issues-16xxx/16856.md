...
```json
{
    "body": "<a id='comment:1'></a>Did you try running `make build` from the sage root directory?",
    "created_at": "2014-08-20T03:34:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281737",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>Did you try running `make build` from the sage root directory?
...
```json
{
    "body": "<a id='comment:2'></a>Thanks. After doing \"make build\" all the doc tests passed.",
    "created_at": "2014-08-20T08:00:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281738",
    "user": "https://trac.sagemath.org/admin/accounts/users/mkamalakshya"
}
```

<a id='comment:2'></a>Thanks. After doing "make build" all the doc tests passed.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16856#event-49301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281739",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281740",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281741",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>No problem. I sometimes wonder if there's a better way to advertise this...",
    "created_at": "2014-08-20T08:19:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281742",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>No problem. I sometimes wonder if there's a better way to advertise this...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281743",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281744",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281745",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281746",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16856#event-49302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16856#issuecomment-281747",
