...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16012#event-211049"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16012#event-211050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16012#event-211051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16012#event-211052"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16012#issuecomment-206026",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16012#issuecomment-206027",
    "user": "https://github.com/novoselt"
}
```
