...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|\n|[caa380b](https://github.com/sagemath/sagetrac-mirror/commit/caa380bf9a0a039da53ec54bfccc22ca7f3341f1)|`Do not unpack hashable entries of tuples when looking for a cache key for unhashable elements in sage.misc.cachefunc`|\n|[a65ac85](https://github.com/sagemath/sagetrac-mirror/commit/a65ac8524294fde91e021c39b9f227277ec33d23)|`improved docstring of SageObject._cache_key`|",
    "created_at": "2014-05-13T00:39:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[6e09cab](https://github.com/sagemath/sagetrac-mirror/commit/6e09cab724440408eefd0c519adb9a4e07d4d62d)|`Merge branch 'develop' into ticket/16316`|\n|[87cf9da](https://github.com/sagemath/sagetrac-mirror/commit/87cf9da2416278dfea890daf37bf696c93a1d972)|`Include an element's parent in _cache_key()`|",
    "created_at": "2014-06-24T00:39:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:21'></a>\nI changed the wording in some places. Is it acceptable like that?\n\n---\nNew commits:\n|                                                                                                                                          |                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[1e5c972](https://github.com/sagemath/sagetrac-mirror/commit/1e5c972f0811859c408e44fdaaf3029a6e251a8d)|`Improved docstrings of SageObject._cache_key() and related methods`|\n|[dc37d43](https://github.com/sagemath/sagetrac-mirror/commit/dc37d43b55bfdff5c3c4b93be8c298955d53872e)|`Merge branch 'u/pbruin/16316-cache_key' of git://trac.sagemath.org/sage into ticket/16316`|",
    "created_at": "2014-06-26T18:57:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|\n|[c0ab188](https://github.com/sagemath/sagetrac-mirror/commit/c0ab188bd2b54ff81eb3925d417aae7f3c6626f5)|`fixed docstring`|",
    "created_at": "2014-06-27T00:45:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[22d1d8e](https://github.com/sagemath/sagetrac-mirror/commit/22d1d8ebe8c9dbdfeee93c344e2a3c8d16325142)|`Include parent instead of id(parent) as first entry of a cache key`|",
    "created_at": "2014-06-27T00:55:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:36'></a>\nReplying to [saraedum](#comment%3A31):\n> It's a very good idea to include the description in the summary of `cachefunc.pyx`. But I also think it should be in `SageObject._cache_key`; if somebody is wondering what it is good for, that is the first place where they will look for it. It is a duplication of docstrings but I hope it is acceptable.\n\n\nIt's a private method only used in one place, so the chances of someone finding it randomly are very slim, but okay, it doesn't really matter.\n\n> I made a few changes to your commit:\n> * I removed some debug statements.\n\n\nWhoops, forgot about those.\n\n>  * Your changes to `_cache_key` change the current behaviour. Say you have a tuple of a polynomial over the rationals and a p-adic number. The old version would only call `_cache_key` of the p-adic number and leave the polynomial. Your version unpacks both which is unnecessary. I restored my version of the code.\n>  * The default implementation of `_cache_key` should raise an error. If somebody calls it (misunderstanding what it is good for), then it makes sense to warn people that they did something wrong: the code in `SageObject._cache_key()` will never be executed in a legitimate context. I do not mind raising a `TypeError` instead of a `NotImplementedError`.\n\n\nRestoring your branch so I can look again.\n\n---\nNew commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[b41c455](https://github.com/sagemath/sagetrac-mirror/commit/b41c4554ddcc9e25fc293fbee386468848e6ee0d)|`restore previous version of _cache_key() in cachefunc.pyx`|\n|[37aa276](https://github.com/sagemath/sagetrac-mirror/commit/37aa276dbbf3b842cf6ec2718f01da46f41f7384)|`reverted changes which treated _cache_key like an attribute`|\n|[5586f56](https://github.com/sagemath/sagetrac-mirror/commit/5586f567789776b2760a199eeb0fedc8e5b45f75)|`removed debug output`|\n|[83944fa](https://github.com/sagemath/sagetrac-mirror/commit/83944fabe78c5561f0cc5b0845d5e8bdb30098c2)|`Restored old version of SageObject._cache_key() but raising a TypeError instead of a NotImplementedError.`|",
    "created_at": "2014-06-27T11:41:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16316",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[c987fc7](https://github.com/sagemath/sagetrac-mirror/commit/c987fc794ee39f7cc20494eb2f334ababe3e1664)|`_cache_key is not an attribute anymore`|\n|[a4f17d1](https://github.com/sagemath/sagetrac-mirror/commit/a4f17d1948e014d50af273ca8901bd6d465327b9)|`fixed doctests`|\n|[aa037de](https://github.com/sagemath/sagetrac-mirror/commit/aa037de6a612d1a6cd0cd6a8b9d3cb828feaef47)|`Fix collisions between unhashable and hashable elements in `@`cached_method`|",
