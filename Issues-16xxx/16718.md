...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278116",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278117",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This also works for infinitely generated groups, but it's a hack and is work very well. I've also copied this over to monoids as well. A note for the future, these functions should be split if we implement an axiom `FinitelyGenerated`.\n\n---\nNew commits:",
    "created_at": "2014-07-27T05:50:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278118",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>This also works for infinitely generated groups, but it's a hack and is work very well. I've also copied this over to monoids as well. A note for the future, these functions should be split if we implement an axiom `FinitelyGenerated`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278119",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Helloooooooooooooooooo !!\n\nWhy do you need to implement the same function twice ? Isn't there a way to say that `group_generators = monoid_generators` ?\n\nNathann",
    "created_at": "2014-07-27T08:56:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278120",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:2'></a>Helloooooooooooooooooo !!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278121",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>It's better to have two separate functions because the number of generators as group is often smaller the number of generators as a monoid (usually by a factor of 2 since the inverses need to be included as generators of the monoid for torsion free generators) -- albeit Sage currently does not make a distinction, nor has the functionality I believe. Plus `group_generators` currently does not call `monoid_generators` and not all groups have a `monoid_generators` method.",
    "created_at": "2014-07-27T21:54:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278122",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>It's better to have two separate functions because the number of generators as group is often smaller the number of generators as a monoid (usually by a factor of 2 since the inverses need to be included as generators of the monoid for torsion free generators) -- albeit Sage currently does not make a distinction, nor has the functionality I believe. Plus `group_generators` currently does not call `monoid_generators` and not all groups have a `monoid_generators` method.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278123",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278124",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278125",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278126",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278127",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278128",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278129",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278130",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278131",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278132",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278133",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278134",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278136",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278137",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278138",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278139",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278140",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278141",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278144",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16718#issuecomment-278145",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16718",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16718#event-48984"
}
```
