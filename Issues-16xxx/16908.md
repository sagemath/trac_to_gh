...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16908#event-224097"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16908#event-224098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16908#event-224099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16908#event-224100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16908",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16908#issuecomment-225367",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16908",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16908#issuecomment-225368",
    "user": "https://github.com/vbraun"
}
```
