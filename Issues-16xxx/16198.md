...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16198#event-213665"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16198#event-213666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16198#event-213667"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16198#event-213668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16198#issuecomment-209432",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16198#issuecomment-209433",
    "user": "https://github.com/vbraun"
}
```
