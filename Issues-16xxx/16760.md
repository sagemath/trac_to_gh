...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[d0b1b82](http://git.sagemath.org/sage.git/commit/?id=d0b1b82747c2a1c6a8fbf08f0c62c79d2b91f2fc)|`Move message about running 'make' to install() in src/bin/sage`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[e711f77](http://git.sagemath.org/sage.git/commit/?id=e711f7753574b9739bf185931cb2314fa7254a47)|`Move message about running 'make' to install() in src/bin/sage`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[ad9994b](http://git.sagemath.org/sage.git/commit/?id=ad9994bee83cb50b3a681c4f5928a39e4afc8e18)|`Move message about running 'make' to install() in src/bin/sage`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nA bit of a hack, but I think this does the job.\n\nJohn, if you agree, then it's positive review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[4e12496](http://git.sagemath.org/sage.git/commit/?id=4e12496227b7f704aa3b8dfbce4e4feb7b15cf46)|`Show the \"please run make\" message only if we actually installed something`|",
