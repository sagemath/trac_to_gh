...
```json
{
    "body": "<a id='comment:11'></a>\nI have pushed my changes, so that someone else may have a change to see how to solve the `-lomalloc_ndebug` problem.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[b426226](http://git.sagemath.org/sage.git/commit/?id=b426226860ce1ad09ece1ee40fca58ccf53cc1e4)|`Make it so that the patches to Singular apply with SAGE_DEBUG=yes`|\n|[3f5ee73](http://git.sagemath.org/sage.git/commit/?id=3f5ee733324e68b966be905d107823d91b487022)|`Define omalloc0`|\n|[bd802db](http://git.sagemath.org/sage.git/commit/?id=bd802db07ff44b2cbbff87e1e900cf30fef4c04a)|`Slight improvement of a patch`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|\n|[9c31893](http://git.sagemath.org/sage.git/commit/?id=9c318934ef2fc17bb341cc7353e48253228c6955)|`Define a missing symbol and change the module name: Singular with xalloc builds`|",
    "created_at": "2014-09-11T12:10:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16938",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[f4c6701](http://git.sagemath.org/sage.git/commit/?id=f4c67018882e40679019e17ab1d58d8d1b6cc3b7)|`Replace lomalloc by lomalloc_ndebug everywhere in debug version`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nReplying to [vbraun](#comment%3A25):\n> Are you using 32bit? I did not enable `SAGE_CHECKS`.\n\n\nNo, I am on 64 bit. Is the file you mentioned only built on 32 bit??\n\n---\nNew commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[25b66c3](http://git.sagemath.org/sage.git/commit/?id=25b66c3f6ad76e06a334b18c3724f4c58537c987)|`Switch yet another -lomalloc`|",
    "created_at": "2014-09-12T13:06:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16938",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[a38e790](http://git.sagemath.org/sage.git/commit/?id=a38e790babdd0c0cc6ced2d79dd16c0603072cc3)|`Fix dangling C pointer to Python temporary`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[1cd65a8](http://git.sagemath.org/sage.git/commit/?id=1cd65a8113c714a718679ce9a6b03a766052ad2e)|`Remove some failing Singular debug statements`|\n|[0802e93](http://git.sagemath.org/sage.git/commit/?id=0802e935cab470a2ce9ee9102203d9b27b55b1af)|`Reduce size of doctest`|",
    "created_at": "2014-09-13T18:44:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16938",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[37fda1d](http://git.sagemath.org/sage.git/commit/?id=37fda1dff0d1f58d7b07489a250526d735a12c62)|`Reduce scale of some more huge doctests`|",
    "created_at": "2014-09-13T20:21:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16938",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:49'></a>\nHans sent a patch for one of the debug build issues to libsingular-devel, I've added it and removed my patch that disabled various checks. If he manages to fix the rest then we might not need my patch...\n\n---\nNew commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[75940b2](http://git.sagemath.org/sage.git/commit/?id=75940b2a4514a58d9596de0b653482e7bac26fe4)|`Reduce size of doctest`|\n|[d737eb4](http://git.sagemath.org/sage.git/commit/?id=d737eb49be7615ddb1267c209fac2403fd79d9bb)|`Reduce scale of some more huge doctests`|\n|[3dedecd](http://git.sagemath.org/sage.git/commit/?id=3dedecd8dbe079567d53f37d3666e1419ed51a43)|`Fix erroneous \"mixed poly/vector\" error message`|",
...
```json
{
    "body": "<a id='comment:50'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[ceb83f9](http://git.sagemath.org/sage.git/commit/?id=ceb83f9a60ddd6d4f60fcc6ba0e67a4cc3c49563)|`Fix slimgb and FreeAlgebra errors`|",
...
```json
{
    "body": "<a id='comment:51'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[9233d05](http://git.sagemath.org/sage.git/commit/?id=9233d05bfaf8fd2d5a005d6880c30448fd750a77)|`Fix quo_rem and macaulay_resultant errors`|",
    "created_at": "2014-09-18T12:27:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16938",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:59'></a>\nReplying to [SimonKing](#comment%3A47):\n> But here, there is simply nothing in the log. It simply says that some tests failed, but not WHICH test failed, not what was the expected output and the actual output, not whether there has been a crash. Absolutely nothing.\n\nI have heard occasional rumours that this happens sometimes, but I have no idea how to reproduce it.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[80ef8cd](http://git.sagemath.org/sage.git/commit/?id=80ef8cd3b5772b0488ab871d059a13f226f00b9c)|`Merge remote-tracking branch 'origin/develop' into ticket/16938`|\n|[44ac240](http://git.sagemath.org/sage.git/commit/?id=44ac240d3a42ae8e3cd3b1e1d0b725f937737d34)|`Typos`|",
    "created_at": "2014-09-30T15:06:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16938",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:64'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[0fb6279](http://git.sagemath.org/sage.git/commit/?id=0fb627916b73a741be1d942b0d94fd0046dc2536)|`Trac #16938: bump Singular version`|",
...
```json
{
    "body": "<a id='comment:66'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[53b73db](http://git.sagemath.org/sage.git/commit/?id=53b73dbfaf33d8e28840d5b6ad91ce1bf941cffa)|`Fix m4ri assertion sizeof(mzd_t) == 64`|",
    "created_at": "2014-10-01T08:17:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16938",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[573cf86](http://git.sagemath.org/sage.git/commit/?id=573cf86db8eb0df38ccfa46a27d411f30c2cbd4f)|`Fix numerical noise in debug build`|\n|[15b7588](http://git.sagemath.org/sage.git/commit/?id=15b7588e82c7d67bbbab14fec4c14c862bcc4c1f)|`Use integer arithmetic in PeriodicRegion.__div__`|\n|[c471edd](http://git.sagemath.org/sage.git/commit/?id=c471edd674e461bb2db75fc899d44fb75b745bba)|`Merge branch 'u/jdemeyer/ticket/17088' of git://trac.sagemath.org/sage into ticket/16938`|",
