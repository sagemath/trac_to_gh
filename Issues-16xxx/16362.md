...
<a id='comment:44'></a>Replying to [ncohen](#comment%3A43):
> > I don't understand your position. If you want to sneak your worse code through the back door, I will protest.
...
<a id='comment:52'></a>Replying to [ncohen](#comment%3A48):
> Yooooooooo !!
> 
> > No, you are simply misled by %time here. 
...
```json
{
    "body": "<a id='comment:53'></a>Replying to [ncohen](#comment%3A51):\n> SIX MONTHS ?\n> \n> Change this to two months and it is a deal. \n\nOK, make it two.",
...
<a id='comment:53'></a>Replying to [ncohen](#comment%3A51):
> SIX MONTHS ?
> 
> Change this to two months and it is a deal. 
...
<a id='comment:58'></a>Replying to [ncohen](#comment%3A57):
> > Useless? You would hate to be able to work with polar graphs on 10000 vertices?
