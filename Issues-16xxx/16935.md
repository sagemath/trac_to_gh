...
<a id='comment:29'></a>Replying to [slabbe](#comment%3A27):
...
<a id='comment:36'></a>Replying to [nadialafreniere](#comment%3A33):
> The doctests passed without them, but I can put them back just in case it is necessary.
