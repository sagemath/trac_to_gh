...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[def64a1](http://git.sagemath.org/sage.git/commit/?id=def64a1a59757069be2840256a41dbc5951d5e07)|`included suggestions from comment 5 (slabbe)`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|\n|[05cbe28](http://git.sagemath.org/sage.git/commit/?id=05cbe2844498c4c1f3d325e4ac27e637188b8e71)|`Separation of lps_lengths and lengths_maximal_palindromes functions, change of indexes, correction of errors, upgrade with version 6.4.1`|",
    "created_at": "2015-02-01T18:12:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16935",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[f4cf2f7](http://git.sagemath.org/sage.git/commit/?id=f4cf2f7fa9af3bea0b71583f946851cf4c041582)|`Modified spacing, use of Integer() and palindromes()`|",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[d0ee49e](http://git.sagemath.org/sage.git/commit/?id=d0ee49ef26ff6277c5ed847e3b03a4c95dd857d6)|`Added Integers() and changed an incorrect error message`|",
    "created_at": "2015-04-09T19:04:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16935",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[fcdd2f8](http://git.sagemath.org/sage.git/commit/?id=fcdd2f830906015ddf3c1623bd7a29dde8e1e58e)|`modified the error message and spacing in documentation`|",
    "created_at": "2015-04-09T19:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16935",
    "type": "issue_comment",
