...
<a id='comment:28'></a>Replying to [bruno](#comment%3A26):
> Replying to [jdemeyer](#comment%3A22):
> > Wouldn't "density" be a better word than "sparsity"?
...
```json
{
    "body": "<a id='comment:49'></a>Replying to [chapoton](#comment%3A47):\n> one failing doctest\n\n\nOne `sig_off()` was missing, fixed.",
    "created_at": "2015-08-26T14:02:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16516",
    "type": "issue_comment",
...
<a id='comment:49'></a>Replying to [chapoton](#comment%3A47):
> one failing doctest
...
<a id='comment:52'></a>Replying to [chapoton](#comment%3A50):
> 1 failing doctest, due to deprecation of polynomial slicing
...
<a id='comment:59'></a>Replying to [tscrim](#comment%3A56):
> Minor comments:
> 
> - Mark the docstring with `r"""` and
>   {{{#!diff
