...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16184#issuecomment-209253",
    "user": "https://github.com/sagetrac-sbesnier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16184#issuecomment-209254",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16184#event-213509"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16184#event-213510"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16184#event-213511"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16184#event-213512"
}
```
