...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16653#event-220515"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16653#event-220516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16653#event-220517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16653#event-220518"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16653#issuecomment-219795",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16653#issuecomment-219796",
    "user": "https://github.com/rwst"
}
```
