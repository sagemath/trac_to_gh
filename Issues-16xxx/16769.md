...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-239661"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-239662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-239663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-239664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219698",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-239665"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-239666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219699",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219700",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219701",
    "user": "https://github.com/sagetrac-ajagekar-akshay"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219702",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-239667"
}
```
