...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16769#issuecomment-279357",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>` RR(2^54) ` is an exact integer although not an instance of `Integer` here. Conversion of `RealNumber` to `Rational` should yield its integral value. What if we check whether `RR(2^54)` or any `RealNumber` in general is an exact integer before returning it as `Rational` ?",
    "created_at": "2016-02-06T17:48:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16769#issuecomment-279358",
    "user": "https://trac.sagemath.org/admin/accounts/users/ajagekar.akshay"
}
```

<a id='comment:3'></a>` RR(2^54) ` is an exact integer although not an instance of `Integer` here. Conversion of `RealNumber` to `Rational` should yield its integral value. What if we check whether `RR(2^54)` or any `RealNumber` in general is an exact integer before returning it as `Rational` ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16769#issuecomment-279360",
    "user": "https://trac.sagemath.org/admin/accounts/users/ajagekar.akshay"
}
```
