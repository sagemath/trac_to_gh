...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16404#issuecomment-214335",
    "user": "https://github.com/sagetrac-foosterhof"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16404#issuecomment-214336",
    "user": "https://github.com/sagetrac-foosterhof"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16404#event-216796"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16404#event-216797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16404",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16404#event-216798"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16404#event-216799"
}
```
