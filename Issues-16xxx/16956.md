...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16956#event-224774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16956#event-224775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16956#event-224776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16956#issuecomment-226500",
    "user": "https://github.com/sagetrac-gdrama"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16956#issuecomment-226501",
    "user": "https://github.com/sagetrac-gdrama"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16956#event-224777"
}
```
