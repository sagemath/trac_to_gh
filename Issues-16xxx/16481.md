...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16481#event-217827"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16481#event-217828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16481#event-217829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16481#event-217830"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16481#issuecomment-215975",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16481#issuecomment-215976",
    "user": "https://github.com/sagetrac-jpflori"
}
```
