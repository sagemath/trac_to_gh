...
```json
{
    "body": "<a id='comment:2'></a>\nA quick and dirty fix which solves the problem at hand but ignores the larger problems of duplicated code and low coordination between `Tachyon.plot` and other surface plots in Sage.\n\n---\nNew commits:\n|                                                                                                                                          |           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------|\n|[faac676](http://git.sagemath.org/sage.git/commit/?id=faac6767bc2b39fcd570057699c5a3939010963a)|`quick fix`|\n|[3700e0d](http://git.sagemath.org/sage.git/commit/?id=3700e0d6af5515c309fef5d5d5f09f16ef7fba7e)|`quick fix for smooth triangles too`|",
    "created_at": "2014-04-25T15:27:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16226",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nHere's a different branch which entirely throws out `__str__` and `__repr__` for Tachyon objects.  All methods are doctested, and all tests pass in sage/plot.  I'm running (long) tests on the whole sage library now.\n\nThe plotting examples in tachyon.py are working as expected.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[1527571](http://git.sagemath.org/sage.git/commit/?id=15275716a29ecf539964b901fe4acb88ca8d48d1)|`don't use __str__ or __repr__ for tachyon string representations`|\n|[af48ed4](http://git.sagemath.org/sage.git/commit/?id=af48ed48e70f456bbf1ca8706988871113a24c84)|`fix doctests`|\n|[0b6e118](http://git.sagemath.org/sage.git/commit/?id=0b6e1184022052ef6437e7c5a0175561b4755ed7)|`more doctest fixes`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[a2cb423](http://git.sagemath.org/sage.git/commit/?id=a2cb4232309afd5e084bb91a1e1410a1ce1f9603)|`use verbose option to check that plots render successfully`|",
    "created_at": "2014-04-28T16:03:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16226",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[543c6ef](http://git.sagemath.org/sage.git/commit/?id=543c6efc0cef99a4d625da6633ca74d50dc9a9e3)|`correct docstring for str`|",
    "created_at": "2014-07-28T18:55:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16226",
    "type": "issue_comment",
