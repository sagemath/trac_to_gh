...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[ea1f5b8](http://git.sagemath.org/sage.git/commit/?id=ea1f5b8888379d2a587b995c04b6bd34bb70ecf5)|`trac #16433: clique_with_loops.is_strongly_regular() is True`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[4e717d3](http://git.sagemath.org/sage.git/commit/?id=4e717d3bb11a562c260a34f6031a0def3bec162d)|`trac #16433: more doc`|",
