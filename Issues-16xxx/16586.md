...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16586#event-48662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16586#issuecomment-214217",
...
```json
{
    "body": "<a id='comment:5'></a>This works now with the default algorithm. Still fails with Dokchitser's scripts:\n\n```\nsage: K.zeta_function(prec=100, algorithm=\"pari\")(7)\n1.0078766798859009530335817870\nsage: K.zeta_function(prec=100, algorithm=\"gp\")(7)\n45333.379954778857657650185188\n```",
    "created_at": "2019-09-10T14:48:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16586#issuecomment-214219",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:5'></a>This works now with the default algorithm. Still fails with Dokchitser's scripts:
