...
```json
{
    "body": "<a id='comment:2'></a>\nThis should do it. \n\nI corrected independent_r_sets and also dependent_r_sets (and then I corrected myself, since the latter needed a slightly different treatment). \n\nAs far as I can see, flats(r) is already fool-proof, and there are no other user-facing methods that take parameters.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|\n|[736bca0](http://git.sagemath.org/sage.git/commit/?id=736bca0b9fe51c42d1dc830f86cf281278d8eddd)|`BasisExchangeMatroid.independent_r_sets() and .dependent_r_sets() now check if input r exceeds the full rank.`|\n|[5bdc0a4](http://git.sagemath.org/sage.git/commit/?id=5bdc0a4548f1149bc086d427f08a2387d9e3ee73)|`Corrected BasisExchangeMatroid.dependent_r_sets(r) to enumerate all r-sets if r > full rank.`|",
    "created_at": "2014-04-13T20:07:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16151",
    "type": "issue_comment",
