...
```
CC:  simonking @nthiery @nathanncohen stumpc5 @saliola gmoose05
...
```json
{
    "body": "I have never seen it. Question: Is the code in `src/sage/combinat/cluster_algebra/` using the code from `src/sage/quivers/`? If yes, then I wonder if #16453 improves the situation. If not, then I have no idea whatsoever on the timeout.",
    "created_at": "2014-09-30T11:01:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16837#issuecomment-222622",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16837#issuecomment-222623",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16837#issuecomment-222624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16837#issuecomment-222625",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16837#issuecomment-222626",
