...
```json
{
    "body": "<a id='comment:1'></a>So I'm thinking we should have a new category for unital associative algebras which sets up this coercion and the non-associative variety not. Comments?",
    "created_at": "2014-06-17T17:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272033",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>So I'm thinking we should have a new category for unital associative algebras which sets up this coercion and the non-associative variety not. Comments?
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16492#event-48465"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>It looks like this may be solved by #19225.",
    "created_at": "2017-08-04T12:34:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272035",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:4'></a>It looks like this may be solved by #19225.
...
```json
{
    "body": "<a id='comment:5'></a>I do not think #19225 is the solution. I think the problem is the lack of a proper category for nonassociative rings and rngs for the corresponding `Hom`, which is still a problem even with #19225.",
    "created_at": "2017-08-06T14:57:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272036",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>I do not think #19225 is the solution. I think the problem is the lack of a proper category for nonassociative rings and rngs for the corresponding `Hom`, which is still a problem even with #19225.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272037",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>There is no error anymore in SageMath 9.1.beta6:\n\n```\nsage: from sage.categories.magmatic_algebras import MagmaticAlgebras\n....: class A(Parent):\n....:     def __init__(self, R):\n....:         Parent.__init__(self, base=R, category=MagmaticAlgebras(R).Unital())\n....: B = A(QQ); B\n....: B.coerce_map_from(QQ)\n....:\n<__main__.A_with_category object at 0x7ee3bdc39408>\nGeneric morphism:\n  From: Rational Field\n  To:   <__main__.A_with_category object at 0x7ee3bdc39408>\n```",
    "created_at": "2020-03-02T07:54:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272038",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:7'></a>There is no error anymore in SageMath 9.1.beta6:
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16492#event-48466"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16492#event-48467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272039",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272040",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Seems like you were right. Thus works-for-me.",
    "created_at": "2020-03-02T23:40:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272041",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:8'></a>Seems like you were right. Thus works-for-me.
...
```json
{
    "body": "<a id='comment:9'></a>Actually it was already fixed in SageMath 9.0 or earlier, most likely by #28328.  I guess we can regard this ticket as a duplicate.",
    "created_at": "2020-03-03T07:37:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272042",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:9'></a>Actually it was already fixed in SageMath 9.0 or earlier, most likely by #28328.  I guess we can regard this ticket as a duplicate.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272043",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16492#issuecomment-272044",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16492",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16492#event-48468"
}
```
