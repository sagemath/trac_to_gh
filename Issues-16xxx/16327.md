...
Attachment [sage-clean-upstream](tarball://root/attachments/some-uuid/ticket16327/sage-clean-upstream) by @nexttime created at 2014-05-11 14:51:51
...
```json
{
    "body": "Hmm.. script still works, after all these years! I will try to look into `sage-list-packages` if I get some time.",
