...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223347",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Attachment [log.txt](tarball://root/attachments/some-uuid/ticket16327/log.txt) by @ppurka created at 2014-05-11 14:50:21\n\nthe bash script",
    "created_at": "2014-05-11T14:50:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223348",
    "user": "https://github.com/ppurka"
}
```

Attachment [log.txt](tarball://root/attachments/some-uuid/ticket16327/log.txt) by @ppurka created at 2014-05-11 14:50:21
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [sage-clean-upstream](tarball://root/attachments/some-uuid/ticket16327/sage-clean-upstream) by @nexttime created at 2014-05-11 14:51:51\n\nOne problem is that currently not all packages have proper versions / \"fullnames\", cf. `sage-list-packages`.  I.e., e.g. `ver` may be empty and then `pkg_ver=\"$pkg-$ver\"` doesn't work.",
    "created_at": "2014-05-11T14:51:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223349",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>Attachment [sage-clean-upstream](tarball://root/attachments/some-uuid/ticket16327/sage-clean-upstream) by @nexttime created at 2014-05-11 14:51:51
...
```json
{
    "body": "<a id='comment:2'></a>P.S.:  Do you plan to handle different branches? :P\n\n(I'd at least check that `master` doesn't reference any of those subject to deletion.)",
    "created_at": "2014-05-11T14:59:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223350",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>P.S.:  Do you plan to handle different branches? :P
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223351",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223352",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223353",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16327#event-48139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223354",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16327#event-48140"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16327#event-48141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223355",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223356",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Hmm.. script still works, after all these years! I will try to look into `sage-list-packages` if I get some time.",
    "created_at": "2020-12-28T06:41:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223357",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:11'></a>Hmm.. script still works, after all these years! I will try to look into `sage-list-packages` if I get some time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16327#issuecomment-223359",
    "user": "https://github.com/ppurka"
}
```
