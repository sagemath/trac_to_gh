...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16940#event-224545"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16940#event-224546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16940#event-224547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16940#event-224548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16940#issuecomment-226213",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16940#issuecomment-226214",
    "user": "https://github.com/videlec"
}
```
