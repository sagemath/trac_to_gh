...
```json
{
    "body": "<a id='comment:2'></a>The problem with the algorithm was that after the recursion, an edge was added. This edge was added to just any 2 vertices before, but there is are 2 specific vertices to which this edge should be added. These vertices are now calculated correctly (hopefully)\n\n---\nNew commits:",
    "created_at": "2014-06-13T08:53:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16475",
    "type": "issue_comment",
...
<a id='comment:2'></a>The problem with the algorithm was that after the recursion, an edge was added. This edge was added to just any 2 vertices before, but there is are 2 specific vertices to which this edge should be added. These vertices are now calculated correctly (hopefully)
...
```json
{
    "body": "<a id='comment:4'></a>This fix works correctly, as far as I tested, when ticket #12797 is applied as well.\n\nFlorian",
...
<a id='comment:4'></a>This fix works correctly, as far as I tested, when ticket #12797 is applied as well.
...
<a id='comment:10'></a>In Graph.vertices():
...
<a id='comment:11'></a>Oh. I see ! Sorry, I had not realized that the problem came from frozensets inside of the graph !
...
```json
{
    "body": "<a id='comment:13'></a>branch does not apply",
    "created_at": "2015-02-18T09:14:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16475",
    "type": "issue_comment",
...
<a id='comment:13'></a>branch does not apply
...
<a id='comment:16'></a>Helloooooooooooo,
