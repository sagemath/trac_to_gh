...
```json
{
    "body": "<a id='comment:2'></a>\nThe proposed solution needs to be reviewed by someone more knowledgeable in the sage building system than I am.\n\n---\nNew commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[08c39b2](http://git.sagemath.org/sage.git/commit/?id=08c39b27e2c68272a75ab1f98f0316e4bbeac5ce)|`Point d'\u00e9tape avant test.`|\n|[b607718](http://git.sagemath.org/sage.git/commit/?id=b607718bd7be120232547f34549750d557e35c4c)|`Fixed package checksums munching by /src/bin/sage-fix-pkg-checksums`|",
    "created_at": "2014-07-08T21:40:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16629",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[d941afd](http://git.sagemath.org/sage.git/commit/?id=d941afd9150164e979b7df98b2e574cdacd78053)|`All discrepancies ==> error and abort (+ cleanup of oversight).`|",
    "created_at": "2014-07-08T22:54:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16629",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[50697bf](http://git.sagemath.org/sage.git/commit/?id=50697bf4b64ce0cf0a185c15ffce539d1392a80f)|`Back to original behaviour (minus tolerance for mixed-case tarball names).`|",
    "created_at": "2014-07-12T14:23:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16629",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[214941f](http://git.sagemath.org/sage.git/commit/?id=214941f6443a352a00f6b84acf6f029bdba67d85)|`Process if versions match.`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[7a2c9da](http://git.sagemath.org/sage.git/commit/?id=7a2c9da063f353392d4b6629a1172b162de4c2f5)|`Final cleanup of my distractions.`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[a046905](http://git.sagemath.org/sage.git/commit/?id=a0469055a4f293df53e6f6ae42ac9dc0e761f7c8)|`Trac #16629: improve sage-fix-pkg-checksums`|",
