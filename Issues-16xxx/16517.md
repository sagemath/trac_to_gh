...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218332"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218333"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218334"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218335"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16517#issuecomment-216671",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16517#issuecomment-216672",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16517#issuecomment-216673",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16517#issuecomment-216674",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218337"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218338"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16517#event-218339"
}
```
