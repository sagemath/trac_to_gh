...
```json
{
    "body": "<a id='comment:1'></a>See also #11327 where a more thorough solution was proposed, but not finished, in 2011.  The patch (branch) posted there on 2014-08-09  solves both the issue reported there (constructing duals of 2-isogenies over function fields) and this one.\n\nThis ticket is therefore redundant and can be closed as a duplicate while #11327 is ready for review.",
    "created_at": "2014-08-07T09:34:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16779#issuecomment-279557",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>See also #11327 where a more thorough solution was proposed, but not finished, in 2011.  The patch (branch) posted there on 2014-08-09  solves both the issue reported there (constructing duals of 2-isogenies over function fields) and this one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16779#issuecomment-279558",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16779#event-49124"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I confirm that #11327 solves this ticket, too. This should be closed as won't fix.",
    "created_at": "2014-08-13T10:43:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16779#issuecomment-279559",
    "user": "https://github.com/categorie"
}
```

<a id='comment:3'></a>I confirm that #11327 solves this ticket, too. This should be closed as won't fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16779#issuecomment-279560",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16779#issuecomment-279561",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16779",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16779#event-49125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16779#issuecomment-279562",
