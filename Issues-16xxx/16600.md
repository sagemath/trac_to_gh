...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16600#event-219704"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16600#event-219705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16600#event-219706"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16600#issuecomment-218699",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16600#issuecomment-218700",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16600#event-219707"
}
```
