...
<a id='comment:6'></a>The code seems functional now. I've also added an `is_generic` method to allow inspection of the '_generic' attribute.
...
<a id='comment:8'></a>I'm not getting this to work. When I evaluate
...
<a id='comment:16'></a>I've made a few small changes:
