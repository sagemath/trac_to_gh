...
```json
{
    "body": "<a id='comment:4'></a>\nThere was a `--without-flint` in the libfac configuration, that doesn't sound right.\n\n---\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[d5b8fa6](http://git.sagemath.org/sage.git/commit/?id=d5b8fa660cb0aafef769c257a575e547bbb1b618)|`remove stray without-flint`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[fa75ea6](http://git.sagemath.org/sage.git/commit/?id=fa75ea6c03a9bcf856d5f3cf9af6eab4fcd939d2)|`Do not add /usr/local/{lib,include} to paths`|",
    "created_at": "2014-08-02T14:04:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16751",
    "type": "issue_comment",
