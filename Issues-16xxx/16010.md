...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16010#event-211027"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16010#event-211028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16010#event-211029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16010#event-211030"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16010#issuecomment-206010",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16010#issuecomment-206011",
    "user": "https://github.com/sagetrac-csar"
}
```
