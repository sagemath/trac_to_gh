...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[04665b0](http://git.sagemath.org/sage.git/commit/?id=04665b0adccb1afb3599372e9bf72545541b8ea3)|`Fix frame size for standard example animation.`|\n|[368dca2](http://git.sagemath.org/sage.git/commit/?id=368dca2860fd72ae05de65c4aa561938e2da7024)|`Mark some animation tests as long time.`|\n|[d515502](http://git.sagemath.org/sage.git/commit/?id=d5155020dc2931d166f360f044a08b7b7bb78b24)|`Minor improvements to aminate documentation.`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[050c3b8](http://git.sagemath.org/sage.git/commit/?id=050c3b8afb736b20e46feb85f9273fba35336688)|`Merge tag '6.3' into ticket/16570`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[a5e766d](http://git.sagemath.org/sage.git/commit/?id=a5e766dcccea56a5af130dc4f7cde649997dc646)|`Improve some more animation examples.`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nHello,\n\nI set the `ymax` limit to 4 for the `x^2` example:\n\nhttp://git.sagemath.org/sage.git/commit/?h=9df42a472cd18d9f7b0eaa3cf820c515f74e54a6&id=811ab08ce3e55c8314ddc81b73671b2cbf611786\n\n---\nNew commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[ba4cfed](http://git.sagemath.org/sage.git/commit/?id=ba4cfedc1f2b778a9918c823cfd545ebb650996f)|`Merge branch 'develop' into ticket/16570`|\n|[3001502](http://git.sagemath.org/sage.git/commit/?id=30015024d8fae3c1257cd2f81fdb3abe23a13edd)|`Merge branch 'u/gagern/ticket/16570' of git://trac.sagemath.org/sage into ticket/16570`|\n|[811ab08](http://git.sagemath.org/sage.git/commit/?id=811ab08ce3e55c8314ddc81b73671b2cbf611786)|`fixed max y-axis range to 4 for the x^2 example`|\n|[9df42a4](http://git.sagemath.org/sage.git/commit/?id=9df42a472cd18d9f7b0eaa3cf820c515f74e54a6)|`Merge branch 'u/gagern/ticket/16570' into ticket/16570`|",
    "created_at": "2014-09-17T16:47:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16570",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:28'></a>\nOK, things look good if I simply pass the keywords to the `plot` function.\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[403a9e6](http://git.sagemath.org/sage.git/commit/?id=403a9e602cd9ec4c77d9688fa752ab432470300f)|`animate: Pass keyword arguments to plot constructor.`|\n|[9e4d39c](http://git.sagemath.org/sage.git/commit/?id=9e4d39c5b66b1188fbfdaf2784f625a9ab1a0fc4)|`Merge tag '6.4.beta4' into ticket/16570`|\n|[e14ebdb](http://git.sagemath.org/sage.git/commit/?id=e14ebdb141a8a8a82e1bcc75d90d80c61adeceeb)|`Mark some animation tests as long time.`|\n|[17d4f90](http://git.sagemath.org/sage.git/commit/?id=17d4f90286041ea73184cc7b231edb6a05b82f60)|`Minor improvements to aminate documentation.`|\n|[07eaa4c](http://git.sagemath.org/sage.git/commit/?id=07eaa4c4164dd734dccd6c14730bc70256efaf93)|`Improve some more animation examples.`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[9d9e590](http://git.sagemath.org/sage.git/commit/?id=9d9e590f5ef642a06f45056ac282fe696131c435)|`fixed max y-axis range to 4 for the x^2 example`|",
