...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16995#event-225240"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16995#event-225241"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16995#event-225242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16995#event-225243"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16995#issuecomment-227086",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16995#issuecomment-227087",
    "user": "https://github.com/novoselt"
}
```
