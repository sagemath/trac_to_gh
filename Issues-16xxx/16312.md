...
```json
{
    "body": "<a id='comment:1'></a>\nI think #7095 (a huge ticket dealing with a couple of issues) is no longer (or not really) relevant here; there's some discussion of `MACOSX_DEPLOYMENT_TARGET` though, see ticket:7095#comment:36 ff.",
    "created_at": "2014-05-09T16:40:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16312#issuecomment-213751",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16312#issuecomment-213752",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148633"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148634"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148635"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148636"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16312#issuecomment-213753",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16312#issuecomment-213754",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148638"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148639"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148640"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16312",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16312#event-148641"
}
```
