...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16312#issuecomment-212215",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16312#issuecomment-212216",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16312#event-215475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16312#event-215476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16312#event-215477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16312",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16312#event-215478"
}
```
