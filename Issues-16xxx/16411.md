...
```json
{
    "body": "<a id='comment:1'></a>I am not sure if this is a problem to be reported upstream. Probably not, it seems like the culprit is on our side, in `sage.libs.singular.polynomial`.",
    "created_at": "2014-05-29T11:17:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269926",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>I am not sure if this is a problem to be reported upstream. Probably not, it seems like the culprit is on our side, in `sage.libs.singular.polynomial`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269927",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16411#event-48302"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>With #18905, I get\n\n```\nsage: C.<x,y,z> = GF(2)[]\nsage: f = x^4+x*y^3+z^6\nsage: a = f(1,0,0)\nsage: get_memory_usage()\n1028.44921875\nsage: for i in xrange(1000000):\n....:     a = f(1,0,0)\n....:     \nsage: get_memory_usage()\n1028.44921875\n```\n\nSo, I suggest to close it as a duplicate.",
    "created_at": "2015-07-23T14:45:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269928",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:4'></a>With #18905, I get
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269929",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16411#event-48303"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16411#event-48304"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269930",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>(duplicate of #18905)",
    "created_at": "2015-07-23T14:45:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269931",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>(duplicate of #18905)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269932",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16411#event-48305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16411#issuecomment-269933",
