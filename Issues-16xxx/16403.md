...
```json
{
    "body": "<a id='comment:18'></a>maybe to clarify: it was not Ralf giving a positive review but Nathann in comment:11.",
...
<a id='comment:18'></a>maybe to clarify: it was not Ralf giving a positive review but Nathann in comment:11.
