...
Replying to [@nthiery](https://github.com/sagemath/sage/issues/16275#comment:0):
> As an alternative, this ticket proposes to add a ``check=True/False``
> optional argument to Hom, and to use it upon unpickling.
