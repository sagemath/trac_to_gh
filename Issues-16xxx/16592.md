...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219582"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219584"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219585"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16592#issuecomment-218509",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16592#issuecomment-218510",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16592#issuecomment-218511",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219586"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219587"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219588"
}
```
