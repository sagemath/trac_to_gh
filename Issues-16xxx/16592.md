...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219578"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219579"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219580"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16592#event-219581"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16592#issuecomment-218512",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16592#issuecomment-218513",
    "user": "https://github.com/nbruin"
}
```
