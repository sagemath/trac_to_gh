...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273544",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273545",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273546",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273547",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273548",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273549",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273550",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273551",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273552",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nWell, we can't get rid of the manual cache because of the `cardinality_*` methods which set it when called (IMO, these should be private methods and have everything go through `cardinality()` but I don't have a stake in this).\n\nI've changed it so that `algorithm` is always ignored if the cardinality is known. If someone wants to check against another algorithm, they can explicitly call one of the `cardinality_*` methods (which always do the computation).\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|\n|[0262f93](https://github.com/sagemath/sagetrac-mirror/commit/0262f938685351ec0044f0b3e039e2df3a94fd3a)|`Merge branch 'u/pbruin/16680-elliptic_curve_cardinality_doctest' of trac.sagemath.org:sage into u/tscrim/16680-elliptic_curve_cardinality_doctest`|\n|[e058079](https://github.com/sagemath/sagetrac-mirror/commit/e058079e4c09923671b09edf681292d5d82c1903)|`Made the cardinality ignore the algorithm if known and added a doctest.`|",
    "created_at": "2014-07-19T00:55:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273553",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273554",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273555",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273556",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16680#event-63374"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273557",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273558",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273559",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273560",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273561",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273562",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273563",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273564",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273565",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16680#event-63375"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16680#issuecomment-273566",
    "user": "https://github.com/vbraun"
}
```
