...
```
Between the time when #15963 was merged in develop and #15963 was actually closed, I found and fixed a bug and pushed it to #15963, see ticket:15963#comment:4. However, due to the race condition outlined above, this fix has never been merged.
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16128#event-143715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16128#issuecomment-208285",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16128#issuecomment-208286",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16128#event-143716"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16128#event-143717"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16128#event-143718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16128",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16128#event-143719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16128#issuecomment-208287",
