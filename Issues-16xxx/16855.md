...
```json
{
    "body": "Changing branch from \"\" to \"u/pbruin/16855-finite_field_comparison\"",
    "created_at": "2014-08-19T20:36:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281707",
    "user": "https://github.com/pjbruin"
}
```

Changing branch from "" to "u/pbruin/16855-finite_field_comparison"
...
```json
{
    "body": "Changing commit from \"\" to \"fcc623fd5c2e402986de71296032048f05041e3a\"",
    "created_at": "2014-08-19T20:36:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281708",
    "user": "https://github.com/pjbruin"
}
```

Changing commit from "" to "fcc623fd5c2e402986de71296032048f05041e3a"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281709",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Changing commit from \"fcc623fd5c2e402986de71296032048f05041e3a\" to \"10bcb8df90756b034907059cf965cbfe01dbc5ac\"",
    "created_at": "2014-08-21T11:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281710",
    "user": "https://github.com/pjbruin"
}
```

Changing commit from "fcc623fd5c2e402986de71296032048f05041e3a" to "10bcb8df90756b034907059cf965cbfe01dbc5ac"
...
```json
{
    "body": "<a id='comment:2'></a>Changing branch to not introduce coercions between different implementations of the same finite field, since this will lead to memory leaks; see Nils Bruin's comments [here](https://groups.google.com/d/msg/sage-devel/c8cCvT84CLo/436vAxVoBdMJ).",
    "created_at": "2014-08-21T11:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281711",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:2'></a>Changing branch to not introduce coercions between different implementations of the same finite field, since this will lead to memory leaks; see Nils Bruin's comments [here](https://groups.google.com/d/msg/sage-devel/c8cCvT84CLo/436vAxVoBdMJ).
...
```json
{
    "body": "Changing branch from \"u/pbruin/16855-finite_field_comparison\" to \"u/pbruin/16855-FiniteField_comparison\"",
    "created_at": "2014-08-21T11:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281712",
    "user": "https://github.com/pjbruin"
}
```

Changing branch from "u/pbruin/16855-finite_field_comparison" to "u/pbruin/16855-FiniteField_comparison"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281713",
...
```json
{
    "body": "<a id='comment:5'></a>I'll try to see if I can produce a memory leak using multidirectional coercions.  Anyway, I think that if we want these coercions, it is probably better to do this on a different ticket.",
    "created_at": "2014-08-21T14:41:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281715",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:5'></a>I'll try to see if I can produce a memory leak using multidirectional coercions.  Anyway, I think that if we want these coercions, it is probably better to do this on a different ticket.
...
```json
{
    "body": "<a id='comment:6'></a>The following does not leak memory with the current branch, but does leak memory after applying the additional commit `fcc623fd` from the other branch:\n\n```\nimport gc\nfor i in range(10000):\n    var = 'a' + str(i)\n    F0 = FiniteField(2^3, var, impl='givaro')\n    F1 = FiniteField(2^3, var, impl='pari_ffelt')\n    _ = F0.coerce_map_from(F1)\n    _ = F1.coerce_map_from(F0)\n    if(i % 100 == 0):\n        gc.collect()\n        print(get_memory_usage())\n```\n[Edit: the correct option is `impl` instead of `implementation`, but it doesn't affect the memory leak.]",
    "created_at": "2014-08-21T14:56:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281716",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:6'></a>The following does not leak memory with the current branch, but does leak memory after applying the additional commit `fcc623fd` from the other branch:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281717",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281718",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Changing commit from \"10bcb8df90756b034907059cf965cbfe01dbc5ac\" to \"e1380c03931414a7f9715e936d587976f06807a2\"",
    "created_at": "2014-08-21T16:37:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281719",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "10bcb8df90756b034907059cf965cbfe01dbc5ac" to "e1380c03931414a7f9715e936d587976f06807a2"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281720",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>While this ticket makes the bug at #16934 go away, we still have the following bug:\n\n```\nsage: k1.<a> = GF(17^14, impl=\"pari_ffelt\")\nsage: _ = a/2\nsage: k2.<a> = GF(17^14, impl=\"pari_ffelt\")\nsage: k1 is k2\nFalse\n```",
    "created_at": "2014-09-04T20:15:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281722",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>While this ticket makes the bug at #16934 go away, we still have the following bug:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281723",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"e1380c03931414a7f9715e936d587976f06807a2\" to \"8d9f33c40df9d5b7bd89833a3b761c80553e152d\"",
    "created_at": "2014-10-31T10:16:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281724",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e1380c03931414a7f9715e936d587976f06807a2" to "8d9f33c40df9d5b7bd89833a3b761c80553e152d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281725",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>And this conflicts with #16983.",
    "created_at": "2014-10-31T14:53:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281726",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:14'></a>And this conflicts with #16983.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281727",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281729",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Oh yes you're right.\nI just had a look at the empty \"merged in\" field.",
    "created_at": "2014-11-03T10:40:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281730",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:18'></a>Oh yes you're right.
I just had a look at the empty "merged in" field.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281731",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281732",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>So I guess it is dark magic I used which confused git.",
    "created_at": "2014-11-03T10:41:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281733",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:19'></a>So I guess it is dark magic I used which confused git.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281734",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "Changing branch from \"u/pbruin/16855-FiniteField_comparison\" to \"8d9f33c40df9d5b7bd89833a3b761c80553e152d\"",
    "created_at": "2014-11-07T16:15:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281735",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/pbruin/16855-FiniteField_comparison" to "8d9f33c40df9d5b7bd89833a3b761c80553e152d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16855#issuecomment-281736",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16855",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16855#event-49300"
}
```
