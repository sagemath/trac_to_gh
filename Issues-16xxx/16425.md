...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234607"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234610"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16425#issuecomment-212129",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16425#issuecomment-212130",
    "user": "https://github.com/sagetrac-skropf"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16425",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16425#issuecomment-212131",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16425",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16425#event-234615"
}
```
