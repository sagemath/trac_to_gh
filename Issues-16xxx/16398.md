...
```json
{
    "body": "Sorry, for that. The doctest is now corrected.",
    "created_at": "2014-07-28T09:18:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16398",
    "type": "issue_comment",
...
```json
{
    "body": "(I updated it again: this is the file for digraphs constructor, so the fix was `graph->digraph` `^^;` Thank you very much though !)",
    "created_at": "2014-07-28T09:20:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16398",
    "type": "issue_comment",
