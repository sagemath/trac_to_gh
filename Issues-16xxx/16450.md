# Issue 16450: Use gp2c for GP scripts
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16450#issuecomment-215979",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16450#event-48908"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16450#issuecomment-215980",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16450#issuecomment-215981",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16450#event-48909"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16450#event-48910"
}
```
