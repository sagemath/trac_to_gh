...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16979#event-225038"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16979#event-225039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16979#event-225040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16979#event-225041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16979#issuecomment-226862",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16979#issuecomment-226863",
    "user": "https://github.com/fchapoton"
}
```
