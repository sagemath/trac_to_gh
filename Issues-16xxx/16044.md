...
```json
{
    "body": "Okay, here we can just do all fixes for any remaining libraries which for [whatever](http://trac.sagemath.org/ticket/16017#comment:39) [reason](http://trac.sagemath.org/ticket/16017#comment:42) don't have the right [install_name](https://groups.google.com/d/msg/sage-release/q1DPhL8WQiM/tXZs-byQBRUJ).\n\nR will be needed for rpy to build.\n\nPari became #17588 and in any case wasn't *necessary* for building.\n\nCC:  @kiwifb @nexttime jpflori\n\nReviewer: Fran\u00e7ois Bissey\n\nResolution: fixed\n\nIssue created by migration from https://trac.sagemath.org/ticket/16044\n\n",
...
```json
{
    "body": "<a id='comment:2'></a>It is a fair question. DYLD_LIBRARY_PATH is defined in sage-env but I don't think it would have the kind of effects we see at building time. I will point my big (not so fat) finger at gcc. A OS X install will, by necessity, build a recent gcc. When did we switch to 4.7.3?\n\nTechnically all those install_name could be relative [http://blog.onesadcookie.com/2008/01/installname-magic.html](http://blog.onesadcookie.com/2008/01/installname-magic.html) but that would be a lot of work. The best way to do something like that would be to have skpg-install systematically change the install_name of all libraries. Never mind that spkg-install is not aware of what it installs.",
    "created_at": "2014-04-02T09:52:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260577",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:2'></a>It is a fair question. DYLD_LIBRARY_PATH is defined in sage-env but I don't think it would have the kind of effects we see at building time. I will point my big (not so fat) finger at gcc. A OS X install will, by necessity, build a recent gcc. When did we switch to 4.7.3?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260578",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260580",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260581",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>...  while it **doesn't** touch hardcoded (absolute) `install_name`s (also seen on MacOS X 10.6) in Darwin's dynamic library files (`.dylib`, `.so`).\n\nm)",
    "created_at": "2014-04-02T18:33:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260582",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:7'></a>...  while it **doesn't** touch hardcoded (absolute) `install_name`s (also seen on MacOS X 10.6) in Darwin's dynamic library files (`.dylib`, `.so`).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260585",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260586",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260587",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260588",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>> Looks as if relocation was currently broken on **any** Darwin (at least MacOS X 10.6, too) anyway.  Not going to tell you what happened when trying `make [p]testlong` in the renamed beta5 installation...\n\nOh, that is bad.  Especially since people download binaries and might move them a few times.  I'm going to ask on sage-release about that.\n> > The only useful info in `man install_name_tool` is that if you want to change the names to long ones is that you want to pass the `-header-pad_max_install_names` option to `ld`.\n\n> \n> :-)  Depends on what weird paths users decide to install / move Sage into.\n\nWe already don't allow spaces very much, so this is not too big of a restriction I think.",
    "created_at": "2014-04-03T01:40:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260589",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>> Looks as if relocation was currently broken on **any** Darwin (at least MacOS X 10.6, too) anyway.  Not going to tell you what happened when trying `make [p]testlong` in the renamed beta5 installation...
...
```json
{
    "body": "<a id='comment:15'></a>W.r.t. relocation on Darwin, fbissey could perhaps confirm I'm not telling nonsense (nor made some stupid mistake).",
    "created_at": "2014-04-03T02:34:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260590",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:15'></a>W.r.t. relocation on Darwin, fbissey could perhaps confirm I'm not telling nonsense (nor made some stupid mistake).
...
```json
{
    "body": "<a id='comment:16'></a>Have to give it a go. I cannot say I haven't worried about relocation but I am not a practioner.",
    "created_at": "2014-04-03T02:41:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260591",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:16'></a>Have to give it a go. I cannot say I haven't worried about relocation but I am not a practioner.
...
```json
{
    "body": "<a id='comment:18'></a>My compilerwrapper https://bitbucket.org/vbraun/compilerwrapper is designed to correctly set install_name / rpaths globally.",
    "created_at": "2014-04-03T10:34:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260593",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:18'></a>My compilerwrapper https://bitbucket.org/vbraun/compilerwrapper is designed to correctly set install_name / rpaths globally.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260594",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260595",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260596",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>> > Looks as if relocation was currently broken on **any** Darwin (at least MacOS X 10.6, too) anyway.  Not going to tell you what happened when trying `make [p]testlong` in the renamed beta5 installation...\n\n> Oh, that is bad.  Especially since people download binaries and might move them a few times.  I'm going to ask on sage-release about that.\n\nAgain, my concern here is especially that when people download binaries that they work, since those are technically relocated (by actual miles, not just bits).",
    "created_at": "2014-04-03T14:52:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260597",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:22'></a>> > Looks as if relocation was currently broken on **any** Darwin (at least MacOS X 10.6, too) anyway.  Not going to tell you what happened when trying `make [p]testlong` in the renamed beta5 installation...
...
```json
{
    "body": "<a id='comment:23'></a>I see these, too, after relocating. If I rebuild just git and run tests again, everything passes.",
    "created_at": "2014-04-03T15:00:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260598",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>I see these, too, after relocating. If I rebuild just git and run tests again, everything passes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260599",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>It was some beta for 6.2, I think 6.2.beta3. I have since deleted it. To be clear:\n\n- I moved it and ran `make ptestlong`. I got the above failures.\n- Then I did `./sage -f git`, did `make ptestlong` again, and everything passed. No other packages were rebuilt when I did `make ptestlong`.\n\nI'll try again, to confirm this.",
    "created_at": "2014-04-03T16:22:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260600",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:25'></a>It was some beta for 6.2, I think 6.2.beta3. I have since deleted it. To be clear:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260601",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Normal priority as it does not affect a first-class platform",
    "created_at": "2014-04-20T23:41:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260603",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:28'></a>Normal priority as it does not affect a first-class platform
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260605",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>If / while you're at it:\n\nLine 152 of R's `spkg-install` currently gives a \"command not found\" error:\n\n```sh\n        RINSTALL_MOVED = yes\n```\nThis should be:\n\n```sh\n        RINSTALL_MOVED=yes\n```",
    "created_at": "2014-05-02T20:35:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260606",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:31'></a>If / while you're at it:
...
```json
{
    "body": "<a id='comment:32'></a>Karl-Dieter, could you paste the relevant part of the rpy2 install log?\n\n---\n\nIf you don't want to mess with R, a work-around could be setting `DYLD_FALLBACK_LIBRARY_PATH` to the relevant folders in **rpy2's** `spkg-install`.",
    "created_at": "2014-05-02T20:53:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260607",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:32'></a>Karl-Dieter, could you paste the relevant part of the rpy2 install log?
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16044#event-47167"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>OK I have started a branch for pari. Should we split the ticket of should I give a go at R and all the others on the same branch and ticket?",
    "created_at": "2014-05-14T01:18:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260609",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:35'></a>OK I have started a branch for pari. Should we split the ticket of should I give a go at R and all the others on the same branch and ticket?
...
```json
{
    "body": "<a id='comment:36'></a>In this event, I'd prefer a minimally invasive thing here for PPC and just rpy (which means fixing R, of course) so it is easy for me to test.  And indeed this is the only library preventing build (or even doctest failures, this is one of only a few) on the platform in the ticket.\n\nDoesn't mean we shouldn't fix the rest!  This is purely for my convenience in testing.",
    "created_at": "2014-05-14T01:25:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260610",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:36'></a>In this event, I'd prefer a minimally invasive thing here for PPC and just rpy (which means fixing R, of course) so it is easy for me to test.  And indeed this is the only library preventing build (or even doctest failures, this is one of only a few) on the platform in the ticket.
...
```json
{
    "body": "<a id='comment:37'></a>Well the ticket title is a bit broader than R but I will look at doing something for it now. If we decide to split for convenience later is another matter.",
    "created_at": "2014-05-14T01:30:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260611",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:37'></a>Well the ticket title is a bit broader than R but I will look at doing something for it now. If we decide to split for convenience later is another matter.
...
```json
{
    "body": "<a id='comment:38'></a>I have a hack. The like of I just vetoed Leif from using in cddlib. The main issue here is that the stuff we need to change is set in configure/configure.ac. In effect we would have to change the sources and re-run autoconf.\n\nBecause we don't want to do that we have to apply some work around. Either passing some variables to make to override the stuff set by autoconf or possibly patching Makefile.in in the various affected sub-folder. In both case we have to be careful each time we change the version of R. It is a royal pain. Do we know anyone upstream in R (and no I don't in spite of being in New Zealand).",
    "created_at": "2014-05-14T03:10:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260612",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:38'></a>I have a hack. The like of I just vetoed Leif from using in cddlib. The main issue here is that the stuff we need to change is set in configure/configure.ac. In effect we would have to change the sources and re-run autoconf.
...
```json
{
    "body": "<a id='comment:39'></a>And it actually only worked for libR.dylib because of the way substitutions are done...\nWill have to patch Makefile.in to avoid triggering autoreconf...",
    "created_at": "2014-05-14T03:19:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260613",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:39'></a>And it actually only worked for libR.dylib because of the way substitutions are done...
Will have to patch Makefile.in to avoid triggering autoreconf...
...
```json
{
    "body": "<a id='comment:40'></a>We already patch configure so I will do that.",
    "created_at": "2014-05-14T03:27:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260614",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:40'></a>We already patch configure so I will do that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260615",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>Try the patch in attachment. Just drop it in the patches folder of r and do\n\n```\n ./sage -f r-3.0.2.p0\n```\nand your problem should be solved I'll do a proper push to a branch with patch description later.",
    "created_at": "2014-05-14T09:29:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260616",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:41'></a>Try the patch in attachment. Just drop it in the patches folder of r and do
...
```json
{
    "body": "<a id='comment:42'></a>I think I'm pretty confident this will work properly; I'll try it tomorrow (the next time I'll have access to that machine).    I agree that it's a bit of a hack but I doubt upstream will be interested in something proper.  Thank YOU :-)",
    "created_at": "2014-05-14T17:29:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260617",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:42'></a>I think I'm pretty confident this will work properly; I'll try it tomorrow (the next time I'll have access to that machine).    I agree that it's a bit of a hack but I doubt upstream will be interested in something proper.  Thank YOU :-)
...
```json
{
    "body": "<a id='comment:44'></a>I didn't have that problem on maverick but I can see how the problem occurs. We may have to change the install_name from spkg-install after the install proper. I am glad I didn't push anything.",
    "created_at": "2014-05-15T21:56:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260619",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:44'></a>I didn't have that problem on maverick but I can see how the problem occurs. We may have to change the install_name from spkg-install after the install proper. I am glad I didn't push anything.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16044#event-47168"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16044#event-47169"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>This continues to be the only thing preventing Sage from building on this platform... passes many tests!  (Mostly those not are timeouts.)  I won't be able to check on this again for a month, but if something pops up in the meantime that'd be swell ;-)",
    "created_at": "2014-09-17T19:18:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260620",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:46'></a>This continues to be the only thing preventing Sage from building on this platform... passes many tests!  (Mostly those not are timeouts.)  I won't be able to check on this again for a month, but if something pops up in the meantime that'd be swell ;-)
...
```json
{
    "body": "<a id='comment:48'></a>Not 100% sure. Especially since I am guessing you want to produce a working sage for OS X 10.4. One thing to try. Instead of building with just \"make\", try:\n\n```\nLDFLAGS=\"-Wl,-rpath=$path_to_sage_local_lib\" make\n```\nif rpath is supported by ld that may work. Otherwise I may need to have the full man page for ld on the machine in question to try to figure out something.",
    "created_at": "2014-12-16T02:30:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260622",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:48'></a>Not 100% sure. Especially since I am guessing you want to produce a working sage for OS X 10.4. One thing to try. Instead of building with just "make", try:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260623",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:50'></a>I am not sure that -Wl argument would do anything apart confusing ld. You can always fix the problem after the install. The install_name_tool can be used to do the fix. And for your R case the problem is that SAGE_LOCAL isn't expanded. You shouldn't have used a variable there. I thought it would be problematic and it appears it is.",
    "created_at": "2014-12-16T03:33:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260624",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:50'></a>I am not sure that -Wl argument would do anything apart confusing ld. You can always fix the problem after the install. The install_name_tool can be used to do the fix. And for your R case the problem is that SAGE_LOCAL isn't expanded. You shouldn't have used a variable there. I thought it would be problematic and it appears it is.
...
```json
{
    "body": "<a id='comment:51'></a>> OK I have started a branch for pari. Should we split the ticket of should I give a go at R and all the others on the same branch and ticket? \n\n\nI think that for now, given other incompatibilities (see #17513) it would be best to keep this for R and open a different ticket to do the more mundane ones, in particular your branch for Pari which is probably still a good idea, right?",
    "created_at": "2015-01-05T17:35:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260625",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:51'></a>> OK I have started a branch for pari. Should we split the ticket of should I give a go at R and all the others on the same branch and ticket? 
...
```json
{
    "body": "<a id='comment:52'></a>Hum I am not sure that exist anymore locally. Now I remember what happened with pari. We had settings in the pari spkg, inherited from William, that \"destroyed\" the correct build flags. We fixed pari if I remember correctly.",
    "created_at": "2015-01-05T18:58:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260626",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:52'></a>Hum I am not sure that exist anymore locally. Now I remember what happened with pari. We had settings in the pari spkg, inherited from William, that "destroyed" the correct build flags. We fixed pari if I remember correctly.
...
```json
{
    "body": "<a id='comment:53'></a>> Hum I am not sure that exist anymore locally. Now I remember what happened with pari. We had settings in the pari spkg, inherited from William, that \"destroyed\" the correct build flags. We fixed pari if I remember correctly.\n\n\nYou mean [this](http://trac.sagemath.org/ticket/16017#comment:42) was fixed?",
    "created_at": "2015-01-05T20:38:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260627",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:53'></a>> Hum I am not sure that exist anymore locally. Now I remember what happened with pari. We had settings in the pari spkg, inherited from William, that "destroyed" the correct build flags. We fixed pari if I remember correctly.
...
```json
{
    "body": "<a id='comment:54'></a>Bother I thought it was. I'll make an issue to remove this braindamage ASAP.",
    "created_at": "2015-01-05T21:42:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260628",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:54'></a>Bother I thought it was. I'll make an issue to remove this braindamage ASAP.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260629",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>It is now #17588.",
    "created_at": "2015-01-05T21:49:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260630",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:55'></a>It is now #17588.
...
```json
{
    "body": "Changing dependencies from \"17588\" to \"\"",
    "created_at": "2015-01-06T14:07:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260632",
    "user": "https://github.com/kcrisman"
}
```

Changing dependencies from "17588" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260633",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:58'></a>output of\n\n```\nnm libRblas.dylib | grep drot\n```\n?",
    "created_at": "2015-01-06T18:51:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260634",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:58'></a>output of
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260635",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:60'></a>The problem is that `install_name_tool` didn't seem to do the right thing.  See above from `otool`\n\n```\n/Users/student/Desktop/sage-6.4.1-gcc-4.7/local/lib/R/lib/libRblas.dylib\n(compatibility version 0.0.0, current version 0.0.0)\n```",
    "created_at": "2015-01-06T19:07:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260636",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:60'></a>The problem is that `install_name_tool` didn't seem to do the right thing.  See above from `otool`
...
```json
{
    "body": "<a id='comment:61'></a>#19370 apparently is quite relevant.",
    "created_at": "2015-10-16T01:45:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260637",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:61'></a>#19370 apparently is quite relevant.
...
```json
{
    "body": "<a id='comment:62'></a>It is, it makes this a duplicate. Once #19370 is closed we should mark this as a duplicate. In my opinion there are still stuff that is hard to fix in `R` (`install_names` of all the `R` packages are missing) but really that becomes upstream's job at this point.",
    "created_at": "2015-10-16T01:48:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260638",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:62'></a>It is, it makes this a duplicate. Once #19370 is closed we should mark this as a duplicate. In my opinion there are still stuff that is hard to fix in `R` (`install_names` of all the `R` packages are missing) but really that becomes upstream's job at this point.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260639",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16044#event-47170"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16044#event-47171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260640",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260641",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16044#issuecomment-260642",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16044",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16044#event-47172"
}
```
