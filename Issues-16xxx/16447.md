...
```json
{
    "body": "<a id='comment:4'></a>The SR issue is different from this commutative algebra ticket. There are also too many cryptic tracebacks in Sage IMO, so I think a warning should be it.",
    "created_at": "2014-06-06T06:44:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16447#issuecomment-211377",
    "user": "https://github.com/rwst"
}
```

<a id='comment:4'></a>The SR issue is different from this commutative algebra ticket. There are also too many cryptic tracebacks in Sage IMO, so I think a warning should be it.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16447#event-48365"
}
```
