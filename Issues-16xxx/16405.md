...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|\n|[8b547db](http://git.sagemath.org/sage.git/commit/?id=8b547db0ecdae108a3fa94b69010b579edb0d149)|`16405: cartesian product of rings and generalization of many cartesian product features`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[eced39e](http://git.sagemath.org/sage.git/commit/?id=eced39e483d11838ad826694a7fd29e26c3cdf64)|`16405: fixed trivial doctest failure and ReST indentation`|",
    "created_at": "2014-06-02T08:10:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16405",
    "type": "issue_comment",
