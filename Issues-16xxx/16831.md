...
```json
{
    "body": "<a id='comment:3'></a>It turns out this problem can be circumvented by making `TensorProducts` a method, rather than a subclass:\n\n```\nclass TestCat(Category_over_base_ring):\n    @cached_method\n    def super_categories(self):\n        return []\n    class ParentMethods:\n        def mytestmthd(self):\n            return \"ok\"\n    def TensorProducts(self):\n        return TestCat_TensorProducts(self)\n\nclass TestCat_TensorProducts(TensorProductsCategory):\n        def _repr_(self):\n            return \"my tensor tst category\" \n        @cached_method\n        def extra_super_categories(self):\n            return [self.base_category()]\n        class ParentMethods:\n            def tenstestmthd(self):\n                return \"ok\"\n```\n\nSeems I've been hit by black-category-magic once again...\n\nBut even with this \"fix\" the `TensorProductsCategory(C)` still throws an error.",
    "created_at": "2014-08-15T22:15:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16831#issuecomment-218504",
    "user": "https://github.com/cnassau"
}
```

<a id='comment:3'></a>It turns out this problem can be circumvented by making `TensorProducts` a method, rather than a subclass:
