...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271448",
    "user": "https://trac.sagemath.org/admin/accounts/users/foosterhof"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271449",
    "user": "https://trac.sagemath.org/admin/accounts/users/foosterhof"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271450",
    "user": "https://trac.sagemath.org/admin/accounts/users/foosterhof"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271451",
    "user": "https://trac.sagemath.org/admin/accounts/users/foosterhof"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271452",
    "user": "https://trac.sagemath.org/admin/accounts/users/foosterhof"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271453",
    "user": "https://trac.sagemath.org/admin/accounts/users/foosterhof"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271454",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271455",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The following hangs:\n\n```\nl = sage.combinat.misc.DoublyLinkedList(xrange(5))\nl.insert(0)\nl\n```",
    "created_at": "2014-06-27T09:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271456",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```

<a id='comment:5'></a>The following hangs:
...
```json
{
    "body": "<a id='comment:8'></a>I forgot for a moment that I could simply take a look at the code :) . Anyway, the implementation of remove() takes O(log n) time, not O(1) as advertised in the docstring, since next_value and prev_value are dictionaries.",
    "created_at": "2014-06-28T07:43:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271459",
    "user": "https://trac.sagemath.org/admin/accounts/users/Rudi"
}
```

<a id='comment:8'></a>I forgot for a moment that I could simply take a look at the code :) . Anyway, the implementation of remove() takes O(log n) time, not O(1) as advertised in the docstring, since next_value and prev_value are dictionaries.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16467#event-48406"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>tests do not pass",
    "created_at": "2015-08-09T12:30:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271460",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:10'></a>tests do not pass
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16467#issuecomment-271461",
    "user": "https://github.com/fchapoton"
}
```
