...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|\n|[bb0dcf0](http://git.sagemath.org/sage.git/commit/?id=bb0dcf0db6ec98f44c91062c54bf03d32749ffd8)|`Ticket 16465 : some operations on classes of combinatorial structures (as unlabelled structures).`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[2a76bb4](http://git.sagemath.org/sage.git/commit/?id=2a76bb402baa95497b3de94b8e95da2c71c9271b)|`Ticket 16465 : (unlabelled) sequence of structures`|",
