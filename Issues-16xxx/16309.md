...
```json
{
    "body": "<a id='comment:1'></a>That's really silly, as the names and defaults are easy to get:\n\n```\nsage: Bla.join.func_code.co_varnames\n('categories', 'as_list', 'ignore_axioms', 'axioms')\nsage: Bla.join.func_defaults\n(False, (), ())",
    "created_at": "2014-05-08T14:31:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267140",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>That's really silly, as the names and defaults are easy to get:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267142",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267144",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267145",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/SimonKing/ticket/16309\"",
    "created_at": "2014-05-08T21:02:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267149",
    "user": "https://github.com/simon-king-jena"
}
```

Changing branch from "" to "u/SimonKing/ticket/16309"
...
```json
{
    "body": "Changing commit from \"\" to \"32a374ffaece155c52a21cb2cef970eee18a79e4\"",
    "created_at": "2014-05-08T21:05:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267150",
    "user": "https://github.com/simon-king-jena"
}
```

Changing commit from "" to "32a374ffaece155c52a21cb2cef970eee18a79e4"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267152",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Hmm. At the moment, I tend to say that this already needs review. The problem described in the previous comment only occurs of `Bla` has no docstring, since otherwise Cython adds embedding information to the docstring.\n\nHence, as long as all classes in Sage get a docstring, we will have no problem. And the fix should be enough for #16296.",
    "created_at": "2014-05-08T21:22:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267153",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>Hmm. At the moment, I tend to say that this already needs review. The problem described in the previous comment only occurs of `Bla` has no docstring, since otherwise Cython adds embedding information to the docstring.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267154",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Catching the `TypeError` does not solve the example above, but it does solve a modified example: If `B` is provided with a docstring, then its source can be detected from the embedding information.\n\nSo, what we should learn: Always provide a docstring!",
    "created_at": "2014-05-08T23:56:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267156",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:14'></a>Catching the `TypeError` does not solve the example above, but it does solve a modified example: If `B` is provided with a docstring, then its source can be detected from the embedding information.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267157",
...
```json
{
    "body": "Changing commit from \"32a374ffaece155c52a21cb2cef970eee18a79e4\" to \"787737761fd909e740f35440ec53ee722a0c52ec\"",
    "created_at": "2014-05-09T00:16:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267158",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "32a374ffaece155c52a21cb2cef970eee18a79e4" to "787737761fd909e740f35440ec53ee722a0c52ec"
...
```json
{
    "body": "<a id='comment:16'></a>So far, I have no idea how to find the sources of a class that is defined in a Cython file, has no docstring and inherits a documented `__init__` method from some other class. However, *if* the class has a documentation, then we can now correctly detect a nested class.\n\nNote that a nested class defined in a Cython file does not have a dot in its name. However, Cython provides an attribute `__qualname__`, and there one does find the full name, including the dot. I have changed sageinspect to use this (new?) feature.\n\nI suppose now it can really be reviewed. It will be essential for Cythoning sage.categories.category.",
    "created_at": "2014-05-09T00:21:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267159",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:16'></a>So far, I have no idea how to find the sources of a class that is defined in a Cython file, has no docstring and inherits a documented `__init__` method from some other class. However, *if* the class has a documentation, then we can now correctly detect a nested class.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16309#event-48066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267160",
...
```json
{
    "body": "<a id='comment:18'></a>Hey Simon,\n\nOnce you remove line 1643:\n\n```\n....: from sage.misc.nested_class import NestedClassMetaclass\n```\nas it is unused in the doctest, LGTM and you can set a positive review.",
    "created_at": "2014-06-13T17:49:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267161",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:18'></a>Hey Simon,
...
```json
{
    "body": "Changing branch from \"u/SimonKing/ticket/16309\" to \"u/tscrim/argspec_static_methods-16309\"",
    "created_at": "2014-07-24T06:53:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267162",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "u/SimonKing/ticket/16309" to "u/tscrim/argspec_static_methods-16309"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267163",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing commit from \"787737761fd909e740f35440ec53ee722a0c52ec\" to \"143b56779f9e69c9718765a0312fc37274bc34dc\"",
    "created_at": "2014-07-24T06:53:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267164",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "787737761fd909e740f35440ec53ee722a0c52ec" to "143b56779f9e69c9718765a0312fc37274bc34dc"
...
```json
{
    "body": "<a id='comment:19'></a>I've removed the line from the doctest and since it is a trivial change, I'm going to set this to positive review.\n\n```\nsage -t sageinspect.py\n    [263 tests, 39.52 s]\n----------------------------------------------------------------------\nAll tests passed!\n----------------------------------------------------------------------\nTotal time for all tests: 39.9 seconds\n    cpu time: 5.0 seconds\n    cumulative wall time: 39.5 seconds\n```\n\n---\nNew commits:",
    "created_at": "2014-07-24T06:53:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267165",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:19'></a>I've removed the line from the doctest and since it is a trivial change, I'm going to set this to positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267166",
...
```json
{
    "body": "Changing branch from \"u/tscrim/argspec_static_methods-16309\" to \"143b56779f9e69c9718765a0312fc37274bc34dc\"",
    "created_at": "2014-07-25T05:05:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16309#issuecomment-267167",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/tscrim/argspec_static_methods-16309" to "143b56779f9e69c9718765a0312fc37274bc34dc"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16309",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16309#event-48067"
}
```
