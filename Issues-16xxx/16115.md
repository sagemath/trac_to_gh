...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262402",
    "user": "https://trac.sagemath.org/admin/accounts/users/sbesnier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262403",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262404",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>See also #7368 for another to-do list for isogenies.",
    "created_at": "2014-04-11T11:16:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262406",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:2'></a>See also #7368 for another to-do list for isogenies.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262407",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262408",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>About `SchemeMorphism` also see the description of #14711 of why it currently does not inherit `Morphism` (simple enough reason, cython won't let you do that currently...).\n\nIIRC this was the corresponding discussion:\n* https://groups.google.com/d/msg/cython-users/-GvwK6sEF0E/vAaliNBQ9XMJ",
    "created_at": "2014-04-18T15:49:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262409",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:6'></a>About `SchemeMorphism` also see the description of #14711 of why it currently does not inherit `Morphism` (simple enough reason, cython won't let you do that currently...).
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16115#event-47486"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I implemented Weierstrass morphisms in 2007: it was the first piece of Sage development I did.  Until that time it was impossible to change models or move points from one model to another!  And the implementation of isogenies was done much later than that.\n\nI do agree that the EllipticCurveIsogeny class is not designed in the way I would want it to be, but it works well enough and has been used an enormous amount over QQ and over number fields, even if it has not been possible (for example) to compose isogenies.\n\nI also agree with Peter that the domain and codomain must be elliptic curves, and not sets or groups of points.\n\nI am currently working on extending the class IsogenyClass_EC to work over number fields (see #16743).  I don't expect that the work done on this and related tickets will affect that a lot.",
    "created_at": "2014-07-30T13:12:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262410",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:8'></a>I implemented Weierstrass morphisms in 2007: it was the first piece of Sage development I did.  Until that time it was impossible to change models or move points from one model to another!  And the implementation of isogenies was done much later than that.
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16115#event-47487"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16115#event-47488"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>added",
    "created_at": "2015-10-20T18:45:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262411",
    "user": "https://trac.sagemath.org/admin/accounts/users/adhalanay"
}
```

<a id='comment:10'></a>added
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16115#event-47489"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16115#event-47490"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I think this is resolved with #32388 and #32502.",
    "created_at": "2021-10-23T06:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262412",
    "user": "https://github.com/yyyyx4"
}
```

<a id='comment:12'></a>I think this is resolved with #32388 and #32502.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262413",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>I agree.",
    "created_at": "2022-09-17T16:56:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262414",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:13'></a>I agree.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262415",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262416",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262417",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16115#issuecomment-262418",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16115",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16115#event-47491"
}
```
