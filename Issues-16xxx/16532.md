...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16532#issuecomment-212959",
...
```json
{
    "body": "<a id='comment:3'></a>Or, if calling `register_coercion` during creation of B rather than A is no option, you should/could rely on `_coerce_map_from_` (on B, of course).",
    "created_at": "2014-06-25T11:39:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16532#issuecomment-212960",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>Or, if calling `register_coercion` during creation of B rather than A is no option, you should/could rely on `_coerce_map_from_` (on B, of course).
...
```json
{
    "body": "<a id='comment:4'></a>Okay, then we need to get back on #15303 as setting up `_coerce_map_from_` can be somewhat painful for things with multiple realizations (ex. symmetric functions). Also, do you think it's worthwhile documenting this somewhere and if so, where? The coercion thematic tutorial(s) or somewhere in `coerce.pyx`?",
    "created_at": "2014-06-25T14:21:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16532#issuecomment-212961",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>Okay, then we need to get back on #15303 as setting up `_coerce_map_from_` can be somewhat painful for things with multiple realizations (ex. symmetric functions). Also, do you think it's worthwhile documenting this somewhere and if so, where? The coercion thematic tutorial(s) or somewhere in `coerce.pyx`?
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16532#event-48540"
}
```
