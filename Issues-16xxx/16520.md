...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16520#event-218378"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16520#event-218379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16520#event-218380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16520#event-218381"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16520#issuecomment-216715",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16520#issuecomment-216716",
    "user": "https://github.com/rwst"
}
```
