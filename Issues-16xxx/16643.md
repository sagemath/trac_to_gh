...
```json
{
    "body": "<a id='comment:3'></a>I changed the title and description, because I found evidence there is no infinite loop involved. Please change back if you're unhappy with the change.",
    "created_at": "2014-07-10T15:54:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276249",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:3'></a>I changed the title and description, because I found evidence there is no infinite loop involved. Please change back if you're unhappy with the change.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276250",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276251",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276252",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276253",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16643#event-48809"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>See also #12731.",
    "created_at": "2014-12-08T15:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276254",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>See also #12731.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276255",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>It's claimed that upstream has this 'fixed' in some sense now.",
    "created_at": "2014-12-15T13:06:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276256",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>It's claimed that upstream has this 'fixed' in some sense now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276257",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276258",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16643#event-48810"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16643#event-48811"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>With Maxima 5.34.1 and also with 5.35.1 (see #17514), both integrals are returned unevaluated:\n\n```\nsage: f = diff((tan(x) + x) * e^tan(x), x)\nsage: %time integrate(f, x)\nCPU times: user 5min 32s, sys: 12 ms, total: 5min 32s\nWall time: 5min 33s\nintegrate((tan(x)^2 + 1)*(x + tan(x))*e^tan(x) + (tan(x)^2 + 2)*e^tan(x), x)\nsage: g = e^tan(x) * sec(x)^2 * (tan(x) + x) + e^tan(x) * (sec(x)^2 + 1)\nsage: %time integrate(g,x)\nCPU times: user 4min 43s, sys: 128 ms, total: 4min 44s\nWall time: 4min 44s\nintegrate((x + tan(x))*e^tan(x)*sec(x)^2 + (sec(x)^2 + 1)*e^tan(x), x)\n```\nI propose to close this since the ECL error appears to have been fixed upstream and the example takes too long to be a sensible doctest.",
    "created_at": "2014-12-16T15:57:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276259",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:10'></a>With Maxima 5.34.1 and also with 5.35.1 (see #17514), both integrals are returned unevaluated:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276262",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Yeah, probably can't have a ticket that says \"make integrals that take a long time faster\", too vague.",
    "created_at": "2015-02-03T03:14:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276263",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:13'></a>Yeah, probably can't have a ticket that says "make integrals that take a long time faster", too vague.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276264",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16643#event-48812"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16643#issuecomment-276265",
