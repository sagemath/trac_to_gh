# Issue 16524: symbolic_expression: Better handling of vectors and matrices
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16524#event-49083"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16524#event-49084"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16524#event-49085"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16524#event-49086"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16524#event-49087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16524",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16524#event-49088"
}
```
