...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274583",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274584",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274585",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Reviewed the patch...looks fine.",
    "created_at": "2014-07-19T17:49:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274586",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:2'></a>Reviewed the patch...looks fine.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274588",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274589",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274590",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274591",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274592",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I now replaced a `dict` by an `OrderedDict` in order to avoid the problem that the order of the output seems to be architecture-dependent. The performance overhead should be bearable as we sort anyway to collect transitions between the same pairs of states.",
    "created_at": "2014-07-21T08:59:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274593",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:7'></a>I now replaced a `dict` by an `OrderedDict` in order to avoid the problem that the order of the output seems to be architecture-dependent. The performance overhead should be bearable as we sort anyway to collect transitions between the same pairs of states.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274594",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274595",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>There seems to be a problem that 0<'I' does not always give the same answer; see\nhttps://groups.google.com/d/topic/sage-devel/zzVpd5yZ_Rw/discussion .",
    "created_at": "2014-07-22T17:00:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274597",
    "user": "https://github.com/cheuberg"
}
```

<a id='comment:10'></a>There seems to be a problem that 0<'I' does not always give the same answer; see
https://groups.google.com/d/topic/sage-devel/zzVpd5yZ_Rw/discussion .
...
```json
{
    "body": "<a id='comment:11'></a>Wouldn't a doctest template like this:\n\n```\n    \\begin{tikzpicture}[auto, initial text=, >=latex, accepting text=, accepting/.style=accepting by arrow, accepting distance=10ex]\n...\n    \\node[state] (v1) at (-6.000000, 3.000000) {$\\mathbf{0}$};\n    \\path[->] (v1.180.00) edge node[rotate=360.00, anchor=south] {$\\$ \\mid \\varepsilon$} ++(180.00:10ex);\n...\n    \\end{tikzpicture}\n```\nbe good enough? Then the whole order thing gets avoided and we're still testing that the output has some of the desired characteristics.",
    "created_at": "2014-07-22T19:51:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274598",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:11'></a>Wouldn't a doctest template like this:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274600",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274601",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274602",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274603",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274605",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274606",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Reviewed the changes. It's a positive_review for me.\n\nCan someone test it on osx and if tests pass give it a positive review?",
    "created_at": "2014-07-23T07:35:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274607",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:16'></a>Reviewed the changes. It's a positive_review for me.
...
```json
{
    "body": "<a id='comment:17'></a>It was now tested on osx as well (thanks to R.B.).",
    "created_at": "2014-07-30T10:54:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274608",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:17'></a>It was now tested on osx as well (thanks to R.B.).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274609",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16580#event-48653"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274610",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16580#issuecomment-274611",
    "user": "https://github.com/vbraun"
}
```
