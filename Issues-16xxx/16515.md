...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16515#issuecomment-216570",
    "user": "https://github.com/sagetrac-tcoffee"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16515#issuecomment-216571",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16515#event-218281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16515#event-218282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16515#event-218283"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16515",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16515#event-218284"
}
```
