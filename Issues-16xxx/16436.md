...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16436#issuecomment-270383",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16436#issuecomment-270385",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>If, as i proposed on sage-devel we could have an overlay (say, `RR`) for real fields, the syntax `CC(3) in RR` would be very readable. The only problem with `CC(3) in RealField(2)` is about `NaN` and `+/-Infinity`, but you should notice that the same problem exists with the current `.is_real()` methods, so the solution is not clean either.",
    "created_at": "2014-06-04T20:25:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16436#issuecomment-270386",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:5'></a>If, as i proposed on sage-devel we could have an overlay (say, `RR`) for real fields, the syntax `CC(3) in RR` would be very readable. The only problem with `CC(3) in RealField(2)` is about `NaN` and `+/-Infinity`, but you should notice that the same problem exists with the current `.is_real()` methods, so the solution is not clean either.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16436#issuecomment-270387",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16436#event-48349"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [tmonteil](#comment%3A1):\n> Hi Sebastien. Note that you can also use coercion with the poorest real representation:\n> \n> \n> ```\n> sage: AA(3) in RealField(2)\n> True\n> ```\n\nSee #12967 and #17984 for why `x in RR` will determine elementship in `RR` not in the mathematical **R**. For this `is_real` is meant.",
    "created_at": "2015-03-21T09:45:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16436#issuecomment-270388",
    "user": "https://github.com/rwst"
}
```

<a id='comment:8'></a>Replying to [tmonteil](#comment%3A1):
> Hi Sebastien. Note that you can also use coercion with the poorest real representation:
> 
> 
> ```
...
```json
{
    "body": "<a id='comment:9'></a>One clean way to implement `is_real` might be to compare x with its conjugate, which is implemented quite often:\n\n```\nsage: def is_real(x):\n....:     return(x == x.conjugate())\n....:\nsage: is_real(ZZ(3))\nTrue\nsage: is_real(QQ(3))\nTrue\nsage: is_real(AA(3))\nTrue\nsage: is_real(RR(3))\nTrue\nsage: is_real(CC(3))\nTrue\n```\nOne could handle `is_imaginary` similarly.",
    "created_at": "2016-04-09T23:31:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16436#issuecomment-270389",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:9'></a>One clean way to implement `is_real` might be to compare x with its conjugate, which is implemented quite often:
