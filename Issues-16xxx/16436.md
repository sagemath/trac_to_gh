...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217168"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16436#issuecomment-214770",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16436#issuecomment-214771",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217172"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217173"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217174"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16436#event-217175"
}
```
