...
```json
{
    "body": "<a id='comment:7'></a>\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[f72a8ed](http://git.sagemath.org/sage.git/commit/?id=f72a8ed01c5745f16f8f1bb317cd5e81d6cf6584)|`Added basic design theory methods`|",
    "created_at": "2015-03-10T02:02:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16534",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[0da6340](http://git.sagemath.org/sage.git/commit/?id=0da6340d92c0f82ca39b7bd862fcf771135dc6e8)|`new basic design theory methods`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[dc5e9c6](http://git.sagemath.org/sage.git/commit/?id=dc5e9c654673101f1875cc3e1cc7221ce4c8d6c0)|`add basic design theory methods and modified packing method`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[426017f](http://git.sagemath.org/sage.git/commit/?id=426017f9590239ab7f967e54a72bf2ef1097121b)|`Added basic design theory methods`|\n|[7ed801f](http://git.sagemath.org/sage.git/commit/?id=7ed801fe7ca73423b394dafb163ce4f34cb3f092)|`fixed first problem in rebase`|\n|[f59048c](http://git.sagemath.org/sage.git/commit/?id=f59048cb60ad74fa438d3f74be09b21e9d690dbd)|`add basic design theory methods and modified packing method`|\n|[3e9bf9c](http://git.sagemath.org/sage.git/commit/?id=3e9bf9cd32cd60867ca43065544259d3fca2cdca)|`rebased to develop`|\n|[5843227](http://git.sagemath.org/sage.git/commit/?id=5843227fc99940401057d609fd9362c4de299996)|`removed blocks_by_size, added examples for union, improved packing, rebased to develop`|\n|[2a3ec4b](http://git.sagemath.org/sage.git/commit/?id=2a3ec4b10a60faf396b1aca933a7e0b40cc98b35)|`Merge branch 'u/brett/design' of git://trac.sagemath.org/sage into design`|",
    "created_at": "2015-03-12T14:29:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16534",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[13280d9](http://git.sagemath.org/sage.git/commit/?id=13280d995c98d13fbf2b9637411d3988999453e1)|`fixed more merging issues`|",
    "created_at": "2015-03-12T15:27:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16534",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[0c935a3](http://git.sagemath.org/sage.git/commit/?id=0c935a3fddca65fea1534110c62ace88bc0b7296)|`made TODO more precise`|",
    "created_at": "2015-03-12T15:58:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16534",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                                                                                                                                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[910b437](http://git.sagemath.org/sage.git/commit/?id=910b4370825c97971adf1320722162fce6b3c52c)|`clean up, improve documentation readibility, added simple option to union, added repeated block choice to user in residual and derived, improved speed with sets and integer cals when sets not possible, shortened method names, added citation for residual and derived.`|",
