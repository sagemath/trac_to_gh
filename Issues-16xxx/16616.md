...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16616#event-219967"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16616#event-219968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16616#event-219969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16616#event-219970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16616#issuecomment-219070",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16616#issuecomment-219071",
    "user": "https://github.com/nbruin"
}
```
