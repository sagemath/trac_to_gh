...
```json
{
    "body": "<a id='comment:1'></a>Maxima (the `.nintegrate` method) seems to have a similar problem.",
    "created_at": "2014-08-29T16:06:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16905#issuecomment-234252",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Maxima (the `.nintegrate` method) seems to have a similar problem.
