...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260162",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Also fails for D,B affine as well. So maybe it has something to do with the `KR_type_vertical`? But it also fails for the D spinors...and works for digraphs on restricted index sets:\n\n```\nsage: C = KirillovReshetikhinCrystal(['A',5,2], 1,1)\nsage: G = C.digraph(index_set=[1,2,3])\nsage: G = C.digraph(index_set=[0,1,2])\n```\nI'm quite puzzled right now about this...",
    "created_at": "2014-03-27T23:13:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260163",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>Also fails for D,B affine as well. So maybe it has something to do with the `KR_type_vertical`? But it also fails for the D spinors...and works for digraphs on restricted index sets:
...
```json
{
    "body": "<a id='comment:6'></a>Okay the problem is in that the latex produced, one of the controls is very small. In fact I get a `2.8588e-15`, and pdflatex errors out saying (ironically)\n\n> ! Dimension too large.\n\n\nIf I set that value to 0, I'm able to compile. So I'm just going to replace them out.",
    "created_at": "2014-03-27T23:39:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260166",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:6'></a>Okay the problem is in that the latex produced, one of the controls is very small. In fact I get a `2.8588e-15`, and pdflatex errors out saying (ironically)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260167",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"58607e63a6c0e12e49ef7e5b26abe0bf751ef4a1\"",
    "created_at": "2014-03-27T23:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260168",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "" to "58607e63a6c0e12e49ef7e5b26abe0bf751ef4a1"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260169",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"public/combinat/crystals/fix_A2odd_KR-16026\"",
    "created_at": "2014-03-27T23:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260170",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "" to "public/combinat/crystals/fix_A2odd_KR-16026"
...
```json
{
    "body": "<a id='comment:7'></a>Okay, I've pushed my (hack) fix, but IDK of a good way to put in a test for it. I also can't say what's going on for you Anne as dot2tex works fine for me (on my ubuntu home machine).\n\n---\nNew commits:",
    "created_at": "2014-03-27T23:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260171",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>Okay, I've pushed my (hack) fix, but IDK of a good way to put in a test for it. I also can't say what's going on for you Anne as dot2tex works fine for me (on my ubuntu home machine).
...
```json
{
    "body": "<a id='comment:8'></a>Well, for me all viewing worked until I upgraded to sage-6.2.beta5 to check this ticket. And now for some reason Sage thinks that dot2tex is not installed even though it is.",
    "created_at": "2014-03-28T02:58:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260172",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:8'></a>Well, for me all viewing worked until I upgraded to sage-6.2.beta5 to check this ticket. And now for some reason Sage thinks that dot2tex is not installed even though it is.
...
```json
{
    "body": "<a id='comment:9'></a>Hmmmm... Instead of working on regexp, couldn't we convert them to float and round them ?....",
    "created_at": "2014-03-28T06:46:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260173",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:9'></a>Hmmmm... Instead of working on regexp, couldn't we convert them to float and round them ?....
...
```json
{
    "body": "<a id='comment:10'></a>Wouldn't that involve patching the `dot2tex` spkg? Perhaps we should do #14408 and see what happens too?\n\n`@`Anne, perhaps with the recent upgrade of matplotlib (which I didn't do because it errored out for me) is breaking dot2tex similar to #14594.\n\nLeif, do you have any thoughts on this?",
    "created_at": "2014-03-28T15:21:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260174",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:10'></a>Wouldn't that involve patching the `dot2tex` spkg? Perhaps we should do #14408 and see what happens too?
...
```json
{
    "body": "<a id='comment:11'></a>FTR, the matplotlib update ticket is #14993.",
    "created_at": "2014-03-29T15:18:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260175",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:11'></a>FTR, the matplotlib update ticket is #14993.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260177",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>First of all, whats up with the that catch-all \"dot2tex not available\" error message. If you can't be helpful then don't catch errors, just let the exception propagate so we can see what is wrong. And, as usual, if you want a feature to work then you need to doctest it.\n\nYou need to remove patches/use-matplotlib-pyparsing.patch from the dot2tex spkg. Whose idea was it to import internals of matplotlib? Did you think that it is not going to break with the next matplotlib update?",
    "created_at": "2014-03-29T17:04:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260178",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:15'></a>First of all, whats up with the that catch-all "dot2tex not available" error message. If you can't be helpful then don't catch errors, just let the exception propagate so we can see what is wrong. And, as usual, if you want a feature to work then you need to doctest it.
...
```json
{
    "body": "Changing branch from \"public/combinat/crystals/fix_A2odd_KR-16026\" to \"u/vbraun/dot2tex\"",
    "created_at": "2014-03-29T20:06:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260182",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/combinat/crystals/fix_A2odd_KR-16026" to "u/vbraun/dot2tex"
...
```json
{
    "body": "<a id='comment:20'></a>The whole drawing stuff also used invalid node labels that newer dot2tex barfs about...\n\n---\nNew commits:",
    "created_at": "2014-03-29T20:11:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260183",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:20'></a>The whole drawing stuff also used invalid node labels that newer dot2tex barfs about...
...
```json
{
    "body": "Changing commit from \"58607e63a6c0e12e49ef7e5b26abe0bf751ef4a1\" to \"702c72b0c4fa9f3247a94a6168daf6fe157a143e\"",
    "created_at": "2014-03-29T20:11:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260184",
    "user": "https://github.com/vbraun"
}
```

Changing commit from "58607e63a6c0e12e49ef7e5b26abe0bf751ef4a1" to "702c72b0c4fa9f3247a94a6168daf6fe157a143e"
...
```json
{
    "body": "<a id='comment:21'></a>Also, you can doctest the latex generation. And if you need dot2tex all the time then work towards making it a standard package.",
    "created_at": "2014-03-29T20:14:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260185",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:21'></a>Also, you can doctest the latex generation. And if you need dot2tex all the time then work towards making it a standard package.
...
```json
{
    "body": "<a id='comment:22'></a>Try this spkg: http://sage.math.washington.edu/home/palmieri/SPKG/dot2tex-2.8.7.p3.spkg. It should fix at least some of the problems, I think. (It's not ready for review: it has uncommitted changes, and someone should convert it to a new style package.)",
    "created_at": "2014-03-29T20:19:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260186",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:22'></a>Try this spkg: http://sage.math.washington.edu/home/palmieri/SPKG/dot2tex-2.8.7.p3.spkg. It should fix at least some of the problems, I think. (It's not ready for review: it has uncommitted changes, and someone should convert it to a new style package.)
...
```json
{
    "body": "<a id='comment:23'></a>Sorry, Volker, I didn't notice your branch. It's pretty similar to my spkg, except that I also added this line (maybe unnecessary):\n\n```\n_noncomma = \"\".join( [ c for c in printables if c != \",\" ] )\n```\nto compensate for not importing it.",
    "created_at": "2014-03-29T20:21:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260187",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>Sorry, Volker, I didn't notice your branch. It's pretty similar to my spkg, except that I also added this line (maybe unnecessary):
...
```json
{
    "body": "<a id='comment:25'></a>Maybe you should use something else to draw your figures, then",
    "created_at": "2014-03-29T20:40:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260189",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:25'></a>Maybe you should use something else to draw your figures, then
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260190",
...
```json
{
    "body": "Changing commit from \"702c72b0c4fa9f3247a94a6168daf6fe157a143e\" to \"e8abf26678ad91ba5b4da9fb9f26c91e8a16736b\"",
    "created_at": "2014-03-29T20:46:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260191",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "702c72b0c4fa9f3247a94a6168daf6fe157a143e" to "e8abf26678ad91ba5b4da9fb9f26c91e8a16736b"
...
```json
{
    "body": "<a id='comment:27'></a>John, nothing in dot2tex refers to `_noncomma`.",
    "created_at": "2014-03-29T20:48:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260192",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:27'></a>John, nothing in dot2tex refers to `_noncomma`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260193",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260194",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260195",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260197",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Replying to [aschilling](#comment%3A30):\n> ImportError: dlopen(/Applications/sage/local/lib/python2.7/site-packages/sage/graphs/cliquer.so, 2): Symbol not found: \t\"#\n>   Referenced from: /Applications/sage/local/lib/libcliquer.so\n>   Expected in: flat namespace\n\n\nDoes a \"make distclean && make\" fix it?",
    "created_at": "2014-03-29T23:51:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260198",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:32'></a>Replying to [aschilling](#comment%3A30):
> ImportError: dlopen(/Applications/sage/local/lib/python2.7/site-packages/sage/graphs/cliquer.so, 2): Symbol not found: 	"#
>   Referenced from: /Applications/sage/local/lib/libcliquer.so
>   Expected in: flat namespace
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260199",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing author from \"Travis Scrimshaw\" to \"Volker Braun\"",
    "created_at": "2014-03-29T23:51:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260200",
    "user": "https://github.com/vbraun"
}
```

Changing author from "Travis Scrimshaw" to "Volker Braun"
...
```json
{
    "body": "Changing commit from \"e8abf26678ad91ba5b4da9fb9f26c91e8a16736b\" to \"289c212d438819939c24e6aa77bd0aeef8ff59ba\"",
    "created_at": "2014-03-30T10:40:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260203",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e8abf26678ad91ba5b4da9fb9f26c91e8a16736b" to "289c212d438819939c24e6aa77bd0aeef8ff59ba"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260204",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260205",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Anne: so whats in the pycrypto log?",
    "created_at": "2014-03-30T10:42:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260206",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:39'></a>Anne: so whats in the pycrypto log?
...
```json
{
    "body": "<a id='comment:40'></a>Leif: You can't go around and import stuff from package internals, that will break with the next update in exactly the way we saw here. Also you can't use the git branch with old versions.",
    "created_at": "2014-03-30T10:45:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260207",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:40'></a>Leif: You can't go around and import stuff from package internals, that will break with the next update in exactly the way we saw here. Also you can't use the git branch with old versions.
...
```json
{
    "body": "Changing commit from \"289c212d438819939c24e6aa77bd0aeef8ff59ba\" to \"0c5b4f8702f15b239adb5412d31c138fe62d0f8b\"",
    "created_at": "2014-03-30T12:05:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260208",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "289c212d438819939c24e6aa77bd0aeef8ff59ba" to "0c5b4f8702f15b239adb5412d31c138fe62d0f8b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260209",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260210",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260212",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>Sounds like an unrelated failure. You can use `git fsck` to check that the git repository is undamaged (ignore dangling blobs, those are fine)...",
    "created_at": "2014-03-30T15:43:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260213",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:44'></a>Sounds like an unrelated failure. You can use `git fsck` to check that the git repository is undamaged (ignore dangling blobs, those are fine)...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260214",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>How do I uninstall my previous installation of dot2tex? Do I just delete the corresponding files in sage/build/pkgs? And then unpack dot2tex-20120520 there?",
    "created_at": "2014-03-30T16:56:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260215",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:46'></a>How do I uninstall my previous installation of dot2tex? Do I just delete the corresponding files in sage/build/pkgs? And then unpack dot2tex-20120520 there?
...
```json
{
    "body": "<a id='comment:47'></a>You can delete `local/lib/python/site-packages/dot2tex`. Or run `make distclean && make`, of course.",
    "created_at": "2014-03-30T18:47:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260216",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:47'></a>You can delete `local/lib/python/site-packages/dot2tex`. Or run `make distclean && make`, of course.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260217",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:49'></a>Running \"make distclean && make\" is equivalent to installing Sage from scratch.\n\nIf you get the same problem on a fresh install then it is unrelated to this ticket. Post to sage-devel. A google search finds this: https://groups.google.com/forum/#!topic/sage-devel/pcBPs9aRH6w",
    "created_at": "2014-03-31T00:21:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260218",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:49'></a>Running "make distclean && make" is equivalent to installing Sage from scratch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260219",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:53'></a>> A third comment: Anne, you need to put the tarball (no need to unpack it) in `sage/upstream`.\n\n\nThat is what I did, but then I got an error message (see above).",
    "created_at": "2014-03-31T16:17:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260222",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:53'></a>> A third comment: Anne, you need to put the tarball (no need to unpack it) in `sage/upstream`.
...
```json
{
    "body": "<a id='comment:54'></a>Run `sage -f dot2tex`. You can't specify file names.\n\nJohn: Feel free to open another ticket for a legacy spkg update.",
    "created_at": "2014-03-31T16:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260223",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:54'></a>Run `sage -f dot2tex`. You can't specify file names.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260224",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"0c5b4f8702f15b239adb5412d31c138fe62d0f8b\" to \"ad62d43a6488a30801c64513eafb7e9a20abb7db\"",
    "created_at": "2014-03-31T16:36:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260225",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0c5b4f8702f15b239adb5412d31c138fe62d0f8b" to "ad62d43a6488a30801c64513eafb7e9a20abb7db"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260226",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:57'></a>Replying to [aschilling](#comment%3A56):\n> Replying to [vbraun](#comment%3A54):\n> > Run `sage -f dot2tex`. You can't specify file names.\n\n> \n> This installs dot2tex-2.8.7.p2.spkg even if it is not in upstream and if dot2tex-20120520.tar.bz2 is the only dot2tex in upstream. At least for me.\n\n\nAre you using Volker's branch? What are the contents of `build/pkgs/dot2tex`?",
    "created_at": "2014-03-31T19:18:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260227",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:57'></a>Replying to [aschilling](#comment%3A56):
> Replying to [vbraun](#comment%3A54):
> > Run `sage -f dot2tex`. You can't specify file names.
...
```json
{
    "body": "<a id='comment:60'></a>Ok, Travis and I figured out the problem. There was a spurious folder dot2tex-20... in build/pkgs/ which I removed and now everything seems to work!",
    "created_at": "2014-03-31T20:59:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260230",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:60'></a>Ok, Travis and I figured out the problem. There was a spurious folder dot2tex-20... in build/pkgs/ which I removed and now everything seems to work!
...
```json
{
    "body": "<a id='comment:61'></a>The new skpg works (with matplotlib-1.2.something), but it doesn't fix my original problem of numerical instability. So I've merged in my old branch.",
    "created_at": "2014-04-01T19:58:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260231",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:61'></a>The new skpg works (with matplotlib-1.2.something), but it doesn't fix my original problem of numerical instability. So I've merged in my old branch.
...
```json
{
    "body": "Changing branch from \"u/vbraun/dot2tex\" to \"public/dot2tex\"",
    "created_at": "2014-04-01T19:58:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260232",
    "user": "https://github.com/tscrim"
}
```

Changing branch from "u/vbraun/dot2tex" to "public/dot2tex"
...
```json
{
    "body": "Changing commit from \"ad62d43a6488a30801c64513eafb7e9a20abb7db\" to \"\"",
    "created_at": "2014-04-01T19:58:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260233",
    "user": "https://github.com/tscrim"
}
```

Changing commit from "ad62d43a6488a30801c64513eafb7e9a20abb7db" to ""
...
```json
{
    "body": "Changing commit from \"\" to \"d9f3ba05fe69c12c440bf03058903f0336ad8600\"",
    "created_at": "2014-04-01T19:59:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260234",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "d9f3ba05fe69c12c440bf03058903f0336ad8600"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260235",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:63'></a>Did you try the patch from https://code.google.com/p/dot2tex/issues/detail?id=29, that would be a much better fix imho.",
    "created_at": "2014-04-01T20:12:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260236",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:63'></a>Did you try the patch from https://code.google.com/p/dot2tex/issues/detail?id=29, that would be a much better fix imho.
...
```json
{
    "body": "<a id='comment:64'></a>PS: I can't reproduce it with graphviz-2.34.0, which I think is responsible for the scientific notation output.",
    "created_at": "2014-04-01T20:13:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260237",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:64'></a>PS: I can't reproduce it with graphviz-2.34.0, which I think is responsible for the scientific notation output.
...
```json
{
    "body": "<a id='comment:65'></a>For me it also worked without Travis' fix (just using the new spkg from Volker).",
    "created_at": "2014-04-01T20:29:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260238",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:65'></a>For me it also worked without Travis' fix (just using the new spkg from Volker).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260239",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"d9f3ba05fe69c12c440bf03058903f0336ad8600\" to \"80fe9f9768279a14fa15570bbff81b28b695b14d\"",
    "created_at": "2014-04-01T20:58:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260240",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d9f3ba05fe69c12c440bf03058903f0336ad8600" to "80fe9f9768279a14fa15570bbff81b28b695b14d"
...
```json
{
    "body": "<a id='comment:67'></a>It probably only happens with certain computers. Anyways, I've added the patch from the link (with some rebasing) and reverted my other change (albeit not in the best git way). Now I can view all the pretty crystals. So if my changes are good, then I believe this is a positive review.",
    "created_at": "2014-04-01T21:01:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260241",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:67'></a>It probably only happens with certain computers. Anyways, I've added the patch from the link (with some rebasing) and reverted my other change (albeit not in the best git way). Now I can view all the pretty crystals. So if my changes are good, then I believe this is a positive review.
...
```json
{
    "body": "<a id='comment:68'></a>I am happy to set a positive review on Volker's branch, but as John ad Leif mention it might be good to have it work also with older versions of sage. I did not seem to require Travis' changes to make all pictures work.",
    "created_at": "2014-04-02T20:18:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260242",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:68'></a>I am happy to set a positive review on Volker's branch, but as John ad Leif mention it might be good to have it work also with older versions of sage. I did not seem to require Travis' changes to make all pictures work.
...
```json
{
    "body": "<a id='comment:69'></a>I don't actually use dot2tex, so I have nothing invested in this. I am happy to leave it as is and put off compatibility with older versions to another ticket (or indefinitely, hoping that it will sort itself out).",
    "created_at": "2014-04-02T20:20:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260243",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:69'></a>I don't actually use dot2tex, so I have nothing invested in this. I am happy to leave it as is and put off compatibility with older versions to another ticket (or indefinitely, hoping that it will sort itself out).
...
```json
{
    "body": "<a id='comment:70'></a>[Like I mentioned before](#comment%3A61), it did work with my matplotlib 1.2.x, so it might still work with older versions too. However, I'm okay with putting backwards compatibility off to another ticket (if anyone actually runs into a problem).",
    "created_at": "2014-04-02T20:26:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260244",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:70'></a>[Like I mentioned before](#comment%3A61), it did work with my matplotlib 1.2.x, so it might still work with older versions too. However, I'm okay with putting backwards compatibility off to another ticket (if anyone actually runs into a problem).
...
```json
{
    "body": "Changing reviewer from \"\" to \"Anne Schilling, Travis Scrimshaw\"",
    "created_at": "2014-04-03T06:37:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260245",
    "user": "https://github.com/anneschilling"
}
```

Changing reviewer from "" to "Anne Schilling, Travis Scrimshaw"
...
```json
{
    "body": "Changing keywords from \"\" to \"dot2tex\".",
    "created_at": "2014-04-03T06:37:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260246",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260247",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:72'></a>Travis and I reviewed the patch and everything seems to work well.",
    "created_at": "2014-04-03T06:40:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260248",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:72'></a>Travis and I reviewed the patch and everything seems to work well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16026#event-47131"
}
```
...
```json
{
    "body": "Changing branch from \"public/dot2tex\" to \"80fe9f9768279a14fa15570bbff81b28b695b14d\"",
    "created_at": "2014-04-04T15:55:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260249",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/dot2tex" to "80fe9f9768279a14fa15570bbff81b28b695b14d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260250",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"80fe9f9768279a14fa15570bbff81b28b695b14d\" to \"\"",
    "created_at": "2014-05-02T08:21:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260252",
    "user": "https://github.com/seblabbe"
}
```

Changing commit from "80fe9f9768279a14fa15570bbff81b28b695b14d" to ""
...
```json
{
    "body": "<a id='comment:75'></a>The tarball is not available at http://www.sagemath.org/packages/optional/. Or am I missing something?",
    "created_at": "2015-01-08T16:08:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16026#issuecomment-260253",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:75'></a>The tarball is not available at http://www.sagemath.org/packages/optional/. Or am I missing something?
