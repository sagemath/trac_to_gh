...
```json
{
    "body": "<a id='comment:3'></a>It's doing things naively, i.e. it adds terms up instead of building the list manually. Doing the list building ourselves would require reading a bit of Singular code to make sure we're doing it right\u2122.",
    "created_at": "2014-06-30T15:43:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16040#issuecomment-218444",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>It's doing things naively, i.e. it adds terms up instead of building the list manually. Doing the list building ourselves would require reading a bit of Singular code to make sure we're doing it right™.
...
```json
{
    "body": "<a id='comment:5'></a>Well, could the right thing to do be anything else but (1) sorting the dictionary items according to the term ordering, or (2) sorting the dictionary items according to the *inverse* term ordering, before feeding them to `p_Add_q`?",
    "created_at": "2015-07-23T14:26:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16040#issuecomment-218445",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Well, could the right thing to do be anything else but (1) sorting the dictionary items according to the term ordering, or (2) sorting the dictionary items according to the *inverse* term ordering, before feeding them to `p_Add_q`?
