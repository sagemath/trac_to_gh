...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16094#event-212311"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16094#event-212312"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16094#event-212313"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16094#event-212314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16094#issuecomment-207645",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16094",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16094#issuecomment-207646",
    "user": "https://github.com/sagetrac-nborie"
}
```
