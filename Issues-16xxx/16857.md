...
```json
{
    "body": "<a id='comment:5'></a>\nFirst attempt at contributing to sage...\n\n---\nNew commits:\n|                                                                                                                                          |                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[9c7d90c](https://git.sagemath.org/sage.git/commit?id=9c7d90c9e9627aabe34e0d76e4e7cc7df5844eb7)|`Added more documentation about ticks in plots`|",
    "created_at": "2016-10-08T21:12:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16857",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[d2a7a27](https://git.sagemath.org/sage.git/commit/?id=d2a7a27a62be75696b5ad6a3793bf63819aac99f)|`More documentation for ticks in plots`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[7c0d150](https://git.sagemath.org/sage.git/commit/?id=7c0d1508bcc97c42d28bdb9679cbe5478fcbc9c6)|`Changed reference from show to plot`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[2135954](https://git.sagemath.org/sage.git/commit/?id=213595493b1ebc555e15cde2977935f89ad13801)|`Added myself to authors, improved readability of examples`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[61f558b](https://git.sagemath.org/sage.git/commit/?id=61f558bdd6dc0edb56a4c22d68d53c04f2353fa0)|`Added space between some arguments, removed from authors`|\n|[4d3ceb4](https://git.sagemath.org/sage.git/commit/?id=4d3ceb478f0125a14f36d04d9793906753150da8)|`Merge branch 'develop' into t/16857/doc_ticks_in_plot`|",
    "created_at": "2016-11-14T15:05:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16857",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[8d10514](https://git.sagemath.org/sage.git/commit/?id=8d10514e1b4a7038077a0a6b01a99e2ec40ffd16)|`More space for readability`|",
