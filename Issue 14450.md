...
Failed example:
    Q = ClusterQuiver([This is the Trac macro *1,1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1,1-macro))
Expected:
...
Got:
    ...
    Traceback (most recent call last):
      ...
      File "<doctest sage.combinat.cluster_algebra_quiver.quiver.ClusterQuiver[37]>", line 1, in <module>
        Q = ClusterQuiver([This is the Trac macro *Integer* that was inherited from the migration called with arguments (1),Integer)](https://trac.sagemath.org/wiki/WikiMacros#Integer-macro))
