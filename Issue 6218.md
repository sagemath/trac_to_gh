# Issue 6218: [with patch, positive review] small changes to jacobian_morphism to make hyperelliptic curve arithmetic faster
...
```json
{
    ...
    "title": "[with patch, positive review] small changes to jacobian_morphism to make hyperelliptic curve arithmetic faster",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-49571",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-49572",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-49573",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-49574",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6218#issuecomment-49575",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6218",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6218#event-14585"
}
```
