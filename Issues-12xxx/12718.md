...
```json
{
    "body": "P.S.: The situation with Fortran is even worse.  We have a useless `sage_fortran` script and `SAGE_FORTRAN*` variables, instead of using `FC` (or `F77`), `FFLAGS`, `FCFLAGS` and `LDFLAGS` etc.",
    "created_at": "2012-04-30T12:57:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12718#issuecomment-152076",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35198"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35199"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35200"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35201"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35202"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35203"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12718#issuecomment-152077",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12718#issuecomment-152078",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35205"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12718#issuecomment-152079",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12718#issuecomment-152080",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12718#issuecomment-152081",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12718",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12718#event-35207"
}
```
