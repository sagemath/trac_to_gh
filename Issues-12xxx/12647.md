...
```json
{
    "body": "<a id='comment:1'></a>This still needs a documentation patch.",
    "created_at": "2012-03-09T21:31:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182449",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>This still needs a documentation patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182450",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Where do you suggest adding documentation? The reference manual ([here](http://sagemath.org/doc/reference/options.html) or [here](http://sagemath.org/doc/reference/environ.html), perhaps)? The top-level README.txt?",
    "created_at": "2012-03-12T20:20:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182451",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Where do you suggest adding documentation? The reference manual ([here](http://sagemath.org/doc/reference/options.html) or [here](http://sagemath.org/doc/reference/environ.html), perhaps)? The top-level README.txt?
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [12647_sagerc_doc.patch](tarball://root/attachments/some-uuid/ticket12647/12647_sagerc_doc.patch) by @jdemeyer created at 2012-03-13 16:54:51",
    "created_at": "2012-03-13T16:54:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182452",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>Attachment [12647_sagerc_doc.patch](tarball://root/attachments/some-uuid/ticket12647/12647_sagerc_doc.patch) by @jdemeyer created at 2012-03-13 16:54:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182453",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182454",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182455",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182456",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182458",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182459",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>(The \"review patch\" needs review.)",
    "created_at": "2012-03-14T18:57:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182460",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>(The "review patch" needs review.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182461",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182462",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>How about adding a commented template rc file, with examples for `CC`, `CFLAGS`, `MAKE` (e.g. conditionally, depending on the hostname), `SAGE_BROWSER`, `SAGE_ATLAS_LIB` etc.?\n\nMaybe on a follow-up ticket?\n\n\n(Unfortunately I meanwhile forgot most of what I had in mind... :-/ )",
    "created_at": "2012-03-16T11:53:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182463",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:8'></a>How about adding a commented template rc file, with examples for `CC`, `CFLAGS`, `MAKE` (e.g. conditionally, depending on the hostname), `SAGE_BROWSER`, `SAGE_ATLAS_LIB` etc.?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182465",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Setting `MAKE` in `sagerc` is a bad idea by the way: currently, `sage-env` is **not** sourced by `spkg/install` which runs the top-level `$MAKE`.  So, setting `MAKE=make -j4` in `sagerc` would only build individual packages in parallel, it would not build multiple packages concurrently.\n\nFixed the minor flaw, thanks for that.",
    "created_at": "2012-03-16T12:43:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182466",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Setting `MAKE` in `sagerc` is a bad idea by the way: currently, `sage-env` is **not** sourced by `spkg/install` which runs the top-level `$MAKE`.  So, setting `MAKE=make -j4` in `sagerc` would only build individual packages in parallel, it would not build multiple packages concurrently.
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [12647_sagerc.patch](tarball://root/attachments/some-uuid/ticket12647/12647_sagerc.patch) by @ppurka created at 2012-03-16 17:17:25\n\nIn some other ticket there were some concerns raised about the non-portability of `x\\+` in sed. Can't remember which ticket it was. The portable solutions were either `xx*` or `x\\{1,\\}`.",
    "created_at": "2012-03-16T17:17:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182467",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:12'></a>Attachment [12647_sagerc.patch](tarball://root/attachments/some-uuid/ticket12647/12647_sagerc.patch) by @ppurka created at 2012-03-16 17:17:25
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182468",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182469",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Regarding the use of sed here, this script is used every time Sage is run, and it hasn't caused any problems on any platform, presumably because (as Jeroen points out) this part only matters on Cygwin.  So I don't see any need to change anything.",
    "created_at": "2012-03-17T15:56:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182470",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:15'></a>Regarding the use of sed here, this script is used every time Sage is run, and it hasn't caused any problems on any platform, presumably because (as Jeroen points out) this part only matters on Cygwin.  So I don't see any need to change anything.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182471",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182472",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182473",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12647#event-34259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182474",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>The patch to `sage-env` causes a beta9 regression since `CFLAGS` are now no longer exported, which at least some spkgs relied on (i.e., their `spkg-install` sets or modifies them, but doesn't export them by itself since this used to be redundant).",
    "created_at": "2012-04-14T01:45:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182475",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:19'></a>The patch to `sage-env` causes a beta9 regression since `CFLAGS` are now no longer exported, which at least some spkgs relied on (i.e., their `spkg-install` sets or modifies them, but doesn't export them by itself since this used to be redundant).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182476",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182477",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182478",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Exporting a variable which you don't set has no effect.  Since `CFLAGS` wasn't (and still isn't) set in `sage-env`, the `export` did nothing.\n\nExample (GNU bash version 4.0.35(1)-release if it matters):\n\n```\njdemeyer@arcanis:~$ ( export FOO; env ) | grep FOO\njdemeyer@arcanis:~$ ( export FOO; FOO=; env ) | grep FOO\nFOO=\n```",
    "created_at": "2012-04-14T08:38:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182479",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>Exporting a variable which you don't set has no effect.  Since `CFLAGS` wasn't (and still isn't) set in `sage-env`, the `export` did nothing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12647#issuecomment-182480",
    "user": "https://github.com/nexttime"
}
```
