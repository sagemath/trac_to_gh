...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12278#issuecomment-148536",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12278#issuecomment-148537",
...
```json
{
    "body": "<a id='comment:3'></a>For the record, here is an example from John Palmieri showing that wrong answers can be output\nsilently when mixing parts_in and other arguments:\n\n```\nsage: [len(p) for p in Partitions(10, length=6, parts_in=[1,2])]\n[5, 6, 7, 8, 9, 10]\nsage: Partitions(10, parts_in=[1,2]).cardinality() == Partitions(10, length=6, parts_in=[1,2]).cardinality()\nTrue\n```",
    "created_at": "2012-08-31T06:56:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12278#issuecomment-148538",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:3'></a>For the record, here is an example from John Palmieri showing that wrong answers can be output
silently when mixing parts_in and other arguments:
...
```json
{
    "body": "<a id='comment:4'></a>Another example which breaks from Alejandro Morales:\n\n```\nPartitions(4,max_slope=-1,max_part=2).list()\n[[2,2]]\n```\nHowever it should return `[]` (i.e. no partitions satisfying the constaints).",
    "created_at": "2012-10-17T23:03:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12278#issuecomment-148539",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:4'></a>Another example which breaks from Alejandro Morales:
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12278#event-32815"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12278#event-32816"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12278#event-32817"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12278#event-32818"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12278#event-32819"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12278#event-32820"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12278#event-32821"
}
```
