...
```json
{
    "body": "Attachment [12635_remove_pbuild.patch](https://github.com/sagemath/sage/files/ticket12635/12635_remove_pbuild.patch) by @jdemeyer created at 2012-03-06 09:26:50\n\nApply to EXTCODE repository",
    "created_at": "2012-03-06T09:26:50Z",
    "issue": "https://github.com/sagemath/sage/issues/12635",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12635#issuecomment-143014",
    "user": "https://github.com/jdemeyer"
}
```

Attachment [12635_remove_pbuild.patch](https://github.com/sagemath/sage/files/ticket12635/12635_remove_pbuild.patch) by @jdemeyer created at 2012-03-06 09:26:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12635",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12635#issuecomment-143015",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12635",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12635#issuecomment-143016",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12635",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12635#issuecomment-143017",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12635",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12635#issuecomment-143018",
    "user": "https://github.com/jdemeyer"
}
```
