...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143391",
    "user": "https://trac.sagemath.org/admin/accounts/users/giraudo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143392",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143393",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143394",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143395",
    "user": "https://trac.sagemath.org/admin/accounts/users/giraudo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143396",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143397",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106226"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106227"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143398",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143399",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106228"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106229"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143400",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143401",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106230"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143402",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106232"
}
```
...
```json
{
    ...
    "label": "pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106233"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106234"
}
```
...
```json
{
    ...
    "label": "pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143403",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106236"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106237"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket12571/trac_12571-shifted_shuffle_of_permutations-reviewed.patch",
...
```json
{
    "body": "reviewed version, qfolded with the patch so as to avoid fuzz when applying the old patch after #14772. I added some more doctests and docstring text. Now rebased upon current version of #14772. Now with fixed docstring.",
    "created_at": "2013-08-21T13:03:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143404",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106238"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143405",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12571#issuecomment-143406",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12571",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12571#event-106241"
}
```
