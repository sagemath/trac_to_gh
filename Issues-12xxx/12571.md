...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12571#issuecomment-141834",
    "user": "https://github.com/sagetrac-giraudo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12571#issuecomment-141835",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12571#event-157800"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12571#event-157801"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12571",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12571#event-157802"
}
```
