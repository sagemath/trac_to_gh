...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34006"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34007"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34008"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34009"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34010"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34011"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12577#issuecomment-146285",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34013"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12577#event-34014"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>`change_ring_of_constants` is not a terrible name--it's pretty accurate.  Maybe we could do a bit better but I think long an clear is better than short and vague.",
    "created_at": "2019-01-23T12:12:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12577#issuecomment-146288",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>`change_ring_of_constants` is not a terrible name--it's pretty accurate.  Maybe we could do a bit better but I think long an clear is better than short and vague.
...
```json
{
    "body": "<a id='comment:10'></a>The problem with \"change\" also kind of problematic since it implies (to me anyways) an in-place modification, when really you're returning a new expression.  Maybe `convert_constants_to_ring(RR)`?",
    "created_at": "2019-01-23T12:13:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12577#issuecomment-146289",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>The problem with "change" also kind of problematic since it implies (to me anyways) an in-place modification, when really you're returning a new expression.  Maybe `convert_constants_to_ring(RR)`?
...
```json
{
    "body": "<a id='comment:12'></a>Removing the \"beginner\" tag from old tickets. Some could be returned to beginner-friendly status by adding a comment about what needs to be done. Some others might be easy for an experienced developer to finish.\n\nRelated ticket: #24850.",
    "created_at": "2020-05-27T02:49:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12577#issuecomment-146291",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:12'></a>Removing the "beginner" tag from old tickets. Some could be returned to beginner-friendly status by adding a comment about what needs to be done. Some others might be easy for an experienced developer to finish.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12577",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12577#issuecomment-146292",
    "user": "https://github.com/DaveWitteMorris"
}
```
