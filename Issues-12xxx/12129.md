...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12129#event-150435"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12129#event-150436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12129#event-150437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12129",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12129#issuecomment-132085",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12129",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12129#issuecomment-132086",
    "user": "https://github.com/tscrim"
}
```
