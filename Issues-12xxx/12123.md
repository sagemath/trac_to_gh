...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150346"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150349"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132029",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150350"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150351"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150352"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132030",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132031",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132032",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150354"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150355"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150356"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150357"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132033",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132034",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132035",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150359"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150360"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150361"
}
```
...
```json
{
    "body": "Changed keywords from **** to **piecewise**",
    "created_at": "2016-06-25T17:45:36Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132036",
    "user": "https://github.com/mkoeppe"
}
```

Changed keywords from **** to **piecewise**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132037",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132038",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150363"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150364"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150366"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132039",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132040",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12123#issuecomment-132041",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12123",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12123#event-150370"
}
```
