...
```json
{
    "body": "<a id='comment:1'></a>I'm not really sure that this is appropriate for a stopgap.  I mean, unless we put in a catch for the *specific* form like `integrate(x * sgn(x^2 - 1/4), x, -1, 0)`, we would have to put in a stopgap for the entire integration, which is ridiculous.  \n\nUnless we checked for the signum function with nonlinear operands in it sometime... but that's more than I have time to parse now.",
    "created_at": "2012-03-23T01:02:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184561",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>I'm not really sure that this is appropriate for a stopgap.  I mean, unless we put in a catch for the *specific* form like `integrate(x * sgn(x^2 - 1/4), x, -1, 0)`, we would have to put in a stopgap for the entire integration, which is ridiculous.  
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34581"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34582"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34583"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34584"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34585"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34586"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34587"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184562",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Naturally, if it becomes unnecessary to do so, we can just close this as wontfix.  This is the best equivalent to a stopgap I can come up with - or possibly we can raise a warning every time `abs_integrate` is used, though this won't stop the hangs and other weird interactions it causes.",
    "created_at": "2014-12-08T15:02:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184563",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Naturally, if it becomes unnecessary to do so, we can just close this as wontfix.  This is the best equivalent to a stopgap I can come up with - or possibly we can raise a warning every time `abs_integrate` is used, though this won't stop the hangs and other weird interactions it causes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184564",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Unfortunately, a lot of the most popular such integrals are not computed with sympy (yet?).  Not even `abs(x)`.\n\n```\nIn [1]: from sympy import *\n\nIn [2]: x=Symbol('x')\n\nIn [3]: integrate( abs(x), x)\nOut[3]: Integral(Abs(x), x)\n\nIn [4]: integrate( abs(x), (x, 0, 1))\nOut[4]: Integral(Abs(x), (x, 0, 1))\n```",
    "created_at": "2014-12-15T20:05:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184565",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>Unfortunately, a lot of the most popular such integrals are not computed with sympy (yet?).  Not even `abs(x)`.
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34588"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34589"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184568",
...
```json
{
    "body": "Changing branch from \"\" to \"u/rws/disable_abs_integrate\"",
    "created_at": "2015-03-07T15:58:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184570",
    "user": "https://github.com/rwst"
}
```

Changing branch from "" to "u/rws/disable_abs_integrate"
...
```json
{
    "body": "<a id='comment:16'></a>This commit removes the package, fixes/moves doctests. I have put those doctests testing the `abs_integrate` package into the wishlist #17910.\n\nIf someone is not comfortable doing this \"silently\", using expression tree walking I could add checks for `abs` and `sgn` and output ... what? Note, some integrals are now solved by Maxima proper.\n\n---\nNew commits:",
    "created_at": "2015-03-07T16:02:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184571",
    "user": "https://github.com/rwst"
}
```

<a id='comment:16'></a>This commit removes the package, fixes/moves doctests. I have put those doctests testing the `abs_integrate` package into the wishlist #17910.
...
```json
{
    "body": "Changing commit from \"\" to \"4790fc753098c35bbd5d2580b77f77ac511f3fdd\"",
    "created_at": "2015-03-07T16:02:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184572",
    "user": "https://github.com/rwst"
}
```

Changing commit from "" to "4790fc753098c35bbd5d2580b77f77ac511f3fdd"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184573",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184575",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184580",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184581",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>> > If we set this variable to the empty list, then no additional integrations will be attempted by Maxima (by default). But, we can still try them ourselves. So we could,\n> > \n> > 1. Try the standard Maxima `integrate`, and save the result.\n> > 2. Try `signum_int`, and see if the result matches the first one. If it does, ignore it. Otherwise, emit a warning and return the answer.\n> > 3. Try `abs_integrate_use_if`, and see if the result matches the first one. If it does, ignore it. Otherwise, emit a warning and return the answer.\n  \n> \n> That's an excellent find and it allows us to have much finer grained control over what integration methods should be tried. However, I'm not so sure that \"printing a warning\" is the right solution. There's a problem with stopgap messages in general:\n> - they just get printed. They can easily get lost if a lot of other output gets printed.\n> - they only get printed once. We're dealing here with an issue that only applies to certain integrals. We assume you're OK as long as the message is printed. When you run into the message, then the result you're looking at at that moment is suspect. After that one, the message doesn't get printed anymore, so you should consider all subsequent results suspect. However, since the behaviour is much more similar to the pre-message situation, it's easy to think that fresh computations in the same session are NOT suspect.\n> \n> I think it is better to simply NOT try the suspect integration methods upon a normal integral invocation and only resort to them when a special command/flag is given, e.g.:\n> \n> ```\n> sage: integrate(abs(sin(x)),x,0,pi)\n> integrate(abs(sin(x)), x, 0, pi)\n> sage: integrate(abs(sin(x)),x,0,pi, algorithm=\"spaced_out_maxima\")\n> 0\n> ```\n> or whatever access method we want to use (and whatever result we get from that).\n\n\n+1",
    "created_at": "2015-03-09T23:19:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184582",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:26'></a>> > If we set this variable to the empty list, then no additional integrations will be attempted by Maxima (by default). But, we can still try them ourselves. So we could,
> > 
> > 1. Try the standard Maxima `integrate`, and save the result.
> > 2. Try `signum_int`, and see if the result matches the first one. If it does, ignore it. Otherwise, emit a warning and return the answer.
> > 3. Try `abs_integrate_use_if`, and see if the result matches the first one. If it does, ignore it. Otherwise, emit a warning and return the answer.
...
```json
{
    "body": "<a id='comment:27'></a>Is that ticket really needs_review ? The last comments point to a needs_work.\n\nAnd notice that a needs_review ticket with no author won't suit Volker :-P",
    "created_at": "2015-03-15T20:37:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184583",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

<a id='comment:27'></a>Is that ticket really needs_review ? The last comments point to a needs_work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184584",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184586",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Related?  [This question.](http://ask.sagemath.org/question/26516/wrong-answer-for-integral/)",
    "created_at": "2015-04-13T18:39:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184587",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:30'></a>Related?  [This question.](http://ask.sagemath.org/question/26516/wrong-answer-for-integral/)
...
```json
{
    "body": "Changing commit from \"4790fc753098c35bbd5d2580b77f77ac511f3fdd\" to \"1993a28f9ea2dec2cfb255fddee6f01939f69372\"",
    "created_at": "2015-06-17T15:17:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184588",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "4790fc753098c35bbd5d2580b77f77ac511f3fdd" to "1993a28f9ea2dec2cfb255fddee6f01939f69372"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184589",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184590",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34590"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34591"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Never *remove* doctests, mark them as `# known bug (Trac #17910)`.",
    "created_at": "2015-06-17T16:57:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184592",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:34'></a>Never *remove* doctests, mark them as `# known bug (Trac #17910)`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184593",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184594",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184595",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184596",
...
```json
{
    "body": "Changing branch from \"u/rws/disable_abs_integrate\" to \"public/disable_abs_integrate\"",
    "created_at": "2019-04-24T19:23:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184597",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "u/rws/disable_abs_integrate" to "public/disable_abs_integrate"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184598",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changing commit from \"1993a28f9ea2dec2cfb255fddee6f01939f69372\" to \"209b2c86c77c9069b38f436331d683720a2faeec\"",
    "created_at": "2019-04-24T19:23:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184599",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "1993a28f9ea2dec2cfb255fddee6f01939f69372" to "209b2c86c77c9069b38f436331d683720a2faeec"
...
```json
{
    "body": "Changing commit from \"209b2c86c77c9069b38f436331d683720a2faeec\" to \"1993a28f9ea2dec2cfb255fddee6f01939f69372\"",
    "created_at": "2019-04-24T19:32:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184600",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "209b2c86c77c9069b38f436331d683720a2faeec" to "1993a28f9ea2dec2cfb255fddee6f01939f69372"
...
```json
{
    "body": "<a id='comment:41'></a>my merge was incorrect, so undone",
    "created_at": "2019-04-24T19:32:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184601",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:41'></a>my merge was incorrect, so undone
...
```json
{
    "body": "Changing branch from \"public/disable_abs_integrate\" to \"u/rws/disable_abs_integrate\"",
    "created_at": "2019-04-24T19:32:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184602",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "public/disable_abs_integrate" to "u/rws/disable_abs_integrate"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184603",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changing commit from \"1993a28f9ea2dec2cfb255fddee6f01939f69372\" to \"b5c9cc58cdda15c3d33e5a47ed953bd17989a6c2\"",
    "created_at": "2019-05-17T18:29:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184604",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "1993a28f9ea2dec2cfb255fddee6f01939f69372" to "b5c9cc58cdda15c3d33e5a47ed953bd17989a6c2"
...
```json
{
    "body": "<a id='comment:43'></a>Here is a fresh new branch\n\n---\nNew commits:",
    "created_at": "2019-05-17T18:29:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184605",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:43'></a>Here is a fresh new branch
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184606",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changing branch from \"u/rws/disable_abs_integrate\" to \"u/chapoton/12731\"",
    "created_at": "2019-05-17T18:29:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184607",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "u/rws/disable_abs_integrate" to "u/chapoton/12731"
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34592"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34593"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>Tagging by `known bug` allows to remember that one could hope for the answer displayed. I think Jeroen suggested to keep the doctest in this way, rather than remove them.\n\nAnd the `radexpand` example no longer works without `abs_integrate`, just returning unevaluated.",
    "created_at": "2019-05-17T19:50:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184609",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:45'></a>Tagging by `known bug` allows to remember that one could hope for the answer displayed. I think Jeroen suggested to keep the doctest in this way, rather than remove them.
...
```json
{
    "body": "<a id='comment:46'></a>bot is morally green, please review",
    "created_at": "2019-05-18T13:39:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184610",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:46'></a>bot is morally green, please review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184611",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184612",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:47'></a>looks good to me. Please add yourself as authors/reviewers...",
    "created_at": "2019-05-22T08:21:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184613",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:47'></a>looks good to me. Please add yourself as authors/reviewers...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184614",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34594"
}
```
...
```json
{
    "body": "Changing branch from \"u/chapoton/12731\" to \"b5c9cc58cdda15c3d33e5a47ed953bd17989a6c2\"",
    "created_at": "2019-05-24T18:29:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184615",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/chapoton/12731" to "b5c9cc58cdda15c3d33e5a47ed953bd17989a6c2"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184616",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"b5c9cc58cdda15c3d33e5a47ed953bd17989a6c2\" to \"\"",
    "created_at": "2019-06-28T01:05:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184617",
    "user": "https://github.com/kcrisman"
}
```

Changing commit from "b5c9cc58cdda15c3d33e5a47ed953bd17989a6c2" to ""
...
```json
{
    "body": "<a id='comment:50'></a>At least according to github, the following stuff in `sage/maxima_lib.py` was not removed (probably because it still passes doctests as Maxima proper improved in the meantime):\n\n```\n        Make sure the abs_integrate package is being used,\n        :trac:`11483`. The following are examples from the Maxima\n        abs_integrate documentation::\n            sage: integrate(abs(x), x)\n            1/2*x*abs(x)\n```",
    "created_at": "2019-06-28T01:05:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184618",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:50'></a>At least according to github, the following stuff in `sage/maxima_lib.py` was not removed (probably because it still passes doctests as Maxima proper improved in the meantime):
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34595"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12731#event-34596"
}
```
...
```json
{
    "body": "<a id='comment:51'></a>Not in Sage 8.8.  Let's please to try keep tickets' milestones related to the release in which we actually intend to include them, and in particular the release in which they were *actually* included, especially when closing tickets.",
    "created_at": "2019-07-03T11:34:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12731",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12731#issuecomment-184619",
    "user": "https://github.com/embray"
}
```

<a id='comment:51'></a>Not in Sage 8.8.  Let's please to try keep tickets' milestones related to the release in which we actually intend to include them, and in particular the release in which they were *actually* included, especially when closing tickets.
