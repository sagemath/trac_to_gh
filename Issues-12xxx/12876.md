...
archive/attachments_017966.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac_12876_category-fix_abstract_class-nt-rel11521.patch](https://github.com/sagemath/sage/files/ticket12876/trac_12876_category-fix_abstract_class-nt-rel11521.patch)\n\nNicolas' patch rebased rel #11521",
    "created_at": "2012-04-27T07:47:43Z",
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
...
archive/attachments_017967.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12876-reviewer.patch](https://github.com/sagemath/sage/files/ticket12876/trac_12876-reviewer.patch)",
    "created_at": "2012-04-27T14:00:57Z",
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
...
```json
{
    "body": "**Changing work issues** from \"Fix ring_refcount_dict problem\" to \"Fix the review-nt patch\".",
...
**Changing work issues** from "Fix ring_refcount_dict problem" to "Fix the review-nt patch".



---

archive/attachments_017968.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Changing work issues** from \"Fix the review-nt patch\" to \"Fix the review-nt patch, fix doctests in map.pyx and homset.py\".",
...
**Changing work issues** from "Fix the review-nt patch" to "Fix the review-nt patch, fix doctests in map.pyx and homset.py".
...
```json
{
    "body": "**Changing work issues** from \"Fix the review-nt patch, fix doctests in map.pyx and homset.py\" to \"Fx doctests in map.pyx and homset.py\".",
...
**Changing work issues** from "Fix the review-nt patch, fix doctests in map.pyx and homset.py" to "Fx doctests in map.pyx and homset.py".
...
```json
{
    "body": "**Changing work issues** from \"Fx doctests in map.pyx and homset.py\" to \"Fx doctests in sageinspect.py\".",
...
**Changing work issues** from "Fx doctests in map.pyx and homset.py" to "Fx doctests in sageinspect.py".
...
```json
{
    "body": "**Changing work issues** from \"Fx doctests in sageinspect.py\" to \"\".",
...
**Changing work issues** from "Fx doctests in sageinspect.py" to "".
...
```json
{
    "body": "**Changing work issues** from \"commit message\" to \"fix doctests and segfaults\".",
...
**Changing work issues** from "commit message" to "fix doctests and segfaults".
...
```json
{
    "body": "**Attachment:** [trac_12876_fix_infinite_polynomial_ring.patch](https://github.com/sagemath/sage/files/ticket12876/trac_12876_fix_infinite_polynomial_ring.patch)\n\nDo not weak-cache things in infinite_polynomial_ring that are cached anyway. Skip more tests in Hecke homset's `TestSuite`",
    "created_at": "2012-08-29T13:00:34Z",
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
...
```json
{
    "body": "**Changing work issues** from \"fix doctests and segfaults\" to \"add commit message to one patch\".",
    "created_at": "2012-08-29T21:24:16Z",
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
...
**Changing work issues** from "fix doctests and segfaults" to "add commit message to one patch".
...
```json
{
    "body": "**Changing work issues** from \"add commit message to one patch\" to \"Understand why the crash in infinite_polynomial_ring is not fixed and what happens with r\".",
...
**Changing work issues** from "add commit message to one patch" to "Understand why the crash in infinite_polynomial_ring is not fixed and what happens with r".
...
```json
{
    "body": "**Changing work issues** from \"Understand why the crash in infinite_polynomial_ring is not fixed and what happens with r\" to \"\".",
...
**Changing work issues** from "Understand why the crash in infinite_polynomial_ring is not fixed and what happens with r" to "".
...
```json
{
    "body": "**Changing work issues** from \"needs rebase\" to \"failing tests; design issue\".",
...
**Changing work issues** from "needs rebase" to "failing tests; design issue".
...
```json
{
    "body": "**Changing work issues** from \"failing tests; design issue\" to \"\".",
...
**Changing work issues** from "failing tests; design issue" to "".
...
```json
{
    "body": "**Attachment:** [trac_12876_r_test.patch](https://github.com/sagemath/sage/files/ticket12876/trac_12876_r_test.patch)\n\nTry to make one test in interfaces/r.py more stable wrt symbolic links",
    "created_at": "2013-05-24T05:32:09Z",
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147763",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147764",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147765",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147766",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147767",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147768",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147769",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147770",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147771",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147772",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "**Attachment:** [trac_12876-review.patch](https://github.com/sagemath/sage/files/ticket12876/trac_12876-review.patch)",
    "created_at": "2013-05-24T14:45:12Z",
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147773",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147774",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147775",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147776",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147777",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "**Attachment:** [trac_12876_category_abstract_classes_for_hom.patch](https://github.com/sagemath/sage/files/ticket12876/trac_12876_category_abstract_classes_for_hom.patch)\n\nCombined patch",
    "created_at": "2013-05-24T15:09:34Z",
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147778",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147779",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147780",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147781",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147782",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147783",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12876#issuecomment-147784",
    "user": "https://github.com/jdemeyer"
}
```
