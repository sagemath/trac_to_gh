...
```json
{
    "body": "<div id=\"comment:343\" align=\"right\">comment:343</div>\n\nIt would probably be better to keep a symlink `$SAGE_LOCAL/include/FLINT -> flint` for a while...  which would also have avoided [this](https://github.com/sagemath/sage/issues/14600#comment:4).",
