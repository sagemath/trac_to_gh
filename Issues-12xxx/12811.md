...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12811#event-161681"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12811#event-161682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12811#event-161683"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12811#issuecomment-146244",
    "user": "https://github.com/dansme"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12811#issuecomment-146245",
    "user": "https://github.com/jdemeyer"
}
```
