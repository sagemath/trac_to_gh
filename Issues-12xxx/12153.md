...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12153#event-150804"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12153#event-150805"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12153#event-150806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12153#issuecomment-132505",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12153",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12153#issuecomment-132506",
    "user": "https://github.com/jdemeyer"
}
```
