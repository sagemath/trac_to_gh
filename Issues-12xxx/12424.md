...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12424#issuecomment-138488",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12424#issuecomment-138489",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12424#issuecomment-138490",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [trac_12424-symmetrica.2.patch](https://github.com/sagemath/sage/files/ticket12424/trac_12424-symmetrica.2.patch) by @jhpalmieri created at 2012-02-05 16:57:41",
    "created_at": "2012-02-05T16:57:41Z",
    "issue": "https://github.com/sagemath/sage/issues/12424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12424#issuecomment-138491",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [trac_12424-symmetrica.2.patch](https://github.com/sagemath/sage/files/ticket12424/trac_12424-symmetrica.2.patch) by @jhpalmieri created at 2012-02-05 16:57:41
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_12424-symmetrica.patch](https://github.com/sagemath/sage/files/ticket12424/trac_12424-symmetrica.patch) by @jhpalmieri created at 2012-04-21 17:20:51\n\nI think this should be closed, since building gcc (#12369) allows symmetrica to build without problems.",
    "created_at": "2012-04-21T17:20:51Z",
    "issue": "https://github.com/sagemath/sage/issues/12424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12424#issuecomment-138492",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12424#issuecomment-138493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12424",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12424#issuecomment-138494",
    "user": "https://github.com/jdemeyer"
}
```
