...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143882"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143883"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143884"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143885"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143886"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143887"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12037#issuecomment-130311",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12037#issuecomment-130312",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143888"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12037",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-143889"
}
```
