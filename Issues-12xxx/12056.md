...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12056#issuecomment-130530",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12056#issuecomment-130531",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket12056/12056_sdist.patch",
    "created_at": "2011-11-21T14:50:48Z",
    "issue": "https://github.com/sagemath/sage/issues/12056",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12056/12056_sdist.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Attachment [12056_sdist.patch](https://github.com/sagemath/sage/files/ticket12056/12056_sdist.patch) by @jdemeyer created at 2011-11-21 14:50:48\n\nApply to SCRIPTS repository",
    "created_at": "2011-11-21T14:50:48Z",
    "issue": "https://github.com/sagemath/sage/issues/12056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12056#issuecomment-130532",
    "user": "https://github.com/jdemeyer"
}
```

Attachment [12056_sdist.patch](https://github.com/sagemath/sage/files/ticket12056/12056_sdist.patch) by @jdemeyer created at 2011-11-21 14:50:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12056#issuecomment-130533",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12056#issuecomment-130534",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12056#issuecomment-130535",
    "user": "https://github.com/jdemeyer"
}
```
