...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158447"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158451"
}
```
...
```json
{
    "body": "Changed keywords from **** to **getitem**",
    "created_at": "2012-05-19T16:05:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12956",
    "type": "issue_comment",
...
Changed keywords from **** to **getitem**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12956#issuecomment-149245",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158453"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12956#issuecomment-149246",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12956",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12956#event-158455"
}
```
