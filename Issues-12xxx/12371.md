...
```json
{
    "body": "<a id='comment:33'></a>I wrote some initial patches, but after that, Nathann is the one who did the authoring, so I'm not sure the changes of[comment:32](#comment%3A32) are correct.",
...
<a id='comment:33'></a>I wrote some initial patches, but after that, Nathann is the one who did the authoring, so I'm not sure the changes of[comment:32](#comment%3A32) are correct.
...
<a id='comment:34'></a>Replying to [Snark](#comment%3A33):
> I wrote some initial patches, but after that, Nathann is the one who did the authoring, so I'm not sure the changes of[comment:32](#comment%3A32) are correct.
