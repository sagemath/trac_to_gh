...
```json
{
    "body": "<a id='comment:17'></a>\nTesting:\n\n```\nsage: R.<X,Y> = ZZ[]\nsage: latex(X-Y)\nX - Y\n```\n(single space present between '-' and Y)\n\n```\nsage: latex(X^2-X)\nX^{2} - X\n```\n(single space present between '-' and X)\n\n---\nNew commits:\n|                                                                                                                                          |                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[7573eb9](https://git.sagemath.org/sage.git/commit?id=7573eb9aecb377d47d199654b6ad591db13204cd)|`Remove unnecessary blank in latex expression of multivariate polynomial`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[ea2d10f](https://git.sagemath.org/sage.git/commit/?id=ea2d10f5c0083d54d2fd7b95da6d159199fd9df5)|`Add test case`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------|\n|[75d9956](https://git.sagemath.org/sage.git/commit/?id=75d995617ab858f83ee7e80e28c7de524770390a)|`Nit fixes`|",
    "created_at": "2019-01-04T12:44:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12908",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------|\n|[3ab45d5](https://git.sagemath.org/sage.git/commit/?id=3ab45d5fe2e106436b12e0c7cfed99d0416525fa)|`Fix doctests`|",
    "created_at": "2019-01-04T13:11:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12908",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:33'></a>\nSquashed.  Thanks Durgesh.  \n  \n---\nNew commits:\n|                                                                                                                                          |                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[86d9920](https://git.sagemath.org/sage.git/commit?id=86d9920a0dea3d92b062f34636465991df0591a3)|`Remove unnecessary blank in latex expression of multivariate polynomial`|",
    "created_at": "2019-01-07T14:26:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12908",
    "type": "issue_comment",
