...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150924"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150928"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,12 @@\n Anyone can run `sage --patchbot` to contribute.\n+\n+*Instructions:*\n+\n+For versions before 5.0:\n+\n+* apply [attachment: patchbot.patch.gz](https://github.com/sagemath/sage/files/ticket12486/patchbot.patch.gz) to the scripts repo.\n+\n+For version 5.0 (and 5.0betaN, etc):\n+\n+* apply [attachment: patchbot-root-5.0.patch.gz](https://github.com/sagemath/sage/files/ticket12486/patchbot-root-5.0.patch.gz) to the SAGE_ROOT repo and\n+* apply [attachment: patchbot-scripts-5.0.patch.gz](https://github.com/sagemath/sage/files/ticket12486/patchbot-scripts-5.0.patch.gz) to the scripts repo.\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,4 +3,4 @@\n **Instructions:**\n \n * apply [attachment: patchbot-root-5.0.patch.gz](https://github.com/sagemath/sage/files/ticket12486/patchbot-root-5.0.patch.gz) to the SAGE_ROOT repo and\n-* apply [attachment: patchbot-scripts-5.0.patch.gz](https://github.com/sagemath/sage/files/ticket12486/patchbot-scripts-5.0.patch.gz) to the scripts repo.\n+* apply [attachment: 12486-patchbot-scripts-5.0-updated.patch.gz](https://github.com/sagemath/sage/files/ticket12486/12486-patchbot-scripts-5.0-updated.patch.gz) to the scripts repo.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150930"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150931"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150932"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150933"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150936"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150937"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,3 +4,4 @@\n \n * apply [attachment: patchbot-root-5.0.patch.gz](https://github.com/sagemath/sage/files/ticket12486/patchbot-root-5.0.patch.gz) to the SAGE_ROOT repo and\n * apply [attachment: 12486-patchbot-scripts-5.0-updated.patch.gz](https://github.com/sagemath/sage/files/ticket12486/12486-patchbot-scripts-5.0-updated.patch.gz) to the scripts repo.\n+* apply [attachment: 12486-fix-sdist.patch.gz](https://github.com/sagemath/sage/files/ticket12486/12486-fix-sdist.patch.gz) to the scripts repo.\n``````\n",
    "created_at": "2012-07-01T05:32:48Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -5,3 +5,4 @@\n * apply [attachment: patchbot-root-5.0.patch.gz](https://github.com/sagemath/sage/files/ticket12486/patchbot-root-5.0.patch.gz) to the SAGE_ROOT repo and\n * apply [attachment: 12486-patchbot-scripts-5.0-updated.patch.gz](https://github.com/sagemath/sage/files/ticket12486/12486-patchbot-scripts-5.0-updated.patch.gz) to the scripts repo.\n * apply [attachment: 12486-fix-sdist.patch.gz](https://github.com/sagemath/sage/files/ticket12486/12486-fix-sdist.patch.gz) to the scripts repo.\n+* apply [attachment: trac_12486_fix_fd_leak.patch.gz](https://github.com/sagemath/sage/files/ticket12486/trac_12486_fix_fd_leak.patch.gz) to the scripts repo.\n``````\n",
    "created_at": "2012-07-01T14:16:55Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150940"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140229",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140230",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140231",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140232",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140233",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140234",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140235",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140236",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140237",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140238",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140239",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140240",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140241",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140242",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140243",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140244",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140245",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150942"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140246",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140247",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150944"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150947"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140248",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140249",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140250",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140251",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140252",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "title_was": "Add patchbot to Sage itself",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150948"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140253",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140254",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140255",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140256",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140257",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150949"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150950"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140258",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150952"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140259",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12486#issuecomment-140260",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150953"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12486#event-150954"
}
```
