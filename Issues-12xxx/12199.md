...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12199#issuecomment-133643",
    "user": "https://github.com/sagetrac-florian"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12199#issuecomment-133644",
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12199#event-151603"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12199#event-151604"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12199#event-151605"
}
```
