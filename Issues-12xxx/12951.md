...
```json
{
    "body": "There is a conflict with #12215. Both tickets need review, but I think that #12215 is more important than this ticket. Hence, I introduced a dependency, and changed my patch accordingly.",
...
```json
{
    "body": "Note to myself: Test that this patch still applies.",
...
```json
{
    "body": "Attachment [trac12951_cached_extension.patch](tarball://root/attachments/some-uuid/ticket12951/trac12951_cached_extension.patch) by @simon-king-jena created at 2013-01-21 10:18:15\n\nI had to rebase the patch. Now it should work again. Still needing review!",
...
Attachment [trac12951_cached_extension.patch](tarball://root/attachments/some-uuid/ticket12951/trac12951_cached_extension.patch) by @simon-king-jena created at 2013-01-21 10:18:15
