...
```json
{
    "body": "<a id='comment:1'></a>Let me add to the list: I don't think these commands are documented anywhere (except in comments at the top of the scripts).  They might be mentioned in the top-level README, and they should definitely be in the installation guide.",
    "created_at": "2012-01-22T17:12:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174406",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>Let me add to the list: I don't think these commands are documented anywhere (except in comments at the top of the scripts).  They might be mentioned in the top-level README, and they should definitely be in the installation guide.
...
```json
{
    "body": "<a id='comment:3'></a>I'm going to do an update of sort to #3052 for #12342 -- at least I'm writing a bunch of relevant code now.   Maybe you'll use it or at least referee my patch.  Nobody but needs to worry about dealing with any of the issues at #12342 now.",
    "created_at": "2012-01-22T18:42:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174408",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>I'm going to do an update of sort to #3052 for #12342 -- at least I'm writing a bunch of relevant code now.   Maybe you'll use it or at least referee my patch.  Nobody but needs to worry about dealing with any of the issues at #12342 now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174409",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174411",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>William, can you comment on my suggestion to abandon this until we switch to git, and the reasoning behind my suggestion?",
    "created_at": "2012-03-02T04:18:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174414",
    "user": "https://github.com/kini"
}
```

<a id='comment:8'></a>William, can you comment on my suggestion to abandon this until we switch to git, and the reasoning behind my suggestion?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174415",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12342#event-33047"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12342#event-33048"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12342#event-33049"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12342#event-33050"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12342#event-33051"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Now we have switched to git..",
    "created_at": "2014-03-04T12:39:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174416",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:12'></a>Now we have switched to git..
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174417",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174418",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174419",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12342#issuecomment-174420",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12342",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12342#event-33052"
}
```
