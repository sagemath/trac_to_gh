...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162808"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162809"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162810"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162811"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162812"
}
```
...
```json
{
    ...
    "subject": "https://github.com/jdemeyer",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162813"
}
```
...
```json
{
    ...
    "subject": "https://github.com/jdemeyer",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12028#issuecomment-128024",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12028#issuecomment-128025",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162815"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12028",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12028#event-162817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12028#issuecomment-128026",
    "user": "https://github.com/jdemeyer"
}
```
