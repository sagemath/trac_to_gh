...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12851#event-34999"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12851#event-35000"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12851#event-35001"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12851#event-35002"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12851#event-35003"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12851#event-35004"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12851#event-35005"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [jakobkroeker](#comment%3A4):\n> However, Singular's genus() is still not bugfree:\n> http://www.singular.uni-kl.de:8002/trac/ticket/259\n\n\nSingular bug 259 appears to be fixed:\nhttps://www.singular.uni-kl.de:8005/trac/ticket/259",
    "created_at": "2016-07-28T23:06:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12851",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12851#issuecomment-187516",
    "user": "https://github.com/slel"
}
```

<a id='comment:7'></a>Replying to [jakobkroeker](#comment%3A4):
> However, Singular's genus() is still not bugfree:
> http://www.singular.uni-kl.de:8002/trac/ticket/259
