# Issue 12940: Meta-Ticket: Unify the use of weights in graphs
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-155669",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-155670",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36090"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36091"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36092"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36093"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36094"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36095"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36096"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36097"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-155671",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-155672",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-155673",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36099"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36100"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36101"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36102"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36103"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-36104"
}
```
