...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189573",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189574",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189575",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189576",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Removed the cython-ified version of the affine permutations class as it was creating issues, and wasn't really improving run times that much.  Made numerous algorithm improvements, though; the patch is now int he sage-combinat queue as well.",
    "created_at": "2012-05-17T18:49:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189577",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:2'></a>Removed the cython-ified version of the affine permutations class as it was creating issues, and wasn't really improving run times that much.  Made numerous algorithm improvements, though; the patch is now int he sage-combinat queue as well.
...
```json
{
    "body": "<a id='comment:4'></a>Ok, at long last, I've fixed up the sage combinat patch and exported; it's the attachment above.  It should also patch the sage files that point out that the new directory and file exist!",
    "created_at": "2012-10-07T13:15:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189579",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:4'></a>Ok, at long last, I've fixed up the sage combinat patch and exported; it's the attachment above.  It should also patch the sage files that point out that the new directory and file exist!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189580",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189582",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Ok, fixed up the docs.  I hadn't seen the -coverage command before.  The ones that are giving warnings now are methods (like _repr_) that are implicitly called within the doc test for that function.\n\nI went through and fixed up latex parts by hand, and am still waiting on the documentation to build to really make a visual check...\n\nBest,\n-tom",
    "created_at": "2012-10-24T07:01:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189583",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:8'></a>Ok, fixed up the docs.  I hadn't seen the -coverage command before.  The ones that are giving warnings now are methods (like _repr_) that are implicitly called within the doc test for that function.
...
```json
{
    "body": "<a id='comment:9'></a>Thanks, tom. You can put #indirect doctest in the line after your test to calm the \n\n```\nsage -coverage\n```\ncommand, if the test indeed indirectly tests the method.\n\nAnne",
    "created_at": "2012-10-24T15:28:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189584",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:9'></a>Thanks, tom. You can put #indirect doctest in the line after your test to calm the 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189587",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Replying to [sdenton](#comment%3A12):\n> Hello!\n> \n> I've been trying to get this expanded and finished up.  The following changes happened lately:\n> \n> * Changed the names of things to AffinePermutation and AffinePermutationGroup, because:\n> * I added affine permutation groups of types ABCDG.  (E and F are in Eriksson, but are ugly; I want to think about whether there's a cleaner way to go about these ones.)\n> * Everything is just in the file affine_permutations.py, which sits directly in sage/combinat\n> \n> I'm now getting a problem I can't figure out, though: Sage is refusing to import the AffinePermutationGroup name.  It doesn't seem to be previously defined, and when I disable all of the import statements I still get an error (so it can't be an import loop; also, nothing calls my file...).  I can manually attach the file just fine, too.\n> \n> I've stared at this a good long time and haven't been able to figure out what's going wrong...\n\n\nAnne tries to write: Don't you mean non-twisted rather than non-exceptional? Type G is exceptional!",
    "created_at": "2013-01-22T09:49:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189588",
    "user": "https://github.com/haraldschilly"
}
```

<a id='comment:13'></a>Replying to [sdenton](#comment%3A12):
> Hello!
> 
> I've been trying to get this expanded and finished up.  The following changes happened lately:
> 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189590",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189591",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Added is_fully_commutative to type A.\nRebased to fix an issue with the new documentation system.",
    "created_at": "2013-03-17T20:37:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189593",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:17'></a>Added is_fully_commutative to type A.
Rebased to fix an issue with the new documentation system.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189594",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Nicolas volunteered me to review the patch. =)\nI sent my comments directly to Tom. When he posts a new version, I can review that.\n\nChris",
    "created_at": "2013-03-24T16:53:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189595",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```

<a id='comment:19'></a>Nicolas volunteered me to review the patch. =)
I sent my comments directly to Tom. When he posts a new version, I can review that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189596",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#14673\"",
    "created_at": "2013-06-01T17:06:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189597",
    "user": "https://github.com/tscrim"
}
```

Changing dependencies from "" to "#14673"
...
```json
{
    "body": "<a id='comment:20'></a>This will need to have a minor rebase over #14673.",
    "created_at": "2013-06-01T17:06:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189598",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:20'></a>This will need to have a minor rebase over #14673.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189599",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189602",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189603",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189606",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189607",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189608",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189609",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189610",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>The patch needs a proper commit message (use hg qrefresh -e to change the message).",
    "created_at": "2013-06-20T07:16:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189611",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:29'></a>The patch needs a proper commit message (use hg qrefresh -e to change the message).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189612",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189613",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189614",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189615",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>Apply: trac_12940_affine_permutations-td.3.patch",
    "created_at": "2013-06-20T08:32:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189616",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```

<a id='comment:31'></a>Apply: trac_12940_affine_permutations-td.3.patch
...
```json
{
    "body": "<a id='comment:32'></a>This patch badly abuses `assert` statements. Assertions should be used to check correctness of the code, not to validate user input. Any `AssertionError` caused by the use of public functions is by definition a bug.",
    "created_at": "2013-06-20T09:11:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189617",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:32'></a>This patch badly abuses `assert` statements. Assertions should be used to check correctness of the code, not to validate user input. Any `AssertionError` caused by the use of public functions is by definition a bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189618",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>Also, while you're at it, could you use the new style doctest continuations:\n\n```\nsage: for a in CP: \n....:     p.to_lehmer_code(a[0],a[1])\n```\ninstead of\n\n```\nsage: for a in CP: \n...     p.to_lehmer_code(a[0],a[1])\n```",
    "created_at": "2013-06-20T09:14:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189619",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:33'></a>Also, while you're at it, could you use the new style doctest continuations:
...
```json
{
    "body": "<a id='comment:34'></a>I'm confused, then; my understanding of the clonable array class was that it needs to have a check method which throws assertion errors if the 'checked' clonable array doesn't actually check out as a proper object.  This checks simultaneously for user errors and for code errors.\n\nCould you point me to a discussion or coding convention on proper ways to use assert statements or check for input correctness?",
    "created_at": "2013-06-20T09:29:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189620",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:34'></a>I'm confused, then; my understanding of the clonable array class was that it needs to have a check method which throws assertion errors if the 'checked' clonable array doesn't actually check out as a proper object.  This checks simultaneously for user errors and for code errors.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189621",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189622",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>Changed all assert statements outside of the 'check' and '_test.+' methods into ValueErrors.  Others left as 'assert' according to conventions in:\nhttp://www.sagemath.org/doc/reference/structure/sage/structure/list_clone.html",
    "created_at": "2013-06-20T10:14:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189623",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:36'></a>Changed all assert statements outside of the 'check' and '_test.+' methods into ValueErrors.  Others left as 'assert' according to conventions in:
http://www.sagemath.org/doc/reference/structure/sage/structure/list_clone.html
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189625",
    "user": "https://trac.sagemath.org/admin/accounts/users/chrisjamesberg"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>I think that's the whole idea of the check methods: they aren't directly accessed by the user, but called to check the integrity of the object.",
    "created_at": "2013-06-20T10:25:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189627",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:40'></a>I think that's the whole idea of the check methods: they aren't directly accessed by the user, but called to check the integrity of the object.
...
```json
{
    "body": "<a id='comment:41'></a>Similarly, should one use asserts or exceptions in test suite methods?",
    "created_at": "2013-06-20T10:27:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189628",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:41'></a>Similarly, should one use asserts or exceptions in test suite methods?
...
```json
{
    "body": "<a id='comment:42'></a>Replying to [sdenton](#comment%3A41):\n> Similarly, should one use asserts or exceptions in test suite methods?\n\nIn test suites, assertions are fine.",
    "created_at": "2013-06-20T10:29:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189629",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:42'></a>Replying to [sdenton](#comment%3A41):
> Similarly, should one use asserts or exceptions in test suite methods?
...
```json
{
    "body": "<a id='comment:43'></a>The following is still a bug. It's a clear example of bad user input leading to an `AssertionError`:\n\n```\nsage: AffinePermutationGroup(['A',8,1])([0])\n---------------------------------------------------------------------------\nAssertionError                            Traceback (most recent call last)\n...\nAssertionError: Length of list must be k+1=9.\n```",
    "created_at": "2013-06-20T10:30:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189630",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:43'></a>The following is still a bug. It's a clear example of bad user input leading to an `AssertionError`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189631",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>Read this sentence again: **I think of assertion failures as serious as a crash due to a Segmentation Fault: it is always a bug in the program if one occurs.**",
    "created_at": "2013-06-20T10:33:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189633",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:45'></a>Read this sentence again: **I think of assertion failures as serious as a crash due to a Segmentation Fault: it is always a bug in the program if one occurs.**
...
```json
{
    "body": "<a id='comment:46'></a>Please don't use `ClonableArray` as an example, it shouldn't be using assertions that way.",
    "created_at": "2013-06-20T10:43:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189634",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:46'></a>Please don't use `ClonableArray` as an example, it shouldn't be using assertions that way.
...
```json
{
    "body": "<a id='comment:47'></a>One more way to think of assertions: they express \"I *know* this condition is true\", not \"I want to *check* that this condition is true\".",
    "created_at": "2013-06-20T11:33:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189635",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:47'></a>One more way to think of assertions: they express "I *know* this condition is true", not "I want to *check* that this condition is true".
...
```json
{
    "body": "<a id='comment:51'></a>Perhaps this should be a `NotImplementedError`:\n\n```\nraise ValueError('Cartan type provided is not implemented as an affine permutation group.')\n```",
    "created_at": "2013-06-20T14:09:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189639",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:51'></a>Perhaps this should be a `NotImplementedError`:
...
```json
{
    "body": "<a id='comment:52'></a>Switched to NotImplementedError in the indicated place.  Can this finally get out the door now?",
    "created_at": "2013-06-20T15:16:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189640",
    "user": "https://github.com/sdenton4"
}
```

<a id='comment:52'></a>Switched to NotImplementedError in the indicated place.  Can this finally get out the door now?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189641",
    "user": "https://github.com/sdenton4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189642",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    "body": "<a id='comment:53'></a>Attachment [trac_12940_affine_permutations-td.patch](tarball://root/attachments/some-uuid/ticket12940/trac_12940_affine_permutations-td.patch) by @anneschilling created at 2013-06-20 16:45:02",
    "created_at": "2013-06-20T16:45:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189643",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:53'></a>Attachment [trac_12940_affine_permutations-td.patch](tarball://root/attachments/some-uuid/ticket12940/trac_12940_affine_permutations-td.patch) by @anneschilling created at 2013-06-20 16:45:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189644",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12940#event-35383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12940#issuecomment-189645",
    "user": "https://github.com/jdemeyer"
}
```
