...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12763#issuecomment-145343",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12763#issuecomment-145344",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12763#issuecomment-145345",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [elliptic_curves-0.6.diff](https://github.com/sagemath/sage/files/ticket12763/elliptic_curves-0.6.diff) by @kiwifb created at 2012-03-28 01:25:41\n\nWonderful. It fixes it. Positive review from me.",
    "created_at": "2012-03-28T01:25:41Z",
    "issue": "https://github.com/sagemath/sage/issues/12763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12763#issuecomment-145346",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12763#issuecomment-145347",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12763#issuecomment-145348",
