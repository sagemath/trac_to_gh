...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12794#event-161339"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12794#event-161340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12794#event-161341"
}
```
...
```json
{
    "body": "Attachment: **[better.png.gz](https://github.com/sagemath/sage/files/ticket12794/better.png.gz)**\n\nshows the solution!",
    "created_at": "2013-06-16T00:54:42Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12794#issuecomment-145799",
    "user": "https://github.com/kcrisman"
}
```

Attachment: **[better.png.gz](https://github.com/sagemath/sage/files/ticket12794/better.png.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12794#issuecomment-145800",
    "user": "https://github.com/kcrisman"
}
```
