...
```json
{
    "body": "<a id='comment:1'></a>Please clarify or remove the following sentence:\n\n```\nNote: To avoid branching, we haven't given explicit dependencies, but the chain's order is important.\n```",
    "created_at": "2012-05-23T18:57:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190941",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Please clarify or remove the following sentence:
...
```json
{
    "body": "<a id='comment:2'></a>Your patch makes the mistaken assumption that the directory `build/` exists.  In any case, `$(INST)` might be a better directory for this.",
    "created_at": "2012-05-23T18:58:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190942",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>Your patch makes the mistaken assumption that the directory `build/` exists.  In any case, `$(INST)` might be a better directory for this.
...
```json
{
    "body": "<a id='comment:3'></a>Seems like your proposal actually makes the `deps` file more complicated, so I'm not sure I like it...\n\nWhy not simply do\n\n```\n$(INST)/$(ZODB): $(INST)/$(TWISTED)\n```\ninstead of\n\n```\nbuild/setuptools-serial-1-stamp: $(INST)/$(TWISTED)\n        touch $@\n$(INST)/$(ZODB): build/setuptools-serial-1-stamp\n```",
    "created_at": "2012-05-23T19:06:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190943",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>Seems like your proposal actually makes the `deps` file more complicated, so I'm not sure I like it...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190944",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Could you make your patch using Mercurial? Also, I personally don't like that when done building, the BUILD directory is polluted with 6 empty files.",
    "created_at": "2012-05-23T19:37:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190945",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>Could you make your patch using Mercurial? Also, I personally don't like that when done building, the BUILD directory is polluted with 6 empty files.
...
```json
{
    "body": "<a id='comment:6'></a>Replying to [Snark](#comment%3A4):\n> My patch removes that sentence, so I don't understand what you expect :-/\n\nActually, your patch simply *moves* that sentence.",
    "created_at": "2012-05-23T20:10:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190946",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>Replying to [Snark](#comment%3A4):
> My patch removes that sentence, so I don't understand what you expect :-/
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190950",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>What is the current status of this ticket? Is it ready for review?",
    "created_at": "2012-07-01T19:25:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190951",
    "user": "https://github.com/ohanar"
}
```

<a id='comment:10'></a>What is the current status of this ticket? Is it ready for review?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190952",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [trac12994.patch](tarball://root/attachments/some-uuid/ticket12994/trac12994.patch) by @ohanar created at 2012-07-03 21:46:01\n\nIMHO making these stamps are unnecessary. I've posted a patch containing my solution, which simply separates out the linearization, and puts it at the bottom of deps.",
    "created_at": "2012-07-03T21:46:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190953",
    "user": "https://github.com/ohanar"
}
```

<a id='comment:11'></a>Attachment [trac12994.patch](tarball://root/attachments/some-uuid/ticket12994/trac12994.patch) by @ohanar created at 2012-07-03 21:46:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190954",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190955",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190956",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#11874\"",
    "created_at": "2012-07-03T21:46:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190957",
    "user": "https://github.com/ohanar"
}
```

Changing dependencies from "" to "#11874"
...
```json
{
    "body": "<a id='comment:12'></a>Your patch doesn't solve the problem of lying dependencies. Those packages don't depend on each other, so the deps file must not say otherwise.",
    "created_at": "2012-07-04T08:25:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190958",
    "user": "https://trac.sagemath.org/admin/accounts/users/Snark"
}
```

<a id='comment:12'></a>Your patch doesn't solve the problem of lying dependencies. Those packages don't depend on each other, so the deps file must not say otherwise.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190959",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I prefer the second patch, because it's simpler while it does essentially the same thing.\n\nJust wondering: why did you reorder the dependencies in that way?\n\nThe Sage library depends on `jinja2` to build, so maybe it's best to build `jinja2` first.",
    "created_at": "2012-07-04T09:52:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190961",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>I prefer the second patch, because it's simpler while it does essentially the same thing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190962",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190963",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190964",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190965",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Replying to [Snark](#comment%3A19):\n> The second patch basically does nothing at all : it serializes things precisely like I complain shouldn't be done, by adding wrong but correct-looking edges in the dependency graph.\n> \n> This is a typical application of the quote : \u201cFor every problem there is a solution which is simple, clean and wrong.\u201d\n> \n> If that problem goes away by getting the original issue down, that's perfect : my goal isn't to make my patch go in -- it's to get things right :  there must not be a \"$(INST)/$(FOO): $(INST)/$(BAR)\" rule in deps between actual packages which doesn't correspond to an actual dependency.\n\n\nI think we all made our point and have to realize that we don't agree.",
    "created_at": "2012-07-04T15:02:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190968",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:21'></a>Replying to [Snark](#comment%3A19):
> The second patch basically does nothing at all : it serializes things precisely like I complain shouldn't be done, by adding wrong but correct-looking edges in the dependency graph.
> 
> This is a typical application of the quote : “For every problem there is a solution which is simple, clean and wrong.”
> 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190969",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>I would say: let's not depend on #13201 here.  Instead, you could fix `spkg/standard/deps` at #13201.  So I assume that [attachment:trac12994.patch] is still the subject of review.",
    "created_at": "2012-08-31T08:36:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190970",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>I would say: let's not depend on #13201 here.  Instead, you could fix `spkg/standard/deps` at #13201.  So I assume that [attachment:trac12994.patch] is still the subject of review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190971",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190972",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190973",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12994#event-35588"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190974",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12994#issuecomment-190975",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12994",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12994#event-35589"
}
```
