...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12994#event-164749"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12994#event-164750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12994#event-164751"
}
```
...
```json
{
    "body": "<a id='comment:23'>Comment 23:</a>\nI would say: let's not depend on #13201 here.  Instead, you could fix `spkg/standard/deps` at #13201.  So I assume that [attachment: trac12994.patch.gz](https://github.com/sagemath/sage/files/ticket12994/trac12994.patch.gz) is still the subject of review.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12994#issuecomment-150000",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12994#issuecomment-150001",
    "user": "https://github.com/jdemeyer"
}
```
