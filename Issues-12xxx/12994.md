...
archive/attachments_018158.json:
```json
{
...
```json
{
    "body": "**Attachment:** [setuptools-serial.patch](https://github.com/sagemath/sage/files/ticket12994/setuptools-serial.patch)\n\nPatch fixing the issue",
    "created_at": "2012-05-26T09:21:41Z",
    "issue": "https://github.com/sagemath/sage/issues/12994",
    "type": "issue_comment",
...
**Attachment:** [setuptools-serial.patch](https://github.com/sagemath/sage/files/ticket12994/setuptools-serial.patch)
...
archive/attachments_018159.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_018160.json:
```json
{
    "asset_content_type": "application/octet-stream",
