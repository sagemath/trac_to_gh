...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180692",
    "user": "https://github.com/itaibn"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [12568-fix.patch](tarball://root/attachments/some-uuid/ticket12568/12568-fix.patch) by @itaibn created at 2012-02-27 22:47:32\n\nI should have done this a while ago since I already have a patch.",
    "created_at": "2012-02-27T22:47:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180693",
    "user": "https://github.com/itaibn"
}
```

<a id='comment:1'></a>Attachment [12568-fix.patch](tarball://root/attachments/some-uuid/ticket12568/12568-fix.patch) by @itaibn created at 2012-02-27 22:47:32
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180694",
    "user": "https://github.com/itaibn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180695",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180696",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180697",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180698",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Moreover the sage-env script is in the spkg/bin directory and not in the local/bin one (edit: this is a recent change #11073).\n\nFinally the micro_release target segfault on my machine...",
    "created_at": "2012-03-30T08:02:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180700",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:4'></a>Moreover the sage-env script is in the spkg/bin directory and not in the local/bin one (edit: this is a recent change #11073).
...
```json
{
    "body": "<a id='comment:5'></a>I propose to let the test target behave like the other ones, i.e. call \"sage -t ...\" (in the end it calls sage-maketest anyway, but at least sage-env is properly called by the sage script).\n\nFor the micro_release one, I'm not sure we can do much better than the solution Itai proposed without calling sage-micro_release from the sage script to properly set SAGE_ROOT (i.e. through an option or something like that).",
    "created_at": "2012-03-30T08:41:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180701",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:5'></a>I propose to let the test target behave like the other ones, i.e. call "sage -t ..." (in the end it calls sage-maketest anyway, but at least sage-env is properly called by the sage script).
...
```json
{
    "body": "<a id='comment:7'></a>My bad once more.\nsage-env is only meant to be sourced (and only once) and should not be executable: #10469",
    "created_at": "2012-03-30T09:15:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180703",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:7'></a>My bad once more.
sage-env is only meant to be sourced (and only once) and should not be executable: #10469
...
```json
{
    "body": "<a id='comment:8'></a>Ok here is a slightly reworked patch making the test target like the other ones.",
    "created_at": "2012-03-30T09:41:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180704",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:8'></a>Ok here is a slightly reworked patch making the test target like the other ones.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180705",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180706",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>1. Obviously, `/usr/bin/env bash` should be simply `bash`.\n\n2. Then, if you don't use `sage-maketest` anymore (which is probably a good thing), remove the `sage-maketest` script.",
    "created_at": "2012-04-13T08:01:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180707",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>1. Obviously, `/usr/bin/env bash` should be simply `bash`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180708",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I think the sage-maketest script is used when you call \"sage -testall\" which is called by some make targets so is still necessary.",
    "created_at": "2012-04-13T08:08:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180709",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:12'></a>I think the sage-maketest script is used when you call "sage -testall" which is called by some make targets so is still necessary.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180710",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180711",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>In fact the testall option is not present in the make targets, but is defined and documented by spkg/bin/sage.\nAnyway, I don't think here is the place to remove it.",
    "created_at": "2012-04-13T08:15:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180712",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:14'></a>In fact the testall option is not present in the make targets, but is defined and documented by spkg/bin/sage.
Anyway, I don't think here is the place to remove it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180713",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180714",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180715",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>`make micro_release` is indeed broken.  It's not surprising, as it changes the python library while `python` is running:\n\n```\nstrip \"/tmp/local/sage/local/lib/libpython2.7.so\"\nbash: line 1:  5817 Segmentation fault      local/bin/sage-micro_release\n```\nbut that's not relevant for this ticket.\n\nEverything else seems to work, so positive_review.",
    "created_at": "2012-04-13T08:49:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180716",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:15'></a>`make micro_release` is indeed broken.  It's not surprising, as it changes the python library while `python` is running:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12568#event-33980"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180717",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12568",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12568#issuecomment-180718",
    "user": "https://github.com/jdemeyer"
}
```
