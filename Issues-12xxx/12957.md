...
```json
{
    "body": "<a id='comment:5'></a>On sage-6.9.beta1 things get better... I modified the description accordingly",
...
<a id='comment:5'></a>On sage-6.9.beta1 things get better... I modified the description accordingly
...
<a id='comment:6'></a>I have updated the description with the status as of version 7.4.beta0.
