...
```json
{
    "body": "<a id='comment:2'></a>See some discussion on #12541.",
    "created_at": "2012-03-18T19:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12688",
    "type": "issue_comment",
...
<a id='comment:2'></a>See some discussion on #12541.
...
```json
{
    "body": "<a id='comment:3'></a>Patch is documentation only.  More thorough, and more in keeping with current documentation standards.",
    "created_at": "2012-03-19T05:24:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12688",
    "type": "issue_comment",
...
<a id='comment:3'></a>Patch is documentation only.  More thorough, and more in keeping with current documentation standards.
...
<a id='comment:4'></a>I'll look at it today/tomorrow if nobody beats me.
...
<a id='comment:7'></a>Replying to [novoselt](#comment%3A4):
>  Perhaps these `span` and `submodule` methods can be somehow consolidated
...
```json
{
    "body": "<a id='comment:9'></a>http://trac.sagemath.org/sage_trac/ticket/12688#comment:5 is still valid ;-)",
    "created_at": "2012-05-25T00:10:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12688",
    "type": "issue_comment",
...
<a id='comment:9'></a>http://trac.sagemath.org/sage_trac/ticket/12688#comment:5 is still valid ;-)
...
```json
{
    "body": "<a id='comment:10'></a>Replying to [novoselt](#comment%3A5):\n\nThanks again - comments addressed in \"update\" patch.\n\nRob\n\n> Little picks:\n> * \"INPUTS\" should be without \"S\" according to guidelines.\n> * There also should be \"OUTPUT\" and perhaps it can precisely state here where the resulting submodule lives.\n> \n> Otherwise looks good to me!",
    "created_at": "2012-05-25T18:13:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12688",
    "type": "issue_comment",
...
<a id='comment:10'></a>Replying to [novoselt](#comment%3A5):
