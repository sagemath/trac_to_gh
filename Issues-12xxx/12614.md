...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12614#event-158518"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12614#event-158519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12614#event-158520"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,2 +1,3 @@\n The bzip2 and prereq \"spkgs\" should clean up their build directories, just like sage-spkg does for other spkgs. See the attached patch.\n \n+Apply [attachment: trac_12614-bzip2-prereq.patch.gz](https://github.com/sagemath/sage/files/ticket12614/trac_12614-bzip2-prereq.patch.gz) to the root repo.\n``````\n",
    "created_at": "2012-02-29T23:53:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12614",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,3 @@\n-The bzip2 and prereq \"spkgs\" should clean up their build directories, just like sage-spkg does for other spkgs. See the attached patch.\n+The prereq \"spkg\" should clean up its build directory, just like sage-spkg does for other spkgs. See the attached patch.\n \n-Apply [attachment: trac_12614-bzip2-prereq.patch.gz](https://github.com/sagemath/sage/files/ticket12614/trac_12614-bzip2-prereq.patch.gz) to the root repo.\n+Apply [attachment: trac_12614-prereq.patch.gz](https://github.com/sagemath/sage/files/ticket12614/trac_12614-prereq.patch.gz) to the root repo.\n``````\n",
    "created_at": "2012-03-05T20:51:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12614",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12614#issuecomment-142496",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12614",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12614#issuecomment-142497",
    "user": "https://github.com/jdemeyer"
}
```
