...
```json
{
    "body": "<a id='comment:14'></a>\nThanks for trying things on Cygwin again!  I gave up a while ago, but if you can keep build instructions up-to-date at [CygwinPort](../wikis/CygwinPort) and #6743, that would be wonderful.",
