...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12132#event-150488"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12132#event-150489"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12132#event-150490"
}
```
...
```json
{
    "body": "Changed assignee from **@craigcitro** to **johanbosman**",
    "created_at": "2011-12-10T13:57:33Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12132",
    "type": "issue_comment",
...
Changed assignee from **@craigcitro** to **johanbosman**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12132#issuecomment-132166",
    "user": "https://github.com/sagetrac-johanbosman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12132#issuecomment-132167",
    "user": "https://github.com/sagetrac-johanbosman"
}
```
