...
```json
{
    "body": "Is this reproducible?  It seems like more of a problem with `sage-doctest` than anything specific to Magma.",
...
```json
{
    "body": "This has been fixed in sage-5.0 already as #12493.   I'm closing this as a dup.",
...
```json
{
    "body": "This should be closed as a dup.",
