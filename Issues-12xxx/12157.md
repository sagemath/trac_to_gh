...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169528",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_12157_modn_givaro.patch](tarball://root/attachments/some-uuid/ticket12157/trac_12157_modn_givaro.patch) by @malb created at 2011-12-15 10:55:27",
    "created_at": "2011-12-15T10:55:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169529",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>Attachment [trac_12157_modn_givaro.patch](tarball://root/attachments/some-uuid/ticket12157/trac_12157_modn_givaro.patch) by @malb created at 2011-12-15 10:55:27
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169530",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169531",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169532",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169533",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>When I say \"Sage's fault\" that may very well be the fault of one of the contained components (i.e. Cython), I didn't mean to be more specific.\n\nI'm just running tests and then will set it to positive review.",
    "created_at": "2011-12-15T11:06:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169534",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>When I say "Sage's fault" that may very well be the fault of one of the contained components (i.e. Cython), I didn't mean to be more specific.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169535",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>In `devel/sage/sage/matrix/matrix_modn_dense_float.cpp` (and any other Cython .c and .cpp file), there is a function\n\n```c\nstatic int __Pyx_check_binary_version(void) {\n    char ctversion[4], rtversion[4];\n    PyOS_snprintf(ctversion, 4, \"%d.%d\", PY_MAJOR_VERSION, PY_MINOR_VERSION);\n    PyOS_snprintf(rtversion, 4, \"%s\", Py_GetVersion());\n    if (ctversion[0] != rtversion[0] || ctversion[2] != rtversion[2]) {\n        char message[200];\n        PyOS_snprintf(message, sizeof(message),\n                      \"compiletime version %s of module '%.100s' \"\n                      \"does not match runtime version %s\",\n                      ctversion, __Pyx_MODULE_NAME, rtversion);\n        #if PY_VERSION_HEX < 0x02050000\n        return PyErr_Warn(NULL, message);\n        #else\n        return PyErr_WarnEx(NULL, message, 1);\n        #endif\n    }\n    return 0;\n}\n```\nMaybe you could try adding some print statements to see what is going wrong...",
    "created_at": "2011-12-15T11:18:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169536",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>In `devel/sage/sage/matrix/matrix_modn_dense_float.cpp` (and any other Cython .c and .cpp file), there is a function
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169537",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169538",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169539",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I am not sure why it dies that way either, on Gentoo we link everything with --as-needed and if don't add givaro to the list of libraries it is not linked at all with these two libraries. But I cannot add anything compared to the report on the sage-on-gentoo tracker.\n\nI'll leave it for you to push \"positive review\" button.",
    "created_at": "2011-12-15T20:56:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169540",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>I am not sure why it dies that way either, on Gentoo we link everything with --as-needed and if don't add givaro to the list of libraries it is not linked at all with these two libraries. But I cannot add anything compared to the report on the sage-on-gentoo tracker.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169541",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169542",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12157#issuecomment-169543",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12157",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12157#event-32315"
}
```
