...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket12412/vector.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12412#issuecomment-139598",
    "user": "https://trac.sagemath.org/admin/accounts/users/JStarx"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12412#event-104067"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12412#event-104068"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12412#event-104069"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12412#issuecomment-139599",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12412#issuecomment-139600",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12412#event-104070"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12412",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12412#event-104071"
}
```
