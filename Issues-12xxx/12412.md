...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154952"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12412#issuecomment-138034",
    "user": "https://github.com/sagetrac-JStarx"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154956"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154957"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154958"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12412#issuecomment-138035",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12412#issuecomment-138036",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154959"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-154960"
}
```
