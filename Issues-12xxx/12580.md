...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12580#event-34018"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12580#event-34019"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12580#event-34020"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12580#event-34021"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12580#event-34022"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12580#event-34023"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12580#event-34024"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Certainly not critical. Not a defect either.",
    "created_at": "2014-08-11T07:53:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12580#issuecomment-155433",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>Certainly not critical. Not a defect either.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12580#issuecomment-155434",
    "user": "https://github.com/rwst"
}
```
