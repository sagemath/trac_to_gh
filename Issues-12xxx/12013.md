...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135275",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135276",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135277",
...
```json
{
    "body": "<a id='comment:7'></a>Thanks for your comments. Updated the patch.",
    "created_at": "2012-02-29T13:51:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135279",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:7'></a>Thanks for your comments. Updated the patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135280",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Looks much better now. It would be nice to follow the [conventions](http://www.sagemath.org/doc/developer/conventions.html) (somewhere in the middle there is an example `def point...` (...template when documenting functions)). E.g. use ``` and ```` at the places where variables or formulas (interval) are.\n\nFurther I suggest to put `sage: entropy(1.1, 2)` and `sage: entropy(1, 1)` under a separate section `TESTS::`, since to me it seems more like a test than an example showing some functionality.\n\nMaybe you can also add the following example (change the values if you want others) to `EXAMPLES`:\n\n```\nsage: entropy(1/5,4)\n-1/5*log(1/5)/log(4) - 4/5*log(4/5)/log(4) + 1/5*log(3)/log(4)\n```\nso that we have an example (with values that are not a special case).",
    "created_at": "2012-03-02T09:41:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135281",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:8'></a>Looks much better now. It would be nice to follow the [conventions](http://www.sagemath.org/doc/developer/conventions.html) (somewhere in the middle there is an example `def point...` (...template when documenting functions)). E.g. use ``` and ```` at the places where variables or formulas (interval) are.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135282",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135283",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [trac_12013-fix_entropy.patch](tarball://root/attachments/some-uuid/ticket12013/trac_12013-fix_entropy.patch) by @ppurka created at 2012-03-02 10:17:47\n\nUpdated it again! Didn't know that I was so inconsistent. :)",
    "created_at": "2012-03-02T10:17:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135284",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:9'></a>Attachment [trac_12013-fix_entropy.patch](tarball://root/attachments/some-uuid/ticket12013/trac_12013-fix_entropy.patch) by @ppurka created at 2012-03-02 10:17:47
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135285",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135286",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12013#issuecomment-135287",
