...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket12075/trac_12075.patch",
    "created_at": "2012-01-10T22:18:49Z",
    "issue": "https://github.com/sagemath/sage/issues/12075",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12075/trac_12075.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/gbe"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>\n**Attachment:** [trac_12075.patch](https://github.com/sagemath/sage/files/ticket12075/trac_12075.patch)",
    "created_at": "2012-01-10T22:18:49Z",
    "issue": "https://github.com/sagemath/sage/issues/12075",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97871"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97872"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97873"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97874"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97875"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12298-v2.patch",
    "asset_url": "tarball://root/attachments/ticket12075/trac_12298-v2.patch",
    "created_at": "2012-01-12T20:40:14Z",
    "issue": "https://github.com/sagemath/sage/issues/12075",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12075/trac_12298-v2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/gbe"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket12075/trac_12075-v2.patch",
    "created_at": "2012-01-12T20:40:14Z",
    "issue": "https://github.com/sagemath/sage/issues/12075",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12075/trac_12075-v2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/gbe"
}
```
...
```json
{
    "body": "**Attachment:** [trac_12298-v2.patch](https://github.com/sagemath/sage/files/ticket12075/trac_12298-v2.patch)\n\n**Attachment:** [trac_12075-v2.patch](https://github.com/sagemath/sage/files/ticket12075/trac_12075-v2.patch)\n\nSame content as trac_12298-v2.patch, just named correctly. Apply instead of trac_12075.patch",
    "created_at": "2012-01-12T20:40:14Z",
    "issue": "https://github.com/sagemath/sage/issues/12075",
    "type": "issue_comment",
...
**Attachment:** [trac_12298-v2.patch](https://github.com/sagemath/sage/files/ticket12075/trac_12298-v2.patch)
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97876"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97877"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97878"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97879"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97880"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97881"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97882"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12075#event-97883"
}
```
