...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_12904.patch](tarball://root/attachments/some-uuid/ticket12904/trac_12904.patch) by @a-andre created at 2012-05-04 18:11:19\n\nThe necessary change to solve the problem is\n\n```diff\n\n--- a/sage/plot/plot3d/texture.py\n+++ b/sage/plot/plot3d/texture.py\n@@ -211,9 +212,9 @@\n         return info.rgb()\n     elif isinstance(info, str):\n         try:\n-            return colors[info]\n+            return Color(info)\n         except KeyError:\n```",
    "created_at": "2012-05-04T18:11:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12904",
    "type": "issue_comment",
...
<a id='comment:1'></a>Attachment [trac_12904.patch](tarball://root/attachments/some-uuid/ticket12904/trac_12904.patch) by @a-andre created at 2012-05-04 18:11:19
...
<a id='comment:2'></a>This is great diagnosis and a nice terse doctest.   I've looked through this a fair amount and the only obvious problem (other than the doctest failure below) I can find is that 
...
```json
{
    "body": "<a id='comment:4'></a>Oh, I had no idea about the dependency.  Love the link about the `in`, very useful.   By new formatting I mean things like [this Python doc](http://docs.python.org/library/stdtypes.html#str.format).\n\nI don't have time to do finish this off right now but I'm sure that this will be fine once I apply #11383.  Good work.",
...
<a id='comment:4'></a>Oh, I had no idea about the dependency.  Love the link about the `in`, very useful.   By new formatting I mean things like [this Python doc](http://docs.python.org/library/stdtypes.html#str.format).
...
```json
{
    "body": "<a id='comment:5'></a>I don't see any other problems here.  Doesn't mean they aren't there, but this seems good.",
...
<a id='comment:5'></a>I don't see any other problems here.  Doesn't mean they aren't there, but this seems good.
