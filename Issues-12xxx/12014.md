...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket12014/test_file.patch",
...
```json
{
    "body": "test trac upload with \"replace existing attachment\"",
    "created_at": "2012-04-30T06:32:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12014",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket12014/trac_12014-make_iter_and_list_faster.patch",
