...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12609#event-158430"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12609#event-158431"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12609#event-158432"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,3 +14,5 @@\n This is totally wrong.  It only checks that a spkg *exists*, not that it has been installed.\n \n See #12608 for removing this wrong checking from PPL.\n+\n+Apply [attachment: trac_12609-doc-developer.patch.gz](https://github.com/sagemath/sage/files/ticket12609/trac_12609-doc-developer.patch.gz) to the main Sage library.\n``````\n",
    "created_at": "2012-03-05T23:08:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12609",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,8 +11,8 @@\n           exit 1\n       fi\n ```\n-This is totally wrong.  It only checks that a spkg *exists*, not that it has been installed.\n+This is totally wrong.  It only checks that a spkg *exists*, not that it has been installed.  See #12608 for removing this wrong checking from PPL.\n \n-See #12608 for removing this wrong checking from PPL.\n+The patches below also include various fixes to \"Producing New Sage Packages\".\n \n-Apply [attachment: trac_12609-doc-developer.patch.gz](https://github.com/sagemath/sage/files/ticket12609/trac_12609-doc-developer.patch.gz) to the main Sage library.\n+Apply [and [12609_review.patch](https://github.com/sagemath/sage/files/ticket12609/41ab34f94365eb24fa53820632fae7bd.gz) to the main Sage library.\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12609#issuecomment-142411",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12609",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12609#issuecomment-142412",
    "user": "https://github.com/jdemeyer"
}
```
