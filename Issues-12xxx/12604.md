...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173075"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173076"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173077"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140064",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173078"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140065",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173079"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140066",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140067",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140068",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140069",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140070",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140071",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140072",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173081"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173082"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140073",
...
```json
{
    "body": "<div id=\"comment:8\" align=\"right\">comment:8</div>\n\nReplying to [@sagetrac-dsm](#comment:5):\n> \"ms.dimension() is literally the dimension of the matrix space itself. This has nothing to do with \"dimensions()\", except that it is the product of them.\"\n> \n> This is a use of the word \"nothing\" with which I am not familiar. :-)\n\nThese are not the Droids you are looking for.",
    "created_at": "2012-02-28T15:33:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140074",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173084"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12604#event-173085"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12604",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12604#issuecomment-140075",
