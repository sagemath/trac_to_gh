...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175292",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nif we have:\n\nkx.<x> = FunctionField(QQ)\nkxY.<Y> = PolynomialRing(QQ)\n\nkxY._singular_ should be k(x)[Y] (which is what this code generates) however, singular only computes the genus of an ideal of k[x][Y] ring. So, I have to generate a tmpR = k[x][Y] each time I need to compute the genus. Maybe it's worth it to add `__singular_`deg2_ private object to store this ring as well. \n\nAlso, it makes sense to store the genus in __genus. But I'm not sure how should I check it's validity. Can the defining polynomial of the function field change after its creation. If not then we can set __genus = -1 and if it's non-negative then it's valid.",
    "created_at": "2011-12-17T03:23:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175293",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12170#event-38095"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12170#event-38096"
}
```
...
```json
{
    ...
    "label": "component: algebra",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12170#event-38097"
}
```
...
```json
{
    ...
    "label": "component: algebraic geometry",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12170#event-38098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175294",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175295",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175296",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175297",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175298",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175299",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175300",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175301",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175302",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175303",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175304",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175305",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175306",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175307",
...
```json
{
    "body": "adds genus computation; adds function fieds and rational func field over non prime finite fields to `_singular_`init and can_convert_to_singular in the singular interface with reduce no of calls to Singular; non integral polynomial bug fixed.",
    "created_at": "2012-02-20T16:44:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175308",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```

adds genus computation; adds function fieds and rational func field over non prime finite fields to `_singular_`init and can_convert_to_singular in the singular interface with reduce no of calls to Singular; non integral polynomial bug fixed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175309",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175310",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175311",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12170#event-38099"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12170#event-38100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175312",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175313",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175314",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175315",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12170#issuecomment-175316",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12170",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12170#event-38101"
}
```
