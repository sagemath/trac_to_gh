...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132653",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98908"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98909"
}
```
...
```json
{
    ...
    "label": "component: algebra",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98910"
}
```
...
```json
{
    ...
    "label": "component: algebraic geometry",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98911"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132654",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132655",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132656",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98912"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132657",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132658",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132659",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132660",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132661",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132662",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98914"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132663",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>\nI have finally qfolded the two patches in one but I don't know how to delete the two first files. Maybe I don't have permission to do so. If anybody can delete *\"*[trac_12170.patch](https://github.com/sagemath/sage/files/ticket12170/trac_12170.patch)*\" and\u00a0\"*[trac_12170_1.patch](https://github.com/sagemath/sage/files/ticket12170/trac_12170_1.patch)\" from this ticket please do so.",
    "created_at": "2011-12-29T02:48:44Z",
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132664",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132665",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket12170/trac_12170-gen_comp_singular_obj.patch",
    "created_at": "2012-02-20T16:44:21Z",
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12170/trac_12170-gen_comp_singular_obj.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    "body": "Attachment [trac_12170-gen_comp_singular_obj.patch](https://github.com/sagemath/sage/files/ticket12170/trac_12170-gen_comp_singular_obj.patch) by sydahmad created at 2012-02-20 16:44:21\n\nadds genus computation; adds function fieds and rational func field over non prime finite fields to _singular_init and can_convert_to_singular in the singular interface with reduce no of calls to Singular; non integral polynomial bug fixed.",
    "created_at": "2012-02-20T16:44:21Z",
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132666",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```

Attachment [trac_12170-gen_comp_singular_obj.patch](https://github.com/sagemath/sage/files/ticket12170/trac_12170-gen_comp_singular_obj.patch) by sydahmad created at 2012-02-20 16:44:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132667",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132668",
    "user": "https://trac.sagemath.org/admin/accounts/users/sydahmad"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132669",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98916"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98917"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98918"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98919"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132670",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132671",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12170#issuecomment-132672",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12170",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12170#event-98922"
}
```
