...
```json
{
    "body": "Well I tried the patch out on my example and it seems to work well.",
...
```json
{
    "body": "Attachment [sage-trac_12834.2.patch](tarball://root/attachments/some-uuid/ticket12834/sage-trac_12834.2.patch) by @orlitzky created at 2013-02-25 05:28:43\n\nUpdated!",
...
```json
{
    "body": "And looking at your last commit `k2 in d1.keys()` is O(n) in **any** case whereas `k2 in d1` is a lookup in a hash table.",
...
```json
{
    "body": "Looks good to me. Can I add a commit to show a more relevant example about comparisons of maple/mathematica with respect to substitution?",
...
```json
{
    "body": "I made some minor cosmetic fixes (typo fix and word-wrap). Other than that it looks good to me. As long as those optional tests work (I don't have maple/mathematica), you can mark it positive review.\n\n---\nLast 10 new commits:",
...
```json
{
    "body": "Thanks for the last fixes!",
    "created_at": "2015-05-19T07:10:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12834",
    "type": "issue_comment",
