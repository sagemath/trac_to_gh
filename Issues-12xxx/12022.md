...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143689"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12022#issuecomment-130079",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12022",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12022#event-143697"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12022",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12022#issuecomment-130080",
    "user": "https://github.com/jdemeyer"
}
```
