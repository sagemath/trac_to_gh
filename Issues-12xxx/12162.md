...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[4040117](http://git.sagemath.org/sage.git/commit/?id=4040117e8d920d235e6b02ca4c38bfd1f5da9880)|`Trac #12162: Add a simplify_full() method to the Matrix_symbolic_dense class.`|",
