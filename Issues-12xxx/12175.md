...
<a id='comment:2'></a>The patchbot show a doctest failure:
...
```json
{
    "body": "<a id='comment:3'></a>I have added a few \"# random# tags. Let us see if the bot is happy.",
...
<a id='comment:3'></a>I have added a few "# random# tags. Let us see if the bot is happy.
...
```json
{
    "body": "<a id='comment:4'></a>This shouldn't get a #random tag. Running the test multiple times gives the same new result every time.",
...
<a id='comment:4'></a>This shouldn't get a #random tag. Running the test multiple times gives the same new result every time.
...
```json
{
    "body": "<a id='comment:5'></a>I do not agree. This is a random function, and we should not expect it to return a fixed result.\n\n```\nsage: SL2Z.random_element(5, distribution='1/n')\n[-1 -1]\n[ 0 -1]\nsage: SL2Z.random_element(5, distribution='1/n')\n[1 1]\n[0 1]\nsage: SL2Z.random_element(5, distribution='1/n')\n[-1  7]\n[ 1 -8]\n```\n\nThe result is random, and the test must be tagged accordingly.",
...
<a id='comment:5'></a>I do not agree. This is a random function, and we should not expect it to return a fixed result.
...
<a id='comment:6'></a>It is a pseudorandom function. From the Developers guide
http://www.sagemath.org/doc/developer/conventions.html
...
<a id='comment:8'></a>Attachment [trac_12175_tag_random_fc.patch](tarball://root/attachments/some-uuid/ticket12175/trac_12175_tag_random_fc.patch) by @fchapoton created at 2013-02-15 09:18:43
...
```json
{
    "body": "<a id='comment:9'></a>Positive review, as the patchbot has given a green light and we agreed on what to do.",
    "created_at": "2013-02-15T12:46:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12175",
    "type": "issue_comment",
...
<a id='comment:9'></a>Positive review, as the patchbot has given a green light and we agreed on what to do.
...
```json
{
    "body": "<a id='comment:11'></a>Please fill in the Author and Reviewer fields with your real names.",
...
<a id='comment:11'></a>Please fill in the Author and Reviewer fields with your real names.
