...
```json
{
    "body": "The new patch has a dependency: #11900, which has positive review and is already in sage-5.0.prealpha0",
...
```json
{
    "body": "Note that inspite of the red blob, the patchbot finds that all tests pass with the the latest prerelease. So, review anyone?",
...
```json
{
    "body": "I see: the old copy method returned a copy whose base ring was None (!). Anyway, this looks like good stuff, and patchbot seems happy with it on two different v5.0 builds, so let's get it in.",
    "created_at": "2012-03-10T12:15:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12290",
    "type": "issue_comment",
