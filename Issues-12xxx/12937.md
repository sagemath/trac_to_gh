...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12937#issuecomment-148760",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12937#issuecomment-148761",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12937#issuecomment-148762",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12937#issuecomment-148763",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12937#issuecomment-148764",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [sqlite-3.7.5.p1.diff](https://github.com/sagemath/sage/files/ticket12937/sqlite-3.7.5.p1.diff) by @jdemeyer created at 2012-05-29 02:32:16\n\nObviously, `-I $SAGE_LOCAL/lib` should be `-L $SAGE_LOCAL/lib`.  This couldn't have solved any problem.",
    "created_at": "2012-05-29T02:32:16Z",
    "issue": "https://github.com/sagemath/sage/issues/12937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12937#issuecomment-148765",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12937#issuecomment-148766",
    "user": "https://github.com/jdemeyer"
}
```
