...
```json
{
    ...
    "type": "issue",
    "updated_at": "2016-06-20T19:41:53Z",
...
```json
{
    "body": "**Attachment:** [trac12996_initial.patch.gz](https://github.com/sagemath/sage/files/ticket12996/trac12996_initial.patch.gz)\n\nfirst version of a class providing support for one-dimensional shifts of finite type",
...
```json
{
    "body": "**Attachment:** [trac_12996_SFT_solved_warnings-MHS.patch.gz](https://github.com/sagemath/sage/files/ticket12996/trac_12996_SFT_solved_warnings-MHS.patch.gz)\n\nremoved personal warnings style, all doctests pass",
