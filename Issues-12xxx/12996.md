...
archive/attachments_018164.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac12996_initial.patch](https://github.com/sagemath/sage/files/ticket12996/trac12996_initial.patch)\n\nfirst version of a class providing support for one-dimensional shifts of finite type",
    "created_at": "2012-05-23T21:23:30Z",
    "issue": "https://github.com/sagemath/sage/issues/12996",
    "type": "issue_comment",
...
**Attachment:** [trac12996_initial.patch](https://github.com/sagemath/sage/files/ticket12996/trac12996_initial.patch)
...
archive/attachments_018166.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_018168.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12996_SFT_addressed_final_comments-MHS.patch](https://github.com/sagemath/sage/files/ticket12996/trac_12996_SFT_addressed_final_comments-MHS.patch)\n\nAddressed the comments by vdelecroix",
    "created_at": "2012-10-01T00:32:46Z",
    "issue": "https://github.com/sagemath/sage/issues/12996",
    "type": "issue_comment",
...
archive/attachments_018169.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_018170.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_018171.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12996_SFT_solved_warnings-MHS.patch](https://github.com/sagemath/sage/files/ticket12996/trac_12996_SFT_solved_warnings-MHS.patch)\n\nremoved personal warnings style, all doctests pass",
    "created_at": "2013-03-04T00:52:52Z",
    "issue": "https://github.com/sagemath/sage/issues/12996",
    "type": "issue_comment",
