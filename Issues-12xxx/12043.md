...
{
    "assignees": [],
    "body": "Computes to any required p-adic precision the characteristic series of the\nAtkin U_p operator on the space of p-adic overconvergent modular forms of\ngiven weight k and level N.\n\n**Apply**:\n1. [attachment: trac_12043-all.patch.gz](https://github.com/sagemath/sage/files/ticket12043/trac_12043-all.patch.gz)\n2. [attachment: 12043-fix.patch.gz](https://github.com/sagemath/sage/files/ticket12043/12043-fix.patch.gz)\n3. [attachment: 12043_long_time.patch.gz](https://github.com/sagemath/sage/files/ticket12043/12043_long_time.patch.gz)\n\nDepends on #12724\nDepends on #12740\n\nAssignee: **@craigcitro**\n\nCC:  @loefflerd\n\nReviewer: **David Loeffler, Jan Vonk**\n\nAuthor: **Alan Lauder**\n\nMerged: **sage-5.3.beta0**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/12043_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12043#event-148997"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12043#event-148998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12043#event-148999"
}
```
...
```json
{
    "body": "<a id='comment:23'>Comment 23:</a>\nAttachment: **[12043_long_time.patch.gz](https://github.com/sagemath/sage/files/ticket12043/12043_long_time.patch.gz)**\n\nAdditional patch [attachment: 12043_long_time.patch.gz](https://github.com/sagemath/sage/files/ticket12043/12043_long_time.patch.gz) needs review.  This is a **blocker** patch.",
    "created_at": "2012-09-01T10:41:54Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12043",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12043#issuecomment-130406",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12043#issuecomment-130407",
    "user": "https://github.com/jdemeyer"
}
```
