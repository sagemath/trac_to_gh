...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12574#issuecomment-141804",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12574#issuecomment-141805",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_12574-python.patch](https://github.com/sagemath/sage/files/ticket12574/trac_12574-python.patch) by @jhpalmieri created at 2012-02-23 17:36:58",
    "created_at": "2012-02-23T17:36:58Z",
    "issue": "https://github.com/sagemath/sage/issues/12574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12574#issuecomment-141806",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12574#issuecomment-141807",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12574#issuecomment-141808",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12574#issuecomment-141809",
    "user": "https://github.com/jdemeyer"
}
```
