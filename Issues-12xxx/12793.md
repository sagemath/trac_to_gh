...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12793#issuecomment-145732",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [12793_type_dual_cmp.patch](https://github.com/sagemath/sage/files/ticket12793/12793_type_dual_cmp.patch) by @nthiery created at 2012-04-02 15:36:18\n\nI just made a micro change to check that exchanging F4dual and B4dual inverses the sign.\nIf you are happy with it, you can set a positive review on my behalf.\n\nThanks for fixing my tests!",
    "created_at": "2012-04-02T15:36:18Z",
    "issue": "https://github.com/sagemath/sage/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12793#issuecomment-145733",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12793#issuecomment-145734",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12793#issuecomment-145735",
    "user": "https://github.com/jdemeyer"
}
```
