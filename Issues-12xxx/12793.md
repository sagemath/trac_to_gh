...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12793#issuecomment-185749",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [12793_type_dual_cmp.patch](tarball://root/attachments/some-uuid/ticket12793/12793_type_dual_cmp.patch) by @nthiery created at 2012-04-02 15:36:18\n\nI just made a micro change to check that exchanging F4dual and B4dual inverses the sign.\nIf you are happy with it, you can set a positive review on my behalf.\n\nThanks for fixing my tests!",
    "created_at": "2012-04-02T15:36:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12793#issuecomment-185750",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:2'></a>Attachment [12793_type_dual_cmp.patch](tarball://root/attachments/some-uuid/ticket12793/12793_type_dual_cmp.patch) by @nthiery created at 2012-04-02 15:36:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12793#issuecomment-185751",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12793#issuecomment-185752",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12793#issuecomment-185753",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12793",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12793#event-34771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12793#issuecomment-185754",
    "user": "https://github.com/jdemeyer"
}
```
