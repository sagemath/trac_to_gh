...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160400"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160403"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -31,3 +31,9 @@\n ```\n On the screen, you do not see the list of environment variables or the status updates for each package (\"PKG: installing. Log file ...\"); instead, you see the ongoing build process for each package, just the way things are now.\n \n+---\n+\n+Apply [attachment: trac_12729-small-install-log.patch.gz](https://github.com/sagemath/sage/files/ticket12729/trac_12729-small-install-log.patch.gz) to the root repository.\n+\n+Note: this depends on #12369, so it might be best to grab the tarball in that ticket's description. You can then apply this right after unpacking the tarball.\n+\n``````\n",
    "created_at": "2012-03-22T16:54:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144833",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144834",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144835",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144836",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144837",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144838",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144839",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144840",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144841",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144842",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144843",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144844",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144845",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144846",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144847",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144848",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144849",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144850",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160406"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144851",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160407"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160408"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160409"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160410"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160411"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160412"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160413"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160414"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144852",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144853",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160417"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144854",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-160421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-144855",
