...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175254"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175256"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175257"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175258"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -31,3 +31,9 @@\n ```\n On the screen, you do not see the list of environment variables or the status updates for each package (\"PKG: installing. Log file ...\"); instead, you see the ongoing build process for each package, just the way things are now.\n \n+---\n+\n+Apply [attachment: trac_12729-small-install-log.patch](https://github.com/sagemath/sage/files/ticket12729/trac_12729-small-install-log.patch.gz) to the root repository.\n+\n+Note: this depends on #12369, so it might be best to grab the tarball in that ticket's description. You can then apply this right after unpacking the tarball.\n+\n``````\n",
    "created_at": "2012-03-22T16:54:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142559",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142560",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Changed dependencies from **#12369** to **#12714, #12369**",
    "created_at": "2012-03-22T17:06:34Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142561",
    "user": "https://github.com/jhpalmieri"
}
```

Changed dependencies from **#12369** to **#12714, #12369**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142562",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142563",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142564",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142565",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142566",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142567",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142568",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142569",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142570",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142571",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142572",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142573",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142574",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142575",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142576",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142577",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175262"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175263"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175264"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175265"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175266"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175267"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175268"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142578",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142579",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142580",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175273"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12729#event-175276"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12729#issuecomment-142581",
