...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145614",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145615",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145616",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket12781/trac_12781_remove_cruft.patch",
    "created_at": "2013-04-23T19:49:13Z",
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12781/trac_12781_remove_cruft.patch",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_12781_remove_cruft.patch](https://github.com/sagemath/sage/files/ticket12781/trac_12781_remove_cruft.patch) by @vbraun created at 2013-04-23 19:49:13\n\nI also happened upon this gem that looks like it changes `sys.path` but actually is never called",
    "created_at": "2013-04-23T19:49:13Z",
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145617",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145618",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145619",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145620",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12781#issuecomment-145621",
