...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145319"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12128#issuecomment-132072",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12128",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12128#event-145327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12128#issuecomment-132073",
    "user": "https://github.com/jdemeyer"
}
```
