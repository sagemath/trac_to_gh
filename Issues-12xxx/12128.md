...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168898",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168899",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168900",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168901",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168902",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>At first I though this was trading one edge case for another (albeit less likely) one. It seems, however, that testing for a `.hg` directory is as good as it gets.\n\nFirst of all, the issue is valid:\n\n```\n$ cd ~/tmp\ntmp $ hg init\ntmp $ mkdir subdir\ntmp $ cd subdir\nsubdir $ hg verify\nchecking changesets\nchecking manifests\ncrosschecking files in changesets and manifests\nchecking files\n0 files, 0 changesets, 0 total revisions\n```\n\nWithin `subdir`, I thought there would be an issue: we can have an `.hg` subdirectory that isn't Mercurial data. However, it looks like Mercurial itself ignores that fact:\n\n```\nsubdir $ ls -a\ntotal 8.0K\ndrwxr-xr-x 2 mjo mjo 4.0K 2011-12-09 15:38 .\ndrwxr-xr-x 4 mjo mjo 4.0K 2011-12-09 15:38 ..\nsubdir $ hg root\n/home/mjo/tmp\nsubdir $ mkdir .hg\nsubdir $ hg root\n/home/mjo/tmp/subdir\n```\n\nMoreover, `hg verify` and the like work with just an empty `.hg` directory. So, we don't gain anything by doing both tests.",
    "created_at": "2011-12-09T22:48:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168903",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:2'></a>At first I though this was trading one edge case for another (albeit less likely) one. It seems, however, that testing for a `.hg` directory is as good as it gets.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12128#event-32240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168904",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12128#issuecomment-168905",
    "user": "https://github.com/jdemeyer"
}
```
