...
```json
{
    "body": "<a id='comment:1'></a>with Sage 4.8 compiled from source only one doctest fails:\n\n```\nThe following tests failed:\n\n        sage -t  devel/sage-main/sage/sandpiles/sandpile.py # Time out\n```\nPaul",
    "created_at": "2012-02-01T16:32:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12411#issuecomment-176135",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:1'></a>with Sage 4.8 compiled from source only one doctest fails:
...
```json
{
    "body": "<a id='comment:2'></a>I propose to close that ticket, since it only concerns an old version of Sage.\n\nPaul",
    "created_at": "2013-01-08T08:46:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12411#issuecomment-176136",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>I propose to close that ticket, since it only concerns an old version of Sage.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12411#issuecomment-176137",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12411#issuecomment-176138",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12411#issuecomment-176139",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12411#event-33313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12411#issuecomment-176140",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12411",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12411#event-33314"
}
```
