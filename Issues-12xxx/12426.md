...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143317"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143318"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143319"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143320"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143321"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143322"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143323"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143324"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143325"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143326"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143327"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143328"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143329"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143330"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143331"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143332"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143333"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143334"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -35,10 +35,10 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-217.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-217.tar.gz.gz) and build with\n \n ```\n-CC=clang CXX=clang++ make\n+make\n ```\n \n \n``````\n",
...
```json
{
    ...
    "milestone_title": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143335"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143336"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -47,7 +47,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-217.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-217.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-218.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-218.tar.gz.gz) and build with\n \n ```\n make\n``````\n",
    "created_at": "2017-04-23T21:48:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12426",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -47,7 +47,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-218.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-218.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-219.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-219.tar.gz.gz) and build with\n \n ```\n make\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -47,7 +47,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-219.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-219.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-220.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-220.tar.gz.gz) and build with\n \n ```\n make\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -47,7 +47,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-220.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-220.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-222.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-222.tar.gz.gz) and build with\n \n ```\n make\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -4,22 +4,6 @@\n \n Packages failing to build (or causing other packages to fail to build) with Clang:\n \n-* Gfan (0.5) -- #12440\n-* Lcalc -- #12437\n-* LinBox -- C++ problem reported upstream at [https://github.com/linbox-team/linbox/issues/39](https://github.com/linbox-team/linbox/issues/39)\n-* !Linbox assumes some compilers including clang++ use the gnu libstdc++ on OS other than OS X: #21977 upstream https://github.com/linbox-team/linbox/issues/46\n-* pynac -- #21623\n-* python3 -- #22756: on OS X, if we use gcc instead of clang, then the `_scproxy` module fails to build. (We already build `python2` with clang on OS X.)\n-* ratpoints -- #12473 (uses nested functions and GCC builtins not supported by clang)\n-* Symmetrica -- #12439\n-* fix `import_array` in `finance/time_series.pyx` now fixed by #20596\n-* fix abuse of `inline` keyword in `pxd` files #21696\n-* Problems compiling `expression.pyx` probably `pynac` upstream problem #21701\n-* fix conflicting language options (`-std=c99` used by C++ code): #22554\n-* build with clang: fplll symbol not found errors (#22643)\n-* `polybori` segfault when built with clang on OS X (#22677)\n-* Get sage to select the right compiler when built with clang (#22678)\n-* numerical noise in doctests when built with clang (#22798)\n * strange warnings from numpy and matplotlib when built with clang (#22799)\n * On linux with clang, python (all versions) uses the wrong option to get the compiler to pass runpath to the linker. Upstream issue #[25229](http://bugs.python.org/issue25229). This doesn't affect OS X and freeBSD. #23046\n \n@@ -29,15 +13,7 @@\n * `eclib`, reported upstream at https://github.com/JohnCremona/eclib/issues/19\n * `gf2x`/`ntl` #18882\n * `giac` - patch to pass tests with gcc/pari-2.8+ causes failures with clang\n-* `zeromq` #22837?\n * `ccache` #22836\n-* `cysignals`, strangely passes with python 3.4 but not 2.7, upstream issue https://github.com/sagemath/cysignals/issues/56 #22691\n-\n----\n-\n-Spkgs ignoring CC/CXX environment variables:\n-\n-* Sage -- #12443 ?\n \n ---\n \n@@ -47,7 +23,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-222.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-222.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-223.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-223.tar.gz.gz) and build with\n \n ```\n make\n@@ -58,4 +34,4 @@\n CC=clang CXX=clang++ make\n ```\n on OS where clang is not the default compiler [it should also work on OS X].\n-For linux add http://bugs.python.org/file40568/distutils-compiler-name.patch to the patches folder of python2 (or python3 if using).\n+For linux add http://bugs.python.org/file40568/distutils-compiler-name.patch to the patches folder of python2 (or python3 if using) #23046.\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-223.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-223.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-226.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-226.tar.gz.gz) and build with\n \n ```\n make\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143337"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-226.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-226.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz) and build with\n \n ```\n make\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz) and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz) to the `upstream` folder and build with\n \n ```\n make\n@@ -36,4 +36,4 @@\n on OS where clang is not the default compiler [it should also work on OS X].\n For linux add http://bugs.python.org/file40568/distutils-compiler-name.patch to the patches folder of python2 (or python3 if using) #23046.\n \n-If you start from a clone rather than a tarball, be sure to download the gcc tarball first before letting the bootstrap try to download from an inexistent gfortran folder in the upstream repo.\n+If you start from a clone rather than a tarball, be sure to also download the gcc tarball to the `upstream` folder first before letting the bootstrap try to download from an inexistent gfortran folder in the upstream repo.\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-227.tar.gz.gz) to the `upstream` folder and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-228.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-228.tar.gz.gz) to the `upstream` folder and build with\n \n ```\n make\n``````\n",
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143338"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143339"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-228.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-228.tar.gz.gz) to the `upstream` folder and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-229.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-229.tar.gz.gz) to the `upstream` folder and build with\n \n ```\n make\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -23,7 +23,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-229.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-229.tar.gz.gz) to the `upstream` folder and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-231.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-231.tar.gz.gz) to the `upstream` folder and build with\n \n ```\n make\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -2,16 +2,9 @@\n \n ---\n \n-Packages failing to build (or causing other packages to fail to build) with Clang:\n-\n-* strange warnings from numpy and matplotlib when built with clang (#22799)\n-* On linux with clang, python (all versions) uses the wrong option to get the compiler to pass runpath to the linker. Upstream issue #[25229](http://bugs.python.org/issue25229). This doesn't affect OS X and freeBSD. #23046\n-\n----\n \n Packages failing their tests\n * `eclib`, reported upstream at https://github.com/JohnCremona/eclib/issues/19\n-* `gf2x`/`ntl` #18882\n * `giac` - patch to pass tests with gcc/pari-2.8+ causes failures with clang\n * `ccache` #22836\n \n@@ -23,7 +16,7 @@\n \n ---\n \n-Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-231.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-231.tar.gz.gz) to the `upstream` folder and build with\n+Testing: merge the attached branch, run `autoreconf` or download the configure tarball [https://github.com/sagemath/sage/files/ticket12426/configure-232.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-232.tar.gz.gz) to the `upstream` folder and build with\n \n ```\n make\n@@ -34,6 +27,5 @@\n CC=clang CXX=clang++ make\n ```\n on OS where clang is not the default compiler [it should also work on OS X].\n-For linux add http://bugs.python.org/file40568/distutils-compiler-name.patch to the patches folder of python2 (or python3 if using) #23046.\n \n-If you start from a clone rather than a tarball, be sure to also download the gcc tarball to the `upstream` folder first before letting the bootstrap try to download from an inexistent gfortran folder in the upstream repo.\n+If you start from a clone rather than a tarball, be sure to also download the gcc tarball to the `upstream` folder first before letting the bootstrap try to download from an nonexistent gfortran folder in the upstream repo.\n``````\n",
...
```json
{
    "body": "**Attachment:** [configure-233.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-233.tar.gz.gz)",
...
**Attachment:** [configure-233.tar.gz.gz](https://github.com/sagemath/sage/files/ticket12426/configure-233.tar.gz.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143341"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143342"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143344"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143345"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143346"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143347"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143350"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143351"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143353"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143364"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143366"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143370"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143371"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12426",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12426#event-143374"
}
```
