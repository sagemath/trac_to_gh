...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -16,4 +16,4 @@\n Nathann\n \n Apply:\n-* [attachment:trac_12220.patch]\n+* [attachment:trac_12220_CbcModel_OsiClpSolverInterface.patch]\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -16,4 +16,4 @@\n Nathann\n \n Apply:\n-* [attachment:trac_12220_CbcModel_OsiClpSolverInterface.patch]\n+* [attachment:trac_12220_CbcModel_OsiClpSolverInterface.2.patch]\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -17,3 +17,4 @@\n \n Apply:\n * [attachment:trac_12220_CbcModel_OsiClpSolverInterface.2.patch]\n+* [attachment:trac_12220_fractional_index.patch]\n``````\n",
    "created_at": "2012-02-06T18:49:45Z",
    "issue": "https://github.com/sagemath/sage/issues/12220",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -17,4 +17,4 @@\n \n Apply:\n * [attachment:trac_12220_CbcModel_OsiClpSolverInterface.2.patch]\n-* [attachment:trac_12220_fractional_index.patch]\n+* [attachment:trac_12220_note-writeLP.patch]\n``````\n",
    "created_at": "2012-02-06T22:09:56Z",
    "issue": "https://github.com/sagemath/sage/issues/12220",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -18,3 +18,4 @@\n Apply:\n * [attachment:trac_12220_CbcModel_OsiClpSolverInterface.2.patch]\n * [attachment:trac_12220_note-writeLP.patch]\n+* [attachment:trac_12220_binpacking_rounding.patch]\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -15,7 +15,7 @@\n \n Nathann\n \n-Apply:\n+**Apply:**\n * [attachment:trac_12220_CbcModel_OsiClpSolverInterface.2.patch]\n * [attachment:trac_12220_note-writeLP.patch]\n-* [attachment:trac_12220_binpacking_rounding.patch]\n+* [attachment:trac_12220_binpacking_rounding.patch] **or** [attachment:trac_12220_coin_rounding.patch] *(attach only one!)*\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -18,4 +18,4 @@\n **Apply:**\n * [attachment:trac_12220_CbcModel_OsiClpSolverInterface.2.patch]\n * [attachment:trac_12220_note-writeLP.patch]\n-* [attachment:trac_12220_binpacking_rounding.patch] **or** [attachment:trac_12220_coin_rounding.patch] *(attach only one!)*\n+* [attachment:trac_12220_binpacking_rounding.patch] **or** [attachment:trac_12220_coin_rounding.patch] *(apply only one of these two!)*\n``````\n",
