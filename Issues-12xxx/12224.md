...
```json
{
    "body": "<a id='comment:23'></a>I just reorganized my comments which were all mixed up. See [Comment 10](#comment%3A10) for an up to date summary.",
...
<a id='comment:23'></a>I just reorganized my comments which were all mixed up. See [Comment 10](#comment%3A10) for an up to date summary.
