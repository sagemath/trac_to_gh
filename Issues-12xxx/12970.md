...
```json
{
    "body": "<a id='comment:1'></a>Does building with SAGE_FAT_BINARY=yes solve your problem?",
    "created_at": "2012-05-18T11:03:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190463",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Does building with SAGE_FAT_BINARY=yes solve your problem?
...
```json
{
    "body": "<a id='comment:2'></a>Yup. It's not really any less of a workaround than what I've been doing, though:\n\n```\n$ make\n# build fails on mpir\n$ CFLAGS=\"-O2 -march=native\" ./sage -i mpir\n# mpir builds successfully\n$ make\n# build continues\n```",
    "created_at": "2012-05-18T13:18:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190464",
    "user": "https://github.com/kini"
}
```

<a id='comment:2'></a>Yup. It's not really any less of a workaround than what I've been doing, though:
...
```json
{
    "body": "<a id='comment:4'></a>Is it really a bug in Virtualbox? Isn't it a bug in MPIR's detection of CPU capabilities? Is it guaranteed that Virtualbox VMs are the only places where MPIR will fail to correctly determine the instruction set of the CPU? (I doubt so...)",
    "created_at": "2012-05-18T13:59:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190466",
    "user": "https://github.com/kini"
}
```

<a id='comment:4'></a>Is it really a bug in Virtualbox? Isn't it a bug in MPIR's detection of CPU capabilities? Is it guaranteed that Virtualbox VMs are the only places where MPIR will fail to correctly determine the instruction set of the CPU? (I doubt so...)
...
```json
{
    "body": "<a id='comment:6'></a>Well, at the least, it seems likely or at least possible on other virtualization platforms. There's also the possibility of weird knockoff processors that pretend to be certain architectures, but I doubt anyone is trying to run Sage on those :P",
    "created_at": "2012-05-18T14:19:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190468",
    "user": "https://github.com/kini"
}
```

<a id='comment:6'></a>Well, at the least, it seems likely or at least possible on other virtualization platforms. There's also the possibility of weird knockoff processors that pretend to be certain architectures, but I doubt anyone is trying to run Sage on those :P
...
```json
{
    "body": "<a id='comment:7'></a>Concerning the success reports with `-march=native` and `SAGE_FAT_BINARY=yes`: did you actually try to run Sage?  Because building is one thing, running another.",
    "created_at": "2012-05-18T14:40:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190469",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Concerning the success reports with `-march=native` and `SAGE_FAT_BINARY=yes`: did you actually try to run Sage?  Because building is one thing, running another.
...
```json
{
    "body": "<a id='comment:8'></a>With `SAGE_FAT_BINARY=yes`, no; with `-march=native`, yes, I was even running a patchbot with it for a while (until I decided to put one on arando instead since it's idle most of the time anyway). I'll run `make ptestlong` on my VM, stand by for results :)",
    "created_at": "2012-05-18T14:56:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190470",
    "user": "https://github.com/kini"
}
```

<a id='comment:8'></a>With `SAGE_FAT_BINARY=yes`, no; with `-march=native`, yes, I was even running a patchbot with it for a while (until I decided to put one on arando instead since it's idle most of the time anyway). I'll run `make ptestlong` on my VM, stand by for results :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190471",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190472",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Please test the spkg [http://boxen.math.washington.edu/home/jdemeyer/spkg/mpir-2.4.0.p5.spkg](http://boxen.math.washington.edu/home/jdemeyer/spkg/mpir-2.4.0.p5.spkg) and attach the MPIR log file, whether it succeeds or not.",
    "created_at": "2012-05-18T22:19:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190473",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>Please test the spkg [http://boxen.math.washington.edu/home/jdemeyer/spkg/mpir-2.4.0.p5.spkg](http://boxen.math.washington.edu/home/jdemeyer/spkg/mpir-2.4.0.p5.spkg) and attach the MPIR log file, whether it succeeds or not.
...
```json
{
    "body": "<a id='comment:10'></a>Sorry, I can't test it - I don't have access to the machine on which I encountered this problem until July when I go back to Singapore (ssh tunnel failed for some reason...).",
    "created_at": "2012-05-20T14:12:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190474",
    "user": "https://github.com/kini"
}
```

<a id='comment:10'></a>Sorry, I can't test it - I don't have access to the machine on which I encountered this problem until July when I go back to Singapore (ssh tunnel failed for some reason...).
...
```json
{
    "body": "<a id='comment:13'></a>The new version passes all tests except one in the yasm testsuite. This is a known bug in yasm and recently fixed at http://tortall.lighthouseapp.com/projects/78676/tickets/220-make-check-failure",
    "created_at": "2012-05-28T01:48:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190476",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:13'></a>The new version passes all tests except one in the yasm testsuite. This is a known bug in yasm and recently fixed at http://tortall.lighthouseapp.com/projects/78676/tickets/220-make-check-failure
...
```json
{
    "body": "Changing dependencies from \"\" to \"#12954\"",
    "created_at": "2012-05-28T05:33:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190477",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "" to "#12954"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190478",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190479",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190480",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Same fails on my laptop -- newest released VirtualBox + Ubuntu 12.04 in 64-bit mode:\n\n```\n\nPASS: modules/preprocs/raw/tests/rawpp_test.sh\nTest dwarf2_gen64_test: O +0-1/1 0%\n ** O: dwarf64_pathname did not match object file!\nFAIL: modules/dbgfmts/dwarf2/tests/gen64/dwarf2_gen64_test.sh\nTest dwarf2_pass32_test: .. +2-0/2 100%\n```\nEverything else passes.",
    "created_at": "2012-05-28T06:08:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190481",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:15'></a>Same fails on my laptop -- newest released VirtualBox + Ubuntu 12.04 in 64-bit mode:
...
```json
{
    "body": "<a id='comment:16'></a>FWIW, mpfr and ecm both work with SAGE_CHECK=\"yes\" on my 64-bit VM.",
    "created_at": "2012-05-28T06:21:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190482",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:16'></a>FWIW, mpfr and ecm both work with SAGE_CHECK="yes" on my 64-bit VM.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190483",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Everything worked on my 32-bit VM too! I've looked at the diffs and everything looks good.",
    "created_at": "2012-05-28T06:43:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190484",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:17'></a>Everything worked on my 32-bit VM too! I've looked at the diffs and everything looks good.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190485",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190486",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190487",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190488",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12970#issuecomment-190489",
    "user": "https://github.com/jdemeyer"
}
```
