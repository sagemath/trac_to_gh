...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147506"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147507"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147512"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12270#issuecomment-135040",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147513"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12270",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-147516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12270#issuecomment-135041",
    "user": "https://github.com/jdemeyer"
}
```
