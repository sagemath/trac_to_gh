...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12061#event-149321"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12061#event-149322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12061#event-149323"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,5 +1,5 @@\n-Towards completing #12024\n+Towards completing #12024.\n \n-* Have been unable to figure out what the `.set()` and `.get()` methods do\n+---\n+Apply only [attachment: trac_12061-doctest_interfaces_psage.2.patch.gz](https://github.com/sagemath/sage/files/ticket12061/trac_12061-doctest_interfaces_psage.2.patch.gz) to `devel/sage`.\n \n-Attaching patch.\n``````\n",
    "created_at": "2012-03-01T11:30:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12061",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12061#issuecomment-130679",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12061#issuecomment-130680",
    "user": "https://github.com/ppurka"
}
```
