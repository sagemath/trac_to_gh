...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169671",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169672",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169673",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169674",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169675",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169677",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169678",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I'm tempted to make #12719 a prerequisite for this: we should update to IPython 0.12, and this will require (I think) revising the formats of the configuration files.  While doing that, we can also move them elsewhere, or just create a single Sage config file and put it somewhere sensible.",
    "created_at": "2012-03-21T20:12:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169679",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>I'm tempted to make #12719 a prerequisite for this: we should update to IPython 0.12, and this will require (I think) revising the formats of the configuration files.  While doing that, we can also move them elsewhere, or just create a single Sage config file and put it somewhere sensible.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12167#event-32345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169680",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169681",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169682",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Fixed by #12719.",
    "created_at": "2013-01-25T09:08:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12167#issuecomment-169683",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Fixed by #12719.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12167",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12167#event-32346"
}
```
