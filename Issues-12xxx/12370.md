...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168764"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168765"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168766"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168767"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168768"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-jlopez",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-134996",
    "user": "https://github.com/sagetrac-jlopez"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168770"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-134997",
    "user": "https://github.com/sagetrac-jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-134998",
    "user": "https://github.com/sagetrac-jlopez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-134999",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-135000",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-135001",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-135002",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12370#issuecomment-135003",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12370",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12370#event-168774"
}
```
