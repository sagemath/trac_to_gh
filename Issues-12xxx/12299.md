...
```json
{
    "body": "**Attachment:** [trac_12299_plot_3D_static_img.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_plot_3D_static_img.patch)\n\nupdate to remove duplicate patches",
    "created_at": "2012-06-04T20:12:11Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Attachment:** [trac_12299_plot_3D_static_img.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_plot_3D_static_img.patch)
...
```json
{
    "body": "**Changing work issues** from \"create upstream pull request\" to \"create upstream pull request, double patch\".",
...
**Changing work issues** from "create upstream pull request" to "create upstream pull request, double patch".
...
```json
{
    "body": "**Changing work issues** from \"create upstream pull request, double patch\" to \"double patch\".",
    "created_at": "2012-06-06T13:11:09Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Changing work issues** from "create upstream pull request, double patch" to "double patch".
...
```json
{
    "body": "**Changing work issues** from \"double patch\" to \"pop-up menu?\".",
...
**Changing work issues** from "double patch" to "pop-up menu?".
...
```json
{
    "body": "<a id='comment:27'></a>\n**Attachment:** [trac_12299_adv_jmol_nb.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_adv_jmol_nb.patch)",
    "created_at": "2012-06-06T19:30:45Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
```json
{
    "body": "**Changing work issues** from \"pop-up menu?\" to \"old worksheets don't work\".",
...
**Changing work issues** from "pop-up menu?" to "old worksheets don't work".
...
```json
{
    "body": "**Changing work issues** from \"old worksheets don't work\" to \"old worksheets don't work, signed and unsigned applet collision\".",
...
**Changing work issues** from "old worksheets don't work" to "old worksheets don't work, signed and unsigned applet collision".
...
```json
{
    "body": "**Changing work issues** from \"old worksheets don't work, signed and unsigned applet collision\" to \"signed and unsigned applet collision\".",
    "created_at": "2012-06-12T03:55:32Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Changing work issues** from "old worksheets don't work, signed and unsigned applet collision" to "signed and unsigned applet collision".
...
```json
{
    "body": "**Changing work issues** from \"signed and unsigned applet collision\" to \"signed and unsigned applet collision, old worksheets may not work all the time\".",
    "created_at": "2012-06-12T13:26:21Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Changing work issues** from "signed and unsigned applet collision" to "signed and unsigned applet collision, old worksheets may not work all the time".
...
```json
{
    "body": "**Changing work issues** from \"signed and unsigned applet collision, old worksheets may not work all the time\" to \"decide default display quality\".",
...
**Changing work issues** from "signed and unsigned applet collision, old worksheets may not work all the time" to "decide default display quality".
...
```json
{
    "body": "**Changing work issues** from \"decide default display quality\" to \"decide default display quality, doctests,switch to generic error\".",
...
**Changing work issues** from "decide default display quality" to "decide default display quality, doctests,switch to generic error".
...
```json
{
    "body": "**Changing work issues** from \"decide default display quality, doctests,switch to generic error\" to \"applet ID when cells re-evaluated,decide default display quality, doctests,switch to generic error\".",
...
**Changing work issues** from "decide default display quality, doctests,switch to generic error" to "applet ID when cells re-evaluated,decide default display quality, doctests,switch to generic error".
...
```json
{
    "body": "**Changing work issues** from \"applet ID when cells re-evaluated,decide default display quality, doctests,switch to generic error\" to \"decide default display quality, doctests,switch to generic error\".",
...
**Changing work issues** from "applet ID when cells re-evaluated,decide default display quality, doctests,switch to generic error" to "decide default display quality, doctests,switch to generic error".
...
```json
{
    "body": "**Changing work issues** from \"decide default display quality, doctests,switch to generic error\" to \"doctests,switch to generic error\".",
...
**Changing work issues** from "decide default display quality, doctests,switch to generic error" to "doctests,switch to generic error".
...
archive/attachments_017060.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12299_server_sync_and_UI.patch",
    "asset_url": "tarball://root/attachments/ticket12299/trac_12299_server_sync_and_UI.patch",
    "created_at": "2012-06-14T19:10:02Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12299/trac_12299_server_sync_and_UI.patch",
    "user": "https://github.com/gutow"
}
```
...
archive/attachments_017061.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12299_server_sync_and_UI.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_server_sync_and_UI.patch)\n\n**Attachment:** [trac_12299_server_sync_and_UI.2.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_server_sync_and_UI.2.patch)\n\nFix server<->Jmol syncing and tweak UI (no more sparkles and better vocabulary).",
    "created_at": "2012-06-14T19:10:02Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Attachment:** [trac_12299_server_sync_and_UI.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_server_sync_and_UI.patch)
...
```json
{
    "body": "**Changing work issues** from \"doctests,switch to generic error\" to \"\".",
    "created_at": "2012-06-14T23:20:55Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Changing work issues** from "doctests,switch to generic error" to "".
...
```json
{
    "body": "<a id='comment:93'></a>\n**Attachment:** [trac_12299_jmoldata_doctests.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_jmoldata_doctests.patch)\n\nDecided to keep JmolData specific error as may need it for movie generation.",
    "created_at": "2012-06-14T23:20:55Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
```json
{
    "body": "**Changing work issues** from \"very minor doc issues\" to \"\".",
...
**Changing work issues** from "very minor doc issues" to "".
...
```json
{
    "body": "**Attachment:** [trac_12299-reviewer.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299-reviewer.patch)",
    "created_at": "2012-06-17T02:20:39Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_12299-jhp.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299-jhp.patch)\n\nminor cleanup of paths in jmoldata.py",
    "created_at": "2012-06-17T19:47:22Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Attachment:** [trac_12299-jhp.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299-jhp.patch)
...
```json
{
    "body": "**Attachment:** [Screen shot 2012-06-18 at 8.28.42 AM.png](https://github.com/sagemath/sage/files/ticket12299/427dde25dc65a51848a3d484c863137a.png)\n\nShows documentation not building properly",
    "created_at": "2012-06-18T12:32:49Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Attachment:** [Screen shot 2012-06-18 at 8.28.42 AM.png](https://github.com/sagemath/sage/files/ticket12299/427dde25dc65a51848a3d484c863137a.png)
...
```json
{
    "body": "**Changing work issues** from \"use predefined paths\" to \"doc built right, update pull request\".",
...
**Changing work issues** from "use predefined paths" to "doc built right, update pull request".
...
```json
{
    "body": "**Changing work issues** from \"doc built right, update pull request\" to \"\".",
...
**Changing work issues** from "doc built right, update pull request" to "".
...
```json
{
    "body": "**Attachment:** [trac_12299-all-in-one.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299-all-in-one.patch)\n\nall Sage library patches, folded into one",
    "created_at": "2012-06-18T16:59:32Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Attachment:** [trac_12299-all-in-one.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299-all-in-one.patch)
...
```json
{
    "body": "**Attachment:** [trac_12299_headless_java.patch](https://github.com/sagemath/sage/files/ticket12299/trac_12299_headless_java.patch)\n\nreinserting headless option for java launch",
    "created_at": "2012-07-03T03:16:21Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac-12299_java_doctest_opt.patch](https://github.com/sagemath/sage/files/ticket12299/trac-12299_java_doctest_opt.patch)\n\nmake java dependent doctests in jmoldata.py optional",
    "created_at": "2012-07-17T12:53:47Z",
    "issue": "https://github.com/sagemath/sage/issues/12299",
    "type": "issue_comment",
...
**Attachment:** [trac-12299_java_doctest_opt.patch](https://github.com/sagemath/sage/files/ticket12299/trac-12299_java_doctest_opt.patch)
