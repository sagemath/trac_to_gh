...
archive/attachments_018172.json:
```json
{
...
```json
{
    "body": "**Attachment:** [lyndon_word.py](https://github.com/sagemath/sage/files/ticket12997/lyndon_word.py)\n\nModified lyndon_word.py",
    "created_at": "2012-05-24T11:21:54Z",
    "issue": "https://github.com/sagemath/sage/issues/12997",
    "type": "issue_comment",
...
**Attachment:** [lyndon_word.py](https://github.com/sagemath/sage/files/ticket12997/lyndon_word.py)
...
archive/attachments_018173.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "diff",
...
archive/attachments_018174.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_018175.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_018176.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12997-Lyndon-review-fc.patch](https://github.com/sagemath/sage/files/ticket12997/trac_12997-Lyndon-review-fc.patch)",
    "created_at": "2013-03-17T20:07:52Z",
    "issue": "https://github.com/sagemath/sage/issues/12997",
    "type": "issue_comment",
