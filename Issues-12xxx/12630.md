...
```json
{
    "body": "<a id='comment:1'></a>\nI want to finally get this ticket off my plate. So, as a starter, I was turning the three patches into three commits of a git branch (removing some trailing whitespace in the process). Next, I need to read the preceding comments again, and fix the code accordingly.\n\n---\nNew commits:\n|                                                                                                         |                                                                                                     |\n|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[fda4012](http://git.sagemath.org/sage.git/commit/?id=fda4012)|#12630: Use existing Sage infrastructure for quiver representations and their homspaces and morphisms|\n|[ff82cf0](http://git.sagemath.org/sage.git/commit/?id=ff82cf0)|Implementation of quivers as associative magmas|\n|[4cbb1b0](http://git.sagemath.org/sage.git/commit/?id=4cbb1b0)|trac #12630 Add representations of quivers and quiver algebras|",
    "created_at": "2013-12-05T22:21:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[e9796a1](http://git.sagemath.org/sage.git/commit/?id=e9796a13f5f8304f42cebc07728bcefb32c83e0a)|`trac #15810: Immutable directed graphs should know that they are directed`|\n|[d6ca86c](http://git.sagemath.org/sage.git/commit/?id=d6ca86c1d6984bc7a468b80905ddec01323cc9b6)|`trac #15810: The graph data structures may have a ._directed but no .directed`|\n|[a16f59f](http://git.sagemath.org/sage.git/commit/?id=a16f59ff43dbab3acebd585fd25b27b208770131)|`Merge branch 'ticket/15810' into ticket/12630, to make acyclicity tests work for immutable directed graphs`|\n|[200b04b](http://git.sagemath.org/sage.git/commit/?id=200b04b9e5c2ffef128fc49253807337777bc266)|`Do not introduce a separate class for quivers (use immutable DiGraph)`|\n|[dc973b4](http://git.sagemath.org/sage.git/commit/?id=dc973b43b0e24a8fc1c7446d296c743f9b9c630f)|`Do not use \"invalid path\" for quivers. Fix all doctests.`|",
...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[edb52df](http://git.sagemath.org/sage.git/commit/?id=edb52dfad756d6dceb3e97dc97fe665c36912b87)|`mostly grammatical fixes to documentation; not a review at all`|",
    "created_at": "2014-02-15T22:50:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[3542d37](http://git.sagemath.org/sage.git/commit/?id=3542d3711d9b3878d602b47ce18854b53168f3c1)|`Merge branch 'develop' into quivers`|\n|[461e1ed](http://git.sagemath.org/sage.git/commit/?id=461e1ed956a1b1623fa0e5d4a68e6c5379af4d68)|`update doctests`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|\n|[f7fc2ec](http://git.sagemath.org/sage.git/commit/?id=f7fc2eca6347a5abbebcad50bc7abe41a73a60e2)|`allowed empty quiver; made homogeneous components work for quivers with cycles; fixed various places in doc`|",
    "created_at": "2014-02-16T03:33:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nNew commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[a6b04c6](http://git.sagemath.org/sage.git/commit/?id=a6b04c6c57b2362cbfa2e300a5d592ef79757fc8)|`a few more doc improvements`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[50eb7bd](http://git.sagemath.org/sage.git/commit/?id=50eb7bde26c2a0c688e0500918597591097aa0cb)|`simplifying all_paths and improving more doc`|",
    "created_at": "2014-02-17T02:29:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[50b0f84](http://git.sagemath.org/sage.git/commit/?id=50b0f845d84b03c1af4c3c1ec5f3855dab8b7d10)|`Trac 12630: Fix QuiverRepHom by renaming __call__ to _call_`|\n|[b550c50](http://git.sagemath.org/sage.git/commit/?id=b550c5013bef54098cc28c7a8ab34cf0f9fccdf9)|`Trac 12630: Fix coercion for path algebras`|",
...
```json
{
    "body": "<a id='comment:0'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[380ec00](http://git.sagemath.org/sage.git/commit/?id=380ec0083cf4cfecd5ccd1317103ffd714ae94c9)|`Trac 12630: Monomials of path algebras must belong to the underlying quiver`|",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[5d6f2fd](http://git.sagemath.org/sage.git/commit/?id=5d6f2fd466ba57c95965f8434cf1c18f6cd0c7f0)|`minor optimization, one() twice as fast`|\n|[d8071d2](http://git.sagemath.org/sage.git/commit/?id=d8071d2de99458efcb8c7168b7bf6e260103156b)|`minor edits to doc again`|",
    "created_at": "2014-02-19T07:23:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[b2248e0](http://git.sagemath.org/sage.git/commit/?id=b2248e0da6dcd8b6c07ff91db00491ce673576e8)|`fixes, mostly decorative`|",
    "created_at": "2014-02-20T04:27:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:0'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[8777776](http://git.sagemath.org/sage.git/commit/?id=877777682486865f1bb401a70fc66260ff6e4094)|`Trac #12630: make \"set_element\" a private method and implement hash`|",
    "created_at": "2014-02-20T13:25:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[c5dd56a](http://git.sagemath.org/sage.git/commit/?id=c5dd56af126669e380f5a9fbb1680447123d22cc)|`trying to be clearer about mutability in the doc`|",
    "created_at": "2014-02-20T14:18:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[48a8fed](http://git.sagemath.org/sage.git/commit/?id=48a8fed2d0503ea4bf4312c9a942c1fd024b0917)|`Trac 12630: Remove mutating _iadd_ from QuiverRepElement`|",
    "created_at": "2014-02-21T20:35:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|\n|[81b351c](http://git.sagemath.org/sage.git/commit/?id=81b351c6567e5e8ed0cb4edbb3351c272081da7d)|`Merge branch 'public/combinat/quivers' of trac.sagemath.org:sage into public/combinat/quivers`|\n|[16fa7c8](http://git.sagemath.org/sage.git/commit/?id=16fa7c8ed1bc9bdb18f6cc04ec5ee31b5b243577)|`Added files to documentation.`|\n|[9658528](http://git.sagemath.org/sage.git/commit/?id=965852853f6cebc08605c4457e5a8f8877d3229b)|`Formatting and documentation tweaks, first pass.`|\n|[a36d50b](http://git.sagemath.org/sage.git/commit/?id=a36d50b4b8896d564d8eb23ab57a98a9fa757e31)|`Added title to morphisms and added tracking on conf.py for docbuild.`|\n|[7330878](http://git.sagemath.org/sage.git/commit/?id=7330878cf490dfc5347b87e151678e93f5acab6e)|`Minor tweaks. Moved data from __init__.py to representation.py.`|\n|[14b73ae](http://git.sagemath.org/sage.git/commit/?id=14b73ae56423b56fb88f18b2e2e83870b41f10e1)|`Some more doc tweaks.`|\n|[5338d69](http://git.sagemath.org/sage.git/commit/?id=5338d6905e1be2a0bcea3ee4ee947a076ed31e96)|`Fixed multichar edge labels in all_paths.`|\n|[2b26654](http://git.sagemath.org/sage.git/commit/?id=2b2665408af342b5f0f1b313690acfef6db12149)|`Added an __iter__() for algebra over nonzero graded components.`|\n|[b628ce3](http://git.sagemath.org/sage.git/commit/?id=b628ce36bc8f5f67a8eae6db125064a85cd85229)|`Added simple, injective, and projective for S, I, P resp.`|",
    "created_at": "2014-05-04T23:49:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|\n|[f3402ef](http://git.sagemath.org/sage.git/commit/?id=f3402ef849622e1f5a7d88205c2911ecd6d03ffa)|`Make documentation of quivers/representation.py build`|",
    "created_at": "2014-05-05T09:48:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12630",
    "type": "issue_comment",
