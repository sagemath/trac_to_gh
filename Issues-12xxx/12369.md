...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154315"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154316"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154317"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154318"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154319"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n The aim is to add a gcc package to Sage.  We probably don't want to always build it, we would install it by default only on systems where this is needed.  This would replace the fortran package.\n \n **spkg**: [http://boxen.math.washington.edu/home/jdemeyer/spkg/gcc-4.4.6.spkg](http://boxen.math.washington.edu/home/jdemeyer/spkg/gcc-4.4.6.spkg)\n+\n+**Apply** [attachment: 12369_gcc_root.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_gcc_root.patch.gz) to the `SAGE_ROOT` repository.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154327"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154328"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154330"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154331"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,7 +3,7 @@\n **spkg**: [http://boxen.math.washington.edu/home/jdemeyer/spkg/gcc-4.6.3.spkg](http://boxen.math.washington.edu/home/jdemeyer/spkg/gcc-4.6.3.spkg)\n \n **Apply**:\n-1. [attachment: 12369_gcc_root.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_gcc_root.patch.gz) to the `SAGE_ROOT` repository.\n+1. [and [12369_no_sage_fortran.patch](https://github.com/sagemath/sage/files/ticket12369/edaaed78bb63e4f85dbcba0eccc0327e.gz) to the `SAGE_ROOT` repository.\n 2. [attachment: 12369_scripts_hgignore.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_scripts_hgignore.patch.gz) to the `SCRIPTS` repository.\n 3. [attachment: 12369_doc.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_doc.patch.gz) to the Sage library.\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154332"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154333"
}
```
...
```json
{
    "body": "<a id='comment:9'>Comment 9:</a>\nFurther testing revealed that `SAGE_FORTRAN` and `SAGE_FORTRAN_LIB` break stuff.  [attachment: 12369_no_sage_fortran.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_no_sage_fortran.patch.gz) ensures that `SAGE_FORTRAN` and `SAGE_FORTRAN_LIB` are ignored when building GCC.\n\nNeeds review.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154334"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154335"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -3,7 +3,7 @@\n **spkg**: [http://boxen.math.washington.edu/home/jdemeyer/spkg/gcc-4.6.3.spkg](http://boxen.math.washington.edu/home/jdemeyer/spkg/gcc-4.6.3.spkg)\n \n **Apply**:\n-1. [and [12369_no_sage_fortran.patch](https://github.com/sagemath/sage/files/ticket12369/edaaed78bb63e4f85dbcba0eccc0327e.gz) to the `SAGE_ROOT` repository.\n+1. [and [attachment: 12369_no_sage_fortran.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_no_sage_fortran.patch.gz)(https://github.com/sagemath/sage/files/ticket12369/edaaed78bb63e4f85dbcba0eccc0327e.gz) to the `SAGE_ROOT` repository.\n 2. [attachment: 12369_scripts_hgignore.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_scripts_hgignore.patch.gz) to the `SCRIPTS` repository.\n 3. [attachment: 12369_doc.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_doc.patch.gz) to the Sage library.\n \n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154336"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154337"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137205",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137206",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137207",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137208",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137209",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137210",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137211",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137212",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137213",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137214",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137215",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137216",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137217",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137218",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137219",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137220",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137221",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137222",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137223",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137224",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137225",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154338"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154339"
}
```
...
```json
{
    "body": "<a id='comment:6'>Comment 6:</a>\nAttachment: **[12369_gcc_root_part2.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_gcc_root_part2.patch.gz)**\n\nTested upgrading from sage-4.5, sage-4.7 and sage-4.8.  Everything fine, `hg status` is clean in the root repositories.\n\nAs far as I can tell, there should be no further obstructions to releasing this.  So please review the last patch: [attachment: 12369_gcc_root_part2.patch.gz](https://github.com/sagemath/sage/files/ticket12369/12369_gcc_root_part2.patch.gz).",
    "created_at": "2012-04-07T10:58:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137227",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137228",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137229",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154342"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12369#event-154343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137230",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137231",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137232",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137233",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137234",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12369",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12369#issuecomment-137235",
    "user": "https://github.com/jdemeyer"
}
```
