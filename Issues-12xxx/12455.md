...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143944"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143948"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143949"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143956"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143957"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143958"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143959"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143960"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -35,3 +35,7 @@\n ```\n \n We should make it symbolical for both airy_ai and airy_bi, as well as their derivatives.\n+\n+---\n+\n+Apply [and [attachment:trac_12455_newstyle_airy2.patch](https://github.com/sagemath/sage/files/ticket12455/9b15b108890032aeb2a28ff35d5cc34c.patch](https://github.com/sagemath/sage/files/ticket12455/cefc77654341bb1ad6ac5324d411d185.patch)).\n``````\n",
    "created_at": "2013-06-19T01:48:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12455",
    "type": "issue_comment",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -38,4 +38,4 @@\n \n ---\n \n-Apply [and [attachment:trac_12455_newstyle_airy2.patch](https://github.com/sagemath/sage/files/ticket12455/9b15b108890032aeb2a28ff35d5cc34c.patch](https://github.com/sagemath/sage/files/ticket12455/cefc77654341bb1ad6ac5324d411d185.patch)).\n+Apply [and [attachment:trac_12455_newstyle_airy2.patch](https://github.com/sagemath/sage/files/ticket12455/097827c4e33fb71e5cad9408b5bc645f.patch](https://github.com/sagemath/sage/files/ticket12455/6c8c151c2c3970d0a0e3f7d36beb6dde.patch)).\n``````\n",
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -38,4 +38,4 @@\n \n ---\n \n-Apply [and [attachment:trac_12455_newstyle_airy2.patch](https://github.com/sagemath/sage/files/ticket12455/097827c4e33fb71e5cad9408b5bc645f.patch](https://github.com/sagemath/sage/files/ticket12455/6c8c151c2c3970d0a0e3f7d36beb6dde.patch)).\n+Apply [and [attachment:trac_12455-newstyle-airy2-rebase.patch](https://github.com/sagemath/sage/files/ticket12455/097827c4e33fb71e5cad9408b5bc645f.patch](https://github.com/sagemath/sage/files/ticket12455/8592549cb572383ee389f28615fcd6b6.patch)).\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143961"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143962"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -38,4 +38,8 @@\n \n ---\n \n-Apply [and [attachment:trac_12455-newstyle-airy2-rebase.patch](https://github.com/sagemath/sage/files/ticket12455/097827c4e33fb71e5cad9408b5bc645f.patch](https://github.com/sagemath/sage/files/ticket12455/8592549cb572383ee389f28615fcd6b6.patch)).\n+Apply \n+\n+* [attachment:trac_12455-newstyle-airy-rebase.patch](https://github.com/sagemath/sage/files/ticket12455/trac_12455-newstyle-airy-rebase.patch)\n+* [attachment:trac_12455-newstyle-airy2-rebase.patch](https://github.com/sagemath/sage/files/ticket12455/trac_12455-newstyle-airy2-rebase.patch)\n+* [attachment: trac_12455-airy_review.patch]\n``````\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143963"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143964"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143965"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143966"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143967"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143970"
}
```
...
```json
{
    "body": "**Changing work issues** from \"circular import, doctest failures\" to \"\".",
    "created_at": "2014-07-24T15:15:05Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12455",
    "type": "issue_comment",
...
**Changing work issues** from "circular import, doctest failures" to "".
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143976"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143979"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143982"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143983"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143984"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143985"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143986"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143987"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143988"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143989"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143991"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12455",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-143992"
}
```
