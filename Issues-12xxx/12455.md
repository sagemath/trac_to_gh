...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-155873"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-155874"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12455#event-155875"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -35,3 +35,7 @@\n ```\n \n We should make it symbolical for both airy_ai and airy_bi, as well as their derivatives.\n+\n+---\n+\n+Apply [and [attachment: trac_12455_newstyle_airy2.patch.gz](https://github.com/sagemath/sage/files/ticket12455/trac_12455_newstyle_airy2.patch.gz)(https://github.com/sagemath/sage/files/ticket12455/598b37e2e921e0a29d225bc7ed8859a7.gz).\n``````\n",
    "created_at": "2013-06-19T01:48:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12455",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -38,4 +38,4 @@\n \n ---\n \n-Apply [and [attachment: trac_12455_newstyle_airy2.patch.gz](https://github.com/sagemath/sage/files/ticket12455/trac_12455_newstyle_airy2.patch.gz)(https://github.com/sagemath/sage/files/ticket12455/598b37e2e921e0a29d225bc7ed8859a7.gz).\n+Apply [and [attachment: trac_12455_newstyle_airy2.patch.gz](https://github.com/sagemath/sage/files/ticket12455/trac_12455_newstyle_airy2.patch.gz)(https://github.com/sagemath/sage/files/ticket12455/3054a2040bb12e06cda4c3b067fca415.gz).\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -38,4 +38,4 @@\n \n ---\n \n-Apply [and [attachment: trac_12455_newstyle_airy2.patch.gz](https://github.com/sagemath/sage/files/ticket12455/trac_12455_newstyle_airy2.patch.gz)(https://github.com/sagemath/sage/files/ticket12455/3054a2040bb12e06cda4c3b067fca415.gz).\n+Apply [and [attachment: trac_12455-newstyle-airy2-rebase.patch.gz](https://github.com/sagemath/sage/files/ticket12455/trac_12455-newstyle-airy2-rebase.patch.gz)(https://github.com/sagemath/sage/files/ticket12455/3054a2040bb12e06cda4c3b067fca415.gz).\n``````\n",
...
```json
{
    "body": "Changed assignee from **olazo** to **@rwst**",
...
Changed assignee from **olazo** to **@rwst**
...
```json
{
    "body": "Changed assignee from **@rwst** to **olazo**",
...
Changed assignee from **@rwst** to **olazo**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12455#issuecomment-139855",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12455#issuecomment-139856",
    "user": "https://github.com/kcrisman"
}
```
