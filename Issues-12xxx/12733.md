...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184622",
...
```json
{
    "body": "<a id='comment:1'></a>Patch submitted. I also added an example to be sure, and corrected a little mistake in a test in sage/misc/functional.py",
    "created_at": "2012-06-12T19:58:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184623",
    "user": "https://github.com/abrochard"
}
```

<a id='comment:1'></a>Patch submitted. I also added an example to be sure, and corrected a little mistake in a test in sage/misc/functional.py
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184624",
...
```json
{
    "body": "<a id='comment:4'></a>This ticket (and the added tests in particular) does not make much sense, unless there exists a symbolic max function. In my opinion, it would be better to return a NotImplementedError than to return nonsense results.",
    "created_at": "2012-07-10T16:00:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184625",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>This ticket (and the added tests in particular) does not make much sense, unless there exists a symbolic max function. In my opinion, it would be better to return a NotImplementedError than to return nonsense results.
...
```json
{
    "body": "<a id='comment:5'></a>Use max_symbolic then: \n\n```\nsage: max_symbolic(a,b)\nmax(a, b)\n```",
    "created_at": "2012-07-10T16:45:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184626",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>Use max_symbolic then: 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184627",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"incorrect tests\"",
    "created_at": "2012-07-10T19:15:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184628",
    "user": "https://github.com/fchapoton"
}
```

Changing work_issues from "" to "incorrect tests"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12733#issuecomment-184629",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12733#event-34604"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12733#event-34605"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12733#event-34606"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12733#event-34607"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12733#event-34608"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12733#event-34609"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12733#event-34610"
}
```
