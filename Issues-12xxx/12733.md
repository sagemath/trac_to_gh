...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12733#issuecomment-144908",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12733#issuecomment-144909",
    "user": "https://github.com/abrochard"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12733#event-160510"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12733#event-160511"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12733#event-160512"
}
```
