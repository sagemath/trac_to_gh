...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12235#issuecomment-134679",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12235#issuecomment-134680",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12235#event-152241"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12235#event-152242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12235",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12235#event-152243"
}
```
