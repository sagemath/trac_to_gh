...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158676"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158678"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158680"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -12,7 +12,7 @@\n \n The coercion path does exist, however!\n \n-This can also be checked with the new syntax using the patches in [https://github.com/sagemath/sage/issues/5457](https://github.com/sagemath/sage/issues/5457) as follows:\n+This can also be checked with the new syntax using the patches in #5457 as follows:\n \n ```\n     sage: R = QQ['q,t'].fraction_field()\n@@ -57,3 +57,8 @@\n     G = coercion_graph(Ht)\n     G.show()\n ```\n+\n+__Apply__\n+\n+* [attachment: trac12969_fix_coercion_cache.patch.gz](https://github.com/sagemath/sage/files/ticket12969/trac12969_fix_coercion_cache.patch.gz), if #5457 is not applied\n+* Both patches, if #5457 is applied\n``````\n",
    "created_at": "2012-07-23T11:42:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12969",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158683"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12969",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12969#event-158686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12969#issuecomment-149589",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12969#issuecomment-149590",
