...
```json
{
    "body": "<a id='comment:2'></a>Just for the record: My impression was that solving this ticket could also help with a couple of coercion-related memory leaks considered in #715, #12215, #12313 and so on.",
    "created_at": "2012-07-20T06:17:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190414",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>Just for the record: My impression was that solving this ticket could also help with a couple of coercion-related memory leaks considered in #715, #12215, #12313 and so on.
...
```json
{
    "body": "<a id='comment:3'></a>I can confirm that the problem occurs with vanilla sage-5.2.rc0, namely resulting in this error:\n\n```\nTypeError: do not know how to make x (= McdP[]) an element of self (=Macdonald polynomials in the Ht basis over Fraction Field of Multivariate Polynomial Ring in q, t over Rational Field)\n```",
    "created_at": "2012-07-20T20:15:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190415",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>I can confirm that the problem occurs with vanilla sage-5.2.rc0, namely resulting in this error:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190418",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Looking at sage/combinat/sf/macdonald.py, there is a cache from different realisations (bases) to Schur basis. There are two exceptions: The P-basis and the Q-basis. Why? Perhaps that is the culprit?",
    "created_at": "2012-07-21T11:18:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190420",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:8'></a>Looking at sage/combinat/sf/macdonald.py, there is a cache from different realisations (bases) to Schur basis. There are two exceptions: The P-basis and the Q-basis. Why? Perhaps that is the culprit?
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -12,7 +12,7 @@\n \n The coercion path does exist, however!\n \n-This can also be checked with the new syntax using the patches in the sage-combinat queue as follows:\n+This can also be checked with the new syntax using the patches in [http://trac.sagemath.org/sage_trac/ticket/5457](http://trac.sagemath.org/sage_trac/ticket/5457) as follows:\n \n ```\n     sage: R = QQ['q,t'].fraction_field()\n``````\n",
    "created_at": "2012-07-21T15:48:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190424",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190426",
...
```json
{
    "body": "<a id='comment:17'></a>> Question: Why is that method not overridden for the different realisations of `MacdonaldPolynomials`?\n\n\nBecause the coercions are registered explicitly during the initialization of Sym / macdonald polynomials. This is better because it leaves maximal freedom to the coercion model (e.g. the coercion model can't do transitivity with _coerce_map_from).\n\nCheers,\n                          Nicolas",
    "created_at": "2012-07-22T08:04:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190428",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:17'></a>> Question: Why is that method not overridden for the different realisations of `MacdonaldPolynomials`?
...
```json
{
    "body": "<a id='comment:19'></a>And while we are at it: _register_pair uses a dictionary in order to implement a set. I think it would be more efficient to use a set right away.",
    "created_at": "2012-07-22T08:25:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190430",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:19'></a>And while we are at it: _register_pair uses a dictionary in order to implement a set. I think it would be more efficient to use a set right away.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190431",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190433",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Question: Is #5457 very close to being positively reviewed? Namely, we must decide whether we use the old syntax for the to-be-written doctest (in that case, this ticket would be a dependency for #5457), or use the new syntax (in that case, due to deprecation warnings, #5457 would become a dependency for this ticket).\n\nFor now, I will use the old syntax.",
    "created_at": "2012-07-22T09:06:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190434",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:23'></a>Question: Is #5457 very close to being positively reviewed? Namely, we must decide whether we use the old syntax for the to-be-written doctest (in that case, this ticket would be a dependency for #5457), or use the new syntax (in that case, due to deprecation warnings, #5457 would become a dependency for this ticket).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190436",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190437",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>For the record: With my patch, all tests pass on bsd.math. However, with the patch, it takes 6403.9 seconds, but it is 6106.7 seconds without the patch. Hence, it could be that we have a serious regression, but of course it could also be due to the machine being busy. Should be investigated.",
    "created_at": "2012-07-22T12:02:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190438",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:25'></a>For the record: With my patch, all tests pass on bsd.math. However, with the patch, it takes 6403.9 seconds, but it is 6106.7 seconds without the patch. Hence, it could be that we have a serious regression, but of course it could also be due to the machine being busy. Should be investigated.
...
```json
{
    "body": "<a id='comment:26'></a>Another data point: On my laptop, the tests for sage/schemes/elliptic_curves took 431.4 seconds without the patch, but 441.4 seconds with the patch. That means a regression of 2.3%, which probably isn't significant. But I'd feel better if the reviewer did some timings as well.",
    "created_at": "2012-07-22T12:52:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190439",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:26'></a>Another data point: On my laptop, the tests for sage/schemes/elliptic_curves took 431.4 seconds without the patch, but 441.4 seconds with the patch. That means a regression of 2.3%, which probably isn't significant. But I'd feel better if the reviewer did some timings as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190442",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>I have slightly updated the patch. Only difference: A dictionary, that previously was declared as \"cdef object\", is now \"cdef dict\".\n\nI repeated timings for `sage -t devel/sage/sage/schemes/elliptic_curves/`. I did three runs, the time is in seconds:\n\n__Vanilla sage-5.2.rc0__\n\n442.5, 441.9, 442.3\n\n__sage-5.2.rc0 plus the patch__\n\n443.3, 440.8, 442.1\n\nSo, apparently the 2.3% regression that I found earlier has been random noise.",
    "created_at": "2012-07-23T11:33:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190443",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:29'></a>I have slightly updated the patch. Only difference: A dictionary, that previously was declared as "cdef object", is now "cdef dict".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190444",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>I have attached a second patch. It is *only* needed if #5457 is applied.\n\nSince there seems to be no regression, I think it can now be reviewed.\n\nFor the release manager: Use the second patch on top of that, as soon as #5457 is merged.\n\nFor the patchbot:\n\nApply trac12969_fix_coercion_cache.patch",
    "created_at": "2012-07-23T11:42:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190445",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:30'></a>I have attached a second patch. It is *only* needed if #5457 is applied.
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -12,7 +12,7 @@\n \n The coercion path does exist, however!\n \n-This can also be checked with the new syntax using the patches in [http://trac.sagemath.org/sage_trac/ticket/5457](http://trac.sagemath.org/sage_trac/ticket/5457) as follows:\n+This can also be checked with the new syntax using the patches in #5457 as follows:\n \n ```\n     sage: R = QQ['q,t'].fraction_field()\n@@ -57,3 +57,8 @@\n     G = coercion_graph(Ht)\n     G.show()\n ```\n+\n+__Apply__\n+\n+* [attachment:trac12969_fix_coercion_cache.patch], if #5457 is not applied\n+* Both patches, if #5457 is applied\n``````\n",
    "created_at": "2012-07-23T11:42:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190446",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>I found that a coercion from None is sought when asking the following:\n\n```\nsage: P = QQ['x','y','a']\nsage: P.has_coerce_map_from(str)\n```\n\nI suggest to fix that *here*, unless it is too complicated.",
    "created_at": "2012-07-24T07:42:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190448",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:32'></a>I found that a coercion from None is sought when asking the following:
...
```json
{
    "body": "<a id='comment:33'></a>Got it. In sage/structure/parent_old.pyx, which unfortunately is still involved in `MPolynomialRing_libsingular`, there is line 152:\n\n```\n            sage_type = py_scalar_parent(S)\n```\nHowever, is S is `<type 'str'>` then its py_scalar_parent is None (which seems wrong, or if it isn't wrong then one should at least catch the special case None). The function py_scalar_parent is in sage/structure/coerce.pyx.",
    "created_at": "2012-07-24T07:51:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190449",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:33'></a>Got it. In sage/structure/parent_old.pyx, which unfortunately is still involved in `MPolynomialRing_libsingular`, there is line 152:
...
```json
{
    "body": "<a id='comment:35'></a>I haven't checked the detail, but the music sounds good. In any cases, we are just looking for a temporary fix that improves the situation until we rewrite completely the search algorithm; if it's not perfect, so be it. So I would say: if all tests pass, go for it.\n\nThanks!",
    "created_at": "2012-07-24T08:48:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190451",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:35'></a>I haven't checked the detail, but the music sounds good. In any cases, we are just looking for a temporary fix that improves the situation until we rewrite completely the search algorithm; if it's not perfect, so be it. So I would say: if all tests pass, go for it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190452",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190453",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190454",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Thanks, Simon, for fixing this bug! Your solution looks ok to me, though I strongly recommend that someone reprograms the coercion algorithm in the future.\n\nI ran all tests on top of 5457 and all tests passed! So I am giving this a positive review. Hopefully it can be merged together with 5457 (but if 5457 gets held up, this can go in nonetheless).\n\nAnne",
    "created_at": "2012-07-25T02:15:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190457",
    "user": "https://github.com/anneschilling"
}
```

<a id='comment:38'></a>Thanks, Simon, for fixing this bug! Your solution looks ok to me, though I strongly recommend that someone reprograms the coercion algorithm in the future.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190458",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190459",
    "user": "https://github.com/anneschilling"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12969#event-35510"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190460",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190461",
    "user": "https://github.com/jdemeyer"
}
```
...
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -30,14 +30,14 @@\n \n ```\n     def coercion_graph(self, G = None):\n-\tif G is None:\n-\t    G = DiGraph()\n-\tif self not in G.vertices():\n-\t    G.add_vertex(self)\n-\t    for h in self._introspect_coerce()['_coerce_from_list']:\n-\t\tcoercion_graph(h.domain(), G)\n-\t\tG.add_edge(h.domain(), self)\n-\treturn G\n+        if G is None:\n+            G = DiGraph()\n+        if self not in G.vertices():\n+            G.add_vertex(self)\n+            for h in self._introspect_coerce()['_coerce_from_list']:\n+                coercion_graph(h.domain(), G)\n+                G.add_edge(h.domain(), self)\n+        return G\n \n     R = QQ['q,t'].fraction_field()\n     R.rename(\"R\")\n``````\n",
    "created_at": "2015-09-06T17:42:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12969#issuecomment-190462",
