...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140079",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140080",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140081",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140082",
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [12481.patch](https://github.com/sagemath/sage/files/ticket12481/12481.patch) by @jdemeyer created at 2012-02-09 14:32:32\n\nReplying to [aapitzsch](#comment%3A4):\n> Could you use\n> \n> ```\n> raise RuntimeError(\"Unable to determine branch\")\n> ```\n> to have less work in the future (when we are moving to Python 3).\n\n\nDone.",
    "created_at": "2012-02-09T14:32:32Z",
    "issue": "https://github.com/sagemath/sage/issues/12481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140083",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140084",
    "user": "https://github.com/a-andre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140085",
    "user": "https://github.com/a-andre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12481#issuecomment-140086",
    "user": "https://github.com/jdemeyer"
}
```
