...
```json
{
    "body": "<a id='comment:1'></a>What cache? There are no cached methods in `ClonableIntArray`, so the behavior within that class appears correct at first glance.\n\nIsn't the problem really that you're saying `sum()` is cacheable, when in reality it isn't? At least under the inherited implementation of `setitem()`.\n\nSince `Foo` is the class with the cached method, `Foo` should invalidate the cache on `setitem()`.",
    "created_at": "2012-05-12T18:31:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12941#issuecomment-189646",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:1'></a>What cache? There are no cached methods in `ClonableIntArray`, so the behavior within that class appears correct at first glance.
...
```json
{
    "body": "<a id='comment:6'></a>Oh, and even if we did clear the cache on `copy()`, there would still be a bug in `Foo`:\n\n```\nsage: with f.clone() as f1:\n...     f1[1] = 4\nsage: f1\n[1, 4, 3]\nsage: f1.sum()\n8\nsage: f1[1] = 100000\nsage: f1.sum()\n8\n```",
    "created_at": "2012-05-12T19:53:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12941#issuecomment-189649",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:6'></a>Oh, and even if we did clear the cache on `copy()`, there would still be a bug in `Foo`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12941#issuecomment-189657",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12941#event-35384"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12941#event-35385"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12941#event-35386"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12941#event-35387"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12941#event-35388"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12941#event-35389"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12941#event-35390"
}
```
