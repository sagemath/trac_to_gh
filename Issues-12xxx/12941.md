...
```json
{
    "body": "Oh, and even if we did clear the cache on `copy()`, there would still be a bug in `Foo`:\n\n```\nsage: with f.clone() as f1:\n...     f1[1] = 4\nsage: f1\n[1, 4, 3]\nsage: f1.sum()\n8\nsage: f1[1] = 100000\nsage: f1.sum()\n8\n```",
