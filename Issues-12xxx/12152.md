...
```json
{
    "body": "<a id='comment:1'></a>See the thread above for some additional discussion, in particular about whether to not consider this a bug, and whether one should just disallow integrals with decimal points.",
    "created_at": "2011-12-14T02:39:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12152#issuecomment-169432",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>See the thread above for some additional discussion, in particular about whether to not consider this a bug, and whether one should just disallow integrals with decimal points.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12152#issuecomment-169434",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12152#event-32302"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12152#event-32303"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12152#event-32304"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12152#event-32305"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12152#event-32306"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12152#event-32307"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12152#event-32308"
}
```
