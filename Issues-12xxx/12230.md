...
archive/attachments_016985.json:
```json
{
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac_12230-ss.patch](https://github.com/sagemath/sage/files/ticket12230/trac_12230-ss.patch)",
    "created_at": "2012-02-09T18:06:22Z",
    "issue": "https://github.com/sagemath/sage/issues/12230",
    "type": "issue_comment",
...
archive/attachments_016986.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:7'></a>\n**Attachment:** [trac_12230-ss-ascii.patch](https://github.com/sagemath/sage/files/ticket12230/trac_12230-ss-ascii.patch)\n\nApply trac_12230-ss-ascii.patch\n\n(for the patchbot)",
    "created_at": "2012-03-11T11:14:38Z",
    "issue": "https://github.com/sagemath/sage/issues/12230",
    "type": "issue_comment",
...
archive/attachments_016987.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_016988.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_016989.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12230-growing_letters-rebase.patch](https://github.com/sagemath/sage/files/ticket12230/trac_12230-growing_letters-rebase.patch)",
    "created_at": "2013-04-08T13:21:43Z",
    "issue": "https://github.com/sagemath/sage/issues/12230",
    "type": "issue_comment",
