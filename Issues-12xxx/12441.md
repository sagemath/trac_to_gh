...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177602",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177603",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177604",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Ooops, didn't see this ticket (as it was not listed on #2999 / #3000).\n\nSince #12680 has meanwhile been merged into Sage 5.0.beta9, we should close this.  Sorry.",
    "created_at": "2012-03-22T12:08:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177605",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:2'></a>Ooops, didn't see this ticket (as it was not listed on #2999 / #3000).
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12441#event-33474"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Positive review w.r.t. that this is now fixed by #12680, so **this ticket can be closed**.",
    "created_at": "2012-04-08T01:29:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177606",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>Positive review w.r.t. that this is now fixed by #12680, so **this ticket can be closed**.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177607",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177608",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177609",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12441#issuecomment-177610",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12441",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12441#event-33475"
}
```
