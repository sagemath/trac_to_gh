...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12948#event-164007"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12948#event-164008"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12948#event-164009"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12948#issuecomment-149043",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12948#issuecomment-149044",
    "user": "https://github.com/kcrisman"
}
```
