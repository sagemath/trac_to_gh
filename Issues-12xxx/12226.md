...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152057"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152058"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152060"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12226#issuecomment-134540",
    "user": "https://github.com/staroste"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12226#issuecomment-134541",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12226#issuecomment-134542",
    "user": "https://github.com/staroste"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12226#issuecomment-134543",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12226#issuecomment-134544",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152062"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152063"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152064"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152065"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152066"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152067"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152068"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152069"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12226#event-152070"
}
```
