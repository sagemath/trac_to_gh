...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12226#issuecomment-171852",
    "user": "https://github.com/staroste"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Should not period be an integer?\n\n... I already had the idea of making `period` an alias of `minimal_period`:\n\n```\nsage: Word('1231').minimal_period()\n3\n```\n\nWhat do you think?",
    "created_at": "2012-01-09T16:41:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12226#issuecomment-171853",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:2'></a>Should not period be an integer?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12226#issuecomment-171854",
    "user": "https://github.com/staroste"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>> I think an alias is not necessary. There is no other period, and anyone looking for that notion will use \"period\" anyway.\n\n\nIf 3 is a period, than 6, 9, 12 are period as well. But I agree that 3 is *the* period. \n\nI would rather suggest the following :\n\n```\nsage: Word('1231').period_word()\nword: 123\nsage: Word('1231').period()\n3\n```",
    "created_at": "2012-01-10T19:42:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12226#issuecomment-171855",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>> I think an alias is not necessary. There is no other period, and anyone looking for that notion will use "period" anyway.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12226#issuecomment-171856",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12226#event-32586"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12226#event-32587"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12226#event-32588"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12226#event-32589"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12226#event-32590"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12226#event-32591"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12226#event-32592"
}
```
