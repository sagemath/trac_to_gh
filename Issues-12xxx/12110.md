...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12110#event-150092"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12110#event-150093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12110#event-150094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12110#issuecomment-131666",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12110",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12110#issuecomment-131667",
    "user": "https://github.com/jdemeyer"
}
```
