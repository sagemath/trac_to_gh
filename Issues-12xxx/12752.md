...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175673"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175674"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175675"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175676"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175678"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175680"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175683"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12752#issuecomment-142978",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175684"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12752#issuecomment-142979",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-175689"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12752#issuecomment-142980",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12752#issuecomment-142981",
    "user": "https://github.com/jdemeyer"
}
```
