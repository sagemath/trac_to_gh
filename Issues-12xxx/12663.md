...
archive/attachments_017631.json:
```json
{
...
```json
{
    "body": "<a id='comment:7'></a>\n**Attachment:** [trac_12663-partitions_iter_fix-ts.patch](https://github.com/sagemath/sage/files/ticket12663/trac_12663-partitions_iter_fix-ts.patch)\n\nFixed.",
    "created_at": "2012-05-16T04:29:06Z",
    "issue": "https://github.com/sagemath/sage/issues/12663",
    "type": "issue_comment",
...
archive/attachments_017632.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [12663-partitions_iter_fix-ts-rebased.patch](https://github.com/sagemath/sage/files/ticket12663/12663-partitions_iter_fix-ts-rebased.patch)",
    "created_at": "2012-05-29T00:04:30Z",
    "issue": "https://github.com/sagemath/sage/issues/12663",
    "type": "issue_comment",
...
**Attachment:** [12663-partitions_iter_fix-ts-rebased.patch](https://github.com/sagemath/sage/files/ticket12663/12663-partitions_iter_fix-ts-rebased.patch)
