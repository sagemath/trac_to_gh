...
```json
{
    "body": "It seems that this problem shall be dealt with at #12802. Hence, I'll mark it as duplicate.",
...
```json
{
    "body": "Jeroen, why \"dependency\"? This here is really just a duplicate.",
