...
```json
{
    "body": "<a id='comment:1'></a>I believe it is easiest to check that this is correct through the test framework of the categories.\n\nI added a test to Rings and also one to Fields() checking that it's a prime or zero.",
    "created_at": "2012-05-21T16:56:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190827",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:1'></a>I believe it is easiest to check that this is correct through the test framework of the categories.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190828",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190829",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190830",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190832",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>That's strange. I'll run the doctests again to see if this also happens here.\n\nActually `_test_characteristic` didn't catch wrong `characteristic()` implementations in some cases which is related to #13043. I'll upload an updated patch soon.",
    "created_at": "2012-05-28T02:21:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190833",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:4'></a>That's strange. I'll run the doctests again to see if this also happens here.
...
```json
{
    "body": "Changing dependencies from \"\" to \"#13043\"",
    "created_at": "2012-05-28T02:21:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190834",
    "user": "https://github.com/saraedum"
}
```

Changing dependencies from "" to "#13043"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190835",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190836",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>This now passes doctests, and every example that I've tried successfully returns Integer characteristic. But I would like someone who understands the category framework and the test framework a bit better to look at this. Consider your patch to have a weak positive review.",
    "created_at": "2012-05-28T18:04:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190837",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:6'></a>This now passes doctests, and every example that I've tried successfully returns Integer characteristic. But I would like someone who understands the category framework and the test framework a bit better to look at this. Consider your patch to have a weak positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190838",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190839",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190840",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190841",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190843",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190844",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190845",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190846",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190847",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12988#issuecomment-190848",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12988",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12988#event-35576"
}
```
