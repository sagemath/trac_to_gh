# Issue 12321: tol and optional in doctests don't play well together
...
```json
{
    "body": "Okay, it's these lines.\n\n```\n        sage: error.numerical_approx() # abs tol 10e-10\n        0\n\n```\nSomehow we must be using this abs tol thing incorrectly.",
    "created_at": "2012-02-10T19:44:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144824",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "In case I can't track this down and someone from #10952 can help, here is the end of the comment modifiers.\n\n```\n' abs tol 10e-10', ' abs tol 10e-10', ' abs tol 10e-10', '']\n```",
    "created_at": "2012-02-10T19:48:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144825",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "I think it's something else in `integral.py` (or, more likely, a combination of things). If I move the `abs tol` test to another file, the tests all pass.",
    "created_at": "2012-02-10T19:59:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144826",
...
```json
{
    "body": "Replacing this comment with `# optional -- internet requires` causes no problems.  Same with `# not tested`.  But any other only optional (e.g., internet, maple) fails with the same problem. \n\nApparently the doctest framework has trouble with `tol` and `only-optional`.  I'm making a note of this ticket at #10952.",
    "created_at": "2012-02-10T20:01:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144827",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "LOL on the base 5 optional test!  Though I wouldn't say it's minimal, strictly speaking - you actually explained yourself.\n\nHopefully someone at #10952 will fix this; I'm not interested in breaking the doctest script by fixing this in some stupid fashion.",
    "created_at": "2012-02-10T20:09:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144829",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144830",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144831",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144833",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144835",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Thanks for explaining why this particular example was wrong. Could you explain what is wrong with the rest of my comment too?",
    "created_at": "2012-02-13T19:05:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144836",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    "body": "It looks like you're right, the new comment was being added too many times.  Here's a new patch; try this instead.",
    "created_at": "2012-02-13T21:57:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144837",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144838",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Yikes!  Thanks for working hard to get something that actually works for this.  Or you can just fix the `tol` keyword :)  I'll do my best to help review any changes if you do come up with a doctest patch.",
    "created_at": "2012-04-05T16:39:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144840",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144841",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144842",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12321#event-33654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12321#issuecomment-144843",
