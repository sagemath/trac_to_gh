...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,3 +1,8 @@\n 1. `list_plot3d` plots extra points at the horizontal x-y plane. This seems to stem from the default value of 0.0 that is assigned in the code. See [this post](https://groups.google.com/d/topic/sage-devel/RAdolRdjSTk/discussion).\n \n 2. This function also does not take in `color` or `rgbcolor` as keywords. Rest of the plot commands including `plot`, `list_plot`, `plot3d` do take in these keywords.\n+\n+Attached patch fixes both these problems.\n+\n+---\n+Apply [attachment:trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch](https://github.com/sagemath/sage/files/ticket12798/trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch) to `devel/sage`.\n``````\n",
    "created_at": "2012-04-03T06:07:50Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145793",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145794",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145795",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145796",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145797",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145798",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106486"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106487"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145799",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145800",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106488"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106489"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145801",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145802",
    "user": "https://github.com/ppurka"
}
```
...
archive/attachments_017226.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch",
    "asset_url": "tarball://root/attachments/ticket12798/trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch",
    "created_at": "2012-05-26T07:46:47Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12798/trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Attachment [trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch](https://github.com/sagemath/sage/files/ticket12798/trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch) by @ppurka created at 2012-05-26 07:46:47\n\nApply to `devel/sage`",
    "created_at": "2012-05-26T07:46:47Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145803",
    "user": "https://github.com/ppurka"
}
```

Attachment [trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch](https://github.com/sagemath/sage/files/ticket12798/trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch) by @ppurka created at 2012-05-26 07:46:47
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145804",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145805",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -2,7 +2,7 @@\n \n 2. This function also does not take in `color` or `rgbcolor` as keywords. Rest of the plot commands including `plot`, `list_plot`, `plot3d` do take in these keywords.\n \n-Attached patch fixes both these problems.\n+First attached patch fixes both these problems, second one fixes more doc and clarifies output.\n \n ---\n-Apply [attachment:trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch](https://github.com/sagemath/sage/files/ticket12798/trac_12798-fix_extraneous_points_and_kwds_in_list_plot3d.patch) to `devel/sage`.\n+Apply [and [attachment:trac_12798-more-doc.patch](https://github.com/sagemath/sage/files/ticket12798/aea4caa4b3ad059c3bfbd569f44420dd.patch](https://github.com/sagemath/sage/files/ticket12798/bf575d2aa2bec7d9943b2b33a41cff31.patch)) to `devel/sage`.\n``````\n",
    "created_at": "2012-05-26T22:43:28Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145806",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145807",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145808",
    "user": "https://github.com/kcrisman"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12798-more-doc.2.patch",
    "asset_url": "tarball://root/attachments/ticket12798/trac_12798-more-doc.2.patch",
    "created_at": "2012-05-27T05:58:32Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12798/trac_12798-more-doc.2.patch",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Attachment [trac_12798-more-doc.2.patch](https://github.com/sagemath/sage/files/ticket12798/trac_12798-more-doc.2.patch) by @ppurka created at 2012-05-27 05:58:32\n\nonly added #long time to last example",
    "created_at": "2012-05-27T05:58:32Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145809",
    "user": "https://github.com/ppurka"
}
```

Attachment [trac_12798-more-doc.2.patch](https://github.com/sagemath/sage/files/ticket12798/trac_12798-more-doc.2.patch) by @ppurka created at 2012-05-27 05:58:32
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n First attached patch fixes both these problems, second one fixes more doc and clarifies output.\n \n ---\n-Apply [and [attachment:trac_12798-more-doc.patch](https://github.com/sagemath/sage/files/ticket12798/aea4caa4b3ad059c3bfbd569f44420dd.patch](https://github.com/sagemath/sage/files/ticket12798/bf575d2aa2bec7d9943b2b33a41cff31.patch)) to `devel/sage`.\n+Apply [and [attachment:trac_12798-more-doc.2.patch](https://github.com/sagemath/sage/files/ticket12798/aea4caa4b3ad059c3bfbd569f44420dd.patch](https://github.com/sagemath/sage/files/ticket12798/ab2a94cd0456dc6cab71274d0c11476c.patch)) to `devel/sage`.\n``````\n",
    "created_at": "2012-05-27T06:00:14Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145810",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145811",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145812",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106490"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145813",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145814",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145815",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145816",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145817",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106494"
}
```
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145818",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145819",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145820",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145821",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145822",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145823",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145824",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145825",
    "user": "https://github.com/ppurka"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12798-more-doc.3.patch",
    "asset_url": "tarball://root/attachments/ticket12798/trac_12798-more-doc.3.patch",
    "created_at": "2012-06-26T12:20:08Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12798/trac_12798-more-doc.3.patch",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>\nAttachment [trac_12798-more-doc.3.patch](https://github.com/sagemath/sage/files/ticket12798/trac_12798-more-doc.3.patch) by @ppurka created at 2012-06-26 12:20:08",
    "created_at": "2012-06-26T12:20:08Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145826",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,4 +5,4 @@\n First attached patch fixes both these problems, second one fixes more doc and clarifies output.\n \n ---\n-Apply [and [attachment:trac_12798-more-doc.2.patch](https://github.com/sagemath/sage/files/ticket12798/aea4caa4b3ad059c3bfbd569f44420dd.patch](https://github.com/sagemath/sage/files/ticket12798/ab2a94cd0456dc6cab71274d0c11476c.patch)) to `devel/sage`.\n+Apply [and [attachment:trac_12798-more-doc.3.patch](https://github.com/sagemath/sage/files/ticket12798/aea4caa4b3ad059c3bfbd569f44420dd.patch](https://github.com/sagemath/sage/files/ticket12798/dae5e933953a0e3e99541674c021d1a4.patch)) to `devel/sage`.\n``````\n",
    "created_at": "2012-06-26T12:20:08Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145827",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145828",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145829",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145830",
    "user": "https://github.com/jdemeyer"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "12798_change.patch",
    "asset_url": "tarball://root/attachments/ticket12798/12798_change.patch",
    "created_at": "2012-06-26T12:49:11Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12798/12798_change.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Attachment [12798_change.patch](https://github.com/sagemath/sage/files/ticket12798/12798_change.patch) by @jdemeyer created at 2012-06-26 12:49:11",
    "created_at": "2012-06-26T12:49:11Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145831",
    "user": "https://github.com/jdemeyer"
}
```

Attachment [12798_change.patch](https://github.com/sagemath/sage/files/ticket12798/12798_change.patch) by @jdemeyer created at 2012-06-26 12:49:11
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "12798_doc.patch",
    "asset_url": "tarball://root/attachments/ticket12798/12798_doc.patch",
    "created_at": "2012-06-26T13:02:26Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12798/12798_doc.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>\nAttachment [12798_doc.patch](https://github.com/sagemath/sage/files/ticket12798/12798_doc.patch) by @jdemeyer created at 2012-06-26 13:02:26\n\nI can absolutely confirm that the slowdown on Solaris SPARC is caused by [attachment:12798_change.patch](https://github.com/sagemath/sage/files/ticket12798/12798_change.patch), not by the added doctests.",
    "created_at": "2012-06-26T13:02:26Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145832",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106497"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145834",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145835",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145836",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145837",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145838",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145839",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145840",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "**Changing assignee** from @jasongrout, @williamstein to @jdemeyer.",
    "created_at": "2012-06-26T14:47:47Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145841",
    "user": "https://github.com/jdemeyer"
}
```

**Changing assignee** from @jasongrout, @williamstein to @jdemeyer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145842",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145843",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145844",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145845",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145846",
    "user": "https://github.com/ppurka"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12798-dont_pass_nan_to_ParametricSurface.patch",
    "asset_url": "tarball://root/attachments/ticket12798/trac_12798-dont_pass_nan_to_ParametricSurface.patch",
    "created_at": "2012-06-26T17:39:33Z",
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12798/trac_12798-dont_pass_nan_to_ParametricSurface.patch",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145848",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145849",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145850",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145851",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145852",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145853",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145854",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145855",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145856",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145857",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145858",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145859",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145860",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145861",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12798#issuecomment-145862",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106499"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106500"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106501"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106502"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106503"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106504"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106505"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12798#event-106506"
}
```
