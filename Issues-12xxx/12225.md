...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12225#issuecomment-171845",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12225#issuecomment-171846",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12225#issuecomment-171847",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>> Related to this, I want to add that I want to remove the class and the file `nfactor_enumerable_word` from Sage. \n\n\nThis is now : #12380",
    "created_at": "2012-01-29T04:12:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12225#issuecomment-171851",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:5'></a>> Related to this, I want to add that I want to remove the class and the file `nfactor_enumerable_word` from Sage. 
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12225#event-32579"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12225#event-32580"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12225#event-32581"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12225#event-32582"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12225#event-32583"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12225#event-32584"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12225#event-32585"
}
```
