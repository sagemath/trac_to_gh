...
```json
{
    "body": "**Changing work issues** from \"segfaults for elliptic curves\" to \"fix it...\".",
...
**Changing work issues** from "segfaults for elliptic curves" to "fix it...".
...
```json
{
    "body": "**Changing work issues** from \"fix it...\" to \"\".",
    "created_at": "2012-01-12T15:14:30Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "fix it..." to "".
...
```json
{
    "body": "**Changing work issues** from \"Fix two tests\" to \"Fix a coercion problem in sage.combinat.sf.sf\".",
...
**Changing work issues** from "Fix two tests" to "Fix a coercion problem in sage.combinat.sf.sf".
...
```json
{
    "body": "**Changing work issues** from \"Fix a coercion problem in sage.combinat.sf.sf\" to \"\".",
    "created_at": "2012-03-09T15:30:18Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "Fix a coercion problem in sage.combinat.sf.sf" to "".
...
```json
{
    "body": "**Changing work issues** from \"coercion in symmetric function algebras\" to \"Rebase wrt #11599. Coercion in symmetric function algebras\".",
    "created_at": "2012-04-15T15:25:50Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "coercion in symmetric function algebras" to "Rebase wrt #11599. Coercion in symmetric function algebras".
...
```json
{
    "body": "**Changing work issues** from \"Rebase wrt #11599. Coercion in symmetric function algebras\" to \"Coercion in symmetric function algebras\".",
    "created_at": "2012-04-15T21:42:55Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "Rebase wrt #11599. Coercion in symmetric function algebras" to "Coercion in symmetric function algebras".
...
```json
{
    "body": "**Changing work issues** from \"Coercion in symmetric function algebras\" to \"Keep the fix from #12313. Coercion in symmetric function algebras\".",
    "created_at": "2012-04-17T10:02:01Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "Coercion in symmetric function algebras" to "Keep the fix from #12313. Coercion in symmetric function algebras".
...
```json
{
    "body": "**Changing work issues** from \"Keep the fix from #12313. Coercion in symmetric function algebras\" to \"\".",
    "created_at": "2012-04-17T15:52:55Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "Keep the fix from #12313. Coercion in symmetric function algebras" to "".
...
```json
{
    "body": "**Changing work issues** from \"rebase wrt #12808\" to \"\".",
...
**Changing work issues** from "rebase wrt #12808" to "".
...
```json
{
    "body": "**Changing work issues** from \"Rebase wrt #7980\" to \"\".",
...
**Changing work issues** from "Rebase wrt #7980" to "".
...
```json
{
    "body": "**Changing work issues** from \"Rebase rel sage-5.3.beta2\" to \"\".",
    "created_at": "2012-08-15T15:32:14Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "Rebase rel sage-5.3.beta2" to "".
...
```json
{
    "body": "**Changing work issues** from \"Do not INCREF when deallocating\" to \"\".",
...
**Changing work issues** from "Do not INCREF when deallocating" to "".
...
```json
{
    "body": "**Changing work issues** from \"Fix one doc test\" to \"\".",
    "created_at": "2012-08-17T17:54:22Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "Fix one doc test" to "".
...
```json
{
    "body": "**Changing work issues** from \"rebase rel #13741\" to \"\".",
    "created_at": "2012-12-29T12:14:11Z",
    "issue": "https://github.com/sagemath/sage/issues/12215",
    "type": "issue_comment",
...
**Changing work issues** from "rebase rel #13741" to "".
