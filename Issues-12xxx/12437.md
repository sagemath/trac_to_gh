...
<a id='comment:13'></a>Replying to [comment:11 ohanar]:
> Your patch looks like a subset of mine.
...
<a id='comment:17'></a>Replying to [comment:16 thansen]:
> Hi leif,
> 
> these are quite some patches. Do you plan to send them upstream?
