...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                         |                                                                          |\n|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[df4cab0](http://git.sagemath.org/sage.git/commit/?id=df4cab0)|trac #12867: Implements random_element methods for Words and moves ._iter_|",
...
```json
{
    "body": "<a id='comment:9'></a>\n(even though there is no automatic git message)\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[e9d71cc](http://git.sagemath.org/sage.git/commit/?id=e9d71cc29cada6747f82d0a71c0653afe52c0d50)|`trac #12867: Doctests fixed and ... changed to ....:`|\n|[0380d55](http://git.sagemath.org/sage.git/commit/?id=0380d55e8ed29a1342230abd45d12fb41b761528)|`trac #12867: Rebase on 6.1.beta3`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBanch updated !\n\nNathann\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[241a151](http://git.sagemath.org/sage.git/commit/?id=241a151def174f9cfa93340fd3dd2a9be1d4aa81)|`trac #12867: Doctests fixed and ... changed to ....:`|\n|[06d63d4](http://git.sagemath.org/sage.git/commit/?id=06d63d4e1b060db6541cb44b61c1033bd08fb56c)|`trac #12867: Rebase on 6.1.beta4`|",
    "created_at": "2014-01-05T19:13:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12867",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[eb7c2ab](http://git.sagemath.org/sage.git/commit/?id=eb7c2ab4e9cca0cb584f2236334db9dae4f41a75)|`Trac #12867: Rebase on 6.2.beta0`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[035603d](http://git.sagemath.org/sage.git/commit/?id=035603dd0c523ff054ffdc2d993b1898d827cf3a)|`trac #12867: rebase on 6.2.beta5`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[61f563a](http://git.sagemath.org/sage.git/commit/?id=61f563aceb93a5c39febe59c0bff679ef8a29a52)|`trac #16287: Merged into 6.2.rc0`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[a4095e1](http://git.sagemath.org/sage.git/commit/?id=a4095e1f8b27a9429db19bf6698022eb971d1a36)|`trac #12867: Bugfix`|",
    "created_at": "2014-04-23T22:44:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12867",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[5899a33](http://git.sagemath.org/sage.git/commit/?id=5899a33c9e3713f01e179cffe108157200a049e6)|`Merge branch 'public/12867' of trac.sagemath.org:sage into tmp`|\n|[3f13460](http://git.sagemath.org/sage.git/commit/?id=3f13460e1441bfaf2d5539262add1ad056f9fb7d)|`trac #12867: Broken doctests`|",
