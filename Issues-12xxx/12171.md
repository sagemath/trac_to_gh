...
```json
{
    "body": "<a id='comment:2'></a>There is spkg at http://sage.math.washington.edu/home/mhansen/mpfi-1.5.0.spkg",
    "created_at": "2011-12-17T10:53:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169727",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>There is spkg at http://sage.math.washington.edu/home/mhansen/mpfi-1.5.0.spkg
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169728",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>by the way, MPFI 1.5.0 fixes a limitation to 1000 characters in `mpfi_set_str`, which can be\ndemonstrated by the following test:\n\n```\nsage: R = RealIntervalField(53)\nsage: R(\"1\" * 1000)\n1.111111111111112?e999\n```\nwhich failed previously. Maybe add a test for that?\n\nPaul",
    "created_at": "2011-12-19T12:52:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169730",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:4'></a>by the way, MPFI 1.5.0 fixes a limitation to 1000 characters in `mpfi_set_str`, which can be
demonstrated by the following test:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169732",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>there is one important change in MPFI 1.5.0 which might cause the failures: `mpfi_set_ui` on\ninput 0 gives `[+0.0,-0.0]` instead of `[+0.0,+0.0]` previously. I will ask upstream why:\n\n```\nsage: R=RealIntervalField(53)\nsage: a=R(0)\nsage: a.lower(), a.upper()\n(0.000000000000000, -0.000000000000000)\n```\n\nMore annoying is the following, which I believe is a bug in MPFI 1.5.0:\n\n```\nsage: a=R(infinity)\nsage: a.lower(), a.upper()\n(+infinity, +infinity)\nsage: b=1/a\nsage: b.lower(), b.upper()\n(0.000000000000000, -0.000000000000000)\n```\n(I would expect `b=[+0.0,+0.0]`.)\n\nPaul",
    "created_at": "2011-12-19T17:59:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169733",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:6'></a>there is one important change in MPFI 1.5.0 which might cause the failures: `mpfi_set_ui` on
input 0 gives `[+0.0,-0.0]` instead of `[+0.0,+0.0]` previously. I will ask upstream why:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169734",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>the first issue with gamma seems to be due to that bug in Sage:\n\n```\nsage: RealIntervalField(54)(-19/3) > 1.462\nTrue\n```\n(works for precision 53 or less).\n\nPaul",
    "created_at": "2011-12-21T11:21:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169736",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:9'></a>the first issue with gamma seems to be due to that bug in Sage:
...
```json
{
    "body": "<a id='comment:10'></a>I got a message from the developers of the Sollya package who say that they had similar\nproblems when upgrading to MPFI 1.5.0. Their solution was to write a wrapper around\nMPFI to give sense to intervals like [+Inf,+Inf].\n\nPaul",
    "created_at": "2011-12-21T11:27:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169737",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:10'></a>I got a message from the developers of the Sollya package who say that they had similar
problems when upgrading to MPFI 1.5.0. Their solution was to write a wrapper around
MPFI to give sense to intervals like [+Inf,+Inf].
...
```json
{
    "body": "<a id='comment:11'></a>the problem from comment [comment:9] seems to only apply on 32-bit machines. I'll first try to\nsolve problems on 64-bit. There is one strange thing with the patch applied:\n\n```\nsage: x = AA(2).sqrt()^2\nsage: (x-2).real_exact(RR)\n0.000000000000000\nsage: x.real_exact(RR)\n2.00000000000000\nsage: (x-2).real_exact(RR)\n-0.000000000000000\n```\nThe MPFI developers claim that in MPFI 1.5 the sign of 0 is irrelevant, but this is still a\nnon-deterministic issue.\n\nPaul",
    "created_at": "2011-12-22T09:44:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169738",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:11'></a>the problem from comment [comment:9] seems to only apply on 32-bit machines. I'll first try to
solve problems on 64-bit. There is one strange thing with the patch applied:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169739",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169740",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>> Should I also rewrite the 2 failing tests like this? What is the reason for the failures?\n\n\nRobert, Mike, are you there?\n\nPaul",
    "created_at": "2011-12-23T18:37:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169742",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:13'></a>> Should I also rewrite the 2 failing tests like this? What is the reason for the failures?
...
```json
{
    "body": "<a id='comment:14'></a>Jeroen, since I got no answer to my question I ask you: do you have an idea how to proceed?\n\nPaul",
    "created_at": "2011-12-27T09:05:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169743",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:14'></a>Jeroen, since I got no answer to my question I ask you: do you have an idea how to proceed?
...
```json
{
    "body": "<a id='comment:15'></a>Hi Paul, sorry for the delay; I've been busy with traveling back to the states / the holidays.  I'll look into why these are failing today.  I started while I was in Warwick, but didn't make much progress.",
    "created_at": "2011-12-27T17:24:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169744",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:15'></a>Hi Paul, sorry for the delay; I've been busy with traveling back to the states / the holidays.  I'll look into why these are failing today.  I started while I was in Warwick, but didn't make much progress.
...
```json
{
    "body": "<a id='comment:17'></a>Replying to [zimmerma](#comment%3A12):\n> I see in `real_mpfi.pyx` that other similar tests are failing and were rewritten in a\n> different way:\n> \n> ```\n> sage: R = RealIntervalField(4000)\n> sage: s = 1/R(3)\n> sage: t = loads(dumps(s))\n> sage: (t.upper(), t.lower()) == (s.upper(), s.lower())\n> True\n> ```\n> Indeed `t==s` fails:\n> \n> ```\n> sage: t == s\n> False\n> ```\n> Should I also rewrite the 2 failing tests like this? What is the reason for the failures?\n\n\nThis is quite strange I cannot think of a reason this would fail unless the \"==\" operator is doing something slightly wrong or something unexpected.",
    "created_at": "2011-12-31T03:34:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169745",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:17'></a>Replying to [zimmerma](#comment%3A12):
> I see in `real_mpfi.pyx` that other similar tests are failing and were rewritten in a
> different way:
> 
> ```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169747",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Attachment [trac_12171b.patch](tarball://root/attachments/some-uuid/ticket12171/trac_12171b.patch) by @zimmermann6 created at 2011-12-31 10:15:36\n\nthe second patch attached fixes the remaining failing tests. Ready for review.\n\nPaul",
    "created_at": "2011-12-31T10:15:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169748",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:19'></a>Attachment [trac_12171b.patch](tarball://root/attachments/some-uuid/ticket12171/trac_12171b.patch) by @zimmermann6 created at 2011-12-31 10:15:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169749",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169750",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169751",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>There is no doubt that this second patch will do the trick and does the right thing. I am just wondering why \"t == s\" doesn't work as expected in the first place. \n\nIn any case I will do some basic reviewing shortly. The patch themselves look good to me. I need to check the spkg in details.",
    "created_at": "2012-01-04T01:40:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169752",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:20'></a>There is no doubt that this second patch will do the trick and does the right thing. I am just wondering why "t == s" doesn't work as expected in the first place. 
...
```json
{
    "body": "<a id='comment:21'></a>Francois, I explain in comment [comment:18] that the semantics of `t == s` is special for\nintervals. If `t=[a,b]` and `s=[c,d]`, it requires that `x==y` for any `a <= x <= b` and `c <= y <= d`, which obviously requires `a=b=c=d`.\n\nThe modified tests did work before because they had `a=b=c=d`, which is no longer the case due\nto change of semantics of MPFI.\n\nPaul",
    "created_at": "2012-01-04T06:40:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169753",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:21'></a>Francois, I explain in comment [comment:18] that the semantics of `t == s` is special for
intervals. If `t=[a,b]` and `s=[c,d]`, it requires that `x==y` for any `a <= x <= b` and `c <= y <= d`, which obviously requires `a=b=c=d`.
...
```json
{
    "body": "<a id='comment:22'></a>Just a quick update: it doesn't appear that mpfi runs a test suite when SAGE_CHECK is set can you fix that?",
    "created_at": "2012-01-07T18:47:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169754",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:22'></a>Just a quick update: it doesn't appear that mpfi runs a test suite when SAGE_CHECK is set can you fix that?
...
```json
{
    "body": "Changing work_issues from \"\" to \"clean hg repo; add SAGE_CHECK\"",
    "created_at": "2012-01-07T23:08:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169756",
    "user": "https://github.com/kiwifb"
}
```

Changing work_issues from "" to "clean hg repo; add SAGE_CHECK"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169757",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169758",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Mike, please can you make the changes in the spkg? I'd like to make progress on this patch during\nSD 35.5, so that we can proceed on #11666.\n\nPaul",
    "created_at": "2012-01-08T10:56:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169759",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:25'></a>Mike, please can you make the changes in the spkg? I'd like to make progress on this patch during
SD 35.5, so that we can proceed on #11666.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169760",
...
```json
{
    "body": "<a id='comment:26'></a>As I happened to be cc'ed on this ticket, I've uplaoded a package with the requested easy changes at http://perso.telecom-paristech.fr/~flori/sage/mpfi-1.5.0.spkg\n\nAt least it install on a (vanilla? not sure... but nothing to exotic) sage 4.7.2 and runs the test suite (and succeed) when asked so on my machine.",
    "created_at": "2012-01-08T11:17:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169761",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:26'></a>As I happened to be cc'ed on this ticket, I've uplaoded a package with the requested easy changes at http://perso.telecom-paristech.fr/~flori/sage/mpfi-1.5.0.spkg
...
```json
{
    "body": "<a id='comment:27'></a>I've also put another version of the package at the same address + \".new\" where the last test in spkg-install is slightly simplified...",
    "created_at": "2012-01-08T11:41:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169762",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:27'></a>I've also put another version of the package at the same address + ".new" where the last test in spkg-install is slightly simplified...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169763",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169764",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169765",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Looking at it again it may have been a little bit more verbose about the removal of the patches in SPKG.txt but it is otherwise fine now. It actually builds and tests fine on something exotic (SLES 11SP1 on power7, although there may be a slight clue about some problems on power7 in those tests).\n\nI giving this a positive review.",
    "created_at": "2012-01-08T20:52:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169766",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:28'></a>Looking at it again it may have been a little bit more verbose about the removal of the patches in SPKG.txt but it is otherwise fine now. It actually builds and tests fine on something exotic (SLES 11SP1 on power7, although there may be a slight clue about some problems on power7 in those tests).
...
```json
{
    "body": "<a id='comment:29'></a>I've put the last package at the \"normal\" address (i.e. without .new at the end) and linked it in the ticket description.",
    "created_at": "2012-01-09T10:25:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169767",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:29'></a>I've put the last package at the "normal" address (i.e. without .new at the end) and linked it in the ticket description.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169768",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12171#event-32357"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#12131\"",
    "created_at": "2012-01-09T23:13:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169769",
    "user": "https://github.com/jdemeyer"
}
```

Changing dependencies from "" to "#12131"
...
```json
{
    "body": "<a id='comment:31'></a>This should be rebased to #12131.",
    "created_at": "2012-01-09T23:13:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169770",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>This should be rebased to #12131.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169771",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169772",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>I hadn't noticed that mpfi was one of the concerned package but I guess it make sense. This should be easy and quick to fix.",
    "created_at": "2012-01-10T01:21:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169773",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:32'></a>I hadn't noticed that mpfi was one of the concerned package but I guess it make sense. This should be easy and quick to fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169774",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169775",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>The concerned line of spkg-install has been updated according to #12131.\n\nYou can find the updated package at the same address:\n\nhttp://perso.telecom-paristech.fr/~flori/sage/mpfi-1.5.0.spkg",
    "created_at": "2012-01-10T12:55:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169776",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:33'></a>The concerned line of spkg-install has been updated according to #12131.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169778",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>My bad, I did not really thought before adding the one line fix from #12131.\n\nI'll do it the right way around later.",
    "created_at": "2012-01-11T08:00:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169779",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:35'></a>My bad, I did not really thought before adding the one line fix from #12131.
...
```json
{
    "body": "<a id='comment:36'></a>note that MPFI 1.5.1 will soon be out:\nhttp://lists.gforge.inria.fr/pipermail/mpfi-users/2012-January/000031.html\n\nPaul",
    "created_at": "2012-01-11T17:44:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169780",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:36'></a>note that MPFI 1.5.1 will soon be out:
http://lists.gforge.inria.fr/pipermail/mpfi-users/2012-January/000031.html
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169783",
...
```json
{
    "body": "<a id='comment:41'></a>Sorry I have fallen of the face of the internet in the past few days (not quite literally but almost). If there is a bit of time the test suite pass on power7 in a sage setting but with the following messages:\n\n```\nPASS: tinit\nPASS: tinit_set\nWarning: reverted endpoints line 21\nWarning: reverted endpoints line 22\nWarning: reverted endpoints line 23\nWarning: reverted endpoints line 26\nWarning: reverted endpoints line 30\nWarning: reverted endpoints line 37\nWarning: reverted endpoints line 38\nPASS: tintersect\n```\nand\n\n```\nPASS: tsech\nPASS: tset\nWarning: reverted endpoints line 11\nWarning: reverted endpoints line 12\nWarning: reverted endpoints line 13\nWarning: reverted endpoints line 14\nWarning: reverted endpoints line 15\nPASS: tset_d\n```\nNot sure if it can have an impact on some sage use or not.",
    "created_at": "2012-01-16T00:27:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169785",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:41'></a>Sorry I have fallen of the face of the internet in the past few days (not quite literally but almost). If there is a bit of time the test suite pass on power7 in a sage setting but with the following messages:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169788",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>Here comes finally a 1.5.1 spkg rebased on #12131 \n\nYou can find it at http://perso.telecom-paristech.fr/~flori/sage/mpfi-1.5.1.spkg\n\nI slightly updated the description and license info as well.",
    "created_at": "2012-01-23T14:38:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169789",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:44'></a>Here comes finally a 1.5.1 spkg rebased on #12131 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169790",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>Shouldn't spkg-check actually be a proper shell script? By that I mean start with something like\n\n```/bin/sh\n```\nor possibly\n\n```/usr/bin/env bash\n```",
    "created_at": "2012-01-23T22:04:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169791",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:45'></a>Shouldn't spkg-check actually be a proper shell script? By that I mean start with something like
...
```json
{
    "body": "<a id='comment:46'></a>fbissey: yes, it should be.  It should also be executable.",
    "created_at": "2012-01-23T22:15:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169792",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:46'></a>fbissey: yes, it should be.  It should also be executable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169793",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169794",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169795",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>Sorry about that, I definitely tried to repackage that one and mpfr one too quickly from scratch on my personal computer and mixed everything.\n\nIt should be ok now (same address as before).",
    "created_at": "2012-01-23T23:07:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169796",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:48'></a>Sorry about that, I definitely tried to repackage that one and mpfr one too quickly from scratch on my personal computer and mixed everything.
...
```json
{
    "body": "<a id='comment:49'></a>OK, I am putting it back to positive review, looks all right, survives basic testing.",
    "created_at": "2012-01-23T23:31:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169797",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:49'></a>OK, I am putting it back to positive review, looks all right, survives basic testing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169798",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169799",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:50'></a>I actually get the doctest failure\n\n```\nsage -t  -force_lib devel/sage/sage/rings/real_mpfi.pyx\n**********************************************************************\nFile \"/mnt/usb1/scratch/jdemeyer/merger/sage-5.0.beta2/devel/sage-main/sage/rings/real_mpfi.pyx\", line 4143:\n    sage: 0 in (RealField(2000)(-19/3).gamma() - RealIntervalField(1000)(-19/3).gamma())\nExpected:\n    True\nGot:\n    False\n**********************************************************************\n```",
    "created_at": "2012-01-24T20:44:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169800",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:50'></a>I actually get the doctest failure
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169801",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169802",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>Sorry, should have mentioned this.  It happened on sage.math, with sage-5.0.beta1 + various other patches + #12171.  I have not tried a plain sage-5.0.beta1 + #12171.",
    "created_at": "2012-01-24T21:25:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169803",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:52'></a>Sorry, should have mentioned this.  It happened on sage.math, with sage-5.0.beta1 + various other patches + #12171.  I have not tried a plain sage-5.0.beta1 + #12171.
...
```json
{
    "body": "<a id='comment:53'></a>I haven't noticed any of that in the prealpha, interestingly enough the time out on power7 apparently happened on a call to .gamma(). I will try 5.0.beta1.",
    "created_at": "2012-01-24T21:34:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169804",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:53'></a>I haven't noticed any of that in the prealpha, interestingly enough the time out on power7 apparently happened on a call to .gamma(). I will try 5.0.beta1.
...
```json
{
    "body": "<a id='comment:54'></a>On my 64 bit linux box after accounting for #12349 (which came out of nowhere suddenly) and applying this ticket\n\n```\nfbissey@QCD-nzi3 /home/work/fbissey/sandbox/sage-5.0.beta1 $ ./sage -t -long -force_lib devel/sage/sage/rings/real_mpfi.pyx\nsage -t -long -force_lib \"devel/sage/sage/rings/real_mpfi.pyx\"\n         [1.3 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 1.3 seconds\n```",
    "created_at": "2012-01-25T03:27:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169805",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:54'></a>On my 64 bit linux box after accounting for #12349 (which came out of nowhere suddenly) and applying this ticket
...
```json
{
    "body": "<a id='comment:57'></a>> I'll open a separate ticket for that\n\n\nit is #12353.\n\nPaul",
    "created_at": "2012-01-25T08:22:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169808",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:57'></a>> I'll open a separate ticket for that
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169810",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:60'></a>I get\n\n```\nsage: RealIntervalField(53)(-1) > RR(1)\nFalse\nsage: RealIntervalField(54)(-1) > RR(1)\nFalse\nsage: (RealField(2000)(-19/3).gamma() - RealIntervalField(1000)(-19/3).gamma())\n0.?e-302\nsage: 0 in (RealField(2000)(-19/3).gamma() - RealIntervalField(1000)(-19/3).gamma())\nTrue\n```",
    "created_at": "2012-01-25T14:38:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169811",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:60'></a>I get
...
```json
{
    "body": "<a id='comment:61'></a>strange, with 4.8 just compiled on a Core2 under Ubuntu 10.10 I get:\n\n```\n\ntarte% ./sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nsage: RealIntervalField(53)(-1) > RR(1)\nFalse\nsage: RealIntervalField(54)(-1) > RR(1)\nTrue\n```\nPaul",
    "created_at": "2012-01-25T14:48:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169812",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:61'></a>strange, with 4.8 just compiled on a Core2 under Ubuntu 10.10 I get:
...
```json
{
    "body": "<a id='comment:63'></a>Francois,\n\nI just built Sage 5.0.beta1 on another 64 bit linux (Core2 under Ubuntu 10.10) and got:\n\n```\ntarte% ./sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n**********************************************************************\n*                                                                    *\n* Warning: this is a prerelease version, and it may be unstable.     *\n*                                                                    *\n**********************************************************************\nsage: RealIntervalField(53)(-1) > RR(1)\nFalse\nsage: RealIntervalField(54)(-1) > RR(1)\nTrue\n```\nPaul",
    "created_at": "2012-01-26T06:57:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169814",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:63'></a>Francois,
...
```json
{
    "body": "<a id='comment:64'></a>This is way more subtle than I thought then. I did my tests without #11666, did you use #11666 as well as this one?",
    "created_at": "2012-01-28T00:28:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169815",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:64'></a>This is way more subtle than I thought then. I did my tests without #11666, did you use #11666 as well as this one?
...
```json
{
    "body": "<a id='comment:66'></a>Everything I said was *without* #11666.",
    "created_at": "2012-01-29T11:10:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169817",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:66'></a>Everything I said was *without* #11666.
...
```json
{
    "body": "<a id='comment:68'></a>since this ticket got a positive review at comment [comment:49], and the doctest\nfailure at comment [comment:50] is a separate issue (#12353) I put this back as \"needs review\".\n\nPaul",
    "created_at": "2012-01-30T08:06:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169819",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:68'></a>since this ticket got a positive review at comment [comment:49], and the doctest
failure at comment [comment:50] is a separate issue (#12353) I put this back as "needs review".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169820",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169821",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:69'></a>If nothing on this ticket changed, I guess we're back to positive review *with* a dependency on #12353.",
    "created_at": "2012-01-30T10:16:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169822",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:69'></a>If nothing on this ticket changed, I guess we're back to positive review *with* a dependency on #12353.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169823",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169824",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:71'></a>Jeroen, now that #12353 has been fixed, you can merge this one too.\n\nPaul",
    "created_at": "2012-02-16T11:22:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169825",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:71'></a>Jeroen, now that #12353 has been fixed, you can merge this one too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169827",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:74'></a>An updated package is available at the same address.\n\nI also added a mecurial tag for mpfi-1.5.1.",
    "created_at": "2012-02-22T10:26:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169829",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```

<a id='comment:74'></a>An updated package is available at the same address.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169830",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169831",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169832",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169833",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12171#event-32358"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169834",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12171#issuecomment-169835",
    "user": "https://github.com/jdemeyer"
}
```
