...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188640",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I'm guessing this will be a sort of meta-ticket, where you open another ticket for an undocumented function, and provide a link here. Hopefully then writing the doctest on the other ticket. Is that what you had in mind? \n\nDave",
    "created_at": "2012-04-30T20:48:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188641",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

<a id='comment:3'></a>I'm guessing this will be a sort of meta-ticket, where you open another ticket for an undocumented function, and provide a link here. Hopefully then writing the doctest on the other ticket. Is that what you had in mind? 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188642",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188643",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188645",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Question: Should the encouraging message only be shown when a user interactively reads the documentation (by `obj?` in the notebook resp. in command line version), or should it also appear in the reference manual?",
    "created_at": "2012-05-03T07:15:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188646",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>Question: Should the encouraging message only be shown when a user interactively reads the documentation (by `obj?` in the notebook resp. in command line version), or should it also appear in the reference manual?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188647",
...
```json
{
    "body": "<a id='comment:8'></a>That I am changing the status to needs_info, let me just say that, we should be able to add this \"Please contribute doctests\" only in the interactive version. It would be very annoying to have this message in files where every function lacks doctests and the reference manual tells people \"Please contribute doctests\". \n\n~KnS",
    "created_at": "2013-02-18T22:29:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188648",
    "user": "https://github.com/KPanComputes"
}
```

<a id='comment:8'></a>That I am changing the status to needs_info, let me just say that, we should be able to add this "Please contribute doctests" only in the interactive version. It would be very annoying to have this message in files where every function lacks doctests and the reference manual tells people "Please contribute doctests". 
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12891#event-35208"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12891#event-35209"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12891#event-35210"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12891#event-35211"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12891#event-35212"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12891#event-35213"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12891#event-35214"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12891#issuecomment-188649",
