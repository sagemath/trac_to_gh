...
```json
{
    "body": "I've added a new version of the patch, with a new option ``opacity`` and an enhanced version of option ``color`` (see docstring).",
...
```json
{
    "body": "I'd be glad if anyone can explain me why the patchbot says \"TestsFailed\". sage -t and docbuild run fine on my machine.",
...
```json
{
    "body": "Please write your real names in the Author/Reviewer fields.",
...
```json
{
    "body": "This should be rebased to sage-5.2.rc1.",
    "created_at": "2012-07-27T20:34:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12454",
    "type": "issue_comment",
...
```json
{
    "body": "A test fails but it doesn't seem to come from this patch.\n\nIt would be great if this could make it into sage-5.2.",
