...
```json
{
    "body": "<a id='comment:1'></a>The sage directory is relocatable and so simply moving the directory from `/tmp/sage-4.8` to `/usr/local/sage-4.8` will enable you to run sage again. After moving the folder you should also run sage just once ( `/usr/local/sage-4.8/sage` ) so that it resolves all the paths.\n\nAs for make install being broken, it seems to happen because there is no `SAGE_ROOT=\".....\"` in the file anymore and so that hard coding doesn't get done any more. A simple fix should be this patch to the Makefile in your `/tmp/sage-4.8/Makefile`:\n\n```diff\n--- Makefile.old\t2012-01-24 20:37:40.000000000 +0800\n+++ Makefile\t2012-01-24 20:42:38.000000000 +0800\n@@ -149,7 +149,7 @@\n \tmkdir -p $(DESTDIR)/sage\n \tmkdir -p $(DESTDIR)/bin/\n \tcp -rpv * $(DESTDIR)/sage/\n-\tpython local/bin/sage-hardcode_sage_root $(DESTDIR)/sage/sage \"$(DESTDIR)\"/sage\n+\tsed -i -e \"s@^#SAGE_ROOT=/path/.*$@SAGE_ROOT=$(DESTDIR)/sage@;q\" \"$(DESTDIR)/sage/sage\"\n \tcp $(DESTDIR)/sage/sage $(DESTDIR)/bin/\n \tcd $(DESTDIR)/bin/; ./sage -c\n\n```",
    "created_at": "2012-01-24T12:44:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174474",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:1'></a>The sage directory is relocatable and so simply moving the directory from `/tmp/sage-4.8` to `/usr/local/sage-4.8` will enable you to run sage again. After moving the folder you should also run sage just once ( `/usr/local/sage-4.8/sage` ) so that it resolves all the paths.
...
```json
{
    "body": "<a id='comment:2'></a>Hmm.. using `@` is not a good idea there. The correct patch should be:\n\n```diff\n--- Makefile.old\t2012-01-20 13:38:18.000000000 +0800\n+++ Makefile\t2012-01-24 20:51:23.000000000 +0800\n@@ -149,7 +149,7 @@\n \tmkdir -p $(DESTDIR)/sage\n \tmkdir -p $(DESTDIR)/bin/\n \tcp -rpv * $(DESTDIR)/sage/\n-\tpython local/bin/sage-hardcode_sage_root $(DESTDIR)/sage/sage \"$(DESTDIR)\"/sage\n+\tsed -i -e \"s|^#SAGE_ROOT=/path/.*$|SAGE_ROOT=\\\"$(DESTDIR)/sage\\\"|;q\" \"$(DESTDIR)/sage/sage\"\n \tcp $(DESTDIR)/sage/sage $(DESTDIR)/bin/\n \tcd $(DESTDIR)/bin/; ./sage -c\n \n```",
    "created_at": "2012-01-24T12:52:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174475",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:2'></a>Hmm.. using `@` is not a good idea there. The correct patch should be:
...
```json
{
    "body": "<a id='comment:4'></a>Sigh. Sorry for the trouble. I don't have sage-4.8 built yet. So, I can't test this as \"make install\". But I did test this sed expression before putting it here (that's how I caught the ``@`` problem).\n\nI see from\n\n```\nsed -i -e \"s|^#SAGE_ROOT=/path/.*SAGE_ROOT=\\\"/usr/local/sage-4.8a/sage\\\"|;q\"\n```\nthat the `$|` was eaten away by the make process (it is not stripped away when run on the terminal). This is why you are getting that sed error. Can you try it without the `$`? Then the patch will look like this:\n\n```diff\n--- Makefile\t2012-01-20 13:38:18.000000000 +0800\n+++ /home/punarbasu/Makefile\t2012-01-24 20:51:23.000000000 +0800\n@@ -149,7 +149,7 @@\n \tmkdir -p $(DESTDIR)/sage\n \tmkdir -p $(DESTDIR)/bin/\n \tcp -rpv * $(DESTDIR)/sage/\n-\tpython local/bin/sage-hardcode_sage_root $(DESTDIR)/sage/sage \"$(DESTDIR)\"/sage\n+\tsed -i -e \"s|^#SAGE_ROOT=/path/.*|SAGE_ROOT=\\\"$(DESTDIR)/sage\\\"|;q\" \"$(DESTDIR)/sage/sage\"\n \tcp $(DESTDIR)/sage/sage $(DESTDIR)/bin/\n \tcd $(DESTDIR)/bin/; ./sage -c\n \n```",
    "created_at": "2012-01-25T16:16:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174477",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:4'></a>Sigh. Sorry for the trouble. I don't have sage-4.8 built yet. So, I can't test this as "make install". But I did test this sed expression before putting it here (that's how I caught the ``@`` problem).
...
```json
{
    "body": "<a id='comment:5'></a>it still does not work. With the change of comment [comment:4], the `$(DESTDIR)/bin/sage` file contains a single line:\n\n```\ntarte% cat /tmp/sage-4.8/bin/sage\n#!/usr/bin/env bash\n```\nPaul",
    "created_at": "2012-01-25T16:33:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174478",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:5'></a>it still does not work. With the change of comment [comment:4], the `$(DESTDIR)/bin/sage` file contains a single line:
...
```json
{
    "body": "<a id='comment:6'></a>Ok. I will leave it up to someone else to come up with a fix to the python file `local/bin/sage-hardcode_sage_root`. I will check this ticket again after I have downloaded and built sage-4.8.\n\nThanks for your patience and feedback.",
    "created_at": "2012-01-25T17:15:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174479",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:6'></a>Ok. I will leave it up to someone else to come up with a fix to the python file `local/bin/sage-hardcode_sage_root`. I will check this ticket again after I have downloaded and built sage-4.8.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174481",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174483",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174486",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174488",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>is the patch ready for review? No work issues were added in comment [comment:8].\n\nPaul",
    "created_at": "2012-01-30T15:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174489",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:12'></a>is the patch ready for review? No work issues were added in comment [comment:8].
...
```json
{
    "body": "<a id='comment:13'></a>Sorry, forgot to set it to needs_review.",
    "created_at": "2012-01-30T15:20:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174490",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:13'></a>Sorry, forgot to set it to needs_review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174491",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174492",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174493",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174494",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174495",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174496",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174498",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174499",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Updated the patch. I guess we could write some logic to detect if a sage process is running, but it would not be robust enough and would bloat the install part.\n\nI updated the patch to not proceed with the installation if the `$(DESTDIR)/sage` is a file or symlink. It will (hopefully) prevent accidents. :)",
    "created_at": "2012-04-13T14:40:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174500",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:19'></a>Updated the patch. I guess we could write some logic to detect if a sage process is running, but it would not be robust enough and would bloat the install part.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174501",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Mention in a comment that the \"`[ -d`\" test is meant to exclude the case that \"$(DESTDIR)\"/sage is an existing file, not a directory.",
    "created_at": "2012-04-13T14:52:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174503",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:22'></a>Mention in a comment that the "`[ -d`" test is meant to exclude the case that "$(DESTDIR)"/sage is an existing file, not a directory.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174504",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174505",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Attachment [trac_12347.patch](tarball://root/attachments/some-uuid/ticket12347/trac_12347.patch) by @ppurka created at 2012-04-13 15:21:27\n\nUpdated.",
    "created_at": "2012-04-13T15:21:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174506",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:24'></a>Attachment [trac_12347.patch](tarball://root/attachments/some-uuid/ticket12347/trac_12347.patch) by @ppurka created at 2012-04-13 15:21:27
...
```json
{
    "body": "<a id='comment:25'></a>Actually `-e` should be portable, going by [this page](http://www.unix.com/man-page/POSIX/1/test/).",
    "created_at": "2012-04-13T15:28:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174507",
    "user": "https://github.com/ppurka"
}
```

<a id='comment:25'></a>Actually `-e` should be portable, going by [this page](http://www.unix.com/man-page/POSIX/1/test/).
...
```json
{
    "body": "<a id='comment:26'></a>Replying to [ppurka](#comment%3A25):\n> Actually `-e` should be portable, going by [this page](http://www.unix.com/man-page/POSIX/1/test/).\n\n\nMaybe it \"should be\", but it isn't.",
    "created_at": "2012-04-13T15:44:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174508",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:26'></a>Replying to [ppurka](#comment%3A25):
> Actually `-e` should be portable, going by [this page](http://www.unix.com/man-page/POSIX/1/test/).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174510",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>the patches apply successfully to sage-5.0.beta13 and `make install` works.\nMy only comment after looking at the patch: shouldn't we check also if $(DESTDIR)/bin\nalready exists?\n\nPaul",
    "created_at": "2012-04-16T14:36:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174511",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:29'></a>the patches apply successfully to sage-5.0.beta13 and `make install` works.
My only comment after looking at the patch: shouldn't we check also if $(DESTDIR)/bin
already exists?
...
```json
{
    "body": "<a id='comment:30'></a>Replying to [zimmerma](#comment%3A29):\n> shouldn't we check also if $(DESTDIR)/bin already exists?\n\nWhy?  What would you propose?",
    "created_at": "2012-04-16T14:47:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174512",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:30'></a>Replying to [zimmerma](#comment%3A29):
> shouldn't we check also if $(DESTDIR)/bin already exists?
...
```json
{
    "body": "<a id='comment:31'></a>if we assume that $(DESTDIR)/sage can already exist, the same can happen for $(DESTDIR)/bin\nwith a previous installation of Sage. What will then happen? I propose to remove\n$(DESTDIR)/bin if it exists and is a directory.\n\nPaul",
    "created_at": "2012-04-16T15:08:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174513",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:31'></a>if we assume that $(DESTDIR)/sage can already exist, the same can happen for $(DESTDIR)/bin
with a previous installation of Sage. What will then happen? I propose to remove
$(DESTDIR)/bin if it exists and is a directory.
...
```json
{
    "body": "<a id='comment:33'></a>ok, then I give a positive review.\n\nPaul",
    "created_at": "2012-04-16T15:22:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174515",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:33'></a>ok, then I give a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174516",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174517",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174518",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174519",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12347#event-33063"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12347",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12347#issuecomment-174520",
    "user": "https://github.com/jdemeyer"
}
```
