...
```json
{
    "body": "Changed assignee from **@sagetrac-mvngu** to **@slel**",
    "created_at": "2012-02-11T10:39:43Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12496#issuecomment-140372",
    "user": "https://github.com/slel"
}
```

Changed assignee from **@sagetrac-mvngu** to **@slel**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12496#issuecomment-140373",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12496#event-156470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12496#event-156471"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12496",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12496#event-156472"
}
```
