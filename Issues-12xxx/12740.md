...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12740#issuecomment-184800",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12740#issuecomment-184801",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I have been playing around with this for a while, and everything really seems to run smoothly. Very nice code and every small test I did gave the predicted answers. Since nobody more experienced objected in the meanwhile, I'll give this a positive review.",
    "created_at": "2012-05-24T16:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12740#issuecomment-184803",
    "user": "https://trac.sagemath.org/admin/accounts/users/janv"
}
```

<a id='comment:4'></a>I have been playing around with this for a while, and everything really seems to run smoothly. Very nice code and every small test I did gave the predicted answers. Since nobody more experienced objected in the meanwhile, I'll give this a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12740#issuecomment-184804",
    "user": "https://trac.sagemath.org/admin/accounts/users/janv"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12740#issuecomment-184805",
    "user": "https://trac.sagemath.org/admin/accounts/users/janv"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12740",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12740#event-34632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12740#issuecomment-184806",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12740#issuecomment-184807",
    "user": "https://github.com/jdemeyer"
}
```
