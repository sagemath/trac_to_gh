...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167101",
...
```json
{
    "body": "<a id='comment:2'></a>As Volker pointed out on sage-devel, an even better way to avoid this is to set the `HGPLAIN` environment variable.",
    "created_at": "2011-11-20T06:59:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167103",
    "user": "https://github.com/kini"
}
```

<a id='comment:2'></a>As Volker pointed out on sage-devel, an even better way to avoid this is to set the `HGPLAIN` environment variable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167105",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167106",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I changed my mind about `HGPLAIN`: maybe it is the best solution.",
    "created_at": "2011-11-20T11:41:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167107",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I changed my mind about `HGPLAIN`: maybe it is the best solution.
...
```json
{
    "body": "<a id='comment:7'></a>If you call mercurial from within sage ('hg-sage' and friends) to diff then we pass `--config pager.pager=...` in `sage/misc/hg.py`. So whether or not the pager is enabled by default in the `hgrc` is just a matter of taste.\n\nMy vote would be:\n* Use `HGPLAIN` in scripts if necessary.\n* Keep the pager extension to intentionally break scripts that forget to set `HGPLAIN`.",
    "created_at": "2011-11-20T11:43:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167108",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:7'></a>If you call mercurial from within sage ('hg-sage' and friends) to diff then we pass `--config pager.pager=...` in `sage/misc/hg.py`. So whether or not the pager is enabled by default in the `hgrc` is just a matter of taste.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167109",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167110",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Proof-of-concept patch using `HGPLAIN`.  Note that I replaced `sage -hg` by `hg` in all scripts, hoping that `SAGE_ROOT/local/bin` is in the path.",
    "created_at": "2011-11-20T11:58:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167111",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>Proof-of-concept patch using `HGPLAIN`.  Note that I replaced `sage -hg` by `hg` in all scripts, hoping that `SAGE_ROOT/local/bin` is in the path.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167112",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167113",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167114",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167115",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167116",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167117",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167119",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167120",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12058#event-32011"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Oh, I think I see.  See #12288 for a followup.",
    "created_at": "2012-01-09T22:25:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167122",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>Oh, I think I see.  See #12288 for a followup.
...
```json
{
    "body": "<a id='comment:17'></a>I wouldn't want to revert this ticket, because it would imply reverting #10594. Sage could unset the environment variable HGPLAIN or explicitly run less. This would be a fairly easy fix.  I don't have the energy to write or review such a patch myself though.",
    "created_at": "2012-01-09T22:31:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167123",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>I wouldn't want to revert this ticket, because it would imply reverting #10594. Sage could unset the environment variable HGPLAIN or explicitly run less. This would be a fairly easy fix.  I don't have the energy to write or review such a patch myself though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12058#issuecomment-167124",
    "user": "https://github.com/kcrisman"
}
```
