...
```json
{
    "body": "<a id='comment:1'></a>See http://groups.google.com/group/sage-support/browse_thread/thread/db78582b77f854d",
    "created_at": "2012-02-03T19:35:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12421#issuecomment-176669",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>See http://groups.google.com/group/sage-support/browse_thread/thread/db78582b77f854d
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12421#issuecomment-176670",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12421#issuecomment-176672",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12421#issuecomment-176673",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I think only defining LESS if it isn't set makes the most sense. We should also add information about this in the tutorial. I also wonder the Sage banner should be changed or expanded: it currently says\n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n```\n`license()` is obviously important, but it's not something that people will need to run very much, and it's not much help for newbies. We could eliminate its mention in the banner, or we could say\n| Sage Version 5.0.beta1, Release Date: 2012-01-22                   |\n| Type notebook() for the GUI, and license() for information.        |\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n```\nThe message printed by `help()` could also say something about what to do after you type something like `matrix_plot?`.",
    "created_at": "2012-02-04T18:04:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12421#issuecomment-176674",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>I think only defining LESS if it isn't set makes the most sense. We should also add information about this in the tutorial. I also wonder the Sage banner should be changed or expanded: it currently says
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12421#issuecomment-176675",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>See #12445 for a revised banner and help message.  Regarding a doctest for the `tutorial()` command, the problem is that the command opens up a file in a web browser, and that's not something we want to happen during doctesting.  In the patch at #12445, I've added doctests which are marked \"not tested\".  If the tutorial (or other piece of documentation) is missing, it should be caught by other doctests in the same file, in particular by the doctest for `_search_src_or_doc`.",
    "created_at": "2012-02-04T22:26:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12421",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12421#issuecomment-176676",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>See #12445 for a revised banner and help message.  Regarding a doctest for the `tutorial()` command, the problem is that the command opens up a file in a web browser, and that's not something we want to happen during doctesting.  In the patch at #12445, I've added doctests which are marked "not tested".  If the tutorial (or other piece of documentation) is missing, it should be caught by other doctests in the same file, in particular by the doctest for `_search_src_or_doc`.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12421#event-33359"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12421#event-33360"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12421#event-33361"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12421#event-33362"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12421#event-33363"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12421#event-33364"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12421#event-33365"
}
```
