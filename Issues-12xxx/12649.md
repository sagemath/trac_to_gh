...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34267"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12649#issuecomment-182484",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34268"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34269"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34270"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34271"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34272"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34273"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>will this be fixed by the recent refactoring ?\n\nmaybe check also other tickets with \"species\" keyword ?",
    "created_at": "2022-09-27T14:32:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12649#issuecomment-182485",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:7'></a>will this be fixed by the recent refactoring ?
...
```json
{
    "body": "<a id='comment:9'></a>Yes, I am eager to close all the other tickets.  However, I want #34552 to be in the develop branch first.",
    "created_at": "2022-09-27T15:18:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12649#issuecomment-182487",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:9'></a>Yes, I am eager to close all the other tickets.  However, I want #34552 to be in the develop branch first.
...
```json
{
    "body": "<a id='comment:10'></a>Hm, I think it should know that the valuation is greater than 0.  The valuation of `Set1 * Set0(Four)` is greater than zero, because the valuation of `Set1` is.\n\n`Set2` is not a polynomial (because it is not 'exact'), so `Set2.__call__` is only defined if its argument has valuation at least 1.  Thus we might as well assume that its valuation is at least 1.\n\nI'm not sure yet.",
    "created_at": "2022-09-27T15:24:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12649#issuecomment-182488",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:10'></a>Hm, I think it should know that the valuation is greater than 0.  The valuation of `Set1 * Set0(Four)` is greater than zero, because the valuation of `Set1` is.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12649#issuecomment-182489",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>We actually thought about this situation (I forgot), and introduced a `check` parameter for `__call__`.  Of course, it is not passed by the species code.\n\nI am still not sure what the best solution might be.",
    "created_at": "2022-09-27T16:02:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12649#issuecomment-182490",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:12'></a>We actually thought about this situation (I forgot), and introduced a `check` parameter for `__call__`.  Of course, it is not passed by the species code.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12649#issuecomment-182491",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34274"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12649#event-34275"
}
```
