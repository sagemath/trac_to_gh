...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12231#event-33269"
}
```
...
```json
{
    "body": "I guess the original problem is due to the fact that the optional `database_pari` package isn't installed. The `_pari_trap recursion too deep` error seems to be a different problem which I cannot reproduce. In any case, there is #9640 which vastly improves the PARI error handling.\n\nClosing as invalid unless somebody convinces me that there is still a bug here...",
    "created_at": "2013-11-02T13:50:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12231#issuecomment-142683",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12231#event-33270"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12231#event-33271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12231#issuecomment-142684",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12231#issuecomment-142685",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12231",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12231#event-33272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12231#issuecomment-142686",
    "user": "https://github.com/jdemeyer"
}
```
