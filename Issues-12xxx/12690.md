...
archive/attachments_017050.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "prime_pi_interrupt_error.patch",
    "asset_url": "tarball://root/attachments/ticket12690/prime_pi_interrupt_error.patch",
    "created_at": "2012-03-18T23:08:39Z",
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12690/prime_pi_interrupt_error.patch",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "Attachment [prime_pi_interrupt_error.patch](https://github.com/sagemath/sage/files/ticket12690/prime_pi_interrupt_error.patch) by @ohanar created at 2012-03-18 23:08:39\n\nprime_pi that causes the interrupt error",
    "created_at": "2012-03-18T23:08:39Z",
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12690#issuecomment-143748",
    "user": "https://github.com/ohanar"
}
```

Attachment [prime_pi_interrupt_error.patch](https://github.com/sagemath/sage/files/ticket12690/prime_pi_interrupt_error.patch) by @ohanar created at 2012-03-18 23:08:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12690#issuecomment-143749",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12690#issuecomment-143750",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105237"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "rename": {
        "from": "signal handling doesn't properly handle multithreaded code",
        "to": "Signal handling doesn't properly handle OpenMP code"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105239"
}
```
...
```json
{
    ...
    "milestone": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105240"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12690#issuecomment-143751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12690#issuecomment-143752",
    "user": "https://github.com/jdemeyer"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "dumb_code.patch",
    "asset_url": "tarball://root/attachments/ticket12690/dumb_code.patch",
    "created_at": "2013-11-04T13:19:56Z",
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12690/dumb_code.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12690#issuecomment-143754",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105243"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12690",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12690#event-105244"
}
```
