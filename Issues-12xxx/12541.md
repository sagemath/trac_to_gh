...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103439"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141038",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141039",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103440"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103441"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket12541/trac_12541_remove_isinstance_Sequence_in_span.patch",
    "created_at": "2012-02-19T22:46:43Z",
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12541/trac_12541_remove_isinstance_Sequence_in_span.patch",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "Attachment [trac_12541_remove_isinstance_Sequence_in_span.patch](https://github.com/sagemath/sage/files/ticket12541/trac_12541_remove_isinstance_Sequence_in_span.patch) by @novoselt created at 2012-02-19 22:46:43",
    "created_at": "2012-02-19T22:46:43Z",
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141040",
    "user": "https://github.com/novoselt"
}
```

Attachment [trac_12541_remove_isinstance_Sequence_in_span.patch](https://github.com/sagemath/sage/files/ticket12541/trac_12541_remove_isinstance_Sequence_in_span.patch) by @novoselt created at 2012-02-19 22:46:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141041",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103442"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103443"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103444"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141042",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103446"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141043",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141044",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103448"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103449"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -24,3 +24,7 @@\n TypeError: isinstance() arg 2 must be a class, type, or tuple of classes and types\n ```\n Such a command is likely to be a mistake, but the error message is irrelevant and is triggered by using a function name `Sequence` in `isinstance`. The attached patch removes this test as sequences are instances of lists and are correctly recognized anyway.\n+\n+**Apply:**\n+\n+[attachment:trac_12541_remove_isinstance_Sequence_in_span.patch](https://github.com/sagemath/sage/files/ticket12541/trac_12541_remove_isinstance_Sequence_in_span.patch)\n``````\n",
    "created_at": "2012-02-20T05:50:14Z",
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141045",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141046",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103450"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141047",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141048",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103452"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103453"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141049",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141050",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141051",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141052",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103454"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103455"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141053",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket12541/trac_12541_decrease_span_typechecking.patch",
    "created_at": "2012-03-15T02:16:27Z",
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12541/trac_12541_decrease_span_typechecking.patch",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>\nAttachment [trac_12541_decrease_span_typechecking.patch](https://github.com/sagemath/sage/files/ticket12541/trac_12541_decrease_span_typechecking.patch) by @novoselt created at 2012-03-15 02:16:27\n\nOK, I've rewritten span function a bit to catch more issues and eliminate isinstance. Seems to work fine although I didn't run full tests yet.",
    "created_at": "2012-03-15T02:16:27Z",
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141054",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103456"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103457"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141055",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103458"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103459"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141056",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103460"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141057",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141058",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141059",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141060",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103462"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141061",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141062",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141063",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12541#issuecomment-141064",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12541",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12541#event-103465"
}
```
