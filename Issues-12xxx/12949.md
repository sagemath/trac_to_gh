...
```json
{
    "body": "<a id='comment:29'></a>\nHere is a git branch.\n\nThis ticket has once been positive reviewed..\n\n---\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[6091c3a](http://git.sagemath.org/sage.git/commit/?id=6091c3a468a76ffb25086c184fdd4446c79e291b)|`#12949: generalized Hsu congruence test for arithmetic subgroups`|",
    "created_at": "2014-02-21T12:54:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12949",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[389b342](http://git.sagemath.org/sage.git/commit/?id=389b3423203e1b5c7e363291c6d0d63473c5eb3a)|`trac #12949 minor details`|",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[2789f49](http://git.sagemath.org/sage.git/commit/?id=2789f49c7a915a1e2305e4c89ecfd9346b3e1f53)|`Merge branch 'u/chapoton/12949' of ssh://trac.sagemath.org:22/sage into 12949`|\n|[4820c61](http://git.sagemath.org/sage.git/commit/?id=4820c61b038378aaa7640a8cb4675b52dfcfad57)|`trac #12949 details`|",
...
```json
{
    "body": "<a id='comment:33'></a>\nHello,\n\nI merged with 6.1.rc1 (trivial conflicts). All test pass and documentation builds. I set it back to positive review.\n\nVincent\n\n---\nNew commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[337fc95](http://git.sagemath.org/sage.git/commit/?id=337fc958ba03cfcbc3bd9a1b7b465f3394b65cb3)|`Merge 6.2.rc1 into 12949-odd_subgroups`|",
...
```json
{
    "body": "<a id='comment:40'></a>\nI've uploaded a new version without the time-wasting tests.\n\n(For some reason, this ticket had been linked to a Git branch which \"git trac\" refused to read, so I just spent the entire morning re-applying the changes by hand.)\n\n---\nNew commits:\n|                                                                                                                                          |                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[d8e4dea](http://git.sagemath.org/sage.git/commit/?id=d8e4dea3f863120d621203bc165bb87325674610)|`Trac 12949: better congruence testing`|\n|[a221151](http://git.sagemath.org/sage.git/commit/?id=a2211519edd92e17203f3dcbd133dc467aecd548)|`Trac 12949: fixed ReST formatting errors`|",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[27b7508](http://git.sagemath.org/sage.git/commit/?id=27b7508b4c99f0116fd3d63dfd3b6dd242302049)|`Trac 12949: changes suggested by reviewer`|",
