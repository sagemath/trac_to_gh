...
```json
{
    "body": "<a id='comment:2'></a>This patch should solve the problem.",
    "created_at": "2012-04-01T22:28:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12770",
    "type": "issue_comment",
...
<a id='comment:2'></a>This patch should solve the problem.
...
```json
{
    "body": "<a id='comment:3'></a>Small modification to allow loops in directed graphs.",
...
<a id='comment:3'></a>Small modification to allow loops in directed graphs.
...
<a id='comment:5'></a>> * It would be better if the examples given check something else than the fact that the number of vertices is correct. One can for example count the edges.
> 
> * Maybe remove the plot in the examples, which has not much to do there.
...
<a id='comment:6'></a>* I would rather keep a short examples section, with a very simple example, just to display the syntax.
...
```json
{
    "body": "<a id='comment:9'></a>here it is, sorry.",
...
<a id='comment:9'></a>here it is, sorry.
...
<a id='comment:10'></a>*According to Nicolas Thiery :*
...
<a id='comment:11'></a>Unfortunately your proposal is slower than the implementation of this patch.
...
```json
{
    "body": "<a id='comment:12'></a>ok, I give a positive review. Thanks for your work.",
...
<a id='comment:12'></a>ok, I give a positive review. Thanks for your work.
...
```json
{
    "body": "<a id='comment:13'></a>You are welcome !",
...
<a id='comment:13'></a>You are welcome !
...
<a id='comment:14'></a>Replying to [dcoudert](#comment%3A11):
> Unfortunately your proposal is slower than the implementation of this patch.
...
```json
{
    "body": "<a id='comment:17'></a>This change still needs review.",
    "created_at": "2012-04-17T11:46:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12770",
    "type": "issue_comment",
...
<a id='comment:17'></a>This change still needs review.
...
<a id='comment:18'></a>Replying to [dcoudert](#comment%3A15):
> The point is that using add_edges, we first create a new list of edges, and then iterate this list to add edges to the new graph.
