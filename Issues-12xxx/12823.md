...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156266"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156268"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156269"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156270"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156272"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156273"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156277"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156280"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156283"
}
```
...
```json
{
    "body": "<a id='comment:35'>Comment 35:</a>\nLooks like I goofed when creating the patch. Please apply [first, then [attachment: trac_12823_alternate_removal.patch.gz](https://github.com/sagemath/sage/files/ticket12823/trac_12823_alternate_removal.patch.gz), and finally [attachment: trac_12823-cplex_gurobi.patch.gz](https://github.com/sagemath/sage/files/ticket12823/trac_12823-cplex_gurobi.patch.gz)(https://github.com/sagemath/sage/files/ticket12823/e70ebb830cfa2dfe71d74858e5b21ab4.gz). I have modified the ticket description to reflect this.\n\nI'm actually getting doctest errors on this, so I may upload new patches. But, if you don't get problems after this, that would suggest things are okay. I'm using an older beta, so I'm probably still missing something.",
...
```json
{
    "body": "<a id='comment:36'>Comment 36:</a>\nNo, I can't get [attachment: trac_12823-cplex_gurobi.patch.gz](https://github.com/sagemath/sage/files/ticket12823/trac_12823-cplex_gurobi.patch.gz) to work, either. Alright, time to rework this.",
...
```json
{
    "body": "<a id='comment:37'>Comment 37:</a>\nThe new patch should incorporate all the changes. It passes doctests on 5.0.beta8. It **might** depend on #12220; I'm not sure. The problems I encountered before were due to my having messed up my queue; I had popped too much, and [attachment: trac_12823_alternate_removal.patch.gz](https://github.com/sagemath/sage/files/ticket12823/trac_12823_alternate_removal.patch.gz) included material from #12736. Please review...",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156287"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156288"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12823#issuecomment-146558",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156297"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12823",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12823#event-156299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12823#issuecomment-146559",
    "user": "https://github.com/jdemeyer"
}
```
