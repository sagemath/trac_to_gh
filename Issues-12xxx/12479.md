...
```json
{
    "body": "<a id='comment:1'></a>See also #11021.",
    "created_at": "2012-02-09T16:21:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178546",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>See also #11021.
...
```json
{
    "body": "<a id='comment:2'></a>Thanks for the link.  I think that ticket is now too bitrotted.  We should consider the ideas from that ticket and apply them (better in separate tickets instead of one \"fix everything\" ticket).",
    "created_at": "2012-02-14T09:25:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178547",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>Thanks for the link.  I think that ticket is now too bitrotted.  We should consider the ideas from that ticket and apply them (better in separate tickets instead of one "fix everything" ticket).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178548",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178549",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178550",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>What is the file `SAGE.txt` referred to in this script? Should it be `SPKG.txt` instead? For example:\n\n```\n        echo >&2 \"No file SAGE.txt in $PKG_NAME\"\n```\n\nBy the way, #12579 also modifies sage-spkg; you might take a look at that ticket if you have time.\n\nWhat do you think of replacing `./spkg-check` with `time ./spkg-check`?",
    "created_at": "2012-02-25T22:50:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178551",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>What is the file `SAGE.txt` referred to in this script? Should it be `SPKG.txt` instead? For example:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178552",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178553",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178554",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>John, could you please review this?",
    "created_at": "2012-02-27T15:01:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178555",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>John, could you please review this?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178556",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178557",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>This is pretty minor, but if a package has been installed already, for example, then with the patch, `sage -i pkg` still creates `SAGE_BUILD_DIR`, then quits without doing anything else. It would be nicer if this directory were not created until needed.\n\nI will look at this more later.",
    "created_at": "2012-02-27T23:51:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178558",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>This is pretty minor, but if a package has been installed already, for example, then with the patch, `sage -i pkg` still creates `SAGE_BUILD_DIR`, then quits without doing anything else. It would be nicer if this directory were not created until needed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178560",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178561",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178562",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178563",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178564",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>John, new patch needs review.  I also made some changes to `spkg/bin/sage` in the calls to `sage-spkg`.  I think I took care of all your comments, except for `-info` which I moved to #12606.\n\nThis version allows multiple options, so you can do something silly like\n\n```\n./sage -i -f -s -f -f -m spkg/optional/mpc-0.9.spkg\n```",
    "created_at": "2012-02-28T10:10:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178565",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>John, new patch needs review.  I also made some changes to `spkg/bin/sage` in the calls to `sage-spkg`.  I think I took care of all your comments, except for `-info` which I moved to #12606.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178566",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178568",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178569",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178570",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178571",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178572",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Fixed, needs review.\n\nI like your idea of a SPKG_CHECK=yes command line option, how about -c for check?  But not on this ticket.",
    "created_at": "2012-02-28T22:38:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178573",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>Fixed, needs review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178574",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178575",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Okay, this looks good.\n\n> I like your idea of a SPKG_CHECK=yes command line option, how about -c for check?  But not on this ticket.\n\n\nSee #12613.",
    "created_at": "2012-02-29T21:43:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178576",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:20'></a>Okay, this looks good.
...
```json
{
    "body": "<a id='comment:22'></a>I'm not sure. Some spkgs (like zn_poly) run a small batch of tests always, and then run much longer tests if `SAGE_CHECK` is set. Anything on this ticket or related ones won't affect tests which are run by the `spkg-install` script; these just affect whether the `spkg-check` script is run.",
    "created_at": "2012-02-29T22:37:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178578",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:22'></a>I'm not sure. Some spkgs (like zn_poly) run a small batch of tests always, and then run much longer tests if `SAGE_CHECK` is set. Anything on this ticket or related ones won't affect tests which are run by the `spkg-install` script; these just affect whether the `spkg-check` script is run.
...
```json
{
    "body": "<a id='comment:23'></a>I guess I was referring to `echo \"Package $PKG_NAME has no test suite.\" `, which wouldn't strictly be true if there was a full test suite run that didn't happen to be in an spkg-check file.   Well, not so important.",
    "created_at": "2012-03-01T02:15:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178579",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:23'></a>I guess I was referring to `echo "Package $PKG_NAME has no test suite." `, which wouldn't strictly be true if there was a full test suite run that didn't happen to be in an spkg-check file.   Well, not so important.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178580",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12479#event-33628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178581",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178582",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12479#issuecomment-178583",
    "user": "https://github.com/jdemeyer"
}
```
