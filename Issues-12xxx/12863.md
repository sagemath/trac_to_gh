...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187737",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [test_roots_3.sage](tarball://root/attachments/some-uuid/ticket12863/test_roots_3.sage) by @vbraun created at 2012-04-20 23:20:25",
    "created_at": "2012-04-20T23:20:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187738",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:1'></a>Attachment [test_roots_3.sage](tarball://root/attachments/some-uuid/ticket12863/test_roots_3.sage) by @vbraun created at 2012-04-20 23:20:25
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187739",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187740",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I've isolated a test case and reported the bug upstream at\n\nhttp://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1309",
    "created_at": "2012-04-28T20:29:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187741",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:2'></a>I've isolated a test case and reported the bug upstream at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187742",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187743",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187744",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>It turns out that this was a floating point bug in pari's `sqrt()`. For the record:\n\nFixed in branches master (testing, commit d1eb887b21) and pari-2.5 (stable,\ncommit 1550af281).",
    "created_at": "2012-05-02T13:47:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187745",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:4'></a>It turns out that this was a floating point bug in pari's `sqrt()`. For the record:
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12863#event-35045"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12863#event-35046"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12863#event-35047"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187746",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187747",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187748",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187749",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>This was fixed in PARI 2.5 (see[comment:4](#comment%3A4)), which has been in Sage for some time.",
    "created_at": "2013-10-30T16:34:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187750",
    "user": "https://github.com/pjbruin"
}
```

<a id='comment:7'></a>This was fixed in PARI 2.5 (see[comment:4](#comment%3A4)), which has been in Sage for some time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12863#issuecomment-187751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12863",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12863#event-35048"
}
```
