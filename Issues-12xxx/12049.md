# Issue 12049: Failures in gp pexpect interface with specific length of $DOT_SAGE using a "screen" terminal
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12049#event-32564"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12049#event-32565"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12049#event-32566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12049",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12049#event-32567"
}
```
