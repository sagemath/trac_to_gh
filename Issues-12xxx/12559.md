...
```json
{
    "body": "Changed assignee from **@sagetrac-mvngu** to **@sagetrac-Kehengsite**",
...
Changed assignee from **@sagetrac-mvngu** to **@sagetrac-Kehengsite**
...
```json
{
    ...
    "milestone_title": "sage-7.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12559#event-157581"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12559#event-157582"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12559#event-157583"
}
```
