...
```json
{
    "body": "<a id='comment:7'></a>Replying to [Kehengsite](#comment%3A6):\n\nlatex->rst [converter http://johnmacfarlane.net/pandoc/]",
...
<a id='comment:7'></a>Replying to [Kehengsite](#comment%3A6):
...
<a id='comment:9'></a>Replying to [Kehengsite](#comment%3A8):
> Waiting to be converted to rst
...
<a id='comment:46'></a>I'm having *exactly* the same pdf build problem Dima had in the now-vanquished[comment:27](#comment%3A27).    I do have `xelatex` and
