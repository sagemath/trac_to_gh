...
```json
{
    "body": "<a id='comment:2'></a>Works for me: applies cleanly against 5.1.beta0 and passes the tests afterwards.",
...
<a id='comment:2'></a>Works for me: applies cleanly against 5.1.beta0 and passes the tests afterwards.
...
```json
{
    "body": "<a id='comment:4'></a>I just went ahead and made the double underscore into a single one.  Positive review?",
...
<a id='comment:4'></a>I just went ahead and made the double underscore into a single one.  Positive review?
