...
```json
{
    "body": "<a id='comment:1'></a>We should remove `NUM_THREADS` from the top-level `Makefile`.",
    "created_at": "2011-11-14T11:50:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166212",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>We should remove `NUM_THREADS` from the top-level `Makefile`.
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,3 +6,7 @@\n \n In #6495, we should implement the same behavior for doc building.\n \n+**Apply**:\n+1. [attachment:12016-root.v2.patch] to the `SAGE_ROOT` repository.\n+2. [attachment:trac_12016-scripts.patch] to the `SCRIPTS` repository.\n+3. [attachment:12016-sage.v2.patch] to the Sage library.\n``````\n",
    "created_at": "2011-11-14T12:37:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166213",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166214",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166215",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,5 +10,5 @@\n \n **Apply**:\n 1. [attachment:12016-root.v2.patch] to the `SAGE_ROOT` repository.\n-2. [attachment:trac_12016-scripts.patch] to the `SCRIPTS` repository.\n+2. [attachment:12016-scripts.v2.patch] to the `SCRIPTS` repository.\n 3. [attachment:12016-sage.v2.patch] to the Sage library.\n``````\n",
    "created_at": "2011-11-14T13:35:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166216",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166217",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166218",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166220",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>For something like `make -j16 ptestlong`, how do we recover the number 16?  If I execute this command (with `MAKE` unset), I see\n\n```\nMAKEFLAGS= --jobserver-fds=3,4 -j\nMFLAGS=- --jobserver-fds=3,4 -j\n```\nbut I don't see \"16\" anywhere in the listing of the environment variables.",
    "created_at": "2011-11-14T21:17:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166221",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:8'></a>For something like `make -j16 ptestlong`, how do we recover the number 16?  If I execute this command (with `MAKE` unset), I see
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166222",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166223",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166224",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166225",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,16 +4,12 @@\n \n - running `make ptestlong` or `sage -tp 0 <files>` will doctest in parallel using 16 threads.  If the `-j` flag in `MAKE` is not set, then determine the number of threads as before: `min(8, cpu_count())`.\n \n-- **TODO**: running `./sage -b` will build the Sage library using 16 threads. If the `-j` flag in `MAKE` is not set, then use only 1 thread.\n+- running `./sage -b` will build the Sage library using 16 threads. If the `-j` flag in `MAKE` is not set, then use only 1 thread.\n \n In #6495, we should implement the same behavior for doc building.\n \n-**TODO:** We should also support:\n-- `make -j16 ptestlong` (as opposed to `MAKE=\"make -j16\" make ptestlong`).  Use `MAKEFLAGS`.\n-- `make -j` (unlimited number of jobs, say set to 9999 if we really need a number).\n-- `make -j37 -j1` (last option takes precedence).\n+**Apply**:\n+1. [attachment:trac_12016-root.v2.patch] to the `SAGE_ROOT` repository.\n+2. [attachment:trac_12016-scripts.v2.patch] to the `SCRIPTS` repository.\n+3. [attachment:trac_12016-sage.v2.patch] to the Sage library.\n \n-**Apply**:\n-1. [attachment:12016-root.v2.patch] to the `SAGE_ROOT` repository.\n-2. [attachment:12016-scripts.v2.patch] to the `SCRIPTS` repository.\n-3. [attachment:12016-sage.v2.patch] to the Sage library.\n``````\n",
    "created_at": "2011-11-16T04:23:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166226",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166229",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166230",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166231",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166232",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166234",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,7 +9,7 @@\n In #6495, we should implement the same behavior for doc building.\n \n **Apply**:\n-1. [attachment:trac_12016-root.v2.patch] to the `SAGE_ROOT` repository.\n-2. [attachment:trac_12016-scripts.v2.patch] to the `SCRIPTS` repository.\n-3. [attachment:trac_12016-sage.v2.patch] to the Sage library.\n+1. [attachment:12016-root.patch] to the `SAGE_ROOT` repository.\n+2. [attachment:12016-scripts.patch] to the `SCRIPTS` repository.\n+3. [attachment:12016-sage.patch] to the Sage library.\n \n``````\n",
    "created_at": "2011-11-29T10:15:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166235",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>The essence of the patch should be there.  I'm not claiming it works, I still need to test many things.",
    "created_at": "2011-11-29T10:15:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166236",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>The essence of the patch should be there.  I'm not claiming it works, I still need to test many things.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166237",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166238",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166239",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,8 +10,9 @@\n \n **Apply**:\n 1. [attachment:12016-root.patch] to the `SAGE_ROOT` repository.\n-2. [attachment:12016-scripts.patch] to the `SCRIPTS` repository.\n-3. [attachment:12016-sage.patch] to the Sage library.\n+2. [attachment:12016-base.patch] to `spkg/base`.\n+3. [attachment:12016-scripts.patch] to the `SCRIPTS` repository.\n+4. [attachment:12016-sage.patch] to the Sage library.\n \n **Notes**:\n With the patches applied, building spkgs in parallel works well, except for a \"jobserver unavailable\" warning in:\n``````\n",
    "created_at": "2011-11-29T14:52:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166240",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>In `spkg/standard/deps`, why prefix most of the rules with \"+\"?",
    "created_at": "2011-11-29T18:16:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166241",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:21'></a>In `spkg/standard/deps`, why prefix most of the rules with "+"?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166242",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166243",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166244",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166246",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:29'></a>Thanks for the feedback, these should be easy fixes.",
    "created_at": "2011-12-07T22:34:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166250",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:29'></a>Thanks for the feedback, these should be easy fixes.
...
```json
{
    "body": "<a id='comment:31'></a>Replying to [jhpalmieri](#comment%3A30):\n> Maybe we could read the argument for `-l` for a cap on the threads for doctesting?\n\n\nShould be possible, in `sage-num-threads.py`.",
    "created_at": "2011-12-08T11:28:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166252",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>Replying to [jhpalmieri](#comment%3A30):
> Maybe we could read the argument for `-l` for a cap on the threads for doctesting?
...
```json
{
    "body": "<a id='comment:32'></a>Since ``execute_list_of_commands_in_serial`` is essentially a special case of ``execute_list_of_commands_in_parallel``, I see no reason to keep the former.",
    "created_at": "2011-12-08T17:17:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166253",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:32'></a>Since ``execute_list_of_commands_in_serial`` is essentially a special case of ``execute_list_of_commands_in_parallel``, I see no reason to keep the former.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166254",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:33'></a>New patch up, implements support for \"-l\" option to make, fixes and simplifies `setup.py`.",
    "created_at": "2011-12-08T17:24:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166255",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:33'></a>New patch up, implements support for "-l" option to make, fixes and simplifies `setup.py`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166257",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166258",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166259",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166260",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166261",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Replying to [jhpalmieri](#comment%3A34):\n>  - singular on sage.math fails all of the time, I think, with `MAKE='make -j -l30'`. [Here's a log.](http://sage.math.washington.edu/home/palmieri/misc/singular-3-1-3-3.p1.log)\n\n\nWell, singular is in the list of fishy packages, see the ticket description.",
    "created_at": "2011-12-09T20:26:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166262",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:37'></a>Replying to [jhpalmieri](#comment%3A34):
>  - singular on sage.math fails all of the time, I think, with `MAKE='make -j -l30'`. [Here's a log.](http://sage.math.washington.edu/home/palmieri/misc/singular-3-1-3-3.p1.log)
...
```json
{
    "body": "<a id='comment:38'></a>Just for fun, I modified `deps` so singular would build all by itself in the build process (I made it depend on linbox and scipy, so it was the last package to be built before the sage package).  Then it built fine using `make -j -l30`.",
    "created_at": "2011-12-09T21:30:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166263",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:38'></a>Just for fun, I modified `deps` so singular would build all by itself in the build process (I made it depend on linbox and scipy, so it was the last package to be built before the sage package).  Then it built fine using `make -j -l30`.
...
```json
{
    "body": "<a id='comment:39'></a>I think it is truly a coincidence that \"make -j -lN\" fails.  I managed to make singular fail with just \"make -jN\", hopefully fixed by #12138.",
    "created_at": "2011-12-09T23:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166264",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:39'></a>I think it is truly a coincidence that "make -j -lN" fails.  I managed to make singular fail with just "make -jN", hopefully fixed by #12138.
...
```json
{
    "body": "<a id='comment:41'></a>When testing with `sage -f`, the proper way to test is using\n\n```\nMAKEFLAGS=\"j50\" ./sage -f ...\n```",
    "created_at": "2011-12-09T23:22:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166266",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:41'></a>When testing with `sage -f`, the proper way to test is using
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166267",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166270",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166271",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166272",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:46'></a>Attachment [12016-base.patch](tarball://root/attachments/some-uuid/ticket12016/12016-base.patch) by @jdemeyer created at 2011-12-10 11:14:21",
    "created_at": "2011-12-10T11:14:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166273",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:46'></a>Attachment [12016-base.patch](tarball://root/attachments/some-uuid/ticket12016/12016-base.patch) by @jdemeyer created at 2011-12-10 11:14:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166274",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166275",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166276",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:49'></a>I'm happy with this except for a few small changes I want to make in sage-num-threads.py: we should use subprocess instead of popen, since popen has been deprecated.  Also, we should catch errors if `sysctl` fails to run -- it's not present on all platforms.  Finally, we might as well search for `max-load` in addition to `load-average`.  See the referee patch.  If you're happy with that, the whole thing can get a positive review.",
    "created_at": "2011-12-10T22:36:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166277",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:49'></a>I'm happy with this except for a few small changes I want to make in sage-num-threads.py: we should use subprocess instead of popen, since popen has been deprecated.  Also, we should catch errors if `sysctl` fails to run -- it's not present on all platforms.  Finally, we might as well search for `max-load` in addition to `load-average`.  See the referee patch.  If you're happy with that, the whole thing can get a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166278",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166279",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166280",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166281",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166282",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166283",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12016#issuecomment-166284",
    "user": "https://github.com/jdemeyer"
}
```
