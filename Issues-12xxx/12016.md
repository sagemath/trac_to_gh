...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148653"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148656"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -6,3 +6,7 @@\n \n In #6495, we should implement the same behavior for doc building.\n \n+**Apply**:\n+1. [attachment: 12016-root.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-root.v2.patch.gz) to the `SAGE_ROOT` repository.\n+2. [attachment: trac_12016-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-scripts.patch.gz) to the `SCRIPTS` repository.\n+3. [attachment: 12016-sage.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-sage.v2.patch.gz) to the Sage library.\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,5 +10,5 @@\n \n **Apply**:\n 1. [attachment: 12016-root.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-root.v2.patch.gz) to the `SAGE_ROOT` repository.\n-2. [attachment: trac_12016-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-scripts.patch.gz) to the `SCRIPTS` repository.\n+2. [attachment: 12016-scripts.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-scripts.v2.patch.gz) to the `SCRIPTS` repository.\n 3. [attachment: 12016-sage.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-sage.v2.patch.gz) to the Sage library.\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148657"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -4,16 +4,12 @@\n \n - running `make ptestlong` or `sage -tp 0 <files>` will doctest in parallel using 16 threads.  If the `-j` flag in `MAKE` is not set, then determine the number of threads as before: `min(8, cpu_count())`.\n \n-- **TODO**: running `./sage -b` will build the Sage library using 16 threads. If the `-j` flag in `MAKE` is not set, then use only 1 thread.\n+- running `./sage -b` will build the Sage library using 16 threads. If the `-j` flag in `MAKE` is not set, then use only 1 thread.\n \n In #6495, we should implement the same behavior for doc building.\n \n-**TODO:** We should also support:\n-- `make -j16 ptestlong` (as opposed to `MAKE=\"make -j16\" make ptestlong`).  Use `MAKEFLAGS`.\n-- `make -j` (unlimited number of jobs, say set to 9999 if we really need a number).\n-- `make -j37 -j1` (last option takes precedence).\n+**Apply**:\n+1. [attachment: trac_12016-root.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-root.v2.patch.gz) to the `SAGE_ROOT` repository.\n+2. [attachment: trac_12016-scripts.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-scripts.v2.patch.gz) to the `SCRIPTS` repository.\n+3. [attachment: trac_12016-sage.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-sage.v2.patch.gz) to the Sage library.\n \n-**Apply**:\n-1. [attachment: 12016-root.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-root.v2.patch.gz) to the `SAGE_ROOT` repository.\n-2. [attachment: 12016-scripts.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-scripts.v2.patch.gz) to the `SCRIPTS` repository.\n-3. [attachment: 12016-sage.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-sage.v2.patch.gz) to the Sage library.\n``````\n",
    "created_at": "2011-11-16T04:23:32Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148658"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148661"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,7 +9,7 @@\n In #6495, we should implement the same behavior for doc building.\n \n **Apply**:\n-1. [attachment: trac_12016-root.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-root.v2.patch.gz) to the `SAGE_ROOT` repository.\n-2. [attachment: trac_12016-scripts.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-scripts.v2.patch.gz) to the `SCRIPTS` repository.\n-3. [attachment: trac_12016-sage.v2.patch.gz](https://github.com/sagemath/sage/files/ticket12016/trac_12016-sage.v2.patch.gz) to the Sage library.\n+1. [attachment: 12016-root.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-root.patch.gz) to the `SAGE_ROOT` repository.\n+2. [attachment: 12016-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-scripts.patch.gz) to the `SCRIPTS` repository.\n+3. [attachment: 12016-sage.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-sage.patch.gz) to the Sage library.\n \n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -10,8 +10,9 @@\n \n **Apply**:\n 1. [attachment: 12016-root.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-root.patch.gz) to the `SAGE_ROOT` repository.\n-2. [attachment: 12016-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-scripts.patch.gz) to the `SCRIPTS` repository.\n-3. [attachment: 12016-sage.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-sage.patch.gz) to the Sage library.\n+2. [attachment: 12016-base.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-base.patch.gz) to `spkg/base`.\n+3. [attachment: 12016-scripts.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-scripts.patch.gz) to the `SCRIPTS` repository.\n+4. [attachment: 12016-sage.patch.gz](https://github.com/sagemath/sage/files/ticket12016/12016-sage.patch.gz) to the Sage library.\n \n **Notes**:\n With the patches applied, building spkgs in parallel works well, except for a \"jobserver unavailable\" warning in:\n``````\n",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129966",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129967",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129968",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129969",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129970",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148663"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129971",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129972",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129973",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129974",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129975",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129976",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129977",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129978",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129979",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129980",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129981",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129982",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129983",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129984",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129985",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129986",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129987",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129988",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129989",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129990",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148664"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129991",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129992",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12016#event-148667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12016#issuecomment-129993",
    "user": "https://github.com/jdemeyer"
}
```
