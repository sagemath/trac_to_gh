...
<a id='comment:7'></a>I would be very much more disturbed if the output was False (it is True, by the way).  I think this is entirely consistent with the good output:
