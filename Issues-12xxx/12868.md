...
```json
{
    "body": "<a id='comment:1'></a>I'm not yet sure whether that's really a bug, or just confusing.  (If I understand correctly, the presence of an `__init__.py` file was unintentional in your case.)\n\nThe behaviour should probably also depend on whether some directory of the path to the attached file is in `PYTHONPATH`.  Haven't yet looked at the code though.\n\n\n\n\n[W.r.t. the component:  \"User interface\" seems a candidate as well.]",
    "created_at": "2012-04-22T14:44:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187847",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:1'></a>I'm not yet sure whether that's really a bug, or just confusing.  (If I understand correctly, the presence of an `__init__.py` file was unintentional in your case.)
...
```json
{
    "body": "<a id='comment:3'></a>Looks like distutils were responsible for that behaviour...",
    "created_at": "2012-04-22T15:35:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187849",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:3'></a>Looks like distutils were responsible for that behaviour...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187851",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187852",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187853",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187854",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187855",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187856",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187857",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187860",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I'll attach a proper patch after further testing.",
    "created_at": "2012-04-22T21:25:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12868#issuecomment-187862",
    "user": "https://github.com/nexttime"
}
```

<a id='comment:16'></a>I'll attach a proper patch after further testing.
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12868#event-35089"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12868#event-35090"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12868#event-35091"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12868#event-35092"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12868#event-35093"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12868#event-35094"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12868#event-35095"
}
```
