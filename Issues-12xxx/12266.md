...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12266#event-152655"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12266#event-152656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12266#event-152657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12266#issuecomment-134982",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12266#issuecomment-134983",
    "user": "https://github.com/jdemeyer"
}
```
