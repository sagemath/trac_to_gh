...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12881#event-162913"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12881#event-162914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12881#event-162915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12881#issuecomment-147919",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12881#issuecomment-147920",
    "user": "https://github.com/kcrisman"
}
```
