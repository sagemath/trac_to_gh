...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149009"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149015"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12368#issuecomment-136981",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149016"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12368",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-149017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12368#issuecomment-136982",
    "user": "https://github.com/jdemeyer"
}
```
