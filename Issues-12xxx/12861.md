...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187707",
    "user": "https://github.com/dansme"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Second patch is the right one, and applies on sage-5.0.beta13 after #12860. Ignore the first patch (I forgot to check \"replace patch\").",
    "created_at": "2012-04-20T10:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187708",
    "user": "https://github.com/dansme"
}
```

<a id='comment:2'></a>Second patch is the right one, and applies on sage-5.0.beta13 after #12860. Ignore the first patch (I forgot to check "replace patch").
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187709",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187711",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Finally, I managed to reliably reproduce the error but only when running `make ptestlong'.\nCalling either\n\n```\nsage -t  --long -force_lib devel/sage/sage/algebras/quatalg/\n```\nor\n\n```\nsage -t  --long devel/sage/sage/algebras/quatalg/\n```\ndirectly all tests pass. I'll try to figure out what's going on here, but this seems to be quite strange.",
    "created_at": "2012-07-26T13:46:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187713",
    "user": "https://github.com/dansme"
}
```

<a id='comment:6'></a>Finally, I managed to reliably reproduce the error but only when running `make ptestlong'.
Calling either
...
```json
{
    "body": "<a id='comment:7'></a>That's interesting.  I applied both patches to a clean Sage-5.2.rc0 install on mod.math.washington.edu, the tests ran fine.   For me, the tests have only failed on my mac, but with both Sage-5.1 and Sage-5.2.rc0.\n\nFor the line discrepancy, I'd been debugging and had some print statements in a few places.",
    "created_at": "2012-07-26T13:57:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187714",
    "user": "https://github.com/adeines"
}
```

<a id='comment:7'></a>That's interesting.  I applied both patches to a clean Sage-5.2.rc0 install on mod.math.washington.edu, the tests ran fine.   For me, the tests have only failed on my mac, but with both Sage-5.1 and Sage-5.2.rc0.
...
```json
{
    "body": "<a id='comment:8'></a>Strange. But at least it always seems to die on the subtraction `min_v - valuation(p, 2)`, so I suppose I must in fact be doing something wrong there (but so far I don't see the problem).",
    "created_at": "2012-07-26T14:03:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187715",
    "user": "https://github.com/dansme"
}
```

<a id='comment:8'></a>Strange. But at least it always seems to die on the subtraction `min_v - valuation(p, 2)`, so I suppose I must in fact be doing something wrong there (but so far I don't see the problem).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187717",
    "user": "https://github.com/dansme"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187718",
    "user": "https://github.com/dansme"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187719",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187720",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I would love to see quaternion algebras over number fields implemented, but don't have any concrete plans to do it anytime soon. So feel free to work on it.",
    "created_at": "2012-07-27T15:31:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187721",
    "user": "https://github.com/dansme"
}
```

<a id='comment:12'></a>I would love to see quaternion algebras over number fields implemented, but don't have any concrete plans to do it anytime soon. So feel free to work on it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187722",
...
```json
{
    "body": "<a id='comment:14'></a>Please fill in your real name as Reviewer.",
    "created_at": "2012-07-27T20:44:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187723",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>Please fill in your real name as Reviewer.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187724",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187725",
    "user": "https://github.com/dansme"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187726",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12861#event-35043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12861#issuecomment-187727",
    "user": "https://github.com/jdemeyer"
}
```
