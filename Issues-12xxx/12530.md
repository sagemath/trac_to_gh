...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179606",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179607",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Your `version_regexp` won't match strings like \"Sage Version 5.0\" (no alpha, beta, or rc). Is that an issue?",
    "created_at": "2012-02-17T18:10:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179608",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>Your `version_regexp` won't match strings like "Sage Version 5.0" (no alpha, beta, or rc). Is that an issue?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179609",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179610",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179611",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Oops, the guard should not have matched the regexp in the first place; I had forgotten the \"$\" at the end of it for an exact match. The updated patch still complains as you suggest, since this is likely to be a typicall typo.\n\nI used the occasion to run pyflakes and clean up the imports.",
    "created_at": "2012-02-19T11:01:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179613",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:6'></a>Oops, the guard should not have matched the regexp in the first place; I had forgotten the "$" at the end of it for an exact match. The updated patch still complains as you suggest, since this is likely to be a typicall typo.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179614",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179615",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179616",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179617",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179618",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>The same, nicer looking:\n\n```diff\ndiff --git a/sage-combinat b/sage-combinat\n--- a/sage-combinat\n+++ b/sage-combinat\n@@ -5,6 +5,7 @@ import re\n from optparse import OptionParser\n from sys import stderr\n from subprocess import Popen, PIPE\n+from warnings import warn\n \n if \"SAGE_ROOT\" in os.environ:\n     sage = os.environ[\"SAGE_ROOT\"]+\"/sage\"\n@@ -294,7 +295,11 @@ def qselect_backward_compatibility_patch\n         if not re.match(version_regexp+\"$\", guard):\n             if  re.match(version_regexp, guard):\n                 # Catch erroneous guards like 4_3_3:\n-                error(\"Invalid version guard in the mercurial queue: %s\"%guard)\n+                message = \"Invalid version guard in the mercurial queue: %s\"%guard\n+                if options.force:\n+                    warn(message)\n+                else:\n+                    error(message)\n             return False\n         if cmp_sage_versions(guard, sage_version) > 0:\n             info(\"Keep backward compatibility patches for sage \"+re.sub(\"_\",\".\",guard))\n```",
    "created_at": "2012-02-20T14:52:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179620",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:12'></a>The same, nicer looking:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179621",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179622",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>The patch is working as expected (at least for me) and is needed for the sage-combinat queue to applied on the various 5.0 sage. Therefore I put a positive review and set it as a blocker.\n\nFlorent",
    "created_at": "2012-02-20T14:56:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179623",
    "user": "https://github.com/hivert"
}
```

<a id='comment:13'></a>The patch is working as expected (at least for me) and is needed for the sage-combinat queue to applied on the various 5.0 sage. Therefore I put a positive review and set it as a blocker.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12530#event-33786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12530#issuecomment-179625",
    "user": "https://github.com/jdemeyer"
}
```
