...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168272",
...
```json
{
    "body": "<a id='comment:3'></a>See #9167 for an example of how to use cygcheck.  I'd do a cygcheck on {{{sage-4.7.2/local/lib/python2.6/site- \npackages/sage/ext/c_lib.dll}}}.  Or wherever that file is \"supposed\" to be.   This may point out some other missing file, perhaps something we need to add to Cygwin we didn't know about.",
    "created_at": "2011-12-02T03:07:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168274",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>See #9167 for an example of how to use cygcheck.  I'd do a cygcheck on {{{sage-4.7.2/local/lib/python2.6/site- 
packages/sage/ext/c_lib.dll}}}.  Or wherever that file is "supposed" to be.   This may point out some other missing file, perhaps something we need to add to Cygwin we didn't know about.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168276",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>> cygcheck: track_down: could not find libntl.dll And on c_lib.dll cygcheck also reports that it can't find libntl.dll \n> Indeed, there is no libntl.dll. There is an .dll.a file, despite the fact that it's a dynamic library. Some misnaming has occurred. Renaming local/lib/libntl.dll.a to local/lib/libntl.dll fixes this particular error.\n\n\nSweet! Because that's #11635. I don't know if it has to be upgraded or not, but that's good news.",
    "created_at": "2011-12-02T13:21:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168278",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>> cygcheck: track_down: could not find libntl.dll And on c_lib.dll cygcheck also reports that it can't find libntl.dll 
> Indeed, there is no libntl.dll. There is an .dll.a file, despite the fact that it's a dynamic library. Some misnaming has occurred. Renaming local/lib/libntl.dll.a to local/lib/libntl.dll fixes this particular error.
...
```json
{
    "body": "<a id='comment:8'></a>> and that's where it silently dies. Any clues?\n\nI use\n\n```\n./sage -gdb \n```\nfor this, at least I think that's the syntax.",
    "created_at": "2011-12-02T13:48:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168279",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>> and that's where it silently dies. Any clues?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168280",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168282",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12104#event-32163"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168283",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168284",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168285",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168286",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12104#event-32164"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12104#issuecomment-168287",
    "user": "https://github.com/jdemeyer"
}
```
