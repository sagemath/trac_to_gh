...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12946#event-163973"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12946#event-163974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12946#event-163975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12946#issuecomment-149007",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12946#issuecomment-149008",
    "user": "https://github.com/jdemeyer"
}
```
