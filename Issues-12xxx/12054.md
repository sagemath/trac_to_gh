...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149193"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12054#issuecomment-130514",
    "user": "https://github.com/sagetrac-emil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12054#issuecomment-130515",
    "user": "https://github.com/sagetrac-emil"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149198"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149199"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12054",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12054#event-149205"
}
```
