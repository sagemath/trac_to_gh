...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143814",
    "user": "https://trac.sagemath.org/admin/accounts/users/emil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143815",
    "user": "https://trac.sagemath.org/admin/accounts/users/emil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143816",
    "user": "https://trac.sagemath.org/admin/accounts/users/emil"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I set Proiority to \"major\", because it is a crash. But if this is wrong please just correct that. I found no info about what is a minor or major bug yet.",
    "created_at": "2011-11-19T10:48:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143817",
    "user": "https://trac.sagemath.org/admin/accounts/users/emil"
}
```

<a id='comment:4'></a>I set Proiority to "major", because it is a crash. But if this is wrong please just correct that. I found no info about what is a minor or major bug yet.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143818",
...
```json
{
    "body": "<a id='comment:5'></a>Well, this code has been tested for a while now, so it has probably been fixed by one of the many bugfixes in the LP code `^^;`\n\nNathann",
    "created_at": "2013-04-20T21:26:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143819",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:5'></a>Well, this code has been tested for a while now, so it has probably been fixed by one of the many bugfixes in the LP code `^^;`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143820",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143821",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12054#issuecomment-143822",
