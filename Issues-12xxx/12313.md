...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12313-rebase_11599.patch",
    "asset_url": "tarball://root/attachments/ticket12313/trac_12313-rebase_11599.patch",
    "created_at": "2012-03-27T14:34:42Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12313/trac_12313-rebase_11599.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "**Attachment:** [trac_12313-cparent-rebase_5.0.beta10.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-cparent-rebase_5.0.beta10.patch)\n\nAdd a cdef'ed reference to the parent in each polynomial; rebased on top of sage-5.0.beta10",
    "created_at": "2012-03-28T13:45:28Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
archive/attachments_017090.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_017091.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12313-mono_dict+modulo.patch",
    "asset_url": "tarball://root/attachments/ticket12313/3936572603ddffeecf3f3325a3039024.patch",
    "created_at": "2012-04-11T14:41:42Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12313/3936572603ddffeecf3f3325a3039024.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
archive/attachments_017092.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12313-mono_dict+modulo.patch](https://github.com/sagemath/sage/files/ticket12313/3936572603ddffeecf3f3325a3039024.patch)\n\n**Attachment:** [trac_12313-reviewer+modulo.patch](https://github.com/sagemath/sage/files/ticket12313/ab768f00eda17ab8a820a6e39f2d0480.patch)\n\nReviewer patch; added doc, some formatting changes, problematic test",
    "created_at": "2012-04-11T14:41:42Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
archive/attachments_017093.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_017094.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12313-mono_dict-take2.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-mono_dict-take2.patch)",
    "created_at": "2012-04-12T13:54:24Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
archive/attachments_017095.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12313-rebase_11599.2.patch",
    "asset_url": "tarball://root/attachments/ticket12313/trac_12313-rebase_11599.2.patch",
    "created_at": "2012-04-12T13:55:20Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12313/trac_12313-rebase_11599.2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
archive/attachments_017096.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
**Attachment:** [trac_12313-rebase_11599.2.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-rebase_11599.2.patch)
...
archive/attachments_017097.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12313-cparent-take2.patch",
    "asset_url": "tarball://root/attachments/ticket12313/trac_12313-cparent-take2.patch",
    "created_at": "2012-04-12T13:56:52Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12313/trac_12313-cparent-take2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
archive/attachments_017098.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12313-cparent-take2.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-cparent-take2.patch)\n\n**Attachment:** [trac_12313-reviewer-take2.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-reviewer-take2.patch)",
    "created_at": "2012-04-12T13:56:52Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
archive/attachments_017099.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12313-size_t-take2.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-size_t-take2.patch)",
    "created_at": "2012-04-12T13:57:07Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
archive/attachments_017100.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_017101.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_017102.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [MonoDictNoRefCache.patch](https://github.com/sagemath/sage/files/ticket12313/MonoDictNoRefCache.patch)\n\nExample implementation of a MonoDict? storing the weakrefs in the buckets as well",
    "created_at": "2012-08-21T23:01:48Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
**Attachment:** [MonoDictNoRefCache.patch](https://github.com/sagemath/sage/files/ticket12313/MonoDictNoRefCache.patch)
...
archive/attachments_017103.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [idkey_dict](https://github.com/sagemath/sage/files/ticket12313/idkey_dict)\n\nExperimental implementation of `IdKeyDict`",
    "created_at": "2012-08-22T08:35:45Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
**Attachment:** [idkey_dict](https://github.com/sagemath/sage/files/ticket12313/idkey_dict)
...
archive/attachments_017104.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [safeweakdict.patch](https://github.com/sagemath/sage/files/ticket12313/safeweakdict.patch)\n\nTrying to explicitly tear down WeakValueDicts in sage",
    "created_at": "2012-08-24T06:27:22Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
**Attachment:** [safeweakdict.patch](https://github.com/sagemath/sage/files/ticket12313/safeweakdict.patch)
...
archive/attachments_017105.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [pbori.diff](https://github.com/sagemath/sage/files/ticket12313/pbori.diff)\n\nModify ReductionStrategy deallocation.",
    "created_at": "2012-08-24T13:17:33Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
**Attachment:** [pbori.diff](https://github.com/sagemath/sage/files/ticket12313/pbori.diff)
...
archive/attachments_017106.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_017107.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12313-safer_tripledicteraser.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-safer_tripledicteraser.patch)\n\nmake TripleDictEraser a little safer",
    "created_at": "2013-01-18T04:43:17Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
...
**Attachment:** [trac_12313-safer_tripledicteraser.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-safer_tripledicteraser.patch)
...
archive/attachments_017108.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_017109.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_017110.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_12313-revert_callback_from_11521.patch](https://github.com/sagemath/sage/files/ticket12313/trac_12313-revert_callback_from_11521.patch)\n\nUse weak reference without callback for homsets (reverting a part of #11521)",
    "created_at": "2013-02-23T22:21:59Z",
    "issue": "https://github.com/sagemath/sage/issues/12313",
    "type": "issue_comment",
