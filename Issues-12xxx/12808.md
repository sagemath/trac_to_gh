...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156019"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156022"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1 +1,5 @@\n When a class `C` is an instance of `ClasscallMetaclass`, then for any constructor call, the system currently looks for `__classcall__` and `__classcall_private__` in `C`. This adds quite an overhead and this could be cached, assuming no one modifies `C` (which seems reasonable). Improving this speeds up, in particular, all call to the constructor of a subclass of `UniqueRepresentation`, eg. many parents, all categories...\n+\n+__Apply__\n+\n+[attachment: trac_12808-classcall_speedup2.patch.gz](https://github.com/sagemath/sage/files/ticket12808/trac_12808-classcall_speedup2.patch.gz)\n``````\n",
    "created_at": "2012-04-22T09:16:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12808",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156024"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156025"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156027"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156028"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12808#issuecomment-146209",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12808#issuecomment-146210",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12808",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12808#event-156034"
}
```
