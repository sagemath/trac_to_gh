...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186197",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Sorry, I can not do any serious work (reviewing), as I am in the middle of holidays. But it looks promising!",
    "created_at": "2012-04-09T23:30:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186199",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:3'></a>Sorry, I can not do any serious work (reviewing), as I am in the middle of holidays. But it looks promising!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186200",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Also, why not going all the way and remove the python version completely? Or at least: Why not cythonizing (and caching?) the `__contains__` method?",
    "created_at": "2012-04-20T07:18:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186201",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:5'></a>Also, why not going all the way and remove the python version completely? Or at least: Why not cythonizing (and caching?) the `__contains__` method?
...
```json
{
    "body": "<a id='comment:7'></a>PS: If that works, one could also get rid of the `DynamicClasscallMetaclass`, which seems like a hack that became necessary since one can not freely combine base classes with different metaclasses.",
    "created_at": "2012-04-20T08:06:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186203",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:7'></a>PS: If that works, one could also get rid of the `DynamicClasscallMetaclass`, which seems like a hack that became necessary since one can not freely combine base classes with different metaclasses.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186204",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186205",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186206",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186207",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Could it be that the patch was created by something like \"hg remove sage/misc/classcall_metaclass.py\" followed by \"hg add sage/misc/classcall_metaclass.pyx\"?\n\nI am no mercurial expert, but I was told that one should better use \"hg rename sage/misc/classcall_metaclass.py sage/misc/classcall_metaclass.pyx\".",
    "created_at": "2012-04-22T08:46:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186208",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>Could it be that the patch was created by something like "hg remove sage/misc/classcall_metaclass.py" followed by "hg add sage/misc/classcall_metaclass.pyx"?
...
```json
{
    "body": "<a id='comment:13'></a>While we are at it: Shouldn't we also try whether changing unique_representation.py into unique_representation.pyx yields a speedup (but not changing \"class\" into \"cdef class\", I guess that won't work)?",
    "created_at": "2012-04-22T08:58:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186209",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>While we are at it: Shouldn't we also try whether changing unique_representation.py into unique_representation.pyx yields a speedup (but not changing "class" into "cdef class", I guess that won't work)?
...
```json
{
    "body": "<a id='comment:14'></a>I have created an alternative patch (using hg rename). It is smaller than the original patch, but should result in identical code. So, either of the patches could be used, but I guess the smaller patch is easier to read (because one sees more easily the additional differences between classcall_metaclass.py and classcall_metaclass.pyx)\n\nApply trac_12808-classcall_speedup2.patch",
    "created_at": "2012-04-22T09:16:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186210",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:14'></a>I have created an alternative patch (using hg rename). It is smaller than the original patch, but should result in identical code. So, either of the patches could be used, but I guess the smaller patch is easier to read (because one sees more easily the additional differences between classcall_metaclass.py and classcall_metaclass.pyx)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186211",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Probably the dynamic class cythonisation should be on a different ticket. However, it seems that the change to cython will not be so difficult: I simply renamed dynamic_class.py into dynamic_class.pyx (and added two lines to module_list.py), and the test suite seems to pass (most of it is already finished). And then, one can apply your trick with `type.__call__`.",
    "created_at": "2012-04-22T18:08:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186213",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:16'></a>Probably the dynamic class cythonisation should be on a different ticket. However, it seems that the change to cython will not be so difficult: I simply renamed dynamic_class.py into dynamic_class.pyx (and added two lines to module_list.py), and the test suite seems to pass (most of it is already finished). And then, one can apply your trick with `type.__call__`.
...
```json
{
    "body": "<a id='comment:17'></a>I see that you added `_included_private_doc_`. Could you elaborate on it? I just searched the sources for that name, but it does not occur anywhere except in your patch. So, what does it do?",
    "created_at": "2012-04-22T19:04:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186214",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:17'></a>I see that you added `_included_private_doc_`. Could you elaborate on it? I just searched the sources for that name, but it does not occur anywhere except in your patch. So, what does it do?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186215",
...
```json
{
    "body": "<a id='comment:19'></a>Note that there is a conflict with #12215, so, either of the patches needs to be rebased. But I guess we first see what patch will be reviewed first...",
    "created_at": "2012-04-23T09:40:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186216",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:19'></a>Note that there is a conflict with #12215, so, either of the patches needs to be rebased. But I guess we first see what patch will be reviewed first...
...
```json
{
    "body": "<a id='comment:22'></a>I forgot: thanks for creating a new patch. I didn't use rename because at some point of my experiment, I was having the two files `*.py` and `*_c.pyx` with the `*.py` importing the other. Then I copied the documentation from `*.py` to `*_c.pyx` until the `*.py` becomes nearly empty. At the end, I renamed the `*_c.pyx` into the `*.pyx` and removed the `*.py`. \n\nHow did you manage to get a patch using rename at the end ?\n\nFlorent",
    "created_at": "2012-04-23T10:28:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186219",
    "user": "https://github.com/hivert"
}
```

<a id='comment:22'></a>I forgot: thanks for creating a new patch. I didn't use rename because at some point of my experiment, I was having the two files `*.py` and `*_c.pyx` with the `*.py` importing the other. Then I copied the documentation from `*.py` to `*_c.pyx` until the `*.py` becomes nearly empty. At the end, I renamed the `*_c.pyx` into the `*.pyx` and removed the `*.py`. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186220",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186222",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186223",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186224",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186225",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>How has the patch changed?",
    "created_at": "2012-04-23T21:01:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186226",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:28'></a>How has the patch changed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186227",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Replying to [hivert](#comment%3A29):\n> Oups ! Sorry I forgot to click \"submit changes\". Simon, your patch is broken. It is missing `classcall_metaclass.pxd` and as a consequence make Sage segfault as startup. I just added the file compared to your patch.\n\n\nAha! So, I forgot `hg add` at some point.",
    "created_at": "2012-04-24T05:08:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186228",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:30'></a>Replying to [hivert](#comment%3A29):
> Oups ! Sorry I forgot to click "submit changes". Simon, your patch is broken. It is missing `classcall_metaclass.pxd` and as a consequence make Sage segfault as startup. I just added the file compared to your patch.
...
```json
{
    "body": "<a id='comment:31'></a>It is relatively easy to change nested_class.py into nested_class.pyx (though not totally trivial). But I was not able to change `NestedClassMetaclass` into a cdef class.\n\nApparently, the problem is that during initialisation of a cdef class (derived from type, at least) the name and the module of that class are not known yet. Hence, a crash in nested_pickle, which is called during initialisation. However, if one determines name and module in a different way and passes it directly to nested_pickle, then there is a different crash, and here I don't understand what is wrong, yet.",
    "created_at": "2012-04-24T06:58:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186229",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:31'></a>It is relatively easy to change nested_class.py into nested_class.pyx (though not totally trivial). But I was not able to change `NestedClassMetaclass` into a cdef class.
...
```json
{
    "body": "<a id='comment:32'></a>I notice that the crash seems to be related with importing the nested class examples in the nested_class module. Perhaps one needs to avoid any application of nested classes in the nested_class module, and move the examples to a different module?",
    "created_at": "2012-04-24T07:30:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186230",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:32'></a>I notice that the crash seems to be related with importing the nested class examples in the nested_class module. Perhaps one needs to avoid any application of nested classes in the nested_class module, and move the examples to a different module?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186231",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>It seems that indeed it is impossible to use a cdef class as metaclass - see the example that I gave at [cython-users](http://groups.google.com/group/cython-users/browse_thread/thread/f1f7f004ee06aaad).\n\nHence, I guess your indirect solution (namely to define fast methods in a cdef class `ClasscallType` and then derive from it a usual Python class `ClasscallMetaclass`) is probably the only feasible.",
    "created_at": "2012-04-24T10:19:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186232",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:34'></a>It seems that indeed it is impossible to use a cdef class as metaclass - see the example that I gave at [cython-users](http://groups.google.com/group/cython-users/browse_thread/thread/f1f7f004ee06aaad).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186233",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186239",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186240",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186241",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186245",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186247",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186248",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186249",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:48'></a>I forgot: Since your patch looks fine to me (independent on whether we eventually decide to cdef `ClasscallMetaclass` directly) and since all tests pass and the documentation looks fine, I give your part of the work a positive review.",
    "created_at": "2012-04-26T16:45:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186250",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:48'></a>I forgot: Since your patch looks fine to me (independent on whether we eventually decide to cdef `ClasscallMetaclass` directly) and since all tests pass and the documentation looks fine, I give your part of the work a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186251",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186252",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:50'></a>Replying to [hivert](#comment%3A49):\n> Ok ! For your part I've a question: is there any reason why do you call\n> `sys_module` in `nested_pickle` whereas you call `sys.module` in\n> `NestedClassMetaclass.__init__` ?\n\n\nThanks for spotting it! I have updated the nested_class patch.\n\nApply trac_12808-classcall_speedup-fh.patch trac_12808_nested_class_cython.patch trac_12808-classcall_cdef.patch",
    "created_at": "2012-04-26T19:47:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186253",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:50'></a>Replying to [hivert](#comment%3A49):
> Ok ! For your part I've a question: is there any reason why do you call
> `sys_module` in `nested_pickle` whereas you call `sys.module` in
> `NestedClassMetaclass.__init__` ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186254",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186255",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:51'></a>Then it's a positive review for me !\n\nI also created #12886 as a followup.\n\nThanks Simon.",
    "created_at": "2012-04-26T21:13:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186256",
    "user": "https://github.com/hivert"
}
```

<a id='comment:51'></a>Then it's a positive review for me !
...
```json
{
    "body": "<a id='comment:52'></a>Please decide which patches have to be applied.",
    "created_at": "2012-04-26T22:20:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186257",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:52'></a>Please decide which patches have to be applied.
...
```json
{
    ...
    "milestone": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12808#event-34849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186258",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186259",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186260",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186261",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186262",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>There is a trivial conflict between this ticket and #12215 (in unique_representation.py). Which one should go first?",
    "created_at": "2012-04-30T08:22:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186263",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:55'></a>There is a trivial conflict between this ticket and #12215 (in unique_representation.py). Which one should go first?
...
```json
{
    "body": "<a id='comment:56'></a>I guess this one should go in first,: After all, #12215 has not been reviewed, yet.",
    "created_at": "2012-04-30T10:47:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186264",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:56'></a>I guess this one should go in first,: After all, #12215 has not been reviewed, yet.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186265",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186266",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186267",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/12808#issuecomment-186268",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/12808",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/12808#event-34850"
}
```
