...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[6f3a3a4](http://git.sagemath.org/sage.git/commit/?id=6f3a3a4aefd7454d1462ffe212ee167b340abbcc)|`make relativize() take only one name if a morphism is given`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[907313d](http://git.sagemath.org/sage.git/commit/?id=907313d3ccac0c2e14d13c4a2f4cb8dda5e82b57)|`add doctest to check the fix`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[87d3531](http://git.sagemath.org/sage.git/commit/?id=87d3531f1457e2e768102b143bfd8cb3ab72e66e)|`Merge remote-tracking branch 'origin/develop' into ticket/12005`|",
    "created_at": "2014-12-19T16:09:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12005",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[90f9d7b](http://git.sagemath.org/sage.git/commit/?id=90f9d7b986913b938e4da11b402d7bd5507a5439)|`Use safe names for relativize() in Sage library`|",
    "created_at": "2014-12-19T21:15:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12005",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nI give a positive review to the ticket, but I have changed the way new names are created inside some methods that use relativize. Jeroen, if you agree, could you put the ticket in positive review?\n\n---\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[f41963b](http://git.sagemath.org/sage.git/commit/?id=f41963b2e24e31f781944808582587629848e3a6)|`Merge tag '6.7' into ticket/12005`|\n|[b549b80](http://git.sagemath.org/sage.git/commit/?id=b549b800b9018ae123c51e6e19077df326a9c3d5)|`Change the names of new variables when using relativize`|",
    "created_at": "2015-06-05T07:22:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/12005",
    "type": "issue_comment",
