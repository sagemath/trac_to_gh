...
```json
{
    "body": "See #17530 for a different issue with `relativize`.",
...
```json
{
    "body": "Personally, I don't care much whether we should use `K.variable_name()*2` or `K.variable_name()+'0'`. I think the doubling was just the first idea which came to my mind.",
...
```json
{
    "body": "I give a positive review to the ticket, but I have changed the way new names are created inside some methods that use relativize. Jeroen, if you agree, could you put the ticket in positive review?\n\n---\nNew commits:",
