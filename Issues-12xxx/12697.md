...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12697#issuecomment-143849",
...
```json
{
    ...
    "asset_name": "string_process-1.0.spkg",
    "asset_url": "tarball://root/attachments/ticket12697/string_process-1.0.spkg",
    "created_at": "2012-03-19T15:41:10Z",
    "issue": "https://github.com/sagemath/sage/issues/12697",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12697/string_process-1.0.spkg",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "Attachment [string_process-1.0.spkg](https://github.com/sagemath/sage/files/ticket12697/string_process-1.0.spkg) by @hivert created at 2012-03-19 15:41:10",
    "created_at": "2012-03-19T15:41:10Z",
    "issue": "https://github.com/sagemath/sage/issues/12697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12697#issuecomment-143850",
    "user": "https://github.com/hivert"
}
```

Attachment [string_process-1.0.spkg](https://github.com/sagemath/sage/files/ticket12697/string_process-1.0.spkg) by @hivert created at 2012-03-19 15:41:10
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_12697-string_process-fh.patch",
    "asset_url": "tarball://root/attachments/ticket12697/trac_12697-string_process-fh.patch",
    "created_at": "2012-03-19T16:03:32Z",
    "issue": "https://github.com/sagemath/sage/issues/12697",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12697/trac_12697-string_process-fh.patch",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac_12697-string_process-fh.patch](https://github.com/sagemath/sage/files/ticket12697/trac_12697-string_process-fh.patch) by @hivert created at 2012-03-19 16:03:32",
    "created_at": "2012-03-19T16:03:32Z",
    "issue": "https://github.com/sagemath/sage/issues/12697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12697#issuecomment-143851",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12697#issuecomment-143852",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12697#issuecomment-143853",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12697#issuecomment-143854",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105310"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105311"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105312"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105313"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105314"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105315"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105316"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12697#event-105317"
}
```
