...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12651#issuecomment-143169",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12651",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12651#issuecomment-143170",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [sage-trac_12651.patch](https://github.com/sagemath/sage/files/ticket12651/sage-trac_12651.patch) by @orlitzky created at 2012-03-10 21:51:43\n\nFirst patch had two lines with trailing whitespace, I just removed them.",
    "created_at": "2012-03-10T21:51:43Z",
    "issue": "https://github.com/sagemath/sage/issues/12651",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12651#issuecomment-143171",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12651",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12651#issuecomment-143172",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12651",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12651#issuecomment-143173",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12651",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12651#issuecomment-143174",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12651",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12651#issuecomment-143175",
