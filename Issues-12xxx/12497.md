...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156470"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156473"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140397",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140398",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -71,4 +71,4 @@\n This type of invalid input should be caught and an appropriate error given to the user.\n \n ---\n-\n+Apply [attachment: trac_12497-fix-sage-segv.patch.gz](https://github.com/sagemath/sage/files/ticket12497/trac_12497-fix-sage-segv.patch.gz) to devel/sage\n``````\n",
    "created_at": "2012-02-11T15:01:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140399",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140400",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140401",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140402",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -71,4 +71,8 @@\n This type of invalid input should be caught and an appropriate error given to the user.\n \n ---\n-Apply [attachment: trac_12497-fix-sage-segv.patch.gz](https://github.com/sagemath/sage/files/ticket12497/trac_12497-fix-sage-segv.patch.gz) to devel/sage\n+Apply either\n+\n+1. [attachment: trac_12497-fix-sage-segv.patch.gz](https://github.com/sagemath/sage/files/ticket12497/trac_12497-fix-sage-segv.patch.gz) to devel/sage for sage-4.8\n+\n+2. [attachment: trac_12497-fix-sage-segv.2.patch.gz](https://github.com/sagemath/sage/files/ticket12497/trac_12497-fix-sage-segv.2.patch.gz) to devel/sage for sage-5.0beta*\n``````\n",
    "created_at": "2012-03-02T11:32:00Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140403",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140404",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140405",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140406",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140407",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140408",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140409",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140410",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140411",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140412",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156482"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140414",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12497#issuecomment-140415",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156483"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12497",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12497#event-156484"
}
```
