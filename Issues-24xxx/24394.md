...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24394#event-320119"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24394#event-320120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24394#event-320121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24394#event-320122"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24394",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24394#issuecomment-372143",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24394",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24394#issuecomment-372144",
    "user": "https://github.com/vit-tucek"
}
```
