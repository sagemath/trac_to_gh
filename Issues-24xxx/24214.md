...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338725",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338726",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338727",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338728",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338729",
...
```json
{
    "body": "Sure, that would be a simple enough thing to change - should I open a new ticket?",
    "created_at": "2017-12-30T22:19:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338730",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338732",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338733",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338735",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338737",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338738",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "For consistency, could you make the output of `get_integral_point` an immutable vector\n\n```\nsage: P = polytopes.icosahedron()\nsage: P.integral_points()[0].is_mutable()\nFalse\nsage: P.get_integral_point(0).is_mutable()\nTrue\n```\n(Just use the method `.set_immutable()` of vectors.)",
    "created_at": "2017-12-31T14:36:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338739",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338741",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338742",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "With the current code, you might construct and intersect polyhedra on different base ring. Instead of `Polyhedron(XXX)` it would be better to use\n\n```\nS = self.parent()\nS(ieqs=[[guess-1] + [0] * i + [-1] + [0] * (D - i - 1)])\n```",
    "created_at": "2018-01-01T13:35:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338743",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338744",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338746",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338748",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338749",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338750",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Can you doctest the fact that `**kwds` are passed (for example you can pass a wrong keyword)?",
    "created_at": "2018-01-05T13:12:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338751",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338752",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "typo in the doc: `it bisects the the upper`",
    "created_at": "2018-01-06T21:07:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338753",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338754",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338755",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338756",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338757",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338758",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338759",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "I think this updated version should have the doctests that require latte_int flagged correctly. However to test this I had to go into my install of sage and manually delete /build/pkgs/latte_int and ./local/bin/count. Is there an easier way to (temporarily) uninstall an optional sage package?",
    "created_at": "2018-01-15T12:29:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338760",
    "user": "https://trac.sagemath.org/admin/accounts/users/mcbell"
}
```
...
```json
{
    "body": "Right now there is not, but Erik Bray (embray) is currently working on developing this. IIRC he has a post on sage-devel within the past month or so about the progress of this.",
    "created_at": "2018-01-15T15:47:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338762",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24214#event-61744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24214#issuecomment-338763",
    "user": "https://github.com/vbraun"
}
```
