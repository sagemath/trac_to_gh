...
```json
{
    "body": "<a id='comment:1'></a>After discussion with upstream, it is related to the dependence on orderings of the rings, so I guess it can be closed.",
    "created_at": "2017-12-16T00:10:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24377#issuecomment-360123",
    "user": "https://github.com/enriqueartal"
}
```

<a id='comment:1'></a>After discussion with upstream, it is related to the dependence on orderings of the rings, so I guess it can be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24377#event-61632"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24377#event-61633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24377#issuecomment-360124",
