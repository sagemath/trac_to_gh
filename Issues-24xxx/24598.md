...
```
As mentioned in ticket:24586#comment:4 and in some other past discussions, we're committing a category error with the "type" of SPKGs.
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24598#issuecomment-377135",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24598",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24598#issuecomment-377136",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222126"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222127"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222128"
}
```
...
```json
{
    ...
    "label": "wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222129"
}
```
...
```json
{
    ...
    "label": "wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222130"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24598",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24598#issuecomment-377137",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222132"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222133"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222134"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24598",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-222135"
}
```
