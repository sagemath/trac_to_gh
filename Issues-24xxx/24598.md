...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-61998"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-61999"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-62000"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-62001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-62002"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Done in #29287. Should be closed.",
    "created_at": "2020-04-18T06:38:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24598",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24598#issuecomment-466255",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Done in #29287. Should be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24598",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24598#issuecomment-466256",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24598",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24598#issuecomment-466257",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24598",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24598#event-62003"
}
```
