...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458177",
...
```json
{
    "body": "<a id='comment:2'></a>I did not ask `t >= RealField(2)(5/4)`, but `t >= 5/4`.\nDoes the following convince you? Note that 6*t is exactly representable in 2-bit precision.\n\n```\nsage: t = RealField(2)(1)\nsage: t >= 7/6\nTrue\nsage: 6*t >= 7\nFalse\n```",
    "created_at": "2017-11-15T15:00:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458178",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>I did not ask `t >= RealField(2)(5/4)`, but `t >= 5/4`.
Does the following convince you? Note that 6*t is exactly representable in 2-bit precision.
...
```json
{
    "body": "<a id='comment:3'></a>Well, comparison happens after coercion, and coercion can only lose precision. If you want comparison that makes sense, you should avoid using such a small precision.",
    "created_at": "2017-11-15T15:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458179",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>Well, comparison happens after coercion, and coercion can only lose precision. If you want comparison that makes sense, you should avoid using such a small precision.
...
```json
{
    "body": "<a id='comment:4'></a>where is it documented that comparison happens after coercion? Is the user warned about that?\nAnd why is the coercion done in the direction QQ to RealField and not the converse, which would not lose any information?",
    "created_at": "2017-11-15T15:19:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458180",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:4'></a>where is it documented that comparison happens after coercion? Is the user warned about that?
And why is the coercion done in the direction QQ to RealField and not the converse, which would not lose any information?
...
```json
{
    "body": "<a id='comment:5'></a>Coercion is supposed to be exact (mathematically), so it can not guess anything from an approximate real number. Going from R to QQ is a conversion.\n\n```\nsage: R = RealField(2)\nsage: R.coerce_map_from(QQ)\n\nGeneric map:\n  From: Rational Field\n  To:   Real Field with 2 bits of precision\nsage: QQ.coerce_map_from(R)\n```",
    "created_at": "2017-11-15T15:22:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458181",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:5'></a>Coercion is supposed to be exact (mathematically), so it can not guess anything from an approximate real number. Going from R to QQ is a conversion.
...
```json
{
    "body": "<a id='comment:7'></a>the issue can be simplified to:\n\n```\nsage: RealField(2)(7) == 10\nTrue\n```",
    "created_at": "2017-11-15T15:45:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458183",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:7'></a>the issue can be simplified to:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458184",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458185",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The behaviour that you see is by design, so by definition it's a feature and not a bug.\n\nNote also that what you see is consistent with subtraction, which is a good thing:\n\n```\nsage: RealField(2)(1) - 5/4\n0.00\n```\n\nI don't see a simple fix here... it would require substantial changes to the coercion model.",
    "created_at": "2017-11-16T08:49:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458186",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>The behaviour that you see is by design, so by definition it's a feature and not a bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458188",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I don't quite see it as a mathematically wrong result as it is correct up to the estimate bounds. If we did that, then I feel this would have to return `False` by the same argument:\n\n```\nsage: bool(pi.n() == pi)\nTrue\n```\nsince `pi.n()` is an inexact floating point number. Also, we have this doctest in `exact_rational`:\n\n```\nsage: RR(3^60).exact_rational() - 3^60\n6125652559\n```",
    "created_at": "2017-11-16T21:53:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458189",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:11'></a>I don't quite see it as a mathematically wrong result as it is correct up to the estimate bounds. If we did that, then I feel this would have to return `False` by the same argument:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458190",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24219#issuecomment-458191",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24219",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24219#event-61356"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24219#event-61357"
}
```
