...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[fc905d7](https://git.sagemath.org/sage.git/commit/?id=fc905d7c9b141834628cdfcc854e280e4704ceab)|`Better support on Python 3 for doctests that expect exceptions.`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[90ebe89](https://git.sagemath.org/sage.git/commit/?id=90ebe89df08b6bc196429818af172555f59c5c6a)|`* Use __qualname__ instead of __name__ where avaialble (i.e. Python 3)`|",
    "created_at": "2017-11-24T11:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24271",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[c05196d](https://git.sagemath.org/sage.git/commit/?id=c05196d665f48635245f65eaea5e632dd8f0b53e)|`Better support on Python 3 for doctests that expect exceptions.`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[9a659d8](https://git.sagemath.org/sage.git/commit/?id=9a659d831cb431c6884d22c715fecc4cda9a6b61)|`Handle some common (particularly IOError) exceptions that are just aliases of`|",
