...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[e8f6bce](https://git.sagemath.org/sage.git/commit/?id=e8f6bcedf9c773287716ded934ff8d838f576758)|`deleted mul method`|\n|[7599c77](https://git.sagemath.org/sage.git/commit/?id=7599c77df7e6e608f034f2968e7a66425ec5c99d)|`Added `mul` method`|\n|[42a790a](https://git.sagemath.org/sage.git/commit/?id=42a790a213545c6410a7e5bfc629649b2c7da8b7)|`Merge branch 'u/pmenegat/multiplication_of_the_gram_matrix' of git://trac.sagemath.org/sage into t/24564/primitive_extension_of_lattices`|\n|[26bacb9](https://git.sagemath.org/sage.git/commit/?id=26bacb9597ae82c54f3d19ba0b95395be1c23a0c)|``mul` method deleted`|",
    "created_at": "2018-02-22T13:05:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24564",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[46a5c45](https://git.sagemath.org/sage.git/commit/?id=46a5c450a8880f47798c4d82315ad453b79866d1)|``mul` method improved`|\n|[930bc87](https://git.sagemath.org/sage.git/commit/?id=930bc87cf3d3066e2b7560eb370c729401ac1895)|`Merge branch 'u/pmenegat/multiplication_of_the_gram_matrix' of git://trac.sagemath.org/sage into t/24564/primitive_extension_of_lattices`|",
    "created_at": "2018-02-23T09:50:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24564",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[6c5310f](https://git.sagemath.org/sage.git/commit/?id=6c5310f8c9872b54e8af3890447af1122493277e)|`function primitive extension moved`|\n|[adaf3f2](https://git.sagemath.org/sage.git/commit/?id=adaf3f2053bb3cf137daa908cc35395cb4f8c307)|`minor modifications`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[6f42b0b](https://git.sagemath.org/sage.git/commit/?id=6f42b0b437ad6d95b62f02e415dff0ae9141d5ac)|`Revert \"deleted mul method\"`|\n|[699d0c2](https://git.sagemath.org/sage.git/commit/?id=699d0c2991189cfd8708a7384aa2d4464fb35b03)|`minor changes`|\n|[1f7e304](https://git.sagemath.org/sage.git/commit/?id=1f7e304a1e164bfebdbf4132fe0c8bac12ddf85f)|`merge conflit resolved (?)`|",
    "created_at": "2018-02-23T11:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24564",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[0c15a66](https://git.sagemath.org/sage.git/commit/?id=0c15a66f6342406bb87f38d074aa863e5c329d4a)|`Added compatibility for lattice with basis`|\n|[c85d4ab](https://git.sagemath.org/sage.git/commit/?id=c85d4abe4c86939f1c426d10dccce9b80dfbf32e)|`sintax modification`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[5499ecb](https://git.sagemath.org/sage.git/commit/?id=5499ecba063d5375c883a06f1ba87c05c70f1581)|`Added ``DirectSumLattices`` and ``GlueLattices```|",
    "created_at": "2018-03-29T08:21:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24564",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[3e46f37](https://git.sagemath.org/sage.git/commit/?id=3e46f377b67657e5ea29ecd304d7571097fe33f9)|`Added documentation for ``LatticeDirectSum```|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[a04c889](https://git.sagemath.org/sage.git/commit/?id=a04c88956adcb2bd088ca9e700682a4cf4e7f744)|`Added documentation`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[d086e54](https://git.sagemath.org/sage.git/commit/?id=d086e54090b3fd3963c2176236b0f958a9e512ab)|`Input check added`|",
    "created_at": "2018-03-29T13:25:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24564",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nyou can give it a positive review if you are happy with my changes.\n\n---\nNew commits:\n|                                                                                                                                          |         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------|\n|[e4b326b](https://git.sagemath.org/sage.git/commit?id=e4b326b264fda6c68999b5e7dc718f15665c2205)|`Cleanup`|",
