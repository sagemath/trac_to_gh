...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24455#event-320799"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24455#event-320800"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24455#event-320801"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24455#issuecomment-372895",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24455#issuecomment-372896",
    "user": "https://github.com/sagetrac-mcbell"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24455#event-320802"
}
```
