...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[72d9751](https://git.sagemath.org/sage.git/commit?id=72d9751acefbb271e75ca088e10d8e09a2647110)|`Upgrade some Jupyter packages`|\n|[54ff63d](https://git.sagemath.org/sage.git/commit?id=54ff63d4c76b892d29211ebe134fe25027b0253c)|`Upgrade to ipywidgets 7`|\n|[c37195c](https://git.sagemath.org/sage.git/commit?id=c37195c71b98bda18fed7c35b1bfbdf6a1a1f86a)|`Clicking on a ToggleButtons widget should run interact`|",
