...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24268#issuecomment-459405",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>#24957 implements a sort of middle ground, where we still use `pexpect.spawn` as a `bytes` interface, but we strategically add some wrappers around it that call `bytes_to_str`.",
    "created_at": "2018-03-12T12:22:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24268#issuecomment-459406",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>#24957 implements a sort of middle ground, where we still use `pexpect.spawn` as a `bytes` interface, but we strategically add some wrappers around it that call `bytes_to_str`.
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24268#event-61434"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24268#event-61435"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24268#event-61436"
}
```
