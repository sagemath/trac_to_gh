...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24217#issuecomment-458162",
...
```json
{
    "body": "<a id='comment:2'></a>It would be convenient if Python somehow had a hook to deal with unraisable exceptions. But it doesn't: it just deletes the exception and there is (AFAIK) no way to figure out that it did that.",
    "created_at": "2018-03-20T13:00:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24217#issuecomment-458163",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>It would be convenient if Python somehow had a hook to deal with unraisable exceptions. But it doesn't: it just deletes the exception and there is (AFAIK) no way to figure out that it did that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24217#issuecomment-458164",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24217#issuecomment-458165",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24217#issuecomment-458166",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24217#issuecomment-458167",
    "user": "https://github.com/jdemeyer"
}
```
