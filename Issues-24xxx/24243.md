...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458793",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24243#event-61395"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Sage-8.0 has SymPy-1.0 which gave the `C1` result, as I just confirmed. Moreover current Sage-8.1.rc2 has SymPy-1.1.1 which gives the `C1` result, as I just confirmed. Finally, the current SymPy-1.1.2-dev does the same so I'm at a loss where you expect the number to come from. Since `rsolve` is a SymPy function the bug should be reported there.",
    "created_at": "2017-11-20T09:38:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458794",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>Sage-8.0 has SymPy-1.0 which gave the `C1` result, as I just confirmed. Moreover current Sage-8.1.rc2 has SymPy-1.1.1 which gives the `C1` result, as I just confirmed. Finally, the current SymPy-1.1.2-dev does the same so I'm at a loss where you expect the number to come from. Since `rsolve` is a SymPy function the bug should be reported there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458795",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>reported upstream at https://github.com/sympy/sympy/issues/13629,\nand set back the milestone to 8.1, since this is also a bug in Sage\n(which could well use another package than SymPy to solve recurrence relations).",
    "created_at": "2017-11-20T15:45:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458796",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>reported upstream at https://github.com/sympy/sympy/issues/13629,
and set back the milestone to 8.1, since this is also a bug in Sage
(which could well use another package than SymPy to solve recurrence relations).
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24243#event-61396"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24243#event-61397"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24243#event-61398"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24243#event-61399"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458797",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>ok I now understand.\nPaul",
    "created_at": "2017-11-20T16:25:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458798",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:4'></a>ok I now understand.
Paul
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458799",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24243#issuecomment-458800",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24243",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24243#event-61400"
}
```
