...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-319650"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-319651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-319652"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-319653"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24355#issuecomment-371320",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24355#issuecomment-371321",
    "user": "https://github.com/mezzarobba"
}
```
