...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24833#event-325630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24833#event-325631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24833#event-325632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24833#event-325633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24833#issuecomment-380179",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24833#issuecomment-380180",
    "user": "https://github.com/rwst"
}
```
