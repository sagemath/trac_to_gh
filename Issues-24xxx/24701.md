...
```json
{
    "body": "<a id='comment:1'></a>Hum, still clang using gcc's libstdc++ from gcc 4.8 in this case. Would sage want to build its own gcc on that box if there is just gcc-4.8?",
    "created_at": "2018-02-10T07:47:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469096",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:1'></a>Hum, still clang using gcc's libstdc++ from gcc 4.8 in this case. Would sage want to build its own gcc on that box if there is just gcc-4.8?
...
```json
{
    "body": "<a id='comment:2'></a>I can't even replace that library but using a libc++ if the system has it would be nice.",
    "created_at": "2018-02-10T09:33:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469097",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>I can't even replace that library but using a libc++ if the system has it would be nice.
...
```json
{
    "body": "<a id='comment:4'></a>That's a tall order as a check. Here it is also possible that the problem is the age of the gcc's libstdc++. Although I think it is better to use libc++/libcxx and that may be easier to enforce even it turns to be overbroad.",
    "created_at": "2018-02-11T06:15:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469098",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:4'></a>That's a tall order as a check. Here it is also possible that the problem is the age of the gcc's libstdc++. Although I think it is better to use libc++/libcxx and that may be easier to enforce even it turns to be overbroad.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469100",
...
```json
{
    "body": "<a id='comment:7'></a>So this ticket is wontfix. Use these flags:\n\n```\nexport CC=\"clang\"\nexport CXX=\"clang++\"\nexport CLANG_DEFAULT_CXX_STDLIB=\"libc++\"\n```",
    "created_at": "2018-02-12T07:13:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469101",
    "user": "https://github.com/rwst"
}
```

<a id='comment:7'></a>So this ticket is wontfix. Use these flags:
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24701#event-62169"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469102",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469103",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469104",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469105",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>#24716 looks similar. Duplicate?",
    "created_at": "2018-02-13T15:45:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469106",
    "user": "https://github.com/rwst"
}
```

<a id='comment:10'></a>#24716 looks similar. Duplicate?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24701#issuecomment-469107",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24701",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24701#event-62170"
}
```
