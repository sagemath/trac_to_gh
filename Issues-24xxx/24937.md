...
```json
{
    "body": "<a id='comment:1'></a>I confirm the bug and could trace it down to some changes between Sage 8.1.beta5 and 8.1.beta8. On my computer (Intel Core i7-6700HQ), with Sage 8.1.beta5 and all previous versions:\n\n```\nsage: from sage.parallel.ncpus import ncpus\nsage: ncpus()\n8\n```\nwhile with Sage 8.1.beta8 and all versions above:\n\n```\nsage: from sage.parallel.ncpus import ncpus\nsage: ncpus()\n1\n```\nSo yes, a very probable culprit is #23713, which has been merged in Sage 8.1.beta8.\n\nA consequence of this is the follwing bug reported at\nhttps://ask.sagemath.org/question/42439/parallel-how-to-use-all-cpus/",
    "created_at": "2018-05-26T13:41:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24937#issuecomment-474389",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:1'></a>I confirm the bug and could trace it down to some changes between Sage 8.1.beta5 and 8.1.beta8. On my computer (Intel Core i7-6700HQ), with Sage 8.1.beta5 and all previous versions:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24937#issuecomment-474391",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I volunteer to fix this. But what should the new behaviour be?",
    "created_at": "2018-07-05T18:32:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24937#issuecomment-474394",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:9'></a>I volunteer to fix this. But what should the new behaviour be?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24937#issuecomment-474395",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24937#issuecomment-474396",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>> I personally liked the \"min(8,cores)\" logic that I think was taking place before.\n\n\n+1 from me for having `npcus()` return `min(8, cores)`",
    "created_at": "2020-03-10T11:34:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24937#issuecomment-474398",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:12'></a>> I personally liked the "min(8,cores)" logic that I think was taking place before.
...
```json
{
    "body": "<a id='comment:14'></a>Or endow `ncpus` with a keyword argument `max=None`, allowing `ncpus(max=8)`.",
    "created_at": "2021-05-11T10:15:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24937#issuecomment-474400",
    "user": "https://github.com/slel"
}
```

<a id='comment:14'></a>Or endow `ncpus` with a keyword argument `max=None`, allowing `ncpus(max=8)`.
