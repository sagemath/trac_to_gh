...
```json
{
    "body": "<a id='comment:1'></a>See also #18821.",
...
<a id='comment:1'></a>See also #18821.
...
<a id='comment:2'></a>Here is how I would describe this bug in the integrate function.
(This can be turned into a doctest when this bug is resolved.)
...
```json
{
    "body": "<a id='comment:3'></a>There are half a dozen similar tickets to this. The reason is that Sage uses a (now) unmaintained package of Maxima, see #12731 for an overview.",
...
<a id='comment:3'></a>There are half a dozen similar tickets to this. The reason is that Sage uses a (now) unmaintained package of Maxima, see #12731 for an overview.
...
```json
{
    "body": "<a id='comment:5'></a>this one is fixed by #27958, that needs review",
...
<a id='comment:5'></a>this one is fixed by #27958, that needs review
