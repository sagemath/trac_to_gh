...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[eeaebe3](https://git.sagemath.org/sage.git/commit/?id=eeaebe309317a0df13b561db53384d5b758a61af)|`Remove some len expressions from doctest for BooleanFunction.truth_table`|",
