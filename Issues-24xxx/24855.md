...
```json
{
    "body": "Now that the docker images are relatively small, we could pass them on in a workspace and use workflows to make this more similar to [GitLab](../wikis/GitLab) CI.\n\nDepends on #24655\n\n**Reviewer:** Julian R\u00fcth\n\n**Author:** Julian R\u00fcth\n\nIssue created by migration from https://trac.sagemath.org/ticket/24855\n\n",
...
```
Now that the docker images are relatively small, we could pass them on in a workspace and use workflows to make this more similar to [GitLab](../wikis/GitLab) CI.
