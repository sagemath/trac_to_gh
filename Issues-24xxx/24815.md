...
```json
{
    "body": "Changing commit from \"\" to \"fcda724addfec8d664d0c2b149a2c17f0cc1ca52\"",
    "created_at": "2018-02-22T11:44:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471398",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "" to "fcda724addfec8d664d0c2b149a2c17f0cc1ca52"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471399",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>One small concern I have with this is that `str`/`bytes` are also considered `Sequence`s by Python.  I think this is okay though, because under this treatment it's really no different than if passed, say, a list of one character strings. Then, if such as list is not valid input, a string is no less invalid.  It just means that if you intend a function to accept string arguments to be processed separately from list/tuple-like arguments, they should always be handled first.  This is what I would probably normally do anyways.",
    "created_at": "2018-02-22T11:48:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471400",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>One small concern I have with this is that `str`/`bytes` are also considered `Sequence`s by Python.  I think this is okay though, because under this treatment it's really no different than if passed, say, a list of one character strings. Then, if such as list is not valid input, a string is no less invalid.  It just means that if you intend a function to accept string arguments to be processed separately from list/tuple-like arguments, they should always be handled first.  This is what I would probably normally do anyways.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471401",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"fcda724addfec8d664d0c2b149a2c17f0cc1ca52\" to \"6644dbdc443203170f8dc5e35368ce3d8eaf1956\"",
    "created_at": "2018-02-22T11:54:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471402",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "fcda724addfec8d664d0c2b149a2c17f0cc1ca52" to "6644dbdc443203170f8dc5e35368ce3d8eaf1956"
...
```json
{
    "body": "<a id='comment:4'></a>This still has some failing tests--I think mostly due to minor mistakes...",
    "created_at": "2018-02-22T12:16:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471403",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>This still has some failing tests--I think mostly due to minor mistakes...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471404",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"6644dbdc443203170f8dc5e35368ce3d8eaf1956\" to \"9660547f4707ffc85edec2c10d1d0e7e58c0b9dc\"",
    "created_at": "2018-02-22T12:44:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471405",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6644dbdc443203170f8dc5e35368ce3d8eaf1956" to "9660547f4707ffc85edec2c10d1d0e7e58c0b9dc"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471406",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>In fact, the main bug I had was due to the aforementioned concern about `str`, where there was one case where it didn't make sense to treat lists of strings equivalently to lists of lists.  This was the only such case, however (a slightly tricky one since it was in the matrix constructor, which has a lot of tricky logic pertaining to flexibility in its arguments).",
    "created_at": "2018-02-22T12:46:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471407",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>In fact, the main bug I had was due to the aforementioned concern about `str`, where there was one case where it didn't make sense to treat lists of strings equivalently to lists of lists.  This was the only such case, however (a slightly tricky one since it was in the matrix constructor, which has a lot of tricky logic pertaining to flexibility in its arguments).
...
```json
{
    "body": "<a id='comment:7'></a>Can you please not make changes to `src/sage/matrix` because I'm dealing with that in #24742.",
    "created_at": "2018-02-22T12:53:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471408",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Can you please not make changes to `src/sage/matrix` because I'm dealing with that in #24742.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471410",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>On the performance question, again, perhaps for the sake of Cython optimization one could first check `list`/`tuple` explicitly since those are going to be the most common anyways, and then fall back on the more generic check.",
    "created_at": "2018-02-22T15:02:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471412",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>On the performance question, again, perhaps for the sake of Cython optimization one could first check `list`/`tuple` explicitly since those are going to be the most common anyways, and then fall back on the more generic check.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471413",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471414",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I don't mind, but then #24742 should do something about this, or a follow-up to it.  There are cases where it *should* accept vectors and ranges at the very least, but currently doesn't.",
    "created_at": "2018-02-22T16:15:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471415",
    "user": "https://github.com/embray"
}
```

<a id='comment:14'></a>I don't mind, but then #24742 should do something about this, or a follow-up to it.  There are cases where it *should* accept vectors and ranges at the very least, but currently doesn't.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471416",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471417",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I think though, that the case where it does the `isinstance` check would be relatively rare if the common cases are handled first.  Before worrying extensively about it one would have to prove that there's an important common case that it actually substantially impacts.",
    "created_at": "2018-02-23T16:10:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471418",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>I think though, that the case where it does the `isinstance` check would be relatively rare if the common cases are handled first.  Before worrying extensively about it one would have to prove that there's an important common case that it actually substantially impacts.
...
```json
{
    "body": "<a id='comment:19'></a>I believe this issue can reasonably be addressed for Sage 8.4.",
    "created_at": "2018-07-18T11:47:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471419",
    "user": "https://github.com/embray"
}
```

<a id='comment:19'></a>I believe this issue can reasonably be addressed for Sage 8.4.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471420",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471421",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Moving all my in-progress tickets to 8.8 milestone.",
    "created_at": "2019-03-25T10:43:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471422",
    "user": "https://github.com/embray"
}
```

<a id='comment:23'></a>Moving all my in-progress tickets to 8.8 milestone.
...
```json
{
    "body": "<a id='comment:24'></a>Tickets still needing working or clarification should be moved to the next release milestone at the soonest (please feel free to revert if you think the ticket is close to being resolved).",
    "created_at": "2019-06-14T14:50:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471423",
    "user": "https://github.com/embray"
}
```

<a id='comment:24'></a>Tickets still needing working or clarification should be moved to the next release milestone at the soonest (please feel free to revert if you think the ticket is close to being resolved).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471424",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471425",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471426",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>The relation between this and #26769 is slightly orthogonal since the `PySequence_Check` function used in `issequence` does not, I believe, check if an object belongs to the `Sequence` ABC.  Perhaps it should, though I think #26769 was born partly out of Jeroen's complaint here that checking `isinstance(..., Sequence)` is too slow.  But I think that's also improved a lot in Python 3.",
    "created_at": "2020-09-02T09:13:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471427",
    "user": "https://github.com/embray"
}
```

<a id='comment:28'></a>The relation between this and #26769 is slightly orthogonal since the `PySequence_Check` function used in `issequence` does not, I believe, check if an object belongs to the `Sequence` ABC.  Perhaps it should, though I think #26769 was born partly out of Jeroen's complaint here that checking `isinstance(..., Sequence)` is too slow.  But I think that's also improved a lot in Python 3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471428",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24815#issuecomment-471429",
    "user": "https://github.com/mkoeppe"
}
```
