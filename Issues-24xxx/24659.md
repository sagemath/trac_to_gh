...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24659#issuecomment-364664",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24659#issuecomment-364665",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Anne, which version of shifted semistandard insertion do you need precisely?  Bruce Sagan's is a bijection between matrices with nonnegative integer entries, possibly primed, and pairs `(T,U)` of generalized shifted tableaux of the same shape, such that `U` has no primed entries on the diagonal.\n\nA generalized shifted tableau is a filling that is weakly increasing in rows and columns and primed entries are not repeated in rows and unprimed entries are not repeated in columns.\n\nThus, `T` is **not** a `ShiftedPrimedTableau`, because it can have primed entries on the diagonal.\n\nI'm not sure how this is dealt with best.  Subclassing?",
    "created_at": "2018-02-06T10:05:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24659#issuecomment-364666",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:2'></a>Anne, which version of shifted semistandard insertion do you need precisely?  Bruce Sagan's is a bijection between matrices with nonnegative integer entries, possibly primed, and pairs `(T,U)` of generalized shifted tableaux of the same shape, such that `U` has no primed entries on the diagonal.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24659#issuecomment-364667",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24659#issuecomment-364668",
...
```json
{
    "body": "<a id='comment:7'></a>In fact, in Rob Muth's paper (https://arxiv.org/pdf/1711.00420.pdf), Remark 3.2, he says \"If X = N, where < is the usual order on integers and every element is of even parity, then 0-insertion is Schensted insertion [S].  For general X and\nstandard tableaux, 0-insertion is mixed insertion as defined by Haiman (where odd\nletters are referred to as circled) [H].\"\n\nHe might be mistaken though, since again when I read your reference, it says something about diagonals.",
    "created_at": "2018-03-12T21:05:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24659#issuecomment-364671",
    "user": "https://github.com/MareoRaft"
}
```

<a id='comment:7'></a>In fact, in Rob Muth's paper (https://arxiv.org/pdf/1711.00420.pdf), Remark 3.2, he says "If X = N, where < is the usual order on integers and every element is of even parity, then 0-insertion is Schensted insertion [S].  For general X and
standard tableaux, 0-insertion is mixed insertion as defined by Haiman (where odd
letters are referred to as circled) [H]."
