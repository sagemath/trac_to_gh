...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[9da13d1](https://git.sagemath.org/sage.git/commit/?id=9da13d17a694eaafa6db50a1badf8c9e489ee762)|`Adds a handy sdh_die helper; rewrites existing helpers to use it`|\n|[8f6ff3b](https://git.sagemath.org/sage.git/commit/?id=8f6ff3b0a38ce5dd9505dfc7af3e4c2091859e19)|`Allow sdh_die, if run without arguments, to read an error message from stdin.`|\n|[9085389](https://git.sagemath.org/sage.git/commit/?id=90853895105138e4a14b6d92d7849bd8e39e40ac)|`Nicer: Automatically format the error message to the terminal width (or 80 chars by default)`|\n|[f375a83](https://git.sagemath.org/sage.git/commit/?id=f375a838442825a5e5ccd6be8250c54160165376)|`With fmt, preserve existing line breaks, just wrap long lines`|\n|[18e1757](https://git.sagemath.org/sage.git/commit/?id=18e1757cb5b875c9488dd9fe42ee72ed9d90e8a3)|`Use sdh_die for sdh_check_vars as well`|",
    "created_at": "2017-10-12T08:31:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24017",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[4b87c10](https://git.sagemath.org/sage.git/commit/?id=4b87c1084d610b82d8f93b89133687a8c3c2ace0)|`Get rid of the $PIP_INSTALL environment variable and replace it with a`|\n|[56ad241](https://git.sagemath.org/sage.git/commit/?id=56ad2411c2678f205ecf062be87d368eed562a88)|`Add some docs for this function`|\n|[e5bebd1](https://git.sagemath.org/sage.git/commit/?id=e5bebd1987d82685570a15efe79944a63b5bba4a)|`Keep PIP_INSTALL for now but quietly mark it as deprecated.`|\n|[c69dfda](https://git.sagemath.org/sage.git/commit/?id=c69dfdaf867b10560b91a740885e22b4ffcaeb88)|`Add error handling and SAGE_SUDO support for sdh_pip_install`|\n|[9af9c98](https://git.sagemath.org/sage.git/commit/?id=9af9c980c57d80193fd6d3ac3f261cf582e546b7)|`Adds a handy sdh_die helper; rewrites existing helpers to use it`|\n|[3cd5b99](https://git.sagemath.org/sage.git/commit/?id=3cd5b9951a50b79f610b8a640f7adfb27eb4da61)|`Allow sdh_die, if run without arguments, to read an error message from stdin.`|\n|[cf67bdd](https://git.sagemath.org/sage.git/commit/?id=cf67bddfde43078c7b150974e48e555a98e853fc)|`Nicer: Automatically format the error message to the terminal width (or 80 chars by default)`|\n|[56de46e](https://git.sagemath.org/sage.git/commit/?id=56de46e48f2d72f91e764ad1601389447f2027cd)|`With fmt, preserve existing line breaks, just wrap long lines`|\n|[caf2698](https://git.sagemath.org/sage.git/commit/?id=caf2698decb2f44521922f9f04a6d494877f4be7)|`Use sdh_die for sdh_check_vars as well`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|\n|[50c1259](https://git.sagemath.org/sage.git/commit/?id=50c1259b5bac2b5a31a35dc1dac4830c9ff23156)|`Error message itself should also be output to stderr!`|\n|[c00425b](https://git.sagemath.org/sage.git/commit/?id=c00425b6281a137c90c4ea67de5b95a8d0ee2b11)|`Fix typo in comment; improve documentation.`|",
    "created_at": "2017-10-25T10:22:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24017",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[43e618a](https://git.sagemath.org/sage.git/commit/?id=43e618a8cbd41366d457674cee37e4ba2b989b5b)|`different logic for handling error codes: sdh_die always returns non-zero, but if the previous exit`|",
    "created_at": "2017-10-25T13:51:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24017",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[883df11](https://git.sagemath.org/sage.git/commit/?id=883df1141b64322b57f9b1393d455c2908fe76c3)|`Use the correct comparison here`|",
