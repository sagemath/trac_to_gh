...
```json
{
    "body": "<a id='comment:1'></a>This works for me in 8.1.rc3 (ie G1==G2). Which version of sage are you using ?",
    "created_at": "2017-11-29T20:49:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358942",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>This works for me in 8.1.rc3 (ie G1==G2). Which version of sage are you using ?
...
```json
{
    "body": "<a id='comment:3'></a>FYI - the ticket is #23150 (I just searched for the commit on trac).",
    "created_at": "2017-11-30T07:15:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358944",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:3'></a>FYI - the ticket is #23150 (I just searched for the commit on trac).
...
```json
{
    "body": "<a id='comment:4'></a>Actually I was wrong about what precisely it was that fixed this  issue. Ticket #23150 was already merged in 8.0, in which the bug is still present, so whatever fixed this, it wasn't that ticket. Anyway, the point is that something happened between 8.0 and 8.1.rc2 which fixed this -- it doesn't matter what! :-)",
    "created_at": "2017-11-30T07:23:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358945",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:4'></a>Actually I was wrong about what precisely it was that fixed this  issue. Ticket #23150 was already merged in 8.0, in which the bug is still present, so whatever fixed this, it wasn't that ticket. Anyway, the point is that something happened between 8.0 and 8.1.rc2 which fixed this -- it doesn't matter what! :-)
...
```json
{
    "body": "<a id='comment:5'></a>could you please recycle the ticket (title and description) for the remaining bug ?",
    "created_at": "2017-11-30T08:40:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358946",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:5'></a>could you please recycle the ticket (title and description) for the remaining bug ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358947",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358948",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358949",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This behaviour probably counts as \"broken by design\", since the docstring for the method `FinitelyGeneratedMatrixGroup_gap.__richcmp__` states\n\n> \"We treat two matrix groups as equal if their generators are the same in the same order.\"\n\n\nThis is a very strange notion of \"equality\" if you ask me!",
    "created_at": "2017-11-30T09:12:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358950",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:8'></a>This behaviour probably counts as "broken by design", since the docstring for the method `FinitelyGeneratedMatrixGroup_gap.__richcmp__` states
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358951",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>This isn't about isomorphism testing. Both H1 and H2 are, by definition, subgroups of the same ambient group, namely GL2(Z / 105 Z). I claim there is one and only one sensible way to define what it means for two subgroups of the same group to be \"equal\".",
    "created_at": "2017-11-30T11:52:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358952",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:10'></a>This isn't about isomorphism testing. Both H1 and H2 are, by definition, subgroups of the same ambient group, namely GL2(Z / 105 Z). I claim there is one and only one sensible way to define what it means for two subgroups of the same group to be "equal".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358953",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358955",
...
```json
{
    "body": "<a id='comment:15'></a>See also #24535",
    "created_at": "2018-06-03T10:30:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358957",
    "user": "https://github.com/videlec"
}
```

<a id='comment:15'></a>See also #24535
...
```json
{
    "body": "<a id='comment:16'></a>Here is another annoying bug.\nIt may or may not be related to this ticket.\n\n```\nsage: G = GL(2,5)\nsage: g = G( matrix([[1,0],[0,4]]))\nsage: H = G.subgroup([g])\nsage: g in H\nFalse\n```\nIn any case, it makes me dream of going back to magma.",
    "created_at": "2018-06-26T11:24:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24301#issuecomment-358958",
    "user": "https://github.com/categorie"
}
```

<a id='comment:16'></a>Here is another annoying bug.
It may or may not be related to this ticket.
