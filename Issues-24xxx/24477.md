...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463301",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>fixed by #31452, so duplicate, please confirm",
    "created_at": "2021-05-24T10:15:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463302",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>fixed by #31452, so duplicate, please confirm
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463303",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463304",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463305",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61772"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463306",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Wups : #31452 in **NOT** in 9.3 (I should wear my spectacles when reading `trac`...).\n\nI'll test this. Restoring status...\n\nApologies.\n\nReplying to [charpent](#comment%3A4):\n> Replying to [chapoton](#comment%3A3):\n> > fixed by #31452, so duplicate, please confirm\n\n> \n> Nope. On 9.3 :\n> \n> ```\n> sage: solve(x, [x], solution_dict=True)\n> ---------------------------------------------------------------------------\n> TypeError                                 Traceback (most recent call last)\n> <ipython-input-5-6f16dd325c63> in <module>\n> ----> 1 solve(x, [x], solution_dict=True)\n> \n> /usr/local/sage-9/local/lib/python3.9/site-packages/sage/symbolic/relation.py in solve(f, *args, **kwds)\n>    1041 \n>    1042     if is_Expression(f): # f is a single expression\n> -> 1043         return _solve_expression(f, x, explicit_solutions, multiplicities, to_poly_solve, solution_dict, algorithm, domain)\n>    1044 \n>    1045     if not isinstance(f, (list, tuple)):\n> \n> /usr/local/sage-9/local/lib/python3.9/site-packages/sage/symbolic/relation.py in _solve_expression(f, x, explicit_solutions, multiplicities, to_poly_solve, solution_dict, algorithm, domain)\n>    1366     if solution_dict:\n>    1367         if isinstance(x, (list, tuple)):\n> -> 1368             X = [{sol.left():sol.right() for sol in b} for b in X]\n>    1369         else:\n>    1370             X = [dict([[sol.left(),sol.right()]]) for sol in X]\n> \n> /usr/local/sage-9/local/lib/python3.9/site-packages/sage/symbolic/relation.py in <listcomp>(.0)\n>    1366     if solution_dict:\n>    1367         if isinstance(x, (list, tuple)):\n> -> 1368             X = [{sol.left():sol.right() for sol in b} for b in X]\n>    1369         else:\n>    1370             X = [dict([[sol.left(),sol.right()]]) for sol in X]\n> \n> TypeError: 'sage.symbolic.expression.Expression' object is not iterable\n> ```\n> \n> ==> `needs_work`, and relevant milestone.\n\n>",
    "created_at": "2021-05-24T10:45:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463307",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:5'></a>Wups : #31452 in **NOT** in 9.3 (I should wear my spectacles when reading `trac`...).
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61774"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463308",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Rebased on 9.3, {{{ptestlong}} of your branch gimes me exactly the same failures (two\n`gap`-related permanent failures and one transient `pari-gp` timeout) as 9.3.\n\n==> `positive_review` (for good, this time (I hope...)).",
    "created_at": "2021-05-24T14:24:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463309",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:6'></a>Rebased on 9.3, {{{ptestlong}} of your branch gimes me exactly the same failures (two
`gap`-related permanent failures and one transient `pari-gp` timeout) as 9.3.
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61776"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61777"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I'm stupid : I positioned `positive_review` on a `duplicate` ticket. Fixed. Time for a walk...",
    "created_at": "2021-05-24T14:26:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463310",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:7'></a>I'm stupid : I positioned `positive_review` on a `duplicate` ticket. Fixed. Time for a walk...
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61778"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24477#event-61780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24477",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24477#issuecomment-463311",
    "user": "https://github.com/fchapoton"
}
```
