...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|\n|[a591ffb](https://git.sagemath.org/sage.git/commit/?id=a591ffb6a55aa36ca84f105d0ffb304ab66eae48)|`Added the ability for packages to have a post-install script called spkg-postinst.`|\n|[599668c](https://git.sagemath.org/sage.git/commit/?id=599668c1ded51d5603395fe7e328cd5522b3dd0f)|`The postinst script should probably be run with SAGE_SUDO if it is set`|\n|[ac34ecb](https://git.sagemath.org/sage.git/commit/?id=ac34ecbe33d0fec7462374b05698aac4bd52bda7)|`Add a paragraph to the docs about spkg-postinst`|\n|[6519c3f](https://git.sagemath.org/sage.git/commit/?id=6519c3fe185169388743ed7742250c7988df9761)|`Use $SAGE_SUDO, in case it's set, when moving files from the $SAGE_DESTDIR to $SAGE_LOCAL`|\n|[454b75b](https://git.sagemath.org/sage.git/commit/?id=454b75b4a9dbf3a02bedc59392aaa1c875b37eff)|`Don't use SAGE_SUDO in these helpers if SAGE_DESTDIR is set`|\n|[fcd6e5d](https://git.sagemath.org/sage.git/commit/?id=fcd6e5d28644c3f24b01d719b6c422e251701c56)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|\n|[fd1719e](https://git.sagemath.org/sage.git/commit/?id=fd1719e051417e956af06a6fe4e51a09171dd366)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|",
    "created_at": "2018-03-26T11:20:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24646",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|\n|[d03844b](https://git.sagemath.org/sage.git/commit/?id=d03844b7b3897d837b5370c3e972900cbacc966b)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|",
    "created_at": "2018-05-14T15:35:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24646",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|\n|[6bbff40](https://git.sagemath.org/sage.git/commit/?id=6bbff408705de682799229f5d4c6bea3e8d2a044)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|\n|[00bd3f3](https://git.sagemath.org/sage.git/commit/?id=00bd3f3814f22b5d43c8402821f3df893ac380b9)|`try installing the symlink anyways and don't poke around SAGE_LOCAL`|",
    "created_at": "2018-05-16T09:53:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24646",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|\n|[5cb0a24](https://git.sagemath.org/sage.git/commit/?id=5cb0a245ebd386bc1fb38d7d46d3bb548d53ad81)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|\n|[208d754](https://git.sagemath.org/sage.git/commit/?id=208d754a61850cccb34b6a27afc3553fa7dc3bbb)|`try installing the symlink anyways and don't poke around SAGE_LOCAL`|",
    "created_at": "2018-06-02T15:11:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24646",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|\n|[49aa08f](https://git.sagemath.org/sage.git/commit/?id=49aa08f9840c02b753eb5e92a3ae9ed3fbe8cee4)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|\n|[449a6a2](https://git.sagemath.org/sage.git/commit/?id=449a6a29ff85becfefa9b915a9aa0e56a3ea409f)|`try installing the symlink anyways and don't poke around SAGE_LOCAL`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|\n|[b1412f5](https://git.sagemath.org/sage.git/commit/?id=b1412f50557397b0b7dd78fed5d9e897e8054204)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|\n|[4d20506](https://git.sagemath.org/sage.git/commit/?id=4d2050677eb89a12bd864f100b601ea3dc586887)|`try installing the symlink anyways and don't poke around SAGE_LOCAL`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|\n|[7643e66](https://git.sagemath.org/sage.git/commit/?id=7643e6604e42ec4bc86a23f45d4611756923a3f3)|`Add support for SAGE_DESTDIR to sdh_pip_install, thus making most Python packages work with staged installation`|\n|[32f5bbe](https://git.sagemath.org/sage.git/commit/?id=32f5bbeac804b37776007407eb00b8acd39559e7)|`try installing the symlink anyways and don't poke around SAGE_LOCAL`|\n|[ff1ccd3](https://git.sagemath.org/sage.git/commit/?id=ff1ccd3c132a4bd27a36a1c56ecaf171ad3b7a5d)|`bump package version on sagenb since its spkg-install changes are slightly non-trivial`|",
    "created_at": "2018-07-30T16:22:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24646",
    "type": "issue_comment",
