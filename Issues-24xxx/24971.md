...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327393"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327395"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24971#issuecomment-382998",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24971#issuecomment-382999",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327396"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24971#issuecomment-383000",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327397"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327398"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327399"
}
```
...
```json
{
    "body": "Changed keywords from **** to **preparser**",
    "created_at": "2020-10-09T13:44:17Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/24971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24971#issuecomment-383001",
    "user": "https://github.com/slel"
}
```

Changed keywords from **** to **preparser**
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24971#event-327400"
}
```
