...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24231#event-318129"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24231#event-318130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24231#event-318131"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24231#event-318132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24231#issuecomment-369395",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "Changed keywords from **** to **maxima, demoivre, cosh, sinh**",
    "created_at": "2021-11-30T22:54:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/24231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24231#issuecomment-369396",
    "user": "https://github.com/slel"
}
```

Changed keywords from **** to **maxima, demoivre, cosh, sinh**
