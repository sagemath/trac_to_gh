...
```json
{
    "body": "<a id='comment:2'></a>Still broken in `8.5.beta2`, but #26288 seems to fix this.",
    "created_at": "2018-11-06T23:53:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24657#issuecomment-467984",
    "user": "https://github.com/Konrad127123"
}
```

<a id='comment:2'></a>Still broken in `8.5.beta2`, but #26288 seems to fix this.
...
```json
{
    "body": "<a id='comment:4'></a>On Debian unstable this bug is only triggered if the system `tk8.6-dev` package is installed.",
    "created_at": "2018-11-08T15:31:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24657#issuecomment-467986",
    "user": "https://github.com/Konrad127123"
}
```

<a id='comment:4'></a>On Debian unstable this bug is only triggered if the system `tk8.6-dev` package is installed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24657#issuecomment-467988",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24657#event-62080"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Let's close this as a duplicate of #28730.",
    "created_at": "2019-11-14T00:44:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24657#issuecomment-467989",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>Let's close this as a duplicate of #28730.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24657#issuecomment-467990",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24657#issuecomment-467991",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24657",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24657#event-62081"
}
```
