...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24657#issuecomment-377169",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24657#issuecomment-377170",
    "user": "https://github.com/Konrad127123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24657#event-323394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24657#event-323395"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24657#event-323396"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24657",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24657#event-323397"
}
```
