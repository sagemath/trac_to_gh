...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308386"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308388"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308389"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308390"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308391"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308395"
}
```
...
```json
{
    "body": "Changed keywords from **** to **upgrade, networkx**",
    "created_at": "2018-06-22T01:38:01Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/24374",
    "type": "issue_comment",
...
Changed keywords from **** to **upgrade, networkx**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308396"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308397"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24374#issuecomment-371912",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308398"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24374",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24374#event-308399"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24374#issuecomment-371913",
