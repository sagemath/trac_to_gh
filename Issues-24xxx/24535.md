...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24535#event-321800"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24535#event-321801"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24535#event-321802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24535#event-321803"
}
```
...
```json
{
    "body": "Changed keywords from **** to **days93**",
    "created_at": "2018-01-12T19:39:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/24535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24535#issuecomment-374212",
    "user": "https://github.com/videlec"
}
```

Changed keywords from **** to **days93**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24535#issuecomment-374213",
