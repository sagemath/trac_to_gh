...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24671#issuecomment-377462",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24671#issuecomment-377463",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24671#event-323565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24671#event-323566"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24671#event-323567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24671#event-323568"
}
```
