...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24801#event-344863"
}
```
...
archive/issue_events_344864.json:
```json
{
    "actor": "https://github.com/nthiery",
    "created_at": "2018-02-21T08:42:38Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24801#event-344864"
}
```
...
archive/issue_events_344865.json:
```json
{
    "actor": "https://github.com/nthiery",
    "created_at": "2018-02-21T08:42:38Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24801#event-344865"
}
```
...
archive/issue_events_344866.json:
```json
{
    "actor": "https://github.com/nthiery",
    "created_at": "2018-02-21T08:42:38Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24801#event-344866"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24801#event-344867"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24801#event-344868"
}
```
