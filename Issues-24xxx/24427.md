...
```json
{
    "body": "<a id='comment:12'></a>\nTo get the ball rolling, I updated the GAP sources according to the instructions in the SPKG.\nI haven't run the tests yet (rebuilding my Sage).\n\n---\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[3c56a1b](https://git.sagemath.org/sage.git/commit?id=3c56a1b498b6a8a4fc05e3cabc656469a237bc6f)|`24427: Upgrade to gap 4.8.10, first step: upgrade the sources`|\n|[a543971](https://git.sagemath.org/sage.git/commit?id=a543971fa359d9a5cd7009935c1a24de39e9601c)|`24427: expanded upgrade instructions for gap's spkg`|",
