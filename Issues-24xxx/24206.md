...
```json
{
    "body": "Changing branch from \"\" to \"u/chapoton/24206\"",
    "created_at": "2017-11-12T15:13:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457815",
    "user": "https://github.com/fchapoton"
}
```

Changing branch from "" to "u/chapoton/24206"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457816",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457817",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"cefa814dcb081ed0c197800bb190c5ec5981cc82\"",
    "created_at": "2017-11-12T15:13:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457818",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "" to "cefa814dcb081ed0c197800bb190c5ec5981cc82"
...
```json
{
    "body": "<a id='comment:2'></a>It already does that by inheriting from `TypeError` in both [Python2](https://docs.python.org/2/library/exceptions.html#exception-hierarchy) and [Python3](https://docs.python.org/3/library/exceptions.html#exception-hierarchy). So I don't understand what this ticket would change other than putting `BaseException` higher in the MRO.",
    "created_at": "2017-11-12T22:38:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457819",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>It already does that by inheriting from `TypeError` in both [Python2](https://docs.python.org/2/library/exceptions.html#exception-hierarchy) and [Python3](https://docs.python.org/3/library/exceptions.html#exception-hierarchy). So I don't understand what this ticket would change other than putting `BaseException` higher in the MRO.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457820",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24206#event-61338"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>ok, then ket us forget about that.",
    "created_at": "2017-11-13T07:00:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457821",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>ok, then ket us forget about that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457822",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457823",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24206#issuecomment-457824",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24206",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24206#event-61339"
}
```
