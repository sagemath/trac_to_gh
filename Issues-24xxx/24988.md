...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24988#event-345637"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24988#event-345638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24988#event-345639"
}
```
...
archive/issue_events_345640.json:
```json
{
    "actor": "https://github.com/cnassau",
    "created_at": "2018-03-15T16:58:22Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24988#event-345640"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24988#issuecomment-380580",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24988#issuecomment-380581",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24988#issuecomment-380582",
    "user": "https://github.com/cnassau"
}
```
...
archive/issue_events_345641.json:
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24988#event-345641"
}
```
