...
```json
{
    "body": "<a id='comment:1'></a>OK, this works on 10.12 as well. Anyone to test on OSX 10.11 ? (We most probably don't need to go any further)\n\n---\nNew commits:",
    "created_at": "2017-12-14T10:28:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461525",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:1'></a>OK, this works on 10.12 as well. Anyone to test on OSX 10.11 ? (We most probably don't need to go any further)
...
```json
{
    "body": "Changing commit from \"\" to \"84861cdd2b9215863e3e4d11794422539fcc83d8\"",
    "created_at": "2017-12-14T10:28:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461526",
    "user": "https://github.com/dimpase"
}
```

Changing commit from "" to "84861cdd2b9215863e3e4d11794422539fcc83d8"
...
```json
{
    "body": "Changing branch from \"\" to \"u/dimpase/mac-appfix\"",
    "created_at": "2017-12-14T10:28:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461527",
    "user": "https://github.com/dimpase"
}
```

Changing branch from "" to "u/dimpase/mac-appfix"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461528",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Just a build fix, not a run fix?  Remind me the process for testing this and I can try it out.",
    "created_at": "2017-12-15T13:22:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461529",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>Just a build fix, not a run fix?  Remind me the process for testing this and I can try it out.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461530",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>> after building Sage, cd to src/mac-app/ and type `make`. After a while you'd get a `sage-8*.dmg` file which you can test by opening, installing (in the usual OSX way) and running.\n\n\nGreat, I just upgraded to the first beta so I can try this quite soon.",
    "created_at": "2017-12-16T00:38:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461531",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>> after building Sage, cd to src/mac-app/ and type `make`. After a while you'd get a `sage-8*.dmg` file which you can test by opening, installing (in the usual OSX way) and running.
...
```json
{
    "body": "<a id='comment:5'></a>It works for me on OS X 10.13, as reported on sage-devel. (Actually, there I just reported building correctly, but it also unpacks and then runs successfully.)",
    "created_at": "2017-12-16T01:02:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461532",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:5'></a>It works for me on OS X 10.13, as reported on sage-devel. (Actually, there I just reported building correctly, but it also unpacks and then runs successfully.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461534",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>The whole story is probably due to the format changes in .DS_store that happened as 10.12 was released.\nSee https://bitbucket.org/al45tair/ds_store/issues/7",
    "created_at": "2017-12-16T10:19:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461535",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:8'></a>The whole story is probably due to the format changes in .DS_store that happened as 10.12 was released.
See https://bitbucket.org/al45tair/ds_store/issues/7
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461537",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>In fact, if you have a look at the Makefile in question, you will see that it explicitly sets Sage.app to be located in `/Applications`. Other locations won't work (it's something not well-documented it seems).\nA [better installer](https://stackoverflow.com/questions/11487596/making-os-x-installer-packages-like-a-pro-xcode-developer-id-ready-pkg) would directly move Sage.app to `/Applications`, rather than \ninviting to move it there. Something for another ticket.\n\nAs well, the existing Sage tree, related to this build, must not be moved/deleted.",
    "created_at": "2017-12-16T19:11:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461539",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:12'></a>In fact, if you have a look at the Makefile in question, you will see that it explicitly sets Sage.app to be located in `/Applications`. Other locations won't work (it's something not well-documented it seems).
A [better installer](https://stackoverflow.com/questions/11487596/making-os-x-installer-packages-like-a-pro-xcode-developer-id-ready-pkg) would directly move Sage.app to `/Applications`, rather than 
inviting to move it there. Something for another ticket.
...
```json
{
    "body": "<a id='comment:14'></a>By the way, I think it's worth having a ticket that this creates a `tmp-...` dmg file in `src/mac-app` that is not eventually trashed.\n\nSeparately, I have no idea why making the app this way makes one that is 7.3 GB and not the usual 3.4 GB; something is being doubled, probably by the way I'm doing it, but I have no idea what.  Maybe it's packaging up an extra dmg in the dmg, who knows.",
    "created_at": "2017-12-17T00:56:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461541",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>By the way, I think it's worth having a ticket that this creates a `tmp-...` dmg file in `src/mac-app` that is not eventually trashed.
...
```json
{
    "body": "<a id='comment:15'></a>About comment 14: the tmp-...dmg file is read-write so that we can mount it and call AppleScript in the mounted directory to set the background image. Read-write dmg's cannot be compressed. After we call AppleScript, we can compress it resulting in a read-only dmg.\n\nI refer to comment 2 in Ticket #23426 for more.",
    "created_at": "2017-12-17T01:50:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461542",
    "user": "https://github.com/unhyperbolic"
}
```

<a id='comment:15'></a>About comment 14: the tmp-...dmg file is read-write so that we can mount it and call AppleScript in the mounted directory to set the background image. Read-write dmg's cannot be compressed. After we call AppleScript, we can compress it resulting in a read-only dmg.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461543",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>> > * I `git pull trac develop`, and the switched branches or not ...\n \n> \n> you have to build Sage first, and only after that\n> build mac-app.\n\nRight, I did do that but forgot to say so.\n\n> > Again, as data point, when I use `binary-pkg` to create a binary I don't have problems with relocation, so there is something I'm doing wrong in this process.  Maybe because my original Sage doesn't live in `Applications`?  But I don't want it there, because it's not an app, it's the command line and my \"development\" version.\n\n> \n> No, the original Sage does not have to be in /Applications\n\n\nThen I have no explanation for this behavior.",
    "created_at": "2017-12-19T19:18:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461544",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:17'></a>> > * I `git pull trac develop`, and the switched branches or not ...
...
```json
{
    "body": "<a id='comment:18'></a>I am told that Mac-app building does not work on OSX 10.11 without the patch.\nThus the question whether this patch introduces a regression there is moot.",
    "created_at": "2018-01-08T15:04:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461545",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:18'></a>I am told that Mac-app building does not work on OSX 10.11 without the patch.
Thus the question whether this patch introduces a regression there is moot.
...
```json
{
    "body": "<a id='comment:19'></a>That's weird because I am successful on 10.11.  But go ahead and I can test it once merged too - let me know.",
    "created_at": "2018-01-08T18:18:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461546",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:19'></a>That's weird because I am successful on 10.11.  But go ahead and I can test it once merged too - let me know.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461547",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461548",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>the ticket has fields author and reviewer, check them :-)\n\nwhy would you need it merged for testing?",
    "created_at": "2018-01-09T08:00:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461549",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:22'></a>the ticket has fields author and reviewer, check them :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461551",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>> git branch and repo used by `binary-pkg` is controlled by lines 3 and 4 of [sage.yaml](https://github.com/sagemath/binary-pkg/blob/master/sage.yaml) - you can change them to whatever you like.\n> \n> Namely, setting  them to \n> \n> ```\n> repository: https://github.com/sagemath/sagetrac-mirror.git\n> branch: u/dimpase/mac-appfix\n> ```\n> should do the trick.\n\nAh, I didn't know I could access the branch that way!  I do edit this file but typically only in stupid ways.  There was another thread where we were warned not to use `sagetrac-mirror` ;-) but this is a good use of it.\n\nWith some luck before I leave work today I might have something useful to say about this on 10.11.",
    "created_at": "2018-01-09T16:18:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461552",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:25'></a>> git branch and repo used by `binary-pkg` is controlled by lines 3 and 4 of [sage.yaml](https://github.com/sagemath/binary-pkg/blob/master/sage.yaml) - you can change them to whatever you like.
> 
> Namely, setting  them to 
> 
> ```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461553",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Are you trying with a fresh clone of https://github.com/sagemath/binary-pkg ?\nDoes it work with these lines in sage.yaml unchanged?\n\nIt works for me on Linux and on OSX 10.13:\n\n1) change these lines in sage.yaml as follows:\n\n```\nrepository: https://github.com/sagemath/sagetrac-mirror.git\nbranch: u/dimpase/mac-appfix\n```\n\n2) run `make package-sage`\n\n3) ...",
    "created_at": "2018-01-09T16:57:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461554",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:27'></a>Are you trying with a fresh clone of https://github.com/sagemath/binary-pkg ?
Does it work with these lines in sage.yaml unchanged?
...
```json
{
    "body": "<a id='comment:29'></a>Indeed, binary-pkg installs a miniconda to get a good python, and perhaps some stale files prevented this from being updated properly. On OSX 10.13 I see\n\n```\n$ ./tools/binary-pkg/bin/python\nPython 3.6.4 | packaged by conda-forge | (default, Dec 23 2017, 16:54:01) \n[GCC 4.2.1 Compatible Apple LLVM 6.1.0 (clang-602.0.53)] on darwin\nType \"help\", \"copyright\", \"credits\" or \"license\" for more information.\n>>> import ld\n>>> \n```\nworking.",
    "created_at": "2018-01-09T18:38:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461556",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:29'></a>Indeed, binary-pkg installs a miniconda to get a good python, and perhaps some stale files prevented this from being updated properly. On OSX 10.13 I see
...
```json
{
    "body": "<a id='comment:30'></a>Probably that's what happened.  Currently building, but of course `SAGE_INSTALL_GCC='yes'` or something in `binary-pkg` and I didn't want to mess with that setting, so this will take a **long** time.",
    "created_at": "2018-01-09T19:12:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461557",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:30'></a>Probably that's what happened.  Currently building, but of course `SAGE_INSTALL_GCC='yes'` or something in `binary-pkg` and I didn't want to mess with that setting, so this will take a **long** time.
...
```json
{
    "body": "<a id='comment:31'></a>I presume you do `make package-sage PACKAGE=\"OSX mac app\"` - I forgot abou the last parameter.",
    "created_at": "2018-01-09T19:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461558",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:31'></a>I presume you do `make package-sage PACKAGE="OSX mac app"` - I forgot abou the last parameter.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461559",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Not only did it work, it saved my ... rear end, because the wireless at the Joint Meetings was sketchy enough I couldn't have given my talk using Sage in number theory without running my local Sage, which ended up being this very dmg :-)",
    "created_at": "2018-01-12T21:40:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461560",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:32'></a>Not only did it work, it saved my ... rear end, because the wireless at the Joint Meetings was sketchy enough I couldn't have given my talk using Sage in number theory without running my local Sage, which ended up being this very dmg :-)
...
```json
{
    "body": "Changing work_issues from \"check that this change works on older OSXs\" to \"\"",
    "created_at": "2018-01-12T21:40:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461561",
    "user": "https://github.com/kcrisman"
}
```

Changing work_issues from "check that this change works on older OSXs" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461562",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Changing branch from \"u/dimpase/mac-appfix\" to \"84861cdd2b9215863e3e4d11794422539fcc83d8\"",
    "created_at": "2018-01-14T10:14:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461563",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/dimpase/mac-appfix" to "84861cdd2b9215863e3e4d11794422539fcc83d8"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24373#event-61628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24373#issuecomment-461564",
    "user": "https://github.com/vbraun"
}
```
