...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/24211",
...
```json
{
    "body": "<a id='comment:1'></a>Is `sin(x)/cos(x)` simplifiable for all x to `tan(x)`?",
    "created_at": "2017-11-13T14:23:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457869",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>Is `sin(x)/cos(x)` simplifiable for all x to `tan(x)`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457870",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457871",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457872",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457873",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24211#event-61347"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>These doctest now work with Pynac master:\n\n```\nsage: [arcsin(t) for t in [0, 1/2, sqrt(2)/2, sqrt(3)/2, 1]]\n[0, 1/6*pi, 1/4*pi, 1/3*pi, 1/2*pi]\nsage: [arcsin(-t) for t in [0, 1/2, sqrt(2)/2, sqrt(3)/2, 1]]\n[0, -1/6*pi, -1/4*pi, -1/3*pi, -1/2*pi]\nsage: [arctan(t) for t in [0, 1/sqrt(3), 1, sqrt(3)]]\n[0, 1/6*pi, 1/4*pi, 1/3*pi]\nsage: [arctan(-t) for t in [0, 1/sqrt(3), 1, sqrt(3)]]\n[0, -1/6*pi, -1/4*pi, -1/3*pi]\n```",
    "created_at": "2017-11-21T15:55:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457874",
    "user": "https://github.com/rwst"
}
```

<a id='comment:6'></a>These doctest now work with Pynac master:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457875",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>#24262 partially fixes some of these deficiencies. See its initial [review](https://trac.sagemath.org/ticket/24262#comment:4).",
    "created_at": "2017-11-22T22:17:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457876",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:8'></a>#24262 partially fixes some of these deficiencies. See its initial [review](https://trac.sagemath.org/ticket/24262#comment:4).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457877",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Edit : added similar examples with arccos/arctan.",
    "created_at": "2017-11-23T15:48:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24211#issuecomment-457878",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:9'></a>Edit : added similar examples with arccos/arctan.
