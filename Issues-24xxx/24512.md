...
```json
{
    "body": "<a id='comment:4'></a>\nFix plotting issues in `CycleGraph` and `WheelGraph`. I have also added a control on the input parameter.\n\n---\nNew commits:\n|                                                                                                                                          |                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[62c1467](https://git.sagemath.org/sage.git/commit?id=62c14676ba1e256b6293f210c2678407b01a7885)|`trac #24512: fix issues in WheelGraph and CycleGraph`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[8a45b32](https://git.sagemath.org/sage.git/commit/?id=8a45b32c1f1ed2a9e8d1f4b8c5201abf72f389f0)|`trac #24512: Merged with 8.2.beta3`|\n|[9a71f1c](https://git.sagemath.org/sage.git/commit/?id=9a71f1c203ff4e2e075dc3b0460cdce66fdd90c0)|`trac #24512: restore use of networkx for the creation of the graph`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[06bd4a3](https://git.sagemath.org/sage.git/commit/?id=06bd4a39cc55b52a110b4680c652fe76caeb58fb)|`trac #24512: stop using networkx in wheelgraph`|\n|[01f35a3](https://git.sagemath.org/sage.git/commit/?id=01f35a35647930d9d8e2f3a044551e4b7ac6f7f6)|`trac #24512: fix doctests in graphic_matroid`|",
