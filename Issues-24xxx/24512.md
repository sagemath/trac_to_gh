...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464006",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This makes perfect sense, I was planning to propose something like this, only using complete graphs.",
    "created_at": "2018-01-12T12:38:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464008",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:3'></a>This makes perfect sense, I was planning to propose something like this, only using complete graphs.
...
```json
{
    "body": "<a id='comment:4'></a>Fix plotting issues in `CycleGraph` and `WheelGraph`. I have also added a control on the input parameter.\n\n---\nNew commits:",
    "created_at": "2018-01-12T14:52:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464009",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:4'></a>Fix plotting issues in `CycleGraph` and `WheelGraph`. I have also added a control on the input parameter.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464010",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464011",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464012",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464013",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464014",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464015",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464016",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464017",
...
```json
{
    "body": "<a id='comment:6'></a>Test failures, see patchbot",
    "created_at": "2018-01-18T20:11:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464018",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:6'></a>Test failures, see patchbot
...
```json
{
    "body": "<a id='comment:7'></a>The problem is in `src/sage/matroids/graphic_matroid.py`.\nSome tests are easy to fix, but I don't know how to fix the issue in `graphic_coextension` and `split_vertex`. I don't know these modules, so some help might be helpful here.",
    "created_at": "2018-01-18T23:58:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464019",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>The problem is in `src/sage/matroids/graphic_matroid.py`.
Some tests are easy to fix, but I don't know how to fix the issue in `graphic_coextension` and `split_vertex`. I don't know these modules, so some help might be helpful here.
...
```json
{
    "body": "<a id='comment:10'></a>> I'd say it's a bug in the graphic matroids code, and it is beyond the scope of this ticket. \n\n\nexactly.\n\n> On a practical note, could we have a less intrusive branch here, which only touches the plotting positions, but not the underlying graph?\n\n\nThe solution is to continue to use `networkx.wheel_graph(n)` and then convert the networkx graph to a sage graph.\n\n> And we'd open another ticket to deal with graphic matroids code, so please keep this branch alive as an illustration of the bug.\n\n\nSo we let this ticket as is for as long as the graphic matroid code has not been fixed. Right?",
    "created_at": "2018-01-19T10:41:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464022",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:10'></a>> I'd say it's a bug in the graphic matroids code, and it is beyond the scope of this ticket. 
...
```json
{
    "body": "<a id='comment:11'></a>I would rather dealt with the layout here, and opened another ticket for the matroid bug.\nOtherwise we have one ticket for two unrelated things, not good...",
    "created_at": "2018-01-19T12:25:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464023",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:11'></a>I would rather dealt with the layout here, and opened another ticket for the matroid bug.
Otherwise we have one ticket for two unrelated things, not good...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464026",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>OK, I was totally confused by your `G` above. Now I see that indeed, it suffices to adjust X (perhaps this is what you meant to say), by looking at `M.graph().edges()`:\n\n```\nsage: G=graphs.WheelGraph(5)\nsage: M = Matroid(range(8),G)\nsage: M.graph().edges()\n[(0, 1, 2),\n (0, 2, 4),\n (0, 3, 6),\n (0, 4, 7),\n (1, 2, 0),\n (1, 4, 1),\n (2, 3, 3),\n (3, 4, 5)]\nsage: M.graphic_coextension(0,X=[4,6]) # 4,6 are labels of 02 and 03\nGraphic matroid of rank 5 on 9 elements\n```\nSo this is how to fix the doctest - just 1-line change:\n\n```\nsage: M.graphic_coextension(0,X=[4,6])\n```",
    "created_at": "2018-01-19T23:44:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464027",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:15'></a>OK, I was totally confused by your `G` above. Now I see that indeed, it suffices to adjust X (perhaps this is what you meant to say), by looking at `M.graph().edges()`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464028",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464029",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I have restored the use of networkx for the creation of the graph to pass the tests in `graphic_matroid`.",
    "created_at": "2018-01-20T10:25:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464030",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:17'></a>I have restored the use of networkx for the creation of the graph to pass the tests in `graphic_matroid`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464031",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I thought you wanted to fix what concern matroids in #24573. You confirm that we adjust the test here ?",
    "created_at": "2018-01-20T12:18:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464033",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:19'></a>I thought you wanted to fix what concern matroids in #24573. You confirm that we adjust the test here ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464034",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464035",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464036",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Hope it will be ok now.",
    "created_at": "2018-01-20T14:41:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464037",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:22'></a>Hope it will be ok now.
...
```json
{
    "body": "<a id='comment:23'></a>OK, looks good, thanks!",
    "created_at": "2018-01-20T16:31:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464038",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:23'></a>OK, looks good, thanks!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464039",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464040",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24512#issuecomment-464041",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24512",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24512#event-61828"
}
```
