...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24469#event-320985"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24469#event-320986"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24469#event-320987"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24469#event-320988"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24469#issuecomment-373180",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24469#issuecomment-373181",
    "user": "https://github.com/slel"
}
```
