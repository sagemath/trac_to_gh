...
```json
{
    "body": "<a id='comment:1'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[e7a5e39](https://git.sagemath.org/sage.git/commit/?id=e7a5e3929ef2108094549a97e63e1dba3fb9b09f)|`Python 3 fixes for sage.misc.decorators.`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[0bb9b1a](https://git.sagemath.org/sage.git/commit/?id=0bb9b1a7c42e21b926e8546df179d1fff4ff1380)|`Python 3 fixes for sage.misc.decorators.`|",
    "created_at": "2018-06-26T08:20:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24562",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[19f3d11](https://git.sagemath.org/sage.git/commit/?id=19f3d118f4881914ec2cd3191c3bc5b3137ac4b7)|`dont' try to make sage_wraps work on classes at all`|\n|[1f61a71](https://git.sagemath.org/sage.git/commit/?id=1f61a71b8b899cec2a4477f171e5135540b7140f)|`for compatibility with Python 3's functools.wraps, set __wrapped__ attribute on the wrapper function`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[44ee2ec](https://git.sagemath.org/sage.git/commit/?id=44ee2ec1bf1c6cd3e1d4654a2ad3696fe3376b2b)|`clean up the infix_operator docstrings a bit to demonstrate actual use as a decorator`|",
