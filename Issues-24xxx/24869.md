...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24869#issuecomment-367880",
...
```json
{
    "body": "<a id='comment:2'></a>We should use Smith form rather than row echelon form, since it's more stable.",
    "created_at": "2019-09-07T12:01:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24869#issuecomment-367881",
    "user": "https://github.com/roed314"
}
```

<a id='comment:2'></a>We should use Smith form rather than row echelon form, since it's more stable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24869#issuecomment-367882",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This issue seems to be fixed after ticket #23486.",
    "created_at": "2022-06-02T09:39:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24869#issuecomment-367883",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:3'></a>This issue seems to be fixed after ticket #23486.
