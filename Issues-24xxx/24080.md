...
```json
{
    "body": "<a id='comment:6'></a>I think now it's superfluous because `ex.op()` does the same and it's short enough.",
    "created_at": "2017-11-18T16:09:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24080",
    "type": "issue_comment",
...
<a id='comment:6'></a>I think now it's superfluous because `ex.op()` does the same and it's short enough.
