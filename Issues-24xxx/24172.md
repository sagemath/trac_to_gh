...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24172#issuecomment-457323",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Someooooone suggested to support the pythonic syntax `!x[(1,2)]` for the negation of a variable ;)",
    "created_at": "2018-01-02T12:43:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24172#issuecomment-457324",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:2'></a>Someooooone suggested to support the pythonic syntax `!x[(1,2)]` for the negation of a variable ;)
