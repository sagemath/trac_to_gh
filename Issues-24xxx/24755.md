...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366298",
...
```json
{
    "body": "<a id='comment:3'></a>There is a specific strangeness about `Piecewise`: the deprecation warning is shown every time, even in interactive usage:\n\n```\nsage: f1(x) = 1\nsage: f2(x) = 1 - x\nsage: f = Piecewise([[(0,1),f1],[(1,2),f2]])\n/usr/local/src/sage-config/src/bin/sage-ipython:1: DeprecationWarning: use lower-case piecewise instead\nSee http://trac.sagemath.org/14801 for details.\n  #!/usr/bin/env sage-python23\nsage: f = Piecewise([[(0,1),f1],[(1,2),f2]])\n/usr/local/src/sage-config/src/bin/sage-ipython:1: DeprecationWarning: use lower-case piecewise instead\nSee http://trac.sagemath.org/14801 for details.\n  #!/usr/bin/env sage-python23\n```",
    "created_at": "2018-04-27T14:56:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366299",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>There is a specific strangeness about `Piecewise`: the deprecation warning is shown every time, even in interactive usage:
...
```json
{
    "body": "<a id='comment:4'></a>`Piecewise` is a lazy import, but that's not the cause:\n\n```\nsage: f1(x) = 1\nsage: f2(x) = 1 - x\nsage: Piecewise = Piecewise._get_object()\nsage: f = Piecewise([[(0,1),f1],[(1,2),f2]])\n/usr/local/src/sage-config/src/bin/sage-ipython:1: DeprecationWarning: use lower-case piecewise instead\nSee http://trac.sagemath.org/14801 for details.\n  #!/usr/bin/env sage-python23\nsage: f = Piecewise([[(0,1),f1],[(1,2),f2]])\n/usr/local/src/sage-config/src/bin/sage-ipython:1: DeprecationWarning: use lower-case piecewise instead\nSee http://trac.sagemath.org/14801 for details.\n  #!/usr/bin/env sage-python23\n```",
    "created_at": "2018-04-27T15:02:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366300",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>`Piecewise` is a lazy import, but that's not the cause:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366301",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I'd still like to know why this specific warning behaves differently from other very similar warnings.",
    "created_at": "2018-04-30T05:04:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366302",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>I'd still like to know why this specific warning behaves differently from other very similar warnings.
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62260"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62261"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62262"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62263"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62264"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62265"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366305",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62266"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24755#event-62267"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Removing most of the rest of my open tickets out of the 8.7 milestone, which should be closed.",
    "created_at": "2019-03-25T10:44:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366306",
    "user": "https://github.com/embray"
}
```

<a id='comment:12'></a>Removing most of the rest of my open tickets out of the 8.7 milestone, which should be closed.
...
```json
{
    "body": "<a id='comment:13'></a>apparently, the fix has been merged (NO, SORRY, NOT MERGED YET)\n\nhttps://github.com/python/cpython/pull/8232\n\nMaybe we should upgrade cpython ?",
    "created_at": "2019-04-09T07:12:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366307",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:13'></a>apparently, the fix has been merged (NO, SORRY, NOT MERGED YET)
...
```json
{
    "body": "<a id='comment:14'></a>Yeah, I know it's had a proposed fix for a while; it's just sitting around waiting for review, as is often the case as there are not enough cpython core developers to review most bug fix PRs, especially for relatively non-critical stuff.  \n\nPerhaps I could try to make some noise about this one because it would be good to have fixed.  In the meantime I'd be hesitant to rely on a patch to work around this.\n\nI think my earlier suggestion\n\n> Perhaps at least for Sage's deprecation warnings we can brute force keep our own warnings registry so that each deprecation is truly only reported once no matter what.\n\n\nis going to end up being simplest until this is fixed upstream.  It sucks, but it's better than nothing and probably not too hard.  I could try to tackle it though it will take me a little time to reorient myself to the warnings module code, since it's been nearly a year since I last looked into it.",
    "created_at": "2019-04-10T12:37:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366308",
    "user": "https://github.com/embray"
}
```

<a id='comment:14'></a>Yeah, I know it's had a proposed fix for a while; it's just sitting around waiting for review, as is often the case as there are not enough cpython core developers to review most bug fix PRs, especially for relatively non-critical stuff.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366309",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>The file `piecewise_old.py` has been removed by #26865, so this ticket should probably either be updated with another example in its description or be closed as \"invalid/wontfix/worksforme\".",
    "created_at": "2019-09-17T00:53:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366310",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:16'></a>The file `piecewise_old.py` has been removed by #26865, so this ticket should probably either be updated with another example in its description or be closed as "invalid/wontfix/worksforme".
...
```json
{
    "body": "<a id='comment:17'></a>the `catch_warnings()` context manager is not meant to work in multithreaded environment: https://docs.python.org/3/library/warnings.html\n\nthis looks like it's basically doomed to be broken for our doctests - see e.g. #28329\nwhere this resurfaced.",
    "created_at": "2019-12-08T22:59:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366311",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:17'></a>the `catch_warnings()` context manager is not meant to work in multithreaded environment: https://docs.python.org/3/library/warnings.html
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366312",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>This does not explain how the interference from #28329 (i.e. https://git.sagemath.org/sage.git/commit/?id=6192e54fe6894b5c444e1a2cb7d0adeec1d94348) can make a difference here.\nBecause it should have been totally safe in a single-threaded environment!",
    "created_at": "2019-12-09T10:53:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366313",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:19'></a>This does not explain how the interference from #28329 (i.e. https://git.sagemath.org/sage.git/commit/?id=6192e54fe6894b5c444e1a2cb7d0adeec1d94348) can make a difference here.
Because it should have been totally safe in a single-threaded environment!
...
```json
{
    "body": "<a id='comment:20'></a>No, it explains it exactly.  The original change used warnings.catch_warnings(), and if that code happened to be called from anywhere in that module it would reset the warnings registry for that module and cause warnings that were previously shown to be shown again instead of hidden.\n\nAgain, threads have nothing to do with it.  It is a single-threaded environment.",
    "created_at": "2019-12-09T15:38:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366314",
    "user": "https://github.com/embray"
}
```

<a id='comment:20'></a>No, it explains it exactly.  The original change used warnings.catch_warnings(), and if that code happened to be called from anywhere in that module it would reset the warnings registry for that module and cause warnings that were previously shown to be shown again instead of hidden.
...
```json
{
    "body": "<a id='comment:21'></a>`catch_warnings()` has been called in context, in `with` block. Are you saying this changes global state? Then the Python docs on it are wrong.",
    "created_at": "2019-12-09T15:43:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24755#issuecomment-366315",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:21'></a>`catch_warnings()` has been called in context, in `with` block. Are you saying this changes global state? Then the Python docs on it are wrong.
