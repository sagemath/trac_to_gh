...
```json
{
    "body": "<a id='comment:1'></a>The problem is that `init_sage` in `sage.doctest.forker` makes changes that aren't reset in the `finally` block of `run_doctests`.",
    "created_at": "2018-02-28T13:08:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24866#issuecomment-345118",
    "user": "https://github.com/roed314"
}
```

<a id='comment:1'></a>The problem is that `init_sage` in `sage.doctest.forker` makes changes that aren't reset in the `finally` block of `run_doctests`.
