...
```json
{
    "body": "Changing dependencies from \"\" to \"#22322\"",
    "created_at": "2017-11-02T15:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456786",
    "user": "https://github.com/rwst"
}
```

Changing dependencies from "" to "#22322"
...
```json
{
    "body": "<a id='comment:2'></a>These sets can be returned by `solveset`: `FiniteSet`, `EmptySet`, `Interval`, `Intersection`, `Union`, `ConditionSet`, `ImageSet`, `Complement`, plus the algebraic sets of numbers like ZZ, RR, CC. We can directly translate `FiniteSet`, `EmptySet`, `Interval`. `ConditionSet` is a AND-combination of a relation and a set, so this can be translated into list format too if the set is finite/interval. Often RR/CC are given as set, and they may be redundant (CC is default with no `domain=` option given, and RR is implicated with any inequality as condition).",
    "created_at": "2017-11-05T07:17:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456787",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>These sets can be returned by `solveset`: `FiniteSet`, `EmptySet`, `Interval`, `Intersection`, `Union`, `ConditionSet`, `ImageSet`, `Complement`, plus the algebraic sets of numbers like ZZ, RR, CC. We can directly translate `FiniteSet`, `EmptySet`, `Interval`. `ConditionSet` is a AND-combination of a relation and a set, so this can be translated into list format too if the set is finite/interval. Often RR/CC are given as set, and they may be redundant (CC is default with no `domain=` option given, and RR is implicated with any inequality as condition).
...
```json
{
    "body": "<a id='comment:3'></a>Should we translate to `sage.set` as optional output?",
    "created_at": "2017-11-05T07:27:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456788",
    "user": "https://github.com/rwst"
}
```

<a id='comment:3'></a>Should we translate to `sage.set` as optional output?
...
```json
{
    "body": "<a id='comment:4'></a>Let's use `sage.set` when we can't express the `solveset` result as list, and later support an option to always use `sage.set`. As to calling `solve` do this when `EmptySet` or the original expression is returned.",
    "created_at": "2017-11-05T07:57:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456789",
    "user": "https://github.com/rwst"
}
```

<a id='comment:4'></a>Let's use `sage.set` when we can't express the `solveset` result as list, and later support an option to always use `sage.set`. As to calling `solve` do this when `EmptySet` or the original expression is returned.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456792",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>See possibly also #31926 or some of its constituent tickets.",
    "created_at": "2021-06-09T00:44:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456794",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:10'></a>See possibly also #31926 or some of its constituent tickets.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456795",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61244"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61245"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61246"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61247"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61248"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61249"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61250"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24142#issuecomment-456796",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61251"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24142#event-61252"
}
```
