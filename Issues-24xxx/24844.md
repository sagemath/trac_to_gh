...
```json
{
    "body": "here is a naive tentative for a start, feel free to take over and enhance\n\n---\nNew commits:",
...
```json
{
    "body": "I think you should add a test for the infinite order case, please.",
...
```json
{
    "body": "ok, thanks. No need to list me as an author.",
    "created_at": "2018-03-02T09:03:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24844",
    "type": "issue_comment",
