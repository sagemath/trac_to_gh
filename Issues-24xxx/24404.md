...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-338250"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-338251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-338252"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-338253"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24404#issuecomment-369561",
    "user": "https://github.com/vit-tucek"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24404#issuecomment-369562",
    "user": "https://github.com/vit-tucek"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-338254"
}
```
