...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-320221"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-320222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-320223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24404#event-320224"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24404#issuecomment-372224",
    "user": "https://github.com/vit-tucek"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24404#issuecomment-372225",
    "user": "https://github.com/vit-tucek"
}
```
