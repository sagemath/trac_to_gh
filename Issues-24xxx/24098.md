...
<a id='comment:18'></a>Replying to [sbrandhorst](#comment%3A14):
> How about `hilbert_conductor_inverse` as a name?
...
```json
{
    "body": "<a id='comment:22'></a>Replying to [sbrandhorst](#comment%3A21):\n> i could settle for\n> hilbert_symbol_negative_at_S\n> \n> :)\n\n\nAh, yes, even better.  Let's go with that :)",
...
<a id='comment:22'></a>Replying to [sbrandhorst](#comment%3A21):
> i could settle for
> hilbert_symbol_negative_at_S
> 
> :)
...
<a id='comment:31'></a>Replying to [sbrandhorst](#comment%3A30):
> We have a green bot. Tests pass.
