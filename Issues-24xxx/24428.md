...
```json
{
    "body": "<a id='comment:27'></a>\nThis needs fixes from pynac-0.7.17. To fix `RR(-1).log` I'd suggest a similar change in `functions/log.py` to enable the fix of `RR.log()`.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[ff8c672](https://git.sagemath.org/sage.git/commit?id=ff8c67205b0caf68bf7269aaccdf600f1533a4d7)|`24832: Extend function domain with some symbolic function calls`|\n|[3bfcc88](https://git.sagemath.org/sage.git/commit?id=3bfcc88024038de47d191a7fdda32f79db5132b2)|`24832: add doctest`|\n|[aa041a9](https://git.sagemath.org/sage.git/commit?id=aa041a972d4b09a1e8b771b370e57f9f9ac19f7b)|`24428: Numerical evaluation should return a complex number if applicable`|",
    "created_at": "2018-02-25T09:18:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24428",
    "type": "issue_comment",
