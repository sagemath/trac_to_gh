...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459177",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Why not `# optional - python2` or `# optional - python3`? That's reusing an existing system for optional tests.",
    "created_at": "2017-11-21T15:59:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459178",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>Why not `# optional - python2` or `# optional - python3`? That's reusing an existing system for optional tests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459179",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459180",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I think it would be better to have `# py2` and `# py3` behave like the `# 32-bit` and `# 64-bit` and be specific for the output. I guess there is also the question of how many of our doctest inputs are going to be specific for Python2. Do any of you have an impression? I think it might be marginal at worst, in which case, we can just build into the doctests an explicit check of Python2 vs 3 as part of the doctest itself.",
    "created_at": "2017-11-22T04:44:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459181",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:5'></a>I think it would be better to have `# py2` and `# py3` behave like the `# 32-bit` and `# 64-bit` and be specific for the output. I guess there is also the question of how many of our doctest inputs are going to be specific for Python2. Do any of you have an impression? I think it might be marginal at worst, in which case, we can just build into the doctests an explicit check of Python2 vs 3 as part of the doctest itself.
...
```json
{
    "body": "<a id='comment:6'></a>I wouldn't mind changing it to apply to the output but not skip the test.  That would actually be better since if the behavior on Python 3 changes in these cases (e.g. `sagenb` works, to use my previous example) then we'd want to see that reflected in the test results.\n\nI think a stronger possibility is *Python 3* only inputs, such as doing things with annotations and other Python 3 only syntax.  So maybe having these tags work on both output and input would be good?",
    "created_at": "2017-11-22T13:11:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459182",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>I wouldn't mind changing it to apply to the output but not skip the test.  That would actually be better since if the behavior on Python 3 changes in these cases (e.g. `sagenb` works, to use my previous example) then we'd want to see that reflected in the test results.
...
```json
{
    "body": "<a id='comment:7'></a>I would not oppose that, but I don't think we do anything like that elsewhere. So it might require some invasive changes and might cause some slight confusion (but that is debatable). I think we would be better off having a separate marker for Python3 input.",
    "created_at": "2017-11-22T22:01:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459183",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:7'></a>I would not oppose that, but I don't think we do anything like that elsewhere. So it might require some invasive changes and might cause some slight confusion (but that is debatable). I think we would be better off having a separate marker for Python3 input.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459185",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I just realized there's a bug in how this is implemented, where tests containing these tags are skipped regardless.",
    "created_at": "2017-12-01T11:12:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459186",
    "user": "https://github.com/embray"
}
```

<a id='comment:9'></a>I just realized there's a bug in how this is implemented, where tests containing these tags are skipped regardless.
...
```json
{
    "body": "<a id='comment:10'></a>Implementation bug aside, I've been working on fixing the sageinspect module, and that's increasingly convinced me that having a concise way to run specific test cases on either Python 2 or Python 3 only is useful, especially in that module.",
    "created_at": "2017-12-01T11:16:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459187",
    "user": "https://github.com/embray"
}
```

<a id='comment:10'></a>Implementation bug aside, I've been working on fixing the sageinspect module, and that's increasingly convinced me that having a concise way to run specific test cases on either Python 2 or Python 3 only is useful, especially in that module.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459188",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459189",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Okay, this definitely works now.  My fixes to the sageinspect module (and in particular its tests) rely on this pretty heavily.",
    "created_at": "2017-12-01T13:58:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459190",
    "user": "https://github.com/embray"
}
```

<a id='comment:12'></a>Okay, this definitely works now.  My fixes to the sageinspect module (and in particular its tests) rely on this pretty heavily.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459191",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459192",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459193",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459195",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459196",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>OK, fine. I don't really agree, but we have to move on. If you want to go forward with `# py2` and `# py3`, you should at least fix the existing uses of `# optional - python2` and `# optional - python3`. If you do that, I'm willing to set this ticket to positive review.",
    "created_at": "2017-12-07T17:29:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459197",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:16'></a>OK, fine. I don't really agree, but we have to move on. If you want to go forward with `# py2` and `# py3`, you should at least fix the existing uses of `# optional - python2` and `# optional - python3`. If you do that, I'm willing to set this ticket to positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459198",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Come on, there are really few instances of `# optional - python[23]` currently in Sage. It doesn't take much effort to fix those. And those can also double as testcase that the `# py2` and `# py3` markers actually work.",
    "created_at": "2017-12-08T09:39:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459199",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>Come on, there are really few instances of `# optional - python[23]` currently in Sage. It doesn't take much effort to fix those. And those can also double as testcase that the `# py2` and `# py3` markers actually work.
...
```json
{
    "body": "<a id='comment:19'></a>Alright, I have no problem doing it (I'll have to double-check but I think I've already fixed most of those cases). It just seemed antithetical to your normal philosophy (which I generally agree with...)",
    "created_at": "2017-12-08T10:45:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459200",
    "user": "https://github.com/embray"
}
```

<a id='comment:19'></a>Alright, I have no problem doing it (I'll have to double-check but I think I've already fixed most of those cases). It just seemed antithetical to your normal philosophy (which I generally agree with...)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459201",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459202",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459203",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Note: I also fixed one case of `# optional - python2` in #24286.",
    "created_at": "2017-12-08T11:04:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459204",
    "user": "https://github.com/embray"
}
```

<a id='comment:21'></a>Note: I also fixed one case of `# optional - python2` in #24286.
...
```json
{
    "body": "<a id='comment:22'></a>typo : \"on optionl features\" in src/doc/en/developer/coding_basics.rst\n\none failing doctest in src/sage/doctest/sources.py",
    "created_at": "2017-12-14T15:45:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459205",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:22'></a>typo : "on optionl features" in src/doc/en/developer/coding_basics.rst
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459206",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459209",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459210",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459211",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>To solve your problem with `_test_enough_doctests`, you could add some extra attribute to `SageDocTestParser` to never skip any test (not even the `# py2` and `# py3` tests). Then you set that attribute when running `_test_enough_doctests`.",
    "created_at": "2017-12-19T12:27:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459212",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:28'></a>To solve your problem with `_test_enough_doctests`, you could add some extra attribute to `SageDocTestParser` to never skip any test (not even the `# py2` and `# py3` tests). Then you set that attribute when running `_test_enough_doctests`.
...
```json
{
    "body": "<a id='comment:29'></a>I'd still just as soon remove that test...",
    "created_at": "2018-01-02T15:27:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459213",
    "user": "https://github.com/embray"
}
```

<a id='comment:29'></a>I'd still just as soon remove that test...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459214",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459215",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>This variant re-uses the existing optional tags implementation. It passes all tests in `sage/doctest`.\n\n---\nNew commits:",
    "created_at": "2018-01-05T10:19:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459216",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:31'></a>This variant re-uses the existing optional tags implementation. It passes all tests in `sage/doctest`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459217",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459218",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>I don't fully understand what this is doing differently, but I'm not opposed as long as it works.",
    "created_at": "2018-01-05T12:08:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459219",
    "user": "https://github.com/embray"
}
```

<a id='comment:32'></a>I don't fully understand what this is doing differently, but I'm not opposed as long as it works.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459220",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>This seems to be ready to go, no ?",
    "created_at": "2018-01-06T19:21:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459221",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:34'></a>This seems to be ready to go, no ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459222",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>ok, let it be. Erik and Jeroen, I added your names as reviewers. Feel free to undo that.",
    "created_at": "2018-01-08T16:42:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459223",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:35'></a>ok, let it be. Erik and Jeroen, I added your names as reviewers. Feel free to undo that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459224",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>Yes, I understand how this is working now. +1",
    "created_at": "2018-01-09T13:34:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459225",
    "user": "https://github.com/embray"
}
```

<a id='comment:36'></a>Yes, I understand how this is working now. +1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459226",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459227",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24261#event-61421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459228",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>follow-up in #24570",
    "created_at": "2018-01-19T15:16:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24261#issuecomment-459229",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:38'></a>follow-up in #24570
