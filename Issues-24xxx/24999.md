...
```json
{
    "body": "<a id='comment:1'></a>With or without #21509?",
    "created_at": "2018-03-18T06:58:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475624",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>With or without #21509?
...
```json
{
    "body": "<a id='comment:2'></a>Just for completeness, I assume you mean Linux i386?",
    "created_at": "2018-03-18T06:59:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475625",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>Just for completeness, I assume you mean Linux i386?
...
```json
{
    "body": "<a id='comment:3'></a>And is this on every Linux i386 system, or one in particular?",
    "created_at": "2018-03-18T07:35:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475626",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>And is this on every Linux i386 system, or one in particular?
...
```json
{
    "body": "<a id='comment:4'></a>The strange thing is that I don't see why cysignals would depend on the CPU type in the first place. It's not doing fancy arithmetic, only syscalls. So I would expect that 32-bit Linux would behave the same as 64-bit Linux.",
    "created_at": "2018-03-18T07:47:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475627",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>The strange thing is that I don't see why cysignals would depend on the CPU type in the first place. It's not doing fancy arithmetic, only syscalls. So I would expect that 32-bit Linux would behave the same as 64-bit Linux.
...
```json
{
    "body": "<a id='comment:5'></a>This is with #21509. Fails on all 32-bit linux buildbots.",
    "created_at": "2018-03-18T09:54:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475628",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:5'></a>This is with #21509. Fails on all 32-bit linux buildbots.
...
```json
{
    "body": "<a id='comment:6'></a>From a few tests that I did so far, it seems that cysignals-1.6.8 is indeed problematic, but cysignals-1.6.9 seems to work. I don't have an explanation for this, I did not intentionally make changes related to 32-bit Linux in between those releases. I have updated #21509 with the latest release of cysignals, could you try that?",
    "created_at": "2018-03-19T08:09:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475629",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>From a few tests that I did so far, it seems that cysignals-1.6.8 is indeed problematic, but cysignals-1.6.9 seems to work. I don't have an explanation for this, I did not intentionally make changes related to 32-bit Linux in between those releases. I have updated #21509 with the latest release of cysignals, could you try that?
...
```json
{
    "body": "<a id='comment:7'></a>Also the cysignals-1.6.8 testsuite fails on 32-bit Linux, so consider that release broken.",
    "created_at": "2018-03-19T08:58:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475630",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>Also the cysignals-1.6.8 testsuite fails on 32-bit Linux, so consider that release broken.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24999#event-62717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24999#issuecomment-475631",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24999",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24999#event-62718"
}
```
