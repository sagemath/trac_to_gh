...
```json
{
    "body": "<a id='comment:1'></a>Package code currently at this link: https://github.com/kjcollins/3d_cayley_graphs. Model class is in cayley_model.sage.\n\n\n\nWe would like to include this as an addition to sage/plot/plot3d, if it's appropriate.",
...
<a id='comment:1'></a>Package code currently at this link: https://github.com/kjcollins/3d_cayley_graphs. Model class is in cayley_model.sage.
...
```json
{
    "body": "<a id='comment:5'></a>In order for the bot to test your ticket, it is required to have the field \"Authors\" filled with the full names of the authors",
...
<a id='comment:5'></a>In order for the bot to test your ticket, it is required to have the field "Authors" filled with the full names of the authors
...
```json
{
    "body": "<a id='comment:8'></a>Is there something specific about `ReflectionGroup` that you need to use? Why not `WeylGroup` or `CoxeterGroup` (when the Cartan/Coxeter type is a finite type)?",
    "created_at": "2018-07-11T15:35:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24280",
    "type": "issue_comment",
...
<a id='comment:8'></a>Is there something specific about `ReflectionGroup` that you need to use? Why not `WeylGroup` or `CoxeterGroup` (when the Cartan/Coxeter type is a finite type)?
...
<a id='comment:12'></a>The problem is that having
