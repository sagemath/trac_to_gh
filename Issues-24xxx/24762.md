...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24762#event-324770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24762#event-324771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24762#event-324772"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24762#event-324773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24762#issuecomment-379275",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24762#issuecomment-379276",
    "user": "https://github.com/dimpase"
}
```
