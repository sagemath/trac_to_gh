...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24255#event-318433"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24255#event-318434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24255#event-318435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24255#event-318436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24255#issuecomment-369805",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24255#issuecomment-369806",
    "user": "https://github.com/rwst"
}
```
