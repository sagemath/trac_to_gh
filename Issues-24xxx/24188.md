...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24188#issuecomment-368554",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-317556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-317557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-317558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24188",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-317559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24188#issuecomment-368555",
    "user": "https://github.com/koffie"
}
```
