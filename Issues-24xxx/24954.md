...
```json
{
    "body": "<a id='comment:1'></a>Idea: SemiWeakValueDictionary will initially create a strong reference to each value (say, by means of a class attribute holding a list containing the items), and gc.collect() will be monkey-patched so that it first removes all strong references kept by SemiWeakValueDictionary before doing the cyclic collection.\n\nIn that way, the values of SemiWeakValueDictionary would be permanent till the next cyclic garbage collection occurs.\n\nWould that work?",
    "created_at": "2018-03-12T12:12:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474652",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:1'></a>Idea: SemiWeakValueDictionary will initially create a strong reference to each value (say, by means of a class attribute holding a list containing the items), and gc.collect() will be monkey-patched so that it first removes all strong references kept by SemiWeakValueDictionary before doing the cyclic collection.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474656",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474658",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>So, in practice, the main difference between (A) and (C) is *when* are the strong references cleared? With (A), it would happen after 100 objects have been inserted in a `WeakValueDictionary` and with (C) it would happen upon garbage collection. I have no idea what works best.",
    "created_at": "2018-03-12T13:29:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474659",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>So, in practice, the main difference between (A) and (C) is *when* are the strong references cleared? With (A), it would happen after 100 objects have been inserted in a `WeakValueDictionary` and with (C) it would happen upon garbage collection. I have no idea what works best.
...
```json
{
    "body": "<a id='comment:10'></a>Ouch, I found the problem: An unreferenced variable \"cls\" in the callback function that shouldn't belong there...\n\nNonetheless, so far, I don't get it to work.",
    "created_at": "2018-03-12T13:57:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474661",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>Ouch, I found the problem: An unreferenced variable "cls" in the callback function that shouldn't belong there...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474662",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/jdemeyer/stronger_references_in_cachedrepresentation\"",
    "created_at": "2018-03-12T14:54:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474663",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "" to "u/jdemeyer/stronger_references_in_cachedrepresentation"
...
```json
{
    "body": "<a id='comment:13'></a>This is my proof-of-concept implementation. It simply adds strong references to the last 64 objects added to the `CachedWeakValueDictionary`.\n\n---\nNew commits:",
    "created_at": "2018-03-12T14:57:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474664",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>This is my proof-of-concept implementation. It simply adds strong references to the last 64 objects added to the `CachedWeakValueDictionary`.
...
```json
{
    "body": "Changing commit from \"\" to \"99717eb55a7833b630e5fd0732dc45b2c0b98d8c\"",
    "created_at": "2018-03-12T14:57:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474665",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "99717eb55a7833b630e5fd0732dc45b2c0b98d8c"
...
```json
{
    "body": "<a id='comment:14'></a>Thats the obvious solution, keep a finite-length lru cache around.",
    "created_at": "2018-03-12T21:07:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474666",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:14'></a>Thats the obvious solution, keep a finite-length lru cache around.
...
```json
{
    "body": "Changing commit from \"99717eb55a7833b630e5fd0732dc45b2c0b98d8c\" to \"bd9e3685f6c34c1d58cc330a97c3f77be1a4cfe9\"",
    "created_at": "2018-03-12T22:11:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474667",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "99717eb55a7833b630e5fd0732dc45b2c0b98d8c" to "bd9e3685f6c34c1d58cc330a97c3f77be1a4cfe9"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474668",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474669",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Replying to [vbraun](#comment%3A14):\n> Thats the obvious solution, keep a finite-length lru cache around.\n\n\nI'm not using a LRU cache, but a much simpler FIFO.",
    "created_at": "2018-03-13T09:06:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474670",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:17'></a>Replying to [vbraun](#comment%3A14):
> Thats the obvious solution, keep a finite-length lru cache around.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474671",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474672",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"bd9e3685f6c34c1d58cc330a97c3f77be1a4cfe9\" to \"a802f12aee11f3b100f82108aacd151e6aad3c80\"",
    "created_at": "2018-03-15T10:46:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474673",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "bd9e3685f6c34c1d58cc330a97c3f77be1a4cfe9" to "a802f12aee11f3b100f82108aacd151e6aad3c80"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474674",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Fixed a few test failures.",
    "created_at": "2018-03-15T10:48:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474675",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:20'></a>Fixed a few test failures.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474676",
...
```json
{
    "body": "<a id='comment:21'></a>This solves the issue (random slowdowns in the test suite of `ore_algebra`) that initially led me to the examples mentioned on #24742. And a way to cache the results of the last few calls to a function is something I was missing for other reasons as well.",
    "created_at": "2018-03-23T13:37:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474677",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:21'></a>This solves the issue (random slowdowns in the test suite of `ore_algebra`) that initially led me to the examples mentioned on #24742. And a way to cache the results of the last few calls to a function is something I was missing for other reasons as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474678",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/stronger_references_in_cachedrepresentation\" to \"a802f12aee11f3b100f82108aacd151e6aad3c80\"",
    "created_at": "2018-05-12T11:47:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474679",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jdemeyer/stronger_references_in_cachedrepresentation" to "a802f12aee11f3b100f82108aacd151e6aad3c80"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24954#issuecomment-474680",
    "user": "https://github.com/vbraun"
}
```
