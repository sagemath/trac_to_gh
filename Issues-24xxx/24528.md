...
```json
{
    "body": "[Traceback please](https://groups.google.com/d/msg/sage-devel/H0t9l6XdfPI/5ss5I5A4CAAJ)",
...
```json
{
    "body": "I fixed a bunch more examples like this in my python 3 branch, although not this specific one.  It seems silly to me to have a ticket for just one line of this, but what's done is done.\n\nI need to make more tickets for all the fixes I already have in order to save duplicate effort.  It's just...a lot...and I need to think of logical ways to break it up.",
...
```json
{
    "body": "maybe it is better not to split, but just bite the bullet and get it in? Perhaps in a dedicated beta?",
...
```json
{
    "body": "Well, it still needs to be reviewed and that works better in small pieces.",
...
```json
{
    "body": "I would rather review one limited in scope patchbomb like this than 20 tickets fixing the same issue in different files.",
