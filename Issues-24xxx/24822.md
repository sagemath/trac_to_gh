...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-325529"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-325530"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-325531"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-325532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24822#issuecomment-380037",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24822#issuecomment-380038",
    "user": "https://github.com/tscrim"
}
```
