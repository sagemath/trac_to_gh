...
```json
{
    "body": "<a id='comment:3'></a>This is still a problem I'm seeing.  It goes away when building cysignals without debug, but that's just because the messages aren't being displayed.  The underlying problem is probably still there.",
...
<a id='comment:3'></a>This is still a problem I'm seeing.  It goes away when building cysignals without debug, but that's just because the messages aren't being displayed.  The underlying problem is probably still there.
...
```json
{
    "body": "<a id='comment:6'></a>C11 atomic operations might help with this.",
...
<a id='comment:6'></a>C11 atomic operations might help with this.
...
```json
{
    "body": "<a id='comment:7'></a>This is fixed in the experimental branch https://github.com/sagemath/cysignals/pull/109",
    "created_at": "2019-03-06T15:45:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24288",
    "type": "issue_comment",
...
<a id='comment:7'></a>This is fixed in the experimental branch https://github.com/sagemath/cysignals/pull/109
...
```json
{
    "body": "<a id='comment:8'></a>Interesting.  Is there a separate ticket in Sage for this?  Even though the issue is for cysignals to fix, it's still an issue in Sage as well until/unless Sage depends on a cysignals that has the fix.",
...
<a id='comment:8'></a>Interesting.  Is there a separate ticket in Sage for this?  Even though the issue is for cysignals to fix, it's still an issue in Sage as well until/unless Sage depends on a cysignals that has the fix.
...
```json
{
    "body": "<a id='comment:9'></a>Now fixed in cysignals master.",
...
<a id='comment:9'></a>Now fixed in cysignals master.
...
```json
{
    "body": "<a id='comment:11'></a>Fixed by #27070",
    "created_at": "2019-03-10T21:36:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24288",
    "type": "issue_comment",
...
<a id='comment:11'></a>Fixed by #27070
