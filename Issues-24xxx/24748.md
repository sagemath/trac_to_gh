...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[b29c0e5](https://git.sagemath.org/sage.git/commit/?id=b29c0e5e40f24e16c21eb318bd9fa3eca16efb1c)|`add a comment to remember that this is only a hack`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[90f0a83](https://git.sagemath.org/sage.git/commit/?id=90f0a835662c71e829ddfeb123d51dc48f16ea08)|`import the factory function from the right module`|",
