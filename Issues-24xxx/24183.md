...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337067"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337068"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337069"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337071"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337072"
}
```
...
archive/issue_events_337073.json:
```json
{
    "actor": "https://github.com/jdemeyer",
    "created_at": "2017-11-10T11:02:55Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337073"
}
```
...
archive/issue_events_337074.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337074"
}
```
...
archive/issue_events_337075.json:
```json
{
    "actor": "https://github.com/roed314",
    "created_at": "2017-11-15T18:44:05Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337075"
}
```
...
archive/issue_events_337076.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337076"
}
```
...
archive/issue_events_337077.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/24183",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24183#event-337077"
}
```
