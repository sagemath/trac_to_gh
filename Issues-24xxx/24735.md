...
```json
{
    "body": "<a id='comment:10'></a>\nPushing WIP patch. Still needs a decision on what to do for __floordiv__, gcd and lcm in the integers coefficient case in multi_polynomial_libsingular.pyx.\n\nUnfortunately starting from 8.3.beta7 there are many more test failures caused by the upgrade due to #23909 \n\n---\nNew commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[3985615](https://git.sagemath.org/sage.git/commit?id=39856158d913143f459fd55609b0372a92dff530)|`Update to singular 4.1.1p2`|\n|[426644f](https://git.sagemath.org/sage.git/commit?id=426644f6d085e053fa0fcf3457702eac685b7cba)|`Adapt to singular 4.1.1 API changes`|\n|[d5fc2a4](https://git.sagemath.org/sage.git/commit?id=d5fc2a4bc640856507d743c2f67ad454874700e7)|`Don't call singclap_pdivide for integer coefficients, it's no longer supported`|\n|[89c4f29](https://git.sagemath.org/sage.git/commit?id=89c4f29a8802e0307b916f16ebef8fec06298eab)|`Merge branch 'develop' of https://github.com/sagemath/sage into t/24735/upgrade_singular_to_4_1_1`|",
    "created_at": "2018-07-12T17:07:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24735",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[4763da1](https://git.sagemath.org/sage.git/commit/?id=4763da19a9ea0be849ee3640fc39747d725cb5a1)|`Fix lcm of polynomials with integer coefficients and add test`|\n|[544f67d](https://git.sagemath.org/sage.git/commit/?id=544f67d45ce00142d99cbca7ca1ef39df95d3551)|`Revert \"Trac #25313: Speed up exact division in \u2124[x,y,...]\"`|\n|[2cd8487](https://git.sagemath.org/sage.git/commit/?id=2cd8487ff5a7f74c6c75659b44be5f48d27639e6)|`singular: update doctests`|",
    "created_at": "2018-07-21T09:34:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24735",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[d9dc104](https://git.sagemath.org/sage.git/commit/?id=d9dc104b4ff3d3cc34fa8ec9483f83fce033f627)|`Make Singular error parser more granular`|\n|[ab851b1](https://git.sagemath.org/sage.git/commit/?id=ab851b1a2485c98b9f281e5bb5ea294e84f39040)|`Update some tests output`|",
    "created_at": "2018-07-21T23:12:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24735",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|\n|[39b3230](https://git.sagemath.org/sage.git/commit/?id=39b3230d4bc2fbd7d2a61926763793434386b057)|`Merge branch 'develop' of git://git.sagemath.org/sage into t/24735/upgrade_singular_to_4_1_1`|\n|[921cc31](https://git.sagemath.org/sage.git/commit/?id=921cc310908e1880884af556dc9452c2b4ba8bc8)|`Fix real base ring detection`|\n|[0f55b76](https://git.sagemath.org/sage.git/commit/?id=0f55b763c775bb0d652b53d50dc26f11e9f472a0)|`More real -> Float porting`|",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[aea0544](https://git.sagemath.org/sage.git/commit/?id=aea054407a41a517070eb06e8efcd02d6356269f)|`Don't check for exact Singular version`|",
    "created_at": "2018-07-24T17:40:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24735",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|\n|[4e52b5e](https://git.sagemath.org/sage.git/commit/?id=4e52b5e3ca6bbb34666c25decbf9bab3e2b46e82)|`Use p_Divide for lcm as suggested by upstream`|\n|[50b9ae2](https://git.sagemath.org/sage.git/commit/?id=50b9ae2fd233c30860e1cbb3e63a26f2cc10560a)|`Backport patch to move singular's NTL handling out of libsingular`|",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|\n|[7b56ef2](https://git.sagemath.org/sage.git/commit/?id=7b56ef2d85a79801916e7a8e831cb4a0f4997c74)|`Document patch`|\n|[930ba2e](https://git.sagemath.org/sage.git/commit/?id=930ba2eb1cacaf4e1e43733feb560dd105d531be)|`Remove duplicate cimport`|",
...
```json
{
    "body": "<a id='comment:56'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[f31d9da](https://git.sagemath.org/sage.git/commit/?id=f31d9da8861773c554079ee2a66922a40156a9a5)|`Move patch documentation inside patch itself`|\n|[07ef11b](https://git.sagemath.org/sage.git/commit/?id=07ef11b3209f498dc771bf5cb02f1b3ce1264cbb)|`rest -> reminder`|",
...
```json
{
    "body": "<a id='comment:88'></a>\nLast 10 new commits:\n|                                                                                                                                          |                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[0f55b76](https://git.sagemath.org/sage.git/commit?id=0f55b763c775bb0d652b53d50dc26f11e9f472a0)|`More real -> Float porting`|\n|[aea0544](https://git.sagemath.org/sage.git/commit?id=aea054407a41a517070eb06e8efcd02d6356269f)|`Don't check for exact Singular version`|\n|[4e52b5e](https://git.sagemath.org/sage.git/commit?id=4e52b5e3ca6bbb34666c25decbf9bab3e2b46e82)|`Use p_Divide for lcm as suggested by upstream`|\n|[50b9ae2](https://git.sagemath.org/sage.git/commit?id=50b9ae2fd233c30860e1cbb3e63a26f2cc10560a)|`Backport patch to move singular's NTL handling out of libsingular`|\n|[7b56ef2](https://git.sagemath.org/sage.git/commit?id=7b56ef2d85a79801916e7a8e831cb4a0f4997c74)|`Document patch`|\n|[930ba2e](https://git.sagemath.org/sage.git/commit?id=930ba2eb1cacaf4e1e43733feb560dd105d531be)|`Remove duplicate cimport`|\n|[f31d9da](https://git.sagemath.org/sage.git/commit?id=f31d9da8861773c554079ee2a66922a40156a9a5)|`Move patch documentation inside patch itself`|\n|[07ef11b](https://git.sagemath.org/sage.git/commit?id=07ef11b3209f498dc771bf5cb02f1b3ce1264cbb)|`rest -> reminder`|\n|[a9e5aed](https://git.sagemath.org/sage.git/commit?id=a9e5aed9215175f8cf49327c790ae153648a2513)|`Minor fixes to Singular interface`|\n|[45ff371](https://git.sagemath.org/sage.git/commit?id=45ff3719d4f9059a0e85d142cd1e31cb87efa11c)|`Fix debug build of Singular`|",
    "created_at": "2018-08-11T13:54:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24735",
    "type": "issue_comment",
