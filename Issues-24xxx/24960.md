...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24960#event-327248"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24960#event-327249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24960#event-327250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24960#event-327251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24960#issuecomment-382802",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24960#issuecomment-382803",
    "user": "https://github.com/mkoeppe"
}
```
