...
```
When I updated to Ubuntu Artful Aardvark (17.10), I noticed that [SageMath](../wikis/SageMath) was uninstalled.
...
```json
{
    "actor": "https://trac.sagemath.org/admin/accounts/users/rolandog",
    "created_at": "2017-11-01T03:40:26Z",
    "event": "unlabeled",
    "issue": "https://github.com/sagemath/sage/issues/24084",
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24084#event-213961"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nModified to major, since this basically means that users that upgraded to Ubuntu 17.10 can't install [SageMath](../wikis/SageMath) from the repository.",
    "created_at": "2017-11-01T03:40:26Z",
    "issue": "https://github.com/sagemath/sage/issues/24084",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24084#event-213962"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24084#event-213963"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24084#event-213964"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24084#event-213965"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24084#event-213966"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24084",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24084#event-213967"
}
```
