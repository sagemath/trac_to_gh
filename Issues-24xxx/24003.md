...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24003#event-315282"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24003#event-315283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24003#event-315284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24003#issuecomment-365299",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24003#issuecomment-365300",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24003#event-315285"
}
```
