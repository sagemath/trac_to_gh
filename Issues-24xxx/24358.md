...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24358#event-319681"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24358#event-319682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24358#event-319683"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24358#event-319684"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24358#issuecomment-371345",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24358#issuecomment-371346",
    "user": "https://github.com/vbraun"
}
```
