...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24093#issuecomment-333959",
    "user": "https://trac.sagemath.org/admin/accounts/users/clienkaemper"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Minimal case:\n\n```\nsage: R = PolynomialRing(QQ, 'x1,x11')\nsage: I = R.ideal(R.gens())\nsage: I.groebner_fan()\n```",
    "created_at": "2017-10-24T18:06:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24093#issuecomment-333960",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:2'></a>Minimal case:
