...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24093#event-316467"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24093#event-316468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24093#event-316469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24093#event-316470"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24093#issuecomment-366972",
    "user": "https://github.com/sagetrac-clienkaemper"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24093#issuecomment-366973",
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24093#event-316471"
}
```
