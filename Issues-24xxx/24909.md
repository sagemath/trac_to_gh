...
```json
{
    "body": "The branch wrongly adds a \"test.py\" file...",
...
```json
{
    "body": "In your tests, make sure that the result is correct (i.e., it is a tree and it is spanning all vertices).",
...
```json
{
    "body": "Now, can you expose this method in the method `min_spanning_tree` in file `generic_graph.py` .\n\nWe are almost done !",
...
```json
{
    "body": "For me the patch is now good to go. Congratulation !",
    "created_at": "2018-03-27T19:19:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24909",
    "type": "issue_comment",
