...
```json
{
    "body": "<a id='comment:1'></a>The following line also loops:\n\n```\np(R(1))\n```\n\nbut this line works:\n\n```\np(S(1))\n```\n\nSo it's a coercion thing...",
    "created_at": "2018-01-16T11:21:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24547",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24547#issuecomment-464758",
    "user": "https://github.com/johanrosenkilde"
}
```

<a id='comment:1'></a>The following line also loops:
