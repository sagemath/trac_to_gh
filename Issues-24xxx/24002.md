...
```json
{
    "body": "<a id='comment:1'></a>The `transitive_reduction` is in `generic_graph.py` and defined for both graphs and digraphs. So either both methods should be restricted to digraphs and moved, or both methods should work on both graphs and digraphs.\n\nFor sure, the current implementation of the `transitive_reduction` method for `Graph` could be improved, using a spanning tree (forest) method. And testing if a graph is transitively reduced should be testing if it is a forest.\n\nFor directed graphs, we could certainly improve the current implementation of both methods.\n\nNote also that both methods should failed if the input graph is immutable...",
    "created_at": "2017-10-10T07:17:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453532",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:1'></a>The `transitive_reduction` is in `generic_graph.py` and defined for both graphs and digraphs. So either both methods should be restricted to digraphs and moved, or both methods should work on both graphs and digraphs.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453533",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453535",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The `__copy__` method that is called when using `copy(G)`, always returns a mutable graph: `return self.copy(immutable=False)`. Good to know.",
    "created_at": "2017-10-10T09:43:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453536",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:5'></a>The `__copy__` method that is called when using `copy(G)`, always returns a mutable graph: `return self.copy(immutable=False)`. Good to know.
...
```json
{
    "body": "<a id='comment:6'></a>According to me, after closing of #26634, there is no need to move `is_transitively_reduced` to digraph.py as it is defined for both graph and digraph now.\n\nSo, either we should change milestone to `invalid/wontfix` or `positive_review` and `close`.\nAny suggestions will be helpful.",
    "created_at": "2020-04-07T15:23:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453537",
    "user": "https://github.com/vipul79321"
}
```

<a id='comment:6'></a>According to me, after closing of #26634, there is no need to move `is_transitively_reduced` to digraph.py as it is defined for both graph and digraph now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453538",
    "user": "https://github.com/vipul79321"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24002#event-61029"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [gh-vipul79321](#comment%3A6):\n\n> So, either we should change milestone to `invalid/wontfix` or `positive_review` and `close`.\n\n\nTrue. I mark this as needs_review/wontfix, so please change to positive_review and this will be closed.",
    "created_at": "2020-04-07T20:19:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453539",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:7'></a>Replying to [gh-vipul79321](#comment%3A6):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453540",
    "user": "https://github.com/vipul79321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453541",
    "user": "https://github.com/vipul79321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24002#issuecomment-453542",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24002",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24002#event-61030"
}
```
