...
```json
{
    "body": "I forgot to add that I tested successfully the [Juniper](https://cran.r-project.org/web/packages/JuniperKernel/index.html) kernel, with zero Sage-specific problem (the kernel itself has some issues, pointed to in the previous post...).",
