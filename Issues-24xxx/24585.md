...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467962",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467963",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467964",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467965",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467966",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467967",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\n\n```\nr_jupyter}}} has been uninstallable for a long time : its installation procedure refers to outdated locations. I have been installing IRkernel \"by hand\"  for a while.\n\nThe problem is that [https://github.com/IRkernel/IRkernel IRkernel] is not (yet) on CRAN ; their authors say they intend to subit it  [https://github.com/IRkernel/IRkernel#installation soon] to CRAN, bu have intended so for a looong time. The [https://github.com/IRkernel/IRkernel/issues/528 serial] does not seem to be close to an end...\n\nMeanwhile, CRAN recently accepted a new [https://cran.r-project.org/web/packages/JuniperKernel/index.html Junyper] package which seems to be an(other) interface between R an Jupyter. A simple skimming of its [https://cran.r-project.org/web/packages/JuniperKernel/JuniperKernel.pdf manual] lets me think that this could be an alternative to IRkernel.\n\nI'll have to test this, but that won't be soon (some RealLife(TM) emergencies to fix...).",
    "created_at": "2018-01-23T07:31:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467968",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467969",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467970",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467971",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467972",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467973",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467974",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467975",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467976",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467977",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467978",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467979",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-467980",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
