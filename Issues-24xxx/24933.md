...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24933#event-326907"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24933#event-326908"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24933#event-326909"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382315",
    "user": "https://github.com/dlubicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382316",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382317",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    "body": "Changed keywords from **p-adics, quadratic forms** to **p-adics, quadratic forms, padicIMA**",
    "created_at": "2018-07-22T20:49:52Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382318",
    "user": "https://github.com/roed314"
}
```

Changed keywords from **p-adics, quadratic forms** to **p-adics, quadratic forms, padicIMA**
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24933#event-326910"
}
```
