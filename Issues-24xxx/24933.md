...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24933#issuecomment-474251",
    "user": "https://github.com/dlubicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24933#issuecomment-474252",
    "user": "https://github.com/dlubicz"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>I would suggest to implement instead a function that solves the equation `a x^2 + b y^2 = 1` which is related to the Hilbert symbol.\n\nYou could also have a look at `arith/misc.py` (line 3944-4045) and `rings/number_field/number_field.py` (line 8937-9165). There, the computation of global and local Hilbert symbols are implemented (using pari). Maybe you can rely on this code (though your implementation is probably more efficient since it avoids the creation of a number field).",
    "created_at": "2018-04-08T15:41:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24933#issuecomment-474254",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:5'></a>I would suggest to implement instead a function that solves the equation `a x^2 + b y^2 = 1` which is related to the Hilbert symbol.
...
```json
{
    "body": "<a id='comment:6'></a>Moreover, the methods I mentioned only compute the Hilbert symbol but do not exhibit a solution to the quadratic equation `a x^2 + b y^2 = 1`. So they do not really solve the question you raised.",
    "created_at": "2018-04-08T17:30:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24933#issuecomment-474255",
    "user": "https://github.com/xcaruso"
}
```

<a id='comment:6'></a>Moreover, the methods I mentioned only compute the Hilbert symbol but do not exhibit a solution to the quadratic equation `a x^2 + b y^2 = 1`. So they do not really solve the question you raised.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24933#issuecomment-474256",
