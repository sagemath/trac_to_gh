...
```json
{
    ...
    "type": "issue",
    "updated_at": "2018-07-22T20:49:52Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24933#event-300415"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24933#event-300416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382171",
    "user": "https://github.com/dlubicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382172",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382173",
    "user": "https://github.com/xcaruso"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24933#issuecomment-382174",
