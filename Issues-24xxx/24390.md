...
```json
{
    "body": "<a id='comment:1'></a>I suspect this was done to make the coding easier or it was based on an older standard of left/right cosets. I have confirmed that the wikipedia definition matches Humpreys, Lang, and Dummit--Foote.\n\nWhile I do not have a particular preference one way or the other (in part, because I can never remember which one is which), this change is likely to very subtly break code with an annoying deprecation as it must always appear.",
    "created_at": "2017-12-19T02:15:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24390#issuecomment-338146",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>I suspect this was done to make the coding easier or it was based on an older standard of left/right cosets. I have confirmed that the wikipedia definition matches Humpreys, Lang, and Dummit--Foote.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24390#issuecomment-338147",
    "user": "https://github.com/vit-tucek"
}
```
