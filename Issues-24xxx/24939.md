...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474415",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474417",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474418",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Finally, see polynomial_element.pyx the roots() member where I inserted fast code that avoids calling Maxima for degree 2. I would be interested in taking over solving every polynomial that's possible in Pynac if I had support for it. It would make QQbar faster, because QQbar uses that code in roots() too.",
    "created_at": "2018-03-10T13:59:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474419",
    "user": "https://github.com/rwst"
}
```

<a id='comment:4'></a>Finally, see polynomial_element.pyx the roots() member where I inserted fast code that avoids calling Maxima for degree 2. I would be interested in taking over solving every polynomial that's possible in Pynac if I had support for it. It would make QQbar faster, because QQbar uses that code in roots() too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474420",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474421",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474422",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474423",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>See `Expression.is_exact()`.",
    "created_at": "2018-03-25T05:59:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24939#issuecomment-474425",
    "user": "https://github.com/rwst"
}
```

<a id='comment:10'></a>See `Expression.is_exact()`.
