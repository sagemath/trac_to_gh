...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[0f55981](https://git.sagemath.org/sage.git/commit?id=0f559816d0f0a88b0598562446a31ca28fc8ed47)|`Trac #24773: delayed substitution: first version`|\n|[b801825](https://git.sagemath.org/sage.git/commit?id=b801825e75dd4ddbe264b39e367640e478833d7a)|`Trac #24773: remove input argument self`|\n|[6d0793a](https://git.sagemath.org/sage.git/commit?id=6d0793a7f2514cbde224320dc08d00bae93d52a5)|`Trac #24773: Shorten references`|\n|[5581894](https://git.sagemath.org/sage.git/commit?id=55818942d0f68722ce228a465427131860a761b6)|`Trac #24773: Fix see also block`|",
    "created_at": "2018-02-19T13:07:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24773",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[d2b835c](https://git.sagemath.org/sage.git/commit/?id=d2b835c21e54e71a84cafcc5ca7702f99ccf29b3)|`Trac #24773: delayed_substitution -> substitution_delayed`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[224476e](https://git.sagemath.org/sage.git/commit/?id=224476ec9e346efb53c4dd60918c6483eae369b2)|`Trac #24773: additional test and explanation`|",
