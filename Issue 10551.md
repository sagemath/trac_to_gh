...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110276",
    "user": "rbeezer"
}
```
...
```json
{
    "body": "I read over the code and it looks nice. I love patches that add tons and tons of documentation! I'll run some doctests and make sure this works properly.",
    "created_at": "2011-01-12T22:20:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110277",
    "user": "ddrake"
}
```
...
```json
{
    "body": "Changing assignee from jason, was to ddrake.",
    "created_at": "2011-01-12T23:18:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110278",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110281",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110282",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110283",
    "user": "rbeezer"
}
```
...
```json
{
    "body": "Sparse integer matrices get sent to the *generic* Smith form routine (which I suspect is broken, #10625).  It fails on an integer matrix.  Solution is to direct sparse integer matrices to the dense version and report the generic version.  \n\nThat change is at #10626, and this ticket will now depend on that patch.",
    "created_at": "2011-01-13T19:14:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110284",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110285",
    "user": "rbeezer"
}
```
...
```json
{
    "body": "v2 patch depends on #10626 to avoid the sparse/smith-form problem, and the numpy types are now all automatically handled by the `prepare()` method for free module elements.  Passes tests in sage/matrix and I'll start full tests right now.",
    "created_at": "2011-01-13T22:15:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110286",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110287",
    "user": "rbeezer"
}
```
...
```json
{
    "body": "This will likely depend on the following sequence:\n\n4.6.1.rc1, #10364, #10537, #10626",
    "created_at": "2011-01-13T22:23:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110288",
    "user": "rbeezer"
}
```
...
```json
{
    "body": "Passes all tests in devel/sage with patches described above, so I think this is ready now.",
    "created_at": "2011-01-13T23:25:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110289",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110290",
    "user": "ddrake"
}
```
...
```json
{
    "body": "Green light from the patchbot...code is good. Positive review.\n\nRelease manager: apply #10537 and #10626 *first*, then only attachment:trac_10604-diagonal-matrix-constructor-v2.patch.",
    "created_at": "2011-01-20T09:48:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110291",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110292",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110293",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110294",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110295",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110296",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110297",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110298",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110299",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110300",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110301",
    "user": "ddrake"
}
```
...
```json
{
    "body": "Attachment [trac_10604_fix_matrix_stack](tarball://root/attachments/some-uuid/ticket10604/trac_10604_fix_matrix_stack) by ddrake created at 2011-01-27 14:44:22\n\nCan someone who knows the matrix code take a look at my patch? All doctests pass with the two patches here applied to 4.6.2.alpha2.",
    "created_at": "2011-01-27T14:44:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110302",
    "user": "ddrake"
}
```

Attachment [trac_10604_fix_matrix_stack](tarball://root/attachments/some-uuid/ticket10604/trac_10604_fix_matrix_stack) by ddrake created at 2011-01-27 14:44:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110303",
    "user": "ddrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110305",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110306",
    "user": "rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10551#issuecomment-110307",
    "user": "jdemeyer"
}
```
