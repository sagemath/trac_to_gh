...
```json
{
    ...
    "title": "New vector from old vector returns the same object",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407810",
    "user": "https://trac.sagemath.org/admin/accounts/users/nailuj"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407811",
...
```json
{
    "body": "We have a similar discussion running for `FiniteRankFreeModule` and elements in the manifolds module, take a look at #30302, especially [comment:3](https://trac.sagemath.org/ticket/30302#comment:3).\n\nIn my opinion, this should not happen.",
    "created_at": "2020-08-07T19:31:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407812",
...
```json
{
    "body": "Even though the corresponding check via the flac `copy` is implemented in `FreeModule`, the coercion model preempts it. The corresponding change should be\n\n```diff\n-        if R is self and no_extra_args:\n-            return x\n```\n\nin `sage.structure.parent.Parent`.\n\nBut I don't know anything about the whole string of consequences coming from this.",
    "created_at": "2020-08-10T17:03:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407813",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "Note that `FreeModule_generic._element_constructor_` has some optional arguments...\n\n```\n    def _element_constructor_(self, x, coerce=True, copy=True, check=True):\n```",
    "created_at": "2020-08-10T18:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407815",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407816",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "This could only be a temporary solution. As you already pointed out, and I totally agree with you, the element constructor should behave consistently, i.e. always returning a mutable element. Returning the very same instant, assuming it is immutable, would contradict this behavior.",
    "created_at": "2020-08-12T06:35:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407818",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407819",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407820",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73800"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73801"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73802"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73803"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407821",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73804"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73805"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407822",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "For that, we would want to (also?) override `__iadd__`, `__imul__` etc. for `+=` and `-=`.",
    "created_at": "2021-08-11T21:25:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407824",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407825",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407826",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "I agree, this is not a normal binop-coercion; nevertheless taking care of it is a task for the coercion system, so I'm +1 for single-underscore `_iadd_` etc. methods.",
    "created_at": "2021-08-11T22:09:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407827",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407829",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28864#issuecomment-407830",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73806"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73807"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73808"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73809"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73810"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28864#event-73811"
}
```
