...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/3261",
    "user": "mhampton"
}
```
Assignee: somebody
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3261#issuecomment-22560",
    "user": "mhansen"
}
```
...
```json
{
    "body": "I've tried this in a few installations with #5020 applied and cannot duplicate this.  I'm going to mark it as invalid.",
    "created_at": "2009-01-20T10:13:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3261",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3261#issuecomment-22561",
    "user": "mhansen"
}
```
