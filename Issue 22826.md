...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22826#issuecomment-319212",
    "user": "rolandog"
}
```
...
```json
{
    "body": "Attachment [sage_bug_23063.png](tarball://root/attachments/some-uuid/ticket23063/sage_bug_23063.png) by chapoton created at 2017-05-24 12:17:39\n\nIn fact, as explained in #12591, the complete last figure is duplicated (superposed with itself). Fixing this requires some expert in matplotlib, which I am not.\n\nNOTE that the blue color is darker in the bottom left of your picture, for the same reason.",
    "created_at": "2017-05-24T12:17:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22826#issuecomment-319213",
    "user": "chapoton"
}
```

Attachment [sage_bug_23063.png](tarball://root/attachments/some-uuid/ticket23063/sage_bug_23063.png) by chapoton created at 2017-05-24 12:17:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22826#issuecomment-319214",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22826#issuecomment-319215",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22826#issuecomment-319216",
    "user": "chapoton"
}
```
