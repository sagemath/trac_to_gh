...
```json
{
    "body": "Are you using a version of Sage recent enough to include #27865 (i.e. >= 8.9.beta0)? I've tried with Sage 8.9.beta6 and everything is fine: the legend labels are not doubled. Uncommenting the other lines leads to a correct result as well.",
    "created_at": "2019-08-15T16:18:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28122#issuecomment-396851",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28122#issuecomment-396852",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "Oops!  I have a *local* install that is updated, but I found this using the Sage cell server, which is of course still not-necessarily-updated - but which I was using to test some auto-generated images before actually generating them.  Sorry!",
    "created_at": "2019-08-15T18:46:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/28122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28122#issuecomment-396853",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28122#event-70832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28122#issuecomment-396854",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28122#issuecomment-396855",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/28122#issuecomment-396856",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28122",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28122#event-70833"
}
```
