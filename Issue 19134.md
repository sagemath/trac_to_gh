...
```json
{
    ...
    "title": "Install Jupyter kernel spec in $SAGE_LOCAL",
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/19134",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262589",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262590",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262591",
    "user": "egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262592",
    "user": "egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262593",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262595",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262596",
    "user": "fbissey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262597",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262598",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262599",
    "user": "fbissey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262600",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262601",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262602",
    "user": "fbissey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262604",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262605",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262606",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262607",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "I think we need to uncouple the IPython from the kernel spec installation.",
    "created_at": "2015-10-09T15:45:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262608",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262609",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "Since this turns out to be a lot trickier than I initially thought, this should not be a 6.9 blocker. Which means that we need to unrebase #19374.",
    "created_at": "2015-10-09T17:44:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262610",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "Thank you for taking my concern on board.",
    "created_at": "2015-10-09T20:26:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262611",
    "user": "fbissey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262612",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262613",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262614",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "Sorry I'm afraid I cannot review this one (don't feel competent about it).",
    "created_at": "2015-10-11T16:57:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262615",
    "user": "egourgoulhon"
}
```
...
```json
{
    "body": "I had a problem on an Ubuntu machine wher I could get MathJax in sheets created in my home directory but nowhere else.\n\nI checked the present patch and recompiled :\n1. It seems to solve my Ubuntu-specific problem\n2. It passes ptestlong.\n\nIs that enough for a positive review ?",
    "created_at": "2015-10-15T14:36:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262616",
    "user": "charpent"
}
```
...
```json
{
    "body": "Replying to [comment:29 charpent]:\n> Is that enough for a positive review ?\n\nWho are you asking? Essentially, that's up to you to decide.",
    "created_at": "2015-10-15T14:41:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262617",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "Note that this depends on #19373. So, it would be nice if you could also review that.",
    "created_at": "2015-10-15T14:42:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262618",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262619",
    "user": "charpent"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262621",
    "user": "charpent"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262622",
    "user": "charpent"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19134#issuecomment-262623",
    "user": "vbraun"
}
```
