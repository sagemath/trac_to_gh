# Issue 28876: Reimplement `sage -i SPKG` for optional/experimental packages as `configure --enable-SPKG && make build`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/28876",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/28876#event-73839"
}
```
