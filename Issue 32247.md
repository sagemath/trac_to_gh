...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32247#issuecomment-459925",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32247#issuecomment-459926",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    "body": "looks good to me, but I am no expert. John, do you approve ?",
    "created_at": "2021-11-09T20:47:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32247#issuecomment-459927",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32247#issuecomment-459930",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32247#issuecomment-459931",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    "body": "You are right, and I agree that the best fix is to make this work for all possible subgroups.  If you write the code I will be happy to review it.  Perhaps we could have a function which does not take m as a paramter, just f, which returns a positive integer m if the argument defines a subgroup of order m and 0 if it does not define a subgroup, and/or have a special case for cyclic kernels `is_cyclic_kernel_polynomial`?",
    "created_at": "2021-11-11T08:38:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/32247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32247#issuecomment-459932",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32247#event-86173"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32247#event-86174"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32247#event-86175"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32247#event-86176"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32247#event-86177"
}
```
