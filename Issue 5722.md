# Issue 5722: [with patch, positive review] fast callable pow
...
```json
{
    ...
    "title": "[with patch, positive review] fast callable pow",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5722",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5722#event-13431"
}
```
