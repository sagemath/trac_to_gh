...
```json
{
    "body": "For what it's worth, this already happens in Sage 5.2 (nearly four years old).  Likely we just never came across an example where it didn't just return a list of solutions when it couldn't give an exact answer.",
    "created_at": "2016-04-13T19:37:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20199#issuecomment-278072",
...
```json
{
    "body": "(Also, the fix would be to somehow parse or otherwise deal with `%solve` objects in Maxima.)",
    "created_at": "2016-06-02T12:57:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20199#issuecomment-278073",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "I think #22709 is a dup.\n\nAlso, a simpler example is just\n\n```\nsolve([cos(x)==x],x,to_poly_solve=True)\n```\n",
    "created_at": "2017-07-12T14:09:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20199",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20199#issuecomment-278074",
    "user": "https://github.com/kcrisman"
}
```
