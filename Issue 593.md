# Issue 593: [with patch] MPolynomialIdeal.reduced_basis() doesn't behave as expected
...
```json
{
    ...
    "title": "[with patch] MPolynomialIdeal.reduced_basis() doesn't behave as expected",
    "type": "issue",
