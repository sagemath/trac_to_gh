...
```
sage: # succeeds
sage: f = Piecewise([This is the Trac macro ** that was inherited from the migration called with arguments (0,1),1)](https://trac.sagemath.org/wiki/WikiMacros#-macro))
sage: f.integral(x,0,1)
1
sage: # fails
sage: f = Piecewise([This is the Trac macro ** that was inherited from the migration called with arguments (0,1),0)](https://trac.sagemath.org/wiki/WikiMacros#-macro))
sage: f.integral(x,0,1)
---------------------------------------------------------------------------
