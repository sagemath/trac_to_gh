...
```json
{
    "body": "Hmm, got hurt by this once again ... in a variant of the same use case.",
    "created_at": "2019-06-03T21:22:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25254#issuecomment-355634",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    "body": "After poking around a bit, I'd be tempted to customize the pickling so that a nested class `foo.A.B` would be unpickled as `getattr(getattr(foo, \"A\"),\"B\")`. This would however not resolve the unpickling of old pickles.",
    "created_at": "2019-06-03T21:48:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25254#issuecomment-355635",
    "user": "https://github.com/nthiery"
}
```
