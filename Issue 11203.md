...
```json
{
    "body": "Attachment [trac_11375.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375.patch) by was created at 2011-08-16 18:45:56\n\nrebased for sage-4.7.1",
...
Attachment [trac_11375.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375.patch) by was created at 2011-08-16 18:45:56
...
```json
{
    "body": "Attachment [trac_11375-rewrite.2.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375-rewrite.2.patch) by was created at 2012-01-07 04:32:37\n\njdmeyer -- good now?",
    "created_at": "2012-01-07T04:32:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11203",
    "type": "issue_comment",
...
Attachment [trac_11375-rewrite.2.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375-rewrite.2.patch) by was created at 2012-01-07 04:32:37
...
```json
{
    "body": "Attachment [trac_11375-rewrite.3.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375-rewrite.3.patch) by was created at 2012-01-13 14:47:51\n\napply on this.  Addresses Jereon's remark *and* fixes a missing-line bug (convert to power series) that caused some test failures.",
...
Attachment [trac_11375-rewrite.3.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375-rewrite.3.patch) by was created at 2012-01-13 14:47:51
...
```json
{
    "body": "Attachment [trac_11375-rewrite.4.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375-rewrite.4.patch) by was created at 2012-01-13 16:33:17\n\nI'll change it to you want just for consistency with most Sage code (but I still don't see that it is invalid).",
...
Attachment [trac_11375-rewrite.4.patch](tarball://root/attachments/some-uuid/ticket11375/trac_11375-rewrite.4.patch) by was created at 2012-01-13 16:33:17
