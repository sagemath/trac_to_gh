...
def _(n=7): 
    ...
    L = [This is the Trac macro *_,l[1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#_,l[1-macro) if l[0] is None else l for l in L] 
    T = [This is the Trac macro *'$p\equiv 1\\text{ mod}* that was inherited from the migration called with arguments (4)$','$p\equiv 3\\text{ mod})](https://trac.sagemath.org/wiki/WikiMacros#'$p\equiv 1\\text{ mod}-macro)    
