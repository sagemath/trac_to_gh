...
sage: G = PermutationGroup([This is the Trac macro ** that was inherited from the migration called with arguments (5,))](https://trac.sagemath.org/wiki/WikiMacros#-macro))
sage: secondary_enumeration_polynomial(G)
