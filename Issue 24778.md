...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347497",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Related issue for CoCalc: https://github.com/sagemathinc/cocalc/issues/2764\n\nI'll implement something compatible with what you do here...",
    "created_at": "2018-03-20T17:30:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347498",
...
```json
{
    "body": "I should add, that while I assigned myself this task OpenDreamKit is currently hiring for a [position](http://opendreamkit.org/2018/02/21/position-paris-sud/) (we're actually interviewing candidates today) under which this work could very likely fall as well.  So depending on how things go I might point someone else in the right direction to work on this...",
    "created_at": "2018-03-21T09:39:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347499",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62741"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62742"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62743"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62744"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62745"
}
```
...
```json
{
    "body": "The system with the legacy Sage notebook is to run `sphinxify` on the docstring to produce html documentation. Rather than try to extract from the built documentation, shouldn't you just keep doing this? The issue may be making sure that mathjax is loaded.",
    "created_at": "2018-11-16T17:09:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347501",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347503",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62746"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62747"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62748"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24778#event-62749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347504",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Attachment [ticket-25015.png](tarball://root/attachments/some-uuid/ticket25015/ticket-25015.png) by @embray created at 2019-08-05 16:00:07\n\nHere's the in-progress version if anyone wants to try it out.\n\n---\nNew commits:",
    "created_at": "2019-08-05T16:00:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347506",
    "user": "https://github.com/embray"
}
```

Attachment [ticket-25015.png](tarball://root/attachments/some-uuid/ticket25015/ticket-25015.png) by @embray created at 2019-08-05 16:00:07
...
```json
{
    "body": "Another shortcoming I noticed is that `sphinxify()` makes no effort to resolve references, so if one docstring refers to another function or something, that reference won't be linked.\n\nIt would be nice if this could instead produce an actual link.  Perhaps that should be tackled as a separate issue though.",
    "created_at": "2019-08-05T16:03:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347507",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347510",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347511",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "These macros are defined in `src/sage/misc/latex_macros.py`. That file has a function `sage_mathjax_macros`, which contains versions of these suitable for use with MathJax, and that is what gets used in the legacy Sage notebook. I would hope there is a way to get the Jupyter notebook to use them.",
    "created_at": "2019-08-15T17:25:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347512",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347514",
...
```json
{
    "body": "I see; we probably don't want to rely on the full HTML docs being built/installed in order to load this stylesheet in the Jupyter kernel though; I'll look at that `copy_static_files` function and see if we can easily replicated its functionality, e.g., when installing the kernel.\n\n---\nNew commits:",
    "created_at": "2019-09-23T15:31:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347515",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "May I ask about the status of this? It would be so nice to have it in the Sage 9.0 release. Even if it is not fully perfect, it is much much better than having the pure ASCII documentation in Jupyter notebooks...",
    "created_at": "2019-11-06T13:28:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24778#issuecomment-347516",
    "user": "https://github.com/egourgoulhon"
}
```
