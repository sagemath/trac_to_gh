# Issue 1423: [with patch, with positive review] bug/issue in python.eval from sage
...
```json
{
    ...
    "title": "[with patch, with positive review] bug/issue in python.eval from sage",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9149",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-3662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9150",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9151",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9152",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-3663"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9153",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
