...
```json
{
    "body": "There's also a lot of repetition between the *implementations* of `MonoDict` and `TripleDict`.  Some of this may be unavoidable, but I suspect much of it isn't.  There are obvious cases of copy-and-paste in docstrings, e.g. one which refers to \"MonoDict\" where it should read \"TripleDict\".\n\nFor the most part all that separates these classes is the number of elements in the key.  The question is can this be generalized a bit more without sacrificing performance.  I suspect yes but it's low priority for me to try.",
    "created_at": "2018-09-11T10:09:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366232",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "It's also too bad this is kind of buried as `sage.structure.coerce_dict`. I was aware this module existed but this is the first time I looked closely at it.  I thought it might be *very* particular to the Sage coercion model in some way, but not necessarily.  It seems like it might have use cases beyond that.  I wonder if some more generalized version of it would be useful to make available as a stand-alone module.",
    "created_at": "2018-09-11T10:19:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366233",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26001#event-65313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366234",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26001#event-65314"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26001#event-65315"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366235",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366236",
...
```json
{
    "body": "One solution to reduce code duplication without losing any performance would be to use a templating language on the source code (say `jinja2` since Sage ships with that or maybe even C++ templates). We could deal with `MonoDict` as a special `n==1` case where needed.",
    "created_at": "2019-01-02T09:00:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366237",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "The question is... is it worth doing that?",
    "created_at": "2019-01-02T16:56:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366239",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366240",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Fair enough; I don't disagree I was just wondering out loud.  In this ticket I'm more concerned about the poor and/or repetitive testing.",
    "created_at": "2019-01-03T19:01:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366241",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26001#event-65316"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26001#event-65317"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26001#issuecomment-366242",
    "user": "https://github.com/embray"
}
```
