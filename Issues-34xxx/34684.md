...
archive/issue_events_474996.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34684#event-474996"
}
```
...
archive/issue_events_474997.json:
```json
{
    "actor": "https://github.com/Eloitor",
    "created_at": "2022-10-21T12:44:20Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34684#event-474997"
}
```
...
archive/issue_events_474998.json:
```json
{
    "actor": "https://github.com/Eloitor",
    "created_at": "2022-10-21T12:44:20Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34684#event-474998"
}
```
...
archive/issue_events_474999.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34684#event-474999"
}
```
