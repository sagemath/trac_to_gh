...
archive/issue_events_475726.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475726"
}
```
...
archive/issue_events_475727.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-17T03:11:22Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475727"
}
```
...
archive/issue_events_475728.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-17T03:11:22Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475728"
}
```
...
archive/issue_events_475729.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-17T03:11:22Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475729"
}
```
...
archive/issue_events_475730.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475730"
}
```
...
archive/issue_events_475731.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475731"
}
```
...
archive/issue_events_475732.json:
```json
{
    "actor": "https://github.com/dimpase",
    "created_at": "2022-11-18T15:06:38Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475732"
}
```
...
archive/issue_events_475733.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475733"
}
```
...
archive/issue_events_475734.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34754",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34754#event-475734"
}
```
