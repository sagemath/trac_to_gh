...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[b914324](https://git.sagemath.org/sage.git/commit?id=b914324e6d6b13dbc4d97fc655e2a1825ed1b433)|`allow overriding GAP memory defaults via env.vars`|",
    "created_at": "2022-06-22T12:15:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34041",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[6a2dcc0](https://git.sagemath.org/sage.git/commit/?id=6a2dcc0c3981fadc530fa226e80451a6db3ed5c6)|`fix docs rst syntax`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[e6ef4fe](https://git.sagemath.org/sage.git/commit/?id=e6ef4fe7e036aca572acc27fe95cfe6c5041bf45)|`use sage.env, SAGE_PEXPECT_.. -> SAGE_GAP_COMMAND`|",
