...
```
As pointed out inticket: ticket:34383#comment:28#comment:34383 andticket: ticket:34383#comment:30#comment:34383, the following are not right:
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34441#issuecomment-686058",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I would actually vote for an error in all cases as this is consistent with other rings/objects that do not implement variable names.\n\nCf. `variable_names_recursive`:\n\n```\nsage: ZZ.variable_names_recursive()\nAttributeError: 'sage.rings.integer_ring.IntegerRing_class' object has no attribute 'variable_names_recursive'\n```",
    "created_at": "2022-08-27T08:14:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34441#issuecomment-686059",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>I would actually vote for an error in all cases as this is consistent with other rings/objects that do not implement variable names.
