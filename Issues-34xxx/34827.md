...
archive/issue_events_476330.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476330"
}
```
...
archive/issue_events_476331.json:
```json
{
    "actor": "https://github.com/25shriya",
    "created_at": "2022-12-06T09:38:14Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476331"
}
```
...
archive/issue_events_476332.json:
```json
{
    "actor": "https://github.com/25shriya",
    "created_at": "2022-12-06T09:38:14Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476332"
}
```
...
archive/issue_events_476333.json:
```json
{
    "actor": "https://github.com/25shriya",
    "created_at": "2022-12-06T09:38:14Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476333"
}
```
...
archive/issue_events_476334.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476334"
}
```
...
archive/issue_events_476335.json:
```json
{
    "actor": "https://github.com/amritanshu-prasad",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476335"
}
```
...
archive/issue_events_476336.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476336"
}
```
...
archive/issue_events_476337.json:
```json
{
    "actor": "https://github.com/saraedum",
    "created_at": "2023-01-14T17:48:39Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34827#event-476337"
}
```
