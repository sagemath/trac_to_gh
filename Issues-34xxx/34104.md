...
archive/issue_events_469036.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469036"
}
```
...
archive/issue_events_469037.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-07-01T01:14:48Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469037"
}
```
...
archive/issue_events_469038.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-07-01T01:14:48Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469038"
}
```
...
archive/issue_events_469039.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-07-01T01:14:48Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469039"
}
```
...
archive/issue_events_469040.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469040"
}
```
...
archive/issue_events_469041.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34104",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34104#event-469044"
}
```
