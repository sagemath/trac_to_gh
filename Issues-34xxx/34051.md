...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|\n|[4a579cf](https://git.sagemath.org/sage.git/commit/?id=4a579cf2514b82d06bfd2f01c9c8e1912feade8c)|`adapt doctests`|",
    "created_at": "2022-06-24T19:05:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34051",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[b48a4ac](https://git.sagemath.org/sage.git/commit/?id=b48a4ac58b463d32f9c037448800d8e9f583b73f)|`correct patch level`|",
    "created_at": "2022-06-26T07:43:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34051",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nReplying to [mantepse](#comment%3A14):\n> OK, so we cannot quite remove the patch in `extdecls.patch`.  Could you please try to put the following into a file `extdecls.patch` in the `patches` directory.\n> \n> ```\n> diff --git a/src/include/cfuns-c.H1 b/src/include/cfuns-c.H1\n> index af23933a..8e458c6c 100644\n> --- a/src/include/cfuns-c.H1\n> +++ b/src/include/cfuns-c.H1\n> @@ -1,2 +1,4 @@\n>  extern int directoryp(char *);\n>  extern int writeablep(char *);\n> +extern int remove_directory(char *);\n> +extern int makedir(char *);\n> ```\n\n\nHow about sending this as a PR to FriCAS\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[4f8939f](https://git.sagemath.org/sage.git/commit?id=4f8939f5f6d38ec22eadfb4bc562b73ba9813ea1)|`build/pkgs/fricas/spkg-install.in: Use --enable-case-insensitive-file-system-check=no`|\n|[58d62f4](https://git.sagemath.org/sage.git/commit?id=58d62f4e22ee7d7f8f38665ab5f40961f811e2ac)|`build/bin/write-dockerfile.sh: ADD src/VERSION.txt`|\n|[4e12f40](https://git.sagemath.org/sage.git/commit?id=4e12f4003a057fccfc97eaf6d3f328529cf4bd84)|`Merge #34017`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[d7df5ec](https://git.sagemath.org/sage.git/commit/?id=d7df5ec9d2c2cb88548c183aeac98d30139a1cd1)|`build/pkgs/fricas/patches/extdecls.patch: Re-add (updated)`|",
    "created_at": "2022-06-29T15:12:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34051",
    "type": "issue_comment",
