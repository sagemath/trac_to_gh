...
archive/issue_comments_671480.json:
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34140#issuecomment-671480",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
archive/issue_comments_671481.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34140#issuecomment-671481",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
archive/issue_comments_671482.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34140#issuecomment-671482",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
archive/issue_comments_671483.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34140#issuecomment-671483",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
archive/issue_comments_671484.json:
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,16 @@\n+The following limit should obviously be `1`, but sagemath says it is `0`. This is a maxima bug that has been reported upstream.\n+\n+```\n+sage: a = var(\"a\")\n+sage: assume(a == 0)\n+sage: limit(a/x + 1, x=0)\n+0\n+```\n+\n+---\n+\n+Here is the original ticket description:\n+\n It is not difficult to see that the value of the following limit is `4*m + 1`. However, sagemath says the value is `0`:\n \n ```\n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34140#issuecomment-671484",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34140#event-108292"
}
```
...
archive/issue_comments_671485.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34140#issuecomment-671485",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34140#event-108293"
}
```
