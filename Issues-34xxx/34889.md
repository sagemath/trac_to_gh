...
archive/issue_events_476785.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476785"
}
```
...
archive/issue_events_476786.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2023-01-03T19:04:37Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476786"
}
```
...
archive/issue_events_476787.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2023-01-03T19:04:37Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476787"
}
```
...
archive/issue_events_476788.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2023-01-03T19:04:37Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476788"
}
```
...
archive/issue_events_476789.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476789"
}
```
...
archive/issue_events_476790.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476790"
}
```
...
archive/issue_events_476791.json:
```json
{
    "actor": "https://github.com/dimpase",
    "created_at": "2023-01-05T09:40:53Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476791"
}
```
...
archive/issue_events_476792.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476792"
}
```
...
archive/issue_events_476793.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2023-01-12T22:11:36Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34889",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34889#event-476793"
}
```
