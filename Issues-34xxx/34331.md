...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[67c7a18](https://git.sagemath.org/sage.git/commit?id=67c7a1804bd1354773b7ac5c1f249a8267545edc)|`E251 in geometry/ and manifolds/`|",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------|\n|[c648547](https://git.sagemath.org/sage.git/commit/?id=c6485477c54c1d40dd0f58cd9745a61e5c6b75d1)|`fix mistake`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[0fdd5a2](https://git.sagemath.org/sage.git/commit/?id=0fdd5a2a55741c0688bb5a6abc5502349463a613)|`some details in polyhedron/base`|",
