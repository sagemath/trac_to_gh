...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34852#issuecomment-564844",
    "user": "https://github.com/loreno-heer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34852#issuecomment-564845",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-455971"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-455972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-455973"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-455974"
}
```
