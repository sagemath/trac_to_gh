...
archive/issue_events_475918.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-475918"
}
```
...
archive/issue_events_475919.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-23T06:19:17Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-475919"
}
```
...
archive/issue_events_475920.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-23T06:19:17Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-475920"
}
```
...
archive/issue_events_475921.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-23T06:19:17Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-475921"
}
```
...
archive/issue_events_475922.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-475922"
}
```
