...
archive/issue_events_473700.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-473700"
}
```
...
archive/issue_events_473701.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-23T06:19:17Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-473701"
}
```
...
archive/issue_events_473702.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-23T06:19:17Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-473702"
}
```
...
archive/issue_events_473703.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-23T06:19:17Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-473703"
}
```
...
archive/issue_events_473704.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34780#event-473704"
}
```
