...
archive/issue_events_476479.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476479"
}
```
...
archive/issue_events_476480.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-12-14T10:37:52Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476480"
}
```
...
archive/issue_events_476481.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-12-14T10:37:52Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476481"
}
```
...
archive/issue_events_476482.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-12-14T10:37:52Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476482"
}
```
...
archive/issue_events_476483.json:
```json
{
    "actor": "https://github.com/fchapoton",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476483"
}
```
...
archive/issue_events_476484.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476484"
}
```
...
archive/issue_events_476485.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2022-12-16T17:45:26Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476485"
}
```
...
archive/issue_events_476486.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476486"
}
```
...
archive/issue_events_476487.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2023-01-12T22:11:51Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34847",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34847#event-476487"
}
```
