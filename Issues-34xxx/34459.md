...
```json
{
    "body": "<a id='comment:1'></a>What is in `/usr/local` on this machine and where does it come from?",
    "created_at": "2022-08-30T18:08:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34459#issuecomment-484842",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>What is in `/usr/local` on this machine and where does it come from?
...
```json
{
    "body": "<a id='comment:3'></a>The message above complains about `/usr/local/bin/bash`. I recommend to move this (or actually the whole /usr/local) away.",
    "created_at": "2022-08-30T19:43:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34459#issuecomment-484844",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>The message above complains about `/usr/local/bin/bash`. I recommend to move this (or actually the whole /usr/local) away.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34459#issuecomment-484845",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34459#event-89549"
}
```
