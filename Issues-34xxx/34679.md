...
```json
{
    "body": "but when in docker we need `--disable-gui`",
...
```json
{
    "body": "With #34583, you can now use `export GIAC_CONFIGURE=\"--enable-fltk\"` to override our default `--disable-fltk`.",
...
```json
{
    "body": "By the way, giac as packages on Fedora 34 doesn't seem to want to report its version:\n\n```\n$ giac --version\n// Using locale /usr/share/locale/\n// en_GB.UTF-8\n// /usr/share/locale/\n// giac\n// UTF-8\n// Maximum number of parallel threads 16\nCan't open display: localhost:10.0\n```\nis it due to it built with GUI enabled?",
