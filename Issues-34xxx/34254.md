...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34254#event-450022"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34254#event-450023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34254#event-450024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34254#event-450025"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34254#issuecomment-556274",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34254#issuecomment-556275",
    "user": "https://github.com/vbraun"
}
```
