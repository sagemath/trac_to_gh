...
archive/issue_events_475746.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475746"
}
```
...
archive/issue_events_475747.json:
```json
{
    "actor": "https://github.com/behackl",
    "created_at": "2022-11-17T13:49:32Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475747"
}
```
...
archive/issue_events_475748.json:
```json
{
    "actor": "https://github.com/behackl",
    "created_at": "2022-11-17T13:49:32Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475748"
}
```
...
archive/issue_events_475749.json:
```json
{
    "actor": "https://github.com/behackl",
    "created_at": "2022-11-17T13:49:32Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475749"
}
```
...
archive/issue_events_475750.json:
```json
{
    "actor": "https://github.com/behackl",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475750"
}
```
...
archive/issue_events_475751.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475751"
}
```
...
archive/issue_events_475752.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-17T20:30:00Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475752"
}
```
...
archive/issue_events_475753.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475753"
}
```
...
archive/issue_events_475754.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34756",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34756#event-475754"
}
```
