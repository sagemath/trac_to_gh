...
archive/issue_events_469226.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469226"
}
```
...
archive/issue_events_469227.json:
```json
{
    "actor": "https://github.com/JohnCremona",
    "created_at": "2022-07-06T13:07:00Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469227"
}
```
...
archive/issue_events_469228.json:
```json
{
    "actor": "https://github.com/JohnCremona",
    "created_at": "2022-07-06T13:07:00Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469228"
}
```
...
archive/issue_events_469229.json:
```json
{
    "actor": "https://github.com/JohnCremona",
    "created_at": "2022-07-06T13:07:00Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469229"
}
```
...
archive/issue_events_469230.json:
```json
{
    "actor": "https://github.com/JohnCremona",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469230"
}
```
...
archive/issue_events_469231.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34121",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34121#event-469234"
}
```
