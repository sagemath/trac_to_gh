...
```json
{
    "body": "in this one, I could not fix the issue in geometry..\n\n---\nNew commits:",
...
```json
{
    "body": "Let's defer this failure to a follow-up ticket",
    "created_at": "2022-07-14T14:16:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34167",
    "type": "issue_comment",
...
```json
{
    "body": "(The directive is mainly used in the thematic tutorials where `show_authors` is specifically set to `True`, but it's used a few other places as well.)",
...
```json
{
    "body": "The same passage in the Developer's guide mentions directives \"image\", \"figure\", and \"autofunction\". The last one is not used, but the others are. Do they need to be added?",
...
```json
{
    "body": "(Adding to the list of directives requires adding #30448 as a dependency.)",
...
```json
{
    "body": "I would rather wait for the next beta to deal with this, rather than try to figure out where the merge conflict is.",
...
```json
{
    "body": "(I'm actually surprised that #22349 hasn't caused more problems, since it's a bit of a patch bomb.)",
...
```json
{
    "body": "dependency of a \"critical\" ticket",
    "created_at": "2022-08-04T23:18:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34167",
    "type": "issue_comment",
