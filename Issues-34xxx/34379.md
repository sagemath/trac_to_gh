...
```json
{
    "body": "<div id=\"comment:14\" align=\"right\">comment:14</div>\n\nI am using `I` from [comment:7](#comment:7). The point is that positive shifts are represented by double negatives.",
...
```json
{
    "body": "<div id=\"comment:16\" align=\"right\">comment:16</div>\n\nReplying to [@kwankyu](#comment:15):\n> Replying to [@tscrim](#comment:14):\n> > I am using `I` from [comment:7](#comment:7). \n\n> \n> `I` is not homogeneous, and the size of `degrees` is not the number of variables. So it is a wrong input.\n\nActually, there is no way it is the one from [comment:7](#comment:7)...I just forgot which one I used in my haste. `^^;;`\n\n> > The point is that positive shifts are represented by double negatives.\n\n> \n> I see. Please fix this here.\n\nWill do.",
