...
archive/issue_events_476143.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476143"
}
```
...
archive/issue_events_476144.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-28T18:56:02Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476144"
}
```
...
archive/issue_events_476145.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-28T18:56:02Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476145"
}
```
...
archive/issue_events_476146.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-28T18:56:02Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476146"
}
```
...
archive/issue_events_476147.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476147"
}
```
...
archive/issue_events_476148.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476148"
}
```
...
archive/issue_events_476149.json:
```json
{
    "actor": "https://github.com/dimpase",
    "created_at": "2022-12-06T21:20:04Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476149"
}
```
...
archive/issue_events_476150.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476150"
}
```
...
archive/issue_events_476151.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2023-01-05T23:16:46Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34804",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34804#event-476151"
}
```
