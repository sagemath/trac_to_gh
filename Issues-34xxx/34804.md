...
<a id='comment:27'></a>Replying to [Matthias Köppe](#comment%3A17):
> Doctests are discovered by parsing files; they cannot be supplied by decorators.
...
```json
{
    "body": "<a id='comment:29'></a>I've opened #34828 to fix the doctest issue in[comment:28](#comment%3A28)",
...
<a id='comment:29'></a>I've opened #34828 to fix the doctest issue in[comment:28](#comment%3A28)
