...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465496"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553796",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553797",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553798",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553799",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553800",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465500"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553801",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465501"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465502"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553802",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34297#event-465503"
}
```
...
```json
{
    "body": "<div id=\"comment:8\" align=\"right\">comment:8</div>\n\nAfter updating to GAP 4.12 and applying the patch in https://github.com/sagemath/sage/issues/34391, this no longer happens on Nix's aarch64 builders. For some weird reason, this still happens on an Oracle Cloud free tier box, but I don't know how to debug that (and, given that it might be some interaction with Oracle's cloud monitoring tools, I don't really care).",
    "created_at": "2022-09-23T16:09:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/34297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34297#issuecomment-553803",
    "user": "https://github.com/collares"
}
```
