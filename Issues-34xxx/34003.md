...
```json
{
    "body": "<a id='comment:3'></a>this is an example which arises in my research. Computing by hand the Taylor expansion with `diff` works well.",
    "created_at": "2022-06-17T06:11:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34003#issuecomment-479518",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:3'></a>this is an example which arises in my research. Computing by hand the Taylor expansion with `diff` works well.
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34003#event-89015"
}
```
