...
archive/issue_events_476696.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-476696"
}
```
...
archive/issue_events_476697.json:
```json
{
    "actor": "https://github.com/xuluze",
    "created_at": "2022-12-23T18:56:45Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-476697"
}
```
...
archive/issue_events_476698.json:
```json
{
    "actor": "https://github.com/xuluze",
    "created_at": "2022-12-23T18:56:45Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-476698"
}
```
...
archive/issue_events_476699.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-476699"
}
```
...
archive/issue_events_476700.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-476700"
}
```
