...
archive/issue_events_474476.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-474476"
}
```
...
archive/issue_events_474477.json:
```json
{
    "actor": "https://github.com/xuluze",
    "created_at": "2022-12-23T18:56:45Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-474477"
}
```
...
archive/issue_events_474478.json:
```json
{
    "actor": "https://github.com/xuluze",
    "created_at": "2022-12-23T18:56:45Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-474478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34876#issuecomment-562017",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-474479"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34876#event-474480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34876#issuecomment-562018",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34876#issuecomment-562019",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34876#issuecomment-562020",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34876",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34876#issuecomment-562021",
    "user": "https://github.com/mkoeppe"
}
```
