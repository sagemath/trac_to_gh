...
archive/issue_events_474342.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474342"
}
```
...
archive/issue_events_474343.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-09-29T10:00:15Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474343"
}
```
...
archive/issue_events_474344.json:
```json
{
    "actor": "https://github.com/mantepse",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474344"
}
```
...
archive/issue_events_474345.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-09-29T10:13:23Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474345"
}
```
...
archive/issue_events_474346.json:
```json
{
    "actor": "https://github.com/mantepse",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474346"
}
```
...
archive/issue_events_474347.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474347"
}
```
...
archive/issue_events_474348.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-10-28T07:18:31Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474348"
}
```
...
archive/issue_events_474349.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474349"
}
```
...
archive/issue_events_474350.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34611",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34611#event-474350"
}
```
