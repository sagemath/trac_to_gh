...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471554"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471558"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471559"
}
```
...
archive/issue_events_471560.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471560"
}
```
...
archive/issue_events_471561.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-08-11T20:12:42Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471561"
}
```
...
archive/issue_events_471562.json:
```json
{
    "actor": "https://github.com/slel",
    "created_at": "2022-08-11T20:12:42Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34341",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34341#event-471564"
}
```
