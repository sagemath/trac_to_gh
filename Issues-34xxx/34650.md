...
archive/issue_events_474693.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34650#event-474693"
}
```
...
archive/issue_events_474694.json:
```json
{
    "actor": "https://github.com/EmmanuelCharpentier",
    "created_at": "2022-10-11T08:41:09Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34650#event-474694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34650#event-474695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34650#event-474696"
}
```
