...
```json
{
    "body": "<a id='comment:2'></a>I'm sure I fixed this quite recently -- and it does work fine using Sage-9.7 (just released).  I just checked that with 9.6 the problem arises, so my memory is good. Upgrade!\n\nI have tagged this ticket as invalid/wontfix, so I hope you agree.",
    "created_at": "2022-09-21T09:16:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34564#issuecomment-688384",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>I'm sure I fixed this quite recently -- and it does work fine using Sage-9.7 (just released).  I just checked that with 9.6 the problem arises, so my memory is good. Upgrade!
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34564#event-89649"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>works for me, hence closing as suggested",
    "created_at": "2022-10-07T06:40:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34564#issuecomment-688385",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:3'></a>works for me, hence closing as suggested
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34564",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34564#event-89650"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34564#issuecomment-688386",
    "user": "https://github.com/fchapoton"
}
```
