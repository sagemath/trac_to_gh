...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34626#issuecomment-689313",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Thanks for investigating this. That's quite a dramatic difference. Could you post a list of the packages in the difference with sizes please?",
    "created_at": "2022-10-02T17:44:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34626",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34626#issuecomment-689314",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>Thanks for investigating this. That's quite a dramatic difference. Could you post a list of the packages in the difference with sizes please?
