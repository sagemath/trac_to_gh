...
```json
{
    "body": "<a id='comment:4'></a>\nThe branch fixes (2), (3), (4) and (7). For (5), we need to decide whether we want to follow the new behavior in GAP, or reimplement the old behavior in some other way. For (6), some tests need to be updated or removed.\n\n---\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[aeff992](https://git.sagemath.org/sage.git/commit?id=aeff992d53a65a705dca5cd5216bcb97c218dce7)|`Adapt to API changes in OpenOutputStream and CloseOutput`|\n|[c3367b4](https://git.sagemath.org/sage.git/commit?id=c3367b4290981e5e93b7a30c48b02f1ae3770dc8)|`Disable colored prompt as it breaks the pexpect interface`|\n|[3b63e99](https://git.sagemath.org/sage.git/commit?id=3b63e998e4d6118fc86b13b940c8f3d3b8307a50)|`Port NaturalHomomorphism uses`|\n|[bc40764](https://git.sagemath.org/sage.git/commit?id=bc40764be044653e06f2da3497e1e05da08251f7)|`Fix tests with GAP 4.12`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[cbc902a](https://git.sagemath.org/sage.git/commit/?id=cbc902a79ff9ec01d4d4eb9a767a1c661fb5dda7)|`Adapt test to new is_transitive and is_primitive behavior`|\n|[80dd6b3](https://git.sagemath.org/sage.git/commit/?id=80dd6b338236f170efca1fc3545df18ce8d8795c)|`Mark test as random. With gap 4.12 on x86_64 it is no longer 2`|\n|[a6c293d](https://git.sagemath.org/sage.git/commit/?id=a6c293d67cfcdf8fba7bc6aa7899e2086d42cc7e)|`Remove test that is now redundant, all seeds give the same answer`|",
    "created_at": "2022-09-30T17:18:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:19'></a>\nmeanwhile, rebased over the latest beta, and all the fixes for spkg-install needed so far.\n\n---\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[6f3b455](https://git.sagemath.org/sage.git/commit?id=6f3b4556db746e6354d55d42eba5925be19a6cad)|`Adapt to API changes in OpenOutputStream and CloseOutput`|\n|[31aaa12](https://git.sagemath.org/sage.git/commit?id=31aaa12fe42e1bcf7d2f69ae431be8bff70c52a7)|`Disable colored prompt as it breaks the pexpect interface`|\n|[d9da790](https://git.sagemath.org/sage.git/commit?id=d9da7900e6714d3f6ec66fd69de9532f95045750)|`Port NaturalHomomorphism uses`|\n|[86a34a0](https://git.sagemath.org/sage.git/commit?id=86a34a0314022ab1f22d7215c2def9c4d4daed5d)|`Fix tests with GAP 4.12`|\n|[3b8283f](https://git.sagemath.org/sage.git/commit?id=3b8283fef303e41e54fe02009b2c648e0bf606fb)|`Adapt test to new is_transitive and is_primitive behavior`|\n|[754b7b1](https://git.sagemath.org/sage.git/commit?id=754b7b15df2eb8a9a68fb4a1fd0b8160af2a7e0a)|`Mark test as random. With gap 4.12 on x86_64 it is no longer 2`|\n|[6e3e8da](https://git.sagemath.org/sage.git/commit?id=6e3e8da1c4dfa6980cd36e6bf2260e5df02d8d78)|`Remove test that is now redundant, all seeds give the same answer`|\n|[09f4df2](https://git.sagemath.org/sage.git/commit?id=09f4df238c9bd74f47e12775a712ba26c4f386bb)|`install gap 4.12.0`|",
    "created_at": "2022-10-17T14:35:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[5a0f6e9](https://git.sagemath.org/sage.git/commit/?id=5a0f6e97874f328964c7a3679b8d66704e3d01b8)|`add GAP upstream PR 5077`|",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[5cfe772](https://git.sagemath.org/sage.git/commit/?id=5cfe77230b019d4d51236e977f1c89ab3d34cd00)|`upgrade libsemigroup and gap_packages`|\n|[61025c0](https://git.sagemath.org/sage.git/commit/?id=61025c0a05e84b33b4f0151ba4895430a63f4f7b)|`Merge branch 'u/dimpase/upgrade__gap_4_12' of trac.sagemath.org:sage into u/dimpase/upgrade__gap_4_12`|",
    "created_at": "2022-10-17T20:23:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[2e3f54b](https://git.sagemath.org/sage.git/commit/?id=2e3f54b25d15223fb94e2b38c46cb5e790dfff0c)|`also, fix the package names etc`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nupdate tp 4.12.1\n\n---\nNew commits:\n|                                                                                                                                          |                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[d503bc8](https://git.sagemath.org/sage.git/commit?id=d503bc81ce1bea49da933bca7085b44965d0d6ff)|`add GAP upstream PR 5077`|\n|[894a89f](https://git.sagemath.org/sage.git/commit?id=894a89f4f9f2faf666fa10d6c23093947b103918)|`also, fix the package names etc`|\n|[d0a9b21](https://git.sagemath.org/sage.git/commit?id=d0a9b213cdaa51afae123940be69fc525b1249d0)|`update GAP to 4.12.1`|",
    "created_at": "2022-10-21T09:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[02b6b4b](https://git.sagemath.org/sage.git/commit/?id=02b6b4b039d86ef25ff29a599ef1a9cf26c84616)|`install GAP package singular - new dependency of liepring`|",
    "created_at": "2022-10-21T14:33:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:43'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[84a527d](https://git.sagemath.org/sage.git/commit/?id=84a527d823e5eea1f144f2a57fb79c15e771e03e)|`moved install of radiroot to gap from gap_packages`|\n|[eb8cd42](https://git.sagemath.org/sage.git/commit/?id=eb8cd42feb58963adba67599bf6e311e03424328)|`moved install of autodoc and utils to gap from gap_packages`|",
...
```json
{
    "body": "<a id='comment:51'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[061b6fb](https://git.sagemath.org/sage.git/commit/?id=061b6fb102d944bff6f94e2c5f37325dd78a847c)|`Mark test as random. With gap 4.12 on x86_64 it is no longer 2`|\n|[a5a4423](https://git.sagemath.org/sage.git/commit/?id=a5a44230494d67837d388b4aba6fd177e1ac3408)|`Remove test that is now redundant, all seeds give the same answer`|\n|[af5f91b](https://git.sagemath.org/sage.git/commit/?id=af5f91b7aa9973297ee821a03f28acda2e1ea131)|`install gap 4.12.0`|\n|[46ef5f8](https://git.sagemath.org/sage.git/commit/?id=46ef5f80fe9c9958005115182c1e55285ec04f1a)|`upgrade libsemigroup and gap_packages`|\n|[d57f502](https://git.sagemath.org/sage.git/commit/?id=d57f50284921a3640e1ee0d23ff617c6fd2ae023)|`add GAP upstream PR 5077`|\n|[34b03ed](https://git.sagemath.org/sage.git/commit/?id=34b03edf4caadd18a4bedebbd636aa84ae1b11d0)|`also, fix the package names etc`|\n|[60ac451](https://git.sagemath.org/sage.git/commit/?id=60ac4514b54cdfd4d4eb8bbe39587a8c3ca0a87a)|`update GAP to 4.12.1`|\n|[412fec4](https://git.sagemath.org/sage.git/commit/?id=412fec406eef21d610c26893ab8491f27ac78d27)|`install GAP package singular - new dependency of liepring`|\n|[f3ce16d](https://git.sagemath.org/sage.git/commit/?id=f3ce16d5e6a92a523ba3f567835f1a76d922a699)|`moved install of radiroot to gap from gap_packages`|\n|[a1e6e43](https://git.sagemath.org/sage.git/commit/?id=a1e6e4316fe68e6d11bfe3565e75bd0e297642a0)|`moved install of autodoc and utils to gap from gap_packages`|",
    "created_at": "2022-11-04T13:54:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34391",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:81'></a>\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[df6d32e](https://git.sagemath.org/sage.git/commit?id=df6d32e3beaf3ae0d31d10e71cbaf2465f080297)|`ensure make gap-clean still works`|",
...
```json
{
    "body": "<a id='comment:95'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[d08847c](https://git.sagemath.org/sage.git/commit/?id=d08847c9abd27d6a059195669bf6f1e4fd05450d)|`also, fix the package names etc`|\n|[4130abb](https://git.sagemath.org/sage.git/commit/?id=4130abbd3df310b5636542017abeae653a1200f4)|`update GAP to 4.12.1`|\n|[c63f276](https://git.sagemath.org/sage.git/commit/?id=c63f276f193bf7ecd4ce1fee4269ca95d6ffed0b)|`install GAP package singular - new dependency of liepring`|\n|[7316eb9](https://git.sagemath.org/sage.git/commit/?id=7316eb9f58cebf64dc0117f1482fca8236a7a87c)|`moved install of radiroot to gap from gap_packages`|\n|[71268c9](https://git.sagemath.org/sage.git/commit/?id=71268c9498dd143643a7c2c9547ca25e2e78987c)|`moved install of autodoc and utils to gap from gap_packages`|\n|[4e055a8](https://git.sagemath.org/sage.git/commit/?id=4e055a84cb943f96d0eb88d23a48fd43ced054f1)|`don't use SAGE_LOCAL/share/gap, switch to GAP's \"make install\"`|\n|[becfa00](https://git.sagemath.org/sage.git/commit/?id=becfa00fdefcbf46e5fe0c604aeb193398a9d39d)|`Search for files in both lib/gap and share/gap`|\n|[09fcb26](https://git.sagemath.org/sage.git/commit/?id=09fcb2672d20e0dcc97233d7a599da0191b0109e)|`Create lib/gap/bin on install`|\n|[93c1bec](https://git.sagemath.org/sage.git/commit/?id=93c1becb5f3eba41b0cea43912c2482389320bf9)|`ensure make gap-clean still works`|\n|[71c9fe3](https://git.sagemath.org/sage.git/commit/?id=71c9fe337455d52637e0272fccdd633d8e96fa2e)|`with SAGE_CHECK=yes, one needs io installed to prevent hangs`|",
    "created_at": "2022-11-23T18:36:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34391",
    "type": "issue_comment",
