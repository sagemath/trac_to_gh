...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[79250c6](https://git.sagemath.org/sage.git/commit/?id=79250c604b58bf0832c3601010e9c4c5a69ad0e7)|`Add documentation of Integer index`|",
    "created_at": "2022-08-10T00:54:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34054",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[f11c1a3](https://git.sagemath.org/sage.git/commit/?id=f11c1a3bcb10ff99fd4ddc46f33140c3ed775c93)|`Add check for positivity of rank`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[250ee34](https://git.sagemath.org/sage.git/commit/?id=250ee345fc32f6d1ad9590027d2563ee862630de)|`Remove TESTS block`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[19f5820](https://git.sagemath.org/sage.git/commit/?id=19f582021bb6887ad45f824e1f3fcdf636e1cd77)|`value->rank and check for integer value`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|\n|[cd816e6](https://git.sagemath.org/sage.git/commit/?id=cd816e6a007fdb1c1430ca6897acc364d596d155)|`Rephrase range`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[c777eca](https://git.sagemath.org/sage.git/commit/?id=c777eca9975a5bf25902b5483d00853b8b4ce1f1)|`Rewrite using enumerate and fix doctests`|",
    "created_at": "2022-08-17T21:04:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34054",
    "type": "issue_comment",
