...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34005#event-465862"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34005#event-465863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34005#event-465864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34005#issuecomment-549667",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34005#issuecomment-549668",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34005#event-465865"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34005#issuecomment-549669",
...
```json
{
    "body": "<div id=\"comment:3\" align=\"right\">comment:3</div>\n\nQuite likely. Non-unique-representation parents make coercion difficult, and from [comment:2](#comment:2), likely even `CachedRepresentation` won't improve the situation. We might have to explicitly convert some elements in the `GroupAlgebra` code to fix this. It should at least fix the symptom, but that is likely just a hack solution with other issues popping up elsewhere...",
    "created_at": "2022-06-17T08:12:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/34005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34005#issuecomment-549670",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34005#event-465866"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34005#event-465867"
}
```
