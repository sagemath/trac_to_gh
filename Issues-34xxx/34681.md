...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472753"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472754"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472755"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472756"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559968",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559969",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559970",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472757"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559971",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559972",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559973",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472758"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472759"
}
```
...
```json
{
    "body": "<div id=\"comment:5\" align=\"right\">comment:5</div>\n\nReplying to [Gonzalo Tornar\u00eda](#comment:4):\n> However, this fix here seems trivial -- can we get this in?\n\nIndeed, why not.",
    "created_at": "2022-11-03T06:06:10Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559975",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559976",
    "user": "https://github.com/yyyyx4"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472760"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-472761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34681#issuecomment-559977",
