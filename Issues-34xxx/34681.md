...
archive/issue_events_474970.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474970"
}
```
...
archive/issue_events_474971.json:
```json
{
    "actor": "https://github.com/tornaria",
    "created_at": "2022-10-20T20:15:48Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474971"
}
```
...
archive/issue_events_474972.json:
```json
{
    "actor": "https://github.com/tornaria",
    "created_at": "2022-10-20T20:15:48Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474972"
}
```
...
archive/issue_events_474973.json:
```json
{
    "actor": "https://github.com/tornaria",
    "created_at": "2022-10-20T20:15:48Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474973"
}
```
...
archive/issue_events_474974.json:
```json
{
    "actor": "https://github.com/tornaria",
    "created_at": "2022-10-20T21:09:48Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474974"
}
```
...
archive/issue_events_474975.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474975"
}
```
...
archive/issue_events_474976.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T06:06:10Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474976"
}
```
...
archive/issue_events_474977.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474977"
}
```
...
archive/issue_events_474978.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34681#event-474978"
}
```
