...
<a id='comment:9'></a>Replying to [Kwankyu Lee](#comment%3A8):
> How is the size of the data measured?
...
<a id='comment:10'></a>Replying to [Lorenz Panny](#comment%3A9):
> Replying to [Kwankyu Lee](#comment%3A8):
> > How is the size of the data measured?
