...
archive/issue_events_474282.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474282"
}
```
...
archive/issue_events_474283.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-09-28T20:54:53Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474283"
}
```
...
archive/issue_events_474284.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-09-28T20:54:53Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474284"
}
```
...
archive/issue_events_474285.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-09-28T20:54:53Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474285"
}
```
...
archive/issue_events_474286.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474286"
}
```
...
archive/issue_events_474287.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-10-01T16:20:48Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474287"
}
```
...
archive/issue_events_474288.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-10-01T16:20:48Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474288"
}
```
...
archive/issue_events_474289.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474289"
}
```
...
archive/issue_events_474290.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34603",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34603#event-474290"
}
```
