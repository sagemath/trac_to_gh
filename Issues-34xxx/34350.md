...
```json
{
    "body": "<a id='comment:4'></a>\nI reproduced the time difference, that's indeed huge!\n\nI also took the opportunity to update the docstring for `__pow__` with your examples. Before that it was only documenting integer powers. Once you have reviewed this change I think it's good to go.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[7b55ef5](https://git.sagemath.org/sage.git/commit?id=7b55ef58e4f2c274165b5a8e277149f83705b52c)|`Speeding up powers of lazy series by using a different algorithm.`|\n|[d4450fb](https://git.sagemath.org/sage.git/commit?id=d4450fb31c4d7331cafbad27bf45c4c3697df679)|`Update lazy_series' __pow__ docstring`|",
    "created_at": "2022-09-21T14:58:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34350",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[b237921](https://git.sagemath.org/sage.git/commit/?id=b23792105a2fbb3d8e7d529774f91eaa3831ac84)|`Formatting issues / docstring conventions`|",
