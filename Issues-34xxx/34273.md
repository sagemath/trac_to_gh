...
```json
{
    "body": "<a id='comment:5'></a>\nWe should probably get the more detailed configure check from Python:\nhttps://github.com/python/cpython/blob/main/configure.ac#L6823\n\n---\nNew commits:\n|                                                                                                                                          |                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[de3e0f3](https://git.sagemath.org/sage.git/commit?id=de3e0f3d5d405ef0f255aaf6d9934f86c72fcca7)|`build/pkgs/openssl/distros/opensuse.txt: Use libopenssl-3-devel`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[d46f190](https://git.sagemath.org/sage.git/commit/?id=d46f190b83388be070d53a105c0b8bd5ba31695f)|`build/pkgs/openssl/spkg-configure.m4: Add API check from python3 configure.ac`|",
