...
archive/issue_events_474351.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474351"
}
```
...
archive/issue_events_474352.json:
```json
{
    "actor": "https://github.com/seblabbe",
    "created_at": "2022-09-29T10:03:22Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474352"
}
```
...
archive/issue_events_474353.json:
```json
{
    "actor": "https://github.com/seblabbe",
    "created_at": "2022-09-29T10:03:22Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474353"
}
```
...
archive/issue_events_474354.json:
```json
{
    "actor": "https://github.com/seblabbe",
    "created_at": "2022-09-29T10:03:22Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474354"
}
```
...
archive/issue_events_474355.json:
```json
{
    "actor": "https://github.com/seblabbe",
    "created_at": "2022-09-29T10:10:03Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474355"
}
```
...
archive/issue_events_474356.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474356"
}
```
...
archive/issue_events_474357.json:
```json
{
    "actor": "https://github.com/dcoudert",
    "created_at": "2022-09-29T11:23:12Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474357"
}
```
...
archive/issue_events_474358.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474358"
}
```
...
archive/issue_events_474359.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34612",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34612#event-474359"
}
```
