...
archive/issue_events_474813.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474813"
}
```
...
archive/issue_events_474814.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-10-15T14:05:43Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474814"
}
```
...
archive/issue_events_474815.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-10-15T14:05:43Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474815"
}
```
...
archive/issue_events_474816.json:
```json
{
    "actor": "https://github.com/maxale",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474816"
}
```
...
archive/issue_events_474817.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474817"
}
```
...
archive/issue_events_474818.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474818"
}
```
...
archive/issue_events_474819.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-10-28T06:47:01Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474819"
}
```
...
archive/issue_events_474820.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474820"
}
```
...
archive/issue_events_474821.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34662",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34662#event-474821"
}
```
