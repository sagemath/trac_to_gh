...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690680",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690681",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690682",
...
```json
{
    "body": "<a id='comment:8'></a>We can improve the heuristic by dispatching on `self.base_ring().is_exact()` - if true, we do `classical`, as before, otherwise `scaled_partial_pivoting`. In particular this will preserve \nthe current setting for `QQ`, etc.",
    "created_at": "2022-11-07T18:04:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690687",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:8'></a>We can improve the heuristic by dispatching on `self.base_ring().is_exact()` - if true, we do `classical`, as before, otherwise `scaled_partial_pivoting`. In particular this will preserve 
the current setting for `QQ`, etc.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690688",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/dimpase/matrix/fix_echelonize\"",
    "created_at": "2022-11-08T09:45:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690689",
    "user": "https://github.com/dimpase"
}
```

Changing branch from "" to "u/dimpase/matrix/fix_echelonize"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690690",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"d6a834a1f1d3cd377b722bcbec97bfc1b468e252\"",
    "created_at": "2022-11-08T09:45:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690691",
    "user": "https://github.com/dimpase"
}
```

Changing commit from "" to "d6a834a1f1d3cd377b722bcbec97bfc1b468e252"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690692",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>It's not clear how to deal with SR matrices (SR is not exact, but we can only do classic echelonize on it) like this, as SR is split out to its own package, and\nso checking whether the base ring is SR directly doesn't seem to be possible, due to this structure - as importing SR is no good.\n\nSo further subclassing (?) seems hard to aviod - any ideas?",
    "created_at": "2022-11-08T12:57:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690693",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:11'></a>It's not clear how to deal with SR matrices (SR is not exact, but we can only do classic echelonize on it) like this, as SR is split out to its own package, and
so checking whether the base ring is SR directly doesn't seem to be possible, due to this structure - as importing SR is no good.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690694",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>while working on it I found a juicy test bug in `pseudoinverse` for an `RR` matrix `M`.\nThe pseudoinverse in the docstring, computed with `M.pseudoinverse(algorithm=\"exact\")`,\nis very bad quality, compared to `M.pseudoinverse(algorithm=\"numpy\")`. I'm changing this test to a meaningful one.",
    "created_at": "2022-11-08T13:54:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690695",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:12'></a>while working on it I found a juicy test bug in `pseudoinverse` for an `RR` matrix `M`.
The pseudoinverse in the docstring, computed with `M.pseudoinverse(algorithm="exact")`,
is very bad quality, compared to `M.pseudoinverse(algorithm="numpy")`. I'm changing this test to a meaningful one.
...
```json
{
    "body": "Changing commit from \"d6a834a1f1d3cd377b722bcbec97bfc1b468e252\" to \"24299ced2b38daef48a2002d24c1766c80d2d0e9\"",
    "created_at": "2022-11-08T16:27:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690696",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "d6a834a1f1d3cd377b722bcbec97bfc1b468e252" to "24299ced2b38daef48a2002d24c1766c80d2d0e9"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690697",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690698",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Changing commit from \"24299ced2b38daef48a2002d24c1766c80d2d0e9\" to \"cce62c225276687c4f9e331688bd638085e2dbcd\"",
    "created_at": "2022-11-08T17:42:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690699",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "24299ced2b38daef48a2002d24c1766c80d2d0e9" to "cce62c225276687c4f9e331688bd638085e2dbcd"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690700",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>> so a stub echelonize implementation on Matrix_symbolic_dense with a different default and then just chains to the echelonize on super would do the trick. \n\n\nDoes `cce62c2` do this? It seems, yes.",
    "created_at": "2022-11-08T17:43:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690701",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:16'></a>> so a stub echelonize implementation on Matrix_symbolic_dense with a different default and then just chains to the echelonize on super would do the trick. 
...
```json
{
    "body": "<a id='comment:18'></a>I still need to add fixes for numerical noise - are you happy with the fix otherwise?",
    "created_at": "2022-11-08T18:00:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690703",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:18'></a>I still need to add fixes for numerical noise - are you happy with the fix otherwise?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690704",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690706",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Changing commit from \"cce62c225276687c4f9e331688bd638085e2dbcd\" to \"0c7da0a8b7a7199c6a1e3247cf8d476e5bdb3478\"",
    "created_at": "2022-11-09T13:37:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690707",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "cce62c225276687c4f9e331688bd638085e2dbcd" to "0c7da0a8b7a7199c6a1e3247cf8d476e5bdb3478"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690708",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>How would one do subclassing for `ComplexField`, `RealField`, etc? Would it need something like [PEP 646 \u2013 Variadic Generics](https://peps.python.org/pep-0646/) ?",
    "created_at": "2022-11-09T13:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690709",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:22'></a>How would one do subclassing for `ComplexField`, `RealField`, etc? Would it need something like [PEP 646 – Variadic Generics](https://peps.python.org/pep-0646/) ?
...
```json
{
    "body": "Changing commit from \"0c7da0a8b7a7199c6a1e3247cf8d476e5bdb3478\" to \"605968da44842a6351f93f69dbe68088ac9d749c\"",
    "created_at": "2022-11-10T17:08:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690711",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "0c7da0a8b7a7199c6a1e3247cf8d476e5bdb3478" to "605968da44842a6351f93f69dbe68088ac9d749c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690712",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690714",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Replying to [Dima Pasechnik](#comment%3A25):\n> Replying to [Nils Bruin](#comment%3A23):\n> [...]\n> > How that would work for ball fields I don't know,\n\n> AFAIK, `arb` has quite a bit of linear algebra nowadays\n> (I guess, these routines are on boxed data, to make them universal, but still...)\n\n\nIndeed! Some of it may have been wrapped already in `matrix_complex_ball_dense.pyx`, which I just found exists...\n\n> \n> Anyhow, this ticket is now ready for review.",
    "created_at": "2022-11-10T22:20:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690715",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:26'></a>Replying to [Dima Pasechnik](#comment%3A25):
> Replying to [Nils Bruin](#comment%3A23):
> [...]
> > How that would work for ball fields I don't know,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690716",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690717",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690718",
...
```json
{
    "body": "Changing branch from \"u/dimpase/matrix/fix_echelonize\" to \"605968da44842a6351f93f69dbe68088ac9d749c\"",
    "created_at": "2022-11-15T23:43:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34724#issuecomment-690719",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/dimpase/matrix/fix_echelonize" to "605968da44842a6351f93f69dbe68088ac9d749c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34724",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34724#event-89776"
}
```
