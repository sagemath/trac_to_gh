...
archive/issue_events_475781.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475781"
}
```
...
archive/issue_events_475782.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-19T18:35:39Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475782"
}
```
...
archive/issue_events_475783.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-19T18:35:39Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475783"
}
```
...
archive/issue_events_475784.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-19T18:35:39Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475784"
}
```
...
archive/issue_events_475785.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-19T18:40:02Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475785"
}
```
...
archive/issue_events_475786.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475786"
}
```
...
archive/issue_events_475787.json:
```json
{
    "actor": "https://github.com/jhpalmieri",
    "created_at": "2022-11-20T19:40:10Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475787"
}
```
...
archive/issue_events_475788.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475788"
}
```
...
archive/issue_events_475789.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34761",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34761#event-475789"
}
```
