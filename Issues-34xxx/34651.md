...
```json
{
    "body": "<a id='comment:9'></a>\nMathematically the code looks very good to me, it has extensive documentation and - from what I can see - it follows the established code conventions for [SageMath](../wikis/SageMath). So I am happy to give an informal positive review, but it would be good if someone more familiar with Sage would have another look.",
