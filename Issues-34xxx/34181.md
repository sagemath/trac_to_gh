...
```json
{
    "body": "<a id='comment:5'></a>\nMarc, I think this fixes the issue\n\n---\nNew commits:\n|                                                                                                                                          |                                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[b1d4970](https://git.sagemath.org/sage.git/commit?id=b1d49708b1e95e6279c2ff3a316cb228b77e47ff)|`build/pkgs/sagelib/spkg-install: Remove scripts directories before build`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nOkay, done.\n\n---\nNew commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[afa19d0](https://git.sagemath.org/sage.git/commit?id=afa19d04757750cf251ebaefa41e26e0dd6da551)|`trac 34181: only rm build/scripts-* for non-editable builds.`|",
    "created_at": "2022-07-25T05:29:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34181",
    "type": "issue_comment",
