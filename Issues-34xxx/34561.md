...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453342"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453344"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34561#issuecomment-561441",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34561#issuecomment-561442",
    "user": "https://github.com/pipedream"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453346"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453348"
}
```
...
archive/issue_events_453349.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453349"
}
```
...
archive/issue_events_453350.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34561",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34561#event-453350"
}
```
