...
archive/attachments_022387.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [debian-no-package-called-openssh.patch](https://github.com/sagemath/sage/files/ticket34561/debian-no-package-called-openssh.patch)\n\nThe correct file to patch is `build/pkgs/_develop/distros/debian.txt`\n\nThe instructions are generated from there.",
    "created_at": "2022-09-20T16:31:48Z",
    "issue": "https://github.com/sagemath/sage/issues/34561",
    "type": "issue_comment",
...
archive/attachments_022388.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [debian.txt.patch](https://github.com/sagemath/sage/files/ticket34561/debian.txt.patch)",
    "created_at": "2022-09-22T16:45:42Z",
    "issue": "https://github.com/sagemath/sage/issues/34561",
    "type": "issue_comment",
