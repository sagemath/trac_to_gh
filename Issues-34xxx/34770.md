...
archive/issue_events_475855.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475855"
}
```
...
archive/issue_events_475856.json:
```json
{
    "actor": "https://github.com/dimpase",
    "created_at": "2022-11-21T23:46:54Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475856"
}
```
...
archive/issue_events_475857.json:
```json
{
    "actor": "https://github.com/dimpase",
    "created_at": "2022-11-21T23:46:54Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475857"
}
```
...
archive/issue_events_475858.json:
```json
{
    "actor": "https://github.com/dimpase",
    "created_at": "2022-11-21T23:46:54Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475858"
}
```
...
archive/issue_events_475859.json:
```json
{
    "actor": "https://github.com/dimpase",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475859"
}
```
...
archive/issue_events_475860.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475860"
}
```
...
archive/issue_events_475861.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475861"
}
```
...
archive/issue_events_475862.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-12-03T04:25:16Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475862"
}
```
...
archive/issue_events_475863.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475863"
}
```
...
archive/issue_events_475864.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34770",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34770#event-475864"
}
```
