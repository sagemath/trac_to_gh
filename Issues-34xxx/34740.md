...
archive/issue_events_475576.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475576"
}
```
...
archive/issue_events_475577.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    "created_at": "2022-11-10T20:35:39Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475577"
}
```
...
archive/issue_events_475578.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    "created_at": "2022-11-10T20:35:39Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475578"
}
```
...
archive/issue_events_475579.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    "created_at": "2022-11-10T20:35:39Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475579"
}
```
...
archive/issue_events_475580.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475580"
}
```
...
archive/issue_events_475581.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    "created_at": "2022-11-11T03:09:41Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475581"
}
```
...
archive/issue_events_475582.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475582"
}
```
...
archive/issue_events_475583.json:
```json
{
    "actor": "https://github.com/kwankyu",
    "created_at": "2022-11-11T23:17:34Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475583"
}
```
...
archive/issue_events_475584.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475584"
}
```
...
archive/issue_events_475585.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34740",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34740#event-475585"
}
```
