...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470626"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34458#issuecomment-556733",
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34458#issuecomment-556734",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34458",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34458#event-470635"
}
```
