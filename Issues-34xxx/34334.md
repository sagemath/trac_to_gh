...
```json
{
    "body": "<a id='comment:1'></a>To be checked whether it's needed at all when we switch to PEP 660 editable wheels (#34209)",
    "created_at": "2022-08-10T17:56:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34334",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34334#issuecomment-683591",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>To be checked whether it's needed at all when we switch to PEP 660 editable wheels (#34209)
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34334#event-89388"
}
```
