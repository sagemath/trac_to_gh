...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[ec0577e](https://git.sagemath.org/sage.git/commit?id=ec0577e58372f91d929929b2787824a934ffb908)|`do not inherit hash from list_clone.pyx`|",
    "created_at": "2022-12-05T07:10:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34824",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[6e8ed10](https://git.sagemath.org/sage.git/commit/?id=6e8ed10ebf6811084acb1a2ca7c81b6455f629ba)|`override _hash_ instead of __hash__`|",
    "created_at": "2022-12-05T10:30:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34824",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|\n|[e8abff3](https://git.sagemath.org/sage.git/commit/?id=e8abff3404797414408214402774cd675023c8a8)|`do not include the parent in the hash of CloneableArray and ClonableIntArray, and remove useless overrides`|\n|[32a2bb4](https://git.sagemath.org/sage.git/commit/?id=32a2bb421afc4c571a68d561b89138589ceb4e3e)|`undo override`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|\n|[49ff03d](https://git.sagemath.org/sage.git/commit/?id=49ff03dedd5650099f91a83e008fe3d1ead95c14)|`check that hash and equality works in DecoratedPermutation, restore hash in OrderedMultisetPartitionIntoSets and AbstractSetPartition`|",
