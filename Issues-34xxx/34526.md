...
```json
{
    "body": "<a id='comment:3'></a>\nI've now manually converted it to a `list-table`. https://sublime-and-sphinx-guide.readthedocs.io/en/latest/tables.html#list-table-directive\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[972afeb](https://git.sagemath.org/sage.git/commit?id=972afeb1e9ef210ed5d6bc4a828402149910eebe)|`src/doc/en/developer/index.rst: Add software landscape table from https://trac.sagemath.org/wiki/WikiStart#Surveyingthemathematicalsoftwarelandscape`|",
    "created_at": "2022-09-18T22:49:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34526",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[cfce091](https://git.sagemath.org/sage.git/commit/?id=cfce091fecee537040d612098a22852d9f083c36)|`src/doc/en/developer/index.rst: Fix transition`|",
