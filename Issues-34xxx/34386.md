...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/34386",
...
```json
{
    "body": "<a id='comment:1'></a>What are everyone's thoughts on this?",
    "created_at": "2022-08-18T02:29:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34386#issuecomment-684944",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>What are everyone's thoughts on this?
...
```json
{
    "body": "<a id='comment:3'></a>> What should `__getitem__` return? On #33950 it returns the `i`-th module. \n\n\n+1 to `i`-th module. For maps, we may use `differential(i)` or `map(i)` or `d(i)` (if you want the shortest)\n\n> Should this new class eventually be a subclass of `FreeResolution_generic`? \n\n\nYes.",
    "created_at": "2022-08-18T06:46:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34386#issuecomment-684946",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:3'></a>> What should `__getitem__` return? On #33950 it returns the `i`-th module. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34386#issuecomment-684948",
    "user": "https://github.com/kwankyu"
}
```
...
archive/issue_comments_684950.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34386#issuecomment-684950",
    "user": "https://github.com/kwankyu"
}
```
...
archive/issue_comments_684954.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34386",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34386#issuecomment-684954",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34386#event-89456"
}
```
