...
```json
{
    "body": "What are everyone's thoughts on this?",
...
```json
{
    "body": "Or `free_resolution_fp_graded`?",
...
```json
{
    "body": "John's preference would shadow mine.",
