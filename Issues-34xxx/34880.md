...
archive/issue_events_476724.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34880#event-476724"
}
```
...
archive/issue_events_476725.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-12-28T03:37:59Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34880#event-476725"
}
```
...
archive/issue_events_476726.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-12-28T03:37:59Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34880#event-476726"
}
```
...
archive/issue_events_476727.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-12-28T03:37:59Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34880#event-476727"
}
```
...
archive/issue_events_476728.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34880#event-476728"
}
```
