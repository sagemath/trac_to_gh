...
archive/issue_events_474910.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474910"
}
```
...
archive/issue_events_474911.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-10-17T16:02:17Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474911"
}
```
...
archive/issue_events_474912.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-10-17T16:02:17Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474912"
}
```
...
archive/issue_events_474913.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-10-17T16:02:17Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474913"
}
```
...
archive/issue_events_474914.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-10-17T16:02:47Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474914"
}
```
...
```json
{
    "body": "<div id=\"comment:12\" align=\"right\">comment:12</div>\n\nNo, that is the correct answer. We have a parent that is the set of all ordered set partitions, no matter the base set.\n\nActually, I know a use case (answering the last part of [comment:9](#comment:9)): We need the union of `OrderedSetPartitions(n)` over all `n` to index the basis of `FQSym`.",
...
```json
{
    "body": "<div id=\"comment:20\" align=\"right\">comment:20</div>\n\nReplying to [Fr\u00e9d\u00e9ric Chapoton](#comment:19):\n> now using `set` and `frozenset`, and so really much faster in iteration. :)\n\nYay!\n\n> Some doctests are failing because of a modified order in the doctests. It is ok to change the doctests ?\n\nOf course.",
...
archive/issue_events_474915.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474915"
}
```
...
archive/issue_events_474916.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-10-21T06:41:54Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474916"
}
```
...
archive/issue_events_474917.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474917"
}
```
...
archive/issue_events_474918.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34673",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34673#event-474918"
}
```
