...
archive/issue_events_475353.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475353"
}
```
...
archive/issue_events_475354.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T11:04:54Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475354"
}
```
...
archive/issue_events_475355.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T11:04:54Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475355"
}
```
...
archive/issue_events_475356.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T11:04:54Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475356"
}
```
...
archive/issue_events_475357.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T11:05:58Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475357"
}
```
...
archive/issue_events_475358.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-04T08:42:54Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475358"
}
```
...
archive/issue_events_475359.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475359"
}
```
...
archive/issue_events_475360.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-11-05T01:18:32Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475360"
}
```
...
archive/issue_events_475361.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475361"
}
```
...
archive/issue_events_475362.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34719",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34719#event-475362"
}
```
