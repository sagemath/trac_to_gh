...
```json
{
    "body": "Did you build it from scratch, or is it an incremental build from a previous version?",
...
```json
{
    "body": "Try what `make list-broken-packages` from #34203 says about your installation.",
...
```json
{
    "body": "Can you reproduce the error also using the testsuite instead of the docbuild? For example `./sage -tp src/sage/rings`",
