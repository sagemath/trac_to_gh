...
archive/issue_events_476052.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34794#event-476052"
}
```
...
archive/issue_events_476053.json:
```json
{
    "actor": "https://github.com/kwankyu",
    "created_at": "2022-11-26T17:35:35Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34794#event-476053"
}
```
...
archive/issue_events_476054.json:
```json
{
    "actor": "https://github.com/kwankyu",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34794#event-476054"
}
```
...
archive/issue_events_476055.json:
```json
{
    "actor": "https://github.com/kwankyu",
    "created_at": "2022-11-26T17:38:04Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34794#event-476055"
}
```
...
archive/issue_events_476056.json:
```json
{
    "actor": "https://github.com/kwankyu",
    "created_at": "2022-11-26T17:38:04Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34794#event-476056"
}
```
