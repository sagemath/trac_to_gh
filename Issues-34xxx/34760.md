...
archive/issue_events_475772.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475772"
}
```
...
archive/issue_events_475773.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-19T14:13:29Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475773"
}
```
...
archive/issue_events_475774.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-19T14:13:29Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475774"
}
```
...
archive/issue_events_475775.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-19T14:13:29Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475775"
}
```
...
archive/issue_events_475776.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-21T07:43:50Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475776"
}
```
...
archive/issue_events_475777.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475777"
}
```
...
archive/issue_events_475778.json:
```json
{
    "actor": "https://github.com/stumpc5",
    "created_at": "2022-12-01T06:15:10Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475778"
}
```
...
archive/issue_events_475779.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475779"
}
```
...
archive/issue_events_475780.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34760",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34760#event-475780"
}
```
