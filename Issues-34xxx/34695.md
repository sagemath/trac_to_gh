...
archive/issue_events_475100.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34695#event-475100"
}
```
...
archive/issue_events_475101.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-10-26T03:50:03Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34695#event-475101"
}
```
...
archive/issue_events_475102.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-10-26T03:50:03Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34695#event-475102"
}
```
...
archive/issue_events_475103.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-10-26T03:50:03Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34695#event-475103"
}
```
...
archive/issue_events_475104.json:
```json
{
    "actor": "https://github.com/maxale",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34695#event-475104"
}
```
...
archive/issue_events_475105.json:
```json
{
    "actor": "https://github.com/maxale",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34695#event-475105"
}
```
