...
<a id='comment:1'></a>These fairly simple changes seem to do the trick.
...
<a id='comment:4'></a>I made small edits.
...
```json
{
    "body": "<a id='comment:7'></a>You can set positive review if you are okay with my edits.",
...
<a id='comment:7'></a>You can set positive review if you are okay with my edits.
