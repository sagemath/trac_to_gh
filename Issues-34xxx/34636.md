...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486864",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486865",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486866",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486867",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "A sparse representation does not make sense also for `Cauchy_invert`: `get_coefficient` accesses all previously computed values.",
    "created_at": "2022-10-11T08:54:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486868",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486869",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486870",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486871",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "I am wondering how much we even want the sparsity in the streams. We want it for the exact series in some cases (sparse versus dense for the (Laurent) polynomial ring), but it seems more like extra weight we are carrying around for the streams, which should instead simply be as dense or sparse as is most effective for them. Or maybe just for multiplication, which might be the only one that could matter? Do you remember if in any place we take advantage of the dense or sparse implementation currently?",
    "created_at": "2022-10-12T08:53:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486873",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486874",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486877",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486878",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Although having a sparse version of `Stream_exact` should be easy, taking advantage of it may be much more work, because currently we always compute a *list* of initial coefficients in `lazy_ring.py`.\n\nI very much doubt that it is worth the effort right now.",
    "created_at": "2022-10-13T07:08:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486880",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "Let us move along. This is definitely an improvement, and we can do further work on subsequent tickets.",
    "created_at": "2022-10-28T07:13:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486882",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486883",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34636#issuecomment-486884",
