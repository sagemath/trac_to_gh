...
archive/issue_events_474553.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474553"
}
```
...
archive/issue_events_474554.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-10-07T16:24:34Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474554"
}
```
...
archive/issue_events_474555.json:
```json
{
    "actor": "https://github.com/mantepse",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474558"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474559"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474560"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34636",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34636#event-474561"
}
```
