...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473446"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473449"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473452"
}
```
...
archive/issue_events_473453.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-09-11T18:48:40Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473453"
}
```
...
archive/issue_events_473454.json:
```json
{
    "actor": "https://github.com/EmmanuelCharpentier",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473454"
}
```
...
archive/issue_events_473455.json:
```json
{
    "actor": "https://github.com/EmmanuelCharpentier",
    "created_at": "2022-09-12T18:20:05Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-473455"
}
```
