...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34333#issuecomment-556789",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket34333/p_grp_cohom_tests.log",
    "created_at": "2022-08-10T21:48:55Z",
    "issue": "https://github.com/sagemath/sage/issues/34333",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket34333/p_grp_cohom_tests.log",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [p_grp_cohom_tests.log](https://github.com/sagemath/sage/files/ticket34333/p_grp_cohom_tests.log) by @jhpalmieri created at 2022-08-10 21:48:55",
    "created_at": "2022-08-10T21:48:55Z",
    "issue": "https://github.com/sagemath/sage/issues/34333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34333#issuecomment-556790",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [p_grp_cohom_tests.log](https://github.com/sagemath/sage/files/ticket34333/p_grp_cohom_tests.log) by @jhpalmieri created at 2022-08-10 21:48:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34333#issuecomment-556791",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34333#issuecomment-556792",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34333#event-305379"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34333#event-305380"
}
```
