...
```json
{
    "body": "<a id='comment:2'></a>I think this ticket would be a duplicate of #26754, except that the ticket was closed because #32427 supposedly deprecated all of sage.finance. Does something still need to be done?",
    "created_at": "2022-06-26T20:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34089#issuecomment-513693",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:2'></a>I think this ticket would be a duplicate of #26754, except that the ticket was closed because #32427 supposedly deprecated all of sage.finance. Does something still need to be done?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34089#issuecomment-513695",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34089",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34089#event-89107"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34089#event-89108"
}
```
