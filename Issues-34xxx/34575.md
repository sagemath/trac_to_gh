...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-453466"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-453467"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-453468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-453469"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34575#issuecomment-561612",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34575#issuecomment-561613",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34575#issuecomment-561614",
    "user": "https://github.com/collares"
}
```
