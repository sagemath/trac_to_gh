...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-471809"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-471810"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-471811"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34575#event-471812"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34575#issuecomment-558631",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34575#issuecomment-558632",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34575#issuecomment-558633",
    "user": "https://github.com/collares"
}
```
