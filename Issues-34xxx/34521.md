...
archive/issue_events_467868.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467868"
}
```
...
archive/issue_events_467869.json:
```json
{
    "actor": "https://github.com/Parcly-Taxel",
    "created_at": "2022-09-11T21:18:15Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467869"
}
```
...
archive/issue_events_467870.json:
```json
{
    "actor": "https://github.com/Parcly-Taxel",
    "created_at": "2022-09-11T21:18:15Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467870"
}
```
...
archive/issue_events_467871.json:
```json
{
    "actor": "https://github.com/Parcly-Taxel",
    "created_at": "2022-09-11T21:18:15Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34521",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467872"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467873"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467874"
}
```
...
```json
{
    ...
    "subject": "https://github.com/dimpase",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34521",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34521#event-467876"
}
```
