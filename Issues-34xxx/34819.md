...
archive/issue_events_476256.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476256"
}
```
...
archive/issue_events_476257.json:
```json
{
    "actor": "https://github.com/io4",
    "created_at": "2022-12-03T00:08:36Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476257"
}
```
...
archive/issue_events_476258.json:
```json
{
    "actor": "https://github.com/io4",
    "created_at": "2022-12-03T00:08:36Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476258"
}
```
...
archive/issue_events_476259.json:
```json
{
    "actor": "https://github.com/io4",
    "created_at": "2022-12-03T00:08:36Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476259"
}
```
...
archive/issue_events_476260.json:
```json
{
    "actor": "https://github.com/io4",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476260"
}
```
...
archive/issue_events_476261.json:
```json
{
    "actor": "https://github.com/io4",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476261"
}
```
...
archive/issue_events_476262.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476262"
}
```
...
archive/issue_events_476263.json:
```json
{
    "actor": "https://github.com/mezzarobba",
    "created_at": "2022-12-07T17:21:16Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476263"
}
```
...
archive/issue_events_476264.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476264"
}
```
...
archive/issue_events_476265.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34819",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34819#event-476265"
}
```
