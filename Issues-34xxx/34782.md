...
archive/issue_events_475940.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34782#event-475940"
}
```
...
archive/issue_events_475941.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-24T06:15:27Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34782#event-475941"
}
```
...
archive/issue_events_475942.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-24T06:15:27Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34782#event-475942"
}
```
...
archive/issue_events_475943.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-24T06:15:27Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34782#event-475943"
}
```
...
archive/issue_events_475944.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34782#event-475944"
}
```
