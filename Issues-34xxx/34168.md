...
```json
{
    "body": "<a id='comment:4'></a>\nSo far this branch addresses the other issues, but not `category_with_axiom.py`.\n\n---\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[be5851f](https://git.sagemath.org/sage.git/commit?id=be5851f1975792161018cff63f15154fe600bcaf)|`trac 34168: fix docstring markup for src/categories`|",
    "created_at": "2022-07-12T21:49:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34168",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[80d7f8f](https://git.sagemath.org/sage.git/commit/?id=80d7f8f4047c999758a141ae2cea777c27d776f0)|`trac 34168: more markup fixes for categories`|",
