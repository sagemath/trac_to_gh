...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/34820",
...
archive/issue_comments_691986.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34820#issuecomment-691986",
    "user": "https://github.com/mathlover2"
}
```
...
archive/issue_comments_691987.json:
```json
{
    "body": "<a id='comment:1'></a>Attachment [sympy_evalf_verbose_output.txt](tarball://root/attachments/some-uuid/ticket34820/sympy_evalf_verbose_output.txt) by @mathlover2 created at 2022-12-07 09:00:27\n\nADDENDUM: It seems this is in fact a bug with Sympy and not sage. Note that in the test code aboce, the Sympy code uses (1/4) instead of Rational(1, 4), which is the correct Sympy representation of rational numbers and what the [SageMath](SageMath) library calls.\n\nI will try to figure out the issue over there, and I request that this ticket be closed.",
    "created_at": "2022-12-07T09:00:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34820#issuecomment-691987",
    "user": "https://github.com/mathlover2"
}
```

<a id='comment:1'></a>Attachment [sympy_evalf_verbose_output.txt](tarball://root/attachments/some-uuid/ticket34820/sympy_evalf_verbose_output.txt) by @mathlover2 created at 2022-12-07 09:00:27
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34820#event-89830"
}
```
...
archive/issue_comments_691988.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34820#issuecomment-691988",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34820",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34820#event-89831"
}
```
