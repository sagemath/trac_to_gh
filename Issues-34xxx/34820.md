...
```
Executing the following code in [SageMath](../wikis/SageMath)
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [sympy_evalf_verbose_output.txt](https://github.com/sagemath/sage/files/ticket34820/sympy_evalf_verbose_output.txt)\n\nADDENDUM: It seems this is in fact a bug with Sympy and not sage. Note that in the test code aboce, the Sympy code uses (1/4) instead of Rational(1, 4), which is the correct Sympy representation of rational numbers and what the [SageMath](../wikis/SageMath) library calls.\n\nI will try to figure out the issue over there, and I request that this ticket be closed.",
    "created_at": "2022-12-07T09:00:27Z",
    "issue": "https://github.com/sagemath/sage/issues/34820",
    "type": "issue_comment",
