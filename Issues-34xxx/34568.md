...
archive/issue_events_473955.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473955"
}
```
...
archive/issue_events_473956.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-09-21T13:45:39Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473956"
}
```
...
archive/issue_events_473957.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-09-21T13:45:39Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473957"
}
```
...
archive/issue_events_473958.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2022-09-21T13:45:39Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473958"
}
```
...
archive/issue_events_473959.json:
```json
{
    "actor": "https://github.com/fchapoton",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473959"
}
```
...
archive/issue_events_473960.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473960"
}
```
...
archive/issue_events_473961.json:
```json
{
    "actor": "https://github.com/jhpalmieri",
    "created_at": "2022-09-22T18:22:45Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473961"
}
```
...
archive/issue_events_473962.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473962"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34568",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34568#event-473963"
}
```
