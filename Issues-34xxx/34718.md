...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454790"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454793"
}
```
...
archive/issue_events_454794.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34718#issuecomment-563361",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34718#issuecomment-563362",
    "user": "https://github.com/sagetrac-git"
}
```
