...
archive/issue_events_475348.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-475348"
}
```
...
archive/issue_events_475349.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T08:40:13Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-475349"
}
```
...
archive/issue_events_475350.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T08:40:13Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-475350"
}
```
...
archive/issue_events_475351.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-03T08:40:13Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-475351"
}
```
...
archive/issue_events_475352.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-475352"
}
```
