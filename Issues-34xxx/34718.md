...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454786"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454787"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454788"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34718#event-454789"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34718#issuecomment-563363",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34718#issuecomment-563364",
    "user": "https://github.com/sagetrac-git"
}
```
