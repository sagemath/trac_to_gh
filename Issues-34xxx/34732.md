...
archive/issue_events_475495.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475495"
}
```
...
archive/issue_events_475496.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-08T14:04:18Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475496"
}
```
...
archive/issue_events_475497.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-08T14:04:18Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475497"
}
```
...
archive/issue_events_475498.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2022-11-08T14:04:18Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475498"
}
```
...
archive/issue_events_475499.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475499"
}
```
...
archive/issue_events_475500.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475500"
}
```
...
archive/issue_events_475501.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-11-15T08:40:11Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475501"
}
```
...
archive/issue_events_475502.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475502"
}
```
...
archive/issue_events_475503.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2022-11-20T12:13:31Z",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-475503"
}
```
