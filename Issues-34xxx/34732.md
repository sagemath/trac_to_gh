...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454937"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454940"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454941"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454942"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34732#issuecomment-563555",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34732#issuecomment-563556",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34732#event-454945"
}
```
