...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451728"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451729"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451730"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451731"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558848",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558849",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558850",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451733"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558851",
    "user": "https://github.com/mkoeppe"
}
```
