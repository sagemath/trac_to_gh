...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451724"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451725"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451726"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-451727"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558852",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558853",
    "user": "https://github.com/mkoeppe"
}
```
