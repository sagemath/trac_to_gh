...
archive/issue_events_476776.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34887#event-476776"
}
```
...
archive/issue_events_476777.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2023-01-02T16:33:45Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34887#event-476777"
}
```
...
archive/issue_events_476778.json:
```json
{
    "actor": "https://github.com/mantepse",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34887#event-476778"
}
```
...
archive/issue_events_476779.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2023-01-02T16:52:44Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34887#event-476779"
}
```
...
archive/issue_events_476780.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2023-01-02T18:23:19Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34887#event-476780"
}
```
