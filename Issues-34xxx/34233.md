...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-470370"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-470371"
}
```
...
archive/issue_events_470372.json:
```json
{
    "actor": "https://github.com/kcrisman",
    "created_at": "2022-07-28T13:52:41Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-470372"
}
```
...
archive/issue_events_470373.json:
```json
{
    "actor": "https://github.com/kcrisman",
    "created_at": "2022-07-28T13:52:41Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-470373"
}
```
...
archive/issue_events_470374.json:
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-470374"
}
```
...
archive/issue_events_470375.json:
```json
{
    "actor": "https://github.com/mkoeppe",
    "created_at": "2022-09-19T18:58:47Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-470375"
}
```
