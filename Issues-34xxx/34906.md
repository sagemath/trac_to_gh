...
archive/issue_events_476901.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34906#event-476901"
}
```
...
archive/issue_events_476902.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2023-01-11T07:30:53Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34906#event-476902"
}
```
...
archive/issue_events_476903.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2023-01-11T07:30:53Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34906#event-476903"
}
```
...
archive/issue_events_476904.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    "created_at": "2023-01-11T07:30:53Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34906#event-476904"
}
```
...
archive/issue_events_476905.json:
```json
{
    "actor": "https://github.com/yyyyx4",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34906#event-476905"
}
```
...
archive/issue_events_476906.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34906#event-476906"
}
```
...
archive/issue_events_476907.json:
```json
{
    "actor": "https://github.com/fchapoton",
    "created_at": "2023-01-12T16:39:34Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34906#event-476907"
}
```
