...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449238"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449239"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34174#issuecomment-555065",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34174#issuecomment-555066",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449242"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449243"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449244"
}
```
...
```json
{
    ...
    "title_was": "ValueError when computing isogeny classes of elliptic curves over number fields",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449245"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449246"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34174",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34174#event-449249"
}
```
