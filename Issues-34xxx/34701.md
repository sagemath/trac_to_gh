...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-472945"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-472946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-472947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-472948"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560220",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560221",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560222",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560223",
    "user": "https://github.com/sagetrac-git"
}
```
