...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34701#issuecomment-690420",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34701#issuecomment-690421",
    "user": "https://github.com/collares"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[90acc7f](https://git.sagemath.org/sage.git/commit/?id=90acc7f1c13a80b8aa673469a2668feb9cd4207f)|`Surround GAP_ValueGlobalVariable calls by GAP_Enter/GAP_Leave`|",
    "created_at": "2022-10-29T00:20:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34701#issuecomment-690422",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34701#issuecomment-690423",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
