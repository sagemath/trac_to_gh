...
archive/issue_comments_678094.json:
```json
{
    "body": "<a id='comment:1'></a>My personal feeling is that `bool(a)` should be equivalent to \"a is not exact zero\".",
    "created_at": "2022-06-19T18:43:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34024#issuecomment-678094",
    "user": "https://github.com/videlec"
}
```

<a id='comment:1'></a>My personal feeling is that `bool(a)` should be equivalent to "a is not exact zero".
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34024#event-89036"
}
```
