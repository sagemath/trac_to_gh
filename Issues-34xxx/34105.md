...
```json
{
    "body": "<a id='comment:3'></a>\nThe first commit fixes the error by skipping zero monomials (and adds a doctest). The second commit cleans up the code a bit.\n\n---\nNew commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[1aafc3c](https://git.sagemath.org/sage.git/commit?id=1aafc3c796db74a74a8c7e797db5b700f880bdac)|`trac 34105 fix ZeroDivisionError`|\n|[48248d6](https://git.sagemath.org/sage.git/commit?id=48248d6ceb84b3b4f63a09979c1f815e6cf26c9c)|`minor refactoring`|",
    "created_at": "2022-07-01T22:05:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34105",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[0b16491](https://git.sagemath.org/sage.git/commit/?id=0b16491070a4ab16439b85359972f39a338b5fe2)|`Remove zeros from generator set`|",
