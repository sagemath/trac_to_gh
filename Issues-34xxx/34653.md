...
archive/issue_events_474719.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474719"
}
```
...
archive/issue_events_474720.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-10-12T23:27:47Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474720"
}
```
...
archive/issue_events_474721.json:
```json
{
    "actor": "https://github.com/mantepse",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474721"
}
```
...
archive/issue_events_474722.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-10-12T23:31:56Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474722"
}
```
...
archive/issue_events_474723.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-10-12T23:31:56Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474723"
}
```
...
archive/issue_events_474724.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474724"
}
```
...
archive/issue_events_474725.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-10-13T04:33:59Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474725"
}
```
...
archive/issue_events_474726.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474726"
}
```
...
archive/issue_events_474727.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34653",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34653#event-474727"
}
```
