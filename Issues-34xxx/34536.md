...
archive/issue_events_471432.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34536#event-471432"
}
```
...
archive/issue_events_471433.json:
```json
{
    "actor": "https://github.com/Parcly-Taxel",
    "created_at": "2022-09-15T05:32:05Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34536#event-471433"
}
```
...
archive/issue_events_471434.json:
```json
{
    "actor": "https://github.com/Parcly-Taxel",
    "created_at": "2022-09-15T05:32:05Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34536#event-471434"
}
```
...
archive/issue_events_471435.json:
```json
{
    "actor": "https://github.com/Parcly-Taxel",
    "created_at": "2022-09-15T05:32:05Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34536#event-471435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34536#issuecomment-557957",
    "user": "https://github.com/Parcly-Taxel"
}
```
