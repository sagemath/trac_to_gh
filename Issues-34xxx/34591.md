...
<a id='comment:7'></a>Replying to [comment:6 Dave Morris]:
> I think this is a duplicate of #34417.
...
<a id='comment:8'></a>I don't know why you say there is no problem with singular. As pointed out in ticket:34417#comment:1, the problem seems to arise in `singular_polynomial_call`.  
...
<a id='comment:10'></a>Replying to [comment:8 Dave Morris]:
> I don't know why you say there is no problem with singular. As pointed out in ticket:34417#comment:1, the problem seems to arise in `singular_polynomial_call`.  
