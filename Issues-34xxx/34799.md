...
archive/issue_events_476106.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476106"
}
```
...
archive/issue_events_476107.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-27T18:41:28Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476107"
}
```
...
archive/issue_events_476108.json:
```json
{
    "actor": "https://github.com/mantepse",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476108"
}
```
...
archive/issue_events_476109.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-27T18:48:21Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476109"
}
```
...
archive/issue_events_476110.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-27T18:48:21Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476110"
}
```
...
archive/issue_events_476111.json:
```json
{
    "actor": "https://github.com/mantepse",
    "created_at": "2022-11-27T18:48:21Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476111"
}
```
...
archive/issue_events_476112.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476112"
}
```
...
archive/issue_events_476113.json:
```json
{
    "actor": "https://github.com/tscrim",
    "created_at": "2022-11-28T23:56:56Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476113"
}
```
...
archive/issue_events_476114.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476114"
}
```
...
archive/issue_events_476115.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34799",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34799#event-476115"
}
```
