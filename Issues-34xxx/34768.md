...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-455284"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-455285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-455286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-455287"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34768#issuecomment-563916",
    "user": "https://github.com/alexhutman"
}
```
