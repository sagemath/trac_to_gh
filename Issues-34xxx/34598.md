...
archive/issue_events_472030.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34598#event-472030"
}
```
...
archive/issue_events_472031.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-09-28T12:39:26Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34598#event-472031"
}
```
...
archive/issue_events_472032.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-09-28T12:39:26Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34598#event-472032"
}
```
...
archive/issue_events_472033.json:
```json
{
    "actor": "https://github.com/maxale",
    "created_at": "2022-09-28T12:39:26Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34598#event-472033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34598",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34598#issuecomment-558999",
    "user": "https://github.com/maxale"
}
```
