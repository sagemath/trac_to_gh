...
archive/issue_events_475462.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475462"
}
```
...
archive/issue_events_475463.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2022-11-07T20:24:18Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475463"
}
```
...
archive/issue_events_475464.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2022-11-07T20:24:18Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475464"
}
```
...
archive/issue_events_475465.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2022-11-07T20:24:18Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475465"
}
```
...
archive/issue_events_475466.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475466"
}
```
...
archive/issue_events_475467.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475467"
}
```
...
archive/issue_events_475468.json:
```json
{
    "actor": "https://github.com/dimpase",
    "created_at": "2022-11-13T23:55:24Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475468"
}
```
...
archive/issue_events_475469.json:
```json
{
    "actor": "https://github.com/vbraun",
    "created_at": "2022-11-15T23:43:00Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475469"
}
```
...
archive/issue_events_475470.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34729",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34729#event-475470"
}
```
