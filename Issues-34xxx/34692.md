...
archive/issue_events_475073.json:
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475073"
}
```
...
archive/issue_events_475074.json:
```json
{
    "actor": "https://github.com/antoine-leudiere",
    "created_at": "2022-10-24T16:50:53Z",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475074"
}
```
...
archive/issue_events_475075.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475075"
}
```
...
archive/issue_events_475076.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    "created_at": "2022-10-27T15:13:38Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475076"
}
```
...
archive/issue_events_475077.json:
```json
{
    "actor": "https://github.com/antoine-leudiere",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475077"
}
```
...
archive/issue_events_475078.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    "created_at": "2022-11-15T01:01:24Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475078"
}
```
...
archive/issue_events_475079.json:
```json
{
    "actor": "https://github.com/DavidAyotte",
    "created_at": "2022-11-15T01:01:24Z",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475079"
}
```
...
archive/issue_events_475080.json:
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475080"
}
```
...
archive/issue_events_475081.json:
```json
{
    "actor": "https://github.com/vbraun",
    ...
    "issue": "https://github.com/sagemath/sage/issues/34692",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34692#event-475081"
}
```
