...
```json
{
    "body": "<a id='comment:9'></a>\nI confirm that [SageMath](../wikis/SageMath) 9.7.beta3 plus #34025 passes ```make ptestlong``` without problems (apart from #33212 on macOS 11.6.7 with Xcode 13.2.1).",
...
```json
{
    "body": "<a id='comment:14'></a>\nHello, where can I look for the merge failure? On my machine, I was able to merge the develop branch (v. 9.7.beta3) into my branch without any merge failure. I upgraded [SageMath](../wikis/SageMath) to version 9.7.beta3 and I'm currently building it.",
...
```json
{
    "body": "<a id='comment:22'></a>\nThank you all for investigating this, I was a little bit confused about this and my [SageMath](../wikis/SageMath) was currently building.",
