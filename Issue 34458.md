...
```json
{
    ...
    "title": "Conversion to SR sometimes add unnecessary coefficient \"1*\"",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34458#issuecomment-488091",
    "user": "@nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34458#issuecomment-488092",
    "user": "@maxale"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34458#issuecomment-488093",
    "user": "@nbruin"
}
```
