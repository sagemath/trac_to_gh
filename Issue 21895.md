...
Original creation time: 2017-01-03 19:59:44
...
sage: AA(sqrt(2))
1.414213562373095?
sage: PointConfiguration([This is the Trac macro *AA* that was inherited from the migration called with arguments (sqrt)](https://trac.sagemath.org/wiki/WikiMacros#AA-macro))
...
sage: PointConfiguration([This is the Trac macro *AA* that was inherited from the migration called with arguments (sqrt)](https://trac.sagemath.org/wiki/WikiMacros#AA-macro)).base_ring()
...
Comment by nbruin created at 2017-01-03 20:45:21
...
```
sage: P=PointConfiguration([This is the Trac macro *1.17,2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1.17,2-macro))
sage: parent(P[0])
...
```
sage: PointConfiguration([This is the Trac macro *1.0,2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1.0,2-macro)).base_ring()
Integer Ring
sage: PointConfiguration([This is the Trac macro *1.1,2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1.1,2-macro)).base_ring()
...
Comment by moritz created at 2017-01-03 22:26:18
...
Comment by tscrim created at 2017-01-03 22:28:55
...
Comment by nbruin created at 2017-01-03 23:29:44
...
Comment by moritz created at 2017-01-04 12:33:14
...
Comment by mkoeppe created at 2017-01-11 23:48:14
...
Comment by tscrim created at 2017-01-12 02:02:03
...
Comment by git created at 2017-01-12 12:37:28
...
Comment by moritz created at 2017-01-12 12:41:10
...
Comment by mkoeppe created at 2017-01-12 21:23:02
...
Comment by vbraun created at 2017-01-29 12:04:25
