...
### Super-duper High Priority: Startup time
  * #8254 - needs_work
  * #11683 - (in progress) speed up ell_curve_isogeny initialization
  * #11040 - needs_work
  * #11043 - needs_work
  * #11714 - possibly invalid; Make sure numpy does not get imported on startup
  * #11716 - positive review
  * #11730 - needs review
  * #11732 - needs review
  * #11733 - needs review
  * #11734 - needs review
  * #11729 - A cached importer that extends the Python module import framework with a persistent cache.
 ...
 * #10152 - closed as dup of #10973
 * #10973 - needs_work; new integral points (Aly and Jen)
 ...
 * #8783 - positive_review frobby optional spkg doesn't build with newer GCC's (Positive review: Benjamin Jones)
 ...
 * #10981 - positive_review -- new algebraic real field partial_fraction_decomposition bug (valiantly but unsuccessfully attempted: Simon Spicer); seems to be cuased by:
 * #11728 - (closed as dup) Multiplication(?) buggy in AA
 * #7879 - positive_review Remove unnecessary signal handling for low prec mpfr operations
 * #8896 - needs_info `0.0000000000000000000000000000` is parsed completely differently
 * #10635 - positive_review refactor polynomial_element.pyx factor function
 * #4949 - positive_review Optionally build spkgs in $SAGE_BUILD_TMPDIR (reviewed by maarten)
 * #10970 - positive_review Remove pipestatus from spkg/install
 ...
 * #10952 - positive_review; better numerical accuracy testing (Rob Beezer, William Stein)
 * #6284 - closed; fix the numerous broken optional magma doctests
 * #8469 - positive_review; add "Number Theory and the RSA Public Key Cryptosystem" (Rob Beezer, Martin Albrecht)
 * #9487 - new; Have an acurate description of what "supported platforms" are
 * #9494 - positive_review; Add a doctest to benchmark.py (Rob Beezer, Benjamin Jones)
 * #10910 - needs_work (basically it just depends on #11130, upgrading pari, and I don't see any additional work that is needed); Avoid nfinit while factoring polynomials
 ...
 * #11421 - positive_review; upgrade optional package NZMATH to version 1.1.0
 ...
 * #7494 - positive_review; remove/move the examples directory stuff already
