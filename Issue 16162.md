# Issue 16162: Matrix stack() should coerce to a common parent
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16162#event-48267"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16162#event-48268"
}
```
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16162#event-48269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16162",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16162#event-48270"
}
```
