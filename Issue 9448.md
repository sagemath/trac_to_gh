...
```json
{
    "body": "I know it does not nearly address all the issues in the ticket, but at least this doc patch is a start...",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9448#issuecomment-90541",
    "user": "mvngu"
}
```
...
```json
{
    "body": "I'm OK with the added documentation in [attachment:9448.patch]. Note that that patch introduces a trivial typo, which is fixed in [attachment:trac-9448_reviewer.patch]. If my reviewer patch is OK, then the whole ticket gets a positive review.",
    "created_at": "2010-11-13T08:42:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9448#issuecomment-90542",
    "user": "mvngu"
}
```
