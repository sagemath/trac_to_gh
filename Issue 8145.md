...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/8145#issuecomment-71604",
    "user": "mvngu"
}
```
...
```json
{
    "body": "The [2] is missing in the quotation... Can we really include it in standard Sage -- is it GPL2 compatible ?\n\nNathann",
    "created_at": "2010-03-21T19:03:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8145",
    "type": "issue_comment",
