# Issue 4381: [with patch, positive review] sage -wthread not passed correctly to ipython
...
```json
{
    ...
    "title": "[with patch, positive review] sage -wthread not passed correctly to ipython",
    "type": "issue",
