...
```json
{
    "body": "As discussed at , pushing new commits to a ticket with status `positive_review` might lead to a race condition resulting in merging the previous ticket.\n\nThus change the developer guide to reflect this.\n\nIssue created by migration from https://trac.sagemath.org/ticket/18228\n\n",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241884",
    "user": "@cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241885",
    "user": "@cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241886",
    "user": "@nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241887",
    "user": "@cheuberg"
}
```
...
```json
{
    "body": "Here is a list of the tickets I am aware of where pushes after `positive_review` led to incomplete merges:\n",
    "created_at": "2015-04-17T04:26:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241888",
    "user": "@cheuberg"
}
```
...
```json
{
    "body": "One thing I don't really like about this ticket is that it refers to the preferences of *the current release manager*. This is unlike everything else in the Sage manual, which is general Sage policy.\n\n(this doesn't mean that I'm against this ticket, but I just wanted to point this out)",
    "created_at": "2015-04-17T04:35:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241889",
    "user": "@jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241890",
    "user": "@nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241891",
    "user": "@cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241892",
    "user": "@nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241893",
    "user": "@nathanncohen"
}
```
...
```json
{
    "body": "Yet another alternative mentionned by Volker: a two-weeks period between a merge and the latest commit. I know that Thierry would be interested by something like that.",
    "created_at": "2015-04-17T07:07:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241894",
    "user": "@nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241895",
    "user": "@cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241896",
    "user": "@cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241897",
    "user": "@cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241898",
    "user": "@nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17991#issuecomment-241899",
    "user": "@nathanncohen"
}
```
