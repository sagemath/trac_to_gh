# Issue 19760: advanced symbolic series of Order any expression
...
```json
{
    "body": "The substitution is fine. To support other than power series would be a major enhancement.",
    "created_at": "2016-02-05T09:11:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19760#issuecomment-271293",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19760#issuecomment-271294",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19760#issuecomment-271295",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "So, until that enhancement is implemented, a second ticket is needed for consistency, which throws an error. But note that the user won't even encounter this inconsistency if she creates symbolic series the way the documentation suggests it:\n\n```\nsage: (1/(1-x)).series(x,2)\n1 + 1*x + Order(x^2)\nsage: s=_\nsage: s.subs(x==sin(x))\nsin(x) + 1\nsage: s.subs(x==exp(x))\ne^x + 1\nsage: s.subs(x==1/x)\n1/x + 1\nsage: s.subs(x=1/x)\n1/x + 1\n```",
    "created_at": "2016-02-09T14:14:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19760#issuecomment-271296",
    "user": "https://github.com/rwst"
}
```
