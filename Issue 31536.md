...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450750",
    "user": "@mwageringel"
}
```
...
```json
{
    "body": "This should be compatible with older versions as well.\n----\nNew commits:",
    "created_at": "2021-05-03T18:09:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450751",
    "user": "@mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450753",
    "user": "@mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450754",
    "user": "@mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450755",
    "user": "@slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450756",
    "user": "@slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450757",
    "user": "@sheerluck"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450758",
    "user": "@mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450759",
    "user": "@mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450760",
    "user": "@vbraun"
}
```
...
```json
{
    "body": "Reply to gh-sheerluck: such addition to kernel.json to include paths to octave and Macaulay2's M2 does not allow me to use either octave or the macaulay2 from a jupyter notebook opened from SageMath-9.6 arm64 version under macOS 12.5.1 on an M1 Mac. What's wrong?",
    "created_at": "2022-08-29T19:52:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/31536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/31536#issuecomment-450761",
    "user": "@murrayE"
}
```
