...
```
  SetPartition([This is the Trac macro *1,2,3* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1,2,3-macro)).to_permutation() == Permutation([2,3,1])
```
