# Issue 6459: [with patch, positive review] make it so control-shift-enter sends a blank line to tinymce
...
```json
{
    ...
    "title": "[with patch, positive review] make it so control-shift-enter sends a blank line to tinymce",
    "type": "issue",
