# Issue 1894: [with patch, with positive review] toy_buchberger failures
...
```json
{
    ...
    "title": "[with patch, with positive review] toy_buchberger failures",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1894",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1894#event-4564"
}
```
