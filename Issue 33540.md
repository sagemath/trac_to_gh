...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477440",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477441",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "How does CHomP compare speed-wise to what Sage can natively do? That might be a reason to continue to support it, perhaps as an experimental package.",
    "created_at": "2022-05-01T23:39:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477442",
    "user": "tscrim"
}
```
...
```json
{
    "body": "Since I can't build CHomP on OS X, it's hard for me to compare. If I have a chance, I'll see if it works on a virtual linux machine and compare there.",
    "created_at": "2022-05-01T23:53:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477443",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "I should be able to run it on my machine. Can you give me a few tests?",
    "created_at": "2022-05-01T23:59:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477444",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477447",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477448",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477451",
    "user": "jhpalmieri"
}
```
...
```json
{
    "body": "Does `kenzo` provide the functionality in question?",
    "created_at": "2022-07-02T10:01:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477452",
    "user": "dimpase"
}
```
...
```json
{
    "body": "Ah, more apparent abandonware. I can find a version of Kenzo from 2008 at https://www-fourier.ujf-grenoble.fr/~sergerar/Kenzo/, and a version last modified several years ago at https://github.com/gheber/kenzo. The documentation is dated 1999, and according to that, it implements chain complexes and simplicial sets, not cubical complexes, not simplicial complexes. There have been some efforts to update it and improve its interface with Sage (#29879, #30400#comment:48) based on the branch at https://github.com/miguelmarco/kenzo/, but the branch and those efforts appear to have stalled. In any case, I think that's a parallel issue.",
    "created_at": "2022-07-02T18:47:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477453",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477454",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477455",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477456",
    "user": "jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33540#issuecomment-477457",
    "user": "vbraun"
}
```
