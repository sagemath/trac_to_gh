...
```json
{
    "body": "see: https://sourceforge.net/p/maxima/bugs/3295/",
    "created_at": "2017-03-19T14:04:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21203#issuecomment-294004",
    "user": "@mforets"
}
```
...
```json
{
    "body": "Is the following example an instance of the same bug, or a different problem?\n\n```\nsage: (cos(pi*x)*exp(-I*pi*x)).integral(x,-1/2,1/2)  # wrong\n1\nsage: F = (cos(pi*x)*exp(-I*pi*x)).integral(x); F(x=1/2)-F(x=-1/2)  # correct\n1/2\n```\n",
    "created_at": "2018-10-02T21:34:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21203#issuecomment-294005",
...
```json
{
    "body": "Hmmm they look similar to me, although in your example the primitive computed by Maxima is correct, but for the case of the description also the primitive is wrong:\n\n\n```\nsage: f1 = (2*cos(2*pi*x) - cos(4*pi*x)) / (5 - 4*cos(2*pi*x))\nsage: F1 = f1.integrate(x)\nsage: F1(x=1) - F1(x=0)  # yet another result!\n5/8\nsage: F1_g = f1.integrate(x, algorithm=\"giac\")\nsage: F1_g(x=1) - F1_g(x=0)\n1/4\n```\n",
    "created_at": "2018-10-02T22:54:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21203#issuecomment-294006",
    "user": "@mforets"
}
```
...
```json
{
    "body": "I'm not sure `integrate` accepts inputs that take non-real values (it should be documented if yes or no):\n\n```\nsage: f(x)=cos(pi*x)*exp(-I*pi*x)\nsage: f(1/4)\n-1/2*I + 1/2\n```\n\nNote that:\n\n```\nsage: (cos(pi*x)*exp(-I*pi*x)).real().integral(x,-1/2,1/2) \n1/2\n```\n",
    "created_at": "2018-10-03T08:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21203#issuecomment-294007",
    "user": "@zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21203#issuecomment-294009",
    "user": "@fchapoton"
}
```
...
```json
{
    "body": "Attachment [bad_primitives.png](tarball://root/attachments/some-uuid/ticket21440/bad_primitives.png) by @fchapoton created at 2020-09-22 12:50:34\n\nHere is the picture, with mathematica_free result at the end, also not continuous\n![](bad_primitives.png\u200b)",
    "created_at": "2020-09-22T12:50:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21203#issuecomment-294010",
    "user": "@fchapoton"
}
```

Attachment [bad_primitives.png](tarball://root/attachments/some-uuid/ticket21440/bad_primitives.png) by @fchapoton created at 2020-09-22 12:50:34
