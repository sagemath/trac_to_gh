...
Original creation time: 2013-07-25 19:29:13

_This is a spin-off from #14403, to get that one landed and have a discussion with a wider scope here._
...
As you can see, the distinction between the two flavours of `x` can easily get lost, e.g. by (deliberate or accidential) coercion into the symbolic ring. The real problem here is not so much the fact that this does not work (after all, the user _could_ have chosen a different variable name in the first place), but rather that this will seem to work but will yield wrong results.
...
Comment by nbruin created at 2013-07-26 12:41:42
