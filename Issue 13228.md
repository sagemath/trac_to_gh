...
```
def test1(N,t):
    L=[This is the Trac macro *i^j for i in [1..N* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#i^j for i in [1..N-macro) for j in [1..N]]
    for i in range(t):
