# Issue 6715: [with patch, positive review] spell-check all modules under sage/logic
...
```json
{
    ...
    "title": "[with patch, positive review] spell-check all modules under sage/logic",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/6715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/6715#event-15856"
}
```
