# Issue 4173: [with spkg, positive review] Solaris: fix cddlib build problem on Solaris x86
...
```json
{
    ...
    "title": "[with spkg, positive review] Solaris: fix cddlib build problem on Solaris x86",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4173#event-9476"
}
```
