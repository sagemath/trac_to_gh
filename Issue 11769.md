...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134029",
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31602"
}
```
...
```json
{
    "body": "Well, in general we do *not* want to do this.  It's been discussed ad nauseam [many](http://groups.google.com/group/sage-support/browse_thread/thread/66d45649ca8c1cc3?pli=1)  [times](http://ask.sagemath.org/question/260/fractional-power-to-negative-number), and the sense is that:\n* Similar programs don't necessarily do this\n* `(-1)^(1/3)` is not really `-1` but a primitive complex root of `-1`.  \n\nThis ticket is about the fact that Maxima returns three solutions to the equation, but when we do the `assume(x,'real')` they *all* mysteriously vanish!",
    "created_at": "2011-11-17T14:18:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134031",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "It seems that sage sets domain: complex (I was made aware of this by burcin in IRC). You do get this result as follows:\n\n```\n(%i8) domain:complex;\n\n(%o8) complex\n(%i9) solve(x^3+1=0,x);\n\n(%o9) [x = ((-1)^(1/3)*sqrt(3)*%i-(-1)^(1/3))/2,\n       x = -((-1)^(1/3)*sqrt(3)*%i+(-1)^(1/3))/2,x = (-1)^(1/3)]\n```",
    "created_at": "2011-11-17T16:15:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134034",
    "user": "https://github.com/mboratko"
}
```
...
```json
{
    "body": "Ugh, all my comments have screwed up formatting. I wish I could edit them (can I?). I should have been:\n\n```\n\n(%i8) domain:complex;\n\n(%o8) complex\n(%i9) solve(x^3+1=0,x);\n\n(%o9) [x = ((-1)^(1/3)*sqrt(3)*%i-(-1)^(1/3))/2,\n       x = -((-1)^(1/3)*sqrt(3)*%i+(-1)^(1/3))/2,x = (-1)^(1/3)]\n\n```",
    "created_at": "2011-11-17T16:16:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134035",
    "user": "https://github.com/mboratko"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134038",
    "user": "https://github.com/mboratko"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31603"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31604"
}
```
...
```json
{
    "body": "Attachment [trac_11941.patch](tarball://root/attachments/some-uuid/ticket11941/trac_11941.patch) by @jdemeyer created at 2013-08-13 15:35:53",
    "created_at": "2013-08-13T15:35:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134039",
    "user": "https://github.com/jdemeyer"
}
```

Attachment [trac_11941.patch](tarball://root/attachments/some-uuid/ticket11941/trac_11941.patch) by @jdemeyer created at 2013-08-13 15:35:53
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31605"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31606"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31607"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31608"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31609"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31610"
}
```
...
```json
{
    "body": "You need to set \"needs review\" if you want someone to look at your code. I'll do that now.",
    "created_at": "2015-01-31T09:05:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134040",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134041",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "As Karl-Dieter says in comment:8 it is not desirable to switch back and forth with Maxima domain commands, so I don't think your patch is the right way to solve it, esp. since you don't get the right result, either. Presumably the failure of assumption should be reported upstream.",
    "created_at": "2015-03-11T17:22:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134042",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134043",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "As found in #22017 SymPy gets it right. If SymPy is better than Maxima with symbolic polynomial roots then I think we should switch to SymPy for the special case.",
    "created_at": "2016-12-05T06:51:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134044",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31611"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/11769#event-31612"
}
```
...
```json
{
    "body": "Note that sympy also incorporates assumptions into the solver:\n\n```python\nIn [2]: x = var('x', real=True)\n\nIn [3]: solve(Eq(x**3, -8))\nOut[3]: [-2]\n```",
    "created_at": "2016-12-05T07:19:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134045",
...
```json
{
    "body": "Switching to SymPy would also depend on something like #22024.",
    "created_at": "2016-12-05T07:39:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134046",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134048",
...
```json
{
    "body": "As pointed out [comment:6 earlier], this is due to `domain:complex`:\n\n```\nMaxima 5.39.0 http://maxima.sourceforge.net\nusing Lisp ECL 16.1.2\nDistributed under the GNU Public License. See the file COPYING.\nDedicated to the memory of William Schelter.\nThe function bug_report() provides bug reporting information.\n(%i1) domain:complex;\n(%o1)                               complex\n(%i2) solve(x^3+1=0,x);\n                1/3                   1/3\n           (- 1)    sqrt(3) %i - (- 1)\n(%o2) [x = ------------------------------, \n                         2\n                                       1/3                   1/3\n                                  (- 1)    sqrt(3) %i + (- 1)              1/3\n                            x = - ------------------------------, x = (- 1)   ]\n                                                2\n```",
    "created_at": "2017-11-14T15:45:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134049",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "And if you can figure out how to deal with this - in Maxima or elsewhere - please do!   I don't think this was ever reported upstream.",
    "created_at": "2017-11-14T15:46:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134050",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134051",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134053",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134055",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134056",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11769#issuecomment-134057",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
