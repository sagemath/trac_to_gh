...
```json
{
    "body": "Attachment [trac_13225-add_upper_lower_semimodular_and_modular_for_lattices-csar-v2.patch](tarball://root/attachments/some-uuid/ticket13225/trac_13225-add_upper_lower_semimodular_and_modular_for_lattices-csar-v2.patch) by chapoton created at 2013-05-09 18:34:09\n\nOk, here is a new patch, with small changes and more doc.\n\nIt seems to be good to go, but let us first wait for the bot report.\n\napply trac_13225-add_upper_lower_semimodular_and_modular_for_lattices-csar-v2.patch",
...
Attachment [trac_13225-add_upper_lower_semimodular_and_modular_for_lattices-csar-v2.patch](tarball://root/attachments/some-uuid/ticket13225/trac_13225-add_upper_lower_semimodular_and_modular_for_lattices-csar-v2.patch) by chapoton created at 2013-05-09 18:34:09
