...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34112#issuecomment-483368",
    "user": "https://github.com/heindel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34112#issuecomment-483369",
    "user": "https://github.com/heindel"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34112#event-89405"
}
```
...
```json
{
    "body": "Attachment [installedPackages.txt](tarball://root/attachments/some-uuid/ticket34349/installedPackages.txt) by @slel created at 2022-08-12 19:32:41\n\nThanks for the report!\n\nOur suggestion mechanism is not perfect.\n\nThe phrasing (\"if not already present\", \"may\")\ntries to convey that.\n\nPropose to close as wontfix, unless someone\ncan suggest a concrete improvement.",
    "created_at": "2022-08-12T19:32:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34112#issuecomment-483370",
    "user": "https://github.com/slel"
}
```

Attachment [installedPackages.txt](tarball://root/attachments/some-uuid/ticket34349/installedPackages.txt) by @slel created at 2022-08-12 19:32:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34112#issuecomment-483371",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34112#issuecomment-483373",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34112#issuecomment-483374",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34112",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/34112#event-89406"
}
```
