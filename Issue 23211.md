# Issue 23211: configure fails when run with a posix shell supporting $LINENO (e.g. dash 0.5.9 and many others)
...
```json
{
    "body": "After much suffering, I found out the code at fault in `configure.ac`:\n\n```\n#---------------------------------------------------------\n# We need to run this configure script with bash\nif test -z \"$BASH_VERSION$CONFIG_SHELL\"\nthen\n    CONFIG_SHELL=bash\n    export CONFIG_SHELL\n    if $CONFIG_SHELL -c \"exit 0\"\n    then\n        exec $CONFIG_SHELL $0 \"$@\"\n[...]\n```\nintroduced by e03f296685f986f89e1e12974f4c5ead9a9ff440.\n\nI guess the idea is to re-run configure ($0) with the same arguments ($`@`) but using bash. However, by the time we reach the line `exec $CONFIG_SHELL $0 \"$`@`\"`, the positional parameters have been obliterated by previous tests. Indeed, in the example above it happens to run `bash ./configure x make` which produces the error.\n\nWhen using debian's dash, it turns out that before reaching this code configure decides to rerun itself and for that reason it sets `CONFIG_SHELL=/bin/sh` (to avoid a recursion).\n\nHence, the test above is wrong (IMO it should //only// test `$BASH_VERSION`).",
    "created_at": "2017-07-18T00:19:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324334",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324335",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324336",
...
```json
{
    "body": "The first patch makes `configure` work with new versions of dash, but it breaks with old versions of dash (unpatched 0.5.6, and also version `0.5.7-4+b1` from debian jessie.\n\nThis happens because `test -z \"$BASH_VERSION$CONFIG_SHELL\"` is incorrect, it should instead be `test -z \"$BASH_VERSION\"`, which is what the second patch does.",
    "created_at": "2017-07-18T02:38:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324337",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324338",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324339",
...
```json
{
    "body": "I'm a bit lost here. I think I understood the problem, and I understand what your patch does. However, I don't see how that actually fixes the problem.",
    "created_at": "2017-07-18T11:46:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324340",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "General side comment: when fixing a bug, three things have to be asked:\n\n(1) what is the problem?\n\n(2) what does the patch do?\n\n(3) how does (2) actually fix (1)?\n\nIn this case, I am missing (3).",
    "created_at": "2017-07-18T11:48:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324341",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324345",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324346",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324347",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Wouldn't it make sense to move the block\n\n```\nif test -z \"$BASH_VERSION\"\n```\neven higher in the file, as early as possible?",
    "created_at": "2017-07-19T07:41:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324348",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324350",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324351",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324352",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Final list of commits for this ticket, on branch [u/tornaria/23448-v3](https://git.sagemath.org/sage.git/log/?h=u/tornaria/23448-v3):",
    "created_at": "2017-07-19T22:56:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324354",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324355",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324356",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324357",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324358",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324359",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23211#event-60225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324360",
...
```json
{
    "body": "Would it be acceptable to simply add to `./bootstrap` the `sed` editing of the generated `./configure` to replace all the occurence of `/bin/sh` with the output of `command -v bash` ?",
    "created_at": "2018-01-07T12:00:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324362",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324364",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324365",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "OK, sorry for noise. It looks good.",
    "created_at": "2018-01-07T15:05:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324366",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324367",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    "body": "I never said that I agreed with the current branch.",
    "created_at": "2018-01-07T15:43:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324368",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324369",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/23211#issuecomment-324370",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/23211",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/23211#event-60226"
}
```
