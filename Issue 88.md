...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/88#issuecomment-431",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/88",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/88#issuecomment-432",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/88",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/88#issuecomment-433",
...
```json
{
    "body": "Changing assignee from dmharvey to somebody.",
...
```json
{
    "body": "Is this still a valid ticket? Certainly the tex is outdated. Also, this should be done over at the Cython project, shouldn't it?",
...
```json
{
    "body": "Yeah, I think since the Cython project now exists, this ticket should probably be marked invalid.",
    "created_at": "2008-02-27T00:23:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/88",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/88#issuecomment-436",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    "body": "So lets do it ... one ticket less to worry about :-)",
    "created_at": "2008-02-27T11:08:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/88",
    "type": "issue_comment",
