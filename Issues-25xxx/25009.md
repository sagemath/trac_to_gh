...
```json
{
    "body": "<div id=\"comment:60\" align=\"right\">comment:60</div>\n\nReplying to [@dimpase](#comment:59):\n> using cmake in an spkg-configure.m4\n\nThis was what I was referring to in [comment:55](#comment:55). If there's no system cmake but finding a library has to depend on that library's installed cmake information, then the `spkg-configure.m4` should just fail.",
