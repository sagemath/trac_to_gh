...
```json
{
    "body": "This distinction is important if you are doing anything where you have to take residues (which I have done in my research). So -1 from me on having `sp == sp3` being `True`.",
