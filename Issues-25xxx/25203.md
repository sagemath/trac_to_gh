...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[e72581d](https://git.sagemath.org/sage.git/commit?id=e72581d02bbaf1156fed561cbb76becd08ab7164)|`Re-implement multiplicative_generator() and zeta()`|",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[7701a1e](https://git.sagemath.org/sage.git/commit/?id=7701a1ee63de664ffe147668c407941e8b243180)|`Re-implement multiplicative_generator() and zeta()`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[35b8fc4](https://git.sagemath.org/sage.git/commit/?id=35b8fc4c46d98df61a93daa88866e9885c921ada)|`zeta() has no compatibility guarantees`|",
    "created_at": "2018-05-01T17:38:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25203",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|\n|[861ae14](https://git.sagemath.org/sage.git/commit/?id=861ae1453b54faf5c8f78b213b9fbc91a9c9f6f2)|`Better doctest`|",
    "created_at": "2018-05-02T07:43:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25203",
    "type": "issue_comment",
