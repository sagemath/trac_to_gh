...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[c46cc6d](https://git.sagemath.org/sage.git/commit/?id=c46cc6db916acf9cd73f8315e10366b78867f55b)|`newline at beginning of docstrings.  _Partitions instead of Partition.`|\n|[bbdd795](https://git.sagemath.org/sage.git/commit/?id=bbdd795dea9e3fd5d06b3111a6294de742745396)|`make first param of every method 'self' and update docstrings accordingly`|",
    "created_at": "2018-09-18T03:31:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25931",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[03e3ed5](https://git.sagemath.org/sage.git/commit/?id=03e3ed5f58753d0d3bf4c8cb0392a9fbc51d1886)|`change error messages from sentences to fragments`|",
    "created_at": "2018-09-18T16:37:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25931",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[a33d73e](https://git.sagemath.org/sage.git/commit/?id=a33d73e4161363396ace95edd9154f3ca2148069)|`remove _is_sequence, is_*_decreasing, k dim list functions`|\n|[1911569](https://git.sagemath.org/sage.git/commit/?id=1911569b2d50c2e5d0d6ffab1c3433ada5f036ae)|`inline k rect dim list function, remove newlines`|",
    "created_at": "2018-09-20T21:29:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25931",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[f3dc7bb](https://git.sagemath.org/sage.git/commit/?id=f3dc7bb9c1efb3eb56e66153cc34a0b28571d204)|`resolve conflict in the references index.rst file`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[ef5701c](https://git.sagemath.org/sage.git/commit/?id=ef5701c03b3499cac7310f135917c7deddbb45c3)|`eliminate 2 images, keep 1 image, fix indentation in docstring`|",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[6fb0814](https://git.sagemath.org/sage.git/commit/?id=6fb0814e5f054045eac9aef059ccceb8332c9f5d)|`remove redundant NOTE in docstring`|\n|[9e30751](https://git.sagemath.org/sage.git/commit/?id=9e3075121266f826c5382409d4f7e13b3c58e486)|`remove citations that haven't been used yet`|\n|[66cadcb](https://git.sagemath.org/sage.git/commit/?id=66cadcb1a5b876cb91b52357198dfe9ddb0c1e97)|`fix TEST block formatting.  attempt to make boundary explanation more clear.`|\n|[4ebb523](https://git.sagemath.org/sage.git/commit/?id=4ebb523d776f02978f7be7aa36e0aa8435e6d66f)|`address review (a) through (l)`|\n|[5e8f38d](https://git.sagemath.org/sage.git/commit/?id=5e8f38d732c3beee3b30fe855337f4d013546853)|`address review items (m) through (o)`|",
...
```json
{
    "body": "<a id='comment:33'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[0a9dedf](https://git.sagemath.org/sage.git/commit/?id=0a9dedfb6a1db27c41a843da981e9cda9e50fff9)|`fix comments on to_k_core`|\n|[cd14216](https://git.sagemath.org/sage.git/commit/?id=cd1421640a104afa8240f159478c05c956486b67)|`remove to_k_core, as it is NOT a generalization of the canonical bijection`|\n|[5078c75](https://git.sagemath.org/sage.git/commit/?id=5078c75ff4683121e4b637baf87c30f7ec1647fe)|`restrict docstrings to 80 char width`|",
    "created_at": "2019-01-05T21:19:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25931",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[46fa747](https://git.sagemath.org/sage.git/commit/?id=46fa747e5209a48b9d32bbb7a0f3e65d42a745a7)|`Fixed minor documentation issues in combinat.partition.`|",
