...
```json
{
    ...
    "created_at": "2018-06-18T16:32:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490579",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490580",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Nasser, do you happen to have a simple integration result containing a `rootOf`? This would be really helpful for testing purposes!",
    "created_at": "2018-06-18T19:49:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490581",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:3'></a>Nasser, do you happen to have a simple integration result containing a `rootOf`? This would be really helpful for testing purposes!
...
```json
{
    "body": "<a id='comment:4'></a>I searched my tests files, and do not see a \"simple\" result. Each of these integrals below generate rootOf when running them in Fricas. But they all produce large results I am afraid. But these should be useful to test your conversion with.\n\n\n```\nintegrate(1/(-1/x^(1/3)+x^(1/2)),x)\nintegrate(x^(1/2)/(-1/x^(1/3)+x^(1/2)),x)\nintegrate((x+(1+x)^(1/2))^(1/2)/(x^2+1)/(1+x)^(1/2),x)\nintegrate((x+(1+x)^(1/2))^(1/2)/(x^2+1),x)\nintegrate(1/(a^5+x^5),x)\nintegrate(x^2/(a^5+x^5),x)\nintegrate(x^3/(a^5+x^5),x)\nintegrate(1/x^2/(a^5+x^5),x)\nintegrate(1/x^3/(a^5+x^5),x)\nintegrate(1/x^4/(a^5+x^5),x)\nintegrate(x^6/(2*x^5+3)^3,x)\nintegrate(tan(x)/(-1+tan(x)^(1/2))^2,x)\n```",
    "created_at": "2018-06-18T21:10:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490582",
    "user": "https://github.com/nasser1"
}
```

<a id='comment:4'></a>I searched my tests files, and do not see a "simple" result. Each of these integrals below generate rootOf when running them in Fricas. But they all produce large results I am afraid. But these should be useful to test your conversion with.
...
```json
{
    "body": "<a id='comment:5'></a>This was very helpful! I've now got something if no variables are involved, however, I am not sure how helpful it is.  For example:\n\n```\nsage: f = 1/(1+x^5)\nsage: F = fricas.integrate(f, x).sage(); F\n(0.06180339887498948? + 0.1902113032590308?*I)*log(2*x + 0.618033988749895? + 1.902113032590308?*I) + (0.06180339887498948? - 0.1902113032590308?*I)*log(2*x + 0.618033988749895? - 1.902113032590308?*I) + 1/5*log(x + 1) - (0.1618033988749895? - 0.11755705045849462?*I)*log(x - 0.8090169943749474? + 0.5877852522924731?*I) - (0.1618033988749895? + 0.11755705045849462?*I)*log(x - 0.8090169943749474? - 0.5877852522924731?*I)\n```\n(I checked the solution, it is correct.)",
    "created_at": "2018-06-18T22:23:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490583",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:5'></a>This was very helpful! I've now got something if no variables are involved, however, I am not sure how helpful it is.  For example:
...
```json
{
    "body": "Changing branch from \"\" to \"u/mantepse/implement_translation_of_fricas_rootof\"",
    "created_at": "2018-06-18T22:43:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490586",
    "user": "https://github.com/mantepse"
}
```

Changing branch from "" to "u/mantepse/implement_translation_of_fricas_rootof"
...
```json
{
    "body": "Changing commit from \"\" to \"84c392e413ef4515ab4e4d3e5e17d6e54c930ef2\"",
    "created_at": "2018-06-18T22:48:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490587",
    "user": "https://github.com/mantepse"
}
```

Changing commit from "" to "84c392e413ef4515ab4e4d3e5e17d6e54c930ef2"
...
```json
{
    "body": "Changing commit from \"84c392e413ef4515ab4e4d3e5e17d6e54c930ef2\" to \"a983d7a55150a8fd566dbb7f4097e001721500d5\"",
    "created_at": "2018-06-19T06:49:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490589",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "84c392e413ef4515ab4e4d3e5e17d6e54c930ef2" to "a983d7a55150a8fd566dbb7f4097e001721500d5"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490590",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490591",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490592",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"a983d7a55150a8fd566dbb7f4097e001721500d5\" to \"becb3681d2f24a47e68902a69c712b172bb96294\"",
    "created_at": "2018-06-19T13:19:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490593",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "a983d7a55150a8fd566dbb7f4097e001721500d5" to "becb3681d2f24a47e68902a69c712b172bb96294"
...
```json
{
    "body": "<a id='comment:14'></a>`@`gh-nasser1: dear Nasser, could you please check whether this works for you now? (it was actually a fair bit of work, so I'd rather get back to it now than later)\n\nPlease test especially integrals with parameters (that is, extra variables) showing up in the `rootOf` expressions.",
    "created_at": "2018-06-20T12:52:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490594",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:14'></a>`@`gh-nasser1: dear Nasser, could you please check whether this works for you now? (it was actually a fair bit of work, so I'd rather get back to it now than later)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490595",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490598",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>No problem, Nasser!",
    "created_at": "2018-06-25T19:24:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490599",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:19'></a>No problem, Nasser!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490600",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Hello; fyi, I tried these in new build and installed sagemath 8.3 beta 8, \n\n\n```\n>sage\n\u250c\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510\n\u2502 SageMath version 8.3.beta8, Release Date: 2018-06-30               \u2502\n\u2502 Type \"notebook()\" for the browser-based notebook interface.        \u2502\n\u2502 Type \"help()\" for help.                                            \u2502\n\u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518\n\n```\n\n\nUsing AUR package manager of Linux Manjaro.\n\nThey still generate \"not yet implemented\" for rootOf.\n\nI will check again when a new version of sagemath is released.\n\nThank you",
    "created_at": "2018-07-07T02:28:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490601",
    "user": "https://github.com/nasser1"
}
```

<a id='comment:21'></a>Hello; fyi, I tried these in new build and installed sagemath 8.3 beta 8, 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490603",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490604",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490605",
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25602#event-64136"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>this fixes pyflake errors\n\n---\nNew commits:",
    "created_at": "2018-08-04T09:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490606",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:27'></a>this fixes pyflake errors
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490607",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing branch from \"u/mantepse/implement_translation_of_fricas_rootof\" to \"public/fricas/rootof\"",
    "created_at": "2018-08-04T09:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490608",
    "user": "https://github.com/dimpase"
}
```

Changing branch from "u/mantepse/implement_translation_of_fricas_rootof" to "public/fricas/rootof"
...
```json
{
    "body": "Changing commit from \"becb3681d2f24a47e68902a69c712b172bb96294\" to \"4539a940848397eb8113f0e889db231e0dac91dc\"",
    "created_at": "2018-08-04T09:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490609",
    "user": "https://github.com/dimpase"
}
```

Changing commit from "becb3681d2f24a47e68902a69c712b172bb96294" to "4539a940848397eb8113f0e889db231e0dac91dc"
...
```json
{
    "body": "<a id='comment:28'></a>if this works for you, please set it to positive review",
    "created_at": "2018-08-04T09:06:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490610",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:28'></a>if this works for you, please set it to positive review
...
```json
{
    "body": "<a id='comment:29'></a>Great! Yes, I rebuilt and all test still pass.  (My intention was to fix the pyflakes stuff in a separate ticket, but I am very happy if they are already fixed now.)\n\nNot sure whether \"you\" is me or Eric, so I am not taking action...",
    "created_at": "2018-08-04T17:21:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490611",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:29'></a>Great! Yes, I rebuilt and all test still pass.  (My intention was to fix the pyflakes stuff in a separate ticket, but I am very happy if they are already fixed now.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490612",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490613",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Thanks to both of you!",
    "created_at": "2018-08-04T17:45:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490614",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:30'></a>Thanks to both of you!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25602#event-64137"
}
```
...
```json
{
    "body": "Changing branch from \"public/fricas/rootof\" to \"4539a940848397eb8113f0e889db231e0dac91dc\"",
    "created_at": "2018-08-06T15:13:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490615",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/fricas/rootof" to "4539a940848397eb8113f0e889db231e0dac91dc"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490616",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"4539a940848397eb8113f0e889db231e0dac91dc\" to \"\"",
    "created_at": "2018-08-19T12:00:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490618",
    "user": "https://github.com/nasser1"
}
```

Changing commit from "4539a940848397eb8113f0e889db231e0dac91dc" to ""
...
```json
{
    "body": "<a id='comment:33'></a>I cannot reproduce this, but it looks like being a problem with maxima...",
    "created_at": "2018-08-19T19:13:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490619",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:33'></a>I cannot reproduce this, but it looks like being a problem with maxima...
...
```json
{
    "body": "<a id='comment:35'></a>Fricas and Maxima have  in Sage ECL, as a common dependency. It seems that here for some reason ECLs used for them are different, but this doesn't quite work.",
    "created_at": "2018-08-20T06:28:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490621",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:35'></a>Fricas and Maxima have  in Sage ECL, as a common dependency. It seems that here for some reason ECLs used for them are different, but this doesn't quite work.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490622",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>To find the implementation used with FriCAS, I think (but I'm not sure) you could do:\n\n```\nsage: fricas.eval(\")lisp (lisp-implementation-version)\")\nsage: fricas.eval(\")lisp (lisp-implementation-type)\")\n```",
    "created_at": "2018-08-20T13:00:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490625",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:39'></a>To find the implementation used with FriCAS, I think (but I'm not sure) you could do:
...
```json
{
    "body": "<a id='comment:41'></a>I'm cc'ng Arch maintainer - is there something fishy with fricas support withe current Arch package?",
    "created_at": "2018-08-20T13:09:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490627",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:41'></a>I'm cc'ng Arch maintainer - is there something fishy with fricas support withe current Arch package?
...
```json
{
    "body": "<a id='comment:42'></a>If you install fricas separately, sagemath will use the global version - which should be good, because sbcl is much faster than ecl.\n\nHowever, this shouldn't interfere at all with maxima.\n\nOne way to debug this is to try to solve the polynomial equation explicitely with maxima.  But that's not so easy, because it contains many `rootOf` operators...",
    "created_at": "2018-08-20T13:18:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25602#issuecomment-490628",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:42'></a>If you install fricas separately, sagemath will use the global version - which should be good, because sbcl is much faster than ecl.
