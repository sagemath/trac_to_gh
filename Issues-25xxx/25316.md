...
Replying to [@timokau](https://github.com/sagemath/sage/issues/25316#comment:0):
> We can instead monkey-patch `build_extensions` to always remove the `-Wstrict-prototypes` argument.
