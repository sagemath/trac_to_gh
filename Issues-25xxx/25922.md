...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25922#issuecomment-385797",
...
```json
{
    "body": "<a id='comment:2'></a>oops. I missed the fact this was already opened as a ticket. I pushed the fix to #25939. The issue is in canonical height, not in is_postcritically_finite.\n\nIf you agree that 25939, fixes the issue in is_postcritically_finite, then mark this as positive-review so that it gets closed as 'duplicate'. If there are still further issues with is_pcf, then we can revisit this ticket for those fixes.",
    "created_at": "2018-07-26T17:17:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25922#issuecomment-385798",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:2'></a>oops. I missed the fact this was already opened as a ticket. I pushed the fix to #25939. The issue is in canonical height, not in is_postcritically_finite.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25922#event-64816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25922#issuecomment-385799",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25922#issuecomment-385800",
    "user": "https://trac.sagemath.org/admin/accounts/users/bellatobin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25922",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25922#event-64817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25922#issuecomment-385801",
