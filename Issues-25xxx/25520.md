...
```json
{
    "body": "<a id='comment:1'></a>This is not really something we can do anything about, I expect. It's just a consequence of\n\n```\nsage: (0^x).simplify()\n0\n```\nwhich is wrong for `x=0`.",
    "created_at": "2018-06-06T20:50:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25520#issuecomment-488634",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:1'></a>This is not really something we can do anything about, I expect. It's just a consequence of
