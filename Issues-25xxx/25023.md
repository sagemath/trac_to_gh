...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25023",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25023#issuecomment-383903",
    "user": "https://github.com/annahaensch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25023",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25023#issuecomment-383904",
    "user": "https://github.com/annahaensch"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25023#event-328031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25023#event-328032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25023#event-328033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25023",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25023#event-328034"
}
```
