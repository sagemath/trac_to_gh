...
archive/attachments_021790.json:
```json
{
...
```json
{
    "body": "**Attachment:** [pickle.sage](https://github.com/sagemath/sage/files/ticket25499/pickle.sage)\n\na hacky script to produce the problematic pickle graph",
    "created_at": "2018-06-03T00:06:52Z",
    "issue": "https://github.com/sagemath/sage/issues/25499",
    "type": "issue_comment",
...
**Attachment:** [pickle.sage](https://github.com/sagemath/sage/files/ticket25499/pickle.sage)
...
archive/attachments_021791.json:
```json
{
    "asset_content_type": "application/octet-stream",
