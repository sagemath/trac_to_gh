...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495020",
...
```json
{
    "body": "<a id='comment:2'></a>Here is another bug in GIAC/XCAS, may be it should be added to above? since it is also in integrate? I did not know if I should open a new one or not, since it is same system. Here it is. This is a bug in giac used by sagemath. It returns \"done\" as result of integrate.\n\n```\nsage: version()\n'SageMath version 8.3.rc0, Release Date: 2018-07-08'\nsage: var('x g b f n c a d');\nsage: integrate(1/((g*x + f)^2*(b*log((e*x + d)^n*c) + a)^3),x, algorithm=\"giac\")\nDone\nsage: \n```",
    "created_at": "2018-07-11T23:23:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495021",
    "user": "https://github.com/nasser1"
}
```

<a id='comment:2'></a>Here is another bug in GIAC/XCAS, may be it should be added to above? since it is also in integrate? I did not know if I should open a new one or not, since it is same system. Here it is. This is a bug in giac used by sagemath. It returns "done" as result of integrate.
...
```json
{
    "body": "<a id='comment:5'></a>The maximal size of objects that will be printed should be controllable with the environment variable GIAC_TAILLEMAX (default 1000). Size is not the length of the printed string, but the size of the giac::gen as defined in symbolic.h:  unsigned taille(const gen & g,unsigned max);",
    "created_at": "2018-07-12T08:11:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495024",
    "user": "https://trac.sagemath.org/admin/accounts/users/parisse"
}
```

<a id='comment:5'></a>The maximal size of objects that will be printed should be controllable with the environment variable GIAC_TAILLEMAX (default 1000). Size is not the length of the printed string, but the size of the giac::gen as defined in symbolic.h:  unsigned taille(const gen & g,unsigned max);
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495025",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495026",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495027",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>But sage's pxepect interface is calling icas/giac so it is different than working with the library as does giacpy or the javascript interface. Adding string before evaluation will break manythings such as mulple commands, and after evaluation we will get the Done from icas.\n\nSo I think that the easiest thing is to change this in icas.cc, moreover there is already an \"insage\" booleen flag. I have test successfully the following patch.\n\nBernard, do you plan to remove the \"Done\" output in icas.cc when the insage flag is on so that next giac version will solve this without patch?\n\n```\n--- a/src/icas.cc\t2017-10-02 10:25:46.000000000 +0200\n+++ b/src/icas.cc\t2018-07-14 10:50:01.650323754 +0200\n@@ -1581,7 +1581,7 @@\n \tint taillemax=1000;\n \tif (getenv(\"GIAC_TAILLEMAX\"))\n \t  taillemax=atoi(getenv(\"GIAC_TAILLEMAX\"));\n-\tstring s=taille(ge,taillemax)>taillemax?\"Done\":ge.print(contextptr);\n+\tstring s=((taille(ge,taillemax)>taillemax)&&(!insage))?\"Done\":ge.print(contextptr);\n \tcout << s;\n       }\n       cout << endl;\n```",
    "created_at": "2018-07-14T12:52:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495029",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

<a id='comment:8'></a>But sage's pxepect interface is calling icas/giac so it is different than working with the library as does giacpy or the javascript interface. Adding string before evaluation will break manythings such as mulple commands, and after evaluation we will get the Done from icas.
...
```json
{
    "body": "<a id='comment:9'></a>Yes, I made the change in my source (with !insage first).",
    "created_at": "2018-07-14T13:06:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495030",
    "user": "https://trac.sagemath.org/admin/accounts/users/parisse"
}
```

<a id='comment:9'></a>Yes, I made the change in my source (with !insage first).
...
```json
{
    "body": "<a id='comment:10'></a>Thank you, so in sage the next giac update should solve these problems automatically.",
    "created_at": "2018-07-14T19:22:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495031",
    "user": "https://github.com/frederichan-IMJPRG"
}
```

<a id='comment:10'></a>Thank you, so in sage the next giac update should solve these problems automatically.
...
```json
{
    "body": "<a id='comment:11'></a>fyi, this is similar giac crash. I tried to report it to giac, but could not get an account on giac tracking. I submitted request to join and never heard back. So posting it here. May be someone who knows how to report them to giac bugs database would be able to do this since I can't.\n\n\n```\nsage: version()\n'SageMath version 8.3.rc0, Release Date: 2018-07-08\n\nsage: var('d x c b a f e')\n(d, x, c, b, a, f, e)\nsage: integrate(sin((d*x + c)^(2/3)*b + a)/(f*x + e),x, algorithm=\"giac\")\nGiac crashed -- automatically restarting.\nsage0*x\n\n\nsage: integrate(sin((d*x + c)^(2/3)*b + a)/(f*x + e)^2,x,algorithm=\"giac\")\nGiac crashed -- automatically restarting.\nsage4*x\n\nsage:  integrate(sin(a + b/(d*x + c)^(2/3))/(f*x + e),x, algorithm=\"giac\")\nGiac crashed -- automatically restarting.\nsage8*x\n\nsage: integrate(sin(a + b/(d*x + c)^(2/3))/(f*x + e)^2,x, algorithm=\"giac\")\nGiac crashed -- automatically restarting.\nsage12*x\n\n\n```",
    "created_at": "2018-07-17T18:20:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495032",
    "user": "https://github.com/nasser1"
}
```

<a id='comment:11'></a>fyi, this is similar giac crash. I tried to report it to giac, but could not get an account on giac tracking. I submitted request to join and never heard back. So posting it here. May be someone who knows how to report them to giac bugs database would be able to do this since I can't.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495035",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64562"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495037",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64563"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64564"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Yes, as `integrate(G1, x)` gives nonsense, this is yet another maxima bug. No problems with `giac` here, anyway, closing.",
    "created_at": "2019-01-16T11:43:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495038",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:16'></a>Yes, as `integrate(G1, x)` gives nonsense, this is yet another maxima bug. No problems with `giac` here, anyway, closing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495039",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Replying to [mantepse](#comment%3A17):\n> Replying to [dimpase](#comment%3A16):\n> > Yes, as `integrate(G1, x)` gives nonsense, this is yet another maxima bug. No problems with `giac` here, anyway, closing.\n\n> \n> No, the result is correct, it is just not very helpful:\n> \n> ```\n> sage: (diff(integrate(G1, x), x) - G1).simplify_full()\n> 0\n> ```\n\n\nthe result of the computation without fixing parameters seems to be incorrect, that's what I was trying to say.",
    "created_at": "2019-01-16T12:51:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495040",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:18'></a>Replying to [mantepse](#comment%3A17):
> Replying to [dimpase](#comment%3A16):
> > Yes, as `integrate(G1, x)` gives nonsense, this is yet another maxima bug. No problems with `giac` here, anyway, closing.
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64565"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495041",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>This is not fixed in 8.6, i still get the errors. This ticket should depend on #26315 and requires a dedicated doctest.",
    "created_at": "2019-01-16T19:05:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495042",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```

<a id='comment:19'></a>This is not fixed in 8.6, i still get the errors. This ticket should depend on #26315 and requires a dedicated doctest.
...
```json
{
    "body": "<a id='comment:20'></a>Please add all the doctests you see fit on the branch of #26315 - I just don't see why we should test giac more than it tests itself...",
    "created_at": "2019-01-16T19:34:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495043",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:20'></a>Please add all the doctests you see fit on the branch of #26315 - I just don't see why we should test giac more than it tests itself...
...
```json
{
    "body": "Changing dependencies from \"\" to \"#26315\"",
    "created_at": "2019-01-16T19:35:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495044",
    "user": "https://github.com/dimpase"
}
```

Changing dependencies from "" to "#26315"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495045",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64567"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64568"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>no work should be done on this ticket, hence positive review.",
    "created_at": "2019-01-16T19:35:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495046",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:21'></a>no work should be done on this ticket, hence positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25822#event-64569"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Presuming these are all correctly reviewed as either duplicate, invalid, or wontfix.",
    "created_at": "2019-02-26T13:58:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495047",
    "user": "https://github.com/embray"
}
```

<a id='comment:22'></a>Presuming these are all correctly reviewed as either duplicate, invalid, or wontfix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25822#issuecomment-495048",
    "user": "https://github.com/embray"
}
```
