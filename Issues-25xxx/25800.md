...
```json
{
    ...
    "type": "issue",
    "updated_at": "2018-07-18T16:59:50Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25800#event-311116"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25800#event-311117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25800#event-311118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25800#issuecomment-398976",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25800#issuecomment-398977",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25800#event-311119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25800#issuecomment-398978",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25800",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25800#issuecomment-398979",
    "user": "https://github.com/jm58660"
}
```
