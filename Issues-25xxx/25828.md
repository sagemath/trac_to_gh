...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[4392be3](https://git.sagemath.org/sage.git/commit/?id=4392be34cd78d95e7fdd7999400328639eb2600d)|`./setup.py build_cython --require-features=sage.features.bliss.BlissLibrary`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[0575b96](https://git.sagemath.org/sage.git/commit/?id=0575b96f0717dc4daaeb0dff1d1af942b2e0d960)|`WIP: Disable bliss Feature test`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|\n|[ac45c74](https://git.sagemath.org/sage.git/commit/?id=ac45c746de433f1af695af9af2047f114df55b7e)|`CythonFeature._is_present: Use version of tmp_filename without dependence on SAGE_TMP`|\n|[8ca2e68](https://git.sagemath.org/sage.git/commit/?id=8ca2e68432048715e2df61b2442a3bba1c582d98)|`src/sage/misc/misc.py: Move import of sage.misc.prandom to functions that need it`|\n|[1cee8f1](https://git.sagemath.org/sage.git/commit/?id=1cee8f1cecf6e3ab597c15d4a93590117bd57b50)|`sage.misc.cython.cython: New options capture_stderr=True, target_dir=None`|\n|[8b85b4d](https://git.sagemath.org/sage.git/commit/?id=8b85b4d47b3cd15cbfb901546871871e0b01672a)|`sage.misc.cython: Move global imports into the functions where they are used`|\n|[4a85117](https://git.sagemath.org/sage.git/commit/?id=4a85117737ca7c8a24d0a3e968345a44bfdd9561)|`sage.features.CythonFeature._is_present: Use tempfile.mkdtemp for cython test file and build`|\n|[fdd4ab7](https://git.sagemath.org/sage.git/commit/?id=fdd4ab7595c0cb1fa06bcbaa658fa2b0b0ffaca3)|`sage.features.CythonFeature._is_present: Improve error reporting in FeatureTestResult`|\n|[4af7b45](https://git.sagemath.org/sage.git/commit/?id=4af7b45c8933b831ae53d0a09e9afdd1c8649578)|`sage.misc.cython.cython: Replace imported sage_makedirs, restore_cwd by local copies`|",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|\n|[aa87fab](https://git.sagemath.org/sage.git/commit/?id=aa87fab54db20d73d11d3edfe7c9cd30daea1a97)|`Merge tag '9.0.beta10' into t/25828/optional-extension-features`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[d53931c](https://git.sagemath.org/sage.git/commit/?id=d53931cab457e48f1ff656343801b66a91733331)|`Replace is_package_installed(\"bliss\") by features`|\n|[2c71083](https://git.sagemath.org/sage.git/commit/?id=2c7108300d66473a2bfeedd5a3fd68a2ac9b9db8)|`./setup.py build_cython --require-features=sage.features.bliss.BlissLibrary`|",
    "created_at": "2020-01-13T02:24:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25828",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:36'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[4392be3](https://git.sagemath.org/sage.git/commit/?id=4392be34cd78d95e7fdd7999400328639eb2600d)|`./setup.py build_cython --require-features=sage.features.bliss.BlissLibrary`|\n|[ac45c74](https://git.sagemath.org/sage.git/commit/?id=ac45c746de433f1af695af9af2047f114df55b7e)|`CythonFeature._is_present: Use version of tmp_filename without dependence on SAGE_TMP`|\n|[8ca2e68](https://git.sagemath.org/sage.git/commit/?id=8ca2e68432048715e2df61b2442a3bba1c582d98)|`src/sage/misc/misc.py: Move import of sage.misc.prandom to functions that need it`|\n|[1cee8f1](https://git.sagemath.org/sage.git/commit/?id=1cee8f1cecf6e3ab597c15d4a93590117bd57b50)|`sage.misc.cython.cython: New options capture_stderr=True, target_dir=None`|\n|[8b85b4d](https://git.sagemath.org/sage.git/commit/?id=8b85b4d47b3cd15cbfb901546871871e0b01672a)|`sage.misc.cython: Move global imports into the functions where they are used`|\n|[4a85117](https://git.sagemath.org/sage.git/commit/?id=4a85117737ca7c8a24d0a3e968345a44bfdd9561)|`sage.features.CythonFeature._is_present: Use tempfile.mkdtemp for cython test file and build`|\n|[fdd4ab7](https://git.sagemath.org/sage.git/commit/?id=fdd4ab7595c0cb1fa06bcbaa658fa2b0b0ffaca3)|`sage.features.CythonFeature._is_present: Improve error reporting in FeatureTestResult`|\n|[4af7b45](https://git.sagemath.org/sage.git/commit/?id=4af7b45c8933b831ae53d0a09e9afdd1c8649578)|`sage.misc.cython.cython: Replace imported sage_makedirs, restore_cwd by local copies`|\n|[aa87fab](https://git.sagemath.org/sage.git/commit/?id=aa87fab54db20d73d11d3edfe7c9cd30daea1a97)|`Merge tag '9.0.beta10' into t/25828/optional-extension-features`|\n|[ef1219e](https://git.sagemath.org/sage.git/commit/?id=ef1219e1493d418ae33bfb93d836b7eda91f8c9e)|`Merge tag '9.1.beta0' into HEAD`|",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[b5e205f](https://git.sagemath.org/sage.git/commit/?id=b5e205f8abccc2dd933bad59045c9ab174b6c3d7)|`WIP: Add progress output`|",
    "created_at": "2020-04-14T01:47:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25828",
    "type": "issue_comment",
