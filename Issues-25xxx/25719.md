...
```json
{
    "body": "<a id='comment:1'></a>So the GAP error message might be a bit of a red herring. It seems like the issue might come from the fact that `R` cannot be read by GAP:\n\n```\nsage: gap(R)\n---------------------------------------------------------------------------\nTypeError                                 Traceback (most recent call last)\n\n[same as in the ticket description]\n\nTypeError: Gap terminated unexpectedly while reading in a large line:\nGap produced error output\nError, Variable: 'Univariate' must have a value\nSyntax error: ; expected in /home/travis/.sage/temp/apricot/10948/interface/tm\\\np10995 line 1\n\\$sage4:=Univariate Quotient Polynomial Ring in xbar over Finite Field of size\\\n 2 with modulus x^4 + x + 1;;\n                           ^\n\n   executing Read(\"/home/travis/.sage/temp/apricot/10948/interface/tmp10995\");\n```\nContrast this with\n\n```\nsage: gap(R.ambient())\nPolynomialRing( GF(2), [\"x\"] )\n```",
    "created_at": "2018-07-01T07:28:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25719#issuecomment-359123",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>So the GAP error message might be a bit of a red herring. It seems like the issue might come from the fact that `R` cannot be read by GAP:
...
```json
{
    "body": "<a id='comment:2'></a>Removing from closed milestone.",
    "created_at": "2019-04-16T15:19:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25719#issuecomment-359124",
    "user": "https://github.com/embray"
}
```

<a id='comment:2'></a>Removing from closed milestone.
