...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488236",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Notice that it still lacks properly formatted comments, so it's still not ready for review\n\n---\nNew commits:",
    "created_at": "2018-06-04T15:16:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488237",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```

<a id='comment:2'></a>Notice that it still lacks properly formatted comments, so it's still not ready for review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488238",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488239",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488243",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488244",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488245",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Could you explain what's the goal of this method and what it does. You will have to add a description of the method anyway. Also, shouldn't original edge labels be added somewhere ?",
    "created_at": "2018-06-05T07:35:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488246",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:9'></a>Could you explain what's the goal of this method and what it does. You will have to add a description of the method anyway. Also, shouldn't original edge labels be added somewhere ?
...
```json
{
    "body": "<a id='comment:11'></a>As far as I understand, it's more or less the code written by stumpc5 - although for bliss rather than for nauty, and the idea is to make it more general, so that it can be used for nauty as well as for bliss as \"backends\" to compute automorphisms etc.",
    "created_at": "2018-06-05T08:35:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488248",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:11'></a>As far as I understand, it's more or less the code written by stumpc5 - although for bliss rather than for nauty, and the idea is to make it more general, so that it can be used for nauty as well as for bliss as "backends" to compute automorphisms etc.
...
```json
{
    "body": "<a id='comment:12'></a>Right, but with bliss we are at Cython/C level so it might be faster. We'll see if the performances are OK.",
    "created_at": "2018-06-05T15:25:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488249",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:12'></a>Right, but with bliss we are at Cython/C level so it might be faster. We'll see if the performances are OK.
...
```json
{
    "body": "<a id='comment:13'></a>I don't really know how pynauty, the interface used, works (Dario, the ticket's author, knows better). My limited understanding that it's also an interface on the level of C, thus it should be fast.",
    "created_at": "2018-06-05T15:44:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488250",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:13'></a>I don't really know how pynauty, the interface used, works (Dario, the ticket's author, knows better). My limited understanding that it's also an interface on the level of C, thus it should be fast.
...
```json
{
    "body": "<a id='comment:14'></a>Actually, while the conversion to a nauty graph and the computation is in c, the relabeling and eventual conversion of the multigraph are done in python. I could easily move the relabeling to C++, the multigraph part would be a little more difficult, but still doable. I don't know if this would be that much of an improvement in performance though, that's why I didn't do it in the first place.",
    "created_at": "2018-06-05T16:47:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488251",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```

<a id='comment:14'></a>Actually, while the conversion to a nauty graph and the computation is in c, the relabeling and eventual conversion of the multigraph are done in python. I could easily move the relabeling to C++, the multigraph part would be a little more difficult, but still doable. I don't know if this would be that much of an improvement in performance though, that's why I didn't do it in the first place.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488252",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488253",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488255",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488256",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>the tarball will be mirrored once the ticket id merged.",
    "created_at": "2018-06-12T22:59:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488258",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:19'></a>the tarball will be mirrored once the ticket id merged.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488259",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Replying to [Vaush](#comment%3A20):\n\nWhy do you need this dependence? This is potentially misleading, and won't get this ticket in before #25391. This is certainly not what we want.",
    "created_at": "2018-06-20T10:32:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488260",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:21'></a>Replying to [Vaush](#comment%3A20):
...
```json
{
    "body": "<a id='comment:22'></a>I see, I added it because on my system I needed #25391 to compile sage, so the branch is initially merged with the one from that ticket.\\\\\nSince the branches are merged, and since I can't have them not merged because otherwise sage won't compile at all for me, I thought I had to list it as a dependency. Is there another way to go about it?",
    "created_at": "2018-06-20T12:07:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488261",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```

<a id='comment:22'></a>I see, I added it because on my system I needed #25391 to compile sage, so the branch is initially merged with the one from that ticket.\\
Since the branches are merged, and since I can't have them not merged because otherwise sage won't compile at all for me, I thought I had to list it as a dependency. Is there another way to go about it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488263",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488264",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Ok, I just deleted the old branch, and created a new one that doesn't merge with ticket #25391.\\\\\nIf anyone has checked out the branch previously, could you please delete your copy and check it out again.",
    "created_at": "2018-06-23T00:27:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488265",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```

<a id='comment:25'></a>Ok, I just deleted the old branch, and created a new one that doesn't merge with ticket #25391.\\
If anyone has checked out the branch previously, could you please delete your copy and check it out again.
...
```json
{
    "body": "<a id='comment:26'></a>What exactly the need for that mega-patch of `build/pkgs/pynauty/patches/sage_graph.patch` ? What does \"recompile with nauty source code\" mean?",
    "created_at": "2018-08-14T07:25:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488266",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:26'></a>What exactly the need for that mega-patch of `build/pkgs/pynauty/patches/sage_graph.patch` ? What does "recompile with nauty source code" mean?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488267",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488270",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488271",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488273",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488274",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488276",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488277",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488278",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488279",
...
```json
{
    "body": "<a id='comment:37'></a>red branch => needs work",
    "created_at": "2020-09-15T16:01:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25506#issuecomment-488280",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:37'></a>red branch => needs work
