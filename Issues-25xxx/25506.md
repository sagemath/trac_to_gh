...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[5f6a20a](https://git.sagemath.org/sage.git/commit/?id=5f6a20a250595cd565acc4a7a873d2cb6b3a27bf)|`Moved function multiedge_to_singledge to the GenericGraph class, changing its name in to_singledge and making it so it doesn't convert the graph into a dictionary anymore`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[58da594](https://git.sagemath.org/sage.git/commit/?id=58da594cdb830a64edb0560018af9b94e95fa18e)|`Added documentation and doctests`|\n|[a05864f](https://git.sagemath.org/sage.git/commit/?id=a05864fe0e0d6524bdc221ac4504179d0c3b1556)|`Fixing exception test bug`|",
    "created_at": "2018-06-10T02:15:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[f5567ac](https://git.sagemath.org/sage.git/commit/?id=f5567ac53ba2ea73da9412a8a6454dd5834a2b82)|`Removed the need to modify the upstream tarball`|\n|[beb64e9](https://git.sagemath.org/sage.git/commit/?id=beb64e9dd1b9d249b73d1b1800ea2bf220e5e4b7)|`PyNauty tests should be optional`|\n|[a1c6572](https://git.sagemath.org/sage.git/commit/?id=a1c6572e0dae8d7f44204a3d3cf9e353683ba677)|`The nauty interface automorphism (and isomorphism, but it's not tested yet) now allows arbitrary edge labels AND multiple edges, even at the same time, though differing edge labels on one multi edge gives flaky results`|\n|[6648f64](https://git.sagemath.org/sage.git/commit/?id=6648f643cc232abe3377dd82e52a5e3def967c17)|`Partial changes`|\n|[6021723](https://git.sagemath.org/sage.git/commit/?id=602172366246c788e1aa88efedaddfb96e7dd8a5)|`Fixed several bugs, added doctests and modified documentation`|",
    "created_at": "2018-06-12T22:43:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|\n|[79488e5](https://git.sagemath.org/sage.git/commit/?id=79488e5bea9e147288183d7747dee430a31719f5)|`pyNauty interface with sagemath completed. TODO: actually use pynauty.isomorphic in is_isomorphic, and document everything`|\n|[dcb29f0](https://git.sagemath.org/sage.git/commit/?id=dcb29f0e812bbded19e67d48f28d44eec803a911)|`Interface integrated with the standard sage methods for automorphism groups and isomorphism checking`|\n|[f2cd759](https://git.sagemath.org/sage.git/commit/?id=f2cd7592d9aec395d081fa7eab056e205ae44254)|`Moved function multiedge_to_singledge to the GenericGraph class, changing its name in to_singledge and making it so it doesn't convert the graph into a dictionary anymore`|\n|[6d18761](https://git.sagemath.org/sage.git/commit/?id=6d187614a9af48f49de2b840e7eda05089600947)|`Added documentation and doctests`|\n|[052f668](https://git.sagemath.org/sage.git/commit/?id=052f6682469de1e78055613cc35d5d0d015f06be)|`Fixing exception test bug`|\n|[f825522](https://git.sagemath.org/sage.git/commit/?id=f825522560ef1858825b5606a1fab45517bef68c)|`Removed the need to modify the upstream tarball`|\n|[7c40f4a](https://git.sagemath.org/sage.git/commit/?id=7c40f4a69944c27d43caffffb48bd417d6b942d5)|`PyNauty tests should be optional`|\n|[56defeb](https://git.sagemath.org/sage.git/commit/?id=56defeb9f79a2e8e4b30f2301b29f4b0777277e1)|`The nauty interface automorphism (and isomorphism, but it's not tested yet) now allows arbitrary edge labels AND multiple edges, even at the same time, though differing edge labels on one multi edge gives flaky results`|\n|[76fb654](https://git.sagemath.org/sage.git/commit/?id=76fb654a04640dce90e2308acecaf7034538eab3)|`Partial changes`|\n|[bf5148b](https://git.sagemath.org/sage.git/commit/?id=bf5148b849737cb00740f17c1d3d170c7df59eb5)|`Fixed several bugs, added doctests and modified documentation`|",
    "created_at": "2018-06-23T00:24:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25506",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[472d319](https://git.sagemath.org/sage.git/commit/?id=472d31997795e06678c323f10bfb87e3db018fe1)|`Small code refactoring`|",
...
```json
{
    "body": "<a id='comment:35'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[a907f60](https://git.sagemath.org/sage.git/commit/?id=a907f609128b22ea3d0666aa6fad0a63baf408b2)|`Added log import`|",
