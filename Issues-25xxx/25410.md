...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25410#issuecomment-391808",
    "user": "https://github.com/sagetrac-saiharsh"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25410#issuecomment-391809",
    "user": "https://github.com/sagetrac-saiharsh"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25410#event-333630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25410#event-333631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25410#event-333632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25410",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25410#event-333633"
}
```
