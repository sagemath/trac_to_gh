...
```json
{
    "body": "<a id='comment:1'></a>The workaround would be to not use `simplify_full` but the specific `simplify_` functions that have an effect with this expression.",
    "created_at": "2018-07-06T14:57:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25789#issuecomment-494422",
    "user": "https://github.com/rwst"
}
```

<a id='comment:1'></a>The workaround would be to not use `simplify_full` but the specific `simplify_` functions that have an effect with this expression.
...
```json
{
    "body": "<a id='comment:2'></a>Well no. With `simplify_rectform` or just `simplify` I get the same. So this happens in the interface / conversion.",
    "created_at": "2018-07-06T15:02:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25789#issuecomment-494423",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>Well no. With `simplify_rectform` or just `simplify` I get the same. So this happens in the interface / conversion.
