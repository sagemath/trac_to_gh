...
```json
{
    "body": "<a id='comment:2'></a>\nThis bug is fixed by the pynac patch in #31585. (So the inaccuracy in the sum is due to an arithmetic overflow.) \n\nThere is only new commit in the branch here. It just deletes the \"known bug\" tag from the doctest in src/sage/functions/hypergeometric.py that is in the description of this ticket.\n\n---\nNew commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[f1a99fa](https://git.sagemath.org/sage.git/commit?id=f1a99fa926a777a54bc78571f36efd4de9396bfd)|`trac 31585 pynac overflow patch`|\n|[3fcf072](https://git.sagemath.org/sage.git/commit?id=3fcf0726cb17a701d279be7cbe724d73ec98370f)|`add doctests`|\n|[fdde3d9](https://git.sagemath.org/sage.git/commit?id=fdde3d9b4a16e51f22181744036920124811a1ef)|`update pynac patch level`|\n|[e8ee3fc](https://git.sagemath.org/sage.git/commit?id=e8ee3fc291a8d547459e89ad40f3cf0e7a953d93)|`trac 25688 remove \"known bug\" tag`|",
    "created_at": "2021-06-19T07:58:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25688",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nRebased on the new #31585 that eliminates a merge conflict.\n\n---\nNew commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[ecb99c8](https://git.sagemath.org/sage.git/commit?id=ecb99c85602cda86f775cff70003cfa548fd9ad4)|`trac 31585 pynac overflow patch`|\n|[2d04fa4](https://git.sagemath.org/sage.git/commit?id=2d04fa4a45f277a2deabeda50cf0f3d9c4a58590)|`add doctests`|\n|[5a340ce](https://git.sagemath.org/sage.git/commit?id=5a340ce206534e0a48d48edeb48197906fb9812a)|`update pynac patch level`|\n|[73e975c](https://git.sagemath.org/sage.git/commit?id=73e975c28997f6662454b3b53dfe2cdebd22f410)|`trac 25688 remove \"known bug\" tag`|",
    "created_at": "2021-06-28T05:06:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25688",
    "type": "issue_comment",
