...
```json
{
    "body": "Thank you!  See also the list at [symbolics](symbolics).",
...
```json
{
    "body": "The situation has improved some. Maxima knows that it can't compute the integrals from examples 2 through 11, but the fallback integrators aren't having much luck on my machine. Without `algorithm=\"maxima\"`, I've been waiting for like half an hour to get results back.",
