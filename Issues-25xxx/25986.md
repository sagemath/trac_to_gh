...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499012",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499013",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/jhpalmieri/cell-complex-fixes-py3\"",
    "created_at": "2018-08-01T21:56:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499015",
    "user": "https://github.com/jhpalmieri"
}
```

Changing branch from "" to "u/jhpalmieri/cell-complex-fixes-py3"
...
```json
{
    "body": "Changing commit from \"\" to \"91db10829379cdecac63143c50ac71fc820588c4\"",
    "created_at": "2018-08-01T22:06:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499016",
    "user": "https://github.com/jhpalmieri"
}
```

Changing commit from "" to "91db10829379cdecac63143c50ac71fc820588c4"
...
```json
{
    "body": "<a id='comment:4'></a>I overstated things in[comment:1](#comment%3A1). To get the situation down to the few failing doctests listed there, I need to apply #25932, #25929, #25978, #25935, #25940, #25986 (= this ticket), and the change (inspired by #24551)\n\n```diff\ndiff --git a/src/sage/groups/perm_gps/permgroup_named.py b/src/sage/groups/perm_gps/permgroup_named.py\nindex da1774e96c..54fa034b4a 100644\n--- a/src/sage/groups/perm_gps/permgroup_named.py\n+++ b/src/sage/groups/perm_gps/permgroup_named.py\n@@ -149,6 +149,8 @@ class PermutationGroup_unique(CachedRepresentation, PermutationGroup_generic):\n         \"\"\"\n         return super(CachedRepresentation, self).__eq__(other)\n \n+    __hash__ = CachedRepresentation.__hash__\n+\n \n class PermutationGroup_symalt(PermutationGroup_unique):\n     \"\"\"\n```",
    "created_at": "2018-08-03T02:00:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499018",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>I overstated things in[comment:1](#comment%3A1). To get the situation down to the few failing doctests listed there, I need to apply #25932, #25929, #25978, #25935, #25940, #25986 (= this ticket), and the change (inspired by #24551)
...
```json
{
    "body": "Changing commit from \"91db10829379cdecac63143c50ac71fc820588c4\" to \"3974bbb79fcc789848074576abd52f866fb12080\"",
    "created_at": "2018-08-03T02:50:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499019",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "91db10829379cdecac63143c50ac71fc820588c4" to "3974bbb79fcc789848074576abd52f866fb12080"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499020",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>A few more fixes.",
    "created_at": "2018-08-03T02:51:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499021",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:6'></a>A few more fixes.
...
```json
{
    "body": "<a id='comment:7'></a>#25992 fixes the problem with parallel processing, and hence with `is_cohen_macaulay`.",
    "created_at": "2018-08-03T02:58:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499022",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>#25992 fixes the problem with parallel processing, and hence with `is_cohen_macaulay`.
...
```json
{
    "body": "Changing commit from \"3974bbb79fcc789848074576abd52f866fb12080\" to \"ff52d0374494371f607b2d40d27a7d88c2c8cce1\"",
    "created_at": "2018-08-03T17:44:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499024",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "3974bbb79fcc789848074576abd52f866fb12080" to "ff52d0374494371f607b2d40d27a7d88c2c8cce1"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499025",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499026",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I think having `n_faces` is useful from a user-interface POV.\n\nThank you. LGTM.",
    "created_at": "2018-08-03T22:21:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499027",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:11'></a>I think having `n_faces` is useful from a user-interface POV.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499028",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499029",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25986#event-64958"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499030",
...
```json
{
    "body": "Changing branch from \"u/jhpalmieri/cell-complex-fixes-py3\" to \"ff52d0374494371f607b2d40d27a7d88c2c8cce1\"",
    "created_at": "2018-08-30T22:24:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25986#issuecomment-499031",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jhpalmieri/cell-complex-fixes-py3" to "ff52d0374494371f607b2d40d27a7d88c2c8cce1"
