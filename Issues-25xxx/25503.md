...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[380a2b0](https://git.sagemath.org/sage.git/commit?id=380a2b0e7a0f375e40be1329d890d0a73f324c92)|`#25503 : do not build R if SAGE_R_LIB is set`|\n|[e8768ed](https://git.sagemath.org/sage.git/commit?id=e8768ed5d0af6683fbdf3775f29c13047cbdecee)|`#25503 : let rpy2 use SAGE_R_LIB for its RHOMES variable`|\n|[0519cda](https://git.sagemath.org/sage.git/commit?id=0519cda83d2fe9ecb2cf1214ea86acf15df405e3)|`#25503 : fix issue between R interface and readline 7`|\n|[eed2ea3](https://git.sagemath.org/sage.git/commit?id=eed2ea352af29fa6e6fb65d274c2e0078a7c07a6)|`#25503 : document the SAGE_R_LIB variable in the install guide`|",
