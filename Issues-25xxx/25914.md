...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497486",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497487",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497488",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497489",
...
```json
{
    "body": "<a id='comment:2'></a>In general this looks good to me. So the idea would be to upstream what can be upstreamed and then put the proposed upstream patches into our SPKGs instead of this monkey patching of sorts?",
    "created_at": "2018-08-22T02:19:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497490",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:2'></a>In general this looks good to me. So the idea would be to upstream what can be upstreamed and then put the proposed upstream patches into our SPKGs instead of this monkey patching of sorts?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497491",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497494",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497495",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497496",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497497",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497498",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497499",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64787"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64788"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Moving all my in-progress tickets to 8.8 milestone.",
    "created_at": "2019-03-25T10:43:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497500",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>Moving all my in-progress tickets to 8.8 milestone.
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64789"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64790"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64791"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497501",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64793"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497502",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64795"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497504",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Thanks, I agree.  I think the only reason I never moved forward on this is that no one really gave any feedback or expressed desire for the feature, though the goal was in part to make it easier for new contributors to make changes.\n\nI don't know what it would require to update this but I don't think it will be too hard.  Most of the Sphinx issues were due to shortcomings in Cython support; I don't think that's any better in Sphinx yet.",
    "created_at": "2020-08-31T15:24:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497505",
    "user": "https://github.com/embray"
}
```

<a id='comment:16'></a>Thanks, I agree.  I think the only reason I never moved forward on this is that no one really gave any feedback or expressed desire for the feature, though the goal was in part to make it easier for new contributors to make changes.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64797"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497506",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64799"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64800"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64801"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64802"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25914#issuecomment-497507",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64803"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64804"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64805"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64806"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64807"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25914#event-64808"
}
```
