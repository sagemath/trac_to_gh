...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[c4aa595](https://git.sagemath.org/sage.git/commit?id=c4aa5950b532924fe9952f7b2ec8ecc42cef45be)|`25125: add all_solutions method to dancing links`|",
    "created_at": "2018-04-09T06:33:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25125",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|\n|[71b8683](https://git.sagemath.org/sage.git/commit/?id=71b86832e62cec0b6fb7ba26e75514ee64adabfc)|`25125: fix doc`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[3073811](https://git.sagemath.org/sage.git/commit/?id=30738114df9b404c0aa2ec0b2e475f3ade6f8f62)|`25125: setting ncpus=None as default`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[9448bfd](https://git.sagemath.org/sage.git/commit/?id=9448bfdbafc0aedf1bb3e74edb3028938cebd961)|`25125: add all_solutions method to dancing links`|\n|[f6257b8](https://git.sagemath.org/sage.git/commit/?id=f6257b876f6693b2d93ffef8bb60f87255109642)|`25125: fix doc`|\n|[876bfd3](https://git.sagemath.org/sage.git/commit/?id=876bfd3cf2839c1fe983dead87731d247349d749)|`25125: setting ncpus=None as default`|\n|[606c156](https://git.sagemath.org/sage.git/commit/?id=606c156e11af547837037584337b68cea73545c0)|`25125: improved sentences before some doctests`|\n|[0a86ab2](https://git.sagemath.org/sage.git/commit/?id=0a86ab2331766b2c6c99a541730afb193c0ac7c3)|`rewriting number_of_solutions method like one_solution and all_solutions`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[a7dec68](https://git.sagemath.org/sage.git/commit/?id=a7dec6805d5fe3d58d983adcee57fc877d484175)|`25125: add all_solutions method to dancing links`|\n|[0afeffa](https://git.sagemath.org/sage.git/commit/?id=0afeffab3885ee1b2e0711811abb0b64d89f59e2)|`25125: fix doc`|\n|[3d255c8](https://git.sagemath.org/sage.git/commit/?id=3d255c84389c2aa739e6b656ef15ca189ae32e8f)|`25125: setting ncpus=None as default`|\n|[7c27fc8](https://git.sagemath.org/sage.git/commit/?id=7c27fc8cf9fcb1ba41ace2c8613547c78aa1aa8d)|`25125: improved sentences before some doctests`|\n|[78c50e3](https://git.sagemath.org/sage.git/commit/?id=78c50e33498784ebbd1a9dc7084a22481690c116)|`rewriting number_of_solutions method like one_solution and all_solutions`|\n|[f20e603](https://git.sagemath.org/sage.git/commit/?id=f20e6030bc8b4bdee274fb093e802a180f414d59)|`25125: allow reinitialization of dlx solver`|",
    "created_at": "2018-05-01T16:26:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25125",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[2230623](https://git.sagemath.org/sage.git/commit/?id=22306233cc4b7eeb34aef812fbff856e312d1ea9)|`25125: reinitialize the dlx solver when needed`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nOn Ubuntu, I can not reproduce the issue.\n\nThe methods I am adding/modifying to the dancing links class are not used by the sudoku solver which uses directly the `search` and  `get_solution` methods. The only thing I changed that may have affected the sudoku thing is the way the `__init__` is done which is now done with the `reinitalize` method. Maybe OSX does not like the line\n\n```\nself._x = dancing_links()\n```\n\nthat was in the `reinitialize` which was called by the `__init__`? So, I added a new commit which does\n\n```\nself._x = dancing_links()\n```\n\nonly for the reinitialization and avoids it for `__init__` as it was before. Can somebody with OSX test whether this fixes the issue?\n\n---\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[b4fdeb5](https://git.sagemath.org/sage.git/commit?id=b4fdeb52ba3105328dcc41bbc978b643c0a368c0)|`25125: add all_solutions method to dancing links`|\n|[5ddc189](https://git.sagemath.org/sage.git/commit?id=5ddc18968028011affdbcbc11503858de0a19d20)|`25125: fix doc`|\n|[0842d46](https://git.sagemath.org/sage.git/commit?id=0842d46a31581ddd3dee4bbd30253b15110a54d2)|`25125: setting ncpus=None as default`|\n|[11b3894](https://git.sagemath.org/sage.git/commit?id=11b389412e146dee9a4ee6ef4b88fae320b888f3)|`25125: improved sentences before some doctests`|\n|[0f320ea](https://git.sagemath.org/sage.git/commit?id=0f320ea3e140bcb8703ea8541a4556445b4c4d52)|`rewriting number_of_solutions method like one_solution and all_solutions`|\n|[2fce4fe](https://git.sagemath.org/sage.git/commit?id=2fce4fe6c0732fcd143e6e616238aca69f5f1e16)|`25125: allow reinitialization of dlx solver`|\n|[a5c4667](https://git.sagemath.org/sage.git/commit?id=a5c46677d73a6cc9c745dbb784de05e42d6501fc)|`25125: reinitialize the dlx solver when needed`|\n|[d13e0ec](https://git.sagemath.org/sage.git/commit?id=d13e0ec76680814329f26aa3860c54065168e469)|`25125: Calling constructor dancing_links() only in reinitialize not in __init__`|",
    "created_at": "2018-05-15T13:31:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25125",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[9a158e6](https://git.sagemath.org/sage.git/commit/?id=9a158e669e0fd14e6ff9d8b0558e8c8ce1066a9c)|`25125: add all_solutions method to dancing links`|\n|[89b5901](https://git.sagemath.org/sage.git/commit/?id=89b590143db0e01faaf726ab81b403ec9bdbe1da)|`25125: fix doc`|\n|[c54a64d](https://git.sagemath.org/sage.git/commit/?id=c54a64de737f51cd7ca9672b1517ba488436b08d)|`25125: setting ncpus=None as default`|\n|[cf7b435](https://git.sagemath.org/sage.git/commit/?id=cf7b435c4c403a2d4c22d61df15a57e310bb2ea8)|`25125: improved sentences before some doctests`|\n|[004126a](https://git.sagemath.org/sage.git/commit/?id=004126a706f01ceacecc01a0c4db5483a8202d7e)|`rewriting number_of_solutions method like one_solution and all_solutions`|\n|[d18e090](https://git.sagemath.org/sage.git/commit/?id=d18e09062e61e32e9952c7752378e693d7ddee15)|`25125: allow reinitialization of dlx solver`|\n|[c05e73b](https://git.sagemath.org/sage.git/commit/?id=c05e73b64a27e3a85ce744b893fe419028232dd7)|`25125: reinitialize the dlx solver when needed`|\n|[10f885d](https://git.sagemath.org/sage.git/commit/?id=10f885d0a3171c377161721df79cf985a5936026)|`25125: Calling constructor dancing_links() only in reinitialize not in __init__`|\n|[25da49e](https://git.sagemath.org/sage.git/commit/?id=25da49e6e04ca7fed46442d27f66d3dc297362ab)|`25125: sorted lists in doctests`|",
    "created_at": "2018-05-24T08:13:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25125",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[c985179](https://git.sagemath.org/sage.git/commit/?id=c9851791ab1b04561be9e7cd18e4f706d44b8545)|`25125: sorting every list even those of size one in doctests`|",
    "created_at": "2018-05-30T19:44:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25125",
    "type": "issue_comment",
