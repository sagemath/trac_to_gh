...
```json
{
    "body": "<a id='comment:1'></a>This line reads \"`deps_arb = $(MP_LIBRARY) mpfr flint`\" in my clang installation.",
...
<a id='comment:1'></a>This line reads "`deps_arb = $(MP_LIBRARY) mpfr flint`" in my clang installation.
...
```json
{
    "body": "<a id='comment:2'></a>Because you have a working gcc so the optional built-in gcc is not compiled...",
...
<a id='comment:2'></a>Because you have a working gcc so the optional built-in gcc is not compiled...
...
```json
{
    "body": "<a id='comment:3'></a>This was already fixed by #24961",
    "created_at": "2018-03-26T11:15:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25031",
    "type": "issue_comment",
...
<a id='comment:3'></a>This was already fixed by #24961
