...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|\n|[50c1e0a](https://git.sagemath.org/sage.git/commit?id=50c1e0aba2d0f5ca0be0a21cf4bd16d6d8a49bf3)|`add a hand-customized version of the patch from the upstream PR which only patches the configure script and the relevant .c sources`|",
    "created_at": "2018-07-13T13:49:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25858",
    "type": "issue_comment",
