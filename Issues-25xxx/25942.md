...
<a id='comment:7'></a>Replying to [comment:6 alauve]:
> What is the correct way to check for semisimplicity?
...
<a id='comment:9'></a>Replying to [comment:6 alauve]:
> What is the correct way to check for semisimplicity?
> 
...
<a id='comment:19'></a>Replying to [comment:11 alauve]:
> That's right. I was speaking less about "how best" rather than "how".
> 
> I don't know how the semisimplicity check gets done...
> 
...
<a id='comment:32'></a>Replying to [comment:31 alauve]:
> > - Why are you using `gap` and not `libgap` here:
> >   {{{
> > eval(gap.eval("Display(Irr(SymmetricGroup(%d)));"%n))
> >   }}}
...
```json
{
    "body": "<a id='comment:43'></a>I am assuming I should take comment:41 as a positive review. Thank you all.",
...
<a id='comment:43'></a>I am assuming I should take comment:41 as a positive review. Thank you all.
