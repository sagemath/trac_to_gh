...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|\n|[78de7b5](https://git.sagemath.org/sage.git/commit?id=78de7b5d2eb7d192509d4a1bcff6f8ed31096273)|`overwrote default implementation of orthogonal idempotents with the faster cpis method.`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[d646607](https://git.sagemath.org/sage.git/commit/?id=d64660771934181709ebc3b43cbd790a2137954d)|`added caching; fixed an error in coefficient computation within cpi method`|\n|[7e6c7ef](https://git.sagemath.org/sage.git/commit/?id=7e6c7ef6bf91335b776b8bf0c36ebff9dd326282)|`work on docstrings`|",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|\n|[44f7d8d](https://git.sagemath.org/sage.git/commit/?id=44f7d8d0703820f64d8ad07c633b209d917a45e5)|`Merge branch 'develop' into public/combinat/speedup_idempotents_for_SymmetricGroupAlgebras_25942`|\n|[6e2d52d](https://git.sagemath.org/sage.git/commit/?id=6e2d52d4276083347ca38d654fd11b0a3a128b29)|`First draft of implementing Nakayama's Conjecture (now a theorem) to correct`|",
    "created_at": "2018-09-01T00:09:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25942",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:26'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[a441a59](https://git.sagemath.org/sage.git/commit/?id=a441a596d549e18f35e810db6b24ad3882e3e37c)|`allow p-cores as input for central_orthogonal_idempotent`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[efa01f7](https://git.sagemath.org/sage.git/commit/?id=efa01f7a9237f179e1b7295060c4eb508d150503)|`setup deprecated_function_alias`|",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[d77425d](https://git.sagemath.org/sage.git/commit/?id=d77425d750529b36af556122def1e28029d658c6)|`Merge branch 'public/combinat/speedup_idempotents_for_SymmetricGroupAlgebras_25942' of git://trac.sagemath.org/sage into public/combinat/speedup_idempotents_for_SymmetricGroupAlgebras_25942`|\n|[86bfd32](https://git.sagemath.org/sage.git/commit/?id=86bfd328d9d43d9c0cb958e31b6816aa64b9ec21)|`Changing the caching of SGA central_orthogonal_idempotent(s).`|\n|[5b752c4](https://git.sagemath.org/sage.git/commit/?id=5b752c4776b13d150f1fc6d60b38220171a7e781)|`Some tweaks to the changed test in fin-dim semiseimple algebras w/ basis.`|",
    "created_at": "2018-09-06T00:09:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25942",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[3223375](https://git.sagemath.org/sage.git/commit/?id=3223375b83ed77021a34ae452a4ac3fa2fc60ab9)|`Further optimizations of idempotent computation in positive char.`|",
...
```json
{
    "body": "<a id='comment:46'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[77c38e2](https://git.sagemath.org/sage.git/commit/?id=77c38e29a3d15b56e15ffaa19d887619eeedd9d4)|`Fixing typo in variable name.`|",
