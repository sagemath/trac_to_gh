...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25798#event-326431"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25798#event-326432"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25798#event-326433"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25798#issuecomment-399095",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25798#issuecomment-399096",
    "user": "https://github.com/AntGeorge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25798#issuecomment-399097",
    "user": "https://github.com/dcoudert"
}
```
