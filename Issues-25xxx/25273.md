...
```json
{
    "body": "<a id='comment:7'></a>\nNew commits:\n|                                                                                                                                          |                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[b8c3c12](https://git.sagemath.org/sage.git/commit?id=b8c3c12a65c71f4612577f8bd7c29d0825bfe18a)|`Clean up cimports in libgap`|\n|[ea2e39c](https://git.sagemath.org/sage.git/commit?id=ea2e39c7374b03b97366f264c89a0f4c75a7c172)|`Unprefixed libGAP interface`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nrebased over the latest beta, fixed bug. We could perhaps finish and merge this, as an intermediate step towards #22626.\n\n---\nNew commits:\n|                                                                                                                                          |                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------|\n|[f9bdacd](https://git.sagemath.org/sage.git/commit?id=f9bdacd7b419be4fa7d7eb5389af9991c226a851)|`rebased over 8.4.b4`|\n|[12cc10c](https://git.sagemath.org/sage.git/commit?id=12cc10c05e6e4c8eda12e7b4ca01d03e0f68b3a2)|`Merge branch 'develop' of trac.sagemath.org:sage into HEAD`|\n|[48e4f7b](https://git.sagemath.org/sage.git/commit?id=48e4f7b9ec98c13acf6345689bea442b30ac316f)|`correcting a typo (?)`|",
    "created_at": "2018-09-18T09:17:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25273",
    "type": "issue_comment",
