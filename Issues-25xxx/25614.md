...
<a id='comment:1'></a>The failing doctest is:
...
<a id='comment:3'></a>I updated the adress of the file in the doctest.
...
```json
{
    "body": "<a id='comment:6'></a>The fix I proposed months ago now works! Maybe because of #25535, the problem `invalid load key` disappeared. Needs review!",
...
<a id='comment:6'></a>The fix I proposed months ago now works! Maybe because of #25535, the problem `invalid load key` disappeared. Needs review!
