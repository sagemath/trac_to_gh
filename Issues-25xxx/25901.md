...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25901#issuecomment-400990",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25901#issuecomment-400991",
    "user": "https://github.com/hughrthomas"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25901#event-339902"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25901#event-339903"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25901#event-339904"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25901#event-339905"
}
```
