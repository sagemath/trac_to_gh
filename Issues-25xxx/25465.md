...
```json
{
    "body": "<a id='comment:1'></a>that code used to work, now some weird `MemoryError`...\n\n(are you very pressed for RAM, maybe?)",
    "created_at": "2018-05-30T14:57:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487110",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:1'></a>that code used to work, now some weird `MemoryError`...
...
```json
{
    "body": "<a id='comment:2'></a>No, 64GB, that's why I don't understand. May be a side effect of something else.",
    "created_at": "2018-05-30T15:19:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487111",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:2'></a>No, 64GB, that's why I don't understand. May be a side effect of something else.
...
```json
{
    "body": "<a id='comment:3'></a>What branch are you getting these on?",
    "created_at": "2018-05-30T15:35:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487112",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:3'></a>What branch are you getting these on?
...
```json
{
    "body": "<a id='comment:4'></a>branch develop of 8.3.beta3, on linux fedora PC with two 4-cores Intel(R) Xeon(R) CPU W5580 `@` 3.20GH and 64GB.\n\nI just found some log files at the root of the sage directory where it is written that there is insufficient memory for the Java Runtime Environment to continue. So it might be a java issue on that computer ? I will investigate with a colleague more expert than me in these kind of issues.",
    "created_at": "2018-05-31T08:05:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487113",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:4'></a>branch develop of 8.3.beta3, on linux fedora PC with two 4-cores Intel(R) Xeon(R) CPU W5580 `@` 3.20GH and 64GB.
...
```json
{
    "body": "<a id='comment:5'></a>another surprizing behavior: When I start a sage console, and then type `g = graphs.JankoKharaghaniGraph(936)`, it's working perfectly. But with `./sage -t --long src/sage/graphs/generators/smallgraphs.py`, it got doctests errors :((",
    "created_at": "2018-05-31T08:15:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487114",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:5'></a>another surprizing behavior: When I start a sage console, and then type `g = graphs.JankoKharaghaniGraph(936)`, it's working perfectly. But with `./sage -t --long src/sage/graphs/generators/smallgraphs.py`, it got doctests errors :((
...
```json
{
    "body": "<a id='comment:6'></a>Is it the same with 8.2 and earlier 8.3betas? (It would be good to try to find the responsible for this commit, by bisecting...)",
    "created_at": "2018-06-01T09:13:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487115",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:6'></a>Is it the same with 8.2 and earlier 8.3betas? (It would be good to try to find the responsible for this commit, by bisecting...)
...
```json
{
    "body": "<a id='comment:7'></a>I tried with 8.2(long to recompute) and also got the errors :(\n\nAre doctests allowed to use same amount of memory than when running a Sagemath console ? Otherwise it might be something coming from my system, but what ? I'm using it since years for Sagemath...",
    "created_at": "2018-06-02T11:11:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487116",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:7'></a>I tried with 8.2(long to recompute) and also got the errors :(
...
```json
{
    "body": "<a id='comment:8'></a>It could be multithreading issue... Did you try running these tests with single thread?",
    "created_at": "2018-06-03T09:54:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487117",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:8'></a>It could be multithreading issue... Did you try running these tests with single thread?
...
```json
{
    "body": "<a id='comment:9'></a>I tried `./sage -tp 1 --long src/sage/graphs/` with same result. I will ask for a system update to test.",
    "created_at": "2018-06-03T11:03:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487118",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:9'></a>I tried `./sage -tp 1 --long src/sage/graphs/` with same result. I will ask for a system update to test.
...
```json
{
    "body": "<a id='comment:10'></a>after a system update to fedora 26, a make dist-clean and full reinstallation of 8.3.beta4, I still have the same errors :((",
    "created_at": "2018-06-05T15:14:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487119",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:10'></a>after a system update to fedora 26, a make dist-clean and full reinstallation of 8.3.beta4, I still have the same errors :((
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25465#event-63896"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Just to say that a duplicate of this ticket was #28865.",
    "created_at": "2020-02-01T14:42:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487120",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:12'></a>Just to say that a duplicate of this ticket was #28865.
...
```json
{
    "body": "<a id='comment:13'></a>Do we now have a solution to fix this issue ? is it sufficient to add `# memlimit` to these doctests ?",
    "created_at": "2020-02-01T15:38:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487121",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:13'></a>Do we now have a solution to fix this issue ? is it sufficient to add `# memlimit` to these doctests ?
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25465#event-63897"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25465#event-63898"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487125",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487126",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487127",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25465#event-63899"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487128",
...
```json
{
    "body": "<a id='comment:20'></a>This was likely fixed by #28978.",
    "created_at": "2020-06-24T06:02:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487129",
    "user": "https://github.com/slel"
}
```

<a id='comment:20'></a>This was likely fixed by #28978.
...
```json
{
    "body": "<a id='comment:21'></a>but the tag `memlimit` is not used in `src/sage/graphs/generators/smallgraphs.py`",
    "created_at": "2020-06-24T06:22:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487130",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:21'></a>but the tag `memlimit` is not used in `src/sage/graphs/generators/smallgraphs.py`
...
```json
{
    "body": "<a id='comment:22'></a>I still have the issue on Ubuntu 16.04, but soon I will upgrade to 20.04, and I assume that will fix the issue?",
    "created_at": "2020-06-24T19:29:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487131",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:22'></a>I still have the issue on Ubuntu 16.04, but soon I will upgrade to 20.04, and I assume that will fix the issue?
...
```json
{
    "body": "<a id='comment:23'></a>Let's hope so.",
    "created_at": "2020-06-24T22:05:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25465",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25465#issuecomment-487132",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:23'></a>Let's hope so.
