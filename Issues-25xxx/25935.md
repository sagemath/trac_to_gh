...
```json
{
    "body": "<a id='comment:2'></a>\nWell, I removed `__eq__` and `__ne__` and there were only a few doctest failures. So I say we go this route.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[6c25916](https://git.sagemath.org/sage.git/commit?id=6c25916cdca7fbfc6f7d89b3bc0c5d04ebea7fdd)|`trac 25935: remove __eq__ for AbelianGroup_class: it should inherit __eq__`|",
