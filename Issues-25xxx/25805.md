...
```json
{
    "body": "<a id='comment:1'></a>Not having had access to such a server I've not yet even played with Windows native containers yet.  I still need to get an Azure account to try that out, as I think it will also work better for the Windows patchbot...",
    "created_at": "2018-07-09T08:59:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360082",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>Not having had access to such a server I've not yet even played with Windows native containers yet.  I still need to get an Azure account to try that out, as I think it will also work better for the Windows patchbot...
...
```json
{
    "body": "<a id='comment:2'></a>I found (docker on) azure to be completely useless. It takes much longer than I am willing to wait to launch VMs there and I never got docker to work, apparently due to disabled virtualization options on the virtual machines.\n\nI am now running Win2k16 Server Standard on QEMU and after some tweaking I am quite happy with the performance.",
    "created_at": "2018-07-09T09:08:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360083",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:2'></a>I found (docker on) azure to be completely useless. It takes much longer than I am willing to wait to launch VMs there and I never got docker to work, apparently due to disabled virtualization options on the virtual machines.
...
```json
{
    "body": "<a id='comment:3'></a>I had just assumed that Microsoft would have put effort into making that work well, given the resources they've put into helping Docker implement it.  If it's useless then why would the push it at all?\n\nHow did you even get this Windows Server, or is it unlicensed?",
    "created_at": "2018-07-09T09:54:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360084",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>I had just assumed that Microsoft would have put effort into making that work well, given the resources they've put into helping Docker implement it.  If it's useless then why would the push it at all?
...
```json
{
    "body": "<a id='comment:4'></a>But the question is, does *Cygwin* perform well?  I have still never been able to get good Cygwin performance in a Windows VM on a Linux host (due mostly to fork, or at least that's my suspicion).",
    "created_at": "2018-07-09T09:55:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360085",
    "user": "https://github.com/embray"
}
```

<a id='comment:4'></a>But the question is, does *Cygwin* perform well?  I have still never been able to get good Cygwin performance in a Windows VM on a Linux host (due mostly to fork, or at least that's my suspicion).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360086",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360087",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Replying to [comment:5 saraedum]:\n> Replying to [comment:3 embray]:\n> > How did you even get this Windows Server, or is it unlicensed?\n\n> It's a 180 day trial.\n\nWhat happens after the trial period runs out?",
    "created_at": "2018-07-09T11:17:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360088",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>Replying to [comment:5 saraedum]:
> Replying to [comment:3 embray]:
> > How did you even get this Windows Server, or is it unlicensed?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360089",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25805#event-64526"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360091",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I propose to close this ticket as there is not really a point anymore in having these docker containers it seems.",
    "created_at": "2018-07-31T10:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360092",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:10'></a>I propose to close this ticket as there is not really a point anymore in having these docker containers it seems.
...
```json
{
    "body": "<a id='comment:11'></a>I think it's still desirable, and might be more feasible in the future.  It's just not clear right now that it's feasible or useful.",
    "created_at": "2018-07-31T13:43:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360093",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>I think it's still desirable, and might be more feasible in the future.  It's just not clear right now that it's feasible or useful.
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25805#event-64527"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25805#event-64528"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>I'm not even sure it's desirable. But sure, let's leave the ticket around.",
    "created_at": "2018-07-31T13:53:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360094",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:12'></a>I'm not even sure it's desirable. But sure, let's leave the ticket around.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360095",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Yes, I was running cygwin inside the docker container.\n\nCan you set this ticket back to \"new\" somehow?",
    "created_at": "2018-07-31T14:20:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360096",
    "user": "https://github.com/saraedum"
}
```

<a id='comment:14'></a>Yes, I was running cygwin inside the docker container.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360097",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25805#event-64529"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>I think I need to close and reopen it",
    "created_at": "2018-08-01T12:09:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360098",
    "user": "https://github.com/embray"
}
```

<a id='comment:15'></a>I think I need to close and reopen it
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360099",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25805#event-64530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360100",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25805",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25805#issuecomment-360101",
    "user": "https://github.com/saraedum"
}
```
