...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25762#issuecomment-493919",
    "user": "https://trac.sagemath.org/admin/accounts/users/tmonteil"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25762#event-64425"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Still broken in 9.6.rc3",
    "created_at": "2022-05-04T23:00:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25762#issuecomment-493920",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>Still broken in 9.6.rc3
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25762#event-64426"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25762#event-64427"
}
```
