...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498729",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498730",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I'm not entirely sure to what extent the failure is really random. It might be deterministic but occur only under a very precise set of conditions.",
    "created_at": "2018-07-29T22:01:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498731",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:3'></a>I'm not entirely sure to what extent the failure is really random. It might be deterministic but occur only under a very precise set of conditions.
...
```json
{
    "body": "<a id='comment:4'></a>A possible cannon-to-shoot-a-mosquito solution might be #25971.",
    "created_at": "2018-07-29T22:28:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498732",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>A possible cannon-to-shoot-a-mosquito solution might be #25971.
...
```json
{
    "body": "<a id='comment:5'></a>I cannot reproduce on my desktop PC, even though that is executing the exact same build script in a sandbox with the exact same dependencies. It looks like I can reproduce deterministically on my laptop. Unfortunately that takes forever to run the whole testsuite...",
    "created_at": "2018-07-30T19:59:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498733",
    "user": "https://github.com/timokau"
}
```

<a id='comment:5'></a>I cannot reproduce on my desktop PC, even though that is executing the exact same build script in a sandbox with the exact same dependencies. It looks like I can reproduce deterministically on my laptop. Unfortunately that takes forever to run the whole testsuite...
...
```json
{
    "body": "<a id='comment:6'></a>It looks like this was actually triggered by the `rc2 -> rc3` upgrade for me, *not* the singular update. I didn't test the rc upgrade individually and assumed the singular update would be at fault because the rc upgrade only contained a couple of bug fixes.",
    "created_at": "2018-07-31T16:02:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498734",
    "user": "https://github.com/timokau"
}
```

<a id='comment:6'></a>It looks like this was actually triggered by the `rc2 -> rc3` upgrade for me, *not* the singular update. I didn't test the rc upgrade individually and assumed the singular update would be at fault because the rc upgrade only contained a couple of bug fixes.
...
```json
{
    "body": "<a id='comment:7'></a>Although looking at the diff, I can't see anything that might cause this. All the changes in `build` can be ignored. So the only things remaining are\n\n- marking a couple of tests as known bugs\n- update the version metadata\n- add a stopgap to DuadicCodeEvenPair and DuadicCodeOddPair",
    "created_at": "2018-07-31T16:06:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498735",
    "user": "https://github.com/timokau"
}
```

<a id='comment:7'></a>Although looking at the diff, I can't see anything that might cause this. All the changes in `build` can be ignored. So the only things remaining are
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498736",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Then what can we do about it? All I can say is that it pretty reliably (2 times in a row) happens after the upgrade and pretty reliable doesn't happen (3 times in a row) before.",
    "created_at": "2018-07-31T19:15:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498737",
    "user": "https://github.com/timokau"
}
```

<a id='comment:9'></a>Then what can we do about it? All I can say is that it pretty reliably (2 times in a row) happens after the upgrade and pretty reliable doesn't happen (3 times in a row) before.
...
```json
{
    "body": "<a id='comment:10'></a>Looks like only integer arithmetic is involved; Might be a corrupted mpir limb in the pool due to a preceeding interrupt test. Where exactly the interrupt hits depends on may external factors...",
    "created_at": "2018-08-05T08:56:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498738",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:10'></a>Looks like only integer arithmetic is involved; Might be a corrupted mpir limb in the pool due to a preceeding interrupt test. Where exactly the interrupt hits depends on may external factors...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25969#issuecomment-498740",
    "user": "https://github.com/jdemeyer"
}
```
