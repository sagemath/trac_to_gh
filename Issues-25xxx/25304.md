...
```json
{
    "body": "Is this still a problem with current Sage?",
...
```json
{
    "body": "Is this the same as #25996?",
...
```json
{
    "body": "Outdated: It now fails in a different way (when tested with `tox -e docker-debian-stretch-i386-minimal-gcc_spkg` gives \"Error building gcc-10.3.0\").\nLet's close this ticket.",
    "created_at": "2021-09-25T19:53:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
