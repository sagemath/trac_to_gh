...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483142",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25304#event-63421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483143",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483144",
...
```json
{
    "body": "<a id='comment:4'></a>Is this still a problem with current Sage?",
    "created_at": "2020-03-23T01:52:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483145",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>Is this still a problem with current Sage?
...
```json
{
    "body": "<a id='comment:5'></a>Is this the same as #25996?",
    "created_at": "2020-04-23T03:31:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483146",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Is this the same as #25996?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483147",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25304#event-63422"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25304#event-63423"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Outdated: It now fails in a different way (when tested with `tox -e docker-debian-stretch-i386-minimal-gcc_spkg` gives \"Error building gcc-10.3.0\").\nLet's close this ticket.",
    "created_at": "2021-09-25T19:53:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483148",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>Outdated: It now fails in a different way (when tested with `tox -e docker-debian-stretch-i386-minimal-gcc_spkg` gives "Error building gcc-10.3.0").
Let's close this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483149",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483150",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25304#issuecomment-483151",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25304",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25304#event-63424"
}
```
