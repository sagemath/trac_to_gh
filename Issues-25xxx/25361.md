...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484420",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484421",
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63578"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>And to be clear, that's not the only problem with the tests, but it was the reason for many of these failures.\n\nIn fact, the above workaround reduced the failures to two:\n\n```\n----------------------------------------------------------------------\nsage -t --long /opt/sagemath-8.3/src/sage/tests/cmdline.py  # 2 doctests failed\nsage -t --long /opt/sagemath-8.3/src/sage/doctest/control.py  # 1 doctest failed\n----------------------------------------------------------------------\n```\n\nSo that's a relief.",
    "created_at": "2018-08-10T16:51:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484425",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>And to be clear, that's not the only problem with the tests, but it was the reason for many of these failures.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484426",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484427",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63579"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63580"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63581"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63582"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Retargeting some of my tickets.",
    "created_at": "2018-12-28T14:09:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484428",
    "user": "https://github.com/embray"
}
```

<a id='comment:11'></a>Retargeting some of my tickets.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484429",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63583"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63584"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Fixing #28289 would also likely fix some of these failures.  ipython_config.py should be ignored by default in the doctests, and *especially* in the REPL tests.",
    "created_at": "2019-07-30T09:55:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484430",
    "user": "https://github.com/embray"
}
```

<a id='comment:13'></a>Fixing #28289 would also likely fix some of these failures.  ipython_config.py should be ignored by default in the doctests, and *especially* in the REPL tests.
...
```json
{
    "body": "<a id='comment:14'></a>Outdated, should be closed.",
    "created_at": "2021-01-10T18:46:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484431",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:14'></a>Outdated, should be closed.
...
```json
{
    ...
    "milestone": "sage-pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63585"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63586"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484432",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484433",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484434",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484435",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Erik, can we close this one ? and what about #25205 ?",
    "created_at": "2021-02-04T14:09:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484436",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:16'></a>Erik, can we close this one ? and what about #25205 ?
...
```json
{
    "body": "<a id='comment:17'></a>Definitely outdated by now.  Some of the failures mentioned here have already been addressed, or have other tickets, or are not even Windows-specific (like the 99seconds.rst one).",
    "created_at": "2021-03-10T15:10:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484437",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>Definitely outdated by now.  Some of the failures mentioned here have already been addressed, or have other tickets, or are not even Windows-specific (like the 99seconds.rst one).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25361#event-63587"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25361",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25361#issuecomment-484438",
    "user": "https://github.com/embray"
}
```
