...
archive/attachments_021794.json:
```json
{
...
```json
{
    "body": "**Attachment:** [memory_leak.py](https://github.com/sagemath/sage/files/ticket25515/memory_leak.py)",
    "created_at": "2018-06-05T22:44:16Z",
    "issue": "https://github.com/sagemath/sage/issues/25515",
    "type": "issue_comment",
...
**Attachment:** [memory_leak.py](https://github.com/sagemath/sage/files/ticket25515/memory_leak.py)
