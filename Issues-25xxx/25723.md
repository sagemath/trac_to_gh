...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337650"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337651"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398031",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    "body": "Changed keywords from **** to **Multivariate polynomials**",
    "created_at": "2018-07-01T07:15:39Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398032",
    "user": "https://github.com/AndrewAtLarge"
}
```

Changed keywords from **** to **Multivariate polynomials**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398033",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398034",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398035",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337653"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398037",
    "user": "https://github.com/sagetrac-tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398038",
    "user": "https://github.com/sagetrac-tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25723#issuecomment-398039",
    "user": "https://github.com/AndrewAtLarge"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337654"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337655"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337656"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25723#event-337657"
}
```
