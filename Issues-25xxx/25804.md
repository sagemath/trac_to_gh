...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25804#event-338610"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25804#event-338611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25804#event-338612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25804#event-338613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25804#issuecomment-399196",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25804#issuecomment-399197",
    "user": "https://github.com/rwst"
}
```
