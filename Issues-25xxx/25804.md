...
```json
{
    "body": "<a id='comment:1'></a>Basically, this cannot be fixed. See #16850 for the underlying issue.\n\nHow often does this crash?",
    "created_at": "2018-07-09T07:15:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25804#issuecomment-360080",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:1'></a>Basically, this cannot be fixed. See #16850 for the underlying issue.
...
```json
{
    "body": "<a id='comment:2'></a>I don't run often `make ptestlong`. If this exists that long, though, it would happen here in less than 10% of runs.",
    "created_at": "2018-07-09T12:37:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25804#issuecomment-360081",
    "user": "https://github.com/rwst"
}
```

<a id='comment:2'></a>I don't run often `make ptestlong`. If this exists that long, though, it would happen here in less than 10% of runs.
