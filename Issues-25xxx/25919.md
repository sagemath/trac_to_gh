...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25919#issuecomment-401680",
    "user": "https://github.com/catch22"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25919#issuecomment-401681",
    "user": "https://github.com/catch22"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25919#event-340124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25919#event-340125"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25919#event-340126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25919",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25919#event-340127"
}
```
