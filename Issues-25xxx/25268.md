...
```json
{
    "body": "<a id='comment:1'></a>Fixed (and doctested) in the git branch I just uploaded at #6072. This ticket can be closed as duplicate when that gets merged.",
    "created_at": "2018-05-12T21:39:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25268#issuecomment-482477",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:1'></a>Fixed (and doctested) in the git branch I just uploaded at #6072. This ticket can be closed as duplicate when that gets merged.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25268#event-63363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25268#issuecomment-482478",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25268#issuecomment-482479",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25268#issuecomment-482480",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#6072\"",
    "created_at": "2018-05-12T22:01:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25268#issuecomment-482481",
    "user": "https://github.com/tscrim"
}
```

Changing dependencies from "" to "#6072"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25268#issuecomment-482482",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25268#issuecomment-482483",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25268",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25268#event-63364"
}
```
