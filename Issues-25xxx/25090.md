...
```json
{
    "body": "<a id='comment:27'></a>Replying to [gh-sebasguts](#comment%3A25):\n> Interesting. I will have a look.\n\n\nAny idea where the segfault appears?",
...
<a id='comment:27'></a>Replying to [gh-sebasguts](#comment%3A25):
> Interesting. I will have a look.
...
<a id='comment:34'></a>Replying to [Winfried](#comment%3A33):
> 
> 
> ```
> amb_space 0
...
<a id='comment:44'></a>Replying to [Winfried](#comment%3A43):
> I think the treatment of degenerate situations is o.k. now in normaliz. These minutes I am testing them on Qnormaliz. Once it is o.k., I will malke release 3.6.2.
