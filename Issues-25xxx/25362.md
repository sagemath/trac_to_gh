...
```json
{
    "body": "<a id='comment:2'></a>I agree. The code in `matrix_space.py` is really doing some kind of caching, where you want to optimize for the case that the object is in the cache.",
    "created_at": "2018-05-15T05:42:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376369",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:2'></a>I agree. The code in `matrix_space.py` is really doing some kind of caching, where you want to optimize for the case that the object is in the cache.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25362#event-63588"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376371",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>OK, that confirms what I thought. The basic observation mentioned in the ticket is true in one situation: in case of a miss, it's faster to check for the attribute first. However, for the code in question it's more important to optimize for the case of a hit, where try/except wins.\n\nWe're thankful to the reporter to look critically at the code. Doing so can uncover problems. In this case it didn't.\n\nIf additional data surfaces we can revert the status of this ticket.",
    "created_at": "2018-05-15T17:11:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376372",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:4'></a>OK, that confirms what I thought. The basic observation mentioned in the ticket is true in one situation: in case of a miss, it's faster to check for the attribute first. However, for the code in question it's more important to optimize for the case of a hit, where try/except wins.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376373",
...
```json
{
    "body": "<a id='comment:6'></a>Concerning the ticket, I don't understand why `__change_ring` is not created in the constructor of matrix spaces!\n\nAs for your comment, using `try/except` is much faster in case of success than a double lookup with `hasattr`.",
    "created_at": "2018-05-17T07:12:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376374",
    "user": "https://github.com/videlec"
}
```

<a id='comment:6'></a>Concerning the ticket, I don't understand why `__change_ring` is not created in the constructor of matrix spaces!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376375",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376376",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376377",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25362",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25362#issuecomment-376378",
    "user": "https://github.com/nbruin"
}
```
