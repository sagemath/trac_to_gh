...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25851#issuecomment-495811",
    "user": "https://github.com/ChukwuemezieChristopherAneke"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This looks like a duplicate of several other tickets. See #21479 (`./configure --prefix=...`), #21469 (enable `VPATH` builds), #21495 (`make install`), #21566. What parts of this ticket are not covered by those?",
    "created_at": "2018-07-12T19:14:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25851",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25851#issuecomment-495812",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:2'></a>This looks like a duplicate of several other tickets. See #21479 (`./configure --prefix=...`), #21469 (enable `VPATH` builds), #21495 (`make install`), #21566. What parts of this ticket are not covered by those?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25851",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25851#issuecomment-495813",
    "user": "https://github.com/ChukwuemezieChristopherAneke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25851",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25851#event-64665"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25851#event-64666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25851",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25851#issuecomment-495814",
