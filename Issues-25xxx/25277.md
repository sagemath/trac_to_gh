...
```json
{
    "body": "<a id='comment:11'></a>In[comment:6](#comment%3A6), is \"that\" referring to[comment:3](#comment%3A3) or this extra test?",
...
<a id='comment:11'></a>In[comment:6](#comment%3A6), is "that" referring to[comment:3](#comment%3A3) or this extra test?
