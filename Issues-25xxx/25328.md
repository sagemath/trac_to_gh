...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483757",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483758",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483759",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483760",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483761",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483762",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483763",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483764",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>From the point of view of regular distribution which build sage with the intent of installing things system wide this patch would be awful. It would result in the kernel being installed in a place not considered for installation. We definitely want a `sys.prefix` location. Using `ENV_JUPYTER_PATH` is admittedly problematic, I am not sure about a `JUPYTER_TARGET_DIR` approach.",
    "created_at": "2018-06-06T23:39:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483765",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:9'></a>From the point of view of regular distribution which build sage with the intent of installing things system wide this patch would be awful. It would result in the kernel being installed in a place not considered for installation. We definitely want a `sys.prefix` location. Using `ENV_JUPYTER_PATH` is admittedly problematic, I am not sure about a `JUPYTER_TARGET_DIR` approach.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483766",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Does nixos patch distutils to install stuff in non-standard locations?",
    "created_at": "2018-06-07T05:27:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483767",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>Does nixos patch distutils to install stuff in non-standard locations?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483769",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483770",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483771",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483772",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483773",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>I wouldn't assume that Sage really has a clean separation between `build` and `install`. I think it's safer to run only `install`, not `build`.",
    "created_at": "2018-06-08T14:53:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483774",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:18'></a>I wouldn't assume that Sage really has a clean separation between `build` and `install`. I think it's safer to run only `install`, not `build`.
...
```json
{
    "body": "<a id='comment:19'></a>See also #21507",
    "created_at": "2018-06-08T14:56:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483775",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:19'></a>See also #21507
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483776",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483777",
    "user": "https://github.com/timokau"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Replying to [gh-timokau](#comment%3A20):\n> Reading the `setup.py` does suggest that the kernel spec is installed in `install` though. The function is called in `sage_install`.\n\n\nYes, you are right.\n\nI think the issue might be confusion between the \"installation prefix\" and `sys.prefix` which may not be the same thing.",
    "created_at": "2018-06-08T15:12:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483778",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:22'></a>Replying to [gh-timokau](#comment%3A20):
> Reading the `setup.py` does suggest that the kernel spec is installed in `install` though. The function is called in `sage_install`.
...
```json
{
    "body": "<a id='comment:23'></a>I have an idea for solving this, hang on...",
    "created_at": "2018-06-08T15:22:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483779",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:23'></a>I have an idea for solving this, hang on...
...
```json
{
    "body": "<a id='comment:24'></a>See #25546",
    "created_at": "2018-06-08T17:52:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483780",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:24'></a>See #25546
...
```json
{
    "body": "<a id='comment:25'></a>So does #25546 fix your issue?",
    "created_at": "2018-06-14T14:13:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483781",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:25'></a>So does #25546 fix your issue?
...
```json
{
    "body": "<a id='comment:27'></a>For the record I move the kernel spec install to `sage_setup` which I neither install or doctest. Most the doctest in that files will fail on a system wide install because they try to touch files that don't belong to users. Those doctests would probably fail just the same for me.",
    "created_at": "2018-06-14T21:18:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483783",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:27'></a>For the record I move the kernel spec install to `sage_setup` which I neither install or doctest. Most the doctest in that files will fail on a system wide install because they try to touch files that don't belong to users. Those doctests would probably fail just the same for me.
...
```json
{
    "body": "<a id='comment:28'></a>`@`jdemeyer I opened a new ticket (#25722) to fix those issues by simply moving the test to a tmpdir. That in combination with your prefix-fix solves the problem for me (in a much better way than I did in this ticket). Thanks!\n\n`@`fbissey I'm not having any issues with tests trying to write where they shouldn't (anymore). I've recently upstreamed a few changes like #25357. Maybe you wouldn't have any problems anymore either if you'd try again now (or after the next sage release).",
    "created_at": "2018-06-30T20:22:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483784",
    "user": "https://github.com/timokau"
}
```

<a id='comment:28'></a>`@`jdemeyer I opened a new ticket (#25722) to fix those issues by simply moving the test to a tmpdir. That in combination with your prefix-fix solves the problem for me (in a much better way than I did in this ticket). Thanks!
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25328#event-63495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25328#issuecomment-483785",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25328",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25328#event-63496"
}
```
