...
Replying to [@timokau](https://github.com/sagemath/sage/issues/25328#comment:0):
> this patch changes the default behaviour from using a system directory to using a user directory
