...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|\n|[74173ec](https://git.sagemath.org/sage.git/commit/?id=74173ece9e67f7a313ac325b53bbd2822b0e96b5)|`should still set need_to_install_gcc=yes in configure if Sage's gcc is already installed`|\n|[2e31f57](https://git.sagemath.org/sage.git/commit/?id=2e31f57c5c9373cfdd5f8c0244827a58d4257ddf)|`build/make/Makefile should be rebuild with build/make/Makefile.in is updated`|\n|[755bc58](https://git.sagemath.org/sage.git/commit/?id=755bc58dc84de51847efaf966b0b5680721205ec)|`Reduce some unnecessary text duplication in the Makefile.`|\n|[dd19cc9](https://git.sagemath.org/sage.git/commit/?id=dd19cc95b96dda1646e582ab336ba647400565ce)|`Clean up a broken GCC in SAGE_LOCAL if it exists.`|\n|[d4d7f6d](https://git.sagemath.org/sage.git/commit/?id=d4d7f6de2fdbe3b248424ea3dcec44b249030dc4)|`Ensure that the gcc SPKG always checks for and cleans up a broken gcc if it exists`|",
    "created_at": "2018-07-13T15:49:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25011",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|\n|[9346272](https://git.sagemath.org/sage.git/commit/?id=9346272e366e12a48dc1bc559105db1d0679f442)|`should still set need_to_install_gcc=yes in configure if Sage's gcc is already installed`|\n|[363bc17](https://git.sagemath.org/sage.git/commit/?id=363bc17a2d5f7667a59ea062915cfc2d0b8fec18)|`build/make/Makefile should be rebuilt when build/make/Makefile.in is updated`|\n|[d8991c0](https://git.sagemath.org/sage.git/commit/?id=d8991c0110605066bc8483ef3a9ec3467fbbd287)|`Reduce some unnecessary text duplication in the Makefile.`|\n|[d3beac8](https://git.sagemath.org/sage.git/commit/?id=d3beac8151aabc931db7577d34225746913680a2)|`Clean up a broken GCC in SAGE_LOCAL if it exists.`|\n|[42153c1](https://git.sagemath.org/sage.git/commit/?id=42153c1f7ff4e89b981e14e81211b4a732bfb24f)|`Ensure that the gcc SPKG always checks for and cleans up a broken gcc if it exists`|",
    "created_at": "2018-07-18T10:05:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25011",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[1153d73](https://git.sagemath.org/sage.git/commit/?id=1153d736816dad8bb8368e6188636cb82502fcce)|`Reduce some unnecessary text duplication in the Makefile.`|\n|[1a6f7e5](https://git.sagemath.org/sage.git/commit/?id=1a6f7e5bebeafa39ac0977694bd864bad7e039d1)|`Clean up a broken GCC in SAGE_LOCAL if it exists.`|\n|[52ef4c9](https://git.sagemath.org/sage.git/commit/?id=52ef4c9cdd74390ecfb6b0c8d455c597f4612410)|`Ensure that the gcc SPKG always checks for and cleans up a broken gcc if it exists`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[1eb1f33](https://git.sagemath.org/sage.git/commit/?id=1eb1f332514617506fe3f97ce51b1b86a3bb01d4)|`fix a typo with wildcards and add some gcc-* executables to be removed`|\n|[68990b9](https://git.sagemath.org/sage.git/commit/?id=68990b96af2268ab2c9015741868a840bd69dd47)|`rather than try to make _clean-broken-gcc explicitly a prerequisite of spkg targets`|",
    "created_at": "2018-07-19T07:29:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25011",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:54'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[92fb34a](https://git.sagemath.org/sage.git/commit/?id=92fb34a66068bd4f1651412102c372e8c883754c)|`new configure tarball I guess`|",
...
```json
{
    "body": "<a id='comment:65'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[4e28d39](https://git.sagemath.org/sage.git/commit/?id=4e28d39d13b42bbcd1f93a49b144a9e422a25ef0)|`Reduce some unnecessary text duplication in the Makefile.`|\n|[458399b](https://git.sagemath.org/sage.git/commit/?id=458399b4850cf64b308eacafc4c00f1daba6f764)|`Clean up a broken GCC in SAGE_LOCAL if it exists.`|\n|[183f937](https://git.sagemath.org/sage.git/commit/?id=183f937f95c5eb8f1301e24cd63d9fe5ed80ba03)|`Ensure that the gcc SPKG always checks for and cleans up a broken gcc if it exists`|\n|[b32c73a](https://git.sagemath.org/sage.git/commit/?id=b32c73ab6b1bfe0f0db955b4d9fa4a743860fff3)|`fix a typo with wildcards and add some gcc-* executables to be removed`|\n|[eb96c97](https://git.sagemath.org/sage.git/commit/?id=eb96c972d2178bf49bcbe6c10c088c45bd093180)|`rather than try to make _clean-broken-gcc explicitly a prerequisite of spkg targets`|\n|[dc56a6c](https://git.sagemath.org/sage.git/commit/?id=dc56a6cb78c99ce633118748a4aeeab13e445530)|`new configure tarball I guess`|",
    "created_at": "2018-09-03T10:12:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25011",
    "type": "issue_comment",
