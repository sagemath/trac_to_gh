...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498901",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>On sage-devel the idea was raise of sorting  otherwise unordered objects also based on their hash (as opposed to their id).  This might be a nice semantic to add, where possible, since it will lead to a more deterministic (at within a given platform) sort.",
    "created_at": "2018-09-07T12:24:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498902",
    "user": "https://github.com/embray"
}
```

<a id='comment:3'></a>On sage-devel the idea was raise of sorting  otherwise unordered objects also based on their hash (as opposed to their id).  This might be a nice semantic to add, where possible, since it will lead to a more deterministic (at within a given platform) sort.
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498903",
...
```json
{
    "body": "<a id='comment:5'></a>This obviously is a useful change.\n\nPython2 compatibility is a wise behavior.\n\nI only deplore that we need to import a new module, even a small one ..",
    "created_at": "2018-12-13T17:17:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498904",
    "user": "https://trac.sagemath.org/admin/accounts/users/zerline"
}
```

<a id='comment:5'></a>This obviously is a useful change.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498905",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498908",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>``SafeSortable`` doesn't cause failures to build, just typesetting in math mode as you note, so that proposed change is cosmetic. The failures come from ```SafeSortable``s`: the second ```` is not recognized by Sphinx as ending a literal block: I'm guessing that Sphinx wants ```` to either be preceded by or followed by a space.\n\nBy the way, I also see a doctest failure:\n\n```\nRunning doctests with ID 2018-12-14-08-47-08-3b058240.\nGit branch: t/25981/misc/safe-sortable\nUsing --optional=dochtml,mpir,python2,sage\nDoctesting 1 file.\nsage -t --warn-long 51.0 src/sage/structure/misc.pyx\n**********************************************************************\nFile \"src/sage/structure/misc.pyx\", line 74, in sage.structure.misc.SafeSortable.lt\nFailed example:\n    SafeSortable.lt(1, 'a')\nExpected:\n    True\nGot:\n    False\n**********************************************************************\n1 item had failures:\n   1 of   3 in sage.structure.misc.SafeSortable.lt\n    [17 tests, 1 failure, 0.01 s]\n----------------------------------------------------------------------\nsage -t --warn-long 51.0 src/sage/structure/misc.pyx  # 1 doctest failed\n----------------------------------------------------------------------\nTotal time for all tests: 0.0 seconds\n    cpu time: 0.0 seconds\n```",
    "created_at": "2018-12-14T16:51:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498910",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:10'></a>``SafeSortable`` doesn't cause failures to build, just typesetting in math mode as you note, so that proposed change is cosmetic. The failures come from ```SafeSortable``s`: the second ```` is not recognized by Sphinx as ending a literal block: I'm guessing that Sphinx wants ```` to either be preceded by or followed by a space.
...
```json
{
    "body": "<a id='comment:11'></a>If you want to create the cross-references, you can use this change instead of my previous suggestion:\n\n```diff\ndiff --git a/src/sage/structure/misc.pyx b/src/sage/structure/misc.pyx\nindex c7e9808279..8217005fa6 100644\n--- a/src/sage/structure/misc.pyx\n+++ b/src/sage/structure/misc.pyx\n@@ -8,13 +8,14 @@ cdef class SafeSortable:\n     Wrapper for arbitrary objects allowing them to always be ordered in the\n     manner of Python 2.x objects.\n \n-    When comparing a `SafeSortable` to another `SafeSortable`, it first\n+    When comparing a :class:`SafeSortable` to another :class:`SafeSortable`, it first\n     attempts comparing their wrapped objects using the standard ``__lt__``\n     comparison.  If that fails, it falls back to comparing them by their type\n     name, then by their id, which is consistent with what Python 2.x does with\n     a pair of otherwise unorderable types.\n \n-    `SafeSortable`s may only be compared with other `SafeSortable`s.\n+    :class:`SafeSortable` objects may only be compared with other\n+    :class:`SafeSortable` objects.\n \n     EXAMPLES::\n \n```",
    "created_at": "2018-12-14T17:00:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498911",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:11'></a>If you want to create the cross-references, you can use this change instead of my previous suggestion:
...
```json
{
    "body": "<a id='comment:12'></a>Regarding the doctest failure, I get\n\n```\nsage: 1 < 'a'\nFalse\nsage: int(1) < 'a'\nTrue\n```\nDid you mean to use `int(1)` instead of 1?",
    "created_at": "2018-12-14T17:04:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498912",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:12'></a>Regarding the doctest failure, I get
...
```json
{
    "body": "<a id='comment:13'></a>`@`zerline: could you clarify why you gave this a positive review if the docs don't build and tests don't pass?",
    "created_at": "2018-12-14T17:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498913",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:13'></a>`@`zerline: could you clarify why you gave this a positive review if the docs don't build and tests don't pass?
...
```json
{
    "body": "<a id='comment:14'></a>It's not really clear to me what the use case of this `SafeSortable` would be. It seems to me that we should just avoid to compare uncomparable objects instead of making uncomparable objects comparable anyway.",
    "created_at": "2018-12-19T15:17:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498914",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:14'></a>It's not really clear to me what the use case of this `SafeSortable` would be. It seems to me that we should just avoid to compare uncomparable objects instead of making uncomparable objects comparable anyway.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498915",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498916",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>One other thing no one has pointed out though is that the \"Python 2 style comparison\" implemented here isn't actually quite correct.  I took the implementation from Python's [pprint](https://github.com/python/cpython/blob/1fb312ce1f147ea84ecb6f5993a20d1a85c53dc3/Lib/pprint.py#L72) module which implements a similar utility, but in pure Python, and not public API (as I explained in the ticket description).  However, it turns out the actual default comparison is a little more complex: https://github.com/python/cpython/blob/3752bc96c0ea1ecf28903cc34cdcd75c658e92ce/Objects/object.c#L767\n\nI think I may update this to something a bit closer to that.  It has the advantage of being deterministic, whereas the current implementation still relies on instance ids which is not ideal.",
    "created_at": "2018-12-20T10:23:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498918",
    "user": "https://github.com/embray"
}
```

<a id='comment:18'></a>One other thing no one has pointed out though is that the "Python 2 style comparison" implemented here isn't actually quite correct.  I took the implementation from Python's [pprint](https://github.com/python/cpython/blob/1fb312ce1f147ea84ecb6f5993a20d1a85c53dc3/Lib/pprint.py#L72) module which implements a similar utility, but in pure Python, and not public API (as I explained in the ticket description).  However, it turns out the actual default comparison is a little more complex: https://github.com/python/cpython/blob/3752bc96c0ea1ecf28903cc34cdcd75c658e92ce/Objects/object.c#L767
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498920",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>First a minor comment about the code: in comparison methods, you don't need to check the type of the first argument: it's `self` (and should be called `self` by PEP 8) and you know that it has the right class. Cython knows it too, so you don't need a `<SafeSortable>` cast.",
    "created_at": "2018-12-23T15:05:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498921",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:21'></a>First a minor comment about the code: in comparison methods, you don't need to check the type of the first argument: it's `self` (and should be called `self` by PEP 8) and you know that it has the right class. Cython knows it too, so you don't need a `<SafeSortable>` cast.
...
```json
{
    "body": "<a id='comment:22'></a>Now about using `SafeSortable`: I'm not convinced that it actually makes sense. If you just want to sort something for the user's convenience and nothing really depends on it, then it's fine: in the best case, it helps and in the worst case, you won't break anything.\n\nBut I wouldn't use `SafeSortable` for anything where the order really matters for an algorithm: the `try`/`except` style means that it's non-transitive (in that sense, it's worse than simply using `str` as sorting key).\n\nFalling back on things like `type()` and `id()` is also trying to force Python 2 sorting semantics in Python 3. I'm not sure that this is the right thing to do.",
    "created_at": "2018-12-23T15:13:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498922",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:22'></a>Now about using `SafeSortable`: I'm not convinced that it actually makes sense. If you just want to sort something for the user's convenience and nothing really depends on it, then it's fine: in the best case, it helps and in the worst case, you won't break anything.
...
```json
{
    "body": "<a id='comment:23'></a>Retargeting some of my tickets (somewhat optimistically for now).",
    "created_at": "2018-12-28T14:10:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498923",
    "user": "https://github.com/embray"
}
```

<a id='comment:23'></a>Retargeting some of my tickets (somewhat optimistically for now).
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64926"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64927"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Replying to [jhpalmieri](#comment%3A19):\n> The doctest may be system dependent. In unpatched Sage running Python 2, `1 < 'a'` returns `False` on several OS X machines.\n\n\nI already explained that it is, as well as the exact reason.",
    "created_at": "2018-12-31T12:57:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498924",
    "user": "https://github.com/embray"
}
```

<a id='comment:24'></a>Replying to [jhpalmieri](#comment%3A19):
> The doctest may be system dependent. In unpatched Sage running Python 2, `1 < 'a'` returns `False` on several OS X machines.
...
```json
{
    "body": "<a id='comment:26'></a>Moving all my in-progress tickets to 8.8 milestone.",
    "created_at": "2019-03-25T10:43:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498926",
    "user": "https://github.com/embray"
}
```

<a id='comment:26'></a>Moving all my in-progress tickets to 8.8 milestone.
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64928"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64929"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>Tickets still needing working or clarification should be moved to the next release milestone at the soonest (please feel free to revert if you think the ticket is close to being resolved).",
    "created_at": "2019-06-14T14:50:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498927",
    "user": "https://github.com/embray"
}
```

<a id='comment:27'></a>Tickets still needing working or clarification should be moved to the next release milestone at the soonest (please feel free to revert if you think the ticket is close to being resolved).
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64930"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64931"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64932"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498928",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64934"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64935"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498929",
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64936"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64937"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64938"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64939"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498930",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64940"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25981#issuecomment-498931",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64942"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64943"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64944"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64945"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64946"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25981#event-64947"
}
```
