...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496616",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496617",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496618",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496619",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496620",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496621",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496622",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Sure, points are *typically* normalized (over a field) so that the last coordinate is 1. But it is simple to create points where that is not true. So I don't think you should assume the points are normalized.\n\n```\nP.<x,y>=ProjectiveSpace(QQ,1)\nQ=P.point([1,2], False)\nQ\n```",
    "created_at": "2018-07-27T21:32:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496625",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:7'></a>Sure, points are *typically* normalized (over a field) so that the last coordinate is 1. But it is simple to create points where that is not true. So I don't think you should assume the points are normalized.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496626",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496627",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496628",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496629",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496630",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496631",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Made the minor changes we talked about, and also caught an error in handling the point at infinity in the preimage code. Also noticed some odd behavior (unrelated to this ticket):\n\n```\nsage: A.<z> = AffineSpace(QQ,1)\nsage: f = DynamicalSystem([z^2], A)\nsage: g = DynamicalSystem([1/z^2], A)\nsage: type(f[0].denominator())\n<type 'sage.rings.integer.Integer'>\nsage: type(g[0].denominator())\n<type 'sage.rings.polynomial.multi_polynomial_libsingular.MPolynomial_libsingular'>\n```\n\nNamely, we get back an int when 1 is in the denominator, and a poly when 1 is in the numerator. Not sure exactly where that is stemming from as of right now.",
    "created_at": "2018-08-08T07:00:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496632",
    "user": "https://github.com/Loops7"
}
```

<a id='comment:11'></a>Made the minor changes we talked about, and also caught an error in handling the point at infinity in the preimage code. Also noticed some odd behavior (unrelated to this ticket):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496633",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496635",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496636",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496637",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496639",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496641",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496642",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496643",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496644",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496645",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>The reason I had the bit about the irreducible element in there was because I figured these are technically examples instead of tests, so it would give some indication as to where the defining equation of the dynamical system came from, and that we actually need a field extension. \n\nI now remember why I removed the QQ case in the first place- it was because of the exact embedding inconsistency you pointed out, but I guess we can just return End(QQ)(1). \n\nAs far as the preimage parameter ordering, I initially did that to remain consistent with the other field_of_def methods, where `n` is the first parameter. It can be changed though. \n\n\n```\nsage: P.<x,y> = ProjectiveSpace(QQ, 1)\nsage: f = DynamicalSystem([1/3*x^3 + x*y^2, y^3], domain=P)\nsage: f.critical_points()\n[(1 : 0)]\nsage: N.<a> = f.field_of_definition_critical(); N\nNumber Field in a with defining polynomial x^2 + 1\nsage: g = f.change_ring(N)\nsage: g.critical_points()\n[(-a : 1), (a : 1), (1 : 0)]\n```\n\nDoes (1:0) have multiplicity 2 here, so that we satisfy the 2d-2 requirement? If so, why?",
    "created_at": "2018-08-16T04:50:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496647",
    "user": "https://github.com/Loops7"
}
```

<a id='comment:20'></a>The reason I had the bit about the irreducible element in there was because I figured these are technically examples instead of tests, so it would give some indication as to where the defining equation of the dynamical system came from, and that we actually need a field extension. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496649",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496650",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496651",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496652",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496654",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496655",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496656",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496657",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Looks good. Just made some minor doc updates. If you're fine with those, we can mark this positive.\n\n---\nNew commits:",
    "created_at": "2018-08-30T15:25:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496658",
    "user": "https://github.com/bhutz"
}
```

<a id='comment:28'></a>Looks good. Just made some minor doc updates. If you're fine with those, we can mark this positive.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496659",
    "user": "https://github.com/bhutz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496660",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496661",
    "user": "https://github.com/Loops7"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496662",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/25886#event-64736"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/25886",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/25886#issuecomment-496663",
    "user": "https://github.com/vbraun"
}
```
