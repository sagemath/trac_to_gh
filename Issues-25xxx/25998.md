...
<a id='comment:1'></a>Seems like a potentially good suggestion, but to clarify, do you think that this should be only in reference to docstrings containing LaTeX commands (the subsection linked in the description), or do you think it should be a universal recommendation for all docstrings?
