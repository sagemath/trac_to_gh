...
```json
{
    "body": "<a id='comment:1'></a>shorter title",
...
<a id='comment:1'></a>shorter title
...
```json
{
    "body": "<a id='comment:7'></a>By the way, several of us predicted this sort of situation (lots of broken doctests related to OEIS) in #16252.",
...
<a id='comment:7'></a>By the way, several of us predicted this sort of situation (lots of broken doctests related to OEIS) in #16252.
...
```json
{
    "body": "<a id='comment:16'></a>ok (but this will need to be done again and again...)",
...
<a id='comment:16'></a>ok (but this will need to be done again and again...)
