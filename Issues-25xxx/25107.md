...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[03d4f0f](https://git.sagemath.org/sage.git/commit/?id=03d4f0f074f6491f35abe580d8833779c7fa0089)|`Fix overly aggressive deleting of output temp file on Cygwin`|",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[85576e9](https://git.sagemath.org/sage.git/commit/?id=85576e961271144e698c07af810c4d3da465c137)|`add a more detailed comment`|",
