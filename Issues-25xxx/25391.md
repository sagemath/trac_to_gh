...
archive/attachments_021073.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "multiple_templates.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket25391/multiple_templates.patch",
...
archive/attachments_021074.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "crypt.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket25391/crypt.patch",
...
archive/attachments_021075.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "zzz_conf.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket25391/zzz_conf.patch",
    "created_at": "2018-05-18T15:05:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25391",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
archive/attachments_021076.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "python3-3.6.1.p1.log",
    "asset_url": "tarball://root/attachments/some-uuid/ticket25391/python3-3.6.1.p1.log",
...
archive/attachments_021077.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "crypt_debug.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket25391/crypt_debug.patch",
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "gdb_screenshot.png",
    "asset_url": "tarball://root/attachments/some-uuid/ticket25391/gdb_screenshot.png",
...
```json
{
    "body": "Screenshot of gdb's output",
    "created_at": "2018-06-21T13:45:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25391",
    "type": "issue_comment",
