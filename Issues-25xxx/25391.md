...
archive/attachments_021782.json:
```json
{
...
```json
{
    "body": "**Attachment:** [multiple_templates.patch](https://github.com/sagemath/sage/files/ticket25391/multiple_templates.patch)\n\nPython2 patch",
    "created_at": "2018-05-18T05:09:05Z",
    "issue": "https://github.com/sagemath/sage/issues/25391",
    "type": "issue_comment",
...
**Attachment:** [multiple_templates.patch](https://github.com/sagemath/sage/files/ticket25391/multiple_templates.patch)
...
archive/attachments_021783.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "packing.patch",
    "asset_url": "tarball://root/attachments/ticket25391/packing.patch",
    "created_at": "2018-05-18T05:09:27Z",
    "issue": "https://github.com/sagemath/sage/issues/25391",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket25391/packing.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/Vaush"
}
```
...
archive/attachments_021784.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [packing.patch](https://github.com/sagemath/sage/files/ticket25391/packing.patch)\n\n**Attachment:** [crypt.patch](https://github.com/sagemath/sage/files/ticket25391/crypt.patch)\n\nPython3 patch - 1 of 2",
    "created_at": "2018-05-18T05:09:27Z",
    "issue": "https://github.com/sagemath/sage/issues/25391",
    "type": "issue_comment",
...
**Attachment:** [packing.patch](https://github.com/sagemath/sage/files/ticket25391/packing.patch)
...
archive/attachments_021785.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [zzz_conf.patch](https://github.com/sagemath/sage/files/ticket25391/zzz_conf.patch)",
    "created_at": "2018-05-18T15:05:27Z",
    "issue": "https://github.com/sagemath/sage/issues/25391",
    "type": "issue_comment",
...
archive/attachments_021786.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_021787.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [crypt_debug.patch](https://github.com/sagemath/sage/files/ticket25391/crypt_debug.patch)",
    "created_at": "2018-06-21T08:31:54Z",
    "issue": "https://github.com/sagemath/sage/issues/25391",
    "type": "issue_comment",
...
**Attachment:** [crypt_debug.patch](https://github.com/sagemath/sage/files/ticket25391/crypt_debug.patch)
...
archive/attachments_021788.json:
```json
{
    "asset_content_type": "application/octet-stream",
