...
```json
{
    "body": "<a id='comment:49'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[2965003](https://git.sagemath.org/sage.git/commit/?id=2965003cb1fd4acecdd099ec876ff99069de2bc9)|`add vim modeline for this file`|\n|[9c1b4f6](https://git.sagemath.org/sage.git/commit/?id=9c1b4f6c24391f952c73783503a33eea0469fdc2)|`move this list into a TOOLCHAIN_DEPS variable we can use to inspect this list elsewhere`|\n|[311989d](https://git.sagemath.org/sage.git/commit/?id=311989deda9e285993f826239b098c35ae72da09)|`Add -k/--keep-existing to sage-spkg`|\n|[89205fe](https://git.sagemath.org/sage.git/commit/?id=89205fe53d870f30de59abc10afc5fff94b99cca)|`From <spkg>-clean targets in the Makefile, just remove the package's`|\n|[cdc6d70](https://git.sagemath.org/sage.git/commit/?id=cdc6d7056d07b127bc2100a64b05ffbead299a48)|`Use sage-spkg --keep-existing when installing/re-installing packages in`|\n|[0a2ab6a](https://git.sagemath.org/sage.git/commit/?id=0a2ab6a9f61e9da6477f096aa5a22685cc4813d7)|`Revert to using sage-spkg-uninstall in <spkg>-clean targets, but add a`|\n|[3cb9be7](https://git.sagemath.org/sage.git/commit/?id=3cb9be71e5aa428dc32c8b6d8ba578444536d343)|`make the toolchain dependency stamp files directly`|",
...
```json
{
    "body": "<a id='comment:50'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[2da7f8e](https://git.sagemath.org/sage.git/commit/?id=2da7f8e7ba0fd588bf3cff48b4c78798288e1f73)|`updated questionable comment; maybe a little better?`|",
...
```json
{
    "body": "<a id='comment:60'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|\n|[85a368f](https://git.sagemath.org/sage.git/commit/?id=85a368f2b4763f4721fb6541953573805cb4b14f)|`each of these templates should have an empty newline at the end to make them more readable when printed one after the other`|",
    "created_at": "2018-07-30T16:11:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25857",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:67'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|\n|[fb51d4e](https://git.sagemath.org/sage.git/commit/?id=fb51d4ef640bb74c3f8e09eb2c89da74fcc0e978)|`allow 'sage-spkg -k' to also be implied by setting the environment varible SAGE_SPKG_SKIP_UNINSTALL=yes`|",
