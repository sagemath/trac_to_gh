...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[86f3480](https://git.sagemath.org/sage.git/commit/?id=86f34801df1417955a444a5d96cecd910aa238fd)|`Better handling of missing directories when uninstalling broken packages`|\n|[7998223](https://git.sagemath.org/sage.git/commit/?id=799822347a94ae72fff36d2304f4719f91363ad2)|`Add the ability for packages to have a pre-uninstall script too.`|\n|[3a26636](https://git.sagemath.org/sage.git/commit/?id=3a26636649a77db34bc7db1856ec3f2da8f7a7bc)|`It seems the best way to handle notebook extensions is to disable them in a prerm script.`|\n|[dad9493](https://git.sagemath.org/sage.git/commit/?id=dad94938c71a1e8340247016d4ac36b9c891e870)|`These packages should have their versions bumped now that they require installing pre/post-uninstall scripts.`|\n|[12265b7](https://git.sagemath.org/sage.git/commit/?id=12265b7d694b5011e4e7b334d7d027ac8f4e98de)|`Move execution of spkg- scripts to a simple utility function, avoiding a bit of boilerplate`|\n|[b6859b1](https://git.sagemath.org/sage.git/commit/?id=b6859b1d36b123c8820eb58c5d43c1e4f69cf3c0)|`Read the path to SAGE_SPKG_INST from the environment if possible; otherwise use the hard-coded default path`|\n|[281ce23](https://git.sagemath.org/sage.git/commit/?id=281ce2334b284e7aa8dcd94e4b02728da944f822)|`similarly, this variable should be read out of the environment if possible`|\n|[c7542de](https://git.sagemath.org/sage.git/commit/?id=c7542de0857b29cdcfb909af98aee8044e0a1c7a)|`Add a 'verbose' flag, and changed some informative output messages to stdout instead of stderr`|\n|[ee018bd](https://git.sagemath.org/sage.git/commit/?id=ee018bd5639bc1da753e5535cef89e7512dc27fe)|`Simplify directory removal`|\n|[20a57d4](https://git.sagemath.org/sage.git/commit/?id=20a57d430fd8bb9591dc47d4f8a317d95b23abf1)|`use brial as an example of splitting an spkg-legacy-uninstall script out from an spkg-install`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|\n|[213c039](https://git.sagemath.org/sage.git/commit/?id=213c039b389fb4a02e1be01a790c339d238bb1f4)|`These packages should have their versions bumped now that they require installing pre/post-uninstall scripts.`|\n|[1331c73](https://git.sagemath.org/sage.git/commit/?id=1331c7315d8e8ea56047f14177d660c4b064ee22)|`Move execution of spkg- scripts to a simple utility function, avoiding a bit of boilerplate`|\n|[6c61d68](https://git.sagemath.org/sage.git/commit/?id=6c61d68af788147d943a30b981b00918617d1606)|`Read the path to SAGE_SPKG_INST from the environment if possible; otherwise use the hard-coded default path`|\n|[654456d](https://git.sagemath.org/sage.git/commit/?id=654456da47dff1b1bb8a5005cd9a8d4faf8ac7bd)|`similarly, this variable should be read out of the environment if possible`|\n|[760d98b](https://git.sagemath.org/sage.git/commit/?id=760d98be4136f8ace609f5e4568cc1bb1fa74403)|`Add a 'verbose' flag, and changed some informative output messages to stdout instead of stderr`|\n|[7597001](https://git.sagemath.org/sage.git/commit/?id=7597001a8ab7f647426bb113f219d963939bec9d)|`Simplify directory removal`|\n|[9d76043](https://git.sagemath.org/sage.git/commit/?id=9d76043bc430f17f38b13379c3efe1e7f277bc28)|`use brial as an example of splitting an spkg-legacy-uninstall script out from an spkg-install`|\n|[554d47a](https://git.sagemath.org/sage.git/commit/?id=554d47a94d1cb56cd3b974f3a8f77906759a3250)|`remove this TODO comment--I have opened an issue for this task at #25202`|\n|[3f528d8](https://git.sagemath.org/sage.git/commit/?id=3f528d8914c8a540a9c33ef7e525a2315ba7049e)|`Use appropariate sage-dist-helpers in the pkg-config postinst script`|\n|[8470eba](https://git.sagemath.org/sage.git/commit/?id=8470ebafa1b8a8e00b34409b2d14ec57843792e7)|`Better error handling with spkg-prerm exits with an error (before it would have just had an unhandled exception and dumped a traceback)`|",
    "created_at": "2018-04-18T09:37:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25139",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[95ed45e](https://git.sagemath.org/sage.git/commit/?id=95ed45ec061424d4708e724c425565e48faa479e)|`minor correction to comment`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|\n|[db87c9b](https://git.sagemath.org/sage.git/commit/?id=db87c9b167a683719fc44aaa445aa9e80b4f3e60)|`These packages should have their versions bumped now that they require installing pre/post-uninstall scripts.`|\n|[bf535f6](https://git.sagemath.org/sage.git/commit/?id=bf535f6cac0db00915145a42c2cb388a55e13abd)|`Move execution of spkg- scripts to a simple utility function, avoiding a bit of boilerplate`|\n|[82b7be5](https://git.sagemath.org/sage.git/commit/?id=82b7be501e4524a304145614adb3aafb5549ebc4)|`Read the path to SAGE_SPKG_INST from the environment if possible; otherwise use the hard-coded default path`|\n|[ec074d6](https://git.sagemath.org/sage.git/commit/?id=ec074d6d827e3b74aae4e5b66e078ea61dba6caa)|`similarly, this variable should be read out of the environment if possible`|\n|[bbdb221](https://git.sagemath.org/sage.git/commit/?id=bbdb221ffea937c11be160ba231c58d266bff50e)|`Add a 'verbose' flag, and changed some informative output messages to stdout instead of stderr`|\n|[c17b46d](https://git.sagemath.org/sage.git/commit/?id=c17b46d7278383f11146aab5a6449ecb3f8fa915)|`Simplify directory removal`|\n|[8907458](https://git.sagemath.org/sage.git/commit/?id=89074580d748e1b77ca2fe615bc16d26ae0c6d83)|`use brial as an example of splitting an spkg-legacy-uninstall script out from an spkg-install`|\n|[98a1f8d](https://git.sagemath.org/sage.git/commit/?id=98a1f8d497e92d48462d0c3d11cb2250a71a1aa7)|`Use appropariate sage-dist-helpers in the pkg-config postinst script`|\n|[8f500c6](https://git.sagemath.org/sage.git/commit/?id=8f500c67e6366a8ff2ce8272effae9f0630855aa)|`Better error handling with spkg-prerm exits with an error (before it would have just had an unhandled exception and dumped a traceback)`|\n|[d364c6c](https://git.sagemath.org/sage.git/commit/?id=d364c6c1bcb9d21778917337e2f71cd0baeb7f3e)|`minor correction to comment`|",
    "created_at": "2018-04-26T09:13:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25139",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|\n|[2faf376](https://git.sagemath.org/sage.git/commit/?id=2faf376be96debe4a13b51e9452bcaf4b6722b34)|`These packages should have their versions bumped now that they require installing pre/post-uninstall scripts.`|\n|[55c21de](https://git.sagemath.org/sage.git/commit/?id=55c21de8236dd331ed110b3befb5f57732ad38d1)|`Move execution of spkg- scripts to a simple utility function, avoiding a bit of boilerplate`|\n|[ce6c825](https://git.sagemath.org/sage.git/commit/?id=ce6c8258bb53b1d0d3fa954495035b201db677e5)|`Read the path to SAGE_SPKG_INST from the environment if possible; otherwise use the hard-coded default path`|\n|[8c2ae0c](https://git.sagemath.org/sage.git/commit/?id=8c2ae0c81d7fda5054abea60e9ef5833abe7680a)|`similarly, this variable should be read out of the environment if possible`|\n|[ac5f16d](https://git.sagemath.org/sage.git/commit/?id=ac5f16d1099f0f8599e387a25d6dcc4f04619cc8)|`Add a 'verbose' flag, and changed some informative output messages to stdout instead of stderr`|\n|[a31606d](https://git.sagemath.org/sage.git/commit/?id=a31606d1220b53738ae44fd671c4f381d56ba96e)|`Simplify directory removal`|\n|[886b7cb](https://git.sagemath.org/sage.git/commit/?id=886b7cb069a6ed0b5dffce9794365cc28acbaff6)|`use brial as an example of splitting an spkg-legacy-uninstall script out from an spkg-install`|\n|[a2f189b](https://git.sagemath.org/sage.git/commit/?id=a2f189bfb1e892439795012ac1fdba47114cc8db)|`Use appropariate sage-dist-helpers in the pkg-config postinst script`|\n|[2c2152d](https://git.sagemath.org/sage.git/commit/?id=2c2152dd15eb7c66a8fbb461f4536531d553207a)|`Better error handling with spkg-prerm exits with an error (before it would have just had an unhandled exception and dumped a traceback)`|\n|[1c8fca3](https://git.sagemath.org/sage.git/commit/?id=1c8fca3598b4978b0e5a28a391d7f5b4e39fbead)|`minor correction to comment`|",
    "created_at": "2018-04-26T10:05:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25139",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. Last 10 new commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[45e39e5](https://git.sagemath.org/sage.git/commit/?id=45e39e5708480225300e020d53d8e40251508d31)|`Add the ability for packages to have a pre-uninstall script too.`|\n|[c167505](https://git.sagemath.org/sage.git/commit/?id=c1675051f826f24e8e2282ab88dac2b540e22185)|`Move execution of spkg- scripts to a simple utility function, avoiding a bit of boilerplate`|\n|[df2af7d](https://git.sagemath.org/sage.git/commit/?id=df2af7dcb77ba133d65a5a0a20e11cd5d075e300)|`Read the path to SAGE_SPKG_INST from the environment if possible; otherwise use the hard-coded default path`|\n|[d720715](https://git.sagemath.org/sage.git/commit/?id=d7207157e13c160668dcc22a33c9601638b84891)|`similarly, this variable should be read out of the environment if possible`|\n|[4721f40](https://git.sagemath.org/sage.git/commit/?id=4721f40ad3d59d85938326b55f3b13a01792c1a0)|`Add a 'verbose' flag, and changed some informative output messages to stdout instead of stderr`|\n|[700f764](https://git.sagemath.org/sage.git/commit/?id=700f7645a7ad909dc67f58e8caec565ca3387665)|`Simplify directory removal`|\n|[f2ef70e](https://git.sagemath.org/sage.git/commit/?id=f2ef70eed3cddd39093fa77d5e906721f420128e)|`use brial as an example of splitting an spkg-legacy-uninstall script out from an spkg-install`|\n|[e8d06a5](https://git.sagemath.org/sage.git/commit/?id=e8d06a5ceb9e53efe8ccc55736f8b7ab04e2bffe)|`Use appropariate sage-dist-helpers in the pkg-config postinst script`|\n|[10def6c](https://git.sagemath.org/sage.git/commit/?id=10def6cce0cbfd52a6a792beb978aa0051880df1)|`Better error handling with spkg-prerm exits with an error (before it would have just had an unhandled exception and dumped a traceback)`|\n|[7a81e70](https://git.sagemath.org/sage.git/commit/?id=7a81e70eaebb7ec27f48614ab5232d7fccff4b74)|`minor correction to comment`|",
    "created_at": "2018-05-21T11:55:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25139",
    "type": "issue_comment",
