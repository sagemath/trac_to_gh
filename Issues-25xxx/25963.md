...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25963#issuecomment-402252",
    "user": "https://github.com/annapuskas"
}
```
...
```json
{
    "body": "Attachment [rank_two_correction_factors.py](https://github.com/sagemath/sage/files/ticket25963/rank_two_correction_factors.py) by @annapuskas created at 2018-07-27 21:07:47\n\nImplements correction factor in hyperbolic type beyond rank two.",
    "created_at": "2018-07-27T21:07:47Z",
    "issue": "https://github.com/sagemath/sage/issues/25963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25963#issuecomment-402253",
    "user": "https://github.com/annapuskas"
}
```

Attachment [rank_two_correction_factors.py](https://github.com/sagemath/sage/files/ticket25963/rank_two_correction_factors.py) by @annapuskas created at 2018-07-27 21:07:47
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [hyperbolic_correction_factors.py](https://github.com/sagemath/sage/files/ticket25963/hyperbolic_correction_factors.py) by @tscrim created at 2018-07-30 07:35:49",
    "created_at": "2018-07-30T07:35:49Z",
    "issue": "https://github.com/sagemath/sage/issues/25963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25963#issuecomment-402254",
    "user": "https://github.com/tscrim"
}
```
