...
```json
{
    "body": "<a id='comment:3'></a>No idea how to deal with giac...",
...
<a id='comment:3'></a>No idea how to deal with giac...
...
```json
{
    "body": "<a id='comment:5'></a>Bernard Parisse, the main developer of Giac, tells me the Lambert W function\nis not implemented in Giac at this point.",
    "created_at": "2018-08-05T10:17:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25987",
    "type": "issue_comment",
...
<a id='comment:5'></a>Bernard Parisse, the main developer of Giac, tells me the Lambert W function
is not implemented in Giac at this point.
...
```json
{
    "body": "<a id='comment:6'></a>OK, so could you review this ticket for the FriCAS part?",
...
<a id='comment:6'></a>OK, so could you review this ticket for the FriCAS part?
...
```json
{
    "body": "<a id='comment:7'></a>branch does not apply",
    "created_at": "2018-08-20T18:37:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25987",
    "type": "issue_comment",
...
<a id='comment:7'></a>branch does not apply
...
<a id='comment:12'></a>sorry about that, Frédéric...
...
```json
{
    "body": "<a id='comment:13'></a>the \"long\" is because pyflakes is running python3..",
...
<a id='comment:13'></a>the "long" is because pyflakes is running python3..
...
```json
{
    "body": "<a id='comment:20'></a>I'm sorry Frederic, I forgot another one...",
...
<a id='comment:20'></a>I'm sorry Frederic, I forgot another one...
