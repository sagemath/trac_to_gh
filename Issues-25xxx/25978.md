...
```json
{
    "body": "<a id='comment:2'></a>\nThe issue here is that `terms` can be `None` while `total` is an integer, and then Python 3 objects to `if terms > total:`.\n\n---\nNew commits:\n|                                                                                                                                          |                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|\n|[d8f9668](https://git.sagemath.org/sage.git/commit?id=d8f9668efec431c33593f7490a78e22f6a8ebfd9)|`trac 25978: don't try to compare None with an int`|",
    "created_at": "2018-07-30T21:20:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25978",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[4a6ff4e](https://git.sagemath.org/sage.git/commit/?id=4a6ff4e6c396231908bd58758e46a9f0bb24dae2)|`trac 25978: add comment explaining the change.`|",
