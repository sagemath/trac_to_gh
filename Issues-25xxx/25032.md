...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25032#event-328158"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25032#event-328159"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25032#event-328160"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25032#event-328161"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25032#issuecomment-384089",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25032",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25032#issuecomment-384090",
    "user": "https://github.com/vbraun"
}
```
