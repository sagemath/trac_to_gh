...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25933#issuecomment-401985",
    "user": "https://github.com/rkingan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25933#issuecomment-401986",
    "user": "https://github.com/rkingan"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25933#event-340281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25933#event-340282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25933#event-340283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25933#event-340284"
}
```
