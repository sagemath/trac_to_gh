...
```json
{
    "body": "<a id='comment:17'></a>\nNew commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[cdae633](https://git.sagemath.org/sage.git/commit?id=cdae633438c433616a4ae8760663e09365ad24ac)|`Trac #25626: Add doctest for integrating exp(t)/(t + 1)^2 with giac`|",
