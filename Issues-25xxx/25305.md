...
<a id='comment:14'></a>Replying to [vdelecroix](#comment%3A10): 
> Actually, I think that all the `has_xxx` stuff would better be features.
...
<a id='comment:15'></a>Replying to [slabbe](#comment%3A14):
> Replying to [vdelecroix](#comment%3A10): 
> > Actually, I think that all the `has_xxx` stuff would better be features.
