...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387396",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket25173/sl3webs.sage",
    "created_at": "2018-05-23T11:05:26Z",
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket25173/sl3webs.sage",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [sl3webs.sage](https://github.com/sagemath/sage/files/ticket25173/sl3webs.sage) by @mantepse created at 2018-05-23 11:05:26\n\nPlease be warned that this code was written for personal usage...\n\nI also have an implementation for Judith's SO(3) algorithm, but this will soon be obsolete.",
    "created_at": "2018-05-23T11:05:26Z",
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387397",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387398",
    "user": "https://github.com/BruceWestbury"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387399",
    "user": "https://github.com/mantepse"
}
```
