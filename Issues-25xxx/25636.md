...
```json
{
    ...
    "url": "https://github.com/sagemath/sage/issues/25636",
...
```json
{
    ...
    "created_at": "2018-06-22T20:20:01Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "milestone_number": null,
    "milestone_title": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354562"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354563"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354564"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354565"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393715",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393716",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354567"
}
```
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "title_is": "ECL crashes in integration",
    "title_was": "Detected access to protected memory, also kwown as 'bus or segmentation fault'",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393718",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393719",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393720",
...
```json
{
    "body": "<div id=\"comment:7\" align=\"right\">comment:7</div>\n\n\"For all these integrals, the right place to report them is really maxima.\"\n\nHello;\n\nBut when I try the integral directly into Maxima 5.41.0, with lisp ECL 16.1.2, on the same Linux box (Manjora 17.1), Maxima does not crash. \n\nIt hanged for long time thinking, so I ended terminating the command eventually. But it did not crash or even give an error.\n\nOnly when called from [SageMath](../wiki/SageMath), there is a crash and it happens very quickly after the call. \n\nMay be [SageMath](../wiki/SageMath) is using different Maxima version. I do not know.  I do not know how Sage communicate with Maxima, or what version of Maxima sage uses. I assumed it is the same as the Maxima installed on same Linux box, or may be Sage is just linked to a Maxima .so lib\n\nIf I report this problem to Maxima, they could tell me that it does not crash in Maxima, which is true, and to report it to [SageMath](../wiki/SageMath).\n\nThank you for looking at this.",
    "created_at": "2018-06-23T17:41:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393721",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393722",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393723",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Attachment: **[sagemath.txt](https://github.com/sagemath/sage/files/ticket25636/sagemath.txt)**\n\nsage math build log file",
    "created_at": "2018-06-23T23:56:15Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393724",
    "user": "https://github.com/nasser1"
}
```

Attachment: **[sagemath.txt](https://github.com/sagemath/sage/files/ticket25636/sagemath.txt)**
...
```json
{
    "body": "<div id=\"comment:10\" align=\"right\">comment:10</div>\n\nHello;\n\nI see. Thanks for the explanation. I now typed these commands you gave above, into my Maxima\n\n```\nbesselexpand : true;\ndisplay2d : false;\ndomain : complex;\nkeepfloat : true;\nload(to_poly_solve);\nload(simplify_sum);\nload(abs_integrate);\nload(diag);\nintegrate(x^m/sqrt(a + b*x^(2 - m)),x);\n```\n\nbut it did NOT crash. It is just sitting there for last 15 minutes thinking. No errors or anything. \n\nSo the difference seems to be in the LISP used. You seem to be using Maxima 5.41.0 using Lisp SBCL 1.4.2-1.fc27 while the Maxima I have is Maxima 5.41.0, with lisp ECL 16.1.2. (I assume that the Maxima I have on Linux got installed when I installed [SageMath](../wiki/SageMath)? I do not know. Since I myself did not install Maxima explicitly myself. I just installed Linux Manjaro, followed by installing [SageMath](../wiki/SageMath) using Majaro pacman, which complied everything from source. The log file for the the build of [SageMath](../wiki/SageMath) is a attached FYI. (this was for sage 8.3 beta5, since then I now updated to sage 8.3 beta 6, but I only kept the log file for the build for beta5, but it should be similar)\n\n\n\nThank you\n\n--Nasser",
    "created_at": "2018-06-23T23:56:55Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393725",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393726",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393727",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393728",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393729",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393730",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393731",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393732",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393733",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393734",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393735",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393736",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "Changed keywords from **integrate** to **integrate, segfault**",
    "created_at": "2018-07-11T18:10:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393737",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393738",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393739",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393740",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393741",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393742",
...
```json
{
    ...
    "milestone_title": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354571"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354572"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354573"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354574"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393743",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393744",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393745",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-393746",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354575"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354576"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354577"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354578"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354579"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-354580"
}
```
