...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396264",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396265",
...
archive/attachments_021797.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "t",
    "asset_url": "tarball://root/attachments/ticket25636/t",
    "created_at": "2018-06-23T15:51:21Z",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket25636/t",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227573"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227574"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396267",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396268",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396269",
...
```json
{
    "body": "<a id='comment:7'></a>\n\"For all these integrals, the right place to report them is really maxima.\"\n\nHello;\n\nBut when I try the integral directly into Maxima 5.41.0, with lisp ECL 16.1.2, on the same Linux box (Manjora 17.1), Maxima does not crash. \n\nIt hanged for long time thinking, so I ended terminating the command eventually. But it did not crash or even give an error.\n\nOnly when called from [SageMath](../wikis/SageMath), there is a crash and it happens very quickly after the call. \n\nMay be [SageMath](../wikis/SageMath) is using different Maxima version. I do not know.  I do not know how Sage communicate with Maxima, or what version of Maxima sage uses. I assumed it is the same as the Maxima installed on same Linux box, or may be Sage is just linked to a Maxima .so lib\n\nIf I report this problem to Maxima, they could tell me that it does not crash in Maxima, which is true, and to report it to [SageMath](../wikis/SageMath).\n\nThank you for looking at this.",
    "created_at": "2018-06-23T17:41:47Z",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396270",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396271",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396272",
    "user": "https://github.com/nbruin"
}
```
...
archive/attachments_021798.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sagemath.txt",
    "asset_url": "tarball://root/attachments/ticket25636/sagemath.txt",
    "created_at": "2018-06-23T23:56:15Z",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket25636/sagemath.txt",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396273",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>\nHello;\n\nI see. Thanks for the explanation. I now typed these commands you gave above, into my Maxima\n\n```\nbesselexpand : true;\ndisplay2d : false;\ndomain : complex;\nkeepfloat : true;\nload(to_poly_solve);\nload(simplify_sum);\nload(abs_integrate);\nload(diag);\nintegrate(x^m/sqrt(a + b*x^(2 - m)),x);\n```\n\nbut it did NOT crash. It is just sitting there for last 15 minutes thinking. No errors or anything. \n\nSo the difference seems to be in the LISP used. You seem to be using Maxima 5.41.0 using Lisp SBCL 1.4.2-1.fc27 while the Maxima I have is Maxima 5.41.0, with lisp ECL 16.1.2. (I assume that the Maxima I have on Linux got installed when I installed [SageMath](../wikis/SageMath)? I do not know. Since I myself did not install Maxima explicitly myself. I just installed Linux Manjaro, followed by installing [SageMath](../wikis/SageMath) using Majaro pacman, which complied everything from source. The log file for the the build of [SageMath](../wikis/SageMath) is a attached FYI. (this was for sage 8.3 beta5, since then I now updated to sage 8.3 beta 6, but I only kept the log file for the build for beta5, but it should be similar)\n\n\n\nThank you\n\n--Nasser",
    "created_at": "2018-06-23T23:56:55Z",
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396274",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396275",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396276",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396277",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396278",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396279",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396280",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396281",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396282",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396283",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396284",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396285",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396286",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396287",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396288",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396289",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396290",
    "user": "https://github.com/nasser1"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396291",
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227576"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227577"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227578"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227579"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396292",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396293",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396294",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25636#issuecomment-396295",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227580"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227581"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227582"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227583"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227584"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25636#event-227585"
}
```
