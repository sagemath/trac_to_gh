...
<a id='comment:7'></a>Overall looks good, but I have a few comments:
...
```json
{
    "body": "<a id='comment:10'></a>done in 60dd2df",
...
<a id='comment:10'></a>done in 60dd2df
...
<a id='comment:11'></a>Trivial fixes needed (see patchbot report)
...
```json
{
    "body": "<a id='comment:13'></a>needs review again!",
...
<a id='comment:13'></a>needs review again!
...
```json
{
    "body": "<a id='comment:14'></a>Thank you. LGTM.",
    "created_at": "2018-08-23T22:47:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/25514",
    "type": "issue_comment",
...
<a id='comment:14'></a>Thank you. LGTM.
...
<a id='comment:16'></a>Segfaults on linux 32-bit:
...
```json
{
    "body": "<a id='comment:17'></a>I am very sorry about that. Nothing to do with 32 bits. I messed up with memory allocation...\n\n---\nNew commits:",
...
<a id='comment:17'></a>I am very sorry about that. Nothing to do with 32 bits. I messed up with memory allocation...
