...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25983#issuecomment-402691",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25983#issuecomment-402692",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25983#event-340873"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25983#event-340874"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25983#event-340875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25983",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25983#event-340876"
}
```
