...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-348256"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-348257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-348258"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-348259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-384556",
    "user": "https://github.com/sagetrac-sanketh"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-384557",
    "user": "https://github.com/sagetrac-sanketh"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-348260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-348261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-384558",
    "user": "https://github.com/sagetrac-sanketh"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-384559",
    "user": "https://github.com/sagetrac-sanketh"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-348262"
}
```
