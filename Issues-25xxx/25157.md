...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-330202"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-330203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-330204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-330205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-387247",
    "user": "https://github.com/sagetrac-sanketh"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-387248",
    "user": "https://github.com/sagetrac-sanketh"
}
```
