...
```json
{
    "body": "Changed keywords from **** to **relative number fields, abelian extensions, class field theory**",
    "created_at": "2018-04-12T19:25:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
...
Changed keywords from **** to **relative number fields, abelian extensions, class field theory**
