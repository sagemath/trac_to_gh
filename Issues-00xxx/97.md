...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/97",
...
```json
{
    "body": "<a id='comment:1'></a>This is not a problem in sage-1.6 anymore. \n\nWilliam",
    "created_at": "2007-01-13T01:51:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/97",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/97#issuecomment-460",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This is not a problem in sage-1.6 anymore. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/97",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/97#issuecomment-461",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/97",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/97#event-196"
}
```
