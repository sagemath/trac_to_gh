...
<a id='comment:1'></a>From one of the IML authors:
...
```json
{
    "body": "<a id='comment:3'></a>There is movement on the IML front and there will be a 1.0.2 release shortly. Currently there is some discussion what patches need to go in.\n\nCheers,\n\nMichael",
...
<a id='comment:3'></a>There is movement on the IML front and there will be a 1.0.2 release shortly. Currently there is some discussion what patches need to go in.
...
```json
{
    "body": "<a id='comment:4'></a>There is a new spkg with the 1.0.1->1.0.2 diff at\n\nhttp://sage.math.washington.edu/home/mabshoff/iml-1.0.1.p7.spkg\n\nCheers,\n\nMichael",
...
<a id='comment:4'></a>There is a new spkg with the 1.0.1->1.0.2 diff at
