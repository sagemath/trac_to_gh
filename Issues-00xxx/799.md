...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/799#issuecomment-5211",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/799#issuecomment-5212",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac799-part2.patch](tarball://root/attachments/some-uuid/ticket799/trac799-part2.patch) by @williamstein created at 2007-12-02 06:09:17",
    "created_at": "2007-12-02T06:09:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/799#issuecomment-5213",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Attachment [trac799-part2.patch](tarball://root/attachments/some-uuid/ticket799/trac799-part2.patch) by @williamstein created at 2007-12-02 06:09:17
...
```json
{
    "body": "<a id='comment:3'></a>These patches are definitely an improvement, and should go in.\n\nThere's still some more work to be done (documentation at least, perhaps some code too) to be able to use the full power of tachyon (like texture maps); but that can wait for later.",
    "created_at": "2007-12-02T07:19:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/799#issuecomment-5214",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:3'></a>These patches are definitely an improvement, and should go in.
...
```json
{
    "body": "<a id='comment:4'></a>Merged in 2.8.15.alpha2.",
    "created_at": "2007-12-02T07:23:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/799#issuecomment-5215",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Merged in 2.8.15.alpha2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/799#issuecomment-5216",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
