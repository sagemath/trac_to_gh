...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/799#issuecomment-3629",
    "user": "https://github.com/williamstein"
}
```
...
archive/attachments_000476.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac799-part1.patch",
    "asset_url": "tarball://root/attachments/ticket799/trac799-part1.patch",
    "created_at": "2007-12-02T06:05:24Z",
    "issue": "https://github.com/sagemath/sage/issues/799",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket799/trac799-part1.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [trac799-part1.patch](https://github.com/sagemath/sage/files/ticket799/trac799-part1.patch) by @williamstein created at 2007-12-02 06:05:24",
    "created_at": "2007-12-02T06:05:24Z",
    "issue": "https://github.com/sagemath/sage/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/799#issuecomment-3630",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac799-part1.patch](https://github.com/sagemath/sage/files/ticket799/trac799-part1.patch) by @williamstein created at 2007-12-02 06:05:24
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/799#event-3697"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/799#event-3698"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac799-part2.patch",
    "asset_url": "tarball://root/attachments/ticket799/trac799-part2.patch",
    "created_at": "2007-12-02T06:09:17Z",
    "issue": "https://github.com/sagemath/sage/issues/799",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket799/trac799-part2.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac799-part2.patch](https://github.com/sagemath/sage/files/ticket799/trac799-part2.patch) by @williamstein created at 2007-12-02 06:09:17",
    "created_at": "2007-12-02T06:09:17Z",
    "issue": "https://github.com/sagemath/sage/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/799#issuecomment-3631",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/799#event-3699"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/799#issuecomment-3632",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/799",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/799#issuecomment-3633",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/799#event-3700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/799",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/799#event-3701"
}
```
