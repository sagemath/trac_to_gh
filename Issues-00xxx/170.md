...
{
    "assignees": [],
    "body": "\n\nComponent: **basic arithmetic**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/170_\n\n",
    ...
    "title": "QQ('1/0')",
    "type": "issue",
    "updated_at": "2007-01-13T01:33:51Z",
    "url": "https://github.com/sagemath/sage/issues/170",
...
```json
{
    ...
    "created_at": "2006-11-28T21:41:04Z",
    "event": "labeled",
    "issue": "https://github.com/sagemath/sage/issues/170",
    "label": "https://github.com/sagemath/sage/labels/c%3A%20basic%20arithmetic",
    "label_color": "0000ff",
    "label_name": "c: basic arithmetic",
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/170#event-1206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/170#event-1207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/170#event-1208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/170#issuecomment-537",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/170",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/170#event-1209"
}
```
