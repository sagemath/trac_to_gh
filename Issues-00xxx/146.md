...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/146#issuecomment-731",
    "user": "https://trac.sagemath.org/admin/accounts/users/justin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Deprecated this to an experimental package.  We shouldn't be supporting this...",
    "created_at": "2007-01-12T23:38:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/146#issuecomment-732",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Deprecated this to an experimental package.  We shouldn't be supporting this...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/146#issuecomment-733",
    "user": "https://github.com/williamstein"
}
```
