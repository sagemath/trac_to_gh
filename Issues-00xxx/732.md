...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/732#issuecomment-4443",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This works now that vertices() sorts the vertices it returns (as of 2.8.6, I believe).",
    "created_at": "2007-10-13T16:58:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/732#issuecomment-4444",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>This works now that vertices() sorts the vertices it returns (as of 2.8.6, I believe).
