...
```json
{
    "body": "<a id='comment:1'></a>I've confirmed that this bug occurs.",
    "created_at": "2007-03-22T02:39:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/328#issuecomment-1723",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>I've confirmed that this bug occurs.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/328#issuecomment-1724",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/328#issuecomment-1726",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/328#issuecomment-1727",
    "user": "https://github.com/fchapoton"
}
```
