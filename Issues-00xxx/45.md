...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-347"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-350"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/45",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/45#issuecomment-196",
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-351"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/45",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-352"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/45",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/45#issuecomment-197",
    "user": "https://github.com/williamstein"
}
```
