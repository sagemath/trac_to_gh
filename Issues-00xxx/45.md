...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-321"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-323"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-324"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/45",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/45#event-325"
}
```
