...
```json
{
    "body": "<a id='comment:1'></a>This is fixed now, interestingly, but maybe the problem is still there?\n\n```\nsage: x = PolynomialRing(Integers(100),'x').gen()\n sage: p = 3*x\n sage: q = 7*x\n sage: y = PolynomialRing(Integers(8),'y').gen()\n sage: print p + q\n   10*x\n sage: print p + q\n   10*x\n10*x\n10*x\n\n```",
    "created_at": "2007-01-12T22:17:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/45",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/45#issuecomment-283",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This is fixed now, interestingly, but maybe the problem is still there?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/45",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/45#issuecomment-284",
    "user": "https://github.com/williamstein"
}
```
