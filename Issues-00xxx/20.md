...
```json
{
    "body": "<a id='comment:2'></a>This is fixed in sage-1.5:\n\n```\nsage: power_ring1.<gen1> = PowerSeriesRing(QQ)\nsage: power_ring2.<gen2> = PowerSeriesRing(QQ)\nsage: huge_power_ring.<x> = PowerSeriesRing(power_ring1)\nsage: huge_power_ring(gen1)\ngen1\nsage: huge_power_ring(gen2)\nx\n```",
    "created_at": "2007-01-07T03:36:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20#issuecomment-80",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>This is fixed in sage-1.5:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20#issuecomment-81",
    "user": "https://github.com/williamstein"
}
```
