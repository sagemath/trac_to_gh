...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1358"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1361"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/200",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1363"
}
```
