...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1241"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1243"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/200",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/200#event-1245"
}
```
