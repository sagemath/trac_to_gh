...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2568"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2569"
}
```
...
archive/attachments_000242.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "593.patch",
    "asset_url": "tarball://root/attachments/ticket593/593.patch",
    "created_at": "2007-10-04T03:02:11Z",
    "issue": "https://github.com/sagemath/sage/issues/593",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket593/593.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [593.patch](https://github.com/sagemath/sage/files/ticket593/593.patch) by @malb created at 2007-10-04 03:02:11\n\nThe attached patch fixes this issue.",
    "created_at": "2007-10-04T03:02:11Z",
    "issue": "https://github.com/sagemath/sage/issues/593",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2570"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2571"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/593",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2572"
}
```
