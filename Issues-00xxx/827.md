...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/827#issuecomment-5380",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] nfrootsof1 from Pari"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/827#event-2815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/827",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/827#issuecomment-5381",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/827",
    "rename": {
        "from": "[with patch, needs review] nfrootsof1 from Pari",
        "to": "[with patch, with positive review] nfrootsof1 from Pari"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/827#event-2816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/827",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/827#issuecomment-5382",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/827",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/827#issuecomment-5383",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/827",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/827#event-2817"
}
```
