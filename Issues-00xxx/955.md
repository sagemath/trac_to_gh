...
```json
{
    "body": "<a id='comment:1'></a>See rings/morphism.pyx for an example of this that is # not tested right now.",
...
<a id='comment:1'></a>See rings/morphism.pyx for an example of this that is # not tested right now.
...
```json
{
    "body": "<a id='comment:4'></a>Release 2.8.8 had a patch for this that fixed most or all of the issues with Singular.  However, other interfaces are still vulnerable to the same problem.  All interfaces should be audited and fixed.",
...
<a id='comment:4'></a>Release 2.8.8 had a patch for this that fixed most or all of the issues with Singular.  However, other interfaces are still vulnerable to the same problem.  All interfaces should be audited and fixed.
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [7176.patch](tarball://root/attachments/some-uuid/ticket955/7176.patch) by cwitty created at 2007-10-27 18:02:30\n\nI've fixed several places that looked slightly dubious, although I could have missed something.\n\nThe attached patch will be in 2.8.10.",
...
<a id='comment:5'></a>Attachment [7176.patch](tarball://root/attachments/some-uuid/ticket955/7176.patch) by cwitty created at 2007-10-27 18:02:30
