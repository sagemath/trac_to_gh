...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/319#issuecomment-1593",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>this is apparently fixed at least as of 2.8",
    "created_at": "2007-08-18T17:13:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/319",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/319#issuecomment-1594",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:1'></a>this is apparently fixed at least as of 2.8
