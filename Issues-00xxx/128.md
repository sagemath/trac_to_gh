...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/128#event-414"
}
```
...
```json
{
    "body": "Attachment [trac_128-ec-constructor.patch](https://github.com/sagemath/sage/files/ticket128/trac_128-ec-constructor.patch) by @JohnCremona created at 2009-12-13 22:59:11\n\nApplies to 4.3.rc0",
    "created_at": "2009-12-13T22:59:11Z",
    "issue": "https://github.com/sagemath/sage/issues/128",
    "type": "issue_comment",
...
Attachment [trac_128-ec-constructor.patch](https://github.com/sagemath/sage/files/ticket128/trac_128-ec-constructor.patch) by @JohnCremona created at 2009-12-13 22:59:11
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/128#event-415"
}
```
