...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/561#issuecomment-3076",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/561#event-1647"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/561#event-1648"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/561#event-1649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/561#issuecomment-3077",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
archive/attachments_000217.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage-2.8.7.rc1-fix-small-memleaks-in_MultiModularBasis_base.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket561/sage-2.8.7.rc1-fix-small-memleaks-in_MultiModularBasis_base.patch",
...
```json
{
    "body": "burcin's fix extracted from the patch for #559",
    "created_at": "2007-10-16T02:56:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/561#issuecomment-3078",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/561",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/561#event-1650"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/561#issuecomment-3079",
