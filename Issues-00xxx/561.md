...
archive/attachments_000220.json:
```json
{
...
```json
{
    "body": "**Attachment:** [sage-2.8.7.rc1-fix-small-memleaks-in_MultiModularBasis_base.patch](https://github.com/sagemath/sage/files/ticket561/sage-2.8.7.rc1-fix-small-memleaks-in_MultiModularBasis_base.patch)\n\nburcin's fix extracted from the patch for #559",
    "created_at": "2007-10-16T02:56:58Z",
    "issue": "https://github.com/sagemath/sage/issues/561",
    "type": "issue_comment",
...
**Attachment:** [sage-2.8.7.rc1-fix-small-memleaks-in_MultiModularBasis_base.patch](https://github.com/sagemath/sage/files/ticket561/sage-2.8.7.rc1-fix-small-memleaks-in_MultiModularBasis_base.patch)
