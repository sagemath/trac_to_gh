# Issue 865: [with patch] [tested by cwitty] several small memory leak in multi_modular
...
```json
{
    ...
    "title": "[with patch] [tested by cwitty] several small memory leak in multi_modular",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/865#issuecomment-5512",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/865#issuecomment-5513",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [Sage-2.8.6-fix-memleak-in-multi_modular.2.patch](tarball://root/attachments/some-uuid/ticket865/Sage-2.8.6-fix-memleak-in-multi_modular.2.patch) by mabshoff created at 2007-10-12 21:20:41\n\nOops, sorry for patch #2, it is identical to the previous one. I did a reload on a tab I wanted to close.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-12T21:20:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/865#issuecomment-5514",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Attachment [Sage-2.8.6-fix-memleak-in-multi_modular.2.patch](tarball://root/attachments/some-uuid/ticket865/Sage-2.8.6-fix-memleak-in-multi_modular.2.patch) by mabshoff created at 2007-10-12 21:20:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/865#issuecomment-5515",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/865",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/865#event-2420"
}
```
