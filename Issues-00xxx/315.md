...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/315#issuecomment-1678",
...
```json
{
    "body": "<a id='comment:2'></a>I think this is basically just a Python question.  One can write interactive Python programs\nthat use SAGE as a library...",
    "created_at": "2007-03-21T23:10:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/315#issuecomment-1679",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>I think this is basically just a Python question.  One can write interactive Python programs
that use SAGE as a library...
