...
```json
{
    ...
    "rename": {
        "from": "sage-2.8.9.rc1: order of .variety() depends on architecture in multi_polynomial_ideal.py",
        "to": "[with patch] sage-2.8.9.rc1: order of .variety() depends on architecture in multi_polynomial_ideal.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/986#event-3370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/986#issuecomment-6315",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/986",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/986#event-3371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/986",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/986#issuecomment-6316",
