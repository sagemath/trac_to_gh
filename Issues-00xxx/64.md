...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/64#issuecomment-350",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/64",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/64#issuecomment-351",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>this is fixed in sage 1.4",
    "created_at": "2006-10-10T23:56:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/64",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/64#issuecomment-352",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:2'></a>this is fixed in sage 1.4
