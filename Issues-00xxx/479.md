...
```json
{
    "body": "<a id='comment:2'></a>Just to confirm that this bug is still around, CCing Cl\u00e9ment :-)",
...
<a id='comment:2'></a>Just to confirm that this bug is still around, CCing Clément :-)
...
```json
{
    "body": "<a id='comment:3'></a>Well, this should be trivial to fix. Any takers?\n\nCheers,\n\nMichael",
...
<a id='comment:3'></a>Well, this should be trivial to fix. Any takers?
...
```json
{
    "body": "<a id='comment:4'></a>Has this one been addressed in the meantime, due to Kirkby's many helpful flag comments?",
...
<a id='comment:4'></a>Has this one been addressed in the meantime, due to Kirkby's many helpful flag comments?
...
<a id='comment:5'></a>linbox appears to have several errors. 
...
```json
{
    "body": "<a id='comment:10'></a>Fixed in #12762?",
    "created_at": "2015-04-13T14:15:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/479",
    "type": "issue_comment",
...
<a id='comment:10'></a>Fixed in #12762?
