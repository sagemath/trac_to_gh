...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/949#issuecomment-6076",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/949#issuecomment-6077",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/949",
    "rename": {
        "from": "\"sage -f\" fails to install packages when given an absolute path",
        "to": "[with patch] \"sage -f\" fails to install packages when given an absolute path"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/949#event-3226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/949",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/949#event-3227"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/949#issuecomment-6078",
