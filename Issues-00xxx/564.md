...
archive/attachments_000221.json:
```json
{
...
```json
{
    "body": "**Attachment:** [6081.patch](https://github.com/sagemath/sage/files/ticket564/6081.patch)\n\nThis fixes the memleak in + or - for sparse matrix arithmetic.",
    "created_at": "2007-09-03T15:19:43Z",
    "issue": "https://github.com/sagemath/sage/issues/564",
    "type": "issue_comment",
...
**Attachment:** [6081.patch](https://github.com/sagemath/sage/files/ticket564/6081.patch)
