...
```json
{
    ...
    "body": "`sage -t` does not pick up segfaults in doctests. For example this code currently causes a segmentation fault:\n\n```\nsage: x = 3**10000000\nsage: bits = 31699256\nsage: R = RealField(bits)\nsage: y = x._mpfr_(R)\nsage: z = y.log()\n```\n\nIf this appears in a doctest, then the test framework continues without comment, and prints \"All tests passed!\" at the end.\n\n\nComponent: **user interface**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/161_\n\n",
    ...
    "type": "issue",
    "updated_at": "2006-11-06T07:41:00Z",
    "url": "https://github.com/sagemath/sage/issues/161",
...
```json
{
    ...
    "created_at": "2006-10-29T21:55:51Z",
    "event": "labeled",
    "issue": "https://github.com/sagemath/sage/issues/161",
    "label": "https://github.com/sagemath/sage/labels/c%3A%20user%20interface",
    "label_color": "000080",
    "label_name": "c: user interface",
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/161#event-1147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/161#event-1148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/161#event-1149"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/161#event-1150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/161#issuecomment-493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/161",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/161#event-1151"
}
```
