# Issue 706: [with patch] irange --- also add range that includes the endpoints by default
...
```json
{
    ...
    "title": "[with patch] irange --- also add range that includes the endpoints by default",
    "type": "issue",
