...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/998#issuecomment-4606",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/998#issuecomment-4607",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/998#issuecomment-4608",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/998#issuecomment-4609",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/998#issuecomment-4610",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket998/998.patch",
    "created_at": "2007-11-25T05:09:01Z",
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket998/998.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "Attachment [998.patch](https://github.com/sagemath/sage/files/ticket998/998.patch) by cwitty created at 2007-11-25 05:09:01",
    "created_at": "2007-11-25T05:09:01Z",
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/998#issuecomment-4611",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

Attachment [998.patch](https://github.com/sagemath/sage/files/ticket998/998.patch) by cwitty created at 2007-11-25 05:09:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/998#issuecomment-4612",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/998#event-4633"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/998#event-4634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/998",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/998#event-4635"
}
```
