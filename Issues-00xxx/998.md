...
```json
{
    "body": "<a id='comment:2'></a>I cannot reproduce this bug\n* on my notebook (Core2Duo, 64-bit Linux)\n* on `sage.math` and my own built of `2.8.9.rc1`",
    "created_at": "2007-10-25T16:40:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/998#issuecomment-6251",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>I cannot reproduce this bug
* on my notebook (Core2Duo, 64-bit Linux)
* on `sage.math` and my own built of `2.8.9.rc1`
...
```json
{
    "body": "<a id='comment:3'></a>Just FYI: backtrace is from 32 bit x86 FC7.\n\nMichael",
    "created_at": "2007-10-25T17:53:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/998#issuecomment-6252",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Just FYI: backtrace is from 32 bit x86 FC7.
...
```json
{
    "body": "<a id='comment:5'></a>I think the problem is that the \"names\" member of a ring is allocated with the wrong size.  This means that omalloc allocates it as a \"large\" allocation, but then tries to free it as a \"small\" allocation, and crashes.  (The problem would only occur for one particular number of variables.)",
    "created_at": "2007-11-25T05:08:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/998#issuecomment-6254",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:5'></a>I think the problem is that the "names" member of a ring is allocated with the wrong size.  This means that omalloc allocates it as a "large" allocation, but then tries to free it as a "small" allocation, and crashes.  (The problem would only occur for one particular number of variables.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/998#issuecomment-6255",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The patch looks good to me, doctesting sr.py with -long repeatedly works.\n\nCheers,\n\nMichael",
    "created_at": "2007-11-25T05:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/998#issuecomment-6256",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>The patch looks good to me, doctesting sr.py with -long repeatedly works.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/998#issuecomment-6257",
    "user": "https://github.com/williamstein"
}
```
