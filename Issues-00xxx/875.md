...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/875#issuecomment-5677",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/875#issuecomment-5678",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/875#issuecomment-5679",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/875#event-2976"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/875#event-2977"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/875#event-2978"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/875#event-2979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/875#issuecomment-5680",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/875",
    "rename": {
        "from": "further work needed on fast Sage --> PARI int conversion",
        "to": "[with patch] further work needed on fast Sage --> PARI int conversion"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/875#event-2980"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/875",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/875#event-2981"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/875#issuecomment-5681",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/875#issuecomment-5682",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
