...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3293",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3294",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I'm happy with coerce_map_from_impl and Q_to_ExtendedQ, but I think _coerce_impl needs to by default check if its in ExtendedZZ then see if it can be coerced into QQ, then error out.  Current code may not work with things that can be in ExtendedQQ but are not typed as integers (3 in RR).",
    "created_at": "2008-03-02T17:35:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3296",
    "user": "https://github.com/garyfurnish"
}
```

<a id='comment:4'></a>I'm happy with coerce_map_from_impl and Q_to_ExtendedQ, but I think _coerce_impl needs to by default check if its in ExtendedZZ then see if it can be coerced into QQ, then error out.  Current code may not work with things that can be in ExtendedQQ but are not typed as integers (3 in RR).
...
```json
{
    "body": "<a id='comment:6'></a>I attached a patch addressing the referee's concerns.",
    "created_at": "2008-03-02T23:27:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3297",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:6'></a>I attached a patch addressing the referee's concerns.
...
```json
{
    "body": "<a id='comment:7'></a>Ummm, the doctests for `sage/rings/extended_integer_ring.py` do not pass for me with this patch.",
    "created_at": "2008-03-03T19:48:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3298",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:7'></a>Ummm, the doctests for `sage/rings/extended_integer_ring.py` do not pass for me with this patch.
...
```json
{
    "body": "<a id='comment:8'></a>Which ones fail?  What version are you applying against?  If it's the cmp ones, it may just be something random due to architecture differences.",
    "created_at": "2008-03-03T22:32:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3299",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:8'></a>Which ones fail?  What version are you applying against?  If it's the cmp ones, it may just be something random due to architecture differences.
...
```json
{
    "body": "<a id='comment:10'></a>Yep.  Python like to be able to compare everything.  With the new coercion stuff coming in, things will have more meaningful _cmp_ functions.",
    "created_at": "2008-03-03T23:00:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3301",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:10'></a>Yep.  Python like to be able to compare everything.  With the new coercion stuff coming in, things will have more meaningful _cmp_ functions.
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [590-referee.patch](tarball://root/attachments/some-uuid/ticket590/590-referee.patch) by dmharvey created at 2008-03-04 00:56:22\n\nokay, I'm happy now.",
    "created_at": "2008-03-04T00:56:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3302",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:11'></a>Attachment [590-referee.patch](tarball://root/attachments/some-uuid/ticket590/590-referee.patch) by dmharvey created at 2008-03-04 00:56:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3303",
...
```json
{
    "body": "<a id='comment:13'></a>Merged both patches in Sage 2.10.3.rc1",
    "created_at": "2008-03-04T03:53:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/590#issuecomment-3304",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:13'></a>Merged both patches in Sage 2.10.3.rc1
