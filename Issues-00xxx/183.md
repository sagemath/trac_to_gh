...
```json
{
    "body": "<a id='comment:1'></a>This is fixed for sage-1.6",
    "created_at": "2007-01-09T18:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/183#issuecomment-914",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This is fixed for sage-1.6
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/183#issuecomment-915",
    "user": "https://github.com/williamstein"
}
```
