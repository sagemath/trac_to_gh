...
```json
{
    ...
    "asset_name": "binomial_symbolic.patch",
    "asset_url": "tarball://root/attachments/ticket628/binomial_symbolic.patch",
    "created_at": "2007-09-09T14:59:41Z",
    "issue": "https://github.com/sagemath/sage/issues/628",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket628/binomial_symbolic.patch",
    "user": "https://github.com/pdenapo"
}
```
...
```json
{
    "body": "Attachment [binomial_symbolic.patch](https://github.com/sagemath/sage/files/ticket628/binomial_symbolic.patch) by @pdenapo created at 2007-09-09 14:59:41",
    "created_at": "2007-09-09T14:59:41Z",
    "issue": "https://github.com/sagemath/sage/issues/628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/628#issuecomment-2333",
    "user": "https://github.com/pdenapo"
}
```

Attachment [binomial_symbolic.patch](https://github.com/sagemath/sage/files/ticket628/binomial_symbolic.patch) by @pdenapo created at 2007-09-09 14:59:41
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/628#event-2714"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/628#event-2715"
}
```
...
archive/attachments_000266.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "binomial_patch.hg",
    "asset_url": "tarball://root/attachments/ticket628/binomial_patch.hg",
    "created_at": "2007-09-10T20:34:58Z",
    "issue": "https://github.com/sagemath/sage/issues/628",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket628/binomial_patch.hg",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    "body": "Attachment [binomial_patch.hg](https://github.com/sagemath/sage/files/ticket628/binomial_patch.hg) by jbmohler created at 2007-09-10 20:34:58\n\nhg bundle including the patch file and my doc-string revisions",
    "created_at": "2007-09-10T20:34:58Z",
    "issue": "https://github.com/sagemath/sage/issues/628",
    "type": "issue_comment",
...
Attachment [binomial_patch.hg](https://github.com/sagemath/sage/files/ticket628/binomial_patch.hg) by jbmohler created at 2007-09-10 20:34:58
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/628",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/628#event-2716"
}
```
