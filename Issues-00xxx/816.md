...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7860"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7863"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/816#issuecomment-3665",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "subject": "https://github.com/malb",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7865"
}
```
...
```json
{
    ...
    "subject": "https://github.com/malb",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7866"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7867"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7868"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/816",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/816#event-7869"
}
```
