...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/501#issuecomment-2601",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/501#issuecomment-2602",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/501#issuecomment-2603",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>And the other half passes Valgrind, too:\n\n```\nsage: def Supercomp():\n....:        p=ZZ(10**5).next_prime()\n....:    for i in range(4):\n....:          print(i)\n....:      print get_memory_usage()\n....:      t = cputime()\n....:      X = SupersingularModule(p)\n....:      X.hecke_matrix(2)\n....:      p = ZZ(p).next_prime()\n....:      print get_memory_usage()\n....:\nsage: Supercomp(); quit\n0\n741.2421875\n764.8984375\n1\n764.8984375\n768.6484375\n2\n768.6484375\n768.6484375\n3\n768.6484375\n768.6328125\n```\nI removed the whole writing to file bit. If that causes leaks we can open another ticket for that.\n\nI am closing the ticket for 2.8.3\n\nCheers,\n\nMichael",
    "created_at": "2007-08-30T20:13:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/501#issuecomment-2604",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>And the other half passes Valgrind, too:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/501#issuecomment-2605",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
