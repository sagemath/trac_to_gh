...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4005"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4007"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4008"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4012"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4013"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4014"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4017"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4019"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4021"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4023"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4025"
}
```
...
```json
{
    "body": "<a id='comment:10'>Comment 10:</a>\n[attachment: sage-test-import.gz](https://github.com/sagemath/sage/files/ticket510/sage-test-import.gz) imports all modules in the given source tree, and prints out those which raise an error.",
    "created_at": "2008-10-15T16:48:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/510",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'>Comment 11:</a>\nI just tried [attachment: 510_real_mpfr_imports.patch.gz](https://github.com/sagemath/sage/files/ticket510/510_real_mpfr_imports.patch.gz)It still applies, and fixes the original problem reported, as I wrote in [comment:7](#comment%3A7) previously.\n\nThe script [attachment: sage-test-import.gz](https://github.com/sagemath/sage/files/ticket510/sage-test-import.gz) lists many other problems of this kind, but feel free to apply this patch, and move the script to another ticket.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4027"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4028"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4030"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/510#event-4031"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/510#issuecomment-1900",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
