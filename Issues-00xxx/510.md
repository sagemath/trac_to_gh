...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1512"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1514"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1516"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1517"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Make sure importing random modules from Sage doesn't segfault"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1518"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1519"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1520"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/510",
    "rename": {
        "from": "[with patch, needs review] Make sure importing random modules from Sage doesn't segfault",
        "to": "[with patch, needs review] Make sure importing sage.rings.real_mpfr without an \"from sage import *\" doesn't segfault Sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1521"
}
```
...
```json
{
    ...
    "label": "component: interfaces",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1522"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/510",
    "rename": {
        "from": "[with patch, needs review] Make sure importing sage.rings.real_mpfr without an \"from sage import *\" doesn't segfault Sage",
        "to": "[with patch, positive review] Make sure importing sage.rings.real_mpfr without an \"from sage import *\" doesn't segfault Sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1523"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1524"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1525"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/510#event-1526"
}
```
