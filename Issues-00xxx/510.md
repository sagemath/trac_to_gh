...
```json
{
    "body": "<a id='comment:11'></a>I just tried attachment:510_real_mpfr_imports.patch. It still applies, and fixes the original problem reported, as I wrote in[comment:7](#comment%3A7) previously.\n\nThe script attachment:sage-test-import lists many other problems of this kind, but feel free to apply this patch, and move the script to another ticket.",
...
<a id='comment:11'></a>I just tried attachment:510_real_mpfr_imports.patch. It still applies, and fixes the original problem reported, as I wrote in[comment:7](#comment%3A7) previously.
