...
```json
{
    ...
    "rename": {
        "from": "graphs: adjacency_matrix() does not call multiple_edges correctly.",
        "to": "[patch] graphs: adjacency_matrix() does not call multiple_edges correctly."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/755#event-2467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/755#issuecomment-4643",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/755",
    "rename": {
        "from": "[patch] graphs: adjacency_matrix() does not call multiple_edges correctly.",
        "to": "[with patch] graphs: adjacency_matrix() does not call multiple_edges correctly."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/755#event-2468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/755#issuecomment-4644",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/755#event-2469"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/755#issuecomment-4645",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/755#issuecomment-4646",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/755",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/755#event-2470"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/755#event-2471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/755#event-2472"
}
```
