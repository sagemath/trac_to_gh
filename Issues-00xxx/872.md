...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7450"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7453"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/872",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7455"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/872#issuecomment-4104",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7456"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7457"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/872",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/872#event-7458"
}
```
...
```json
{
    "body": "Changed keywords from **** to **singular, number, fields, factorization**",
    "created_at": "2023-01-14T16:19:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/872#issuecomment-4105",
    "user": "https://github.com/fchapoton"
}
```

Changed keywords from **** to **singular, number, fields, factorization**
