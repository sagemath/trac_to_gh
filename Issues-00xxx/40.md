...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/40#issuecomment-260",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I can't find this mm.sage example any more.  Moreover, the preparser does work\non multiple lines, so won't fix until get a proper bug report.",
    "created_at": "2007-01-12T21:57:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/40",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/40#issuecomment-261",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>I can't find this mm.sage example any more.  Moreover, the preparser does work
on multiple lines, so won't fix until get a proper bug report.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/40",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/40#issuecomment-262",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/40",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/40#issuecomment-263",
    "user": "https://github.com/williamstein"
}
```
