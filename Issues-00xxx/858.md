...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/858#issuecomment-5577",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/858#issuecomment-5578",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] add support for numpy arrays with integer entries"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/858#event-2929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/858#issuecomment-5579",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/858#issuecomment-5580",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/858#issuecomment-5581",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/858",
    "rename": {
        "from": "[with patch] add support for numpy arrays with integer entries",
        "to": "[with patch] [tested by cwitty] add support for numpy arrays with integer entries"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/858#event-2930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/858",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/858#event-2931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/858#issuecomment-5582",
