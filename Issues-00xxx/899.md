...
```json
{
    ...
    "rename": {
        "from": "minor error in inst.tex",
        "to": "[with patch] minor error in inst.tex"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/899#event-3048"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/899#event-3049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/899#issuecomment-5798",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/899#issuecomment-5799",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/899#issuecomment-5800",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/899#event-3050"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/899#event-3051"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/899#issuecomment-5801",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/899",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/899#event-3052"
}
```
