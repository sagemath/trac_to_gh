...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/132#event-302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-627",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-628",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "rename": {
        "from": "maxima -- implement special arithmetic for MaximaFunction class",
        "to": "[with patch, needs review] maxima -- implement special arithmetic for MaximaFunction class"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/132#event-303"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/132#event-304"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/132#event-305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-629",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-630",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-631",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-632",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "rename": {
        "from": "[with patch, needs review] maxima -- implement special arithmetic for MaximaFunction class",
        "to": "[with patch, positive review] maxima -- implement special arithmetic for MaximaFunction class"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/132#event-306"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-633",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-634",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-635",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/132#event-307"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-636",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/132",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/132#issuecomment-637",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
