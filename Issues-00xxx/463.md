...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/463#event-1352"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/463",
    "rename": {
        "from": "sage -upgrade:  \"sage -upgrade URL\" will install all *newer* spkg's from the given URL, which can also be a local directory",
        "to": "[with patch; needs review] sage -upgrade:  \"sage -upgrade URL\" will install all *newer* spkg's from the given URL, which can also be a local directory"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/463#event-1353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/463",
    "rename": {
        "from": "[with patch; needs review] sage -upgrade:  \"sage -upgrade URL\" will install all *newer* spkg's from the given URL, which can also be a local directory",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/463#event-1354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/463#issuecomment-2401",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/463",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/463#event-1355"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/463#issuecomment-2402",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/463#issuecomment-2403",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/463#issuecomment-2404",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
