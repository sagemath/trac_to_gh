...
```json
{
    ...
    "milestone": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/35#event-166"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/35",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/35#event-167"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/35",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/35#issuecomment-170",
    "user": "https://github.com/williamstein"
}
```
