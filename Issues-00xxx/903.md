...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5812",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5813",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5814",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5815",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5816",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5817",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5818",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "rename": {
        "from": "[with patch, needs review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)",
        "to": "[with patch, with negative review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3065"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5819",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5820",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "rename": {
        "from": "[with patch, with negative review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)",
        "to": "[with additional patch, needs review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5821",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5822",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5823",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5824",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "rename": {
        "from": "[with additional patch, needs review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)",
        "to": "[with patch, needs review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3067"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)",
        "to": "[with patch, positive review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5825",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5826",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "rename": {
        "from": "[with patch, positive review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)",
        "to": "[with patch, positive review pending fix of doctest failures] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3069"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5827",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "rename": {
        "from": "[with patch, positive review pending fix of doctest failures] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)",
        "to": "[with patch, positive review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3070"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5828",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5829",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5830",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3071"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)",
        "to": "[with patch, very positive review] charpoly of matrices over number fields is ridiculously slow right now (easy fixes exist)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3072"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5831",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5832",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5833",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/903#event-3073"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5834",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/903#issuecomment-5835",
    "user": "https://github.com/aghitza"
}
```
