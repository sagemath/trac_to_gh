...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/535#issuecomment-2312",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/535#issuecomment-2313",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1542"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1543"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1544"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1545"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/535#issuecomment-2314",
...
```json
{
    ...
    "milestone": "sage-2.8.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1547"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/535",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1549"
}
```
