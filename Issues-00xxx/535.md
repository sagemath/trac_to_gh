...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/535#issuecomment-2306",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/535#issuecomment-2307",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1550"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1551"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1552"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/535#issuecomment-2308",
...
```json
{
    ...
    "milestone": "sage-2.8.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1553"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/535",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/535#event-1555"
}
```
