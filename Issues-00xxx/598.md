...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4762"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4765"
}
```
...
```json
{
    "body": "Assignee: **@sagetrac-jbmohler**",
...
```json
{
    "body": "Changed assignee from **@sagetrac-jbmohler** to **@mwhansen**",
...
Changed assignee from **@sagetrac-jbmohler** to **@mwhansen**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4766"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/598",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/598#event-4770"
}
```
