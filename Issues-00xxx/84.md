...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/84#event-593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/84#event-594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/84#event-595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/84#event-596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/84#event-597"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-dmharvey** to **@ncalexan**",
...
Changed assignee from **@sagetrac-dmharvey** to **@ncalexan**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/84",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/84#event-598"
}
```
