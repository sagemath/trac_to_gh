...
archive/attachments_000161.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "5835-number_of_partitions-improvement.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket486/5835-number_of_partitions-improvement.patch",
...
```json
{
    "body": "Patch for the improvements described in this ticket. Touches files setup.py, combinat.py, and partitions_c.cc",
    "created_at": "2007-08-29T15:56:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/486#issuecomment-2576",
    "user": "https://trac.sagemath.org/admin/accounts/users/bober"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/486#issuecomment-2577",
    "user": "https://trac.sagemath.org/admin/accounts/users/bober"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/486#event-1370"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/486#event-1371"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/486#event-1372"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/486#issuecomment-2578",
...
archive/attachments_000162.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "partition_updates.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket486/partition_updates.hg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/486#issuecomment-2579",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/486#event-1373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/486#issuecomment-2580",
    "user": "https://github.com/williamstein"
}
```
