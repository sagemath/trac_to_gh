...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/680#issuecomment-3622",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/680#issuecomment-3623",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/680",
    "rename": {
        "from": "Solaris 9: fix partition import problem",
        "to": "[with patch] Solaris 9: fix partition import problem"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/680#event-2156"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/680#issuecomment-3624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/680",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/680#event-2157"
}
```
