...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/680#issuecomment-3806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>A patch for this problem can be found at \n\nhttp://fsmath.mathematik.uni-dortmund.de/~mabshoff/patches/Sage-2.8.4-fix-partition.so-load-problem-on-Solaris9.patch\n\nCheers,\n\nMichael",
    "created_at": "2007-09-18T20:18:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/680#issuecomment-3807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>A patch for this problem can be found at 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/680#issuecomment-3808",
