...
```json
{
    "body": "<a id='comment:1'></a>Works for me now:\n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n| SAGE Version 2.8.3.alpha2, Release Date: 2007-08-29                |\n| Type notebook() for the GUI, and license() for information.        |\nsage: x,y=PolynomialRing(QQ,2,\"xy\").gens()\nsage: f = 5*x+y-5\nsage: f(1,1)\n1\nsage: type(f(1,1))\n<type 'sage.rings.rational.Rational'>\n```\n\nI guess credit should go to Robert or William.\n\nCheers,\n\nMichael",
    "created_at": "2007-08-30T12:21:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/484#issuecomment-2515",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Works for me now:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/484#issuecomment-2516",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/484#issuecomment-2517",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
