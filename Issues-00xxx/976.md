...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/976",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-5940",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-5941",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Well, in nr.cpp we have a specialization for mpz_t for the constructor, so it might be an index issue. Otherwise I am out of ideas.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-24T03:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-5942",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-5943",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "This is fixed upstream and the updated spkg is in 2.8.9.alpha1",
    "created_at": "2007-10-24T18:38:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-5944",
    "user": "https://github.com/malb"
}
```
