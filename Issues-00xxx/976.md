...
```json
{
    "body": "<a id='comment:2'></a>Ok, it is my impression that in fast.cpp:442\n\n```\n  Z_NR<ZT> ztmp;\n```\nis not properly initialized if ZT is an mpz or somehow the index might be \"off\".\n\nCheers,\n\nMichael",
    "created_at": "2007-10-24T03:23:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-6478",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Ok, it is my impression that in fast.cpp:442
...
```json
{
    "body": "<a id='comment:3'></a>Well, in nr.cpp we have a specialization for mpz_t for the constructor, so it might be an index issue. Otherwise I am out of ideas.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-24T03:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-6479",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Well, in nr.cpp we have a specialization for mpz_t for the constructor, so it might be an index issue. Otherwise I am out of ideas.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-6480",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This is fixed upstream and the updated spkg is in 2.8.9.alpha1",
    "created_at": "2007-10-24T18:38:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/976#issuecomment-6481",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>This is fixed upstream and the updated spkg is in 2.8.9.alpha1
