...
```json
{
    "body": "<a id='comment:1'></a>Ok, after looking at init_stack in the pari source code it might be as simple as doing a \n\n```\nsage_free((void*)Bot)\n```\nupon exiting Sage. I haven't tried it, though.\n\nCheers,\n\nMichael",
    "created_at": "2007-09-20T20:30:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/470#issuecomment-2440",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Ok, after looking at init_stack in the pari source code it might be as simple as doing a 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/470#issuecomment-2442",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This was fixes by William and Gonzalo during the rewrite of the pari stack extension code.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-12T01:56:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/470#issuecomment-2443",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>This was fixes by William and Gonzalo during the rewrite of the pari stack extension code.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/470#issuecomment-2444",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/470#issuecomment-2445",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/470#issuecomment-2447",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Well, there are some cases where the dealloc doesn't work, so close this for now and open a ticket when I find a reproducible case where it does happen.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-14T11:54:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/470#issuecomment-2448",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Well, there are some cases where the dealloc doesn't work, so close this for now and open a ticket when I find a reproducible case where it does happen.
