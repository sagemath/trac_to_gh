...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/336#event-917"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/336#issuecomment-1729",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] Create an option to clear all cell output"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/336#event-918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/336#issuecomment-1730",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/336#issuecomment-1731",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "rename": {
        "from": "[with patch; needs review] Create an option to clear all cell output",
        "to": "[with patch; negative review] Create an option to clear all cell output"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/336#event-919"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/336#issuecomment-1732",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "rename": {
        "from": "[with patch; negative review] Create an option to clear all cell output",
        "to": "[with patch; positive review] Create an option to clear all cell output"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/336#event-920"
}
```
...
```json
{
    ...
    "milestone": "sage-feature",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/336#event-921"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/336#event-922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/336#event-923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/336#issuecomment-1733",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/336#issuecomment-1734",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
