...
```json
{
    "body": "<a id='comment:2'></a>fixed by patching python itself (for sage-2.8.2)",
    "created_at": "2007-08-18T23:54:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/423#issuecomment-2343",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>fixed by patching python itself (for sage-2.8.2)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/423#issuecomment-2344",
    "user": "https://github.com/williamstein"
}
```
