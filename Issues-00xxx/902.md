...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/902#issuecomment-5810",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/902",
    "rename": {
        "from": "implement computation of minpoly of symbolics",
        "to": "[with patch] implement computation of minpoly of symbolics"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/902#event-3062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/902#issuecomment-5811",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/902",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/902#event-3063"
}
```
