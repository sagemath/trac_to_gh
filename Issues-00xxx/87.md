...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/87#issuecomment-452",
...
```json
{
    "body": "<a id='comment:3'></a>It works fine now:\n\n```\n\nsage: Qyz=QQ['y,z']; y,z=Qyz.gens()\nsage: (1/y)*y\n1\nsage: (y^2/y)*y\ny^2\n```",
    "created_at": "2007-01-13T02:16:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/87",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/87#issuecomment-453",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>It works fine now:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/87",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/87#issuecomment-454",
    "user": "https://github.com/williamstein"
}
```
