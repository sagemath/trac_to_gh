...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/466#event-3516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/466#event-3517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/466#event-3518"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **@sagetrac-pdehaye**",
    "created_at": "2007-08-22T19:30:08Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/466",
    "type": "issue_comment",
...
Changed assignee from **@williamstein** to **@sagetrac-pdehaye**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/466#event-3519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/466",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/466#event-3520"
}
```
