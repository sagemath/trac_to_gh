...
```json
{
    "body": "<a id='comment:17'>Comment 17:</a>\nAttachment: **[trac_329.patch.gz](https://github.com/sagemath/sage/files/ticket329/trac_329.patch.gz)**\n\nNew patch fixes adds a \"then\" which should follow an \"elif\" in sage-spkg.\n\nAlso, I once again uploaded a mis-named patch. Please ignore trac_329.patch; only [attachment: trac_329_sage_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket329/trac_329_sage_scripts.patch.gz) and [attachment: trac_329_spkg_base.patch.gz](https://github.com/sagemath/sage/files/ticket329/trac_329_spkg_base.patch.gz) are necessary.",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -36,3 +36,5 @@\n ```\n \n * Ticket #7617 implements the integrity check procedure below for the SageTeX spkg.\n+\n+Apply only [attachment: trac_329_sage_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket329/trac_329_sage_scripts.patch.gz) to the scripts repo.\n``````\n",
