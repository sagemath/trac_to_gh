...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/583#issuecomment-2185",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_name": "trac583.patch",
    "asset_url": "tarball://root/attachments/ticket583/trac583.patch",
    "created_at": "2007-09-04T02:17:53Z",
    "issue": "https://github.com/sagemath/sage/issues/583",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket583/trac583.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac583.patch](https://github.com/sagemath/sage/files/ticket583/trac583.patch) by @williamstein created at 2007-09-04 02:17:53",
    "created_at": "2007-09-04T02:17:53Z",
    "issue": "https://github.com/sagemath/sage/issues/583",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/583",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/583#event-2536"
}
```
