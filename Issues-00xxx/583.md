...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/583#issuecomment-3261",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac583.patch](tarball://root/attachments/some-uuid/ticket583/trac583.patch) by @williamstein created at 2007-09-04 02:17:53",
    "created_at": "2007-09-04T02:17:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/583#issuecomment-3262",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Attachment [trac583.patch](tarball://root/attachments/some-uuid/ticket583/trac583.patch) by @williamstein created at 2007-09-04 02:17:53
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/583#issuecomment-3263",
    "user": "https://github.com/williamstein"
}
```
