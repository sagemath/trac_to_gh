...
```json
{
    "body": "<a id='comment:1'></a>Actually the problem is apparently with `__invert__`:\n\n```\nsage: (1 + O(5)).__invert__()\n 1 + O(5^20)\n```",
    "created_at": "2006-09-27T13:37:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/89",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/89#issuecomment-463",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:1'></a>Actually the problem is apparently with `__invert__`:
...
```json
{
    "body": "<a id='comment:2'></a>fixed in sage 1.4",
    "created_at": "2006-10-10T23:58:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/89",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/89#issuecomment-464",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:2'></a>fixed in sage 1.4
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/89",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/89#issuecomment-465",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
