...
```json
{
    ...
    "type": "issue",
    "updated_at": "2007-01-22T03:27:54Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/98#event-712"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/98#event-713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/98#event-714"
}
```
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/98",
    "title_is": "p-adic print_prec does not work as advertised",
    "title_was": "p-adic print_prec does work as advertised",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/98#event-715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/98",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/98#issuecomment-312",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/98",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/98#issuecomment-313",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/98",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/98#event-716"
}
```
