...
```json
{
    "body": "<a id='comment:2'></a>This is terrible!  But it's pointless to fix when the p-adics are on the way out to be replaced by new implementation...  keep the example in mind though.",
    "created_at": "2007-01-13T02:55:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/98",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/98#issuecomment-487",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>This is terrible!  But it's pointless to fix when the p-adics are on the way out to be replaced by new implementation...  keep the example in mind though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/98",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/98#issuecomment-488",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/98",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/98#issuecomment-489",
    "user": "https://github.com/williamstein"
}
```
