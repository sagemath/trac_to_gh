...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/413#issuecomment-1557",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/413#event-1700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/413",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/413#event-1701"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/413#event-1702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/413",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/413#issuecomment-1558",
...
{
    "actor": "https://trac.sagemath.org/admin/accounts/users/mabshoff",
    "created_at": "2008-03-17T04:40:15Z",
    "event": "labeled",
    "issue": "https://github.com/sagemath/sagetest/issues/413",
    "label": "duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/413#event-1703"
}
```
