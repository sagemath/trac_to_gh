...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5746"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5749"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5751"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5752"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5753"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5754"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5755"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5756"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5757"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5758"
}
```
...
```json
{
    ...
    "title_was": "notebook improvement -- upload allow txt worksheets.",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5759"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5760"
}
```
...
```json
{
    ...
    "title_was": "notebook improvement -- upload allow txt worksheets.",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5761"
}
```
...
```json
{
    ...
    "title_was": "[negative review] notebook improvement -- upload allow txt worksheets.",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5762"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5765"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/637",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/637#event-5766"
}
```
