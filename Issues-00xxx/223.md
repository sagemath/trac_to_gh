...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/223#issuecomment-1037",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/223",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/223#issuecomment-1038",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/223",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/223#issuecomment-1039",
...
```json
{
    "body": "<a id='comment:2'></a>With Sage 2.8.2pre this works for me:\n\n```\nsage: x = PolynomialRing(RationalField(), 'x').gen()\nsage: f1 = x^0\nsage: f2 = 1-x\nsage: f3 = 2*x\nsage: f4 = 10*x-x^2\nsage: f = Piecewise([[(0,1),f1],[(1,2),f2],[(2,3),f3],[(3,10),f4]])\nsage: plot(f)\nGraphics object consisting of 4 graphics primitives\n```",
    "created_at": "2007-08-21T12:36:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/223",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/223#issuecomment-1040",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>With Sage 2.8.2pre this works for me:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/223",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/223#event-455"
}
```
