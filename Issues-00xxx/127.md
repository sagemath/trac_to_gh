...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/127#event-832"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/127#event-833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/127#event-834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/127#event-835"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/127#event-836"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/127",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/127#event-837"
}
```
