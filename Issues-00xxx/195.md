...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/195#event-1204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/195#event-1205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/195#event-1206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/195#event-1207"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/195#event-1208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/195",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/195#event-1209"
}
```
