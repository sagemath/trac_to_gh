...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/845#event-2604"
}
```
...
```json
{
    ...
    "asset_name": "magma_bool.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket845/magma_bool.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/845#issuecomment-5620",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/845#issuecomment-5621",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/845#issuecomment-5622",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/845#event-2605"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/845#event-2606"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/845#event-2607"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/845#issuecomment-5623",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/845#issuecomment-5624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/845#issuecomment-5625",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/845",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/845#event-2608"
}
```
