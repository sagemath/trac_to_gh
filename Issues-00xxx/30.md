...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30#event-77"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30#issuecomment-202",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30#event-78"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30#event-79"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30#event-80"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30#issuecomment-203",
    "user": "https://github.com/williamstein"
}
```
