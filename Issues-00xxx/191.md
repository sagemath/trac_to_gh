...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-945",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-946",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-947",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-948",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>CC'ing myself.",
    "created_at": "2009-06-27T00:52:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-949",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:6'></a>CC'ing myself.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-950",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-951",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-952",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-953",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>See #7239",
    "created_at": "2010-07-08T14:17:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-954",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:8'></a>See #7239
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-955",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-956",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Please do not close tickets yourself. Only release managers have the authority to do this.",
    "created_at": "2010-07-08T19:20:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-957",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:9'></a>Please do not close tickets yourself. Only release managers have the authority to do this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-958",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-959",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>What I usually do in this situation is to set the ticket to \"needs review\" with a message saying I think it ought to be closed. Then if someone else agrees, we can set it to \"positive review\", and then it'll show up in the list of tickets to be merged in the next release. Then the release manager will close it. In this case, I've put it at \"positive review\", since I agree with your claim that it should be fixed. \n\nBTW, I'm not sure \"duplicate\" is fair; this ticket has been open for years, so #7239 was a duplicate of this one rather than the other way round. Perhaps \"fixed\" is the most appropriate resolution. But that is for the release manager to decide.",
    "created_at": "2010-07-08T19:23:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-960",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:11'></a>What I usually do in this situation is to set the ticket to "needs review" with a message saying I think it ought to be closed. Then if someone else agrees, we can set it to "positive review", and then it'll show up in the list of tickets to be merged in the next release. Then the release manager will close it. In this case, I've put it at "positive review", since I agree with your claim that it should be fixed. 
...
```json
{
    "body": "<a id='comment:12'></a>I'm resolving this as a \"duplicate,\" simply because the only relevant milestone is \"sage-duplicate/invalid/wontfix.\"",
    "created_at": "2010-07-20T09:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-961",
    "user": "https://github.com/qed777"
}
```

<a id='comment:12'></a>I'm resolving this as a "duplicate," simply because the only relevant milestone is "sage-duplicate/invalid/wontfix."
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/191#issuecomment-962",
    "user": "https://github.com/qed777"
}
```
