...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/684#issuecomment-3824",
...
```json
{
    "body": "<a id='comment:1'></a>This isn't a bug, it's a lack of something that would be nice being implemented (because we never got to it).\n\nIt's easy to do this:\n\n```\nsage: Integer(repr(ntl.ZZ_random(1000)))\n937\n```\n\nHowever, that uses base 10 strings.   It would be much better to get at the underlying\nNTL pointer to some GMP data.  I have no clue how to do that. \n\nWilliam",
    "created_at": "2007-09-18T00:54:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/684#issuecomment-3825",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This isn't a bug, it's a lack of something that would be nice being implemented (because we never got to it).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/684#issuecomment-3826",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/684#issuecomment-3827",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/684#issuecomment-3828",
...
```json
{
    "body": "<a id='comment:4'></a>Yep, this fully works now, and is implemented in ntl_wrap.cpp.  Nice.",
    "created_at": "2007-10-19T01:10:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/684#issuecomment-3829",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Yep, this fully works now, and is implemented in ntl_wrap.cpp.  Nice.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/684#issuecomment-3830",
    "user": "https://github.com/williamstein"
}
```
