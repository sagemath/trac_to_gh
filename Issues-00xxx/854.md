...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/854#issuecomment-5558",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/854#issuecomment-5559",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/854",
    "rename": {
        "from": "[with patch] memory leak: MultiModularBasis_base_mpz_crt_vec_tail",
        "to": "[with patch] [tested by cwitty] memory leak: MultiModularBasis_base_mpz_crt_vec_tail"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/854#event-2911"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/854",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/854#issuecomment-5560",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/854",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/854#event-2912"
}
```
