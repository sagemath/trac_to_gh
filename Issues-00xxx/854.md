# Issue 854: [with patch] [tested by cwitty] memory leak: MultiModularBasis_base_mpz_crt_vec_tail
...
```json
{
    ...
    "title": "[with patch] [tested by cwitty] memory leak: MultiModularBasis_base_mpz_crt_vec_tail",
    "type": "issue",
