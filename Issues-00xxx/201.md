...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/201#issuecomment-658",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/201#issuecomment-659",
...
archive/attachments_000047.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "options.h",
    "asset_url": "tarball://root/attachments/ticket201/options.h",
    "created_at": "2007-08-17T14:35:10Z",
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket201/options.h",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [options.h](https://github.com/sagemath/sage/files/ticket201/options.h) by @williamstein created at 2007-08-17 14:35:10",
    "created_at": "2007-08-17T14:35:10Z",
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/201#issuecomment-660",
    "user": "https://github.com/williamstein"
}
```

Attachment [options.h](https://github.com/sagemath/sage/files/ticket201/options.h) by @williamstein created at 2007-08-17 14:35:10
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/201#event-675"
}
```
...
archive/attachments_000048.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "realroots.cc",
    "asset_url": "tarball://root/attachments/ticket201/realroots.cc",
    "created_at": "2007-08-18T21:18:23Z",
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket201/realroots.cc",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [realroots.cc](https://github.com/sagemath/sage/files/ticket201/realroots.cc) by @williamstein created at 2007-08-18 21:18:23",
    "created_at": "2007-08-18T21:18:23Z",
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/201#issuecomment-661",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/201#event-676"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/201#event-677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/201#issuecomment-662",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/201#issuecomment-663",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/201#event-678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/201#issuecomment-664",
    "user": "https://github.com/williamstein"
}
```
