...
```json
{
    "body": "<a id='comment:1'></a>For the matching discussion in sage-devel see http://groups.google.com/group/sage-devel/t/813495b9968f3ed5\n\nHello Nils,\n\na quick grep revealed that this is very likely a problem in LinBox,\nspecifically somewhere in\n\n   linbox/algorithms/rational-reconstruction.h\n\nIf LinBox returns an error and if Sage doesn't catch that error I\ncannot tell you.\n\nCheers,\n\nMichael",
    "created_at": "2007-08-28T06:43:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/498#issuecomment-2588",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>For the matching discussion in sage-devel see http://groups.google.com/group/sage-devel/t/813495b9968f3ed5
...
```json
{
    "body": "<a id='comment:2'></a>This is actually an open ticket at the LinBox trac: see http://linalg.org/projects/linalg/ticket/3\n\nCheers,\n\nMichael",
    "created_at": "2007-08-28T08:33:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/498#issuecomment-2589",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This is actually an open ticket at the LinBox trac: see http://linalg.org/projects/linalg/ticket/3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/498#issuecomment-2591",
...
```json
{
    "body": "<a id='comment:5'></a>Clement Pernet is investigating the issue. Once he has a patch we will probably just patch the current LinBox.spkg.\n\nCheers,\n\nMichael",
    "created_at": "2007-08-28T18:25:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/498#issuecomment-2592",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Clement Pernet is investigating the issue. Once he has a patch we will probably just patch the current LinBox.spkg.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/498#issuecomment-2593",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Due to some oversight the new spkg never made it in the 2.8.3 release. We now have an updated spkg with a proper fix (the one above was just a workaround which reduce performance significantly). For more see ticket #581.\n\nCheers,\n\nMichael",
    "created_at": "2007-09-03T19:40:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/498#issuecomment-2594",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Due to some oversight the new spkg never made it in the 2.8.3 release. We now have an updated spkg with a proper fix (the one above was just a workaround which reduce performance significantly). For more see ticket #581.
