...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/189#event-1268"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/189#event-1269"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/189#event-1270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/189#event-1271"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/189#event-1272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/189",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/189#event-1273"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/189",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/189#issuecomment-628",
    "user": "https://github.com/williamstein"
}
```
