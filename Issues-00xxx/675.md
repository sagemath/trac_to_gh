...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/675#issuecomment-3776",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/675#issuecomment-3777",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This has been fixed in 2.9.x when making sure that 64 bits values in 32 bit mode on Solaris are long long.\n\nCheers,\n\nMichael",
    "created_at": "2008-01-20T20:14:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/675#issuecomment-3778",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This has been fixed in 2.9.x when making sure that 64 bits values in 32 bit mode on Solaris are long long.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/675#issuecomment-3779",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
