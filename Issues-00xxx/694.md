...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/694#issuecomment-3918",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/694#issuecomment-3920",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/694#issuecomment-3922",
...
```json
{
    "body": "<a id='comment:5'></a>Attached is a patch (6546) which makes use of the new SINGULAR spkg found at \n\nhttp://sage.math.washington.edu/home/malb/pkgs/singular-3-0-3-1-20070929.spkg\n\nwhich provides a multimodular GCD.",
    "created_at": "2007-10-01T23:22:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/694#issuecomment-3923",
    "user": "https://github.com/malb"
}
```

<a id='comment:5'></a>Attached is a patch (6546) which makes use of the new SINGULAR spkg found at 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/694#issuecomment-3924",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/694#issuecomment-3925",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/694#issuecomment-3926",
    "user": "https://github.com/williamstein"
}
```
