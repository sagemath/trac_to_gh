...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5595"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5598"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5599"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5600"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-jbmohler** to **@malb**",
    "created_at": "2007-10-01T23:22:40Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/694#issuecomment-2629",
    "user": "https://github.com/malb"
}
```

Changed assignee from **@sagetrac-jbmohler** to **@malb**
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5601"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5602"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/694",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/694#event-5603"
}
```
