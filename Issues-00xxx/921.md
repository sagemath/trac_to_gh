...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/921#issuecomment-6141",
...
```json
{
    "body": "<a id='comment:1'></a>I'm attaching a patch which catches the divergence error and moves it farther up the chain so that the user isn't presented with such a huge error.\n\nHere is the behavior after the patch:\n\n```\nsage: integrate(1/x^3,x,0,1)\n---------------------------------------------------------------------------\n<type 'exceptions.ValueError'>            Traceback (most recent call last)\n\n/opt/sage/devel/sage-calc/sage/calculus/<ipython console> in <module>()\n\n/opt/sage/local/lib/python2.5/site-packages/sage/calculus/functional.py in integral(f, *args, **kwds)\n    175         return f.integral(*args, **kwds)\n    176     except ValueError, err:\n--> 177         raise err\n    178     except AttributeError:\n    179         pass\n\n<type 'exceptions.ValueError'>: Integral is divergent.\n```",
    "created_at": "2007-10-24T00:36:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/921#issuecomment-6142",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>I'm attaching a patch which catches the divergence error and moves it farther up the chain so that the user isn't presented with such a huge error.
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [921.patch](tarball://root/attachments/some-uuid/ticket921/921.patch) by @mwhansen created at 2007-10-24 00:38:52",
    "created_at": "2007-10-24T00:38:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/921#issuecomment-6143",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>Attachment [921.patch](tarball://root/attachments/some-uuid/ticket921/921.patch) by @mwhansen created at 2007-10-24 00:38:52
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/921#issuecomment-6144",
...
```json
{
    "body": "<a id='comment:4'></a>applied to 2.8.9.alpha1",
    "created_at": "2007-10-24T19:24:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/921#issuecomment-6145",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>applied to 2.8.9.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/921#issuecomment-6146",
    "user": "https://github.com/malb"
}
```
