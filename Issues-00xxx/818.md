...
```json
{
    ...
    "asset_name": "prod.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket818/prod.hg",
...
```json
{
    "body": "convert to cython bundle",
    "created_at": "2007-10-04T01:34:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/818#issuecomment-5473",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/818#issuecomment-5474",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/818",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/818#event-2516"
}
```
