...
```json
{
    "body": "<a id='comment:3'></a>The workaround now is to use the timeit command, which does send things to the preparser.\n\n```\nsage: timeit('[1..10]')\n625 loops, best of 3: 220 \u00b5s per loop\n```",
    "created_at": "2009-01-14T08:08:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5177",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>The workaround now is to use the timeit command, which does send things to the preparser.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5178",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Just because there is a workaround doesn't mean this should be closed.  I reported this problem to Fernando Perez of Ipython and he \"admitted\" that it is a bug, and was working on fixing it at that last sage days.  I'm re-opening this.\n\nBy the way, it's generally very bad for anybody but me or Michael Abshoff to close tickets on trac!",
    "created_at": "2009-01-14T16:49:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5179",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>Just because there is a workaround doesn't mean this should be closed.  I reported this problem to Fernando Perez of Ipython and he "admitted" that it is a bug, and was working on fixing it at that last sage days.  I'm re-opening this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5180",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5181",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I only closed it after mabshoff gave his okay on IRC.  I guess I should have posted the IRC log.",
    "created_at": "2009-01-14T17:29:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5182",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:6'></a>I only closed it after mabshoff gave his okay on IRC.  I guess I should have posted the IRC log.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5183",
...
```json
{
    "body": "<a id='comment:8'></a>We can overwrite the default magic commands in IPython:\n\n```\nsage: _ip.expose_magic(\"timeit\", lambda self, s: timeit(s))\nsage: %timeit [1..10]\n625 loops, best of 3: 58.4 \u00b5s per loop\n```",
    "created_at": "2009-01-21T20:19:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5184",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:8'></a>We can overwrite the default magic commands in IPython:
...
```json
{
    "body": "<a id='comment:10'></a>Are you doing this in the notebook or the command-line?  They're two totally separate things.\n\nCan you hop on IRC?",
    "created_at": "2009-01-21T20:52:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5186",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:10'></a>Are you doing this in the notebook or the command-line?  They're two totally separate things.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5188",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5189",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>In `preparse_ipython`, lines starting with `%` have not been changed unless they refer to some interface. I added support for `%timeit`.\n\nIdea: Call `timeit.eval`\n\nWith the patch, the following examples now work:\n\n```\nsage: %timeit [1..10]\n625 loops, best of 3: 127 \u00c2\u00b5s per loop\nsage: %timeit 'a'==\"a\"\n625 loops, best of 3: 285 ns per loop\n```\nand the other ways of calling the timer still work:\n\n```\nsage: %time [1..10]\nCPU times: user 0.00 s, sys: 0.00 s, total: 0.00 s\nsage: timeit('[1..10]')\n625 loops, best of 3: 127 \u00c2\u00b5s per loop\n```",
    "created_at": "2009-01-21T22:11:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5190",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:13'></a>In `preparse_ipython`, lines starting with `%` have not been changed unless they refer to some interface. I added support for `%timeit`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5191",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5192",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>To emphasize another detail: My suggestion only relates with `%timeit` on the command line, not on the notebook.",
    "created_at": "2009-01-22T19:38:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5193",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:15'></a>To emphasize another detail: My suggestion only relates with `%timeit` on the command line, not on the notebook.
...
```json
{
    "body": "<a id='comment:16'></a>This patch works for me, but I think mhansen ought to comment on this approach versus the approach he advocated above using `_ip.expose_magic(\"timeit\", lambda self, s: timeit(s))`",
    "created_at": "2009-01-28T17:36:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5194",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:16'></a>This patch works for me, but I think mhansen ought to comment on this approach versus the approach he advocated above using `_ip.expose_magic("timeit", lambda self, s: timeit(s))`
...
```json
{
    "body": "<a id='comment:17'></a>The _ip.expose_magic approach also seems to work just as well.  I would prefer using the ipython mechanism for doing this, rather than complicating the preparser.\n\nIn fact, I'd suggest using ipython to do all of the %mode functionality as well, if it's a possibility.",
    "created_at": "2009-01-28T17:38:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5195",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:17'></a>The _ip.expose_magic approach also seems to work just as well.  I would prefer using the ipython mechanism for doing this, rather than complicating the preparser.
...
```json
{
    "body": "<a id='comment:20'></a>Changing this to \"needs work\" in light of mhansen's solution above.",
    "created_at": "2009-04-22T02:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5198",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:20'></a>Changing this to "needs work" in light of mhansen's solution above.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5199",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5200",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5201",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>I've put a patch up which implements the expose_magic idea.",
    "created_at": "2010-01-17T07:32:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5202",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:21'></a>I've put a patch up which implements the expose_magic idea.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5203",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Looks great!  Positive review to Mike's patch.  Only apply Mike's patch (to the local/bin repository!)",
    "created_at": "2010-01-17T08:40:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5204",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:22'></a>Looks great!  Positive review to Mike's patch.  Only apply Mike's patch (to the local/bin repository!)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5205",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5206",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5207",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/797#issuecomment-5208",
    "user": "https://github.com/rlmill"
}
```
