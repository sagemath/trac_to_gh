# Issue 761: [with patch] graphs: Lots of various doc changes and additional doc tests.
...
```json
{
    ...
    "title": "[with patch] graphs: Lots of various doc changes and additional doc tests.",
    "type": "issue",
...
```json
{
    "body": "Attachment [#761.patch](tarball://root/attachments/some-uuid/ticket761/#761.patch) by @jasongrout created at 2007-10-03 07:53:52\n\nSame patch as listed in the post.",
    "created_at": "2007-10-03T07:53:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/761#issuecomment-4496",
    "user": "https://github.com/jasongrout"
}
```

Attachment [#761.patch](tarball://root/attachments/some-uuid/ticket761/#761.patch) by @jasongrout created at 2007-10-03 07:53:52
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/761#event-2079"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/761",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/761#event-2080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/761#issuecomment-4497",
...
```json
{
    ...
    "milestone": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/761#event-2081"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/761#event-2082"
}
```
