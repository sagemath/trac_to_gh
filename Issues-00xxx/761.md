...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket761/80df1c1419005824c60547e230e70959.patch",
    "created_at": "2007-10-03T07:53:52Z",
    "issue": "https://github.com/sagemath/sage/issues/761",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket761/80df1c1419005824c60547e230e70959.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [#761.patch](https://github.com/sagemath/sage/files/ticket761/80df1c1419005824c60547e230e70959.patch) by @jasongrout created at 2007-10-03 07:53:52\n\nSame patch as listed in the post.",
    "created_at": "2007-10-03T07:53:52Z",
    "issue": "https://github.com/sagemath/sage/issues/761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/761#issuecomment-3391",
    "user": "https://github.com/jasongrout"
}
```

Attachment [#761.patch](https://github.com/sagemath/sage/files/ticket761/80df1c1419005824c60547e230e70959.patch) by @jasongrout created at 2007-10-03 07:53:52
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/761#event-3469"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/761#event-3470"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/761",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/761#event-3471"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/761#event-3472"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/761#event-3473"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/761#issuecomment-3392",
