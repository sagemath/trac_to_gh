...
```json
{
    "body": "<a id='comment:1'></a>Did this ever work?  Is this really a feature request?",
...
<a id='comment:1'></a>Did this ever work?  Is this really a feature request?
...
```json
{
    "body": "<a id='comment:3'></a>Fixed in attached patch.",
    "created_at": "2007-10-20T21:46:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/688",
    "type": "issue_comment",
...
<a id='comment:3'></a>Fixed in attached patch.
...
```json
{
    "body": "<a id='comment:6'></a>inst.tex.hg is a bundle against hg_sage.  You accidently did hg_sage.send('...') instead of\nhg_doc.send('...').  Please create a bundle against the docs.",
    "created_at": "2007-10-20T21:52:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/688",
    "type": "issue_comment",
...
<a id='comment:6'></a>inst.tex.hg is a bundle against hg_sage.  You accidently did hg_sage.send('...') instead of
hg_doc.send('...').  Please create a bundle against the docs.
...
```json
{
    "body": "<a id='comment:7'></a>That comment was meant for a different ticket. Sorry.",
...
<a id='comment:7'></a>That comment was meant for a different ticket. Sorry.
