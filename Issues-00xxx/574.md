...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/574",
...
```json
{
    "body": "<a id='comment:1'></a>I think this is due to confusion in the many ways of representing state. We should come up with a list of all the ways state can be represented/inputted, and make sure all functions can accept that kind of state. \n\n- Robert",
    "created_at": "2007-09-03T16:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-3083",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>I think this is due to confusion in the many ways of representing state. We should come up with a list of all the ways state can be represented/inputted, and make sure all functions can accept that kind of state. 
...
```json
{
    "body": "Changing assignee from @wdjoyner to @robertwb.",
    "created_at": "2007-09-03T16:30:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-3084",
    "user": "https://github.com/robertwb"
}
```

Changing assignee from @wdjoyner to @robertwb.
...
```json
{
    "body": "<a id='comment:2'></a>See #570",
    "created_at": "2007-09-06T19:34:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-3085",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>See #570
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/574#issuecomment-3086",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/574",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/574#event-1537"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/574#event-1538"
}
```
