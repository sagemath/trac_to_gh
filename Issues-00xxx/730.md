...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6066"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6067"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6068"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6069"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6070"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **rlmiller**",
    "created_at": "2007-09-21T18:50:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/730",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/730#issuecomment-3226",
    "user": "https://github.com/williamstein"
}
```

Changed assignee from **@williamstein** to **rlmiller**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/730",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/730#issuecomment-3227",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/730",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/730#issuecomment-3228",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6071"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6072"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/730",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6073"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6074"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6075"
}
```
