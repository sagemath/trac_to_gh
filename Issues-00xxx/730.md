...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6008"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6010"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6011"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **@sagetrac-rlmiller**",
    "created_at": "2007-09-21T18:50:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/730",
    "type": "issue_comment",
...
Changed assignee from **@williamstein** to **@sagetrac-rlmiller**
...
```json
{
    ...
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6012"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6013"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/730",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6014"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6015"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/730#event-6016"
}
```
