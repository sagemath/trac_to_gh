...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/521#event-1563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/521#issuecomment-2731",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/521#event-1564"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/521#event-1565"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/521#issuecomment-2732",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/521#issuecomment-2733",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/521#issuecomment-2734",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with partial patch, needs review] put a doctest for every single function schemes/elliptic_curves/monsky_washnitzer.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/521#event-1566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/521#issuecomment-2735",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/521#issuecomment-2736",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "rename": {
        "from": "[with partial patch, needs review] put a doctest for every single function schemes/elliptic_curves/monsky_washnitzer.py",
        "to": "[with partial patch, positive review] put a doctest for every single function schemes/elliptic_curves/monsky_washnitzer.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/521#event-1567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/521",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/521#event-1568"
}
```
