...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket630/combinat.hg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/630#issuecomment-2407",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/630#issuecomment-2408",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/630#event-2788"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/630#event-2789"
}
```
...
archive/attachments_000268.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "tut.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket630/tut.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/630#issuecomment-2409",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/630",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/630#event-2790"
}
```
...
archive/attachments_000269.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "combinat.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket630/combinat.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/630#issuecomment-2410",
    "user": "https://github.com/mwhansen"
}
```
...
archive/attachments_000270.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "combinat2.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket630/combinat2.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/630#issuecomment-2411",
    "user": "https://github.com/nthiery"
}
```
