...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/158#issuecomment-740",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/158",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/158#issuecomment-741",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>fixed -- was an easy addition to sage-spkg",
    "created_at": "2006-11-06T07:52:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/158",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/158#issuecomment-742",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>fixed -- was an easy addition to sage-spkg
