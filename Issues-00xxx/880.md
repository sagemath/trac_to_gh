...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/880#issuecomment-5940",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>There was a copy-and-paste error that ended up reading uninitialized local variables, causing crashes on some machines.  Remove this incorrect, redundant code.",
    "created_at": "2007-10-13T21:47:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/880#issuecomment-5941",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:1'></a>There was a copy-and-paste error that ended up reading uninitialized local variables, causing crashes on some machines.  Remove this incorrect, redundant code.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/880#issuecomment-5942",
