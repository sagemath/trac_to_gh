...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/880#issuecomment-5721",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/880#issuecomment-5722",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/880",
    "rename": {
        "from": "2.8.7-alpha0: many segfaults when running doctests on 32-bit x86 Linux",
        "to": "[with patch] 2.8.7-alpha0: many segfaults when running doctests on 32-bit x86 Linux"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/880#event-2997"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/880#event-2998"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/880#issuecomment-5723",
