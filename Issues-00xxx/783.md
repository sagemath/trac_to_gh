...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5066",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [783-dilog_lame.patch](tarball://root/attachments/some-uuid/ticket783/783-dilog_lame.patch) by @aghitza created at 2008-04-19 14:41:38\n\nBut polylog is implemented to a more serious extent, in calculus.py.  I think we should just have dilog(z) be an alias for polylog(2, z).\n\nI've put up a patch making this change.",
    "created_at": "2008-04-19T14:41:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5067",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:2'></a>Attachment [783-dilog_lame.patch](tarball://root/attachments/some-uuid/ticket783/783-dilog_lame.patch) by @aghitza created at 2008-04-19 14:41:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5068",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5070",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5071",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5072",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5073",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5074",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I'd like to reopen this ticket, since the fix only corrected integer input (here with Sage 4.3.1):\n\n```\nsage: dilog(-1.1)\nERROR: An unexpected error occurred while tokenizing input\nThe following traceback may be corrupted or invalid\nThe error message is: ('EOF in multi-line statement', (2251, 0))\n\n---------------------------------------------------------------------------\nNotImplementedError                       Traceback (most recent call last\n```\nPari knows how to compute this:\n\n```\nsage: gp.dilog(-1.1)\n-0.89083809026228267332015894927022713036\n```",
    "created_at": "2010-02-07T10:44:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5075",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:6'></a>I'd like to reopen this ticket, since the fix only corrected integer input (here with Sage 4.3.1):
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5076",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5077",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5078",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>The patch had some typos so I uploaded a correct version.  The +Infinity/-Infinity thing should probably be a new ticket as it's something that should be done in a manner consistent for all functions.",
    "created_at": "2010-08-30T18:12:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5080",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:10'></a>The patch had some typos so I uploaded a correct version.  The +Infinity/-Infinity thing should probably be a new ticket as it's something that should be done in a manner consistent for all functions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5081",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5082",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>good work, Mike!",
    "created_at": "2010-09-01T14:54:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5083",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:11'></a>good work, Mike!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5084",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>The function `syntactically_equal()` in attachment:trac_783.patch doesn't contain doctests. I don't see how the changes to `sage/symbolic/expression.pyx` in that patch are relevant to this ticket. Perhaps these should be on a different ticket.",
    "created_at": "2010-09-12T12:05:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5085",
    "user": "https://github.com/burcin"
}
```

<a id='comment:12'></a>The function `syntactically_equal()` in attachment:trac_783.patch doesn't contain doctests. I don't see how the changes to `sage/symbolic/expression.pyx` in that patch are relevant to this ticket. Perhaps these should be on a different ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5086",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5087",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5088",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5089",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Sorry about that -- I'm not sure how those changes snuck into that patch.",
    "created_at": "2010-09-12T17:00:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5090",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:14'></a>Sorry about that -- I'm not sure how those changes snuck into that patch.
...
```json
{
    "body": "<a id='comment:15'></a>> Sorry about that -- I'm not sure how those changes snuck into that patch. \n\n\nI'm sorry I didn't see that during my review. Anyway I confirm all doctests still pass\n(tested with Sage 4.5.2).\n\nPaul",
    "created_at": "2010-09-13T10:13:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5091",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:15'></a>> Sorry about that -- I'm not sure how those changes snuck into that patch. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5092",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/783#issuecomment-5093",
    "user": "https://github.com/qed777"
}
```
