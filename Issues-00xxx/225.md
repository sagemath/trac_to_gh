...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket225/5821.patch",
    "created_at": "2007-08-23T06:00:56Z",
    "issue": "https://github.com/sagemath/sage/issues/225",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket225/5821.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [5821.patch](https://github.com/sagemath/sage/files/ticket225/5821.patch) by @williamstein created at 2007-08-23 06:00:56",
    "created_at": "2007-08-23T06:00:56Z",
    "issue": "https://github.com/sagemath/sage/issues/225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/225#issuecomment-722",
    "user": "https://github.com/williamstein"
}
```

Attachment [5821.patch](https://github.com/sagemath/sage/files/ticket225/5821.patch) by @williamstein created at 2007-08-23 06:00:56
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/225",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/225#event-752"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/225#event-753"
}
```
