...
```json
{
    "body": "<a id='comment:1'></a>Well, as it turned out the pari only instantiates its stack ones. The problem is caused by some reference not being freed, so it is very likely a Cython issue.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-01T03:28:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/718#issuecomment-4322",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Well, as it turned out the pari only instantiates its stack ones. The problem is caused by some reference not being freed, so it is very likely a Cython issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/718#issuecomment-4323",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is no longer a problem in Sage 3.1.1, so close it as fixed. Who fixed it we will never know :)\n\nCheers,\n\nMichael",
    "created_at": "2008-08-27T01:20:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/718#issuecomment-4324",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>This is no longer a problem in Sage 3.1.1, so close it as fixed. Who fixed it we will never know :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/718",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/718#issuecomment-4325",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
