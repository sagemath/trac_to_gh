...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/995#issuecomment-6349",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/995",
    "rename": {
        "from": "Generalize polynomial .roots() method by adding optional ring= parameter for result ring",
        "to": "[with patch] Generalize polynomial .roots() method by adding optional ring= parameter for result ring"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/995#event-3392"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/995#issuecomment-6350",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/995#event-3393"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/995#issuecomment-6351",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/995#issuecomment-6352",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/995#issuecomment-6353",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/995#issuecomment-6354",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/995",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/995#event-3394"
}
```
