...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/492#issuecomment-2702",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/492#event-1256"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This issue has been resolved by the NTL rewrite a couple releases ago.\n\nCheers,\n\nMichael",
    "created_at": "2007-12-06T20:55:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/492#issuecomment-2703",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This issue has been resolved by the NTL rewrite a couple releases ago.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/492#issuecomment-2704",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/492",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/492#event-1257"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Resolved with an unknown release before 2.9.alpha1.",
    "created_at": "2007-12-06T20:56:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/492#issuecomment-2705",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Resolved with an unknown release before 2.9.alpha1.
