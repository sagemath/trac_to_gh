...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7252"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7253"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7256"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7258"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7259"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7261"
}
```
...
```json
{
    ...
    "title_was": "Interface to QEPCAD for quantifier elimination and solving systems of inequalities",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7262"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7263"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7264"
}
```
...
```json
{
    ...
    "title_was": "Interface to QEPCAD for quantifier elimination and solving systems of inequalities",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7265"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7266"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7268"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7269"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7270"
}
```
...
```json
{
    ...
    "title_was": "Interface to QEPCAD for quantifier elimination and solving systems of inequalities",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7271"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/772#event-7272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/772#issuecomment-3274",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
