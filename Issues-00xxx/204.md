...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/204#issuecomment-1001",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This is now fixed for sage > 1.8.  The problem in involved the \nreal number constructor.   While I was at it, I optimized that a lot.",
    "created_at": "2007-01-23T21:50:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/204#issuecomment-1002",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>This is now fixed for sage > 1.8.  The problem in involved the 
real number constructor.   While I was at it, I optimized that a lot.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/204#issuecomment-1003",
    "user": "https://github.com/williamstein"
}
```
