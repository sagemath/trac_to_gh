...
```json
{
    "body": "<a id='comment:7'></a>Fixed in #1261 (PBuild)",
...
<a id='comment:7'></a>Fixed in #1261 (PBuild)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22#issuecomment-182",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22#issuecomment-183",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Mhh, looking at the complete ticket history this patch does not cover all what needs to be fixed on this ticket. I will post a patch on top that also fixes this issue.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-16T17:46:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22#issuecomment-184",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Mhh, looking at the complete ticket history this patch does not cover all what needs to be fixed on this ticket. I will post a patch on top that also fixes this issue.
...
```json
{
    "body": "<a id='comment:12'></a>Unfortunately the trick William suggested does not work everywhere, i.e. even on the latest stable Debian release this happens:\n\n```\nmabshoff@modular:~$ uname -p\nunknown\n```\nFrom **man uname** on that box:\n\n```\n       -p, --processor\n              print the processor type or \"unknown\"\n```\n\nSo we might want to make that part of the ticket a followup ticket.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-16T17:50:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22#issuecomment-185",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Unfortunately the trick William suggested does not work everywhere, i.e. even on the latest stable Debian release this happens:
...
```json
{
    "body": "<a id='comment:14'></a>This is a \"perfect patch.\"\n\n... ;-)",
    "created_at": "2009-01-22T17:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22#issuecomment-187",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:14'></a>This is a "perfect patch."
...
```json
{
    "body": "<a id='comment:15'></a>Merged in Sage 3.3.alpha1.\n\nNote that the remaining issue from this ticket has been moved to #5062.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-23T00:34:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22#issuecomment-188",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>Merged in Sage 3.3.alpha1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22#issuecomment-189",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
