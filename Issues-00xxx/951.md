...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/951#issuecomment-6082",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/951",
    "rename": {
        "from": "evaluating polynomial over Z/nZ produces incorrect type",
        "to": "[with patch] evaluating polynomial over Z/nZ produces incorrect type"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/951#event-3232"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/951#event-3233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/951#issuecomment-6083",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/951",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/951#event-3234"
}
```
