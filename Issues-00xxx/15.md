...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15#event-89"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15#event-90"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15#event-91"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15#event-92"
}
```
