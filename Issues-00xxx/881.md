...
```json
{
    "body": "<a id='comment:1'></a>This is a bug, but I should be realistic and wait for sage-2.8.8 -- we can't fix every possible bug before\nevery release.",
    "created_at": "2007-10-14T05:16:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/881#issuecomment-5943",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This is a bug, but I should be realistic and wait for sage-2.8.8 -- we can't fix every possible bug before
every release.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/881",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/881#issuecomment-5944",
