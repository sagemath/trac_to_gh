# Issue 740: [with positive review] Implement standard transformations for elliptic curves & points
...
```json
{
    ...
    "title": "[with positive review] Implement standard transformations for elliptic curves & points",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4603",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4604",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4605",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4606",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "asset_name": "eciso.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket740/eciso.hg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4607",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4608",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket740/8087.patch",
...
```json
{
    "body": "This coimpletely replaces the previous patch (eciso.hg)",
    "created_at": "2008-01-27T03:44:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4609",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket740/8088.patch",
...
```json
{
    "body": "Minor additional patch to 8087.patch (fix 2 doctests)",
    "created_at": "2008-01-27T04:00:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4610",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4611",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "rename": {
        "from": "Implement standard transformations for elliptic curves & points",
        "to": "[with positive review] Implement standard transformations for elliptic curves & points"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4612",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4613",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2209"
}
```
