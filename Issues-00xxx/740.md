...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4498",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2407"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] Implement standard transformations for elliptic curves & points"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4499",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "rename": {
        "from": "[with patch] Implement standard transformations for elliptic curves & points",
        "to": "Implement standard transformations for elliptic curves & points"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2409"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4500",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4501",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2410"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4502",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4503",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4504",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4505",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4506",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch] Implement standard transformations for elliptic curves & points",
        "to": "[with patch, with positive review] Implement standard transformations for elliptic curves & points"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2411"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4507",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/740#issuecomment-4508",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/740",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/740#event-2412"
}
```
