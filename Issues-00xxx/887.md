...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/887#issuecomment-5745",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/887",
    "rename": {
        "from": "2.8.7-alpha0: doctest failure in rings/polynomial/real_roots.pyx",
        "to": "[with patch] 2.8.7-alpha0: doctest failure in rings/polynomial/real_roots.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/887#event-3011"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/887#issuecomment-5746",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/887",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/887#event-3012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/887#issuecomment-5747",
