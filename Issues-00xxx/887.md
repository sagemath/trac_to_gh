# Issue 887: [with patch] 2.8.7-alpha0: doctest failure in rings/polynomial/real_roots.pyx
...
```json
{
    ...
    "title": "[with patch] 2.8.7-alpha0: doctest failure in rings/polynomial/real_roots.pyx",
    "type": "issue",
