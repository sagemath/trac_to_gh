...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2642",
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_508.patch](tarball://root/attachments/some-uuid/ticket508/trac_508.patch) by anakha created at 2008-10-24 00:37:26\n\nFixes the problem by emulating load and attach.\n\nIt won't work with files that have spaces in their name because sage, sage-sage, sage-run, and various other are not ready to deal with that, yet.",
    "created_at": "2008-10-24T00:37:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2645",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```

<a id='comment:4'></a>Attachment [trac_508.patch](tarball://root/attachments/some-uuid/ticket508/trac_508.patch) by anakha created at 2008-10-24 00:37:26
...
```json
{
    "body": "<a id='comment:5'></a>This doesn't work because when sage-eval gets run the working directory is local/bin/, so the file test.sage isn't found.  I bet you tested this patch with test.sage in SAGE_ROOT/local/bin/, which is the only case when this will work:\n\n```\nteragon-2:sage-3.2 wstein$ more test.sage\nprint \"Hi\"\nteragon-2:sage-3.2 wstein$ ./sage -c \"load test.sage\"\n/Users/wstein/sage/build/sage-3.2/local/bin/sage-preparse: File test.sage is missing\npython: can't open file 'test.py': [Errno 2] No such file or directory\nteragon-2:sage-3.2 wstein$ cp test.sage local/bin/\nteragon-2:sage-3.2 wstein$ ./sage -c \"load test.sage\"\nHi\n```",
    "created_at": "2008-11-27T07:49:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2646",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>This doesn't work because when sage-eval gets run the working directory is local/bin/, so the file test.sage isn't found.  I bet you tested this patch with test.sage in SAGE_ROOT/local/bin/, which is the only case when this will work:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2647",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2648",
    "user": "https://trac.sagemath.org/admin/accounts/users/abergeron"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>It did work with 3.1.4 in other directories.  But it doesn't with 3.2 and up as you pointed out.\n\nLast patch fixes this.",
    "created_at": "2008-12-24T04:57:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2649",
    "user": "https://trac.sagemath.org/admin/accounts/users/abergeron"
}
```

<a id='comment:6'></a>It did work with 3.1.4 in other directories.  But it doesn't with 3.2 and up as you pointed out.
...
```json
{
    "body": "<a id='comment:8'></a>Target time for the review: January 12th",
    "created_at": "2008-12-29T21:15:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2650",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:8'></a>Target time for the review: January 12th
...
```json
{
    "body": "<a id='comment:9'></a>Rescheduled for January 18th",
    "created_at": "2009-01-15T21:40:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2651",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:9'></a>Rescheduled for January 18th
...
```json
{
    "body": "<a id='comment:11'></a>Works fine, and looks good to me. (Apply the v2 patch only; tested with Sage 3.2.3)\n\nI adjusted the milestone because this patch does not interfere with the sphinxification.",
    "created_at": "2009-01-18T23:52:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2652",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```

<a id='comment:11'></a>Works fine, and looks good to me. (Apply the v2 patch only; tested with Sage 3.2.3)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2653",
...
```json
{
    "body": "<a id='comment:12'></a>Merged in Sage 3.3.alpha0",
    "created_at": "2009-01-19T06:14:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2654",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Merged in Sage 3.3.alpha0
