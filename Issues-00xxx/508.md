...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] problem with \"sage -c\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "rename": {
        "from": "[with patch; needs review] problem with \"sage -c\"",
        "to": "[with patch; needs work] problem with \"sage -c\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "rename": {
        "from": "[with patch; needs work] problem with \"sage -c\"",
        "to": "[with patch; needs review] problem with \"sage -c\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1500"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1501"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1502"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1503"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] problem with \"sage -c\"",
        "to": "[with patch; needs review, under review by gsw] problem with \"sage -c\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "rename": {
        "from": "[with patch; needs review, under review by gsw] problem with \"sage -c\"",
        "to": "[with patch; needs review] problem with \"sage -c\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2655",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1506"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1507"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] problem with \"sage -c\"",
        "to": "[with patch; positive review] problem with \"sage -c\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2656",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/508#issuecomment-2657",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/508",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/508#event-1509"
}
```
