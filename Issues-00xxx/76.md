...
```json
{
    ...
    "type": "issue",
    "updated_at": "2006-09-23T00:59:49Z",
    "url": "https://github.com/sagemath/sage/issues/76",
...
```json
{
    ...
    "created_at": "2006-09-22T22:28:05Z",
    "event": "labeled",
    "issue": "https://github.com/sagemath/sage/issues/76",
    "label": "https://github.com/sagemath/sage/labels/component%3A%20basic%20arithmetic",
    "label_color": "0000ff",
    "label_name": "component: basic arithmetic",
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/76#event-554"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/76#event-555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/76#event-556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/76",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/76#issuecomment-290",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/76",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/76#event-557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/76",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/76#issuecomment-291",
    "user": "https://github.com/williamstein"
}
```
