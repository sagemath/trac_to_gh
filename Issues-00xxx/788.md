...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5123",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5124",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/788#event-2182"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>There now seem to be quite a number of those. I will post a patch here to attempt to wipe them out.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-31T04:21:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5125",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>There now seem to be quite a number of those. I will post a patch here to attempt to wipe them out.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5126",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5127",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5130",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5131",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5132",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Patch looks good to me. I did not merge the hunk in sage/rings/polynomial/polynomial_element.pyx around line 1942. That can be taken care of down the road. \n\nSince we will do an alpha2 shortly any numerical noise doctest failure can be fixed before rc0, so positive review.\n\nCheers,\n\nMichael",
    "created_at": "2008-10-30T04:26:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5134",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Patch looks good to me. I did not merge the hunk in sage/rings/polynomial/polynomial_element.pyx around line 1942. That can be taken care of down the road. 
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/788#event-2183"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/788#event-2184"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5135",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/788#event-2185"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/788#issuecomment-5136",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
