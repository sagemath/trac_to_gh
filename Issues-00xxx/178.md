...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/178#issuecomment-857",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/178",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/178#event-335"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/178#issuecomment-858",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Input to Sage() is *not* preparsed -- you have to do it.  So 2^250 - 1\nis actually just 251!!  It's \"2 xor 250 minus 1\".",
    "created_at": "2006-12-08T01:31:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/178#issuecomment-859",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Input to Sage() is *not* preparsed -- you have to do it.  So 2^250 - 1
is actually just 251!!  It's "2 xor 250 minus 1".
