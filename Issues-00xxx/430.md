...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/430#issuecomment-2379",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/430#issuecomment-2380",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The factoring now works, but it depends on root finding, which currently sucks. A new ticket will be made for the root problem.",
    "created_at": "2007-08-18T19:15:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/430#issuecomment-2381",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>The factoring now works, but it depends on root finding, which currently sucks. A new ticket will be made for the root problem.
