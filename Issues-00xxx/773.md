...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/773#event-2567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/773#issuecomment-4796",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/773#issuecomment-4797",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "rename": {
        "from": "SAGE drops . from path",
        "to": "[with patch; needs review] SAGE drops . from path"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/773#event-2568"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/773#event-2569"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/773#event-2570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/773#issuecomment-4798",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/773#issuecomment-4799",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "rename": {
        "from": "[with patch; needs review] SAGE drops . from path",
        "to": "[with patch; positive review] SAGE drops . from path"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/773#event-2571"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/773#issuecomment-4800",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/773#event-2572"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/773#issuecomment-4801",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/773#issuecomment-4802",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
