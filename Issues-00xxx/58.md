...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/58#event-147"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/58#event-148"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/58#event-149"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/58",
    "rename": {
        "from": "wanted -- subsets of a set",
        "to": "[with patch] wanted -- subsets of a set"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/58#event-150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/58",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/58#issuecomment-293",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/58",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/58#issuecomment-294",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/58",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/58#event-151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/58",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/58#issuecomment-295",
