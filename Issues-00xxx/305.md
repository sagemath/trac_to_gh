...
```json
{
    "body": "<a id='comment:1'></a>Two more examples of weirdness:\n\n```\nsage: K = pAdicField(5)\nsage: x = K(0)\nsage: x.prec()\n Infinity\nsage: y = loads(dumps(x))\nsage: y.prec()\n <class 'sage.rings.padic_field.pAdicField_generic'>\n```\n\nand\n\n```\nsage: K = pAdicField(5)\nsage: x = K(42)\nsage: x.prec()\n Infinity\nsage: y = loads(dumps(x))\nsage: y.prec()\n '_pAdicField_generic__p'\n```",
    "created_at": "2007-03-03T15:09:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/305#issuecomment-1527",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:1'></a>Two more examples of weirdness:
...
```json
{
    "body": "<a id='comment:2'></a>This is fixed by David Roe's new p-adics in SAGE-2.3.",
    "created_at": "2007-03-06T22:22:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/305#issuecomment-1528",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>This is fixed by David Roe's new p-adics in SAGE-2.3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/305#issuecomment-1529",
    "user": "https://github.com/williamstein"
}
```
