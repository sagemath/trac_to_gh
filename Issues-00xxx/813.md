...
{
    "assignees": [],
    "body": "This should give similar results, but it is inconsistent:\n\n```\nP1.<x>=QQ[]\nL=P1.fraction_field()\nx=L(x)\nP2.<y>=P1[]\n\nf=x+y\n\nP3.<x,y>=QQ[]\n\nP3(f)\n\n0*P3.0+f\n```\n\n---\n\nApply\n\n1. [attachment: trac813_univariate_coerce_from_multivariate.patch.gz](https://github.com/sagemath/sage/files/ticket813/trac813_univariate_coerce_from_multivariate.patch.gz)\n2. [attachment: trac_813_review.patch.gz](https://github.com/sagemath/sage/files/ticket813/trac_813_review.patch.gz)\n\nto the Sage library repository.\n\n\nDepends on #9944\n\nAssignee: **@roed314**\n\nAuthor: **Simon King**\n\nReviewer: **Julian Rueth**\n\nMerged: **sage-4.7.2.alpha3**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/813_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6952"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6956"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6957"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6958"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6959"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6960"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6961"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6965"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6969"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,3 +14,12 @@\n \n 0*P3.0+f\n ```\n+\n+---\n+\n+Apply\n+\n+1. [attachment: trac813_univariate_coerce_from_multivariate.patch.gz](https://github.com/sagemath/sage/files/ticket813/trac813_univariate_coerce_from_multivariate.patch.gz)\n+2. [attachment: trac_813_review.2.patch.gz](https://github.com/sagemath/sage/files/ticket813/trac_813_review.2.patch.gz)\n+\n+to the sage repository.\n``````\n",
    "created_at": "2011-09-21T13:29:28Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/813",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6971"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6976"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/813",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/813#event-6979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/813#issuecomment-3869",
