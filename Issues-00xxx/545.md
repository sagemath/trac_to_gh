...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/545#issuecomment-2849",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/545#issuecomment-2850",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/545#issuecomment-2851",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/545#issuecomment-2852",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/545#issuecomment-2853",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/545#issuecomment-2854",
    "user": "https://github.com/pdenapo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/545#issuecomment-2855",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; has partial positive review] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1663"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1664"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "rename": {
        "from": "[with patch; has partial positive review] polish the new symbolic logic code.",
        "to": "[with patch; needs review] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "rename": {
        "from": "[with patch; needs review] polish the new symbolic logic code.",
        "to": "[with bundle; needs review] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "rename": {
        "from": "[with bundle; needs review] polish the new symbolic logic code.",
        "to": "[with patch; needs review] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1668"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] polish the new symbolic logic code.",
        "to": "[with patch; needs work] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "rename": {
        "from": "[with patch; needs work] polish the new symbolic logic code.",
        "to": "[with patch, needs review] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1670"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1671"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1672"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] polish the new symbolic logic code.",
        "to": "[with patch, needs review, under review by gsw] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1673"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "rename": {
        "from": "[with patch, needs review, under review by gsw] polish the new symbolic logic code.",
        "to": "[with patch, needs review] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1674"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] polish the new symbolic logic code.",
        "to": "[with patch, positive review] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1675"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1676"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "rename": {
        "from": "[with patch, positive review] polish the new symbolic logic code.",
        "to": "[with patch, needs work] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1679"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1680"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs work] polish the new symbolic logic code.",
        "to": "[with new patch; positive review, needs one more reviewer] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1681"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "rename": {
        "from": "[with new patch; positive review, needs one more reviewer] polish the new symbolic logic code.",
        "to": "[with patch; needs work] polish the new symbolic logic code."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1682"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1683"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1684"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1685"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/545",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/545#event-1687"
}
```
