...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/262#issuecomment-1376",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/262#issuecomment-1377",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I have added the code by Alex Ghitza that implements the algorithm mentioned above into SAGE for 2.8.4.2.",
    "created_at": "2007-09-13T05:56:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/262#issuecomment-1378",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>I have added the code by Alex Ghitza that implements the algorithm mentioned above into SAGE for 2.8.4.2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/262#issuecomment-1379",
    "user": "https://github.com/williamstein"
}
```
