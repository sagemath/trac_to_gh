...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/210#event-490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/210#issuecomment-955",
...
```json
{
    ...
    "rename": {
        "from": "discrete log",
        "to": "[with patch, needs review] discrete log and other generic functions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/210#event-491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/210#issuecomment-956",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/210#issuecomment-957",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/210",
    "rename": {
        "from": "[with patch, needs review] discrete log and other generic functions",
        "to": "[with patch, positive review] discrete log and other generic functions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/210#event-492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/210",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/210#event-493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/210#issuecomment-958",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/210",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/210#issuecomment-959",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
