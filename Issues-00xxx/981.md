...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/981#issuecomment-6294",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/981",
    "rename": {
        "from": "bug in the method conjugacy_classes_subgroups",
        "to": "[with patch] bug in the method conjugacy_classes_subgroups"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/981#event-3361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/981#issuecomment-6295",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/981",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/981#issuecomment-6296",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/981",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/981#event-3362"
}
```
