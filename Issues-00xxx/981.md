...
<a id='comment:1'></a>Patch is here:
http://sage.math.washington.edu/home/wdj/patches/permgp-patch.hg
Passes sage -t. Created agains sage 2.8.3 on a suse amd64 machine,
so may be a bit old....
...
```json
{
    "body": "<a id='comment:3'></a>applied to 2.8.9.alpha1",
...
<a id='comment:3'></a>applied to 2.8.9.alpha1
