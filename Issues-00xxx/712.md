...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-4024",
...
```json
{
    "body": "<a id='comment:1'></a>Save the attached file to disk, start maxima and \nI think this is a bug in Maxima, not Sage per se:\n\n```\n batchload(\"/home/was/tmp/maxima_bug\")\n;\nMaxima encountered a Lisp error:\n\n\nCAR: 1 is not a list\n\nAutomatically continuing.\nTo reenable the Lisp debugger set *debugger-hook* to nil.\n```",
    "created_at": "2007-09-20T18:52:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-4025",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Save the attached file to disk, start maxima and 
I think this is a bug in Maxima, not Sage per se:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-4026",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [j](tarball://root/attachments/some-uuid/ticket712/j) by mabshoff created at 2007-12-04 14:30:20",
    "created_at": "2007-12-04T14:30:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-4027",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Attachment [j](tarball://root/attachments/some-uuid/ticket712/j) by mabshoff created at 2007-12-04 14:30:20
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-4028",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This is very very likely fix by #1827, and testing this in Sage-2.10 it works fine on my test systems.  I'm closing this unless somebody can replicate it. \n\nNOTE -- the attachments j and maxima_bug I put above are irrelevant and pointless -- they just illustrate that maxima's Solve has lame error messages when given crappy input.",
    "created_at": "2008-01-19T13:30:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-4029",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>This is very very likely fix by #1827, and testing this in Sage-2.10 it works fine on my test systems.  I'm closing this unless somebody can replicate it. 
