...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket712/maxima_bug",
...
```json
{
    "body": "replicates bug in Maxima",
    "created_at": "2007-09-20T18:51:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-3941",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-3942",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/712#event-2087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-3943",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "j",
    "asset_url": "tarball://root/attachments/some-uuid/ticket712/j",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-3944",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/712#event-2088"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/712#event-2089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/712#event-2090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-3945",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/712#issuecomment-3946",
    "user": "https://github.com/williamstein"
}
```
