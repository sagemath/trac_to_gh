...
```json
{
    "body": "<a id='comment:3'></a>Does [nose](http://trac.sagemath.org/sage_trac/ticket/9921) have a better way of handling this (not that we could switch to that anytime soon)?  I thought about, but decided against, making this \"wontfix\" after six years - it WOULD be nice.  Comments?",
    "created_at": "2013-01-29T20:31:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-801",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>Does [nose](http://trac.sagemath.org/sage_trac/ticket/9921) have a better way of handling this (not that we could switch to that anytime soon)?  I thought about, but decided against, making this "wontfix" after six years - it WOULD be nice.  Comments?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-802",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-803",
...
```json
{
    "body": "<a id='comment:4'></a>The new doctest option `sage -t --initial` sort of does this: it shows only the first failure in a doctest block. It's an *option* which needs to be specified explicitly but I think that's sufficient.",
    "created_at": "2013-06-13T12:20:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-804",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>The new doctest option `sage -t --initial` sort of does this: it shows only the first failure in a doctest block. It's an *option* which needs to be specified explicitly but I think that's sufficient.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-805",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-806",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-807",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/164#issuecomment-808",
    "user": "https://github.com/jdemeyer"
}
```
