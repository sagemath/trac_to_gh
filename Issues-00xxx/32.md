...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32#issuecomment-157",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32#event-133"
}
```
...
```json
{
    ...
    "milestone": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32#event-134"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/32#event-135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/32",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/32#issuecomment-158",
    "user": "https://github.com/williamstein"
}
```
