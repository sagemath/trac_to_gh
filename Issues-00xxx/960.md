...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6132",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/960#event-3263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6133",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6134",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "rename": {
        "from": "reconsider how floating point values are printed",
        "to": "[with patch] reconsider how floating point values are printed"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/960#event-3264"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6135",
...
```json
{
    ...
    "milestone": "sage-2.8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/960#event-3265"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/960#event-3266"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6136",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6137",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/960#event-3267"
}
```
