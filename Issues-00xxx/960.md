...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,5 +1,5 @@\n ```\n- some f-p values are printed like integers, which may confuse the user\n+some f-p values are printed like integers, which may confuse the user\n  (especially if one copies them with the mouse):\n  sage: 2.0^46\n  70368744177664.0\n@@ -19,8 +19,6 @@\n Paul Z.\n ```\n \n-Assignee: somebody\n-\n Comment: 1\n \n Summary: reconsider how floating point values are printed\n``````\n",
    "created_at": "2007-10-21T13:42:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6024",
...
```json
{
    "body": "<a id='comment:3'></a>The inconsistency mentioned is because of the automagic behavior of decimal literals, where longer literals get more bits:\n\n```\nsage: (2.0^47).prec()\n53\nsage: (140737488355328.0).prec()\n56\n```\n\nMaybe this magic behavior should be removed, or somehow modified to be less confusing?  (Although I have no idea how to make it less confusing.)\n\nSee also #962, for problems with the current implementation of the precision extension.",
    "created_at": "2007-10-21T15:13:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6025",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:3'></a>The inconsistency mentioned is because of the automagic behavior of decimal literals, where longer literals get more bits:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6026",
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [mpfr.patch](tarball://root/attachments/some-uuid/ticket960/mpfr.patch) by @mwhansen created at 2007-10-24 00:31:09\n\nI've attached a patch that makes sure that all real numbers include a \".\" so that they don't get confused with integers.\n\nHere is the behavior after the patch\n\n```\nsage:  2.0^47\n140737488355328.\nsage:  2.0^46\n70368744177664.0\nsage:  2.0^99\n633825300114115000000000000000.\nsage:  2.0^100\n1.26765060022823e30\nsage: 140737488355328.\n140737488355328.\nsage: a = 2.0^47\nsage: a\n140737488355328.\nsage: a.prec()\n53\nsage: b = 140737488355328.\nsage: b.prec()\n53\n```",
    "created_at": "2007-10-24T00:31:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6027",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:5'></a>Attachment [mpfr.patch](tarball://root/attachments/some-uuid/ticket960/mpfr.patch) by @mwhansen created at 2007-10-24 00:31:09
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6028",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/960#issuecomment-6029",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
