...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/847#issuecomment-3994",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/847#event-4031"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket847/847.patch",
    "created_at": "2007-11-30T22:34:56Z",
    "issue": "https://github.com/sagemath/sage/issues/847",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket847/847.patch",
...
```json
{
    "body": "Attachment [847.patch](https://github.com/sagemath/sage/files/ticket847/847.patch) by @mwhansen created at 2007-11-30 22:34:56",
    "created_at": "2007-11-30T22:34:56Z",
    "issue": "https://github.com/sagemath/sage/issues/847",
    "type": "issue_comment",
...
Attachment [847.patch](https://github.com/sagemath/sage/files/ticket847/847.patch) by @mwhansen created at 2007-11-30 22:34:56
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/847#event-4032"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/847#event-4033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/847",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/847#event-4034"
}
```
