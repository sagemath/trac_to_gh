# Issue 882: [with patch] 2.8.7-alpha0: doctest failures in sets/set.py and matrix/matrix_integer_dense.pyx (due to RR->ZZ coercion patch)
...
```json
{
    ...
    "title": "[with patch] 2.8.7-alpha0: doctest failures in sets/set.py and matrix/matrix_integer_dense.pyx (due to RR->ZZ coercion patch)",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/882#event-2458"
}
```
