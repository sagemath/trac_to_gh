...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/942#issuecomment-5938",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Fixed via #919 by roed.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-20T18:38:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/942#issuecomment-5939",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Fixed via #919 by roed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/942#issuecomment-5940",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
