...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4548"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4549"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4516",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4517",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_name": "update-environment.patch",
    "asset_url": "tarball://root/attachments/ticket975/update-environment.patch",
    "created_at": "2007-12-12T00:22:33Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket975/update-environment.patch",
...
```json
{
    "body": "**Attachment:** [update-environment.patch](https://github.com/sagemath/sage/files/ticket975/update-environment.patch)",
    "created_at": "2007-12-12T00:22:33Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4518",
    "user": "https://github.com/jasongrout"
}
```

**Attachment:** [update-environment.patch](https://github.com/sagemath/sage/files/ticket975/update-environment.patch)
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4550"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4551"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4519",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "rename": {
        "from": "Library incompatibilities when launching external applications",
        "to": "[with partial patch] Library incompatibilities when launching external applications"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4552"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4520",
    "user": "https://github.com/jasongrout"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "browser.patch",
    "asset_url": "tarball://root/attachments/ticket975/browser.patch",
    "created_at": "2008-01-10T05:24:14Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket975/browser.patch",
    "user": "https://github.com/jasongrout"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "native-execute.patch",
    "asset_url": "tarball://root/attachments/ticket975/native-execute.patch",
    "created_at": "2008-01-10T05:24:14Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket975/native-execute.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "**Attachment:** [browser.patch](https://github.com/sagemath/sage/files/ticket975/browser.patch)\n\n**Attachment:** [native-execute.patch](https://github.com/sagemath/sage/files/ticket975/native-execute.patch)\n\nApply to sage-scripts.  Creates new \"native-execute\" command that resets the LD_LIBRARY_PATH variable.",
    "created_at": "2008-01-10T05:24:14Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4521",
    "user": "https://github.com/jasongrout"
}
```

**Attachment:** [browser.patch](https://github.com/sagemath/sage/files/ticket975/browser.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "rename": {
        "from": "[with partial patch] Library incompatibilities when launching external applications",
        "to": "Library incompatibilities when launching external applications"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4553"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4522",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4523",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4524",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4525",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/975#event-4557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4526",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "Sage-2.10.alpha3-fix-rename-sage-native-issues.patch",
    "asset_url": "tarball://root/attachments/ticket975/Sage-2.10.alpha3-fix-rename-sage-native-issues.patch",
    "created_at": "2008-01-13T17:37:54Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket975/Sage-2.10.alpha3-fix-rename-sage-native-issues.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "**Attachment:** [Sage-2.10.alpha3-fix-rename-sage-native-issues.patch](https://github.com/sagemath/sage/files/ticket975/Sage-2.10.alpha3-fix-rename-sage-native-issues.patch)",
    "created_at": "2008-01-13T17:37:54Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/975#issuecomment-4527",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

**Attachment:** [Sage-2.10.alpha3-fix-rename-sage-native-issues.patch](https://github.com/sagemath/sage/files/ticket975/Sage-2.10.alpha3-fix-rename-sage-native-issues.patch)
