...
archive/attachments_000642.json:
```json
{
...
```json
{
    "body": "Attachment [update-environment.patch](https://github.com/sagemath/sage/files/ticket975/update-environment.patch) by @jasongrout created at 2007-12-12 00:22:33",
    "created_at": "2007-12-12T00:22:33Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
...
Attachment [update-environment.patch](https://github.com/sagemath/sage/files/ticket975/update-environment.patch) by @jasongrout created at 2007-12-12 00:22:33
...
archive/attachments_000643.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [native-execute.patch](https://github.com/sagemath/sage/files/ticket975/native-execute.patch) by @jasongrout created at 2008-01-10 05:24:14\n\nApply to sage-scripts.  Creates new \"native-execute\" command that resets the LD_LIBRARY_PATH variable.",
    "created_at": "2008-01-10T05:24:14Z",
    "issue": "https://github.com/sagemath/sage/issues/975",
    "type": "issue_comment",
...
Attachment [native-execute.patch](https://github.com/sagemath/sage/files/ticket975/native-execute.patch) by @jasongrout created at 2008-01-10 05:24:14
