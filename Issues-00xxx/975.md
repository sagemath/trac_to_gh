# Issue 975: [with positive review] Library incompatibilities when launching external applications
...
```json
{
    ...
    "title": "[with positive review] Library incompatibilities when launching external applications",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6393",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/975#event-2979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6394",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6395",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket975/update-environment.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6396",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/975#event-2980"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/975#event-2981"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6397",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/975#event-2982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6398",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket975/native-execute.patch",
...
```json
{
    "body": "Apply to sage-scripts.  Creates new \"native-execute\" command that resets the LD_LIBRARY_PATH variable.",
    "created_at": "2008-01-10T05:24:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6399",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/975#event-2983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6400",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "rename": {
        "from": "Library incompatibilities when launching external applications",
        "to": "[with positive review] Library incompatibilities when launching external applications"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/975#event-2984"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6401",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6402",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6403",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6404",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/975#event-2985"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/975#issuecomment-6405",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
