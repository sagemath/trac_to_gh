...
```json
{
    ...
    "type": "issue",
    "updated_at": "2007-01-09T18:13:59Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/186#event-1139"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/186#event-1140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/186#event-1141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/186",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/186#event-1142"
}
```
