...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sage/issues/378",
...
```json
{
    ...
    "created_at": "2007-09-11T00:47:45Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1342",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1343",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1344",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1345",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1446"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1346",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1347",
    "user": "https://github.com/qed777"
}
```
...
archive/attachments_000098.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_378-load_attach_path.patch",
    "asset_url": "tarball://root/attachments/ticket378/trac_378-load_attach_path.patch",
    "created_at": "2010-02-16T00:22:23Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.patch",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac_378-load_attach_path.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.patch) by @qed777 created at 2010-02-16 00:22:23\n\nFeel free to improve the patch!",
    "created_at": "2010-02-16T00:22:23Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1348",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1349",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1350",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1449"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1351",
    "user": "https://github.com/qed777"
}
```
...
archive/attachments_000099.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_378-load_attach_path.2.patch",
    "asset_url": "tarball://root/attachments/ticket378/trac_378-load_attach_path.2.patch",
    "created_at": "2010-02-20T23:49:33Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.patch",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "Attachment [trac_378-load_attach_path.2.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.patch) by @qed777 created at 2010-02-20 23:49:33\n\nMore examples.  Handle absolute paths.  Replaces previous.",
    "created_at": "2010-02-20T23:49:33Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1352",
    "user": "https://github.com/qed777"
}
```

Attachment [trac_378-load_attach_path.2.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.patch) by @qed777 created at 2010-02-20 23:49:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1353",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1451"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1354",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1355",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1453"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1356",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1455"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1456"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1357",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1359",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1360",
...
archive/attachments_000100.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_378-load_attach_path.2.1.patch",
    "asset_url": "tarball://root/attachments/ticket378/trac_378-load_attach_path.2.1.patch",
    "created_at": "2010-11-04T06:14:08Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.1.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    "body": "Attachment [trac_378-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.1.patch) by flawrence created at 2010-11-04 06:14:08\n\nuse os.path.userexpand on load, separate reset function, also use paths for detach. replaces previous.",
    "created_at": "2010-11-04T06:14:08Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1361",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```

Attachment [trac_378-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.1.patch) by flawrence created at 2010-11-04 06:14:08
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1457"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1458"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1362",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1363",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
archive/attachments_000101.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_387-load_attach_path.2.1.patch",
    "asset_url": "tarball://root/attachments/ticket378/trac_387-load_attach_path.2.1.patch",
    "created_at": "2010-11-05T02:46:38Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket378/trac_387-load_attach_path.2.1.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    "body": "Attachment [trac_387-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_387-load_attach_path.2.1.patch) by flawrence created at 2010-11-05 02:46:38\n\nuse os.path.userexpand on load, separate reset function, also use paths for detach. actually replaces previous this time..",
    "created_at": "2010-11-05T02:46:38Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1364",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```

Attachment [trac_387-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_387-load_attach_path.2.1.patch) by flawrence created at 2010-11-05 02:46:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1365",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1366",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1367",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1368",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1369",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1370",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1371",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1372",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1373",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1374",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1375",
    "user": "https://trac.sagemath.org/admin/accounts/users/flawrence"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1376",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1377",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1459"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1460"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1378",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1379",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/378#event-1462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/378#issuecomment-1380",
    "user": "https://github.com/jdemeyer"
}
```
