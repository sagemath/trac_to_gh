...
```json
{
    "body": "<a id='comment:5'></a>\n**Attachment:** [trac_378-load_attach_path.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.patch)\n\nFeel free to improve the patch!",
    "created_at": "2010-02-16T00:22:23Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_378-load_attach_path.2.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.patch)\n\nMore examples.  Handle absolute paths.  Replaces previous.",
    "created_at": "2010-02-20T23:49:33Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
...
**Attachment:** [trac_378-load_attach_path.2.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.patch)
...
```json
{
    "body": "**Attachment:** [trac_378-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.1.patch)\n\nuse os.path.userexpand on load, separate reset function, also use paths for detach. replaces previous.",
    "created_at": "2010-11-04T06:14:08Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
...
**Attachment:** [trac_378-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_378-load_attach_path.2.1.patch)
...
```json
{
    "body": "**Attachment:** [trac_387-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_387-load_attach_path.2.1.patch)\n\nuse os.path.userexpand on load, separate reset function, also use paths for detach. actually replaces previous this time..",
    "created_at": "2010-11-05T02:46:38Z",
    "issue": "https://github.com/sagemath/sage/issues/378",
    "type": "issue_comment",
...
**Attachment:** [trac_387-load_attach_path.2.1.patch](https://github.com/sagemath/sage/files/ticket378/trac_387-load_attach_path.2.1.patch)
