...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket641/cython-sage-all.patch",
    "created_at": "2007-09-12T04:51:10Z",
    "issue": "https://github.com/sagemath/sage/issues/641",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket641/cython-sage-all.patch",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [cython-sage-all.patch](https://github.com/sagemath/sage/files/ticket641/cython-sage-all.patch) by @robertwb created at 2007-09-12 04:51:10",
    "created_at": "2007-09-12T04:51:10Z",
    "issue": "https://github.com/sagemath/sage/issues/641",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/641#event-2776"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/641#event-2777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/641",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/641#event-2778"
}
```
