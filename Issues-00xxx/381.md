...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2040",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2041",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2042",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2043",
...
```json
{
    "body": "<a id='comment:4'></a>Look at #7893 ([http://trac.sagemath.org/sage_trac/ticket/7893](http://trac.sagemath.org/sage_trac/ticket/7893)).\n\nIt would be good to incorporate the idea of the example to the script in the previous ticket.",
    "created_at": "2010-10-17T04:39:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2044",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:4'></a>Look at #7893 ([http://trac.sagemath.org/sage_trac/ticket/7893](http://trac.sagemath.org/sage_trac/ticket/7893)).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2045",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2046",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>What's wrong with nohup? It does exactly what you want, why add a Sage option to emulate nohup?",
    "created_at": "2013-06-13T12:23:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2047",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>What's wrong with nohup? It does exactly what you want, why add a Sage option to emulate nohup?
...
```json
{
    "body": "<a id='comment:8'></a>I think nohup doesn't daemonize.  There is a long list of things that should happen when a process is damonized:\n\n     http://en.wikipedia.org/wiki/Daemon_(computing) \n\nThe right way to solve this problem would almost certainly involve including this Python module:  https://pypi.python.org/pypi/python-daemon/",
    "created_at": "2013-06-13T16:49:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2048",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>I think nohup doesn't daemonize.  There is a long list of things that should happen when a process is damonized:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2049",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>> This refers to traditional Unix daemons, which would be quite different from a Sage \"daemon\" started by an ordinary user.\n\n\nI think traditional daemonization is the right way to solve this problem.  Moreover, it would be a useful step for making it easy to run a sage server as part of the usual system-wide daemons on Unix.",
    "created_at": "2013-06-13T18:25:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2050",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:10'></a>> This refers to traditional Unix daemons, which would be quite different from a Sage "daemon" started by an ordinary user.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2051",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2052",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2053",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>The problem that this ticket deals with is nowadays solved by using the OS tools such as Upstart in Ubuntu for example. So I think there needs no further discussion on this matter.",
    "created_at": "2016-03-23T04:38:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2054",
    "user": "https://github.com/kwankyu"
}
```

<a id='comment:17'></a>The problem that this ticket deals with is nowadays solved by using the OS tools such as Upstart in Ubuntu for example. So I think there needs no further discussion on this matter.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2055",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2056",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/381#issuecomment-2057",
