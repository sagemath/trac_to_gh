...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/364#issuecomment-1845",
...
```json
{
    "body": "<a id='comment:1'></a>I think all fraction fields should have their names assigned in the fraction field constructor.\nI've modified 2.5.1 so this is the case.  \n\nAll fraction fields should have variable_names() set on creation.  It was a mistake to omit\nthat from the constructor.",
    "created_at": "2007-05-18T13:21:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/364#issuecomment-1846",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>I think all fraction fields should have their names assigned in the fraction field constructor.
I've modified 2.5.1 so this is the case.  
