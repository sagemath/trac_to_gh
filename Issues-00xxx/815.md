...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/815#issuecomment-5322",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2768"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2769"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/815#issuecomment-5323",
...
```json
{
    ...
    "milestone": "sage-2.8.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2772"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "rename": {
        "from": "doctesting is broken on .sage files",
        "to": "[with patch; needs review] doctesting is broken on .sage files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/815#issuecomment-5324",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/815#issuecomment-5325",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/815#issuecomment-5326",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "rename": {
        "from": "[with patch; needs review] doctesting is broken on .sage files",
        "to": "[with patch; positive review] doctesting is broken on .sage files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/815#issuecomment-5327",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/815#event-2776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/815#issuecomment-5328",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
