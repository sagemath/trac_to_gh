...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2534",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2535",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>one more thing I forgot: The build requires bison, so we should just run bison on the grammar file and include the output so bison isn't invoked. For that see also ticket #472 which fixed the same \"problem\" for Singular\n\nCheers,\n\nMichael",
    "created_at": "2007-08-24T17:05:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2537",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>one more thing I forgot: The build requires bison, so we should just run bison on the grammar file and include the output so bison isn't invoked. For that see also ticket #472 which fixed the same "problem" for Singular
...
```json
{
    "body": "<a id='comment:7'></a>And just to be through: http://groups.google.com/group/sage-devel/t/bfa83514467cdfe6",
    "created_at": "2007-08-24T22:00:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2540",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>And just to be through: http://groups.google.com/group/sage-devel/t/bfa83514467cdfe6
...
```json
{
    "body": "<a id='comment:8'></a>I've created and attached an initial spkg for LiE.\n\nI've also attached a bundle with an expect interface for LiE.  It supports tab-completion, help, etc.\n\nI'm not sure how much more beneficial a C library interface to it would be...",
    "created_at": "2007-08-28T00:43:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2541",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:8'></a>I've created and attached an initial spkg for LiE.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2542",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2543",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/489#issuecomment-2544",
