...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7563"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7564"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7566"
}
```
...
```json
{
    "body": "Changed assignee from **failure** to **@roed314**",
...
Changed assignee from **failure** to **@roed314**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7567"
}
```
...
```json
{
    "body": "Changed assignee from **@roed314** to **was***",
    "created_at": "2007-10-14T19:14:01Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/884#issuecomment-4170",
    "user": "https://github.com/williamstein"
}
```

Changed assignee from **@roed314** to **was***
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/884#issuecomment-4171",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/884",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7568"
}
```
