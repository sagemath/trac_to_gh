...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7515"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7518"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-failure** to **@roed314**",
...
Changed assignee from **@sagetrac-failure** to **@roed314**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/884",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/884#event-7520"
}
```
