...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/111#event-266"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/111",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/111#event-267"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/111",
    "rename": {
        "from": "def copy -- they should all be def __copy__",
        "to": "[with patch, needs review] def copy -- they should all be def __copy__"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/111#event-268"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/111",
    "rename": {
        "from": "[with patch, needs review] def copy -- they should all be def __copy__",
        "to": "[with patch, positive review] def copy -- they should all be def __copy__"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/111#event-269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/111",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/111#event-270"
}
```
