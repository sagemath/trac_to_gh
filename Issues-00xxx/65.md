...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-323",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/65#event-169"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/65",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-324",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/65",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/65#event-170"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/65#event-171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/65",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-325",
    "user": "https://github.com/williamstein"
}
```
