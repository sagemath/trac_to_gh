...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-263",
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/65#event-167"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/65",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-264",
    "user": "https://github.com/williamstein"
}
```
