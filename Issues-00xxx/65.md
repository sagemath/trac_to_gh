...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-328",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/65#event-164"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/65",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-329",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/65",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/65#event-165"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/65#event-166"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/65",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/65#issuecomment-330",
    "user": "https://github.com/williamstein"
}
```
