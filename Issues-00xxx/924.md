...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/924#issuecomment-5934",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/924#event-3125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/924#issuecomment-5935",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg; needs corr patch] the matplotlib spkg patches break underlying functionality"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/924#event-3126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/924#issuecomment-5936",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/924#issuecomment-5937",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/924#issuecomment-5938",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "rename": {
        "from": "[with spkg; needs corr patch] the matplotlib spkg patches break underlying functionality",
        "to": "[with spkg and with patch] the matplotlib spkg patches break underlying functionality"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/924#event-3127"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/924#issuecomment-5939",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/924#event-3128"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/924#issuecomment-5940",
    "user": "https://github.com/rlmill"
}
```
