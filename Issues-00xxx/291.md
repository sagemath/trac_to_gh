...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/291#issuecomment-1442",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/291",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/291#issuecomment-1443",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/291",
    "rename": {
        "from": "strange printing of -1 in multivariate polynomial rings",
        "to": "[with patch, needs review] strange printing of -1 in multivariate polynomial rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/291#event-774"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/291#event-775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/291",
    "rename": {
        "from": "[with patch, needs review] strange printing of -1 in multivariate polynomial rings",
        "to": "[with patch, positive review] strange printing of -1 in multivariate polynomial rings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/291#event-776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/291",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/291#event-777"
}
```
