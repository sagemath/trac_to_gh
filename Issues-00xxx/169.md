...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/169",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/169",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-370"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] slice assignment not implemented for PARI C library interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/169",
    "rename": {
        "from": "[with patch, needs review] slice assignment not implemented for PARI C library interface",
        "to": "[with patch, needs work] slice assignment not implemented for PARI C library interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-372"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/169",
    "rename": {
        "from": "[with patch, needs work] slice assignment not implemented for PARI C library interface",
        "to": "[with new patch, needs review] slice assignment not implemented for PARI C library interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/169",
    "rename": {
        "from": "[with new patch, needs review] slice assignment not implemented for PARI C library interface",
        "to": "[with new patch, positive review] slice assignment not implemented for PARI C library interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-374"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/169",
    "rename": {
        "from": "[with new patch, positive review] slice assignment not implemented for PARI C library interface",
        "to": "[with patch, needs work] slice assignment not implemented for PARI C library interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-375"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs work] slice assignment not implemented for PARI C library interface",
        "to": "[with patch, positive review] slice assignment not implemented for PARI C library interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-376"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/169",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/169#event-377"
}
```
