...
```json
{
    "body": "<a id='comment:4'></a>When valgrinding devel/sage-main/sage/rings/finite_field_givaro.pyx with 100% coverage now shows no leak when using the givaro.spkg from #2525. Hence this ticket should be closed once that ticket is merged.\n\nCheers,\n\nMichael",
    "created_at": "2008-03-15T05:05:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/520",
    "type": "issue_comment",
...
<a id='comment:4'></a>When valgrinding devel/sage-main/sage/rings/finite_field_givaro.pyx with 100% coverage now shows no leak when using the givaro.spkg from #2525. Hence this ticket should be closed once that ticket is merged.
...
```json
{
    "body": "<a id='comment:5'></a>This has been fixed due to the new Givaro.spkg from #2524 (not #2525 as mentioned mistakenly in the previous comment.\n\nCheers,\n\nMichael",
...
<a id='comment:5'></a>This has been fixed due to the new Givaro.spkg from #2524 (not #2525 as mentioned mistakenly in the previous comment.
...
```json
{
    "body": "<a id='comment:6'></a>Closed in Sage 2.10.4.alpha0 due to merging the Giavro.spkg from #2524.",
    "created_at": "2008-03-15T06:46:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/520",
    "type": "issue_comment",
...
<a id='comment:6'></a>Closed in Sage 2.10.4.alpha0 due to merging the Giavro.spkg from #2524.
