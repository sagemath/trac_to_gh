...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/56#issuecomment-307",
...
```json
{
    "body": "<a id='comment:2'></a>Some numbers with the latest SAGE and latest magma:\n\n```\nsage: sage: A = srange(10^6)\nsage: sage: time B = [i+two for i in A]\nCPU times: user 0.22 s, sys: 0.69 s, total: 0.91 s\nWall time: 0.92\n\n> A := [0..10^6-1];\n> time B := [i + two : i in A];\nTime: 0.220\n```",
    "created_at": "2007-08-23T06:33:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/56",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/56#issuecomment-308",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Some numbers with the latest SAGE and latest magma:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/56",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/56#issuecomment-309",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/56",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/56#issuecomment-310",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/56",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/56#issuecomment-313",
    "user": "https://github.com/williamstein"
}
```
