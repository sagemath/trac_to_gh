...
```
Somewhat bizarrely, the SAGE `_sig_`on/_sig_off signal handling code
appears to be completely not doing anything at all.  Weird!  This is a
major bug that must be fixed before SAGE-2.0. 
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/196#issuecomment-926",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/196#issuecomment-927",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/196#issuecomment-928",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/196",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/196#event-431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/196#issuecomment-929",
    "user": "https://github.com/williamstein"
}
```
