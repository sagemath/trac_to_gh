...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/306#issuecomment-1528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/306#issuecomment-1529",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/306",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-830"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with bundle] switch running branches without building"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-831"
}
```
