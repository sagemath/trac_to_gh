...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/306#issuecomment-1120",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/306#issuecomment-1121",
    "user": "https://github.com/ncalexan"
}
```
...
archive/attachments_000080.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "ncalexan-scripts-clone.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket306/ncalexan-scripts-clone.hg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/306#issuecomment-1122",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-1199"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-1200"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-1201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/306",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-1202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/306",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/306#issuecomment-1123",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-1203"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-1204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/306#event-1205"
}
```
