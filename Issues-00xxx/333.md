...
```json
{
    "body": "<a id='comment:2'></a>I think this ticket should be set to invalid because the notebook has a multi-user model now.",
    "created_at": "2008-03-18T10:07:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/333#issuecomment-1823",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```

<a id='comment:2'></a>I think this ticket should be set to invalid because the notebook has a multi-user model now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/333#issuecomment-1824",
