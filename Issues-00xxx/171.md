...
```json
{
    ...
    "type": "issue",
    "updated_at": "2007-01-13T01:44:19Z",
    "url": "https://github.com/sagemath/sage/issues/171",
...
```json
{
    ...
    "created_at": "2006-11-30T13:18:26Z",
    "event": "labeled",
    "issue": "https://github.com/sagemath/sage/issues/171",
    "label": "https://github.com/sagemath/sage/labels/c%3A%20basic%20arithmetic",
    "label_color": "0000ff",
    "label_name": "c: basic arithmetic",
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/171#event-1234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/171#event-1235"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/171#event-1236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/171#issuecomment-538",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/171#event-1237"
}
```
