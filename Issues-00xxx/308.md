...
```json
{
    "body": "<a id='comment:1'></a>Mmmh, I get the following:\n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n| SAGE Version 2.8.2, Release Date: 2007-08-22                       |\n| Type notebook() for the GUI, and license() for information.        |\nsage: log_html ()\nHTML Logger\nsage: 1+1\n2\n```\nCan this be closed now? \n\nCheers,\n\nMichael",
    "created_at": "2007-08-24T23:18:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/308#issuecomment-1632",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Mmmh, I get the following:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/308#issuecomment-1633",
