...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_693-spawn-browser-start-nb.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-browser-start-nb.patch)\n\nThis patch should do the trick. Apply to scripts repository.",
    "created_at": "2009-11-15T15:35:46Z",
    "issue": "https://github.com/sagemath/sage/issues/693",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_693-spawn-browser-start-nb.2.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-browser-start-nb.2.patch)\n\nChecks if the notebook server is running too, instead of just checking if the PID exists.",
    "created_at": "2009-11-18T13:33:02Z",
    "issue": "https://github.com/sagemath/sage/issues/693",
    "type": "issue_comment",
...
**Attachment:** [trac_693-spawn-browser-start-nb.2.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-browser-start-nb.2.patch)
...
```json
{
    "body": "**Attachment:** [trac_693-spawn-browser-start-nb.3.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-browser-start-nb.3.patch)\n\nFixes bug with arguments.",
    "created_at": "2009-11-19T19:31:59Z",
    "issue": "https://github.com/sagemath/sage/issues/693",
    "type": "issue_comment",
...
**Attachment:** [trac_693-spawn-browser-start-nb.3.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-browser-start-nb.3.patch)
...
```json
{
    "body": "**Attachment:** [trac_693-spawn-browser-start-nb.4.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-browser-start-nb.4.patch)\n\nSame thing, without actually checking if the Twistd process is running",
    "created_at": "2009-11-19T19:33:52Z",
    "issue": "https://github.com/sagemath/sage/issues/693",
    "type": "issue_comment",
...
**Attachment:** [trac_693-spawn-browser-start-nb.4.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-browser-start-nb.4.patch)
...
**Attachment:** [trac_693-spawn-nb.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-nb.patch)
...
```json
{
    "body": "**Attachment:** [trac_693-spawn-nb.2.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-nb.2.patch)\n\nUses signals only to check if the process exists (as Twisted does)",
    "created_at": "2009-12-09T12:10:35Z",
    "issue": "https://github.com/sagemath/sage/issues/693",
    "type": "issue_comment",
...
**Attachment:** [trac_693-spawn-nb.2.patch](https://github.com/sagemath/sage/files/ticket693/trac_693-spawn-nb.2.patch)
