...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3879",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac_693-spawn-browser-start-nb.patch](tarball://root/attachments/some-uuid/ticket693/trac_693-spawn-browser-start-nb.patch) by @TimDumol created at 2009-11-15 15:35:46\n\nThis patch should do the trick. Apply to scripts repository.",
    "created_at": "2009-11-15T15:35:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3880",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:1'></a>Attachment [trac_693-spawn-browser-start-nb.patch](tarball://root/attachments/some-uuid/ticket693/trac_693-spawn-browser-start-nb.patch) by @TimDumol created at 2009-11-15 15:35:46
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3881",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3882",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3883",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I am not sure which method is preferrable, since checking if the notebook server is running does not work if the user has no permission to read `/proc` and to send signals. Please feel free to approve of either patch.",
    "created_at": "2009-11-18T13:33:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3884",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:2'></a>I am not sure which method is preferrable, since checking if the notebook server is running does not work if the user has no permission to read `/proc` and to send signals. Please feel free to approve of either patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3885",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3886",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3888",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3889",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3890",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>All your points make sense. I have implemented the changes in `run_notebook.py`. I've decided to check if the process is running, since that's also what `twistd` does.",
    "created_at": "2009-11-21T01:34:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3891",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:4'></a>All your points make sense. I have implemented the changes in `run_notebook.py`. I've decided to check if the process is running, since that's also what `twistd` does.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3892",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3893",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>On OS X this doesn't work at all.  Depending on what I do either I get two notebook servers running simultaneously on the same directory (bad), or I get \"Another twistd server is running, PID 40940\".\n\nOn OS X there is no /proc filesystem.  However, when I run this code from this patch:\n\n```\n        try:\n            print 1\n            # First check using /proc directory\n            if os.path.exists('/proc/%d'  % twistd_pid):\n                launch_browser_to_nb()\n                return\n            else:\n                remove_pidfile(twistd_pid_path)                \n        except:\n            print 2\n```\nI don't see \"2\" printed, i.e., no exception is raised.   That's clear if you read the code -- you don't raise an exception.",
    "created_at": "2009-12-08T17:03:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3894",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>On OS X this doesn't work at all.  Depending on what I do either I get two notebook servers running simultaneously on the same directory (bad), or I get "Another twistd server is running, PID 40940".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3895",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I have removed the /proc check, since it's what Twisted does anyways.",
    "created_at": "2009-12-09T12:11:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3896",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:6'></a>I have removed the /proc check, since it's what Twisted does anyways.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3897",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I guess we need to update the patch to take advantage of #2779?",
    "created_at": "2010-01-20T06:54:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3898",
    "user": "https://github.com/qed777"
}
```

<a id='comment:7'></a>I guess we need to update the patch to take advantage of #2779?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3899",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3901",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3902",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3903",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Apply trac_693-spawn_notebook.3.patch",
    "created_at": "2010-12-29T13:18:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3905",
    "user": "https://github.com/gvol"
}
```

<a id='comment:13'></a>Apply trac_693-spawn_notebook.3.patch
...
```json
{
    "body": "<a id='comment:14'></a>I'd like to test #8473, which depends on this, but I'm reluctant to do so until someone who knows something about the notebook takes a look at this.  Bug days folks?",
    "created_at": "2011-01-11T04:11:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3906",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>I'd like to test #8473, which depends on this, but I'm reluctant to do so until someone who knows something about the notebook takes a look at this.  Bug days folks?
...
```json
{
    "body": "<a id='comment:15'></a>Open browser if server running and open_viewer=True. pep8 clean-ups. Rebased for queue in comment. Replaces previous. \n\n <a href=\"http://www.nicetick.com\"><font color=\"#000000\">air jordan</font></a>\n",
    "created_at": "2011-03-15T16:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3907",
    "user": "https://trac.sagemath.org/admin/accounts/users/amog2011"
}
```

<a id='comment:15'></a>Open browser if server running and open_viewer=True. pep8 clean-ups. Rebased for queue in comment. Replaces previous. 
...
```json
{
    "body": "<a id='comment:16'></a>Replying to [amog2011](#comment%3A15):\n> Open browser if server running and open_viewer=True. pep8 clean-ups. Rebased for queue in comment. Replaces previous. \n\nThis is a spam comment. Can someone please remove this 'user'?  I don't know who has permissions for this.",
    "created_at": "2011-03-15T16:50:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3908",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:16'></a>Replying to [amog2011](#comment%3A15):
> Open browser if server running and open_viewer=True. pep8 clean-ups. Rebased for queue in comment. Replaces previous. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3909",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3910",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3911",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I have been using this (with #8473) for some time without problems.  I have also reviewed the code and it looks okay given my limited understanding of the notebook.",
    "created_at": "2011-03-24T21:45:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3912",
    "user": "https://github.com/gvol"
}
```

<a id='comment:19'></a>I have been using this (with #8473) for some time without problems.  I have also reviewed the code and it looks okay given my limited understanding of the notebook.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3914",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3915",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3916",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/693#issuecomment-3917",
    "user": "https://github.com/jdemeyer"
}
```
