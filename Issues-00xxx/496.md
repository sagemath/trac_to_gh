...
```json
{
    "body": "<a id='comment:1'></a>Attachment [arith_496.hg](tarball://root/attachments/some-uuid/ticket496/arith_496.hg) by boothby created at 2007-08-28 06:43:29\n\nAttached patch fixes the problem.",
...
<a id='comment:1'></a>Attachment [arith_496.hg](tarball://root/attachments/some-uuid/ticket496/arith_496.hg) by boothby created at 2007-08-28 06:43:29
...
<a id='comment:3'></a>Attached file introduces bugs.  Better fix is located at:
...
```json
{
    "body": "<a id='comment:6'></a>Everything seems to check out.  Almost all element classes are now using the generic code, and all tests pass.  The classes which do not use generic code are listed in #503, or have good reason not to use it (for example, integers call mpz library code).",
    "created_at": "2007-08-31T22:45:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/496",
    "type": "issue_comment",
...
<a id='comment:6'></a>Everything seems to check out.  Almost all element classes are now using the generic code, and all tests pass.  The classes which do not use generic code are listed in #503, or have good reason not to use it (for example, integers call mpz library code).
