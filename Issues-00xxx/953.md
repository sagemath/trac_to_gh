# Issue 953: [with patch] the axiom / sage interface is currently totally broken, at least on 64-bit linux
...
```json
{
    ...
    "closed_at": "2007-10-21T02:20:39Z",
    ...
    "title": "[with patch] the axiom / sage interface is currently totally broken, at least on 64-bit linux",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/953",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/953#event-2627"
}
```
...
```json
{
    ...
    "created_at": "2007-10-21T02:26:31Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sagetest/issues/953",
    "milestone": "sage-2.8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/953#event-2628"
}
```
