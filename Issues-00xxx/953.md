...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-4454"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-4455"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-4456"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/953#issuecomment-4406",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/953#issuecomment-4407",
...
archive/attachments_000617.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "axiom.patch",
    "asset_url": "tarball://root/attachments/ticket953/axiom.patch",
    "created_at": "2007-10-21T02:16:51Z",
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket953/axiom.patch",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "Attachment [axiom.patch](https://github.com/sagemath/sage/files/ticket953/axiom.patch) by @mwhansen created at 2007-10-21 02:16:51",
    "created_at": "2007-10-21T02:16:51Z",
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_comment",
...
Attachment [axiom.patch](https://github.com/sagemath/sage/files/ticket953/axiom.patch) by @mwhansen created at 2007-10-21 02:16:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-4457"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-4458"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-4459"
}
```
