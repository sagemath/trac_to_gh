...
```json
{
    ...
    "type": "issue",
    "updated_at": "2007-10-21T02:26:31Z",
    "url": "https://github.com/sagemath/sage/issues/953",
...
```json
{
    ...
    "created_at": "2007-10-20T23:49:20Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/953",
    "milestone_number": null,
    "milestone_title": "sage-2.8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8119"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8124"
}
```
...
{
    "actor": "https://github.com/williamstein",
    "created_at": "2007-10-21T00:02:48Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/953",
    "milestone_number": null,
    "milestone_title": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/953#issuecomment-4408",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/953#issuecomment-4409",
...
```json
{
    "body": "Attachment: **[axiom.patch.gz](https://github.com/sagemath/sage/files/ticket953/axiom.patch.gz)**",
    "created_at": "2007-10-21T02:16:51Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/953#issuecomment-4410",
    "user": "https://github.com/mwhansen"
}
```

Attachment: **[axiom.patch.gz](https://github.com/sagemath/sage/files/ticket953/axiom.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/953",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8126"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8127"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/953#event-8128"
}
```
