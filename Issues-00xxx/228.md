...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1025",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/228#event-553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1026",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/228#event-554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1027",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1028",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/228#event-555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1029",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "rename": {
        "from": "bug in sage notebook cell parser and promp stripping.",
        "to": "[with patch] bug in sage notebook cell parser and promp stripping."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/228#event-556"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/228#event-557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1030",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/228#event-558"
}
```
