...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1097",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1098",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Reopen ticket because a patch wasn't created and approved.",
    "created_at": "2007-09-05T16:30:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1099",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```

<a id='comment:2'></a>Reopen ticket because a patch wasn't created and approved.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1100",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [ncalexan-228-v2.hg](tarball://root/attachments/some-uuid/ticket228/ncalexan-228-v2.hg) by @ncalexan created at 2007-09-20 21:07:07\n\nThe attached patch addresses this issue by only considering input examples if it starts with a prompt (sage: or >>>).",
    "created_at": "2007-09-20T21:07:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1101",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:4'></a>Attachment [ncalexan-228-v2.hg](tarball://root/attachments/some-uuid/ticket228/ncalexan-228-v2.hg) by @ncalexan created at 2007-09-20 21:07:07
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/228#issuecomment-1102",
    "user": "https://github.com/williamstein"
}
```
