...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1527"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1528"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1529"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1530"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-1532"
}
```
