...
```json
{
    ...
    "subject": "https://github.com/boothby",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-4354"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-4355"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-4356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/503",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-4357"
}
```
