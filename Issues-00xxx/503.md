...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3842"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3845"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3847"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-boothby** to **@roed314**",
    "created_at": "2007-09-07T01:12:09Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/503",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-boothby** to **@roed314**
...
```json
{
    "body": "Changed assignee from **@roed314** to **@robertwb**",
...
Changed assignee from **@roed314** to **@robertwb**
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3848"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/503",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/503#event-3850"
}
```
