...
{
    "assignees": [],
    "body": "\n```\nsage: singular('2')*3\n\n\n------------------------------------------------------------\nUnhandled SIGSEGV: A segmentation fault occured in SAGE.\nThis probably occured because a *compiled* component\nof SAGE has a bug in it (typically accessing invalid memory)\nor is not properly wrapped with _sig_on, _sig_off.\nYou might want to run SAGE under gdb with 'sage -gdb' to debug this.\nSAGE will now terminate (sorry).\n------------------------------------------------------------\n\n```\n\nAssignee: **@robertwb**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/833_\n\n",
    ...
    "type": "issue",
    "updated_at": "2007-10-14T17:26:57Z",
    "url": "https://github.com/sagemath/sage/issues/833",
...
```json
{
    ...
    "created_at": "2007-10-06T03:10:24Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/833",
    "milestone_number": null,
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7095"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7096"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3924",
...
```json
{
    ...
    "milestone_title": "sage-2.8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7099"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3925",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7101"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3926",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3927",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3928",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3929",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3930",
    "user": "https://github.com/sagetrac-cwitty"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7103"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7104"
}
```
...
```json
{
    "body": "Attachment: **[cython-fix.patch.gz](https://github.com/sagemath/sage/files/ticket833/cython-fix.patch.gz)**\n\nThis is the patch I applied to the Cython spkg (to the inner hg repository).  I'm only posting this for completeness; you want to download the spkg instead.",
    "created_at": "2007-10-14T07:01:18Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3931",
    "user": "https://github.com/sagetrac-cwitty"
}
```

Attachment: **[cython-fix.patch.gz](https://github.com/sagemath/sage/files/ticket833/cython-fix.patch.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3932",
    "user": "https://github.com/sagetrac-cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3933",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3934",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/833#issuecomment-3935",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-7105"
}
```
