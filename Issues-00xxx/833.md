...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-3964"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-3965"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-3966"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-3967"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-3968"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-3969"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket833/cython-fix.patch",
    "created_at": "2007-10-14T07:01:18Z",
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket833/cython-fix.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
Attachment [cython-fix.patch](https://github.com/sagemath/sage/files/ticket833/cython-fix.patch) by cwitty created at 2007-10-14 07:01:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/833",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/833#event-3970"
}
```
