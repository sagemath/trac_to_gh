...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/428#issuecomment-2370",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/428#issuecomment-2372",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Upgraded from XCode 2.2 to 2.4.1 and this resolves the problem.",
    "created_at": "2007-08-28T22:27:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/428#issuecomment-2373",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:2'></a>Upgraded from XCode 2.2 to 2.4.1 and this resolves the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/428#issuecomment-2374",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/428#issuecomment-2375",
    "user": "https://github.com/fchapoton"
}
```
