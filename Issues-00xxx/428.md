...
archive/attachments_000137.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "install.log.gz",
    "asset_url": "tarball://root/attachments/ticket428/install.log.gz",
    "created_at": "2007-08-15T16:30:48Z",
    "issue": "https://github.com/sagemath/sage/issues/428",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket428/install.log.gz",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    "body": "Attachment [install.log.gz](https://github.com/sagemath/sage/files/ticket428/install.log.gz) by dmharvey created at 2007-08-15 16:30:48\n\nfull install log for failed build",
    "created_at": "2007-08-15T16:30:48Z",
    "issue": "https://github.com/sagemath/sage/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/428#issuecomment-1605",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

Attachment [install.log.gz](https://github.com/sagemath/sage/files/ticket428/install.log.gz) by dmharvey created at 2007-08-15 16:30:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/428#issuecomment-1606",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/428#event-1743"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/428#issuecomment-1607",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/428#issuecomment-1608",
