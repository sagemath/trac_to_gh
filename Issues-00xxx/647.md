...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/647#issuecomment-3635",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The main thing that needs to happen to close this ticket is that 1-2 people need to look at this patch\nand say \"yep, looks good\".",
    "created_at": "2007-09-13T14:08:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/647#issuecomment-3636",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>The main thing that needs to happen to close this ticket is that 1-2 people need to look at this patch
and say "yep, looks good".
...
```json
{
    "body": "<a id='comment:2'></a>OK, I just looked at it, and it *has* no doctests at all for the new functions it introduces.  Please add these.",
    "created_at": "2007-09-13T14:08:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/647#issuecomment-3637",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>OK, I just looked at it, and it *has* no doctests at all for the new functions it introduces.  Please add these.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [newquatalgelm.hg](tarball://root/attachments/some-uuid/ticket647/newquatalgelm.hg) by @aghitza created at 2007-09-20 15:39:17\n\nI inserted doctests and attached the new version newquatalgelm.hg.",
    "created_at": "2007-09-20T15:39:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/647#issuecomment-3638",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:3'></a>Attachment [newquatalgelm.hg](tarball://root/attachments/some-uuid/ticket647/newquatalgelm.hg) by @aghitza created at 2007-09-20 15:39:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/647#issuecomment-3639",
    "user": "https://github.com/williamstein"
}
```
