...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/81#issuecomment-410",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "The solution will be to detect that SAGE_ROOT has changed (we should save the last known SAGE_ROOT somewhere). If so, recursively delete all .pyc and .pyo files from the python/site-packages directories.  This will fix the problem completely, since those\nget safely generated on restart.",
    "created_at": "2006-10-15T07:58:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/81",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/81#issuecomment-411",
    "user": "https://github.com/williamstein"
}
```
