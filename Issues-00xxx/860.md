...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/860#issuecomment-5305",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Hmm, I don't see any patch. Did it get merged already?\n\nCheers,\n\nMichael",
    "created_at": "2007-10-12T16:24:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/860",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/860#issuecomment-5306",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Hmm, I don't see any patch. Did it get merged already?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/860",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/860#issuecomment-5307",
    "user": "https://github.com/williamstein"
}
```
