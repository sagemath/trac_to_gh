...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/192#issuecomment-963",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/192#issuecomment-964",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This will be fixed automatically by fixing trac #196.",
    "created_at": "2007-01-19T09:54:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/192#issuecomment-965",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>This will be fixed automatically by fixing trac #196.
...
```json
{
    "body": "<a id='comment:4'></a>Fixed by fixing trac #196.",
    "created_at": "2007-01-21T21:51:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/192#issuecomment-966",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Fixed by fixing trac #196.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/192#issuecomment-967",
    "user": "https://github.com/williamstein"
}
```
