...
```json
{
    "body": "<a id='comment:2'></a>i fixed this on the plane to san diego.  now it works with the *new* aiom package that builds on CLISP.\n\nWilliam",
    "created_at": "2007-08-18T23:36:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/420#issuecomment-2200",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>i fixed this on the plane to san diego.  now it works with the *new* aiom package that builds on CLISP.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/420#issuecomment-2201",
    "user": "https://github.com/williamstein"
}
```
