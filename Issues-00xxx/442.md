...
```json
{
    "body": "<a id='comment:1'></a>in sage-2.8.1/local/lib/python2.5/site-packages/numpy/lib/polynomial.py,\nline 116 appears to be casting whatever float type is given to just float.",
    "created_at": "2007-08-18T19:44:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/442#issuecomment-2435",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:1'></a>in sage-2.8.1/local/lib/python2.5/site-packages/numpy/lib/polynomial.py,
line 116 appears to be casting whatever float type is given to just float.
...
```json
{
    "body": "<a id='comment:2'></a>This is just as much an issue for eigen_left and eigen_right:\n \nsage: g = Matrix(RDF, [[0, -9],[1,6]]); g\n[ 0.0 -9.0]\n[ 1.0  6.0]\nsage: g.eigen_left()\n([3.00000003183, 2.99999996817], .....",
    "created_at": "2007-08-18T20:24:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/442#issuecomment-2436",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:2'></a>This is just as much an issue for eigen_left and eigen_right:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/442#issuecomment-2437",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>See ticket #211.",
    "created_at": "2007-08-18T20:33:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/442",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/442#issuecomment-2438",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>See ticket #211.
