...
<a id='comment:28'></a>Replying to [zimmerma](#comment%3A27):
> yes I tried other patches (#10983, #8720, #10596) before #715, but each one with a
> different clone.
...
```json
{
    "body": "Changing dependencies from \"\" to \"#9138, #11900\"",
...
Changing dependencies from "" to "#9138, #11900"
...
```json
{
    "body": "Changing work_issues from \"\" to \"Comparison of the third key items\"",
    "created_at": "2011-12-30T09:24:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
...
Changing work_issues from "" to "Comparison of the third key items"
...
<a id='comment:64'></a>Replying to [jpflori](#comment%3A63):
> Ok, I'll give the new patch a go and report after make ptestlong
...
```json
{
    "body": "Changing work_issues from \"\" to \"avoid regression\"",
    "created_at": "2012-01-03T14:52:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
...
Changing work_issues from "" to "avoid regression"
...
<a id='comment:79'></a>Replying to [vbraun](#comment%3A78):
> Just as a remark from the side lines, it seems that consistently storing a reference in the parent would be the cleanest solution.
...
<a id='comment:83'></a>Replying to [SimonKing](#comment%3A82):
...
<a id='comment:94'></a>Replying to [jpflori](#comment%3A93):
> I've just built last sage prealpha and am quite busy today, but I'll at least run ptestlong with and without patches to get timings in the afternoo.
...
<a id='comment:98'></a>Replying to [jpflori](#comment%3A97):
>  * 3092.9 seconds with no errors on vanilla
>  * 3097.8 seconds with 3 errors in sage.matrix.action.pyx and 1 in  sage.structure.corece_dict.pyx on vanille + the two patches in the  current ticket ([#715](http://trac.sagemath.org/sage_trac/ticket/715)) description.
...
```json
{
    "body": "Changing work_issues from \"\" to \"Avoid a regression\"",
    "created_at": "2012-01-05T17:02:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
...
Changing work_issues from "" to "Avoid a regression"
...
<a id='comment:116'></a>Replying to [SimonKing](#comment%3A114):
> How should the eraser know which entry is to be removed? I wouldn't like to re-implement the weakref module...
...
<a id='comment:130'></a>Replying to [jpflori](#comment%3A129):
> Running "make ptestlong" gave me:
> 
> * sage-5.0.prealpha1 vanilla: 1397.9 sec
> * sage-5.0.prealpha1 + 715: 1415.0 sec
...
<a id='comment:144'></a>Replying to [jpflori](#comment%3A142):
> With the current implementation, Actions always use a weak ref for the underlying set so that it can and will be garbage collected if it is not strong refed elsewhere.
> 
> You illustrate and mention that in some examples in action.pyx.
> 
...
<a id='comment:146'></a>Replying to [jpflori](#comment%3A145):
> I'll have some time to work on this today or friday.
> 
> Any progress on your side ?
> 
...
<a id='comment:163'></a>Replying to [davidloeffler](#comment%3A162):
> What is there here that still needs review? I can confirm that the change in jpflori's reviewer patch does not affect the doctest, in the sense that the new patched doctest fails without this ticket applied but succeeds with it. Is this ready to go in?
...
<a id='comment:177'></a>Replying to [jpflori](#comment%3A173):
> Putting back the if h<0: h=-h (without really thinking about it) seems to solve the problem.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4296",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4297",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4298",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4299",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4301",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4302",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4303",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4304",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4305",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4306",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4307",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4308",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4309",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4310",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4311",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4312",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4313",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4314",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4315",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"Fix __delitem__\"",
    "created_at": "2012-08-20T10:16:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4316",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "Fix __delitem__"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4317",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4318",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4319",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4320",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4321",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4322",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4323",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "Changing work_issues from \"\" to \"test activity of weak references if addresses coincide\"",
    "created_at": "2012-08-21T08:19:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4324",
    "user": "https://github.com/simon-king-jena"
}
```

Changing work_issues from "" to "test activity of weak references if addresses coincide"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4325",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4326",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4327",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4328",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4329",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4330",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4331",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4332",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4333",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4334",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4335",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4336",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4337",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4338",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4339",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4340",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4341",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4342",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4343",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4344",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4345",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4348",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4350",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:231'></a>Replying to [jdemeyer](#comment%3A228):\n> Replying to [SimonKing](#comment%3A227):\n> > Perhaps I should retry with 5.4.beta0, then?\n\n> Yes, you could.\n\nBuilding it now...",
    "created_at": "2012-09-05T12:54:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4351",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:231'></a>Replying to [jdemeyer](#comment%3A228):
> Replying to [SimonKing](#comment%3A227):
> > Perhaps I should retry with 5.4.beta0, then?
...
```json
{
    "body": "<a id='comment:233'></a>Replying to [vbraun](#comment%3A232):\n>   * gdb disables ASLR by default, so all memory locations are reproducible (but different from running without gdb).\n\n\nOK, that is likely to be a problem here.",
    "created_at": "2012-09-05T13:16:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4353",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:233'></a>Replying to [vbraun](#comment%3A232):
>   * gdb disables ASLR by default, so all memory locations are reproducible (but different from running without gdb).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4354",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4355",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4356",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4357",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:239'></a>Replying to [SimonKing](#comment%3A234):\n> Hooray!\n\nHooray because you get a Segmentation Fault, there are a lot of tickets that should make you happy then :-)\n\n> Why is it so much faster for you, Jeroen?\n\nCaching (the disk kind) perhaps?",
    "created_at": "2012-09-05T17:56:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4359",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:239'></a>Replying to [SimonKing](#comment%3A234):
> Hooray!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4360",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4361",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4362",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4363",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4364",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4366",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4369",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4371",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4372",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4373",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4374",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4375",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4376",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4377",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4378",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4379",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4380",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:260'></a>Replying to [nbruin](#comment%3A257):\n> Using `os.exit` versus `os._exit`: I can see why one might have thought that's a good idea. We got what we came for (the function got executed and the result is stored in an `.sobj` -- this should really be communicated via a pipe to the parent, not via a temporary file), so why risk fouling it up by doing more just to exit? However, if someone uses this for side-effects (write to some shared file) it could be the buffers don't get flushed. On the other hand, code is executing in parallel here (that's the point), so one would probably already run into problems.\n\n\nChanging `os._exit` into `os.exit` won't work. The example `oddprime_factors.precompute(range(1,99))` seems to hang with that change.",
    "created_at": "2012-09-07T16:44:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4381",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:260'></a>Replying to [nbruin](#comment%3A257):
> Using `os.exit` versus `os._exit`: I can see why one might have thought that's a good idea. We got what we came for (the function got executed and the result is stored in an `.sobj` -- this should really be communicated via a pipe to the parent, not via a temporary file), so why risk fouling it up by doing more just to exit? However, if someone uses this for side-effects (write to some shared file) it could be the buffers don't get flushed. On the other hand, code is executing in parallel here (that's the point), so one would probably already run into problems.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4383",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4388",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4393",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4394",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4395",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4396",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4397",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4398",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4399",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4400",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4401",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4402",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4403",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4404",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4405",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4410",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4411",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4412",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4413",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Cc to Martin, since I suppose he knows about Singular's `omAlloc` and can comment on the problems described in[comment:295](#comment%3A295).\n\nNils: Kudos for digging to such depth!\n\nSince there is a new Singular spkg at #13237 which got merged into sage-5.4.beta0, we may check whether the segfault also occurs with the old version of Singular.",
    "created_at": "2012-09-09T22:50:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4418",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:6'></a>Cc to Martin, since I suppose he knows about Singular's `omAlloc` and can comment on the problems described in[comment:295](#comment%3A295).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4419",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4420",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4421",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4422",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4423",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4424",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4425",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4428",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4430",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4431",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4432",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4433",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4439",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4440",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4441",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4442",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4443",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4444",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4447",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4448",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4449",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4450",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4451",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4452",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4453",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4454",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4455",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4456",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4457",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4458",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4459",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4460",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4461",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4462",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4463",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4464",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4465",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4467",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4468",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4469",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4470",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4471",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4472",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4473",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    "body": "<a id='comment:340'></a>Replying to [mjo](#comment%3A336):\n> The fix at #12313 is what does it for me:\n\n\nThe next step for me is to move the pari-fix from #12313 to a separate ticket.",
    "created_at": "2012-11-22T10:17:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4474",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:340'></a>Replying to [mjo](#comment%3A336):
> The fix at #12313 is what does it for me:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4475",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4476",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4477",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4478",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4479",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4481",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4482",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4483",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4484",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4485",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4486",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4487",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4490",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4491",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:359'></a>Replying to [jpflori](#comment%3A358):\n> Replying to [SimonKing](#comment%3A356):\n> > I remember - but I do not remember the ticket number - that I had to *incref* something in the *deallocation* of something homset-related. It could be that it was in groupoids, but I am not sure.\n> > \n\n> Was it #13447?\n\nNope. It did involve groupoids, I think.",
    "created_at": "2012-12-26T17:18:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4494",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:359'></a>Replying to [jpflori](#comment%3A358):
> Replying to [SimonKing](#comment%3A356):
> > I remember - but I do not remember the ticket number - that I had to *incref* something in the *deallocation* of something homset-related. It could be that it was in groupoids, but I am not sure.
> > 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4495",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4496",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4497",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4498",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4499",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/715#issuecomment-4501",
    "user": "https://github.com/JohnCremona"
}
```
