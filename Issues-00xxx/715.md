...
```json
{
    "body": "**Work Issues:** Comparison of the third key items",
    "created_at": "2011-12-30T09:24:05Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "**Changing work issues** from \"Comparison of the third key items\" to \"fix doctests\".",
    "created_at": "2011-12-30T23:30:08Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Changing work issues** from "Comparison of the third key items" to "fix doctests".
...
```json
{
    "body": "**Work Issues:** avoid regression",
    "created_at": "2012-01-03T14:52:54Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "**Changing work issues** from \"avoid regression\" to \"\".",
    "created_at": "2012-01-04T10:10:59Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Changing work issues** from "avoid regression" to "".
...
```json
{
    "body": "**Work Issues:** Avoid a regression",
    "created_at": "2012-01-05T17:02:43Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Work Issues:** Avoid a regression
...
```json
{
    "body": "**Changing work issues** from \"Avoid a regression\" to \"Get some timings\".",
...
**Changing work issues** from "Avoid a regression" to "Get some timings".
...
```json
{
    "body": "**Changing work issues** from \"Get some timings\" to \"Improve timing and provid documentation\".",
...
**Changing work issues** from "Get some timings" to "Improve timing and provid documentation".
...
```json
{
    "body": "**Changing work issues** from \"Improve timing and provid documentation\" to \"Rename `TripleDictById` into `TripleDict`. Improve timing and update documentation\".",
    "created_at": "2012-01-08T17:21:37Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Changing work issues** from "Improve timing and provid documentation" to "Rename `TripleDictById` into `TripleDict`. Improve timing and update documentation".
...
```json
{
    "body": "**Changing work issues** from \"Rename `TripleDictById` into `TripleDict`. Improve timing and update documentation\" to \"Should we rename `TripleDictById` into `TripleDict`, or do we want a \"weak triple dictionary with comparison by equality\"?\".",
    "created_at": "2012-01-09T00:23:01Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Changing work issues** from "Rename `TripleDictById` into `TripleDict`. Improve timing and update documentation" to "Should we rename `TripleDictById` into `TripleDict`, or do we want a "weak triple dictionary with comparison by equality"?".
...
```json
{
    "body": "**Changing work issues** from \"Should we rename `TripleDictById` into `TripleDict`, or do we want a \"weak triple dictionary with comparison by equality\"?\" to \"\".",
    "created_at": "2012-01-09T16:43:06Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Changing work issues** from "Should we rename `TripleDictById` into `TripleDict`, or do we want a "weak triple dictionary with comparison by equality"?" to "".
...
```json
{
    "body": "**Attachment:** [trac715_one_triple_dict.patch](https://github.com/sagemath/sage/files/ticket715/trac715_one_triple_dict.patch)\n\nDrop the distinction of `TripleDict` versus `TripleDictById`. Use the memory addresses as dictionary keys",
    "created_at": "2012-01-09T20:13:06Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac715_optional_weakref.patch](https://github.com/sagemath/sage/files/ticket715/trac715_optional_weakref.patch)\n\nMake use of weakrefs optional: off by default, on for coercion",
    "created_at": "2012-02-10T16:58:07Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Attachment:** [trac715_optional_weakref.patch](https://github.com/sagemath/sage/files/ticket715/trac715_optional_weakref.patch)
...
```json
{
    "body": "**Attachment:** [trac_715-one_triple_dict-take2.patch](https://github.com/sagemath/sage/files/ticket715/trac_715-one_triple_dict-take2.patch)\n\nVersion without fuzz",
    "created_at": "2012-04-12T13:47:31Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_715-reviewer-take2.patch](https://github.com/sagemath/sage/files/ticket715/trac_715-reviewer-take2.patch)",
    "created_at": "2012-04-12T13:48:01Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_715-rebase_11599-take2.patch](https://github.com/sagemath/sage/files/ticket715/trac_715-rebase_11599-take2.patch)\n\nUse size_t instead of Py_ssize_t for indices used by PyList_GET_ITEM",
    "created_at": "2012-04-12T13:49:07Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [trac_715_specification.patch](https://github.com/sagemath/sage/files/ticket715/trac_715_specification.patch)\n\nDocument the specifications of `TripleDict`",
    "created_at": "2012-08-16T18:24:18Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "**Work Issues:** Fix __delitem__",
...
```json
{
    "body": "**Changing work issues** from \"Fix __delitem__\" to \"\".",
    "created_at": "2012-08-20T10:33:02Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Changing work issues** from "Fix __delitem__" to "".
...
```json
{
    "body": "**Work Issues:** test activity of weak references if addresses coincide",
    "created_at": "2012-08-21T08:19:23Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
**Work Issues:** test activity of weak references if addresses coincide
...
```json
{
    "body": "**Attachment:** [trac_715_combined.patch](https://github.com/sagemath/sage/files/ticket715/trac_715_combined.patch)\n\nIntroduce weak references to coercion dicts, and refactor the hashtables.",
    "created_at": "2012-09-03T09:30:10Z",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:358'></a>\nReplying to [@simon-king-jena](#comment%3A356):\n> I remember - but I do not remember the ticket number - that I had to *incref* something in the *deallocation* of something homset-related. It could be that it was in groupoids, but I am not sure.\n> \n\nWas it #13447?\n> The fact that I had to incref before deallocating suggests that something fishy was going on, and perhaps it is related?",
