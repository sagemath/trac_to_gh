...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2093"
}
```
...
```json
{
    ...
    "milestone": "sage-feature",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2094"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2095"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2096"
}
```
...
```json
{
    ...
    "milestone": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2098"
}
```
...
```json
{
    ...
    "milestone": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2099"
}
```
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2100"
}
```
...
```json
{
    ...
    "milestone": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2101"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2102"
}
```
...
```json
{
    ...
    "milestone": "sage-pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2103"
}
```
...
```json
{
    ...
    "milestone": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2104"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>\nAh! If one does quit_sage() in an interactive session and then quits sage, the segfault occurs in `_unsafe_deallocate_pari_`stack. That problem is fixed in another patch of mine, namely [at #12215](http://trac.sagemath.org/sage_trac/attachment/ticket/12215/trac12215_segfault_fixes.patch).",
...
```json
{
    "body": "<a id='comment:9'></a>\nIf one replaces `_unsafe_deallocate_pari_`stack by `__dealloc__` (as suggested by #12215), the segfault created by manually using quit_sage() has moved to `sage.rings.integer.clear_mpz_globals()`. I guess that function has to do some checks before calling free.\n\nAnyway. With the change to pari, one still has the signal 11 problem in sage -t sage/misc/cachefunc.pyx, as before.",
...
```json
{
    ...
    "milestone": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2105"
}
```
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2106"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2107"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/715#event-2108"
}
```
