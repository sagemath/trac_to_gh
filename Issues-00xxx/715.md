...
```json
{
    "body": "<a id='comment:53'>Comment 53:</a>\nMeanwhile I built sage-5.0.prealpha0 and applied #11780 and [attachment: trac715_two_tripledicts.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_two_tripledicts.patch.gz). Sage starts fine.\n\nSo, Volker, what had you have applied when Sage didn't start?",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,7 +19,4 @@\n \n So weak refs should be used in all these places if it does not slow things too much.\n \n-Apply:\n-\n-* [attachment: trac715_two_tripledicts.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_two_tripledicts.patch.gz)\n-* [attachment: trac715_weak_action.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_weak_action.patch.gz)\n+Apply [attachment: trac715_tripledict_combined.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_tripledict_combined.patch.gz)\n``````\n",
    "created_at": "2012-01-07T12:13:22Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,4 +19,4 @@\n \n So weak refs should be used in all these places if it does not slow things too much.\n \n-Apply [attachment: trac715_tripledict_combined.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_tripledict_combined.patch.gz)\n+Apply [attachment: trac715_one_tripledict.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_one_tripledict.patch.gz)\n``````\n",
    "created_at": "2012-01-09T16:43:06Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -19,4 +19,4 @@\n \n So weak refs should be used in all these places if it does not slow things too much.\n \n-Apply [attachment: trac715_one_tripledict.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_one_tripledict.patch.gz)\n+Apply\u00a0[attachment: trac715_one_triple_dict.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_one_triple_dict.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5866"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5867"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5869"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5870"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5871"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5872"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5873"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5874"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5875"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5876"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5877"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5878"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5879"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5880"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5881"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5882"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5883"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5884"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5885"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5886"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5887"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5888"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5889"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5890"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5891"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5892"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5893"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5894"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5895"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5896"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5897"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5898"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5901"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5902"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5904"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5905"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5906"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5907"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5908"
}
```
...
```json
{
    "body": "<a id='comment:8'>Comment 8:</a>\nAttachment: **[failing_test_under_gdb.py.gz](https://github.com/sagemath/sage/files/ticket715/failing_test_under_gdb.py.gz)**\n\nI am not totally sure if I understand what you mean: You say it would be interesting to see the temporary file that is created by `sage -t`? Then: see [attachment: failing_test_under_gdb.py.gz](https://github.com/sagemath/sage/files/ticket715/failing_test_under_gdb.py.gz).\n\nThe original file was as in [comment:251](#comment%3A251). It passes when running `sage -t`, but fails when running `sage -t -gdb`.",
...
```json
{
    "body": "<a id='comment:6'>Comment 6:</a>\nI'm pretty sure the failing tests are because of [attachment: trac_715_osx64-dealloc.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac_715_osx64-dealloc.patch.gz) (since that's the only thing that changed recently).",
...
```json
{
    "body": "<a id='comment:8'>Comment 8:</a>\nSigh.\n\nNils, you found that `python -t` [attachment: cachefunc_94107.py.gz](https://github.com/sagemath/sage/files/ticket715/cachefunc_94107.py.gz) segfaults in example_27, right? But if one deletes all tests that come *after* example_27, the segfault vanishes.\n\nIn other words, whether there is a segfault or not depends on the presence of tests that will never be executed because of the segfault.",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5909"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5910"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5911"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/715#event-5915"
}
```
