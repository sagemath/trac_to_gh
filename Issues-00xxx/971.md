...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/971#issuecomment-4500",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4533"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4534"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/971#issuecomment-4501",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4535"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4536"
}
```
...
```json
{
    ...
    "asset_name": "971.patch",
    "asset_url": "tarball://root/attachments/ticket971/971.patch",
    "created_at": "2007-11-01T01:23:17Z",
    "issue": "https://github.com/sagemath/sage/issues/971",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket971/971.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/971",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/971#issuecomment-4503",
