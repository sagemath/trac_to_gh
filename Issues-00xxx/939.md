...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/939#issuecomment-6175",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/939#issuecomment-6176",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/939#issuecomment-6177",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nValgrind says:\n\n```\n==31660== Conditional jump or move depends on uninitialised value(s)\n==31660==    at 0x4451ED: PyObject_Free (obmalloc.c:920)\n==31660==    by 0x4C7158: code_dealloc (codeobject.c:270)\n==31660==    by 0x4CD46D: frame_dealloc (frameobject.c:444)\n==31660==    by 0x4AC94A: tb_dealloc (traceback.c:34)\n==31660==    by 0x4AC956: tb_dealloc (traceback.c:33)\n==31660==    by 0x4AC956: tb_dealloc (traceback.c:33)\n==31660==    by 0x4AC956: tb_dealloc (traceback.c:33)\n==31660==    by 0x4AC956: tb_dealloc (traceback.c:33)\n==31660==    by 0x4AC956: tb_dealloc (traceback.c:33)\n==31660==    by 0x4AC956: tb_dealloc (traceback.c:33)\n==31660==    by 0x96389BC: `__Pyx_`GetExcValue (parent.c:6870)\n==31660==    by 0x9648136: `__pyx_f_`6parent_6Parent_get_action_c_impl (parent.c:2844)\n\n==31660== Use of uninitialised value of size 8\n==31660==    at 0x445206: PyObject_Free (obmalloc.c:920)\n==31660==    by 0x4C7158: code_dealloc (codeobject.c:270)\n==31660==    by 0x4CD46D: frame_dealloc (frameobject.c:444)\n==31660==    by 0x4AC94A: tb_dealloc (traceback.c:34)\n==31660==    by 0x96389BC: `__Pyx_`GetExcValue (parent.c:6870)\n==31660==    by 0x9646E52: `__pyx_f_`6parent_6Parent_get_action_c_impl (parent.c:2556)\n==31660==    by 0x963D127: `__pyx_f_`6parent_6Parent_get_action_c (parent.c:1658)\n==31660==    by 0x99C9FD4: `__pyx_f_`6coerce_24CoercionModel_cache_maps_discover_action_c (coerce.c:6409)\n==31660==    by 0x99CA974: `__pyx_f_`6coerce_24CoercionModel_cache_maps_discover_action_c (coerce.c:6824)\n==31660==    by 0x99C1D77: `__pyx_f_`6coerce_24CoercionModel_cache_maps_get_action_c (coerce.c:6261)\n==31660==    by 0x99DBB96: `__pyx_f_`6coerce_24CoercionModel_cache_maps_bin_op_c (coerce.c:4515)\n==31660==    by 0x977FCA1: `__pyx_f_py_`7element_11RingElement___mul__ (element.c:7603)\n```\nBut that might be just due to k being \"out of bounds\" again.\n\nCheers,\n\nMichael",
    "created_at": "2007-10-20T17:39:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/939#issuecomment-6178",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/939#issuecomment-6180",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/939",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/939#event-2858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/939#issuecomment-6181",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/939#event-2859"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/939#issuecomment-6182",
    "user": "https://github.com/williamstein"
}
```
