...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/475#issuecomment-2607",
...
```json
{
    "body": "<a id='comment:2'></a>-g in CFLAGS is, IMHO, a different level than turning off all optimization and Python memory management (the latter actually have a significant speed impact, the former none).",
    "created_at": "2009-07-28T12:58:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/475#issuecomment-2608",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>-g in CFLAGS is, IMHO, a different level than turning off all optimization and Python memory management (the latter actually have a significant speed impact, the former none).
