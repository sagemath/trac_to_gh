# Issue 822: [with patch] Some matrix multiplications inefficiencies
...
```json
{
    ...
    "title": "[with patch] Some matrix multiplications inefficiencies",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/822#issuecomment-5353",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/822",
    "rename": {
        "from": "Some matrix multiplications inefficiencies",
        "to": "[with patch] Some matrix multiplications inefficiencies"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/822#event-2798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/822",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/822#event-2799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/822#issuecomment-5354",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/822#issuecomment-5355",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/822#issuecomment-5356",
    "user": "https://github.com/williamstein"
}
```
