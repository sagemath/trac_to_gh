...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/190#event-626"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/190#event-627"
}
```
...
archive/attachments_000045.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac190-1.patch",
    "asset_url": "tarball://root/attachments/ticket190/trac190-1.patch",
    "created_at": "2007-08-18T18:51:42Z",
    "issue": "https://github.com/sagemath/sage/issues/190",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket190/trac190-1.patch",
...
```json
{
    "body": "Attachment [trac190-1.patch](https://github.com/sagemath/sage/files/ticket190/trac190-1.patch) by dmharvey created at 2007-08-18 18:51:42\n\npartial fix for bug",
    "created_at": "2007-08-18T18:51:42Z",
    "issue": "https://github.com/sagemath/sage/issues/190",
    "type": "issue_comment",
...
Attachment [trac190-1.patch](https://github.com/sagemath/sage/files/ticket190/trac190-1.patch) by dmharvey created at 2007-08-18 18:51:42
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/190",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/190#event-628"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/190#event-629"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/190#event-630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/190#event-631"
}
```
