...
```json
{
    "body": "<a id='comment:1'></a>I don't understand what you're talking about, what you want, or why this is a defect and not\nan enhancement.  Please clarify this trac issue.",
...
<a id='comment:1'></a>I don't understand what you're talking about, what you want, or why this is a defect and not
an enhancement.  Please clarify this trac issue.
...
```json
{
    "body": "<a id='comment:4'></a>The attached patch implements this.",
...
<a id='comment:4'></a>The attached patch implements this.
...
```json
{
    "body": "<a id='comment:8'></a>applied to 2.8.9.alpha0",
    "created_at": "2007-10-23T19:51:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/282",
    "type": "issue_comment",
...
<a id='comment:8'></a>applied to 2.8.9.alpha0
