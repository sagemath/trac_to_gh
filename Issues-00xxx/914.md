...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6099",
...
```json
{
    "body": "<a id='comment:2'></a>Here's the steps I took to get it to work.\n\nrm -rf $SAGE_ROOT/devel/sage-main\nrm -rf $SAGE_ROOT/spkg/installed/sage-2.8.7\nsage -upgrade\n\nThis should probably be marked as invalid.",
    "created_at": "2007-10-17T22:51:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6100",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>Here's the steps I took to get it to work.
...
```json
{
    "body": "<a id='comment:3'></a>There is a problem here, but it's basically probably too hard too fix, and there is an easy workaround (see above).",
    "created_at": "2007-10-19T01:21:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6101",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>There is a problem here, but it's basically probably too hard too fix, and there is an easy workaround (see above).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6102",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6103",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6104",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6105",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6106",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6107",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6108",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/914#issuecomment-6109",
    "user": "https://github.com/williamstein"
}
```
