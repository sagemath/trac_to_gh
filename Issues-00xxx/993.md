...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/993#issuecomment-6341",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/993",
    "rename": {
        "from": "Pari's gp interpreter has built-in library search path, defeating Sage mechanisms",
        "to": "[with spkg] Pari's gp interpreter has built-in library search path, defeating Sage mechanisms"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/993#event-3389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/993#issuecomment-6342",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/993#issuecomment-6343",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/993#issuecomment-6344",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/993#issuecomment-6345",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/993",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/993#event-3390"
}
```
