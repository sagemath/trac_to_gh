# Issue 760: [with patch] graphs: a small change to subgraphs allow it to default to the original graph.
...
```json
{
    ...
    "title": "[with patch] graphs: a small change to subgraphs allow it to default to the original graph.",
    "type": "issue",
...
```json
{
    ...
    "rename": {
        "from": "[patch] graphs: a small change to subgraphs allow it to default to the original graph.",
        "to": "[with patch] graphs: a small change to subgraphs allow it to default to the original graph."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/760#event-2494"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/760#issuecomment-4685",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/760#issuecomment-4686",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/760#event-2495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/760",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/760#event-2496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/760#issuecomment-4687",
...
```json
{
    ...
    "milestone": "sage-2.8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/760#event-2497"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/760#event-2498"
}
```
