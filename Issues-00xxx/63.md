...
```json
{
    "body": "<a id='comment:1'></a>Now it stays in the same cell, but bounces to the beginning.  Still a bug.",
...
<a id='comment:1'></a>Now it stays in the same cell, but bounces to the beginning.  Still a bug.
...
```json
{
    "body": "<a id='comment:4'></a>fixed by Tom Boothby for SAGE-1.8.",
    "created_at": "2007-01-22T01:42:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/63",
    "type": "issue_comment",
...
<a id='comment:4'></a>fixed by Tom Boothby for SAGE-1.8.
