...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3050",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3051",
...
archive/attachments_000213.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "6169.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket558/6169.patch",
...
```json
{
    "body": "work in progress for freeing the integer pool on exit",
    "created_at": "2007-09-06T18:26:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3052",
    "user": "https://github.com/malb"
}
```
...
archive/attachments_000214.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "6170.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket558/6170.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3053",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/558#event-1632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3054",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3055",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3056",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3057",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/558#event-1633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/558#event-1634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3058",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3059",
    "user": "https://github.com/malb"
}
```
...
archive/attachments_000215.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "6253.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket558/6253.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/558#issuecomment-3060",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/558#event-1635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/558#event-1636"
}
```
