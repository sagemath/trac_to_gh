...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [minpoly_FiniteFieldElement.patch](https://github.com/sagemath/sage/files/ticket497/minpoly_FiniteFieldElement.patch) by @pdenapo created at 2007-09-01 21:08:37\n\nHere is an updated version of my patch. It also adds a default variable name 'x' to charpoly.",
    "created_at": "2007-09-01T21:08:37Z",
    "issue": "https://github.com/sagemath/sage/issues/497",
    "type": "issue_comment",
