...
```json
{
    ...
    "rename": {
        "from": "[with spkg, needs review] update M2 to the 1.1 release",
        "to": "[with spkg, not ready for review] update M2 to the 1.1 release"
    },
    "type": "issue_event",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10",
    "rename": {
        "from": "[with spkg, not ready for review] update M2 to the 1.1 release",
        "to": "[with spkg, positive review] update M2 to the 1.1 release"
    },
    "type": "issue_event",
