...
archive/attachments_000526.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "856.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket856/856.patch",
...
```json
{
    "body": "patch needs testing on 32-bit machines",
    "created_at": "2007-10-12T04:47:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/856",
    "type": "issue_comment",
