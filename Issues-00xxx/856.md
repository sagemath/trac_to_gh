# Issue 856: [with patch] [tested by cwitty] strange behaviour when converting a numpy matrix to a sage one
...
```json
{
    ...
    "title": "[with patch] [tested by cwitty] strange behaviour when converting a numpy matrix to a sage one",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/856#issuecomment-5567",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] strange behaviour when converting a numpy matrix to a sage one"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/856#event-2915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/856#issuecomment-5568",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/856",
    "rename": {
        "from": "[with patch] strange behaviour when converting a numpy matrix to a sage one",
        "to": "[with patch] [tested by cwitty] strange behaviour when converting a numpy matrix to a sage one"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/856#event-2916"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/856",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/856#issuecomment-5569",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/856",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/856#event-2917"
}
```
