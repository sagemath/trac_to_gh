...
```json
{
    "body": "**Attachment:** [jordan-form.2.patch](https://github.com/sagemath/sage/files/ticket874/jordan-form.2.patch)\n\nApply (and review) instead of original jordan-form.patch.",
    "created_at": "2008-02-16T05:49:22Z",
    "issue": "https://github.com/sagemath/sage/issues/874",
    "type": "issue_comment",
...
**Attachment:** [jordan-form.2.patch](https://github.com/sagemath/sage/files/ticket874/jordan-form.2.patch)
...
```json
{
    "body": "**Attachment:** [jordan-form.3.patch](https://github.com/sagemath/sage/files/ticket874/jordan-form.3.patch)\n\nAdds a note saying that the computation is naive.",
    "created_at": "2008-02-22T20:37:11Z",
    "issue": "https://github.com/sagemath/sage/issues/874",
    "type": "issue_comment",
...
**Attachment:** [jordan-form.3.patch](https://github.com/sagemath/sage/files/ticket874/jordan-form.3.patch)
...
archive/attachments_000563.json:
```json
{
    "asset_content_type": "application/octet-stream",
