...
```json
{
    "body": "<a id='comment:4'></a>I fixed this by changing prereq-0.3-install, and actually did a bunch of other\nminor cleanup to the base directory, including creating an .hg repo there.",
...
<a id='comment:4'></a>I fixed this by changing prereq-0.3-install, and actually did a bunch of other
minor cleanup to the base directory, including creating an .hg repo there.
...
<a id='comment:5'></a>Here is the interesting part of the script:
