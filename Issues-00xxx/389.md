...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/389#event-1062"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/389#event-1063"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/389#event-1064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/389#issuecomment-2005",
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/389#event-1065"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/389#event-1066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/389",
    "rename": {
        "from": "bug in mpfi C library",
        "to": "[with spkg, patch] bug in mpfi C library"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/389#event-1067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/389#issuecomment-2006",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/389#issuecomment-2007",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/389",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/389#issuecomment-2008",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/389",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/389#event-1068"
}
```
