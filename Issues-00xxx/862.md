...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket862/Sage-2.8.6-fix-memleak-in-Matrix_modn_sparse.patch",
    "created_at": "2007-10-13T00:05:39Z",
    "issue": "https://github.com/sagemath/sage/issues/862",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket862/Sage-2.8.6-fix-memleak-in-Matrix_modn_sparse.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [Sage-2.8.6-fix-memleak-in-Matrix_modn_sparse.patch](https://github.com/sagemath/sage/files/ticket862/Sage-2.8.6-fix-memleak-in-Matrix_modn_sparse.patch) by mabshoff created at 2007-10-13 00:05:39",
    "created_at": "2007-10-13T00:05:39Z",
    "issue": "https://github.com/sagemath/sage/issues/862",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/862#event-4079"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/862",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/862#event-4080"
}
```
