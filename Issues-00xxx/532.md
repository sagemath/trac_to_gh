...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/532#issuecomment-2814",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/532#issuecomment-2815",
...
```json
{
    "body": "<a id='comment:5'></a>This is because polynomial_element.pyx has a global (well, module-level) variable holding a RealField:\n\n```\nRR = RealField()\n```\n(As a module-level variable, this never gets freed.)\n\nEach RealField holds two RealNumbers (._zero_element and ._one_element), so they never get freed either.",
    "created_at": "2007-10-11T22:02:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/532",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/532#issuecomment-2816",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:5'></a>This is because polynomial_element.pyx has a global (well, module-level) variable holding a RealField:
