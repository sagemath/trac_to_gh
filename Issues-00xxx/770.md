...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/770#issuecomment-4757",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/770#issuecomment-4758",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/770",
    "rename": {
        "from": "Bad behaviour when Ctrl-C hit while running an expect interface",
        "to": "[with patch] Bad behaviour when Ctrl-C hit while running an expect interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/770#event-2546"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/770#event-2547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/770",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/770#event-2548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/770#issuecomment-4759",
