...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/152#issuecomment-759",
...
```json
{
    "body": "<a id='comment:1'></a>Fixed. Thanks so much for the detailed description and bugfix.",
    "created_at": "2007-02-08T21:30:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/152#issuecomment-760",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>Fixed. Thanks so much for the detailed description and bugfix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/152#issuecomment-761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/152#issuecomment-762",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/152#issuecomment-763",
    "user": "https://github.com/fchapoton"
}
```
