...
```json
{
    "body": "**Attachment:** [iml-1.0.3.p0.diff](https://github.com/sagemath/sage/files/ticket748/iml-1.0.3.p0.diff)",
    "created_at": "2013-06-14T13:24:37Z",
    "issue": "https://github.com/sagemath/sage/issues/748",
    "type": "issue_comment",
...
**Attachment:** [iml-1.0.3.p0.diff](https://github.com/sagemath/sage/files/ticket748/iml-1.0.3.p0.diff)
...
```json
{
    "body": "**Changing work issues** from \"remove tinyatlas stuff, rename sage*.patch\" to \"\".",
...
**Changing work issues** from "remove tinyatlas stuff, rename sage*.patch" to "".
