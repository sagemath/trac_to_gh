...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/748#issuecomment-4645",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket748/iml-1.0.3.p0.diff",
...
```json
{
    "body": "<a id='comment:51'></a>\nReplying to [leif](#comment%3A50):\n> **Sign of life of IML upstream** on #14648 !!1!111!\n\n\nticket:14648#comment:51 ff. that is.",
