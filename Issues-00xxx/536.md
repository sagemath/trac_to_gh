...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/536#issuecomment-2315",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/536#event-1550"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/536#event-1551"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/536#event-1552"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/536#event-1553"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/536#event-1554"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/536#event-1555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/536#issuecomment-2316",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/536#issuecomment-2317",
    "user": "https://github.com/craigcitro"
}
```
