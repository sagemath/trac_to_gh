...
```json
{
    "body": "<a id='comment:1'></a>This ticket seems like a high priority item. It is a little stale and William ought to update what has happened. If there are only small issues left we should close this ticket and open individual tickets for the remaining items.\n\nCheers,\n\nMichael",
    "created_at": "2007-09-10T02:40:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/198#issuecomment-980",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>This ticket seems like a high priority item. It is a little stale and William ought to update what has happened. If there are only small issues left we should close this ticket and open individual tickets for the remaining items.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/198#issuecomment-981",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This will be replaced by many smaller tickets.",
    "created_at": "2007-10-24T02:54:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/198#issuecomment-982",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>This will be replaced by many smaller tickets.
