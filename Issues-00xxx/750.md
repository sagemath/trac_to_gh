...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/750#event-2449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4613",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4614",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4615",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4616",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "milestone": "sage-feature",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/750#event-2450"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/750#event-2451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4617",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4618",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4619",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "rename": {
        "from": "permutation group element (dict method, acting on lists)",
        "to": "[with patch] permutation group element (dict method, acting on lists)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/750#event-2452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/750#issuecomment-4620",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/750",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/750#event-2453"
}
```
