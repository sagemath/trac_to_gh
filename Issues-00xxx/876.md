...
```json
{
    "body": "<a id='comment:3'></a>This looks very much like a wish list item. Moved.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-05T22:25:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/876",
    "type": "issue_comment",
...
<a id='comment:3'></a>This looks very much like a wish list item. Moved.
...
```json
{
    "body": "<a id='comment:4'></a>BTW, in gap_packages there is a GPL'd package called braid that might help here. It was packaged before GPLv3 came out (I actually did the packaging but did not write any of the code).",
...
<a id='comment:4'></a>BTW, in gap_packages there is a GPL'd package called braid that might help here. It was packaged before GPLv3 came out (I actually did the packaging but did not write any of the code).
...
<a id='comment:5'></a>Incidentally, apparently the braid package is now autoloaded, though it doesn't seem to be used anywhere.  This is improperly documented in interfaces/gap.py, though:
...
```json
{
    "body": "<a id='comment:7'></a>Looks like this is now much further along at #12339.",
    "created_at": "2012-07-07T03:01:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/876",
    "type": "issue_comment",
...
<a id='comment:7'></a>Looks like this is now much further along at #12339.
