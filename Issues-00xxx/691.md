...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/691#issuecomment-3871",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/691#issuecomment-3872",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Actually, there is a problem with f._compute.  Ignore the above patch for now.",
    "created_at": "2007-09-19T00:57:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/691#issuecomment-3873",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:3'></a>Actually, there is a problem with f._compute.  Ignore the above patch for now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/691#issuecomment-3874",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [691.2.patch](tarball://root/attachments/some-uuid/ticket691/691.2.patch) by @mwhansen created at 2007-09-19 01:24:18\n\nPatch attached which fixes the issues.",
    "created_at": "2007-09-19T01:24:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/691#issuecomment-3875",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>Attachment [691.2.patch](tarball://root/attachments/some-uuid/ticket691/691.2.patch) by @mwhansen created at 2007-09-19 01:24:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/691#issuecomment-3876",
