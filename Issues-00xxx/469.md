...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2565",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2566",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2567",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2569",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2572",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Ok, I updated the spkg as well applied the bundle. I also disabled doctests until you can send in the missing bits.\n\nCheers,\n\nMichael",
    "created_at": "2007-12-10T22:34:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2573",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Ok, I updated the spkg as well applied the bundle. I also disabled doctests until you can send in the missing bits.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2574",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Attachment [fix_pbori_doctests.hg](tarball://root/attachments/some-uuid/ticket469/fix_pbori_doctests.hg) by mabshoff created at 2007-12-12 18:37:38\n\nMerged in 2.9.alpha6. - Finally. Doctests pass.",
    "created_at": "2007-12-12T18:37:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2575",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:13'></a>Attachment [fix_pbori_doctests.hg](tarball://root/attachments/some-uuid/ticket469/fix_pbori_doctests.hg) by mabshoff created at 2007-12-12 18:37:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/469#issuecomment-2576",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
