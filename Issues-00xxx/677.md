...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/677#issuecomment-3625",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Ok, this works in python's doctests, so no need to implement this. Maybe it still needs to be added to the manual.\n\nCheers,\n\nMichael",
    "created_at": "2007-11-26T22:20:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/677#issuecomment-3626",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Ok, this works in python's doctests, so no need to implement this. Maybe it still needs to be added to the manual.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/677#issuecomment-3627",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
