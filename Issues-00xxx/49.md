...
```json
{
    "body": "<a id='comment:1'></a>Another way of putting this is that the **only** time the default precision should be relevant is when coercing other objects into the field, and this should be overridable in the element constructor. At all other times, e.g. performing arithmetic on two elements, the precision of the **elements** should be the only relevant thing.",
    "created_at": "2006-09-13T14:45:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/49",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/49#issuecomment-297",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:1'></a>Another way of putting this is that the **only** time the default precision should be relevant is when coercing other objects into the field, and this should be overridable in the element constructor. At all other times, e.g. performing arithmetic on two elements, the precision of the **elements** should be the only relevant thing.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/49",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/49#issuecomment-298",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/49",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/49#issuecomment-299",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
