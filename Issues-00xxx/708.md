...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/708#issuecomment-3823",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/708#event-2255"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/708#issuecomment-3824",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/708",
    "rename": {
        "from": "performance issue -- Magma is way faster at testing some polynomials for irreducibility",
        "to": "[with patch, needs review] performance issue -- Magma is way faster at testing some polynomials for irreducibility"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/708#event-2256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/708#issuecomment-3825",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/708",
    "rename": {
        "from": "[with patch, needs review] performance issue -- Magma is way faster at testing some polynomials for irreducibility",
        "to": "[with patch, positive review] performance issue -- Magma is way faster at testing some polynomials for irreducibility"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/708#event-2257"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/708",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/708#event-2258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/708#issuecomment-3826",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/708",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/708#issuecomment-3827",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
