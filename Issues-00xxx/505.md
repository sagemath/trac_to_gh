...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/505#issuecomment-2772",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/505",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/505#issuecomment-2773",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/505",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/505#issuecomment-2774",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I rerun the test with 2.8.3alpha2 and valgrind and can confirm that the problem is gone and the fix works.\n\nCheers,\n\nMichael",
    "created_at": "2007-08-29T11:24:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/505",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/505#issuecomment-2775",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>I rerun the test with 2.8.3alpha2 and valgrind and can confirm that the problem is gone and the fix works.
