...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/505#issuecomment-1861",
...
```json
{
    ...
    "asset_name": "m4ri_cleanup.patch",
    "asset_url": "tarball://root/attachments/ticket505/m4ri_cleanup.patch",
    "created_at": "2007-08-28T23:52:25Z",
    "issue": "https://github.com/sagemath/sage/issues/505",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket505/m4ri_cleanup.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [m4ri_cleanup.patch](https://github.com/sagemath/sage/files/ticket505/m4ri_cleanup.patch) by @williamstein created at 2007-08-28 23:52:25\n\nThis fixes the m4ri not being cleaned up issue, I hope.",
    "created_at": "2007-08-28T23:52:25Z",
    "issue": "https://github.com/sagemath/sage/issues/505",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/505#issuecomment-1862",
    "user": "https://github.com/williamstein"
}
```

Attachment [m4ri_cleanup.patch](https://github.com/sagemath/sage/files/ticket505/m4ri_cleanup.patch) by @williamstein created at 2007-08-28 23:52:25
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/505#event-2093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/505#event-2094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/505",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/505#event-2095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/505",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/505#issuecomment-1863",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
