...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/295#event-2160"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/295#event-2161"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/295#event-2162"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **Nick Alexander**",
...
Changed assignee from **@williamstein** to **Nick Alexander**
...
```json
{
    "body": "Changed assignee from **Nick Alexander** to **@ncalexan**",
...
Changed assignee from **Nick Alexander** to **@ncalexan**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/295",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/295#event-2163"
}
```
