...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/188#event-620"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/188#event-621"
}
```
...
```json
{
    ...
    "milestone": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/188#event-622"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/188",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/188#event-623"
}
```
