# Issue 309: [with positive review] rationals enumeration not  monotone in height
...
```json
{
    ...
    "title": "[with positive review] rationals enumeration not  monotone in height",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-793"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1568",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1569",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "milestone": "sage-feature",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-795"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1570",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1571",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1572",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1573",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1574",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1575",
    "user": "https://github.com/aghitza"
}
```
...
archive/attachments_000081.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "309-rational_iter_height.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket309/309-rational_iter_height.patch",
    "created_at": "2008-09-02T02:07:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "attachment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1576",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1577",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1578",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
archive/attachments_000082.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "309-rational_iter_height_interactive.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket309/309-rational_iter_height_interactive.patch",
...
```json
{
    "body": "apply on top of 309-rational_iter_height.patch and the patch from #4037",
    "created_at": "2008-09-02T04:52:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1579",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1580",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1581",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        "from": "rationals enumeration not  monotone in height",
        "to": "[with positive review] rationals enumeration not  monotone in height"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1582",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1583",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/309#event-801"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/309#issuecomment-1584",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
