...
archive/attachments_000595.json:
```json
{
...
```json
{
    "body": "**Attachment:** [trac915.patch](https://github.com/sagemath/sage/files/ticket915/trac915.patch)\n\nRemove the usage of GMP-Integer implementation of Z",
    "created_at": "2008-02-17T02:39:43Z",
    "issue": "https://github.com/sagemath/sage/issues/915",
    "type": "issue_comment",
...
**Attachment:** [trac915.patch](https://github.com/sagemath/sage/files/ticket915/trac915.patch)
...
archive/attachments_000596.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac915.2.patch](https://github.com/sagemath/sage/files/ticket915/trac915.2.patch)\n\nRemove the work-around with gmp-integers",
    "created_at": "2008-02-17T02:49:05Z",
    "issue": "https://github.com/sagemath/sage/issues/915",
    "type": "issue_comment",
...
**Attachment:** [trac915.2.patch](https://github.com/sagemath/sage/files/ticket915/trac915.2.patch)
