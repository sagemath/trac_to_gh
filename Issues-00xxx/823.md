...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/823#issuecomment-5564",
...
```json
{
    "body": "<a id='comment:6'></a>I just noticed that building the cvxopt package with this atlas causes a missing symbol error for the cvxopt package\n\n_g95_ioparm\n\nI'm mystified by this. Need to investigate.",
    "created_at": "2007-11-27T06:23:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/823#issuecomment-5567",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkantor"
}
```

<a id='comment:6'></a>I just noticed that building the cvxopt package with this atlas causes a missing symbol error for the cvxopt package
...
```json
{
    "body": "<a id='comment:7'></a>Ignore the cvxopt package issue, it was a mistake on my part, I think atlas is ready to go.",
    "created_at": "2007-11-28T06:05:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/823#issuecomment-5568",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkantor"
}
```

<a id='comment:7'></a>Ignore the cvxopt package issue, it was a mistake on my part, I think atlas is ready to go.
...
```json
{
    "body": "<a id='comment:8'></a>the atlas3.8 package didn't have mabshoff's patch so that the shared objects are copied by make install \n\nhttp://sage.math.washington.edu/home/jkantor/spkgs/atlas-3.8.p1.spkg",
    "created_at": "2007-11-28T22:37:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/823#issuecomment-5569",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkantor"
}
```

<a id='comment:8'></a>the atlas3.8 package didn't have mabshoff's patch so that the shared objects are copied by make install 
...
```json
{
    "body": "<a id='comment:10'></a>On OSX the ld options --whole_archive don't exist. \n\nThe following appears to produce a shared atlas from the static one\n\nld -dylib -o libatlas.dylib  -lm -lc -all_load libatlas.a\n\n(-L must be set appropriately)",
    "created_at": "2007-11-29T02:26:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/823#issuecomment-5571",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkantor"
}
```

<a id='comment:10'></a>On OSX the ld options --whole_archive don't exist. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/823#issuecomment-5573",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/823#issuecomment-5574",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
