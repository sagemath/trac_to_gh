...
```json
{
    "body": "<a id='comment:1'></a>This much simpler example also leaks:\n\n```\nsage: K = GF(10007^2, 'a')\nsage: X = PolynomialRing(K, 'x').gen()\nsage: s = K.random_element(); t = K.random_element()\nsage: for i in range(1000):\n    _ = t*X\n```",
    "created_at": "2007-08-18T16:12:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1461",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This much simpler example also leaks:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1462",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Not givaro, pari:\n\nsage: K = GF(10007^2, 'a')\nsage: type(K)\n<class 'sage.rings.finite_field.FiniteField_ext_pari'>",
    "created_at": "2007-08-18T16:15:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1463",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Not givaro, pari:
...
```json
{
    "body": "<a id='comment:4'></a>The problem is in polynomial creation.\n\n```\nK = GF(2^16, 'a')\nprint type(K)\nR.<x> = K[]\nprint type(R)\ns = K.random_element()\n\ndef leak(n):\n    m = get_memory_usage()\n    for i in range(n):\n        _ = R([1])\n    print get_memory_usage() - m\n\nleak(10000)\n```",
    "created_at": "2007-08-18T20:05:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1464",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>The problem is in polynomial creation.
...
```json
{
    "body": "<a id='comment:6'></a>after much hunting, the bug appears to be in PARI gen __bool__ method, which currently is implemented as:\n\n```\ndef __bool__(gen self):\n   _sig_on\n   t = bool(self.g != stoi(0))\n   _sig_off\n   return t\n```\n\nwhich doesn't make a whole lot of sense.",
    "created_at": "2007-08-18T21:56:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1465",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:6'></a>after much hunting, the bug appears to be in PARI gen __bool__ method, which currently is implemented as:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1466",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This is really a symptom of some sort of much more general memory leak problem in the PARI C library interface, as the following bizarre example illustrates:\n\n```\nsage: n = pari('x')\nsage: m = pari(0)\nsage: s = get_memory_usage()\nsage: for i in range(2*10^5):\n...       _ = pari(0)\n...\nsage: print get_memory_usage() - s\n0.0\nsage: n = pari('x')\nsage: m = pari(0)\nsage: s = get_memory_usage()\nsage: for i in range(2*10^5):\n...       _ = n == m\n...\nsage: print get_memory_usage() - s\n0.0\nsage: n = pari('x')\nsage: m = pari(0)\nsage: s = get_memory_usage()\nsage: for i in range(2*10^5):\n...       _ = n == pari(0)\n...\nsage: print get_memory_usage() - s\n10.87109375\n```",
    "created_at": "2007-08-19T05:32:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1467",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>This is really a symptom of some sort of much more general memory leak problem in the PARI C library interface, as the following bizarre example illustrates:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/274#issuecomment-1468",
    "user": "https://github.com/williamstein"
}
```
