...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/39#issuecomment-179",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/39",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/39#issuecomment-180",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/39",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/39#event-178"
}
```
...
```json
{
    ...
    "milestone": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/39#event-179"
}
```
