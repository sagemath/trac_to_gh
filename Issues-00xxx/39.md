...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/39#issuecomment-181",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/39",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/39#issuecomment-182",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/39",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/39#event-181"
}
```
...
```json
{
    ...
    "milestone": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/39#event-182"
}
```
