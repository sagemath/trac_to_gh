...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-289"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/39",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-292"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-293"
}
```
