...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-307"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/39",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/39#issuecomment-179",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/39",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/39#issuecomment-180",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/39",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-311"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/39#event-312"
}
```
