...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2750",
...
```json
{
    "body": "<a id='comment:3'></a>pexpect is now in version 2.3.  We appear to still have version 2.0 (? it's hard to tell, no obvious pexpect version command).  Anyway, might upgrading render this obsolete?",
    "created_at": "2009-12-30T04:47:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2751",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:3'></a>pexpect is now in version 2.3.  We appear to still have version 2.0 (? it's hard to tell, no obvious pexpect version command).  Anyway, might upgrading render this obsolete?
...
```json
{
    "body": "<a id='comment:4'></a>Recent version of pexpect is 3.3 (http://pexpect.readthedocs.org/en/latest/index.html) which could be installed using pip. But installing this version will result in failing doctests.",
    "created_at": "2014-08-18T19:38:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2752",
    "user": "https://github.com/a-andre"
}
```

<a id='comment:4'></a>Recent version of pexpect is 3.3 (http://pexpect.readthedocs.org/en/latest/index.html) which could be installed using pip. But installing this version will result in failing doctests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2753",
...
```json
{
    "body": "<a id='comment:5'></a>Fixed by #10295.",
    "created_at": "2015-12-04T13:59:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2754",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:5'></a>Fixed by #10295.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2755",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2756",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/502#issuecomment-2758",
