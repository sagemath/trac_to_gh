...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/149#event-898"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/149#event-899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/149#event-900"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/149#event-901"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/149",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/149#event-902"
}
```
