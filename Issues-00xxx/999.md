...
```json
{
    "body": "<a id='comment:1'></a>To include the GAP code which is written in GAP, you need to count the lines in the *.gi files\nas well. I don't know if you can exclude all lines beginning with a # or not (these would be\ncomments or documentation).",
...
<a id='comment:1'></a>To include the GAP code which is written in GAP, you need to count the lines in the *.gi files
as well. I don't know if you can exclude all lines beginning with a # or not (these would be
comments or documentation).
...
```json
{
    "body": "<a id='comment:4'></a>I don't think we need such a thing...",
    "created_at": "2013-06-13T12:27:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/999",
    "type": "issue_comment",
...
<a id='comment:4'></a>I don't think we need such a thing...
