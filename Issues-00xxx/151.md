...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/151#issuecomment-716",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/151#issuecomment-717",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/151#issuecomment-719",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/151#issuecomment-720",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The example\n\n```\nmaxima.eval(\"-(1/2)*taylor (sqrt (1-4*x^2), x, 0, 15)\")\n```\n\nno longer causes problems.  But other things do.\n\nWilliam",
    "created_at": "2007-01-12T23:49:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/151#issuecomment-721",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>The example
...
```json
{
    "body": "<a id='comment:9'></a>I wrote a \"sage-cleaner\" daemon, which I *think* totally deals with this problem and more very nicely (and gets rid of the need for the monitor process).  I have tested it extensively on OS X and it works perfectly.   Only further testing will tell for sure, but for now (and for SAGE-1.8) this bug is closed.",
    "created_at": "2007-01-22T21:37:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/151#issuecomment-723",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>I wrote a "sage-cleaner" daemon, which I *think* totally deals with this problem and more very nicely (and gets rid of the need for the monitor process).  I have tested it extensively on OS X and it works perfectly.   Only further testing will tell for sure, but for now (and for SAGE-1.8) this bug is closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/151#issuecomment-724",
    "user": "https://github.com/williamstein"
}
```
