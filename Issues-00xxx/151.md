...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/151#event-906"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/151#event-907"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/151#event-908"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/151#event-909"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/151",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/151#event-910"
}
```
