...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/607#event-5475"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/607#event-5476"
}
```
...
```json
{
    ...
    "subject": "https://github.com/robertwb",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/607#event-5477"
}
```
...
```json
{
    ...
    "subject": "https://github.com/robertwb",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/607#event-5478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/607",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/607#event-5479"
}
```
