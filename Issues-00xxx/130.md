...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/130#issuecomment-667",
...
```json
{
    "body": "<a id='comment:2'></a>In straight Ipython this problems doesn't happen.  In sage it does.  Tricky.  \n\nPLAN:\n1. disable bits of how sage customizes ipython until find the problem.",
    "created_at": "2007-01-12T23:23:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/130#issuecomment-668",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>In straight Ipython this problems doesn't happen.  In sage it does.  Tricky.  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/130#issuecomment-669",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/130#issuecomment-670",
    "user": "https://github.com/williamstein"
}
```
