...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-796"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-797"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/130",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-799"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-800"
}
```
