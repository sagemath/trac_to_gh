...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-861"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/130#issuecomment-446",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/130#issuecomment-447",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/130#issuecomment-448",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/130",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-865"
}
```
...
```json
{
    ...
    "milestone_title": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/130#event-866"
}
```
