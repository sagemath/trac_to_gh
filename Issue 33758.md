...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479418",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479419",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Parts work: running `make ptestlong-nodoc` skips the right files. The start of `test.log`:\n\n```\n### Running ./sage -t --logfile=logs/test.log  --optional=sage,optional,!sagemath_doc_html,!sagemath_doc_pdf --all\n```\n",
    "created_at": "2022-06-23T04:56:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479421",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479422",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479423",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479424",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479425",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "I think this message belongs on the console, not the log",
    "created_at": "2022-06-26T18:07:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479427",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Fine with me if you want to push this change using `tee` to the ticket. I agree that the deprecation notice is easily overlooked, but I don't think it's very important",
    "created_at": "2022-06-26T21:39:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479429",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479430",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479431",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479432",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33758#issuecomment-479433",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33758",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33758#event-89006"
}
```
