...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337907",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I propose autotoolization. It would be hell to make this work on OSX and other non-linux otherwise. Do shout if you need help with this - it's not hard, in fact.",
    "created_at": "2017-12-10T10:17:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337909",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337911",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337912",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337913",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337914",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337915",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "PS: There is only one header file to be installed, namely `meataxe.h`. The other header files apparently are only used for testing. So, they should actually better be moved into the test/ folder.",
    "created_at": "2017-12-10T16:20:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337916",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Currently meataxe only has a single src directory, containing all headers (the one to be included and the ones used for testing) and all code files (regardless whether for library functions, for executable or for tests). That'd really require a major overhaul.",
    "created_at": "2017-12-10T16:23:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337917",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337918",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337919",
    "user": "dimpase"
}
```
...
```json
{
    "body": "Another question concerning the portability of the dynamic library approach. Are dynamic libraries really available on all platforms targeted by Sage?",
    "created_at": "2017-12-17T09:44:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337921",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337922",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337923",
    "user": "dimpase"
}
```
...
```json
{
    "body": "As I mentioned earlier, upstream ignores my patches to add Winograd-Strassen multiplication, although it is faster than schoolbook multiplication even for quite small matrices. But what would happen if upstream would accept autotoolization, but would keep ignoring the other patches?\n\nWouldn't the addition of another source file imply a change in `src/Makefile.am` (which would be part of the distribution)? I.e., we would have to wait for upstream to accept the autotoolization and then still need to patch Makefile.am",
    "created_at": "2017-12-17T10:22:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337924",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Just create a fork. The fact that upstream ignores patches should not preclude further development, and the license perfectly allows this. \n\nCall it AutoMeatAxe, say...",
    "created_at": "2017-12-17T10:25:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337925",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337926",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337930",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "BTW, I just created a parallel computation (using the `@`parallel decorator) of matrix products of different sizes. At least with the current static library, it works fine.",
    "created_at": "2017-12-17T13:25:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337931",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337932",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337933",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "`@`parallel does not do any memory sharing among subprocesses---which is often a problem for computations where you really want to avoid the overhead of copying everything, but in this case it would actually make the transition to the dynamic setting seamless.\n\n(of course, in a real multithreaded application things like global variables are something that is to be avoided, but it's not the case here.)",
    "created_at": "2017-12-17T13:55:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337934",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337935",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337936",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337940",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "various versions of .so are fine, it is the usual versioning stuff. only one of them is not a link. by default both static and dynamic libs are built. you can use a parameter to configure to build only dynamic one, something like `--disable-static`\n\nheader location can be adjusted in the progs that use them.",
    "created_at": "2017-12-27T10:36:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337942",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337943",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337944",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337945",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337946",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337947",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "If found [a macro to check for doxygen](http://www.gnu.org/software/autoconf-archive/ax_prog_doxygen.html#ax_prog_doxygen) at the Autoconf archive. Do I understand correctly that I am supposed to copy that macro into the m4/ directory of my package in order to use it?",
    "created_at": "2017-12-27T13:52:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337949",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337951",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337952",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337953",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337954",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Concerning \"type 'dirs' is not supported\", I find the following matches for \"dirs\" in etc/ (where the doxygen layout file resides):\n\n```\netc/layout.xml:    <tab type=\"dirs\" visible=\"yes\" title=\"\"/>\netc/layout.xml:      <dirs visible=\"yes\" title=\"\"/>\netc/layout.xml:      <dirs visible=\"yes\"/>\n```\n",
    "created_at": "2017-12-27T18:54:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337955",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337957",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337958",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337959",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337960",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Very very odd: Although Doxyfile says `GENERATE_LATEX='NO'`, autotools is still calling doxygen with `GENERATE_LATEX='YES'`.",
    "created_at": "2017-12-27T21:21:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337961",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Solved it! Apparently `DX_INIT` needs to be called *after* `DX_..._FEATURE`.",
    "created_at": "2017-12-27T21:26:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337962",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "There remain these problems: Documentation is not uninstalled and I cannot prescribe a directory name different from doc/.",
    "created_at": "2017-12-27T21:29:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337963",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337964",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337965",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337966",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337969",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "You can call `$(MKDIR_P)$ in the makefile, why would you need to call it from your scripts? You can also export it in the makefile, why would you need a script for it? \n\nHowever, it seems that you rather want to create temporary directories/files directly, make tests output to stdout, and redirect it to temporary files.",
    "created_at": "2017-12-29T14:18:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337970",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337971",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337972",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Is it ok to build the always install the documentation if the package gets installed? Could be a problem if doxygen is missing.\nOr should it only be installed, if `SAGE_SPKG_INSTALL=yes`?",
    "created_at": "2017-12-29T16:24:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337975",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Is it fine to use `rm -f` in an install script, or is there some variable for it, such as `$(RM) -f`?",
    "created_at": "2017-12-29T16:51:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337976",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337977",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "There is one test in sage.matrix.special that fails, but that's because of #23706. I opened #24445, but I think this shouldn't be a dependency: The failing test can be fixed without #24445.",
    "created_at": "2017-12-29T20:01:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337978",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337979",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337980",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337981",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337983",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337984",
    "user": "git"
}
```
...
```json
{
    "body": "For now, I have fixed make distcheck by appending to the path. It works...\n\nNext, I will be running `make test` for Sage.",
    "created_at": "2017-12-29T21:06:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337985",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337986",
    "user": "git"
}
```
...
```json
{
    "body": "Sorry, I made a mistake and had to force-push. Now it should be fine.\n----\nNew commits:",
    "created_at": "2017-12-29T21:17:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337987",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337988",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337989",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "You should use the standard template for `build/pkgs/meataxe/SPKG.txt`",
    "created_at": "2017-12-30T09:16:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337990",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "And `$SAGE_LOCAL` should be quoted in `spkg-install`.",
    "created_at": "2017-12-30T09:22:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337991",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337993",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "In `spkg-install` files, you should use the new utility functions like `sdh_configure`. See `build/pkgs/ccache/spkg-install` for an example.",
    "created_at": "2017-12-30T09:26:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337994",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337995",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337996",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337997",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337998",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-337999",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338001",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338002",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "PS: I think I should update the tarball, as I have slightly modified the documentation, by giving more proper reference to the \"unshared\" MeatAxe.",
    "created_at": "2017-12-30T10:35:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338003",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338004",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338005",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338006",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338007",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338008",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Found'em in SAGE_ROOT/src/bin...",
    "created_at": "2017-12-30T11:43:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338009",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "I can only say that the introduction of sdh_ things serves the purpose of a saner package management. E.g. I am told it would allow automatic reuse of system library in place of one supplied by Sage, and removal.",
    "created_at": "2017-12-30T11:55:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338010",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338011",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338012",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338013",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338014",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338015",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338016",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338018",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338019",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338020",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338021",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338022",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "On a `ppc64le` system, the testsuite fails badly (report attached). To be fair, the testsuite for the old meataxe also failed on that system, so I'm not blaming this ticket.",
    "created_at": "2017-12-30T17:22:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338023",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338024",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338025",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338026",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "In the summary at the very end of the configure script, I should probably also include what endianness has been found.",
    "created_at": "2017-12-30T17:49:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338028",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338030",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338031",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "`./configure` correctly detects\n\n```\n[meataxe-1.0] checking whether byte ordering is bigendian... no\n```\n",
    "created_at": "2017-12-30T18:28:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338032",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338033",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338035",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338036",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338037",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338038",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338039",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "I have updated the tarball and the checksum. The tests pass for me (i.e., creation of the test directories seems to work). Can you test if it works for you?\n\nAlso, in the configuration summary, I added a line about endianness.\n----\nNew commits:",
    "created_at": "2017-12-30T19:24:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338040",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338041",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338042",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338043",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338044",
    "user": "git"
}
```
...
```json
{
    "body": "Some more testing revealed that the problem with the `_out` directories is not fixed. But the issue is a race condition: I believe that `check-local` is simply an additional test target. It is unspecified whether this is run before/during/after the other tests.\n\nBut why don't you simply create the directory in the test script? That would be the easiest solution.",
    "created_at": "2017-12-30T19:38:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338045",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338047",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338048",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338049",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Do you see any other way but to use `mkdir -p t-xxxx_out` in the test script `t-xxxx`? Is `mkdir -p` available on all platforms supported by Sage? Or are there systems for which `$MKDIR_P` is different from `mkdir -p`?",
    "created_at": "2017-12-30T19:56:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338050",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338051",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338052",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "I am now trying to remove the race condition as follows:\n\n```\ncheck-local: mk.dir\n\trm -f mk.dir\n\nmk.dir:\n\tfor dir in $(TESTNUMBERS); do \\\n\t\t$(MKDIR_P) $${dir}_out; \\\n\tdone\n\ttouch mk.dir\n```\n\nIt works for me. Does it work, for you?\n----\nNew commits:",
    "created_at": "2017-12-30T20:16:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338053",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338054",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338055",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Concerning mkdir -p, see also https://unix.stackexchange.com/questions/49263/recursive-mkdir/49264 or https://www.gnu.org/savannah-checkouts/gnu/autoconf/manual/autoconf-2.69/html_node/Limitations-of-Usual-Tools.html#Limitations-of-Usual-Tools",
    "created_at": "2017-12-30T20:43:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338056",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Concerning the race condition, I could imagine that `check` starts after the actions in `check-local` are all *initiated*, but it isn't waited till they *terminated*. So, I think the fix pointed out in comment:141 (that already is in the current tarball) makes sense.",
    "created_at": "2017-12-30T21:37:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338057",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338058",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338059",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338060",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338061",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338062",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338063",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "appears to work on OSX with clang, too.",
    "created_at": "2018-01-01T11:17:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338064",
    "user": "dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338065",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "Rebased to 8.2.beta2, removed commits belonging to #24445, squashed to one commit. All to allow for easier testing.\n----\nNew commits:",
    "created_at": "2018-01-04T11:26:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338067",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338068",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338069",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338070",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338071",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338072",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338073",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "The build issue is not *caused* by this ticket (the old meataxe also had it and other optional Cython modules might also have it) but given that it's easy to fix, let's do that. Details coming soon...",
    "created_at": "2018-01-04T12:43:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338074",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338075",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338076",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338078",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "The underlying build issue is also fixed on the Cython level at #24471. Still, I think it's safer to delete all old meataxe libraries anyway. That is not a strong opinion though: I will change my mind if you think that I should.",
    "created_at": "2018-01-04T13:23:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338079",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338080",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338081",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Since the install location is the same in the old and in the new version, `make install` of the new version should successfully remove the old version.",
    "created_at": "2018-01-04T13:37:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338082",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338083",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338084",
    "user": "SimonKing"
}
```
...
```json
{
    "body": "Now it should be right.\n----\nNew commits:",
    "created_at": "2018-01-04T13:48:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338085",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338086",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338087",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338088",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338089",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338091",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338092",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338093",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338094",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338095",
    "user": "jdemeyer"
}
```
...
```json
{
    "body": "My last commit still needs review...",
    "created_at": "2018-01-05T09:07:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338096",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338097",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338098",
    "user": "SimonKing"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338099",
    "user": "jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24122#issuecomment-338100",
    "user": "vbraun"
}
```
