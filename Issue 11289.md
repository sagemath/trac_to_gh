...
```json
{
    "body": "Attachment [parallel.patch](tarball://root/attachments/some-uuid/ticket11461/parallel.patch) by niles created at 2011-06-10 18:06:52\n\nthis patch breaks `@`parallel, but prints information about how it's broken",
...
Attachment [parallel.patch](tarball://root/attachments/some-uuid/ticket11461/parallel.patch) by niles created at 2011-06-10 18:06:52
...
```json
{
    "body": "Attachment [trac_11461.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461.patch) by mhansen created at 2011-06-13 02:32:34",
...
Attachment [trac_11461.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461.patch) by mhansen created at 2011-06-13 02:32:34
...
```json
{
    "body": "Attachment [trac_11461_rebase.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461_rebase.patch) by niles created at 2011-09-08 01:27:38\n\nPasses all long tests on 4.7.1.\n\nPatchbot: apply trac_11461_rebase.patch",
...
Attachment [trac_11461_rebase.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461_rebase.patch) by niles created at 2011-09-08 01:27:38
...
```json
{
    "body": "Attachment [trac_11461_rebase_2.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461_rebase_2.patch) by niles created at 2012-01-16 18:37:58\n\nrebased to 4.7.2",
...
Attachment [trac_11461_rebase_2.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461_rebase_2.patch) by niles created at 2012-01-16 18:37:58
...
```json
{
    "body": "Attachment [trac_11461_rebase_3.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461_rebase_3.patch) by niles created at 2012-01-16 20:51:34\n\nSorry for the many updates; this patch is now compatible with (depends on) #11462.",
...
Attachment [trac_11461_rebase_3.patch](tarball://root/attachments/some-uuid/ticket11461/trac_11461_rebase_3.patch) by niles created at 2012-01-16 20:51:34
