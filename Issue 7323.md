...
```json
{
    "body": "Use trac_7323-simplicial-v2.patch instead.",
...
```json
{
    "body": "I do agree with the second patch. Seems very good to me.",
    "created_at": "2009-10-28T21:08:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/7323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/7323#issuecomment-61194",
    "user": "psaade"
}
```
...
```json
{
    "body": "(I just re-attached the same patch, so I could add the comment \"apply only this patch\".)",
