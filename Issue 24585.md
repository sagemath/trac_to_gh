...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-344874",
    "user": "@darijgr"
}
```
...
```json
{
    "body": "A superalgebra is an algebra, but an algebra is also a superalgebra. So there is a tensor product in either category. And they're different! The one in Algebras has forgotten the super-structure from the super-tensorand. How do we decide which to use?",
    "created_at": "2018-02-23T00:02:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-344876",
    "user": "@darijgr"
}
```
...
```json
{
    "body": "IIRC, Sage takes the safest route by taking the meet category, which in this case should be `Algebras(QQ)` since we essentially say an algebra is not a superalgebra (in the same way we do not say a ring is a ZZ-algebra).",
    "created_at": "2018-02-23T00:04:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24585#issuecomment-344877",
    "user": "@tscrim"
}
```
