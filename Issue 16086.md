...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209304",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209305",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209306",
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16086#event-48128"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209308",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209309",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209310",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209311",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209312",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Okay, I just loaded your branch and saw what you did. If you want to expose such a function you must really document it, a bit like the documentation of `OA_from_quasi_difference_matrix` and `OA_from_Vmt`. Definine difference matrices, and how the BIBD is produced.\n\nI don't know how to do that. That's why I left it as an inlined function.\n\nBTW, I think that the name should end with \"difference_family\", not DF.\n\nI will create the bugix ticket in a second.\n\nNathann",
    "created_at": "2014-05-27T17:50:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209313",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "Okay, actually it seems that the infinite recursion cannot happen when we avoid the stupid cases `v=1` and `k=1`. SOoooooooooooo instead of creating a ticket we can fix it here !\n\nAs I don't know what we will do with your branch and mine I don't write the commit but the fix is easy :\n\n```\n     \"\"\"\n-    if ((binomial(v,2)%binomial(k,2) != 0) or\n+    if (v<k or\n+        k<2 or\n+        (binomial(v,2)%binomial(k,2) != 0) or\n         (v-1)%(k-1) != 0):\n         if existence:\n```\n\n\nNathann",
    "created_at": "2014-05-27T18:01:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209314",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209315",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "Actually, I did a mistake: BIBD(1,k) always exists, just consider an empty set of blocks !!",
    "created_at": "2014-05-30T10:24:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209316",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209317",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209318",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209320",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209321",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209322",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209323",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209324",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/16086#issuecomment-209325",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/16086",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/16086#event-48129"
}
```
