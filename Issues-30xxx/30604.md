...
```json
{
    "body": "<a id='comment:1'></a>\nupstream already have some of these fixes in master, but not all.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[711fe05](https://git.sagemath.org/sage.git/commit?id=711fe05025795e44b84233e065d240859ccae5bd)|`missing extern decls and #include statements for scipy on xcode12`|",
