...
```json
{
    "body": "<a id='comment:6'></a>Rebased on 9.3.rc5.",
...
<a id='comment:6'></a>Rebased on 9.3.rc5.
...
```json
{
    "body": "<a id='comment:9'></a>Thank you for the review, David.",
...
<a id='comment:9'></a>Thank you for the review, David.
