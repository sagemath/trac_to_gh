...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -16,3 +16,5 @@\n sage: V in MetricSpaces()\n ```\n \n+also add (from ticket:30061#comment:44) `EuclideanSpace` (implementing the distance function by means of the Cartesian chart) and possibly other manifold classes.\n+\n``````\n",
