...
```json
{
    "body": "<a id='comment:2'></a>Thanks for catching this. This is another friendly reminder that working on those test suites is really useful.",
...
<a id='comment:2'></a>Thanks for catching this. This is another friendly reminder that working on those test suites is really useful.
...
<a id='comment:5'></a>Replying to [git](#comment%3A4):
> Branch pushed to git repo; I updated commit sha1. New commits:
> |                                                                                                                                           |                        |
> |-------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
> |[7fe6b43](https://git.sagemath.org/sage.git/commit/?id=7fe6b43d2ab3adde507fe745726b82c3bbc8059d)|`One transposition only`|
