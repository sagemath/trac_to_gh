...
```json
{
    "body": "<a id='comment:1'></a>The issue is already there in Sage 9.2.beta14.",
    "created_at": "2020-11-16T16:42:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613568",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:1'></a>The issue is already there in Sage 9.2.beta14.
...
```json
{
    "body": "<a id='comment:3'></a>The bug could arise from the upgrade to ipython 7 performed in #28197 (merged in Sage 9.2.beta8) or from the follow-up ticket #30417 (merged in Sage 9.2.beta11).",
    "created_at": "2020-11-17T08:07:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613570",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:3'></a>The bug could arise from the upgrade to ipython 7 performed in #28197 (merged in Sage 9.2.beta8) or from the follow-up ticket #30417 (merged in Sage 9.2.beta11).
...
```json
{
    "body": "<a id='comment:5'></a>I get the same if `f(x) = x \\ + 1` is typed at the sage prompt. So probably not the correct thing to try.",
    "created_at": "2020-11-18T00:47:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613572",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:5'></a>I get the same if `f(x) = x \ + 1` is typed at the sage prompt. So probably not the correct thing to try.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613573",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"68afcdb5b7ebf42e1a5c35e894759978d1bb1391\"",
    "created_at": "2020-11-21T23:28:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613576",
    "user": "https://github.com/jcamp0x2a"
}
```

Changing commit from "" to "68afcdb5b7ebf42e1a5c35e894759978d1bb1391"
...
```json
{
    "body": "Changing branch from \"\" to \"u/gh-jcamp0x2a/30928-backslash-continuation\"",
    "created_at": "2020-11-21T23:28:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613577",
    "user": "https://github.com/jcamp0x2a"
}
```

Changing branch from "" to "u/gh-jcamp0x2a/30928-backslash-continuation"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613578",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613580",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Initial testing indicates that line continuation is now working. However, regardless the input after the `sage: ` prompt, that input is parsed twice. Perhaps this is a separate issue or maybe not an issue? \n\nExample:\n\n```\nsage: f(x) = x \\ \n....:        + 1 \\ \n....:        + x^2                                                                                                                                                                                   \nwe are now in sage.repl.interpreter.SagePreparseTransformer\nresult of L = line.lstrip() in sage.repl.preparse\nf(x) = x \\\n       + 1 \\\n       + x^2\n\nwe are now in sage.repl.interpreter.SagePreparseTransformer\nresult of L = line.lstrip() in sage.repl.preparse\nf(x) = x \\\n       + 1 \\\n       + x^2\n\nsage: f(x)                                                                                                                                                                                           \nwe are now in sage.repl.interpreter.SagePreparseTransformer\nresult of L = line.lstrip() in sage.repl.preparse\nf(x)\n\nwe are now in sage.repl.interpreter.SagePreparseTransformer\nresult of L = line.lstrip() in sage.repl.preparse\nf(x)\n\nx^2 + x + 1\n```",
    "created_at": "2020-11-22T02:09:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613581",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:11'></a>Initial testing indicates that line continuation is now working. However, regardless the input after the `sage: ` prompt, that input is parsed twice. Perhaps this is a separate issue or maybe not an issue? 
...
```json
{
    "body": "<a id='comment:12'></a>Hmm... perhaps this is an IPython quirk? For example, running an IPython installed completely independently of Sage:\n\n```\n$ ~/.local/bin/ipython3\nPython 3.6.9 (default, Oct  8 2020, 12:12:24)\nType 'copyright', 'credits' or 'license' for more information\nIPython 7.16.1 -- An enhanced Interactive Python. Type '?' for help.\n\nIn [1]: def transform(lines):\n   ...:     print(lines)\n   ...:     return lines\n   ...:\n\nIn [2]: get_ipython().input_transformers_post.append(transform)\n\nIn [3]: 2 + 2\n['2 + 2\\n']\n['2 + 2\\n']\nOut[3]: 4\n```",
    "created_at": "2020-11-22T03:44:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613582",
    "user": "https://github.com/jcamp0x2a"
}
```

<a id='comment:12'></a>Hmm... perhaps this is an IPython quirk? For example, running an IPython installed completely independently of Sage:
...
```json
{
    "body": "<a id='comment:13'></a>Same here with `Python 3.8.6`. Bug or feature?",
    "created_at": "2020-11-22T04:23:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613583",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:13'></a>Same here with `Python 3.8.6`. Bug or feature?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613584",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613585",
...
```json
{
    "body": "Changing commit from \"68afcdb5b7ebf42e1a5c35e894759978d1bb1391\" to \"e45c71789eb151c5c3c9d15cca17deb9ff3d135c\"",
    "created_at": "2020-11-22T16:49:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613586",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "68afcdb5b7ebf42e1a5c35e894759978d1bb1391" to "e45c71789eb151c5c3c9d15cca17deb9ff3d135c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613588",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Btw, while making tests for this ticket branch, I found another error:\n\n```\nsage: f(x) = (x +  \n....:         1)                                                                                    \n  File \"<ipython-input-10-ae23cb631161>\", line 1\n    __tmp__=var(\"x\"); f = symbolic_expression((x + ).function(x)\n                                                   ^\nSyntaxError: invalid syntax\n```\nBut this does not pertain to the current ticket: it is already here in Sage 9.1.",
    "created_at": "2020-11-23T12:28:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613590",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:19'></a>Btw, while making tests for this ticket branch, I found another error:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613591",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613592",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613593",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Replying to [gh-jcamp0x2a](#comment%3A21):\n> The code is still fresh in my mind, and this seems like a trivial fix, so I'm going to try to knock it out here. If it's not as trivial as I thought, though, I'll spin off a new ticket and put this back into review.\n\n\nOK very good!",
    "created_at": "2020-11-23T16:44:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613594",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:22'></a>Replying to [gh-jcamp0x2a](#comment%3A21):
> The code is still fresh in my mind, and this seems like a trivial fix, so I'm going to try to knock it out here. If it's not as trivial as I thought, though, I'll spin off a new ticket and put this back into review.
...
```json
{
    "body": "Changing commit from \"e45c71789eb151c5c3c9d15cca17deb9ff3d135c\" to \"64c5757b4fb67d492f0c64cf7d3bda2d3616b56c\"",
    "created_at": "2020-11-23T17:56:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613595",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "e45c71789eb151c5c3c9d15cca17deb9ff3d135c" to "64c5757b4fb67d492f0c64cf7d3bda2d3616b56c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613596",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613597",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Not trivial. Forgot about nested parentheses/braces/brackets. A regular expression is really ill-suited to handling that, so `preparse_calculus` is going to need some work. Can use backslash continuations as a workaround for now.\n\nOn the bright side, I *was* able to quickly add support for breaking the parameter list onto multiple lines like so:\n\n```python\nf(a,\n  b,\n  c,\n  d) = a + b*2 + c*3 + d*4\n```\n\n...and we'll see what pyflakes has to say now. :)",
    "created_at": "2020-11-23T18:05:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613598",
    "user": "https://github.com/jcamp0x2a"
}
```

<a id='comment:24'></a>Not trivial. Forgot about nested parentheses/braces/brackets. A regular expression is really ill-suited to handling that, so `preparse_calculus` is going to need some work. Can use backslash continuations as a workaround for now.
...
```json
{
    "body": "<a id='comment:26'></a>Not sure what the source of the Darwin failures is. Every thing is fine here with `beta2`. I believe I've seen other false negative failures on Darwin.",
    "created_at": "2020-11-25T05:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613600",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:26'></a>Not sure what the source of the Darwin failures is. Every thing is fine here with `beta2`. I believe I've seen other false negative failures on Darwin.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613602",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613603",
    "user": "https://github.com/strogdon"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Eric please add your name to reviewers if you agree.",
    "created_at": "2020-11-25T05:39:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613604",
    "user": "https://github.com/strogdon"
}
```

<a id='comment:28'></a>Eric please add your name to reviewers if you agree.
...
```json
{
    "body": "<a id='comment:29'></a>Thank you very much for having fixed this!",
    "created_at": "2020-11-25T10:04:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613605",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:29'></a>Thank you very much for having fixed this!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613606",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613607",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613608",
...
```json
{
    "body": "Changing branch from \"u/gh-jcamp0x2a/30928-backslash-continuation\" to \"64c5757b4fb67d492f0c64cf7d3bda2d3616b56c\"",
    "created_at": "2020-12-05T22:13:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30928#issuecomment-613609",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/gh-jcamp0x2a/30928-backslash-continuation" to "64c5757b4fb67d492f0c64cf7d3bda2d3616b56c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30928",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30928#event-80763"
}
```
