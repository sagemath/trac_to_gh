...
```json
{
    "body": "<a id='comment:1'></a>That's a good idea for the `config.status --recheck` that is invoked by `make` sometimes.",
    "created_at": "2020-07-31T00:18:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30258#issuecomment-455002",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>That's a good idea for the `config.status --recheck` that is invoked by `make` sometimes.
...
```json
{
    "body": "<a id='comment:3'></a>Is it the main `Makefile` or `build/make/Makefile` that needs tweaking?\n\nIn passing, indentation in `Makefile`s is tabs-only but the main Makefile\nhas spaces mixed in at line 56.",
    "created_at": "2020-08-03T02:03:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30258#issuecomment-455003",
    "user": "https://github.com/slel"
}
```

<a id='comment:3'></a>Is it the main `Makefile` or `build/make/Makefile` that needs tweaking?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30258#issuecomment-455004",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78243"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78244"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78245"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30258#issuecomment-455006",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78246"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78247"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78248"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78249"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78250"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78251"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78252"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30258#event-78253"
}
```
