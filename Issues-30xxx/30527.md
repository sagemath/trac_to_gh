...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[147ec0f](https://git.sagemath.org/sage.git/commit/?id=147ec0f455c60ac72f51fdee97af2643b24d6dbf)|`build/pkgs/pip2pi: New`|\n|[e79de96](https://git.sagemath.org/sage.git/commit/?id=e79de9681ebd117165148769af5104dd125452e9)|`build/make/install: At the end, update the repository index`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[ee4a743](https://git.sagemath.org/sage.git/commit/?id=ee4a7435e0fc6b57550ffc8ef0aa1890428afd4b)|`Merge tag '9.3.beta2' into t/30527/pep-503-simple-repository-for-wheels`|\n|[9bae6a1](https://git.sagemath.org/sage.git/commit/?id=9bae6a13496b7cbf3eac6f7407dd30626e4d9591)|`build/pkgs/pip2pi: Make it a normal package`|\n|[4e7f968](https://git.sagemath.org/sage.git/commit/?id=4e7f9681d286bf74b8b589eb3387a41f02460117)|`build/pkgs/pip2pi/patches: Add patch for python >=3.8 support`|",
...
```json
{
    "body": "<a id='comment:33'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[333e50c](https://git.sagemath.org/sage.git/commit/?id=333e50c002787d5fc828109388d83f5f9b7bd78c)|`build/make/install: Do not ignore errors from dir2pi`|",
    "created_at": "2020-12-06T04:57:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30527",
    "type": "issue_comment",
