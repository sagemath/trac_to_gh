...
```json
{
    "body": "`cygwin-readline.patch` no longer applies",
...
```json
{
    "body": "Run of optional packages in https://github.com/mkoeppe/sage/actions/runs/1239984514 shows a failure of python_igraph-0.8.3 on `debian-buster`; but this package is being upgraded anyway in #32510",
...
```json
{
    "body": "With fedora 35, using the branch of this ticket or develop (with a change in configure to use system python3.10) with updated packages for cysignals and gmpy2, I have an error in pyzmq, see #31855",
...
```json
{
    "body": "Could you push your test branch to this ticket please? The branch that is on here is outdated",
...
```json
{
    "body": "I just pushed it, merged with develop, #32037 (update lcal to solve some failed tests), #32576 (cysignals needed for Fedora 35), #32797 (update pari to solve some failed tests), #32828 (pymzq needed for Fedora 35), #32885 (use of, e.g., sage -installed), and #32930 (prompt_toolkit gave an annoying warning).\n\n---\nLast 10 new commits:",
...
```json
{
    "body": "Let's reuse this ticket for an update to 3.10.x targeted for Sage 9.6",
...
```json
{
    "body": "First part of the patch for 3.10 is at https://github.com/conda-forge/python-feedstock/blob/master/recipe/patches/0008-bpo-22699-Allow-compiling-on-debian-ubuntu-with-a-di.patch",
...
```json
{
    "body": "Been using and testing on 3.10 for a while - the only thing unknown to me is the debian/ubuntu patch. But I trust Isuru's work. So, let's move on.",
    "created_at": "2022-03-07T18:55:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30767",
    "type": "issue_comment",
