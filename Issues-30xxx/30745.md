...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608633",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>upstream ecl is indeed useless, as no known to me distro (gentoo, homebrew) provides sufficiently patched ecl-20.\nSo we can have a spkg-configure.m4 for it, erroring out if it's found, on any distro.\n\n\nperhaps ntl/flint/singular combo on homebrew is good enough for Sage?",
    "created_at": "2020-10-08T16:36:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608634",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:2'></a>upstream ecl is indeed useless, as no known to me distro (gentoo, homebrew) provides sufficiently patched ecl-20.
So we can have a spkg-configure.m4 for it, erroring out if it's found, on any distro.
...
```json
{
    "body": "<a id='comment:3'></a>Traditionally build systems are supposed to pick up stuff in /usr/local, so its a bit of a feature. Gentoo doesn't install anything there afaik, it is intended for stuff that users install by hand (i.e. non-portage in Gentoo). I consider it the big homebrew WTF. \n\nRealistically, if you have stuff installed in /usr/local then you don't have a supported platform any more. Sure we should try to accommodate homebrew but imho not a blocker.",
    "created_at": "2020-10-10T23:51:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608635",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:3'></a>Traditionally build systems are supposed to pick up stuff in /usr/local, so its a bit of a feature. Gentoo doesn't install anything there afaik, it is intended for stuff that users install by hand (i.e. non-portage in Gentoo). I consider it the big homebrew WTF. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608636",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608637",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608638",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608639",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>A related recent change was made in #29697 (`sage_include_directories`: Do not add another copy of SAGE_INC, SAGE_LOCAL/lib to include dirs, library dirs).",
    "created_at": "2020-10-15T03:16:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608641",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:7'></a>A related recent change was made in #29697 (`sage_include_directories`: Do not add another copy of SAGE_INC, SAGE_LOCAL/lib to include dirs, library dirs).
...
```json
{
    "body": "<a id='comment:8'></a>The correct fix for `ecl` is probably to call `ecl-config` to determine the correct flags. #30770",
    "created_at": "2020-10-15T03:25:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608642",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:8'></a>The correct fix for `ecl` is probably to call `ecl-config` to determine the correct flags. #30770
...
```json
{
    "body": "<a id='comment:9'></a>arb, ntl, and flint can and should just be enabled on Homebrew. ECL is a different story, as it lacks patches.",
    "created_at": "2020-10-20T15:15:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608643",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:9'></a>arb, ntl, and flint can and should just be enabled on Homebrew. ECL is a different story, as it lacks patches.
...
```json
{
    "body": "<a id='comment:10'></a>It's not quite that easy, I am afraid. There are still the threading issues such as #27764",
    "created_at": "2020-10-21T00:05:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608644",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:10'></a>It's not quite that easy, I am afraid. There are still the threading issues such as #27764
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608645",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>more precisely, I see 2 doctests failing in `src/sage/rings/polynomial/plural.pyx` - not sure if this is related. The rest of `make ptest` passes.",
    "created_at": "2020-10-21T10:18:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608646",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:12'></a>more precisely, I see 2 doctests failing in `src/sage/rings/polynomial/plural.pyx` - not sure if this is related. The rest of `make ptest` passes.
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30745#event-80131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608647",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/dimpase/build/brewenablearbetc\"",
    "created_at": "2020-11-16T22:55:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608648",
    "user": "https://github.com/dimpase"
}
```

Changing branch from "" to "u/dimpase/build/brewenablearbetc"
...
```json
{
    "body": "<a id='comment:14'></a>my tests show that we can use Homebrew's NTL, arb, and flint, and with flint 2.6.3 patches in it's time to advertise them.\n\nFor testing, don't forget to ran `make arb-clean ntl-clean flint-clean` after installing them in Homebrew.\n\n---\nNew commits:",
    "created_at": "2020-11-16T22:55:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608649",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:14'></a>my tests show that we can use Homebrew's NTL, arb, and flint, and with flint 2.6.3 patches in it's time to advertise them.
...
```json
{
    "body": "Changing commit from \"\" to \"bb37468f15668033ab10af7c6157ef6a2a5f3379\"",
    "created_at": "2020-11-16T22:55:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608650",
    "user": "https://github.com/dimpase"
}
```

Changing commit from "" to "bb37468f15668033ab10af7c6157ef6a2a5f3379"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608651",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608652",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Changing reviewer from \"\" to \"https://github.com/mkoeppe/sage/actions/runs/367237067\"",
    "created_at": "2020-11-17T02:06:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608653",
    "user": "https://github.com/mkoeppe"
}
```

Changing reviewer from "" to "https://github.com/mkoeppe/sage/actions/runs/367237067"
...
```json
{
    "body": "<a id='comment:17'></a>most of these errors look like the things fixed in the branch of #29719 - which is marked as closed, but perhaps it's not in your/this branch yet?",
    "created_at": "2020-11-17T18:47:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608655",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:17'></a>most of these errors look like the things fixed in the branch of #29719 - which is marked as closed, but perhaps it's not in your/this branch yet?
...
```json
{
    "body": "<a id='comment:18'></a>The branch from #29719 is named `public/packages/flint260` - you can  try merging it and test again.",
    "created_at": "2020-11-17T20:01:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608656",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:18'></a>The branch from #29719 is named `public/packages/flint260` - you can  try merging it and test again.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608659",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>the `plural.pyx` doctest error iso a Heisenbug. The following, i.e. repeating a part of this test a bit earlier in the  lets the tests there pass for me. Needless to say, it cannot be reproduced in the Sage prompt, either.\n\n```diff\n--- a/src/sage/rings/polynomial/plural.pyx\n+++ b/src/sage/rings/polynomial/plural.pyx\n@@ -367,6 +367,8 @@ cdef class NCPolynomialRing_plural(Ring):\n             True\n             sage: H is loads(dumps(H))  # indirect doctest\n             True\n+            sage: A2.<x,y,z> = FreeAlgebra(GF(5), 3)\n+            sage: R2 = A2.g_algebra({y*x:x*y-z, z*x:x*z+2*x, z*y:y*z-2*y}, order=TermOrder('degrevlex', 2))\n \n         Check that :trac:`17224` is fixed::\n \n```\nIf you like I can add this \"fix\" to the branch.\n\nalternatively, if I just change the order of tests, using `randorder` option, everything works too:\n\n```bash\n./sage -tp --random-seed=0 --randorder=42 --long src/sage/rings/polynomial/plural.pyx\n```",
    "created_at": "2020-11-18T11:34:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608660",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:22'></a>the `plural.pyx` doctest error iso a Heisenbug. The following, i.e. repeating a part of this test a bit earlier in the  lets the tests there pass for me. Needless to say, it cannot be reproduced in the Sage prompt, either.
...
```json
{
    "body": "<a id='comment:23'></a>That's sweeping things under the rug. Not necessarily the worst thing to do, but I wish there were an actual fix. I guess if we \"fix\" this now and upstream fixes the real bug pretty soon, it's a good approach.",
    "created_at": "2020-11-18T17:32:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608661",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:23'></a>That's sweeping things under the rug. Not necessarily the worst thing to do, but I wish there were an actual fix. I guess if we "fix" this now and upstream fixes the real bug pretty soon, it's a good approach.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608662",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Changing commit from \"bb37468f15668033ab10af7c6157ef6a2a5f3379\" to \"2fd95cded92f24596c4484757b486bd1e99ed74c\"",
    "created_at": "2020-11-18T19:19:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608663",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "bb37468f15668033ab10af7c6157ef6a2a5f3379" to "2fd95cded92f24596c4484757b486bd1e99ed74c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608664",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>ready for review",
    "created_at": "2020-11-18T21:04:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608665",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:26'></a>ready for review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608667",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>The problem is certainly not in flint update, which is modern high quality code, but in Singular's plural package, which is relying on [9-year old C++](https://github.com/Singular/Singular/tree/spielwiese/libpolys/polys/nc), not used much, either, no wonder it misbehaves. \n\nI cc few people who might tell us more about the dump (I can reproduce it, so it's not random).\n\nIt seems that Singular with Clang is not tested much (e.g. Singular built on OpenBSD 6.7 and 6.8 with OpenBSD's clang 10 and 11: standalone Singular crashes on startup).",
    "created_at": "2020-11-20T12:36:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608668",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:28'></a>The problem is certainly not in flint update, which is modern high quality code, but in Singular's plural package, which is relying on [9-year old C++](https://github.com/Singular/Singular/tree/spielwiese/libpolys/polys/nc), not used much, either, no wonder it misbehaves. 
...
```json
{
    "body": "<a id='comment:29'></a>At first glance, from what I can read, it looks like the system has to be \"primed\" before the error occurs. That suggests memory management issues - which have always been a hard topic in singular :(",
    "created_at": "2020-11-20T19:19:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608669",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:29'></a>At first glance, from what I can read, it looks like the system has to be "primed" before the error occurs. That suggests memory management issues - which have always been a hard topic in singular :(
...
```json
{
    "body": "<a id='comment:30'></a>Unfortunately it also seems that the Singular team is uninterested in portability testing - my pull request at https://github.com/Singular/Singular/pull/1018 has been sitting there without even an acknowledgment by the maintainers",
    "created_at": "2020-11-20T19:56:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608670",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:30'></a>Unfortunately it also seems that the Singular team is uninterested in portability testing - my pull request at https://github.com/Singular/Singular/pull/1018 has been sitting there without even an acknowledgment by the maintainers
...
```json
{
    "body": "<a id='comment:31'></a>If this is really a Singular issue, then let's merge the bandaid and move on. Any objections? What is the status with ecl? Does that need a new ticket?",
    "created_at": "2020-11-20T22:41:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608671",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:31'></a>If this is really a Singular issue, then let's merge the bandaid and move on. Any objections? What is the status with ecl? Does that need a new ticket?
...
```json
{
    "body": "<a id='comment:32'></a>Also note #29528 which is about this Singular bug. As well, in #25993 (upgrade to Singular 4.1.3p2 - the latest)\nthese tests are marked as `# not tested`. I tried the branch of  #25993 with these tests reenabled, and they all work! And this doubling from[comment:27](#comment%3A27) does not give any trouble either. So perhaps the latest Singular and the latest Flint are a winning combo?",
    "created_at": "2020-11-20T23:55:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608672",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:32'></a>Also note #29528 which is about this Singular bug. As well, in #25993 (upgrade to Singular 4.1.3p2 - the latest)
these tests are marked as `# not tested`. I tried the branch of  #25993 with these tests reenabled, and they all work! And this doubling from[comment:27](#comment%3A27) does not give any trouble either. So perhaps the latest Singular and the latest Flint are a winning combo?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608673",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608674",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608675",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608676",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:37'></a>Changing ticket summary; feel free to improve or revert.",
    "created_at": "2020-11-23T11:58:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608678",
    "user": "https://github.com/slel"
}
```

<a id='comment:37'></a>Changing ticket summary; feel free to improve or revert.
...
```json
{
    "body": "<a id='comment:38'></a>Replying to [slelievre](#comment%3A36):\n> Since the ECL part is postponed, should we\n> update this ticket's summary and description?\n> \n> Could the summary be: \"Allow using arb, flint and ntl from Homebrew\"?\n> \n> Is the ECL issue part of #29617 or does it need a new ticket?\n\nyes, #29617 would probably take care of this.\nEven better, we should upsteam to Homebrew \"our\" ECL patches.",
    "created_at": "2020-11-24T21:55:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608679",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:38'></a>Replying to [slelievre](#comment%3A36):
> Since the ECL part is postponed, should we
> update this ticket's summary and description?
> 
> Could the summary be: "Allow using arb, flint and ntl from Homebrew"?
...
```json
{
    "body": "Changing branch from \"u/dimpase/build/brewenablearbetc\" to \"2fd95cded92f24596c4484757b486bd1e99ed74c\"",
    "created_at": "2020-11-29T11:58:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608680",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/dimpase/build/brewenablearbetc" to "2fd95cded92f24596c4484757b486bd1e99ed74c"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30745#issuecomment-608681",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30745",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30745#event-80132"
}
```
