...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414096"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414099"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476118",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476119",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476120",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476121",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476122",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476123",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476124",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476125",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476126",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<div id=\"comment:9\" align=\"right\">comment:9</div>\n\nReplying to [@mkoeppe](#comment:8):\n> > For some reason, there are dozens of maxima.eval calls in sage/[src,doc] \n\n> \n> Note that at least in some modules, actually `lazy_import('sage.interfaces.maxima_lib','maxima')` is done.\n\nin just one, in src/sage/calculus/calculus.py (which I quote in [comment:7](#comment:7))",
    "created_at": "2020-07-08T08:08:12Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476127",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476128",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476129",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414101"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414102"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414103"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414104"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30071#issuecomment-476130",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414105"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414106"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414107"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414108"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414109"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414110"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414111"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414112"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414113"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30071#event-414114"
}
```
