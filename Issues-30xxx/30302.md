...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596351",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596352",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Both `M()` and `M(0)` return a new mutable element. That's how one creates a new vector, whose components can then be modified. If you want the immutable 0 element, you can use `M.zero()`.\n\nThe arithmetic operations should either always create an immutable element or always create a new mutable element. It would be very inconvenient if the result of an operation was sometimes immutable, sometimes a new mutable element, depending on the input. (And it would be highly problematic if sometimes it would return an existing mutable element.)",
    "created_at": "2020-08-06T11:44:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596353",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>Both `M()` and `M(0)` return a new mutable element. That's how one creates a new vector, whose components can then be modified. If you want the immutable 0 element, you can use `M.zero()`.
...
```json
{
    "body": "<a id='comment:4'></a>My concern here would be performance. For complicated symbolic expressions, creating a copy can have a significant CPU cost. The main concern is about scalar fields, because tensor fields arithmetics always end up to scalar fields arithmetics, the scalar fields being the tensor components in a given frame. For the time being, `ScalarField._add_()` starts with\n\n```\n        if self._is_zero:\n            return other\n        if other._is_zero:\n            return self\n```\nIf we change this to return a copy (I understand the arguments put forward by Matthias), then I would advocate for extensive benchmarks, with complicated tensor fields (those in the doctests are too simple), such as in those mentionned [here](https://trac.sagemath.org/ticket/30116#comment:52).",
    "created_at": "2020-08-06T14:38:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596354",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:4'></a>My concern here would be performance. For complicated symbolic expressions, creating a copy can have a significant CPU cost. The main concern is about scalar fields, because tensor fields arithmetics always end up to scalar fields arithmetics, the scalar fields being the tensor components in a given frame. For the time being, `ScalarField._add_()` starts with
...
```json
{
    "body": "<a id='comment:5'></a>Symbolic expressions are immutable and therefore do not need to be copied.\n\nThe cost of making a copy should be dominated by copying the dictionaries in the Components objects.",
    "created_at": "2020-08-06T16:54:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596355",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Symbolic expressions are immutable and therefore do not need to be copied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596357",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596358",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596359",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596360",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596362",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596363",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Another implementation strategy if you consider `Components` objects an implementation detail that is not exposed to the user: Change them to \"copy-on-write\" semantics\n\n---\nNew commits:",
    "created_at": "2020-08-06T19:16:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596364",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:13'></a>Another implementation strategy if you consider `Components` objects an implementation detail that is not exposed to the user: Change them to "copy-on-write" semantics
...
```json
{
    "body": "<a id='comment:14'></a>I've pushed my changes.",
    "created_at": "2020-08-06T19:17:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596365",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:14'></a>I've pushed my changes.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596367",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>However, regarding my prun test, I think that\n\n```python\n        resu = type(self)(self.parent())\n```\n\nis the costly line. And that one shouldn't be an issue for more complicated expressions.",
    "created_at": "2020-08-06T19:45:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596368",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:17'></a>However, regarding my prun test, I think that
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596369",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I wonder, is copying the chart function even necessary? If new expressions are set/added, a new chart function is created anyway,isn't it? \n\nIf the user wants the chart function directly, one can create a copy there. Or we state all chart functions belonging to scalar fields automatically as immutable (available since #30310). If the user wants to modify it, he must copy it manually.",
    "created_at": "2020-08-07T11:55:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596370",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:19'></a>I wonder, is copying the chart function even necessary? If new expressions are set/added, a new chart function is created anyway,isn't it? 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596371",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596372",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Watch my edit. Sorry for the chaos.",
    "created_at": "2020-08-07T16:10:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596374",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:24'></a>Watch my edit. Sorry for the chaos.
...
```json
{
    "body": "<a id='comment:25'></a>Another useful thing for benchmarking is `%lprun`; see [this tutorial](https://doc.sagemath.org/html/en/thematic_tutorials/profiling.html#python-level-line-by-line-profiling-lprun).",
    "created_at": "2020-08-07T23:03:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596375",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:25'></a>Another useful thing for benchmarking is `%lprun`; see [this tutorial](https://doc.sagemath.org/html/en/thematic_tutorials/profiling.html#python-level-line-by-line-profiling-lprun).
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78435"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78436"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30302#issuecomment-596376",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78438"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78439"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78440"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78441"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78442"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78443"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78444"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30302#event-78445"
}
```
