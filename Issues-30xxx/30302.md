...
```
This question arose from ticket #30239, [[comment:36](#comment%3A36)](https://github.com/sagemath/sage/issues/30239#comment:36).
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30302#event-399160"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30302#event-399161"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30302#event-399162"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30302#issuecomment-483716",
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30302#event-399163"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30302",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30302#issuecomment-483717",
    "user": "https://github.com/mkoeppe"
}
```
