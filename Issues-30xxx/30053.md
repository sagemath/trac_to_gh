...
```json
{
    "body": "<a id='comment:6'></a>\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[37e042c](https://git.sagemath.org/sage.git/commit?id=37e042c44d71e841e19fcf70b6995a0f9b3c4ec2)|`only use locale C.UTF-8 if available, else C`|",
    "created_at": "2020-07-05T12:13:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30053",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[e5f6663](https://git.sagemath.org/sage.git/commit/?id=e5f6663372fab14c6a386004a925de59be216f31)|`only use locale C.UTF-8 if available, else C`|",
...
```json
{
    "body": "<a id='comment:80'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[ff6f4a6](https://git.sagemath.org/sage.git/commit/?id=ff6f4a68d4f396cb5f10e9918e5942113f739aa1)|`assume Python 3.7 or better`|",
...
```json
{
    "body": "<a id='comment:84'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[64c3a8a](https://git.sagemath.org/sage.git/commit/?id=64c3a8a6c99e916b68dfec6a2cd1346b023916e9)|`only test python3, to be 3.7 or 3.8`|",
    "created_at": "2020-09-16T16:46:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30053",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:87'></a>\nI have made an adjustment. I don't like mixing the change discussed in #30546 into this ticket\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|\n|[be47518](https://git.sagemath.org/sage.git/commit?id=be47518c1019d37e11bbac9a3268d69b196691c8)|`build/pkgs/python3/spkg-configure.m4: Use 'python >= 3.7'; keep checking for 'python3.8, python3.7'`|",
