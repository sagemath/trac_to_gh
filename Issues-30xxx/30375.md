...
```json
{
    "body": "<a id='comment:14'></a>\n**Branch pushed to git repo; I updated commit sha1.** New commits:\n|                                                                                                                                           |                                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[d979c22](https://github.com/sagemath/sagetrac-mirror/commit/d979c2251c191e1a661fcfd5cd89dc5f83750fb7)|<code>do not generate `sage-build-env`; respect environment settings at make time</code>|",
