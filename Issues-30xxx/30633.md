...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605844",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30633#event-79644"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605845",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I confirm I have the issue on Ubuntu 18.04 + 9.3.beta0 running Python 3.8.0.\n\nBut, I do not have this issue on Ubuntu 20.04 + 9.2.rc3 running Python 3.8.5.",
    "created_at": "2020-11-01T20:01:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605846",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:4'></a>I confirm I have the issue on Ubuntu 18.04 + 9.3.beta0 running Python 3.8.0.
...
```json
{
    "body": "<a id='comment:5'></a>To fix it, likely `build/pkgs/sympow/spkg-configure.m4` would need to be improved so that it rejects the broken system versions of sympow.",
    "created_at": "2020-11-01T20:03:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605847",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>To fix it, likely `build/pkgs/sympow/spkg-configure.m4` would need to be improved so that it rejects the broken system versions of sympow.
...
```json
{
    "body": "<a id='comment:6'></a>Previous work in this direction was done in #30147",
    "created_at": "2020-11-01T20:03:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605848",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>Previous work in this direction was done in #30147
...
```json
{
    "body": "<a id='comment:7'></a>After doing `sage -i sympow`, the issue disappears.",
    "created_at": "2020-11-01T20:07:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605849",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:7'></a>After doing `sage -i sympow`, the issue disappears.
...
```json
{
    "body": "<a id='comment:8'></a>Ok, I see, the version on my system is 1.023:\n\n```\n$ sympow -version\n1.023 RELEASE (Debian 1.023-8)\n(sage-sh) $ sympow -version\n2.023.6 RELEASE\n```",
    "created_at": "2020-11-01T20:10:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605850",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:8'></a>Ok, I see, the version on my system is 1.023:
...
```json
{
    "body": "<a id='comment:9'></a>And on Ubuntu 20.04, the version is:\n\n```\n$ sympow -version\n2.023.5 RELEASE (Debian 2.023.5-2)\n```\nwhich explains why it works on my other machine.",
    "created_at": "2020-11-01T20:11:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605851",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:9'></a>And on Ubuntu 20.04, the version is:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605852",
...
```json
{
    "body": "<a id='comment:12'></a>So the input `[1,-1,0,-79,289]` does fail. Copy pasting what is in the current `sage/build/pkgs/sympow/spkg-configure.m4`, I get:\n\n```\n$ echo \"@<:@1,-1,0,-79,289@:>@\" | sympow -analrank | grep ^\"Analytic Rank is 4\"\n**ERROR** Input appears to be bogus\n```\n\non both Ubuntu 20.04 and Ubuntu 18.04.",
    "created_at": "2020-11-02T08:01:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605854",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:12'></a>So the input `[1,-1,0,-79,289]` does fail. Copy pasting what is in the current `sage/build/pkgs/sympow/spkg-configure.m4`, I get:
...
```json
{
    "body": "<a id='comment:13'></a>I do get a different behavior if I write:\n\nOn Ubuntu 18.04, sympow 1.023:\n\n```\n$ sympow -curve [1,-1,0,-79,289] -analrank | grep ^\"Analytic Rank is 4\"\n```\n\nOn Ubuntu 20.04, sympow 2.023:\n\n```\n$ sympow -curve [1,-1,0,-79,289] -analrank | grep ^\"Analytic Rank is 4\"\nAnalytic Rank is 4 : leading L-term 8.94385e+00\n```",
    "created_at": "2020-11-02T08:08:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605855",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:13'></a>I do get a different behavior if I write:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605856",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605857",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>> so it seems that sympow version 1.023 is passing the test, whereas it should not.\n\n\nIn fact, sympow 1.023 does pass the test written with the \"echo\" way:\n\n```\n$ echo \"[1,-1,0,-79,289]\" | sympow -analrank\nsympow 1.023 RELEASE (Debian 1.023-8)  (c) Mark Watkins --- see README and COPYING for details\nMinimal model of curve  is [1,-1,0,-79,289]\nAt 2: Inertia Group is  C1 MULTIPLICATIVE REDUCTION\nAt 117223: Inertia Group is  C1 MULTIPLICATIVE REDUCTION\nConductor is 234446\nsp 1: Conductor at 2 is 1+0, root number is 1\nsp 1: Euler factor at 2 is 1+1*x\nsp 1: Conductor at 117223 is 1+0, root number is -1\nsp 1: Euler factor at 117223 is 1-1*x\n1st sym power conductor is 234446, global root number is 1\nNT 1d0: 1064\nMaximal number of terms is 1064\n0.0E+00\nDone with small primes 1049\nL(E,1) appears to be zero 8.96886e-13\nNT 1d2: 702\n0.0E+00\nDone with small primes 1049\nL''(E,1) appears to be zero 7.93453e-16\nNT 1d4: 437\n0.0E+00\nDone with small primes 1049\nAnalytic Rank is 4 : leading L-term 8.94385e+00\n```\n\nBut, it does not work with the following syntax:\n\n```\n$ sympow -curve [1,-1,0,-79,289] -analrank\nsympow 1.023 RELEASE (Debian 1.023-8)  (c) Mark Watkins --- see README and COPYING for details\nMinimal model of curve  is [1,-1,0,-79,289]\nAt 2: Inertia Group is  C1 MULTIPLICATIVE REDUCTION\nAt 117223: Inertia Group is  C1 MULTIPLICATIVE REDUCTION\nConductor is 234446\nsp 1: Conductor at 2 is 1+0, root number is 1\nsp 1: Euler factor at 2 is 1+1*x\nsp 1: Conductor at 117223 is 1+0, root number is -1\nsp 1: Euler factor at 117223 is 1-1*x\n1st sym power conductor is 234446, global root number is 1\nNT 1d0: 1064\nMaximal number of terms is 1064\n0.0E+00\nDone with small primes 1049\nErreur de segmentation\n```",
    "created_at": "2020-11-02T11:04:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605858",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:16'></a>> so it seems that sympow version 1.023 is passing the test, whereas it should not.
...
```json
{
    "body": "<a id='comment:17'></a>ok, I will add a test with the other syntax, too. Thanks for helping to dig the problem (which makes me willing to curse in various languages :-)) up.",
    "created_at": "2020-11-02T11:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605859",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:17'></a>ok, I will add a test with the other syntax, too. Thanks for helping to dig the problem (which makes me willing to curse in various languages :-)) up.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605860",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605861",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605862",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>OK, here it is\n\n---\nNew commits:",
    "created_at": "2020-11-02T14:08:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605863",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:18'></a>OK, here it is
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605864",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605865",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605867",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605869",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>I don't know if it is related, because on Ubuntu 18.04 with sympow version 1.023, there is no mystery: the command `sympow -curve [1,-1,0,-79,289] -analrank` systematically fails as well as:\n\n```\nsage: sympow.analytic_rank(EllipticCurve('11a'))                                                                              \nSegmentation fault\n---------------------------------------------------------------------------\nRuntimeError                              Traceback (most recent call last)\n<ipython-input-1-8cf6df7248bc> in <module>\n----> 1 sympow.analytic_rank(EllipticCurve('11a'))\n~/GitBox/sage/local/lib/python3.8/site-packages/sage/lfunctions/sympow.py in analytic_rank(self, E)\n    295         if i == -1:\n    296             print(self._fix_err(v))\n--> 297             raise RuntimeError(\"failed to compute analytic rank\")\n    298         j = v.rfind(':')\n    299         r = sage.rings.all.Integer(v[i + len(s):j])\nRuntimeError: failed to compute analytic rank\n```",
    "created_at": "2020-11-02T15:15:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605871",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:23'></a>I don't know if it is related, because on Ubuntu 18.04 with sympow version 1.023, there is no mystery: the command `sympow -curve [1,-1,0,-79,289] -analrank` systematically fails as well as:
...
```json
{
    "body": "<a id='comment:24'></a>Why not try it and see?  BTW, I definitely identified a bug, so if this isn't the cause of this particular problem, it will likely cause someone else problems down the road.\n\n\nReplying to [slabbe](#comment%3A23):\n> I don't know if it is related, because on Ubuntu 18.04 with sympow version 1.023, there is no mystery: the command `sympow -curve [1,-1,0,-79,289] -analrank` systematically fails as well as:\n> \n> ```\n> sage: sympow.analytic_rank(EllipticCurve('11a'))                                                                              \n> Segmentation fault\n> ---------------------------------------------------------------------------\n> RuntimeError                              Traceback (most recent call last)\n> <ipython-input-1-8cf6df7248bc> in <module>\n> ----> 1 sympow.analytic_rank(EllipticCurve('11a'))\n> ~/GitBox/sage/local/lib/python3.8/site-packages/sage/lfunctions/sympow.py in analytic_rank(self, E)\n>     295         if i == -1:\n>     296             print(self._fix_err(v))\n> --> 297             raise RuntimeError(\"failed to compute analytic rank\")\n>     298         j = v.rfind(':')\n>     299         r = sage.rings.all.Integer(v[i + len(s):j])\n> RuntimeError: failed to compute analytic rank\n> ```",
    "created_at": "2020-11-02T15:20:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605872",
    "user": "https://github.com/stephenmontgomerysmith"
}
```

<a id='comment:24'></a>Why not try it and see?  BTW, I definitely identified a bug, so if this isn't the cause of this particular problem, it will likely cause someone else problems down the road.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605874",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>There is no branch I know of that contains this patch.  You will either have to hack the source code yourself, or wait until someone else puts it into a branch.\n\nReplying to [dimpase](#comment%3A26):\n> Replying to [slabbe](#comment%3A25):\n> > Replying to [gh-stephenmontgomerysmith](#comment%3A24):\n> > > Why not try it and see? \n\n> > \n> > I don't see what I should try? Is your branch public? If yes, what is the name of the branch?\n\n> \n> see #12858, more precisely \n> https://trac.sagemath.org/ticket/12858#comment:16\n> I gather this is Debian \"upstream\", with this bug still in.\n>  \n> I agree that this is an upstream bug, and the problem is to identify the upstream...\n> \n> > \n> > > BTW, I definitely identified a bug, so if this isn't the cause of this particular problem, it will likely cause someone else problems down the road.\n\n> > \n> > Okay, so maybe it should be part of another ticket, since the bug described in the current ticket is already fixed by the proposed branch.",
    "created_at": "2020-11-02T17:32:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605875",
    "user": "https://github.com/stephenmontgomerysmith"
}
```

<a id='comment:27'></a>There is no branch I know of that contains this patch.  You will either have to hack the source code yourself, or wait until someone else puts it into a branch.
...
```json
{
    "body": "<a id='comment:28'></a>It looks like another fix was committed a while ago.  While the other fix wasn't technically correct, it should nevertheless have solved this issue.  So most likely this won't fix your particular problem.  Sorry.",
    "created_at": "2020-11-03T20:21:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605876",
    "user": "https://github.com/stephenmontgomerysmith"
}
```

<a id='comment:28'></a>It looks like another fix was committed a while ago.  While the other fix wasn't technically correct, it should nevertheless have solved this issue.  So most likely this won't fix your particular problem.  Sorry.
...
```json
{
    "body": "<a id='comment:29'></a>Replying to [slabbe](#comment%3A19):\n> (I wonder if the sentence \"the following SPKGs did not find equivalent system packages\" should be improved, because it is not clear what is meant by \"equivalent\". Does it mean that the system `sympow` was not there at all in which case the user will think to install it or that `sympow` from the system was too old and there is nothing to do?)\n\n\nI created #30863 to address this issue.",
    "created_at": "2020-11-04T13:01:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605877",
    "user": "https://github.com/seblabbe"
}
```

<a id='comment:29'></a>Replying to [slabbe](#comment%3A19):
> (I wonder if the sentence "the following SPKGs did not find equivalent system packages" should be improved, because it is not clear what is meant by "equivalent". Does it mean that the system `sympow` was not there at all in which case the user will think to install it or that `sympow` from the system was too old and there is nothing to do?)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605879",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30633#issuecomment-605880",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30633",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30633#event-79645"
}
```
