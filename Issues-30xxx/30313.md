...
```json
{
    "body": "<a id='comment:1'></a>On Windows, running the notebook in a native python installation and connecting to the Sage jupyter kernel running in cygwin would also be an attractive deployment option.",
    "created_at": "2020-08-08T19:04:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596746",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>On Windows, running the notebook in a native python installation and connecting to the Sage jupyter kernel running in cygwin would also be an attractive deployment option.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596747",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596749",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596750",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596751",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596752",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I've added a few links. (I haven't used any of these packages myself yet.)",
    "created_at": "2020-08-20T01:29:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596753",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:9'></a>I've added a few links. (I haven't used any of these packages myself yet.)
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78506"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78507"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30313#issuecomment-596754",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78509"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78510"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78511"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78512"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78513"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78514"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78515"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30313#event-78516"
}
```
