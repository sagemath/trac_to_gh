...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404723"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404724"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404725"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404726"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492859",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492860",
    "user": "https://github.com/slel"
}
```
