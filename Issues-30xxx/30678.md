...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404727"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404728"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404729"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404730"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492855",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404731"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404732"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404733"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492856",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492857",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-404736"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492858",
    "user": "https://github.com/slel"
}
```
