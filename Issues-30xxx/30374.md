...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486124",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486125",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486126",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486127",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486128",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486129",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>\nAttachment [unicode_mapsto.png](https://github.com/sagemath/sage/files/ticket30374/unicode_mapsto.png) by @egourgoulhon created at 2021-07-02 14:40:21\n\nReplying to [chapoton](#comment%3A8):\n> I would prefer \u27fc (but apparently bad for the mac guys)\n\nNot only for the mac guys: in my Ubuntu terminal, I have\n\n![](unicode_mapsto.png)\n\nSo not only U+27FC does not appear longer, but it is even less clear than U+21A6.",
    "created_at": "2021-07-02T14:40:21Z",
    "issue": "https://github.com/sagemath/sage/issues/30374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486130",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30374",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30374#issuecomment-486131",
    "user": "https://github.com/fchapoton"
}
```
