...
```json
{
    "body": "<a id='comment:1'></a>See an attempt in #30624, which I need to finalize.",
    "created_at": "2020-11-04T13:04:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30863#issuecomment-612042",
    "user": "https://github.com/slel"
}
```

<a id='comment:1'></a>See an attempt in #30624, which I need to finalize.
...
```json
{
    "body": "<a id='comment:2'></a>I wrote too fast. What you suggest is different.\n\nIt can be considered as part of #29146 and related to #29586.",
    "created_at": "2020-11-04T13:09:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30863#issuecomment-612043",
    "user": "https://github.com/slel"
}
```

<a id='comment:2'></a>I wrote too fast. What you suggest is different.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80540"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30863#issuecomment-612044",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80541"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80542"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80543"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80544"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80545"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80546"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80547"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30863#event-80548"
}
```
