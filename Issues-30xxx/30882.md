...
```json
{
    "body": "<a id='comment:1'></a>I was unable to reproduce the error on Linux with gfortran 10.2.0.",
    "created_at": "2020-11-10T14:17:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612391",
    "user": "https://github.com/embray"
}
```

<a id='comment:1'></a>I was unable to reproduce the error on Linux with gfortran 10.2.0.
...
```json
{
    "body": "<a id='comment:4'></a>FWIW, the automatic tests on GH Actions do not test this configuration.\n`cygwin-standard` has both system MPIR and system gfortran,\nand `cygwin-minimal` has neither of the two.",
    "created_at": "2020-11-12T17:04:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612394",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>FWIW, the automatic tests on GH Actions do not test this configuration.
`cygwin-standard` has both system MPIR and system gfortran,
and `cygwin-minimal` has neither of the two.
...
```json
{
    "body": "<a id='comment:5'></a>However, I do see some internal compiler errors from `gcc` on `cygwin-minimal` - for example in https://github.com/mkoeppe/sage/runs/1592024084 while building `curl`, `numpy`, `pillow`, and `suitesparse`",
    "created_at": "2020-12-22T07:35:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612395",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>However, I do see some internal compiler errors from `gcc` on `cygwin-minimal` - for example in https://github.com/mkoeppe/sage/runs/1592024084 while building `curl`, `numpy`, `pillow`, and `suitesparse`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612396",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30882#event-80598"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I would propose to close this ticket as outdated",
    "created_at": "2021-03-18T22:48:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612397",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>I would propose to close this ticket as outdated
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612398",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612399",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30882#event-80599"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30882#issuecomment-612400",
    "user": "https://github.com/mkoeppe"
}
```
