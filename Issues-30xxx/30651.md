...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30651/openblas-tail.txt",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30651/error-in-start.txt",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30651/pillow-8.0.1-VANILLA.log",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30651/pillow-8.0.1-30589.log",
...
```json
{
    "body": "built with SYSTEM_VERSION_COMPAT=1",
    "created_at": "2020-12-28T23:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30651",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30651/pillow-8.0.1-SYSTEM_VERSION_COMPAT=1.log",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30651/config.log",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30651/scipy-1.5.4.log",
