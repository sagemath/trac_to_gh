...
```json
{
    "body": "<a id='comment:30'></a>\nNeeds review. Let's please get this in - it's a prerequisite so that we can write sane instructions on how to run a fully functional [SageMath](../wikis/SageMath) jupyter kernel in a system jupyter notebook or jupyterlab (#30476) into Sage 9.3",
    "created_at": "2020-12-04T19:32:42Z",
    "issue": "https://github.com/sagemath/sage/issues/30972",
    "type": "issue_comment",
