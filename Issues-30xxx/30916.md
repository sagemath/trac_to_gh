...
```json
{
    "body": "<a id='comment:5'></a>\nI have added a keyword \"check\" to the method \"extension\". If anybody has a better way to do this feel free to change it. \n\n---\nNew commits:\n|                                                                                                                                          |                                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[bd4224b](https://git.sagemath.org/sage.git/commit?id=bd4224b1ef2f21217f454e56b6e95a702248865a)|`Added irreducibility verificator (check=False) for extension method`|",
