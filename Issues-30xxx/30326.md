...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30326#issuecomment-597101",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>A partial workaround is to pass the offending expression to `sympy`, whose `latex` doesn't have this bug (but doesn't correctly translates all Sage's bells and whistles) :\n\n```\nsage: f(x)=1/(1+x^2)\nsage: C=pi\nsage: Ex=integrate(f(x),x,-oo,oo,hold=True) ; Ex\nintegrate(1/(x^2 + 1), x, -Infinity, +Infinity)\nsage: latex(Ex/C)\n\\frac{\\pi}{\\pi}\nsage: import sympy\nsage: latex(sympy.sympify(Ex/C))\n\\text{\\texttt{Integral(1/(x**2{ }+{ }1),{ }(x,{ }{-}oo,{ }oo))/pi}}\n```\n\n(Note that `oo` isn't either `sympified` as expected or typeset as `\\infty`...)",
    "created_at": "2020-08-10T09:35:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30326#issuecomment-597102",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:2'></a>A partial workaround is to pass the offending expression to `sympy`, whose `latex` doesn't have this bug (but doesn't correctly translates all Sage's bells and whistles) :
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78548"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78549"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30326#issuecomment-597103",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78551"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78552"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78553"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78554"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>This seems to work in 9.6.rc3, needs a doctest\n\n```\nsage: f = integral(x, x, 0, 1, hold=True)\nsage: latex(f)\n\\int_{0}^{1} x\\,{d x}\n```",
    "created_at": "2022-04-30T08:49:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30326#issuecomment-597104",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:7'></a>This seems to work in 9.6.rc3, needs a doctest
...
```json
{
    "body": "<a id='comment:8'></a>No, I think we still have the problem (in 9.6.rc3):\n\n```\nsage: f = integral(x, x, 0, 1, hold=True)\nsage: latex(f)  # this is correct (at least since 9.2)\n\\int_{0}^{1} x\\,{d x}\nsage: latex(f / pi)  # this is still not correct\n\\frac{\\frac{1}{2}}{\\pi}\n```",
    "created_at": "2022-05-01T07:55:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30326#issuecomment-597105",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:8'></a>No, I think we still have the problem (in 9.6.rc3):
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78555"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78556"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78557"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30326#event-78558"
}
```
