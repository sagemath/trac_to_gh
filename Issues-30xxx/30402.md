...
archive/attachments_022111.json:
```json
{
...
```json
{
    "body": "**Attachment:** [test-save.sage](https://github.com/sagemath/sage/files/ticket30402/test-save.sage)\n\nTest script to run on Cocalc",
    "created_at": "2020-08-20T04:05:59Z",
    "issue": "https://github.com/sagemath/sage/issues/30402",
    "type": "issue_comment",
...
**Attachment:** [test-save.sage](https://github.com/sagemath/sage/files/ticket30402/test-save.sage)
...
archive/attachments_022112.json:
```json
{
    "asset_content_type": "application/octet-stream",
