...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30402/test-save.sage",
...
```json
{
    "body": "Test script to run on Cocalc",
    "created_at": "2020-08-20T04:05:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30402",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket30402/matrix-load-save-bug-examples.txt",
...
```json
{
    "body": "Results of running test script with different versions of Sage",
    "created_at": "2020-08-20T04:06:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30402",
    "type": "issue_comment",
