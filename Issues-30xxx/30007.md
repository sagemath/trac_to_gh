...
```json
{
    "body": "I think this version does what you suggested. It seems from that diff that I was working over an old version of the file, there are some changes that I didn't include. I'll rebase it",
...
```json
{
    "body": "I made some reviewer changes. If my changes are good, then you can set a positive review.",
...
```json
{
    "body": "The case `regular=0`, that's why it's a positive integer or a tuple of non-negative integers. So I rephrased the description of the class `PartitionTuples` where this is relevant. In the regular classes that's fine cause all those classes receive a tuple, and for tuples `0` is allowed. I also added a couple of missing spaces in the errors raised. Let me know if this is fine.",
...
```json
{
    "body": "Are there changes you were going to push or is this just explaining your previous commits?",
...
```json
{
    "body": "That was just explaining the previous commit, I wasn't sure if that would be alright with you",
...
```json
{
    "body": "Then if you are fine with my changes, you can set a positive review.",
...
```json
{
    "body": "Assigning it to review again so that it is picked by the bot even though I just made your change",
...
```json
{
    "body": "I tested it and it was fine.",
    "created_at": "2020-07-05T03:47:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30007",
    "type": "issue_comment",
