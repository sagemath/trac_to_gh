...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30226#issuecomment-594325",
...
```json
{
    "body": "<a id='comment:5'></a>Getting math to display in 2D plots requires dollar signs around the LaTeX. Should do the same here for consistency. That way could assume every string starting with dollar sign should be rendered with MathJax.",
    "created_at": "2020-07-29T02:31:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30226#issuecomment-594327",
    "user": "https://github.com/paulmasson"
}
```

<a id='comment:5'></a>Getting math to display in 2D plots requires dollar signs around the LaTeX. Should do the same here for consistency. That way could assume every string starting with dollar sign should be rendered with MathJax.
...
```json
{
    "body": "<a id='comment:6'></a>MathJax is already a standard package...",
    "created_at": "2020-07-29T02:42:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30226#issuecomment-594328",
    "user": "https://github.com/paulmasson"
}
```

<a id='comment:6'></a>MathJax is already a standard package...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30226#issuecomment-594330",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30226",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30226#issuecomment-594331",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78093"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78094"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78095"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78096"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78097"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78098"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78099"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78100"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78101"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30226#event-78102"
}
```
