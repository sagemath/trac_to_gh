...
```json
{
    "body": "<a id='comment:18'></a>\nReplying to [paulmasson](#comment%3A15):\n> Replying to [mkoeppe](#comment%3A13):\n> > Thanks. And for the offline mode - does it make sense to make several versions available in SAGE_LOCAL?\n\n> No, it does not. The Three.js template is specifically tailored to the release currently in use. Mr. Doob sometimes breaks things. Backwards compatibility is not assured.\n\nHmm... perhaps it would be better to link the offline plots to a specific version.\n\nFor example, suppose I generate an offline plot using the template that works for r117. The plot links to `/home/joshua/sage/local/share/threejs/build/three.min.js`. Some time in the future I upgrade [SageMath](../wikis/SageMath) in-place. (Do normal users do that?) That old plot is now linking to three.js r122 despite the template it was generated from only being guaranteed to work with r117. Suddenly the plot may no longer work.\n\nThat's not an issue for the Jupyter notebook since it's a \"live\" environment and you can always just re-run the cell to get an up-to-date plot. It's also not an issue for the CDN scripts since those are tied to specific versions.\n\nAlthough even if we fixed this, it'd still be fragile in that moving/deleting [SageMath](../wikis/SageMath) would also break old plots. To make a fully self-contained and isolated offline plot would probably require including the content of `three.min.js` inline instead of linking, but I imagine that might run afoul of the license.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498181",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498182",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498183",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498184",
    "user": "https://github.com/enriqueartal"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498185",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498186",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498187",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498188",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498189",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498190",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498191",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498192",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498193",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498194",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498195",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498196",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498197",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498198",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498199",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498200",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498201",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498202",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498203",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498204",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498205",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498206",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498207",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498208",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498209",
    "user": "https://github.com/jcamp0x2a"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498210",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30915#issuecomment-498211",
