...
```json
{
    "body": "<a id='comment:8'></a>\nThose bits should have gone when I \"normalised\" clang for building sage on OS X. We were probably planing to remove them at a later stage and forgot.\n\nWell, the opportunity is clearly now.\n\n---\nNew commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[1cb38cd](https://git.sagemath.org/sage.git/commit?id=1cb38cd90280a0d7478d509e07c8ba5024911f30)|`tox.ini: Add configuration factor gcc_10`|\n|[f190f51](https://git.sagemath.org/sage.git/commit?id=f190f512fe3812815efa3dcd800cd9acc7464e50)|`build/pkgs/cmake/spkg-install.in: Do not explicitly use clang on macos`|\n|[0c89bc0](https://git.sagemath.org/sage.git/commit?id=0c89bc05604004424610103bd2771a11df463e20)|`build/pkgs/{gmp,mpir}/spkg-install.in: Do not override compiler set explicitly to clang`|\n|[178a490](https://git.sagemath.org/sage.git/commit?id=178a49080389ff8e2538b4ac55bbe90f3b582a64)|`build/pkgs/pari/spkg-install.in: Do not recompute MACOSX_VERSION`|\n|[13ef685](https://git.sagemath.org/sage.git/commit?id=13ef68536884cdddea4c617cf55c51ce976bab80)|`build/pkgs/python3/spkg-build.in: Do not explicitly use clang on macos`|\n|[2a5e7db](https://git.sagemath.org/sage.git/commit?id=2a5e7db2f496d3b364543b9efbaceac9094fc6ae)|`build/pkgs/r/spkg-install.in: Do not explicitly use clang on macos`|\n|[c187d65](https://git.sagemath.org/sage.git/commit?id=c187d65a6f14f6cadf5c1fa1970d8990ce26a70b)|`build/pkgs/psutil/spkg-install.in: Do not explicitly use clang on macos`|\n|[3fd3388](https://git.sagemath.org/sage.git/commit?id=3fd3388757aec91dd5a4b65ccc6e623e55c307c1)|`build/pkgs/curl/spkg-install.in: Do not explicitly use clang on macos`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|\n|[5bc544c](https://git.sagemath.org/sage.git/commit/?id=5bc544c69426400585542c2b209fe797ba5685bf)|`build/pkgs/cmake/spkg-install.in: Do not explicitly use clang on macos`|\n|[da4ea53](https://git.sagemath.org/sage.git/commit/?id=da4ea53f797235e3be9ba5bc09299606005b9998)|`build/pkgs/{gmp,mpir}/spkg-install.in: Do not override compiler set explicitly to clang`|\n|[05b06b2](https://git.sagemath.org/sage.git/commit/?id=05b06b28e4cc661941207a1f587b288a65c67b9c)|`build/pkgs/pari/spkg-install.in: Do not recompute MACOSX_VERSION`|\n|[e796b8a](https://git.sagemath.org/sage.git/commit/?id=e796b8a43285bf309dacea2cfad443028dd4aab3)|`build/pkgs/python3/spkg-build.in: Do not explicitly use clang on macos`|\n|[5895d23](https://git.sagemath.org/sage.git/commit/?id=5895d238471a6b17a752bfed15e3980baac91e46)|`build/pkgs/r/spkg-install.in: Do not explicitly use clang on macos`|\n|[350bc01](https://git.sagemath.org/sage.git/commit/?id=350bc01fa791f9b07f70546d687ba116e29a1bb9)|`build/pkgs/psutil/spkg-install.in: Do not explicitly use clang on macos`|\n|[2a39819](https://git.sagemath.org/sage.git/commit/?id=2a3981932d00235d13afc32edf76c1699dbbabc5)|`build/pkgs/curl/spkg-install.in: Do not explicitly use clang on macos`|",
    "created_at": "2021-01-18T05:26:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30725",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[1b16a8c](https://git.sagemath.org/sage.git/commit/?id=1b16a8c4884fd6eb464b94121b29990b0cc4dff8)|`build/pkgs/pari/spkg-install.in: Do not recompute MACOSX_VERSION`|\n|[c6e30ea](https://git.sagemath.org/sage.git/commit/?id=c6e30eab754c20f53ceef40508a223c590f06cb1)|`tox.ini: Add configuration factors gcc_10, gcc_11`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[9b0eb15](https://git.sagemath.org/sage.git/commit/?id=9b0eb15897bbde3ad5e440b26d714f637516e91d)|`build/pkgs/{cmake,curl,psutil,python3,r}: If setting CC=clang, also set CFLAGS`|",
