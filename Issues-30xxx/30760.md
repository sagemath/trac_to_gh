...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30760#event-406009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30760#event-406010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30760#event-406011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30760#event-406012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30760#issuecomment-494715",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30760#issuecomment-494716",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30760#issuecomment-494717",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30760#issuecomment-494718",
...
```json
{
    "body": "Changed keywords from **** to **parser, syntax**",
    "created_at": "2020-10-14T21:29:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/30760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30760#issuecomment-494719",
    "user": "https://github.com/slel"
}
```

Changed keywords from **** to **parser, syntax**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30760#issuecomment-494720",
    "user": "https://github.com/slel"
}
```
