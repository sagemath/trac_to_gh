...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607336",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607337",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607338",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Note that `NonNegativeIntegers._element_constructor_()` calls `__contains__()`, so that we cannot just remove the `__contains__()` method and rely on the generic one from `Parent`.\n\n---\nNew commits:",
    "created_at": "2020-09-30T16:08:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607339",
    "user": "https://github.com/mezzarobba"
}
```

<a id='comment:1'></a>Note that `NonNegativeIntegers._element_constructor_()` calls `__contains__()`, so that we cannot just remove the `__contains__()` method and rely on the generic one from `Parent`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607340",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607341",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607342",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607343",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607344",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30684#event-79842"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30684#event-79843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607345",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30684#issuecomment-607346",
    "user": "https://github.com/vbraun"
}
```
