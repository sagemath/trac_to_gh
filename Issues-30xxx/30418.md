...
<a id='comment:3'></a>This change works:
...
```json
{
    "body": "<a id='comment:12'></a>It would be nice for this ticket to get reviewed for sage 9.2.",
...
<a id='comment:12'></a>It would be nice for this ticket to get reviewed for sage 9.2.
...
```json
{
    "body": "<a id='comment:13'></a>Looks okay to me.",
    "created_at": "2020-09-29T21:16:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30418",
    "type": "issue_comment",
...
<a id='comment:13'></a>Looks okay to me.
