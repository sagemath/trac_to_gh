...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30152#event-396962"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30152#event-396963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30152#event-396964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30152#event-396965"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30152#issuecomment-480479",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30152",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30152#issuecomment-480480",
    "user": "https://github.com/kwankyu"
}
```
