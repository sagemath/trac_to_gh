...
```json
{
    "body": "Not really `make python3-clean`, more like `make python3_venv-clean`; see #29708 (\"Fix switching between `--with-system-python3` and `--without-system-python3`\"). I had hoped to fix it via #29386, but this won't be ready for Sage 9.2.\n\nWe can try a hotfix for this issue by adding `build/pkgs/python3/legacy-uninstall`",
    "created_at": "2020-10-01T15:53:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434114",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434115",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Here's an attempt. Untested\n\n---\nNew commits:",
    "created_at": "2020-10-01T17:17:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434116",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "\"Of course\" the `spkg-legacy-uninstall` mechanism is broken... It is one of the `WRAPPED_SCRIPTS` of `build/bin/sage-spkg`, but `sage_bootstrap.uninstall.legacy_uninstall` tries to execute `spkg-legacy-uninstall` directly out of `SAGE_ROOT/build` with bash...",
    "created_at": "2020-10-02T02:27:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434117",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434118",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434119",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "So the problem with #29096 is that the uninstall script wasn't being run by `sage-spkg`, so the conversion from `SCRIPT.in` to `SCRIPT` didn't do anything useful?\n\nI also don't understand how the use of the `spkg-legacy-uninstall` script compares to its documentation. R and gap, for example, are modern packages. Why do they need legacy uninstall scripts?",
    "created_at": "2020-10-03T19:49:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434120",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434121",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Okay, good. The ticket description says that we should remove `$SAGE_LOCAL/lib/python3*`, but the script removes `$SAGE_LOCAL/bin/python3*`. Which is correct?",
    "created_at": "2020-10-03T20:10:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434122",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Not sure if the original report really meant \"lib\", and I don't think there is any problem with it.  The branch, in any case, takes care of removing the problematic symlinks in \"bin\". I have update ticket summary and description.",
    "created_at": "2020-10-03T20:46:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434123",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "The original report did mean `lib` rather than `bin`. I guess both should be taken care of.",
    "created_at": "2020-10-03T21:34:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434124",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "If I've built Sage with a system Python 3, I'm not sure what `make python3-clean` should do. Should it really remove all Python site libraries? If it does this, it has to somehow let the build system know to rebuild all of those packages.",
    "created_at": "2020-10-03T21:38:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434125",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434126",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434127",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434128",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "Right, I understand that, so Dima, what did you have in mind?",
    "created_at": "2020-10-04T04:52:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434129",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434131",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434132",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "weird things happen if you switch from one external python3 to another.",
    "created_at": "2020-10-04T16:04:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434133",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "I think the branch of this ticket addresses this by making `make python3-clean` remove the interpreter symlinks and the `pyvenv.cfg`. Please try",
    "created_at": "2020-10-04T16:10:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434134",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434135",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "I don't have any objections to it. Dima?",
    "created_at": "2020-10-05T21:57:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434136",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "A nitpick, but I don't like mass renaming of spkg-legacy-uninstall.in involving adding boilerplate into each of them. Couldn't build/sage_bootstrap/uninstall.py, the only place it is called from, just prepend the `#!` line?",
    "created_at": "2020-10-06T08:21:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434137",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434138",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434139",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434140",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434141",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30450#issuecomment-434142",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30450",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30450#event-79859"
}
```
