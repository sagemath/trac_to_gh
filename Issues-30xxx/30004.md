...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[690b757](https://git.sagemath.org/sage.git/commit/?id=690b7573b92930b018773a96cf8d90281e9094c4)|`added references and changed names to BIBD`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[f016797](https://git.sagemath.org/sage.git/commit/?id=f016797af059aefdf081866da3b3d2d99c9c64dc)|`fixed typo in docstring`|",
