...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30691#issuecomment-607499",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79876"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79877"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79878"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79879"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79880"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79881"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79882"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79883"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79884"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30691#event-79885"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I cannot reproduce this with the new code, so very likely, this can be closed after #34552.",
    "created_at": "2022-09-27T20:58:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30691#issuecomment-607500",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:8'></a>I cannot reproduce this with the new code, so very likely, this can be closed after #34552.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30691",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30691#issuecomment-607501",
    "user": "https://github.com/mantepse"
}
```
