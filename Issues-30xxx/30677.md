...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[caf88ef](https://git.sagemath.org/sage.git/commit/?id=caf88ef6fc81d50c7844d8f3285c75333fa25482)|`Add config for unittests`|",
    "created_at": "2020-10-03T22:10:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30677",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|\n|[87719de](https://git.sagemath.org/sage.git/commit/?id=87719de3d25237a5974b56ada36ed0df1633ad8d)|`.vscode/settings.json: Change python.pythonPath to python.defaultInterpreterPath`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[656f85c](https://git.sagemath.org/sage.git/commit/?id=656f85cbd409086c800fd857cacca4a267e10ef1)|`Add VS code config for inplace venv`|\n|[caf88ef](https://git.sagemath.org/sage.git/commit/?id=caf88ef6fc81d50c7844d8f3285c75333fa25482)|`Add config for unittests`|\n|[208d2fa](https://git.sagemath.org/sage.git/commit/?id=208d2fa5cb7ea0cc279454ea939f9fae50160306)|`Merge branch 'public/build/vscode' of git://trac.sagemath.org/sage into public/build/vscode`|\n|[9bc5815](https://git.sagemath.org/sage.git/commit/?id=9bc5815d4b28495c281aa7fd02039d87042e54a3)|`Merge branch 'develop' of git://github.com/sagemath/sage into public/build/vscode`|\n|[9bcead8](https://git.sagemath.org/sage.git/commit/?id=9bcead852003c7b0c3c48c5542572756b6236994)|`Add config to discover tests`|",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[89b8754](https://git.sagemath.org/sage.git/commit/?id=89b8754ad30c6a1bd1fdbd6d62011055bf13b24a)|`Fix exit code for pytest in case of no matched files`|\n|[278f0e0](https://git.sagemath.org/sage.git/commit/?id=278f0e024ba41399393af26fdddf5e6df4858064)|`Merge branch 'public/build/vscode' of trac.sagemath.org:sage into public/build/vscode`|\n|[df1534c](https://git.sagemath.org/sage.git/commit/?id=df1534c11ea5680699f801d026451b0124ccd019)|`Add extension recommendations`|",
