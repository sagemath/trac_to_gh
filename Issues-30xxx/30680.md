...
```json
{
    ...
    "type": "issue",
    "updated_at": "2022-02-27T22:00:50Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371805"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371806"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371807"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371808"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371809"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371810"
}
```
...
```json
{
    "body": "**Attachment:** [perf_accounted_time.png.gz](https://github.com/sagemath/sage/files/ticket30680/perf_accounted_time.png.gz)\n\nvisualization of total time (green colors) and accounted time (red colors) for both python and cythonized code.",
...
**Attachment:** [perf_accounted_time.png.gz](https://github.com/sagemath/sage/files/ticket30680/perf_accounted_time.png.gz)
...
```json
{
    "body": "**Attachment:** [perf_comp.png.gz](https://github.com/sagemath/sage/files/ticket30680/perf_comp.png.gz)\n\nVisualization of performance data where only time spent in external modules are shown",
...
**Attachment:** [perf_comp.png.gz](https://github.com/sagemath/sage/files/ticket30680/perf_comp.png.gz)
...
```json
{
    "body": "**Attachment:** [perf_cython.png.gz](https://github.com/sagemath/sage/files/ticket30680/perf_cython.png.gz)\n\nVisualization of performance data for python code only.",
...
**Attachment:** [perf_cython.png.gz](https://github.com/sagemath/sage/files/ticket30680/perf_cython.png.gz)
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371811"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371812"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371813"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371814"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371815"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371816"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371817"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371818"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371819"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371833"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30680",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30680#event-371834"
}
```
