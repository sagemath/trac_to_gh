...
```json
{
    "body": "<a id='comment:2'></a>#30378 seems relevant.",
    "created_at": "2020-10-01T17:03:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607397",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:2'></a>#30378 seems relevant.
...
```json
{
    "body": "<a id='comment:3'></a>The error is trigerred by the existence of the assumption about `k`, which might trigger further transformations (which turn out to be toxic in this case).\n\nThis works:\n\n```\nf = function(\"f\")\nvar(\"k\")\nEq = f(x).diff(x, 2)/f(x) == k\nwith assuming(k > 0):\n    Sp = desolve(Eq, f(x), ivar=x)\nwith assuming(k == 0):\n    Sz = desolve(Eq, f(x), ivar=x)\nwith assuming(k < 0):\n    Sn = desolve(Eq, f(x), ivar=x)\nSn1 = Sn.subs(sqrt(k) == I*sqrt(abs(k)))\n```\n\nThis crashes Sage:\n\n```\nassume(k < 0)\nSn2 = Sn.subs(sqrt(k) == I*sqrt(abs(k)))\n```\n\nDitto when using `with assuming...`.",
    "created_at": "2020-10-01T22:50:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607398",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:3'></a>The error is trigerred by the existence of the assumption about `k`, which might trigger further transformations (which turn out to be toxic in this case).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607399",
...
```json
{
    "body": "<a id='comment:4'></a>Given that our release is long overdue, and nobody works on the present ticket, I turn it to critical. ANybody proposing a branch in the next few days can of course reconsider this.",
    "created_at": "2020-10-09T13:57:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607400",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:4'></a>Given that our release is long overdue, and nobody works on the present ticket, I turn it to critical. ANybody proposing a branch in the next few days can of course reconsider this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607401",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>A very quick check with Cocalc's available kernels (back to 8.2) shows that the following:\n\n```\nfrom __future__ import print_function\nprint(sage.version.version)\nf = function(\"f\")\nvar(\"k\")\nEq = f(x).diff(x, 2)/f(x) == k\nwith assuming(k < 0):\n    Sn = desolve(Eq, f(x), ivar=x)\nvar(\"K1,_K2\")\nwith assuming (k < 0):\n    print(Sn.subs(sqrt(k) == I*sqrt(abs(k))))\n```\n\ncrashed even in 8.2 days...\nremoving the `with assuming (x < 0):` allows it to run.",
    "created_at": "2020-10-09T14:41:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607402",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:6'></a>A very quick check with Cocalc's available kernels (back to 8.2) shows that the following:
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30688#event-79860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607403",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Mark as `blocker`, but for 9.3...",
    "created_at": "2020-10-19T07:17:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607404",
    "user": "https://github.com/EmmanuelCharpentier"
}
```

<a id='comment:7'></a>Mark as `blocker`, but for 9.3...
...
```json
{
    "body": "<a id='comment:8'></a>Might be related to #30446.",
    "created_at": "2021-01-23T18:27:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607405",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:8'></a>Might be related to #30446.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607406",
...
```json
{
    "body": "<a id='comment:13'></a>Thanks for working on this. As you know, pynac is based on an old fork of ginac - so the question is also whether this bug was fixed upstream.",
    "created_at": "2021-01-30T11:43:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607411",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:13'></a>Thanks for working on this. As you know, pynac is based on an old fork of ginac - so the question is also whether this bug was fixed upstream.
...
```json
{
    "body": "<a id='comment:14'></a>This is what one has in Ginac upstream: https://ginac.de/reference/power_8cpp_source.html\n\n```c++\n        // search for positive/negative factors\n         for (auto & cit : m.seq) {\n             ex e=m.recombine_pair_to_ex(cit);\n             if (e.info(info_flags::positive))\n                 prodseq.push_back(pow(e, exponent).expand(options));\n             else if (e.info(info_flags::negative)) {\n                 prodseq.push_back(pow(-e, exponent).expand(options));\n                 possign = !possign;\n             } else\n                 powseq.push_back(cit);\n         }\n```\nLooks like it's still basically the same, but I'm not 100% sure.",
    "created_at": "2021-01-30T11:49:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607412",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:14'></a>This is what one has in Ginac upstream: https://ginac.de/reference/power_8cpp_source.html
...
```json
{
    "body": "Changing branch from \"\" to \"public/30688\"",
    "created_at": "2021-01-30T20:46:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607414",
    "user": "https://github.com/DaveWitteMorris"
}
```

Changing branch from "" to "public/30688"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607415",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Setting to \"needs review\" to ask the patchbots whether they think that deleting the `else if` clause is a viable option (and to encourage comments from human reviewers).\n\ndimpase already knows this, but for others who are following the thread: As pointed out by mkoeppe inticket: ticket:30446#comment:17#comment:30446, we will actually need a new pynac tarball, not just a patch, when we have decided how to fix this. But I think a patch is good enough for now.\n\n---\nNew commits:",
    "created_at": "2021-01-30T20:57:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607416",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:17'></a>Setting to "needs review" to ask the patchbots whether they think that deleting the `else if` clause is a viable option (and to encourage comments from human reviewers).
...
```json
{
    "body": "Changing commit from \"\" to \"050b28e8911e5a440a4d91caf4da641b824154ac\"",
    "created_at": "2021-01-30T20:57:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607417",
    "user": "https://github.com/DaveWitteMorris"
}
```

Changing commit from "" to "050b28e8911e5a440a4d91caf4da641b824154ac"
...
```json
{
    "body": "<a id='comment:19'></a>OK, I understand now - indeed,[comment:12](#comment%3A12) says that there is a recursion happening in this loop for negative terms. \n\nWhat I don't understand is why only negative terms are a problem.\n\nProbably one needs to rewrite this part modelling on `expand_mul()` in the same file.",
    "created_at": "2021-01-31T01:46:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607419",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:19'></a>OK, I understand now - indeed,[comment:12](#comment%3A12) says that there is a recursion happening in this loop for negative terms. 
...
```json
{
    "body": "<a id='comment:20'></a>Opened https://github.com/pynac/pynac/issues/368 - hopefully people knowing GiNaC code can comment.",
    "created_at": "2021-01-31T13:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607420",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:20'></a>Opened https://github.com/pynac/pynac/issues/368 - hopefully people knowing GiNaC code can comment.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607421",
...
```json
{
    "body": "Changing commit from \"050b28e8911e5a440a4d91caf4da641b824154ac\" to \"6ea4bc6074b7fd5606277aee7c140d786fc4b75d\"",
    "created_at": "2021-02-01T19:47:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607422",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "050b28e8911e5a440a4d91caf4da641b824154ac" to "6ea4bc6074b7fd5606277aee7c140d786fc4b75d"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607424",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607428",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607429",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607430",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>OK, I'm at loss here. \n\nAnyway,let's get your patch in, but please rebase it over\nthe branch of #30446\n(i.e. it should be for pynac 0.7.27, not the current one)",
    "created_at": "2021-02-02T00:56:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607431",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:26'></a>OK, I'm at loss here. 
...
```json
{
    "body": "Changing branch from \"public/30688\" to \"public/30688r1\"",
    "created_at": "2021-02-03T07:15:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607432",
    "user": "https://github.com/DaveWitteMorris"
}
```

Changing branch from "public/30688" to "public/30688r1"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607433",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>OK, I always having trouble doing a rebase, but I think I eventually got it correct.\n\nI changed the package version to 0.7.27.p1 -- is that correct?\n\n---\nLast 10 new commits:",
    "created_at": "2021-02-03T07:17:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607434",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:28'></a>OK, I always having trouble doing a rebase, but I think I eventually got it correct.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607435",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "Changing commit from \"6ea4bc6074b7fd5606277aee7c140d786fc4b75d\" to \"20067d34f7d50886b6efe3ba81729a381a4602a8\"",
    "created_at": "2021-02-03T07:17:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607436",
    "user": "https://github.com/DaveWitteMorris"
}
```

Changing commit from "6ea4bc6074b7fd5606277aee7c140d786fc4b75d" to "20067d34f7d50886b6efe3ba81729a381a4602a8"
...
```json
{
    "body": "<a id='comment:29'></a>Followup ticket: I opened #31337 for reimplementing the `else if` clause.",
    "created_at": "2021-02-04T05:03:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607437",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:29'></a>Followup ticket: I opened #31337 for reimplementing the `else if` clause.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607438",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>OK,good.",
    "created_at": "2021-02-27T15:14:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607439",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:31'></a>OK,good.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30688#event-79861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607440",
...
```json
{
    "body": "Changing branch from \"public/30688r1\" to \"20067d34f7d50886b6efe3ba81729a381a4602a8\"",
    "created_at": "2021-03-07T17:06:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607441",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "public/30688r1" to "20067d34f7d50886b6efe3ba81729a381a4602a8"
...
```json
{
    "body": "Changing commit from \"20067d34f7d50886b6efe3ba81729a381a4602a8\" to \"\"",
    "created_at": "2021-03-07T18:21:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607442",
    "user": "https://github.com/slel"
}
```

Changing commit from "20067d34f7d50886b6efe3ba81729a381a4602a8" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30688#issuecomment-607443",
    "user": "https://github.com/slel"
}
```
