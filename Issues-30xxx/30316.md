...
archive/issue_comments_569706.json:
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569706",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569707.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569707",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88846"
}
```
...
archive/issue_comments_569708.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569708",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569709.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569709",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88847"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88848"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88849"
}
```
...
archive/issue_comments_569710.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569710",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88850"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88851"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88852"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88853"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88854"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88855"
}
```
...
archive/issue_comments_569711.json:
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -16,5 +16,5 @@\n \n See also: \n - #30315 Switch jsmol to jupyter-jsmol, make jmol optional\n+- #20978 `polygon3d` view in jmol broken\n \n-\n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569711",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569712.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569712",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88856"
}
```
...
archive/issue_comments_569713.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569713",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569714.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569714",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569715.json:
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -5,8 +5,6 @@\n https://sourceforge.net/projects/jmol/files/Jmol/Version%2014.32/Jmol%2014.32.35/\n \n jmol is also available as a system package on many systems (https://repology.org/project/jmol/versions), so we should add spkg-configure for it.  \n-- Debian/Ubuntu: `jmol`\n-- Fedora 32: `jmol`\n \n \n Previous update: \n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569715",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569716.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569716",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569717.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569717",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_569718.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30316#issuecomment-569718",
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88857"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30316#event-88858"
}
```
