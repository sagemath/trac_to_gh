...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------|\n|[91bebd0](https://git.sagemath.org/sage.git/commit/?id=91bebd0b9de8fb0724216c79a3dde611fdffff67)|`add warning`|",
...
```json
{
    "body": "<a id='comment:45'></a>\nSorry, I goofed up the sphinx syntax of the `WARNING` block in the docstring. I fixed that, and rebased on 9.3b7.\n\n---\nNew commits:\n|                                                                                                                                          |                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|\n|[d75ef40](https://git.sagemath.org/sage.git/commit?id=d75ef40848a6211e896597aad19ca82008857b13)|`fix trac #30378`|\n|[c15730c](https://git.sagemath.org/sage.git/commit?id=c15730ce264ea30d044e50c064764eb8c0f43b69)|`update doctest error message`|\n|[14aec0c](https://git.sagemath.org/sage.git/commit?id=14aec0c6a840c4211fa2cdaa533d1eb606ed0686)|`add warning`|\n|[8d4db46](https://git.sagemath.org/sage.git/commit?id=8d4db4686b31902f7c411637431ff349d4de5191)|`wrong syntax for warning`|",
    "created_at": "2021-02-14T03:07:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30378",
    "type": "issue_comment",
