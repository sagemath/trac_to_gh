...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[3cd351c](https://git.sagemath.org/sage.git/commit?id=3cd351c795a86552354569e203dc849e07e5af1c)|`build/bin/sage-spkg: Set SAGE_SPKG_WHEELS in wrapped scripts`|",
    "created_at": "2020-10-15T04:30:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30771",
    "type": "issue_comment",
