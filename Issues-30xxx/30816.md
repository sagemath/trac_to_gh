...
```json
{
    "body": "<a id='comment:3'></a>I've opened https://sourceforge.net/p/maxima/bugs/3677/ to track this bug.",
    "created_at": "2020-11-15T06:00:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30816#issuecomment-436424",
    "user": "https://trac.sagemath.org/admin/accounts/users/robert_dodier"
}
```

<a id='comment:3'></a>I've opened https://sourceforge.net/p/maxima/bugs/3677/ to track this bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30816#issuecomment-436425",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80388"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80389"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80390"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80391"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80392"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80393"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80394"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80395"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30816#event-80396"
}
```
