...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389142"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30548#issuecomment-490312",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389148"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30548#issuecomment-490313",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389149"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30548",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30548#event-389150"
}
```
