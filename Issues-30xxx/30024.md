...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30024#issuecomment-478188",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30024#issuecomment-478189",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30024#event-395204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30024#event-395205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30024#event-395206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30024#event-395207"
}
```
