...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605627",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605628",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605629",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605630",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605631",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605633",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605634",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605635",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605636",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605637",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605638",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605639",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605640",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605641",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605642",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>\nWell\n\n```diff\n--- a/sage/data_structures/bitset_intrinsics.h\n+++ b/sage/data_structures/bitset_intrinsics.h\n@@ -9,7 +9,7 @@\n #############################################################################\n */\n \n-inline int `_bitset_`isempty(mp_limb_t* bits, mp_bitcnt_t limbs){\n+static inline int `_bitset_`isempty(mp_limb_t* bits, mp_bitcnt_t limbs){\n     /*\n     Test whether bits is empty.  Return True (i.e., 1) if the set is\n     empty, False (i.e., 0) otherwise.\n@@ -24,7 +24,7 @@ inline int `_bitset_`isempty(mp_limb_t* bits, mp_bitcnt_t limbs){\n     return mpn_cmp(bits+1, bits, limbs-1) == 0;\n }\n \n-inline int `_bitset_`eq(mp_limb_t* a, mp_limb_t* b, mp_bitcnt_t limbs){\n+static inline int `_bitset_`eq(mp_limb_t* a, mp_limb_t* b, mp_bitcnt_t limbs){\n     /*\n     Compare bitset a and b.  Return True (i.e., 1) if the sets are\n     equal, and False (i.e., 0) otherwise.\n@@ -32,7 +32,7 @@ inline int `_bitset_`eq(mp_limb_t* a, mp_limb_t* b, mp_bitcnt_t limbs){\n     return mpn_cmp(a, b, limbs) == 0;\n }\n \n-inline int `_bitset_`issubset(mp_limb_t* a, mp_limb_t* b, mp_bitcnt_t limbs){\n+static inline int `_bitset_`issubset(mp_limb_t* a, mp_limb_t* b, mp_bitcnt_t limbs){\n     /*\n     Test whether a is a subset of b (i.e., every element in a is also\n     in b).\n```\ndid the trick, I have a successful build now.",
    "created_at": "2020-09-26T09:25:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605643",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605644",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605645",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30596#event-89672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605646",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605647",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605648",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30596#issuecomment-605649",
    "user": "https://github.com/kiwifb"
}
```
