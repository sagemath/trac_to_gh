...
```json
{
    "body": "<a id='comment:5'></a>\nI have not run doctests, just tried this by monkey-patching my local [SageMath](../wikis/SageMath) but this should work. Let's see what the patchbot thinks about this.",
