...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595856",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595857",
...
```json
{
    "body": "<a id='comment:5'></a>Being canonical is a necessary condition for a coerce map, but not a sufficient one.\n\nIn #30242 (unfinished), this canonical injection from the exterior module to the tensor module is made available as the \"lift\" map. But it should not be a coercion.",
    "created_at": "2020-08-03T10:57:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595858",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>Being canonical is a necessary condition for a coerce map, but not a sufficient one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595859",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595861",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>What would happen if one implements both directions, i.e. both coercions? Would that be possible?",
    "created_at": "2020-08-03T12:17:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595862",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:9'></a>What would happen if one implements both directions, i.e. both coercions? Would that be possible?
...
```json
{
    "body": "<a id='comment:10'></a>I would think that this is dangerous because the composition antisymmetrizes.",
    "created_at": "2020-08-03T12:21:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595863",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:10'></a>I would think that this is dangerous because the composition antisymmetrizes.
...
```json
{
    "body": "<a id='comment:11'></a>I just found a good discussion of the two viewpoints of `ExtPower` as a quotient space vs. as a subspace (which I was not familiar with) in https://kconrad.math.uconn.edu/blurbs/linmultialg/extmod.pdf, page 12/13.",
    "created_at": "2020-08-03T12:23:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595864",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:11'></a>I just found a good discussion of the two viewpoints of `ExtPower` as a quotient space vs. as a subspace (which I was not familiar with) in https://kconrad.math.uconn.edu/blurbs/linmultialg/extmod.pdf, page 12/13.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595865",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595866",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595868",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595872",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595873",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78337"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30278#issuecomment-595874",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78338"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78339"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78340"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78341"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78342"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78343"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78344"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78345"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78346"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30278#event-78347"
}
```
