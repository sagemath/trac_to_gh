...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|\n|[2a8e3b7](https://git.sagemath.org/sage.git/commit?id=2a8e3b7a47f42d46a10334756d11fc51921db254)|`Feature.resolution: If spkg is given, try to give system package information; only show 'sage -i' if sage-spkg is available`|",
    "created_at": "2020-09-19T03:14:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30606",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|\n|[febf5e6](https://git.sagemath.org/sage.git/commit/?id=febf5e6e153fc826c4ad77ee822766a41c945ddf)|`Feature.resolution: Use lazy strings to delay system package lookup`|\n|[081e736](https://git.sagemath.org/sage.git/commit/?id=081e7367d6b2081d37a25b73ba3d3333eb8956f0)|`sage.features.package_systems: New, use it in Feature.resolution`|\n|[36772a5](https://git.sagemath.org/sage.git/commit/?id=36772a5cf26c7a80cd2730c2fdea009e18e7a550)|`Feature.resolution: Fix up`|\n|[04fa02d](https://git.sagemath.org/sage.git/commit/?id=04fa02da502df29f00c12c92bdc828e8b1948dc2)|`build/bin/{sage-get-system-packages,sage-print-system-package-command}: Handle pip`|\n|[3f66ab7](https://git.sagemath.org/sage.git/commit/?id=3f66ab7d60f1e5e8aee8be19d7680410fdb51f93)|`build/bin/sage-print-system-package-command: Handle --prompt=PROMPT, fix error reporting`|\n|[d2055ac](https://git.sagemath.org/sage.git/commit/?id=d2055ac0443b48b20c0f12b5b810cda1e42f77d5)|`sage.features: Add features PackageSystem, SagePackageSystem, PipPackageSystem, use them in Feature.resolution`|",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[fa10a90](https://git.sagemath.org/sage.git/commit/?id=fa10a901256c0c133b5957a48cc57fd5a8a9832f)|`src/sage/features/__init__.py: Add doctests`|",
