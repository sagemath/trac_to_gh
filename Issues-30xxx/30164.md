...
```json
{
    "body": "<a id='comment:2'></a>Perhaps, in fact, this category should define (as an abstract method) the method `isomorphism_with_fixed_basis` proposed in #30094.",
    "created_at": "2020-07-19T15:01:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592853",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>Perhaps, in fact, this category should define (as an abstract method) the method `isomorphism_with_fixed_basis` proposed in #30094.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592855",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592856",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592857",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592858",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592859",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Thanks a lot for your explanations.",
    "created_at": "2020-07-26T02:23:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592860",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:9'></a>Thanks a lot for your explanations.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592861",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>In a slightly different direction: I think it should also be clarified what exactly the category `Modules(R).FiniteDimensional()` is.",
    "created_at": "2020-07-27T06:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592862",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:11'></a>In a slightly different direction: I think it should also be clarified what exactly the category `Modules(R).FiniteDimensional()` is.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592863",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592864",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77790"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30164#issuecomment-592865",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77791"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77792"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77793"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77794"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77795"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77796"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77797"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77798"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77799"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30164#event-77800"
}
```
