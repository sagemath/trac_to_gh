...
```json
{
    "body": "<a id='comment:1'></a>I've implemented three more with `FinitelyGeneratedAsLieConformalAlgebra`, `FinitelyGeneratedAsVertexAlgebra` and `FinitelyGeneratedAsPoissonVertexAlgebra` I think it's only a matter of time until people (like me) are drawn to Sage and start implementing more. \n\nFor `Modules(QQ)` this was probably left intentionally like this. I can see a few reasons for this, since for modules over a `k` algebra `R`, `FiniteDimensional` means typically finite dimensional over `k`, it could be very confusing/tricky to have a `modules.SubcategoryMethods.FinitelyGenerated`.",
    "created_at": "2020-07-27T21:21:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594653",
    "user": "https://github.com/heluani"
}
```

<a id='comment:1'></a>I've implemented three more with `FinitelyGeneratedAsLieConformalAlgebra`, `FinitelyGeneratedAsVertexAlgebra` and `FinitelyGeneratedAsPoissonVertexAlgebra` I think it's only a matter of time until people (like me) are drawn to Sage and start implementing more. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594657",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>By the way, I am trying to figure out what exactly is meant by the category `Modules(R).FiniteDimensional()`. ~~Is this intended to be imply \"free\" already?~~",
    "created_at": "2020-07-28T17:11:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594658",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:6'></a>By the way, I am trying to figure out what exactly is meant by the category `Modules(R).FiniteDimensional()`. ~~Is this intended to be imply "free" already?~~
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594663",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Replying to [heluani](#comment%3A11):\n> I apologize if this is getting to \"chatty\" for a trac ticket. \n\n\nTo the contrary -- this was very helpful. Thanks for taking the time to explain!",
    "created_at": "2020-08-03T19:38:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594664",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:12'></a>Replying to [heluani](#comment%3A11):
> I apologize if this is getting to "chatty" for a trac ticket. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594666",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594667",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594668",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78130"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78131"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30233#issuecomment-594670",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78133"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78134"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78135"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78136"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78137"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78138"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78139"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30233#event-78140"
}
```
