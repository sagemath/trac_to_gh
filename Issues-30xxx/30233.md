...
```json
{
    "body": "By the way, I am trying to figure out what exactly is meant by the category `Modules(R).FiniteDimensional()`. ~~Is this intended to be imply \"free\" already?~~",
...
Replying to [comment:11 heluani]:
> I apologize if this is getting to "chatty" for a trac ticket. 
