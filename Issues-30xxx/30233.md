...
```json
{
    ...
    "url": "https://github.com/sagemath/sage/issues/30233",
...
```json
{
    ...
    "created_at": "2020-07-27T18:33:59Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "milestone_number": null,
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479346",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479348",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479349",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479350",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479351",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479352",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479353",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479354",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479356",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479358",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    "body": "<div id=\"comment:14\"></div>\n\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/2cf761420fbb107622a8febb4c6a88d1c4493fd9\"><code>2cf7614</code></a></td><td><code>Implement generic FinitelyGenerated axioms</code></td></tr></table>\n",
    "created_at": "2020-08-06T19:07:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479359",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    "body": "Branch: **[public/finitely_generated_as_xxx_axioms](https://github.com/sagemath/sagetrac-mirror/tree/public/finitely_generated_as_xxx_axioms)**",
    "created_at": "2020-08-06T19:07:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479360",
    "user": "https://github.com/heluani"
}
```

Branch: **[public/finitely_generated_as_xxx_axioms](https://github.com/sagemath/sagetrac-mirror/tree/public/finitely_generated_as_xxx_axioms)**
...
```json
{
    "body": "Commit: **[`2cf7614`](https://github.com/sagemath/sagetrac-mirror/commit/2cf761420fbb107622a8febb4c6a88d1c4493fd9)**",
    "created_at": "2020-08-06T19:07:45Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479361",
    "user": "https://github.com/heluani"
}
```

Commit: **[`2cf7614`](https://github.com/sagemath/sagetrac-mirror/commit/2cf761420fbb107622a8febb4c6a88d1c4493fd9)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479362",
    "user": "https://github.com/heluani"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416421"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416422"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416423"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416424"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30233#issuecomment-479363",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416425"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416426"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416427"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416428"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416429"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416430"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416431"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416432"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416433"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30233#event-416434"
}
```
