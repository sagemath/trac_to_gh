...
```
Upgrade to planarity 3.0.1.0, in particular to avoid patching, which is flaky as the patch file has mixed CR and CRLF endings, leading to breakdown of [GitLab](../wikis/GitLab) runner.
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1 +1 @@\n-to version 3.0.1.0 so as to avoid patching\n+to version 3.0.1.0, in particular to avoid patching, which is flaky as the patch file has mixed CR and CRLF endings, leading to breakdown of [GitLab](../wikis/GitLab) runner.\n``````\n",
    "created_at": "2020-11-08T18:11:02Z",
    "issue": "https://github.com/sagemath/sage/issues/30874",
    "type": "issue_comment",
