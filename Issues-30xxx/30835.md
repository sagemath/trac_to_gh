...
Replying to [@mkoeppe](https://github.com/sagemath/sage/issues/30835#comment:0):
> Portability issues (solving them should not be a prerequisite for the present ticket):
