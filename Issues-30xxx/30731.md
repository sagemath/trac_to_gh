...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|\n|[218fe09](https://git.sagemath.org/sage.git/commit?id=218fe09a5873f61fe4f0efc004502dea85f56de3)|`Use system python for generation of conway_polynomials and elliptic_curves`|\n|[9f15544](https://git.sagemath.org/sage.git/commit?id=9f15544b8ddb9ca2770c6eec88ab80180672ce7e)|`Use python3 instead of system-python`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|\n|[f7323ee](https://git.sagemath.org/sage.git/commit/?id=f7323ee56b14a291cf9fb8312fde6ab2d20dd570)|`Merge branch 'develop' of git://github.com/sagemath/sage into public/build/sharedSystemPython`|\n|[7cb43a5](https://git.sagemath.org/sage.git/commit/?id=7cb43a574c3869e27824b9b8202310910831ad44)|`Remove other instances of sage-python23`|",
    "created_at": "2020-12-18T22:37:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30731",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[df2822c](https://git.sagemath.org/sage.git/commit/?id=df2822c5c130811bcba1d7e65743b100444083dd)|`Update documentation regarding use of python3 vs. sage-bootstrap-python`|",
