...
```json
{
    "body": "<a id='comment:2'></a>\nTobias, before I add more of these, do you think this format is useful for generating other files?\n\n---\nNew commits:\n|                                                                                                                                          |                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[a754e8c](https://git.sagemath.org/sage.git/commit?id=a754e8c70b528e2c010e2d62c9375c874802a8c0)|`Add some build/pkgs/*/install-requires.txt`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[11ce883](https://git.sagemath.org/sage.git/commit/?id=11ce883bcb57024a33c6b22ca0dc8ceb2674e9c8)|`Add more build/pkgs/*/install-requires.txt`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|\n|[82d0df3](https://git.sagemath.org/sage.git/commit/?id=82d0df3d31a02e31855994c4e0d16316d70060af)|`build/pkgs/p_group_cohomology/install-requires.txt: Not on PyPI, remove`|\n|[d5e9840](https://git.sagemath.org/sage.git/commit/?id=d5e9840e860958f2aafe63280ea822900e722658)|`build/pkgs/pathpy/install-requires.txt: Package removed in #30611, remove`|",
