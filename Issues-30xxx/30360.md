...
```json
{
    "body": "<a id='comment:7'></a>\nReplying to [mkoeppe](#comment%3A3):\n> I think the methods `_lmul_` and `_rmul_` of `NumberFieldElement_quadratic` are in the way. I think they may just need to be removed (haven't tried)\n\n\nBy itself this does not fix it... (see branch)\n\n---\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[8a9c2aa](https://git.sagemath.org/sage.git/commit?id=8a9c2aa05454dc3695a1f8eceb4b657047fda489)|`WIP: NumberFieldElement_quadratic._lmul_, _rmul_: Remove`|",
    "created_at": "2020-08-15T16:21:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30360",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[fc48d6d](https://git.sagemath.org/sage.git/commit/?id=fc48d6d937fd497268518d8ee8f153918ff4dde4)|`sage.categories.pushout.AlgebraicExtensionFunctor: Handle latex_names`|\n|[d85068f](https://git.sagemath.org/sage.git/commit/?id=d85068ffe6353790ea03d3dcd1cb652883a78923)|`CommutativeRing.extension, NumberField_generic.extension, FiniteField.extension: Accept latex_name argument`|\n|[7a88492](https://git.sagemath.org/sage.git/commit/?id=7a88492013d4b4147c35d0ceb2124e38bc393aae)|`NumberField_generic.construction: Pass latex_names to AlgebraicExtensionFunctor`|",
...
```json
{
    "body": "<a id='comment:20'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|\n|[1842e47](https://git.sagemath.org/sage.git/commit/?id=1842e477e5c54140b77dae80ace0554387bf7863)|`sage.rings.number_field.number_field.NumberField_generic: Use _latex_names instead of __latex_variable_name, deprecate .latex_variable_name()`|\n|[f9ceef7](https://git.sagemath.org/sage.git/commit/?id=f9ceef7cd3977cd0f5cd27e2dcd959c2e817b050)|`Merge branch 't/30372/replace_numberfield_generic___latex_variable_name_by___latex_name' into t/30360/action_of_number_field_on_free_module_over_zz_not_discovered`|\n|[56f6c4d](https://git.sagemath.org/sage.git/commit/?id=56f6c4d754634cd764d0e9be1906047afa239456)|`sage.rings.number_field.number_field.NumberFieldTower: Pass latex_name to extension`|\n|[42eb272](https://git.sagemath.org/sage.git/commit/?id=42eb272ad538d404e7375fb5e0560e4e2ccf6508)|`sage.rings.number_field.number_field.NumberField_generic.construction: Collect latex_names from the tower of extensions`|\n|[6697bca](https://git.sagemath.org/sage.git/commit/?id=6697bca3c89ddae1be7ffcc5e4464832f6475199)|`Fixup`|\n|[a6e828e](https://git.sagemath.org/sage.git/commit/?id=a6e828e8a6189728135588dd156e271e773a4f97)|`Merge branch 't/30372/replace_numberfield_generic___latex_variable_name_by___latex_name' into t/30360/action_of_number_field_on_free_module_over_zz_not_discovered`|\n|[20ce248](https://git.sagemath.org/sage.git/commit/?id=20ce24899b75292cec183f6c6f8c4af8c13fbcfc)|`src/sage/rings/number_field/number_field_element_quadratic.pyx: Add test for #30360`|",
    "created_at": "2020-08-15T20:28:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30360",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|\n|[da551dc](https://git.sagemath.org/sage.git/commit/?id=da551dcf21959eb14e768656c7d55a6ad8760f14)|`src/sage/rings/number_field/number_field.py: Fix error found by pyflakes`|\n|[6d29391](https://git.sagemath.org/sage.git/commit/?id=6d293911c4be27878476d9c057d70d5aa59f3305)|`Merge branch 't/30372/replace_numberfield_generic___latex_variable_name_by___latex_name' into t/30360/action_of_number_field_on_free_module_over_zz_not_discovered`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------|\n|[45aeabd](https://git.sagemath.org/sage.git/commit/?id=45aeabd06a57edc121f2d13c12224c9b77391717)|`doctests`|\n|[f2ffd17](https://git.sagemath.org/sage.git/commit/?id=f2ffd171ddef3c2f20cfe678cafa8b59c6d289f9)|`Ring.extension, NumberField...__init__: Prefer latex_names over latex_name`|\n|[e0c216b](https://git.sagemath.org/sage.git/commit/?id=e0c216bb35121c5537653800698db3cd51781578)|`Treat latex_names in a similar manner to names`|\n|[86b40c2](https://git.sagemath.org/sage.git/commit/?id=86b40c2a3d80f07963f012d502062bcb73b26d28)|`adjust _latex for elements of relative number fields`|\n|[3e5cc17](https://git.sagemath.org/sage.git/commit/?id=3e5cc17d9dc779dc214161860e33d2dcf63582a1)|`src/sage/categories/pushout.py: Prefer latex_names in doctest`|\n|[e40588a](https://git.sagemath.org/sage.git/commit/?id=e40588ababaaeb1899352149d8dcc854fb7bc9a4)|`FiniteField.extension: Make arguments latex_name, latex_names keyword-only`|\n|[c598fbb](https://git.sagemath.org/sage.git/commit/?id=c598fbbd9730a35ec17cb0c72b3f8f1608fcadf2)|`src/sage/rings/number_field/number_field_element.pyx: Use latex_variable_names instead of deprecated latex_variable_name`|",
...
```json
{
    "body": "<a id='comment:42'></a>\nReplying to [tscrim](#comment%3A41):\n> I think the problem is in `NumberFieldTower`, the string is not a `r\"\"\"`. Let me see if that fixes it.\n\n\nI think that fixes it. Please double-check. What a cryptic error message through...\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[45e0c4f](https://git.sagemath.org/sage.git/commit?id=45e0c4f4cdfeda48e308d13b9ff740c941fd0d7b)|`Merge branch 'u/mkoeppe/action_of_number_field_on_free_module_over_zz_not_discovered' of git://trac.sagemath.org/sage into public/coercion/latex_names-30360`|\n|[a3c790f](https://git.sagemath.org/sage.git/commit?id=a3c790f6fb38fca37c37dae86e568a5acdedb1c0)|`Fix pdf docbuild in NumberFieldTower.`|",
    "created_at": "2020-08-27T00:43:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30360",
    "type": "issue_comment",
