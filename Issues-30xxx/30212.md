...
```json
{
    "body": "We need reviewers able to read English, French, German, Portuguese, and Japanese. Actually, for Japanese, we need also need someone able to write it.\n\n---\nNew commits:",
    "created_at": "2020-08-28T14:04:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30212",
    "type": "issue_comment",
...
```json
{
    "body": "French and English OK for me, I cannot comment on other languages.",
...
```json
{
    "body": "I slightly corrected the German version, English is fine -- and I cannot comment on the others. :-)",
...
```json
{
    "body": "The Portuguese translation seems OK, according a Brazilian student of my team.",
...
```json
{
    "body": "Here is what I could do with the Japanese version. I will ask someone I know to double-check.",
...
```json
{
    "body": "I had a native speaker friend of mine check the Japanese version. Now it is more natural.",
...
```json
{
    "body": "Please add author and reviewer names as appropriate,\nand someone give this positive review.",
...
```json
{
    "body": "added my name. Once other people have added the appropriate names we can switch to positive review.",
...
```json
{
    "body": "We still need reviewer names for German and portuguese unless Travis can vouch for them.",
...
```json
{
    "body": "I can only say the Portuguese seems right coming from my knowledge of Spanish. I would not rely on that however. `;)`",
...
```json
{
    "body": "Reimundo Heluani validated the Portuguese version on sage-devel:\n\n- https://groups.google.com/d/msg/sage-devel/cGMKwfIAjEk/7TQjSfkEBwAJ",
