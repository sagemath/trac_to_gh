...
```json
{
    "body": "<a id='comment:1'></a>When using the most updated version of sage (including #29925, #29926 which might be relevant), and  implementing the yet-unreviewed ticket #29927, the only one of the above examples which remains problematic is:\n\n```\nsage: T.<a> = Qp(31, 3).extension(x^3 - 31)\nsage: D.<b> = Qp(31, 6).extension(x^3 - 31)\nsage: D(29*a^27 + O(a^36))\n29*b^27 + 18*b^33 + O(b^36)\n```\nBut this results from the problem in _polynomial_list() which is described in #29932. \nIndeed:\n\n```\nsage: T.<a> = Qp(31, 3).extension(x^3 - 31)\nsage: T((29*a^27 + O(a^36))._polynomial_list())\n29*a^27 + 18*a^33 + O(a^36)\n```",
    "created_at": "2020-08-26T13:13:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30420#issuecomment-600553",
    "user": "https://github.com/n-vi"
}
```

<a id='comment:1'></a>When using the most updated version of sage (including #29925, #29926 which might be relevant), and  implementing the yet-unreviewed ticket #29927, the only one of the above examples which remains problematic is:
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30420#event-78898"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30420#issuecomment-600554",
    "user": "https://github.com/n-vi"
}
```
...
archive/issue_comments_600555.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30420#issuecomment-600555",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30420",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30420#event-78899"
}
```
...
archive/issue_comments_600556.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30420#issuecomment-600556",
