...
```json
{
    "body": "<a id='comment:10'></a>The changes discussed in[comment:2](#comment%3A2) to[comment:4](#comment%3A4) still need to be implemented",
...
<a id='comment:10'></a>The changes discussed in[comment:2](#comment%3A2) to[comment:4](#comment%3A4) still need to be implemented
