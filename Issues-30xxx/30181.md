...
```json
{
    "body": "<a id='comment:15'></a>`@`gh-mjungmath Did you see comment:8?",
...
<a id='comment:15'></a>`@`gh-mjungmath Did you see comment:8?
...
<a id='comment:23'></a>Replying to [comment:14 gh-mjungmath]:
> What about a slighly more general approach like having a class `ElementWithMutability` 
...
<a id='comment:25'></a>Replying to [comment:24 gh-mjungmath]:
> connections already support hashing even though they cannot be considered immutable. Strictly speaking, this is a defect.
