...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397382"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397384"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30181#issuecomment-481016",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30181#issuecomment-481017",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397386"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397388"
}
```
...
```json
{
    "body": "<div id=\"comment:15\" align=\"right\">Comment 15</div>\n\n@mjungmath Did you see [comment:8](#comment%3A8)?",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30181",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30181#event-397390"
}
```
