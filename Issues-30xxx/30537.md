...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|\n|[dffb33e](https://git.sagemath.org/sage.git/commit/?id=dffb33e3b63b40be02fe9adbf05c94c39bda24db)|`build/pkgs/giac: Upgrade to 1.6.0-47`|\n|[eb3ea4c](https://git.sagemath.org/sage.git/commit/?id=eb3ea4c5a96649ae3e2676143c75d386f25c5449)|`build/pkgs/giac/spkg-install.in: Use configure --disable-micropy`|",
    "created_at": "2021-02-20T17:44:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30537",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[66c645e](https://git.sagemath.org/sage.git/commit/?id=66c645e68dfe831e41c36495f73f865cff5f6aae)|`build/pkgs/giac: Patch out micropython`|",
    "created_at": "2021-02-20T18:32:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30537",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:53'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[f49c6bf](https://git.sagemath.org/sage.git/commit/?id=f49c6bf458e3384ff906e0eaed2c68cb0c19562a)|`build/pkgs/pari/spkg-configure.m4: Check PARI_MT_ENGINE`|",
...
```json
{
    "body": "<a id='comment:56'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[2c78378](https://git.sagemath.org/sage.git/commit/?id=2c783788d3d106fa86a0578a14070f0567459f0d)|`build/pkgs/pari: Use Configure --mt=pthread`|",
...
```json
{
    "body": "<a id='comment:61'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|\n|[8192488](https://git.sagemath.org/sage.git/commit/?id=819248812fbf894fa6f564c1db792deda154c906)|`sage.libs.giac, sage.rings.polynomial.multi_polynomial_ideal: Relax doctests for giac 1.6.0-47`|",
    "created_at": "2021-02-21T03:57:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30537",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:68'></a>\nReplying to [mkoeppe](#comment%3A66):\n> Looks like the function `groebner_basis` defined in `src/sage/libs/giac/__init__.py` ought to be updated.\n\n\nDone.\n\n> Does `eliminate` in older versions of `giac` also accept the additional argument?\n\n\nYes, looks like it, tested as well with the giac version before this ticket.\n\n\nReady for review\n\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|\n|[3f2c335](https://git.sagemath.org/sage.git/commit?id=3f2c335082477a0d4e411b71a72e744a4e8dbd26)|`sage.libs.giac.groebner_basis: When calling eliminate, pass 'gbasis' so that giac 1.6.0-47 does not use resultants instead`|",
    "created_at": "2021-02-22T01:58:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30537",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:83'></a>\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[b066c15](https://git.sagemath.org/sage.git/commit?id=b066c1542a0a0958054769ff951e84c64d9369c5)|`Fix giac interfaces doctest for sqrt use and formatting.`|\n|[66f28e7](https://git.sagemath.org/sage.git/commit?id=66f28e77804971718e2ef01fc5d4122041bdf1ba)|`update checksum.`|\n|[7ebea00](https://git.sagemath.org/sage.git/commit?id=7ebea00f86f3689df168810b6688b65ad0faba77)|`flush some print statements so parallel and serial doctests results matches`|",
    "created_at": "2021-02-23T01:01:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30537",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:86'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|\n|[6132c9a](https://git.sagemath.org/sage.git/commit/?id=6132c9a6501e32715f2fd0d4742b42fa8eba84ec)|`update upstream url to proper version`|",
...
```json
{
    "body": "<a id='comment:93'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[db1fcfd](https://git.sagemath.org/sage.git/commit/?id=db1fcfd3d0c73cfc1caabf260b03cac04e6f40f3)|`Factorization examples working with 15.0 and 1.6.0`|",
...
```json
{
    "body": "<a id='comment:95'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[c702e45](https://git.sagemath.org/sage.git/commit/?id=c702e45e2eb4e5ef40564d725f7059b163ac3073)|`allow system giac-1.6.0`|",
    "created_at": "2021-02-23T09:12:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30537",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:0'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[f05720b](https://git.sagemath.org/sage.git/commit/?id=f05720bf63dfaf33a4e3b6d3ed2c2c0ec46b5d31)|`make a doctest giac version independent`|",
    "created_at": "2021-02-23T20:16:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30537",
    "type": "issue_comment",
