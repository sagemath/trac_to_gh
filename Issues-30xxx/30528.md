...
```json
{
    "body": "This LGTM although it is making me wonder if we should have our own bitset operations class in Sage. There is the C++ STL bitset, and if we do need something slightly more custom, it would be good as a C++ library that we would then interface with.",
    "created_at": "2020-09-08T22:51:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30528",
    "type": "issue_comment",
...
```json
{
    "body": "Thank you for the explanation and the rebase.",
...
```json
{
    "body": "`@`mkoeppe: Could you maybe check if this works on OSX? So if it compiles now and if tests in `geometry/polyhedron` pass?",
...
```json
{
    "body": "https://github.com/kliem/sage/actions/runs/374613473\n\nEventually this will also terminate.",
...
```json
{
    "body": "Ok. Seems to work now. The OSX patchbot came back and it is morally green (unrelated tests fail).",
    "created_at": "2020-11-24T08:09:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30528",
    "type": "issue_comment",
