...
```json
{
    "body": "<a id='comment:13'></a>\nThis seems to work:\n\n1. The build finished with `/bin/sh -> /bin/dash`.\n2. I can run `~/src/sage.git/local/bin/sage` from my home directory afterwards and it works.\n  \n---\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[b8a2dcc](https://git.sagemath.org/sage.git/commit?id=b8a2dcc941fbc09516826a402da3c0a8594a05a1)|`Trac #30128: always source sage-env-config before sage-env.`|\n|[624e326](https://git.sagemath.org/sage.git/commit?id=624e32674aef4947aa36d8c5d8051a7c6816fd62)|`Trac #30128: enforce sourcing of sage-env-config before src/bin/sage-env.`|",
    "created_at": "2020-07-13T21:28:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30128",
    "type": "issue_comment",
