...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30403#event-400775"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30403#event-400776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30403#event-400777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30403#event-400778"
}
```
...
```json
{
    "body": "Changed keywords from **** to **gitlab, docker**",
...
Changed keywords from **** to **gitlab, docker**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30403#issuecomment-487074",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30403#issuecomment-487075",
    "user": "https://github.com/vbraun"
}
```
