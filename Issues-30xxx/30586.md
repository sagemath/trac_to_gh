...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79533"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Should this instead be reported to rpy2?\n\nhttps://github.com/rpy2/rpy2/issues",
    "created_at": "2021-03-27T14:35:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30586#issuecomment-432322",
    "user": "https://github.com/slel"
}
```

<a id='comment:4'></a>Should this instead be reported to rpy2?
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79534"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79535"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30586#issuecomment-432323",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79536"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79537"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79538"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79539"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79540"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79541"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79542"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30586#event-79543"
}
```
