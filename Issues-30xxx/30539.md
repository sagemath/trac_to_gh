...
<a id='comment:25'></a>Replying to [comment:23 gh-dkwo]:
> I'm puzzled by python, giac, etc: all these should not be built.
> I forgot to add freetype-devel:
...
<a id='comment:29'></a>Replying to [comment:28 gh-dkwo]:
> I attached config.log from my machine. Only difference should be with isl and gf2x, which are not in repository and I built myself.
...
<a id='comment:31'></a>Replying to [comment:27 gh-dkwo]:
> Sure, I attached void.more​. I have to think why it is not behaving as on my machine.
> Are you generating a new docker image every time, and then use 
> 
> ```
