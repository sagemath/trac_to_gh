...
```json
{
    "body": "<a id='comment:11'></a>\nhere is a tentative, just removing the `_send_interrupt` method\n\n---\nNew commits:\n|                                                                                                                                          |                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[95e1efd](https://git.sagemath.org/sage.git/commit?id=95e1efd943245a9bcca8c9a85268edc7e3004ac2)|`remove custom _send_interrupt in singular pexpect interface`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[85f65bf](https://git.sagemath.org/sage.git/commit/?id=85f65bf368331688ab3b8fe319e318ed046eecdc)|`remove custom _send_interrupt in singular pexpect interface`|",
