...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30657#event-404403"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30657#event-404404"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30657#event-404405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30657#event-404406"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30657#issuecomment-492354",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30657#issuecomment-492355",
    "user": "https://github.com/vbraun"
}
```
