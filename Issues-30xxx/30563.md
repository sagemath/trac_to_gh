...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30563#event-403098"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30563#event-403099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30563#event-403100"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30563#event-403101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30563#issuecomment-490620",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30563#issuecomment-490621",
    "user": "https://github.com/kiwifb"
}
```
