...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[e0c5313](https://git.sagemath.org/sage.git/commit?id=e0c5313203da84ba75e751738e87403e56c0bbdc)|`30186: Fix containment check for standard bracketed Lyndon words`|",
    "created_at": "2021-02-15T11:03:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30186",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|\n|[c7df5f2](https://git.sagemath.org/sage.git/commit/?id=c7df5f2aa44a7c11d6e634a703188269a1ad6213)|`30186: Return word and raise exception on error instead of returning list`|",
...
```json
{
    "body": "<a id='comment:21'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[41ecff7](https://git.sagemath.org/sage.git/commit/?id=41ecff765b54311428fb06244f6d3b5c1c4c0af1)|`30186: Fix few things`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[13b9f25](https://git.sagemath.org/sage.git/commit/?id=13b9f258957bd06afd5e7d4a31331b025932542b)|`30186: Fix few more things`|",
...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[fffa870](https://git.sagemath.org/sage.git/commit/?id=fffa870595be0baaa597a4e324eaad687233cb04)|`30186: Fix another few things`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[e2ca3e8](https://git.sagemath.org/sage.git/commit/?id=e2ca3e8b6df1959b91d6af695e1a663ad43fa938)|`30186: Add a regression test`|",
