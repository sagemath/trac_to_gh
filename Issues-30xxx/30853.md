...
archive/issue_comments_604278.json:
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30853#issuecomment-604278",
    "user": "https://github.com/GMS103"
}
```
...
archive/issue_comments_604279.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30853#issuecomment-604279",
...
archive/issue_comments_604280.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30853#issuecomment-604280",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98612"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98613"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98614"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98615"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98616"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98617"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98618"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98619"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30853#event-98620"
}
```
