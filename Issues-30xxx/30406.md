...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486920",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486921",
    "user": "https://github.com/davidlowryduda"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486922",
    "user": "https://github.com/tobiasdiez"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486923",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486924",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486926",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,6 +1,8 @@\n-I've heard that once upon a time there was a bot that created trac issues based on github PRs. Apparently the bot was lost.\n+I've heard that once upon a time there was a bot that created trac issues based on GitHub PRs. Apparently the bot was lost.\n \n-I found https://github.com/trac-hacks/trac-github which has the feature to \"update the local git mirror used by Trac after each push to [GitHub](../wikis/GitHub), and notify the new changesets to Trac;\". Sounds like this is exactly what would be needed to allow PRs from github.\n+I found https://github.com/trac-hacks/trac-github which has the feature to \"update the local git mirror used by Trac after each push to GitHub, and notify the new changesets to Trac;\". Sounds like this is exactly what would be needed to allow PRs from github.\n I couldn't find anything on how to install trac plugins here on sage.\n \n+Related:\n \n+- #30363: Migrate to GitHub\n``````\n",
    "created_at": "2021-03-27T23:27:44Z",
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486927",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486929",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486930",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486931",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486932",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486933",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30406#issuecomment-486934",
    "user": "https://github.com/mkoeppe"
}
```
