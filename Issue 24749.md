...
```json
{
    ...
    "title": "Possible bug in Integer's fast_tp_new causing subtle test failure",
    "type": "issue",
...
```json
{
    "body": "We should also consider the possibility of a bug in Cygwin, as this has not been observed on other platforms.",
    "created_at": "2018-03-15T10:56:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346984",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346985",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Can you compile the Sage library with `-O0 -g` just to check for a potential compiler bug? You will need to do `rm -rf src/build` first.",
    "created_at": "2018-03-15T13:05:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346987",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "I'll give that a try in a bit.  A compiler bug is also certainly a possibility.  This is gcc 6.4.0.",
    "created_at": "2018-03-15T13:18:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346988",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "It's not possible that there'd be anywhere in Sage where it creates Integer objects while the GIL is released, is there?",
    "created_at": "2018-03-15T13:31:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346989",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "More generally, I think that Sage never releases the GIL. Libraries used by Sage (e.g. Numpy) might.",
    "created_at": "2018-03-15T13:38:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346990",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Specifically this is inside `fast_mul` which is doing some pretty heavy creation and destruction of Integers.  If I just run the same code manually at the prompt and hit Ctrl-C, depending on exactly where it is `fast_mul`, sometimes I just get a `KeyboardInterrupt` raised from cysignals, or sometimes my `RuntimeError` gets raised.",
    "created_at": "2018-03-15T14:31:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346992",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346993",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346994",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Yes.  Then at some point the `_mpz_realloc` I mentioned above sets the pointer to the same address as one of the existing (presumably unused) integers in the pool.",
    "created_at": "2018-03-15T16:09:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346995",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Something else to try (just shooting in the dark here): explicitly call `sage.ext.memory.init_memory_functions()` before doing your tests.",
    "created_at": "2018-03-15T16:20:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346997",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346998",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-346999",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Does the cysignals testsuite pass (`./sage -f -c cysignals`)? Does anything change if cysignals (and the Sage library) is compiled with `-O0`?",
    "created_at": "2018-03-15T18:53:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347000",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "In other to narrow the problem down, it would be good to know if it matters whether cysignals is compiled with `-O0` or whether the Sage library is compiled with `-O0`.",
    "created_at": "2018-03-16T14:12:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347002",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347003",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347004",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347005",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "OK, so the problem persists with `-O0`. Good, so it looks like a real bug (either in Sage, cysignals, MPIR or Cygwin).",
    "created_at": "2018-03-16T14:17:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347006",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Yes, likely one of those four things--probably not the compiler though I wouldn't rule it out completely.",
    "created_at": "2018-03-16T14:20:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347007",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347008",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "I'm still doing more testing, but I seem to have fixed it by wrapping any call to `_mpz_realloc` *and* anything that *calls* `_mpz_realloc` with `sig_block/unblock()`.  But a better solution would be nice since the category of \"anything that calls `_mpz_realloc`\" includes most `mpz_` functions.",
    "created_at": "2018-03-16T15:41:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347010",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "I'm afraid that this is essentially an unsolvable problem. It's well known that `longjmp()` (used by cysignals) can mess up the internal state of objects. In cysignals, I implemented safe memory allocation functions like `sig_malloc()` because those were the most common source of breakage. But of course, things can break in other ways.",
    "created_at": "2018-03-16T15:51:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347011",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347013",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347015",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347018",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Just writing down a thought before I forget: temporarily disable the integer pool following an exception from cysignals, possibly even clear it. Only re-enable next time an Integer is explicitly created. Might be nice to have an alternative to `sig_on()` that can register an error callback (without having to write an explicit try/except)",
    "created_at": "2018-03-16T22:34:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347019",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347020",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "cysignals could run a gc cycle after interrupt and have a boolean flag to tell c/cython code that we are currently in this \"dangerous\" gc cycle. This seems to be a reasonable cysignals feature, allowing users to react to possibly inconsistent C data structueres. \n\nThe integer pool could use that to not recycle `mpz_t`.",
    "created_at": "2018-03-17T23:57:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347021",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347022",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347024",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Otherwise, I think that's a pretty acceptable solution.  It *could* lead to memory leaks, but the present situation is no better in that regard.  And we can guess this will probably be a rare situation ...",
    "created_at": "2018-03-19T11:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347026",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347027",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347028",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "That brings me back to my earlier point that it would be very helpful to be able to wrap/override `_mpz_realloc` since that's worst offender with respect to memory allocations inside most mpz functions (mostly called to extend the limbs array to make room for the result).",
    "created_at": "2018-03-19T13:34:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347029",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347030",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "By the way, I tried to reproduce this problem on Linux by adding an artificial delay in `sage_sig_realloc` (to increase the chances of the alarm happening there). Unfortunately, it could not reproduce the Cygwin problem. Maybe `realloc()` is more hardened against this?",
    "created_at": "2018-03-19T20:09:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347031",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347033",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "I'd certainly like to fix this in cysignals. However, I have lately been bitten by various breakages of cysignals on various platforms, so I'd like to improve the continuous integration of cysignals first. If you know of a free CI service that lets you run Python code on platforms other than Linux x86_64, let me know :-)",
    "created_at": "2018-03-20T12:43:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347035",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "OSX is still tricky, though I think Travis-CI has it now?\n\nI can set up CI for cysignals on Cygwin if you want.",
    "created_at": "2018-03-20T12:51:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347036",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347037",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Julian R\u00fcth suggested to try conda for Travis CI on OS X. I'll try that.",
    "created_at": "2018-03-20T12:57:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347038",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347039",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347040",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "You may also be interested in https://github.com/sagemath/cysignals/pull/76 which is about a work-in-progress native Windows port of cysignals, using mingw64.",
    "created_at": "2018-03-20T19:22:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347041",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347042",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62674"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347043",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62675"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62676"
}
```
...
```json
{
    "body": "Conceivably doable.  This will likely never have a perfect fix, but if we can get the `sig_occurred()` feature in cysignals it will help.",
    "created_at": "2018-07-18T11:53:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347044",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347045",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62677"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62678"
}
```
...
```json
{
    "body": "This doesn't quite work yet because `sig_occurred()` is being called with a live exception. Since `sig_occurred()` may call `gc.collect()`, this means trouble.\n\nReally, `sig_occurred` should check for `PyErr_Occurred()` which is both an optimization and a protection against doing GC with an exception set.\n\n---\nNew commits:",
    "created_at": "2018-12-17T15:02:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347046",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347047",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347048",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62679"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347049",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347050",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Did you do anything about comment:70?  It's not clear what you did to address this, if anything.  Does cysignals 1.8.1 fix this?",
    "created_at": "2019-01-07T13:56:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347051",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347052",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347054",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Okay, great.  I'm testing now on Cygwin, and will give positive review assuming it passes.  \n\nAlso need to make sure cysignals 1.8.1 lands in Debian but that's no reason to hold up the ticket.",
    "created_at": "2019-01-07T14:07:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347055",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347056",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Been running this test in a loop for more than an hour now with no crash.  Of course, this still isn't 100% fool-proof but it's definitely much better.",
    "created_at": "2019-01-07T15:36:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347057",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347058",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347059",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "So this is genuinely breaking docbuild tests somehow. That's bizarre...",
    "created_at": "2019-01-17T20:50:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347060",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "In fact, the test already fails on Python 3 with vanilla Sage 8.6.",
    "created_at": "2019-01-17T22:11:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347062",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347063",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/24749#event-62681"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24749#issuecomment-347064",
    "user": "https://github.com/vbraun"
}
```
