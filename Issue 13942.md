# Issue 13942: Warn when creating number fields with non-monic-integral polynomials
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13942#event-39910"
}
```
...
```json
{
    ...
    "milestone": "sage-duplicate/invalid/wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13942#event-39911"
}
```
...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13942#event-39912"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13942",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13942#event-39913"
}
```
