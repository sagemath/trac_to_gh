...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90892",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90893",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "I'd like to review this but for some reason it doesn't apply for the `implicit_plot3d` part.  I can't figure out where the lines 230-232 in the patch come from - the file doesn't seem to have been changed in quite some time, according to hg, and 4.5.2.rc1 doesn't have this. \n\nBy the way, I am *very* curious about *why* this fixes it!  Does smooth require differentiating?",
    "created_at": "2010-08-05T20:44:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90894",
...
```json
{
    "body": "Or does this depend on #9482, as I now realize?",
    "created_at": "2010-08-05T20:46:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90895",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90896",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90897",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90898",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90899",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90901",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "I'm taking care of adding that content.  It's really silly this took so long, but I didn't know whether Carl would do that.   It's just some comments, so positive review!  It still applies :)",
    "created_at": "2011-06-14T03:31:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90902",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90903",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90904",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9483#event-9635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9483#issuecomment-90905",
    "user": "https://github.com/jdemeyer"
}
```
