...
```json
{
    "body": "Using version 9.1 of sage, it seems that `_polynomial_`list(), written in the file: /sage/src/sage/rings/padics/padic_ZZ_pX_CR_element.pyx, sometimes returns wrong results:\n\n```\nsage: T.<a> = Qp(5).extension(x^2-5)\nsage: T(1/5)._polynomial_list()\n[5 + O(5^20)]\nsage: T(a^-800)._polynomial_list()\n[O(5^20)]\nsage: T(25)._polynomial_list()\n[5^2 + 3*5^21 + O(5^22)]\n```\n\nThe first 2 problems are fixed by:\n* changing direction of shifting: substituting the >> sign by <<. This makes sense, as the function `_ntl_rep_`abs() specifies in its documentation that p<sup>k</sup> should be multiplied (rather then divided) by. The previous doctest only tested cases in which k==0, so no shifting was needed.\n* Specifying the precision of the elements to be such that they have the desired precision **after** the shifting.\n\nHowever, the third problem was not solved.\n\nNote: I did not add a doctest for the case where e == 1, because I couldn't think of any eisenstein extension with such property, and if I understand correctly, this implementation of `_polynomial_`list() is only used for eisenstein extensions.\n\n**Keywords:** shift, _polynomial_list\n\n**Branch/Commit:** [1c02c6081226c39c1ca3f485496b14302376f799](https://github.com/sagemath/sagetrac-mirror/commit/1c02c6081226c39c1ca3f485496b14302376f799)\n\n**Reviewer:** Travis Scrimshaw\n\n**Author:** Noa Viner\n\n**Resolution:** fixed\n\nIssue created by migration from https://trac.sagemath.org/ticket/29925\n\n",
...
```
Using version 9.1 of sage, it seems that `_polynomial_`list(), written in the file: /sage/src/sage/rings/padics/padic_ZZ_pX_CR_element.pyx, sometimes returns wrong results:
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588111",
    "user": "https://github.com/n-vi"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n-Using version 9.1 of sage, it seems that `_polynomial_`list(), written in the file: /sage/src/sage/rings/padics/padic_ZZ_pX_CR_element.py, sometimes returns wrong results:\n+Using version 9.1 of sage, it seems that `_polynomial_`list(), written in the file: /sage/src/sage/rings/padics/padic_ZZ_pX_CR_element.pyx, sometimes returns wrong results:\n \n ```\n sage: T.<a> = Qp(5).extension(x^2-5)\n@@ -11,9 +11,9 @@\n ```\n \n The first 2 problems are fixed by:\n-* changing direction of shifting: substituting the >> sign by <<. This makes sense, as the function `_ntl_rep_`abs specifies in its documentation that p<sup>k</sup> should be multiplied (rather then divied) by.\n+* changing direction of shifting: substituting the >> sign by <<. This makes sense, as the function `_ntl_rep_`abs() specifies in its documentation that p<sup>k</sup> should be multiplied (rather then divided) by. The previous doctest only tested cases in which k==0, so no shifting was needed.\n * Specifying the precision of the elements to be such that they have the desired precision **after** the shifting.\n \n However, the third problem was not solved.\n \n-Note: I did not add a doctest for the case where e == 1, because I couldn't think of any eisenstein extension with such property.\n+Note: I did not add a doctest for the case where e == 1, because I couldn't think of any eisenstein extension with such property, and if I understand correctly, this implementation of `_polynomial_`list() is only used for eisenstein extensions.\n``````\n",
    "created_at": "2020-06-21T13:43:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588112",
    "user": "https://github.com/n-vi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588113",
    "user": "https://github.com/n-vi"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\n**New commits:**\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/1c02c6081226c39c1ca3f485496b14302376f799\">1c02c60</a></td><td><code>Fix shifting issues in `_polynomial_`list()</code></td></tr></table>\n",
    "created_at": "2020-06-21T13:43:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588114",
    "user": "https://github.com/n-vi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588115",
    "user": "https://github.com/n-vi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588116",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588117",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588118",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588119",
    "user": "https://github.com/n-vi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588120",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29925#issuecomment-588121",
    "user": "https://github.com/vbraun"
}
```
