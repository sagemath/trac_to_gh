...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391469"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391472"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29773#issuecomment-472880",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29773",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29773#issuecomment-472881",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29773",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29773#event-391476"
}
```
