...
```json
{
    "body": "<a id='comment:1'></a>The second example is definitely broken since `K(2) == K1(2)` is `True`.",
    "created_at": "2020-04-19T14:29:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576769",
    "user": "https://github.com/videlec"
}
```

<a id='comment:1'></a>The second example is definitely broken since `K(2) == K1(2)` is `True`.
...
```json
{
    "body": "<a id='comment:3'></a>I think the best way to solve this is to implement sections of number field morphisms\n\n```\nsage: K.coerce_map_from(K1)\nGeneric morphism:\n  From: Cyclotomic Field of order 3 and degree 2\n  To:   Cyclotomic Field of order 12 and degree 4\n  Defn: z1 -> z^2 - 1\nsage: K.coerce_map_from(K1).section() # should be the partial map K1 -> K\n```",
    "created_at": "2020-04-19T14:41:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576771",
    "user": "https://github.com/videlec"
}
```

<a id='comment:3'></a>I think the best way to solve this is to implement sections of number field morphisms
...
```json
{
    "body": "<a id='comment:5'></a>So clearly `CyclotomicField._coerce_from_other_cyclotomic_field()` is broken. It looks like someone tried to fix this earlier (possibly many years ago by now), but that caused a bunch of broken doctests in modular forms and so they gave up.\n\nIt may be that this code predates the current coercion model and thus would need an overhaul to bring it inline with what we do elsewhere. Cc'ing roed since he'll know whether or not this is true.",
    "created_at": "2020-04-19T14:49:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576773",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:5'></a>So clearly `CyclotomicField._coerce_from_other_cyclotomic_field()` is broken. It looks like someone tried to fix this earlier (possibly many years ago by now), but that caused a bunch of broken doctests in modular forms and so they gave up.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29511#event-75261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576774",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576775",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576776",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Here is a patch based on vdelecroix's observation about `preimage` already being implemented for a homomorphism of cyclotomic fields. I ran some tests, but I really need to see a patchbot run for this because it's such a basic operation.\n\n---\nNew commits:",
    "created_at": "2020-08-12T01:03:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576777",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:8'></a>Here is a patch based on vdelecroix's observation about `preimage` already being implemented for a homomorphism of cyclotomic fields. I ran some tests, but I really need to see a patchbot run for this because it's such a basic operation.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576778",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576780",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576781",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576782",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576783",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576784",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576785",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29511#event-75262"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29511",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29511#issuecomment-576786",
    "user": "https://github.com/vbraun"
}
```
