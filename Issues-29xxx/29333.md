...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29333#event-385053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29333#event-385054"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29333#event-385055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29333#event-385056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29333#issuecomment-463102",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29333#issuecomment-463103",
    "user": "https://github.com/dcoudert"
}
```
