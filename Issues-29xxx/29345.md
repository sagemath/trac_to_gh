...
<a id='comment:26'></a>And here are already merged upstream fixes for[comment:20](#comment%3A20) problem
...
<a id='comment:53'></a>Replying to [mjo](#comment%3A23):
> New commits fix the `break` statements and probably lrcalc.
