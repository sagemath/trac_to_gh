...
```json
{
    "body": "<a id='comment:2'></a>and so what ?",
    "created_at": "2020-06-26T11:19:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29996#issuecomment-450643",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:2'></a>and so what ?
...
```json
{
    "body": "<a id='comment:3'></a>Well, at least in `FiniteLatticePoset.congruences_lattice` we expect to be able to create set partitions of arbitrary sets:\n\n```\nsage: P = posets.AntichainPoset(2)\nsage: L = LatticePoset(P.with_bounds())\nsage: L.congruences_lattice()\n...\nTypeError: unsupported operand parent(s) for <: 'Integer Ring' and '<class 'str'>'\nsage: L.relabel().congruences_lattice()\nFinite lattice containing 4 elements\n```\n(personally, I also create set partitions of arbitrary sets quite frequently)",
    "created_at": "2020-06-26T11:29:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29996#issuecomment-450644",
    "user": "https://github.com/mantepse"
}
```

<a id='comment:3'></a>Well, at least in `FiniteLatticePoset.congruences_lattice` we expect to be able to create set partitions of arbitrary sets:
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77080"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77081"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77082"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29996",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29996#issuecomment-450645",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77083"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77084"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77085"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77086"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77087"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77088"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77089"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29996#event-77090"
}
```
