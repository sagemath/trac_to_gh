...
```json
{
    "body": "<a id='comment:1'></a>Would that be `gambit`, `numpy` and `pillow`?\n\nAnd is this how to find them?\n\n```\n$ git grep \"setup.py\" build/pkgs\n```",
    "created_at": "2020-05-09T23:21:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441670",
    "user": "https://github.com/slel"
}
```

<a id='comment:1'></a>Would that be `gambit`, `numpy` and `pillow`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441671",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>... Also consider pipenv + pipfile as suggested in #30317 ...",
    "created_at": "2020-08-30T19:31:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441672",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:5'></a>... Also consider pipenv + pipfile as suggested in #30317 ...
...
```json
{
    "body": "<a id='comment:7'></a>I would prefer not to have two separate package installation and management systems.  If the only motivation of this is the race condition, like I said this can be solved with an additional file lock to prevent multiple Python packages from being installed simultaneously.",
    "created_at": "2020-09-01T13:16:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441673",
    "user": "https://github.com/embray"
}
```

<a id='comment:7'></a>I would prefer not to have two separate package installation and management systems.  If the only motivation of this is the race condition, like I said this can be solved with an additional file lock to prevent multiple Python packages from being installed simultaneously.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441674",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441675",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441676",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441677",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441678",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441679",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441680",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Narrowed the scope of the ticket.",
    "created_at": "2020-09-08T02:31:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441681",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:15'></a>Narrowed the scope of the ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441682",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441683",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441684",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441685",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Replying to [comment:1 slelievre]:\n> Would that be `gambit`, `numpy` and `pillow`?\n> \n> And is this how to find them?\n> \n> ```\n> $ git grep \"setup.py\" build/pkgs\n> ```\n\nYes, still need to take care of these.",
    "created_at": "2020-09-08T05:46:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441686",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:20'></a>Replying to [comment:1 slelievre]:
> Would that be `gambit`, `numpy` and `pillow`?
> 
> And is this how to find them?
> 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441687",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441688",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441689",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441690",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441691",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441692",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>- Why `sdh_store_and_pip_install_wheel requires . as only argument`? Why not just call it with no arguments?\n\n- This function should be documented in `developer/packaging.rst`.\n\n- Does `sage-pip-uninstall` leave the old wheels lying around?\n\n- Typo in `sage-pip-uninstall` (copied from `sage-pip-install`): \"this command hould use\"",
    "created_at": "2020-09-17T00:32:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441693",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:28'></a>- Why `sdh_store_and_pip_install_wheel requires . as only argument`? Why not just call it with no arguments?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441694",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441695",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441696",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441697",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Seems okay to me, and it built and passed tests before, so I think it's okay. Of course, I can [no longer build Sage](https://trac.sagemath.org/ticket/30494#comment:9) anymore, so perhaps take this review with a grain of salt.",
    "created_at": "2020-09-18T03:16:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441698",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:32'></a>Seems okay to me, and it built and passed tests before, so I think it's okay. Of course, I can [no longer build Sage](https://trac.sagemath.org/ticket/30494#comment:9) anymore, so perhaps take this review with a grain of salt.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441699",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441700",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441701",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441702",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441703",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441704",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "<a id='comment:39'></a>Follow-up: #30771",
    "created_at": "2020-10-15T04:26:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441705",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:39'></a>Follow-up: #30771
...
```json
{
    "body": "<a id='comment:40'></a>I'm not really sure what the advantage is of this complication. For the follow-up do you propose eliminating the installation manifests installed to `/var/lib/sage/installed/`? I would very much prefer to not do that. I see no reason for Python packages to be arbitrarily treated differently in this regard. But I'm not sure if that is really the plan.",
    "created_at": "2020-10-22T13:33:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441706",
    "user": "https://github.com/embray"
}
```

<a id='comment:40'></a>I'm not really sure what the advantage is of this complication. For the follow-up do you propose eliminating the installation manifests installed to `/var/lib/sage/installed/`? I would very much prefer to not do that. I see no reason for Python packages to be arbitrarily treated differently in this regard. But I'm not sure if that is really the plan.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441707",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29500#issuecomment-441708",
    "user": "https://github.com/mkoeppe"
}
```
