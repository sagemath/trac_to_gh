...
```json
{
    "body": "<a id='comment:1'></a>The practice of testing third-party software from within Sage's doctests is going to cause these problems more and more frequently. (I myself am guilty of adding doctests for maxima regressions to sage.)\n\nIn this case, why is the sage library testing the sqlite3 executable at all? The library doesn't use it. If anything, it belongs in a sqlite3 spkg-check... but I'm sure sqlite3's own test suite already ensures that the thing runs.\n\nMy suggestion: delete these tests.",
    "created_at": "2020-01-28T12:51:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29092#issuecomment-407664",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:1'></a>The practice of testing third-party software from within Sage's doctests is going to cause these problems more and more frequently. (I myself am guilty of adding doctests for maxima regressions to sage.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29092#issuecomment-407665",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29092#issuecomment-407666",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73754"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73755"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73756"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29092#issuecomment-407667",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73757"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73758"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73759"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73760"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73761"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73762"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73763"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73764"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73765"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29092#event-73766"
}
```
