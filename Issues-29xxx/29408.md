...
```json
{
    "body": "<a id='comment:36'></a>\nThis did not work after all, but I have found a solution that seems to work and is reasonably clean.\n\n---\nNew commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[4541e18](https://git.sagemath.org/sage.git/commit?id=4541e189ee189c554512c2948aba7bdea6b02629)|`src/bin/sage-env: Set LDSHARED when CXX is set`|",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[7472971](https://git.sagemath.org/sage.git/commit/?id=747297132ccf36b1c610ccafbef984a403fc39e7)|`build/pkgs/numpy/spkg-install.in: Unset LDSHARED`|",
    "created_at": "2020-03-28T14:42:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29408",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:54'></a>\nNew commits:\n|                                                                                                                                          |                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[bcb7534](https://git.sagemath.org/sage.git/commit?id=bcb753409f879151616cb022be8a35247f4be2e0)|`Add -pthread to LDSHARED`|",
    "created_at": "2020-04-01T03:01:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29408",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:59'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|\n|[e4056f0](https://git.sagemath.org/sage.git/commit/?id=e4056f05b37a5bae7ceca18992ee91a502089259)|`Set LDSHARED only on OSX`|",
...
```json
{
    "body": "<a id='comment:62'></a>\nrebased on 9.1.beta9\n\n---\nNew commits:\n|                                                                                                                                          |                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|\n|[7a6238e](https://git.sagemath.org/sage.git/commit?id=7a6238eed2ab25519b1b40061dc3803e3163c581)|`src/bin/sage-env: Set LDSHARED when CXX is set`|\n|[cbe7a1e](https://git.sagemath.org/sage.git/commit?id=cbe7a1e9c6724d1ae9ae0f5b26c218c967a915e5)|`build/pkgs/numpy/spkg-install.in: Unset LDSHARED`|\n|[089d2a2](https://git.sagemath.org/sage.git/commit?id=089d2a2ea8aa64a2bf7bafb77094f9d9e73e3cd7)|`Add -pthread to LDSHARED`|\n|[96a599c](https://git.sagemath.org/sage.git/commit?id=96a599c5ff3802bd77f63688d859aa689c3f5fe1)|`Set LDSHARED only on OSX`|",
...
```json
{
    "body": "<a id='comment:66'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|\n|[f721740](https://git.sagemath.org/sage.git/commit/?id=f721740d1e85cc6f503d5b0fba01bdcbc4e9f97e)|`build/pkgs/python3/spkg-configure.m4: Also check whether C++ extensions can be built`|\n|[8317c3e](https://git.sagemath.org/sage.git/commit/?id=8317c3eb7729c06aeace618726808d6342fda046)|`Undo #21175: Set ARCHFLAGS only when compiling Perl modules`|",
