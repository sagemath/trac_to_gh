...
```json
{
    "body": "<a id='comment:20'></a>\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[f6341db](https://git.sagemath.org/sage.git/commit?id=f6341dbf62b8726f55080bc2198f3c3c952ba5ff)|`build/pkgs/pari/spkg-configure.m4: Add test for bnfisunit bug`|\n|[c4a0a22](https://git.sagemath.org/sage.git/commit?id=c4a0a22a9b6a47df266b9f06dbb0c8ae2e9ebf41)|`build/pkgs/pari/spkg-configure.m4: Re-enable main PARI test (lost in SAGE_SPKG_CONFIGURE macro change); remove duplicate AC_MSG`|",
