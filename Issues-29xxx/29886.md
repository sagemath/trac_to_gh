...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------|\n|[1b38de3](https://git.sagemath.org/sage.git/commit/?id=1b38de3b2ce0c4449e1826575d40ad2b3f582ad8)|`fixed formatting`|\n|[9b5145b](https://git.sagemath.org/sage.git/commit/?id=9b5145b551a552ece2f31c0cf6a42b7c10d08f89)|`removed trailing whitespaces`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|\n|[08fc893](https://git.sagemath.org/sage.git/commit/?id=08fc8931f350c764b29aa1f76ac2a504de7cac5b)|`fixed more code formatting; allow f=None for nomal symmetric matrices`|",
