...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29798#issuecomment-473199",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29798#issuecomment-473200",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29798#issuecomment-473201",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29798#issuecomment-473202",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29798#issuecomment-473203",
    "user": "https://github.com/cduston44"
}
```
