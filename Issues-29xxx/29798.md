...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29798#issuecomment-584330",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29798#issuecomment-584331",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29798#issuecomment-584332",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Are package lists going to be the same for `slackware` and `slackware-multilib`?",
    "created_at": "2020-07-12T15:57:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29798#issuecomment-584333",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:3'></a>Are package lists going to be the same for `slackware` and `slackware-multilib`?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29798#issuecomment-584334",
    "user": "https://github.com/cduston44"
}
```
