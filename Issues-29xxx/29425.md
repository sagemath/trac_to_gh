...
```json
{
    "body": "<a id='comment:47'></a>\nAn upgrade ticket like this really needs to be run on the [GitHub](../wikis/GitHub) test infrastructure...",
