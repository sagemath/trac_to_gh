...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29515#issuecomment-467072",
    "user": "https://github.com/thierry-FreeBSD"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29515#issuecomment-467073",
    "user": "https://github.com/thierry-FreeBSD"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29515#event-387699"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29515#event-387700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29515#event-387701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29515",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29515#event-387702"
}
```
