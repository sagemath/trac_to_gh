...
<a id='comment:12'></a>Replying to [comment:9 gh-mwageringel]:
> ...  if Sage could be configured to source it during the build process.
...
```json
{
    "body": "<a id='comment:15'></a>I would suggest waiting until #29507 is resolved, instead of adding this message now and then possibly changing it after #29507. (But if others feel strongly that it should go in now, I won't object. I like the wording in comment:11.)",
...
<a id='comment:15'></a>I would suggest waiting until #29507 is resolved, instead of adding this message now and then possibly changing it after #29507. (But if others feel strongly that it should go in now, I won't object. I like the wording in comment:11.)
...
<a id='comment:28'></a>Replying to [comment:19 jhpalmieri]:
> I still don't see the message at the end of `./configure`, though, when I have installed all of the recommended packages:
> 
> ```
> $ ./configure
...
<a id='comment:30'></a>Replying to [comment:19 jhpalmieri]:
> I think it will still be an FAQ, since people are not in the habit of running `./configure` before running `make`.
