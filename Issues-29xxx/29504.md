...
Replying to [@jhpalmieri](https://github.com/sagemath/sage/issues/29504#comment:0):
> When homebrew is detected, the "hints" at the end of running `./configure` should suggest running the script `.homebrew-build-env`.
