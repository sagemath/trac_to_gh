...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29588#event-75548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578747",
...
```json
{
    "body": "<a id='comment:2'></a>Actually, this problem was caused by a mix between pari being built by Sage, and a linkage with libpari.so provided by the system package.\n\nThe root cause of this error is a bug in pari's spkg-configure.m4: see #28242#comment:53",
    "created_at": "2020-04-27T20:56:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578748",
    "user": "https://github.com/thierry-FreeBSD"
}
```

<a id='comment:2'></a>Actually, this problem was caused by a mix between pari being built by Sage, and a linkage with libpari.so provided by the system package.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29588#event-75549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29588#event-75550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578749",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Possibly relevant:\n\n- #31474: Upgrade: cysignals 1.10.3",
    "created_at": "2021-03-22T03:03:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578750",
    "user": "https://github.com/slel"
}
```

<a id='comment:5'></a>Possibly relevant:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578751",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>If solved elsewhere please give positive review\nso this can be closed.",
    "created_at": "2021-03-22T03:05:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578752",
    "user": "https://github.com/slel"
}
```

<a id='comment:6'></a>If solved elsewhere please give positive review
so this can be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578753",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578754",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578755",
    "user": "https://github.com/slel"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Let us close this if no longer an issue.",
    "created_at": "2021-08-19T22:32:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578756",
    "user": "https://github.com/slel"
}
```

<a id='comment:7'></a>Let us close this if no longer an issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29588#event-75551"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29588#issuecomment-578757",
    "user": "https://github.com/mkoeppe"
}
```
