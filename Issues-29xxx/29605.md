...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                      |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|\n|[d87d4e0](https://git.sagemath.org/sage.git/commit/?id=d87d4e00c1660626c1389bf75dd52286f43aad43)|`trac 29605: fixed the last remaining failing doctest`|",
    "created_at": "2020-04-28T08:49:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29605",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|\n|[6800403](https://git.sagemath.org/sage.git/commit/?id=68004038f3bb392291e2e28ddf6dafb35a1d5ef1)|`trac 29605: Fixed bug in the base case when self is a tree + added corresponding doctest + simplified method`|",
    "created_at": "2020-05-01T08:31:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29605",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[14bcaca](https://git.sagemath.org/sage.git/commit/?id=14bcaca22d72849e89860691fb43229a90c194b8)|`fixed patchbot warning in graph_plot.py`|",
    "created_at": "2020-05-02T09:29:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29605",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nI rebased the ticket on 9.2.beta1, fixed merge conflicts and added a missing doctest.\n\n---\nNew commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[053c5cc](https://git.sagemath.org/sage.git/commit?id=053c5cc154ffa260fbae1db97dbfa3bbc6e571f8)|`trac #29605: fix merge conflicts and add a missing test`|",
    "created_at": "2020-06-20T07:45:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29605",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[3f5abed](https://git.sagemath.org/sage.git/commit/?id=3f5abedf9706ff2c73872777722f327808301230)|`trac #29605: improve alignment in graph_plot.py`|",
    "created_at": "2020-06-20T08:02:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29605",
    "type": "issue_comment",
