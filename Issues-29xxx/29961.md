...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29961#issuecomment-476778",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267464"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267465"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267466"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29961#issuecomment-476779",
...
```json
{
    ...
    "asset_name": "crash_kvq1b27w.log",
    "asset_url": "tarball://root/attachments/ticket29961/crash_kvq1b27w.log",
    "created_at": "2021-06-01T06:59:57Z",
    "issue": "https://github.com/sagemath/sage/issues/29961",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket29961/crash_kvq1b27w.log",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    "body": "Attachment [crash_kvq1b27w.log](https://github.com/sagemath/sage/files/ticket29961/crash_kvq1b27w.log) by @kliem created at 2021-06-01 06:59:57\n\nrandom_expr crashing",
    "created_at": "2021-06-01T06:59:57Z",
    "issue": "https://github.com/sagemath/sage/issues/29961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29961#issuecomment-476780",
    "user": "https://github.com/kliem"
}
```

Attachment [crash_kvq1b27w.log](https://github.com/sagemath/sage/files/ticket29961/crash_kvq1b27w.log) by @kliem created at 2021-06-01 06:59:57
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29961#issuecomment-476781",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267468"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267469"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267470"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267471"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267472"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267473"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267474"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267475"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29961#event-267476"
}
```
