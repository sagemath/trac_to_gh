...
```json
{
    "body": "<a id='comment:1'></a>perhaps fixing this in ./configure is the most natural thing to do.",
    "created_at": "2020-04-30T05:53:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443786",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:1'></a>perhaps fixing this in ./configure is the most natural thing to do.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443787",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443788",
...
```json
{
    "body": "<a id='comment:4'></a>Yes, we should first define the meaning of these options.",
    "created_at": "2020-05-01T15:33:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443789",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>Yes, we should first define the meaning of these options.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443790",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75677"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75678"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Just got bitten by this again.",
    "created_at": "2021-03-24T19:09:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443791",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:9'></a>Just got bitten by this again.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443792",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>We recently switched the default back to GMP because MPIR is bit-rotting. Being able to choose GMP instead of MPIR had obvious benefits when MPIR was the default. But is there any benefit to being able to use MPIR as an alternative when GMP is the default?",
    "created_at": "2021-03-25T00:35:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443793",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:10'></a>We recently switched the default back to GMP because MPIR is bit-rotting. Being able to choose GMP instead of MPIR had obvious benefits when MPIR was the default. But is there any benefit to being able to use MPIR as an alternative when GMP is the default?
...
```json
{
    "body": "<a id='comment:11'></a>The only reason that comes to mind is that at least one package uses an mpir-specific interface: #30325.\n\nFor Sage 9.3, I would be reluctant to remove MPIR completely. But it would be good to remove this trap in our configure script.",
    "created_at": "2021-03-25T00:39:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443794",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:11'></a>The only reason that comes to mind is that at least one package uses an mpir-specific interface: #30325.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443795",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>For boost, of course, we could just remove the full `boost` package and only offer our cropped version of `boost`. It could be argued again that it's not Sage's job to provide a full `boost` installation. (Our version is ancient in any case)",
    "created_at": "2021-03-28T01:16:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443796",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:13'></a>For boost, of course, we could just remove the full `boost` package and only offer our cropped version of `boost`. It could be argued again that it's not Sage's job to provide a full `boost` installation. (Our version is ancient in any case)
...
```json
{
    "body": "<a id='comment:14'></a>removing full boost is certainly a good idea.",
    "created_at": "2021-03-28T15:11:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443797",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:14'></a>removing full boost is certainly a good idea.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443798",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443799",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75679"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75680"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Moving to 9.4, as 9.3 has been released.",
    "created_at": "2021-05-10T17:42:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443800",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:18'></a>Moving to 9.4, as 9.3 has been released.
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75681"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75682"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I have opened #32549 to remove package `mpir`",
    "created_at": "2021-09-22T03:01:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443801",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:20'></a>I have opened #32549 to remove package `mpir`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443802",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75683"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75684"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443803",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29620#issuecomment-443804",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75685"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75686"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75687"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29620#event-75688"
}
```
