...
```json
{
    "body": "<a id='comment:6'></a>Merged in #28989 again, to fix a merge conflict caused by the latest changes there.",
...
<a id='comment:6'></a>Merged in #28989 again, to fix a merge conflict caused by the latest changes there.
...
<a id='comment:7'></a>Two little changes:
