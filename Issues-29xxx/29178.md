...
```
One can authenticate themselves on the trac server in two ways. Either they have a trac username and password, or via [GitHub](../wikis/GitHub). 
