# Issue 29430: Passing scale=semilogx or loglog to show() produces different results than plot()
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29430#issuecomment-417201",
