...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403033"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403038"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403040"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403041"
}
```
...
```json
{
    ...
    "title_was": "Fix R installation errors related to gfortran",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403044"
}
```
...
```json
{
    ...
    "title_was": "Fix R installation errors related to gfortran, or downgrade R to \"experimental\"",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403046"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29170",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29170#event-403047"
}
```
