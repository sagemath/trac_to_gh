# Issue 29351: FreeBSD: cysignals-1.10.2 compilation error / non-TLS reference since Sage 9.1.rc1
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29351#event-75548"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29351#event-75549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29351#event-75550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29351",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29351#event-75551"
}
```
