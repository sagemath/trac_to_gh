...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|\n|[3b435d9](https://git.sagemath.org/sage.git/commit/?id=3b435d972a72feada67f65a8c96796952a91ac90)|`build/bin/sage-dist-helpers (sdh_store_and_pip_install_wheel): Record name of installed distribution name`|\n|[34bd445](https://git.sagemath.org/sage.git/commit/?id=34bd4459deb61a8430733a3b88a96fd0dbede243)|`sdh_pip_uninstall (sdh_pip_uninstall): New helper functtion; use same flags in 'make SPKG-clean' for pip packages`|\n|[49af8aa](https://git.sagemath.org/sage.git/commit/?id=49af8aa45b40ae471e4748a7f343f8050df6383e)|`build/bin/sage-spkg, build/sage_bootstrap/uninstall.py: Prepare/install/use the spkg-piprm script`|",
...
```json
{
    "body": "<a id='comment:28'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|\n|[ecd49fb](https://git.sagemath.org/sage.git/commit/?id=ecd49fb5900e8cc8139efc3c50b6f8aed14c16df)|`build/bin/sage-dist-helpers, src/doc/en/developer/packaging.rst: Document sdh_pip_uninstall`|",
...
```json
{
    "body": "<a id='comment:29'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[c3eeb69](https://git.sagemath.org/sage.git/commit/?id=c3eeb69f78412ed0d8ad4c7aebdb834b512aad3c)|`build/bin/sage-spkg: Fix typo in comment, unindent a block`|",
    "created_at": "2021-07-08T01:17:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29585",
    "type": "issue_comment",
