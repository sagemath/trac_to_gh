...
```json
{
    "body": "<a id='comment:7'></a>\nHere's a branch to work with.\n\n---\nNew commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[3e9f720](https://git.sagemath.org/sage.git/commit?id=3e9f720994ad63f00d7275e781b9aa1765652dfc)|`trac 29541: matplotlib 3.2.1`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nThis is ready for testing, I think.\n\n---\nNew commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[d21857c](https://git.sagemath.org/sage.git/commit?id=d21857c6a1102cb5085a1edc02323f1938a7f71f)|`trac 29547: fix doctest in root_lattice_realizations.py`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[9a4b89b](https://git.sagemath.org/sage.git/commit/?id=9a4b89bba06a056e3663376e46a4783cfcb7c67a)|`trac 29541: matplotlib 3.2.1`|\n|[cad0196](https://git.sagemath.org/sage.git/commit/?id=cad019632f3d2a8ffc747c1613c54dc9c6f936c0)|`Easy to fix doctests`|\n|[8640711](https://git.sagemath.org/sage.git/commit/?id=86407117a484c3699fe1ee3b1194f47ca9d641b9)|`trac 29547: fix doctest in root_lattice_realizations.py`|\n|[b436dbc](https://git.sagemath.org/sage.git/commit/?id=b436dbcabff07056ae4ea7eaebaf7cb528341cf9)|`trac 29547: rebase and restore upstream_url line in checksums.ini`|",
    "created_at": "2020-04-23T05:15:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29547",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:50'></a>\nGenerally speaking, this patch doesn't affect functionality or behavior in sage. So, from the point of view of distros it is safe. It only deals with a corner case that is not just a sage problem.\n\nBranch done.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|\n|[bb7e259](https://git.sagemath.org/sage.git/commit?id=bb7e259951c508c3279ee02756e12914a911b7fa)|`Add matplotlib upstream patch to deal with memory leaks on OS X. The patch should probably removed in the next matplotlib upgrade.`|",
...
```json
{
    "body": "<a id='comment:64'></a>\nNew commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[9a4b89b](https://git.sagemath.org/sage.git/commit?id=9a4b89bba06a056e3663376e46a4783cfcb7c67a)|`trac 29541: matplotlib 3.2.1`|\n|[cad0196](https://git.sagemath.org/sage.git/commit?id=cad019632f3d2a8ffc747c1613c54dc9c6f936c0)|`Easy to fix doctests`|\n|[8640711](https://git.sagemath.org/sage.git/commit?id=86407117a484c3699fe1ee3b1194f47ca9d641b9)|`trac 29547: fix doctest in root_lattice_realizations.py`|\n|[b436dbc](https://git.sagemath.org/sage.git/commit?id=b436dbcabff07056ae4ea7eaebaf7cb528341cf9)|`trac 29547: rebase and restore upstream_url line in checksums.ini`|\n|[bb7e259](https://git.sagemath.org/sage.git/commit?id=bb7e259951c508c3279ee02756e12914a911b7fa)|`Add matplotlib upstream patch to deal with memory leaks on OS X. The patch should probably removed in the next matplotlib upgrade.`|\n|[eee7843](https://git.sagemath.org/sage.git/commit?id=eee78435a27f2921acc4bd062592ffee9fc17deb)|`trac 29547: use sage-python23 instead of sage-system-python to install`|",
    "created_at": "2020-05-27T22:19:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29547",
    "type": "issue_comment",
