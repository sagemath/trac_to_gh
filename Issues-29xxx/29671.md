...
```json
{
    "body": "<a id='comment:1'></a>Looks like this is an upstream issue:\n\n```\nsage: singular(I).minAssGTZ()\n```\nalso hangs, whereas similar commands like\n\n```\nsage: singular(I).primdecGTZ()\n```\nwork just fine.",
    "created_at": "2020-05-15T04:17:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29671#issuecomment-580839",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:1'></a>Looks like this is an upstream issue:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29671#issuecomment-580840",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29671#issuecomment-580841",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29671#issuecomment-580842",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75857"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75858"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75859"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75860"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75861"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75862"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75863"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75864"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75865"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29671#event-75866"
}
```
