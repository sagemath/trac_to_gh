...
```json
{
    "body": "<a id='comment:2'></a>I just tested under a linux box disabling the tweek we did to prevent the compiler optimization and I get the same error as you point, so it really looks that is the cuplrit.\n\nIn particular, the only line I had to modify is this one:\n\n```\n: ${CXXFLAGS=-O0 -g}\n```\n\n\nIn the `configure.ac` file [1]\n\nMaybe that kind of autotools behaviour is platform-dependent?\n\n\n[1] https://github.com/miguelmarco/SIROCCO2/blob/master/configure.ac#L4\n\n\nP.S. I noticed that you forked the old sirocco repo. The one we are using here is the version 2 one:  https://github.com/miguelmarco/SIROCCO2",
    "created_at": "2020-02-08T11:08:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568612",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:2'></a>I just tested under a linux box disabling the tweek we did to prevent the compiler optimization and I get the same error as you point, so it really looks that is the cuplrit.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568613",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I was able to reproduce this on Linux also by removing `-O0` and setting `-O2` instead.",
    "created_at": "2020-02-10T15:45:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568616",
    "user": "https://github.com/embray"
}
```

<a id='comment:6'></a>I was able to reproduce this on Linux also by removing `-O0` and setting `-O2` instead.
...
```json
{
    "body": "<a id='comment:8'></a>I can also reproduce the problem enabling basic optimizations with `-O1`, so it could be any combination of\n\n```\n-fauto-inc-dec \n-fbranch-count-reg \n-fcombine-stack-adjustments \n-fcompare-elim \n-fcprop-registers \n-fdce \n-fdefer-pop \n-fdelayed-branch \n-fdse \n-fforward-propagate \n-fguess-branch-probability \n-fif-conversion \n-fif-conversion2 \n-finline-functions-called-once \n-fipa-profile \n-fipa-pure-const \n-fipa-reference \n-fipa-reference-addressable \n-fmerge-constants \n-fmove-loop-invariants \n-fomit-frame-pointer \n-freorder-blocks \n-fshrink-wrap \n-fshrink-wrap-separate \n-fsplit-wide-types \n-fssa-backprop \n-fssa-phiopt \n-ftree-bit-ccp \n-ftree-ccp \n-ftree-ch \n-ftree-coalesce-vars \n-ftree-copy-prop \n-ftree-dce \n-ftree-dominator-opts \n-ftree-dse \n-ftree-forwprop \n-ftree-fre \n-ftree-phiprop \n-ftree-pta \n-ftree-scev-cprop \n-ftree-sink \n-ftree-slsr \n-ftree-sra \n-ftree-ter \n-funit-at-a-time\n```",
    "created_at": "2020-02-10T15:57:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568618",
    "user": "https://github.com/embray"
}
```

<a id='comment:8'></a>I can also reproduce the problem enabling basic optimizations with `-O1`, so it could be any combination of
...
```json
{
    "body": "<a id='comment:9'></a>I didn't dig into the details of what specific optimization was the problem. Sorry.",
    "created_at": "2020-02-10T16:08:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568619",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:9'></a>I didn't dig into the details of what specific optimization was the problem. Sorry.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568623",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568624",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568625",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568626",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/embray/ticket-29167\"",
    "created_at": "2020-02-10T18:58:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568627",
    "user": "https://github.com/embray"
}
```

Changing branch from "" to "u/embray/ticket-29167"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568628",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "Changing commit from \"\" to \"35d7703fff39cdd210ced0846c1e8693bb262aa6\"",
    "created_at": "2020-02-10T18:58:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568629",
    "user": "https://github.com/embray"
}
```

Changing commit from "" to "35d7703fff39cdd210ced0846c1e8693bb262aa6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568631",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568632",
    "user": "https://github.com/embray"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I just created a new release in github. The source code is available at https://github.com/miguelmarco/SIROCCO2/releases/download/v2.0.1/libsirocco-2.0.1.tar.gz",
    "created_at": "2020-02-11T14:17:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568633",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:16'></a>I just created a new release in github. The source code is available at https://github.com/miguelmarco/SIROCCO2/releases/download/v2.0.1/libsirocco-2.0.1.tar.gz
...
```json
{
    "body": "<a id='comment:17'></a>Oh shoot, before you made the release I should have pointed out to you the fixes I made for Cygwin.  I forgot to make a PR for them yet.  I will do that now...",
    "created_at": "2020-02-12T17:22:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568634",
    "user": "https://github.com/embray"
}
```

<a id='comment:17'></a>Oh shoot, before you made the release I should have pointed out to you the fixes I made for Cygwin.  I forgot to make a PR for them yet.  I will do that now...
...
```json
{
    "body": "<a id='comment:18'></a>No problem, I can make another release (that is the good thing about numbers: we won't run out of them).",
    "created_at": "2020-02-12T19:31:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568635",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:18'></a>No problem, I can make another release (that is the good thing about numbers: we won't run out of them).
...
```json
{
    "body": "<a id='comment:19'></a>I made a new release on github.\n\nThe tarball is available at https://github.com/miguelmarco/SIROCCO2/releases/download/2.0.2/libsirocco-2.0.2.tar.gz",
    "created_at": "2020-02-16T19:43:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568636",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:19'></a>I made a new release on github.
...
```json
{
    "body": "<a id='comment:20'></a>Erik, are you going to rebase this ticket based on the new release?",
    "created_at": "2020-02-25T01:49:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568637",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:20'></a>Erik, are you going to rebase this ticket based on the new release?
...
```json
{
    "body": "<a id='comment:21'></a>Yes, I've been busy with other things, but I plan to replace this ticket with one to update the sirocco spkg to the new release.",
    "created_at": "2020-03-05T12:19:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568638",
    "user": "https://github.com/embray"
}
```

<a id='comment:21'></a>Yes, I've been busy with other things, but I plan to replace this ticket with one to update the sirocco spkg to the new release.
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29167#event-74063"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Superseded by #29284 which upgrades the SIROCCO SPKG to the new 2.0.2 release, rather than patching.",
    "created_at": "2020-03-06T14:57:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568639",
    "user": "https://github.com/embray"
}
```

<a id='comment:22'></a>Superseded by #29284 which upgrades the SIROCCO SPKG to the new 2.0.2 release, rather than patching.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568640",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29167#event-74064"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29167#issuecomment-568641",
