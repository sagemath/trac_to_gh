...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577483",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577484",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577485",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577486",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577487",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577488",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577489",
...
```json
{
    "body": "<a id='comment:2'></a>Note that this change is backwards incompatible for anyone who was passing `algorithm` to `normal_basis` but not as a keyword. IMO, this is sufficiently unlikely to warrant additional action, but you could do a deprecation warning `if isinstance(degree, str):` to possibly catch this. I leave that choice up to you. Either way you decide, you can set a positive review (after adding the deprecation).",
    "created_at": "2020-04-22T02:38:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577490",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:2'></a>Note that this change is backwards incompatible for anyone who was passing `algorithm` to `normal_basis` but not as a keyword. IMO, this is sufficiently unlikely to warrant additional action, but you could do a deprecation warning `if isinstance(degree, str):` to possibly catch this. I leave that choice up to you. Either way you decide, you can set a positive review (after adding the deprecation).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577491",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577492",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577493",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Thanks for the suggestions. I have implemented them accordingly. Indeed, it is good to keep backward compatibility when possible.",
    "created_at": "2020-04-22T19:07:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577494",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:5'></a>Thanks for the suggestions. I have implemented them accordingly. Indeed, it is good to keep backward compatibility when possible.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577495",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577496",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29543#issuecomment-577498",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29543",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29543#event-75397"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29543#event-75398"
}
```
