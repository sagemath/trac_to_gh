...
```json
{
    "body": "<a id='comment:1'></a>\nI changed the order of the first tests in method `_triangulate` of `schnyder.py`.\n\n---\nNew commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[e688022](https://git.sagemath.org/sage.git/commit?id=e688022665ceb0c54f19cc51fbe9da64c1a89c1f)|`trac #29522: make error messages more consistent`|",
    "created_at": "2020-04-18T10:06:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29522",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[c6ad503](https://git.sagemath.org/sage.git/commit/?id=c6ad5030a366525fe38d26444b1aeb96153927ba)|`trac #29522: handling disconnected graphs in layout_planar`|\n|[9facf50](https://git.sagemath.org/sage.git/commit/?id=9facf503b2ebbfd6cb15a071a7c7b56badb53489)|`trac #29522: doctests`|\n|[9917e8c](https://git.sagemath.org/sage.git/commit/?id=9917e8c404b9901fbfdb5c90b96f13e7f1d42535)|`trac #29522: order of arguments of layout_split + documentation`|",
    "created_at": "2020-04-18T21:13:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29522",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|\n|[374e3bd](https://git.sagemath.org/sage.git/commit/?id=374e3bd0114905024d1f848a2ab6fea728efa28f)|`trac #29522: fixed bug in layout_split with options `on_embedding` and `set_embedding``|\n|[6b882f0](https://git.sagemath.org/sage.git/commit/?id=6b882f0a8351518b1f7e6c5277ea65e808e20da5)|`trac #29522: in layout_planar, handling of small or disconnected graphs move to the beginning of the function`|\n|[2566ee8](https://git.sagemath.org/sage.git/commit/?id=2566ee8dfed7007663334d15ebdc69a21b2be503)|`trac #29522: fixed bug when `on_embedding` is given and the input graph has no `_embedding` attribute`|\n|[4d6f2c3](https://git.sagemath.org/sage.git/commit/?id=4d6f2c3af6eaa7b7586d9860ae24d7545a164d4d)|`trac #29522: doctests`|",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|\n|[e034cbd](https://git.sagemath.org/sage.git/commit/?id=e034cbd904de50c5a633233c2d1053042481ebc3)|`trac #29522: fixed failing doctests`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|\n|[e5ca4f9](https://git.sagemath.org/sage.git/commit/?id=e5ca4f9f3c931a3abc50e261a92070d0c50cd33a)|`trac #29522: added an error message when the input G is not planar and set_embedding=None and on_embedding=None and G._embedding is not set`|\n|[9159384](https://git.sagemath.org/sage.git/commit/?id=9159384a018a1c54bc19b0b41b8f89d35c857e60)|`trac #29522: added test in spring_layout_fast_split`|",
    "created_at": "2020-04-20T08:35:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29522",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[ba68814](https://git.sagemath.org/sage.git/commit/?id=ba688144e7482475e9239bcb2dc4e539781e500e)|`pep8 review commit`|",
