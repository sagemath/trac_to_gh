...
```json
{
    "body": "<a id='comment:5'></a>\nI'm confused--should this say \"GitHub\" in the title or \"GitLab\"?  I don't know of any [GitHub](../wikis/GitHub) CI docker images.",
...
```json
{
    "body": "<a id='comment:17'></a>\nGiven that [GitLab](../wikis/GitLab) Docker build is broken for ages, can we arrange for GitHub-built docker images to be pushed to the main Docker repo,\nor at least create some sort of advertised Docker repo on [GitHub](../wikis/GitHub)?",
