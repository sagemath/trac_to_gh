...
```json
{
    "body": "<a id='comment:1'></a>\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[af221cb](https://git.sagemath.org/sage.git/commit?id=af221cb4ecda0dbd002fa14d2a90d7a9c763c3c7)|`set up the hypercube with both Vrep and Hrep`|\n|[486b0e1](https://git.sagemath.org/sage.git/commit?id=486b0e131f9b77d855897f3725f74f29a9c666fb)|`fixed doctests`|\n|[3942824](https://git.sagemath.org/sage.git/commit?id=3942824ce0bbb1c19e425e306d02b548f0f3ce43)|`fixed more doctests involving order`|",
    "created_at": "2020-02-14T15:25:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29198",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:2'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[8b8abb2](https://git.sagemath.org/sage.git/commit/?id=8b8abb233a2a0c099c3554ec9cb51579fdf6ceb4)|`more doctests`|",
...
```json
{
    "body": "<a id='comment:3'></a>\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[f9958f3](https://git.sagemath.org/sage.git/commit?id=f9958f36466cddff0d5e4fd6c99bf77acb5ab6cf)|`set up the hypercube with both Vrep and Hrep`|\n|[b2b544e](https://git.sagemath.org/sage.git/commit?id=b2b544e26cfcec977b2ce90fff7d9ec8caed6647)|`fixed doctests`|\n|[6ca4267](https://git.sagemath.org/sage.git/commit?id=6ca4267c71eab3b8db005d915b35a982af9ecdbe)|`fixed more doctests involving order`|\n|[86cca93](https://git.sagemath.org/sage.git/commit?id=86cca93a0a31d5f5122ccca6f3b79ed05f6ae7e4)|`more doctests`|\n|[ac0390b](https://git.sagemath.org/sage.git/commit?id=ac0390b6f98185d8eae0e2c196cc32bc3be2b5c8)|`fixed one more test`|",
    "created_at": "2020-02-24T10:11:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29198",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[53b54e2](https://git.sagemath.org/sage.git/commit/?id=53b54e26eb7a1707c69103d6b39f68f24870f22e)|`a new failing doctest`|",
    "created_at": "2020-02-28T10:49:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29198",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[357fcd1](https://git.sagemath.org/sage.git/commit?id=357fcd1f30f90c406b2fcbc4bf8433ff2faf592a)|`set up the hypercube with both Vrep and Hrep`|\n|[91ae9ba](https://git.sagemath.org/sage.git/commit?id=91ae9baed801970849814fcf7d035204dd48686d)|`fixed doctests`|",
    "created_at": "2020-03-02T12:26:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29198",
    "type": "issue_comment",
