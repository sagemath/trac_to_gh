...
```json
{
    "body": "<a id='comment:8'></a>\nNew commits:\n|                                                                                                                                          |                                                                                |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[f0f03c9](https://git.sagemath.org/sage.git/commit?id=f0f03c9e68e90f8fc8a9c63d5793860cd1c3ddf0)|`build/bin/sage-spkg: Remove dead code for manufacturing an spkg-install script`|\n|[46e5f68](https://git.sagemath.org/sage.git/commit?id=46e5f687b745a1ec892d09cec5971b1287e2550d)|`build/bin/sage-spkg: Get rid of USE_LOCAL_SCRIPTS (it was always yes); prepare for script packages`|\n|[fee5bc2](https://git.sagemath.org/sage.git/commit?id=fee5bc2c04387745dbb9b8265ec13be7bcd434e1)|`build/bin/sage-spkg: For script packages, do not poison the proxy variables`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[3ceeaa7](https://git.sagemath.org/sage.git/commit/?id=3ceeaa73f60a4640380015059b50cf30bb74e972)|`build/bin/sage-spkg: Fix up for normal and script packages`|\n|[8c4fb4d](https://git.sagemath.org/sage.git/commit/?id=8c4fb4da757361aeb8a0ac6299425f0a41983497)|`build/bin/sage-spkg: Handle script packages without package-version.txt`|\n|[137365a](https://git.sagemath.org/sage.git/commit/?id=137365af932c9006e5d92150ed5b0e389627c55b)|`build/make/Makefile.in: Replace 'SPKG-clean' by 'SPKG-uninstall', with deprecation`|\n|[a9cbfda](https://git.sagemath.org/sage.git/commit/?id=a9cbfdaba49b4f754ec273aa588185313807217b)|`build/make/Makefile.in: Install script packages using sage-spkg`|\n|[81a63df](https://git.sagemath.org/sage.git/commit/?id=81a63df3107793d067f1bd5a9807bfff8c0cd054)|`src/bin/sage: Use 'make SPKG-uninstall' instead of -clean`|",
    "created_at": "2020-09-24T23:31:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29386",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|\n|[3d6fa59](https://git.sagemath.org/sage.git/commit/?id=3d6fa5924f54b85a28f5c4d969afca01da8801fc)|`build/make/Makefile.in: Replace 'SPKG-clean' by 'SPKG-uninstall', with deprecation, for pip packages too`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[ae5ea98](https://git.sagemath.org/sage.git/commit/?id=ae5ea98908707d8ce3f23603f51b070b117c3892)|`build/make/Makefile.in: Make SPKG-uninstall targets phony`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[47ef805](https://git.sagemath.org/sage.git/commit/?id=47ef805fff45ed166ca2210becf68ba72276eeab)|`WIP: Install pip packages with sage-spkg`|\n|[6c27c05](https://git.sagemath.org/sage.git/commit/?id=6c27c05e64886bfb2133dc70c6f87145eb74fcf5)|`build/make/Makefile.in: Another SPKG-clean -> SPKG-uninstall`|",
    "created_at": "2020-09-25T01:46:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29386",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[9750195](https://git.sagemath.org/sage.git/commit/?id=9750195b6f71ff414c06576a66708b3fbd21365c)|`WIP: Install pip packages with sage-spkg`|\n|[be2417c](https://git.sagemath.org/sage.git/commit/?id=be2417cd48549b2c1a9fa29bcd362b08c2a6fda7)|`Merge tag '9.2.beta14' into t/30657/fix_up__sage__p_`|\n|[8ee7ee2](https://git.sagemath.org/sage.git/commit/?id=8ee7ee29ea4686a968846df1621f52adcd8f4173)|`build/make/install: Set SAGE_SPKG_WHEELS also here so that script packages still work`|\n|[72c5901](https://git.sagemath.org/sage.git/commit/?id=72c59013c7fde5ca457a537402a9b7fb8ef50958)|`Merge branch 't/30657/fix_up__sage__p_' into t/29386/install_script_packages_via_sage_spkg`|\n|[660d689](https://git.sagemath.org/sage.git/commit/?id=660d689c8fc712b813adb19f076aa9d8eeaaccb4)|`Revert \"build/make/install: Set SAGE_SPKG_WHEELS also here so that script packages still work\"`|",
    "created_at": "2020-10-02T02:07:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29386",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|\n|[483b65e](https://git.sagemath.org/sage.git/commit/?id=483b65e5d576a8ceefa574c514353945bf9e303a)|`build/bin/sage-spkg: Remove dead code for manufacturing an spkg-install script`|\n|[445ed7e](https://git.sagemath.org/sage.git/commit/?id=445ed7e10f70899ddc0c44bda203d25f8164a22d)|`build/bin/sage-spkg: Get rid of USE_LOCAL_SCRIPTS (it was always yes); prepare for script packages`|\n|[74f549c](https://git.sagemath.org/sage.git/commit/?id=74f549c1c51471773e4376762006bd9399a3817c)|`build/bin/sage-spkg: For script packages, do not poison the proxy variables`|\n|[20ddd7e](https://git.sagemath.org/sage.git/commit/?id=20ddd7eff31e2e3c34642988ebbbdbda27e47e32)|`build/bin/sage-spkg: Exit with error for some old-style script invocations`|\n|[25d38e9](https://git.sagemath.org/sage.git/commit/?id=25d38e9561d14a9a13aaca825e031018fcdf3a6b)|`build/bin/sage-spkg: Remove error message when checksums.ini does not exist (script package)`|\n|[97c61be](https://git.sagemath.org/sage.git/commit/?id=97c61be1bc28897c14cf927e67862e2102916737)|`build/bin/sage-spkg: Fix up for normal and script packages`|\n|[1b1401d](https://git.sagemath.org/sage.git/commit/?id=1b1401d03133198899e9a791f8a690d28019d7d4)|`build/bin/sage-spkg: Handle script packages without package-version.txt`|\n|[d850e60](https://git.sagemath.org/sage.git/commit/?id=d850e60f4bbb1effe3d713b6e0581db4e61614e8)|`build/make/Makefile.in: Install script packages using sage-spkg`|\n|[7a25d1d](https://git.sagemath.org/sage.git/commit/?id=7a25d1d0b74cf7fe7b29b0169ba2539b323ae04a)|`WIP: Install pip packages with sage-spkg`|",
    "created_at": "2022-07-21T07:01:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29386",
    "type": "issue_comment",
