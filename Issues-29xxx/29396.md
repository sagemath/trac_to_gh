...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[687208d](https://git.sagemath.org/sage.git/commit/?id=687208dd0c6347dc70cbd7bc9180b13047cfeb19)|`same correction in another place`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1 and set ticket back to needs_review. New commits:\n|                                                                                                                                           |                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------|\n|[fcd0354](https://git.sagemath.org/sage.git/commit/?id=fcd0354017150d394f222e5c3b3ed458132b58eb)|`better to use \"not in\"`|",
