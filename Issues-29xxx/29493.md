...
```json
{
    "body": "<a id='comment:12'></a>\nHere's a preliminary branch. I haven't run a ptestlong yet, and you can definitely crash sage if you ignore the warnings and disable the safety net. But I've basically eliminated the need for our custom GLPK error handling, and thus the need for the rejected patch to reset the error state.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[e39cffd](https://git.sagemath.org/sage.git/commit?id=e39cffdeec34349b16ac2412da406a005034b3df)|`Trac #29493: add sanity checks for GLPK's variable bound methods.`|\n|[3fec617](https://git.sagemath.org/sage.git/commit?id=3fec6171cc6cc6e1b3e010730245c8c6ad2470d0)|`Trac #29493: add missing bounds checks for other GLPK backend methods.`|\n|[3a1b741](https://git.sagemath.org/sage.git/commit?id=3a1b74118bdc75d8683b78ea68e71328236da1ff)|`Trac #29493: add bounds checks to GLPK's add_linear_constraint() method.`|\n|[3b75fc0](https://git.sagemath.org/sage.git/commit?id=3b75fc09da94a9797b50b478bf8ab64fda5f7034)|`Trac #29493: add bounds checks to GLPK's get_col_dual() method.`|\n|[51824a6](https://git.sagemath.org/sage.git/commit?id=51824a638343fa3fd1eba23fb77cfcdbc910a8a9)|`Trac #29493: verify input to GLPK row/column tableaux methods.`|\n|[c9507a0](https://git.sagemath.org/sage.git/commit?id=c9507a0f07533f5ba759f20a8c563959b8666cc1)|`Trac #29493: make simplex_then_intopt the default GLPK method.`|\n|[82a7527](https://git.sagemath.org/sage.git/commit?id=82a75279407972529ffc72e18758267efc9fafe2)|`Trac #29493: remove doctest that intentionally crashes GLPK.`|\n|[7d8db10](https://git.sagemath.org/sage.git/commit?id=7d8db103f578fea9b8b12274a3da06d59a45f5e8)|`Trac #29493: remove glpk.error extension module.`|\n|[f5edb44](https://git.sagemath.org/sage.git/commit?id=f5edb44647c5df2f9a16975f19bfab99e0323111)|`Trac #29493: drop rejected GLPK patch.`|",
    "created_at": "2020-06-01T00:27:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29493",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[20e92ef](https://git.sagemath.org/sage.git/commit/?id=20e92efc7775e1fe8246e8a5d1b3cdfcfdc9db09)|`Trac #29493: make simplex_then_intopt the default GLPK method.`|\n|[83ea75a](https://git.sagemath.org/sage.git/commit/?id=83ea75a999a56327232e8a11ed0c00e1b93c5666)|`Trac #29493: remove doctest that intentionally crashes GLPK.`|\n|[c9b9a24](https://git.sagemath.org/sage.git/commit/?id=c9b9a24e499bc5219c8926ba8e1bf5562dc18548)|`Trac #29493: remove glpk.error and glpk.env extension modules.`|\n|[1cc9f61](https://git.sagemath.org/sage.git/commit/?id=1cc9f614374d889eecef7dd0c4772bd5c431b6d5)|`Trac #29493: drop GLPK patch that was rejected by upstream.`|",
    "created_at": "2020-06-02T12:52:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29493",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:43'></a>\nReplying to [mjo](#comment%3A38):\n> If I'm writing a new sage package and if I rely on being able to catch `GLPKError`\n\n\n... this appears to be a documentation issue. I have added a commit that addresses it.\n  \n---\nNew commits:\n|                                                                                                                                          |                                                                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|\n|[83629f5](https://git.sagemath.org/sage.git/commit?id=83629f54979e58d77c1ce7deb5122b90e9ef4b41)|`sage.libs.glpk.error: Add documentation discouraging users from using GLPKError`|\n|[066b1e8](https://git.sagemath.org/sage.git/commit?id=066b1e86daa1b6cf70643a8f72944f9197709dfe)|`setup_glpk_error_handler: Disable doctest that tests the GLPK error recovery patch`|",
    "created_at": "2020-06-09T02:59:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29493",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:47'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|\n|[9427aa1](https://git.sagemath.org/sage.git/commit/?id=9427aa12355b28e359f8d7c263964e8390639d6c)|`src/sage/libs/glpk/error.pyx: Fixup doctest markup`|",
...
```json
{
    "body": "<a id='comment:49'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[28024ac](https://git.sagemath.org/sage.git/commit/?id=28024ac250757dce3b900e28caeacd65c235128e)|`src/sage/libs/glpk/error.pyx: Make doctest more flexible`|",
...
```json
{
    "body": "<a id='comment:51'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |               |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[8acdf34](https://git.sagemath.org/sage.git/commit/?id=8acdf34c0a5179daa4e6ee9ba4fc024b67f18ec2)|`Fixup doctest`|",
