...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380710"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380711"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380712"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380714"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29036#issuecomment-456833",
...
```json
{
    "body": "<div id=\"comment:2\" align=\"right\">Comment 2</div>\n\nWorks for me, too:\n\n```\n% ls\n% tar xf ../../tar-files/sage-9.1.rc2.tar.gz \n% cd sage-9.1.rc2 \n% ./sage -v\nSageMath version 9.1.rc2, Release Date: 2020-04-25\n```\nI suppose it could be a Debian problem, or more generally a problem for the distros. @sagetrac-Snark: Is there a reason to keep this open?",
    "created_at": "2020-05-03T17:29:37Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/29036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29036#issuecomment-456834",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29036#issuecomment-456835",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29036",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380721"
}
```
