...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380706"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29036#event-380709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29036#issuecomment-456836",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29036#issuecomment-456837",
    "user": "https://github.com/jhpalmieri"
}
```
