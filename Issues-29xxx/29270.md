...
<a id='comment:1'></a>Are you looking for the following?
...
<a id='comment:2'></a>Yes, something like that.  But for some reason not every tree from the combinat had this in the tab-completion.
...
```json
{
    "body": "<a id='comment:3'></a>We could have a true tree backend in graphs with implementation of dedicated algorithms and connected to trees in combinat. We already have `BipartiteGraph`...",
...
<a id='comment:3'></a>We could have a true tree backend in graphs with implementation of dedicated algorithms and connected to trees in combinat. We already have `BipartiteGraph`...
