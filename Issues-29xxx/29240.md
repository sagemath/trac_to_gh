...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29240#event-383765"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29240#event-383766"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29240#event-383767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29240#event-383768"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29240#issuecomment-461527",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29240#issuecomment-461528",
    "user": "https://github.com/slel"
}
```
