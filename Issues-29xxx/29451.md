...
```json
{
    "body": "<a id='comment:10'></a>\nRelated previous ticket:\n- #17204: OSX Yosemite libtool version detection\n \n---\nNew commits:\n|                                                                                                                                          |                                                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[79cd878](https://git.sagemath.org/sage.git/commit?id=79cd878b7fa7dac35626596deb488ae390269b79)|`build/pkgs/pari/spkg-install.in: Use fake MACOSX_DEPLOYMENT_TARGET`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |       |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------|\n|[ef6ecf4](https://git.sagemath.org/sage.git/commit/?id=ef6ecf4e857541f253e114ad12d99304627e4eeb)|`fixup`|",
