...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584283",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Upstream IML should be smarter about detecting GMP, it just guesses at `/usr/local/lib` and `/usr/lib` by default.\n\nTo that end: it would be nice if the pkg-config file for gmp included the `-L/usr/libX` flag needed to link against it in the \"Libs\" field. But in the meantime we can probably fake it with...\n\n```\n$ pkg-config --variable=libdir gmp\n/usr/lib64\n```",
    "created_at": "2020-06-05T01:06:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584284",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:4'></a>Upstream IML should be smarter about detecting GMP, it just guesses at `/usr/local/lib` and `/usr/lib` by default.
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584285",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76278"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76279"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76280"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76281"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76282"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76283"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76284"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76285"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>outdated",
    "created_at": "2022-08-31T03:00:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584286",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:10'></a>outdated
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76286"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76287"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584287",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584288",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584289",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29795#event-76288"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29795",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29795#issuecomment-584290",
    "user": "https://github.com/mkoeppe"
}
```
