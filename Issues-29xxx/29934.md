...
<a id='comment:2'></a>And another bug discovered:
...
```json
{
    "body": "<a id='comment:3'></a>Apparently this introduced when improving products.\n\nEdited: No, I can actually trace it back at least to sage 7.4",
...
<a id='comment:3'></a>Apparently this introduced when improving products.
...
```json
{
    "body": "<a id='comment:12'></a>pyflakes has a complaint about unused variable R, but I think it's fine.",
...
<a id='comment:12'></a>pyflakes has a complaint about unused variable R, but I think it's fine.
