...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392003"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392004"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392005"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29808#issuecomment-473588",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29808#issuecomment-473589",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392008"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392010"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29808",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29808#event-392011"
}
```
