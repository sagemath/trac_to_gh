...
```json
{
    "body": "Tests run at https://github.com/mkoeppe/sage/actions/runs/59868244",
...
```json
{
    "body": "lgtm (we still don't know from GH Actions whether tests pass on MacOS, but I suppose it is now for the bots)",
    "created_at": "2020-03-28T02:33:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29378",
    "type": "issue_comment",
