...
```json
{
    "body": "<a id='comment:1'></a>see #29163 ?",
    "created_at": "2020-02-11T18:48:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29179#issuecomment-436340",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:1'></a>see #29163 ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29179#issuecomment-436342",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29179#event-74108"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29179#issuecomment-436343",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Though my comment about testing still stands ... is there some ticket open about testing for the *non*-presence of a package?  This is a desideratum.  I can open one if you don't know of one.",
    "created_at": "2020-02-11T22:43:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29179#issuecomment-436344",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Though my comment about testing still stands ... is there some ticket open about testing for the *non*-presence of a package?  This is a desideratum.  I can open one if you don't know of one.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29179#issuecomment-436345",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29179",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29179#event-74109"
}
```
