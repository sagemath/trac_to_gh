...
```json
{
    "body": "<a id='comment:9'></a>\nconfigure is now happy with my pari. However there is something that I don't understand in [config.log line 2023](https://github.com/sagemath/sage/files/ticket29554/367e5dcecdcd1304473641e939a715b3.log#L2023).  `matpermanent` is not found. Why is there a search for it if it does not matter?",
