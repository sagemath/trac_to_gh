...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401195"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401199"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401200"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461399",
    "user": "https://github.com/TheFool5"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461400",
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401201"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461401",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461402",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461403",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461404",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461405",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461406",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461407",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461408",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401205"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401206"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461409",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401208"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401209"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401210"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461410",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461411",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461412",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461413",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461414",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401215"
}
```
...
```json
{
    "body": "<div id=\"comment:13\" align=\"right\">comment:13</div>\n\nThe PR just adds a doctest to verify that `cot(1 + i).imag().n()` is equal to `(1/tan(1 + i)).imag().n()` (modulo to an error tolerance of `10^-12`). It fails in 9.2:\n\n```\nsage: cot(1 + i).imag().n() - (1/tan(1 + i)).imag().n()\n1.73602828579185\n```\nBut it passes in 9.3:\n\n```\nsage: cot(1 + i).imag().n() - (1/tan(1 + i)).imag().n()\n-1.11022302462516e-16\n```\n\n---\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/275f5b9b0507e1dd9c9cfd83d18b730e22823544\"><code>275f5b9</code></a></td><td><code>trac 29400 add doctest</code></td></tr></table>\n",
    "created_at": "2021-10-09T17:21:32Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461415",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461416",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461417",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401217"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461418",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29400#event-401219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29400",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29400#issuecomment-461419",
