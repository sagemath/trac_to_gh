...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465165",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket29428/Sage_crash_report.txt",
    "created_at": "2020-04-07T09:51:03Z",
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket29428/Sage_crash_report.txt",
    "user": "https://github.com/mmasdeu"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [Sage_crash_report.txt](https://github.com/sagemath/sage/files/ticket29428/Sage_crash_report.txt) by @mmasdeu created at 2020-04-07 09:51:03\n\nI uninstalled my extensions and it seems that the problem persists. Here is a MNWE:\n\n```\nsage: E = EllipticCurve('11a1')\nsage: Et = E.tate_curve(11)\nsage: Et.<TAB>\n```\n\nAfter this, nothing shows up. After a couple of seconds, Sage crashes. I attached the crash report.",
    "created_at": "2020-04-07T09:51:03Z",
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465166",
    "user": "https://github.com/mmasdeu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465167",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465168",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465169",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465170",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket29428/a90c6c4de7fd795ea4f421b224b612e6.png",
    "created_at": "2020-04-25T20:22:29Z",
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket29428/a90c6c4de7fd795ea4f421b224b612e6.png",
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [Screen Shot 2020-04-25 at 11.39.23 AM.png](https://github.com/sagemath/sage/files/ticket29428/a90c6c4de7fd795ea4f421b224b612e6.png) by @mkoeppe created at 2020-04-25 20:22:29\n\nWe had a similar problem with polymake/jupymake. Tab completion in IPython runs in a separate thread. This can break packages that are not prepared for threaded operation.",
    "created_at": "2020-04-25T20:22:29Z",
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465171",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465172",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465173",
    "user": "https://github.com/antonio-rojas"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465174",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29428#issuecomment-465175",
    "user": "https://github.com/jhpalmieri"
}
```
