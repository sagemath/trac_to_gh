...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29681#issuecomment-470634",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29681#issuecomment-470635",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29681#event-390149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29681#event-390150"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29681#event-390151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29681#event-390152"
}
```
