...
```json
{
    "body": "<a id='comment:1'></a>See also [this answer](https://stackoverflow.com/a/60069113/) where the original user found a Sage-native way to do it, though presumably implementing correctly would be better.",
    "created_at": "2020-02-05T18:37:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29151#issuecomment-408824",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>See also [this answer](https://stackoverflow.com/a/60069113/) where the original user found a Sage-native way to do it, though presumably implementing correctly would be better.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29151#issuecomment-408825",
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73971"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73972"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73973"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73974"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29151#issuecomment-408826",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73975"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73976"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73977"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73978"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73979"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73980"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73981"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29151#event-73982"
}
```
