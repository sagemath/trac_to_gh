...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|\n|[f31b6a0](https://git.sagemath.org/sage.git/commit/?id=f31b6a09b38cd9b6e3b9070ab5e20cb605866812)|`src/sage/geometry: Move Extension options from src/module_list.py to distutils directives`|",
    "created_at": "2020-05-18T03:41:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29706",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|\n|[0c0ef43](https://git.sagemath.org/sage.git/commit/?id=0c0ef436367253b44d7c7dce5c30b18c63b79a73)|`src/sage/libs/ntl: Move Extension options from src/module_list.py to distutils directives`|\n|[a4d04d3](https://git.sagemath.org/sage.git/commit/?id=a4d04d34ebec904216fa846f25b03d8a15a996bd)|`src/sage/modular: Move Extension options from src/module_list.py to distutils directives`|\n|[17ca1d7](https://git.sagemath.org/sage.git/commit/?id=17ca1d722dde4293be7daca9043a2d4dce9a03fc)|`src/sage/env.py (cython_aliases): Add aliases for libraries use in module_list.py`|\n|[346bd88](https://git.sagemath.org/sage.git/commit/?id=346bd8887cc45d189a17174107291c72e8b9ad6a)|`src/sage/modules: Move Extension options from src/module_list.py to distutils directives`|",
    "created_at": "2020-05-18T05:09:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29706",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:47'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|\n|[1bfe30d](https://git.sagemath.org/sage.git/commit/?id=1bfe30dffe9128f58c9110c2ebb594e52a7c40f5)|`sage.env.cython_aliases: Another fix for macOS without zlib pc`|",
