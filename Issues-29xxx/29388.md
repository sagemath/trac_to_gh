...
```json
{
    "body": "<a id='comment:2'></a>\nTickets are to propose and discuss changes to [SageMath](../wikis/SageMath). Not to discuss the content of GSoC. For the latter, do use the mailing list https://groups.google.com/forum/#!forum/sage-gsoc",
