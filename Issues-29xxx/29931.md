...
```json
{
    "body": "<a id='comment:1'></a>Attachment [ntl_crash_log](tarball://root/attachments/some-uuid/ticket29931/ntl_crash_log) by @mkoeppe created at 2020-10-24 20:15:01",
    "created_at": "2020-10-24T20:15:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29931",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29931#issuecomment-421140",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:1'></a>Attachment [ntl_crash_log](tarball://root/attachments/some-uuid/ticket29931/ntl_crash_log) by @mkoeppe created at 2020-10-24 20:15:01
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29931",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29931#issuecomment-421141",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76773"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76774"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76775"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76776"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76777"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76778"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76779"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76780"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Still crashing in sage 9.7.rc0",
    "created_at": "2022-09-05T12:39:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29931",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29931#issuecomment-421142",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:6'></a>Still crashing in sage 9.7.rc0
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76781"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29931#event-76782"
}
```
