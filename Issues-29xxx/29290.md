...
```json
{
    "body": "<a id='comment:14'></a>\nhere https://github.com/sagemath/sagetrac-mirror/blob/develop/src/doc/en/developer/portability_testing.rst?id=1f7e16a72e39fb0a154cfb3d4eec1c3cbe9877da#n831 (it's already merged in the latest develop) you can read how to run tests on Cygwin etc via [GitHub](GitHub).\n\nBasically, you need a fork of sage repo on [GitHub](GitHub), then you can make a pull request to the develop branch of your fork from a branch incorporating this ticket, and then in about 12 hours you get the results with tests etc.",
