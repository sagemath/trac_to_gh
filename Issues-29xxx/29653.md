...
archive/attachments_022074.json:
```json
{
...
```json
{
    "body": "**Attachment:** [patch-configure.ac](https://github.com/sagemath/sage/files/ticket29653/patch-configure.ac)\n\nAdd FreeBSD support in configure",
    "created_at": "2020-05-05T17:29:13Z",
    "issue": "https://github.com/sagemath/sage/issues/29653",
    "type": "issue_comment",
...
**Attachment:** [patch-configure.ac](https://github.com/sagemath/sage/files/ticket29653/patch-configure.ac)
...
archive/attachments_022075.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [build_bin_sage-guess-package-system.diff](https://github.com/sagemath/sage/files/ticket29653/build_bin_sage-guess-package-system.diff)\n\nAdd support of FreeBSD pkg in build/bin/sage-guess-package-system",
    "created_at": "2020-05-05T17:31:06Z",
    "issue": "https://github.com/sagemath/sage/issues/29653",
    "type": "issue_comment",
...
**Attachment:** [build_bin_sage-guess-package-system.diff](https://github.com/sagemath/sage/files/ticket29653/build_bin_sage-guess-package-system.diff)
...
archive/attachments_022076.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [build_bin_sage-print-system-package-command](https://github.com/sagemath/sage/files/ticket29653/build_bin_sage-print-system-package-command)\n\nAdd support of FreeBSD pkg in build/bin/sage-print-system-package-command",
    "created_at": "2020-05-05T17:31:55Z",
    "issue": "https://github.com/sagemath/sage/issues/29653",
    "type": "issue_comment",
...
**Attachment:** [build_bin_sage-print-system-package-command](https://github.com/sagemath/sage/files/ticket29653/build_bin_sage-print-system-package-command)
...
archive/attachments_022077.json:
```json
{
    "asset_content_type": "application/octet-stream",
