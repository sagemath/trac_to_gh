...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-579996",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                                                                                                                                                                                                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n|[bb6cc0c](https://github.com/sagemath/sagetrac-mirror/commit/bb6cc0cfb8b1c8375e91560f7f85ea816e666aa5)|`Merge branch 't/29785/move_extension_options_from_src_module_list_py_to__distutils___directives_in_the_individual_files__part_3__get_rid_of_uname_specific_' into t/29847/install_sage_setup_with_pip__move_sage_include_directories__cython_aliases_from_sage_env_to_sage_setup`|\n|[4a9dd3a](https://github.com/sagemath/sagetrac-mirror/commit/4a9dd3ad8c103784403e8ecce172427b2f5c0eff)|`Merge branch 't/29855/sagelib_setup_py__fix_dependencies_on_header_files_of_packages_gmp__ntl' into t/29847/install_sage_setup_with_pip__move_sage_include_directories__cython_aliases_from_sage_env_to_sage_setup`|\n|[f04ea03](https://github.com/sagemath/sagetrac-mirror/commit/f04ea0342bec69692f06af35eee334d9fae0a3aa)|`sage_setup.library_order: Do not fail if cython_aliases cannot be imported`|\n|[cb16b91](https://github.com/sagemath/sagetrac-mirror/commit/cb16b915315b3535460f76ab93907ed5075fb8cb)|`sage_setup.sage_build_cython: Do not fail if cython_aliases, sage_include_directories cannot be imported`|",
    "created_at": "2020-11-14T06:36:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-579997",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-579998",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-579999",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-580000",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94481"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94482"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94483"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94484"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94485"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94486"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94487"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29924#event-94488"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-580001",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-580002",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29924#issuecomment-580003",
    "user": "https://github.com/mkoeppe"
}
```
