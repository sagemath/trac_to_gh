...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29297#issuecomment-410854",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29297#issuecomment-410855",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I have also observed this issue when building Sage with ATLAS. Thanks for the fix.",
    "created_at": "2020-03-08T12:20:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29297#issuecomment-410856",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:2'></a>I have also observed this issue when building Sage with ATLAS. Thanks for the fix.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29297#issuecomment-410857",
    "user": "https://github.com/mwageringel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29297",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29297#issuecomment-410858",
