...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29359#issuecomment-411857",
...
```json
{
    "body": "<a id='comment:2'></a>The problem here seems to be that there is a coercion from the dense matrix space to the sparse one, so the sparse matrix space is discovered as a common parent:\n\n```\nsage: a = matrix.random(ZZ, 3, sparse=False)\nsage: b = matrix.random(QQ, 3, sparse=True)\nsage: b.parent().has_coerce_map_from(a.parent())\nTrue\nsage: coercion_model.common_parent(a, b)\nFull MatrixSpace of 3 by 3 sparse matrices over Rational Field\n```\n\nIt would be better if the pushout were used here, as it correctly results in a dense matrix space:\n\n```\nsage: sage.categories.pushout.pushout(a.parent(), b.parent())\nFull MatrixSpace of 3 by 3 dense matrices over Rational Field\n```",
    "created_at": "2020-07-05T20:48:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29359#issuecomment-411858",
    "user": "https://github.com/mwageringel"
}
```

<a id='comment:2'></a>The problem here seems to be that there is a coercion from the dense matrix space to the sparse one, so the sparse matrix space is discovered as a common parent:
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74772"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74773"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74774"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29359#issuecomment-411860",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74776"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74777"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74778"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74779"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74780"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74781"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74782"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29359#event-74783"
}
```
