...
```json
{
    "body": "<a id='comment:1'></a>Works on my sage session.\n\n---\nNew commits:",
    "created_at": "2020-04-22T11:53:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29550",
    "type": "issue_comment",
...
<a id='comment:1'></a>Works on my sage session.
...
```json
{
    "body": "<a id='comment:3'></a>Note that the testing framework did not catch this because Sage is using a verbatim copy of the Python 2 version of the `Random` module during doctesting. This is to ensure identical results between Python 2 and Python 3 in the doctests.",
...
<a id='comment:3'></a>Note that the testing framework did not catch this because Sage is using a verbatim copy of the Python 2 version of the `Random` module during doctesting. This is to ensure identical results between Python 2 and Python 3 in the doctests.
...
```json
{
    "body": "<a id='comment:4'></a>Oh, this is new to me. Does this mean we need to test on Python3 with a proper Python 3 Random module, just to make sure no more errors like this are left?",
...
<a id='comment:4'></a>Oh, this is new to me. Does this mean we need to test on Python3 with a proper Python 3 Random module, just to make sure no more errors like this are left?
