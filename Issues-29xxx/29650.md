...
archive/issue_comments_581102.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29650#issuecomment-581102",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_581103.json:
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -11,4 +11,9 @@\n \n    (b) Extra credit for automating the splitting into nodes and stages from package dependencies and compilation time data. This is a stochastic scheduling problem with precedence constraints.\n \n+3. (from #29929)\n \n+python detection - see #30177\n+Use tar --ignore-failed-read to work around trouble on cygwin (\u200bhttps://trac.sagemath.org/ticket/25993#comment:107)\n+\n+\n``````\n",
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29650#issuecomment-581103",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_581104.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29650#issuecomment-581104",
    "user": "https://github.com/mkoeppe"
}
```
...
archive/issue_comments_581105.json:
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29650#issuecomment-581105",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29650#issuecomment-581106",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29650#issuecomment-581107",
    "user": "https://github.com/mkoeppe"
}
```
