...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29608#issuecomment-443553",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29608#issuecomment-443554",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75594"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I opened ticket #29616 to discuss the error about the assumption being redundant, so this ticket can focus on the other issue: can the maxima code (`%pi`) in the error message be automatically translated to sage syntax (`pi`) before it is presented to the user?",
    "created_at": "2020-04-29T07:03:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29608#issuecomment-443555",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:1'></a>I opened ticket #29616 to discuss the error about the assumption being redundant, so this ticket can focus on the other issue: can the maxima code (`%pi`) in the error message be automatically translated to sage syntax (`pi`) before it is presented to the user?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29608#issuecomment-443556",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75595"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75596"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75597"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75598"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29608#issuecomment-443557",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75599"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75600"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75601"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75602"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75603"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75604"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75605"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29608#event-75606"
}
```
