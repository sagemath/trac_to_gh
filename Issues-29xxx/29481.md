...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373777"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373779"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373780"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373781"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373782"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373783"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29481",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29481#event-373785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29481#issuecomment-466310",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29481",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29481#issuecomment-466311",
    "user": "https://github.com/jhpalmieri"
}
```
