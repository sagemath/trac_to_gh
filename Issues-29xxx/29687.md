...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29687#issuecomment-470820",
    "user": "https://github.com/sgrosser"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29687#issuecomment-470821",
    "user": "https://github.com/sgrosser"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29687#event-390242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29687#event-390243"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29687#event-390244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29687",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29687#event-390245"
}
```
