...
```json
{
    "body": "<a id='comment:1'></a>it is not clear how to see that it is broken. Could you point at a doctest that doesn't work at the Sage prompt?",
    "created_at": "2020-05-29T13:25:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583236",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:1'></a>it is not clear how to see that it is broken. Could you point at a doctest that doesn't work at the Sage prompt?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583237",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The OP at https://groups.google.com/d/msg/sage-support/0RsGgb3lmZg/WNxT_rzNAwAJ says that the problem is fixed in Sage 9.1. Dima, can you confirm this? (sorry I don't have any macOS computer at hand...). If yes, we may close this ticket.",
    "created_at": "2020-06-02T06:51:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583238",
    "user": "https://github.com/egourgoulhon"
}
```

<a id='comment:3'></a>The OP at https://groups.google.com/d/msg/sage-support/0RsGgb3lmZg/WNxT_rzNAwAJ says that the problem is fixed in Sage 9.1. Dima, can you confirm this? (sorry I don't have any macOS computer at hand...). If yes, we may close this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583239",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583240",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>works for me on macOS and Sage 9.2.beta0",
    "created_at": "2020-06-07T17:09:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583241",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:4'></a>works for me on macOS and Sage 9.2.beta0
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29755#event-76127"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583242",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583243",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29755#issuecomment-583244",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29755",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29755#event-76128"
}
```
