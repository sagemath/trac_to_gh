...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566736",
    "user": "https://trac.sagemath.org/admin/accounts/users/nailuj"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566737",
...
```json
{
    "body": "<a id='comment:5'></a>We have a similar discussion running for `FiniteRankFreeModule` and elements in the manifolds module, take a look at #30302, especially [comment:3](https://trac.sagemath.org/ticket/30302#comment:3).\n\nIn my opinion, this should not happen.",
    "created_at": "2020-08-07T19:31:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566738",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:5'></a>We have a similar discussion running for `FiniteRankFreeModule` and elements in the manifolds module, take a look at #30302, especially [comment:3](https://trac.sagemath.org/ticket/30302#comment:3).
...
```json
{
    "body": "<a id='comment:6'></a>Even though the corresponding check via the flac `copy` is implemented in `FreeModule`, the coercion model preempts it. The corresponding change should be\n\n```diff\n-        if R is self and no_extra_args:\n-            return x\n```\n\nin `sage.structure.parent.Parent`.\n\nBut I don't know anything about the whole string of consequences coming from this.",
    "created_at": "2020-08-10T17:03:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566739",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:6'></a>Even though the corresponding check via the flac `copy` is implemented in `FreeModule`, the coercion model preempts it. The corresponding change should be
...
```json
{
    "body": "<a id='comment:7'></a>Just for fun, I've deleted these lines and ran a doctest:\n\n```\nFile \"src/sage/structure/parent.pyx\", line 1473, in sage.structure.parent.Parent._is_valid_homomorphism_._is_coercion_cached\nFailed example:\n    R._is_coercion_cached(QQ)\nExpected:\n    False\nGot:\n    True\n```",
    "created_at": "2020-08-10T17:12:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566740",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:7'></a>Just for fun, I've deleted these lines and ran a doctest:
...
```json
{
    "body": "<a id='comment:8'></a>Note that `FreeModule_generic._element_constructor_` has some optional arguments...\n\n```\n    def _element_constructor_(self, x, coerce=True, copy=True, check=True):\n```",
    "created_at": "2020-08-10T18:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566741",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:8'></a>Note that `FreeModule_generic._element_constructor_` has some optional arguments...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566742",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>This could only be a temporary solution. As you already pointed out, and I totally agree with you, the element constructor should behave consistently, i.e. always returning a mutable element. Returning the very same instant, assuming it is immutable, would contradict this behavior.",
    "created_at": "2020-08-12T06:35:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566744",
    "user": "https://github.com/mjungmath"
}
```

<a id='comment:11'></a>This could only be a temporary solution. As you already pointed out, and I totally agree with you, the element constructor should behave consistently, i.e. always returning a mutable element. Returning the very same instant, assuming it is immutable, would contradict this behavior.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566745",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566746",
    "user": "https://github.com/mjungmath"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73800"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73801"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73802"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73803"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566747",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73804"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73805"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566748",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566749",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>For that, we would want to (also?) override `__iadd__`, `__imul__` etc. for `+=` and `-=`.",
    "created_at": "2021-08-11T21:25:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566751",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:23'></a>For that, we would want to (also?) override `__iadd__`, `__imul__` etc. for `+=` and `-=`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566752",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566753",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>I agree, this is not a normal binop-coercion; nevertheless taking care of it is a task for the coercion system, so I'm +1 for single-underscore `_iadd_` etc. methods.",
    "created_at": "2021-08-11T22:09:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566754",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:26'></a>I agree, this is not a normal binop-coercion; nevertheless taking care of it is a task for the coercion system, so I'm +1 for single-underscore `_iadd_` etc. methods.
...
```json
{
    "body": "Changing branch from \"\" to \"u/mkoeppe/refined_protocol_for__element_constructor__in_element_classes_with_mutability\"",
    "created_at": "2021-08-11T23:01:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566755",
    "user": "https://github.com/mkoeppe"
}
```

Changing branch from "" to "u/mkoeppe/refined_protocol_for__element_constructor__in_element_classes_with_mutability"
...
```json
{
    "body": "Changing commit from \"\" to \"501e7ef60ae4f46843464ed6a7c93c0ea050dec3\"",
    "created_at": "2021-08-11T23:04:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566756",
    "user": "https://github.com/mkoeppe"
}
```

Changing commit from "" to "501e7ef60ae4f46843464ed6a7c93c0ea050dec3"
...
```json
{
    "body": "<a id='comment:28'></a>Here's the beginning of a `_test_...` method to enforce the proposed protocol. \n\n`git grep mutable=` reveals that various classes use the keyword `mutable=...`, others use `immutable=...`. Should we aim to support both for all classes?\n\n---\nNew commits:",
    "created_at": "2021-08-11T23:04:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566757",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:28'></a>Here's the beginning of a `_test_...` method to enforce the proposed protocol. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566758",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29101",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29101#issuecomment-566759",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73806"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73807"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73808"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73809"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73810"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29101#event-73811"
}
```
