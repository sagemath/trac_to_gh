...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[6fa0327](https://git.sagemath.org/sage.git/commit/?id=6fa032702da536c26d3e5de0a69b4a4ef2e39922)|`improved a little`|",
    "created_at": "2020-05-28T18:43:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29744",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[1068f75](https://git.sagemath.org/sage.git/commit/?id=1068f753c89e6de759681e6faeb436c94bb0a836)|`updated using active vertices list`|",
    "created_at": "2020-05-29T18:10:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29744",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:10'></a>\nI pushed a new branch with a different version of the algorithm. For me it's better and it is generally faster than iFUB.\nI have also renamed the algorithm as `DHV` instead of `diameter_dragan`. The branch is in public, so you can modify it.\n\n---\nNew commits:\n|                                                                                                                                          |                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[1d08d3b](https://git.sagemath.org/sage.git/commit?id=1d08d3b6139fa0532b0c65b1cc0662d548081085)|`trac #29744: rebuild on top of 9.2.beta0`|\n|[37ac47a](https://git.sagemath.org/sage.git/commit?id=37ac47a9297fc0a04441862ba8b2a82251d464a7)|`trac #29744: improved version of the algorithm`|",
    "created_at": "2020-05-30T14:37:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29744",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                   |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------|\n|[a049556](https://git.sagemath.org/sage.git/commit/?id=a0495566ae194295ec7613decac5d983527c451d)|`index error fixed`|",
    "created_at": "2020-05-30T18:22:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29744",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[f9319d5](https://git.sagemath.org/sage.git/commit/?id=f9319d547f03ca9c8dcf166a7a626e6f22c12599)|`trac #29744: minor edit`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[9a06bbd](https://git.sagemath.org/sage.git/commit/?id=9a06bbd64dfa93e3497c7de0a6ff775b3e1d37cc)|`fixed for negative weights`|",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[d33b780](https://git.sagemath.org/sage.git/commit/?id=d33b7808fac7b8a42411e554a62dcde75734fc69)|`trac #29744: fix merge conflicts`|",
...
```json
{
    "body": "<a id='comment:45'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[3eed584](https://git.sagemath.org/sage.git/commit/?id=3eed5849912893e1e9d6e8ec9ca0f1400091369b)|`trac #29744: review commit`|",
    "created_at": "2020-07-15T08:20:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29744",
    "type": "issue_comment",
