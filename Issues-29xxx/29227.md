...
```json
{
    "body": "<a id='comment:16'></a>\nHere is a branch that makes the doctest compatible with 32-bit and 64-bit.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|\n|[e36459a](https://git.sagemath.org/sage.git/commit?id=e36459aa7acdb03c0a0e25898e0bac6eaebfa9d6)|`Merge branch 'u/gh-jcamp0x2a/29227-threejs_repr' of git://trac.sagemath.org/sage into u/gh-jcamp0x2a/29227-threejs_repr`|\n|[e76dbdd](https://git.sagemath.org/sage.git/commit?id=e76dbdda30e241a4c29dcee4afee5a38e24ca4bd)|`Fixing doctest for numerical noise on 32-bit.`|",
