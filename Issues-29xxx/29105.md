...
archive/attachments_022023.json:
```json
{
...
archive/attachments_022024.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_022025.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_022026.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [tox.ini.patch](https://github.com/sagemath/sage/files/ticket29105/tox.ini.patch)",
    "created_at": "2020-06-16T16:30:12Z",
    "issue": "https://github.com/sagemath/sage/issues/29105",
    "type": "issue_comment",
...
**Attachment:** [tox.ini.patch](https://github.com/sagemath/sage/files/ticket29105/tox.ini.patch)



---

archive/attachments_022027.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [write-dockerfile.sh.patch](https://github.com/sagemath/sage/files/ticket29105/write-dockerfile.sh.patch)",
    "created_at": "2020-06-16T16:30:31Z",
    "issue": "https://github.com/sagemath/sage/issues/29105",
    "type": "issue_comment",
...
**Attachment:** [write-dockerfile.sh.patch](https://github.com/sagemath/sage/files/ticket29105/write-dockerfile.sh.patch)



---

archive/attachments_022028.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:29'></a>\n**Attachment:** [Dockerfile_gentoo-20.06-gcc9-py37](https://github.com/sagemath/sage/files/ticket29105/Dockerfile_gentoo-20.06-gcc9-py37)\n\nhttps://hub.docker.com/r/fbissey/sage-on-gentoo-stage/tags ... this does not seem to exist yet?",
    "created_at": "2020-06-16T16:41:51Z",
    "issue": "https://github.com/sagemath/sage/issues/29105",
    "type": "issue_comment",
