...
```json
{
    "body": "<a id='comment:6'></a>\nThis can be done in the same `constants.py` file, but //after// global definition of `e`. Doctested in the `mathematica.py` interface (passes for me).\n\n===>`needs_review`.\n\n---\nNew commits:\n|                                                                                                                                          |                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|\n|[5fa13e0](https://git.sagemath.org/sage.git/commit?id=5fa13e0b9be188e898defdd33abe52fdb2d01caf)|`Backtranslate Mathematica's E exponential symbol to Sage's e.`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                    |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|\n|[f37400a](https://git.sagemath.org/sage.git/commit/?id=f37400a8e527c2c755a4619a7ee1bce3e41519a9)|`Mathematica's E backtranslation: typo/thinko fixes, more doctests.`|",
    "created_at": "2020-06-11T19:52:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29833",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:16'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|\n|[be9d130](https://git.sagemath.org/sage.git/commit/?id=be9d130b08e6c3e5ce3b2e8026080ed03a932b7a)|`Backtranslate Mathematica's E to Sage's e : assorted fixes.`|",
