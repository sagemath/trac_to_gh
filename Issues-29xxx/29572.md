...
```json
{
    "body": "<a id='comment:24'></a>\nNew commits:\n|                                                                                                                                          |                                                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|\n|[b709cf2](https://git.sagemath.org/sage.git/commit?id=b709cf2e10d491f0822e368774a8ee02aa9bea44)|`build/pkgs/perl_term_readline_gnu/patches: Add 0002-Makefile.PL-Include-CFLAGS-LDFLAGS.patch`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nNew commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[5eed418](https://git.sagemath.org/sage.git/commit?id=5eed4183e75c4c307fbf6391e373dd9c871de84e)|`Update patch for perl_term_readline_gnu`|",
    "created_at": "2020-05-01T04:40:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29572",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:36'></a>\nNew run at https://github.com/mkoeppe/sage/actions/runs/92850133\n\n---\nNew commits:\n|                                                                                                                                          |                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|\n|[94fb0ec](https://git.sagemath.org/sage.git/commit?id=94fb0ecfec3f6235aafe5234d579efe40e32dfd0)|`Update patch for perl_term_readline_gnu`|",
    "created_at": "2020-05-01T06:29:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29572",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------|\n|[1c3b7f3](https://git.sagemath.org/sage.git/commit/?id=1c3b7f3049a21b807540a0f29df4efb8e9d5aecd)|`Update patch`|",
...
```json
{
    "body": "<a id='comment:50'></a>\nNew commits:\n|                                                                                                                                          |                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[e07dd79](https://git.sagemath.org/sage.git/commit?id=e07dd7937fc71fc89393441a96da5216628c9402)|`Try a workaround for Perl changing LDFLAGS`|",
...
```json
{
    "body": "<a id='comment:51'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[df48845](https://git.sagemath.org/sage.git/commit/?id=df4884530bcd1c29460feed2011e23ef3b42c12a)|`Try a workaround for Perl changing LDFLAGS`|",
    "created_at": "2020-05-02T23:47:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29572",
    "type": "issue_comment",
