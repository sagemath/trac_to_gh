...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29431#issuecomment-465440",
    "user": "https://github.com/ArchitWagle"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29431#issuecomment-465441",
    "user": "https://github.com/ArchitWagle"
}
```
...
```json
{
    "body": "Changed keywords from none to **graph, gsoc, radius**",
    "created_at": "2020-03-30T20:08:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/29431",
    "type": "issue_comment",
...
Changed keywords from none to **graph, gsoc, radius**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29431#event-386561"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29431#event-386562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29431#event-386563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29431",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29431#event-386564"
}
```
