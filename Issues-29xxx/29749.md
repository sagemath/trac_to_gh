...
```json
{
    "body": "<a id='comment:3'></a>\nThanks for catching this. Just a quick note -- it's not just \"documentation\", also the new [GitHub](../wikis/GitHub) CI workflow uses these package lists, see https://github.com/sagemath/sage/actions?query=workflow%3A%22CI+cygwin-standard%22",
