...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396502"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396503"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396504"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396506"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396507"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396510"
}
```
...
```json
{
    "body": "<div id=\"comment:36\" align=\"right\">comment:36</div>\n\nAttachment: **[vdelecroix-29071-fflas_ffpack-2.4.3.log](https://github.com/sagemath/sage/files/ticket29071/vdelecroix-29071-fflas_ffpack-2.4.3.log)**\n\nReplying to [@antonio-rojas](#comment%3A34):\n> Replying to [@dimpase](#comment%3A27):\n> > with this branch, reverting #29025 makes everything  work on Arch (also with OpenBLAS, gsl, R, etc from the system)\n> \n> \n> I can confirm, thank you. Vincent, can you post the config log of the failed fflas-ffpack build?\n\nHere they are\n- [config.log](https://github.com/sagemath/sage/files/ticket29071/vdelecroix-29071-config.log)\n- [fflas_ffpack-2.4.3.log](https://github.com/sagemath/sage/files/ticket29071/vdelecroix-29071-fflas_ffpack-2.4.3.log)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396512"
}
```
...
```json
{
    "body": "<div id=\"comment:52\" align=\"right\">comment:52</div>\n\nHere is [config.log](https://github.com/sagemath/sage/files/ticket29071/vdelecroix-29071-config.log)",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29071",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29071#event-396520"
}
```
