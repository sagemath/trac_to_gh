...
```
sage: IncidenceStructure([0,1],[This is the Trac macro *0,1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0,1-macro)*15).parameters()      
(2, 2, 2, 15)
sage: IncidenceStructure([0,1],[This is the Trac macro *0,1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0,1-macro)*15).is_block_design()
...
