...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319076",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319077",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319078",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319079",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319080",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319083",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319084",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    "body": "I should clarify that the doctests for graphs passed. When I tried everything, there were some problems, but the problem is likely with my installation and not with changes to `graph.py`.",
    "created_at": "2017-05-30T02:27:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319086",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319087",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "In the LP, the only place where you need to use `min(u,v), max(u,v)` is `p.sum(b[min(u, v), max(u,v)] for u in self.neighbors(v) if u != v), max=1)`. Here you have no guarantee that `u < v`, but each time you use `for u, v in W`,  we know that `u < v`.\n\nYou can remove the line `#self._scream_if_not_simple(allow_loops=True)`.",
    "created_at": "2017-06-03T11:14:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319088",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319089",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319090",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Actually, I think I see it now. I'll fix it shortly.",
    "created_at": "2017-06-05T00:31:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319092",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319093",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319094",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319096",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319098",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "The patch is now good to go (passes all tests, etc.). I agree with Travis that it would be a lot of work to save small computation time.",
    "created_at": "2017-06-05T08:26:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319099",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319100",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/22844#event-59732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/22844",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/22844#issuecomment-319101",
