...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375095",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375097",
    "user": "https://github.com/ghseeli"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375098",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375099",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66718"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66719"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66720"
}
```
...
```json
{
    "body": "Changing milestone to sage-pending until further activity.",
    "created_at": "2019-01-16T01:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375100",
    "user": "https://github.com/ghseeli"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375102",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375104",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Hi, Kevin! I have attempted to fix all the issues from the patchbot report, so we will see if it is a happier robot next time it comes around. Thank you again for pointing out the problems!",
    "created_at": "2019-01-24T03:26:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375105",
    "user": "https://github.com/ghseeli"
}
```
...
```json
{
    ...
    "milestone": "sage-pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66721"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66722"
}
```
...
```json
{
    "body": "Hi, Travis! Thank you for doing this! I agree with your assessments. I will review your changes this weekend. Also, Mike suggested that I be a little more mathematically detailed in the documentation, so I will probably add a little bit to the docstring describing the `ShiftingOperatorAlgebra` class.",
    "created_at": "2019-09-05T12:42:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375107",
    "user": "https://github.com/ghseeli"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375109",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375112",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375113",
    "user": "https://github.com/ghseeli"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66723"
}
```
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66724"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375114",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/26702#event-66725"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/26702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/26702#issuecomment-375115",
