...
```json
{
    "body": "Attachment [ncurses-5.9.20131221.log](tarball://root/attachments/some-uuid/ticket21762/ncurses-5.9.20131221.log) by mjo created at 2019-08-06 18:40:36\n\nThis probably got fixed upstream. I still use dash as my /bin/sh, so I'll come find this later and reopen it if I'm wrong.",
...
Attachment [ncurses-5.9.20131221.log](tarball://root/attachments/some-uuid/ticket21762/ncurses-5.9.20131221.log) by mjo created at 2019-08-06 18:40:36
