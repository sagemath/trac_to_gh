...
```json
{
    "body": "This is about as naive a fix as could be imagined, although it does speed things up.",
...
```json
{
    "body": "I give John's patch a positive review, modulo that I added doctests and made it not use generic code mod p if p is a large prime, since then the generic code still sucks right now.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5570#issuecomment-43404",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5570#issuecomment-43405",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5570",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5570#issuecomment-43406",
    "user": "mabshoff"
}
```
