# Issue 896: [with patch] remove obsolete comment in matrix_modn_dense.pyx
...
```json
{
    ...
    "title": "[with patch] remove obsolete comment in matrix_modn_dense.pyx",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/896",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/896#event-2485"
}
```
