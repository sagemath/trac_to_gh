# Issue 4589: [with patch; positive review] sage/rings/polynomial/multi_polynomial_ideal.py doctest failure due to #4583
...
```json
{
    ...
    "title": "[with patch; positive review] sage/rings/polynomial/multi_polynomial_ideal.py doctest failure due to #4583",
    "type": "issue",
