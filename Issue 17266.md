...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17266#event-50308"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17266#issuecomment-229575",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17266#issuecomment-229576",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    "body": "#17504 suggests this could be caused by `nargs=1`, but I've just retested it using the identical sequence except with `z = sage.symbolic.function_factory.function('z')`, and it throws the same exception.",
    "created_at": "2014-12-17T03:22:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17266#issuecomment-229577",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```
...
```json
{
    "body": "OK, this is a very nice example. It seems that expression pickling *forces* functions to have a fixed arity. On the other hand, calling solve goes through the maxima strings interface, so its resulting functions have undeclared arity. That's why in the example given, the \"nargs=1\" has no effect: After calling \"solve\" it's stripped. The following does not produce an error:\n\n```\nsage: from sage.symbolic.function_factory import function\nsage: z=function('z',nargs=1)\nsage: z1=loads(dumps(z(x))).operator()\nsage: z==z1\nTrue\nsage: z is z1\nFalse\nsage: limit(z(x),x=0)\nlimit(z(x), x, 0)\nsage: limit(z1(x),x=0)\nlimit(z(x), x, 0)\n```\nSo there are two issues at play in this ticket:\n- maxima's string interface doesn't deal with arity properly, see #17504\n- pickling of expressions doesn't deal with arity properly in another way.",
    "created_at": "2014-12-19T23:50:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17266#issuecomment-229579",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    "body": "possibly related: #17558 (pickled function loses its args)",
    "created_at": "2014-12-27T23:58:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17266#issuecomment-229580",
    "user": "https://trac.sagemath.org/admin/accounts/users/wonder"
}
```
