...
sage: c = L1.congruence([This is the Trac macro *0, 1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 1-macro))
sage: L2.quotient(c)
...
```
sage: L1 = Posets.BooleanLattice(3)
sage: c = L1.congruence([This is the Trac macro *0, 1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#0, 1-macro)); c
{{0, 1}, {2, 3}, {4, 5}, {6, 7}}
sage: L1.quotient(c)
