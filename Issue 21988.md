...
```json
{
    "body": "Martin, you reviewed #20058 and so may be interested in this too. The code should work, but I am currently compiling it on a slow machine.\n\nWhat you think about function name, parameter names and examples? I am not very satisfied, but don't know what would be better.\n----\nNew commits:",
    "created_at": "2017-01-21T19:04:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305613",
    "user": "jmantysalo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305614",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305615",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "* I think you should specify the possibilities for `element_constructor` in the docstring.\n\n* it might be nice to show an example using the `FiniteLatticePoset.congruence` method.\n\n* why aren't you satisfied with the names?",
    "created_at": "2017-01-22T08:23:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305616",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305617",
    "user": "jmantysalo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305618",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305619",
    "user": "git"
}
```
...
```json
{
    "body": "Is it \"quotient by congruence\" or \"quotient of congruence\" or something else?",
    "created_at": "2017-01-22T09:55:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305620",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "More comments for this one?",
    "created_at": "2017-01-29T14:04:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305621",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "I would like to have as few `WARNING`s as possible. Can we avoid that by requiring the input to be of type SetPartition? And/or `rename()` the set partition given by `congruence()`? Then the user would really need to break things to get an error.\n\nOr do we break something if we just put extra value `._congruence_base_lattice` pointing to the lattice to a `SetPartition`-object? Of course that would cost some extra bytes for every congruence.",
    "created_at": "2017-01-30T06:58:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305623",
    "user": "jmantysalo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305624",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305625",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305626",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "That is going to fail in an extremely subtle way if the user passes in something constructed from `congruence` and then the \"same\" set partition constructed directly. It is also completely unnecessary by how you are handling the input.\n\nIf you want a check, then you need to check that it satisfies the properties of being a congruence (I would also then add an extra argument `check=True` to have the option of turning this off). Otherwise it needs to be a `.. WARNING::`.",
    "created_at": "2017-01-31T15:07:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305627",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305628",
    "user": "jmantysalo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305630",
    "user": "jmantysalo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305631",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305632",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "I second `labels`.",
    "created_at": "2017-02-02T15:31:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305634",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305635",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305636",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "Maybe we can go with this.",
    "created_at": "2017-02-03T07:34:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305637",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "I have no time to check this properly, but I think `labels` is good - that's also what `GenericGraph.disjoint_union` uses.",
    "created_at": "2017-02-05T21:03:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305638",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305639",
    "user": "git"
}
```
...
```json
{
    "body": "I suspect the doctest in `src/sage/misc/rest_index_of_methods.py` will (still) fail. The number 55 just needs to be bumped slightly.",
    "created_at": "2017-02-11T15:17:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305641",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305642",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305643",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "A typo in the docstring: \"congurence\" should be \"congruence\".",
    "created_at": "2017-02-12T10:59:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305644",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305645",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305646",
    "user": "jmantysalo"
}
```
...
```json
{
    "body": "(I cannot build the documentation here in reasonable time, because my computer is too small. Can I set it to positive review anyway?)",
    "created_at": "2017-02-12T14:07:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305648",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305649",
    "user": "jmantysalo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305650",
    "user": "mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/21988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/21988#issuecomment-305651",
    "user": "vbraun"
}
```
