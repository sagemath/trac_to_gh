...
```json
{
    "body": "Looks good to me.  I had actually been meaning to do this as well.\n\nMerged in 4.0.1.rc1.",
    "created_at": "2009-06-04T19:28:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6208",
    "type": "issue_comment",
...
```json
{
    "body": "The milestone for this one should be Sage 4.0.1. Unfortunately, it's still stuck at Sage 4.0.2. Someone with admin priviledges on trac might know how to do that.",
    "created_at": "2009-06-06T22:15:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/6208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/6208#issuecomment-49604",
    "user": "mvngu"
}
```
...
```json
{
    "body": "Just correcting the milestone (since it was already merged).",
