...
```json
{
    ...
    "title": "a cosine of arcsin limit that is evaluated incorrectly",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33903#issuecomment-481377",
    "user": "@DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33903",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33903#issuecomment-481378",
    "user": "@DaveWitteMorris"
}
```
