...
```json
{
    ...
    "title": "Some algebraic substitutions may crash Sage",
    "type": "issue",
...
```json
{
    "body": "#30378 seems relevant.",
    "created_at": "2020-10-01T17:03:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434144",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "The error is trigerred by the existence of the assumption about `k`, which might trigger further transformations (which turn out to be toxic in this case).\n\nThis works:\n\n```\nf = function(\"f\")\nvar(\"k\")\nEq = f(x).diff(x, 2)/f(x) == k\nwith assuming(k > 0):\n    Sp = desolve(Eq, f(x), ivar=x)\nwith assuming(k == 0):\n    Sz = desolve(Eq, f(x), ivar=x)\nwith assuming(k < 0):\n    Sn = desolve(Eq, f(x), ivar=x)\nSn1 = Sn.subs(sqrt(k) == I*sqrt(abs(k)))\n```\n\n\nThis crashes Sage:\n\n```\nassume(k < 0)\nSn2 = Sn.subs(sqrt(k) == I*sqrt(abs(k)))\n```\n\n\nDitto when using `with assuming...`.",
    "created_at": "2020-10-01T22:50:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434145",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434146",
...
```json
{
    "body": "Given that our release is long overdue, and nobody works on the present ticket, I turn it to critical. ANybody proposing a branch in the next few days can of course reconsider this.",
    "created_at": "2020-10-09T13:57:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434147",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434148",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30451#event-79860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434150",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "Mark as `blocker`, but for 9.3...",
    "created_at": "2020-10-19T07:17:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434151",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "Might be related to #30446.",
    "created_at": "2021-01-23T18:27:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434152",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434153",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434154",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Thanks for working on this. As you know, pynac is based on an old fork of ginac - so the question is also whether this bug was fixed upstream.",
    "created_at": "2021-01-30T11:43:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434158",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434161",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434163",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "OK, I understand now - indeed, comment:12 says that there is a recursion happening in this loop for negative terms. \n\nWhat I don't understand is why only negative terms are a problem.\n\nProbably one needs to rewrite this part modelling on `expand_mul()` in the same file.",
    "created_at": "2021-01-31T01:46:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434164",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "Opened https://github.com/pynac/pynac/issues/368 - hopefully people knowing GiNaC code can comment.",
    "created_at": "2021-01-31T13:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434165",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434166",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434171",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434173",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "OK, I always having trouble doing a rebase, but I think I eventually got it correct.\n\nI changed the package version to 0.7.27.p1 -- is that correct?\n----\nLast 10 new commits:",
    "created_at": "2021-02-03T07:17:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434174",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    "body": "Followup ticket: I opened #31337 for reimplementing the `else if` clause.",
    "created_at": "2021-02-04T05:03:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434175",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434176",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434177",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/30451#event-79861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/30451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/30451#issuecomment-434178",
