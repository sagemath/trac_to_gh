...
```
CC:  gmoose05 stumpc5 benstrasser etn40ff chapoton aram.dermenjian
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24680#issuecomment-346226",
    "user": "benstrasser"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/24680",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/24680#issuecomment-346227",
    "user": "stumpc5"
}
```
