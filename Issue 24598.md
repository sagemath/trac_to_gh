...
```
    sage: Polyhedron([This is the Trac macro *sqrt* that was inherited from the migration called with arguments (2))](https://trac.sagemath.org/wiki/WikiMacros#sqrt-macro))
