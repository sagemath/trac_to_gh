...
function __check_git__() {
    ...
    [This is the Trac macro *"${_s}" = "fatal:"* * that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#"${_s}" = "fatal:"* -macro) && echo "" && return
    ...
    elif [This is the Trac macro *-n "$_g_s" * that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#-n "$_g_s" -macro); then
