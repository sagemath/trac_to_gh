...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29883#issuecomment-423999",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29883#issuecomment-424001",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29883#issuecomment-424002",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "Have you tried to set `JUPYTER_PATH` in the sage environment to point to the folder where the system's kernel are located?\n\nhttps://jupyter-client.readthedocs.io/en/stable/kernels.html",
    "created_at": "2020-08-05T20:54:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/29883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29883#issuecomment-424003",
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77593"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77594"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77595"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/29883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/29883#issuecomment-424004",
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77596"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77597"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77598"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77599"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77600"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77601"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77602"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/29883#event-77603"
}
```
