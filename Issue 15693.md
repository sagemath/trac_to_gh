...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15693#event-46851"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15693#event-46852"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15693#event-46853"
}
```
...
```json
{
    "body": "Seems fixed now (sage 7.6 beta 4). Needs a test?\nThen needs review.",
    "created_at": "2017-03-03T23:58:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15693#issuecomment-202922",
...
```json
{
    "body": "I propose to close this one as \"garbage in, garbage out\".",
    "created_at": "2022-02-24T16:18:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15693#issuecomment-202923",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15693#issuecomment-202924",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15693#event-46854"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15693#event-46855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15693#issuecomment-202926",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15693",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15693#event-46856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/15693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15693#issuecomment-202927",
    "user": "https://github.com/fchapoton"
}
```
