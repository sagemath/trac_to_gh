...
```
        We test that :trac:`5525` is fixed::
            ...
            sage: A = (QQ^1).span([This is the Trac macro *1/3* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1/3-macro),ZZ); B = (QQ^1).span([This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro),ZZ);
...
```
        Comparison with a quotient module (see :trac:`10513`)::
            ...
            sage: M = QQ^3 / [This is the Trac macro *1,2,3* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1,2,3-macro)
            sage: V = QQ^2
            sage: V == M
            False
            sage: M == V
