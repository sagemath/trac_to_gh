...
Expected:
    [1, 0, 0]
Got:
    [<bound method AffineCrystalFromClassicalAndPromotion_with_category.element_class.epsilon0 of [This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro)>, <bound method AffineCrystalFromClassicalAndPromotion_with_category.element_class.epsilon0 of [This is the Trac macro *2* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#2-macro)>, <bound method AffineCrystalFromClassicalAndPromotion_with_category.element_class.epsilon0 of [This is the Trac macro *3* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#3-macro)>]
**********************************************************************
