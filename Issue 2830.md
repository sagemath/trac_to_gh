# Issue 2830: [with spkg, positive review] ace-5.0.spkg fails to install
...
```json
{
    ...
    "title": "[with spkg, positive review] ace-5.0.spkg fails to install",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2830",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2830#event-6507"
}
```
