...
```json
{
    "body": "this graphs_to_simple patch is superseded by the patches in #716.",
...
```json
{
    "body": "I think that the wiki is probably the best place for it.  I'm going to (finally) close this ticket as invalid.",
