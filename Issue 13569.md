# Issue 13569: Translate maxima's if() function to Sage's cases()
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13569#issuecomment-167613",
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38613"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38614"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38615"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38616"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38617"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38618"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38619"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13569#issuecomment-167614",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38620"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/13569#event-38621"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/13569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/13569#issuecomment-167615",
    "user": "https://github.com/kcrisman"
}
```
