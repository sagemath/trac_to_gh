...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11010#issuecomment-119672",
    "user": "was"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11010#issuecomment-119673",
    "user": "was"
}
```
...
```json
{
    "body": "Attachment [trac_11163.patch](tarball://root/attachments/some-uuid/ticket11163/trac_11163.patch) by davidloeffler created at 2011-04-10 08:06:13\n\nYes, this looks fine. (However: William, would you mind using the more specific trac ticket categories \"elliptic curves\", \"modular forms\", etc, rather than just bunging everything in \"number theory\"?)",
    "created_at": "2011-04-10T08:06:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/11010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11010#issuecomment-119674",
    "user": "davidloeffler"
}
```

Attachment [trac_11163.patch](tarball://root/attachments/some-uuid/ticket11163/trac_11163.patch) by davidloeffler created at 2011-04-10 08:06:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11010#issuecomment-119675",
    "user": "davidloeffler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11010#issuecomment-119676",
    "user": "davidloeffler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11010#issuecomment-119677",
    "user": "was"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/11010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/11010#issuecomment-119678",
    "user": "jdemeyer"
}
```
