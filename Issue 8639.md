...
```json
{
    "body": "This seems to pass all tests on  sage 4.3.5 on a 10.6.2 mac (the only failure was that of the fresh copy of 4.3.5).",
...
```json
{
    "body": "Seems like a very very minor change. As far as I can seen, positive review.",
...
```json
{
    "body": "Merged \"trac_8639.patch\" in 4.4.alpha0.",
    "created_at": "2010-04-16T18:55:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/8639",
    "type": "issue_comment",
