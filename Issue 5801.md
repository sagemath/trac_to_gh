...
```json
{
    "body": "This works now, apparently. Confirm and close?",
...
```json
{
    "body": "Files no longer exist. So let's close this.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5801",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5801#event-6051"
}
```
