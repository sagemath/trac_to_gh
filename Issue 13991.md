...
```json
{
    "body": "Attachment [trac_14195.patch](tarball://root/attachments/some-uuid/ticket14195/trac_14195.patch) by ncohen created at 2013-03-03 23:00:49\n\n> The patch is working and solves the issue. However, I don't understand why you put commas after some declarations. Is it a mistake or is it useful?\n\nMistake ! It has no interest that I know of, and seems to be ignored by Cython. Patch updated !\n\nNathann",
...
Attachment [trac_14195.patch](tarball://root/attachments/some-uuid/ticket14195/trac_14195.patch) by ncohen created at 2013-03-03 23:00:49
