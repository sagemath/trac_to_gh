...
```json
{
    "body": "is it because these binaries ignore pkg-config data, or is it faulty pkg-config data?",
    "created_at": "2019-06-17T20:37:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391904",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391905",
...
```json
{
    "body": "Is this a blocker? It will prevent upgrading Sage from 8.7 to 8.8 on OS X.",
    "created_at": "2019-06-17T22:29:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391906",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391908",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391909",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Another guess might be that the dependency on `$(BLAS)` is not 100% properly processed, and the corresponding generated makefile rules do not trigger the needed rebuilds.\n\nOr perhaps the need to rebuild is not working for some other reason.\n\nPerhaps Erik may say something about it.",
    "created_at": "2019-06-18T09:01:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391911",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391912",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69411"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391913",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391914",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69412"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69413"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391915",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391916",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69414"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69415"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69416"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69417"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69418"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391917",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69420"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391918",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69422"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/27771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/27771#issuecomment-391919",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69424"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69425"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69426"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/27771#event-69427"
}
```
