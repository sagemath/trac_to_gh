# Issue 34014: Add optional package cvxpy

archive/issues_034014.json:
```json
{
    "body": "CC:  dimpase yzh @sheerluck dcoudert slabbe @maxale fbissey isuruf @tkralphs\n\n(split out from #31962)\n\nIssue created by migration from https://trac.sagemath.org/ticket/34251\n\n",
    ...
    "title": "Add optional package cvxpy",
    "type": "issue",
    "url": "https://github.com/sagemath/sagetest/issues/34014",
    "user": "mkoeppe"
}
```
CC:  dimpase yzh @sheerluck dcoudert slabbe @maxale fbissey isuruf @tkralphs
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482722",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482723",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482724",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482725",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482726",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482727",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482728",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482729",
    "user": "git"
}
```
...
```json
{
    "body": "I am not sure, but it feels like if `default_sdp_solver()` is 'Cvxopt' then the tests in `cvxpy_sdp_backend.py` are broken. And if `default_sdp_solver()` is 'Cvxpy' then the tests in `cvxopt_backend.pyx` are broken. Sorry if that is irrelevant to this ticket.\n----\nNew commits:",
    "created_at": "2022-07-30T21:22:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482730",
    "user": "@sheerluck"
}
```
...
```json
{
    "body": "Here on this ticket, there's no SDP solver backend",
    "created_at": "2022-07-30T21:24:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482731",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "We had that on #31962, but I have split out the present ticket",
    "created_at": "2022-07-30T21:25:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482732",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482733",
    "user": "git"
}
```
...
```json
{
    "body": "I have yet to package this stuff for Gentoo (I already did cylp). I am going to have a closer look for obvious mistakes shortly.",
    "created_at": "2022-07-31T02:35:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482734",
    "user": "fbissey"
}
```
...
```json
{
    "body": "I was wondering about the dependency of qdldl on cmake. It vendors amd from suitesparse and build it with cmake. Lovely, but unvendoring it is out of scope of the ticket.\n\nThat's the only remark on the package added. They all look good, I'll have to test the sage bits later.",
    "created_at": "2022-07-31T03:01:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482735",
    "user": "fbissey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482736",
    "user": "git"
}
```
...
```json
{
    "body": "Added conda distro information. There doesn't appear to be a conda-forge package for cylp, so that will have to be taken via pip (#33613, needs review)",
    "created_at": "2022-08-05T22:06:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482737",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "Note for other packagers: qdldl-python include suitesparse's amd sources and qdldl's c sources. The vendored amd source are customised to use the vendored qdldl. I don't recommend trying to unvendor. osqp-python similarly vendor osqp but it looks like it could be unvendored but I am not going to try that just yet.",
    "created_at": "2022-08-06T09:40:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482738",
    "user": "fbissey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482739",
    "user": "fbissey"
}
```
...
```json
{
    "body": "osqp-python needs cmake, just like qdldl-python https://github.com/osqp/osqp-python/blob/master/setup.py#L222 so it must be added to the `dependencies` file.",
    "created_at": "2022-08-06T09:47:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482740",
    "user": "fbissey"
}
```
...
```json
{
    "body": "I very much doubt that ecos_python depend on suitesparse. It vendors its own copies of amd, ldl and suitesparse_config. And by the look of it there may be some customisation by macro definition and the copies themselves are ancient (more than 4 years old, possibly forked more than 8 years ago). \n\nosqp also has its bits of suitesparse (amd+suitesparse_config) and so does scs (amd+suitesparse_config again). All at various stage of ageing. And the c version of qdldl shows up everywhere.",
    "created_at": "2022-08-06T11:08:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482741",
    "user": "fbissey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482742",
    "user": "git"
}
```
...
```json
{
    "body": "I agree with your analysis. I've made these changes",
    "created_at": "2022-08-06T12:41:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482743",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482744",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482745",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482746",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482749",
    "user": "MartinPepin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482752",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482753",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482754",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "Thanks for the careful reading of the docstrings! I'll make changes later today.",
    "created_at": "2022-09-20T19:53:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482755",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "Replying to [comment:39 Martin P\u00e9pin]:\n> **In cvxpy_backend.pyx**\n> I get the following cython warning:\n> {{{\n> [cython] FutureWarning: Cython directive 'language_level' not set, using 2 for now\n> (Py2). This will change in a later release!\n> }}}\n> Shouldn't we write `# cython: language_level = 3` at the top of every new cython file?\n\nSince #33544, we set this globally (in `src/sage_setup/cython_options.py`).",
    "created_at": "2022-09-24T22:39:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482756",
    "user": "mkoeppe"
}
```

Replying to [comment:39 Martin Pépin]:
> **In cvxpy_backend.pyx**
> I get the following cython warning:
> {{{
> [cython] FutureWarning: Cython directive 'language_level' not set, using 2 for now
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482757",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482758",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482759",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482760",
    "user": "mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482761",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482762",
    "user": "git"
}
```
...
```json
{
    "body": "Replying to [comment:36 Martin P\u00e9pin]:\n> Some test do not pass, most notably: \n> \n> {{{\n> sage -t --long --random-seed=262306895609334379547192037378099413502 src/sage/numerical/backends/cvxpy_backend.pyx\n>     Killed due to segmentation fault\n\nOK, I can reproduce this now, using ubuntu-jammy",
    "created_at": "2022-09-25T04:50:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482763",
    "user": "mkoeppe"
}
```

Replying to [comment:36 Martin Pépin]:
> Some test do not pass, most notably: 
> 
> {{{
> sage -t --long --random-seed=262306895609334379547192037378099413502 src/sage/numerical/backends/cvxpy_backend.pyx
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482764",
    "user": "MartinPepin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482765",
    "user": "MartinPepin"
}
```
...
```json
{
    "body": "Yes, Sage-the-distribution has the same role as a Linux distribution like Debian.",
    "created_at": "2022-09-26T16:33:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482766",
    "user": "mkoeppe"
}
```
...
```json
{
    "body": "Attachment [cvxpy.log](tarball://root/attachments/some-uuid/ticket34251/cvxpy.log) by MartinPepin created at 2022-10-02 16:14:46",
    "created_at": "2022-10-02T16:14:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482767",
    "user": "MartinPepin"
}
```

Attachment [cvxpy.log](tarball://root/attachments/some-uuid/ticket34251/cvxpy.log) by MartinPepin created at 2022-10-02 16:14:46
...
```json
{
    "body": "After rebasing on develop, I now get the attached errors when running `sage -t --long --random-seed=262306895609334379547192037378099413502 src/sage/numerical/backends/cvxpy_backend.pyx`\n\nDon't know why the segfault occurred before but the new errors look minor now",
    "created_at": "2022-10-02T16:16:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482768",
    "user": "MartinPepin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482769",
    "user": "git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482770",
    "user": "git"
}
```
...
```json
{
    "body": "Tests at https://github.com/mkoeppe/sage/actions/runs/3476460100, https://github.com/mkoeppe/sage/actions/runs/3476460090",
    "created_at": "2022-11-16T04:51:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/34014",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/34014#issuecomment-482771",
    "user": "mkoeppe"
}
```
