# Issue 5655: [with patch, positive review] Improved enumeration of vertices and 0-dimensional faces
...
```json
{
    ...
    "title": "[with patch, positive review] Improved enumeration of vertices and 0-dimensional faces",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5655",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5655#event-13292"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5655#event-13293"
}
```
