...
sage: p1 = SetPartition([This is the Trac macro *s[0* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#s[0-macro), [s[1]]])
sage: p2 = SetPartition([This is the Trac macro *s[1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#s[1-macro), [s[0]]])
sage: p1 == p2
False
```
