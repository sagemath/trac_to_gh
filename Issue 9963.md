...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9963#issuecomment-99638",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9963#issuecomment-99640",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "I was a little too fast.  If an object has a `_pari_` method and a `_pari_init_` method, the `_pari_` method takes precedence, right?  So it doesn't hurt to have both (where `_pari_init` is then only used for Gp).",
    "created_at": "2010-09-24T16:41:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9963#issuecomment-99641",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Also note that currently no single object has a `_gp_` or `_gp_init_` method.",
    "created_at": "2010-09-24T16:45:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/9963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9963#issuecomment-99642",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/9963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/9963#issuecomment-99643",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9963#event-25138"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9963#event-25139"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9963#event-25140"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9963#event-25141"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9963#event-25142"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9963#event-25143"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/9963#event-25144"
}
```
