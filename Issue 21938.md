...
Attachment [singular-4.1.0p1.log](tarball://root/attachments/some-uuid/ticket22175/singular-4.1.0p1.log) by fbissey created at 2017-01-15 10:06:37
...
```json
{
    "body": "Attachment [config.log](tarball://root/attachments/some-uuid/ticket22175/config.log) by fbissey created at 2017-01-15 10:36:25\n\nI should have been more specific. `singular`'s `config.log` in `SAGE_LOCAL/var/tmp/sage/build/singular-4.1.0p1/src/` I think.",
...
Attachment [config.log](tarball://root/attachments/some-uuid/ticket22175/config.log) by fbissey created at 2017-01-15 10:36:25
