...
```json
{
    "body": "So... I want push the code but... it is ask the \"git`@`trac... password:\". (It is a strange problem, from an other folder of sage I have not this fu**** problem)",
    "created_at": "2014-11-19T14:58:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227443",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227444",
...
```json
{
    "body": "I have no real interest in this, but I'm curious as to whether such a long name needs to be in the global namespace.  We already have way too many categories there that are fairly \"empty\" when you try to use them directly (as opposed to giving properties to actual mathematical objects).",
    "created_at": "2014-11-19T17:47:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227445",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227446",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227447",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227448",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227449",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227450",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227451",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    "body": "Jean-Baptiste is proposing giving the `Compositions`, `Permutations` and `BinaryTrees` this treatment (as they are some of the first objects that will be used to create a CHA).  I propose adding `SetPartitions` to that list since NCSym is already defined and should follow that structure.",
    "created_at": "2015-09-22T17:33:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227454",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    "body": "In this category you would need to specify the enumeration and it is graded (by non-negative integers by default).\nFor each `n` one would specify a `FiniteEnumeratedSet` which is iterable.  Are you thinking of structures that are not captured by this definition?",
    "created_at": "2015-09-22T18:23:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227457",
    "user": "https://github.com/zabrocki"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227458",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227459",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227460",
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/17130#event-50075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227461",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227463",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227465",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227467",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227468",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227469",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/17130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/17130#issuecomment-227470",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
