...
```json
{
    "body": "So you suggest to return always a fraction? In that case we would need a good conversion from such fractions back to Laurent polynomials (for the ones that actually can be converted).",
    "created_at": "2016-07-06T14:47:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20726#issuecomment-286346",
    "user": "mmarco"
}
```
...
```json
{
    "body": "It is *really* annoying to not be able to do `1 / x` and stay within Laurent polynomials as there is a lot more functionality available than in the fraction field. So -1 on always returning an element in the fraction field (in this case).",
    "created_at": "2016-07-06T21:56:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/20726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20726#issuecomment-286348",
    "user": "tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20726#issuecomment-286349",
    "user": "vdelecroix"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/20726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/20726#issuecomment-286350",
    "user": "tscrim"
}
```
