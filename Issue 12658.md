...
```json
{
    "body": "Attachment [ecm-6.3.p4-p5.diff](tarball://root/attachments/some-uuid/ticket12830/ecm-6.3.p4-p5.diff) by leif created at 2012-04-11 11:25:28\n\nDiff between the previous spkg in Sage and my new p5 spkg.  For reference / review only.",
...
Attachment [ecm-6.3.p4-p5.diff](tarball://root/attachments/some-uuid/ticket12830/ecm-6.3.p4-p5.diff) by leif created at 2012-04-11 11:25:28
...
```json
{
    "body": "Attachment [ecm-6.3.p5-p6.diff](tarball://root/attachments/some-uuid/ticket12830/ecm-6.3.p5-p6.diff) by leif created at 2012-04-16 22:36:03\n\nDiff between my p5 and p6 spkgs.  For reference / review only.",
...
Attachment [ecm-6.3.p5-p6.diff](tarball://root/attachments/some-uuid/ticket12830/ecm-6.3.p5-p6.diff) by leif created at 2012-04-16 22:36:03
...
```json
{
    "body": "Attachment [ecm-6.3.p4-p6.diff](tarball://root/attachments/some-uuid/ticket12830/ecm-6.3.p4-p6.diff) by leif created at 2012-04-16 22:36:51\n\nDiff between the previous spkg in Sage and my new p6 spkg.  For reference / review only.",
...
Attachment [ecm-6.3.p4-p6.diff](tarball://root/attachments/some-uuid/ticket12830/ecm-6.3.p4-p6.diff) by leif created at 2012-04-16 22:36:51
