# Issue 4668: [with spkg, with positive review] libSingular's header have too tight permissions
...
```json
{
    ...
    "title": "[with spkg, with positive review] libSingular's header have too tight permissions",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4668",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/4668#event-10693"
}
```
