...
```json
{
    "body": "Attachment [trac_11897-doctest-RDF-eigenmatrix.rebased.patch](tarball://root/attachments/some-uuid/ticket11897/trac_11897-doctest-RDF-eigenmatrix.rebased.patch) by leif created at 2011-10-05 20:53:09\n\nRob's patch rebased on Sage 4.7.2.alpha3.",
...
Attachment [trac_11897-doctest-RDF-eigenmatrix.rebased.patch](tarball://root/attachments/some-uuid/ticket11897/trac_11897-doctest-RDF-eigenmatrix.rebased.patch) by leif created at 2011-10-05 20:53:09
...
```json
{
    "body": "Attachment [trac_11897-fix_noisy_zeroes_in_eigenvalues.reviewer.patch](tarball://root/attachments/some-uuid/ticket11897/trac_11897-fix_noisy_zeroes_in_eigenvalues.reviewer.patch) by leif created at 2011-10-06 16:28:11\n\nNext try.\n\n(I've attached a reviewer patch to be applied on top.)\n\nHopefully `2e-15` suffices for `bsd.math` as well... Apple c**p...",
...
Attachment [trac_11897-fix_noisy_zeroes_in_eigenvalues.reviewer.patch](tarball://root/attachments/some-uuid/ticket11897/trac_11897-fix_noisy_zeroes_in_eigenvalues.reviewer.patch) by leif created at 2011-10-06 16:28:11
