# Issue 5382: [with spkg, positive review] Update MPFR to 2.4.1 (security)
...
```json
{
    ...
    "title": "[with spkg, positive review] Update MPFR to 2.4.1 (security)",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5382#issuecomment-41371",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5382#issuecomment-41372",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5382",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/5382#event-12544"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5382#issuecomment-41373",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/5382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/5382#issuecomment-41374",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
