...
sage: ~SF.one()
s[]
sage: M = Matrix([This is the Trac macro *SF.one* that was inherited from the migration called with arguments ())](https://trac.sagemath.org/wiki/WikiMacros#SF.one-macro))
sage: M.determinant()
s[]
sage: ~M.determinant()
s[]
...
sage: ~S.one()
1
sage: M = Matrix([This is the Trac macro *S.one* that was inherited from the migration called with arguments ())](https://trac.sagemath.org/wiki/WikiMacros#S.one-macro))
...
sage: M = Matrix([This is the Trac macro *A.one* that was inherited from the migration called with arguments ())](https://trac.sagemath.org/wiki/WikiMacros#A.one-macro))
sage: M.is_invertible()
True
sage: M.inverse()
---------------------------------------------------------------------------
...
sage: M = Matrix([This is the Trac macro *NCSF.one* that was inherited from the migration called with arguments ())](https://trac.sagemath.org/wiki/WikiMacros#NCSF.one-macro))
sage: M.is_invertible()
True
sage: M.inverse()
---------------------------------------------------------------------------
...
sage: M = Matrix([This is the Trac macro *F.one* that was inherited from the migration called with arguments ())](https://trac.sagemath.org/wiki/WikiMacros#F.one-macro))
sage: M*M == M
True
sage: M.inverse()
---------------------------------------------------------------------------
