...
```
sage: vector(1/1) * matrix(Zmod(2),[This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro))
Unhandled SIGSEGV
```
...
sage: vector(1/1) * matrix(Zmod(2),[This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro))
(0)
sage: vector(1/1) * matrix(Zmod(11),[This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro))
(0)
```
...
```
sage: v=vector([Zmod(1)(1)]); m=matrix(Zmod(1),[This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro))
sage: v*m
sage: m*v
sage: m*m
```
...
sage: vector(1/1) * matrix(Zmod(11),[This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro))
(0)
sage: sage: v=vector([Zmod(1)(1)]); m=matrix(Zmod(1),[This is the Trac macro *1* that was inherited from the migration](https://trac.sagemath.org/wiki/WikiMacros#1-macro))
sage: sage: v*m
(0)
sage: sage: m*v
(0)
...
----> 1 vector(Integer(1)/Integer(1)) * matrix(Zmod(Integer(2)),[This is the Trac macro *Integer* that was inherited from the migration called with arguments (1))](https://trac.sagemath.org/wiki/WikiMacros#Integer-macro))
...
----> 1 vector(Integer(1)/Integer(1)) * matrix(Zmod(Integer(11)),[This is the Trac macro *Integer* that was inherited from the migration called with arguments (1))](https://trac.sagemath.org/wiki/WikiMacros#Integer-macro))
