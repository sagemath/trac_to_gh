...
```json
{
    ...
    "title": "[patch] graphs: Lots of various doc changes and additional doc tests.",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/761#issuecomment-4512",
    "user": "jason"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/761#issuecomment-4513",
    "user": "rlm"
}
```
