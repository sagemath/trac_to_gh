 ...
 * _`combinat/combinat.py`_: `euler_number()` (#17770 and #20763)
 * _`geometry/lattice_polytope.py`_: `positive_integer_relations()` (see #20766)
 * _`functions/orthogonal_polys.py`_: `hermite()` (#20297), `jacobi_P()` (#22326), `laguerre()` (#16813), `legendre_P/Q()` (#17151), `ultraspherical()` (#20428)
 ...
 * _`symbolic/expression.pyx`_: `Ex.assume()`, `forget()`, `assume_str()`, `assert()`, `expand_trig()`, `reduce_trig()`, `coefficients()` (#20455), `poly()` (#20455), `maxima_methods()`, `rectform()`, `simplify()`, `simplify_real()`, `simplify_rational()` (#21335), `simplify_log()`, `expand_log()`, `factor()` (#23835), `solve()`, `sum()`
 ...
 * _`functions/special.py`_: spherical_hankel1/2(), spherical_harmonic (#15024, #20939)
 ...
 * _`symbolic/expression.pyx`_: Expression._maxima_(), taylor(), combine() (#21034), partial_fraction() (#25645), simplify_hypergeometric(), simplify_factorial(), canonicalize_radical()
