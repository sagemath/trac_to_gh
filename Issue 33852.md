# Issue 33852: stock prices don't work anymore
...
```json
{
    "body": "I think this ticket would be a duplicate of #26754, except that the ticket was closed because #32427 supposedly deprecated all of sage.finance. Does something still need to be done?",
    "created_at": "2022-06-26T20:03:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/33852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33852#issuecomment-480290",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33852#issuecomment-480292",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33852#event-89107"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/33852#event-89108"
}
```
