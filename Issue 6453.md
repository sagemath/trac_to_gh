# Issue 6453: [with spkg, positive review] MPFR test failures on Solaris 10 update 4 on host 't2'
...
```json
{
    ...
    "closed_at": "2009-07-24T06:58:59Z",
    ...
    "title": "[with spkg, positive review] MPFR test failures on Solaris 10 update 4 on host 't2'",
    "type": "issue",
