...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342313",
    "user": "https://trac.sagemath.org/admin/accounts/users/gouezel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342315",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342316",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342317",
    "user": "https://trac.sagemath.org/admin/accounts/users/gouezel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342318",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342319",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342320",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19051#event-60267"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342321",
    "user": "https://trac.sagemath.org/admin/accounts/users/gouezel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342322",
    "user": "https://trac.sagemath.org/admin/accounts/users/gouezel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342323",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342324",
    "user": "https://trac.sagemath.org/admin/accounts/users/gouezel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342325",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342326",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>\nI already tried a different linking order, it does not make any difference.\n\nHere is the difference between (working) sage.6.8.beta2 and (failing) sage.6.9.beta2 regarding symbols:\n\nin 6.8.beta2:\n\n```\nnm /home/Sebastien/sage13/sage/local/lib build/temp.cygwin-1.7.35-x86_64-2.7/build/cythonized/sage/modular/arithgroup/farey_symbol.o | grep `_to_`SL2Z\n000000000001f190 T convert_to_SL2Z\n\nnm build/temp.cygwin-1.7.35-x86_64-2.7/sage/modular/arithgroup/farey.o | grep `_to_`SL2Z\n                 U convert_to_SL2Z\n```\n\nin 6.9.beta2:\n\n```\nnm build/temp.cygwin-2.2.0-x86_64-2.7/home/Sebastien/sage15/sage/src/build/cythonized/sage/modular/arithgroup/farey_symbol.o | grep `_to_`SL2Z\n000000000001cfa0 T convert_to_SL2Z\n\nnm build/temp.cygwin-2.2.0-x86_64-2.7/sage/modular/arithgroup/farey.o | grep `_to_`SL2Z\n                 U `__imp_convert_to_`SL2Z\n```\n\nlooks like the symbol in farey.o got prefixed by `__imp_`for some reason. So, the symbols in the two files do not match... Is this `__imp_` some kind of cython magic? Is it there on other platforms?",
    "created_at": "2015-08-19T13:02:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342327",
    "user": "https://trac.sagemath.org/admin/accounts/users/gouezel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342328",
    "user": "https://trac.sagemath.org/admin/accounts/users/gouezel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19051#event-60268"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19051#issuecomment-342329",
