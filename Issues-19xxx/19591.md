...
```json
{
    "body": "hmm, how is it supposed to work ? I am not able to zoom.",
...
```json
{
    "body": "Here is a very very small commit that changes the default list of colors used by d3js. We used to select \"category20\" but as you can see consecutive colors can be very close to each other, and it made visualization more difficult.\n\nhttp://bl.ocks.org/aaizemberg/78bd3dade9593896a59d\n\nNow this looks better:\n\n```\nsage: graphs.PathGraph(10).show(method='js',vertex_partition=[[i] for i in range(10)])\n```",
...
```json
{
    "body": "It would be cool if somebody could review this. I keep reaplying it over and over each time I am done with my work on another branch, that's how useful this thing is to me.\n\nNathann",
...
```json
{
    "body": "How is the zoom supposed to work? I tried everything, but no change.",
...
```json
{
    "body": "Nevermind, I forgot to rebuild Sage. :-/",
...
```json
{
    "body": "OK, I got it working now. The added code is short and does what it advertises. For me this is OK, but it should probably be reapplied to the latest version. I actually have no immediate clue of how to reapply, so if you reapply it, I'll re-review it immediately.",
...
```json
{
    "body": "Hmm, it's been a long week with many early mornings and late evenings, and I guess I was half a sleep yesterday evening. Don't mind my gibberish. I had a new look at your code (since I don't trust my ability to make a good judgement yesterday), and the code looks OK.\n\nCheers\nNico",
...
```json
{
    "body": "Thaaaaaaaanks for the review !!! If this code is as useful to others as it is to me, I swear that it is a good addition `:-)`\n\nNathann",
