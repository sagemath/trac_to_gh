...
```json
{
    "body": "<a id='comment:25'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[fc4cc3c](https://git.sagemath.org/sage.git/commit/?id=fc4cc3cca72d96ce9d3e6b86c542e7e4b91dbf55)|`intro for the french legacy sagenb section`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                              |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[6bb46f7](https://git.sagemath.org/sage.git/commit/?id=6bb46f7afdde3205cfa7ded3b91321d3612a370f)|`Significantly update PREP logging on page for Export/Jupyter`|",
...
```json
{
    "body": "<a id='comment:31'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                 |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|\n|[d1b4e1b](https://git.sagemath.org/sage.git/commit/?id=d1b4e1b2ceb6c5ba24aac46304093f1a6dab707b)|`Update intro tutorial with Jupyter pics and doc`|",
...
```json
{
    "body": "<a id='comment:33'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                        |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[b018055](https://git.sagemath.org/sage.git/commit/?id=b01805591cdcbb3fb052f02501ac0174b4f0d2ac)|`Update pt translation for Jupyter more`|\n|[95cdd4b](https://git.sagemath.org/sage.git/commit/?id=95cdd4b1c483d00c65c7fc7164a08ba10e844b16)|`Add notes regarding filesystem for SageNB/Jupyter`|",
