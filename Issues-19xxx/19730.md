...
```json
{
    "body": "<a id='comment:2'></a>What prevents you from using the objective C compiler which comes with Xcode?",
...
<a id='comment:2'></a>What prevents you from using the objective C compiler which comes with Xcode?
...
<a id='comment:5'></a>Replying to [cnassau](#comment%3A4):
> I just wouldn't want to force users of the package to install X-code.
