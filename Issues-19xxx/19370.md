...
```json
{
    "body": "Changing commit from \"c953b2e7c3dab533a3caa864b061019ae7ef6ce1\" to \"f39401adac20a5eb4c9bae6a8a3f56c70995f172\"",
    "created_at": "2015-10-07T23:19:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346739",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "c953b2e7c3dab533a3caa864b061019ae7ef6ce1" to "f39401adac20a5eb4c9bae6a8a3f56c70995f172"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346740",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Building with `SAGE_DEBUG=1` to try to get to the root of the present segfault. `maxima` will not build on top of `ecl` built with `SAGE_DEBUG=1` (regardless of setting for `maxima` itself). I do not know if it is unique to `El Capitan`.",
    "created_at": "2015-10-08T01:14:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346741",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:4'></a>Building with `SAGE_DEBUG=1` to try to get to the root of the present segfault. `maxima` will not build on top of `ecl` built with `SAGE_DEBUG=1` (regardless of setting for `maxima` itself). I do not know if it is unique to `El Capitan`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346742",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Do you mean `SAGE_DEBUG=yes`? I don't see any reason why `SAGE_DEBUG=1` would have any effect. In any case, I just tried a build on OS X 10.10 with `SAGE_DEBUG=1` and it went fine. Now I'm trying with `SAGE_DEBUG=yes`. I'll report on the results tomorrow.",
    "created_at": "2015-10-08T05:40:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346743",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:7'></a>Do you mean `SAGE_DEBUG=yes`? I don't see any reason why `SAGE_DEBUG=1` would have any effect. In any case, I just tried a build on OS X 10.10 with `SAGE_DEBUG=1` and it went fine. Now I'm trying with `SAGE_DEBUG=yes`. I'll report on the results tomorrow.
...
```json
{
    "body": "<a id='comment:8'></a>I thought the important bit was for `SAGE_DEBUG` to be defined but may be some `spkg-install` look specifically for `yes`.",
    "created_at": "2015-10-08T06:16:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346744",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:8'></a>I thought the important bit was for `SAGE_DEBUG` to be defined but may be some `spkg-install` look specifically for `yes`.
...
```json
{
    "body": "<a id='comment:10'></a>Run the command `grep -R SAGE_DEBUG build/pkgs/` to see the uses of `SAGE_DEBUG`: most test whether it is \"yes\".\n\nOn OS X 10.10 with `SAGE_DEBUG=yes` for the entire Sage build, `maxima` fails to build, `zn_poly` and `singular` build successfully. (I do not have `SAGE_CHECK` set, by the way.)",
    "created_at": "2015-10-08T14:57:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346746",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:10'></a>Run the command `grep -R SAGE_DEBUG build/pkgs/` to see the uses of `SAGE_DEBUG`: most test whether it is "yes".
...
```json
{
    "body": "<a id='comment:11'></a>OK retrying with `SAGE_DEBUG=yes` I should have thought of grepping. Interesting that maxima fails when `ecl` has debug code. There are a few extra things that seem to be required to link when `sage` itself is not compiled with `-DNDEBUG`, at least on OS X but that's possibly a different issue.",
    "created_at": "2015-10-08T21:36:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346747",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:11'></a>OK retrying with `SAGE_DEBUG=yes` I should have thought of grepping. Interesting that maxima fails when `ecl` has debug code. There are a few extra things that seem to be required to link when `sage` itself is not compiled with `-DNDEBUG`, at least on OS X but that's possibly a different issue.
...
```json
{
    "body": "<a id='comment:12'></a>For the record, the symbol is indeed in libsingular on OSX10.10:\n\n```\n$ nm local/lib/libsingular.dylib | grep  _om_BinPageIndicies\n0000000000674a58 S _om_BinPageIndicies\n```",
    "created_at": "2015-10-08T23:02:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346748",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:12'></a>For the record, the symbol is indeed in libsingular on OSX10.10:
...
```json
{
    "body": "<a id='comment:13'></a>Thanks for the info Volker, I will have to check if it is, in a non-debug build of singular.",
    "created_at": "2015-10-08T23:04:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346749",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:13'></a>Thanks for the info Volker, I will have to check if it is, in a non-debug build of singular.
...
```json
{
    "body": "<a id='comment:15'></a>PPS: let me know if you want an account on the OSX 10.10 buildbot to compare with...",
    "created_at": "2015-10-08T23:07:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346751",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:15'></a>PPS: let me know if you want an account on the OSX 10.10 buildbot to compare with...
...
```json
{
    "body": "<a id='comment:16'></a>I'll think about the offer but I may be too split for time to run things on the two fronts at the same time. I will definitely check what happens here regarding `singular`.\n\nI really need to get a debug build in shape if I want to track that segfault.",
    "created_at": "2015-10-08T23:13:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346752",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:16'></a>I'll think about the offer but I may be too split for time to run things on the two fronts at the same time. I will definitely check what happens here regarding `singular`.
...
```json
{
    "body": "<a id='comment:18'></a>Thats normal, a self-compiled gdb lacks permissions on OSX to debug. Run gdb as root or figure out how to properly codesign it (the latter didn't work for me when I tried once it but is supposed to work).",
    "created_at": "2015-10-09T08:38:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346754",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:18'></a>Thats normal, a self-compiled gdb lacks permissions on OSX to debug. Run gdb as root or figure out how to properly codesign it (the latter didn't work for me when I tried once it but is supposed to work).
...
```json
{
    "body": "<a id='comment:20'></a>Looks like it uses the system clang _Unwind_RaiseException, whereas it should be using the one from SAGE_ROOT/local/lib/libgcc",
    "created_at": "2015-10-09T09:52:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346756",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:20'></a>Looks like it uses the system clang _Unwind_RaiseException, whereas it should be using the one from SAGE_ROOT/local/lib/libgcc
...
```json
{
    "body": "<a id='comment:21'></a>Yes I can find the symbol in `libgcc_s_x86_64.1.dylib`. I may have to re-attempt rpath-ing the whole thing. I am fairly sure that the first time I only managed to rpath all the dylibs, unfortunately python modules, still in `.so` in vanilla sage, are bundles which is a different linking option on OS X.",
    "created_at": "2015-10-09T10:10:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346757",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:21'></a>Yes I can find the symbol in `libgcc_s_x86_64.1.dylib`. I may have to re-attempt rpath-ing the whole thing. I am fairly sure that the first time I only managed to rpath all the dylibs, unfortunately python modules, still in `.so` in vanilla sage, are bundles which is a different linking option on OS X.
...
```json
{
    "body": "<a id='comment:26'></a>I think we are hit by this incredibly trivial (and incredibly powerful) bug in the gmp build-system: https://lists.macosforge.org/pipermail/macports-tickets/2014-September/170442.html \n\nThe problem is that OS 10.10 and OS 10.11 are erroneously recognized as OSX 10.1 (!) Among other things this leads to a corrupted gcc which is hit by internal compiler errors when optimization is turned on.\n\nI have added a (somewhat hasty) patch for gmp which at least fixes the two test failures t-divrem_1 and t-fat. This patch is on the trac branch u/cnassau/capitan . The gmp test-suite still fails, but now at a later stage (cxx).",
    "created_at": "2015-10-11T21:20:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346761",
    "user": "https://github.com/cnassau"
}
```

<a id='comment:26'></a>I think we are hit by this incredibly trivial (and incredibly powerful) bug in the gmp build-system: https://lists.macosforge.org/pipermail/macports-tickets/2014-September/170442.html 
...
```json
{
    "body": "<a id='comment:27'></a>That bug is old. It can be worked around by setting MACOSX_DEPLOYMENT_TARGET=10.9, see src/bin/sage-env. The latter file almost certainly needs to be updated to also set it for 10.11",
    "created_at": "2015-10-11T22:25:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346762",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:27'></a>That bug is old. It can be worked around by setting MACOSX_DEPLOYMENT_TARGET=10.9, see src/bin/sage-env. The latter file almost certainly needs to be updated to also set it for 10.11
...
```json
{
    "body": "<a id='comment:28'></a>Indeed, with the obvious \"fix\" in sage-env I could now build all of sage and start running the doctests. My 40G harddrive overflowed during the build because I kept the full installation logs (sigh), and I now get plenty of doctest failures, apparently due to missing packages (sympy, conway_polynomials, ...). Will have to rebuild, it seems...",
    "created_at": "2015-10-12T09:11:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346763",
    "user": "https://github.com/cnassau"
}
```

<a id='comment:28'></a>Indeed, with the obvious "fix" in sage-env I could now build all of sage and start running the doctests. My 40G harddrive overflowed during the build because I kept the full installation logs (sigh), and I now get plenty of doctest failures, apparently due to missing packages (sympy, conway_polynomials, ...). Will have to rebuild, it seems...
...
```json
{
    "body": "<a id='comment:29'></a>Yup, after a clean rebuild I get just these errors from \"make ptest\":\n\n```\n----------------------------------------------------------------------\nsage -t src/sage/libs/lcalc/lcalc_Lfunction.pyx  # 85 doctests failed\n----------------------------------------------------------------------\nTotal time for all tests: 1863.5 seconds\n    cpu time: 5238.4 seconds\n    cumulative wall time: 7144.0 seconds\nmake: *** [ptest] Error 1\n```",
    "created_at": "2015-10-12T12:50:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346764",
    "user": "https://github.com/cnassau"
}
```

<a id='comment:29'></a>Yup, after a clean rebuild I get just these errors from "make ptest":
...
```json
{
    "body": "<a id='comment:30'></a>I wonder how to proceed from here: the resulting sage is functional, but libraries are only found in the original build-location. Using install_name_tool for all produced dynlibs seems unpractical to me...\n\nCould we maybe trick the linker into \"flat_namespace\" mode by exporting something like `CFLAGS=\"-Wl,-flat_namespace\"` globally? Any opinions if that might be a viable option?",
    "created_at": "2015-10-12T14:29:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346765",
    "user": "https://github.com/cnassau"
}
```

<a id='comment:30'></a>I wonder how to proceed from here: the resulting sage is functional, but libraries are only found in the original build-location. Using install_name_tool for all produced dynlibs seems unpractical to me...
...
```json
{
    "body": "Changing branch from \"u/fbissey/capitan\" to \"u/ohanar/elcapitan\"",
    "created_at": "2015-10-13T02:15:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346767",
    "user": "https://github.com/ohanar"
}
```

Changing branch from "u/fbissey/capitan" to "u/ohanar/elcapitan"
...
```json
{
    "body": "<a id='comment:32'></a>All doctests pass for me with the attached branch, although the linker really doesn't like having `MACOSX_DEPLOYMENT_TARGET` being set to 10.9.\n\n---\nNew commits:",
    "created_at": "2015-10-13T02:15:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346768",
    "user": "https://github.com/ohanar"
}
```

<a id='comment:32'></a>All doctests pass for me with the attached branch, although the linker really doesn't like having `MACOSX_DEPLOYMENT_TARGET` being set to 10.9.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346769",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    "body": "Changing commit from \"f39401adac20a5eb4c9bae6a8a3f56c70995f172\" to \"d3f5e995393794d56bc73bd05faebfaa784a2afe\"",
    "created_at": "2015-10-13T02:15:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346770",
    "user": "https://github.com/ohanar"
}
```

Changing commit from "f39401adac20a5eb4c9bae6a8a3f56c70995f172" to "d3f5e995393794d56bc73bd05faebfaa784a2afe"
...
```json
{
    "body": "<a id='comment:33'></a>I thought I had done `lcalc`, obviously not. I am guessing that may have been a big source of my troubles.",
    "created_at": "2015-10-13T04:01:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346771",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:33'></a>I thought I had done `lcalc`, obviously not. I am guessing that may have been a big source of my troubles.
...
```json
{
    "body": "<a id='comment:34'></a>OK testing it. Andrew, is it ok if I review your changes and you review mine? I guess Christian can do some reviewing too. That would mean we would have one reviewer that is not also an author.",
    "created_at": "2015-10-13T21:15:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346772",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:34'></a>OK testing it. Andrew, is it ok if I review your changes and you review mine? I guess Christian can do some reviewing too. That would mean we would have one reviewer that is not also an author.
...
```json
{
    "body": "Changing reviewer from \"\" to \"Fran\u00e7ois Bissey, Andrew Ohana\"",
    "created_at": "2015-10-14T02:05:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346773",
    "user": "https://github.com/kiwifb"
}
```

Changing reviewer from "" to "François Bissey, Andrew Ohana"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346774",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>And `sage` starts here too. I'll run the doctests overnight since my poor laptop is not that fast. But I am not expecting any problems. Please check I didn't do anything wrong with your name in the appropriate fields Andrew.",
    "created_at": "2015-10-14T02:05:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346775",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:35'></a>And `sage` starts here too. I'll run the doctests overnight since my poor laptop is not that fast. But I am not expecting any problems. Please check I didn't do anything wrong with your name in the appropriate fields Andrew.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346776",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346778",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>> But I think we have an important milestone, `sage` can be built on `El Capitan` and I think after adding a warning we should merge it immediately.\n\n\nNo problem. Could you maybe create a new ticket for the follow up issues? I'd be happy to set this ticket back to positive-review then.",
    "created_at": "2015-10-14T07:54:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346780",
    "user": "https://github.com/cnassau"
}
```

<a id='comment:38'></a>> But I think we have an important milestone, `sage` can be built on `El Capitan` and I think after adding a warning we should merge it immediately.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346784",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    "body": "<a id='comment:42'></a>Replying to [yomcat](#comment%3A41):\n> Replying to [cnassau](#comment%3A40):\n> \n> I redid the build with a `make distclean` (I did this the first time, but I think something went wrong with it), followed by `export MAKE=\"make -j6\"; make ptestlong`, and all tests passed.\n\n\nWonderful! I'll give this ticket its positive review back then.",
    "created_at": "2015-10-14T18:10:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346785",
    "user": "https://github.com/cnassau"
}
```

<a id='comment:42'></a>Replying to [yomcat](#comment%3A41):
> Replying to [cnassau](#comment%3A40):
> 
> I redid the build with a `make distclean` (I did this the first time, but I think something went wrong with it), followed by `export MAKE="make -j6"; make ptestlong`, and all tests passed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346786",
    "user": "https://github.com/cnassau"
}
```
...
```json
{
    "body": "<a id='comment:44'></a>We could support \"upgrading\" to `El Capitan` by bumping the versions of `lcalc`, `R`, `singular` and `cliquer`. That would force their rebuild.",
    "created_at": "2015-10-14T20:30:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346788",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:44'></a>We could support "upgrading" to `El Capitan` by bumping the versions of `lcalc`, `R`, `singular` and `cliquer`. That would force their rebuild.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346789",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "<a id='comment:45'></a>With this branch on OS X 10.11, Cython failed its test suite for me. See [log file http://www.math.washington.edu/~palmieri/Sage/cython-0.23.1.p0.log].\n\nShould we set this back to \"needs work\"?\n\n(I also had a failure with gf2x, but I think that was an instance of #18882. It passed its test suite when I ran it a second time.)",
    "created_at": "2015-10-15T23:02:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346790",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:45'></a>With this branch on OS X 10.11, Cython failed its test suite for me. See [log file http://www.math.washington.edu/~palmieri/Sage/cython-0.23.1.p0.log].
...
```json
{
    "body": "<a id='comment:46'></a>I am quite unwilling to put it back to work personally but this needs investigating. Would upgrading `cython` to 0.23.3 (#19334) improve the situation? And of course is it an `El Capitan` only problem or does it show up anywhere else?",
    "created_at": "2015-10-15T23:14:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346791",
    "user": "https://github.com/kiwifb"
}
```

<a id='comment:46'></a>I am quite unwilling to put it back to work personally but this needs investigating. Would upgrading `cython` to 0.23.3 (#19334) improve the situation? And of course is it an `El Capitan` only problem or does it show up anywhere else?
...
```json
{
    "body": "<a id='comment:47'></a>Just do it on a separate ticket.",
    "created_at": "2015-10-16T00:31:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346792",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:47'></a>Just do it on a separate ticket.
...
```json
{
    "body": "<a id='comment:48'></a>I see the same problem on OS X 10.10, so let's keep this as \"positive review\".",
    "created_at": "2015-10-16T00:34:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346793",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:48'></a>I see the same problem on OS X 10.10, so let's keep this as "positive review".
...
```json
{
    "body": "Changing branch from \"u/ohanar/elcapitan\" to \"d3f5e995393794d56bc73bd05faebfaa784a2afe\"",
    "created_at": "2015-10-16T08:22:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346796",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/ohanar/elcapitan" to "d3f5e995393794d56bc73bd05faebfaa784a2afe"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19370#event-53579"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346797",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    "body": "Changing commit from \"d3f5e995393794d56bc73bd05faebfaa784a2afe\" to \"\"",
    "created_at": "2017-07-19T09:22:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346798",
    "user": "https://github.com/fchapoton"
}
```

Changing commit from "d3f5e995393794d56bc73bd05faebfaa784a2afe" to ""
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346799",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    "body": "<a id='comment:52'></a>for uniqueness of names",
    "created_at": "2017-07-19T09:22:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19370#issuecomment-346800",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:52'></a>for uniqueness of names
