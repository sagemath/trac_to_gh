...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278681",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278682",
    "user": "https://trac.sagemath.org/admin/accounts/users/r.gaia.cs"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket19433/r-3.2.2.p0.log",
    "created_at": "2015-10-19T06:18:14Z",
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket19433/r-3.2.2.p0.log",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [r-3.2.2.p0.log](https://github.com/sagemath/sage/files/ticket19433/r-3.2.2.p0.log) by @jdemeyer created at 2015-10-19 06:18:14\n\nAnd which version of Sage is this?",
    "created_at": "2015-10-19T06:18:14Z",
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278683",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278684",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278685",
    "user": "https://trac.sagemath.org/admin/accounts/users/r.gaia.cs"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278686",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278687",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19433#issuecomment-278688",
