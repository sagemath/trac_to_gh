...
```json
{
    "body": "The maxima long line error is now #19876. It doesn't have anything to do with cell magics either, it a expect interface bug.\n\nThe online documentation works for me. Did you build the docs? Whats the content of `SAGE_LOCAL/share/jupyter/kernels/sagemath`",
...
```json
{
    "body": "Ok, seems like there is an issue if the notebook is in a subdirectory. This is now #19885\n\nFeel free to open a ticket for your R issue.",
