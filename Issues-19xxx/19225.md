...
```json
{
    "body": "This still happens in SageMath 8.0.beta12.",
...
```json
{
    "body": "I am now working on a more minimal solution.  After splitting off part of it into #29225, I realised that time has progressed by exactly 10<sup>4</sup> tickets...",
...
```json
{
    "body": "Of course I didn't empty the \"commit\" field on purpose.",
