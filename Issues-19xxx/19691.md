# Issue 19691: doctest fix for infinities break the hash contract
...
```json
{
    ...
    "milestone": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19691#event-54408"
}
```
...
```json
{
    ...
    "milestone": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19691#event-54409"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19691#event-54410"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19691",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19691#event-54411"
}
```
