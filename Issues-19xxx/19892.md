...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358457",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "milestone": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19892#event-54360"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I am going through the code, but there are some explanations I don't fully understand. For instance, can you give an example of the phnomenon explained in \n\n```\n                    # Do not append ``zero_part`` yet! It might be\n                    # redundant (in the sense that some of its defining\n                    # inequalities are always equalities on it). Check for\n                    # this:\n```\n\nplease?",
    "created_at": "2016-01-27T17:51:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358459",
    "user": "https://github.com/miguelmarco"
}
```

<a id='comment:4'></a>I am going through the code, but there are some explanations I don't fully understand. For instance, can you give an example of the phnomenon explained in 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358460",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>(I think it's the EXAMPLES with only one colon in the docstring face_semigroup_algebra that is breaking the docbuild.)",
    "created_at": "2016-01-27T18:19:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358461",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:6'></a>(I think it's the EXAMPLES with only one colon in the docstring face_semigroup_algebra that is breaking the docbuild.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358462",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358464",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358466",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358468",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358469",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358470",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358471",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358472",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>The doc seems to build now -- canyou confirm?",
    "created_at": "2016-01-28T16:16:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358473",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:13'></a>The doc seems to build now -- canyou confirm?
...
```json
{
    "body": "<a id='comment:14'></a>The doc seems to build now -- canyou confirm?",
    "created_at": "2016-01-28T16:16:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358474",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:14'></a>The doc seems to build now -- canyou confirm?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358475",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358476",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358478",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Aaand thanks again!!",
    "created_at": "2016-01-28T23:36:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358479",
    "user": "https://github.com/darijgr"
}
```

<a id='comment:18'></a>Aaand thanks again!!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358480",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19892#event-54361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19892#issuecomment-358481",
    "user": "https://github.com/vbraun"
}
```
