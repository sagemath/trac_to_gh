...
```json
{
    "body": "<a id='comment:1'></a>It makes sense to me that a vector basis should be mutable. For example, what if you wanted to normalize the basis, order it or replace a basis vector? The resulting contents of the instance could still be a valid basis. There could also be some abstract vector spaces whose basis vectors make sense as strings.",
    "created_at": "2015-12-31T02:28:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356528",
    "user": "https://trac.sagemath.org/admin/accounts/users/DayneSorvisto"
}
```

<a id='comment:1'></a>It makes sense to me that a vector basis should be mutable. For example, what if you wanted to normalize the basis, order it or replace a basis vector? The resulting contents of the instance could still be a valid basis. There could also be some abstract vector spaces whose basis vectors make sense as strings.
...
```json
{
    "body": "<a id='comment:4'></a>Looks like all Sage objects which define a '+' and can be immutable are failing. I tried matrices and graphs, and both have it.\n\nNathann",
    "created_at": "2015-12-31T09:11:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356531",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:4'></a>Looks like all Sage objects which define a '+' and can be immutable are failing. I tried matrices and graphs, and both have it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356532",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356533",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356534",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356535",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356536",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Replying to [nbruin](#comment%3A3):\n> Introspection seems to indicate:\n> `__iadd__`, `__imul__`,`__delitem__`,`__delslice__` should be intercepted.\n\n\nDone (except for `__delslice__`, which does not exist any more in Python 3).",
    "created_at": "2021-09-01T05:19:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356537",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:9'></a>Replying to [nbruin](#comment%3A3):
> Introspection seems to indicate:
> `__iadd__`, `__imul__`,`__delitem__`,`__delslice__` should be intercepted.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356538",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356539",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Note that Python's semantics for `A += B` are very close to `A = A + B`. The default is really that it is the latter (and NOT that `A += B` is an error). Some mutable types change the meaning to mutating behaviour instead of binding to a fresh object. Consider this:\n\n```\nsage: t1 = (1,2,3)\nsage: t2 = t1\nsage: t2 += (4,5,6) #this binds t2 to a new tuple\nsage: t1\n(1, 2, 3)\nsage: t2\n(1, 2, 3, 4, 5, 6)\nsage: l1 = [1,2,3]\nsage: l2 = l1\nsage: l2 += [4,5,6] #this mutates the list that l2 is bound to.\nsage: l1\n[1, 2, 3, 4, 5, 6]\nsage: l2\n[1, 2, 3, 4, 5, 6]\n```",
    "created_at": "2021-09-01T06:56:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356540",
    "user": "https://github.com/nbruin"
}
```

<a id='comment:11'></a>Note that Python's semantics for `A += B` are very close to `A = A + B`. The default is really that it is the latter (and NOT that `A += B` is an error). Some mutable types change the meaning to mutating behaviour instead of binding to a fresh object. Consider this:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356541",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356542",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356543",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356544",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356545",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356546",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Thanks for the comments! Here's a better version",
    "created_at": "2021-09-01T18:36:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356547",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:16'></a>Thanks for the comments! Here's a better version
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356548",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356551",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Right, and also the following does not even work:\n\n```\nsage: M = Sequence([1, 2, 3], immutable=False) \nsage: M * 2\nTypeError: unbound method SageObject.category() needs an argument\n```",
    "created_at": "2021-09-02T19:13:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356552",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:20'></a>Right, and also the following does not even work:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356553",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356554",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Here's another iteration for `__add__`, `__iadd__`...",
    "created_at": "2021-09-03T22:49:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356555",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:22'></a>Here's another iteration for `__add__`, `__iadd__`...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356556",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356557",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356558",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356559",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356560",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>The `Sequence` constructor uses `sage.structure.element.canonical_coercion` on adjacent elements from left to right.\n\nIt could probably be simplified using `coercion_model.common_parent`, but the constructor's parameter `use_sage_types=False` and fallbacks for non-coercible inputs are a complication",
    "created_at": "2021-09-04T18:16:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356561",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:27'></a>The `Sequence` constructor uses `sage.structure.element.canonical_coercion` on adjacent elements from left to right.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356562",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356563",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356564",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356565",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356566",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356567",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Here's a new version that implements this. I haven't tested ill-behaved elements yet.\n\nNext is to generalize the `Sequence` constructor so it can accept generators",
    "created_at": "2021-09-04T19:22:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356568",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:32'></a>Here's a new version that implements this. I haven't tested ill-behaved elements yet.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356569",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356570",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356571",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356572",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356574",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356575",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356576",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:38'></a>Replying to [nbruin](#comment%3A35):\n> Given that you're using the coercion maps in a coercion environment, I don't think you need to copy them. [...]\n\n\nThanks for the explanation, I agree.",
    "created_at": "2021-09-04T21:08:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356577",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:38'></a>Replying to [nbruin](#comment%3A35):
> Given that you're using the coercion maps in a coercion environment, I don't think you need to copy them. [...]
...
```json
{
    "body": "<a id='comment:39'></a>I think in the failing testcase of `3 * M`, `Integer.__mul__` calls `coercion_model.bin_op`, which seems to get confused by `M` being a `Parent`, not an `Element`",
    "created_at": "2021-09-04T21:11:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356578",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:39'></a>I think in the failing testcase of `3 * M`, `Integer.__mul__` calls `coercion_model.bin_op`, which seems to get confused by `M` being a `Parent`, not an `Element`
...
```json
{
    "body": "<a id='comment:40'></a>(`3r * M` works.)",
    "created_at": "2021-09-04T21:11:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356579",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:40'></a>(`3r * M` works.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356580",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    "body": "<a id='comment:41'></a>I think I need some help with this ticket",
    "created_at": "2021-10-13T17:02:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356581",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:41'></a>I think I need some help with this ticket
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356582",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19813#issuecomment-356583",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
