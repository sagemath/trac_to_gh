...
```json
{
    "body": "Changing branch from \"\" to \"u/novoselt/graph_eq\"",
    "created_at": "2015-08-24T03:16:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339425",
    "user": "https://github.com/novoselt"
}
```

Changing branch from "" to "u/novoselt/graph_eq"
...
```json
{
    "body": "Changing commit from \"\" to \"6e83ae06e04597ddcf92cd981f4f690c4b57deef\"",
    "created_at": "2015-08-24T03:17:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339427",
    "user": "https://github.com/novoselt"
}
```

Changing commit from "" to "6e83ae06e04597ddcf92cd981f4f690c4b57deef"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339428",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339429",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339431",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Speedup confirmed. After `P7 = Posets(7).list()` the command `P=Posets.ChainPoset(7)` took about 635 microseconds, after this patch it takes about 540 microseconds. I ran the test on i5-3470 `@` 3.20GHz.\n\nYou can mark this as positive_review. Or if you want, check my comment above.",
    "created_at": "2015-08-24T06:12:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339432",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:5'></a>Speedup confirmed. After `P7 = Posets(7).list()` the command `P=Posets.ChainPoset(7)` took about 635 microseconds, after this patch it takes about 540 microseconds. I ran the test on i5-3470 `@` 3.20GHz.
...
```json
{
    "body": "<a id='comment:6'></a>Just a note: if you ever want more speed than that for posets, it is possible to get it. Posets are stored internally as 'static sparse graphs', and that can be done in linear time (~m) instead of ~mlog(n) here.\n\nThat speedup with be small, however, compared to this one.\n\nNathann",
    "created_at": "2015-08-24T08:00:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339433",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:6'></a>Just a note: if you ever want more speed than that for posets, it is possible to get it. Posets are stored internally as 'static sparse graphs', and that can be done in linear time (~m) instead of ~mlog(n) here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339434",
...
```json
{
    "body": "Changing commit from \"6e83ae06e04597ddcf92cd981f4f690c4b57deef\" to \"536c4817a1a8521c49255b75c6a6b475d10e38d2\"",
    "created_at": "2015-08-24T15:49:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339435",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "6e83ae06e04597ddcf92cd981f4f690c4b57deef" to "536c4817a1a8521c49255b75c6a6b475d10e38d2"
...
```json
{
    "body": "<a id='comment:8'></a>Thanks for taking a look! Went over the rest of the code without changing the logic.\n\n---\nNew commits:",
    "created_at": "2015-08-24T15:52:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339436",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:8'></a>Thanks for taking a look! Went over the rest of the code without changing the logic.
...
```json
{
    "body": "<a id='comment:9'></a>You build a list of booleans that you do not need ... And if you use iterators, you will build an iterator that you do not need either.\n\nTechnically (though you did not introduce it) comparing labels by sorting lists if wrong, as you cannot suppose that the labels are TOTALLY ordered. Should be a set comparison instead.\n\nNathann",
    "created_at": "2015-08-24T16:46:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339437",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:9'></a>You build a list of booleans that you do not need ... And if you use iterators, you will build an iterator that you do not need either.
...
```json
{
    "body": "Changing commit from \"536c4817a1a8521c49255b75c6a6b475d10e38d2\" to \"f2a826c5f5b28ab793d1eb750a87d91f9bafbb96\"",
    "created_at": "2015-08-24T17:02:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339438",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "536c4817a1a8521c49255b75c6a6b475d10e38d2" to "f2a826c5f5b28ab793d1eb750a87d91f9bafbb96"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339439",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>You've changed the meaning: `labels=self._weighted and other._weighted` is consistent with the documentation, while `labels=self._weighted` is not.\n\nRegarding the multi-edge check: what I have tried to do was avoiding `sorted` since you have pointed out that labels may not be sortable. I don't see any real alternative to doing what I've done then.",
    "created_at": "2015-08-24T19:16:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339442",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:13'></a>You've changed the meaning: `labels=self._weighted and other._weighted` is consistent with the documentation, while `labels=self._weighted` is not.
...
```json
{
    "body": "<a id='comment:14'></a>> You've changed the meaning: `labels=self._weighted and other._weighted` is consistent with the documentation, while `labels=self._weighted` is not.\n\n\nI did that because it is tested several lines above that `self.weighted() == other.weighted()`.\n\n> Regarding the multi-edge check: what I have tried to do was avoiding `sorted` since you have pointed out that labels may not be sortable. I don't see any real alternative to doing what I've done then.\n\n\nOh. I see. Well, then if you want to compare lists like that, then it can be done on the lists of labels directly, instead of the lists of all edges.\n\nNathann",
    "created_at": "2015-08-24T20:06:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339443",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:14'></a>> You've changed the meaning: `labels=self._weighted and other._weighted` is consistent with the documentation, while `labels=self._weighted` is not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339446",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"f2a826c5f5b28ab793d1eb750a87d91f9bafbb96\" to \"959c85d02f96b679a1bc082543359554d496eeb7\"",
    "created_at": "2015-08-25T15:34:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339447",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "f2a826c5f5b28ab793d1eb750a87d91f9bafbb96" to "959c85d02f96b679a1bc082543359554d496eeb7"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339448",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>OK - no more long lists and no relying on sorting but doing it in case it helps. I guess complexity is now like `pairs_of_connected_vertices * number_of_labels_per_pair * log(number_of_labels_per_pair)` when there is order and without taking log when there is not.\n\n---\nNew commits:",
    "created_at": "2015-08-25T15:37:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339449",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:18'></a>OK - no more long lists and no relying on sorting but doing it in case it helps. I guess complexity is now like `pairs_of_connected_vertices * number_of_labels_per_pair * log(number_of_labels_per_pair)` when there is order and without taking log when there is not.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339450",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Ran `make ptestlong` with no issues. Thanks for reviewing and I'll work on improving my manners ;-)",
    "created_at": "2015-08-25T19:39:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339451",
    "user": "https://github.com/novoselt"
}
```

<a id='comment:20'></a>Ran `make ptestlong` with no issues. Thanks for reviewing and I'll work on improving my manners ;-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339452",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339453",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Okayyyy. Thanks for the code! And if you ever see graph equality reaching the top of the screen when you profile poset code, remember that some more can be saved there.\n\nThough of course, removing this 'UniqueRepresentation' inheritance would mean that there is no need to call `Graph.__eq__` anymore when a poset is created `:-P`\n\nNathann",
    "created_at": "2015-08-25T20:23:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339454",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:21'></a>Okayyyy. Thanks for the code! And if you ever see graph equality reaching the top of the screen when you profile poset code, remember that some more can be saved there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19077#event-53049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339455",
...
```json
{
    "body": "Changing branch from \"u/novoselt/graph_eq\" to \"959c85d02f96b679a1bc082543359554d496eeb7\"",
    "created_at": "2015-08-26T03:00:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19077",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19077#issuecomment-339456",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/novoselt/graph_eq" to "959c85d02f96b679a1bc082543359554d496eeb7"
