...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259164"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259165"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259166"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259167"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19550#issuecomment-281024",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19550#issuecomment-281025",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259168"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19550",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19550#event-259172"
}
```
