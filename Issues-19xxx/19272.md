...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|\n|[dfa11ac](http://git.sagemath.org/sage.git/commit/?id=dfa11ac492437cedd686081681fec297404ecf59)|`Removing work around for older version of networkx. It gets in the way in newer install.`|",
...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|\n|[2d9dfcd](http://git.sagemath.org/sage.git/commit/?id=2d9dfcdf97ce3b741d181b6f0c6f1f1cc68b880c)|`Networkx has a runtime dependency on decorator and may try to install it if not present`|",
...
```json
{
    "body": "<a id='comment:15'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[02a7a76](http://git.sagemath.org/sage.git/commit/?id=02a7a7653653a8c4c44ec936aa962c514b5ecce4)|`More robust test for networkx`|",
