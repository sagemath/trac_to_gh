...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357681",
    "user": "https://trac.sagemath.org/admin/accounts/users/malcolmkotok"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Note also ticket #15239 regarding testing for nondegeneracy, which might be worth dealing with first.",
    "created_at": "2016-04-05T02:49:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357683",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:3'></a>Note also ticket #15239 regarding testing for nondegeneracy, which might be worth dealing with first.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357684",
...
```json
{
    "body": "<a id='comment:5'></a>For (my own) convenience, the link to the code is http://hdl.handle.net/1802/30832.\n\nRelated projects: #20265, #23863.",
    "created_at": "2017-09-23T04:17:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357685",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:5'></a>For (my own) convenience, the link to the code is http://hdl.handle.net/1802/30832.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357686",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357687",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357688",
    "user": "https://trac.sagemath.org/admin/accounts/users/ursula"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I tried this code about a year ago and it seemed to have some serious problems like it not finishing for a plane quartic curve over F_p (for any p). I wrote to Kotok about this, but never heard back from him. It could be some trivial issue, but it is hard to say.",
    "created_at": "2017-10-10T14:25:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357689",
    "user": "https://trac.sagemath.org/admin/accounts/users/jantuitman"
}
```

<a id='comment:8'></a>I tried this code about a year ago and it seemed to have some serious problems like it not finishing for a plane quartic curve over F_p (for any p). I wrote to Kotok about this, but never heard back from him. It could be some trivial issue, but it is hard to say.
...
```json
{
    "body": "<a id='comment:9'></a>My understanding is that some successful experiments with the code were made at SD91. Maybe someone can push the result to trac so that the rest of us can help with stress-testing?",
    "created_at": "2017-10-11T05:05:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357690",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:9'></a>My understanding is that some successful experiments with the code were made at SD91. Maybe someone can push the result to trac so that the rest of us can help with stress-testing?
...
```json
{
    "body": "<a id='comment:10'></a>Ok, here is what I'm talking about:\n\n\n```\nload(\"ffzeta.sage\");\nR.<x,y>=PolynomialRing(ZZ,2);\n\n# does work:\nQ=y^2-(x^3+x+1); p=13;\nffzeta(Q,p,verbose=True);\n\n# does not work:\nQ=y^4+(5*x-4)*y^3+(3*x^2+2*x-3)*y^2+(x^3+4*x^2-2*x+3)*y+(3*x^4-2*x^3-4*x^2+2*x+2); p=11;\nffzeta(Q,p,verbose=True);\n\n```",
    "created_at": "2017-10-11T09:49:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357691",
    "user": "https://trac.sagemath.org/admin/accounts/users/jantuitman"
}
```

<a id='comment:10'></a>Ok, here is what I'm talking about:
...
```json
{
    "body": "<a id='comment:11'></a>The Sperber-Voight algorithm being implemented here has as a complexity parameter the number of interior monomials, so it probably doesn't stand much of a chance for dense equations (although descending it from Sage to Cython might help near the borderline).\n\nFor smooth projective hypersurfaces, we also have tickets #20265 (deformation) and #23863 (controlled reduction). For nondegenerate toric hypersurfaces, Edgar Costa has functioning C code doing controlled reduction, but I believe it is not yet available for public consumption.",
    "created_at": "2017-10-11T14:55:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357692",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:11'></a>The Sperber-Voight algorithm being implemented here has as a complexity parameter the number of interior monomials, so it probably doesn't stand much of a chance for dense equations (although descending it from Sage to Cython might help near the borderline).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357693",
...
```json
{
    "body": "<a id='comment:13'></a>We have some debugging to make this a method for polynomials.  There are definitely errors in the computation in the multivariate example at the beginning of the function.\n\n---\nNew commits:",
    "created_at": "2017-10-20T14:34:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357694",
    "user": "https://github.com/mckenziewest"
}
```

<a id='comment:13'></a>We have some debugging to make this a method for polynomials.  There are definitely errors in the computation in the multivariate example at the beginning of the function.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357695",
    "user": "https://github.com/mckenziewest"
}
```
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357696",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357697",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357698",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357699",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357700",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357701",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357702",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Maybe this could be saved ?",
    "created_at": "2019-10-08T16:11:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357703",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:17'></a>Maybe this could be saved ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357705",
...
```json
{
    ...
    "milestone": "sage-9.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54300"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357706",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54302"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54303"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54304"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54305"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54306"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54307"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19865#issuecomment-357708",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54308"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54309"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54310"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54311"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54312"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54313"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54314"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19865#event-54315"
}
```
