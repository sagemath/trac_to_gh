...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19518#event-258779"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19518#event-258780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280388",
    "user": "https://github.com/etn40ff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280389",
    "user": "https://github.com/etn40ff"
}
```
...
```json
{
    "body": "Changed keywords from **** to **GroupAlgebra PolynomialRing**",
    "created_at": "2015-11-04T12:25:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280390",
    "user": "https://github.com/etn40ff"
}
```

Changed keywords from **** to **GroupAlgebra PolynomialRing**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19518#event-258781"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280391",
    "user": "https://github.com/etn40ff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19518#event-258782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280392",
    "user": "https://github.com/etn40ff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19518#event-258783"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280393",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280394",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280395",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280396",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280397",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19518#issuecomment-280398",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19518#event-258784"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19518#event-258785"
}
```
