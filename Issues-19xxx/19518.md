...
<a id='comment:5'></a>This has uncovered a couple of different bugs:
...
```json
{
    "body": "<a id='comment:6'></a>doctests fail (cf. patchbot)",
...
<a id='comment:6'></a>doctests fail (cf. patchbot)
