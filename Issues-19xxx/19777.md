...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355758",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355759",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355760",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355761",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I think I already mentioned on another ticket that 2-intersection codes and 2-distance codes are (almost) the same thing. Why don't you add these 2-intersection codes to the corr. db, instead of hardcoding them into strongly_regular_graphs_db?",
    "created_at": "2015-12-24T14:34:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355762",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:3'></a>I think I already mentioned on another ticket that 2-intersection codes and 2-distance codes are (almost) the same thing. Why don't you add these 2-intersection codes to the corr. db, instead of hardcoding them into strongly_regular_graphs_db?
...
```json
{
    "body": "<a id='comment:5'></a>Hmmmm.. I used your code and generated the graph from the two weights code. For some reason it takes infinitely more time.\n\n```\nsage: %time strongly_regular_from_two_weight_code(c)\nCPU times: user 19 s, sys: 104 ms, total: 19.1 s\nWall time: 18.5 s\nGraph on 1024 vertices\n```",
    "created_at": "2015-12-24T16:06:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355764",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:5'></a>Hmmmm.. I used your code and generated the graph from the two weights code. For some reason it takes infinitely more time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355765",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>> well, all I am saying is that these matrices etc should go into the database; it's another story how to use them - nothing prevents you from calling the faster function on them...\n\n\nI understand, yet what you ask represents a big amount of work if you insist to make me do all of it.",
    "created_at": "2015-12-24T16:11:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355766",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:7'></a>> well, all I am saying is that these matrices etc should go into the database; it's another story how to use them - nothing prevents you from calling the faster function on them...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355767",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>> I can do the work, it's not a problem (although I currently have keyboard/mouse elbow, and should not do much typing for a while), but do you agree that by right this data must be in the `coding/` ?\n\n\nYeah yeah that's where it should be. At the moment I am trying to figure out what exactly needs to be done, and how. Turns out that the difference between a two-weight code and a two intersection set is merely a matrix transposition, is it?\n\nNathann",
    "created_at": "2015-12-24T16:19:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355768",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:9'></a>> I can do the work, it's not a problem (although I currently have keyboard/mouse elbow, and should not do much typing for a while), but do you agree that by right this data must be in the `coding/` ?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355769",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Okay, everything looks fairly straightforward. The only problem is with the SRG parameter 'guessing' from the two_weight codes. If we do the operation through the matrix's transpose I have no idea what parameters we end up with.\n\nNathann",
    "created_at": "2015-12-24T16:22:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355770",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:11'></a>Okay, everything looks fairly straightforward. The only problem is with the SRG parameter 'guessing' from the two_weight codes. If we do the operation through the matrix's transpose I have no idea what parameters we end up with.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355771",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>I still don't see a way to do the job cleanly.",
    "created_at": "2015-12-24T17:45:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355772",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:13'></a>I still don't see a way to do the job cleanly.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355773",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355775",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355776",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355777",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355779",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355780",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>I converted the old SRG from Disset into a code too. Cleaner. Slower, but cleaner.",
    "created_at": "2015-12-25T14:01:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355781",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:20'></a>I converted the old SRG from Disset into a code too. Cleaner. Slower, but cleaner.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355782",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>(and the time differences increases quickly with the size of the graph you build)",
    "created_at": "2015-12-25T16:47:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355784",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:23'></a>(and the time differences increases quickly with the size of the graph you build)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355785",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>............. because you made me do it ?..",
    "created_at": "2015-12-25T17:18:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355786",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:25'></a>............. because you made me do it ?..
...
```json
{
    "body": "<a id='comment:26'></a>What the hell man, I had those four functions in the strongly_regular_db file and you asked me to add them inside of the two-weight database. Now they are in he two-weight database and the SRG that correspond are built as they always were, through the \"SRG from 2-weight code\" function. \n\nI thought that you said you knew how to guess the parameters of the SRG that would be obtained when using the \"SRG from 2-intersection code\". Because that's the problem, in case it needs be said again: I cannot replace the first function by the other, for I don't know what exactly the parameters of the SRG will be. Will I get what I expect or its complement?\n\nIf you can guess that then you can use the faster of the two functions.\n\nNathann",
    "created_at": "2015-12-25T17:20:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355787",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:26'></a>What the hell man, I had those four functions in the strongly_regular_db file and you asked me to add them inside of the two-weight database. Now they are in he two-weight database and the SRG that correspond are built as they always were, through the "SRG from 2-weight code" function. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355788",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355791",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355792",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>this will need a bit more work --- not 100% ready for review yet. One part of it works more by an accident than due to theory.",
    "created_at": "2015-12-26T08:06:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355793",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:31'></a>this will need a bit more work --- not 100% ready for review yet. One part of it works more by an accident than due to theory.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355795",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Okay then,\n\nNathann",
    "created_at": "2015-12-26T12:36:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355796",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:34'></a>Okay then,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355797",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355798",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:36'></a>OK, ready now :-)",
    "created_at": "2015-12-26T22:53:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355799",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:36'></a>OK, ready now :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355802",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "<a id='comment:40'></a>It seems that those two codes generate the very same two graphs\n\n```\n{'q': 2, 'n': 73, 'source': 'Shared by Eric Chen [ChenDB]_.', 'w2': 40, 'w1': 32, 'k': 9}\n{'q': 2, 'n': 219, 'source': 'Shared by Eric Chen [ChenDB]_.', 'w2': 112, 'w1': 96, 'k': 9}\n```",
    "created_at": "2015-12-27T10:53:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355803",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:40'></a>It seems that those two codes generate the very same two graphs
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355804",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355805",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355806",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355807",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355809",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355810",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355811",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355812",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355813",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355814",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355815",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355816",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355817",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:49'></a>Seems that I am growing more incompetent with git every day. Sorry for the mess. I cleaned it and rebased the branch again `:-/`\n\nNathann",
    "created_at": "2015-12-28T14:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355818",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:49'></a>Seems that I am growing more incompetent with git every day. Sorry for the mess. I cleaned it and rebased the branch again `:-/`
...
```json
{
    "body": "<a id='comment:51'></a>4) What would you think of leaving the `SRG_` function in the index, even if that construction is overwritten by the 2-weight code one? I don't think that it hurt, and at least from the point of view of the code this list is still an index of all `SRG_*` functions.",
    "created_at": "2015-12-28T14:51:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355820",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:51'></a>4) What would you think of leaving the `SRG_` function in the index, even if that construction is overwritten by the 2-weight code one? I don't think that it hurt, and at least from the point of view of the code this list is still an index of all `SRG_*` functions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355822",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355823",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355824",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:55'></a>Okayyyyyyyy... Good to go? `:-)`\n\nNathann",
    "created_at": "2015-12-29T17:23:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355825",
    "user": "https://github.com/nathanncohen"
}
```

<a id='comment:55'></a>Okayyyyyyyy... Good to go? `:-)`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355826",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    "body": "<a id='comment:56'></a>good :-)",
    "created_at": "2015-12-30T21:27:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355827",
    "user": "https://github.com/dimpase"
}
```

<a id='comment:56'></a>good :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355828",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19777#issuecomment-355829",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19777",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19777#event-54169"
}
```
