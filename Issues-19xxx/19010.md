...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269832"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267521",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267522",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267523",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267524",
...
```json
{
    ...
    "milestone_title": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269836"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267525",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269838"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267526",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267527",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269840"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267529",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267530",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267531",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267532",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267533",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267534",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267535",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269842"
}
```
...
```json
{
    "body": "<div id=\"comment:14\" align=\"right\">comment:14</div>\n\nReplying to [@DaveWitteMorris](#comment:12):\n> After a bit of searching, I discovered that [#27468 comment:5](https://github.com/sagemath/sage/issues/27468#comment:5) says \"This fixes #19010 as well\". Feel free to edit the comment in my PR to mention #27468, or tell me what should be done.\n\nThanks, I was simply curious. Nothing to do.",
    "created_at": "2020-05-11T18:11:20Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267536",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19010#event-269844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19010#issuecomment-267537",
