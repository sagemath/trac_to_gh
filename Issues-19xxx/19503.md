...
<a id='comment:9'></a>Replying to [jdemeyer](#comment%3A5):
> Why did you *remove* `TESTS:` in some places?
...
<a id='comment:27'></a>Replying to [jmantysalo](#comment%3A26):
> I.e. have an environment variable or something
...
<a id='comment:29'></a>Replying to [jhpalmieri](#comment%3A17):
> The lines after the original test,
> 
> ```
>  Classes and methods
...
<a id='comment:38'></a>Replying to [jhpalmieri](#comment%3A37):
> Should we ask on sage-devel?
