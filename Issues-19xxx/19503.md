...
```json
{
    "body": "<a id='comment:10'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|\n|[95f8c72](http://git.sagemath.org/sage.git/commit/?id=95f8c726ec2344d9a1e37da64a5528bc5f7acc84)|`trac 19503: more documentation, minor fixes`|",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|\n|[c659e02](http://git.sagemath.org/sage.git/commit/?id=c659e025d483d55b4bf644fa2f367884c7a2ca20)|`trac 19503: don't publicly advertise SAGE_SKIP_TESTS_BLOCKS.`|",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|\n|[05c6521](http://git.sagemath.org/sage.git/commit/?id=05c6521b2c6645e043714d849f38964824cb1443)|`trac 19503: try to deal with situations where ReST headers end TESTS blocks`|",
...
```json
{
    "body": "<a id='comment:41'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[12533ac](http://git.sagemath.org/sage.git/commit/?id=12533acdc84f1f2c1db67dcd5925fdaf8a7a348a)|`Merge branch 'develop' into t/19503/TESTS`|",
    "created_at": "2015-11-13T22:11:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19503",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:45'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                                      |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|\n|[2c56292](http://git.sagemath.org/sage.git/commit/?id=2c56292b5dc44fb1b06dd0516d9f8fec61ce1e4b)|`trac 19503: detect 'fake' headers: lines that look like ReST headers`|",
