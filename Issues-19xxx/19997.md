...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19997#event-264703"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19997#event-264704"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19997#event-264705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19997#event-264706"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19997#issuecomment-289023",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19997#issuecomment-289024",
    "user": "https://github.com/rwst"
}
```
