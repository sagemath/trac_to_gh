...
```json
{
    "body": "<a id='comment:4'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                       |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|\n|[7973eea](http://git.sagemath.org/sage.git/commit/?id=7973eea1d6d6a807d02c690fe815ed69a832b393)|`Fixed failing doctest`|\n|[5931513](http://git.sagemath.org/sage.git/commit/?id=5931513893c6c02029cb2fe4460aa1981219e1d5)|`Properly formatted documentation`|\n|[a799c2d](http://git.sagemath.org/sage.git/commit/?id=a799c2d42157ec62eea564640fc244d2bfeb2fa8)|`Changed the way we patch matplotlib not to repackage the downloaded source`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------|\n|[d360f7a](http://git.sagemath.org/sage.git/commit/?id=d360f7a34c4c9bba6a7f6032edd62cccd0d2420e)|`Missing blank line`|",
