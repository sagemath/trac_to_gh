...
```json
{
    "body": "<a id='comment:1'></a>I think a good part of this is taken care of by #18066, but there will probably be some remaining things related to filtered/graded modules that we will need to address.",
    "created_at": "2015-10-11T19:28:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346275",
    "user": "https://github.com/tscrim"
}
```

<a id='comment:1'></a>I think a good part of this is taken care of by #18066, but there will probably be some remaining things related to filtered/graded modules that we will need to address.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346276",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346277",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Is this ticket still relevant?",
    "created_at": "2020-07-17T18:36:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346278",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:2'></a>Is this ticket still relevant?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346279",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53533"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53534"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346280",
...
```json
{
    "body": "<a id='comment:4'></a>So what's missing is a few abstract methods and perhaps `_test` methods in `sage.categories.modules_with_basis`?",
    "created_at": "2020-07-18T20:22:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346281",
    "user": "https://github.com/mkoeppe"
}
```

<a id='comment:4'></a>So what's missing is a few abstract methods and perhaps `_test` methods in `sage.categories.modules_with_basis`?
...
```json
{
    "body": "<a id='comment:5'></a>Yes. And to resolve some conflicts in the current API; e.g. what idiom to use to iterate over pairs (indicies, coefficients), etc.",
    "created_at": "2020-07-19T07:14:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346282",
    "user": "https://github.com/nthiery"
}
```

<a id='comment:5'></a>Yes. And to resolve some conflicts in the current API; e.g. what idiom to use to iterate over pairs (indicies, coefficients), etc.
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53535"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346284",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53537"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346285",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53539"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53540"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53541"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53542"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19346#issuecomment-346286",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53543"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53544"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53545"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19346#event-53546"
}
```
