...
```json
{
    "body": "<a id='comment:4'></a>\nNew commits:\n|                                                                                                                                          |                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|\n|[34c2727](http://git.sagemath.org/sage.git/commit/?id=34c272719df882e68b04500bcf78452fd198307f)|`Let PARI handle its own stack`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |             |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------|\n|[47f985e](http://git.sagemath.org/sage.git/commit/?id=47f985ec65a3da0041d27b4824db94118c67ddf1)|`Minor fixes`|",
    "created_at": "2016-01-14T16:17:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19883",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |      |\n|------------------------------------------------------------------------------------------------------------------------------------------|------|\n|[5bc6f27](http://git.sagemath.org/sage.git/commit/?id=5bc6f271aa21be3f54b12322f7dde9b3d5b04fe9)|`Typo`|",
...
```json
{
    "body": "<a id='comment:14'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[435a4fe](http://git.sagemath.org/sage.git/commit/?id=435a4fe79fb3b2d7a652c4d512bc6531c4762ab3)|`Add maximum stack size to message`|",
...
```json
{
    "body": "<a id='comment:27'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|\n|[7e4919e](http://git.sagemath.org/sage.git/commit/?id=7e4919e9778a91f8ceb65db7a0d7ff894006122f)|`Use virtual_memory_limit() to determine size of PARI stack`|",
...
```json
{
    "body": "<a id='comment:32'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[edf23e8](http://git.sagemath.org/sage.git/commit/?id=edf23e8643c9cbceafbb4bfd88b1edf6bb4032b6)|`Set debugmem=1 for testsuite`|",
    "created_at": "2016-01-20T09:32:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19883",
    "type": "issue_comment",
