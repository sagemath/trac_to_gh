...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262707"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286260",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286261",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262710"
}
```
