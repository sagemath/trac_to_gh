...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262711"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262712"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262713"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286254",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286255",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286256",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286257",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286258",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    "body": "Changed keywords from **** to **arb, polynomial**",
    "created_at": "2019-03-08T02:58:07Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/19841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19841#issuecomment-286259",
    "user": "https://github.com/slel"
}
```

Changed keywords from **** to **arb, polynomial**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262714"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19841#event-262716"
}
```
