...
```json
{
    "body": "<a id='comment:3'></a>\nThis is fixed in Pynac git master. This ticket has doctests but they depend on a pynac-0.7.2 upgade.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[896bdc7](https://git.sagemath.org/sage.git/commit?id=896bdc714d486dedda490f5949afd261bcb25ca3)|`19906: doctest fix for: dilog(RR) should return an element of RR`|",
    "created_at": "2016-12-05T08:55:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19906",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\nNote also\n\n```\nsage: polylog(3,RBF(1.1))      # there is a polylog RBF member!\n1.37625299668538 - 0.0142691615444952*I\nsage: dilog(RBF(1.1))\n1.96199910130557 - 0.299425760685590*I\n```\n\n---\nNew commits:\n|                                                                                                                                          |                                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|\n|[4f451a4](https://git.sagemath.org/sage.git/commit?id=4f451a479be21b5eeac4ca4dccf934203f5a4166)|`19906: doctest fix for: dilog(RR) should return an element of RR`|",
