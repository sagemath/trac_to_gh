...
```json
{
    "body": "`sage --valgrind` crashes with a system valgrind both at 3.11.0 and 3.12.0, and current develop. It looks exactly like\n\nhttps://bugs.kde.org/show_bug.cgi?id=360415\n\nA self-compiled valgrind-3.13.0 does not do this anymore.",
...
```json
{
    "body": "Attachment [valgrind-3.13.0.log](tarball://root/attachments/some-uuid/ticket19618/valgrind-3.13.0.log) by @slel created at 2019-01-13 22:31:28\n\nValgrind 3.14.0 was released on 2018-10-09.\n\nTarball: https://sourceware.org/ftp/valgrind/valgrind-3.14.0.tar.bz2",
...
```json
{
    "body": "I guess for an experimental package, the fact that the package builds and can be used constitutes a positive review. Since I merely changed the checksum, I believe I am not author but reviewer.",
    "created_at": "2019-02-15T08:09:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19618",
    "type": "issue_comment",
