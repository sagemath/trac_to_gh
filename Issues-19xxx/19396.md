...
```json
{
    "body": "<a id='comment:3'></a>In principle the most important thing in poset is not \"covers\", it is \"is less or equal\". But is this about adding a label to covering relation?\n\nI guess this could be useful addition. About implementing it I know nothing.\n\nName should of course be `cover_label` or `covering_label`, not `edge_label`.",
    "created_at": "2015-10-18T17:52:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279704",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:3'></a>In principle the most important thing in poset is not "covers", it is "is less or equal". But is this about adding a label to covering relation?
...
```json
{
    "body": "<a id='comment:4'></a>This is just about covering relations. And as I listed in the description, there are tons of situations where you would want a labeling of the cover relations, and the notion of a labeling for their transitive closure doesn't make much sense.\n\nThe name should probably be `cover_labels`, to match the currently existing option for the `plot()` method.",
    "created_at": "2015-10-18T18:16:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279705",
    "user": "https://github.com/kevindilks"
}
```

<a id='comment:4'></a>This is just about covering relations. And as I listed in the description, there are tons of situations where you would want a labeling of the cover relations, and the notion of a labeling for their transitive closure doesn't make much sense.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279706",
    "user": "https://github.com/kevindilks"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Can we define labels in some natural way in `product()`, `ordinal_product()` etc? What functions would have to change? At least `dual()`, but everything that creates a new poset(s) from old poset(s) should be checked.",
    "created_at": "2016-09-25T06:01:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279707",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:6'></a>Can we define labels in some natural way in `product()`, `ordinal_product()` etc? What functions would have to change? At least `dual()`, but everything that creates a new poset(s) from old poset(s) should be checked.
...
```json
{
    "body": "<a id='comment:8'></a>This is already implemented -- the `plot` method accepts `cover_labels` option. I suggest closing this ticket.",
    "created_at": "2018-06-28T14:05:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279708",
    "user": "https://github.com/vit-tucek"
}
```

<a id='comment:8'></a>This is already implemented -- the `plot` method accepts `cover_labels` option. I suggest closing this ticket.
...
```json
{
    "body": "<a id='comment:9'></a>This isn't just for plotting. This would make the edge labels a persistent part of the poset data.",
    "created_at": "2018-06-28T14:10:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279709",
    "user": "https://github.com/kevindilks"
}
```

<a id='comment:9'></a>This isn't just for plotting. This would make the edge labels a persistent part of the poset data.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279710",
    "user": "https://github.com/vit-tucek"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19396#issuecomment-279711",
    "user": "https://github.com/vit-tucek"
}
```
