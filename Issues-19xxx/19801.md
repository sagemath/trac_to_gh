...
```json
{
    "body": "<a id='comment:2'></a>\nThis is missing from the index of functions. As #19123 is stalled, I think I will later make a new ticket only for the index.\n\n---\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[812f19d](http://git.sagemath.org/sage.git/commit/?id=812f19df8b8de0ecade650b26b088e528b4ab672)|`Add pseudocomplement() and is_pseudocomplemented().`|\n|[aafb86c](http://git.sagemath.org/sage.git/commit/?id=aafb86c7212eeeea29e460adaabd6c7884007594)|`Removed spaces from empty lines.`|",
...
```json
{
    "body": "<a id='comment:5'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                    |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|\n|[a9c00e2](http://git.sagemath.org/sage.git/commit/?id=a9c00e2d691282e6d77a63827b2ada33ceaaeb6d)|`Several corrections from reviewer.`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[84c8010](http://git.sagemath.org/sage.git/commit/?id=84c8010dbfbd19718b593f3be134bd89b4c92bf8)|`More corrections from reviewer.`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|\n|[b99175d](http://git.sagemath.org/sage.git/commit/?id=b99175d9016e8de15019fd3b9de4449cdcd23bbe)|`Last comments from reviewer.`|",
