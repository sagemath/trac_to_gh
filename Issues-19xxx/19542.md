...
```json
{
    "body": "I'm against this. I have exceptions which are meant to be informative, and sometimes contain >1 sentence. I do not agree with a standard that would force me to make them less informative.",
...
```json
{
    "body": "I cannot find that discussion. Can you add a link toward the thread in this ticket's description?",
...
```json
{
    "body": "True. I asked for more \"votes\" on this on list.",
...
```json
{
    "body": "This one does not seem to converge. Should we just close this ticket, and maybe return to it in a future far away?",
