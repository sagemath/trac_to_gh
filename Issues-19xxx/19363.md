...
```json
{
    "body": "Indeed, still in 8.4.beta6 I see\n\n```\nsage: from sage.matroids.advanced import *\n....: import gc\n....: \n....: i = 0\n....: while True:\n....:     if i%10000==0:\n....:         gc.collect()\n....:         print get_memory_usage()\n....:     i += 1\n....:     _ = psi(.5)\n....:     \n7\n2692.96875\n0\n2696.46875\n0\n2699.96875\n0\n2703.71875\n0\n2707.7265625\n0\n2711.734375\n0\n2715.87109375\n0\n2719.87890625\n0\n2723.88671875\n0\n2728.0234375\n...\n```",
...
```json
{
    "body": "`beta(-1.0,-0.5)` leaks just as well, while `gamma(-0.5)` does not.",
...
```json
{
    "body": "Where is the code for converting a ball to a `numeric`?",
...
```json
{
    "body": "I probably am missing something, but how do you call `Py_DECREF()` on something that is `NULL`?",
...
```json
{
    "body": "Yes. I just don't know if there are any scenarios where this error would be caught and execution continues as usual.",
