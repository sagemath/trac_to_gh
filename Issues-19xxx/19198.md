...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19198#issuecomment-343024",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19198#issuecomment-343025",
...
```json
{
    "body": "<a id='comment:4'></a>For the instructions in `mpi4py.rst`, I can make it work using #19158 (for `openmpi`) and #19187 (for `mpi4py`).",
    "created_at": "2015-09-14T10:07:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19198",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19198#issuecomment-343026",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>For the instructions in `mpi4py.rst`, I can make it work using #19158 (for `openmpi`) and #19187 (for `mpi4py`).
