...
```json
{
    ...
    "asset_name": "19097.pdf",
    "asset_url": "tarball://root/attachments/ticket19097/19097.pdf",
    "created_at": "2015-10-20T01:34:26Z",
    "issue": "https://github.com/sagemath/sage/issues/19097",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket19097/19097.pdf",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    "body": "**Attachment:** [19097.pdf](https://github.com/sagemath/sage/files/ticket19097/19097.pdf)",
    "created_at": "2015-10-20T01:34:26Z",
    "issue": "https://github.com/sagemath/sage/issues/19097",
    "type": "issue_comment",
...
**Attachment:** [19097.pdf](https://github.com/sagemath/sage/files/ticket19097/19097.pdf)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171856"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171857"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171858"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171859"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171860"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171861"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171862"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171863"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171864"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171865"
}
```
...
```json
{
    ...
    "milestone": "sage-7.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171866"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171867"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171868"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171869"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19097",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19097#event-171870"
}
```
