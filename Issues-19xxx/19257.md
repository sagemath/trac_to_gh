...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273353"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19257#issuecomment-273219",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19257#issuecomment-273220",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19257#issuecomment-273221",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19257",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19257#event-273364"
}
```
