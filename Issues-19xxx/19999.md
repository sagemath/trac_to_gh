...
```json
{
    "body": "<a id='comment:1'></a>It seems that there is a problem with the comparison in these cartesian products of growth groups.\n\nThis might also cause this behavior:\n\n```\nsage: (-1)^x + O(1/x)\nO(x^(-1))\n```",
    "created_at": "2016-02-01T12:35:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360681",
    "user": "https://github.com/behackl"
}
```

<a id='comment:1'></a>It seems that there is a problem with the comparison in these cartesian products of growth groups.
...
```json
{
    "body": "<a id='comment:2'></a>I've tried to find the actual reason for this infinite loop. It turns out that the entire poset structure breaks down after inserting `(-1)^x`:\n\n```\nsage: ex = 1 + (-1)^x\nsage: s = ex.summands; s\nposet((-1)^x, 1)\nsage: print s.repr_full()\nposet((-1)^x, 1)\n+-- (-1)^x\n+-- null\n+-- 1\n+-- oo\n```",
    "created_at": "2016-02-03T10:10:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360682",
    "user": "https://github.com/behackl"
}
```

<a id='comment:2'></a>I've tried to find the actual reason for this infinite loop. It turns out that the entire poset structure breaks down after inserting `(-1)^x`:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360684",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360685",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360688",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/behackl/exp-growth-inf-loop\"",
    "created_at": "2016-02-03T12:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360689",
    "user": "https://github.com/behackl"
}
```

Changing branch from "" to "u/behackl/exp-growth-inf-loop"
...
```json
{
    "body": "<a id='comment:8'></a>I forgot that the proposed refactoring of `MutablePoset` would result in a structure that does not resemble a poset any more; thanks for the hint.\n\nTherefore, as the resulting increased number of required `O`-terms is just inconvenient I've implemented option 1.\n\n---\nNew commits:",
    "created_at": "2016-02-03T12:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360690",
    "user": "https://github.com/behackl"
}
```

<a id='comment:8'></a>I forgot that the proposed refactoring of `MutablePoset` would result in a structure that does not resemble a poset any more; thanks for the hint.
...
```json
{
    "body": "Changing commit from \"\" to \"b506dff52dc57995e229f57144f280516c0b6b8b\"",
    "created_at": "2016-02-03T12:58:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360691",
    "user": "https://github.com/behackl"
}
```

Changing commit from "" to "b506dff52dc57995e229f57144f280516c0b6b8b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360692",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360693",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360695",
    "user": "https://github.com/behackl"
}
```
...
```json
{
    "body": "Changing commit from \"b506dff52dc57995e229f57144f280516c0b6b8b\" to \"7881bb3632dd40cb9add6ce3dfd3e6255e9f82be\"",
    "created_at": "2016-02-03T22:58:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360696",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b506dff52dc57995e229f57144f280516c0b6b8b" to "7881bb3632dd40cb9add6ce3dfd3e6255e9f82be"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360697",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360698",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360699",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n+Using `q^x` for negative `q` leads to errors.\n+\n ```\n sage: 1 + (-1)^x + (1/2)^x\n ```\n@@ -14,6 +16,9 @@\n ```\n works.\n \n+Thus make `q^x` and `(-q)^x` incomparable; also making cartesian products of growth groups fit to have lexicographic products of non-linear orders.\n+\n+\n Comment: 1\n \n Summary: infinite recursion creating certain asymptotic expansion\n``````\n",
    "created_at": "2016-02-04T16:46:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360700",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360701",
    "user": "https://github.com/cheuberg"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360702",
...
```json
{
    "body": "Changing branch from \"u/behackl/exp-growth-inf-loop\" to \"7881bb3632dd40cb9add6ce3dfd3e6255e9f82be\"",
    "created_at": "2016-02-05T19:30:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19999#issuecomment-360703",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/behackl/exp-growth-inf-loop" to "7881bb3632dd40cb9add6ce3dfd3e6255e9f82be"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19999",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19999#event-54522"
}
```
