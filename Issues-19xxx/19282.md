...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19282#event-255843"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19282#event-255844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19282#event-255845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19282#issuecomment-276098",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19282#event-255846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19282",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19282#issuecomment-276099",
    "user": "https://github.com/zabrocki"
}
```
