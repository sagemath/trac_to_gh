...
```json
{
    "body": "<a id='comment:1'></a>\nThe mosst obvious use-case for this ticket would be #19483 (whose original tarball is .zip) but it is already reviewed. I'll do what the reviewers ask.\n\nNathann\n\n---\nNew commits:\n|                                                                                                                                          |                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|\n|[465d83c](http://git.sagemath.org/sage.git/commit/?id=465d83c199cbe9f399574db2e3d79708ae118ad8)|`trac #19484 - sage -unzip`|\n|[291bf3e](http://git.sagemath.org/sage.git/commit/?id=291bf3e6dd79cc18de67e9b213420fd66c98ff71)|`trac #19487: Support .zip upstream/ files`|",
    "created_at": "2015-10-27T14:43:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19487",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:6'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[727ac93](http://git.sagemath.org/sage.git/commit/?id=727ac938b282c541f489d273c2a3cf7bbc96fc2e)|`trac #19484: sage-unzip`|\n|[ba21cc0](http://git.sagemath.org/sage.git/commit/?id=ba21cc01a8b39ecf546560c85d0b128b9eea10c7)|`trac #19487: Support .zip upstream/ files`|",
...
```json
{
    "body": "<a id='comment:12'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                         |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[eeedb3b](http://git.sagemath.org/sage.git/commit/?id=eeedb3b4b05454c62249fe0577e4b7a84e9f2338)|`trac #19712: strongly_regular_graph() crashes when mu=0`|\n|[f5d75ab](http://git.sagemath.org/sage.git/commit/?id=f5d75abd01a66f964fa39559c6579063db3f4228)|`trac #19487: Merged with mu=0`|\n|[1312500](http://git.sagemath.org/sage.git/commit/?id=1312500851383e2eb45c4ea4f1da0663659a2d62)|`trac #19487: remove -s`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[ab197d3](http://git.sagemath.org/sage.git/commit/?id=ab197d3bd1b89a7d6d1a7bd1542a60d639b70014)|`trac #19487: Support .zip upstream/ files`|\n|[a49b1e4](http://git.sagemath.org/sage.git/commit/?id=a49b1e48d3bf4f673893637903974708325c53b9)|`trac #19487: remove -s`|",
...
```json
{
    "body": "<a id='comment:17'></a>\nThe regexp needed fixing also.\n\n---\nNew commits:\n|                                                                                                                                          |                                                     |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|\n|[7e464c1](http://git.sagemath.org/sage.git/commit/?id=7e464c1a8bf37422e30b36f5b99ff6a7748e6606)|`Make regular expression portable; add documentation`|",
...
```json
{
    "body": "<a id='comment:32'></a>\nNew commits:\n|                                                                                                                                          |                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|\n|[7552aec](http://git.sagemath.org/sage.git/commit/?id=7552aec622492393705dfee6d3b9002989b41be8)|`trac #19487: Merged with 6.10.rc2`|\n|[81b0e63](http://git.sagemath.org/sage.git/commit/?id=81b0e6304a5f6374bcaf84481e07f66c1bf26d29)|`trac #19487: Use bliss' original upstream .zip file`|",
    "created_at": "2015-12-19T10:13:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19487",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:38'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[ab96b27](http://git.sagemath.org/sage.git/commit/?id=ab96b271f093272132427b6c147c1704d2dc370f)|`trac #19487: bz2 file extension`|",
...
```json
{
    "body": "<a id='comment:39'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                          |                                 |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|\n|[b8f4d6a](http://git.sagemath.org/sage.git/commit/?id=b8f4d6af1650283791a53332e0b5a0eeacc46974)|`trac #19487: bz2 file extension`|",
    "created_at": "2015-12-20T20:52:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19487",
    "type": "issue_comment",
