...
```json
{
    "body": "<a id='comment:2'></a>\nThe proposed fix is to just let the `doc` target depend on `doc-clean`. Perhaps is there a lighter solution ?\n\n---\nNew commits:\n|                                                                                                                                          |                                              |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|\n|[131ff97](http://git.sagemath.org/sage.git/commit/?id=131ff97a5e7fa8dfb33c907ad68dc2bfe6151a54)|`#19882 : let doc target depend on doc-clean.`|",
    "created_at": "2016-01-13T17:42:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19882",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:8'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                           |\n|------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|\n|[80a0a52](http://git.sagemath.org/sage.git/commit/?id=80a0a522ccc5c0768558ae32ea98c995a3c8e9ca)|`#19882 : run doc-clean only if doc-html lead to an error.`|",
    "created_at": "2016-01-15T17:08:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19882",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|\n|[5b555ae](http://git.sagemath.org/sage.git/commit/?id=5b555ae3493879c81f7f7ba7190dd1e272f54dbd)|`#19882 add one level of indirection (comment 12)`|",
...
```json
{
    "body": "<a id='comment:19'></a>\nBranch pushed to git repo; I updated commit sha1. This was a forced push. New commits:\n|                                                                                                                                           |                                |\n|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|\n|[e80667d](https://git.sagemath.org/sage.git/commit/?id=e80667dee0e1ad2fff59c3b3007a724d80c0aed5)|`#19882 : rebased on 7.6.beta6.`|",
...
```json
{
    "body": "<a id='comment:22'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                  |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[83d8cc8](https://git.sagemath.org/sage.git/commit/?id=83d8cc8c87a6c4bb32a8bb9ffad22bfa59872889)|`#19882 : replace spaces by tabs.`|",
    "created_at": "2017-03-10T18:25:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19882",
    "type": "issue_comment",
