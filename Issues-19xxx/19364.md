...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346631",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346632",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346633",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346634",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19364#event-53568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346635",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346636",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Strange order:\n\n```\n(lower left, upper right, upper left, lower right)\n```\nwhat is the reason of this choice ?",
    "created_at": "2015-10-07T20:04:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346637",
    "user": "https://github.com/fchapoton"
}
```

<a id='comment:7'></a>Strange order:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346638",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Are both methods really needed? `endpoints` already contains all the information. The only advantage of `edges` I see is that the output belongs to the same field.",
    "created_at": "2015-11-28T16:54:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346639",
    "user": "https://github.com/videlec"
}
```

<a id='comment:9'></a>Are both methods really needed? `endpoints` already contains all the information. The only advantage of `edges` I see is that the output belongs to the same field.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346640",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>\"needed\" is always very subjective. I mean, is Sage (the program as a whole) \"needed\"?\n\nThe main motivation is to allow more easily code which can run unchanged for both `RIF` and `CIF`. Depending on the application, that would be either `edges()` or `endpoints()` which happen to coincide for `RIF` but not for `CIF`.",
    "created_at": "2015-11-28T18:04:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346641",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>"needed" is always very subjective. I mean, is Sage (the program as a whole) "needed"?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346642",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346643",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346644",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346645",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346646",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346647",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19364#event-53569"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19364#issuecomment-346649",
    "user": "https://github.com/vbraun"
}
```
