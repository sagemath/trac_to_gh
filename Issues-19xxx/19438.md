...
```json
{
    "body": "<a id='comment:2'></a>\nNew commits:\n|                                                                                                                                          |                                                          |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|\n|[929d605](http://git.sagemath.org/sage.git/commit/?id=929d605a9570dfe52d7e86d41feaab1c5be915e5)|`trac #19438 bug corrected in as_permutation_group method`|\n|[cd3e801](http://git.sagemath.org/sage.git/commit/?id=cd3e801346b8ec7db6af1c407ac0243985f983b4)|`Fixed the bug described in the ticket.`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                  |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|\n|[9d7c09d](http://git.sagemath.org/sage.git/commit/?id=9d7c09d34f95de85ba1b3f7ba54a9b03ec634a0d)|`Added a blank line after TESTS::`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[ffeb721](http://git.sagemath.org/sage.git/commit/?id=ffeb721ce7a670888acd2f396d806d1a5f04ea28)|`Trimmed the spaces on the blank lines.`|",
