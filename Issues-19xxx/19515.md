...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349953",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349954",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349955",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I've tried your patch, but appearently I'm doing something wrong:\n\n1) checkout your branch, `./sage -b` (or `make`)\n\n2) `./sage -n jupyter`\n\n3a) New notebook with\n\n```\nview(transducers.GrayCode())\n```\nopens a pdf and shows the transducer there (not embedded)\n\n3b) New notebook with\n\n```\nsage.misc.latex.EMBEDDED_MODE = True\nview(transducers.GrayCode())\n```\nreturns\n\n```\n<IPython.core.display.Image object>\n```\n\nAny ideas?",
    "created_at": "2015-11-06T14:09:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349956",
    "user": "https://github.com/dkrenn"
}
```

<a id='comment:2'></a>I've tried your patch, but appearently I'm doing something wrong:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349957",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349958",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The file `00-init.ipy` is located in `$HOME/.sage/ipython_genutils-0.1.0/profile_default/startup/`. \nMy file contains exactly:\n\n```\nfrom sage.all import *\nfrom sage.misc.latex import latex\nlatex.add_package_to_preamble_if_available(\"tikz\")\nlatex.add_to_mathjax_avoid_list(\"tikz\")\nsage.misc.latex.EMBEDDED_MODE = True\n```\n\nIf it does not work... I have no idea how to fix that...",
    "created_at": "2015-11-10T17:36:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349959",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```

<a id='comment:5'></a>The file `00-init.ipy` is located in `$HOME/.sage/ipython_genutils-0.1.0/profile_default/startup/`. 
My file contains exactly:
...
```json
{
    "body": "<a id='comment:6'></a>You might want to test this on top of #19566.",
    "created_at": "2015-11-13T01:13:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349960",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:6'></a>You might want to test this on top of #19566.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349961",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349963",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Mucking around with EMBEDDED_MODE global variables is phenomenally fugly, we should work to get rid of that. Most certainly we should not build new stuff that relies on it.\n\nAlso, this ticket doesn't let you do anything useful with the pdf file besides immediately showing it, it still doesn't work as displayhook, and further deepens the weird differences between view/show/pretty_print.",
    "created_at": "2016-05-22T10:11:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19515#issuecomment-349964",
    "user": "https://github.com/vbraun"
}
```

<a id='comment:11'></a>Mucking around with EMBEDDED_MODE global variables is phenomenally fugly, we should work to get rid of that. Most certainly we should not build new stuff that relies on it.
