...
```json
{
    "body": "I will update this branch to remove the edgelist constructor. All I need for the moment is this 'nde' reader anyway. And at least this format is properly specified.\n\nNathann",
