...
<a id='comment:50'></a>Replying to [comment:42 ncohen]:
...
<a id='comment:62'></a>Replying to [comment:59 ncohen]:
...
<a id='comment:63'></a>Replying to [comment:60 chapoton]:
> I would be happy if you just change the name to `ordinal_summands`.
