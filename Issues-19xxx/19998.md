...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19998#issuecomment-290536",
...
```json
{
    ...
    "milestone": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19998#event-183037"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19998#event-183038"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19998#event-183039"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19998#issuecomment-290537",
    "user": "https://github.com/rwst"
}
```
