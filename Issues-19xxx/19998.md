...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19998#issuecomment-289023",
...
```json
{
    ...
    "milestone_title": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-264719"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-264720"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-264721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19998#issuecomment-289024",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-264722"
}
```
