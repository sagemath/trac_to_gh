...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-349997",
...
```json
{
    "body": "<a id='comment:2'></a>There is something strange with `bliss` installation, see https://groups.google.com/forum/#!topic/sage-devel/_1OYNuVNltM\n\n`return_graph` is not converse of `inplace`. I guess. It is badly documented. What is the meaning of it's output? A list of pairs somehow... Try\n\n```\nG = graphs.PetersenGraph()\nG.relabel(lambda x: chr(ord('a')+x))\nG.canonical_label(return_graph=False)\n```\n\nAnd why it deletes vertex positioning contraty to `relabel`? Try for example\n\n```\nG = graphs.PetersenGraph()\nG.relabel(lambda x: chr(ord('a')+x))\nG.show()\nG = G.canonical_label()\nG.canonical_label().show()\n```",
    "created_at": "2015-11-05T15:32:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-349998",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:2'></a>There is something strange with `bliss` installation, see https://groups.google.com/forum/#!topic/sage-devel/_1OYNuVNltM
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350000",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>OK, modified the description. I do not think that forgetting vertex positions is necessarily a bug. But to remember them on `relabel()` and to forget on `canonical_label()` is.",
    "created_at": "2015-11-06T06:09:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350001",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:4'></a>OK, modified the description. I do not think that forgetting vertex positions is necessarily a bug. But to remember them on `relabel()` and to forget on `canonical_label()` is.
...
```json
{
    "body": "Changing branch from \"\" to \"u/jmantysalo/graph-can-label-pos\"",
    "created_at": "2017-10-30T11:00:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350002",
    "user": "https://github.com/jm58660"
}
```

Changing branch from "" to "u/jmantysalo/graph-can-label-pos"
...
```json
{
    "body": "<a id='comment:6'></a>Getting back to this old ticket... First of all I changed the check for parameters to better understand what happens. Now `algorithm='bliss'` will always raise an error if Bliss is not installed, even when the graph has multiedges and Bliss could not be used anyway.\n\nI think that this should just compute canonical relabeling and call `.relabel()`. That would take care the problem of vertex positions.\n\n---\nNew commits:",
    "created_at": "2017-10-30T11:09:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350003",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:6'></a>Getting back to this old ticket... First of all I changed the check for parameters to better understand what happens. Now `algorithm='bliss'` will always raise an error if Bliss is not installed, even when the graph has multiedges and Bliss could not be used anyway.
...
```json
{
    "body": "Changing commit from \"\" to \"753b8e03e2ea177bd51ae49711ed762172f32730\"",
    "created_at": "2017-10-30T11:09:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350004",
    "user": "https://github.com/jm58660"
}
```

Changing commit from "" to "753b8e03e2ea177bd51ae49711ed762172f32730"
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19517#event-53788"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350005",
...
```json
{
    "body": "Changing commit from \"753b8e03e2ea177bd51ae49711ed762172f32730\" to \"81f337a4f9a5ff89d4d9ab561441b795bbf40a31\"",
    "created_at": "2017-10-31T06:15:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350007",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "753b8e03e2ea177bd51ae49711ed762172f32730" to "81f337a4f9a5ff89d4d9ab561441b795bbf40a31"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350008",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Ah, I did not notice the line `not edge_labels` I removed. Now corrected that one.\n\n(These must also be said in `INPUT`section.)",
    "created_at": "2017-10-31T06:16:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350009",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:9'></a>Ah, I did not notice the line `not edge_labels` I removed. Now corrected that one.
...
```json
{
    "body": "Changing commit from \"81f337a4f9a5ff89d4d9ab561441b795bbf40a31\" to \"ac925246354752b6f27e6643efd2a7c6fccd0cd5\"",
    "created_at": "2017-10-31T08:37:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350010",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "81f337a4f9a5ff89d4d9ab561441b795bbf40a31" to "ac925246354752b6f27e6643efd2a7c6fccd0cd5"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350011",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Just noticed that Bliss with `return_graph=False` returns set of edges, not a dictionary of mapping. Hence we must copy a part of `relabel`:\n\n```\nattributes_to_update = ('_pos', '_assoc', '_embedding')\nfor attr in attributes_to_update:\n    if hasattr(self, attr) and getattr(self, attr) is not None:\n        new_attr = {}\n        for v,value in iteritems(getattr(self, attr)):\n            new_attr[perm[v]] = value\n\n        setattr(self, attr, new_attr)\n```",
    "created_at": "2017-11-01T05:09:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350012",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:11'></a>Just noticed that Bliss with `return_graph=False` returns set of edges, not a dictionary of mapping. Hence we must copy a part of `relabel`:
...
```json
{
    "body": "<a id='comment:13'></a>Just came here after the sage-devel post by Jori. Is there anything controversial here? Or were you just fishing for reviewers :-)",
    "created_at": "2017-11-02T23:39:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350014",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:13'></a>Just came here after the sage-devel post by Jori. Is there anything controversial here? Or were you just fishing for reviewers :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350015",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "Changing commit from \"ac925246354752b6f27e6643efd2a7c6fccd0cd5\" to \"b233fdf562e91531b70da45e98da9b7e228f6046\"",
    "created_at": "2017-11-03T05:45:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350016",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "ac925246354752b6f27e6643efd2a7c6fccd0cd5" to "b233fdf562e91531b70da45e98da9b7e228f6046"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350017",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Some modifications to docstring. Now also vertex positions are preserved even when Bliss is used.\n\nMust add many tests to this.",
    "created_at": "2017-11-03T05:46:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350018",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:16'></a>Some modifications to docstring. Now also vertex positions are preserved even when Bliss is used.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350019",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"b233fdf562e91531b70da45e98da9b7e228f6046\" to \"39ce1ef11371c37708ca72c72b26174136b1c2d7\"",
    "created_at": "2017-11-03T08:28:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350020",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "b233fdf562e91531b70da45e98da9b7e228f6046" to "39ce1ef11371c37708ca72c72b26174136b1c2d7"
...
```json
{
    "body": "<a id='comment:18'></a>Currently Bliss have no verbose mode, and the docstring of `search_tree` says \"verbosity \u2013 currently ignored\". Hence I just removed the parameter.\n\nI changed docstring and allowed `return_graph=False` only when `bliss=True` is explicitly said.\n\nDocstring modified.\n\nNow this needs comments.",
    "created_at": "2017-11-03T08:35:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350021",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:18'></a>Currently Bliss have no verbose mode, and the docstring of `search_tree` says "verbosity – currently ignored". Hence I just removed the parameter.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350023",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"39ce1ef11371c37708ca72c72b26174136b1c2d7\" to \"ea621c672a9b38d0fc80f3b11d4931f5014f5fb6\"",
    "created_at": "2017-11-03T18:36:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350024",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "39ce1ef11371c37708ca72c72b26174136b1c2d7" to "ea621c672a9b38d0fc80f3b11d4931f5014f5fb6"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350025",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Found a bug in my code. Deprecation and your suggestions done.\n\nI also tried to make better examples. Still lacking an example of partition, also I will check that the parameter is really used.",
    "created_at": "2017-11-03T18:38:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350026",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:22'></a>Found a bug in my code. Deprecation and your suggestions done.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350027",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"ea621c672a9b38d0fc80f3b11d4931f5014f5fb6\" to \"739a9dfc0e6d76bac1a440fddbbffe26ad91ff6b\"",
    "created_at": "2017-11-04T16:59:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350028",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "ea621c672a9b38d0fc80f3b11d4931f5014f5fb6" to "739a9dfc0e6d76bac1a440fddbbffe26ad91ff6b"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350029",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Maybe these changes should be integrated to Sage now, and get back to this later? One parameter is still missing examples and documentation, but that can be done later.",
    "created_at": "2017-11-04T17:01:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350030",
    "user": "https://github.com/jm58660"
}
```

<a id='comment:24'></a>Maybe these changes should be integrated to Sage now, and get back to this later? One parameter is still missing examples and documentation, but that can be done later.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350031",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "Changing commit from \"739a9dfc0e6d76bac1a440fddbbffe26ad91ff6b\" to \"4dabccd35885ec9b70a6dcaeb06ab1779c323d81\"",
    "created_at": "2017-11-05T13:45:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350033",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "739a9dfc0e6d76bac1a440fddbbffe26ad91ff6b" to "4dabccd35885ec9b70a6dcaeb06ab1779c323d81"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350034",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350035",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>> In general I try to write a one-line description of the function to TOC when possible. For example `is_uniform` is explained as \"Return True if all congruences of the lattice consists of equal-sized blocks.\" in TOC, but the function starts with \"Return True if the lattice is uniform - -\" and then explains what is uniform.\n\n \nAgreed. A significant effort remains to be done for cleaning the graph module. \n\n  \n\n> > You don't want to use [canonization](https://en.wikipedia.org/wiki/Canonization) but [canonicalization](https://en.wikipedia.org/wiki/Canonicalization), right ? ;)\n\n> \n> But then there is [Graph canonization](https://en.wikipedia.org/wiki/Graph_canonization), so what to do?\n\n \nYou are right. I did not see that. So let's use graph canonization.\n\nCould you add a link to the wikipedia page ?\n\n \n\n> > For parameter `partition`, I tried the following:\n\n> \n> For that we must first define what means to be \"canonical\" but still \"restrict permutations\". That's why I suggest postponing that to another ticket.\n\n\nAgreed. It's already much better\n\n \n\n> E: I am not sure if the function should keep the graph's name or not. However, now it is consistent with `relabel()`.\n\n\nI have no opinion on that.",
    "created_at": "2017-11-05T14:22:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350036",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:28'></a>> In general I try to write a one-line description of the function to TOC when possible. For example `is_uniform` is explained as "Return True if all congruences of the lattice consists of equal-sized blocks." in TOC, but the function starts with "Return True if the lattice is uniform - -" and then explains what is uniform.
...
```json
{
    "body": "Changing commit from \"4dabccd35885ec9b70a6dcaeb06ab1779c323d81\" to \"d8dc2670e73fa83f7b40f82e73b2b5028449cfac\"",
    "created_at": "2017-11-05T17:29:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350037",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "4dabccd35885ec9b70a6dcaeb06ab1779c323d81" to "d8dc2670e73fa83f7b40f82e73b2b5028449cfac"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350038",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350039",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350040",
    "user": "https://github.com/jm58660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350041",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    "body": "<a id='comment:31'></a>Good. The doc displays nicely now (I like the \\cong stuff).",
    "created_at": "2017-11-05T17:58:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350042",
    "user": "https://github.com/dcoudert"
}
```

<a id='comment:31'></a>Good. The doc displays nicely now (I like the \cong stuff).
...
```json
{
    "body": "Changing branch from \"u/jmantysalo/graph-can-label-pos\" to \"d8dc2670e73fa83f7b40f82e73b2b5028449cfac\"",
    "created_at": "2017-11-08T19:24:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350043",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jmantysalo/graph-can-label-pos" to "d8dc2670e73fa83f7b40f82e73b2b5028449cfac"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/19517#event-53789"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/19517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/19517#issuecomment-350044",
    "user": "https://github.com/vbraun"
}
```
