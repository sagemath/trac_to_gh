...
```json
{
    "body": "<a id='comment:2'></a>\nI pushed the patch, this is now open for review.\n\n---\nNew commits:\n|                                                                                                                                          |                                                                   |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|\n|[ce9b19c](http://git.sagemath.org/sage.git/commit/?id=ce9b19cdfd3c6dece69a2eb73a6b651dc5749dcd)|`Rewrote covering_radius method to have a non-guava implementation`|",
    "created_at": "2016-01-19T10:29:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19913",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:3'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|\n|[c13dc05](http://git.sagemath.org/sage.git/commit/?id=c13dc05eb34d6fe59be06b651760478aa537d87e)|`covering_radius is now a cached method`|",
...
```json
{
    "body": "<a id='comment:7'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[37dad1a](http://git.sagemath.org/sage.git/commit/?id=37dad1a7c7504bde31fabdf450f325a591f4a08c)|`Better test to check if Guava is installed`|",
...
```json
{
    "body": "<a id='comment:9'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |               |\n|------------------------------------------------------------------------------------------------------------------------------------------|---------------|\n|[88f0d6f](http://git.sagemath.org/sage.git/commit/?id=88f0d6f1106ec5f7615053d68a6e573343a565c1)|`Update to 7.0`|\n|[654b4e2](http://git.sagemath.org/sage.git/commit/?id=654b4e24b961fd63c20e6cfd737554339177e5ce)|`Fixed bug with check on Guava`|",
...
```json
{
    "body": "<a id='comment:11'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                          |                                            |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|\n|[15a108c](http://git.sagemath.org/sage.git/commit/?id=15a108ce3f7a742fca65044a695dda7ec84c4cf0)|`Merged with latest beta and fixed conflict`|",
    "created_at": "2016-04-26T13:11:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/19913",
    "type": "issue_comment",
