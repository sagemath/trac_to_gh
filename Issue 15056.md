...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15056#issuecomment-192359",
...
```json
{
    "body": "Attachment [trac_15293-lazy_import_combinat_stuff-nt.patch](tarball://root/attachments/some-uuid/ticket15293/trac_15293-lazy_import_combinat_stuff-nt.patch) by @fchapoton created at 2013-10-28 08:30:02",
    "created_at": "2013-10-28T08:30:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/15056",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/15056#issuecomment-192360",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15056#event-44282"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15056#event-44283"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15056#event-44284"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15056#event-44285"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/15056#event-44286"
}
```
