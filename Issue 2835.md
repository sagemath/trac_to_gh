# Issue 2835: [with patch, positive review] primes_of_degree_one iterator for NumberField_generic
...
```json
{
    ...
    "title": "[with patch, positive review] primes_of_degree_one iterator for NumberField_generic",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2835",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2835#event-6512"
}
```
