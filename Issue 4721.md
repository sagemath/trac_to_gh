...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35611",
    "user": "pbutler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35612",
    "user": "pbutler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35615",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35616",
    "user": "pbutler"
}
```
...
```json
{
    "body": "I've made some changes and added a new patch. Changing from needs work to needs review.",
    "created_at": "2008-12-11T16:47:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35617",
    "user": "pbutler"
}
```
...
```json
{
    "body": "Works as advertised.  I don't care about any design / structure details of calculus, so I think somebody else should look at it.",
    "created_at": "2009-01-24T11:24:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35618",
    "user": "boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35620",
    "user": "pbutler"
}
```
...
```json
{
    "body": "Yes. Can you please do that and add the FTC example to the docstring?",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35622",
    "user": "pbutler"
}
```
...
```json
{
    "body": "I've added a patch with the changes requested.",
    "created_at": "2009-01-25T02:09:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35623",
    "user": "pbutler"
}
```
...
```json
{
    "body": "Can you explain how to apply the patches? The third one does not apply cleanly on top of the second one, in 3.3.alpha1.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35626",
    "user": "pbutler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35628",
    "user": "pbutler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35630",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35631",
    "user": "pbutler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35632",
    "user": "pbutler"
}
```
...
```json
{
    "body": "If it was a *.tex file then it might have been a doc test failure. Can you please run sage -testall on your machine again? \n\nI ran my tests on an old intel macbook, which might have it's own oddities.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35636",
    "user": "pbutler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35641",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35642",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35643",
    "user": "mabshoff"
}
```
...
```json
{
    "body": "Merged const_doctest.patch and piecewise_all_patches.patch in Sage 3.3.rc0.\n\nMike: const_doctest.patch touches one doctest in const.tex.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-09T08:26:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/4721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4721#issuecomment-35644",
    "user": "mabshoff"
}
```
