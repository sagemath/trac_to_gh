...
```json
{
    ...
    "title": "Could you please let polynomial ring exponent support large number?",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33063#issuecomment-471339",
    "user": "slelievre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33063",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33063#issuecomment-471340",
    "user": "@lyciumlee"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/33063",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/33063#issuecomment-471341",
    "user": "@lyciumlee"
}
```
