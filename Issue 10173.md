...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103103",
    "user": "thome"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103104",
    "user": "lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103105",
    "user": "lftabera"
}
```
...
```json
{
    "body": "Attachment [relative_norm.2.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.2.patch) by thome created at 2010-10-26 14:28:05",
    "created_at": "2010-10-26T14:28:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103106",
    "user": "thome"
}
```

Attachment [relative_norm.2.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.2.patch) by thome created at 2010-10-26 14:28:05
...
```json
{
    "body": "Attachment [relative_norm.3.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.3.patch) by thome created at 2010-10-26 14:44:17\n\nReplying to [comment:1 lftabera]:\n> This will also improve the trace in the important case where the field is the base field.\n\nyes indeed.\n \n> I think I would call self.base_ring() instead of self.parent().base_field()\n\ndone\n\n> I wonder if this can be further improved. For example if base equals self.parent() the returning 1x1 matrix should be instantaneous (although this is  a very corner case).\n\nindeed. I considered at first it wasn't worth the trouble, but it's so ridiculously expensive that the 1-line additional diff is worth it, I believe.\n\n> Also, you need to add a doctest for the change.\n\nSure, done. However there's no difference in functionality beyond speed.\n\nE.",
    "created_at": "2010-10-26T14:44:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103107",
    "user": "thome"
}
```

Attachment [relative_norm.3.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.3.patch) by thome created at 2010-10-26 14:44:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103108",
    "user": "lftabera"
}
```
...
```json
{
    "body": "Attachment [relative_norm.5.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.5.patch) by thome created at 2010-10-27 09:19:01",
    "created_at": "2010-10-27T09:19:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103109",
    "user": "thome"
}
```

Attachment [relative_norm.5.patch](tarball://root/attachments/some-uuid/ticket10174/relative_norm.5.patch) by thome created at 2010-10-27 09:19:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103110",
    "user": "thome"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103111",
    "user": "thome"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103112",
    "user": "lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103113",
    "user": "lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103114",
    "user": "lftabera"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/10173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/10173#issuecomment-103115",
    "user": "jdemeyer"
}
```
