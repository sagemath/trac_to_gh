...
```json
{
    "body": "Patch at http://sage.math.washington.edu/home/mhansen/trac_4925.patch",
...
```json
{
    "body": "http://sage.math.washington.edu/home/mhansen/sage/devel/sage/doc/output/html/en/reference/sage/rings/number_field/number_field.html has some weirdness going on with the line \"We create the 7`th cyclotomic field `\\mathbb{Q}(\\zeta_7) with the default generator name.\"",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4925#issuecomment-37372",
    "user": "cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4925#issuecomment-37373",
    "user": "mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/4925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/4925#issuecomment-37374",
    "user": "mabshoff"
}
```
