...
```json
{
    "body": "<a id='comment:1'></a>How about replacing tmp_expect_interface_local by a function that returns, \n\n  `'/tmp/interface' + str(os.getpid())`\n\nthis way, it should always just work?",
    "created_at": "2008-08-24T11:40:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3942#issuecomment-30578",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>How about replacing tmp_expect_interface_local by a function that returns, 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3942#issuecomment-30579",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3942#issuecomment-30580",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>My one concern with this patch is that the temp files should be cleaned up properly. I don't know the mechanisms for this...",
    "created_at": "2008-08-24T14:41:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3942#issuecomment-30581",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>My one concern with this patch is that the temp files should be cleaned up properly. I don't know the mechanisms for this...
...
```json
{
    "body": "<a id='comment:4'></a>> My one concern with this patch is that the temp files should be cleaned up properly. \n> I don't know the mechanisms for this... \n\n\nThat's all taken care of because the files are in SAGE_TMP.  No worries.\n\nI think this is a good patch.",
    "created_at": "2008-08-24T17:15:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3942#issuecomment-30582",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>> My one concern with this patch is that the temp files should be cleaned up properly. 
> I don't know the mechanisms for this... 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3942#issuecomment-30583",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3942#issuecomment-30584",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
