...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-27999",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Coercion between isomorphic parents should result in an element of the left operand's parent"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3744#event-13791"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "rename": {
        "from": "[with patch, needs review] Coercion between isomorphic parents should result in an element of the left operand's parent",
        "to": "[with patch, negative review] Coercion between isomorphic parents should result in an element of the left operand's parent"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3744#event-13792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-28000",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "rename": {
        "from": "[with patch, negative review] Coercion between isomorphic parents should result in an element of the left operand's parent",
        "to": "[with patch, waiting on new coercion] Coercion between isomorphic parents should result in an element of the left operand's parent"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3744#event-13793"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-28001",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-28002",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-28003",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-28004",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3744#event-13794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-28005",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3744#issuecomment-28006",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3744",
    "rename": {
        "from": "[with patch, waiting on new coercion] Coercion between isomorphic parents should result in an element of the left operand's parent",
        "to": "[with patch, positive review] Coercion between isomorphic parents should result in an element of the left operand's parent"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3744#event-13795"
}
```
