...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31945"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31948"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3002#issuecomment-15724",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31951"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3002",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31952"
}
```
