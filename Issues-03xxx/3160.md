# Issue 3160: [with patch, positive review] change is_planar for graphs to return bool
...
```json
{
    ...
    "title": "[with patch, positive review] change is_planar for graphs to return bool",
    "type": "issue",
