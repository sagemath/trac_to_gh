...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3160#issuecomment-23008",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3160",
    "rename": {
        "from": "change is_planar for graphs to return bool",
        "to": "[with patch, needs review] change is_planar for graphs to return bool"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3160#event-11242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3160",
    "rename": {
        "from": "[with patch, needs review] change is_planar for graphs to return bool",
        "to": "[with patch, positive review] change is_planar for graphs to return bool"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3160#event-11243"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3160#issuecomment-23009",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3160",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3160#event-11244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3160#issuecomment-23010",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3160#issuecomment-23011",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
