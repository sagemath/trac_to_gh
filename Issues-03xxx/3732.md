...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28643",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28645",
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [gaussian-integral-testcase.py](tarball://root/attachments/some-uuid/ticket3732/gaussian-integral-testcase.py) by gnprice created at 2008-10-24 10:26:55\n\nI added a testcase for another integral, namely `integral( s^2 * exp(- (a + b) * s^2 ), s)`, that fails to integrate.  This is reproduced on Sage 3.1.1.",
    "created_at": "2008-10-24T10:26:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28646",
    "user": "https://trac.sagemath.org/admin/accounts/users/gnprice"
}
```

<a id='comment:2'></a>Attachment [gaussian-integral-testcase.py](tarball://root/attachments/some-uuid/ticket3732/gaussian-integral-testcase.py) by gnprice created at 2008-10-24 10:26:55
...
```json
{
    "body": "<a id='comment:4'></a>With the latest Maxima upgrade and Pynac conversion, the last two integrals are correct - the penultimate one is, of course, \n\n```\n1/2*sqrt(pi)\n```\nand the last one is \n\n```\n1/2*(a+b)^(3/2)*s^3*gamma_incomplete(-3/2,(a+b)/s^2)/(s^2)^(3/2)\n```",
    "created_at": "2009-09-24T00:43:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28648",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>With the latest Maxima upgrade and Pynac conversion, the last two integrals are correct - the penultimate one is, of course, 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28649",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Update: these (the three remaining ones above) are still in Maxima 5.20.1.",
    "created_at": "2009-12-22T17:02:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28651",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Update: these (the three remaining ones above) are still in Maxima 5.20.1.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28652",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Here is a particularly easy one (that sympy and giac can do, of course):\n\n```\nsage: var(\"a\");\nsage: integrate(cos(x), x, 0, a)\n    <snip>\nValueError: ...\nIs a positive, negative or zero?\n\nsage: integrate(cos(x), x, 0, a, algorithm=\"sympy\")\nsin(a)\n\nsage: integrate(cos(x), x, 0, a, algorithm=\"giac\")\nsin(a)\n```",
    "created_at": "2021-01-27T18:57:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3732#issuecomment-28653",
    "user": "https://github.com/DaveWitteMorris"
}
```

<a id='comment:11'></a>Here is a particularly easy one (that sympy and giac can do, of course):
