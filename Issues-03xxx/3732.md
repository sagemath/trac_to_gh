...
```json
{
    "body": "**Attachment:** [testintfailscases.py](https://github.com/sagemath/sage/files/ticket3732/testintfailscases.py)",
    "created_at": "2008-07-28T04:11:36Z",
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
...
**Attachment:** [testintfailscases.py](https://github.com/sagemath/sage/files/ticket3732/testintfailscases.py)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21411",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21412",
...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [gaussian-integral-testcase.py](https://github.com/sagemath/sage/files/ticket3732/gaussian-integral-testcase.py)\n\nI added a testcase for another integral, namely `integral( s^2 * exp(- (a + b) * s^2 ), s)`, that fails to integrate.  This is reproduced on Sage 3.1.1.",
    "created_at": "2008-10-24T10:26:55Z",
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21413",
    "user": "https://trac.sagemath.org/admin/accounts/users/gnprice"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21414",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21415",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21416",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21417",
    "user": "https://github.com/kcrisman"
}
```
