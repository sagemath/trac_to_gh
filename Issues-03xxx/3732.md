...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3732/testintfailscases.py",
    "created_at": "2008-07-28T04:11:36Z",
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3732/testintfailscases.py",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [testintfailscases.py](https://github.com/sagemath/sage/files/ticket3732/testintfailscases.py) by @williamstein created at 2008-07-28 04:11:36",
    "created_at": "2008-07-28T04:11:36Z",
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21401",
    "user": "https://github.com/williamstein"
}
```

Attachment [testintfailscases.py](https://github.com/sagemath/sage/files/ticket3732/testintfailscases.py) by @williamstein created at 2008-07-28 04:11:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21402",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21403",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3732/gaussian-integral-testcase.py",
    "created_at": "2008-10-24T10:26:55Z",
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3732/gaussian-integral-testcase.py",
    "user": "https://trac.sagemath.org/admin/accounts/users/gnprice"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [gaussian-integral-testcase.py](https://github.com/sagemath/sage/files/ticket3732/gaussian-integral-testcase.py) by gnprice created at 2008-10-24 10:26:55\n\nI added a testcase for another integral, namely `integral( s^2 * exp(- (a + b) * s^2 ), s)`, that fails to integrate.  This is reproduced on Sage 3.1.1.",
    "created_at": "2008-10-24T10:26:55Z",
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21404",
    "user": "https://trac.sagemath.org/admin/accounts/users/gnprice"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20951"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21405",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21406",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21407",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21408",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20952"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21409",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20953"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20954"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20955"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20956"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20957"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20958"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20959"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3732#event-20960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3732#issuecomment-21410",
