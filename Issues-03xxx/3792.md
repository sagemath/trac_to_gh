...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3792#issuecomment-28398",
    "user": "https://github.com/certik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3792",
    "rename": {
        "from": "fix Sage build when there is a broken systemwide freetype library",
        "to": "[with spkg, positive review] fix Sage build when there is a broken systemwide freetype library"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3792#event-14018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3792#issuecomment-28399",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3792#event-14019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3792#issuecomment-28400",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3792#issuecomment-28401",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3792#issuecomment-28402",
    "user": "https://github.com/certik"
}
```
