# Issue 3734: [with patch, positive review] inverse() fails for 0 by 0 matrices
...
```json
{
    ...
    "title": "[with patch, positive review] inverse() fails for 0 by 0 matrices",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-26452",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-26453",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-8553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-26454",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-26455",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-8554"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-8555"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-8556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-26456",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
