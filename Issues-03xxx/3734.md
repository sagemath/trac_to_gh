...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-27920",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "rename": {
        "from": "inverse() fails for 0 by 0 matrices",
        "to": "[with patch, needs review] inverse() fails for 0 by 0 matrices"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-13743"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-27921",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-13744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-27922",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "rename": {
        "from": "[with patch, needs review] inverse() fails for 0 by 0 matrices",
        "to": "[with patch, positive review] inverse() fails for 0 by 0 matrices"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-13745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-27923",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-13746"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-13747"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3734#event-13748"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3734#issuecomment-27924",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
