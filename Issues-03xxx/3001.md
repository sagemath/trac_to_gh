...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3001#issuecomment-16464",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3001/trac_3001.patch",
    "created_at": "2009-07-02T02:30:25Z",
    "issue": "https://github.com/sagemath/sage/issues/3001",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3001/trac_3001.patch",
...
```json
{
    "body": "Attachment [trac_3001.patch](https://github.com/sagemath/sage/files/ticket3001/trac_3001.patch) by @dandrake created at 2009-07-02 02:30:25",
    "created_at": "2009-07-02T02:30:25Z",
    "issue": "https://github.com/sagemath/sage/issues/3001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3001#issuecomment-16465",
    "user": "https://github.com/dandrake"
}
```

Attachment [trac_3001.patch](https://github.com/sagemath/sage/files/ticket3001/trac_3001.patch) by @dandrake created at 2009-07-02 02:30:25
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3001#issuecomment-16466",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3001#issuecomment-16467",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3001#issuecomment-16468",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3001#issuecomment-16469",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
