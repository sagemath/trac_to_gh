...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30468"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30471"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3214",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30472"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30473"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30476"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30478"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30479"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30485"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30486"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30487"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30488"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30489"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3214#issuecomment-17793",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:17'>Comment 17:</a>\nAttachment: **[trac_3214-py_gcd.patch.gz](https://github.com/sagemath/sage/files/ticket3214/trac_3214-py_gcd.patch.gz)**\n\nI finally found time to look at this.\n\n[attachment: trac_3214-py_gcd.patch.gz](https://github.com/sagemath/sage/files/ticket3214/trac_3214-py_gcd.patch.gz) fixes the doctest problem. It is not a very clean solution, but since we are going to switch to using Sage/Singular for gcd's it's not worth investing more time in this.\n\nIf someone can look over my 2 line patch, and change the subject to \"positive review\", maybe this can still make it to 3.3.",
    "created_at": "2009-02-08T18:30:23Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/3214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3214#issuecomment-17794",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30491"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3214#issuecomment-17795",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30494"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3214",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3214#event-30497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3214",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3214#issuecomment-17796",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
