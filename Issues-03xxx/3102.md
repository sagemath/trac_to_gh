...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22479",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3102#event-10998"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22480",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] debugging output in p-adics with print mode \"digits\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3102#event-10999"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22481",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "rename": {
        "from": "[with patch, needs review] debugging output in p-adics with print mode \"digits\"",
        "to": "[with patch, with review, issue remains] debugging output in p-adics with print mode \"digits\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3102#event-11000"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "rename": {
        "from": "[with patch, with review, issue remains] debugging output in p-adics with print mode \"digits\"",
        "to": "[with patch, needs review] debugging output in p-adics with print mode \"digits\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3102#event-11001"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22482",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22483",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22484",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22485",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] debugging output in p-adics with print mode \"digits\"",
        "to": "[with patch, positive review] debugging output in p-adics with print mode \"digits\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3102#event-11002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22486",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22487",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3102#event-11003"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22488",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3102#issuecomment-22489",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
