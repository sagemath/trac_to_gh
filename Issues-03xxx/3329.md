...
```json
{
    "body": "<a id='comment:1'></a>See also #3330, which is about the exact same test case, but requests a working implementation of GCD (rather than just a better error message).",
    "created_at": "2008-05-29T17:39:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3329#issuecomment-24909",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:1'></a>See also #3330, which is about the exact same test case, but requests a working implementation of GCD (rather than just a better error message).
...
```json
{
    "body": "<a id='comment:3'></a>This seems to work now because we avoid Singular\n\n```\nsage: R.<a,b> = NumberField(x^2-3,'g').extension(x^2-7,'h')[]\nsage: h = R.base_ring().gen()\nsage: S.<y> = R.fraction_field()[]\nsage: xgcd(y^2, a*h*y+b)\n(49*a^4*b^2/(343*a^6), 1, ((-1)/(h*a))*y + 49*a^4*b/(343*a^6))\n```\n\nCarl, any thoughts on this?",
    "created_at": "2009-01-23T07:21:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3329#issuecomment-24911",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>This seems to work now because we avoid Singular
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3329#issuecomment-24912",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3329#issuecomment-24913",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Since Carl's not involved any more, and this now works fine (in sage-4.3.1.rc0 too), I'm closing this as fixed:\n\n```\nbash$ sage\n----------------------------------------------------------------------\n----------------------------------------------------------------------\n**********************************************************************\n*                                                                    *\n* Warning: this is a prerelease version, and it may be unstable.     *\n*                                                                    *\n**********************************************************************\nsage:   R.<a,b> = NumberField(x^2-3,'g').extension(x^2-7,'h')[]\nsage:   h = R.base_ring().gen()\nsage:   S.<y> = R.fraction_field()[]\nsage:   xgcd(y^2, a*h*y+b)\n(7*a^2*b^2/(7*a^2*b^2), 7*a^2/b^2, (((-7)*a^2)/(h*a*b^2))*y + 7*a^2*b/(7*a^2*b^2))\n```",
    "created_at": "2010-01-18T13:08:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3329#issuecomment-24914",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>Since Carl's not involved any more, and this now works fine (in sage-4.3.1.rc0 too), I'm closing this as fixed:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3329#issuecomment-24915",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3329#issuecomment-24916",
    "user": "https://github.com/williamstein"
}
```
