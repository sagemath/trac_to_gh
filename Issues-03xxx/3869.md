# Issue 3869: [with patch, positive review] CremonaDatabase functions iter() and isogeny_classes() sort keys wrongly
...
```json
{
    ...
    "title": "[with patch, positive review] CremonaDatabase functions iter() and isogeny_classes() sort keys wrongly",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3869#event-8881"
}
```
