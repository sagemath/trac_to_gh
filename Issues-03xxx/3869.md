...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3869#issuecomment-29060",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3869#issuecomment-29061",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "rename": {
        "from": "CremonaDatabase functions iter() and isogeny_classes() sort keys wrongly",
        "to": "[with patch, needs review] CremonaDatabase functions iter() and isogeny_classes() sort keys wrongly"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3869#event-14369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "rename": {
        "from": "[with patch, needs review] CremonaDatabase functions iter() and isogeny_classes() sort keys wrongly",
        "to": "[with patch, positive review] CremonaDatabase functions iter() and isogeny_classes() sort keys wrongly"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3869#event-14370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3869#issuecomment-29062",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3869#issuecomment-29063",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3869#event-14371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3869#issuecomment-29064",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3869#issuecomment-29065",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
