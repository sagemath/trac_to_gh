...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3716#issuecomment-27768",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3716",
    "rename": {
        "from": "[with spkg, needs review] add GINV as experimental/optional package",
        "to": "[with spkg, positive review] add GINV as experimental/optional package"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3716#event-13667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3716#issuecomment-27769",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3716#issuecomment-27770",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3716#issuecomment-27771",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3716",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3716#event-13668"
}
```
