...
archive/attachments_003637.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac-3499.2.patch](https://github.com/sagemath/sage/files/ticket3499/trac-3499.2.patch)\n\nI just realized that this may depend on trac #3495. Sorry.",
    "created_at": "2008-06-24T00:26:42Z",
    "issue": "https://github.com/sagemath/sage/issues/3499",
    "type": "issue_comment",
...
archive/attachments_003638.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac-3499-2.patch",
