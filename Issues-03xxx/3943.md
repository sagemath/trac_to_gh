...
```json
{
    "body": "<a id='comment:1'></a>Second patch applied. Still not ready for review. Now has block designs, insidence matrix and graph, automorphism group and block designs from finite projective geometries.",
    "created_at": "2008-09-01T02:36:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28947",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:1'></a>Second patch applied. Still not ready for review. Now has block designs, insidence matrix and graph, automorphism group and block designs from finite projective geometries.
...
```json
{
    "body": "<a id='comment:2'></a>Added affine geometry designs, Witt designs and significant \"polishing\".",
    "created_at": "2008-09-05T12:25:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28948",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:2'></a>Added affine geometry designs, Witt designs and significant "polishing".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28949",
...
```json
{
    "body": "<a id='comment:6'></a>I've made some revisions following (offlist) suggestions of Robert Miller. This patch 10575 is rebased on 3.1.3.alpha0 and does not use the other patches. \n\nIt passes sage -t .../block_design.py. However, for me it fails sage -testall (it triggers a mysterious-to-me SEGFAULT in some of the calculus files).",
    "created_at": "2008-09-21T02:35:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28952",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:6'></a>I've made some revisions following (offlist) suggestions of Robert Miller. This patch 10575 is rebased on 3.1.3.alpha0 and does not use the other patches. 
...
```json
{
    "body": "<a id='comment:7'></a>I just want to raise the initial point rlm made: Why should we merge this? The XML seems like a bad, bad idea and whatever functionality is missing can (according to rlm) be easily added via our own code. \n\nSince this requires an spkg I see little possibility for this make to make it past the inclusion procedure. We had the first rejection in form of gp2c and I feel the same that we should stop including \"random\" and likely half baked code.\n\nCheers,\n\nMichae",
    "created_at": "2008-09-21T05:31:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28953",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>I just want to raise the initial point rlm made: Why should we merge this? The XML seems like a bad, bad idea and whatever functionality is missing can (according to rlm) be easily added via our own code. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28955",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>I think I have implemented everything both Robert M and Michael have suggested. It needs more functionality but this is a basic start and passes sage -testall. To install,\napply 10575 and 10576 to 3.1.3.alpha0.",
    "created_at": "2008-09-23T10:06:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28957",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:11'></a>I think I have implemented everything both Robert M and Michael have suggested. It needs more functionality but this is a basic start and passes sage -testall. To install,
apply 10575 and 10576 to 3.1.3.alpha0.
...
```json
{
    "body": "<a id='comment:16'></a>Actually, can I suggest getting rid of the \"trac_\" part and just going with \"XXXX-description-of-patch.patch\"?  Our policy is that all patches go through trac, so it's somewhat redundant.  Also, it's quicker easier to tab-complete if the \"trac_\" prefix is not there.",
    "created_at": "2008-09-24T01:41:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28961",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:16'></a>Actually, can I suggest getting rid of the "trac_" part and just going with "XXXX-description-of-patch.patch"?  Our policy is that all patches go through trac, so it's somewhat redundant.  Also, it's quicker easier to tab-complete if the "trac_" prefix is not there.
...
```json
{
    "body": "<a id='comment:17'></a>This is not a discussion for this particular ticket, but for sage-devel.",
    "created_at": "2008-09-24T01:42:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28962",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:17'></a>This is not a discussion for this particular ticket, but for sage-devel.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28963",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I'll be sure to do all these things. I can do them tomorrow \nbut it is no problem with me if it doesn't get reviewed \nuntil after 3.1.3.final is out this weekend.",
    "created_at": "2008-09-24T12:29:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28964",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:19'></a>I'll be sure to do all these things. I can do them tomorrow 
but it is no problem with me if it doesn't get reviewed 
until after 3.1.3.final is out this weekend.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28965",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28967",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:23'></a>Replying to [comment:22 wdj]:\n> Robert:\n> \n> Maybe the class `IncidenceStructure` belongs in its own module, say `incidence_structures.py`? Which directory it goes in might does not matter so much, so why not put both in designs? What do you think?\n\n\nThat definitely works for me. If anyone wants to move it around, they can discuss it later.",
    "created_at": "2008-09-25T23:52:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28969",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:23'></a>Replying to [comment:22 wdj]:
> Robert:
> 
> Maybe the class `IncidenceStructure` belongs in its own module, say `incidence_structures.py`? Which directory it goes in might does not matter so much, so why not put both in designs? What do you think?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28970",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28971",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28972",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>I think these patches satisfy all the docstring requirements you listed above. They pass sage -t -optional\nand sage -t. Sorry for the ridiculous number of patches. I kept forgetting things, eg, hg details. Not the dual of a block design is not necessarily a block design, so I made BlockDesign with a test=False option.",
    "created_at": "2008-09-27T00:35:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28973",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:25'></a>I think these patches satisfy all the docstring requirements you listed above. They pass sage -t -optional
and sage -t. Sorry for the ridiculous number of patches. I kept forgetting things, eg, hg details. Not the dual of a block design is not necessarily a block design, so I made BlockDesign with a test=False option.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28974",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28975",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:27'></a>There is no such thing as an almost positive review :). Please stick to the default tags.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-27T22:24:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28977",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:27'></a>There is no such thing as an almost positive review :). Please stick to the default tags.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28978",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28980",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28981",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:30'></a>Attachment [trac3943-block-designs8.patch](tarball://root/attachments/some-uuid/ticket3943/trac3943-block-designs8.patch) by @wdjoyner created at 2008-09-30 03:03:06\n\nThis last patch may or may not improve things. It passes sage -t -optional.\n\n1. I moved __repr__ to __str__ and created a very simple __repr__ method.\n2. I moved is_block_design to block_design_checker\n3. Created a new an rigorous (and very slow) is_block_design, following an off-list suggestion of the referee.\n4. Added some material to some of the docstrings.",
    "created_at": "2008-09-30T03:03:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28982",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:30'></a>Attachment [trac3943-block-designs8.patch](tarball://root/attachments/some-uuid/ticket3943/trac3943-block-designs8.patch) by @wdjoyner created at 2008-09-30 03:03:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28983",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:32'></a>Apply all patches in order.",
    "created_at": "2008-09-30T03:45:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28984",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:32'></a>Apply all patches in order.
...
```json
{
    "body": "<a id='comment:34'></a>Merged all *eight* patches in Sage 3.1.3.alpha2",
    "created_at": "2008-09-30T07:02:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28986",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:34'></a>Merged all *eight* patches in Sage 3.1.3.alpha2
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3943#issuecomment-28987",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
