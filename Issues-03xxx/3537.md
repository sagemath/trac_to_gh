...
{
    "assignees": [],
    "body": "The env variable RM is set to `rm` instead of `rm -f`. This breaks newer libtools, for example anything in Fedora 12 or later (libtool 2.2.6, autoconf 2.63, automake 1.11.1). They assume that `$RM` is either unset or `RM=\"rm -f\"`, that is, deleting non-existing files must not cause an error.\n\nOne of the symptoms of this breakage is that configure ends with\n\n```\nrm: cannot remove `libtoolT': No such file or directory\n```\nCompile will break later on...\n\n---\n\nThere are three approaches presented here:\n\n- change $RM from \"rm\" to \"rm -f\": [attachment: trac_3537_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537_scripts.patch.gz)\n- keep $RM as it is, but document it: [attachment: trac_3537-doc.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-doc.patch.gz) (needs_work)\n- don't set $RM at all: [attachment: trac_3537-unset-RM.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-unset-RM.patch.gz)\n\nApply [attachment: trac_3537-unset-RM.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-unset-RM.patch.gz)\n\nAssignee: **@garyfurnish**\n\nCC:  mabshoff Snark drkirkby @jdemeyer\n\nAuthor: **Jeroen Demeyer**\n\nReviewer: **Mariah Lenox**\n\nMerged: **sage-4.7.1.alpha1**\n\n_Issue created by migration from https://trac.sagemath.org/ticket/3537_\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33608"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33610"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33612"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33614"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33617"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33618"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33621"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33622"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33623"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33624"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33626"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -7,4 +7,11 @@\n ```\n Compile will break later on...\n \n+---\n \n+There are two approaches presented here:\n+\n+- change $RM from \"rm\" to \"rm -f\"  (this is [attachment: trac_3537_scripts.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537_scripts.patch.gz))\n+- keep $RM as it is, but document it (this is [attachment: trac_3537-doc.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-doc.patch.gz))\n+\n+Only one should be applied, not both.\n``````\n",
    "created_at": "2011-03-26T17:04:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -15,3 +15,5 @@\n - keep $RM as it is, but document it (this is [attachment: trac_3537-doc.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-doc.patch.gz))\n \n Only one should be applied, not both.\n+\n+**Apply** [attachment: trac_3537-doc.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-doc.patch.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33629"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33631"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33632"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3537#issuecomment-20126",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:23'>Comment 23:</a>\nAttachment: **[trac_3537-unset-RM.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-unset-RM.patch.gz)**\n\n[attachment: trac_3537-unset-RM.patch.gz](https://github.com/sagemath/sage/files/ticket3537/trac_3537-unset-RM.patch.gz) applied to sage-4.7.rc2 tested on skynet/taurus with make testlong.  All tests passed.  Positive review.",
    "created_at": "2011-05-12T20:40:02Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3537#issuecomment-20127",
    "user": "https://github.com/sagetrac-mariah"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33636"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3537#issuecomment-20128",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3537#issuecomment-20129",
    "user": "https://github.com/sagetrac-mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3537#issuecomment-20130",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33638"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3537#event-33639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3537#issuecomment-20131",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3537",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3537#issuecomment-20132",
    "user": "https://github.com/jdemeyer"
}
```
