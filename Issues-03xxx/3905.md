...
```json
{
    "body": "<a id='comment:1'></a>(By the way, this patch also fixes the issue raised in #3393.  If this patch gets merged into Sage, we should close that ticket, too.)",
    "created_at": "2008-08-20T00:38:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28598",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:1'></a>(By the way, this patch also fixes the issue raised in #3393.  If this patch gets merged into Sage, we should close that ticket, too.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28599",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Hi, I've posted my notes above. Please be soft on me w.r.t. to the wording which might be perceived as rude/commanding. I don't mean it that way rather these are just short notes with suggestions/impressions etc. I hope you don't take offense.",
    "created_at": "2008-08-20T15:03:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28601",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>Hi, I've posted my notes above. Please be soft on me w.r.t. to the wording which might be perceived as rude/commanding. I don't mean it that way rather these are just short notes with suggestions/impressions etc. I hope you don't take offense.
...
```json
{
    "body": "<a id='comment:4'></a>Thanks for the comments. I will be busy with some other work for a while, and then I'll have time to try to deal with these. I will probably have questions about some of them, because I don't understand everything that I probably should.\n\nMeanwhile, if you have more comments, please let me know.",
    "created_at": "2008-08-20T17:31:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28602",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:4'></a>Thanks for the comments. I will be busy with some other work for a while, and then I'll have time to try to deal with these. I will probably have questions about some of them, because I don't understand everything that I probably should.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28603",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28606",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>By the way, do the patches here take care of #1647 and #1648? How about #2078? #2422?  (And I already pointed out #3393.)\n\nIf this is closed, I think those others should be as well.  (It's always fun to close a lot of tickets, right?)",
    "created_at": "2008-08-25T21:21:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28607",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>By the way, do the patches here take care of #1647 and #1648? How about #2078? #2422?  (And I already pointed out #3393.)
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -9,6 +9,13 @@\n Meanwhile, in addition to the patch, you can look at a PDF version of the guide here:\n [http://www.math.washington.edu/~palmieri/Sage/prog.pdf](http://www.math.washington.edu/~palmieri/Sage/prog.pdf)\n \n+Once this ticket is merged we can close:\n+* #1647\n+* #1648\n+* #2078\n+* #2422\n+* #3393\n+\n Comment: 1\n \n Summary: [with patch, needs review] revision of programming guide\n``````\n",
    "created_at": "2008-08-25T21:33:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28608",
...
```json
{
    "body": "<a id='comment:10'></a>Thanks for pointing that out. I mentioned this ticket on the tickets you mentioned.\n\nCheers,\n\nMichael",
    "created_at": "2008-08-25T21:33:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28609",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Thanks for pointing that out. I mentioned this ticket on the tickets you mentioned.
...
```json
{
    "body": "<a id='comment:11'></a>`mabshoff` is looking at the first patch, I've looked over the second patch, and the only complaint I have is that approx. line 312 isn't grammatical:\n\n```\nIt is {\\em very important} that you include your name in\nthe AUTHOR log, since everybody who submits code to \\sage\nto receive proper credit...\n```\n\nThey *should* receive proper credit...",
    "created_at": "2008-08-31T00:20:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28610",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:11'></a>`mabshoff` is looking at the first patch, I've looked over the second patch, and the only complaint I have is that approx. line 312 isn't grammatical:
...
```json
{
    "body": "<a id='comment:14'></a>The PRNG stuff is very well documented in the relevant modules. Perhaps a pointer in that direction is enough?",
    "created_at": "2008-08-31T07:47:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28613",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:14'></a>The PRNG stuff is very well documented in the relevant modules. Perhaps a pointer in that direction is enough?
...
```json
{
    "body": "<a id='comment:16'></a>Merged both patches in Sage 3.1.2.alpha3",
    "created_at": "2008-08-31T07:54:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28615",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:16'></a>Merged both patches in Sage 3.1.2.alpha3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3905#issuecomment-28616",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
