...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3597#issuecomment-26021",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Positive review, it builds for me, but cripples Maxima for now. Oh well, Maxima without readline is better than no Maxima at all.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-08T00:16:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3597#issuecomment-26022",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Positive review, it builds for me, but cripples Maxima for now. Oh well, Maxima without readline is better than no Maxima at all.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3597#issuecomment-26023",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3597#issuecomment-26024",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
