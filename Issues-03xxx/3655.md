...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3655#issuecomment-26448",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I added a patch implementing the suggestion above. It is just a few lines. Passes sage -testall.",
    "created_at": "2008-07-15T10:49:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3655#issuecomment-26449",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:1'></a>I added a patch implementing the suggestion above. It is just a few lines. Passes sage -testall.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3655#issuecomment-26450",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3655#issuecomment-26451",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3655#issuecomment-26452",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3655#issuecomment-26453",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
