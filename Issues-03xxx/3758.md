...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3758#issuecomment-28109",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3758#issuecomment-28110",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13851"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13852"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3758#issuecomment-28111",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3758#issuecomment-28112",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "rename": {
        "from": "crypto --   sage -t -long devel/sage/sage/crypto/mq/sr.py  fails on many machines",
        "to": "[with patch, needs review] crypto --   sage -t -long devel/sage/sage/crypto/mq/sr.py  fails on many machines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3758#issuecomment-28113",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "rename": {
        "from": "[with patch, needs review] crypto --   sage -t -long devel/sage/sage/crypto/mq/sr.py  fails on many machines",
        "to": "[with patch, positive review] crypto --   sage -t -long devel/sage/sage/crypto/mq/sr.py  fails on many machines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3758#issuecomment-28114",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3758",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3758#issuecomment-28115",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13857"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3758#event-13858"
}
```
