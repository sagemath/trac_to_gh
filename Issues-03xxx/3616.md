...
```json
{
    "body": "<a id='comment:1'></a>Recompiling with -O0 does *not* fix the problem.  The flint test suite *fails* on\nitanium even with -O0:\n\n```\nTesting fmpz_CRT_ui()... FAIL!\nTesting fmpz_sqrtrem()... ok\n\nAt least one test FAILED!\n```\n\nThat's the first failure.\n\nThis is flint-1.010.\n\nwilliam",
    "created_at": "2008-07-08T19:27:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3616#issuecomment-26124",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Recompiling with -O0 does *not* fix the problem.  The flint test suite *fails* on
itanium even with -O0:
...
```json
{
    "body": "<a id='comment:2'></a>More test failures on iras (itanium box):\n\n```\nTesting fmpz_poly_CRT_unsigned()... FAIL!\nTesting fmpz_poly_CRT()... FAIL!\n```",
    "created_at": "2008-07-08T19:51:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3616#issuecomment-26125",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>More test failures on iras (itanium box):
...
```json
{
    "body": "<a id='comment:3'></a>Due to the hard work by Bill Hard we now have a 1.0.11 spkg at\n\nhttp://sage.math.washington.edu/home/mabshoff/flint-1.011.spkg\n\nI turned on spkg-check per default. Builds and tests fine on x86-64 and Itanium.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-09T16:04:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3616#issuecomment-26126",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Due to the hard work by Bill Hard we now have a 1.0.11 spkg at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3616#issuecomment-26127",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3616",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3616#issuecomment-26128",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
