...
```json
{
    ...
    "asset_name": "sage-3506.patch",
    "asset_url": "tarball://root/attachments/ticket3506/sage-3506.patch",
    "created_at": "2008-06-25T01:40:02Z",
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3506/sage-3506.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [sage-3506.patch](https://github.com/sagemath/sage/files/ticket3506/sage-3506.patch) by @williamstein created at 2008-06-25 01:40:02",
    "created_at": "2008-06-25T01:40:02Z",
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3506#issuecomment-19878",
    "user": "https://github.com/williamstein"
}
```

Attachment [sage-3506.patch](https://github.com/sagemath/sage/files/ticket3506/sage-3506.patch) by @williamstein created at 2008-06-25 01:40:02
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3506#event-19295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3506#issuecomment-19879",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "rename": {
        "from": "I can't build m4ri on the vmware image unless I replace the ctypedef int bit by just an int in the two places it is used.",
        "to": "m4ri misbuilds with gcc 4.1.2 20060928 (prerelease) (Ubuntu 4.1.1-13ubuntu5)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3506#event-19296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "rename": {
        "from": "m4ri misbuilds with gcc 4.1.2 20060928 (prerelease) (Ubuntu 4.1.1-13ubuntu5)",
        "to": "Sage's m4ri extension fails to build with gcc 4.1.2 20060928 (prerelease) (Ubuntu 4.1.1-13ubuntu5)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3506#event-19297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3506#issuecomment-19880",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3506#issuecomment-19881",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3506#event-19298"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3506#event-19299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3506#event-19300"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3506#issuecomment-19882",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
