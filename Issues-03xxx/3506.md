...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3506#issuecomment-25990",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] I can't build m4ri on the vmware image unless I replace the ctypedef int bit by just an int in the two places it is used."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3506#event-12732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3506#issuecomment-25991",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "rename": {
        "from": "[with patch; needs review] I can't build m4ri on the vmware image unless I replace the ctypedef int bit by just an int in the two places it is used.",
        "to": "[with patch; needs review] m4ri misbuilds with gcc 4.1.2 20060928 (prerelease) (Ubuntu 4.1.1-13ubuntu5)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3506#event-12733"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "rename": {
        "from": "[with patch; needs review] m4ri misbuilds with gcc 4.1.2 20060928 (prerelease) (Ubuntu 4.1.1-13ubuntu5)",
        "to": "[with patch; needs review] Sage's m4ri extension fails to build with gcc 4.1.2 20060928 (prerelease) (Ubuntu 4.1.1-13ubuntu5)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3506#event-12734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3506#issuecomment-25992",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3506#issuecomment-25993",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3506#issuecomment-25994",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3506#event-12735"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3506#issuecomment-25995",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
