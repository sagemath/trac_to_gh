...
```json
{
    ...
    "rename": {
        "from": "quaddouble configuration and spkg-install cleaning",
        "to": "[with patch, needs review] quaddouble configuration and spkg-install cleaning"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3079#event-10905"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3079#issuecomment-22284",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3079#event-10906"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3079#issuecomment-22285",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3079",
    "rename": {
        "from": "[with patch, needs review] quaddouble configuration and spkg-install cleaning",
        "to": "[with patch, needs work] quaddouble configuration and spkg-install cleaning"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3079#event-10907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3079#issuecomment-22286",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3079#issuecomment-22287",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3079",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3079#event-10908"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3079#event-10909"
}
```
