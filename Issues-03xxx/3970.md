...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23180",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23181",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23182",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23183",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23184",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23185",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23186",
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [trac_3970.patch](https://github.com/sagemath/sage/files/ticket3970/trac_3970.patch) by @mwhansen created at 2009-10-07 04:20:59\n\nI forgot to remove the pari doctest.  It should also be removed since these parents should not have coercions going in both directions.\n\nThis is taken care of in the new patch.",
    "created_at": "2009-10-07T04:20:59Z",
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23187",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3970#issuecomment-23188",
    "user": "https://github.com/maxthemouse"
}
```
