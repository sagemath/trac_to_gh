...
```json
{
    "body": "<a id='comment:1'></a>In fact it is even easier than that!  For about 6 months mwrank has had the ability to deal with non-integral and non-minimal models.  In this case simply commenting out lines 1350 and 1351 in ell_rational_field.py produces this:\n\n```\nsage: E = EllipticCurve([-3/8,-2/3])\nsage: E.gens()\n[(10/9 : 29/54 : 1)]\n```\n\nPatch coming up.",
    "created_at": "2008-05-26T13:39:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22112",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>In fact it is even easier than that!  For about 6 months mwrank has had the ability to deal with non-integral and non-minimal models.  In this case simply commenting out lines 1350 and 1351 in ell_rational_field.py produces this:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22114",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [eclib.patch](tarball://root/attachments/some-uuid/ticket3119/eclib.patch) by @JohnCremona created at 2008-05-26 21:29:09\n\nExtra patch added to fix the same bug in a better way.  Now wrap.cc should not need to be changed -- just checking...",
    "created_at": "2008-05-26T21:29:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22117",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>Attachment [eclib.patch](tarball://root/attachments/some-uuid/ticket3119/eclib.patch) by @JohnCremona created at 2008-05-26 21:29:09
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac-3119a.patch](tarball://root/attachments/some-uuid/ticket3119/trac-3119a.patch) by @JohnCremona created at 2008-05-26 22:11:45\n\nLatest patch trac-3119a.patch undoes one change in the original patch (the one-line change to wrap.cc) since the same thing is fixed better by patching eclib.  I have tested this, so I hope it is clear.",
    "created_at": "2008-05-26T22:11:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22118",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:6'></a>Attachment [trac-3119a.patch](tarball://root/attachments/some-uuid/ticket3119/trac-3119a.patch) by @JohnCremona created at 2008-05-26 22:11:45
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22119",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22120",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>William -- my patches to sort this one out included a (tiny) patch to eclib source code which I posted here.  Without that patch the issue is *not* fixed.  Can you confirm whether or not you were testing with a patched eclib?  John",
    "created_at": "2008-06-16T13:23:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22122",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:11'></a>William -- my patches to sort this one out included a (tiny) patch to eclib source code which I posted here.  Without that patch the issue is *not* fixed.  Can you confirm whether or not you were testing with a patched eclib?  John
...
```json
{
    "body": "<a id='comment:12'></a>Yes, I had that fix applied.  Does everything *definitely* work for you with that patch applied?",
    "created_at": "2008-06-19T23:03:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22123",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:12'></a>Yes, I had that fix applied.  Does everything *definitely* work for you with that patch applied?
...
```json
{
    "body": "<a id='comment:13'></a>I applied all 4 patches to a fresh install of 3.0.3.rc0, which I believe is the same as 3.0.3.  I did not apply the eclib patch which I assumed had been already applied to 3.0.3 (if Michael reads this could he confirm?).  And there were no problems:\n\n```\njohn@ubuntu%sage -t /home/john/sage-3.0.3.rc0/devel/sage-3119/sage/schemes/elliptic_curves/ell_rational_field.py \nsage -t  devel/sage-3119/sage/schemes/elliptic_curves/ell_rational_field.py\n\t [112.5 s]\n``` \nSo this is rather mysterious.\n\nIncidentally some of those tests are taking a bit long.",
    "created_at": "2008-06-20T20:33:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22124",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:13'></a>I applied all 4 patches to a fresh install of 3.0.3.rc0, which I believe is the same as 3.0.3.  I did not apply the eclib patch which I assumed had been already applied to 3.0.3 (if Michael reads this could he confirm?).  And there were no problems:
...
```json
{
    "body": "<a id='comment:15'></a>The newly patched eclib at  http://www.warwick.ac.uk/staff/J.E.Cremona/eclib-20080310.p3.spkg contains several small fixes *including* the eclib.patch attached to this ticket already.",
    "created_at": "2008-06-23T21:14:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22126",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:15'></a>The newly patched eclib at  http://www.warwick.ac.uk/staff/J.E.Cremona/eclib-20080310.p3.spkg contains several small fixes *including* the eclib.patch attached to this ticket already.
...
```json
{
    "body": "<a id='comment:16'></a>I have split of the spkg to #3509.\n\nCheers,\n\nMichael",
    "created_at": "2008-06-25T08:28:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22127",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:16'></a>I have split of the spkg to #3509.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22128",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>I have checked that this patch still applies cleanly and passes tests with 3.1.alpha0.\n\nIt is a *very simple* patch -- the serious change happened in eclib and has already been merged.\n\nPlease will someone help put this to bed!",
    "created_at": "2008-08-09T08:26:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22130",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:19'></a>I have checked that this patch still applies cleanly and passes tests with 3.1.alpha0.
...
```json
{
    "body": "<a id='comment:20'></a>This works for me with 3.0.6.  The sage library patch looks good; I haven't checked the already merged changes to eclib.\n\nApply!",
    "created_at": "2008-08-10T21:01:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22131",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:20'></a>This works for me with 3.0.6.  The sage library patch looks good; I haven't checked the already merged changes to eclib.
...
```json
{
    "body": "<a id='comment:21'></a>Patch looks good to me, but there is a minimal doctest issue related to numerical noise that I fixed:\n\n```\nsage -t -long devel/sage/sage/schemes/elliptic_curves/ell_rational_field.py\n**********************************************************************\nFile \"/scratch/mabshoff/release-cycle/sage-3.1.alpha1/tmp/ell_rational_field.py\", line 1475:\n    sage: EllipticCurve([0, 0, 1, -79, 342]).regulator(proof=False)  # long time (seconds)\nExpected:\n    14.7905275701310\nGot:\n    14.7905275701311\n**********************************************************************\n```\n\nCheers,\n\nMichael",
    "created_at": "2008-08-11T01:45:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22132",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:21'></a>Patch looks good to me, but there is a minimal doctest issue related to numerical noise that I fixed:
...
```json
{
    "body": "<a id='comment:22'></a>Merged in Sage 3.1.alpha1",
    "created_at": "2008-08-11T02:05:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22133",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:22'></a>Merged in Sage 3.1.alpha1
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3119#event-7043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3119#issuecomment-22134",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3119",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3119#event-7044"
}
```
