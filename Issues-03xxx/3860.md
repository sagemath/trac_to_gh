...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3860#issuecomment-28976",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3860",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3860#issuecomment-28977",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3860",
    "rename": {
        "from": "itanium -- can't build mercurial extension",
        "to": "[with spkg, needs review] itanium -- can't build mercurial extension"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3860#event-14318"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3860",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3860#issuecomment-28978",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3860",
    "rename": {
        "from": "[with spkg, needs review] itanium -- can't build mercurial extension",
        "to": "[with spkg, positive review] itanium -- can't build mercurial extension"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3860#event-14319"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3860",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3860#issuecomment-28979",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3860",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3860#event-14320"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3860",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3860#issuecomment-28980",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
