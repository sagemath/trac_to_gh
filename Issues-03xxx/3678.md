...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3678#event-13497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3678#issuecomment-27409",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3678#issuecomment-27410",
...
```json
{
    ...
    "rename": {
        "from": "fractional powers for polynomial variables bug",
        "to": "[with patch, needs review] fractional powers for polynomial variables bug"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3678#event-13498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3678#issuecomment-27411",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "rename": {
        "from": "[with patch, needs review] fractional powers for polynomial variables bug",
        "to": "[with patch, with positive review] fractional powers for polynomial variables bug"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3678#event-13499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3678#issuecomment-27412",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3678#issuecomment-27413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3678#event-13500"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3678#event-13501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3678#issuecomment-27414",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
