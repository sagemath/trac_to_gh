...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3343#issuecomment-24389",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] arguments, documentation to ln function"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3343#event-11933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3343",
    "rename": {
        "from": "[with patch, needs review] arguments, documentation to ln function",
        "to": "[with patch, with positive review] arguments, documentation to ln function"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3343#event-11934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3343",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3343#issuecomment-24390",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3343",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3343#issuecomment-24391",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3343",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3343#issuecomment-24392",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3343",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3343#event-11935"
}
```
