...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3234#issuecomment-23514",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3234",
    "rename": {
        "from": "[with patch; needs review] cygwin -- make numpy work with cygwin",
        "to": "[with patch; positive review] cygwin -- make numpy work with cygwin"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3234#event-11526"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3234#issuecomment-23515",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3234",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3234#event-11527"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3234#issuecomment-23516",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
