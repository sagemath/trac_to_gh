...
```json
{
    "body": "<a id='comment:1'></a>Wontfix since we have disabled libiconv for the R build on Solaris for now. Should iconv become mandatory we will revisit the issue.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-06T00:54:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3381#issuecomment-25562",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Wontfix since we have disabled libiconv for the R build on Solaris for now. Should iconv become mandatory we will revisit the issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3381#issuecomment-25563",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3381#issuecomment-25564",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
