...
```json
{
    "body": "<a id='comment:1'></a>I'm not sure exactly what you mean here, but if it would involve computing the basis_matrix for all `FreeModules` (even in the `FreeModule_ambient` case, where currently the basis_matrix is only computed lazily when requested) I think it's a bad idea unless the following can be vastly sped up:\n\n```\nsage: %time K = FreeModule(ZZ, 2000)\nCPU times: user 0.00 s, sys: 0.00 s, total: 0.00 s\nWall time: 0.00 s\nsage: %time _ = K.basis_matrix()\nCPU times: user 191.08 s, sys: 19.63 s, total: 210.71 s\nWall time: 210.69 s\n```",
    "created_at": "2008-08-02T14:12:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28374",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:1'></a>I'm not sure exactly what you mean here, but if it would involve computing the basis_matrix for all `FreeModules` (even in the `FreeModule_ambient` case, where currently the basis_matrix is only computed lazily when requested) I think it's a bad idea unless the following can be vastly sped up:
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_3699.patch](tarball://root/attachments/some-uuid/ticket3699/trac_3699.patch) by @JohnCremona created at 2009-03-22 18:31:37\n\nPatch attached which does what I think was intended.  Based on 3.4, all tests in sage/modules should pass.",
    "created_at": "2009-03-22T18:31:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28376",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:3'></a>Attachment [trac_3699.patch](tarball://root/attachments/some-uuid/ticket3699/trac_3699.patch) by @JohnCremona created at 2009-03-22 18:31:37
...
```json
{
    "body": "<a id='comment:5'></a>This still applies fine to 4.0 and is still in need of a review -- should be very quick!  All doctests in sage/modules pass.",
    "created_at": "2009-05-30T15:47:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28377",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>This still applies fine to 4.0 and is still in need of a review -- should be very quick!  All doctests in sage/modules pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28378",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28379",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3699#event-8474"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Merged in 4.0.1.rc0.",
    "created_at": "2009-06-03T18:29:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28380",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>Merged in 4.0.1.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28381",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28382",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3699#issuecomment-28383",
    "user": "https://github.com/mwhansen"
}
```
