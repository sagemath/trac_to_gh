# Issue 3529: [with spkg, positive review] ATLAS.spkg: reapply the PowerPC detection fix
...
```json
{
    ...
    "title": "[with spkg, positive review] ATLAS.spkg: reapply the PowerPC detection fix",
    "type": "issue",
