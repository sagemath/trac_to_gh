...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38102"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38103"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38104"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38105"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38106"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38107"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38108"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38109"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **@sagetrac-NilsSkoruppa**",
...
Changed assignee from **@williamstein** to **@sagetrac-NilsSkoruppa**
...
```json
{
    ...
    "title_was": "BinaryQF_reduced_representatives in binary_qf.py produces extra unreduced forms",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38110"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-NilsSkoruppa** to **@sagetrac-choldsworth**",
...
Changed assignee from **@sagetrac-NilsSkoruppa** to **@sagetrac-choldsworth**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38111"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38112"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38114"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3857",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3857#event-38115"
}
```
