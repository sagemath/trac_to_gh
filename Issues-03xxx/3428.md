...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19431",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19432",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [univariate_poly_quo_rem_zero.patch](https://github.com/sagemath/sage/files/ticket3428/univariate_poly_quo_rem_zero.patch) by @craigcitro created at 2008-06-15 21:55:42",
    "created_at": "2008-06-15T21:55:42Z",
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19433",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19434",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19435",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19436",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19437",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac-3428-doctest.patch](https://github.com/sagemath/sage/files/ticket3428/trac-3428-doctest.patch) by mabshoff created at 2008-06-23 10:00:53\n\nMerged in Sage 3.0.4.alpha0",
    "created_at": "2008-06-23T10:00:53Z",
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3428#issuecomment-19438",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
