...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28642",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28643",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14163"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "rename": {
        "from": "[with patch, needs review] 2d-plots has no functionality for grid lines",
        "to": "[with patch, positive review pending minor changes] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14164"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28644",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28645",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "rename": {
        "from": "[with patch, positive review pending minor changes] 2d-plots has no functionality for grid lines",
        "to": "[with patch, positive review pending minor changes, minor changes made] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14165"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28646",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28647",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "rename": {
        "from": "[with patch, positive review pending minor changes, minor changes made] 2d-plots has no functionality for grid lines",
        "to": "[with patch, needs re-review] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14166"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28648",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, positive review] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14167"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "rename": {
        "from": "[with patch, positive review] 2d-plots has no functionality for grid lines",
        "to": "[with patch, positive review, needs review] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14168"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28649",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "rename": {
        "from": "[with patch, positive review, needs review] 2d-plots has no functionality for grid lines",
        "to": "[with patch, positive review, needs rebase] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14169"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "rename": {
        "from": "[with patch, positive review, needs rebase] 2d-plots has no functionality for grid lines",
        "to": "[with patch, positive review] 2d-plots has no functionality for grid lines"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14170"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28650",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28651",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3825#event-14171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3825#issuecomment-28652",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
