...
```json
{
    "body": "<a id='comment:1'></a>From the jmol documentation, I don't know if there is anyway to tell it to draw a straight line (instead of a curve).  See http://chemapps.stolaf.edu/jmol/docs/#draw",
...
<a id='comment:1'></a>From the jmol documentation, I don't know if there is anyway to tell it to draw a straight line (instead of a curve).  See http://chemapps.stolaf.edu/jmol/docs/#draw
...
<a id='comment:6'></a>Less important now that the default 3d rendering engine
is Three.js, but still quite puzzling.
