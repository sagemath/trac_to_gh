...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38640"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38642"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38643"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38644"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38647"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38652"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38653"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38656"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38657"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38658"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38661"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38664"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,4 +14,4 @@\n \n ---\n \n-Apply only trac_3979_power_series_substitution_rev3.patch\n+Apply only [attachment: trac_3979_power_series_substitution_rev3.patch.gz](https://github.com/sagemath/sage/files/ticket3979/trac_3979_power_series_substitution_rev3.patch.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,4 +14,4 @@\n \n ---\n \n-Apply only [attachment: trac_3979_power_series_substitution_rev3.patch.gz](https://github.com/sagemath/sage/files/ticket3979/trac_3979_power_series_substitution_rev3.patch.gz)\n+Apply only [attachment: trac_3979_power_series_substitution_rev4.patch.gz](https://github.com/sagemath/sage/files/ticket3979/trac_3979_power_series_substitution_rev4.patch.gz)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -14,4 +14,4 @@\n \n ---\n \n-Apply only [attachment: trac_3979_power_series_substitution_rev4.patch.gz](https://github.com/sagemath/sage/files/ticket3979/trac_3979_power_series_substitution_rev4.patch.gz)\n+Apply [followed by  [attachment: trac_3979_power_series_substitution_rev4_extra.patch.gz](https://github.com/sagemath/sage/files/ticket3979/trac_3979_power_series_substitution_rev4_extra.patch.gz)(https://github.com/sagemath/sage/files/ticket3979/985a14acc1dc8f47d933c7ca80fc72b7.gz)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38665"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3979#issuecomment-23284",
    "user": "https://github.com/sagetrac-fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3979#issuecomment-23285",
    "user": "https://github.com/sagetrac-fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3979#issuecomment-23286",
    "user": "https://github.com/sagetrac-fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3979#issuecomment-23287",
    "user": "https://github.com/sagetrac-fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3979#issuecomment-23288",
    "user": "https://github.com/sagetrac-fwclarke"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3979#event-38668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3979#issuecomment-23289",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3979#issuecomment-23290",
    "user": "https://github.com/jdemeyer"
}
```
