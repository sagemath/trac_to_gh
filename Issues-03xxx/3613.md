...
```json
{
    ...
    "title": "[with positive review] symbolic equations are not passed to Maple correctly",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3613#issuecomment-29291",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3613#issuecomment-29292",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3613#issuecomment-29293",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3613/trac_3613.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3613#issuecomment-29294",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3613",
    "rename": {
        "from": "symbolic equations are not passed to Maple correctly",
        "to": "[with positive review] symbolic equations are not passed to Maple correctly"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3613#event-10760"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3613#issuecomment-29295",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3613",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3613#event-10761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3613#issuecomment-29296",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3613#event-10762"
}
```
