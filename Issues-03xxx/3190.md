# Issue 3190: [with spkg, positive review] add 64 bit OSX build support to zodb
...
```json
{
    ...
    "title": "[with spkg, positive review] add 64 bit OSX build support to zodb",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3190",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3190#event-7193"
}
```
