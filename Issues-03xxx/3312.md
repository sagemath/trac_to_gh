...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35620"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35621"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35622"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35623"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35624"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3312#issuecomment-17507",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35625"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3312#issuecomment-17508",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35629"
}
```
...
```json
{
    ...
    "title_was": "dsage.setup() -- very serious bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35631"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3312#issuecomment-17509",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3312#issuecomment-17510",
    "user": "https://github.com/yqiang"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3312",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35634"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3312",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3312#issuecomment-17511",
