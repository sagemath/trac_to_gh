...
```json
{
    "body": "<a id='comment:5'></a>DSage is completely broken in 3.0.2 and 3.0.3!!!!! Can you post some patches so that we can run it out of the box?",
...
<a id='comment:5'></a>DSage is completely broken in 3.0.2 and 3.0.3!!!!! Can you post some patches so that we can run it out of the box?
...
```json
{
    "body": "<a id='comment:6'></a>What exactly is wrong with this patch? Use this ticket to provide feedback about this particular patch and the issue it aims to fix. File a separate bug if dsage doesn't run for you and include some actual repro steps.",
...
<a id='comment:6'></a>What exactly is wrong with this patch? Use this ticket to provide feedback about this particular patch and the issue it aims to fix. File a separate bug if dsage doesn't run for you and include some actual repro steps.
...
```json
{
    "body": "<a id='comment:9'></a>Merged in Sage 3.0.3.final",
    "created_at": "2008-06-18T23:18:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3312",
    "type": "issue_comment",
...
<a id='comment:9'></a>Merged in Sage 3.0.3.final
