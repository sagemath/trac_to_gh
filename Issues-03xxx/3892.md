...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3892#issuecomment-29325",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3892#issuecomment-29326",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3892",
    "rename": {
        "from": "PowerSeries random element over GF(q) (Givaro) fails",
        "to": "[with patch, needs review] PowerSeries random element over GF(q) (Givaro) fails"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3892#event-14461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3892#issuecomment-29327",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3892",
    "rename": {
        "from": "[with patch, needs review] PowerSeries random element over GF(q) (Givaro) fails",
        "to": "[with patch, positive review] PowerSeries random element over GF(q) (Givaro) fails"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3892#event-14462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3892#issuecomment-29328",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3892#issuecomment-29329",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3892",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3892#event-14463"
}
```
