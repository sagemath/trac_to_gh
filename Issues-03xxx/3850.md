...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3850#issuecomment-22169",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [sage-3850.patch](https://github.com/sagemath/sage/files/ticket3850/sage-3850.patch) by @williamstein created at 2008-08-15 08:51:04\n\nRobert Bradshaw's #3788 caused this (and another failure).    The attached ticket fixes it.",
    "created_at": "2008-08-15T08:51:04Z",
    "issue": "https://github.com/sagemath/sage/issues/3850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3850#issuecomment-22170",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3850#issuecomment-22171",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3850#issuecomment-22172",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
