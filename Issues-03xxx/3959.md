...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23099",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3959/group_algebras.hg",
    "created_at": "2008-08-26T17:57:17Z",
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3959/group_algebras.hg",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [group_algebras.hg](https://github.com/sagemath/sage/files/ticket3959/group_algebras.hg) by @loefflerd created at 2008-08-26 17:57:17\n\n(The above hg changeset bundle works fine for me but the trac browser doesn't seem to like it -- not sure what's going on there.)",
    "created_at": "2008-08-26T17:57:17Z",
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23100",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23101",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23102",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3959/group_algebras_v1.patch",
    "created_at": "2008-08-27T14:10:36Z",
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3959/group_algebras_v1.patch",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23104",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23105",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23106",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3959",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3959#issuecomment-23107",
    "user": "https://github.com/loefflerd"
}
```
