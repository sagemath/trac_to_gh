...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3636#issuecomment-27054",
    "user": "https://github.com/itolkov"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] Text control, no label"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3636#event-13341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "rename": {
        "from": "[with patch; needs review] Text control, no label",
        "to": "[with patch; positive review pending additional documentation] Text control, no label"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3636#event-13342"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3636#issuecomment-27055",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3636#event-13343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3636#issuecomment-27056",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3636#issuecomment-27057",
    "user": "https://github.com/itolkov"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3636#issuecomment-27058",
    "user": "https://github.com/itolkov"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "rename": {
        "from": "[with patch; positive review pending additional documentation] Text control, no label",
        "to": "[with patch; positive review] Text control, no label"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3636#event-13344"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3636#issuecomment-27059",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3636#event-13345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3636#issuecomment-27060",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3636#event-13346"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3636#event-13347"
}
```
