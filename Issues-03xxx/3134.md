# Issue 3134: [with patch, positive review] binomial doesn't take big integers
...
```json
{
    ...
    "title": "[with patch, positive review] binomial doesn't take big integers",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3134#event-7088"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3134",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3134#event-7089"
}
```
