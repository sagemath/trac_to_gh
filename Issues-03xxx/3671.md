...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20917",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20918",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20919",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20489"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20920",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20491"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20492"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20921",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20494"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20922",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20923",
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20496"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20497"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20498"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20499"
}
```
...
```json
{
    ...
    "asset_name": "ffpack_charpoly_3671.patch",
    "asset_url": "tarball://root/attachments/ticket3671/ffpack_charpoly_3671.patch",
    "created_at": "2008-08-12T19:01:39Z",
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3671/ffpack_charpoly_3671.patch",
    "user": "https://github.com/ClementPernet"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20500"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20501"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[still no review needed] ssmod.py doctest failures in Sage 3.0.4 or later"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20502"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3671#issuecomment-20925",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "rename": {
        "from": "[still no review needed] ssmod.py doctest failures in Sage 3.0.4 or later",
        "to": "ssmod.py doctest failures in Sage 3.0.4 or later"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20503"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20504"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3671",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3671#event-20506"
}
```
