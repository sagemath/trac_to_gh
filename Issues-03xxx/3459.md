...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] incorrect coercion in number field ideals",
        "to": "[with patch, with positive review] incorrect coercion in number field ideals"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3459#event-12514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3459#issuecomment-25659",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3459#issuecomment-25660",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3459",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3459#event-12515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3459#issuecomment-25661",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3459#event-12516"
}
```
