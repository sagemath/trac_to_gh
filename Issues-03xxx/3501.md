...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3501#issuecomment-26666",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>This patch looks good and fixes the bug. \nI have run the doctest on 3.0.4alpha1, and they pass.",
    "created_at": "2008-06-24T23:12:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3501#issuecomment-26667",
    "user": "https://github.com/ClementPernet"
}
```

<a id='comment:1'></a>This patch looks good and fixes the bug. 
I have run the doctest on 3.0.4alpha1, and they pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3501#issuecomment-26668",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3501#issuecomment-26669",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
