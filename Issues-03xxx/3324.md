...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24866",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The code depends on: #3204 (which is in 3.0.3.alpha0) so it won't work against 3.0.2. Sorry for not pointing that out earlier. I don't know about the OSX failure though.",
    "created_at": "2008-06-03T15:02:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24867",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>The code depends on: #3204 (which is in 3.0.3.alpha0) so it won't work against 3.0.2. Sorry for not pointing that out earlier. I don't know about the OSX failure though.
...
```json
{
    "body": "<a id='comment:4'></a>I've updated the patch to avoid temporary files.",
    "created_at": "2008-06-12T22:30:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24868",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>I've updated the patch to avoid temporary files.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24869",
...
```json
{
    "body": "<a id='comment:7'></a>wstein, can you review my update until 6/18?",
    "created_at": "2008-06-16T03:29:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24870",
    "user": "https://github.com/malb"
}
```

<a id='comment:7'></a>wstein, can you review my update until 6/18?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24872",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [m4ri_png.patch](tarball://root/attachments/some-uuid/ticket3324/m4ri_png.patch) by @malb created at 2008-06-20 03:45:15\n\nThe attached patch addresses this issue.",
    "created_at": "2008-06-20T03:45:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24873",
    "user": "https://github.com/malb"
}
```

<a id='comment:9'></a>Attachment [m4ri_png.patch](tarball://root/attachments/some-uuid/ticket3324/m4ri_png.patch) by @malb created at 2008-06-20 03:45:15
...
```json
{
    "body": "<a id='comment:11'></a>This does not fix the problem for me:\n\n```\n\n/Users/was/s/local/lib/python2.5/site-packages/sage/matrix/matrix_space.py in <module>()\n     36 import matrix_modn_sparse\n     37 \n---> 38 import matrix_mod2_dense\n     39 #import matrix_mod2_sparse\n     40 \n\nImportError: dlopen(/Users/was/s/local/lib/python2.5/site-packages/sage/matrix/matrix_mod2_dense.so, 2): Symbol not found: _png_check_sig\n  Referenced from: /Users/was/s/local/lib//libgd.2.dylib\n  Expected in: flat namespace\n\nsage: \n\n```",
    "created_at": "2008-06-20T04:12:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24874",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>This does not fix the problem for me:
...
```json
{
    "body": "<a id='comment:13'></a>Are you 100% sure that you rebuilt with the patch applied? Note that I just replaced the patch and thus the download manager might have called in somewhat else when downloading. I'm just asking because it works for me on OSX. I'll try on a different machine though.",
    "created_at": "2008-06-22T17:59:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24875",
    "user": "https://github.com/malb"
}
```

<a id='comment:13'></a>Are you 100% sure that you rebuilt with the patch applied? Note that I just replaced the patch and thus the download manager might have called in somewhat else when downloading. I'm just asking because it works for me on OSX. I'll try on a different machine though.
...
```json
{
    "body": "<a id='comment:15'></a>**State of affairs for editorial meeting 26/06/08**\n\nI do have a working copy on bsd and I'm trying to find out what exactly made it work for me.",
    "created_at": "2008-06-25T11:18:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24877",
    "user": "https://github.com/malb"
}
```

<a id='comment:15'></a>**State of affairs for editorial meeting 26/06/08**
...
```json
{
    "body": "<a id='comment:17'></a>The problem with libpng.dylib is that certain spkgs like Python and R do not have LDFLAGS and CPPFLAGS set correctly so that on rebuilding them (on upgrade for example) we pick up the systems libpng which is broken. The issue has been corrected for Python, but some more work is needed for R and likely some other spkgs. \n\nCheers,\n\nMichael",
    "created_at": "2008-08-27T02:22:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:17'></a>The problem with libpng.dylib is that certain spkgs like Python and R do not have LDFLAGS and CPPFLAGS set correctly so that on rebuilding them (on upgrade for example) we pick up the systems libpng which is broken. The issue has been corrected for Python, but some more work is needed for R and likely some other spkgs. 
...
```json
{
    "body": "<a id='comment:18'></a>Guessing from William's failure above gd is also affected here. I believe #3792 will fix that issue.\n\nCheers,\n\nMichael",
    "created_at": "2008-08-27T02:23:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24880",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:18'></a>Guessing from William's failure above gd is also affected here. I believe #3792 will fix that issue.
...
```json
{
    "body": "<a id='comment:19'></a>I fixed all the problems on OSX in libpng.spkg, python.spkg and r.spkg and with those fixes the patch applies, builds correctly and all doctests pass on OSX. Positive review pending three other tickets I am about to open.\n\nCheers,\n\nMichael",
    "created_at": "2008-08-30T17:51:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24881",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:19'></a>I fixed all the problems on OSX in libpng.spkg, python.spkg and r.spkg and with those fixes the patch applies, builds correctly and all doctests pass on OSX. Positive review pending three other tickets I am about to open.
...
```json
{
    "body": "<a id='comment:20'></a>The spkgs at \n\n* #4007\n* #4008\n* #4009\n\nfix the issues on OSX. Those three spkgs have been merged, so we can now merge this ticket.\n\nCheers,\n\nMichael",
    "created_at": "2008-08-31T00:07:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24882",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:20'></a>The spkgs at 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24883",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Merged in Sage 3.1.2.alpha3",
    "created_at": "2008-08-31T00:14:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3324#issuecomment-24884",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:21'></a>Merged in Sage 3.1.2.alpha3
