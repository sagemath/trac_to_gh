...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3961#issuecomment-30778",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The attached patch fixes the bug (and at the same time slightly improves the debug output, and also introduces a small speedup).  The bug was in the line now number 1135.\n\nThe apparent inconsistency noted at the end of the bug report is bogus:  the default generator for `GF(10007^2)` is not sqrt(-1) so the two curves are actually different.\n\nPatch is based on 3.1.1, and all doctests in sage.schemes.elliptic_curves pass.",
    "created_at": "2008-08-27T09:57:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3961#issuecomment-30779",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>The attached patch fixes the bug (and at the same time slightly improves the debug output, and also introduces a small speedup).  The bug was in the line now number 1135.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3961#issuecomment-30780",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3961#issuecomment-30781",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The patch indeed fixes the bug, and there is a small speed gain.",
    "created_at": "2008-08-29T04:07:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3961#issuecomment-30782",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:3'></a>The patch indeed fixes the bug, and there is a small speed gain.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3961#issuecomment-30783",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3961#issuecomment-30784",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
