...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29026",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>It looks like the problem here is that we don't have a full HTML/Javascript parser built in to cell.py?",
    "created_at": "2009-01-21T07:43:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29027",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>It looks like the problem here is that we don't have a full HTML/Javascript parser built in to cell.py?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29028",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29029",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29030",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Apparently this is invalid javascript.\n\nfoo.html shows that firefox gives the same behavior.",
    "created_at": "2010-01-19T06:56:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29031",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```

<a id='comment:3'></a>Apparently this is invalid javascript.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29032",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29033",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3777#issuecomment-29034",
    "user": "https://trac.sagemath.org/admin/accounts/users/acleone"
}
```
