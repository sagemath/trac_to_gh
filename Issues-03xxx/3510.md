...
```json
{
    ...
    "type": "issue",
    "updated_at": "2017-09-23T02:49:04Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31024"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31026"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3510#issuecomment-19899",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3510",
    "rename": {
        "from": "sage charpoly woefully slower than Mma's for small integer matrices",
        "to": "sage charpoly slower than Mma's for small integer (dim <=10) matrices"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31027"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3510#issuecomment-19900",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31028"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31029"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31030"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31031"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31032"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31033"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31034"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31035"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3510#event-31036"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3510#issuecomment-19901",
