...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32041"
}
```
...
```json
{
    "body": "**Attachment:** [dsage_process_pool_patches.tar.gz.gz](https://github.com/sagemath/sage/files/ticket3600/dsage_process_pool_patches.tar.gz.gz)\n\n**Attachment:** [dsage_process_pool_patches.tar.2.gz.gz](https://github.com/sagemath/sage/files/ticket3600/dsage_process_pool_patches.tar.2.gz.gz)\n\nall the patches split up and whitespace only patches are in the whitespace sub directory",
...
**Attachment:** [dsage_process_pool_patches.tar.gz.gz](https://github.com/sagemath/sage/files/ticket3600/dsage_process_pool_patches.tar.gz.gz)
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32045"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3600",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32046"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3600#event-32047"
}
```
