...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [sage_scripts-dsage-testdir.patch](https://github.com/sagemath/sage/files/ticket3721/sage_scripts-dsage-testdir.patch) by mabshoff created at 2008-07-29 17:16:38",
    "created_at": "2008-07-29T17:16:38Z",
    "issue": "https://github.com/sagemath/sage/issues/3721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3721#issuecomment-21326",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3721#issuecomment-21327",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3721#issuecomment-21328",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
