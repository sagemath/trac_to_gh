...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-27950",
...
```json
{
    "body": "<a id='comment:2'></a>Apply only `3840-gfurnish-multivariate-conversion-from-0.patch`; hopefully the credit in hg remains with gfurnish.  Let me know if not; I used the hg export command this time.\n\nI think this patch does what the referee wants and strikes a better doctesting balance.\n\nWhether -1 is correct or -Infinity is correct, this at least makes sage internally more consistent.",
    "created_at": "2008-08-13T18:52:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-27951",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:2'></a>Apply only `3840-gfurnish-multivariate-conversion-from-0.patch`; hopefully the credit in hg remains with gfurnish.  Let me know if not; I used the hg export command this time.
...
```json
{
    "body": "<a id='comment:3'></a>Positive review for the second patch.  All credit to Gfurnish (except Nick and I get referee credit).",
    "created_at": "2008-08-13T19:08:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-27952",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Positive review for the second patch.  All credit to Gfurnish (except Nick and I get referee credit).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-27953",
...
```json
{
    "body": "<a id='comment:4'></a>Merged 3840-gfurnish-multivariate-conversion-from-0.patch in Sage 3.1.alpha2",
    "created_at": "2008-08-13T21:05:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-27954",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Merged 3840-gfurnish-multivariate-conversion-from-0.patch in Sage 3.1.alpha2
