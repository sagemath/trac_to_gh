...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] conversion of 0 from MV polynomial rings broken",
        "to": "[with patch, needs work] conversion of 0 from MV polynomial rings broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3840#event-14222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-28748",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-28749",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-28750",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-28751",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "rename": {
        "from": "[with patch, needs work] conversion of 0 from MV polynomial rings broken",
        "to": "[with patch, positive review to the second patch] conversion of 0 from MV polynomial rings broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3840#event-14223"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-28752",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3840#issuecomment-28753",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3840",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3840#event-14224"
}
```
