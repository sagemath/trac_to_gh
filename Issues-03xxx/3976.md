...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3976#issuecomment-30120",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "rename": {
        "from": "[with patch, needs review] improve doctests to expect.py, maxima.py, and lie.py",
        "to": "[with patch, positive review pending] improve doctests to expect.py, maxima.py, and lie.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3976#event-14837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3976#issuecomment-30121",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3976#issuecomment-30122",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "rename": {
        "from": "[with patch, positive review pending] improve doctests to expect.py, maxima.py, and lie.py",
        "to": "[with patch, positive review] improve doctests to expect.py, maxima.py, and lie.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3976#event-14838"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3976#issuecomment-30123",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3976#issuecomment-30124",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3976#issuecomment-30125",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3976",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3976#event-14839"
}
```
