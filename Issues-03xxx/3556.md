...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] Bug in IntegerModRing(n) for very large n",
        "to": "[with patch, positive review] Bug in IntegerModRing(n) for very large n"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3556#event-12975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3556#issuecomment-26449",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3556#issuecomment-26450",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3556",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3556#event-12976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3556#issuecomment-26451",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
