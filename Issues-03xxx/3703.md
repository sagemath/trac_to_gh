...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [trac3703-set_edge_label.patch](https://github.com/sagemath/sage/files/ticket3703/trac3703-set_edge_label.patch) by @jasongrout created at 2008-07-22 14:49:19\n\nPositive review.  Good catch!\n\nPasses doctests in graphs/*.py, graphs/*.pyx, and graphs/base/*.pyx",
    "created_at": "2008-07-22T14:49:19Z",
    "issue": "https://github.com/sagemath/sage/issues/3703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3703#issuecomment-21210",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3703#issuecomment-21211",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3703#issuecomment-21212",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3703#issuecomment-21213",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3703#issuecomment-21214",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3703",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3703#issuecomment-21215",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
