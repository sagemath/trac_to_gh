# Issue 3962: [with patch, positive review] Error in converting vector to SR
...
```json
{
    ...
    "title": "[with patch, positive review] Error in converting vector to SR",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3962",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3962#event-9091"
}
```
