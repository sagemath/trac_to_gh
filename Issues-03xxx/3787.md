...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28360",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28361",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28362",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13990"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28363",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28364",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13991"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13992"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13993"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13994"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "rename": {
        "from": "make ATLAS use extended cpuid",
        "to": "[with spkg, needs review] make ATLAS use extended cpuid"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13995"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28365",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "rename": {
        "from": "[with spkg, needs review] make ATLAS use extended cpuid",
        "to": "[with spkg, positive review] make ATLAS use extended cpuid"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28366",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3787#event-13997"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28367",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3787#issuecomment-28368",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
