...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3293#issuecomment-23900",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3293",
    "rename": {
        "from": "[with patch, needs review] MPolynomialRing_generic.random_element returns tuple when degree=0",
        "to": "[with patch, positive review] MPolynomialRing_generic.random_element returns tuple when degree=0"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3293#event-11744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3293",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3293#issuecomment-23901",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3293",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3293#issuecomment-23902",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3293",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3293#event-11745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3293",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3293#issuecomment-23903",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
