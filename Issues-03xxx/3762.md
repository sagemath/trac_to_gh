...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28163",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, not ready for review] remove quaddouble from sage -- not used, source of pain, mpfr is better"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3762#event-13886"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28164",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28165",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28166",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28167",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28168",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "rename": {
        "from": "[with patch, not ready for review] remove quaddouble from sage -- not used, source of pain, mpfr is better",
        "to": "[with patch, needs review] remove quaddouble from sage -- not used, source of pain, mpfr is better"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3762#event-13887"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3762#event-13888"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "rename": {
        "from": "[with patch, needs review] remove quaddouble from sage -- not used, source of pain, mpfr is better",
        "to": "[with patch, positive review] remove quaddouble from sage -- not used, source of pain, mpfr is better"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3762#event-13889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28169",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28170",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28171",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "rename": {
        "from": "[with patch, positive review] remove quaddouble from sage -- not used, source of pain, mpfr is better",
        "to": "[with patch, positive review] deprecate quaddouble, switch the number of partitions code to use MPFR all the way"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3762#event-13890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3762#event-13891"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28172",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3762#issuecomment-28173",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
