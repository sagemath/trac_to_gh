...
archive/attachments_003261.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [8869.patch](https://github.com/sagemath/sage/files/ticket3212/8869.patch)\n\nPatch for allowing row mult by non-ring elements",
    "created_at": "2008-05-18T03:33:08Z",
    "issue": "https://github.com/sagemath/sage/issues/3212",
    "type": "issue_comment",
...
**Attachment:** [8869.patch](https://github.com/sagemath/sage/files/ticket3212/8869.patch)
...
```json
{
    "body": "<a id='comment:7'></a>\n**Attachment:** [rescaling.patch](https://github.com/sagemath/sage/files/ticket3212/rescaling.patch)\n\nUse only rescaling.patch.",
    "created_at": "2008-06-06T03:12:13Z",
    "issue": "https://github.com/sagemath/sage/issues/3212",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:9'></a>\n**Attachment:** [rescale.patch](https://github.com/sagemath/sage/files/ticket3212/rescale.patch)\n\nUse only rescale.patch.  This is hopefully the final version.",
    "created_at": "2008-06-06T21:04:18Z",
    "issue": "https://github.com/sagemath/sage/issues/3212",
    "type": "issue_comment",
