...
```json
{
    "body": "<a id='comment:4'></a>One may want to check the latest CVS of Maxima, where I believe some definitions relating to this have changed.",
    "created_at": "2009-09-22T21:10:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26780",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>One may want to check the latest CVS of Maxima, where I believe some definitions relating to this have changed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26781",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Just updating.  This is still in 5.20.1, but it's not clear whether this is really a bug, since radical simplifications will in their nature sometimes change which square root of -1 they use, and perhaps it's not possible to do so consistently across multiplication or division.  Comments?",
    "created_at": "2009-12-22T17:00:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26782",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>Just updating.  This is still in 5.20.1, but it's not clear whether this is really a bug, since radical simplifications will in their nature sometimes change which square root of -1 they use, and perhaps it's not possible to do so consistently across multiplication or division.  Comments?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26783",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Maxima devs have been discussing some things related to this, so it could be worth checking whether this has changed again in their CVS.",
    "created_at": "2010-02-05T20:09:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26784",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>Maxima devs have been discussing some things related to this, so it could be worth checking whether this has changed again in their CVS.
...
```json
{
    "body": "<a id='comment:7'></a>What is really going on here is that `simplify_radical` uses `radcan` under the hood, which treats things as symbolic expressions, not functions, and just chooses a branch - consistently, but arbitrarily.  At least I think that is what is here.  See [the Maxima list thread starting here](http://www.math.utexas.edu/pipermail/maxima/2011/026097.html).",
    "created_at": "2011-09-23T14:46:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26785",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:7'></a>What is really going on here is that `simplify_radical` uses `radcan` under the hood, which treats things as symbolic expressions, not functions, and just chooses a branch - consistently, but arbitrarily.  At least I think that is what is here.  See [the Maxima list thread starting here](http://www.math.utexas.edu/pipermail/maxima/2011/026097.html).
...
```json
{
    "body": "<a id='comment:12'></a>It seems to be that this is probably a dup of #14305, #11912, and/or other such tickets.  Thoughts?",
    "created_at": "2014-11-17T17:31:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26786",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:12'></a>It seems to be that this is probably a dup of #14305, #11912, and/or other such tickets.  Thoughts?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26787",
...
```json
{
    "body": "<a id='comment:14'></a>> > It seems to be that this is probably a dup of #14305, #11912, and/or other such tickets.  Thoughts?\n\n> \n> Indeed, #11912 \"fixes\" it by renaming `simplify_radical` and updating its documentation so that it's very clear that this might happen.\n\n\nIn which case perhaps this integration example could be added there.",
    "created_at": "2014-11-17T18:19:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26788",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:14'></a>> > It seems to be that this is probably a dup of #14305, #11912, and/or other such tickets.  Thoughts?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26789",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26790",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>> > In which case perhaps this integration example could be added there.\n\n> \n> That was my reasoning anyway. If it will help get it reviewed faster, I'll add whatever you want =)\n\n\nWell, I think that pointing out that things you might not think would be affected is not bad.",
    "created_at": "2014-11-18T02:41:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26791",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:16'></a>> > In which case perhaps this integration example could be added there.
...
```json
{
    "body": "<a id='comment:17'></a>Ok, I've just added this example to the branch at #11912.",
    "created_at": "2014-11-18T15:22:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26792",
    "user": "https://github.com/orlitzky"
}
```

<a id='comment:17'></a>Ok, I've just added this example to the branch at #11912.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26793",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>> Ok, I've just added this example to the branch at #11912.\n\nSweet.",
    "created_at": "2014-11-18T15:26:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26794",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:18'></a>> Ok, I've just added this example to the branch at #11912.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26795",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3520#issuecomment-26796",
