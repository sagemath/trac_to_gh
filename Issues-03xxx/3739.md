...
```json
{
    ...
    "rename": {
        "from": "notebook -- new user default",
        "to": "[with patch, needs review] notebook -- new user default"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3739#event-13772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3739#issuecomment-27977",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3739",
    "rename": {
        "from": "[with patch, needs review] notebook -- new user default",
        "to": "[with patch, positive review] notebook -- new user default"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3739#event-13773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3739#issuecomment-27978",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3739",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3739#event-13774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3739#issuecomment-27979",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
