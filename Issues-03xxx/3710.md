...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26956",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26957",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [test.dat](tarball://root/attachments/some-uuid/ticket3710/test.dat) by aginiewicz created at 2008-07-23 00:20:15",
    "created_at": "2008-07-23T00:20:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26958",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```

<a id='comment:1'></a>Attachment [test.dat](tarball://root/attachments/some-uuid/ticket3710/test.dat) by aginiewicz created at 2008-07-23 00:20:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26959",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>There's what I did to fix it: I added gcc version check and set GCCFIX variable to flags needed to fix the issue for gcc 4.2.4 and all 4.3.* (I wasn't able to test 4.3.0), also added simple patch that adds it to src/unix/Make-arch... I put it into patches directory and spkg-install, basing how it's done with some other packages\n\nI hope all is ok because that's my only second fix but first tracked from start and with own ticket... if anything would look better other way I'd be happy to know",
    "created_at": "2008-08-02T02:01:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26960",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```

<a id='comment:2'></a>There's what I did to fix it: I added gcc version check and set GCCFIX variable to flags needed to fix the issue for gcc 4.2.4 and all 4.3.* (I wasn't able to test 4.3.0), also added simple patch that adds it to src/unix/Make-arch... I put it into patches directory and spkg-install, basing how it's done with some other packages
...
```json
{
    "body": "<a id='comment:3'></a>btw, as this is segfault fix only I guess it could go to 3.1 so I reassign it to 3.1 as I don't know if before release tickets ready to review from next milestone are searched for... are there reasons for it to not make in for 3.1?\n\ncheers,\nAndrzej.",
    "created_at": "2008-08-03T00:35:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26961",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```

<a id='comment:3'></a>btw, as this is segfault fix only I guess it could go to 3.1 so I reassign it to 3.1 as I don't know if before release tickets ready to review from next milestone are searched for... are there reasons for it to not make in for 3.1?
...
```json
{
    "body": "<a id='comment:4'></a>Changed spkg along with information from #3882 - there are both patch (to generate new file if new version of Tachyon will come out) and patched file that is copied over.",
    "created_at": "2008-08-17T20:06:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26962",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```

<a id='comment:4'></a>Changed spkg along with information from #3882 - there are both patch (to generate new file if new version of Tachyon will come out) and patched file that is copied over.
...
```json
{
    "body": "<a id='comment:6'></a>For the record: the updated spkg is at\n\nhttp://sage.math.washington.edu/home/mabshoff/release-cycles-3.1.2/alpha0/tachyon-0.98beta.p6.spkg\n\nCheers,\n\nMichael",
    "created_at": "2008-08-22T21:42:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26964",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>For the record: the updated spkg is at
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26965",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26966",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>will know next time, thanks for pointing all this out!",
    "created_at": "2008-08-23T03:05:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3710#issuecomment-26967",
    "user": "https://trac.sagemath.org/admin/accounts/users/aginiewicz"
}
```

<a id='comment:8'></a>will know next time, thanks for pointing all this out!
