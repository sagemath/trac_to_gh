...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3308#issuecomment-24008",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3308",
    "rename": {
        "from": "[with patch; needs review] Update sage-sbuildhack to work with new sbuild in Debian",
        "to": "[with patch; positive review] Update sage-sbuildhack to work with new sbuild in Debian"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3308#event-11805"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3308#issuecomment-24009",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3308",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3308#event-11806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3308#issuecomment-24010",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3308#issuecomment-24011",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
