...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3650#issuecomment-27887",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Positive review. What could go wrong? ;)\n\nCheers,\n\nMichael",
    "created_at": "2008-07-15T23:37:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3650#issuecomment-27888",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Positive review. What could go wrong? ;)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3650#issuecomment-27889",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3650#issuecomment-27890",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
