...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3654#issuecomment-20819",
...
```json
{
    "body": "Attachment [sage-3654-deprecation.patch](https://github.com/sagemath/sage/files/ticket3654/sage-3654-deprecation.patch) by @jasongrout created at 2008-08-25 20:35:33",
    "created_at": "2008-08-25T20:35:33Z",
    "issue": "https://github.com/sagemath/sage/issues/3654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3654#issuecomment-20820",
    "user": "https://github.com/jasongrout"
}
```

Attachment [sage-3654-deprecation.patch](https://github.com/sagemath/sage/files/ticket3654/sage-3654-deprecation.patch) by @jasongrout created at 2008-08-25 20:35:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3654#issuecomment-20821",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3654#issuecomment-20822",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3654#issuecomment-20823",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
