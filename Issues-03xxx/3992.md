...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3992#issuecomment-30268",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Sage 3.1.2.alpha2: three tests in sage/interfaces/octave.py need to be optional"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3992#event-14897"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3992#issuecomment-30269",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3992#issuecomment-30270",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3992",
    "rename": {
        "from": "[with patch, needs review] Sage 3.1.2.alpha2: three tests in sage/interfaces/octave.py need to be optional",
        "to": "[with patch, with positive review] Sage 3.1.2.alpha2: three tests in sage/interfaces/octave.py need to be optional"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3992#event-14898"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3992#issuecomment-30271",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3992",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3992#event-14899"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3992",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3992#issuecomment-30272",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
