...
```json
{
    "body": "<a id='comment:2'></a>Just a short comment: could you put back in the matrix() and vector() functions and add a deprecation warning for now?  That way code doesn't suddenly break.",
...
<a id='comment:2'></a>Just a short comment: could you put back in the matrix() and vector() functions and add a deprecation warning for now?  That way code doesn't suddenly break.
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [vector_matrix.patch](tarball://root/attachments/some-uuid/ticket3920/vector_matrix.patch) by @jhpalmieri created at 2008-10-17 21:25:37\n\nSince you use \"\\code\" in the docstring for vector and matrix, the docstrings need to start with r\"\"\" instead of \"\"\".  Patch attached.",
...
<a id='comment:3'></a>Attachment [vector_matrix.patch](tarball://root/attachments/some-uuid/ticket3920/vector_matrix.patch) by @jhpalmieri created at 2008-10-17 21:25:37
...
<a id='comment:4'></a>Otherwise, your patch looks good to me. Now I finally know of an example of the `_vector_` method -- I was looking for one when I was revising the Developer's guide...
...
```json
{
    "body": "<a id='comment:6'></a>Positive review on John's additional patch.\n\nCheers,\n\nMichael",
...
<a id='comment:6'></a>Positive review on John's additional patch.
...
<a id='comment:7'></a>Robert: This patch touches
...
```json
{
    "body": "<a id='comment:8'></a>Merged both patches in Sage 3.2.alpha0",
...
<a id='comment:8'></a>Merged both patches in Sage 3.2.alpha0
