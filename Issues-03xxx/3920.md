...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22755",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22756",
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [vector_matrix.patch](https://github.com/sagemath/sage/files/ticket3920/vector_matrix.patch) by @jhpalmieri created at 2008-10-17 21:25:37\n\nSince you use \"\\code\" in the docstring for vector and matrix, the docstrings need to start with r\"\"\" instead of \"\"\".  Patch attached.",
    "created_at": "2008-10-17T21:25:37Z",
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22757",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [10736.patch](https://github.com/sagemath/sage/files/ticket3920/10736.patch) by @jhpalmieri created at 2008-10-17 21:25:55\n\napply after malb's patch",
    "created_at": "2008-10-17T21:25:55Z",
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22758",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [10736.patch](https://github.com/sagemath/sage/files/ticket3920/10736.patch) by @jhpalmieri created at 2008-10-17 21:25:55
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22759",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22760",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22762",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3920#issuecomment-22763",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
