...
<a id='comment:1'></a>According to the docs on matplotlib:
...
```json
{
    "body": "<a id='comment:2'></a>This should be taken care of at the same time as #3877.",
...
<a id='comment:2'></a>This should be taken care of at the same time as #3877.
...
```json
{
    "body": "<a id='comment:3'></a>Jason is right, this is orthogonal to #3877. Shame on Alex for using such a stupid syntax as (xmin, ymin) to denote the tail coordinates of an arrow.",
...
<a id='comment:3'></a>Jason is right, this is orthogonal to #3877. Shame on Alex for using such a stupid syntax as (xmin, ymin) to denote the tail coordinates of an arrow.
...
```json
{
    "body": "<a id='comment:4'></a>Patch looks good to me. Rlm explained to me what needed fixing.\n\nCheers,\n\nMichael",
...
<a id='comment:4'></a>Patch looks good to me. Rlm explained to me what needed fixing.
