...
```json
{
    "body": "<a id='comment:8'></a>\nNew commits:\n|                                                                                                                                          |                                                        |\n|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|\n|[bc3600f](https://git.sagemath.org/sage.git/commit?id=bc3600f96bc83573671511187fa5f1317a6b2ff7)|`trac 3889 add extend keyword for sqrt in number fields`|",
...
```json
{
    "body": "<a id='comment:13'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                           |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|\n|[1a5b352](https://git.sagemath.org/sage.git/commit/?id=1a5b352d046abcf6efe16ac00175947414ccd429)|`Merge branch 'u/chapoton/3889' in 9.2.rc3`|\n|[7840c06](https://git.sagemath.org/sage.git/commit/?id=7840c068381246d92cae723ce8ece7ff56974873)|`add the name keyword for extended sqrt in number_fields`|",
    "created_at": "2020-10-20T07:54:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3889",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:18'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                          |\n|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|\n|[ec8ba00](https://git.sagemath.org/sage.git/commit/?id=ec8ba002a60232e3e4bf5721c3d7a91dbb6cdb93)|`do  not use SR in sqrt for number fields`|",
    "created_at": "2020-10-20T11:20:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3889",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:23'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|\n|[8498168](https://git.sagemath.org/sage.git/commit/?id=8498168b11310919868f03e66acfdacc5ed71f87)|`deprecate fallback to SR sqrt for number field elements`|",
...
```json
{
    "body": "<a id='comment:24'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----|\n|[d1ffcea](https://git.sagemath.org/sage.git/commit/?id=d1ffcea612a5c591af58987095ab8e6d1043a2e5)|`fix`|",
    "created_at": "2020-10-21T18:52:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3889",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:30'></a>\nThis works for the volume of polyhedra now.\n\nI did change the behaviour. The new default `None` is deprecated now and `extend=False` raises a `ValueError` to be consistent with other rings. The new default should then be `extend=True` once we remove the deprecation warning.\n\nThe `QR` method of method of matrices does not raise correctly a `TypeError`, if the base ring does not support the required roots. (Before it would sometimes implicitly extend even though the documentation tells us that the base ring must support roots.)\n\n---\nNew commits:\n|                                                                                                                                          |                                                                               |\n|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|\n|[0967711](https://git.sagemath.org/sage.git/commit?id=096771197824560522fcb4d89e7abf22d0e8bb41)|`Merge branch 'u/chapoton/3889' of git://trac.sagemath.org/sage into test/3889`|\n|[5e12423](https://git.sagemath.org/sage.git/commit?id=5e1242362c83753a931df8c88b5d98f60872eeb3)|`raise error when `extend=False``|\n|[77d0fce](https://git.sagemath.org/sage.git/commit?id=77d0fce43c10513eab21e98043fa22b08c1a3a50)|`do not raise deprecation error for QR method of matrices`|\n|[93803bc](https://git.sagemath.org/sage.git/commit?id=93803bc9c80a88f0132c23ff08f9e1b031edc4a0)|`do not use symbolic ring for volume of polyhedra`|\n|[6f1bde7](https://git.sagemath.org/sage.git/commit?id=6f1bde7014f6c1bbb506a8ccbfe323d0f2181b08)|`update deprecation message`|\n|[198883c](https://git.sagemath.org/sage.git/commit?id=198883c209f27f3d92687b59da52df00f43965ac)|`less changes`|",
...
```json
{
    "body": "<a id='comment:34'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------|\n|[88d17ce](https://git.sagemath.org/sage.git/commit/?id=88d17ce6a29b7b8836b9f8004bb46b7b9d17cc38)|`small fixes`|",
    "created_at": "2020-10-26T11:36:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3889",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:37'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                            |\n|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|\n|[0487ce0](https://git.sagemath.org/sage.git/commit/?id=0487ce09fd2a6638cb940e2005dd4fb01f86c656)|`remove deprecation warning`|",
    "created_at": "2020-10-26T12:20:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3889",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:40'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                             |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|\n|[457bc05](https://git.sagemath.org/sage.git/commit/?id=457bc0508b1df788c7710d8aad94df322fc78c48)|`properly change the default`|",
...
```json
{
    "body": "<a id='comment:44'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                                                                                     |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|\n|[12ed75d](https://git.sagemath.org/sage.git/commit/?id=12ed75d4e1d002aadd9926a2dff07cee818d7d0b)|`Merge branch 'u/gh-kliem/3889' of git://trac.sagemath.org/sage into u/gh-kliem/3889`|\n|[758de17](https://git.sagemath.org/sage.git/commit/?id=758de17979dfa617144fb5a22c998e7e6102a647)|`consistent behaviour with ZZ and QQ`|",
    "created_at": "2021-01-11T09:12:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3889",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:48'></a>\nBranch pushed to git repo; I updated commit sha1. New commits:\n|                                                                                                                                           |                         |\n|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|\n|[b46078a](https://git.sagemath.org/sage.git/commit/?id=b46078a359d0b8621a46dca8b757a10f5830c9a5)|`revert change to matrix`|",
