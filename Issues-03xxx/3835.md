...
<a id='comment:1'></a>Attachment [trac_3835-algebraic_closure.patch](tarball://root/attachments/some-uuid/ticket3835/trac_3835-algebraic_closure.patch) by @JohnCremona created at 2009-08-30 20:36:33
...
```json
{
    "body": "<a id='comment:2'></a>My use-case at the time was QQ -> QQbar, I think.",
...
<a id='comment:2'></a>My use-case at the time was QQ -> QQbar, I think.
