# Issue 3586: [with patch; positive review] twist.py -- doctest doesn't work on some machines due to ports not being open-able
...
```json
{
    ...
    "title": "[with patch; positive review] twist.py -- doctest doesn't work on some machines due to ports not being open-able",
    "type": "issue",
...
```json
{
    "body": "It seems that on the machine where this fails for me, this is probably a race condition between the notebook starting and the first connection being made. At least, when I add a sleep(1) after the test_notebook() call, I can no longer reproduce this.\n\nMaybe we should make the notebook server print a small log message when it is ready to receive connections, and make run_notebook wait for that (through pexpect) when fork=True ?",
    "created_at": "2008-07-07T17:09:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3586#issuecomment-25263",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3586#issuecomment-25265",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3586#issuecomment-25266",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3586#issuecomment-25267",
