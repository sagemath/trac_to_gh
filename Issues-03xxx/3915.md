...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38796"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38797"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38798"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38799"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38800"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38801"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38803"
}
```
...
```json
{
    ...
    "title_was": "PolyBoRi interface improvements",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22748",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38805"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38806"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38807"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22749",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22750",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22751",
    "user": "https://github.com/sagetrac-PolyBoRi"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22752",
...
```json
{
    ...
    "title_was": "PolyBoRi interface improvements",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38808"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38809"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22753",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22754",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3915#issuecomment-22755",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3915",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3915#event-38811"
}
```
