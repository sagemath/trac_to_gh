...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] Bug in sparse polynomials over finite fields",
        "to": "[with patch, positive review] Bug in sparse polynomials over finite fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3272#event-11676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3272#issuecomment-23759",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3272#issuecomment-23760",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3272",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3272#event-11677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3272#issuecomment-23761",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
