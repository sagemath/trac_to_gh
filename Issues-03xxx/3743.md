...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3743#issuecomment-27992",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "rename": {
        "from": "notebook -- allow admin user to view any worksheet",
        "to": "[with patch, needs review] notebook -- allow admin user to view any worksheet"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13783"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3743#issuecomment-27993",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "rename": {
        "from": "[with patch, needs review] notebook -- allow admin user to view any worksheet",
        "to": "[with patch, needs work] notebook -- allow admin user to view any worksheet"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3743#issuecomment-27994",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3743#issuecomment-27995",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "rename": {
        "from": "[with patch, needs work] notebook -- allow admin user to view any worksheet",
        "to": "[with patch, needs review] notebook -- allow admin user to view any worksheet"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13786"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13787"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13788"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3743#issuecomment-27996",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] notebook -- allow admin user to view any worksheet",
        "to": "[with patch; positive review] notebook -- allow admin user to view any worksheet"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13789"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3743#issuecomment-27997",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3743#issuecomment-27998",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3743",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3743#event-13790"
}
```
