...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3946#issuecomment-29864",
    "user": "https://trac.sagemath.org/admin/accounts/users/choldsworth"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] Tidier BinaryQF reductions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3946#event-14724"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3946#issuecomment-29865",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3946",
    "rename": {
        "from": "[with patch; needs review] Tidier BinaryQF reductions",
        "to": "[with patch; with positive review] Tidier BinaryQF reductions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3946#event-14725"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3946#issuecomment-29866",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3946#event-14726"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3946#issuecomment-29867",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
