# Issue 3974: [with positive review] renaming of integral_weierstrass_model to integral_short_weierstrass_model
...
```json
{
    ...
    "title": "[with positive review] renaming of integral_weierstrass_model to integral_short_weierstrass_model",
    "type": "issue",
...
archive/attachments_004170.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage_trac3974.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket3974/sage_trac3974.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33148",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3974#event-11904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33149",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33150",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33151",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33152",
    "user": "https://github.com/categorie"
}
```
...
archive/attachments_004171.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage_trac3974_new.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket3974/sage_trac3974_new.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33153",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "rename": {
        "from": "renaming of integral_weierstrass_model to integral_short_weierstrass_model",
        "to": "[with positive review] renaming of integral_weierstrass_model to integral_short_weierstrass_model"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3974#event-11905"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33154",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33155",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3974#event-11906"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3974#issuecomment-33156",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
