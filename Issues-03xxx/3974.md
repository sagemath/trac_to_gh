...
```json
{
    "body": "Attachment [sage_trac3974.patch](https://github.com/sagemath/sage/files/ticket3974/sage_trac3974.patch) by @categorie created at 2008-08-28 12:10:49",
    "created_at": "2008-08-28T12:10:49Z",
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23204",
    "user": "https://github.com/categorie"
}
```

Attachment [sage_trac3974.patch](https://github.com/sagemath/sage/files/ticket3974/sage_trac3974.patch) by @categorie created at 2008-08-28 12:10:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23205",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23206",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23207",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23208",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [sage_trac3974_new.patch](https://github.com/sagemath/sage/files/ticket3974/sage_trac3974_new.patch) by @categorie created at 2008-08-29 13:28:56\n\nI changed the patch according to Michael's remark. It replaces the previous patch. This patch only works with the patch from ticket 3654.\n\n Chris.",
    "created_at": "2008-08-29T13:28:56Z",
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23209",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23210",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3974#issuecomment-23211",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
