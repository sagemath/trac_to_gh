...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-24791",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-24792",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "rename": {
        "from": "[with patch, needs review] converting strings to ZZ[x,y] fails",
        "to": "[with patch, positive review] converting strings to ZZ[x,y] fails"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-12094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-24793",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-12095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-24794",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-12096"
}
```
