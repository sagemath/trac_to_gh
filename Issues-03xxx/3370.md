...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-18927",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "asset_name": "string_to_ZZxy_conversion.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket3370/string_to_ZZxy_conversion.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-18928",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-18230"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-18231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-18232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-18929",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-18233"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3370#event-18234"
}
```
