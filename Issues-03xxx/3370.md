...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-25468",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [string_to_ZZxy_conversion.patch](tarball://root/attachments/some-uuid/ticket3370/string_to_ZZxy_conversion.patch) by @malb created at 2008-06-12 23:02:02\n\npatch looks good.",
    "created_at": "2008-06-12T23:02:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-25469",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>Attachment [string_to_ZZxy_conversion.patch](tarball://root/attachments/some-uuid/ticket3370/string_to_ZZxy_conversion.patch) by @malb created at 2008-06-12 23:02:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-25470",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3370",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3370#issuecomment-25471",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
