...
```json
{
    "body": "<a id='comment:1'></a>Attachment [9606.patch](tarball://root/attachments/some-uuid/ticket3105/9606.patch) by @JohnCremona created at 2008-05-05 16:14:20\n\nThis patch appliesw fine to 3.0.1 and the doctests in sage/rings/number_field all pass.\n\nIt looks fine to me.",
...
<a id='comment:1'></a>Attachment [9606.patch](tarball://root/attachments/some-uuid/ticket3105/9606.patch) by @JohnCremona created at 2008-05-05 16:14:20
