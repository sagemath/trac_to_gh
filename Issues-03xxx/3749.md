...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21517",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21518",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21519",
    "user": "https://trac.sagemath.org/admin/accounts/users/ljpk"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21520",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21521",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3749/trac_3749-is_cyclic.patch",
    "created_at": "2008-12-11T13:35:28Z",
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic.patch",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "Attachment [trac_3749-is_cyclic.patch](https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic.patch) by @wdjoyner created at 2008-12-11 13:35:28\n\nbased on 3.2.2.alpha1",
    "created_at": "2008-12-11T13:35:28Z",
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21522",
    "user": "https://github.com/wdjoyner"
}
```

Attachment [trac_3749-is_cyclic.patch](https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic.patch) by @wdjoyner created at 2008-12-11 13:35:28
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21523",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21524",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21059"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3749#issuecomment-21525",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3749/trac_3749-is_cyclic2.patch",
    "created_at": "2008-12-12T02:07:25Z",
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic2.patch",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "Attachment [trac_3749-is_cyclic2.patch](https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic2.patch) by @wdjoyner created at 2008-12-12 02:07:25\n\nApply other patch first. Based on 3.2.2.alpha1",
    "created_at": "2008-12-12T02:07:25Z",
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
...
Attachment [trac_3749-is_cyclic2.patch](https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic2.patch) by @wdjoyner created at 2008-12-12 02:07:25
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21060"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21061"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21062"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21063"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3749/trac_3749-is_cyclic3.patch",
    "created_at": "2008-12-12T23:53:34Z",
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic3.patch",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>\nAttachment [trac_3749-is_cyclic3.patch](https://github.com/sagemath/sage/files/ticket3749/trac_3749-is_cyclic3.patch) by @wdjoyner created at 2008-12-12 23:53:34\n\nI think this last patch fixes things the way you suggested. Also, both abelian_groups.py and dual_abelian_groups.py pass sage -t now.",
    "created_at": "2008-12-12T23:53:34Z",
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21064"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21065"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21066"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21067"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3749",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21069"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21070"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3749#event-21071"
}
```
