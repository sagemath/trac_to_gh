...
<a id='comment:17'></a>Replying to [comment:15 wdj]:
> Another thing I tried was a completely different workflow:
> 
> (a) download the old gap spkg, unpack it into sagestuff/gap-4.4.10.p10
> 
...
<a id='comment:21'></a>Replying to [comment:20 wdj]:
...
<a id='comment:30'></a>Replying to [comment:29 wdj]:
...
<a id='comment:33'></a>Replying to [comment:32 wdj]:
...
<a id='comment:46'></a>Replying to [comment:45 wdj]:
