# Issue 3405: [with spkg, positive review] update Singular SPKG to newest upstream release
...
```json
{
    ...
    "title": "[with spkg, positive review] update Singular SPKG to newest upstream release",
    "type": "issue",
