...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3405#issuecomment-25117",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3405",
    "rename": {
        "from": "[with spkg, needs review] update Singular SPKG to newest upstream release",
        "to": "[with spkg, under review by mabshoff before 6/27] update Singular SPKG to newest upstream release"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3405#event-12234"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3405#event-12235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3405",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3405#issuecomment-25118",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, positive review] update Singular SPKG to newest upstream release"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3405#event-12236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3405",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3405#event-12237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3405",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3405#issuecomment-25119",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
