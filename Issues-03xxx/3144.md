...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3144#event-29203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3144#event-29204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3144#event-29205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3144",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3144#event-29206"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3144#event-29207"
}
```
