...
```json
{
    "body": "<a id='comment:1'></a>This bug is also in sage-3.0.4.rc0 on arch linux.",
    "created_at": "2008-07-08T06:21:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27430",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>This bug is also in sage-3.0.4.rc0 on arch linux.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27431",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3593#event-8229"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [sage-3593.patch](tarball://root/attachments/some-uuid/ticket3593/sage-3593.patch) by @williamstein created at 2008-07-08 06:31:39",
    "created_at": "2008-07-08T06:31:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27433",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>Attachment [sage-3593.patch](tarball://root/attachments/some-uuid/ticket3593/sage-3593.patch) by @williamstein created at 2008-07-08 06:31:39
...
```json
{
    "body": "<a id='comment:5'></a>I was able to reproduce the problem on sage.math by running 4 doctests simultaneously. The problem is that we weren't using temporary directories for the separate dsage servers so twistd never launched the other servers.  Attached is a patch that fixes this issue.",
    "created_at": "2008-07-08T07:52:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27434",
    "user": "https://github.com/yqiang"
}
```

<a id='comment:5'></a>I was able to reproduce the problem on sage.math by running 4 doctests simultaneously. The problem is that we weren't using temporary directories for the separate dsage servers so twistd never launched the other servers.  Attached is a patch that fixes this issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27435",
    "user": "https://github.com/yqiang"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27436",
    "user": "https://github.com/yqiang"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3593#event-8230"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3593#event-8231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3593#event-8232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27437",
...
```json
{
    "body": "<a id='comment:7'></a>Merged in Sage 3.0.4.rc1",
    "created_at": "2008-07-09T16:20:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27438",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged in Sage 3.0.4.rc1
...
```json
{
    ...
    "milestone": "sage-3.0.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3593#event-8233"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3593#event-8234"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Did you merge in William's patch to disable doctesting or my patches to fix doctesting?",
    "created_at": "2008-07-09T16:30:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3593#issuecomment-27439",
    "user": "https://github.com/yqiang"
}
```

<a id='comment:9'></a>Did you merge in William's patch to disable doctesting or my patches to fix doctesting?
