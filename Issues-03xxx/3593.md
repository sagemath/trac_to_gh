...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20446",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20447",
    "user": "https://github.com/williamstein"
}
```
...
archive/attachments_003609.json:
```json
{
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [sage-3593.patch](https://github.com/sagemath/sage/files/ticket3593/sage-3593.patch) by @williamstein created at 2008-07-08 06:31:39",
    "created_at": "2008-07-08T06:31:39Z",
    "issue": "https://github.com/sagemath/sage/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20448",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20449",
...
archive/attachments_003610.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [tmpdir.patch](https://github.com/sagemath/sage/files/ticket3593/tmpdir.patch) by @yqiang created at 2008-07-08 07:52:37",
    "created_at": "2008-07-08T07:52:37Z",
    "issue": "https://github.com/sagemath/sage/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20450",
    "user": "https://github.com/yqiang"
}
```

Attachment [tmpdir.patch](https://github.com/sagemath/sage/files/ticket3593/tmpdir.patch) by @yqiang created at 2008-07-08 07:52:37



---

archive/attachments_003611.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [find_ports.patch](https://github.com/sagemath/sage/files/ticket3593/find_ports.patch) by @yqiang created at 2008-07-08 17:19:38\n\nThis will bind to port 0 and the OS will return a valid port to listen on",
    "created_at": "2008-07-08T17:19:38Z",
    "issue": "https://github.com/sagemath/sage/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20451",
    "user": "https://github.com/yqiang"
}
```

Attachment [find_ports.patch](https://github.com/sagemath/sage/files/ticket3593/find_ports.patch) by @yqiang created at 2008-07-08 17:19:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20452",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3593#issuecomment-20453",
    "user": "https://github.com/yqiang"
}
```
