...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3451#issuecomment-26285",
...
```json
{
    "body": "<a id='comment:2'></a>I have changed things in the following way: if we try to evaluate f(p), then the first step is to coerce p into the domain of f.  If that works, then the evaluation goes forth.  Otherwise, there is of course an error message saying that p has no business being there in the first place.\n\nThe change is in the generic scheme morphism code, so it should work for affine spaces, projective spaces, and whatever else inherits from schemes.",
    "created_at": "2008-08-27T08:55:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3451#issuecomment-26286",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:2'></a>I have changed things in the following way: if we try to evaluate f(p), then the first step is to coerce p into the domain of f.  If that works, then the evaluation goes forth.  Otherwise, there is of course an error message saying that p has no business being there in the first place.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3451#issuecomment-26287",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3451#issuecomment-26288",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Looks ok to me.  I see that you are relying on whatever error message is produced by \"dom(x)\" in case x cannot be coerced into dom rather than supplying your own, of the form \"... cannot be coerced into the domain\", but that is ok.\n\nPatch applies cleanly to 3.1.2.alpha3 and all doctests in sage.schemes.generic pass.",
    "created_at": "2008-09-01T19:50:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3451#issuecomment-26289",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>Looks ok to me.  I see that you are relying on whatever error message is produced by "dom(x)" in case x cannot be coerced into dom rather than supplying your own, of the form "... cannot be coerced into the domain", but that is ok.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3451#issuecomment-26290",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3451#issuecomment-26291",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
