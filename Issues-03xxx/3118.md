...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23286",
...
```json
{
    "body": "<a id='comment:1'></a>Both attachments fix that problem. Btw, I wonder why integer=True is not the default,\nat least for integer inputs. I guess there are many calls to gcd with integers in the\nSage library without Integer=True:\n\n```\nbash-3.00$ pwd\n/usr/local/sage-3.1.4/sage/devel/sage/sage\nbash-3.00$ find . -type f -name \"*.py\" -exec grep \\-iw GCD {} \\; | wc -l\n297\n```",
    "created_at": "2008-10-19T13:42:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23287",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:1'></a>Both attachments fix that problem. Btw, I wonder why integer=True is not the default,
at least for integer inputs. I guess there are many calls to gcd with integers in the
Sage library without Integer=True:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23289",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23293",
...
```json
{
    "body": "<a id='comment:7'></a>Georg is right -- I made that change so that gcd((-2,)) returns 2 and similarly for lcm.  And the patches were based on 3.2.alpha0 -- sorry Paul.",
    "created_at": "2008-10-23T22:16:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23294",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>Georg is right -- I made that change so that gcd((-2,)) returns 2 and similarly for lcm.  And the patches were based on 3.2.alpha0 -- sorry Paul.
...
```json
{
    "body": "<a id='comment:8'></a>I tried all the above examples which work as expected, and also did sage -t in the rings\ndirectory. Since John already did sage -testall, I give a positive review.",
    "created_at": "2008-10-24T16:06:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23295",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:8'></a>I tried all the above examples which work as expected, and also did sage -t in the rings
directory. Since John already did sage -testall, I give a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23296",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Merged sage-trac_3118.patch and sage-trac_3118-2.patch in Sage 3.2.alpha1",
    "created_at": "2008-10-25T22:41:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3118#issuecomment-23297",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Merged sage-trac_3118.patch and sage-trac_3118-2.patch in Sage 3.2.alpha1
