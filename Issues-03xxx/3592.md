...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [sage.patch](https://github.com/sagemath/sage/files/ticket3592/sage.patch) by mabshoff created at 2008-07-07 22:17:06\n\nThe category of this ticket is packages and please also assign a milestone per default.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-07T22:17:06Z",
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20437",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20438",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20439",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20440",
    "user": "https://github.com/certik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20441",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20442",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20443",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20444",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3592#issuecomment-20445",
