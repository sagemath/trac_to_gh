...
```json
{
    "body": "<a id='comment:1'></a>Hm, my pure PolyBoRi-tests are clean. Which example code was used above?\n\nRegards,\n  Alexander",
    "created_at": "2008-05-29T07:49:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3299",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3299#issuecomment-24619",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```

<a id='comment:1'></a>Hm, my pure PolyBoRi-tests are clean. Which example code was used above?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3299",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3299#issuecomment-24621",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```
