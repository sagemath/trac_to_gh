...
```json
{
    "body": "<a id='comment:1'></a>The underlying issue is that the reprs of the generators of polynomial rings over Z/2Z have minus signs and SymbolicArithmetic._polynomial_ expects them to not have the signs.  I think the appropriate fix would be to fix the printing for the generators of polynomial rings over Z/2Z\n\n```\nsage: Integers(3)['x,y'].gens()\n(x, y)\nsage: Integers(2)['x,y'].gens()\n(-x, -y)\n```\n\n\n```\n        for v in vars:\n            r = repr(v)\n            for g in G:\n                if repr(g) == r:\n                    sub.append((v,g))\n```",
    "created_at": "2008-05-08T04:56:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23352",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>The underlying issue is that the reprs of the generators of polynomial rings over Z/2Z have minus signs and SymbolicArithmetic._polynomial_ expects them to not have the signs.  I think the appropriate fix would be to fix the printing for the generators of polynomial rings over Z/2Z
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23353",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This patch also fixes #3125.",
    "created_at": "2009-01-21T21:02:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23354",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:3'></a>This patch also fixes #3125.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23355",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [trac_3124.patch](tarball://root/attachments/some-uuid/ticket3124/trac_3124.patch) by @mwhansen created at 2009-01-21 21:04:01\n\nAnd by #3125, I mean #3135.",
    "created_at": "2009-01-21T21:04:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23356",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>Attachment [trac_3124.patch](tarball://root/attachments/some-uuid/ticket3124/trac_3124.patch) by @mwhansen created at 2009-01-21 21:04:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23357",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3124#issuecomment-23359",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
