...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3124#issuecomment-17308",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3124#issuecomment-17309",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3124#issuecomment-17310",
    "user": "https://github.com/mwhansen"
}
```
...
archive/attachments_003165.json:
```json
{
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac_3124.patch](https://github.com/sagemath/sage/files/ticket3124/trac_3124.patch)\n\nAnd by #3125, I mean #3135.",
    "created_at": "2009-01-21T21:04:01Z",
    "issue": "https://github.com/sagemath/sage/issues/3124",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3124#issuecomment-17311",
    "user": "https://github.com/mwhansen"
}
```
