...
```json
{
    ...
    "asset_name": "sudoku.patch",
    "asset_url": "tarball://root/attachments/ticket3084/sudoku.patch",
    "created_at": "2008-05-02T21:59:31Z",
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3084/sudoku.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    "body": "Attachment [sudoku.patch](https://github.com/sagemath/sage/files/ticket3084/sudoku.patch) by boothby created at 2008-05-02 21:59:31",
    "created_at": "2008-05-02T21:59:31Z",
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17007",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

Attachment [sudoku.patch](https://github.com/sagemath/sage/files/ticket3084/sudoku.patch) by boothby created at 2008-05-02 21:59:31
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16274"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17008",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16276"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16277"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16278"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17009",
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_3084_sudoku_class.patch",
    "asset_url": "tarball://root/attachments/ticket3084/trac_3084_sudoku_class.patch",
    "created_at": "2009-06-07T00:10:50Z",
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3084/trac_3084_sudoku_class.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17011",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16279"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16280"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17012",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17013",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17014",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16281"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16282"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3084#issuecomment-17015",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16283"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3084",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3084#event-16284"
}
```
