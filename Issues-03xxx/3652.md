# Issue 3652: [with patch, with positive review] FreeModule(ZZ, 2000).random_element() is far slower than it should be
...
```json
{
    ...
    "title": "[with patch, with positive review] FreeModule(ZZ, 2000).random_element() is far slower than it should be",
    "type": "issue",
