...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] FreeModule(ZZ, 2000).random_element() is far slower than it should be",
        "to": "[with patch, with positive review] FreeModule(ZZ, 2000).random_element() is far slower than it should be"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3652#event-13400"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3652#issuecomment-27171",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3652#issuecomment-27172",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3652",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3652#event-13401"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3652#issuecomment-27173",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3652#event-13402"
}
```
