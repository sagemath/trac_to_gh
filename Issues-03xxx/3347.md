...
archive/attachments_003417.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [3347-2.patch](https://github.com/sagemath/sage/files/ticket3347/3347-2.patch)\n\nchanges to tutorial (large!)",
    "created_at": "2008-06-02T19:09:20Z",
    "issue": "https://github.com/sagemath/sage/issues/3347",
    "type": "issue_comment",
...
**Attachment:** [3347-2.patch](https://github.com/sagemath/sage/files/ticket3347/3347-2.patch)
...
archive/attachments_003418.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_003419.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:13'></a>\n**Attachment:** [3347-2-with-dsage.patch](https://github.com/sagemath/sage/files/ticket3347/3347-2-with-dsage.patch)",
    "created_at": "2008-06-15T21:50:34Z",
    "issue": "https://github.com/sagemath/sage/issues/3347",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [3347-new.patch](https://github.com/sagemath/sage/files/ticket3347/3347-new.patch)\n\nuse 3347-1.patch and this patch (against tutorial from sage 3.0.3)",
    "created_at": "2008-06-19T20:52:43Z",
    "issue": "https://github.com/sagemath/sage/issues/3347",
    "type": "issue_comment",
...
**Attachment:** [3347-new.patch](https://github.com/sagemath/sage/files/ticket3347/3347-new.patch)
...
```json
{
    "body": "**Attachment:** [3347.patch](https://github.com/sagemath/sage/files/ticket3347/3347.patch)",
    "created_at": "2008-06-19T20:59:23Z",
    "issue": "https://github.com/sagemath/sage/issues/3347",
    "type": "issue_comment",
...
**Attachment:** [3347.patch](https://github.com/sagemath/sage/files/ticket3347/3347.patch)
