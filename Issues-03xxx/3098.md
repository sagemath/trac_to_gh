...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3098#issuecomment-23080",
...
```json
{
    "body": "<a id='comment:3'></a>After applying this patch the doctest of `sage/schemes/generic/divisor.py` hangs with the following in the singular pexpect log:\n\n```\n> intvec sage241=. if(defined(sage220)>0){kill sage220;}\nintvec sage241=. if(defined(sage220)>0){kill sage220;}\n   ? error occurred in STDIN line 1059: `intvec sage241=. if(defined(sage220)>0){kill sage220;}`\n   ? expected intvec-expression. type 'help intvec;'\n   ? last reserved name was `intvec`\n   skipping text from ` `. \nquit\n\nAuf Wiedersehen.\n```",
    "created_at": "2008-05-03T22:40:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3098#issuecomment-23081",
    "user": "https://github.com/wjp"
}
```

<a id='comment:3'></a>After applying this patch the doctest of `sage/schemes/generic/divisor.py` hangs with the following in the singular pexpect log:
...
```json
{
    "body": "<a id='comment:4'></a>It looks like it just needed an extra semicolon at the end, actually. I don't have time to finish a -testall now, but pending that, positive review.",
    "created_at": "2008-05-03T23:01:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3098#issuecomment-23082",
    "user": "https://github.com/wjp"
}
```

<a id='comment:4'></a>It looks like it just needed an extra semicolon at the end, actually. I don't have time to finish a -testall now, but pending that, positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3098#issuecomment-23084",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>With all three patches applied:\n\n```\nAll tests passed!\nTotal time for all tests: 944.7 seconds\n```\nw00t - 3.0.1 - here we come.\n\nCheers,\n\nMichael",
    "created_at": "2008-05-04T17:36:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3098#issuecomment-23085",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>With all three patches applied:
...
```json
{
    "body": "<a id='comment:8'></a>Merged in Sage 3.0.1.final. William did also test on boxen affected by the ring.pyx failure.",
    "created_at": "2008-05-04T17:40:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3098#issuecomment-23086",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Merged in Sage 3.0.1.final. William did also test on boxen affected by the ring.pyx failure.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3098",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3098#issuecomment-23087",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
