# Issue 3864: [with patch, positive review] Bug exposed by p-adic matrices
...
```json
{
    ...
    "title": "[with patch, positive review] Bug exposed by p-adic matrices",
    "type": "issue",
...
```json
{
    "body": "Attachment [trac-3864.patch](tarball://root/attachments/some-uuid/ticket3864/trac-3864.patch) by @craigcitro created at 2008-08-15 02:35:29",
    "created_at": "2008-08-15T02:35:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3864#issuecomment-29022",
    "user": "https://github.com/craigcitro"
}
```

Attachment [trac-3864.patch](tarball://root/attachments/some-uuid/ticket3864/trac-3864.patch) by @craigcitro created at 2008-08-15 02:35:29
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3864",
    "rename": {
        "from": "[with patch, needs review] Bug exposed by p-adic matrices",
        "to": "[with patch, positive review] Bug exposed by p-adic matrices"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3864#event-14347"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3864",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3864#event-14348"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3864#issuecomment-29023",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3864#issuecomment-29024",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
