...
archive/attachments_003309.json:
```json
{
...
```json
{
    "body": "**Attachment:** [pbori-0.5-sage.patch](https://github.com/sagemath/sage/files/ticket3264/pbori-0.5-sage.patch)",
    "created_at": "2008-07-11T01:40:44Z",
    "issue": "https://github.com/sagemath/sage/issues/3264",
    "type": "issue_comment",
...
**Attachment:** [pbori-0.5-sage.patch](https://github.com/sagemath/sage/files/ticket3264/pbori-0.5-sage.patch)
...
archive/attachments_003310.json:
```json
{
    "asset_content_type": "application/octet-stream",
