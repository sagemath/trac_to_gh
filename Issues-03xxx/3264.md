...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35205"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35208"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35209"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35210"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35211"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35212"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35213"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35214"
}
```
...
```json
{
    ...
    "title_was": "[with patch+spkg, needs review] Upgrade PolyBoRi to 0.5rc",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3264",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-35216"
}
```
