...
```json
{
    "body": "<a id='comment:1'></a>This would be quite helpful for getting SAGE into Debian (since the polybori-0.4 package is the first version that satisfies Debian python policy).",
    "created_at": "2008-05-30T06:03:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23115",
    "user": "https://github.com/timabbott"
}
```

<a id='comment:1'></a>This would be quite helpful for getting SAGE into Debian (since the polybori-0.4 package is the first version that satisfies Debian python policy).
...
```json
{
    "body": "<a id='comment:2'></a>I've attached a patch to SAGE required to make SAGE build against the polybori 0.5 release candidate.\n\nThe corresponding polybori-0.5rc.spkg is available at:\n\nhttp://sage.math.washington.edu/home/tabbott/polybori-0.5rc.spkg",
    "created_at": "2008-07-11T01:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23116",
    "user": "https://github.com/timabbott"
}
```

<a id='comment:2'></a>I've attached a patch to SAGE required to make SAGE build against the polybori 0.5 release candidate.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23117",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23118",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23119",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>IIRC correctly Martin is afk the weekend, but we might still catch him. So I added him to CC :)\n\nCheers,\n\nMichael",
    "created_at": "2008-07-11T03:43:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23122",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>IIRC correctly Martin is afk the weekend, but we might still catch him. So I added him to CC :)
...
```json
{
    "body": "<a id='comment:7'></a>This certainly looks like a C vs. C++ issue, that's all I can say for now without actually digging in.",
    "created_at": "2008-07-11T09:53:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23123",
    "user": "https://github.com/malb"
}
```

<a id='comment:7'></a>This certainly looks like a C vs. C++ issue, that's all I can say for now without actually digging in.
...
```json
{
    "body": "<a id='comment:8'></a>Note that PolyBoRi 0.5 still ships its own M4RI and does not use the default M4RI installed (in Sage or the system). We should sit down with the authors at ISSAC and discuss how to change that :-)",
    "created_at": "2008-07-11T15:14:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23124",
    "user": "https://github.com/malb"
}
```

<a id='comment:8'></a>Note that PolyBoRi 0.5 still ships its own M4RI and does not use the default M4RI installed (in Sage or the system). We should sit down with the authors at ISSAC and discuss how to change that :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23125",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Note that #3195 might be resolved by this upgrade.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-21T07:07:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23126",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Note that #3195 might be resolved by this upgrade.
...
```json
{
    "body": "<a id='comment:11'></a>> I am sitting next to Michael B. and he correctly pointed out that the issue is with the extension and not PolyBoRi itself.\n\n\nI don't understand what you mean by \"the issue is with the extension\".",
    "created_at": "2008-07-21T19:24:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23127",
    "user": "https://github.com/malb"
}
```

<a id='comment:11'></a>> I am sitting next to Michael B. and he correctly pointed out that the issue is with the extension and not PolyBoRi itself.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23129",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>The errors are due to -ansi, which is probably still in the spkg-patches of custom.py and/or SConstruct.\n\nBest regards,\n  Alexander",
    "created_at": "2008-07-22T21:42:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23132",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```

<a id='comment:16'></a>The errors are due to -ansi, which is probably still in the spkg-patches of custom.py and/or SConstruct.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23133",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23134",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [pbori-0.5-sage.2.patch](tarball://root/attachments/some-uuid/ticket3264/pbori-0.5-sage.2.patch) by @malb created at 2008-09-01 13:54:29\n\nHi there,\n\nI've uploaded an updated SPKG (not based on the rc Alexander pointed us to) here:\n\n  http://sage.math.washington.edu/home/malb/spkgs/polybori-0.5rc.p1.spkg\n\nand updated the attached patch. `sage -t sage/rings/` passes for me. I'v reverted #3104 too btw. and fixed the SPKG.txt.",
    "created_at": "2008-09-01T13:54:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23135",
    "user": "https://github.com/malb"
}
```

<a id='comment:18'></a>Attachment [pbori-0.5-sage.2.patch](tarball://root/attachments/some-uuid/ticket3264/pbori-0.5-sage.2.patch) by @malb created at 2008-09-01 13:54:29
...
```json
{
    "body": "<a id='comment:21'></a>Merged in Sage 3.1.2.rc0",
    "created_at": "2008-09-07T00:46:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23138",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:21'></a>Merged in Sage 3.1.2.rc0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3264#issuecomment-23139",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
