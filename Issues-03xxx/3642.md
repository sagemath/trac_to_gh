...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3642#issuecomment-20748",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3642#event-20308"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3642#event-20309"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3642#event-20310"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3642#event-20311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3642",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3642#event-20312"
}
```
