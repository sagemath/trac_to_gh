...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32937"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32940"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32941"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32942"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3088#issuecomment-16269",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3088#issuecomment-16270",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3088",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3088#event-32945"
}
```
