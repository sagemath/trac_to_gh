...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] Fixes for Debian gfan build",
        "to": "[with patch; positive review] Fixes for Debian gfan build"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3088#event-10937"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3088#issuecomment-22374",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3088#issuecomment-22375",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3088",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3088#event-10938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3088#issuecomment-22376",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
