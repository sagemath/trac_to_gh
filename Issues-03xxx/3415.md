# Issue 3415: [with patch; positive review] sage-3.0.3.alpha2 -- clean test of simple.py fails badly on osx ppc (fermat)
...
```json
{
    ...
    "title": "[with patch; positive review] sage-3.0.3.alpha2 -- clean test of simple.py fails badly on osx ppc (fermat)",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3415#issuecomment-25860",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [3415-simpletwist.patch](tarball://root/attachments/some-uuid/ticket3415/3415-simpletwist.patch) by @robertwb created at 2008-06-13 18:29:48\n\nI knew I was getting into trouble as soon as I tried to write doctests for a live notebook... \n\nThe above patch may not fix the issue, but it will help debut what is going on. It looks like it was unable to open a port to start the notebook (firewall issue?).",
    "created_at": "2008-06-13T18:29:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3415#issuecomment-25861",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>Attachment [3415-simpletwist.patch](tarball://root/attachments/some-uuid/ticket3415/3415-simpletwist.patch) by @robertwb created at 2008-06-13 18:29:48
...
```json
{
    "body": "<a id='comment:3'></a>In retrospect I think the network on the given test machine (at Harvard) is very foobar'd. \nSo apply this safe package and close this.",
    "created_at": "2008-06-13T22:32:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3415#issuecomment-25862",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>In retrospect I think the network on the given test machine (at Harvard) is very foobar'd. 
So apply this safe package and close this.
...
```json
{
    "body": "<a id='comment:4'></a>Merged in Sage 3.0.3.rc0",
    "created_at": "2008-06-15T18:39:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3415#issuecomment-25863",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Merged in Sage 3.0.3.rc0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3415#issuecomment-25864",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
