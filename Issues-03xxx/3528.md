# Issue 3528: [with spkg, positive review] test_gcc_version.pl claims that gcc 4.3 is not a valid compiler to build FLINT
...
```json
{
    ...
    "title": "[with spkg, positive review] test_gcc_version.pl claims that gcc 4.3 is not a valid compiler to build FLINT",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3528#issuecomment-26174",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3528#issuecomment-26175",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3528",
    "rename": {
        "from": "test_gcc_version.pl claims that gcc 4.3 is not a valid compiler to build FLINT",
        "to": "[with spkg, needs review] test_gcc_version.pl claims that gcc 4.3 is not a valid compiler to build FLINT"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3528#event-12832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3528#issuecomment-26176",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3528",
    "rename": {
        "from": "[with spkg, needs review] test_gcc_version.pl claims that gcc 4.3 is not a valid compiler to build FLINT",
        "to": "[with spkg, positive review] test_gcc_version.pl claims that gcc 4.3 is not a valid compiler to build FLINT"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3528#event-12833"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3528#issuecomment-26177",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3528",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3528#issuecomment-26178",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3528",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3528#event-12834"
}
```
