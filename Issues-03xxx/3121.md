...
```json
{
    "body": "<a id='comment:1'></a>The current patch needs to be cleaned up and doctests fixed.  I'm putting it up so that people can play with it if they want and also to backup the work.  I plan to clean it up fairly soon.",
    "created_at": "2008-05-07T08:43:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23321",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>The current patch needs to be cleaned up and doctests fixed.  I'm putting it up so that people can play with it if they want and also to backup the work.  I plan to clean it up fairly soon.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23323",
...
```json
{
    "body": "<a id='comment:4'></a>The patch has been updated to address all of William's comments and is ready to be reviewed again.",
    "created_at": "2008-05-08T01:30:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23324",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:4'></a>The patch has been updated to address all of William's comments and is ready to be reviewed again.
...
```json
{
    "body": "<a id='comment:5'></a>I tried the example:\n\n```\n@interact\ndef _(a = input_grid(2,2, default = [[1,7],[3,4]], label='M', width=10), \n      v = input_grid(2,1, default=[[1],[2]], label='v', width=10)):\n    m = matrix(a); v = matrix(v)\n    try: x = m\\v\n    except: x = \"(no solution)\"\n    html('$$%s %s = %s$$'%(latex(m), latex(x), latex(v)))\n```\nbut now the defaults in the input form are all empty instead of containing\nthe defaults.",
    "created_at": "2008-05-08T15:53:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23325",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>I tried the example:
...
```json
{
    "body": "<a id='comment:7'></a>Changing the once instance of svalue to value fixes points 1 and 3 above. \n\nJust add something to the docstring for interact? and this will be done.",
    "created_at": "2008-05-08T16:17:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23327",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:7'></a>Changing the once instance of svalue to value fixes points 1 and 3 above. 
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac-3121-input-grid.patch](tarball://root/attachments/some-uuid/ticket3121/trac-3121-input-grid.patch) by @jasongrout created at 2008-05-09 19:50:23\n\nI updated the patch again; sorry about not catching that typo (I apparently forgot to run sage -b before testing the last patch).  \n\nI also added an is_Matrix check to the automatic controls, so something like:\n\n```\n@interact\ndef _(A=matrix(3,3)):\n    print A\n```\n\ncreates the appropriate input_grid control.  I made my example in interact? use that method.\n\nThere are two patches above.  They are identical and one can be deleted.",
    "created_at": "2008-05-09T19:50:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23328",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:8'></a>Attachment [trac-3121-input-grid.patch](tarball://root/attachments/some-uuid/ticket3121/trac-3121-input-grid.patch) by @jasongrout created at 2008-05-09 19:50:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23329",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [sage-3121-part2_doc.patch](tarball://root/attachments/some-uuid/ticket3121/sage-3121-part2_doc.patch) by @williamstein created at 2008-05-11 02:54:59\n\nI'm OK with this if Jason is ok with sage-3121-part2_doc.patch",
    "created_at": "2008-05-11T02:54:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23330",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>Attachment [sage-3121-part2_doc.patch](tarball://root/attachments/some-uuid/ticket3121/sage-3121-part2_doc.patch) by @williamstein created at 2008-05-11 02:54:59
...
```json
{
    "body": "<a id='comment:10'></a>Looks good to me.  William's patch also fixes a few other unrelated documentation things with interact.",
    "created_at": "2008-05-11T03:09:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23331",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:10'></a>Looks good to me.  William's patch also fixes a few other unrelated documentation things with interact.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23332",
...
```json
{
    "body": "<a id='comment:11'></a>Merged both patches in Sage 3.0.2.alpha0",
    "created_at": "2008-05-11T09:59:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3121#issuecomment-23333",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged both patches in Sage 3.0.2.alpha0
