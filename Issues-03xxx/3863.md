...
```json
{
    "body": "<a id='comment:12'></a>Apparently #7661 depends on #7748, which already has a positive review, but requires 3 patches to be applied. Instructions are here: comment:15:ticket:7748\n\nI'm sorry for the inconvenience. Many thanks for helping me sort through the dependencies.",
    "created_at": "2010-04-06T15:54:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
...
<a id='comment:12'></a>Apparently #7661 depends on #7748, which already has a positive review, but requires 3 patches to be applied. Instructions are here: comment:15:ticket:7748
