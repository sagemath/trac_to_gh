...
```json
{
    "body": "<a id='comment:2'></a>The essential problem is that with half-integer or integer exponents of x, Maxima can symbolically integrate this using Erf.   Otherwise it can't (that doesn't mean it's not possible, just that Maxima doesn't know).  Before, Sage tried to turn the expression into a complex one if it couldn't evaluate it, but that doesn't do much for a real (unevaluated) integral; now the new symbolics just complain that it's not numeric, which of course it isn't.\n\nMy view is that the correct fix is to put some kind of check in for when \"integrate\" is part of the output string fed into .n() and in that case at least attempt to use numerical_integral or something.  Of course that has the problem that things like \n\n```\nsage: integrate(1/(1+x^7))\n1/7*log(x + 1) - 1/7*integrate((x^5 - 2*x^4 + 3*x^3 - 4*x^2 + 5*x - 6)/(x^6 - x^5 + x^4 - x^3 + x^2 - x + 1), x)\n```\nMaxima is able to partly symbolically integrate, leaving\n\n```\nsage: integrate(1/(1+x^7),x,0,1)\n```\nin trouble.  But at least a check for \"integrate\" at the beginning could help.",
    "created_at": "2009-05-22T15:49:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29754",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>The essential problem is that with half-integer or integer exponents of x, Maxima can symbolically integrate this using Erf.   Otherwise it can't (that doesn't mean it's not possible, just that Maxima doesn't know).  Before, Sage tried to turn the expression into a complex one if it couldn't evaluate it, but that doesn't do much for a real (unevaluated) integral; now the new symbolics just complain that it's not numeric, which of course it isn't.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29755",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Actually, the solution is much cleaner since .n() will call the _evalf_ method on the integrate function which we can just have resort to a numerical integral if it is definite and has no free variables.\n\nI'll look into this later.",
    "created_at": "2009-06-04T23:28:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29757",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:5'></a>Actually, the solution is much cleaner since .n() will call the _evalf_ method on the integrate function which we can just have resort to a numerical integral if it is definite and has no free variables.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29758",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29759",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29760",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29761",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29763",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29764",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This was fixed by #6465. Despite the fact that we still have problems with numerical integration (#8321), the problem addressed here is solved. I suggest that we add a doctest and close this ticket.\n\nattachment:trac_3863-doctest.patch adds a trivial doctest. Here is the same computation in Maple: \n\n```\n    |\\^/|     Maple 12 (IBM INTEL LINUX)\n._|\\|   |/|_. Copyright (c) Maplesoft, a division of Waterloo Maple Inc. 2008\n \\  MAPLE  /  All rights reserved. Maple is a trademark of\n <____ ____>  Waterloo Maple Inc.\n      |       Type ? for help.\n> Digits:=30;                             \n                                 Digits := 30\n\n> evalf(Int(x^2.7 * exp(-2.4*x), x=0..3));\nmemory used=3.8MB, alloc=3.1MB, time=0.06\nmemory used=7.6MB, alloc=4.4MB, time=0.13\nmemory used=11.4MB, alloc=4.4MB, time=0.21\n                       0.154572952320789711837207551604\n```",
    "created_at": "2010-04-05T13:07:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29765",
    "user": "https://github.com/burcin"
}
```

<a id='comment:8'></a>This was fixed by #6465. Despite the fact that we still have problems with numerical integration (#8321), the problem addressed here is solved. I suggest that we add a doctest and close this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29766",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"Golam Mortuza Hossain, Burcin Erocal\"",
    "created_at": "2010-04-05T13:07:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29767",
    "user": "https://github.com/burcin"
}
```

Changing author from "" to "Golam Mortuza Hossain, Burcin Erocal"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29768",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29771",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29772",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29773",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Apparently #7661 depends on #7748, which already has a positive review, but requires 3 patches to be applied. Instructions are here:[comment:15](#comment%3A15):ticket:7748\n\nI'm sorry for the inconvenience. Many thanks for helping me sort through the dependencies.",
    "created_at": "2010-04-06T15:54:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29774",
    "user": "https://github.com/burcin"
}
```

<a id='comment:12'></a>Apparently #7661 depends on #7748, which already has a positive review, but requires 3 patches to be applied. Instructions are here:[comment:15](#comment%3A15):ticket:7748
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29775",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29776",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Release manager: this ticket depends on #7748 and #7761.",
    "created_at": "2010-04-07T02:46:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29777",
    "user": "https://github.com/dandrake"
}
```

<a id='comment:14'></a>Release manager: this ticket depends on #7748 and #7761.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29778",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Merged \"trac_3863-doctest.patch\" in 4.4.alpha0.",
    "created_at": "2010-04-15T20:16:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29779",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:16'></a>Merged "trac_3863-doctest.patch" in 4.4.alpha0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29780",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3863#issuecomment-29781",
    "user": "https://github.com/jhpalmieri"
}
```
