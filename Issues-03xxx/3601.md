...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3601/tensor_product-for_trac.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3601/tensor_product-3601-review.patch",
