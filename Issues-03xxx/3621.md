...
```json
{
    "body": "Changed assignee from **@cswiercz** to **@cswiercz, brettnak**",
...
Changed assignee from **@cswiercz** to **@cswiercz, brettnak**
...
```json
{
    "body": "Changed assignee from **@cswiercz, brettnak** to **@cswiercz**",
...
Changed assignee from **@cswiercz, brettnak** to **@cswiercz**
