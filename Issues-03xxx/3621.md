...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39436"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39437"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39438"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39439"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39440"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39441"
}
```
...
```json
{
    "body": "Replying to [@cswiercz](https://github.com/sagemath/sage/issues/3621#comment:0):\n> There was an issue with Stock.historical() only returning stock information from Jan 1, 1990 onward and no earlier. The addition of an explicit enddate to the Google Finance query seems to fix this. Fix is demonstrated in the doctests of Stock.historical()\n> \n> Uses the datetime.date python module.\n\nThis ticket depends on #3356.",
    "created_at": "2008-07-09T16:56:11Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19713",
    "user": "https://github.com/cswiercz"
}
```

Replying to [@cswiercz](https://github.com/sagemath/sage/issues/3621#comment:0):
> There was an issue with Stock.historical() only returning stock information from Jan 1, 1990 onward and no earlier. The addition of an explicit enddate to the Google Finance query seems to fix this. Fix is demonstrated in the doctests of Stock.historical()
> 
> Uses the datetime.date python module.
...
```json
{
    ...
    "event": "assigned",
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "subject": "https://github.com/sagetrac-brettnak",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39442"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19714",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19715",
    "user": "https://github.com/sagetrac-brettnak"
}
```
...
```json
{
    ...
    "subject": "https://github.com/cswiercz",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19716",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39446"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39447"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19717",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19718",
    "user": "https://github.com/sagetrac-brettnak"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39453"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39454"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-brettnak",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39455"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39456"
}
```
...
```json
{
    ...
    "subject": "https://github.com/cswiercz",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39457"
}
```
...
```json
{
    ...
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "title_is": "sage.finance - add expand and refine finance.Stock",
    "title_was": "Finance -- Fix Stock.historical(), addition of enddate input",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39459"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19719",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19720",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19721",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19722",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19723",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19724",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19725",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19726",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19727",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19728",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19729",
    "user": "https://github.com/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19730",
    "user": "https://github.com/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19731",
    "user": "https://github.com/boothby"
}
```

Attachment: **[3621–example.patch.gz](https://github.com/sagemath/sage/files/ticket3621/e4a0248e3a4ac214abefc7948846a4c0.gz)**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19732",
    "user": "https://github.com/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19733",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39465"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19734",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3621#issuecomment-19735",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3621",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3621#event-39467"
}
```
