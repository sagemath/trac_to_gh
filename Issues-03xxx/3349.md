...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25123",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This ticket is very vague, and we have been dealing with these issues on a per-spkg basis, I think - not to mention that it has gotten no comments in four years.  I'm recommending to close this, though the release manager could have another view.",
    "created_at": "2012-06-01T17:55:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25124",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:2'></a>This ticket is very vague, and we have been dealing with these issues on a per-spkg basis, I think - not to mention that it has gotten no comments in four years.  I'm recommending to close this, though the release manager could have another view.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25125",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25126",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25127",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25128",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Sage is building perfectly fine now on a lot of OS X machines.  The ticket doesn't mention any *concrete* instance of the issue.",
    "created_at": "2012-06-02T12:37:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25129",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:4'></a>Sage is building perfectly fine now on a lot of OS X machines.  The ticket doesn't mention any *concrete* instance of the issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3349#issuecomment-25130",
    "user": "https://github.com/jdemeyer"
}
```
