...
```json
{
    "body": "Attachment [twisted-8.0.1-64bit-osx-support.patch](https://github.com/sagemath/sage/files/ticket3193/twisted-8.0.1-64bit-osx-support.patch) by mabshoff created at 2008-05-28 09:55:34",
    "created_at": "2008-05-28T09:55:34Z",
    "issue": "https://github.com/sagemath/sage/issues/3193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3193#issuecomment-17633",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

Attachment [twisted-8.0.1-64bit-osx-support.patch](https://github.com/sagemath/sage/files/ticket3193/twisted-8.0.1-64bit-osx-support.patch) by mabshoff created at 2008-05-28 09:55:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3193#issuecomment-17634",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3193",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3193#issuecomment-17635",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
