...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-29372",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Looks good. I don't have an Itanium to test on, but Michael assures me that it works on the machine where it had previously failed. I also looked at the only change in the spkg, which seems reasonable, and built it on my machine, which doesn't seem to cause any trouble.",
    "created_at": "2008-08-29T09:05:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-29374",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:3'></a>Looks good. I don't have an Itanium to test on, but Michael assures me that it works on the machine where it had previously failed. I also looked at the only change in the spkg, which seems reasonable, and built it on my machine, which doesn't seem to cause any trouble.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-29375",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-29376",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
