# Issue 3989: [with positive review] autotools issues with gd-2.0.35
...
```json
{
    ...
    "title": "[with positive review] autotools issues with gd-2.0.35",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-33314",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-33315",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "rename": {
        "from": "autotools issues with gd-2.0.35",
        "to": "[with positive review] autotools issues with gd-2.0.35"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3989#event-11940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-33316",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3989#event-11941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-33317",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3989#issuecomment-33318",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
