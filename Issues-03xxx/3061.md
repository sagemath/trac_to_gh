# Issue 3061: [with positive review] use readlink and realpatch so that symlinking sage works
...
```json
{
    ...
    "title": "[with positive review] use readlink and realpatch so that symlinking sage works",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3061#issuecomment-23952",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3061/trac_3061.patch",
    "created_at": "2008-04-30T05:43:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "type": "attachment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3061#issuecomment-23953",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3061#issuecomment-23954",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "rename": {
        "from": "use readlink and realpatch so that symlinking sage works",
        "to": "[with positive review] use readlink and realpatch so that symlinking sage works"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3061#event-8938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3061#issuecomment-23955",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3061#issuecomment-23956",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3061#issuecomment-23957",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3061",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3061#event-8939"
}
```
