...
```json
{
    "body": "<a id='comment:1'></a>Attachment [3345.patch](tarball://root/attachments/some-uuid/ticket3345/3345.patch) by @mwhansen created at 2008-06-10 04:06:56",
    "created_at": "2008-06-10T04:06:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23180",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>Attachment [3345.patch](tarball://root/attachments/some-uuid/ticket3345/3345.patch) by @mwhansen created at 2008-06-10 04:06:56
...
```json
{
    "body": "<a id='comment:2'></a>I've attached a patch which grabs the interpreters namespace from IPython and passes it in as the globals to pdb.runeval.  I'm not sure why trace worked before / why it's not working now though.",
    "created_at": "2008-06-10T04:07:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23181",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>I've attached a patch which grabs the interpreters namespace from IPython and passes it in as the globals to pdb.runeval.  I'm not sure why trace worked before / why it's not working now though.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23182",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23183",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>With the patch `trace('2 + 2')` works now, but strangely each instance of trace seems to start by recalling the last : \n\n```\n----------------------------------------------------------------------\n----------------------------------------------------------------------\nLoading SAGE library. Current Mercurial branch is: fwc\nsage: trace('2 + 2')\n> <string>(1)<module>()\n(Pdb) s\n--Return--\n> <string>(1)<module>()->4\n(Pdb) s\n4\nsage: trace('2 + 2')\n> <string>(1)<module>()->4\n(Pdb) s\n--Return--\n> <string>(1)<module>()->4\n(Pdb) s\n4\nsage: trace('3 + 3')\n> <string>(1)<module>()->4\n(Pdb) s\n--Return--\n> <string>(1)<module>()->6\n(Pdb) s\n6\nsage: trace('3 + 3')\n> <string>(1)<module>()->6\n(Pdb) s\n--Return--\n> <string>(1)<module>()->6\n(Pdb) s\n6\n```\n| SAGE Version 3.0.2, Release Date: 2008-05-24                       |\n| Type notebook() for the GUI, and license() for information.        |\nAnd there are still some things `trace` can't do:\n\n```\nsage: trace(\"P.<y> = QQ[]\")\n------------------------------------------------------------\n   File \"<string>\", line 1\n     P = QQ['y']; (y,) = P._first_ngens(Integer(1))\n       ^\nSyntaxError: invalid syntax\n```\nBut there's no problem with\n\n```\nsage: P = QQ['y']; (y,) = P._first_ngens(Integer(1))\nsage: P\nUnivariate Polynomial Ring in y over Rational Field\nsage: P == parent(y)\nTrue\n```",
    "created_at": "2008-06-10T07:55:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23184",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```

<a id='comment:3'></a>With the patch `trace('2 + 2')` works now, but strangely each instance of trace seems to start by recalling the last : 
...
```json
{
    "body": "<a id='comment:5'></a>Why did this get positive review? It looks broken.",
    "created_at": "2008-06-15T21:20:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23185",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:5'></a>Why did this get positive review? It looks broken.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23186",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23187",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>I don't know what's going on recalling the last value produced by trace, but that seems to be something within pdb.  Trace has never worked on (and probably shouldn't) work on statements (like assignment ones) -- only on expressions.",
    "created_at": "2008-07-15T21:29:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23188",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:8'></a>I don't know what's going on recalling the last value produced by trace, but that seems to be something within pdb.  Trace has never worked on (and probably shouldn't) work on statements (like assignment ones) -- only on expressions.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23189",
...
```json
{
    "body": "<a id='comment:9'></a>While refereeing trac_3345.patch I:\n1. fix the issue with running assignments, and \n2. added some mean serious doctests\n3. Added a proper error message when one uses trace in the notebook",
    "created_at": "2008-07-21T18:20:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23190",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>While refereeing trac_3345.patch I:
1. fix the issue with running assignments, and 
2. added some mean serious doctests
3. Added a proper error message when one uses trace in the notebook
...
```json
{
    "body": "<a id='comment:10'></a>To apply this patch you should apply trac_3345.patch and trac_3345-part2.patch",
    "created_at": "2008-07-21T18:23:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23191",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:10'></a>To apply this patch you should apply trac_3345.patch and trac_3345-part2.patch
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [trac_3345-part3.patch](tarball://root/attachments/some-uuid/ticket3345/trac_3345-part3.patch) by @williamstein created at 2008-07-21 21:00:13",
    "created_at": "2008-07-21T21:00:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23193",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:12'></a>Attachment [trac_3345-part3.patch](tarball://root/attachments/some-uuid/ticket3345/trac_3345-part3.patch) by @williamstein created at 2008-07-21 21:00:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23194",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Positive review for all four trac_3345* patches.",
    "created_at": "2008-07-21T22:53:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23195",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:13'></a>Positive review for all four trac_3345* patches.
...
```json
{
    "body": "<a id='comment:14'></a>Merged trac_3345.patch, trac_3345-part2.patch, trac_3345-part3.patch and\ntrac_3345-part4.patch in Sage 3.0.6.rc0.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-21T22:56:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23196",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:14'></a>Merged trac_3345.patch, trac_3345-part2.patch, trac_3345-part3.patch and
trac_3345-part4.patch in Sage 3.0.6.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3345#issuecomment-23197",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
