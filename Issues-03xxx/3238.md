...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3238#issuecomment-23531",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3238",
    "rename": {
        "from": "[with patch; needs review] libfpll spkg -- update to work with cygwin",
        "to": "[with patch; positive review] libfpll spkg -- update to work with cygwin"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3238#event-11538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3238#issuecomment-23532",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3238#issuecomment-23533",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3238",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3238#event-11539"
}
```
