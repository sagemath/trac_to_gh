# Issue 3285: [with patch, positive review] segfault in binary_code.pyx on 32-bit linux
...
```json
{
    ...
    "title": "[with patch, positive review] segfault in binary_code.pyx on 32-bit linux",
    "type": "issue",
...
```json
{
    "body": "Description changed:\n```diff\n--- \n+++ \n@@ -1,3 +1,5 @@\n+On many 32-bit linux systems binary_code.pyx is foobar.\n+\n ```\n was@ubuntu:~/build/sage-3.0.2.rc0$ ./sage -t --gdb devel/sage/sage/coding/binary_code.pyx\n sage -t --gdb devel/sage/sage/coding/binary_code.pyx        ********************************************************************************\n@@ -26,6 +28,30 @@\n (gdb) \n ```\n \n+More useful output:\n+\n+```\n+ok\n+Trying:\n+    soc_iter = self_orthogonal_binary_codes(Integer(12), Integer(6), Integer(4))###line 3748:_sage_    >>> soc_iter = self_orthogonal_binary_codes(12, 6, 4)\n+Expecting nothing\n+ok\n+Trying:\n+    L = list(soc_iter)###line 3749:_sage_    >>> L = list(soc_iter)\n+Expecting nothing\n+\n+\n+------------------------------------------------------------\n+Unhandled SIGSEGV: A segmentation fault occured in SAGE.\n+This probably occured because a *compiled* component\n+of SAGE has a bug in it (typically accessing invalid memory)\n+or is not properly wrapped with _sig_on, _sig_off.\n+You might want to run SAGE under gdb with 'sage -gdb' to debug this.\n+SAGE will now terminate (sorry).\n+------------------------------------------------------------\n+\n+```\n+\n Comment: 1\n \n Summary: segfault in binary_code.pyx on 32-bit linux\n```\n",
    "created_at": "2008-05-23T17:22:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3285#issuecomment-23268",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3285#issuecomment-23269",
...
```json
{
    "body": "<a id='comment:3'></a>On 32-bit Ubuntu, I was able to reproduce the segfault, which does not happen after applying:\n\nhttp://sage.math.washington.edu/home/rlmill/trac-3285-mem_bc.patch",
    "created_at": "2008-05-23T23:32:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3285#issuecomment-23270",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>On 32-bit Ubuntu, I was able to reproduce the segfault, which does not happen after applying:
...
```json
{
    "body": "<a id='comment:4'></a>The patch fixes the issue, the coding directory now valgrinds clean and \"testall long\" passes. Positive review.\n\nCheers,\n\nMichael",
    "created_at": "2008-05-24T00:31:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3285#issuecomment-23271",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>The patch fixes the issue, the coding directory now valgrinds clean and "testall long" passes. Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3285#event-7385"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Merged in Sage 3.0.3.rc3",
    "created_at": "2008-05-24T00:31:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3285#issuecomment-23272",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Merged in Sage 3.0.3.rc3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3285#issuecomment-23273",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3285#issuecomment-23274",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
