...
```json
{
    ...
    "type": "issue",
    "updated_at": "2008-05-24T00:31:28Z",
    "url": "https://github.com/sagemath/sage/issues/3285",
...
```json
{
    ...
    "created_at": "2008-05-23T17:20:39Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "milestone_number": null,
    "milestone_title": "sage-3.0.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35442"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35445"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35446"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3285#issuecomment-17352",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3285#issuecomment-17353",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3285#issuecomment-17354",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3285#issuecomment-17355",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3285#event-35451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3285#issuecomment-17356",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    "body": "Attachment: **[trac-3285-mem_bc.patch.gz](https://github.com/sagemath/sage/files/ticket3285/trac-3285-mem_bc.patch.gz)**",
    "created_at": "2008-05-24T00:39:13Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/3285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3285#issuecomment-17357",
    "user": "https://github.com/sagetrac-mabshoff"
}
```

Attachment: **[trac-3285-mem_bc.patch.gz](https://github.com/sagemath/sage/files/ticket3285/trac-3285-mem_bc.patch.gz)**
