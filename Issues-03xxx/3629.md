...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3629#issuecomment-27016",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with new spkg, needs review] ]givaro-3.2.11 installs its own libgmpxx.{so,a}"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3629#event-13317"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3629",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3629#issuecomment-27017",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3629",
    "rename": {
        "from": "[with new spkg, needs review] ]givaro-3.2.11 installs its own libgmpxx.{so,a}",
        "to": "[with new spkg, positive review] givaro-3.2.11 installs its own libgmpxx.{so,a}"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3629#event-13318"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3629",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3629#issuecomment-27018",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3629",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3629#issuecomment-27019",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3629",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3629#event-13319"
}
```
