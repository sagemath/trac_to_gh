...
```json
{
    "body": "<a id='comment:2'></a>No, not yet; definitely not yet.  I'm embarrassed to post the patch as it was; I only posted it because I was more embarrassed by almost losing the patch (I just barely found it).",
...
<a id='comment:2'></a>No, not yet; definitely not yet.  I'm embarrassed to post the patch as it was; I only posted it because I was more embarrassed by almost losing the patch (I just barely found it).
...
```json
{
    "body": "<a id='comment:3'></a>I am thinking of giving this to a student of mine for an independent study project.  To avoid duplication of effort I would appreciate being informed of any independent effort on it.\n\nThanks,\nMarshall Hampton",
...
<a id='comment:3'></a>I am thinking of giving this to a student of mine for an independent study project.  To avoid duplication of effort I would appreciate being informed of any independent effort on it.
...
```json
{
    "body": "<a id='comment:4'></a>It looks like my student didn't get very far, unfortunately.  I will attempt to improve this further, but I am attaching a rebased (and slightly cleaned-up) patch in case other people want to move ahead faster.",
...
<a id='comment:4'></a>It looks like my student didn't get very far, unfortunately.  I will attempt to improve this further, but I am attaching a rebased (and slightly cleaned-up) patch in case other people want to move ahead faster.
...
<a id='comment:5'></a>There is a bounty for a feature like this:
...
```json
{
    "body": "<a id='comment:10'></a>Given that the legacy-notebook is no longer maintained or developed, let us close that old ticket.",
...
<a id='comment:10'></a>Given that the legacy-notebook is no longer maintained or developed, let us close that old ticket.
