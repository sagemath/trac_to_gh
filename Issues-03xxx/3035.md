...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3035#event-28017"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3035#event-28018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3035#event-28019"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3035#event-28020"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3035#event-28021"
}
```
...
```json
{
    ...
    "title_was": "calculus/equations.py",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3035#event-28022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3035",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3035#event-28023"
}
```
