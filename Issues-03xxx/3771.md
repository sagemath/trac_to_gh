...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3771#issuecomment-28248",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3771",
    "rename": {
        "from": "[with patch; needs review] make it so typing \"sage -br\" for new binary sage installs doesn't require rebuilding everything",
        "to": "[with patch; with positive review] make it so typing \"sage -br\" for new binary sage installs doesn't require rebuilding everything"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3771#event-13925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3771#issuecomment-28249",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3771",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3771#event-13926"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3771#issuecomment-28250",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
