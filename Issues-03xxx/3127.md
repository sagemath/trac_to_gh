...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3127#event-29554"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3127#event-29555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3127#event-29556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3127#event-29557"
}
```
...
```json
{
    "body": "Changed assignee from **@wdjoyner** to **@roed314**",
...
Changed assignee from **@wdjoyner** to **@roed314**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3127#event-29558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3127",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3127#event-29559"
}
```
