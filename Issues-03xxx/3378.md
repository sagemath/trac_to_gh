...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3378#issuecomment-24864",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3378",
    "rename": {
        "from": "[with patch, needs review] graphs.nauty_geng fails due to missing imports",
        "to": "[with patch, positive review] graphs.nauty_geng fails due to missing imports"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3378#event-12132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3378#issuecomment-24865",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3378",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3378#event-12133"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3378#issuecomment-24866",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3378#issuecomment-24867",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
