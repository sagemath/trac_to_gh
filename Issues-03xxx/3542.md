...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26347",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3542#event-12903"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26348",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "rename": {
        "from": "[with patch, needs review] multimodular algorithm for Bernoulli numbers",
        "to": "[with patch, needs work] multimodular algorithm for Bernoulli numbers"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3542#event-12904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26349",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26350",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26351",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "rename": {
        "from": "[with patch, needs work] multimodular algorithm for Bernoulli numbers",
        "to": "[with patch, needs review] multimodular algorithm for Bernoulli numbers"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3542#event-12905"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26352",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26353",
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] multimodular algorithm for Bernoulli numbers",
        "to": "[with patch, with positive review] multimodular algorithm for Bernoulli numbers"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3542#event-12906"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26354",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3542#event-12907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3542#issuecomment-26355",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3542#event-12908"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3542#event-12909"
}
```
