...
```json
{
    "body": "<a id='comment:1'></a>Attachment [m4ri_hash.patch](tarball://root/attachments/some-uuid/ticket3724/m4ri_hash.patch) by @malb created at 2008-08-06 16:32:32\n\nit seems, the patch is independent of the PNG fix.",
...
<a id='comment:1'></a>Attachment [m4ri_hash.patch](tarball://root/attachments/some-uuid/ticket3724/m4ri_hash.patch) by @malb created at 2008-08-06 16:32:32
...
```json
{
    "body": "<a id='comment:2'></a>Simon, can you review my patch?",
...
<a id='comment:2'></a>Simon, can you review my patch?
...
<a id='comment:3'></a>The patch applies to sage-3.1.1
...
<a id='comment:7'></a>Sorry, but i think i should re-open the ticket:
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [m4ri_hash2.patch](tarball://root/attachments/some-uuid/ticket3724/m4ri_hash2.patch) by @malb created at 2008-08-26 13:25:29\n\nYou're right, good catch. The attached patch addresses that issue.",
...
<a id='comment:8'></a>Attachment [m4ri_hash2.patch](tarball://root/attachments/some-uuid/ticket3724/m4ri_hash2.patch) by @malb created at 2008-08-26 13:25:29
...
```json
{
    "body": "<a id='comment:9'></a>m4ri_hash2.patch looks good to me. Positive review.",
...
<a id='comment:9'></a>m4ri_hash2.patch looks good to me. Positive review.
...
```json
{
    "body": "<a id='comment:10'></a>Merged m4ri_hash2.patch in Sage 3.1.2.alpha1",
    "created_at": "2008-08-26T21:50:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3724",
    "type": "issue_comment",
...
<a id='comment:10'></a>Merged m4ri_hash2.patch in Sage 3.1.2.alpha1
...
```json
{
    "body": "<a id='comment:11'></a>The new hash-ing method does not obey Sage's hashing rules. See Robert's comment at #3956. Obeying this rule however would come with a considerable speed penalty compared to `m4ri_hash.patch`.",
...
<a id='comment:11'></a>The new hash-ing method does not obey Sage's hashing rules. See Robert's comment at #3956. Obeying this rule however would come with a considerable speed penalty compared to `m4ri_hash.patch`.
...
```json
{
    "body": "<a id='comment:13'></a>your wish is my command.",
...
<a id='comment:13'></a>your wish is my command.
