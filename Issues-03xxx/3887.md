...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37583"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37584"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37585"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37586"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37587"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3887",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37591"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3887",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3887#event-37592"
}
```
