...
```json
{
    "body": "<a id='comment:1'></a>Attachment [sage-3482.patch](tarball://root/attachments/some-uuid/ticket3482/sage-3482.patch) by @williamstein created at 2008-06-20 06:27:41",
    "created_at": "2008-06-20T06:27:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26503",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Attachment [sage-3482.patch](tarball://root/attachments/some-uuid/ticket3482/sage-3482.patch) by @williamstein created at 2008-06-20 06:27:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26504",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Please change the environment variable to start with SAGE; these should all be consistent.  Also, why is it not SAGE_PICKLE_JAR_ROOT in keeping with the convention?\n\nThe doctests do not show what filename a particular object is given, nor does it demonstrate a failing load.  If the idea is figure out what class cannot be reconstituted, that's not enough.  Also, it would be nice to test unpickling a class that no longer exists in the library.\n\nIn addition, the code doesn't return the unpickled objects -- say a dict or similar.  Why not?\n\nI say this is not done yet.",
    "created_at": "2008-06-20T21:54:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26505",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:4'></a>Please change the environment variable to start with SAGE; these should all be consistent.  Also, why is it not SAGE_PICKLE_JAR_ROOT in keeping with the convention?
...
```json
{
    "body": "<a id='comment:6'></a>A suggestion: maybe the file should actually store a triple, `(dumps(x), repr(x), repr(parent(x)))` (maybe also repr(type(x)) and repr(type(parent(x)))).  The repr's would serve two purposes: in case a pickle fails to unpickle in a new version, this is useful for figuring out where to look; and repr(x) and repr(parent(x)) can be recomputed in the new version of Sage and compared to the pickled version, as a minimal check that unpickling actually gave the correct object.\n\nThe downside is that changing the printing of an object would start to make the pickle jar tests fail; there would have to be a way of updating the printing in previous-version pickle jars (without changing the previous dumps(x)).",
    "created_at": "2008-06-22T20:27:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26507",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:6'></a>A suggestion: maybe the file should actually store a triple, `(dumps(x), repr(x), repr(parent(x)))` (maybe also repr(type(x)) and repr(type(parent(x)))).  The repr's would serve two purposes: in case a pickle fails to unpickle in a new version, this is useful for figuring out where to look; and repr(x) and repr(parent(x)) can be recomputed in the new version of Sage and compared to the pickled version, as a minimal check that unpickling actually gave the correct object.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26509",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26510",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26511",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [sage-3482-part3.patch](tarball://root/attachments/some-uuid/ticket3482/sage-3482-part3.patch) by @williamstein created at 2008-07-06 19:37:28",
    "created_at": "2008-07-06T19:37:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26512",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>Attachment [sage-3482-part3.patch](tarball://root/attachments/some-uuid/ticket3482/sage-3482-part3.patch) by @williamstein created at 2008-07-06 19:37:28
...
```json
{
    "body": "<a id='comment:10'></a>I still want to see doctests that show a failing unpickle, but this is still good and should be applied.  Positive review from me.",
    "created_at": "2008-07-06T20:01:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26513",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:10'></a>I still want to see doctests that show a failing unpickle, but this is still good and should be applied.  Positive review from me.
...
```json
{
    "body": "<a id='comment:11'></a>Merged in Sage 3.0.4.alpha2",
    "created_at": "2008-07-07T03:34:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26514",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged in Sage 3.0.4.alpha2
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26515",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-26516",
    "user": "https://github.com/williamstein"
}
```
