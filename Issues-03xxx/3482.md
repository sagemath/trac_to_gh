# Issue 3482: [with positive review] create a pickle jar
...
```json
{
    ...
    "title": "[with positive review] create a pickle jar",
    "type": "issue",
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10288"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3482/sage-3482.patch",
    "created_at": "2008-06-20T06:27:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "attachment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28095",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28096",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] create a pickle jar"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28097",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28098",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "rename": {
        "from": "[with positive review] create a pickle jar",
        "to": "[with mixed review] create a pickle jar"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28099",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28100",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28101",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28102",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3482/sage-3482-part2.patch",
...
```json
{
    "body": "this addresses the referee's remarks.",
    "created_at": "2008-07-06T17:57:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28103",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3482/pickle_jar-3.0.3.tar.bz2",
...
```json
{
    "body": "an official pickle jar from sage-3.0.3 made on ubuntu 64-bit (sagemath.org)",
    "created_at": "2008-07-06T19:16:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28104",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10291"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3482/sage-3482-part3.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28105",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28106",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10292"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10293"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10294"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3482#event-10295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28107",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28108",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3482/pickle_jar-3.0.5.tar.bz2",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3482#issuecomment-28109",
    "user": "https://github.com/williamstein"
}
```
