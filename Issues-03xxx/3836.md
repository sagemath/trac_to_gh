...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3836#issuecomment-29473",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3836#issuecomment-29474",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3836#issuecomment-29476",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Turns out that this is going to be available once it makes its way back from the single-cell server code!  See [this ask.sagemath.org question](http://ask.sagemath.org/question/1061/), in particular Jason's answer.",
    "created_at": "2012-01-17T23:27:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3836#issuecomment-29477",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:4'></a>Turns out that this is going to be available once it makes its way back from the single-cell server code!  See [this ask.sagemath.org question](http://ask.sagemath.org/question/1061/), in particular Jason's answer.
...
```json
{
    "body": "<a id='comment:9'></a>This can be done in Jupyter, using traitlets links.",
    "created_at": "2017-03-21T11:17:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3836#issuecomment-29478",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:9'></a>This can be done in Jupyter, using traitlets links.
