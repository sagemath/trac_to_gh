...
```json
{
    ...
    "rename": {
        "from": "notebook -- parses tracebacks in the output of docstrings of help command",
        "to": "[with patch; needs review] notebook -- parses tracebacks in the output of docstrings of help command"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3024#event-10700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3024#issuecomment-21829",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "rename": {
        "from": "[with patch; needs review] notebook -- parses tracebacks in the output of docstrings of help command",
        "to": "[with patch; positive review] notebook -- parses tracebacks in the output of docstrings of help command"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3024#event-10701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3024#issuecomment-21830",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3024#issuecomment-21831",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3024#issuecomment-21832",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3024#event-10702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3024#issuecomment-21833",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3024#issuecomment-21834",
    "user": "https://github.com/fchapoton"
}
```
