...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22808",
...
```json
{
    "body": "Attachment [primegen-0.97.spkg](https://github.com/sagemath/sage/files/ticket3925/primegen-0.97.spkg) by @wjp created at 2009-07-13 21:48:07",
    "created_at": "2009-07-13T21:48:07Z",
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22809",
    "user": "https://github.com/wjp"
}
```

Attachment [primegen-0.97.spkg](https://github.com/sagemath/sage/files/ticket3925/primegen-0.97.spkg) by @wjp created at 2009-07-13 21:48:07
...
```json
{
    "body": "Attachment [trac-3925-spkg_deps.patch](https://github.com/sagemath/sage/files/ticket3925/trac-3925-spkg_deps.patch) by @wjp created at 2009-07-13 21:48:18",
    "created_at": "2009-07-13T21:48:18Z",
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22810",
    "user": "https://github.com/wjp"
}
```

Attachment [trac-3925-spkg_deps.patch](https://github.com/sagemath/sage/files/ticket3925/trac-3925-spkg_deps.patch) by @wjp created at 2009-07-13 21:48:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22811",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac-3925-primegen.patch](https://github.com/sagemath/sage/files/ticket3925/trac-3925-primegen.patch) by @JohnCremona created at 2009-07-24 21:14:10\n\nHello Willem.  I successfully installed the spkg and the second patch but I don't know how to install the first patch as it changes files not in the usual code tree.  If you tell me how, I would like to test this.  -- John",
    "created_at": "2009-07-24T21:14:10Z",
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22812",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22813",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22814",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22815",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3925#issuecomment-22816",
