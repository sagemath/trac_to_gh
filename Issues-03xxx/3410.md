...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25832",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25833",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25834",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>attachment:trac3410-matrix_polyring_magma-2.patch addresses both of the problems pointed out in[comment:1](#comment%3A1). It applies to 3.0.3.alpha2, doesn't call magma for each matrix element, and on the way probably optimizes conversion of polynomials to magma as well.",
    "created_at": "2008-06-14T00:15:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25835",
    "user": "https://github.com/burcin"
}
```

<a id='comment:2'></a>attachment:trac3410-matrix_polyring_magma-2.patch addresses both of the problems pointed out in[comment:1](#comment%3A1). It applies to 3.0.3.alpha2, doesn't call magma for each matrix element, and on the way probably optimizes conversion of polynomials to magma as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25836",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25837",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25838",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25839",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25840",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25841",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3410",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3410#issuecomment-25842",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
