...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] notebook -- fix bug where it saved the notebook every tie it checked for idle worksheets",
        "to": "[with patch; postive review] notebook -- fix bug where it saved the notebook every tie it checked for idle worksheets"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3555#event-12973"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3555#issuecomment-26446",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3555",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3555#event-12974"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3555#issuecomment-26447",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3555#issuecomment-26448",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
