...
<a id='comment:1'></a>Attachment [trac_3041.patch](tarball://root/attachments/some-uuid/ticket3041/trac_3041.patch) by mabshoff created at 2008-04-27 05:03:17
...
```json
{
    "body": "<a id='comment:2'></a>Tested on OSX and Linux. Spkg builds, modular forms doctest all pass.",
...
<a id='comment:2'></a>Tested on OSX and Linux. Spkg builds, modular forms doctest all pass.
...
```json
{
    "body": "<a id='comment:4'></a>Partial credit goes to Francois Bissey.\n\nCheers,\n\nMichael",
...
<a id='comment:4'></a>Partial credit goes to Francois Bissey.
