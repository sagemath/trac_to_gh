...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3623/3623-factory-1.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3623/3623-factory-3.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3623/3623-factory-4.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3623/3623-factory-5.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3623/3623-all-3.2.1.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3623/3623-fix.patch",
...
```json
{
    "body": "apply after 3623-3.2.1-all.patch",
    "created_at": "2008-12-02T20:18:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3623",
    "type": "issue_comment",
