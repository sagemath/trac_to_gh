# Issue 3763: [with positive review] add conversions from AA/QQbar to standard types
...
```json
{
    ...
    "title": "[with positive review] add conversions from AA/QQbar to standard types",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket3763/trac3763-qqbar-conversions.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3763#issuecomment-30875",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3763#event-11233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3763#issuecomment-30876",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3763#issuecomment-30877",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] add conversions from AA/QQbar to standard types"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3763#event-11234"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3763#issuecomment-30878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3763",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3763#issuecomment-30879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3763",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3763#event-11235"
}
```
