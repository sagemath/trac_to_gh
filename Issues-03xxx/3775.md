...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3775#event-8652"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Arrg, invalid. The above happened when invoking Maxima directly, so this is not a bug on our end.",
    "created_at": "2008-08-05T17:35:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3775#issuecomment-29017",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Arrg, invalid. The above happened when invoking Maxima directly, so this is not a bug on our end.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3775#issuecomment-29018",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
