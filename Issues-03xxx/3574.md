...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39202"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3574#issuecomment-19494",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3574#issuecomment-19495",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3574",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3574#event-39209"
}
```
