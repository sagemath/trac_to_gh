...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36354"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36357"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36358"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3363#issuecomment-18083",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3363#issuecomment-18084",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3363",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36359"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3363#issuecomment-18085",
...
```json
{
    ...
    "milestone_title": "sage-4.4.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3363#event-36362"
}
```
