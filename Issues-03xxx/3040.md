...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21952",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21953",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "rename": {
        "from": "[with patch; needs review] make it so magma(A) works for matrices over cyclotomic number fields",
        "to": "[with patch, with negative review] make it so magma(A) works for matrices over cyclotomic number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3040#event-10749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21954",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "rename": {
        "from": "[with patch, with negative review] make it so magma(A) works for matrices over cyclotomic number fields",
        "to": "[with patch, with positive review] make it so magma(A) works for matrices over cyclotomic number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3040#event-10750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21955",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21956",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "rename": {
        "from": "[with patch, with positive review] make it so magma(A) works for matrices over cyclotomic number fields",
        "to": "[with patch, with positive review, needs rebase] make it so magma(A) works for matrices over cyclotomic number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3040#event-10751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21957",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21958",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3040#event-10752"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21959",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3040#issuecomment-21960",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3040",
    "rename": {
        "from": "[with patch, with positive review, needs rebase] make it so magma(A) works for matrices over cyclotomic number fields",
        "to": "[with patch, with positive review] make it so magma(A) works for matrices over cyclotomic number fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3040#event-10753"
}
```
