...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3711#issuecomment-28482",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3711#issuecomment-28483",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I add a selenium doctest for this (test_3711) which can be found at http://sage.math.washington.edu/home/mhansen/sage_selenium/test_notebook.py",
    "created_at": "2008-09-08T00:00:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3711#issuecomment-28484",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>I add a selenium doctest for this (test_3711) which can be found at http://sage.math.washington.edu/home/mhansen/sage_selenium/test_notebook.py
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3711#issuecomment-28485",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I didn't run the selenium doctest, but I did various file operations to make sure that the bug was resolved and that some new bug didn't pop up.",
    "created_at": "2008-09-08T11:30:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3711#issuecomment-28486",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```

<a id='comment:2'></a>I didn't run the selenium doctest, but I did various file operations to make sure that the bug was resolved and that some new bug didn't pop up.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3711#issuecomment-28487",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3711#issuecomment-28488",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
