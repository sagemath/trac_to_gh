# Issue 3711: [with patch, positive review] notebook -- folder of worksheets not properly saved
...
```json
{
    ...
    "title": "[with patch, positive review] notebook -- folder of worksheets not properly saved",
    "type": "issue",
