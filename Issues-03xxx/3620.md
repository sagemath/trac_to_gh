...
```json
{
    "body": "<a id='comment:1'></a>But note, we may want to use our own implementation since minpoly and charpoly of *matrices* over finite fields in sage is so fast.",
    "created_at": "2008-07-09T00:49:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26153",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>But note, we may want to use our own implementation since minpoly and charpoly of *matrices* over finite fields in sage is so fast.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26154",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26155",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26156",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26157",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26160",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>1. dmharvey -- i have no clue what the point of your remark is above.\n\n2. the point of my patch, by the way, is just to be a first tiny step.",
    "created_at": "2008-07-09T19:59:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26161",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:9'></a>1. dmharvey -- i have no clue what the point of your remark is above.
...
```json
{
    "body": "<a id='comment:10'></a>Looks good to me.  Should there be another ticket for improving this further.",
    "created_at": "2008-07-09T20:12:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26162",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:10'></a>Looks good to me.  Should there be another ticket for improving this further.
...
```json
{
    "body": "<a id='comment:11'></a>My point is just that computing the matrix and computing its charpoly both take non-negligble time.",
    "created_at": "2008-07-09T20:36:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26163",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:11'></a>My point is just that computing the matrix and computing its charpoly both take non-negligble time.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26164",
...
```json
{
    "body": "<a id='comment:12'></a>Merged in Sage 3.0.4.rc3",
    "created_at": "2008-07-10T02:01:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26165",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Merged in Sage 3.0.4.rc3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26166",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26167",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>It looks like NTL does have minimal polynomial computations, though provided in http://www.shoup.net/ntl/doc/GF2X.txt rather than http://www.shoup.net/ntl/doc/GF2E.txt . We should probably use the proof flag to decide the algorithm. Trace could be wrapped as well. \n\nAlso, the computation of matrix() is using the completely generic code, which has got to be sub-optimal for manipulating elements of GF(2).",
    "created_at": "2008-07-10T06:47:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26168",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:13'></a>It looks like NTL does have minimal polynomial computations, though provided in http://www.shoup.net/ntl/doc/GF2X.txt rather than http://www.shoup.net/ntl/doc/GF2E.txt . We should probably use the proof flag to decide the algorithm. Trace could be wrapped as well. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3620#issuecomment-26170",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
