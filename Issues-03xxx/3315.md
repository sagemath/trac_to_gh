...
```json
{
    "body": "<a id='comment:1'></a>See also #3313 for another input format parametric_plot should take: vectors.",
...
<a id='comment:1'></a>See also #3313 for another input format parametric_plot should take: vectors.
...
```json
{
    "body": "<a id='comment:2'></a>Really, parametric_plot should take functions returning any of the allowed types (tuple, list, or with #3313, vectors).",
...
<a id='comment:2'></a>Really, parametric_plot should take functions returning any of the allowed types (tuple, list, or with #3313, vectors).
...
<a id='comment:3'></a>Replying to [jason](#comment%3A1):
> See also #3313 for another input format parametric_plot should take: vectors.
