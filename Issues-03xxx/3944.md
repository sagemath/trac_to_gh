...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3944#issuecomment-29848",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3944#issuecomment-29849",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] replace \"sage -upgrade\" by \"sage -expert_upgrade\" and upgrade() by \"expert_upgrade()\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3944#event-14715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3944#issuecomment-29850",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3944",
    "rename": {
        "from": "[with patch; needs review] replace \"sage -upgrade\" by \"sage -expert_upgrade\" and upgrade() by \"expert_upgrade()\"",
        "to": "[with patch; positive review] replace \"sage -upgrade\" by \"sage -expert_upgrade\" and upgrade() by \"expert_upgrade()\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3944#event-14716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3944",
    "rename": {
        "from": "[with patch; positive review] replace \"sage -upgrade\" by \"sage -expert_upgrade\" and upgrade() by \"expert_upgrade()\"",
        "to": "[with patch; positive review; some debate] replace \"sage -upgrade\" by \"sage -expert_upgrade\" and upgrade() by \"expert_upgrade()\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3944#event-14717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3944#issuecomment-29851",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3944#issuecomment-29852",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3944",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3944#event-14718"
}
```
