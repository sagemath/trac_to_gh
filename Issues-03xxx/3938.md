...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29752",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29753",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29754",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] coercion framework converts built-in types to Sage types when it should not"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29755",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29756",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29757",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29758",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29759",
    "user": "https://trac.sagemath.org/admin/accounts/users/anakha"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "rename": {
        "from": "[with patch, needs review] coercion framework converts built-in types to Sage types when it should not",
        "to": "[with patch, positive review] coercion framework converts built-in types to Sage types when it should not"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14671"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29760",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "rename": {
        "from": "[with patch, positive review] coercion framework converts built-in types to Sage types when it should not",
        "to": "[with patch, needs work] coercion framework converts built-in types to Sage types when it should not"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "rename": {
        "from": "[with patch, needs work] coercion framework converts built-in types to Sage types when it should not",
        "to": "[with patch, needs review] coercion framework converts built-in types to Sage types when it should not"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14673"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29762",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29763",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] coercion framework converts built-in types to Sage types when it should not",
        "to": "[with patch, with positive review pending minor fixes] coercion framework converts built-in types to Sage types when it should not"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14674"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29764",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29765",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29766",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29767",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "rename": {
        "from": "[with patch, with positive review pending minor fixes] coercion framework converts built-in types to Sage types when it should not",
        "to": "[with patch, with positive review] coercion framework converts built-in types to Sage types when it should not"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29768",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29769",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14676"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3938#event-14677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29770",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3938",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3938#issuecomment-29771",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
