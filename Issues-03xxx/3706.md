...
```json
{
    ...
    "type": "issue",
    "updated_at": "2008-07-28T11:00:13Z",
    "url": "https://github.com/sagemath/sage/issues/3706",
...
```json
{
    ...
    "created_at": "2008-07-22T07:58:17Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "milestone_number": null,
    "milestone_title": "sage-3.0.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40533"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40536"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3706#issuecomment-20353",
...
```json
{
    "body": "<div id=\"comment:2\" align=\"right\">comment:2</div>\n\nAttachment: **[sage-3706.patch.gz](https://github.com/sagemath/sage/files/ticket3706/sage-3706.patch.gz)**",
    "created_at": "2008-07-25T19:44:43Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3706#issuecomment-20354",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40538"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40539"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40540"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3706#issuecomment-20355",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40541"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40542"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3706#issuecomment-20356",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
