...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] cygwin -- new givaro spkg that works around stupidity in cygwin",
        "to": "[with patch; positive review] cygwin -- new givaro spkg that works around stupidity in cygwin"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3230#event-11508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3230#issuecomment-23433",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3230",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3230#event-11509"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3230#issuecomment-23434",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3230#issuecomment-23435",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
