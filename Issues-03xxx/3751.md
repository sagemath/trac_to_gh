...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3751#issuecomment-28073",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Type of output returned by QuadraticField(-1).class_number()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3751#event-13832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3751#issuecomment-28074",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3751",
    "rename": {
        "from": "[with patch, needs review] Type of output returned by QuadraticField(-1).class_number()",
        "to": "[with patch, with positive review] Type of output returned by QuadraticField(-1).class_number()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3751#event-13833"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3751#issuecomment-28075",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3751",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3751#event-13834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3751#issuecomment-28076",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3751#event-13835"
}
```
