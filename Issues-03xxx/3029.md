...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21336",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    "body": "Description changed:\n```diff\n--- \n+++ \n@@ -1,7 +1,8 @@\n Debian doesn't allow you to upload packages that use DEB_AUTO_UPDATE_DEBIAN_CONTROL because it causes confusion with Non-Maintainer Uploads.  Since I'd like to get the packages so that they can be uploaded to Debian, we should remove it from our rules files.  Since it's fine for our purposes, I've modified sage-debsource to set DEB_AUTO_UPDATE_DEBIAN_CONTROL so that it always gets used when we are building packages.  I think it's probably easier for Michael to just make the changes than to merge N patches, so the following code will do the relevant update when the relevant spkgs are unpacked.\n \n+```\n perl -i -0pe 's/^DEB_AUTO_UPDATE_DEBIAN_CONTROL = 1\\n//m' */dist/debian/*/rules */dist/debian/rules\n-\n+```\n (if the patches are easier to deal with, let me know and I'll generate them)\n The complete list of spkgs that require this treatment is as follows:\n \n@@ -31,6 +32,7 @@\n tachyon\n zn_poly\n \n+\n Summary: [with patch; needs review] Move DEB_AUTO_UPDATE_DEBIAN_CONTROL out of Debian packages\n \n Issue created by migration from https://trac.sagemath.org/ticket/3029\n```\n",
    "created_at": "2008-04-26T04:24:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21337",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21338",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21339",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21340",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21341",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21342",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21343",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21344",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21345",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21346",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21347",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21348",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21349",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21350",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21351",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21352",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21353",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21354",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21355",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21356",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21357",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21358",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21359",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21360",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3029#issuecomment-21361",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
