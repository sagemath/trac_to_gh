...
archive/attachments_003527.json:
```json
{
...
```json
{
    "body": "**Attachment:** [kbessel_fixes.patch](https://github.com/sagemath/sage/files/ticket3426/kbessel_fixes.patch)",
    "created_at": "2008-06-14T22:10:30Z",
    "issue": "https://github.com/sagemath/sage/issues/3426",
    "type": "issue_comment",
...
**Attachment:** [kbessel_fixes.patch](https://github.com/sagemath/sage/files/ticket3426/kbessel_fixes.patch)
...
archive/attachments_003528.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:30'></a>\n**Attachment:** [trac3426-fix-bessel-fns.patch](https://github.com/sagemath/sage/files/ticket3426/trac3426-fix-bessel-fns.patch)\n\nOK, I've replaced my patch with one that fixes the issue reported by Dan.",
    "created_at": "2008-10-10T12:28:54Z",
    "issue": "https://github.com/sagemath/sage/issues/3426",
    "type": "issue_comment",
