...
```json
{
    "body": "<a id='comment:1'></a>The argument doesn't exist in symbolics, so I'm in favor of removal (and I have no idea what it does either)",
    "created_at": "2008-08-06T06:30:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29039",
    "user": "https://github.com/garyfurnish"
}
```

<a id='comment:1'></a>The argument doesn't exist in symbolics, so I'm in favor of removal (and I have no idea what it does either)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29040",
...
```json
{
    "body": "<a id='comment:2'></a>The argument was used to pass in additional variables to the variables method which would then be subsequently returned.  This functionality was never used, and I can't / couldn't think of a case where it would be needed.  So, I do think the correct fix is to remove it.  I've attached a patch which does that and passes tests.",
    "created_at": "2008-08-06T20:09:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29041",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>The argument was used to pass in additional variables to the variables method which would then be subsequently returned.  This functionality was never used, and I can't / couldn't think of a case where it would be needed.  So, I do think the correct fix is to remove it.  I've attached a patch which does that and passes tests.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29042",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [trac_3779.patch](tarball://root/attachments/some-uuid/ticket3779/trac_3779.patch) by @robertwb created at 2008-08-07 02:02:48\n\nLooks good to me, and fixes the bug. The only question I had is why you wrote tuple([]) rather than (), but I'm OK with that.",
    "created_at": "2008-08-07T02:02:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29043",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>Attachment [trac_3779.patch](tarball://root/attachments/some-uuid/ticket3779/trac_3779.patch) by @robertwb created at 2008-08-07 02:02:48
...
```json
{
    "body": "<a id='comment:4'></a>There's no real reason -- it's just what I happened to type :-)",
    "created_at": "2008-08-07T02:12:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29044",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>There's no real reason -- it's just what I happened to type :-)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29045",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29046",
...
```json
{
    "body": "<a id='comment:5'></a>Merged both patches in Sage 3.1.alpha1",
    "created_at": "2008-08-10T06:33:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3779#issuecomment-29047",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Merged both patches in Sage 3.1.alpha1
