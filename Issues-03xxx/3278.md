...
```json
{
    "body": "Attachment [3278.patch](https://github.com/sagemath/sage/files/ticket3278/3278.patch) by @mwhansen created at 2008-05-23 10:13:01",
    "created_at": "2008-05-23T10:13:01Z",
    "issue": "https://github.com/sagemath/sage/issues/3278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3278#issuecomment-18123",
    "user": "https://github.com/mwhansen"
}
```

Attachment [3278.patch](https://github.com/sagemath/sage/files/ticket3278/3278.patch) by @mwhansen created at 2008-05-23 10:13:01
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3278#issuecomment-18124",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3278#event-17538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3278#issuecomment-18125",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3278#event-17539"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3278#event-17540"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3278#issuecomment-18126",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3278#event-17541"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3278#event-17542"
}
```
