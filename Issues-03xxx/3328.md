...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3328/spkg-install.patch",
    "created_at": "2008-05-29T09:38:48Z",
    "issue": "https://github.com/sagemath/sage/issues/3328",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3328/spkg-install.patch",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Attachment [spkg-install.patch](https://github.com/sagemath/sage/files/ticket3328/spkg-install.patch) by @kiwifb created at 2008-05-29 09:38:48",
    "created_at": "2008-05-29T09:38:48Z",
    "issue": "https://github.com/sagemath/sage/issues/3328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3328#issuecomment-18468",
    "user": "https://github.com/kiwifb"
}
```

Attachment [spkg-install.patch](https://github.com/sagemath/sage/files/ticket3328/spkg-install.patch) by @kiwifb created at 2008-05-29 09:38:48
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3328/sage-env.patch",
    "created_at": "2008-05-29T09:39:18Z",
    "issue": "https://github.com/sagemath/sage/issues/3328",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3328/sage-env.patch",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    "body": "Attachment [sage-env.patch](https://github.com/sagemath/sage/files/ticket3328/sage-env.patch) by @kiwifb created at 2008-05-29 09:39:18",
    "created_at": "2008-05-29T09:39:18Z",
    "issue": "https://github.com/sagemath/sage/issues/3328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3328#issuecomment-18469",
    "user": "https://github.com/kiwifb"
}
```

Attachment [sage-env.patch](https://github.com/sagemath/sage/files/ticket3328/sage-env.patch) by @kiwifb created at 2008-05-29 09:39:18
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3328#issuecomment-18470",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3328#issuecomment-18471",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3328#issuecomment-18472",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
