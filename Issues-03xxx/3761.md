...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13870"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28137",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28138",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28139",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "rename": {
        "from": "[with patch; needs review] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
        "to": "[with patch; needs works] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28140",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "rename": {
        "from": "[with patch; needs works] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
        "to": "[with patch; needs work] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13872"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13873"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13874"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28141",
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13876"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28142",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "rename": {
        "from": "[with patch; needs work] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
        "to": "[with patch; needs review] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28143",
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
        "to": "[with patch; positive review pending trivial changes] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13879"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28144",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28145",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28146",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28147",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28148",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28149",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "rename": {
        "from": "[with patch; positive review pending trivial changes] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28150",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28151",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28152",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28153",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; positive review] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28154",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28155",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "rename": {
        "from": "[with patch; positive review] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
        "to": "[with patch; needs work] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28156",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28157",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs work] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
        "to": "[with patch; needs review for an epsilon] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13883"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28158",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28159",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28160",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "rename": {
        "from": "[with patch; needs review for an epsilon] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built",
        "to": "[with patch; positive review] warning when run sage binary if the processor instruction set doesn't support everything that was on the machine where sage was built"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28161",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3761#issuecomment-28162",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3761",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3761#event-13885"
}
```
