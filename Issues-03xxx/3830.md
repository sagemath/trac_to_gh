...
```json
{
    ...
    "rename": {
        "from": "plot(sin(1/x), (x,-1,3), foo=10) yields an error message about line, but should yield one about plot.",
        "to": "[with patch, needs review] plot(sin(1/x), (x,-1,3), foo=10) yields an error message about line, but should yield one about plot."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3830#event-14190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28687",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28688",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28689",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28690",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "rename": {
        "from": "[with patch, needs review] plot(sin(1/x), (x,-1,3), foo=10) yields an error message about line, but should yield one about plot.",
        "to": "[with patch, positive review] plot(sin(1/x), (x,-1,3), foo=10) yields an error message about line, but should yield one about plot."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3830#event-14191"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3830#event-14192"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28691",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28692",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3830#event-14193"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28693",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-28694",
    "user": "https://github.com/fchapoton"
}
```
