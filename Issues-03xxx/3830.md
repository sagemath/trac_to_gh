...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29443",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29444",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29445",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29446",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29447",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29448",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29449",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,8 +1,6 @@\n ```\n plot(sin(1/x), (x,-1,3), foo=10)\n ///\n-          \t\n-\n verbose 0 (1537: plot.py, options) WARNING: Ignoring option\n 'plot_division'=0\n verbose 0 (1537: plot.py, options) \n@@ -36,7 +34,8 @@\n AttributeError: Unknown property foo\n ```\n \n-The error that comes from line could just be very lightly wrapped in an error from plot that says plot error using the line command.  This could thus be almost trivially fixed.\n+The error that comes from line could just be very lightly wrapped in an error from plot that says plot error using the line command.  This could thus be almost trivially fixed. \n+\n \n Summary: plot(sin(1/x), (x,-1,3), foo=10) yields an error message about line, but should yield one about plot.\n \n``````\n",
    "created_at": "2015-09-06T16:20:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3830#issuecomment-29450",
    "user": "https://github.com/fchapoton"
}
```
