...
```json
{
    ...
    "rename": {
        "from": "K.gen() where K = GF(p) returns 1, not a primitive element",
        "to": "[with patch, needs review] K.gen() where K = GF(p) returns 1, not a primitive element"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3045#event-10770"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3045#issuecomment-22005",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3045#issuecomment-22006",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3045#issuecomment-22007",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3045#issuecomment-22008",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "rename": {
        "from": "[with patch, needs review] K.gen() where K = GF(p) returns 1, not a primitive element",
        "to": "[with patch, positive review] K.gen() where K = GF(p) returns 1, not a primitive element"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3045#event-10771"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3045#event-10772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3045#issuecomment-22009",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3045#event-10773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3045#issuecomment-22010",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
