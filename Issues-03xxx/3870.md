...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-37411"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-37412"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-37413"
}
```
...
```json
{
    "body": "Changed keywords from **** to **scipy**",
...
Changed keywords from **** to **scipy**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-37414"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3870",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-37415"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-37416"
}
```
