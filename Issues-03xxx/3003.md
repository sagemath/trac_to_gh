...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21675",
    "user": "https://github.com/jbandlow"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21676",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "rename": {
        "from": "Bugfix for to_tableau() method of CrystalOfTableaux elements (with patch; needs review)",
        "to": "[with patch, needs review] Bugfix for to_tableau() method of CrystalOfTableaux elements (with patch; needs review)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3003#event-10632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21677",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21678",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21679",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21680",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "rename": {
        "from": "[with patch, needs review] Bugfix for to_tableau() method of CrystalOfTableaux elements (with patch; needs review)",
        "to": "[with patch, positive review] Bugfix for to_tableau() method of CrystalOfTableaux elements (with patch; needs review)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3003#event-10633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21681",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3003#issuecomment-21682",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3003",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3003#event-10634"
}
```
