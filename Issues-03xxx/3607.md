# Issue 3607: [with patch, positive review] graph_isom.py: "Conditional jump or move depends on uninitialised value(s)"
...
```json
{
    ...
    "title": "[with patch, positive review] graph_isom.py: \"Conditional jump or move depends on uninitialised value(s)\"",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3607",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3607#event-8263"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3607#event-8264"
}
```
