...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-22998",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-22999",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-23000",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-23001",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22544"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac_3945.patch](https://github.com/sagemath/sage/files/ticket3945/trac_3945.patch) by @mwhansen created at 2008-10-12 19:01:24",
    "created_at": "2008-10-12T19:01:24Z",
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-23002",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "Attachment [trac_3945-2.patch](https://github.com/sagemath/sage/files/ticket3945/trac_3945-2.patch) by @mwhansen created at 2008-10-12 20:12:57",
    "created_at": "2008-10-12T20:12:57Z",
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-23003",
    "user": "https://github.com/mwhansen"
}
```

Attachment [trac_3945-2.patch](https://github.com/sagemath/sage/files/ticket3945/trac_3945-2.patch) by @mwhansen created at 2008-10-12 20:12:57
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22545"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-23004",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22547"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3945#issuecomment-23005",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22549"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3945#event-22550"
}
```
...
```json
{
    "body": "Attachment [trac_3945-3.patch](https://github.com/sagemath/sage/files/ticket3945/trac_3945-3.patch) by @mwhansen created at 2008-10-12 23:02:03",
    "created_at": "2008-10-12T23:02:03Z",
    "issue": "https://github.com/sagemath/sage/issues/3945",
    "type": "issue_comment",
...
Attachment [trac_3945-3.patch](https://github.com/sagemath/sage/files/ticket3945/trac_3945-3.patch) by @mwhansen created at 2008-10-12 23:02:03
