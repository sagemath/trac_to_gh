...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30096",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30098",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30099",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30100",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac_3893_args_kwds_for_random_element-rebased-to-4.5.3.alpha2.patch](tarball://root/attachments/some-uuid/ticket3893/trac_3893_args_kwds_for_random_element-rebased-to-4.5.3.alpha2.patch) by @malb created at 2010-08-24 15:18:04\n\nI rebased the patch to 4.5.3.alpha2 and ran long doctests: all passed. The patch also looks good, the only issue I'd have: I'd either move the lines \"Trac#3893 ...\" to the TESTS:: section or remove that line completely. I understand that people want to point out where something changed, but that docstring is saying nothing to a user since it is developer information.",
    "created_at": "2010-08-24T15:18:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30101",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>Attachment [trac_3893_args_kwds_for_random_element-rebased-to-4.5.3.alpha2.patch](tarball://root/attachments/some-uuid/ticket3893/trac_3893_args_kwds_for_random_element-rebased-to-4.5.3.alpha2.patch) by @malb created at 2010-08-24 15:18:04
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30102",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30103",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30104",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30105",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30106",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30107",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30108",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>rebased patch applies cleanly to 4.5.3; switching to positive review, as per Martin's recommendation",
    "created_at": "2010-09-21T17:47:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30109",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:6'></a>rebased patch applies cleanly to 4.5.3; switching to positive review, as per Martin's recommendation
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30111",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30112",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30113",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30114",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [trac_3893_args_kwds_for_random_element_4.6.alpha2.patch](tarball://root/attachments/some-uuid/ticket3893/trac_3893_args_kwds_for_random_element_4.6.alpha2.patch) by @nilesjohnson created at 2010-09-30 12:29:36\n\nIndeed; the interaction seems to be with #8955: after applying those patches, I get exactly the same doctest failures, with exactly the same \"Got\" output.  I just uploaded a fixed patch which passes all doctests after applying #8955.",
    "created_at": "2010-09-30T12:29:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30115",
    "user": "https://github.com/nilesjohnson"
}
```

<a id='comment:9'></a>Attachment [trac_3893_args_kwds_for_random_element_4.6.alpha2.patch](tarball://root/attachments/some-uuid/ticket3893/trac_3893_args_kwds_for_random_element_4.6.alpha2.patch) by @nilesjohnson created at 2010-09-30 12:29:36
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30116",
    "user": "https://github.com/nilesjohnson"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Martin, could you review the latest patch?  If it's OK, I'll merge it into 4.6.alpha3.",
    "created_at": "2010-10-03T09:30:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30117",
    "user": "https://github.com/qed777"
}
```

<a id='comment:10'></a>Martin, could you review the latest patch?  If it's OK, I'll merge it into 4.6.alpha3.
...
```json
{
    "body": "<a id='comment:11'></a>The updated patch applies with some fuzz, but it applies. Doctests pass. I trust only doctest failures were addressed and thus I give this a positive review.",
    "created_at": "2010-10-03T14:56:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30118",
    "user": "https://github.com/malb"
}
```

<a id='comment:11'></a>The updated patch applies with some fuzz, but it applies. Doctests pass. I trust only doctest failures were addressed and thus I give this a positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30119",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30120",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3893#issuecomment-30121",
    "user": "https://github.com/qed777"
}
```
