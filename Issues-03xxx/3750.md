...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28800",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28801",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I think that log should default to base 'e' as it does with all the other types.  Also both of them should probably take an optional number of bits of precision to use with the default being 53.",
    "created_at": "2008-10-24T03:30:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28802",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:2'></a>I think that log should default to base 'e' as it does with all the other types.  Also both of them should probably take an optional number of bits of precision to use with the default being 53.
...
```json
{
    "body": "<a id='comment:3'></a>Somebody should point out the exact_log function in this discussion since it is relevant to the original poster and is superfast:\n\n```\nsage: N = 8\nsage: N.exact_log(2)\n3\n```",
    "created_at": "2008-10-24T04:39:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28803",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Somebody should point out the exact_log function in this discussion since it is relevant to the original poster and is superfast:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28804",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28805",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>The patch now should deal with both of the reviewer's comments.",
    "created_at": "2008-10-26T00:17:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28806",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:5'></a>The patch now should deal with both of the reviewer's comments.
...
```json
{
    "body": "<a id='comment:7'></a>Hmm... there's an issue that before log(3) would just give log(3) since 3 is exact.  After the patch, log(3) will automatically give an approximation which probably isn't desired.",
    "created_at": "2008-10-26T00:24:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28807",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>Hmm... there's an issue that before log(3) would just give log(3) since 3 is exact.  After the patch, log(3) will automatically give an approximation which probably isn't desired.
...
```json
{
    "body": "<a id='comment:8'></a>Mike, Good point about log(3).  This should be dealt with the same way as with sqrt:\n\n```\nsage: 3.sqrt()\nsqrt(3)\nsage: 3.sqrt(prec=53)\n1.73205080756888\n```",
    "created_at": "2008-10-26T22:13:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28808",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:8'></a>Mike, Good point about log(3).  This should be dealt with the same way as with sqrt:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28810",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Nice work!  I'm pretty happy with how this turned out.",
    "created_at": "2008-11-04T21:42:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28811",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:10'></a>Nice work!  I'm pretty happy with how this turned out.
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [trac_3750-fix.patch](tarball://root/attachments/some-uuid/ticket3750/trac_3750-fix.patch) by @mwhansen created at 2008-11-06 12:49:30\n\nI've attached a patch which fixes the issue.",
    "created_at": "2008-11-06T12:49:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28813",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:12'></a>Attachment [trac_3750-fix.patch](tarball://root/attachments/some-uuid/ticket3750/trac_3750-fix.patch) by @mwhansen created at 2008-11-06 12:49:30
...
```json
{
    "body": "<a id='comment:13'></a>This works!  I was going to use q.is_power_of(q0), but as far as I can tell there isn't any meaningful difference between these solutions.  Use integer-log-exp-final.patch and trac_3750-fix.patch.  I assume I can review mhansen's fix; if not, my apologies.\n\nTo be honest, how was this working before, when the symbolic logs didn't have an integer_part() method to begin with?",
    "created_at": "2008-11-06T14:49:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28814",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:13'></a>This works!  I was going to use q.is_power_of(q0), but as far as I can tell there isn't any meaningful difference between these solutions.  Use integer-log-exp-final.patch and trac_3750-fix.patch.  I assume I can review mhansen's fix; if not, my apologies.
...
```json
{
    "body": "<a id='comment:14'></a>Merged integer-log-exp-final.patch and trac_3750-fix.patch in Sage 3.2.rc0.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-09T18:18:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28815",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:14'></a>Merged integer-log-exp-final.patch and trac_3750-fix.patch in Sage 3.2.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3750#issuecomment-28816",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
