# Issue 3907: [with patch, positive review] plot correctly up to asymptotes
...
```json
{
    ...
    "title": "[with patch, positive review] plot correctly up to asymptotes",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3907",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3907#event-8967"
}
```
