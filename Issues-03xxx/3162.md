...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3162#issuecomment-22451",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Also, I'm pretty sure that PARI does OK with echelon forms of matrices with high-precision entries, so one could look at that code...",
    "created_at": "2008-05-12T02:53:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3162#issuecomment-22453",
    "user": "https://github.com/NathanDunfield"
}
```

<a id='comment:2'></a>Also, I'm pretty sure that PARI does OK with echelon forms of matrices with high-precision entries, so one could look at that code...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3162#issuecomment-22454",
