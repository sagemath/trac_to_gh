...
```json
{
    ...
    "asset_name": "prob-sol.sobj",
    "asset_url": "tarball://root/attachments/ticket3162/prob-sol.sobj",
    "created_at": "2008-05-12T00:52:41Z",
    "issue": "https://github.com/sagemath/sage/issues/3162",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3162/prob-sol.sobj",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "Attachment [prob-sol.sobj](https://github.com/sagemath/sage/files/ticket3162/prob-sol.sobj) by @NathanDunfield created at 2008-05-12 00:52:41\n\nProblem matrix",
    "created_at": "2008-05-12T00:52:41Z",
    "issue": "https://github.com/sagemath/sage/issues/3162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3162#issuecomment-17541",
    "user": "https://github.com/NathanDunfield"
}
```

Attachment [prob-sol.sobj](https://github.com/sagemath/sage/files/ticket3162/prob-sol.sobj) by @NathanDunfield created at 2008-05-12 00:52:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3162#issuecomment-17542",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3162#issuecomment-17543",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16805"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16806"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16807"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16808"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16809"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16810"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16811"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16812"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16813"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16814"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3162#event-16815"
}
```
