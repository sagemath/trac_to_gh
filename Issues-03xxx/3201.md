...
<a id='comment:1'></a>I can confirm that this sort of bug is very likely to happen.  I think \ parsing
gets done before the code gets sent to latex.eval or something like that.  It's an
interesting bug, and definitely something that needs to get fixed.
...
<a id='comment:2'></a>This is caused by the line
...
```json
{
    "body": "<a id='comment:4'></a>Note that this patch depends on #5050.",
...
<a id='comment:4'></a>Note that this patch depends on #5050.
...
```json
{
    "body": "<a id='comment:5'></a>The patch works for me.  Where is the doctest?",
...
<a id='comment:5'></a>The patch works for me.  Where is the doctest?
...
```json
{
    "body": "<a id='comment:6'></a>I don't know a good way to add a doctest.  I've added a test to Selenium test suite.",
...
<a id='comment:6'></a>I don't know a good way to add a doctest.  I've added a test to Selenium test suite.
...
```json
{
    "body": "<a id='comment:7'></a>Positive review even though this skirts the doctesting rule.\n\nCheers,\n\nMichael",
...
<a id='comment:7'></a>Positive review even though this skirts the doctesting rule.
