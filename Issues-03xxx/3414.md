...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32812"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32813"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32814"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32815"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3414",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3414#issuecomment-19252",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32817"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32818"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32819"
}
```
