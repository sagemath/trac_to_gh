...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32143"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3414",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32144"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3414#event-32145"
}
```
