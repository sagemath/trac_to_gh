...
```json
{
    "body": "<a id='comment:1'></a>\nThe output of --gdb --verbose doctesting of that file\n\n```\nTrying:\n    M.eisenstein_submodule().hecke_bound()###line 311:_sage_    >>> M.eisenstein_submodule().hecke_bound()\nExpecting:\n    53\n\nProgram received signal SIGILL, Illegal instruction.\n[Switching to Thread 182894175264 (LWP 18352)]\n0x0000002aa1a61dd8 in ZmodF_poly_pointwise_mul () from /u/was/sage-3.0.4.rc1/local/lib/libflint-1.010.so\n(gdb) bt\n#0  0x0000002aa1a61dd8 in ZmodF_poly_pointwise_mul () from /u/was/sage-3.0.4.rc1/local/lib/libflint-1.010.so\n#1  0x0000002aa1a697ea in ZmodF_poly_convolution () from /u/was/sage-3.0.4.rc1/local/lib/libflint-1.010.so\n#2  0x0000002aa1a49d4e in `_fmpz_poly_mul_`SS () from /u/was/sage-3.0.4.rc1/local/lib/libflint-1.010.so\n#3  0x0000002aa1906fa2 in `__pyx_f_`4sage_5rings_10polynomial_30polynomial_integer_dense_flint_30Polynomial_integer_dense_flint__mul_c_impl (__pyx_v_self=0x2aad241fa0, `__pyx_v_`right=0x2aad241fa0) at sage/rings/polynomial/polynomial_integer_dense_flint.cpp:6925\n#4  0x0000002a9c101ce8 in `__pyx_pf_`4sage_9structure_7element_11RingElement___mul__ (__pyx_v_self=0x2aad241fa0,\n    `__pyx_v_`right=0x2aad241fa0) at sage/structure/element.c:16532\n#5  0x0000000000416007 in binary_op1 (v=Variable \"v\" is not available.\n) at Objects/abstract.c:398\n#6  0x0000000000417ff8 in PyNumber_Multiply (v=0x2aad241fa0, w=0x2aad241fa0) at Objects/abstract.c:669\n#7  0x0000002aa167b53e in `__pyx_f_`4sage_5rings_10polynomial_19polynomial_compiled_6sqr_pd_eval (__pyx_v_self=0x2aaef3a310,\n    `__pyx_v_`vars=Variable \"__pyx_v_vars\" is not available.\n) at sage/rings/polynomial/polynomial_compiled.c:2730\n#8  0x0000002aa167afff in `__pyx_f_`4sage_5rings_10polynomial_19polynomial_compiled_6mul_pd_eval (__pyx_v_self=0x2aaef40170,\n    `__pyx_v_`vars=0x2aad241e50, `__pyx_v_`coeffs=0x27f0710) at sage/rings/polynomial/polynomial_compiled.c:1887\n#9  0x0000002aa167f119 in `__pyx_f_`4sage_5rings_10polynomial_19polynomial_compiled_26CompiledPolynomialFunction_eval (\n    `__pyx_v_`self=0x2aae528c20, `__pyx_v_`x=Variable \"__pyx_v_x\" is not available.\n) at sage/rings/polynomial/polynomial_compiled.c:1887\n#10 0x0000002aa154fce8 in `__pyx_pf_`4sage_5rings_10polynomial_18polynomial_element_10Polynomial___call__ (__pyx_v_self=0x2aad241c90,\n    `__pyx_`args=0x2aae528c20, `__pyx_`kwds=Variable \"__pyx_kwds\" is not available.\n) at sage/rings/polynomial/polynomial_element.c:4565\n#11 0x00000000004197c3 in PyObject_Call (func=Variable \"func\" is not available.\n) at Objects/abstract.c:1861\n#12 0x0000002aa78fa7b4 in `__pyx_pf_`4sage_6matrix_21matrix_rational_dense_21Matrix_rational_dense_charpoly (\n    `__pyx_v_`self=0x2aaef361a0, `__pyx_`args=Variable \"__pyx_args\" is not available.\n) at sage/matrix/matrix_rational_dense.c:7735\n#13 0x000000000048aa9c in PyEval_EvalFrameEx (f=0x2497ac0, throwflag=Variable \"throwflag\" is not available.\n) at Python/ceval.c:3573\n#14 0x000000000048c371 in PyEval_EvalCodeEx (co=0x2aa863e648, globals=Variable \"globals\" is not available.\n) at Python/ceval.c:2836\n#15 0x000000000048a5da in PyEval_EvalFrameEx (f=0x276dd80, throwflag=Variable \"throwflag\" is not available.\n) at Python/ceval.c:3668\n#16 0x000000000048c371 in PyEval_EvalCodeEx (co=0x2aa86326c0, globals=Variable \"globals\" is not available.\n\n```",
    "created_at": "2008-07-09T18:51:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3627#issuecomment-29497",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3627#issuecomment-29498",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3627#issuecomment-29499",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3627#issuecomment-29500",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3627#issuecomment-29501",
    "user": "https://github.com/williamstein"
}
```
