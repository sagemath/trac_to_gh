...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3858/ref.patch",
    "created_at": "2008-08-14T22:08:32Z",
    "issue": "https://github.com/sagemath/sage/issues/3858",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3858/ref.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [ref.patch](https://github.com/sagemath/sage/files/ticket3858/ref.patch) by mabshoff created at 2008-08-14 22:08:32\n\nHi John,\n\nthanks a lot for doing this. Usually we end up doing this at the last minute, so thanks again :)\n\nCheers,\n\nMichael",
    "created_at": "2008-08-14T22:08:32Z",
    "issue": "https://github.com/sagemath/sage/issues/3858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3858#issuecomment-22253",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3858#issuecomment-22254",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3858#event-21854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3858#issuecomment-22255",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3858#event-21855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3858",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3858#event-21856"
}
```
