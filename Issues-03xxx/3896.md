...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37687"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37690"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37691"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37692"
}
```
...
```json
{
    ...
    "title_was": "[with spkg, patch - needs review] Upgrade Cython to 0.9.8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3896",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-37696"
}
```
