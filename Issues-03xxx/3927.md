...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29640",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patches, needs review] Factorization class has no division implemented"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3927#event-14610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29641",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3927#event-14611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29642",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "rename": {
        "from": "[with patches, needs review] Factorization class has no division implemented",
        "to": "[with new patch, needs review] Several enhancements and bug fixes for Factorization class"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3927#event-14612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "rename": {
        "from": "[with new patch, needs review] Several enhancements and bug fixes for Factorization class",
        "to": "[with new patch, positive review] Several enhancements and bug fixes for Factorization class"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3927#event-14613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29643",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29644",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29645",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3927#event-14614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29646",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3927#issuecomment-29647",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
