...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3561#issuecomment-26474",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] make it so sage does *not* import numpy by default on startup."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3561#event-12988"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3561",
    "rename": {
        "from": "[with patch; needs review] make it so sage does *not* import numpy by default on startup.",
        "to": "[with patch; positive review] make it so sage does *not* import numpy by default on startup."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3561#event-12989"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3561#issuecomment-26475",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3561",
    "rename": {
        "from": "[with patch; positive review] make it so sage does *not* import numpy by default on startup.",
        "to": "[with patch; positive review] make it so sage does *not* import numpy by default on startup in totallyreal_data.pyx."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3561#event-12990"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3561#issuecomment-26476",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3561",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3561#event-12991"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3561#issuecomment-26477",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
