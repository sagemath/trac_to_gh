...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30187",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30188",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30189",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30190",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [pickle_jar.tar.bz2](tarball://root/attachments/some-uuid/ticket3900/pickle_jar.tar.bz2) by @williamstein created at 2008-10-23 21:27:11",
    "created_at": "2008-10-23T21:27:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30191",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Attachment [pickle_jar.tar.bz2](tarball://root/attachments/some-uuid/ticket3900/pickle_jar.tar.bz2) by @williamstein created at 2008-10-23 21:27:11
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30192",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Sorry for the noise.\n\nNow I put in the correct file and all's well\n\n\n```\n[jaap@paix sage-3.2.rc1]$ ./sage -t  devel/sage/sage/structure/sage_object.pyx\nsage -t  devel/sage/sage/structure/sage_object.pyx          \n\t [6.6 s]\n \n----------------------------------------------------------------------\nAll tests passed!\n\nSo positive review.\n\n\n```",
    "created_at": "2008-11-18T15:42:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30194",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:7'></a>Sorry for the noise.
...
```json
{
    "body": "<a id='comment:8'></a>We need to deal with -sdist and -bdist copying pickle_jar.tar.bz2. One way to do this would be to check the file into the repo, but that seems like a bad idea. \n\nThoughts?\n\nCheers,\n\nMichael",
    "created_at": "2008-11-18T18:11:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30195",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>We need to deal with -sdist and -bdist copying pickle_jar.tar.bz2. One way to do this would be to check the file into the repo, but that seems like a bad idea. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30197",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>On closer inspection: we don't even have to check in the pickle jar into the ext repo, so I will just put it in there.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-19T21:34:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30198",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>On closer inspection: we don't even have to check in the pickle jar into the ext repo, so I will just put it in there.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30199",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Merged in Sage 3.2.rc2",
    "created_at": "2008-11-19T21:43:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3900#issuecomment-30200",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Merged in Sage 3.2.rc2
