...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [matrix_modn_dense_hash.patch](https://github.com/sagemath/sage/files/ticket3956/matrix_modn_dense_hash.patch) by @malb created at 2008-08-26 14:53:18\n\nThe attached patch speeds up hashing a bit. However, GF(2) speed is not achievable for e.g. GF(3) since the matrices are not packed. I didn't improve `randomize` since that one could be slightly more tricky.",
    "created_at": "2008-08-26T14:53:18Z",
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23080",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23081",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23082",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23083",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23084",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23085",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23086",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3956#issuecomment-23087",
...
```json
{
    "body": "Attachment [matrix_modn_dense_hash.3.patch](https://github.com/sagemath/sage/files/ticket3956/matrix_modn_dense_hash.3.patch) by @malb created at 2008-08-27 20:54:35",
    "created_at": "2008-08-27T20:54:35Z",
    "issue": "https://github.com/sagemath/sage/issues/3956",
    "type": "issue_comment",
...
Attachment [matrix_modn_dense_hash.3.patch](https://github.com/sagemath/sage/files/ticket3956/matrix_modn_dense_hash.3.patch) by @malb created at 2008-08-27 20:54:35
