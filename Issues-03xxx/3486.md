...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33758"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33759"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33760"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3486#issuecomment-19774",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33762"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33764"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-33765"
}
```
