...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3486#issuecomment-26542",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This problem turned out to be a NFS problem. gcc 4.3.x just triggered the error that has always been on that machine since `#if ` now produces an error.\n\nCheers,\n\nMichael",
    "created_at": "2008-06-26T03:50:16Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3486#issuecomment-26543",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This problem turned out to be a NFS problem. gcc 4.3.x just triggered the error that has always been on that machine since `#if ` now produces an error.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3486#issuecomment-26544",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
