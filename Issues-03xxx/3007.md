...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22320",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22321",
...
```json
{
    "body": "<a id='comment:2'></a>The following works except that it's not properly offset, i.e. you have to hit space a few times before you find the documentation for `Factorization`.\n\n```\nsage: gap.Factorization?\nType:\t\tGapFunction\nBase Class:\t<class 'sage.interfaces.gap.GapFunction'>\nString Form:\tFactorization\nNamespace:\tInteractive\nLoaded File:\t/Users/gvol/SageStuff/sage-5.0.rc0/local/lib/python2.7/site-packages/sage/interfaces/gap.py\nSource File:\t/Users/gvol/SageStuff/sage-5.0.rc0/devel/sage/sage/interfaces/gap.py\nDefinition:\tgap.Factorization(self, *args, **kwds)\nDocstring:\n    Help: several entries match this topic - type ?2 to get match [2]\n    \n    [1] Reference: factorization\n    [2] Reference: Factorization\n\nCall def:\tgap.Factorization(self, *args, **kwds)\n\nCall docstring:\n    x.__init__(...) initializes x; see help(type(x)) for signature\n\n\nsage: gap.\"2\"?\n...the real documentation...\n```",
    "created_at": "2012-06-05T18:47:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22322",
    "user": "https://github.com/gvol"
}
```

<a id='comment:2'></a>The following works except that it's not properly offset, i.e. you have to hit space a few times before you find the documentation for `Factorization`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22323",
    "user": "https://github.com/gvol"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This has been fixed in 5.7.",
    "created_at": "2013-03-10T22:24:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22324",
    "user": "https://github.com/gvol"
}
```

<a id='comment:3'></a>This has been fixed in 5.7.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22325",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22326",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3007#issuecomment-22327",
