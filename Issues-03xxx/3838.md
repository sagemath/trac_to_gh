...
archive/attachments_004130.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [RElementAccess.patch](https://github.com/sagemath/sage/files/ticket3838/RElementAccess.patch)",
    "created_at": "2008-08-13T17:29:16Z",
    "issue": "https://github.com/sagemath/sage/issues/3838",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [RElementAccess2.patch](https://github.com/sagemath/sage/files/ticket3838/RElementAccess2.patch)\n\nCorrection for the first patch",
    "created_at": "2008-08-13T20:00:50Z",
    "issue": "https://github.com/sagemath/sage/issues/3838",
    "type": "issue_comment",
...
**Attachment:** [RElementAccess2.patch](https://github.com/sagemath/sage/files/ticket3838/RElementAccess2.patch)
...
```json
{
    "body": "**Attachment:** [RElementAccess3.patch](https://github.com/sagemath/sage/files/ticket3838/RElementAccess3.patch)\n\nTo be applied after the two previous patches",
    "created_at": "2008-08-14T06:53:45Z",
    "issue": "https://github.com/sagemath/sage/issues/3838",
    "type": "issue_comment",
...
**Attachment:** [RElementAccess3.patch](https://github.com/sagemath/sage/files/ticket3838/RElementAccess3.patch)
...
```json
{
    "body": "**Attachment:** [RElementAccessNew.patch](https://github.com/sagemath/sage/files/ticket3838/RElementAccessNew.patch)\n\nReplaces all previous patches",
    "created_at": "2008-08-14T07:17:12Z",
    "issue": "https://github.com/sagemath/sage/issues/3838",
    "type": "issue_comment",
...
**Attachment:** [RElementAccessNew.patch](https://github.com/sagemath/sage/files/ticket3838/RElementAccessNew.patch)
