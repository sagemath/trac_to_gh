...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24275",
...
```json
{
    "body": "<a id='comment:3'></a>What should we do with this ticket? I vote for closing as wontfix since it would be strange to add a jacob method again with a deprecation warning, wouldn't it?",
    "created_at": "2008-08-18T17:46:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24277",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>What should we do with this ticket? I vote for closing as wontfix since it would be strange to add a jacob method again with a deprecation warning, wouldn't it?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24279",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24280",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The patch implements Kiran's request.",
    "created_at": "2008-08-27T22:57:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24281",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:6'></a>The patch implements Kiran's request.
...
```json
{
    "body": "<a id='comment:8'></a>This function should not be implemented for `sage.rings.polynomial.multi_polynomial_libsingular.MPolynomial_libsingular` but for `sage.rings.polynomial.multi_polynomial.MPolynomial`. The former inherits from the later. I suppose that'd also mean to move `gradient` to `MPolynomial`.",
    "created_at": "2008-08-27T23:39:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24282",
    "user": "https://github.com/malb"
}
```

<a id='comment:8'></a>This function should not be implemented for `sage.rings.polynomial.multi_polynomial_libsingular.MPolynomial_libsingular` but for `sage.rings.polynomial.multi_polynomial.MPolynomial`. The former inherits from the later. I suppose that'd also mean to move `gradient` to `MPolynomial`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24283",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Ah, I thought this might come up.  I have replaced the patch with a new one, where I have put a very simple-minded gradient() function in MPolynomial, but it is of course quite a bit slower than the specialized one for MPolynomial_libsingular, so I don't want to remove the latter.  The function jacobian_ideal() is now in MPolynomial.\n\nBTW, if anyone has ideas on how to make the generic gradient() faster in MPolynomial, I would happily implement them.",
    "created_at": "2008-08-28T03:40:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24284",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:9'></a>Ah, I thought this might come up.  I have replaced the patch with a new one, where I have put a very simple-minded gradient() function in MPolynomial, but it is of course quite a bit slower than the specialized one for MPolynomial_libsingular, so I don't want to remove the latter.  The function jacobian_ideal() is now in MPolynomial.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24285",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24286",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Merged in Sage 3.1.2.alpha2",
    "created_at": "2008-08-28T12:00:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3253#issuecomment-24287",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged in Sage 3.1.2.alpha2
