...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3463#issuecomment-25688",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3463#issuecomment-25689",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3463#issuecomment-25690",
    "user": "https://trac.sagemath.org/admin/accounts/users/TimothyClemans"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, not ready for review] notebook -- create a resource folder and move AnonymousToplevel to it"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3463#event-12530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3463#issuecomment-25691",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3463#issuecomment-25692",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3463",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3463#event-12531"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3463#event-12532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3463",
    "rename": {
        "from": "[with patch, not ready for review] notebook -- create a resource folder and move AnonymousToplevel to it",
        "to": "notebook -- create a resource folder and move AnonymousToplevel to it"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3463#event-12533"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3463#issuecomment-25693",
