...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Some elliptic curve doctests fail when the optional database is installed"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3793#event-14020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3793#issuecomment-28403",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3793#event-14021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "rename": {
        "from": "[with patch, needs review] Some elliptic curve doctests fail when the optional database is installed",
        "to": "[with patch, with positive review] Some elliptic curve doctests fail when the optional database is installed"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3793#event-14022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3793#issuecomment-28404",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3793#issuecomment-28405",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3793#issuecomment-28406",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3793#event-14023"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3793#issuecomment-28407",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3793#issuecomment-28408",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
