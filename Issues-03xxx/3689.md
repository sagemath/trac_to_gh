...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3689#issuecomment-28264",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Oops, tried to update the wrong patch.  You just want the examples-shebang.patch.\nAlong with applying that patch, one should run\n\n```\nrmdir misc\n```\nfrom the root of the examples spkg.  The /usr/bin/env/sage issues have already been fixed.",
    "created_at": "2009-04-26T05:24:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3689#issuecomment-28265",
    "user": "https://github.com/timabbott"
}
```

<a id='comment:1'></a>Oops, tried to update the wrong patch.  You just want the examples-shebang.patch.
Along with applying that patch, one should run
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3689#issuecomment-28267",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3689#issuecomment-28268",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3689#issuecomment-28269",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/3689#issuecomment-28270",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
