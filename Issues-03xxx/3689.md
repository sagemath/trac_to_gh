...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3689/sage_scripts-shebang.patch",
    "created_at": "2009-04-26T05:20:33Z",
    "issue": "https://github.com/sagemath/sage/issues/3689",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3689/sage_scripts-shebang.patch",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    "body": "Attachment [sage_scripts-shebang.patch](https://github.com/sagemath/sage/files/ticket3689/sage_scripts-shebang.patch) by @timabbott created at 2009-04-26 05:20:33",
    "created_at": "2009-04-26T05:20:33Z",
    "issue": "https://github.com/sagemath/sage/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3689#issuecomment-21102",
    "user": "https://github.com/timabbott"
}
```

Attachment [sage_scripts-shebang.patch](https://github.com/sagemath/sage/files/ticket3689/sage_scripts-shebang.patch) by @timabbott created at 2009-04-26 05:20:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3689#issuecomment-21103",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3689#issuecomment-21104",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3689#issuecomment-21105",
    "user": "https://github.com/maxthemouse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3689#issuecomment-21106",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3689#issuecomment-21107",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
