...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3822/sage.patch",
    "created_at": "2008-08-12T20:31:08Z",
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3822/sage.patch",
    "user": "https://github.com/itolkov"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [sage.patch](https://github.com/sagemath/sage/files/ticket3822/sage.patch) by @itolkov created at 2008-08-12 20:31:08\n\n1. Changed default step size from 1 to such that there are 500 steps\n   2. `(a, b)` is now equivalent to `slider(a, b)`",
    "created_at": "2008-08-12T20:31:08Z",
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21991",
    "user": "https://github.com/itolkov"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21992",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3822/sage2.2.patch",
    "created_at": "2008-08-14T19:06:58Z",
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3822/sage2.2.patch",
    "user": "https://github.com/itolkov"
}
```
...
```json
{
    "body": "Attachment [sage2.2.patch](https://github.com/sagemath/sage/files/ticket3822/sage2.2.patch) by @itolkov created at 2008-08-14 19:06:58\n\nApply after sage.patch",
    "created_at": "2008-08-14T19:06:58Z",
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21993",
    "user": "https://github.com/itolkov"
}
```

Attachment [sage2.2.patch](https://github.com/sagemath/sage/files/ticket3822/sage2.2.patch) by @itolkov created at 2008-08-14 19:06:58
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21994",
    "user": "https://github.com/itolkov"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21995",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3822/sage-3822.patch",
    "created_at": "2008-08-15T10:02:34Z",
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3822/sage-3822.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [sage-3822.patch](https://github.com/sagemath/sage/files/ticket3822/sage-3822.patch) by @williamstein created at 2008-08-15 10:02:34",
    "created_at": "2008-08-15T10:02:34Z",
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21996",
    "user": "https://github.com/williamstein"
}
```

Attachment [sage-3822.patch](https://github.com/sagemath/sage/files/ticket3822/sage-3822.patch) by @williamstein created at 2008-08-15 10:02:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21997",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3822#issuecomment-21998",
