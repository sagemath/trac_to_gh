...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2734#event-25057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2734#event-25058"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2734#event-25059"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2734#event-25060"
}
```
