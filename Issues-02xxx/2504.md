...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2504#issuecomment-17728",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] number field .units() method caches proof=False result and returns it for proof=True"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2504#event-8816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2504#issuecomment-17729",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2504#issuecomment-17730",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2504",
    "rename": {
        "from": "[with patch, needs review] number field .units() method caches proof=False result and returns it for proof=True",
        "to": "[with patch, with positive review] number field .units() method caches proof=False result and returns it for proof=True"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2504#event-8817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2504#issuecomment-17731",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2504#issuecomment-17732",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2504",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2504#event-8818"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2504#issuecomment-17733",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
