...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2156#issuecomment-11061",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2156#issuecomment-11062",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2156#issuecomment-11063",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2156#issuecomment-11064",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [2156-tripledict.patch](https://github.com/sagemath/sage/files/ticket2156/2156-tripledict.patch) by @robertwb created at 2008-02-14 18:29:51\n\nI've uploaded a new spkg with a lowercase 'c' to the same directory as before. With the attached patch, things should work fine.",
    "created_at": "2008-02-14T18:29:51Z",
    "issue": "https://github.com/sagemath/sage/issues/2156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2156#issuecomment-11065",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2156#issuecomment-11066",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
