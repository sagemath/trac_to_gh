# Issue 2230: [with patch, with positive review] sage-2.10.2.alpha1 -- linear algebra hash not implemented
...
```json
{
    ...
    "title": "[with patch, with positive review] sage-2.10.2.alpha1 -- linear algebra hash not implemented",
    "type": "issue",
