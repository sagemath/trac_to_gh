...
```json
{
    "body": "<a id='comment:1'></a>I think this may be a subtlety having to do with Python comparison (although I'm tempted to call it a bug, maybe \"subtlety\" is more P.C.). The funny thing is if you define the method\n\n```\ndef __ne__(self, other):\n    return (not (self == other))\n```\nyou get the correct behavior. Before making a patch, it might be good to figure out why this is the case...",
    "created_at": "2008-03-14T00:45:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2506#issuecomment-18278",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:1'></a>I think this may be a subtlety having to do with Python comparison (although I'm tempted to call it a bug, maybe "subtlety" is more P.C.). The funny thing is if you define the method
...
```json
{
    "body": "<a id='comment:2'></a>The correct behavior is the following:\n\n```\nsage: g = Graph()\nsage: g2 = g.copy()\nsage: g == g\nTrue\nsage: g != g\nFalse\nsage: g2 == g\nTrue\nsage: g2 != g\nFalse\nsage: g is g\nTrue\nsage: g2 is g\nFalse\n```",
    "created_at": "2008-03-14T00:46:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2506#issuecomment-18279",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:2'></a>The correct behavior is the following:
...
```json
{
    "body": "<a id='comment:4'></a>Aparently, to have proper behavior, we do have to implement the `__ne__` method:\n\nhttp://www.voidspace.org.uk/python/articles/comparison.shtml",
    "created_at": "2008-03-14T13:39:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2506#issuecomment-18280",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>Aparently, to have proper behavior, we do have to implement the `__ne__` method:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2506#issuecomment-18281",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Patch looks good to me and fixes the bug.",
    "created_at": "2008-03-14T14:15:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2506#issuecomment-18282",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Patch looks good to me and fixes the bug.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2506#issuecomment-18283",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2506#issuecomment-18284",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
