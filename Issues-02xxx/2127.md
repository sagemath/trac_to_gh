...
```json
{
    ...
    "asset_name": "linboxdet.1.patch",
    "asset_url": "tarball://root/attachments/ticket2127/linboxdet.1.patch",
    "created_at": "2008-02-09T15:00:40Z",
    "issue": "https://github.com/sagemath/sage/issues/2127",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2127/linboxdet.1.patch",
    "user": "https://github.com/ClementPernet"
}
```
...
```json
{
    "body": "**Attachment:** [linboxdet.1.patch](https://github.com/sagemath/sage/files/ticket2127/linboxdet.1.patch)\n\n**Attachment:** [linboxdet.2.patch](https://github.com/sagemath/sage/files/ticket2127/linboxdet.2.patch)\n\nChange the wrapper for linbox rank and det to use Modular<double> (fixes a bug) and add appropriate delete.",
    "created_at": "2008-02-09T15:00:40Z",
    "issue": "https://github.com/sagemath/sage/issues/2127",
    "type": "issue_comment",
...
**Attachment:** [linboxdet.1.patch](https://github.com/sagemath/sage/files/ticket2127/linboxdet.1.patch)
...
```json
{
    "body": "**Attachment:** [linboxdet.3.patch](https://github.com/sagemath/sage/files/ticket2127/linboxdet.3.patch)\n\nUpdated patch for rank/det wrapping of ffpack",
    "created_at": "2008-02-16T23:26:39Z",
    "issue": "https://github.com/sagemath/sage/issues/2127",
    "type": "issue_comment",
...
**Attachment:** [linboxdet.3.patch](https://github.com/sagemath/sage/files/ticket2127/linboxdet.3.patch)
...
```json
{
    "body": "**Attachment:** [8338.patch](https://github.com/sagemath/sage/files/ticket2127/8338.patch)\n\nfix the last doctest failure with det over nonprime modular rings.",
    "created_at": "2008-02-17T02:07:24Z",
    "issue": "https://github.com/sagemath/sage/issues/2127",
    "type": "issue_comment",
...
**Attachment:** [8338.patch](https://github.com/sagemath/sage/files/ticket2127/8338.patch)
...
```json
{
    "body": "<a id='comment:9'></a>\n**Attachment:** [8339.patch](https://github.com/sagemath/sage/files/ticket2127/8339.patch)",
    "created_at": "2008-02-17T02:18:02Z",
    "issue": "https://github.com/sagemath/sage/issues/2127",
    "type": "issue_comment",
