...
```json
{
    ...
    "rename": {
        "from": "followup to #1983 -- 0^0 for 0 a rational",
        "to": "[with patch; needs review] followup to #1983 -- 0^0 for 0 a rational"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2057#event-7041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2057#issuecomment-13902",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2057",
    "rename": {
        "from": "[with patch; needs review] followup to #1983 -- 0^0 for 0 a rational",
        "to": "[with patch; positive review] followup to #1983 -- 0^0 for 0 a rational"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2057#event-7042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2057#issuecomment-13903",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2057#issuecomment-13904",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2057",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2057#event-7043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2057",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2057#issuecomment-13905",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
