...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2615#event-9232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2615#issuecomment-18817",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] wish: compute the jordan basis together with the jordan canonical form"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2615#event-9233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2615#issuecomment-18818",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2615#issuecomment-18819",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2615#event-9234"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2615#event-9235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "rename": {
        "from": "[with patch, needs review] wish: compute the jordan basis together with the jordan canonical form",
        "to": "[with patch, needs review] compute the jordan basis together with the jordan canonical form"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2615#event-9236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2615#issuecomment-18820",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2615#issuecomment-18821",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "rename": {
        "from": "[with patch, needs review] compute the jordan basis together with the jordan canonical form",
        "to": "[with patch, positive review] compute the jordan basis together with the jordan canonical form"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2615#event-9237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2615#event-9238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2615#issuecomment-18822",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2615#issuecomment-18823",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
