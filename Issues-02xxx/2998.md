...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31898"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31901"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31902"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2998#issuecomment-15671",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2998",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31905"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-31906"
}
```
