# Issue 2190: [with bundle, positive review] implement a ZZ-module saturation algorithm: this is the key thing needed to compute kernels over ZZ, etc.
...
```json
{
    ...
    "title": "[with bundle, positive review] implement a ZZ-module saturation algorithm: this is the key thing needed to compute kernels over ZZ, etc.",
    "type": "issue",
