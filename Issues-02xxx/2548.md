...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2548#issuecomment-17832",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2548#issuecomment-17833",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2548#issuecomment-17834",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2548#issuecomment-17835",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I think the answer to the posters's question is -- use the \"function\" function:\n\n```\nsage: var('x,y')\n(x, y)\nsage: f = (x^2 + y^2).function(x,y)\nsage: f\n(x, y) |--> y^2 + x^2\n```",
    "created_at": "2008-03-16T20:47:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2548#issuecomment-17836",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>I think the answer to the posters's question is -- use the "function" function:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2548#issuecomment-17837",
    "user": "https://github.com/williamstein"
}
```
