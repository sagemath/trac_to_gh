...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27118"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27119"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27122"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27124"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27125"
}
```
...
```json
{
    ...
    "title_was": "add support for Laurent polynomials in Sage",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27126"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27127"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2895#issuecomment-15883",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2895#issuecomment-15884",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27129"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2895#issuecomment-15885",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27130"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2895",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-27131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2895#issuecomment-15886",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
