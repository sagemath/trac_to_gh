...
```json
{
    "body": "<a id='comment:2'></a>> It is the default behaviour of Sage to return the echelon form over fraction fields\n\n\nWell that's TERRIBLE, and needs to be changed ASAP.  It is completely wrong / inconsistent.",
    "created_at": "2008-02-06T20:05:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13774",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>> It is the default behaviour of Sage to return the echelon form over fraction fields
...
```json
{
    "body": "<a id='comment:3'></a>We ought to sort this out before 2.10.2 is released.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-14T23:49:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13775",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>We ought to sort this out before 2.10.2 is released.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13776",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>YES, this is a blocker.  If you create a free module over QQ[x] with given generators, it replaces the generators by a basis coming from the rows of the \"echelon form\" of the matrix.  It is terrible if the elements in this echelon form aren't even in the QQ[x] span of the original matrix.",
    "created_at": "2008-02-17T22:58:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13778",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>YES, this is a blocker.  If you create a free module over QQ[x] with given generators, it replaces the generators by a basis coming from the rows of the "echelon form" of the matrix.  It is terrible if the elements in this echelon form aren't even in the QQ[x] span of the original matrix.
...
```json
{
    "body": "<a id='comment:7'></a>* in docstring of _echelonize_ring NotImplemenetedError should get \\code{}\n\nYes.\n\n* does self.dense_matrix() return self if it is already dense? If not the extra copy should be avoided by checking if the matrix is dense or sparse first\n\nYes, it returns self. \n\n* What is the status of \"#not very useful?\" is that a note to self to fix this or for the user?\n\nIt looks WRONG to me.  Shouldn't the second row be removed?!\n\n* \"#This code is by Me\" that should be William Stein\n\nOK.\n\n* Erocal Burcin -> Burcin Erocal \n\nOK. \n\nAny chance you could make the changes you suggest above?  I have to a bunch\nof other stuff today, and don't want to hold up rc1.",
    "created_at": "2008-02-21T20:35:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13780",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:7'></a>* in docstring of _echelonize_ring NotImplemenetedError should get \code{}
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13781",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>William, if you redo the patch you should also remove the last hunk since it has already been merged via some other patch.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-21T21:09:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13783",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>William, if you redo the patch you should also remove the last hunk since it has already been merged via some other patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2075#event-4982"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Merged sage-2075.2.patch in Sage 2.10.2.rc0.",
    "created_at": "2008-02-22T01:15:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13784",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged sage-2075.2.patch in Sage 2.10.2.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2075",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2075#issuecomment-13785",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
