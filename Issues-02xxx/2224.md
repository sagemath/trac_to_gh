# Issue 2224: [with patch, with positive review] sage-2.10.2.alpha1 -- strange show doctest bug in group.pyx
...
```json
{
    ...
    "title": "[with patch, with positive review] sage-2.10.2.alpha1 -- strange show doctest bug in group.pyx",
    "type": "issue",
