...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2224/sage-2224.patch",
    "created_at": "2008-02-21T19:11:00Z",
    "issue": "https://github.com/sagemath/sage/issues/2224",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2224/sage-2224.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [sage-2224.patch](https://github.com/sagemath/sage/files/ticket2224/sage-2224.patch) by @williamstein created at 2008-02-21 19:11:00\n\nthis fixes the doctest by implemeting new code in plot.py so that rgbcolor='#fffff00' works; i.e., improve the plotting code.",
    "created_at": "2008-02-21T19:11:00Z",
    "issue": "https://github.com/sagemath/sage/issues/2224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2224#issuecomment-11537",
    "user": "https://github.com/williamstein"
}
```

Attachment [sage-2224.patch](https://github.com/sagemath/sage/files/ticket2224/sage-2224.patch) by @williamstein created at 2008-02-21 19:11:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2224#issuecomment-11538",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2224#issuecomment-11539",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2224",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2224#issuecomment-11540",
