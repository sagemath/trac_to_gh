...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] wronskian is broken on constants",
        "to": "[with patch, positive review] wronskian is broken on constants"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2977#event-10572"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2977#issuecomment-21499",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2977#issuecomment-21500",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2977",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2977#issuecomment-21501",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2977",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2977#event-10573"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2977#event-10574"
}
```
