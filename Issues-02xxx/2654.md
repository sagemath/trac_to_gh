...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-20383",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2654/2654-cyclo.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-fixes.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-printing.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-doctest-fixes.patch",
    "created_at": "2008-04-02T19:58:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-64bit.patch",
