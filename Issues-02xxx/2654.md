...
```json
{
    "body": "<a id='comment:4'></a>This is due to some (very!) poor conversion code, not due to the algorithm itself. \n\n```\nsage: import sage.rings.polynomial.cyclotomic as c\nsage: n = factorial(10)\nsage: time f = newcyc(n)\nCPU time: 12.40 s,  Wall time: 12.53 s\nsage: time L = c.cyclotomic_coeffs(n)\nCPU time: 0.12 s,  Wall time: 0.13 s\n```",
    "created_at": "2008-03-31T20:03:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19682",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:4'></a>This is due to some (very!) poor conversion code, not due to the algorithm itself. 
...
```json
{
    "body": "<a id='comment:5'></a>In that case I'll leave this alone and wait for you to provide a suitable patch!",
    "created_at": "2008-03-31T21:43:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19683",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:5'></a>In that case I'll leave this alone and wait for you to provide a suitable patch!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19684",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19686",
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [2654-cyclo-fixes.patch](tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-fixes.patch) by @robertwb created at 2008-04-01 05:14:23\n\nFixes area attached.",
    "created_at": "2008-04-01T05:14:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19687",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:9'></a>Attachment [2654-cyclo-fixes.patch](tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-fixes.patch) by @robertwb created at 2008-04-01 05:14:23
...
```json
{
    "body": "<a id='comment:10'></a>I really have no horses in this race.",
    "created_at": "2008-04-01T12:07:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19688",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>I really have no horses in this race.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19689",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>These examples (powers of two) show very clearly what I was talking about.  The `2^n'th` cyclotomic polynomial is `x<sup>(2</sup>(n-1))+1` which is obtained by taking x+1 and replacing x by `x<sup>(2</sup>(n-1))`.  This should be trivial for sparse polys, and one would expect a fatal explosion for dense polys.\n\nI'll try it on my 32 bit machine now.",
    "created_at": "2008-04-01T12:58:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19691",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:12'></a>These examples (powers of two) show very clearly what I was talking about.  The `2^n'th` cyclotomic polynomial is `x<sup>(2</sup>(n-1))+1` which is obtained by taking x+1 and replacing x by `x<sup>(2</sup>(n-1))`.  This should be trivial for sparse polys, and one would expect a fatal explosion for dense polys.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19694",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19695",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Attachment [2654-cyclo-doctest-fixes.patch](tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-doctest-fixes.patch) by @robertwb created at 2008-04-02 19:58:29\n\nI implemented fast printing for `ZZ[x]`, but the generic case could be done better in some cases and I didn't touch that. \n\nAs for the limit, it's buried in ntl/include/ctools.h. \n\n```\n#define NTL_OVFBND (1L << (NTL_BITS_PER_LONG-4))\n```\n\nwhich is now checked for (rather than inducing a crash). Also, the failing doctests are fixed.",
    "created_at": "2008-04-02T19:58:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19696",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:16'></a>Attachment [2654-cyclo-doctest-fixes.patch](tarball://root/attachments/some-uuid/ticket2654/2654-cyclo-doctest-fixes.patch) by @robertwb created at 2008-04-02 19:58:29
...
```json
{
    "body": "<a id='comment:17'></a>I have succesfully applied the last two patches and tested them, and am very happy with this now.\nAll four patches are needed!",
    "created_at": "2008-04-02T21:21:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19697",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:17'></a>I have succesfully applied the last two patches and tested them, and am very happy with this now.
All four patches are needed!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19699",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:20'></a>Yes, I didn't have a 64 bit tests in the doctest, so the docstring got mangled. I posted a patch to address this issue.",
    "created_at": "2008-04-04T18:24:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19700",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:20'></a>Yes, I didn't have a 64 bit tests in the doctest, so the docstring got mangled. I posted a patch to address this issue.
...
```json
{
    "body": "<a id='comment:21'></a>Yep. That fixes the issue for me. Positive review.\n\nCheers,\n\nMichael",
    "created_at": "2008-04-04T18:58:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19701",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:21'></a>Yep. That fixes the issue for me. Positive review.
...
```json
{
    "body": "<a id='comment:22'></a>Merged in Sage 3.0.alpha1",
    "created_at": "2008-04-04T19:39:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19702",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:22'></a>Merged in Sage 3.0.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2654",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2654#issuecomment-19703",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
