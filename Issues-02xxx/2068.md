...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2068#issuecomment-13976",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2068",
    "rename": {
        "from": "zlib -- not picking up the right zlib when building libpng",
        "to": "[with spkg] zlib -- not picking up the right zlib when building libpng"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2068#event-7076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2068",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2068#event-7077"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2068",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2068#issuecomment-13977",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2068",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2068#issuecomment-13978",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
