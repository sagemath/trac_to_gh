...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-18306"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-18307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-18308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-18309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2068",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-18310"
}
```
