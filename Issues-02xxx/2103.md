...
```json
{
    "body": "<a id='comment:1'></a>I'd also like this. I'll have a go at it.",
    "created_at": "2008-09-21T18:27:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14777",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:1'></a>I'd also like this. I'll have a go at it.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14778",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14779",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I've added myself on the CC list for this.  My student Maite Aranes is in the process of implementing cusps for general number fields, by the way, but I have not yet made a ticket for it.",
    "created_at": "2008-09-23T11:33:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14781",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:3'></a>I've added myself on the CC list for this.  My student Maite Aranes is in the process of implementing cusps for general number fields, by the way, but I have not yet made a ticket for it.
...
```json
{
    "body": "<a id='comment:4'></a>For the patch **2103.patch**, here's a possible fix for improving the documentation:\n\n\n```\n-Since Gamma0(N) always, contains the matrix -1, this always\n+Since Gamma0(N) always contains the matrix -1, this always\n```\nAfter applying that diff, you'd get:\n\n```\nReturn True precisely if this subgroup contains the matrix -1. \n\nSince Gamma0(N) always contains the matrix -1, this always \nreturns True.\n```",
    "created_at": "2008-10-27T12:18:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14782",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:4'></a>For the patch **2103.patch**, here's a possible fix for improving the documentation:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14783",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14784",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>It was conflicting with mhansen's changeset 10648, deprecating is_blah() functions. I've uploaded a new patch (also incorporating mvngu's docstring fix), which was created under 3.1.4 and seems to apply fine to 3.2.alpha1 as well.",
    "created_at": "2008-10-28T11:22:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14785",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:6'></a>It was conflicting with mhansen's changeset 10648, deprecating is_blah() functions. I've uploaded a new patch (also incorporating mvngu's docstring fix), which was created under 3.1.4 and seems to apply fine to 3.2.alpha1 as well.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14786",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14788",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Oops! The same function appears twice in dims.py, with identical code both times -- that was silly of me. I have recreated the patch with only one copy of dimension_modular_forms_H, and added a doctest for it.",
    "created_at": "2008-10-28T18:33:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14789",
    "user": "https://github.com/loefflerd"
}
```

<a id='comment:8'></a>Oops! The same function appears twice in dims.py, with identical code both times -- that was silly of me. I have recreated the patch with only one copy of dimension_modular_forms_H, and added a doctest for it.
...
```json
{
    "body": "<a id='comment:9'></a>Ok, I'm in the process of reviewing this -- I'll have it done in a little bit.",
    "created_at": "2008-10-28T20:05:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14790",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:9'></a>Ok, I'm in the process of reviewing this -- I'll have it done in a little bit.
...
```json
{
    "body": "<a id='comment:11'></a>Craig's additional patch looks good to me;  though I don't have time at the moment to check that everything works properly.",
    "created_at": "2008-10-29T09:51:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14792",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:11'></a>Craig's additional patch looks good to me;  though I don't have time at the moment to check that everything works properly.
...
```json
{
    "body": "<a id='comment:12'></a>1. Note that only the last two patches should be applied: 2103-new.patch and trac-2103-pt2.patch\n    2. They apply cleanly to 3.2.alpha1\n    3. All tests in sage/modular pass\n\nI am happy to give this a positive review, reinforcing Craig's.",
    "created_at": "2008-10-29T12:05:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14793",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:12'></a>1. Note that only the last two patches should be applied: 2103-new.patch and trac-2103-pt2.patch
    2. They apply cleanly to 3.2.alpha1
    3. All tests in sage/modular pass
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14794",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Merged in Sage 3.2.alpha2",
    "created_at": "2008-10-29T13:47:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14795",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:13'></a>Merged in Sage 3.2.alpha2
...
```json
{
    "body": "Changing reviewer from \"\" to \"Craig Citro, John Cremona\"",
    "created_at": "2009-06-07T08:48:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14796",
    "user": "https://github.com/loefflerd"
}
```

Changing reviewer from "" to "Craig Citro, John Cremona"
...
```json
{
    "body": "Changing merged from \"\" to \"3.2.alpha2\"",
    "created_at": "2009-06-07T08:48:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14797",
    "user": "https://github.com/loefflerd"
}
```

Changing merged from "" to "3.2.alpha2"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2103#issuecomment-14798",
    "user": "https://github.com/loefflerd"
}
```
