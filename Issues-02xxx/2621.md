...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] parallel doctest: concurrency problem when creating .doctest directories"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2621#event-9275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2621#issuecomment-18872",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2621#issuecomment-18873",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2621#issuecomment-18874",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2621",
    "rename": {
        "from": "[with patch, needs review] parallel doctest: concurrency problem when creating .doctest directories",
        "to": "[with patch, positive review] parallel doctest: concurrency problem when creating .doctest directories"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2621#event-9276"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2621#issuecomment-18875",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2621",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2621#event-9277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2621#issuecomment-18876",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
