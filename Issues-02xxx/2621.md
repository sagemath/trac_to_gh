# Issue 2621: [with patch, positive review] parallel doctest: concurrency problem when creating .doctest directories
...
```json
{
    ...
    "title": "[with patch, positive review] parallel doctest: concurrency problem when creating .doctest directories",
    "type": "issue",
