...
```json
{
    ...
    "rename": {
        "from": "[with spkg; needs review] Fixed Debian support for linbox",
        "to": "[with spkg; positive review] Fixed Debian support for linbox"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2647#event-9392"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2647#issuecomment-19083",
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2647#event-9393"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2647#issuecomment-19084",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2647",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2647#event-9394"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2647",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2647#issuecomment-19085",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
