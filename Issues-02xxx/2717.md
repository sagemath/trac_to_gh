# Issue 2717: [with patch, positive review] maxima expect interface synchronization not sufficiently robust
...
```json
{
    ...
    "title": "[with patch, positive review] maxima expect interface synchronization not sufficiently robust",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2717#issuecomment-19642",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2717",
    "rename": {
        "from": "maxima expect interface synchronization not sufficiently robust",
        "to": "[with patch, needs review] maxima expect interface synchronization not sufficiently robust"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2717#event-9652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2717#issuecomment-19643",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2717#issuecomment-19644",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2717",
    "rename": {
        "from": "[with patch, needs review] maxima expect interface synchronization not sufficiently robust",
        "to": "[with patch, positive review] maxima expect interface synchronization not sufficiently robust"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2717#event-9653"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2717#issuecomment-19645",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2717",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2717#event-9654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2717#issuecomment-19646",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
