...
```json
{
    "body": "**Attachment:** [mpoly_over_numberfield.patch](https://github.com/sagemath/sage/files/ticket2420/mpoly_over_numberfield.patch)\n\nnew patch, adding more doctests, should apply to sage 2.10.3.rc2",
    "created_at": "2008-03-08T00:35:50Z",
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
...
**Attachment:** [mpoly_over_numberfield.patch](https://github.com/sagemath/sage/files/ticket2420/mpoly_over_numberfield.patch)
...
```json
{
    "body": "**Work Issues:** Side effect of GAP on Pari",
    "created_at": "2010-07-06T14:32:07Z",
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
...
**Work Issues:** Side effect of GAP on Pari
...
```json
{
    "body": "**Changing work issues** from \"Side effect of GAP on Pari\" to \"Consider stacks of polynomial rings over number fields\".",
...
**Changing work issues** from "Side effect of GAP on Pari" to "Consider stacks of polynomial rings over number fields".
...
```json
{
    "body": "**Attachment:** [trac_2420_GAP_interface_polynomials.patch](https://github.com/sagemath/sage/files/ticket2420/trac_2420_GAP_interface_polynomials.patch)\n\nDisregard first patch; apply after the patches from #9205, #9438, #9423, #8909 and #5618",
    "created_at": "2010-07-08T09:58:17Z",
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
...
**Attachment:** [trac_2420_GAP_interface_polynomials.patch](https://github.com/sagemath/sage/files/ticket2420/trac_2420_GAP_interface_polynomials.patch)
...
```json
{
    "body": "**Changing work issues** from \"Consider stacks of polynomial rings over number fields\" to \"\".",
    "created_at": "2010-07-08T10:46:57Z",
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
...
**Changing work issues** from "Consider stacks of polynomial rings over number fields" to "".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2420#issuecomment-12906",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2420#issuecomment-12907",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2420#issuecomment-12908",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2420#issuecomment-12909",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2420#issuecomment-12910",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2420",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2420#issuecomment-12911",
    "user": "https://github.com/videlec"
}
```
