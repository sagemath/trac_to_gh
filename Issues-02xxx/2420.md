...
```json
{
    "body": "Some of the patch is now implemented in #18266 (in a compatible way with libgap).",
...
```json
{
    "body": "Perhaps we don't have to make every imaginable case work in one fell swoop, so long as improvements can be made in specific cases, such as in #27005",
