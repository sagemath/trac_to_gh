...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] greatly speed up matrix inversion for 1x1 and 2x2 matrices over QQ by a factor of 20!",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2155#event-7418"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2155#issuecomment-14818",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs new review] greatly speed up matrix inversion for 1x1 and 2x2 matrices over QQ by a factor of 20!; speed up changing base rings (architecture); hadamard bound"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2155#event-7419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2155#issuecomment-14819",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2155#issuecomment-14820",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2155#issuecomment-14821",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "rename": {
        "from": "[with patch; needs new review] greatly speed up matrix inversion for 1x1 and 2x2 matrices over QQ by a factor of 20!; speed up changing base rings (architecture); hadamard bound",
        "to": "[with patch; needs additional review] greatly speed up matrix inversion for 1x1 and 2x2 matrices over QQ by a factor of 20!; speed up changing base rings (architecture); hadamard bound"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2155#event-7420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2155#issuecomment-14822",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2155#issuecomment-14823",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2155",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2155#event-7421"
}
```
