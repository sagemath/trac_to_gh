...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2287#issuecomment-15871",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2287#issuecomment-15872",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, needs review] error installing rubiks related to location of install"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2287#event-7891"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2287#issuecomment-15873",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2287",
    "rename": {
        "from": "[with spkg, needs review] error installing rubiks related to location of install",
        "to": "[with spkg, with positive review] error installing rubiks related to location of install"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2287#event-7892"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2287#issuecomment-15874",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2287",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2287#event-7893"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2287#issuecomment-15875",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2287#issuecomment-15876",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2287#event-7894"
}
```
