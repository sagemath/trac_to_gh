...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, easy review] make the final output of \"sage -i\" more user friendly (easy to fix)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2087#event-7149"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2087#issuecomment-14104",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2087#issuecomment-14105",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2087",
    "rename": {
        "from": "[with patch, easy review] make the final output of \"sage -i\" more user friendly (easy to fix)",
        "to": "[with patch, positive review] make the final output of \"sage -i\" more user friendly (easy to fix)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2087#event-7150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2087",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2087#event-7151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2087#issuecomment-14106",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2087",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2087#issuecomment-14107",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
