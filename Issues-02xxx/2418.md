...
```json
{
    "body": "<a id='comment:2'></a>I certainly don't think the ticket is invalid; it's definitely a bug in Sage (via Pari), even if it's not a bug in the Sage library code.\n\nFor this example, it presumably works to divide through by the leading coefficient (to get a monic polynomial) before handing off to Pari.  Maybe that's a reasonable strategy in general?\n\nOr, we could just report it as a bug to Pari upstream, and hope they fix it.",
    "created_at": "2009-01-23T20:59:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17570",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:2'></a>I certainly don't think the ticket is invalid; it's definitely a bug in Sage (via Pari), even if it's not a bug in the Sage library code.
...
```json
{
    "body": "<a id='comment:3'></a>I've followed Carl's suggestion -- see the attached patch.",
    "created_at": "2010-01-03T06:47:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17571",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:3'></a>I've followed Carl's suggestion -- see the attached patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17572",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17573",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17574",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17575",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Positive review.  The patch applies to 4.3 and all tests in rings/polynomial pass.",
    "created_at": "2010-01-06T16:37:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17576",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:4'></a>Positive review.  The patch applies to 4.3 and all tests in rings/polynomial pass.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17577",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17578",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17579",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17580",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17582",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17583",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [trac_2418-rebased.patch](tarball://root/attachments/some-uuid/ticket2418/trac_2418-rebased.patch) by @JohnCremona created at 2010-01-13 11:47:31\n\nI checked that this applies fine on top of 4.3.1.alpha1 + #6237, and tests pass, so positive review.",
    "created_at": "2010-01-13T11:47:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17584",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:7'></a>Attachment [trac_2418-rebased.patch](tarball://root/attachments/some-uuid/ticket2418/trac_2418-rebased.patch) by @JohnCremona created at 2010-01-13 11:47:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17585",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17586",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2418",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2418#issuecomment-17587",
    "user": "https://github.com/rlmill"
}
```
