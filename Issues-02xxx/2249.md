# Issue 2249: [with positive review] comments to indicate in docstrings that log is not finished in some cases for p-adics
...
```json
{
    ...
    "title": "[with positive review] comments to indicate in docstrings that log is not finished in some cases for p-adics",
    "type": "issue",
...
```json
{
    ...
    "rename": {
        "from": "comments to indicate in docstrings that log is not finished in some cases for p-adics",
        "to": "[with positive review] comments to indicate in docstrings that log is not finished in some cases for p-adics"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2249#event-6627"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2249#issuecomment-16409",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2249",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2249#event-6628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2249#issuecomment-16410",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2249#issuecomment-16411",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
