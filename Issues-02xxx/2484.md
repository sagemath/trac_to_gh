...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2484#issuecomment-17591",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] \"Conditional jump\" in  QuadDoubleElement __repr__"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2484#event-8750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2484",
    "rename": {
        "from": "[with patch, needs review] \"Conditional jump\" in  QuadDoubleElement __repr__",
        "to": "[with patch, with positive review] \"Conditional jump\" in  QuadDoubleElement __repr__"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2484#event-8751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2484#issuecomment-17592",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2484",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2484#event-8752"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2484#issuecomment-17593",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2484#issuecomment-17594",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
