...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2754#event-25235"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2754#event-25236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2754#event-25237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2754#event-25238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2754",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2754#event-25239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2754",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2754#event-25240"
}
```
