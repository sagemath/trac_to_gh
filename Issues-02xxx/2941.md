...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16132",
    "user": "https://github.com/certik"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [sympy-0.5.13.patch](https://github.com/sagemath/sage/files/ticket2941/sympy-0.5.13.patch) by @certik created at 2008-04-16 09:43:42\n\n**Important note**: execute this command\n\nrm -r sage/local/lib/python2.5/site-packages/sympy*\n\nbefore installing the spkg, otherwise sympy will be broken.",
    "created_at": "2008-04-16T09:43:42Z",
    "issue": "https://github.com/sagemath/sage/issues/2941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16133",
    "user": "https://github.com/certik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16134",
...
```json
{
    "body": "Attachment [sympy-0.5.13.spkg](https://github.com/sagemath/sage/files/ticket2941/sympy-0.5.13.spkg) by @certik created at 2008-04-16 11:51:39",
    "created_at": "2008-04-16T11:51:39Z",
    "issue": "https://github.com/sagemath/sage/issues/2941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16135",
    "user": "https://github.com/certik"
}
```

Attachment [sympy-0.5.13.spkg](https://github.com/sagemath/sage/files/ticket2941/sympy-0.5.13.spkg) by @certik created at 2008-04-16 11:51:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16136",
    "user": "https://github.com/certik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16137",
    "user": "https://github.com/certik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16138",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2941",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2941#issuecomment-16139",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
