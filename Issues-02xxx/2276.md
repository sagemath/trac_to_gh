...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2276#issuecomment-11830",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2276#issuecomment-11831",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2276#issuecomment-11832",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [trac_2276.patch](https://github.com/sagemath/sage/files/ticket2276/trac_2276.patch) by @malb created at 2008-03-28 12:00:36\n\nThe attached patch implements `__mod__` which fixes the issue. Note, that type checking is performed in `quo_rem` and thus is not needed in `__mod__`.",
    "created_at": "2008-03-28T12:00:36Z",
    "issue": "https://github.com/sagemath/sage/issues/2276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2276#issuecomment-11833",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2276#issuecomment-11834",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2276#issuecomment-11835",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
