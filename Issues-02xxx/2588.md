...
archive/attachments_002374.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "2588-ncalexan-jacobian-morphism1.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket2588/2588-ncalexan-jacobian-morphism1.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2588",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2588#issuecomment-19743",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2588/trac_2588_fix-doctest.patch",
...
```json
{
    "body": "this patch actually fixes the stupid mistake I introduces in the changed doctest",
    "created_at": "2008-03-20T02:01:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2588",
    "type": "issue_comment",
