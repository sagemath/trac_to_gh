...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20509"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20512"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2035#issuecomment-9692",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2035",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20514"
}
```
