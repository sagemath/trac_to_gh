...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-17976"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-17977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-17978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-17979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2035",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-17980"
}
```
