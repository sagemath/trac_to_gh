...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2575/config.log",
    "created_at": "2008-03-17T18:29:10Z",
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2575/config.log",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    "body": "Attachment [config.log](https://github.com/sagemath/sage/files/ticket2575/config.log) by @haraldschilly created at 2008-03-17 18:29:10\n\nconfig.log produced by the configure process, for debugging, see BASECC variable",
    "created_at": "2008-03-17T18:29:10Z",
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2575#issuecomment-13932",
    "user": "https://github.com/haraldschilly"
}
```

Attachment [config.log](https://github.com/sagemath/sage/files/ticket2575/config.log) by @haraldschilly created at 2008-03-17 18:29:10
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2575#issuecomment-13933",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2575#issuecomment-13934",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2575#issuecomment-13935",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2575#issuecomment-13936",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2575#issuecomment-13937",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2575#issuecomment-13938",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
