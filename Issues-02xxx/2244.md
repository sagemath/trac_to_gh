...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2244#issuecomment-11646",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2244#issuecomment-11647",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [wiggle-interior.patch](https://github.com/sagemath/sage/files/ticket2244/wiggle-interior.patch) by @jasongrout created at 2008-02-21 21:20:51\n\napply after William's patch",
    "created_at": "2008-02-21T21:20:51Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2244#issuecomment-11648",
    "user": "https://github.com/jasongrout"
}
```

Attachment [wiggle-interior.patch](https://github.com/sagemath/sage/files/ticket2244/wiggle-interior.patch) by @jasongrout created at 2008-02-21 21:20:51
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2244#issuecomment-11649",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2244#issuecomment-11650",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2244#issuecomment-11651",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [sage-2244-nowiggle.patch](https://github.com/sagemath/sage/files/ticket2244/sage-2244-nowiggle.patch) by @williamstein created at 2008-02-24 04:58:06\n\nApply sage-2244-nowiggle.patch (which has now been rebased) followed by wiggle-interior.patch which will apply correctly with some \"fuzz\". \n\n -- William",
    "created_at": "2008-02-24T04:58:06Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
...
```json
{
    "body": "Attachment [2244_nowiggle_new.patch](https://github.com/sagemath/sage/files/ticket2244/2244_nowiggle_new.patch) by @aghitza created at 2008-03-15 18:11:16\n\napply instead of the two above",
    "created_at": "2008-03-15T18:11:16Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
...
Attachment [2244_nowiggle_new.patch](https://github.com/sagemath/sage/files/ticket2244/2244_nowiggle_new.patch) by @aghitza created at 2008-03-15 18:11:16
