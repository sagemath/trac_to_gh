...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20006",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Code looks fine to me.  I haven't checked it yet as my machine is tied up doing --testall on 3.0.alpha2.",
    "created_at": "2008-04-07T19:49:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20007",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:1'></a>Code looks fine to me.  I haven't checked it yet as my machine is tied up doing --testall on 3.0.alpha2.
...
```json
{
    "body": "Description changed:\n```diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n-Use some data provided by Michael Monagan, as well as take advantage of the fact (mentioned in the previous ticket by John Cremona) that $\\Phi_{pn}(x) = \\Phi_n(x^p)$ for $p|n$.\n+Use some data provided by Michael Monagan, as well as take advantage of the fact (mentioned in the previous ticket by John Cremona) that \\`$\\Phi_{pn}(x) = \\Phi_n(x^p)$ for $p|n$.\\`\n \n Summary: [with patch, needs review] more speedups to cyclotomic polynomials\n \n```\n",
    "created_at": "2008-04-07T20:59:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20009",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20010",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>It was just a conflict with a random doctest. I rebased it against 3.0.alpha3. Apply 2847-cyclo-limits.patch and 2847-cyclo-radical-rebased.patch.",
    "created_at": "2008-04-09T03:41:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20011",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:4'></a>It was just a conflict with a random doctest. I rebased it against 3.0.alpha3. Apply 2847-cyclo-limits.patch and 2847-cyclo-radical-rebased.patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20012",
...
```json
{
    "body": "<a id='comment:6'></a>Merged 2847-cyclo-limits.patch and 2847-cyclo-radical-rebased.patch in Sage 3.0.alpha3",
    "created_at": "2008-04-09T04:07:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20013",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Merged 2847-cyclo-limits.patch and 2847-cyclo-radical-rebased.patch in Sage 3.0.alpha3
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20014",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [2847-Zn_x-fix.patch](tarball://root/attachments/some-uuid/ticket2847/2847-Zn_x-fix.patch) by @robertwb created at 2008-04-09 04:39:46\n\nLooks like this exposed a bug in the (Z/nZ)[x] __init__ method, which I have fixed in the attached patch.",
    "created_at": "2008-04-09T04:39:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20016",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:8'></a>Attachment [2847-Zn_x-fix.patch](tarball://root/attachments/some-uuid/ticket2847/2847-Zn_x-fix.patch) by @robertwb created at 2008-04-09 04:39:46
...
```json
{
    "body": "<a id='comment:10'></a>Thanks Robert. 2847-Zn_x-fix.patch fixes the issue. Merged in Sage 3.0.alpha3",
    "created_at": "2008-04-09T05:04:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2847",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2847#issuecomment-20017",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Thanks Robert. 2847-Zn_x-fix.patch fixes the issue. Merged in Sage 3.0.alpha3
