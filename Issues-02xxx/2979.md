...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21512",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg; may or may not work] clisp -- try to build using -O2; if that fails try again but using -O0."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2979#event-10577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21513",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21514",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21515",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "rename": {
        "from": "[with spkg; may or may not work] clisp -- try to build using -O2; if that fails try again but using -O0.",
        "to": "[with spkg; may or may not work] force \"-O0\" for clisp with gcc 4.3"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2979#event-10578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21516",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21517",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21518",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2979#issuecomment-21519",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2979#event-10579"
}
```
