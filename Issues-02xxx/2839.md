...
<a id='comment:2'></a>The patch also includes a speed up for change of bases over QQ.
...
```json
{
    "body": "<a id='comment:3'></a>The patch works for me (32-bit Ubuntu Hardy) and fixes the issues mentioned in the sage-devel thread. All tests pass on /libs/symmetrica/symmetrica.pxi.",
...
<a id='comment:3'></a>The patch works for me (32-bit Ubuntu Hardy) and fixes the issues mentioned in the sage-devel thread. All tests pass on /libs/symmetrica/symmetrica.pxi.
