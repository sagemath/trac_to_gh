...
```json
{
    "body": "<a id='comment:1'></a>Whenever I hear \"union\", I think \"disjoint union\" (at least as far as graphs go).  So I vote for making this the disjoint union and making another function the non-disjoint union.",
    "created_at": "2008-02-26T13:44:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2315#issuecomment-15803",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>Whenever I hear "union", I think "disjoint union" (at least as far as graphs go).  So I vote for making this the disjoint union and making another function the non-disjoint union.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2315#issuecomment-15804",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Furthermore, I vote with a patch :)",
    "created_at": "2008-02-26T22:52:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2315#issuecomment-15805",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>Furthermore, I vote with a patch :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2315#issuecomment-15808",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [graph-union2.patch](tarball://root/attachments/some-uuid/ticket2315/graph-union2.patch) by @jasongrout created at 2008-02-27 20:55:42\n\nThe graph-union2.patch takes care of the recommendations.  This now depends on the patch at #2283 to work correctly (otherwise 3*G will still return an error because 3 == Integer(3) at the Sage command line).",
    "created_at": "2008-02-27T20:55:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2315#issuecomment-15809",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>Attachment [graph-union2.patch](tarball://root/attachments/some-uuid/ticket2315/graph-union2.patch) by @jasongrout created at 2008-02-27 20:55:42
...
```json
{
    "body": "<a id='comment:7'></a>Merged both patches in Sage 2.10.3.rc0",
    "created_at": "2008-02-28T06:17:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2315#issuecomment-15810",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged both patches in Sage 2.10.3.rc0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2315",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2315#issuecomment-15811",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
