# Issue 2225: [with positive review] sage-2.10.2.alpha1 -- genus2reduction is now completely broken (maybe caused by new spkg with makefile?)
...
```json
{
    ...
    "title": "[with positive review] sage-2.10.2.alpha1 -- genus2reduction is now completely broken (maybe caused by new spkg with makefile?)",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16216",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16217",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16218",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16219",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16220",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "rename": {
        "from": "sage-2.10.2.alpha1 -- genus2reduction is now completely broken (maybe caused by new spkg with makefile?)",
        "to": "[with positive review] sage-2.10.2.alpha1 -- genus2reduction is now completely broken (maybe caused by new spkg with makefile?)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2225#event-6570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16221",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16222",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2225#issuecomment-16223",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2225",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2225#event-6571"
}
```
