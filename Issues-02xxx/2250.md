...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2250#issuecomment-11678",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2250#issuecomment-11679",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [2250-inverse-action.patch](https://github.com/sagemath/sage/files/ticket2250/2250-inverse-action.patch) by @robertwb created at 2008-02-21 21:24:48\n\nThe above patch fixes this issue, returning None rather than raising an error in this corner case where there is no action (now that division by Z -> multiplication by Q).",
    "created_at": "2008-02-21T21:24:48Z",
    "issue": "https://github.com/sagemath/sage/issues/2250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2250#issuecomment-11680",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2250#issuecomment-11681",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2250#issuecomment-11682",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
