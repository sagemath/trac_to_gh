# Issue 2250: [with patch; positive review] sage 2.10.2.rc0: elliptic_curves/monsky_washnitzer.py doctest failure with -long
...
```json
{
    ...
    "title": "[with patch; positive review] sage 2.10.2.rc0: elliptic_curves/monsky_washnitzer.py doctest failure with -long",
    "type": "issue",
