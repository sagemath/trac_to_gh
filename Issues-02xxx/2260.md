...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20341"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20342"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20344"
}
```
...
```json
{
    "body": "Changed assignee from **m abs** to **@sagetrac-mabshoff**",
...
Changed assignee from **m abs** to **@sagetrac-mabshoff**
...
```json
{
    ...
    "milestone_title": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20345"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20346"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20347"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2260",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2260#event-20348"
}
```
