...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2020#event-6903"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] change an error message when running a certain command and the elliptic curve database is too small"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2020#event-6904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2020#issuecomment-13595",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "rename": {
        "from": "[with patch; needs review] change an error message when running a certain command and the elliptic curve database is too small",
        "to": "[with patch; with positive review] change an error message when running a certain command and the elliptic curve database is too small"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2020#event-6905"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "rename": {
        "from": "[with patch; with positive review] change an error message when running a certain command and the elliptic curve database is too small",
        "to": "[with patch; with positive review, needs doctest fix] change an error message when running a certain command and the elliptic curve database is too small"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2020#event-6906"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2020#issuecomment-13596",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "rename": {
        "from": "[with patch; with positive review, needs doctest fix] change an error message when running a certain command and the elliptic curve database is too small",
        "to": "[with patch; with positive review] change an error message when running a certain command and the elliptic curve database is too small"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2020#event-6907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2020#issuecomment-13597",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2020#issuecomment-13598",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2020#issuecomment-13599",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2020#event-6908"
}
```
