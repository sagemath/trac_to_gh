...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2530#issuecomment-18062",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2530",
    "rename": {
        "from": "interact bug -- drop down menu default doesn't show default value",
        "to": "[with patch; needs review] interact bug -- drop down menu default doesn't show default value"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2530#event-8921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2530",
    "rename": {
        "from": "[with patch; needs review] interact bug -- drop down menu default doesn't show default value",
        "to": "[with patch; positive review] interact bug -- drop down menu default doesn't show default value"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2530#event-8922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2530#issuecomment-18063",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2530#event-8923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2530#issuecomment-18064",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2530#issuecomment-18065",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2530",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2530#event-8924"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2530",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2530#issuecomment-18066",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
