...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23613"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23617"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23618"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23620"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23621"
}
```
...
```json
{
    ...
    "title_was": "Add reduced adjacency matrix and alist file format support to BipartiteGraph",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23622"
}
```
...
```json
{
    ...
    "title_was": "[positive review pending] Add reduced adjacency matrix and alist file format support to BipartiteGraph",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23623"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23624"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2597",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2597#event-23627"
}
```
