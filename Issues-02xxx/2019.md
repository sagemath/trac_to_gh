...
```json
{
    "body": "<a id='comment:1'></a>This is not a fix but a work-around:\nIf you create a clone then the problem goes away!",
...
<a id='comment:1'></a>This is not a fix but a work-around:
If you create a clone then the problem goes away!
...
<a id='comment:2'></a>Here seems to be the solution, which makes the above problem go away: 
...
<a id='comment:3'></a>Fortunately there is now a simple solution to this problem.
...
<a id='comment:4'></a>That did it- thanks!
...
```json
{
    "body": "<a id='comment:5'></a>I have uploaded the new optional spkg the the sagemath.org repo. In the future we should add a proper hg repo in the base directory as well as update SPKG.txt on changes.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-02T06:50:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2019",
    "type": "issue_comment",
...
<a id='comment:5'></a>I have uploaded the new optional spkg the the sagemath.org repo. In the future we should add a proper hg repo in the base directory as well as update SPKG.txt on changes.
...
```json
{
    "body": "<a id='comment:6'></a>Optional spkg uploaded to sagemath.org and mirrored out",
...
<a id='comment:6'></a>Optional spkg uploaded to sagemath.org and mirrored out
