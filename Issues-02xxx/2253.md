# Issue 2253: [with positive review] sage-2.10.2 -- timeit doctests not robust enough
...
```json
{
    ...
    "title": "[with positive review] sage-2.10.2 -- timeit doctests not robust enough",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2253/8652.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-16431",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2253#event-6636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-16432",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-16433",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] sage-2.10.2 -- timeit doctests not robust enough"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2253#event-6637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2253#event-6638"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-16434",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-16435",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
