...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-15625",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; too trivial to review] sage-2.10.2 -- timeit doctests not robust enough"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2253#event-7773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-15626",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-15627",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "rename": {
        "from": "[with patch; too trivial to review] sage-2.10.2 -- timeit doctests not robust enough",
        "to": "[with patch; with positive review] sage-2.10.2 -- timeit doctests not robust enough"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2253#event-7774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2253#event-7775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-15628",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2253#issuecomment-15629",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
