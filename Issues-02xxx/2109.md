...
```json
{
    "body": "<a id='comment:1'></a>Here is what happens in sage-4.1.1:\n\n```\nsage: maxima.eval('sage0: x == x;')\n'x'\n```",
...
<a id='comment:1'></a>Here is what happens in sage-4.1.1:
...
```json
{
    "body": "<a id='comment:2'></a>So at least it doesn't hang anymore.  I will change the summary.",
...
<a id='comment:2'></a>So at least it doesn't hang anymore.  I will change the summary.
...
<a id='comment:4'></a>Passes relevant tests, catches several different types of incorrect input errors, and helped me learn a little more about pexpect.  Positive review, and thanks! 
