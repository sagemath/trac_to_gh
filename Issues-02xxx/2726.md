...
```json
{
    "body": "Attachment [build-system.patch](https://github.com/sagemath/sage/files/ticket2726/build-system.patch) by @timabbott created at 2008-03-29 22:16:07",
    "created_at": "2008-03-29T22:16:07Z",
    "issue": "https://github.com/sagemath/sage/issues/2726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2726#issuecomment-14933",
    "user": "https://github.com/timabbott"
}
```

Attachment [build-system.patch](https://github.com/sagemath/sage/files/ticket2726/build-system.patch) by @timabbott created at 2008-03-29 22:16:07
...
```json
{
    "body": "Attachment [build-system2.patch](https://github.com/sagemath/sage/files/ticket2726/build-system2.patch) by mabshoff created at 2008-04-01 20:31:58\n\nmake sure SbuildHack.pm gets copied by -sdist",
    "created_at": "2008-04-01T20:31:58Z",
    "issue": "https://github.com/sagemath/sage/issues/2726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2726#issuecomment-14934",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

Attachment [build-system2.patch](https://github.com/sagemath/sage/files/ticket2726/build-system2.patch) by mabshoff created at 2008-04-01 20:31:58
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac_2726_sage-SbuildHack.pm-copy.patch](https://github.com/sagemath/sage/files/ticket2726/trac_2726_sage-SbuildHack.pm-copy.patch) by mabshoff created at 2008-04-01 20:32:48\n\nPatch looks good to me. My minimal patch makes sure that SbuildHack.pm is copied on `-sdist`\n\nCheers,\n\nMichael",
    "created_at": "2008-04-01T20:32:48Z",
    "issue": "https://github.com/sagemath/sage/issues/2726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2726#issuecomment-14935",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2726#issuecomment-14936",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
