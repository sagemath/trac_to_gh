...
```json
{
    "body": "**Attachment:** [trac-2107.patch](https://github.com/sagemath/sage/files/ticket2107/trac-2107.patch)\n\nChange the wrapper for linbox rank, to directly use FFPACK rank.",
    "created_at": "2008-02-09T00:31:39Z",
    "issue": "https://github.com/sagemath/sage/issues/2107",
    "type": "issue_comment",
...
**Attachment:** [trac-2107.patch](https://github.com/sagemath/sage/files/ticket2107/trac-2107.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2107#issuecomment-10713",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2107#issuecomment-10714",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2107#issuecomment-10715",
    "user": "https://github.com/ClementPernet"
}
```
...
```json
{
    "body": "**Attachment:** [linboxdet.3.patch](https://github.com/sagemath/sage/files/ticket2107/linboxdet.3.patch)\n\nadds the originial problem report as a doctest",
    "created_at": "2008-02-17T00:26:34Z",
    "issue": "https://github.com/sagemath/sage/issues/2107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2107#issuecomment-10716",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

**Attachment:** [linboxdet.3.patch](https://github.com/sagemath/sage/files/ticket2107/linboxdet.3.patch)
...
archive/attachments_001826.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [Sage-2.10.2.alpha1-trac_2107_doctest.patch](https://github.com/sagemath/sage/files/ticket2107/Sage-2.10.2.alpha1-trac_2107_doctest.patch)\n\nThe spkg at \n\nhttp://sage.math.washington.edu/home/mabshoff/release-cycles-2.10.2/alpha1/linbox-20070915.p5.spkg\n\nfixes the issue. It is linbox-20070915.p4 + the fixes from linbox-20070915.p5 at #2127 merged into one.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-17T00:28:02Z",
    "issue": "https://github.com/sagemath/sage/issues/2107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2107#issuecomment-10717",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2107#issuecomment-10718",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
