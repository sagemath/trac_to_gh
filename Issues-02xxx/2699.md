...
archive/attachments_002506.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "install.log.tar.tar.bz2",
    "asset_url": "tarball://root/attachments/ticket2699/install.log.tar.tar.bz2",
    "created_at": "2008-03-28T14:10:02Z",
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2699/install.log.tar.tar.bz2",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    "body": "Attachment [install.log.tar.tar.bz2](https://github.com/sagemath/sage/files/ticket2699/install.log.tar.tar.bz2) by @haraldschilly created at 2008-03-28 14:10:02\n\ninstall.log of failed scipy build",
    "created_at": "2008-03-28T14:10:02Z",
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2699#issuecomment-14803",
    "user": "https://github.com/haraldschilly"
}
```

Attachment [install.log.tar.tar.bz2](https://github.com/sagemath/sage/files/ticket2699/install.log.tar.tar.bz2) by @haraldschilly created at 2008-03-28 14:10:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2699#issuecomment-14804",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2699#issuecomment-14805",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2699#issuecomment-14806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2699#issuecomment-14807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2699#event-14098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2699#event-14099"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2699",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2699#issuecomment-14808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
