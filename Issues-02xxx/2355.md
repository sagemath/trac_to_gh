...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24428"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24431"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24432"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24435"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24436"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24437"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24438"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24439"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24440"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24441"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24442"
}
```
...
```json
{
    ...
    "title_was": "[negative review] Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24443"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24444"
}
```
...
```json
{
    ...
    "title_was": "[with negative review] Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24445"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.10.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24446"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24447"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24448"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24449"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24452"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24453"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24454"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24455"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24456"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2355",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-24457"
}
```
