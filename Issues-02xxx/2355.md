...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2355#issuecomment-17508",
...
```json
{
    ...
    "asset_name": "2355.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket2355/2355.hg",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2355/2355.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2355/trac_2355_fast.patch",
...
```json
{
    "body": "Apply on top of 2355.patch",
    "created_at": "2008-03-25T23:35:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2355",
    "type": "issue_comment",
