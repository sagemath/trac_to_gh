...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21029"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21035"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21036"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21037"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21038"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21039"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21040"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21041"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21042"
}
```
...
```json
{
    ...
    "title_was": "[negative review] Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21043"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21044"
}
```
...
```json
{
    ...
    "title_was": "[with negative review] Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21045"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.10.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21046"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21047"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21048"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21049"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21052"
}
```
...
```json
{
    ...
    "title_was": "Write a clearer submatrix implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2355",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2355#event-21057"
}
```
