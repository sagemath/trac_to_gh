...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2625/pb_singular.patch",
    "created_at": "2008-03-26T06:27:18Z",
    "issue": "https://github.com/sagemath/sage/issues/2625",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2625/pb_singular.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2625#issuecomment-14314",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2625#issuecomment-14315",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2625#issuecomment-14316",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2625#issuecomment-14317",
    "user": "https://github.com/malb"
}
```
