...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21356",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21357",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, positive review] ATLAS 3.8.1: Fix Itanium 2 detection on Itanium/gcc compiler flags on RHEL5/Itanium"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2954#event-10492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21358",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2954#event-10493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21359",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21360",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
