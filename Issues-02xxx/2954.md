...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21977",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21978",
...
```json
{
    "body": "<a id='comment:3'></a>Build time on Itanium is quite bad, especially compared to x86-64, but I guess that it is partially the fault of gcc 4.1.1 I used.\n\nOh well,\n\nMichael",
    "created_at": "2008-04-19T06:52:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21979",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Build time on Itanium is quite bad, especially compared to x86-64, but I guess that it is partially the fault of gcc 4.1.1 I used.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21980",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2954#issuecomment-21981",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
