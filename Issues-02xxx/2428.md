...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25238"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25239"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25241"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2428#issuecomment-12308",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25243"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25244"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2428#event-25245"
}
```
