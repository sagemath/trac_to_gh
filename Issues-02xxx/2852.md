...
```json
{
    ...
    "rename": {
        "from": "ctrl-enter broken in firefox/linux",
        "to": "[with patch, needs review] ctrl-enter broken in firefox/linux"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2852#event-10071"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2852#issuecomment-20503",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2852#issuecomment-20504",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2852",
    "rename": {
        "from": "[with patch, needs review] ctrl-enter broken in firefox/linux",
        "to": "[with patch, positive review] ctrl-enter broken in firefox/linux"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2852#event-10072"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2852#event-10073"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2852#issuecomment-20505",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2852#issuecomment-20506",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
