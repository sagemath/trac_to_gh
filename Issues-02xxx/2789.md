...
```json
{
    "body": "<a id='comment:2'></a>This now works without major changes... but I found a show stopper bug.  It had to do with hashing \"large\" residue fields, meaning large characteristic residue fields.  The hash method tried to hash an ideal of the residue field itself, which tried to hash its parent, leading to an infinite loop.\n\nThis means that at no time has a residue field with cardinality a very large prime been created in Sage!\n\nI've added the obvious .ideal() method, tested the hashing and construction for larger examples, and added doctests showing Groebner basis computations.",
    "created_at": "2009-01-22T09:02:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19618",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:2'></a>This now works without major changes... but I found a show stopper bug.  It had to do with hashing "large" residue fields, meaning large characteristic residue fields.  The hash method tried to hash an ideal of the residue field itself, which tried to hash its parent, leading to an infinite loop.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19619",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19620",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19621",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19622",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19623",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2789#issuecomment-19625",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
