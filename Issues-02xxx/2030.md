...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17918"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17919"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17920"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17921"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2030#issuecomment-10210",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2030#issuecomment-10211",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17924"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2030",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2030#issuecomment-10212",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2030",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2030#event-17926"
}
```
