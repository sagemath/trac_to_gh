# Issue 2395: [with patch, positive review] New features for number fields (gap interface, matrix groups)
...
```json
{
    ...
    "title": "[with patch, positive review] New features for number fields (gap interface, matrix groups)",
    "type": "issue",
