...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2326#issuecomment-12137",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2326#issuecomment-12138",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2326#issuecomment-12139",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2326#issuecomment-12140",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>\nAttachment [2326-final.patch](https://github.com/sagemath/sage/files/ticket2326/2326-final.patch) by @jasongrout created at 2008-03-01 10:24:41\n\nSorry for the caps, but I just wanted to make sure mabshoff saw it :)  It looks good to me.",
    "created_at": "2008-03-01T10:24:41Z",
    "issue": "https://github.com/sagemath/sage/issues/2326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2326#issuecomment-12141",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2326",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2326#issuecomment-12142",
