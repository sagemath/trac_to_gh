...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20629"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20634"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20636"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20637"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20638"
}
```
...
```json
{
    ...
    "title_was": "segfault in p-adic extension() method",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20639"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2325",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20640"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2325#issuecomment-12143",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2325#issuecomment-12144",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2325#issuecomment-12145",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2325#issuecomment-12146",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2325",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2325#event-20644"
}
```
