...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14708",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "rename": {
        "from": "[with patch, needs review] wrap scipy optimization routines and cvxopt linear programming, add gradient/hessian to calculus",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2143#event-7362"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review ] wrap scipy optimization routines and cvxopt linear programming, add gradient/hessian to calculus"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2143#event-7363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14709",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14710",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14711",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2143#event-7364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14712",
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review ] wrap scipy optimization routines and cvxopt linear programming, add gradient/hessian to calculus",
        "to": "[with patch; positive review ] wrap scipy optimization routines and cvxopt linear programming, add gradient/hessian to calculus"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2143#event-7365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14713",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2143#event-7366"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14714",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14715",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14716",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14717",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2143#issuecomment-14718",
    "user": "https://trac.sagemath.org/admin/accounts/users/edrex"
}
```
