...
<a id='comment:1'></a>Clicking the link gives:
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [optimize.patch](tarball://root/attachments/some-uuid/ticket2143/optimize.patch) by @dfdeshom created at 2008-03-03 21:05:13\n\nAttaching the patch on trac for convenience...",
...
<a id='comment:4'></a>Attachment [optimize.patch](tarball://root/attachments/some-uuid/ticket2143/optimize.patch) by @dfdeshom created at 2008-03-03 21:05:13
...
```json
{
    "body": "<a id='comment:7'></a>I fixed some typos and formatting issues. Both 2143.patch and 2143-2.patch should be applied.",
...
<a id='comment:7'></a>I fixed some typos and formatting issues. Both 2143.patch and 2143-2.patch should be applied.
...
```json
{
    "body": "<a id='comment:8'></a>Merged 2143.patch and 2143-2.patch in Sage 2.10.4.rc0",
    "created_at": "2008-03-16T02:57:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2143",
    "type": "issue_comment",
...
<a id='comment:8'></a>Merged 2143.patch and 2143-2.patch in Sage 2.10.4.rc0
...
<a id='comment:10'></a>These are actually different things.
...
```json
{
    "body": "<a id='comment:11'></a>Ah... I like the f(x,y)=x<sup>2+y</sup>2 syntax/construction better, since it makes the mapping explicit for expressions which may not contain all variables. Filed as #2547",
...
<a id='comment:11'></a>Ah... I like the f(x,y)=x<sup>2+y</sup>2 syntax/construction better, since it makes the mapping explicit for expressions which may not contain all variables. Filed as #2547
