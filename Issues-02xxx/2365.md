...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] with sage -wthread, attach runs code in wrong thread on subsequent loads",
        "to": "[with patch, with positive review] with sage -wthread, attach runs code in wrong thread on subsequent loads"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2365#event-8250"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2365#issuecomment-16704",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2365#event-8251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2365#issuecomment-16705",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2365#issuecomment-16706",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
