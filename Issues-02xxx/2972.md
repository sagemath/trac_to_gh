...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16318",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16319",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16320",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15665"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2972/sage-2972.patch",
    "created_at": "2008-04-21T03:14:03Z",
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2972/sage-2972.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [sage-2972.patch](https://github.com/sagemath/sage/files/ticket2972/sage-2972.patch) by @williamstein created at 2008-04-21 03:14:03\n\nI posted a patch that disables weakrefs, which appears to fix the problem.\n\nThis isn't too much of a tradeoff.",
    "created_at": "2008-04-21T03:14:03Z",
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16321",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16322",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16323",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15666"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15667"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16324",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
