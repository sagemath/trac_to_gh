...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16326",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16327",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16328",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [sage-2972.patch](https://github.com/sagemath/sage/files/ticket2972/sage-2972.patch)\n\nI posted a patch that disables weakrefs, which appears to fix the problem.\n\nThis isn't too much of a tradeoff.",
    "created_at": "2008-04-21T03:14:03Z",
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2972#issuecomment-16329",
    "user": "https://github.com/williamstein"
}
```
