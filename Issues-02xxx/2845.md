...
```json
{
    "body": "Attachment [polybori_assert.patch](https://github.com/sagemath/sage/files/ticket2845/polybori_assert.patch) by @malb created at 2008-04-07 16:15:02",
    "created_at": "2008-04-07T16:15:02Z",
    "issue": "https://github.com/sagemath/sage/issues/2845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2845#issuecomment-15530",
    "user": "https://github.com/malb"
}
```

Attachment [polybori_assert.patch](https://github.com/sagemath/sage/files/ticket2845/polybori_assert.patch) by @malb created at 2008-04-07 16:15:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2845#issuecomment-15531",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2845#issuecomment-15532",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2845#issuecomment-15533",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2845#issuecomment-15534",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
