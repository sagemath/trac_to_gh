...
```json
{
    "body": "<a id='comment:3'></a>Patch passes doctest on Sage 3.0.alpha4. Somebody else needs to take a closer look and figure out of all of this is a good idea.\n\nCheers,\n\nMichael",
...
<a id='comment:3'></a>Patch passes doctest on Sage 3.0.alpha4. Somebody else needs to take a closer look and figure out of all of this is a good idea.
...
```json
{
    "body": "<a id='comment:4'></a>It all looks good to me.  testall passes (on 3.0 alpha3), the new code in parent.pyx is equivalent and plausibly faster (although I didn't benchmark it), and reducing optimization on .spyx files from -O3 to -O2 is good.",
...
<a id='comment:4'></a>It all looks good to me.  testall passes (on 3.0 alpha3), the new code in parent.pyx is equivalent and plausibly faster (although I didn't benchmark it), and reducing optimization on .spyx files from -O3 to -O2 is good.
