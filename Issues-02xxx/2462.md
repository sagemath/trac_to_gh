...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22212"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22213"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22215"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22218"
}
```
...
```json
{
    "body": "Removed assignee **@robertwb**",
    "created_at": "2008-10-29T15:38:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/2462",
    "type": "issue_comment",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22219"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22221"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2462#issuecomment-13163",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2462#issuecomment-13164",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22223"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2462#issuecomment-13165",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22224"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22225"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2462",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2462#event-22227"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2462",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2462#issuecomment-13166",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
