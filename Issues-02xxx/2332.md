...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2332#issuecomment-16339",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2332",
    "rename": {
        "from": "notebook -- the evaluate link doesn't",
        "to": "[with patch, needs review] notebook -- the evaluate link doesn't"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2332#event-8085"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2332#issuecomment-16340",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2332#event-8086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2332",
    "rename": {
        "from": "[with patch, needs review] notebook -- the evaluate link doesn't",
        "to": "[with patch, positive review] notebook -- the evaluate link doesn't"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2332#event-8087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2332#issuecomment-16341",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2332",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2332#event-8088"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2332#issuecomment-16342",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2332",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2332#issuecomment-16343",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
