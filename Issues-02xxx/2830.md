...
```json
{
    ...
    "rename": {
        "from": "ace-5.0.spkg fails to install",
        "to": "[with spkg, positive review] ace-5.0.spkg fails to install"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2830#event-9998"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2830#issuecomment-20349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2830#issuecomment-20350",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2830#issuecomment-20351",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2830",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2830#event-9999"
}
```
