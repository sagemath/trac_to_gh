...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2739#event-6367"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2739",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2739#event-6368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2739#issuecomment-19296",
...
```json
{
    "body": "<a id='comment:1'></a>Due to Harald Schilly's hard work we now have\n\nhttp://sagemath.org/tour.html\n\nwhich I consider a solution to the above ticket. So I am considering this issue resolved and should more specific issues be raised those should be done via new tickets.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-31T03:32:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2739",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2739#issuecomment-19297",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Due to Harald Schilly's hard work we now have
