...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2301#issuecomment-11969",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2301#issuecomment-11970",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2301#issuecomment-11971",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2301#issuecomment-11972",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2301#issuecomment-11973",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2301#issuecomment-11974",
    "user": "https://github.com/simon-king-jena"
}
```
...
archive/attachments_002014.json:
```json
{
...
archive/attachments_002015.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [sage_structured_str_list.2.patch](https://github.com/sagemath/sage/files/ticket2301/sage_structured_str_list.2.patch) by @simon-king-jena created at 2008-02-27 08:54:20",
    "created_at": "2008-02-27T08:54:20Z",
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
...
Attachment [sage_structured_str_list.2.patch](https://github.com/sagemath/sage/files/ticket2301/sage_structured_str_list.2.patch) by @simon-king-jena created at 2008-02-27 08:54:20



---

archive/attachments_002016.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [riemann_roch_basis.2.patch](https://github.com/sagemath/sage/files/ticket2301/riemann_roch_basis.2.patch) by @simon-king-jena created at 2008-02-27 08:55:03",
    "created_at": "2008-02-27T08:55:03Z",
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
...
Attachment [riemann_roch_basis.2.patch](https://github.com/sagemath/sage/files/ticket2301/riemann_roch_basis.2.patch) by @simon-king-jena created at 2008-02-27 08:55:03
...
archive/attachments_002017.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:18'></a>\nAttachment [trac_2301_superpatch.patch](https://github.com/sagemath/sage/files/ticket2301/trac_2301_superpatch.patch) by @malb created at 2008-02-27 13:02:31\n\nmabshoff, please apply `trac_2301_superpatch.patch` it contains **exactly** the same code as Simon's patches. Credits go to Simon King. `make test` passes.",
    "created_at": "2008-02-27T13:02:31Z",
    "issue": "https://github.com/sagemath/sage/issues/2301",
    "type": "issue_comment",
