...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16475",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16476",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Sorry, the bug is in sage_**structured**_str_list, rather than in ..._flattened_...",
    "created_at": "2008-02-26T07:48:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16477",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:2'></a>Sorry, the bug is in sage_**structured**_str_list, rather than in ..._flattened_...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16479",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16481",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16483",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>> 1. Change `riemann_roch_basis`, since it relies on getting a *wrong* answer from `sage_structured_str_list`\n> \n> 2. Change `sage_structured_str_list` so that not only singular lists are turned into a sage list, but also singular ideals and intvecs are turned into lists.\n> \n> I prefer the first option, since the second option clearly violates the specification of `sage_structured_str_list`.\n\n\nThis seems reasonable, however we should contact the original author (I don't know this area of the code). I assume it is William whom I hereby CC.\n \n> Anyway, i think we will only be able to fix the bug later.\n\n\nUntil we have figured this one out I think we shouldn't merge the patch. However, this seems to be something that can be resolved quickly.",
    "created_at": "2008-02-27T00:15:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16485",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>> 1. Change `riemann_roch_basis`, since it relies on getting a *wrong* answer from `sage_structured_str_list`
> 
> 2. Change `sage_structured_str_list` so that not only singular lists are turned into a sage list, but also singular ideals and intvecs are turned into lists.
> 
> I prefer the first option, since the second option clearly violates the specification of `sage_structured_str_list`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16486",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16487",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16488",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Replying to [malb](#comment%3A7):\n> Unfortunately I don't know such a function. But I see the point that it is a matter of taste. However, I still prefer the first option because `_[1] = 0` depends on the index of the list ([1]) while just `0` doesn't.\n\n\nAnd, by the way, i prefer the first option as well, and the patches work accordingly.",
    "created_at": "2008-02-27T09:14:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16489",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:12'></a>Replying to [malb](#comment%3A7):
> Unfortunately I don't know such a function. But I see the point that it is a matter of taste. However, I still prefer the first option because `_[1] = 0` depends on the index of the list ([1]) while just `0` doesn't.
...
```json
{
    "body": "<a id='comment:13'></a>Patches look good. Positive review.",
    "created_at": "2008-02-27T11:10:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16490",
    "user": "https://github.com/malb"
}
```

<a id='comment:13'></a>Patches look good. Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16495",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Attachment [trac_2301_superpatch.patch](tarball://root/attachments/some-uuid/ticket2301/trac_2301_superpatch.patch) by @malb created at 2008-02-27 13:02:31\n\nmabshoff, please apply `trac_2301_superpatch.patch` it contains **exactly** the same code as Simon's patches. Credits go to Simon King. `make test` passes.",
    "created_at": "2008-02-27T13:02:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16496",
    "user": "https://github.com/malb"
}
```

<a id='comment:18'></a>Attachment [trac_2301_superpatch.patch](tarball://root/attachments/some-uuid/ticket2301/trac_2301_superpatch.patch) by @malb created at 2008-02-27 13:02:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16497",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Merged trac_2301_superpatch.patch in Sage 2.10.3.rc0",
    "created_at": "2008-02-27T21:28:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16499",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:22'></a>Merged trac_2301_superpatch.patch in Sage 2.10.3.rc0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16500",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>This appears to cause a failure in another module:\n\nsage -t  devel/sage-rrspace/sage/interfaces/singular.py\n**********************************************************************\nFile \"singular.py\", line 1117:\n   sage: RL.sage_structured_str_list()\nExpected:\n   ['0', ['x', 'y'], [['dp', '1,\\n1 '], ['C', '0 ']], '0']\nGot:\n   [[], [], [], [], [], [], [], [], [], [], [], ['0']]\n**********************************************************************",
    "created_at": "2008-02-28T02:36:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16502",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:24'></a>This appears to cause a failure in another module:
...
```json
{
    "body": "<a id='comment:25'></a>Ignore my last comment. (I ran the test incorrectly.)",
    "created_at": "2008-02-28T11:35:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16503",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:25'></a>Ignore my last comment. (I ran the test incorrectly.)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16505",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:28'></a>Replying to [mabshoff](#comment%3A27):\n> I am under the impression that malb's patch merged all your patches, but please verify with 2.10.3.rc0. \n\n\nYes, everything is in.",
    "created_at": "2008-02-29T22:29:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2301",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2301#issuecomment-16506",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:28'></a>Replying to [mabshoff](#comment%3A27):
> I am under the impression that malb's patch merged all your patches, but please verify with 2.10.3.rc0. 
