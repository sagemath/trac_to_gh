...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28416"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28417"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28419"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2688#issuecomment-14011",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2688#issuecomment-14012",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28423"
}
```
...
```json
{
    ...
    "title_was": "Kuratowski subgraph isolator for planarity checking",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28424"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2688#issuecomment-14013",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28425"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2688#issuecomment-14014",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2688",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2688#issuecomment-14015",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28426"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2688",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2688#event-28427"
}
```
