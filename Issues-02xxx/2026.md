...
```json
{
    "body": "Attachment [trac-2026.patch](https://github.com/sagemath/sage/files/ticket2026/trac-2026.patch) by @williamstein created at 2008-02-01 23:11:04",
    "created_at": "2008-02-01T23:11:04Z",
    "issue": "https://github.com/sagemath/sage/issues/2026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2026#issuecomment-10174",
    "user": "https://github.com/williamstein"
}
```

Attachment [trac-2026.patch](https://github.com/sagemath/sage/files/ticket2026/trac-2026.patch) by @williamstein created at 2008-02-01 23:11:04
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2026#issuecomment-10175",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [eigenspace-docs.2.patch](https://github.com/sagemath/sage/files/ticket2026/eigenspace-docs.2.patch) by @jasongrout created at 2008-02-01 23:39:21\n\nApply instead of first patch (this includes the first patch)",
    "created_at": "2008-02-01T23:39:21Z",
    "issue": "https://github.com/sagemath/sage/issues/2026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2026#issuecomment-10176",
    "user": "https://github.com/jasongrout"
}
```

Attachment [eigenspace-docs.2.patch](https://github.com/sagemath/sage/files/ticket2026/eigenspace-docs.2.patch) by @jasongrout created at 2008-02-01 23:39:21
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2026#issuecomment-10177",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2026#issuecomment-10178",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2026#issuecomment-10179",
