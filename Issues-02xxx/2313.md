...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2313#issuecomment-16586",
...
```json
{
    "body": "<a id='comment:1'></a>Now that #463 is merged this ticket can be closed since -upgrade will delete any older and no longer used spkgs.\n\nCheers,\n\nMichael",
    "created_at": "2008-12-02T02:21:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2313",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2313#issuecomment-16587",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Now that #463 is merged this ticket can be closed since -upgrade will delete any older and no longer used spkgs.
