...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2498#issuecomment-13341",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2498#issuecomment-13342",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2498#issuecomment-13343",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2498/2498_factor_pari.patch",
    "created_at": "2008-03-22T19:54:47Z",
    "issue": "https://github.com/sagemath/sage/issues/2498",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2498/2498_factor_pari.patch",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [2498_factor_pari.patch](https://github.com/sagemath/sage/files/ticket2498/2498_factor_pari.patch) by @aghitza created at 2008-03-22 19:54:47\n\nYes, it should be possible to do something smart here.  For now, I'm just making factor() and is_irreducible() throw NotImplementedError so we don't get wrong answers.\n\nSee the attached patch.",
    "created_at": "2008-03-22T19:54:47Z",
    "issue": "https://github.com/sagemath/sage/issues/2498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2498#issuecomment-13344",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2498#issuecomment-13345",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2498#issuecomment-13346",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2498",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2498#issuecomment-13347",
    "user": "https://github.com/JohnCremona"
}
```
