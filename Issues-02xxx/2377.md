...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-16780",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "rename": {
        "from": "[with patch, needs review] Bugfix for the new __copy__ method of SingularElement",
        "to": "[with patch, with positive review] Bugfix for the new __copy__ method of SingularElement"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2377#event-8303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-16781",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2377#event-8304"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-16782",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-16783",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
