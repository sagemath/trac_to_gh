# Issue 2377: [with positive review] Bugfix for the new __copy__ method of SingularElement
...
```json
{
    ...
    "title": "[with positive review] Bugfix for the new __copy__ method of SingularElement",
    "type": "issue",
...
archive/attachments_002137.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "bugfix__copy__.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket2377/bugfix__copy__.patch",
...
```json
{
    "body": "Bugfix for the new copy method for SingularElement?; should apply to sage-2.10.3.rc0",
    "created_at": "2008-03-03T17:17:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-17734",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "rename": {
        "from": "Bugfix for the new __copy__ method of SingularElement",
        "to": "[with positive review] Bugfix for the new __copy__ method of SingularElement"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2377#event-7049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-17735",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2377#event-7050"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-17736",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2377#issuecomment-17737",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
