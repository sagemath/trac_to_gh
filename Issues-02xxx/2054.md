...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2054#issuecomment-10330",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2054/scripts_2054.patch",
    "created_at": "2010-02-02T19:53:15Z",
    "issue": "https://github.com/sagemath/sage/issues/2054",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2054/scripts_2054.patch",
...
```json
{
    "body": "Attachment [scripts_2054.patch](https://github.com/sagemath/sage/files/ticket2054/scripts_2054.patch) by @mwhansen created at 2010-02-02 19:53:15",
    "created_at": "2010-02-02T19:53:15Z",
    "issue": "https://github.com/sagemath/sage/issues/2054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2054#issuecomment-10331",
    "user": "https://github.com/mwhansen"
}
```

Attachment [scripts_2054.patch](https://github.com/sagemath/sage/files/ticket2054/scripts_2054.patch) by @mwhansen created at 2010-02-02 19:53:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2054#issuecomment-10332",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2054#issuecomment-10334",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2054",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2054#issuecomment-10335",
    "user": "https://trac.sagemath.org/admin/accounts/users/rossk"
}
```
