...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2256",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19977"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2256#issuecomment-11714",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2256#event-19978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2256#issuecomment-11715",
    "user": "https://github.com/ncalexan"
}
```
