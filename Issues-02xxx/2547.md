...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23494"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23497"
}
```
...
```json
{
    "body": "Changed assignee from **@wdjoyner** to **@garyfurnish**",
...
Changed assignee from **@wdjoyner** to **@garyfurnish**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2547",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23500"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.10.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23501"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23503"
}
```
...
```json
{
    "body": "Changed assignee from **@garyfurnish** to **@sagetrac-jkantor**",
...
Changed assignee from **@garyfurnish** to **@sagetrac-jkantor**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23504"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23505"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23506"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23507"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-jkantor** to **@jicama**",
    "created_at": "2008-09-01T04:33:55Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/2547",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-jkantor** to **@jicama**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23510"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2547",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2547#event-23511"
}
```
