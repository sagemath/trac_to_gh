...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13286",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>(I think the preview of the attached file is broken and only shows the second half.  So you should download the file and view it locally.)",
    "created_at": "2008-01-31T06:40:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13287",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>(I think the preview of the attached file is broken and only shows the second half.  So you should download the file and view it locally.)
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [Sage-2.10.1.rc4-matrix_group.py-long-doctest-failure.patch](tarball://root/attachments/some-uuid/ticket2001/Sage-2.10.1.rc4-matrix_group.py-long-doctest-failure.patch) by mabshoff created at 2008-01-31 08:17:25\n\n`schemes/elliptic_curves/sha.py` also works fine, it just timed out with the 3 minute default timeout value. There is also a patch up for the `groups/matrix_gps/matrix_group.py` doctest failure.\n\nCheers,\n\nMichael",
    "created_at": "2008-01-31T08:17:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13289",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Attachment [Sage-2.10.1.rc4-matrix_group.py-long-doctest-failure.patch](tarball://root/attachments/some-uuid/ticket2001/Sage-2.10.1.rc4-matrix_group.py-long-doctest-failure.patch) by mabshoff created at 2008-01-31 08:17:25
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13290",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Four down, three to go. I am wandering if we shouldn't remove the two remaining `#long` from  gen.pyx since doctesting with the long option needs 12 seconds versus 5 seconds without.",
    "created_at": "2008-01-31T08:34:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13291",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Four down, three to go. I am wandering if we shouldn't remove the two remaining `#long` from  gen.pyx since doctesting with the long option needs 12 seconds versus 5 seconds without.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13293",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [trac-2001-rest_of_problems.patch](tarball://root/attachments/some-uuid/ticket2001/trac-2001-rest_of_problems.patch) by mabshoff created at 2008-02-02 09:51:39\n\nAll three patches look good, i.e. was reviewed mine and the other way around.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-02T09:51:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13294",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:6'></a>Attachment [trac-2001-rest_of_problems.patch](tarball://root/attachments/some-uuid/ticket2001/trac-2001-rest_of_problems.patch) by mabshoff created at 2008-02-02 09:51:39
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13295",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Merged all three patches in Sage 2.10.1.rc5",
    "created_at": "2008-02-02T09:52:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2001",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2001#issuecomment-13296",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged all three patches in Sage 2.10.1.rc5
