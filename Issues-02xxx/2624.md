...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23946"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23948"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23949"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23951"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2624",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23953"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23956"
}
```
...
```json
{
    "body": "Changed assignee from **mabshoff** to **@jhpalmieri**",
    "created_at": "2009-09-21T22:42:38Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/2624",
    "type": "issue_comment",
...
Changed assignee from **mabshoff** to **@jhpalmieri**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23957"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23958"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23959"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2624",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2624#event-23961"
}
```
