...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10660"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11183",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11184",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11185",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11186",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11187",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11188",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "rename": {
        "from": "cython skipping build optimization",
        "to": "cython skipping (build optimization)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10662"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11189",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2180#issuecomment-11190",
    "user": "https://github.com/williamstein"
}
```
...
archive/attachments_001847.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage-2180.patch",
    "asset_url": "tarball://root/attachments/ticket2180/sage-2180.patch",
    "created_at": "2008-02-24T09:22:45Z",
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2180/sage-2180.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>\nAttachment [sage-2180.patch](https://github.com/sagemath/sage/files/ticket2180/sage-2180.patch) by mabshoff created at 2008-02-24 09:22:45",
    "created_at": "2008-02-24T09:22:45Z",
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10663"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10664"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10665"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2180",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2180#event-10667"
}
```
