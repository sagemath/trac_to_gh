...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15573",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [crystal_weights.patch](https://github.com/sagemath/sage/files/ticket2853/crystal_weights.patch) by mabshoff created at 2008-04-08 08:57:44",
    "created_at": "2008-04-08T08:57:44Z",
    "issue": "https://github.com/sagemath/sage/issues/2853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15574",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Attachment [2853.patch](https://github.com/sagemath/sage/files/ticket2853/2853.patch) by @mwhansen created at 2008-04-08 09:28:25",
    "created_at": "2008-04-08T09:28:25Z",
    "issue": "https://github.com/sagemath/sage/issues/2853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15575",
    "user": "https://github.com/mwhansen"
}
```

Attachment [2853.patch](https://github.com/sagemath/sage/files/ticket2853/2853.patch) by @mwhansen created at 2008-04-08 09:28:25
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15576",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15577",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15578",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15579",
    "user": "https://github.com/dwbump"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\nAttachment [2853.1.patch](https://github.com/sagemath/sage/files/ticket2853/2853.1.patch) by @dwbump created at 2008-04-08 23:17:29\n\nIt turns out that I had forgotten the G2 patch that went in on Saturday.\n\nI corrected the patch and added it as 2853.1.patch. I believe it is now\ncorrect.\n\nDan",
    "created_at": "2008-04-08T23:17:29Z",
    "issue": "https://github.com/sagemath/sage/issues/2853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2853#issuecomment-15580",
    "user": "https://github.com/dwbump"
}
```
