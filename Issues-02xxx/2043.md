...
```json
{
    ...
    "title": "[with spkg] add proper LDFLAGS to libpng.spkg",
    "type": "issue",
...
```json
{
    "body": "<a id='comment:1'></a>This is a dupe of #2068 - William needs to pay more attention to trac :)\n\nCheers,\n\nMichael",
    "created_at": "2008-02-17T23:43:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2043#issuecomment-14257",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>This is a dupe of #2068 - William needs to pay more attention to trac :)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2043",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2043#event-4907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2043#issuecomment-14258",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
