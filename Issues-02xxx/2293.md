...
```json
{
    "body": "<a id='comment:4'></a>The patch for #2292 fixes this.",
...
<a id='comment:4'></a>The patch for #2292 fixes this.
...
```json
{
    "body": "<a id='comment:5'></a>Fixed due to the patch at #2292 merged in Sage 2.10.3.rc0",
...
<a id='comment:5'></a>Fixed due to the patch at #2292 merged in Sage 2.10.3.rc0
