# Issue 2562: [with patch, positive review] minor symbolic doc things
...
```json
{
    ...
    "title": "[with patch, positive review] minor symbolic doc things",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18832",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Most of the issues above (as well as the typos in the patch) are no longer in Sage.  Of those that are, the issue about inexactness is fine, because 1.9393 is not in fact in SR, but SR(1.9393) is inexact in that sense.  \n\nIt is true that help for is_SymbolicVariable and is_SymbolicExpressionRing is nonexistent, for Python reasons, apparently:\n\n```\nsage: is_SymbolicExpressionRing??\nError getting source: could not find class definition\nType: partial\n...\npartial(func, *args, **keywords) - new function with partial application of the given arguments and keywords.\n```\nBut this can go on a new ticket.\n\nThe new patch fixes the rest.",
    "created_at": "2009-09-04T18:51:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18833",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:1'></a>Most of the issues above (as well as the typos in the patch) are no longer in Sage.  Of those that are, the issue about inexactness is fine, because 1.9393 is not in fact in SR, but SR(1.9393) is inexact in that sense.  
...
```json
{
    "body": "<a id='comment:3'></a>> Paul, do you have any suggestions on how to improve the documentation (especially around the place you mentioned) with regards to this issue? \n\n\nI believe one could simply avoid the wording \"exact\" or \"inexact\" in that context.\n\nPaul",
    "created_at": "2009-09-10T14:03:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18835",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:3'></a>> Paul, do you have any suggestions on how to improve the documentation (especially around the place you mentioned) with regards to this issue? 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18837",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18838",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I think a new ticket should be opened and/or a question asked on sage-devel on this, since it is clearly not  \"minor symbolic doc thing\" :)  If the current patch is okay, though, this issue shouldn't stop it from getting a positive review, going in, and improving the documentation on those issues.  As I said above, I don't understand the exact/inexact stuff.",
    "created_at": "2009-09-12T23:52:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18840",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:6'></a>I think a new ticket should be opened and/or a question asked on sage-devel on this, since it is clearly not  "minor symbolic doc thing" :)  If the current patch is okay, though, this issue shouldn't stop it from getting a positive review, going in, and improving the documentation on those issues.  As I said above, I don't understand the exact/inexact stuff.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18843",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18844",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Merged `trac_2562-minor-symb-docs.patch`.",
    "created_at": "2009-09-23T04:06:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18845",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```

<a id='comment:9'></a>Merged `trac_2562-minor-symb-docs.patch`.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18846",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2562",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2562#issuecomment-18847",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
