...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2878#issuecomment-20754",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2878#issuecomment-20755",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2878",
    "rename": {
        "from": "notebook -- cython .c and .html links should open in new links (use target=\"_new\"",
        "to": "[with patch; needs review] notebook -- cython .c and .html links should open in new links (use target=\"_new\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2878#event-10184"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2878",
    "rename": {
        "from": "[with patch; needs review] notebook -- cython .c and .html links should open in new links (use target=\"_new\"",
        "to": "[with patch; positive review] notebook -- cython .c and .html links should open in new links (use target=\"_new\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2878#event-10185"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2878#issuecomment-20756",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2878#issuecomment-20757",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2878",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2878#issuecomment-20758",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2878",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2878#event-10186"
}
```
