...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2010#event-17456"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2010#event-17457"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2010#event-17458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2010#event-17459"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2010",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2010#event-17460"
}
```
