...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-26070"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-26071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-26072"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-26073"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2496",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-26074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2496#issuecomment-12677",
    "user": "https://github.com/williamstein"
}
```
