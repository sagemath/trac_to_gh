...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-22561"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-22562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-22563"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-22564"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2496",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2496#event-22565"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2496",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2496#issuecomment-13346",
    "user": "https://github.com/williamstein"
}
```
