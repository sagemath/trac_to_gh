...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30622"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30623"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30624"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30625"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2887#issuecomment-15079",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30628"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2887#issuecomment-15080",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2887",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2887#event-30630"
}
```
