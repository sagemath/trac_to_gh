...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2887#issuecomment-15806",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [sage-2887.patch](https://github.com/sagemath/sage/files/ticket2887/sage-2887.patch) by mabshoff created at 2008-04-12 09:58:26\n\nMerged in Sage 3.0.alpha4",
    "created_at": "2008-04-12T09:58:26Z",
    "issue": "https://github.com/sagemath/sage/issues/2887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2887#issuecomment-15807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
