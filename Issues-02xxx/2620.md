...
```json
{
    "body": "<a id='comment:1'></a>Attachment [generator_generator.patch](tarball://root/attachments/some-uuid/ticket2620/generator_generator.patch) by mabshoff created at 2008-04-01 14:30:40\n\nPatch looks good to me. Doctests pass. Positive review.\n\nCheers,\n\nMichael",
...
<a id='comment:1'></a>Attachment [generator_generator.patch](tarball://root/attachments/some-uuid/ticket2620/generator_generator.patch) by mabshoff created at 2008-04-01 14:30:40
