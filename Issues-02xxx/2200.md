...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14854",
...
```json
{
    "body": "<a id='comment:3'></a>Regarding genus2reduction, i should probably get a clear copyright license statement from Qing Liu, who said to me only\n\n```\nFrom Qing.Liu@math.u-bordeaux1.fr Sat Jul 16 23:33:18 2005\nReturn-path: <Qing.Liu@math.u-bordeaux1.fr>\n\nHi William,\n\nIt will be a pleasure for me that you include genus2reduction in SAGE.\nNote however that the program is not maintained anymore.  Please\nfeel free to make any technical modifications to make it compile\nin recent systems.\n\nBest regards,\n\nLiu\n\n```",
    "created_at": "2008-02-17T22:15:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14856",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Regarding genus2reduction, i should probably get a clear copyright license statement from Qing Liu, who said to me only
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14857",
...
```json
{
    "body": "<a id='comment:6'></a>I've pinged the genus2reduction author.\n\nWilliam",
    "created_at": "2008-02-17T23:08:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14859",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>I've pinged the genus2reduction author.
...
```json
{
    "body": "<a id='comment:7'></a>I've received written permission from Liu to GPL genus2reduction, and have done so.  The new package is here:\n\nhttp://sage.math.washington.edu/home/was/patches/genus2reduction-0.3.p2.spkg\n\nPlease switch to this.",
    "created_at": "2008-02-18T00:06:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14860",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:7'></a>I've received written permission from Liu to GPL genus2reduction, and have done so.  The new package is here:
...
```json
{
    "body": "<a id='comment:8'></a>Okay, I've attached a Debian copyright file for genus2reduction to #2199.",
    "created_at": "2008-02-18T00:27:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14861",
    "user": "https://github.com/timabbott"
}
```

<a id='comment:8'></a>Okay, I've attached a Debian copyright file for genus2reduction to #2199.
...
```json
{
    "body": "<a id='comment:9'></a>The genus2reduction.spkg has been merged a while ago. The issue about tachyon's BSD status should be on a new ticket.\n\nCheers,\n\nMichael",
    "created_at": "2008-04-01T20:38:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14862",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>The genus2reduction.spkg has been merged a while ago. The issue about tachyon's BSD status should be on a new ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2200",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2200#issuecomment-14863",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
