...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2311/scripts-2311.patch",
    "created_at": "2008-02-26T04:45:41Z",
    "issue": "https://github.com/sagemath/sage/issues/2311",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2311/scripts-2311.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [scripts-2311.patch](https://github.com/sagemath/sage/files/ticket2311/scripts-2311.patch) by @williamstein created at 2008-02-26 04:45:41",
    "created_at": "2008-02-26T04:45:41Z",
    "issue": "https://github.com/sagemath/sage/issues/2311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2311#issuecomment-12052",
    "user": "https://github.com/williamstein"
}
```

Attachment [scripts-2311.patch](https://github.com/sagemath/sage/files/ticket2311/scripts-2311.patch) by @williamstein created at 2008-02-26 04:45:41
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2311#issuecomment-12053",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2311#issuecomment-12054",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2311#issuecomment-12055",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
