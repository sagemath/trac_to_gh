...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2111#issuecomment-14847",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2111#issuecomment-14848",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Both patches look good, there's a lot to like in the first patch.  Apply!\n\nI personally prefer long outputs of doctests to be all one line -- I find it makes it easier to find errors -- but that's no reason to reject a good patch :)",
    "created_at": "2008-02-15T03:54:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2111#issuecomment-14849",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:1'></a>Both patches look good, there's a lot to like in the first patch.  Apply!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2111#issuecomment-14850",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2111#issuecomment-14851",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
