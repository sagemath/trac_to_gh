...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2040#issuecomment-10269",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2040/plot.patch",
    "created_at": "2008-05-13T21:54:26Z",
    "issue": "https://github.com/sagemath/sage/issues/2040",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2040/plot.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [plot.patch](https://github.com/sagemath/sage/files/ticket2040/plot.patch) by @jhpalmieri created at 2008-05-13 21:54:26\n\nI've attached a patch for point 1.  I don't know anything about point 2.",
    "created_at": "2008-05-13T21:54:26Z",
    "issue": "https://github.com/sagemath/sage/issues/2040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2040#issuecomment-10270",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2040/plot2.patch",
    "created_at": "2008-05-13T21:57:34Z",
    "issue": "https://github.com/sagemath/sage/issues/2040",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2040/plot2.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "Attachment [plot2.patch](https://github.com/sagemath/sage/files/ticket2040/plot2.patch) by @jhpalmieri created at 2008-05-13 21:57:34\n\nshow axes_labels when called from command line",
    "created_at": "2008-05-13T21:57:34Z",
    "issue": "https://github.com/sagemath/sage/issues/2040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2040#issuecomment-10271",
    "user": "https://github.com/jhpalmieri"
}
```

Attachment [plot2.patch](https://github.com/sagemath/sage/files/ticket2040/plot2.patch) by @jhpalmieri created at 2008-05-13 21:57:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2040#issuecomment-10272",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2040#issuecomment-10273",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2040",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2040#issuecomment-10274",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
