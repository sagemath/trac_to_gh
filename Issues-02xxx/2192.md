...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19646"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19647"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19650"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19651"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2192#issuecomment-11254",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19653"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2192#issuecomment-11255",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2192",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2192#event-19655"
}
```
