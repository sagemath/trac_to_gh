...
```json
{
    "body": "<a id='comment:8'></a>See also #19502 for a possibly related bug (or possibly not).",
...
<a id='comment:8'></a>See also #19502 for a possibly related bug (or possibly not).
