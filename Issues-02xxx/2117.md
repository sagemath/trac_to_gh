...
```json
{
    "body": "<a id='comment:1'></a>As we don't get the URL at the beginning with the startup token, I'm going to mark this as invalid.  I can't reproduce it in 3.2.3.",
    "created_at": "2009-01-23T13:22:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2117#issuecomment-14249",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:1'></a>As we don't get the URL at the beginning with the startup token, I'm going to mark this as invalid.  I can't reproduce it in 3.2.3.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2117#issuecomment-14250",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2117#issuecomment-14251",
...
```json
{
    "body": "<a id='comment:2'></a>This came up last week on sage-edu with Sage 3.2.3, so there is certainly a bug to be found and fixed here. It was reproducible with a wiped .sage by someone who seemed technically competent enough not to make a dumb mistake. So I am reopening this.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-23T16:25:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2117#issuecomment-14252",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This came up last week on sage-edu with Sage 3.2.3, so there is certainly a bug to be found and fixed here. It was reproducible with a wiped .sage by someone who seemed technically competent enough not to make a dumb mistake. So I am reopening this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2117#issuecomment-14253",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This thread ( http://groups.google.com/group/sage-edu/browse_thread/thread/4565115a21b28f5d/9e75206e7fada15b?lnk=gst&q=internal+server+error#9e75206e7fada15b ) is a different issue than the one reported here.",
    "created_at": "2009-01-24T01:50:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2117#issuecomment-14254",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:3'></a>This thread ( http://groups.google.com/group/sage-edu/browse_thread/thread/4565115a21b28f5d/9e75206e7fada15b?lnk=gst&q=internal+server+error#9e75206e7fada15b ) is a different issue than the one reported here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2117",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2117#issuecomment-14255",
    "user": "https://github.com/mwhansen"
}
```
