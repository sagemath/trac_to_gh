...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2178#issuecomment-11167",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [trac-2178.patch](https://github.com/sagemath/sage/files/ticket2178/trac-2178.patch) by cwitty created at 2008-02-16 17:28:00\n\nThe attached patch avoids the problem.  It also patches docstrings that create TeX errors on my laptop, so that I can actually build the refman.",
    "created_at": "2008-02-16T17:28:00Z",
    "issue": "https://github.com/sagemath/sage/issues/2178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2178#issuecomment-11168",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2178#issuecomment-11169",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2178#issuecomment-11170",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
