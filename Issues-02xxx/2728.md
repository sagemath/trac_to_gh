...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2728#issuecomment-19249",
...
```json
{
    "body": "<a id='comment:1'></a>This is not **Sage Specific**: It might be due to Debian packaging an older version of Maxima or alternatively be caused by using gcl instead of clisp. It is certainly borderline, but I don't think in this case it is on our end to fix this. \n\nCheers,\n\nMichael",
    "created_at": "2008-03-30T09:57:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2728#issuecomment-19250",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>This is not **Sage Specific**: It might be due to Debian packaging an older version of Maxima or alternatively be caused by using gcl instead of clisp. It is certainly borderline, but I don't think in this case it is on our end to fix this. 
