...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2097#issuecomment-14164",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] aspect_ratio option to show() for function plots does not work correctly"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2097#event-7198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2097#issuecomment-14165",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2097#event-7199"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2097#issuecomment-14166",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2097",
    "rename": {
        "from": "[with patch, needs review] aspect_ratio option to show() for function plots does not work correctly",
        "to": "[with patch, with positive review] aspect_ratio option to show() for function plots does not work correctly"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2097#event-7200"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2097",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2097#event-7201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2097#issuecomment-14167",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2097#issuecomment-14168",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
