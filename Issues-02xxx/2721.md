# Issue 2721: [with patch, positive review] parallel doctest not robust against filesystem issues
...
```json
{
    ...
    "title": "[with patch, positive review] parallel doctest not robust against filesystem issues",
    "type": "issue",
