...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2721#issuecomment-19668",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2721",
    "rename": {
        "from": "parallel doctest not robust against filesystem issues",
        "to": "[with patch, positive review] parallel doctest not robust against filesystem issues"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2721#event-9665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2721#issuecomment-19669",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2721",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2721#event-9666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2721",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2721#issuecomment-19670",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
