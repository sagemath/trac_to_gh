# Issue 2226: [with patch; with positive review] sage-2.10.2.alpha1 -- integral is now wrong (imho) for polynomials
...
```json
{
    ...
    "title": "[with patch; with positive review] sage-2.10.2.alpha1 -- integral is now wrong (imho) for polynomials",
    "type": "issue",
