...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2603#event-27357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2603#event-27358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2603#event-27359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2603#event-27360"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2603#event-27361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2603#issuecomment-13427",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2603#issuecomment-13428",
    "user": "https://github.com/ncalexan"
}
```
