...
```json
{
    "body": "<a id='comment:2'></a>I'm glad #2581 addresses that particular problem, but asking for a solution space for general matrix equations is still reasonable.  A trivial example might be\n\n```\nsage: zero_matrix(3, 2).solution_space_right(zero_matrix(3, 1))\n```\n\nwhich should yield a full matrix space (matrices of size 2 by 1).",
    "created_at": "2008-03-19T19:49:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2603",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2603#issuecomment-19203",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:2'></a>I'm glad #2581 addresses that particular problem, but asking for a solution space for general matrix equations is still reasonable.  A trivial example might be
