...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2867#issuecomment-15648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2867#issuecomment-15649",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Attachment [load_files.2.patch](https://github.com/sagemath/sage/files/ticket2867/load_files.2.patch) by @yqiang created at 2008-04-10 03:41:12",
    "created_at": "2008-04-10T03:41:12Z",
    "issue": "https://github.com/sagemath/sage/issues/2867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2867#issuecomment-15650",
    "user": "https://github.com/yqiang"
}
```

Attachment [load_files.2.patch](https://github.com/sagemath/sage/files/ticket2867/load_files.2.patch) by @yqiang created at 2008-04-10 03:41:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2867",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2867#issuecomment-15651",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
