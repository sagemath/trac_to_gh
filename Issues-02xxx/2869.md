...
```json
{
    "body": "<a id='comment:1'></a>Attachment [2869-resizer.patch](tarball://root/attachments/some-uuid/ticket2869/2869-resizer.patch) by boothby created at 2008-04-09 23:52:17",
...
<a id='comment:1'></a>Attachment [2869-resizer.patch](tarball://root/attachments/some-uuid/ticket2869/2869-resizer.patch) by boothby created at 2008-04-09 23:52:17
...
```json
{
    "body": "<a id='comment:5'></a>Patch was only partially applied to alpha4.  Posted rebase.",
...
<a id='comment:5'></a>Patch was only partially applied to alpha4.  Posted rebase.
...
```json
{
    "body": "<a id='comment:6'></a>Yeah, something went very, very wrong. Applied 2869-resizer_rebase-alpha5.patch - sorry boothby ;)\n\nCheers,\n\nMichael",
...
<a id='comment:6'></a>Yeah, something went very, very wrong. Applied 2869-resizer_rebase-alpha5.patch - sorry boothby ;)
