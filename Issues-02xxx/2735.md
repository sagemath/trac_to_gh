...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2735#issuecomment-19722",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2735",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2735#issuecomment-19723",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2735",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2735#event-9693"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2735",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2735#issuecomment-19724",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2735",
    "rename": {
        "from": "[with patch; needs review] minor eclib build system improvements",
        "to": "[with patch; positive review] minor eclib build system improvements"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2735#event-9694"
}
```
