# Issue 2024: [with patch, mixed but mainly negative reviews] univariate gcd over Z_N (N composite)
...
```json
{
    ...
    "title": "[with patch, mixed but mainly negative reviews] univariate gcd over Z_N (N composite)",
    "type": "issue",
