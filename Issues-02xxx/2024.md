...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17856"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17860"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17861"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17864"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17865"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17866"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17867"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2024#issuecomment-10175",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17868"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2024#issuecomment-10176",
...
```json
{
    ...
    "title_was": "univariate gcd over Z_N (N composite)",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17869"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2024",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2024#issuecomment-10177",
    "user": "https://github.com/sagetrac-dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17870"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-17871"
}
```
