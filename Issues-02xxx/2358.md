...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24411"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24412"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24413"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24414"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2358",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24417"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2358#issuecomment-11889",
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24418"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24419"
}
```
