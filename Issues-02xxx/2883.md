...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2883#issuecomment-20782",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] notebook -- typing in safari is sluggish!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2883#event-10202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2883#issuecomment-20783",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "rename": {
        "from": "[with patch, needs review] notebook -- typing in safari is sluggish!",
        "to": "[with patch, negative review (pending new patch)] notebook -- typing in safari is sluggish!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2883#event-10203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2883#issuecomment-20784",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2883#event-10204"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] notebook -- typing in safari is sluggish!",
        "to": "[with patch, positive review] notebook -- typing in safari is sluggish!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2883#event-10205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2883#issuecomment-20785",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "rename": {
        "from": "[with patch, positive review] notebook -- typing in safari is sluggish!",
        "to": "[with patch, positive review, needs rebase] notebook -- typing in safari is sluggish!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2883#event-10206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "rename": {
        "from": "[with patch, positive review, needs rebase] notebook -- typing in safari is sluggish!",
        "to": "[with patch, positive review] notebook -- typing in safari is sluggish!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2883#event-10207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2883#issuecomment-20786",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2883#issuecomment-20787",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2883#issuecomment-20788",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2883",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2883#event-10208"
}
```
