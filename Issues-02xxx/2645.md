...
<a id='comment:2'></a>In https://groups.google.com/group/sage-devel/browse_thread/thread/d88bc7503638af0c Robert Bradshaw commented:
...
```json
{
    "body": "<a id='comment:3'></a>The comment about line3d does not change the bug and does not change the patch.  The comment about line3d was to address a problem with plot_vector_field3d (#2646)",
...
<a id='comment:3'></a>The comment about line3d does not change the bug and does not change the patch.  The comment about line3d was to address a problem with plot_vector_field3d (#2646)
...
<a id='comment:4'></a>Works great for me. A good example of this is
