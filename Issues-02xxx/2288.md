...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2288/442.patch",
    "created_at": "2008-02-24T22:13:12Z",
    "issue": "https://github.com/sagemath/sage/issues/2288",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2288/442.patch",
...
```json
{
    "body": "Attachment [442.patch](https://github.com/sagemath/sage/files/ticket2288/442.patch) by @wdjoyner created at 2008-02-24 22:13:12",
    "created_at": "2008-02-24T22:13:12Z",
    "issue": "https://github.com/sagemath/sage/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2288#issuecomment-11881",
    "user": "https://github.com/wdjoyner"
}
```

Attachment [442.patch](https://github.com/sagemath/sage/files/ticket2288/442.patch) by @wdjoyner created at 2008-02-24 22:13:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2288#issuecomment-11882",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2288#event-11295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2288#issuecomment-11883",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2288#event-11296"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2288#event-11297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2288#issuecomment-11884",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2288#event-11298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2288",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2288#event-11299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2288#issuecomment-11885",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
