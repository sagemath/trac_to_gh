# Issue 2288: [with patch, with positive review] tutorial -- fix some typos (easy)
...
```json
{
    ...
    "title": "[with patch, with positive review] tutorial -- fix some typos (easy)",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2288#issuecomment-15140",
...
```json
{
    "body": "<a id='comment:1'></a>The patch fixes the valid typos reported above.",
    "created_at": "2008-02-24T22:15:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2288#issuecomment-15141",
    "user": "https://github.com/wdjoyner"
}
```

<a id='comment:1'></a>The patch fixes the valid typos reported above.
...
```json
{
    "body": "<a id='comment:2'></a>Does this patch depend or conflict in any way with #2289?\n\nCheers,\n\nMichael",
    "created_at": "2008-02-24T22:17:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2288#issuecomment-15142",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Does this patch depend or conflict in any way with #2289?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2288#issuecomment-15143",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2288",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2288#event-5409"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2288#issuecomment-15144",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2288",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2288#issuecomment-15145",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
