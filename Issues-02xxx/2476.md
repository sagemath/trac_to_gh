...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22741"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22742"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22743"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22744"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2476",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22746"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2476",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2476#issuecomment-13224",
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2476#event-22749"
}
```
