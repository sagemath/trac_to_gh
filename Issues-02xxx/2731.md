...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-25041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-25042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-25043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-25044"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2731",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-25045"
}
```
