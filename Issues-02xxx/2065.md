...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18285"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18288"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2065",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2065",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2065#issuecomment-10402",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2065#event-18290"
}
```
