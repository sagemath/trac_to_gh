...
archive/attachments_002289.json:
```json
{
...
archive/attachments_002290.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [charpoly_frobenius_bug.patch](https://github.com/sagemath/sage/files/ticket2453/charpoly_frobenius_bug.patch)\n\ndiff of linbox-1.1.5rc2.p4 against 1.1.5rc2.p5",
    "created_at": "2008-03-12T02:03:44Z",
    "issue": "https://github.com/sagemath/sage/issues/2453",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2453#issuecomment-13097",
    "user": "https://github.com/ClementPernet"
}
```

**Attachment:** [charpoly_frobenius_bug.patch](https://github.com/sagemath/sage/files/ticket2453/charpoly_frobenius_bug.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2453",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2453#issuecomment-13098",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2453",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2453#issuecomment-13099",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2453",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2453#issuecomment-13100",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2453",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2453#issuecomment-13101",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
