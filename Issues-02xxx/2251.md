...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac-2252.patch](tarball://root/attachments/some-uuid/ticket2251/trac-2252.patch) by @craigcitro created at 2008-02-21 23:13:49\n\nFixes the doctest to the answer that sage was producing, which is correct. (One can check it within sage, i.e. it's easy to check that the two ideals are equal to one another, and I even double-checked in Pari to make sure we weren't missing something in moving the answer from Pari to Sage.)",
    "created_at": "2008-02-21T23:13:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2251#issuecomment-16096",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:1'></a>Attachment [trac-2252.patch](tarball://root/attachments/some-uuid/ticket2251/trac-2252.patch) by @craigcitro created at 2008-02-21 23:13:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2251#issuecomment-16097",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Note that the patch says 2252.patch, but it's really for this ticket.",
    "created_at": "2008-02-21T23:14:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2251#issuecomment-16098",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:2'></a>Note that the patch says 2252.patch, but it's really for this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2251#issuecomment-16099",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2251",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2251#issuecomment-16100",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
