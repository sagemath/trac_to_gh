# Issue 2704: [with patch, positive review] bug in lcm(a,b) for a,b polynomials in QQ[] if a is constant
...
```json
{
    ...
    "title": "[with patch, positive review] bug in lcm(a,b) for a,b polynomials in QQ[] if a is constant",
    "type": "issue",
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2704#event-9603"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2704#issuecomment-19560",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2704#issuecomment-19561",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2704#issuecomment-19562",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "rename": {
        "from": "bug in lcm(a,b) for a,b polynomials in QQ[] if a is constant",
        "to": "[with patch, needs review] bug in lcm(a,b) for a,b polynomials in QQ[] if a is constant"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2704#event-9604"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2704#issuecomment-19563",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "rename": {
        "from": "[with patch, needs review] bug in lcm(a,b) for a,b polynomials in QQ[] if a is constant",
        "to": "[with patch, positive review] bug in lcm(a,b) for a,b polynomials in QQ[] if a is constant"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2704#event-9605"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2704#issuecomment-19564",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2704#event-9606"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2704#issuecomment-19565",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2704",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2704#issuecomment-19566",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
