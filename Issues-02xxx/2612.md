...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2612#issuecomment-18794",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2612#event-9220"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2612#issuecomment-18795",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2612",
    "rename": {
        "from": "[with simple patch] String to Integer Conversion",
        "to": "[with simple patch, positive review] String to Integer Conversion"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2612#event-9221"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2612#issuecomment-18796",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2612",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2612#event-9222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2612#issuecomment-18797",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
