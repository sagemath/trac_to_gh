...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2628#issuecomment-14331",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2628/literate_notebook.png",
    "created_at": "2008-03-21T15:46:54Z",
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2628/literate_notebook.png",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    "body": "Attachment [literate_notebook.png](https://github.com/sagemath/sage/files/ticket2628/literate_notebook.png) by @NathanDunfield created at 2008-03-21 15:46:54\n\n\"Source\" for mockup",
    "created_at": "2008-03-21T15:46:54Z",
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2628#issuecomment-14332",
    "user": "https://github.com/NathanDunfield"
}
```

Attachment [literate_notebook.png](https://github.com/sagemath/sage/files/ticket2628/literate_notebook.png) by @NathanDunfield created at 2008-03-21 15:46:54
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2628/notebook.txt",
    "created_at": "2008-03-21T16:34:49Z",
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2628/notebook.txt",
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [notebook.txt](https://github.com/sagemath/sage/files/ticket2628/notebook.txt) by @garyfurnish created at 2008-03-21 16:34:49",
    "created_at": "2008-03-21T16:34:49Z",
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2628#issuecomment-14333",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2628#issuecomment-14334",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2628#issuecomment-14335",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2628#issuecomment-14336",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2628#issuecomment-14337",
    "user": "https://github.com/mwhansen"
}
```
