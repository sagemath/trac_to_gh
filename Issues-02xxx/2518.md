...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18525",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18526",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The issue here is likely that we use\n\n```\nos.kill(int(pid),0)\n```\nIt is likely that using \"kill -9 $PID\" via os.system() ought to fix the issue.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-29T17:23:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18527",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>The issue here is likely that we use
...
```json
{
    "body": "<a id='comment:2'></a>I believe the problem was that if clisp crashed and restarted those processes could get stuck at 99% and not be killed at exit.\n\nThis hasn't been reported in a while, so I would prefer to close this as fixed. Thoughts?\n\nCheers,\n\nMichael",
    "created_at": "2009-05-13T18:41:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18528",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>I believe the problem was that if clisp crashed and restarted those processes could get stuck at 99% and not be killed at exit.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18529",
...
```json
{
    "body": "<a id='comment:3'></a>Since this hasn't been reported in around 8 months, I think this should be closed.",
    "created_at": "2010-01-19T07:15:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18530",
    "user": "https://github.com/TimDumol"
}
```

<a id='comment:3'></a>Since this hasn't been reported in around 8 months, I think this should be closed.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18531",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18532",
...
```json
{
    "body": "<a id='comment:4'></a>Seems reasonable to me.",
    "created_at": "2010-01-19T07:17:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2518",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2518#issuecomment-18533",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>Seems reasonable to me.
