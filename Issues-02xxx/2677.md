...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2677#issuecomment-19303",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with easy patch; needs review] sage 2.11.alpha1: doctest failures in real_double_dense.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2677#event-9492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2677",
    "rename": {
        "from": "[with easy patch; needs review] sage 2.11.alpha1: doctest failures in real_double_dense.pyx",
        "to": "[with easy patch; positive review] sage 2.11.alpha1: doctest failures in real_double_dense.pyx"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2677#event-9493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2677#issuecomment-19304",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2677#issuecomment-19305",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2677",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2677#event-9494"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2677#issuecomment-19306",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
