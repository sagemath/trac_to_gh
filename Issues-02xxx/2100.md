...
```json
{
    "body": "**Attachment:** [2100-aspect_ratio.2.patch](https://github.com/sagemath/sage/files/ticket2100/2100-aspect_ratio.2.patch)\n\napply instead of previous patch",
    "created_at": "2010-10-07T07:08:23Z",
    "issue": "https://github.com/sagemath/sage/issues/2100",
    "type": "issue_comment",
...
**Attachment:** [2100-aspect_ratio.2.patch](https://github.com/sagemath/sage/files/ticket2100/2100-aspect_ratio.2.patch)
...
```json
{
    "body": "**Attachment:** [trac_2100-aspect-ratio-rebase.patch](https://github.com/sagemath/sage/files/ticket2100/trac_2100-aspect-ratio-rebase.patch)\n\nRebase to 4.6.1/4.6.2.alpha0",
    "created_at": "2011-01-17T20:06:30Z",
    "issue": "https://github.com/sagemath/sage/issues/2100",
    "type": "issue_comment",
...
**Attachment:** [trac_2100-aspect-ratio-rebase.patch](https://github.com/sagemath/sage/files/ticket2100/trac_2100-aspect-ratio-rebase.patch)
...
```json
{
    "body": "**Attachment:** [trac_2100-3d-vector.patch](https://github.com/sagemath/sage/files/ticket2100/trac_2100-3d-vector.patch)\n\nreviewer patch",
    "created_at": "2011-01-19T20:38:49Z",
    "issue": "https://github.com/sagemath/sage/issues/2100",
    "type": "issue_comment",
...
**Attachment:** [trac_2100-3d-vector.patch](https://github.com/sagemath/sage/files/ticket2100/trac_2100-3d-vector.patch)
...
```json
{
    "body": "**Changing work issues** from \"Plotting of vectors examples\" to \"\".",
...
**Changing work issues** from "Plotting of vectors examples" to "".
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2100/Before.png",
    "created_at": "2011-02-19T04:21:54Z",
    "issue": "https://github.com/sagemath/sage/issues/2100",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2100/Before.png",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "**Changing work issues** from \"unify option names\" to \"\".",
...
**Changing work issues** from "unify option names" to "".
...
```json
{
    "body": "**Attachment:** [trac_2100-auto-automatic-and-vector.patch](https://github.com/sagemath/sage/files/ticket2100/trac_2100-auto-automatic-and-vector.patch)\n\nApply after rebase patch",
    "created_at": "2011-06-20T14:45:44Z",
    "issue": "https://github.com/sagemath/sage/issues/2100",
    "type": "issue_comment",
...
**Attachment:** [trac_2100-auto-automatic-and-vector.patch](https://github.com/sagemath/sage/files/ticket2100/trac_2100-auto-automatic-and-vector.patch)
