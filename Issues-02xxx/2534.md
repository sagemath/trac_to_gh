...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2534#issuecomment-13667",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2534#issuecomment-13668",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "Attachment [2534.patch](https://github.com/sagemath/sage/files/ticket2534/2534.patch) by @mwhansen created at 2008-03-16 03:32:25",
    "created_at": "2008-03-16T03:32:25Z",
    "issue": "https://github.com/sagemath/sage/issues/2534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2534#issuecomment-13669",
    "user": "https://github.com/mwhansen"
}
```

Attachment [2534.patch](https://github.com/sagemath/sage/files/ticket2534/2534.patch) by @mwhansen created at 2008-03-16 03:32:25
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [2534.2.patch](https://github.com/sagemath/sage/files/ticket2534/2534.2.patch) by @mwhansen created at 2008-03-16 04:23:24\n\nOnly apply 2534.2.patch which was made against 2.10.4.alpha0.",
    "created_at": "2008-03-16T04:23:24Z",
    "issue": "https://github.com/sagemath/sage/issues/2534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2534#issuecomment-13670",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2534#issuecomment-13671",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2534#issuecomment-13672",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
