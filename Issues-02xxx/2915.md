...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, neesd review] bug in symbolic integration or \"stupid bug in the sage/maxima interface\"?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2915#event-10340"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2915#issuecomment-21049",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2915#issuecomment-21050",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2915#issuecomment-21051",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "rename": {
        "from": "[with patch, neesd review] bug in symbolic integration or \"stupid bug in the sage/maxima interface\"?",
        "to": "[with patch, positive review] bug in symbolic integration or \"stupid bug in the sage/maxima interface\"?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2915#event-10341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2915#issuecomment-21052",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2915#event-10342"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2915#issuecomment-21053",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2915#issuecomment-21054",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
