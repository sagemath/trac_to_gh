...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18479"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18483"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18484"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18485"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18486"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18488"
}
```
...
```json
{
    ...
    "title_was": "bug in graph_isom and binary_code",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18489"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2085#issuecomment-10501",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2085#issuecomment-10502",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2085",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2085#event-18492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2085#issuecomment-10503",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
