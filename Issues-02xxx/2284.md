...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2284#issuecomment-15857",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2284#issuecomment-15858",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2284#issuecomment-15859",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "rename": {
        "from": "CallableSymbolicExpression._latex_() has some odd behavior",
        "to": "[with patch, needs review] CallableSymbolicExpression._latex_() has some odd behavior"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2284#event-7883"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2284#issuecomment-15860",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "rename": {
        "from": "[with patch, needs review] CallableSymbolicExpression._latex_() has some odd behavior",
        "to": "[with patch, positive review] CallableSymbolicExpression._latex_() has some odd behavior"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2284#event-7884"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2284#event-7885"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2284#issuecomment-15861",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2284#issuecomment-15862",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
