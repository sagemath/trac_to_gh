...
```json
{
    "body": "<a id='comment:1'></a>Also note that _latex_() does not TeX the variable names on the left:\n\n``` \t\nsage: f(omega) = omega\nsage: f._latex_()\n'omega \\\\ {\\\\mapsto}\\\\ {2 \\\\omega}'\n```\n\n'omega' should be '\\\\omega'.",
...
<a id='comment:1'></a>Also note that _latex_() does not TeX the variable names on the left:
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [latex.hg](tarball://root/attachments/some-uuid/ticket2284/latex.hg) by @bobmoretti created at 2008-02-24 00:36:40\n\nOkay, submitted a fix; need a review.",
...
<a id='comment:2'></a>Attachment [latex.hg](tarball://root/attachments/some-uuid/ticket2284/latex.hg) by @bobmoretti created at 2008-02-24 00:36:40
...
```json
{
    "body": "<a id='comment:3'></a>Applies cleanly to 2.10.3.alpha0 and passes tests for me.",
...
<a id='comment:3'></a>Applies cleanly to 2.10.3.alpha0 and passes tests for me.
