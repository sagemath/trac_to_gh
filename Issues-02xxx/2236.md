...
```json
{
    "body": "<a id='comment:1'></a>I agree with the suggestion to *not* randomize the endpoints.  That's bad.",
...
<a id='comment:1'></a>I agree with the suggestion to *not* randomize the endpoints.  That's bad.
...
```json
{
    "body": "<a id='comment:4'></a>For the record, on IRC:\n\n[16:55] <wstein> #2236 -- positive review.",
...
<a id='comment:4'></a>For the record, on IRC:
