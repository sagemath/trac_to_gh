# Issue 2485: [with positive review] Complete docstrings and doctests for schemes/elliptic_curves
...
```json
{
    ...
    "title": "[with positive review] Complete docstrings and doctests for schemes/elliptic_curves",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18662",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18663",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2485/8866.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18664",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18665",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18666",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] Complete docstrings and doctests for schemes/elliptic_curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2485#event-7401"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18667",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2485/8867.patch",
...
```json
{
    "body": "Apply after 8866.patch",
    "created_at": "2008-03-14T19:52:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18668",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "rename": {
        "from": "[with positive review] Complete docstrings and doctests for schemes/elliptic_curves",
        "to": "[with positive review, with new patch, needs further review] Complete docstrings and doctests for schemes/elliptic_curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2485#event-7402"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18670",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "rename": {
        "from": "[with positive review, with new patch, needs further review] Complete docstrings and doctests for schemes/elliptic_curves",
        "to": "[with positive review] Complete docstrings and doctests for schemes/elliptic_curves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2485#event-7403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18671",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2485#issuecomment-18672",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2485",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2485#event-7404"
}
```
