...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15625",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15626",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I just realized that this patch is against 2.10.1 + patches from 1085 -- I don't think this should cause any trouble, since it only touches one file, but if it does, I'll rebase it.",
    "created_at": "2008-02-18T01:26:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15627",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:1'></a>I just realized that this patch is against 2.10.1 + patches from 1085 -- I don't think this should cause any trouble, since it only touches one file, but if it does, I'll rebase it.
...
```json
{
    "body": "<a id='comment:2'></a>Couldn't apply the patch tos sage-2.10.2.alpha.\n\nJaap",
    "created_at": "2008-02-18T11:43:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15628",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:2'></a>Couldn't apply the patch tos sage-2.10.2.alpha.
...
```json
{
    "body": "<a id='comment:3'></a>Just applied the patch by hand and it works:\n\n```\n\n[jaap@paix sage-2.10.2.alpha0]$ ./sage -t  devel/sage-main/sage/rings/number_field/number_field.py\nsage -t  devel/sage-main/sage/rings/number_field/number_field.py\n         [21.3 s]\n \n----------------------------------------------------------------------\nAll tests passed!\nTotal time for all tests: 21.3 seconds\n\n```",
    "created_at": "2008-02-18T12:49:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15629",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:3'></a>Just applied the patch by hand and it works:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15630",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2201#event-5255"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15631",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>FYI: This patch fixes the doctest issue on sage.math, too.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-18T17:04:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2201#issuecomment-15632",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>FYI: This patch fixes the doctest issue on sage.math, too.
