...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-21126"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-21127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-21128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-21129"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2090",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-21130"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2090#issuecomment-9957",
    "user": "https://github.com/williamstein"
}
```
