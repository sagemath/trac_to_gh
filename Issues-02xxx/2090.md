...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-18535"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-18536"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-18537"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-18538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2090",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2090#event-18539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2090#issuecomment-10517",
    "user": "https://github.com/williamstein"
}
```
