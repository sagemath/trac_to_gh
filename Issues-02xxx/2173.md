# Issue 2173: [with patch; positive review] SAGE setup.py should run cython as "python2.5 cython" and other debian fixes
...
```json
{
    ...
    "title": "[with patch; positive review] SAGE setup.py should run cython as \"python2.5 cython\" and other debian fixes",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2173#event-5194"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2173#event-5195"
}
```
