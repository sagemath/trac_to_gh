...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20120",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>malb, I'm reviewing the patch too and taking care of these issues.",
    "created_at": "2008-03-29T08:12:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20121",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>malb, I'm reviewing the patch too and taking care of these issues.
...
```json
{
    "body": "<a id='comment:5'></a>I changed many of the doctests to use a more \"modern\" style for constructing the polynomial rings.  I also changed is_monomial to treat 2*x as a monomial since it agrees with _polydict and matches the standard mathematical definition for a monomial.\n\nApply the last two patches.  They apply to 2.11 alpha1 and pass -testall",
    "created_at": "2008-03-29T08:44:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20122",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:5'></a>I changed many of the doctests to use a more "modern" style for constructing the polynomial rings.  I also changed is_monomial to treat 2*x as a monomial since it agrees with _polydict and matches the standard mathematical definition for a monomial.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20123",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I've updated 2702-referee.patch to use the old definition of monomial, added an extra docstest, and a sentence in the docstring describing what it's using for the definition of monomial.\n\n\nThis should probably be taken to sage-devel.\n\n\nI'm fine with the last two patches being applied.",
    "created_at": "2008-03-29T19:50:19Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20124",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:7'></a>I've updated 2702-referee.patch to use the old definition of monomial, added an extra docstest, and a sentence in the docstring describing what it's using for the definition of monomial.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20125",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20126",
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [2702-referee.patch](tarball://root/attachments/some-uuid/ticket2702/2702-referee.patch) by mabshoff created at 2008-03-29 20:30:46\n\nMerged 2702.patch and 2702-referee.patch in Sage 2.11.rc0",
    "created_at": "2008-03-29T20:30:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2702",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2702#issuecomment-20127",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Attachment [2702-referee.patch](tarball://root/attachments/some-uuid/ticket2702/2702-referee.patch) by mabshoff created at 2008-03-29 20:30:46
