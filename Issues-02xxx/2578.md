...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13966",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13967",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13968",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13969",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13970",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2578/trac-2578.patch",
    "created_at": "2009-01-23T10:34:38Z",
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2578/trac-2578.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac-2578.patch](https://github.com/sagemath/sage/files/ticket2578/trac-2578.patch) by @williamstein created at 2009-01-23 10:34:38\n\npositive review;\n\nit could be optimized by using horner's rule",
    "created_at": "2009-01-23T10:34:38Z",
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13971",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13972",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
