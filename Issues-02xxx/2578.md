...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27080"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27081"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27083"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27084"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13289",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27085"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13290",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13291",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "title_was": "bug in bernoulli_polynomial",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27088"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27089"
}
```
...
```json
{
    ...
    "subject": "https://github.com/craigcitro",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13293",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27092"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2578#issuecomment-13294",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2578",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2578#event-27096"
}
```
