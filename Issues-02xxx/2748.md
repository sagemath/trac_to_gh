# Issue 2748: [with patch, positive review] Permutation constructor does not accept lists of tuples
...
```json
{
    ...
    "title": "[with patch, positive review] Permutation constructor does not accept lists of tuples",
    "type": "issue",
