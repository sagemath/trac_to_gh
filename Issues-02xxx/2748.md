...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2748#issuecomment-19794",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2748#event-9731"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2748#issuecomment-19795",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, positive review] Permutation constructor does not accept lists of tuples [with patch, needs review]"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2748#event-9732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2748",
    "rename": {
        "from": "[with patch, positive review] Permutation constructor does not accept lists of tuples [with patch, needs review]",
        "to": "[with patch, positive review] Permutation constructor does not accept lists of tuples"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2748#event-9733"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2748#issuecomment-19796",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2748",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2748#event-9734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2748#issuecomment-19797",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
