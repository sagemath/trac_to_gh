...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2875#issuecomment-20688",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] notebook -- save_session is completely broken in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2875#event-10150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2875#issuecomment-20689",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2875#issuecomment-20690",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "rename": {
        "from": "[with patch; needs review] notebook -- save_session is completely broken in the notebook",
        "to": "[with patch; positive review pending doctests / testing] notebook -- save_session is completely broken in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2875#event-10151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2875#issuecomment-20691",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2875#issuecomment-20692",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; positive review] notebook -- save_session is completely broken in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2875#event-10152"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2875#event-10153"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2875#issuecomment-20693",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2875",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2875#issuecomment-20694",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
