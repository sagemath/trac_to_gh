...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24865"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24866"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24867"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24868"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24869"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24870"
}
```
...
```json
{
    ...
    "subject": "https://github.com/ClementPernet",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24871"
}
```
...
```json
{
    ...
    "subject": "https://github.com/ClementPernet",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24872"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24873"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24874"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24875"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2388",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24876"
}
```
