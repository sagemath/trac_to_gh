...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2187#issuecomment-15026",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2187#issuecomment-15027",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2187",
    "rename": {
        "from": "[with patch, needs review] improve refman autogeneration; add and rewrite much reference manual text",
        "to": "[with patch, with positive review] improve refman autogeneration; add and rewrite much reference manual text"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2187#event-7539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2187#issuecomment-15028",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2187#issuecomment-15029",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2187",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2187#event-7540"
}
```
