# Issue 2333: [with patch, very positive review] hg_sage.apply('http://trac.sagemath.org/.../ticket/2245/sage-2245.patch') should be made to work
...
```json
{
    ...
    "title": "[with patch, very positive review] hg_sage.apply('http://trac.sagemath.org/.../ticket/2245/sage-2245.patch') should be made to work",
    "type": "issue",
