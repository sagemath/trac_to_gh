...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] hg_sage.apply('http://trac.sagemath.org/sage_trac/attachment/ticket/2245/sage-2245.patch') should be made to work"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2333#event-8089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2333#issuecomment-16344",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2333#issuecomment-16345",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2333#issuecomment-16346",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2333#issuecomment-16347",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "rename": {
        "from": "[with patch, needs review] hg_sage.apply('http://trac.sagemath.org/sage_trac/attachment/ticket/2245/sage-2245.patch') should be made to work",
        "to": "[with patch, needs review] hg_sage.apply('http://trac.sagemath.org/.../ticket/2245/sage-2245.patch') should be made to work"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2333#event-8090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2333#issuecomment-16348",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "rename": {
        "from": "[with patch, needs review] hg_sage.apply('http://trac.sagemath.org/.../ticket/2245/sage-2245.patch') should be made to work",
        "to": "[with patch, very positive review] hg_sage.apply('http://trac.sagemath.org/.../ticket/2245/sage-2245.patch') should be made to work"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2333#event-8091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2333#issuecomment-16349",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2333#issuecomment-16350",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2333",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2333#event-8092"
}
```
