...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2601#issuecomment-18644",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2601#event-9176"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2601#issuecomment-18645",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2601#issuecomment-18646",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "rename": {
        "from": "problem with _mpoly_dict_recursive()",
        "to": "[with patch; needs review] problem with _mpoly_dict_recursive()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2601#event-9177"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2601#event-9178"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "rename": {
        "from": "[with patch; needs review] problem with _mpoly_dict_recursive()",
        "to": "[with patch; positive review] problem with _mpoly_dict_recursive()"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2601#event-9179"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2601#issuecomment-18647",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2601#issuecomment-18648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2601#event-9180"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2601#issuecomment-18649",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
