...
<a id='comment:5'></a>In fact, singular resultants are slow compared to other methods, so it would really be a good idea to write specific sage code for resultants.
...
```json
{
    "body": "<a id='comment:9'></a>hmm, the second doctest is more about univariate polynomials. Maybe it should go there ?",
...
<a id='comment:9'></a>hmm, the second doctest is more about univariate polynomials. Maybe it should go there ?
...
```json
{
    "body": "<a id='comment:11'></a>ok, test is now at the right place.",
...
<a id='comment:11'></a>ok, test is now at the right place.
...
```json
{
    "body": "<a id='comment:12'></a>and the bot is green.",
...
<a id='comment:12'></a>and the bot is green.
