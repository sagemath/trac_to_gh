...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2842#issuecomment-20429",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2842#issuecomment-20430",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "rename": {
        "from": "[with patch, needs review] PyLint unused variable cleanup for sage.rings.polynomial",
        "to": "[with patch, positive review] PyLint unused variable cleanup for sage.rings.polynomial"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2842#event-10032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "rename": {
        "from": "[with patch, positive review] PyLint unused variable cleanup for sage.rings.polynomial",
        "to": "[with patch, positive review, pending fixes] PyLint unused variable cleanup for sage.rings.polynomial"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2842#event-10033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2842#issuecomment-20431",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2842#issuecomment-20432",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2842#issuecomment-20433",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "rename": {
        "from": "[with patch, positive review, pending fixes] PyLint unused variable cleanup for sage.rings.polynomial",
        "to": "[with patch, positive review] PyLint unused variable cleanup for sage.rings.polynomial"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2842#event-10034"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2842#issuecomment-20434",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2842#event-10035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2842#issuecomment-20435",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
