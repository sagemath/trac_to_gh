...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2383#issuecomment-12645",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2383#issuecomment-12646",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2383/memleak.py",
    "created_at": "2008-03-16T09:14:12Z",
    "issue": "https://github.com/sagemath/sage/issues/2383",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2383/memleak.py",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [memleak.py](https://github.com/sagemath/sage/files/ticket2383/memleak.py) by @robertwb created at 2008-03-16 09:14:12\n\nThe attached pure python file leaks too.",
    "created_at": "2008-03-16T09:14:12Z",
    "issue": "https://github.com/sagemath/sage/issues/2383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2383#issuecomment-12647",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2383#issuecomment-12648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2383",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2383#issuecomment-12649",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
