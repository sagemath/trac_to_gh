# Issue 2994: [with spkg, positive review] polybori.spkg: fix permission issue of the headers
...
```json
{
    ...
    "title": "[with spkg, positive review] polybori.spkg: fix permission issue of the headers",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2994#issuecomment-20554",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2994#issuecomment-20556",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2994#issuecomment-20557",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2994#event-6819"
}
```
