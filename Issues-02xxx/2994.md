...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2994#issuecomment-21591",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, needs trivial review] polybori.spkg: fix permission issue of the headers"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2994#event-10614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2994#issuecomment-21592",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "rename": {
        "from": "[with spkg, needs trivial review] polybori.spkg: fix permission issue of the headers",
        "to": "[with spkg, positive review] polybori.spkg: fix permission issue of the headers"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2994#event-10615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2994#issuecomment-21593",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2994#issuecomment-21594",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2994",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2994#event-10616"
}
```
