# Issue 2247: [with positive review] comment out long doctest in totallyreal_rel.py
...
```json
{
    ...
    "title": "[with positive review] comment out long doctest in totallyreal_rel.py",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2247#issuecomment-16400",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2247#issuecomment-16401",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] comment out long doctest in totallyreal_rel.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2247#event-6623"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2247",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2247#event-6624"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2247#issuecomment-16402",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2247#issuecomment-16403",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
