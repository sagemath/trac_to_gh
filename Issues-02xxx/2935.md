...
```json
{
    "body": "<a id='comment:1'></a>Well, there already seems to be a notebook running on port 8000, so could that have something to do with that? Can you check and report back?\n\nDo we support more than one notebook running from the same Sage instance?\n\nCheers,\n\nMichael",
    "created_at": "2008-04-15T19:12:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21799",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Well, there already seems to be a notebook running on port 8000, so could that have something to do with that? Can you check and report back?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21800",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Neither tom nor I can replicate this.\n\nCould you try with a fresh NOTEBOOK directory?  E.g.,\n\n  sage: notebook(directory = 'foo')\n\nwilliam",
    "created_at": "2008-04-16T21:44:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21801",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Neither tom nor I can replicate this.
...
```json
{
    "body": "<a id='comment:5'></a>Follow up: selecting an old ws and clicking on 'Archive' cased the same error here.",
    "created_at": "2008-04-16T22:57:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21803",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:5'></a>Follow up: selecting an old ws and clicking on 'Archive' cased the same error here.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21805",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>This issue seems to be introduced with sage-2.10.1.\n\nIn sage-2.9 clicking on the Archive button gives a warning.\n\nI put up some screen shots here: http://sage.math.washington.edu/home/jsp/screenshots/s1/\n\nJaap",
    "created_at": "2008-04-18T13:48:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21806",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:8'></a>This issue seems to be introduced with sage-2.10.1.
...
```json
{
    "body": "<a id='comment:9'></a>Could this have something to do with encoding? Jaap: what is the locale you use?\n\nCheers,\n\nMichael",
    "created_at": "2008-04-18T20:33:33Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Could this have something to do with encoding? Jaap: what is the locale you use?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21808",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Can anybody but Jaap replicate this problem?",
    "created_at": "2008-04-20T17:23:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21809",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>Can anybody but Jaap replicate this problem?
...
```json
{
    "body": "<a id='comment:14'></a>Once again this is what I do now to avoid the error:\n\nStart the notebook in sage-3.0.\n\nClose the notebook tab in firefox.\n\nConnect to https://localhost:8001/\n\nNow I have a notebook running in which I can Archive en Delete worksheets.\n\nJaap",
    "created_at": "2008-04-22T16:45:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21811",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:14'></a>Once again this is what I do now to avoid the error:
...
```json
{
    "body": "<a id='comment:15'></a>Since nobody else can replicate this, and it could just be some weird cookie corruption on Jaap's computer (or a weird firefox bug), I'm closing this as invalid.",
    "created_at": "2008-05-10T23:17:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21812",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:15'></a>Since nobody else can replicate this, and it could just be some weird cookie corruption on Jaap's computer (or a weird firefox bug), I'm closing this as invalid.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2935#issuecomment-21813",
    "user": "https://github.com/williamstein"
}
```
