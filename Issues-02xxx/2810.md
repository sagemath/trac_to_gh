...
```json
{
    "body": "<a id='comment:3'></a>\nLooks good.\n\nIt causes a small doctest failure on line 95 of schemes/elliptic_curves/gp_cremona.py, since in elliptic_curve_finite_field you have gotten rid of `_cremona_abgrp_`data().  I think that doctest should just be removed from gp_cremona.py anyway, but I don't know whether you have good reasons to keep it around.\n\nAnyway, after this doctest failure gets fixed one way or another I'm happy to give this a positive review.",
