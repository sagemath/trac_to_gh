...
```json
{
    "body": "Attachment [build_cache_symlink.patch](https://github.com/sagemath/sage/files/ticket2295/build_cache_symlink.patch) by @burcin created at 2008-02-24 20:02:06\n\nfix build cache problem when sage_root has symlinks",
    "created_at": "2008-02-24T20:02:06Z",
    "issue": "https://github.com/sagemath/sage/issues/2295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2295#issuecomment-11925",
    "user": "https://github.com/burcin"
}
```

Attachment [build_cache_symlink.patch](https://github.com/sagemath/sage/files/ticket2295/build_cache_symlink.patch) by @burcin created at 2008-02-24 20:02:06
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2295#issuecomment-11926",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2295#issuecomment-11927",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
