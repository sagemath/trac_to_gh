...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21371"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21375"
}
```
...
```json
{
    "body": "<a id='comment:2'>Comment 2:</a>\nAttachment: **[2353_deprecate_MPolynomialRing-doc_changes.patch.gz](https://github.com/sagemath/sage/files/ticket2353/2353_deprecate_MPolynomialRing-doc_changes.patch.gz)**\n\n[attachment: 2353_deprecate_MPolynomialRing.patch.gz](https://github.com/sagemath/sage/files/ticket2353/2353_deprecate_MPolynomialRing.patch.gz) adds a deprecation notice to `MPolynomialRing` using Python's `warnings` module. It also prepends the docstring for `PolynomialRing` with the text:\n\n```\n    This function is deprecated and will be removed in a future version of\n    Sage. Please use PolynomialRing instead.\n\n    If you have questions regarding this function and it's replacement,\n    please send your comments to sage-support@googlegroups.com.\n```\n\n[attachment: 2353_deprecate_MPolynomialRing-doc_changes.patch.gz](https://github.com/sagemath/sage/files/ticket2353/2353_deprecate_MPolynomialRing-doc_changes.patch.gz) replaces occurences of `MPolynomialRing` in the documentation with `PolynomialRing`. I don't know why the file `commontex/patchlevel.tex` appears in this patch.",
    "created_at": "2008-05-11T02:17:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/2353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2353#issuecomment-12458",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2353#issuecomment-12459",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21376"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21377"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2353#issuecomment-12460",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21378"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2353",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2353#event-21379"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2353",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2353#issuecomment-12461",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
