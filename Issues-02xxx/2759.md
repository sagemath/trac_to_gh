...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2759#issuecomment-19877",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2759",
    "rename": {
        "from": "[with patch; needs review] SAGE debian/ directory updates",
        "to": "[with patch; positive review] SAGE debian/ directory updates"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2759#event-9764"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2759#issuecomment-19878",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2759#issuecomment-19879",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2759",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2759#event-9765"
}
```
