...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2897#issuecomment-20900",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, positive review] GAP: replace guava 3.4 by new and improved guava 3.4"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2897#event-10261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2897#issuecomment-20901",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2897#issuecomment-20902",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2897",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2897#event-10262"
}
```
