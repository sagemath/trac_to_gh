...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2990#issuecomment-16392",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2990#issuecomment-16393",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2990#issuecomment-16394",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2990",
    "rename": {
        "from": "sage-3.0.rc1: calculus/functions.py segfault on debian64 xeon vmware image",
        "to": "[with patch; I'm the only one that can review it and it works] sage-3.0.rc1: calculus/functions.py segfault on debian64 xeon vmware image"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2990#event-15744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2990",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2990#event-15745"
}
```
...
```json
{
    ...
    "asset_name": "sage-2990.patch",
    "asset_url": "tarball://root/attachments/ticket2990/sage-2990.patch",
    "created_at": "2008-04-22T04:40:19Z",
    "issue": "https://github.com/sagemath/sage/issues/2990",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2990/sage-2990.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [sage-2990.patch](https://github.com/sagemath/sage/files/ticket2990/sage-2990.patch) by mabshoff created at 2008-04-22 04:40:19\n\nMerged in Sage 3.0.final",
    "created_at": "2008-04-22T04:40:19Z",
    "issue": "https://github.com/sagemath/sage/issues/2990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2990#issuecomment-16395",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
