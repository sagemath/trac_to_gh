...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31643"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31644"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31646"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2971",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2971#issuecomment-15574",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31650"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2971#event-31651"
}
```
