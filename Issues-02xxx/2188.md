...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2188#issuecomment-15498",
...
```json
{
    "body": "<a id='comment:1'></a>The bit-shift method uses the GMP function ``mpz_mul_2exp``, thus this ticket is no longer valid.",
    "created_at": "2010-01-16T08:06:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2188#issuecomment-15499",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

<a id='comment:1'></a>The bit-shift method uses the GMP function ``mpz_mul_2exp``, thus this ticket is no longer valid.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2188#issuecomment-15500",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2188",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2188#event-5226"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2188#event-5227"
}
```
