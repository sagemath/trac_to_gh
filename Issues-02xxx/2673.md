...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28255"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28256"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28258"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2673",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28260"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28261"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28262"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2673",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2673#issuecomment-13910",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28264"
}
```
