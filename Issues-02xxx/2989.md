...
```json
{
    "body": "<a id='comment:1'></a>Attachment [sage-2989.patch](tarball://root/attachments/some-uuid/ticket2989/sage-2989.patch) by boothby created at 2008-04-21 20:42:30\n\nfails to apply against alpha5 :(",
    "created_at": "2008-04-21T20:42:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2989#issuecomment-21065",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```

<a id='comment:1'></a>Attachment [sage-2989.patch](tarball://root/attachments/some-uuid/ticket2989/sage-2989.patch) by boothby created at 2008-04-21 20:42:30
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2989#issuecomment-21066",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2989#issuecomment-21067",
    "user": "https://github.com/williamstein"
}
```
