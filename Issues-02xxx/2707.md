...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] clean and better document is_totally_real(), add is_totally_imaginary() to NumberField_generic",
        "to": "[with patch, has referee report] clean and better document is_totally_real(), add is_totally_imaginary() to NumberField_generic"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2707#event-9616"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2707#issuecomment-19582",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2707#issuecomment-19583",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "rename": {
        "from": "[with patch, has referee report] clean and better document is_totally_real(), add is_totally_imaginary() to NumberField_generic",
        "to": "[with patch, needs review] clean and better document is_totally_real(), add is_totally_imaginary() to NumberField_generic"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2707#event-9617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2707#issuecomment-19584",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch, needs review] clean and better document is_totally_real(), add is_totally_imaginary() to NumberField_generic",
        "to": "[with patch, with positive review] clean and better document is_totally_real(), add is_totally_imaginary() to NumberField_generic"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2707#event-9618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2707#issuecomment-19585",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2707#event-9619"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2707#issuecomment-19586",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2707",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2707#issuecomment-19587",
    "user": "https://github.com/ncalexan"
}
```
