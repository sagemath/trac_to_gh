...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2818#issuecomment-20272",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, positive review] notebook -- document most functions in js.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2818#event-9958"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2818#issuecomment-20273",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2818",
    "rename": {
        "from": "[with patch, positive review] notebook -- document most functions in js.py",
        "to": "[with patch, positive review, needs rebase] notebook -- document most functions in js.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2818#event-9959"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2818#issuecomment-20274",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2818",
    "rename": {
        "from": "[with patch, positive review, needs rebase] notebook -- document most functions in js.py",
        "to": "[with patch, positive review] notebook -- document most functions in js.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2818#event-9960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2818#issuecomment-20275",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2818#issuecomment-20276",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2818",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2818#event-9961"
}
```
