...
```json
{
    "body": "<a id='comment:1'></a>Attachment [sage-2576.patch](tarball://root/attachments/some-uuid/ticket2576/sage-2576.patch) by @williamstein created at 2008-03-17 18:52:06\n\nTo test the attached:\n\n```\nR.<x,y,z> = PolynomialRing(QQ, 3, order='lex')\np = z^2 + 1; q = z^3 + 2\nI = (p*q^2, y-z^2)*R\npd = I.complete_primary_decomposition?\n```",
...
<a id='comment:1'></a>Attachment [sage-2576.patch](tarball://root/attachments/some-uuid/ticket2576/sage-2576.patch) by @williamstein created at 2008-03-17 18:52:06
...
```json
{
    "body": "<a id='comment:3'></a>Michael Brickenstein on [sage-devel]:\n\n```\nBy the way\nwrapper.__name__=func.__name__\nis usually also a good practice.\n```",
...
<a id='comment:3'></a>Michael Brickenstein on [sage-devel]:
...
<a id='comment:4'></a>Replying to [was](#comment%3A1):
> To test the attached:
> 
> ```
> R.<x,y,z> = PolynomialRing(QQ, 3, order='lex')
...
```json
{
    "body": "<a id='comment:5'></a>Merged in Sage 2.11.alpha0",
    "created_at": "2008-03-18T00:32:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2576",
    "type": "issue_comment",
...
<a id='comment:5'></a>Merged in Sage 2.11.alpha0
