...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2031",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17637"
}
```
