...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17927"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2031#issuecomment-10215",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2031#issuecomment-10216",
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17931"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17932"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2031",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2031#event-17934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2031",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2031#issuecomment-10217",
    "user": "https://github.com/williamstein"
}
```
