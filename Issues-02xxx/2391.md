...
```json
{
    "body": "Attachment [scripts-2391.patch](https://github.com/sagemath/sage/files/ticket2391/scripts-2391.patch) by @williamstein created at 2008-03-05 01:10:23\n\nthis fixes the bug and vastly improves the documentation of sage-preparse",
    "created_at": "2008-03-05T01:10:23Z",
    "issue": "https://github.com/sagemath/sage/issues/2391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2391#issuecomment-12688",
    "user": "https://github.com/williamstein"
}
```

Attachment [scripts-2391.patch](https://github.com/sagemath/sage/files/ticket2391/scripts-2391.patch) by @williamstein created at 2008-03-05 01:10:23
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2391#issuecomment-12689",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2391#issuecomment-12690",
