...
```json
{
    "body": "<a id='comment:3'></a>\nRegarding my comment about split_file_names -- yes it could be done that way, but split_file_names is a VERY complicated function whereas `_strip_`quotes which is included in this patch is very simple and easy to use/understand. So I'm not convinced by my previous suggestion.",
