...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17910"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17913"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17915"
}
```
...
```json
{
    "body": "<a id='comment:2'>Comment 2:</a>\nThe problem seen after applying [attachment: trac_2059_1.patch.gz](https://github.com/sagemath/sage/files/ticket2059/trac_2059_1.patch.gz) is a bug in `PolyBoRi` itself. Trying to compute the Groebner basis of an ideal generated by [x,y] causes the heuristic function to blow up with the same problem in the ipython shell that comes with `PolyBoRi.` I will report this upstream.",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2059#issuecomment-10374",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17917"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2059#issuecomment-10375",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2059",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2059#event-17918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2059#issuecomment-10376",
