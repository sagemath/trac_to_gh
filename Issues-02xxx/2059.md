...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14358",
...
```json
{
    "body": "<a id='comment:1'></a>The attached patch `trac_2059_1.patch` fixes the attribute error, however now:\n\n```\nsage:  sage: B.<x,y,z> = BooleanPolynomialRing(3)\nsage:  sage: B.ideal([x,y])\nIdeal (x, y) of Boolean PolynomialRing in x, y, z\nsage:  sage: B.ideal([x,y])^3\nIdeal (x, x*y, x*y, x*y, x*y, x*y, x*y, y) of Boolean PolynomialRing in x, y, z\nsage:  B.ideal([x,y])^20\n...\n<type 'exceptions.AttributeError'>: 'list' object has no attribute 'minimalizeAndTailReduce'\n```\n\nBurcin, any idea?",
    "created_at": "2008-02-05T17:27:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14359",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>The attached patch `trac_2059_1.patch` fixes the attribute error, however now:
...
```json
{
    "body": "<a id='comment:2'></a>The problem seen after applying attachment:trac_2059_1.patch is a bug in `PolyBoRi` itself. Trying to compute the Groebner basis of an ideal generated by [x,y] causes the heuristic function to blow up with the same problem in the ipython shell that comes with `PolyBoRi.` I will report this upstream.",
    "created_at": "2008-02-06T11:06:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14360",
    "user": "https://github.com/burcin"
}
```

<a id='comment:2'></a>The problem seen after applying attachment:trac_2059_1.patch is a bug in `PolyBoRi` itself. Trying to compute the Groebner basis of an ideal generated by [x,y] causes the heuristic function to blow up with the same problem in the ipython shell that comes with `PolyBoRi.` I will report this upstream.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14361",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14362",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This seems to be fixed in PolyBoRi 0.3.1:\n\n```\nsage: B.<x,y,z> = BooleanPolynomialRing(3)\nsage: B.ideal([x,y])\nIdeal (x, y) of Boolean PolynomialRing in x, y, z\nsage: B.ideal([x,y])^3\nIdeal (x, x*y, x*y, x*y, x*y, x*y, x*y, y) of Boolean PolynomialRing in x, y, z\nsage: B.ideal([x,y])^20\nIdeal (x, y) of Boolean PolynomialRing in x, y, z\n```",
    "created_at": "2008-04-07T13:15:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14363",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>This seems to be fixed in PolyBoRi 0.3.1:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14364",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2059#event-4941"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Closed on recommendation of malb.",
    "created_at": "2008-04-07T13:41:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2059#issuecomment-14365",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Closed on recommendation of malb.
