...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2233#issuecomment-15970",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2233#issuecomment-15971",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2233#issuecomment-15972",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [trac2233_padics3.patch](tarball://root/attachments/some-uuid/ticket2233/trac2233_padics3.patch) by mabshoff created at 2008-02-20 17:20:03\n\nMerged all three patches in Sage 2.10.2.alpha2",
    "created_at": "2008-02-20T17:20:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2233#issuecomment-15973",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Attachment [trac2233_padics3.patch](tarball://root/attachments/some-uuid/ticket2233/trac2233_padics3.patch) by mabshoff created at 2008-02-20 17:20:03
