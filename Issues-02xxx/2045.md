...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2045#event-18091"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2045#event-18092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2045#event-18093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2045#event-18094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2045#issuecomment-10306",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2045",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2045#event-18095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2045#issuecomment-10307",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2045#event-18096"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2045#event-18097"
}
```
