# Issue 2833: [Patch attached, positive review] Linbox build failure on OSX 10.4 intel
...
```json
{
    ...
    "title": "[Patch attached, positive review] Linbox build failure on OSX 10.4 intel",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2833",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2833#event-6510"
}
```
