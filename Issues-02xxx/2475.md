...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17521",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17522",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2475#event-8717"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] doctest -- get coverage of modular/dims.py up to 100%"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2475#event-8718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17523",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17524",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "rename": {
        "from": "[with patch; needs review] doctest -- get coverage of modular/dims.py up to 100%",
        "to": "[with patch; with positive review] doctest -- get coverage of modular/dims.py up to 100%"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2475#event-8719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17525",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17526",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17527",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2475#event-8720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2475#issuecomment-17529",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
