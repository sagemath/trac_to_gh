...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2572#issuecomment-18420",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2572#issuecomment-18421",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2572#issuecomment-18422",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "rename": {
        "from": "imag() not defined for Algebraic Real Field",
        "to": "[with patch, needs review] imag() not defined for Algebraic Real Field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2572#event-9071"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2572#issuecomment-18423",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "rename": {
        "from": "[with patch, needs review] imag() not defined for Algebraic Real Field",
        "to": "[with patch, positive review] imag() not defined for Algebraic Real Field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2572#event-9072"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2572#issuecomment-18424",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2572#issuecomment-18425",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2572",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2572#event-9073"
}
```
