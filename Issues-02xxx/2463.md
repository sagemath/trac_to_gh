...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22228"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22229"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22232"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22233"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22234"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.10.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22235"
}
```
...
```json
{
    ...
    "title_was": "Linbox static commentator make sage crash on PPC",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2463",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-22237"
}
```
