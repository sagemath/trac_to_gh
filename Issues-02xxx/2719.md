# Issue 2719: [with patch; positive review] bitset is completely broken on os x 10.4 G5
...
```json
{
    ...
    "title": "[with patch; positive review] bitset is completely broken on os x 10.4 G5",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2719",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2719#event-6344"
}
```
