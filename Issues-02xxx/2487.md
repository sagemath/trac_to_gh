...
```json
{
    ...
    "asset_name": "trac_2487.patch",
    "asset_url": "tarball://root/attachments/ticket2487/trac_2487.patch",
    "created_at": "2008-03-13T01:58:05Z",
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2487/trac_2487.patch",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    "body": "Attachment [trac_2487.patch](https://github.com/sagemath/sage/files/ticket2487/trac_2487.patch) by @garyfurnish created at 2008-03-13 01:58:05",
    "created_at": "2008-03-13T01:58:05Z",
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13282",
    "user": "https://github.com/garyfurnish"
}
```

Attachment [trac_2487.patch](https://github.com/sagemath/sage/files/ticket2487/trac_2487.patch) by @garyfurnish created at 2008-03-13 01:58:05
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13283",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-12680"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-12681"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13284",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-12682"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13285",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-12683"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-12684"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-12685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-12686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13286",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
