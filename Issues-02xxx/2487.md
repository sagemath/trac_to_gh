...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22475"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22478"
}
```
...
```json
{
    "body": "Changed assignee from **@malb** to **@garyfurnish**",
    "created_at": "2008-03-13T01:58:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13293",
    "user": "https://github.com/garyfurnish"
}
```

Changed assignee from **@malb** to **@garyfurnish**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13294",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13295",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22484"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2487#event-22485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2487",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2487#issuecomment-13296",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
