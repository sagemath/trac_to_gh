...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2154#issuecomment-11051",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2154#issuecomment-11052",
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [2154-invalid-perm.patch](https://github.com/sagemath/sage/files/ticket2154/2154-invalid-perm.patch) by @robertwb created at 2008-02-21 22:06:24\n\nIt looks like the problem here was actually infinite loops, but it now checks to make sure it always gets a valid permutation (even if check=False is set).",
    "created_at": "2008-02-21T22:06:24Z",
    "issue": "https://github.com/sagemath/sage/issues/2154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2154#issuecomment-11053",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2154#issuecomment-11054",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2154#issuecomment-11055",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
