...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14465",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14466",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14467",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>attachment:2148-polybori_monomial_order_keywords.patch corrects the monomial order keywords in the `PolyBoRi` wrapper.",
    "created_at": "2008-02-17T16:53:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14468",
    "user": "https://github.com/burcin"
}
```

<a id='comment:1'></a>attachment:2148-polybori_monomial_order_keywords.patch corrects the monomial order keywords in the `PolyBoRi` wrapper.
...
```json
{
    "body": "<a id='comment:3'></a>You're right, it's not so simple. I'll look at it a bit more.",
    "created_at": "2008-02-17T18:35:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14470",
    "user": "https://github.com/burcin"
}
```

<a id='comment:3'></a>You're right, it's not so simple. I'll look at it a bit more.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14471",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14472",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Attachment [2148-polybori-fix_degrevlex.patch](tarball://root/attachments/some-uuid/ticket2148/2148-polybori-fix_degrevlex.patch) by @burcin created at 2008-03-08 13:31:46\n\nattachment:2148-polybori-fix_degrevlex.patch arranges the variable indexes in the Sage - `PolyBoRi` interface to handle the difference between degrevlex and dp_asc orders.\n\nNote that with this patch, printing is reversed when using dp_asc orders:\n\n```\nsage: P.<x,y,z> = BooleanPolynomialRing(3,order='degrevlex')\nsage: x*y*z\nz*y*x\nsage: P.<x,y,z> = BooleanPolynomialRing(3,order='lex')\nsage: x*y*z\nx*y*z\n```",
    "created_at": "2008-03-08T13:31:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14473",
    "user": "https://github.com/burcin"
}
```

<a id='comment:5'></a>Attachment [2148-polybori-fix_degrevlex.patch](tarball://root/attachments/some-uuid/ticket2148/2148-polybori-fix_degrevlex.patch) by @burcin created at 2008-03-08 13:31:46
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14474",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14475",
...
```json
{
    "body": "<a id='comment:8'></a>Merged 2148-polybori-fix_degrevlex.patch in Sage 2.11.alpha0",
    "created_at": "2008-03-18T00:08:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2148#issuecomment-14476",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Merged 2148-polybori-fix_degrevlex.patch in Sage 2.11.alpha0
