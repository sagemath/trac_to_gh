# Issue 2399: [with patch, positive review] allow utf8 characters in the notebook cells
...
```json
{
    ...
    "title": "[with patch, positive review] allow utf8 characters in the notebook cells",
    "type": "issue",
