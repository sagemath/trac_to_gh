...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2216#issuecomment-15325",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Creating an order in a number field --> infinite loop?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2216#event-7664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "rename": {
        "from": "[with patch, needs review] Creating an order in a number field --> infinite loop?",
        "to": "[with patch, with 99% positive review] Creating an order in a number field --> infinite loop?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2216#event-7665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2216#issuecomment-15326",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2216#issuecomment-15327",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2216#issuecomment-15328",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, positive review] Creating an order in a number field --> infinite loop?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2216#event-7666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2216#issuecomment-15329",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2216#issuecomment-15330",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2216#event-7667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2216#issuecomment-15331",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
