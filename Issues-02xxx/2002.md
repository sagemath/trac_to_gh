...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13514",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] creating a fresh new notebook in sage-2.10.1.rc3 is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2002#event-6858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13515",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13516",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13517",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13518",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "rename": {
        "from": "[with patch, needs review] creating a fresh new notebook in sage-2.10.1.rc3 is broken",
        "to": "[with patch, with cautious positive review] creating a fresh new notebook in sage-2.10.1.rc3 is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2002#event-6859"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "rename": {
        "from": "[with patch, with cautious positive review] creating a fresh new notebook in sage-2.10.1.rc3 is broken",
        "to": "[with patch, with positive review] creating a fresh new notebook in sage-2.10.1.rc3 is broken"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2002#event-6860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13519",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13520",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2002#event-6861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2002#issuecomment-13521",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
