...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2002#issuecomment-10062",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2002#issuecomment-10063",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2002/pretty-print-notebook.patch",
    "created_at": "2008-01-31T21:07:43Z",
    "issue": "https://github.com/sagemath/sage/issues/2002",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2002/pretty-print-notebook.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "Attachment [pretty-print-notebook.patch](https://github.com/sagemath/sage/files/ticket2002/pretty-print-notebook.patch) by @jasongrout created at 2008-01-31 21:07:43",
    "created_at": "2008-01-31T21:07:43Z",
    "issue": "https://github.com/sagemath/sage/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2002#issuecomment-10064",
    "user": "https://github.com/jasongrout"
}
```

Attachment [pretty-print-notebook.patch](https://github.com/sagemath/sage/files/ticket2002/pretty-print-notebook.patch) by @jasongrout created at 2008-01-31 21:07:43
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2002#issuecomment-10065",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2002#issuecomment-10066",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2002#issuecomment-10067",
