...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21871",
    "user": "https://github.com/jbalakrishnan"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Even series inversion gives the list index breakage:\n\n```\nsage: p = 11\nsage: K = Qp(p,10)\nsage: C.<t> = LaurentSeriesRing(K)\nsage: D.<s> = PowerSeriesRing(C)\nsage: z = 1 + (t^3 + O(t^13))*s\nsage: 1/z\n```",
    "created_at": "2008-04-29T20:32:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21873",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:3'></a>Even series inversion gives the list index breakage:
...
```json
{
    "body": "<a id='comment:4'></a>Actually even just squaring something really simple can break:\n\n```\nsage: K = Qp(p,10)\nsage: C.<t> = LaurentSeriesRing(K)\nsage: D.<s> = PowerSeriesRing(C)\nsage: z = (1 + O(t)) + t*s^2\nsage: z * z\n[boom]\n```",
    "created_at": "2008-04-29T20:48:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21874",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:4'></a>Actually even just squaring something really simple can break:
...
```json
{
    "body": "<a id='comment:5'></a>ok, the bug is in the polynomial mult instead of the power series mult:\n\n```\nsage: K = Qp(p,10)\nsage: C.<t> = LaurentSeriesRing(K)\nsage: D.<s> = PolynomialRing(C)\nsage: z = (1 + O(t)) + t*s^2\nsage: z * z\n[boom]\n```",
    "created_at": "2008-04-29T20:55:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21875",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:5'></a>ok, the bug is in the polynomial mult instead of the power series mult:
...
```json
{
    "body": "<a id='comment:6'></a>At least part of this bug is caused by some broken code in p-adic polynomial getslice. Here is the example from the docstring:\n\n```\nsage: K = Qp(13,7)\nsage: R.<t> = K[]       \nsage: a = 13^7*t^3 + K(169,4)*t - 13^4\nsage: a[1:2]\n(13^2 + O(13^4))*t\n```\n\nbut this one dies:\n\n```\nsage: t[0:1]\n[boom]\n```",
    "created_at": "2008-04-29T21:29:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21876",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:6'></a>At least part of this bug is caused by some broken code in p-adic polynomial getslice. Here is the example from the docstring:
...
```json
{
    "body": "<a id='comment:7'></a>A smaller example of the original bug (this example involves only multiplication, no division):\n\n```\nsage: R.<u> = QQ[]\nsage: p = 11\nsage: K = Qp(p,10)\nsage: J.<a> = K.extension(u^2-p)\nsage: C.<t> = LaurentSeriesRing(J)\nsage: D.<s> = PowerSeriesRing(C)\nsage: x = t + (t^2 + O(t^3))*s\nsage: y = t^(-1) + (-1 + O(t))*s + O(s^2)\nsage: x * y\n[boom]\n```",
    "created_at": "2008-04-30T18:02:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21877",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:7'></a>A smaller example of the original bug (this example involves only multiplication, no division):
...
```json
{
    "body": "<a id='comment:8'></a>Even simpler (doesn't need the outer PowerSeries ring):\n\n```\nR.<u> = QQ[]\np = 11\nK = Qp(p,10)\nJ.<a> = K.extension(u^2-p)\nC.<t> = LaurentSeriesRing(J)\nD.<s> = PolynomialRing(C)\nx = t + (t^2 + O(t^3))*s\ny = t^(-1) + (-1 + O(t))*s\nh = x * y\n[boom]\n```",
    "created_at": "2008-04-30T18:09:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21878",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:8'></a>Even simpler (doesn't need the outer PowerSeries ring):
...
```json
{
    "body": "<a id='comment:12'></a>Attachment [2943.patch](tarball://root/attachments/some-uuid/ticket2943/2943.patch) by dmharvey created at 2008-05-13 13:01:01\n\nAttached patch should fix this bug.\n\n(Note: this does not fix the \"list index\" exception issue, which also came up in the above discussion. That is now a separate ticket: #3184)",
    "created_at": "2008-05-13T13:01:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21882",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:12'></a>Attachment [2943.patch](tarball://root/attachments/some-uuid/ticket2943/2943.patch) by dmharvey created at 2008-05-13 13:01:01
...
```json
{
    "body": "<a id='comment:14'></a>Someone else seems to have hit a related bug, see the following thread:\n\nhttp://groups.google.com/group/sage-devel/browse_thread/thread/56a73f331e6b2977",
    "created_at": "2008-07-17T15:35:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21884",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:14'></a>Someone else seems to have hit a related bug, see the following thread:
...
```json
{
    "body": "<a id='comment:15'></a>Any movement here? This ticket seems to have gone stale.\n\nCheers,\n\nMichael",
    "created_at": "2008-11-23T10:17:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21885",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>Any movement here? This ticket seems to have gone stale.
...
```json
{
    "body": "<a id='comment:16'></a>I can simplify dmharvey's bad example even further. No need to work over the p-adics at all! (This execution is from 3.2.3.)\n\n```\nsage: C.<t> = PowerSeriesRing(Integers())                                       \nsage: D.<s> = PowerSeriesRing(C)                                               \nsage: y = 1 - (t + O(t^2))*s + O(s^5)                                          \nsage: 1/y                                                                      \n1 + (t + O(t^2))*s + (2*t^2 + O(t^3))*s^2 + O(s^5)\n```\nSo I dare say this is really a bug in power series, specifically in precision management.",
    "created_at": "2009-01-22T03:00:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21886",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:16'></a>I can simplify dmharvey's bad example even further. No need to work over the p-adics at all! (This execution is from 3.2.3.)
...
```json
{
    "body": "<a id='comment:21'></a>> This is a systemic problem with using the generic polynomial module with an inexact ring: it has a habit of truncating leading zeroes after virtually every arithmetic operation. This systemic problem needs a systemic solution: there needs to be a way to check whether an element of an inexact ring is an exact zero or not, so that `truncate` can preserve inexact leading zeroes, i.e., a method called `is_exact_zero` or something.\n\n\nI agree, this is the key. I believe it's been discussed several times in the past. Unfortunately the Sage development model seems to be very good at introducing systemic design bugs like this, but doesn't seem to be very good at fixing them (my perennial favourite is #3680). What we need is a hero with lots of time on their hands.\n\ndavid",
    "created_at": "2009-01-22T16:10:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21891",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:21'></a>> This is a systemic problem with using the generic polynomial module with an inexact ring: it has a habit of truncating leading zeroes after virtually every arithmetic operation. This systemic problem needs a systemic solution: there needs to be a way to check whether an element of an inexact ring is an exact zero or not, so that `truncate` can preserve inexact leading zeroes, i.e., a method called `is_exact_zero` or something.
...
```json
{
    "body": "<a id='comment:22'></a>In order to clarify things for newcomers to this discussion, I created a separate ticket #5075 to deal with the truncation of leading zeroes. Once that gets resolved, we can come back to the Karatsuba issue.",
    "created_at": "2009-01-23T19:06:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21892",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:22'></a>In order to clarify things for newcomers to this discussion, I created a separate ticket #5075 to deal with the truncation of leading zeroes. Once that gets resolved, we can come back to the Karatsuba issue.
...
```json
{
    "body": "<a id='comment:23'></a>All the examples on this ticket seem to be resolved in 4.0rc0. I'm not sure why, since #5075 is still open, but fixing #3056, #3184, and others may have helped. \n\nEspecially in light of the existence of #6084 (which should fix #5075 among other things), I propose to call this issue fixed and put this ticket out of its misery.",
    "created_at": "2009-05-22T03:34:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21893",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:23'></a>All the examples on this ticket seem to be resolved in 4.0rc0. I'm not sure why, since #5075 is still open, but fixing #3056, #3184, and others may have helped. 
...
```json
{
    "body": "<a id='comment:24'></a>Attachment [trac_13106.patch](tarball://root/attachments/some-uuid/ticket2943/trac_13106.patch) by @kedlaya created at 2009-12-03 03:26:34\n\nI decided this ticket should actually end up with a patch and a review, so I added a patch (mislabeled, sorry) to put another doctest from the above discussion into polynomial_element.pyx.",
    "created_at": "2009-12-03T03:26:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21894",
    "user": "https://github.com/kedlaya"
}
```

<a id='comment:24'></a>Attachment [trac_13106.patch](tarball://root/attachments/some-uuid/ticket2943/trac_13106.patch) by @kedlaya created at 2009-12-03 03:26:34
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21895",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    "body": "Changing author from \"\" to \"kedlaya\"",
    "created_at": "2009-12-03T03:26:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21896",
    "user": "https://github.com/kedlaya"
}
```

Changing author from "" to "kedlaya"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21897",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21898",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21899",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21900",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21901",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2943#issuecomment-21902",
    "user": "https://github.com/mwhansen"
}
```
