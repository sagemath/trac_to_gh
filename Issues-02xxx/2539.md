...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2539#event-23422"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2539#event-23423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2539#event-23424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2539#event-23425"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2539",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2539#event-23426"
}
```
