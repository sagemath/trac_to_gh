...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2000#issuecomment-13498",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] fall back to univariate factoring if possible"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2000#event-6851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2000",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2000#issuecomment-13499",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2000",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2000#issuecomment-13500",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2000",
    "rename": {
        "from": "[with patch, needs review] fall back to univariate factoring if possible",
        "to": "[with patch, positive review] fall back to univariate factoring if possible"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2000#event-6852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2000",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2000#issuecomment-13501",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2000",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2000#event-6853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2000",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2000#issuecomment-13502",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
