...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2449#issuecomment-13034",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2449#issuecomment-13035",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2449#issuecomment-13036",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2449#issuecomment-13037",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2449#issuecomment-13038",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2449#issuecomment-13039",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2449/sage-2449-extra1.patch",
    "created_at": "2008-03-10T16:41:07Z",
    "issue": "https://github.com/sagemath/sage/issues/2449",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2449/sage-2449-extra1.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [sage-2449-extra1.patch](https://github.com/sagemath/sage/files/ticket2449/sage-2449-extra1.patch) by @williamstein created at 2008-03-10 16:41:07\n\nOnly apply this *after* #2451, or some of the doctest examples might be very slow.",
    "created_at": "2008-03-10T16:41:07Z",
    "issue": "https://github.com/sagemath/sage/issues/2449",
    "type": "issue_comment",
...
Attachment [sage-2449-extra1.patch](https://github.com/sagemath/sage/files/ticket2449/sage-2449-extra1.patch) by @williamstein created at 2008-03-10 16:41:07
