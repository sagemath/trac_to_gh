# Issue 2814: [with patch, positive review] sage-3.0-alpha1 on ppc -- new randstate code doesn't work right at all
...
```json
{
    ...
    "title": "[with patch, positive review] sage-3.0-alpha1 on ppc -- new randstate code doesn't work right at all",
    "type": "issue",
...
```json
{
    "body": "Description changed:\n```diff\n--- \n+++ \n@@ -315,6 +315,37 @@\n ***Test Failed*** 4 failures.\n ```\n \n+```\n+sage -t  devel/sage/sage/rings/complex_double.pyx\n+**********************************************\n+************************\n+File \"/Users/was/build/sage-3.0.alpha1/tmp/complex_double.py\", line 179:\n+   sage: CDF.random_element()\n+Expected:\n+   -0.436810529675 + 0.736945423566*I\n+Got:\n+   0.736945423566 - 0.436810529675*I\n+**********************************************************************\n+File \"/Users/was/build/sage-3.0.alpha1/tmp/complex_double.py\", line 181:\n+   sage: CDF.random_element(-10,10,-10,10)\n+Expected:\n+   -7.08874026302 - 9.54135400334*I\n+Got:\n+   -9.54135400334 - 7.08874026302*I\n+**********************************************************************\n+File \"/Users/was/build/sage-3.0.alpha1/tmp/complex_double.py\", line 183:\n+   sage: CDF.random_element(-10^20,10^20,-2,2)\n+Expected:\n+   -7.58765473764e+19 + 0.925549022839*I\n+Got:\n+   4.62774511419e+19 - 1.51753094753*I\n+**********************************************************************\n+1 items had failures:\n+  3 of   4 in __main__.example_7\n+***Test Failed*** 3 failures.\n+```\n+\n+\n Comment: 1\n \n Summary: sage-3.0-alpha1 on ppc -- new randstate code doesn't work right at all\n```\n",
    "created_at": "2008-04-05T20:02:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2814#issuecomment-19783",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2814#issuecomment-19784",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2814#issuecomment-19785",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I believe that the two patches fix all of the issues in this ticket.  With the patches, sage -testall passes on 32-bit x86, but they have NOT BEEN TESTED on PPC at all, so somebody needs to do that.",
    "created_at": "2008-04-10T03:02:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2814#issuecomment-19786",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:2'></a>I believe that the two patches fix all of the issues in this ticket.  With the patches, sage -testall passes on 32-bit x86, but they have NOT BEEN TESTED on PPC at all, so somebody needs to do that.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2814#issuecomment-19789",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2814",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2814#issuecomment-19790",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
