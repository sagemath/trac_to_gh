...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19917",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19918",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19919",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19920",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, with negative review] error in elem.matrix(F) and elem.norm(F) for F == elem.parent() a number field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2767#event-9784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19921",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19922",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "rename": {
        "from": "[with patch, with negative review] error in elem.matrix(F) and elem.norm(F) for F == elem.parent() a number field",
        "to": "[with patch, with positive review] error in elem.matrix(F) and elem.norm(F) for F == elem.parent() a number field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2767#event-9785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19923",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19924",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2767#event-9786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-19925",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
