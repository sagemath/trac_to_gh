# Issue 2767: [with positive review] error in elem.matrix(F) and elem.norm(F) for F == elem.parent() a number field
...
```json
{
    ...
    "title": "[with positive review] error in elem.matrix(F) and elem.norm(F) for F == elem.parent() a number field",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21300",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21301",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21302",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "asset_name": "trac-2767.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket2767/trac-2767.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21303",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2767#event-8193"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21304",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21305",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] error in elem.matrix(F) and elem.norm(F) for F == elem.parent() a number field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2767#event-8194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21306",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21307",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2767#event-8195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2767",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2767#issuecomment-21308",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
