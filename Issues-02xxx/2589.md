...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23961"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2589#issuecomment-14048",
    "user": "https://github.com/NathanDunfield"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23965"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23967"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2589",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-23968"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2589#issuecomment-14049",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2589",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2589#issuecomment-14050",
    "user": "https://github.com/NathanDunfield"
}
```
