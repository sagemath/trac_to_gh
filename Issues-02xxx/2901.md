...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2901#issuecomment-20957",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] rewrite load_session and save_session to use much better modern techniques (in particular merge the notebook and non-notebook implementations)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2901#event-10289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2901#issuecomment-20958",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2901#issuecomment-20959",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2901",
    "rename": {
        "from": "[with patch; needs review] rewrite load_session and save_session to use much better modern techniques (in particular merge the notebook and non-notebook implementations)",
        "to": "[with patch; with positive review] rewrite load_session and save_session to use much better modern techniques (in particular merge the notebook and non-notebook implementations)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2901#event-10290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2901#issuecomment-20960",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2901#issuecomment-20961",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2901",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2901#event-10291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2901#issuecomment-20962",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
