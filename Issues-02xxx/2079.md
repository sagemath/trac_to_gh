...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14492",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14495",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This is a really really serious bug somewhere in the actions part of the coercion model.  I've promoted it to a blocker.",
    "created_at": "2008-02-19T00:58:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14496",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>This is a really really serious bug somewhere in the actions part of the coercion model.  I've promoted it to a blocker.
...
```json
{
    "body": "<a id='comment:5'></a>The problem is around line 869 of coerce.pyx, where if we put:\n\n```\n        if self.connecting is not None:\n            print \"g before = \", g\n            g = self.connecting._call_c(g)\n            print \"g after = \", g\n```\n\nthen run the sample code:\n\n```\nsage: R.<x> = QQ[]; a = 2*x^2+2\nsage: a /= 2\ng before =  1/2\ng after =  1\n3 2*x^2 + 2 1\n```\n\nyou see that self.connecting._call_c is somehow replacing 1/2 by 1.  Not good.",
    "created_at": "2008-02-19T01:29:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14497",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:5'></a>The problem is around line 869 of coerce.pyx, where if we put:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14499",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [sage-2079.patch](tarball://root/attachments/some-uuid/ticket2079/sage-2079.patch) by @robertwb created at 2008-02-19 04:09:48\n\nI figured out what the issue is. I will post a fix tonight (after making sure it breaks nothing else, and adding more doctests/consistency checks.)",
    "created_at": "2008-02-19T04:09:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14500",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>Attachment [sage-2079.patch](tarball://root/attachments/some-uuid/ticket2079/sage-2079.patch) by @robertwb created at 2008-02-19 04:09:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14501",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14502",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14503",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14505",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>One more comment: ALL the patches attached to this ticket should be applied in order.",
    "created_at": "2008-02-19T14:37:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14506",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>One more comment: ALL the patches attached to this ticket should be applied in order.
...
```json
{
    "body": "<a id='comment:12'></a>All four patches merge in Sage 2.10.2.alpha1",
    "created_at": "2008-02-19T14:56:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14507",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>All four patches merge in Sage 2.10.2.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2079#issuecomment-14508",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
