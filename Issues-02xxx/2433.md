...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2433#issuecomment-17216",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2433#issuecomment-17217",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patches, need review] Refactor graph code; prepare for backend migration; miscellaneous small things from Waterloo"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2433#event-8527"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2433#issuecomment-17218",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2433",
    "rename": {
        "from": "[with patches, need review] Refactor graph code; prepare for backend migration; miscellaneous small things from Waterloo",
        "to": "[with patches, very positive review] Refactor graph code; prepare for backend migration; miscellaneous small things from Waterloo"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2433#event-8528"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2433#issuecomment-17219",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2433#issuecomment-17220",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2433",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2433#event-8529"
}
```
