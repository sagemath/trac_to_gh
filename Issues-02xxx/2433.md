...
<a id='comment:2'></a>I can't actually post the patches as attachments to the trac ticket, so here are the links instead:
...
```json
{
    "body": "<a id='comment:3'></a>I've gone through all of the individual patches, and they definitely look good to me.  The big patch  applied cleanly to 2.10.3.rc2 for me and all tests pass.",
...
<a id='comment:3'></a>I've gone through all of the individual patches, and they definitely look good to me.  The big patch  applied cleanly to 2.10.3.rc2 for me and all tests pass.
...
```json
{
    "body": "<a id='comment:4'></a>Merged in Sage 2.10.3.rc4",
    "created_at": "2008-03-10T03:19:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2433",
    "type": "issue_comment",
...
<a id='comment:4'></a>Merged in Sage 2.10.3.rc4
