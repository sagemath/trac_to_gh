...
```json
{
    "body": "<a id='comment:3'></a>patch looks good. I say apply.",
...
<a id='comment:3'></a>patch looks good. I say apply.
...
```json
{
    "body": "<a id='comment:5'></a>Didier, please submit mercurial patches in the future so you will get proper credit for your patches in the changelog. In this case it was too late and now credit goes to me :(\n\nCheers,\n\nMichael",
...
<a id='comment:5'></a>Didier, please submit mercurial patches in the future so you will get proper credit for your patches in the changelog. In this case it was too late and now credit goes to me :(
