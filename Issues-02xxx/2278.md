...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2278#event-23364"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2278#event-23365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2278#event-23366"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2278#event-23367"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2278#event-23368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2278#issuecomment-11240",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2278#event-23369"
}
```
