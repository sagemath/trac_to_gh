...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2128#issuecomment-14619",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] bug in random_prime (trivial to fix!)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2128#event-7310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2128#issuecomment-14620",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "rename": {
        "from": "[with patch, needs review] bug in random_prime (trivial to fix!)",
        "to": "[with patch, with positive review, requesting doctest] bug in random_prime (trivial to fix!)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2128#event-7311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "rename": {
        "from": "[with patch, with positive review, requesting doctest] bug in random_prime (trivial to fix!)",
        "to": "[with patch, with positive review] bug in random_prime (trivial to fix!)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2128#event-7312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2128#issuecomment-14621",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2128#issuecomment-14622",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2128#event-7313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2128#issuecomment-14623",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2128",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2128#issuecomment-14624",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
