...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2172#issuecomment-14928",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2172#issuecomment-14929",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2172#issuecomment-14930",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] sage -sdist loses debian build infrastructure"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2172#event-7479"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2172#issuecomment-14931",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2172#issuecomment-14932",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "rename": {
        "from": "[with patch, needs review] sage -sdist loses debian build infrastructure",
        "to": "[with patch, with positive review] sage -sdist loses debian build infrastructure"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2172#event-7480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2172#event-7481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2172#issuecomment-14933",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2172",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2172#issuecomment-14934",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
