# Issue 2349: [with positive review] homogenize does different things in different contexts
...
```json
{
    ...
    "title": "[with positive review] homogenize does different things in different contexts",
    "type": "issue",
...
```json
{
    ...
    "asset_name": "trac_2349.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket2349/trac_2349.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2349#issuecomment-17440",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2349#issuecomment-17441",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2349",
    "rename": {
        "from": "homogenize does different things in different contexts",
        "to": "[with positive review] homogenize does different things in different contexts"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2349#event-6931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2349#issuecomment-17442",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2349#issuecomment-17443",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2349#issuecomment-17444",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2349",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2349#event-6932"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2349#event-6933"
}
```
