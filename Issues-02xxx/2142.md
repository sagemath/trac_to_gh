...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2142#issuecomment-10967",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2142#issuecomment-10968",
...
```json
{
    "body": "Attachment [2142-subdivisions.patch](https://github.com/sagemath/sage/files/ticket2142/2142-subdivisions.patch) by @robertwb created at 2008-03-06 20:00:28",
    "created_at": "2008-03-06T20:00:28Z",
    "issue": "https://github.com/sagemath/sage/issues/2142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2142#issuecomment-10969",
    "user": "https://github.com/robertwb"
}
```

Attachment [2142-subdivisions.patch](https://github.com/sagemath/sage/files/ticket2142/2142-subdivisions.patch) by @robertwb created at 2008-03-06 20:00:28
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2142#issuecomment-10970",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2142#issuecomment-10971",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2142#issuecomment-10972",
    "user": "https://github.com/jasongrout"
}
```
