...
```json
{
    "body": "<a id='comment:1'></a>The attached patch fixes a few of the docstring problems mentioned by Dan Drake. Really very minor changes. I didn't touch the functions written by Mike Hansen since I wasn't sure what plans he had for them. The issue of the lower case vs upper case functions wasn't dealt with. Perhaps the lower case functions should be removed from combinat/all.py?",
...
<a id='comment:1'></a>The attached patch fixes a few of the docstring problems mentioned by Dan Drake. Really very minor changes. I didn't touch the functions written by Mike Hansen since I wasn't sure what plans he had for them. The issue of the lower case vs upper case functions wasn't dealt with. Perhaps the lower case functions should be removed from combinat/all.py?
...
<a id='comment:2'></a>Attachment [8710.patch](tarball://root/attachments/some-uuid/ticket2328/8710.patch) by @dandrake created at 2008-02-27 23:44:49
...
<a id='comment:3'></a>I've attached a patch which addresses most of my complaining in the email thread. :)
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [combinat-doc.2.patch](tarball://root/attachments/some-uuid/ticket2328/combinat-doc.2.patch) by @mwhansen created at 2008-03-10 09:04:14\n\nI've uploaded combinat-doc.2.patch which replaces the first combinat-doc.patch",
...
<a id='comment:4'></a>Attachment [combinat-doc.2.patch](tarball://root/attachments/some-uuid/ticket2328/combinat-doc.2.patch) by @mwhansen created at 2008-03-10 09:04:14
...
```json
{
    "body": "<a id='comment:5'></a>I had trouble applying combinat-doc.2.patch against 2.10.2, 2.10.3.rc2 and 2.10.rc3, so I don't know what this is supposed to apply against.",
...
<a id='comment:5'></a>I had trouble applying combinat-doc.2.patch against 2.10.2, 2.10.3.rc2 and 2.10.rc3, so I don't know what this is supposed to apply against.
...
<a id='comment:8'></a>I've looked over the patches and give this a positive review.
...
```json
{
    "body": "<a id='comment:11'></a>Attachment [2328.patch](tarball://root/attachments/some-uuid/ticket2328/2328.patch) by @mwhansen created at 2008-03-14 19:20:33\n\nApply only 2328.patch after #2432 is applied.",
...
<a id='comment:11'></a>Attachment [2328.patch](tarball://root/attachments/some-uuid/ticket2328/2328.patch) by @mwhansen created at 2008-03-14 19:20:33
...
```json
{
    "body": "<a id='comment:12'></a>Merged in Sage 2.10.4.alpha0",
    "created_at": "2008-03-14T19:56:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2328",
    "type": "issue_comment",
...
<a id='comment:12'></a>Merged in Sage 2.10.4.alpha0
