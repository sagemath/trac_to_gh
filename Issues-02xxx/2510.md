...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2510#issuecomment-13420",
...
```json
{
    ...
    "asset_name": "2510-fix.patch",
    "asset_url": "tarball://root/attachments/ticket2510/2510-fix.patch",
    "created_at": "2008-03-14T02:24:21Z",
    "issue": "https://github.com/sagemath/sage/issues/2510",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2510/2510-fix.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [2510-fix.patch](https://github.com/sagemath/sage/files/ticket2510/2510-fix.patch) by mabshoff created at 2008-03-14 02:24:21\n\nPatch looks good to me. All doctests pass again with this patch applied.",
    "created_at": "2008-03-14T02:24:21Z",
    "issue": "https://github.com/sagemath/sage/issues/2510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2510#issuecomment-13421",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2510#event-12820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2510#issuecomment-13422",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2510#event-12821"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2510#event-12822"
}
```
