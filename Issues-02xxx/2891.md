...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30662"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30664"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30665"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30667"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30669"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30670"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30671"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30672"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30673"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30674"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30675"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30676"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30677"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30678"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30679"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15093",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15094",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15095",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15096",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15097",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15098",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15099",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "title_was": "inline_fortran -- completely rewrite to not save a global variable and *not* got hacked into various global structures all over",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30681"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30682"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30683"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15100",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15101",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15102",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15103",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15104",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15105",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15106",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15107",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15108",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15109",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15110",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15111",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15112",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15113",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15114",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30685"
}
```
...
```json
{
    "body": "<div id=\"comment:25\" align=\"right\">comment:25</div>\n\nGot it, I also see what I was messing up earlier.\n\nSo this is fine other than the import stuff in [comment:21](#comment:21), though one way to deal with that is to *not* remove those for now and deal with it when updating sagenb, e.g. #10057.",
    "created_at": "2014-12-12T19:26:57Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15115",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15116",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15117",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30689"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2891#issuecomment-15118",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30691"
}
```
