...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21430",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [inline_fortran.py](tarball://root/attachments/some-uuid/ticket2891/inline_fortran.py) by @williamstein created at 2008-04-12 03:17:57",
    "created_at": "2008-04-12T03:17:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21431",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:1'></a>Attachment [inline_fortran.py](tarball://root/attachments/some-uuid/ticket2891/inline_fortran.py) by @williamstein created at 2008-04-12 03:17:57
...
```json
{
    "body": "<a id='comment:8'></a>Hey Jeroen, you worked on several related tickets like #13992 and #13887 - is this ticket even needed at this point?  \n\n~~(Also, I can't figure out how exactly `src/sage/misc/inline_fortran.py` gets used, as it doesn't seem to ever be imported, and is only mentioned a comment in the scripts...)~~ The notebook is the only place this is used in any case (maybe also SMC?).  See also #8427.",
    "created_at": "2014-12-09T16:17:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21432",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:8'></a>Hey Jeroen, you worked on several related tickets like #13992 and #13887 - is this ticket even needed at this point?  
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21433",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21434",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21435",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>The problem is also that there isn't a single example using this `globals` argument, so it's hard to even know what the code *should* do.",
    "created_at": "2014-12-09T17:21:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21436",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:10'></a>The problem is also that there isn't a single example using this `globals` argument, so it's hard to even know what the code *should* do.
...
```json
{
    "body": "<a id='comment:11'></a>We could probably remove this whole `inline_fortran` thing without anybody noticing...",
    "created_at": "2014-12-09T17:26:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21437",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:11'></a>We could probably remove this whole `inline_fortran` thing without anybody noticing...
...
```json
{
    "body": "<a id='comment:12'></a>If you care, the `inline_fortran` stuff was added in Sage by\n\n```\ncommit d46359f9384268204bd687e2a7aaded15938399d\nAuthor: William Stein <wstein@gmail.com>\nDate:   Tue Jun 26 16:37:36 2007 -0700\n\n    (Josh Kantor and W Stein) Add support for %fortran in the notebook.\n\n```",
    "created_at": "2014-12-09T17:31:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21438",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:12'></a>If you care, the `inline_fortran` stuff was added in Sage by
...
```json
{
    "body": "<a id='comment:13'></a>> We could probably remove this whole `inline_fortran` thing without anybody noticing...\n\nI thought so too, but I figured out where it is used - in sagenb for `%fortran`.  As it says in the thing you quote, in fact.",
    "created_at": "2014-12-09T18:06:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21439",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:13'></a>> We could probably remove this whole `inline_fortran` thing without anybody noticing...
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21440",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21441",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "Changing branch from \"\" to \"u/jdemeyer/ticket/2891\"",
    "created_at": "2014-12-09T20:04:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21442",
    "user": "https://github.com/jdemeyer"
}
```

Changing branch from "" to "u/jdemeyer/ticket/2891"
...
```json
{
    "body": "Changing commit from \"\" to \"55e8f1e6b84a90661d6e9f6e06a252e892b5f501\"",
    "created_at": "2014-12-09T20:04:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21443",
    "user": "https://github.com/jdemeyer"
}
```

Changing commit from "" to "55e8f1e6b84a90661d6e9f6e06a252e892b5f501"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21444",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21445",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>Overall looks good to me, but I would have to take some time to look at the details in a few instances, especially the \n\n```\n# Note that f2py() doesn't raise an exception if it fails.\n```\nbit and checking that the deprecations work.  The reorganization, importing, and removal of much of server/support.py is just fine.",
    "created_at": "2014-12-09T20:13:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21446",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:18'></a>Overall looks good to me, but I would have to take some time to look at the details in a few instances, especially the 
...
```json
{
    "body": "Changing commit from \"55e8f1e6b84a90661d6e9f6e06a252e892b5f501\" to \"8d36b44de3b3402fe9d68164d692ceabafc61860\"",
    "created_at": "2014-12-09T21:23:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21447",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "55e8f1e6b84a90661d6e9f6e06a252e892b5f501" to "8d36b44de3b3402fe9d68164d692ceabafc61860"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21448",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21449",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "body": "Changing commit from \"8d36b44de3b3402fe9d68164d692ceabafc61860\" to \"15f151b9c695ec54662aef9974fe5d2fc40101f7\"",
    "created_at": "2014-12-12T10:44:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21450",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "8d36b44de3b3402fe9d68164d692ceabafc61860" to "15f151b9c695ec54662aef9974fe5d2fc40101f7"
...
```json
{
    "body": "<a id='comment:23'></a>But if I write the file in the other test\n\n```\nsage: fortran('./hello.f',globals())\n/Users/.../sage/local/lib/python2.7/site-packages/sage/misc/inline_fortran.py:23: DeprecationWarning: Calling fortran() with a filename is deprecated, use fortran(open(f).read) instead\nSee http://trac.sagemath.org/2891 for details.\n  return self.eval(*args, **kwds)\nsage: hello\n<fortran object>\nsage: hello()\n Hello World!\n```",
    "created_at": "2014-12-12T16:46:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21453",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:23'></a>But if I write the file in the other test
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21454",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21455",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21456",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:25'></a>Got it, I also see what I was messing up earlier.\n\nSo this is fine other than the import stuff in[comment:21](#comment%3A21), though one way to deal with that is to *not* remove those for now and deal with it when updating sagenb, e.g. #10057.",
    "created_at": "2014-12-12T19:26:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21457",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:25'></a>Got it, I also see what I was messing up earlier.
...
```json
{
    "body": "Changing commit from \"15f151b9c695ec54662aef9974fe5d2fc40101f7\" to \"af874432402ff79e9afc6240d6d5d06d362052e9\"",
    "created_at": "2014-12-13T07:37:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21458",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```

Changing commit from "15f151b9c695ec54662aef9974fe5d2fc40101f7" to "af874432402ff79e9afc6240d6d5d06d362052e9"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21459",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21460",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21461",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21462",
...
```json
{
    "body": "Changing branch from \"u/jdemeyer/ticket/2891\" to \"af874432402ff79e9afc6240d6d5d06d362052e9\"",
    "created_at": "2014-12-15T17:50:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2891#issuecomment-21463",
    "user": "https://github.com/vbraun"
}
```

Changing branch from "u/jdemeyer/ticket/2891" to "af874432402ff79e9afc6240d6d5d06d362052e9"
