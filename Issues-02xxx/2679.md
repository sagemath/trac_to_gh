...
<a id='comment:1'></a>The file to change is 
...
```json
{
    "body": "<a id='comment:2'></a>This can be closed now, right?",
...
<a id='comment:2'></a>This can be closed now, right?
...
```json
{
    "body": "<a id='comment:3'></a>Close in Sage 3.4.alpha0 due to the switch to ReST.\n\nThanks for catching this.\n\nCheers,\n\nMichael",
    "created_at": "2009-02-26T17:27:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2679",
    "type": "issue_comment",
...
<a id='comment:3'></a>Close in Sage 3.4.alpha0 due to the switch to ReST.
