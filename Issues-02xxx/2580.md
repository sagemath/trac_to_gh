...
```json
{
    "body": "<a id='comment:1'></a>Attachment [2580-graph_backends_added_files.patch](tarball://root/attachments/some-uuid/ticket2580/2580-graph_backends_added_files.patch) by @rlmill created at 2008-03-18 02:01:14\n\nMake sure to apply both patches before building. :)",
...
<a id='comment:1'></a>Attachment [2580-graph_backends_added_files.patch](tarball://root/attachments/some-uuid/ticket2580/2580-graph_backends_added_files.patch) by @rlmill created at 2008-03-18 02:01:14
...
```json
{
    "body": "<a id='comment:3'></a>Applies, passes tests, and looks good to me.  I'm not too concerned about the doctests in the new file.",
...
<a id='comment:3'></a>Applies, passes tests, and looks good to me.  I'm not too concerned about the doctests in the new file.
...
```json
{
    "body": "<a id='comment:4'></a>Merged in Sage 2.11.alpha0",
    "created_at": "2008-03-18T11:04:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2580",
    "type": "issue_comment",
...
<a id='comment:4'></a>Merged in Sage 2.11.alpha0
