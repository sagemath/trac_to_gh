# Issue 2600: [with patch, positive review] vector plot throws error when function contains a float
...
```json
{
    ...
    "title": "[with patch, positive review] vector plot throws error when function contains a float",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2600",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2600#event-6060"
}
```
