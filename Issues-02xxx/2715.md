...
```json
{
    ...
    "rename": {
        "from": "sage -coverage currently counts functions that are defined in doctests",
        "to": "[with patch, needs review] sage -coverage currently counts functions that are defined in doctests"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2715#event-9636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2715#issuecomment-19622",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2715#issuecomment-19623",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2715",
    "rename": {
        "from": "[with patch, needs review] sage -coverage currently counts functions that are defined in doctests",
        "to": "[with patch, positive review] sage -coverage currently counts functions that are defined in doctests"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2715#event-9637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2715#issuecomment-19624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2715#issuecomment-19625",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2715#event-9638"
}
```
