...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20888",
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [polybori-valgrind-cleaned](tarball://root/attachments/some-uuid/ticket2822/polybori-valgrind-cleaned) by @malb created at 2008-04-07 13:18:37\n\nAfter rebuilding PolyBoRi with debugging options (export SAGE_DEBUG=1) I don't get this invalid read anymore. I've attached a the valgrind log for a simple session.\n\nIt might be worth noting that almost all alleged memleaks are due to one call. It might make sense to ask Michael and Alexander about that one.",
    "created_at": "2008-04-07T13:18:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20889",
    "user": "https://github.com/malb"
}
```

<a id='comment:1'></a>Attachment [polybori-valgrind-cleaned](tarball://root/attachments/some-uuid/ticket2822/polybori-valgrind-cleaned) by @malb created at 2008-04-07 13:18:37
...
```json
{
    "body": "<a id='comment:2'></a>For the record: We don't know yet if it is \"our\" wrapper fault or an internal PolyBoRi fault.",
    "created_at": "2008-04-07T14:11:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20890",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>For the record: We don't know yet if it is "our" wrapper fault or an internal PolyBoRi fault.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20891",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>You can also disable the NDEBUG flag in PolyBoRi,\nscons CPPDEFINES=\"\"\nto get lots of assertions checked.",
    "created_at": "2008-04-07T14:16:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20892",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```

<a id='comment:3'></a>You can also disable the NDEBUG flag in PolyBoRi,
scons CPPDEFINES=""
to get lots of assertions checked.
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [CCuddCore.h](tarball://root/attachments/some-uuid/ticket2822/CCuddCore.h) by PolyBoRi created at 2008-04-11 05:43:13\n\nThanks to Alexander we provide a fixed CCuddCore.h.\nI hope, that will fix the invalid reads (at least it should fix the leaks).",
    "created_at": "2008-04-11T05:43:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20898",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```

<a id='comment:9'></a>Attachment [CCuddCore.h](tarball://root/attachments/some-uuid/ticket2822/CCuddCore.h) by PolyBoRi created at 2008-04-11 05:43:13
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20900",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20901",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>**Review**\n- builds fine under Debian/Linux\n- after rebuilding `pbori.pyx` no more SIGSEGVs\n- I say apply.",
    "created_at": "2008-04-11T21:52:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20902",
    "user": "https://github.com/malb"
}
```

<a id='comment:12'></a>**Review**
- builds fine under Debian/Linux
- after rebuilding `pbori.pyx` no more SIGSEGVs
- I say apply.
...
```json
{
    "body": "<a id='comment:13'></a>Merged in Sage 3.0.alpha4",
    "created_at": "2008-04-11T22:09:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20903",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:13'></a>Merged in Sage 3.0.alpha4
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20904",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20905",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Attachment [CCuddCore.2.h](tarball://root/attachments/some-uuid/ticket2822/CCuddCore.2.h) by PolyBoRi created at 2008-04-12 23:09:06\n\nHi everybody,\nI've added a new (somehow cleaner) version of CCuddCore.h. Maybe that fixes some of the remaining leaks.\n\nRegards\n  Alexander Dreyer",
    "created_at": "2008-04-12T23:09:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2822#issuecomment-20906",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```

<a id='comment:14'></a>Attachment [CCuddCore.2.h](tarball://root/attachments/some-uuid/ticket2822/CCuddCore.2.h) by PolyBoRi created at 2008-04-12 23:09:06
