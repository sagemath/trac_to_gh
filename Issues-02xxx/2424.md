# Issue 2424: [with patch, with positive review] small roots method for polynomials mod N (N composite)
...
```json
{
    ...
    "title": "[with patch, with positive review] small roots method for polynomials mod N (N composite)",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2424#event-5726"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2424",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2424#event-5727"
}
```
