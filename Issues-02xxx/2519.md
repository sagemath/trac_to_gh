...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26358"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26359"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12933",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12934",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26362"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26364"
}
```
...
```json
{
    ...
    "title_was": "Add support for posets, semi-lattices, etc. to Sage",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12935",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26366"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12936",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12937",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12938",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12939",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12940",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "title_was": "Add support for posets, semi-lattices, etc. to Sage",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26367"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12941",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26370"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26371"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2519#event-26374"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2519#issuecomment-12942",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
