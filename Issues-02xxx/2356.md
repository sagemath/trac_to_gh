...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21425"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21427"
}
```
...
```json
{
    "body": "Changed assignee from **@wdjoyner** to **@JohnCremona**",
    "created_at": "2008-03-02T17:35:26Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_comment",
...
Changed assignee from **@wdjoyner** to **@JohnCremona**
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21428"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21430"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-21431"
}
```
