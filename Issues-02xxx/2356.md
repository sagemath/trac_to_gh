...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [8682.patch](https://github.com/sagemath/sage/files/ticket2356/8682.patch) by @JohnCremona created at 2008-02-29 22:48:48\n\nAttached patch 8682 fixes both issues:  increases m by 1 and uses a dict() for fast lookup of the table.",
    "created_at": "2008-02-29T22:48:48Z",
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2356#issuecomment-12483",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2356#issuecomment-12484",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2356#issuecomment-12485",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2356#issuecomment-12486",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2356#issuecomment-12487",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2356#issuecomment-12488",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
