...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-16767",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-16768",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "rename": {
        "from": "Sage 2.10.3.rc1: graph_isom.py doctest failure in PermutationGroup",
        "to": "[with patch] Sage 2.10.3.rc1: graph_isom.py doctest failure in PermutationGroup"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2375#event-8297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-16769",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "rename": {
        "from": "[with patch] Sage 2.10.3.rc1: graph_isom.py doctest failure in PermutationGroup",
        "to": "[with patch, positive review] Sage 2.10.3.rc1: graph_isom.py doctest failure in PermutationGroup"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2375#event-8298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-16770",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-16771",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2375#event-8299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2375#issuecomment-16772",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
