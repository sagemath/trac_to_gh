...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2888#issuecomment-15808",
...
```json
{
    "body": "Attachment [2888.patch](https://github.com/sagemath/sage/files/ticket2888/2888.patch) by @dfdeshom created at 2008-04-13 03:08:37\n\npatch against alpha3",
    "created_at": "2008-04-13T03:08:37Z",
    "issue": "https://github.com/sagemath/sage/issues/2888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2888#issuecomment-15809",
    "user": "https://github.com/dfdeshom"
}
```

Attachment [2888.patch](https://github.com/sagemath/sage/files/ticket2888/2888.patch) by @dfdeshom created at 2008-04-13 03:08:37
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2888#issuecomment-15810",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2888#issuecomment-15811",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2888#issuecomment-15812",
...
```json
{
    "body": "Attachment [2888-incoming-alpha4.patch](https://github.com/sagemath/sage/files/ticket2888/2888-incoming-alpha4.patch) by @dfdeshom created at 2008-04-13 04:37:02\n\npatch against upcoming alpha release",
    "created_at": "2008-04-13T04:37:02Z",
    "issue": "https://github.com/sagemath/sage/issues/2888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2888#issuecomment-15813",
    "user": "https://github.com/dfdeshom"
}
```

Attachment [2888-incoming-alpha4.patch](https://github.com/sagemath/sage/files/ticket2888/2888-incoming-alpha4.patch) by @dfdeshom created at 2008-04-13 04:37:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2888#issuecomment-15814",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
