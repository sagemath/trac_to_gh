...
```json
{
    ...
    "rename": {
        ...
        "to": "[with simple patch, needs review] discriminant method sometimes returns values in the fraction field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2417#event-8456"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2417#event-8457"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2417#issuecomment-17044",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2417#issuecomment-17045",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2417",
    "rename": {
        "from": "[with simple patch, needs review] discriminant method sometimes returns values in the fraction field",
        "to": "[with simple patch, positive review] discriminant method sometimes returns values in the fraction field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2417#event-8458"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2417#issuecomment-17046",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2417#issuecomment-17047",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2417",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2417#event-8459"
}
```
