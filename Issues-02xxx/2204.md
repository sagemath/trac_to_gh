# Issue 2204: [with positive review] Integrate Karim Belabas's HNF bug fix for pari, add 64 bit OSX support
...
```json
{
    ...
    "title": "[with positive review] Integrate Karim Belabas's HNF bug fix for pari, add 64 bit OSX support",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2204/hnf.patch",
...
```json
{
    "body": "This patch needs to be applied to the pari.spkg",
    "created_at": "2008-02-18T18:12:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15963",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15964",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15965",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15966",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2204#event-6497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15967",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15968",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "rename": {
        "from": "Integrate Karim Belabas's HNF bug fix for pari, add 64 bit OSX support",
        "to": "[with positive review] Integrate Karim Belabas's HNF bug fix for pari, add 64 bit OSX support"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2204#event-6498"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket2204/trac-2204.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15969",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15970",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2204#issuecomment-15971",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2204",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/2204#event-6499"
}
```
