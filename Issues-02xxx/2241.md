...
```json
{
    "body": "<a id='comment:1'></a>I don't know how to read this.  Will a similar approach as in #2239 fix this memleak?  (In totallyreal_rel.py, numpy.roots is called on an array of floats instead of ints...)\n\nJV",
    "created_at": "2008-02-29T20:07:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2241#issuecomment-16032",
    "user": "https://github.com/jvoight"
}
```

<a id='comment:1'></a>I don't know how to read this.  Will a similar approach as in #2239 fix this memleak?  (In totallyreal_rel.py, numpy.roots is called on an array of floats instead of ints...)
...
```json
{
    "body": "<a id='comment:2'></a>This issue has been fixed some time prior to Sage 3.1.2.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-15T04:43:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2241#issuecomment-16033",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This issue has been fixed some time prior to Sage 3.1.2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2241#issuecomment-16034",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
