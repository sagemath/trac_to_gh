...
```json
{
    "body": "<a id='comment:1'></a>Attachment [nf-from-algebraic.patch](tarball://root/attachments/some-uuid/ticket2298/nf-from-algebraic.patch) by @jasongrout created at 2008-02-25 16:18:17",
    "created_at": "2008-02-25T16:18:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16433",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>Attachment [nf-from-algebraic.patch](tarball://root/attachments/some-uuid/ticket2298/nf-from-algebraic.patch) by @jasongrout created at 2008-02-25 16:18:17
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16435",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16436",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Evidently one of the Pari functions I call gives different results on 32-bit vs. 64-bit, so I've added \"# 32-bit\" and \"# 64-bit\" on the relevant doctest (and tested the result on 32-bit x86 and 64-bit x86).",
    "created_at": "2008-02-28T03:54:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16437",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:4'></a>Evidently one of the Pari functions I call gives different results on 32-bit vs. 64-bit, so I've added "# 32-bit" and "# 64-bit" on the relevant doctest (and tested the result on 32-bit x86 and 64-bit x86).
...
```json
{
    "body": "<a id='comment:6'></a>It would be nice if\n\n```\nnf_elements_from_algebraics([sqrt(2), sqrt(3 + sqrt(2))*I, sqrt(3 - sqrt(2))*I])\n```\njust worked, too -- coerced to QQbar for you.",
    "created_at": "2008-03-02T00:57:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16439",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:6'></a>It would be nice if
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16440",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>I've created a new patch in response to Nick's comments above: nf-from-algebraic-response.patch (to be applied after nf-from-algebraic-v2.patch).  Note that nf-from-algebraic-v2.patch has already been positively reviewed by Nick; only the -response.patch needs to be reviewed.\n\nI mostly did what Nick asked, with two exceptions: 1) I don't like aliases; since there are no backward-compatibility issues, I just renamed the function to the more-descriptive name, instead of having an alias. 2) I named the method version \"as_number_field_element\", instead of \"number_field_containing\".\n\nI did test that doctests pass in qqbar.py on both 32-bit and 64-bit x86 linux after this patch.",
    "created_at": "2008-03-02T19:23:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16441",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:7'></a>I've created a new patch in response to Nick's comments above: nf-from-algebraic-response.patch (to be applied after nf-from-algebraic-v2.patch).  Note that nf-from-algebraic-v2.patch has already been positively reviewed by Nick; only the -response.patch needs to be reviewed.
...
```json
{
    "body": "<a id='comment:8'></a>Response patch is fantastic.  This is so useful for my research, please apply!",
    "created_at": "2008-03-02T19:54:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16442",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:8'></a>Response patch is fantastic.  This is so useful for my research, please apply!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16443",
...
```json
{
    "body": "<a id='comment:10'></a>Merged nf-from-algebraic-v2.patch and nf-from-algebraic-response.patch  in Sage 2.10.3.rc1",
    "created_at": "2008-03-02T20:47:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/2298#issuecomment-16444",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Merged nf-from-algebraic-v2.patch and nf-from-algebraic-response.patch  in Sage 2.10.3.rc1
