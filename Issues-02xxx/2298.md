...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23566"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23568"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11335",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11336",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23571"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11337",
    "user": "https://github.com/sagetrac-cwitty"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23572"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23573"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11338",
    "user": "https://github.com/sagetrac-cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11339",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23574"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11340",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11341",
    "user": "https://github.com/sagetrac-cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11342",
    "user": "https://github.com/sagetrac-cwitty"
}
```
...
```json
{
    ...
    "title_was": "implement a way to compute a number field containing given algebraic numbers",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23576"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11343",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2298#issuecomment-11344",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-23579"
}
```
