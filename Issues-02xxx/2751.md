...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25665"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25667"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25669"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25671"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25672"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25673"
}
```
...
```json
{
    ...
    "title_was": "multivariate polynomials is_homogeneous",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25674"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25675"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25676"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2751#issuecomment-15040",
    "user": "https://github.com/sagetrac-jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2751#issuecomment-15041",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2751#issuecomment-15042",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2751",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2751#issuecomment-15043",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2751",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2751#event-25679"
}
```
