...
Original creation time: 2014-12-05 10:43:49
...
Comment by nbruin created at 2014-12-05 19:28:04
...
Comment by rws created at 2014-12-25 09:33:25
...
Comment by schymans created at 2015-01-06 22:26:07
...
Comment by nbruin created at 2015-01-08 22:53:09
...
Comment by nbruin created at 2015-01-08 23:01:32
...
Comment by schymans created at 2015-01-11 22:13:06
...
Comment by nbruin created at 2015-01-12 00:12:42
...
> sage: f = cr(a)
> }}}
At least one occurrence of that is in the doctest of `sage.symbolic.function_factory.function`, which (now) goes out of its way to import _that_ function, which does _not_ have the side-effect of mutating the global scope, as documented. So the assignment is actually necessary.
...
Comment by ncohen created at 2015-01-13 08:18:40
...
Comment by nbruin created at 2015-01-13 16:23:33
...
Comment by ncohen created at 2015-01-13 16:26:46
...
Comment by rws created at 2015-02-01 16:54:44
...
Comment by git created at 2015-02-02 08:28:20
...
Comment by rws created at 2015-02-02 08:33:30
...
Comment by kcrisman created at 2015-02-03 01:33:35
...
I'm _still_ not sure I even understand some of the subtle differences.  Are there occasions where the old behavior was "right" in the sense that one wanted that returned, and have we shown how to get that object?  What about the ask.sagemath question?
...
Comment by nbruin created at 2015-02-03 02:09:13
...
> I'm _still_ not sure I even understand some of the subtle differences.  Are there occasions where the old behavior was "right" in the sense that one wanted that returned, and have we shown how to get that object?
...
Comment by kcrisman created at 2015-02-03 02:24:53
...
Comment by zimmerma created at 2015-02-03 07:52:41
...
Comment by kcrisman created at 2015-03-09 23:17:13
...
Comment by nbruin created at 2015-03-10 01:13:15
...
I think that's another issue. The problem there is that global namespace `var` and `function` return a value _as well as_ insert something into the namespace. That's counter to python custom (routines that mutate state normally return `None`. Compare `L.sort()` and `sorted(L)`. There are exceptions: `L.pop()`).
...
Comment by schymans created at 2015-03-11 07:45:19
...
Comment by rws created at 2015-03-14 15:49:42
...
Comment by mmezzarobba created at 2015-03-15 10:08:29
...
Comment by rws created at 2015-04-12 15:15:31
...
Comment by rws created at 2015-06-11 07:36:35
...
Comment by git created at 2015-11-09 23:57:23
...
Comment by git created at 2015-11-10 01:17:15
...
Comment by nbruin created at 2015-11-10 01:18:57
...
Comment by nbruin created at 2015-11-10 18:35:02
