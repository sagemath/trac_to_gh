# Issue 3148: [with patch, positive review] improved orthogonal functions
...
```json
{
    ...
    "title": "[with patch, positive review] improved orthogonal functions",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/3148",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3148#event-7111"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/3148#event-7112"
}
```
