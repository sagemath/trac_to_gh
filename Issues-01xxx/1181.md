...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1181#issuecomment-5570",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1181#issuecomment-5571",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1181/hash-patch-2_8_12.hg",
    "created_at": "2007-11-16T12:45:00Z",
    "issue": "https://github.com/sagemath/sage/issues/1181",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1181/hash-patch-2_8_12.hg",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [hash-patch-2_8_12.hg](https://github.com/sagemath/sage/files/ticket1181/hash-patch-2_8_12.hg) by jbmohler created at 2007-11-16 12:45:00",
    "created_at": "2007-11-16T12:45:00Z",
    "issue": "https://github.com/sagemath/sage/issues/1181",
    "type": "issue_comment",
