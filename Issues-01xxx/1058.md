...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10135"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10137"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10138"
}
```
...
```json
{
    ...
    "subject": "https://github.com/bobmoretti",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10139"
}
```
...
```json
{
    ...
    "subject": "https://github.com/bobmoretti",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10140"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10141"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10142"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10143"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10144"
}
```
...
```json
{
    ...
    "subject": "https://github.com/JohnCremona",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1058#issuecomment-4607",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10149"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1058#issuecomment-4608",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1058#issuecomment-4609",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1058",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1058#event-10151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1058#issuecomment-4610",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
