...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -26,7 +26,6 @@\n system:sage\n \n ```\n-id=0|\n def stupid_function(n):\n      Z_F = NumberField(x^2-x-1, 't').maximal_order()\n      for i in range(n):\n@@ -34,14 +33,12 @@\n ```\n \n ```\n-id=1|\n time stupid_function(10^4)\n ///\n CPU time: 7.88 s,  Wall time: 9.31 s\n ```\n \n ```\n-id=10|\n def stupid_function(n):\n      Z_F = NumberField(x^2-x-1, 't').maximal_order()\n      a,b = Z_F.gens()\n@@ -50,14 +47,12 @@\n ```\n \n ```\n-id=11|\n time stupid_function(10^4)\n ///\n CPU time: 0.05 s,  Wall time: 0.05 s\n ```\n \n ```\n-id=2|\n def stupid_function(n):\n      K = NumberField(x^2-x-1, 't')\n      for i in range(n):\n@@ -65,14 +60,12 @@\n ```\n \n ```\n-id=3|\n time stupid_function(10^4)\n ///\n CPU time: 4.81 s,  Wall time: 4.88 s\n ```\n \n ```\n-id=4|\n def stupid_function(n):\n      K = NumberField(x^2-x-1, 't')\n      v = [5,1]\n@@ -81,14 +74,12 @@\n ```\n \n ```\n-id=5|\n time stupid_function(10^4)\n ///\n CPU time: 4.78 s,  Wall time: 4.81 s\n ```\n \n ```\n-id=6|\n def stupid_function(n):\n      K = NumberField(x^2-x-1, 't')\n      one = K(1); t = K.gen(); five = K(5)\n@@ -97,14 +88,12 @@\n ```\n \n ```\n-id=7|\n time stupid_function(10^4)\n ///\n CPU time: 0.04 s,  Wall time: 0.04 s\n ```\n \n ```\n-id=8|\n def stupid_function(n):\n      K = NumberField(x^2-x-1, 't')\n      t = K.gen()\n@@ -113,7 +102,6 @@\n ```\n \n ```\n-id=9|\n time stupid_function(10^4)\n ///\n CPU time: 0.38 s,  Wall time: 0.38 s\n@@ -126,8 +114,6 @@\n \n ```\n \n-Assignee: @williamstein\n-\n Comment: 1\n \n Summary: optimize creating elements of orders and number fields by coercing in lists\n``````\n",
    "created_at": "2007-11-09T08:21:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7435",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>I think it's worth applying this patch, even if it doesn't solve the whole problem.\n\nIn my tests, it applied cleanly, sage/rings/number_field/* doctests still passed, and the code looks reasonable.  I approve.",
    "created_at": "2007-12-01T03:06:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7437",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:4'></a>I think it's worth applying this patch, even if it doesn't solve the whole problem.
...
```json
{
    "body": "<a id='comment:5'></a>Applied 1134.hg (1.4 kB) - added by dmharvey on 11/14/2007 03:30:21 PM.\n\nWhat are we supposed to do about this now? Close this and open another ticket for the remaining issue?\n\nCheers,\n\nMichael",
    "created_at": "2007-12-01T11:42:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7438",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Applied 1134.hg (1.4 kB) - added by dmharvey on 11/14/2007 03:30:21 PM.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7439",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7440",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7441",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7442",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7443",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I posted a patch which adds a fast case for tuples / lists of coefficients in the power basis.  For the timings with Z_F, most of the time is spent checking the embedding.  I've added a check option to disable that check if you know that the element is already in the order.\n\nThe bundle which was attached had been previously merged in.",
    "created_at": "2013-07-22T13:42:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7444",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:9'></a>I posted a patch which adds a fast case for tuples / lists of coefficients in the power basis.  For the timings with Z_F, most of the time is spent checking the embedding.  I've added a check option to disable that check if you know that the element is already in the order.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7445",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7446",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Patch applies with some fuzz to sage-6.0 if you use `patch -l`",
    "created_at": "2014-02-13T08:22:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7447",
    "user": "https://github.com/rwst"
}
```

<a id='comment:12'></a>Patch applies with some fuzz to sage-6.0 if you use `patch -l`
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1134",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1134#issuecomment-7449",
    "user": "https://github.com/videlec"
}
```
