...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1375#event-6420"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1375#event-6421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1375#issuecomment-6813",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1375#event-6422"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\nAttachment [trac1375.patch](https://github.com/sagemath/sage/files/ticket1375/trac1375.patch) by cwitty created at 2007-12-02 20:41:23\n\nLooks good to me.",
    "created_at": "2007-12-02T20:41:23Z",
    "issue": "https://github.com/sagemath/sage/issues/1375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1375#issuecomment-6814",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1375#event-6423"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1375#event-6424"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1375",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1375#event-6425"
}
```
