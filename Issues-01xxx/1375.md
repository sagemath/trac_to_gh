# Issue 1375: [with positive review] tutorial texing typo issue
...
```json
{
    ...
    "title": "[with positive review] tutorial texing typo issue",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1375#issuecomment-9489",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1375#event-4134"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1375#issuecomment-9490",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1375",
    "rename": {
        "from": "tutorial texing typo issue",
        "to": "[with positive review] tutorial texing typo issue"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1375#event-4135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1375#issuecomment-9491",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1375",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1375#event-4136"
}
```
