# Issue 1395: [with patch, with positive review] notebook(directory="foo/") misbehaves
...
```json
{
    ...
    "title": "[with patch, with positive review] notebook(directory=\"foo/\") misbehaves",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1395#issuecomment-9359",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1395#issuecomment-9360",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] notebook(directory=\"foo/\") misbehaves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1395#event-4763"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1395#issuecomment-9361",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1395#issuecomment-9362",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1395",
    "rename": {
        "from": "[with patch] notebook(directory=\"foo/\") misbehaves",
        "to": "[with patch, with positive review] notebook(directory=\"foo/\") misbehaves"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1395#event-4764"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1395#issuecomment-9363",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1395",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1395#event-4765"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1395",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1395#issuecomment-9364",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
