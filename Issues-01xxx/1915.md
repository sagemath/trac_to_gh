...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1915#issuecomment-12623",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] infinity doesn't behave well"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1915#event-6501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "rename": {
        "from": "[with patch, needs review] infinity doesn't behave well",
        "to": "[with patch, needs some work] infinity doesn't behave well"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1915#event-6502"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1915#issuecomment-12624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "rename": {
        "from": "[with patch, needs some work] infinity doesn't behave well",
        "to": "[with new patch, needs review] infinity doesn't behave well"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1915#event-6503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1915#issuecomment-12625",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "rename": {
        "from": "[with new patch, needs review] infinity doesn't behave well",
        "to": "[with new patch, positive review] infinity doesn't behave well"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1915#event-6504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1915#issuecomment-12626",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1915#event-6505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1915#issuecomment-12627",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1915",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1915#issuecomment-12628",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1915#event-6506"
}
```
