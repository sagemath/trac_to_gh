...
```json
{
    "body": "<a id='comment:3'></a>I skimmed the patch, and nothing jumped out as being wrong.  Also, I applied the patch and doctested the changed file, and tests passed.  (I did not do testall.)\n\nIn short, looks good to me.",
...
<a id='comment:3'></a>I skimmed the patch, and nothing jumped out as being wrong.  Also, I applied the patch and doctested the changed file, and tests passed.  (I did not do testall.)
...
```json
{
    "body": "<a id='comment:4'></a>Merged in 2.8.15.alpha1.",
    "created_at": "2007-12-01T16:16:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1280",
    "type": "issue_comment",
...
<a id='comment:4'></a>Merged in 2.8.15.alpha1.
