# Issue 1423: [with positive review] bug/issue in python.eval from sage
...
```json
{
    ...
    "title": "[with positive review] bug/issue in python.eval from sage",
    "type": "issue",
...
```json
{
    ...
    "asset_name": "trac-1423.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1423/trac-1423.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9865",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4294"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9866",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] bug/issue in python.eval from sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4296"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac-1423-part2.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1423/trac-1423-part2.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9867",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9868",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9869",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
