...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9582",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4875"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] bug/issue in python.eval from sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4876"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "rename": {
        "from": "[with patch] bug/issue in python.eval from sage",
        "to": "[with patch, with negative review] bug/issue in python.eval from sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9583",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "rename": {
        "from": "[with patch, with negative review] bug/issue in python.eval from sage",
        "to": "[with patch, with positive review] bug/issue in python.eval from sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9584",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9585",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1423#event-4879"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1423",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1423#issuecomment-9586",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
