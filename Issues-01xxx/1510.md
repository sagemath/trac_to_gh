...
```json
{
    "body": "Changed assignee from **@williamstein** to **@sagetrac-tkosan**",
...
Changed assignee from **@williamstein** to **@sagetrac-tkosan**
...
```json
{
    "body": "Changed assignee from **@sagetrac-tkosan** to **@williamstein**",
...
Changed assignee from **@sagetrac-tkosan** to **@williamstein**
