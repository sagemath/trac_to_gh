...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1020#event-8638"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1020#event-8639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1020#event-8640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1020#event-8641"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1020#event-8642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1020#event-8643"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-mabshoff** to **@sagetrac-cwitty**",
    "created_at": "2007-10-28T16:54:21Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/1020",
    "type": "issue_comment",
...
Changed assignee from **@sagetrac-mabshoff** to **@sagetrac-cwitty**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1020#event-8644"
}
```
