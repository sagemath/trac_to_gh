...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1249#issuecomment-8178",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1249",
    "rename": {
        "from": "[with patch] fixes bug in graph plotting with partitions",
        "to": "[with patch, with positive review] fixes bug in graph plotting with partitions"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1249#event-4261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1249#issuecomment-8179",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1249#issuecomment-8180",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1249",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1249#issuecomment-8181",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1249",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1249#event-4262"
}
```
