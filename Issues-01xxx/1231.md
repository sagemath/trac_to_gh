...
```json
{
    "body": "<a id='comment:2'></a>But, 5 seconds later I get:\n\n```\nsage: ModularSymbols(1,12,0,GF(5)).simple_factors()\n\n\n------------------------------------------------------------\nUnhandled SIGSEGV: A segmentation fault occured in SAGE.\nThis probably occured because a *compiled* component\nof SAGE has a bug in it (typically accessing invalid memory)\nor is not properly wrapped with _sig_on, _sig_off.\nYou might want to run SAGE under gdb with 'sage -gdb' to debug this.\nSAGE will now terminate (sorry).\n------------------------------------------------------------\n```\n\nCheers,\n\nMichael",
    "created_at": "2007-11-21T04:57:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8290",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>But, 5 seconds later I get:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8293",
...
```json
{
    "body": "<a id='comment:5'></a>Fixed this. It was a coercion problem: we tried to subtract an int from a matrix over GF(5), which caused the crash. Added a doctest to catch at least this in the future.",
    "created_at": "2007-12-02T10:46:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8294",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:5'></a>Fixed this. It was a coercion problem: we tried to subtract an int from a matrix over GF(5), which caused the crash. Added a doctest to catch at least this in the future.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8295",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8296",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8298",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Added a patch file that includes just this fix, as opposed to the bundle I posted, which also includes most of my fix for 1129.",
    "created_at": "2007-12-02T19:13:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8299",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:7'></a>Added a patch file that includes just this fix, as opposed to the bundle I posted, which also includes most of my fix for 1129.
...
```json
{
    "body": "<a id='comment:8'></a>Also, the bug that was being exposed by this is now being reported as #1374.",
    "created_at": "2007-12-02T19:24:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8300",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:8'></a>Also, the bug that was being exposed by this is now being reported as #1374.
...
```json
{
    "body": "<a id='comment:9'></a>Looks good.  Thanks for creating #1374, Craig!  (Apply only 1231.patch)",
    "created_at": "2007-12-02T19:31:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8301",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:9'></a>Looks good.  Thanks for creating #1374, Craig!  (Apply only 1231.patch)
...
```json
{
    "body": "<a id='comment:10'></a>Merged 1231.patch only in 2.8.15.rc0.",
    "created_at": "2007-12-02T20:14:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8302",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Merged 1231.patch only in 2.8.15.rc0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8303",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
