# Issue 1231: [with positive review] seg fault when computing with modular symbols over a finite field
...
```json
{
    ...
    "title": "[with positive review] seg fault when computing with modular symbols over a finite field",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1231#event-3700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8236",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8237",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAnd valgrind also complains about:\n\n```\n==14816== Use of uninitialised value of size 8\n==14816==    at 0x445206: PyObject_Free (obmalloc.c:920)\n==14816==    by 0x4C49FB: freechildren (node.c:132)\n==14816==    by 0x4C4988: freechildren (node.c:130)\n==14816==    by 0x4C4BB1: PyNode_Free (node.c:130)\n==14816==    by 0x4A70CB: PyRun_StringFlags (pythonrun.c:1364)\n==14816==    by 0x47BBA1: builtin_eval (bltinmodule.c:599)\n==14816==    by 0x415522: PyObject_Call (abstract.c:1860)\n==14816==    by 0x47C850: PyEval_CallObjectWithKeywords (ceval.c:3433)\n==14816==    by 0xF7482F6: `__pyx_pf_`4sage_5rings_10polynomial_25polynomial_modn_dense_ntl_22Polynomial_dense_mod_n_int_list(\n_object*, _object*) (polynomial_modn_dense_ntl.cpp:1832)\n==14816==    by 0x415522: PyObject_Call (abstract.c:1860)\n==14816==    by 0x47C850: PyEval_CallObjectWithKeywords (ceval.c:3433)\n==14816==    by 0xF749630: `__pyx_pf_`4sage_5rings_10polynomial_25polynomial_modn_dense_ntl_22Polynomial_dense_mod_n_list(_obj\nect*, _object*) (polynomial_modn_dense_ntl.cpp:3319)\n==14816==\n==14816== Invalid read of size 8\n==14816==    at 0xD2ACA4C: `__pyx_f_`4sage_5rings_11integer_mod_15NativeIntStruct_lookup (integer_mod.c:1568)\n==14816==    by 0xD2E5C20: `__pyx_f_`4sage_5rings_11integer_mod_14IntegerMod_int__new_c (integer_mod.c:7950)\n==14816==    by 0xD2B0368: `__pyx_f_`4sage_5rings_11integer_mod_14IntegerMod_int__sub_c_impl (integer_mod.c:8553)\n==14816==    by 0x9787833: `__pyx_pf_`4sage_9structure_7element_13ModuleElement___sub__ (element.c:11343)\n==14816==    by 0x4157EC: binary_op1 (abstract.c:398)\n==14816==    by 0x41701D: PyNumber_Subtract (abstract.c:450)\n==14816==    by 0x119E0150: `__pyx_f_`4sage_6matrix_7matrix0_6Matrix__sub_c_impl (matrix0.c:8445)\n==14816==    by 0x9787833: `__pyx_pf_`4sage_9structure_7element_13ModuleElement___sub__ (element.c:11343)\n==14816==    by 0x4157EC: binary_op1 (abstract.c:398)\n==14816==    by 0x41701D: PyNumber_Subtract (abstract.c:450)\n==14816==    by 0x6D3517D: op_sub (operator.c:72)\n==14816==    by 0x415522: PyObject_Call (abstract.c:1860)\n```\nAnd right before it crashes:\n\n```\n==14816== Invalid read of size 8\n==14816==    at 0xD2ACA50: `__pyx_f_`4sage_5rings_11integer_mod_15NativeIntStruct_lookup (integer_mod.c:1569)\n==14816==    by 0xD2E5C20: `__pyx_f_`4sage_5rings_11integer_mod_14IntegerMod_int__new_c (integer_mod.c:7950)\n==14816==    by 0xD2B0368: `__pyx_f_`4sage_5rings_11integer_mod_14IntegerMod_int__sub_c_impl (integer_mod.c:8553)\n==14816==    by 0x9787833: `__pyx_pf_`4sage_9structure_7element_13ModuleElement___sub__ (element.c:11343)\n==14816==    by 0x4157EC: binary_op1 (abstract.c:398)\n==14816==    by 0x41701D: PyNumber_Subtract (abstract.c:450)\n==14816==    by 0x119E0150: `__pyx_f_`4sage_6matrix_7matrix0_6Matrix__sub_c_impl (matrix0.c:8445)\n==14816==    by 0x9787833: `__pyx_pf_`4sage_9structure_7element_13ModuleElement___sub__ (element.c:11343)\n==14816==    by 0x4157EC: binary_op1 (abstract.c:398)\n==14816==    by 0x41701D: PyNumber_Subtract (abstract.c:450)\n==14816==    by 0x6D3517D: op_sub (operator.c:72)\n==14816==    by 0x415522: PyObject_Call (abstract.c:1860)\n```\n\nCheers,\n\nMichael",
    "created_at": "2007-11-21T05:20:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8239",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "asset_name": "trac_1231.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1231/trac_1231.hg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8240",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8241",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8242",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8243",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8244",
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "1231.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1231/1231.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8245",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8246",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8247",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8248",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "rename": {
        "from": "seg fault when computing with modular symbols over a finite field",
        "to": "[with positive review] seg fault when computing with modular symbols over a finite field"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1231#event-3701"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8249",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1231#event-3702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1231#issuecomment-8250",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
