...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13562"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13563"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13564"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13565"
}
```
...
```json
{
    "body": "Changed assignee from **@williamstein** to **jason grout**",
...
Changed assignee from **@williamstein** to **jason grout**
...
```json
{
    "body": "Changed assignee from **jason grout** to **@jasongrout**",
...
Changed assignee from **jason grout** to **@jasongrout**
...
```json
{
    ...
    "milestone_title": "sage-2.9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13566"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13569"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1575",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1575#event-13570"
}
```
