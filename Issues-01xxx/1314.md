...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1314",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1314#issuecomment-8880",
...
```json
{
    "body": "<a id='comment:78'></a>\nReplying to [tscrim](#comment%3A71):\n> Okay, `@cached_function` doesn't work because we can't pass a key function to it...\n\n\nI don't understand what you mean with this. Note that in the @_cached decorator you are not passing an arbitrary key function either: You have `_cache_`key hardcoded.",
