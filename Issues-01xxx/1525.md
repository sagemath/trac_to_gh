...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1525#issuecomment-7531",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1525#issuecomment-7532",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1525#issuecomment-7533",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "Attachment [bipartite.patch](https://github.com/sagemath/sage/files/ticket1525/bipartite.patch) by @rlmill created at 2008-01-14 00:27:36\n\nNote that now these numbers are backed up by Sloane!",
    "created_at": "2008-01-14T00:27:36Z",
    "issue": "https://github.com/sagemath/sage/issues/1525",
    "type": "issue_comment",
...
Attachment [bipartite.patch](https://github.com/sagemath/sage/files/ticket1525/bipartite.patch) by @rlmill created at 2008-01-14 00:27:36
