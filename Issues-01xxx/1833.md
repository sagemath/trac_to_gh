...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1833#issuecomment-12475",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This patch also moves plot3d_adaptive into plot3d (i.e., as an option), and deprecates globally exposing plot3d_adaptive.   This is natural to do in the context of this patch.",
    "created_at": "2008-01-18T16:23:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1833#issuecomment-12476",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>This patch also moves plot3d_adaptive into plot3d (i.e., as an option), and deprecates globally exposing plot3d_adaptive.   This is natural to do in the context of this patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1833#issuecomment-12477",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1833#issuecomment-12478",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1833#issuecomment-12479",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1833#issuecomment-12480",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
