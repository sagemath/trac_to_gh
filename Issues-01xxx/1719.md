...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1719#issuecomment-11346",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1719#issuecomment-11347",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs easy review] problems building documentation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1719#event-5781"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1719#event-5782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1719#issuecomment-11348",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1719",
    "rename": {
        "from": "[with patch, needs easy review] problems building documentation",
        "to": "[with patch, needs review (easy)] problems building documentation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1719#event-5783"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, positice review] problems building documentation"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1719#event-5784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1719#issuecomment-11349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1719",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1719#event-5785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1719#issuecomment-11350",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1719",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1719#issuecomment-11351",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
