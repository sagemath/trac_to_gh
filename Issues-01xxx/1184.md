...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1184#issuecomment-5587",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1184#issuecomment-5588",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\nAttachment [Sage-2.8.15.alpha1-twiddle-with-link-order.patch](https://github.com/sagemath/sage/files/ticket1184/Sage-2.8.15.alpha1-twiddle-with-link-order.patch) by mabshoff created at 2007-12-02 02:55:56\n\nThe updated spkg is at \n\nhttp://sage.math.washington.edu/home/mabshoff/ntl-5.4.1.p7.spkg\n\nYou need to apply both the patch and add the ntl.spkg.\n\nCheers,\n\nMichael",
    "created_at": "2007-12-02T02:55:56Z",
    "issue": "https://github.com/sagemath/sage/issues/1184",
    "type": "issue_comment",
