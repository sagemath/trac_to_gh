...
```json
{
    "body": "<a id='comment:1'></a>This was caused by an absolute symlink in the polybori package polybori-0.1.p4.spkg, included in alpha4. Update to polybori-0.1-r5.spkg makes the symlinks relative and fixes the problem.\n\nNew package is included in 2.9.alpha7.",
    "created_at": "2007-12-15T10:53:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1447",
    "type": "issue_comment",
...
<a id='comment:1'></a>This was caused by an absolute symlink in the polybori package polybori-0.1.p4.spkg, included in alpha4. Update to polybori-0.1-r5.spkg makes the symlinks relative and fixes the problem.
