...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1327#issuecomment-8880",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1327",
    "rename": {
        "from": "2.8.14/Solaris: scipy import error - fortran compiler related",
        "to": "[with spkg] 2.8.14/Solaris: scipy import error - fortran compiler related"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1327#event-4525"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1327#issuecomment-8881",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1327#issuecomment-8882",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1327",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1327#event-4526"
}
```
