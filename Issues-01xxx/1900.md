...
```json
{
    "body": "Attachment [graph_am-updated.patch](https://github.com/sagemath/sage/files/ticket1900/graph_am-updated.patch) by @jasongrout created at 2008-01-24 05:44:07",
    "created_at": "2008-01-24T05:44:07Z",
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1900#issuecomment-9259",
    "user": "https://github.com/jasongrout"
}
```

Attachment [graph_am-updated.patch](https://github.com/sagemath/sage/files/ticket1900/graph_am-updated.patch) by @jasongrout created at 2008-01-24 05:44:07
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1900#issuecomment-9260",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1900#issuecomment-9261",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nAttachment [graph_am-over_integers.patch](https://github.com/sagemath/sage/files/ticket1900/graph_am-over_integers.patch) by @jasongrout created at 2008-01-24 06:22:49",
    "created_at": "2008-01-24T06:22:49Z",
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1900#issuecomment-9262",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1900#issuecomment-9263",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1900#issuecomment-9264",
    "user": "https://github.com/jasongrout"
}
```
