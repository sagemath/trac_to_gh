...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1558#issuecomment-10369",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1558",
    "rename": {
        "from": "[with patch] more NTL wrapping, coefficient access and factoring",
        "to": "[with patch, needs review] more NTL wrapping, coefficient access and factoring"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1558#event-5284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1558#issuecomment-10370",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1558",
    "rename": {
        "from": "[with patch, needs review] more NTL wrapping, coefficient access and factoring",
        "to": "[with patch, with positive review] more NTL wrapping, coefficient access and factoring"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1558#event-5285"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1558",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1558#event-5286"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1558#issuecomment-10371",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1558#issuecomment-10372",
    "user": "https://github.com/rlmill"
}
```
