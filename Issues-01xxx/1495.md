...
```json
{
    "body": "<a id='comment:1'></a>We need to detect if power management is enabled and set some non-performance mode. Otherwise print a warning and ask for confirmation to continue.\n\nCheers,\n\nMichael",
    "created_at": "2007-12-18T23:04:56Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1495#issuecomment-10377",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>We need to detect if power management is enabled and set some non-performance mode. Otherwise print a warning and ask for confirmation to continue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1495#issuecomment-10378",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1495",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1495#issuecomment-10380",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
