...
```json
{
    "body": "Attachment [1605-sage_vectors_to_magma.patch](https://github.com/sagemath/sage/files/ticket1605/1605-sage_vectors_to_magma.patch) by @burcin created at 2008-05-12 15:12:00\n\nadd support for converting vectors to magma",
    "created_at": "2008-05-12T15:12:00Z",
    "issue": "https://github.com/sagemath/sage/issues/1605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1605#issuecomment-7854",
    "user": "https://github.com/burcin"
}
```

Attachment [1605-sage_vectors_to_magma.patch](https://github.com/sagemath/sage/files/ticket1605/1605-sage_vectors_to_magma.patch) by @burcin created at 2008-05-12 15:12:00
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1605#issuecomment-7855",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1605#issuecomment-7856",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1605#issuecomment-7857",
