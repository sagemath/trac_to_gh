...
```json
{
    "body": "<a id='comment:1'></a>Attachment [1356.patch](tarball://root/attachments/some-uuid/ticket1356/1356.patch) by @rlmill created at 2007-12-02 19:34:21\n\nNow:\n\n```\nsage: v = QQbar.zeta(3) + 1\nsage: v.exactify()\nsage: v.abs().minpoly()\nx - 1\n```",
...
<a id='comment:1'></a>Attachment [1356.patch](tarball://root/attachments/some-uuid/ticket1356/1356.patch) by @rlmill created at 2007-12-02 19:34:21
