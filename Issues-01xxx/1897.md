...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1897#issuecomment-12499",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1897#issuecomment-12500",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] %latex -- bug in passing in predefined sage variables (serious but probably very easy to fix)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1897#event-6433"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1897#issuecomment-12501",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "rename": {
        "from": "[with patch, needs review] %latex -- bug in passing in predefined sage variables (serious but probably very easy to fix)",
        "to": "[with patch, needs work] %latex -- bug in passing in predefined sage variables (serious but probably very easy to fix)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1897#event-6434"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1897#issuecomment-12502",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "rename": {
        "from": "[with patch, needs work] %latex -- bug in passing in predefined sage variables (serious but probably very easy to fix)",
        "to": "[with patch, positive work] %latex -- bug in passing in predefined sage variables (serious but probably very easy to fix)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1897#event-6435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1897#issuecomment-12503",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "rename": {
        "from": "[with patch, positive work] %latex -- bug in passing in predefined sage variables (serious but probably very easy to fix)",
        "to": "[with patch, positive review] %latex -- bug in passing in predefined sage variables (serious but probably very easy to fix)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1897#event-6436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1897#event-6437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1897#issuecomment-12504",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1897#issuecomment-12505",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1897#event-6438"
}
```
