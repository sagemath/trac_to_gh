...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1125#issuecomment-7098",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1125",
    "rename": {
        "from": "cvxopt fix completely breaks building Sage with gfortran",
        "to": "[with spkg] cvxopt fix completely breaks building Sage with gfortran"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1125#event-3784"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1125#event-3785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1125",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1125#issuecomment-7099",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1125",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1125#event-3786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1125",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1125#issuecomment-7100",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1125",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1125#issuecomment-7101",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
