...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12015"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12018"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1240#issuecomment-5612",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1240",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1240#issuecomment-5613",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12021"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12022"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12025"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1240#issuecomment-5614",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12026"
}
```
...
```json
{
    ...
    "subject": "https://github.com/zimmermann6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12027"
}
```
...
```json
{
    ...
    "subject": "https://github.com/zimmermann6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12028"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1240",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12029"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1240#issuecomment-5615",
...
```json
{
    ...
    "milestone_title": "sage-4.3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12030"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1240#event-12033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1240#issuecomment-5616",
    "user": "https://github.com/zimmermann6"
}
```
