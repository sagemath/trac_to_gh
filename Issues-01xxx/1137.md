# Issue 1137: [with patch, positive referee] algorithmic mistakes in translating a matrix to shades of grey...
...
```json
{
    ...
    "title": "[with patch, positive referee] algorithmic mistakes in translating a matrix to shades of grey...",
    "type": "issue",
