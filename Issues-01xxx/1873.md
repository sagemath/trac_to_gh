...
```json
{
    ...
    "rename": {
        "from": "[with patch] elementary function expansion returns result in the wrong ring",
        "to": "[with patch, needs review] elementary function expansion returns result in the wrong ring"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1873#event-6342"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1873#issuecomment-12353",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1873#issuecomment-12354",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1873",
    "rename": {
        "from": "[with patch, needs review] elementary function expansion returns result in the wrong ring",
        "to": "[with patch, with positive review] elementary function expansion returns result in the wrong ring"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1873#event-6343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1873#issuecomment-12355",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1873#issuecomment-12356",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1873",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1873#issuecomment-12357",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1873",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1873#event-6344"
}
```
