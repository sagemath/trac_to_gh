...
```json
{
    "body": "<a id='comment:1'></a>I get -1 with both X.LLL() and X.LLL(algorithm='NTL:LLL') on a Pentium M with sage-2.8.12.\nMaybe a processor-specific problem?",
    "created_at": "2007-11-16T22:50:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7551",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:1'></a>I get -1 with both X.LLL() and X.LLL(algorithm='NTL:LLL') on a Pentium M with sage-2.8.12.
Maybe a processor-specific problem?
...
```json
{
    "body": "<a id='comment:2'></a>My processor is a Core2Duo which I use in 64-bit mode (Debian/testing AMD64). I can also reproduce this bug on sage.math (64-bit Opteron). So I assume this is an issue with 64-bit architectures.",
    "created_at": "2007-11-17T13:23:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7552",
    "user": "https://github.com/malb"
}
```

<a id='comment:2'></a>My processor is a Core2Duo which I use in 64-bit mode (Debian/testing AMD64). I can also reproduce this bug on sage.math (64-bit Opteron). So I assume this is an issue with 64-bit architectures.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7553",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7554",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7555",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I upgraded this bug to a blocker as it is a bug which leads to wrong results without raising an error.",
    "created_at": "2007-11-17T14:26:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7556",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>I upgraded this bug to a blocker as it is a bug which leads to wrong results without raising an error.
...
```json
{
    "body": "<a id='comment:6'></a>Correction to the above comment: fpLLL gets things wrong, not NTL.\n\nCurrently Sage doesn't check the return value of the LLL() calls in fplll.pyx (zero = ok, non-zero = error). When adding that, it turns out that for this example fpLLL itself detects something is wrong.",
    "created_at": "2007-11-19T00:42:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7559",
    "user": "https://github.com/wjp"
}
```

<a id='comment:6'></a>Correction to the above comment: fpLLL gets things wrong, not NTL.
...
```json
{
    "body": "<a id='comment:7'></a>In at least two places, fpLLL was assuming longs and ints were the same size. The patch I'm attaching should fix those. I already e-mailed Damien Stehle about this, too.",
    "created_at": "2007-11-19T02:35:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7560",
    "user": "https://github.com/wjp"
}
```

<a id='comment:7'></a>In at least two places, fpLLL was assuming longs and ints were the same size. The patch I'm attaching should fix those. I already e-mailed Damien Stehle about this, too.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7561",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [fplll_64bit.patch](tarball://root/attachments/some-uuid/ticket1188/fplll_64bit.patch) by mabshoff created at 2007-11-19 08:57:57\n\nA new spkg is available at:\n\nhttp://sage.math.washington.edu/home/malb/pkgs/libfplll-2.1.4-20071119.spkg\n\nmalb will add a doctest to verify this issue has really been fixed. Once that is merged we can hopefully close this ticket.\n\nCheers,\n\nMichael",
    "created_at": "2007-11-19T08:57:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7562",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Attachment [fplll_64bit.patch](tarball://root/attachments/some-uuid/ticket1188/fplll_64bit.patch) by mabshoff created at 2007-11-19 08:57:57
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7563",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [fplll.patch](tarball://root/attachments/some-uuid/ticket1188/fplll.patch) by @wjp created at 2007-11-19 11:41:47\n\nmalb: The error codes from LLL() are positive when an error occurs. Attaching an updated (non-hg) patch that replaces the ret < 0 checks by ret != 0.",
    "created_at": "2007-11-19T11:41:47Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7564",
    "user": "https://github.com/wjp"
}
```

<a id='comment:9'></a>Attachment [fplll.patch](tarball://root/attachments/some-uuid/ticket1188/fplll.patch) by @wjp created at 2007-11-19 11:41:47
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7565",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>#1188 looks good -- make sure to only apply fplll2.patch instead of fplll.patch.\n\nAnd wow or wow wjp did a great job on that one in multiple ways!",
    "created_at": "2007-11-20T15:38:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7567",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:11'></a>#1188 looks good -- make sure to only apply fplll2.patch instead of fplll.patch.
...
```json
{
    "body": "<a id='comment:12'></a>Merged in 2.8.13.rc1. - see #1217 for followup.\n\nI would like to close this ticket. I did apply the doctest.patch and updated to the latest upstream libfplll.spkg that malb provided.",
    "created_at": "2007-11-20T15:55:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7568",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Merged in 2.8.13.rc1. - see #1217 for followup.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1188#issuecomment-7569",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
