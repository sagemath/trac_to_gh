...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1063#issuecomment-7009",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>applied to 2.8.11.rc1",
    "created_at": "2007-11-02T02:26:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1063",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1063#issuecomment-7010",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>applied to 2.8.11.rc1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1063",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1063#event-2873"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1063",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1063#issuecomment-7011",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
