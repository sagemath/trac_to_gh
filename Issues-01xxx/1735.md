...
```json
{
    "body": "**Attachment:** [Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch](https://github.com/sagemath/sage/files/ticket1735/Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch)",
    "created_at": "2008-01-13T01:37:15Z",
    "issue": "https://github.com/sagemath/sage/issues/1735",
    "type": "issue_comment",
...
**Attachment:** [Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch](https://github.com/sagemath/sage/files/ticket1735/Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch)
