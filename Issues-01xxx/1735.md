...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1735/Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch",
    "created_at": "2008-01-13T01:37:15Z",
    "issue": "https://github.com/sagemath/sage/issues/1735",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1735/Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Attachment [Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch](https://github.com/sagemath/sage/files/ticket1735/Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch) by mabshoff created at 2008-01-13 01:37:15",
    "created_at": "2008-01-13T01:37:15Z",
    "issue": "https://github.com/sagemath/sage/issues/1735",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1735#issuecomment-8445",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

Attachment [Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch](https://github.com/sagemath/sage/files/ticket1735/Sage-2.10.alpha2-do-not-mark-a-spkg-as-installed-if-sage-check-fails.patch) by mabshoff created at 2008-01-13 01:37:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1735",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1735#issuecomment-8446",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1735",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1735#issuecomment-8447",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1735",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1735#issuecomment-8448",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
