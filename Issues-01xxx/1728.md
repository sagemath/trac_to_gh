...
archive/attachments_001379.json:
```json
{
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [Sage-2.10.alpha2-fix-numerical-noise-doctest-failure-from-numpy-1.0.4.patch](https://github.com/sagemath/sage/files/ticket1728/Sage-2.10.alpha2-fix-numerical-noise-doctest-failure-from-numpy-1.0.4.patch)\n\nI don't like the part about\n\n```\n             sage: x = CC['x'].0\n             sage: i = CC.0\n             sage: f = (x - 1)*(x - i)\n             sage: f.roots(multiplicities=False)\n-            [1.00000000000000 - ...*I,... 1.00000000000000*I]\n+            [...1.00000000000000*I, 1.00000000000000...*I]\n```\nbut I don't see any viable alternative.\n\nCheers,\n\nMichael",
    "created_at": "2008-01-09T01:49:51Z",
    "issue": "https://github.com/sagemath/sage/issues/1728",
    "type": "issue_comment",
...
archive/attachments_001380.json:
```json
{
    "asset_content_type": "application/octet-stream",
