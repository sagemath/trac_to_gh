...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12509",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12510",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>The above patch integrates this loop-order change into the modn case, reducing the time by about a third.",
    "created_at": "2008-01-25T10:47:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12511",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>The above patch integrates this loop-order change into the modn case, reducing the time by about a third.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12512",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,5 @@\n Today in the sage seminar Cl\u00e9ment Pernet demonstrated that in the naive matrix multiply algorithm (used as a basecase for all others)\n+we have a major inefficiency.\n \n Specifically, for computing C = A*B,\n \n@@ -18,9 +19,8 @@\n             C[i,j] += A[i,k] * B[k,j]\n ```\n \n-gives the same result, but much better cache performance.\n+gives the same result, but much better cache performance. \n \n-Assignee: @williamstein\n \n Summary: Optimize matrix multiply cache friendliness\n \n``````\n",
    "created_at": "2008-01-25T10:49:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12513",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1924#event-4630"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12515",
...
```json
{
    "body": "<a id='comment:6'></a>Hey, I can give this a positive review, since I just thoroughly tried it out, and I'm not the author! :-)",
    "created_at": "2008-01-25T13:33:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12518",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>Hey, I can give this a positive review, since I just thoroughly tried it out, and I'm not the author! :-)
...
```json
{
    "body": "<a id='comment:7'></a>Well, William's reexported patch applies cleanly. But since it is about 2kb smaller than the original patch somebody has to give me at least that the original patch was fishy ;)\n\nCheers,\n\nMichael",
    "created_at": "2008-01-25T17:22:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12519",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Well, William's reexported patch applies cleanly. But since it is about 2kb smaller than the original patch somebody has to give me at least that the original patch was fishy ;)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1924#event-4631"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12520",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12521",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>The original patch had two diffs in it...I guess I'll try and avoid doing that from now on. Looks like William was able to respond faster than I was though.",
    "created_at": "2008-01-25T19:03:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1924#issuecomment-12522",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:9'></a>The original patch had two diffs in it...I guess I'll try and avoid doing that from now on. Looks like William was able to respond faster than I was though.
