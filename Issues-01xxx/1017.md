...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1017/solution_dict.patch",
    "created_at": "2007-10-28T04:08:43Z",
    "issue": "https://github.com/sagemath/sage/issues/1017",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1017/solution_dict.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\nAttachment [solution_dict.patch](https://github.com/sagemath/sage/files/ticket1017/solution_dict.patch) by @jasongrout created at 2007-10-28 04:08:43\n\npatch is no longer a partial patch.\n\nI just noticed one modification.\n\n```\nsol_list_dict=blah\nreturn sol_list_dict\n```\ncould be shortened to\n\n```\nreturn blah\n```",
    "created_at": "2007-10-28T04:08:43Z",
    "issue": "https://github.com/sagemath/sage/issues/1017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1017#issuecomment-4748",
    "user": "https://github.com/jasongrout"
}
```
