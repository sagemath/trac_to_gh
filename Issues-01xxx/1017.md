...
```json
{
    "body": "<a id='comment:1'></a>Attachment [solution_dict.patch](tarball://root/attachments/some-uuid/ticket1017/solution_dict.patch) by @jasongrout created at 2007-10-28 04:08:43\n\npatch is no longer a partial patch.\n\nI just noticed one modification.\n\n```\nsol_list_dict=blah\nreturn sol_list_dict\n```\ncould be shortened to\n\n```\nreturn blah\n```",
    "created_at": "2007-10-28T04:08:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1017#issuecomment-6425",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:1'></a>Attachment [solution_dict.patch](tarball://root/attachments/some-uuid/ticket1017/solution_dict.patch) by @jasongrout created at 2007-10-28 04:08:43
...
```json
{
    "body": "<a id='comment:2'></a>I meant, in the last part of the patch:\n\n```\nsol_dict=blah\nreturn sol_dict\n```\ncould be shortened to\n\n```\nreturn blah\n```",
    "created_at": "2007-10-28T04:10:01Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1017#issuecomment-6426",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:2'></a>I meant, in the last part of the patch:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1017#issuecomment-6427",
