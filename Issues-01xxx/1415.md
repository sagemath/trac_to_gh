...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1415#event-11112"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1415#event-11113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1415#event-11114"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1415#issuecomment-7052",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1415#issuecomment-7053",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1415",
    "rename": {
        "from": "FLINT 1.0 (from 2.9.alpha1) fails to compile with gcc 4.3 prerelease",
        "to": "FLINT 1.0.6  fails to compile with gcc 4.3 prerelease [gmp.h releated]"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1415#event-11115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1415",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1415#event-11116"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1415#event-11117"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1415#event-11118"
}
```
