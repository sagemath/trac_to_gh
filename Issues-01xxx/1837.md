...
```json
{
    ...
    "asset_name": "groebner-kwds.patch",
    "asset_url": "tarball://root/attachments/ticket1837/groebner-kwds.patch",
    "created_at": "2008-01-18T19:54:15Z",
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1837/groebner-kwds.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "Attachment [groebner-kwds.patch](https://github.com/sagemath/sage/files/ticket1837/groebner-kwds.patch) by @malb created at 2008-01-18 19:54:15",
    "created_at": "2008-01-18T19:54:15Z",
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1837#issuecomment-8942",
    "user": "https://github.com/malb"
}
```

Attachment [groebner-kwds.patch](https://github.com/sagemath/sage/files/ticket1837/groebner-kwds.patch) by @malb created at 2008-01-18 19:54:15
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1837#issuecomment-8943",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1837#issuecomment-8944",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1837#event-8538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1837#issuecomment-8945",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1837#issuecomment-8946",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1837#event-8539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1837#event-8540"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1837#issuecomment-8947",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1837",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1837#issuecomment-8948",
    "user": "https://github.com/malb"
}
```
