...
```json
{
    "body": "<a id='comment:2'></a>Sorry I did not know about the assumptions() command. Maybe assume? should point to it.\nIs a SEE ALSO section possible in the documentation? Also consider (from Wester's test suite):\n\n```\nsage: assume(x>=y, y>=z,z>=x)\nsage: assumptions()\n[x >= y, y >= z, z >= x]\nsage: print bool(x==z)\nFalse\n```\n\nYes assume should complain if we say that x>0 and x<0 (at least if it can lead to wrong results).",
    "created_at": "2007-11-13T22:51:26Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7701",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:2'></a>Sorry I did not know about the assumptions() command. Maybe assume? should point to it.
Is a SEE ALSO section possible in the documentation? Also consider (from Wester's test suite):
...
```json
{
    "body": "<a id='comment:3'></a>More strange results:\n\n```\nsage: assume(x > 0)\nsage: bool (x <> 1)\nTrue\n```\nand:\n\n```\nsage: assume(x <= 1, x >= 1)\nsage: bool(x==1)\nFalse\n```",
    "created_at": "2007-11-13T22:53:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7702",
    "user": "https://github.com/zimmermann6"
}
```

<a id='comment:3'></a>More strange results:
...
```json
{
    "body": "<a id='comment:5'></a>Apparently Maxima complains (behind the scenes?):\n\n```\nMaxima 5.12.0 http://maxima.sourceforge.net\nUsing Lisp GNU Common Lisp (GCL) GCL 2.6.7 (aka GCL)\nDistributed under the GNU Public License. See the file COPYING.\nDedicated to the memory of William Schelter.\nThis is a development version of Maxima. The function bug_report()\nprovides bug reporting information.\n(%i1) assume(x<0);\n(%o1)                               [x < 0]\n(%i2) assume(x>0);\n(%o2)                           [inconsistent]\n```",
    "created_at": "2007-11-14T00:33:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7704",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:5'></a>Apparently Maxima complains (behind the scenes?):
...
```json
{
    "body": "<a id='comment:7'></a>One more note: \n\nQEPCAD also simplifies the expression [x>=y /\\ y>=z /\\ z>= x] to [y-x=0 /\\ z-y = 0].",
    "created_at": "2007-11-14T01:21:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7706",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:7'></a>One more note: 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7707",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7708",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>At the very least this ticket should upgrade the documentation for assume? and assumptions?  to point out that one should always forget() before assuming something new about a variable.\n\nA related ticket is #3277, which would implement a block to automatically call assume and forget if desired.  Also, #772 is now an experimental spkg.",
    "created_at": "2009-01-29T16:42:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7709",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:9'></a>At the very least this ticket should upgrade the documentation for assume? and assumptions?  to point out that one should always forget() before assuming something new about a variable.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7713",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:13'></a>Oh, and just for the record, continuing in the same session, where we assumed x>0:\n\n```\nsage: bool(x>1)\nFalse # right!\nsage: bool(x>-1)\nTrue # right!\n```\nSo the problem really does seem to be the Ginac handling of !=, not something else.",
    "created_at": "2009-10-01T15:36:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7714",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:13'></a>Oh, and just for the record, continuing in the same session, where we assumed x>0:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7715",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7717",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>Okay, with respect to [this discussion](http://groups.google.com/group/sage-devel/browse_thread/thread/ae7d15985d4735cb) on this update adds correct parsing of Maxima output with #, thus:\n\n```\nsage: a = maxima(\"x#0\")\nsage: a.sage()\nx != 0\n```\nApply only 'final' patch.",
    "created_at": "2009-11-10T02:42:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7718",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:15'></a>Okay, with respect to [this discussion](http://groups.google.com/group/sage-devel/browse_thread/thread/ae7d15985d4735cb) on this update adds correct parsing of Maxima output with #, thus:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7719",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7721",
    "user": "https://github.com/robert-marik"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7724",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7725",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7726",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1163",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1163#issuecomment-7727",
