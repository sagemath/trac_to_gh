...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1448#issuecomment-9746",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] iterate over MatrixSpace"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1448#event-4942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1448#issuecomment-9747",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1448#issuecomment-9748",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1448#issuecomment-9749",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "rename": {
        "from": "[with patch] iterate over MatrixSpace",
        "to": "[with patch, needs review] iterate over MatrixSpace"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1448#event-4943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1448#issuecomment-9750",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "rename": {
        "from": "[with patch, needs review] iterate over MatrixSpace",
        "to": "[with patch, with positive review] iterate over MatrixSpace"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1448#event-4944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1448#event-4945"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1448#issuecomment-9751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1448",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1448#issuecomment-9752",
    "user": "https://github.com/rlmill"
}
```
