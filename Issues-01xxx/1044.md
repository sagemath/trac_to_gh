...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1044#issuecomment-4825",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1044/1044.patch",
    "created_at": "2007-11-01T02:40:58Z",
    "issue": "https://github.com/sagemath/sage/issues/1044",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1044/1044.patch",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1044#event-4811"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1044#event-4812"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1044",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1044#event-4813"
}
```
