...
```json
{
    "body": "<a id='comment:2'></a>This looks like a revisit of the \"2*Singular('2')\" coercion issue we had:\n\n```\nsage: B\n[1/2*a + 1/2, a]\nsage: B[0]\n1/2*a + 1/2\nsage: B[1]\na\nsage: 1*B[0]\n\n\n------------------------------------------------------------\nUnhandled SIGFPE: An unhandled floating point exception occured in SAGE.\nThis probably occured because a *compiled* component\nof SAGE has a bug in it (typically accessing invalid memory)\nor is not properly wrapped with _sig_on, _sig_off.\nYou might want to run SAGE under gdb with 'sage -gdb' to debug this.\nSAGE will now terminate (sorry).\n------------------------------------------------------------\n```\n\nCheers,\n\nMichael",
    "created_at": "2007-11-01T01:35:06Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6545",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This looks like a revisit of the "2*Singular('2')" coercion issue we had:
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [1044.patch](tarball://root/attachments/some-uuid/ticket1044/1044.patch) by cwitty created at 2007-11-01 02:40:58\n\nI've added an attachment that fixes the crash.  (I think the underlying problem might actually be in the coercion code, though.)",
    "created_at": "2007-11-01T02:40:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6546",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:3'></a>Attachment [1044.patch](tarball://root/attachments/some-uuid/ticket1044/1044.patch) by cwitty created at 2007-11-01 02:40:58
...
```json
{
    "body": "<a id='comment:5'></a>applied to 2.8.11.alpha0 - the patch by Carl is a work around, for more discussion see\n\nhttp://groups.google.com/group/sage-devel/t/2174d803e19c141e\nhttp://groups.google.com/group/sage-devel/t/d49e60aaf7e91645\n\nCheers,\n\nMichael",
    "created_at": "2007-11-01T10:07:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6547",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>applied to 2.8.11.alpha0 - the patch by Carl is a work around, for more discussion see
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6548",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The coercion model is working as expected. The error is because the base of order elements is Z (which is correctly enforced) but the _rmul_ is inherited from number_field_element which expects a rational. \n\n```\nsage: sage: K.<a> = NumberField(x^2 - 5)\nsage: sage: B = K.maximal_order().basis();\nsage: B[1].parent().base_ring() # this is bad\nRational Field\nsage: B[1].parent().base()\nInteger Ring\n```\n\nSee also Ticket #1057\n\n- Robert",
    "created_at": "2007-11-01T21:14:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6549",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:6'></a>The coercion model is working as expected. The error is because the base of order elements is Z (which is correctly enforced) but the _rmul_ is inherited from number_field_element which expects a rational. 
