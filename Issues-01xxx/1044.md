# Issue 1044: [with patch] segfault apply morphism to field element
...
```json
{
    ...
    "title": "[with patch] segfault apply morphism to field element",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6336",
...
```json
{
    "body": "applied to 2.8.11.alpha0 - the patch by Carl is a work around, for more discussion see\n\nhttp://groups.google.com/group/sage-devel/t/2174d803e19c141e\nhttp://groups.google.com/group/sage-devel/t/d49e60aaf7e91645\n\nCheers,\n\nMichael",
    "created_at": "2007-11-01T10:07:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6337",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6338",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "The coercion model is working as expected. The error is because the base of order elements is Z (which is correctly enforced) but the _rmul_ is inherited from number_field_element which expects a rational. \n\n```\nsage: sage: K.<a> = NumberField(x^2 - 5)\nsage: sage: B = K.maximal_order().basis();\nsage: B[1].parent().base_ring() # this is bad\nRational Field\nsage: B[1].parent().base()\nInteger Ring\n```\n\nSee also Ticket #1057\n\n- Robert",
    "created_at": "2007-11-01T21:14:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1044#issuecomment-6339",
