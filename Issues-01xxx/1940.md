# Issue 1940: [with patch, with positive review] Segmentation fault when comparing two empty ideals
...
```json
{
    ...
    "title": "[with patch, with positive review] Segmentation fault when comparing two empty ideals",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1940#issuecomment-12817",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Segmentation fault when comparing two empty ideals"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1940#event-6592"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1940",
    "rename": {
        "from": "[with patch, needs review] Segmentation fault when comparing two empty ideals",
        "to": "[with patch, with positive review] Segmentation fault when comparing two empty ideals"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1940#event-6593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1940#issuecomment-12818",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1940#issuecomment-12819",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1940",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1940#issuecomment-12820",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1940",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1940#event-6594"
}
```
