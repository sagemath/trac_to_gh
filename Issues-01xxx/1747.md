...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1747#issuecomment-11483",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1747",
    "rename": {
        "from": "[with patch, needs review] speed improvement for mq.SR.polynomial_system",
        "to": "[with patch, with positive review] speed improvement for mq.SR.polynomial_system"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1747#event-5864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1747#issuecomment-11484",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1747#issuecomment-11485",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1747",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1747#event-5865"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1747#issuecomment-11486",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
