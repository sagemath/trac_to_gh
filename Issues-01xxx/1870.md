...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1870#event-14715"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1870#event-14716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1870#event-14717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1870#event-14718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1870#issuecomment-9117",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1870#event-14719"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1870#event-14720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1870#issuecomment-9118",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1870",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1870#issuecomment-9119",
...
```json
{
    "body": "**Changing work issues** from \"Close with #3693\" to \"\".",
...
**Changing work issues** from "Close with #3693" to "".
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1870",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1870#event-14721"
}
```
