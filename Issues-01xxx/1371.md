# Issue 1371: [with bundle, with positive review] hg_sage.pull/push() to non-default server with multiple branches
...
```json
{
    ...
    "title": "[with bundle, with positive review] hg_sage.pull/push() to non-default server with multiple branches",
    "type": "issue",
