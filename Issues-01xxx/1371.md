# Issue 1371: [with positive review] hg_sage.pull/push() to non-default server with multiple branches
...
```json
{
    ...
    "title": "[with positive review] hg_sage.pull/push() to non-default server with multiple branches",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1371/push_bundle--Dec_2_2007.hg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9463",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4123"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9464",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4124"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9465",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9466",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9467",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] hg_sage.pull/push() to non-default server with multiple branches"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9468",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9469",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
