...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9512",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>This should be applied, assuming that it does not change the default behaviour.  (It should not.)  It does look like there is an incorrectly indented line, but compiling should catch that.\n\nI do worry about the copyright change, though -- I thought we agreed to give all the copyright's to William Stein, to ease future license changes.  We should check if Jon Hanke is okay with that?",
    "created_at": "2008-01-22T18:56:03Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9513",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:4'></a>This should be applied, assuming that it does not change the default behaviour.  (It should not.)  It does look like there is an incorrectly indented line, but compiling should catch that.
...
```json
{
    "body": "<a id='comment:6'></a>After discussion with William at SD7, this should be applied.",
    "created_at": "2008-02-09T03:42:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9515",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:6'></a>After discussion with William at SD7, this should be applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9516",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9517",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
