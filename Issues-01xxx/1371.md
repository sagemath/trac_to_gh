...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9195",
    "user": "https://github.com/jonhanke"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with bundle] hg_sage.pull/push() to non-default server with multiple branches"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4672"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4673"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "rename": {
        "from": "[with bundle] hg_sage.pull/push() to non-default server with multiple branches",
        "to": "[with bundle, needs review] hg_sage.pull/push() to non-default server with multiple branches"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4674"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "rename": {
        "from": "[with bundle, needs review] hg_sage.pull/push() to non-default server with multiple branches",
        "to": "[with bundle, with mostly positive review] hg_sage.pull/push() to non-default server with multiple branches"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9196",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9197",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9198",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "rename": {
        "from": "[with bundle, with mostly positive review] hg_sage.pull/push() to non-default server with multiple branches",
        "to": "[with bundle, with positive review] hg_sage.pull/push() to non-default server with multiple branches"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9199",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1371#event-4677"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1371#issuecomment-9200",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
