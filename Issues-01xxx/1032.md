...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1032#event-8020"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1032#event-8021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1032#event-8022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1032",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1032#event-8023"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1032",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1032#event-8024"
}
```
