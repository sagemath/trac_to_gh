...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1869#issuecomment-12320",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1869#issuecomment-12321",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1869#issuecomment-12322",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Implement show(list(graphs(n))) et al"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1869#event-6328"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1869#issuecomment-12323",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1869",
    "rename": {
        "from": "[with patch, needs review] Implement show(list(graphs(n))) et al",
        "to": "[with patch, with positive review] Implement show(list(graphs(n))) et al"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1869#event-6329"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1869#issuecomment-12324",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1869",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1869#event-6330"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1869#issuecomment-12325",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
