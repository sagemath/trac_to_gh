...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1935#issuecomment-12784",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1935#issuecomment-12785",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1935",
    "rename": {
        "from": "[with patch, needs review] legendre_symbol currently quite slow",
        "to": "[with patch, with positive review] legendre_symbol currently quite slow"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1935#event-6570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1935#issuecomment-12786",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1935#issuecomment-12787",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1935",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1935#event-6571"
}
```
