...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1745#issuecomment-8473",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1745#event-8010"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1745#event-8011"
}
```
...
```json
{
    ...
    "asset_name": "rationalpoints01.hg",
    "asset_url": "tarball://root/attachments/ticket1745/rationalpoints01.hg",
    "created_at": "2008-01-13T01:08:26Z",
    "issue": "https://github.com/sagemath/sage/issues/1745",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1745/rationalpoints01.hg",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [rationalpoints01.hg](https://github.com/sagemath/sage/files/ticket1745/rationalpoints01.hg) by @williamstein created at 2008-01-13 01:08:26",
    "created_at": "2008-01-13T01:08:26Z",
    "issue": "https://github.com/sagemath/sage/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1745#issuecomment-8474",
    "user": "https://github.com/williamstein"
}
```

Attachment [rationalpoints01.hg](https://github.com/sagemath/sage/files/ticket1745/rationalpoints01.hg) by @williamstein created at 2008-01-13 01:08:26
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1745#event-8012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1745#issuecomment-8475",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1745#event-8013"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1745",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1745#event-8014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1745#issuecomment-8476",
