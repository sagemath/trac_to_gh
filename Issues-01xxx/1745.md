...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-11309",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-11310",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Positive review by David Kohel\n\n```\nHi William,\n\nThe small points enumeration code indeed fixes the enumeration bug.\n\n```",
    "created_at": "2008-01-16T18:36:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-11311",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>Positive review by David Kohel
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-11312",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1745#issuecomment-11313",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
