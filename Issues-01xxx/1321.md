...
```json
{
    "body": "The patches:\n\n* [attachment:trac_1321-sage_graphed_v3.patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sage_graphed_v3.patch) to the **sage** repo.\n* [attachment:trac_1321-sagenb_graphed.patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sagenb_graphed.patch) to the **sagenb** repo.\n\n**Assignee:** @rlmill\n\n**CC:**  boothby @rlmill @rbeezer\n\n**Author:** Radoslav Kirov, Mitesh Patel\n\n**Reviewer:** Robert Miller, Rob Beezer\n\n**Merged:** sage-4.3.1.alpha0\n\nIssue created by migration from https://trac.sagemath.org/ticket/1321\n\n",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6155"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1321#issuecomment-6470",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1321#issuecomment-6471",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1321#issuecomment-6472",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6156"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6157"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6158"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6159"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6160"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6161"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6162"
}
```
...
```json
{
    ...
    "asset_name": "trac_1321-sagenb_graphed.patch",
    "asset_url": "tarball://root/attachments/ticket1321/trac_1321-sagenb_graphed.patch",
    "created_at": "2009-11-24T03:45:01Z",
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1321/trac_1321-sagenb_graphed.patch",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    "body": "Attachment [trac_1321-sagenb_graphed.patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sagenb_graphed.patch) by @qed777 created at 2009-11-24 03:45:01\n\nRado's graph editor.  Apply this patch to the **sagenb** repo.  Apply this patch only.",
    "created_at": "2009-11-24T03:45:01Z",
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "issue_comment",
...
Attachment [trac_1321-sagenb_graphed.patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sagenb_graphed.patch) by @qed777 created at 2009-11-24 03:45:01
...
```json
{
    "body": "<a id='comment:22'></a>\nUpdate: The [sagenb patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sagenb_graphed.patch) works for me when I apply it to SageNB 0.4.4, in the absence of #3895 and #7495.  The patch may also work with SageNB 0.4.3, which is part of Sage 4.3.alpha0.  But it may be best to [get the latest](http://nb.sagemath.org/).",
...
```json
{
    "body": "<a id='comment:23'></a>\n[Version 2 of the sage library patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sage_graphed_v2.patch), which replaces first version, fixes the docstrings.",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6163"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6164"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_1321-sage_graphed_v3.patch",
    "asset_url": "tarball://root/attachments/ticket1321/trac_1321-sage_graphed_v3.patch",
    "created_at": "2009-11-24T07:28:14Z",
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1321/trac_1321-sage_graphed_v3.patch",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6165"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6166"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6167"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1321#event-6168"
}
```
