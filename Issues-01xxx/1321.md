...
```json
{
    "body": "**Attachment:** [trac_1321-sagenb_graphed.patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sagenb_graphed.patch)\n\nRado's graph editor.  Apply this patch to the **sagenb** repo.  Apply this patch only.",
    "created_at": "2009-11-24T03:45:01Z",
    "issue": "https://github.com/sagemath/sage/issues/1321",
    "type": "issue_comment",
...
**Attachment:** [trac_1321-sagenb_graphed.patch](https://github.com/sagemath/sage/files/ticket1321/trac_1321-sagenb_graphed.patch)
...
archive/attachments_001022.json:
```json
{
    "asset_content_type": "application/octet-stream",
