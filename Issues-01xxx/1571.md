...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1571#event-7295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1571#event-7296"
}
```
...
archive/attachments_001227.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "Sage-2.10.alpha3-integrate-Minh-Nguyen-suggestions-for-tut.tex.patch",
    "asset_url": "tarball://root/attachments/ticket1571/Sage-2.10.alpha3-integrate-Minh-Nguyen-suggestions-for-tut.tex.patch",
    "created_at": "2008-01-13T18:43:40Z",
    "issue": "https://github.com/sagemath/sage/issues/1571",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1571/Sage-2.10.alpha3-integrate-Minh-Nguyen-suggestions-for-tut.tex.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "Attachment [Sage-2.10.alpha3-integrate-Minh-Nguyen-suggestions-for-tut.tex.patch](https://github.com/sagemath/sage/files/ticket1571/Sage-2.10.alpha3-integrate-Minh-Nguyen-suggestions-for-tut.tex.patch) by mabshoff created at 2008-01-13 18:43:40",
    "created_at": "2008-01-13T18:43:40Z",
    "issue": "https://github.com/sagemath/sage/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1571#issuecomment-7711",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

Attachment [Sage-2.10.alpha3-integrate-Minh-Nguyen-suggestions-for-tut.tex.patch](https://github.com/sagemath/sage/files/ticket1571/Sage-2.10.alpha3-integrate-Minh-Nguyen-suggestions-for-tut.tex.patch) by mabshoff created at 2008-01-13 18:43:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1571",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1571#event-7297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1571#issuecomment-7712",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1571#issuecomment-7713",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1571#event-7298"
}
```
