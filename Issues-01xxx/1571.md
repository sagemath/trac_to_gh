...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1571#event-5332"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] corrections for tut.tex"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1571#event-5333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10437",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10438",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1571#event-5334"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10439",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10440",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "rename": {
        "from": "[with patch] corrections for tut.tex",
        "to": "[with patch, positive review] corrections for tut.tex"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1571#event-5335"
}
```
