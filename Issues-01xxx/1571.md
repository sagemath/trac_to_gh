...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10790",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10791",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10792",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>All the suggested changes in this patch look good to me.",
    "created_at": "2008-01-14T05:55:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1571",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1571#issuecomment-10793",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:4'></a>All the suggested changes in this patch look good to me.
