# Issue 1779: [with positive review] setup.py computes the cache of some irrelevent files
...
```json
{
    ...
    "title": "[with positive review] setup.py computes the cache of some irrelevent files",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1779#issuecomment-12175",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1779#issuecomment-12176",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1779#event-5220"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] setup.py computes the cache of some irrelevent files"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1779#event-5221"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1779#issuecomment-12177",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1779#issuecomment-12178",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1779",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1779#event-5222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1779#issuecomment-12179",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
