...
archive/attachments_000931.json:
```json
{
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac-1235.patch](https://github.com/sagemath/sage/files/ticket1235/trac-1235.patch)",
    "created_at": "2007-12-08T08:43:05Z",
    "issue": "https://github.com/sagemath/sage/issues/1235",
    "type": "issue_comment",
...
archive/attachments_000932.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "<a id='comment:5'></a>\n**Attachment:** [trac-1235-part2.patch](https://github.com/sagemath/sage/files/ticket1235/trac-1235-part2.patch)\n\nSeems good to me. Tested the patch (both parts).\nIt appears to work robustly in the cases I tried.",
    "created_at": "2007-12-08T09:39:38Z",
    "issue": "https://github.com/sagemath/sage/issues/1235",
    "type": "issue_comment",
...
archive/attachments_000933.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac-1235-doctest_fix.patch](https://github.com/sagemath/sage/files/ticket1235/trac-1235-doctest_fix.patch)\n\nThis fixes a doctest failure on Redhat Linux 32-bit.",
    "created_at": "2007-12-10T15:34:12Z",
    "issue": "https://github.com/sagemath/sage/issues/1235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1235#issuecomment-5912",
    "user": "https://github.com/williamstein"
}
```

**Attachment:** [trac-1235-doctest_fix.patch](https://github.com/sagemath/sage/files/ticket1235/trac-1235-doctest_fix.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1235",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1235#issuecomment-5913",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
