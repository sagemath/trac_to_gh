...
```json
{
    ...
    "rename": {
        ...
        "to": "[with trivial patch, needs review] is_pseudoprime docstring doesn't wrap"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1985#event-6795"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-13414",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-13415",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "rename": {
        "from": "[with trivial patch, needs review] is_pseudoprime docstring doesn't wrap",
        "to": "[with trivial patch, positive review] is_pseudoprime docstring doesn't wrap"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1985#event-6796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1985#event-6797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-13416",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-13417",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
