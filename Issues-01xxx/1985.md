# Issue 1985: [with trivial patch] is_pseudoprime docstring doesn't wrap
...
```json
{
    ...
    "title": "[with trivial patch] is_pseudoprime docstring doesn't wrap",
    "type": "issue",
...
```json
{
    ...
    "rename": {
        "from": "is_pseudoprime docstring doesn't wrap",
        "to": "[with trivial patch] is_pseudoprime docstring doesn't wrap"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1985#event-5839"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-14013",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-14014",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-14015",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-14016",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1985#event-5840"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-14017",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1985#issuecomment-14018",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
