...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1460#issuecomment-9826",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1460#event-4986"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] bug in float( ... ) conversion in calculus"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1460#event-4987"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1460#issuecomment-9827",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1460#issuecomment-9828",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1460",
    "rename": {
        "from": "[with patch] bug in float( ... ) conversion in calculus",
        "to": "[with patch, with positive review] bug in float( ... ) conversion in calculus"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1460#event-4988"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1460",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1460#event-4989"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1460#issuecomment-9829",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1460",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1460#issuecomment-9830",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
