...
archive/attachments_001571.json:
```json
{
...
```json
{
    "body": "**Attachment:** [show_list.patch](https://github.com/sagemath/sage/files/ticket1908/show_list.patch)\n\nUpdated patch to fix typo in doctests",
    "created_at": "2008-01-24T04:46:30Z",
    "issue": "https://github.com/sagemath/sage/issues/1908",
    "type": "issue_comment",
...
**Attachment:** [show_list.patch](https://github.com/sagemath/sage/files/ticket1908/show_list.patch)
...
archive/attachments_001572.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [show_list-updated.patch](https://github.com/sagemath/sage/files/ticket1908/show_list-updated.patch)\n\nApply in place of show_list.patch",
    "created_at": "2008-01-24T22:14:09Z",
    "issue": "https://github.com/sagemath/sage/issues/1908",
    "type": "issue_comment",
...
**Attachment:** [show_list-updated.patch](https://github.com/sagemath/sage/files/ticket1908/show_list-updated.patch)
...
```json
{
    "body": "**Attachment:** [show_list-updated-ref.patch](https://github.com/sagemath/sage/files/ticket1908/show_list-updated-ref.patch)",
    "created_at": "2008-01-25T10:15:59Z",
    "issue": "https://github.com/sagemath/sage/issues/1908",
    "type": "issue_comment",
...
**Attachment:** [show_list-updated-ref.patch](https://github.com/sagemath/sage/files/ticket1908/show_list-updated-ref.patch)
