...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16581"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16582"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16584"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16585"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16586"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16587"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1926",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16588"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16589"
}
```
...
```json
{
    "body": "<a id='comment:7'>Comment 7:</a>\nAttachment: **[1926-make_doctests_optional.patch.gz](https://github.com/sagemath/sage/files/ticket1926/1926-make_doctests_optional.patch.gz)**\n\n[attachment: 1926-make_doctests_optional.patch.gz](https://github.com/sagemath/sage/files/ticket1926/1926-make_doctests_optional.patch.gz) needs to be applied to make the new doctests in the maple interface optional.",
    "created_at": "2008-01-29T09:16:41Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/1926",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1926",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16590"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1926#event-16591"
}
```
