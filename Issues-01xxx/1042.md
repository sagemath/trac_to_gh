...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1042#event-3535"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1042#event-3536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1042#issuecomment-6647",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1042#issuecomment-6648",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1042",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1042#issuecomment-6649",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1042",
    "rename": {
        "from": "reset() doesn't restore anything in all_cmdline or all_notebook",
        "to": "[with patch] reset() doesn't restore anything in all_cmdline or all_notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1042#event-3537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1042",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1042#event-3538"
}
```
