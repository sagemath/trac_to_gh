...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1893#issuecomment-12478",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6406"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with bundle, needs review] Added graphical plotting to discrete random variables."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1893#issuecomment-12479",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "rename": {
        "from": "[with bundle, needs review] Added graphical plotting to discrete random variables.",
        "to": "[with bundle, with positive review] Added graphical plotting to discrete random variables."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1893#issuecomment-12480",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "rename": {
        "from": "[with bundle, with positive review] Added graphical plotting to discrete random variables.",
        "to": "[with bundle, needs additional review] Added graphical plotting to discrete random variables."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6409"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1893#issuecomment-12481",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1893#issuecomment-12482",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1893#issuecomment-12483",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6410"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6411"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6412"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6413"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6414"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6415"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6416"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1893#event-6417"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1893",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1893#issuecomment-12484",
