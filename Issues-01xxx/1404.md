...
```json
{
    "body": "<a id='comment:1'></a>Hmm, since now both branches of the if case are identical except the additional newline couldn't we make collapse the if statement?\n\nCheers,\n\nMichael",
    "created_at": "2007-12-05T19:20:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1404#issuecomment-9794",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Hmm, since now both branches of the if case are identical except the additional newline couldn't we make collapse the if statement?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1404#issuecomment-9795",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1404",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1404#event-3627"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1404#issuecomment-9796",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1404#issuecomment-9797",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
