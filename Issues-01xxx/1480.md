...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9945",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9946",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "rename": {
        "from": "[with patch] implement P.show() for mathematica elements -- nice mathematica graphics in the sage notebook!",
        "to": "[with patch, positive referee] implement P.show() for mathematica elements -- nice mathematica graphics in the sage notebook!"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1480#event-5052"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1480#event-5053"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9947",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9948",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
