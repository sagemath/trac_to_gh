# Issue 1480: [with patch, positive referee] implement P.show() for mathematica elements -- nice mathematica graphics in the sage notebook!
...
```json
{
    ...
    "title": "[with patch, positive referee] implement P.show() for mathematica elements -- nice mathematica graphics in the sage notebook!",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9491",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9492",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1480#event-3762"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1480",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1480#issuecomment-9494",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
