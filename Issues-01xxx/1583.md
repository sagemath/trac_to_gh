...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10516",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "rename": {
        "from": "simple modules of modular symbols over finite fields",
        "to": "[with patch, needs review] simple modules of modular symbols over finite fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1583#event-5368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10517",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10518",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "rename": {
        "from": "[with patch, needs review] simple modules of modular symbols over finite fields",
        "to": "[with patch, positive review] simple modules of modular symbols over finite fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1583#event-5369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10519",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10520",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1583#event-5370"
}
```
