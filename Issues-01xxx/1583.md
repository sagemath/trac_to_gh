...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10869",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10870",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [craigcitro-1583.patch](tarball://root/attachments/some-uuid/ticket1583/craigcitro-1583.patch) by @craigcitro created at 2008-01-21 06:10:22\n\nAdded a patch to fix this. I actually add the _is_simple flag when the cuspidal subspace is created -- when that's one-dimensional, we know it must be simple, so it seems easier to tag it then, rather than do something involving checking stability under the Hecke operators ...",
    "created_at": "2008-01-21T06:10:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10871",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:1'></a>Attachment [craigcitro-1583.patch](tarball://root/attachments/some-uuid/ticket1583/craigcitro-1583.patch) by @craigcitro created at 2008-01-21 06:10:22
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10872",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1583#issuecomment-10873",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
