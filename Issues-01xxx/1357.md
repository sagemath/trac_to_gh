# Issue 1357: [with positive review] the polynomial .roots() method should work with ring=QQbar
...
```json
{
    ...
    "title": "[with positive review] the polynomial .roots() method should work with ring=QQbar",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9318",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9319",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] the polynomial .roots() method should work with ring=QQbar"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1357#event-4066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1357#event-4067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9320",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9321",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
