# Issue 1357: [with patch, with positive review] the polynomial .roots() method should work with ring=QQbar
...
```json
{
    ...
    "title": "[with patch, with positive review] the polynomial .roots() method should work with ring=QQbar",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9058",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "rename": {
        "from": "the polynomial .roots() method should work with ring=QQbar",
        "to": "[with patch] the polynomial .roots() method should work with ring=QQbar"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1357#event-4606"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9059",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "rename": {
        "from": "[with patch] the polynomial .roots() method should work with ring=QQbar",
        "to": "[with patch, with positive review] the polynomial .roots() method should work with ring=QQbar"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1357#event-4607"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1357#event-4608"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9060",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1357",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1357#issuecomment-9061",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
