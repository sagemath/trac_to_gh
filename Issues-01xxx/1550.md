# Issue 1550: [with positive review] use libecm instead of pexpect+ecm binary
...
```json
{
    ...
    "title": "[with positive review] use libecm instead of pexpect+ecm binary",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10648",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10649",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1550#event-4609"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10650",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10651",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10652",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] use libecm instead of pexpect+ecm binary"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1550#event-4610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10653",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10654",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10655",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1550#event-4611"
}
```
