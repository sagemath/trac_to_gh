...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10323",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10324",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, probably not ready] use libecm instead of pexpect+ecm binary"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1550#event-5262"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10325",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10326",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10327",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "rename": {
        "from": "[with patch, probably not ready] use libecm instead of pexpect+ecm binary",
        "to": "[with patch, with positive review] use libecm instead of pexpect+ecm binary"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1550#event-5263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10328",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10329",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1550#issuecomment-10330",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1550",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1550#event-5264"
}
```
