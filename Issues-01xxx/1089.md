...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6899",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "rename": {
        "from": "[with patch] graphs: update subgraph to handle a list of edges",
        "to": "[not ready] graphs: update subgraph to handle a list of edges"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1089#event-3675"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1089#event-3676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6900",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6901",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6902",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6903",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6904",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1089#event-3677"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1089#event-3678"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] graphs: update subgraph to handle a list of edges"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1089#event-3679"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1089#event-3680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6905",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1089#event-3681"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6906",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1089",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1089#issuecomment-6907",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
