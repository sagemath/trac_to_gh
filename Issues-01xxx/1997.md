# Issue 1997: [with patch; positive review] magma interface -- interrupting restarts magma way way too aggressively
...
```json
{
    ...
    "title": "[with patch; positive review] magma interface -- interrupting restarts magma way way too aggressively",
    "type": "issue",
