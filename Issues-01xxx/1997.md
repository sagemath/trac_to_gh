...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1997#issuecomment-13476",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1997",
    "rename": {
        "from": "magma interface -- interrupting restarts magma way way too aggressively",
        "to": "[with patch; needs review] magma interface -- interrupting restarts magma way way too aggressively"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1997#event-6841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1997#issuecomment-13477",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1997#issuecomment-13478",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1997",
    "rename": {
        "from": "[with patch; needs review] magma interface -- interrupting restarts magma way way too aggressively",
        "to": "[with patch; positive review] magma interface -- interrupting restarts magma way way too aggressively"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1997#event-6842"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1997#issuecomment-13479",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1997#issuecomment-13480",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1997",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1997#event-6843"
}
```
