...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1638#issuecomment-10699",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1638#issuecomment-10700",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>All known instances of /bin/bash have been fixed. So I am closing this and any new instances can be fixed via new tickets.\n\nCheers,\n\nMichael",
    "created_at": "2008-08-25T04:16:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1638#issuecomment-10701",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>All known instances of /bin/bash have been fixed. So I am closing this and any new instances can be fixed via new tickets.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1638",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1638#issuecomment-10702",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1638",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1638#event-4055"
}
```
