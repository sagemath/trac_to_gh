...
```json
{
    "body": "<a id='comment:1'></a>I forgot to mention... this patch depends on the patch from #1270, which must be applied first.",
...
<a id='comment:1'></a>I forgot to mention... this patch depends on the patch from #1270, which must be applied first.
