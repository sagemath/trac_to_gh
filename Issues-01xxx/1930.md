...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg] Sage 2.10.1.alpha2: R is broken for parallel make, rpy is broken for fresh installs"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1930#event-6558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1930",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1930#issuecomment-12754",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1930",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1930#issuecomment-12755",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1930",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1930#issuecomment-12756",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1930",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1930#event-6559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1930",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1930#issuecomment-12757",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1930",
    "rename": {
        "from": "[with spkg] Sage 2.10.1.alpha2: R is broken for parallel make, rpy is broken for fresh installs",
        "to": "[with spkg] Sage 2.10.1.alpha2: R is broken for parallel make, rpy is broken for fresh installs, remove recommended.tar.gzs"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1930#event-6560"
}
```
