...
```json
{
    "body": "<a id='comment:2'></a>Attachment [trac-1645.patch](tarball://root/attachments/some-uuid/ticket1645/trac-1645.patch) by @williamstein created at 2008-01-02 06:12:12\n\nThis actually has nothing to do with erf really -- it's that converting a real interval to Maxima (or any other system) should raise a TypeError, but doesn't.   \n\nOf course, erf could be implemented for intervals, but that's not done yet; that would be an enhancement not a bug.",
    "created_at": "2008-01-02T06:12:12Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1645#issuecomment-11273",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:2'></a>Attachment [trac-1645.patch](tarball://root/attachments/some-uuid/ticket1645/trac-1645.patch) by @williamstein created at 2008-01-02 06:12:12
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1645#issuecomment-11274",
...
```json
{
    "body": "<a id='comment:4'></a>Looks good to me; and this patch was already applied in 2.9.2.",
    "created_at": "2008-01-15T03:21:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1645#issuecomment-11275",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:4'></a>Looks good to me; and this patch was already applied in 2.9.2.
