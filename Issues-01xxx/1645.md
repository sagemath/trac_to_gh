...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1645#event-5580"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1645#issuecomment-10910",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] erf doesn't evaluate with intervals"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1645#event-5581"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "rename": {
        "from": "[with patch, needs review] erf doesn't evaluate with intervals",
        "to": "[with patch, with positive review] erf doesn't evaluate with intervals"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1645#event-5582"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1645#event-5583"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1645#event-5584"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1645#issuecomment-10911",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1645#issuecomment-10912",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1645",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1645#event-5585"
}
```
