...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1724#issuecomment-11747",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1724#issuecomment-11748",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>Attachment [craigcitro-1724.patch](tarball://root/attachments/some-uuid/ticket1724/craigcitro-1724.patch) by @craigcitro created at 2008-01-21 08:46:00\n\nThis fixes the above bug. It also smooths out a few issues to do with the following: at  various places in the modular forms code, it seems that self.prec() is used where self.sturm_bound() is what we really want. There may be more of these that are hard to track down -- for instance, one might use self.basis()[0].prec(), etc.",
    "created_at": "2008-01-21T08:46:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1724#issuecomment-11749",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:2'></a>Attachment [craigcitro-1724.patch](tarball://root/attachments/some-uuid/ticket1724/craigcitro-1724.patch) by @craigcitro created at 2008-01-21 08:46:00
...
```json
{
    "body": "<a id='comment:3'></a>Oops -- I forgot to mention, this patch will only apply to a branch that already has the patches for #1844 applied.",
    "created_at": "2008-01-21T08:46:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1724#issuecomment-11750",
    "user": "https://github.com/craigcitro"
}
```

<a id='comment:3'></a>Oops -- I forgot to mention, this patch will only apply to a branch that already has the patches for #1844 applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1724#issuecomment-11751",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1724#issuecomment-11752",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1724#issuecomment-11753",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
