...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1253#issuecomment-8474",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1253#issuecomment-8476",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1253#issuecomment-8477",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Merged in 2.8.14.rc1. Let's hope it still works on OSX < 10.5.1 :)\n\nCheers,\n\nMichael",
    "created_at": "2007-11-24T15:47:07Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1253#issuecomment-8478",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Merged in 2.8.14.rc1. Let's hope it still works on OSX < 10.5.1 :)
