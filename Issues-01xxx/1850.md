...
<a id='comment:1'></a>Very disturbingly, if you render using tachyon you don't see the problem:
...
<a id='comment:2'></a>This seems to hit a hard-coded point limit of 256 in jmol's `org/jmol/shapespecial/Draw.java`, line 69.
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [1850-jmol-pointlimit.diff](tarball://root/attachments/some-uuid/ticket1850/1850-jmol-pointlimit.diff) by @robertwb created at 2008-01-20 01:06:15",
...
<a id='comment:4'></a>Attachment [1850-jmol-pointlimit.diff](tarball://root/attachments/some-uuid/ticket1850/1850-jmol-pointlimit.diff) by @robertwb created at 2008-01-20 01:06:15
...
```json
{
    "body": "<a id='comment:5'></a>It works well for me.  Thanks Robert!",
...
<a id='comment:5'></a>It works well for me.  Thanks Robert!
...
```json
{
    "body": "<a id='comment:6'></a>Merged in Sage 2.10.1.alpha0",
    "created_at": "2008-01-20T01:53:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1850",
    "type": "issue_comment",
...
<a id='comment:6'></a>Merged in Sage 2.10.1.alpha0
