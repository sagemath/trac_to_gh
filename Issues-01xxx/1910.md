...
```json
{
    "body": "<a id='comment:1'></a>This seems to be the reason: matrix_field_dense.pyx has matrix_pid_dense has its parent, but matrix_pid_dense doesn't even exist (yet)! Same for matrix_field_sparse and its counterpart, matrix_pid_sparse.",
    "created_at": "2008-03-04T17:07:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1910#issuecomment-12407",
    "user": "https://github.com/dfdeshom"
}
```

<a id='comment:1'></a>This seems to be the reason: matrix_field_dense.pyx has matrix_pid_dense has its parent, but matrix_pid_dense doesn't even exist (yet)! Same for matrix_field_sparse and its counterpart, matrix_pid_sparse.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1910",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1910#issuecomment-12409",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
