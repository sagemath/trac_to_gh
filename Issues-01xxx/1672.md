...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1672#event-14226"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1672#event-14227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1672#event-14228"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1672#event-14229"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1672#event-14230"
}
```
...
```json
{
    "body": "Changed assignee from **@robertwb** to **@williamstein**",
...
Changed assignee from **@robertwb** to **@williamstein**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1672",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1672#event-14231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1672#issuecomment-8171",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1672#issuecomment-8172",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
