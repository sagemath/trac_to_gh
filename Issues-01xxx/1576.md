...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10463",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10464",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10465",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10466",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] implicit multiplication -- sage needs to have *some* way to do this (even if not by default)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1576#event-5346"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "rename": {
        "from": "[with patch] implicit multiplication -- sage needs to have *some* way to do this (even if not by default)",
        "to": "[with patch; very positive review] implicit multiplication -- sage needs to have *some* way to do this (even if not by default)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1576#event-5347"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10467",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10468",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10469",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1576#event-5348"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1576#issuecomment-10470",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
