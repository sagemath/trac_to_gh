# Issue 1681: [with positive review] serious bug when raising complex(0,1) to the power of the Sage integer 2.
...
```json
{
    ...
    "title": "[with positive review] serious bug when raising complex(0,1) to the power of the Sage integer 2.",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11509",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11510",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11511",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11512",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11513",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] serious bug when raising complex(0,1) to the power of the Sage integer 2."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1681#event-4941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11514",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1681#event-4942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11515",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1681",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1681#issuecomment-11516",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
