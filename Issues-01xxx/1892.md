...
```json
{
    ...
    "rename": {
        "from": "notebook -- uploading a data file should give some help about the DATA variable",
        "to": "[with patch; needs review] notebook -- uploading a data file should give some help about the DATA variable"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1892#event-6403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1892#issuecomment-12474",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1892#issuecomment-12475",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1892",
    "rename": {
        "from": "[with patch; needs review] notebook -- uploading a data file should give some help about the DATA variable",
        "to": "[with patch; positive review] notebook -- uploading a data file should give some help about the DATA variable"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1892#event-6404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1892#issuecomment-12476",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1892#issuecomment-12477",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1892",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1892#event-6405"
}
```
