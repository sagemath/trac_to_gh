# Issue 1911: [with positive review] elliptic curves -- make heegner_index command return index instead of square of index; clarify why sometimes results is not an integer (it's not a bug, it's part of the algorithm)
...
```json
{
    ...
    "title": "[with positive review] elliptic curves -- make heegner_index command return index instead of square of index; clarify why sometimes results is not an integer (it's not a bug, it's part of the algorithm)",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1911#event-5590"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1911/trac-1911-heegner_index.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-13140",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] elliptic curves -- make heegner_index command return index instead of square of index; clarify why sometimes results is not an integer (it's not a bug, it's part of the algorithm)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1911#event-5591"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-13141",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1911#event-5592"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1911/1911-pt2.patch",
    "created_at": "2008-01-26T11:21:14Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "attachment",
    "url": "https://github.com/assets/some-id/some-uuid.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-13142",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-13143",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
