...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] elliptic curves -- make heegner_index command return index instead of square of index; clarify why sometimes results is not an integer (it's not a bug, it's part of the algorithm)",
        "to": "[with patch; mostly positive review] elliptic curves -- make heegner_index command return index instead of square of index; clarify why sometimes results is not an integer (it's not a bug, it's part of the algorithm)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1911#event-6485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-12596",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "rename": {
        "from": "[with patch; mostly positive review] elliptic curves -- make heegner_index command return index instead of square of index; clarify why sometimes results is not an integer (it's not a bug, it's part of the algorithm)",
        "to": "[with patch; with positive review] elliptic curves -- make heegner_index command return index instead of square of index; clarify why sometimes results is not an integer (it's not a bug, it's part of the algorithm)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1911#event-6486"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-12597",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1911#event-6487"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-12598",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1911#issuecomment-12599",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
