...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13636",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>The real problem can be boiled down a little:\n\n```\nsage: G = Graph('^????????????????????{??N??@w??FaGa?PCO@CP?AGa?_QO?Q@G?CcA??cc????Bo????{????F_')\nsage: G.relabel([i+1 for i in xrange(31)])\nsage: perm = {4:16, 16:4}\nsage: A = G.canonical_label()\nsage: B = G.relabel(perm, inplace=False).canonical_label()\nsage: A == B\nFalse\n```",
    "created_at": "2008-02-06T19:08:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13637",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>The real problem can be boiled down a little:
...
```json
{
    "body": "<a id='comment:4'></a>Slightly easier to digest still:\n\n```\nsage: G = Graph('^????????????????????{??N??@w??FaGa?PCO@CP?AGa?_QO?Q@G?CcA??cc????Bo????{????F_')\nsage: perm = {3:15, 15:3}\nsage: H = G.relabel(perm, inplace=False)\nsage: G.canonical_label() == H.canonical_label()\nFalse\n```",
    "created_at": "2008-02-06T19:54:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13638",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:4'></a>Slightly easier to digest still:
...
```json
{
    "body": "<a id='comment:5'></a>After applying the patches at #2085, and setting use_indicator_function to False, the example returns True! This is our first clue...",
    "created_at": "2008-02-16T21:06:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13639",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:5'></a>After applying the patches at #2085, and setting use_indicator_function to False, the example returns True! This is our first clue...
...
```json
{
    "body": "<a id='comment:6'></a>Attachment [1961-only_update_qzb_if_zero.patch](tarball://root/attachments/some-uuid/ticket1961/1961-only_update_qzb_if_zero.patch) by @rlmill created at 2008-02-17 02:41:22\n\nAfter three weeks, the problem is solved. The patch should apply on top of #2186, which depends on a few things...",
    "created_at": "2008-02-17T02:41:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13640",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:6'></a>Attachment [1961-only_update_qzb_if_zero.patch](tarball://root/attachments/some-uuid/ticket1961/1961-only_update_qzb_if_zero.patch) by @rlmill created at 2008-02-17 02:41:22
...
```json
{
    "body": "<a id='comment:7'></a>The patch for this problem also fixes #1360, so make sure to close that ticket once this patch is applied.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-18T21:04:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13641",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>The patch for this problem also fixes #1360, so make sure to close that ticket once this patch is applied.
...
```json
{
    "body": "<a id='comment:8'></a>After applying this patch, the patch from #2211 should also be applied.",
    "created_at": "2008-02-19T19:45:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13642",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:8'></a>After applying this patch, the patch from #2211 should also be applied.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13643",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13644",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>Merged in Sage 2.10.2.alpha2",
    "created_at": "2008-02-19T22:18:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1961#issuecomment-13645",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:10'></a>Merged in Sage 2.10.2.alpha2
