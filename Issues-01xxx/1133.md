...
```json
{
    "body": "<a id='comment:2'></a>See the last patch of #1296",
...
<a id='comment:2'></a>See the last patch of #1296
...
<a id='comment:3'></a>This issue was fixed by Robert Bradshaw's patch referred above and merged in 2.9.0. It works in Sage 2.9.1.1:
