...
<a id='comment:1'></a>Unfortunately there is a bug somewhere or some sort of mathematical contradiction going on here, as the following calculation illustrates:
...
```json
{
    "body": "<a id='comment:3'></a>*Doh* -- I was being stupid / confused between Eisenstein series and cusp form, since it was a long day.\n\nChange this to a positive review!",
...
<a id='comment:3'></a>*Doh* -- I was being stupid / confused between Eisenstein series and cusp form, since it was a long day.
