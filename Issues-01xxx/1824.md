# Issue 1824: [with patch, with positive review] *huge* memory leak in PolyBoRi iteratiors
...
```json
{
    ...
    "title": "[with patch, with positive review] *huge* memory leak in PolyBoRi iteratiors",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11519",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11520",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>D'oh ... assigned to the correct component now ;)",
    "created_at": "2008-01-18T05:06:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11521",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>D'oh ... assigned to the correct component now ;)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11522",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11523",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>If you install the polybori package with the environment variable `SAGE_DEBUG` set, then it builds the debug symbols.\n\nI will look into these.",
    "created_at": "2008-01-20T10:07:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11524",
    "user": "https://github.com/burcin"
}
```

<a id='comment:2'></a>If you install the polybori package with the environment variable `SAGE_DEBUG` set, then it builds the debug symbols.
...
```json
{
    "body": "<a id='comment:3'></a>Hi brucin,\n\nrpw might have a fix for this issue. You should ping him about this. \n\nCheers,\n\nMichael",
    "created_at": "2008-01-21T07:15:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11525",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Hi brucin,
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11526",
...
```json
{
    "body": "<a id='comment:5'></a>Patch looks good to me. I will look into the remaining memleak. It looks like CuddInit is called - we might need to call some deallocation routine for Cudd before exiting Sage. I will open another ticket once I figure out whose fault the memleak is.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-07T05:31:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11528",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Patch looks good to me. I will look into the remaining memleak. It looks like CuddInit is called - we might need to call some deallocation routine for Cudd before exiting Sage. I will open another ticket once I figure out whose fault the memleak is.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11529",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1824#issuecomment-11530",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1824",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1824#event-4436"
}
```
