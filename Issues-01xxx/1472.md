...
```json
{
    "body": "<a id='comment:2'></a>For the sake of the reviewer, could you give an example of a command sequence that fails with the current gnuplotpy package and works with the new one?",
...
<a id='comment:2'></a>For the sake of the reviewer, could you give an example of a command sequence that fails with the current gnuplotpy package and works with the new one?
...
```json
{
    "body": "<a id='comment:3'></a>Looks good to me.  Tested using sample code from http://www.math.washington.edu/~jkantor/Numerical_Sage/node13.html .",
...
<a id='comment:3'></a>Looks good to me.  Tested using sample code from http://www.math.washington.edu/~jkantor/Numerical_Sage/node13.html .
...
```json
{
    "body": "<a id='comment:4'></a>The optional spkg has been added to sagemath.org.",
...
<a id='comment:4'></a>The optional spkg has been added to sagemath.org.
