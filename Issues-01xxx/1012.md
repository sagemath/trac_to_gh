...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1012#event-8567"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1012#event-8568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1012#event-8569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1012#event-8570"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1012#event-8571"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1012#event-8572"
}
```
...
```json
{
    "body": "Changed assignee from **@sagetrac-failure** to **@sagetrac-cwitty**",
...
Changed assignee from **@sagetrac-failure** to **@sagetrac-cwitty**
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1012",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1012#event-8573"
}
```
