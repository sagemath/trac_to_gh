...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1816#issuecomment-11948",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] rename MPolynomialRing.repr_long method to __str__"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1816#event-6144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1816",
    "rename": {
        "from": "[with patch, needs review] rename MPolynomialRing.repr_long method to __str__",
        "to": "[with patch, with negative review] rename MPolynomialRing.repr_long method to __str__"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1816#event-6145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1816#issuecomment-11949",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1816#issuecomment-11950",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1816#issuecomment-11951",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1816",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1816#event-6146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1816#issuecomment-11952",
    "user": "https://github.com/malb"
}
```
