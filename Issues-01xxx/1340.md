# Issue 1340: [with positive review] %cython broken if directory name contains spaces
...
```json
{
    ...
    "title": "[with positive review] %cython broken if directory name contains spaces",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9235",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9236",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9237",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1340#event-4035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9238",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9239",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9240",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1340#event-4036"
}
```
...
archive/attachments_001019.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "1340-cython-spaces.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1340/1340-cython-spaces.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9241",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "rename": {
        "from": "%cython broken if directory name contains spaces",
        "to": "[with positive review] %cython broken if directory name contains spaces"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1340#event-4037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9242",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1340#event-4038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9243",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1340#issuecomment-9244",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
