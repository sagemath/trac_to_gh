...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1709#issuecomment-11289",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1709",
    "rename": {
        "from": "[with patch] Make experimental jmol graph plotting work",
        "to": "[with patch, positive review] Make experimental jmol graph plotting work"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1709#event-5754"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1709#issuecomment-11290",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1709",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1709#issuecomment-11291",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1709",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1709#event-5755"
}
```
