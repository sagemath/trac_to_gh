# Issue 1789: [with patch; with positive review] standalone Sage scripts don't work on Linux -- they work fine on OS X
...
```json
{
    ...
    "title": "[with patch; with positive review] standalone Sage scripts don't work on Linux -- they work fine on OS X",
    "type": "issue",
