...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1789#issuecomment-11783",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1789#issuecomment-11784",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] standalone Sage scripts don't work on Linux -- they work fine on OS X"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1789#event-6050"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1789",
    "rename": {
        "from": "[with patch; needs review] standalone Sage scripts don't work on Linux -- they work fine on OS X",
        "to": "[with patch; with positive review] standalone Sage scripts don't work on Linux -- they work fine on OS X"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1789#event-6051"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1789#issuecomment-11785",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1789#event-6052"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1789#issuecomment-11786",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1789#issuecomment-11787",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
