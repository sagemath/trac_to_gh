# Issue 1871: [with patch, positive review] wiki -- pressing control-c just starts another copy running
...
```json
{
    ...
    "title": "[with patch, positive review] wiki -- pressing control-c just starts another copy running",
    "type": "issue",
