...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14944"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14947"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14948"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1515#issuecomment-7078",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1515#issuecomment-7079",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "subject": "https://github.com/robertwb",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14949"
}
```
...
```json
{
    ...
    "subject": "https://github.com/robertwb",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14950"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1515#issuecomment-7080",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1515",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1515#event-14951"
}
```
