...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1515#issuecomment-10489",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Now the first example works. Also, the second example almost does\n\n```\nS = ParametricSurface(lambda x,y:(cos(x),sin(x), y), domain=(range(10),range(10)))\n```\n\n(Note the missing ()'s, it expects to arguments, not a tuple).",
    "created_at": "2007-12-15T02:04:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1515#issuecomment-10490",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:1'></a>Now the first example works. Also, the second example almost does
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1515#issuecomment-10491",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1515#issuecomment-10492",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1515#issuecomment-10493",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1515#issuecomment-10494",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
