...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1175#issuecomment-7609",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1175",
    "rename": {
        "from": "circular link in sage/local/lib/python2.5",
        "to": "[with spkg] circular link in sage/local/lib/python2.5"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1175#event-4009"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1175#issuecomment-7610",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1175#issuecomment-7611",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1175",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1175#issuecomment-7612",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1175",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1175#event-4010"
}
```
