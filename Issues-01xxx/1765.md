...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] allow list of variables as second input to solve command (very easy to implement)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1765#event-5939"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11596",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1765#event-5940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11597",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "rename": {
        "from": "[with patch; needs review] allow list of variables as second input to solve command (very easy to implement)",
        "to": "[with patch; negative review] allow list of variables as second input to solve command (very easy to implement)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1765#event-5941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11598",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11599",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "rename": {
        "from": "[with patch; negative review] allow list of variables as second input to solve command (very easy to implement)",
        "to": "[with patch; needs review] allow list of variables as second input to solve command (very easy to implement)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1765#event-5942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11600",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "rename": {
        "from": "[with patch; needs review] allow list of variables as second input to solve command (very easy to implement)",
        "to": "[with patch; with positive review] allow list of variables as second input to solve command (very easy to implement)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1765#event-5943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11601",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11602",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1765#issuecomment-11603",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1765",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1765#event-5944"
}
```
