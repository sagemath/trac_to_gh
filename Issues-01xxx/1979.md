...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1979#issuecomment-13378",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "rename": {
        "from": "doctest fall out from #740 in tut.tex",
        "to": "[with patch, needs review] doctest fall out from #740 in tut.tex"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1979#event-6782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1979#issuecomment-13379",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1979#event-6783"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1979#issuecomment-13380",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "rename": {
        "from": "[with patch, needs review] doctest fall out from #740 in tut.tex",
        "to": "[with patch, positive review] doctest fall out from #740 in tut.tex"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1979#event-6784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1979#issuecomment-13381",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1979#issuecomment-13382",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1979#issuecomment-13383",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
