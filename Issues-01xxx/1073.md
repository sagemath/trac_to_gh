...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1073#event-3623"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1073#issuecomment-6801",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] right after \"sage -pkg\" creates a package, print out some useful information"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1073#event-3624"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1073",
    "rename": {
        "from": "[with patch] right after \"sage -pkg\" creates a package, print out some useful information",
        "to": "[with patch, with positive review] right after \"sage -pkg\" creates a package, print out some useful information"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1073#event-3625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1073#issuecomment-6802",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1073#issuecomment-6803",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1073",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1073#event-3626"
}
```
