...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n-As justification that this is for *consistency*, everybody defines 0^0 to be 1, except Mathematica:\n+As justification that this is for *consistency*, everybody defines 0<sup>0</sup> to be 1, except Mathematica:\n \n ```\n \n@@ -21,6 +21,8 @@\n 1.00000000000000\n ```\n \n+\n+\n Summary: [with patch; needs review] change 0^0, for 0 a Sage integer, to evaluate to 1 for consistency with Python, PARI, Magma, Maple, MPFR, GMP, etc.\n \n Issue created by migration from https://trac.sagemath.org/ticket/1983\n``````\n",
...
```json
{
    "body": "<a id='comment:2'></a>This works as described.",
...
<a id='comment:2'></a>This works as described.
