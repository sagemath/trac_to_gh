...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1983#issuecomment-13402",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1983#issuecomment-13403",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1983#issuecomment-13404",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "rename": {
        "from": "[with patch; needs review] change 0^0, for 0 a Sage integer, to evaluate to 1 for consistency with Python, PARI, Magma, Maple, MPFR, GMP, etc.",
        "to": "[with patch; positive review] change 0^0, for 0 a Sage integer, to evaluate to 1 for consistency with Python, PARI, Magma, Maple, MPFR, GMP, etc."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1983#event-6790"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1983#issuecomment-13405",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1983#issuecomment-13406",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1983#event-6791"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1983#event-6792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1983#issuecomment-13407",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1983#issuecomment-13408",
    "user": "https://github.com/fchapoton"
}
```
