...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8336",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] modify singular interface to allow for verbose output"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1274#event-4325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8337",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "rename": {
        "from": "[with patch, needs review] modify singular interface to allow for verbose output",
        "to": "[with patch, with positive review] modify singular interface to allow for verbose output"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1274#event-4326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8338",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8339",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1274#event-4327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8340",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
