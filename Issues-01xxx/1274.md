# Issue 1274: [with positive review] modify singular interface to allow for verbose output
...
```json
{
    ...
    "title": "[with positive review] modify singular interface to allow for verbose output",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1274/trac_1274.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8563",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8564",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8565",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "rename": {
        "from": "modify singular interface to allow for verbose output",
        "to": "[with positive review] modify singular interface to allow for verbose output"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1274#event-3829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8566",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8567",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1274#event-3830"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1274",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1274#issuecomment-8568",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
