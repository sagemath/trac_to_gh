...
```json
{
    "body": "<a id='comment:2'></a>Ok, this should be easy enough to fix. Axiom should probably also be installed as sage.axiom or something similar.\n\nCheers,\n\nMichael",
    "created_at": "2008-09-15T20:56:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1753#issuecomment-11887",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>Ok, this should be easy enough to fix. Axiom should probably also be installed as sage.axiom or something similar.
...
```json
{
    "body": "<a id='comment:7'></a>`make install` is no longer supported, see #1792.",
    "created_at": "2016-05-20T08:22:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1753#issuecomment-11888",
    "user": "https://github.com/jdemeyer"
}
```

<a id='comment:7'></a>`make install` is no longer supported, see #1792.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1753#issuecomment-11889",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1753#issuecomment-11890",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1753#issuecomment-11891",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1753#issuecomment-11892",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1753#issuecomment-11893",
