...
```json
{
    "body": "<a id='comment:1'></a>In this case, the roots method tries to factor f and extract roots from the factorization:\n\n```\nsage: factor(f)\n(8) * (y + 8) * y^2\n```\nI'm told that we need to check that the coefficient ring forms a unique factorization domain before using this strategy, but I don't know how to check that in Sage.",
    "created_at": "2007-11-27T15:54:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1292#issuecomment-8757",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

<a id='comment:1'></a>In this case, the roots method tries to factor f and extract roots from the factorization:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1292#issuecomment-8759",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>For the IntegerModRing case, we could probably do something with http://www.shoup.net/ntl/doc/ZZ_pXFactoring.txt .",
    "created_at": "2007-11-27T20:50:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1292#issuecomment-8760",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:4'></a>For the IntegerModRing case, we could probably do something with http://www.shoup.net/ntl/doc/ZZ_pXFactoring.txt .
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1292#issuecomment-8762",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1292#issuecomment-8763",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1292#issuecomment-8764",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
