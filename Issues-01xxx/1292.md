...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1292#issuecomment-6208",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1292#issuecomment-6209",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1292#issuecomment-6210",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1292#issuecomment-6211",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1292#event-5975"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1292#event-5976"
}
```
...
archive/attachments_000966.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "1292.patch",
    "asset_url": "tarball://root/attachments/ticket1292/1292.patch",
    "created_at": "2007-11-28T02:09:51Z",
    "issue": "https://github.com/sagemath/sage/issues/1292",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1292/1292.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1292#issuecomment-6213",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1292",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1292#issuecomment-6214",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1292",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1292#event-5977"
}
```
