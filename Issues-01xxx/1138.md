# Issue 1138: [with patch, positive review] add implementation of tonelli-shanks to sage
...
```json
{
    ...
    "title": "[with patch, positive review] add implementation of tonelli-shanks to sage",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7106",
...
```json
{
    "body": "<a id='comment:2'></a>The algorithm as written is NOT faster for actual squares mod p, the timings are poor because sqrt(a) creates symbolic square roots for half the values. \n\nFor p == 1 mod 16, I think there may be an improvement. I am investigating this further.",
    "created_at": "2008-02-16T21:18:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7107",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:2'></a>The algorithm as written is NOT faster for actual squares mod p, the timings are poor because sqrt(a) creates symbolic square roots for half the values. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7108",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This algorithm has also been implemented in FLINT, so I am simply going to wrap that.",
    "created_at": "2008-02-16T21:48:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7109",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>This algorithm has also been implemented in FLINT, so I am simply going to wrap that.
...
```json
{
    "body": "<a id='comment:4'></a>Attachment [1138-sqrt-mod.patch](tarball://root/attachments/some-uuid/ticket1138/1138-sqrt-mod.patch) by @robertwb created at 2008-02-18 22:51:59\n\nI wasn't able to get FLINT to give me the correct answers, the algorithm turns out to be simple enough that I just implemented it right in the library. \n\nThere are several other minor optimizations in the patch too.",
    "created_at": "2008-02-18T22:51:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7110",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:4'></a>Attachment [1138-sqrt-mod.patch](tarball://root/attachments/some-uuid/ticket1138/1138-sqrt-mod.patch) by @robertwb created at 2008-02-18 22:51:59
...
```json
{
    "body": "<a id='comment:5'></a>Isn't this algorithm already in PARI?",
    "created_at": "2008-02-23T03:25:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7111",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:5'></a>Isn't this algorithm already in PARI?
...
```json
{
    "body": "<a id='comment:6'></a>Robert's patch didn't apply cleanly to 2.10.2, I've rebased it, see new patch. I'm going to review it more carefully now.",
    "created_at": "2008-02-23T14:43:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7112",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:6'></a>Robert's patch didn't apply cleanly to 2.10.2, I've rebased it, see new patch. I'm going to review it more carefully now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7114",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>I rebased it again against 2.10.4 and touched it up a bit. It should work now. `sage/schemes/generic/projective_space.py` passes on my OS X 10.4.11 intel laptop.",
    "created_at": "2008-03-26T03:14:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7115",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:9'></a>I rebased it again against 2.10.4 and touched it up a bit. It should work now. `sage/schemes/generic/projective_space.py` passes on my OS X 10.4.11 intel laptop.
...
```json
{
    "body": "<a id='comment:10'></a>Attachment [1138.patch](tarball://root/attachments/some-uuid/ticket1138/1138.patch) by @mwhansen created at 2008-04-04 20:22:05\n\nLooks good to me.  I've attached 1138.patch which is rebased against sage-3.0.alpha0",
    "created_at": "2008-04-04T20:22:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7116",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:10'></a>Attachment [1138.patch](tarball://root/attachments/some-uuid/ticket1138/1138.patch) by @mwhansen created at 2008-04-04 20:22:05
...
```json
{
    "body": "<a id='comment:11'></a>The original code was from Steffen Reidt: http://groups.google.com/group/sage-devel/browse_frm/thread/e7910523502a641/62d692cb57caf7ff?lnk=gst&q=tonelli+shanks#62d692cb57caf7ff",
    "created_at": "2008-04-04T20:35:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7117",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:11'></a>The original code was from Steffen Reidt: http://groups.google.com/group/sage-devel/browse_frm/thread/e7910523502a641/62d692cb57caf7ff?lnk=gst&q=tonelli+shanks#62d692cb57caf7ff
...
```json
{
    "body": "<a id='comment:12'></a>Merged 1138.patch in Sage 3.0.alpha1",
    "created_at": "2008-04-04T21:29:23Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7118",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Merged 1138.patch in Sage 3.0.alpha1
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1138#issuecomment-7119",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
