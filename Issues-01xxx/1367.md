...
```json
{
    "body": "<a id='comment:2'></a>This might well be fixed by the patches posted for #1946.  Unfortunately I do not seem to be able to test that, owing to my complete incompetence in applying patches, even my own.  It would be a good idea if #1946 was cross-referenced to this one.\n\n In case this seems crazy:  fixing #1946 by adding lots of doctests to the code for Tate's algorithm over number fields revealed some minor bugs in its implementation, and fixing those revealed some bugs in the code for ideals and fractional ideals in number fields.  I fixed that (in late January, partly jointly with William) and at the same time -- I seem to remember -- fixed this thing about ideals in relative extensions.\n\n Both the patches  attached to #1946 are waiting review....",
    "created_at": "2008-02-18T12:08:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9475",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:2'></a>This might well be fixed by the patches posted for #1946.  Unfortunately I do not seem to be able to test that, owing to my complete incompetence in applying patches, even my own.  It would be a good idea if #1946 was cross-referenced to this one.
...
```json
{
    "body": "<a id='comment:3'></a>This is still broken in sage-3.0.",
    "created_at": "2008-04-25T01:00:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9476",
    "user": "https://github.com/aghitza"
}
```

<a id='comment:3'></a>This is still broken in sage-3.0.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9478",
    "user": "https://trac.sagemath.org/admin/accounts/users/fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9479",
...
```json
{
    "body": "<a id='comment:5'></a>Hi Francis, \n\nI changed the title slightly so our various sql queries pick it up.\n\nCheers,\n\nMichael",
    "created_at": "2008-07-18T18:19:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9480",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>Hi Francis, 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9481",
...
```json
{
    "body": "<a id='comment:9'></a>I spent several evening 6 months ago on this chunk of code, trying to see how it was supposed to work and fixing what didn't.  It was not a very happy experience -- not helped by the fact that this was just about the first ever Sage development which I did.  On the other hand, I was helped a lot at the time by William.  Th eonly reason I got into that code at all was that I decided to add doctests to `ell_number_field.py` and found lots of things broken. \n\nAnyway, while I cannot guarantee to have time to review this properly soon, I'll do what I can.",
    "created_at": "2008-07-19T08:55:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9484",
    "user": "https://github.com/JohnCremona"
}
```

<a id='comment:9'></a>I spent several evening 6 months ago on this chunk of code, trying to see how it was supposed to work and fixing what didn't.  It was not a very happy experience -- not helped by the fact that this was just about the first ever Sage development which I did.  On the other hand, I was helped a lot at the time by William.  Th eonly reason I got into that code at all was that I decided to add doctests to `ell_number_field.py` and found lots of things broken. 
...
```json
{
    "body": "<a id='comment:11'></a>I have made a new ticket #3680 to cover my general gripes about the algebraic number theory framework. But I don't have time to work on it now.",
    "created_at": "2008-07-19T13:38:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9486",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```

<a id='comment:11'></a>I have made a new ticket #3680 to cover my general gripes about the algebraic number theory framework. But I don't have time to work on it now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9488",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Nick, David: any chance to see some movement on this? I would like to get this in before it rots and potential issues can be addressed via followup tickets.\n\nThoughts?\n\nCheers,\n\nMichael",
    "created_at": "2009-01-29T04:10:53Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9492",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:16'></a>Nick, David: any chance to see some movement on this? I would like to get this in before it rots and potential issues can be addressed via followup tickets.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9493",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>I think this should be applied and more tickets opened for any additional issues.\n\n* It's an improvement upon the old code and addresses 3 tickets.\n\n* It was never going to be the final say in this area.\n\n* I don't have time to work on it more, and neither does David Roe.",
    "created_at": "2009-01-29T05:00:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9494",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:17'></a>I think this should be applied and more tickets opened for any additional issues.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9496",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Opened #5126 and #5127.",
    "created_at": "2009-01-29T05:09:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9497",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:19'></a>Opened #5126 and #5127.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9499",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9500",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9501",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>Attachment [trac_1367-prebase.patch](tarball://root/attachments/some-uuid/ticket1367/trac_1367-prebase.patch) by mabshoff created at 2009-01-29 05:42:49\n\nMerged trac_1367-prebase.patch and trac_1367.2.patch in Sage 3.3.alpha3.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-29T05:42:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9502",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:21'></a>Attachment [trac_1367-prebase.patch](tarball://root/attachments/some-uuid/ticket1367/trac_1367-prebase.patch) by mabshoff created at 2009-01-29 05:42:49
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9503",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9504",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>The issues David remarked about are now being handled via #5126 and #5127.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-29T05:43:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9505",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:22'></a>The issues David remarked about are now being handled via #5126 and #5127.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1367#issuecomment-9506",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
