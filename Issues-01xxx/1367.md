# Issue 1367: [with patch, positive review] weird bug creating fractional ideal in relative number field
...
```json
{
    ...
    "title": "[with patch, positive review] weird bug creating fractional ideal in relative number field",
    "type": "issue",
