...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1838#issuecomment-12111",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1838#issuecomment-12112",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1838",
    "rename": {
        "from": "[with patch] comma in latex lists need a trailing space",
        "to": "[with patch, with preliminary review] comma in latex lists need a trailing space"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1838#event-6208"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1838#event-6209"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1838#issuecomment-12113",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1838#issuecomment-12114",
...
```json
{
    ...
    "milestone": "sage-wishlist",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1838#event-6210"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1838#event-6211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1838#issuecomment-12115",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1838#issuecomment-12116",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1838",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1838#event-6212"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1838#event-6213"
}
```
