...
```json
{
    "body": "<a id='comment:1'></a>Attachment [Sage-2.9.alpha7-fix-ATLAS-linking.patch](tarball://root/attachments/some-uuid/ticket1499/Sage-2.9.alpha7-fix-ATLAS-linking.patch) by mabshoff created at 2007-12-14 00:52:31\n\nThe patch passes a `sage -ba` and a `testall` on OSX 10.5\n\nCheers,\n\nMichael",
    "created_at": "2007-12-14T00:52:31Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1499#issuecomment-10390",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Attachment [Sage-2.9.alpha7-fix-ATLAS-linking.patch](tarball://root/attachments/some-uuid/ticket1499/Sage-2.9.alpha7-fix-ATLAS-linking.patch) by mabshoff created at 2007-12-14 00:52:31
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1499#issuecomment-10391",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1499",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1499#issuecomment-10392",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
