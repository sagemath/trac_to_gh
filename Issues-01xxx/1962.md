...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1962#issuecomment-13221",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1962#issuecomment-13222",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1962#issuecomment-13223",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] set_edge_label creates edges when multiple edges are allowed"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1962#event-6714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1962#issuecomment-13224",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "rename": {
        "from": "[with patch, needs review] set_edge_label creates edges when multiple edges are allowed",
        "to": "[with patch, with positive review] set_edge_label creates edges when multiple edges are allowed"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1962#event-6715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1962#issuecomment-13225",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1962#issuecomment-13226",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1962#issuecomment-13227",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1962",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1962#event-6716"
}
```
