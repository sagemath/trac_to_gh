...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11717"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11720"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11721"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.15",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11722"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11723"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11724"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11725"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11726"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1366",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11727"
}
```
...
```json
{
    ...
    "title_was": "speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11728"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11729"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11730"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11732"
}
```
...
```json
{
    ...
    "title_was": "speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11733"
}
```
...
```json
{
    ...
    "title_was": "[with negative review] speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11734"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11735"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11736"
}
```
...
```json
{
    ...
    "title_was": "[with updated patch] speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11737"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11740"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1366",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11741"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1366#issuecomment-6764",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
