...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13458"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13461"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13462"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13463"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.8.15",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13464"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13465"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13466"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13467"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1366",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13469"
}
```
...
```json
{
    ...
    "title_was": "speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13470"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13472"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13474"
}
```
...
```json
{
    ...
    "title_was": "speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13475"
}
```
...
```json
{
    ...
    "title_was": "[with negative review] speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13476"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13477"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13478"
}
```
...
```json
{
    ...
    "title_was": "[with updated patch] speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13482"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1366",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-13483"
}
```
