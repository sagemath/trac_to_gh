...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11638"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11641"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11643"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11644"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11645"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11646"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1366",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11648"
}
```
...
```json
{
    ...
    "title_was": "speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11649"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11650"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11651"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11652"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11653"
}
```
...
```json
{
    ...
    "title_was": "speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11654"
}
```
...
```json
{
    ...
    "title_was": "[with negative review] speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11655"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11656"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11657"
}
```
...
```json
{
    ...
    "title_was": "[with updated patch] speed up \"sage -br\" -- make it cache the dependency diagram instead of computing it every time",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11658"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1366",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1366#event-11662"
}
```
