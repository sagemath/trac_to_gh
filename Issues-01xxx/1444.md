...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1444/bzip2-1.0.4-install",
...
```json
{
    "body": "put this file in spkg/base/   overwriting the one there already.",
    "created_at": "2007-12-10T01:12:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1444",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1444#issuecomment-10020",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1444",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1444#issuecomment-10021",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1444",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1444#issuecomment-10022",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1444",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1444#event-4345"
}
```
