...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1970#issuecomment-13297",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1970#issuecomment-13298",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1970#issuecomment-13299",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with tiny patch; positive review] notebook -- gnutls should not be needed if you're running the notebook insecurely, so don't require it"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1970#event-6753"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1970#issuecomment-13300",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1970#issuecomment-13301",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1970",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1970#event-6754"
}
```
