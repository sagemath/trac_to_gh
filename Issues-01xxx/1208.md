...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1208#issuecomment-5726",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1208#issuecomment-5727",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "asset_name": "choose27112007.hg",
    "asset_url": "tarball://root/attachments/ticket1208/choose27112007.hg",
    "created_at": "2007-11-27T20:35:27Z",
    "issue": "https://github.com/sagemath/sage/issues/1208",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1208/choose27112007.hg",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1208",
    "rename": {
        "from": "Faster _choose in matrix2.py",
        "to": "(with patch bundle) Faster _choose in matrix2.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1208#event-5580"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1208#event-5581"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1208#event-5582"
}
```
...
archive/attachments_000880.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "newchoose.hg",
    "asset_url": "tarball://root/attachments/ticket1208/newchoose.hg",
    "created_at": "2007-11-29T15:44:40Z",
    "issue": "https://github.com/sagemath/sage/issues/1208",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1208/newchoose.hg",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    "body": "Attachment [newchoose.hg](https://github.com/sagemath/sage/files/ticket1208/newchoose.hg) by @jaapspies created at 2007-11-29 15:44:40",
    "created_at": "2007-11-29T15:44:40Z",
    "issue": "https://github.com/sagemath/sage/issues/1208",
    "type": "issue_comment",
...
Attachment [newchoose.hg](https://github.com/sagemath/sage/files/ticket1208/newchoose.hg) by @jaapspies created at 2007-11-29 15:44:40
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1208",
    "rename": {
        "from": "(with patch bundle) Faster _choose in matrix2.py",
        "to": "Faster _choose in matrix2.py"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1208#event-5583"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1208#event-5584"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1208#event-5585"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1208",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1208#event-5586"
}
```
