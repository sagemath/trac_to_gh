...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1990#issuecomment-10007",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1990#issuecomment-10008",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1990#issuecomment-10009",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1990/trac1990-zz-random-element.patch",
    "created_at": "2008-03-29T18:35:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1990",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1990/trac1990-zz-random-element.patch",
...
```json
{
    "body": "Attachment [trac1990-zz-random-element.patch](https://github.com/sagemath/sage/files/ticket1990/trac1990-zz-random-element.patch) by cwitty created at 2008-03-29 18:35:19",
    "created_at": "2008-03-29T18:35:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1990#issuecomment-10010",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

Attachment [trac1990-zz-random-element.patch](https://github.com/sagemath/sage/files/ticket1990/trac1990-zz-random-element.patch) by cwitty created at 2008-03-29 18:35:19
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1990#issuecomment-10011",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1990#issuecomment-10012",
