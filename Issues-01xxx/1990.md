# Issue 1990: [with positive review] ZZ.random_element() -- never returns 0 and typos/nonsense in docstrings
...
```json
{
    ...
    "title": "[with positive review] ZZ.random_element() -- never returns 0 and typos/nonsense in docstrings",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14048",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14049",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14050",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "asset_name": "trac1990-zz-random-element.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1990/trac1990-zz-random-element.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14051",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14052",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "rename": {
        "from": "ZZ.random_element() -- never returns 0 and typos/nonsense in docstrings",
        "to": "[with positive review] ZZ.random_element() -- never returns 0 and typos/nonsense in docstrings"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1990#event-5849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14053",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1990#event-5850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14054",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1990",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1990#issuecomment-14055",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1990#event-5851"
}
```
