...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1092#issuecomment-6918",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1092#issuecomment-6919",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] small memleaks exposed by ntl_ZZ_pE (from 2.8.12.alpha0)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1092#event-3685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1092#issuecomment-6920",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1092",
    "rename": {
        "from": "[with patch, needs review] small memleaks exposed by ntl_ZZ_pE (from 2.8.12.alpha0)",
        "to": "[with patch, with positive review] small memleaks exposed by ntl_ZZ_pE (from 2.8.12.alpha0)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1092#event-3686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1092#issuecomment-6921",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1092",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1092#issuecomment-6922",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1092",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1092#event-3687"
}
```
