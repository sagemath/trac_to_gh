...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1380#issuecomment-6829",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6443"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1380#issuecomment-6830",
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1380#issuecomment-6831",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6446"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6447"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1380/trac1380.patch",
    "created_at": "2007-12-18T21:09:00Z",
    "issue": "https://github.com/sagemath/sage/issues/1380",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1380/trac1380.patch",
...
```json
{
    "body": "<a id='comment:5'></a>\nAttachment [trac1380.patch](https://github.com/sagemath/sage/files/ticket1380/trac1380.patch) by @rlmill created at 2007-12-18 21:09:00",
    "created_at": "2007-12-18T21:09:00Z",
    "issue": "https://github.com/sagemath/sage/issues/1380",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6448"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1380",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1380#event-6450"
}
```
