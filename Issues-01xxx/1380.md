...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1380#issuecomment-9242",
    "user": "https://trac.sagemath.org/admin/accounts/users/jbmohler"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1380#issuecomment-9243",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1380#issuecomment-9244",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1380#event-4704"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1380#issuecomment-9245",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "rename": {
        "from": "subs in the MPolynomial_libsingular insists on taking things to QQ",
        "to": "[with patch] subs in the MPolynomial_libsingular insists on taking things to QQ"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1380#event-4705"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "rename": {
        "from": "[with patch] subs in the MPolynomial_libsingular insists on taking things to QQ",
        "to": "[with patch, positive review] subs in the MPolynomial_libsingular insists on taking things to QQ"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1380#event-4706"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1380#issuecomment-9246",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1380#issuecomment-9247",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1380",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1380#event-4707"
}
```
