# Issue 1716: [with positive review] add function log1p in mpfr interface
...
```json
{
    ...
    "title": "[with positive review] add function log1p in mpfr interface",
    "type": "issue",
...
```json
{
    ...
    "rename": {
        "from": "add function log1p in mpfr interface",
        "to": "[with positive review] add function log1p in mpfr interface"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1716#event-5019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1716#issuecomment-11744",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1716#issuecomment-11745",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1716",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1716#event-5020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1716",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1716#issuecomment-11746",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
