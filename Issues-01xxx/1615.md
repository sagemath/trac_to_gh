# Issue 1615: [with spkg, positive review] mpfi -- build is seriously broken on at least one system
...
```json
{
    ...
    "title": "[with spkg, positive review] mpfi -- build is seriously broken on at least one system",
    "type": "issue",
