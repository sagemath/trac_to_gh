...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1615#issuecomment-10711",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1615#issuecomment-10712",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1615#issuecomment-10713",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1615",
    "rename": {
        "from": "mpfi -- build is seriously broken on at least one system",
        "to": "[with spkg, needs review] mpfi -- build is seriously broken on at least one system"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1615#event-5481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1615",
    "rename": {
        "from": "[with spkg, needs review] mpfi -- build is seriously broken on at least one system",
        "to": "[with spkg, positive review] mpfi -- build is seriously broken on at least one system"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1615#event-5482"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1615",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1615#issuecomment-10714",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1615",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1615#event-5483"
}
```
