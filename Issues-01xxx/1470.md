...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1470#issuecomment-7307",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1470#issuecomment-7308",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "rename": {
        "from": "upgrade maxima.spkg to 5.14.0",
        "to": "[doctest fixes] upgrade maxima.spkg to 5.14.0"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6877"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6878"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6879"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6880"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "rename": {
        "from": "[doctest fixes] upgrade maxima.spkg to 5.14.0",
        "to": "upgrade maxima.spkg to 5.15.0"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6882"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6883"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "rename": {
        "from": "upgrade maxima.spkg to 5.15.0",
        "to": "upgrade maxima.spkg to 5.16.x"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6884"
}
```
...
```json
{
    ...
    "asset_name": "doc_1470.patch",
    "asset_url": "tarball://root/attachments/ticket1470/doc_1470.patch",
    "created_at": "2008-08-21T23:30:39Z",
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1470/doc_1470.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6885"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6886"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "rename": {
        "from": "upgrade maxima.spkg to 5.16.x",
        "to": "upgrade maxima.spkg to 5.16.2"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6887"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6888"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6889"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1470#event-6891"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "maxima-16.2-fix.patch",
    "asset_url": "tarball://root/attachments/ticket1470/maxima-16.2-fix.patch",
    "created_at": "2008-08-22T18:58:58Z",
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1470/maxima-16.2-fix.patch",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "**Attachment:** [maxima-16.2-fix.patch](https://github.com/sagemath/sage/files/ticket1470/maxima-16.2-fix.patch)",
    "created_at": "2008-08-22T18:58:58Z",
    "issue": "https://github.com/sagemath/sage/issues/1470",
    "type": "issue_comment",
...
**Attachment:** [maxima-16.2-fix.patch](https://github.com/sagemath/sage/files/ticket1470/maxima-16.2-fix.patch)
