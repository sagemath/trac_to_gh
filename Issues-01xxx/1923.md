...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1923#event-6529"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12698",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12699",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] Make an obvious checkbox or menu to switch on pretty printing in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1923#event-6530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12700",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12701",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "rename": {
        "from": "[with patch, needs review] Make an obvious checkbox or menu to switch on pretty printing in the notebook",
        "to": "[with patch, mostly positive review] Make an obvious checkbox or menu to switch on pretty printing in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1923#event-6531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12702",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12703",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "rename": {
        "from": "[with patch, mostly positive review] Make an obvious checkbox or menu to switch on pretty printing in the notebook",
        "to": "[with patch, positive review] Make an obvious checkbox or menu to switch on pretty printing in the notebook"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1923#event-6532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12704",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12705",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-12706",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1923#event-6533"
}
```
