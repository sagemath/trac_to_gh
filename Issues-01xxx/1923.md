...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13114",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13115",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13116",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>Attachment [prettyprint-checkbox.patch](tarball://root/attachments/some-uuid/ticket1923/prettyprint-checkbox.patch) by @jasongrout created at 2008-01-25 19:34:38",
    "created_at": "2008-01-25T19:34:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13117",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:3'></a>Attachment [prettyprint-checkbox.patch](tarball://root/attachments/some-uuid/ticket1923/prettyprint-checkbox.patch) by @jasongrout created at 2008-01-25 19:34:38
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13119",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>I think this should go into Sage as is.   More should be done at some point, but isn't needed now.  Already this is very useful (and I do use it now in fact!)",
    "created_at": "2008-01-29T12:30:40Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13121",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:6'></a>I think this should go into Sage as is.   More should be done at some point, but isn't needed now.  Already this is very useful (and I do use it now in fact!)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13122",
...
```json
{
    "body": "<a id='comment:7'></a>Merged prettyprint-checkbox-updated.patch in Sage 2.10.1.rc3",
    "created_at": "2008-01-29T12:38:20Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1923",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1923#issuecomment-13123",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:7'></a>Merged prettyprint-checkbox-updated.patch in Sage 2.10.1.rc3
