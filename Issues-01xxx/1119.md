...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [ell_gf2_random.patch](https://github.com/sagemath/sage/files/ticket1119/ell_gf2_random.patch)",
    "created_at": "2007-11-11T23:39:20Z",
    "issue": "https://github.com/sagemath/sage/issues/1119",
    "type": "issue_comment",
...
archive/attachments_000795.json:
```json
{
    "asset_content_type": "application/octet-stream",
