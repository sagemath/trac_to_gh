...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9066",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9067",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8683"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9068",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1862/implicit-plot.patch",
    "created_at": "2008-03-02T18:31:33Z",
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1862/implicit-plot.patch",
...
```json
{
    "body": "Attachment [implicit-plot.patch](https://github.com/sagemath/sage/files/ticket1862/implicit-plot.patch) by cwitty created at 2008-03-02 18:31:33",
    "created_at": "2008-03-02T18:31:33Z",
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9069",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```

Attachment [implicit-plot.patch](https://github.com/sagemath/sage/files/ticket1862/implicit-plot.patch) by cwitty created at 2008-03-02 18:31:33
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8684"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9070",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9071",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9072",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8686"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8687"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1862/1862.patch",
    "created_at": "2008-03-15T23:20:32Z",
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1862/1862.patch",
...
```json
{
    "body": "<a id='comment:10'></a>\nAttachment [1862.patch](https://github.com/sagemath/sage/files/ticket1862/1862.patch) by @mwhansen created at 2008-03-15 23:20:32\n\nI've put up a version of the patch ( 1862.patch ) rebased against 2.10.4.alpha0.  That's the one that should be applied.  Other than that, looks good to me.",
    "created_at": "2008-03-15T23:20:32Z",
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9073",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8688"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8689"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1862#issuecomment-9074",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1862",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1862#event-8691"
}
```
