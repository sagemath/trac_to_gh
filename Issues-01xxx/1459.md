...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1459#issuecomment-9821",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1459#issuecomment-9822",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "rename": {
        "from": "[with patch] make notebook ?? behavior like command line behavior",
        "to": "[with patch, negative review] make notebook ?? behavior like command line behavior"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1459#event-4982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "rename": {
        "from": "[with patch, negative review] make notebook ?? behavior like command line behavior",
        "to": "[with patch, needs new review] make notebook ?? behavior like command line behavior"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1459#event-4983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1459#issuecomment-9823",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1459#issuecomment-9824",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1459#event-4984"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1459#issuecomment-9825",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1459",
    "rename": {
        "from": "[with patch, needs new review] make notebook ?? behavior like command line behavior",
        "to": "[with patch, positive review] make notebook ?? behavior like command line behavior"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1459#event-4985"
}
```
