...
```json
{
    "body": "<a id='comment:15'></a>\nWe now have\n\n```\nsage: Ei(10)\nEi(10)\n```\nbut the rest aren't there yet...\n\nBut the problem is that this ticket is WAY too broad, at least in the current framework of how we deal with tickets.  We now have an entire [metapage on the wiki](../wikis/symbolics/functions) devoted to this topic!   Bessel J is #4102, log gamma is #10075, etc.  \n\nSo I recommend that this ticket be closed as far too broad (in retrospect - somehow it seemed easier two years ago!) and adequately replaced by a slew of tickets already opened.",
