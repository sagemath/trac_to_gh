...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1805/trac-1805.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1805/trac-1805-part2.patch",
...
```json
{
    "body": "this part 2 fixes some additional issues, typos, etc., I saw when proofreading my patch.",
    "created_at": "2008-01-17T21:47:11Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1805",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1805/sage-1805-part2-rebased.patch",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1805/sage-1805-rebase_part3.patch",
...
archive/attachments_001411.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "sage-1805-part4-make_ref_happy.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1805/sage-1805-part4-make_ref_happy.patch",
