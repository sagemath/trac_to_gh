...
```json
{
    "body": "<a id='comment:1'></a>This works now (3.1.3), so should be closed.",
...
<a id='comment:1'></a>This works now (3.1.3), so should be closed.
...
```json
{
    "body": "<a id='comment:2'></a>Closed due to fixes via other tickets. Thanks Jason.\n\nCheers,\n\nMichael",
    "created_at": "2008-10-18T09:05:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1860",
    "type": "issue_comment",
...
<a id='comment:2'></a>Closed due to fixes via other tickets. Thanks Jason.
