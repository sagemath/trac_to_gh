# Issue 1590: [with patch, positive review] notebook -- change it so changes are saved even in cells that aren't evaluated
...
```json
{
    ...
    "title": "[with patch, positive review] notebook -- change it so changes are saved even in cells that aren't evaluated",
    "type": "issue",
