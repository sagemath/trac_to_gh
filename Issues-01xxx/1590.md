...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1590#issuecomment-10556",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1590#event-5390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1590#issuecomment-10557",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] notebook -- change it so changes are saved even in cells that aren't evaluated"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1590#event-5391"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1590#issuecomment-10558",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1590",
    "rename": {
        "from": "[with patch, needs review] notebook -- change it so changes are saved even in cells that aren't evaluated",
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1590#event-5392"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1590#issuecomment-10559",
    "user": "https://trac.sagemath.org/admin/accounts/users/boothby"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, positive review] notebook -- change it so changes are saved even in cells that aren't evaluated"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1590#event-5393"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1590#issuecomment-10560",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1590",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1590#issuecomment-10561",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1590",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1590#event-5394"
}
```
