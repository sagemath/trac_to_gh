...
```json
{
    ...
    "rename": {
        ...
        "to": "[with trivial patch, needs review] Sage 2.10: qqbar numerical doctest failure"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1880#event-6363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1880#issuecomment-12388",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1880",
    "rename": {
        "from": "[with trivial patch, needs review] Sage 2.10: qqbar numerical doctest failure",
        "to": "[with trivial patch, positive review] Sage 2.10: qqbar numerical doctest failure"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1880#event-6364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1880#event-6365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1880#issuecomment-12389",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1880#issuecomment-12390",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
