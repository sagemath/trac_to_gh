...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1228#event-10417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1228#event-10418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1228#event-10419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1228#event-10420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1228#event-10421"
}
```
