...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9287",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9288",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9289",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9290",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>I just realized that a much better solution is to finish implementing immutable vectors and make the return of A[n] be an immutable row.  It accomplishes the same thing and is more usable.  So I did this.\n\nThat said, the above patch is fine -- using .row(...) all over in code is fine and faster.",
    "created_at": "2007-12-15T12:57:15Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9291",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:3'></a>I just realized that a much better solution is to finish implementing immutable vectors and make the return of A[n] be an immutable row.  It accomplishes the same thing and is more usable.  So I did this.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9292",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9293",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1401#issuecomment-9294",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
