...
```json
{
    ...
    "rename": {
        "from": "atlas-3.8.p4.spkg fails to build on Intel Core 2 Duo with 32-bit operating system",
        "to": "[with spkg] atlas-3.8.p4.spkg fails to build on Intel Core 2 Duo with 32-bit operating system"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1497#event-5116"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1497#issuecomment-10046",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1497#issuecomment-10047",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1497",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1497#event-5117"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1497#issuecomment-10048",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
