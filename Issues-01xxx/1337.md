...
```json
{
    "body": "**Attachment:** [1337.diff](https://github.com/sagemath/sage/files/ticket1337/1337.diff)",
    "created_at": "2008-01-18T02:41:38Z",
    "issue": "https://github.com/sagemath/sage/issues/1337",
    "type": "issue_comment",
...
**Attachment:** [1337.diff](https://github.com/sagemath/sage/files/ticket1337/1337.diff)
...
```json
{
    "body": "<a id='comment:9'></a>\n**Attachment:** [integers.pyx.patch](https://github.com/sagemath/sage/files/ticket1337/integers.pyx.patch)",
    "created_at": "2008-02-27T08:22:51Z",
    "issue": "https://github.com/sagemath/sage/issues/1337",
    "type": "issue_comment",
...
```json
{
    "body": "**Attachment:** [integer.pyx.patch](https://github.com/sagemath/sage/files/ticket1337/integer.pyx.patch)\n\nFixed doctest issues",
    "created_at": "2008-02-27T10:13:17Z",
    "issue": "https://github.com/sagemath/sage/issues/1337",
    "type": "issue_comment",
...
**Attachment:** [integer.pyx.patch](https://github.com/sagemath/sage/files/ticket1337/integer.pyx.patch)
...
```json
{
    "body": "**Attachment:** [trac_1337.patch](https://github.com/sagemath/sage/files/ticket1337/trac_1337.patch)\n\ndouble free fix (needs test all)",
    "created_at": "2008-03-09T01:12:14Z",
    "issue": "https://github.com/sagemath/sage/issues/1337",
    "type": "issue_comment",
...
**Attachment:** [trac_1337.patch](https://github.com/sagemath/sage/files/ticket1337/trac_1337.patch)
...
archive/attachments_001047.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_1337-workaround.patch](https://github.com/sagemath/sage/files/ticket1337/trac_1337-workaround.patch)\n\nThis patch introduces a workaround - but that causes leaks if the integer pool is exhausted",
    "created_at": "2008-03-09T05:04:30Z",
    "issue": "https://github.com/sagemath/sage/issues/1337",
    "type": "issue_comment",
...
**Attachment:** [trac_1337-workaround.patch](https://github.com/sagemath/sage/files/ticket1337/trac_1337-workaround.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1337#issuecomment-6615",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1337#issuecomment-6616",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
