...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8792",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8793",
...
```json
{
    "body": "<a id='comment:3'></a>The new version of Cython handle tp_new in a more efficient manner, try applying the above patch. \n\n(In any case this should be applied to SAGE even if it doesn't fix the issue.)",
    "created_at": "2008-01-18T02:42:21Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8794",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:3'></a>The new version of Cython handle tp_new in a more efficient manner, try applying the above patch. 
...
```json
{
    "body": "<a id='comment:4'></a>Applying the patch and rebuilding all of Sage with the latest Cython (see #1801) does *not* solve the issue.\n\nCheers,\n\nMichael",
    "created_at": "2008-01-18T06:41:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8795",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Applying the patch and rebuilding all of Sage with the latest Cython (see #1801) does *not* solve the issue.
...
```json
{
    "body": "<a id='comment:5'></a>I merged 1337.diff into Sage 2.10.1.alpha1. Last time I checked it didn't fix the original problem, so stay tuned.\n\nCheers,\n\nMichael",
    "created_at": "2008-01-22T03:37:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8796",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:5'></a>I merged 1337.diff into Sage 2.10.1.alpha1. Last time I checked it didn't fix the original problem, so stay tuned.
...
```json
{
    "body": "<a id='comment:7'></a>The presence, or absence, of this patch should not impact an error like this--are you sure it is due to this patch (and not some non-deterministic thing)?",
    "created_at": "2008-01-22T07:01:55Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8798",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:7'></a>The presence, or absence, of this patch should not impact an error like this--are you sure it is due to this patch (and not some non-deterministic thing)?
...
```json
{
    "body": "<a id='comment:8'></a>I am attaching a patch that should fix the issue, as the elements of the structure used by the integers were in the wrong order, but I don't have a easy way to reproduce this, so testing would be appreciated.",
    "created_at": "2008-02-27T08:01:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8799",
    "user": "https://github.com/garyfurnish"
}
```

<a id='comment:8'></a>I am attaching a patch that should fix the issue, as the elements of the structure used by the integers were in the wrong order, but I don't have a easy way to reproduce this, so testing would be appreciated.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8800",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8801",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8802",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>Attachment [integers.pyx.patch](tarball://root/attachments/some-uuid/ticket1337/integers.pyx.patch) by mabshoff created at 2008-02-27 08:22:51",
    "created_at": "2008-02-27T08:22:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8803",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:9'></a>Attachment [integers.pyx.patch](tarball://root/attachments/some-uuid/ticket1337/integers.pyx.patch) by mabshoff created at 2008-02-27 08:22:51
...
```json
{
    "body": "<a id='comment:10'></a>The ZZ constructor breaks in the case of x=NULL because it was relying on broken code, patch coming up as soon as it make checks.",
    "created_at": "2008-02-27T08:40:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8804",
    "user": "https://github.com/garyfurnish"
}
```

<a id='comment:10'></a>The ZZ constructor breaks in the case of x=NULL because it was relying on broken code, patch coming up as soon as it make checks.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8805",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>The last patch correctly solves all issues, and needs testing.  (Ignore the first one).",
    "created_at": "2008-02-27T10:14:18Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8806",
    "user": "https://github.com/garyfurnish"
}
```

<a id='comment:11'></a>The last patch correctly solves all issues, and needs testing.  (Ignore the first one).
...
```json
{
    "body": "<a id='comment:12'></a>It looks good to me, though I haven't ever been able to reproduce the error so someone else needs to test it. \n\n1337.diff should be applied (though it doesn't fix the bug, but it simplifies things)\n\nintegers.pyx.patch should NOT be applied (or returned integers might not have value 0)\n\ninteger.pyx.patch should be applied.",
    "created_at": "2008-02-29T09:05:00Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8807",
    "user": "https://github.com/robertwb"
}
```

<a id='comment:12'></a>It looks good to me, though I haven't ever been able to reproduce the error so someone else needs to test it. 
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>Move integer.pyx.patch and structure fix to 2363.",
    "created_at": "2008-03-01T20:29:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8809",
    "user": "https://github.com/garyfurnish"
}
```

<a id='comment:14'></a>Move integer.pyx.patch and structure fix to 2363.
...
```json
{
    "body": "<a id='comment:15'></a>Robert: Can you open another ticket for the 1337.diff patch, so that it can be reviewed. Or do you think it resolves this issue?\n\nSince Gary moved integer.pyx.patch to #2363 and you gave it a positive review I transferred the positive review there, merged it and then closed the ticket.\n\nCheers,\n\nMichael",
    "created_at": "2008-03-01T22:46:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8810",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:15'></a>Robert: Can you open another ticket for the 1337.diff patch, so that it can be reviewed. Or do you think it resolves this issue?
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8811",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8812",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:17'></a>Rubber stamp positive review",
    "created_at": "2008-03-09T05:30:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8813",
    "user": "https://github.com/garyfurnish"
}
```

<a id='comment:17'></a>Rubber stamp positive review
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8814",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Merged trac_1337-workaround.patch in Sage 2.10.3.rc3. The fix is a workaround, that trades a segfault for a small leak. This will be dealt with at #2435.",
    "created_at": "2008-03-09T05:33:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1337#issuecomment-8815",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:19'></a>Merged trac_1337-workaround.patch in Sage 2.10.3.rc3. The fix is a workaround, that trades a segfault for a small leak. This will be dealt with at #2435.
