...
```json
{
    "body": "<a id='comment:3'></a>Oops, 2.3.21 is the version that is currently in the repo.",
    "created_at": "2008-01-21T23:25:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12800",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>Oops, 2.3.21 is the version that is currently in the repo.
...
```json
{
    "body": "<a id='comment:5'></a>Unfortunately it looks like the Mac Intel version is broken, so this should not be included.  I am corresponding with Jan Verschelde (the creator of phcpack) to figure out what is going on.",
    "created_at": "2008-01-22T01:53:28Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12801",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:5'></a>Unfortunately it looks like the Mac Intel version is broken, so this should not be included.  I am corresponding with Jan Verschelde (the creator of phcpack) to figure out what is going on.
...
```json
{
    "body": "<a id='comment:7'></a>I have changed the install file so that, as before, intel macs will run the ppc version (through rosetta).  This makes the update much less exciting but it actually works.",
    "created_at": "2008-01-22T13:20:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12802",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:7'></a>I have changed the install file so that, as before, intel macs will run the ppc version (through rosetta).  This makes the update much less exciting but it actually works.
...
```json
{
    "body": "<a id='comment:9'></a>Sorry I should have previewed.  Interface file is at:\n\n[http://www.d.umn.edu/~mhampton/phc.py](http://www.d.umn.edu/~mhampton/phc.py)\n\nand the spkg is at\n\n[http://www.d.umn.edu/~mhampton/phc-2.3.38.spkg](http://www.d.umn.edu/~mhampton/phc-2.3.38.spkg)",
    "created_at": "2008-02-24T17:53:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12804",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:9'></a>Sorry I should have previewed.  Interface file is at:
...
```json
{
    "body": "<a id='comment:10'></a>I changed the patch so that the Integer type is imported; the previous one had a bug. I am actively using this for a research project so it should get some more stress testing this week.",
    "created_at": "2008-02-26T00:24:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12805",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:10'></a>I changed the patch so that the Integer type is imported; the previous one had a bug. I am actively using this for a research project so it should get some more stress testing this week.
...
```json
{
    "body": "<a id='comment:11'></a>Fixed a bug that affected larger problems, added optional tag to doctests - I assume that causes them to be skipped usually.",
    "created_at": "2008-02-27T00:38:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:11'></a>Fixed a bug that affected larger problems, added optional tag to doctests - I assume that causes them to be skipped usually.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12807",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12808",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12810",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:15'></a>The file phc.py at http://www.d.umn.edu/~mhampton/phc.py has been changed to address the review comments.  I have updated the spkg to try to remove the superfluous OS X files.",
    "created_at": "2008-03-18T18:14:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12811",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:15'></a>The file phc.py at http://www.d.umn.edu/~mhampton/phc.py has been changed to address the review comments.  I have updated the spkg to try to remove the superfluous OS X files.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12812",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>I just noticed that Jan released another version, so I have updated to that and fixed a bug in my spkg-install script.  The new spkg is at:\n\nhttp://www.d.umn.edu/~mhampton/phc-2.3.39.spkg\n\n[with experimental spkg]",
    "created_at": "2008-03-20T19:24:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12813",
    "user": "https://trac.sagemath.org/admin/accounts/users/mhampton"
}
```

<a id='comment:16'></a>I just noticed that Jan released another version, so I have updated to that and fixed a bug in my spkg-install script.  The new spkg is at:
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12814",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12817",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:19'></a>Merged in Sage 2.11.rc0",
    "created_at": "2008-03-29T15:40:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1882#issuecomment-12818",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:19'></a>Merged in Sage 2.11.rc0
