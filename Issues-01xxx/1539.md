...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1539#issuecomment-10267",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1539#issuecomment-10268",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1539",
    "rename": {
        "from": "bdist of sage should include devel/doc",
        "to": "[with patch; needs review] bdist of sage should include devel/doc"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1539#event-5237"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1539#issuecomment-10269",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1539",
    "rename": {
        "from": "[with patch; needs review] bdist of sage should include devel/doc",
        "to": "[with patch; positive review] bdist of sage should include devel/doc"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1539#event-5238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1539",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1539#event-5239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1539#issuecomment-10270",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1539#issuecomment-10271",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
