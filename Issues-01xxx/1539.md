...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1539#issuecomment-7579",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1539/scripts-1539.patch",
    "created_at": "2008-08-26T09:16:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1539",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1539/scripts-1539.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "Attachment [scripts-1539.patch](https://github.com/sagemath/sage/files/ticket1539/scripts-1539.patch) by @williamstein created at 2008-08-26 09:16:19",
    "created_at": "2008-08-26T09:16:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1539#issuecomment-7580",
    "user": "https://github.com/williamstein"
}
```

Attachment [scripts-1539.patch](https://github.com/sagemath/sage/files/ticket1539/scripts-1539.patch) by @williamstein created at 2008-08-26 09:16:19
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1539#issuecomment-7581",
