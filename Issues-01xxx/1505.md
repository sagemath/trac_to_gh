...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1505#issuecomment-7448",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "Attachment [removing_m4ri.patch](https://github.com/sagemath/sage/files/ticket1505/removing_m4ri.patch) by @malb created at 2007-12-16 15:03:16",
    "created_at": "2007-12-16T15:03:16Z",
    "issue": "https://github.com/sagemath/sage/issues/1505",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1505#issuecomment-7449",
    "user": "https://github.com/malb"
}
```

Attachment [removing_m4ri.patch](https://github.com/sagemath/sage/files/ticket1505/removing_m4ri.patch) by @malb created at 2007-12-16 15:03:16
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1505",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1505#issuecomment-7450",
    "user": "https://github.com/malb"
}
```
