...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1136/weirstrass.hg",
    "created_at": "2007-11-09T23:44:47Z",
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1136/weirstrass.hg",
    "user": "https://github.com/bobmoretti"
}
```
...
```json
{
    "body": "Attachment [weirstrass.hg](https://github.com/sagemath/sage/files/ticket1136/weirstrass.hg) by @bobmoretti created at 2007-11-09 23:44:47\n\npatch for weierstrass normal form transform code",
    "created_at": "2007-11-09T23:44:47Z",
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1136#issuecomment-5232",
    "user": "https://github.com/bobmoretti"
}
```

Attachment [weirstrass.hg](https://github.com/sagemath/sage/files/ticket1136/weirstrass.hg) by @bobmoretti created at 2007-11-09 23:44:47
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1136#event-5227"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1136#issuecomment-5233",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1136/libsingular-singsegv.patch",
    "created_at": "2007-11-11T20:59:08Z",
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1136/libsingular-singsegv.patch",
...
```json
{
    "body": "Attachment [libsingular-singsegv.patch](https://github.com/sagemath/sage/files/ticket1136/libsingular-singsegv.patch) by @malb created at 2007-11-11 20:59:08",
    "created_at": "2007-11-11T20:59:08Z",
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1136#issuecomment-5234",
    "user": "https://github.com/malb"
}
```

Attachment [libsingular-singsegv.patch](https://github.com/sagemath/sage/files/ticket1136/libsingular-singsegv.patch) by @malb created at 2007-11-11 20:59:08
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1136#issuecomment-5235",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1136#event-5228"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1136#event-5229"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1136#issuecomment-5236",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1136#event-5230"
}
```
