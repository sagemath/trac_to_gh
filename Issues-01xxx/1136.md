...
```json
{
    "body": "**Attachment:** [weirstrass.hg](https://github.com/sagemath/sage/files/ticket1136/weirstrass.hg)\n\npatch for weierstrass normal form transform code",
    "created_at": "2007-11-09T23:44:47Z",
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
...
**Attachment:** [weirstrass.hg](https://github.com/sagemath/sage/files/ticket1136/weirstrass.hg)
...
archive/attachments_000819.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [libsingular-singsegv.patch](https://github.com/sagemath/sage/files/ticket1136/libsingular-singsegv.patch)",
    "created_at": "2007-11-11T20:59:08Z",
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
...
**Attachment:** [libsingular-singsegv.patch](https://github.com/sagemath/sage/files/ticket1136/libsingular-singsegv.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1136#issuecomment-5237",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1136",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1136#issuecomment-5238",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
