# Issue 1122: [with patch] error in libsingular -> givaro conversion for finite extension fields
...
```json
{
    ...
    "title": "[with patch] error in libsingular -> givaro conversion for finite extension fields",
    "type": "issue",
