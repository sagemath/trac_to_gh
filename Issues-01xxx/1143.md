...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1143#issuecomment-7253",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1143",
    "rename": {
        "from": "[with patch] improve nintegrate documentation in response to Paul Zimmerman's talk",
        "to": "[with patch -- DO NOT APPLY] improve nintegrate documentation in response to Paul Zimmerman's talk"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1143#event-3869"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1143#issuecomment-7254",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1143#issuecomment-7255",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1143#issuecomment-7256",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1143",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1143#event-3870"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1143#issuecomment-7257",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] improve nintegrate documentation in response to Paul Zimmerman's talk"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1143#event-3871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1143",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1143#issuecomment-7258",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
