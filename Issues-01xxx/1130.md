# Issue 1130: [with positive review] point counting for elliptic curves over non-prime finite fields
...
```json
{
    ...
    "title": "[with positive review] point counting for elliptic curves over non-prime finite fields",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1130/ell_bsgs.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7332",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1130#event-3384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7333",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7334",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7335",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7336",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7337",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7338",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1130#event-3385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7339",
    "user": "https://github.com/JohnCremona"
}
```
...
archive/attachments_000787.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "8311.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1130/8311.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7340",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1130#event-3386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7341",
...
archive/attachments_000788.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "1130-ncalexan-cleaning-1.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1130/1130-ncalexan-cleaning-1.hg",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7342",
    "user": "https://github.com/ncalexan"
}
```
...
archive/attachments_000789.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "8312.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1130/8312.patch",
...
```json
{
    "body": "addition minor fixes",
    "created_at": "2008-02-16T20:26:41Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7343",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7344",
    "user": "https://github.com/JohnCremona"
}
```
...
archive/attachments_000790.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "1130-jcremona-ncalexan-final.hg",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1130/1130-jcremona-ncalexan-final.hg",
...
```json
{
    "body": "This bundle should apply to a clean sage-2.10.2.alpha0 and supersedes everything but malb's bsgs code, which is not ready for application.",
    "created_at": "2008-02-16T21:25:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7345",
    "user": "https://github.com/ncalexan"
}
```
...
archive/attachments_000791.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "1130-jcremona-ncalexan-final.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1130/1130-jcremona-ncalexan-final.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7346",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] point counting for elliptic curves over non-prime finite fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1130#event-3387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7347",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1130#event-3388"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1130#issuecomment-7348",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
