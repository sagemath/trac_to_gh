...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8005",
...
```json
{
    "body": "<a id='comment:1'></a>It seems like one would first have to add matsolvemod as a method in the gen class. (Or use the interface...).",
    "created_at": "2013-03-30T18:54:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8006",
    "user": "https://github.com/rharron"
}
```

<a id='comment:1'></a>It seems like one would first have to add matsolvemod as a method in the gen class. (Or use the interface...).
...
```json
{
    "body": "<a id='comment:2'></a>I've added http://trac.sagemath.org/sage_trac/ticket/14391 so that one can access matsolvemod through the C-library interface. However, I now remember William telling me you can solve equations in **Z**/n**Z** using the code he wrote for finitely generated modular over a PID. And you can. It would be nice to use that implementation for A.solve_right.\n\nReplying to [robharron](#comment%3A1):\n> It seems like one would first have to add matsolvemod as a method in the gen class. (Or use the interface...).",
    "created_at": "2013-03-31T01:35:17Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8007",
    "user": "https://github.com/rharron"
}
```

<a id='comment:2'></a>I've added http://trac.sagemath.org/sage_trac/ticket/14391 so that one can access matsolvemod through the C-library interface. However, I now remember William telling me you can solve equations in **Z**/n**Z** using the code he wrote for finitely generated modular over a PID. And you can. It would be nice to use that implementation for A.solve_right.
...
```json
{
    "body": "<a id='comment:3'></a>Okay, I've written a patch for this! Using pari is significantly faster than using the f.g. modules over a PID code, so the patch depends on #14391. This patch applies onto sage 5.8 and all doctests passed (using --testall --long).",
    "created_at": "2013-04-02T04:05:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8008",
    "user": "https://github.com/rharron"
}
```

<a id='comment:3'></a>Okay, I've written a patch for this! Using pari is significantly faster than using the f.g. modules over a PID code, so the patch depends on #14391. This patch applies onto sage 5.8 and all doctests passed (using --testall --long).
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8009",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8010",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    "body": "Changing dependencies from \"\" to \"#14391\"",
    "created_at": "2013-04-02T04:28:22Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8011",
    "user": "https://github.com/rharron"
}
```

Changing dependencies from "" to "#14391"
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8012",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8013",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>Can you post some timings comparing the two approaches (I am curious about larger dimensions & bitsizes)? The patch itself looks fine to me.",
    "created_at": "2013-04-02T11:32:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8014",
    "user": "https://github.com/malb"
}
```

<a id='comment:5'></a>Can you post some timings comparing the two approaches (I am curious about larger dimensions & bitsizes)? The patch itself looks fine to me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8016",
    "user": "https://github.com/rharron"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>Attachment [solve_left_slow_snippet.py](tarball://root/attachments/some-uuid/ticket1191/solve_left_slow_snippet.py) by @malb created at 2013-04-02 18:33:50\n\nOkay, that convinces me.",
    "created_at": "2013-04-02T18:33:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8017",
    "user": "https://github.com/malb"
}
```

<a id='comment:7'></a>Attachment [solve_left_slow_snippet.py](tarball://root/attachments/some-uuid/ticket1191/solve_left_slow_snippet.py) by @malb created at 2013-04-02 18:33:50
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8018",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8019",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8020",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1191#issuecomment-8021",
    "user": "https://github.com/jdemeyer"
}
```
