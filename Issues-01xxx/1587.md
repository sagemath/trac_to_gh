...
```json
{
    "body": "<a id='comment:3'></a>I believe this has been fixes by introducing the right and left kernel. \n\nAlex: If you agree please close the ticket.\n\nCheers,\n\nMichael",
...
<a id='comment:3'></a>I believe this has been fixes by introducing the right and left kernel. 
...
```json
{
    "body": "<a id='comment:4'></a>Yes, this is in much better shape now, thanks to #2542.\n\n(And I get to close a ticket, how exciting! :)",
...
<a id='comment:4'></a>Yes, this is in much better shape now, thanks to #2542.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10889",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The documentation for kernel? is still wrong.",
    "created_at": "2008-11-30T20:30:44Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10890",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:6'></a>The documentation for kernel? is still wrong.
...
```json
{
    "body": "<a id='comment:8'></a>If it's all right, wstein, I'd like to make this part of my linear algebra overhaul over Christmas break, so I'm accepting this ticket.",
    "created_at": "2008-12-13T16:52:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10891",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:8'></a>If it's all right, wstein, I'd like to make this part of my linear algebra overhaul over Christmas break, so I'm accepting this ticket.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10892",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10893",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>If you're doing a linear algebra overhaul, please see ticket #5009 for another left/right issue, and see #5001 for another kernel issue.",
    "created_at": "2009-01-18T06:34:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10894",
    "user": "https://github.com/jhpalmieri"
}
```

<a id='comment:9'></a>If you're doing a linear algebra overhaul, please see ticket #5009 for another left/right issue, and see #5001 for another kernel issue.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10895",
...
```json
{
    "body": "<a id='comment:10'></a>Attachment [kernel_doc.patch](tarball://root/attachments/some-uuid/ticket1587/kernel_doc.patch) by @simon-king-jena created at 2009-01-23 21:39:02\n\nI added some words and some examples (including corner cases) to the function `kernel` in `sage/misc/functional.py` and to the `kernel` method in `sage/matrix/matrix_rational_dense.py`. \n\nSince the examples of the `kernel` method for dense integer matrices and for sparse matrices are clear enough, I believe that my patch suffices to clearify the documentation of `kernel`.",
    "created_at": "2009-01-23T21:39:02Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10896",
    "user": "https://github.com/simon-king-jena"
}
```

<a id='comment:10'></a>Attachment [kernel_doc.patch](tarball://root/attachments/some-uuid/ticket1587/kernel_doc.patch) by @simon-king-jena created at 2009-01-23 21:39:02
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10897",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>Merged in Sage 3.3.alpha2.\n\nCheers,\n\nMichael",
    "created_at": "2009-01-25T02:20:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10898",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:12'></a>Merged in Sage 3.3.alpha2.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1587",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1587#issuecomment-10899",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
