...
```json
{
    ...
    "rename": {
        "from": "doctest: fix shapes.pyx fallout from #1666",
        "to": "[with patch] doctest: fix shapes.pyx fallout from #1666"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1671#event-5648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1671#issuecomment-11062",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1671",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1671#event-5649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1671#issuecomment-11063",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
