...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1671#issuecomment-10897",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>Attachment [Sage-2.9.2-remove-debug-output.patch](tarball://root/attachments/some-uuid/ticket1671/Sage-2.9.2-remove-debug-output.patch) by mabshoff created at 2008-01-03 17:27:58\n\nApplied to 2.9.2.alpha0.",
    "created_at": "2008-01-03T17:27:58Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1671#issuecomment-10898",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>Attachment [Sage-2.9.2-remove-debug-output.patch](tarball://root/attachments/some-uuid/ticket1671/Sage-2.9.2-remove-debug-output.patch) by mabshoff created at 2008-01-03 17:27:58
