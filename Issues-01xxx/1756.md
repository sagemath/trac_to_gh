...
```json
{
    "body": "<a id='comment:1'></a>Singular's Hilbert series has overflow issues in certain situations. Let me digg out some email about a test case and report this to the Singular team.\n\nCheers,\n\nMichael",
...
<a id='comment:1'></a>Singular's Hilbert series has overflow issues in certain situations. Let me digg out some email about a test case and report this to the Singular team.
...
```json
{
    "body": "<a id='comment:2'></a>See #1793 for a patch, copying mabshoff's comment over to that ticket now and closing this as dupe.",
...
<a id='comment:2'></a>See #1793 for a patch, copying mabshoff's comment over to that ticket now and closing this as dupe.
