...
```json
{
    "body": "<a id='comment:2'></a>This should be available now with #5448, but this ticket would now be to expose that functionality from matplotlib.",
...
<a id='comment:2'></a>This should be available now with #5448, but this ticket would now be to expose that functionality from matplotlib.
...
<a id='comment:3'></a>Attachment [formatter.patch](tarball://root/attachments/some-uuid/ticket1431/formatter.patch) by @jasongrout created at 2009-11-12 00:17:34
...
```json
{
    "body": "<a id='comment:5'></a>This looks like a great start.  Now we need a wrapper to make creating the formatters and locators easy for the average user.  I will try to help with that, and documentation, as I get a chance.  Thanks!",
...
<a id='comment:5'></a>This looks like a great start.  Now we need a wrapper to make creating the formatters and locators easy for the average user.  I will try to help with that, and documentation, as I get a chance.  Thanks!
...
```json
{
    "body": "<a id='comment:6'></a>Personally, I think creating formatters and locators *is* easy.  Notice what I did to create the locator: `MultipleLocator(float(pi/3))`.  The formatter is slightly harder because it's a harder problem I was trying to solve---given a floating point number, find a nice multiple of pi expression for a label.  In general, though, it's easy to just give a list of tick values and strings.\n\nWhat did you have in mind for an easier wrapper?",
    "created_at": "2009-11-12T03:36:05Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9963",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>A simpler example:\n\n```\ndef multiple_of_pi(n,pos):\n    m = n*1.0/float(pi)\n    c=[i for i in convergents(m) if i.denominator()<12]\n    q=c[-1]\n    return '$%s$'%latex(q*pi)\n\nfrom matplotlib.ticker import MultipleLocator, FuncFormatter\nplot(sin(x), (x, -4, 4), tick_locator=MultipleLocator(float(pi/4)), tick_formatter=FuncFormatter(multiple_of_pi))\n\n```",
    "created_at": "2009-11-12T03:45:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9964",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:7'></a>A simpler example:
...
```json
{
    "body": "<a id='comment:8'></a>See #4529 for a related ticket---logarithmic scales.",
    "created_at": "2009-11-12T04:13:32Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9965",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:8'></a>See #4529 for a related ticket---logarithmic scales.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9967",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9968",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9969",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9972",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9974",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:14'></a>I'm putting this as needs_work while we flush out a nice design.",
    "created_at": "2009-11-12T17:46:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9975",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:14'></a>I'm putting this as needs_work while we flush out a nice design.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9976",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9978",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:16'></a>Okay, I've finally had time to return to this, and I'm almost done dealing with this.  It is actually really cool!\n\nFormatting by multiples of constants (or numbers) will be implemented, as well as locating by arbitrary lists.  Note that \n\n```\n    ``LogLocator``\n       logarithmically ticks from min to max\n```\ncould solve our log problems, though I think that would not belong on this ticket (and I think there is one for this).",
    "created_at": "2010-04-20T17:41:34Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9979",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:16'></a>Okay, I've finally had time to return to this, and I'm almost done dealing with this.  It is actually really cool!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9980",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9981",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9982",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9984",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9985",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:22'></a>Okay, I've fixed all of these things.  Note that Mma only includes major ticks for lists of ticks, so I just went with that (much easier!).  The latex thing was annoying - there was a bug in sage.misc.latex.str_function:\n\n```\nsage: sage.misc.latex.str_function('4')\n'4'\nsage: sage.misc.latex.str_function('4.0')\n'\\\\texttt{4.0}'\n```\nAt least I view this as a bug, and in any case it prevents the latexing from working properly even if the tick_locator had [0,1.0,e] rather than [0,1,e].  Unified patch coming up.",
    "created_at": "2010-04-21T03:20:42Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9987",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:22'></a>Okay, I've fixed all of these things.  Note that Mma only includes major ticks for lists of ticks, so I just went with that (much easier!).  The latex thing was annoying - there was a bug in sage.misc.latex.str_function:
...
```json
{
    "body": "<a id='comment:23'></a>Apply only ticks, formatting, and latex patch.",
    "created_at": "2010-04-21T03:27:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9988",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:23'></a>Apply only ticks, formatting, and latex patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9989",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9990",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:24'></a>Very nice now!\u00a0 One last thing that I saw: the examples for _multiple_... still have the problem of halfof the ticks being in latex and the other half not.\u00a0 For example, plot(x!^2, (x, -2, 2), tick_formatter=pi) has the vertical labels in the standard font and the horizontal labels in tex.",
    "created_at": "2010-04-21T03:40:29Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9991",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:24'></a>Very nice now!  One last thing that I saw: the examples for _multiple_... still have the problem of halfof the ticks being in latex and the other half not.  For example, plot(x!^2, (x, -2, 2), tick_formatter=pi) has the vertical labels in the standard font and the horizontal labels in tex.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9992",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:26'></a>Thanks for all the work on this ticket.  I'm helping my wife with a final project for an environmental science class (involving measuring \"smog\"), and not having tick control is devastating.   Finally, for the first time, I personally really need this capability :-)\n\nAnother killer is not have a legend.  Is that also easy to add via something similar?  (Probably.)",
    "created_at": "2010-05-18T05:28:46Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9993",
    "user": "https://github.com/williamstein"
}
```

<a id='comment:26'></a>Thanks for all the work on this ticket.  I'm helping my wife with a final project for an environmental science class (involving measuring "smog"), and not having tick control is devastating.   Finally, for the first time, I personally really need this capability :-)
...
```json
{
    "body": "<a id='comment:27'></a>Replying to [was](#comment%3A26):\n\n> Another killer is not have a legend.  Is that also easy to add via something similar?  (Probably.)\n\n\nSee #4342",
    "created_at": "2010-05-18T05:31:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9994",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:27'></a>Replying to [was](#comment%3A26):
...
```json
{
    "body": "<a id='comment:28'></a>Of course, you can also always use straight matplotlib to do these things right now.",
    "created_at": "2010-05-18T05:33:25Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9995",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:28'></a>Of course, you can also always use straight matplotlib to do these things right now.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-9997",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-10001",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:34'></a>Attachment [trac_1431-ticks-and-formatting-and-latex.patch](tarball://root/attachments/some-uuid/ticket1431/trac_1431-ticks-and-formatting-and-latex.patch) by @kcrisman created at 2010-05-25 18:46:48\n\nNeeds review.  Notice that for some reason it kept the old message - but this latest one is based on 4.4.2, no worries :-)",
    "created_at": "2010-05-25T18:46:48Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-10002",
    "user": "https://github.com/kcrisman"
}
```

<a id='comment:34'></a>Attachment [trac_1431-ticks-and-formatting-and-latex.patch](tarball://root/attachments/some-uuid/ticket1431/trac_1431-ticks-and-formatting-and-latex.patch) by @kcrisman created at 2010-05-25 18:46:48
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-10003",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:35'></a>Looks great, applies to 4.5.2, and doctests pass in changed files.  Great job!",
    "created_at": "2010-09-03T22:06:49Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-10004",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:35'></a>Looks great, applies to 4.5.2, and doctests pass in changed files.  Great job!
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-10005",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-10006",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1431#issuecomment-10007",
    "user": "https://github.com/qed777"
}
```
