...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1601#event-5428"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with proto patch, needs review] issue with noclobber and building sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1601#event-5429"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1601#issuecomment-10608",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1601#issuecomment-10609",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1601#issuecomment-10610",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "rename": {
        "from": "[with proto patch, needs review] issue with noclobber and building sage",
        "to": "[with patch, needs easy review] issue with noclobber and building sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1601#event-5430"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1601#issuecomment-10611",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "rename": {
        "from": "[with patch, needs easy review] issue with noclobber and building sage",
        "to": "[with patch, positive review] issue with noclobber and building sage"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1601#event-5431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1601#event-5432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1601#issuecomment-10612",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1601",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1601#issuecomment-10613",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
