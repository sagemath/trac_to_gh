...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15540"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15542"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15543"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15544"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7304",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7305",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15548"
}
```
...
```json
{
    ...
    "title_was": "Make polynomial .diff() accept optional argument times for repeated differentiation.",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7306",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15551"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7307",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7308",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7309",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7310",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15552"
}
```
...
```json
{
    ...
    "subject": "https://github.com/malb",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7311",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7312",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7313",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7314",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7315",
    "user": "https://github.com/sagetrac-dmharvey"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15558"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1578#issuecomment-7316",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1578#event-15559"
}
```
