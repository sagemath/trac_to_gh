...
```json
{
    "body": "**Attachment:** [ncalexan-mpoly-diff-times-updated.patch](https://github.com/sagemath/sage/files/ticket1578/ncalexan-mpoly-diff-times-updated.patch)\n\nThis should be the final version; use this over the two earlier bundles and one earlier patch.",
    "created_at": "2008-01-13T02:01:27Z",
    "issue": "https://github.com/sagemath/sage/issues/1578",
    "type": "issue_comment",
...
**Attachment:** [ncalexan-mpoly-diff-times-updated.patch](https://github.com/sagemath/sage/files/ticket1578/ncalexan-mpoly-diff-times-updated.patch)
