...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1740#issuecomment-11455",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1740#issuecomment-11456",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1740",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1740#event-5850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1740#issuecomment-11457",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1740",
    "rename": {
        "from": "Fix Pentium M detection for ATLAS BLAS",
        "to": "[with spkg] Fix Pentium M detection for ATLAS BLAS"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1740#event-5851"
}
```
