...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1783#issuecomment-11753",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] fix latex errors with fraction field elements"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1783#event-6034"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1783#issuecomment-11754",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1783",
    "rename": {
        "from": "[with patch] fix latex errors with fraction field elements",
        "to": "[with patch, with positive review] fix latex errors with fraction field elements"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1783#event-6035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1783#issuecomment-11755",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1783#issuecomment-11756",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1783",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1783#event-6036"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1783#issuecomment-11757",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
