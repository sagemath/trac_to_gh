# Issue 1488: [patch, with positive review] fix output of symbolic vectors
...
```json
{
    ...
    "title": "[patch, with positive review] fix output of symbolic vectors",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1488",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1488#event-3794"
}
```
