...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13156"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13157"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13158"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13159"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13160"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13161"
}
```
...
```json
{
    "body": "<a id='comment:6'>Comment 6:</a>\n[attachment: polybori-coercion.patch.gz](https://github.com/sagemath/sage/files/ticket1541/polybori-coercion.patch.gz) provides coercion enhancements and small fixes to `pbori.pyx`. It should be applied after [attachment: polybori_booleanpolynomial_getattr.patch..gz](https://github.com/sagemath/sage/files/ticket1541/polybori_booleanpolynomial_getattr.patch..gz)\n\nThis patch adds coercion from `ZZ`, and `GF(2)` to `BooleanPolynomialRing`, so Martin's patch needs to be revised.",
...
```json
{
    "body": "<a id='comment:7'>Comment 7:</a>\n[attachment: polybori-coercion.patch.gz](https://github.com/sagemath/sage/files/ticket1541/polybori-coercion.patch.gz) is now ticket #1667.",
...
```json
{
    ...
    "title_was": "improve PolyBoRi integration",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13162"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1541",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-13163"
}
```
