...
```json
{
    "body": "<a id='comment:3'></a>Disregard those valgrind results- they are useless.",
    "created_at": "2007-12-22T00:50:54Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10624",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:3'></a>Disregard those valgrind results- they are useless.
...
```json
{
    "body": "<a id='comment:4'></a>I think the negative review has been resolved, and the currRing patch attached to this ticket should be applied (given a positive review) soon.",
    "created_at": "2007-12-25T15:57:10Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10625",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>I think the negative review has been resolved, and the currRing patch attached to this ticket should be applied (given a positive review) soon.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10626",
...
```json
{
    "body": "<a id='comment:6'></a>attachment:polybori-coercion.patch provides coercion enhancements and small fixes to `pbori.pyx`. It should be applied after attachment:polybori_booleanpolynomial_getattr.patch.\n\nThis patch adds coercion from `ZZ`, and `GF(2)` to `BooleanPolynomialRing`, so Martin's patch needs to be revised.",
    "created_at": "2007-12-30T16:09:04Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10628",
    "user": "https://github.com/burcin"
}
```

<a id='comment:6'></a>attachment:polybori-coercion.patch provides coercion enhancements and small fixes to `pbori.pyx`. It should be applied after attachment:polybori_booleanpolynomial_getattr.patch.
...
```json
{
    "body": "<a id='comment:7'></a>attachment:polybori-coercion.patch is now ticket #1667.",
    "created_at": "2008-01-03T15:05:13Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10629",
    "user": "https://github.com/burcin"
}
```

<a id='comment:7'></a>attachment:polybori-coercion.patch is now ticket #1667.
...
```json
{
    "body": "<a id='comment:8'></a>Replying to [burcin](#comment%3A6):\n> This patch adds coercion from `ZZ`, and `GF(2)` to `BooleanPolynomialRing`, so Martin's patch needs to be revised.\n\n\nIn the sense that the comments are outdated?",
    "created_at": "2008-01-06T13:20:37Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10630",
    "user": "https://github.com/malb"
}
```

<a id='comment:8'></a>Replying to [burcin](#comment%3A6):
> This patch adds coercion from `ZZ`, and `GF(2)` to `BooleanPolynomialRing`, so Martin's patch needs to be revised.
...
```json
{
    "body": "<a id='comment:9'></a>The `currRing.patch` is now #1701 because it doesn't logically belong here.",
    "created_at": "2008-01-06T13:23:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10631",
    "user": "https://github.com/malb"
}
```

<a id='comment:9'></a>The `currRing.patch` is now #1701 because it doesn't logically belong here.
...
```json
{
    "body": "<a id='comment:10'></a>Deleted original patch, just use burcin's getattr patch.",
    "created_at": "2008-01-07T15:40:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10632",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>Deleted original patch, just use burcin's getattr patch.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1541",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1541#issuecomment-10633",
