...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15297"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15298"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15300"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15301"
}
```
...
```json
{
    ...
    "title_was": "improve PolyBoRi integration",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1541",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1541#event-15303"
}
```
