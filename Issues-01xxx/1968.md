...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1968#issuecomment-13289",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] notebook -- remove capability of using live tutorial for users not signed in to the notebook server"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1968#event-6748"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "rename": {
        "from": "[with patch; needs review] notebook -- remove capability of using live tutorial for users not signed in to the notebook server",
        "to": "[with patch; request for clarification] notebook -- remove capability of using live tutorial for users not signed in to the notebook server"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1968#event-6749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1968#issuecomment-13290",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1968#issuecomment-13291",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "rename": {
        "from": "[with patch; request for clarification] notebook -- remove capability of using live tutorial for users not signed in to the notebook server",
        "to": "[with patch; with positive review] notebook -- remove capability of using live tutorial for users not signed in to the notebook server"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1968#event-6750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1968#issuecomment-13292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1968#issuecomment-13293",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1968#event-6751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1968#issuecomment-13294",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
