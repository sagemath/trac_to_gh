...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6432",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>This is still an issue with 2.10.1 and when I now switch the Sage notebook at sagenb into octave mode it seems like only every second cell is evaluated.\n\nCheers,\n\nMichael",
    "created_at": "2008-02-15T22:31:51Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6433",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:3'></a>This is still an issue with 2.10.1 and when I now switch the Sage notebook at sagenb into octave mode it seems like only every second cell is evaluated.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6434",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6435",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6436",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6437",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6438",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>It turns out that this is caused by the chdir command (which is run before each cell is evaluated) screwing up the syncronization.\n\nThis can also be fixed by improving the Octave interface to have better error detection.",
    "created_at": "2009-01-22T09:21:38Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6439",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:6'></a>It turns out that this is caused by the chdir command (which is run before each cell is evaluated) screwing up the syncronization.
...
```json
{
    "body": "<a id='comment:7'></a>This works for me.  Mike explained the patch and it sounds reasonable.  Positive Review.",
    "created_at": "2009-01-22T17:11:36Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6440",
    "user": "https://github.com/jasongrout"
}
```

<a id='comment:7'></a>This works for me.  Mike explained the patch and it sounds reasonable.  Positive Review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6441",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1019#issuecomment-6442",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
