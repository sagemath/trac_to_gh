# Issue 1793: [with patch, with positive review] Hilbert series, Hilbert polynomial, Laurent series expansion
...
```json
{
    ...
    "title": "[with patch, with positive review] Hilbert series, Hilbert polynomial, Laurent series expansion",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12207",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>`hilbert2.hg` contains the corrections William suggested on IRC and replaces `hilbert.hg`.",
    "created_at": "2008-01-16T19:56:08Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12208",
    "user": "https://github.com/malb"
}
```

<a id='comment:3'></a>`hilbert2.hg` contains the corrections William suggested on IRC and replaces `hilbert.hg`.
...
```json
{
    "body": "<a id='comment:4'></a>The patches from hilbery2.hg with ids a692e0df3534, 0b92c1071492, 6f3a99024ee7 should be applied.\n\nI didn't look at the other patches.",
    "created_at": "2008-01-20T06:18:39Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12209",
    "user": "https://github.com/ncalexan"
}
```

<a id='comment:4'></a>The patches from hilbery2.hg with ids a692e0df3534, 0b92c1071492, 6f3a99024ee7 should be applied.
...
```json
{
    "body": "<a id='comment:5'></a>Because the bundle contained many irrelevant patches I tried to provide clean patches instead and deleted every copy of my patches on the way (and all attachments to avoid confusion for the release maintainer). Me stupid. I'll provide new patches as soon as I have re-implemented the functionality.",
    "created_at": "2008-01-20T14:37:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12210",
    "user": "https://github.com/malb"
}
```

<a id='comment:5'></a>Because the bundle contained many irrelevant patches I tried to provide clean patches instead and deleted every copy of my patches on the way (and all attachments to avoid confusion for the release maintainer). Me stupid. I'll provide new patches as soon as I have re-implemented the functionality.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12211",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>The attached files `trac_1793_hilbert.patch` and `trac_1793_laurent.patch` re-implement the desired functionality and need review.",
    "created_at": "2008-01-20T16:48:09Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12212",
    "user": "https://github.com/malb"
}
```

<a id='comment:6'></a>The attached files `trac_1793_hilbert.patch` and `trac_1793_laurent.patch` re-implement the desired functionality and need review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12214",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Merged all three patches in Sage 2.10.2.alpha0",
    "created_at": "2008-02-15T00:29:50Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12215",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:8'></a>Merged all three patches in Sage 2.10.2.alpha0
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1793#event-4383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1793#issuecomment-12216",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
