...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1793#issuecomment-8731",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1793",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1793#issuecomment-8732",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8323"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8324"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8325"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8326"
}
```
...
```json
{
    ...
    "asset_name": "trac_1793_hilbert.patch",
    "asset_url": "tarball://root/attachments/ticket1793/trac_1793_hilbert.patch",
    "created_at": "2008-01-20T16:47:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1793",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1793/trac_1793_hilbert.patch",
    "user": "https://github.com/malb"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_1793_laurent.patch",
    "asset_url": "tarball://root/attachments/ticket1793/trac_1793_laurent.patch",
    "created_at": "2008-01-20T16:47:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1793",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1793/trac_1793_laurent.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "**Attachment:** [trac_1793_hilbert.patch](https://github.com/sagemath/sage/files/ticket1793/trac_1793_hilbert.patch)\n\n**Attachment:** [trac_1793_laurent.patch](https://github.com/sagemath/sage/files/ticket1793/trac_1793_laurent.patch)",
    "created_at": "2008-01-20T16:47:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1793",
    "type": "issue_comment",
...
**Attachment:** [trac_1793_hilbert.patch](https://github.com/sagemath/sage/files/ticket1793/trac_1793_hilbert.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8327"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8328"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_1793_review.patch",
    "asset_url": "tarball://root/attachments/ticket1793/trac_1793_review.patch",
    "created_at": "2008-02-14T23:27:13Z",
    "issue": "https://github.com/sagemath/sage/issues/1793",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1793/trac_1793_review.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "**Attachment:** [trac_1793_review.patch](https://github.com/sagemath/sage/files/ticket1793/trac_1793_review.patch)\n\npatch removes remark about index of regularity",
    "created_at": "2008-02-14T23:27:13Z",
    "issue": "https://github.com/sagemath/sage/issues/1793",
    "type": "issue_comment",
...
**Attachment:** [trac_1793_review.patch](https://github.com/sagemath/sage/files/ticket1793/trac_1793_review.patch)
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8329"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1793",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1793#event-8330"
}
```
