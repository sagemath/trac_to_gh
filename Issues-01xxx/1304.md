...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10161"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10162"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10163"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1304",
    "rename": {
        "from": "[graphs] edge-labeled graph isomorphism",
        "to": "graphs: edge-labeled graph isomorphism"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10164"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1304#issuecomment-6284",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10165"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10166"
}
```
...
```json
{
    ...
    "rename": {
        "from": "graphs: edge-labeled graph isomorphism",
        "to": "edge-labeled graph isomorphism"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10167"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10168"
}
```
...
```json
{
    ...
    "milestone_title": "sage-2.10.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10172"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1304",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1304#event-10173"
}
```
