...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1785#issuecomment-11763",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] bug in creating points on elliptic curves over extension fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1785#event-6040"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1785",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1785#issuecomment-11764",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1785",
    "rename": {
        "from": "[with patch, needs review] bug in creating points on elliptic curves over extension fields",
        "to": "[with patch, with positive  review] bug in creating points on elliptic curves over extension fields"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1785#event-6041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1785",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1785#issuecomment-11765",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1785",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1785#issuecomment-11766",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1785",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1785#issuecomment-11767",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1785",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1785#event-6042"
}
```
