# Issue 1785: [with patch, with positive  review] bug in creating points on elliptic curves over extension fields
...
```json
{
    ...
    "title": "[with patch, with positive  review] bug in creating points on elliptic curves over extension fields",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1785",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1785#event-4362"
}
```
