...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11352"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11353"
}
```
...
```json
{
    "body": "Changed assignee from **@mwhansen** to **@sagetrac-boothby**",
    "created_at": "2007-12-01T07:12:42Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/1322",
    "type": "issue_comment",
...
Changed assignee from **@mwhansen** to **@sagetrac-boothby**
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11357"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11360"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1322",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1322#event-11362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1322#issuecomment-6544",
    "user": "https://github.com/williamstein"
}
```
