...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-9896",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with spkg, needs review] moving a sage install breaks clisp"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1471#event-5018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-9897",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "rename": {
        "from": "[with spkg, needs review] moving a sage install breaks clisp",
        "to": "[with spkg, with positive review] moving a sage install breaks clisp"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1471#event-5019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-9898",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1471#event-5020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-9899",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-9900",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
