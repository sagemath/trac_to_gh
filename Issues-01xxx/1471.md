...
```json
{
    "body": "<a id='comment:1'></a>Since sage-2.9.1.alpha3 this issue seems to be gone, maybe earlier? My standard procedure now is to relocate my installed sage before I do a make check.\n\nclisp just worked\n\nJaap",
    "created_at": "2007-12-22T19:15:45Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-10229",
    "user": "https://github.com/jaapspies"
}
```

<a id='comment:1'></a>Since sage-2.9.1.alpha3 this issue seems to be gone, maybe earlier? My standard procedure now is to relocate my installed sage before I do a make check.
...
```json
{
    "body": "<a id='comment:2'></a>I still see the problem with Sage 2.9.1.1. I assume you might have some other sage install in the right location, so you don't see the problem. I needed to adapt maxima to use `clisp.bin` instead of clisp (the default) to build. The following two spkgs fix the problem:\n\n* http://sage.math.washington.edu/home/mabshoff/clisp-2.41.p12.spkg\n* http://sage.math.washington.edu/home/mabshoff/maxima-5.13.0.p2.spkg\n\nCheers,\n\nMichael",
    "created_at": "2008-01-02T21:41:59Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-10230",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>I still see the problem with Sage 2.9.1.1. I assume you might have some other sage install in the right location, so you don't see the problem. I needed to adapt maxima to use `clisp.bin` instead of clisp (the default) to build. The following two spkgs fix the problem:
...
```json
{
    "body": "<a id='comment:3'></a>Michael, your spkgs fixed the problem for me.",
    "created_at": "2008-01-03T07:07:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-10231",
    "user": "https://github.com/mwhansen"
}
```

<a id='comment:3'></a>Michael, your spkgs fixed the problem for me.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-10232",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Merged in 2.9.2.alpha0",
    "created_at": "2008-01-03T07:16:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1471#issuecomment-10233",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:4'></a>Merged in 2.9.2.alpha0
