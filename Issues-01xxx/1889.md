...
```json
{
    "body": "Attachment [trac_1889-sr-doctests.patch](https://github.com/sagemath/sage/files/ticket1889/trac_1889-sr-doctests.patch) by @malb created at 2008-01-23 17:05:33",
    "created_at": "2008-01-23T17:05:33Z",
    "issue": "https://github.com/sagemath/sage/issues/1889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1889#issuecomment-9216",
    "user": "https://github.com/malb"
}
```

Attachment [trac_1889-sr-doctests.patch](https://github.com/sagemath/sage/files/ticket1889/trac_1889-sr-doctests.patch) by @malb created at 2008-01-23 17:05:33
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1889#issuecomment-9217",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1889#issuecomment-9218",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1889",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1889#issuecomment-9219",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
