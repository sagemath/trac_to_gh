# Issue 1302: [with patch, with two positive reviews] bug in laurent_series integration
...
```json
{
    ...
    "title": "[with patch, with two positive reviews] bug in laurent_series integration",
    "type": "issue",
