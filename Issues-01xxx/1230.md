...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1230#issuecomment-8006",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1230#issuecomment-8007",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch; needs review] Quit worksheet behaviour"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1230#event-4174"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1230#issuecomment-8008",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "rename": {
        "from": "[with patch; needs review] Quit worksheet behaviour",
        "to": "[with patch; positive review with small comments] Quit worksheet behaviour"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1230#event-4175"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1230#issuecomment-8009",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1230#issuecomment-8010",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "rename": {
        "from": "[with patch; positive review with small comments] Quit worksheet behaviour",
        "to": "[with patch; positive review] Quit worksheet behaviour"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1230#event-4176"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1230#issuecomment-8011",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1230#issuecomment-8012",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1230",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1230#event-4177"
}
```
