...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1372#issuecomment-9201",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1372",
    "rename": {
        "from": "2.8.15.alpha2: dokchitser.py doctest failure (numerical noise)",
        "to": "[with patch] 2.8.15.alpha2: dokchitser.py doctest failure (numerical noise)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1372#event-4678"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1372#issuecomment-9202",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1372",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1372#event-4679"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1372#issuecomment-9203",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
