...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] latex bug with symbolics"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1771#event-5979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1771#issuecomment-11653",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1771",
    "rename": {
        "from": "[with patch] latex bug with symbolics",
        "to": "[with patch, positive review] latex bug with symbolics"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1771#event-5980"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1771#issuecomment-11654",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1771#issuecomment-11655",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1771",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1771#event-5981"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1771#event-5982"
}
```
