...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1064#event-3589"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1064#event-3590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1064",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1064#issuecomment-6761",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1064",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1064#issuecomment-6762",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] applying permutation is coded in a way that behaves badly when input isn't an \"expected type\""
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1064#event-3591"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1064",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1064#event-3592"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1064",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1064#issuecomment-6763",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1064",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1064#issuecomment-6764",
    "user": "https://github.com/rlmill"
}
```
