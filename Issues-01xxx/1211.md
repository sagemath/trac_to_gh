...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10302"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10305"
}
```
...
```json
{
    "body": "Changed assignee from **@malb** to **@sagetrac-dmharvey**",
...
Changed assignee from **@malb** to **@sagetrac-dmharvey**
...
```json
{
    ...
    "milestone_title": "sage-2.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10306"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1211",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1211#event-10310"
}
```
