...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1211#issuecomment-7871",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1211#issuecomment-7872",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1211#issuecomment-7873",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1211#issuecomment-7874",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] NTL crash in polynomial remainder over ZZ"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1211#event-4123"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1211#event-4124"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1211#issuecomment-7875",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "rename": {
        "from": "[with patch] NTL crash in polynomial remainder over ZZ",
        "to": "[with patch, with positive review] NTL crash in polynomial remainder over ZZ"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1211#event-4125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1211#event-4126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1211#issuecomment-7876",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1211#issuecomment-7877",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
