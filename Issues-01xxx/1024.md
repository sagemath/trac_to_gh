...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1024/Sage-2.8.10.alpha1-fix-memleak-in-matrix_rational_sparse_mpq_vector_set_entry.patch",
    "created_at": "2007-10-28T20:10:20Z",
    "issue": "https://github.com/sagemath/sage/issues/1024",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1024/Sage-2.8.10.alpha1-fix-memleak-in-matrix_rational_sparse_mpq_vector_set_entry.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1024#event-4743"
}
```
