# Issue 1024: [with patch] small memleak in matrix_rational_sparse_mpq_vector_set_entry
...
```json
{
    ...
    "title": "[with patch] small memleak in matrix_rational_sparse_mpq_vector_set_entry",
    "type": "issue",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1024#event-2799"
}
```
