# Issue 1566: [with patch] Symbolic substitution infinite recursion (was "NumberField infinite recursion")
...
```json
{
    ...
    "title": "[with patch] Symbolic substitution infinite recursion (was \"NumberField infinite recursion\")",
    "type": "issue",
