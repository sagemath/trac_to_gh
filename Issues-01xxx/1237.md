# Issue 1237: [with patch, positive review] E.torsion_order() fails on curves with big coefficients !!
...
```json
{
    ...
    "title": "[with patch, positive review] E.torsion_order() fails on curves with big coefficients !!",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1237#event-3271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1237",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1237#event-3272"
}
```
