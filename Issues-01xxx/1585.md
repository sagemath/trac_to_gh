...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1585#issuecomment-10363",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>I've fixed the files in guava",
    "created_at": "2007-12-22T20:42:35Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1585#issuecomment-10364",
    "user": "https://github.com/rlmill"
}
```

<a id='comment:2'></a>I've fixed the files in guava
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1585#issuecomment-10366",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
