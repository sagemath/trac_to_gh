...
```json
{
    ...
    "asset_name": "Sage-2.9.1.alpha1-fix-binary-memleak.patch",
    "asset_url": "tarball://root/attachments/some-uuid/ticket1572/Sage-2.9.1.alpha1-fix-binary-memleak.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1572#issuecomment-10777",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
