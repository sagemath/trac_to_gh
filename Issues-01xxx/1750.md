...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1750#issuecomment-11338",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>I can no longer reproduce this. We upgraded ipyhton as well as numpy mutliple times, so let's open another ticket if this pops up again.\n\nCheers,\n\nMichael",
    "created_at": "2008-10-26T16:18:27Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1750#issuecomment-11339",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:1'></a>I can no longer reproduce this. We upgraded ipyhton as well as numpy mutliple times, so let's open another ticket if this pops up again.
