...
```json
{
    "body": "Changed assignee from **mabshoff** to **tkosan**",
...
Changed assignee from **mabshoff** to **tkosan**
...
```json
{
    "body": "Changed assignee from **tkosan** to **mabshoff**",
...
Changed assignee from **tkosan** to **mabshoff**
