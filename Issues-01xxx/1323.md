...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8860",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8861",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8862",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8863",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "rename": {
        "from": "generate all subspaces of a vector space/projective space",
        "to": "[with patch, needs review] generate all subspaces of a vector space/projective space"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1323#event-4515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8864",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8865",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "rename": {
        "from": "[with patch, needs review] generate all subspaces of a vector space/projective space",
        "to": "[with patch, positive review] generate all subspaces of a vector space/projective space"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1323#event-4516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8866",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1323#issuecomment-8867",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1323",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1323#event-4517"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1323#event-4518"
}
```
