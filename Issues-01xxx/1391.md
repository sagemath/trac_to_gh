...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9341",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9342",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch, needs review] bug in unit part of factorizations of multivariate polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9343",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9344",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "rename": {
        "from": "[with patch, needs review] bug in unit part of factorizations of multivariate polynomials",
        "to": "[with patch, with positive review] bug in unit part of factorizations of multivariate polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4751"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9345",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "rename": {
        "from": "[with patch, with positive review] bug in unit part of factorizations of multivariate polynomials",
        "to": "[with patch, needs rebase] bug in unit part of factorizations of multivariate polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4752"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9346",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9347",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9348",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "rename": {
        "from": "[with patch, needs rebase] bug in unit part of factorizations of multivariate polynomials",
        "to": "[with patch, with positive review] bug in unit part of factorizations of multivariate polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4753"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4754"
}
```
