# Issue 1391: [with positive review] bug in unit part of factorizations of multivariate polynomials
...
```json
{
    ...
    "title": "[with positive review] bug in unit part of factorizations of multivariate polynomials",
    "type": "issue",
...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9616",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9617",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9618",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9619",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9620",
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with positive review] bug in unit part of factorizations of multivariate polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9621",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "rename": {
        "from": "[with positive review] bug in unit part of factorizations of multivariate polynomials",
        "to": "[needs rebase] bug in unit part of factorizations of multivariate polynomials"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9622",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9623",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1391#issuecomment-9624",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1391",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1391#event-4191"
}
```
