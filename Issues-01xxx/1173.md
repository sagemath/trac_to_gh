...
```json
{
    "body": "**Changing work issues** from \"add erf(sqrt(2)) and erf(45000).n(), formatting, perhaps speed\" to \"add erf(sqrt(2)) and erf(45000).n(), formatting, speed\".",
    "created_at": "2011-08-19T14:15:17Z",
    "issue": "https://github.com/sagemath/sage/issues/1173",
    "type": "issue_comment",
...
**Changing work issues** from "add erf(sqrt(2)) and erf(45000).n(), formatting, perhaps speed" to "add erf(sqrt(2)) and erf(45000).n(), formatting, speed".
...
archive/attachments_000860.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_000861.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_1173-move_call.patch](https://github.com/sagemath/sage/files/ticket1173/trac_1173-move_call.patch)",
    "created_at": "2011-10-30T11:11:04Z",
    "issue": "https://github.com/sagemath/sage/issues/1173",
    "type": "issue_comment",
...
**Attachment:** [trac_1173-move_call.patch](https://github.com/sagemath/sage/files/ticket1173/trac_1173-move_call.patch)
...
archive/attachments_000862.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "**Attachment:** [trac_1173_complex_erf_v3.patch](https://github.com/sagemath/sage/files/ticket1173/trac_1173_complex_erf_v3.patch)\n\n11143-style erf, use mpfr where possible",
    "created_at": "2011-10-30T21:29:01Z",
    "issue": "https://github.com/sagemath/sage/issues/1173",
    "type": "issue_comment",
...
**Attachment:** [trac_1173_complex_erf_v3.patch](https://github.com/sagemath/sage/files/ticket1173/trac_1173_complex_erf_v3.patch)
...
```json
{
    "body": "**Changing work issues** from \"add erf(sqrt(2)) and erf(45000).n(), formatting, speed\" to \"\".",
    "created_at": "2011-12-26T09:33:21Z",
    "issue": "https://github.com/sagemath/sage/issues/1173",
    "type": "issue_comment",
...
**Changing work issues** from "add erf(sqrt(2)) and erf(45000).n(), formatting, speed" to "".
