...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1300#issuecomment-6251",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1300#issuecomment-6252",
    "user": "https://github.com/simon-king-jena"
}
```
...
archive/attachments_000975.json:
```json
{
...
```json
{
    "body": "Attachment [SingularMatrix.patch](https://github.com/sagemath/sage/files/ticket1300/SingularMatrix.patch) by @simon-king-jena created at 2008-08-14 11:13:19\n\nTry to avoid autogenerated names when printing pexpect objects",
    "created_at": "2008-08-14T11:13:19Z",
    "issue": "https://github.com/sagemath/sage/issues/1300",
    "type": "issue_comment",
...
Attachment [SingularMatrix.patch](https://github.com/sagemath/sage/files/ticket1300/SingularMatrix.patch) by @simon-king-jena created at 2008-08-14 11:13:19
...
archive/attachments_000976.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
archive/attachments_000977.json:
```json
{
    "asset_content_type": "application/octet-stream",
...
```json
{
    "body": "Attachment [SingularMatrixMoreTest.patch](https://github.com/sagemath/sage/files/ticket1300/SingularMatrixMoreTest.patch) by @malb created at 2008-08-19 10:49:53\n\nslight layout fixups",
    "created_at": "2008-08-19T10:49:53Z",
    "issue": "https://github.com/sagemath/sage/issues/1300",
    "type": "issue_comment",
...
Attachment [SingularMatrixMoreTest.patch](https://github.com/sagemath/sage/files/ticket1300/SingularMatrixMoreTest.patch) by @malb created at 2008-08-19 10:49:53
