# Issue 1300: [with patch, positive review] Customize the output of Singular matrices
...
```json
{
    ...
    "title": "[with patch, positive review] Customize the output of Singular matrices",
    "type": "issue",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1300#event-3404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8138",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8139",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>Is the change in the newest Singular upstream? If so, we can make use of it. If not, we should wait for it to hit the official Singular release.",
    "created_at": "2008-06-12T23:03:52Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8141",
    "user": "https://github.com/malb"
}
```

<a id='comment:4'></a>Is the change in the newest Singular upstream? If so, we can make use of it. If not, we should wait for it to hit the official Singular release.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8142",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8143",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8145",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:8'></a>Attachment [trac_1300_fixup.patch](tarball://root/attachments/some-uuid/ticket1300/trac_1300_fixup.patch) by @malb created at 2008-08-18 11:33:24\n\n**Review**\n* no doctest was added to demonstrate the new behavior (added in attached patch)\n* `expect.py` is not the right place for Singular specific interface issue, thus it should be moved code to `singular.py` (done in attached patch).\n\nI'll give Simon's patch a positive review if my patch is applied afterwards. So my patch needs a review.",
    "created_at": "2008-08-18T11:33:24Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8146",
    "user": "https://github.com/malb"
}
```

<a id='comment:8'></a>Attachment [trac_1300_fixup.patch](tarball://root/attachments/some-uuid/ticket1300/trac_1300_fixup.patch) by @malb created at 2008-08-18 11:33:24
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8147",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8148",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "<a id='comment:10'></a>I edited Simon's patch to match Sage's undocumented docstring style. Positive review.",
    "created_at": "2008-08-19T10:50:30Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8149",
    "user": "https://github.com/malb"
}
```

<a id='comment:10'></a>I edited Simon's patch to match Sage's undocumented docstring style. Positive review.
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8150",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1300#event-3405"
}
```
...
```json
{
    "body": "<a id='comment:11'></a>Merged SingularMatrix.patch, trac_1300_fixup.patch and SingularMatrixMoreTest.patch in Sage 3.1.2.alpha0",
    "created_at": "2008-08-21T21:22:43Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1300",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1300#issuecomment-8151",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:11'></a>Merged SingularMatrix.patch, trac_1300_fixup.patch and SingularMatrixMoreTest.patch in Sage 3.1.2.alpha0
