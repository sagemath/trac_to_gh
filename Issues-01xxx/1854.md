# Issue 1854: [with patch; positive review] add more 3d plots to the reference manual
...
```json
{
    ...
    "title": "[with patch; positive review] add more 3d plots to the reference manual",
    "type": "issue",
