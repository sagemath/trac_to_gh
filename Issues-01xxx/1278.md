...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1278#issuecomment-8656",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1278#issuecomment-8657",
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1278#event-3353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1278#event-3354"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>This happened a while ago.",
    "created_at": "2007-12-14T04:11:57Z",
    "issue": "https://github.com/sagemath/sagetest/issues/1278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1278#issuecomment-8658",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```

<a id='comment:2'></a>This happened a while ago.
