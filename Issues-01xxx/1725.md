...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1725#event-13455"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1725#event-13456"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1725#event-13457"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1725#event-13458"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1725",
    "rename": {
        "from": "Experimental package for wxPython",
        "to": "Experimental package for wxPython (for now linux only)"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1725#event-13459"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1725#issuecomment-8411",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1725",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1725#event-13460"
}
```
