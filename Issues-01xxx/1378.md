...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1378#event-4695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1378#issuecomment-9231",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1378#issuecomment-9232",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] add ssh-client (i.e., ssh-keygen) as a required package in various places in the docs."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1378#event-4696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1378#issuecomment-9233",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1378#issuecomment-9234",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "rename": {
        "from": "[with patch] add ssh-client (i.e., ssh-keygen) as a required package in various places in the docs.",
        "to": "[with patch, with positive review] add ssh-client (i.e., ssh-keygen) as a required package in various places in the docs."
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1378#event-4697"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1378#event-4698"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1378#issuecomment-9235",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1378#issuecomment-9236",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
