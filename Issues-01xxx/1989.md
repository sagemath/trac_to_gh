...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20028"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20031"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20032"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20033"
}
```
...
```json
{
    ...
    "subject": "https://github.com/craigcitro",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20034"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1989#issuecomment-9468",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1989#issuecomment-9469",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1989",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1989#event-20036"
}
```
