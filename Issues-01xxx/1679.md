# Issue 1679: [with positive review] two documentation typos
...
```json
{
    ...
    "title": "[with positive review] two documentation typos",
    "type": "issue",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/some-uuid/ticket1679/1679.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1679#issuecomment-11497",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1679",
    "rename": {
        "from": "two documentation typos",
        "to": "[with positive review] two documentation typos"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1679#event-4933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1679#issuecomment-11498",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1679#issuecomment-11499",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1679#issuecomment-11500",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1679",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1679#event-4934"
}
```
