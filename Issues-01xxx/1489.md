...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1489#issuecomment-10016",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "rename": {
        ...
        "to": "[with patch] serious bug in calculus maxima parsing"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1489#event-5101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1489#issuecomment-10017",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1489",
    "rename": {
        "from": "[with patch] serious bug in calculus maxima parsing",
        "to": "[with patch, with positive review] serious bug in calculus maxima parsing"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1489#event-5102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1489",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sagetest/issues/1489#event-5103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1489#issuecomment-10018",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sagetest/issues/1489",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1489#issuecomment-10019",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
