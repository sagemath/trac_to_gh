...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sagetest/issues/1616#issuecomment-11075",
...
```json
{
    "body": "<a id='comment:2'></a>There is more work left to be done so that the functions always display as arcsin within Sage as well as making sure to treat them as asin when working with Maxima.\n\n\nI will be posting a new patch here in the near future.",
...
<a id='comment:2'></a>There is more work left to be done so that the functions always display as arcsin within Sage as well as making sure to treat them as asin when working with Maxima.
...
```json
{
    "body": "<a id='comment:3'></a>I just put up three new patches (to be applied in order) which pass -testall for me.",
...
<a id='comment:3'></a>I just put up three new patches (to be applied in order) which pass -testall for me.
...
```json
{
    "body": "<a id='comment:5'></a>Merged all three of mahnsen's patches in Sage 2.10.1.alpha0",
...
<a id='comment:5'></a>Merged all three of mahnsen's patches in Sage 2.10.1.alpha0
