# Issue 1348: [with patch, with positive review] Incorporate Jan Groenewald's documentation fixes
...
```json
{
    ...
    "title": "[with patch, with positive review] Incorporate Jan Groenewald's documentation fixes",
    "type": "issue",
