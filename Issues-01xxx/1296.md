...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1296#event-11032"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1296#event-11033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1296#event-11034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1296#event-11035"
}
```
...
```json
{
    "body": "Changed assignee from **@mwhansen** to **@robertwb**",
...
Changed assignee from **@mwhansen** to **@robertwb**
...
```json
{
    ...
    "milestone_title": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1296#event-11036"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1296#event-11037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1296#issuecomment-6249",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1296",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1296#event-11038"
}
```
