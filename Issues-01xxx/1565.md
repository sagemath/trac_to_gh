...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15495"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15496"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15497"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15498"
}
```
...
```json
{
    ...
    "title_was": "RealDoubleField documentation missing",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15499"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15500"
}
```
...
```json
{
    ...
    "title_was": "RealDoubleField documentation missing",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1565",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15502"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15503"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1565#event-15504"
}
```
