# Issue 1691: [with patch, with positive review] old bug in pari.gen __setitem__ code
...
```json
{
    ...
    "title": "[with patch, with positive review] old bug in pari.gen __setitem__ code",
    "type": "issue",
